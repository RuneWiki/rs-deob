...
public class class319 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IILhe;I)Lfl;", line = 23)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(II)V", line = 41)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IZ)Lud;", line = 137)
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(I)V", line = 192)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IZIIIIIII)V", line = 207)
    ...
    @OriginalMember(owner = "client!eu", name = "c", descriptor = "(I)V", line = 225)
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(Lrl;Lps;)V", line = 238)
