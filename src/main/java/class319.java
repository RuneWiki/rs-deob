...
public class class319 {
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(Lwm;B)Ljq;")
    ...
    @OriginalMember(owner = "client!ho", name = "b", descriptor = "(I)Lmt;")
    ...
    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(Lgga;Lgga;)V")
