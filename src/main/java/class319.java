...
public class class319 extends class440 {
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "()V", line = 5)
    public class319() {
        super(1, false);
    }

    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IBI)V", line = 9)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(BI)[I", line = 82)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(ILmo;I)V", line = 116)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(II)[[I", line = 130)
    ...
    @OriginalMember(owner = "client!tc", name = "g", descriptor = "(I)V", line = 173)
