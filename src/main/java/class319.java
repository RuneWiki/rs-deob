...
public class class319 implements class209 {
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(BLer;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(ZLjava/lang/String;I)V", line = 46)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(I)J", line = 59)
    ...
    @OriginalMember(owner = "client!qea", name = "b", descriptor = "(I)V", line = 97)
