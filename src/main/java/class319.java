...
public class class319 {
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(II[BZI)Z", line = 26)
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(ILlp;Llp;I)V", line = 296)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(II)[B", line = 144)
    ...
    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(B)Lbd;", line = 228)
    ...
    @OriginalMember(owner = "client!ap", name = "toString", descriptor = "()Ljava/lang/String;", line = 248)
    public final String toString() {
        field4804++;
        return "Cache:" + this.field4795;
    }

    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IZ[BI)Z", line = 261)
