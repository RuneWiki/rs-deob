...
public class class319 extends class147 {
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(BII)I", line = 3)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(Z)F", line = 20)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(IZ)V", line = 36)
    ...
    @OriginalMember(owner = "client!fda", name = "b", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!fda", name = "c", descriptor = "(I)D", line = 67)
    public final double method2052(int arg0) {
        field4528++;
        return arg0 == -1 ? this.field4516 : -0.12721405750383324D;
    }

    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(Ltq;ILtq;)V", line = 131)
    ...
    @OriginalMember(owner = "client!fda", name = "g", descriptor = "(I)Z", line = 150)
    public final boolean method2055(int arg0) {
        field4540++;
        return arg0 < 22 ? true : this.field4534;
    }

    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(ILha;)Lkr;", line = 161)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(ZLjagtheora/ogg/OggPacket;)V", line = 181)
    ...
    @OriginalMember(owner = "client!fda", name = "b", descriptor = "(Z)J", line = 258)
    ...
    @OriginalMember(owner = "client!fda", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 282)
    public class319(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(II)V", line = 293)
