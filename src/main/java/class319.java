...
public class class319 extends class189 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IZ)Lob;", line = 3)
    ...
    @OriginalMember(owner = "client!ug", name = "d", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!ug", name = "c", descriptor = "(B)Ljava/lang/Object;", line = 40)
    public final Object method580(byte arg0) {
        field4889++;
        return arg0 >= -56 ? null : this.field4890;
    }

    @OriginalMember(owner = "client!ug", name = "c", descriptor = "(I)Z", line = 54)
    public final boolean method579(int arg0) {
        field4895++;
        return arg0 != 71;
    }

    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 78)
