...
public abstract class class319 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IILaf;I)V", line = 17)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(II)V", line = 54)
