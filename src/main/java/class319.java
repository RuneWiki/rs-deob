...
public class class319 extends class220 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lhb;Lqj;Lqj;Lqj;I)Z")
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(IBLil;)V")
    ...
    @OriginalMember(owner = "client!fn", name = "b", descriptor = "(III)Lbr;")
