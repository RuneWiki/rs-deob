...
public class class319 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(ZBLps;)V")
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(BILr;)Z")
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IIIIIILr;III)V")
    ...
    @OriginalMember(owner = "client!wa", name = "<init>", descriptor = "(I[Lfq;IIII)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
