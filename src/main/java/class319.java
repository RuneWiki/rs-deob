...
public class class319 {
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "([BJI)V", line = 3)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "([BII)V", line = 90)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Z)V", line = 141)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(B)V", line = 164)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(III)Z", line = 274)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(I)V", line = 296)
