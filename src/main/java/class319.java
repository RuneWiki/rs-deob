...
public class class319 extends class14 {
    ...
    @OriginalMember(owner = "client!nq", name = "e", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "()V", line = 15)
    public class319() {
        super(1, true);
    }

    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(IB)[I", line = 20)
