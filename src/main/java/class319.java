...
public class class319 extends class393 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(ZB)V", line = 5)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 69)
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(I)V", line = 118)
    public class319(int arg0) {
        this.field4839 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!ob", name = "g", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(B)V", line = 149)
