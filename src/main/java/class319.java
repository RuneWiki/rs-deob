...
public class class319 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(IIZIZI)V", line = 9)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(II)Z", line = 66)
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(Ldw;)V", line = 123)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 82)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(IILwu;)Z", line = 149)
