...
public abstract class class319 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIILjava/lang/String;IIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/lang/String;IIIZI)V", line = 36)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IILjava/lang/String;III)V", line = 51)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ZII)V", line = 73)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 103)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(III[ILjava/lang/String;I[Lo;I)V", line = 178)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/lang/String;I[IILjava/util/Random;IBI[Lo;I)I", line = 191)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "([Lo;IIIIIIILta;IIIIILjava/lang/String;[II)I", line = 235)
    ...
    @OriginalMember(owner = "client!la", name = "b", descriptor = "(IILjava/lang/String;III)V", line = 336)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIIIILta;IIII[Lo;I[ILjava/lang/String;I)I", line = 352)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IZIILjava/lang/String;[II[Lo;Lta;)V", line = 367)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIIIILjava/lang/String;)V", line = 519)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IZLjava/lang/String;)V", line = 547)
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(Lza;Lul;)V", line = 589)
    public class319(class290 arg0, class411 arg1) {
        this.field4612 = arg0;
        this.field4614 = arg1;
    }

    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIIILjava/lang/String;II[Lo;I[I[IIILjava/util/Random;)I", line = 600)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "([I[I[ILjava/lang/String;[Lo;III)V", line = 679)
    ...
    @OriginalMember(owner = "client!la", name = "b", descriptor = "(IIIIIILjava/lang/String;)V", line = 842)
