...
public abstract class class319 extends class167 {
    ...
    @OriginalMember(owner = "client!nb", name = "o", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(B[Luca;)I", line = 15)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(CZ)C", line = 184)
    ...
    @OriginalMember(owner = "client!nb", name = "g", descriptor = "(I)Z", line = 215)
    ...
    @OriginalMember(owner = "client!nb", name = "p", descriptor = "(I)V", line = 268)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IIIII)V", line = 285)
    ...
    @OriginalMember(owner = "client!nb", name = "q", descriptor = "(I)V", line = 299)
    ...
    @OriginalMember(owner = "client!nb", name = "r", descriptor = "(I)V", line = 310)
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(ILha;)Z", line = 327)
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "(IIIIIIIIIZB)V", line = 344)
