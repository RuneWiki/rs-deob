...
public class class319 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Ljn;II)Ltu;")
    ...
    @OriginalMember(owner = "client!tu", name = "c", descriptor = "()Lep;")
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "(Lun;)V")
