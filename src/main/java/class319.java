...
public class class319 extends class424 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Lrg;BI)V")
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Lti;)V")
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Lij;I)V")
