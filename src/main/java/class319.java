...
public abstract class class319 {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(III)I", line = 24)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "([IIIZI)V", line = 62)
