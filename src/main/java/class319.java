...
public class class319 extends class60 {
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lkq;III)V")
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "(ILhd;)V")
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "(Lhd;)V")
