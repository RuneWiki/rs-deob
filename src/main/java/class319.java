...
public class class319 extends class30 {
    ...
    @OriginalMember(owner = "client!ak", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "()V", line = 17)
    public class319() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ak", name = "b", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(BILac;)V", line = 44)
    ...
    @OriginalMember(owner = "client!ak", name = "b", descriptor = "(II)V", line = 111)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(II)[I", line = 146)
