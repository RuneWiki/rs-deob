...
public class class319 extends class363 implements class158 {
    ...
    @OriginalMember(owner = "client!nb", name = "d", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;", line = 5)
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "(Laia;IZ[[I)V", line = 24)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lws;B)V", line = 77)
