...
public class class319 {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(JI)V", line = 14)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IBLkk;)V", line = 108)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Lkk;I)V", line = 125)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IIB)V", line = 174)
