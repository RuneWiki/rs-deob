...
public abstract class class319 {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!rt", name = "<init>", descriptor = "(IIIII)V", line = 288)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IIII)V", line = 93)
    ...
    @OriginalMember(owner = "client!rt", name = "d", descriptor = "(B)V", line = 268)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(BIII)V", line = 302)
