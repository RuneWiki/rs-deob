...
public class class319 extends class117 {
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Lti;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Ljava/awt/Color;ILjava/awt/Color;ZLjava/lang/String;ILjava/awt/Color;)V", line = 19)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ILti;)V", line = 99)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(II[IIIIZIIIII[IILoe;)I", line = 123)
    ...
    @OriginalMember(owner = "client!nq", name = "f", descriptor = "(I)V", line = 304)
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(II)I", line = 322)
