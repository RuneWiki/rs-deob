...
public abstract class class319 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(II)V", line = 7)
    public final void method1958(int arg0, int arg1) {
        this.method793(arg0, arg1, 0, 0, 1);
    }

    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(FFFFIIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(FFIILus;II)V", line = 42)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(FFII)V", line = 47)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(IIII)V", line = 50)
    public final void method1962(int arg0, int arg1, int arg2, int arg3) {
        this.method792(arg0, arg1, arg2, arg3, 0, 0, 1);
    }

    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(FFFFIILus;II)V", line = 54)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(FFIIIII)V", line = 80)
