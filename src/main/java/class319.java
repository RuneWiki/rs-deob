...
public class class319 extends class712 implements class752 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(III)V", line = 4)
    public final void method689(int arg0, int arg1, int arg2) {
        this.method1869(this.nativeid, arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIII)V", line = 17)
    public final void method1874(int arg0, int arg1, int arg2, int arg3) {
        this.method1877(this.nativeid, arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!j", name = "finalize", descriptor = "()V", line = 28)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IILaa;II)V", line = 33)
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Loa;II)V", line = 40)
    public class319(class50 arg0, int arg1, int arg2) {
        this.method1889(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!j", name = "b", descriptor = "()I", line = 45)
    public final int method1882() {
        return this.method1881(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(FFFFFFIIII)V", line = 48)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(FFFFFFILaa;II)V", line = 55)
    ...
    @OriginalMember(owner = "client!j", name = "w", descriptor = "(Z)V", line = 59)
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Loa;[I[B[BIIII)V", line = 65)
    ...
    @OriginalMember(owner = "client!j", name = "d", descriptor = "()I", line = 72)
    public final int method1892() {
        return this.method1891(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "()I", line = 75)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIII)V", line = 82)
