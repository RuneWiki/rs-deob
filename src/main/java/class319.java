...
public class class319 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ZBLjava/lang/String;I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!wr", name = "b", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lhd;IZ)V", line = 141)
