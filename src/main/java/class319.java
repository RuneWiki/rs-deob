...
public class class319 extends class214 {
    ...
    @OriginalMember(owner = "client!iia", name = "b", descriptor = "(III)V", line = 7)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(IB)[I", line = 21)
    ...
    @OriginalMember(owner = "client!iia", name = "<init>", descriptor = "()V", line = 43)
    public class319() {
        super(0, true);
    }
}
