...
public class class319 extends class577 {
    ...
    @OriginalMember(owner = "client!ln", name = "b", descriptor = "(ILqa;)Lin;")
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Lqa;ILr;)V")
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(ILqa;IB)Z")
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(IILqa;)Lr;")
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Lqa;I)Lpl;")
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Lpl;IIILr;I)V")
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Lqa;IZIILco;I)V")
