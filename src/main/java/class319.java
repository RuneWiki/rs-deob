...
public class class319 {
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(I)Z", line = 8)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!jr", name = "c", descriptor = "(I)V", line = 135)
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(Z)V", line = 152)
    public class319(boolean arg0) {
        this.field4526 = arg0;
    }

    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IILha;ZILsha;)V", line = 161)
