...
public class class319 {
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "([SI)[S", line = 3)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(IBI)Z", line = 185)
