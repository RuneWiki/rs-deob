...
public class class319 extends class739 {
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(IIILnf;Lnf;)V", line = 4)
    ...
    @OriginalMember(owner = "client!iia", name = "c", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!iia", name = "<init>", descriptor = "()V", line = 67)
    public class319() {
        super(1, true);
    }

    @OriginalMember(owner = "client!iia", name = "c", descriptor = "(II)[I", line = 73)
    ...
    @OriginalMember(owner = "client!iia", name = "d", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(ZI)[I", line = 123)
    ...
    @OriginalMember(owner = "client!iia", name = "b", descriptor = "(B)V", line = 165)
    ...
    @OriginalMember(owner = "client!iia", name = "b", descriptor = "(I)V", line = 350)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(IIIII)V", line = 372)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(Lsl;IB)V", line = 433)
