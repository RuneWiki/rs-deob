...
public class class319 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!qd", name = "b", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(II)Lns;", line = 74)
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lsn;ILci;)V", line = 118)
