...
public class class319 extends class423 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(III)Lik;", line = 4)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(ZLia;)V", line = 15)
    ...
    @OriginalMember(owner = "client!vi", name = "c", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IJLfp;IZ)V", line = 50)
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(Lfp;Lai;Ldj;J)V", line = 483)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(I)V", line = 239)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(Z)Z", line = 323)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(JI)V", line = 431)
    ...
    @OriginalMember(owner = "client!vi", name = "c", descriptor = "(Z)V", line = 455)
