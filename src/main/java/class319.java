...
public class class319 extends class75 {
    ...
    @OriginalMember(owner = "client!t", name = "b", descriptor = "(BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(III)B", line = 33)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(FIZILck;)V", line = 52)
    ...
    @OriginalMember(owner = "client!t", name = "b", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!t", name = "b", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!t", name = "c", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(II[I[Ljava/lang/Object;I)V", line = 194)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(BI)V", line = 249)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IC)Z", line = 270)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(ZLgk;)V", line = 281)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lgk;Z)V", line = 302)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lgk;B)V", line = 319)
