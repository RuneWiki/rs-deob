...
public class class319 extends class366 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IILlf;)V", line = 5)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(I)Z", line = 37)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IILqb;II)V", line = 48)
    ...
    @OriginalMember(owner = "client!vi", name = "d", descriptor = "(B)V", line = 102)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(IIII)V", line = 931)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Llf;I)V", line = 963)
    ...
    @OriginalMember(owner = "client!vi", name = "c", descriptor = "(I)V", line = 997)
