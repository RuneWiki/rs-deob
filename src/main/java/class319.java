...
public class class319 extends class406 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Ltq;II)Lvi;", line = 7)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "([B)V", line = 33)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(I)[F", line = 77)
    ...
    @OriginalMember(owner = "client!vi", name = "c", descriptor = "(I)F", line = 490)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Ltq;)Z", line = 502)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "([BI)V", line = 521)
    ...
    @OriginalMember(owner = "client!vi", name = "d", descriptor = "(I)I", line = 528)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "([B)V", line = 558)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "()I", line = 710)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "([I)Lvo;", line = 721)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "()V", line = 783)
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "([B)V", line = 801)
