...
public class class319 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(I)Ldh;", line = 8)
    ...
    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(I)V", line = 63)
    public class319(int arg0) {
        this.field4627 = arg0;
    }

    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(IIIIII)V", line = 70)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IIILoh;)V", line = 28)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(ZLdh;)V", line = 41)
