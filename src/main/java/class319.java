...
public abstract class class319 extends class329 {
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!qh", name = "b", descriptor = "(I)I", line = 18)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Les;I)Luba;", line = 32)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(B)Z", line = 42)
    public final boolean method1834(byte arg0) {
        field4081++;
        return arg0 < 14 ? false : false;
    }

    @OriginalMember(owner = "client!qh", name = "j", descriptor = "(I)Z", line = 60)
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "(Lqj;)V", line = 74)
    public class319(class548 arg0) {
        this.field4079 = arg0;
    }

    @OriginalMember(owner = "client!qh", name = "k", descriptor = "(I)V", line = 82)
