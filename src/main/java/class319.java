...
public class class319 extends class171 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(ILm;FLm;)V")
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Z)Lm;")
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "(Lhd;I)V")
