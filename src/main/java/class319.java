...
public class class319 extends class258 {
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(Lim;B)V", line = 16)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(IIILcda;Lcda;)V", line = 45)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(BLmc;)V", line = 103)
