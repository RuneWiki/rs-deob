...
public class class319 {
    ...
    @OriginalMember(owner = "client!la", name = "toString", descriptor = "()Ljava/lang/String;", line = 6)
    public final String toString() {
        field4625++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIIIIB)V", line = 14)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 33)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(BI)I", line = 94)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(II)I", line = 105)
    public static final int method1996(int arg0, int arg1) {
        field4618++;
        return arg1 == -12981 ? arg0 & 0x7F : 46;
    }

    @OriginalMember(owner = "client!la", name = "b", descriptor = "(B)I", line = 118)
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(II)V", line = 128)
