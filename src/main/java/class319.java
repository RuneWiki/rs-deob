...
public abstract class class319 extends class149 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IIIIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!vc", name = "b", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!vc", name = "b", descriptor = "(Z)V", line = 49)
