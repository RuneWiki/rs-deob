...
public class class319 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 35)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lhs;)V", line = 69)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Z)V", line = 181)
