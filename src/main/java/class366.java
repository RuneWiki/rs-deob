...
public class class366 extends class5 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(ILes;I)V")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(BLes;)Lmk;")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(ILi;)V")
