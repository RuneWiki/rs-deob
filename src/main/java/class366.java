...
public class class366 {
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;)V", line = 22)
