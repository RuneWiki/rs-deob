...
public class class366 implements class190 {
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IIII)I", line = 4)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IIIIIII)V", line = 40)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "([IBJI)Ljava/lang/String;", line = 68)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(DB)V", line = 106)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(II)I", line = 141)
