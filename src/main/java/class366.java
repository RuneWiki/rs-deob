...
public class class366 extends class377 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(ZLjava/lang/String;Ljava/lang/String;)V", line = 4)
    ...
    @OriginalMember(owner = "client!br", name = "b", descriptor = "(II)V", line = 17)
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(I)V", line = 30)
    private class366(int arg0) {
        super(0, false);
        this.method2132(124, arg0);
    }

    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IB)[[I", line = 39)
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "()V", line = 77)
    public class366() {
        this(0);
    }

    @OriginalMember(owner = "client!br", name = "b", descriptor = "(BLjava/lang/String;)Z", line = 86)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IILjava/io/File;[B)V", line = 115)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IILji;)V", line = 129)
