...
public class class366 {
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "(I)Ltv;")
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Lau;B)V")
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "(B)Ltv;")
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(Lau;)V")
