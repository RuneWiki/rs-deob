...
public class class366 extends class756 implements class450 {
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "([IZ[ILns;[I)V")
    ...
    @OriginalMember(owner = "client!ow", name = "<init>", descriptor = "(Lvf;I[BI)V")
    ...
    @OriginalMember(owner = "client!ow", name = "<init>", descriptor = "(Lvf;ILjaclib/memory/Buffer;)V")
