...
public class class366 {
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(Lhd;Z)V", line = 146)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(Lfi;IIIB)V", line = 192)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(I)V", line = 213)
    ...
    @OriginalMember(owner = "client!kw", name = "b", descriptor = "(I)V", line = 325)
