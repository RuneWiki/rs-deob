...
public class class366 extends class211 {
    ...
    @OriginalMember(owner = "client!sc", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!sc", name = "d", descriptor = "(III)V", line = 30)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(CZI)I", line = 51)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Laaa;)V", line = 75)
    ...
    @OriginalMember(owner = "client!sc", name = "g", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IBIILjava/lang/String;III)V", line = 183)
    ...
    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "()V", line = 342)
    public class366() {
        super(0, true);
    }

    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IZ)I", line = 208)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(BILib;)V", line = 262)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(I)V", line = 350)
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(II)[I", line = 368)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(ZB)I", line = 594)
