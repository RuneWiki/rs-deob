...
public class class366 extends class383 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lqn;II)Lhr;", line = 116)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "()V", line = 123)
    public final void method2102() {
        this.field4753 = null;
    }

    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "(Lfh;)V", line = 126)
