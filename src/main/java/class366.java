...
public class class366 extends class34 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IB)[I", line = 3)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Z[B)Z", line = 14)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lsv;I)Lkj;", line = 54)
    ...
    @OriginalMember(owner = "client!cr", name = "f", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "()V", line = 132)
    public class366() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(IBI)I", line = 135)
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(ZII)Z", line = 155)
