...
public abstract class class366 implements class582 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(I[I)Ljava/lang/String;", line = 22)
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "(Ldba;)V", line = 82)
