...
public class class366 extends class446 {
    ...
    @OriginalMember(owner = "client!wa", name = "d", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(ZI)I", line = 33)
    ...
    @OriginalMember(owner = "client!wa", name = "d", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!wa", name = "<init>", descriptor = "(Lte;)V", line = 60)
    public class366(class367 arg0) {
        this.field5162 = arg0;
    }

    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(BLnq;)V", line = 69)
