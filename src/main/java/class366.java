...
public class class366 extends class583 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(ILee;)V")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(II)Las;")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IIIBZIIFI)[[I")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Lee;B[I)V")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Lee;B)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(ILee;I)V")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(ILwt;)I")
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(IIBII)V")
