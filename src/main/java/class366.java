...
public abstract class class366 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(I)Lfg;", line = 21)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(III)V", line = 54)
