...
public class class366 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Z)Z", line = 14)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(II)V", line = 126)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(B)V", line = 138)
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "(B)V", line = 152)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IB)V", line = 193)
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Ld;ILfo;)V", line = 249)
    public class366(class104 arg0, int arg1, class361 arg2) {
        this.field4997 = arg2;
        this.field4997.method2136(-15, 1);
    }

    @OriginalMember(owner = "client!um", name = "b", descriptor = "(IB)Lgj;", line = 267)
