...
public class class366 implements Runnable {
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ow", name = "run", descriptor = "()V", line = 20)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(FIIIZIII)[I", line = 68)
