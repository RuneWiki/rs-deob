...
public class class366 extends class513 {
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(II)Z", line = 119)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!ija", name = "f", descriptor = "(I)Z", line = 144)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(ILha;)V", line = 166)
    ...
    @OriginalMember(owner = "client!ija", name = "b", descriptor = "(Z)V", line = 182)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(IB)Z", line = 196)
    ...
    @OriginalMember(owner = "client!ija", name = "b", descriptor = "(III)Z", line = 207)
    ...
    @OriginalMember(owner = "client!ija", name = "<init>", descriptor = "(I)V", line = 217)
    public class366(int arg0) {
        this.field4970 = arg0;
    }

    @OriginalMember(owner = "client!ija", name = "b", descriptor = "(II)Z", line = 228)
