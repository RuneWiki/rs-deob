...
public class class366 implements class702 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(I)Lve;", line = 5)
    public final class527 method606(int arg0) {
        field5280++;
        return arg0 == 0 ? class365.field5277 : null;
    }

    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "(I)V", line = 16)
    public class366(int arg0) {
        this.field5279 = arg0;
    }

    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(B)V", line = 30)
