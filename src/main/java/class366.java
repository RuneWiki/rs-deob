...
public abstract class class366 {
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Lti;B)V", line = 6)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!hl", name = "b", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(Lqg;)V", line = 87)
    public class366(class321 arg0) {
        this.field5494 = arg0;
    }

    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(I[JB[II)V", line = 99)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Z)V", line = 157)
