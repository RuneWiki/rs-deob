...
public class class366 extends class666 {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(ILiaa;Z)V", line = 90)
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "()V", line = 136)
    public class366() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ga", name = "b", descriptor = "(Z)V", line = 144)
