...
public class class366 extends class328 {
    ...
    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(III)V", line = 22)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(BII)V", line = 49)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(III)V", line = 60)
