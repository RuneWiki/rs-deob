...
public class class366 extends class444 {
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IIZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!hl", name = "e", descriptor = "(B)Z", line = 21)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(BI)V", line = 32)
    ...
    @OriginalMember(owner = "client!hl", name = "f", descriptor = "(B)Ljava/lang/Object;", line = 49)
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(Lbq;Ljava/lang/Object;I)V", line = 65)
    public class366(class190 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field5455 = arg1;
    }

    @OriginalMember(owner = "client!hl", name = "g", descriptor = "(B)Lie;", line = 74)
