...
public class class366 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Loh;I)V")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(BLpb;)Z")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Lco;B)V")
    ...
    @OriginalMember(owner = "client!pb", name = "<init>", descriptor = "(Lco;)V")
