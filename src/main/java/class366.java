...
public class class366 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(Ljava/lang/String;IILjava/lang/String;IILjava/lang/String;Ljava/lang/String;)V", line = 7)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(Z)V", line = 41)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(III)V", line = 53)
