...
public abstract class class366 extends class241 {
    ...
    @OriginalMember(owner = "client!rr", name = "b", descriptor = "(III)Ldaa;", line = 4)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(ILur;I[I)Leh;", line = 12)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(I)V", line = 195)
