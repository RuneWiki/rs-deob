...
public class class366 {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(I)V", line = 20)
    public static void method2296(int arg0) {
        int var1 = -75 / ((2 - arg0) / 44);
        field5634 = null;
    }

    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Lof;II)Z", line = 30)
    ...
    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(B)V", line = 188)
