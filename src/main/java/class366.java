...
public class class366 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!eg", name = "toString", descriptor = "()Ljava/lang/String;", line = 32)
