...
public class class366 extends class276 {
    ...
    @OriginalMember(owner = "client!mo", name = "c", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(I)V", line = 153)
    public class366(int arg0) {
        this.field5694 = arg0;
    }

    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(B)V", line = 130)
