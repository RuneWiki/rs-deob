...
public class class366 extends class371 implements class210 {
    ...
    @OriginalMember(owner = "client!ar", name = "c", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(IIIIILip;)V", line = 15)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lvc;B)V", line = 23)
    ...
    @OriginalMember(owner = "client!ar", name = "e", descriptor = "(I)I", line = 33)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(ZLvc;)V", line = 48)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ZLvc;)V", line = 63)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(B)I", line = 75)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ILvc;II)Z", line = 86)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(B)I", line = 101)
    public final int method71(byte arg0) {
        field5031++;
        return arg0 < 81 ? -120 : 0;
    }

    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(BILvc;)Ln;", line = 112)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lvc;I)Lep;", line = 139)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(I)I", line = 151)
