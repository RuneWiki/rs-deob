...
public class class366 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Z[B)V", line = 4)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Ll;IIIIILza;)V", line = 185)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I)V", line = 291)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "([BI)V", line = 305)
