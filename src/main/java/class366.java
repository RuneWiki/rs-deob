...
public class class366 extends class115 {
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(BLbk;I)V")
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "([Ldl;ZILen;I[BZ)V")
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(ILjf;)Z")
