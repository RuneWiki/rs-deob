...
public class class366 extends class425 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Z)Z", line = 14)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IIII)I", line = 41)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Ltj;ZLtj;Ltj;)V", line = 74)
    ...
    @OriginalMember(owner = "client!wa", name = "b", descriptor = "(Z)V", line = 95)
