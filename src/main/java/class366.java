...
public class class366 {
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IIIIIIIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(B)Lst;", line = 66)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Lst;I)V", line = 76)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Ln;ILdn;)V", line = 93)
    ...
    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "(I)V", line = 117)
    public class366(int arg0) {
        this.field4811 = arg0;
    }

    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "(IIIIII)V", line = 125)
