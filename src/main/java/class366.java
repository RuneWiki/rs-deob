...
public class class366 extends class754 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(ILd;Ljava/awt/Canvas;I)Lha;")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IZI)Lnq;")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Luk;[III)Lgea;")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Z)Lhq;")
    ...
    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "(ILrfa;Lrfa;Lgd;Loj;I[BIZ)V")
