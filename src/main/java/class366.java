...
public class class366 extends class132 {
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IBII)I", line = 4)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(ZLeo;)V", line = 34)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(III)V", line = 53)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(II)V", line = 72)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IIB)V", line = 86)
    public final void method927(int arg0, int arg1, byte arg2) {
        ++field4713;
        int var4 = 28 / ((-47 - arg2) / 33);
    }

    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(B)V", line = 96)
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(IIIIIII)V", line = 108)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IZI)V", line = 119)
