...
public class class366 extends class306 {
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "()V", line = 4)
    public class366() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!fd", name = "h", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(BBI)V", line = 22)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IIII)[B", line = 37)
    ...
    @OriginalMember(owner = "client!fd", name = "c", descriptor = "(II)I", line = 60)
