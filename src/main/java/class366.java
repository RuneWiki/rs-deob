...
public class class366 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(I[J[Ljava/lang/Object;BI)V", line = 29)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "([Ljava/lang/String;IBI)Ljava/lang/String;", line = 84)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(I)V", line = 170)
