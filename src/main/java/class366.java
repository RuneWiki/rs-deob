...
public class class366 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IIB)Z", line = 24)
    ...
    @OriginalMember(owner = "client!nd", name = "toString", descriptor = "()Ljava/lang/String;", line = 36)
    public final String toString() {
        field5370++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(II[B)[B", line = 61)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IZ[B)Ljava/lang/Object;", line = 73)
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "(II)V", line = 110)
