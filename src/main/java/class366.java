...
public class class366 extends class98 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(II)[I", line = 7)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IZ)V", line = 142)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(BLli;)Z", line = 159)
    ...
    @OriginalMember(owner = "client!wa", name = "b", descriptor = "(I)V", line = 189)
    ...
    @OriginalMember(owner = "client!wa", name = "<init>", descriptor = "()V", line = 201)
    public class366() {
        super(0, true);
    }

    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(ILdg;I)V", line = 209)
    ...
    @OriginalMember(owner = "client!wa", name = "f", descriptor = "(B)V", line = 275)
