...
public class class743 extends class458 implements class212 {
    ...
    @OriginalMember(owner = "client!fka", name = "<init>", descriptor = "(Lhk;ILjaclib/memory/Buffer;)V")
    ...
    @OriginalMember(owner = "client!fka", name = "a", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!fka", name = "a", descriptor = "([Ljava/lang/Object;B[I)V")
    ...
    @OriginalMember(owner = "client!fka", name = "<init>", descriptor = "(Lhk;I[BI)V")
