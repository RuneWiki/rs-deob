...
public class class743 {
    ...
    @OriginalMember(owner = "client!fka", name = "a", descriptor = "(ILdia;I)V")
    ...
    @OriginalMember(owner = "client!fka", name = "a", descriptor = "(Ldia;B)V")
    ...
    @OriginalMember(owner = "client!fka", name = "a", descriptor = "(ZLdia;I)V")
    ...
    @OriginalMember(owner = "client!fka", name = "a", descriptor = "(Ldia;I)V")
    ...
    @OriginalMember(owner = "client!fka", name = "a", descriptor = "(ILef;ILdia;)V")
    ...
    @OriginalMember(owner = "client!fka", name = "b", descriptor = "(Ldia;B)V")
