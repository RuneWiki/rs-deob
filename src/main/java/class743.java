...
public abstract class class743 extends class674 {
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(Z)Z", line = 6)
    ...
    @OriginalMember(owner = "client!gs", name = "f", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!gs", name = "i", descriptor = "(I)Z", line = 60)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(I[Lkb;)I", line = 77)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(II)I", line = 252)
    ...
    @OriginalMember(owner = "client!gs", name = "c", descriptor = "(Z)V", line = 290)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(IIIIIIIIIZB)V", line = 299)
