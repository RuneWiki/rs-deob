...
public class class743 {
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(IZ)Lis;", line = 39)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(Lvl;B)V", line = 83)
    ...
    @OriginalMember(owner = "client!oha", name = "<init>", descriptor = "(Lal;ILnd;)V", line = 195)
