...
public class class743 implements class769 {
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(BII)V", line = 14)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(IB)I", line = 44)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(III)V", line = 64)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(I)Z", line = 95)
    ...
    @OriginalMember(owner = "client!nea", name = "b", descriptor = "(I)V", line = 196)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(IZI)V", line = 223)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(B)V", line = 253)
    ...
    @OriginalMember(owner = "client!nea", name = "b", descriptor = "(BII)V", line = 264)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(IILha;IIZ)V", line = 287)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(ZI)I", line = 312)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(BILmea;I)V", line = 358)
