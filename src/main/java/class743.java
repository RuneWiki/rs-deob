...
public class class743 {
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(IF)I", line = 13)
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(F)F", line = 74)
    private static final float method4147(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!lja", name = "a", descriptor = "()V", line = 81)
    public static void method4148() {
        field10354 = null;
        field10351 = null;
    }

    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(IIF)F", line = 86)
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(Lrv;Lmv;)V", line = 92)
    ...
    @OriginalMember(owner = "client!lja", name = "b", descriptor = "(IIF)F", line = 158)
