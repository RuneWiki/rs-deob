...
public class class743 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(II)Lll;")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(B[II[ILlea;I)Lbga;")
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(Lmca;ILgga;Lgga;)V")
