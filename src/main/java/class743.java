...
public class class743 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIILgga;)V", line = 45)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ILgga;B)V", line = 97)
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(I)Liaa;", line = 118)
    ...
    @OriginalMember(owner = "client!ac", name = "c", descriptor = "(I)V", line = 134)
