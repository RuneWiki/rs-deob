...
public class class743 extends class159 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(ZLda;Ljava/lang/String;Lej;Lha;B)V")
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Lwu;II)V")
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(Ldw;)V")
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IIIILiha;II)Z")
