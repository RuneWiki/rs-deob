...
public class class743 extends class60 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(CIIIZLaa;II)V", line = 5)
    public final void method132(char arg0, int arg1, int arg2, int arg3, boolean arg4, class487 arg5, int arg6, int arg7) {
    }

    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(Lwga;Loea;[Lrh;Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!kr", name = "fa", descriptor = "(CIIIZ)V", line = 313)
