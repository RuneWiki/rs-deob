...
public class class743 {
    ...
    @OriginalMember(owner = "client!qc", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field10334++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(BLji;)Llc;", line = 19)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(B)V", line = 34)
