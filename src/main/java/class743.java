...
public class class743 {
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(BI)Lrd;", line = 20)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(Ljava/lang/String;Z)Z", line = 48)
    ...
    @OriginalMember(owner = "client!bca", name = "<init>", descriptor = "(Lfs;ILlga;)V", line = 81)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(IB)[I", line = 64)
