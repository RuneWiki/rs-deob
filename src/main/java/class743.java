...
public abstract class class743 implements class185 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(FFIILaa;II)V")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(FFFFFFLaa;II)V")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(FFFFIILaa;II)V")
