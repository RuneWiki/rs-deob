...
public class class743 extends class283 {
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Lkw;Lrb;)V", line = 47)
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(IZ)V", line = 94)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ZII)V", line = 141)
    ...
    @OriginalMember(owner = "client!lr", name = "c", descriptor = "(B)V", line = 218)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I)Z", line = 237)
    ...
    @OriginalMember(owner = "client!lr", name = "c", descriptor = "(I)V", line = 248)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(II)I", line = 261)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lqk;B)Lqk;", line = 272)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(B)V", line = 301)
    ...
    @OriginalMember(owner = "client!lr", name = "d", descriptor = "(I)V", line = 320)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lou;II)V", line = 353)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ZI)V", line = 373)
