...
public class class743 {
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(ZII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(BI)Lpba;", line = 18)
    ...
    @OriginalMember(owner = "client!lja", name = "b", descriptor = "(BI)V", line = 51)
    ...
    @OriginalMember(owner = "client!lja", name = "<init>", descriptor = "(Lto;ILla;)V", line = 103)
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!lja", name = "b", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(B)V", line = 122)
