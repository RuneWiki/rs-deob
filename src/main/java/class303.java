...
public class class303 extends class485 {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(ILha;IZ)Lda;", line = 3)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(IIIILnv;I)Ltea;", line = 37)
    ...
    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "(II[I[I)V", line = 64)
