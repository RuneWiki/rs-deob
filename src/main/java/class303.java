...
public class class303 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "([IIB)Lrm;", line = 14)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIBIIIIII)V", line = 37)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(II[I)Lrm;", line = 92)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(II[II)Lrm;", line = 114)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IB)V", line = 148)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(I[IBI)Lrm;", line = 162)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIII)V", line = 207)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(I)V", line = 225)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Lum;Lum;)V", line = 242)
