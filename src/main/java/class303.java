...
public class class303 extends class85 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IILha;)Z")
    ...
    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "(Llea;IIZ)V")
    ...
    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "(Llea;IIII)V")
    ...
    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "(Llea;II[III)V")
