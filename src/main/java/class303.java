...
public class class303 extends class187 {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(BI)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Lvm;I[[[BBIIIIIIIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IB)V", line = 60)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Lvm;IIILmk;)V", line = 83)
    ...
    @OriginalMember(owner = "client!bd", name = "<init>", descriptor = "(Lof;)V", line = 117)
    public class303(class421 arg0) {
        this.field4122 = arg0;
    }

    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(B)V", line = 126)
