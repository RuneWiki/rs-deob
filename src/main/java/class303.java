...
public class class303 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IIBIIIIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(II)I", line = 47)
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(B)V", line = 86)
