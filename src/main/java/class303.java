...
public class class303 extends class263 {
    ...
    @OriginalMember(owner = "client!tk", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!tk", name = "c", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(IB)[[I", line = 33)
    ...
    @OriginalMember(owner = "client!tk", name = "<init>", descriptor = "()V", line = 83)
    public class303() {
        super(1, false);
    }

    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Lok;BLok;)I", line = 92)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(BLrc;)V", line = 124)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IZLgk;)V", line = 174)
    ...
    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(II)V", line = 213)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ZZB)V", line = 468)
    ...
    @OriginalMember(owner = "client!tk", name = "e", descriptor = "(I)V", line = 500)
