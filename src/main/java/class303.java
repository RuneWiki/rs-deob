...
public class class303 extends class437 {
    ...
    @OriginalMember(owner = "client!wf", name = "c", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!wf", name = "b", descriptor = "(III)V", line = 25)
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "(IIIIIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(IIILos;ZILtj;)V", line = 63)
    ...
    @OriginalMember(owner = "client!wf", name = "b", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!wf", name = "b", descriptor = "(II)V", line = 99)
    ...
    @OriginalMember(owner = "client!wf", name = "b", descriptor = "(B)V", line = 111)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(III)V", line = 138)
