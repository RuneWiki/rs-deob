...
public class class303 extends class604 {
    ...
    @OriginalMember(owner = "client!caa", name = "<init>", descriptor = "()V", line = 5)
    public class303() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!caa", name = "d", descriptor = "(B)V", line = 12)
    public static void method1910(byte arg0) {
        field4296 = null;
        int var1 = -120 % ((-arg0 - 21) / 39);
    }

    @OriginalMember(owner = "client!caa", name = "b", descriptor = "(BII)V", line = 21)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(IIII)[B", line = 36)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(II)I", line = 57)
