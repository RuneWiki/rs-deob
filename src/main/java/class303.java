...
public class class303 {
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(B)I", line = 11)
    ...
    @OriginalMember(owner = "client!mu", name = "toString", descriptor = "()Ljava/lang/String;", line = 24)
    public final String toString() {
        field4217++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(II)V", line = 32)
    public class303(int arg0, int arg1) {
        this.field4216 = arg1;
        this.field4214 = arg0;
    }

    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BI)Lbo;", line = 41)
