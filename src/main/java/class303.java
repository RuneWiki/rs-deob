...
public class class303 extends class310 {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Lie;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!wb", name = "d", descriptor = "(B)V", line = 348)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Z)I", line = 543)
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(II)I", line = 718)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(I)V", line = 739)
    ...
    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "(Lk;)V", line = 1187)
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(I)V", line = 786)
    ...
    @OriginalMember(owner = "client!wb", name = "c", descriptor = "(II)Z", line = 824)
    public final boolean method2089(int arg0, int arg1) {
        ++field4726;
        return ~arg0 == arg1 && !this.field4717 ? super.field4882 : true;
    }

    @OriginalMember(owner = "client!wb", name = "e", descriptor = "(B)V", line = 839)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IB)I", line = 863)
    ...
    @OriginalMember(owner = "client!wb", name = "c", descriptor = "(I)I", line = 909)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(III)Z", line = 968)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(ZLk;)V", line = 979)
    ...
    @OriginalMember(owner = "client!wb", name = "d", descriptor = "(II)I", line = 1018)
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(ZI)V", line = 1037)
    ...
    @OriginalMember(owner = "client!wb", name = "e", descriptor = "(II)V", line = 1080)
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(III)I", line = 1104)
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(Z)V", line = 1155)
    ...
    @OriginalMember(owner = "client!wb", name = "f", descriptor = "(II)Z", line = 1275)
    public final boolean method2100(int arg0, int arg1) {
        ++field4720;
        return arg0 != arg1 ? true : super.field4882;
    }

    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(BZ)V", line = 1287)
