...
public class class303 extends class114 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(II)Z", line = 8)
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "([B)V", line = 21)
    public class303(byte[] arg0) {
        this.field4430 = arg0;
    }

    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ILuu;)V", line = 29)
    ...
    @OriginalMember(owner = "client!gr", name = "f", descriptor = "(I)V", line = 40)
