...
public class class303 extends class578 {
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(Lqs;B)V")
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(III)Lmf;")
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(Z)Lek;")
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(Lqs;I)V")
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(BZILd;)V")
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(ILqs;)V")
