...
public class class303 extends class434 {
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(Luea;Lha;Ljia;IIIZLbm;I)V")
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;Z)V")
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(ILqk;II)V")
    ...
    @OriginalMember(owner = "client!qia", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
