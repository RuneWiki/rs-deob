...
public class class303 implements Runnable {
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(ILje;Lje;)V")
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(ILwt;)V")
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(I[BLce;I)Lwt;")
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Lce;II)Lwt;")
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(ILce;I)Lwt;")
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Ltq;IILmu;III[[[B[I[I[I[I[IIBIIZ)V")
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(Lng;)V")
