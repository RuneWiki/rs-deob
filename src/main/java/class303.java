...
public class class303 extends class478 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "([BI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Ltf;Lfa;ILjava/awt/Canvas;B)Lr;", line = 28)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "()V", line = 58)
    public class303() {
        super(1, true);
    }

    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(II)[I", line = 71)
