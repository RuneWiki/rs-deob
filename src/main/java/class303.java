...
public class class303 extends class627 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(BII)Z", line = 22)
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(ILmo;IZ)V", line = 43)
