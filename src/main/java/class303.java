...
public class class303 {
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(ZLkt;)I")
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(IZLhr;Z)V")
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Ljava/net/Socket;BI)Lida;")
