...
public class class303 extends class478 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(III[Ljava/lang/Object;[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 61)
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(III)V", line = 77)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(III)V", line = 93)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IBI)V", line = 121)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(I)V", line = 136)
