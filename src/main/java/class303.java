...
public class class303 extends class333 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(II)I", line = 8)
    ...
    @OriginalMember(owner = "client!lo", name = "d", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!lo", name = "b", descriptor = "(I)Z", line = 35)
    public final boolean method1944(int arg0) {
        field4459++;
        return arg0 == 4 ? this.field4453 : false;
    }

    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(B)C", line = 49)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(I)I", line = 61)
    public final int method1946(int arg0) {
        field4463++;
        return arg0 == 4 ? this.field4456 : 124;
    }

    @OriginalMember(owner = "client!lo", name = "b", descriptor = "(B)I", line = 73)
    ...
    @OriginalMember(owner = "client!lo", name = "c", descriptor = "(I)J", line = 87)
