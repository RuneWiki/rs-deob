...
public class class303 {
    ...
    @OriginalMember(owner = "client!qia", name = "c", descriptor = "(I)Lpha;")
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(BI)Laj;")
    ...
    @OriginalMember(owner = "client!qia", name = "<init>", descriptor = "(Lcr;ILla;)V")
