...
public class class303 extends class450 {
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(III)Z", line = 15)
    ...
    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "(ILup;)V", line = 29)
    public class303(int arg0, class278 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "(ZI)V", line = 32)
    ...
    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "(Lup;)V", line = 48)
    public class303(class278 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lee;B)Lqk;", line = 51)
    ...
    @OriginalMember(owner = "client!w", name = "b", descriptor = "(Z)I", line = 65)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(IIB)Z", line = 77)
    ...
    @OriginalMember(owner = "client!w", name = "c", descriptor = "(II)V", line = 89)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(B)V", line = 139)
    ...
    @OriginalMember(owner = "client!w", name = "b", descriptor = "(I)Z", line = 161)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(II)I", line = 182)
