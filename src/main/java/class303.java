...
public class class303 extends class25 {
    ...
    @OriginalMember(owner = "client!sb", name = "d", descriptor = "(B)Z", line = 6)
    public final boolean method175(byte arg0) {
        int var2 = 93 / ((arg0 + 70) / 55);
        return true;
    }

    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 15)
    public final Object method174(int arg0) {
        return arg0 == -9023 ? this.field3728.get() : (Object) null;
    }

    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Lgj;Ljava/lang/Object;I)V", line = 24)
