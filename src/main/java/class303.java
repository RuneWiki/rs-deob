...
public class class303 extends class354 {
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(BLvea;)V")
    ...
    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "(ILwo;)V")
    ...
    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "(Lwo;)V")
