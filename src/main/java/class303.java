...
public abstract class class303 extends class547 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(ILsf;Lha;BIIZ)V")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Z[Ljw;)I")
    ...
    @OriginalMember(owner = "client!bq", name = "c", descriptor = "(ILha;)Z")
