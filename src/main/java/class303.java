...
public class class303 {
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lpe;II)Z", line = 49)
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(I[Lje;IIII)V", line = 218)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIIIIILpe;)V", line = 137)
