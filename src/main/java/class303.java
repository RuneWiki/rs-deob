...
public abstract class class303 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!io", name = "start", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IIFFLnk;IFBFIF)[B", line = 14)
    ...
    @OriginalMember(owner = "client!io", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 29)
    ...
    @OriginalMember(owner = "client!io", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 44)
    ...
    @OriginalMember(owner = "client!io", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 60)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(B)V", line = 78)
    public static void method1808(byte arg0) {
        field4034 = null;
        int var1 = 32 % ((44 - arg0) / 37);
    }

    @OriginalMember(owner = "client!io", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 88)
    public final void windowDeiconified(WindowEvent arg0) {
        field4003++;
    }

    @OriginalMember(owner = "client!io", name = "b", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ILjava/lang/String;)V", line = 143)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ZI)V", line = 168)
    ...
    @OriginalMember(owner = "client!io", name = "run", descriptor = "()V", line = 251)
    ...
    @OriginalMember(owner = "client!io", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 370)
    ...
    @OriginalMember(owner = "client!io", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 394)
    public final void windowActivated(WindowEvent arg0) {
        field4031++;
    }

    @OriginalMember(owner = "client!io", name = "stop", descriptor = "()V", line = 404)
    ...
    @OriginalMember(owner = "client!io", name = "destroy", descriptor = "()V", line = 415)
    ...
    @OriginalMember(owner = "client!io", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 429)
    ...
    @OriginalMember(owner = "client!io", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 447)
    ...
    @OriginalMember(owner = "client!io", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 458)
    public final void windowIconified(WindowEvent arg0) {
        field4021++;
    }

    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Z)V", line = 467)
    ...
    @OriginalMember(owner = "client!io", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 499)
    public final void update(Graphics arg0) {
        field4030++;
        this.paint(arg0);
    }

    @OriginalMember(owner = "client!io", name = "b", descriptor = "(I)Z", line = 508)
    ...
    @OriginalMember(owner = "client!io", name = "providesignlink", descriptor = "(Lfq;)V", line = 550)
    ...
    @OriginalMember(owner = "client!io", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 559)
    public final void focusLost(FocusEvent arg0) {
        field4004++;
        class75.field945 = false;
    }

    @OriginalMember(owner = "client!io", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 569)
    public final void windowOpened(WindowEvent arg0) {
        field4028++;
    }

    @OriginalMember(owner = "client!io", name = "d", descriptor = "(I)Ljava/lang/String;", line = 582)
    ...
    @OriginalMember(owner = "client!io", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 603)
    public final void windowClosed(WindowEvent arg0) {
        field4018++;
    }

    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IZIIIIILjava/lang/String;)V", line = 610)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IIIII)V", line = 656)
    ...
    @OriginalMember(owner = "client!io", name = "e", descriptor = "(I)V", line = 701)
    ...
    @OriginalMember(owner = "client!io", name = "f", descriptor = "(I)V", line = 738)
    ...
    @OriginalMember(owner = "client!io", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 785)
    public final void windowClosing(WindowEvent arg0) {
        this.destroy();
        field4027++;
    }

    @OriginalMember(owner = "client!io", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 796)
