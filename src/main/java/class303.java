...
public class class303 extends class236 {
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Leq;IZIJ)V")
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(IILum;BLeq;)V")
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "(Leq;Lin;Lko;J)V")
