...
public class class303 extends class270 {
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Lbd;IIZ)V")
    ...
    @OriginalMember(owner = "client!al", name = "v", descriptor = "(IILha;)Lha;")
    ...
    @OriginalMember(owner = "client!al", name = "DA", descriptor = "(Lha;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Lha;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!al", name = "E", descriptor = "(Lha;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Lqea;[I)V")
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lag;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(IIILjava/lang/Class;)Lrc;")
