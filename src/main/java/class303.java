...
public class class303 {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(ILja;)V", line = 19)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(I)V", line = 469)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Z)V", line = 480)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "([BZ)Leq;", line = 501)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IIIIIIIII)V", line = 580)
    ...
    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(I)V", line = 616)
