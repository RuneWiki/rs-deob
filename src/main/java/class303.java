...
public class class303 extends OutputStream {
    ...
    @OriginalMember(owner = "client!ti", name = "write", descriptor = "(I)V", line = 7)
    public final void write(int arg0) throws IOException {
        field4275++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IIIZIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Lod;Ljava/lang/String;IB)Ldd;", line = 77)
