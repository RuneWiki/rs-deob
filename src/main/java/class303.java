...
public class class303 extends class331 {
    ...
    @OriginalMember(owner = "client!fo", name = "b", descriptor = "(Ldg;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(IBLdg;)V")
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(ILdg;[I)V")
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Ltq;I)V")
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Ldg;B)V")
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Lqk;)V")
