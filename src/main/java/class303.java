...
public class class303 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(ILn;BIIBII)Ln;")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IILn;III)Ln;")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lkk;II)V")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lkk;I)V")
