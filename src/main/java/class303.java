...
public abstract class class303 extends class455 {
    ...
    @OriginalMember(owner = "client!rp", name = "f", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Lcg;IIII)V")
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IILya;ILor;IZ)V")
