...
public abstract class class303 extends class242 {
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(III)Lrr;")
    ...
    @OriginalMember(owner = "client!rr", name = "c", descriptor = "(B)[Ljd;")
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(BLrn;ZIILqa;I)V")
