...
public class class303 extends class41 {
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(Loga;I)V")
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(ILes;)V")
    ...
    @OriginalMember(owner = "client!uu", name = "d", descriptor = "(B)V")
