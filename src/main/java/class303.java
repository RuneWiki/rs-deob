...
public abstract class class303 {
    ...
    @OriginalMember(owner = "client!oaa", name = "b", descriptor = "(I)Lih;")
    ...
    @OriginalMember(owner = "client!oaa", name = "d", descriptor = "(I)Lwaa;")
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(Lkv;Lav;Lfb;IIIII)V")
    ...
    @OriginalMember(owner = "client!oaa", name = "b", descriptor = "(B)Lkk;")
    ...
    @OriginalMember(owner = "client!oaa", name = "e", descriptor = "(I)Lio;")
