...
public class class786 {
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(II)[[[B", line = 3)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(B)V", line = 793)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(I)V", line = 803)
