...
public abstract class class786 {
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(Lha;Z)V")
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(Lnba;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(Lha;Ld;B)V")
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(II[BLog;)Lhga;")
