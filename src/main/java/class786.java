...
public class class786 extends class379 {
    ...
    @OriginalMember(owner = "client!lo", name = "b", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IBI)Z", line = 17)
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(Lke;)V", line = 133)
    public class786(class625 arg0) {
        this.field10851 = arg0;
    }

    @OriginalMember(owner = "client!lo", name = "c", descriptor = "(Z)V", line = 68)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(BII)Z", line = 112)
