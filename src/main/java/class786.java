...
public class class786 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IBII)V", line = 7)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lso;B)V", line = 28)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ILie;IZIIIILaa;Lmea;Ljava/lang/String;Lda;)V", line = 66)
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(Lso;)V", line = 151)
    public class786(class494 arg0) {
        this.method4306(arg0, (byte) -35);
    }

    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(BLhs;)V", line = 118)
