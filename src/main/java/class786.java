...
public class class786 extends class101 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "([[ZIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lr;III[Z)V", line = 82)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IIIIIBI)V", line = 115)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(SI)V", line = 303)
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(Lai;Lew;Luca;[I)V", line = 318)
