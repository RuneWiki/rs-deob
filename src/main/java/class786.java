...
public class class786 implements class489 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(III)V", line = 16)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ZI)I", line = 44)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IZI)V", line = 57)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Lha;Ld;I)V", line = 85)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(I)V", line = 311)
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(III)V", line = 342)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(BI)I", line = 371)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ZB)I", line = 392)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IBI)V", line = 429)
