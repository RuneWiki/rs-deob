...
public class class786 extends class735 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(III)I", line = 7)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lrh;Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ILfca;)V", line = 42)
