...
public class class279 {
    ...
    @OriginalMember(owner = "client!ds", name = "finalize", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(ILjava/lang/String;)J", line = 29)
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(Ltt;JI)V", line = 75)
