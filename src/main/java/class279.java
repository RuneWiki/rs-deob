...
public class class279 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IIF)F", line = 5)
    ...
    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(IIF)F", line = 17)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "()V", line = 26)
    public static void method1744() {
        field3848 = null;
        field3851 = null;
    }

    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(Llk;Le;)V", line = 32)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IF)I", line = 104)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(F)F", line = 167)
