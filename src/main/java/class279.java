...
public class class279 implements class515 {
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!mda", name = "b", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(B)Z", line = 28)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(ZI)V", line = 50)
    ...
    @OriginalMember(owner = "client!mda", name = "<init>", descriptor = "(Luo;)V", line = 66)
