...
public abstract class class279 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ILge;IIZIIIIILuo;)Lge;", line = 6)
    ...
    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "(II)V", line = 62)
    public class279(int arg0, int arg1) {
        this.field3611 = arg1;
        this.field3612 = arg0;
    }

    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Z)V", line = 98)
