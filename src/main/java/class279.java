...
public class class279 {
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(ZIIJI)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Z)V", line = 81)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Lnq;ZLuo;)V", line = 93)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IZ)V", line = 222)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(I)V", line = 243)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(B)V", line = 267)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IB[[B[[ILij;Lij;IZ[[BLuo;[[B[[BI)V", line = 285)
