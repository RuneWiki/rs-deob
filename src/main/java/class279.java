...
public class class279 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Lae;I)Lfm;")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "([B)[Lfm;")
    ...
    @OriginalMember(owner = "client!fm", name = "d", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Lae;II)[Lfm;")
    ...
    @OriginalMember(owner = "client!fm", name = "g", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(Lae;II)Lfm;")
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(Lae;I)[Lfm;")
