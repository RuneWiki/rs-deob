...
public abstract class class279 extends class167 {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!rh", name = "j", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!rh", name = "g", descriptor = "(I)Z", line = 32)
    ...
    @OriginalMember(owner = "client!rh", name = "n", descriptor = "(I)Z", line = 43)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(I[II[FI[FI[IIIIII)V", line = 54)
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(ILha;)Z", line = 137)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(I)V", line = 158)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IZLha;)Leia;", line = 170)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IIIIIII)V", line = 184)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IZIIIIBIF)[[I", line = 1342)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Lha;Lwea;ZIIII)V", line = 1373)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(B[Luca;)I", line = 1385)
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "(IIIII)V", line = 1396)
