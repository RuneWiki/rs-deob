...
public abstract class class279 {
    ...
    @OriginalMember(owner = "client!oca", name = "b", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(Lraa;B)Ljava/lang/String;", line = 34)
    ...
    @OriginalMember(owner = "client!oca", name = "b", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!oca", name = "c", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!oca", name = "d", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!oca", name = "<init>", descriptor = "(Lpj;)V", line = 89)
    public class279(class38 arg0) {
        this.field4267 = arg0;
    }

    @OriginalMember(owner = "client!oca", name = "e", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!oca", name = "b", descriptor = "(Z)V", line = 118)
