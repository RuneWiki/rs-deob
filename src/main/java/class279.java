...
public class class279 extends class297 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(ZII)V", line = 8)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(IIIIIIZII)Z", line = 19)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(IZ)V", line = 47)
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Lnk;II)V", line = 75)
    ...
    @OriginalMember(owner = "client!we", name = "c", descriptor = "(I)I", line = 87)
    public static final int method1656(int arg0) {
        ++field3656;
        return arg0 != 2 ? 57 : 2;
    }

    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "(Lbo;)V", line = 99)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Z)Z", line = 117)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(ZI)V", line = 147)
    ...
    @OriginalMember(owner = "client!we", name = "d", descriptor = "(I)V", line = 160)
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "(B)V", line = 196)
