...
public abstract class class279 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(III)Z", line = 16)
    ...
    @OriginalMember(owner = "client!df", name = "d", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Loi;Z)I", line = 44)
