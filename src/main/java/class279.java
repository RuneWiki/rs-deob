...
public abstract class class279 extends class419 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!ns", name = "f", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!ns", name = "f", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lns;Z)Z", line = 57)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 165)
