...
public class class279 extends class260 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(ZLjava/awt/Canvas;)Lab;", line = 3)
    ...
    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "(Lod;IIIIIIZ)V", line = 23)
    ...
    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "(Lod;IIIIZ[BI)V", line = 37)
    ...
    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "(Lod;IIIII[BI)V", line = 59)
    ...
    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "(Lod;IIIZ[I)V", line = 74)
    ...
    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "(Lod;IIII[I)V", line = 98)
    ...
    @OriginalMember(owner = "client!we", name = "i", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "(Lod;IIIIIZ)V", line = 132)
