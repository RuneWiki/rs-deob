...
public class class279 implements Runnable {
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;B)Lvd;")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Z)La;")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Ljava/net/URL;I)Lvd;")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(BLjava/awt/Frame;)Lvd;")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ILjava/lang/Class;)Lvd;")
    public final class26 method1884(int arg0, Class arg1) {
        return arg0 == 0 ? this.method1905(arg1, 0, 10, false, 0) : null;
    }

    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ILjava/lang/String;)Lvd;")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Ljava/lang/Class;Z)Lvd;")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(B)Lvd;")
    public final class26 method1887(byte arg0) {
        return arg0 == -40 ? this.method1905((Object) null, 0, 12, false, 0) : null;
    }

    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Ljava/lang/Class;ILjava/lang/String;)Lvd;")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(I)Lvd;")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "([Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Class;I)Lvd;")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IIIBI)Lvd;")
    ...
    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(ILjava/lang/String;)Lvd;")
    ...
    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(B)Lvd;")
    public final class26 method1893(byte arg0) {
        return arg0 == -49 ? this.method1905((Object) null, 0, 13, false, 0) : null;
    }

    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ILjava/lang/String;I)Lvd;")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ILjava/lang/Runnable;I)Lvd;")
    public final class26 method1897(int arg0, Runnable arg1, int arg2) {
        return arg2 == 2 ? this.method1905(arg1, arg0, 2, false, 0) : null;
    }

    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(II)Lvd;")
    ...
    @OriginalMember(owner = "client!ap", name = "d", descriptor = "(I)Lvd;")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IIILjava/lang/Object;I)Lvd;")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Ljava/awt/Component;II[IILjava/awt/Point;)Lvd;")
    ...
    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(ILjava/lang/Class;)Lvd;")
    public final class26 method1903(int arg0, Class arg1) {
        return arg0 == -17074 ? this.method1905(arg1, 0, 11, false, 0) : null;
    }

    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Ljava/awt/Component;ZB)Lvd;")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Ljava/lang/Object;IIZI)Lvd;")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IBILjava/awt/Component;)Lvd;")
