...
public class class279 implements class171 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lnn;IIII)V")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IIBLnn;)V")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lml;II)V")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lw;Lya;I)I")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IILml;I)V")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lcf;II)V")
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Lug;)V")
