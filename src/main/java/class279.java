...
public class class279 extends class452 {
    ...
    @OriginalMember(owner = "client!un", name = "d", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!un", name = "g", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(III)Z", line = 55)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(IIIBIII)V", line = 68)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(IIIII)V", line = 510)
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(Lbl;II)V", line = 547)
