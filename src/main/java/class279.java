...
public class class279 extends class448 implements class323 {
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(Lqa;B)Lvs;", line = 3)
    ...
    @OriginalMember(owner = "client!qm", name = "e", descriptor = "(I)Z", line = 39)
    public final boolean method177(int arg0) {
        ++field3582;
        return arg0 != 5 ? false : false;
    }

    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IZILqa;)Z", line = 51)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(BLqa;)V", line = 68)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(I)I", line = 86)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(I)I", line = 97)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(B)V", line = 108)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(BLrn;ZIILqa;I)V", line = 119)
    ...
    @OriginalMember(owner = "client!qm", name = "c", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!qm", name = "i", descriptor = "(I)I", line = 145)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lqa;B)V", line = 155)
    ...
    @OriginalMember(owner = "client!qm", name = "d", descriptor = "(I)I", line = 169)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Z)Z", line = 184)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lqa;I)V", line = 195)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IILqa;)Lc;", line = 207)
    ...
    @OriginalMember(owner = "client!qm", name = "j", descriptor = "(I)V", line = 218)
    public static void method1716(int arg0) {
        field3581 = null;
        int var1 = 37 / ((arg0 - -61) / 58);
    }

    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(Lqa;Ljt;IIIIIZIIIIIII)V", line = 228)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IILqa;Lcc;ILtn;)Z", line = 241)
