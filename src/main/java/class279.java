...
public class class279 extends class304 implements class620 {
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(FZ)F", line = 4)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Llea;III)V", line = 18)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(ZIZ)V", line = 32)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(BI)V", line = 46)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(FI)F", line = 79)
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(Lck;Lem;IIZ[BII)V", line = 92)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(ILfba;I)Z", line = 113)
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(Lck;IIZ[III)V", line = 134)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(B)Z", line = 154)
    ...
    @OriginalMember(owner = "client!ou", name = "d", descriptor = "(B)V", line = 166)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IIIIBLem;II[F)V", line = 179)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(III[IIIII)V", line = 194)
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(Lck;Lem;IIZ[FII)V", line = 208)
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(Lck;Lem;Lew;II)V", line = 229)
    ...
    @OriginalMember(owner = "client!ou", name = "h", descriptor = "(I)V", line = 244)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IBIIII[I)V", line = 254)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(I)I", line = 277)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(I)I", line = 288)
    public final int method373(int arg0) {
        ++field3535;
        return arg0 != -15836 ? -25 : this.field3545;
    }

    @OriginalMember(owner = "client!ou", name = "a", descriptor = "([BIBIIILem;II)V", line = 299)
