...
public class class279 {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Lae;Lna;IIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ILon;)V", line = 134)
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(B)V", line = 153)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;IB)V", line = 177)
