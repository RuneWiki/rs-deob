...
public class class279 extends class666 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IB)[[I", line = 16)
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "()V", line = 65)
    public class279() {
        super(1, false);
    }

    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(ILiaa;Z)V", line = 68)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "([BIII)[B", line = 83)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(II)[I", line = 97)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(I[Ljava/lang/String;IB)Ljava/lang/String;", line = 132)
