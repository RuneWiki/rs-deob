...
public class class279 extends class275 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lnr;[Ldn;Z)V")
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "()Llc;")
    public final class125 method1783() {
        return this.field4104;
    }

    @OriginalMember(owner = "client!qp", name = "c", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "([Lla;Z)V")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lnr;J)Z")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lnr;J[Ldn;[Lla;Z)V")
