...
public class class279 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Ljava/awt/Frame;Llh;B)V")
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IIIIIZI)Lmc;")
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lvm;Z)V")
