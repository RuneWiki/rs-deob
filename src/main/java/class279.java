...
public class class279 extends class23 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(IILqa;)Z")
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(Lti;I)V")
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(ILqa;)Lnj;")
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(IIILqa;)Z")
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(IBLuc;II)V")
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(IIILqa;ZLee;Z)V")
    ...
    @OriginalMember(owner = "client!sg", name = "b", descriptor = "(Lqa;B)Lem;")
