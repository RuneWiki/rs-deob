...
public class class279 implements class217 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(B)Z", line = 34)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(III)Ldfa;", line = 75)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Lpl;Lpl;Lnn;)V", line = 94)
