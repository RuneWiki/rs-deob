...
public class class279 extends class341 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(BLir;Lir;)I")
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(ILsj;I)I")
    ...
    @OriginalMember(owner = "client!ni", name = "w", descriptor = "(I)V")
