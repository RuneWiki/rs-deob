...
public class class279 extends Canvas {
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(IB)Lwh;")
    ...
    @OriginalMember(owner = "client!vca", name = "update", descriptor = "(Ljava/awt/Graphics;)V")
    public final void update(Graphics arg0) {
        this.field3925.update(arg0);
        field3926++;
    }

    @OriginalMember(owner = "client!vca", name = "<init>", descriptor = "(Ljava/awt/Component;)V")
    ...
    @OriginalMember(owner = "client!vca", name = "paint", descriptor = "(Ljava/awt/Graphics;)V")
