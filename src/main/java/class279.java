...
public class class279 extends class115 {
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(II)[I", line = 5)
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "()V", line = 58)
    public class279() {
        super(1, true);
    }

    @OriginalMember(owner = "client!qq", name = "e", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(BLbk;I)V", line = 78)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ZI)I", line = 92)
    ...
    @OriginalMember(owner = "client!qq", name = "c", descriptor = "(II)V", line = 111)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Z)V", line = 126)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(BIIII)V", line = 137)
