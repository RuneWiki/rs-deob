...
public class class279 {
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IIII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "()V", line = 115)
    ...
    @OriginalMember(owner = "client!gk", name = "b", descriptor = "()Z", line = 167)
    private final boolean method1923() {
        return this.field4011.method978() == this.field4010;
    }

    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(Lig;)V", line = 361)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Lgs;)Z", line = 173)
    ...
    @OriginalMember(owner = "client!gk", name = "c", descriptor = "()V", line = 198)
    ...
    @OriginalMember(owner = "client!gk", name = "b", descriptor = "(Lgs;)V", line = 225)
    public final void method1926(class29 arg0) {
        this.method1927(arg0, true);
    }

    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Lgs;Z)V", line = 231)
    ...
    @OriginalMember(owner = "client!gk", name = "d", descriptor = "()V", line = 249)
