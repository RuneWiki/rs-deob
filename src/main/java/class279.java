...
public class class279 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(B)I", line = 12)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Z)V", line = 54)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IZI)V", line = 72)
