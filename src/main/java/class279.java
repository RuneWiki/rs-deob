...
public class class279 extends class73 {
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ub", name = "c", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(III)V", line = 66)
    ...
    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "(IIIIIII)V", line = 85)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(III)V", line = 99)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(BII)V", line = 116)
