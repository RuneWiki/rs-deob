...
public class class279 {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(BLrg;)V", line = 12)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "([[[Lr;IIIIZ)Z", line = 45)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Lrg;II)V", line = 371)
