...
public class class279 extends class61 {
    ...
    @OriginalMember(owner = "client!gf", name = "fa", descriptor = "(CIIIZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(Lbi;Ljl;[Lhb;Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(CIIIZLaa;II)V", line = 264)
