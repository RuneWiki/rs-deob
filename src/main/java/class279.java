...
public class class279 extends class694 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Ljc;I)Lvm;", line = 5)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IZI)V", line = 26)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IILrj;ILmq;IIIIIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(BI)V", line = 67)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IB)Z", line = 83)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(Z)V", line = 104)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(ZII)Law;", line = 121)
