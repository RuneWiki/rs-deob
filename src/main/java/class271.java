...
public class class271 extends class179 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 17)
    ...
    @OriginalMember(owner = "client!wj", name = "d", descriptor = "()V", line = 53)
    ...
    @OriginalMember(owner = "client!wj", name = "b", descriptor = "()I", line = 86)
    public final int method56() {
        return this.field3617 - (this.field3621.available() >> (class495.field7227 ? 2 : 1));
    }

    @OriginalMember(owner = "client!wj", name = "c", descriptor = "()V", line = 94)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 100)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "()V", line = 136)
