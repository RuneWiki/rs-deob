...
public class class271 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(II)Lqg;", line = 23)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IB)Lqs;", line = 44)
