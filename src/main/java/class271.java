...
public class class271 extends class702 implements class200 {
    ...
    @OriginalMember(owner = "client!w", name = "finalize", descriptor = "()V", line = 8)
    ...
    @OriginalMember(owner = "client!w", name = "xa", descriptor = "(III)V", line = 13)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(IILua;II)V", line = 23)
    ...
    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "(Ll;Lm;[I[BIIII)V", line = 34)
