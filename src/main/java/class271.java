...
public class class271 extends class336 {
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Ltl;I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ZLhu;)V", line = 275)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Z)Ltl;", line = 312)
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(II)Z", line = 366)
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(Lhu;)V", line = 404)
    ...
    @OriginalMember(owner = "client!ra", name = "c", descriptor = "(II)Z", line = 385)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(BLtl;)Lnc;", line = 488)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IIII[I)V", line = 524)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ZB)V", line = 552)
    ...
    @OriginalMember(owner = "client!ra", name = "d", descriptor = "(II)I", line = 572)
