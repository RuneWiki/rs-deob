...
public class class271 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(I)I", line = 8)
    ...
    @OriginalMember(owner = "client!qg", name = "toString", descriptor = "()Ljava/lang/String;", line = 23)
    public final String toString() {
        field3548++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(ILfn;ZIIBLmv;)V", line = 32)
    ...
    @OriginalMember(owner = "client!qg", name = "b", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 64)
