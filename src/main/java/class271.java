...
public class class271 extends OutputStream {
    ...
    @OriginalMember(owner = "client!il", name = "write", descriptor = "(I)V", line = 3)
    public final void write(int arg0) throws IOException {
        field3846++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!il", name = "a", descriptor = "(BILaj;I)V", line = 13)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Ljava/lang/String;IC)I", line = 81)
