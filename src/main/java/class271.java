...
public class class271 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "([BI)[B", line = 5)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(II)I", line = 73)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(BI)I", line = 115)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(I[BBI)I", line = 134)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(B)V", line = 156)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IIILhfa;Lhfa;)V", line = 172)
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(II)V", line = 210)
