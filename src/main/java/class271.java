...
public class class271 extends class389 implements class203 {
    ...
    @OriginalMember(owner = "client!ba", name = "<init>", descriptor = "(Lhd;ILjava/nio/ByteBuffer;)V", line = 4)
    public class271(class17 arg0, int arg1, ByteBuffer arg2) {
        super(arg0, arg2);
        this.field3647 = arg1;
    }

    @OriginalMember(owner = "client!ba", name = "b", descriptor = "(Lrs;)V", line = 9)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(I[BI)V", line = 12)
    public final void method821(int arg0, byte[] arg1, int arg2) {
        this.method2402(arg1, arg2);
        this.field3647 = arg0;
    }

    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Lrs;)V", line = 16)
    ...
    @OriginalMember(owner = "client!ba", name = "<init>", descriptor = "(Lhd;I[BI)V", line = 19)
    public class271(class17 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field3647 = arg1;
    }

    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(ILrs;)V", line = 23)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "()I", line = 27)
    public final int method353() {
        return 0;
    }

    @OriginalMember(owner = "client!ba", name = "c", descriptor = "(Lrs;)V", line = 30)
