...
public class class271 extends class10 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(ZLok;)V", line = 15)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IIZ)Lvl;", line = 55)
    ...
    @OriginalMember(owner = "client!br", name = "b", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(II)Lgh;", line = 83)
    ...
    @OriginalMember(owner = "client!br", name = "b", descriptor = "(B)Ldl;", line = 108)
    ...
    @OriginalMember(owner = "client!br", name = "b", descriptor = "(Z)I", line = 120)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(ILdl;Ldl;F)Z", line = 131)
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Lda;I)V", line = 340)
