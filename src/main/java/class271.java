...
public class class271 {
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Lgk;I)V")
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IILeo;B)V")
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(BLgk;)V")
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Lgk;BI)V")
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Lgk;Z)V")
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Lgk;ILiv;)V")
