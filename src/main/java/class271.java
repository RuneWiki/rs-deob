...
public class class271 implements class630 {
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(IIIBI)V", line = 11)
    ...
    @OriginalMember(owner = "client!ida", name = "b", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(I)Lag;", line = 50)
    ...
    @OriginalMember(owner = "client!ida", name = "<init>", descriptor = "(ILvfa;Lrq;IIIIIIIZ)V", line = 72)
