...
public class class271 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(I[III)Lck;", line = 10)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Lem;II)Ljava/lang/String;", line = 50)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Z)V", line = 74)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(I[II)Lck;", line = 86)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(II[II)Lck;", line = 109)
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(I[II)Lck;", line = 149)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(B)[Lwa;", line = 173)
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Lmg;Lmg;)V", line = 199)
