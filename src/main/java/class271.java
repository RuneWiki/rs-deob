...
public class class271 {
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(II)Lhs;")
    ...
    @OriginalMember(owner = "client!sda", name = "b", descriptor = "(II)Lkl;")
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(III)Lqj;")
    ...
    @OriginalMember(owner = "client!sda", name = "<init>", descriptor = "(Lto;ILla;Lla;Lla;)V")
