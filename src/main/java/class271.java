...
public class class271 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IBLae;)Z")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IIIIIIIILae;I)V")
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(I[Lap;IIII)V")
