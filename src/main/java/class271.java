...
public class class271 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "(I)Ljda;", line = 17)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(B)Ljda;", line = 38)
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "(B)Ljda;", line = 63)
    ...
    @OriginalMember(owner = "client!cp", name = "c", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!cp", name = "d", descriptor = "(I)I", line = 110)
    ...
    @OriginalMember(owner = "client!cp", name = "e", descriptor = "(I)Z", line = 130)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(Ljda;I)V", line = 144)
    ...
    @OriginalMember(owner = "client!cp", name = "f", descriptor = "(I)Ljda;", line = 161)
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "()V", line = 192)
    public class271() {
