...
public class class271 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(ZI)Z", line = 19)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(II)I", line = 30)
    public static final int method1867(int arg0, int arg1) {
        field4280++;
        return arg1 == 255 ? arg0 & 0xFF : 81;
    }

    @OriginalMember(owner = "client!mo", name = "toString", descriptor = "()Ljava/lang/String;", line = 49)
    public final String toString() {
        field4284++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(II)V", line = 59)
