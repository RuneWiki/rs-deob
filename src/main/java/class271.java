...
public class class271 implements class758 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(ZI)V", line = 20)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lig;I)V", line = 59)
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "(Loh;Loh;Lk;)V", line = 100)
