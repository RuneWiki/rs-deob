...
public abstract class class271 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(II)I", line = 17)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IIZ)V", line = 52)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IBI)V", line = 96)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(ZI)Z", line = 142)
