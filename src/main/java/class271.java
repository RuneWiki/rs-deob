...
public abstract class class271 extends class49 {
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lmd;I)I", line = 23)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IIIIII)V", line = 60)
