...
public class class271 extends class312 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 33)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IFIFI[FIIFFI)V", line = 45)
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "(I)V", line = 186)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(BIZLvb;ZILvb;)I", line = 155)
