...
public class class271 extends class438 implements class3 {
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "(Lha;Ltk;IIIIIZIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(B)Z", line = 14)
    ...
    @OriginalMember(owner = "client!uk", name = "f", descriptor = "(B)Z", line = 26)
    ...
    @OriginalMember(owner = "client!uk", name = "f", descriptor = "(I)Z", line = 37)
    ...
    @OriginalMember(owner = "client!uk", name = "b", descriptor = "(I)I", line = 49)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IILvf;I[BZIZ)Lub;", line = 70)
    ...
    @OriginalMember(owner = "client!uk", name = "b", descriptor = "(B)I", line = 89)
    ...
    @OriginalMember(owner = "client!uk", name = "c", descriptor = "(B)I", line = 101)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IIILha;)Z", line = 126)
    ...
    @OriginalMember(owner = "client!uk", name = "b", descriptor = "(Lha;B)Lrga;", line = 142)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lha;B)Lkv;", line = 154)
    ...
    @OriginalMember(owner = "client!uk", name = "e", descriptor = "(B)I", line = 206)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(ILdq;)V", line = 218)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(BLha;)V", line = 231)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lrda;ZZ)V", line = 255)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(ILha;)V", line = 289)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lha;I)V", line = 300)
    ...
    @OriginalMember(owner = "client!uk", name = "g", descriptor = "(I)I", line = 312)
