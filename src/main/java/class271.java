...
public class class271 {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(ILfca;)Llp;", line = 19)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(BLjda;)I", line = 58)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Ljava/awt/Component;BZ)Ltba;", line = 86)
