...
public class class271 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lko;I)V", line = 17)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(ILjava/lang/Throwable;Ljava/lang/String;)V", line = 64)
