...
public class class271 extends class161 {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(ILjd;III)V", line = 13)
    ...
    @OriginalMember(owner = "client!wi", name = "d", descriptor = "(I)V", line = 177)
    ...
    @OriginalMember(owner = "client!wi", name = "e", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(II)V", line = 227)
