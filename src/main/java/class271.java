...
public class class271 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Lya;[II)V")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Lya;[IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Lya;[II[I[I)V")
