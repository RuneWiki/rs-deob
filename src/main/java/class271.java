...
public class class271 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(IB)Lkg;", line = 7)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(JB)V", line = 34)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/Class;", line = 120)
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "(IIII)V", line = 158)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(BI)[B", line = 173)
