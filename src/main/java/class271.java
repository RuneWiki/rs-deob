...
public class class271 extends class155 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Lea;JB)V")
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Lea;Lac;III)V")
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "(Lrg;)V")
