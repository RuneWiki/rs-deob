...
public class class271 {
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Lnr;IILao;III[[[B[I[I[I[I[IIBIIZ)V", line = 33)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(BLjava/lang/Throwable;)Ljava/lang/String;", line = 222)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(B)V", line = 306)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(I)V", line = 344)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IIIII)V", line = 357)
