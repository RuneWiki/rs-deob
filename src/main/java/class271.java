...
public class class271 extends class319 {
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Z)Lnj;")
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IILha;Ljava/lang/String;ZIII)V")
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(Lwga;IIIIII)V")
