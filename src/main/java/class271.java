...
public class class271 extends class337 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(BILhp;)V")
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Lcg;IIIII)V")
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(ILul;)I")
