...
public class class271 {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(I)Lwo;")
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "([[[Lup;B)V")
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Lwba;BLrl;)Lcw;")
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IILol;)V")
