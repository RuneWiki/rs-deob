...
public class class271 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(I)Llh;", line = 5)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(B)Llh;", line = 40)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "()V", line = 63)
    public class271() {
    }

    @OriginalMember(owner = "client!il", name = "a", descriptor = "(BLoj;)I", line = 66)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IZILha;)V", line = 140)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Lvu;)V", line = 160)
    public class271(class677 arg0) {
        this.field4159 = arg0;
    }

    @OriginalMember(owner = "client!il", name = "b", descriptor = "(I)V", line = 171)
