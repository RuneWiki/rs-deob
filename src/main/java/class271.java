...
public class class271 {
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(II)Z", line = 5)
    ...
    @OriginalMember(owner = "client!fp", name = "toString", descriptor = "()Ljava/lang/String;", line = 18)
    public final String toString() {
        field3837++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(ZIILte;[II)Lrp;", line = 33)
    ...
    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "(I)V", line = 54)
    public class271(int arg0) {
        this.field3838 = arg0;
    }

    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Z)V", line = 80)
