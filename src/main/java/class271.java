...
public class class271 extends class175 {
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "()V", line = 208)
    public class271() {
        super(1, false);
    }

    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(ILdt;Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!pd", name = "g", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(BZ)I", line = 71)
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IB)[[I", line = 126)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(ZI)[I", line = 173)
