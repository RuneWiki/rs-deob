...
public class class271 extends class101 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(ILbba;)V")
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Ldga;I[[B)V")
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(Lct;IIIII)V")
