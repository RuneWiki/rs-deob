...
public class class271 extends class487 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "()Lqp;")
    public final class487 method614() {
        field3919++;
        return null;
    }

    @OriginalMember(owner = "client!es", name = "c", descriptor = "(I)Lbu;")
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(DIZ)Lbu;")
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Lbu;B)V")
    ...
    @OriginalMember(owner = "client!es", name = "c", descriptor = "()Lqp;")
