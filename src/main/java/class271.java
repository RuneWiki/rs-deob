...
public abstract class class271 {
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(IIIII)V", line = 383)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!rn", name = "d", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!rn", name = "e", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(BIII)V", line = 121)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IIIBII)V", line = 300)
