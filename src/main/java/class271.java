...
public class class271 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIIIILqa;Lr;IILaba;IIIII)Lr;", line = 7)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Z)V", line = 218)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(BII)Z", line = 233)
