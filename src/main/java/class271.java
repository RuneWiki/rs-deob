...
public class class271 extends class56 {
    ...
    @OriginalMember(owner = "client!se", name = "c", descriptor = "(I)V", line = 5)
    public static void method1597(int arg0) {
        int var1 = -28 / ((-64 - arg0) / 46);
        field3197 = null;
    }

    @OriginalMember(owner = "client!se", name = "a", descriptor = "(BILes;)V", line = 20)
    ...
    @OriginalMember(owner = "client!se", name = "<init>", descriptor = "()V", line = 74)
    public class271() {
        super(1, false);
    }

    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IB)V", line = 61)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(BI)[[I", line = 78)
