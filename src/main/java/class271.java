...
public class class271 extends class337 {
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(II)V", line = 10)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(III[B)Ljava/lang/String;", line = 24)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!mt", name = "b", descriptor = "(B)Z", line = 88)
    ...
    @OriginalMember(owner = "client!mt", name = "e", descriptor = "(I)V", line = 105)
