...
public class class271 extends Canvas {
    ...
    @OriginalMember(owner = "client!fu", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 5)
    public final void update(Graphics arg0) {
        this.field3763.update(arg0);
        field3765++;
    }

    @OriginalMember(owner = "client!fu", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 15)
    public final void paint(Graphics arg0) {
        field3762++;
        this.field3763.paint(arg0);
    }

    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 23)
    public class271(Component arg0) {
        this.field3763 = arg0;
    }

    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IIII)V", line = 32)
