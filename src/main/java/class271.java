...
public class class271 extends class37 implements class338 {
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(IILqa;I)Z")
    ...
    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "(Lqa;Lus;IIIIIZIIIIIII)V")
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Lqa;Z)V")
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(BLqa;I)Lc;")
    ...
    @OriginalMember(owner = "client!mt", name = "b", descriptor = "(ILqa;)Lfm;")
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(IILqa;Leq;IIZ)V")
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Lqa;I)V")
    public final void method340(class162 arg0, int arg1) {
        this.field3567.method2381(arg1 ^ arg1, arg0);
        ++field3566;
    }

    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(ILqa;)V")
