...
public class class54 extends class605 implements class137 {
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIIIIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!da", name = "e", descriptor = "(I)V", line = 15)
    public final void method296(int arg0) {
        this.field620[arg0].method3392();
    }

    @OriginalMember(owner = "client!da", name = "e", descriptor = "()Z", line = 18)
    public final boolean method297() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "d", descriptor = "(Ljava/awt/Canvas;)V", line = 22)
    ...
    @OriginalMember(owner = "client!da", name = "c", descriptor = "(IIIIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II)I", line = 47)
    public final int method300(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II[I[I)Lfa;", line = 50)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIILfa;II)V", line = 54)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II[[I[[IIII)Ld;", line = 57)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lba;Lbe;Lq;Lsda;I)V", line = 63)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIII)Ldw;", line = 80)
    public final class622 method308(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!da", name = "b", descriptor = "(Li;)V", line = 92)
    public final void method314(class35 arg0) {
        this.field599 = (class537) arg0;
        this.method318(arg0);
    }

    @OriginalMember(owner = "client!da", name = "g", descriptor = "()V", line = 99)
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "(IIIIII)V", line = 111)
    ...
    @OriginalMember(owner = "client!da", name = "x", descriptor = "()Z", line = 117)
    public final boolean method322() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Z)V", line = 119)
    public final void method323(boolean arg0) {
    }

    @OriginalMember(owner = "client!da", name = "C", descriptor = "()I", line = 122)
    public final int method324() {
        return 4;
    }

    @OriginalMember(owner = "client!da", name = "j", descriptor = "()Z", line = 126)
    public final boolean method325() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lor;IIII)Lba;", line = 129)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Lba;Lbe;Lq;[Lsda;I)V", line = 133)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lcq;[Laf;Z)Lta;", line = 178)
    ...
    @OriginalMember(owner = "client!da", name = "h", descriptor = "()Lnl;", line = 217)
    public final class479 method330() {
        return new class479(0, "SSE", 1, "CPU", 0L);
    }

    @OriginalMember(owner = "client!da", name = "r", descriptor = "()Z", line = 220)
    public final boolean method331() {
        return false;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIII)V", line = 222)
    public final void method332(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!da", name = "D", descriptor = "()Z", line = 226)
    public final boolean method334() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "A", descriptor = "()Z", line = 229)
    public final boolean method335() {
        return false;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "()Lq;", line = 233)
    public final class364 method337() {
        return new class532();
    }

    @OriginalMember(owner = "client!da", name = "q", descriptor = "()V", line = 236)
    ...
    @OriginalMember(owner = "client!da", name = "E", descriptor = "()Lt;", line = 248)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I[Loj;)V", line = 261)
    ...
    @OriginalMember(owner = "client!da", name = "f", descriptor = "()Z", line = 279)
    public final boolean method341() {
        return false;
    }

    @OriginalMember(owner = "client!da", name = "p", descriptor = "()Lq;", line = 282)
    public final class364 method342() {
        return this.field613;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "([IIIII)Lxa;", line = 286)
    ...
    @OriginalMember(owner = "client!da", name = "d", descriptor = "(I)V", line = 324)
    public final void method345(int arg0) {
        this.field620[arg0].method3387();
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIF)Loj;", line = 327)
    ...
    @OriginalMember(owner = "client!da", name = "c", descriptor = "(Ljava/awt/Canvas;)V", line = 332)
    ...
    @OriginalMember(owner = "client!da", name = "h", descriptor = "(I)V", line = 341)
    ...
    @OriginalMember(owner = "client!da", name = "m", descriptor = "()V", line = 354)
    public final void method349() {
    }

    @OriginalMember(owner = "client!da", name = "t", descriptor = "()V", line = 356)
    public final void method350() {
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIII)V", line = 360)
    ...
    @OriginalMember(owner = "client!da", name = "qa", descriptor = "(S)Z", line = 364)
    ...
    @OriginalMember(owner = "client!da", name = "z", descriptor = "()V", line = 374)
    public final void method354() {
    }

    @OriginalMember(owner = "client!da", name = "g", descriptor = "(I)Li;", line = 378)
    ...
    @OriginalMember(owner = "client!da", name = "i", descriptor = "()Z", line = 384)
    public final boolean method356() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 388)
    ...
    @OriginalMember(owner = "client!da", name = "s", descriptor = "()V", line = 402)
    ...
    @OriginalMember(owner = "client!da", name = "l", descriptor = "()Z", line = 407)
    public final boolean method359() {
        return false;
    }

    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Ljava/awt/Canvas;Le;)V", line = 770)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 414)
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "()V", line = 428)
    public final void method362() {
    }

    @OriginalMember(owner = "client!da", name = "d", descriptor = "()Z", line = 433)
    public final boolean method363() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "HA", descriptor = "()Ljava/lang/Object;", line = 438)
    private final Object method366() {
        return new class312(this);
    }

    @OriginalMember(owner = "client!da", name = "o", descriptor = "()V", line = 441)
    ...
    @OriginalMember(owner = "client!da", name = "w", descriptor = "()Z", line = 474)
    public final boolean method370() {
        return false;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ldw;Ldw;FLdw;)Ldw;", line = 477)
    public final class622 method371(class622 arg0, class622 arg1, float arg2, class622 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!da", name = "d", descriptor = "(S)Z", line = 488)
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "(Z)V", line = 511)
    public final void method378(boolean arg0) {
    }

    @OriginalMember(owner = "client!da", name = "c", descriptor = "()V", line = 513)
    public final void method379() {
    }

    @OriginalMember(owner = "client!da", name = "f", descriptor = "(I)V", line = 516)
    public final void method380(int arg0) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lq;)V", line = 521)
    public final void method382(class364 arg0) {
        this.field616 = arg0;
        this.method336(arg0);
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 525)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Lba;Lq;[Lsda;I)V", line = 536)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lbe;Z)V", line = 556)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(FFF)V", line = 589)
    public final void method387(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Laf;Z)Lxa;", line = 593)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIZ)Lxa;", line = 669)
    ...
    @OriginalMember(owner = "client!da", name = "n", descriptor = "()Z", line = 676)
    public final boolean method390() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ldw;)V", line = 682)
    public final void method392(class622 arg0) {
    }

    @OriginalMember(owner = "client!da", name = "y", descriptor = "()Z", line = 699)
    public final boolean method395() {
        return false;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lbe;)V", line = 702)
    ...
    @OriginalMember(owner = "client!da", name = "u", descriptor = "()Z", line = 708)
    public final boolean method398() {
        return false;
    }

    @OriginalMember(owner = "client!da", name = "B", descriptor = "()Z", line = 711)
    public final boolean method399() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I)V", line = 715)
    ...
    @OriginalMember(owner = "client!da", name = "c", descriptor = "(Z)V", line = 739)
