...
public class class54 {
    ...
    @OriginalMember(owner = "client!SMJSOFHG", name = "a", descriptor = "(LFHVZVKRA;ZLBJPWOXRJ;)V")
    ...
    @OriginalMember(owner = "client!SMJSOFHG", name = "a", descriptor = "(I[BII[LHUQCCBIO;LHFOJZUJK;)V")
    ...
    @OriginalMember(owner = "client!SMJSOFHG", name = "a", descriptor = "(IIZIIILHFOJZUJK;ILHUQCCBIO;)V")
    ...
    @OriginalMember(owner = "client!SMJSOFHG", name = "a", descriptor = "(IIILHUQCCBIO;IIIZ[[[ILHFOJZUJK;I)V")
    ...
    @OriginalMember(owner = "client!SMJSOFHG", name = "a", descriptor = "(LHFOJZUJK;I[LHUQCCBIO;)V")
