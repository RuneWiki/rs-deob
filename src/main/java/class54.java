...
public class class54 {
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(IBLkk;)V", line = 8)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(I)Z", line = 88)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(B)Lqi;", line = 121)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Lkk;B)V", line = 179)
    ...
    @OriginalMember(owner = "client!sl", name = "b", descriptor = "(B)Z", line = 205)
    ...
    @OriginalMember(owner = "client!sl", name = "b", descriptor = "(I)Lqi;", line = 232)
    ...
    @OriginalMember(owner = "client!sl", name = "c", descriptor = "(B)V", line = 297)
