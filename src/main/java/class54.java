...
public class class54 extends class319 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(II)I", line = 35)
    ...
    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "(IIIIIFFF)V", line = 82)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IIB)V", line = 93)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IIBI)V", line = 107)
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(III)V", line = 135)
    ...
    @OriginalMember(owner = "client!mq", name = "c", descriptor = "(I)V", line = 178)
