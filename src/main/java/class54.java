...
public class class54 implements class32 {
    ...
    @OriginalMember(owner = "client!gja", name = "f", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(II)V", line = 24)
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(ILkm;BI)V", line = 38)
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(Lqba;III)V", line = 69)
    ...
    @OriginalMember(owner = "client!gja", name = "e", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!gja", name = "b", descriptor = "(B)Z", line = 119)
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!gja", name = "b", descriptor = "(II)V", line = 153)
    ...
    @OriginalMember(owner = "client!gja", name = "b", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!gja", name = "<init>", descriptor = "(Lqfa;)V", line = 533)
    ...
    @OriginalMember(owner = "client!gja", name = "d", descriptor = "(I)V", line = 187)
    ...
    @OriginalMember(owner = "client!gja", name = "g", descriptor = "(I)V", line = 200)
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(Z)V", line = 213)
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(Lqba;BIII)V", line = 415)
    ...
    @OriginalMember(owner = "client!gja", name = "finalize", descriptor = "()V", line = 448)
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(Lkm;II)V", line = 457)
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(BILmw;)V", line = 477)
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(IB)I", line = 511)
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 523)
    ...
    @OriginalMember(owner = "client!gja", name = "c", descriptor = "(I)V", line = 547)
    ...
    @OriginalMember(owner = "client!gja", name = "b", descriptor = "(IB)V", line = 560)
