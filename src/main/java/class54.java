...
public class class54 {
    ...
    @OriginalMember(owner = "client!OWNYSRQV", name = "b", descriptor = "LOWNYSRQV;")
    public class54 field1299;

    @OriginalMember(owner = "client!OWNYSRQV", name = "c", descriptor = "LOWNYSRQV;")
    public class54 field1300;

    @OriginalMember(owner = "client!OWNYSRQV", name = "d", descriptor = "Z")
