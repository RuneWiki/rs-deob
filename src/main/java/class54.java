...
public class class54 {
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(ILgj;)V")
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(Lgj;ZLjava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(Lka;I)V")
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(BLgj;ILjava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(IILsa;II)V")
    ...
    @OriginalMember(owner = "client!gea", name = "b", descriptor = "(ILgj;)Ljava/lang/Object;")
