...
public class class54 extends class393 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(III)Z", line = 16)
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "()V", line = 57)
    public class54() {
    }

    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 60)
