...
public class class54 extends class219 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(I)J", line = 48)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Z)J", line = 86)
