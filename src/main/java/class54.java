...
public class class54 extends class435 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Lja;J)Z")
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Lja;[Loo;Z)V")
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Lja;J[Loo;[Lbo;Z)V")
    ...
    @OriginalMember(owner = "client!bl", name = "d", descriptor = "()Lhe;")
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "([Lbo;Z)V")
