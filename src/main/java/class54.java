...
public class class54 extends class107 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lhn;IIII)Lba;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(II[[I[[IIII)Ld;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lcq;IIII)V")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "([Lba;Lhfa;Lq;[Lrc;I)V")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Ljava/lang/Runnable;)Lvd;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "([Lba;Lq;[Lrc;I)V")
    ...
    @OriginalMember(owner = "client!ha", name = "<init>", descriptor = "(Ljava/awt/Canvas;Le;)V")
