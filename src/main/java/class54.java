...
public class class54 extends class129 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(CIIIZLsf;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(Lse;Lvn;[Lok;Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(CIIIZ)V", line = 258)
