...
public class class54 {
    ...
    @OriginalMember(owner = "client!mk", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 29)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IILjava/lang/String;)V", line = 40)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(II)I", line = 61)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(I)[Ljava/lang/String;", line = 96)
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(IZ)V", line = 189)
    public class54(int arg0, boolean arg1) {
        this.field613 = arg0;
        this.field612 = arg1;
    }

    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IIBII)I", line = 130)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IIIILha;I)V", line = 147)
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(II)V", line = 171)
