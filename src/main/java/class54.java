...
public class class54 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(II)Lub;")
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(BLms;II)V")
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(Ldk;ILfc;)V")
