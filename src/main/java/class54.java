...
@OriginalClass("client!TKIWGAGO")
public class class54 extends class12 {

    @OriginalMember(owner = "client!TKIWGAGO", name = "qb", descriptor = "Z")
    public boolean field1342 = false;

    @OriginalMember(owner = "client!TKIWGAGO", name = "rb", descriptor = "B")
    private byte field1343 = 0;

    @OriginalMember(owner = "client!TKIWGAGO", name = "sb", descriptor = "B")
    private byte field1344 = -125;

    @OriginalMember(owner = "client!TKIWGAGO", name = "Ab", descriptor = "B")
    private byte field1352 = 55;

    @OriginalMember(owner = "client!TKIWGAGO", name = "Bb", descriptor = "I")
    private int field1353 = -630;

    @OriginalMember(owner = "client!TKIWGAGO", name = "Cb", descriptor = "[I")
    public int[] field1354 = new int[5];

    @OriginalMember(owner = "client!TKIWGAGO", name = "Db", descriptor = "J")
    public long field1355 = -1L;

    @OriginalMember(owner = "client!TKIWGAGO", name = "Fb", descriptor = "I")
    private int field1357 = 123;

    @OriginalMember(owner = "client!TKIWGAGO", name = "Gb", descriptor = "Z")
    private boolean field1358 = false;

    @OriginalMember(owner = "client!TKIWGAGO", name = "Lb", descriptor = "Z")
    public boolean field1363 = false;

    @OriginalMember(owner = "client!TKIWGAGO", name = "Rb", descriptor = "[I")
    public int[] field1369 = new int[12];

    @OriginalMember(owner = "client!TKIWGAGO", name = "Sb", descriptor = "LGOPFMRDJ;")
    public static class22 field1370 = new class22(639, 260);

    @OriginalMember(owner = "client!TKIWGAGO", name = "tb", descriptor = "I")
    public int field1345;

    @OriginalMember(owner = "client!TKIWGAGO", name = "ub", descriptor = "I")
    public int field1346;

    @OriginalMember(owner = "client!TKIWGAGO", name = "vb", descriptor = "I")
    public int field1347;

    @OriginalMember(owner = "client!TKIWGAGO", name = "wb", descriptor = "I")
    public int field1348;

    @OriginalMember(owner = "client!TKIWGAGO", name = "xb", descriptor = "I")
    public int field1349;

    @OriginalMember(owner = "client!TKIWGAGO", name = "yb", descriptor = "I")
    public int field1350;

    @OriginalMember(owner = "client!TKIWGAGO", name = "zb", descriptor = "I")
    public int field1351;

    @OriginalMember(owner = "client!TKIWGAGO", name = "Hb", descriptor = "I")
    public int field1359;

    @OriginalMember(owner = "client!TKIWGAGO", name = "Jb", descriptor = "I")
    public int field1361;

    @OriginalMember(owner = "client!TKIWGAGO", name = "Kb", descriptor = "I")
    public int field1362;

    @OriginalMember(owner = "client!TKIWGAGO", name = "Mb", descriptor = "I")
    public int field1364;

    @OriginalMember(owner = "client!TKIWGAGO", name = "Nb", descriptor = "I")
    public int field1365;

    @OriginalMember(owner = "client!TKIWGAGO", name = "Ob", descriptor = "I")
    ...
    @OriginalMember(owner = "client!TKIWGAGO", name = "Qb", descriptor = "J")
    public long field1368;

    @OriginalMember(owner = "client!TKIWGAGO", name = "Eb", descriptor = "LFWGUGZKU;")
    public class19 field1356;

    @OriginalMember(owner = "client!TKIWGAGO", name = "Pb", descriptor = "LITSMSHJO;")
    public class27 field1367;

    @OriginalMember(owner = "client!TKIWGAGO", name = "Ib", descriptor = "Ljava/lang/String;")
    public String field1360;

    @OriginalMember(owner = "client!TKIWGAGO", name = "b", descriptor = "(Z)Z")
    ...
    @OriginalMember(owner = "client!TKIWGAGO", name = "a", descriptor = "(B)LITSMSHJO;")
    ...
    @OriginalMember(owner = "client!TKIWGAGO", name = "b", descriptor = "(I)LITSMSHJO;")
    ...
    @OriginalMember(owner = "client!TKIWGAGO", name = "a", descriptor = "(Z)LITSMSHJO;")
    ...
    @OriginalMember(owner = "client!TKIWGAGO", name = "a", descriptor = "(LXQPFGONL;Z)V")
