...
public class class54 extends class166 {
    ...
    @OriginalMember(owner = "client!vg", name = "e", descriptor = "(B)Lho;")
    ...
    @OriginalMember(owner = "client!vg", name = "l", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!vg", name = "<init>", descriptor = "(ILvd;I)V")
