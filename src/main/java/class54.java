...
public class class54 extends class120 implements class142 {
    ...
    @OriginalMember(owner = "client!u", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(B)J", line = 15)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IIIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IB[BI)V", line = 55)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(I)I", line = 68)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Z)I", line = 88)
    public final int method456(boolean arg0) {
        ++field691;
        return arg0 ? 44 : super.field1650;
    }

    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "(Lih;I[BIZ)V", line = 100)
    public class54(class503 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34963, arg2, arg3, arg4);
        this.field693 = arg1;
    }

    @OriginalMember(owner = "client!u", name = "c", descriptor = "(B)V", line = 108)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(BI)V", line = 118)
