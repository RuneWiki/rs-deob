...
public class class54 {
    ...
    @OriginalMember(owner = "client!VLLJSJTJ", name = "f", descriptor = "LWWONSPNF;")
    public class62 field1451 = new class62();

    @OriginalMember(owner = "client!VLLJSJTJ", name = "g", descriptor = "LWWONSPNF;")
    ...
    @OriginalMember(owner = "client!VLLJSJTJ", name = "a", descriptor = "(LWWONSPNF;)V")
    ...
    @OriginalMember(owner = "client!VLLJSJTJ", name = "a", descriptor = "(ILWWONSPNF;)V")
    ...
    @OriginalMember(owner = "client!VLLJSJTJ", name = "a", descriptor = "()LWWONSPNF;")
    ...
    @OriginalMember(owner = "client!VLLJSJTJ", name = "b", descriptor = "()LWWONSPNF;")
    ...
    @OriginalMember(owner = "client!VLLJSJTJ", name = "a", descriptor = "(I)LWWONSPNF;")
    ...
    @OriginalMember(owner = "client!VLLJSJTJ", name = "a", descriptor = "(Z)LWWONSPNF;")
    ...
    @OriginalMember(owner = "client!VLLJSJTJ", name = "b", descriptor = "(I)LWWONSPNF;")
