...
public class class54 extends class362 {
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(IB)V", line = 5)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!gda", name = "<init>", descriptor = "(IIIIIZ)V", line = 60)
