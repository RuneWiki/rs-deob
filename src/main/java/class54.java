...
public class class54 {
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "([Lov;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(ILjava/lang/String;I[Lit;)I", line = 41)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(ILjava/lang/String;)I", line = 66)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "([Lit;Ljava/lang/String;I)I", line = 86)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(IZ)I", line = 192)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 206)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "([II[Lit;Ljava/lang/String;[Ljava/lang/String;)I", line = 220)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(I[Lit;ILjava/lang/String;I)I", line = 474)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(IILjava/lang/String;[Lit;)Ljava/lang/String;", line = 495)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(I)V", line = 619)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(ICI)I", line = 632)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(ILjava/lang/String;B[Lit;)I", line = 656)
    ...
    @OriginalMember(owner = "client!pia", name = "<init>", descriptor = "([B)V", line = 666)
