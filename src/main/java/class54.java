...
public class class54 extends class69 {
    ...
    @OriginalMember(owner = "client!TVKIEQYR", name = "rb", descriptor = "LZNUYRYPY;")
    public class71 field1359;

    @OriginalMember(owner = "client!TVKIEQYR", name = "a", descriptor = "(I)LHEQROJXW;")
    ...
    @OriginalMember(owner = "client!TVKIEQYR", name = "a", descriptor = "(B)LHEQROJXW;")
