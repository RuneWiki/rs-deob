...
@OriginalClass("client!UUFZOKXH")
public class class54 extends class43 implements Runnable {

    @OriginalMember(owner = "client!UUFZOKXH", name = "a", descriptor = "Z")
    private boolean field1320 = true;

    @OriginalMember(owner = "client!UUFZOKXH", name = "b", descriptor = "[[B")
    private byte[][] field1321 = new byte[4][];

    @OriginalMember(owner = "client!UUFZOKXH", name = "d", descriptor = "Z")
    private boolean field1323 = false;

    @OriginalMember(owner = "client!UUFZOKXH", name = "g", descriptor = "Z")
    private boolean field1326 = false;

    @OriginalMember(owner = "client!UUFZOKXH", name = "j", descriptor = "I")
    private int field1329 = 357;

    @OriginalMember(owner = "client!UUFZOKXH", name = "k", descriptor = "Ljava/util/zip/CRC32;")
    private CRC32 field1330 = new CRC32();

    @OriginalMember(owner = "client!UUFZOKXH", name = "l", descriptor = "LYLURZVWU;")
    private class65 field1331 = new class65((byte) 52);

    @OriginalMember(owner = "client!UUFZOKXH", name = "n", descriptor = "Ljava/lang/String;")
    public String field1333 = "";

    @OriginalMember(owner = "client!UUFZOKXH", name = "q", descriptor = "LYLURZVWU;")
    private class65 field1336 = new class65((byte) 52);

    @OriginalMember(owner = "client!UUFZOKXH", name = "v", descriptor = "[B")
    private byte[] field1341 = new byte[500];

    @OriginalMember(owner = "client!UUFZOKXH", name = "z", descriptor = "I")
    private int field1345 = 7;

    @OriginalMember(owner = "client!UUFZOKXH", name = "C", descriptor = "LXWKFKQRL;")
    private class63 field1348 = new class63(false);

    @OriginalMember(owner = "client!UUFZOKXH", name = "F", descriptor = "[[I")
    private int[][] field1351 = new int[4][];

    @OriginalMember(owner = "client!UUFZOKXH", name = "H", descriptor = "I")
    private int field1353 = 884;

    @OriginalMember(owner = "client!UUFZOKXH", name = "I", descriptor = "LYLURZVWU;")
    private class65 field1354 = new class65((byte) 52);

    @OriginalMember(owner = "client!UUFZOKXH", name = "J", descriptor = "[B")
    private byte[] field1355 = new byte[65000];

    @OriginalMember(owner = "client!UUFZOKXH", name = "L", descriptor = "LYLURZVWU;")
    private class65 field1357 = new class65((byte) 52);

    @OriginalMember(owner = "client!UUFZOKXH", name = "M", descriptor = "[[I")
    private int[][] field1358 = new int[4][];

    @OriginalMember(owner = "client!UUFZOKXH", name = "P", descriptor = "LYLURZVWU;")
    private class65 field1361 = new class65((byte) 52);

    @OriginalMember(owner = "client!UUFZOKXH", name = "e", descriptor = "I")
    ...
    @OriginalMember(owner = "client!UUFZOKXH", name = "i", descriptor = "I")
    private int field1328;

    @OriginalMember(owner = "client!UUFZOKXH", name = "m", descriptor = "I")
    private int field1332;

    @OriginalMember(owner = "client!UUFZOKXH", name = "o", descriptor = "I")
    public int field1334;

    @OriginalMember(owner = "client!UUFZOKXH", name = "p", descriptor = "I")
    private int field1335;

    @OriginalMember(owner = "client!UUFZOKXH", name = "t", descriptor = "I")
    private int field1339;

    @OriginalMember(owner = "client!UUFZOKXH", name = "u", descriptor = "I")
    private int field1340;

    @OriginalMember(owner = "client!UUFZOKXH", name = "A", descriptor = "I")
    private int field1346;

    @OriginalMember(owner = "client!UUFZOKXH", name = "E", descriptor = "I")
    private int field1350;

    @OriginalMember(owner = "client!UUFZOKXH", name = "K", descriptor = "I")
    private int field1356;

    @OriginalMember(owner = "client!UUFZOKXH", name = "B", descriptor = "J")
    private long field1347;

    @OriginalMember(owner = "client!UUFZOKXH", name = "c", descriptor = "LNCZPZCRJ;")
    private class36 field1322;

    @OriginalMember(owner = "client!UUFZOKXH", name = "x", descriptor = "Lclient;")
    private client field1343;

    @OriginalMember(owner = "client!UUFZOKXH", name = "s", descriptor = "Ljava/io/InputStream;")
    private InputStream field1338;

    @OriginalMember(owner = "client!UUFZOKXH", name = "G", descriptor = "Ljava/io/OutputStream;")
    private OutputStream field1352;

    @OriginalMember(owner = "client!UUFZOKXH", name = "N", descriptor = "Ljava/net/Socket;")
    private Socket field1359;

    @OriginalMember(owner = "client!UUFZOKXH", name = "r", descriptor = "[B")
    private byte[] field1337;

    @OriginalMember(owner = "client!UUFZOKXH", name = "w", descriptor = "[I")
    private int[] field1342;

    @OriginalMember(owner = "client!UUFZOKXH", name = "y", descriptor = "[I")
    private int[] field1344;

    @OriginalMember(owner = "client!UUFZOKXH", name = "D", descriptor = "[I")
    private int[] field1349;

    @OriginalMember(owner = "client!UUFZOKXH", name = "O", descriptor = "[I")
    private int[] field1360;

    @OriginalMember(owner = "client!UUFZOKXH", name = "Q", descriptor = "[I")
    private int[] field1362;

    @OriginalMember(owner = "client!UUFZOKXH", name = "R", descriptor = "[I")
    private int[] field1363;

    @OriginalMember(owner = "client!UUFZOKXH", name = "a", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!UUFZOKXH", name = "b", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!UUFZOKXH", name = "a", descriptor = "(IIII)I")
    ...
    @OriginalMember(owner = "client!UUFZOKXH", name = "run", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!UUFZOKXH", name = "a", descriptor = "(II)Z")
    ...
    @OriginalMember(owner = "client!UUFZOKXH", name = "c", descriptor = "(I)I")
    ...
    @OriginalMember(owner = "client!UUFZOKXH", name = "a", descriptor = "(ZI)V")
    ...
    @OriginalMember(owner = "client!UUFZOKXH", name = "b", descriptor = "()V")
    public final void method440() {
        this.field1320 = false;
    }

    @OriginalMember(owner = "client!UUFZOKXH", name = "a", descriptor = "(IIZ)V")
    ...
    @OriginalMember(owner = "client!UUFZOKXH", name = "d", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!UUFZOKXH", name = "a", descriptor = "(IBII)V")
    ...
    @OriginalMember(owner = "client!UUFZOKXH", name = "c", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!UUFZOKXH", name = "a", descriptor = "(IB)Z")
    ...
    @OriginalMember(owner = "client!UUFZOKXH", name = "a", descriptor = "(ILNCZPZCRJ;)V")
    ...
    @OriginalMember(owner = "client!UUFZOKXH", name = "a", descriptor = "(I[BII)Z")
    ...
    @OriginalMember(owner = "client!UUFZOKXH", name = "a", descriptor = "(LOTSGNSQM;Lclient;)V")
    ...
    @OriginalMember(owner = "client!UUFZOKXH", name = "c", descriptor = "(II)V")
