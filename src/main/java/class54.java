...
public class class54 extends class499 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IBI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(BIII[I)Z", line = 28)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(II[II)Z", line = 56)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "([IIBI)Z", line = 83)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IIIIIIIII)V", line = 110)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IIIII)V", line = 123)
    ...
    @OriginalMember(owner = "client!kl", name = "d", descriptor = "(B)V", line = 135)
    ...
    @OriginalMember(owner = "client!kl", name = "e", descriptor = "(B)V", line = 156)
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 262)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(I)V", line = 213)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IZ)Z", line = 231)
