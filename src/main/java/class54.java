...
public class class54 extends class223 {
    ...
    @OriginalMember(owner = "client!tga", name = "A", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(ILnh;ILjr;I)Lem;", line = 29)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(IZIIILnh;[BI)Lem;", line = 40)
    ...
    @OriginalMember(owner = "client!tga", name = "D", descriptor = "(I)V", line = 49)
    public final void method315(int arg0) {
        this.field696.Clear(1, arg0, 0.0F, 0);
    }

    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(IIILjagdx/IDirect3D;Ljagdx/D3DPRESENT_PARAMETERS;I)Z", line = 58)
    ...
    @OriginalMember(owner = "client!tga", name = "t", descriptor = "()Ltaa;", line = 162)
    ...
    @OriginalMember(owner = "client!tga", name = "o", descriptor = "()V", line = 170)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Lnba;Z)V", line = 199)
    ...
    @OriginalMember(owner = "client!tga", name = "o", descriptor = "(I)V", line = 223)
    ...
    @OriginalMember(owner = "client!tga", name = "o", descriptor = "(B)V", line = 259)
    ...
    @OriginalMember(owner = "client!tga", name = "B", descriptor = "()V", line = 269)
    public final void method322() {
        this.method1272(true, (byte) -84);
        this.field696.Clear(2, 0, 1.0F, 0);
    }

    @OriginalMember(owner = "client!tga", name = "G", descriptor = "(I)V", line = 277)
    ...
    @OriginalMember(owner = "client!tga", name = "ab", descriptor = "(I)Z", line = 288)
    ...
    @OriginalMember(owner = "client!tga", name = "l", descriptor = "()V", line = 327)
    public final void method325() {
    }

    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(ILjava/awt/Canvas;)Ljava/lang/Object;", line = 331)
    ...
    @OriginalMember(owner = "client!tga", name = "w", descriptor = "()V", line = 341)
    public final void method327() {
    }

    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(ILsv;II)V", line = 345)
    ...
    @OriginalMember(owner = "client!tga", name = "h", descriptor = "(Z)V", line = 359)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(BLra;)I", line = 390)
    ...
    @OriginalMember(owner = "client!tga", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/dj;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Lmb;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Le;Lpfa;I)V", line = 1523)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Lff;B)V", line = 424)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Lns;B)I", line = 447)
    ...
    @OriginalMember(owner = "client!tga", name = "s", descriptor = "(B)V", line = 477)
    ...
    @OriginalMember(owner = "client!tga", name = "e", descriptor = "(Z)V", line = 488)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Lte;B)V", line = 498)
    ...
    @OriginalMember(owner = "client!tga", name = "r", descriptor = "()V", line = 521)
    public final void method336() {
    }

    @OriginalMember(owner = "client!tga", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Le;Lpfa;Ljava/lang/Integer;)Loa;", line = 525)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Lvt;Z)V", line = 622)
    ...
    @OriginalMember(owner = "client!tga", name = "b", descriptor = "(ILjr;Lnh;)I", line = 661)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(III[IZII)Lem;", line = 699)
    ...
    @OriginalMember(owner = "client!tga", name = "b", descriptor = "(BZ)Lvl;", line = 709)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(IZ)Lii;", line = 719)
    public final class519 method341(int arg0, boolean arg1) {
        return arg0 < 103 ? (class519) null : new class626(this, arg1);
    }

    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(ILsv;)I", line = 729)
    ...
    @OriginalMember(owner = "client!tga", name = "h", descriptor = "(I)V", line = 764)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(ILbf;)V", line = 780)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 791)
    public final void method345(Rectangle[] arg0, int arg1) throws class202 {
        this.method318();
    }

    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Ljava/awt/Canvas;ILjava/lang/Object;)V", line = 801)
    ...
    @OriginalMember(owner = "client!tga", name = "m", descriptor = "(I)V", line = 810)
    ...
    @OriginalMember(owner = "client!tga", name = "g", descriptor = "(B)V", line = 821)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(II[BBILnh;)Lht;", line = 833)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "([Loc;B)Lbf;", line = 844)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Lip;Lip;FLip;)Lip;", line = 854)
    public final class662 method351(class662 arg0, class662 arg1, float arg2, class662 arg3) {
        return arg2 < 0.5F ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(II[[IZ)Lqca;", line = 861)
    ...
    @OriginalMember(owner = "client!tga", name = "j", descriptor = "(B)V", line = 873)
    public final void method353(byte arg0) {
        int var2 = -4 / ((-arg0 - 23) / 48);
        this.field696.method2470(15, this.field2789);
    }

    @OriginalMember(owner = "client!tga", name = "e", descriptor = "(I)V", line = 881)
    public final synchronized void method354(int arg0) {
        this.field699.method3539((byte) 43);
        super.method354(arg0);
    }

    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(ILjava/lang/Object;Ljava/awt/Canvas;)V", line = 889)
    ...
    @OriginalMember(owner = "client!tga", name = "C", descriptor = "(I)V", line = 900)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(ILjr;Lnh;)Z", line = 914)
    ...
    @OriginalMember(owner = "client!tga", name = "y", descriptor = "(I)V", line = 926)
    ...
    @OriginalMember(owner = "client!tga", name = "c", descriptor = "(I)V", line = 949)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(ILnh;Ljr;)Z", line = 977)
    ...
    @OriginalMember(owner = "client!tga", name = "m", descriptor = "()Z", line = 988)
    public final boolean method361() {
        return false;
    }

    @OriginalMember(owner = "client!tga", name = "A", descriptor = "(B)V", line = 1000)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(IILii;)V", line = 1016)
    ...
    @OriginalMember(owner = "client!tga", name = "n", descriptor = "(I)V", line = 1033)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Lhs;B)I", line = 1044)
    ...
    @OriginalMember(owner = "client!tga", name = "b", descriptor = "(ZB)V", line = 1070)
    ...
    @OriginalMember(owner = "client!tga", name = "i", descriptor = "(I)F", line = 1082)
    public final float method367(int arg0) {
        return arg0 == 10 ? -0.5F : 1.1513916F;
    }

    @OriginalMember(owner = "client!tga", name = "k", descriptor = "(I)V", line = 1096)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Lxa;Z)V", line = 1134)
    public final void method369(class468 arg0, boolean arg1) {
    }

    @OriginalMember(owner = "client!tga", name = "z", descriptor = "(I)V", line = 1137)
    ...
    @OriginalMember(owner = "client!tga", name = "A", descriptor = "(I)V", line = 1174)
    ...
    @OriginalMember(owner = "client!tga", name = "O", descriptor = "(I)V", line = 1210)
    ...
    @OriginalMember(owner = "client!tga", name = "H", descriptor = "(I)V", line = 1220)
    ...
    @OriginalMember(owner = "client!tga", name = "d", descriptor = "()V", line = 1233)
    public final void method374() {
    }

    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(IBIIILsv;Lvl;)V", line = 1238)
    ...
    @OriginalMember(owner = "client!tga", name = "c", descriptor = "(II)V", line = 1255)
    ...
    @OriginalMember(owner = "client!tga", name = "s", descriptor = "(I)V", line = 1265)
    ...
    @OriginalMember(owner = "client!tga", name = "r", descriptor = "(I)V", line = 1296)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(IIII)V", line = 1305)
    public final void method379(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!tga", name = "SA", descriptor = "()I", line = 1308)
    public final int method380() {
        return 0;
    }

    @OriginalMember(owner = "client!tga", name = "p", descriptor = "(I)V", line = 1315)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(IILhs;Z)V", line = 1328)
    ...
    @OriginalMember(owner = "client!tga", name = "d", descriptor = "(B)V", line = 1373)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(IIZLnh;I[FII)Lem;", line = 1382)
    ...
    @OriginalMember(owner = "client!tga", name = "R", descriptor = "(I)V", line = 1392)
    ...
    @OriginalMember(owner = "client!tga", name = "g", descriptor = "(II)Lho;", line = 1402)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(BLjava/awt/Canvas;Ljava/lang/Object;)V", line = 1437)
    ...
    @OriginalMember(owner = "client!tga", name = "b", descriptor = "(Z)V", line = 1461)
    public final void method388(boolean arg0) {
    }

    @OriginalMember(owner = "client!tga", name = "v", descriptor = "(I)V", line = 1464)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(ZLhs;ZII)V", line = 1486)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(FFF)V", line = 1570)
    public final void method391(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!tga", name = "h", descriptor = "()V", line = 1573)
    public final void method392() {
        this.field699.method3538((byte) 111);
        super.method392();
    }

    @OriginalMember(owner = "client!tga", name = "z", descriptor = "()Z", line = 1582)
    public final boolean method393() {
        return false;
    }

    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Lju;B)I", line = 1589)
    ...
    @OriginalMember(owner = "client!tga", name = "h", descriptor = "(B)V", line = 1608)
    ...
    @OriginalMember(owner = "client!tga", name = "KA", descriptor = "(IIII)[I", line = 1627)
