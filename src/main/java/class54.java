...
public class class54 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ILvj;I)V")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(BLvj;)V")
