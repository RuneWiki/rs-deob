...
public abstract class class54 extends class578 {
    ...
    @OriginalMember(owner = "client!ha", name = "d", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ha", name = "g", descriptor = "(I)V", line = 229)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Ljava/lang/String;B)Ljava/lang/String;", line = 244)
