...
public class class54 extends InputStream {
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!gja", name = "read", descriptor = "()I", line = 19)
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(Lkf;ZLda;Lha;ZLjava/lang/String;)V", line = 28)
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(I[BZ)V", line = 128)
