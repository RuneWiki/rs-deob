...
@OriginalClass("client!SSXXGGTR")
public class class54 extends class14 implements Runnable {

    @OriginalMember(owner = "client!SSXXGGTR", name = "a", descriptor = "Ljava/lang/String;")
    public String field1400 = "";

    @OriginalMember(owner = "client!SSXXGGTR", name = "b", descriptor = "Z")
    private boolean field1401 = true;

    @OriginalMember(owner = "client!SSXXGGTR", name = "c", descriptor = "[[I")
    private int[][] field1402 = new int[4][];

    @OriginalMember(owner = "client!SSXXGGTR", name = "i", descriptor = "[[B")
    private byte[][] field1408 = new byte[4][];

    @OriginalMember(owner = "client!SSXXGGTR", name = "k", descriptor = "[B")
    private byte[] field1410 = new byte[65000];

    @OriginalMember(owner = "client!SSXXGGTR", name = "m", descriptor = "LJQOEJEDB;")
    private class25 field1412 = new class25(3);

    @OriginalMember(owner = "client!SSXXGGTR", name = "o", descriptor = "I")
    private int field1414 = 30502;

    @OriginalMember(owner = "client!SSXXGGTR", name = "p", descriptor = "Z")
    private boolean field1415 = true;

    @OriginalMember(owner = "client!SSXXGGTR", name = "q", descriptor = "LJQOEJEDB;")
    private class25 field1416 = new class25(3);

    @OriginalMember(owner = "client!SSXXGGTR", name = "u", descriptor = "[B")
    private byte[] field1420 = new byte[500];

    @OriginalMember(owner = "client!SSXXGGTR", name = "w", descriptor = "I")
    private int field1422 = -158;

    @OriginalMember(owner = "client!SSXXGGTR", name = "x", descriptor = "Z")
    private boolean field1423 = true;

    @OriginalMember(owner = "client!SSXXGGTR", name = "y", descriptor = "LJQOEJEDB;")
    private class25 field1424 = new class25(3);

    @OriginalMember(owner = "client!SSXXGGTR", name = "B", descriptor = "LMMJBXXXO;")
    private class36 field1427 = new class36(field1418);

    @OriginalMember(owner = "client!SSXXGGTR", name = "C", descriptor = "LJQOEJEDB;")
    private class25 field1428 = new class25(3);

    @OriginalMember(owner = "client!SSXXGGTR", name = "H", descriptor = "I")
    ...
    @OriginalMember(owner = "client!SSXXGGTR", name = "R", descriptor = "Ljava/util/zip/CRC32;")
    private CRC32 field1443 = new CRC32();

    @OriginalMember(owner = "client!SSXXGGTR", name = "T", descriptor = "[[I")
    private int[][] field1445 = new int[4][];

    @OriginalMember(owner = "client!SSXXGGTR", name = "e", descriptor = "I")
    private int field1404;

    @OriginalMember(owner = "client!SSXXGGTR", name = "f", descriptor = "I")
    private int field1405;

    @OriginalMember(owner = "client!SSXXGGTR", name = "l", descriptor = "I")
    public int field1411;

    @OriginalMember(owner = "client!SSXXGGTR", name = "r", descriptor = "I")
    private int field1417;

    @OriginalMember(owner = "client!SSXXGGTR", name = "v", descriptor = "I")
    private int field1421;

    @OriginalMember(owner = "client!SSXXGGTR", name = "A", descriptor = "I")
    ...
    @OriginalMember(owner = "client!SSXXGGTR", name = "G", descriptor = "I")
    private int field1432;

    @OriginalMember(owner = "client!SSXXGGTR", name = "I", descriptor = "I")
    public int field1434;

    @OriginalMember(owner = "client!SSXXGGTR", name = "J", descriptor = "I")
    private int field1435;

    @OriginalMember(owner = "client!SSXXGGTR", name = "M", descriptor = "I")
    private int field1438;

    @OriginalMember(owner = "client!SSXXGGTR", name = "z", descriptor = "J")
    private long field1425;

    @OriginalMember(owner = "client!SSXXGGTR", name = "t", descriptor = "LLOBJUMRN;")
    private class34 field1419;

    @OriginalMember(owner = "client!SSXXGGTR", name = "S", descriptor = "Lclient;")
    private client field1444;

    @OriginalMember(owner = "client!SSXXGGTR", name = "n", descriptor = "Ljava/io/InputStream;")
    private InputStream field1413;

    @OriginalMember(owner = "client!SSXXGGTR", name = "O", descriptor = "Ljava/io/OutputStream;")
    private OutputStream field1440;

    @OriginalMember(owner = "client!SSXXGGTR", name = "d", descriptor = "Ljava/net/Socket;")
    private Socket field1403;

    @OriginalMember(owner = "client!SSXXGGTR", name = "s", descriptor = "Z")
    private static boolean field1418;

    @OriginalMember(owner = "client!SSXXGGTR", name = "g", descriptor = "[B")
    ...
    @OriginalMember(owner = "client!SSXXGGTR", name = "D", descriptor = "[I")
    private int[] field1429;

    @OriginalMember(owner = "client!SSXXGGTR", name = "K", descriptor = "[I")
    private int[] field1436;

    @OriginalMember(owner = "client!SSXXGGTR", name = "L", descriptor = "[I")
    private int[] field1437;

    @OriginalMember(owner = "client!SSXXGGTR", name = "N", descriptor = "[I")
    private int[] field1439;

    @OriginalMember(owner = "client!SSXXGGTR", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!SSXXGGTR", name = "a", descriptor = "(LSYUGXMZF;Lclient;)V")
    ...
    @OriginalMember(owner = "client!SSXXGGTR", name = "a", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!SSXXGGTR", name = "a", descriptor = "()LLOBJUMRN;")
    ...
    @OriginalMember(owner = "client!SSXXGGTR", name = "b", descriptor = "(II)Z")
    ...
    @OriginalMember(owner = "client!SSXXGGTR", name = "c", descriptor = "(II)Z")
    ...
    @OriginalMember(owner = "client!SSXXGGTR", name = "a", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!SSXXGGTR", name = "a", descriptor = "(IZBI)V")
    ...
    @OriginalMember(owner = "client!SSXXGGTR", name = "b", descriptor = "()I")
    ...
    @OriginalMember(owner = "client!SSXXGGTR", name = "c", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!SSXXGGTR", name = "a", descriptor = "(IZ)V")
    ...
    @OriginalMember(owner = "client!SSXXGGTR", name = "d", descriptor = "(II)I")
    ...
    @OriginalMember(owner = "client!SSXXGGTR", name = "a", descriptor = "(IIIZ)I")
    ...
    @OriginalMember(owner = "client!SSXXGGTR", name = "d", descriptor = "(I)I")
    public final int method542(int arg0) {
        return arg0 == -7482 ? this.field1437.length : this.field1421;
    }

    @OriginalMember(owner = "client!SSXXGGTR", name = "a", descriptor = "(IBI)V")
    ...
    @OriginalMember(owner = "client!SSXXGGTR", name = "b", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!SSXXGGTR", name = "run", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!SSXXGGTR", name = "c", descriptor = "()V")
    public final void method545() {
        this.field1415 = false;
    }

    @OriginalMember(owner = "client!SSXXGGTR", name = "a", descriptor = "(III[B)Z")
    ...
    @OriginalMember(owner = "client!SSXXGGTR", name = "a", descriptor = "(I)V")
    public final void method265(int arg0) {
        this.method531(0, arg0);
    }

    @OriginalMember(owner = "client!SSXXGGTR", name = "a", descriptor = "(ILLOBJUMRN;)V")
    ...
    @OriginalMember(owner = "client!SSXXGGTR", name = "e", descriptor = "(II)I")
    public final int method548(int arg0, int arg1) {
        return arg1 == 0 ? this.field1445[arg0].length : 1;
    }

    @OriginalMember(owner = "client!SSXXGGTR", name = "c", descriptor = "(B)V")
