...
public class class54 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "([BB)[B", line = 17)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(II)I", line = 104)
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "(II)V", line = 128)
