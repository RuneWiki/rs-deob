...
public class class54 extends class115 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(BLjava/lang/String;)V", line = 6)
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "()V", line = 20)
    public class54() {
        super(0, true);
    }

    @OriginalMember(owner = "client!hk", name = "h", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!hk", name = "b", descriptor = "(II)[I", line = 52)
    ...
    @OriginalMember(owner = "client!hk", name = "c", descriptor = "(II)V", line = 75)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(BLbk;I)V", line = 89)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(II)[[I", line = 166)
    ...
    @OriginalMember(owner = "client!hk", name = "i", descriptor = "(I)[Ld;", line = 229)
    ...
    @OriginalMember(owner = "client!hk", name = "e", descriptor = "(B)V", line = 310)
    ...
    @OriginalMember(owner = "client!hk", name = "f", descriptor = "(B)V", line = 329)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(I[[I)V", line = 356)
