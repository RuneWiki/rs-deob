...
@OriginalClass("client!RSNWTZPO")
public class class54 {

    @OriginalMember(owner = "client!RSNWTZPO", name = "a", descriptor = "I")
    private int field1392 = 1;

    @OriginalMember(owner = "client!RSNWTZPO", name = "b", descriptor = "I")
    private int field1393;

    @OriginalMember(owner = "client!RSNWTZPO", name = "e", descriptor = "I")
    public int field1396;

    @OriginalMember(owner = "client!RSNWTZPO", name = "f", descriptor = "I")
    public int field1397;

    @OriginalMember(owner = "client!RSNWTZPO", name = "g", descriptor = "I")
    public int field1398;

    @OriginalMember(owner = "client!RSNWTZPO", name = "h", descriptor = "I")
    private int field1399;

    @OriginalMember(owner = "client!RSNWTZPO", name = "i", descriptor = "I")
    private int field1400;

    @OriginalMember(owner = "client!RSNWTZPO", name = "j", descriptor = "I")
    private int field1401;

    @OriginalMember(owner = "client!RSNWTZPO", name = "k", descriptor = "I")
    private int field1402;

    @OriginalMember(owner = "client!RSNWTZPO", name = "l", descriptor = "I")
    private int field1403;

    @OriginalMember(owner = "client!RSNWTZPO", name = "m", descriptor = "I")
    public static int field1404;

    @OriginalMember(owner = "client!RSNWTZPO", name = "c", descriptor = "[I")
    private int[] field1394;

    @OriginalMember(owner = "client!RSNWTZPO", name = "d", descriptor = "[I")
    private int[] field1395;

    @OriginalMember(owner = "client!RSNWTZPO", name = "a", descriptor = "(ILINLHDAGO;)V")
    ...
    @OriginalMember(owner = "client!RSNWTZPO", name = "a", descriptor = "(LINLHDAGO;I)V")
    ...
    @OriginalMember(owner = "client!RSNWTZPO", name = "a", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!RSNWTZPO", name = "a", descriptor = "(II)I")
