...
public class class54 extends class439 {
    ...
    @OriginalMember(owner = "client!aw", name = "d", descriptor = "()V", line = 15)
    ...
    @OriginalMember(owner = "client!aw", name = "d", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 30)
    ...
    @OriginalMember(owner = "client!aw", name = "b", descriptor = "()V", line = 55)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "()I", line = 91)
    public final int method463() {
        return this.field652 - (this.field653.available() >> (class295.field4060 ? 2 : 1));
    }

    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 101)
    ...
    @OriginalMember(owner = "client!aw", name = "c", descriptor = "()V", line = 135)
