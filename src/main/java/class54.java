...
public class class54 extends class402 implements class425 {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IZBLza;)Lrn;")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ILza;I)Le;")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IBILvs;Lza;ZI)V")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Lza;Z)V")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ZLrj;)Z")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ILza;B)Le;")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ZLza;II)Z")
    ...
    @OriginalMember(owner = "client!u", name = "b", descriptor = "(Lza;I)Lnd;")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "(Lza;Ljc;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(BLza;)V")
