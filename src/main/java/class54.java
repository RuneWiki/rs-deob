...
public class class54 extends class200 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Z)I", line = 5)
    ...
    @OriginalMember(owner = "client!kl", name = "e", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!kl", name = "f", descriptor = "(I)I", line = 47)
    ...
    @OriginalMember(owner = "client!kl", name = "g", descriptor = "(I)J", line = 58)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(ZB)V", line = 69)
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "(II)V", line = 107)
    public class54(int arg0, int arg1) {
        super.field4904 = (long) arg1 | (long) arg0 << 32;
    }

    @OriginalMember(owner = "client!kl", name = "h", descriptor = "(I)V", line = 128)
