...
public class class54 extends class86 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(ILtl;)V", line = 13)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Ltl;II)V", line = 37)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IBI)I", line = 111)
    ...
    @OriginalMember(owner = "client!mq", name = "c", descriptor = "(B)V", line = 129)
    ...
    @OriginalMember(owner = "client!mq", name = "c", descriptor = "(I)I", line = 150)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(II)Lwi;", line = 169)
    ...
    @OriginalMember(owner = "client!mq", name = "d", descriptor = "(I)Ljava/lang/String;", line = 184)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(ZLtl;)Ljava/lang/String;", line = 213)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IILjb;I)V", line = 244)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Ltl;[II)V", line = 264)
    ...
    @OriginalMember(owner = "client!mq", name = "e", descriptor = "(I)V", line = 293)
    public static void method371(int arg0) {
        field729 = null;
        int var1 = -108 % ((arg0 - 29) / 56);
    }

    @OriginalMember(owner = "client!mq", name = "d", descriptor = "(B)V", line = 302)
