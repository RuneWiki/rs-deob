...
public class class54 extends class147 {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lbg;ILbg;)V")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lja;I)V")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lja;II)V")
