...
public class class54 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IIIIIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(BI)V", line = 31)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IZ)Lrc;", line = 46)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(II)V", line = 82)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IIIIII)Z", line = 96)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(B)V", line = 156)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IBII)V", line = 171)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(I)Z", line = 185)
