...
@OriginalClass("client!TFKCMRVE")
public class class54 {

    @OriginalMember(owner = "client!TFKCMRVE", name = "b", descriptor = "Z")
    private boolean field1354 = true;

    @OriginalMember(owner = "client!TFKCMRVE", name = "c", descriptor = "Z")
    private boolean field1355 = true;

    @OriginalMember(owner = "client!TFKCMRVE", name = "f", descriptor = "I")
    public int field1358 = -1;

    @OriginalMember(owner = "client!TFKCMRVE", name = "h", descriptor = "[I")
    public int[] field1360 = new int[6];

    @OriginalMember(owner = "client!TFKCMRVE", name = "i", descriptor = "[I")
    public int[] field1361 = new int[6];

    @OriginalMember(owner = "client!TFKCMRVE", name = "j", descriptor = "[I")
    public int[] field1362 = new int[] { -1, -1, -1, -1, -1 };

    @OriginalMember(owner = "client!TFKCMRVE", name = "k", descriptor = "Z")
    public boolean field1363 = false;

    @OriginalMember(owner = "client!TFKCMRVE", name = "d", descriptor = "I")
    public static int field1356;

    @OriginalMember(owner = "client!TFKCMRVE", name = "a", descriptor = "Z")
    private static boolean field1353;

    @OriginalMember(owner = "client!TFKCMRVE", name = "g", descriptor = "[I")
    public int[] field1359;

    @OriginalMember(owner = "client!TFKCMRVE", name = "e", descriptor = "[LTFKCMRVE;")
    public static class54[] field1357;

    @OriginalMember(owner = "client!TFKCMRVE", name = "a", descriptor = "(ILBBMKAXRK;)V")
    ...
    @OriginalMember(owner = "client!TFKCMRVE", name = "a", descriptor = "(LEILHLJCE;B)V")
    ...
    @OriginalMember(owner = "client!TFKCMRVE", name = "a", descriptor = "(Z)Z")
    ...
    @OriginalMember(owner = "client!TFKCMRVE", name = "a", descriptor = "(B)LKBEXSZSN;")
    ...
    @OriginalMember(owner = "client!TFKCMRVE", name = "a", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!TFKCMRVE", name = "b", descriptor = "(I)LKBEXSZSN;")
    ...
    @OriginalMember(owner = "client!TFKCMRVE", name = "<init>", descriptor = "()V")
    public class54() {
        if (class30.field987) {
        }
    }
