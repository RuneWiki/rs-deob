...
public class class54 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Lui;II)Lmq;")
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "()Luk;")
    ...
    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "(Lre;)V")
