...
public class class54 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "()I", line = 5)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(II)I", line = 13)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "()[F", line = 23)
    public final float[] method285() {
        return this.field548[this.method283()];
    }

    @OriginalMember(owner = "client!ts", name = "c", descriptor = "()V", line = 27)
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "()V", line = 165)
    public class54() {
