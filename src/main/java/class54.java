...
public class class54 extends class5 {
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(CII)I", line = 3)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!qw", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZ)V", line = 57)
