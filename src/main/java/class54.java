...
public class class54 extends class428 {
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(I[Lf;)V")
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(Lqa;B)Lvs;")
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IZILqa;)Z")
