...
public class class54 extends class335 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Lio;I)Lfda;")
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ILio;I)V")
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IIIIIIIIILev;II)Z")
