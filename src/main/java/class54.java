...
public class class54 {
    ...
    @OriginalMember(owner = "client!VNWSQIXW", name = "e", descriptor = "LOGGHOMII;")
    private class33 field1524 = new class33();

    @OriginalMember(owner = "client!VNWSQIXW", name = "i", descriptor = "LPNEYGONI;")
    ...
    @OriginalMember(owner = "client!VNWSQIXW", name = "h", descriptor = "LBELQMOFW;")
    ...
    @OriginalMember(owner = "client!VNWSQIXW", name = "a", descriptor = "(J)LOGGHOMII;")
    ...
    @OriginalMember(owner = "client!VNWSQIXW", name = "a", descriptor = "(IJLOGGHOMII;)V")
