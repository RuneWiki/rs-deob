...
public class class54 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Lfj;I)I", line = 5)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "([BI)V", line = 78)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Ltq;B)V", line = 265)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(I)V", line = 277)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(BIZIZII)V", line = 303)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "([BI)V", line = 366)
