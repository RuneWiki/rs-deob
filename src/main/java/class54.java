...
public class class54 {
    ...
    @OriginalMember(owner = "client!SFNSVANZ", name = "c", descriptor = "[LSFNSVANZ;")
    public static class54[] field1311;

    @OriginalMember(owner = "client!SFNSVANZ", name = "a", descriptor = "(LFNOQZAYQ;I)V")
    ...
    @OriginalMember(owner = "client!SFNSVANZ", name = "a", descriptor = "(LDNRIFKTO;IB)V")
