...
@OriginalClass("client!VIVVOUFY")
public class class54 extends class6 {

    @OriginalMember(owner = "client!VIVVOUFY", name = "j", descriptor = "I")
    public int field1482 = 1000;

    @OriginalMember(owner = "client!VIVVOUFY", name = "k", descriptor = "Z")
    public static boolean field1483;

    @OriginalMember(owner = "client!VIVVOUFY", name = "i", descriptor = "[LNNJZYNNI;")
    public class34[] field1481;

    @OriginalMember(owner = "client!VIVVOUFY", name = "a", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!VIVVOUFY", name = "a", descriptor = "(B)LCCYECDYX;")
