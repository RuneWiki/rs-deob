...
public class class54 {
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(BJI)Lcl;")
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(I)Lgja;")
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(ILgja;)V")
