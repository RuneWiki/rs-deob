...
public class class54 extends class62 {
    ...
    @OriginalMember(owner = "client!SLPOTSAU", name = "z", descriptor = "LDWUJPTWU;")
    ...
    @OriginalMember(owner = "client!SLPOTSAU", name = "y", descriptor = "Lclient;")
    public static client field1414;

    @OriginalMember(owner = "client!SLPOTSAU", name = "b", descriptor = "(I)LLWJTLDAE;")
    ...
    @OriginalMember(owner = "client!SLPOTSAU", name = "a", descriptor = "(I)LPSGMMDJS;")
