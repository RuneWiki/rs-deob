...
public class class54 implements class346 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(BZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(I)Lqfa;", line = 39)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(B)I", line = 53)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IIZIIIII)V", line = 72)
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(B)V", line = 87)
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(Leq;)V", line = 102)
