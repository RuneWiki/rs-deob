...
public class class54 {
    ...
    @OriginalMember(owner = "client!TDXKKGZV", name = "m", descriptor = "I")
    ...
    @OriginalMember(owner = "client!TDXKKGZV", name = "a", descriptor = "(ILIMUIZRAF;)V")
    ...
    @OriginalMember(owner = "client!TDXKKGZV", name = "a", descriptor = "(ZLIMUIZRAF;)V")
