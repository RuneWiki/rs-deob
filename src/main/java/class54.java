...
public class class54 extends class378 implements Runnable {
    ...
    @OriginalMember(owner = "client!hk", name = "run", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!hk", name = "c", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IBI)V", line = 32)
    ...
    @OriginalMember(owner = "client!hk", name = "d", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "(Lli;)V", line = 203)
    public class54(class247 arg0) {
        this.field796 = arg0;
    }

    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(II)I", line = 74)
    ...
    @OriginalMember(owner = "client!hk", name = "b", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ZIIIII)V", line = 99)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IB)Lsb;", line = 122)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(BLaa;Lrg;)V", line = 164)
    ...
    @OriginalMember(owner = "client!hk", name = "e", descriptor = "(I)V", line = 176)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Lcm;ZZI)V", line = 211)
