...
public class class54 extends class22 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!rf", name = "c", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(BLhg;)V", line = 52)
    ...
    @OriginalMember(owner = "client!rf", name = "c", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lhg;I)V", line = 161)
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lhe;B)V", line = 188)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(II)V", line = 201)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(BLhg;)V", line = 212)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Log;IIFZ)V", line = 229)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(IILhe;IZII)V", line = 248)
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(II)V", line = 292)
