...
public abstract class class54 extends class69 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IIIIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Lae;I)V", line = 44)
    ...
    @OriginalMember(owner = "client!ms", name = "b", descriptor = "(I)V", line = 113)
