...
public class class54 {
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(ZII)V", line = 35)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!wba", name = "b", descriptor = "(B)Z", line = 69)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Lha;IIIIIIZZ)V", line = 171)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(IB)Lko;", line = 291)
    ...
    @OriginalMember(owner = "client!wba", name = "<init>", descriptor = "(Lgia;ILaj;Laj;)V", line = 340)
