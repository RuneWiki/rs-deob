...
public abstract class class54 {
    ...
    @OriginalMember(owner = "client!gja", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(BLjava/lang/String;I)V", line = 42)
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(IB)V", line = 143)
    ...
    @OriginalMember(owner = "client!gja", name = "<init>", descriptor = "(Lhia;)V", line = 158)
    ...
    @OriginalMember(owner = "client!gja", name = "c", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(IIILlk;IIIILvea;III)V", line = 179)
    ...
    @OriginalMember(owner = "client!gja", name = "<init>", descriptor = "(ILhia;)V", line = 204)
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(BI)I", line = 216)
    ...
    @OriginalMember(owner = "client!gja", name = "b", descriptor = "(II)V", line = 262)
