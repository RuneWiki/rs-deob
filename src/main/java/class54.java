...
public class class54 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(I)Lff;", line = 49)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(ILmo;Ljava/lang/String;Z)Lpe;", line = 74)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(BI)Lcg;", line = 125)
    ...
    @OriginalMember(owner = "client!er", name = "c", descriptor = "(I)Lff;", line = 152)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "()V", line = 240)
    public class54() {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(ZLff;)V", line = 195)
    ...
    @OriginalMember(owner = "client!er", name = "e", descriptor = "(I)Lff;", line = 220)
