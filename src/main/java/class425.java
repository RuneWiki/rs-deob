...
public class class425 extends class338 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lam;Lam;BLam;Lam;)V", line = 9)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IB)I", line = 26)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Z)V", line = 65)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lam;Lam;ZLvm;)V", line = 101)
