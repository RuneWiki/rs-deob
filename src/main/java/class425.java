...
public class class425 implements class338 {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(I)Z", line = 17)
    ...
    @OriginalMember(owner = "client!wi", name = "c", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(III)I", line = 45)
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(Lkq;)V", line = 62)
    public class425(class541 arg0) {
        this.field5650 = arg0;
    }

    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(ZI)V", line = 71)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(I)V", line = 104)
