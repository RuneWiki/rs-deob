...
public class class425 extends class448 {
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 4)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(III[BIIBI[B)V", line = 32)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Lofa;B)Lhc;", line = 77)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;B)V", line = 117)
