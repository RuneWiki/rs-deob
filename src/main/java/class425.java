...
public abstract class class425 extends class321 {
    ...
    @OriginalMember(owner = "client!ha", name = "e", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!ha", name = "f", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(III)Z", line = 57)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(II)I", line = 68)
    public static int method2563(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIIIZI)V", line = 79)
