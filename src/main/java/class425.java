...
public class class425 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lkh;I)V", line = 12)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Z)V", line = 266)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IIIII)V", line = 278)
