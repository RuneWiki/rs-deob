...
public class class425 {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(B)V", line = 4)
    public static void method2601(byte arg0) {
        field6066 = null;
        int var1 = 108 % ((arg0 - 57) / 45);
    }

    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(I)[[I", line = 17)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(II)[I", line = 38)
    ...
    @OriginalMember(owner = "client!ga", name = "b", descriptor = "(B)V", line = 107)
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(III)V", line = 159)
    ...
    @OriginalMember(owner = "client!ga", name = "b", descriptor = "(I)Lwr;", line = 132)
