...
public class class425 extends class88 {
    ...
    @OriginalMember(owner = "client!nq", name = "c", descriptor = "(I)Lmk;", line = 4)
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Lsea;Lob;)V", line = 49)
    public class425(class648 arg0, class687 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(B)V", line = 52)
    public static void method2452(byte arg0) {
        int var1 = -61 % ((23 - arg0) / 54);
        field5959 = null;
    }

    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(III)Z", line = 62)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ZZ)V", line = 78)
