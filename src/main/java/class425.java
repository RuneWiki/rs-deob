...
public class class425 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(II)Z", line = 15)
    ...
    @OriginalMember(owner = "client!la", name = "b", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IBI)Z", line = 65)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(B)V", line = 80)
