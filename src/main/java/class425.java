...
public abstract class class425 extends class496 {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(BI)I", line = 6)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ZI)Z", line = 82)
