...
public class class425 extends class207 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(FZILta;I)V")
    ...
    @OriginalMember(owner = "client!th", name = "c", descriptor = "(I)Lkn;")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Lui;B)V")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Lfq;I)V")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(BLfq;)V")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ZLfq;)V")
