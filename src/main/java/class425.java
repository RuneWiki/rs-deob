...
public class class425 extends class188 {
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(III)V", line = 7)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(IIZII)V", line = 157)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(IIIIIIII)V", line = 171)
    ...
    @OriginalMember(owner = "client!qba", name = "<init>", descriptor = "(Lqfa;IIZ[[BI)V", line = 197)
    ...
    @OriginalMember(owner = "client!qba", name = "<init>", descriptor = "(Lqfa;II)V", line = 230)
    ...
    @OriginalMember(owner = "client!qba", name = "<init>", descriptor = "(Lqfa;IIZ[[I)V", line = 247)
    ...
    @OriginalMember(owner = "client!qba", name = "d", descriptor = "(I)V", line = 216)
