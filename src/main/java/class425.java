...
public class class425 implements Runnable {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "([BIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!du", name = "run", descriptor = "()V", line = 46)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Lbm;B)V", line = 122)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Z)V", line = 137)
    ...
    @OriginalMember(owner = "client!du", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 185)
    ...
    @OriginalMember(owner = "client!du", name = "b", descriptor = "(I)V", line = 160)
