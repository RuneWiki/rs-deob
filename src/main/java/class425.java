...
public class class425 extends class114 {
    ...
    @OriginalMember(owner = "client!vs", name = "b", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!vs", name = "f", descriptor = "(I)Z", line = 28)
    ...
    @OriginalMember(owner = "client!vs", name = "b", descriptor = "(II)Z", line = 123)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(III[FIII)V", line = 138)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(ILqa;)V", line = 235)
    ...
    @OriginalMember(owner = "client!vs", name = "c", descriptor = "(II)Z", line = 257)
    ...
    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "(I)V", line = 267)
    public class425(int arg0) {
        this.field6476 = arg0;
    }

    @OriginalMember(owner = "client!vs", name = "a", descriptor = "()V", line = 275)
