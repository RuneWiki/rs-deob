...
public class class425 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Lmf;)V")
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(Lmf;)V")
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ILmf;)I")
    ...
    @OriginalMember(owner = "client!ot", name = "c", descriptor = "(Lmf;)B")
    ...
    @OriginalMember(owner = "client!ot", name = "d", descriptor = "(Lmf;)V")
    ...
    @OriginalMember(owner = "client!ot", name = "e", descriptor = "(Lmf;)B")
