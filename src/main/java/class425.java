...
public class class425 extends class90 {
    ...
    @OriginalMember(owner = "client!hr", name = "f", descriptor = "(I)[Leh;")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ILvc;III)V")
    ...
    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "(Lhd;)V")
