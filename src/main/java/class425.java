...
public class class425 extends class70 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!un", name = "d", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!un", name = "b", descriptor = "(B)Z", line = 15)
    ...
    @OriginalMember(owner = "client!un", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 26)
    ...
    @OriginalMember(owner = "client!un", name = "c", descriptor = "(I)Z", line = 51)
    ...
    @OriginalMember(owner = "client!un", name = "e", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!un", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 84)
    ...
    @OriginalMember(owner = "client!un", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 94)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        field5982++;
        this.method2440(-22490, arg0.getX(), arg0.getY());
    }

    @OriginalMember(owner = "client!un", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 105)
    public final synchronized void mouseExited(MouseEvent arg0) {
        field5965++;
        this.method2440(-22490, arg0.getX(), arg0.getY());
    }

    @OriginalMember(owner = "client!un", name = "b", descriptor = "(Z)V", line = 113)
    ...
    @OriginalMember(owner = "client!un", name = "b", descriptor = "(III)V", line = 126)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(BLlr;)Lkfa;", line = 155)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 180)
    ...
    @OriginalMember(owner = "client!un", name = "d", descriptor = "(I)I", line = 193)
    public final int method528(int arg0) {
        field5989++;
        return arg0 <= 4 ? 121 : this.field5978;
    }

    @OriginalMember(owner = "client!un", name = "a", descriptor = "(I)Lhfa;", line = 208)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(II)Z", line = 219)
    ...
    @OriginalMember(owner = "client!un", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 237)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method2440(-22490, arg0.getX(), arg0.getY());
        field5979++;
    }

    @OriginalMember(owner = "client!un", name = "b", descriptor = "(II)I", line = 245)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(ILjava/awt/event/MouseEvent;)I", line = 258)
    ...
    @OriginalMember(owner = "client!un", name = "e", descriptor = "(B)V", line = 296)
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 431)
    public class425(Component arg0, boolean arg1) {
        this.method2434(-32, arg0);
        this.field5995 = arg1;
    }

    @OriginalMember(owner = "client!un", name = "c", descriptor = "(B)I", line = 326)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(IIIII)V", line = 338)
    ...
    @OriginalMember(owner = "client!un", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 358)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method2440(-22490, arg0.getX(), arg0.getY());
        field5966++;
    }

    @OriginalMember(owner = "client!un", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 368)
    ...
    @OriginalMember(owner = "client!un", name = "f", descriptor = "(B)V", line = 411)
    ...
    @OriginalMember(owner = "client!un", name = "c", descriptor = "(III)V", line = 447)
