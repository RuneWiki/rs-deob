...
public class class425 {
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(BI)Lnd;", line = 37)
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "(ILjn;Ljn;)V", line = 78)
