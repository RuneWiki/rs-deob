...
public class class425 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IIIIIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(I)Z", line = 228)
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(Z)V", line = 298)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 308)
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(J[I[S[S)V", line = 366)
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "()V", line = 378)
    protected class425() {
    }
}
