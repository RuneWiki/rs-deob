...
public class class425 extends class105 {
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IIZ)V", line = 74)
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(III)V", line = 84)
    ...
    @OriginalMember(owner = "client!th", name = "c", descriptor = "(II)I", line = 95)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(III)V", line = 113)
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(IIIIII)V", line = 134)
