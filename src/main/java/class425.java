...
public class class425 extends class185 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IZI)Z", line = 7)
    ...
    @OriginalMember(owner = "client!re", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 18)
    ...
    @OriginalMember(owner = "client!re", name = "c", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IZIII)V", line = 46)
    ...
    @OriginalMember(owner = "client!re", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 62)
    public final void startProduction(ImageConsumer arg0) {
        ++field6273;
        this.addConsumer(arg0);
    }

    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIILjava/awt/Graphics;)V", line = 70)
    ...
    @OriginalMember(owner = "client!re", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 82)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field6269;
        return this.field6271 == arg0;
    }

    @OriginalMember(owner = "client!re", name = "d", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIILjava/awt/Graphics;BI)V", line = 102)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(BLjava/awt/Canvas;)V", line = 122)
    ...
    @OriginalMember(owner = "client!re", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 155)
    ...
    @OriginalMember(owner = "client!re", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 169)
