...
public class class425 extends class408 {
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(ZI)I", line = 3)
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(I)J", line = 24)
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(Lge;ZBZLjava/lang/String;)V", line = 50)
    ...
    @OriginalMember(owner = "client!hea", name = "<init>", descriptor = "([[SD)V", line = 113)
