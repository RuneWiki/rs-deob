...
public class class425 extends class406 {
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "([ILqm;B[I[I)V", line = 29)
    ...
    @OriginalMember(owner = "client!ge", name = "c", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ZJ)Ljava/lang/String;", line = 164)
