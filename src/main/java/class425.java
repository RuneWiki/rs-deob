...
public class class425 extends class358 {
    ...
    @OriginalMember(owner = "client!cga", name = "<init>", descriptor = "(Lpq;)V")
    public class425(class194 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!cga", name = "c", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(Lrq;Lrq;BI)V")
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(ILgs;)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
