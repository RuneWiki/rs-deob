...
public class class425 extends class385 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Lbfa;I)Ljava/lang/String;", line = 15)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IBI)Z", line = 32)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Les;B)Ljava/lang/String;", line = 43)
    ...
    @OriginalMember(owner = "client!ob", name = "b", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!ob", name = "b", descriptor = "(II)I", line = 71)
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(I)V", line = 87)
