...
public class class425 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(I)Luo;", line = 4)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "([I[BI[II[[BI[[B)I", line = 24)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IIII)Loo;", line = 82)
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "(IIIIB)V", line = 98)
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "(Loo;I)V", line = 109)
