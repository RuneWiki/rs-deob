...
public class class425 extends class153 implements class196 {
    ...
    @OriginalMember(owner = "client!iv", name = "c", descriptor = "(B)V", line = 5)
    public final void method59(byte arg0) {
        ++field6342;
        int var2 = 28 / ((27 - arg0) / 63);
    }

    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(ILqa;B)Lc;", line = 15)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(I)I", line = 27)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(I)I", line = 38)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(BLqa;)V", line = 49)
    ...
    @OriginalMember(owner = "client!iv", name = "e", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(ILqa;)V", line = 77)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Lqa;I)Lpj;", line = 87)
    ...
    @OriginalMember(owner = "client!iv", name = "h", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(ILbv;)V", line = 138)
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(Lqa;Leu;IIIIIZIIIIIII)V", line = 181)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(BLqa;)V", line = 191)
    ...
    @OriginalMember(owner = "client!iv", name = "i", descriptor = "(I)V", line = 203)
    ...
    @OriginalMember(owner = "client!iv", name = "d", descriptor = "(B)I", line = 220)
    public final int method779(byte arg0) {
        ++field6326;
        return arg0 != 9 ? 119 : this.field6322.method2601(-38);
    }

    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(B)I", line = 232)
    public final int method63(byte arg0) {
        ++field6341;
        return arg0 != 63 ? 124 : this.field6322.field6432;
    }

    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(B)Z", line = 244)
    ...
    @OriginalMember(owner = "client!iv", name = "d", descriptor = "(I)Z", line = 256)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Lqv;BLqa;IZII)V", line = 269)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IIIIII)V", line = 284)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IIILqa;)Z", line = 313)
