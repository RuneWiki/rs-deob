...
public class class425 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ILee;)Ltga;", line = 7)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IC)C", line = 46)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(I)V", line = 80)
