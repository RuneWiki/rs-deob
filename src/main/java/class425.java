...
public class class425 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lh;)V")
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lh;Lsk;)V")
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lh;I)V")
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(Lh;)V")
    ...
    @OriginalMember(owner = "client!fj", name = "c", descriptor = "(Lh;)V")
