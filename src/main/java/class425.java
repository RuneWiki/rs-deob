...
public class class425 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IB)[[[B", line = 54)
    ...
    @OriginalMember(owner = "client!ge", name = "c", descriptor = "(B)Z", line = 829)
