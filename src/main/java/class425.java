...
public class class425 extends class352 {
    ...
    @OriginalMember(owner = "client!jn", name = "<init>", descriptor = "(Lkp;Ldi;[Lnc;[I[I)V")
    ...
    @OriginalMember(owner = "client!jn", name = "b", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(CIIIZLtm;II)V")
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "([B[IIIIIIIIIIILtm;II)V")
    ...
    @OriginalMember(owner = "client!jn", name = "b", descriptor = "([B[IIIIIIIIIIILtm;II)V")
