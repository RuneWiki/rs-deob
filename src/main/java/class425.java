...
public class class425 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ZILmr;)V")
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IIIZB)Lwf;")
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Lht;BIIII)Lcq;")
