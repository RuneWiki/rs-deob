...
public class class425 implements class715 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(III)Lhba;", line = 64)
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 71)
    public class425(String arg0, int arg1) {
        this.field5641 = arg1;
    }

    @OriginalMember(owner = "client!oh", name = "toString", descriptor = "()Ljava/lang/String;", line = 82)
