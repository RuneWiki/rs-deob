...
public class class425 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(ILjava/lang/String;II[Lf;)I", line = 7)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IILjava/lang/String;[Lf;)I", line = 22)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(II)I", line = 34)
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(II)I", line = 51)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(CII)I", line = 67)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIB)Z", line = 82)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(Ljava/lang/String;B[Lf;I)Ljava/lang/String;", line = 92)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIIIIIIILit;Lit;)V", line = 214)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIBLem;)V", line = 262)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IZ[Lf;Ljava/lang/String;)I", line = 274)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(BIILjava/lang/Object;)[B", line = 303)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "([Ljava/lang/String;Ljava/lang/String;[Lf;B[I)I", line = 336)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(B)V", line = 583)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(BLjava/lang/String;)I", line = 594)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(ILjava/lang/String;[Lf;)I", line = 612)
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "([B)V", line = 728)
