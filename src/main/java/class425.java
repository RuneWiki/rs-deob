...
public class class425 extends class73 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(III)Lcj;", line = 48)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!bl", name = "c", descriptor = "(B)I", line = 238)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(Z)I", line = 259)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(II)[B", line = 277)
    ...
    @OriginalMember(owner = "client!bl", name = "c", descriptor = "(Z)I", line = 297)
    ...
    @OriginalMember(owner = "client!bl", name = "c", descriptor = "(I)I", line = 330)
    ...
    @OriginalMember(owner = "client!bl", name = "d", descriptor = "(I)V", line = 341)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(III)Lut;", line = 421)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(II)V", line = 633)
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(ILrq;Lrq;Lpp;Lro;IIZ)V", line = 794)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IB)I", line = 674)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Z)Lra;", line = 691)
