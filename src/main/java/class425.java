...
public class class425 {
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(I)Lpb;")
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(B)Lpb;")
    ...
    @OriginalMember(owner = "client!ep", name = "<init>", descriptor = "(Ldu;)V")
