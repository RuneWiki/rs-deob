...
public class class425 extends class232 {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(IB)[I", line = 3)
    ...
    @OriginalMember(owner = "client!ga", name = "c", descriptor = "(III)Z", line = 53)
    ...
    @OriginalMember(owner = "client!ga", name = "d", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(IZI)Z", line = 90)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(ILwq;I)V", line = 122)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(B)V", line = 199)
