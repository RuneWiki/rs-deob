...
public class class425 {
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(IIIIIIIIIBI)V", line = 13)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(IIBI)Z", line = 34)
    ...
    @OriginalMember(owner = "client!ew", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 74)
