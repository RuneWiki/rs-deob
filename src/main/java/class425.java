...
public class class425 implements class346 {
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(Lcca;IZZLcca;ZI)I")
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IIILla;Ljava/lang/String;I)I")
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "(Lpa;Leaa;)V")
