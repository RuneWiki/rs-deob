...
public class class550 extends class108 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(II)I", line = 69)
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(II)V", line = 79)
