...
public class class550 extends class31 implements class269 {
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!lca", name = "f", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!lca", name = "d", descriptor = "(I)Z", line = 24)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(Z)I", line = 37)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(Lqa;Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(ILqa;II)Z", line = 60)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(ILqa;)V", line = 72)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(ILqa;Z)Lr;", line = 82)
    ...
    @OriginalMember(owner = "client!lca", name = "c", descriptor = "(B)V", line = 96)
    ...
    @OriginalMember(owner = "client!lca", name = "c", descriptor = "(ILqa;)Loj;", line = 107)
    ...
    @OriginalMember(owner = "client!lca", name = "<init>", descriptor = "(IIILwv;)V", line = 118)
    public class550(int arg0, int arg1, int arg2, class31 arg3) {
        super(arg0, arg1, arg2, arg3.field235, false, false);
        this.field8079 = arg3;
    }

    @OriginalMember(owner = "client!lca", name = "b", descriptor = "(B)V", line = 126)
    ...
    @OriginalMember(owner = "client!lca", name = "b", descriptor = "(I)Z", line = 136)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(I)I", line = 146)
    public final int method342(int arg0) {
        field8074++;
        return arg0 == -2329 ? 0 : -71;
    }

    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(ZLqa;)V", line = 158)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(B)I", line = 168)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(BIII)I", line = 184)
    ...
    @OriginalMember(owner = "client!lca", name = "b", descriptor = "(ILqa;)Lso;", line = 208)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(ZLoe;ILqa;III)V", line = 222)
