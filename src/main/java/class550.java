...
public class class550 {
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(III)V", line = 6)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!lba", name = "<init>", descriptor = "(Lrda;)V", line = 91)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(BI)S", line = 55)
