...
public class class550 {
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "()I", line = 3)
    ...
    @OriginalMember(owner = "client!cba", name = "b", descriptor = "()V", line = 20)
    public void method662() throws Exception {
        field7572++;
    }

    @OriginalMember(owner = "client!cba", name = "b", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(ILjba;I)V", line = 147)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "([II)V", line = 169)
    ...
    @OriginalMember(owner = "client!cba", name = "c", descriptor = "(I)V", line = 327)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(ZLjba;)V", line = 346)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(IB)V", line = 359)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(IIZBIII)V", line = 379)
    ...
    @OriginalMember(owner = "client!cba", name = "c", descriptor = "()V", line = 396)
    public void method665() {
        field7564++;
    }

    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(II[II[Ljava/lang/Object;)V", line = 411)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(Z)V", line = 468)
    ...
    @OriginalMember(owner = "client!cba", name = "d", descriptor = "()V", line = 509)
    public void method667() throws Exception {
        field7578++;
    }

    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 518)
