...
public class class550 extends class512 {
    ...
    @OriginalMember(owner = "client!bba", name = "f", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(IILlo;)V", line = 31)
    ...
    @OriginalMember(owner = "client!bba", name = "f", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!bba", name = "d", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(ZZ)V", line = 112)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(ZLwu;IJIII)V", line = 125)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(IZ)V", line = 133)
    ...
    @OriginalMember(owner = "client!bba", name = "<init>", descriptor = "(Lsb;Lwu;)V", line = 252)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(IIZ)V", line = 160)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(IILmr;Ljava/lang/String;)Lfg;", line = 171)
    ...
    @OriginalMember(owner = "client!bba", name = "b", descriptor = "(I)V", line = 278)
    ...
    @OriginalMember(owner = "client!bba", name = "e", descriptor = "(I)Z", line = 313)
