...
public class class550 extends class166 {
    ...
    @OriginalMember(owner = "client!lba", name = "b", descriptor = "()Lpf;")
    ...
    @OriginalMember(owner = "client!lba", name = "c", descriptor = "()Lpf;")
    public final class583 method3116() {
        return this.field7788;
    }

    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(IZ)Llba;")
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(Lha;[Lfk;Z)V")
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(Lha;J[Lfk;[Lcia;Z)V")
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(Lha;J)Z")
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "([Lcia;Z)V")
