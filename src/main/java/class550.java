...
public class class550 extends class5 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!wh", name = "c", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "()V", line = 30)
    public class550() {
        this(0);
    }

    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(ILes;I)V", line = 33)
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(I)V", line = 60)
    private class550(int arg0) {
        super(0, false);
        this.method3034(arg0, (byte) 6);
    }

    @OriginalMember(owner = "client!wh", name = "i", descriptor = "(I)I", line = 69)
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(III)Lwr;", line = 106)
    ...
    @OriginalMember(owner = "client!wh", name = "d", descriptor = "(B)V", line = 118)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IZ)[[I", line = 146)
