...
public class class550 implements class432 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IZIJILaa;Lofa;II)V")
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Luq;Ljava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(I)Lkt;")
