...
public class class550 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIILr;II)V", line = 50)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(BZLjava/lang/String;J)V", line = 148)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(B)V", line = 223)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIIIIIIII)Z", line = 237)
