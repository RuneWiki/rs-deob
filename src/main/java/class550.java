...
public class class550 {
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(IBIIIILni;Lni;II)V", line = 10)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(BLdc;)Luw;", line = 81)
    ...
    @OriginalMember(owner = "client!sha", name = "b", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(BI)Lhk;", line = 131)
    ...
    @OriginalMember(owner = "client!sha", name = "c", descriptor = "(I)V", line = 160)
    ...
    @OriginalMember(owner = "client!sha", name = "<init>", descriptor = "(Lgp;ILuu;)V", line = 237)
