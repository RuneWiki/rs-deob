...
public class class550 implements class126 {
    ...
    @OriginalMember(owner = "client!afa", name = "b", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(B)Ljv;", line = 20)
    ...
    @OriginalMember(owner = "client!afa", name = "<init>", descriptor = "(Lrn;Lhv;IIIII)V", line = 39)
