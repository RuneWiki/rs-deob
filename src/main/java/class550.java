...
public class class550 extends class59 {
    ...
    @OriginalMember(owner = "client!cba", name = "fa", descriptor = "(CIIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(CIIIZLaa;II)V", line = 26)
    public final void method102(char arg0, int arg1, int arg2, int arg3, boolean arg4, class486 arg5, int arg6, int arg7) {
    }

    @OriginalMember(owner = "client!cba", name = "<init>", descriptor = "(Lsr;Lqm;[Ldga;Z)V", line = 30)
