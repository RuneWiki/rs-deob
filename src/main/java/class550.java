...
public class class550 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IILkga;)V", line = 11)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "(Lln;Lnw;Lum;IIIII)V", line = 239)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(B)V", line = 64)
