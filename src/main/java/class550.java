...
public class class550 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ILre;I)V")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(IILlr;)V")
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(Luca;Lpga;Lvfa;IIIII)V")
