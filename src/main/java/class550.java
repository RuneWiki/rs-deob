...
public class class550 implements class543 {
    ...
    @OriginalMember(owner = "client!um", name = "toString", descriptor = "()Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(I[S)[S", line = 27)
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 58)
