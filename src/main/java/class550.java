...
public class class550 extends class689 {
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Ldga;II[B)Lfb;", line = 4)
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "(Lrfa;)V", line = 49)
    public class550(class202 arg0) {
        super(arg0, false);
    }

    @OriginalMember(owner = "client!wv", name = "c", descriptor = "(B)V", line = 65)
