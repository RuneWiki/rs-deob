...
public class class550 extends class101 {
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(BLig;)I", line = 16)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(I)I", line = 59)
    ...
    @OriginalMember(owner = "client!baa", name = "<init>", descriptor = "([B)V", line = 77)
