...
public class class550 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(ZIILbt;III)V", line = 7)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IIIIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!sf", name = "<init>", descriptor = "(Len;III)V", line = 142)
