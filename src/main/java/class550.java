...
public class class550 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(II)[B", line = 4)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Z[B)V", line = 60)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(B)V", line = 107)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(ZI)I", line = 127)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lsea;II)Lvk;", line = 141)
