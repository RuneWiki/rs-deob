...
public class class550 extends class16 {
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(Liaa;I)Lbo;", line = 5)
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "(Lap;)V", line = 18)
    ...
    @OriginalMember(owner = "client!qs", name = "b", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(I)Z", line = 96)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IIZ)V", line = 107)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(ZB)V", line = 118)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(BZ)V", line = 155)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IILuda;)V", line = 168)
