...
public class class550 extends class415 {
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Lnba;Ljava/lang/Object;I)V", line = 4)
    public class550(class249 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field8212 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!ck", name = "g", descriptor = "(I)Z", line = 13)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 24)
