...
public class class550 extends class354 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!el", name = "c", descriptor = "(II)V", line = 16)
    ...
    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "(Lwo;)V", line = 28)
    public class550(class746 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!el", name = "b", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(II)I", line = 41)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IIIIIIIII)V", line = 77)
    ...
    @OriginalMember(owner = "client!el", name = "c", descriptor = "(I)Z", line = 90)
    ...
    @OriginalMember(owner = "client!el", name = "c", descriptor = "(B)I", line = 108)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "([B[BIIIIIII)V", line = 120)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "(ILwo;)V", line = 189)
