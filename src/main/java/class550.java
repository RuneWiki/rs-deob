...
public class class550 implements class22 {
    ...
    @OriginalMember(owner = "client!uba", name = "<init>", descriptor = "()V", line = 190)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IIZ)V", line = 10)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(I[I)V", line = 35)
    ...
    @OriginalMember(owner = "client!uba", name = "b", descriptor = "(II)V", line = 67)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(II)I", line = 79)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IB)V", line = 113)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IZLjava/awt/Component;I)V", line = 137)
