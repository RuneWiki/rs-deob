...
public class class550 {
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(I)I", line = 15)
    ...
    @OriginalMember(owner = "client!eba", name = "toString", descriptor = "()Ljava/lang/String;", line = 26)
    public final String toString() {
        field7512++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(BIIIIZI)V", line = 48)
    ...
    @OriginalMember(owner = "client!eba", name = "<init>", descriptor = "(II)V", line = 75)
