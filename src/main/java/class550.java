...
public class class550 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IZIZI)V", line = 57)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ILhr;)Z", line = 87)
