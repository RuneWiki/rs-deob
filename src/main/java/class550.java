...
public class class550 extends class616 implements class519 {
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(CI)Z", line = 18)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!eba", name = "b", descriptor = "(I)I", line = 40)
    public final int method503(int arg0) {
        field6901++;
        return arg0 == -3267 ? super.method503(-3267) : 59;
    }

    @OriginalMember(owner = "client!eba", name = "<init>", descriptor = "(Lel;Z)V", line = 51)
    public class550(class513 arg0, boolean arg1) {
        super(arg0, 34962, arg1);
    }

    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;", line = 55)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(B)Z", line = 66)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(IZ)Z", line = 77)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(ILjaclib/memory/Source;II)Z", line = 88)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(BLac;)V", line = 114)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(IBI)Z", line = 147)
