...
public class class341 implements IEnumModesCallback {
    ...
    @OriginalMember(owner = "client!ga", name = "callbackEnumModes", descriptor = "(Lcom/ms/directX/DDSurfaceDesc;Lcom/ms/com/IUnknown;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Ljava/awt/Frame;B)V", line = 20)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(I)[I", line = 32)
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "()V", line = 49)
    public class341() {
        this.field4360.initialize(null);
    }

    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(IIIZLjava/awt/Frame;I)V", line = 58)
