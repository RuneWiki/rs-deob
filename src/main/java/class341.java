...
public class class341 extends class756 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Lkp;I)V")
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(BLib;)V")
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IZLjava/net/Socket;)Lvt;")
