...
public class class341 extends class214 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(BI)[I", line = 8)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Llk;II)V", line = 41)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IIIBI)Z", line = 68)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "()V", line = 89)
    public class341() {
        this(4096);
    }

    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IIIIIII)I", line = 97)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ILjava/lang/String;Z)V", line = 142)
