...
public class class341 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(ZLvq;)V", line = 4)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Ltj;ILtj;Lvq;)V", line = 45)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(BI)Ljava/lang/String;", line = 61)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(II)V", line = 99)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(II[B)I", line = 111)
