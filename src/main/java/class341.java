...
public class class341 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IIII)I", line = 4)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IIIII)Z", line = 32)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Lqh;I)V", line = 79)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(I)Z", line = 93)
    ...
    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(I)V", line = 221)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(B)V", line = 325)
    ...
    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(Lih;)V", line = 595)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IFIIZIIIZ)[[I", line = 399)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Z)Z", line = 431)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(ILqh;)Z", line = 444)
    ...
    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(Z)V", line = 479)
    ...
    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(B)V", line = 510)
