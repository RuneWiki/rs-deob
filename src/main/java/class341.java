...
public class class341 extends class359 {
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!im", name = "b", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!im", name = "c", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(S)V", line = 70)
