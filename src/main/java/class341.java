...
public class class341 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(II)Lhga;")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Lin;I)V")
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(Lci;ILsea;Lsea;)V")
