...
public class class341 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(ILji;)Lhi;", line = 3)
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "(Lni;Lni;)V", line = 28)
    public class341(class522 arg0, class522 arg1) {
        this.field4590 = arg0;
        this.field4592 = arg1;
    }

    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Z)Lvv;", line = 37)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IIIILha;III)V", line = 51)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(BLtda;)Lrea;", line = 77)
