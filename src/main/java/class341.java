...
public class class341 {
    ...
    @OriginalMember(owner = "client!jn", name = "b", descriptor = "(II)Lhaa;", line = 16)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(B)V", line = 42)
    public static void method1978(byte arg0) {
        field4181 = null;
        int var1 = 91 % ((arg0 - 57) / 36);
    }

    @OriginalMember(owner = "client!jn", name = "b", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!jn", name = "<init>", descriptor = "(Lega;ILwm;)V", line = 101)
