...
public abstract class class341 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!ng", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 34)
    ...
    @OriginalMember(owner = "client!ng", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 54)
    public final void windowActivated(WindowEvent arg0) {
        field4709++;
    }

    @OriginalMember(owner = "client!ng", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 61)
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(I)Z", line = 77)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Z)Ljava/lang/String;", line = 88)
    ...
    @OriginalMember(owner = "client!ng", name = "stop", descriptor = "()V", line = 100)
    ...
    @OriginalMember(owner = "client!ng", name = "c", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!ng", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 152)
    public final void windowIconified(WindowEvent arg0) {
        field4731++;
    }

    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 160)
    ...
    @OriginalMember(owner = "client!ng", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 190)
    public final void windowOpened(WindowEvent arg0) {
        field4712++;
    }

    @OriginalMember(owner = "client!ng", name = "d", descriptor = "(I)V", line = 198)
    ...
    @OriginalMember(owner = "client!ng", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 245)
    ...
    @OriginalMember(owner = "client!ng", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 260)
    ...
    @OriginalMember(owner = "client!ng", name = "c", descriptor = "(Z)Z", line = 278)
    ...
    @OriginalMember(owner = "client!ng", name = "start", descriptor = "()V", line = 320)
    ...
    @OriginalMember(owner = "client!ng", name = "destroy", descriptor = "()V", line = 332)
    ...
    @OriginalMember(owner = "client!ng", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 347)
    ...
    @OriginalMember(owner = "client!ng", name = "e", descriptor = "(I)Z", line = 356)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IIILjava/lang/String;ZIII)V", line = 376)
    ...
    @OriginalMember(owner = "client!ng", name = "f", descriptor = "(I)Z", line = 422)
    ...
    @OriginalMember(owner = "client!ng", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 434)
    public final void update(Graphics arg0) {
        field4718++;
        this.paint(arg0);
    }

    @OriginalMember(owner = "client!ng", name = "h", descriptor = "(I)Z", line = 442)
    ...
    @OriginalMember(owner = "client!ng", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 457)
    public final void windowClosed(WindowEvent arg0) {
        field4707++;
    }

    @OriginalMember(owner = "client!ng", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 464)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(BZ)V", line = 490)
    ...
    @OriginalMember(owner = "client!ng", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 566)
    public final void focusLost(FocusEvent arg0) {
        class119.field1443 = false;
        field4725++;
    }

    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(BLht;)I", line = 575)
    ...
    @OriginalMember(owner = "client!ng", name = "j", descriptor = "(I)V", line = 597)
    ...
    @OriginalMember(owner = "client!ng", name = "provideLoaderApplet", descriptor = "(Ljava/applet/Applet;)V", line = 651)
    public static final void provideLoaderApplet(Applet arg0) {
        class213.field2800 = arg0;
        field4742++;
    }

    @OriginalMember(owner = "client!ng", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 663)
    public final void windowDeactivated(WindowEvent arg0) {
        field4732++;
    }

    @OriginalMember(owner = "client!ng", name = "run", descriptor = "()V", line = 672)
    ...
    @OriginalMember(owner = "client!ng", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 792)
    public final void windowDeiconified(WindowEvent arg0) {
        field4721++;
    }

    @OriginalMember(owner = "client!ng", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 807)
    public final void windowClosing(WindowEvent arg0) {
        this.destroy();
        field4717++;
    }

    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IIIILjava/lang/String;II)V", line = 817)
    ...
    @OriginalMember(owner = "client!ng", name = "c", descriptor = "(B)V", line = 867)
