...
public class class341 implements Runnable {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "([BLcw;BI)Llj;", line = 29)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Llj;I)V", line = 48)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lcw;II)Llj;", line = 76)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IZ)V", line = 108)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IIIB)V", line = 183)
    ...
    @OriginalMember(owner = "client!je", name = "run", descriptor = "()V", line = 213)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IIB)Ljava/lang/String;", line = 262)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(ILcw;B)Llj;", line = 303)
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "(Llp;)V", line = 332)
