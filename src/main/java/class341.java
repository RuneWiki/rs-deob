...
public class class341 extends class428 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ZLjava/lang/String;)Ljava/lang/String;", line = 15)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(I[IIII[IIILfn;IIIZII)I", line = 68)
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(B)V", line = 242)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(I)V", line = 255)
