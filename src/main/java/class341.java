...
public class class341 extends class263 {
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IZLgk;)V", line = 3)
    ...
    @OriginalMember(owner = "client!rd", name = "b", descriptor = "(IB)[[I", line = 50)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IB)[I", line = 128)
    ...
    @OriginalMember(owner = "client!rd", name = "c", descriptor = "(III)Lnu;", line = 174)
    ...
    @OriginalMember(owner = "client!rd", name = "d", descriptor = "(III)Z", line = 181)
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "()V", line = 194)
    public class341() {
        super(1, false);
    }
}
