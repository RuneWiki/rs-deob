...
public class class341 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ILbi;)Lbi;", line = 14)
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(I)V", line = 138)
