...
public class class341 extends class55 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IIZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!vu", name = "e", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(ZB)V", line = 51)
    public final void method197(boolean arg0, byte arg1) {
        int var3 = -44 % ((arg1 + 61) / 44);
    }

    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!vu", name = "g", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IZ)V", line = 142)
    ...
    @OriginalMember(owner = "client!vu", name = "c", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(I)V", line = 206)
    ...
    @OriginalMember(owner = "client!vu", name = "f", descriptor = "(I)Z", line = 225)
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "(Lul;Lnd;)V", line = 234)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IILfe;)V", line = 264)
    ...
    @OriginalMember(owner = "client!vu", name = "d", descriptor = "(I)V", line = 300)
