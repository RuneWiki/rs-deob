...
public class class341 extends class461 {
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(IJLha;ZB)V")
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(IJLha;)V")
    ...
    @OriginalMember(owner = "client!bia", name = "<init>", descriptor = "(Lha;Lfba;Lju;J)V")
