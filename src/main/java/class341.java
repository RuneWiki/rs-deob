...
public class class341 extends class297 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Lcea;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "()V", line = 46)
    public class341() {
        super(0, true);
    }

    @OriginalMember(owner = "client!gd", name = "f", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!gd", name = "c", descriptor = "(II)[I", line = 81)
