...
public class class341 extends class271 {
    ...
    @OriginalMember(owner = "client!un", name = "c", descriptor = "(I)Lnb;", line = 4)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(ILnb;FLnb;)V", line = 17)
    ...
    @OriginalMember(owner = "client!un", name = "d", descriptor = "(I)I", line = 102)
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(Lic;I)V", line = 110)
