...
public class class341 extends class488 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(CZ)Z", line = 20)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(B)I", line = 53)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IIBLjava/lang/Object;)[B", line = 98)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IIIIII)V", line = 129)
    ...
    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(I)V", line = 231)
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "(II[I[I)V", line = 272)
