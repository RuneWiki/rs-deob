...
public abstract class class341 {
    ...
    @OriginalMember(owner = "client!kda", name = "b", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(B)Z", line = 30)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(Z)Z", line = 45)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(BLhh;)I", line = 58)
    ...
    @OriginalMember(owner = "client!kda", name = "b", descriptor = "(B)Z", line = 94)
    ...
    @OriginalMember(owner = "client!kda", name = "c", descriptor = "(Z)J", line = 106)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(I)Z", line = 117)
