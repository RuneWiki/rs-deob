...
public class class341 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(B[BJ)V", line = 8)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "([BII)V", line = 110)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IZ)Z", line = 196)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(III)I", line = 210)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(B)V", line = 230)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Z)V", line = 345)
