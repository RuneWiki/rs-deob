...
public class class341 extends class355 {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Lpp;IIIIIIIIIIIZZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "()V", line = 26)
    ...
    @OriginalMember(owner = "client!u", name = "b", descriptor = "()V", line = 36)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(JI)V", line = 48)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(J)V", line = 443)
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "(Lpp;IIIIIIIIIIIZZ)V", line = 571)
