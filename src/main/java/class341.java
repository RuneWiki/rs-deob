...
public class class341 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Ljk;Luk;)V")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ZLpr;B)V")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IZIIB)Lfc;")
