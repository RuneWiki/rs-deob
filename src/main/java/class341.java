...
public class class341 {
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(I)Ltv;", line = 3)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(IB)V", line = 16)
    ...
    @OriginalMember(owner = "client!mga", name = "b", descriptor = "(I)I", line = 29)
    ...
    @OriginalMember(owner = "client!mga", name = "c", descriptor = "(I)Ltv;", line = 72)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(IIB)Z", line = 106)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(Lis;B)V", line = 120)
    ...
    @OriginalMember(owner = "client!mga", name = "<init>", descriptor = "()V", line = 167)
    public class341() {
    }

    @OriginalMember(owner = "client!mga", name = "<init>", descriptor = "(Lmo;)V", line = 169)
    public class341(class482 arg0) {
        this.field4735 = arg0;
    }

    @OriginalMember(owner = "client!mga", name = "d", descriptor = "(I)V", line = 177)
