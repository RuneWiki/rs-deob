...
public class class341 extends class5 {
    ...
    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "()V", line = 12)
    public class341() {
        super(0, true);
    }

    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(II)[I", line = 15)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!uq", name = "b", descriptor = "(IZI)I", line = 59)
    ...
    @OriginalMember(owner = "client!uq", name = "b", descriptor = "(II)V", line = 74)
