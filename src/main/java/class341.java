...
public class class341 {
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(IB)Lge;")
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(ZLac;Lac;BI)I")
    ...
    @OriginalMember(owner = "client!e", name = "<init>", descriptor = "(Ldn;ILr;Lr;)V")
