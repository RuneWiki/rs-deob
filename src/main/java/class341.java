...
public class class341 extends class313 {
    ...
    @OriginalMember(owner = "client!vk", name = "c", descriptor = "(I)Ljava/net/Socket;", line = 13)
    ...
    @OriginalMember(owner = "client!vk", name = "httpProxyConnect", descriptor = "(Ljava/lang/String;ILjava/lang/String;)Ljava/net/Socket;", line = 86)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Ljava/net/Proxy;B)Ljava/net/Socket;", line = 157)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 188)
