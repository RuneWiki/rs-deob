...
public class class341 extends class98 {
    ...
    @OriginalMember(owner = "client!fe", name = "c", descriptor = "(IBI)Lon;")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(IILjs;)V")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(ILdg;I)V")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(IZIII)V")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(IIIIIBLqe;Lae;)Lgj;")
