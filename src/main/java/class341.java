...
public class class341 extends class72 implements class274 {
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(IIZLjava/lang/String;Ljava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!vv", name = "b", descriptor = "(I)J", line = 54)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(BII[B)V", line = 65)
    ...
    @OriginalMember(owner = "client!vv", name = "c", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!vv", name = "<init>", descriptor = "(Lkv;I[BI)V", line = 89)
    public class341(class280 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field5061 = arg1;
    }

    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(I)I", line = 103)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(Z)I", line = 118)
