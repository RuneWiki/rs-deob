...
public class class341 extends class403 implements class635 {
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(Loea;ILjaclib/memory/Buffer;)V", line = 5)
    public class341(class594 arg0, int arg1, Buffer arg2) {
        super(arg0, arg2);
        this.field4792 = arg1;
    }

    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(B)I", line = 13)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(B)J", line = 36)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(Loea;I[BI)V", line = 52)
    public class341(class594 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field4792 = arg1;
    }

    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IIB[B)V", line = 60)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Z)I", line = 74)
