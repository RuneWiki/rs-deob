...
public class class341 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(III)Lip;", line = 15)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(I)Lwb;", line = 45)
    ...
    @OriginalMember(owner = "client!ll", name = "b", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!ll", name = "c", descriptor = "(I)Lwb;", line = 81)
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "()V", line = 107)
    public class341() {
        this.field4710.field4948 = this.field4710;
        this.field4710.field4947 = this.field4710;
    }

    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ILwb;)V", line = 118)
