...
public class class341 implements Runnable {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(B)Llf;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Ljava/awt/Point;BLjava/awt/Component;[III)Llf;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(I)Lkc;")
    public final class448 method2197(int arg0) {
        int var2 = -39 % ((22 - arg0) / 56);
        return this.field5014;
    }

    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Ljava/lang/String;I)Llf;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Ljava/awt/Component;IBI)Llf;")
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(I)Llf;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IBIII)Llf;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IB)Llf;")
    public final class350 method2204(int arg0, byte arg1) {
        int var3 = 8 / ((arg1 - 27) / 48);
        return this.method2218(3, 3, 0, (Object) null, arg0);
    }

    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IBLjava/lang/Object;II)Llf;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Ljava/lang/String;IZ)Llf;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ILjava/lang/Class;)Llf;")
    public final class350 method2207(int arg0, Class arg1) {
        return arg0 == 0 ? this.method2218(3, 20, 0, arg1, 0) : null;
    }

    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(BLjava/awt/Frame;)Llf;")
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(Ljava/lang/String;I)Llf;")
    public final class350 method2209(String arg0, int arg1) {
        return arg1 < 45 ? null : this.method2218(3, 21, 0, arg0, 0);
    }

    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;B)Llf;")
    public final class350 method2210(Transferable arg0, byte arg1) {
        int var3 = -88 / ((arg1 - 18) / 59);
        return this.method2218(3, 19, 0, arg0, 0);
    }

    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Ljava/lang/Class;B)Llf;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ILjava/lang/Runnable;I)Llf;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Ljava/net/URL;I)Llf;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ILjava/lang/String;[Ljava/lang/Class;Ljava/lang/Class;)Llf;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(BLjava/lang/Class;)Llf;")
    ...
    @OriginalMember(owner = "client!gt", name = "f", descriptor = "(I)Llf;")
    public final class350 method2217(int arg0) {
        return arg0 >= -93 ? null : this.method2218(3, 12, 0, (Object) null, 0);
    }

    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IIILjava/lang/Object;I)Llf;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IZLjava/awt/Component;)Llf;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Class;)Llf;")
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(B)Llf;")
