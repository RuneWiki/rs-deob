...
public class class341 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ZLce;)I")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lpi;B)[Lsda;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(BI)Lkba;")
    ...
    @OriginalMember(owner = "client!tt", name = "<init>", descriptor = "(Lmj;)V")
