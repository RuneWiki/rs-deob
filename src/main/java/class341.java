...
public class class341 extends class372 implements class41 {
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(IILya;)Lt;", line = 4)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lya;I)V", line = 26)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(I)I", line = 37)
    ...
    @OriginalMember(owner = "client!np", name = "d", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Z)I", line = 69)
    ...
    @OriginalMember(owner = "client!np", name = "c", descriptor = "(Z)I", line = 80)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(I)Z", line = 92)
    ...
    @OriginalMember(owner = "client!np", name = "c", descriptor = "(I)I", line = 106)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(ILya;)V", line = 122)
    ...
    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "(Lya;Lho;IIIIZIIIII)V", line = 150)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(IILya;)Lt;", line = 175)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(ZLya;)Llo;", line = 186)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(ILya;II)Z", line = 212)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 236)
    ...
    @OriginalMember(owner = "client!np", name = "g", descriptor = "(I)V", line = 250)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(ILya;)V", line = 260)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(BIZLya;)Ldp;", line = 289)
