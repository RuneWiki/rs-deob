...
public class class341 extends class187 {
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Z[[BBLbl;IILbl;Lvm;[[B[[BI[[I[[B)V", line = 3)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(II)Ljava/lang/String;", line = 28)
    ...
    @OriginalMember(owner = "client!pa", name = "f", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(BI)I", line = 86)
    ...
    @OriginalMember(owner = "client!pa", name = "g", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(BLtq;)V", line = 132)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Ltq;II)V", line = 156)
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(II)Z", line = 211)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IIBII)V", line = 234)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 250)
    ...
    @OriginalMember(owner = "client!pa", name = "c", descriptor = "(B)V", line = 284)
