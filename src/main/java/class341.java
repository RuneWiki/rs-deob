...
public class class341 extends class82 {
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "()V", line = 4)
    public class341() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Los;I)Lal;", line = 9)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "([BIIB)Ljava/lang/String;", line = 42)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!ns", name = "c", descriptor = "(II)[I", line = 93)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IILos;)V", line = 129)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(II)[[I", line = 147)
