...
public class class334 extends class410 {
    ...
    @OriginalMember(owner = "client!oq", name = "c", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!oq", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(B)Ljd;", line = 195)
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "(Ltl;Lpd;IIIIIIIIIIIIII)V", line = 207)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(II)V", line = 219)
