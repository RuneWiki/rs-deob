...
public class class334 {
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(IB)I", line = 6)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "([I)V", line = 191)
    ...
    @OriginalMember(owner = "client!mt", name = "b", descriptor = "(I)V", line = 226)
