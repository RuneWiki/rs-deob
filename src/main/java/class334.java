...
public class class334 {
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(BI)Ltba;")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Lrr;)V")
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(Lnb;ILoh;)V")
