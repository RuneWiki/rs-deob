...
public class class334 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Lvt;II)V", line = 49)
    ...
    @OriginalMember(owner = "client!so", name = "b", descriptor = "(B)V", line = 217)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(BLjava/lang/String;I)Ljava/lang/String;", line = 238)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Ljava/lang/String;Lkd;II)Lgj;", line = 257)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Loj;IZ)Lrg;", line = 340)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(ILeh;)Z", line = 379)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Lvt;B)V", line = 441)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(BLoj;)Lrg;", line = 461)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(III)I", line = 496)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Lg;Lg;I)V", line = 563)
