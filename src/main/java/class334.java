...
public abstract class class334 {
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(I)Z", line = 15)
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(I)Z", line = 33)
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(B)Z", line = 48)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(ZLst;)V", line = 59)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(BIIIII)V", line = 76)
    ...
    @OriginalMember(owner = "client!jr", name = "c", descriptor = "(B)V", line = 185)
    ...
    @OriginalMember(owner = "client!jr", name = "d", descriptor = "(B)Z", line = 203)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IB)Z", line = 216)
