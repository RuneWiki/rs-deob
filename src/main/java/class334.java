...
public class class334 extends class509 {
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IZ)V", line = 36)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IBI)V", line = 78)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(I)Z", line = 131)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ZB)V", line = 141)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ZILmn;)V", line = 158)
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(Lnca;Ldda;Lui;)V", line = 166)
    ...
    @OriginalMember(owner = "client!om", name = "c", descriptor = "(B)V", line = 184)
    ...
    @OriginalMember(owner = "client!om", name = "c", descriptor = "(I)V", line = 204)
