...
public class class334 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ILdg;I)V", line = 27)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IILdg;I)V", line = 47)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(BIII)I", line = 76)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ZLae;II)Lgj;", line = 100)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(I)Z", line = 152)
