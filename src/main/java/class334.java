...
public class class334 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ILjava/lang/String;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(IIIIB)V", line = 93)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(IIBII)I", line = 109)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(I)I", line = 122)
