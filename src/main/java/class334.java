...
public abstract class class334 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IILvs;)V", line = 12)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(II[ILvs;IIILvs;IZB)V", line = 59)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(I[IIIIZ[IIII)V", line = 94)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lii;ZIILdt;Z[ZLdt;[IIII)V", line = 195)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ILo;IZIIIII)V", line = 421)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lvs;IILvs;IBI[ZLvs;ILvs;IIZI)V", line = 541)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ZLvs;ILvs;IIIIB)V", line = 596)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(I)V", line = 644)
