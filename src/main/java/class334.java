...
public class class334 extends class9 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 15)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IIILjava/awt/Graphics;)V", line = 36)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IIBLjava/awt/Graphics;II)V", line = 46)
