...
public class class334 extends class47 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(BII)I", line = 17)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IB)V", line = 39)
    ...
    @OriginalMember(owner = "client!ct", name = "d", descriptor = "(I)I", line = 52)
    ...
    @OriginalMember(owner = "client!ct", name = "b", descriptor = "(Z)V", line = 65)
    ...
    @OriginalMember(owner = "client!ct", name = "e", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!ct", name = "c", descriptor = "(Z)I", line = 96)
    public final int method2105(boolean arg0) {
        ++field4646;
        return !arg0 ? 8 : (int) super.field6382;
    }

    @OriginalMember(owner = "client!ct", name = "f", descriptor = "(I)J", line = 119)
    public final long method2106(int arg0) {
        ++field4644;
        return arg0 != 13 ? 122L : super.field713 & Long.MAX_VALUE;
    }

    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "(II)V", line = 129)
