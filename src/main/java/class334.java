...
public class class334 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IIZI)I", line = 4)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(III)I", line = 45)
