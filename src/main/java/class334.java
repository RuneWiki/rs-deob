...
public class class334 extends class666 {
    ...
    @OriginalMember(owner = "client!vk", name = "h", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IC)Z", line = 15)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(II)[I", line = 27)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IB)[[I", line = 115)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ILiaa;Z)V", line = 247)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ILpi;)V", line = 296)
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "()V", line = 318)
    public class334() {
        super(1, false);
    }

    @OriginalMember(owner = "client!vk", name = "i", descriptor = "(I)V", line = 330)
