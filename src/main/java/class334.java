...
public class class334 extends class145 {
    ...
    @OriginalMember(owner = "client!nb", name = "e", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "()V", line = 22)
    public class334() {
        super(0, true);
    }

    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(II)Los;", line = 26)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Loo;Ltj;ILpe;)V", line = 49)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(II)[I", line = 199)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(ILjava/lang/String;)I", line = 229)
    ...
    @OriginalMember(owner = "client!nb", name = "c", descriptor = "(II)V", line = 254)
