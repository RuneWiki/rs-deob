...
public class class334 extends class30 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(BILac;)V", line = 14)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IB)[[I", line = 50)
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "()V", line = 119)
    public class334() {
        super(1, false);
    }

    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(II)[I", line = 126)
    ...
    @OriginalMember(owner = "client!bc", name = "d", descriptor = "(I)V", line = 182)
