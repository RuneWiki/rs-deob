...
public class class334 extends class477 {
    ...
    @OriginalMember(owner = "client!ls", name = "<init>", descriptor = "(Lgk;Lwl;)V", line = 9)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Ljava/lang/String;IILgk;)Lhd;", line = 31)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IIIZZ)Ldn;", line = 56)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(III)I", line = 78)
    ...
    @OriginalMember(owner = "client!ls", name = "c", descriptor = "(B)V", line = 112)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(B)Z", line = 125)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ZZ)V", line = 137)
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(B)V", line = 167)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(BII)V", line = 195)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Lrh;II)V", line = 223)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ZI)V", line = 240)
