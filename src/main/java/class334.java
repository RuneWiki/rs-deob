...
public abstract class class334 extends class766 {
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(B)V", line = 8)
    public static void method2048(byte arg0) {
        field4738 = null;
        int var1 = -57 % ((38 - arg0) / 48);
    }

    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(IILuf;)I", line = 17)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(IZLol;)V", line = 39)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(ZII)V", line = 49)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(Lnfa;[Lmfa;)V", line = 103)
    ...
    @OriginalMember(owner = "client!ica", name = "b", descriptor = "(B)V", line = 173)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(ZI)[[I", line = 185)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(II)[I", line = 196)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(III)[I", line = 207)
    ...
    @OriginalMember(owner = "client!ica", name = "b", descriptor = "(I)I", line = 228)
    ...
    @OriginalMember(owner = "client!ica", name = "b", descriptor = "(III)[[I", line = 239)
    ...
    @OriginalMember(owner = "client!ica", name = "f", descriptor = "(I)I", line = 274)
    public int method2054(int arg0) {
        field4746++;
        return arg0 == -21437 ? -1 : 3;
    }

    @OriginalMember(owner = "client!ica", name = "<init>", descriptor = "(IZ)V", line = 288)
