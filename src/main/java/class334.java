...
public class class334 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Ltl;B)V")
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(I)Lrl;")
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ILtl;I)V")
