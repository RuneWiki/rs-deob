...
public class class334 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(ZIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "(ILjt;Ljt;I)V", line = 427)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(II)[B", line = 56)
    ...
    @OriginalMember(owner = "client!ek", name = "toString", descriptor = "()Ljava/lang/String;", line = 136)
    public final String toString() {
        field4850++;
        return "Cache:" + this.field4846;
    }

    @OriginalMember(owner = "client!ek", name = "a", descriptor = "([BIIIZ)Z", line = 144)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IIBI)V", line = 267)
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "(I)V", line = 280)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(B[BII)Z", line = 394)
