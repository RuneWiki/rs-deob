...
public class class334 extends class105 {
    ...
    @OriginalMember(owner = "client!qq", name = "l", descriptor = "Lkh;")
    public static class13 field4414 = new class13(5000);

    @OriginalMember(owner = "client!qq", name = "A", descriptor = "I")
    public static int field4429;

    @OriginalMember(owner = "client!qq", name = "B", descriptor = "[[S")
    public static short[][] field4430;

    @OriginalMember(owner = "client!qq", name = "D", descriptor = "Z")
    public static boolean field4432;
    ...
    public static final void method1945(int arg0) {
        for (int var1 = arg0; ~var1 > ~class252.field3358.length; ++var1) {
            for (int var2 = 0; var2 < class252.field3358[0].length; ++var2) {
                for (int var3 = 0; ~class252.field3358[0][0].length < ~var3; ++var3) {
                    class252.field3358[var1][var2][var3] = 0;
                }
            }
        }
        ++field4423;
    ...
    public final void method638(int arg0, int arg1, int arg2) {
        ++field4427;
        int var4 = this.field4421 * arg1 >> 12;
        int var5 = this.field4425 * arg2 >> 12;
        int var6 = this.field4431 * arg1 >> 12;
        int var7 = this.field4428 * arg2 >> 12;
        int var8 = this.field4417 * arg1 >> 12;
        int var9 = this.field4422 * arg2 >> 12;
        if (arg0 < 4) {
            field4433 = null;
        }
        int var10 = this.field4415 * arg1 >> 12;
        int var11 = this.field4416 * arg2 >> 12;
        class211.method1346(19440, var8, super.field1411, var4, var11, var6, var10, var5, var9, var7);
    }

    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(BLza;)V")
    public static final void method1947(byte arg0, class287 arg1) {
        if (class483.field7125) {
            class104.method630((byte) -45, arg1);
        } else {
            class119.method711(arg1, (byte) 73);
        }
        if (arg0 < -78) {
            ++field4412;
        }
    ...
    public static final boolean method1948(byte arg0) {
        ++field4426;
        if (arg0 != 86) {
            return false;
        } else {
            return class401.field5807 != class287.field3779 || ~class509.field7372 <= -3;
        }
    }
    ...
    public final void method640(int arg0, int arg1, int arg2) {
        ++field4424;
        if (arg1 != -3686) {
            this.method638(-51, 110, -66);
        }
    }

    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ZI)V")
    public static final void method1949(boolean arg0, int arg1) {
        ++field4419;
        class514.method3065(-1, class372.field5051, class430.field6244, class168.field2174, arg0);
        if (arg1 != -28025) {
            method1946(false);
        }
    }

    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(BLfo;)I")
    public static final int method1950(byte arg0, class361 arg1) {
        if (arg0 != 57) {
            field4433 = null;
        }
        ++field4418;
        int var2 = 0;
        if (arg1.method2133(0, class36.field371)) {
            ++var2;
        }
        if (arg1.method2133(arg0 ^ 57, class339.field4486)) {
            ++var2;
        }
        return var2;
    }
