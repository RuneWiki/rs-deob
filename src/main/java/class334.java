...
public class class334 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IBIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ZB)V", line = 34)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(II)Lqa;", line = 120)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 156)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(I)V", line = 187)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IILsa;)Ljq;", line = 200)
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(I)Z", line = 228)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Len;Lra;BLra;)V", line = 248)
    ...
    @OriginalMember(owner = "client!ug", name = "c", descriptor = "(I)V", line = 264)
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(II)Lsq;", line = 291)
