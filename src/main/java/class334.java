...
public abstract class class334 {
    ...
    @OriginalMember(owner = "client!go", name = "c", descriptor = "(I)Lmo;", line = 10)
    ...
    @OriginalMember(owner = "client!go", name = "c", descriptor = "(B)Z", line = 37)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Ljava/awt/Canvas;B)Lcd;", line = 58)
    ...
    @OriginalMember(owner = "client!go", name = "e", descriptor = "(I)V", line = 82)
