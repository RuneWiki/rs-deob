...
public class class334 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Ljava/awt/Canvas;Ld;III)Lha;", line = 22)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IIIII)V", line = 34)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(B)Ltw;", line = 56)
