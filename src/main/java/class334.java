...
public class class334 extends class154 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(FB)V", line = 6)
    ...
    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "(IIIIIF)V", line = 20)
    public class334(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!mn", name = "d", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(III)B", line = 34)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IIII)V", line = 53)
