...
public class class334 extends class493 implements class459 {
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(Llm;II[III)V")
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(Llm;Lec;II[FII)V")
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(Llm;Lec;II[BII)V")
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(Llm;Lec;Lbt;II)V")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(I[BLec;IIIIII)V")
