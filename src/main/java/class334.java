...
public class class334 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Lkda;B)I")
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(ILqr;)V")
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(II)Lqr;")
    ...
    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(Lqr;)V")
