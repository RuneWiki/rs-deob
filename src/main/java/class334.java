...
public class class334 extends class667 {
    ...
    @OriginalMember(owner = "client!jo", name = "d", descriptor = "(Z)V", line = 106)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(ZI)[[I", line = 118)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 168)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(II)V", line = 186)
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(Z)V", line = 439)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Lud;II)V", line = 462)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(ZZ)V", line = 502)
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "()V", line = 527)
    public class334() {
        super(1, false);
    }
}
