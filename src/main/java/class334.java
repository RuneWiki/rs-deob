...
public class class334 extends class669 {
    ...
    @OriginalMember(owner = "client!vh", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "(Lej;Lmca;)V", line = 22)
    public class334(class111 arg0, class29 arg1) {
        super(arg0);
        this.field4588 = arg1;
    }

    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IILnq;)V", line = 31)
    ...
    @OriginalMember(owner = "client!vh", name = "b", descriptor = "(I)Z", line = 43)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(BII)V", line = 78)
    ...
    @OriginalMember(owner = "client!vh", name = "b", descriptor = "(Z)V", line = 122)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(ZZ)V", line = 136)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(ZI)V", line = 162)
