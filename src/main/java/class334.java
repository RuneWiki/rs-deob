...
public class class334 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(I)Lgk;", line = 21)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(JI)V", line = 41)
