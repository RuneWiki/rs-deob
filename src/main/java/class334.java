...
public class class334 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(BLfi;)V")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Lfh;I)Lub;")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ILfh;)Lqb;")
