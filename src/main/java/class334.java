...
public class class334 {
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(BLln;)I")
    ...
    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(BI)Lvb;")
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Lgia;ILaj;Ldd;)V")
