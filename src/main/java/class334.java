...
public class class334 extends class134 implements class55 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lqa;ZII)Ltt;")
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(Lqa;Lpk;IIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!bi", name = "c", descriptor = "(ILqa;)V")
    public final void method400(int arg0, class162 arg1) {
        ++field4552;
        int var3 = -122 % ((-29 - arg0) / 33);
    }

    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lqa;III)Z")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IILqa;)Lc;")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lqa;I)Lip;")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IILco;ILqa;ZZ)V")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lqa;BI)Lc;")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILqa;)V")
