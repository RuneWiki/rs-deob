...
public class class334 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Z)Lbr;", line = 4)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(I)V", line = 58)
    public class334(int arg0) {
        this.field4798 = arg0;
    }

    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(IIIIII)V", line = 65)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Lbr;B)V", line = 37)
