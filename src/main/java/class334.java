...
public class class334 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IILnt;Lwm;)V", line = 23)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIII)V", line = 136)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(II)Lcr;", line = 158)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(B)I", line = 188)
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(B)V", line = 202)
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(I)V", line = 218)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IZ)V", line = 240)
    ...
    @OriginalMember(owner = "client!ka", name = "<init>", descriptor = "(Lle;ILoi;)V", line = 265)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIIZII)V", line = 285)
