...
public class class334 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!tm", name = "b", descriptor = "(I)Z", line = 18)
    ...
    @OriginalMember(owner = "client!tm", name = "c", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(B)I", line = 41)
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(ZIIZ)V", line = 56)
    ...
    @OriginalMember(owner = "client!tm", name = "d", descriptor = "(I)V", line = 68)
