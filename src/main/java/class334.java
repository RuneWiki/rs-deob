...
public class class334 extends class210 {
    ...
    @OriginalMember(owner = "client!ug", name = "g", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "()V", line = 18)
    public class334() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IILat;)V", line = 31)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(II)[[I", line = 68)
