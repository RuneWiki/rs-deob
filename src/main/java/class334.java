...
public class class334 extends class86 {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ZILrt;)V", line = 5)
    ...
    @OriginalMember(owner = "client!qq", name = "e", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IBLid;IZII)V", line = 68)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Lfh;I)Ljava/lang/String;", line = 122)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(I[ILrt;III)V", line = 137)
    ...
    @OriginalMember(owner = "client!qq", name = "c", descriptor = "()I", line = 205)
    public final int method691() {
        field4207++;
        return 0;
    }

    @OriginalMember(owner = "client!qq", name = "a", descriptor = "([III)V", line = 215)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(I)V", line = 261)
    ...
    @OriginalMember(owner = "client!qq", name = "d", descriptor = "()Lhu;", line = 296)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "()Lhu;", line = 315)
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "(Lgj;)V", line = 356)
    public class334(class450 arg0) {
        this.field4206 = arg0;
    }

    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IIIIIIII[Lhd;I)V", line = 364)
