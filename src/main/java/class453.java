...
public class class453 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(BI)Lug;", line = 28)
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(IILew;)V", line = 102)
    ...
    @OriginalMember(owner = "client!ug", name = "toString", descriptor = "()Ljava/lang/String;", line = 128)
