...
public class class453 {
    ...
    @OriginalMember(owner = "client!oh", name = "finalize", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(III[B)I", line = 17)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(JB)V", line = 32)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(B)J", line = 60)
    ...
    @OriginalMember(owner = "client!oh", name = "b", descriptor = "(I)Ljava/io/File;", line = 70)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(IB[BI)V", line = 82)
