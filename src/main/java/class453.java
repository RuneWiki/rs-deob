...
public class class453 extends class179 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Ll;Lqs;B)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(III)Lec;")
    ...
    @OriginalMember(owner = "client!fh", name = "c", descriptor = "(B)[Lvi;")
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "(Lih;II[BI)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ILza;IIII)V")
