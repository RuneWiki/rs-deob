...
public class class453 implements class87 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Lsr;IBI)V")
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ILhp;I)V")
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(BLsr;I)V")
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IILlm;II)V")
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ILlm;IB)V")
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "(Lgk;)V")
