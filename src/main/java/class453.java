...
public class class453 {
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(Lgga;Z)Laq;", line = 7)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "([[IB)V", line = 99)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(IIIII)V", line = 116)
    ...
    @OriginalMember(owner = "client!daa", name = "toString", descriptor = "()Ljava/lang/String;", line = 145)
