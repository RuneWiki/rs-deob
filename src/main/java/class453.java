...
public class class453 extends class416 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IBLee;)V")
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ILwu;Z)Lhu;")
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Lee;B)V")
