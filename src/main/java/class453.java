...
public class class453 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(BLrk;I)V")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IIIIIZI)Laj;")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(III)Lrm;")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Lrk;B)V")
