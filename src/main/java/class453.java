...
public class class453 extends class584 {
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(ZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(ILld;B)V", line = 16)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(BI[F)[F", line = 28)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(ZZ)V", line = 46)
    ...
    @OriginalMember(owner = "client!mi", name = "g", descriptor = "(I)V", line = 56)
    public static void method2578(int arg0) {
        field6284 = null;
        int var1 = 67 % ((arg0 - 32) / 47);
    }

    @OriginalMember(owner = "client!mi", name = "c", descriptor = "(B)Z", line = 74)
    ...
    @OriginalMember(owner = "client!mi", name = "<init>", descriptor = "(Lfo;)V", line = 86)
    public class453(class473 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!mi", name = "h", descriptor = "(I)I", line = 89)
    ...
    @OriginalMember(owner = "client!mi", name = "f", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(III)V", line = 143)
