...
public class class453 extends class45 implements class247 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 11)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Ljava/lang/Exception;)V", line = 48)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "()V", line = 73)
