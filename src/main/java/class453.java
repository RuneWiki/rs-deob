...
public class class453 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(II)[[I", line = 27)
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(III)V", line = 189)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Z)V", line = 104)
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(I)I", line = 130)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(BII)Z", line = 150)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(B)[[[I", line = 163)
