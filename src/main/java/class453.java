...
public class class453 {
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(IIZIB[Ltp;)V", line = 19)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(III)V", line = 72)
