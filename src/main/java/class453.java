...
public class class453 extends class342 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(J)V", line = 6)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "()V", line = 134)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(JI)V", line = 143)
    ...
    @OriginalMember(owner = "client!oh", name = "b", descriptor = "()V", line = 539)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Lkp;IIIIIIIIIIIZZ)V", line = 550)
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(Lkp;IIIIIIIIIIIZZ)V", line = 571)
