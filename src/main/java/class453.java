...
public class class453 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(II)I", line = 13)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IB)I", line = 39)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(B[B)[B", line = 54)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IBII)I", line = 122)
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "(II)V", line = 152)
