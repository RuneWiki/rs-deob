...
public class class453 extends class433 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(FFFFFFLfa;II)V")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IILfa;II)V")
    ...
    @OriginalMember(owner = "client!sf", name = "<init>", descriptor = "(Lad;IIII)V")
    ...
    @OriginalMember(owner = "client!sf", name = "<init>", descriptor = "(Lad;II[III)V")
