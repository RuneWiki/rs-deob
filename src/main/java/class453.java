...
public class class453 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IILij;ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(II)Z", line = 46)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(I)Z", line = 63)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(I)Z", line = 175)
