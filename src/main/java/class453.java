...
public abstract class class453 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(I[BII)I", line = 3)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lkg;IBII)Z", line = 26)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(I)V", line = 159)
