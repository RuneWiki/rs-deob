...
public class class453 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(BLjava/lang/String;)I", line = 16)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "([BI)V", line = 51)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(B)V", line = 248)
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "([BI[B)V", line = 277)
