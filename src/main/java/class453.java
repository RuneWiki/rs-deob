...
public class class453 extends class264 {
    ...
    @OriginalMember(owner = "client!nja", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!nja", name = "b", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!nja", name = "b", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!nja", name = "c", descriptor = "(B)I", line = 40)
    ...
    @OriginalMember(owner = "client!nja", name = "<init>", descriptor = "(Lmfa;)V", line = 51)
    public class453(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!nja", name = "a", descriptor = "(BI)I", line = 54)
    ...
    @OriginalMember(owner = "client!nja", name = "<init>", descriptor = "(ILmfa;)V", line = 67)
    public class453(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!nja", name = "b", descriptor = "(BI)V", line = 100)
