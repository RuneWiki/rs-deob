...
public abstract class class453 {
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(III)Lnt;")
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "(Lfd;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "(Lfd;ILjaggl/memory/NativeBuffer;IZ)V")
