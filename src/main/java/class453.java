...
public class class453 extends class152 {
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(DLbt;IILd;ZI)[I")
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(IZBLd;DIZLbt;)[I")
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(Ld;Lbt;IIIZ)[F")
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(IIZLkq;)V")
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(BLd;Lbt;)Z")
    ...
    @OriginalMember(owner = "client!mea", name = "<init>", descriptor = "(Les;)V")
