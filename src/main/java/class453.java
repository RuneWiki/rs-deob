...
public class class453 extends class254 {
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IF)V", line = 3)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(FI)V", line = 20)
    ...
    @OriginalMember(owner = "client!uba", name = "<init>", descriptor = "(I)V", line = 40)
    public class453(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!uba", name = "z", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!uba", name = "A", descriptor = "(I)V", line = 71)
