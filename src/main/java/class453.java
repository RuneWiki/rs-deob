...
public class class453 extends class307 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IIIILuq;)V", line = 27)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(II)I", line = 67)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IIILga;)V", line = 98)
