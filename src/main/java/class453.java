...
public abstract class class453 {
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(II)V", line = 16)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(JB)I", line = 35)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "([JB[Ljava/lang/Object;)V", line = 52)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(III)Z", line = 67)
