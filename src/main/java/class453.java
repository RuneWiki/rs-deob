...
public class class453 implements Runnable {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Lrk;I)V", line = 16)
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(I)I", line = 29)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(B)I", line = 56)
    public final int method2770(byte arg0) {
        field6280++;
        return arg0 <= 42 ? 29 : this.field6285;
    }

    @OriginalMember(owner = "client!sc", name = "c", descriptor = "(I)Lcia;", line = 67)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(DI)V", line = 78)
    ...
    @OriginalMember(owner = "client!sc", name = "d", descriptor = "(I)J", line = 106)
    ...
    @OriginalMember(owner = "client!sc", name = "e", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!sc", name = "f", descriptor = "(I)Ljava/lang/String;", line = 131)
    ...
    @OriginalMember(owner = "client!sc", name = "g", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!sc", name = "h", descriptor = "(I)I", line = 157)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IJLjava/lang/String;ILcia;)V", line = 172)
    ...
    @OriginalMember(owner = "client!sc", name = "i", descriptor = "(I)Z", line = 188)
    ...
    @OriginalMember(owner = "client!sc", name = "run", descriptor = "()V", line = 200)
