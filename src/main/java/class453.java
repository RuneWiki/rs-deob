...
public class class453 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ILre;)V")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Lui;Ldi;Lui;Lui;I)Z")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IBLre;)V")
