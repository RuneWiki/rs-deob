...
public class class453 extends class326 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IILnk;I)V")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILbt;I)V")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Lbu;I[[B)V")
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(B)Las;")
