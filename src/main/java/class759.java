...
public class class759 {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Lvj;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(BI)V", line = 59)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(ILvj;)V", line = 162)
