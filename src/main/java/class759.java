...
public class class759 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lso;Z)V")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lr;III[Z)Z")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILso;I)V")
