...
public class class759 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lmj;Lha;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IZLwq;)V", line = 20)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(JIZIB)Ljava/lang/String;", line = 53)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lwq;I)V", line = 135)
