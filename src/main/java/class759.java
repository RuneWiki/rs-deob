...
public class class759 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IZ)I", line = 12)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(III)I", line = 55)
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(III)Z", line = 79)
    ...
    @OriginalMember(owner = "client!pf", name = "c", descriptor = "(III)Z", line = 89)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIIZ)I", line = 100)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIJZ)Ljava/lang/String;", line = 151)
    ...
    @OriginalMember(owner = "client!pf", name = "toString", descriptor = "()Ljava/lang/String;", line = 186)
