...
public class class759 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(IIILha;Lofa;)V")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Lov;I)V")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(ILdt;)Lar;")
    ...
    @OriginalMember(owner = "client!bo", name = "b", descriptor = "(Lov;I)Z")
    ...
    @OriginalMember(owner = "client!bo", name = "<init>", descriptor = "(Llf;)V")
