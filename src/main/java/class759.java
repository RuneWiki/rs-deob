...
public abstract class class759 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(ZI[B)V", line = 3)
    ...
    @OriginalMember(owner = "client!mp", name = "c", descriptor = "(I)[Ldp;", line = 31)
    ...
    @OriginalMember(owner = "client!mp", name = "finalize", descriptor = "()V", line = 44)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(ZII)V", line = 55)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(BJ)Ljava/lang/String;", line = 67)
    ...
    @OriginalMember(owner = "client!mp", name = "d", descriptor = "(I)Loaa;", line = 99)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(II)I", line = 114)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(Leea;I[BIZ)V", line = 125)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(Leea;ILjaclib/memory/Buffer;IZ)V", line = 145)
