...
public class class759 extends class238 {
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!sha", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 15)
    public class759(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(IIIIIII)I", line = 20)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(BLjagtheora/ogg/OggPacket;)V", line = 51)
    ...
    @OriginalMember(owner = "client!sha", name = "c", descriptor = "(B)V", line = 61)
