...
public class class759 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "([BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!tl", name = "<init>", descriptor = "(Ldw;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!tl", name = "<init>", descriptor = "(Ldw;Ljaclib/memory/Buffer;)V", line = 21)
