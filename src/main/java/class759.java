...
public class class759 extends class243 {
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(ILji;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!wia", name = "d", descriptor = "(III)I", line = 88)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(II)[I", line = 109)
    ...
    @OriginalMember(owner = "client!wia", name = "d", descriptor = "(B)V", line = 207)
    ...
    @OriginalMember(owner = "client!wia", name = "c", descriptor = "(I)V", line = 218)
    ...
    @OriginalMember(owner = "client!wia", name = "<init>", descriptor = "()V", line = 288)
    public class759() {
        super(0, true);
    }

    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(Z)V", line = 327)
