...
public class class759 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(IIILha;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!eca", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 33)
    public class759(Throwable arg0, String arg1) {
        this.field10595 = arg1;
        this.field10598 = arg0;
    }

    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(III)I", line = 54)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(I)V", line = 67)
