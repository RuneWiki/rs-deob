...
public abstract class class759 extends class65 {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(B)I", line = 9)
    ...
    @OriginalMember(owner = "client!vt", name = "e", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!vt", name = "f", descriptor = "(B)I", line = 33)
    ...
    @OriginalMember(owner = "client!vt", name = "g", descriptor = "(B)I", line = 44)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(ILgba;)I", line = 61)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(I)F", line = 90)
    public final float method4226(int arg0) {
        field10591++;
        return arg0 == 5 ? this.field10589 : -0.21725684F;
    }

    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "(IIIIIF)V", line = 102)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Z)I", line = 115)
    ...
    @OriginalMember(owner = "client!vt", name = "b", descriptor = "(I)I", line = 129)
