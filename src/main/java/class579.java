...
public class class579 extends class623 implements class686 {
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!gk", name = "b", descriptor = "(Z)V", line = 30)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IIII[[[B[I[I[I[I[IIBIIZZIIZ)V", line = 47)
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(Leq;III)V", line = 354)
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(Leq;IIII)V", line = 369)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(III)V", line = 330)
    ...
    @OriginalMember(owner = "client!gk", name = "finalize", descriptor = "()V", line = 341)
