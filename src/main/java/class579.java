...
public class class579 extends class297 {
    ...
    @OriginalMember(owner = "client!v", name = "b", descriptor = "(B)[Lfh;", line = 18)
    ...
    @OriginalMember(owner = "client!v", name = "f", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "()V", line = 255)
    public class579() {
        super(0, true);
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lcea;II)V", line = 49)
    ...
    @OriginalMember(owner = "client!v", name = "c", descriptor = "(II)[I", line = 117)
