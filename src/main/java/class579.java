...
public class class579 extends class152 implements class212 {
    ...
    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "(Lhk;ILjaclib/memory/Buffer;IZ)V")
    ...
    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "(Lhk;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IIILgj;)Ljf;")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Luv;II)V")
