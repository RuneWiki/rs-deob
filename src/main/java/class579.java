...
public class class579 extends class512 {
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Lsb;Lwu;Ljo;)V", line = 4)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lua;I)V", line = 21)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IIZ)V", line = 42)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(ZZ)V", line = 67)
    ...
    @OriginalMember(owner = "client!po", name = "e", descriptor = "(I)Z", line = 78)
    ...
    @OriginalMember(owner = "client!po", name = "f", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IZ)V", line = 107)
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IILlo;)V", line = 136)
