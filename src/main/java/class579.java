...
public class class579 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "([IIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "([I[IIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "([I[IIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "([I[IIIIIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(Lhr;)V")
