...
public class class579 extends class5 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IZ)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Z)V", line = 46)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IIIBIIIIII)V", line = 93)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(IBI)V", line = 110)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "()V", line = 184)
    public class579() {
        super(1, false);
    }

    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILes;I)V", line = 187)
