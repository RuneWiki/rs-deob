...
public class class579 extends class691 implements class129 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Ljaclib/memory/Source;IBI)Z")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "(Lnv;Z)V")
