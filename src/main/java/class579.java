...
public class class579 extends class714 {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(B)Lhl;", line = 5)
    ...
    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "(Lmp;Lfe;IIIIIIIII)V", line = 21)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(JI)V", line = 40)
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(I)V", line = 61)
