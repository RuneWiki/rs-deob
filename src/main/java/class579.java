...
public class class579 extends class568 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(III[I)V", line = 21)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(II[II)V", line = 35)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IIII)Z", line = 50)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(BII)Z", line = 78)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IBI)Z", line = 92)
    ...
    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "(IIIIIIIII)V", line = 107)
