...
public class class579 extends class321 {
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(I[B)Llc;", line = 11)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(IIIIZIII)V", line = 91)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(B)V", line = 138)
    ...
    @OriginalMember(owner = "client!ab", name = "e", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(ZC)I", line = 180)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(BC)I", line = 204)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Lgk;B)V", line = 229)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Lgk;II)V", line = 262)
