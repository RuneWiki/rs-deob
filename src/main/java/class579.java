...
public class class579 {
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(Lgt;I)V", line = 55)
