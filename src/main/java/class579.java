...
public class class579 {
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(Z)Lnp;", line = 5)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(II)I", line = 32)
    public static final int method3180(int arg0, int arg1) {
        return class612.field8277 == null ? 0 : class612.field8277[arg0][arg1] & 0xFFFF;
    }

    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(I)Lnp;", line = 39)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(Lnp;I)V", line = 60)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(B)I", line = 77)
    ...
    @OriginalMember(owner = "client!baa", name = "b", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!baa", name = "<init>", descriptor = "()V", line = 129)
    public class579() {
