...
public class class579 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(CB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IIII)I", line = 29)
