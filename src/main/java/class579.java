...
public class class579 extends class56 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "([Lbu;ILeea;)Laea;")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(ILee;I)V")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Ljava/lang/String;ZILjava/lang/String;)V")
