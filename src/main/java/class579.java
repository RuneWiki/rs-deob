...
public class class579 extends class128 {
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Lha;J)V")
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Lij;IIIIIIIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!iu", name = "<init>", descriptor = "(Lij;IIIIIIIIIIIZZ)V")
