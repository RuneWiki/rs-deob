...
public class class579 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(BILdga;)V", line = 3)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IILfa;Lfca;Loa;IIII)V", line = 32)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(B)V", line = 139)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ILdga;)V", line = 161)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(I)Z", line = 186)
