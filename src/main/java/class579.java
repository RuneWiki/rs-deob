...
public class class579 implements class643 {
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!vaa", name = "b", descriptor = "(III)V", line = 31)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(BII)V", line = 55)
    ...
    @OriginalMember(owner = "client!vaa", name = "b", descriptor = "(II)I", line = 84)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(B)V", line = 102)
    ...
    @OriginalMember(owner = "client!vaa", name = "b", descriptor = "(B)V", line = 131)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(IIZ)V", line = 149)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(IIB)V", line = 176)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(BZ)I", line = 209)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(II)I", line = 249)
