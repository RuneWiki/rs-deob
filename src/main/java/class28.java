...
public class class28 extends class43 {
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(I)Z", line = 8)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IIIII)V", line = 21)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(II)V", line = 43)
    ...
    @OriginalMember(owner = "client!rh", name = "c", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!rh", name = "d", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "()V", line = 158)
    public class28() {
    }

    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(ILwo;)V", line = 162)
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 170)
