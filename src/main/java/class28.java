...
@OriginalClass("client!LOPREVUC")
public class class28 {

    @OriginalMember(owner = "client!LOPREVUC", name = "a", descriptor = "Z")
    private boolean field992 = true;

    @OriginalMember(owner = "client!LOPREVUC", name = "b", descriptor = "I")
    private int field993 = 6;

    @OriginalMember(owner = "client!LOPREVUC", name = "c", descriptor = "LCJDGAOKT;")
    public class6 field994 = new class6();

    @OriginalMember(owner = "client!LOPREVUC", name = "d", descriptor = "LCJDGAOKT;")
    private class6 field995;

    @OriginalMember(owner = "client!LOPREVUC", name = "<init>", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!LOPREVUC", name = "a", descriptor = "(LCJDGAOKT;)V")
    ...
    @OriginalMember(owner = "client!LOPREVUC", name = "a", descriptor = "()LCJDGAOKT;")
    ...
    @OriginalMember(owner = "client!LOPREVUC", name = "b", descriptor = "()LCJDGAOKT;")
    ...
    @OriginalMember(owner = "client!LOPREVUC", name = "a", descriptor = "(I)LCJDGAOKT;")
    ...
    @OriginalMember(owner = "client!LOPREVUC", name = "c", descriptor = "()I")
