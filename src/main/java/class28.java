...
public class class28 extends class116 {
    ...
    @OriginalMember(owner = "client!bh", name = "e", descriptor = "()I", line = 3)
    public final synchronized int method220() {
        return this.field458.method2266(-1);
    }

    @OriginalMember(owner = "client!bh", name = "f", descriptor = "()V", line = 9)
    ...
    @OriginalMember(owner = "client!bh", name = "d", descriptor = "()Lei;", line = 29)
    public final class116 method222() {
        return (class116) this.field458.method2256(-123);
    }

    @OriginalMember(owner = "client!bh", name = "a", descriptor = "()I", line = 32)
    public final int method223() {
        return 0;
    }

    @OriginalMember(owner = "client!bh", name = "c", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Ljj;)V", line = 85)
    ...
    @OriginalMember(owner = "client!bh", name = "c", descriptor = "([III)V", line = 100)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Loo;Ljj;)V", line = 111)
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "()Lei;", line = 118)
    public final class116 method228() {
        return (class116) this.field458.method2257((byte) 108);
    }

    @OriginalMember(owner = "client!bh", name = "d", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Lei;)V", line = 136)
    public final synchronized void method230(class116 arg0) {
        this.field458.method2265((byte) -5, arg0);
    }

    @OriginalMember(owner = "client!bh", name = "b", descriptor = "([III)V", line = 143)
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(Lei;)V", line = 187)
