...
public class class28 extends class393 {
    ...
    @OriginalMember(owner = "client!sl", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(IZLjava/lang/Object;)[B", line = 16)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(ILvg;I)V", line = 63)
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "()V", line = 256)
    public class28() {
    }

    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "(J)V", line = 264)
