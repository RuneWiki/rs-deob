...
public class class28 {
    ...
    @OriginalMember(owner = "client!KJOXMCRE", name = "c", descriptor = "[LKJOXMCRE;")
    public static class28[] field1032;

    @OriginalMember(owner = "client!KJOXMCRE", name = "a", descriptor = "(LMNPBQFWE;B)V")
    ...
    @OriginalMember(owner = "client!KJOXMCRE", name = "a", descriptor = "(ILBJPWOXRJ;)V")
