...
public abstract class class28 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IZLqh;)V", line = 21)
    ...
    @OriginalMember(owner = "client!be", name = "b", descriptor = "(II)I", line = 177)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Lpi;III)V", line = 192)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(B)V", line = 221)
