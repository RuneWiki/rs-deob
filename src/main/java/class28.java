...
public class class28 extends class367 implements class231 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(ILqa;Z)Lr;")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lraa;)V")
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(ILqa;)Lkm;")
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Lqa;Ltk;IIIIIZIIIIII)V")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(BLqa;II)Z")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lqa;I)Lbi;")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(ZLqa;)V")
