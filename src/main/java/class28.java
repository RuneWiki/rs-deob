...
public class class28 extends class35 {
    ...
    @OriginalMember(owner = "client!HOSNGCXH", name = "<init>", descriptor = "(LTKEGJSFV;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!HOSNGCXH", name = "a", descriptor = "(ILDGXCFOYI;BI)V")
