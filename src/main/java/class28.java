...
public class class28 extends class481 implements class300 {
    ...
    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "(Lvg;IZ[[I)V")
    ...
    @OriginalMember(owner = "client!o", name = "b", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
    public final IDirect3DBaseTexture method130(int arg0) {
        return arg0 < 9 ? (IDirect3DBaseTexture) null : this.field350;
    }

    @OriginalMember(owner = "client!o", name = "a", descriptor = "(BLqaa;)V")
