...
public class class28 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(B)Lsd;")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(I)Lsd;")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Lsd;I)V")
