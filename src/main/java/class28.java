...
public class class28 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Lsi;ZI)V", line = 31)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Lsi;B)V", line = 114)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(I)Lhq;", line = 162)
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(I)V", line = 198)
