...
public class class28 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Lip;Lda;Z)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Lda;I)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Lgh;II)I")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(ILda;I)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(ILda;)V")
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(Lda;I)V")
