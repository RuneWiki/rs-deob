...
public class class28 extends class424 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(I)Z", line = 8)
    ...
    @OriginalMember(owner = "client!bo", name = "b", descriptor = "(I)V", line = 23)
    public static void method236(int arg0) {
        int var1 = -25 % ((arg0 + 54) / 57);
        field433 = null;
    }

    @OriginalMember(owner = "client!bo", name = "c", descriptor = "(B)V", line = 40)
