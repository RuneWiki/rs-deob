...
public class class28 extends class434 {
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!wm", name = "c", descriptor = "(I)D", line = 42)
    ...
    @OriginalMember(owner = "client!wm", name = "d", descriptor = "(B)Lpm;", line = 66)
    ...
    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 81)
    public class28(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Ljava/awt/Canvas;Ld;III)Lha;", line = 90)
    ...
    @OriginalMember(owner = "client!wm", name = "d", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;Z)V", line = 116)
