...
public class class28 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(II)V", line = 7)
    ...
    @OriginalMember(owner = "client!vo", name = "b", descriptor = "(II)I", line = 37)
    public static int method220(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!vo", name = "a", descriptor = "([BI)[B", line = 50)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(IZ)I", line = 118)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Z)V", line = 137)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 156)
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "(II)V", line = 165)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(IB)I", line = 231)
