...
public class class28 extends class627 {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(B)I", line = 7)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(I)Z", line = 18)
    ...
    @OriginalMember(owner = "client!bw", name = "b", descriptor = "(B)V", line = 29)
    public static void method287(byte arg0) {
        int var1 = 113 / ((arg0 - 63) / 34);
        field464 = null;
    }

    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(II)Z", line = 38)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Z)Z", line = 50)
    ...
    @OriginalMember(owner = "client!bw", name = "e", descriptor = "(B)Z", line = 70)
    ...
    @OriginalMember(owner = "client!bw", name = "b", descriptor = "(I)I", line = 82)
    ...
    @OriginalMember(owner = "client!bw", name = "<init>", descriptor = "(II)V", line = 92)
