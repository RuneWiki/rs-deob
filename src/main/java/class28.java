...
public class class28 extends class423 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(BLct;)V")
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IIIIILfp;IIIBI[[[BI)V")
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IIII)Lva;")
