...
public class class28 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lir;I)Z")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lfca;B)V")
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Lfca;)V")
