...
public class class28 {
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(ILqb;)V")
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Lbk;II)V")
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Lbk;I)V")
