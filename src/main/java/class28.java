...
public class class28 implements class563 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(I)Lrba;", line = 4)
    ...
    @OriginalMember(owner = "client!jf", name = "c", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!jf", name = "d", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Lga;Ljava/lang/String;)V", line = 49)
    public class28(class332 arg0, String arg1) {
        this.field404 = arg1;
        this.field410 = arg0;
    }

    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(II)V", line = 58)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(JZ)V", line = 206)
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(I)I", line = 230)
