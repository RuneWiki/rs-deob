...
public class class28 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(JB)Ljq;", line = 8)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(ILjq;J)V", line = 36)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Z)V", line = 57)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(I)Ljq;", line = 73)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(B)V", line = 111)
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "(I)V", line = 132)
