...
public class class28 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Luc;I)V", line = 41)
    ...
    @OriginalMember(owner = "client!uc", name = "b", descriptor = "(I)Luc;", line = 56)
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "(I)V", line = 139)
    public class28(int arg0) {
        this.field218 = arg0;
    }

    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "(IIIIII)V", line = 146)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(BI)I", line = 76)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(BLjava/lang/String;)V", line = 109)
