...
public class class28 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Lr;III[Z)Z", line = 30)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(II)V", line = 69)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(I)V", line = 80)
