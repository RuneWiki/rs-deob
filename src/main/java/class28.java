...
public class class28 extends class10 implements Runnable {
    ...
    @OriginalMember(owner = "client!JHGVYYQH", name = "b", descriptor = "LUEUHLQTT;")
    ...
    @OriginalMember(owner = "client!JHGVYYQH", name = "f", descriptor = "LUEUHLQTT;")
    ...
    @OriginalMember(owner = "client!JHGVYYQH", name = "k", descriptor = "LUEUHLQTT;")
    ...
    @OriginalMember(owner = "client!JHGVYYQH", name = "z", descriptor = "LHIGYXWXY;")
    ...
    @OriginalMember(owner = "client!JHGVYYQH", name = "G", descriptor = "LUEUHLQTT;")
    ...
    @OriginalMember(owner = "client!JHGVYYQH", name = "N", descriptor = "LUEUHLQTT;")
    ...
    @OriginalMember(owner = "client!JHGVYYQH", name = "H", descriptor = "LMNWUSGDU;")
    private class35 field956;

    @OriginalMember(owner = "client!JHGVYYQH", name = "s", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!JHGVYYQH", name = "a", descriptor = "()LMNWUSGDU;")
    ...
    @OriginalMember(owner = "client!JHGVYYQH", name = "a", descriptor = "(LMNWUSGDU;Z)V")
    ...
    @OriginalMember(owner = "client!JHGVYYQH", name = "a", descriptor = "(LTXPLZUUI;Lclient;)V")
