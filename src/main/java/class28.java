...
public class class28 extends class431 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Lrn;I)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(BLiq;)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Liq;B)V")
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(BLiq;)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(FZILna;B)V")
