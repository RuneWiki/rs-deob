...
@OriginalClass("client!LDWABQSV")
public class class28 extends class40 {

    @OriginalMember(owner = "client!LDWABQSV", name = "j", descriptor = "Z")
    private boolean field885 = false;

    @OriginalMember(owner = "client!LDWABQSV", name = "l", descriptor = "I")
    public int field887 = 1000;

    @OriginalMember(owner = "client!LDWABQSV", name = "m", descriptor = "Z")
    public static boolean field888;

    @OriginalMember(owner = "client!LDWABQSV", name = "k", descriptor = "[LEOYNCIUW;")
    public class11[] field886;

    @OriginalMember(owner = "client!LDWABQSV", name = "a", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!LDWABQSV", name = "a", descriptor = "(I)LNJPATAFL;")
