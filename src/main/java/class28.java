...
public class class28 extends class13 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Lkh;BI)V")
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ILij;)V")
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ZIII)Lks;")
