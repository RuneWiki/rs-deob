...
public class class28 extends class601 {
    ...
    @OriginalMember(owner = "client!o", name = "d", descriptor = "(Z)Lk;", line = 4)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(BI)[I", line = 19)
    ...
    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "()V", line = 265)
    public class28() {
        super(2, false);
    }

    @OriginalMember(owner = "client!o", name = "a", descriptor = "(B)V", line = 268)
    ...
    @OriginalMember(owner = "client!o", name = "e", descriptor = "(I)V", line = 285)
    ...
    @OriginalMember(owner = "client!o", name = "b", descriptor = "(IZ)[[I", line = 297)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Lee;BI)V", line = 614)
