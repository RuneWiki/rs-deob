...
public class class28 {
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(ZI)V", line = 31)
    ...
    @OriginalMember(owner = "client!jf", name = "c", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!jf", name = "d", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Lrf;ILpl;)V", line = 232)
    public class28(class112 arg0, int arg1, class612 arg2) {
        this.field406 = arg2;
        this.field406.method3349(1, true);
    }

    @OriginalMember(owner = "client!jf", name = "e", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(ZI)Lgda;", line = 203)
