...
public class class28 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(II)Loga;", line = 48)
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Lpj;Ld;)V", line = 216)
    public class28(class156 arg0, class160 arg1) {
        this.field410 = arg0;
        this.field405 = arg1;
    }

    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Ljava/lang/String;IZLjava/lang/String;ZII)V", line = 101)
