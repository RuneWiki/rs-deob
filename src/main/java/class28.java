...
@OriginalClass("client!IWTQKRSS")
public class class28 {

    @OriginalMember(owner = "client!IWTQKRSS", name = "a", descriptor = "Z")
    private boolean field930 = true;

    @OriginalMember(owner = "client!IWTQKRSS", name = "f", descriptor = "I")
    public int field935 = -1;

    @OriginalMember(owner = "client!IWTQKRSS", name = "g", descriptor = "Z")
    public boolean field936 = false;

    @OriginalMember(owner = "client!IWTQKRSS", name = "h", descriptor = "Z")
    public boolean field937 = true;

    @OriginalMember(owner = "client!IWTQKRSS", name = "b", descriptor = "I")
    public static int field931;

    @OriginalMember(owner = "client!IWTQKRSS", name = "e", descriptor = "I")
    public int field934;

    @OriginalMember(owner = "client!IWTQKRSS", name = "i", descriptor = "I")
    public int field938;

    @OriginalMember(owner = "client!IWTQKRSS", name = "j", descriptor = "I")
    public int field939;

    @OriginalMember(owner = "client!IWTQKRSS", name = "k", descriptor = "I")
    public int field940;

    @OriginalMember(owner = "client!IWTQKRSS", name = "l", descriptor = "I")
    public int field941;

    @OriginalMember(owner = "client!IWTQKRSS", name = "m", descriptor = "I")
    public int field942;

    @OriginalMember(owner = "client!IWTQKRSS", name = "n", descriptor = "I")
    public int field943;

    @OriginalMember(owner = "client!IWTQKRSS", name = "d", descriptor = "Ljava/lang/String;")
    public String field933;

    @OriginalMember(owner = "client!IWTQKRSS", name = "c", descriptor = "[LIWTQKRSS;")
    public static class28[] field932;

    @OriginalMember(owner = "client!IWTQKRSS", name = "a", descriptor = "(ZLXMRRKSSB;)V")
    ...
    @OriginalMember(owner = "client!IWTQKRSS", name = "a", descriptor = "(LXQPFGONL;I)V")
    ...
    @OriginalMember(owner = "client!IWTQKRSS", name = "a", descriptor = "(ZI)V")
    ...
    @OriginalMember(owner = "client!IWTQKRSS", name = "a", descriptor = "(III)I")
