...
public class class28 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Lvh;I)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Lir;II)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(ZLjava/awt/Component;)Loo;")
