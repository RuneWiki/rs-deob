...
public class class28 extends class456 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(II)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(ILvg;I)V", line = 136)
    ...
    @OriginalMember(owner = "client!oo", name = "b", descriptor = "(B)V", line = 157)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IBLre;)V", line = 170)
    ...
    @OriginalMember(owner = "client!oo", name = "b", descriptor = "(II)[I", line = 214)
    ...
    @OriginalMember(owner = "client!oo", name = "c", descriptor = "(II)V", line = 305)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Ljava/lang/String;ZB)V", line = 328)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(ILje;)Lje;", line = 423)
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "()V", line = 466)
    public class28() {
        super(1, false);
    }

    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Lre;I)Llb;", line = 454)
