...
public class class28 extends class98 {
    ...
    @OriginalMember(owner = "client!gs", name = "f", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!gs", name = "e", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ZI)V", line = 138)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "()V", line = 391)
    public class28() {
        super(1, false);
    }

    @OriginalMember(owner = "client!gs", name = "f", descriptor = "(I)V", line = 398)
    ...
    @OriginalMember(owner = "client!gs", name = "g", descriptor = "(I)V", line = 423)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ILdg;I)V", line = 447)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IIILtn;Ltn;)V", line = 488)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(II)[[I", line = 517)
