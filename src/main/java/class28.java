...
public class class28 extends class159 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(B)Lni;", line = 6)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "()V", line = 68)
    ...
    @OriginalMember(owner = "client!uc", name = "c", descriptor = "(I)V", line = 81)
    public static void method203(int arg0) {
        int var1 = -55 % ((arg0 - 81) / 44);
        field389 = null;
    }

    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "(Loea;IIIIII)V", line = 94)
