...
@OriginalClass("client!HYUBDXHD")
public class class28 extends class63 {

    @OriginalMember(owner = "client!HYUBDXHD", name = "p", descriptor = "Z")
    public boolean field933 = false;

    @OriginalMember(owner = "client!HYUBDXHD", name = "q", descriptor = "Z")
    private boolean field934 = false;

    @OriginalMember(owner = "client!HYUBDXHD", name = "l", descriptor = "LFULHVSIU;")
    private class21 field929;

    @OriginalMember(owner = "client!HYUBDXHD", name = "r", descriptor = "I")
    public int field935;

    @OriginalMember(owner = "client!HYUBDXHD", name = "s", descriptor = "I")
    public int field936;

    @OriginalMember(owner = "client!HYUBDXHD", name = "t", descriptor = "I")
    public int field937;

    @OriginalMember(owner = "client!HYUBDXHD", name = "u", descriptor = "I")
    public int field938;

    @OriginalMember(owner = "client!HYUBDXHD", name = "m", descriptor = "I")
    public int field930;

    @OriginalMember(owner = "client!HYUBDXHD", name = "n", descriptor = "I")
    private int field931;

    @OriginalMember(owner = "client!HYUBDXHD", name = "o", descriptor = "I")
    private int field932;

    @OriginalMember(owner = "client!HYUBDXHD", name = "a", descriptor = "(BI)V")
    ...
    @OriginalMember(owner = "client!HYUBDXHD", name = "a", descriptor = "(I)LKPUOCBCE;")
    ...
    @OriginalMember(owner = "client!HYUBDXHD", name = "<init>", descriptor = "(IIIIIIII)V")
