...
public class class28 implements Runnable {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Lis;I)V")
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(ILhca;I)Lis;")
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(ILhca;I)Lis;")
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "([BZILhca;)Lis;")
    ...
    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "(Lmr;)V")
