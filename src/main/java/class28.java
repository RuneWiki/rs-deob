...
public class class28 extends class14 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IBLmd;)V", line = 3)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IB)[I", line = 90)
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(B)V", line = 201)
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "()V", line = 401)
    public class28() {
        super(0, true);
    }

    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(II)Z", line = 218)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IIIZ)I", line = 280)
    ...
    @OriginalMember(owner = "client!bh", name = "e", descriptor = "(I)V", line = 301)
    ...
    @OriginalMember(owner = "client!bh", name = "f", descriptor = "(I)V", line = 365)
