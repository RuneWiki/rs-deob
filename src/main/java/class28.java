...
public class class28 extends class386 implements class529 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(ZLya;)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IZILya;)Lmg;")
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(Lya;I)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Lya;II)Lt;")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Lya;I)V")
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "(Lya;Lrd;IIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IILya;I)Z")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(ILya;B)Lt;")
    ...
    @OriginalMember(owner = "client!bh", name = "c", descriptor = "(Lya;I)Lfk;")
