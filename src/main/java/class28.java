...
public class class28 extends class319 {
    ...
    @OriginalMember(owner = "client!nf", name = "h", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!nf", name = "d", descriptor = "(Z)V", line = 31)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(BC)Z", line = 44)
    ...
    @OriginalMember(owner = "client!nf", name = "C", descriptor = "(I)Lrg;", line = 67)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(BI[BI)V", line = 78)
    ...
    @OriginalMember(owner = "client!nf", name = "o", descriptor = "(II)V", line = 96)
    ...
    @OriginalMember(owner = "client!nf", name = "i", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!nf", name = "j", descriptor = "(B)V", line = 126)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "([IB)V", line = 159)
    ...
    @OriginalMember(owner = "client!nf", name = "p", descriptor = "(II)I", line = 170)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(III)I", line = 200)
    ...
    @OriginalMember(owner = "client!nf", name = "D", descriptor = "(I)V", line = 222)
    ...
    @OriginalMember(owner = "client!nf", name = "E", descriptor = "(I)Z", line = 233)
    ...
    @OriginalMember(owner = "client!nf", name = "<init>", descriptor = "(I)V", line = 253)
    public class28(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!nf", name = "c", descriptor = "(BI)I", line = 257)
