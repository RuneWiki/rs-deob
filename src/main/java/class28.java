...
@OriginalClass("client!KVKPXLHS")
public class class28 {

    @OriginalMember(owner = "client!KVKPXLHS", name = "a", descriptor = "Z")
    private boolean field835 = true;

    @OriginalMember(owner = "client!KVKPXLHS", name = "b", descriptor = "B")
    private byte field836 = 2;

    @OriginalMember(owner = "client!KVKPXLHS", name = "c", descriptor = "[I")
    public int[] field837 = new int[2];

    @OriginalMember(owner = "client!KVKPXLHS", name = "d", descriptor = "[[[I")
    public int[][][] field838 = new int[2][2][4];

    @OriginalMember(owner = "client!KVKPXLHS", name = "e", descriptor = "[[[I")
    public int[][][] field839 = new int[2][2][4];

    @OriginalMember(owner = "client!KVKPXLHS", name = "f", descriptor = "[I")
    public int[] field840 = new int[2];

    @OriginalMember(owner = "client!KVKPXLHS", name = "g", descriptor = "[[F")
    public static float[][] field841 = new float[2][8];

    @OriginalMember(owner = "client!KVKPXLHS", name = "h", descriptor = "[[I")
    public static int[][] field842 = new int[2][8];

    @OriginalMember(owner = "client!KVKPXLHS", name = "i", descriptor = "F")
    public static float field843;

    @OriginalMember(owner = "client!KVKPXLHS", name = "j", descriptor = "I")
    public static int field844;

    @OriginalMember(owner = "client!KVKPXLHS", name = "a", descriptor = "(IIFI)F")
    ...
    @OriginalMember(owner = "client!KVKPXLHS", name = "a", descriptor = "(IF)F")
    ...
    @OriginalMember(owner = "client!KVKPXLHS", name = "a", descriptor = "(IFII)F")
    ...
    @OriginalMember(owner = "client!KVKPXLHS", name = "a", descriptor = "(IZF)I")
    ...
    @OriginalMember(owner = "client!KVKPXLHS", name = "a", descriptor = "(BLRPKBYPNF;LMQZHAILV;)V")
