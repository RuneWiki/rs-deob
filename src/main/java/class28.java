...
public class class28 implements Runnable {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ZLjava/lang/String;)Z", line = 18)
    ...
    @OriginalMember(owner = "client!o", name = "b", descriptor = "(B)Z", line = 29)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Z)Lnw;", line = 40)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(I)J", line = 51)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IZ)V", line = 62)
    ...
    @OriginalMember(owner = "client!o", name = "b", descriptor = "(Z)V", line = 129)
    ...
    @OriginalMember(owner = "client!o", name = "c", descriptor = "(I)I", line = 151)
    ...
    @OriginalMember(owner = "client!o", name = "d", descriptor = "(I)I", line = 166)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ILwl;)V", line = 177)
    ...
    @OriginalMember(owner = "client!o", name = "c", descriptor = "(B)I", line = 191)
    ...
    @OriginalMember(owner = "client!o", name = "e", descriptor = "(I)Ljava/lang/String;", line = 218)
    public final String method277(int arg0) {
        field351++;
        return arg0 > -26 ? null : this.field359;
    }

    @OriginalMember(owner = "client!o", name = "a", descriptor = "(JLjava/lang/String;IILnw;)V", line = 230)
    ...
    @OriginalMember(owner = "client!o", name = "run", descriptor = "()V", line = 244)
