...
public class class28 extends class147 {
    ...
    @OriginalMember(owner = "client!cg", name = "O", descriptor = "Llf;")
    public static class109 field611 = class35.method275("(U1", 2);

    @OriginalMember(owner = "client!cg", name = "S", descriptor = "Llf;")
    public static class109 field615 = class35.method275("(U(Y", 2);

    @OriginalMember(owner = "client!cg", name = "L", descriptor = "Lrc;")
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(IILja;I)V")
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(BILja;)V")
