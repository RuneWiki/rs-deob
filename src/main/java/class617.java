...
public class class617 implements class531 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;III)V", line = 3)
    ...
    @OriginalMember(owner = "client!a", name = "finalize", descriptor = "()V", line = 63)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "()V", line = 69)
    private final void method3504() {
        this.method3497(this.nativeid);
    }

    @OriginalMember(owner = "client!a", name = "w", descriptor = "(Z)V", line = 72)
    public final void method83(boolean arg0) {
        this.method3499(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Ldfa;[III)V", line = 77)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lha;[I[I[I[SI)V", line = 82)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Ldfa;[II)V", line = 85)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILdfa;ZI)Z", line = 88)
    ...
    @OriginalMember(owner = "client!a", name = "b", descriptor = "()V", line = 97)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;II)V", line = 104)
    ...
    @OriginalMember(owner = "client!a", name = "d", descriptor = "()V", line = 107)
    public final void method3517() {
        this.field8843 = Thread.currentThread();
        this.method3504();
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;IIIIIII[[Z)V", line = 112)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILdfa;Z)Z", line = 118)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lha;IIIIIII)V", line = 121)
    ...
    @OriginalMember(owner = "client!a", name = "<init>", descriptor = "(Loa;II)V", line = 126)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;[ILdfa;)V", line = 141)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lka;IIIZ)V", line = 145)
