...
public class class617 extends class190 implements class599 {
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(BILwv;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(Lr;Z)V", line = 78)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(ILir;ZILr;IB)V", line = 89)
    ...
    @OriginalMember(owner = "client!bv", name = "l", descriptor = "(I)I", line = 119)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(BLr;)Lqw;", line = 130)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(Lr;B)V", line = 159)
    ...
    @OriginalMember(owner = "client!bv", name = "b", descriptor = "(IIIIII)I", line = 186)
    ...
    @OriginalMember(owner = "client!bv", name = "<init>", descriptor = "(Lr;Ltc;IIIIIZIIZ)V", line = 249)
    ...
    @OriginalMember(owner = "client!bv", name = "b", descriptor = "(I)Z", line = 282)
    public final boolean method705(int arg0) {
        ++field8565;
        return arg0 < 67 ? true : this.field8544;
    }

    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(IILr;)Lda;", line = 296)
    ...
    @OriginalMember(owner = "client!bv", name = "b", descriptor = "(Lr;I)Lcu;", line = 319)
    ...
    @OriginalMember(owner = "client!bv", name = "i", descriptor = "(I)Z", line = 335)
    public final boolean method166(int arg0) {
        ++field8564;
        return arg0 != 0 ? true : this.field8549;
    }

    @OriginalMember(owner = "client!bv", name = "f", descriptor = "(I)Z", line = 349)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(I)V", line = 361)
    ...
    @OriginalMember(owner = "client!bv", name = "n", descriptor = "(I)V", line = 377)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(Lr;I)V", line = 388)
    ...
    @OriginalMember(owner = "client!bv", name = "c", descriptor = "(I)I", line = 423)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(ZLkba;)V", line = 436)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(B)I", line = 467)
    ...
    @OriginalMember(owner = "client!bv", name = "j", descriptor = "(I)Z", line = 479)
    ...
    @OriginalMember(owner = "client!bv", name = "c", descriptor = "(B)V", line = 498)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(ZLr;II)Z", line = 513)
    ...
    @OriginalMember(owner = "client!bv", name = "b", descriptor = "(B)I", line = 535)
    ...
    @OriginalMember(owner = "client!bv", name = "d", descriptor = "(B)I", line = 547)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(IILr;Z)Lht;", line = 559)
