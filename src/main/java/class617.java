...
public class class617 extends class640 {
    ...
    @OriginalMember(owner = "client!wfa", name = "<init>", descriptor = "(Lnga;[III)V")
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "([I[III)V")
    ...
    @OriginalMember(owner = "client!wfa", name = "<init>", descriptor = "(Lnga;II)V")
    ...
    @OriginalMember(owner = "client!wfa", name = "<init>", descriptor = "(Lnga;[IIIII)V")
