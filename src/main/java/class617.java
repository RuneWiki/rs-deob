...
public abstract class class617 extends class421 {
    ...
    @OriginalMember(owner = "client!nu", name = "b", descriptor = "(ILha;)Z")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(ZLje;IIILha;I)V")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(I[Lqm;)I")
