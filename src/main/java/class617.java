...
public class class617 implements Runnable {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ILpk;Z)Ljba;")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(BLpk;I)Ljba;")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(BLjba;)V")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Lpk;[BII)Ljba;")
    ...
    @OriginalMember(owner = "client!tl", name = "<init>", descriptor = "(Lvk;)V")
