...
public class class617 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IZ)Lgr;", line = 28)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IB)V", line = 58)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(FFZIF)F", line = 72)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Lkda;Lkda;ILkda;Lkda;)V", line = 96)
    ...
    @OriginalMember(owner = "client!rl", name = "<init>", descriptor = "(Lbt;ILkda;)V", line = 121)
    public class617(class39 arg0, int arg1, class328 arg2) {
        this.field9121 = arg2;
        this.field9121.method1975(104, 30);
    }

    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(B)V", line = 137)
