...
public class class617 extends class687 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Lrfa;Z[[[BIB)Z", line = 34)
    ...
    @OriginalMember(owner = "client!k", name = "<init>", descriptor = "(Ldr;)V", line = 96)
