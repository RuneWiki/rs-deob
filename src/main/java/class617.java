...
public class class617 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(BILoga;IIIIIIII)Z", line = 7)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IIIIIIIIII)V", line = 254)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(I)V", line = 369)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(B[I[Ljava/lang/Object;)V", line = 383)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Lkf;Z)V", line = 397)
