...
public abstract class class617 {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(ILjava/lang/String;)J", line = 19)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "([III[ILok;I)Llda;", line = 40)
