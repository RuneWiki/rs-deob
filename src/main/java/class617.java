...
public class class617 extends class49 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Lae;DIILd;ZIZ)[I", line = 11)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Z)V", line = 148)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ZLd;Lae;)Z", line = 174)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(I)V", line = 227)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Lae;IZIZLd;D)[I", line = 240)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Ljava/awt/Canvas;Ld;III)Lha;", line = 380)
    ...
    @OriginalMember(owner = "client!tm", name = "g", descriptor = "(I)V", line = 398)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ZLd;IIILae;)[F", line = 433)
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "()V", line = 540)
    public class617() {
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(Lgga;)V", line = 558)
