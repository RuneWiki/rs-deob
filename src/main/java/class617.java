...
public class class617 extends class354 {
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(II[Ljava/lang/Object;[II)V", line = 3)
    ...
    @OriginalMember(owner = "client!mfa", name = "b", descriptor = "(B)I", line = 60)
    ...
    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "(ILwo;)V", line = 70)
    public class617(int arg0, class746 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!mfa", name = "c", descriptor = "(I)Z", line = 73)
    ...
    @OriginalMember(owner = "client!mfa", name = "c", descriptor = "(B)V", line = 92)
    public static void method3449(byte arg0) {
        field8508 = null;
        int var1 = 17 % ((arg0 - -44) / 55);
    }

    @OriginalMember(owner = "client!mfa", name = "c", descriptor = "(II)V", line = 101)
    ...
    @OriginalMember(owner = "client!mfa", name = "b", descriptor = "(II)I", line = 113)
    ...
    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "(Lwo;)V", line = 134)
    public class617(class746 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(JIIIILnd;ZB)V", line = 138)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(B)I", line = 163)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(I)V", line = 177)
