...
public class class617 extends class41 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Ler;I[[B)V")
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ILes;)V")
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Loga;I)V")
