...
public class class617 extends class175 implements class391 {
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Lqq;I)V")
    ...
    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(Z)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!lw", name = "<init>", descriptor = "(Lnca;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(ILjt;I[BIIIII)V")
    ...
    @OriginalMember(owner = "client!lw", name = "<init>", descriptor = "(Lnca;Ljt;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!lw", name = "<init>", descriptor = "(Lnca;Ljt;Llc;II)V")
