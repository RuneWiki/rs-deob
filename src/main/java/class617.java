...
public abstract class class617 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(ILjava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(I)Lbe;", line = 26)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 37)
    ...
    @OriginalMember(owner = "client!pl", name = "b", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(III)Lch;", line = 81)
