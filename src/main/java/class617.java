...
public class class617 extends class86 {
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(ILsf;)V", line = 5)
    public class617(int arg0, class551 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Lsf;)V", line = 29)
    public class617(class551 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ok", name = "a", descriptor = "([Ll;Lck;I)Lfm;", line = 36)
    ...
    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(II)I", line = 105)
    ...
    @OriginalMember(owner = "client!ok", name = "c", descriptor = "(I)Z", line = 128)
    ...
    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(I)I", line = 149)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Z)I", line = 164)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IZ)V", line = 177)
    ...
    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(Z)V", line = 188)
