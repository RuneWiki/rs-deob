...
public class class617 {
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(III)Z", line = 19)
    ...
    @OriginalMember(owner = "client!sv", name = "toString", descriptor = "()Ljava/lang/String;", line = 31)
    public final String toString() {
        field8370++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Z[I)Ljava/lang/String;", line = 41)
