...
public class class617 extends class289 {
    ...
    @OriginalMember(owner = "client!nu", name = "b", descriptor = "(IIZI)[B", line = 7)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(BIB)V", line = 24)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IIBI)V", line = 39)
    ...
    @OriginalMember(owner = "client!nu", name = "d", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(Ldt;I)Lpha;", line = 65)
