...
public class class617 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(BI)I", line = 14)
    public static final int method3547(byte arg0, int arg1) {
        field8930++;
        return arg0 == -92 ? arg1 >>> 8 : 74;
    }

    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(I)V", line = 28)
