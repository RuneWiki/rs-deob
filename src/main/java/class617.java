...
public class class617 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "([BIBI)[B", line = 16)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(B)Z", line = 31)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(ILdk;)[I", line = 115)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(II[F[IIII[II[FIII)V", line = 149)
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "(Lch;)V", line = 266)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Z)V", line = 236)
