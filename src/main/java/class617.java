...
public class class617 implements class15 {
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(Lvfa;ILvfa;)V", line = 20)
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(IB)I", line = 38)
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "([ILas;JZ)Ljava/lang/String;", line = 54)
