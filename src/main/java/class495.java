...
public class class495 extends class404 {
    ...
    @OriginalMember(owner = "client!fm", name = "h", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(BILhs;)Luf;", line = 18)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(II)[I", line = 46)
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "()V", line = 85)
    public class495() {
        super(1, true);
    }
}
