...
public class class495 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(B)Lfp;", line = 6)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(ILfp;)V", line = 31)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(I)I", line = 50)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Ljava/lang/String;IIZIZLjava/lang/String;)V", line = 70)
    ...
    @OriginalMember(owner = "client!mg", name = "b", descriptor = "(B)V", line = 185)
    ...
    @OriginalMember(owner = "client!mg", name = "b", descriptor = "(I)Lfp;", line = 208)
    ...
    @OriginalMember(owner = "client!mg", name = "<init>", descriptor = "()V", line = 234)
    public class495() {
