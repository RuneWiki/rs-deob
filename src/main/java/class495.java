...
public class class495 extends class283 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lcd;)V", line = 8)
    public final synchronized void method2847(class283 arg0) {
        this.field7159.method3169(-124, arg0);
    }

    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lmu;Lfd;)V", line = 11)
    ...
    @OriginalMember(owner = "client!lb", name = "c", descriptor = "([III)V", line = 22)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lfd;)V", line = 35)
    ...
    @OriginalMember(owner = "client!lb", name = "b", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!lb", name = "c", descriptor = "()Lcd;", line = 63)
    public final class283 method651() {
        return (class283) this.field7159.method3168(false);
    }

    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "()I", line = 115)
    public final int method671() {
        return 0;
    }

    @OriginalMember(owner = "client!lb", name = "b", descriptor = "(Lcd;)V", line = 118)
    public final synchronized void method2852(class283 arg0) {
        arg0.method1519((byte) 121);
    }

    @OriginalMember(owner = "client!lb", name = "e", descriptor = "()I", line = 122)
    public final synchronized int method2853() {
        return this.field7159.method3165((byte) 92);
    }

    @OriginalMember(owner = "client!lb", name = "f", descriptor = "()V", line = 128)
    ...
    @OriginalMember(owner = "client!lb", name = "b", descriptor = "([III)V", line = 149)
    ...
    @OriginalMember(owner = "client!lb", name = "d", descriptor = "()Lcd;", line = 194)
