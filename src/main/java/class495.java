...
public class class495 extends class431 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IILya;B)Lt;")
    ...
    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(Lya;I)V")
    ...
    @OriginalMember(owner = "client!dd", name = "c", descriptor = "(Lya;I)Lfk;")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IILya;I)Z")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IILfi;BZLya;I)V")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lt;Lya;I)V")
