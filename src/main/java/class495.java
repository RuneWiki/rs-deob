...
public class class495 extends class616 {
    ...
    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "(Lac;IIII[I)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "(Lac;IIIII)V")
    public class495(class541 arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
    ...
    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "(Lac;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "(Lac;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "(Lac;IIII)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "(Lac;IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "(Lac;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "(Lac;IIIZ[III)V")
