...
public class class495 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ILmd;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lmd;B)V", line = 44)
    ...
    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(B)Z", line = 68)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(BII)V", line = 90)
