...
public class class495 {
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(ILac;)Lfm;", line = 21)
    ...
    @OriginalMember(owner = "client!pga", name = "<init>", descriptor = "(I)V", line = 33)
