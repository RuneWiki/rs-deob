...
public class class495 extends class375 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Lqaa;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Lmo;II)V", line = 189)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(I)V", line = 206)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ILmo;)V", line = 216)
    ...
    @OriginalMember(owner = "client!ts", name = "d", descriptor = "(B)V", line = 241)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(III)Lkg;", line = 258)
