...
public class class495 extends class170 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(IIIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(IIB)V", line = 590)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(I)V", line = 609)
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(IIIIIII)V", line = 619)
    ...
    @OriginalMember(owner = "client!jm", name = "b", descriptor = "(IIB)V", line = 631)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(III)V", line = 654)
