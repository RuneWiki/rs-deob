...
public class class495 extends class77 implements Runnable {
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(III)Z", line = 19)
    ...
    @OriginalMember(owner = "client!of", name = "c", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(Liu;)V", line = 48)
    public class495(class518 arg0) {
        this.field7458 = arg0;
    }

    @OriginalMember(owner = "client!of", name = "run", descriptor = "()V", line = 56)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(B)V", line = 74)
