...
public class class495 extends class154 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(III)V", line = 70)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(II)V", line = 115)
