...
public class class495 extends class516 {
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(BZ)V", line = 8)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IILjava/io/File;)[B", line = 39)
    ...
    @OriginalMember(owner = "client!nf", name = "c", descriptor = "(B)Z", line = 57)
    ...
    @OriginalMember(owner = "client!nf", name = "<init>", descriptor = "(Lcb;)V", line = 69)
    public class495(class444 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(Z)V", line = 75)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(III)V", line = 101)
    public final void method200(int arg0, int arg1, int arg2) {
        ++field7039;
        int var4 = 74 % ((-41 - arg0) / 57);
    }

    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(ZZ)V", line = 110)
    ...
    @OriginalMember(owner = "client!nf", name = "c", descriptor = "(III)Z", line = 125)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(Lpb;II)V", line = 138)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IIIZI)V", line = 150)
