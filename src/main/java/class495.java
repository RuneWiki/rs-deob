...
public class class495 extends class517 {
    ...
    @OriginalMember(owner = "client!gl", name = "wa", descriptor = "([I)V", line = 4)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(B)[F", line = 21)
    ...
    @OriginalMember(owner = "client!gl", name = "W", descriptor = "(III)V", line = 45)
    ...
    @OriginalMember(owner = "client!gl", name = "ha", descriptor = "(Lc;)V", line = 58)
    ...
    @OriginalMember(owner = "client!gl", name = "v", descriptor = "()V", line = 82)
    ...
    @OriginalMember(owner = "client!gl", name = "K", descriptor = "(III[I)V", line = 97)
    ...
    @OriginalMember(owner = "client!gl", name = "EA", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(B)V", line = 142)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "()Lc;", line = 177)
    ...
    @OriginalMember(owner = "client!gl", name = "U", descriptor = "(III)V", line = 199)
    ...
    @OriginalMember(owner = "client!gl", name = "ca", descriptor = "(I)V", line = 212)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(FIBFIIF)V", line = 226)
    ...
    @OriginalMember(owner = "client!gl", name = "YA", descriptor = "(IIIIII)V", line = 260)
    ...
    @OriginalMember(owner = "client!gl", name = "ea", descriptor = "(I)V", line = 298)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IILum;IIZI)V", line = 329)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ILc;)V", line = 348)
    ...
    @OriginalMember(owner = "client!gl", name = "A", descriptor = "(I)V", line = 376)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(I)[F", line = 393)
    ...
    @OriginalMember(owner = "client!gl", name = "g", descriptor = "(I)V", line = 417)
    ...
    @OriginalMember(owner = "client!gl", name = "c", descriptor = "(I)V", line = 430)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "()V", line = 440)
    public class495() {
        this.method964();
    }

    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(III[I)V", line = 448)
