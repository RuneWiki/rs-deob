...
public class class495 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IB)I", line = 3)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(II)Z", line = 42)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(B)V", line = 105)
