...
public class class495 {
    ...
    @OriginalMember(owner = "client!iba", name = "b", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(Lpfa;I)[Liba;")
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(Lpfa;II)Liba;")
    ...
    @OriginalMember(owner = "client!iba", name = "b", descriptor = "(Lpfa;I)Liba;")
    ...
    @OriginalMember(owner = "client!iba", name = "g", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!iba", name = "b", descriptor = "(Lpfa;II)[Liba;")
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "([B)[Liba;")
