...
public class class495 implements class660 {
    ...
    @OriginalMember(owner = "client!ln", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "()V", line = 38)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(I)V", line = 123)
    public class495(int arg0) {
        this.field6332 = arg0;
    }

    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(B)Lgp;", line = 136)
