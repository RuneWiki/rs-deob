...
public class class495 extends class6 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lga;ZZIDILmg;Z)[I")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ILmg;DIZILga;)[I")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(BLga;Lmg;ZII)[F")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lga;BLmg;)Z")
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "(Lsi;)V")
