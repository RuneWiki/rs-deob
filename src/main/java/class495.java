...
public class class495 {
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(IB)Lro;")
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(Ldc;B)Lrf;")
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(II)Lpia;")
    ...
    @OriginalMember(owner = "client!pga", name = "<init>", descriptor = "(Lgp;ILuu;Luu;Luu;)V")
