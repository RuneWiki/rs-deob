...
public class class495 extends class679 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IIZ)V", line = 24)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IIIIII)V", line = 60)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IILjava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 82)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(BZ)V", line = 91)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IIB)V", line = 138)
    ...
    @OriginalMember(owner = "client!nh", name = "b", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(IIIIIFFF)V", line = 177)
    ...
    @OriginalMember(owner = "client!nh", name = "d", descriptor = "(B)V", line = 187)
