...
public class class495 extends class206 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(IILha;Lef;I)V", line = 11)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Z)V", line = 45)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(I[I[IIZ)J", line = 56)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(ILee;Lhs;BIILha;ZII)Lka;", line = 97)
