...
public class class495 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Lsj;)V")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Lsj;I)V")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Lmd;I)V")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Lcd;II)V")
