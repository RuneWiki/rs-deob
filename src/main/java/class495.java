...
public abstract class class495 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(II[IZZII[III)V", line = 14)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIILva;Lva;ZIII)V", line = 115)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIIIILs;III)V", line = 163)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIZILmt;Z[IILu;[ZILu;)V", line = 289)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIIIIILva;Lva;IIZLva;[ZILva;)V", line = 497)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(II[IILva;ILva;ZIII)V", line = 555)
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(I)V", line = 603)
    public static void method2895(int arg0) {
        field7019 = null;
        int var1 = -81 % ((arg0 - 12) / 37);
    }

    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IBLva;)V", line = 636)
