...
public class class495 extends class661 {
    ...
    @OriginalMember(owner = "client!iaa", name = "i", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "()Lbca;")
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(Z)Lma;")
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(Lbca;)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(I[[BLvaa;)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(Lbca;I)V")
