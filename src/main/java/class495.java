...
public class class495 extends class111 implements class57 {
    ...
    @OriginalMember(owner = "client!hj", name = "e", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IILoa;I)Z", line = 17)
    ...
    @OriginalMember(owner = "client!hj", name = "b", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(Loa;II)Lba;", line = 53)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IZLoa;)Lba;", line = 75)
    ...
    @OriginalMember(owner = "client!hj", name = "<init>", descriptor = "(Loa;Lqd;IIIIZIZ)V", line = 87)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IIZLoa;)Llo;", line = 122)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(Loa;B)Laca;", line = 153)
    ...
    @OriginalMember(owner = "client!hj", name = "b", descriptor = "(I)I", line = 178)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(Loa;I)V", line = 191)
    ...
    @OriginalMember(owner = "client!hj", name = "g", descriptor = "(I)V", line = 201)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IIILva;Loa;ZI)V", line = 213)
    ...
    @OriginalMember(owner = "client!hj", name = "c", descriptor = "(I)V", line = 236)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(I)Z", line = 250)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(ILoa;)V", line = 261)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(BLoa;)V", line = 292)
    ...
    @OriginalMember(owner = "client!hj", name = "b", descriptor = "(Loa;I)Lew;", line = 322)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IZ)Loo;", line = 340)
    ...
    @OriginalMember(owner = "client!hj", name = "d", descriptor = "(I)I", line = 369)
    ...
    @OriginalMember(owner = "client!hj", name = "f", descriptor = "(I)Z", line = 387)
