...
public class class700 extends class369 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lud;BI)V")
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(Lqo;Llc;)V")
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(BLin;)V")
