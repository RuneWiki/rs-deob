...
public class class700 extends class578 {
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Ld;Lha;B)V")
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(III)Log;")
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IILwd;)Z")
