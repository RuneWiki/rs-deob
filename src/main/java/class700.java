...
public class class700 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ILri;)V", line = 176)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(BLbo;I)V", line = 205)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Z)V", line = 225)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(I)V", line = 236)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IIIIIIIII)V", line = 251)
    ...
    @OriginalMember(owner = "client!lo", name = "b", descriptor = "(I)V", line = 304)
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(Lrr;Lml;Lhm;IIIII)V", line = 340)
