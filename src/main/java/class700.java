...
public class class700 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(ILsea;Lsea;Lmm;)V", line = 161)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ZZII)I", line = 46)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(JZLgo;[I)Ljava/lang/String;", line = 70)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IZ)Ltl;", line = 94)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(B)V", line = 136)
