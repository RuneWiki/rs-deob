...
public class class700 extends class322 {
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(Lch;)V")
    ...
    @OriginalMember(owner = "client!gn", name = "b", descriptor = "(Z)I")
    ...
    @OriginalMember(owner = "client!gn", name = "c", descriptor = "(I)Luda;")
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(ILch;)V")
