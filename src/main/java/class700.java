...
public class class700 {
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IIIII)Z", line = 8)
    ...
    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(I)V", line = 485)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IZ)Z", line = 496)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IIILjava/lang/Class;)Lqda;", line = 538)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(ZZIIZ)I", line = 569)
    ...
    @OriginalMember(owner = "client!ik", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 607)
