...
public class class700 extends class281 {

    @OriginalMember(owner = "client!lo", name = "g", descriptor = "Ljava/net/ProxySelector;")
    private ProxySelector field9856 = ProxySelector.getDefault();

    @OriginalMember(owner = "client!lo", name = "h", descriptor = "Ljava/lang/Class;")
    public static Class field9857;

    @OriginalMember(owner = "client!lo", name = "i", descriptor = "Ljava/lang/Class;")
    public static Class field9858;
    ...
    private final Socket httpProxyConnect(String arg0, int arg1, String arg2) throws IOException {
        ...
        if (arg2 == null) {
            var5.write(("CONNECT " + this.field4181 + ":" + this.field4178 + " HTTP/1.0\n\n").getBytes(Charset.forName("ISO-8859-1")));
        } else {
            var5.write(("CONNECT " + this.field4181 + ":" + this.field4178 + " HTTP/1.0\n" + arg2 + "\n\n").getBytes(Charset.forName("ISO-8859-1")));
        }
        var5.flush();
    ...
    private final Socket method3908(Proxy arg0, boolean arg1) throws IOException {
        if (arg0.type() == Type.DIRECT) {
            return this.method1859(4);
        }
        if (arg1) {
            this.field9856 = null;
        }
        ...
        if (arg0.type() == Type.HTTP) {
            ...
            try {
                ...
                Method var8 = var7.getDeclaredMethod("getProxyAuth", field9857 == null ? (field9857 = method3909("java.lang.String")) : field9857, Integer.TYPE);
                ...
                if (var9 != null) {
                    ...
                    if ((Boolean) var10.invoke(var9)) {
                        ...
                        Method var12 = var7.getDeclaredMethod("getHeaderValue", field9858 == null ? (field9858 = method3909("java.net.URL")) : field9858, field9857 == null ? (field9857 = method3909("java.lang.String")) : field9857);
                        var12.setAccessible(true);
                        String var13 = (String) var11.invoke(var9);
                        String var14 = (String) var12.invoke(var9, new URL("https://" + this.field4181 + "/"), "https");
                        var6 = var13 + ": " + var14;
                    }
                }
            ...
            var5.connect(new InetSocketAddress(this.field4181, this.field4178));
            return var5;
        } else {
            return null;
        }
    ...
    public final Socket method1857(int arg0) throws IOException {
        ...
        boolean var3 = this.field4178 == 443;
        List var4;
        List var5;
        try {
            var4 = this.field9856.select(new URI((var3 ? "https" : "http") + "://" + this.field4181));
            var5 = this.field9856.select(new URI((var3 ? "http" : "https") + "://" + this.field4181));
        ...
        for (int var10 = 0; var10 < var9.length; var10++) {
            ...
            try {
                Socket var13 = this.method3908(var12, false);
                if (var13 != null) {
                    return var13;
                }
            } catch (class583 var16) {
                var8 = var16;
    ...
    public static Class method3909(String arg0) {
        try {
