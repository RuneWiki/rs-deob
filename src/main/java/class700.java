...
public class class700 implements class90 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(III)I", line = 41)
    ...
    @OriginalMember(owner = "client!lo", name = "b", descriptor = "(B)Z", line = 60)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(BZ)V", line = 74)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(BLvq;)I", line = 88)
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(Lcl;)V", line = 174)
