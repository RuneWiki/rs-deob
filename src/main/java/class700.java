...
public class class700 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IZLqn;Ljava/lang/String;Ljava/lang/String;Z)V")
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lha;IIZIII)V")
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Lha;Ljp;I)V")
