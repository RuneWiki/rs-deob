...
public class class700 extends class633 implements class690 {
    ...
    @OriginalMember(owner = "client!kaa", name = "b", descriptor = "(I)J", line = 3)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(I)I", line = 20)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(III)V", line = 31)
    ...
    @OriginalMember(owner = "client!kaa", name = "c", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!kaa", name = "<init>", descriptor = "(Llea;I[BI)V", line = 73)
    public class700(class573 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field9810 = arg1;
    }

    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(I[BII)V", line = 83)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(I[JII[I)V", line = 100)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(B)I", line = 158)
