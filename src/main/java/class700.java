...
public class class700 extends class364 {
    ...
    @OriginalMember(owner = "client!bea", name = "httpProxyConnect", descriptor = "(Ljava/lang/String;ILjava/lang/String;)Ljava/net/Socket;", line = 13)
    ...
    @OriginalMember(owner = "client!bea", name = "b", descriptor = "(I)Ljava/net/Socket;", line = 88)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(ILjava/net/Proxy;)Ljava/net/Socket;", line = 158)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 192)
