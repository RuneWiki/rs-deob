...
public class class700 {
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Lraa;I)V")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Lso;I)V")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Lul;II)V")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Lso;)V")
