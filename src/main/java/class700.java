...
public class class700 extends class72 {
    ...
    @OriginalMember(owner = "client!waa", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!waa", name = "e", descriptor = "(I)I", line = 27)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(II)V", line = 97)
    ...
    @OriginalMember(owner = "client!waa", name = "b", descriptor = "(I)I", line = 109)
    public final int method60(int arg0) {
        ++field9830;
        return arg0 != -3271 ? -59 : 1;
    }

    @OriginalMember(owner = "client!waa", name = "b", descriptor = "(Z)V", line = 121)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(JILha;)V", line = 138)
    ...
    @OriginalMember(owner = "client!waa", name = "b", descriptor = "(II)I", line = 174)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Lak;I)I", line = 185)
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "(ILcq;)V", line = 215)
    public class700(int arg0, class464 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!waa", name = "c", descriptor = "(Z)V", line = 219)
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "(Lcq;)V", line = 235)
