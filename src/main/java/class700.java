...
public class class700 extends class408 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILvd;ZZIIDLd;)[I")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IILvd;ZBLd;)[F")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IIZ)Lsca;")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Lvd;Ld;B)Z")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ZILvd;IZLd;D)[I")
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "(Lrg;)V")
