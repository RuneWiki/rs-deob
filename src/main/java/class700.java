...
public class class700 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "([[BILtha;)V")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(I)Lns;")
    ...
    @OriginalMember(owner = "client!jl", name = "b", descriptor = "(I)Lns;")
    ...
    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(Lsga;)V")
