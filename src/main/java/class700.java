...
public class class700 implements Runnable {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IBILaia;)J", line = 5)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IJ)I", line = 39)
    ...
    @OriginalMember(owner = "client!q", name = "run", descriptor = "()V", line = 50)
