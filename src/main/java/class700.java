...
public class class700 extends class424 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(I)V", line = 48)
