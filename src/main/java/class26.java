...
public class class26 {
    ...
    @OriginalMember(owner = "client!JBXCIWFE", name = "c", descriptor = "LIMUIZRAF;")
    ...
    @OriginalMember(owner = "client!JBXCIWFE", name = "a", descriptor = "(ZLIMUIZRAF;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!JBXCIWFE", name = "a", descriptor = "(Ljava/lang/String;LIMUIZRAF;I)V")
