...
public class class26 extends class85 {
    ...
    @OriginalMember(owner = "client!ce", name = "U", descriptor = "Llf;")
    public static class109 field553 = class35.method275("Startseite auf (WSpielkonto wiederherstellen(W)3", 2);

    @OriginalMember(owner = "client!ce", name = "T", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(BILja;)V")
