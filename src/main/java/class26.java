...
public class class26 implements class524 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IIIFIZ)[F", line = 4)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(II)Lco;", line = 15)
    public final class295 method140(int arg0, int arg1) {
        field240++;
        return arg1 == 862 ? this.field241[arg0] : null;
    }

    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ZIIFII)[I", line = 27)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(I)I", line = 38)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IIII)V", line = 55)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(II)Z", line = 69)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IZFIII)[I", line = 82)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IZ)Leh;", line = 94)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(BZ)I", line = 135)
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Ltf;Ltf;Ltf;)V", line = 188)
