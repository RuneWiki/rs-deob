...
public class class26 {
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(BIIII)Z", line = 7)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!vj", name = "toString", descriptor = "()Ljava/lang/String;", line = 35)
    public final String toString() {
        field264++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!vj", name = "b", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!vj", name = "<init>", descriptor = "(II)V", line = 57)
