...
public class class26 {
    ...
    @OriginalMember(owner = "client!qaa", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field337++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(B)Z", line = 17)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(I[FZ)[F", line = 33)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(I)V", line = 58)
