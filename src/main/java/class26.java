...
public class class26 extends class681 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(ILjava/lang/String;)I", line = 95)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(I)V", line = 224)
