...
public class class26 extends class243 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IIILha;III)Lka;", line = 22)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(II)[I", line = 74)
