...
public class class26 extends class335 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(B)J", line = 3)
    public final long method160(byte arg0) {
        return arg0 < 2 ? -20L : this.field352;
    }

    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!ir", name = "c", descriptor = "(I)J", line = 26)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IJ)I", line = 61)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(I)J", line = 99)
