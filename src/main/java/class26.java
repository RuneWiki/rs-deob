...
@OriginalClass("client!HQFMWUSH")
public class class26 {

    @OriginalMember(owner = "client!HQFMWUSH", name = "b", descriptor = "I")
    public int field889 = -1;

    @OriginalMember(owner = "client!HQFMWUSH", name = "c", descriptor = "I")
    private int field890 = 128;

    @OriginalMember(owner = "client!HQFMWUSH", name = "e", descriptor = "I")
    public int field892 = -1;

    @OriginalMember(owner = "client!HQFMWUSH", name = "f", descriptor = "I")
    public int field893 = -1;

    @OriginalMember(owner = "client!HQFMWUSH", name = "g", descriptor = "I")
    public int field894 = -1;

    @OriginalMember(owner = "client!HQFMWUSH", name = "i", descriptor = "I")
    private int field896 = 6972;

    @OriginalMember(owner = "client!HQFMWUSH", name = "j", descriptor = "I")
    public int field897 = -1;

    @OriginalMember(owner = "client!HQFMWUSH", name = "l", descriptor = "B")
    private byte field899 = 3;

    @OriginalMember(owner = "client!HQFMWUSH", name = "m", descriptor = "I")
    public int field900 = -1;

    @OriginalMember(owner = "client!HQFMWUSH", name = "o", descriptor = "I")
    public int field902 = -1;

    @OriginalMember(owner = "client!HQFMWUSH", name = "r", descriptor = "Z")
    public boolean field905 = true;

    @OriginalMember(owner = "client!HQFMWUSH", name = "s", descriptor = "J")
    public long field906 = -1L;

    @OriginalMember(owner = "client!HQFMWUSH", name = "u", descriptor = "I")
    public int field908 = 32;

    @OriginalMember(owner = "client!HQFMWUSH", name = "y", descriptor = "I")
    public int field912 = -1;

    @OriginalMember(owner = "client!HQFMWUSH", name = "C", descriptor = "B")
    public byte field916 = 1;

    @OriginalMember(owner = "client!HQFMWUSH", name = "D", descriptor = "I")
    public int field917 = -1;

    @OriginalMember(owner = "client!HQFMWUSH", name = "E", descriptor = "Z")
    ...
    @OriginalMember(owner = "client!HQFMWUSH", name = "K", descriptor = "I")
    public int field924 = -1;

    @OriginalMember(owner = "client!HQFMWUSH", name = "L", descriptor = "Z")
    public boolean field925 = false;

    @OriginalMember(owner = "client!HQFMWUSH", name = "M", descriptor = "I")
    private int field926 = 128;

    @OriginalMember(owner = "client!HQFMWUSH", name = "p", descriptor = "LHPFNYARJ;")
    public static class25 field903 = new class25((byte) 41, 30);

    @OriginalMember(owner = "client!HQFMWUSH", name = "k", descriptor = "I")
    private static int field898;

    @OriginalMember(owner = "client!HQFMWUSH", name = "t", descriptor = "I")
    ...
    @OriginalMember(owner = "client!HQFMWUSH", name = "x", descriptor = "LXOUQUKZW;")
    private static class62 field911;

    @OriginalMember(owner = "client!HQFMWUSH", name = "h", descriptor = "Lclient;")
    public static client field895;

    @OriginalMember(owner = "client!HQFMWUSH", name = "A", descriptor = "Ljava/lang/String;")
    public String field914;

    @OriginalMember(owner = "client!HQFMWUSH", name = "a", descriptor = "[B")
    public byte[] field888;

    @OriginalMember(owner = "client!HQFMWUSH", name = "d", descriptor = "[I")
    private int[] field891;

    @OriginalMember(owner = "client!HQFMWUSH", name = "n", descriptor = "[I")
    private static int[] field901;

    @OriginalMember(owner = "client!HQFMWUSH", name = "q", descriptor = "[I")
    public int[] field904;

    @OriginalMember(owner = "client!HQFMWUSH", name = "v", descriptor = "[I")
    private int[] field909;

    @OriginalMember(owner = "client!HQFMWUSH", name = "w", descriptor = "[I")
    private int[] field910;

    @OriginalMember(owner = "client!HQFMWUSH", name = "z", descriptor = "[I")
    private int[] field913;

    @OriginalMember(owner = "client!HQFMWUSH", name = "J", descriptor = "[LHQFMWUSH;")
    private static class26[] field923;

    @OriginalMember(owner = "client!HQFMWUSH", name = "H", descriptor = "[Ljava/lang/String;")
    public String[] field921;

    @OriginalMember(owner = "client!HQFMWUSH", name = "a", descriptor = "(I[III)LKPUOCBCE;")
    ...
    @OriginalMember(owner = "client!HQFMWUSH", name = "a", descriptor = "(BLXOUQUKZW;)V")
    ...
    @OriginalMember(owner = "client!HQFMWUSH", name = "a", descriptor = "(Z)LKPUOCBCE;")
    ...
    @OriginalMember(owner = "client!HQFMWUSH", name = "a", descriptor = "(B)LHQFMWUSH;")
    ...
    @OriginalMember(owner = "client!HQFMWUSH", name = "a", descriptor = "(I)LHQFMWUSH;")
    ...
    @OriginalMember(owner = "client!HQFMWUSH", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!HQFMWUSH", name = "a", descriptor = "(LCVNWKEAW;)V")
