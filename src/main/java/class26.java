...
public class class26 implements class210 {
    ...
    @OriginalMember(owner = "client!db", name = "c", descriptor = "(II)Ltg;")
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(II)Ljh;")
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(Llm;Llm;Llm;)V")
