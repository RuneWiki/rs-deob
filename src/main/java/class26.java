...
public class class26 extends class695 {
    ...
    @OriginalMember(owner = "client!qaa", name = "e", descriptor = "(BI)I", line = 3)
    ...
    @OriginalMember(owner = "client!qaa", name = "m", descriptor = "(B)I", line = 43)
    ...
    @OriginalMember(owner = "client!qaa", name = "f", descriptor = "(BI)I", line = 60)
    public final int method311(byte arg0, int arg1) {
        ++field383;
        return arg0 != -31 ? 64 : arg1 * 8 + -this.field380;
    }

    @OriginalMember(owner = "client!qaa", name = "p", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!qaa", name = "q", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Loda;", line = 103)
    ...
    @OriginalMember(owner = "client!qaa", name = "r", descriptor = "(I)[Lnea;", line = 122)
    ...
    @OriginalMember(owner = "client!qaa", name = "<init>", descriptor = "(I)V", line = 133)
    public class26(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qaa", name = "g", descriptor = "(BI)V", line = 142)
    ...
    @OriginalMember(owner = "client!qaa", name = "s", descriptor = "(I)V", line = 154)
    public final void method317(int arg0) {
        ++field382;
        super.field9761 = (this.field380 + 7) / arg0;
    }

    @OriginalMember(owner = "client!qaa", name = "t", descriptor = "(I)Z", line = 168)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(ILqm;)V", line = 185)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(I[I)V", line = 196)
    ...
    @OriginalMember(owner = "client!qaa", name = "j", descriptor = "(II)Lkq;", line = 211)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "([BIIB)V", line = 255)
