...
public class class26 extends class58 {
    ...
    @OriginalMember(owner = "client!we", name = "i", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(ILfp;I)Z", line = 26)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(III)V", line = 137)
    ...
    @OriginalMember(owner = "client!we", name = "f", descriptor = "(I)Z", line = 224)
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "(Z)Z", line = 243)
    ...
    @OriginalMember(owner = "client!we", name = "d", descriptor = "(I)V", line = 254)
    ...
    @OriginalMember(owner = "client!we", name = "e", descriptor = "(B)I", line = 265)
    public final int method268(byte arg0) {
        ++field364;
        return arg0 >= -101 ? 93 : super.field736;
    }

    @OriginalMember(owner = "client!we", name = "d", descriptor = "(B)Z", line = 280)
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "(ILfp;)V", line = 293)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Lfp;III)Z", line = 316)
    ...
    @OriginalMember(owner = "client!we", name = "h", descriptor = "(B)I", line = 348)
    ...
    @OriginalMember(owner = "client!we", name = "g", descriptor = "(I)V", line = 371)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(ILfp;)Luq;", line = 382)
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "(IIIIIII)V", line = 458)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Lfp;Lje;ZIIII)V", line = 515)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(IBIIII)V", line = 526)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Lun;I)V", line = 624)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(IIBIZI)V", line = 645)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(B)I", line = 714)
