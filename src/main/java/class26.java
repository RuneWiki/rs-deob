...
public class class26 extends class448 {
    ...
    @OriginalMember(owner = "client!ml", name = "b", descriptor = "(Lqa;B)Lvs;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(BLrn;ZIILqa;I)V")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IZILqa;)Z")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IILqa;Z)Lc;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Lqa;Lc;Z)V")
