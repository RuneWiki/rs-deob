...
public class class26 {
    ...
    @OriginalMember(owner = "client!wv", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field451++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(IIIIIII)V", line = 34)
    ...
    @OriginalMember(owner = "client!wv", name = "b", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 82)
