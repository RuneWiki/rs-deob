...
public class class26 extends class578 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(BLjc;)V")
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Ljw;B)V")
    ...
    @OriginalMember(owner = "client!kj", name = "b", descriptor = "(II)Lo;")
    ...
    @OriginalMember(owner = "client!kj", name = "<init>", descriptor = "(Ljc;)V")
