...
public class class26 extends class262 {
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(ILoa;B)V")
    ...
    @OriginalMember(owner = "client!qaa", name = "<init>", descriptor = "(Lifa;)V")
    ...
    @OriginalMember(owner = "client!qaa", name = "h", descriptor = "(I)V")
