...
public class class26 extends class578 {
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(Ljava/lang/String;I)J", line = 4)
    ...
    @OriginalMember(owner = "client!qaa", name = "d", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(BLac;)V", line = 39)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 64)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(ILac;I)V", line = 127)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(BLjava/lang/String;I)Ljava/lang/String;", line = 174)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(III)I", line = 201)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(Lin;I)V", line = 226)
