...
public abstract class class26 implements class107 {
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Ljaggl/opengl;IIIIII[I)V")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Ljaggl/opengl;IIIII[B)V")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Ljaggl/opengl;IIIII[F)V")
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(Lnm;IIIZ)V")
