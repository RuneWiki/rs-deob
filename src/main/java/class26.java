...
public class class26 implements Runnable {
    ...
    @OriginalMember(owner = "client!wv", name = "run", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Lti;I)V", line = 49)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Z)V", line = 78)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(B)V", line = 102)
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "()V", line = 130)
    public class26() {
        this.field451.setDaemon(true);
        this.field451.start();
    }

    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Loo;Z)V", line = 117)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Ljava/lang/String;I)Lbg;", line = 143)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(IIIZIIIIILoe;II)Z", line = 164)
