...
public class class26 extends class86 {
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Lnq;)V", line = 7)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ZI)Lom;", line = 121)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ZB)V", line = 147)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ZLlr;I)V", line = 163)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(I)V", line = 176)
    ...
    @OriginalMember(owner = "client!ud", name = "b", descriptor = "(B)Z", line = 205)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IBI)V", line = 216)
    ...
    @OriginalMember(owner = "client!ud", name = "b", descriptor = "(Z)V", line = 233)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IZ)V", line = 243)
    ...
    @OriginalMember(owner = "client!ud", name = "b", descriptor = "(I)V", line = 271)
