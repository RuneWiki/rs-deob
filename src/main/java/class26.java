...
public class class26 {
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "()[B", line = 5)
    ...
    @OriginalMember(owner = "client!qaa", name = "b", descriptor = "()Lmr;", line = 69)
    ...
    @OriginalMember(owner = "client!qaa", name = "<init>", descriptor = "(Los;)V", line = 129)
    ...
    @OriginalMember(owner = "client!qaa", name = "<init>", descriptor = "()V", line = 149)
    private class26() {
    }

    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(Ldn;II)Lqaa;", line = 77)
    ...
    @OriginalMember(owner = "client!qaa", name = "c", descriptor = "()I", line = 87)
