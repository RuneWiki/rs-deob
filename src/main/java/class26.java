...
public class class26 extends class50 {
    ...
    @OriginalMember(owner = "client!INVDQNJU", name = "<init>", descriptor = "(LXRWUKRPO;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!INVDQNJU", name = "a", descriptor = "(LVUMXQDFQ;IIZ)V")
