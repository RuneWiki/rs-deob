...
public class class26 extends class398 {
    ...
    @OriginalMember(owner = "client!db", name = "b", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "([ILri;[IB[I)V", line = 51)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Ldp;Ldp;Ldp;I)V", line = 145)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(ILjava/lang/String;IIIILjava/lang/String;J)V", line = 158)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IIB)V", line = 183)
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(IIIIIII)V", line = 210)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IZLdp;Ldp;)V", line = 229)
