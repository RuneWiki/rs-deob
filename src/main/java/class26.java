...
public class class26 extends class221 {
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Lrl;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Lrl;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Lrl;IIII)V")
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Lrl;IIIII)V")
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Lrl;IIIIZ[IZ)V")
