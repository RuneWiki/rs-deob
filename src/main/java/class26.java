...
public class class26 {
    ...
    @OriginalMember(owner = "client!KTPZRJZJ", name = "g", descriptor = "[LSMALAPQM;")
    ...
    @OriginalMember(owner = "client!KTPZRJZJ", name = "c", descriptor = "[LKTPZRJZJ;")
    ...
    @OriginalMember(owner = "client!KTPZRJZJ", name = "f", descriptor = "LNHEPCMLW;")
    ...
    @OriginalMember(owner = "client!KTPZRJZJ", name = "a", descriptor = "(ILNHEPCMLW;)V")
    ...
    @OriginalMember(owner = "client!KTPZRJZJ", name = "a", descriptor = "(IIZ)LNHEPCMLW;")
    ...
    @OriginalMember(owner = "client!KTPZRJZJ", name = "a", descriptor = "(ZLNHEPCMLW;)V")
    ...
    @OriginalMember(owner = "client!KTPZRJZJ", name = "a", descriptor = "(II)LNHEPCMLW;")
