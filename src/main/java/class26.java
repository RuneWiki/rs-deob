...
public class class26 extends class14 {
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IIIIIII)J", line = 4)
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(Lpf;Ldg;IIIIIIIIIIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(BI)V", line = 36)
    ...
    @OriginalMember(owner = "client!iv", name = "c", descriptor = "(B)V", line = 183)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(B)Lgp;", line = 200)
