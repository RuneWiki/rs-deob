...
public class class26 extends class148 {
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(IIIILme;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(IIZ)V", line = 13)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(ILdh;I)V", line = 39)
    ...
    @OriginalMember(owner = "client!wv", name = "e", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!wv", name = "b", descriptor = "(IBI)Z", line = 88)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(II)[I", line = 99)
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "()V", line = 242)
    public class26() {
        super(1, false);
    }

    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(ZI)[[I", line = 173)
