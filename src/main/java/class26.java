...
public class class26 extends class70 implements class196 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ILqa;)V", line = 3)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(BLqa;)V", line = 13)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Lqv;BLqa;IZII)V", line = 24)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IIILqa;)Z", line = 35)
    ...
    @OriginalMember(owner = "client!af", name = "g", descriptor = "(I)[Lpg;", line = 56)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(BLqa;)V", line = 67)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Lqa;I)Lpj;", line = 90)
    ...
    @OriginalMember(owner = "client!af", name = "c", descriptor = "(B)V", line = 131)
    public final void method59(byte arg0) {
        ++field427;
        int var2 = -81 % ((arg0 - 27) / 63);
    }

    @OriginalMember(owner = "client!af", name = "a", descriptor = "(I)I", line = 141)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(B)Z", line = 157)
    ...
    @OriginalMember(owner = "client!af", name = "d", descriptor = "(I)Z", line = 170)
    public final boolean method49(int arg0) {
        ++field429;
        return arg0 != 7 ? false : false;
    }

    @OriginalMember(owner = "client!af", name = "e", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(B)I", line = 196)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(I)I", line = 208)
    ...
    @OriginalMember(owner = "client!af", name = "h", descriptor = "(I)V", line = 220)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ILqa;B)Lc;", line = 239)
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Lqa;Leu;IIIIIZIII)V", line = 251)
