...
public class class26 extends class170 {
    ...
    @OriginalMember(owner = "client!db", name = "e", descriptor = "(I)I", line = 7)
    public final int method157(int arg0) {
        ++field327;
        return arg0 != -10495 ? 118 : (int) super.field4226;
    }

    @OriginalMember(owner = "client!db", name = "f", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(B[Lwn;)V", line = 33)
    ...
    @OriginalMember(owner = "client!db", name = "g", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!db", name = "h", descriptor = "(I)I", line = 87)
    ...
    @OriginalMember(owner = "client!db", name = "i", descriptor = "(I)I", line = 99)
    public static final int method162(int arg0) {
        ++field338;
        return arg0 != 12 ? -43 : 6;
    }

    @OriginalMember(owner = "client!db", name = "j", descriptor = "(I)J", line = 110)
    ...
    @OriginalMember(owner = "client!db", name = "k", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(II)V", line = 142)
