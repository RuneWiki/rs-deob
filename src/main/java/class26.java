...
public class class26 extends class167 implements class303 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IZLza;Z)Luo;", line = 3)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lza;I)V", line = 35)
    ...
    @OriginalMember(owner = "client!pc", name = "c", descriptor = "(B)I", line = 63)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IBILza;)Z", line = 75)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(I)I", line = 100)
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(B)Z", line = 112)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Llb;IZIBILza;)V", line = 128)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ILza;B)Le;", line = 153)
    ...
    @OriginalMember(owner = "client!pc", name = "g", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(Lza;I)V", line = 185)
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(I)V", line = 219)
    ...
    @OriginalMember(owner = "client!pc", name = "c", descriptor = "(Lza;I)V", line = 233)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(BLza;I)Le;", line = 244)
    ...
    @OriginalMember(owner = "client!pc", name = "e", descriptor = "(I)V", line = 267)
    ...
    @OriginalMember(owner = "client!pc", name = "c", descriptor = "(I)Z", line = 281)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(B)I", line = 292)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(BLza;)Lql;", line = 303)
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Lza;Lpm;IIIIZIZ)V", line = 329)
