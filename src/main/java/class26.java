...
@OriginalClass("client!HARRRJHW")
public class class26 {

    @OriginalMember(owner = "client!HARRRJHW", name = "a", descriptor = "I")
    private int field946 = 411;

    @OriginalMember(owner = "client!HARRRJHW", name = "i", descriptor = "I")
    public int field954 = -1;

    @OriginalMember(owner = "client!HARRRJHW", name = "k", descriptor = "Z")
    public boolean field956 = false;

    @OriginalMember(owner = "client!HARRRJHW", name = "l", descriptor = "I")
    public int field957 = 5;

    @OriginalMember(owner = "client!HARRRJHW", name = "m", descriptor = "I")
    public int field958 = -1;

    @OriginalMember(owner = "client!HARRRJHW", name = "n", descriptor = "I")
    public int field959 = -1;

    @OriginalMember(owner = "client!HARRRJHW", name = "o", descriptor = "I")
    public int field960 = 99;

    @OriginalMember(owner = "client!HARRRJHW", name = "p", descriptor = "I")
    public int field961 = -1;

    @OriginalMember(owner = "client!HARRRJHW", name = "q", descriptor = "I")
    public int field962 = -1;

    @OriginalMember(owner = "client!HARRRJHW", name = "r", descriptor = "I")
    public int field963 = 2;

    @OriginalMember(owner = "client!HARRRJHW", name = "b", descriptor = "I")
    private static int field947 = 623;

    @OriginalMember(owner = "client!HARRRJHW", name = "c", descriptor = "I")
    public static int field948;

    @OriginalMember(owner = "client!HARRRJHW", name = "e", descriptor = "I")
    public int field950;

    @OriginalMember(owner = "client!HARRRJHW", name = "s", descriptor = "I")
    public int field964;

    @OriginalMember(owner = "client!HARRRJHW", name = "t", descriptor = "I")
    public static int field965;

    @OriginalMember(owner = "client!HARRRJHW", name = "f", descriptor = "[I")
    public int[] field951;

    @OriginalMember(owner = "client!HARRRJHW", name = "g", descriptor = "[I")
    public int[] field952;

    @OriginalMember(owner = "client!HARRRJHW", name = "h", descriptor = "[I")
    private int[] field953;

    @OriginalMember(owner = "client!HARRRJHW", name = "j", descriptor = "[I")
    public int[] field955;

    @OriginalMember(owner = "client!HARRRJHW", name = "d", descriptor = "[LHARRRJHW;")
    public static class26[] field949;

    @OriginalMember(owner = "client!HARRRJHW", name = "a", descriptor = "(LDYBMLHQM;Z)V")
    ...
    @OriginalMember(owner = "client!HARRRJHW", name = "a", descriptor = "(II)I")
    ...
    @OriginalMember(owner = "client!HARRRJHW", name = "a", descriptor = "(ILINLHDAGO;)V")
