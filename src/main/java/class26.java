...
public class class26 implements class196 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ZZIIIF)[I", line = 9)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(FIIIZI)[F", line = 25)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(II)I", line = 36)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Ljava/awt/Frame;Lnv;I)V", line = 47)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(BI)Lum;", line = 72)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(B)[Lme;", line = 98)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IIII)Z", line = 180)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(BI)Z", line = 397)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IB)Lks;", line = 413)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(I)V", line = 424)
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Lqs;Lqs;Lqs;)V", line = 452)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IFIBIZ)[I", line = 442)
