...
public class class26 extends class346 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IZILjava/lang/String;)Z", line = 4)
    ...
    @OriginalMember(owner = "client!nc", name = "b", descriptor = "(III[B)V", line = 76)
    ...
    @OriginalMember(owner = "client!nc", name = "b", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(ZBI)Lsv;", line = 99)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IB)Z", line = 112)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(III[B)I", line = 128)
    ...
    @OriginalMember(owner = "client!nc", name = "finalize", descriptor = "()V", line = 143)
    protected final void finalize() {
        field370++;
        this.method201(37);
    }

    @OriginalMember(owner = "client!nc", name = "b", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 173)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(B)V", line = 190)
