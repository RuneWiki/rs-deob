...
public class class26 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(BI)V", line = 27)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Z)V", line = 41)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(II)Lsh;", line = 67)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Llo;ILnl;)V", line = 102)
