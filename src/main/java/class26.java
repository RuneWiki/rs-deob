...
public class class26 implements Runnable {
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Lnc;I)V")
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(BLjava/lang/String;JILei;)V")
    ...
    @OriginalMember(owner = "client!ov", name = "b", descriptor = "(B)Lei;")
