...
public class class26 extends class501 {
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!qaa", name = "g", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!qaa", name = "b", descriptor = "(Z)Ljava/lang/String;", line = 49)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(IB)V", line = 76)
    ...
    @OriginalMember(owner = "client!qaa", name = "b", descriptor = "(IB)Ltda;", line = 91)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(II[Ljava/lang/String;I)Ljava/lang/String;", line = 106)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(ZIFIZIII)[I", line = 169)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(IIB)I", line = 197)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(Lgw;I)V", line = 215)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(Lgw;I[I)V", line = 240)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(ILkda;II)Llg;", line = 268)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(IILgw;)V", line = 285)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(B)V", line = 359)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(ZLgw;)Ljava/lang/String;", line = 376)
