...
public class class26 {
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(IIII)Lwv;")
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(ILgm;Lqa;III)V")
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(IIILrl;Lrl;)V")
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(I)Lnc;")
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "(Lwv;I)V")
