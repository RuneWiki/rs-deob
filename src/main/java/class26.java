...
public abstract class class26 extends class176 {
    ...
    @OriginalMember(owner = "client!ev", name = "c", descriptor = "(IILw;)Lw;")
    ...
    @OriginalMember(owner = "client!ev", name = "aa", descriptor = "(Lw;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ev", name = "<init>", descriptor = "(Lkb;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Lw;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!ev", name = "FA", descriptor = "(Lw;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Lhj;[I)V")
