...
@OriginalClass("client!IKYTXJCI")
public class class26 extends class53 {

    @OriginalMember(owner = "client!IKYTXJCI", name = "r", descriptor = "I")
    private int field842 = 4;

    @OriginalMember(owner = "client!IKYTXJCI", name = "o", descriptor = "I")
    private int field839;

    @OriginalMember(owner = "client!IKYTXJCI", name = "p", descriptor = "I")
    private int field840;

    @OriginalMember(owner = "client!IKYTXJCI", name = "q", descriptor = "I")
    private int field841;

    @OriginalMember(owner = "client!IKYTXJCI", name = "u", descriptor = "I")
    private int field845;

    @OriginalMember(owner = "client!IKYTXJCI", name = "v", descriptor = "I")
    private int field846;

    @OriginalMember(owner = "client!IKYTXJCI", name = "w", descriptor = "I")
    private int field847;

    @OriginalMember(owner = "client!IKYTXJCI", name = "x", descriptor = "I")
    private int field848;

    @OriginalMember(owner = "client!IKYTXJCI", name = "y", descriptor = "LHZCWGKOF;")
    private class24 field849;

    @OriginalMember(owner = "client!IKYTXJCI", name = "t", descriptor = "I")
    private int field844;

    @OriginalMember(owner = "client!IKYTXJCI", name = "s", descriptor = "I")
    private int field843;

    @OriginalMember(owner = "client!IKYTXJCI", name = "m", descriptor = "I")
    public int field837;

    @OriginalMember(owner = "client!IKYTXJCI", name = "n", descriptor = "I")
    public int field838;

    @OriginalMember(owner = "client!IKYTXJCI", name = "z", descriptor = "[I")
    public int[] field850;

    @OriginalMember(owner = "client!IKYTXJCI", name = "l", descriptor = "Lclient;")
    public static client field836;

    @OriginalMember(owner = "client!IKYTXJCI", name = "a", descriptor = "(I)LDHQCHKXN;")
    ...
    @OriginalMember(owner = "client!IKYTXJCI", name = "a", descriptor = "(Z)LITSMSHJO;")
    ...
    @OriginalMember(owner = "client!IKYTXJCI", name = "<init>", descriptor = "(IIIIZIIIII)V")
