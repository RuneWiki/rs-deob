...
public class class26 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(B)Lgj;")
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(ILgj;)V")
    ...
    @OriginalMember(owner = "client!nc", name = "b", descriptor = "(B)Lgj;")
    ...
    @OriginalMember(owner = "client!nc", name = "e", descriptor = "(I)Lgj;")
