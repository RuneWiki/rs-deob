...
public class class26 {
    ...
    @OriginalMember(owner = "client!GTOTZKQF", name = "d", descriptor = "LLDILQFVA;")
    ...
    @OriginalMember(owner = "client!GTOTZKQF", name = "a", descriptor = "(ILLDILQFVA;B)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!GTOTZKQF", name = "a", descriptor = "(ZLLDILQFVA;Ljava/lang/String;)V")
