...
public class class26 {
    ...
    @OriginalMember(owner = "client!wv", name = "b", descriptor = "(II)Loa;")
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(IIZLfp;Lvl;ILza;Ljd;)V")
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "(Lle;ILoi;)V")
