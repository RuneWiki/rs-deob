...
public class class26 {
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Lya;Lmg;B)V")
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Lem;III)V")
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Lsi;I)V")
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(IBLsi;)V")
