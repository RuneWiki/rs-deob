...
public class class26 extends class739 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Ljava/awt/Component;IZ)Lsh;", line = 6)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Lqk;BII)V", line = 24)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IIIIIIII)V", line = 48)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Lsl;IB)V", line = 251)
    ...
    @OriginalMember(owner = "client!vj", name = "b", descriptor = "(II)[[I", line = 277)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IIILjava/lang/Object;)[B", line = 316)
    ...
    @OriginalMember(owner = "client!vj", name = "c", descriptor = "(II)V", line = 348)
    ...
    @OriginalMember(owner = "client!vj", name = "c", descriptor = "(III)Z", line = 358)
    ...
    @OriginalMember(owner = "client!vj", name = "<init>", descriptor = "()V", line = 375)
    public class26() {
        this(0);
    }

    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 379)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IB)I", line = 415)
    ...
    @OriginalMember(owner = "client!vj", name = "<init>", descriptor = "(I)V", line = 427)
    private class26(int arg0) {
        super(0, false);
        this.method115(4080, arg0);
    }

    @OriginalMember(owner = "client!vj", name = "c", descriptor = "(I)V", line = 438)
