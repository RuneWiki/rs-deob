...
@OriginalClass("OPPOFIOL")
public class Pix3D extends Pix2D {

    @OriginalMember(owner = "OPPOFIOL", name = "x", descriptor = "I")
    private static int _flowObfuscator9 = -436;

    @OriginalMember(owner = "OPPOFIOL", name = "y", descriptor = "I")
    private static int _flowObfuscator10 = -477;

    @OriginalMember(owner = "OPPOFIOL", name = "z", descriptor = "Z")
    private static boolean _flowObfuscator11 = true;

    @OriginalMember(owner = "OPPOFIOL", name = "A", descriptor = "Z")
    public static boolean lowDetail = true;

    @OriginalMember(owner = "OPPOFIOL", name = "D", descriptor = "Z")
    public static boolean jagged = true;

    @OriginalMember(owner = "OPPOFIOL", name = "H", descriptor = "[I")
    public static int[] divTable = new int[512];

    @OriginalMember(owner = "OPPOFIOL", name = "I", descriptor = "[I")
    public static int[] divTable2 = new int[2048];

    @OriginalMember(owner = "OPPOFIOL", name = "J", descriptor = "[I")
    public static int[] sinTable = new int[2048];

    @OriginalMember(owner = "OPPOFIOL", name = "K", descriptor = "[I")
    public static int[] cosTable = new int[2048];

    @OriginalMember(owner = "OPPOFIOL", name = "N", descriptor = "[LDSMJIEPN;")
    public static Pix8[] textures;

    @OriginalMember(owner = "OPPOFIOL", name = "O", descriptor = "[Z")
    public static boolean[] textureTranslucent;

    @OriginalMember(owner = "OPPOFIOL", name = "P", descriptor = "[I")
    public static int[] averageTextureRGB;

    @OriginalMember(owner = "OPPOFIOL", name = "S", descriptor = "[[I")
    public static int[][] activeTexels;

    @OriginalMember(owner = "OPPOFIOL", name = "T", descriptor = "[I")
    public static int[] textureCycle;

    @OriginalMember(owner = "OPPOFIOL", name = "V", descriptor = "[I")
    public static int[] colourTable;

    @OriginalMember(owner = "OPPOFIOL", name = "W", descriptor = "[[I")
    public static int[][] textureColourTable;

    @OriginalMember(owner = "OPPOFIOL", name = "G", descriptor = "I")
    public static int centerH3D;

    @OriginalMember(owner = "OPPOFIOL", name = "F", descriptor = "I")
    public static int centerW3D;

    @OriginalMember(owner = "OPPOFIOL", name = "U", descriptor = "I")
    public static int cycle;

    @OriginalMember(owner = "OPPOFIOL", name = "Q", descriptor = "I")
    public static int poolSize;

    @OriginalMember(owner = "OPPOFIOL", name = "M", descriptor = "I")
    public static int textureOffset;

    @OriginalMember(owner = "OPPOFIOL", name = "E", descriptor = "I")
    public static int trans;

    @OriginalMember(owner = "OPPOFIOL", name = "B", descriptor = "Z")
    public static boolean clipX;

    @OriginalMember(owner = "OPPOFIOL", name = "C", descriptor = "Z")
    public static boolean opaque;

    @OriginalMember(owner = "OPPOFIOL", name = "L", descriptor = "[I")
    public static int[] lineOffset;

    @OriginalMember(owner = "OPPOFIOL", name = "R", descriptor = "[[I")
    public static int[][] texelPool;

    @OriginalMember(owner = "OPPOFIOL", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "OPPOFIOL", name = "a", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "OPPOFIOL", name = "a", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "OPPOFIOL", name = "c", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "OPPOFIOL", name = "a", descriptor = "(IZ)V")
    ...
    @OriginalMember(owner = "OPPOFIOL", name = "a", descriptor = "(LXTGLDHGX;I)V")
    public static final void unpackTextures(Jagfile arg0, int arg1) {
        ...
        for (int var2 = 0; var2 < 50; var2++) {
            try {
                ...
                if (lowDetail && textures[var2].width == 128) {
    ...
    @OriginalMember(owner = "OPPOFIOL", name = "a", descriptor = "(II)I")
    public static final int getAverageTextureRGB(int arg0, int arg1) {
        if (arg1 != 12660) {
            ...
            int var3 = 0;
            int var4 = 0;
            int var5 = textureColourTable[arg0].length;
            for (int var6 = 0; var6 < var5; var6++) {
                var2 += textureColourTable[arg0][var6] >> 16 & 0xFF;
                var3 += textureColourTable[arg0][var6] >> 8 & 0xFF;
                var4 += textureColourTable[arg0][var6] & 0xFF;
            }
    ...
    @OriginalMember(owner = "OPPOFIOL", name = "b", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "OPPOFIOL", name = "d", descriptor = "(I)[I")
    public static final int[] getTexels(int arg0) {
        ...
        int[] var6 = textureColourTable[arg0];
        if (lowDetail) {
    ...
    @OriginalMember(owner = "OPPOFIOL", name = "a", descriptor = "(DB)V")
    public static final void setBrightness(double arg0, byte arg1) {
        ...
        for (int var7 = 0; var7 < 512; var7++) {
            ...
            for (int var16 = 0; var16 < 128; var16++) {
                ...
                colourTable[var6++] = var39;
            }
        }
        for (int var8 = 0; var8 < 50; var8++) {
            if (textures[var8] != null) {
                int[] var10 = textures[var8].palette;
                textureColourTable[var8] = new int[var10.length];
                for (int var11 = 0; var11 < var10.length; var11++) {
                    textureColourTable[var8][var11] = setGamma(var10[var11], var4);
                    if ((textureColourTable[var8][var11] & 0xF8F8FF) == 0 && var11 != 0) {
                        textureColourTable[var8][var11] = 1;
                    }
                }
            }
        }
    ...
    @OriginalMember(owner = "OPPOFIOL", name = "a", descriptor = "(ID)I")
    ...
    @OriginalMember(owner = "OPPOFIOL", name = "a", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "OPPOFIOL", name = "a", descriptor = "([IIIIIIII)V")
    ...
    @OriginalMember(owner = "OPPOFIOL", name = "c", descriptor = "(IIIIIII)V")
    ...
    @OriginalMember(owner = "OPPOFIOL", name = "a", descriptor = "([IIIIII)V")
    ...
    @OriginalMember(owner = "OPPOFIOL", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "OPPOFIOL", name = "a", descriptor = "([I[IIIIIIIIIIIIII)V")
