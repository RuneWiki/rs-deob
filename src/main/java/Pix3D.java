...
public class Pix3D extends Pix2D {
    ...
    private static int field638 = -130;

    @OriginalMember(owner = "ib", name = "B", descriptor = "I")
    private static int field639 = 3;

    @OriginalMember(owner = "ib", name = "C", descriptor = "I")
    private static int field640 = 43504;
    ...
    @OriginalMember(owner = "ib", name = "H", descriptor = "Z")
    ...
    @OriginalMember(owner = "ib", name = "R", descriptor = "[Lkb;")
    ...
    @OriginalMember(owner = "ib", name = "ab", descriptor = "[[I")
    ...
    @OriginalMember(owner = "ib", name = "G", descriptor = "Z")
