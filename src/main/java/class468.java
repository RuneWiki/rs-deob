...
public class class468 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(JI)I", line = 11)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I[BII)[B", line = 45)
