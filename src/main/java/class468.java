...
public class class468 implements IEnumModesCallback {
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(B)[I", line = 5)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(ILjava/awt/Frame;)V", line = 23)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IIIILjava/awt/Frame;I)V", line = 34)
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "()V", line = 52)
    public class468() {
        this.field6381.initialize(null);
    }

    @OriginalMember(owner = "client!oc", name = "callbackEnumModes", descriptor = "(Lcom/ms/directX/DDSurfaceDesc;Lcom/ms/com/IUnknown;)V", line = 61)
