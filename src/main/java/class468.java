...
public class class468 {
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IB)V", line = 16)
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(IB)Lfv;", line = 32)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(II)Z", line = 83)
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(B)V", line = 141)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(Lwv;ILqs;)V", line = 173)
