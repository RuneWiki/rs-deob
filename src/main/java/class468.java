...
public class class468 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IIB)I", line = 3)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!kl", name = "toString", descriptor = "()Ljava/lang/String;", line = 107)
