...
public class class468 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(ZIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Li;IBI)V", line = 50)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Z)V", line = 125)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IIBLi;)Z", line = 153)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "([[ZBIIIZ)V", line = 229)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Li;III)V", line = 413)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IIBII)V", line = 486)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(I)V", line = 513)
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(Lih;Lus;)V", line = 525)
