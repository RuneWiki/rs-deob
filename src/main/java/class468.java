...
public class class468 extends class166 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "([BI)[B", line = 3)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lji;I)Luu;", line = 19)
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(I)V", line = 42)
