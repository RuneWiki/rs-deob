...
public class class468 extends class403 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Lbt;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(I[I)V", line = 25)
    ...
    @OriginalMember(owner = "client!bn", name = "x", descriptor = "(I)V", line = 37)
    public final void method2800(int arg0) {
        ++field6538;
        this.field6546 = super.field5262 * arg0;
    }

    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Lkl;I)V", line = 55)
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "(I)V", line = 67)
    public class468(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bn", name = "m", descriptor = "(II)I", line = 70)
    ...
    @OriginalMember(owner = "client!bn", name = "n", descriptor = "(II)I", line = 104)
    ...
    @OriginalMember(owner = "client!bn", name = "y", descriptor = "(I)Z", line = 115)
    ...
    @OriginalMember(owner = "client!bn", name = "e", descriptor = "(Z)V", line = 134)
    ...
    @OriginalMember(owner = "client!bn", name = "z", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!bn", name = "n", descriptor = "(B)I", line = 164)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(III[B)V", line = 187)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Ldw;I)I", line = 205)
    ...
    @OriginalMember(owner = "client!bn", name = "o", descriptor = "(II)V", line = 247)
