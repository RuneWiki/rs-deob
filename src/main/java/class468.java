...
public class class468 {
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IILha;Z)Lda;", line = 3)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(II)Lfha;", line = 25)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(III)Z", line = 59)
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(II)V", line = 71)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Lqk;Z)V", line = 89)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(ZI)V", line = 109)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(B)V", line = 125)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(I)V", line = 135)
    ...
    @OriginalMember(owner = "client!jp", name = "c", descriptor = "(II)I", line = 152)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(BI)V", line = 172)
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(I)V", line = 198)
    ...
    @OriginalMember(owner = "client!jp", name = "c", descriptor = "(I)V", line = 218)
    ...
    @OriginalMember(owner = "client!jp", name = "<init>", descriptor = "(Lmp;IZLla;Lla;)V", line = 252)
