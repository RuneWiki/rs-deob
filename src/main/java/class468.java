...
public abstract class class468 extends class587 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IFIFFIII)[F", line = 18)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lis;B)Lis;", line = 100)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(B)V", line = 151)
