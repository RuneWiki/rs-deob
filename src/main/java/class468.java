...
public class class468 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(ILnaa;II)V", line = 20)
    ...
    @OriginalMember(owner = "client!so", name = "toString", descriptor = "()Ljava/lang/String;", line = 32)
    public final String toString() {
        field6696++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "(II)V", line = 49)
