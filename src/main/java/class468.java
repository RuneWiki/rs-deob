...
public class class468 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lpu;II)Lek;")
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "()Lmm;")
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "(Lmo;)V")
