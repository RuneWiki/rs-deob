...
public class class468 {
    ...
    @OriginalMember(owner = "client!dv", name = "<init>", descriptor = "(Lht;)V", line = 134)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(II)Z", line = 13)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Lao;BI)Z", line = 23)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IZIZ)V", line = 44)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(III)V", line = 92)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(I)V", line = 115)
