...
public class class468 {
    ...
    @OriginalMember(owner = "client!dp", name = "d", descriptor = "(I)Loga;")
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(BI)Lvu;")
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "(Lrf;ILpl;)V")
