...
public class class468 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(BIILza;IIIII)V")
    ...
    @OriginalMember(owner = "client!pb", name = "<init>", descriptor = "(Lur;I)V")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(BI)Lkv;")
