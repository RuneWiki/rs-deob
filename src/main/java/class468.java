...
public class class468 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lga;)V")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(ZI)Lhk;")
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(Lsj;ILin;)V")
