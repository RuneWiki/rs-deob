...
public class class468 extends class564 {
    ...
    @OriginalMember(owner = "client!vaa", name = "m", descriptor = "(I)I")
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(ILha;I)Z")
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(ILkm;)V")
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(ZLha;IILkba;II)V")
    ...
    @OriginalMember(owner = "client!vaa", name = "f", descriptor = "(I)I")
    ...
    @OriginalMember(owner = "client!vaa", name = "b", descriptor = "(BLha;)Lml;")
    ...
    @OriginalMember(owner = "client!vaa", name = "o", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!vaa", name = "p", descriptor = "(I)Z")
    private final boolean method2793(int arg0) {
        ++field6623;
        return arg0 != -19066 ? true : this.field6632.field5046;
    }

    @OriginalMember(owner = "client!vaa", name = "b", descriptor = "(ILha;)Lkj;")
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(ZIIIBI)V")
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(Lha;III)Z")
