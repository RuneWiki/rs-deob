...
public class class468 {
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(Lud;I)Lus;")
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(I)Ltq;")
    ...
    @OriginalMember(owner = "client!maa", name = "b", descriptor = "(I)Ltq;")
    ...
    @OriginalMember(owner = "client!maa", name = "<init>", descriptor = "(Lnt;)V")
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(BLnt;)V")
