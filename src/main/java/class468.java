...
public class class468 extends class381 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Ldj;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(IC)C", line = 49)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(IC)Z", line = 92)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(III)Z", line = 115)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(IIII)Z", line = 132)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "([IIIZ)V", line = 155)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(BI[II)V", line = 171)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ZII)Z", line = 184)
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "(IIIIIIIII)V", line = 202)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(BI)[B", line = 218)
