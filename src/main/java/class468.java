...
public class class468 extends class184 {
    ...
    @OriginalMember(owner = "client!fj", name = "e", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "()V", line = 228)
    public class468() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(BILfh;)V", line = 94)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(II)[I", line = 203)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IIIIIII)I", line = 246)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(BI[I)V", line = 325)
