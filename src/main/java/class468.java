...
public class class468 extends class162 implements class276 {
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lmd;Lmd;FLmd;)Lmd;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lgn;Z)V")
    ...
    @OriginalMember(owner = "client!h", name = "<init>", descriptor = "(ILjava/awt/Canvas;Lm;Lci;)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lds;[Ldt;Z)Loa;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lc;Lgn;Lia;Lsf;I)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "([Lc;Lia;[Lsf;I)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Ldt;Z)Lf;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(I[Ltj;)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lgn;)V")
    ...
    @OriginalMember(owner = "client!h", name = "j", descriptor = "()Lia;")
    ...
    @OriginalMember(owner = "client!h", name = "d", descriptor = "(IIIIII)Lmd;")
    public final class379 method432(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lmd;)V")
    ...
    @OriginalMember(owner = "client!h", name = "e", descriptor = "(I)Ll;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIIIIF)Ltj;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Llo;IIII)Lc;")
