...
public class class468 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lfca;Lmt;)V", line = 5)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IIF)F", line = 72)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "()V", line = 78)
    public static void method2691() {
        field6332 = null;
        field6335 = null;
    }

    @OriginalMember(owner = "client!os", name = "b", descriptor = "(IIF)F", line = 88)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(F)F", line = 96)
    private static final float method2693(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IF)I", line = 100)
