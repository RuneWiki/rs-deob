...
public class class468 extends class214 {
    ...
    @OriginalMember(owner = "client!bl", name = "e", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "()V", line = 17)
    public class468() {
        super(1, true);
    }

    @OriginalMember(owner = "client!bl", name = "f", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(BLjava/lang/Object;Z)[B", line = 53)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(BIIII)V", line = 99)
    ...
    @OriginalMember(owner = "client!bl", name = "g", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Llk;II)V", line = 140)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(BI)[I", line = 183)
