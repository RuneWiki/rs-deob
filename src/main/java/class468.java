...
public class class468 {
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(IBI)Z", line = 7)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(Ldt;I)Lqi;", line = 25)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(IIII)V", line = 42)
