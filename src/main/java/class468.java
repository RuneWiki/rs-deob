...
public class class468 extends class476 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(I)[B", line = 7)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(III)[B", line = 21)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "([BB)V", line = 32)
