...
public class class468 extends class424 {
    ...
    @OriginalMember(owner = "client!vj", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(II)V", line = 16)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(BIIII)V", line = 36)
