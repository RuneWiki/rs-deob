...
public class class468 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(BI)Lpd;")
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(BLla;Lha;)V")
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Lpd;B)V")
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(Lpd;)V")
