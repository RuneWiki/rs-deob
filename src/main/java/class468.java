...
public abstract class class468 {
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(II)V", line = 7)
    public final void method2637(int arg0, int arg1) {
        this.method271(arg0, arg1, 1, 0, 1);
    }

    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(FFIIIII)V", line = 12)
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(FFIILfa;II)V", line = 21)
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(FFFFIIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(FFFFIILfa;II)V", line = 58)
    ...
    @OriginalMember(owner = "client!xa", name = "b", descriptor = "(IIII)V", line = 82)
