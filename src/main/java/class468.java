...
public class class468 extends class228 {
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Lte;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Lte;IIIII)V")
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Lte;IIII)V")
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Lte;IIIIZ[IZ)V")
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Lte;IIIIZ[FI)V")
