...
public class class557 extends class487 {
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "()Lq;")
    ...
    @OriginalMember(owner = "client!lu", name = "M", descriptor = "(Lq;)V")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Lr;Lci;BI)V")
