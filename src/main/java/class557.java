...
public class class557 extends class408 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IC)I", line = 6)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(CI)I", line = 33)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(ILrg;)V", line = 65)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IIIII)V", line = 91)
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(B)V", line = 151)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(ILrg;I)V", line = 164)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(I)V", line = 229)
    ...
    @OriginalMember(owner = "client!fs", name = "e", descriptor = "(I)V", line = 253)
