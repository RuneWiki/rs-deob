...
public class class557 extends class741 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IIZIIIILsn;IIII)Z")
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IILml;)V")
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "(Loaa;Lae;)V")
