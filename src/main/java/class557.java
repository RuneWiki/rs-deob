...
public class class557 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IIIILdba;Lpa;IIIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(I)J", line = 42)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IFIFF)F", line = 65)
