...
public class class557 extends class27 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(BZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IILvf;)V", line = 29)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(III)V", line = 41)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Z)Z", line = 143)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ZI)V", line = 156)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(Llj;)V", line = 167)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(B)V", line = 296)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 324)
