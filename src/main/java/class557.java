...
public class class557 extends class444 implements class706 {
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(ZLha;IILkba;II)V")
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(Lha;ZZI)Lqha;")
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(IILha;)Lka;")
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(Lha;III)Z")
    ...
    @OriginalMember(owner = "client!nda", name = "b", descriptor = "(ILha;)Lkj;")
    ...
    @OriginalMember(owner = "client!nda", name = "b", descriptor = "(BLha;)Lml;")
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!nda", name = "m", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!nda", name = "c", descriptor = "(B)I")
    ...
    @OriginalMember(owner = "client!nda", name = "i", descriptor = "(I)I")
    ...
    @OriginalMember(owner = "client!nda", name = "<init>", descriptor = "(Lha;Lhba;IIIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!nda", name = "g", descriptor = "(B)I")
    ...
    @OriginalMember(owner = "client!nda", name = "d", descriptor = "(I)Z")
