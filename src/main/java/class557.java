...
public class class557 extends class496 {
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!nda", name = "<init>", descriptor = "(Lqo;IIZ)V")
    ...
    @OriginalMember(owner = "client!nda", name = "<init>", descriptor = "(Lqo;IIII)V")
    ...
    @OriginalMember(owner = "client!nda", name = "<init>", descriptor = "(Lqo;II[III)V")
