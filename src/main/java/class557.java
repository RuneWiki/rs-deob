...
public class class557 extends class265 implements class532 {
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(Z)Lbk;")
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(Lkd;Lbk;Z)V")
