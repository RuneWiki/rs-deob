...
public class class557 extends class213 {
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(Lrb;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(Lr;B)Llt;", line = 18)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(Z)V", line = 144)
    ...
    @OriginalMember(owner = "client!kfa", name = "g", descriptor = "(B)I", line = 156)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(BIIIZI)V", line = 178)
    ...
    @OriginalMember(owner = "client!kfa", name = "b", descriptor = "(BLr;)Lsr;", line = 262)
    ...
    @OriginalMember(owner = "client!kfa", name = "m", descriptor = "(I)V", line = 273)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(Lr;III)Z", line = 288)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(BII)V", line = 347)
    ...
    @OriginalMember(owner = "client!kfa", name = "b", descriptor = "(I)I", line = 448)
    ...
    @OriginalMember(owner = "client!kfa", name = "c", descriptor = "(I)I", line = 470)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(Lr;Z)V", line = 492)
    ...
    @OriginalMember(owner = "client!kfa", name = "h", descriptor = "(I)V", line = 521)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(ILr;I)Z", line = 533)
    ...
    @OriginalMember(owner = "client!kfa", name = "i", descriptor = "(B)Z", line = 701)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(IIZLr;ILub;I)V", line = 712)
    ...
    @OriginalMember(owner = "client!kfa", name = "c", descriptor = "(B)Z", line = 724)
    ...
    @OriginalMember(owner = "client!kfa", name = "j", descriptor = "(B)Z", line = 747)
