...
public class class557 implements class702 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Ljava/lang/String;II)Lqk;")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ILev;III)Z")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(I)Lve;")
    public final class527 method606(int arg0) {
        field7912++;
        return arg0 == 0 ? class272.field3798 : null;
    }

    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(Ljava/lang/String;Lfda;Laba;IIIIIIIIII)V")
