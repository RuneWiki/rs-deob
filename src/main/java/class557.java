...
public class class557 {
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "()V", line = 3)
    public static final void method3341() {
        field8085 = null;
        field8097 = null;
    }

    @OriginalMember(owner = "client!vw", name = "b", descriptor = "()V", line = 10)
    public final void method3342() {
        this.field8090 = null;
    }

    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(Lha;Lvw;)Z", line = 15)
    public final boolean method3343(class543 arg0, class557 arg1) {
        return this.field8090 != null || this.method3347(arg0, arg1);
    }

    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(IIII)Z", line = 25)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(Lha;IIIIII)V", line = 82)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(Lha;)V", line = 120)
    ...
    @OriginalMember(owner = "client!vw", name = "b", descriptor = "(Lha;Lvw;)Z", line = 181)
    ...
    @OriginalMember(owner = "client!vw", name = "c", descriptor = "()V", line = 216)
    ...
    @OriginalMember(owner = "client!vw", name = "b", descriptor = "(Lha;)V", line = 223)
    ...
    @OriginalMember(owner = "client!vw", name = "c", descriptor = "(Lha;Lvw;)V", line = 304)
    ...
    @OriginalMember(owner = "client!vw", name = "d", descriptor = "(Lha;Lvw;)V", line = 387)
    ...
    @OriginalMember(owner = "client!vw", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 472)
