...
public class class557 extends class601 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(B[[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Lmc;II)V", line = 56)
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(II)[[I", line = 131)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IB)[I", line = 192)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "()V", line = 216)
    public class557() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(B[B)V", line = 220)
