...
public class class557 extends class646 {
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(Lek;IB)V")
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(Lek;II)V")
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(ZLvo;)V")
