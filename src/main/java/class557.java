...
public class class557 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Lha;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "([II[I[ILefa;)V", line = 54)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(BLjava/lang/String;)I", line = 156)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(B)V", line = 183)
