...
public class class557 extends InputStream {
    ...
    @OriginalMember(owner = "client!pt", name = "read", descriptor = "()I", line = 4)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IIIIIZII)V", line = 14)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Z)V", line = 143)
