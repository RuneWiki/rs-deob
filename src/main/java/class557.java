...
public class class557 extends class551 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lkq;B)I", line = 6)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(BI)Z", line = 49)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IZ)Z", line = 59)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IBII)V", line = 96)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(IIIIIF)V", line = 111)
    public class557(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!fi", name = "d", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(FI)V", line = 135)
