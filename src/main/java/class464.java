...
public class class464 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(II)Lbf;", line = 43)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(B)V", line = 129)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(IB)V", line = 145)
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "(Lee;ILul;)V", line = 166)
