...
public class class464 extends class562 {
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(II)[[I", line = 9)
    ...
    @OriginalMember(owner = "client!id", name = "c", descriptor = "(II)Z", line = 57)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IIIIIIBII)V", line = 74)
    ...
    @OriginalMember(owner = "client!id", name = "h", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Ljf;I)V", line = 112)
    ...
    @OriginalMember(owner = "client!id", name = "e", descriptor = "(B)V", line = 709)
