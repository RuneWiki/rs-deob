...
public class class464 implements Runnable {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Ljava/lang/String;BIJLhd;)V")
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Lb;I)V")
    ...
    @OriginalMember(owner = "client!nj", name = "f", descriptor = "(I)Lhd;")
