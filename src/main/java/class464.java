...
public class class464 extends class325 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(BI)[I", line = 6)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Z)V", line = 107)
    ...
    @OriginalMember(owner = "client!io", name = "e", descriptor = "(B)V", line = 130)
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "()V", line = 305)
    public class464() {
        super(0, true);
    }

    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Ljp;IB)V", line = 217)
