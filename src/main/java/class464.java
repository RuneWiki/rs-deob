...
public class class464 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIIILth;ZIILfp;ZIIB)V", line = 42)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(BI)V", line = 658)
