...
public abstract class class464 extends class337 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IIIIZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ZLjagtheora/ogg/OggPacket;)V", line = 51)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Z)V", line = 61)
    ...
    @OriginalMember(owner = "client!bk", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 73)
