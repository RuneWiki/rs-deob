...
public class class464 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lob;ZLmaa;Lqa;II)Z")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(B)[Lfo;")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lnc;B)V")
