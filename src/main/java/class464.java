...
public class class464 extends class402 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(IZ)V", line = 17)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "(Lpc;Lod;)V", line = 59)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(III)V", line = 81)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(IBLfha;)V", line = 110)
    ...
    @OriginalMember(owner = "client!jc", name = "c", descriptor = "(IZ)V", line = 156)
