...
public class class464 extends class694 implements class624 {
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ZLha;)V")
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(ILha;)Lww;")
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(BLha;)Lck;")
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Lha;Lqfa;IIIIIZIIII)V")
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(BILha;)Lka;")
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Lha;BIZ)Lga;")
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Lha;IIB)Z")
