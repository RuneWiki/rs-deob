...
public class class464 {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(B[[BLfca;)V", line = 4)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(IIIIIIIIIIIIII)V", line = 105)
