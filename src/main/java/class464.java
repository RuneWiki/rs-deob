...
public class class464 extends class381 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(BIII)I", line = 56)
