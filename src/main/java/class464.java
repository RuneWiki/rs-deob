...
public class class464 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "([III)Lte;")
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "([IIBI)Lte;")
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(I[II)Lte;")
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(I[IIB)Lte;")
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "(Lkea;Lkea;)V")
