...
public class class464 extends class214 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IBIIIIIIII)Z", line = 7)
    ...
    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 650)
    public class464(String arg0, int arg1) {
        this.field6618 = (short) arg1;
        this.field6620 = arg0;
    }

    @OriginalMember(owner = "client!os", name = "b", descriptor = "(B)V", line = 660)
