...
public class class464 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!pb", name = "b", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!pb", name = "c", descriptor = "(I)I", line = 219)
    ...
    @OriginalMember(owner = "client!pb", name = "d", descriptor = "(I)V", line = 240)
    ...
    @OriginalMember(owner = "client!pb", name = "<init>", descriptor = "()V", line = 252)
    private class464() {
    }

    @OriginalMember(owner = "client!pb", name = "<init>", descriptor = "([I)V", line = 258)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IIIII)V", line = 281)
