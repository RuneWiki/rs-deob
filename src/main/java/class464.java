...
public class class464 extends class646 {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(II)[[I", line = 10)
    ...
    @OriginalMember(owner = "client!og", name = "d", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!og", name = "f", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "()V", line = 141)
    public class464() {
        super(1, false);
    }

    @OriginalMember(owner = "client!og", name = "b", descriptor = "(IB)[I", line = 144)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Lek;IB)V", line = 183)
