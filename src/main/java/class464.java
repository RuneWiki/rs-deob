...
public class class464 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(JLwf;B)V", line = 7)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(I)Lwf;", line = 28)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(ILhd;)V", line = 59)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IJ)Lwf;", line = 100)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IIIIIIIB)V", line = 138)
    ...
    @OriginalMember(owner = "client!rs", name = "<init>", descriptor = "(I)V", line = 194)
