...
public class class464 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IZ)Z", line = 3)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IIBI)I", line = 31)
