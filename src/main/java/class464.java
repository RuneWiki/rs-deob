...
public class class464 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Ldh;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(ILdh;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IZLqa;I)Lf;", line = 68)
    ...
    @OriginalMember(owner = "client!pb", name = "b", descriptor = "(I)Z", line = 112)
