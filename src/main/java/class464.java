...
public class class464 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(B)Z", line = 12)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!bg", name = "b", descriptor = "(I)Lm;", line = 41)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Z)Lm;", line = 63)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ILbg;)V", line = 85)
    ...
    @OriginalMember(owner = "client!bg", name = "b", descriptor = "(B)Lm;", line = 96)
    ...
    @OriginalMember(owner = "client!bg", name = "c", descriptor = "(I)Lm;", line = 115)
    ...
    @OriginalMember(owner = "client!bg", name = "d", descriptor = "(I)I", line = 134)
    ...
    @OriginalMember(owner = "client!bg", name = "e", descriptor = "(I)Lm;", line = 157)
    ...
    @OriginalMember(owner = "client!bg", name = "f", descriptor = "(I)V", line = 181)
    ...
    @OriginalMember(owner = "client!bg", name = "c", descriptor = "(B)V", line = 197)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lbe;Z)V", line = 219)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lm;I)V", line = 280)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(BLm;)V", line = 300)
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "()V", line = 343)
    public class464() {
        this.field6565.field2543 = this.field6565;
        this.field6565.field2545 = this.field6565;
    }

    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ILbg;Lm;)V", line = 320)
