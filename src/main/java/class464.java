...
public class class464 extends class343 {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Ldf;IZIIILha;)V")
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Lha;III)Lka;")
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Lha;I)Lcca;")
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(BLha;)Ltf;")
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Lha;ZLqq;Lka;)V")
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IIILqj;Lqj;)V")
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IILha;B)Z")
    ...
    @OriginalMember(owner = "client!ti", name = "c", descriptor = "(ILha;)V")
