...
public class class464 {
    ...
    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "(Lwb;)V", line = 126)
    public class464(class45 arg0) {
        this.field6537 = arg0;
    }

    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(I)Lpt;", line = 10)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(BLoj;)V", line = 40)
    ...
    @OriginalMember(owner = "client!tj", name = "b", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!tj", name = "c", descriptor = "(I)Lpt;", line = 79)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IBIII)V", line = 88)
    ...
    @OriginalMember(owner = "client!tj", name = "d", descriptor = "(I)V", line = 104)
