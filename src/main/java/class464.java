...
public class class464 extends class651 {
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!it", name = "d", descriptor = "()V", line = 12)
    public final void method3564() {
        this.field6767 = true;
    }

    @OriginalMember(owner = "client!it", name = "c", descriptor = "()Lkia;", line = 15)
    public final class788 method3565() {
        return this.field6777;
    }

    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Lha;)V", line = 18)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(J)V", line = 31)
    public final void method3567(long arg0) {
        this.field6769 = arg0;
    }

    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "(IZ)V", line = 394)
    private class464(int arg0, boolean arg1) {
        this.method3563(arg0, arg1);
    }

    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IIIII)V", line = 38)
    public final void method3568(int arg0, int arg1, int arg2, int arg3, int arg4) {
        this.field6774 = arg0;
    }

    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Lha;J[Lkw;[Liia;Z)V", line = 49)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Lha;J)Z", line = 57)
    ...
    @OriginalMember(owner = "client!it", name = "e", descriptor = "()V", line = 107)
    public final void method3571() {
        this.field6775 = true;
    }

    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Lha;[Lkw;Z)V", line = 112)
    ...
    @OriginalMember(owner = "client!it", name = "g", descriptor = "()V", line = 190)
    private final void method3573() {
        this.field6767 = false;
    }

    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IZ)Lit;", line = 196)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "([Liia;Z)V", line = 211)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "()V", line = 299)
    public static void method3576() {
        field6768 = null;
        field6770 = null;
    }

    @OriginalMember(owner = "client!it", name = "b", descriptor = "()Lkia;", line = 308)
    ...
    @OriginalMember(owner = "client!it", name = "f", descriptor = "()V", line = 323)
