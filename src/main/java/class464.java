...
public class class464 extends class499 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "([Ljava/lang/String;IIZ)Ljava/lang/String;", line = 37)
    ...
    @OriginalMember(owner = "client!mj", name = "<init>", descriptor = "(IIIIIZ)V", line = 103)
