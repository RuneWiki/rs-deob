...
public class class464 {
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(I)V", line = 99)
    public class464(int arg0) {
        this.field6486 = arg0;
    }

    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(IIIIII)V", line = 114)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(B)Lph;", line = 8)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(BIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ILph;)V", line = 65)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(III)Lhr;", line = 84)
