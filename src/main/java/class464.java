...
public class class464 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "([III)V", line = 9)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lr;[II)V", line = 64)
    public static final void method2732(class166 arg0, int[] arg1, int arg2) {
        method2736(arg0, arg1, 0, arg1.length, arg2, null, null);
    }

    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(I)Z", line = 68)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(II)V", line = 143)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lr;[II[I[I)V", line = 180)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lr;[IIII[I[I)V", line = 188)
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "()V", line = 225)
    private static final void method2737() {
        field6673 = 0;
    }

    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(II)V", line = 228)
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(I)V", line = 273)
