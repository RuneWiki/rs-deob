...
public class class464 extends class45 {
    ...
    @OriginalMember(owner = "client!pb", name = "<init>", descriptor = "()V", line = 7)
    public class464() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Lcu;II)V", line = 27)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(II)[I", line = 67)
