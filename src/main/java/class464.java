...
public abstract class class464 {
    ...
    @OriginalMember(owner = "client!is", name = "b", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(BLjava/lang/String;)V", line = 21)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(ZJ)I", line = 129)
