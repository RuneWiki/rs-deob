...
public abstract class class489 {
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(Ljava/lang/Throwable;B)Ljava/lang/String;", line = 12)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(ZBLjava/io/File;)V", line = 83)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(B)V", line = 107)
    ...
    @OriginalMember(owner = "client!lda", name = "<init>", descriptor = "(Leq;)V", line = 126)
