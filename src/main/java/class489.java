...
public abstract class class489 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIILjava/lang/String;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILjava/lang/String;)V", line = 55)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIII[II[Lf;ILea;IBILjava/lang/String;III)I", line = 86)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[IIIILjava/lang/String;IILjava/util/Random;[Lf;)I", line = 101)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(BLqa;Ldt;Lcn;)V", line = 140)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[Lf;ILjava/lang/String;Lea;IIIIIII[IIII)I", line = 292)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIILjava/lang/String;I)V", line = 392)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IBI)V", line = 420)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIILjava/lang/String;II)V", line = 439)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([IILjava/lang/String;[Lf;I[II[I)V", line = 472)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(ILjava/lang/String;)V", line = 641)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([IIIII[I[Lf;IIIBILjava/lang/String;Ljava/util/Random;I)I", line = 728)
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Lqa;Lje;)V", line = 808)
    public class489(class162 arg0, class275 arg1) {
        this.field7216 = arg1;
        this.field7229 = arg0;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/lang/String;IBIII)V", line = 817)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[Lf;I[IILea;ILjava/lang/String;)V", line = 833)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(B)V", line = 983)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIILjava/lang/String;Z)V", line = 994)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/lang/String;[Lf;III[III)V", line = 1011)
