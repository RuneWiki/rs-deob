...
public abstract class class489 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIII[IILjava/util/Random;Ljava/lang/String;[Lf;II[III)I")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lea;IIIIILjava/lang/String;[Lf;[I)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(III[IILea;IILjava/lang/String;IIIII[Lf;I)I")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([ILjava/util/Random;ILjava/lang/String;IIIZ[Lf;I)I")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILjava/lang/String;ILea;II[IIIII[Lf;)I")
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Lqa;Leu;)V")
    public class489(class162 arg0, class332 arg1) {
        this.field7229 = arg1;
        this.field7234 = arg0;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/lang/String;[Lf;I[IBI[I[I)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(BI[Lf;I[ILjava/lang/String;II)V")
