...
public class class489 extends class639 {
    ...
    @OriginalMember(owner = "client!rt", name = "b", descriptor = "(B)I", line = 9)
    ...
    @OriginalMember(owner = "client!rt", name = "b", descriptor = "(I)I", line = 23)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(II)V", line = 47)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(Ljava/lang/String;B)[B", line = 78)
    ...
    @OriginalMember(owner = "client!rt", name = "c", descriptor = "(I)V", line = 216)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(BLjava/awt/Component;IILrp;)Lefa;", line = 241)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IB)[B", line = 322)
    ...
    @OriginalMember(owner = "client!rt", name = "d", descriptor = "(I)V", line = 342)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(BI)I", line = 530)
    ...
    @OriginalMember(owner = "client!rt", name = "e", descriptor = "(I)V", line = 549)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(ZII)Z", line = 592)
    ...
    @OriginalMember(owner = "client!rt", name = "<init>", descriptor = "(ILkv;Lkv;Lth;Lqw;I[BIZ)V", line = 1063)
    ...
    @OriginalMember(owner = "client!rt", name = "f", descriptor = "(I)V", line = 614)
    ...
    @OriginalMember(owner = "client!rt", name = "b", descriptor = "(Z)I", line = 626)
    ...
    @OriginalMember(owner = "client!rt", name = "g", descriptor = "(I)I", line = 640)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(Z)Lvh;", line = 665)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(III)Lgf;", line = 765)
