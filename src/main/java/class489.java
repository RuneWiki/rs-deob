...
public class class489 {
    ...
    @OriginalMember(owner = "client!jt", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field7399++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "(I)V", line = 18)
    public class489(int arg0) {
        this.field7400 = arg0;
    }

    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IIIIII)V", line = 40)
