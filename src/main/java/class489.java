...
public abstract class class489 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIILjava/lang/String;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([IBI[Lf;Ljava/lang/String;[II[I)V", line = 37)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIIIILea;Ljava/lang/String;[Lf;I[III)I", line = 205)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(IIIILjava/lang/String;II)V", line = 302)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I)V", line = 325)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(B)V", line = 337)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/lang/String;[IIILjava/util/Random;IIII[Lf;)I", line = 349)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIBIILjava/lang/String;)V", line = 386)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 402)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[Lf;IILea;ILjava/lang/String;I[I)V", line = 437)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIIII)V", line = 590)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/lang/String;ZIIII)V", line = 610)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[Lf;II[IILjava/lang/String;)V", line = 627)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIBLea;II[Lf;IIIIII[IILjava/lang/String;)I", line = 642)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(ILjava/lang/String;IBIIII)V", line = 656)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/lang/String;IIIII)V", line = 688)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(ZII)V", line = 704)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(I)V", line = 724)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(ILjava/lang/String;)V", line = 734)
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Lqa;Lre;)V", line = 806)
    public class489(class162 arg0, class425 arg1) {
        this.field6785 = arg1;
        this.field6799 = arg0;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IB[IILjava/util/Random;I[ILjava/lang/String;IIII[Lf;II)I", line = 826)
