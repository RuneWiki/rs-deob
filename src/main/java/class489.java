...
public class class489 extends class48 {
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(Lli;II[III)V")
    ...
    @OriginalMember(owner = "client!fu", name = "b", descriptor = "()Leg;")
    ...
    @OriginalMember(owner = "client!fu", name = "d", descriptor = "()Leg;")
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(Lli;II)V")
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(Llfa;)V")
