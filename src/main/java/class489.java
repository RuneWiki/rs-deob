...
public class class489 extends class165 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(ILjava/awt/Graphics;IIBI)V", line = 10)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IIILjava/awt/Graphics;)V", line = 27)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 39)
