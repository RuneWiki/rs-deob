...
public class class489 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIIII)V", line = 76)
    ...
    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(IIIII)V", line = 90)
