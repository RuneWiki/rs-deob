...
public class class489 extends class138 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(II)Lwd;")
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IILr;III[[[BIIIIII)V")
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(I[BILmr;)Liea;")
