...
public class class489 extends class144 {
    ...
    @OriginalMember(owner = "client!up", name = "finalize", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Lr;I)Lej;", line = 17)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(BI)V", line = 63)
    ...
    @OriginalMember(owner = "client!up", name = "b", descriptor = "(ILr;)Leh;", line = 125)
    ...
    @OriginalMember(owner = "client!up", name = "j", descriptor = "(I)V", line = 138)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(IIIIIIIIIIIIZ)V", line = 149)
    ...
    @OriginalMember(owner = "client!up", name = "h", descriptor = "(I)Z", line = 174)
    ...
    @OriginalMember(owner = "client!up", name = "i", descriptor = "(I)I", line = 186)
    public final int method626(int arg0) {
        ++field7023;
        return arg0 != -32768 ? 106 : this.field7016;
    }

    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Lq;ILda;Lr;)V", line = 198)
    ...
    @OriginalMember(owner = "client!up", name = "c", descriptor = "(ILr;)V", line = 225)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(B)I", line = 250)
    ...
    @OriginalMember(owner = "client!up", name = "c", descriptor = "(Z)Z", line = 263)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(BLr;I)Lda;", line = 274)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IBIII)V", line = 294)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IILr;B)Z", line = 351)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Lvj;IZLr;IIB)V", line = 379)
    ...
    @OriginalMember(owner = "client!up", name = "k", descriptor = "(I)V", line = 395)
    ...
    @OriginalMember(owner = "client!up", name = "g", descriptor = "(I)Z", line = 409)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Z)V", line = 422)
