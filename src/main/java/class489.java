...
public class class489 extends class139 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Z)Lht;")
    ...
    @OriginalMember(owner = "client!bf", name = "b", descriptor = "(Loa;I)Lok;")
    ...
    @OriginalMember(owner = "client!bf", name = "c", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(ILoa;)Lgr;")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IILoa;I)Z")
