...
public class class489 extends class440 {
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(ZZB)V", line = 3)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(BI)[I", line = 26)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(IBI)I", line = 58)
    ...
    @OriginalMember(owner = "client!iba", name = "<init>", descriptor = "()V", line = 78)
    public class489() {
        super(0, true);
    }
}
