...
public class class489 extends class477 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(B)Z", line = 4)
    public final boolean method264(byte arg0) {
        ++field7135;
        return arg0 <= 45 ? true : this.field7131;
    }

    @OriginalMember(owner = "client!on", name = "a", descriptor = "(ZI)V", line = 17)
    ...
    @OriginalMember(owner = "client!on", name = "<init>", descriptor = "(Lgk;Lwl;)V", line = 28)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(ZZ)V", line = 49)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lrh;II)V", line = 83)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(BII)V", line = 106)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Z)V", line = 144)
    ...
    @OriginalMember(owner = "client!on", name = "b", descriptor = "(Z)V", line = 155)
    ...
    @OriginalMember(owner = "client!on", name = "b", descriptor = "(I)V", line = 174)
    ...
    @OriginalMember(owner = "client!on", name = "b", descriptor = "(B)V", line = 192)
