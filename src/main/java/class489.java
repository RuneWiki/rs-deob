...
public class class489 implements class595 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "([IJLed;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lub;I)I")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Luq;I)V")
