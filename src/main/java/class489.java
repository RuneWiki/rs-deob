...
public class class489 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(B)Lom;", line = 10)
    public static final class252 method2861(byte arg0) {
        field7140++;
        return arg0 > -48 ? null : class350.field5111;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lod;B[[B)V", line = 36)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(B)V", line = 72)
