...
public class class489 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(I[II)Lar;", line = 3)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(I[III)Lar;", line = 33)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "([III)Lar;", line = 83)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "(Lgp;Lgp;)V", line = 162)
    public class489(class561 arg0, class561 arg1) {
        this.field6884 = arg1;
        this.field6880 = arg0;
    }

    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(III[I)Lar;", line = 124)
