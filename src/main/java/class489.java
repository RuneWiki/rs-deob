...
public class class489 extends class216 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(I)J", line = 39)
    ...
    @OriginalMember(owner = "client!kb", name = "c", descriptor = "(I)J", line = 49)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "()V", line = 102)
    public class489() {
