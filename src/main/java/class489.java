...
public class class489 {
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(III)V", line = 25)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IIII)V", line = 167)
