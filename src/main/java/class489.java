...
public class class489 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(II)Lsv;", line = 6)
    ...
    @OriginalMember(owner = "client!dq", name = "toString", descriptor = "()Ljava/lang/String;", line = 29)
    public final String toString() {
        field7142++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(I)Ljava/lang/String;", line = 39)
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "(II)V", line = 73)
    public class489(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B)V", line = 86)
