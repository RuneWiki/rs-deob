...
public class class489 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "([I)V", line = 56)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Ll;Ljava/awt/Canvas;IB)Lza;", line = 101)
