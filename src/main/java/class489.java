...
public class class489 {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(III)Z", line = 26)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 60)
