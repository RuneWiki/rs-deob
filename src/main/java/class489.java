...
public class class489 extends class295 {
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(Lsn;I)V")
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ZLsn;)V")
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ILwq;)V")
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lsn;I)V")
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ZFIILo;)V")
