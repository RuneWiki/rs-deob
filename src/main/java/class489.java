...
public class class489 {
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "()V", line = 118)
    public class489() {
    }

    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(Lwaa;)V", line = 267)
    public class489(class652 arg0) {
        this.field6831 = arg0;
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 20)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Z)Lii;", line = 127)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(B)V", line = 160)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(I)Lii;", line = 173)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IFIIIIII[FIIFF)V", line = 185)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIZ)Z", line = 278)
