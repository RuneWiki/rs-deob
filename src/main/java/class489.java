...
public class class489 extends class357 implements class407 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(BI[BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(Lffa;I[BI)V", line = 18)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(B)I", line = 31)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I)I", line = 42)
    ...
    @OriginalMember(owner = "client!bg", name = "b", descriptor = "(B)J", line = 53)
    ...
    @OriginalMember(owner = "client!bg", name = "b", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(Lffa;ILjaclib/memory/Buffer;)V", line = 75)
