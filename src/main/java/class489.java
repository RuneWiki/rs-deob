...
public class class489 extends class321 {
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(B)J", line = 3)
    public final long method2791(byte arg0) {
        ++field6951;
        return arg0 != -76 ? -113L : Long.MAX_VALUE & super.field4679;
    }

    @OriginalMember(owner = "client!sda", name = "d", descriptor = "(B)I", line = 14)
    ...
    @OriginalMember(owner = "client!sda", name = "e", descriptor = "(B)I", line = 25)
    public final int method2793(byte arg0) {
        ++field6943;
        return arg0 != 12 ? -67 : (int) (255L & super.field5740 >>> 32);
    }

    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(IIZLmv;IIZ)V", line = 36)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(IB)V", line = 63)
    ...
    @OriginalMember(owner = "client!sda", name = "e", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!sda", name = "f", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!sda", name = "f", descriptor = "(B)Lmi;", line = 121)
    ...
    @OriginalMember(owner = "client!sda", name = "g", descriptor = "(I)V", line = 138)
    ...
    @OriginalMember(owner = "client!sda", name = "<init>", descriptor = "(II)V", line = 158)
