...
public class class489 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(ILjp;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Ljp;I)V", line = 213)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IIIBLka;III)Lka;", line = 240)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(ZIII)I", line = 332)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Ljava/lang/String;IIZ)V", line = 477)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(I)V", line = 596)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(ILka;ZIII)Lka;", line = 625)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(B)V", line = 770)
