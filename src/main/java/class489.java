...
public class class489 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lha;Llga;Lii;)V")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lha;Llga;IIII)V")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lha;Lcea;IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lin;Lcb;Lqe;Luha;Lon;Loda;Ldd;)V")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lha;IIIIIII[S[BZ)V")
    ...
    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(I)Ldfa;")
    public static final class167 method2885(int arg0) {
        return (class167) field6763.method1465((long) arg0, -6008);
    }

    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(Lha;)Luh;")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Ld;III)I")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lha;IIII)Luh;")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lha;IIII[S[B)V")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Ld;II)V")
    ...
    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(Lha;IIII)V")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(II)Ldfa;")
    ...
    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(II)Lmn;")
