...
public class class489 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(III)Z", line = 42)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IIIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(III)I", line = 72)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IIZI)I", line = 89)
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(Lad;)V", line = 113)
    public class489(class362 arg0) {
        this.field7126 = arg0;
    }

    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ILrv;FLrv;)Z", line = 125)
