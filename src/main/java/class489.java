...
public class class489 extends class136 implements class455 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(I[BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "()I", line = 8)
    public final int method747() {
        return 0;
    }

    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(Lic;I[BI)V", line = 11)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(III)V", line = 17)
