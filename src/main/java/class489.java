...
public class class489 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IILre;)V", line = 15)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lre;B)V", line = 182)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IB)V", line = 213)
