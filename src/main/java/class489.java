...
public class class489 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(CB)Z", line = 16)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(ILwk;)V", line = 44)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IIIIIII)V", line = 480)
