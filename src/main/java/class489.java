...
public class class489 extends class387 {
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(ZB)V", line = 3)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(I)Z", line = 40)
    ...
    @OriginalMember(owner = "client!lda", name = "b", descriptor = "(Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(Z)V", line = 96)
    ...
    @OriginalMember(owner = "client!lda", name = "<init>", descriptor = "(Lrda;Llba;)V", line = 119)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(II)V", line = 131)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(III)V", line = 147)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(BILiga;)V", line = 194)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(BZ)V", line = 206)
