...
public class class489 extends class577 {
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "([Lmea;BIIZI)V")
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(Lha;ILjp;)I")
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(Lje;[Lqm;)V")
