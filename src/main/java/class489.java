...
public class class489 extends class323 {
    ...
    @OriginalMember(owner = "client!im", name = "b", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(BBI)V", line = 38)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(BII)V", line = 53)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(III)I", line = 88)
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(IIIIIFFF)V", line = 120)
    ...
    @OriginalMember(owner = "client!im", name = "d", descriptor = "(I)V", line = 130)
