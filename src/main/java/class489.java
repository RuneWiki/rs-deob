...
public class class489 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(BLgga;)Lom;", line = 21)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(BLgga;)V", line = 57)
    ...
    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "(Lgga;)V", line = 220)
    public class489(class511 arg0) {
        this.method2893((byte) -71, arg0);
    }

    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Lhia;I)V", line = 139)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IZIB)I", line = 164)
