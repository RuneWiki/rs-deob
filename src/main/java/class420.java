...
public class class420 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!sg", name = "b", descriptor = "(B)[Lwg;", line = 45)
