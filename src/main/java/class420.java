...
public class class420 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(I)Z", line = 30)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(B)Z", line = 54)
    ...
    @OriginalMember(owner = "client!hn", name = "<init>", descriptor = "(BIIIIIILnfa;)V", line = 66)
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(B)V", line = 82)
