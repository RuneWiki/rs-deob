...
public abstract class class420 extends class640 {
    ...
    @OriginalMember(owner = "client!df", name = "c", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!df", name = "g", descriptor = "(I)I", line = 42)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "([Luf;IIB)I", line = 59)
    ...
    @OriginalMember(owner = "client!df", name = "f", descriptor = "(I)V", line = 100)
