...
public class class420 extends class533 {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!du", name = "<init>", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(FIFIFIIB[FIF)V", line = 36)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(IBII)V", line = 166)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(IIIZII)V", line = 177)
