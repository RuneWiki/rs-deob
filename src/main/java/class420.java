...
public class class420 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(ILpe;IIIIIIIZII[II[I)I", line = 19)
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(ZI)V", line = 218)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(B)Z", line = 237)
    ...
    @OriginalMember(owner = "client!cb", name = "c", descriptor = "(I)V", line = 256)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(II)V", line = 275)
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(ZI)V", line = 303)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(BI)Lqs;", line = 319)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Z)V", line = 348)
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(Lci;IZLg;Lg;)V", line = 379)
