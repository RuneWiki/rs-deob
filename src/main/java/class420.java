...
public class class420 {
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(CILjava/lang/String;)[Ljava/lang/String;", line = 17)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(III)Z", line = 52)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(ZII)Z", line = 63)
    ...
    @OriginalMember(owner = "client!mt", name = "finalize", descriptor = "()V", line = 82)
    ...
    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "(Lji;II)V", line = 91)
