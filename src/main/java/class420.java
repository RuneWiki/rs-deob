...
public class class420 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "([Let;II)V")
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(I)Lef;")
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(Z)Lef;")
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(Lef;Z)V")
