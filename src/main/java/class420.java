...
public abstract class class420 extends class128 {
    ...
    @OriginalMember(owner = "client!hs", name = "d", descriptor = "(B)Z")
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(BZLfd;)V")
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ZIIILai;ILvm;)V")
