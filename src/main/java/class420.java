...
public class class420 extends class260 {
    ...
    @OriginalMember(owner = "client!et", name = "c", descriptor = "(I)Ltt;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IIIIIIILya;IIII[[[B)V")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lya;IB)Lt;")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
