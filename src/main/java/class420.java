...
public class class420 {
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lom;Lnq;Lnq;ILnq;)Z")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(BLpn;J)V")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(JI)Lpn;")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lnq;BLnq;)V")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Z[II[IIIIIIIIIIILhh;)I")
