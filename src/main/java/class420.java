...
public class class420 extends class48 implements class9 {
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lae;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!no", name = "e", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(Lae;Ljh;IIIIIIIZIIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lae;ZI)Lbk;", line = 51)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ILae;)V", line = 63)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(B)I", line = 74)
    ...
    @OriginalMember(owner = "client!no", name = "d", descriptor = "(I)I", line = 87)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!no", name = "d", descriptor = "(B)I", line = 115)
    ...
    @OriginalMember(owner = "client!no", name = "b", descriptor = "(I)Z", line = 127)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(BLae;)Ljg;", line = 138)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ILae;II)Z", line = 176)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lae;I)V", line = 196)
    ...
    @OriginalMember(owner = "client!no", name = "c", descriptor = "(I)I", line = 207)
