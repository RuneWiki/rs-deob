...
public class class420 implements class255 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Z)Lqi;", line = 31)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(BIIIIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(Ljava/lang/String;Lgq;Lkfa;IIIIIIIIII)V", line = 70)
