...
public class class420 extends class59 {
    ...
    @OriginalMember(owner = "client!hs", name = "c", descriptor = "(II)V", line = 20)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Lja;ZI[Lc;IIIIZI[BI)V", line = 37)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIBLqo;)V", line = 117)
    ...
    @OriginalMember(owner = "client!hs", name = "c", descriptor = "(I)V", line = 450)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IBZ)V", line = 471)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIIII)V", line = 556)
    ...
    @OriginalMember(owner = "client!hs", name = "d", descriptor = "(I)V", line = 575)
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "()V", line = 776)
    protected class420() {
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(Lec;)V", line = 786)
