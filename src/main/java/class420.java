...
public class class420 {
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(I[B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(II)V", line = 27)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Z)V", line = 45)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IIIIIIIIII)V", line = 81)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IIII)V", line = 156)
