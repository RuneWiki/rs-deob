...
public class class420 extends class349 {
    ...
    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "()V", line = 594)
    public class420() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ke", name = "b", descriptor = "(BI)[I", line = 11)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IILdga;)V", line = 262)
    ...
    @OriginalMember(owner = "client!ke", name = "c", descriptor = "(B)V", line = 357)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(ZIIII)V", line = 369)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "([[ILjava/util/Random;BIIII)V", line = 389)
    ...
    @OriginalMember(owner = "client!ke", name = "d", descriptor = "(B)V", line = 600)
