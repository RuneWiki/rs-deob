...
public class class420 extends class151 implements class226 {
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(Lhj;ILjava/nio/ByteBuffer;)V", line = 5)
    public class420(class338 arg0, int arg1, ByteBuffer arg2) {
        super(arg0, arg2);
        this.field6066 = arg1;
    }

    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(Lln;)V", line = 9)
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(Lhj;I[BI)V", line = 12)
    public class420(class338 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field6066 = arg1;
    }

    @OriginalMember(owner = "client!ed", name = "a", descriptor = "()I", line = 16)
    public final int method641() {
        return 0;
    }

    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(I[BI)V", line = 19)
    public final void method1433(int arg0, byte[] arg1, int arg2) {
        this.method1027(arg1, arg2);
        this.field6066 = arg0;
    }

    @OriginalMember(owner = "client!ed", name = "c", descriptor = "(Lln;)V", line = 24)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Lln;)V", line = 27)
    ...
    @OriginalMember(owner = "client!ed", name = "d", descriptor = "(Lln;)V", line = 30)
