...
public class class420 extends class114 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Lt;)V", line = 3)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Z)V", line = 10)
    public final void method304(boolean arg0) {
        this.field1748.method2212(8448, 7681);
    }

    @OriginalMember(owner = "client!gq", name = "a", descriptor = "()Z", line = 13)
    public final boolean method309() {
        return true;
    }

    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Lmm;)V", line = 37)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "()V", line = 75)
