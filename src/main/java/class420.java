...
public class class420 extends class145 {
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(Z)Lvh;", line = 5)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Ljava/lang/String;Z)Ljava/lang/String;", line = 16)
    ...
    @OriginalMember(owner = "client!mf", name = "e", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ILkda;)V", line = 109)
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(B)V", line = 166)
