...
public abstract class class420 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([ILjava/lang/String;[IBI[I[Lpu;I)V", line = 10)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IILjava/lang/String;III)V", line = 172)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIILjava/util/Random;Ljava/lang/String;[II[Lpu;II)I", line = 187)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Lpu;IIIII[IILjava/util/Random;II[IIILjava/lang/String;)I", line = 224)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIILjava/lang/String;IB)V", line = 308)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILjava/lang/String;IBILaa;[Lpu;I[I)V", line = 323)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 472)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIILjava/lang/String;)V", line = 550)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(BILaa;IILjava/lang/String;II[Lpu;IIIIII[I)I", line = 574)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/lang/String;IIIII)V", line = 590)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(B)V", line = 609)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Z)Z", line = 621)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/lang/String;I[Lpu;IIII[I)V", line = 723)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIILjava/lang/String;IIII)V", line = 737)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/lang/String;I[Lpu;IIIBILaa;IIIII[III)I", line = 770)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIB)V", line = 876)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIILjava/lang/String;III)V", line = 897)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IZLjava/lang/String;)V", line = 929)
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lha;Lne;)V", line = 969)
