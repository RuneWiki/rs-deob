...
public class class420 extends class80 {
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "()V", line = 3)
    public class420() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(II)[I", line = 6)
    ...
    @OriginalMember(owner = "client!ot", name = "c", descriptor = "(B)V", line = 94)
    ...
    @OriginalMember(owner = "client!ot", name = "d", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(BI)Z", line = 125)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(IIB)Z", line = 138)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IILnn;)V", line = 165)
