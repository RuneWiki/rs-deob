...
public abstract class class420 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIIII)Luj;", line = 43)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IILba;ILii;IIZ)V", line = 75)
