...
public class class420 extends class320 {
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IZI)Z", line = 6)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IBI)Z", line = 17)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "()V", line = 64)
    public class420() {
    }

    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(S)V", line = 67)
