...
public class class420 extends class659 implements class745 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(IILha;IIIIIIIILtd;)V")
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "(Llf;III)V")
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "(Llf;IIII)V")
