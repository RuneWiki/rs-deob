...
public class class420 extends class235 implements class529 {
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Lya;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IILya;Z)Lmg;", line = 37)
    ...
    @OriginalMember(owner = "client!rj", name = "d", descriptor = "(B)Z", line = 69)
    ...
    @OriginalMember(owner = "client!rj", name = "e", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(BLwn;[[B)V", line = 90)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(B)I", line = 124)
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(Lya;I)V", line = 137)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Lya;II)Lt;", line = 149)
    ...
    @OriginalMember(owner = "client!rj", name = "d", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IILfi;BZLya;I)V", line = 181)
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(Lya;Lrd;IIIIZIIZ)V", line = 221)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(III)Z", line = 255)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Z)I", line = 268)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(BILya;)Lt;", line = 283)
    ...
    @OriginalMember(owner = "client!rj", name = "c", descriptor = "(Lya;I)Lfk;", line = 303)
    ...
    @OriginalMember(owner = "client!rj", name = "c", descriptor = "(I)I", line = 333)
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(I)V", line = 343)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IILya;I)Z", line = 357)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(I)Z", line = 381)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ZLya;)V", line = 392)
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(III)V", line = 419)
