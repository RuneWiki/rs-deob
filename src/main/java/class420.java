...
public class class420 extends class552 implements class187 {
    ...
    @OriginalMember(owner = "client!ep", name = "<init>", descriptor = "(Lgaa;Lec;III[B)V")
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Lmv;I)V")
    public final void method521(class688 arg0, int arg1) {
        super.method521(arg0, arg1);
    }

    @OriginalMember(owner = "client!ep", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
