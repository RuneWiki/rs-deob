...
public class class420 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ZI)V", line = 61)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ZLql;I)V", line = 123)
