...
public class class420 {
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(IIIILqa;II)V", line = 9)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!mw", name = "b", descriptor = "(I)V", line = 221)
    public static void method2474(int arg0) {
        field5697 = null;
        int var1 = -89 / ((arg0 - 53) / 54);
    }

    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(IIZ)V", line = 234)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(III)Luj;", line = 315)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(IIIII)V", line = 326)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(IIIBIIZ)V", line = 340)
    ...
    @OriginalMember(owner = "client!mw", name = "<init>", descriptor = "()V", line = 380)
    protected class420() {
    ...
    @OriginalMember(owner = "client!mw", name = "<init>", descriptor = "(Lqa;Lgw;I)V", line = 390)
