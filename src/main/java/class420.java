...
public class class420 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lza;)V", line = 5)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "()V", line = 85)
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "()V", line = 92)
    public static final void method2487() {
        field5915 = null;
        field5914 = null;
    }

    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(Lza;)V", line = 96)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lza;Lpm;)Z", line = 158)
    public final boolean method2489(class290 arg0, class420 arg1) {
        return this.field5925 != null || this.method2495(arg0, arg1);
    }

    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lza;IIIIII)V", line = 161)
    ...
    @OriginalMember(owner = "client!pm", name = "c", descriptor = "()V", line = 189)
    public final void method2491() {
        this.field5925 = null;
    }

    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIII)Z", line = 198)
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(Lza;Lpm;)V", line = 256)
    ...
    @OriginalMember(owner = "client!pm", name = "c", descriptor = "(Lza;Lpm;)V", line = 358)
    ...
    @OriginalMember(owner = "client!pm", name = "d", descriptor = "(Lza;Lpm;)Z", line = 443)
    ...
    @OriginalMember(owner = "client!pm", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 476)
