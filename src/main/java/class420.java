...
public class class420 extends class319 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(FFFFFFLus;II)V")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IILus;II)V")
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(Lnm;IIII)V")
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(Lnm;II[III)V")
