...
public class class420 extends class66 {
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Lji;I)V")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(I)Ldh;")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Lrb;IZ)V")
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(Lji;)V")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ZLdh;)V")
