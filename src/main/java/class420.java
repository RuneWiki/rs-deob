...
public class class420 {
    ...
    @OriginalMember(owner = "client!ep", name = "listmodes", descriptor = "()[I", line = 9)
    ...
    @OriginalMember(owner = "client!ep", name = "exit", descriptor = "()V", line = 34)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ILjava/awt/Frame;)V", line = 53)
    ...
    @OriginalMember(owner = "client!ep", name = "enter", descriptor = "(Ljava/awt/Frame;IIII)V", line = 98)
    ...
    @OriginalMember(owner = "client!ep", name = "<init>", descriptor = "()V", line = 158)
