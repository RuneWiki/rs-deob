...
public class class420 extends class40 {
    ...
    @OriginalMember(owner = "client!no", name = "b", descriptor = "(II)I", line = 3)
    public static final int method2642(int arg0, int arg1) {
        return class25.field314 != null ? class25.field314[arg0][arg1] & 16777215 : 0;
    }

    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "()V", line = 9)
    public class420() {
        super(3, false);
    }

    @OriginalMember(owner = "client!no", name = "a", descriptor = "(BI)[I", line = 13)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lvq;Z)V", line = 69)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(II)[[I", line = 237)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IILlf;)V", line = 316)
