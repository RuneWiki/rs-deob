...
public class class420 extends class226 implements class171 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Luo;IIZ)Z")
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Luo;ZIB)Lcb;")
    ...
    @OriginalMember(owner = "client!on", name = "b", descriptor = "(Luo;B)V")
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Luo;IIIZBLpc;)V")
    ...
    @OriginalMember(owner = "client!on", name = "c", descriptor = "(Luo;B)Lkj;")
    ...
    @OriginalMember(owner = "client!on", name = "<init>", descriptor = "(Luo;Lnd;IIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Luo;II)Lge;")
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(BLuo;)V")
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Luo;BI)Lge;")
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Luo;B)V")
