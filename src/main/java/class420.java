...
public class class420 {
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IIBIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IBIZI)V", line = 78)
