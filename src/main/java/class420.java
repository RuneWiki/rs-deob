...
public class class420 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(I)Lio;", line = 4)
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(I)Lio;", line = 78)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(BLgk;)Lie;", line = 146)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "([BB)Ltq;", line = 157)
    ...
    @OriginalMember(owner = "client!bh", name = "c", descriptor = "(I)Z", line = 241)
    ...
    @OriginalMember(owner = "client!bh", name = "d", descriptor = "(I)Z", line = 278)
    ...
    @OriginalMember(owner = "client!bh", name = "e", descriptor = "(I)V", line = 309)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IILgk;)V", line = 319)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Lgk;B)V", line = 401)
