...
public class class420 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lbt;II)Ltb;", line = 6)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "()I", line = 18)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "()[B", line = 62)
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "(Les;)V", line = 124)
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "()V", line = 144)
    private class420() {
    }

    @OriginalMember(owner = "client!tb", name = "c", descriptor = "()Laia;", line = 148)
