...
public class class420 {
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(ILjava/lang/Object;Lhg;)V")
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(Lvs;Z)V")
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(IIIZI)Lvf;")
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(ILhg;BLjava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(ILhi;)I")
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(BLhg;)V")
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(Lhg;I)Ljava/lang/Object;")
