...
public class class420 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(BLjagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V")
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V")
