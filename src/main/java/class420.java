...
public class class420 {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!ga", name = "b", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!ga", name = "c", descriptor = "(I)I", line = 51)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(B)Ldn;", line = 70)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Ldn;B)V", line = 91)
    ...
    @OriginalMember(owner = "client!ga", name = "d", descriptor = "(I)Ldn;", line = 113)
    ...
    @OriginalMember(owner = "client!ga", name = "b", descriptor = "(B)Ldn;", line = 132)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Z)Ldn;", line = 153)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Ldn;Z)V", line = 174)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Lga;Z)V", line = 192)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(BI)Z", line = 204)
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "()V", line = 282)
    public class420() {
        this.field5911.field7583 = this.field5911;
        this.field5911.field7578 = this.field5911;
    }

    @OriginalMember(owner = "client!ga", name = "c", descriptor = "(B)Z", line = 268)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(ILga;Ldn;)V", line = 291)
    ...
    @OriginalMember(owner = "client!ga", name = "e", descriptor = "(I)Ldn;", line = 323)
