...
public abstract class class420 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IC)B", line = 5)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(III)V", line = 150)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(ZLct;)V", line = 286)
