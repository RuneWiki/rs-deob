...
public class class420 extends class354 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IIIIIIB)I", line = 9)
    ...
    @OriginalMember(owner = "client!id", name = "h", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!id", name = "g", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(Z)V", line = 68)
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(B)Z", line = 79)
    ...
    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "()V", line = 104)
    public class420() {
        super(0, true);
    }

    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lnj;II)V", line = 107)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IZ)V", line = 169)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lwj;B)V", line = 245)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(I[[[BIIILqa;IIIIIII)V", line = 274)
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(IIIII)V", line = 309)
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(BI)[I", line = 329)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IIZ)V", line = 469)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IILuu;)Lgg;", line = 495)
