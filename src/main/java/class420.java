...
public abstract class class420 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(III)I", line = 6)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IIIZI)V", line = 55)
