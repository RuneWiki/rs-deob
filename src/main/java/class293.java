...
public class class293 {
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(I)Lme;")
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(BLef;)V")
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(B)Lme;")
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IZLiu;BLiu;)I")
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Lef;)V")
