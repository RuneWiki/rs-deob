...
public class class293 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "([BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IIIIIBI)V", line = 39)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(I)V", line = 58)
