...
public class class293 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!qe", name = "b", descriptor = "(B)Lag;", line = 63)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Ltq;IZ)Lnp;", line = 98)
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(Lsq;)V", line = 135)
    public class293(class454 arg0) {
        this.field4013 = arg0;
    }

    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(I)Lag;", line = 144)
