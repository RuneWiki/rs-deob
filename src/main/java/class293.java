...
public class class293 {
    ...
    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(I)Lqm;")
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(BLgw;)V")
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Lgw;BI)V")
