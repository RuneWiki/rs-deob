...
public class class293 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Lii;IIII[S[B)V", line = 3)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "([B[B[SII)V", line = 62)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Llm;)V", line = 205)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Lii;II)V", line = 226)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "()V", line = 404)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(I)V", line = 416)
    public static final void method1989(int arg0) {
        field4174 = (class252) field4173.method384((long) arg0, true);
    }

    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Lfh;II)V", line = 421)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "()V", line = 432)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Lii;Lni;IIII)V", line = 454)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Lii;IIII)V", line = 461)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Lii;IIIIIII[S[BZ)V", line = 803)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Lii;)V", line = 966)
    ...
    @OriginalMember(owner = "client!kf", name = "c", descriptor = "()V", line = 976)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Lfh;III)I", line = 989)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(Lii;)Lar;", line = 1046)
    ...
    @OriginalMember(owner = "client!kf", name = "d", descriptor = "()V", line = 1057)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(II)Lln;", line = 1080)
    ...
    @OriginalMember(owner = "client!kf", name = "e", descriptor = "()V", line = 1094)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Lii;Lnj;IIII[I[I)V", line = 1251)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(II)Lql;", line = 1386)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(Lii;IIII)Lar;", line = 1403)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(IIIIIIII)V", line = 1414)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(I)Lln;", line = 1424)
