...
public class class293 extends class578 {
    ...
    @OriginalMember(owner = "client!vca", name = "i", descriptor = "(I)Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(IIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(IF)V", line = 43)
    ...
    @OriginalMember(owner = "client!vca", name = "<init>", descriptor = "(IIIIIF)V", line = 53)
    public class293(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!vca", name = "j", descriptor = "(I)V", line = 61)
