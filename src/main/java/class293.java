...
public class class293 extends class488 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "([B[IIIIIIIIIIILea;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!q", name = "B", descriptor = "(CIIIZ)V", line = 101)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "([B[IIIIIIII)V", line = 165)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(CIIIZLea;II)V", line = 200)
    ...
    @OriginalMember(owner = "client!q", name = "b", descriptor = "([B[IIIIIIIIIIILea;II)V", line = 269)
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "(Lin;Lds;[Ldt;[I[I)V", line = 354)
    ...
    @OriginalMember(owner = "client!q", name = "b", descriptor = "([B[IIIIIIII)V", line = 376)
