...
public class class293 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(Lic;Lm;I)V")
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(B)Lkp;")
    ...
    @OriginalMember(owner = "client!q", name = "b", descriptor = "(B)Lkp;")
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "(Lwa;)V")
