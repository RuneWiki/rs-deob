...
public abstract class class293 implements class268 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Ljaggl/opengl;IIIIII[I)V")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Ljaggl/opengl;IIIII[B)V")
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(Lsq;IIIZ)V")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Ljaggl/opengl;IIIII[F)V")
