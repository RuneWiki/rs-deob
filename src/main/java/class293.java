...
public class class293 extends class512 {
    ...
    @OriginalMember(owner = "client!nm", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(I[[I)V", line = 36)
    ...
    @OriginalMember(owner = "client!nm", name = "b", descriptor = "(II)[[I", line = 85)
    ...
    @OriginalMember(owner = "client!nm", name = "c", descriptor = "(B)V", line = 146)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(ZILia;)V", line = 157)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IB)[I", line = 232)
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "()V", line = 258)
    public class293() {
        super(0, true);
    }
}
