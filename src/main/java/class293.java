...
public class class293 {
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(ILsl;Lhr;)Lbia;", line = 6)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(Z)V", line = 51)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(Lsl;B)V", line = 62)
