...
public class class293 {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(CBLjava/lang/String;)[Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(JI)Lvba;", line = 61)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Z)V", line = 89)
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(Z)Lvba;", line = 105)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IBI)Z", line = 146)
    ...
    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "(I)V", line = 157)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(BLvba;J)V", line = 185)
