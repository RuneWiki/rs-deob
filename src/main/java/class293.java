...
public class class293 implements Runnable {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILjava/lang/String;)Lcq;", line = 8)
    public final class324 method1844(int arg0, String arg1) {
        int var3 = 1 / ((-arg0 - 28) / 61);
        return this.method1867(0, 0, 21, 44, arg1);
    }

    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;ZI)Ljava/io/File;", line = 17)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Ljava/awt/Frame;I)Lcq;", line = 106)
    public final class324 method1846(Frame arg0, int arg1) {
        return arg1 == 7 ? this.method1867(0, 0, 7, 74, arg0) : null;
    }

    @OriginalMember(owner = "client!li", name = "a", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IIIII)Lcq;", line = 170)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IILjava/lang/Object;II)Lcq;", line = 181)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Class;)Lcq;", line = 219)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(I)Lcq;", line = 231)
    public final class324 method1851(int arg0) {
        return arg0 > -1 ? null : this.method1867(0, 0, 18, 53, null);
    }

    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILjava/lang/String;B)Lcq;", line = 241)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IB)Lcq;", line = 256)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILjava/net/URL;)Lcq;", line = 267)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Z)Z", line = 277)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(ILjava/lang/String;)Lcq;", line = 299)
    ...
    @OriginalMember(owner = "client!li", name = "c", descriptor = "(I)V", line = 309)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILjava/lang/Class;)V", line = 319)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IZLjava/lang/Runnable;)Lcq;", line = 354)
    public final class324 method1859(int arg0, boolean arg1, Runnable arg2) {
        return arg1 ? this.method1867(0, arg0, 2, -125, arg2) : null;
    }

    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;I)V", line = 682)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ZLjava/awt/datatransfer/Transferable;)Lcq;", line = 367)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ZILjava/awt/Component;)Lcq;", line = 377)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ZLjava/lang/String;)Lcq;", line = 387)
    public final class324 method1862(boolean arg0, String arg1) {
        return arg0 ? null : this.method1867(0, 0, 16, -109, arg1);
    }

    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IBILjava/awt/Component;)Lcq;", line = 397)
    ...
    @OriginalMember(owner = "client!li", name = "d", descriptor = "(I)Lol;", line = 412)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ZLjava/lang/Class;)Lcq;", line = 422)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IIB[ILjava/awt/Point;Ljava/awt/Component;)Lcq;", line = 435)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IIIILjava/lang/Object;)Lcq;", line = 451)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILjava/lang/Class;[Ljava/lang/Class;Ljava/lang/String;)Lcq;", line = 485)
    ...
    @OriginalMember(owner = "client!li", name = "run", descriptor = "()V", line = 499)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Ljava/lang/String;B)[B", line = 624)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Ljava/lang/Class;B)Lcq;", line = 637)
    public final class324 method1870(Class arg0, byte arg1) {
        return arg1 == -18 ? this.method1867(0, 0, 20, -121, arg0) : null;
    }

    @OriginalMember(owner = "client!li", name = "e", descriptor = "(I)Lcq;", line = 654)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(ZLjava/lang/String;)Ljava/io/File;", line = 664)
