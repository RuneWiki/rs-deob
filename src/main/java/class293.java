...
public class class293 extends class596 implements class550 {
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!tr", name = "<init>", descriptor = "(Llt;Lkca;III[B)V")
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Lqt;I)V")
