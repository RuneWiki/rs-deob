...
public class class293 extends class340 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(II)V", line = 9)
    ...
    @OriginalMember(owner = "client!sb", name = "f", descriptor = "(I)F", line = 38)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!sb", name = "g", descriptor = "(I)Z", line = 67)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;Z)V", line = 79)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 157)
    public class293(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(BC)Z", line = 170)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Z)J", line = 255)
    ...
    @OriginalMember(owner = "client!sb", name = "e", descriptor = "(I)V", line = 266)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lha;I)Lufa;", line = 297)
    ...
    @OriginalMember(owner = "client!sb", name = "h", descriptor = "(I)D", line = 320)
