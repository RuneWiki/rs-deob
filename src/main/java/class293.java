...
public class class293 extends class83 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(DI)V")
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(IBLtq;)V")
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(BI)I")
