...
public abstract class class293 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(BZLjava/lang/String;)V", line = 4)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(III)I", line = 83)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(IIZ)V", line = 96)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(BII)I", line = 124)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(II[S)[S", line = 163)
