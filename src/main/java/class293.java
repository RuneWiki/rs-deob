...
public class class293 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(ZILkda;)V")
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(II)Lia;")
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Lsj;ILin;Lin;)V")
