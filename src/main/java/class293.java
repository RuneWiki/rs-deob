...
public class class293 {
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Lob;BJ)V", line = 20)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(B)V", line = 72)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(JZ)V", line = 121)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(BJ)Lob;", line = 140)
    ...
    @OriginalMember(owner = "client!qi", name = "<init>", descriptor = "(I)V", line = 180)
