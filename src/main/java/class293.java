...
public class class293 extends class194 implements class254 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lpe;)V")
    ...
    @OriginalMember(owner = "client!ko", name = "c", descriptor = "(Lpe;)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILpe;)V")
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(Lpe;)V")
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(Lpo;I[BI)V")
    public class293(class332 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field4211 = arg1;
    }

    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(Lpo;ILjava/nio/ByteBuffer;)V")
