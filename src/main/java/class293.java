...
public class class293 {
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(II)V", line = 16)
    ...
    @OriginalMember(owner = "client!vv", name = "b", descriptor = "(II)Lgf;", line = 45)
    ...
    @OriginalMember(owner = "client!vv", name = "b", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!vv", name = "c", descriptor = "(I)J", line = 94)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(III)I", line = 105)
    ...
    @OriginalMember(owner = "client!vv", name = "<init>", descriptor = "(Ljda;ILjo;)V", line = 126)
