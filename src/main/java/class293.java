...
public class class293 {
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Ljr;B)V")
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Lw;III[Z)V")
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(ILjr;I)V")
