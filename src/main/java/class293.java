...
public class class293 {
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(BLcf;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IIILng;IB)Ldd;")
    ...
    @OriginalMember(owner = "client!sj", name = "b", descriptor = "(II)Lwa;")
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(ILwm;)V")
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "(Ldn;ILr;)V")
