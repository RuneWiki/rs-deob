...
public class class293 extends class263 {
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lts;I)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(B)Z", line = 21)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(B)V", line = 92)
