...
public class class293 extends class179 {
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(II)Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!kf", name = "c", descriptor = "(II)Z", line = 18)
    ...
    @OriginalMember(owner = "client!kf", name = "e", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!kf", name = "d", descriptor = "(II)Z", line = 49)
    ...
    @OriginalMember(owner = "client!kf", name = "f", descriptor = "(B)Z", line = 61)
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "(I)V", line = 166)
