...
public class class293 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(IZII)V", line = 22)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(BI)V", line = 35)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(IZ)Lcd;", line = 86)
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(IZ)V", line = 131)
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(II)V", line = 169)
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(ZI)V", line = 189)
    ...
    @OriginalMember(owner = "client!mf", name = "c", descriptor = "(I)V", line = 220)
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Liv;IZLuu;Luu;)V", line = 263)
