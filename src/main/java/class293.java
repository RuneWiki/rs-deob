...
public class class293 extends class695 {
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(Lbi;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(Lbi;IIIII)V")
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(Lbi;IIII)V")
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(Lbi;IIIIZ[IIIZ)V")
    ...
    @OriginalMember(owner = "client!bq", name = "h", descriptor = "(I)Llk;")
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(Lbi;IIIIZ[BIZ)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
