...
public class class293 {
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(I[Ljava/lang/String;Z[SI)V", line = 8)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(BI)I", line = 64)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(II)Ljava/lang/String;", line = 78)
