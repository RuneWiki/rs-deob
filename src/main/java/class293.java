...
public class class293 extends class98 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILdg;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(II)[I", line = 54)
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "()V", line = 138)
    public class293() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ko", name = "e", descriptor = "(I)V", line = 160)
    ...
    @OriginalMember(owner = "client!ko", name = "f", descriptor = "(I)V", line = 174)
