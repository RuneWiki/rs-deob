...
public class class293 extends class451 implements class559 {
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(ZILmb;Lha;III)V")
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(IIBLha;)Z")
    ...
    @OriginalMember(owner = "client!wia", name = "j", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(ZLha;)V")
    ...
    @OriginalMember(owner = "client!wia", name = "b", descriptor = "(Lha;B)Lufa;")
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(IILha;Z)Lsca;")
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(II)Ljea;")
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(Lha;BI)Lka;")
    ...
    @OriginalMember(owner = "client!wia", name = "<init>", descriptor = "(Lha;Lqg;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(Lha;I)Lie;")
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(Lrq;Z)V")
