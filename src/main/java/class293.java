...
public abstract class class293 extends class544 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(III)Z", line = 8)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(B)V", line = 126)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ILdia;ILjava/lang/String;)Lkd;", line = 141)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Lwc;I)V", line = 182)
