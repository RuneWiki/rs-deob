...
public class class293 {
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(IZ)I", line = 4)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "([I)V", line = 67)
    ...
    @OriginalMember(owner = "client!ab", name = "b", descriptor = "(I)V", line = 108)
