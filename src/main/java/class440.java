...
public class class440 extends class34 implements class193 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IILuo;I)Z")
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Luo;I)V")
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(Luo;Lgm;IIIIIIIZI)V")
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(ZLuo;)Laj;")
    ...
    @OriginalMember(owner = "client!ob", name = "b", descriptor = "(Luo;I)V")
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(ILuo;I)Lmj;")
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IBIILrr;Luo;Z)V")
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(BI)Ltq;")
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(ILuo;)V")
