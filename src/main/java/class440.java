...
public abstract class class440 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IB)I", line = 3)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(I)Ljava/net/Socket;", line = 16)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(CII)C", line = 29)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IIBLcm;)V", line = 116)
