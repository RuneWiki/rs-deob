...
public class class440 extends class168 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Leca;")
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Llp;IIIII)V")
