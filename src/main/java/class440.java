...
public class class440 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Z)Lnk;", line = 3)
    ...
    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(Z)Lnk;", line = 26)
    ...
    @OriginalMember(owner = "client!tl", name = "c", descriptor = "(Z)V", line = 73)
    ...
    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(I)I", line = 86)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ZLnk;)V", line = 106)
    ...
    @OriginalMember(owner = "client!tl", name = "<init>", descriptor = "()V", line = 142)
    public class440() {
