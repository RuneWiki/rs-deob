...
public class class440 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lpl;B)V", line = 33)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ILr;Lae;II)V", line = 52)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(II)V", line = 88)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IIIIB)V", line = 154)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IZI)Z", line = 170)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ILes;I)V", line = 181)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(B)V", line = 234)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IZIIIII)V", line = 257)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IILr;IIIB)Lda;", line = 382)
    ...
    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(II)Z", line = 429)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Z)V", line = 457)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(I)V", line = 480)
    ...
    @OriginalMember(owner = "client!ss", name = "c", descriptor = "(II)I", line = 502)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Les;B)V", line = 528)
    ...
    @OriginalMember(owner = "client!ss", name = "d", descriptor = "(II)Ljava/lang/String;", line = 549)
    ...
    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(I)V", line = 573)
