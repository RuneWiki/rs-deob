...
public class class440 extends class450 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(I)Lup;", line = 14)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 63)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(ILup;)V", line = 125)
    public class440(int arg0, class278 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Z)I", line = 128)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(Z)I", line = 141)
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Lup;)V", line = 153)
    public class440(class278 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ZI)V", line = 162)
