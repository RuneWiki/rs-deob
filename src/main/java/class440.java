...
public class class440 extends class189 {
    ...
    @OriginalMember(owner = "client!kn", name = "e", descriptor = "(I)Ljava/lang/Object;", line = 6)
    public final Object method1242(int arg0) {
        int var2 = -83 / ((arg0 + 65) / 36);
        return this.field6377.get();
    }

    @OriginalMember(owner = "client!kn", name = "d", descriptor = "(I)Z", line = 14)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(Ljava/lang/Object;)V", line = 23)
