...
public class class440 extends class523 {
    ...
    @OriginalMember(owner = "client!aga", name = "g", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(ILba;III)Lvg;", line = 20)
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(IIIB)[B", line = 37)
    ...
    @OriginalMember(owner = "client!aga", name = "b", descriptor = "(BII)V", line = 50)
    ...
    @OriginalMember(owner = "client!aga", name = "<init>", descriptor = "()V", line = 65)
    public class440() {
