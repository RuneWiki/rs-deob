...
public class class440 extends class617 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Z)Lvn;", line = 52)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IIZII)V", line = 70)
    ...
    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 252)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(III[II)Z", line = 87)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(III)Z", line = 113)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(II[II)Z", line = 157)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(I[IIB)Z", line = 186)
