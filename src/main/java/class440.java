...
public class class440 extends class42 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(BIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "([IIII)V", line = 108)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(BII)Z", line = 122)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IIII)Z", line = 140)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "([IBII)V", line = 159)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IIZ)Z", line = 175)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(I)V", line = 192)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IB)Ljava/lang/String;", line = 203)
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(IIIIIIIII)V", line = 237)
