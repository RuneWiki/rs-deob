...
public class class440 extends class12 {
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(I)Leq;")
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(III)Lhh;")
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "(ILur;Lur;Liv;Lcd;IIZ)V")
