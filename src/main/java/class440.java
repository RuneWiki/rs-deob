...
public class class440 extends class526 implements class706 {
    ...
    @OriginalMember(owner = "client!ti", name = "e", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(ZLha;IILkba;II)V", line = 19)
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(Lha;Lhba;IIIIIZII)V", line = 32)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(ILha;)V", line = 45)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Z)Z", line = 60)
    ...
    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(BLha;)Lml;", line = 71)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(B)Z", line = 125)
    ...
    @OriginalMember(owner = "client!ti", name = "i", descriptor = "(I)I", line = 137)
    ...
    @OriginalMember(owner = "client!ti", name = "g", descriptor = "(B)I", line = 150)
    ...
    @OriginalMember(owner = "client!ti", name = "d", descriptor = "(B)V", line = 161)
    ...
    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(B)I", line = 171)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(BLha;)V", line = 184)
    ...
    @OriginalMember(owner = "client!ti", name = "c", descriptor = "(B)I", line = 207)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(I)I", line = 222)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Lha;I)V", line = 233)
    ...
    @OriginalMember(owner = "client!ti", name = "d", descriptor = "(I)Z", line = 284)
    ...
    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(ILha;)Lkj;", line = 295)
    public final class566 method744(int arg0, class58 arg1) {
        ++field6282;
        return arg0 != 0 ? null : this.field6268;
    }

    @OriginalMember(owner = "client!ti", name = "l", descriptor = "(I)V", line = 307)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Lha;III)Z", line = 320)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Lha;B)V", line = 340)
    ...
    @OriginalMember(owner = "client!ti", name = "k", descriptor = "(I)V", line = 369)
