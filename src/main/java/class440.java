...
public class class440 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Lvp;ILpa;ILha;III)V", line = 46)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(B)[Lj;", line = 99)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(III)Lsm;", line = 123)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Ljava/awt/Canvas;B)Lie;", line = 131)
