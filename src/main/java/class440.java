...
public class class440 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(IBIIII[II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(B)V", line = 106)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Z)V", line = 117)
    public static final void method2652(boolean arg0) {
        class593.field8116 = arg0;
        field6264++;
    }

    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Ljda;I)V", line = 125)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(B)V", line = 195)
    ...
    @OriginalMember(owner = "client!ks", name = "<init>", descriptor = "(Z)V", line = 224)
