...
public class class440 {
    ...
    @OriginalMember(owner = "client!ep", name = "toString", descriptor = "()Ljava/lang/String;", line = 10)
    public final String toString() {
        field6292++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(JII)Ljava/lang/String;", line = 21)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ILvm;I)V", line = 43)
    ...
    @OriginalMember(owner = "client!ep", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 86)
    public class440(String arg0, int arg1) {
        this.field6293 = arg1;
    }

    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(B)I", line = 96)
