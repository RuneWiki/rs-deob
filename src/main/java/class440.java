...
public class class440 extends class40 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IILlf;)V")
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Lsf;)V")
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Lkn;IIZLvq;)V")
    ...
    @OriginalMember(owner = "client!ob", name = "d", descriptor = "(I)Lao;")
