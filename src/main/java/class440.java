...
public class class440 extends class29 {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(BJ)I", line = 7)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(B)J", line = 39)
    ...
    @OriginalMember(owner = "client!qq", name = "c", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(I)J", line = 86)
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(B)J", line = 119)
