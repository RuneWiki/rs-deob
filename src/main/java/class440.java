...
public class class440 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Lqa;Loo;)V")
    ...
    @OriginalMember(owner = "client!oo", name = "b", descriptor = "(Lqa;Loo;)Z")
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Lqa;)V")
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Lqa;IIIIII)V")
    ...
    @OriginalMember(owner = "client!oo", name = "b", descriptor = "(Lqa;)V")
    ...
    @OriginalMember(owner = "client!oo", name = "c", descriptor = "(Lqa;Loo;)V")
    ...
    @OriginalMember(owner = "client!oo", name = "d", descriptor = "(Lqa;Loo;)Z")
