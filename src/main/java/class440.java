...
public class class440 extends class42 {
    ...
    @OriginalMember(owner = "client!uw", name = "c", descriptor = "(I)Ldka;", line = 4)
    ...
    @OriginalMember(owner = "client!uw", name = "b", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IIBIIIIIII)V", line = 113)
    ...
    @OriginalMember(owner = "client!uw", name = "d", descriptor = "(I)V", line = 190)
    ...
    @OriginalMember(owner = "client!uw", name = "<init>", descriptor = "(Lvf;IIIIII)V", line = 209)
