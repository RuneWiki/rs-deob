...
public class class440 extends class390 implements class210 {
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(Lvc;Lnm;IIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lvc;I)Lep;")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ZLvc;)V")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ZILvc;IILuq;I)V")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lvc;B)V")
    ...
    @OriginalMember(owner = "client!bg", name = "b", descriptor = "(ZLvc;)V")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ZLvc;II)Lco;")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ILvc;II)Z")
    ...
    @OriginalMember(owner = "client!bg", name = "d", descriptor = "(I)Lct;")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(BILvc;)Ln;")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lvc;II)Ln;")
