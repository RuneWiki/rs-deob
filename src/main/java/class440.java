...
public class class440 extends class621 {
    ...
    @OriginalMember(owner = "client!maa", name = "<init>", descriptor = "(ILrt;Lcp;III)V", line = 5)
    public class440(int arg0, class212 arg1, class679 arg2, int arg3, int arg4, int arg5) {
        super(arg0, arg1, arg2, arg3, arg4);
        this.field6043 = arg5;
    }

    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(II)I", line = 16)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "([BIIIILjava/lang/String;)I", line = 29)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(B)Los;", line = 168)
