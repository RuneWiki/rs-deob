...
public class class440 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IIIILcf;)V", line = 7)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Z)V", line = 47)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IZ)V", line = 60)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(BI)Llu;", line = 76)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(ZI)V", line = 104)
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(Z)V", line = 115)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(ZIIIIII)V", line = 130)
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "(Lcm;ILlt;)V", line = 167)
