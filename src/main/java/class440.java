...
public class class440 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(II)Lfd;", line = 20)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IIB)V", line = 53)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(BI)S", line = 73)
    ...
    @OriginalMember(owner = "client!os", name = "b", descriptor = "(II)V", line = 104)
    ...
    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "(Lcw;ILeq;Leq;)V", line = 173)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(I)V", line = 138)
    ...
    @OriginalMember(owner = "client!os", name = "b", descriptor = "(Z)V", line = 154)
