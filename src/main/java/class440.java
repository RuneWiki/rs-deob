...
public class class440 extends class377 implements class238 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Lgt;I)V")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(IBILha;)Z")
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(ILha;)Lrk;")
    ...
    @OriginalMember(owner = "client!mf", name = "h", descriptor = "(I)Lhd;")
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lha;Ltba;IIIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ZLha;)Loba;")
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(Lha;I)V")
