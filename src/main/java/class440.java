...
public class class440 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(II)Ltga;", line = 5)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(Lvd;ILpe;)V", line = 83)
    public class440(class635 arg0, int arg1, class615 arg2) {
        this.field5676 = arg2;
        this.field5676.method3341(30, -19046);
    }

    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(II)V", line = 72)
    ...
    @OriginalMember(owner = "client!qp", name = "c", descriptor = "(I)V", line = 112)
