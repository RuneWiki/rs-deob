...
public class class440 extends class644 implements class612 {
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IIILjaclib/memory/Source;)Z", line = 4)
    ...
    @OriginalMember(owner = "client!uw", name = "b", descriptor = "(I)Z", line = 19)
    ...
    @OriginalMember(owner = "client!uw", name = "c", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(III)Z", line = 144)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(II)I", line = 165)
    public static int method2643(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!uw", name = "g", descriptor = "(I)I", line = 172)
    public final int method2644(int arg0) {
        ++field6191;
        return arg0 > -19 ? 112 : this.field6180;
    }

    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/String;)V", line = 185)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;", line = 198)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(Ljava/lang/String;ZLjava/lang/String;C)Ljava/lang/String;", line = 211)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IZ)Lnd;", line = 266)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(I)V", line = 294)
    public final void method2614(int arg0) {
        super.method2614(arg0);
        ++field6177;
    }

    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(B)I", line = 307)
    public final int method2631(byte arg0) {
        ++field6190;
        return arg0 < 81 ? -90 : super.method2631((byte) 100);
    }

    @OriginalMember(owner = "client!uw", name = "b", descriptor = "(IB)V", line = 321)
    ...
    @OriginalMember(owner = "client!uw", name = "<init>", descriptor = "(Lpa;Z)V", line = 373)
