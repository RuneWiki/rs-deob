...
public class class440 {
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "([ILgj;BLgj;)V", line = 79)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(Z)V", line = 105)
    ...
    @OriginalMember(owner = "client!uw", name = "b", descriptor = "(I)Z", line = 115)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(II)V", line = 130)
    ...
    @OriginalMember(owner = "client!uw", name = "<init>", descriptor = "(Lsf;)V", line = 191)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IB)V", line = 152)
