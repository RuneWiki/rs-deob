...
public class class440 {
    ...
    @OriginalMember(owner = "client!mja", name = "a", descriptor = "(Luq;Lbr;Ltga;Luq;BLuq;)Z", line = 4)
    ...
    @OriginalMember(owner = "client!mja", name = "finalize", descriptor = "()V", line = 33)
    ...
    @OriginalMember(owner = "client!mja", name = "<init>", descriptor = "(Llf;JI)V", line = 47)
