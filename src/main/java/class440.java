...
public class class440 {
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "([BBZ)Ljava/lang/Object;", line = 8)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(Lio;B)V", line = 43)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(BI)I", line = 79)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 105)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(II)Z", line = 134)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(B)V", line = 157)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(Lio;II)V", line = 181)
    ...
    @OriginalMember(owner = "client!hba", name = "b", descriptor = "(I)V", line = 235)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(IIIIII)V", line = 248)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(IB)V", line = 272)
    ...
    @OriginalMember(owner = "client!hba", name = "b", descriptor = "(BI)Ljava/lang/String;", line = 283)
    ...
    @OriginalMember(owner = "client!hba", name = "c", descriptor = "(I)V", line = 304)
