...
public abstract class class440 {
    ...
    @OriginalMember(owner = "client!mja", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!mja", name = "a", descriptor = "(Lss;IZZ)V", line = 19)
    ...
    @OriginalMember(owner = "client!mja", name = "a", descriptor = "(II)I", line = 92)
