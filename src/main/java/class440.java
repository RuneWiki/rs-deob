...
public class class440 extends class136 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(II)[I", line = 6)
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "()V", line = 70)
    public class440() {
        super(0, true);
    }

    @OriginalMember(owner = "client!oo", name = "f", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IILiv;)V", line = 88)
