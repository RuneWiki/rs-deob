...
public class class440 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(Lsj;B)Ljava/lang/String;", line = 17)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(Ljb;IBLjb;)Lfa;", line = 34)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(B)Z", line = 47)
    ...
    @OriginalMember(owner = "client!nc", name = "b", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(Ljb;BZLjb;I)Lfa;", line = 122)
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Lph;Lau;)V", line = 163)
