...
public abstract class class440 extends class410 {
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(I[Lpk;)I")
    ...
    @OriginalMember(owner = "client!maa", name = "b", descriptor = "(ILha;)Z")
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(ZILmb;Lha;III)V")
