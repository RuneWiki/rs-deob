...
public class class440 extends class524 implements class691 {
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(Lr;B)Llt;")
    ...
    @OriginalMember(owner = "client!oga", name = "<init>", descriptor = "(Lr;Lfga;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!oga", name = "b", descriptor = "(BLr;)Lsr;")
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(BLr;)V")
    ...
    @OriginalMember(owner = "client!oga", name = "k", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(IIZLr;ILub;I)V")
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(Lr;III)Z")
    ...
    @OriginalMember(owner = "client!oga", name = "b", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(Lr;Z)V")
