...
public abstract class class440 implements class463 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(ZIII[ILqg;)Lls;")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IBILtn;)V")
    ...
    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "(Lqg;IIIZ)V")
