...
public class class440 extends class83 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IBLtq;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ee", name = "c", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IZLam;ZIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ZI)[[I", line = 47)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Z[B)[B", line = 94)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lfd;III)V", line = 112)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IB)Z", line = 449)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(II)[I", line = 465)
    ...
    @OriginalMember(owner = "client!ee", name = "d", descriptor = "(II)Lhi;", line = 499)
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "()V", line = 522)
    public class440() {
        super(1, false);
    }
}
