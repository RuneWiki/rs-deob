...
public class class440 extends class512 {
    ...
    @OriginalMember(owner = "client!oh", name = "b", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "()V", line = 16)
    public class440() {
        super(1, true);
    }

    @OriginalMember(owner = "client!oh", name = "c", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(ZILia;)V", line = 34)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(IB)[I", line = 53)
