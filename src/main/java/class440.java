...
public class class440 extends class367 implements class278 {
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(IIILof;)V", line = 5)
    public class440(int arg0, int arg1, int arg2, class367 arg3) {
        super(arg0, arg1, arg2, false, false);
        this.field6032 = arg3;
    }

    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Lkm;I)V", line = 16)
    public final void method216(class487 arg0, int arg1) {
        field6025++;
        int var3 = -16 / ((arg1 + 12) / 60);
    }

    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ILkm;IZILkj;B)V", line = 26)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(III)Lba;", line = 42)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(I)I", line = 62)
    public final int method215(int arg0) {
        field6026++;
        return arg0 == -11524 ? 0 : 87;
    }

    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Lkm;BII)Z", line = 74)
    public final boolean method199(class487 arg0, byte arg1, int arg2, int arg3) {
        field6027++;
        return arg1 < 123 ? false : false;
    }

    @OriginalMember(owner = "client!sh", name = "e", descriptor = "(I)Z", line = 86)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Lkm;II)Lab;", line = 97)
    ...
    @OriginalMember(owner = "client!sh", name = "d", descriptor = "(Lkm;I)Lto;", line = 109)
    ...
    @OriginalMember(owner = "client!sh", name = "c", descriptor = "(Lkm;I)V", line = 120)
    public final void method197(class487 arg0, int arg1) {
        int var3 = 72 % ((64 - arg1) / 59);
        field6039++;
    }

    @OriginalMember(owner = "client!sh", name = "c", descriptor = "(I)I", line = 129)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(B)V", line = 143)
    ...
    @OriginalMember(owner = "client!sh", name = "c", descriptor = "(B)V", line = 153)
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(I)Z", line = 165)
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(Z)I", line = 179)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Z)V", line = 190)
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(Lkm;I)V", line = 204)
