...
public class class440 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(I)Lia;")
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Lsu;I)V")
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(I)Lia;")
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(Lsu;)V")
