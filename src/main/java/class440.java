...
public class class440 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(ILae;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IIII)I", line = 52)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lae;II)V", line = 76)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(ILwd;)Z", line = 99)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(I)V", line = 172)
