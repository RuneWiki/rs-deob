...
public class class440 extends class300 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lmo;)V", line = 3)
    public final void method9(class195 arg0) {
        this.field4409.method929(arg0);
    }

    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(Lge;Lmk;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "()V", line = 36)
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(Z)V", line = 42)
    public final void method7(boolean arg0) {
    }

    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Z)V", line = 95)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "()Z", line = 105)
