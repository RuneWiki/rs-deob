...
public class class440 {
    ...
    @OriginalMember(owner = "client!mja", name = "a", descriptor = "(Lqca;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!mja", name = "a", descriptor = "(Lmea;III)V", line = 24)
    ...
    @OriginalMember(owner = "client!mja", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!mja", name = "<init>", descriptor = "(Lqfa;)V", line = 532)
    ...
    @OriginalMember(owner = "client!mja", name = "a", descriptor = "(ILqca;)Z", line = 67)
    ...
    @OriginalMember(owner = "client!mja", name = "a", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!mja", name = "b", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!mja", name = "a", descriptor = "(IIIII)Z", line = 201)
    ...
    @OriginalMember(owner = "client!mja", name = "c", descriptor = "(I)Z", line = 245)
    ...
    @OriginalMember(owner = "client!mja", name = "d", descriptor = "(I)Z", line = 376)
    ...
    @OriginalMember(owner = "client!mja", name = "a", descriptor = "(Z)V", line = 387)
