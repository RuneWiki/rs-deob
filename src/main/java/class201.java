...
public class class201 {
    ...
    @OriginalMember(owner = "client!dl", name = "b", descriptor = "()Ldg;")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Lij;II)Ldl;")
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(Lrg;)V")
