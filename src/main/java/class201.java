...
public class class201 extends class499 {
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Ljava/lang/String;II)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(III)I", line = 25)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(ZI)Z", line = 64)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Lmd;I)V", line = 76)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(IIZIIIIII)Z", line = 119)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(BLmd;I)V", line = 138)
