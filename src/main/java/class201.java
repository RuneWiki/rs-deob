...
public class class201 extends class349 {
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(IILdga;)V", line = 11)
    ...
    @OriginalMember(owner = "client!gfa", name = "f", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!gfa", name = "g", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!gfa", name = "b", descriptor = "(BI)[I", line = 84)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(IB)[[I", line = 176)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(II)V", line = 308)
    ...
    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "()V", line = 335)
    public class201() {
        super(1, false);
    }
}
