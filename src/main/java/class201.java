...
public class class201 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Z)[[[I", line = 6)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IIIIIII)V", line = 45)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IIIIIZZ)V", line = 62)
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(III)V", line = 273)
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(B)V", line = 141)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(II)[[I", line = 166)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 242)
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(II)Z", line = 258)
