...
public class class201 extends class534 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(FFFFFFILua;II)V")
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IIZLtf;III)V")
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IILua;II)V")
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "(Lvj;IIZ)V")
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "(Lvj;IIII)V")
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "(Lvj;II[III)V")
