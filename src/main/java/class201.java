...
public class class201 extends class84 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(BII)Z", line = 9)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(III)Z", line = 35)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(BLha;I)Lpga;", line = 46)
