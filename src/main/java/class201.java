...
public class class201 {
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(IZLqa;IIZI)Lka;")
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Lka;IZIIILqa;B)V")
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Lqa;Lku;IIIIIIZI)V")
