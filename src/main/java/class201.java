...
public class class201 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IB)Lbb;")
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(BIZII[[[Lhg;)Z")
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(ILvc;)I")
