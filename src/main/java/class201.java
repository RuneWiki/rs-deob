...
public class class201 extends class371 {
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Lqa;[Lu;Z)V")
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Lqa;J[Lu;[Lat;Z)V")
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Lqa;J)Z")
    ...
    @OriginalMember(owner = "client!ce", name = "e", descriptor = "()Lpo;")
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "([Lat;Z)V")
