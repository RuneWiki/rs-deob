...
public class class201 {
    ...
    @OriginalMember(owner = "client!vh", name = "h", descriptor = "[[[Ltf;")
    ...
    @OriginalMember(owner = "client!vh", name = "f", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!vh", name = "g", descriptor = "Llf;")
    public static class109 field3964 = field3963;

    @OriginalMember(owner = "client!vh", name = "j", descriptor = "[I")
    public static int[] field3967 = new int[128];

    @OriginalMember(owner = "client!vh", name = "l", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!vh", name = "m", descriptor = "Lua;")
