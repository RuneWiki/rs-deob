...
public class class201 extends class279 {
    ...
    @OriginalMember(owner = "client!fq", name = "e", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(III)V", line = 33)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(BZ)V", line = 60)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ZI)V", line = 70)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(B)Z", line = 89)
    ...
    @OriginalMember(owner = "client!fq", name = "d", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Z)V", line = 116)
    ...
    @OriginalMember(owner = "client!fq", name = "c", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(IZLiu;)V", line = 149)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(I)V", line = 161)
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(Lhb;Lla;Lno;)V", line = 190)
    ...
    @OriginalMember(owner = "client!fq", name = "b", descriptor = "(Z)V", line = 207)
