...
public class class201 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(B)I", line = 8)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Lfv;Lza;I)I", line = 27)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(IIIII)V", line = 50)
    ...
    @OriginalMember(owner = "client!un", name = "b", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(Lwv;ILqs;)V", line = 100)
