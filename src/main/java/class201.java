...
public class class201 extends class627 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(I)I", line = 27)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(II)V", line = 90)
    public class201(int arg0, int arg1) {
        this.field2566 = arg0;
        this.field2568 = arg1;
    }

    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IZIIIZI)V", line = 100)
    ...
    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(IIIII)V", line = 148)
