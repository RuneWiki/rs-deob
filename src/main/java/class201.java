...
public class class201 {
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(BII)V", line = 4)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(IC)Z", line = 34)
