...
public class class201 extends class440 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IIIIIIIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!nt", name = "<init>", descriptor = "()V", line = 124)
    public class201() {
        super(1, false);
    }

    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(BI)[I", line = 46)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(ILmo;I)V", line = 79)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(II)[[I", line = 129)
    ...
    @OriginalMember(owner = "client!nt", name = "g", descriptor = "(I)V", line = 182)
