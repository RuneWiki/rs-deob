...
public class class201 implements Runnable {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IILes;)Ldm;")
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(IILes;)Ldm;")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(I[BLes;I)Ldm;")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(BLdm;)V")
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(Lpq;)V")
