...
public class class201 extends class67 {
    ...
    @OriginalMember(owner = "client!lf", name = "w", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(I)V", line = 48)
    public final void method461(int arg0) {
        ++field2969;
        super.field827[arg0].method204(false, (Runnable) null);
    }

    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(II[[I[[IIII)Lsa;", line = 56)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ln;)V", line = 65)
    public class201(Canvas arg0, class17 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Lfd;IIII)Lr;", line = 69)
    ...
    @OriginalMember(owner = "client!lf", name = "v", descriptor = "()V", line = 78)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IIIIIIIIII)V", line = 107)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "([Lr;Lrd;Lm;[Lpr;I)V", line = 148)
    ...
    @OriginalMember(owner = "client!lf", name = "o", descriptor = "(I)V", line = 173)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "([Lr;Lm;[Lpr;I)V", line = 185)
    ...
    @OriginalMember(owner = "client!lf", name = "d", descriptor = "(I)V", line = 201)
    public final void method459(int arg0) {
        super.field827[arg0].method204(false, Thread.currentThread());
        ++field2977;
    }

    @OriginalMember(owner = "client!lf", name = "h", descriptor = "(I)V", line = 215)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Ljava/lang/Runnable;)Lrk;", line = 233)
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 256)
    ...
    @OriginalMember(owner = "client!lf", name = "c", descriptor = "(Ljava/awt/Canvas;)V", line = 283)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IIIIIII)V", line = 335)
    ...
    @OriginalMember(owner = "client!lf", name = "B", descriptor = "()Z", line = 412)
