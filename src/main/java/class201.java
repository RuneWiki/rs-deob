...
public abstract class class201 extends class295 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IIIZZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!cu", name = "f", descriptor = "(B)Z", line = 18)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "([Ltw;I)I", line = 31)
    ...
    @OriginalMember(owner = "client!cu", name = "h", descriptor = "(I)Z", line = 114)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "(IIIIII)V", line = 130)
