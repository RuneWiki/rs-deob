...
public class class201 extends class260 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IB)I", line = 3)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IIIZ)I", line = 20)
    ...
    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "(ILfca;)V", line = 55)
    public class201(int arg0, class92 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(B)I", line = 59)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(I)I", line = 71)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(BI)V", line = 87)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(IB)V", line = 103)
    ...
    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "(Lfca;)V", line = 114)
    public class201(class92 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Z)V", line = 117)
    ...
    @OriginalMember(owner = "client!vp", name = "c", descriptor = "(I)Z", line = 134)
    ...
    @OriginalMember(owner = "client!vp", name = "d", descriptor = "(I)Z", line = 148)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(B)V", line = 174)
