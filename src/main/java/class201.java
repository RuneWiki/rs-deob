...
public class class201 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ZB)V", line = 3)
    public static final synchronized void method1797(boolean arg0, byte arg1) {
        int var2 = -24 / ((arg1 - 60) / 61);
        field3127 = arg0;
    }

    @OriginalMember(owner = "client!op", name = "a", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Z)V", line = 40)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(BLe;)V", line = 60)
