...
public class class201 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(III)V", line = 26)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ILha;)V", line = 44)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(II)V", line = 152)
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(J[I[S[S)V", line = 177)
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "()V", line = 187)
    protected class201() {
    }
}
