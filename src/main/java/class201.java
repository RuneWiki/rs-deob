...
public class class201 extends class698 {
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(IIZZZ)I", line = 5)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(III)V", line = 75)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(IIB)V", line = 85)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(ZII)V", line = 96)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(IIIIIIII)V", line = 116)
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(IIIIII)V", line = 286)
