...
public abstract class class201 implements class758 {
    ...
    @OriginalMember(owner = "client!fq", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!fq", name = "b", descriptor = "(B)Z", line = 52)
    ...
    @OriginalMember(owner = "client!fq", name = "c", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ZI)V", line = 99)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(B)Z", line = 134)
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(Loh;Loh;Llaa;)V", line = 154)
