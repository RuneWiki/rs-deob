...
public class class201 extends class391 {
    ...
    @OriginalMember(owner = "client!re", name = "c", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(B)I", line = 25)
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(III)V", line = 40)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(III)V", line = 60)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(II)V", line = 78)
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "(IIIIIII)V", line = 94)
