...
public class class201 extends class24 implements class350 {
    ...
    @OriginalMember(owner = "client!ca", name = "finalize", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Lw;Lg;[IIIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(FFFFFFLta;II)V", line = 30)
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Lw;Lg;IIII)V", line = 32)
    ...
    @OriginalMember(owner = "client!ca", name = "oa", descriptor = "(III)V", line = 39)
