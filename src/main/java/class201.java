...
public abstract class class201 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "()V", line = 4)
    public static final void method1413() {
        class28.method229(1, class169.field2565);
    }

    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(JZ)I", line = 15)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "([I[FIIIIIIII[FI[I)V", line = 33)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(II)I", line = 115)
