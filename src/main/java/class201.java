...
public class class201 extends class187 {
    ...
    @OriginalMember(owner = "client!hk", name = "f", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(CI)I", line = 18)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(CB)I", line = 43)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ILtq;)V", line = 70)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IILtq;)V", line = 95)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(BLjava/lang/String;)V", line = 155)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IBIIIIII)V", line = 209)
    ...
    @OriginalMember(owner = "client!hk", name = "b", descriptor = "(B)V", line = 416)
    ...
    @OriginalMember(owner = "client!hk", name = "g", descriptor = "(I)V", line = 426)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ZIIIII)V", line = 463)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IIIB)I", line = 654)
