...
public class class201 implements class244 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(III)Lne;")
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(Lne;I)V")
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(BLjg;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(Ln;I)V")
