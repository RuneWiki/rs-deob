...
public class class201 implements Runnable {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(B)I", line = 19)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!cu", name = "c", descriptor = "(I)Lsj;", line = 71)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(BII)I", line = 82)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(Z)V", line = 110)
    public final void method1426(boolean arg0) {
        this.field2993 = arg0;
        field2988++;
    }

    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(B)J", line = 118)
    ...
    @OriginalMember(owner = "client!cu", name = "d", descriptor = "(I)I", line = 130)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Ltga;B)V", line = 143)
    ...
    @OriginalMember(owner = "client!cu", name = "run", descriptor = "()V", line = 159)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Lsj;Ljava/lang/String;JII)V", line = 287)
    ...
    @OriginalMember(owner = "client!cu", name = "c", descriptor = "(Z)Z", line = 319)
    ...
    @OriginalMember(owner = "client!cu", name = "e", descriptor = "(I)Ljava/lang/String;", line = 334)
