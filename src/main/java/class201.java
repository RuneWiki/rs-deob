...
public class class201 extends class461 {
    ...
    @OriginalMember(owner = "client!hm", name = "c", descriptor = "()Lmi;")
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Lsw;II)V")
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "([IIBIILsw;)V")
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "()Lmi;")
    ...
    @OriginalMember(owner = "client!hm", name = "<init>", descriptor = "(Lmt;)V")
