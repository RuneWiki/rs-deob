...
public class class201 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(B[[[Lgn;ZIII)Z")
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(BLgq;I)Z")
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Lmca;IZ)Lsr;")
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "(Lji;)V")
