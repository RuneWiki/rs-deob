...
public class class201 {
    ...
    @OriginalMember(owner = "client!ce", name = "b", descriptor = "(II)Lvs;")
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Lcu;I)Ltn;")
    ...
    @OriginalMember(owner = "client!ce", name = "<init>", descriptor = "(Loq;ILbu;)V")
