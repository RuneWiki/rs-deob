...
public abstract class class201 {
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(ZILjava/lang/String;ILjava/lang/String;ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(IIIILha;IZII)V", line = 112)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(I)V", line = 256)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(B)V", line = 273)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(ILcea;)I", line = 302)
