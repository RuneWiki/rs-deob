...
public class class201 extends class102 {
    ...
    @OriginalMember(owner = "client!hk", name = "c", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IIIII)V", line = 92)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(B)V", line = 115)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Z)V", line = 131)
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "(Lii;Lho;Lkr;J)V", line = 376)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IJ)V", line = 154)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Lii;JIZI)V", line = 198)
