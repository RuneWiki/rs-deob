...
public class class201 extends class134 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(BILwo;)Lfa;", line = 4)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Ljava/lang/String;ZI)V", line = 21)
    ...
    @OriginalMember(owner = "client!ca", name = "e", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(ILbe;)V", line = 114)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IIII[Laq;IIIII)V", line = 154)
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(I)I", line = 808)
    ...
    @OriginalMember(owner = "client!ca", name = "c", descriptor = "(I)[B", line = 824)
