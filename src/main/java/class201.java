...
public abstract class class201 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(BLjava/lang/String;)V", line = 5)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ZILjava/lang/String;III)V", line = 83)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IIILjava/lang/String;II)V", line = 104)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(BLjava/lang/String;I)V", line = 118)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(BIIIILjava/lang/String;)V", line = 156)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IIBII)V", line = 171)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IIIIIILjava/lang/String;I)V", line = 184)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IIILjava/lang/String;IIB)V", line = 214)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IBI)V", line = 251)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "([Lxa;Ljava/lang/String;IIILfa;I[II)V", line = 271)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IIIIILjava/lang/String;I)V", line = 424)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IB)V", line = 455)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "()V", line = 478)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "([III[Lxa;III[IIIILjava/util/Random;IILjava/lang/String;)I", line = 654)
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(Loa;Lub;)V", line = 729)
    public class201(class650 arg0, class20 arg1) {
        this.field2330 = arg1;
        this.field2345 = arg0;
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IILjava/lang/String;II[Lxa;BI[IIIIIIILfa;)I", line = 738)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ILjava/lang/String;III[I[Lxa;I)V", line = 750)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(I[Lxa;ILjava/util/Random;ILjava/lang/String;[IIII)I", line = 766)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "([Lxa;[ILjava/lang/String;[IIIB[I)V", line = 804)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(III[Lxa;Ljava/lang/String;IIIII[IILfa;IIBI)I", line = 975)
