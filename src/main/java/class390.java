...
public class class390 {
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IIIB)V", line = 5)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(Lwp;Lefa;BII)V", line = 118)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "()V", line = 437)
