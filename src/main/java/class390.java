...
public class class390 extends class35 {
    ...
    @OriginalMember(owner = "client!si", name = "<init>", descriptor = "(Lvj;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!si", name = "U", descriptor = "(Lj;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ILco;IB)V")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Lj;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!si", name = "O", descriptor = "(IILj;)Lj;")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Lfk;[I)V")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Lpl;)V")
    ...
    @OriginalMember(owner = "client!si", name = "SA", descriptor = "(Lj;IIIIZ)V")
