...
public class class390 extends class491 {
    ...
    @OriginalMember(owner = "client!po", name = "d", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Z)Ljava/lang/Object;", line = 15)
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Ls;Ljava/lang/Object;I)V", line = 25)
