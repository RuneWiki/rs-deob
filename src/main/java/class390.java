...
public class class390 extends class223 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "()V", line = 52)
    public static void method2396() {
        field5753 = null;
    }

    @OriginalMember(owner = "client!si", name = "b", descriptor = "()[I", line = 57)
    public final int[] method2397() {
        return this.field5755;
    }

    @OriginalMember(owner = "client!si", name = "<init>", descriptor = "(II[IZ)V", line = 59)
