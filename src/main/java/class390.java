...
public class class390 {
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(IB)Ljv;")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(BLk;Ljava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!ad", name = "<init>", descriptor = "(Lei;ILri;)V")
