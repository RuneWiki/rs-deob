...
public class class390 extends class712 {
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(ILkq;II)V")
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(ILha;)Lrk;")
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IBILha;)Z")
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Lgda;Lha;IIZII)V")
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(ILnh;Lha;Lka;)V")
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IIILha;)Lka;")
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(ZLha;)Loba;")
