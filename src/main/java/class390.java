...
public class class390 extends class318 {
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(B)Lku;")
    public final class375 method2063(byte arg0) {
        field5521++;
        return arg0 == -79 ? this.field5514 : null;
    }

    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IIILha;ILhba;)V")
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(Leea;I)V")
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(FLku;ILku;)Z")
