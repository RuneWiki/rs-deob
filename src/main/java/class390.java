...
public class class390 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Lnt;Ljava/awt/Frame;B)V", line = 7)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IB)Z", line = 56)
