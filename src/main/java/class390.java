...
public class class390 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ZI)V", line = 9)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(II)V", line = 145)
