...
public class class390 {
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "()V", line = 11)
    public class390() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Lnj;Z[B)V", line = 14)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(III)V", line = 64)
