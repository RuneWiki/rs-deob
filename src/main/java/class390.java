...
public class class390 {
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(ILi;)V", line = 22)
    public static final void method2253(int arg0, class270 arg1) {
        class246.field3214[arg0] = arg1;
    }

    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(Z)V", line = 30)
