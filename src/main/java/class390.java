...
public abstract class class390 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(I)Z", line = 90)
    ...
    @OriginalMember(owner = "client!jh", name = "c", descriptor = "(I)Z", line = 101)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(B)Z", line = 114)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(III)Lfo;", line = 125)
    ...
    @OriginalMember(owner = "client!jh", name = "d", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IIIII)V", line = 165)
    ...
    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(B)Z", line = 213)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ILjava/lang/String;IBILjava/lang/String;ZZJIZ)V", line = 224)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ZI)V", line = 284)
