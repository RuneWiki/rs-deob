...
public class class390 extends class530 implements class242 {
    ...
    @OriginalMember(owner = "client!xa", name = "d", descriptor = "()[Lhv;")
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(Lc;Ltq;II)V")
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(Lc;Ltq;I)V")
    ...
    @OriginalMember(owner = "client!xa", name = "<init>", descriptor = "(Lw;Lg;Lko;IIII)V")
    ...
    @OriginalMember(owner = "client!xa", name = "c", descriptor = "()[Lgh;")
