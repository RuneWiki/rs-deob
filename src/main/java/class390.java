...
public class class390 implements class409 {
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(BI)V", line = 8)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(I)Lhr;", line = 32)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(ILsl;)Lhj;", line = 63)
    ...
    @OriginalMember(owner = "client!ada", name = "<init>", descriptor = "(Leda;Lcga;IIIIIII)V", line = 73)
