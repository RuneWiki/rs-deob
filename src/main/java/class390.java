...
public class class390 {
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(BI)V", line = 24)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(ZIIII[[[Lwr;)Z", line = 37)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(I)V", line = 358)
    ...
    @OriginalMember(owner = "client!cw", name = "b", descriptor = "(I)V", line = 374)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "([ILpg;II[II)Lt;", line = 390)
    ...
    @OriginalMember(owner = "client!cw", name = "<init>", descriptor = "(Lad;ILdk;Ldk;)V", line = 426)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(IZ)Lhc;", line = 442)
