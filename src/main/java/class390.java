...
public class class390 extends class360 implements class231 {
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(ZLqa;)V")
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(Lqa;I)Lbi;")
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!cda", name = "b", descriptor = "(ILqa;)Lkm;")
    public final class120 method260(int arg0, class167 arg1) {
        ++field5835;
        return arg0 >= -50 ? null : this.field5831;
    }

    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(ILqa;Z)Lr;")
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(Ljba;IIII)V")
    ...
    @OriginalMember(owner = "client!cda", name = "<init>", descriptor = "(Lqa;Ltk;IIIIIZIIIIIII)V")
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(BZILqa;IILcea;)V")
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(BLqa;II)Z")
