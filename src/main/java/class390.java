...
public class class390 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IB)V", line = 29)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lqj;ILqj;)V", line = 66)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IIILs;)V", line = 79)
