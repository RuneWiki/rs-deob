...
public class class390 extends class30 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IB)[I", line = 4)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(II)I", line = 44)
    public static final int method2461(int arg0, int arg1) {
        ++field5862;
        return arg0 != -9812 ? 75 : arg1 & 255;
    }

    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(BLe;)V", line = 56)
    ...
    @OriginalMember(owner = "client!rs", name = "<init>", descriptor = "()V", line = 71)
    public class390() {
        super(1, true);
    }

    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(ILne;B)I", line = 79)
    ...
    @OriginalMember(owner = "client!rs", name = "f", descriptor = "(I)V", line = 99)
