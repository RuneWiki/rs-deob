...
public class class390 extends class460 {
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(Z)Log;", line = 5)
    ...
    @OriginalMember(owner = "client!nf", name = "b", descriptor = "(Z)I", line = 111)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(BI)I", line = 122)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IIZ)Lpp;", line = 139)
    ...
    @OriginalMember(owner = "client!nf", name = "b", descriptor = "(I)V", line = 361)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IB)V", line = 542)
    ...
    @OriginalMember(owner = "client!nf", name = "<init>", descriptor = "(ILap;Lap;Lno;Lmf;IIZ)V", line = 746)
    ...
    @OriginalMember(owner = "client!nf", name = "c", descriptor = "(I)V", line = 578)
    ...
    @OriginalMember(owner = "client!nf", name = "c", descriptor = "(Z)V", line = 625)
    ...
    @OriginalMember(owner = "client!nf", name = "d", descriptor = "(I)I", line = 640)
    ...
    @OriginalMember(owner = "client!nf", name = "e", descriptor = "(I)I", line = 655)
    ...
    @OriginalMember(owner = "client!nf", name = "f", descriptor = "(I)I", line = 680)
    ...
    @OriginalMember(owner = "client!nf", name = "b", descriptor = "(II)[B", line = 701)
