...
public class class390 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IILps;BI)V")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ILti;)V")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ILti;I)V")
