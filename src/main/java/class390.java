...
public class class390 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(II)Ljava/lang/String;", line = 7)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Z)V", line = 32)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "()V", line = 44)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IZ)V", line = 281)
