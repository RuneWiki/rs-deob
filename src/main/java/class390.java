...
public class class390 extends class54 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Lag;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(III)Z", line = 23)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IIIIIII)V", line = 34)
    ...
    @OriginalMember(owner = "client!ob", name = "c", descriptor = "(I)V", line = 222)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Lgga;B)V", line = 238)
    ...
    @OriginalMember(owner = "client!ob", name = "b", descriptor = "(III)V", line = 275)
