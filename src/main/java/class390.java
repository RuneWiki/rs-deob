...
public class class390 extends class649 {
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(III)Z", line = 18)
    ...
    @OriginalMember(owner = "client!ada", name = "c", descriptor = "(I)Z", line = 29)
    ...
    @OriginalMember(owner = "client!ada", name = "d", descriptor = "(I)I", line = 42)
    ...
    @OriginalMember(owner = "client!ada", name = "b", descriptor = "(II)V", line = 54)
    ...
    @OriginalMember(owner = "client!ada", name = "b", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(I)I", line = 102)
    ...
    @OriginalMember(owner = "client!ada", name = "e", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!ada", name = "f", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(IB)V", line = 135)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(Z)V", line = 147)
    ...
    @OriginalMember(owner = "client!ada", name = "<init>", descriptor = "(ILhs;)V", line = 158)
    public class390(int arg0, class358 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(IIIIIZI)V", line = 161)
    ...
    @OriginalMember(owner = "client!ada", name = "<init>", descriptor = "(Lhs;)V", line = 196)
