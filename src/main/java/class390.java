...
public class class390 {
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "([BIBI)I", line = 3)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(IJ)V", line = 20)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(Lbs;B)I", line = 33)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!kda", name = "finalize", descriptor = "()V", line = 74)
    ...
    @OriginalMember(owner = "client!kda", name = "b", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(B)J", line = 108)
    ...
    @OriginalMember(owner = "client!kda", name = "c", descriptor = "(I)Ljava/io/File;", line = 122)
    ...
    @OriginalMember(owner = "client!kda", name = "<init>", descriptor = "(Ljava/io/File;Ljava/lang/String;J)V", line = 132)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "([BBII)V", line = 175)
