...
public class class390 {
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(BLjava/lang/String;)V", line = 11)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(I)Z", line = 33)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(FIIFIIFI)[F", line = 80)
