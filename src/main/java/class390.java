...
public class class390 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Z)Lrh;", line = 3)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(FIII[FFIIIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(II)Lfs;", line = 96)
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "(II)V", line = 106)
    public class390(int arg0, int arg1) {
        this.field5234 = arg1;
        this.field5239 = arg0;
    }

    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "(Lfs;I)V", line = 114)
