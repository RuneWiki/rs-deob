...
public class class390 {
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(ZI)I", line = 3)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(Lps;BI)V", line = 26)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(Llba;Z)Z", line = 61)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(B)V", line = 164)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(I)V", line = 230)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(Lps;B)V", line = 248)
    ...
    @OriginalMember(owner = "client!cda", name = "b", descriptor = "(I)Z", line = 281)
