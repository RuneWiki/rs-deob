...
public class class390 {
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(II)Loh;")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lnn;I)V")
    ...
    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "(Lkp;ILph;)V")
