...
public class class390 extends class378 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Lke;I)V")
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IIILjava/lang/Class;)Lug;")
    ...
    @OriginalMember(owner = "client!dk", name = "b", descriptor = "(BLke;)V")
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Lli;I)V")
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(ILcl;ZIF)V")
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Ltq;Z)V")
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(BLke;)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
