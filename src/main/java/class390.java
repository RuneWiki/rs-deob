...
public class class390 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Lol;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(BILmha;ZLmha;)I", line = 64)
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(Lgga;)V", line = 180)
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "()V", line = 192)
    protected class390() {
