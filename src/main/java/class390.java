...
public class class390 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IZ)S", line = 3)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(BZ)V", line = 36)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(II)V", line = 73)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(IZ)Ljaa;", line = 122)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(B)V", line = 156)
    ...
    @OriginalMember(owner = "client!vq", name = "<init>", descriptor = "(Lre;ILdn;)V", line = 171)
