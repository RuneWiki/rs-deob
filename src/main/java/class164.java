...
public class class164 extends class344 implements class670 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IILoa;I)Z")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ILoa;)Lgr;")
    ...
    @OriginalMember(owner = "client!wp", name = "b", descriptor = "(Loa;I)Lok;")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ZIZIILfl;Loa;)V")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "(Loa;Lbfa;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!wp", name = "c", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IILoa;)Lba;")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Loa;B)V")
