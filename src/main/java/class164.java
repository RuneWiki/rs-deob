...
public class class164 extends class337 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IILqa;)Lc;", line = 47)
