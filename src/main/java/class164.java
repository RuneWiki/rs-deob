...
public class class164 extends class450 {
    ...
    @OriginalMember(owner = "client!tba", name = "<init>", descriptor = "(Lup;)V")
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(Lee;I)V")
    ...
    @OriginalMember(owner = "client!tba", name = "c", descriptor = "(Z)I")
    ...
    @OriginalMember(owner = "client!tba", name = "<init>", descriptor = "(ILup;)V")
    public class164(int arg0, class278 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!tba", name = "c", descriptor = "(II)Lon;")
