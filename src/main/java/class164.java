...
public class class164 {
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Ljava/lang/String;ZLra;I)V", line = 17)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IIIILig;)V", line = 58)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Lfp;B)Z", line = 99)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IIII[BII)V", line = 120)
