...
public class class164 {
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(IILoa;Z)Liaa;")
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(IB)Lkm;")
    ...
    @OriginalMember(owner = "client!aba", name = "<init>", descriptor = "(Lbs;ILpfa;Lpfa;)V")
