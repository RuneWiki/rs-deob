...
public class class164 extends class38 implements class103 {
    ...
    @OriginalMember(owner = "client!qa", name = "r", descriptor = "()V", line = 2)
    public final void method352() {
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(I)V", line = 6)
    public final void method279(int arg0) {
        this.field2098[arg0].method114();
    }

    @OriginalMember(owner = "client!qa", name = "m", descriptor = "()V", line = 8)
    public final void method313() {
    }

    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 12)
    ...
    @OriginalMember(owner = "client!qa", name = "sa", descriptor = "(S)Z", line = 26)
    ...
    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "(ILjava/awt/Canvas;Lga;Lpc;)V", line = 50)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIIIILma;II)V", line = 93)
    ...
    @OriginalMember(owner = "client!qa", name = "SA", descriptor = "()Ljava/lang/Object;", line = 96)
    private final Object method1055() {
        return new class146();
    }

    @OriginalMember(owner = "client!qa", name = "d", descriptor = "()V", line = 103)
    ...
    @OriginalMember(owner = "client!qa", name = "ha", descriptor = "()V", line = 123)
    ...
    @OriginalMember(owner = "client!qa", name = "v", descriptor = "()Z", line = 128)
    public final boolean method362() {
        return false;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "([Lt;Lfm;Lc;[Lvs;I)V", line = 132)
    ...
    @OriginalMember(owner = "client!qa", name = "z", descriptor = "()Z", line = 174)
    public final boolean method368() {
        return true;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "([IIIII)Ll;", line = 178)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lkc;Lkc;FLkc;)Lkc;", line = 218)
    public final class87 method273(class87 arg0, class87 arg1, float arg2, class87 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!qa", name = "j", descriptor = "()Z", line = 222)
    public final boolean method304() {
        return false;
    }

    @OriginalMember(owner = "client!qa", name = "C", descriptor = "()Z", line = 226)
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(II)I", line = 233)
    public final int method370(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(II)I", line = 237)
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "()V", line = 244)
    public final void method272() {
    }

    @OriginalMember(owner = "client!qa", name = "c", descriptor = "()Z", line = 250)
    public final boolean method281() {
        return true;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lqv;Z)Ll;", line = 255)
    ...
    @OriginalMember(owner = "client!qa", name = "c", descriptor = "(Z)V", line = 328)
    public final void method346(boolean arg0) {
    }

    @OriginalMember(owner = "client!qa", name = "k", descriptor = "()V", line = 333)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIII)V", line = 358)
    public final void method375(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIIZ)Ll;", line = 361)
    ...
    @OriginalMember(owner = "client!qa", name = "t", descriptor = "()Z", line = 369)
    public final boolean method356() {
        return false;
    }

    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(I)V", line = 375)
    public final void method285(int arg0) {
        this.field2098[arg0].method113();
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lli;[Lqv;Z)Lla;", line = 380)
    ...
    @OriginalMember(owner = "client!qa", name = "p", descriptor = "()Z", line = 388)
    public final boolean method322() {
        return false;
    }

    @OriginalMember(owner = "client!qa", name = "f", descriptor = "(I)Lu;", line = 392)
    ...
    @OriginalMember(owner = "client!qa", name = "n", descriptor = "()I", line = 397)
    public final int method314() {
        return 4;
    }

    @OriginalMember(owner = "client!qa", name = "s", descriptor = "()Z", line = 404)
    public final boolean method354() {
        return true;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 411)
    ...
    @OriginalMember(owner = "client!qa", name = "i", descriptor = "()V", line = 461)
    public final void method302() {
    }

    @OriginalMember(owner = "client!qa", name = "d", descriptor = "(Ljava/awt/Canvas;)V", line = 465)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Z)V", line = 481)
    public final void method280(boolean arg0) {
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lkc;)V", line = 484)
    public final void method294(class87 arg0) {
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIIII)V", line = 489)
    ...
    @OriginalMember(owner = "client!qa", name = "u", descriptor = "()Z", line = 496)
    public final boolean method360() {
        return true;
    }

    @OriginalMember(owner = "client!qa", name = "g", descriptor = "()Z", line = 499)
    public final boolean method293() {
        return false;
    }

    @OriginalMember(owner = "client!qa", name = "c", descriptor = "(I)V", line = 504)
    public final void method332(int arg0) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!qa", name = "f", descriptor = "()Z", line = 510)
    public final boolean method289() {
        return false;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lmb;IIII)Lt;", line = 516)
    ...
    @OriginalMember(owner = "client!qa", name = "q", descriptor = "()Z", line = 519)
    public final boolean method339() {
        return true;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lfm;Z)V", line = 523)
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(Z)V", line = 552)
    public final void method284(boolean arg0) {
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(II[[I[[IIII)Lta;", line = 555)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "([Lt;Lc;[Lvs;I)V", line = 560)
    ...
    @OriginalMember(owner = "client!qa", name = "h", descriptor = "()Z", line = 578)
    public final boolean method297() {
        return true;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(I[Lku;)V", line = 582)
    ...
    @OriginalMember(owner = "client!qa", name = "B", descriptor = "()Lc;", line = 602)
    public final class123 method371() {
        return new class31();
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIIIF)Lku;", line = 605)
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(IIIIII)Lkc;", line = 611)
    public final class87 method292(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!qa", name = "A", descriptor = "()Lc;", line = 614)
    public final class123 method369() {
        return this.field2086;
    }

    @OriginalMember(owner = "client!qa", name = "c", descriptor = "(IIIIII)V", line = 618)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIIIII)V", line = 624)
    ...
    @OriginalMember(owner = "client!qa", name = "x", descriptor = "()Z", line = 631)
    public final boolean method363() {
        return true;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 637)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(II[I[I)Lma;", line = 656)
    ...
    @OriginalMember(owner = "client!qa", name = "o", descriptor = "()Z", line = 659)
    public final boolean method316() {
        return true;
    }

    @OriginalMember(owner = "client!qa", name = "g", descriptor = "(I)V", line = 662)
    ...
    @OriginalMember(owner = "client!qa", name = "R", descriptor = "(S)Z", line = 681)
    ...
    @OriginalMember(owner = "client!qa", name = "y", descriptor = "()V", line = 691)
    public final void method365() {
    }

    @OriginalMember(owner = "client!qa", name = "c", descriptor = "(Ljava/awt/Canvas;)V", line = 696)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lfm;)V", line = 710)
    ...
    @OriginalMember(owner = "client!qa", name = "finalize", descriptor = "()V", line = 726)
    protected final void finalize() {
        this.method120();
    }

    @OriginalMember(owner = "client!qa", name = "d", descriptor = "(I)V", line = 731)
    ...
    @OriginalMember(owner = "client!qa", name = "E", descriptor = "()Ln;", line = 746)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lt;Lfm;Lc;Lvs;I)V", line = 776)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIIIIIIII)V", line = 828)
    public final void method312(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(FFF)V", line = 830)
