...
public class class164 {
    ...
    @OriginalMember(owner = "client!rg", name = "k", descriptor = "Lkf;")
    public static class100 field3076;

    @OriginalMember(owner = "client!rg", name = "f", descriptor = "Lah;")
    public static class9 field3071;

    @OriginalMember(owner = "client!rg", name = "t", descriptor = "[S")
    public static short[] field3085;

    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IIZI)Llf;")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(ILlf;IZI)V")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(BLbg;ZLdb;Lbg;)V")
