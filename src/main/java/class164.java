...
public class class164 extends class219 {
    ...
    @OriginalMember(owner = "client!as", name = "b", descriptor = "(B)F", line = 7)
    ...
    @OriginalMember(owner = "client!as", name = "c", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 52)
    public class164(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!as", name = "a", descriptor = "(II)V", line = 58)
    ...
    @OriginalMember(owner = "client!as", name = "d", descriptor = "(B)Ljava/lang/String;", line = 83)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(ILjagtheora/ogg/OggPacket;)V", line = 94)
    ...
    @OriginalMember(owner = "client!as", name = "b", descriptor = "(Z)F", line = 166)
    ...
    @OriginalMember(owner = "client!as", name = "b", descriptor = "(I)Ljava/lang/String;", line = 177)
