...
public class class164 {
    ...
    @OriginalMember(owner = "client!wn", name = "b", descriptor = "(II)Lgu;")
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(ILui;IZ)Lfo;")
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "(Lgp;ILui;Lui;)V")
