...
public class class164 {
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(Ljr;I)V")
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(ILoa;IZ)Lgg;")
    ...
    @OriginalMember(owner = "client!cw", name = "b", descriptor = "(I)[Lpq;")
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(Ljr;IB)V")
