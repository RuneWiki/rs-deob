...
public class class164 extends class435 {
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 35)
    ...
    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Z)V", line = 102)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IIIIIIIIII)V", line = 118)
