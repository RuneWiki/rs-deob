...
public abstract class class164 extends class665 {
    ...
    @OriginalMember(owner = "client!cw", name = "b", descriptor = "(Z)I", line = 7)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(Lr;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!cw", name = "b", descriptor = "(I)Z", line = 43)
    ...
    @OriginalMember(owner = "client!cw", name = "<init>", descriptor = "(Lok;)V", line = 54)
    public class164(class228 arg0) {
        this.field2358 = arg0;
    }

    @OriginalMember(owner = "client!cw", name = "c", descriptor = "(Z)V", line = 67)
    ...
    @OriginalMember(owner = "client!cw", name = "c", descriptor = "(I)Z", line = 82)
    public final boolean method1136(int arg0) {
        field2357++;
        return arg0 == -8857 ? this.field2353 : true;
    }

    @OriginalMember(owner = "client!cw", name = "e", descriptor = "(I)I", line = 93)
