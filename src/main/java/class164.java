...
public class class164 extends class231 {
    ...
    @OriginalMember(owner = "client!w", name = "b", descriptor = "(III)[B", line = 4)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(IB)V", line = 10)
    ...
    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "()V", line = 16)
    public class164() {
