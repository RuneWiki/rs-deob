...
public class class164 extends class147 implements class425 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(BLii;)V", line = 4)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(Lii;I)Leb;", line = 17)
    ...
    @OriginalMember(owner = "client!fi", name = "d", descriptor = "(I)I", line = 54)
    ...
    @OriginalMember(owner = "client!fi", name = "d", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ILii;)V", line = 103)
    ...
    @OriginalMember(owner = "client!fi", name = "e", descriptor = "(I)Z", line = 120)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(I)I", line = 132)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lii;IIIILnc;Z)V", line = 147)
    ...
    @OriginalMember(owner = "client!fi", name = "g", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IIZLii;)Z", line = 180)
    ...
    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(I)Z", line = 197)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Z)V", line = 208)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lii;I)V", line = 220)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ILii;I)Ldc;", line = 233)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(I)I", line = 248)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(B)V", line = 259)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(III)Lba;", line = 270)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(Lii;Lge;IIIIIIZI)V", line = 289)
