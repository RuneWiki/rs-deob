...
public class class164 extends class336 {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 4)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(ZZ)V", line = 17)
    ...
    @OriginalMember(owner = "client!ih", name = "c", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Z)Z", line = 45)
    ...
    @OriginalMember(owner = "client!ih", name = "d", descriptor = "(I)I", line = 57)
    ...
    @OriginalMember(owner = "client!ih", name = "<init>", descriptor = "(Ldc;Ljava/lang/Object;I)V", line = 198)
