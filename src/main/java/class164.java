...
public class class164 extends class145 {
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(ZI)[I", line = 3)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "([[II)V", line = 26)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IILrt;)V", line = 78)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(BI)[[I", line = 153)
    ...
    @OriginalMember(owner = "client!kk", name = "i", descriptor = "(I)V", line = 215)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "()V", line = 237)
    public class164() {
        super(0, true);
    }
}
