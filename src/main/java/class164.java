...
public class class164 {
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(I[Ljava/lang/String;BI)Ljava/lang/String;", line = 22)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IBI)I", line = 84)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IIII)V", line = 102)
