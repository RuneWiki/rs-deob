...
public class class164 extends class163 {
    ...
    @OriginalMember(owner = "client!sr", name = "c", descriptor = "(B)Ljava/lang/Object;", line = 5)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(Lqo;Ljava/lang/Object;I)V", line = 14)
    public class164(class19 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field2466 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!sr", name = "f", descriptor = "(I)Z", line = 24)
