...
public class class164 extends class260 {
    ...
    @OriginalMember(owner = "client!faa", name = "<init>", descriptor = "(Lgn;)V")
    public class164(class729 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!faa", name = "<init>", descriptor = "(ILgn;)V")
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "([[BLrr;I)V")
