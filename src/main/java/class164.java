...
public class class164 extends class192 {
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(IB)[I", line = 5)
    ...
    @OriginalMember(owner = "client!cfa", name = "c", descriptor = "(I)V", line = 217)
    ...
    @OriginalMember(owner = "client!cfa", name = "<init>", descriptor = "()V", line = 249)
    public class164() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cfa", name = "c", descriptor = "(B)V", line = 256)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(ILfd;I)V", line = 293)
