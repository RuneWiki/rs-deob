...
public class class164 {
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(Lefa;B)V")
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(I)Lefa;")
    ...
    @OriginalMember(owner = "client!ada", name = "b", descriptor = "(I)Lefa;")
    ...
    @OriginalMember(owner = "client!ada", name = "b", descriptor = "(B)Lefa;")
    ...
    @OriginalMember(owner = "client!ada", name = "f", descriptor = "(I)Lefa;")
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(Lada;I)V")
    ...
    @OriginalMember(owner = "client!ada", name = "b", descriptor = "(Lefa;B)V")
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(Z)Lefa;")
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(Lefa;BLada;)V")
