...
public class class164 extends class646 {
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(IBZLr;)Lla;", line = 4)
    ...
    @OriginalMember(owner = "client!cfa", name = "<init>", descriptor = "()V", line = 20)
    public class164() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cfa", name = "c", descriptor = "(IB)V", line = 23)
    ...
    @OriginalMember(owner = "client!cfa", name = "b", descriptor = "(IB)[I", line = 36)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(IIB)I", line = 69)
