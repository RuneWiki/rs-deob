...
public class class164 {
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Lud;ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IILs;ILs;Lsd;IIIZIIBLha;)Lka;", line = 125)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(BLud;)V", line = 247)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(B)V", line = 269)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IIILsd;ILha;I)Lka;", line = 284)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(II)I", line = 307)
    public static int method1221(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IILha;IILsd;I)Lka;", line = 320)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(BI)I", line = 343)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IIIIIIIILsd;Ls;ZLha;Ls;)Lka;", line = 364)
