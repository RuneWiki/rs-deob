...
public class class164 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(ZIIIIB)V", line = 5)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(I)V", line = 158)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(III)V", line = 171)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IIIIIII)V", line = 180)
