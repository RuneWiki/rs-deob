...
public class class164 extends class174 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Lcf;IZLvc;I)V")
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(ILvc;II)Z")
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Lvc;I)Lep;")
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(ZLvc;)V")
