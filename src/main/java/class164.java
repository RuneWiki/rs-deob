...
public class class164 extends class617 {
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(ZLnp;)V")
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(ILce;)V")
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Lnp;BI)V")
