...
public class class164 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(III)Z", line = 9)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(BIILru;IILha;)Lka;", line = 26)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IIIILha;Lru;I)Lka;", line = 44)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(I)Z", line = 65)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IBLs;IIIZILs;ILru;Lha;IB)Lka;", line = 76)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Lsl;I)V", line = 203)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IILsl;)V", line = 236)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IILs;BIILru;IILs;IZLha;)Lka;", line = 374)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Z)V", line = 385)
