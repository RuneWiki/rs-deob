...
public class class164 extends class54 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ILie;)Llf;", line = 5)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(BII)Z", line = 33)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IIIIIBI)V", line = 52)
    ...
    @OriginalMember(owner = "client!wp", name = "e", descriptor = "(B)V", line = 496)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Z)V", line = 524)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IIIII)V", line = 541)
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "(Lrr;II)V", line = 562)
