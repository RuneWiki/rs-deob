...
public class class164 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Ljava/lang/String;Lgt;ZIZ)V")
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(ZILin;)Z")
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(Ltt;)V")
