...
public class class164 extends class748 {
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(ILvj;)Lwr;", line = 3)
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "()V", line = 14)
    public class164() {
        super(0, true);
    }

    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IZ)Lcba;", line = 18)
    ...
    @OriginalMember(owner = "client!kh", name = "d", descriptor = "(III)Z", line = 51)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(II)[I", line = 67)
    ...
    @OriginalMember(owner = "client!kh", name = "d", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!kh", name = "e", descriptor = "(B)V", line = 102)
