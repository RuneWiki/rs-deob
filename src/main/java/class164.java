...
public class class164 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(ZLft;)Z")
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Lat;I)Z")
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Lft;B)V")
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(Lpg;)V")
