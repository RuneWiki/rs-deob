...
public class class164 implements Runnable {
    ...
    @OriginalMember(owner = "client!bj", name = "finalize", descriptor = "()V", line = 3)
    protected final void finalize() {
        field2487++;
        this.method1186((byte) -124);
    }

    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(I[BII)V", line = 11)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(I)I", line = 70)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(I[BII)V", line = 111)
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(Ljava/net/Socket;Lul;)V", line = 300)
    ...
    @OriginalMember(owner = "client!bj", name = "run", descriptor = "()V", line = 141)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(I)V", line = 213)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(B)V", line = 231)
    ...
    @OriginalMember(owner = "client!bj", name = "c", descriptor = "(I)I", line = 286)
