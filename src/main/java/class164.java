...
public class class164 {
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!tba", name = "b", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!tba", name = "finalize", descriptor = "()V", line = 40)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(BLvq;)V", line = 49)
    ...
    @OriginalMember(owner = "client!tba", name = "<init>", descriptor = "(Lqo;JI)V", line = 82)
