...
public class class164 extends class37 implements class358 {
    ...
    @OriginalMember(owner = "client!pha", name = "<init>", descriptor = "(Lai;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!pha", name = "d", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(BIIII[FILwd;I)V")
    ...
    @OriginalMember(owner = "client!pha", name = "e", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!pha", name = "<init>", descriptor = "(Lai;Lwd;Ljm;II)V")
    ...
    @OriginalMember(owner = "client!pha", name = "<init>", descriptor = "(Lai;Lwd;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!pha", name = "<init>", descriptor = "(Lai;Lwd;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(ZLig;)Lua;")
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(IIB[BIIILwd;I)V")
