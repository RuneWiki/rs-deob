...
public class class164 extends class114 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Lr;III[Z)Z")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Ljc;I)V")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ILwfa;)V")
