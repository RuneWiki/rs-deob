...
public class class164 {
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(ILrv;)V")
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(IILrv;)V")
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(I)[Lpb;")
