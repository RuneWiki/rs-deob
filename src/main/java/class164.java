...
public class class164 extends class263 {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Lgo;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 44)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(IIIIIIII)V", line = 67)
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "()V", line = 88)
    public class164() {
        super(0, true);
    }

    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(IB)[I", line = 91)
    ...
    @OriginalMember(owner = "client!mr", name = "d", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!mr", name = "b", descriptor = "(Ljava/lang/String;I)I", line = 119)
