...
public class class164 extends class406 {
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(CI)C", line = 3)
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "()V", line = 33)
    public class164() {
    }

    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(II)[B", line = 39)
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "(J)V", line = 144)
    public class164(long arg0) {
        this.field2315 = arg0;
    }

    @OriginalMember(owner = "client!nb", name = "c", descriptor = "(I)V", line = 152)
