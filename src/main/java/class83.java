...
public class class83 extends class648 {
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 16)
    ...
    @OriginalMember(owner = "client!cda", name = "d", descriptor = "()V", line = 37)
    ...
    @OriginalMember(owner = "client!cda", name = "b", descriptor = "()V", line = 60)
    ...
    @OriginalMember(owner = "client!cda", name = "c", descriptor = "()I", line = 93)
    public final int method468() {
        return this.field1032 - (this.field1033.available() >> (class129.field1643 ? 2 : 1));
    }

    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 101)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "()V", line = 137)
