...
public class class83 {
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(Luw;II)V")
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(Lrk;)V")
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(Ljk;I)V")
