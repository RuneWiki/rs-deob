...
public class class83 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(II)[B", line = 4)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(BLjava/lang/String;)V", line = 41)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IIIII)V", line = 78)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Z)V", line = 108)
