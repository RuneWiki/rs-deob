...
public class class83 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(BI)V", line = 36)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(II)Ljava/lang/String;", line = 66)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 139)
    public class83(String arg0, String arg1, String arg2, String arg3) {
        this.field1159 = new String[] { arg0, arg1, arg2, arg3 };
    }

    @OriginalMember(owner = "client!fg", name = "toString", descriptor = "()Ljava/lang/String;", line = 167)
