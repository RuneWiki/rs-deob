...
public class class83 extends class281 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(JI)V", line = 3)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "()V", line = 397)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lbq;IIIIIIIIIIIZ)V", line = 407)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(J)V", line = 431)
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "()V", line = 559)
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "(Lbq;IIIIIIIIIIIZ)V", line = 569)
