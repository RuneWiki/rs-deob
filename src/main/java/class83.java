...
public class class83 {
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(BI)Ltaa;", line = 8)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(JZLwe;)V", line = 46)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(JI)Lwe;", line = 66)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!kca", name = "b", descriptor = "(I)Lwe;", line = 113)
    ...
    @OriginalMember(owner = "client!kca", name = "<init>", descriptor = "(I)V", line = 144)
