...
public class class83 {
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(B)I", line = 15)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(I)I", line = 27)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!qu", name = "<init>", descriptor = "()V", line = 78)
    public class83() {
    }

    @OriginalMember(owner = "client!qu", name = "<init>", descriptor = "(Lie;)V", line = 80)
