...
public class class83 extends class37 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(III)V", line = 6)
    ...
    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(III)V", line = 31)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(B)V", line = 51)
    public static void method595(byte arg0) {
        field1415 = null;
        int var1 = 4 % ((25 - arg0) / 52);
    }

    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ILbl;ILjava/lang/String;)Luh;", line = 61)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(IIB)V", line = 102)
    ...
    @OriginalMember(owner = "client!mc", name = "<init>", descriptor = "(IIIIIII)V", line = 120)
