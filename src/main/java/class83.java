...
public class class83 extends class356 implements class57 {
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(BLoa;)V", line = 3)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(I)I", line = 34)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(ILoa;I)Lba;", line = 44)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Loa;B)Laca;", line = 67)
    ...
    @OriginalMember(owner = "client!iv", name = "c", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IZLoa;)Lba;", line = 114)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Loa;I)V", line = 129)
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(Loa;Lqd;IIIIZIIIII)V", line = 139)
    ...
    @OriginalMember(owner = "client!iv", name = "d", descriptor = "(I)I", line = 165)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(Loa;I)Lew;", line = 176)
    ...
    @OriginalMember(owner = "client!iv", name = "i", descriptor = "(I)V", line = 191)
    ...
    @OriginalMember(owner = "client!iv", name = "g", descriptor = "(I)I", line = 201)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(ILoa;)V", line = 219)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Loa;ZII)Llo;", line = 249)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(I)Z", line = 279)
    ...
    @OriginalMember(owner = "client!iv", name = "e", descriptor = "(I)I", line = 295)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IILoa;I)Z", line = 307)
