...
public class class83 extends class472 {
    ...
    @OriginalMember(owner = "client!m", name = "b", descriptor = "()Lnd;")
    public final class473 method567() {
        return this.field1252;
    }

    @OriginalMember(owner = "client!m", name = "a", descriptor = "([Lta;Z)V")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(Lkm;[Lqm;Z)V")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(Lkm;J)Z")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(Lkm;J[Lqm;[Lta;Z)V")
