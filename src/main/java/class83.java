...
public class class83 extends class262 {
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(IZI)V", line = 13)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(ILoa;B)V", line = 46)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(I)Z", line = 66)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(IZ)V", line = 80)
    ...
    @OriginalMember(owner = "client!qfa", name = "<init>", descriptor = "(Ldda;Ljn;Lvt;)V", line = 111)
    ...
    @OriginalMember(owner = "client!qfa", name = "c", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 152)
