...
public class class83 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IIBLts;II)Lts;")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lrg;Z)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(BIIIIIBLts;)Lts;")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILrg;)V")
