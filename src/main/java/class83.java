...
public class class83 {
    ...
    @OriginalMember(owner = "client!pp", name = "b", descriptor = "(II)Loda;")
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(ZZILda;ILha;IIILha;Lnk;I)Lit;")
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(IBIILnk;ILha;I)Lit;")
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(Lcr;IZLqia;Lla;Lla;)V")
