...
public class class83 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Lwn;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IIIZ)V", line = 54)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(I)V", line = 69)
