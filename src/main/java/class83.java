...
public class class83 {
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "(Liea;I)I", line = 3)
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!cja", name = "b", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!cja", name = "toString", descriptor = "()Ljava/lang/String;", line = 146)
