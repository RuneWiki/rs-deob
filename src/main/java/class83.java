...
public class class83 implements Runnable {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Ljava/awt/Canvas;ILec;IZLga;)Lya;")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Ljava/awt/Component;I)Ljv;")
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Ljava/net/Socket;Lec;)V")
