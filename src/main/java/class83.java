...
public class class83 extends class529 {
    ...
    @OriginalMember(owner = "client!rda", name = "c", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!rda", name = "e", descriptor = "(B)V", line = 74)
    ...
    @OriginalMember(owner = "client!rda", name = "f", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(IZ)Lfj;", line = 115)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(BIIII)I", line = 130)
    ...
    @OriginalMember(owner = "client!rda", name = "g", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(IBLtn;)V", line = 273)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(II)[[I", line = 289)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "([BBII)I", line = 331)
    ...
    @OriginalMember(owner = "client!rda", name = "<init>", descriptor = "()V", line = 354)
    public class83() {
        super(1, false);
    }

    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(IB)[I", line = 358)
