...
public class class83 extends class82 {
    ...
    @OriginalMember(owner = "client!eda", name = "<init>", descriptor = "()V", line = 290)
    public class83() {
        super(0, true);
    }

    @OriginalMember(owner = "client!eda", name = "h", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!eda", name = "c", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!eda", name = "c", descriptor = "(II)[I", line = 75)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IILos;)V", line = 296)
