...
public class class83 extends class223 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Lfs;I)Ldi;")
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Lfs;II)Ldi;")
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Lfs;)Z")
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "([I)Ljs;")
