...
public class class83 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lvo;", line = 22)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IZZII)I", line = 44)
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(I)V", line = 93)
