...
public abstract class class83 implements class34 {
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(BLcw;)V", line = 3)
    ...
    @OriginalMember(owner = "client!mba", name = "c", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(IB[B)[B", line = 50)
    ...
    @OriginalMember(owner = "client!mba", name = "d", descriptor = "(I)I", line = 66)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(III[II)V", line = 79)
    ...
    @OriginalMember(owner = "client!mba", name = "e", descriptor = "(I)Lah;", line = 186)
    ...
    @OriginalMember(owner = "client!mba", name = "b", descriptor = "(I)V", line = 203)
    ...
    @OriginalMember(owner = "client!mba", name = "f", descriptor = "(I)V", line = 240)
    ...
    @OriginalMember(owner = "client!mba", name = "g", descriptor = "(I)I", line = 256)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(III)B", line = 355)
    ...
    @OriginalMember(owner = "client!mba", name = "b", descriptor = "(III)Z", line = 373)
    ...
    @OriginalMember(owner = "client!mba", name = "c", descriptor = "(III)Z", line = 393)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(III[FI)V", line = 405)
    ...
    @OriginalMember(owner = "client!mba", name = "finalize", descriptor = "()V", line = 502)
    ...
    @OriginalMember(owner = "client!mba", name = "h", descriptor = "(I)V", line = 511)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "([BIIII)V", line = 524)
    ...
    @OriginalMember(owner = "client!mba", name = "<init>", descriptor = "(Loaa;ILpb;Loea;IZ)V", line = 625)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(IB)V", line = 644)
