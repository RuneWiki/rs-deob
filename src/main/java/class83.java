...
public class class83 extends class436 {
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(IILeb;)V", line = 3)
    ...
    @OriginalMember(owner = "client!d", name = "f", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!d", name = "e", descriptor = "(B)V", line = 209)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(BI)I", line = 220)
    ...
    @OriginalMember(owner = "client!d", name = "g", descriptor = "(I)V", line = 232)
    ...
    @OriginalMember(owner = "client!d", name = "<init>", descriptor = "()V", line = 452)
    public class83() {
        super(1, true);
    }

    @OriginalMember(owner = "client!d", name = "b", descriptor = "(BI)[I", line = 258)
    ...
    @OriginalMember(owner = "client!d", name = "d", descriptor = "(I)V", line = 280)
    ...
    @OriginalMember(owner = "client!d", name = "h", descriptor = "(I)V", line = 304)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(II)[I", line = 374)
    ...
    @OriginalMember(owner = "client!d", name = "i", descriptor = "(I)V", line = 430)
