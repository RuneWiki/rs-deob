...
public class class83 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ILol;)V", line = 8)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(B)Lol;", line = 27)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IIII)Z", line = 46)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(I)Lol;", line = 61)
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(B)Lol;", line = 83)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ZLjava/lang/String;I)I", line = 138)
    ...
    @OriginalMember(owner = "client!ju", name = "c", descriptor = "(B)V", line = 149)
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "()V", line = 187)
    public class83() {
        this.field1725.field3032 = this.field1725;
        this.field1725.field3035 = this.field1725;
    }

    @OriginalMember(owner = "client!ju", name = "d", descriptor = "(B)V", line = 179)
