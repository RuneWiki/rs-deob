...
public class class83 extends class66 {
    ...
    @OriginalMember(owner = "client!kb", name = "c", descriptor = "(Lfp;)V", line = 7)
    ...
    @OriginalMember(owner = "client!kb", name = "c", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!kb", name = "d", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(III)V", line = 111)
    ...
    @OriginalMember(owner = "client!kb", name = "c", descriptor = "(II)Ltp;", line = 138)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(B)V", line = 178)
