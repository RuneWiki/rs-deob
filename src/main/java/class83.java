...
public class class83 extends class719 {
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(ZLb;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!aw", name = "h", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "(Lsha;Luq;)V", line = 249)
    ...
    @OriginalMember(owner = "client!aw", name = "g", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!aw", name = "e", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!aw", name = "c", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!aw", name = "b", descriptor = "(B)Z", line = 161)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(BILwc;)V", line = 172)
    ...
    @OriginalMember(owner = "client!aw", name = "c", descriptor = "(B)V", line = 211)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(III)V", line = 227)
    ...
    @OriginalMember(owner = "client!aw", name = "i", descriptor = "(I)V", line = 239)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(ZZ)V", line = 277)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(IZ)V", line = 287)
