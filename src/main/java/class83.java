...
public class class83 implements class204 {
    ...
    @OriginalMember(owner = "client!lp", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(JZ)Z", line = 18)
    ...
    @OriginalMember(owner = "client!lp", name = "d", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Z)I", line = 54)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Ljava/lang/String;BLjava/lang/Class;Ljava/lang/Object;)Z", line = 67)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(I)I", line = 96)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(BI)I", line = 111)
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(II)I", line = 139)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IZ)V", line = 156)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;I)Ljava/lang/Object;", line = 348)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ILjava/lang/Class;Ljava/lang/String;Ljava/lang/Object;)I", line = 370)
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(B)V", line = 395)
