...
public class class83 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ZII)Z", line = 14)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IBI)Z", line = 25)
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(III)Z", line = 33)
    ...
    @OriginalMember(owner = "client!rc", name = "c", descriptor = "(III)Z", line = 43)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(BII)Z", line = 53)
    ...
    @OriginalMember(owner = "client!rc", name = "d", descriptor = "(III)Z", line = 63)
    ...
    @OriginalMember(owner = "client!rc", name = "e", descriptor = "(III)Z", line = 73)
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(BII)Z", line = 83)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IIB)Z", line = 93)
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(IIB)Z", line = 103)
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(IBI)Z", line = 113)
    ...
    @OriginalMember(owner = "client!rc", name = "f", descriptor = "(III)Z", line = 123)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IZI)Z", line = 133)
    ...
    @OriginalMember(owner = "client!rc", name = "c", descriptor = "(IIB)Z", line = 144)
    public static final boolean method669(int arg0, int arg1, byte arg2) {
        int var3 = 37 % ((2 - arg2) / 52);
        return false;
    }

    @OriginalMember(owner = "client!rc", name = "d", descriptor = "(IIB)Z", line = 152)
    ...
    @OriginalMember(owner = "client!rc", name = "c", descriptor = "(IBI)Z", line = 162)
    ...
    @OriginalMember(owner = "client!rc", name = "d", descriptor = "(IBI)Z", line = 178)
    ...
    @OriginalMember(owner = "client!rc", name = "g", descriptor = "(III)Z", line = 188)
    ...
    @OriginalMember(owner = "client!rc", name = "h", descriptor = "(III)Z", line = 203)
    public static final boolean method674(int arg0, int arg1, int arg2) {
        int var3 = -14 / ((arg0 - 49) / 62);
        return (arg2 & 0x400) != 0 && (arg1 & 0x37) != 0;
    }

    @OriginalMember(owner = "client!rc", name = "i", descriptor = "(III)Z", line = 211)
    ...
    @OriginalMember(owner = "client!rc", name = "c", descriptor = "(BII)Z", line = 221)
    ...
    @OriginalMember(owner = "client!rc", name = "j", descriptor = "(III)Z", line = 231)
    ...
    @OriginalMember(owner = "client!rc", name = "k", descriptor = "(III)Z", line = 241)
    ...
    @OriginalMember(owner = "client!rc", name = "d", descriptor = "(BII)Z", line = 253)
    ...
    @OriginalMember(owner = "client!rc", name = "l", descriptor = "(III)Z", line = 263)
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(IZI)Z", line = 273)
    ...
    @OriginalMember(owner = "client!rc", name = "m", descriptor = "(III)Z", line = 283)
    ...
    @OriginalMember(owner = "client!rc", name = "n", descriptor = "(III)Z", line = 293)
    ...
    @OriginalMember(owner = "client!rc", name = "o", descriptor = "(III)Z", line = 303)
    public static final boolean method684(int arg0, int arg1, int arg2) {
        return arg0 == 8320 ? (arg1 & 0x18) != 0 | (arg1 & 0x220) == 544 : true;
    }

    @OriginalMember(owner = "client!rc", name = "p", descriptor = "(III)Z", line = 314)
