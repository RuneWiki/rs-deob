...
public class class83 extends IOException {
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IIII)I", line = 3)
    ...
    @OriginalMember(owner = "client!qu", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 22)
    public class83(String arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IFFF)F", line = 29)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IIBIII)V", line = 43)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(Z)V", line = 73)
