...
public class class83 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Lob;I)V", line = 19)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(BII)Lmq;", line = 445)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(I)V", line = 469)
