...
public class class83 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(ILtq;IIIIIIZI)V")
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(ILtq;B)Z")
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IILnd;)V")
    ...
    @OriginalMember(owner = "client!bt", name = "<init>", descriptor = "(I[Lvr;IIII)V")
