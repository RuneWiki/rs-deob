...
public class class83 extends class189 {
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "()V", line = 10)
    public static void method639() {
        field1037 = null;
    }

    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(II)V", line = 14)
    ...
    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "(II[IZ)V", line = 59)
