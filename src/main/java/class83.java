...
public class class83 {
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "([II[III)V")
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "([Ljava/lang/Object;I[Ljava/lang/Object;II)V")
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "([BI[BII)V")
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "([FI[FII)V")
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "([SI[SII)V")
