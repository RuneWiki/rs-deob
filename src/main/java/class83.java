...
public class class83 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(BII)I", line = 3)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(BLjava/lang/Throwable;Ljava/lang/String;)V", line = 27)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lae;Lae;I)V", line = 84)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ILjava/lang/String;B)I", line = 102)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ZIII)Ljava/lang/String;", line = 118)
