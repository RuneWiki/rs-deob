...
public class class83 {
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(BLal;)V")
    ...
    @OriginalMember(owner = "client!dha", name = "c", descriptor = "(I)Lal;")
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(BLjs;)V")
    ...
    @OriginalMember(owner = "client!dha", name = "d", descriptor = "(I)Lal;")
    ...
    @OriginalMember(owner = "client!dha", name = "b", descriptor = "(Z)Lal;")
