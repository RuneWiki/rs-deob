...
public class class46 {
    ...
    @OriginalMember(owner = "client!RPRWOACX", name = "c", descriptor = "[LRPRWOACX;")
    public static class46[] field1339;

    @OriginalMember(owner = "client!RPRWOACX", name = "a", descriptor = "(ILINOFEYKQ;)V")
    ...
    @OriginalMember(owner = "client!RPRWOACX", name = "a", descriptor = "(ZLNHEPCMLW;)V")
    ...
    @OriginalMember(owner = "client!RPRWOACX", name = "b", descriptor = "(I)LCSGBDGDY;")
    ...
    @OriginalMember(owner = "client!RPRWOACX", name = "a", descriptor = "(Z)LCSGBDGDY;")
