...
public class class46 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Lap;ZLap;ZI)Lnf;")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IILap;Lap;)Lnf;")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Lbp;ILbp;)V")
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(Lno;Lmf;)V")
