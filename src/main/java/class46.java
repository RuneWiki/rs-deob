...
public class class46 extends class198 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Lza;J)Z")
    ...
    @OriginalMember(owner = "client!dl", name = "c", descriptor = "()Leu;")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Lza;J[Lsu;[Lop;Z)V")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "([Lop;Z)V")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Lza;[Lsu;Z)V")
