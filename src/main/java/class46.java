...
public class class46 extends class391 implements class83 {
    ...
    @OriginalMember(owner = "client!lu", name = "b", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IIZLr;)Z")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Lr;Z)V")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Lr;IZI)Ldg;")
    ...
    @OriginalMember(owner = "client!lu", name = "c", descriptor = "(Lr;I)Lifa;")
    ...
    @OriginalMember(owner = "client!lu", name = "<init>", descriptor = "(Lr;Llt;IIIIIZIIII)V")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IILr;)Lda;")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Lr;I)Lhr;")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(BLr;)V")
