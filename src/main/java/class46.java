...
public class class46 extends class521 {
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(Lza;III)Z")
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(ILza;I)Z")
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(Lza;IIILps;IZ)V")
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(ILza;)V")
    ...
    @OriginalMember(owner = "client!pv", name = "b", descriptor = "(ILza;)Lhp;")
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(ILju;)V")
    ...
    @OriginalMember(owner = "client!pv", name = "k", descriptor = "(I)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!pv", name = "b", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
