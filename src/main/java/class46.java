...
public class class46 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(II)V", line = 26)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(BI)Lvc;", line = 48)
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(II)V", line = 92)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ILje;IB)V", line = 103)
    ...
    @OriginalMember(owner = "client!mf", name = "c", descriptor = "(II)V", line = 140)
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lgp;IZLui;Lui;)V", line = 253)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ZB)V", line = 180)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ZZ)V", line = 197)
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(I)V", line = 214)
