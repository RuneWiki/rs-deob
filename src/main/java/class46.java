...
public class class46 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IBII)Lqr;", line = 4)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(B)Lrm;", line = 24)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(IIIIB)V", line = 57)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IIIIIIIIBI)V", line = 69)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(Lqr;I)V", line = 143)
