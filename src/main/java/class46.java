...
public class class46 {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(DZ)V", line = 62)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(BIIIIII)Lqe;", line = 88)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ILko;ZLkh;)V", line = 111)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(BCLjava/lang/String;)[Ljava/lang/String;", line = 224)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ZILpg;ZLpg;II)I", line = 260)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(III)V", line = 295)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Z)V", line = 311)
    ...
    @OriginalMember(owner = "client!u", name = "b", descriptor = "(Z)V", line = 398)
