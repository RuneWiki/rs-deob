...
public class class46 {
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "(IIIIIIIIIZI)V", line = 30)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(I)V", line = 55)
