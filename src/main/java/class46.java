...
public class class46 {
    ...
    @OriginalMember(owner = "client!OOTLZHQB", name = "f", descriptor = "LAGCGSOQI;")
    private class1 field1090 = new class1();

    @OriginalMember(owner = "client!OOTLZHQB", name = "j", descriptor = "LBOZWYCIO;")
    ...
    @OriginalMember(owner = "client!OOTLZHQB", name = "i", descriptor = "LBVBAURNI;")
    ...
    @OriginalMember(owner = "client!OOTLZHQB", name = "a", descriptor = "(J)LAGCGSOQI;")
    ...
    @OriginalMember(owner = "client!OOTLZHQB", name = "a", descriptor = "(JLAGCGSOQI;B)V")
