...
public class class46 extends class304 implements class620 {
    ...
    @OriginalMember(owner = "client!hia", name = "<init>", descriptor = "(Lck;Lem;Lew;II)V")
    ...
    @OriginalMember(owner = "client!hia", name = "h", descriptor = "(I)I")
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "([BIBIIILem;II)V")
    ...
    @OriginalMember(owner = "client!hia", name = "<init>", descriptor = "(Lck;Lem;II[BII)V")
    ...
    @OriginalMember(owner = "client!hia", name = "<init>", descriptor = "(Lck;Lem;II[FII)V")
    ...
    @OriginalMember(owner = "client!hia", name = "<init>", descriptor = "(Lck;II[III)V")
    ...
    @OriginalMember(owner = "client!hia", name = "i", descriptor = "(I)V")
