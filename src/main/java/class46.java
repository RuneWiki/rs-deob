...
public abstract class class46 {
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(I)I", line = 8)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(IIZI)V", line = 23)
    ...
    @OriginalMember(owner = "client!jea", name = "<init>", descriptor = "(IIIII)V", line = 290)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(Z)V", line = 198)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(B)V", line = 218)
    ...
    @OriginalMember(owner = "client!jea", name = "d", descriptor = "(I)V", line = 276)
