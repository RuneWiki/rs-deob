...
public class class46 implements class233 {
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IBILjaclib/memory/Source;)Z")
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(Lcka;Z)V")
