...
public class class46 extends class383 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(ZII[I)V", line = 24)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IIII)Z", line = 38)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IZI)Z", line = 57)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Ljava/lang/String;ZJIIIZILjava/lang/String;ZZI)V", line = 72)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(ILya;I)Z", line = 159)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(BII)Z", line = 568)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(II[II)V", line = 586)
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(IIIIIIIII)V", line = 608)
