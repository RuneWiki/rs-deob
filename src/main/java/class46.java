...
public class class46 {
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(ZILko;)V", line = 4)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "(Lnf;Lom;Lkk;IIIII)V", line = 154)
    ...
    @OriginalMember(owner = "client!bp", name = "b", descriptor = "(I)V", line = 143)
