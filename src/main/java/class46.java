...
public abstract class class46 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IIII)I", line = 27)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(II)I", line = 61)
