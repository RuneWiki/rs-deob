...
public class class46 extends class66 implements Runnable {
    ...
    @OriginalMember(owner = "client!wba", name = "run", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(BI)V", line = 30)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(IBII)I", line = 76)
    ...
    @OriginalMember(owner = "client!wba", name = "<init>", descriptor = "(Lvaa;)V", line = 133)
    public class46(class437 arg0) {
        this.field622 = arg0;
    }

    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!wba", name = "b", descriptor = "(B)V", line = 117)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(IBI[IIIII)V", line = 141)
