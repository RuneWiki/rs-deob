...
public class class46 extends class171 implements class21 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "([BIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(II)I", line = 22)
    public static final int method288(int arg0, int arg1) {
        return class180.field2647 != null ? class180.field2647[arg0][arg1] & 255 : 0;
    }

    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(I)I", line = 25)
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(Lod;I[BI)V", line = 61)
    public class46(class349 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field728 = arg1;
    }

    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(Lod;ILjaggl/memory/NativeBuffer;)V", line = 69)
    public class46(class349 arg0, int arg1, NativeBuffer arg2) {
        super(arg0, arg2);
        this.field728 = arg1;
    }

    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(B)I", line = 77)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ZI)V", line = 88)
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(II)V", line = 104)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Z)J", line = 115)
