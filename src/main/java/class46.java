...
public class class46 {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "()Lfp;")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Lra;II)Lu;")
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "(Lbk;)V")
