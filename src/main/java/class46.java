...
public class class46 {
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(ILfha;)V")
    ...
    @OriginalMember(owner = "client!hj", name = "b", descriptor = "(I)Ltq;")
    ...
    @OriginalMember(owner = "client!hj", name = "<init>", descriptor = "(Lfha;)V")
    public class46(class522 arg0) {
        this.field668 = arg0;
    }

    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(B)Ltq;")
