...
public class class46 extends class58 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(B)Lgfa;")
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ILaa;IIILvo;BIJ)V")
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lml;I)V")
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(FILgfa;Lgfa;)Z")
