...
public class class46 extends class34 {
    ...
    @OriginalMember(owner = "client!lu", name = "c", descriptor = "(Loa;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!lu", name = "finalize", descriptor = "()V", line = 24)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(II)V", line = 36)
    ...
    @OriginalMember(owner = "client!lu", name = "c", descriptor = "(I)Z", line = 75)
    ...
    @OriginalMember(owner = "client!lu", name = "d", descriptor = "(I)I", line = 86)
    public final int method270(int arg0) {
        ++field649;
        return arg0 != 2495 ? 85 : this.field655;
    }

    @OriginalMember(owner = "client!lu", name = "b", descriptor = "(II)V", line = 97)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(ILoa;II)Lba;", line = 128)
    ...
    @OriginalMember(owner = "client!lu", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 145)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(B)V", line = 172)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(I)V", line = 188)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IILoa;I)Z", line = 201)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(ZLq;Lba;Loa;)V", line = 212)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(BII)Z", line = 246)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IILoa;ILcq;ZI)V", line = 315)
    ...
    @OriginalMember(owner = "client!lu", name = "d", descriptor = "(Loa;I)Lcd;", line = 326)
    ...
    @OriginalMember(owner = "client!lu", name = "d", descriptor = "(B)V", line = 355)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(ILoo;Loa;ILkq;ILdt;I)V", line = 368)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Loa;B)Lpl;", line = 422)
