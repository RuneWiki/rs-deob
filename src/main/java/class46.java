...
public class class46 {
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "(I)Lwk;")
    ...
    @OriginalMember(owner = "client!cja", name = "b", descriptor = "(I)Lwk;")
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "(JI)Lwk;")
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "(JLwk;B)V")
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "([Lwk;I)I")
    ...
    @OriginalMember(owner = "client!cja", name = "b", descriptor = "(B)Lwk;")
