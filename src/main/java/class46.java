...
public class class46 {
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(I)Lpca;", line = 3)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(B)Lpca;", line = 24)
    ...
    @OriginalMember(owner = "client!wba", name = "b", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Lpca;I)V", line = 58)
    ...
    @OriginalMember(owner = "client!wba", name = "c", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!wba", name = "d", descriptor = "(I)Lpca;", line = 104)
    ...
    @OriginalMember(owner = "client!wba", name = "e", descriptor = "(I)I", line = 128)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Lwba;I)V", line = 165)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(BLpca;)V", line = 176)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Lpca;ILwba;)V", line = 197)
    ...
    @OriginalMember(owner = "client!wba", name = "b", descriptor = "(B)Z", line = 219)
    ...
    @OriginalMember(owner = "client!wba", name = "<init>", descriptor = "()V", line = 235)
    public class46() {
        this.field716.field9382 = this.field716;
        this.field716.field9384 = this.field716;
    }

    @OriginalMember(owner = "client!wba", name = "f", descriptor = "(I)Lpca;", line = 244)
    ...
    @OriginalMember(owner = "client!wba", name = "c", descriptor = "(B)Lpca;", line = 263)
