...
public class class46 extends class56 {
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "([[II)V", line = 19)
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "(BI)[[I", line = 69)
    ...
    @OriginalMember(owner = "client!cja", name = "c", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "(II)[I", line = 144)
    ...
    @OriginalMember(owner = "client!cja", name = "d", descriptor = "(I)Z", line = 167)
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "(BILes;)V", line = 179)
