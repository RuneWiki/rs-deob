...
public class class46 extends class58 {
    ...
    @OriginalMember(owner = "client!QDXHSLSL", name = "ub", descriptor = "LLPTCUHOU;")
    public class36 field1140;

    @OriginalMember(owner = "client!QDXHSLSL", name = "a", descriptor = "(I)LVHYCWIPJ;")
    ...
    @OriginalMember(owner = "client!QDXHSLSL", name = "b", descriptor = "(I)LVHYCWIPJ;")
