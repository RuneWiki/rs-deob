...
public class class46 {
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(I)Ljda;", line = 3)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Lvk;BIIII)Ljava/awt/Frame;", line = 33)
    ...
    @OriginalMember(owner = "client!kaa", name = "b", descriptor = "(I)Ljava/lang/String;", line = 103)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(ZLjava/lang/String;)I", line = 124)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(ILeq;JIIIIZ)V", line = 147)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(JLjda;I)V", line = 168)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(JZ)Ljda;", line = 193)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(III)Lwr;", line = 223)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(B)V", line = 239)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(BII)Ljn;", line = 256)
    ...
    @OriginalMember(owner = "client!kaa", name = "<init>", descriptor = "(I)V", line = 281)
