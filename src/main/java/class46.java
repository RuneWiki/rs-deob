...
public class class46 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ZIILnk;)V", line = 8)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(B)Ltl;", line = 33)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(I)Ltl;", line = 57)
    ...
    @OriginalMember(owner = "client!wc", name = "c", descriptor = "(I)Ltl;", line = 102)
    ...
    @OriginalMember(owner = "client!wc", name = "d", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ILtl;)V", line = 131)
