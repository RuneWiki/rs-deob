...
public class class46 extends class33 implements class438 {
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(Lqa;Z)V")
    ...
    @OriginalMember(owner = "client!wf", name = "b", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(ILqa;)Llb;")
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(BILqa;)Lr;")
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(BLqa;)Led;")
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(ILqa;IIZLse;I)V")
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(ILqa;IB)Z")
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "(IIILwaa;)V")
