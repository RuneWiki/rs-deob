...
public abstract class class46 extends class29 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(III)V", line = 10)
    ...
    @OriginalMember(owner = "client!kl", name = "b", descriptor = "(II)Z", line = 25)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IZIIZ)V", line = 38)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IIIII)V", line = 61)
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "(IIIZZ)V", line = 114)
    ...
    @OriginalMember(owner = "client!kl", name = "g", descriptor = "(I)V", line = 103)
