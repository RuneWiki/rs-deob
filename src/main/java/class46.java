...
public class class46 extends class431 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(III)Ljava/lang/String;", line = 7)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IBLjava/lang/String;Lkd;)Lrm;", line = 49)
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "()V", line = 75)
    public class46() {
    }

    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 96)
