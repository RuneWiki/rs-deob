...
public class class46 extends class381 {
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(Lda;IIZ[[BI)V", line = 17)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(ILsd;IIIIIIIII)Z", line = 36)
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(Lda;II)V", line = 432)
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(Lda;IIZ[[I)V", line = 450)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IIIIB)V", line = 400)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(I)V", line = 414)
