...
public class class46 {
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(ILr;)V", line = 4)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "([Lvv;II)V", line = 56)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Lhb;BIIB)V", line = 95)
    ...
    @OriginalMember(owner = "client!wba", name = "<init>", descriptor = "(Llj;J[Ln;)V", line = 134)
    public class46(class565 arg0, long arg1, class17[] arg2) {
        this.field553 = arg0;
        this.field552 = arg1;
    }

    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(ILin;)Ljava/lang/String;", line = 145)
    ...
    @OriginalMember(owner = "client!wba", name = "finalize", descriptor = "()V", line = 167)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(I)V", line = 180)
