...
@OriginalClass("client!OHPTKXPC")
public class class46 {

    @OriginalMember(owner = "client!OHPTKXPC", name = "a", descriptor = "LZFYYAYEX;")
    private static class70 field1210 = new class70();

    @OriginalMember(owner = "client!OHPTKXPC", name = "a", descriptor = "([BI[BII)I")
    ...
    @OriginalMember(owner = "client!OHPTKXPC", name = "a", descriptor = "(LZFYYAYEX;)V")
    ...
    @OriginalMember(owner = "client!OHPTKXPC", name = "b", descriptor = "(LZFYYAYEX;)V")
    ...
    @OriginalMember(owner = "client!OHPTKXPC", name = "c", descriptor = "(LZFYYAYEX;)B")
    private static byte method426(class70 arg0) {
        return (byte) method428(8, arg0);
    }

    @OriginalMember(owner = "client!OHPTKXPC", name = "d", descriptor = "(LZFYYAYEX;)B")
    private static byte method427(class70 arg0) {
        return (byte) method428(1, arg0);
    }

    @OriginalMember(owner = "client!OHPTKXPC", name = "a", descriptor = "(ILZFYYAYEX;)I")
    ...
    @OriginalMember(owner = "client!OHPTKXPC", name = "e", descriptor = "(LZFYYAYEX;)V")
    ...
    @OriginalMember(owner = "client!OHPTKXPC", name = "a", descriptor = "([I[I[I[BIII)V")
