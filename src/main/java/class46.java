...
public class class46 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Ltt;I)I", line = 32)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(II)Lca;", line = 72)
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(ILkea;Lkea;)V", line = 111)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IZLqb;)V", line = 133)
