...
public class class46 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(III)Z", line = 17)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(II)Lah;", line = 35)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Z)V", line = 95)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(Lgca;Ld;)V", line = 107)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(II)Z", line = 118)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(B)V", line = 129)
