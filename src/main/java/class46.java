...
public class class46 extends class610 {
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(ZLkw;Z)V")
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(ZZ)V")
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(IILit;)V")
    ...
    @OriginalMember(owner = "client!aea", name = "<init>", descriptor = "(Len;)V")
