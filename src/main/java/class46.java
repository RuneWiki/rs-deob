...
public class class46 {
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(II)I", line = 27)
