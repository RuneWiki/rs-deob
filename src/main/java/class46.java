...
public class class46 extends class85 {
    ...
    @OriginalMember(owner = "client!ee", name = "Q", descriptor = "Lvg;")
    public static class200 field955 = null;

    @OriginalMember(owner = "client!ee", name = "X", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ee", name = "ab", descriptor = "Loh;")
    public static class138 field965;

    @OriginalMember(owner = "client!ee", name = "S", descriptor = "Ldb;")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(BILja;)V")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ILja;)V")
