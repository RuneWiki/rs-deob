...
public class class46 extends class457 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ILou;IIB)V")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(B[Lec;I)V")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ILhn;I)V")
