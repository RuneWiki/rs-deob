...
public class class46 {
    ...
    @OriginalMember(owner = "client!PTKBILNJ", name = "g", descriptor = "[LPTKBILNJ;")
    public static class46[] field1223;

    @OriginalMember(owner = "client!PTKBILNJ", name = "a", descriptor = "(ILTXPLZUUI;)V")
    ...
    @OriginalMember(owner = "client!PTKBILNJ", name = "a", descriptor = "(LPKHWFJLM;Z)V")
    ...
    @OriginalMember(owner = "client!PTKBILNJ", name = "a", descriptor = "(I)LPSGMMDJS;")
    ...
    @OriginalMember(owner = "client!PTKBILNJ", name = "b", descriptor = "(B)LPSGMMDJS;")
