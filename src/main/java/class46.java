...
public class class46 {
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(III)I", line = 12)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(I[B)V", line = 26)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(ZIII)I", line = 195)
    ...
    @OriginalMember(owner = "client!qn", name = "<init>", descriptor = "([BI)V", line = 217)
