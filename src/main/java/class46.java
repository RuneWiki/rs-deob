...
public class class46 extends class567 {
    ...
    @OriginalMember(owner = "client!dm", name = "e", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(ILjava/lang/String;I)I", line = 14)
    ...
    @OriginalMember(owner = "client!dm", name = "c", descriptor = "(I)[B", line = 26)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Z)I", line = 54)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IB)Lol;", line = 72)
    ...
    @OriginalMember(owner = "client!dm", name = "f", descriptor = "(I)V", line = 98)
