...
public class class46 extends class325 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(II)Ltg;", line = 4)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(BI)[I", line = 32)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Z)V", line = 74)
    ...
    @OriginalMember(owner = "client!vo", name = "e", descriptor = "(B)V", line = 94)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Laj;I)V", line = 114)
    ...
    @OriginalMember(owner = "client!vo", name = "f", descriptor = "(B)V", line = 145)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Ljp;IB)V", line = 157)
    ...
    @OriginalMember(owner = "client!vo", name = "b", descriptor = "(I)I", line = 185)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Ljava/lang/String;IC)[Ljava/lang/String;", line = 198)
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "()V", line = 421)
    public class46() {
        super(1, true);
    }

    @OriginalMember(owner = "client!vo", name = "g", descriptor = "(B)V", line = 237)
    ...
    @OriginalMember(owner = "client!vo", name = "b", descriptor = "(II)[I", line = 424)
