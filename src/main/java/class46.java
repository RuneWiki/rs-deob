...
public class class46 extends class354 {
    ...
    @OriginalMember(owner = "client!qr", name = "g", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(IIIIIII)V", line = 48)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "()V", line = 245)
    public class46() {
        super(1, true);
    }

    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Lei;B)V", line = 104)
    ...
    @OriginalMember(owner = "client!qr", name = "c", descriptor = "(B)V", line = 154)
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(BI)[I", line = 165)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Lnj;II)V", line = 256)
