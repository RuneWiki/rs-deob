...
public class class46 implements class543 {
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!kaa", name = "c", descriptor = "(Z)Ljm;")
    ...
    @OriginalMember(owner = "client!kaa", name = "<init>", descriptor = "(Lhl;Ljm;Z)V")
