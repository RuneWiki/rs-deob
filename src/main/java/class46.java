...
public abstract class class46 {
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(I)Lmj;")
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(IZZ)Lkj;")
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ILgt;)V")
