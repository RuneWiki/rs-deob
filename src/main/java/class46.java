...
public class class46 extends class277 {
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "(Lqj;)V")
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(IILrg;)V")
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(IBLkp;I)V")
