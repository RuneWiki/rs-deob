...
public class class46 extends class395 {
    ...
    @OriginalMember(owner = "client!lu", name = "<init>", descriptor = "(Lve;Lll;[Lfda;[I[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(CIIIZLua;II)V", line = 45)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "([B[IIIIIIII)V", line = 110)
    ...
    @OriginalMember(owner = "client!lu", name = "OA", descriptor = "(CIIIZ)V", line = 142)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "([B[IIIIIIIIIIILua;II)V", line = 202)
