...
public class class333 {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IIILr;)V", line = 24)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(ILifa;[III[I)Lhv;", line = 523)
    ...
    @OriginalMember(owner = "client!uv", name = "toString", descriptor = "()Ljava/lang/String;", line = 580)
