...
public class class333 extends class690 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IFFFIIIIFLue;F[BI)V")
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Lcn;ILcn;F)Z")
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "(I)Lcn;")
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IIIIILha;)V")
    ...
    @OriginalMember(owner = "client!hm", name = "<init>", descriptor = "(Lpea;I)V")
