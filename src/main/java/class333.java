...
public class class333 extends class234 {
    ...
    @OriginalMember(owner = "client!qca", name = "e", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(FI)V", line = 15)
    ...
    @OriginalMember(owner = "client!qca", name = "<init>", descriptor = "(I)V", line = 34)
    public class333(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 37)
    ...
    @OriginalMember(owner = "client!qca", name = "z", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(BF)V", line = 163)
