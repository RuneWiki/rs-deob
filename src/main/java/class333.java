...
public class class333 extends class345 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(CIIIZLkf;II)V")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "([B[IIIIIIIIIIILkf;II)V")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "([B[I[IIIIIIIIIIILkf;II)V")
    ...
    @OriginalMember(owner = "client!sf", name = "<init>", descriptor = "(Lj;Lvi;[Ldk;[I[I)V")
