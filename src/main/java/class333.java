...
public class class333 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(BLkk;)Ldr;", line = 67)
