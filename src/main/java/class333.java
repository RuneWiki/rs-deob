...
public class class333 implements Runnable {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Ljava/lang/String;I)Lpj;", line = 18)
    ...
    @OriginalMember(owner = "client!mo", name = "run", descriptor = "()V", line = 39)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Lum;I)V", line = 78)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "()V", line = 129)
    public class333() {
