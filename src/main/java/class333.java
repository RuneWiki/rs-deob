...
public class class333 extends class295 {
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "(IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "(Ljava/awt/Canvas;)V", line = 25)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 67)
    public final void method476(Rectangle[] arg0, int arg1) {
        this.method536();
        ++field4653;
    }

    @OriginalMember(owner = "client!pg", name = "j", descriptor = "()V", line = 76)
    ...
    @OriginalMember(owner = "client!pg", name = "JA", descriptor = "(F)V", line = 95)
    ...
    @OriginalMember(owner = "client!pg", name = "t", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!pg", name = "i", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IBLfw;II)V", line = 159)
    ...
    @OriginalMember(owner = "client!pg", name = "w", descriptor = "()I", line = 176)
    public final int method502() {
        ++field4529;
        return 4;
    }

    @OriginalMember(owner = "client!pg", name = "d", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!pg", name = "j", descriptor = "(I)V", line = 350)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(IIII)V", line = 380)
    public final void method474(int arg0, int arg1, int arg2, int arg3) {
        ++field4676;
        this.field4720.method1146(arg0, arg3, 0, arg2, arg1);
    }

    @OriginalMember(owner = "client!pg", name = "h", descriptor = "(I)V", line = 390)
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "(II)V", line = 407)
    ...
    @OriginalMember(owner = "client!pg", name = "y", descriptor = "()V", line = 436)
    ...
    @OriginalMember(owner = "client!pg", name = "o", descriptor = "()Z", line = 447)
    public final boolean method551() {
        ++field4702;
        return true;
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(B)V", line = 455)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(II[I[I)Lta;", line = 474)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(BII)V", line = 482)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IIZ)V", line = 506)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lli;Z)V", line = 520)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lqq;IIII)Le;", line = 554)
    ...
    @OriginalMember(owner = "client!pg", name = "k", descriptor = "(I)V", line = 562)
    ...
    @OriginalMember(owner = "client!pg", name = "OA", descriptor = "()I", line = 573)
    ...
    @OriginalMember(owner = "client!pg", name = "ya", descriptor = "(I)V", line = 584)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lli;I)V", line = 601)
    ...
    @OriginalMember(owner = "client!pg", name = "k", descriptor = "()Z", line = 628)
    public final boolean method466() {
        ++field4688;
        return this.field4817 && (!this.method549() || this.field4843);
    }

    @OriginalMember(owner = "client!pg", name = "t", descriptor = "()Z", line = 636)
    public final boolean method498() {
        ++field4686;
        return true;
    }

    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(IIIIII)V", line = 645)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(Z)V", line = 661)
    public final void method524(boolean arg0) {
        ++field4583;
    }

    @OriginalMember(owner = "client!pg", name = "i", descriptor = "()Z", line = 670)
    public final boolean method542() {
        ++field4684;
        return true;
    }

    @OriginalMember(owner = "client!pg", name = "pa", descriptor = "()I", line = 679)
    public final int method473() {
        ++field4690;
        return this.field4742 + this.field4740 + this.field4739;
    }

    @OriginalMember(owner = "client!pg", name = "u", descriptor = "()Z", line = 690)
    public final boolean method475() {
        ++field4590;
        return true;
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lhf;Lhf;Lhf;Lhf;I)V", line = 699)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(I)V", line = 747)
    public final void method513(int arg0) {
        ++field4712;
        this.method1978(false);
    }

    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(B)I", line = 756)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ZIZI)V", line = 842)
    ...
    @OriginalMember(owner = "client!pg", name = "l", descriptor = "(I)V", line = 906)
    ...
    @OriginalMember(owner = "client!pg", name = "T", descriptor = "()F", line = 924)
    public final float method461() {
        ++field4654;
        return this.field4856;
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "([Le;Lc;[Lrr;I)V", line = 936)
    ...
    @OriginalMember(owner = "client!pg", name = "aa", descriptor = "()F", line = 956)
    public final float method472() {
        ++field4658;
        return this.field4841;
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lfg;Z)V", line = 966)
    ...
    @OriginalMember(owner = "client!pg", name = "d", descriptor = "(Z)V", line = 1005)
    ...
    @OriginalMember(owner = "client!pg", name = "e", descriptor = "(II)V", line = 1020)
    ...
    @OriginalMember(owner = "client!pg", name = "ZA", descriptor = "(IIIII)V", line = 1034)
    public final void method460(int arg0, int arg1, int arg2, int arg3, int arg4) {
        ++field4558;
        throw new IllegalStateException("Circle fill is not supported by the gl toolkit");
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IIIIZ)Lo;", line = 1045)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 1057)
    ...
    @OriginalMember(owner = "client!pg", name = "da", descriptor = "(FF)V", line = 1078)
    ...
    @OriginalMember(owner = "client!pg", name = "s", descriptor = "()Z", line = 1103)
    public final boolean method492() {
        ++field4640;
        return true;
    }

    @OriginalMember(owner = "client!pg", name = "l", descriptor = "()Z", line = 1114)
    public final boolean method531() {
        ++field4541;
        return false;
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(FIFF)V", line = 1122)
    ...
    @OriginalMember(owner = "client!pg", name = "m", descriptor = "(I)V", line = 1139)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Ln;)V", line = 1158)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(II)I", line = 1223)
    public final int method525(int arg0, int arg1) {
        ++field4568;
        return arg1 | arg0;
    }

    @OriginalMember(owner = "client!pg", name = "n", descriptor = "(I)V", line = 1233)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IZI[BI)Lnn;", line = 1245)
    ...
    @OriginalMember(owner = "client!pg", name = "r", descriptor = "()I", line = 1261)
    public final int method464() {
        ++field4555;
        return this.field4785;
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(FFF)V", line = 1269)
    ...
    @OriginalMember(owner = "client!pg", name = "o", descriptor = "(I)V", line = 1281)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(III)V", line = 1300)
    ...
    @OriginalMember(owner = "client!pg", name = "v", descriptor = "()Z", line = 1315)
    public final boolean method564() {
        ++field4668;
        return this.field4716.method2136(3, (byte) -57);
    }

    @OriginalMember(owner = "client!pg", name = "P", descriptor = "(IIIIII)V", line = 1324)
    ...
    @OriginalMember(owner = "client!pg", name = "f", descriptor = "(II)V", line = 1357)
    ...
    @OriginalMember(owner = "client!pg", name = "p", descriptor = "(I)V", line = 1371)
    ...
    @OriginalMember(owner = "client!pg", name = "VA", descriptor = "(IIIIII)Z", line = 1392)
    ...
    @OriginalMember(owner = "client!pg", name = "K", descriptor = "(IIIIII[BII)V", line = 1430)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IIIIII)Lks;", line = 1488)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(BI)V", line = 1496)
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "(Z)V", line = 1512)
    ...
    @OriginalMember(owner = "client!pg", name = "f", descriptor = "(I)V", line = 1527)
    public final void method494(int arg0) {
        this.method2011((byte) -97);
        ++field4666;
    }

    @OriginalMember(owner = "client!pg", name = "b", descriptor = "()Z", line = 1536)
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "(B)V", line = 1563)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IIIIIII)V", line = 1588)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ZI)V", line = 1600)
    ...
    @OriginalMember(owner = "client!pg", name = "d", descriptor = "(B)V", line = 1616)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(FBF)V", line = 1665)
    ...
    @OriginalMember(owner = "client!pg", name = "q", descriptor = "(I)V", line = 1681)
    ...
    @OriginalMember(owner = "client!pg", name = "d", descriptor = "(IIII)V", line = 1710)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(II[[I[[IIII)Lya;", line = 1719)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IZ)I", line = 1728)
    ...
    @OriginalMember(owner = "client!pg", name = "MA", descriptor = "([I)V", line = 1751)
    ...
    @OriginalMember(owner = "client!pg", name = "e", descriptor = "(Z)V", line = 1763)
    ...
    @OriginalMember(owner = "client!pg", name = "IA", descriptor = "(IIIII)V", line = 1803)
    ...
    @OriginalMember(owner = "client!pg", name = "B", descriptor = "(IFFFFF)V", line = 1823)
    ...
    @OriginalMember(owner = "client!pg", name = "e", descriptor = "(B)V", line = 1873)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IB)V", line = 1938)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ZLnn;)V", line = 1950)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ILfw;)V", line = 1972)
    ...
    @OriginalMember(owner = "client!pg", name = "e", descriptor = "()V", line = 1990)
    public final void method485() {
        this.field4720.method1148(-3);
        ++field4683;
    }

    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(Lli;I)V", line = 2001)
    ...
    @OriginalMember(owner = "client!pg", name = "d", descriptor = "()V", line = 2033)
    public final void method490() {
        ++field4663;
    }

    @OriginalMember(owner = "client!pg", name = "r", descriptor = "(I)Lgi;", line = 2041)
    ...
    @OriginalMember(owner = "client!pg", name = "z", descriptor = "()V", line = 2052)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lsh;I)V", line = 2069)
    public final void method2003(class511 arg0, int arg1) {
        OpenGL.glLoadMatrixf(arg0.method3030(false), arg1);
        ++field4629;
    }

    @OriginalMember(owner = "client!pg", name = "B", descriptor = "()Lc;", line = 2080)
    public final class512 method489() {
        ++field4689;
        return new class511();
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "([Le;Lvk;Lc;[Lrr;I)V", line = 2088)
    ...
    @OriginalMember(owner = "client!pg", name = "f", descriptor = "(B)V", line = 2097)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(III)V", line = 2108)
    ...
    @OriginalMember(owner = "client!pg", name = "sa", descriptor = "(IIII)[I", line = 2119)
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "(I)Ln;", line = 2141)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "([BIZIB)Lfw;", line = 2152)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lvk;)V", line = 2169)
    public final void method533(class334 arg0) {
        this.field4721.method2970((byte) -125, arg0, this);
        ++field4624;
    }

    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 2177)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(FFZFF)V", line = 2215)
    ...
    @OriginalMember(owner = "client!pg", name = "s", descriptor = "(I)V", line = 2230)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lli;B)V", line = 2302)
    ...
    @OriginalMember(owner = "client!pg", name = "x", descriptor = "()Z", line = 2325)
    public final boolean method549() {
        ++field4612;
        return this.field4718 != null && this.field4718.method2540(111);
    }

    @OriginalMember(owner = "client!pg", name = "ma", descriptor = "(IIIII)V", line = 2334)
    ...
    @OriginalMember(owner = "client!pg", name = "va", descriptor = "()V", line = 2355)
    ...
    @OriginalMember(owner = "client!pg", name = "u", descriptor = "(I)V", line = 2370)
    ...
    @OriginalMember(owner = "client!pg", name = "d", descriptor = "(Ljava/awt/Canvas;)V", line = 2381)
    ...
    @OriginalMember(owner = "client!pg", name = "g", descriptor = "(B)V", line = 2412)
    ...
    @OriginalMember(owner = "client!pg", name = "n", descriptor = "()V", line = 2437)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Le;Lvk;Lc;Lrr;I)V", line = 2450)
    ...
    @OriginalMember(owner = "client!pg", name = "f", descriptor = "()Z", line = 2460)
    public final boolean method519() {
        ++field4551;
        return this.field4718 != null && (~this.field4719 >= -2 || this.field4843);
    }

    @OriginalMember(owner = "client!pg", name = "ba", descriptor = "(IIII)V", line = 2469)
    ...
    @OriginalMember(owner = "client!pg", name = "s", descriptor = "(IIII)V", line = 2500)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IIIIIILta;II)V", line = 2519)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ILli;)V", line = 2550)
    ...
    @OriginalMember(owner = "client!pg", name = "AA", descriptor = "()I", line = 2571)
    public final int method520() {
        ++field4604;
        return this.field4790;
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(I[Lsa;)V", line = 2582)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "([IIIII)Lo;", line = 2604)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(BF)V", line = 2612)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IJ)V", line = 2632)
    ...
    @OriginalMember(owner = "client!pg", name = "v", descriptor = "(I)V", line = 2644)
    ...
    @OriginalMember(owner = "client!pg", name = "SA", descriptor = "(Lc;)V", line = 2670)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(ZI)V", line = 2686)
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "(III)V", line = 2708)
    ...
    @OriginalMember(owner = "client!pg", name = "h", descriptor = "(B)V", line = 2725)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lkt;[Lau;Z)Lla;", line = 2741)
    public final class306 method529(class61 arg0, class396[] arg1, boolean arg2) {
        ++field4641;
        return new class52(this, arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!pg", name = "Q", descriptor = "(III)V", line = 2751)
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "()V", line = 2774)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(BI)I", line = 2819)
    ...
    @OriginalMember(owner = "client!pg", name = "d", descriptor = "(IIIIII)V", line = 2864)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(IZ)V", line = 2898)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(II)I", line = 2915)
    public final int method459(int arg0, int arg1) {
        ++field4587;
        return arg0 & arg1 ^ arg1;
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(BIIZLjaggl/memory/NativeBuffer;)Lnn;", line = 2923)
    ...
    @OriginalMember(owner = "client!pg", name = "w", descriptor = "(I)V", line = 2938)
    ...
    @OriginalMember(owner = "client!pg", name = "d", descriptor = "(III)V", line = 2963)
    ...
    @OriginalMember(owner = "client!pg", name = "g", descriptor = "()Z", line = 3005)
    public final boolean method514() {
        ++field4619;
        return true;
    }

    @OriginalMember(owner = "client!pg", name = "i", descriptor = "(B)V", line = 3013)
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "(IZ)V", line = 3037)
    ...
    @OriginalMember(owner = "client!pg", name = "GA", descriptor = "(IIII)V", line = 3054)
    ...
    @OriginalMember(owner = "client!pg", name = "x", descriptor = "(I)V", line = 3078)
    ...
    @OriginalMember(owner = "client!pg", name = "q", descriptor = "()Lc;", line = 3093)
    public final class512 method541() {
        ++field4546;
        return this.field4722;
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lks;Lks;FLks;)Lks;", line = 3101)
    ...
    @OriginalMember(owner = "client!pg", name = "j", descriptor = "(B)V", line = 3154)
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "(ZI)V", line = 3169)
    ...
    @OriginalMember(owner = "client!pg", name = "k", descriptor = "(B)V", line = 3187)
    ...
    @OriginalMember(owner = "client!pg", name = "l", descriptor = "(B)V", line = 3199)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(I)V", line = 3228)
    ...
    @OriginalMember(owner = "client!pg", name = "y", descriptor = "(I)V", line = 3241)
    ...
    @OriginalMember(owner = "client!pg", name = "v", descriptor = "(III[I)V", line = 3252)
    ...
    @OriginalMember(owner = "client!pg", name = "f", descriptor = "(Z)V", line = 3292)
    ...
    @OriginalMember(owner = "client!pg", name = "g", descriptor = "(II)V", line = 3314)
    ...
    @OriginalMember(owner = "client!pg", name = "ra", descriptor = "(ILta;II)V", line = 3406)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IIII)V", line = 3438)
    ...
    @OriginalMember(owner = "client!pg", name = "Y", descriptor = "()I", line = 3456)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lau;Z)Lo;", line = 3467)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IIIIIIIIII)V", line = 3528)
    public final void method469(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9) {
        ++field4708;
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(BLli;)V", line = 3536)
    ...
    @OriginalMember(owner = "client!pg", name = "g", descriptor = "(Z)V", line = 3555)
    ...
    @OriginalMember(owner = "client!pg", name = "d", descriptor = "(II)V", line = 3596)
    ...
    @OriginalMember(owner = "client!pg", name = "HA", descriptor = "(IIII)V", line = 3622)
    ...
    @OriginalMember(owner = "client!pg", name = "d", descriptor = "(IZ)V", line = 3649)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ILsh;)V", line = 3666)
    ...
    @OriginalMember(owner = "client!pg", name = "z", descriptor = "(I)V", line = 3681)
    ...
    @OriginalMember(owner = "client!pg", name = "h", descriptor = "(II)I", line = 3699)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ZIII)V", line = 3729)
    ...
    @OriginalMember(owner = "client!pg", name = "A", descriptor = "()Z", line = 3741)
    public final boolean method557() {
        ++field4594;
        return false;
    }

    @OriginalMember(owner = "client!pg", name = "m", descriptor = "()Z", line = 3749)
    public final boolean method561() {
        ++field4577;
        return true;
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "()Z", line = 3760)
    public final boolean method550() {
        ++field4714;
        return true;
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Z)V", line = 3770)
    public final void method521(boolean arg0) {
        ++field4528;
    }

    @OriginalMember(owner = "client!pg", name = "h", descriptor = "()V", line = 3782)
    ...
    @OriginalMember(owner = "client!pg", name = "A", descriptor = "(I)V", line = 3826)
    ...
    @OriginalMember(owner = "client!pg", name = "B", descriptor = "(I)V", line = 3842)
    ...
    @OriginalMember(owner = "client!pg", name = "C", descriptor = "(I)V", line = 3863)
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(ILjava/awt/Canvas;Ll;ILor;)V", line = 3874)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lks;)V", line = 4075)
    public final void method480(class23 arg0) {
        ++field4609;
        this.field4860 = (class403) arg0;
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IIIIIF)Lsa;", line = 4084)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(BII)V", line = 4094)
