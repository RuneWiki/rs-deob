...
public class class333 extends class453 {
    ...
    @OriginalMember(owner = "client!vi", name = "d", descriptor = "()V", line = 10)
    public final void method1559() {
        field4777.method816(this.field4776, -18915);
    }

    @OriginalMember(owner = "client!vi", name = "a", descriptor = "()I", line = 13)
    public final int method1564() {
        return field4777.method815(this.field4776, (byte) -69);
    }

    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(Lkd;I)V", line = 15)
    public class333(class355 arg0, int arg1) {
        field4777 = arg0.method2151(false);
        this.field4776 = arg1;
    }

    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 20)
    ...
    @OriginalMember(owner = "client!vi", name = "c", descriptor = "()V", line = 23)
    public final void method1561() {
        field4777.method819(this.field4776, super.field6400);
    }

    @OriginalMember(owner = "client!vi", name = "b", descriptor = "()V", line = 27)
    public final void method1560() {
        field4777.method817(this.field4776, -10639);
    }

    @OriginalMember(owner = "client!vi", name = "e", descriptor = "()V", line = 30)
