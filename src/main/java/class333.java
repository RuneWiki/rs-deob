...
public abstract class class333 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lgf;IIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(III)Z", line = 192)
