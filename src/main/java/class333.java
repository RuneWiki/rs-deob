...
public abstract class class333 {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(BLwq;)V", line = 22)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(BII)V", line = 60)
