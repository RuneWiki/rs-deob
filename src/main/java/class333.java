...
public class class333 {
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(ILrg;ILqa;IILau;Ljk;)V")
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(IILwn;)V")
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Ltf;Ltf;I)V")
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Lwn;B)V")
