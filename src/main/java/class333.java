...
public class class333 extends class354 {
    ...
    @OriginalMember(owner = "client!wb", name = "c", descriptor = "(I)Z", line = 25)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Z)Z", line = 42)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IZ)V", line = 53)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(B)I", line = 64)
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(B)I", line = 79)
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(II)I", line = 89)
    ...
    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "(Lwo;)V", line = 105)
    public class333(class746 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "(ILwo;)V", line = 129)
    public class333(int arg0, class746 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!wb", name = "c", descriptor = "(II)V", line = 114)
