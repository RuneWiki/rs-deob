...
public class class333 {
    ...
    @OriginalMember(owner = "client!ko", name = "finalize", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "([BIII)I", line = 15)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(II[BI)V", line = 43)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(B)Ljava/io/File;", line = 61)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(B)J", line = 73)
    public final long method2069(byte arg0) throws IOException {
        return arg0 >= -73 ? 13L : this.field4976.length();
    }

    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(JI)V", line = 84)
