...
public class class333 extends class322 {
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(ILch;)V", line = 3)
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "(Z)I", line = 23)
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "(II)V", line = 34)
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IB)Z", line = 60)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(II)I", line = 70)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(B)I", line = 82)
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(Lch;)V", line = 95)
