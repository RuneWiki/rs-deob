...
public class class333 {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(BLes;I)V", line = 17)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ZLes;)V", line = 74)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ZI)V", line = 102)
