...
public class class333 extends class80 {
    ...
    @OriginalMember(owner = "client!nm", name = "b", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "()V", line = 171)
    public class333() {
        super(1, false);
    }

    @OriginalMember(owner = "client!nm", name = "c", descriptor = "(II)[[I", line = 61)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IILnn;)V", line = 136)
