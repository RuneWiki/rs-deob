...
public class class333 extends class179 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Laq;III)V", line = 44)
    ...
    @OriginalMember(owner = "client!kp", name = "c", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IIIIIII)V", line = 82)
