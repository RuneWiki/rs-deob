...
public class class333 {
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!gga", name = "d", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(Ljava/lang/Throwable;ZLjava/lang/String;)V", line = 37)
    ...
    @OriginalMember(owner = "client!gga", name = "c", descriptor = "(B)V", line = 93)
    public static void method1924(byte arg0) {
        int var1 = -68 / ((arg0 + 13) / 62);
        field4180 = null;
    }

    @OriginalMember(owner = "client!gga", name = "e", descriptor = "(I)Z", line = 110)
