...
public class class333 {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lea;IIII[S[B)V")
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(II)Lwe;")
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(I)Lge;")
    public static final class104 method2015(int arg0) {
        return (class104) field4489.method837((byte) -72, (long) arg0);
    }

    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lgf;II)V")
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lij;)V")
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lea;II)V")
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lea;)V")
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lea;IIII)V")
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lea;Lrg;IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(Lea;)Ljm;")
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(II)Lge;")
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(Lea;IIII)Ljm;")
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lea;Lqg;IIII)V")
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lea;IIIIIII[S[BZ)V")
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lgf;III)I")
