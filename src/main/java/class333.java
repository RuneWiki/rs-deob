...
public class class333 extends class297 {
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(Lcea;II)V")
    ...
    @OriginalMember(owner = "client!pba", name = "f", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(ILma;ILin;ZII)V")
