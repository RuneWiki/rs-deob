...
public class class333 extends class417 {
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(BLjba;)V", line = 61)
    ...
    @OriginalMember(owner = "client!wb", name = "c", descriptor = "(I)Ljba;", line = 79)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Z)D", line = 91)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Lgv;Lvha;IIIIILcea;)V", line = 111)
    ...
    @OriginalMember(owner = "client!wb", name = "c", descriptor = "()I", line = 214)
    public final int method1979() {
        field4507++;
        return 1;
    }

    @OriginalMember(owner = "client!wb", name = "e", descriptor = "(I)Lkw;", line = 223)
    ...
    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "(I)V", line = 514)
    public class333(int arg0) {
        this.field4491 = arg0;
    }

    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(DII)Ljba;", line = 268)
    ...
    @OriginalMember(owner = "client!wb", name = "f", descriptor = "(I)V", line = 297)
    ...
    @OriginalMember(owner = "client!wb", name = "c", descriptor = "(Z)I", line = 328)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(B)V", line = 343)
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "([III)V", line = 366)
    ...
    @OriginalMember(owner = "client!wb", name = "g", descriptor = "(I)V", line = 432)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IIII)I", line = 445)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(ZI)V", line = 462)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "()Lmha;", line = 478)
    public final class417 method1989() {
        field4502++;
        return null;
    }

    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(II)V", line = 489)
    ...
    @OriginalMember(owner = "client!wb", name = "d", descriptor = "()Lmha;", line = 503)
