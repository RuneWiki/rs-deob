...
public class class333 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Lol;)V", line = 15)
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "()V", line = 33)
    public class333() {
        this.field4722[0] = 0;
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(I)I", line = 44)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(Lol;)V", line = 63)
