...
public class class333 implements class21 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(B)Los;")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "([[[Lfba;IIZZI)Z")
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "(Ljava/lang/String;Lrt;Lcp;IIIIIIIIII)V")
