...
public class class333 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ILhm;I)V", line = 12)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "([BIBI)V", line = 139)
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(Lqi;Lc;Lch;IIIII)V", line = 162)
