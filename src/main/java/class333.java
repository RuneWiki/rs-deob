...
public class class333 extends class384 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lbia;BI)V", line = 8)
    ...
    @OriginalMember(owner = "client!lr", name = "f", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ZB)V", line = 40)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IBI)V", line = 74)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IZ)V", line = 102)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILlea;IIB)V", line = 115)
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(B)V", line = 161)
    ...
    @OriginalMember(owner = "client!lr", name = "d", descriptor = "(B)Z", line = 184)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I[I[IZILeq;)Lwg;", line = 196)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Lck;Lkha;Leb;)V", line = 229)
