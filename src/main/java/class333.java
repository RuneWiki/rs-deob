...
public class class333 extends class114 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Lnj;B)V", line = 6)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(IILnj;)V", line = 27)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(IIIB)I", line = 43)
    ...
    @OriginalMember(owner = "client!so", name = "f", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Lqa;BI)Z", line = 85)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 501)
