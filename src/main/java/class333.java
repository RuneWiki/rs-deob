...
public class class333 implements class67 {

    @OriginalMember(owner = "client!jg", name = "a", descriptor = "I")
    private int field5315 = -1;

    @OriginalMember(owner = "client!jg", name = "b", descriptor = "[I")
    private int[] field5316 = null;

    @OriginalMember(owner = "client!jg", name = "c", descriptor = "Z")
    private boolean field5317 = false;

    @OriginalMember(owner = "client!jg", name = "d", descriptor = "()V", line = 7)
    private final void method2353() {
        GL var1 = class241.field4012;
        this.field5315 = var1.glGenLists(2);
        var1.glNewList(this.field5315, 4864);
        if (this.field5316 == null) {
            ...
            if (this.field5317) {
                ...
                var1.glTexEnvi(8960, 34162, 7681);
                var1.glTexEnvi(8960, 34184, 34167);
                var1.glBindTexture(3553, class241.field4001);
                var1.glEnable(3553);
            }
            var1.glActiveTexture(33984);
        }
        var1.glEndList();
        var1.glNewList(this.field5315 + 1, 4864);
        if (this.field5316 == null) {
    ...
    @OriginalMember(owner = "client!jg", name = "c", descriptor = "()I", line = 99)
    public final int method226() {
        return 4;
    }

    @OriginalMember(owner = "client!jg", name = "<init>", descriptor = "()V", line = 147)
    public class333() {
        if (class241.field3994 && class241.field4040 >= 2) {
            this.method2354();
            GL var1 = class241.field4012;
            var1.glBindTexture(34067, this.field5316[0]);
            ...
            var1.glBindTexture(34067, this.field5316[1]);
            var1.glTexParameteri(34067, 10241, 9729);
            var1.glTexParameteri(34067, 10240, 9729);
            var1.glTexParameteri(34067, 32882, 33071);
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            var1.glBindTexture(34067, this.field5316[2]);
            var1.glTexParameteri(34067, 10241, 9729);
            var1.glTexParameteri(34067, 10240, 9729);
            var1.glTexParameteri(34067, 32882, 33071);
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            this.field5317 = class241.field4040 < 3;
        }
        this.method2353();
    }

    @OriginalMember(owner = "client!jg", name = "a", descriptor = "()V", line = 107)
    public final void method222() {
        GL var1 = class241.field4012;
        if (class281.field4606) {
            var1.glCallList(this.field5315 + 1);
        } else {
            var1.glTexEnvi(8960, 34184, 5890);
        }
    }

    @OriginalMember(owner = "client!jg", name = "b", descriptor = "()V", line = 118)
    public final void method224() {
        GL var1 = class241.field4012;
        class241.method1718(1);
        if (class281.field4606) {
            var1.glCallList(this.field5315);
        } else {
            var1.glTexEnvi(8960, 34184, 34167);
        }
    }

    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(I)V", line = 135)
    public final void method225(int arg0) {
        GL var2 = class241.field4012;
        if (class281.field4606 && this.field5316 != null) {
            var2.glActiveTexture(33985);
            var2.glBindTexture(34067, this.field5316[arg0 - 1]);
            var2.glActiveTexture(33984);
        }
    }

    @OriginalMember(owner = "client!jg", name = "e", descriptor = "()V", line = 186)
    private final void method2354() {
        GL var1 = class241.field4012;
        if (this.field5316 == null) {
            this.field5316 = new int[3];
            var1.glGenTextures(3, this.field5316, 0);
        }
        short var2 = 4096;
