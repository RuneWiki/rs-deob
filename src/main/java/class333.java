...
public class class333 extends class436 {
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "()V", line = 10)
    public class333() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IZLjava/awt/Color;Ljava/awt/Color;Ljava/lang/String;Ljava/awt/Color;I)V", line = 14)
    ...
    @OriginalMember(owner = "client!ug", name = "c", descriptor = "(II)V", line = 91)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IIIII)V", line = 126)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(II)[I", line = 140)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IILeb;)V", line = 224)
    ...
    @OriginalMember(owner = "client!ug", name = "f", descriptor = "(I)V", line = 270)
    ...
    @OriginalMember(owner = "client!ug", name = "g", descriptor = "(I)V", line = 295)
