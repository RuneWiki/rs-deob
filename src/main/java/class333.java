...
public class class333 extends class502 {
    ...
    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(ILeka;)V")
    ...
    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(Leka;)V")
    public class333(class492 arg0) {
        super(arg0);
        class72.method633((byte) -6, super.field6865);
    }

    @OriginalMember(owner = "client!aj", name = "d", descriptor = "(I)Lqj;")
