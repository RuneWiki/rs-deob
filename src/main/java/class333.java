...
public class class333 extends class429 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(I)Lkba;", line = 6)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(ZIZILep;)V", line = 26)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IIB)V", line = 106)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IBI)V", line = 116)
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(IBI)V", line = 135)
    ...
    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "(IIIIIII)V", line = 155)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 167)
