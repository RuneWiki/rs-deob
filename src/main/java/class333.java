...
public class class333 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "([BIII)Z", line = 6)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(II)V", line = 32)
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(II)[B", line = 74)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Z[BIII)Z", line = 153)
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(ILjm;Ljm;I)V", line = 309)
    ...
    @OriginalMember(owner = "client!ug", name = "toString", descriptor = "()Ljava/lang/String;", line = 302)
