...
public class class333 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IZIIIILkg;Lza;Ltl;ILsq;I)Le;")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lck;Lim;IIILdj;ILsq;[Lsl;ZIILsq;Lkg;Lza;Ltl;IILvk;)Le;")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lza;IILtl;Lkg;Lsq;ILim;IILdj;Lck;)Le;")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(ILkg;II)V")
