...
public class class333 extends class140 {
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Lte;Lwq;)V")
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IILjl;)V")
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(ILvp;Lqa;ILpa;IIII)V")
