...
public class class333 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ZI)Lud;", line = 15)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "(Lvd;Lga;)V", line = 154)
    public class333(class258 arg0, class243 arg1) {
        this.field5160 = arg1;
        this.field5157 = arg0;
    }

    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IIIII)V", line = 86)
    ...
    @OriginalMember(owner = "client!wp", name = "b", descriptor = "(B)V", line = 139)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ILgo;II)V", line = 166)
