...
public class class333 extends class366 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(ILgo;B)V", line = 4)
    public final void method6(int arg0, class440 arg1, byte arg2) {
        int var4 = 33 / ((31 - arg2) / 59);
        ++field5104;
    }

    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(ZZ)V", line = 16)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IIB)V", line = 28)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Ltp;Z)Z", line = 74)
    ...
    @OriginalMember(owner = "client!eu", name = "c", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(B)V", line = 202)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Ldb;Lda;ILqa;)V", line = 214)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(I)Z", line = 363)
    ...
    @OriginalMember(owner = "client!eu", name = "c", descriptor = "(B)V", line = 376)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(ZI)V", line = 423)
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(Lqg;Lpe;)V", line = 455)
