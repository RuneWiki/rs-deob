...
public class class333 extends class314 {
    ...
    @OriginalMember(owner = "client!uv", name = "h", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!uv", name = "<init>", descriptor = "()V", line = 31)
    public class333() {
        super(1, false);
    }

    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(BLqk;)Lqk;", line = 37)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(II)[I", line = 51)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(BLie;I)V", line = 84)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(Lie;I)Lio;", line = 130)
    ...
    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(IIB)I", line = 166)
    ...
    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(Z)V", line = 188)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IJ)V", line = 201)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(B)V", line = 287)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IB)[[I", line = 305)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/String;", line = 352)
