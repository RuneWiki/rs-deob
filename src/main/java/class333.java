...
public class class333 extends class143 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IIIZLfa;Lvo;)[F", line = 3)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Lvo;ILfa;)Z", line = 110)
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(III)B", line = 162)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(BI)V", line = 183)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(ZIDZLvo;IILfa;)[I", line = 196)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(II)Lai;", line = 347)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(I)V", line = 666)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Lat;Z)Z", line = 679)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(ILvo;ZIDILfa;)[I", line = 796)
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "()V", line = 933)
    public class333() {
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "(Lek;)V", line = 948)
