...
public class class333 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Len;IIIIII)V")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Len;)V")
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(Len;)V")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Len;Lsi;)Z")
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(Len;Lsi;)Z")
    public final boolean method2141(class174 arg0, class333 arg1) {
        return this.field4890 != null || this.method2139(arg0, arg1);
    }

    @OriginalMember(owner = "client!si", name = "c", descriptor = "(Len;Lsi;)V")
    ...
    @OriginalMember(owner = "client!si", name = "d", descriptor = "(Len;Lsi;)V")
