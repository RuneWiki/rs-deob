...
public class class333 extends class225 {
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(III)I", line = 12)
    ...
    @OriginalMember(owner = "client!nb", name = "d", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(ILjava/lang/String;I)Ljava/lang/String;", line = 40)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Llm;B)V", line = 61)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lps;III)V", line = 77)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(ILnj;)V", line = 101)
    ...
    @OriginalMember(owner = "client!nb", name = "c", descriptor = "(III)I", line = 122)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lnj;ZI)V", line = 148)
