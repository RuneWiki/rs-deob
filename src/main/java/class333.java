...
public class class333 implements class26 {
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(BJ)Z", line = 14)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(ZI)V", line = 26)
    ...
    @OriginalMember(owner = "client!ica", name = "b", descriptor = "(I)I", line = 53)
    public final int method111(int arg0) {
        field4762++;
        return arg0 >= -67 ? -28 : this.field4765.field2808;
    }

    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(Z)V", line = 64)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!ica", name = "c", descriptor = "(I)I", line = 118)
    ...
    @OriginalMember(owner = "client!ica", name = "<init>", descriptor = "(Leu;Lbd;)V", line = 143)
