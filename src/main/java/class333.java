...
public class class333 extends class129 {
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(IILrca;)V", line = 5)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Z)Z", line = 40)
    ...
    @OriginalMember(owner = "client!iw", name = "c", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!iw", name = "e", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!iw", name = "f", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!iw", name = "<init>", descriptor = "(Lsd;Lla;)V", line = 254)
    ...
    @OriginalMember(owner = "client!iw", name = "b", descriptor = "(B)V", line = 164)
    ...
    @OriginalMember(owner = "client!iw", name = "c", descriptor = "(B)V", line = 200)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(ZB)V", line = 219)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(IIB)V", line = 229)
    public final void method786(int arg0, int arg1, byte arg2) {
        int var4 = 26 / ((arg2 - 21) / 56);
    }

    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(B)V", line = 237)
    ...
    @OriginalMember(owner = "client!iw", name = "d", descriptor = "(I)V", line = 282)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(ZI)V", line = 303)
