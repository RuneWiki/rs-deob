...
public class class333 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IIIBI)V", line = 6)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IILje;ZIILus;II)V", line = 87)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lui;B)V", line = 140)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(I)V", line = 152)
