...
public class class333 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Lil;IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(IIIIILnr;)Lqc;", line = 94)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ILil;)V", line = 200)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Z)V", line = 231)
    ...
    @OriginalMember(owner = "client!ll", name = "b", descriptor = "(Z)V", line = 270)
