...
public class class333 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IZ)Llt;", line = 31)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(II)V", line = 82)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(BZ)V", line = 104)
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "(Ldd;IZLpj;Lpj;)V", line = 244)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IIII)Z", line = 122)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(ZB)V", line = 153)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(ZI)V", line = 172)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(I)V", line = 196)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(BI)V", line = 229)
