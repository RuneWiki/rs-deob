...
public class class333 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(ZI)Lqba;", line = 23)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(B)I", line = 61)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!pp", name = "b", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!pp", name = "c", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(Lcda;ILkea;)V", line = 152)
