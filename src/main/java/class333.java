...
public abstract class class333 extends class219 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(ZII)Lwq;", line = 4)
    ...
    @OriginalMember(owner = "client!vc", name = "b", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(BII)Z", line = 34)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IZLjava/lang/String;)V", line = 46)
    public static final void method2155(int arg0, boolean arg1, String arg2) {
        field4976++;
        class524.method3052(arg2, arg1, arg0, -1, -57);
    }

    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Lpha;I)V", line = 64)
