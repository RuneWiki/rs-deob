...
public class class186 extends class531 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IZLdca;)V")
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Lha;IJ)V")
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Lqfa;Lgo;)V")
