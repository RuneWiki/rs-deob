...
public class class186 extends class530 {
    ...
    @OriginalMember(owner = "client!oc", name = "h", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IB)V", line = 18)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(BF)V", line = 31)
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(IIIIIF)V", line = 45)
    public class186(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IIIZ)V", line = 58)
