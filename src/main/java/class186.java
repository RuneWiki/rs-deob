...
public class class186 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Lch;I)V", line = 30)
    ...
    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "([I)V", line = 64)
