...
public class class186 extends class407 implements class56 {
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "(ILtj;)V", line = 5)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(B)I", line = 18)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Ltj;I)Lri;", line = 29)
    ...
    @OriginalMember(owner = "client!he", name = "c", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(BLtj;)V", line = 78)
    ...
    @OriginalMember(owner = "client!he", name = "g", descriptor = "(I)I", line = 94)
    public final int method345(int arg0) {
        ++field2529;
        return arg0 < 14 ? -92 : this.field2551.method2479(true);
    }

    @OriginalMember(owner = "client!he", name = "b", descriptor = "(I)Z", line = 108)
    ...
    @OriginalMember(owner = "client!he", name = "d", descriptor = "(I)I", line = 125)
    public final int method116(int arg0) {
        ++field2555;
        return arg0 != 24186 ? -98 : this.field2551.field5562;
    }

    @OriginalMember(owner = "client!he", name = "a", descriptor = "(ILtj;)V", line = 136)
    ...
    @OriginalMember(owner = "client!he", name = "e", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "(B)Z", line = 165)
    ...
    @OriginalMember(owner = "client!he", name = "h", descriptor = "(I)V", line = 177)
    public static void method1238(int arg0) {
        int var1 = 68 % ((-60 - arg0) / 53);
        field2547 = null;
    }

    @OriginalMember(owner = "client!he", name = "a", descriptor = "(ILtj;II)Z", line = 188)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(III)Z", line = 208)
    ...
    @OriginalMember(owner = "client!he", name = "<init>", descriptor = "(Ltj;Lqr;IIIIIIIZIIIII)V", line = 223)
    ...
    @OriginalMember(owner = "client!he", name = "e", descriptor = "(B)V", line = 237)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IIB)Ljr;", line = 267)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(I)I", line = 292)
    ...
    @OriginalMember(owner = "client!he", name = "f", descriptor = "(B)V", line = 303)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IIIILsj;IILsf;I)V", line = 315)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Lir;I)V", line = 366)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(ILtj;BIZLkm;I)V", line = 378)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Ltj;IB)Lqb;", line = 390)
