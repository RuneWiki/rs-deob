...
public class class186 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(BI)[B", line = 3)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ZIII)I", line = 63)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(IB)V", line = 95)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(III)Log;", line = 110)
    ...
    @OriginalMember(owner = "client!fq", name = "b", descriptor = "(B)V", line = 124)
