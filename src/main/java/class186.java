...
public class class186 extends class295 {
    ...
    @OriginalMember(owner = "client!rd", name = "d", descriptor = "(I)Ljava/lang/Object;", line = 6)
    public final Object method1208(int arg0) {
        return arg0 < 98 ? (Object) null : this.field2518.get();
    }

    @OriginalMember(owner = "client!rd", name = "f", descriptor = "(I)Z", line = 16)
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "(Ljava/lang/Object;)V", line = 24)
