...
public class class186 extends class413 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Lon;B)V", line = 7)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(IIIZ)I", line = 25)
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(IIIII)V", line = 69)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(ZI)Lss;", line = 94)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(ILae;II)Z", line = 123)
    ...
    @OriginalMember(owner = "client!jg", name = "c", descriptor = "(I)V", line = 149)
