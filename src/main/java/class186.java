...
public class class186 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ILmc;)V", line = 5)
    ...
    @OriginalMember(owner = "client!o", name = "b", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Lmc;II)V", line = 78)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Z)[Lgh;", line = 99)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ZILjava/lang/String;)Z", line = 110)
    ...
    @OriginalMember(owner = "client!o", name = "c", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "([BIIIIII)V", line = 1064)
