...
public class class186 {
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "([Lof;ILjava/lang/String;Z)I", line = 7)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "([Ljava/lang/String;[I[Lof;ILjava/lang/String;)I", line = 24)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IB)I", line = 262)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IIII)I", line = 274)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Ljava/lang/String;[Lof;BI)I", line = 298)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(ICI)I", line = 329)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Ljava/lang/String;[Lof;I)I", line = 343)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(ILjava/lang/String;[Lof;II)I", line = 449)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(I)V", line = 472)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 486)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Z)V", line = 501)
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "([B)V", line = 522)
