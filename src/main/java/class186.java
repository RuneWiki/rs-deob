...
public class class186 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Lkt;IIIII)Lng;", line = 30)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ZI)S", line = 76)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(II)V", line = 104)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(ZI)Luu;", line = 117)
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Lee;ILul;)V", line = 156)
