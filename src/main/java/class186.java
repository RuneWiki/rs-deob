...
public class class186 implements class216 {
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "()V", line = 18)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(ZB)V", line = 195)
    ...
    @OriginalMember(owner = "client!qga", name = "<init>", descriptor = "(Lwu;Lqk;)V", line = 243)
    public class186(class376 arg0, class15 arg1) {
        this.field2821 = arg0;
        this.field2812 = arg1;
    }

    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(B)V", line = 252)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(BLwd;)V", line = 263)
