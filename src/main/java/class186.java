...
public class class186 extends class314 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(II)[I", line = 6)
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "([BZ)[B", line = 45)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(BLie;I)V", line = 103)
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "()V", line = 131)
    public class186() {
        this(4096);
    }
}
