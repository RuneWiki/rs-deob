...
public class class186 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "()V", line = 4)
    public static void method1013() {
        field2242 = null;
    }

    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(II)V", line = 7)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "([III)V", line = 54)
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "(II)V", line = 105)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Lqa;[II[I[I)V", line = 191)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Lqa;[II)V", line = 197)
    public static final void method1019(class206 arg0, int[] arg1, int arg2) {
        method1020(arg0, arg1, 0, arg1.length, arg2, null, null);
    }

    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Lqa;[IIII[I[I)V", line = 203)
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "()V", line = 239)
    private static final void method1021() {
        field2243 = 0;
    }

    @OriginalMember(owner = "client!hm", name = "b", descriptor = "(I)Z", line = 245)
