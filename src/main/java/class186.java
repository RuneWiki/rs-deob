...
public class class186 extends class578 {
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(Llga;)Z")
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "([I)Lvfa;")
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(Llga;II)Leia;")
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(Llga;I)Leia;")
    ...
    @OriginalMember(owner = "client!eia", name = "b", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!eia", name = "b", descriptor = "()V")
