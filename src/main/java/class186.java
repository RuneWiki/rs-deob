...
public class class186 {
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(Lrk;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IZ)V", line = 14)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(B)Ljd;", line = 57)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!uw", name = "b", descriptor = "(I)Ljd;", line = 96)
    ...
    @OriginalMember(owner = "client!uw", name = "<init>", descriptor = "()V", line = 121)
    public class186() {
    }

    @OriginalMember(owner = "client!uw", name = "<init>", descriptor = "(Lrk;)V", line = 126)
