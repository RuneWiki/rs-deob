...
public class class186 extends class748 {
    ...
    @OriginalMember(owner = "client!wl", name = "<init>", descriptor = "()V", line = 4)
    public class186() {
        super(1, true);
    }

    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(BI)V", line = 11)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(II)[I", line = 25)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IIIIIIIIII)V", line = 96)
    ...
    @OriginalMember(owner = "client!wl", name = "d", descriptor = "(III)Z", line = 141)
    ...
    @OriginalMember(owner = "client!wl", name = "e", descriptor = "(III)V", line = 153)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IZLvj;)V", line = 187)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(B)V", line = 231)
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(Z)V", line = 245)
    ...
    @OriginalMember(owner = "client!wl", name = "g", descriptor = "(I)V", line = 282)
