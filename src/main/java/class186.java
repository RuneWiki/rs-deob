...
public class class186 {
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Lio;IZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Z)V", line = 168)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(ILjava/awt/Canvas;)Lfc;", line = 208)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(IIIIBLda;ZI)Lda;", line = 234)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(ILda;IIII)Lda;", line = 300)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(BII)Z", line = 455)
    ...
    @OriginalMember(owner = "client!hca", name = "b", descriptor = "(I)Lue;", line = 479)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "()V", line = 501)
    public static final void method1232() {
        class402.method2299(1, class171.field2428);
    }

    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(ILio;)V", line = 516)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(IBZI)I", line = 540)
