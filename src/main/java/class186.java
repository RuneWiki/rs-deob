...
public class class186 extends class269 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "([B[I[IIIIIIIIIIILi;II)V")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!gf", name = "g", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "([B[I[IIIIIII)V")
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(Lfg;Lgg;[Lho;[I[I)V")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(CIIIZLi;II)V")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "([B[IIIIIIIIIIILi;II)V")
