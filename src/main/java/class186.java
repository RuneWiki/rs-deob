...
public abstract class class186 extends class401 {
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(I)Z", line = 13)
    ...
    @OriginalMember(owner = "client!tw", name = "b", descriptor = "(I)I", line = 34)
    public final int method1279(int arg0) {
        field2696++;
        return arg0 == 0 ? this.field2708 : -8;
    }

    @OriginalMember(owner = "client!tw", name = "b", descriptor = "(Z)I", line = 45)
    public final int method1280(boolean arg0) {
        field2706++;
        return arg0 ? this.field2701 : 72;
    }

    @OriginalMember(owner = "client!tw", name = "c", descriptor = "(I)I", line = 56)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(B)I", line = 80)
    ...
    @OriginalMember(owner = "client!tw", name = "d", descriptor = "(I)I", line = 91)
    ...
    @OriginalMember(owner = "client!tw", name = "g", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!tw", name = "h", descriptor = "(I)F", line = 116)
    ...
    @OriginalMember(owner = "client!tw", name = "<init>", descriptor = "(IIIIIF)V", line = 130)
