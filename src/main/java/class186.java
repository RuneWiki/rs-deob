...
public class class186 extends class22 implements class232 {
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(Llj;Lnea;III[B)V")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ILrha;)V")
    public final void method211(int arg0, class455 arg1) {
        super.method211(arg0, arg1);
    }

    @OriginalMember(owner = "client!cr", name = "c", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;")
