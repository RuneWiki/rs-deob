...
public class class186 extends class90 {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Len;", line = 4)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!lt", name = "f", descriptor = "(I)I", line = 33)
    ...
    @OriginalMember(owner = "client!lt", name = "g", descriptor = "(I)J", line = 49)
    ...
    @OriginalMember(owner = "client!lt", name = "h", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Z)I", line = 85)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(III)V", line = 103)
    ...
    @OriginalMember(owner = "client!lt", name = "i", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "(II)V", line = 134)
