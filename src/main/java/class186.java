...
public class class186 {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ZLjava/lang/String;)J", line = 27)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIIIII)V", line = 106)
