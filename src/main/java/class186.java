...
public class class186 extends class43 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(II)V", line = 78)
