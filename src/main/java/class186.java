...
public class class186 {
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(IZZ)V", line = 17)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(Z)V", line = 45)
    ...
    @OriginalMember(owner = "client!qga", name = "b", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(II)Lcq;", line = 71)
    ...
    @OriginalMember(owner = "client!qga", name = "b", descriptor = "(II)V", line = 105)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!qga", name = "<init>", descriptor = "(Lsj;ILin;)V", line = 147)
