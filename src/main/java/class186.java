...
public class class186 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IZ)Lpq;")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(BLij;)V")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(BLeq;I)V")
