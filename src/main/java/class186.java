...
public class class186 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(ILdga;I)V")
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lpq;BII)Lhe;")
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Ldga;I)V")
