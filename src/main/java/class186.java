...
public class class186 extends class464 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!qg", name = "i", descriptor = "(I)[B", line = 17)
    ...
    @OriginalMember(owner = "client!qg", name = "g", descriptor = "(I)I", line = 38)
