...
public class class186 extends class120 {
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(ZIBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!dca", name = "<init>", descriptor = "(I)V", line = 28)
    public class186(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(FI)V", line = 39)
    ...
    @OriginalMember(owner = "client!dca", name = "z", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(BF)V", line = 68)
