...
public class class186 {
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(B[BIIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "([BIILjava/io/File;)V", line = 41)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(I)V", line = 58)
