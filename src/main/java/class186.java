...
public class class186 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 18)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(I)Liga;", line = 39)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(ZLjava/lang/String;I)V", line = 56)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IIZ)I", line = 137)
    ...
    @OriginalMember(owner = "client!vn", name = "toString", descriptor = "()Ljava/lang/String;", line = 159)
