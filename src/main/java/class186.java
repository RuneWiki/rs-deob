...
public class class186 {
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "()V", line = 5)
    public static final void method1159() {
        field2320 = null;
        field2313 = null;
    }

    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(Lha;IIIIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(Lha;Lcfa;)Z", line = 43)
    public final boolean method1161(class473 arg0, class186 arg1) {
        return this.field2319 != null || this.method1168(arg0, arg1);
    }

    @OriginalMember(owner = "client!cfa", name = "b", descriptor = "(Lha;Lcfa;)V", line = 52)
    ...
    @OriginalMember(owner = "client!cfa", name = "b", descriptor = "()V", line = 135)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(IIII)Z", line = 144)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(Lha;)V", line = 204)
    ...
    @OriginalMember(owner = "client!cfa", name = "c", descriptor = "(Lha;Lcfa;)V", line = 264)
    ...
    @OriginalMember(owner = "client!cfa", name = "c", descriptor = "()V", line = 352)
    public final void method1167() {
        this.field2319 = null;
    }

    @OriginalMember(owner = "client!cfa", name = "d", descriptor = "(Lha;Lcfa;)Z", line = 356)
    ...
    @OriginalMember(owner = "client!cfa", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 393)
    ...
    @OriginalMember(owner = "client!cfa", name = "b", descriptor = "(Lha;)V", line = 404)
