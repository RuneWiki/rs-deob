...
public class class186 extends class424 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(III)Lfi;", line = 8)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(IIIIIZ)V", line = 45)
