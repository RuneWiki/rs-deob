...
public class class186 extends class37 {
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(IIIIZIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!wfa", name = "b", descriptor = "(I)V", line = 211)
    ...
    @OriginalMember(owner = "client!wfa", name = "<init>", descriptor = "(I)V", line = 222)
