...
public class class186 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lfh;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(II)Z", line = 25)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(I[Lfi;I)V", line = 44)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(ILfh;I)V", line = 138)
