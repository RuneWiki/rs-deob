...
public class class186 extends class14 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IBLmd;)V", line = 56)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(B)V", line = 99)
    ...
    @OriginalMember(owner = "client!ol", name = "<init>", descriptor = "()V", line = 109)
    public class186() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IIII[FFFIIII)V", line = 114)
    ...
    @OriginalMember(owner = "client!ol", name = "d", descriptor = "(Z)V", line = 176)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IB)[I", line = 203)
