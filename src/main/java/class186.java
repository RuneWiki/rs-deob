...
public class class186 extends class379 {
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(Ljava/io/File;B)[B", line = 3)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(I)V", line = 14)
    public static void method1239(int arg0) {
        int var1 = 125 / ((arg0 - 37) / 54);
        field2252 = null;
    }

    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(Lha;IIIIILjw;IIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!hga", name = "<init>", descriptor = "(II)V", line = 50)
