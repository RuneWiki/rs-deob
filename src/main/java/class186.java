...
public class class186 extends class377 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IILji;)V", line = 9)
    ...
    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "()V", line = 104)
    public class186() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IILoa;B)V", line = 112)
    ...
    @OriginalMember(owner = "client!pk", name = "f", descriptor = "(I)V", line = 578)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(II)[I", line = 605)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Z)V", line = 819)
