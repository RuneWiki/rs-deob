...
public class class186 {
    ...
    @OriginalMember(owner = "client!dca", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!dca", name = "<init>", descriptor = "(ILcka;Lcka;I)V", line = 504)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(IZ)I", line = 27)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(BLjava/lang/String;)V", line = 81)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(III[B)Z", line = 179)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(IB)[B", line = 205)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(IZBI[B)Z", line = 284)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(ZJ)V", line = 404)
