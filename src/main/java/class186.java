...
public class class186 extends class278 {
    ...
    @OriginalMember(owner = "client!ov", name = "fa", descriptor = "(IILr;)Lr;")
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(IIILjt;)V")
    ...
    @OriginalMember(owner = "client!ov", name = "wa", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ov", name = "<init>", descriptor = "(Lgt;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!ov", name = "CA", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Lbh;[I)V")
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Lr;IIIIZ)Z")
