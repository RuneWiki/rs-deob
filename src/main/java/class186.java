...
public class class186 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(II)Ljv;", line = 5)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IB)V", line = 48)
    ...
    @OriginalMember(owner = "client!ja", name = "b", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "(Lle;ILoi;)V", line = 101)
