...
public abstract class class186 extends class205 {
    ...
    @OriginalMember(owner = "client!lia", name = "b", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(III)Z", line = 18)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(ILha;)V", line = 30)
    ...
    @OriginalMember(owner = "client!lia", name = "<init>", descriptor = "(Leq;I)V", line = 57)
