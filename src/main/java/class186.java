...
public class class186 extends class529 {
    ...
    @OriginalMember(owner = "client!pha", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!pha", name = "<init>", descriptor = "()V", line = 500)
    public class186() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pha", name = "f", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(IB)[I", line = 47)
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(I[[IIIILjava/util/Random;I)V", line = 303)
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(IBLtn;)V", line = 519)
