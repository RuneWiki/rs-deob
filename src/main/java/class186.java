...
public class class186 implements class147 {

    @OriginalMember(owner = "client!ka", name = "b", descriptor = "Z")
    private boolean field3401 = false;

    @OriginalMember(owner = "client!ka", name = "a", descriptor = "I")
    private int field3400 = -1;

    @OriginalMember(owner = "client!ka", name = "c", descriptor = "[I")
    private int[] field3402 = null;

    @OriginalMember(owner = "client!ka", name = "d", descriptor = "()V", line = 13)
    private final void method1433() {
        GL var1 = class97.field1801;
        if (this.field3402 == null) {
            this.field3402 = new int[3];
            var1.glGenTextures(3, this.field3402, 0);
        }
        short var2 = 4096;
        ...
        for (int var6 = 0; var6 < 6; var6++) {
            ...
            var1.glBindTexture(34067, this.field3402[0]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var4));
            var1.glBindTexture(34067, this.field3402[1]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var5));
            var1.glBindTexture(34067, this.field3402[2]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var3));
            class308.field5471 += var2 * 3;
        }
    }

    @OriginalMember(owner = "client!ka", name = "b", descriptor = "()I", line = 129)
    public final int method72() {
        return 4;
    }

    @OriginalMember(owner = "client!ka", name = "c", descriptor = "()V", line = 133)
    public final void method73() {
        GL var1 = class97.field1801;
        if (class126.field2340) {
            var1.glCallList(this.field3400 + 1);
        } else {
            var1.glTexEnvi(8960, 34184, 5890);
        }
    }

    @OriginalMember(owner = "client!ka", name = "a", descriptor = "()V", line = 142)
    public final void method76() {
        GL var1 = class97.field1801;
        class97.method811(1);
        if (class126.field2340) {
            var1.glCallList(this.field3400);
        } else {
            var1.glTexEnvi(8960, 34184, 34167);
        }
    }

    @OriginalMember(owner = "client!ka", name = "e", descriptor = "()V", line = 159)
    private final void method1434() {
        GL var1 = class97.field1801;
        this.field3400 = var1.glGenLists(2);
        var1.glNewList(this.field3400, 4864);
        if (this.field3402 == null) {
            var1.glTexEnvi(8960, 34184, 34167);
        } else {
            ...
            if (this.field3401) {
                ...
                var1.glTexEnvi(8960, 34162, 7681);
                var1.glTexEnvi(8960, 34184, 34167);
                var1.glBindTexture(3553, class97.field1812);
                var1.glEnable(3553);
            }
            var1.glActiveTexture(33984);
        }
        var1.glEndList();
        var1.glNewList(this.field3400 + 1, 4864);
        if (this.field3402 == null) {
            var1.glTexEnvi(8960, 34184, 5890);
        } else {
            var1.glActiveTexture(33985);
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(I)V", line = 251)
    public final void method75(int arg0) {
        GL var2 = class97.field1801;
        if (class126.field2340 && this.field3402 != null) {
            var2.glActiveTexture(33985);
            var2.glBindTexture(34067, this.field3402[arg0 - 1]);
            var2.glActiveTexture(33984);
        }
    }

    @OriginalMember(owner = "client!ka", name = "<init>", descriptor = "()V", line = 271)
    public class186() {
        if (class97.field1810 && class97.field1821 >= 2) {
            this.method1433();
            GL var1 = class97.field1801;
            var1.glBindTexture(34067, this.field3402[0]);
            ...
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            this.field3401 = class97.field1821 < 3;
        }
        this.method1434();
    }
}
