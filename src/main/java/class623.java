...
public class class623 {
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(I[FI)[F", line = 5)
    ...
    @OriginalMember(owner = "client!sk", name = "toString", descriptor = "()Ljava/lang/String;", line = 23)
    public final String toString() {
        field8468++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(II)Z", line = 31)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(I)I", line = 42)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(BLha;)V", line = 66)
    ...
    @OriginalMember(owner = "client!sk", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 153)
