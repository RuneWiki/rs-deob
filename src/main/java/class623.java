...
public class class623 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(BI)Lom;")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Lfw;III)V")
    ...
    @OriginalMember(owner = "client!bo", name = "<init>", descriptor = "(Lbt;ILkda;Lkda;)V")
