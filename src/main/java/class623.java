...
public class class623 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "()V", line = 8)
    public static final void method3491() {
        field8796 = null;
        field8792 = null;
    }

    @OriginalMember(owner = "client!ka", name = "b", descriptor = "()V", line = 15)
    public final void method3492() {
        this.field8789 = null;
    }

    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lr;Lka;)Z", line = 23)
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(Lr;Lka;)V", line = 58)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lr;)V", line = 147)
    ...
    @OriginalMember(owner = "client!ka", name = "c", descriptor = "(Lr;Lka;)V", line = 231)
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(Lr;)V", line = 314)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIII)Z", line = 378)
    ...
    @OriginalMember(owner = "client!ka", name = "d", descriptor = "(Lr;Lka;)Z", line = 436)
    public final boolean method3499(class564 arg0, class623 arg1) {
        return this.field8789 != null || this.method3493(arg0, arg1);
    }

    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lr;IIIIII)V", line = 441)
    ...
    @OriginalMember(owner = "client!ka", name = "c", descriptor = "()V", line = 466)
    ...
    @OriginalMember(owner = "client!ka", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 478)
