...
public class class623 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Ljava/lang/String;Ljava/applet/Applet;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Ljava/lang/String;[Ljava/lang/Object;ILjava/applet/Applet;)Ljava/lang/Object;", line = 13)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Ljava/applet/Applet;Ljava/lang/String;B)Ljava/lang/Object;", line = 23)
