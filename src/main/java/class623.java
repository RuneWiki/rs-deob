...
public class class623 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "([[IZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Lps;IIII[Lgea;I)V", line = 31)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(BLqa;[Lgea;[[[I)V", line = 109)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(II[Lgea;IILps;IIII)V", line = 208)
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(IIIZLul;Lar;)V", line = 2514)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Lps;IIIIIZIZII)V", line = 427)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "([[ILsa;Lsa;Lsa;IZLqa;)V", line = 557)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Lsa;Lqa;BLsa;)V", line = 870)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IIIII)V", line = 1049)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(ILli;Lqa;[[B[[BI[ZIIIIILch;[[B)V", line = 1066)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(ILsa;ILqa;Lsa;[[ILsa;)V", line = 1534)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(I)V", line = 2402)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IIIIII)V", line = 2415)
