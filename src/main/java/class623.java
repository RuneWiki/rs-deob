...
public class class623 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ILbja;Lha;)I", line = 4)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 46)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IJ)V", line = 73)
