...
public class class623 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Los;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(BLos;I)V", line = 34)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(I)Lpl;", line = 88)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(B)V", line = 150)
