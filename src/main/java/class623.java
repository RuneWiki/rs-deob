...
public class class623 extends class189 {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(FFIB[FIIFFII)V", line = 8)
    ...
    @OriginalMember(owner = "client!ua", name = "<init>", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!ua", name = "b", descriptor = "(B)V", line = 102)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Lbi;I)V", line = 113)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(III)Z", line = 140)
