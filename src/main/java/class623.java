...
public class class623 extends class37 {
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(Lrc;[I)V")
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(BIILtv;)V")
    ...
    @OriginalMember(owner = "client!vfa", name = "<init>", descriptor = "(Lok;IIII[[I[[II)V")
