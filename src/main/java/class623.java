...
public class class623 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(JLha;B)V", line = 7)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(II)V", line = 62)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(B[Ljava/lang/Object;[I)V", line = 84)
