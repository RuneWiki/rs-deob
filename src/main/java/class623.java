...
public class class623 extends OutputStream {
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(BI)Lkka;")
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(III)Luda;")
    ...
    @OriginalMember(owner = "client!ww", name = "write", descriptor = "(I)V")
