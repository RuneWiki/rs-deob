...
public class class623 implements class175 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ILjava/lang/String;IIILda;)I")
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(Lfb;Ldu;)V")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IIIZ)Lgda;")
