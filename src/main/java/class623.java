...
public class class623 extends class627 {
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(II)Z", line = 7)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!ab", name = "b", descriptor = "(II)V", line = 38)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(B)Z", line = 64)
