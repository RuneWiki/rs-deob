...
public class class623 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IBI)Z", line = 5)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "([JI[I)V", line = 17)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "()V", line = 36)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(I)V", line = 210)
