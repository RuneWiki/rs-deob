...
public class class623 extends class400 {
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(Lpj;Lpia;[Lgu;Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!md", name = "fa", descriptor = "(CIIIZ)V", line = 309)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(CIIIZLaa;II)V", line = 331)
