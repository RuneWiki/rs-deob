...
public class class623 extends class444 implements class411 {
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "(Lkfa;I[BI)V")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(ILnr;)V")
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "(Lkfa;ILjaclib/memory/Buffer;)V")
