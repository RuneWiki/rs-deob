...
public class class623 extends class339 {
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(ILio;)V", line = 5)
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "(ZII)I", line = 31)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IILjava/lang/String;)Ljava/lang/String;", line = 52)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(Lio;II)V", line = 92)
