...
public class class771 {
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(ILgga;B)V", line = 18)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(ILgga;)V", line = 48)
