...
public class class771 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(II)Lau;")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(ZILdq;III)V")
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(IILdn;)V")
