...
public class class771 extends class260 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Ljava/lang/String;II)I", line = 14)
    ...
    @OriginalMember(owner = "client!kn", name = "c", descriptor = "(II)I", line = 26)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Ljava/lang/String;I)J", line = 39)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(Lgn;)V", line = 61)
    public class771(class729 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!kn", name = "d", descriptor = "(I)I", line = 81)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(ILgn;)V", line = 94)
    public class771(int arg0, class729 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!kn", name = "b", descriptor = "(I)I", line = 97)
    ...
    @OriginalMember(owner = "client!kn", name = "d", descriptor = "(II)Lej;", line = 114)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(B)V", line = 151)
