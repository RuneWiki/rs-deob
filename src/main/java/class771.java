...
public class class771 {
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(II)Lrba;", line = 3)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!oha", name = "b", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(IIIIIILqba;Lqba;II)V", line = 80)
    ...
    @OriginalMember(owner = "client!oha", name = "c", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!oha", name = "<init>", descriptor = "(Llf;Ld;)V", line = 145)
