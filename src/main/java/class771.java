...
public class class771 implements Runnable {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Lod;B)V")
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IIILjava/lang/Class;)Lnb;")
    ...
    @OriginalMember(owner = "client!kn", name = "c", descriptor = "(B)Lbu;")
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(ILjava/lang/String;Lbu;IJ)V")
