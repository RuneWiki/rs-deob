...
public class class771 {
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(ILrv;Z)V", line = 53)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(Lrv;B)V", line = 114)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(I)V", line = 136)
