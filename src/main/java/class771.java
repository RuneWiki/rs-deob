...
public class class771 extends class211 {
    ...
    @OriginalMember(owner = "client!oha", name = "c", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!oha", name = "c", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!oha", name = "<init>", descriptor = "()V", line = 265)
    public class771() {
        super(0, true);
    }

    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(BLjava/lang/String;Lmca;ZZ)V", line = 51)
    ...
    @OriginalMember(owner = "client!oha", name = "b", descriptor = "(II)[I", line = 62)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(BILib;)V", line = 197)
