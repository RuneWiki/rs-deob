...
public class class771 extends class58 {
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(ZLtl;)V")
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(B)Lgfa;")
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "(Lml;IIIIII)V")
