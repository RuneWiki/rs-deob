...
public class class637 extends class602 implements class542 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lha;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Ldga;Lhh;III[B)V", line = 18)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 33)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IIIIIII)V", line = 47)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(I)V", line = 64)
