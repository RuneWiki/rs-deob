...
public class class637 {
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(IZILr;)V")
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(ILr;II)Z")
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(Lr;III)V")
    ...
    @OriginalMember(owner = "client!lea", name = "<init>", descriptor = "(Lqfa;Lre;)V")
