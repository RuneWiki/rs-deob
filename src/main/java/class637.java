...
public class class637 extends class561 implements class560 {
    ...
    @OriginalMember(owner = "client!uca", name = "<init>", descriptor = "(Lqba;Ljt;III[B)V", line = 8)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!uca", name = "b", descriptor = "(II)I", line = 34)
