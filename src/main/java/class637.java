...
public class class637 extends class740 implements class543 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;", line = 26)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(Z)I", line = 42)
    ...
    @OriginalMember(owner = "client!av", name = "c", descriptor = "(Z)Ljm;", line = 58)
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "(Lai;Ljm;Z)V", line = 70)
    public class637(class597 arg0, class687 arg1, boolean arg2) {
        super(arg0, 34963, arg2);
        this.field9161 = arg1;
    }

    @OriginalMember(owner = "client!av", name = "a", descriptor = "(II)V", line = 83)
    ...
    @OriginalMember(owner = "client!av", name = "f", descriptor = "(I)V", line = 98)
