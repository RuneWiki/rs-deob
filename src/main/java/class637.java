...
public class class637 extends class412 {
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(I)Lfca;", line = 20)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "(Lvj;IIIIII)V", line = 111)
