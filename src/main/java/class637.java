...
public class class637 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(JJ)J", line = 21)
    public static long method3702(long arg0, long arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!fe", name = "b", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(B)V", line = 44)
    public static void method3704(byte arg0) {
        field9059 = null;
        int var1 = -44 % ((-arg0 - 7) / 38);
    }

    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(II)V", line = 56)
    ...
    @OriginalMember(owner = "client!fe", name = "b", descriptor = "(II)Lrc;", line = 70)
    ...
    @OriginalMember(owner = "client!fe", name = "<init>", descriptor = "(Lwj;ILwu;)V", line = 102)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Z)V", line = 122)
