...
public class class637 extends class659 {
    ...
    @OriginalMember(owner = "client!bg", name = "c", descriptor = "()Lac;")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ILuf;I)V")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "([ILuf;IIII)V")
    ...
    @OriginalMember(owner = "client!bg", name = "d", descriptor = "()Lac;")
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(Lfn;)V")
