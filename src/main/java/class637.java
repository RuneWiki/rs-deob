...
public class class637 extends class128 implements class21 {
    ...
    @OriginalMember(owner = "client!hda", name = "<init>", descriptor = "(Lmh;I[BIZ)V", line = 6)
    public class637(class537 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field9151 = arg1;
    }

    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(I)I", line = 26)
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(I)J", line = 37)
    public final long method135(int arg0) {
        ++field9152;
        return arg0 != -29959 ? 106L : 0L;
    }

    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(B)I", line = 63)
    public final int method137(byte arg0) {
        ++field9154;
        return arg0 < 43 ? -89 : this.field9151;
    }

    @OriginalMember(owner = "client!hda", name = "<init>", descriptor = "(Lmh;ILjaclib/memory/Buffer;IZ)V", line = 74)
    public class637(class537 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field9151 = arg1;
    }

    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(I[BZI)V", line = 82)
