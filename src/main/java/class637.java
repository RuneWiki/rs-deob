...
public class class637 extends class430 implements class270 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Ldca;B)V", line = 6)
    public final void method246(class161 arg0, byte arg1) {
        super.method246(arg0, (byte) 16);
        int var3 = -122 % ((arg1 - 64) / 39);
    }

    @OriginalMember(owner = "client!vm", name = "d", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;", line = 29)
    public final IDirect3DBaseTexture method575(byte arg0) {
        int var2 = -92 / ((-arg0 - 83) / 34);
        return this.field8950;
    }

    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "(Lto;IZ[[I)V", line = 36)
