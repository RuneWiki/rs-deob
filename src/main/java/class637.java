...
public class class637 extends class508 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ZZIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(II)V", line = 192)
    ...
    @OriginalMember(owner = "client!ri", name = "<init>", descriptor = "(Lbi;)V", line = 203)
