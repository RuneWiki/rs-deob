...
public class class637 extends class105 {
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "()V", line = 4)
    public class637() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(IIII)[B", line = 7)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Lec;IIIB)V", line = 19)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Z)V", line = 183)
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(Z)Lse;", line = 196)
    ...
    @OriginalMember(owner = "client!bs", name = "d", descriptor = "(III)Z", line = 238)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(BII)V", line = 249)
