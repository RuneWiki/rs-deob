...
public class class637 extends class540 {
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(BI)Z", line = 35)
    ...
    @OriginalMember(owner = "client!cia", name = "<init>", descriptor = "()V", line = 47)
    public class637() {
    }

    @OriginalMember(owner = "client!cia", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 49)
