...
public class class637 extends class669 implements class168 {
    ...
    @OriginalMember(owner = "client!tda", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!tda", name = "<init>", descriptor = "(Ltg;IZ[[I)V", line = 17)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(Llda;I)V", line = 68)
    public final void method81(class485 arg0, int arg1) {
        super.method81(arg0, arg1);
    }

    @OriginalMember(owner = "client!tda", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 75)
