...
public abstract class class637 extends class49 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!sr", name = "h", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IBLjava/lang/String;ZI)V", line = 66)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Z)V", line = 76)
