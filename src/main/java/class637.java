...
public class class637 extends class615 {
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(IBI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(II)[[I", line = 15)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(ILii;)[Lnga;", line = 85)
    ...
    @OriginalMember(owner = "client!nfa", name = "b", descriptor = "(I)I", line = 128)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Lgba;I)Lgba;", line = 140)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(B)V", line = 175)
    ...
    @OriginalMember(owner = "client!nfa", name = "<init>", descriptor = "()V", line = 186)
    public class637() {
        super(0, false);
    }

    @OriginalMember(owner = "client!nfa", name = "f", descriptor = "(I)V", line = 192)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(BILeh;)V", line = 211)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Z)Z", line = 225)
