...
public abstract class class637 extends class108 {
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(I)I", line = 16)
    ...
    @OriginalMember(owner = "client!uca", name = "b", descriptor = "(I)F", line = 34)
    ...
    @OriginalMember(owner = "client!uca", name = "c", descriptor = "(I)I", line = 45)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(I[BI)[B", line = 59)
    ...
    @OriginalMember(owner = "client!uca", name = "f", descriptor = "(I)I", line = 83)
    public final int method3681(int arg0) {
        field9248++;
        return arg0 == -27102 ? this.field9253 : 66;
    }

    @OriginalMember(owner = "client!uca", name = "<init>", descriptor = "(IIIIIF)V", line = 97)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Z)I", line = 110)
    ...
    @OriginalMember(owner = "client!uca", name = "g", descriptor = "(I)I", line = 125)
