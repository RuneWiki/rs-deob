...
public class class637 {
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;ZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(BI)I", line = 23)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!bm", name = "b", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!bm", name = "toString", descriptor = "()Ljava/lang/String;", line = 106)
