...
public class class637 extends class219 {
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(Lfba;[IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(Lfba;[III)V")
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(Lfba;II)V")
