...
public class class637 extends class28 {
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(IIIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!jw", name = "<init>", descriptor = "(Ldw;)V", line = 43)
    public class637(class676 arg0) {
        this.field8702 = arg0;
    }

    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(IC)I", line = 65)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(IIZ)I", line = 76)
