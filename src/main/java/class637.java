...
public class class637 {
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(Ljc;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "()V", line = 43)
    public void method835() throws Exception {
        field8816++;
    }

    @OriginalMember(owner = "client!jca", name = "b", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!jca", name = "b", descriptor = "()V", line = 96)
    public void method833() throws Exception {
        field8825++;
    }

    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!jca", name = "c", descriptor = "()V", line = 223)
    public void method830() {
        field8832++;
    }

    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(II)V", line = 232)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(IZLjc;)V", line = 254)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 275)
    public void method834(Component arg0) throws Exception {
        field8823++;
    }

    @OriginalMember(owner = "client!jca", name = "a", descriptor = "([II)V", line = 284)
    ...
    @OriginalMember(owner = "client!jca", name = "c", descriptor = "(I)V", line = 442)
    ...
    @OriginalMember(owner = "client!jca", name = "d", descriptor = "()I", line = 471)
    public int method831() throws Exception {
        field8820++;
        return this.field8835;
    }

    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(IIB)Z", line = 481)
    ...
    @OriginalMember(owner = "client!jca", name = "d", descriptor = "(I)V", line = 495)
