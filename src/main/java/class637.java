...
public class class637 extends class555 {
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(Z)Llr;")
    ...
    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "(Lqq;)V")
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Lot;BI)V")
