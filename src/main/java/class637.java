...
public class class637 {
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(IIIIII)I", line = 6)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(I[BII[BI)I", line = 68)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "([BI[BIIZ)I", line = 151)
    ...
    @OriginalMember(owner = "client!ow", name = "<init>", descriptor = "([B)V", line = 305)
