...
public class class637 {
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(II)V", line = 18)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!ufa", name = "b", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!ufa", name = "c", descriptor = "(B)V", line = 94)
    ...
    @OriginalMember(owner = "client!ufa", name = "d", descriptor = "(B)V", line = 112)
    ...
    @OriginalMember(owner = "client!ufa", name = "b", descriptor = "(II)Lr;", line = 127)
    ...
    @OriginalMember(owner = "client!ufa", name = "<init>", descriptor = "(Lbs;ILpfa;Lpfa;)V", line = 158)
