...
public class mapview extends GameShell {
                    ...
                    if (var1 <= 0) {
                        if (super.field23 == 1) {
                            ...
                            if (this.field199) {
                                ...
                                if (super.field24 > this.field193 && super.field25 > this.field194 && super.field24 < this.field195 + this.field193 && super.field25 < this.field194 + 18) {
                                    this.field198 = 0;
                                }
                                if (super.field24 > this.field193 && super.field25 > this.field196 + this.field194 - 18 && super.field24 < this.field195 + this.field193 && super.field25 < this.field196 + this.field194) {
                                    this.field198 = 25;
                                }
                            }
                            this.field161 = true;
            ...
            if (this.field199) {
                ...
                for (int var9 = 0; var9 < 25; ++var9) {
                    if (this.field197 + var9 < this.field176.length && this.field197 + var9 < this.field225.length) {
                        ...
                        this.field177.method38(this.field225[this.field197 + var9], this.field193 + 21, var8 + 14, 0);
                        int var10 = 16777215;
                        ...
                        this.field177.method38(this.field225[this.field197 + var9], this.field193 + 20, var8 + 13, var10);
                    }
                    var8 += 17;
                }
            }
    ...
    private final void method68(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, String arg7) {
        ...
        this.field177.method40(arg7, var11 / 2 + var9 + 1, var12 / 2 + var10 + 1 + 4, 0);
        this.field177.method40(arg7, var11 / 2 + var9, var12 / 2 + var10 + 4, 16777215);
    }
            ...
            if (field154) {
                for (int var35 = field163 / 64; var35 < (field165 + field163) / 64; ++var35) {
                    for (int var36 = field164 / 64; var36 < (field166 + field164) / 64; ++var36) {
                        ...
                        this.field177.method39(var35 + "_" + var36, var43 - 5, var44 - 5, 16777215);
                        if (var35 == 33 && var36 >= 71 && var36 <= 73) {
                            this.field177.method40("u_pass", (var41 + var43) / 2, (var42 + var44) / 2, 16711680);
                        } else if (var35 >= 32 && var35 <= 34 && var36 >= 70 && var36 <= 74) {
                            this.field177.method40("u_pass", (var41 + var43) / 2, (var42 + var44) / 2, 16776960);
                        }
                    }
                }
            }
