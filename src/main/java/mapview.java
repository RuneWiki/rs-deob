...
public class mapview extends GameShell {
    ...
    private Pix8[] field179 = new Pix8[50];

    @OriginalMember(owner = "mapview!mapview", name = "db", descriptor = "[Lg;")
    private Pix24[] field180 = new Pix24[50];
    ...
    private static int field227 = 3200 - field157;

    @OriginalMember(owner = "mapview!mapview", name = "Zb", descriptor = "I")
    private static int field228 = field170 + field158 - 3200;
    ...
    @OriginalMember(owner = "mapview!mapview", name = "Kb", descriptor = "Lg;")
    private Pix24 field213;

    @OriginalMember(owner = "mapview!mapview", name = "eb", descriptor = "Li;")
    private PixFont field181;
    ...
    @OriginalMember(owner = "mapview!mapview", name = "mb", descriptor = "Lf;")
    ...
    @OriginalMember(owner = "mapview!mapview", name = "bb", descriptor = "[[B")
    ...
    public static final void main(String[] arg0) {
        for (int var1 = 0; var1 < arg0.length; ++var1) {
            if (arg0[var1].equalsIgnoreCase("wip")) {
                field156 = true;
                field218 = false;
                field157 = 2048;
                field158 = 2560;
                field159 = 3776;
                field160 = 4096;
                field169 = field159 - field157 + 64;
                field170 = field160 - field158 + 64;
                field227 = 3200 - field157;
                field228 = field170 + field158 - 3200;
            }
        }
        mapview var2 = new mapview();
        var2.method6(635, 503);
    }
    ...
    public final void method5() {
        ...
        Packet var2 = new Packet(var1.method62("labels.dat", (byte[]) null));
        this.field219 = var2.method47();
        for (int var3 = 0; var3 < this.field219; ++var3) {
            this.field221[var3] = var2.method48();
            this.field222[var3] = var2.method47();
            this.field223[var3] = var2.method47();
            this.field224[var3] = var2.method45();
        }
        Packet var4 = new Packet(var1.method62("floorcol.dat", (byte[]) null));
        int var5 = var4.method47();
        this.field171 = new int[var5 + 1];
        this.field172 = new int[var5 + 1];
        for (int var6 = 0; var6 < var5; ++var6) {
            this.field171[var6 + 1] = var4.method44();
            this.field172[var6 + 1] = var4.method44();
        }
        byte[] var7 = var1.method62("underlay.dat", (byte[]) null);
        byte[][] var8 = new byte[field169][field170];
        this.method64(var7, var8);
        byte[] var9 = var1.method62("overlay.dat", (byte[]) null);
        this.field174 = new int[field169][field170];
        this.field175 = new byte[field169][field170];
        this.method65(var9, this.field174, this.field175);
        byte[] var10 = var1.method62("loc.dat", (byte[]) null);
        this.field176 = new byte[field169][field170];
        this.field178 = new byte[field169][field170];
        this.field177 = new byte[field169][field170];
        this.method63(var10, this.field176, this.field178, this.field177);
        try {
            for (int var11 = 0; var11 < 50; ++var11) {
                this.field179[var11] = new Pix8(var1, "mapscene", var11);
            }
        } catch (Exception var14) {
        }
        try {
            for (int var12 = 0; var12 < 50; ++var12) {
                this.field180[var12] = new Pix24(var1, "mapfunction", var12);
            }
        } catch (Exception var13) {
        }
        this.field181 = new PixFont(var1, "b12");
        this.field182 = new WorldMapFont(11, true, this);
        this.field183 = new WorldMapFont(12, true, this);
        this.field184 = new WorldMapFont(14, true, this);
        this.field185 = new WorldMapFont(17, true, this);
        this.field186 = new WorldMapFont(19, true, this);
        this.field187 = new WorldMapFont(22, true, this);
        this.field188 = new WorldMapFont(26, true, this);
        this.field189 = new WorldMapFont(30, true, this);
        this.field173 = new int[field169][field170];
        this.method66(var8, this.field173);
        this.field213 = new Pix24(this.field209, this.field208);
        this.field213.method31();
        this.method69(0, 0, field169, field170, 0, 0, this.field209, this.field208);
        Draw2D.method17(0, 0, this.field209, this.field208, 0);
        Draw2D.method17(1, 1, this.field209 - 2, this.field208 - 2, this.field161);
    ...
    private final void method63(byte[] arg0, byte[][] arg1, byte[][] arg2, byte[][] arg3) {
        ...
        while (true) {
            while (var5 < arg0.length) {
                int var6 = (arg0[var5++] & 255) * 64 - field157;
                int var7 = (arg0[var5++] & 255) * 64 - field158;
                if (var6 > 0 && var7 > 0 && var6 + 64 < field169 && var7 + 64 < field170) {
                    for (int var8 = 0; var8 < 64; ++var8) {
                        byte[] var9 = arg1[var6 + var8];
                        byte[] var10 = arg2[var6 + var8];
                        byte[] var11 = arg3[var6 + var8];
                        int var12 = field170 - var7 - 1;
                        for (int var13 = -64; var13 < 0; ++var13) {
                            while (true) {
                                ...
                                if (var14 < 29) {
                                    ...
                                    this.field194[this.field193] = var6 + var8;
                                    this.field195[this.field193] = var12;
                                    this.field196[this.field193] = var14 - 160;
                                    ++this.field193;
                                }
                            }
                        }
    ...
    private final void method64(byte[] arg0, byte[][] arg1) {
        ...
        while (true) {
            while (var3 < arg0.length) {
                int var4 = (arg0[var3++] & 255) * 64 - field157;
                int var5 = (arg0[var3++] & 255) * 64 - field158;
                if (var4 > 0 && var5 > 0 && var4 + 64 < field169 && var5 + 64 < field170) {
                    for (int var6 = 0; var6 < 64; ++var6) {
                        byte[] var7 = arg1[var4 + var6];
                        int var8 = field170 - var5 - 1;
    ...
    private final void method65(byte[] arg0, int[][] arg1, byte[][] arg2) {
        ...
        while (true) {
            while (var4 < arg0.length) {
                int var5 = (arg0[var4++] & 255) * 64 - field157;
                int var6 = (arg0[var4++] & 255) * 64 - field158;
                if (var5 > 0 && var6 > 0 && var5 + 64 < field169 && var6 + 64 < field170) {
                    for (int var7 = 0; var7 < 64; ++var7) {
                        int[] var8 = arg1[var5 + var7];
                        byte[] var9 = arg2[var5 + var7];
                        int var10 = field170 - var6 - 1;
                        for (int var11 = -64; var11 < 0; ++var11) {
                            byte var12 = arg0[var4++];
                            if (var12 != 0) {
                                var9[var10] = arg0[var4++];
                                var8[var10--] = this.field172[var12];
                            } else {
                                var8[var10--] = 0;
                            }
                        }
    ...
    private final void method66(byte[][] arg0, int[][] arg1) {
        ...
        for (int var7 = 5; var7 < var3 - 5; ++var7) {
            ...
            for (int var10 = 0; var10 < var4; ++var10) {
                var5[var10] += this.field171[var8[var10] & 255] - this.field171[var9[var10] & 255];
            }
    ...
    public final void method12() {
        if (super.field27[1] == 1) {
            field227 = (int) ((double) field227 - 16.0D / this.field225);
            this.field167 = true;
        }
        if (super.field27[2] == 1) {
            field227 = (int) (16.0D / this.field225 + (double) field227);
            this.field167 = true;
        }
        if (super.field27[3] == 1) {
            field228 = (int) ((double) field228 - 16.0D / this.field225);
            this.field167 = true;
        }
        if (super.field27[4] == 1) {
            field228 = (int) (16.0D / this.field225 + (double) field228);
            this.field167 = true;
        }
        int var1 = 1;
        while (true) {
            do {
                do {
                    if (var1 <= 0) {
                        if (super.field23 == 1) {
                            this.field214 = super.field24;
                            this.field215 = super.field25;
                            this.field216 = field227;
                            this.field217 = field228;
                            ...
                            if (super.field24 > this.field197 && super.field25 > this.field200 + this.field198 && super.field24 < this.field199 + this.field197 && super.field25 < 503) {
                                this.field203 = !this.field203;
                                this.field214 = -1;
                            }
                            if (super.field24 > this.field210 && super.field25 > this.field211 + this.field208 && super.field24 < this.field210 + this.field209 && super.field25 < 503) {
                                this.field212 = !this.field212;
                                this.field214 = -1;
                            }
                            if (this.field203) {
                                if (super.field24 > this.field197 && super.field25 > this.field198 && super.field24 < this.field199 + this.field197 && super.field25 < this.field200 + this.field198) {
                                    this.field214 = -1;
                                }
                                if (super.field24 > this.field197 && super.field25 > this.field198 && super.field24 < this.field199 + this.field197 && super.field25 < this.field198 + 18) {
                                    this.field202 = 0;
                                }
                                if (super.field24 > this.field197 && super.field25 > this.field200 + this.field198 - 18 && super.field24 < this.field199 + this.field197 && super.field25 < this.field200 + this.field198) {
                                    this.field202 = 25;
                                }
                            }
                            this.field167 = true;
                        ...
                        if (this.field203) {
                            this.field204 = -1;
                            if (super.field17 > this.field197 && super.field17 < this.field199 + this.field197) {
                                int var10 = this.field198 + 21 + 5;
                                for (int var11 = 0; var11 < 25; ++var11) {
                                    if (this.field201 + var11 >= this.field229.length || !this.field229[this.field201 + var11].equals("???")) {
                                        if (super.field18 >= var10 && super.field18 < var10 + 17) {
                                            this.field204 = this.field201 + var11;
                                            if (super.field23 == 1) {
                                                this.field206 = this.field201 + var11;
                                                this.field207 = 50;
                                            }
                                        }
                                        var10 += 17;
                            ...
                            if (this.field205 != this.field204) {
                                this.field205 = this.field204;
                                this.field167 = true;
                            }
                        }
                        if ((super.field16 == 1 || super.field23 == 1) && this.field212) {
                            ...
                            if (var12 > this.field210 && var13 > this.field211 && var12 < this.field210 + this.field209 && var13 < this.field211 + this.field208) {
                                field227 = (var12 - this.field210) * field169 / this.field209;
                                field228 = (var13 - this.field211) * field170 / this.field208;
                                this.field214 = -1;
                                this.field167 = true;
                            }
                        }
                        if (super.field16 == 1 && this.field214 != -1) {
                            field227 = (int) ((double) (this.field214 - super.field17) * 2.0D / this.field226) + this.field216;
                            field228 = (int) ((double) (this.field215 - super.field18) * 2.0D / this.field226) + this.field217;
                            this.field167 = true;
                        }
                        ...
                        if (this.field201 < this.field202) {
                            this.field167 = true;
                            ++this.field201;
                        }
                        if (this.field201 > this.field202) {
                        ...
                        int var14 = field227 - (int) (635.0D / this.field225);
                        int var15 = field228 - (int) (503.0D / this.field225);
                        int var16 = (int) (635.0D / this.field225) + field227;
                        int var17 = (int) (503.0D / this.field225) + field228;
                        if (var14 < 48) {
                            field227 = (int) (635.0D / this.field225) + 48;
                        }
                        if (var15 < 48) {
                            field228 = (int) (503.0D / this.field225) + 48;
                        }
                        if (var16 > field169 - 48) {
                            field227 = field169 - 48 - (int) (635.0D / this.field225);
                        }
                        if (var17 > field170 - 48) {
                            field228 = field170 - 48 - (int) (503.0D / this.field225);
                        }
                        return;
                    }
                    var1 = this.method7();
            ...
            Pix24 var2 = new Pix24(field169 * 2, field170 * 2);
            var2.method31();
            this.method69(0, 0, field169, field170, 0, 0, field169 * 2, field170 * 2);
            super.field10.method50();
            ...
            try {
                BufferedOutputStream var8 = new BufferedOutputStream(new FileOutputStream("map-" + field169 * 2 + "-" + field170 * 2 + "-rgb.raw"));
                var8.write(var4);
                var8.close();
            } catch (Exception var18) {
                var18.printStackTrace();
            }
            System.out.println("Done export: " + field169 * 2 + "," + field170 * 2);
        }
    }
    ...
    public final void method8() {
        if (this.field167) {
            ...
            this.field168 = 0;
            Draw2D.method20();
            int var1 = field227 - (int) (635.0D / this.field225);
            int var2 = field228 - (int) (503.0D / this.field225);
            int var3 = (int) (635.0D / this.field225) + field227;
            int var4 = (int) (503.0D / this.field225) + field228;
            this.method69(var1, var2, var3, var4, 0, 0, 635, 503);
            if (this.field212) {
                this.field213.method34(this.field210, this.field211);
                Draw2D.method16(this.field209 * var1 / field169 + this.field210, this.field208 * var2 / field170 + this.field211, (var3 - var1) * this.field209 / field169, (var4 - var2) * this.field208 / field170, 16711680, 128);
                Draw2D.method17(this.field209 * var1 / field169 + this.field210, this.field208 * var2 / field170 + this.field211, (var3 - var1) * this.field209 / field169, (var4 - var2) * this.field208 / field170, 16711680);
                if (this.field207 > 0 && this.field207 % 10 < 5) {
                    for (int var5 = 0; var5 < this.field193; ++var5) {
                        if (this.field196[var5] == this.field206) {
                            int var6 = this.field194[var5] * this.field209 / field169 + this.field210;
                            int var7 = this.field195[var5] * this.field208 / field170 + this.field211;
            ...
            if (this.field203) {
                this.method68(this.field197, this.field198, this.field199, 18, 10066329, 7829367, 5592405, "Prev page");
                this.method68(this.field197, this.field198 + 18, this.field199, this.field200 - 36, 10066329, 7829367, 5592405, "");
                this.method68(this.field197, this.field200 + this.field198 - 18, this.field199, 18, 10066329, 7829367, 5592405, "Next page");
                int var8 = this.field198 + 3 + 18;
                for (int var9 = 0; var9 < 25; ++var9) {
                    if (this.field201 + var9 < this.field180.length && this.field201 + var9 < this.field229.length) {
                        if (this.field229[this.field201 + var9].equals("???")) {
                            continue;
                        }
                        this.field180[this.field201 + var9].method32(this.field197 + 3, var8);
                        this.field181.method38(this.field229[this.field201 + var9], this.field197 + 21, var8 + 14, 0);
                        int var10 = 16777215;
                        if (this.field201 + var9 == this.field204) {
                            var10 = 12298922;
                        }
                        if (this.field207 > 0 && this.field207 % 10 < 5 && this.field201 + var9 == this.field206) {
                            var10 = 16776960;
                        }
                        this.field181.method38(this.field229[this.field201 + var9], this.field197 + 20, var8 + 13, var10);
                    }
                    var8 += 17;
                }
            }
            this.method68(this.field210, this.field211 + this.field208, this.field209, 18, this.field161, this.field162, this.field163, "Overview");
            this.method68(this.field197, this.field200 + this.field198, this.field199, 18, this.field161, this.field162, this.field163, "Key");
            if (this.field226 == 3.0D) {
                this.method68(170, 471, 50, 30, this.field164, this.field165, this.field166, "37%");
            } else {
                this.method68(170, 471, 50, 30, this.field161, this.field162, this.field163, "37%");
            }
            if (this.field226 == 4.0D) {
                this.method68(230, 471, 50, 30, this.field164, this.field165, this.field166, "50%");
            } else {
                this.method68(230, 471, 50, 30, this.field161, this.field162, this.field163, "50%");
            }
            if (this.field226 == 6.0D) {
                this.method68(290, 471, 50, 30, this.field164, this.field165, this.field166, "75%");
            } else {
                this.method68(290, 471, 50, 30, this.field161, this.field162, this.field163, "75%");
            }
            if (this.field226 == 8.0D) {
                this.method68(350, 471, 50, 30, this.field164, this.field165, this.field166, "100%");
            } else {
                this.method68(350, 471, 50, 30, this.field161, this.field162, this.field163, "100%");
            }
        }
        --this.field168;
        if (this.field168 <= 0) {
    ...
    private final void method68(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, String arg7) {
        ...
        this.field181.method40(arg7, var11 / 2 + var9 + 1, var12 / 2 + var10 + 1 + 4, 0);
        this.field181.method40(arg7, var11 / 2 + var9, var12 / 2 + var10 + 4, 16777215);
    }
    ...
    private final void method69(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
        ...
        for (int var13 = 0; var13 < var9; ++var13) {
            ...
            if (var65 > 0) {
                ...
                int[] var68 = this.field173[arg0 + var13];
                int[] var69 = this.field174[arg0 + var13];
                byte[] var70 = this.field175[arg0 + var13];
        ...
        if (arg2 - arg0 <= arg6 - arg4) {
            ...
            for (int var15 = 0; var15 < var9; ++var15) {
                ...
                if (var47 > 0) {
                    byte[] var48 = this.field176[arg0 + var15];
                    byte[] var49 = this.field178[arg0 + var15];
                    byte[] var50 = this.field177[arg0 + var15];
                    for (int var51 = 0; var51 < var10; ++var51) {
                        ...
                        if (var54 > 0) {
                            ...
                            if (var61 != 0) {
                                this.field179[var61 - 1].method36(var45 - var47 / 2, var52 - var54 / 2, var47 * 2, var54 * 2);
                            }
                            int var62 = var50[arg1 + var51] & 255;
                            if (var62 != 0) {
                                this.field192[var14] = var62 - 1;
                                this.field190[var14] = var47 / 2 + var45;
                                this.field191[var14] = var54 / 2 + var52;
                                ++var14;
                            }
                        }
                    }
            ...
            for (int var16 = 0; var16 < var14; ++var16) {
                this.field180[this.field192[var16]].method32(this.field190[var16] - 7, this.field191[var16] - 7);
            }
            if (this.field207 > 0) {
                for (int var17 = 0; var17 < var14; ++var17) {
                    if (this.field192[var17] == this.field206) {
                        this.field180[this.field192[var17]].method32(this.field190[var17] - 7, this.field191[var17] - 7);
                        if (this.field207 % 10 < 5) {
                            Draw2D.method21(this.field190[var17], this.field191[var17], 15, 16776960, 128);
                            Draw2D.method21(this.field190[var17], this.field191[var17], 7, 16777215, 256);
                        }
                    }
                }
            }
            if (this.field226 == this.field225 && field218) {
                for (int var18 = 0; var18 < this.field219; ++var18) {
                    int var19 = this.field222[var18];
                    int var20 = this.field223[var18];
                    int var21 = var19 - field157;
                    int var22 = field170 + field158 - var20;
                    int var23 = (var21 - arg0) * (arg6 - arg4) / (arg2 - arg0) + arg4;
                    int var24 = (var22 - arg1) * (arg7 - arg5) / (arg3 - arg1) + arg5;
                    int var25 = this.field224[var18];
                    int var26 = 16777215;
                    ...
                    if (var27 != null) {
                        String var28 = this.field221[var18];
                        int var29 = 1;
            ...
            if (field156) {
                for (int var35 = field157 / 64; var35 < (field169 + field157) / 64; ++var35) {
                    for (int var36 = field158 / 64; var36 < (field170 + field158) / 64; ++var36) {
                        int var37 = var35 * 64;
                        int var38 = var36 * 64;
                        int var39 = var37 - field157;
                        int var40 = field170 + field158 - var38;
                        ...
                        this.field181.method39(var35 + "_" + var36, var43 - 5, var44 - 5, 16777215);
                    }
                }
            }
        }
    ...
    private final byte[] method72() {
        ...
        try {
            ...
            for (int var2 = 0; var2 < 10; ++var2) {
                var1 = var1 + Version.field154[var2];
            }
    ...
    private final boolean method76(byte[] arg0) throws Exception {
        if (arg0 == null) {
            ...
            for (int var4 = 0; var4 < 20; ++var4) {
                if (Version.field154[var4] != var3[var4]) {
                    return false;
                }
            }
            return true;
