...
public class mapview extends class1 {
    ...
    private class8[] field175 = new class8[100];

    @OriginalMember(owner = "mapview!mapview", name = "bb", descriptor = "[Lg;")
    private class7[] field176 = new class7[100];
    ...
    public final void method5() {
        class15 var1 = this.method71();
        this.method2(100, "Please wait... Rendering Map");
        class10 var2 = new class10(var1.method62("size.dat", (byte[]) null));
        ...
        class10 var3 = new class10(var1.method62("labels.dat", (byte[]) null));
        ...
        class10 var5 = new class10(var1.method62("floorcol.dat", (byte[]) null));
        ...
        try {
            for (int var12 = 0; var12 < 100; ++var12) {
                this.field175[var12] = new class8(var1, "mapscene", var12);
            }
        } catch (Exception var15) {
        }
        try {
            for (int var13 = 0; var13 < 100; ++var13) {
                this.field176[var13] = new class7(var1, "mapfunction", var13);
            }
        } catch (Exception var14) {
        }
        this.field177 = new class9(var1, "b12_full", false);
        this.field178 = new class6(11, true, this);
        this.field179 = new class6(12, true, this);
        this.field180 = new class6(14, true, this);
        this.field181 = new class6(17, true, this);
        this.field182 = new class6(19, true, this);
        this.field183 = new class6(22, true, this);
        this.field184 = new class6(26, true, this);
        this.field185 = new class6(30, true, this);
        this.field169 = new int[field165][field166];
        this.method66(var9, this.field169);
        this.field209 = new class7(this.field205, this.field204);
        this.field209.method31();
        this.method69(0, 0, field165, field166, 0, 0, this.field205, this.field204);
        class5.method17(0, 0, this.field205, this.field204, 0);
        class5.method17(1, 1, this.field205 - 2, this.field204 - 2, this.field155);
                    ...
                    for (int var7 = 0; var7 < 64; ++var7) {
                        ...
                        for (int var11 = -64; var11 < 0; ++var11) {
                            ...
                            if (var12 != 0) {
                                ...
                                var8[var10--] = this.field168[var12];
                            } else {
                                var8[var10--] = 0;
                            }
                        }
    ...
    public final void method12() {
        ...
        while (true) {
            ...
            class7 var2 = new class7(field165 * 2, field166 * 2);
            var2.method31();
    ...
    public final void method8() {
        if (this.field161) {
            ...
            if (this.field208) {
                ...
                class5.method16(this.field205 * var1 / field165 + this.field206, this.field204 * var2 / field166 + this.field207, (var3 - var1) * this.field205 / field165, (var4 - var2) * this.field204 / field166, 16711680, 128);
                class5.method17(this.field205 * var1 / field165 + this.field206, this.field204 * var2 / field166 + this.field207, (var3 - var1) * this.field205 / field165, (var4 - var2) * this.field204 / field166, 16711680);
                if (this.field203 > 0 && this.field203 % 10 < 5) {
                    for (int var5 = 0; var5 < this.field189; ++var5) {
                        if (this.field192[var5] == this.field202) {
                            ...
                            class5.method21(var6, var7, 2, 16776960, 256);
                        }
                    }
                }
            }
    ...
    private final void method68(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, String arg7) {
        class5.method17(arg0, arg1, arg2, arg3, 0);
        int var9 = arg0 + 1;
        int var10 = arg1 + 1;
        int var11 = arg2 - 2;
        int var12 = arg3 - 2;
        class5.method19(var9, var10, var11, var12, arg5);
        class5.method13(var9, var10, var11, arg4);
        class5.method14(var9, var10, var12, arg4);
        class5.method13(var9, var10 + var12 - 1, var11, arg6);
        class5.method14(var9 + var11 - 1, var10, var12, arg6);
            ...
            if (var65 > 0) {
                ...
                for (int var71 = 0; var71 < var10; ++var71) {
                    ...
                    if (var74 > 0) {
                        ...
                        if (var77 == 0) {
                            class5.method19(var66, var75, var67 - var66, var76 - var75, var68[arg1 + var71]);
                        } else {
                            byte var78 = var70[arg1 + var71];
                            int var79 = var78 & 252;
                            if (var79 != 0 && var65 > 1 && var74 > 1) {
                                this.method70(class5.field37, class5.field38 * var75 + var66, var68[arg1 + var71], var77, var65, var74, var79 >> 2, var78 & 3);
                            } else {
                                class5.method19(var66, var75, var65, var74, var77);
                            }
                        }
                    }
                }
                    ...
                    for (int var51 = 0; var51 < var10; ++var51) {
                        ...
                        if (var54 > 0) {
                            ...
                            if (var55 != 0) {
                                ...
                                if (var55 == 1) {
                                    class5.method14(var45, var52, var54, var58);
                                } else if (var55 == 2) {
                                    class5.method13(var45, var52, var47, var58);
                                } else if (var55 == 3) {
                                    class5.method14(var56, var52, var54, var58);
                                } else if (var55 == 4) {
                                    class5.method13(var45, var57, var47, var58);
                                } else if (var55 == 9) {
                                    class5.method14(var45, var52, var54, 16777215);
                                    class5.method13(var45, var52, var47, var58);
                                } else if (var55 == 10) {
                                    class5.method14(var56, var52, var54, 16777215);
                                    class5.method13(var45, var52, var47, var58);
                                } else if (var55 == 11) {
                                    class5.method14(var56, var52, var54, 16777215);
                                    class5.method13(var45, var57, var47, var58);
                                    ...
                                    class5.method13(var45, var52, 1, var58);
                                } else if (var55 == 18) {
                                    class5.method13(var56, var52, 1, var58);
                                } else if (var55 == 19) {
                                    class5.method13(var56, var57, 1, var58);
                                } else if (var55 == 20) {
                                    class5.method13(var45, var57, 1, var58);
                                } else if (var55 == 25) {
                                    for (int var59 = 0; var59 < var54; ++var59) {
                                        class5.method13(var45 + var59, var57 - var59, 1, var58);
                                    }
                                } else if (var55 == 26) {
                                    for (int var60 = 0; var60 < var54; ++var60) {
                                        class5.method13(var45 + var60, var52 + var60, 1, var58);
                                    }
                                }
                            }
                ...
                for (int var17 = 0; var17 < var14; ++var17) {
                    if (this.field188[var17] == this.field202) {
                        ...
                        if (this.field203 % 10 < 5) {
                            class5.method21(this.field186[var17], this.field187[var17], 15, 16776960, 128);
                            class5.method21(this.field186[var17], this.field187[var17], 7, 16777215, 256);
                        }
                    }
                }
            }
            ...
            if (field154) {
                for (int var35 = field163 / 64; var35 < (field165 + field163) / 64; ++var35) {
                    for (int var36 = field164 / 64; var36 < (field166 + field164) / 64; ++var36) {
                        ...
                        class5.method17(var41, var42, var43 - var41, var44 - var42, 16777215);
                        ...
                        } else if (var35 >= 32 && var35 <= 34 && var36 >= 70 && var36 <= 74) {
                            this.field177.method41("u_pass", (var41 + var43) / 2, (var42 + var44) / 2, 16776960);
                        }
                    }
                }
            }
    ...
    private final class15 method71() {
        Object var1 = null;
        String var2 = null;
        try {
            var2 = this.method73();
    ...
    private final byte[] method72() {
        ...
        try {
            ...
            for (int var2 = 0; var2 < 10; ++var2) {
                var1 = var1 + class16.field152[var2];
            }
    ...
    private final boolean method76(byte[] arg0) throws Exception {
        if (arg0 == null) {
            ...
            for (int var4 = 0; var4 < 20; ++var4) {
                if (class16.field152[var4] != var3[var4]) {
                    return false;
                }
            }
            return true;
