...
public class Component {
    ...
    @OriginalMember(owner = "client!d", name = "mb", descriptor = "Lt;")
    ...
    @OriginalMember(owner = "client!d", name = "X", descriptor = "Ljb;")
    public Pix24 field117;

    @OriginalMember(owner = "client!d", name = "Y", descriptor = "Ljb;")
    public Pix24 field118;

    @OriginalMember(owner = "client!d", name = "Q", descriptor = "Llb;")
    ...
    @OriginalMember(owner = "client!d", name = "J", descriptor = "[Ljb;")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Lyb;I[Llb;Lyb;)V")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(ZILfb;I)V")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(IILjava/lang/String;Lyb;)Ljb;")
    private static Pix24 method37(int arg0, int arg1, String arg2, Jagfile arg3) {
        long var4 = (JString.method312(193, arg2) << 8) + (long) arg1;
        Pix24 var6 = (Pix24) field133.method115(var4);
        if (arg0 <= 0) {
