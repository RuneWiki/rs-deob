...
public class class751 extends class362 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IBI)Lat;")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ILin;)I")
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(Lff;)V")
