...
public abstract class class751 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(ILjava/lang/String;)I", line = 4)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(BZZLjava/lang/String;ILjava/lang/String;I)V", line = 38)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(I)V", line = 151)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(IIIIZ)V", line = 165)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(BII)I", line = 203)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(ILjava/lang/String;IIJZLjava/lang/String;IZIZIJ)V", line = 229)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(III)I", line = 258)
    ...
    @OriginalMember(owner = "client!s", name = "<init>", descriptor = "(III[[I)V", line = 274)
