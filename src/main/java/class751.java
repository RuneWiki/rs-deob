...
public class class751 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IB)I", line = 6)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Z)V", line = 25)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "([SI)[S", line = 40)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(B)[Lne;", line = 122)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(ZIZI)Ljava/lang/String;", line = 133)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IZ)I", line = 183)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(BLso;)Lcf;", line = 199)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(I[B)[B", line = 217)
    ...
    @OriginalMember(owner = "client!hn", name = "<init>", descriptor = "(II)V", line = 283)
