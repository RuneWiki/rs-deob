...
public class class751 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(I)Lgt;", line = 3)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Lqba;B)V", line = 29)
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(I)V", line = 137)
