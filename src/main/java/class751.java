...
public abstract class class751 extends class133 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(FFFFFFIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(FFFFFFILaa;II)V", line = 115)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(IIIIIII)V", line = 127)
    ...
    @OriginalMember(owner = "client!mo", name = "d", descriptor = "()I", line = 171)
    public final int method1048() {
        return this.field10475 + this.field10473 + this.field10467;
    }

    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(FFFFFF)Z", line = 190)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "([I)V", line = 333)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "()I", line = 343)
    public final int method1042() {
        return this.field10452;
    }

    @OriginalMember(owner = "client!mo", name = "a", descriptor = "()I", line = 348)
    public final int method1036() {
        return this.field10470 + this.field10452 + this.field10472;
    }

    @OriginalMember(owner = "client!mo", name = "c", descriptor = "()I", line = 361)
    public final int method1043() {
        return this.field10473;
    }

    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(Lgf;II)V", line = 373)
