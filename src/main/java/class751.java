...
public abstract class class751 extends class540 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(III)[[I", line = 4)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IBI)[I", line = 39)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(I)I", line = 72)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(ILrv;I)V", line = 83)
    public void method309(int arg0, class120 arg1, int arg2) {
        field10404++;
        int var4 = 53 / ((25 - arg0) / 63);
    }

    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IB)[[I", line = 129)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(II)[I", line = 144)
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(B)V", line = 156)
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(III)V", line = 172)
    ...
    @OriginalMember(owner = "client!rl", name = "d", descriptor = "(B)I", line = 194)
    ...
    @OriginalMember(owner = "client!rl", name = "<init>", descriptor = "(IZ)V", line = 207)
