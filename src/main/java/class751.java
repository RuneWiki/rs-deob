...
public class class751 extends class172 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(ILgga;)V", line = 18)
    ...
    @OriginalMember(owner = "client!lb", name = "b", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(BLhia;)V", line = 45)
