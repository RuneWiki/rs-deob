...
public class class751 extends class205 {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(Lofa;B)V", line = 7)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!uv", name = "c", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(BC)I", line = 104)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(CB)I", line = 131)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IIIII)V", line = 160)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(ILofa;I)V", line = 204)
