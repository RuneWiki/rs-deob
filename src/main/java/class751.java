...
public class class751 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lha;IIIIIII[S[BZ)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lha;II)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lgga;Loo;Lui;Lsc;Lac;Lu;Lqp;)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lha;IIII[S[B)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lha;Ljg;Lll;)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lha;IIII)Low;")
    ...
    @OriginalMember(owner = "client!lb", name = "b", descriptor = "(I)Ljea;")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lha;Lol;IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(II)Ljea;")
    ...
    @OriginalMember(owner = "client!lb", name = "b", descriptor = "(II)Lpf;")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "([B[B[SII)V")
    ...
    @OriginalMember(owner = "client!lb", name = "b", descriptor = "(Lha;)Low;")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Ld;II)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lha;Ljg;IIII)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Ld;III)I")
    ...
    @OriginalMember(owner = "client!lb", name = "b", descriptor = "(Lha;IIII)V")
