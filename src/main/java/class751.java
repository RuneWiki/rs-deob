...
public class class751 extends class679 {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(I)Lag;", line = 8)
    public final class214 method210(int arg0) {
        field10437++;
        return arg0 == 7288 ? class540.field7551 : null;
    }

    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!uv", name = "<init>", descriptor = "(Lvfa;Lrq;IIIIIIIIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IIII)I", line = 47)
