...
public class class751 extends class314 {
    ...
    @OriginalMember(owner = "client!gfa", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(Z)J", line = 21)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(I)I", line = 32)
    ...
    @OriginalMember(owner = "client!gfa", name = "e", descriptor = "(I)I", line = 45)
    ...
    @OriginalMember(owner = "client!gfa", name = "g", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!gfa", name = "h", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!gfa", name = "c", descriptor = "(I)I", line = 97)
    ...
    @OriginalMember(owner = "client!gfa", name = "b", descriptor = "(I)I", line = 124)
    ...
    @OriginalMember(owner = "client!gfa", name = "i", descriptor = "(I)Z", line = 139)
