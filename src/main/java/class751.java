...
public class class751 extends class601 {
    ...
    @OriginalMember(owner = "client!kf", name = "f", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "()V", line = 14)
    public class751() {
        super(1, false);
    }

    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(IB)[I", line = 17)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(II)[[I", line = 51)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(IIZ)V", line = 93)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Lmc;II)V", line = 167)
    ...
    @OriginalMember(owner = "client!kf", name = "c", descriptor = "(III)Z", line = 181)
