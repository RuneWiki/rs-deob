...
public class class751 extends class55 {
    ...
    @OriginalMember(owner = "client!mo", name = "g", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!mo", name = "f", descriptor = "(I)Z", line = 18)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(III)Z", line = 36)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(Lij;)V", line = 59)
    public class751(class424 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(FFFFFIIF)F", line = 64)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IIZ)V", line = 132)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IILfe;)V", line = 146)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(ZB)V", line = 160)
    public final void method197(boolean arg0, byte arg1) {
        int var3 = 45 % ((-61 - arg1) / 44);
        ++field10488;
    }

    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IZ)V", line = 169)
