...
public class class751 extends class782 {
    ...
    @OriginalMember(owner = "client!dr", name = "b", descriptor = "(IBI)V", line = 18)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IBI)V", line = 38)
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(IIIIIII)V", line = 59)
