...
public class class188 extends class588 {
    ...
    @OriginalMember(owner = "client!ov", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ov", name = "<init>", descriptor = "(Lvd;Lvd;Lhha;)V", line = 22)
    public class188(class39 arg0, class39 arg1, class521 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(ZZLjava/lang/String;ILjava/lang/String;)V", line = 39)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(IIIII)V", line = 91)
