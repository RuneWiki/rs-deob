...
public class class188 extends class591 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!oc", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 5)
    public final synchronized void keyReleased(KeyEvent arg0) {
        field3138++;
        this.method1514(1, (byte) -26, arg0);
    }

    @OriginalMember(owner = "client!oc", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 13)
    public final synchronized void keyPressed(KeyEvent arg0) {
        this.method1514(0, (byte) -26, arg0);
        field3134++;
    }

    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!oc", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 113)
    public final synchronized void focusLost(FocusEvent arg0) {
        this.method1513(0, -1, 60, '\u0000');
        field3132++;
    }

    @OriginalMember(owner = "client!oc", name = "c", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!oc", name = "d", descriptor = "(I)I", line = 140)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IIIC)V", line = 164)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IBLjava/awt/event/KeyEvent;)V", line = 182)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(II)Z", line = 217)
    ...
    @OriginalMember(owner = "client!oc", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 233)
    public final void focusGained(FocusEvent arg0) {
        field3145++;
    }

    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 242)
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(Z)V", line = 270)
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 349)
    public class188(Component arg0) {
        class9.method189(-307);
        this.method1516(-113, arg0);
    }

    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Z)Lvc;", line = 284)
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(B)V", line = 296)
    ...
    @OriginalMember(owner = "client!oc", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 336)
