...
public class class188 extends class17 implements class620 {
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IILoa;ILcq;ZI)V")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(ZILoa;I)Lid;")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Loa;B)Lpl;")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IILoa;I)Z")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!lw", name = "c", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Loa;II)Lba;")
    ...
    @OriginalMember(owner = "client!lw", name = "d", descriptor = "(Loa;I)Lcd;")
    ...
    @OriginalMember(owner = "client!lw", name = "<init>", descriptor = "(Loa;Lsa;IIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Loa;ZI)Lba;")
