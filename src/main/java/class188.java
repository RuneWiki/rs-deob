...
public class class188 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(BZZLlt;Ljava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIIIILza;I)V")
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(Lza;Lnn;I)V")
