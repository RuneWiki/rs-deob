...
public abstract class class188 {
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(B)V", line = 3)
    public void method1302(byte arg0) {
        field2505++;
        int var2 = -118 / ((arg0 + 16) / 47);
    }

    @OriginalMember(owner = "client!aba", name = "b", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!aba", name = "c", descriptor = "(B)V", line = 117)
    ...
    @OriginalMember(owner = "client!aba", name = "d", descriptor = "(B)V", line = 132)
    ...
    @OriginalMember(owner = "client!aba", name = "e", descriptor = "(B)V", line = 143)
    ...
    @OriginalMember(owner = "client!aba", name = "b", descriptor = "(I)V", line = 153)
    ...
    @OriginalMember(owner = "client!aba", name = "c", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!aba", name = "<init>", descriptor = "(Lai;)V", line = 179)
