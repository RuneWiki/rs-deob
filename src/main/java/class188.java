...
public abstract class class188 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!gd", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 9)
    public final void focusLost(FocusEvent arg0) {
        field2584++;
        class45.field635 = false;
    }

    @OriginalMember(owner = "client!gd", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 19)
    public final void windowClosing(WindowEvent arg0) {
        field2578++;
        this.destroy();
    }

    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!gd", name = "start", descriptor = "()V", line = 71)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(BIIIIILjava/lang/String;)V", line = 82)
    ...
    @OriginalMember(owner = "client!gd", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 101)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IZ)V", line = 117)
    ...
    @OriginalMember(owner = "client!gd", name = "providesignlink", descriptor = "(Lko;)V", line = 195)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Ljava/lang/String;ZIIIIII)V", line = 207)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(III)Ljava/lang/String;", line = 257)
    ...
    @OriginalMember(owner = "client!gd", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 297)
    public final void windowIconified(WindowEvent arg0) {
        field2563++;
    }

    @OriginalMember(owner = "client!gd", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 304)
    public final void windowClosed(WindowEvent arg0) {
        field2595++;
    }

    @OriginalMember(owner = "client!gd", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 312)
    public final void windowDeactivated(WindowEvent arg0) {
        field2568++;
    }

    @OriginalMember(owner = "client!gd", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 322)
    ...
    @OriginalMember(owner = "client!gd", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 331)
    public final void update(Graphics arg0) {
        field2581++;
        this.paint(arg0);
    }

    @OriginalMember(owner = "client!gd", name = "destroy", descriptor = "()V", line = 339)
    ...
    @OriginalMember(owner = "client!gd", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 357)
    public final void windowActivated(WindowEvent arg0) {
        field2580++;
    }

    @OriginalMember(owner = "client!gd", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 364)
    public final void windowDeiconified(WindowEvent arg0) {
        field2573++;
    }

    @OriginalMember(owner = "client!gd", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 376)
    ...
    @OriginalMember(owner = "client!gd", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 392)
    public final void windowOpened(WindowEvent arg0) {
        field2585++;
    }

    @OriginalMember(owner = "client!gd", name = "c", descriptor = "(I)V", line = 404)
    ...
    @OriginalMember(owner = "client!gd", name = "run", descriptor = "()V", line = 451)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(B)Z", line = 569)
    ...
    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(B)V", line = 605)
    ...
    @OriginalMember(owner = "client!gd", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 635)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 660)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IIIII)V", line = 688)
    ...
    @OriginalMember(owner = "client!gd", name = "stop", descriptor = "()V", line = 737)
    ...
    @OriginalMember(owner = "client!gd", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 749)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Z)V", line = 772)
    ...
    @OriginalMember(owner = "client!gd", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 813)
    ...
    @OriginalMember(owner = "client!gd", name = "d", descriptor = "(B)V", line = 835)
