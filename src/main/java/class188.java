...
public class class188 {
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(III)V", line = 2)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(B)Lwh;", line = 29)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Lsv;)V", line = 52)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(B)V", line = 117)
