...
public abstract class class188 implements class122 {
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(I)[Lhp;", line = 5)
    ...
    @OriginalMember(owner = "client!ao", name = "finalize", descriptor = "()V", line = 16)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(II)V", line = 25)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(B)Z", line = 63)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Lht;IIIZ)V", line = 237)
    ...
    @OriginalMember(owner = "client!ao", name = "c", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(B)Ljava/lang/String;", line = 102)
    ...
    @OriginalMember(owner = "client!ao", name = "d", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!ao", name = "e", descriptor = "(I)V", line = 157)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(ZB)V", line = 177)
    ...
    @OriginalMember(owner = "client!ao", name = "f", descriptor = "(I)I", line = 195)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(BZ)V", line = 219)
    ...
    @OriginalMember(owner = "client!ao", name = "c", descriptor = "(B)I", line = 254)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(BI)V", line = 270)
