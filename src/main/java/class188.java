...
public class class188 implements Runnable {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Ljava/lang/String;ZII)Lvn;", line = 4)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(II)Lvn;", line = 13)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IZIII)Lvn;", line = 25)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(I[BLjava/io/File;)Z", line = 41)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "([IIIILjava/awt/Component;Ljava/awt/Point;)Lvn;", line = 62)
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(I)Ljava/lang/Object;", line = 72)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Ljava/lang/String;Z)Lvn;", line = 84)
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(ILjava/lang/String;IZ)V", line = 702)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "([Ljava/lang/Class;Ljava/lang/String;BLjava/lang/Class;)Lvn;", line = 114)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Ljava/lang/Runnable;BI)Lvn;", line = 123)
    ...
    @OriginalMember(owner = "client!ft", name = "run", descriptor = "()V", line = 141)
    ...
    @OriginalMember(owner = "client!ft", name = "c", descriptor = "(I)V", line = 437)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Z)Z", line = 493)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(ILjava/net/URL;)Lvn;", line = 512)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Ljava/lang/String;ZI)Lvn;", line = 525)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Ljava/lang/Object;IIIB)Lvn;", line = 544)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Ljava/lang/String;I)Lrv;", line = 573)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(I)Lvn;", line = 584)
    public final class328 method1579(int arg0) {
        return arg0 == 65535 ? this.method1577(null, 0, 5, 0, (byte) 107) : null;
    }

    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(Z)V", line = 602)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/Class;)Lvn;", line = 616)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Ljava/awt/Frame;I)Lvn;", line = 634)
    public final class328 method1582(Frame arg0, int arg1) {
        return arg1 == -3824 ? this.method1577(arg0, 0, 7, 0, (byte) 75) : null;
    }

    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;I)Lrv;", line = 644)
