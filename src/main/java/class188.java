...
public class class188 extends class397 {
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(BI)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(II)[I", line = 142)
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "()V", line = 234)
    public class188() {
        super(1, false);
    }

    @OriginalMember(owner = "client!nb", name = "c", descriptor = "(Z)V", line = 248)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IBLae;)V", line = 259)
