...
public class class188 {
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(II[BI[BI)I", line = 4)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(II[BII[B)I", line = 158)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(I)V", line = 228)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "([B)V", line = 246)
