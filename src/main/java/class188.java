...
public class class188 extends class89 {
    ...
    @OriginalMember(owner = "client!ol", name = "c", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(ILfh;)V", line = 14)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(CI)I", line = 37)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Lfh;IB)V", line = 103)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(CB)I", line = 166)
