...
public class class188 extends class260 {
    ...
    @OriginalMember(owner = "client!uu", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!uu", name = "d", descriptor = "(I)Z", line = 17)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(B)I", line = 30)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(II)Z", line = 41)
    ...
    @OriginalMember(owner = "client!uu", name = "c", descriptor = "(B)I", line = 52)
    ...
    @OriginalMember(owner = "client!uu", name = "d", descriptor = "(B)Z", line = 65)
    ...
    @OriginalMember(owner = "client!uu", name = "e", descriptor = "(I)Z", line = 76)
    ...
    @OriginalMember(owner = "client!uu", name = "<init>", descriptor = "(II)V", line = 88)
