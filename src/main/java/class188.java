...
public class class188 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIIILqa;IILqo;)Lf;", line = 17)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(BI)Lfq;", line = 36)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IZ)V", line = 118)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(IZ)I", line = 134)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(B)V", line = 162)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(B)V", line = 181)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(II)Z", line = 192)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(BLjava/lang/String;I)V", line = 203)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(ZZLqo;IIIIILqa;ILqa;Loa;)Lf;", line = 285)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(I)V", line = 351)
    ...
    @OriginalMember(owner = "client!ao", name = "c", descriptor = "(II)V", line = 371)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Z)V", line = 392)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Loq;IZLbm;Lbu;Lbu;)V", line = 428)
