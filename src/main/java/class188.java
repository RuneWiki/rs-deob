...
public abstract class class188 {
    ...
    @OriginalMember(owner = "client!s", name = "b", descriptor = "(I)Z", line = 10)
    ...
    @OriginalMember(owner = "client!s", name = "b", descriptor = "(Z)I", line = 28)
    ...
    @OriginalMember(owner = "client!s", name = "d", descriptor = "(B)V", line = 41)
