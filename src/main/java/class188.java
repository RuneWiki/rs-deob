...
public class class188 extends class232 {
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "()V", line = 58)
    public class188() {
        super(1, false);
    }

    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IB)[I", line = 22)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ILwq;I)V", line = 66)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(II)[[I", line = 109)
    ...
    @OriginalMember(owner = "client!sq", name = "d", descriptor = "(I)V", line = 160)
