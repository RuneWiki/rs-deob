...
public class class188 {
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(I)Lm;", line = 4)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(I)Lm;", line = 68)
    ...
    @OriginalMember(owner = "client!kk", name = "c", descriptor = "(I)I", line = 81)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(B)Lm;", line = 120)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(JLm;B)V", line = 153)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(BJ)Lm;", line = 175)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "([Lm;I)I", line = 205)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(BLee;)Llaa;", line = 236)
    ...
    @OriginalMember(owner = "client!kk", name = "d", descriptor = "(I)I", line = 249)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(I)V", line = 261)
