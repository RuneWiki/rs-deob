...
public class class188 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(ILco;I)V")
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(ILco;)V")
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(II)I")
