...
public class class188 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Ljk;IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IZJII)Ljava/lang/String;", line = 57)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IB)Ljava/lang/String;", line = 150)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IIIIIILjava/lang/String;)V", line = 198)
