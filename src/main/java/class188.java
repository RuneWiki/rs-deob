...
public class class188 {
    ...
    @OriginalMember(owner = "client!ao", name = "toString", descriptor = "()Ljava/lang/String;", line = 5)
    public final String toString() {
        field2783++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(II)V", line = 27)
    public class188(int arg0, int arg1) {
        this.field2785 = arg1;
        this.field2782 = arg0;
    }

    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(B)I", line = 36)
