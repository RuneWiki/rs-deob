...
public class class188 {
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(ILbc;Lfo;IZLnd;[Lnm;Lof;IILfo;ILr;Lme;IIILoq;ILgm;[I)Lda;")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IILr;I)V")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(ILr;Lgm;Lof;Loq;Lfo;ILme;ILbc;IB)Lda;")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(BLbc;II)V")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(BIILgm;)V")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IIIIIIILgm;Lfo;Loq;ILr;)Lda;")
