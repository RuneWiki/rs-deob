...
public class class188 extends class33 implements class438 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(ILqa;IIZLse;I)V")
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(BILqa;)Lr;")
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(BLqa;)Led;")
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(ILqa;)Llb;")
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(ILqa;IB)Z")
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "(Lqa;Lih;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(Lqa;B)V")
