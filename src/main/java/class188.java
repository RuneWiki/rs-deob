...
public class class188 implements Runnable {
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(ICI)I", line = 5)
    ...
    @OriginalMember(owner = "client!mu", name = "run", descriptor = "()V", line = 28)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Lol;I)V", line = 73)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Llt;I)V", line = 88)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Ltq;B)Ltq;", line = 124)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(IBI)I", line = 154)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BLjava/lang/String;)Lmh;", line = 168)
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(I)V", line = 190)
    ...
    @OriginalMember(owner = "client!mu", name = "c", descriptor = "(I)V", line = 205)
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "()V", line = 259)
    public class188() {
