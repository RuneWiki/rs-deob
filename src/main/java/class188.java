...
public class class188 {
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(II)I", line = 8)
    public static final int method1306(int arg0, int arg1) {
        field2713++;
        return arg0 <= 51 ? 24 : arg1 >>> 10;
    }

    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IBII)V", line = 19)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(ZI)V", line = 56)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IIIIIIB)V", line = 312)
