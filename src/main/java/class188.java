...
public class class188 extends class393 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ZLai;)V", line = 24)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(IIILde;Lde;)V", line = 71)
    ...
    @OriginalMember(owner = "client!tm", name = "b", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(IIIIIIBIII)V", line = 92)
