...
public class class188 extends class118 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lts;)V", line = 4)
    public final void method717(class33 arg0) {
    }

    @OriginalMember(owner = "client!co", name = "g", descriptor = "()I", line = 10)
    ...
    @OriginalMember(owner = "client!co", name = "u", descriptor = "()I", line = 15)
    public final int method751() {
        return this.field2210;
    }

    @OriginalMember(owner = "client!co", name = "b", descriptor = "(IIII)V", line = 17)
    public final void method766(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!co", name = "L", descriptor = "()I", line = 22)
    public final int method788() {
        return 0;
    }

    @OriginalMember(owner = "client!co", name = "f", descriptor = "(IIIIII)Z", line = 26)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(II[I[I)Lem;", line = 57)
    public final class423 method786(int arg0, int arg1, int[] arg2, int[] arg3) {
        return new class80(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!co", name = "d", descriptor = "(II)V", line = 60)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lfa;[Liq;Z)Lak;", line = 85)
    ...
    @OriginalMember(owner = "client!co", name = "d", descriptor = "(I)V", line = 115)
    public final void method743(int arg0) {
        this.field2182[arg0].method38((Runnable) null, (byte) 28);
    }

    @OriginalMember(owner = "client!co", name = "b", descriptor = "(IIIII)V", line = 118)
    ...
    @OriginalMember(owner = "client!co", name = "b", descriptor = "(III)V", line = 190)
    ...
    @OriginalMember(owner = "client!co", name = "e", descriptor = "(IIII)V", line = 196)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "()Z", line = 204)
    public final boolean method1158() {
        return this.field2174;
    }

    @OriginalMember(owner = "client!co", name = "y", descriptor = "()Z", line = 210)
    public final boolean method762() {
        return false;
    }

    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIIIIII)V", line = 214)
    ...
    @OriginalMember(owner = "client!co", name = "b", descriptor = "()V", line = 283)
    ...
    @OriginalMember(owner = "client!co", name = "c", descriptor = "(II)V", line = 293)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lge;Lsk;Lwr;Lfi;I)V", line = 300)
    ...
    @OriginalMember(owner = "client!co", name = "c", descriptor = "(I)V", line = 303)
    public final void method728(int arg0) {
        this.method789(0, 0, this.field2194, this.field2179, arg0, 0);
    }

    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIIIIILem;II)V", line = 307)
    ...
    @OriginalMember(owner = "client!co", name = "o", descriptor = "()V", line = 544)
    public final void method727() {
    }

    @OriginalMember(owner = "client!co", name = "b", descriptor = "(I)V", line = 549)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Ljava/lang/Runnable;)Lde;", line = 582)
    ...
    @OriginalMember(owner = "client!co", name = "c", descriptor = "()V", line = 596)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IFFFFF)V", line = 620)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIIIII[BII)V", line = 629)
    ...
    @OriginalMember(owner = "client!co", name = "G", descriptor = "()I", line = 805)
    ...
    @OriginalMember(owner = "client!co", name = "J", descriptor = "()Z", line = 812)
    public final boolean method783() {
        return true;
    }

    @OriginalMember(owner = "client!co", name = "j", descriptor = "()Z", line = 815)
    public final boolean method711() {
        return false;
    }

    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lac;)V", line = 817)
    public final void method724(class197 arg0) {
    }

    @OriginalMember(owner = "client!co", name = "q", descriptor = "()V", line = 820)
    ...
    @OriginalMember(owner = "client!co", name = "E", descriptor = "()I", line = 827)
    public final int method775() {
        return 0;
    }

    @OriginalMember(owner = "client!co", name = "i", descriptor = "(I)Z", line = 830)
    public final boolean method1162(int arg0) {
        return this.field2211 || this.field2202.method960(arg0, (byte) -40).field4856;
    }

    @OriginalMember(owner = "client!co", name = "j", descriptor = "(I)I", line = 836)
    public final int method1163(int arg0) {
        return this.field2202.method960(arg0, (byte) -40).field4864 & 65535;
    }

    @OriginalMember(owner = "client!co", name = "k", descriptor = "(I)[I", line = 840)
    ...
    @OriginalMember(owner = "client!co", name = "f", descriptor = "()V", line = 860)
    public final void method694() {
        this.field2213.method2298(0);
    }

    @OriginalMember(owner = "client!co", name = "K", descriptor = "()Z", line = 863)
    public final boolean method785() {
        return false;
    }

    @OriginalMember(owner = "client!co", name = "D", descriptor = "()I", line = 870)
    public final int method771() {
        return this.field2169;
    }

    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "(Ljava/awt/Canvas;Lgd;I)V", line = 2419)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lbp;III)V", line = 878)
    ...
    @OriginalMember(owner = "client!co", name = "z", descriptor = "()F", line = 921)
    public final float method764() {
        return this.field2177;
    }

    @OriginalMember(owner = "client!co", name = "v", descriptor = "()V", line = 924)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(FF)V", line = 936)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(II)I", line = 941)
    public final int method707(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!co", name = "p", descriptor = "()V", line = 945)
    ...
    @OriginalMember(owner = "client!co", name = "h", descriptor = "()Z", line = 957)
    public final boolean method708() {
        return false;
    }

    @OriginalMember(owner = "client!co", name = "l", descriptor = "(I)Z", line = 960)
    public final boolean method1166(int arg0) {
        return this.field2202.method960(arg0, (byte) -40).field4854;
    }

    @OriginalMember(owner = "client!co", name = "d", descriptor = "(IIII)V", line = 963)
    ...
    @OriginalMember(owner = "client!co", name = "m", descriptor = "(I)[I", line = 983)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 1003)
    ...
    @OriginalMember(owner = "client!co", name = "I", descriptor = "()Z", line = 1030)
    public final boolean method781() {
        return false;
    }

    @OriginalMember(owner = "client!co", name = "b", descriptor = "(Z)V", line = 1033)
    public final void method755(boolean arg0) {
    }

    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIIIIIIIII)V", line = 1037)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ILem;II)V", line = 1072)
    ...
    @OriginalMember(owner = "client!co", name = "B", descriptor = "()Lwr;", line = 1129)
    public final class450 method769() {
        return new class331();
    }

    @OriginalMember(owner = "client!co", name = "f", descriptor = "(I)Lac;", line = 1132)
    public final class197 method758(int arg0) {
        return null;
    }

    @OriginalMember(owner = "client!co", name = "b", descriptor = "(II)I", line = 1135)
    public final int method721(int arg0, int arg1) {
        int var3 = arg0 | 66560;
        return var3 & arg1 ^ arg1;
    }

    @OriginalMember(owner = "client!co", name = "a", descriptor = "([I)V", line = 1141)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "([IIIII)Lc;", line = 1151)
    ...
    @OriginalMember(owner = "client!co", name = "n", descriptor = "(I)Z", line = 1189)
    public final boolean method1168(int arg0) {
        return this.field2202.method963(arg0, true);
    }

    @OriginalMember(owner = "client!co", name = "a", descriptor = "(F)V", line = 1192)
    public final void method688(float arg0) {
        this.field2193 = (int) (arg0 * 65535.0F);
    }

    @OriginalMember(owner = "client!co", name = "c", descriptor = "(IIII)V", line = 1205)
    ...
    @OriginalMember(owner = "client!co", name = "r", descriptor = "()V", line = 1219)
    public final void method735() {
    }

    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Z)V", line = 1222)
    public final void method690(boolean arg0) {
    }

    @OriginalMember(owner = "client!co", name = "l", descriptor = "()Z", line = 1225)
    public final boolean method723() {
        return false;
    }

    @OriginalMember(owner = "client!co", name = "i", descriptor = "()V", line = 1228)
    public final void method710() {
        this.field2175 = this.field2168;
        this.field2190 = false;
    }

    @OriginalMember(owner = "client!co", name = "d", descriptor = "()Z", line = 1233)
    public final boolean method689() {
        return true;
    }

    @OriginalMember(owner = "client!co", name = "a", descriptor = "(III)V", line = 1236)
    ...
    @OriginalMember(owner = "client!co", name = "M", descriptor = "()V", line = 1244)
    ...
    @OriginalMember(owner = "client!co", name = "t", descriptor = "()Lwr;", line = 1286)
    public final class450 method742() {
        class8 var1 = this.method1160(Thread.currentThread());
        return var1.field69;
    }

    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lsk;)V", line = 1291)
    ...
    @OriginalMember(owner = "client!co", name = "H", descriptor = "()Z", line = 1330)
    public final boolean method779() {
        return false;
    }

    @OriginalMember(owner = "client!co", name = "b", descriptor = "(IIIIII)V", line = 1333)
    ...
    @OriginalMember(owner = "client!co", name = "c", descriptor = "(IIIII)V", line = 1550)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIII)[I", line = 1837)
    ...
    @OriginalMember(owner = "client!co", name = "d", descriptor = "(IIIIII)Lts;", line = 1867)
    public final class33 method763(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!co", name = "a", descriptor = "(II[[I[[IIII)Lip;", line = 1870)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 1873)
    public final void method693(Canvas arg0) {
        this.field2172 = arg0;
        this.method776();
    }

    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIIIZ)Lc;", line = 1879)
    ...
    @OriginalMember(owner = "client!co", name = "c", descriptor = "(Z)V", line = 1911)
    public final void method787(boolean arg0) {
        this.field2211 = arg0;
        this.field2213.method2298(0);
    }

    @OriginalMember(owner = "client!co", name = "g", descriptor = "(I)V", line = 1915)
    public final void method759(int arg0) {
        this.field2182[arg0].method38(Thread.currentThread(), (byte) 28);
    }

    @OriginalMember(owner = "client!co", name = "x", descriptor = "()Z", line = 1921)
    public final boolean method761() {
        return true;
    }

    @OriginalMember(owner = "client!co", name = "a", descriptor = "(I)V", line = 1927)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(I[Lsi;)V", line = 1942)
    public final void method784(int arg0, class92[] arg1) {
    }

    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Liq;Z)Lc;", line = 1946)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lwr;)V", line = 2048)
    public final void method749(class450 arg0) {
        this.field2201 = (class331) arg0;
    }

    @OriginalMember(owner = "client!co", name = "A", descriptor = "()V", line = 2052)
    public final void method765() {
    }

    @OriginalMember(owner = "client!co", name = "e", descriptor = "(IIIIII)V", line = 2055)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIIII)V", line = 2190)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(FFF)V", line = 2265)
    public final void method777(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!co", name = "e", descriptor = "()Z", line = 2268)
    public final boolean method692() {
        return false;
    }

    @OriginalMember(owner = "client!co", name = "w", descriptor = "()F", line = 2272)
    public final float method760() {
        return this.field2203;
    }

    @OriginalMember(owner = "client!co", name = "s", descriptor = "()Z", line = 2279)
    public final boolean method740() {
        return false;
    }

    @OriginalMember(owner = "client!co", name = "k", descriptor = "()Z", line = 2287)
    public final boolean method714() {
        return false;
    }

    @OriginalMember(owner = "client!co", name = "C", descriptor = "()Z", line = 2301)
    public final boolean method770() {
        return true;
    }

    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lhf;IIII)Lge;", line = 2307)
    ...
    @OriginalMember(owner = "client!co", name = "c", descriptor = "(IIIIII)V", line = 2311)
    ...
    @OriginalMember(owner = "client!co", name = "n", descriptor = "()Z", line = 2317)
    public final boolean method726() {
        return false;
    }

    @OriginalMember(owner = "client!co", name = "F", descriptor = "()V", line = 2320)
    ...
    @OriginalMember(owner = "client!co", name = "m", descriptor = "()V", line = 2343)
    public final void method725() {
    }

    @OriginalMember(owner = "client!co", name = "a", descriptor = "(III[I)V", line = 2354)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "([Lge;Lwr;[Lfi;I)V", line = 2385)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "([Lge;Lsk;Lwr;[Lfi;I)V", line = 2401)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lts;Lts;FLts;)Lts;", line = 2417)
