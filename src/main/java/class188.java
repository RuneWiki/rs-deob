...
public class class188 extends class98 {
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(III)I", line = 10)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "()V", line = 24)
    public class188() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(II)[I", line = 31)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Ljj;IILae;Lnd;IILli;)V", line = 65)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIIII)V", line = 114)
