...
public abstract class class188 extends class361 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(B[Lada;)I")
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(BLfd;ZILfd;)I")
    ...
    @OriginalMember(owner = "client!vp", name = "g", descriptor = "(B)V")
