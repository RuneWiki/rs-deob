...
public class class188 extends class377 {
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(Luf;B)Luf;")
    ...
    @OriginalMember(owner = "client!cfa", name = "<init>", descriptor = "(Llea;IIII)V")
    ...
    @OriginalMember(owner = "client!cfa", name = "d", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!cfa", name = "<init>", descriptor = "(Llea;IIII[BI)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
