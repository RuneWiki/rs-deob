...
public class class188 extends class739 {
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(Ljava/lang/String;Z)Z", line = 5)
    ...
    @OriginalMember(owner = "client!hba", name = "<init>", descriptor = "()V", line = 161)
    public class188() {
        super(1, false);
    }

    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(Lsl;IB)V", line = 54)
    ...
    @OriginalMember(owner = "client!hba", name = "b", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!hba", name = "b", descriptor = "(II)[[I", line = 110)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(ZI)[I", line = 166)
