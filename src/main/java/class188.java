...
public class class188 extends class246 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ZI)V", line = 58)
    ...
    @OriginalMember(owner = "client!ko", name = "c", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILfg;I)V", line = 83)
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(Lpg;)V", line = 198)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Ldk;IIZII)V", line = 99)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IBII[I)V", line = 119)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(BII)V", line = 152)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ZB)V", line = 168)
