...
public class class188 extends class35 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IIIBLbn;Lbq;ZLja;II)Lrc;", line = 4)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IZB[I[I)J", line = 237)
    ...
    @OriginalMember(owner = "client!tp", name = "c", descriptor = "(I)V", line = 290)
