...
public abstract class class188 extends class9 {
    ...
    @OriginalMember(owner = "client!bea", name = "f", descriptor = "(B)V", line = 12)
    public static void method1026(byte arg0) {
        int var1 = -112 / ((arg0 + 27) / 60);
        field2260 = null;
    }

    @OriginalMember(owner = "client!bea", name = "c", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!bea", name = "<init>", descriptor = "(I)V", line = 56)
