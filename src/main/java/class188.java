...
public class class188 extends class2 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(BLps;)Z", line = 35)
    ...
    @OriginalMember(owner = "client!tp", name = "b", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(II[I[I)V", line = 114)
