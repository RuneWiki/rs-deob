...
public class class188 extends class293 implements class83 {
    ...
    @OriginalMember(owner = "client!lw", name = "c", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!lw", name = "i", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(B)I", line = 27)
    ...
    @OriginalMember(owner = "client!lw", name = "e", descriptor = "(I)Z", line = 39)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(ILr;ILcaa;ZII)V", line = 55)
    ...
    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(I)I", line = 87)
    ...
    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(Lr;I)V", line = 98)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Lr;I)Lhr;", line = 108)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IBLr;)Lda;", line = 139)
    ...
    @OriginalMember(owner = "client!lw", name = "h", descriptor = "(I)Z", line = 162)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Lr;Z)V", line = 176)
    ...
    @OriginalMember(owner = "client!lw", name = "<init>", descriptor = "(Lr;Llt;IIIIIZIIIIIIZ)V", line = 204)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(BLr;)V", line = 236)
    ...
    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(Z)I", line = 267)
    ...
    @OriginalMember(owner = "client!lw", name = "d", descriptor = "(Z)Z", line = 284)
    ...
    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(II)Z", line = 295)
    ...
    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(B)I", line = 306)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IIZLr;)Z", line = 317)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Ldc;IBLr;I)V", line = 341)
    ...
    @OriginalMember(owner = "client!lw", name = "f", descriptor = "(I)I", line = 376)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(I)V", line = 388)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IILr;Z)Ldg;", line = 408)
    ...
    @OriginalMember(owner = "client!lw", name = "c", descriptor = "(Lr;I)Lifa;", line = 439)
    ...
    @OriginalMember(owner = "client!lw", name = "j", descriptor = "(I)I", line = 457)
    ...
    @OriginalMember(owner = "client!lw", name = "d", descriptor = "(B)V", line = 477)
