...
public class class188 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IZZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 46)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(BI)Z", line = 59)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IBI)V", line = 73)
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Lbv;)V", line = 143)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lkv;II)Z", line = 99)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(I)V", line = 124)
