...
public class class188 {
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(Lev;)V")
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(Lev;I)V")
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(Lpc;I)V")
