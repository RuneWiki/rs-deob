...
public class class656 {
    ...
    @OriginalMember(owner = "client!ms", name = "b", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!ms", name = "c", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 74)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(III)Z", line = 179)
