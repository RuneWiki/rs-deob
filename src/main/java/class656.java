...
public class class656 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(BLiaa;)V", line = 10)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IIIZIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ZILjava/lang/String;J)V", line = 618)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(BILiaa;)V", line = 683)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(B)V", line = 714)
