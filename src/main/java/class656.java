...
public class class656 extends Canvas {
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 3)
    public class656(Component arg0) {
        this.field9120 = arg0;
    }

    @OriginalMember(owner = "client!ed", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 16)
    public final void paint(Graphics arg0) {
        field9122++;
        this.field9120.paint(arg0);
    }

    @OriginalMember(owner = "client!ed", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 29)
    public final void update(Graphics arg0) {
        field9126++;
        this.field9120.update(arg0);
    }

    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(B)V", line = 38)
