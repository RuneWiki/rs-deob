...
public class class656 {
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Lol;B)V")
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(BLhi;)V")
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Lea;[I[I[IB)V")
    ...
    @OriginalMember(owner = "client!mda", name = "<init>", descriptor = "(Lol;)V")
