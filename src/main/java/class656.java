...
public abstract class class656 extends class202 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IBILrfa;ZILha;)V")
    ...
    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(Lha;B)Z")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(B[Lta;)I")
