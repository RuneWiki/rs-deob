...
public class class656 extends class260 {
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(ILgn;)V")
    public class656(int arg0, class729 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(Lgn;)V")
    public class656(class729 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ZLmea;IIB)V")
