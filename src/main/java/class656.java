...
public class class656 extends class167 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!qp", name = "c", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(Lfp;Led;)V", line = 37)
