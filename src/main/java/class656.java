...
public class class656 extends class252 {
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(Lbb;II)V")
    ...
    @OriginalMember(owner = "client!pw", name = "h", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!pw", name = "<init>", descriptor = "(Lhp;Lpu;Luk;)V")
