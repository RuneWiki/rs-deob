...
public class class656 {
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Lha;Lig;IIII[I[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Lha;IIII)V", line = 140)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "()V", line = 483)
    ...
    @OriginalMember(owner = "client!dv", name = "b", descriptor = "()V", line = 505)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Lha;Lm;IIII)V", line = 518)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Lha;IIIIIII[S[BZ)V", line = 523)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "([B[B[SII)V", line = 685)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IIIIIIII)V", line = 828)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(II)Lsc;", line = 841)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Ld;II)V", line = 859)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(I)Ldba;", line = 868)
    public static final class92 method3732(int arg0) {
        return (class92) field9352.method1754(false, (long) arg0);
    }

    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Loh;Lwea;Lfs;Llu;Lafa;Ldda;Lnf;)V", line = 871)
    ...
    @OriginalMember(owner = "client!dv", name = "c", descriptor = "()V", line = 904)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Lha;)V", line = 1061)
    ...
    @OriginalMember(owner = "client!dv", name = "b", descriptor = "(I)V", line = 1071)
    public static final void method3736(int arg0) {
        field9357 = (class92) field9352.method1754(false, (long) arg0);
    }

    @OriginalMember(owner = "client!dv", name = "b", descriptor = "(Lha;)Lbq;", line = 1078)
    ...
    @OriginalMember(owner = "client!dv", name = "d", descriptor = "()V", line = 1088)
    ...
    @OriginalMember(owner = "client!dv", name = "b", descriptor = "(II)Ldba;", line = 1118)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Lha;Lm;Laia;)V", line = 1131)
    ...
    @OriginalMember(owner = "client!dv", name = "e", descriptor = "()V", line = 1239)
    ...
    @OriginalMember(owner = "client!dv", name = "b", descriptor = "(Lha;IIII)Lbq;", line = 1253)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Lha;II)V", line = 1265)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Ld;III)I", line = 1452)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Lha;IIII[S[B)V", line = 1508)
