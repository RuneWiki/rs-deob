...
public class class656 extends class60 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ILha;Lkq;II)V")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ILbt;)V")
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(ILhd;)V")
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lhd;)V")
