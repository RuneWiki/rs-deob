...
public class class656 extends class331 {
    ...
    @OriginalMember(owner = "client!tfa", name = "b", descriptor = "(II)I", line = 24)
    ...
    @OriginalMember(owner = "client!tfa", name = "c", descriptor = "(B)I", line = 39)
    ...
    @OriginalMember(owner = "client!tfa", name = "<init>", descriptor = "(Lts;)V", line = 50)
    public class656(class41 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!tfa", name = "b", descriptor = "(B)I", line = 53)
    public final int method226(byte arg0) {
        ++field9021;
        return arg0 != 13 ? 68 : 1;
    }

    @OriginalMember(owner = "client!tfa", name = "<init>", descriptor = "(ILts;)V", line = 66)
    public class656(int arg0, class41 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!tfa", name = "d", descriptor = "(B)Z", line = 69)
    ...
    @OriginalMember(owner = "client!tfa", name = "c", descriptor = "(II)V", line = 82)
