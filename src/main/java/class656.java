...
public class class656 {
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(BIZIILri;Lqk;)V", line = 4)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!pw", name = "toString", descriptor = "()Ljava/lang/String;", line = 28)
