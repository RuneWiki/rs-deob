...
public class class656 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IILji;)V", line = 14)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Z)V", line = 82)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(ILha;Lkba;II)V", line = 94)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IZIIIIII)V", line = 133)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(BLem;)Ljava/lang/String;", line = 151)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(ZLha;)Lufa;", line = 184)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(ILha;)V", line = 222)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(II)Ljava/lang/String;", line = 281)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lha;I)Lufa;", line = 309)
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(ILha;)Lufa;", line = 338)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lji;I)V", line = 364)
    ...
    @OriginalMember(owner = "client!fj", name = "c", descriptor = "(ILha;)Lufa;", line = 385)
