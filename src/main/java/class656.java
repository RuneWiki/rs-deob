...
public class class656 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(II)Luj;", line = 4)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ILha;II)V", line = 35)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IB)V", line = 579)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Lcn;IZ)V", line = 598)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(JIBZ)Ljava/lang/String;", line = 630)
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(I)V", line = 663)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(B)V", line = 675)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ILjava/util/Random;B)I", line = 689)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(I)V", line = 727)
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(Lto;ILla;Lla;)V", line = 747)
