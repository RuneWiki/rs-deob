...
public class class656 extends class337 {
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(IIIBI)V", line = 4)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(Lsj;II)V", line = 17)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(I)V", line = 335)
    ...
    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "(Lkfa;IIZ[[I)V", line = 355)
    ...
    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "(Lkfa;IIZ[[BI)V", line = 391)
    ...
    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "(Lkfa;II)V", line = 410)
