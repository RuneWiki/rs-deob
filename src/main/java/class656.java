...
public class class656 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Ldc;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(B)Ldu;", line = 35)
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!sn", name = "c", descriptor = "(I)Ldu;", line = 147)
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "()V", line = 168)
    public class656() {
    }

    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(Ldc;)V", line = 176)
