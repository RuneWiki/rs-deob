...
public class class656 {
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(BLjava/lang/String;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "([BI)V", line = 20)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "([Ljava/lang/String;B)[Ljava/lang/String;", line = 211)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(I)V", line = 241)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IILoea;Ljava/lang/String;)Lgn;", line = 252)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Z)V", line = 293)
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "([BI[B)V", line = 346)
