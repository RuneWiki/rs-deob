...
public class class656 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(II)Lgk;", line = 3)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(II)Lcl;", line = 65)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IIIBLeu;I)V", line = 133)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(BI)V", line = 394)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(I)V", line = 409)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Lcr;ILla;)V", line = 428)
