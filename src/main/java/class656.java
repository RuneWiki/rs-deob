...
public class class656 implements class691 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Lkk;III)V")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IILmt;)V")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Lbq;III)V")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IILbq;)V")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ILkk;IIB)V")
    ...
    @OriginalMember(owner = "client!mj", name = "<init>", descriptor = "(Lbi;)V")
