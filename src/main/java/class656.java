...
public class class656 extends class545 {
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(BZ)V", line = 15)
    ...
    @OriginalMember(owner = "client!mw", name = "i", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(IILec;)V", line = 42)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(ZZ)V", line = 53)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(III)V", line = 70)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!mw", name = "<init>", descriptor = "(Lmba;Lla;Lur;)V", line = 110)
    ...
    @OriginalMember(owner = "client!mw", name = "b", descriptor = "(I)Z", line = 126)
