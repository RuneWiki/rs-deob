...
public class class377 extends class192 {
    ...
    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "()V", line = 3)
    public class377() {
        super(1, false);
    }

    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ILfd;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!de", name = "b", descriptor = "(III)Lpga;", line = 27)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(IB)[I", line = 38)
    ...
    @OriginalMember(owner = "client!de", name = "b", descriptor = "(IB)[[I", line = 70)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Lwk;IZ)V", line = 116)
    ...
    @OriginalMember(owner = "client!de", name = "e", descriptor = "(B)V", line = 184)
    ...
    @OriginalMember(owner = "client!de", name = "c", descriptor = "(I)V", line = 216)
    ...
    @OriginalMember(owner = "client!de", name = "f", descriptor = "(B)V", line = 232)
