...
public abstract class class377 {
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(ZI)Lmt;", line = 3)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(ILmh;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!e", name = "b", descriptor = "(III)Z", line = 83)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(B)V", line = 102)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(ILmh;IIIZI[IIILmh;)V", line = 121)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "([IILgg;Lnb;ZIIZ[ZLnb;II)V", line = 159)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(ZILmh;II[ZLmh;ILmh;IIIIILmh;)V", line = 369)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(IIIIIILya;II)V", line = 426)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(ZLjg;)V", line = 555)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(BIILmh;IIIZLmh;)V", line = 596)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(IZ[IIIIII[II)V", line = 637)
