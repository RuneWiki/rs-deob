...
public class class377 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ILj;II)V")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Lj;III)Z")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Lj;IIZ)V")
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(Lht;Ljt;)V")
