...
public class class377 implements class493 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(I)I", line = 8)
    ...
    @OriginalMember(owner = "client!pe", name = "b", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(B)[Ljv;", line = 60)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(I[IJLlp;)Ljava/lang/String;", line = 72)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(ILuca;IBILoa;)V", line = 106)
