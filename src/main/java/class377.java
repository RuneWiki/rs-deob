...
public class class377 extends class623 {
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 358)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IIB)Z", line = 34)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(II[IB)Z", line = 59)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IIIIIIIIII)V", line = 86)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IZ[II)Z", line = 163)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "([IIIII)Z", line = 189)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Ljava/lang/String;BIZ)Z", line = 230)
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(B)V", line = 304)
