...
public abstract class class377 extends class200 {
    ...
    @OriginalMember(owner = "client!j", name = "e", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "()V", line = 17)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lle;Lle;I)V", line = 268)
