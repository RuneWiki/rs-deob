...
public class class377 extends class406 {
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(Lnd;)V", line = 176)
    public class377(class324 arg0) {
        this.field5315 = arg0;
    }

    @OriginalMember(owner = "client!sn", name = "a", descriptor = "([II[Ljava/lang/Object;II)V", line = 11)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(III)Z", line = 64)
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(I)Z", line = 91)
    ...
    @OriginalMember(owner = "client!sn", name = "c", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!sn", name = "d", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IB)V", line = 184)
