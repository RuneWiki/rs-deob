...
public class class377 extends class354 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Z)I", line = 3)
    ...
    @OriginalMember(owner = "client!tp", name = "h", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IB)[[I", line = 29)
    ...
    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "()V", line = 98)
    public class377() {
        super(0, false);
    }

    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Lnj;II)V", line = 102)
    ...
    @OriginalMember(owner = "client!tp", name = "b", descriptor = "(B)Z", line = 122)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(II)I", line = 161)
