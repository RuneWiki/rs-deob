...
public class class377 extends class117 implements class503 {
    ...
    @OriginalMember(owner = "client!ac", name = "c", descriptor = "(ILya;)V")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIIILlh;I)V")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Lya;ZLhq;Lcu;)V")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Lya;IZLij;III)V")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ZILya;I)Z")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Lya;B)Lmf;")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ILya;)V")
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(ILya;)V")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(BLya;I)Lt;")
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(IIILei;)V")
