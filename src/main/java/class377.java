...
public class class377 extends class86 {
    ...
    @OriginalMember(owner = "client!jh", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!jh", name = "c", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!jh", name = "d", descriptor = "(B)I", line = 31)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IIBI)V", line = 41)
    ...
    @OriginalMember(owner = "client!jh", name = "e", descriptor = "(B)J", line = 73)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 83)
    ...
    @OriginalMember(owner = "client!jh", name = "d", descriptor = "(I)I", line = 118)
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "(II)V", line = 136)
