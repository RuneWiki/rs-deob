...
public class class377 {
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(Ljava/lang/Object;ILwt;)V", line = 18)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(ILwt;BLjava/lang/Object;)V", line = 34)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(Lwt;I)V", line = 114)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(IZ)V", line = 144)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(Law;I)V", line = 191)
    ...
    @OriginalMember(owner = "client!mga", name = "b", descriptor = "(B)I", line = 208)
    ...
    @OriginalMember(owner = "client!mga", name = "b", descriptor = "(I)V", line = 219)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(ILwt;)Ljava/lang/Object;", line = 242)
    ...
    @OriginalMember(owner = "client!mga", name = "<init>", descriptor = "(I)V", line = 305)
