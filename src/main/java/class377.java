...
public abstract class class377 implements class318 {
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(Z)Z", line = 19)
    ...
    @OriginalMember(owner = "client!afa", name = "b", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(ZB)V", line = 88)
    ...
    @OriginalMember(owner = "client!afa", name = "c", descriptor = "(B)I", line = 113)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(IIIIZI)V", line = 168)
    ...
    @OriginalMember(owner = "client!afa", name = "b", descriptor = "(I)V", line = 263)
    ...
    @OriginalMember(owner = "client!afa", name = "<init>", descriptor = "(Lla;Lla;Lada;)V", line = 274)
