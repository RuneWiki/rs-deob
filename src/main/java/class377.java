...
public class class377 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lvq;ZI)V")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ILrw;Lmo;)Lwaa;")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ILmo;)V")
