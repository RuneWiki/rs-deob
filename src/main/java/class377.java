...
public class class377 extends class412 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Lqq;BII)Z")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(BLqq;)Lkm;")
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(ZLqq;)V")
