...
public class class377 {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IIIIIILha;IIIII[[[B)V", line = 4)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Leo;Z)V", line = 40)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(BI)Len;", line = 60)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(B)V", line = 106)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IZI)Z", line = 120)
    ...
    @OriginalMember(owner = "client!oj", name = "b", descriptor = "(I)V", line = 143)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(II)V", line = 162)
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "(Lcw;ILeq;)V", line = 177)
