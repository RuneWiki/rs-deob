...
public class class377 extends class62 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lgw;II)V")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lk;III[Z)Z")
