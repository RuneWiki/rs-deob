...
public class class377 {
    ...
    @OriginalMember(owner = "client!ws", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(IZ)V", line = 25)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Le;Z)V", line = 54)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(I)V", line = 88)
