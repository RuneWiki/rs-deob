...
public class class377 {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(BLqda;)Lida;")
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(ZLni;B)V")
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Lni;B)V")
