...
public class class377 extends class512 {
    ...
    @OriginalMember(owner = "client!afa", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!afa", name = "e", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(ZZ)V", line = 39)
    ...
    @OriginalMember(owner = "client!afa", name = "<init>", descriptor = "(Lrd;Lwu;Ljo;)V", line = 48)
    ...
    @OriginalMember(owner = "client!afa", name = "e", descriptor = "(I)Z", line = 66)
    public final boolean method35(int arg0) {
        int var2 = 49 / ((-arg0 - 72) / 37);
        return this.field5257 != null;
    }

    @OriginalMember(owner = "client!afa", name = "d", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!afa", name = "c", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!afa", name = "c", descriptor = "(B)V", line = 122)
    ...
    @OriginalMember(owner = "client!afa", name = "d", descriptor = "(B)V", line = 140)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(IILlo;)V", line = 174)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(IZ)V", line = 183)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(IIZ)V", line = 202)
