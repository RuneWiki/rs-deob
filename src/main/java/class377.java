...
public abstract class class377 extends class85 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Lbt;II)V", line = 7)
    ...
    @OriginalMember(owner = "client!jo", name = "f", descriptor = "(I)[Lvg;", line = 27)
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(I)V", line = 43)
    public class377(int arg0) {
        this.field4898 = arg0;
    }

    @OriginalMember(owner = "client!jo", name = "e", descriptor = "(B)V", line = 55)
