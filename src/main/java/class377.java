...
public class class377 extends class513 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IB)I", line = 7)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(FFFI)F", line = 158)
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZ)V", line = 168)
