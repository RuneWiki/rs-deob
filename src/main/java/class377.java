...
public class class377 {
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Z)Lmv;", line = 3)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(ILmv;)V", line = 21)
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(I)V", line = 45)
    public class377(int arg0) {
        this.field4824 = arg0;
    }

    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(IIIIII)V", line = 52)
