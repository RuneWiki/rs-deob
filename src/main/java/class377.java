...
public class class377 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Ljava/lang/String;IIII[B)I", line = 8)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(B)V", line = 146)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(II)Z", line = 170)
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 181)
