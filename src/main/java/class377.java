...
public class class377 extends class694 {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(ZII)Lfn;")
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(B)Lega;")
    ...
    @OriginalMember(owner = "client!du", name = "<init>", descriptor = "(ILrt;Lrt;Lus;Lma;I[BIZ)V")
