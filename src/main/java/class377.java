...
public abstract class class377 extends class61 {
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(Lgda;Lha;IIZII)V")
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(B[Lkp;)I")
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(Lha;B)Z")
