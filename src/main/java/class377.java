...
public class class377 extends class518 {
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(I)F", line = 3)
    public final float method2438(int arg0) {
        ++field5707;
        return arg0 >= -9 ? -1.0017077F : this.field5700;
    }

    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 14)
    public class377(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Z)F", line = 94)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(I)V", line = 111)
    public final void method1165(int arg0) {
        int var2 = 25 % ((63 - arg0) / 49);
        ++field5709;
    }

    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(III)Z", line = 126)
    ...
    @OriginalMember(owner = "client!ku", name = "c", descriptor = "(I)Ljava/lang/String;", line = 141)
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(B)Ljava/lang/String;", line = 156)
