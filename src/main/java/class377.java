...
public class class377 extends class348 {
    ...
    @OriginalMember(owner = "client!rm", name = "c", descriptor = "()Lgh;")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ILtr;I)V")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(I[ILtr;IBI)V")
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "()Lgh;")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ILgh;)V")
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(Lln;)V")
