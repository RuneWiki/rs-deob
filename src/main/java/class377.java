...
public class class377 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(IILr;I)V")
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(ILr;II)Z")
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "(IILr;I)V")
    ...
    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "(Lck;Llc;)V")
