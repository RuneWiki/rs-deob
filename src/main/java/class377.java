...
public class class377 extends class30 {
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IB)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "()V", line = 45)
    public class377() {
        super(1, false);
    }

    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(BILac;)V", line = 53)
    ...
    @OriginalMember(owner = "client!dg", name = "c", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(III)V", line = 81)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(II)[I", line = 160)
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(Z)V", line = 195)
    ...
    @OriginalMember(owner = "client!dg", name = "d", descriptor = "(I)V", line = 226)
