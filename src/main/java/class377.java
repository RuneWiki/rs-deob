...
public class class377 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(BI)I", line = 5)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(Lua;B)V", line = 23)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IIIBI)V", line = 46)
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "(Lrv;)V", line = 135)
    public class377(class120 arg0) {
        this.method2334(68, arg0);
    }

    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(ILrv;)V", line = 90)
