...
public abstract class class377 extends class271 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "([BI)[B", line = 20)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IZII)I", line = 59)
