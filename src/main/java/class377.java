...
public class class377 extends class116 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(FFFFFFLpa;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(ILua;)V", line = 96)
    ...
    @OriginalMember(owner = "client!nk", name = "CA", descriptor = "(FFFFFFIII)V", line = 113)
    ...
    @OriginalMember(owner = "client!nk", name = "c", descriptor = "()I", line = 184)
    public final int method718() {
        field5531++;
        return this.field5538.field4035;
    }

    @OriginalMember(owner = "client!nk", name = "i", descriptor = "(IIIIIII)V", line = 194)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(Z)V", line = 332)
    ...
    @OriginalMember(owner = "client!nk", name = "EA", descriptor = "()I", line = 349)
    public final int method722() {
        field5518++;
        return this.field5538.field4035 + this.field5535 + this.field5540;
    }

    @OriginalMember(owner = "client!nk", name = "BA", descriptor = "(III)V", line = 357)
    ...
    @OriginalMember(owner = "client!nk", name = "la", descriptor = "()I", line = 380)
    public final int method721() {
        field5527++;
        return this.field5538.field4043;
    }

    @OriginalMember(owner = "client!nk", name = "ra", descriptor = "(IIIIIII)V", line = 393)
    ...
    @OriginalMember(owner = "client!nk", name = "b", descriptor = "(II)V", line = 497)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(IILpa;II)V", line = 534)
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(Los;IIII)V", line = 739)
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(Los;II[III)V", line = 750)
    ...
    @OriginalMember(owner = "client!nk", name = "ma", descriptor = "()I", line = 603)
    public final int method714() {
        field5522++;
        return this.field5538.field4043 - (-this.field5536 - this.field5542);
    }

    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(I)V", line = 611)
    ...
    @OriginalMember(owner = "client!nk", name = "KA", descriptor = "(IIII)V", line = 655)
    ...
    @OriginalMember(owner = "client!nk", name = "P", descriptor = "(IIIIII)V", line = 667)
    ...
    @OriginalMember(owner = "client!nk", name = "DA", descriptor = "(IIIII)V", line = 677)
