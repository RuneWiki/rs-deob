...
public class class377 extends class481 {
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lza;IZJI)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIILjava/lang/Class;)Ltn;")
    ...
    @OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lza;Lmf;Lbv;J)V")
