...
public class class377 extends class279 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lsi;[I)V")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lum;II)V")
    ...
    @OriginalMember(owner = "client!ef", name = "b", descriptor = "(Lgi;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lgi;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ef", name = "c", descriptor = "(Lgi;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IILgi;)Lgi;")
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(Lh;IIII[[I[[II)V")
