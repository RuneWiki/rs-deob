...
public class class377 {
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(IZI)V", line = 59)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(I)I", line = 90)
    ...
    @OriginalMember(owner = "client!ws", name = "b", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!ws", name = "c", descriptor = "(I)I", line = 149)
    ...
    @OriginalMember(owner = "client!ws", name = "d", descriptor = "(I)V", line = 168)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Lso;I)Lwo;", line = 179)
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "()V", line = 194)
    private class377() {
    }

    @OriginalMember(owner = "client!ws", name = "b", descriptor = "(B)V", line = 197)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(IIIIIIIIIILmb;I)Z", line = 345)
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "([I)V", line = 778)
