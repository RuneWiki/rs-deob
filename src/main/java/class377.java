...
public class class377 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(ILsf;IILha;)V", line = 3)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIIIZ)Z", line = 341)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IZI)Ljava/lang/String;", line = 365)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIIZB)Lik;", line = 381)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIIZIIIII)Z", line = 420)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(I)V", line = 453)
