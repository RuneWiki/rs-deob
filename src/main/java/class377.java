...
public class class377 {
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(IILos;)V", line = 5)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(BLos;)V", line = 20)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(IZI)V", line = 43)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(I)V", line = 65)
