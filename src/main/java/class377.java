...
public class class377 extends class513 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "([BB)[B", line = 5)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IBI)V", line = 21)
    ...
    @OriginalMember(owner = "client!nn", name = "e", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(III)V", line = 81)
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(IIIIIFFF)V", line = 117)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IIIIIIZ)V", line = 127)
    ...
    @OriginalMember(owner = "client!nn", name = "c", descriptor = "(I)V", line = 152)
