...
public abstract class class377 implements class200 {
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(II)V", line = 23)
    ...
    @OriginalMember(owner = "client!fga", name = "b", descriptor = "(I)I", line = 39)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(B)I", line = 52)
    ...
    @OriginalMember(owner = "client!fga", name = "c", descriptor = "(I)I", line = 69)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(BZ)V", line = 88)
    ...
    @OriginalMember(owner = "client!fga", name = "b", descriptor = "(B)V", line = 107)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(III)Z", line = 125)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(Z)Z", line = 138)
    ...
    @OriginalMember(owner = "client!fga", name = "<init>", descriptor = "(Llea;IIIZ)V", line = 219)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(Lgga;IZ)Lkia;", line = 169)
    ...
    @OriginalMember(owner = "client!fga", name = "finalize", descriptor = "()V", line = 187)
    ...
    @OriginalMember(owner = "client!fga", name = "c", descriptor = "(B)V", line = 199)
