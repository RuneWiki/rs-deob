...
public class class377 extends class130 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(ZII)V", line = 4)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!nt", name = "<init>", descriptor = "(Lcl;)V", line = 109)
    public class377(class53 arg0) {
        this.field5558 = arg0;
    }

    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(III)Z", line = 51)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IIII)V", line = 94)
