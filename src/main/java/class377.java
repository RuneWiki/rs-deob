...
public class class377 extends class362 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(I)Ll;")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(III)Lmm;")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ZLmb;)V")
    ...
    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "(ILuf;Luf;Lka;Lid;IIZ)V")
