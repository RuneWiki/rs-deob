...
public abstract class class377 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 11)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Lwa;ILwa;)V", line = 82)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IIILpn;)V", line = 107)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Ljava/awt/Color;Ljava/lang/String;ZLjava/awt/Color;IILjava/awt/Color;)V", line = 170)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Ljava/lang/String;IB)V", line = 248)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(BI)Lli;", line = 274)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(I)V", line = 304)
