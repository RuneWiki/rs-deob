...
public abstract class class377 extends class117 {
    ...
    @OriginalMember(owner = "client!j", name = "f", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(BILqf;)Z", line = 18)
    ...
    @OriginalMember(owner = "client!j", name = "g", descriptor = "(I)V", line = 180)
