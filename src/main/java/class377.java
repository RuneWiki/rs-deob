...
public class class377 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(BI)Lfn;", line = 37)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(II)V", line = 67)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "(Lee;ILul;)V", line = 113)
