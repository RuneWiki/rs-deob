...
public class class377 {
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(Lbi;II)Lqba;", line = 4)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "()I", line = 15)
    ...
    @OriginalMember(owner = "client!qba", name = "b", descriptor = "()[B", line = 61)
    ...
    @OriginalMember(owner = "client!qba", name = "c", descriptor = "()Lfc;", line = 121)
    ...
    @OriginalMember(owner = "client!qba", name = "<init>", descriptor = "(Leh;)V", line = 128)
    ...
    @OriginalMember(owner = "client!qba", name = "<init>", descriptor = "()V", line = 148)
    private class377() {
    }
}
