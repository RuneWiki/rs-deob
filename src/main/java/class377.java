...
public class class377 extends class346 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ILir;)V")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Lfb;ZI)V")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(III[Lsj;IIIIII)V")
