...
public class class377 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!jt", name = "b", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!jt", name = "d", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "(Lnm;Lec;III)V", line = 52)
