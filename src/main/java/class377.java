...
public class class377 extends class631 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(IILta;)V", line = 63)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(ZZ)V", line = 75)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Z)V", line = 94)
    ...
    @OriginalMember(owner = "client!ln", name = "b", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(Leea;Lrc;)V", line = 120)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(B)Z", line = 156)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "([I[IILvaa;[I)V", line = 166)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(IZ)V", line = 270)
