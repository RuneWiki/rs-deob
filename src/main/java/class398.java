...
public class class398 {
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(Ljava/awt/Component;)V")
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(IZ)Lve;")
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(IZLpda;)V")
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(ZLpda;)V")
