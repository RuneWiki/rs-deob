...
public class class398 extends class91 {
    ...
    @OriginalMember(owner = "client!lk", name = "h", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(BLsg;ILsg;)V", line = 16)
    ...
    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "(Lbl;)V", line = 174)
    public class398(class442 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IIILab;Lab;)V", line = 181)
    ...
    @OriginalMember(owner = "client!lk", name = "f", descriptor = "(I)Z", line = 190)
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(IZ)V", line = 201)
    ...
    @OriginalMember(owner = "client!lk", name = "d", descriptor = "(I)V", line = 212)
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(III)V", line = 233)
    ...
    @OriginalMember(owner = "client!lk", name = "d", descriptor = "(B)Z", line = 316)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(B)I", line = 353)
