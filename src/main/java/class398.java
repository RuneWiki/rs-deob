...
public class class398 {
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "([Loo;B)I")
    ...
    @OriginalMember(owner = "client!cv", name = "d", descriptor = "(I)Loo;")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(B)Loo;")
    ...
    @OriginalMember(owner = "client!cv", name = "f", descriptor = "(I)Loo;")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(IJ)Loo;")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(ILoo;J)V")
