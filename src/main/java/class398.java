...
public class class398 extends class666 {
    ...
    @OriginalMember(owner = "client!rp", name = "e", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IIIIIII)V", line = 79)
    ...
    @OriginalMember(owner = "client!rp", name = "b", descriptor = "(Z)V", line = 95)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IB)[[I", line = 106)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(ILiaa;Z)V", line = 149)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IIIBIII)I", line = 171)
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "()V", line = 203)
    public class398() {
        super(1, false);
    }

    @OriginalMember(owner = "client!rp", name = "b", descriptor = "(IIII)V", line = 206)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(II)[I", line = 222)
