...
public class class398 extends class334 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Ld;Ljava/awt/Canvas;BI)Lha;")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IIIJZIILgga;)V")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IZLol;)V")
