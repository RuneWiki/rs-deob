...
public class class398 extends class311 {
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(B)I", line = 27)
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(Lcb;II[B)V", line = 37)
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(Lcb;II[I)V", line = 50)
