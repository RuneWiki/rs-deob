...
public class class398 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(II)Lpca;", line = 31)
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Lmp;ILla;)V", line = 135)
    public class398(class315 arg0, int arg1, class423 arg2) {
        this.field5695 = arg2;
        this.field5695.method2616(5, 0);
    }

    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Lqk;IBI)V", line = 64)
