...
public class class398 extends class646 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "(I)V", line = 13)
    private class398(int arg0) {
        super(0, false);
        this.method2421(-20279, arg0);
    }

    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(ILjava/lang/String;)V", line = 23)
    ...
    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "()V", line = 90)
    public class398() {
        this(0);
    }

    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Lek;IB)V", line = 93)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(II)[[I", line = 120)
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(II)V", line = 160)
