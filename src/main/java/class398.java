...
public class class398 {
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(Lrl;)V", line = 668)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IBLrl;)V", line = 16)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Lrl;Z)V", line = 408)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(I)V", line = 421)
    ...
    @OriginalMember(owner = "client!hl", name = "b", descriptor = "(Lrl;Z)V", line = 435)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ZLrl;)V", line = 449)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ILrl;B)V", line = 463)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(B)V", line = 480)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Lik;IBLrl;)V", line = 492)
