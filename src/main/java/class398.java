...
public class class398 extends class362 {
    ...
    @OriginalMember(owner = "client!ku", name = "d", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(II)[I", line = 70)
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "()V", line = 388)
    public class398() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ku", name = "c", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Lfca;II)V", line = 412)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(I)V", line = 507)
