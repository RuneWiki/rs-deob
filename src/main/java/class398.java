...
public class class398 implements class249 {
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(ZIILje;)V", line = 5)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IBILui;ZII)V", line = 81)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(J[III)Ljava/lang/String;", line = 101)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(I)V", line = 136)
