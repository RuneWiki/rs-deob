...
public class class398 extends class407 {
    ...
    @OriginalMember(owner = "client!po", name = "d", descriptor = "()Lcv;", line = 3)
    public final class407 method511() {
        return (class407) this.field5622.method2660((byte) 67);
    }

    @OriginalMember(owner = "client!po", name = "e", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!po", name = "c", descriptor = "([III)V", line = 25)
    ...
    @OriginalMember(owner = "client!po", name = "f", descriptor = "()I", line = 39)
    public final synchronized int method2307() {
        return this.field5622.method2665(96);
    }

    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lju;)V", line = 44)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lcv;)V", line = 109)
    public final synchronized void method2309(class407 arg0) {
        this.field5622.method2658(arg0, false);
    }

    @OriginalMember(owner = "client!po", name = "b", descriptor = "()I", line = 114)
    public final int method518() {
        return 0;
    }

    @OriginalMember(owner = "client!po", name = "a", descriptor = "([III)V", line = 121)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lev;Lju;)V", line = 167)
    ...
    @OriginalMember(owner = "client!po", name = "e", descriptor = "(I)V", line = 176)
    ...
    @OriginalMember(owner = "client!po", name = "c", descriptor = "()Lcv;", line = 189)
    public final class407 method520() {
        return (class407) this.field5622.method2655(15152);
    }

    @OriginalMember(owner = "client!po", name = "b", descriptor = "(Lcv;)V", line = 198)
