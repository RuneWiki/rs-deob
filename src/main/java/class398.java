...
public abstract class class398 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lwg;II)V")
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(ZLwg;IILwg;[IIIIII)V")
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IZLwg;ILwg;IIII)V")
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "([IZIILir;[ZLgh;IIIZLgh;)V")
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lwg;IIZIILwg;ZLwg;Lwg;I[ZIII)V")
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IIIIIIILta;I)V")
    ...
    @OriginalMember(owner = "client!t", name = "b", descriptor = "(I)Lgv;")
