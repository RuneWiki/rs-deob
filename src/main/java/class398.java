...
public class class398 extends class424 {
    ...
    @OriginalMember(owner = "client!jn", name = "g", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!jn", name = "<init>", descriptor = "()V", line = 25)
    public class398() {
        super(0, true);
    }

    @OriginalMember(owner = "client!jn", name = "h", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!jn", name = "c", descriptor = "(III)I", line = 53)
    ...
    @OriginalMember(owner = "client!jn", name = "b", descriptor = "(IB)[I", line = 68)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ILjq;)V", line = 101)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(BI)V", line = 127)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IZIIIIIIIII)Z", line = 164)
