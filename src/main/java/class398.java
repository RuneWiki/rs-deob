...
public class class398 extends class338 {
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IIIIIIBI)V", line = 16)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IB)V", line = 65)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(BII)B", line = 98)
    ...
    @OriginalMember(owner = "client!fa", name = "d", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 154)
