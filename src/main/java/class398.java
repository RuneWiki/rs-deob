...
public class class398 extends class715 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(B)J", line = 17)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(I)J", line = 28)
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "()V", line = 116)
    public class398() {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(B)J", line = 65)
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(IJ)I", line = 82)
