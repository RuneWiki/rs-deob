...
public class class398 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(II[B)[B", line = 10)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IZIIJ)Ljava/lang/String;", line = 38)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(B)V", line = 130)
