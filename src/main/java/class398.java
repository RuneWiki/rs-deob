...
public class class398 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(BI)[B", line = 3)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IIII)V", line = 86)
    ...
    @OriginalMember(owner = "client!hc", name = "toString", descriptor = "()Ljava/lang/String;", line = 111)
    public final String toString() {
        field5651++;
        return "Cache:" + this.field5660;
    }

    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(I[BII)Z", line = 120)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(Lab;I)V", line = 151)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(I[BIZZ)Z", line = 168)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(I)V", line = 290)
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(ILet;Let;I)V", line = 330)
