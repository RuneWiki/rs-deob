...
public class class398 {
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Z)Lpd;", line = 23)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Lbg;II)V", line = 51)
    ...
    @OriginalMember(owner = "client!gk", name = "b", descriptor = "(Z)V", line = 71)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(BI)I", line = 82)
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "([I)V", line = 109)
    ...
    @OriginalMember(owner = "client!gk", name = "b", descriptor = "(I)V", line = 157)
