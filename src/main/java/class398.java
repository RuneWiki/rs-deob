...
public class class398 {
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(ILan;IIILya;I)Lt;", line = 4)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Lya;IIZIILan;)Lt;", line = 15)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(II)I", line = 27)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(ZIZII)Lmg;", line = 31)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Lsi;IB)V", line = 56)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Lya;ILan;ZILta;IIIIILta;I)Lt;", line = 179)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(I)V", line = 201)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/Class;", line = 213)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Lya;ILta;IIIILan;BIIIZLta;)Lt;", line = 259)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IBLsk;ILvc;)V", line = 371)
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(I)V", line = 724)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IIII)Z", line = 741)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Lsi;I)V", line = 758)
