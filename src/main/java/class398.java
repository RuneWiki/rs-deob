...
public class class398 {
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(II)Lbi;", line = 6)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIIIII)V", line = 50)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IC)Z", line = 84)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(B)V", line = 116)
