...
public class class398 extends class38 implements class255 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(II)I", line = 8)
    ...
    @OriginalMember(owner = "client!ia", name = "d", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(Lrl;I[BIZ)V", line = 33)
    public class398(class487 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34963, arg2, arg3, arg4);
        this.field5869 = arg1;
    }

    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(I)I", line = 45)
    public final int method893(int arg0) {
        ++field5871;
        return arg0 != 14889 ? -72 : this.field5869;
    }

    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(I)I", line = 56)
    ...
    @OriginalMember(owner = "client!ia", name = "c", descriptor = "(I)J", line = 67)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(II[BI)V", line = 77)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Lis;IIII)V", line = 89)
