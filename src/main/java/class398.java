...
public class class398 extends class147 implements class613 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IIILjaclib/memory/Source;)Z")
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(Lhp;Z)V")
    public class398(class296 arg0, boolean arg1) {
        super(arg0, 34962, arg1);
    }

    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;")
