...
public class class398 {
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(IZI)Z", line = 5)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(IZII)I", line = 53)
