...
public class class398 extends class189 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IIZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(Lus;)V", line = 40)
