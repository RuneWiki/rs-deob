...
public class class398 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(IIIZ)Z", line = 6)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(BLqa;)V", line = 35)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 146)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(I)V", line = 161)
    ...
    @OriginalMember(owner = "client!so", name = "b", descriptor = "(I)V", line = 252)
    ...
    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 265)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(IIIIIIIBIII)V", line = 282)
