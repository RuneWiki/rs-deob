...
public class class398 {
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lqa;ZBLoa;ZIILqa;IIILpt;)Lf;")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(BLpt;Lqa;IIIII)Lf;")
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(II)Lje;")
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "(Lgo;IZLwh;Lns;Lns;)V")
