...
public class class398 extends class259 {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(ILbc;Lbc;F)V", line = 6)
    ...
    @OriginalMember(owner = "client!ua", name = "b", descriptor = "(B)Lbc;", line = 89)
    public final class205 method1619(byte arg0) {
        int var2 = -4 / ((-arg0 - 29) / 34);
        return this.field5795;
    }

    @OriginalMember(owner = "client!ua", name = "b", descriptor = "(I)I", line = 97)
    ...
    @OriginalMember(owner = "client!ua", name = "<init>", descriptor = "(Lpo;I)V", line = 110)
