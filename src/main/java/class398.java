...
public class class398 extends class40 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!nt", name = "e", descriptor = "()Z", line = 73)
    public final boolean method2369() {
        return this.field676.field6405 && this.field676.field6375 && this.field676.field6403;
    }

    @OriginalMember(owner = "client!nt", name = "c", descriptor = "()I", line = 76)
    public final int method326() {
        return 1;
    }

    @OriginalMember(owner = "client!nt", name = "<init>", descriptor = "(Lqi;)V", line = 92)
    public class398(class458 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!nt", name = "a", descriptor = "()Z", line = 95)
    ...
    @OriginalMember(owner = "client!nt", name = "d", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(ILai;Lai;)V", line = 135)
    ...
    @OriginalMember(owner = "client!nt", name = "d", descriptor = "()V", line = 286)
    ...
    @OriginalMember(owner = "client!nt", name = "b", descriptor = "()Z", line = 302)
