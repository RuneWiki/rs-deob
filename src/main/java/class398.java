...
public class class398 {
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(I)Lgj;")
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(I)Lgj;")
    ...
    @OriginalMember(owner = "client!qi", name = "c", descriptor = "(I)Lgj;")
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(B)Lgj;")
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Lgj;I)V")
