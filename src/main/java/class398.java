...
public class class398 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(B)Lkq;")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ILkq;)V")
    ...
    @OriginalMember(owner = "client!si", name = "c", descriptor = "(I)Lkq;")
