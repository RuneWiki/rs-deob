...
public class class398 extends class419 {
    ...
    @OriginalMember(owner = "client!hu", name = "b", descriptor = "(II)I", line = 6)
    ...
    @OriginalMember(owner = "client!hu", name = "f", descriptor = "(I)I", line = 23)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(IZ)V", line = 40)
    ...
    @OriginalMember(owner = "client!hu", name = "d", descriptor = "(B)[B", line = 91)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(IIIII)V", line = 111)
    ...
    @OriginalMember(owner = "client!hu", name = "g", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!hu", name = "b", descriptor = "(ZI)V", line = 137)
