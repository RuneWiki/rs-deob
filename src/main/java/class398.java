...
public class class398 extends class484 {
    ...
    @OriginalMember(owner = "client!pe", name = "d", descriptor = "(I)Lbt;")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(ILml;)V")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(ILbt;)V")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(III)Lf;")
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(Lml;)V")
