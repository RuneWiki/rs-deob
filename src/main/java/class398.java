...
public class class398 extends class375 {
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!ku", name = "c", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IZ)[B", line = 36)
