...
public class class398 {
    ...
    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(Lsq;)V", line = 101)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IIZ)V", line = 8)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(ZIZI)V", line = 24)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lod;B)Z", line = 64)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(II)Z", line = 83)
