...
@OriginalClass("client!YDSZUOCR")
public class class64 {

    @OriginalMember(owner = "client!YDSZUOCR", name = "a", descriptor = "Z")
    private boolean field1607 = true;

    @OriginalMember(owner = "client!YDSZUOCR", name = "b", descriptor = "I")
    private int field1608;

    @OriginalMember(owner = "client!YDSZUOCR", name = "c", descriptor = "[LZZBPVHZB;")
    private class72[] field1609;

    @OriginalMember(owner = "client!YDSZUOCR", name = "<init>", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!YDSZUOCR", name = "a", descriptor = "(J)LZZBPVHZB;")
    ...
    @OriginalMember(owner = "client!YDSZUOCR", name = "a", descriptor = "(ZLZZBPVHZB;J)V")
