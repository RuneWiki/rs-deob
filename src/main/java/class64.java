...
public class class64 {
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(III)Llaa;")
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(Lpv;B)V")
    ...
    @OriginalMember(owner = "client!pv", name = "b", descriptor = "(I)Lpv;")
