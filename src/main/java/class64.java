...
public class class64 {
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(II)V", line = 9)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IIIIIIIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(I[BI)I", line = 44)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Z)V", line = 69)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(II)Lpm;", line = 103)
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(Lai;ILic;)V", line = 131)
