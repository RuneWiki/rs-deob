...
public class class64 extends class235 {
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(II)I", line = 22)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IILil;)V", line = 37)
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(BI)V", line = 76)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Lil;I)V", line = 125)
