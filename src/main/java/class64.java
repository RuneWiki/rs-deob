...
public class class64 extends class4 {
    ...
    @OriginalMember(owner = "client!WFUJSESJ", name = "u", descriptor = "LBZONLWPM;")
    ...
    @OriginalMember(owner = "client!WFUJSESJ", name = "s", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!WFUJSESJ", name = "a", descriptor = "(I)LIGXVZOHI;")
    ...
    @OriginalMember(owner = "client!WFUJSESJ", name = "b", descriptor = "(I)LHGKOLOPU;")
