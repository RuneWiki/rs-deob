...
public class class64 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(B[II[Ljava/lang/Object;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ILha;I)Lkr;", line = 76)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(Loea;)V", line = 127)
