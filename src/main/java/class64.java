...
public class class64 {
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Ljava/lang/String;[BIZ)I", line = 10)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(IIIB)Lhi;", line = 56)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Z)Lce;", line = 74)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "(IIIIB)V", line = 106)
