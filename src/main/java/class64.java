...
public class class64 {
    ...
    @OriginalMember(owner = "client!oi", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V", line = 7)
    ...
    @OriginalMember(owner = "client!oi", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!oi", name = "movemouse", descriptor = "(II)V", line = 53)
    public final void movemouse(int arg0, int arg1) {
        this.field714.mouseMove(arg0, arg1);
    }

    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "()V", line = 59)
