...
public class class64 {
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IILea;IILmq;IILqa;)V", line = 16)
    ...
    @OriginalMember(owner = "client!iv", name = "toString", descriptor = "()Ljava/lang/String;", line = 118)
    public final String toString() {
        field1095++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(III)I", line = 130)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IIIII)V", line = 150)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(I)I", line = 169)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(I)V", line = 187)
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(II)V", line = 197)
