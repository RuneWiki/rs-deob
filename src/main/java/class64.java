...
public class class64 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "([BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(I)V", line = 51)
    public static final void method540(int arg0) {
        field791++;
        class123.method834(0, arg0, 255);
    }

    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IIII)V", line = 67)
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(II)[B", line = 187)
