...
public class class64 implements class270 {
    ...
    @OriginalMember(owner = "client!in", name = "b", descriptor = "(II)Lia;")
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(II)Lvk;")
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(Luu;Luu;Luu;)V")
