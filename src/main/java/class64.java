...
public class class64 {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IILza;ILl;II)V")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Lia;I)Lkt;")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(BILih;Ljava/lang/String;)Laj;")
