...
public class class64 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(BILsa;Lpca;ILdg;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(B)Z", line = 123)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "([Ltc;BIIIZ)V", line = 135)
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(BIIIII)V", line = 219)
