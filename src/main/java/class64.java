...
public class class64 extends class273 {
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(Lpq;Lcl;[Lup;[I[I)V")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "([B[IIIIIIIIIIILud;II)V")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(CIIIZLud;II)V")
