...
public abstract class class64 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(I)Z", line = 9)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!dl", name = "b", descriptor = "(B)Z", line = 30)
    ...
    @OriginalMember(owner = "client!dl", name = "c", descriptor = "(B)Z", line = 46)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Z)Z", line = 58)
