...
public class class64 extends class53 {
    ...
    @OriginalMember(owner = "client!pv", name = "e", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 14)
    ...
    @OriginalMember(owner = "client!pv", name = "c", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!pv", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 37)
