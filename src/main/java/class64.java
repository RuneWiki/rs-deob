...
public class class64 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Lgb;I)V")
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Ltq;I)V")
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Lgb;)V")
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Lsl;II)V")
