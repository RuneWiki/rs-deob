...
public class class64 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(JI)V", line = 8)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Z)V", line = 96)
    ...
    @OriginalMember(owner = "client!jt", name = "b", descriptor = "(I)J", line = 146)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(II)V", line = 159)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(II[BI)V", line = 185)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IIIIIIIB)V", line = 368)
    ...
    @OriginalMember(owner = "client!jt", name = "b", descriptor = "(Z)Ljava/io/File;", line = 422)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(I[BII)V", line = 435)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(I[B)V", line = 560)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(B)V", line = 581)
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "(Lde;II)V", line = 611)
