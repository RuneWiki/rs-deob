...
public class class64 extends class623 {
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "(Lar;)V", line = 52)
    public class64(class561 arg0) {
        this.field863 = arg0;
    }

    @OriginalMember(owner = "client!oi", name = "b", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(BI)Z", line = 72)
    ...
    @OriginalMember(owner = "client!oi", name = "e", descriptor = "(B)Z", line = 85)
