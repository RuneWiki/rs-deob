...
public class class64 extends class503 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Lto;I)V")
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Lya;IIZF)V")
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(ILvt;)V")
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Lvt;I)V")
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(ILvt;)V")
