...
public class class64 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "()I", line = 4)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Ldk;II)Lhn;", line = 50)
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "()[B", line = 62)
    ...
    @OriginalMember(owner = "client!hn", name = "<init>", descriptor = "(Lsv;)V", line = 124)
    ...
    @OriginalMember(owner = "client!hn", name = "<init>", descriptor = "()V", line = 149)
    private class64() {
    }

    @OriginalMember(owner = "client!hn", name = "c", descriptor = "()Lhe;", line = 146)
