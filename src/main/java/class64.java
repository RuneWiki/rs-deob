...
public class class64 {
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(II)I", line = 25)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(ILiv;)V", line = 46)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 69)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(ZI)Z", line = 113)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(Liv;II)V", line = 137)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(II)Ljava/lang/String;", line = 190)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(I)V", line = 211)
