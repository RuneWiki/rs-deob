...
public class class64 extends class35 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Ltq;IZ)Lns;", line = 37)
