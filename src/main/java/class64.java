...
public class class64 {
    ...
    @OriginalMember(owner = "client!WYQNTERC", name = "b", descriptor = "LWYQNTERC;")
    public class64 field1588;

    @OriginalMember(owner = "client!WYQNTERC", name = "c", descriptor = "LWYQNTERC;")
    public class64 field1589;

    @OriginalMember(owner = "client!WYQNTERC", name = "d", descriptor = "Z")
