...
public class class64 {
    ...
    @OriginalMember(owner = "client!YJSRODCC", name = "m", descriptor = "I")
    ...
    @OriginalMember(owner = "client!YJSRODCC", name = "a", descriptor = "(LPGNBHFUF;I)V")
    ...
    @OriginalMember(owner = "client!YJSRODCC", name = "b", descriptor = "(LPGNBHFUF;I)V")
