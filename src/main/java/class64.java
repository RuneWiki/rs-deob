...
public class class64 extends class331 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(BI)Z", line = 7)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IILon;ILhb;IIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!di", name = "c", descriptor = "(B)Lgk;", line = 70)
    ...
    @OriginalMember(owner = "client!di", name = "e", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(II)Z", line = 110)
    ...
    @OriginalMember(owner = "client!di", name = "d", descriptor = "(B)Z", line = 122)
    ...
    @OriginalMember(owner = "client!di", name = "<init>", descriptor = "(I)V", line = 226)
