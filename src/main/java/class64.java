...
public class class64 extends class447 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ZIILqj;Lsr;I)[F")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Lsr;Lqj;I)Z")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Laa;Lqj;I)V")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IDLqj;BIZLsr;)[I")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Lsr;ZLqj;DZIIZ)[I")
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Leb;)V")
