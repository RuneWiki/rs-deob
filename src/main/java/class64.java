...
public class class64 extends class407 {
    ...
    @OriginalMember(owner = "client!ps", name = "d", descriptor = "()Lcv;")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ILss;III[I)V")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Lss;II)V")
    ...
    @OriginalMember(owner = "client!ps", name = "c", descriptor = "()Lcv;")
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(Lri;)V")
