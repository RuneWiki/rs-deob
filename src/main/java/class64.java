...
public class class64 extends class667 {
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Llaa;B)V")
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Lac;I)V")
    ...
    @OriginalMember(owner = "client!naa", name = "<init>", descriptor = "(Llaa;)V")
