...
public class class64 {
    ...
    @OriginalMember(owner = "client!XBBVJJRK", name = "b", descriptor = "LHSUOZGYX;")
    public class20 field1628 = new class20();

    @OriginalMember(owner = "client!XBBVJJRK", name = "c", descriptor = "LHSUOZGYX;")
    ...
    @OriginalMember(owner = "client!XBBVJJRK", name = "a", descriptor = "(LHSUOZGYX;)V")
    ...
    @OriginalMember(owner = "client!XBBVJJRK", name = "a", descriptor = "()LHSUOZGYX;")
    ...
    @OriginalMember(owner = "client!XBBVJJRK", name = "a", descriptor = "(B)LHSUOZGYX;")
