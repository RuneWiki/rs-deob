...
public class class64 implements Runnable {
    ...
    @OriginalMember(owner = "client!YVLAOVKQ", name = "g", descriptor = "LCMOCHGYM;")
    ...
    @OriginalMember(owner = "client!YVLAOVKQ", name = "<init>", descriptor = "(LCMOCHGYM;ILjava/net/Socket;)V")
