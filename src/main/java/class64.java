...
public class class64 extends class101 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Llq;Lfd;)V", line = 5)
    ...
    @OriginalMember(owner = "client!nr", name = "c", descriptor = "()Lsd;", line = 13)
    public final class101 method191() {
        return (class101) this.field769.method1731((byte) -125);
    }

    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Lsd;)V", line = 18)
    public final synchronized void method424(class101 arg0) {
        this.field769.method1728(-126, arg0);
    }

    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!nr", name = "e", descriptor = "()I", line = 73)
    public final synchronized int method425() {
        return this.field769.method1735(-121);
    }

    @OriginalMember(owner = "client!nr", name = "d", descriptor = "()Lsd;", line = 77)
    public final class101 method176() {
        return (class101) this.field769.method1724(0);
    }

    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(Lsd;)V", line = 80)
    public final synchronized void method426(class101 arg0) {
        arg0.method3387((byte) -107);
    }

    @OriginalMember(owner = "client!nr", name = "c", descriptor = "([III)V", line = 88)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!nr", name = "f", descriptor = "()V", line = 110)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "()I", line = 128)
    public final int method210() {
        return 0;
    }

    @OriginalMember(owner = "client!nr", name = "b", descriptor = "([III)V", line = 140)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Lfd;)V", line = 184)
