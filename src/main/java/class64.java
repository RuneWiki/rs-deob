...
public class class64 {
    ...
    @OriginalMember(owner = "client!me", name = "finalize", descriptor = "()V", line = 7)
    protected final void finalize() throws Throwable {
        this.field781.method2105(this.field780);
        super.finalize();
    }

    @OriginalMember(owner = "client!me", name = "a", descriptor = "(Lh;ILjava/lang/String;)Lme;", line = 13)
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Lh;II)V", line = 35)
