...
public class class64 extends class35 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Lmb;IIILja;)V", line = 29)
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "()V", line = 90)
    public class64() {
    }

    @OriginalMember(owner = "client!ji", name = "c", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 113)
