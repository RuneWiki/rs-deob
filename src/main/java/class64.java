...
public class class64 {
    ...
    @OriginalMember(owner = "client!UAVNMKVJ", name = "o", descriptor = "LOOTLZHQB;")
    ...
    @OriginalMember(owner = "client!UAVNMKVJ", name = "g", descriptor = "LLCRVYGCP;")
    public class36 field1561;

    @OriginalMember(owner = "client!UAVNMKVJ", name = "a", descriptor = "Z")
    private static boolean field1555;

    @OriginalMember(owner = "client!UAVNMKVJ", name = "c", descriptor = "[LUAVNMKVJ;")
    public static class64[] field1557;

    @OriginalMember(owner = "client!UAVNMKVJ", name = "a", descriptor = "(ILHRXSNEYZ;)V")
    ...
    @OriginalMember(owner = "client!UAVNMKVJ", name = "a", descriptor = "(LJHKSAGUC;I)V")
    ...
    @OriginalMember(owner = "client!UAVNMKVJ", name = "a", descriptor = "()LRTQSBWRH;")
