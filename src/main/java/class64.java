...
public class class64 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;)V", line = 5)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IZI)Z", line = 34)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(B[B)V", line = 45)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IIIIZZIII[ILtea;III[I)I", line = 126)
