...
public class class64 extends class205 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(ZB)V", line = 6)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "()V", line = 17)
    public final void method419() {
    }

    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Lks;II[BI)V", line = 19)
