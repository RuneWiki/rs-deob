...
@OriginalClass("client!WEZGVHTE")
public class class64 {

    @OriginalMember(owner = "client!WEZGVHTE", name = "a", descriptor = "I")
    private int field1619 = 624;

    @OriginalMember(owner = "client!WEZGVHTE", name = "b", descriptor = "Z")
    private boolean field1620 = false;

    @OriginalMember(owner = "client!WEZGVHTE", name = "c", descriptor = "I")
    private int field1621 = -768;

    @OriginalMember(owner = "client!WEZGVHTE", name = "d", descriptor = "I")
    private int field1622;

    @OriginalMember(owner = "client!WEZGVHTE", name = "e", descriptor = "[LAIZKCREI;")
    private class1[] field1623;

    @OriginalMember(owner = "client!WEZGVHTE", name = "<init>", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!WEZGVHTE", name = "a", descriptor = "(J)LAIZKCREI;")
    ...
    @OriginalMember(owner = "client!WEZGVHTE", name = "a", descriptor = "(ILAIZKCREI;J)V")
