...
public class class64 extends class251 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!jt", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!jt", name = "d", descriptor = "(B)I", line = 36)
    ...
    @OriginalMember(owner = "client!jt", name = "g", descriptor = "(I)I", line = 52)
    ...
    @OriginalMember(owner = "client!jt", name = "h", descriptor = "(I)J", line = 64)
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "(II)V", line = 82)
    public class64(int arg0, int arg1) {
        super.field2798 = (long) arg1 | (long) arg0 << 32;
    }

    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IILqq;)Z", line = 90)
    ...
    @OriginalMember(owner = "client!jt", name = "i", descriptor = "(I)V", line = 496)
