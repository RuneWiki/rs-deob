...
public class class64 extends class31 {
    ...
    @OriginalMember(owner = "client!naa", name = "<init>", descriptor = "(Lut;Lgi;IIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(B)Lrw;")
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(ZILok;II[I)Lot;")
