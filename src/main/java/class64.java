...
@OriginalClass("client!YDNCHMHU")
public class class64 extends class30 {

    @OriginalMember(owner = "client!YDNCHMHU", name = "j", descriptor = "I")
    public int field1528 = 1000;

    @OriginalMember(owner = "client!YDNCHMHU", name = "k", descriptor = "Z")
    public static boolean field1529;

    @OriginalMember(owner = "client!YDNCHMHU", name = "i", descriptor = "[LWEADLANG;")
    public class58[] field1527;

    @OriginalMember(owner = "client!YDNCHMHU", name = "a", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!YDNCHMHU", name = "a", descriptor = "(Z)LOIBEFFXI;")
