...
@OriginalClass("client!VLFCQHDE")
public class class64 {

    @OriginalMember(owner = "client!VLFCQHDE", name = "a", descriptor = "Z")
    private boolean field1647 = true;

    @OriginalMember(owner = "client!VLFCQHDE", name = "b", descriptor = "I")
    public int field1648;

    @OriginalMember(owner = "client!VLFCQHDE", name = "c", descriptor = "[I")
    public int[] field1649;

    @OriginalMember(owner = "client!VLFCQHDE", name = "d", descriptor = "[[I")
    public int[][] field1650;

    @OriginalMember(owner = "client!VLFCQHDE", name = "<init>", descriptor = "(ZLMUKVLYLC;)V")
