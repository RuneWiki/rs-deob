...
public class class64 {
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(BJ)Ldn;")
    ...
    @OriginalMember(owner = "client!tga", name = "b", descriptor = "(I)Ldn;")
    ...
    @OriginalMember(owner = "client!tga", name = "c", descriptor = "(I)Ldn;")
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(JLdn;Z)V")
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(I[Ldn;)I")
    ...
    @OriginalMember(owner = "client!tga", name = "f", descriptor = "(I)Ldn;")
