...
public class class64 extends OutputStream {
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!sga", name = "b", descriptor = "(I)V", line = 444)
    ...
    @OriginalMember(owner = "client!sga", name = "write", descriptor = "(I)V", line = 457)
    public final void write(int arg0) throws IOException {
        field981++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(IBI)I", line = 467)
