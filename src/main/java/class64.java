...
public class class64 {
    ...
    @OriginalMember(owner = "client!XWNROHZR", name = "o", descriptor = "LUECXVCCS;")
    ...
    @OriginalMember(owner = "client!XWNROHZR", name = "g", descriptor = "LUVDKTGZK;")
    public class58 field1669;

    @OriginalMember(owner = "client!XWNROHZR", name = "c", descriptor = "[LXWNROHZR;")
    public static class64[] field1665;

    @OriginalMember(owner = "client!XWNROHZR", name = "a", descriptor = "(LGWOEELWB;B)V")
    ...
    @OriginalMember(owner = "client!XWNROHZR", name = "a", descriptor = "(LMLYYHULT;B)V")
    ...
    @OriginalMember(owner = "client!XWNROHZR", name = "a", descriptor = "()LCADBNSXE;")
