...
public class class64 extends class381 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Lrk;Lrk;B)V", line = 6)
    ...
    @OriginalMember(owner = "client!ji", name = "c", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!ji", name = "c", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(II)I", line = 69)
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(II)V", line = 80)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Lrk;I)V", line = 102)
