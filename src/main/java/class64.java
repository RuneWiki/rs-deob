...
public class class64 {
    ...
    @OriginalMember(owner = "client!XHDTVZNY", name = "n", descriptor = "LHGKRJZKS;")
    ...
    @OriginalMember(owner = "client!XHDTVZNY", name = "f", descriptor = "LWLHKAARP;")
    public class59 field1624;

    @OriginalMember(owner = "client!XHDTVZNY", name = "b", descriptor = "[LXHDTVZNY;")
    public static class64[] field1620;

    @OriginalMember(owner = "client!XHDTVZNY", name = "a", descriptor = "(ZLXRWUKRPO;)V")
    ...
    @OriginalMember(owner = "client!XHDTVZNY", name = "a", descriptor = "(BLGLMIQHJI;)V")
    ...
    @OriginalMember(owner = "client!XHDTVZNY", name = "a", descriptor = "()LVHYCWIPJ;")
