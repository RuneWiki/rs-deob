...
public class class64 extends class439 {
    ...
    @OriginalMember(owner = "client!iv", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!iv", name = "d", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!iv", name = "e", descriptor = "(I)V", line = 158)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IILjava/lang/String;ILjava/lang/String;Ljava/lang/String;)V", line = 177)
