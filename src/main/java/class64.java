...
public class class64 {
    ...
    public class64(int[] arg0, byte arg1) {
        if (arg1 == 4) {
            boolean var3 = false;
        } else {
            this.field1579 = !this.field1579;
        }
        this.field1582 = new int[256];
        this.field1581 = new int[256];
        for (int var4 = 0; var4 < arg0.length; var4++) {
            this.field1581[var4] = arg0[var4];
        }
        this.method536();
    }
    ...
    public final int method534() {
        ...
        return this.field1581[this.field1580];
    }
    ...
    private final void method535() {
        ...
        for (int var1 = 0; var1 < 256; var1++) {
            int var2 = this.field1582[var1];
            if ((var1 & 0x3) == 0) {
                this.field1583 ^= this.field1583 << 13;
            } else if ((var1 & 0x3) == 1) {
                this.field1583 ^= this.field1583 >>> 6;
            } else if ((var1 & 0x3) == 2) {
                this.field1583 ^= this.field1583 << 2;
            } else if ((var1 & 0x3) == 3) {
                this.field1583 ^= this.field1583 >>> 16;
            }
            this.field1583 += this.field1582[var1 + 128 & 0xFF];
            int var3;
            this.field1582[var1] = var3 = this.field1582[var2 >> 2 & 0xFF] + this.field1583 + this.field1584;
            this.field1581[var1] = this.field1584 = this.field1582[var3 >> 8 >> 2 & 0xFF] + var2;
        }
    }
    ...
    private final void method536() {
        ...
        for (int var10 = 0; var10 < 256; var10 += 8) {
            int var36 = this.field1581[var10] + var8;
            int var37 = this.field1581[var10 + 1] + var7;
            int var38 = this.field1581[var10 + 2] + var6;
            int var39 = this.field1581[var10 + 3] + var5;
            int var40 = this.field1581[var10 + 4] + var4;
            int var41 = this.field1581[var10 + 5] + var3;
            int var42 = this.field1581[var10 + 6] + var2;
            int var43 = this.field1581[var10 + 7] + var1;
            ...
            var6 = var1 + var50;
            var8 = var7 + var57;
            this.field1582[var10] = var8;
            this.field1582[var10 + 1] = var7;
            this.field1582[var10 + 2] = var6;
            this.field1582[var10 + 3] = var5;
            this.field1582[var10 + 4] = var4;
            this.field1582[var10 + 5] = var3;
            this.field1582[var10 + 6] = var2;
            this.field1582[var10 + 7] = var1;
        }
        for (int var11 = 0; var11 < 256; var11 += 8) {
            int var12 = this.field1582[var11] + var8;
            int var13 = this.field1582[var11 + 1] + var7;
            int var14 = this.field1582[var11 + 2] + var6;
            int var15 = this.field1582[var11 + 3] + var5;
            int var16 = this.field1582[var11 + 4] + var4;
            int var17 = this.field1582[var11 + 5] + var3;
            int var18 = this.field1582[var11 + 6] + var2;
            int var19 = this.field1582[var11 + 7] + var1;
            ...
            var6 = var1 + var26;
            var8 = var7 + var33;
            this.field1582[var11] = var8;
            this.field1582[var11 + 1] = var7;
            this.field1582[var11 + 2] = var6;
            this.field1582[var11 + 3] = var5;
            this.field1582[var11 + 4] = var4;
            this.field1582[var11 + 5] = var3;
            this.field1582[var11 + 6] = var2;
            this.field1582[var11 + 7] = var1;
        }
        this.method535();
        this.field1580 = 256;
    }
