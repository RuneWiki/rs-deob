...
public abstract class class64 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/lang/String;ILjava/util/Random;II[IIIIII[III[Lhk;)I", line = 4)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 83)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 126)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/lang/String;IIIII)V", line = 203)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I)V", line = 220)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IILjava/lang/String;[Lhk;[IIIILjava/util/Random;I)I", line = 234)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIB)V", line = 275)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIII[ILaa;[Lhk;IBIIIILjava/lang/String;III)I", line = 295)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIILjava/lang/String;I)V", line = 396)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IBIIILjava/lang/String;)V", line = 410)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(BLaa;IILjava/lang/String;IIII[Lhk;III[III)I", line = 433)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIILjava/lang/String;II)V", line = 445)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II[ILaa;II[Lhk;ILjava/lang/String;)V", line = 481)
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lha;Lkaa;)V", line = 635)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Lhk;IILjava/lang/String;III[I)V", line = 648)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IILjava/lang/String;IIII)V", line = 660)
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "(IILjava/lang/String;IIII)V", line = 683)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([II[I[Lhk;[IILjava/lang/String;I)V", line = 716)
