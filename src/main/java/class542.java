...
public class class542 extends class384 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lke;BI)V")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lfd;ZIIZLfd;I)I")
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "(Lai;Loh;)V")
