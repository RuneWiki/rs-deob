...
public class class542 extends class331 {
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(ILts;)V", line = 18)
    public class542(int arg0, class41 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!gm", name = "c", descriptor = "(II)V", line = 21)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(BI)V", line = 34)
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(II)I", line = 82)
    ...
    @OriginalMember(owner = "client!gm", name = "c", descriptor = "(B)Z", line = 101)
    ...
    @OriginalMember(owner = "client!gm", name = "c", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!gm", name = "d", descriptor = "(B)I", line = 311)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Lts;)V", line = 332)
