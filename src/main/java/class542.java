...
public abstract class class542 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(B)V", line = 16)
    public static void method3185(byte arg0) {
        int var1 = 40 / ((arg0 + 12) / 49);
        field8026 = null;
    }

    @OriginalMember(owner = "client!tp", name = "b", descriptor = "(III)V", line = 31)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(I)V", line = 44)
