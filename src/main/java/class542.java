...
public class class542 {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Les;I)V")
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IILes;)V")
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IIIIIIZ)Ljt;")
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(ZLr;II)Lf;")
