...
public class class542 extends class540 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Lha;IIIIZI)V", line = 14)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "(ILeq;IZ)V", line = 81)
