...
public class class542 extends class159 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(ZII)V", line = 19)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(ZB)V", line = 29)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Z)Z", line = 42)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(BZ)V", line = 53)
    ...
    @OriginalMember(owner = "client!so", name = "c", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Ljava/lang/String;Ldc;B)I", line = 73)
    ...
    @OriginalMember(owner = "client!so", name = "b", descriptor = "(Z)V", line = 92)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(BLjava/lang/String;)V", line = 108)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Lwu;II)V", line = 124)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(ZIBLjava/lang/String;)V", line = 137)
    ...
    @OriginalMember(owner = "client!so", name = "b", descriptor = "(B)V", line = 258)
    ...
    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "(Ldw;)V", line = 276)
