...
public class class542 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Lgw;ILjava/lang/String;)I", line = 4)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(BI)V", line = 191)
