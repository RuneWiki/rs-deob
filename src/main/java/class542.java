...
public class class542 extends class94 implements class49 {
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(Lsea;B)I", line = 6)
    ...
    @OriginalMember(owner = "client!fda", name = "d", descriptor = "(Lr;I)Llf;", line = 38)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(Lr;I)V", line = 52)
    ...
    @OriginalMember(owner = "client!fda", name = "b", descriptor = "(I)I", line = 80)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(Lr;Z)V", line = 92)
    ...
    @OriginalMember(owner = "client!fda", name = "b", descriptor = "(B)Z", line = 102)
    ...
    @OriginalMember(owner = "client!fda", name = "i", descriptor = "(I)Z", line = 118)
    ...
    @OriginalMember(owner = "client!fda", name = "e", descriptor = "(B)I", line = 134)
    ...
    @OriginalMember(owner = "client!fda", name = "<init>", descriptor = "(Lr;Lqp;IIIIIZIIII)V", line = 145)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(Z)I", line = 169)
    public final int method237(boolean arg0) {
        ++field7602;
        return arg0 ? -126 : this.field7631;
    }

    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(Lr;III)Z", line = 180)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(ILjava/lang/String;)J", line = 200)
    ...
    @OriginalMember(owner = "client!fda", name = "h", descriptor = "(I)Z", line = 228)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(Lr;II)Lda;", line = 239)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(B)I", line = 260)
    ...
    @OriginalMember(owner = "client!fda", name = "c", descriptor = "(Lr;I)Lwj;", line = 271)
    ...
    @OriginalMember(owner = "client!fda", name = "g", descriptor = "(I)I", line = 304)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(Lr;IZI)Lhi;", line = 317)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(III)Z", line = 347)
    ...
    @OriginalMember(owner = "client!fda", name = "b", descriptor = "(II)I", line = 358)
    public static final int method3051(int arg0, int arg1) {
        return class383.field5172 != null ? class383.field5172[arg0][arg1] & 65535 : 0;
    }

    @OriginalMember(owner = "client!fda", name = "c", descriptor = "(II)V", line = 362)
    ...
    @OriginalMember(owner = "client!fda", name = "b", descriptor = "(Lr;I)V", line = 374)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(I)V", line = 405)
