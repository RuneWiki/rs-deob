...
public class class542 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(I[BI)I", line = 22)
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(I)[Ldu;", line = 34)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IIIIIIBI)V", line = 45)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(ZIIIII)V", line = 71)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(II)V", line = 124)
