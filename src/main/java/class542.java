...
public class class542 extends class735 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Lrh;Z)V")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Lcn;)V")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ILfca;)V")
