...
public class class542 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(B)Lmu;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lmfa;I)V")
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(Lmfa;)V")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(I)[Lfv;")
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(I)Lmu;")
