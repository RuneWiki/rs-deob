...
public class class542 extends class133 implements class533 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(FFFFFFIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(FFFFFFILaa;II)V", line = 13)
    ...
    @OriginalMember(owner = "client!j", name = "c", descriptor = "()I", line = 16)
    public final int method1043() {
        return this.method3030(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(III)V", line = 20)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIII)V", line = 33)
    public final void method1032(int arg0, int arg1, int arg2, int arg3) {
        this.method3021(this.nativeid, arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIII)V", line = 36)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IILaa;II)V", line = 41)
    ...
    @OriginalMember(owner = "client!j", name = "b", descriptor = "(IIIIIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "([I)V", line = 47)
    public final void method1046(int[] arg0) {
        this.method3029(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!j", name = "b", descriptor = "()I", line = 58)
    public final int method1042() {
        return this.method3022(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Loa;II)V", line = 61)
    public class542(class695 arg0, int arg1, int arg2) {
        this.method3027(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Loa;[IIIIIZ)V", line = 64)
    ...
    @OriginalMember(owner = "client!j", name = "d", descriptor = "()I", line = 68)
    public final int method1048() {
        return this.method3023(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "()I", line = 72)
    public final int method1036() {
        return this.method3037(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "finalize", descriptor = "()V", line = 75)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIII)V", line = 86)
