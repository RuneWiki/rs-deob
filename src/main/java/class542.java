...
public class class542 {
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(Lov;)V", line = 5)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(ILs;)V", line = 82)
    public static final void method3173(int arg0, class339 arg1) {
        class211.field3511[arg0] = arg1;
    }

    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(B)V", line = 94)
