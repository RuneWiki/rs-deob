...
public class class542 extends class306 implements class394 {
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Lr;B)V")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(ILr;I)Lda;")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IILr;B)Z")
    ...
    @OriginalMember(owner = "client!gk", name = "c", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Lr;I)Lej;")
    ...
    @OriginalMember(owner = "client!gk", name = "b", descriptor = "(ILr;)Leh;")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(ZLr;IZ)Lfj;")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(Lr;Lnf;IIIIIZIIII)V")
