...
public class class542 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "([I[II[ILwc;)V", line = 13)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(BI)Lgq;", line = 122)
    ...
    @OriginalMember(owner = "client!gq", name = "toString", descriptor = "()Ljava/lang/String;", line = 192)
    public final String toString() {
        field7356++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(B)V", line = 203)
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(IILig;)V", line = 219)
