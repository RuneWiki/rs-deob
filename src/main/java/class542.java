...
public class class542 {
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!kka", name = "toString", descriptor = "()Ljava/lang/String;", line = 22)
    public final String toString() {
        field6808++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(IIZ)V", line = 32)
