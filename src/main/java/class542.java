...
public abstract class class542 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IZII)I", line = 12)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(II)I", line = 44)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(III)V", line = 100)
