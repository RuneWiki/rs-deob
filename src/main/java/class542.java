...
public class class542 {
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(II)I", line = 21)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Lhg;B)V", line = 49)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(ZILha;I)Lek;", line = 105)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(I)V", line = 174)
