...
public abstract class class542 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(ZII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IZ)V", line = 16)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(B)V", line = 60)
