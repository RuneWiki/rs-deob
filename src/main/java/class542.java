...
public class class542 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Z)V", line = 30)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "()V", line = 57)
    public class542() {
    }

    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(B)Lgj;", line = 60)
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(B)Lgj;", line = 81)
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "(Lnc;)V", line = 100)
