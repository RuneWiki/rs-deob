...
public class class542 extends class680 implements class533 {
    ...
    @OriginalMember(owner = "client!j", name = "c", descriptor = "()I", line = 6)
    public final int method666() {
        return this.method3071(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "c", descriptor = "(IIII)V", line = 9)
    public final void method670(int arg0, int arg1, int arg2, int arg3) {
        this.method3070(this.nativeid, arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!j", name = "b", descriptor = "(IIIIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!j", name = "b", descriptor = "()I", line = 21)
    public final int method674() {
        return this.method3058(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "()I", line = 24)
    public final int method676() {
        return this.method3060(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "([I)V", line = 27)
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Loa;II)V", line = 34)
    public class542(class694 arg0, int arg1, int arg2) {
        this.method3063(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(III)V", line = 39)
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Loa;[IIIIIZ)V", line = 47)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(FFFFFFIIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!j", name = "finalize", descriptor = "()V", line = 55)
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Loa;[I[B[BIIII)V", line = 59)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIII)V", line = 67)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IILaa;II)V", line = 72)
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Loa;IIIIZ)V", line = 78)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIIIII)V", line = 83)
    ...
    @OriginalMember(owner = "client!j", name = "d", descriptor = "()I", line = 86)
