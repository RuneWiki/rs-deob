...
public class class542 implements class563 {
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(I)Lrba;")
    ...
    @OriginalMember(owner = "client!dca", name = "c", descriptor = "(I)Ler;")
    ...
    @OriginalMember(owner = "client!dca", name = "<init>", descriptor = "(Lga;Ljava/lang/String;)V")
