...
public class PixFontFull extends PixFont {
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(BLjava/lang/String;Lyb;)V")
    ...
    public void method205(int arg0, int arg1, String arg2, int arg3, boolean arg4, int arg5) {
        ...
        if (arg2 != null) {
            ...
            if (arg1 == 0) {
                if (this.field707) {
                    Draw2D.method159(8388608, arg3 - var7, var7, (int) ((double) super.field692 * 0.7D) + var8, (byte) 2);
                }
            }
        }
    }
    ...
    private void method212(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        ...
        if (arg2 + arg4 >= Draw2D.field625) {
            arg4 -= arg2 + arg4 - Draw2D.field625 + 1;
        }
        ...
        if (arg1 + arg3 >= Draw2D.field627) {
            int var13 = arg1 + arg3 - Draw2D.field627 + 1;
            arg3 -= var13;
            var9 += var13;
            var8 += var13;
        }
        if (arg3 > 0 && arg4 > 0) {
            this.method213(Draw2D.field621, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }
    ...
    private void method214(int arg0, byte[] arg1, int arg2, int arg3, int arg4, int arg5, int arg6, boolean arg7) {
        int var9 = Draw2D.field622 * arg6 + arg2;
        int var10 = Draw2D.field622 - arg5;
        int var11 = 0;
        int var12 = 0;
        if (arg6 < Draw2D.field624) {
            int var13 = Draw2D.field624 - arg6;
            arg4 -= var13;
        ...
        if (arg4 + arg6 >= Draw2D.field625) {
            arg4 -= arg4 + arg6 - Draw2D.field625 + 1;
        }
        if (arg2 < Draw2D.field626) {
            int var14 = Draw2D.field626 - arg2;
            arg5 -= var14;
        ...
        if (arg2 + arg5 >= Draw2D.field627) {
            int var15 = arg2 + arg5 - Draw2D.field627 + 1;
            arg5 -= var15;
            var11 += var15;
            var10 += var15;
        }
        if (arg5 > 0 && arg4 > 0) {
            this.method215(var11, arg3, 0, Draw2D.field621, arg5, var12, arg1, arg4, var10, arg0, var9);
            if (!arg7) {
