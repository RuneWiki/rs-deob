...
public class class12 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Lm;IILkj;Ljava/awt/Canvas;)Lqa;", line = 5)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(B)V", line = 20)
    public static void method101(byte arg0) {
        int var1 = 111 / ((arg0 - 16) / 48);
        field144 = null;
    }

    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Lqa;)V", line = 31)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "()V", line = 122)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(I)V", line = 296)
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(Lht;Lbm;III)V", line = 320)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Ljava/lang/Object;III)[B", line = 337)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IBI)Lss;", line = 372)
