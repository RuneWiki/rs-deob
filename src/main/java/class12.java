...
public class class12 extends class397 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IB)I", line = 8)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(BIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!qk", name = "c", descriptor = "(B)V", line = 243)
    ...
    @OriginalMember(owner = "client!qk", name = "d", descriptor = "(I)V", line = 254)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IIZ)V", line = 270)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ILjava/lang/String;Lrd;I)Lts;", line = 345)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(I[Lon;ZIII)V", line = 422)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IIIIIIIB)V", line = 470)
    ...
    @OriginalMember(owner = "client!qk", name = "e", descriptor = "(I)Z", line = 500)
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "()V", line = 520)
    protected class12() {
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "(Ldg;)V", line = 540)
