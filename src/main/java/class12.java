...
public abstract class class12 extends class134 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(BLjagtheora/ogg/OggPacket;)V")
    ...
    @OriginalMember(owner = "client!ma", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
