...
@OriginalClass("client!EAXVDNXA")
public class class12 {

    @OriginalMember(owner = "client!EAXVDNXA", name = "b", descriptor = "I")
    public int field706;

    @OriginalMember(owner = "client!EAXVDNXA", name = "g", descriptor = "Z")
    private boolean field711;

    @OriginalMember(owner = "client!EAXVDNXA", name = "a", descriptor = "[B")
    public byte[] field705;

    @OriginalMember(owner = "client!EAXVDNXA", name = "c", descriptor = "[I")
    public int[] field707;

    @OriginalMember(owner = "client!EAXVDNXA", name = "d", descriptor = "[I")
    public int[] field708;

    @OriginalMember(owner = "client!EAXVDNXA", name = "e", descriptor = "[I")
    public int[] field709;

    @OriginalMember(owner = "client!EAXVDNXA", name = "f", descriptor = "[I")
    public int[] field710;

    @OriginalMember(owner = "client!EAXVDNXA", name = "<init>", descriptor = "([BI)V")
    ...
    @OriginalMember(owner = "client!EAXVDNXA", name = "a", descriptor = "(I[B)V")
    ...
    @OriginalMember(owner = "client!EAXVDNXA", name = "a", descriptor = "(Ljava/lang/String;[B)[B")
