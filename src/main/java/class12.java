...
public class class12 {
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(Z)V", line = 13)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(ILjava/lang/String;)V", line = 23)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(B)V", line = 91)
