...
public class class12 {
    ...
    @OriginalMember(owner = "client!ba", name = "h", descriptor = "J")
    public long field183 = 0L;

    @OriginalMember(owner = "client!ba", name = "c", descriptor = "Llf;")
    public static class109 field178 = class35.method275("Bitte entfernen Sie ", 2);

    @OriginalMember(owner = "client!ba", name = "f", descriptor = "I")
    public static int field181 = 0;

    @OriginalMember(owner = "client!ba", name = "g", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ba", name = "m", descriptor = "Lka;")
    public class95 field188;

    @OriginalMember(owner = "client!ba", name = "o", descriptor = "Lka;")
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IILlf;SJILlf;)V")
