...
@OriginalClass("client!DFQOFKQS")
public class class12 {

    @OriginalMember(owner = "client!DFQOFKQS", name = "a", descriptor = "B")
    private byte field665 = 44;

    @OriginalMember(owner = "client!DFQOFKQS", name = "b", descriptor = "I")
    private int field666 = -26246;

    @OriginalMember(owner = "client!DFQOFKQS", name = "c", descriptor = "B")
    private byte field667 = 5;

    @OriginalMember(owner = "client!DFQOFKQS", name = "d", descriptor = "Z")
    private boolean field668 = false;

    @OriginalMember(owner = "client!DFQOFKQS", name = "i", descriptor = "[LYPPCWCLI;")
    private class69[] field673 = new class69[10];

    @OriginalMember(owner = "client!DFQOFKQS", name = "e", descriptor = "[LDFQOFKQS;")
    private static class12[] field669 = new class12[5000];

    @OriginalMember(owner = "client!DFQOFKQS", name = "f", descriptor = "[I")
    public static int[] field670 = new int[5000];

    @OriginalMember(owner = "client!DFQOFKQS", name = "j", descriptor = "I")
    private int field674;

    @OriginalMember(owner = "client!DFQOFKQS", name = "k", descriptor = "I")
    private int field675;

    @OriginalMember(owner = "client!DFQOFKQS", name = "h", descriptor = "LYOXDZEVD;")
    private static class68 field672;

    @OriginalMember(owner = "client!DFQOFKQS", name = "g", descriptor = "[B")
    private static byte[] field671;

    @OriginalMember(owner = "client!DFQOFKQS", name = "<init>", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!DFQOFKQS", name = "a", descriptor = "(LYOXDZEVD;Z)V")
    ...
    @OriginalMember(owner = "client!DFQOFKQS", name = "a", descriptor = "(III)LYOXDZEVD;")
    ...
    @OriginalMember(owner = "client!DFQOFKQS", name = "a", descriptor = "(BLYOXDZEVD;)V")
    ...
    @OriginalMember(owner = "client!DFQOFKQS", name = "a", descriptor = "(B)I")
    ...
    @OriginalMember(owner = "client!DFQOFKQS", name = "a", descriptor = "(IB)LYOXDZEVD;")
    ...
    @OriginalMember(owner = "client!DFQOFKQS", name = "a", descriptor = "(I)I")
