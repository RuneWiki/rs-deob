...
public class class12 extends class201 implements class145 {
    ...
    @OriginalMember(owner = "client!ma", name = "<init>", descriptor = "(Lda;La;Lub;[Liba;[Lxa;)V", line = 5)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(CIIIZLfa;II)V", line = 33)
    ...
    @OriginalMember(owner = "client!ma", name = "finalize", descriptor = "()V", line = 38)
