...
public abstract class class12 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IZI)Z", line = 7)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IIILai;I)V", line = 76)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 135)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(B)V", line = 161)
