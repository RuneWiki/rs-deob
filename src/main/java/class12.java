...
public class class12 extends class101 {
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(BCLjava/lang/String;)I", line = 38)
    ...
    @OriginalMember(owner = "client!daa", name = "d", descriptor = "(B)V", line = 63)
