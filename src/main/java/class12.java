...
public class class12 {
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(I)Z", line = 36)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ILms;Lms;)V", line = 59)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(BLjava/lang/String;)V", line = 75)
