...
public class class12 {
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(BLha;)V", line = 3)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(III)V", line = 113)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(Lr;III[Z)Z", line = 129)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(I)V", line = 169)
