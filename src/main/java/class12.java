...
public class class12 extends class45 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Lcu;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ds", name = "d", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!ds", name = "f", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "()V", line = 130)
    public class12() {
        super(3, false);
    }

    @OriginalMember(owner = "client!ds", name = "b", descriptor = "(II)[[I", line = 70)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(II)[I", line = 136)
