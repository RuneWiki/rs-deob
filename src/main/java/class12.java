...
public class class12 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(BZILha;)Liea;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(ZLsl;I)V")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lsl;I)V")
