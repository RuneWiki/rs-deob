...
public class class12 extends class159 implements class28 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "()[Lia;")
    ...
    @OriginalMember(owner = "client!ma", name = "b", descriptor = "()[Llh;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lm;Lpr;II)V")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lm;Lpr;I)V")
    ...
    @OriginalMember(owner = "client!ma", name = "<init>", descriptor = "(La;Lc;Lfd;IIII)V")
