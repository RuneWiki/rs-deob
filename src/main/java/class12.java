...
public class class12 extends class535 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Z)Lvv;")
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(ILwn;I)V")
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Lul;Lwn;II)V")
