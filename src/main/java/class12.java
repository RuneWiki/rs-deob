...
public class class12 {
    ...
    @OriginalMember(owner = "client!FGIDBWCJ", name = "d", descriptor = "[LFGIDBWCJ;")
    public static class12[] field731;

    @OriginalMember(owner = "client!FGIDBWCJ", name = "a", descriptor = "(LDTIATKJO;I)V")
    ...
    @OriginalMember(owner = "client!FGIDBWCJ", name = "a", descriptor = "(LGHHPHSRU;I)V")
    ...
    @OriginalMember(owner = "client!FGIDBWCJ", name = "b", descriptor = "(B)LOQIGXOFQ;")
    ...
    @OriginalMember(owner = "client!FGIDBWCJ", name = "a", descriptor = "(Z)LOQIGXOFQ;")
