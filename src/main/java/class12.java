...
public class class12 {
    ...
    @OriginalMember(owner = "client!GALAVQEJ", name = "b", descriptor = "LZPNSJLZE;")
    ...
    @OriginalMember(owner = "client!GALAVQEJ", name = "j", descriptor = "LNHEPCMLW;")
    private static class35 field720;

    @OriginalMember(owner = "client!GALAVQEJ", name = "n", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!GALAVQEJ", name = "q", descriptor = "[LGALAVQEJ;")
    ...
    @OriginalMember(owner = "client!GALAVQEJ", name = "a", descriptor = "(I)LGALAVQEJ;")
    ...
    @OriginalMember(owner = "client!GALAVQEJ", name = "b", descriptor = "(I)LCSGBDGDY;")
    ...
    @OriginalMember(owner = "client!GALAVQEJ", name = "a", descriptor = "(II[II)LCSGBDGDY;")
    ...
    @OriginalMember(owner = "client!GALAVQEJ", name = "c", descriptor = "(I)LGALAVQEJ;")
    ...
    @OriginalMember(owner = "client!GALAVQEJ", name = "a", descriptor = "(ZLNHEPCMLW;)V")
    ...
    @OriginalMember(owner = "client!GALAVQEJ", name = "a", descriptor = "(LINOFEYKQ;)V")
