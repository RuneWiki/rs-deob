...
public class class12 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Lbt;BI)V", line = 200)
    ...
    @OriginalMember(owner = "client!ds", name = "b", descriptor = "(B)V", line = 307)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(ILbt;)V", line = 389)
