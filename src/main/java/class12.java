...
public class class12 extends class193 {
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(Lug;Lpl;)V")
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Lsq;II)V")
    ...
    @OriginalMember(owner = "client!ds", name = "d", descriptor = "(B)[Lup;")
