...
public class class12 extends class9 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Le;IIII)Lbi;")
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(I)Lmk;")
    ...
    @OriginalMember(owner = "client!pm", name = "j", descriptor = "()Lm;")
    public final class187 method84() {
        return new class122();
    }

    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIIIIILtm;II)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lci;)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lm;)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(I[Lap;)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lhi;[Ltr;Z)Ldf;")
    ...
    @OriginalMember(owner = "client!pm", name = "C", descriptor = "()Lm;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Ljava/lang/Runnable;)Lnc;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ILtm;II)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lw;III)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Ltr;Z)Lae;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "([IIIII)Lae;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "([Lbi;Lm;[Loo;I)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(II[I[I)Ltm;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lbi;Lci;Lm;Loo;I)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIIIII)Lsd;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lmk;)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lsd;Lsd;FLsd;)Lsd;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(II[[I[[IIII)Lui;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lsd;)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIIIZ)Lae;")
    ...
    @OriginalMember(owner = "client!pm", name = "<init>", descriptor = "(Ljava/awt/Canvas;Lic;I)V")
