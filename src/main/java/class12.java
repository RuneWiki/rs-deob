...
public class class12 extends class305 {
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 7)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(II)[I", line = 62)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ILfh;B)V", line = 97)
    ...
    @OriginalMember(owner = "client!ad", name = "<init>", descriptor = "()V", line = 166)
    public class12() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(B)V", line = 148)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ILtt;)V", line = 173)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(IB)[[I", line = 211)
    ...
    @OriginalMember(owner = "client!ad", name = "f", descriptor = "(I)V", line = 258)
