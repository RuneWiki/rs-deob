...
public class class12 {
    ...
    @OriginalMember(owner = "client!EKGZTZOT", name = "d", descriptor = "[LAJSSLSFA;")
    ...
    @OriginalMember(owner = "client!EKGZTZOT", name = "a", descriptor = "(J)LAJSSLSFA;")
    ...
    @OriginalMember(owner = "client!EKGZTZOT", name = "a", descriptor = "(LAJSSLSFA;JI)V")
