...
public class class12 extends class224 {
    ...
    @OriginalMember(owner = "client!dka", name = "<init>", descriptor = "(Lvf;II)V")
    ...
    @OriginalMember(owner = "client!dka", name = "<init>", descriptor = "(Lvf;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!dka", name = "<init>", descriptor = "(Lvf;IIZ[[BI)V")
