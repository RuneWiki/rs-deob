...
public class class12 implements class607 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(B[J[I)V")
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Lwaa;BIII)V")
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ILpm;BI)V")
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ILpca;I)V")
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IBLwaa;I)V")
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Lpm;BI)V")
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "(Lqj;)V")
