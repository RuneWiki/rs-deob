...
public class class12 extends class401 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(J)V", line = 5)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Llg;IIIIIIIIIIIZ)V", line = 132)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(JI)V", line = 150)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "()V", line = 547)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "()V", line = 559)
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "(Llg;IIIIIIIIIIIZ)V", line = 569)
