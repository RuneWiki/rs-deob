...
public class class12 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(IZ)Llca;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(ILjn;)V")
    ...
    @OriginalMember(owner = "client!ma", name = "<init>", descriptor = "(Ler;ILjn;Ljn;)V")
