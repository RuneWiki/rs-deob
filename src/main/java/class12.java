...
public class class12 {
    ...
    @OriginalMember(owner = "client!ds", name = "b", descriptor = "(B)Lmt;")
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Lmt;JZ)V")
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(JI)Lmt;")
