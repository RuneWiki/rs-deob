...
public class class12 {
    ...
    @OriginalMember(owner = "client!EOJHVRZF", name = "f", descriptor = "LEWMBJETC;")
    private class13 field703 = new class13();

    @OriginalMember(owner = "client!EOJHVRZF", name = "j", descriptor = "LODYOEFFK;")
    ...
    @OriginalMember(owner = "client!EOJHVRZF", name = "i", descriptor = "LOAXQGLDV;")
    ...
    @OriginalMember(owner = "client!EOJHVRZF", name = "a", descriptor = "(J)LEWMBJETC;")
    ...
    @OriginalMember(owner = "client!EOJHVRZF", name = "a", descriptor = "(JILEWMBJETC;)V")
