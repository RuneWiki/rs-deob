...
public class class12 extends class30 {
    ...
    @OriginalMember(owner = "client!qk", name = "c", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!qk", name = "f", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!qk", name = "e", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(III)I", line = 63)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Ljg;II)V", line = 79)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IB)[I", line = 123)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IIILjava/lang/Class;)Ljr;", line = 251)
    ...
    @OriginalMember(owner = "client!qk", name = "f", descriptor = "(B)V", line = 276)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IIZ)V", line = 312)
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "()V", line = 374)
    public class12() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IIIIIIIILe;I[[[BZI)V", line = 341)
