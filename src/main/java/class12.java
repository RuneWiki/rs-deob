...
public class class12 extends class157 implements class28 {
    ...
    @OriginalMember(owner = "client!ma", name = "c", descriptor = "()[Ldl;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lm;Lcf;II)V")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lm;Lcf;I)V")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "()[Lfr;")
    ...
    @OriginalMember(owner = "client!ma", name = "<init>", descriptor = "(La;Lc;Lei;IIII)V")
