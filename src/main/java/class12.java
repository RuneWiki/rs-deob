...
public class class12 implements Runnable {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(ILpca;)V")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(ZLjava/lang/String;)Lml;")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(ILlv;)V")
