...
public class class12 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IIIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!oo", name = "b", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(II)Lhca;", line = 63)
    ...
    @OriginalMember(owner = "client!oo", name = "c", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Z)V", line = 121)
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "(Lmca;ILgga;)V", line = 154)
    public class12(class41 arg0, int arg1, class513 arg2) {
        this.field148 = arg2;
        this.field157 = this.field148.method3007(-1, 4);
    }

    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IB)V", line = 139)
