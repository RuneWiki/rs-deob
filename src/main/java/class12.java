...
public class class12 extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!DZXWUJSL", name = "p", descriptor = "[LSWNASVGQ;")
    ...
    @OriginalMember(owner = "client!DZXWUJSL", name = "q", descriptor = "LIOEGEBWF;")
    public class21 field718;

    @OriginalMember(owner = "client!DZXWUJSL", name = "o", descriptor = "LWOKQCNXG;")
