...
public class class12 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lsl;I)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lsl;II)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ZLsl;)Lsg;")
