...
public class class12 {
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/Class;", line = 4)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(BIIIILdc;II)Ldc;", line = 350)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Lnj;I)V", line = 410)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(BIIZ)I", line = 434)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Lnj;II)V", line = 548)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(B)V", line = 707)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ZLjava/lang/String;ILlm;)Lle;", line = 729)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(BLdc;IIII)Ldc;", line = 783)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IIC)C", line = 905)
