...
public class class12 extends class56 {
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;BLjava/lang/String;)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(II)[I", line = 24)
    ...
    @OriginalMember(owner = "client!daa", name = "c", descriptor = "(III)I", line = 112)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(BI)[[I", line = 133)
    ...
    @OriginalMember(owner = "client!daa", name = "c", descriptor = "(I)V", line = 266)
    ...
    @OriginalMember(owner = "client!daa", name = "<init>", descriptor = "()V", line = 282)
    public class12() {
        super(1, false);
    }

    @OriginalMember(owner = "client!daa", name = "d", descriptor = "(III)Z", line = 286)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(BILes;)V", line = 305)
