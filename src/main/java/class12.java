...
public abstract class class12 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(IIIII)V", line = 418)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "([[[Lwr;IIIZI)Z", line = 57)
    ...
    @OriginalMember(owner = "client!ds", name = "b", descriptor = "(I)V", line = 377)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IIIB)V", line = 432)
