...
public class class12 extends class381 {
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(Z)V", line = 111)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IC)I", line = 123)
    ...
    @OriginalMember(owner = "client!uw", name = "b", descriptor = "(I)V", line = 138)
    public static void method81(int arg0) {
        field295 = null;
        int var1 = 38 / ((arg0 + 46) / 57);
    }

    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IB)I", line = 155)
    public static final int method82(int arg0, byte arg1) {
        field293++;
        return arg1 > -111 ? -42 : arg0 >>> 8;
    }

    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(B)V", line = 167)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "([BLne;I[I)Z", line = 186)
    ...
    @OriginalMember(owner = "client!uw", name = "<init>", descriptor = "()V", line = 241)
    public class12() {
    }

    @OriginalMember(owner = "client!uw", name = "<init>", descriptor = "([B)V", line = 247)
    ...
    @OriginalMember(owner = "client!uw", name = "b", descriptor = "(B)V", line = 890)
