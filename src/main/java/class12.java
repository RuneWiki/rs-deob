...
public class class12 implements class456 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IIBIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(IIIIIIZZ)V", line = 22)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "()V", line = 37)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(Lpga;Lit;Ljba;)V", line = 54)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IIIIIIZZ)V", line = 98)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IIILrs;II)Lsb;", line = 106)
