...
public class class12 {
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ILtq;)Lsi;", line = 4)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(BLjava/lang/String;)V", line = 23)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(B)V", line = 41)
