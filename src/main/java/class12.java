...
public class class12 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IB)V", line = 24)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(II)Ldj;", line = 40)
    ...
    @OriginalMember(owner = "client!ds", name = "b", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!ds", name = "c", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(Lgo;ILns;)V", line = 99)
