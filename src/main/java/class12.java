...
@OriginalClass("client!ECQQOXBD")
public class class12 {

    @OriginalMember(owner = "client!ECQQOXBD", name = "a", descriptor = "I")
    private int field637 = -40275;

    @OriginalMember(owner = "client!ECQQOXBD", name = "b", descriptor = "I")
    private int field638;

    @OriginalMember(owner = "client!ECQQOXBD", name = "c", descriptor = "[LTLIWLEHU;")
    private class54[] field639;

    @OriginalMember(owner = "client!ECQQOXBD", name = "<init>", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!ECQQOXBD", name = "a", descriptor = "(J)LTLIWLEHU;")
    ...
    @OriginalMember(owner = "client!ECQQOXBD", name = "a", descriptor = "(JLTLIWLEHU;Z)V")
