...
public class class12 {
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(II)Lsia;")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(I)[Lqj;")
    ...
    @OriginalMember(owner = "client!vl", name = "<init>", descriptor = "(Lrda;Ld;)V")
