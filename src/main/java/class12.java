...
public class class12 {
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(ILha;I)V")
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(I)[Ldv;")
    ...
    @OriginalMember(owner = "client!daa", name = "<init>", descriptor = "(Lda;)V")
    ...
    @OriginalMember(owner = "client!daa", name = "<init>", descriptor = "(Lda;Llq;)V")
