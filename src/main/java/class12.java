...
public class class12 extends class60 {
    ...
    @OriginalMember(owner = "client!CYZGZTKE", name = "m", descriptor = "Z")
    public static boolean field583;

    @OriginalMember(owner = "client!CYZGZTKE", name = "k", descriptor = "[LBRVNRJXX;")
    ...
    @OriginalMember(owner = "client!CYZGZTKE", name = "a", descriptor = "(I)LLFTMDGKK;")
