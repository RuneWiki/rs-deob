...
public class class12 extends class28 {
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(ZIBIIZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!uw", name = "<init>", descriptor = "(Lpi;)V", line = 65)
