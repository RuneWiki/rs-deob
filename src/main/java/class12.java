...
public class class12 extends class19 {
    ...
    @OriginalMember(owner = "client!DLNMSHLT", name = "<init>", descriptor = "(LHRXSNEYZ;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!DLNMSHLT", name = "a", descriptor = "(LYAPSNHGU;III)V")
