...
public class class12 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ILjd;)V")
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(BLvfa;I)Z")
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IIILev;IIIBIII)Z")
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "(Lag;)V")
