...
public class class12 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ILvt;)V", line = 10)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(III)V", line = 34)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIILdd;IILoj;)Lqh;", line = 64)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(I)V", line = 185)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IILvt;)V", line = 203)
