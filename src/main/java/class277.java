...
public class class277 extends class225 {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(ILnj;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(IZ)V", line = 60)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(II)I", line = 314)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 337)
    ...
    @OriginalMember(owner = "client!ga", name = "b", descriptor = "(II)V", line = 367)
    ...
    @OriginalMember(owner = "client!ga", name = "e", descriptor = "(I)I", line = 380)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(IIIIII)Z", line = 406)
    ...
    @OriginalMember(owner = "client!ga", name = "d", descriptor = "(B)V", line = 443)
    ...
    @OriginalMember(owner = "client!ga", name = "c", descriptor = "(II)Ljava/lang/String;", line = 456)
    ...
    @OriginalMember(owner = "client!ga", name = "f", descriptor = "(I)V", line = 479)
    ...
    @OriginalMember(owner = "client!ga", name = "g", descriptor = "(I)V", line = 501)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(ILnj;)V", line = 533)
    ...
    @OriginalMember(owner = "client!ga", name = "d", descriptor = "(II)Z", line = 555)
