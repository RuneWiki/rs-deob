...
public class class277 extends class304 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!mm", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 4)
    public final synchronized void focusLost(FocusEvent arg0) {
        this.method1655(0, (byte) 117, '\u0000', -1);
        field3396++;
    }

    @OriginalMember(owner = "client!mm", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 20)
    public final synchronized void keyPressed(KeyEvent arg0) {
        this.method1660(0, false, arg0);
        field3404++;
    }

    @OriginalMember(owner = "client!mm", name = "c", descriptor = "(I)I", line = 28)
    ...
    @OriginalMember(owner = "client!mm", name = "d", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Z)V", line = 79)
    ...
    @OriginalMember(owner = "client!mm", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 90)
    public final void focusGained(FocusEvent arg0) {
        field3391++;
    }

    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IBCI)V", line = 99)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IB)Z", line = 208)
    ...
    @OriginalMember(owner = "client!mm", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 227)
    public final synchronized void keyReleased(KeyEvent arg0) {
        field3386++;
        this.method1660(1, false, arg0);
    }

    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(I)Lq;", line = 235)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Ljava/lang/String;BI)I", line = 246)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IZLjava/awt/event/KeyEvent;)V", line = 258)
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 351)
    public class277(Component arg0) {
        class627.method3594((byte) 115);
        this.method1661(arg0, (byte) 119);
    }

    @OriginalMember(owner = "client!mm", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 298)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Ljava/awt/Component;B)V", line = 317)
