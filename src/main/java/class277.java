...
public class class277 extends class601 {
    ...
    @OriginalMember(owner = "client!oe", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!oe", name = "b", descriptor = "(II)V", line = 36)
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(Lqea;)V", line = 46)
    public class277(class339 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(I)I", line = 49)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IB)I", line = 60)
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(ILqea;)V", line = 71)
    public class277(int arg0, class339 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!oe", name = "c", descriptor = "(I)I", line = 78)
