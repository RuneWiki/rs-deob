...
public class class277 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ZB)Z", line = 6)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IIIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(II)Lrj;", line = 103)
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "(Lwv;ILqs;)V", line = 174)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IIIIIIIIII)V", line = 139)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(I)V", line = 165)
