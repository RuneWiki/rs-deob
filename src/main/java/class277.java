...
public class class277 extends Canvas {
    ...
    @OriginalMember(owner = "client!mu", name = "paint", descriptor = "(Ljava/awt/Graphics;)V")
    ...
    @OriginalMember(owner = "client!mu", name = "update", descriptor = "(Ljava/awt/Graphics;)V")
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Ljava/awt/Component;)V")
