...
public class class277 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(II)Lbga;")
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "(ILpe;Lpe;)V")
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(ILoa;)V")
