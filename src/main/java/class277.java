...
public class class277 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(CII)C", line = 3)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(ILdp;)V", line = 82)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(Lbi;I)V", line = 103)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(III)Z", line = 114)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(I)Z", line = 125)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(ZLjw;)V", line = 137)
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!re", name = "c", descriptor = "(I)Lcda;", line = 177)
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 268)
    public class277(String arg0) {
        this.field3887 = arg0;
    }

    @OriginalMember(owner = "client!re", name = "a", descriptor = "(ILjw;)V", line = 198)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(I[BLjava/lang/String;I)I", line = 223)
