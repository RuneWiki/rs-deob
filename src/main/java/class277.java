...
public class class277 {
    ...
    @OriginalMember(owner = "client!tia", name = "a", descriptor = "(Lpi;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!tia", name = "a", descriptor = "(II)Lub;")
    ...
    @OriginalMember(owner = "client!tia", name = "<init>", descriptor = "(Liv;ILcb;)V")
