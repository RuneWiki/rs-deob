...
public class class277 extends class176 {
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Lbt;IIIZ[I)V", line = 5)
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Lbt;IIIIIIZ)V", line = 26)
    ...
    @OriginalMember(owner = "client!hf", name = "f", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!hf", name = "g", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!hf", name = "h", descriptor = "(I)V", line = 189)
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Lbt;IIIII[BI)V", line = 205)
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Lbt;IIIIIZ)V", line = 221)
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Lbt;IIIIZ[BI)V", line = 250)
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Lbt;IIII[I)V", line = 280)
