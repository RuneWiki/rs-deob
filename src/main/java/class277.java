...
public class class277 extends class439 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(BII)V", line = 3)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IBI)V", line = 860)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(III)V", line = 879)
    ...
    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "(IIIIIII)V", line = 898)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(B)V", line = 910)
