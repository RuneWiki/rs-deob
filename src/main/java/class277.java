...
public class class277 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(BLjc;)V")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lqp;B)Z")
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(ILjc;)V")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(ILjc;)V")
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(Ljc;)V")
