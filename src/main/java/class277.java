...
public class class277 extends class131 {
    ...
    @OriginalMember(owner = "client!ae", name = "c", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!ae", name = "d", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!ae", name = "d", descriptor = "(I)Llq;", line = 153)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Lvg;I)Lvg;", line = 164)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Lh;B)I", line = 180)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IZ)V", line = 233)
