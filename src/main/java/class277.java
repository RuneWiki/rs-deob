...
public class class277 extends class644 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(ILria;)V", line = 4)
    ...
    @OriginalMember(owner = "client!vea", name = "b", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "()V", line = 71)
    ...
    @OriginalMember(owner = "client!vea", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZJZ)V", line = 248)
