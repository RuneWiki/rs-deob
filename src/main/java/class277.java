...
public class class277 extends class56 {
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(BILes;)V", line = 9)
    ...
    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "()V", line = 54)
    public class277() {
        super(1, false);
    }

    @OriginalMember(owner = "client!mb", name = "b", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(BI)[[I", line = 87)
