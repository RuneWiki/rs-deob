...
public class class277 extends class43 {
    ...
    @OriginalMember(owner = "client!hc", name = "b", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(ZZLup;I)V", line = 22)
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "([B)V", line = 88)
    public class277(byte[] arg0) {
        this.field3582 = arg0;
    }

    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(BC)Z", line = 96)
