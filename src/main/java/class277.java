...
public class class277 {
    ...
    @OriginalMember(owner = "client!rp", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field4344++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "(I)V", line = 30)
