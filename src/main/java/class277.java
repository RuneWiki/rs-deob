...
public class class277 extends class105 {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 12)
    ...
    @OriginalMember(owner = "client!eo", name = "c", descriptor = "()I", line = 49)
    public final int method742() {
        return this.field4090 - (this.field4092.available() >> (class263.field3896 ? 2 : 1));
    }

    @OriginalMember(owner = "client!eo", name = "d", descriptor = "()V", line = 58)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "()V", line = 91)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 97)
    ...
    @OriginalMember(owner = "client!eo", name = "c", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!eo", name = "b", descriptor = "()V", line = 138)
