...
public class class277 extends class623 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(Ltn;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!rk", name = "c", descriptor = "(II)Lfq;")
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ILtn;)V")
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "([IILtn;)V")
