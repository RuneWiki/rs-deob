...
public class class277 extends class15 {
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IZI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "([BI)[B", line = 15)
    ...
    @OriginalMember(owner = "client!rr", name = "<init>", descriptor = "(Lbv;II[B)V", line = 30)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(B)V", line = 52)
