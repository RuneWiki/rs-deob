...
public class class277 implements class126 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IILob;II)V")
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(II)Lwr;")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(II)Lfg;")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ZLmq;)V")
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Lbu;Lbu;Lbu;)V")
