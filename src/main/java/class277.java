...
public class class277 extends class184 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(I[II)V", line = 3)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IIII)V", line = 126)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IIFII)V", line = 137)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(BI)V", line = 246)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(II)V", line = 262)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(JI)V", line = 277)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(B)V", line = 302)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(I)V", line = 382)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(BI)V", line = 409)
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(Lmh;IIIII)V", line = 429)
