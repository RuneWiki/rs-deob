...
public class class277 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Lbu;I)V")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Z)Lkp;")
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(I)Lkp;")
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(Lbu;)V")
