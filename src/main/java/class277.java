...
public class class277 {
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(Z)[Lng;")
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Loe;B)V")
