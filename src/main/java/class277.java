...
public class class277 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(B[B)Lnc;", line = 3)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(III)Lja;", line = 94)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Z)V", line = 114)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IIIII)V", line = 137)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(II)Lep;", line = 172)
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "(ILfo;Lfo;)V", line = 214)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(ILjava/lang/String;)V", line = 241)
