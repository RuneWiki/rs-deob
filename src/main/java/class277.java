...
public class class277 extends class449 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Z)J", line = 3)
    public final long method1442(boolean arg0) {
        return arg0 ? -58L : this.field4182;
    }

    @OriginalMember(owner = "client!df", name = "c", descriptor = "(I)J", line = 15)
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "()V", line = 102)
    public class277() {
    ...
    @OriginalMember(owner = "client!df", name = "b", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(II)I", line = 63)
