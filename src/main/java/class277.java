...
public class class277 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IIILjo;Lwm;III)Ljd;")
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(II)Lqf;")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ILur;ILwm;ZIZLjo;ILwm;IB)Ljd;")
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Ldn;IZLbe;Lr;Lr;)V")
