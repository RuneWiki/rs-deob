...
public class class277 {
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(II)Lfga;")
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(BLvfa;)Lvfa;")
    ...
    @OriginalMember(owner = "client!vea", name = "b", descriptor = "(I)Lpf;")
