...
public abstract class class277 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!kj", name = "b", descriptor = "(BII)V", line = 21)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(BIIIIZ)V", line = 45)
    ...
    @OriginalMember(owner = "client!kj", name = "b", descriptor = "(I)V", line = 244)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Lwn;I[IB)V", line = 271)
