...
public class class277 {
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(II[BI)Ljava/lang/String;", line = 11)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(BI)V", line = 73)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(II)V", line = 89)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!gaa", name = "b", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!gaa", name = "c", descriptor = "(B)V", line = 134)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Laj;II)V", line = 195)
