...
public class class277 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(II)Lbq;", line = 24)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(III)V", line = 79)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(B)V", line = 92)
    ...
    @OriginalMember(owner = "client!up", name = "b", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(ILsba;)V", line = 185)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(Lrga;ILni;Lni;)V", line = 211)
    ...
    @OriginalMember(owner = "client!up", name = "c", descriptor = "(I)V", line = 231)
