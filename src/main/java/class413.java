...
public abstract class class413 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(IILtn;I)V")
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ZLdb;ILda;Lqa;Lvb;II)V")
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ILhh;)V")
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Z[[[Lkf;IIZI)Z")
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(BLtn;)V")
