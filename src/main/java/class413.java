...
public class class413 extends class125 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IIIIFZIZ)[I", line = 4)
    ...
    @OriginalMember(owner = "client!uh", name = "<init>", descriptor = "(Lgp;)V", line = 29)
    public class413(class549 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!uh", name = "c", descriptor = "(Z)V", line = 34)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(ZI)I", line = 47)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(I)Z", line = 110)
    ...
    @OriginalMember(owner = "client!uh", name = "<init>", descriptor = "(ILgp;)V", line = 124)
    public class413(int arg0, class549 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(B)I", line = 129)
    ...
    @OriginalMember(owner = "client!uh", name = "d", descriptor = "(Z)I", line = 139)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(Z)V", line = 153)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(BI)V", line = 170)
