...
public class class413 extends class748 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IZLvj;)V", line = 6)
    ...
    @OriginalMember(owner = "client!uh", name = "g", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!uh", name = "h", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!uh", name = "i", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(II)[[I", line = 188)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(II)[I", line = 322)
