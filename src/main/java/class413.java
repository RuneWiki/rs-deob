...
public class class413 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Lsu;I)V")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(B)Lsu;")
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(I)Lsu;")
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(B)Lsu;")
