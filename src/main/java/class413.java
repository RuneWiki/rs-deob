...
public abstract class class413 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(ILgo;I)I", line = 21)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Lgo;I)V", line = 75)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IIILjava/lang/Object;)[B", line = 139)
