...
public class class413 extends class363 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(ZI)V", line = 7)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(ZB)V", line = 37)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Ljk;IB)V", line = 51)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(BII)Z", line = 62)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IIIZLje;Lea;ILvg;ILjava/lang/String;Loa;I)V", line = 90)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(ZII)Z", line = 136)
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(I)Z", line = 147)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 157)
    ...
    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "(Lod;)V", line = 182)
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(Z)V", line = 200)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(III)V", line = 216)
    ...
    @OriginalMember(owner = "client!lk", name = "c", descriptor = "(Z)V", line = 235)
