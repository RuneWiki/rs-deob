...
public class class413 {
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "([BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(II)Ldf;", line = 201)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(I)V", line = 226)
    ...
    @OriginalMember(owner = "client!naa", name = "<init>", descriptor = "([BI[B)V", line = 257)
