...
public class class413 extends class427 implements class226 {
    ...
    @OriginalMember(owner = "client!sj", name = "b", descriptor = "(BLha;)Lmg;")
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "(Lha;Lsea;IIIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(Lha;I)Luh;")
    ...
    @OriginalMember(owner = "client!sj", name = "c", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!sj", name = "b", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(BIILha;)Z")
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(Lol;I)V")
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(Lpe;B)V")
