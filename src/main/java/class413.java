...
public class class413 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IBIII)V", line = 61)
