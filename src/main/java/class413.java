...
public abstract class class413 {
    ...
    @OriginalMember(owner = "client!jd", name = "b", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "(IIIII)V", line = 381)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(I[I)Ljava/lang/String;", line = 99)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IIII)V", line = 156)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Z)V", line = 324)
    ...
    @OriginalMember(owner = "client!jd", name = "c", descriptor = "(I)V", line = 359)
