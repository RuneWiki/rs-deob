...
public class class413 extends class168 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "([BI)V", line = 47)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "([I)Lct;", line = 54)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Lnd;)Z", line = 118)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Lnd;I)Lrm;", line = 131)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(I)[F", line = 147)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "([B)V", line = 563)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(I)F", line = 716)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Lnd;II)Lrm;", line = 731)
    ...
    @OriginalMember(owner = "client!rm", name = "c", descriptor = "(I)I", line = 746)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "()V", line = 775)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "()I", line = 807)
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "([B)V", line = 815)
