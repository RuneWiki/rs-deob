...
public class class413 extends class98 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!uf", name = "d", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Ljga;", line = 36)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IIIIILjava/lang/String;II)V", line = 53)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!uf", name = "c", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!uf", name = "g", descriptor = "(I)J", line = 102)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(II)I", line = 113)
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "(II)V", line = 131)
    public class413(int arg0, int arg1) {
        super.field844 = (long) arg0 << 32 | (long) arg1;
    }

    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(Z)I", line = 141)
