...
public class class413 {
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IBLr;I)Z", line = 8)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(ILr;II)V", line = 79)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIIZ[[ZI)V", line = 151)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(I)V", line = 352)
    public static void method2556(int arg0) {
        int var1 = -46 / ((65 - arg0) / 61);
        field6003 = null;
    }

    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(I)V", line = 366)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IILr;I)V", line = 400)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIIII)V", line = 473)
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Lwga;Lqm;)V", line = 516)
