...
public class class413 extends class477 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IFFFB)F")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IIIB)V")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IFI[FIIIIFIIIF)V")
