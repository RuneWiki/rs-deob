...
public class class413 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IZIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(B)Ljava/lang/String;", line = 36)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ZIIIIII)V", line = 62)
