...
public class class413 extends class56 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(IZ[Lkq;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(BILes;)V")
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(IIBLbt;)Lbj;")
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(Loq;Loq;I)V")
