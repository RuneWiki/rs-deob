...
public class class413 extends class646 {
    ...
    @OriginalMember(owner = "client!maa", name = "b", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!maa", name = "<init>", descriptor = "()V", line = 14)
    public class413() {
        super(0, true);
    }

    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(Lek;IB)V", line = 18)
    ...
    @OriginalMember(owner = "client!maa", name = "c", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(ILis;)V", line = 91)
    ...
    @OriginalMember(owner = "client!maa", name = "b", descriptor = "(IB)[I", line = 117)
