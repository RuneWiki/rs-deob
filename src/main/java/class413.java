...
public class class413 extends class83 implements class116 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(ILoj;II)Z")
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Loj;B)V")
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Lqo;B)V")
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(III)Lv;")
    ...
    @OriginalMember(owner = "client!s", name = "d", descriptor = "(ILoj;)V")
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(ILoj;B)Lqh;")
    ...
    @OriginalMember(owner = "client!s", name = "<init>", descriptor = "(Loj;Lcu;IIIIIZIIIIIII)V")
    ...
    @OriginalMember(owner = "client!s", name = "c", descriptor = "(ILoj;)Lmg;")
    ...
    @OriginalMember(owner = "client!s", name = "b", descriptor = "(ILoj;)V")
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(IIZLa;IBLoj;)V")
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(ILoj;)V")
