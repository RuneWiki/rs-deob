...
public class class413 extends class263 {
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(III)V", line = 8)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(ZB)V", line = 58)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IZ)V", line = 106)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Lce;IZ)V", line = 117)
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(Lbl;Lmt;)V", line = 129)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(I)Z", line = 207)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Z)Z", line = 225)
    ...
    @OriginalMember(owner = "client!ou", name = "c", descriptor = "(I)[Lvh;", line = 332)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(II)Ltq;", line = 348)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(B)V", line = 372)
    ...
    @OriginalMember(owner = "client!ou", name = "d", descriptor = "(I)V", line = 390)
