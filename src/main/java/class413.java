...
public class class413 extends class42 {
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IIILjava/lang/Class;)Lsv;", line = 65)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(II)V", line = 90)
