...
public class class413 extends class342 {
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(I)J", line = 3)
    public final long method1965(int arg0) {
        return arg0 == 1 ? this.field5859 : 68L;
    }

    @OriginalMember(owner = "client!pr", name = "e", descriptor = "(I)J", line = 15)
    ...
    @OriginalMember(owner = "client!pr", name = "c", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(B)J", line = 80)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(JI)I", line = 100)
