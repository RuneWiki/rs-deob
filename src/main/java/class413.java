...
public class class413 extends class176 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IIIIIII)I", line = 3)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Ljava/lang/String;I)[B", line = 49)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IIB)I", line = 187)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(I[IZ)[I", line = 214)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Lcc;III)V", line = 276)
