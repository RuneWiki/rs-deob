...
public class class413 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lfu;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lfu;)V", line = 348)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(Lfu;)V", line = 357)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lfu;Lpa;)V", line = 367)
    ...
    @OriginalMember(owner = "client!cm", name = "c", descriptor = "(Lfu;)V", line = 594)
