...
public class class413 extends class17 {
    ...
    @OriginalMember(owner = "client!uo", name = "g", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(ZZ)V", line = 124)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IB)[[I", line = 192)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Ll;ILza;IIII)V", line = 245)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(BI)V", line = 328)
    ...
    @OriginalMember(owner = "client!uo", name = "c", descriptor = "(B)V", line = 583)
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(II)I", line = 594)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "()V", line = 607)
    public class413() {
        super(1, false);
    }

    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(B[Ljava/lang/String;)[Ljava/lang/String;", line = 610)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Lwm;II)V", line = 636)
