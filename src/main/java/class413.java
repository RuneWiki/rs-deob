...
public class class413 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(III)Lkfa;")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IBZ)Lbd;")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(ILni;Lni;Lni;Lni;)V")
