...
public class class413 implements Runnable {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ILwda;)V", line = 8)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!kp", name = "run", descriptor = "()V", line = 33)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Ljava/lang/String;I)Lgd;", line = 72)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "()V", line = 128)
    public class413() {
