...
public abstract class class413 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IC)C", line = 20)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(JLjava/lang/String;IIIILjava/lang/String;I)V", line = 418)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Z)Z", line = 453)
