...
public class class413 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(II)Lbs;")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Lqa;IIBIIILag;)Lf;")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IILpc;IIIZ)V")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(ZLqa;IIZILag;Lqa;ILoa;ZI)Lf;")
    ...
    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "(Lrb;IZLct;Lpc;Lpc;)V")
