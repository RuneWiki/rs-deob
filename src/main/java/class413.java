...
public class class413 {
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(B)J", line = 4)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(BI)V", line = 35)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(II)Lgh;", line = 75)
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "(Lmv;)V", line = 106)
