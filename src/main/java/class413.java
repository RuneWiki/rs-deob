...
public class class413 extends Callback {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Ljava/awt/Component;ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(III)V", line = 48)
    ...
    @OriginalMember(owner = "client!nn", name = "callback", descriptor = "(IIII)I", line = 62)
