...
public abstract class class413 extends class291 {
    ...
    @OriginalMember(owner = "client!id", name = "h", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IIIIIII)V", line = 40)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lya;IZLij;III)V", line = 623)
    ...
    @OriginalMember(owner = "client!id", name = "f", descriptor = "(I)Z", line = 636)
