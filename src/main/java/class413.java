...
public class class413 extends class210 implements class113 {
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Leq;Lhn;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(BLeq;)V")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Leq;IILgs;III[[[B[I[I[I[I[IIBIIZ)V")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Leq;I)V")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IIILbp;IZLeq;)V")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Leq;ZI)Lva;")
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(Leq;Z)Lgl;")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ILeq;Z)Lva;")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ILeq;BI)Z")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Leq;ZII)Luq;")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Leq;Z)V")
