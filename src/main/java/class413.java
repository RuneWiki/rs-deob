...
public class class413 extends class403 {
    ...
    @OriginalMember(owner = "client!nd", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(ZII)V", line = 13)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IIIII)V", line = 94)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IILks;III)V", line = 112)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(III[B)Ljava/lang/String;", line = 235)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(BI)V", line = 305)
    ...
    @OriginalMember(owner = "client!nd", name = "e", descriptor = "(I)V", line = 339)
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "()V", line = 542)
    protected class413() {
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "(Lil;)V", line = 552)
