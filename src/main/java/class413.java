...
public class class413 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Leh;I)V")
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Leh;II)V")
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IBZLoa;)Lxa;")
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(ILgba;II)V")
