...
public class class413 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Lfo;Lfo;IZZ)Lcm;", line = 50)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(II)Lrg;", line = 91)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Lfo;ZILfo;)Lcm;", line = 117)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(B)Z", line = 129)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(III[FIII)V", line = 209)
    ...
    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "(Llba;Lnp;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", line = 303)
