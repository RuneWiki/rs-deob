...
public class class413 extends class559 {
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(BIILuv;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!ifa", name = "<init>", descriptor = "(Ldw;II)V", line = 97)
    ...
    @OriginalMember(owner = "client!ifa", name = "<init>", descriptor = "(Ldw;IIZ[[BI)V", line = 114)
    ...
    @OriginalMember(owner = "client!ifa", name = "<init>", descriptor = "(Ldw;IIZ[[I)V", line = 172)
    ...
    @OriginalMember(owner = "client!ifa", name = "f", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(IBIII)V", line = 153)
