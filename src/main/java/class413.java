...
public class class413 extends class496 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(II)V", line = 21)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(II)V", line = 49)
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "(II)V", line = 64)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(FIIII)V", line = 78)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "([III)V", line = 188)
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(Lnba;IIIII)V", line = 324)
