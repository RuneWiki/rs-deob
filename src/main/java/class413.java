...
public class class413 extends class227 {
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(Lug;II)V", line = 88)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(Ljk;Z)V", line = 133)
    ...
    @OriginalMember(owner = "client!ht", name = "c", descriptor = "(II)I", line = 154)
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "()V", line = 173)
    public class413() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ht", name = "b", descriptor = "(Z)V", line = 181)
    ...
    @OriginalMember(owner = "client!ht", name = "c", descriptor = "(III)Z", line = 198)
