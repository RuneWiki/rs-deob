...
public class class413 {
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(I)I", line = 9)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(Lhp;)V", line = 28)
    ...
    @OriginalMember(owner = "client!ht", name = "b", descriptor = "(Lhp;)V", line = 43)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "()V", line = 49)
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "()V", line = 55)
    public class413() {
        this.field6183[0] = 0;
