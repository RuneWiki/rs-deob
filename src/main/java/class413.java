...
public abstract class class413 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I[Lf;[ILjava/lang/String;I[I[II)V", line = 4)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IILua;ILjava/lang/String;IIIII[Lf;[IIIII)I", line = 167)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 183)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(JJ)J", line = 257)
    public static long method2187(long arg0, long arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!la", name = "a", descriptor = "(III)V", line = 269)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(BZ)V", line = 294)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "([Lf;IIIILjava/util/Random;Ljava/lang/String;I[III[IIII)I", line = 376)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIILjava/lang/String;IIB)V", line = 454)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IZILjava/lang/String;II)V", line = 484)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(II[Lf;I[IIILjava/lang/String;)V", line = 500)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "([ILjava/util/Random;[Lf;IIIILjava/lang/String;ZI)I", line = 516)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(BILjava/lang/String;IIIII)V", line = 553)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/lang/String;II[Lf;[ILua;III)V", line = 585)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILua;Ljava/lang/String;IIZ[IIIII[Lf;IIIII)I", line = 735)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IILjava/lang/String;III)V", line = 838)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIIILjava/lang/String;)V", line = 868)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILes;)Liea;", line = 891)
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(Lr;Lsa;)V", line = 920)
    public class413(class566 arg0, class595 arg1) {
        this.field5155 = arg0;
        this.field5157 = arg1;
    }

    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IBLjava/lang/String;)V", line = 933)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIIIZIII)Z", line = 974)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I)V", line = 1007)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIIIILjava/lang/String;)V", line = 1021)
