...
public class class413 extends class47 {
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Z)J", line = 4)
    public final long method339(boolean arg0) {
        return arg0 ? -34L : this.field5980;
    }

    @OriginalMember(owner = "client!g", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(IZ)I", line = 34)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(I)J", line = 79)
