...
public class class95 {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(IF)I")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Ldh;Ljr;)V")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(IIF)F")
    ...
    @OriginalMember(owner = "client!mr", name = "b", descriptor = "(IIF)F")
