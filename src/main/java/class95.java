...
public class class95 extends class189 {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(FIIBIFIF)[F")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(IZ[II[I)J")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ZBLmga;ILha;IIIILof;)Lka;")
