...
public class class95 extends class156 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 14)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Lsia;Lsia;II)V", line = 91)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIILwu;IZJ)V", line = 247)
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "(Lrda;)V", line = 260)
    public class95(class663 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!sd", name = "c", descriptor = "(Z)Z", line = 267)
    ...
    @OriginalMember(owner = "client!sd", name = "c", descriptor = "(B)I", line = 281)
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(I)Z", line = 293)
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(III)V", line = 331)
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(IZ)V", line = 410)
    ...
    @OriginalMember(owner = "client!sd", name = "d", descriptor = "(B)V", line = 421)
    ...
    @OriginalMember(owner = "client!sd", name = "d", descriptor = "(Z)V", line = 443)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIZ)I", line = 462)
    ...
    @OriginalMember(owner = "client!sd", name = "f", descriptor = "(I)Z", line = 478)
