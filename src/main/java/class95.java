...
public class class95 implements class202 {
    ...
    @OriginalMember(owner = "client!gg", name = "c", descriptor = "()V", line = 3)
    public final void method556() {
        this.field1209.field1918.glBindFramebufferEXT(36160, this.field1207);
    }

    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ILhf;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Lig;)V", line = 121)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ILwl;I)V", line = 42)
    public final void method559(int arg0, class234 arg1, int arg2) {
        this.method564(arg0, arg1, 0, arg2);
    }

    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ILhf;)V", line = 48)
    public final void method560(int arg0, class225 arg1) {
        this.method557(arg0, arg1, 0);
    }

    @OriginalMember(owner = "client!gg", name = "b", descriptor = "()V", line = 51)
    public final void method561() {
        this.field1209.field1918.glBindFramebufferEXT(36160, 0);
    }

    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ILrr;)V", line = 54)
    ...
    @OriginalMember(owner = "client!gg", name = "d", descriptor = "()Z", line = 77)
    public final boolean method563() {
        int var1 = this.field1209.field1918.glCheckFramebufferStatusEXT(36160);
        return var1 == 36053;
    }

    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ILwl;II)V", line = 90)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "()I", line = 119)
    public final int method565() {
        return this.field1205;
    }

    @OriginalMember(owner = "client!gg", name = "b", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!gg", name = "finalize", descriptor = "()V", line = 139)
