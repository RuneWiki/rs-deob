...
public class class95 extends class615 {
    ...
    @OriginalMember(owner = "client!er", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(BILeh;)V", line = 19)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(BLrc;Lrc;)V", line = 35)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "()V", line = 53)
    public class95() {
        super(1, true);
    }

    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IB)[I", line = 61)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Z)I", line = 113)
