...
public class class95 extends class396 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(I[IIIZ)Z", line = 3)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(II)V", line = 30)
    ...
    @OriginalMember(owner = "client!gg", name = "d", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZI)V", line = 271)
    ...
    @OriginalMember(owner = "client!gg", name = "d", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(II[IB)Z", line = 82)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "([IIII)Z", line = 114)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(III)Z", line = 139)
    ...
    @OriginalMember(owner = "client!gg", name = "b", descriptor = "(III)I", line = 162)
    ...
    @OriginalMember(owner = "client!gg", name = "e", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Len;I)V", line = 218)
