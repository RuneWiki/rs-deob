...
public class class95 {
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(ZLjava/lang/String;Ljava/lang/String;)V", line = 16)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(IIIIIIZIII)V", line = 88)
    ...
    @OriginalMember(owner = "client!bba", name = "b", descriptor = "(B)Z", line = 163)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(IIIII)Z", line = 174)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(Lvb;B)V", line = 238)
    ...
    @OriginalMember(owner = "client!bba", name = "<init>", descriptor = "(Lmh;)V", line = 623)
    ...
    @OriginalMember(owner = "client!bba", name = "c", descriptor = "(B)V", line = 257)
    ...
    @OriginalMember(owner = "client!bba", name = "d", descriptor = "(B)V", line = 359)
    ...
    @OriginalMember(owner = "client!bba", name = "b", descriptor = "(I)Z", line = 389)
    ...
    @OriginalMember(owner = "client!bba", name = "e", descriptor = "(B)Loda;", line = 518)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(BLvb;)Z", line = 529)
