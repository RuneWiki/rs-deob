...
public class class95 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ILpe;)I")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(III[Ltc;IIIIBI)V")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIZII)Lsm;")
