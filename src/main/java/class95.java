...
public class class95 extends class10 {
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!wk", name = "c", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!wk", name = "d", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(Lfd;II[B)V", line = 53)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;)V", line = 67)
