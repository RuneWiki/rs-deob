...
public class class95 extends class320 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Z)Lpda;", line = 9)
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(Lrl;IIIIII)V", line = 76)
    ...
    @OriginalMember(owner = "client!rm", name = "c", descriptor = "(I)V", line = 90)
