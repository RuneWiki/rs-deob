...
public class class95 extends class392 {
    ...
    @OriginalMember(owner = "client!qe", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!qe", name = "b", descriptor = "(Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!qe", name = "c", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!qe", name = "b", descriptor = "(II)I", line = 48)
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(Lw;)V", line = 61)
    public class95(class675 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qe", name = "d", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(ILw;)V", line = 111)
    public class95(int arg0, class675 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(BI)V", line = 115)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Z)I", line = 126)
    ...
    @OriginalMember(owner = "client!qe", name = "e", descriptor = "(I)I", line = 137)
