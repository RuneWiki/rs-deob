...
public class class95 extends class399 {
    ...
    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ZZ)Z", line = 19)
    public static boolean method525(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Loa;III)Z", line = 29)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(I[J[III)V", line = 55)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(II)V", line = 123)
