...
public class class95 {
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(B)Z", line = 22)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(I)V", line = 296)
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(I)V", line = 313)
    ...
    @OriginalMember(owner = "client!gm", name = "c", descriptor = "(B)Z", line = 325)
    ...
    @OriginalMember(owner = "client!gm", name = "c", descriptor = "(I)Z", line = 341)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Z)I", line = 352)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ZI)V", line = 363)
    ...
    @OriginalMember(owner = "client!gm", name = "d", descriptor = "(I)V", line = 393)
    ...
    @OriginalMember(owner = "client!gm", name = "d", descriptor = "(B)V", line = 424)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ZBIIZ)Lml;", line = 454)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IZLkc;)V", line = 498)
    ...
    @OriginalMember(owner = "client!gm", name = "e", descriptor = "(B)V", line = 573)
    ...
    @OriginalMember(owner = "client!gm", name = "f", descriptor = "(B)V", line = 596)
