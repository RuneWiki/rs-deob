...
public class class95 extends class521 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ZLhs;)V")
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ZI[[[Ltg;IZI)Z")
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Z)Lbt;")
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ILbt;)V")
    ...
    @OriginalMember(owner = "client!bk", name = "<init>", descriptor = "(Lhs;)V")
