...
public class class95 extends class38 {
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 24)
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "()V", line = 38)
    public class95() {
        super(1, true);
    }

    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(BI)[I", line = 41)
