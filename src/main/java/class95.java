...
public class class95 extends class346 {
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "()V", line = 4)
    public class95() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ld", name = "b", descriptor = "(II)[I", line = 8)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Lir;I)V", line = 87)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(BZ)C", line = 102)
    ...
    @OriginalMember(owner = "client!ld", name = "d", descriptor = "(B)V", line = 137)
    ...
    @OriginalMember(owner = "client!ld", name = "e", descriptor = "(B)V", line = 170)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IIII)V", line = 184)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Lfb;ZI)V", line = 198)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(ILir;I)Lvn;", line = 243)
    ...
    @OriginalMember(owner = "client!ld", name = "b", descriptor = "(B)V", line = 274)
