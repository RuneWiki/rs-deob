...
public class class95 extends class531 {
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(IZLdca;)V")
    ...
    @OriginalMember(owner = "client!oia", name = "<init>", descriptor = "(Lqfa;Lgo;)V")
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(FFIFLafa;ZIIFFI)[B")
