...
public class class95 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(Lok;ZLok;Lrl;Lok;)Z", line = 5)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(II)V", line = 26)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(B)V", line = 115)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(BI)Z", line = 128)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(ZLgk;)V", line = 147)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(ILgk;I)V", line = 187)
