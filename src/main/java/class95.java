...
public class class95 implements class690 {
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(B)Lam;", line = 36)
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "(Lkha;Ljava/lang/String;)V", line = 47)
