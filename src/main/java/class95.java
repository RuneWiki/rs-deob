...
public abstract class class95 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(ILdg;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Ltq;I)I")
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(ILae;II)V")
