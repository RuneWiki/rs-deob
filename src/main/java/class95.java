...
public class class95 {
    ...
    @OriginalMember(owner = "client!ik", name = "<init>", descriptor = "(Lrs;[BI)V", line = 4)
    ...
    @OriginalMember(owner = "client!ik", name = "<init>", descriptor = "(Lrs;Ljaclib/memory/Buffer;)V", line = 13)
    public class95(class166 arg0, Buffer arg1) {
        this.field1416 = arg0;
        this.field1415 = arg1;
    }

    @OriginalMember(owner = "client!ik", name = "a", descriptor = "([BI)V", line = 22)
