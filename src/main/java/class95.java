...
public class class95 extends class300 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lmo;)V", line = 11)
    public final void method9(class195 arg0) {
        this.field4409.method929(arg0);
    }

    @OriginalMember(owner = "client!qc", name = "b", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Lge;Lmk;)V", line = 69)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!qc", name = "c", descriptor = "()V", line = 177)
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(Z)V", line = 201)
    public final void method7(boolean arg0) {
    }

    @OriginalMember(owner = "client!qc", name = "a", descriptor = "()Z", line = 203)
