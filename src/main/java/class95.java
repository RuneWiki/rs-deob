...
public abstract class class95 extends class147 {
    ...
    @OriginalMember(owner = "client!ka", name = "P", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ka", name = "X", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ka", name = "Z", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ka", name = "L", descriptor = "Loh;")
    public static class138 field1937;

    @OriginalMember(owner = "client!ka", name = "R", descriptor = "Loh;")
    public static class138 field1943;

    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(I)Lue;")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIIIILka;IJZ)Z")
