...
public abstract class class95 {
    ...
    @OriginalMember(owner = "client!gg", name = "finalize", descriptor = "()V", line = 5)
    protected final void finalize() throws Throwable {
        this.field1411.method2139(this.field1409, this.field1413);
        super.finalize();
    }

    @OriginalMember(owner = "client!gg", name = "a", descriptor = "()I", line = 10)
    public int method641() {
        return this.field1409;
    }

    @OriginalMember(owner = "client!gg", name = "a", descriptor = "([BI)V", line = 28)
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Lhj;I[BIZ)V", line = 40)
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Lhj;ILjava/nio/ByteBuffer;Z)V", line = 57)
