...
public class class95 implements class126 {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(ZZIIFI)[F", line = 14)
    ...
    @OriginalMember(owner = "client!mr", name = "b", descriptor = "(II)Loh;", line = 31)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(FIIZII)[I", line = 49)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(BI)Ldn;", line = 62)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(II)Z", line = 91)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(FZIIII)[I", line = 104)
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(Lpc;Lpc;Lpc;)V", line = 118)
