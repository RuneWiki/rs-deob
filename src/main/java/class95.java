...
public class class95 extends class92 {
    ...
    @OriginalMember(owner = "client!ri", name = "<init>", descriptor = "(Lcb;Llg;[Lqm;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ri", name = "HA", descriptor = "(CIIIZ)V", line = 306)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(CIIIZLpa;II)V", line = 331)
