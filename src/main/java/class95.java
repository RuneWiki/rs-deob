...
public class class95 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Z)J", line = 4)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(BI)V", line = 21)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(II)[B", line = 50)
