...
public class class95 {
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(Lh;[BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "([BI)V", line = 20)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(Lh;Ljava/nio/ByteBuffer;)V", line = 28)
