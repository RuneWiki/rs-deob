...
public class class95 implements Runnable {
    ...
    @OriginalMember(owner = "client!mr", name = "finalize", descriptor = "()V", line = 3)
    protected final void finalize() {
        field1324++;
        this.method644(-92);
    }

    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!mr", name = "b", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "([BIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!mr", name = "c", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(B)I", line = 140)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(B[[BLmi;)V", line = 160)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(IIZ)V", line = 236)
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(Ljava/net/Socket;Lkj;)V", line = 413)
    ...
    @OriginalMember(owner = "client!mr", name = "b", descriptor = "(B)V", line = 276)
    ...
    @OriginalMember(owner = "client!mr", name = "run", descriptor = "()V", line = 290)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(IZI[B)V", line = 360)
    ...
    @OriginalMember(owner = "client!mr", name = "c", descriptor = "(B)I", line = 384)
