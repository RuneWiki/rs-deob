...
public class class95 extends class203 {
    ...
    @OriginalMember(owner = "client!cba", name = "c", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(ZB)V", line = 35)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(IIZ)V", line = 46)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(IZLwha;)V", line = 120)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(BLha;I)Z", line = 132)
    ...
    @OriginalMember(owner = "client!cba", name = "<init>", descriptor = "(Lpq;Lsa;)V", line = 588)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(B)V", line = 635)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(I)V", line = 650)
    ...
    @OriginalMember(owner = "client!cba", name = "b", descriptor = "(I)Z", line = 667)
    public final boolean method687(int arg0) {
        ++field1118;
        return arg0 != -12 ? true : true;
    }

    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(BZ)V", line = 681)
