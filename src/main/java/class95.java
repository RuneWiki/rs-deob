...
public class class95 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Lha;Lpq;)V", line = 7)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IF)I", line = 83)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(F)F", line = 148)
    private static final float method710(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IIF)F", line = 153)
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(IIF)F", line = 165)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "()V", line = 170)
