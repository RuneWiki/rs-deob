...
public abstract class class95 extends class189 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ZBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IZI)V", line = 51)
    ...
    @OriginalMember(owner = "client!ls", name = "<init>", descriptor = "(Lws;I)V", line = 73)
    public class95(class241 arg0, int arg1) {
        this.field1866 = arg0;
        this.field1860 = arg1;
    }

    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(Z)V", line = 88)
