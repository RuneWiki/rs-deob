...
public class class95 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(IIIIBI)V", line = 40)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Lha;BI)Lkc;", line = 63)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(BI)V", line = 80)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(II)[I", line = 99)
    ...
    @OriginalMember(owner = "client!tn", name = "c", descriptor = "(I)[[I", line = 170)
    ...
    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "(III)V", line = 212)
