...
public class class95 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lvm;Ljf;)V", line = 11)
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(Lvm;Ljf;)Z", line = 95)
    public final boolean method516(class322 arg0, class95 arg1) {
        return this.field1109 != null || this.method523(arg0, arg1);
    }

    @OriginalMember(owner = "client!jf", name = "b", descriptor = "()V", line = 98)
    public static final void method517() {
        field1097 = null;
        field1104 = null;
    }

    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lvm;IIIIII)V", line = 114)
    ...
    @OriginalMember(owner = "client!jf", name = "c", descriptor = "()V", line = 140)
    public final void method519() {
        this.field1109 = null;
    }

    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lvm;)V", line = 146)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IIII)Z", line = 212)
    ...
    @OriginalMember(owner = "client!jf", name = "c", descriptor = "(Lvm;Ljf;)V", line = 268)
    ...
    @OriginalMember(owner = "client!jf", name = "d", descriptor = "(Lvm;Ljf;)Z", line = 358)
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(Lvm;)V", line = 393)
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 479)
