...
public class class95 extends class61 {
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "([B[I[IIIIIIIIIIILaa;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(CIIIZLaa;II)V", line = 95)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "([B[I[IIIIIII)V", line = 162)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V", line = 220)
    ...
    @OriginalMember(owner = "client!dba", name = "<init>", descriptor = "(Laha;Ljl;[Lhb;[I[I)V", line = 306)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "([B[IIIIIIII)V", line = 331)
    ...
    @OriginalMember(owner = "client!dba", name = "fa", descriptor = "(CIIIZ)V", line = 389)
