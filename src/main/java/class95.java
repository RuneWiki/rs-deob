...
public class class95 extends class165 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(ILmia;)V", line = 7)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Lrv;I)V", line = 35)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(II)Z", line = 48)
