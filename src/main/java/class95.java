...
public abstract class class95 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!ls", name = "destroy", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IIIIIILjava/lang/String;Z)V", line = 32)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(BLjava/lang/String;)V", line = 73)
    ...
    @OriginalMember(owner = "client!ls", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 127)
    public final void windowOpened(WindowEvent arg0) {
        field1339++;
    }

    @OriginalMember(owner = "client!ls", name = "run", descriptor = "()V", line = 137)
    ...
    @OriginalMember(owner = "client!ls", name = "providesignlink", descriptor = "(Lod;)V", line = 253)
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(B)V", line = 262)
    ...
    @OriginalMember(owner = "client!ls", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 310)
    public final void windowDeactivated(WindowEvent arg0) {
        field1349++;
    }

    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(I)V", line = 318)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(II)Z", line = 350)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(III[B)I", line = 364)
    ...
    @OriginalMember(owner = "client!ls", name = "c", descriptor = "(B)Z", line = 389)
    ...
    @OriginalMember(owner = "client!ls", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 428)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(BZ)V", line = 444)
    ...
    @OriginalMember(owner = "client!ls", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 527)
    public final void windowIconified(WindowEvent arg0) {
        field1352++;
    }

    @OriginalMember(owner = "client!ls", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 535)
    public final void windowActivated(WindowEvent arg0) {
        field1346++;
    }

    @OriginalMember(owner = "client!ls", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 542)
    public final void update(Graphics arg0) {
        field1342++;
        this.paint(arg0);
    }

    @OriginalMember(owner = "client!ls", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 552)
    ...
    @OriginalMember(owner = "client!ls", name = "stop", descriptor = "()V", line = 567)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IBI)B", line = 580)
    ...
    @OriginalMember(owner = "client!ls", name = "start", descriptor = "()V", line = 600)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 613)
    ...
    @OriginalMember(owner = "client!ls", name = "e", descriptor = "(B)V", line = 639)
    ...
    @OriginalMember(owner = "client!ls", name = "d", descriptor = "(I)V", line = 670)
    ...
    @OriginalMember(owner = "client!ls", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 717)
    public final void focusLost(FocusEvent arg0) {
        field1334++;
        class111.field1553 = false;
    }

    @OriginalMember(owner = "client!ls", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 733)
    public final void windowClosed(WindowEvent arg0) {
        field1341++;
    }

    @OriginalMember(owner = "client!ls", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 744)
    ...
    @OriginalMember(owner = "client!ls", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 763)
    ...
    @OriginalMember(owner = "client!ls", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 772)
    ...
    @OriginalMember(owner = "client!ls", name = "c", descriptor = "(Z)Ljava/lang/String;", line = 789)
    ...
    @OriginalMember(owner = "client!ls", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 803)
    public final void windowClosing(WindowEvent arg0) {
        this.destroy();
        field1347++;
    }

    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IIIII)V", line = 812)
    ...
    @OriginalMember(owner = "client!ls", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 860)
    ...
    @OriginalMember(owner = "client!ls", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 883)
