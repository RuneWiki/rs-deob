...
public class class95 extends class232 {
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(IB)[I", line = 5)
    ...
    @OriginalMember(owner = "client!eha", name = "<init>", descriptor = "()V", line = 54)
    public class95() {
        super(1, true);
    }

    @OriginalMember(owner = "client!eha", name = "d", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!eha", name = "e", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!eha", name = "c", descriptor = "(B)V", line = 92)
    ...
    @OriginalMember(owner = "client!eha", name = "c", descriptor = "(III)I", line = 103)
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(ILwq;I)V", line = 126)
    ...
    @OriginalMember(owner = "client!eha", name = "c", descriptor = "(II)[I", line = 154)
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(IZI)V", line = 178)
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(B)V", line = 207)
    ...
    @OriginalMember(owner = "client!eha", name = "b", descriptor = "(B)V", line = 229)
