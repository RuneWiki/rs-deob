...
public abstract class class95 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lgm;Lgm;[[II[[BII[[B[[BLnr;[[BZB)V", line = 3)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ILtn;IZ[ZIILtn;[IZILjp;)V", line = 288)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IIII[IIILkj;Lkj;ZI)V", line = 501)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IIILgm;III)V", line = 540)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lkj;ILkj;IILkj;IIIILkj;[ZZIB)V", line = 632)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IIIIILkj;ZLkj;I)V", line = 692)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Z)V", line = 725)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IILkj;)V", line = 738)
    ...
    @OriginalMember(owner = "client!qc", name = "e", descriptor = "(I)V", line = 780)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IIZ[IIIIII[I)V", line = 805)
