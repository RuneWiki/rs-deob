...
public class class22 extends class225 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IIIIIII)V", line = 13)
    ...
    @OriginalMember(owner = "client!vq", name = "e", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!vq", name = "f", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!vq", name = "<init>", descriptor = "([B)V", line = 71)
