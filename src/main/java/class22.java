...
public class class22 extends class481 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lsl;Ljava/lang/String;I)I")
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Ljava/lang/String;IILbi;)Ljq;")
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(Lij;IIZ)V")
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(Lij;II[III)V")
