...
public class class22 extends class646 {
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Len;IIIZ[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Len;IIIIIIZ)V", line = 24)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Len;IIII[I)V", line = 37)
    ...
    @OriginalMember(owner = "client!an", name = "c", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Len;IIIIZ[BI)V", line = 66)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(ZI)V", line = 89)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Len;IIIIIZ)V", line = 102)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Len;IIIII[BI)V", line = 127)
