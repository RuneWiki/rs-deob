...
public class class22 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(I)Llk;")
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IZ)Ldu;")
    ...
    @OriginalMember(owner = "client!af", name = "c", descriptor = "(I)[Lbc;")
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Lgf;IBLvh;I)V")
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Llo;ILnl;)V")
