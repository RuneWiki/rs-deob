...
public class class22 extends class324 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(II)V", line = 11)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(B)V", line = 30)
    public static void method135(byte arg0) {
        field235 = null;
        int var1 = 107 / ((arg0 - 82) / 36);
    }

    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(BI)V", line = 39)
    ...
    @OriginalMember(owner = "client!nc", name = "b", descriptor = "(BI)V", line = 48)
    ...
    @OriginalMember(owner = "client!nc", name = "c", descriptor = "(BI)V", line = 76)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(BLoa;)V", line = 91)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(ILjava/lang/String;)I", line = 106)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IIII)V", line = 140)
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Lpf;IIIII)V", line = 156)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IIIFI)V", line = 175)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "([III)V", line = 285)
