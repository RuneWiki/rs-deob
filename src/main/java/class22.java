...
@OriginalClass("client!HZQUFYDK")
public class class22 extends class28 {

    @OriginalMember(owner = "client!HZQUFYDK", name = "w", descriptor = "I")
    private int field796 = 49110;

    @OriginalMember(owner = "client!HZQUFYDK", name = "B", descriptor = "B")
    private byte field801 = 39;

    @OriginalMember(owner = "client!HZQUFYDK", name = "n", descriptor = "I")
    private int field787;

    @OriginalMember(owner = "client!HZQUFYDK", name = "o", descriptor = "I")
    private int field788;

    @OriginalMember(owner = "client!HZQUFYDK", name = "p", descriptor = "I")
    private int field789;

    @OriginalMember(owner = "client!HZQUFYDK", name = "x", descriptor = "I")
    private int field797;

    @OriginalMember(owner = "client!HZQUFYDK", name = "y", descriptor = "I")
    private int field798;

    @OriginalMember(owner = "client!HZQUFYDK", name = "z", descriptor = "I")
    private int field799;

    @OriginalMember(owner = "client!HZQUFYDK", name = "A", descriptor = "I")
    private int field800;

    @OriginalMember(owner = "client!HZQUFYDK", name = "q", descriptor = "LTLXFHCOO;")
    private class58 field790;

    @OriginalMember(owner = "client!HZQUFYDK", name = "s", descriptor = "I")
    private int field792;

    @OriginalMember(owner = "client!HZQUFYDK", name = "r", descriptor = "I")
    private int field791;

    @OriginalMember(owner = "client!HZQUFYDK", name = "t", descriptor = "I")
    public int field793;

    @OriginalMember(owner = "client!HZQUFYDK", name = "u", descriptor = "I")
    public int field794;

    @OriginalMember(owner = "client!HZQUFYDK", name = "C", descriptor = "[I")
    public int[] field802;

    @OriginalMember(owner = "client!HZQUFYDK", name = "v", descriptor = "Lclient;")
    public static client field795;

    @OriginalMember(owner = "client!HZQUFYDK", name = "b", descriptor = "(I)LPFIKHQJO;")
    ...
    @OriginalMember(owner = "client!HZQUFYDK", name = "<init>", descriptor = "(IIIIIIZIBI)V")
    ...
    @OriginalMember(owner = "client!HZQUFYDK", name = "a", descriptor = "(I)LNJPATAFL;")
