...
public class class22 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "([BI)V", line = 67)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(B[BII)V", line = 80)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ZJ)V", line = 271)
    ...
    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "(Lmea;II)V", line = 781)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(B)V", line = 293)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IIZ)I", line = 371)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(I)J", line = 406)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "([BBII)V", line = 427)
    ...
    @OriginalMember(owner = "client!ub", name = "c", descriptor = "(B)V", line = 550)
    ...
    @OriginalMember(owner = "client!ub", name = "c", descriptor = "(I)Ljava/io/File;", line = 568)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ZIII)I", line = 582)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "()V", line = 607)
