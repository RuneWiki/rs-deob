...
public class class22 {
    ...
    @OriginalMember(owner = "client!HQHBJEDA", name = "d", descriptor = "LYPJRJNAP;")
    ...
    @OriginalMember(owner = "client!HQHBJEDA", name = "b", descriptor = "[LHQHBJEDA;")
    ...
    @OriginalMember(owner = "client!HQHBJEDA", name = "a", descriptor = "(IB)LHQHBJEDA;")
