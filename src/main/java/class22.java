...
@OriginalClass("client!FMUEZRNA")
public class class22 {

    @OriginalMember(owner = "client!FMUEZRNA", name = "a", descriptor = "I")
    private int field850 = 1;

    @OriginalMember(owner = "client!FMUEZRNA", name = "b", descriptor = "Z")
    private boolean field851 = false;

    @OriginalMember(owner = "client!FMUEZRNA", name = "h", descriptor = "[LXPILULJC;")
    private class66[] field857 = new class66[10];

    @OriginalMember(owner = "client!FMUEZRNA", name = "c", descriptor = "Z")
    private static boolean field852 = true;

    @OriginalMember(owner = "client!FMUEZRNA", name = "d", descriptor = "[LFMUEZRNA;")
    private static class22[] field853 = new class22[5000];

    @OriginalMember(owner = "client!FMUEZRNA", name = "e", descriptor = "[I")
    public static int[] field854 = new int[5000];

    @OriginalMember(owner = "client!FMUEZRNA", name = "i", descriptor = "I")
    private int field858;

    @OriginalMember(owner = "client!FMUEZRNA", name = "j", descriptor = "I")
    private int field859;

    @OriginalMember(owner = "client!FMUEZRNA", name = "g", descriptor = "LINLHDAGO;")
    private static class29 field856;

    @OriginalMember(owner = "client!FMUEZRNA", name = "f", descriptor = "[B")
    private static byte[] field855;

    @OriginalMember(owner = "client!FMUEZRNA", name = "<init>", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!FMUEZRNA", name = "a", descriptor = "(LINLHDAGO;Z)V")
    ...
    @OriginalMember(owner = "client!FMUEZRNA", name = "a", descriptor = "(III)LINLHDAGO;")
    ...
    @OriginalMember(owner = "client!FMUEZRNA", name = "a", descriptor = "(ILINLHDAGO;)V")
    ...
    @OriginalMember(owner = "client!FMUEZRNA", name = "a", descriptor = "(Z)I")
    ...
    @OriginalMember(owner = "client!FMUEZRNA", name = "a", descriptor = "(IZ)LINLHDAGO;")
    ...
    @OriginalMember(owner = "client!FMUEZRNA", name = "a", descriptor = "(I)I")
