...
public class class22 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(II)Lel;")
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(ILjo;)V")
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Ljda;ILjo;)V")
