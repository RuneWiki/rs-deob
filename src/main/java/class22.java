...
public class class22 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(I)Lon;", line = 8)
    ...
    @OriginalMember(owner = "client!vq", name = "<init>", descriptor = "()V", line = 220)
    public class22() {
        this.field322.field497 = this.field322;
        this.field322.field498 = this.field322;
    }

    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Z)I", line = 33)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(BLon;)V", line = 82)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Lvq;I)V", line = 100)
    ...
    @OriginalMember(owner = "client!vq", name = "c", descriptor = "(I)Lon;", line = 120)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Lon;I)V", line = 137)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(B)Z", line = 154)
    ...
    @OriginalMember(owner = "client!vq", name = "d", descriptor = "(I)Lon;", line = 180)
    ...
    @OriginalMember(owner = "client!vq", name = "e", descriptor = "(I)V", line = 201)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(II)Ldj;", line = 229)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(B)Lon;", line = 296)
    ...
    @OriginalMember(owner = "client!vq", name = "c", descriptor = "(B)Lon;", line = 321)
    ...
    @OriginalMember(owner = "client!vq", name = "d", descriptor = "(B)V", line = 342)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(BLvq;Lon;)V", line = 355)
