...
@OriginalClass("client!JFYFSKVR")
public class class22 {

    @OriginalMember(owner = "client!JFYFSKVR", name = "a", descriptor = "I")
    private int field756 = -261;

    @OriginalMember(owner = "client!JFYFSKVR", name = "b", descriptor = "I")
    private int field757 = -548;

    @OriginalMember(owner = "client!JFYFSKVR", name = "c", descriptor = "Z")
    private boolean field758 = true;

    @OriginalMember(owner = "client!JFYFSKVR", name = "k", descriptor = "I")
    public int field766 = -1;

    @OriginalMember(owner = "client!JFYFSKVR", name = "m", descriptor = "Z")
    public boolean field768 = false;

    @OriginalMember(owner = "client!JFYFSKVR", name = "n", descriptor = "I")
    public int field769 = 5;

    @OriginalMember(owner = "client!JFYFSKVR", name = "o", descriptor = "I")
    public int field770 = -1;

    @OriginalMember(owner = "client!JFYFSKVR", name = "p", descriptor = "I")
    public int field771 = -1;

    @OriginalMember(owner = "client!JFYFSKVR", name = "q", descriptor = "I")
    public int field772 = 99;

    @OriginalMember(owner = "client!JFYFSKVR", name = "r", descriptor = "I")
    public int field773 = -1;

    @OriginalMember(owner = "client!JFYFSKVR", name = "s", descriptor = "I")
    public int field774 = -1;

    @OriginalMember(owner = "client!JFYFSKVR", name = "t", descriptor = "I")
    public int field775 = 2;

    @OriginalMember(owner = "client!JFYFSKVR", name = "d", descriptor = "I")
    private static int field759 = -11;

    @OriginalMember(owner = "client!JFYFSKVR", name = "e", descriptor = "I")
    public static int field760;

    @OriginalMember(owner = "client!JFYFSKVR", name = "g", descriptor = "I")
    public int field762;

    @OriginalMember(owner = "client!JFYFSKVR", name = "u", descriptor = "I")
    public int field776;

    @OriginalMember(owner = "client!JFYFSKVR", name = "v", descriptor = "I")
    public static int field777;

    @OriginalMember(owner = "client!JFYFSKVR", name = "h", descriptor = "[I")
    public int[] field763;

    @OriginalMember(owner = "client!JFYFSKVR", name = "i", descriptor = "[I")
    public int[] field764;

    @OriginalMember(owner = "client!JFYFSKVR", name = "j", descriptor = "[I")
    private int[] field765;

    @OriginalMember(owner = "client!JFYFSKVR", name = "l", descriptor = "[I")
    public int[] field767;

    @OriginalMember(owner = "client!JFYFSKVR", name = "f", descriptor = "[LJFYFSKVR;")
    public static class22[] field761;

    @OriginalMember(owner = "client!JFYFSKVR", name = "a", descriptor = "(LCXFTMSCH;B)V")
    ...
    @OriginalMember(owner = "client!JFYFSKVR", name = "a", descriptor = "(II)I")
    ...
    @OriginalMember(owner = "client!JFYFSKVR", name = "a", descriptor = "(LMQZHAILV;I)V")
    ...
    @OriginalMember(owner = "client!JFYFSKVR", name = "<init>", descriptor = "()V")
    public class22() {
