...
public class class22 implements Runnable {
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(ZI)Lvr;", line = 5)
    ...
    @OriginalMember(owner = "client!cv", name = "run", descriptor = "()V", line = 23)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Z)Z", line = 76)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(IIIIIII)V", line = 123)
