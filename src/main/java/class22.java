...
public class class22 implements class688 {
    ...
    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lut;I)Z", line = 23)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(B)J", line = 69)
