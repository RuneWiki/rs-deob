...
public class class22 extends class48 {
    ...
    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(II)V", line = 5)
    public final void method193(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!lg", name = "a", descriptor = "()V", line = 13)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Luj;II)V", line = 524)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lma;[I)V", line = 574)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IILfq;)Lfq;", line = 578)
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(Lnm;IIII[[I[[II)V", line = 602)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(III)V", line = 660)
    ...
    @OriginalMember(owner = "client!lg", name = "c", descriptor = "(II)I", line = 665)
    public final int method199(int arg0, int arg1) {
        return this.field267[arg0][arg1];
    }

    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(Lfq;IIIIZ)V", line = 672)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 685)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lfq;IIIIZ)Z", line = 766)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(III[[ZZ)V", line = 784)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(II)I", line = 911)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 930)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IIIIIII[[Z)V", line = 987)
    ...
    @OriginalMember(owner = "client!lg", name = "c", descriptor = "(Lfq;IIIIZ)V", line = 1149)
