...
public abstract class class22 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(III)I", line = 5)
    ...
    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IIIIIBI)V", line = 91)
