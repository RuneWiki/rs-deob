...
public class class22 extends class139 {
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Lej;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IIILdf;)V")
    ...
    @OriginalMember(owner = "client!an", name = "aa", descriptor = "(Lw;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!an", name = "c", descriptor = "(IILw;)Lw;")
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lw;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lpv;[I)V")
    ...
    @OriginalMember(owner = "client!an", name = "FA", descriptor = "(Lw;IIIIZ)V")
