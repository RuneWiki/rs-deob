...
public class class22 extends class514 {
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(Lgca;II[B)V", line = 9)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lmj;II)Ljava/lang/String;", line = 22)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(Lgca;II[I)V", line = 51)
