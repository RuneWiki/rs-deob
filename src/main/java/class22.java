...
@OriginalClass("client!GDVKBIIV")
public class class22 {

    @OriginalMember(owner = "client!GDVKBIIV", name = "a", descriptor = "I")
    private int field800 = 637;

    @OriginalMember(owner = "client!GDVKBIIV", name = "b", descriptor = "I")
    private int field801 = -489;

    @OriginalMember(owner = "client!GDVKBIIV", name = "c", descriptor = "B")
    private byte field802 = 5;

    @OriginalMember(owner = "client!GDVKBIIV", name = "d", descriptor = "B")
    private byte field803 = 5;

    @OriginalMember(owner = "client!GDVKBIIV", name = "e", descriptor = "Z")
    private boolean field804 = false;

    @OriginalMember(owner = "client!GDVKBIIV", name = "g", descriptor = "Z")
    private boolean field806 = true;

    @OriginalMember(owner = "client!GDVKBIIV", name = "h", descriptor = "Z")
    private boolean field807 = false;

    @OriginalMember(owner = "client!GDVKBIIV", name = "i", descriptor = "I")
    private int field808 = -131;

    @OriginalMember(owner = "client!GDVKBIIV", name = "j", descriptor = "I")
    public int field809 = 0;

    @OriginalMember(owner = "client!GDVKBIIV", name = "k", descriptor = "I")
    public int field810 = 0;

    @OriginalMember(owner = "client!GDVKBIIV", name = "l", descriptor = "I")
    public int field811;

    @OriginalMember(owner = "client!GDVKBIIV", name = "m", descriptor = "I")
    public int field812;

    @OriginalMember(owner = "client!GDVKBIIV", name = "n", descriptor = "[[I")
    public int[][] field813;

    @OriginalMember(owner = "client!GDVKBIIV", name = "f", descriptor = "I")
    private int field805;

    @OriginalMember(owner = "client!GDVKBIIV", name = "<init>", descriptor = "(IIB)V")
    ...
    @OriginalMember(owner = "client!GDVKBIIV", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!GDVKBIIV", name = "a", descriptor = "(ZIZIII)V")
    ...
    @OriginalMember(owner = "client!GDVKBIIV", name = "a", descriptor = "(IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!GDVKBIIV", name = "a", descriptor = "(IIB)V")
    ...
    @OriginalMember(owner = "client!GDVKBIIV", name = "a", descriptor = "(III)V")
    private void method219(int arg0, int arg1, int arg2) {
        this.field813[arg0][arg1] |= arg2;
    }

    @OriginalMember(owner = "client!GDVKBIIV", name = "a", descriptor = "(IIZIIZ)V")
    ...
    @OriginalMember(owner = "client!GDVKBIIV", name = "a", descriptor = "(IIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!GDVKBIIV", name = "a", descriptor = "(IIII)V")
    ...
    @OriginalMember(owner = "client!GDVKBIIV", name = "b", descriptor = "(IIB)V")
    ...
    @OriginalMember(owner = "client!GDVKBIIV", name = "a", descriptor = "(IIIIBII)Z")
    ...
    @OriginalMember(owner = "client!GDVKBIIV", name = "a", descriptor = "(IIIIIII)Z")
    ...
    @OriginalMember(owner = "client!GDVKBIIV", name = "a", descriptor = "(IIIIIBII)Z")
