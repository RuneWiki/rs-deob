...
public class class22 extends class210 implements class526 {
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Lr;Ljs;IIIIIZIIIIIIZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(B)I", line = 38)
    public final int method213(byte arg0) {
        ++field266;
        return arg0 <= 39 ? 35 : this.field261;
    }

    @OriginalMember(owner = "client!an", name = "a", descriptor = "(BLr;)V", line = 53)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lr;Z)V", line = 81)
    ...
    @OriginalMember(owner = "client!an", name = "f", descriptor = "(I)I", line = 97)
    ...
    @OriginalMember(owner = "client!an", name = "c", descriptor = "(Z)I", line = 108)
    ...
    @OriginalMember(owner = "client!an", name = "d", descriptor = "(I)I", line = 119)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(ILr;)Lcr;", line = 134)
    ...
    @OriginalMember(owner = "client!an", name = "e", descriptor = "(B)Z", line = 152)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(ILr;I)Lda;", line = 166)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IIILr;)Z", line = 187)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lr;I)V", line = 208)
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "(Z)Z", line = 237)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(I)V", line = 249)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Z)I", line = 263)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IB)V", line = 274)
    ...
    @OriginalMember(owner = "client!an", name = "g", descriptor = "(I)Z", line = 290)
    public final boolean method215(int arg0) {
        ++field248;
        return arg0 <= 49 ? false : this.field276;
    }

    @OriginalMember(owner = "client!an", name = "a", descriptor = "(ILac;)Lec;", line = 304)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(ZLr;II)Lfh;", line = 317)
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "(B)I", line = 347)
    ...
    @OriginalMember(owner = "client!an", name = "i", descriptor = "(I)V", line = 359)
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "(Lr;I)Lbca;", line = 374)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lvv;IIZLr;II)V", line = 405)
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "(I)Z", line = 436)
