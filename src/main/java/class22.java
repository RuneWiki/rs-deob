...
public class class22 {
    ...
    @OriginalMember(owner = "client!IRCSYKHE", name = "o", descriptor = "LOKKLRABS;")
    private class41 field878;

    @OriginalMember(owner = "client!IRCSYKHE", name = "b", descriptor = "LXJOITHUI;")
    private class65 field865;

    @OriginalMember(owner = "client!IRCSYKHE", name = "c", descriptor = "LXJOITHUI;")
    private class65 field866;

    @OriginalMember(owner = "client!IRCSYKHE", name = "d", descriptor = "LXJOITHUI;")
    private class65 field867;

    @OriginalMember(owner = "client!IRCSYKHE", name = "e", descriptor = "LXJOITHUI;")
    private class65 field868;

    @OriginalMember(owner = "client!IRCSYKHE", name = "f", descriptor = "LXJOITHUI;")
    private class65 field869;

    @OriginalMember(owner = "client!IRCSYKHE", name = "g", descriptor = "LXJOITHUI;")
    private class65 field870;

    @OriginalMember(owner = "client!IRCSYKHE", name = "h", descriptor = "LXJOITHUI;")
    private class65 field871;

    @OriginalMember(owner = "client!IRCSYKHE", name = "i", descriptor = "LXJOITHUI;")
    private class65 field872;

    @OriginalMember(owner = "client!IRCSYKHE", name = "p", descriptor = "LXJOITHUI;")
    ...
    @OriginalMember(owner = "client!IRCSYKHE", name = "a", descriptor = "(ILBJPWOXRJ;)V")
