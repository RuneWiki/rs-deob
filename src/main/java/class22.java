...
public class class22 {
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "()V", line = 134)
    public void method145() throws Exception {
        field406++;
    }

    @OriginalMember(owner = "client!cv", name = "b", descriptor = "()V", line = 141)
    public void method146() {
        field397++;
    }

    @OriginalMember(owner = "client!cv", name = "c", descriptor = "()V", line = 152)
    public void method147() throws Exception {
        field411++;
    }

    @OriginalMember(owner = "client!cv", name = "d", descriptor = "()I", line = 165)
    public int method148() throws Exception {
        field408++;
        return this.field424;
    }

    @OriginalMember(owner = "client!cv", name = "b", descriptor = "(I)V", line = 177)
    public void method149(int arg0) throws Exception {
        field396++;
    }

    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 186)
    public void method150(Component arg0) throws Exception {
        field416++;
    }

    @OriginalMember(owner = "client!cv", name = "c", descriptor = "(I)V", line = 196)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Lac;II)V", line = 221)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(BLac;)V", line = 246)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(II)V", line = 260)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "([II)V", line = 280)
    ...
    @OriginalMember(owner = "client!cv", name = "d", descriptor = "(I)V", line = 443)
