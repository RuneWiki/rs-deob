...
public class class22 {
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(BLcd;)Z", line = 4)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "()V", line = 95)
    public class22() {
        this.field216 = -50;
        this.field206 = 1.2F;
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Lofa;)V", line = 111)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(JJ)J", line = 36)
    public static long method120(long arg0, long arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(ILofa;)V", line = 44)
