...
public class class22 extends class259 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!cw", name = "c", descriptor = "(I)[Lkr;")
    ...
    @OriginalMember(owner = "client!cw", name = "b", descriptor = "(I)Lup;")
    ...
    @OriginalMember(owner = "client!cw", name = "d", descriptor = "(B)V")
