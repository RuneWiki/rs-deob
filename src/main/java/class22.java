...
public class class22 extends class331 implements class289 {
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(BLoa;)V")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IILoa;)Lba;")
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(ILoa;)V")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ILoa;)V")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lbo;ILoa;IIIZ)V")
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(Loa;Luca;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(BLoa;)Lvg;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Loa;B)Llt;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IIILoa;)Z")
