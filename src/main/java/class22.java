...
public class class22 {
    ...
    @OriginalMember(owner = "client!HIGYXWXY", name = "a", descriptor = "LOBKNBIRU;")
    public class40 field860 = new class40();

    @OriginalMember(owner = "client!HIGYXWXY", name = "b", descriptor = "LOBKNBIRU;")
    ...
    @OriginalMember(owner = "client!HIGYXWXY", name = "a", descriptor = "(LOBKNBIRU;)V")
    ...
    @OriginalMember(owner = "client!HIGYXWXY", name = "a", descriptor = "(Z)LOBKNBIRU;")
