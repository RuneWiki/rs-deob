...
public class class22 extends class377 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "([BI)Ljg;")
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IILji;)V")
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(ZLoa;)V")
    ...
    @OriginalMember(owner = "client!an", name = "f", descriptor = "(I)V")
