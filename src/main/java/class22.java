...
@OriginalClass("client!GTYZUNUD")
public class class22 {

    @OriginalMember(owner = "client!GTYZUNUD", name = "a", descriptor = "B")
    private byte field834 = -77;

    @OriginalMember(owner = "client!GTYZUNUD", name = "c", descriptor = "I")
    private int field836 = -44;

    @OriginalMember(owner = "client!GTYZUNUD", name = "i", descriptor = "[LCYFJILLF;")
    private class11[] field842 = new class11[10];

    @OriginalMember(owner = "client!GTYZUNUD", name = "b", descriptor = "Z")
    private static boolean field835 = true;

    @OriginalMember(owner = "client!GTYZUNUD", name = "e", descriptor = "[LGTYZUNUD;")
    private static class22[] field838 = new class22[5000];

    @OriginalMember(owner = "client!GTYZUNUD", name = "f", descriptor = "[I")
    public static int[] field839 = new int[5000];

    @OriginalMember(owner = "client!GTYZUNUD", name = "j", descriptor = "I")
    private int field843;

    @OriginalMember(owner = "client!GTYZUNUD", name = "k", descriptor = "I")
    private int field844;

    @OriginalMember(owner = "client!GTYZUNUD", name = "h", descriptor = "LEILHLJCE;")
    private static class17 field841;

    @OriginalMember(owner = "client!GTYZUNUD", name = "d", descriptor = "Z")
    private static boolean field837;

    @OriginalMember(owner = "client!GTYZUNUD", name = "g", descriptor = "[B")
    private static byte[] field840;

    @OriginalMember(owner = "client!GTYZUNUD", name = "<init>", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!GTYZUNUD", name = "a", descriptor = "(ILEILHLJCE;)V")
    ...
    @OriginalMember(owner = "client!GTYZUNUD", name = "a", descriptor = "(BII)LEILHLJCE;")
    ...
    @OriginalMember(owner = "client!GTYZUNUD", name = "a", descriptor = "(LEILHLJCE;B)V")
    ...
    @OriginalMember(owner = "client!GTYZUNUD", name = "a", descriptor = "(I)I")
    ...
    @OriginalMember(owner = "client!GTYZUNUD", name = "a", descriptor = "(II)LEILHLJCE;")
    ...
    @OriginalMember(owner = "client!GTYZUNUD", name = "b", descriptor = "(I)I")
