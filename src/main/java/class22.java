...
public class class22 extends class344 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "()V", line = 7)
    public final void method28() {
    }

    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(Lse;II[BI)V", line = 9)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IZ)V", line = 26)
