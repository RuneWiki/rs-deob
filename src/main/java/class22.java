...
public class class22 extends class436 {
    ...
    @OriginalMember(owner = "client!rk", name = "f", descriptor = "(I)V", line = 4)
    public static void method146(int arg0) {
        field289 = null;
        int var1 = -54 / ((20 - arg0) / 42);
    }

    @OriginalMember(owner = "client!rk", name = "d", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!rk", name = "c", descriptor = "(II)Lde;", line = 25)
    ...
    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "()V", line = 651)
    public class22() {
        super(0, true);
    }

    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IILeb;)V", line = 55)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(II)[I", line = 167)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IIIILjava/util/Random;I[[I)V", line = 423)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IZ)V", line = 632)
