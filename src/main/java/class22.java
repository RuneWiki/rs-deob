...
public class class22 extends class425 {
    ...
    @OriginalMember(owner = "client!ub", name = "c", descriptor = "(Lha;B)Lpia;")
    ...
    @OriginalMember(owner = "client!ub", name = "d", descriptor = "(Lha;B)Lln;")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(III[IIZIIILeq;II[III)I")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ILha;II)Z")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ILha;I)Z")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ILfq;BIILha;Z)V")
    ...
    @OriginalMember(owner = "client!ub", name = "e", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(BLoaa;)V")
