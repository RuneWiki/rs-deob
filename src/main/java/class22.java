...
public class class22 {
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Ltl;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ov", name = "b", descriptor = "(Ltl;)V", line = 10)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "()V", line = 25)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(I)I", line = 33)
    ...
    @OriginalMember(owner = "client!ov", name = "<init>", descriptor = "()V", line = 56)
    public class22() {
        this.field341[0] = 0;
