...
public class class22 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IIIIII)V", line = 62)
    ...
    @OriginalMember(owner = "client!qo", name = "toString", descriptor = "()Ljava/lang/String;", line = 156)
    public final String toString() {
        field199++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(I)V", line = 170)
