...
@OriginalClass("client!GPPDQFCV")
public class class22 extends class61 {

    @OriginalMember(owner = "client!GPPDQFCV", name = "sb", descriptor = "I")
    private int field954 = 1;

    @OriginalMember(owner = "client!GPPDQFCV", name = "Bb", descriptor = "I")
    private int field963 = -130;

    @OriginalMember(owner = "client!GPPDQFCV", name = "Cb", descriptor = "Z")
    public boolean field964 = false;

    @OriginalMember(owner = "client!GPPDQFCV", name = "Ib", descriptor = "Z")
    public boolean field970 = false;

    @OriginalMember(owner = "client!GPPDQFCV", name = "Jb", descriptor = "J")
    public long field971 = -1L;

    @OriginalMember(owner = "client!GPPDQFCV", name = "Mb", descriptor = "[I")
    public int[] field974 = new int[5];

    @OriginalMember(owner = "client!GPPDQFCV", name = "Nb", descriptor = "[I")
    public int[] field975 = new int[12];

    @OriginalMember(owner = "client!GPPDQFCV", name = "Kb", descriptor = "LASORKPAH;")
    public static class2 field972 = new class2(48975, 260);

    @OriginalMember(owner = "client!GPPDQFCV", name = "qb", descriptor = "I")
    public int field952;

    @OriginalMember(owner = "client!GPPDQFCV", name = "ub", descriptor = "I")
    public int field956;

    @OriginalMember(owner = "client!GPPDQFCV", name = "vb", descriptor = "I")
    public int field957;

    @OriginalMember(owner = "client!GPPDQFCV", name = "wb", descriptor = "I")
    public int field958;

    @OriginalMember(owner = "client!GPPDQFCV", name = "xb", descriptor = "I")
    public int field959;

    @OriginalMember(owner = "client!GPPDQFCV", name = "yb", descriptor = "I")
    public int field960;

    @OriginalMember(owner = "client!GPPDQFCV", name = "zb", descriptor = "I")
    public int field961;

    @OriginalMember(owner = "client!GPPDQFCV", name = "Ab", descriptor = "I")
    public int field962;

    @OriginalMember(owner = "client!GPPDQFCV", name = "Db", descriptor = "I")
    public int field965;

    @OriginalMember(owner = "client!GPPDQFCV", name = "Eb", descriptor = "I")
    public int field966;

    @OriginalMember(owner = "client!GPPDQFCV", name = "Fb", descriptor = "I")
    public int field967;

    @OriginalMember(owner = "client!GPPDQFCV", name = "Gb", descriptor = "I")
    public int field968;

    @OriginalMember(owner = "client!GPPDQFCV", name = "Ob", descriptor = "I")
    public int field976;

    @OriginalMember(owner = "client!GPPDQFCV", name = "Pb", descriptor = "I")
    public int field977;

    @OriginalMember(owner = "client!GPPDQFCV", name = "Qb", descriptor = "I")
    public int field978;

    @OriginalMember(owner = "client!GPPDQFCV", name = "tb", descriptor = "J")
    public long field955;

    @OriginalMember(owner = "client!GPPDQFCV", name = "Hb", descriptor = "LGFYXEFQY;")
    public class21 field969;

    @OriginalMember(owner = "client!GPPDQFCV", name = "rb", descriptor = "LBXXPAJNW;")
    public class4 field953;

    @OriginalMember(owner = "client!GPPDQFCV", name = "Lb", descriptor = "Ljava/lang/String;")
    public String field973;

    @OriginalMember(owner = "client!GPPDQFCV", name = "a", descriptor = "(B)LGFYXEFQY;")
    ...
    @OriginalMember(owner = "client!GPPDQFCV", name = "a", descriptor = "(I)LGFYXEFQY;")
    ...
    @OriginalMember(owner = "client!GPPDQFCV", name = "a", descriptor = "(LCKBTFRZM;I)V")
    ...
    @OriginalMember(owner = "client!GPPDQFCV", name = "b", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!GPPDQFCV", name = "d", descriptor = "(I)LGFYXEFQY;")
