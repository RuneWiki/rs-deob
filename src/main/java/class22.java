...
public class class22 extends class324 {
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 10)
    public class22(String arg0, int arg1) {
        this.field396 = arg0;
        this.field397 = (short) arg1;
    }

    @OriginalMember(owner = "client!an", name = "a", descriptor = "(III)Ljg;", line = 25)
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IIIILkk;I)Ljava/awt/Frame;", line = 53)
