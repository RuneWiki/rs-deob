...
public class class22 extends class10 {
    ...
    @OriginalMember(owner = "client!IWSGBTLV", name = "m", descriptor = "Z")
    public static boolean field946;

    @OriginalMember(owner = "client!IWSGBTLV", name = "k", descriptor = "[LRXUUDUNX;")
    ...
    @OriginalMember(owner = "client!IWSGBTLV", name = "a", descriptor = "(I)LCADBNSXE;")
