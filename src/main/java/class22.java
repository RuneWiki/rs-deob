...
public class class22 extends class276 {
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ov", name = "b", descriptor = "(II)Lec;", line = 14)
    ...
    @OriginalMember(owner = "client!ov", name = "<init>", descriptor = "()V", line = 46)
    public class22() {
    }

    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(FIZFF)F", line = 50)
    ...
    @OriginalMember(owner = "client!ov", name = "<init>", descriptor = "(I)V", line = 62)
