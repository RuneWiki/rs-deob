...
public class class22 extends class287 implements class536 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(III)Let;")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(II)Lat;")
    ...
    @OriginalMember(owner = "client!rc", name = "<init>", descriptor = "(Lpg;III)V")
    ...
    @OriginalMember(owner = "client!rc", name = "<init>", descriptor = "(Lpg;IIII)V")
