...
public class class22 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IILga;I)V", line = 17)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(B)V", line = 114)
