...
public class class22 extends class296 {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(III)V", line = 9)
    ...
    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(IIIIIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(IBI)V", line = 42)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(BII)V", line = 62)
