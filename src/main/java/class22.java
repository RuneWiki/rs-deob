...
public class class22 extends class314 implements class41 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Z)I", line = 6)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IILya;)Lt;", line = 17)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(ZLya;)Llo;", line = 40)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(I)Z", line = 80)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lih;B)V", line = 91)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(ILya;)V", line = 134)
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(ILya;)V", line = 145)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(ILya;II)Z", line = 160)
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(I)I", line = 181)
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Lya;Lho;IIIIIZIII)V", line = 193)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IBI)Z", line = 206)
    ...
    @OriginalMember(owner = "client!ir", name = "c", descriptor = "(I)I", line = 217)
    ...
    @OriginalMember(owner = "client!ir", name = "f", descriptor = "(I)V", line = 229)
    ...
    @OriginalMember(owner = "client!ir", name = "d", descriptor = "(I)V", line = 254)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lya;I)V", line = 264)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lgg;IZIIILya;)V", line = 286)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(B)Z", line = 296)
