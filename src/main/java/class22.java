...
public class class22 extends class320 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 18)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IIZIIII)V", line = 80)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IBI)Z", line = 245)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(BS)V", line = 257)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "([[ZIIII)V", line = 295)
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Lvj;Lsi;Lfk;[I)V", line = 359)
