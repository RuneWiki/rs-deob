...
public class class22 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lha;[II[I[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "()V", line = 8)
    private static final void method137() {
        field321 = 0;
    }

    @OriginalMember(owner = "client!qo", name = "b", descriptor = "()V", line = 12)
    public static void method138() {
        field324 = null;
    }

    @OriginalMember(owner = "client!qo", name = "a", descriptor = "([III)V", line = 22)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lha;[II)V", line = 71)
    public static final void method140(class58 arg0, int[] arg1, int arg2) {
        method141(arg0, arg1, 0, arg1.length, arg2, null, null);
    }

    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lha;[IIII[I[I)V", line = 79)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(I)Z", line = 116)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(II)V", line = 193)
    ...
    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(II)V", line = 238)
    ...
    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(I)V", line = 275)
