...
public class class22 extends class225 {
    ...
    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "(Lig;IIIZ[I)V")
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IILig;III)Lrk;")
    ...
    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "(Lig;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "(Lig;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ZZILig;I[I)Lrk;")
    ...
    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "(Lig;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(Lig;BI[BIIIZ)Lrk;")
    ...
    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "(Lig;IIII[I)V")
    ...
    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "(Lig;IIIIIIZ)V")
