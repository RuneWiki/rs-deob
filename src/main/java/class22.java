...
public class class22 extends class184 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ILd;IILjava/awt/Canvas;)Lha;", line = 5)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lsca;II)Ljava/lang/String;", line = 17)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IIIIIIII)V", line = 40)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "()V", line = 247)
    public class22() {
    }

    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IIBIIIII)V", line = 251)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(B)V", line = 275)
    public static void method117(byte arg0) {
        int var1 = -63 / ((arg0 - 63) / 60);
        field235 = null;
    }

    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(BII)V", line = 284)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IB)V", line = 313)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(J)V", line = 324)
    public class22(long arg0) {
        this.field228 = arg0;
    }

    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IIB)I", line = 332)
