...
public class class22 extends class452 {
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IZ)Z", line = 17)
    public final boolean method165(int arg0, boolean arg1) {
        field270++;
        return arg1 ? this.field263[arg0].field3793 : false;
    }

    @OriginalMember(owner = "client!ir", name = "c", descriptor = "(II)Z", line = 29)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(B)Z", line = 40)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(ILga;Lya;)V", line = 137)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(I)V", line = 370)
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(I)V", line = 387)
