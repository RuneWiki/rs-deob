...
public class class22 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(FIIIIIIII[F)V", line = 15)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IIII[IIIIZIIILuh;[II)I", line = 71)
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(I)V", line = 252)
