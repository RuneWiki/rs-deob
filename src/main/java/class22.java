...
public class class22 extends class417 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IILks;ILgba;)V")
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lus;B)I")
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(BLgba;)V")
