...
public class class22 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ILjagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V")
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V")
