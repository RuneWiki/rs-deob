...
public class class22 extends class21 {
    ...
    @OriginalMember(owner = "client!FSCCBLKX", name = "o", descriptor = "LXKEHWKFH;")
    ...
    @OriginalMember(owner = "client!FSCCBLKX", name = "z", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!FSCCBLKX", name = "a", descriptor = "(B)LUSIJLMTP;")
    ...
    @OriginalMember(owner = "client!FSCCBLKX", name = "a", descriptor = "(I)LHEQROJXW;")
