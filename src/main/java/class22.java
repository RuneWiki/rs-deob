...
public class class22 extends class333 {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(BI)V", line = 18)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(IIIIII[B[BI)V", line = 40)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "([BZ)Ljava/lang/String;", line = 84)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(IILwl;Lkca;Lr;I)Z", line = 96)
    ...
    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "()V", line = 319)
    public class22() {
    }

    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(I)V", line = 321)
