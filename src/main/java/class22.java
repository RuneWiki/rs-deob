...
public class class22 extends class17 implements class29 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(ILos;II[BIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Lbea;Los;IIZ[FII)V", line = 20)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Ljava/io/File;I)[B", line = 39)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(ZZB)V", line = 50)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IF)F", line = 68)
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "(I)Z", line = 79)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Lbea;Los;Lmg;II)V", line = 91)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(BILos;I[FIIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!an", name = "i", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Lbea;IIZ[III)V", line = 131)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Lbea;Los;IIZ[BII)V", line = 156)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(I)I", line = 178)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(III)Z", line = 189)
    ...
    @OriginalMember(owner = "client!an", name = "c", descriptor = "(I)I", line = 200)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(II[IIIIII)V", line = 211)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(FB)F", line = 225)
