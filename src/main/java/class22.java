...
public class class22 extends class475 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(BI)V", line = 4)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(II)V", line = 18)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(II)Lum;", line = 34)
