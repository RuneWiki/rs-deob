...
public class class22 extends class220 {
    ...
    @OriginalMember(owner = "client!vq", name = "d", descriptor = "(II)Lwp;")
    ...
    @OriginalMember(owner = "client!vq", name = "f", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IBLil;)V")
