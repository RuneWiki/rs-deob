...
public class class22 extends class96 {
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(BLza;)Luc;")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IIIZILot;Lza;)V")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(ZLdh;)V")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(ILza;BI)Z")
    ...
    @OriginalMember(owner = "client!ir", name = "c", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lza;II)Z")
