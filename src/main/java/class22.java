...
public class class22 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(B)Lgk;", line = 6)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(Ldq;)V", line = 70)
    public class22(class90 arg0) {
        this.field308 = arg0;
    }

    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(I)Lgk;", line = 81)
