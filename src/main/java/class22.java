...
public class class22 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(I)V", line = 8)
    public static void method241(int arg0) {
        field352 = null;
        int var1 = 92 / ((54 - arg0) / 48);
    }

    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "(ILjava/lang/String;ILjava/lang/String;J)V", line = 27)
