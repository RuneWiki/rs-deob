...
public class class22 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IIIIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(I)I", line = 80)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Z)V", line = 94)
    ...
    @OriginalMember(owner = "client!vq", name = "c", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(II)V", line = 120)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Lti;BI)Lha;", line = 134)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IIBI)Z", line = 157)
