...
public class class22 extends class79 {
    ...
    @OriginalMember(owner = "client!ir", name = "c", descriptor = "(B)Z", line = 4)
    public final boolean method141(byte arg0) {
        field229++;
        return arg0 == 55 ? false : false;
    }

    @OriginalMember(owner = "client!ir", name = "d", descriptor = "(B)Ljava/lang/Object;", line = 15)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lsq;)V", line = 27)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Z)V", line = 83)
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 96)
