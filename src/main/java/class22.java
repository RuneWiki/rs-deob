...
public class class22 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(B)Lvda;", line = 4)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lvda;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(I)Lvda;", line = 58)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(BLvda;)V", line = 79)
    ...
    @OriginalMember(owner = "client!an", name = "c", descriptor = "(B)Lvda;", line = 99)
    ...
    @OriginalMember(owner = "client!an", name = "d", descriptor = "(B)I", line = 117)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "()V", line = 185)
    public class22() {
        this.field546.field2002 = this.field546;
        this.field546.field2003 = this.field546;
    }

    @OriginalMember(owner = "client!an", name = "b", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!an", name = "e", descriptor = "(B)Lvda;", line = 158)
    ...
    @OriginalMember(owner = "client!an", name = "c", descriptor = "(I)V", line = 195)
