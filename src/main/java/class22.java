...
public class class22 extends class605 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(III)I", line = 70)
    ...
    @OriginalMember(owner = "client!ub", name = "c", descriptor = "(Z)V", line = 87)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(IIII)[B", line = 97)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(BIB)V", line = 115)
