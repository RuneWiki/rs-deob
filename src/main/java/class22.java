...
public class class22 extends class521 {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Lqa;J)V", line = 16)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Lrba;IIIIIIIIIIIZZ)V", line = 215)
    ...
    @OriginalMember(owner = "client!fo", name = "b", descriptor = "()V", line = 234)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(JI)V", line = 242)
    ...
    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(Lrba;IIIIIIIIIIIZZ)V", line = 636)
