...
public class class523 extends class299 {
    ...
    @OriginalMember(owner = "client!mi", name = "<init>", descriptor = "(Les;)V", line = 3)
    public class523(class404 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(I[BB)I", line = 8)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(IZ)V", line = 19)
    ...
    @OriginalMember(owner = "client!mi", name = "d", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(Z)I", line = 43)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(ILjava/net/Socket;I)Lcca;", line = 55)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(I)I", line = 66)
    ...
    @OriginalMember(owner = "client!mi", name = "c", descriptor = "(I)Z", line = 78)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!mi", name = "<init>", descriptor = "(ILes;)V", line = 123)
    public class523(int arg0, class404 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(II)I", line = 134)
