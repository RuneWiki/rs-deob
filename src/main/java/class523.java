...
public class class523 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "([BIZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Z)V", line = 140)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(II)Lcw;", line = 152)
    ...
    @OriginalMember(owner = "client!pu", name = "c", descriptor = "(I)V", line = 201)
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(Llj;Lfa;)V", line = 334)
    public class523(class565 arg0, class212 arg1) {
        this.field7098 = arg1;
        this.field7105 = arg0;
    }

    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(ZILjava/lang/String;Ljava/lang/String;ZZI)V", line = 223)
