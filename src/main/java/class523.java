...
public class class523 extends class459 implements MouseWheelListener {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 5)
    public final void method2662(int arg0, Component arg1) {
        int var3 = 89 / ((46 - arg0) / 37);
        arg1.removeMouseWheelListener(this);
    }

    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(BLjava/awt/Component;)V", line = 13)
    ...
    @OriginalMember(owner = "client!nd", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 23)
    public final synchronized void mouseWheelMoved(MouseWheelEvent arg0) {
        this.field7690 += arg0.getWheelRotation();
    }

    @OriginalMember(owner = "client!nd", name = "b", descriptor = "(I)I", line = 35)
