...
public class class523 extends class354 {
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!cc", name = "c", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lnj;II)V", line = 88)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(II)Z", line = 179)
    ...
    @OriginalMember(owner = "client!cc", name = "d", descriptor = "(B)V", line = 189)
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "()V", line = 204)
    public class523() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cc", name = "g", descriptor = "(I)V", line = 222)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(BI)[I", line = 249)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lkw;IIIII)V", line = 353)
