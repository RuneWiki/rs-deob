...
public class class523 extends class217 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(BLjava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!lj", name = "c", descriptor = "(B)Z", line = 54)
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(B)I", line = 68)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(I)[B", line = 85)
    ...
    @OriginalMember(owner = "client!lj", name = "d", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!lj", name = "g", descriptor = "(I)V", line = 157)
