...
public class class523 extends class691 implements class422 {
    ...
    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(Lnv;Ldw;Z)V")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Luea;I)[I")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Z)Ldw;")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(ILkq;IIZ)V")
