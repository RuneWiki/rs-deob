...
public class class523 {
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(I)[Lrb;", line = 7)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(II)Lbi;", line = 34)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(ZIZ)I", line = 64)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(BI)Z", line = 102)
    ...
    @OriginalMember(owner = "client!mv", name = "b", descriptor = "(I)Z", line = 160)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(IILsv;)V", line = 174)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(IZBLza;)Lo;", line = 203)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Lsv;B)V", line = 253)
