...
public class class523 extends class173 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(ILjava/lang/String;Z)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IZLmc;)V", line = 39)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(ZLmc;)V", line = 92)
    ...
    @OriginalMember(owner = "client!va", name = "b", descriptor = "(III)I", line = 115)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(I[Ljava/lang/String;)[Ljava/lang/String;", line = 133)
