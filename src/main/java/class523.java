...
public class class523 extends class359 implements class21 {
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(Lod;I[BIZ)V", line = 4)
    public class523(class349 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field7747 = arg1;
    }

    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "([BIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(I)I", line = 38)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Z)J", line = 49)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lic;B)V", line = 61)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(Lod;ILjaggl/memory/NativeBuffer;IZ)V", line = 91)
    public class523(class349 arg0, int arg1, NativeBuffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field7747 = arg1;
    }

    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(B)I", line = 107)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(Z)V", line = 125)
