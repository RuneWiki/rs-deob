...
public class class523 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Lgp;I)V", line = 22)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(I[B)V", line = 45)
    ...
    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "([BI[B)V", line = 244)
