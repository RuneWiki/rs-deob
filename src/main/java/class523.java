...
public class class523 extends class257 implements class52 {
    ...
    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(Ll;Lm;II)V", line = 26)
    public class523(class261 arg0, class496 arg1, int arg2, int arg3) {
        this.method3082(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(Ll;Lm;[IIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!va", name = "finalize", descriptor = "()V", line = 34)
    ...
    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(Ll;Lm;IIII)V", line = 41)
