...
public class class523 extends class24 {
    ...
    @OriginalMember(owner = "client!fl", name = "ya", descriptor = "(IIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!fl", name = "la", descriptor = "(IIIIIII)V", line = 108)
    ...
    @OriginalMember(owner = "client!fl", name = "b", descriptor = "(II)V", line = 245)
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "(Lda;IIII)V", line = 789)
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "(Lda;II[III)V", line = 799)
    ...
    @OriginalMember(owner = "client!fl", name = "XA", descriptor = "(IIIIII)V", line = 293)
    ...
    @OriginalMember(owner = "client!fl", name = "W", descriptor = "(IIIII)V", line = 303)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IILta;II)V", line = 354)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Lza;Lvs;III)V", line = 413)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(I)V", line = 467)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Z)V", line = 479)
    ...
    @OriginalMember(owner = "client!fl", name = "H", descriptor = "(FFFFFFIII)V", line = 498)
    ...
    @OriginalMember(owner = "client!fl", name = "RA", descriptor = "()I", line = 570)
    public final int method147() {
        field7585++;
        return this.field7591.field1365 + this.field7608 + this.field7604;
    }

    @OriginalMember(owner = "client!fl", name = "YA", descriptor = "()I", line = 579)
    public final int method157() {
        field7589++;
        return this.field7591.field1365;
    }

    @OriginalMember(owner = "client!fl", name = "Q", descriptor = "()I", line = 587)
    public final int method165() {
        field7590++;
        return this.field7591.field1368 + this.field7605 + this.field7596;
    }

    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Li;III[Z)V", line = 597)
    ...
    @OriginalMember(owner = "client!fl", name = "b", descriptor = "(I)V", line = 624)
    ...
    @OriginalMember(owner = "client!fl", name = "ha", descriptor = "(IIII)V", line = 643)
    ...
    @OriginalMember(owner = "client!fl", name = "ZA", descriptor = "()I", line = 655)
    public final int method154() {
        field7607++;
        return this.field7591.field1368;
    }

    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(FFFFFFLta;II)V", line = 680)
    ...
    @OriginalMember(owner = "client!fl", name = "oa", descriptor = "(III)V", line = 767)
