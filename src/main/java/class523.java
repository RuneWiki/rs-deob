...
public class class523 extends class695 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Ljava/awt/Canvas;III)Lid;", line = 8)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(IIII)[B", line = 32)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ILud;)Lada;", line = 49)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(II)V", line = 72)
    ...
    @OriginalMember(owner = "client!lh", name = "d", descriptor = "(I)I", line = 86)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIB)V", line = 97)
    ...
    @OriginalMember(owner = "client!lh", name = "e", descriptor = "(I)V", line = 114)
