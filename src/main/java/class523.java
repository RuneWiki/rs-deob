...
public class class523 extends class692 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ILfga;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "(Llea;Lan;)V", line = 20)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ZI)V", line = 59)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(BI)V", line = 77)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!jc", name = "c", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(I)Z", line = 126)
    public final boolean method1112(int arg0) {
        ++field7323;
        return arg0 < -124;
    }

    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(IZI)V", line = 144)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ZB)V", line = 201)
