...
public class class523 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IILni;II)V", line = 11)
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "(I)V", line = 440)
    public class523(int arg0) {
        this.field7109 = arg0;
    }

    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "(IIIIII)V", line = 447)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IIIIIIII)V", line = 181)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(B)V", line = 391)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(ILff;)V", line = 405)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Z)Lff;", line = 420)
