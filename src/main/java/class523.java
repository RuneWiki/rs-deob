...
public class class523 extends class17 {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(BLhm;IZI)V", line = 11)
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "()V", line = 91)
    public class523() {
        super(1, false);
    }

    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IIII)V", line = 95)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(BLjava/lang/Throwable;)Ljava/lang/String;", line = 204)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IB)[[I", line = 277)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IIIILhr;)V", line = 352)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(IIII)V", line = 396)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lwm;II)V", line = 454)
