...
public abstract class class523 extends class267 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(ILwg;)Z", line = 25)
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(I)V", line = 43)
