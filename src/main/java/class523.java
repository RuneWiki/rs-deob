...
public class class523 extends class439 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IILqg;Ljava/lang/String;)Lwe;", line = 18)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IB)V", line = 58)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IFIII)V", line = 77)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(II)V", line = 187)
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(B)V", line = 209)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IIIZ)V", line = 222)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(II[I)V", line = 239)
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(Lpp;IIIII)V", line = 367)
