...
public class class523 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Lie;IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Z)V", line = 49)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(II[BIIII[BI)V", line = 63)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(ZZ)V", line = 108)
