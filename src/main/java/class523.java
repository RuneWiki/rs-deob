...
public class class523 extends InputStream {
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(Lgg;Z[[[BIB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(Z)V", line = 71)
    ...
    @OriginalMember(owner = "client!baa", name = "read", descriptor = "()I", line = 89)
