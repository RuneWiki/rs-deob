...
public class class523 implements class298 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Ljava/lang/Class;ILjava/lang/Object;Ljava/lang/String;)Z", line = 8)
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!pu", name = "e", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!pu", name = "c", descriptor = "(I)I", line = 50)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(I)I", line = 63)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;B)Ljava/lang/Object;", line = 77)
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(Ljava/lang/Class;ILjava/lang/Object;Ljava/lang/String;)I", line = 96)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(ZZ)V", line = 113)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(II)I", line = 304)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IJ)Z", line = 328)
    public final boolean method2065(int arg0, long arg1) {
        field7583++;
        return arg0 == 26711 ? true : true;
    }

    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IB)I", line = 341)
    ...
    @OriginalMember(owner = "client!pu", name = "d", descriptor = "(I)V", line = 364)
    public final void method2068(int arg0) {
        field7612++;
        class532.method3220(arg0 ^ arg0);
    }

    @OriginalMember(owner = "client!pu", name = "f", descriptor = "(I)V", line = 376)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(B)V", line = 388)
