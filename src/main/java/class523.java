...
public class class523 extends class278 {
    ...
    @OriginalMember(owner = "client!um", name = "wa", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!um", name = "CA", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!um", name = "fa", descriptor = "(IILr;)Lr;")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IIILru;)V")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Lada;[I)V")
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Lln;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Lr;IIIIZ)Z")
