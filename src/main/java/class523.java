...
public class class523 extends class249 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Lme;ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "(Lwh;)V", line = 16)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(I)Z", line = 128)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IILha;Lnn;)V", line = 142)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(III)V", line = 469)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IZ)V", line = 494)
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(I)V", line = 529)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(B)V", line = 558)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(ZZ)V", line = 570)
    ...
    @OriginalMember(owner = "client!ni", name = "d", descriptor = "(I)V", line = 591)
