...
public class class523 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(BILue;Ljava/lang/Object;)V", line = 21)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Z)I", line = 52)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(FFBF)F", line = 64)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lue;I)Ljava/lang/Object;", line = 75)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IB)V", line = 127)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(BLwm;)V", line = 176)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(B)V", line = 195)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(Lue;I)V", line = 205)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(Z)I", line = 239)
    public final int method3122(boolean arg0) {
        field7752++;
        return arg0 ? this.field7754 : 79;
    }

    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lue;BLjava/lang/Object;)V", line = 253)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(B)V", line = 267)
    ...
    @OriginalMember(owner = "client!pn", name = "c", descriptor = "(Z)V", line = 295)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(I)V", line = 310)
