...
public class class523 extends class35 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIIIBIIIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "(I)V", line = 130)
