...
public class class523 {
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(ILji;)V")
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(Lpfa;B)V")
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(ILji;I)V")
