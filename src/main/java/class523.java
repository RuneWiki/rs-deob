...
public abstract class class523 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(III)Z", line = 59)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lqa;I)V", line = 71)
