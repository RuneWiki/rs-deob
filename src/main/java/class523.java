...
public class class523 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Lqs;I)Lwh;")
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Lqs;II)[Lwh;")
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(Lqs;I)[Lwh;")
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(Lqs;II)Lwh;")
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "([B)[Lwh;")
