...
public class class523 extends class611 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Lr;Z)V")
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Lr;B)Llt;")
    ...
    @OriginalMember(owner = "client!k", name = "b", descriptor = "(BLr;)Lsr;")
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Lr;III)Z")
