...
public class class523 extends class486 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(I)Llm;", line = 6)
    ...
    @OriginalMember(owner = "client!eu", name = "c", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(Lgk;IIIIII)V", line = 96)
