...
public class class523 extends class29 {
    ...
    @OriginalMember(owner = "client!no", name = "b", descriptor = "(Lr;I)Lcu;")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(BLr;)Lqw;")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ILda;Lr;Lq;)V")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ILir;ZILr;IB)V")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ZLr;II)Z")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lr;IIZ)Lda;")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lr;Z)V")
