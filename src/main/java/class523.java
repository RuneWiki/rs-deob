...
public class class523 extends class216 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "([B[IIIIIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!tu", name = "fa", descriptor = "(CIIIZ)V", line = 43)
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "(Led;Lcd;[Lcu;[I[I)V", line = 99)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V", line = 139)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(CIIIZLaa;II)V", line = 233)
