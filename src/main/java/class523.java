...
public class class523 extends class612 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Lra;Lfc;IIIZLet;Lpa;Ljava/lang/String;III)V", line = 6)
    ...
    @OriginalMember(owner = "client!wa", name = "c", descriptor = "(I)V", line = 52)
    public static void method2975(int arg0) {
        field7333 = null;
        int var1 = -54 % ((22 - arg0) / 39);
    }

    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(BZ)V", line = 66)
