...
public class class523 {
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(Lwq;I)I")
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(Ldk;B)V")
    ...
    @OriginalMember(owner = "client!tw", name = "<init>", descriptor = "(Lkw;I)V")
