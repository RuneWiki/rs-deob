...
public class class698 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Z[[[Lmf;IIII)Z")
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(ILud;)Lge;")
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(Loea;JI)V")
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lud;B)Lrv;")
