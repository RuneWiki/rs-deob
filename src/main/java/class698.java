...
public class class698 extends class450 {
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(Lht;B)V")
    ...
    @OriginalMember(owner = "client!sea", name = "<init>", descriptor = "(ILup;)V")
    ...
    @OriginalMember(owner = "client!sea", name = "<init>", descriptor = "(Lup;)V")
