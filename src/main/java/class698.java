...
public class class698 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(B)V", line = 14)
    public static void method3931(byte arg0) {
        field9719 = null;
        int var1 = 22 / ((arg0 - 67) / 59);
    }

    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(BLlja;ZZ)V", line = 23)
