...
public class class698 extends class405 {
    ...
    @OriginalMember(owner = "client!hfa", name = "b", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!hfa", name = "finalize", descriptor = "()V", line = 25)
    protected final void finalize() {
        this.method2461(false);
        field9723++;
    }

    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(II[BI)V", line = 45)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(II)Z", line = 61)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(III[B)I", line = 72)
    ...
    @OriginalMember(owner = "client!hfa", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 86)
