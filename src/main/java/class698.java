...
public class class698 extends class546 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(B)V", line = 138)
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(I)V", line = 157)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IBI)Z", line = 171)
