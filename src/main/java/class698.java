...
public abstract class class698 {
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(Z)V", line = 13)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(I[[BB[B[I[[BI[I)I", line = 28)
    ...
    @OriginalMember(owner = "client!vv", name = "b", descriptor = "(Z)Z", line = 90)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(B)Z", line = 102)
    ...
    @OriginalMember(owner = "client!vv", name = "b", descriptor = "(B)Z", line = 116)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(I)Z", line = 127)
