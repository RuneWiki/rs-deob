...
public class class698 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IILr;I)V", line = 19)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ILr;II)V", line = 94)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "([[ZBZIII)V", line = 164)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IIIII)V", line = 350)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "([BZ)Z", line = 398)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IBLr;I)Z", line = 425)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(B)V", line = 498)
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Lffa;Laq;)V", line = 525)
