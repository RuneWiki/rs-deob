...
public class class698 extends class615 {
    ...
    @OriginalMember(owner = "client!ih", name = "f", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!ih", name = "g", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!ih", name = "<init>", descriptor = "(ILoh;I)V", line = 52)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "([BB)I", line = 62)
