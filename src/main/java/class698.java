...
public class class698 extends class288 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(I[IIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(B)Los;", line = 113)
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(Lrt;Lcp;IIIIIIIIII)V", line = 124)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ILoa;Le;)V", line = 138)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Lqi;III)J", line = 369)
