...
public class class698 {
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(IB)I", line = 45)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(Llt;B)V", line = 64)
