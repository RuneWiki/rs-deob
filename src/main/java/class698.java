...
public class class698 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(I)Z", line = 19)
    ...
    @OriginalMember(owner = "client!jh", name = "c", descriptor = "(B)I", line = 299)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ZLqda;I)V", line = 309)
    ...
    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(I)V", line = 381)
    ...
    @OriginalMember(owner = "client!jh", name = "d", descriptor = "(B)V", line = 411)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ZB)V", line = 440)
    ...
    @OriginalMember(owner = "client!jh", name = "c", descriptor = "(I)I", line = 468)
    ...
    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(Z)Z", line = 482)
    ...
    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(B)V", line = 493)
    ...
    @OriginalMember(owner = "client!jh", name = "d", descriptor = "(I)V", line = 514)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(BIBIZ)Laf;", line = 536)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Z)V", line = 577)
