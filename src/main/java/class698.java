...
public class class698 extends class3 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B)Lq;", line = 11)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IIJIZLin;BI)V", line = 71)
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "(Lqo;IIIIII)V", line = 98)
