...
public class class698 extends class277 {
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(IILrg;)V")
    ...
    @OriginalMember(owner = "client!vv", name = "<init>", descriptor = "(Lqj;)V")
    ...
    @OriginalMember(owner = "client!vv", name = "d", descriptor = "(B)V")
