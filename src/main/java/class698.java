...
public class class698 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(II)Z", line = 23)
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "(Lac;)V", line = 118)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ZZIIZI)V", line = 44)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Lcu;ZI)Z", line = 106)
