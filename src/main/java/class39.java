...
public class class39 extends class280 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(I)Lea;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(FLea;Lea;I)V")
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(Lks;I)V")
