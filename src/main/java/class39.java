...
public class class39 extends class286 {
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(Lvj;IIII[I)V")
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(Lvj;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(Lvj;IIIZ[I)V")
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(Lvj;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(Lvj;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(Lvj;IIIIIIZ)V")
