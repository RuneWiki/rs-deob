...
public class class39 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(I)I", line = 8)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Llf;)V", line = 25)
    ...
    @OriginalMember(owner = "client!dl", name = "b", descriptor = "(Llf;)V", line = 33)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "()V", line = 49)
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "()V", line = 56)
    public class39() {
        this.field528[0] = 0;
