...
public class class39 implements class344 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Lkha;ILkha;I)V")
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Lcg;Lac;Lsh;)V")
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Ldv;I)V")
