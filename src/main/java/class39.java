...
public class class39 extends Exception {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(IIIIIIZIII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(IBIII)V", line = 35)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(IIIILad;I)V", line = 107)
