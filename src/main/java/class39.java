...
public class class39 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Ltn;Lea;IIIILqa;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IBII)I", line = 106)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IB)Lva;", line = 119)
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(IB)V", line = 159)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(B)V", line = 185)
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(Lmt;ILhh;)V", line = 203)
