...
public class class39 extends class469 implements class529 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(I[IIIIIZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILkd;ZII)Z", line = 24)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IIII)V", line = 29)
    public final void method321(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lkd;IZ)V", line = 32)
    public final void method322(class280 arg0, int arg1, boolean arg2) {
        this.method314(((class276) arg0).nativeid, arg1, arg2);
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(BIZ)Lka;", line = 40)
    ...
    @OriginalMember(owner = "client!i", name = "d", descriptor = "()V", line = 42)
    public final void method326() {
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lkd;Lig;I)V", line = 47)
    ...
    @OriginalMember(owner = "client!i", name = "f", descriptor = "()[Lgi;", line = 68)
    public final class675[] method334() {
        return this.field585;
    }

    @OriginalMember(owner = "client!i", name = "c", descriptor = "()[Luga;", line = 72)
    public final class206[] method336() {
        return this.field586;
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "([ILkd;)V", line = 77)
    private final void method339(int[] arg0, class280 arg1) {
        this.field584.method3887().method3565(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "()Z", line = 81)
    public final boolean method341() {
        return true;
    }

    @OriginalMember(owner = "client!i", name = "e", descriptor = "()V", line = 84)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lkd;Lig;II)V", line = 101)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lka;IIIZ)V", line = 119)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILkd;ZI)Z", line = 125)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lkd;)V", line = 134)
    ...
    @OriginalMember(owner = "client!i", name = "finalize", descriptor = "()V", line = 191)
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;Lya;Lww;IIII)V", line = 200)
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;)V", line = 273)
