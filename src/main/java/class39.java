...
@OriginalClass("client!KIRTNGZJ")
public class class39 {

    @OriginalMember(owner = "client!KIRTNGZJ", name = "b", descriptor = "I")
    private int field1193 = -49833;

    @OriginalMember(owner = "client!KIRTNGZJ", name = "i", descriptor = "I")
    public int field1200 = -1;

    @OriginalMember(owner = "client!KIRTNGZJ", name = "k", descriptor = "Z")
    public boolean field1202 = false;

    @OriginalMember(owner = "client!KIRTNGZJ", name = "l", descriptor = "I")
    public int field1203 = 5;

    @OriginalMember(owner = "client!KIRTNGZJ", name = "m", descriptor = "I")
    public int field1204 = -1;

    @OriginalMember(owner = "client!KIRTNGZJ", name = "n", descriptor = "I")
    public int field1205 = -1;

    @OriginalMember(owner = "client!KIRTNGZJ", name = "o", descriptor = "I")
    public int field1206 = 99;

    @OriginalMember(owner = "client!KIRTNGZJ", name = "p", descriptor = "I")
    public int field1207 = -1;

    @OriginalMember(owner = "client!KIRTNGZJ", name = "q", descriptor = "I")
    public int field1208 = -1;

    @OriginalMember(owner = "client!KIRTNGZJ", name = "r", descriptor = "I")
    public int field1209 = 2;

    @OriginalMember(owner = "client!KIRTNGZJ", name = "c", descriptor = "I")
    public static int field1194;

    @OriginalMember(owner = "client!KIRTNGZJ", name = "e", descriptor = "I")
    public int field1196;

    @OriginalMember(owner = "client!KIRTNGZJ", name = "s", descriptor = "I")
    public int field1210;

    @OriginalMember(owner = "client!KIRTNGZJ", name = "t", descriptor = "I")
    public static int field1211;

    @OriginalMember(owner = "client!KIRTNGZJ", name = "a", descriptor = "Z")
    private static boolean field1192;

    @OriginalMember(owner = "client!KIRTNGZJ", name = "f", descriptor = "[I")
    public int[] field1197;

    @OriginalMember(owner = "client!KIRTNGZJ", name = "g", descriptor = "[I")
    public int[] field1198;

    @OriginalMember(owner = "client!KIRTNGZJ", name = "h", descriptor = "[I")
    private int[] field1199;

    @OriginalMember(owner = "client!KIRTNGZJ", name = "j", descriptor = "[I")
    public int[] field1201;

    @OriginalMember(owner = "client!KIRTNGZJ", name = "d", descriptor = "[LKIRTNGZJ;")
    public static class39[] field1195;

    @OriginalMember(owner = "client!KIRTNGZJ", name = "a", descriptor = "(ZLEAXVDNXA;)V")
    ...
    @OriginalMember(owner = "client!KIRTNGZJ", name = "a", descriptor = "(II)I")
    ...
    @OriginalMember(owner = "client!KIRTNGZJ", name = "a", descriptor = "(BLCKBTFRZM;)V")
