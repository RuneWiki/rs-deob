...
public class class39 extends class40 {
    ...
    @OriginalMember(owner = "client!vg", name = "<init>", descriptor = "(Lef;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!vg", name = "<init>", descriptor = "(Lef;II)V")
    ...
    @OriginalMember(owner = "client!vg", name = "<init>", descriptor = "(Lef;IIZ[[BI)V")
