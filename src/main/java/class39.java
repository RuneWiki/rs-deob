...
public class class39 extends class331 {
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(II)V", line = 32)
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(III)V", line = 48)
    ...
    @OriginalMember(owner = "client!qn", name = "c", descriptor = "(Z)V", line = 69)
