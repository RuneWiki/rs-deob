...
public class class39 {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(II)Ljo;", line = 5)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(I)V", line = 52)
    public final void method186(int arg0) {
        int var2 = 71 % ((arg0 + 15) / 58);
        this.field402.method613(true);
    }

    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "(Lql;Lal;)V", line = 61)
