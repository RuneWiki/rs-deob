...
public class class39 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(II)V", line = 26)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Z)V", line = 40)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IB)Ltf;", line = 53)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(II)Z", line = 88)
    ...
    @OriginalMember(owner = "client!rq", name = "c", descriptor = "(II)V", line = 110)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(ZILat;I)V", line = 179)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(I)V", line = 211)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Lad;ILdk;)V", line = 247)
    public class39(class12 arg0, int arg1, class421 arg2) {
        this.field582 = arg2;
        this.field587 = this.field582.method2509(0, 4);
    }

    @OriginalMember(owner = "client!rq", name = "c", descriptor = "(I)V", line = 232)
