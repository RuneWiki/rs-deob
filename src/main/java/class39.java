...
public class class39 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(II)[I", line = 6)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(III)I", line = 291)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "()V", line = 358)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lre;)V", line = 395)
