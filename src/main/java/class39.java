...
public class class39 extends class295 {
    ...
    @OriginalMember(owner = "client!is", name = "e", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(ZC)I", line = 35)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(ZLap;)V", line = 60)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(CI)I", line = 81)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(ILap;B)V", line = 115)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 185)
    ...
    @OriginalMember(owner = "client!is", name = "e", descriptor = "(I)V", line = 240)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(BII)V", line = 259)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Lrk;I)V", line = 272)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(IIIIIII)V", line = 287)
