...
@OriginalClass("client!LVXNVCAS")
public class class39 {

    @OriginalMember(owner = "client!LVXNVCAS", name = "a", descriptor = "I")
    private int field1116;

    @OriginalMember(owner = "client!LVXNVCAS", name = "b", descriptor = "[LFLQEGCUY;")
    private class15[] field1117;

    @OriginalMember(owner = "client!LVXNVCAS", name = "<init>", descriptor = "(ZI)V")
    ...
    @OriginalMember(owner = "client!LVXNVCAS", name = "a", descriptor = "(J)LFLQEGCUY;")
    ...
    @OriginalMember(owner = "client!LVXNVCAS", name = "a", descriptor = "(IJLFLQEGCUY;)V")
