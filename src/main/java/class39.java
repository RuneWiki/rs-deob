...
public class class39 extends class30 {
    ...
    @OriginalMember(owner = "client!NSRXNXHB", name = "l", descriptor = "Z")
    public static boolean field1117;

    @OriginalMember(owner = "client!NSRXNXHB", name = "j", descriptor = "[LNONLGXRN;")
    ...
    @OriginalMember(owner = "client!NSRXNXHB", name = "a", descriptor = "(I)LFUTAQMCE;")
