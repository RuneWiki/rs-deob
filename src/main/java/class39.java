...
public class class39 extends class615 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(IIIZLbi;Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(IB)[I", line = 25)
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "()V", line = 50)
    public class39() {
        this(4096);
    }

    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Z)V", line = 53)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(IIIIIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(BILeh;)V", line = 117)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(IIB)Z", line = 144)
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "(I)V", line = 168)
