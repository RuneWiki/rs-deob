...
public abstract class class39 extends class452 {
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IIZIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Z)V", line = 72)
    ...
    @OriginalMember(owner = "client!vg", name = "<init>", descriptor = "(I)V", line = 83)
