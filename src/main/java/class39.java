...
public class class39 {
    ...
    @OriginalMember(owner = "client!OHEMVFER", name = "c", descriptor = "[LOHEMVFER;")
    public static class39[] field1195;

    @OriginalMember(owner = "client!OHEMVFER", name = "a", descriptor = "(ILINOFEYKQ;)V")
    ...
    @OriginalMember(owner = "client!OHEMVFER", name = "a", descriptor = "(ILNHEPCMLW;I)V")
