...
public abstract class class39 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IZII)V", line = 25)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Lgn;IIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(I)V", line = 205)
