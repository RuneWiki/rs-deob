...
public class class39 extends class42 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(ZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IILem;)V", line = 87)
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZ)V", line = 130)
