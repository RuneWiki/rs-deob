...
public class class39 extends class56 {
    ...
    @OriginalMember(owner = "client!ud", name = "c", descriptor = "(III)I", line = 7)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(II)[I", line = 21)
    ...
    @OriginalMember(owner = "client!ud", name = "d", descriptor = "(III)Z", line = 54)
    ...
    @OriginalMember(owner = "client!ud", name = "d", descriptor = "(Z)I", line = 72)
    ...
    @OriginalMember(owner = "client!ud", name = "b", descriptor = "(B)V", line = 94)
