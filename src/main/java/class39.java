...
public class class39 extends class214 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(ILjr;)V", line = 4)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(BI)[I", line = 43)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(II)V", line = 111)
    ...
    @OriginalMember(owner = "client!na", name = "<init>", descriptor = "()V", line = 126)
    public class39() {
        super(0, true);
    }

    @OriginalMember(owner = "client!na", name = "a", descriptor = "(Llk;II)V", line = 130)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 174)
    ...
    @OriginalMember(owner = "client!na", name = "e", descriptor = "(I)V", line = 205)
    ...
    @OriginalMember(owner = "client!na", name = "b", descriptor = "(B)V", line = 218)
