...
public class class39 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(BLsl;)V", line = 4)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IIIIILbi;)Lbaa;", line = 25)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Lsl;BI)V", line = 73)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IZIII)Lkp;", line = 110)
