...
public class class39 extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!OFXQYNOM", name = "o", descriptor = "[LTTWFVYGB;")
    ...
    @OriginalMember(owner = "client!OFXQYNOM", name = "p", descriptor = "LJYOWNEXJ;")
    public class25 field1198;

    @OriginalMember(owner = "client!OFXQYNOM", name = "n", descriptor = "LMVSFNVJP;")
