...
public class class39 implements class95 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IIZLmaa;I)V")
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Lgha;II)V")
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ILgha;II)V")
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ILru;Z)V")
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Lmaa;III)V")
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "(Lck;)V")
