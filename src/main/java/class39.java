...
public class class39 {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IZ)Lcda;", line = 33)
    ...
    @OriginalMember(owner = "client!ud", name = "b", descriptor = "(II)V", line = 82)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ILs;)V", line = 95)
    public static final void method241(int arg0, class296 arg1) {
        class745.field10286[arg0] = arg1;
    }

    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Lim;ILgj;)V", line = 108)
