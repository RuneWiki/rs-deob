...
public class class39 extends class475 implements class533 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lofa;Lvh;II)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILofa;ZII)Z")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILofa;ZI)Z")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lofa;)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "([ILofa;)V")
    private final void method306(int[] arg0, class333 arg1) {
        this.field542.method3917().method3385(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!i", name = "e", descriptor = "()[Lcm;")
    ...
    @OriginalMember(owner = "client!i", name = "c", descriptor = "()[Lhi;")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lofa;Lvh;I)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lofa;IZ)V")
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;Lya;Lur;IIII)V")
