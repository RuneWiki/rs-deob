...
public class class39 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(III)V", line = 9)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ZIZLva;)V", line = 19)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ILoh;)I", line = 101)
