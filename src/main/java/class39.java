...
public class class39 extends class471 implements class532 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lnga;Lfn;I)V")
    ...
    @OriginalMember(owner = "client!i", name = "b", descriptor = "()[Lde;")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILnga;ZII)Z")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILnga;ZI)Z")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lnga;)V")
    ...
    @OriginalMember(owner = "client!i", name = "d", descriptor = "()[Lok;")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lnga;Lfn;II)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lnga;IZ)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "([ILnga;)V")
    private final void method267(int[] arg0, class513 arg1) {
        this.field484.method3904().method3462(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;Lya;Lie;IIII)V")
