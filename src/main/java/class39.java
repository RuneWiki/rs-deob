...
public class class39 {
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(Ljava/awt/Component;Z)Lkc;", line = 12)
    public static final class72 method293(Component arg0, boolean arg1) {
        field458++;
        return arg1 ? new class244(arg0) : null;
    }

    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(I[Ljava/lang/String;)[Ljava/lang/String;", line = 124)
