...
public class class39 {
    ...
    @OriginalMember(owner = "client!dh", name = "c", descriptor = "Llf;")
    private static class109 field830 = class35.method275("Unexpected server response)3", 2);

    @OriginalMember(owner = "client!dh", name = "b", descriptor = "Llf;")
    public static class109 field829 = class35.method275("m-Ochte mit Ihnen handeln)3", 2);

    @OriginalMember(owner = "client!dh", name = "e", descriptor = "Llf;")
    public static class109 field832 = field830;

    @OriginalMember(owner = "client!dh", name = "d", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!dh", name = "h", descriptor = "Loh;")
