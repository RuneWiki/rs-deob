...
public class class39 {
    ...
    @OriginalMember(owner = "client!ODYOEFFK", name = "c", descriptor = "LEWMBJETC;")
    public class13 field1188 = new class13();

    @OriginalMember(owner = "client!ODYOEFFK", name = "d", descriptor = "LEWMBJETC;")
    ...
    @OriginalMember(owner = "client!ODYOEFFK", name = "a", descriptor = "(LEWMBJETC;)V")
    ...
    @OriginalMember(owner = "client!ODYOEFFK", name = "a", descriptor = "()LEWMBJETC;")
    ...
    @OriginalMember(owner = "client!ODYOEFFK", name = "b", descriptor = "()LEWMBJETC;")
    ...
    @OriginalMember(owner = "client!ODYOEFFK", name = "a", descriptor = "(Z)LEWMBJETC;")
