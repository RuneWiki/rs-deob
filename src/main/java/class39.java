...
public class class39 implements class46 {
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "(I)V", line = 6)
    public class39(int arg0) {
        this.field724 = arg0;
    }

    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(BLn;Ln;)V", line = 31)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(B)Lsq;", line = 64)
