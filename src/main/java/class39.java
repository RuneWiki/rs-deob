...
public class class39 extends class605 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "(Lok;Lsda;)V", line = 40)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(IIFIIIIZI)[[I", line = 61)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ZB)V", line = 91)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Z)Z", line = 101)
    public final boolean method48(boolean arg0) {
        ++field646;
        return arg0 ? false : this.field652;
    }

    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ILip;I)V", line = 113)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(IZI)V", line = 130)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(I)V", line = 170)
