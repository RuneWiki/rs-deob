...
public class class39 extends class470 implements class531 {
    ...
    @OriginalMember(owner = "client!i", name = "c", descriptor = "()[Loia;", line = 3)
    public final class88[] method186() {
        return this.field434;
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Ldfa;Lim;II)V", line = 7)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "()V", line = 25)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILdfa;ZII)Z", line = 43)
    ...
    @OriginalMember(owner = "client!i", name = "f", descriptor = "()Z", line = 66)
    public final boolean method200() {
        return true;
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "([ILdfa;)V", line = 69)
    private final void method201(int[] arg0, class165 arg1) {
        this.field435.method3900().method3523(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(I[IIIIIZ)V", line = 78)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Ldfa;IZ)V", line = 85)
    public final void method210(class165 arg0, int arg1, boolean arg2) {
        this.method215(((class276) arg0).nativeid, arg1, arg2);
    }

    @OriginalMember(owner = "client!i", name = "d", descriptor = "()[Lnda;", line = 89)
    public final class555[] method212() {
        return this.field436;
    }

    @OriginalMember(owner = "client!i", name = "finalize", descriptor = "()V", line = 96)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Ldfa;)V", line = 105)
    ...
    @OriginalMember(owner = "client!i", name = "b", descriptor = "()V", line = 162)
    public final void method223() {
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IIII)V", line = 166)
    public final void method226(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILdfa;ZI)Z", line = 169)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Ldfa;Lim;I)V", line = 172)
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;Lya;Luk;IIII)V", line = 198)
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;)V", line = 270)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(BIZ)Lka;", line = 277)
