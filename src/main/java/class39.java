...
public class class39 extends class194 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(II)[I", line = 14)
    ...
    @OriginalMember(owner = "client!mn", name = "h", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IZ)I", line = 113)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IIIZZ)V", line = 130)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(BI)V", line = 157)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IILbg;)V", line = 185)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 227)
