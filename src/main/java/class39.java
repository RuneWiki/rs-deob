...
public class class39 extends class529 {
    ...
    @OriginalMember(owner = "client!aea", name = "<init>", descriptor = "(Lct;Lrc;IIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(BC)C")
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(I)Lwea;")
