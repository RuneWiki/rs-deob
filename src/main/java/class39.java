...
public class class39 extends class155 {
    ...
    @OriginalMember(owner = "client!wf", name = "b", descriptor = "(B)Ljava/net/Socket;", line = 13)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(ILjava/net/Proxy;)Ljava/net/Socket;", line = 86)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 109)
    ...
    @OriginalMember(owner = "client!wf", name = "httpProxyConnect", descriptor = "(Ljava/lang/String;ILjava/lang/String;)Ljava/net/Socket;", line = 162)
