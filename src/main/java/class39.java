...
public class class39 extends class101 {
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(III)Z", line = 17)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IIIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!bh", name = "d", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(II)V", line = 193)
