...
public class class39 extends class719 {
    ...
    @OriginalMember(owner = "client!ud", name = "b", descriptor = "(B)Z", line = 8)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(III)V", line = 20)
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Lsha;Luq;Lgaa;)V", line = 49)
    ...
    @OriginalMember(owner = "client!ud", name = "g", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ZLb;I)V", line = 91)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IZ)V", line = 111)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(FBFF)F", line = 142)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(JI)V", line = 155)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ZZ)V", line = 242)
    ...
    @OriginalMember(owner = "client!ud", name = "h", descriptor = "(I)V", line = 252)
    public static void method226(int arg0) {
        field406 = null;
        int var1 = -78 % ((arg0 - -37) / 42);
    }

    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 261)
