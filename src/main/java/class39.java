...
@OriginalClass("client!LOFYMKZK")
public class class39 extends class63 {

    @OriginalMember(owner = "client!LOFYMKZK", name = "l", descriptor = "I")
    private int field1116 = 6;

    @OriginalMember(owner = "client!LOFYMKZK", name = "m", descriptor = "Z")
    private boolean field1117 = true;

    @OriginalMember(owner = "client!LOFYMKZK", name = "s", descriptor = "Z")
    private boolean field1123 = false;

    @OriginalMember(owner = "client!LOFYMKZK", name = "x", descriptor = "I")
    private int field1128;

    @OriginalMember(owner = "client!LOFYMKZK", name = "y", descriptor = "I")
    private int field1129;

    @OriginalMember(owner = "client!LOFYMKZK", name = "z", descriptor = "I")
    private int field1130;

    @OriginalMember(owner = "client!LOFYMKZK", name = "n", descriptor = "I")
    private int field1118;

    @OriginalMember(owner = "client!LOFYMKZK", name = "o", descriptor = "I")
    private int field1119;

    @OriginalMember(owner = "client!LOFYMKZK", name = "p", descriptor = "I")
    private int field1120;

    @OriginalMember(owner = "client!LOFYMKZK", name = "q", descriptor = "I")
    private int field1121;

    @OriginalMember(owner = "client!LOFYMKZK", name = "B", descriptor = "LNMXKUYSC;")
    private class42 field1132;

    @OriginalMember(owner = "client!LOFYMKZK", name = "r", descriptor = "I")
    private int field1122;

    @OriginalMember(owner = "client!LOFYMKZK", name = "w", descriptor = "I")
    private int field1127;

    @OriginalMember(owner = "client!LOFYMKZK", name = "u", descriptor = "I")
    public int field1125;

    @OriginalMember(owner = "client!LOFYMKZK", name = "v", descriptor = "I")
    public int field1126;

    @OriginalMember(owner = "client!LOFYMKZK", name = "A", descriptor = "[I")
    public int[] field1131;

    @OriginalMember(owner = "client!LOFYMKZK", name = "t", descriptor = "Lclient;")
    public static client field1124;

    @OriginalMember(owner = "client!LOFYMKZK", name = "<init>", descriptor = "(IIIIIIZIII)V")
    ...
    @OriginalMember(owner = "client!LOFYMKZK", name = "b", descriptor = "(I)LSCWSBSIM;")
    ...
    @OriginalMember(owner = "client!LOFYMKZK", name = "a", descriptor = "(I)LKPUOCBCE;")
