...
public class class39 {
    ...
    @OriginalMember(owner = "client!gv", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field557++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(II)V", line = 25)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Ljava/lang/String;II)Z", line = 43)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(BLfd;)V", line = 98)
