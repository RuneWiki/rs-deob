...
public class class39 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(I[J[Ljava/lang/Object;)V", line = 6)
    ...
    @OriginalMember(owner = "client!bt", name = "toString", descriptor = "()Ljava/lang/String;", line = 25)
    public final String toString() {
        field468++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IBILks;)V", line = 33)
    ...
    @OriginalMember(owner = "client!bt", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 90)
    public class39(String arg0, int arg1) {
        this.field473 = arg0;
        this.field470 = arg1;
    }

    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Z)V", line = 100)
