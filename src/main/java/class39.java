...
public class class39 extends class666 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IIIILkm;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(I)I", line = 276)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(ILha;)V", line = 292)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(B)[B", line = 344)
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(B)V", line = 368)
    ...
    @OriginalMember(owner = "client!ch", name = "c", descriptor = "(B)V", line = 379)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(BLab;ZZ)V", line = 391)
