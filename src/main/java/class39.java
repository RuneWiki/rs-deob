...
public class class39 extends class201 implements class47 {
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "()[Lil;")
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Lia;Lmn;II)V")
    ...
    @OriginalMember(owner = "client!p", name = "d", descriptor = "()[Le;")
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Lia;Lmn;I)V")
    ...
    @OriginalMember(owner = "client!p", name = "<init>", descriptor = "(Lh;Lba;Lro;IIII)V")
