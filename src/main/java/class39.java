...
public class class39 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "([[BILn;)V")
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Lgv;I)V")
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(B)Lgv;")
