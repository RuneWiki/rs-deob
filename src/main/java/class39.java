...
public class class39 extends class13 {
    ...
    @OriginalMember(owner = "client!dl", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!dl", name = "b", descriptor = "(II)V", line = 109)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Lnq;Lnq;IZI)V", line = 374)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(BI)Lcf;", line = 396)
    ...
    @OriginalMember(owner = "client!dl", name = "e", descriptor = "(I)V", line = 422)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(ILg;)V", line = 455)
    ...
    @OriginalMember(owner = "client!dl", name = "e", descriptor = "(B)I", line = 475)
    ...
    @OriginalMember(owner = "client!dl", name = "f", descriptor = "(I)V", line = 490)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(II)[[I", line = 503)
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "()V", line = 554)
    public class39() {
        super(1, false);
    }

    @OriginalMember(owner = "client!dl", name = "c", descriptor = "(I)V", line = 557)
    ...
    @OriginalMember(owner = "client!dl", name = "f", descriptor = "(B)V", line = 576)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Lkh;BI)V", line = 592)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(ZLoo;)I", line = 630)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IJLuo;)V", line = 712)
    ...
    @OriginalMember(owner = "client!dl", name = "c", descriptor = "(II)Z", line = 746)
