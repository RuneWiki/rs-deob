...
public class class39 {
    ...
    @OriginalMember(owner = "client!NLIOLBXV", name = "f", descriptor = "LHSGACJOH;")
    ...
    @OriginalMember(owner = "client!NLIOLBXV", name = "d", descriptor = "[LNLIOLBXV;")
    ...
    @OriginalMember(owner = "client!NLIOLBXV", name = "c", descriptor = "(I)LNLIOLBXV;")
