...
public abstract class class39 extends class687 {
    ...
    @OriginalMember(owner = "client!bt", name = "h", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!bt", name = "j", descriptor = "(I)Z", line = 21)
    ...
    @OriginalMember(owner = "client!bt", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 37)
