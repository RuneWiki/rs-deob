...
public abstract class class89 extends class120 {
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(ILjg;)V", line = 3)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Ljg;Z)V", line = 238)
    ...
    @OriginalMember(owner = "client!aq", name = "e", descriptor = "(I)V", line = 278)
    ...
    @OriginalMember(owner = "client!aq", name = "<init>", descriptor = "(IIII)V", line = 295)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "([BIBI[[B[I[I[[B)I", line = 307)
