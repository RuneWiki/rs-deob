...
public class class89 extends class260 {
    ...
    @OriginalMember(owner = "client!wf", name = "c", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(Lya;Lij;III)V", line = 28)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(ZLjava/lang/String;ZI)Z", line = 76)
