...
public class class89 extends class659 {
    ...
    @OriginalMember(owner = "client!via", name = "c", descriptor = "(I)Ltfa;")
    ...
    @OriginalMember(owner = "client!via", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(ILjagtheora/ogg/OggPacket;)V")
