...
public class class89 extends class205 {
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Lks;IIIIZ[IZ)V")
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Lks;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Lks;IIII)V")
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Lks;IIIII)V")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IIII[BIIIZ)V")
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Lks;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IIII[IIIZ)V")
