...
public class class89 {
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(I)Lhf;")
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ZILbg;)V")
    ...
    @OriginalMember(owner = "client!lh", name = "d", descriptor = "(I)Lhf;")
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Lbg;I)V")
