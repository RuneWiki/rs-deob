...
public class class89 {
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(III)Lin;")
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(ILr;IIZIIII)V")
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(ILkj;)Z")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
