...
public abstract class class89 {
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IIBI)V", line = 7)
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(IIIII)V", line = 330)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(B)V", line = 184)
    ...
    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(I)V", line = 218)
    ...
    @OriginalMember(owner = "client!cd", name = "c", descriptor = "(I)V", line = 256)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lr;I)V", line = 277)
