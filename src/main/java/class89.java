...
public class class89 extends class392 {
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Lw;)V", line = 3)
    public class89(class675 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(ILw;)V", line = 6)
    public class89(int arg0, class675 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(BI)V", line = 15)
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(II)I", line = 26)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Z)I", line = 37)
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(I)I", line = 67)
