...
public class class89 {
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!ow", name = "b", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(II)V", line = 62)
    ...
    @OriginalMember(owner = "client!ow", name = "c", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!ow", name = "<init>", descriptor = "(Loda;ILdda;)V", line = 94)
    public class89(class559 arg0, int arg1, class597 arg2) {
        this.field1131 = arg2;
        this.field1131.method3462(32, 73);
    }

    @OriginalMember(owner = "client!ow", name = "b", descriptor = "(II)Lbf;", line = 112)
