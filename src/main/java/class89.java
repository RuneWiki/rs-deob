...
public class class89 {
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(IZII)I", line = 4)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(IZI)B", line = 35)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "([[BILiaa;)V", line = 54)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!pw", name = "toString", descriptor = "()Ljava/lang/String;", line = 101)
    public final String toString() {
        field1171++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(IIIIIIIIII)V", line = 109)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(Ldg;B)V", line = 135)
    ...
    @OriginalMember(owner = "client!pw", name = "<init>", descriptor = "(I)V", line = 155)
