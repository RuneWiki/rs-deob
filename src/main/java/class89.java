...
public class class89 extends class35 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Ljava/awt/Frame;Lvj;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(III)I", line = 29)
    ...
    @OriginalMember(owner = "client!kq", name = "c", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!kq", name = "c", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(II)V", line = 77)
