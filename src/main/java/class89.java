...
public class class89 extends class383 {
    ...
    @OriginalMember(owner = "client!wf", name = "e", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!wf", name = "b", descriptor = "(Z)Z", line = 25)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "([BIIB)[B", line = 43)
