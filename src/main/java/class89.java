...
public class class89 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IIIIIIB)V", line = 136)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IB)I", line = 166)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(II)V", line = 177)
    public static final void method789(int arg0, int arg1) {
        field1311++;
        class334.field4531.method2534(arg1 ^ arg1, arg0);
    }

    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(II)V", line = 185)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lpe;IIILsj;IIIIII)Lsj;", line = 201)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(B)I", line = 244)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IBLfo;)Ldb;", line = 257)
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(I)I", line = 284)
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "()V", line = 304)
    public class89() {
    }

    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(Lap;)V", line = 313)
