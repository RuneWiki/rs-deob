...
public class class89 {
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(Lha;B)V", line = 11)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(Z)[Lkq;", line = 44)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(BI)I", line = 55)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!haa", name = "b", descriptor = "(BI)Lsha;", line = 84)
    ...
    @OriginalMember(owner = "client!haa", name = "<init>", descriptor = "(Liv;ILcb;)V", line = 119)
