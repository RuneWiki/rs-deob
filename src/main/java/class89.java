...
public class class89 {
    ...
    @OriginalMember(owner = "client!wf", name = "b", descriptor = "(II)Lrd;")
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(IILya;IIIIIIIII[[[B)V")
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "(Ljk;IZLfs;Lfs;)V")
