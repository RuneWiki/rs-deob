...
public class class89 extends class13 {
    ...
    @OriginalMember(owner = "client!jh", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Lkh;BI)V", line = 16)
    ...
    @OriginalMember(owner = "client!jh", name = "e", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ZI)[I", line = 110)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IIIII)V", line = 245)
    ...
    @OriginalMember(owner = "client!jh", name = "c", descriptor = "(I)V", line = 266)
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "()V", line = 293)
    public class89() {
        super(0, true);
    }

    @OriginalMember(owner = "client!jh", name = "c", descriptor = "(III)V", line = 300)
