...
public abstract class class89 extends class107 {
    ...
    @OriginalMember(owner = "client!kca", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(III)Lbt;", line = 16)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(IB)I", line = 23)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(BII)Z", line = 68)
    ...
    @OriginalMember(owner = "client!kca", name = "<init>", descriptor = "(Ldr;I)V", line = 85)
