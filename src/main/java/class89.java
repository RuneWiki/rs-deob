...
public class class89 extends class9 {
    ...
    @OriginalMember(owner = "client!jd", name = "Q", descriptor = "Ljava/lang/Class;")
    public static Class field1847;

    @OriginalMember(owner = "client!jd", name = "D", descriptor = "Ljavax/sound/sampled/AudioFormat;")
    private AudioFormat field1843;

    @OriginalMember(owner = "client!jd", name = "O", descriptor = "Ljavax/sound/sampled/SourceDataLine;")
