...
public class class89 extends class299 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(II)[B", line = 3)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(B)[Lfi;", line = 52)
    ...
    @OriginalMember(owner = "client!vr", name = "e", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!vr", name = "f", descriptor = "(I)Lpd;", line = 78)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(II)V", line = 102)
