...
public class class89 extends class66 {
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;)V", line = 20)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(ILie;I)V", line = 34)
    ...
    @OriginalMember(owner = "client!qda", name = "<init>", descriptor = "()V", line = 67)
    public class89() {
    }

    @OriginalMember(owner = "client!qda", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 69)
