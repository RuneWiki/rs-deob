...
public class class89 extends class692 {
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Lrs;IIIZ[III)V", line = 3)
    ...
    @OriginalMember(owner = "client!sb", name = "c", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Lrs;IIIIIZ)V", line = 36)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Lrs;IIII)V", line = 62)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Lrs;IIIIZ[BI)V", line = 83)
    ...
    @OriginalMember(owner = "client!sb", name = "c", descriptor = "(II)V", line = 105)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Lrs;IIIIIIZ)V", line = 119)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Lrs;IIII[I)V", line = 137)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Lrs;IIIII)V", line = 155)
    public class89(class166 arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Lrs;IIIII[BI)V", line = 168)
