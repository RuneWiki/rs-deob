...
public class class89 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ZLoa;B)Lxa;")
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ZLoba;)Z")
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Loa;B)Lxa;")
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Liaa;ZI)V")
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ZLiaa;)V")
