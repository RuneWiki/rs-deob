...
public class class89 extends class488 {
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(Lbl;Lpm;[Lfd;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(CIIIZLbe;II)V", line = 209)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(CIIIZ)V", line = 254)
