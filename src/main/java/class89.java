...
public class class89 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "()[B", line = 10)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(Lfc;II)Lvh;", line = 69)
    ...
    @OriginalMember(owner = "client!vh", name = "b", descriptor = "()I", line = 77)
    ...
    @OriginalMember(owner = "client!vh", name = "c", descriptor = "()Lcu;", line = 122)
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "(Llk;)V", line = 129)
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "()V", line = 149)
    private class89() {
    }
}
