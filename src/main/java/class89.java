...
public class class89 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(B)[Lfm;", line = 22)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILlh;I)V", line = 33)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILlh;)V", line = 71)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(I)V", line = 98)
