...
public abstract class class89 {
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(ILha;Ld;)V", line = 15)
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 244)
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(BLha;)V", line = 279)
