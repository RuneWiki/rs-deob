...
public class class89 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Lbk;)V", line = 4)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(I)I", line = 23)
    ...
    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(Lbk;)V", line = 44)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "()V", line = 50)
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "()V", line = 56)
    public class89() {
        this.field998[0] = 0;
