...
public class class89 extends class138 implements class242 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IILta;II)V", line = 3)
    public final void method206(int arg0, int arg1, class448 arg2, int arg3, int arg4) {
        this.method627(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(FFFFFFLta;II)V", line = 9)
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Lw;Lg;[IIIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!ca", name = "finalize", descriptor = "()V", line = 32)
    ...
    @OriginalMember(owner = "client!ca", name = "oa", descriptor = "(III)V", line = 38)
