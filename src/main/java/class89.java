...
public class class89 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lwo;I)V")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lwo;B)Z")
    ...
    @OriginalMember(owner = "client!mc", name = "<init>", descriptor = "(Lnq;)V")
