...
public class class89 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(II)V", line = 26)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "(Lpo;ILgda;Lgda;)V", line = 253)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Ljava/lang/String;IZZ)V", line = 98)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(BI)Lkw;", line = 217)
