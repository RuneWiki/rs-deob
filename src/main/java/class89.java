...
public class class89 extends class319 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "([B[IIIIIIIIIIILta;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(CIIIZLta;II)V", line = 100)
    ...
    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "(Lwc;Lul;[Ldd;[I[I)V", line = 162)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "([B[IIIIIIII)V", line = 186)
    ...
    @OriginalMember(owner = "client!kc", name = "B", descriptor = "(CIIIZ)V", line = 223)
