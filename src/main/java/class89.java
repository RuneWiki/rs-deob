...
public abstract class class89 implements class698 {
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(FFIFIILhm;IF[BIIF)V")
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(ILha;I)Ltba;")
    ...
    @OriginalMember(owner = "client!cba", name = "<init>", descriptor = "(Lkha;Lkha;Lpd;)V")
