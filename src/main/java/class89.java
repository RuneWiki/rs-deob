...
public class class89 extends class389 {
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(I[Ltp;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(ILbq;Lha;II)V", line = 74)
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(Z)V", line = 108)
    ...
    @OriginalMember(owner = "client!eha", name = "<init>", descriptor = "(I)V", line = 120)
