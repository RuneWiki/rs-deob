...
public class class89 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "([[[Lno;IIIZI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(B)V", line = 328)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(IB)V", line = 343)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(BILjava/lang/String;)Z", line = 361)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ZZ)Z", line = 409)
