...
public class class89 extends class96 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Z[[I)V", line = 10)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(II)[I", line = 60)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(II)[[I", line = 82)
    ...
    @OriginalMember(owner = "client!ed", name = "g", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IILbt;)V", line = 161)
