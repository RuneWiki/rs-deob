...
public class class89 {
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(B)Lpw;", line = 16)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(BLpw;)V", line = 27)
    ...
    @OriginalMember(owner = "client!pw", name = "<init>", descriptor = "(I)V", line = 251)
    public class89(int arg0) {
        this.field1364 = arg0;
    }

    @OriginalMember(owner = "client!pw", name = "<init>", descriptor = "(IIIIII)V", line = 258)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(IIBIIZ)V", line = 52)
