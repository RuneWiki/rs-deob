...
public class class89 {
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(Lrt;I)V")
    ...
    @OriginalMember(owner = "client!kba", name = "b", descriptor = "(I)Luj;")
    ...
    @OriginalMember(owner = "client!kba", name = "c", descriptor = "(I)Luj;")
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(BLeea;)V")
    ...
    @OriginalMember(owner = "client!kba", name = "<init>", descriptor = "(Leea;)V")
