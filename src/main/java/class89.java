...
public abstract class class89 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Lqn;ILaj;)V", line = 7)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IIIIIZ)V", line = 55)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(I)V", line = 155)
