...
public class class89 {
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(IIIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(BC)V", line = 47)
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(II)V", line = 73)
    public final void method836(int arg0, int arg1) {
        field1587++;
        OpenGL.glNewList(this.field1588 + arg1, arg0);
    }

    @OriginalMember(owner = "client!eha", name = "<init>", descriptor = "(Loea;I)V", line = 80)
