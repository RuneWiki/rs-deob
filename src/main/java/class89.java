...
public class class89 extends class125 {
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(Lgp;)V", line = 5)
    public class89(class549 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IIIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IIIBIIII)V", line = 110)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(Z)V", line = 162)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(B)I", line = 183)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(ILgp;)V", line = 193)
    public class89(int arg0, class549 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(ZI)V", line = 196)
    ...
    @OriginalMember(owner = "client!pn", name = "c", descriptor = "(Z)I", line = 271)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(BI)V", line = 282)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ZI)I", line = 294)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(B)V", line = 305)
