...
public class class89 extends class343 {
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(Z)I", line = 3)
    ...
    @OriginalMember(owner = "client!vr", name = "c", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!vr", name = "g", descriptor = "(I)Z", line = 33)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILwr;Lwr;I)V", line = 44)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IBI)V", line = 198)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(II)V", line = 277)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(B)Z", line = 299)
    ...
    @OriginalMember(owner = "client!vr", name = "<init>", descriptor = "(Lbo;)V", line = 336)
    public class89(class511 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!vr", name = "i", descriptor = "(I)Z", line = 341)
    ...
    @OriginalMember(owner = "client!vr", name = "e", descriptor = "(I)V", line = 363)
