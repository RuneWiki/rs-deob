...
public class class89 extends class62 {
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(IIIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(IB)[[I", line = 111)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(B)V", line = 187)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(Lgw;II)V", line = 200)
    ...
    @OriginalMember(owner = "client!kba", name = "h", descriptor = "(I)V", line = 252)
    ...
    @OriginalMember(owner = "client!kba", name = "b", descriptor = "(IIIB)V", line = 265)
    ...
    @OriginalMember(owner = "client!kba", name = "<init>", descriptor = "()V", line = 394)
    public class89() {
        super(1, false);
    }

    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(I[SII[Ljava/lang/String;)V", line = 328)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(Lvp;I)V", line = 397)
