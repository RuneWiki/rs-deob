...
public class class89 extends class305 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "([Lfi;IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!bt", name = "<init>", descriptor = "()V", line = 92)
    public class89() {
        super(1, false);
    }

    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Z)Lop;", line = 96)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(ILfh;B)V", line = 120)
    ...
    @OriginalMember(owner = "client!bt", name = "b", descriptor = "(III)V", line = 164)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IB)[[I", line = 187)
    ...
    @OriginalMember(owner = "client!bt", name = "e", descriptor = "(B)V", line = 264)
