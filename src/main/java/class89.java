...
public class class89 extends class148 {
    ...
    @OriginalMember(owner = "client!vr", name = "e", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!vr", name = "<init>", descriptor = "()V", line = 15)
    public class89() {
        super(0, true);
    }

    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(II)[I", line = 21)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(III)I", line = 54)
