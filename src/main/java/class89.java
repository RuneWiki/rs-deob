...
public class class89 {
    ...
    @OriginalMember(owner = "client!iia", name = "toString", descriptor = "()Ljava/lang/String;", line = 5)
    public final String toString() {
        field1205++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(III)I", line = 15)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(BLuca;ILha;Luaa;ILbq;II)V", line = 48)
