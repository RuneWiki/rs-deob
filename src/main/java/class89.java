...
public class class89 extends class544 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Lqa;)V")
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Los;I)V")
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(ZLpq;)V")
