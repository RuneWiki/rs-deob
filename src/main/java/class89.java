...
public class class89 {
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Leh;)V", line = 38)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "()V", line = 100)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(II)[I", line = 115)
