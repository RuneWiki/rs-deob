...
public class class89 implements class136 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ZI)Lw;")
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Lkq;IIIIB)Ljava/awt/Frame;")
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Ljava/lang/String;BLeb;)I")
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IB)Lgm;")
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "(Lqj;Lqj;Lqj;)V")
