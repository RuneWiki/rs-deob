...
public abstract class class89 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(I)Z", line = 10)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(B)Z", line = 25)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Z)Z", line = 42)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IZI)V", line = 58)
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IZLjava/lang/String;Lwl;)V", line = 99)
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(B)Z", line = 123)
