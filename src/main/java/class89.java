...
public class class89 extends class42 {
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "(Lig;Lfg;)V", line = 56)
    ...
    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(Z)V", line = 86)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "()Z", line = 97)
    public final boolean method287() {
        return true;
    }

    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Lee;)V", line = 100)
    public final void method286(class404 arg0) {
        this.field582.method888(arg0);
    }

    @OriginalMember(owner = "client!jh", name = "b", descriptor = "()V", line = 103)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Z)V", line = 113)
