...
public class class89 {
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(I)Lqfa;", line = 5)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(ZLqfa;)V", line = 16)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(Lrr;IIB)V", line = 33)
    ...
    @OriginalMember(owner = "client!qfa", name = "<init>", descriptor = "(I)V", line = 187)
    public class89(int arg0) {
        this.field1145 = arg0;
    }

    @OriginalMember(owner = "client!qfa", name = "<init>", descriptor = "(IIIIII)V", line = 194)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(IZI)Z", line = 107)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(B)V", line = 123)
    ...
    @OriginalMember(owner = "client!qfa", name = "b", descriptor = "(B)V", line = 157)
