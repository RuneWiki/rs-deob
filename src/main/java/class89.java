...
public class class89 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(I)Lu;", line = 30)
    ...
    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "()V", line = 225)
    public class89() {
    ...
    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "(Ltq;)V", line = 241)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(ZLja;)Z", line = 53)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(Ltq;I)V", line = 73)
    ...
    @OriginalMember(owner = "client!ja", name = "b", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IZI)V", line = 98)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(ZLem;ZZ)V", line = 163)
