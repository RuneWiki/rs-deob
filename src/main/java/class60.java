...
public class class60 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(I)Lls;", line = 4)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lss;B)V", line = 146)
