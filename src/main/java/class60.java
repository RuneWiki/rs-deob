...
public class class60 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Lvm;Ljava/lang/String;[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Lvm;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Lvm;Ljava/lang/String;IIIZ)V")
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Lvm;IZLjava/awt/Component;)V")
