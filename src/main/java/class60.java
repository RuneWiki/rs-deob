...
public class class60 extends class601 {
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "(ILqea;)V", line = 3)
    public class60(int arg0, class339 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!sv", name = "b", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!sv", name = "c", descriptor = "(I)I", line = 24)
    public final int method431(int arg0) {
        ++field872;
        return arg0 != 0 ? -11 : super.field8131;
    }

    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IB)I", line = 40)
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "(Lqea;)V", line = 57)
    public class60(class339 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!sv", name = "b", descriptor = "(II)V", line = 77)
    ...
    @OriginalMember(owner = "client!sv", name = "d", descriptor = "(I)Z", line = 87)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(I)I", line = 102)
    public final int method45(int arg0) {
        ++field866;
        return arg0 != 8976 ? 50 : 0;
    }

    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IILrp;III)Ljava/awt/Frame;", line = 116)
