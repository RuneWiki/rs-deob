...
public class class60 {
    ...
    @OriginalMember(owner = "client!WLTAOGXS", name = "o", descriptor = "LGHIPAIQX;")
    private class20 field1569;

    @OriginalMember(owner = "client!WLTAOGXS", name = "b", descriptor = "LLYKGAWTC;")
    private class37 field1556;

    @OriginalMember(owner = "client!WLTAOGXS", name = "c", descriptor = "LLYKGAWTC;")
    private class37 field1557;

    @OriginalMember(owner = "client!WLTAOGXS", name = "d", descriptor = "LLYKGAWTC;")
    private class37 field1558;

    @OriginalMember(owner = "client!WLTAOGXS", name = "e", descriptor = "LLYKGAWTC;")
    private class37 field1559;

    @OriginalMember(owner = "client!WLTAOGXS", name = "f", descriptor = "LLYKGAWTC;")
    private class37 field1560;

    @OriginalMember(owner = "client!WLTAOGXS", name = "g", descriptor = "LLYKGAWTC;")
    private class37 field1561;

    @OriginalMember(owner = "client!WLTAOGXS", name = "h", descriptor = "LLYKGAWTC;")
    private class37 field1562;

    @OriginalMember(owner = "client!WLTAOGXS", name = "i", descriptor = "LLYKGAWTC;")
    private class37 field1563;

    @OriginalMember(owner = "client!WLTAOGXS", name = "p", descriptor = "LLYKGAWTC;")
    ...
    @OriginalMember(owner = "client!WLTAOGXS", name = "a", descriptor = "(BLGLMIQHJI;)V")
