...
public class class60 {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(ZII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(II)Z", line = 38)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(ZLig;)Lvr;", line = 50)
    ...
    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(I)V", line = 85)
