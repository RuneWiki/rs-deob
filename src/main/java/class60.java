...
public class class60 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Lae;Ljava/lang/String;IIIZ)V")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Lae;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(Lae;IZLjava/awt/Component;)V")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Lae;Ljava/lang/String;[IIIIZ)V")
