...
public class class60 {
    ...
    @OriginalMember(owner = "client!WHKCNEXD", name = "w", descriptor = "LWMYPWVZI;")
    ...
    @OriginalMember(owner = "client!WHKCNEXD", name = "K", descriptor = "LIMUIZRAF;")
    private static class24 field1561;

    @OriginalMember(owner = "client!WHKCNEXD", name = "d", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!WHKCNEXD", name = "B", descriptor = "[LWHKCNEXD;")
    ...
    @OriginalMember(owner = "client!WHKCNEXD", name = "a", descriptor = "(LBYZSQZUF;)V")
    ...
    @OriginalMember(owner = "client!WHKCNEXD", name = "b", descriptor = "(I)LWHKCNEXD;")
    ...
    @OriginalMember(owner = "client!WHKCNEXD", name = "a", descriptor = "([IZII)LYABPKWWG;")
    ...
    @OriginalMember(owner = "client!WHKCNEXD", name = "d", descriptor = "(I)LWHKCNEXD;")
    ...
    @OriginalMember(owner = "client!WHKCNEXD", name = "a", descriptor = "(B)LYABPKWWG;")
    ...
    @OriginalMember(owner = "client!WHKCNEXD", name = "a", descriptor = "(ILIMUIZRAF;)V")
