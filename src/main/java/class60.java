...
@OriginalClass("client!XAYNDIOJ")
public class class60 {

    @OriginalMember(owner = "client!XAYNDIOJ", name = "a", descriptor = "B")
    private byte field1469 = 44;

    @OriginalMember(owner = "client!XAYNDIOJ", name = "d", descriptor = "I")
    public int field1472 = -1;

    @OriginalMember(owner = "client!XAYNDIOJ", name = "f", descriptor = "[I")
    public int[] field1474 = new int[6];

    @OriginalMember(owner = "client!XAYNDIOJ", name = "g", descriptor = "[I")
    public int[] field1475 = new int[6];

    @OriginalMember(owner = "client!XAYNDIOJ", name = "h", descriptor = "[I")
    public int[] field1476 = new int[] { -1, -1, -1, -1, -1 };

    @OriginalMember(owner = "client!XAYNDIOJ", name = "i", descriptor = "Z")
    public boolean field1477 = false;

    @OriginalMember(owner = "client!XAYNDIOJ", name = "b", descriptor = "I")
    public static int field1470;

    @OriginalMember(owner = "client!XAYNDIOJ", name = "e", descriptor = "[I")
    public int[] field1473;

    @OriginalMember(owner = "client!XAYNDIOJ", name = "c", descriptor = "[LXAYNDIOJ;")
    public static class60[] field1471;

    @OriginalMember(owner = "client!XAYNDIOJ", name = "a", descriptor = "(LOTSGNSQM;Z)V")
    ...
    @OriginalMember(owner = "client!XAYNDIOJ", name = "a", descriptor = "(BLYOXDZEVD;)V")
    ...
    @OriginalMember(owner = "client!XAYNDIOJ", name = "a", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!XAYNDIOJ", name = "a", descriptor = "(Z)LOIBEFFXI;")
    ...
    @OriginalMember(owner = "client!XAYNDIOJ", name = "b", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!XAYNDIOJ", name = "c", descriptor = "(I)LOIBEFFXI;")
    ...
    @OriginalMember(owner = "client!XAYNDIOJ", name = "<init>", descriptor = "()V")
    public class60() {
