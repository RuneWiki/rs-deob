...
public abstract class class60 {
    ...
    @OriginalMember(owner = "client!vg", name = "<init>", descriptor = "(Lhd;)V")
    public class60(class773 arg0) {
        this.field798 = arg0;
        this.field799 = this.method405(false);
    }

    @OriginalMember(owner = "client!vg", name = "<init>", descriptor = "(ILhd;)V")
    public class60(int arg0, class773 arg1) {
        this.field799 = arg0;
        this.field798 = arg1;
    }

    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IBLgda;Lfs;)V")
