...
public class class60 extends class436 {
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(IILeb;)V", line = 17)
    ...
    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "()V", line = 193)
    public class60() {
        super(1, false);
    }

    @OriginalMember(owner = "client!bm", name = "b", descriptor = "(II)[[I", line = 68)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(II)[I", line = 135)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(B[I[Ljava/lang/Object;)V", line = 182)
