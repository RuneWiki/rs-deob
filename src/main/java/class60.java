...
public abstract class class60 {
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(III)V", line = 35)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Lok;ZLok;Lok;Lok;)V", line = 52)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IB)V", line = 74)
