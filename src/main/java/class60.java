...
public class class60 {
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(II)I", line = 21)
    public static int method339(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(III)Z", line = 33)
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(II)I", line = 60)
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "([I)V", line = 88)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(B)V", line = 124)
