...
public class class60 extends class646 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Lek;IB)V", line = 11)
    ...
    @OriginalMember(owner = "client!nn", name = "b", descriptor = "(IB)[I", line = 57)
    ...
    @OriginalMember(owner = "client!nn", name = "d", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!nn", name = "c", descriptor = "(I)V", line = 147)
