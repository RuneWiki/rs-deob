...
public class class60 extends class71 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(III)Lba;")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ILvg;IB)V")
