...
public class class60 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Ljava/net/Socket;II)Lhp;", line = 20)
    ...
    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(I)Z", line = 31)
    ...
    @OriginalMember(owner = "client!tn", name = "toString", descriptor = "()Ljava/lang/String;", line = 52)
    public final String toString() {
        field741++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(BLhj;)V", line = 60)
    ...
    @OriginalMember(owner = "client!tn", name = "c", descriptor = "(I)I", line = 103)
    ...
    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "(II)V", line = 117)
