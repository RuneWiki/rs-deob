...
public class class60 {
    ...
    @OriginalMember(owner = "client!VLUKUYNM", name = "c", descriptor = "LOWNYSRQV;")
    public class54 field1338 = new class54();

    @OriginalMember(owner = "client!VLUKUYNM", name = "d", descriptor = "LOWNYSRQV;")
    ...
    @OriginalMember(owner = "client!VLUKUYNM", name = "a", descriptor = "(LOWNYSRQV;)V")
    ...
    @OriginalMember(owner = "client!VLUKUYNM", name = "a", descriptor = "(LOWNYSRQV;I)V")
    ...
    @OriginalMember(owner = "client!VLUKUYNM", name = "a", descriptor = "()LOWNYSRQV;")
    ...
    @OriginalMember(owner = "client!VLUKUYNM", name = "b", descriptor = "()LOWNYSRQV;")
    ...
    @OriginalMember(owner = "client!VLUKUYNM", name = "a", descriptor = "(I)LOWNYSRQV;")
    ...
    @OriginalMember(owner = "client!VLUKUYNM", name = "b", descriptor = "(I)LOWNYSRQV;")
    ...
    @OriginalMember(owner = "client!VLUKUYNM", name = "c", descriptor = "(I)LOWNYSRQV;")
