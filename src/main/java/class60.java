...
public class class60 extends class62 {
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "()V", line = 157)
    public class60() {
        super(1, true);
    }

    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Lgw;II)V", line = 41)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(IIZIIILkda;)V", line = 83)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Z)V", line = 110)
    ...
    @OriginalMember(owner = "client!qh", name = "g", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!qh", name = "h", descriptor = "(I)V", line = 137)
    ...
    @OriginalMember(owner = "client!qh", name = "c", descriptor = "(II)[I", line = 160)
