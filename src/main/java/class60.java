...
public class class60 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(BLj;)V")
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(B)Lj;")
    ...
    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(B)Lj;")
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(I)Lj;")
    ...
    @OriginalMember(owner = "client!tn", name = "e", descriptor = "(B)Lj;")
