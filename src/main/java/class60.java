...
public class class60 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lbu;IZIZII)V", line = 10)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Z)V", line = 30)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(I)V", line = 53)
