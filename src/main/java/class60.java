...
public class class60 {
    ...
    @OriginalMember(owner = "client!UKVGEEAO", name = "a", descriptor = "LPFXCFGDE;")
    ...
    @OriginalMember(owner = "client!UKVGEEAO", name = "a", descriptor = "(LPFXCFGDE;)V")
    ...
    @OriginalMember(owner = "client!UKVGEEAO", name = "b", descriptor = "(LPFXCFGDE;)V")
    ...
    @OriginalMember(owner = "client!UKVGEEAO", name = "c", descriptor = "(LPFXCFGDE;)B")
    private static byte method528(class43 arg0) {
        return (byte) method530(8, arg0);
    }

    @OriginalMember(owner = "client!UKVGEEAO", name = "d", descriptor = "(LPFXCFGDE;)B")
    private static byte method529(class43 arg0) {
        return (byte) method530(1, arg0);
    }

    @OriginalMember(owner = "client!UKVGEEAO", name = "a", descriptor = "(ILPFXCFGDE;)I")
    ...
    @OriginalMember(owner = "client!UKVGEEAO", name = "e", descriptor = "(LPFXCFGDE;)V")
