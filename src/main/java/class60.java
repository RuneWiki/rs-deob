...
public class class60 implements class422 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(B)Lvj;", line = 18)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 29)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(I)I", line = 41)
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(Lpu;Ljava/lang/String;)V", line = 69)
    public class60(class522 arg0, String arg1) {
        this.field1144 = arg1;
        this.field1138 = arg0;
    }

    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IIBLde;Lqaa;)V", line = 81)
