...
public class class60 extends class35 implements class90 {
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(Lom;Llw;II[BII)V", line = 3)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(I[IIIIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(B)I", line = 42)
    public final int method588(byte arg0) {
        ++field939;
        return arg0 != 21 ? -88 : this.field932;
    }

    @OriginalMember(owner = "client!in", name = "b", descriptor = "(B)Z", line = 53)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IF)F", line = 64)
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(Lom;Llw;II[FII)V", line = 75)
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(Lom;Llw;Lal;II)V", line = 89)
    ...
    @OriginalMember(owner = "client!in", name = "b", descriptor = "(IF)F", line = 102)
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(Lom;II[III)V", line = 119)
    ...
    @OriginalMember(owner = "client!in", name = "d", descriptor = "(I)[Lfe;", line = 135)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Z)I", line = 148)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ILlw;IIIIII[B)V", line = 160)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IBII[III)V", line = 187)
    ...
    @OriginalMember(owner = "client!in", name = "e", descriptor = "(B)V", line = 210)
    public static void method596(byte arg0) {
        field933 = null;
        int var1 = -75 / ((arg0 - -2) / 58);
    }

    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IZZ)V", line = 219)
