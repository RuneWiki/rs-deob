...
public class class60 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 16)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(II)Z", line = 51)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;B)Ljava/lang/String;", line = 62)
