...
public abstract class class60 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([II[Lhu;Ljava/lang/String;IIIBLjava/util/Random;I)I")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([ILjava/util/Random;I[Lhu;[IIIIILjava/lang/String;IIIII)I")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I[II[ILjava/lang/String;I[Lhu;[I)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I[Lhu;IIIIII[IIILaa;IIIILjava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IZIILjava/lang/String;I[Lhu;[ILaa;)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IILaa;Ljava/lang/String;I[IIIIIII[Lhu;III)I")
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lha;Lrc;)V")
    public class60(class59 arg0, class539 arg1) {
        this.field747 = arg1;
        this.field735 = arg0;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "([IIZLjava/lang/String;III[Lhu;)V")
