...
public class class60 {
    ...
    @OriginalMember(owner = "client!in", name = "b", descriptor = "(II)Lcm;")
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ILhd;Lhd;)V")
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Lga;Lya;IIIII)V")
    ...
    @OriginalMember(owner = "client!in", name = "c", descriptor = "(II)Lid;")
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(Lae;ILqn;Lqn;Lqn;)V")
