...
public class class60 {
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(ZLjava/lang/String;IZLtd;Ljava/lang/String;)V", line = 4)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(II)I", line = 69)
    public static final int method403(int arg0, int arg1) {
        return class721.field9985 == null ? 0 : class721.field9985[arg0][arg1] & 0xFFFF;
    }

    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(B)V", line = 72)
    ...
    @OriginalMember(owner = "client!vg", name = "b", descriptor = "(B)V", line = 109)
