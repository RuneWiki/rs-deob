...
public class class60 extends class148 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!tt", name = "e", descriptor = "(I)V", line = 19)
    public static void method357(int arg0) {
        int var1 = -71 / ((-2 - arg0) / 47);
        field891 = null;
    }

    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ILdh;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!tt", name = "e", descriptor = "(B)V", line = 106)
    ...
    @OriginalMember(owner = "client!tt", name = "<init>", descriptor = "()V", line = 137)
    public class60() {
        super(0, true);
    }

    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(II)[I", line = 169)
