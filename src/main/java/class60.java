...
public class class60 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IIIIIZ)V", line = 11)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(I)V", line = 201)
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(I)V", line = 214)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ZI)Lom;", line = 229)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IIIIIIIIII)V", line = 257)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(II)V", line = 274)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(B)V", line = 288)
    ...
    @OriginalMember(owner = "client!tt", name = "<init>", descriptor = "(Lrb;ILpc;)V", line = 317)
