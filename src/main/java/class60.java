...
public class class60 {
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IILsm;)V")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ILrg;)V")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IBLrg;)V")
