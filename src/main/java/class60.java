...
public class class60 extends class386 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Llu;IIIIIIIIIIIZZ)V", line = 11)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(J)V", line = 31)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(JI)V", line = 159)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "()V", line = 554)
    ...
    @OriginalMember(owner = "client!wr", name = "b", descriptor = "()V", line = 565)
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(Llu;IIIIIIIIIIIZZ)V", line = 571)
