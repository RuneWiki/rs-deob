...
public class class60 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "()Lar;")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Lgp;II)Lmn;")
    ...
    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "(Lco;)V")
