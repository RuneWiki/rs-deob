...
@OriginalClass("client!UMTLOYSA")
public class class60 {

    @OriginalMember(owner = "client!UMTLOYSA", name = "a", descriptor = "Z")
    private boolean field1414 = false;

    @OriginalMember(owner = "client!UMTLOYSA", name = "b", descriptor = "I")
    private int field1415 = 534;

    @OriginalMember(owner = "client!UMTLOYSA", name = "c", descriptor = "LBIJRHVKA;")
    public class8 field1416 = new class8();

    @OriginalMember(owner = "client!UMTLOYSA", name = "d", descriptor = "LBIJRHVKA;")
    private class8 field1417;

    @OriginalMember(owner = "client!UMTLOYSA", name = "<init>", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!UMTLOYSA", name = "a", descriptor = "(LBIJRHVKA;)V")
    ...
    @OriginalMember(owner = "client!UMTLOYSA", name = "a", descriptor = "()LBIJRHVKA;")
    ...
    @OriginalMember(owner = "client!UMTLOYSA", name = "b", descriptor = "()LBIJRHVKA;")
    ...
    @OriginalMember(owner = "client!UMTLOYSA", name = "a", descriptor = "(I)LBIJRHVKA;")
    ...
    @OriginalMember(owner = "client!UMTLOYSA", name = "c", descriptor = "()I")
