...
public class class60 extends class210 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lat;B)Lwq;", line = 3)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IIIB)V", line = 14)
    ...
    @OriginalMember(owner = "client!f", name = "g", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IB)[I", line = 37)
    ...
    @OriginalMember(owner = "client!f", name = "h", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!f", name = "d", descriptor = "(III)Lhl;", line = 131)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IILat;)V", line = 145)
    ...
    @OriginalMember(owner = "client!f", name = "<init>", descriptor = "()V", line = 206)
    public class60() {
        super(0, true);
    }

    @OriginalMember(owner = "client!f", name = "e", descriptor = "(I)V", line = 198)
