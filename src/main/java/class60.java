...
@OriginalClass("client!XMRRKSSB")
public class class60 {

    @OriginalMember(owner = "client!XMRRKSSB", name = "a", descriptor = "Z")
    private boolean field1490 = false;

    @OriginalMember(owner = "client!XMRRKSSB", name = "c", descriptor = "I")
    public int field1492;

    @OriginalMember(owner = "client!XMRRKSSB", name = "h", descriptor = "Z")
    private boolean field1497;

    @OriginalMember(owner = "client!XMRRKSSB", name = "b", descriptor = "[B")
    public byte[] field1491;

    @OriginalMember(owner = "client!XMRRKSSB", name = "d", descriptor = "[I")
    public int[] field1493;

    @OriginalMember(owner = "client!XMRRKSSB", name = "e", descriptor = "[I")
    public int[] field1494;

    @OriginalMember(owner = "client!XMRRKSSB", name = "f", descriptor = "[I")
    public int[] field1495;

    @OriginalMember(owner = "client!XMRRKSSB", name = "g", descriptor = "[I")
    public int[] field1496;

    @OriginalMember(owner = "client!XMRRKSSB", name = "<init>", descriptor = "([BI)V")
    public class60(byte[] arg0, int arg1) {
        int var3 = 17 / arg1;
        this.method464(arg0, false);
    }

    @OriginalMember(owner = "client!XMRRKSSB", name = "a", descriptor = "([BZ)V")
    ...
    @OriginalMember(owner = "client!XMRRKSSB", name = "a", descriptor = "(Ljava/lang/String;[B)[B")
