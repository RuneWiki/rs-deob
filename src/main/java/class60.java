...
@OriginalClass("client!VPISXBMB")
public class class60 {

    @OriginalMember(owner = "client!VPISXBMB", name = "a", descriptor = "I")
    private static int field1414 = -742;

    @OriginalMember(owner = "client!VPISXBMB", name = "c", descriptor = "I")
    public int field1416;

    @OriginalMember(owner = "client!VPISXBMB", name = "e", descriptor = "I")
    public int field1418;

    @OriginalMember(owner = "client!VPISXBMB", name = "d", descriptor = "LPCSJGLYB;")
    public class38 field1417;

    @OriginalMember(owner = "client!VPISXBMB", name = "f", descriptor = "[I")
    public int[] field1419;

    @OriginalMember(owner = "client!VPISXBMB", name = "g", descriptor = "[I")
    public int[] field1420;

    @OriginalMember(owner = "client!VPISXBMB", name = "h", descriptor = "[I")
    public int[] field1421;

    @OriginalMember(owner = "client!VPISXBMB", name = "i", descriptor = "[I")
    public int[] field1422;

    @OriginalMember(owner = "client!VPISXBMB", name = "b", descriptor = "[LVPISXBMB;")
    private static class60[] field1415;

    @OriginalMember(owner = "client!VPISXBMB", name = "j", descriptor = "[Z")
    private static boolean[] field1423;

    @OriginalMember(owner = "client!VPISXBMB", name = "a", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!VPISXBMB", name = "a", descriptor = "(I[B)V")
    ...
    @OriginalMember(owner = "client!VPISXBMB", name = "a", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!VPISXBMB", name = "a", descriptor = "(II)LVPISXBMB;")
    ...
    @OriginalMember(owner = "client!VPISXBMB", name = "b", descriptor = "(II)Z")
