...
public class class60 implements class386 {
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Lrc;BI)V")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IILgi;II)V")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BIILgi;)V")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(III)Lbp;")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ZLbd;II)V")
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Lpg;)V")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IILbd;)V")
