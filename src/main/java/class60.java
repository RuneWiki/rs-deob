...
public class class60 extends class376 implements class322 {
    ...
    @OriginalMember(owner = "client!fw", name = "c", descriptor = "(I)I", line = 8)
    ...
    @OriginalMember(owner = "client!fw", name = "b", descriptor = "(I)J", line = 20)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(I)I", line = 31)
    ...
    @OriginalMember(owner = "client!fw", name = "d", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!fw", name = "<init>", descriptor = "(Lvf;I[BIZ)V", line = 54)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(IIZ[B)V", line = 66)
    ...
    @OriginalMember(owner = "client!fw", name = "e", descriptor = "(I)V", line = 79)
