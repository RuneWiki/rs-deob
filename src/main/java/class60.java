...
public abstract class class60 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lqa;)V", line = 6)
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(Z)V", line = 89)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(III)V", line = 104)
