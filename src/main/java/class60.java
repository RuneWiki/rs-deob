...
public class class60 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IBIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(BILha;IIIIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!am", name = "<init>", descriptor = "(I[Ldw;IIII)V", line = 277)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IBLha;)Z", line = 111)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(B)V", line = 187)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "([BI)[B", line = 216)
