...
public class class60 extends class211 {
    ...
    @OriginalMember(owner = "client!vg", name = "g", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(BILib;)V", line = 41)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(ZI)I", line = 84)
    ...
    @OriginalMember(owner = "client!vg", name = "<init>", descriptor = "()V", line = 386)
    public class60() {
        super(0, true);
    }

    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!vg", name = "b", descriptor = "(II)[I", line = 141)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "()V", line = 260)
    ...
    @OriginalMember(owner = "client!vg", name = "c", descriptor = "(I)V", line = 335)
    ...
    @OriginalMember(owner = "client!vg", name = "h", descriptor = "(I)V", line = 348)
