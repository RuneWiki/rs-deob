...
public class class60 extends class238 {
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(BZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IIIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!sh", name = "e", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(Lmh;II[BI)V", line = 96)
