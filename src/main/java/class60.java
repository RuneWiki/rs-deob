...
public class class60 extends class270 {
    ...
    @OriginalMember(owner = "client!hl", name = "b", descriptor = "(BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "()V", line = 694)
    public class60() {
        super(0, true);
    }

    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Ljava/util/Random;II[[IIII)V", line = 47)
    ...
    @OriginalMember(owner = "client!hl", name = "f", descriptor = "(I)V", line = 247)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 257)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(BLec;I)V", line = 311)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(BI)[I", line = 413)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Z)V", line = 671)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IZIILmb;)V", line = 697)
