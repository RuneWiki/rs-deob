...
public class class60 {
    ...
    @OriginalMember(owner = "client!XWMRKIHQ", name = "d", descriptor = "[LMRGQMKFG;")
    ...
    @OriginalMember(owner = "client!XWMRKIHQ", name = "a", descriptor = "(J)LMRGQMKFG;")
    ...
    @OriginalMember(owner = "client!XWMRKIHQ", name = "a", descriptor = "(BLMRGQMKFG;J)V")
