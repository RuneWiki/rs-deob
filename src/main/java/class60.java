...
public abstract class class60 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Lmi;[II[I[IILjava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILjava/lang/String;BIII[Lmi;[I)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([IIBLaa;I[Lmi;IIIILjava/lang/String;IIIIII)I")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II)Lat;")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II[ILjava/lang/String;II[Lmi;IILjava/util/Random;)I")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lbga;[Lifa;I)Llha;")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(III[Lmi;Laa;Ljava/lang/String;[III)V")
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lha;Loea;)V")
    public class60(class59 arg0, class597 arg1) {
        this.field1193 = arg1;
        this.field1178 = arg0;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "([III[Lmi;IIILaa;IIIIIZILjava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([II[Lmi;IIIILjava/util/Random;IIIIILjava/lang/String;[I)I")
