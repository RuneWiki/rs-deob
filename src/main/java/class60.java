...
public abstract class class60 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(BILjava/awt/Canvas;Ld;ILni;II)Lha;", line = 8)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIII[II)Lufa;", line = 65)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIII)V", line = 89)
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(IIIII)V", line = 110)
    ...
    @OriginalMember(owner = "client!ha", name = "c", descriptor = "(IIIII)V", line = 124)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIIBI)V", line = 142)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ILufa;)V", line = 156)
    ...
    @OriginalMember(owner = "client!ha", name = "finalize", descriptor = "()V", line = 170)
    protected void finalize() {
        this.method342(-1);
        field635++;
    }

    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ZIIIII)V", line = 203)
    ...
    @OriginalMember(owner = "client!ha", name = "<init>", descriptor = "(Ld;)V", line = 219)
    ...
    @OriginalMember(owner = "client!ha", name = "c", descriptor = "(Z)V", line = 250)
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(IIIIII)V", line = 265)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "([Ljava/awt/Rectangle;II)V", line = 291)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ILji;)Luk;", line = 303)
