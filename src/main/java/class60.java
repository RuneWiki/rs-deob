...
public class class60 extends class443 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(ILjava/lang/String;I)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(ILfb;)V", line = 28)
    ...
    @OriginalMember(owner = "client!go", name = "d", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(III)I", line = 60)
    ...
    @OriginalMember(owner = "client!go", name = "c", descriptor = "(Z)V", line = 80)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(ZI)V", line = 165)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Lfb;II)V", line = 233)
    ...
    @OriginalMember(owner = "client!go", name = "e", descriptor = "(B)V", line = 278)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Lie;B)V", line = 298)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IIIZIIII)V", line = 1355)
