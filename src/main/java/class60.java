...
public class class60 implements Runnable {
    ...
    @OriginalMember(owner = "client!UFCPVKNJ", name = "h", descriptor = "LKWRIFYWM;")
    ...
    @OriginalMember(owner = "client!UFCPVKNJ", name = "<init>", descriptor = "(ILjava/net/Socket;LKWRIFYWM;)V")
