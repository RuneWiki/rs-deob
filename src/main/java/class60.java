...
public class class60 extends class114 implements class371 {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Lqa;La;IIIII)V")
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(Lnq;III)V")
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(Lnq;IIII)V")
