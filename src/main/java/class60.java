...
public class class60 extends class90 implements class503 {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ILya;)V", line = 4)
    ...
    @OriginalMember(owner = "client!in", name = "b", descriptor = "(IB)V", line = 31)
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(Lya;Ljo;IIIIZIIZ)V", line = 46)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Lya;B)Lmf;", line = 82)
    ...
    @OriginalMember(owner = "client!in", name = "b", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!in", name = "b", descriptor = "(ILya;)V", line = 124)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Lya;II)Lt;", line = 157)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(BLya;I)Lt;", line = 182)
    ...
    @OriginalMember(owner = "client!in", name = "c", descriptor = "(I)Z", line = 193)
    ...
    @OriginalMember(owner = "client!in", name = "d", descriptor = "(I)I", line = 207)
    ...
    @OriginalMember(owner = "client!in", name = "i", descriptor = "(I)V", line = 219)
    ...
    @OriginalMember(owner = "client!in", name = "f", descriptor = "(I)Z", line = 232)
    ...
    @OriginalMember(owner = "client!in", name = "c", descriptor = "(ILya;)V", line = 244)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IZLya;I)Lso;", line = 254)
    ...
    @OriginalMember(owner = "client!in", name = "h", descriptor = "(I)V", line = 286)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(I)I", line = 300)
    ...
    @OriginalMember(owner = "client!in", name = "c", descriptor = "(IB)Lem;", line = 311)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Lya;IZLij;III)V", line = 339)
    ...
    @OriginalMember(owner = "client!in", name = "e", descriptor = "(I)I", line = 372)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ZILya;I)Z", line = 392)
