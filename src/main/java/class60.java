...
public class class60 extends class26 {
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Lnm;IIZ[[I)V", line = 5)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(III)V", line = 38)
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Lnm;II)V", line = 42)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "()V", line = 59)
    public final void method309() {
        this.field329.field3648.glFramebufferTexture2DEXT(36160, this.field831, 3553, 0, 0);
        this.field831 = -1;
    }

    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Lnm;IIZ[[BI)V", line = 65)
