...
public class class657 {
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!oda", name = "<init>", descriptor = "(I)V", line = 52)
