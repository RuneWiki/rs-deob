...
public class class657 extends class319 {
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(Lha;Lwea;ZIIII)V")
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(Lha;IZI)Lka;")
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(IIILha;)Z")
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(ILha;)Ldfa;")
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(Lha;B)Lel;")
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(ILka;Luu;Lha;)V")
