...
public abstract class class657 implements class317 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ip", name = "b", descriptor = "(I)I", line = 26)
    ...
    @OriginalMember(owner = "client!ip", name = "c", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(BZ)V", line = 53)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(II)V", line = 74)
    ...
    @OriginalMember(owner = "client!ip", name = "b", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!ip", name = "finalize", descriptor = "()V", line = 102)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Z)I", line = 112)
    ...
    @OriginalMember(owner = "client!ip", name = "d", descriptor = "(I)Z", line = 132)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ZI)V", line = 156)
    ...
    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "(Lok;IIIZ)V", line = 201)
