...
public class class657 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IBIIIIIIII)Z", line = 6)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(B)V", line = 641)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IIIIF[F[FIIIIF)V", line = 652)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IB)Z", line = 711)
