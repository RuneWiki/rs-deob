...
public class class657 extends class601 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lee;BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!fj", name = "e", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!fj", name = "f", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "()V", line = 99)
    public class657() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(BI)[I", line = 109)
