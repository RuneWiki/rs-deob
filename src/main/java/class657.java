...
public class class657 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(I[JII[I)V", line = 15)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(BI)Z", line = 71)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IB)[I", line = 83)
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(I)V", line = 104)
