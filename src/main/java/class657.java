...
public class class657 extends class214 {
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "()V", line = 31)
    public class657() {
        super(0, true);
    }

    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(ILofa;I)V", line = 35)
    ...
    @OriginalMember(owner = "client!tb", name = "e", descriptor = "(B)V", line = 107)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IIIII[B)V", line = 126)
    ...
    @OriginalMember(owner = "client!tb", name = "c", descriptor = "(II)[[I", line = 155)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(B[[I)V", line = 217)
