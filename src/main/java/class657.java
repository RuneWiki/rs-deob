...
public class class657 extends class398 {
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "(Luca;)V")
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(ILdu;Ldu;)V")
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(ILvaa;B)V")
