...
public class class657 {
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IIIIII)V", line = 114)
    ...
    @OriginalMember(owner = "client!dv", name = "b", descriptor = "(I)V", line = 220)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(JB)V", line = 233)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IZIIZ)V", line = 260)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Lkha;BJ)V", line = 526)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IJ)Lkha;", line = 556)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(ZI)I", line = 578)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(B)V", line = 685)
    ...
    @OriginalMember(owner = "client!dv", name = "<init>", descriptor = "(I)V", line = 731)
