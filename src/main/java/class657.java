...
public abstract class class657 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Lec;I)V")
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(Lffa;)V")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(I[Lcn;IIZI)V")
