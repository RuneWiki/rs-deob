...
public class class657 extends class502 {
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(II)I", line = 6)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!pda", name = "b", descriptor = "(I)Z", line = 52)
    ...
    @OriginalMember(owner = "client!pda", name = "c", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(IZ)V", line = 82)
    ...
    @OriginalMember(owner = "client!pda", name = "<init>", descriptor = "(Leka;)V", line = 105)
    public class657(class492 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!pda", name = "c", descriptor = "(B)I", line = 108)
    ...
    @OriginalMember(owner = "client!pda", name = "<init>", descriptor = "(ILeka;)V", line = 121)
    public class657(int arg0, class492 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!pda", name = "c", descriptor = "(II)V", line = 124)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(I)I", line = 135)
