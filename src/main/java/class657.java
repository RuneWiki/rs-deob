...
public class class657 extends class504 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(II)V", line = 13)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IIIFI)V", line = 44)
    ...
    @OriginalMember(owner = "client!gn", name = "b", descriptor = "(II)V", line = 157)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(I[II)V", line = 177)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(BI)V", line = 300)
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(Lsm;IIIII)V", line = 312)
