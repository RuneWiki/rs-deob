...
public class class657 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IZ)I", line = 9)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Ljava/lang/String;II)Z", line = 53)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(I)V", line = 119)
