...
public class class657 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Ln;BII)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IILuq;)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Ldda;ZI[B)Lav;")
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "(Lkga;Lcu;Lsm;IIIII)V")
