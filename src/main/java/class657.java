...
public class class657 extends class751 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IIB)Z", line = 27)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(II)[I", line = 47)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ILrv;I)V", line = 103)
    ...
    @OriginalMember(owner = "client!am", name = "c", descriptor = "(III)Z", line = 181)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IIIIII)V", line = 211)
    ...
    @OriginalMember(owner = "client!am", name = "c", descriptor = "(I)V", line = 271)
