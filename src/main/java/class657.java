...
public class class657 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(B)[Lnk;", line = 21)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(IIILva;IILva;III)V", line = 32)
    ...
    @OriginalMember(owner = "client!nk", name = "toString", descriptor = "()Ljava/lang/String;", line = 89)
    public final String toString() {
        field9246++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(IILps;)V", line = 111)
