...
public class class657 extends class477 {
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "()V", line = 3)
    public class657() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(BI)Lvp;", line = 6)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(BII)I", line = 21)
    ...
    @OriginalMember(owner = "client!qs", name = "e", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IIII)[B", line = 51)
    ...
    @OriginalMember(owner = "client!qs", name = "b", descriptor = "(IIB)V", line = 66)
