...
public class class433 {
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "([Ljava/lang/String;Z)[Ljava/lang/String;", line = 55)
