...
public class class433 extends class275 {
    ...
    @OriginalMember(owner = "client!g", name = "b", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(IB)Z", line = 30)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Z)V", line = 54)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(III)V", line = 253)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Lnr;BII)Z", line = 273)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Loq;III)V", line = 308)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Lro;III)V", line = 338)
