...
public class class433 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(BLfca;Laca;)Lev;")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(BII)Z")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Lfca;I)V")
