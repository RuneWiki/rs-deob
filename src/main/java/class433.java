...
public abstract class class433 extends class263 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!bg", name = "b", descriptor = "(I)I", line = 25)
    ...
    @OriginalMember(owner = "client!bg", name = "d", descriptor = "(I)I", line = 37)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IIIIIII)V", line = 49)
    ...
    @OriginalMember(owner = "client!bg", name = "e", descriptor = "(I)Z", line = 71)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(II)V", line = 90)
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(Ljaa;)V", line = 105)
