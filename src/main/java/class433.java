...
public class class433 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(B[Lkp;)I", line = 14)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(I)I", line = 45)
    ...
    @OriginalMember(owner = "client!wa", name = "b", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!wa", name = "c", descriptor = "(I)I", line = 91)
    ...
    @OriginalMember(owner = "client!wa", name = "d", descriptor = "(I)Lkp;", line = 125)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Lvg;III)V", line = 156)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(ZJ)Lkp;", line = 179)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Lkp;JI)V", line = 211)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 232)
    ...
    @OriginalMember(owner = "client!wa", name = "<init>", descriptor = "(I)V", line = 247)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Z)Lkp;", line = 269)
    ...
    @OriginalMember(owner = "client!wa", name = "e", descriptor = "(I)Lkp;", line = 286)
