...
public class class433 extends class349 {
    ...
    @OriginalMember(owner = "client!wa", name = "c", descriptor = "(III)Lud;")
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(I)Leh;")
    ...
    @OriginalMember(owner = "client!wa", name = "<init>", descriptor = "(ILoc;Loc;Loj;Lfn;IIZ)V")
