...
public abstract class class433 {
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(I)Z", line = 40)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Z)Z", line = 51)
    ...
    @OriginalMember(owner = "client!wk", name = "c", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!wk", name = "d", descriptor = "(I)V", line = 170)
