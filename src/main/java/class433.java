...
public class class433 {
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(Lpq;I)V", line = 12)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(Z)V", line = 43)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(Lkg;BI)V", line = 54)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(II)Lkaa;", line = 98)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 124)
    ...
    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(II)V", line = 136)
    ...
    @OriginalMember(owner = "client!sk", name = "<init>", descriptor = "(Luea;ILpq;)V", line = 154)
