...
public class class433 implements class171 {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(I)Lvm;", line = 4)
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(I)I", line = 15)
    ...
    @OriginalMember(owner = "client!ps", name = "c", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(Lwu;)V", line = 50)
    public class433(class557 arg0) {
        this.field5942 = arg0;
    }

    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(IILpaa;I)V", line = 62)
