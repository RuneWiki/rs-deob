...
public abstract class class433 implements class430 {
    ...
    @OriginalMember(owner = "client!ch", name = "finalize", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!ch", name = "d", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(I)I", line = 24)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(BIII)I", line = 45)
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(II)V", line = 86)
    ...
    @OriginalMember(owner = "client!ch", name = "c", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(II[FII)V", line = 122)
    ...
    @OriginalMember(owner = "client!ch", name = "c", descriptor = "(B)V", line = 216)
    ...
    @OriginalMember(owner = "client!ch", name = "d", descriptor = "(I)I", line = 246)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(I[IIII)V", line = 345)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lcba;I)V", line = 451)
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(Ldc;ILhi;Lne;IZ)V", line = 580)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(I[BIII)V", line = 481)
