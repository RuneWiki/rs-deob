...
public class class433 extends class431 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ZLhp;)V")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Ljs;I[[B)V")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(BI)Lhf;")
