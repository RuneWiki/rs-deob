...
public class class433 extends class683 {
    ...
    @OriginalMember(owner = "client!iaa", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(IIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 41)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(I)Z", line = 52)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 64)
