...
public class class433 extends class50 {
    ...
    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "(Lql;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "(Lql;II)V")
    ...
    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "(Lql;IIZ[[BI)V")
