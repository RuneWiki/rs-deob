...
public class class433 extends class305 {
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(ILfh;B)V", line = 7)
    ...
    @OriginalMember(owner = "client!r", name = "<init>", descriptor = "()V", line = 67)
    public class433() {
        super(0, true);
    }
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(II)[I", line = 95)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(B)V", line = 240)
