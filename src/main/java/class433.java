...
public class class433 extends class214 {
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "()V", line = 3)
    public class433() {
        super(1, true);
    }

    @OriginalMember(owner = "client!bs", name = "f", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IB)[I", line = 18)
