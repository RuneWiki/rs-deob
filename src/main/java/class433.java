...
public class class433 extends class465 {
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IZLfp;)Lsq;")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(FI)V")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IILag;)V")
