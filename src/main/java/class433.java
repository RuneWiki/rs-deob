...
public class class433 extends class309 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(BLve;)V", line = 7)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(Lve;)V", line = 31)
    ...
    @OriginalMember(owner = "client!vh", name = "g", descriptor = "(I)[F", line = 54)
    ...
    @OriginalMember(owner = "client!vh", name = "b", descriptor = "(III)V", line = 74)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IIIIII)V", line = 97)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(B)[F", line = 131)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(III)V", line = 153)
    ...
    @OriginalMember(owner = "client!vh", name = "f", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!vh", name = "c", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!vh", name = "e", descriptor = "(I)V", line = 190)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "()V", line = 215)
    ...
    @OriginalMember(owner = "client!vh", name = "b", descriptor = "(I)V", line = 225)
    ...
    @OriginalMember(owner = "client!vh", name = "b", descriptor = "()Lvh;", line = 257)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(III[I)V", line = 277)
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "()V", line = 284)
    public class433() {
        this.method1856();
    }

    @OriginalMember(owner = "client!vh", name = "a", descriptor = "([I)V", line = 295)
