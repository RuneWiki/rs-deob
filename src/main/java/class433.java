...
public class class433 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IIIIII)V", line = 38)
