...
public class class433 extends class585 {
    ...
    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(IIB)Z", line = 6)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Ljava/lang/String;ILtd;I)Lhu;", line = 25)
    ...
    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(III)Z", line = 37)
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "()V", line = 56)
    public class433() {
        super(0, true);
    }

    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(II)[I", line = 64)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lso;II)V", line = 116)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(I)V", line = 191)
    ...
    @OriginalMember(owner = "client!lg", name = "e", descriptor = "(B)V", line = 203)
    ...
    @OriginalMember(owner = "client!lg", name = "c", descriptor = "(I)Lqe;", line = 225)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IB)I", line = 264)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IZ)V", line = 284)
