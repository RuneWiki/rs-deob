...
public class class433 extends class179 {
    ...
    @OriginalMember(owner = "client!bc", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!bc", name = "d", descriptor = "(B)V", line = 115)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Lwo;Z)V", line = 128)
    ...
    @OriginalMember(owner = "client!bc", name = "c", descriptor = "(I)V", line = 143)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Laq;B)V", line = 159)
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "(Lps;)V", line = 213)
