...
public class class433 extends class551 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(CB)C", line = 3)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(B)Z", line = 408)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(B)V", line = 505)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(II)Z", line = 528)
    ...
    @OriginalMember(owner = "client!vq", name = "<init>", descriptor = "(I)V", line = 543)
    public class433(int arg0) {
        this.field6333 = arg0;
    }

    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(BI)Z", line = 551)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IIB)Z", line = 561)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(ZI)Z", line = 575)
    ...
    @OriginalMember(owner = "client!vq", name = "g", descriptor = "(I)V", line = 587)
