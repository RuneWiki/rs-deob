...
public class class433 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IIZ)B", line = 4)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(II[BI)Z", line = 36)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(B)I", line = 116)
    public static final int method2706(byte arg0) {
        field6190++;
        return arg0 == 88 ? 6 : 0;
    }

    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IIIIILni;IILvq;II)Lni;", line = 137)
