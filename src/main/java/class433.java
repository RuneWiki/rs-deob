...
public class class433 {
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(II)Lgea;", line = 120)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(Z)V", line = 154)
    ...
    @OriginalMember(owner = "client!vaa", name = "b", descriptor = "(II)V", line = 170)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(B)V", line = 186)
    ...
    @OriginalMember(owner = "client!vaa", name = "b", descriptor = "(Z)V", line = 198)
    ...
    @OriginalMember(owner = "client!vaa", name = "b", descriptor = "(B)V", line = 241)
    ...
    @OriginalMember(owner = "client!vaa", name = "<init>", descriptor = "(Lci;ILsea;)V", line = 256)
