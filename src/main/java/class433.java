...
public class class433 extends class80 {
    ...
    @OriginalMember(owner = "client!ou", name = "d", descriptor = "(I)V", line = 3)
    public static void method2599(int arg0) {
        int var1 = -24 / ((arg0 - 15) / 58);
        field6452 = null;
    }

    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(ILgh;)V", line = 13)
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "()V", line = 45)
    public class433() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ou", name = "e", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(II)[I", line = 60)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Ljv;IIBIIZ)V", line = 119)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(BIILjq;II)V", line = 177)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IILnn;)V", line = 309)
