...
public class class433 extends class190 {
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(FIIFIFIIIF[F)V", line = 7)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ILoi;Lza;Loi;)V", line = 135)
