...
public class class433 extends class699 {
    ...
    @OriginalMember(owner = "client!ip", name = "b", descriptor = "(ZLr;)V")
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Lr;I)Lsd;")
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ZLr;)Log;")
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Les;B)Lkk;")
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(IILr;I)Z")
