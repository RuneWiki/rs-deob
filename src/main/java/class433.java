...
public class class433 implements class369 {
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!maa", name = "toString", descriptor = "()Ljava/lang/String;", line = 18)
    public final String toString() {
        field6135++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(BLjava/util/Random;I)I", line = 37)
    ...
    @OriginalMember(owner = "client!maa", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 64)
