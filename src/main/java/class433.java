...
public class class433 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Los;Z)V")
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(ILvv;)V")
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IILos;)V")
