...
public class class433 {
    ...
    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "(I)V", line = 2)
    public class433(int arg0) {
        this.field6205 = (byte) arg0;
    }

    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(B)V", line = 27)
