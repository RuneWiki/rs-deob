...
public class class433 extends class125 {
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ZZILjava/lang/String;Lhga;)V", line = 19)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(B)I", line = 88)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(IB)V", line = 98)
    ...
    @OriginalMember(owner = "client!ps", name = "c", descriptor = "(Z)I", line = 130)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(Lgp;)V", line = 143)
    public class433(class549 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ps", name = "c", descriptor = "(I)Z", line = 149)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ZI)I", line = 167)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(ILgp;)V", line = 188)
    public class433(int arg0, class549 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(Z)V", line = 194)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(BI)V", line = 215)
