...
public class class433 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Ldca;ZILdca;I)Ltf;", line = 24)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ILdca;Ldca;B)Ltf;", line = 69)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Z)V", line = 86)
    ...
    @OriginalMember(owner = "client!rm", name = "c", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(I)Z", line = 142)
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(Lmo;Lqh;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", line = 225)
