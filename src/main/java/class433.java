...
public class class433 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(JZIII)Ljava/lang/String;", line = 26)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "()V", line = 106)
    public static final void method2666() {
        class425.method2617(1, class478.field7065);
    }

    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ILjk;Z)V", line = 112)
