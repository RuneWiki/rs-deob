...
public class class433 extends class739 {
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "([[[BIIBIZ[IIZ[IIII[II[I[II)V", line = 3)
    ...
    @OriginalMember(owner = "client!uba", name = "d", descriptor = "(Z)V", line = 450)
    ...
    @OriginalMember(owner = "client!uba", name = "<init>", descriptor = "()V", line = 465)
    public class433() {
        super(1, false);
    }

    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(II)[I", line = 470)
    ...
    @OriginalMember(owner = "client!uba", name = "e", descriptor = "(I)V", line = 559)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(Lsl;II)V", line = 579)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(BI)[[I", line = 623)
