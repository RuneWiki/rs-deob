...
public class class433 {
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lza;IIIIII)V")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lus;)V")
    ...
    @OriginalMember(owner = "client!us", name = "<init>", descriptor = "(Lza;Lsv;I)V")
