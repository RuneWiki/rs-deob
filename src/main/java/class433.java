...
public abstract class class433 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lha;Ljs;ILef;ZIIILsu;)V")
    ...
    @OriginalMember(owner = "client!lg", name = "c", descriptor = "(B)Lqha;")
    ...
    @OriginalMember(owner = "client!lg", name = "d", descriptor = "(B)Lu;")
    ...
    @OriginalMember(owner = "client!lg", name = "f", descriptor = "(I)Lhb;")
    ...
    @OriginalMember(owner = "client!lg", name = "c", descriptor = "(Z)Lgn;")
