...
public class class433 extends class464 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(III)Z", line = 20)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "([SI)[S", line = 39)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;Z)V", line = 56)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(I)F", line = 129)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Low;)V", line = 140)
    public static final void method2487(class780 arg0) {
        class108.field1468 = arg0;
    }

    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(B)F", line = 143)
    ...
    @OriginalMember(owner = "client!uh", name = "e", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(B)Ljava/lang/String;", line = 165)
    ...
    @OriginalMember(owner = "client!uh", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 176)
    public class433(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!uh", name = "f", descriptor = "(I)Ljava/lang/String;", line = 191)
