...
public class class433 {
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(C)V", line = 3)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "()V", line = 12)
    public final void method2590() {
        this.field6259.field3342.glEndList();
    }

    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "(Lic;I)V", line = 15)
