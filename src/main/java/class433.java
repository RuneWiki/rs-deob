...
public class class433 extends class75 {
    ...
    @OriginalMember(owner = "client!us", name = "c", descriptor = "(III)V", line = 7)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IIBLkh;I)V", line = 21)
    ...
    @OriginalMember(owner = "client!us", name = "e", descriptor = "(I)V", line = 185)
    ...
    @OriginalMember(owner = "client!us", name = "f", descriptor = "(I)Lrt;", line = 197)
    ...
    @OriginalMember(owner = "client!us", name = "b", descriptor = "(IB)[[I", line = 214)
