...
public abstract class class433 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(ZIZLjava/lang/String;)I", line = 6)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(B)V", line = 932)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;", line = 951)
