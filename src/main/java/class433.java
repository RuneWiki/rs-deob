...
public class class433 {
    ...
    @OriginalMember(owner = "client!qe", name = "b", descriptor = "(B)Ljea;")
    ...
    @OriginalMember(owner = "client!qe", name = "c", descriptor = "(B)Ljea;")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(ILri;)I")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Ljea;I)V")
    ...
    @OriginalMember(owner = "client!qe", name = "c", descriptor = "(I)Ljea;")
    ...
    @OriginalMember(owner = "client!qe", name = "d", descriptor = "(I)Ljea;")
