...
public class class433 implements class169 {
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Z)V", line = 13)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "([BIZI)Ljava/lang/String;", line = 28)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(I)Lkq;", line = 118)
    ...
    @OriginalMember(owner = "client!gaa", name = "<init>", descriptor = "(ILvn;Lmf;IIIIIIIZ)V", line = 143)
