...
public class class742 extends class623 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ILtn;)Ljv;")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "([Lmb;II)V")
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Lgf;)V")
