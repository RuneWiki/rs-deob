...
public class class742 extends class214 {
    ...
    @OriginalMember(owner = "client!ufa", name = "f", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(IZ)Lfe;")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(ILofa;I)V")
