...
public class class742 extends class571 {
    ...
    @OriginalMember(owner = "client!fka", name = "e", descriptor = "(Z)Z", line = 8)
    ...
    @OriginalMember(owner = "client!fka", name = "a", descriptor = "(IIB)V", line = 20)
    ...
    @OriginalMember(owner = "client!fka", name = "<init>", descriptor = "(Lpc;)V", line = 100)
    public class742(class700 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fka", name = "f", descriptor = "(Z)V", line = 105)
    ...
    @OriginalMember(owner = "client!fka", name = "b", descriptor = "(B)V", line = 119)
    ...
    @OriginalMember(owner = "client!fka", name = "a", descriptor = "(Lld;Lld;IB)V", line = 150)
    ...
    @OriginalMember(owner = "client!fka", name = "a", descriptor = "(I)Z", line = 307)
    ...
    @OriginalMember(owner = "client!fka", name = "a", descriptor = "(II)V", line = 343)
    ...
    @OriginalMember(owner = "client!fka", name = "c", descriptor = "(I)Z", line = 357)
    ...
    @OriginalMember(owner = "client!fka", name = "d", descriptor = "(Z)I", line = 368)
