...
public class class742 extends class301 {
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(B[Lpu;)V")
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Lwj;II)V")
    ...
    @OriginalMember(owner = "client!paa", name = "<init>", descriptor = "(Lck;Lwo;)V")
