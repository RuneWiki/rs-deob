...
public class class742 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(JLpaa;IIIIIILaa;)V", line = 3)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ILjava/lang/String;I[Lcw;)I", line = 59)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(BLjava/lang/String;)I", line = 88)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(II)I", line = 99)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IIBLjava/lang/String;[Lcw;)I", line = 110)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "([Lcw;ILjava/lang/String;I)I", line = 133)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ICI)I", line = 145)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Ljava/lang/String;[Lcw;IB)Ljava/lang/String;", line = 162)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ILjava/lang/String;[Lcw;)I", line = 291)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Ljava/lang/String;I[Ljava/lang/String;[Lcw;[I)I", line = 400)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(B)V", line = 652)
    public static void method4142(byte arg0) {
        int var1 = 65 / ((arg0 - 27) / 32);
        field10342 = null;
    }

    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "([B)V", line = 662)
