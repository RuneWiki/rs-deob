...
public class class742 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(BII)I", line = 7)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(I)J", line = 19)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(I)I", line = 40)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;I)V", line = 60)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IIIII[BII[B)V", line = 86)
