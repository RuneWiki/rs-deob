...
public class class742 implements Runnable {
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Ljava/lang/String;Z)Lfo;")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Ljava/lang/String;IILjava/lang/String;)Lfi;")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(BILjava/lang/String;Z)Lfo;")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(II)Lfo;")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Ljava/lang/String;I)Lfi;")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;I)Lfo;")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IIIII)Lfo;")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(BLjava/net/URL;)Lfo;")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(ZLjava/lang/String;Z)Lfo;")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(BLjava/awt/Frame;)Lfo;")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(ILjava/lang/Runnable;B)Lfo;")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Ljava/lang/String;[Ljava/lang/Class;ILjava/lang/Class;)Lfo;")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Ljava/awt/Component;Ljava/awt/Point;BI[II)Lfo;")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Ljava/lang/Object;IIBI)Lfo;")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(I)Lfo;")
