...
public class class742 {
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(Ldt;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(II)I", line = 33)
    public static final int method4077(int arg0, int arg1) {
        field10048++;
        return arg0 == -17388 ? arg1 & 0xFF : -43;
    }

    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(Lha;IZZ)Lhh;", line = 46)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(ILdt;B)V", line = 92)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(BIJ)Ljava/lang/String;", line = 125)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(I)Z", line = 148)
