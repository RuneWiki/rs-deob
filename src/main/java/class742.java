...
public class class742 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ILig;)V", line = 3)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(CBI)I", line = 23)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ILig;I)V", line = 278)
