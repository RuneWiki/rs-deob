...
public class class742 implements class520 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ILgga;BLvt;)V", line = 3)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "(B)V", line = 146)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(B)J", line = 160)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lwt;B)Z", line = 200)
