...
public class class742 implements class245 {
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Ljava/lang/String;Ljc;B)I", line = 21)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IILvo;BLha;)V", line = 42)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I)Luu;", line = 79)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Lrj;Lmq;IIIIIII)V", line = 89)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIZII)V", line = 105)
