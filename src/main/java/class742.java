...
public class class742 extends class739 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Lsl;IB)V", line = 8)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ZI)[I", line = 43)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "()V", line = 105)
    public class742() {
        super(3, false);
    }

    @OriginalMember(owner = "client!gs", name = "c", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(II)[[I", line = 130)
