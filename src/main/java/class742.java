...
public class class742 extends class585 {
    ...
    @OriginalMember(owner = "client!fka", name = "<init>", descriptor = "()V", line = 7)
    public class742() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fka", name = "c", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!fka", name = "b", descriptor = "(II)[I", line = 24)
    ...
    @OriginalMember(owner = "client!fka", name = "a", descriptor = "(BLtd;ILso;)V", line = 81)
    ...
    @OriginalMember(owner = "client!fka", name = "a", descriptor = "(Lso;II)V", line = 203)
    ...
    @OriginalMember(owner = "client!fka", name = "a", descriptor = "(IIIIIIBLjava/lang/String;)V", line = 258)
