...
public class class42 extends class175 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ILdt;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!vd", name = "g", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "()V", line = 188)
    public class42() {
        super(1, false);
    }

    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ZI)[I", line = 64)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IB)[[I", line = 109)
