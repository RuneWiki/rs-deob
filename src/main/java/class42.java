...
public class class42 extends class23 implements class415 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(III[[ZZ)V", line = 117)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lia;IIIIZ)Z", line = 135)
    public final boolean method212(class423 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lbe;[I)V", line = 138)
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lc;Lk;II[[I[[IIII)V", line = 144)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II)V", line = 149)
    public final void method210(int arg0, int arg1) {
        this.field616.method773().method2681(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIII[[Z)V", line = 155)
    ...
    @OriginalMember(owner = "client!da", name = "finalize", descriptor = "()V", line = 169)
