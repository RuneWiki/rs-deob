...
public class class42 extends class125 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(Lgp;)V", line = 34)
    public class42(class549 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(ZI)I", line = 41)
    ...
    @OriginalMember(owner = "client!bq", name = "b", descriptor = "(Z)V", line = 56)
    ...
    @OriginalMember(owner = "client!bq", name = "b", descriptor = "(I)Z", line = 73)
    ...
    @OriginalMember(owner = "client!bq", name = "c", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(ILgp;)V", line = 102)
    public class42(int arg0, class549 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(B)I", line = 106)
    ...
    @OriginalMember(owner = "client!bq", name = "c", descriptor = "(Z)I", line = 120)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(BI)V", line = 137)
