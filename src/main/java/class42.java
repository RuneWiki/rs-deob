...
public class class42 {
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(BC)Z", line = 7)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(IIB)V", line = 49)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(BLjg;)V", line = 65)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Z)V", line = 88)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "([[BII[Z[[BILe;[[BBIILee;ILfr;)V", line = 121)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(IILjg;)V", line = 608)
