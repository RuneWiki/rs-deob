...
public class class42 extends class395 {
    ...
    @OriginalMember(owner = "client!lj", name = "d", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!lj", name = "e", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!lj", name = "g", descriptor = "(I)Ljava/lang/Object;", line = 56)
    public final Object method289(int arg0) {
        field621++;
        return arg0 == 20239 ? this.field619 : null;
    }

    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 70)
    public class42(Object arg0, int arg1) {
        super(arg1);
        this.field619 = arg0;
    }

    @OriginalMember(owner = "client!lj", name = "f", descriptor = "(I)Z", line = 78)
