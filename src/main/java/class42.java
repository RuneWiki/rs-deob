...
public class class42 extends class295 implements Runnable {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Llo;IZ)V")
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(ILlo;)V")
    ...
    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "(Lwr;)V")
