...
public abstract class class42 implements class389 {
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(ZII)V", line = 15)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(III)V", line = 30)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(ZZ)V", line = 63)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(II)Z", line = 93)
    ...
    @OriginalMember(owner = "client!ic", name = "b", descriptor = "(B)I", line = 108)
    ...
    @OriginalMember(owner = "client!ic", name = "b", descriptor = "(I)Z", line = 165)
    ...
    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "(Lvo;Lvo;Lem;)V", line = 186)
