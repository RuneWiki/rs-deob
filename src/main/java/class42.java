...
public class class42 {
    ...
    @OriginalMember(owner = "client!QORKDXHW", name = "b", descriptor = "[LQORKDXHW;")
    public static class42[] field1367;

    @OriginalMember(owner = "client!QORKDXHW", name = "a", descriptor = "(LDTIATKJO;I)V")
    ...
    @OriginalMember(owner = "client!QORKDXHW", name = "a", descriptor = "(IILGHHPHSRU;)V")
