...
public class class42 extends class45 implements class627 {
    ...
    @OriginalMember(owner = "client!kaa", name = "<init>", descriptor = "(Lgf;IZ[[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Ljava/io/File;Ljava/lang/String;B)V", line = 59)
