...
public class class42 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "([BI[BII)V")
    public static final void method234(byte[] arg0, int arg1, byte[] arg2, int arg3, int arg4) {
        if (arg0 == arg2) {
            if (arg1 == arg3) {
                return;
            }
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "([II[III)V")
