...
public class class42 extends class431 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ZII)I", line = 5)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Z)V", line = 28)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(CB)Z", line = 38)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(I[B)V", line = 60)
