...
public class class42 {
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(ILtj;B)Z", line = 256)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(II)Z", line = 277)
    public final boolean method260(int arg0, int arg1) {
        field590++;
        return arg0 == Integer.MAX_VALUE ? this.field596[arg1].method16(-24566) : true;
    }

    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(IZBIIZ)V", line = 288)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(I)Z", line = 344)
    ...
    @OriginalMember(owner = "client!sca", name = "<init>", descriptor = "(Ljaa;)V", line = 400)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(IIB)Z", line = 364)
    ...
    @OriginalMember(owner = "client!sca", name = "b", descriptor = "(I)V", line = 383)
