...
public class class42 extends class142 implements class103 {
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(II)V", line = 10)
    ...
    @OriginalMember(owner = "client!ha", name = "<init>", descriptor = "(Lqa;Lna;II[[I[[IIII)V", line = 133)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lvp;[I)V", line = 138)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIIIII[[Z)V", line = 144)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lba;IIIIZ)Z", line = 147)
    public final boolean method428(class263 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return true;
    }

    @OriginalMember(owner = "client!ha", name = "finalize", descriptor = "()V", line = 150)
    protected final void finalize() {
        class260.method1672((byte) 50, this);
    }

    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(III[[ZZ)V", line = 154)
