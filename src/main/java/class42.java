...
public class class42 {
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(Z)V", line = 26)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(IILgaa;)Ljava/lang/String;", line = 44)
    ...
    @OriginalMember(owner = "client!wca", name = "b", descriptor = "(I)I", line = 69)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(IIIIIIILrl;IIII)Z", line = 81)
    ...
    @OriginalMember(owner = "client!wca", name = "b", descriptor = "(B)I", line = 513)
    ...
    @OriginalMember(owner = "client!wca", name = "c", descriptor = "(I)Z", line = 526)
    ...
    @OriginalMember(owner = "client!wca", name = "<init>", descriptor = "(ZIIZ)V", line = 537)
