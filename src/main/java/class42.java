...
public class class42 {
    ...
    @OriginalMember(owner = "client!pja", name = "a", descriptor = "(BILgaa;)V")
    ...
    @OriginalMember(owner = "client!pja", name = "a", descriptor = "(ILjp;B)V")
    ...
    @OriginalMember(owner = "client!pja", name = "a", descriptor = "(ILjp;)V")
    ...
    @OriginalMember(owner = "client!pja", name = "a", descriptor = "(Ldia;I[II[II)Lcg;")
