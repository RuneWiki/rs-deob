...
public class class42 extends class477 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Lrh;II)V")
    ...
    @OriginalMember(owner = "client!mn", name = "c", descriptor = "(B)[Lhk;")
    ...
    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "(Lgk;Lwl;)V")
