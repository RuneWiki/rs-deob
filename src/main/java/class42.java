...
public class class42 extends class210 {
    ...
    @OriginalMember(owner = "client!gs", name = "g", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IB)[I", line = 31)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(II)Lip;", line = 165)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "()V", line = 208)
    public class42() {
        super(0, true);
    }

    @OriginalMember(owner = "client!gs", name = "e", descriptor = "(I)V", line = 196)
    public final void method363(int arg0) {
        ++field562;
        class51.method392(arg0 ^ arg0);
    }

    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IILat;)V", line = 215)
