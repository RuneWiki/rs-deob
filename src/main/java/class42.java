...
public class class42 {
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(Z)I", line = 5)
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(B)Z", line = 29)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ZIIBLci;II)V", line = 44)
    ...
    @OriginalMember(owner = "client!ha", name = "c", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ZZLjava/lang/Object;)[B", line = 78)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIIB[BI)V", line = 117)
    ...
    @OriginalMember(owner = "client!ha", name = "d", descriptor = "(I)V", line = 214)
