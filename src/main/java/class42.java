...
public class class42 extends class91 {
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(IB)Lwi;", line = 3)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(ILae;Lae;ZI)I", line = 28)
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(ZII)V", line = 127)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(ZII)V", line = 182)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(III)V", line = 205)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IIII)I", line = 228)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Lrg;I)Lwb;", line = 252)
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(B)V", line = 275)
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(III)V", line = 288)
    ...
    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "(IIIIII)V", line = 298)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(II)Ljava/lang/String;", line = 309)
