...
public class class42 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Z)V", line = 74)
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "(I)Lpn;", line = 93)
    ...
    @OriginalMember(owner = "client!da", name = "c", descriptor = "(I)Z", line = 127)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(BI[B)I", line = 148)
