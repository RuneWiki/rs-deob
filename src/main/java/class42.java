...
@OriginalClass("client!PUBJBHOK")
public class class42 {

    @OriginalMember(owner = "client!PUBJBHOK", name = "a", descriptor = "I")
    private int field1015 = -591;

    @OriginalMember(owner = "client!PUBJBHOK", name = "b", descriptor = "I")
    private int field1016 = 28077;

    @OriginalMember(owner = "client!PUBJBHOK", name = "c", descriptor = "LTSSAWEFF;")
    public class53 field1017 = new class53();

    @OriginalMember(owner = "client!PUBJBHOK", name = "d", descriptor = "LTSSAWEFF;")
    private class53 field1018;

    @OriginalMember(owner = "client!PUBJBHOK", name = "<init>", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!PUBJBHOK", name = "a", descriptor = "(LTSSAWEFF;)V")
    ...
    @OriginalMember(owner = "client!PUBJBHOK", name = "a", descriptor = "(ILTSSAWEFF;)V")
    ...
    @OriginalMember(owner = "client!PUBJBHOK", name = "a", descriptor = "()LTSSAWEFF;")
    ...
    @OriginalMember(owner = "client!PUBJBHOK", name = "b", descriptor = "()LTSSAWEFF;")
    ...
    @OriginalMember(owner = "client!PUBJBHOK", name = "a", descriptor = "(B)LTSSAWEFF;")
    ...
    @OriginalMember(owner = "client!PUBJBHOK", name = "a", descriptor = "(I)LTSSAWEFF;")
    ...
    @OriginalMember(owner = "client!PUBJBHOK", name = "b", descriptor = "(I)LTSSAWEFF;")
    ...
    @OriginalMember(owner = "client!PUBJBHOK", name = "c", descriptor = "()V")
