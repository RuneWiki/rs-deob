...
public class class42 {
    ...
    @OriginalMember(owner = "client!OXBPHQKK", name = "s", descriptor = "Z")
    ...
    @OriginalMember(owner = "client!OXBPHQKK", name = "c", descriptor = "[LOXBPHQKK;")
    public static class42[] field1314;

    @OriginalMember(owner = "client!OXBPHQKK", name = "a", descriptor = "(LMNPBQFWE;B)V")
    ...
    @OriginalMember(owner = "client!OXBPHQKK", name = "a", descriptor = "(ILBJPWOXRJ;)V")
