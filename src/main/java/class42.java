...
public class class42 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(I)I", line = 67)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ZLod;)V", line = 82)
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(I)V", line = 130)
    public class42(int arg0) {
        this.field545 = arg0;
    }

    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(IIIIII)V", line = 148)
    ...
    @OriginalMember(owner = "client!od", name = "c", descriptor = "(I)Lod;", line = 138)
