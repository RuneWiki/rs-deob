...
public class class42 {
    ...
    @OriginalMember(owner = "client!MCCUMEPE", name = "g", descriptor = "[LOWNYSRQV;")
    ...
    @OriginalMember(owner = "client!MCCUMEPE", name = "a", descriptor = "(J)LOWNYSRQV;")
    ...
    @OriginalMember(owner = "client!MCCUMEPE", name = "a", descriptor = "(BLOWNYSRQV;J)V")
