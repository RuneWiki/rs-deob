...
public class class42 extends class498 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Loi;I)Lnr;")
    ...
    @OriginalMember(owner = "client!nr", name = "e", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "([I)Lcj;")
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Loi;II)Lnr;")
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Loi;)Z")
