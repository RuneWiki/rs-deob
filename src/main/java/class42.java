...
@OriginalClass("client!ROUYYYUE")
public class class42 {

    @OriginalMember(owner = "client!ROUYYYUE", name = "a", descriptor = "I")
    private static int field1306 = 830;

    @OriginalMember(owner = "client!ROUYYYUE", name = "b", descriptor = "Z")
    private static boolean field1307 = true;

    @OriginalMember(owner = "client!ROUYYYUE", name = "a", descriptor = "(IIII)I")
    ...
    @OriginalMember(owner = "client!ROUYYYUE", name = "a", descriptor = "(IIIZ)I")
    ...
    @OriginalMember(owner = "client!ROUYYYUE", name = "a", descriptor = "(ZIIIII)I")
    ...
    @OriginalMember(owner = "client!ROUYYYUE", name = "a", descriptor = "(IIIIII)I")
