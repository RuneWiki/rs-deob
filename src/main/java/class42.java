...
public class class42 {
    ...
    @OriginalMember(owner = "client!LSQNLJTA", name = "f", descriptor = "LUXRJCYSS;")
    private class60 field1079 = new class60();

    @OriginalMember(owner = "client!LSQNLJTA", name = "j", descriptor = "LBGEXEDZG;")
    ...
    @OriginalMember(owner = "client!LSQNLJTA", name = "i", descriptor = "LLJCRDSKE;")
    ...
    @OriginalMember(owner = "client!LSQNLJTA", name = "a", descriptor = "(J)LUXRJCYSS;")
    ...
    @OriginalMember(owner = "client!LSQNLJTA", name = "a", descriptor = "(LUXRJCYSS;IJ)V")
