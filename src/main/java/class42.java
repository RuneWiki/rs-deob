...
public class class42 extends InputStream {
    ...
    @OriginalMember(owner = "client!ic", name = "b", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;I)V", line = 34)
    ...
    @OriginalMember(owner = "client!ic", name = "read", descriptor = "()I", line = 48)
