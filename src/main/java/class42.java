...
public abstract class class42 implements class12 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Llda;I)V")
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "([FIIIZ)V")
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(II[BII)V")
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IBII[I)V")
    ...
    @OriginalMember(owner = "client!bt", name = "<init>", descriptor = "(Lfha;ILbda;Lwt;IZ)V")
