...
public class class42 extends class439 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(BZLps;)V", line = 4)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Z)Lcp;", line = 157)
    ...
    @OriginalMember(owner = "client!da", name = "c", descriptor = "(Z)V", line = 178)
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(I)V", line = 220)
    public class42(int arg0) {
        this.field649 = arg0;
    }

    @OriginalMember(owner = "client!da", name = "c", descriptor = "(I)V", line = 210)
