...
public class class42 extends class155 {
    ...
    @OriginalMember(owner = "client!vd", name = "b", descriptor = "(I)Z", line = 5)
    public final boolean method250(int arg0) {
        int var2 = 15 % ((-arg0 - 8) / 41);
        return this.field671 != null;
    }

    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!vd", name = "f", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!vd", name = "d", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IIB)V", line = 78)
    ...
    @OriginalMember(owner = "client!vd", name = "e", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ZZ)V", line = 148)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IZ)V", line = 158)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Lbr;II)V", line = 176)
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "(Laia;Lgj;Luw;)V", line = 185)
    ...
    @OriginalMember(owner = "client!vd", name = "c", descriptor = "(I)V", line = 206)
