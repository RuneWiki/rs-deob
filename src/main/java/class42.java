...
public class class42 extends class366 implements class28 {
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(II[BLpb;IIIII)V")
    ...
    @OriginalMember(owner = "client!wca", name = "<init>", descriptor = "(Lsga;Lpb;Loea;II)V")
    ...
    @OriginalMember(owner = "client!wca", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(BLcw;)V")
    ...
    @OriginalMember(owner = "client!wca", name = "<init>", descriptor = "(Lsga;Lpb;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!wca", name = "<init>", descriptor = "(Lsga;IIZ[III)V")
