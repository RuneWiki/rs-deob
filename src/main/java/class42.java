...
public class class42 {
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "Llf;")
    public static class109 field874 = class35.method275(")3", 2);

    @OriginalMember(owner = "client!ea", name = "a", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ea", name = "d", descriptor = "Llf;")
    public static class109 field876 = class35.method275("Bitte geben Sie Ihren Benutzenamen ein)3", 2);

    @OriginalMember(owner = "client!ea", name = "k", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ea", name = "n", descriptor = "Llf;")
    public static class109 field886 = class35.method275("<br>(X100(U(Y", 2);

    @OriginalMember(owner = "client!ea", name = "f", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(ILid;)V")
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(III)Led;")
