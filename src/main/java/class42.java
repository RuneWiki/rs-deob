...
public class class42 extends class55 {
    ...
    @OriginalMember(owner = "client!PDAYFSBN", name = "sb", descriptor = "LYIBRLAQY;")
    public class70 field1082;

    @OriginalMember(owner = "client!PDAYFSBN", name = "a", descriptor = "(I)LPSGMMDJS;")
    ...
    @OriginalMember(owner = "client!PDAYFSBN", name = "b", descriptor = "(I)LPSGMMDJS;")
