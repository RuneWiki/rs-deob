...
public class class42 extends class55 implements class326 {
    ...
    @OriginalMember(owner = "client!cja", name = "c", descriptor = "(I)J", line = 6)
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "(Z)I", line = 18)
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "(IILsba;I)V", line = 32)
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "(I)I", line = 104)
    ...
    @OriginalMember(owner = "client!cja", name = "e", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!cja", name = "a", descriptor = "(B)I", line = 124)
    public final int method257(byte arg0) {
        field434++;
        return arg0 == 82 ? this.field428 : -4;
    }

    @OriginalMember(owner = "client!cja", name = "b", descriptor = "(I)C", line = 136)
