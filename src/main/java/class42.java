...
public class class42 {
    ...
    @OriginalMember(owner = "client!PNPNYEVW", name = "s", descriptor = "I")
    ...
    @OriginalMember(owner = "client!PNPNYEVW", name = "c", descriptor = "[LPNPNYEVW;")
    public static class42[] field1219;

    @OriginalMember(owner = "client!PNPNYEVW", name = "a", descriptor = "(ILINOFEYKQ;)V")
    ...
    @OriginalMember(owner = "client!PNPNYEVW", name = "a", descriptor = "(ZLNHEPCMLW;)V")
