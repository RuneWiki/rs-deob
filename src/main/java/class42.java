...
@OriginalClass("client!NMXKUYSC")
public class class42 {

    @OriginalMember(owner = "client!NMXKUYSC", name = "b", descriptor = "I")
    private int field1156 = 5;

    @OriginalMember(owner = "client!NMXKUYSC", name = "i", descriptor = "I")
    public int field1163 = -1;

    @OriginalMember(owner = "client!NMXKUYSC", name = "k", descriptor = "Z")
    public boolean field1165 = false;

    @OriginalMember(owner = "client!NMXKUYSC", name = "l", descriptor = "I")
    public int field1166 = 5;

    @OriginalMember(owner = "client!NMXKUYSC", name = "m", descriptor = "I")
    public int field1167 = -1;

    @OriginalMember(owner = "client!NMXKUYSC", name = "n", descriptor = "I")
    public int field1168 = -1;

    @OriginalMember(owner = "client!NMXKUYSC", name = "o", descriptor = "I")
    public int field1169 = 99;

    @OriginalMember(owner = "client!NMXKUYSC", name = "p", descriptor = "I")
    public int field1170 = -1;

    @OriginalMember(owner = "client!NMXKUYSC", name = "q", descriptor = "I")
    public int field1171 = -1;

    @OriginalMember(owner = "client!NMXKUYSC", name = "r", descriptor = "I")
    public int field1172 = 2;

    @OriginalMember(owner = "client!NMXKUYSC", name = "a", descriptor = "I")
    private int field1155;

    @OriginalMember(owner = "client!NMXKUYSC", name = "c", descriptor = "I")
    public static int field1157;

    @OriginalMember(owner = "client!NMXKUYSC", name = "e", descriptor = "I")
    public int field1159;

    @OriginalMember(owner = "client!NMXKUYSC", name = "s", descriptor = "I")
    public int field1173;

    @OriginalMember(owner = "client!NMXKUYSC", name = "t", descriptor = "I")
    public static int field1174;

    @OriginalMember(owner = "client!NMXKUYSC", name = "f", descriptor = "[I")
    public int[] field1160;

    @OriginalMember(owner = "client!NMXKUYSC", name = "g", descriptor = "[I")
    public int[] field1161;

    @OriginalMember(owner = "client!NMXKUYSC", name = "h", descriptor = "[I")
    private int[] field1162;

    @OriginalMember(owner = "client!NMXKUYSC", name = "j", descriptor = "[I")
    public int[] field1164;

    @OriginalMember(owner = "client!NMXKUYSC", name = "d", descriptor = "[LNMXKUYSC;")
    public static class42[] field1158;

    @OriginalMember(owner = "client!NMXKUYSC", name = "a", descriptor = "(ILCVNWKEAW;)V")
    ...
    @OriginalMember(owner = "client!NMXKUYSC", name = "a", descriptor = "(IB)I")
    ...
    @OriginalMember(owner = "client!NMXKUYSC", name = "a", descriptor = "(BLXOUQUKZW;)V")
