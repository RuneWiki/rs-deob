...
public class class42 extends class307 {
    ...
    @OriginalMember(owner = "client!wc", name = "b", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!wc", name = "e", descriptor = "(I)I", line = 29)
    ...
    @OriginalMember(owner = "client!wc", name = "c", descriptor = "(B)J", line = 42)
    ...
    @OriginalMember(owner = "client!wc", name = "g", descriptor = "(I)V", line = 60)
    public static void method386(int arg0) {
        int var1 = -51 % ((arg0 + 60) / 38);
        field610 = null;
    }

    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ILkm;)V", line = 70)
    ...
    @OriginalMember(owner = "client!wc", name = "d", descriptor = "(I)I", line = 224)
