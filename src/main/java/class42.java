...
public class class42 {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(I)[Lss;", line = 33)
    ...
    @OriginalMember(owner = "client!is", name = "b", descriptor = "(I)[Ldb;", line = 44)
    ...
    @OriginalMember(owner = "client!is", name = "c", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "([I)V", line = 73)
