...
public class class42 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(BII)Z", line = 17)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(II[BI)I", line = 30)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IJ)V", line = 51)
    ...
    @OriginalMember(owner = "client!bt", name = "finalize", descriptor = "()V", line = 62)
    ...
    @OriginalMember(owner = "client!bt", name = "b", descriptor = "(II[BI)V", line = 75)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(B)J", line = 97)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IIILbj;)V", line = 111)
    ...
    @OriginalMember(owner = "client!bt", name = "b", descriptor = "(I)Ljava/io/File;", line = 170)
    ...
    @OriginalMember(owner = "client!bt", name = "c", descriptor = "(I)V", line = 185)
    ...
    @OriginalMember(owner = "client!bt", name = "<init>", descriptor = "(Ljava/io/File;Ljava/lang/String;J)V", line = 214)
