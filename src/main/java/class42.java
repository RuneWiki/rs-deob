...
public class class42 implements Runnable {
    ...
    @OriginalMember(owner = "client!OAGIEZRU", name = "f", descriptor = "LKISFBCOP;")
    ...
    @OriginalMember(owner = "client!OAGIEZRU", name = "<init>", descriptor = "(LKISFBCOP;BLjava/net/Socket;)V")
