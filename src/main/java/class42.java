...
public class class42 extends class585 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ZI)[[I", line = 4)
    ...
    @OriginalMember(owner = "client!vd", name = "e", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Lso;II)V", line = 80)
