...
public class class42 extends class214 {
    ...
    @OriginalMember(owner = "client!ts", name = "c", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ZLjava/lang/String;Llk;)I")
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ILbc;ILkm;III)V")
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Llk;II)V")
