...
public class class42 extends class214 {
    ...
    @OriginalMember(owner = "client!mv", name = "c", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(IILei;B)V", line = 20)
    ...
    @OriginalMember(owner = "client!mv", name = "f", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(IB)[I", line = 105)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(ILofa;I)V", line = 319)
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "()V", line = 730)
    public class42() {
        super(0, true);
    }

    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Z[[[BIBIIZ)V", line = 407)
