...
public class class42 extends class35 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!wb", name = "c", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(BILrc;ILja;Lbq;IIIIIZIII)Lrc;", line = 24)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(ILja;IIIIIII)V", line = 235)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(ZZIIIII)V", line = 375)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IIZI)I", line = 401)
