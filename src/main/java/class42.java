...
public class class42 implements Runnable {
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(BLd;)V")
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(Ljava/lang/String;I)Lvm;")
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(ILr;BI)V")
