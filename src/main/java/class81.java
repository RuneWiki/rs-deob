...
public class class81 extends class79 {
    ...
    @OriginalMember(owner = "client!ho", name = "b", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(II[Lon;)V", line = 20)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 101)
