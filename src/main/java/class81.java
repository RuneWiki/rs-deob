...
public class class81 {
    ...
    @OriginalMember(owner = "client!haa", name = "b", descriptor = "(I)[Loo;", line = 18)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(BIIIIII)Z", line = 30)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "([Lfk;ILno;)Ltm;", line = 100)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(BI)V", line = 168)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(BIIILha;I)V", line = 188)
