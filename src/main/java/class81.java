...
public class class81 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Lbf;ILjava/lang/String;)Lcg;", line = 4)
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "(Lbf;II)V", line = 48)
