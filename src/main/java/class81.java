...
public class class81 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(ILbt;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Ltu;Z)V", line = 49)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(BI)V", line = 61)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Z)Llf;", line = 85)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(I)Llf;", line = 105)
    ...
    @OriginalMember(owner = "client!ms", name = "b", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "()V", line = 149)
    public class81() {
    }

    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(Ltu;)V", line = 160)
