...
public class class81 extends class250 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Z)J", line = 5)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!mg", name = "b", descriptor = "(Z)J", line = 37)
    ...
    @OriginalMember(owner = "client!mg", name = "b", descriptor = "(II)I", line = 70)
