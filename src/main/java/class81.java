...
public abstract class class81 extends class170 {
    ...
    @OriginalMember(owner = "client!nh", name = "f", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(II[B)I", line = 25)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IIIIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IIIIIIIIII)V", line = 76)
