...
public class class81 extends class431 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(II[II)V", line = 19)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "([IIII)V", line = 32)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IIILqv;Lqv;)V", line = 48)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(BI)V", line = 61)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(BII)Z", line = 75)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IIIIIIII)V", line = 90)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IIIB)Z", line = 303)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(IIIIIIIII)V", line = 318)
