...
public class class81 {
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(ILek;)V")
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(IILoq;ILr;II)Lda;")
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(IILi;Li;BIILoq;IIZLr;I)Lda;")
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(IIBILoq;ILr;)Lda;")
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(IBLek;)V")
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(IILr;ILi;BILi;ILoq;IIZI)Lda;")
