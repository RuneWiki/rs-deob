...
public class class81 extends class344 {
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(Z)Z", line = 4)
    ...
    @OriginalMember(owner = "client!qw", name = "b", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(IZ)V", line = 117)
    ...
    @OriginalMember(owner = "client!qw", name = "b", descriptor = "(III)V", line = 145)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(Lgb;II)V", line = 162)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(BZ)V", line = 174)
    ...
    @OriginalMember(owner = "client!qw", name = "<init>", descriptor = "(Lvf;)V", line = 191)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "([Lhk;I)V", line = 303)
