...
public class class81 extends class407 {
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(IIIIIIIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(BLtj;)V", line = 28)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Ltj;I)Lri;", line = 58)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Ltj;BLqb;)V", line = 92)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(B)Z", line = 122)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ZI)V", line = 136)
    ...
    @OriginalMember(owner = "client!ia", name = "g", descriptor = "(I)I", line = 201)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Z)V", line = 217)
    ...
    @OriginalMember(owner = "client!ia", name = "finalize", descriptor = "()V", line = 235)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(B)V", line = 253)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ILtj;II)Z", line = 265)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ILtj;B)Lqb;", line = 280)
    ...
    @OriginalMember(owner = "client!ia", name = "d", descriptor = "(B)V", line = 297)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ILtj;BIZLkm;I)V", line = 313)
    ...
    @OriginalMember(owner = "client!ia", name = "e", descriptor = "(B)V", line = 323)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(IIIBI)V", line = 336)
    ...
    @OriginalMember(owner = "client!ia", name = "e", descriptor = "(I)V", line = 382)
