...
public class class81 extends class239 {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Lgs;IIIIIIIIIIIZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "()V", line = 26)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(J)V", line = 37)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(JI)V", line = 168)
    ...
    @OriginalMember(owner = "client!hu", name = "b", descriptor = "()V", line = 563)
    ...
    @OriginalMember(owner = "client!hu", name = "<init>", descriptor = "(Lgs;IIIIIIIIIIIZZ)V", line = 571)
