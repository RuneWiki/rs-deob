...
public class class81 implements Runnable {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "()V", line = 12)
    ...
    @OriginalMember(owner = "client!gv", name = "c", descriptor = "()V", line = 20)
    ...
    @OriginalMember(owner = "client!gv", name = "d", descriptor = "()Z", line = 27)
    public final boolean method570() {
        return this.field850 == null || !this.field849 && this.field850.method3372((byte) -38);
    }

    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(ILha;)V", line = 168)
    public class81(int arg0, class58 arg1) {
        this.field843 = arg0;
        this.field845 = arg1;
    }

    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Lot;)V", line = 35)
    ...
    @OriginalMember(owner = "client!gv", name = "e", descriptor = "()V", line = 45)
    ...
    @OriginalMember(owner = "client!gv", name = "run", descriptor = "()V", line = 145)
    ...
    @OriginalMember(owner = "client!gv", name = "f", descriptor = "()J", line = 156)
