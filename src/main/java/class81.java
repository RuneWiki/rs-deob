...
public abstract class class81 extends class190 {
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(IIIIIIIIIIILoa;[[[B)V", line = 4)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(ILle;IIIIIIIII)Z", line = 39)
    ...
    @OriginalMember(owner = "client!dba", name = "b", descriptor = "(B)V", line = 297)
