...
public class class81 {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(IIIIIZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "([I[[BIB[[B[BI[I)I", line = 48)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Z)V", line = 105)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(BC)V", line = 123)
    ...
    @OriginalMember(owner = "client!hu", name = "<init>", descriptor = "(Lrl;I)V", line = 133)
