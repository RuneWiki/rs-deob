...
public abstract class class81 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(III)V", line = 16)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(BI)Z", line = 70)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Lnj;II)Ljava/lang/String;", line = 96)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(I)[Lsd;", line = 160)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(II)I", line = 247)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(IIZ)V", line = 298)
