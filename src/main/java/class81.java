...
public class class81 implements class101 {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Lgga;I)Lcb;")
    ...
    @OriginalMember(owner = "client!qq", name = "c", descriptor = "(II)Ltm;")
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(II)Lqr;")
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "(Lae;Lae;Lae;)V")
