...
public class class81 extends class111 {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Z)D", line = 7)
    ...
    @OriginalMember(owner = "client!u", name = "c", descriptor = "(I)J", line = 23)
    public final long method642(int arg0) {
        field1130++;
        return arg0 == -1 ? this.field1113 : 102L;
    }

    @OriginalMember(owner = "client!u", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 68)
    public class81(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!u", name = "f", descriptor = "(I)Z", line = 81)
    public final boolean method644(int arg0) {
        field1112++;
        return arg0 <= 95 ? true : this.field1102;
    }

    @OriginalMember(owner = "client!u", name = "a", descriptor = "(B)F", line = 99)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;B)V", line = 112)
    ...
    @OriginalMember(owner = "client!u", name = "g", descriptor = "(I)Z", line = 186)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ILha;)Lhh;", line = 203)
    ...
    @OriginalMember(owner = "client!u", name = "c", descriptor = "(B)V", line = 223)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(BI)I", line = 234)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IB)V", line = 352)
