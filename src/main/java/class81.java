...
public class class81 extends class281 {
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(Lha;II)V")
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(ILoba;)Z")
    ...
    @OriginalMember(owner = "client!gea", name = "b", descriptor = "(ILoba;)Z")
