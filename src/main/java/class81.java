...
public class class81 extends class464 {
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;Z)V")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IBLuaa;)I")
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
