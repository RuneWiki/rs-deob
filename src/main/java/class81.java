...
public class class81 extends class145 {
    ...
    @OriginalMember(owner = "client!nh", name = "d", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(II)[I", line = 15)
    ...
    @OriginalMember(owner = "client!nh", name = "e", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!nh", name = "f", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "()V", line = 164)
    public class81() {
        super(1, true);
    }

    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(BZIII)V", line = 137)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IZIIII)V", line = 167)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Lap;BI)V", line = 268)
