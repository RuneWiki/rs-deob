...
public class class81 extends class359 {
    ...
    @OriginalMember(owner = "client!mg", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Z[BI)Ljava/lang/Object;", line = 27)
    ...
    @OriginalMember(owner = "client!mg", name = "b", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(ZI)V", line = 156)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(IILjf;IIIII)V", line = 231)
