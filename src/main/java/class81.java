...
public class class81 extends class16 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!ut", name = "b", descriptor = "(FFFFFFLma;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!ut", name = "<init>", descriptor = "(Lfd;IIII)V", line = 1215)
    ...
    @OriginalMember(owner = "client!ut", name = "<init>", descriptor = "(Lfd;II[III)V", line = 1225)
    ...
    @OriginalMember(owner = "client!ut", name = "la", descriptor = "()I", line = 111)
    public final int method110() {
        field1089++;
        return this.field1090.field743;
    }

    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(IIIIII)V", line = 141)
    ...
    @OriginalMember(owner = "client!ut", name = "T", descriptor = "()I", line = 158)
    public final int method117() {
        field1102++;
        return this.field1090.field748 + this.field1082 + this.field1084;
    }

    @OriginalMember(owner = "client!ut", name = "BA", descriptor = "(III)V", line = 167)
    ...
    @OriginalMember(owner = "client!ut", name = "j", descriptor = "()I", line = 191)
    public final int method125() {
        field1092++;
        return this.field1090.field743 + this.field1098 + this.field1078;
    }

    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(I[BII)Ljava/lang/String;", line = 206)
    ...
    @OriginalMember(owner = "client!ut", name = "ma", descriptor = "()I", line = 253)
    public final int method126() {
        field1095++;
        return this.field1090.field748;
    }

    @OriginalMember(owner = "client!ut", name = "b", descriptor = "(B)V", line = 261)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(FFFFFFIII)V", line = 467)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(IILma;II)V", line = 544)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(BI)V", line = 603)
    ...
    @OriginalMember(owner = "client!ut", name = "r", descriptor = "(IIIII)V", line = 638)
    ...
    @OriginalMember(owner = "client!ut", name = "JA", descriptor = "(IIIIIII)V", line = 692)
    ...
    @OriginalMember(owner = "client!ut", name = "t", descriptor = "(IIIIII)V", line = 830)
    ...
    @OriginalMember(owner = "client!ut", name = "MA", descriptor = "(IIII)V", line = 843)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(IIIIILsd;IIIII)Z", line = 855)
    ...
    @OriginalMember(owner = "client!ut", name = "s", descriptor = "(IIIIIII)V", line = 1109)
