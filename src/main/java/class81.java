...
public class class81 extends class71 {
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(II)Z", line = 30)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(IIII)Z", line = 63)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(I[IZI)V", line = 80)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(III[I)V", line = 93)
    ...
    @OriginalMember(owner = "client!jca", name = "b", descriptor = "(III)Z", line = 106)
    ...
    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "(IIIIIIIII)V", line = 128)
