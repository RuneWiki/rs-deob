...
public class class81 extends class100 {
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Ljava/lang/String;IBLjava/lang/String;ILjava/lang/String;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ld", name = "b", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(BJ)V", line = 38)
    ...
    @OriginalMember(owner = "client!ld", name = "b", descriptor = "(Z)V", line = 65)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IIII)I", line = 150)
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "(Lza;Lgh;Lcc;J)V", line = 375)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(JLza;ZZI)V", line = 190)
