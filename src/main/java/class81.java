...
public class class81 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IIIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(II)V", line = 47)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ZILjava/lang/String;)I", line = 93)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IIB)V", line = 124)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IZ)Lwn;", line = 138)
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Lcw;ILeq;Leq;)V", line = 179)
