...
public class class81 implements class512 {
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(ZI)V", line = 18)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;", line = 52)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(B)Llc;", line = 70)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(I)Z", line = 80)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Z)V", line = 100)
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(Lnca;Llc;Z)V", line = 122)
