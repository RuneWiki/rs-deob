...
public class class81 extends class214 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(ILofa;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!hn", name = "c", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!hn", name = "e", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!hn", name = "<init>", descriptor = "()V", line = 74)
    public class81() {
        super(0, true);
    }

    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(Z)V", line = 90)
    ...
    @OriginalMember(owner = "client!hn", name = "c", descriptor = "(Z)Lnfa;", line = 116)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IB)[I", line = 135)
