...
public class class81 implements class505 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(JILgo;[I)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "([II[IBLod;I)Leb;", line = 55)
