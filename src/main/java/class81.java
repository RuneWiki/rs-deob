...
public class class81 extends class152 implements class458 {
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(Lkga;I[BIZ)V", line = 15)
    public class81(class506 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field1175 = arg1;
    }

    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(CII)I", line = 26)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(I[BLjava/lang/String;I)I", line = 47)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(B)J", line = 90)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(Lkga;ILjaclib/memory/Buffer;IZ)V", line = 101)
    public class81(class506 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field1175 = arg1;
    }

    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Lun;I)V", line = 109)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Z)V", line = 155)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(I)I", line = 170)
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(Z)V", line = 189)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(I[BII)V", line = 202)
