...
public class class81 extends class363 {
    ...
    @OriginalMember(owner = "client!tn", name = "d", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(B)V", line = 56)
    public static void method617(byte arg0) {
        int var1 = -123 % ((23 - arg0) / 55);
        field1050 = null;
    }

    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(Z)V", line = 66)
    ...
    @OriginalMember(owner = "client!tn", name = "c", descriptor = "(II)Z", line = 81)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(ILe;ILjava/awt/Canvas;)Loa;", line = 92)
    ...
    @OriginalMember(owner = "client!tn", name = "e", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!tn", name = "c", descriptor = "(B)Z", line = 116)
    ...
    @OriginalMember(owner = "client!tn", name = "d", descriptor = "(II)Z", line = 220)
    ...
    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "(I)V", line = 233)
    public class81(int arg0) {
        this.field1051 = arg0;
    }

    @OriginalMember(owner = "client!tn", name = "e", descriptor = "(II)Z", line = 244)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Lpv;IIIII)V", line = 256)
