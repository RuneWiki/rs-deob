...
public class class81 extends class439 {
    ...
    @OriginalMember(owner = "client!ju", name = "c", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(BZZII)Lhh;", line = 23)
    ...
    @OriginalMember(owner = "client!ju", name = "d", descriptor = "(I)V", line = 52)
