...
public class ObjType {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(BLkb;)V")
    ...
    public static final Pix24 method291(int arg0, int arg1, int arg2) {
        Pix24 var3 = (Pix24) field916.method101((long) arg0);
        ...
        int[] var11 = Draw2D.field534;
        int var12 = Draw2D.field535;
        int var13 = Draw2D.field536;
        int var14 = Draw2D.field539;
        int var15 = Draw2D.field540;
        int var16 = Draw2D.field537;
        int var17 = Draw2D.field538;
        Draw3D.field552 = false;
        Draw2D.method144(32, true, 32, var7.field579);
        Draw2D.method148(0, 0, 0, (byte) 107, 32, 32);
        int var18 = 90 / arg2;
        Draw3D.method153(796);
        Model var19 = var4.method290(1);
        int var20 = Draw3D.field558[var4.field889] * var4.field888 >> 16;
        int var21 = Draw3D.field559[var4.field889] * var4.field888 >> 16;
        ...
        if (var4.field914 != -1) {
            Pix24 var24 = method291(var4.field913, 10, 44);
        ...
        Draw2D.method144(var12, true, var13, var11);
        Draw2D.method146(field875, var14, var16, var15, var17);
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IZ)Leb;")
