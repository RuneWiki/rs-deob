...
public class ObjType {
    ...
    @OriginalMember(owner = "client!cc", name = "T", descriptor = "Ls;")
    public static LruCache field916 = new LruCache((byte) 0, 50);

    @OriginalMember(owner = "client!cc", name = "U", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!cc", name = "g", descriptor = "Lkb;")
    ...
    @OriginalMember(owner = "client!cc", name = "h", descriptor = "[Lcc;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lub;)V")
    public static final void method292(Jagfile arg0) {
        field877 = new Packet(363, arg0.method257("obj.dat", null, (byte) 2));
        Packet var1 = new Packet(363, arg0.method257("obj.idx", null, (byte) 2));
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ZLkb;)V")
    ...
    @OriginalMember(owner = "client!cc", name = "c", descriptor = "(I)Leb;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(III)Lhb;")
    public static final Pix24 method299(int arg0, int arg1, int arg2) {
        Pix24 var3 = (Pix24) field917.method103((long) arg0);
        ...
        Pix24 var7 = new Pix24(32, 32);
        int var8 = Draw3D.field554;
        int var9 = Draw3D.field555;
        int[] var10 = Draw3D.field560;
        int[] var11 = Draw2D.field533;
        int var12 = Draw2D.field534;
        int var13 = Draw2D.field535;
        int var14 = Draw2D.field538;
        int var15 = Draw2D.field539;
        int var16 = Draw2D.field536;
        int var17 = Draw2D.field537;
        Draw3D.field552 = false;
        Draw2D.method146(32, var7.field577, -657, 32);
        Draw2D.method150(0, 0, 0, (byte) 93, 32, 32);
        Draw3D.method155(field873);
        Model var18 = var4.method298(1);
        int var19 = Draw3D.field558[var4.field888] * var4.field887 >> 16;
        int var20 = Draw3D.field559[var4.field888] * var4.field887 >> 16;
        ...
        if (var4.field915 != -1) {
            Pix24 var23 = method299(var4.field914, 24638, 10);
        ...
        Draw2D.method146(var12, var11, -657, var13);
        Draw2D.method148(var17, var16, var15, 789, var14);
        Draw3D.field554 = var8;
        Draw3D.field555 = var9;
        Draw3D.field560 = var10;
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(BI)Leb;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(II)Leb;")
