...
public class ObjType {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(Lmb;B)V")
    ...
    @OriginalMember(owner = "client!hc", name = "b", descriptor = "(I)Lfb;")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(ZIII)Ljb;")
    public static final Pix24 method356(boolean arg0, int arg1, int arg2, int arg3) {
        if (arg1 == 0) {
            Pix24 var4 = (Pix24) field1095.method115((long) arg3);
        ...
        int var11 = Draw3D.field662;
        int var12 = Draw3D.field663;
        int[] var13 = Draw3D.field668;
        int[] var14 = Draw2D.field644;
        int var15 = Draw2D.field645;
        int var16 = Draw2D.field646;
        int var17 = Draw2D.field649;
        int var18 = Draw2D.field650;
        int var19 = Draw2D.field647;
        int var20 = Draw2D.field648;
        Draw3D.field660 = false;
        Draw2D.method165(var10.field688, 741, 32, 32);
        Draw2D.method170(0, 0, 0, 32, (byte) 51, 32);
        Draw3D.method178(field1045);
        ...
        int var22 = Draw3D.field666[var5.field1062] * var21 >> 16;
        int var23 = Draw3D.field667[var5.field1062] * var21 >> 16;
        ...
        Draw2D.method165(var14, 741, var15, var16);
        Draw2D.method167(true, var18, var17, var19, var20);
        Draw3D.field662 = var11;
        Draw3D.field663 = var12;
        Draw3D.field668 = var13;
        Draw3D.field660 = true;
        if (arg0) {
            throw new NullPointerException();
        }
        if (var5.field1068) {
