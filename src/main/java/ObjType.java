...
public class ObjType {
    ...
    @OriginalMember(owner = "client!hc", name = "X", descriptor = "Ls;")
    public static LruCache field1072 = new LruCache(false, 50);

    @OriginalMember(owner = "client!hc", name = "Y", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!hc", name = "f", descriptor = "Llb;")
    ...
    @OriginalMember(owner = "client!hc", name = "b", descriptor = "(I)Lhc;")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(Llb;B)V")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IIIB)Lib;")
    public static final Pix24 method348(int arg0, int arg1, int arg2, byte arg3) {
        if (arg2 == 0) {
            Pix24 var4 = (Pix24) field1073.method101((long) arg1);
        ...
        int var11 = Draw3D.field639;
        int var12 = Draw3D.field640;
        int[] var13 = Draw3D.field645;
        ...
        Draw2D.method151(32, 32, var10.field663, false);
        Draw2D.method156(0, 0, 32, 32, -37952, 0);
        ...
        int var22 = Draw3D.field643[var5.field1039] * var21 >> 16;
        int var23 = Draw3D.field644[var5.field1039] * var21 >> 16;
        ...
        Draw2D.method151(var15, var16, var14, false);
        Draw2D.method153(var19, var17, var18, var20, 297);
        Draw3D.field639 = var11;
        Draw3D.field640 = var12;
        Draw3D.field645 = var13;
