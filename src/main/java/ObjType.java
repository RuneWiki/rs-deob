...
public class ObjType {
    ...
    @OriginalMember(owner = "client!zb", name = "J", descriptor = "Ls;")
    public static LruCache field836 = new LruCache(-24094, 50);

    @OriginalMember(owner = "client!zb", name = "K", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!zb", name = "d", descriptor = "Lkb;")
    ...
    @OriginalMember(owner = "client!zb", name = "e", descriptor = "[Lzb;")
    ...
    @OriginalMember(owner = "client!zb", name = "a", descriptor = "(Lub;)V")
    ...
    @OriginalMember(owner = "client!zb", name = "b", descriptor = "(I)Lzb;")
    ...
    @OriginalMember(owner = "client!zb", name = "a", descriptor = "(ILkb;)V")
    ...
    @OriginalMember(owner = "client!zb", name = "b", descriptor = "()Leb;")
    ...
    @OriginalMember(owner = "client!zb", name = "a", descriptor = "(IB)Lhb;")
    public static final Pix24 method269(int arg0, byte arg1) {
        Pix24 var2 = (Pix24) field837.method99((long) arg0);
        if (var2 != null) {
            return var2;
        }
        ObjType var3 = method265(arg0);
        Pix24 var4 = new Pix24(32, 32);
        int var5 = Draw3D.field540;
        int var6 = Draw3D.field541;
        int[] var7 = Draw3D.field546;
        int[] var8 = Draw2D.field522;
        int var9 = Draw2D.field523;
        int var10 = Draw2D.field524;
        Draw3D.field538 = false;
        Draw2D.method141(32, var4.field565, 32, -810);
        Draw2D.method145(0, field801, 32, 0, 32, 0);
        Draw3D.method150((byte) 16);
        Model var11 = var3.method268();
        int var12 = Draw3D.field544[var3.field814] * var3.field813 >> 16;
        int var13 = Draw3D.field545[var3.field814] * var3.field813 >> 16;
        ...
        Draw2D.method141(var9, var8, var10, -810);
        Draw3D.field540 = var5;
        Draw3D.field541 = var6;
        Draw3D.field546 = var7;
        if (arg1 != -11) {
            throw new NullPointerException();
        }
        Draw3D.field538 = true;
        if (var3.field821) {
            var4.field570 = 33;
        } else {
            var4.field570 = 32;
    ...
    @OriginalMember(owner = "client!zb", name = "a", descriptor = "(II)Leb;")
    ...
    @OriginalMember(owner = "client!zb", name = "a", descriptor = "(BI)Leb;")
