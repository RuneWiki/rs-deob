...
public class ObjType {
    ...
    @OriginalMember(owner = "client!gc", name = "R", descriptor = "Lt;")
    public static LruCache field1019 = new LruCache(false, 50);

    @OriginalMember(owner = "client!gc", name = "S", descriptor = "Lt;")
    ...
    @OriginalMember(owner = "client!gc", name = "e", descriptor = "Lmb;")
    ...
    @OriginalMember(owner = "client!gc", name = "f", descriptor = "[Lgc;")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(Lyb;)V")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(I)Lgc;")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(ZLmb;)V")
    ...
    @OriginalMember(owner = "client!gc", name = "c", descriptor = "(I)Lfb;")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(II)Lfb;")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(III)Ljb;")
    public static final Pix24 method341(int arg0, int arg1, int arg2) {
        Pix24 var3 = (Pix24) field1020.method113((long) arg2);
        ...
        Pix24 var9 = new Pix24(32, 32);
        int var10 = Draw3D.field628;
        int var11 = Draw3D.field629;
        int[] var12 = Draw3D.field634;
        int[] var13 = Draw2D.field608;
        int var14 = Draw2D.field609;
        int var15 = Draw2D.field610;
        int var16 = Draw2D.field613;
        int var17 = Draw2D.field614;
        int var18 = Draw2D.field611;
        int var19 = Draw2D.field612;
        Draw3D.field626 = false;
        Draw2D.method161(32, (byte) 102, 32, var9.field651);
        Draw2D.method165(0, 32, 0, 32, (byte) 5, 0);
        Draw3D.method170((byte) 2);
        int var20 = Draw3D.field632[var4.field991] * var4.field990 >> 16;
        int var21 = Draw3D.field633[var4.field991] * var4.field990 >> 16;
        ...
        Draw2D.method161(var15, (byte) 102, var14, var13);
        Draw2D.method163(false, var16, var18, var19, var17);
        Draw3D.field628 = var10;
        Draw3D.field629 = var11;
        Draw3D.field634 = var12;
        Draw3D.field626 = true;
        if (var4.field998) {
            var9.field656 = 33;
        } else {
            var9.field656 = 32;
    ...
    @OriginalMember(owner = "client!gc", name = "c", descriptor = "(II)Lfb;")
    ...
    @OriginalMember(owner = "client!gc", name = "e", descriptor = "(II)Lfb;")
