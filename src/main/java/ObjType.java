...
public class ObjType {
    ...
    public static final Pix24 method292(int arg0, int arg1, int arg2) {
        Pix24 var3 = (Pix24) field929.method102((long) arg1);
        ...
        int[] var10 = Draw3D.field563;
        int[] var11 = Draw2D.field539;
        int var12 = Draw2D.field540;
        int var13 = Draw2D.field541;
        if (arg2 != 0) {
            throw new NullPointerException();
        }
        int var14 = Draw2D.field544;
        int var15 = Draw2D.field545;
        int var16 = Draw2D.field542;
        int var17 = Draw2D.field543;
        Draw3D.field555 = false;
        Draw2D.method145(var7.field580, 32, 32, (byte) 6);
        Draw2D.method149(0, 32, 0, 5, 0, 32);
        Draw3D.method154((byte) 0);
        Model var18 = var4.method291(1);
        int var19 = Draw3D.field561[var4.field902] * var4.field901 >> 16;
        int var20 = Draw3D.field562[var4.field902] * var4.field901 >> 16;
        ...
        if (var4.field927 != -1) {
            Pix24 var23 = method292(10, var4.field926, 0);
        ...
        Draw2D.method145(var11, var12, var13, (byte) 6);
        Draw2D.method147(var14, var16, var15, var17, 0);
        Draw3D.field557 = var8;
        Draw3D.field558 = var9;
        Draw3D.field563 = var10;
        Draw3D.field555 = true;
        if (var4.field909) {
            var7.field585 = 33;
        } else {
            var7.field585 = 32;
