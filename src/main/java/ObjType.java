...
public class ObjType {
    ...
    @OriginalMember(owner = "client!yb", name = "N", descriptor = "Lr;")
    public static LruCache field820 = new LruCache(-947, 50);

    @OriginalMember(owner = "client!yb", name = "O", descriptor = "Lr;")
    ...
    @OriginalMember(owner = "client!yb", name = "h", descriptor = "Ljb;")
    ...
    @OriginalMember(owner = "client!yb", name = "i", descriptor = "[Lyb;")
    ...
    @OriginalMember(owner = "client!yb", name = "a", descriptor = "(Ltb;)V")
    ...
    @OriginalMember(owner = "client!yb", name = "b", descriptor = "(I)Lyb;")
    ...
    @OriginalMember(owner = "client!yb", name = "a", descriptor = "(BLjb;)V")
    ...
    @OriginalMember(owner = "client!yb", name = "b", descriptor = "()Ldb;")
    ...
    @OriginalMember(owner = "client!yb", name = "a", descriptor = "(II)Lgb;")
    public static final Pix24 method253(int arg0, int arg1) {
        Pix24 var2 = (Pix24) field821.method84((long) arg0);
        if (var2 != null) {
            return var2;
        }
        ObjType var3 = method249(arg0);
        Pix24 var4 = new Pix24(32, 32, 0);
        int var5 = Draw3D.field525;
        int var6 = Draw3D.field526;
        int[] var7 = Draw3D.field531;
        int[] var8 = Draw2D.field506;
        int var9 = Draw2D.field507;
        int var10 = Draw2D.field508;
        Draw3D.field523 = false;
        Draw2D.method127(field782, 32, var4.field547, 32);
        Draw2D.method131(0, 32, 0, false, 32, 0);
        Draw3D.method136((byte) -111);
        Model var11 = var3.method252();
        int var12 = Draw3D.field529[var3.field798] * var3.field797 >> 16;
        int var13 = Draw3D.field530[var3.field798] * var3.field797 >> 16;
        ...
        Draw2D.method127(field782, var9, var8, var10);
        Draw3D.field525 = var5;
        Draw3D.field526 = var6;
        Draw3D.field531 = var7;
        Draw3D.field523 = true;
        if (arg1 != -25063) {
    ...
    @OriginalMember(owner = "client!yb", name = "a", descriptor = "(IB)Ldb;")
    ...
    @OriginalMember(owner = "client!yb", name = "b", descriptor = "(II)Ldb;")
