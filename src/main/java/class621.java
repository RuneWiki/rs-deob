...
public class class621 extends class76 {
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(Lha;JIIZ)V")
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(BLha;J)V")
    ...
    @OriginalMember(owner = "client!oea", name = "<init>", descriptor = "(Lha;Lnha;Lqo;J)V")
