...
public class class621 extends class555 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(I)Lag;")
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(I[B)Lnfa;")
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(B[[BLtp;)V")
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "(Lvfa;Lrq;IIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "([ILkc;BI)V")
