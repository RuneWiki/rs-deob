...
public class class621 extends class646 {
    ...
    @OriginalMember(owner = "client!qi", name = "<init>", descriptor = "()V", line = 3)
    public class621() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IIIIB)V", line = 6)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Lek;IB)V", line = 30)
    ...
    @OriginalMember(owner = "client!qi", name = "d", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(IB)[I", line = 68)
    ...
    @OriginalMember(owner = "client!qi", name = "d", descriptor = "(III)Z", line = 148)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Lr;IIIIIIZZ)V", line = 161)
