...
public class class621 extends class239 {
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "()V", line = 4)
    public class621() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(IIII)[B", line = 30)
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(Z)V", line = 45)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(BIB)V", line = 113)
