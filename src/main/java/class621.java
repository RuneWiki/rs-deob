...
public class class621 {
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!naa", name = "<init>", descriptor = "(I)V", line = 43)
