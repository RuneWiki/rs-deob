...
public class class621 extends class443 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(DIILn;ZLgp;I)[I", line = 12)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(III)Lkd;", line = 157)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(DIIZILgp;Ln;Z)[I", line = 165)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(I)V", line = 305)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILn;Lgp;)Z", line = 318)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Ln;Lgp;ZIII)[F", line = 371)
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "()V", line = 487)
    public class621() {
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(Lco;)V", line = 505)
