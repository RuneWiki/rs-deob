...
public class class621 {
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(Lvh;Lvh;II)Llm;", line = 3)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(B)V", line = 24)
    public static void method3395(byte arg0) {
        int var1 = 112 % ((50 - arg0) / 53);
        field8441 = null;
    }

    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(Lhc;Z)Z", line = 34)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(Lvh;IZLvh;Z)Llm;", line = 144)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(I)Z", line = 192)
    ...
    @OriginalMember(owner = "client!lda", name = "b", descriptor = "(I)V", line = 272)
    ...
    @OriginalMember(owner = "client!lda", name = "<init>", descriptor = "(Lkl;Lmca;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", line = 304)
