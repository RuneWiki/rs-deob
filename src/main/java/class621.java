...
public class class621 {
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IILig;)V")
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ILig;)V")
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(Ltp;ILha;II)V")
