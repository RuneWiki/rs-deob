...
public class class621 extends class501 {
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(Lgw;B)V", line = 6)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(ZLgw;I)V", line = 26)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(IZ)V", line = 79)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(I[B)Lod;", line = 146)
