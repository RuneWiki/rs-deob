...
public class class621 implements class385 {
    ...
    @OriginalMember(owner = "client!pea", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(I[B)Z", line = 19)
    ...
    @OriginalMember(owner = "client!pea", name = "c", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(III)I", line = 57)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(I)Z", line = 70)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(ZI)V", line = 88)
    ...
    @OriginalMember(owner = "client!pea", name = "<init>", descriptor = "(Lgga;Lrm;)V", line = 114)
