...
public class class621 {
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(BIILufa;)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lufa;IILcu;IIIILsa;ILoa;I)Lba;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lhb;Lsa;ILoa;Ltr;Lcu;Lufa;ILada;III)Lba;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IILtr;I)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(BILtr;ILufa;IILcu;Lsa;Lhb;ILada;Liu;[Lrf;ZILcu;ILoa;)Lba;")
