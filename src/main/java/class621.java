...
public class class621 extends class656 {
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(BD)V", line = 3)
    ...
    @OriginalMember(owner = "client!kia", name = "<init>", descriptor = "(Lpda;)V", line = 103)
    public class621(class630 arg0) {
        this.field8275 = arg0;
    }

    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(IIIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(III)Z", line = 68)
