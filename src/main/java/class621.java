...
public class class621 extends class551 {
    ...
    @OriginalMember(owner = "client!tg", name = "g", descriptor = "(I)I", line = 6)
    public final int method3591(int arg0) {
        ++field9067;
        return arg0 != -20163 ? -105 : (int) (255L & super.field7465 >>> 32);
    }

    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!tg", name = "h", descriptor = "(I)I", line = 33)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(B)J", line = 44)
    ...
    @OriginalMember(owner = "client!tg", name = "c", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IZZ)V", line = 68)
    ...
    @OriginalMember(owner = "client!tg", name = "d", descriptor = "(B)V", line = 107)
    ...
    @OriginalMember(owner = "client!tg", name = "i", descriptor = "(I)V", line = 212)
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(II)V", line = 226)
