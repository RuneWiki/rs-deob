...
public abstract class class621 extends class61 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lha;B)Z")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Ljava/awt/Component;ILlc;II)Lnj;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(B[Lkp;)I")
