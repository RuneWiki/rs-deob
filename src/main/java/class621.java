...
public class class621 implements class122 {
    ...
    @OriginalMember(owner = "client!et", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(II)V", line = 26)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ILfw;I)V", line = 51)
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(B)Z", line = 99)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ILkf;IB)V", line = 120)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IILbja;IB)V", line = 153)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(I)V", line = 186)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(BI)V", line = 201)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Z)I", line = 217)
    ...
    @OriginalMember(owner = "client!et", name = "c", descriptor = "(I)V", line = 237)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IILkf;)V", line = 250)
    ...
    @OriginalMember(owner = "client!et", name = "e", descriptor = "(I)V", line = 261)
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(Lhk;)V", line = 327)
    ...
    @OriginalMember(owner = "client!et", name = "finalize", descriptor = "()V", line = 280)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IILbja;I)V", line = 290)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ZI)V", line = 309)
