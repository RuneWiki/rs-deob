...
public class class621 {
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(II)I", line = 13)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Throwable;B)V", line = 62)
