...
public class class621 {
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IB)Lnm;", line = 5)
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(IB)V", line = 36)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Z)V", line = 63)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(ZBI)I", line = 75)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IIIILkn;)V", line = 128)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Ljava/lang/String;IIJIBLjava/lang/String;ZIIZ)V", line = 162)
    ...
    @OriginalMember(owner = "client!qi", name = "<init>", descriptor = "(Lsea;ILmv;Lmv;)V", line = 189)
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(I)[I", line = 208)
