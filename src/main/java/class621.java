...
public class class621 implements class534 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lql;[II)V", line = 3)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILql;Z)Z", line = 10)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;[ILql;)V", line = 18)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lka;IIIZ)V", line = 25)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;IIIIIII[[Z)V", line = 28)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lql;[III)V", line = 32)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILql;ZI)Z", line = 37)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;III)V", line = 41)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "()V", line = 47)
    public final void method3583() {
        this.field8713 = Thread.currentThread();
        this.method3591();
    }

    @OriginalMember(owner = "client!a", name = "b", descriptor = "()V", line = 51)
    private final void method3584() {
        this.method3571(this.nativeid);
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Li;BIZ)Lka;", line = 56)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lha;IIIIIII)V", line = 100)
    ...
    @OriginalMember(owner = "client!a", name = "c", descriptor = "()V", line = 104)
    public final void method3588() {
        this.field8713 = null;
        this.method3584();
    }

    @OriginalMember(owner = "client!a", name = "finalize", descriptor = "()V", line = 108)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lha;[I[I[I[SI)V", line = 126)
