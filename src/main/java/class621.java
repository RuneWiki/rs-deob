...
public class class621 extends class26 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(B)Lgp;", line = 6)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IIIILih;Lha;)V", line = 17)
    ...
    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(Lpf;Ldg;IIIIIIIIIIIIII)V", line = 69)
