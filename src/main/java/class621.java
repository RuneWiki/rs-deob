...
public class class621 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Ljagdx/IDirect3DSwapChain;ILjagdx/IDirect3DSurface;)V")
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V")
