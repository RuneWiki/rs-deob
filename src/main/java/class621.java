...
public class class621 implements class21 {
    ...
    @OriginalMember(owner = "client!ica", name = "<init>", descriptor = "(ILrt;Lcp;II)V", line = 13)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(B)Los;", line = 27)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(Leh;IZLii;)V", line = 39)
