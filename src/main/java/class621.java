...
public class class621 {
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(IFZIBIII)[I", line = 9)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!waa", name = "finalize", descriptor = "()V", line = 50)
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "(Lrs;JI)V", line = 59)
