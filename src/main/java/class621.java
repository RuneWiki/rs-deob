...
public class class621 extends class212 {
    ...
    @OriginalMember(owner = "client!kia", name = "b", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!kia", name = "d", descriptor = "(I)I", line = 19)
    public final int method3539(int arg0) {
        ++field8451;
        return arg0 != -32350 ? -65 : super.field3006;
    }

    @OriginalMember(owner = "client!kia", name = "e", descriptor = "(I)Z", line = 32)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(Z)V", line = 49)
    ...
    @OriginalMember(owner = "client!kia", name = "b", descriptor = "(II)I", line = 76)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(II)V", line = 98)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 108)
    ...
    @OriginalMember(owner = "client!kia", name = "<init>", descriptor = "(ILdh;)V", line = 122)
    public class621(int arg0, class322 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!kia", name = "f", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!kia", name = "<init>", descriptor = "(Ldh;)V", line = 138)
