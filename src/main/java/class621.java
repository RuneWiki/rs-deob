...
public class class621 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IZLor;I)V", line = 29)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(I)I", line = 53)
    public static final int method3410(int arg0) {
        field8366++;
        return ~class669.field9399 == arg0 ? class107.field1479 : 0;
    }

    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Ld;Lha;B)V", line = 70)
