...
public class class621 extends class473 {
    ...
    @OriginalMember(owner = "client!nfa", name = "b", descriptor = "(ZZ)Ltfa;")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(ILdj;)V")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "([BILvj;BII)Lte;")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(IZI[IZII)Lae;")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(I[BIZILvj;II)Lae;")
    ...
    @OriginalMember(owner = "client!nfa", name = "p", descriptor = "()Lhl;")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(IBLtfa;)V")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(ILeh;)V")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(IBILvj;Lnb;)Lae;")
    ...
    @OriginalMember(owner = "client!nfa", name = "e", descriptor = "(II)Lor;")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(ILcea;IZ)V")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Lvj;Lnb;B)Z")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Ldga;Ldga;FLdga;)Ldga;")
    public final class190 method290(class190 arg0, class190 arg1, float arg2, class190 arg3) {
        ++field8764;
        return !(arg2 < 0.5F) ? arg1 : arg0;
    }

    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(ZZLcea;II)V")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(IIBLvd;Ltj;II)V")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(IIILvd;)V")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Lvj;Lnb;I)Z")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Z[[III)Lvfa;")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(I[FZIIZILvj;)Lae;")
    ...
    @OriginalMember(owner = "client!nfa", name = "<init>", descriptor = "(Ljaggl/OpenGL;Ljava/awt/Canvas;JLe;Ljo;I)V")
    ...
    @OriginalMember(owner = "client!nfa", name = "b", descriptor = "(BZ)Ltj;")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(B[Lada;)Leh;")
