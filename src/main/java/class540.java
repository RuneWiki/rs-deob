...
public class class540 extends class153 {
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(ILha;Luv;)V", line = 33)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(III)Lki;", line = 57)
