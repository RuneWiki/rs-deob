...
public class class540 extends class354 {
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "(ILwo;)V", line = 22)
    public class540(int arg0, class746 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ur", name = "c", descriptor = "(I)I", line = 28)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(I)V", line = 177)
    ...
    @OriginalMember(owner = "client!ur", name = "c", descriptor = "(II)V", line = 196)
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "(Lwo;)V", line = 207)
    public class540(class746 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ur", name = "d", descriptor = "(I)Z", line = 211)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(III)I", line = 225)
    ...
    @OriginalMember(owner = "client!ur", name = "e", descriptor = "(I)V", line = 250)
    ...
    @OriginalMember(owner = "client!ur", name = "c", descriptor = "(B)I", line = 268)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(B)I", line = 282)
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(II)I", line = 293)
    ...
    @OriginalMember(owner = "client!ur", name = "f", descriptor = "(I)V", line = 308)
