...
public class class540 extends class377 {
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IB)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!nf", name = "b", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IILji;)V", line = 75)
    ...
    @OriginalMember(owner = "client!nf", name = "b", descriptor = "(II)V", line = 111)
    ...
    @OriginalMember(owner = "client!nf", name = "<init>", descriptor = "()V", line = 362)
    public class540() {
        super(1, false);
    }

    @OriginalMember(owner = "client!nf", name = "f", descriptor = "(I)V", line = 365)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(Z)V", line = 383)
    ...
    @OriginalMember(owner = "client!nf", name = "b", descriptor = "(Z)V", line = 487)
