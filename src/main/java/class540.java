...
public class class540 extends class56 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IZ)[I", line = 4)
    ...
    @OriginalMember(owner = "client!ac", name = "e", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIZ)I", line = 86)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ILee;I)V", line = 101)
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "()V", line = 146)
    public class540() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(I)V", line = 151)
