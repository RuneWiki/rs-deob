...
public class class540 extends class136 {
    ...
    @OriginalMember(owner = "client!ot", name = "BA", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(III[[ZZ)V", line = 69)
    ...
    @OriginalMember(owner = "client!ot", name = "aa", descriptor = "(Lw;IIIIZ)V", line = 77)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IIIIIII[[Z)V", line = 95)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Lmv;III)V", line = 267)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Len;IIII[[I[[II)V", line = 329)
    ...
    @OriginalMember(owner = "client!ot", name = "sa", descriptor = "(II)I", line = 396)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(II)V", line = 421)
    public final void method280(int arg0, int arg1) {
        ++field7352;
    }

    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IILjava/lang/String;)V", line = 441)
    ...
    @OriginalMember(owner = "client!ot", name = "c", descriptor = "(IILw;)Lw;", line = 520)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(III)B", line = 549)
    ...
    @OriginalMember(owner = "client!ot", name = "EA", descriptor = "(III)V", line = 568)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(I)V", line = 580)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(I[[ZZBIII)V", line = 590)
    ...
    @OriginalMember(owner = "client!ot", name = "FA", descriptor = "(Lw;IIIIZ)V", line = 732)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ILuq;IB)J", line = 749)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 786)
    ...
    @OriginalMember(owner = "client!ot", name = "JA", descriptor = "(II)I", line = 880)
    public final int method273(int arg0, int arg1) {
        ++field7343;
        return this.field7353[arg0][arg1];
    }

    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Lld;[I)V", line = 906)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Lw;IIIIZ)Z", line = 916)
    ...
    @OriginalMember(owner = "client!ot", name = "ba", descriptor = "()V", line = 937)
