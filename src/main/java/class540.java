...
public class class540 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Loa;Ljava/lang/String;[IIIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "()I", line = 24)
    public final int method3041() {
        return this.field7392 - 1;
    }

    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Loa;Ljava/lang/String;IIIZ)V", line = 30)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Loa;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 48)
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "()I", line = 138)
    public final int method3044() {
        return this.field7390;
    }

    @OriginalMember(owner = "client!ek", name = "c", descriptor = "()V", line = 141)
    public static void method3045() {
        field7397 = null;
    }

    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Ljava/lang/String;)I", line = 146)
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "(Loa;IZLjava/awt/Component;)V", line = 173)
