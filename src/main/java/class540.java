...
public class class540 {
    ...
    @OriginalMember(owner = "client!gq", name = "d", descriptor = "(I)Lcja;")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(BLcja;)V")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Z)Lcja;")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(I)Lcja;")
