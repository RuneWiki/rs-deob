...
public class class540 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 9)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IIBII)V", line = 70)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(III)V", line = 86)
