...
public class class540 extends class535 {
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "()V", line = 10)
    public class540() {
        super(1, false);
    }

    @OriginalMember(owner = "client!lo", name = "c", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(II)[[I", line = 32)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lwn;I)Lpn;", line = 126)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ILwn;I)V", line = 168)
