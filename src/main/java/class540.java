...
public class class540 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(II)Lsaa;", line = 33)
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "(Lkga;Lfa;)V", line = 98)
