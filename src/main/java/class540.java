...
public class class540 extends class67 {
    ...
    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(I)[B", line = 8)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(I[B)V", line = 21)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(III)[B", line = 36)
