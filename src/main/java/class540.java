...
public abstract class class540 implements class396 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Lha;ILmea;)I", line = 3)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ZI)V", line = 28)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(ZI)V", line = 50)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(BI)V", line = 123)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(BLjava/lang/String;)V", line = 141)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(I)Z", line = 152)
    ...
    @OriginalMember(owner = "client!gq", name = "c", descriptor = "(I)I", line = 173)
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Luq;Luq;Lcd;)V", line = 227)
