...
public class class540 extends class65 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(III)I", line = 15)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(I)V", line = 31)
