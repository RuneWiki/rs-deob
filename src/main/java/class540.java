...
public class class540 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IB[I)Ljp;")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(I[III)Ljp;")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "([III)Ljp;")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(II[II)Ljp;")
    ...
    @OriginalMember(owner = "client!f", name = "<init>", descriptor = "(Luu;Luu;)V")
