...
public class class540 {
    ...
    @OriginalMember(owner = "client!dn", name = "d", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!dn", name = "e", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!dn", name = "f", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!dn", name = "c", descriptor = "(B)V", line = 47)
