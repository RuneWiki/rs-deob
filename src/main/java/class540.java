...
public class class540 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lha;Lrc;)V")
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(Lha;Lrc;)V")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lha;IIIIII)V")
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!rc", name = "c", descriptor = "(Lha;Lrc;)Z")
    public final boolean method3169(class60 arg0, class540 arg1) {
        return this.field7712 != null || this.method3170(arg0, arg1);
    }

    @OriginalMember(owner = "client!rc", name = "d", descriptor = "(Lha;Lrc;)Z")
