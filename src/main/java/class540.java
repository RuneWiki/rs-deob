...
public class class540 implements class236 {
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(I)Ltca;", line = 15)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(III)Z", line = 42)
    ...
    @OriginalMember(owner = "client!fda", name = "<init>", descriptor = "(ILtl;Lfn;IIIIIIIZ)V", line = 59)
