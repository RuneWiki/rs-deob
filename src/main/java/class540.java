...
public class class540 extends class210 implements class526 {
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!pf", name = "g", descriptor = "(I)Z", line = 14)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ILr;)Lcr;", line = 26)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Lr;Z)V", line = 36)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIILr;)Z", line = 61)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Lvv;IIZLr;II)V", line = 81)
    ...
    @OriginalMember(owner = "client!pf", name = "f", descriptor = "(I)I", line = 92)
    ...
    @OriginalMember(owner = "client!pf", name = "i", descriptor = "(B)V", line = 104)
    public static void method3050(byte arg0) {
        field7304 = null;
        int var1 = -69 % ((arg0 - -19) / 49);
    }

    @OriginalMember(owner = "client!pf", name = "d", descriptor = "(I)I", line = 114)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Z)I", line = 128)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Lr;I)V", line = 141)
    ...
    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "(Lr;Ljs;IIIIIZIIIIIII)V", line = 152)
    ...
    @OriginalMember(owner = "client!pf", name = "i", descriptor = "(I)V", line = 171)
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(Lr;I)Lbca;", line = 182)
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(I)Z", line = 234)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(I)V", line = 248)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(B)I", line = 260)
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(Z)Z", line = 272)
    public final boolean method216(boolean arg0) {
        ++field7282;
        return !arg0 ? false : false;
    }

    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(BLr;)V", line = 283)
    ...
    @OriginalMember(owner = "client!pf", name = "e", descriptor = "(B)Z", line = 301)
