...
public class class540 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(I[I)Ljava/lang/String;", line = 24)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(I)Lft;", line = 77)
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(Lrda;I)V", line = 90)
    public class540(class663 arg0, int arg1) {
        this.field7151 = OpenGL.glGenLists(arg1);
    }

    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(II)V", line = 105)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(BC)V", line = 116)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(III)V", line = 127)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(B)V", line = 215)
