...
public class class540 implements class344 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(B)Ldca;", line = 13)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Lfda;I)V", line = 44)
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(Lwm;Ljava/lang/String;)V", line = 418)
