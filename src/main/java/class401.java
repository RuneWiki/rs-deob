...
public class class401 {
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(B)Ldk;", line = 7)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Lhb;)V", line = 33)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Lbt;I)V", line = 103)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(ILbt;I)V", line = 145)
