...
public class class401 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lun;I)V", line = 60)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(BILun;)V", line = 103)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IIIIIIIIIILga;)Z", line = 336)
