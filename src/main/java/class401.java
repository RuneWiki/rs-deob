...
public class class401 extends class601 {
    ...
    @OriginalMember(owner = "client!jc", name = "d", descriptor = "(I)J", line = 3)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(Z)V", line = 37)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(BJ)I", line = 51)
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "()V", line = 115)
    public class401() {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Z)J", line = 87)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(B)J", line = 103)
