...
public class class401 extends class111 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ZLgf;)I", line = 5)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IIZZLgf;)V", line = 42)
    ...
    @OriginalMember(owner = "client!ss", name = "d", descriptor = "(II)V", line = 81)
    ...
    @OriginalMember(owner = "client!ss", name = "eb", descriptor = "(I)Z", line = 91)
    ...
    @OriginalMember(owner = "client!ss", name = "g", descriptor = "(Z)V", line = 130)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IILob;Lft;III)V", line = 141)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ZLts;)V", line = 157)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ZI[[II)Lul;", line = 169)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ZLjava/lang/Object;Ljava/awt/Canvas;)V", line = 179)
    ...
    @OriginalMember(owner = "client!ss", name = "v", descriptor = "(I)V", line = 189)
    ...
    @OriginalMember(owner = "client!ss", name = "c", descriptor = "(B)V", line = 200)
    ...
    @OriginalMember(owner = "client!ss", name = "cb", descriptor = "(I)V", line = 230)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lxa;Z)V", line = 243)
    public final void method80(class468 arg0, boolean arg1) {
    }

    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lhi;ZLne;)Z", line = 247)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "([FIZIIILhi;B)Lak;", line = 258)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ZLsk;)V", line = 268)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IIIIILhi;[BZ)Lak;", line = 292)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lhi;Lne;I)Z", line = 303)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lob;B)I", line = 316)
    ...
    @OriginalMember(owner = "client!ss", name = "d", descriptor = "(ZI)Leu;", line = 350)
    public final class448 method108(boolean arg0, int arg1) {
        return arg1 == 15918 ? new class494(this, arg0) : (class448) null;
    }

    @OriginalMember(owner = "client!ss", name = "P", descriptor = "(I)F", line = 360)
    ...
    @OriginalMember(owner = "client!ss", name = "k", descriptor = "(B)V", line = 374)
    ...
    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(Ljava/lang/Object;Ljava/awt/Canvas;I)V", line = 392)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lnn;B)V", line = 416)
    ...
    @OriginalMember(owner = "client!ss", name = "w", descriptor = "(I)V", line = 455)
    ...
    @OriginalMember(owner = "client!ss", name = "C", descriptor = "(I)V", line = 466)
    ...
    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/bea;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Lkfa;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Le;Lbi;I)V", line = 921)
    ...
    @OriginalMember(owner = "client!ss", name = "D", descriptor = "(I)V", line = 490)
    public final void method87(int arg0) {
        this.field5342.Clear(1, arg0, 0.0F, 0);
    }

    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ILjava/awt/Canvas;)Ljava/lang/Object;", line = 498)
    ...
    @OriginalMember(owner = "client!ss", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Le;Lbi;Ljava/lang/Integer;)Loa;", line = 509)
    ...
    @OriginalMember(owner = "client!ss", name = "V", descriptor = "(I)V", line = 610)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(BIILob;)V", line = 624)
    ...
    @OriginalMember(owner = "client!ss", name = "KA", descriptor = "(IIII)[I", line = 637)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Ljava/lang/Object;Ljava/awt/Canvas;I)V", line = 678)
    public final void method81(Object arg0, Canvas arg1, int arg2) {
        this.field5326 = (class564) arg0;
        int var4 = 112 % ((77 - arg2) / 35);
    }

    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(BI)Llu;", line = 688)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 724)
    public final void method86(Rectangle[] arg0, int arg1) throws class26 {
        this.method97();
    }

    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(IZ)V", line = 731)
    ...
    @OriginalMember(owner = "client!ss", name = "r", descriptor = "(I)V", line = 742)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Ldn;Ldn;FLdn;)Ldn;", line = 779)
    public final class483 method49(class483 arg0, class483 arg1, float arg2, class483 arg3) {
        return arg2 < 0.5F ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Ljagdx/D3DPRESENT_PARAMETERS;IILjagdx/IDirect3D;II)Z", line = 787)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lne;IILhi;I)Lak;", line = 893)
    ...
    @OriginalMember(owner = "client!ss", name = "z", descriptor = "(I)V", line = 906)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IIII)V", line = 919)
    public final void method51(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!ss", name = "h", descriptor = "(Z)V", line = 970)
    ...
    @OriginalMember(owner = "client!ss", name = "j", descriptor = "()V", line = 981)
    public final void method38() {
        this.method826(true, 66);
        this.field5342.Clear(2, 0, 1.0F, 0);
    }

    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(FFF)V", line = 988)
    public final void method70(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!ss", name = "ab", descriptor = "(I)V", line = 992)
    ...
    @OriginalMember(owner = "client!ss", name = "j", descriptor = "(B)V", line = 1002)
    ...
    @OriginalMember(owner = "client!ss", name = "v", descriptor = "(B)V", line = 1039)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(BIZI[III)Lak;", line = 1049)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lnea;B)I", line = 1059)
    ...
    @OriginalMember(owner = "client!ss", name = "SA", descriptor = "()I", line = 1088)
    public final int method104() {
        return 0;
    }

    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(Lhi;Lne;I)I", line = 1095)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lgf;ZBI)V", line = 1137)
    ...
    @OriginalMember(owner = "client!ss", name = "e", descriptor = "(I)V", line = 1181)
    public final synchronized void method52(int arg0) {
        this.field5340.method3486((byte) 21);
        super.method52(arg0);
    }

    @OriginalMember(owner = "client!ss", name = "t", descriptor = "(B)V", line = 1191)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(BLeea;)V", line = 1201)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lmf;Z)V", line = 1224)
    ...
    @OriginalMember(owner = "client!ss", name = "r", descriptor = "(B)V", line = 1249)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ZI)Lft;", line = 1259)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(I[Lca;)Lts;", line = 1269)
    public final class501 method45(int arg0, class282[] arg1) {
        return arg0 == 1 ? new dxVertexLayout(this, arg1) : (class501) null;
    }

    @OriginalMember(owner = "client!ss", name = "n", descriptor = "(I)V", line = 1279)
    ...
    @OriginalMember(owner = "client!ss", name = "E", descriptor = "()Z", line = 1309)
    public final boolean method96() {
        return false;
    }

    @OriginalMember(owner = "client!ss", name = "q", descriptor = "(I)V", line = 1316)
    public final void method85(int arg0) {
        this.method94(-122);
        this.method31(arg0 ^ arg0);
    }

    @OriginalMember(owner = "client!ss", name = "e", descriptor = "()V", line = 1324)
    public final void method76() {
    }

    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(BLeu;I)V", line = 1331)
    ...
    @OriginalMember(owner = "client!ss", name = "h", descriptor = "()V", line = 1343)
    ...
    @OriginalMember(owner = "client!ss", name = "j", descriptor = "(I)V", line = 1368)
    ...
    @OriginalMember(owner = "client!ss", name = "x", descriptor = "(I)V", line = 1403)
    ...
    @OriginalMember(owner = "client!ss", name = "i", descriptor = "(B)V", line = 1413)
    ...
    @OriginalMember(owner = "client!ss", name = "b", descriptor = "()V", line = 1423)
    public final void method107() {
    }

    @OriginalMember(owner = "client!ss", name = "f", descriptor = "(Z)V", line = 1427)
    ...
    @OriginalMember(owner = "client!ss", name = "o", descriptor = "(I)V", line = 1438)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(B[BIILhi;I)Ljs;", line = 1470)
    ...
    @OriginalMember(owner = "client!ss", name = "A", descriptor = "()V", line = 1481)
    ...
    @OriginalMember(owner = "client!ss", name = "o", descriptor = "()Z", line = 1505)
    public final boolean method93() {
        return false;
    }

    @OriginalMember(owner = "client!ss", name = "l", descriptor = "(I)V", line = 1514)
    ...
    @OriginalMember(owner = "client!ss", name = "t", descriptor = "()V", line = 1524)
    public final void method30() {
    }

    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(Z)V", line = 1527)
    public final void method33(boolean arg0) {
    }

    @OriginalMember(owner = "client!ss", name = "m", descriptor = "()V", line = 1533)
    public final void method56() {
        this.field5340.method3485((byte) -77);
        super.method56();
    }

    @OriginalMember(owner = "client!ss", name = "M", descriptor = "(I)V", line = 1543)
    ...
    @OriginalMember(owner = "client!ss", name = "x", descriptor = "()Lffa;", line = 1582)
    ...
    @OriginalMember(owner = "client!ss", name = "u", descriptor = "(B)V", line = 1593)
    ...
    @OriginalMember(owner = "client!ss", name = "j", descriptor = "(Z)V", line = 1603)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ILcba;)I", line = 1614)
    ...
    @OriginalMember(owner = "client!ss", name = "n", descriptor = "()V", line = 1631)
    public final void method29() {
    }

    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Leb;B)I", line = 1634)
