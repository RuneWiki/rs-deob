...
public class class401 extends class119 {
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(BII)V", line = 50)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(BJ)Ljava/lang/String;", line = 72)
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(IIIIIII)V", line = 97)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IBI)V", line = 120)
