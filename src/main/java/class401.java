...
public class class401 extends class413 implements class191 {
    ...
    @OriginalMember(owner = "client!dda", name = "<init>", descriptor = "(Lsd;Leu;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(I[BIIIIILeu;I)V")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(ZLli;)V")
    ...
    @OriginalMember(owner = "client!dda", name = "<init>", descriptor = "(Lsd;Leu;Lpj;II)V")
    ...
    @OriginalMember(owner = "client!dda", name = "<init>", descriptor = "(Lsd;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!dda", name = "c", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;")
