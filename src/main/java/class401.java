...
public class class401 extends class227 {
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Ljava/lang/String;Z)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IBI)Z", line = 56)
    ...
    @OriginalMember(owner = "client!qi", name = "c", descriptor = "(III)Z", line = 70)
    ...
    @OriginalMember(owner = "client!qi", name = "j", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(II)[I", line = 99)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(I[BII)I", line = 131)
    ...
    @OriginalMember(owner = "client!qi", name = "d", descriptor = "(III)I", line = 155)
    ...
    @OriginalMember(owner = "client!qi", name = "<init>", descriptor = "()V", line = 169)
    public class401() {
        super(0, true);
    }
}
