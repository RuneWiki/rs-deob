...
public class class401 extends class86 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "([I)Lhh;")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(Lhe;)Z")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(Lhe;I)Lnu;")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(Lhe;II)Lnu;")
