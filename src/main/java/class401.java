...
public class class401 extends class501 implements class161 {
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Lza;B)V", line = 13)
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "(Lza;Lii;IIIIZIIZ)V", line = 41)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Lza;IIILps;IZ)V", line = 78)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Lza;IZ)Le;", line = 113)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(ILza;IZ)Lhw;", line = 126)
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(ILza;)Lhp;", line = 158)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Lza;III)Z", line = 180)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IIIIIIILza;III[[[BI)V", line = 202)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(I)I", line = 237)
    ...
    @OriginalMember(owner = "client!kh", name = "c", descriptor = "(B)Z", line = 251)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(BLza;)V", line = 264)
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(I)I", line = 292)
    ...
    @OriginalMember(owner = "client!kh", name = "d", descriptor = "(I)V", line = 309)
    ...
    @OriginalMember(owner = "client!kh", name = "f", descriptor = "(I)V", line = 324)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(ZLza;I)Le;", line = 339)
    ...
    @OriginalMember(owner = "client!kh", name = "c", descriptor = "(I)V", line = 376)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(ILza;)V", line = 390)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(B)I", line = 403)
