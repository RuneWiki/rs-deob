...
public class class401 extends class299 {
    ...
    @OriginalMember(owner = "client!ab", name = "d", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Lvq;)V", line = 43)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(BI)V", line = 136)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(IIZII)V", line = 149)
