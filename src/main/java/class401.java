...
public class class401 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(ILkk;)Lf;", line = 16)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(IIIBIILpf;IIIII)Z", line = 33)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(B)V", line = 461)
    ...
    @OriginalMember(owner = "client!oh", name = "b", descriptor = "(B)V", line = 505)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "([II)Ljava/lang/String;", line = 653)
    ...
    @OriginalMember(owner = "client!oh", name = "b", descriptor = "(I)V", line = 705)
    ...
    @OriginalMember(owner = "client!oh", name = "c", descriptor = "(I)I", line = 718)
    ...
    @OriginalMember(owner = "client!oh", name = "d", descriptor = "(I)I", line = 738)
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "()V", line = 763)
    private class401() {
    }

    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "([I)V", line = 766)
