...
public class class401 extends class72 {
    ...
    @OriginalMember(owner = "client!wk", name = "d", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(IIBI)[B", line = 19)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(IC)Z", line = 36)
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "()V", line = 49)
    public class401() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(IBI)V", line = 52)
