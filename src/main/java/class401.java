...
public abstract class class401 implements class302 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Ljaclib/memory/Source;II)Z")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lmh;ILjava/lang/String;I)Lnb;")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(Ltm;IZ)V")
