...
public class class401 {
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Lgr;IIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(III[Lms;IZ)V", line = 77)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Ljava/lang/String;IILjava/lang/String;)I", line = 130)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(BLnq;)V", line = 261)
