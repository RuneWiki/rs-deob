...
public class class401 extends class190 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(ILnba;I)V")
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "([Lit;I)V")
    ...
    @OriginalMember(owner = "client!rb", name = "<init>", descriptor = "(Lrs;)V")
