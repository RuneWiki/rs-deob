...
public class class401 {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(BI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Z)V", line = 51)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(II)V", line = 69)
    ...
    @OriginalMember(owner = "client!aj", name = "c", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(BI)Ldt;", line = 103)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(III)V", line = 142)
    ...
    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(Lvd;ILpe;Lpe;)V", line = 166)
