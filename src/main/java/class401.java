...
public class class401 extends class542 {
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(BII)V", line = 18)
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IIB)V", line = 54)
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(II)V", line = 83)
    ...
    @OriginalMember(owner = "client!pu", name = "c", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(III)V", line = 168)
