...
public class class401 extends class62 {
    ...
    @OriginalMember(owner = "client!vaa", name = "h", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!vaa", name = "g", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(Lgw;II)V", line = 127)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(IB)[[I", line = 166)
    ...
    @OriginalMember(owner = "client!vaa", name = "<init>", descriptor = "()V", line = 218)
    public class401() {
        super(1, false);
    }

    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(IZ)V", line = 222)
    ...
    @OriginalMember(owner = "client!vaa", name = "i", descriptor = "(I)V", line = 475)
