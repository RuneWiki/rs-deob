...
public class class401 extends class184 {
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Loea;Lqr;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ZI)V", line = 43)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IZ)V", line = 54)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "([Ljava/lang/String;[SIII)V", line = 86)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IIZ)V", line = 145)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lud;I)V", line = 182)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(I)Z", line = 213)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(I)V", line = 224)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Liia;ZI)V", line = 240)
