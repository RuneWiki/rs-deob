...
public class class401 extends class656 {
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(BI)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!mt", name = "b", descriptor = "(BI)V", line = 13)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Lkf;[Ltn;)V", line = 57)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(B)V", line = 138)
    ...
    @OriginalMember(owner = "client!mt", name = "c", descriptor = "(B)V", line = 150)
    ...
    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "(II)V", line = 633)
