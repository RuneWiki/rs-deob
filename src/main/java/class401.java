...
public class class401 {
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!aha", name = "b", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(IB)Lni;", line = 61)
    ...
    @OriginalMember(owner = "client!aha", name = "c", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!aha", name = "d", descriptor = "(B)V", line = 142)
    ...
    @OriginalMember(owner = "client!aha", name = "<init>", descriptor = "(Ldt;ILwia;)V", line = 158)
    ...
    @OriginalMember(owner = "client!aha", name = "e", descriptor = "(B)Z", line = 178)
