...
public class class401 implements class175 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(I)Lqda;")
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(Loe;Lqda;Z)V")
