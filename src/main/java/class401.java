...
public abstract class class401 {
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(B)J", line = 4)
    public static final long method2503(byte arg0) {
        field5907++;
        return arg0 == -45 ? class272.field3828.method1696(-18931) : -58L;
    }

    @OriginalMember(owner = "client!tb", name = "c", descriptor = "(B)V", line = 19)
    public static void method2504(byte arg0) {
        field5909 = null;
        int var1 = -52 / ((-arg0 - 22) / 55);
    }

    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(IJ)I", line = 32)
