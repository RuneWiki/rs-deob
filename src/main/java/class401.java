...
public class class401 extends class269 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(CIIIZLi;II)V")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "([B[IIIIIIIIIIILi;II)V")
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(Lfg;Lgg;[Lho;[I[I)V")
