...
public class class401 extends class439 {
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(I[B)[B", line = 3)
    ...
    @OriginalMember(owner = "client!im", name = "c", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IB)I", line = 77)
    public static final int method2496(int arg0, byte arg1) {
        field5880++;
        return arg1 == 15 ? arg0 >>> 8 : -100;
    }

    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(IIIIIZ)V", line = 97)
