...
public class class401 extends class396 {
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(Lfd;IIZ[[BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!im", name = "f", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IIIBI)V", line = 35)
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(Lfd;IIZ[[I)V", line = 47)
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(Lfd;II)V", line = 91)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(I)V", line = 130)
