...
public class class401 extends class25 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "()Lhfa;")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IZ)Lio;")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Loa;J[Lbh;[Lvp;Z)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "([Lvp;Z)V")
    ...
    @OriginalMember(owner = "client!io", name = "c", descriptor = "()V")
    public static void method2283() {
        field5568 = null;
        field5576 = null;
    }

    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Loa;)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Loa;[Lbh;Z)V")
    ...
    @OriginalMember(owner = "client!io", name = "e", descriptor = "()Lhfa;")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Loa;J)Z")
