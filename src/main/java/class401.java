...
public class class401 {
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(BI)Ljava/lang/String;", line = 14)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(IIBIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(ZII)V", line = 127)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(IZ)Lek;", line = 140)
    ...
    @OriginalMember(owner = "client!eaa", name = "b", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(IB)V", line = 195)
    ...
    @OriginalMember(owner = "client!eaa", name = "c", descriptor = "(I)V", line = 211)
    ...
    @OriginalMember(owner = "client!eaa", name = "d", descriptor = "(I)V", line = 227)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(II)V", line = 266)
    ...
    @OriginalMember(owner = "client!eaa", name = "<init>", descriptor = "(Lega;ILwm;Lwm;)V", line = 308)
