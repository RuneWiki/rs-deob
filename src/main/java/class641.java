...
public class class641 extends class264 {
    ...
    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "(Lmfa;)V")
    public class641(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!aaa", name = "c", descriptor = "(I)Luja;")
    ...
    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "(ILmfa;)V")
