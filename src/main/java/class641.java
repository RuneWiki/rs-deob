...
public class class641 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(I)Z", line = 22)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IIZZZ)V", line = 95)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lmo;I)Lpr;", line = 123)
