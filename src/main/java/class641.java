...
public class class641 extends class416 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(I)Lcw;", line = 18)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Z)I", line = 35)
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(I)V", line = 48)
    public static void method3719(int arg0) {
        field8988 = null;
        int var1 = 89 % ((arg0 + 52) / 32);
    }

    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(I)V", line = 57)
