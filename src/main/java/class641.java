...
public class class641 extends class125 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(BLhg;)I", line = 3)
    ...
    @OriginalMember(owner = "client!l", name = "b", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(ILjava/awt/Canvas;IB)V", line = 96)
    ...
    @OriginalMember(owner = "client!l", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 122)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field9108;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IIBLjava/awt/Graphics;IIII)V", line = 129)
    ...
    @OriginalMember(owner = "client!l", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 147)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(BIIII)V", line = 162)
    ...
    @OriginalMember(owner = "client!l", name = "f", descriptor = "(I)V", line = 181)
    ...
    @OriginalMember(owner = "client!l", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 197)
    public final void startProduction(ImageConsumer arg0) {
        ++field9098;
        this.addConsumer(arg0);
    }

    @OriginalMember(owner = "client!l", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 207)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field9095;
        return this.field9100 == arg0;
    }

    @OriginalMember(owner = "client!l", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 222)
