...
public class class641 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ZLps;)Ltk;")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lbaa;IB)Z")
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(Los;)V")
