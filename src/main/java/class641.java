...
public class class641 extends class435 {
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(I)Lfu;", line = 7)
    ...
    @OriginalMember(owner = "client!fca", name = "b", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(BLek;)V", line = 61)
    ...
    @OriginalMember(owner = "client!fca", name = "c", descriptor = "(I)I", line = 105)
    ...
    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "()V", line = 128)
    public class641() {
    }

    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "(ZLwv;)V", line = 130)
