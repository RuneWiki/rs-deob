...
public abstract class class641 {
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(B)Lpl;")
    ...
    @OriginalMember(owner = "client!jf", name = "d", descriptor = "(I)Luc;")
    ...
    @OriginalMember(owner = "client!jf", name = "g", descriptor = "(I)Ljaa;")
    ...
    @OriginalMember(owner = "client!jf", name = "i", descriptor = "(I)Lij;")
