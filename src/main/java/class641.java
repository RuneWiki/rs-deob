...
public class class641 {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IB)I", line = 3)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(I[B)[B", line = 36)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(II)I", line = 105)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(III)Ljava/lang/String;", line = 162)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(BLns;)V", line = 206)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(I[S)[S", line = 570)
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(II)V", line = 647)
