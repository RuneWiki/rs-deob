...
public class class641 implements class288 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(I)Z", line = 42)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Z)I", line = 65)
    ...
    @OriginalMember(owner = "client!jm", name = "b", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;", line = 97)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(B)I", line = 118)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Ljaclib/memory/Source;III)Z", line = 130)
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(Lega;Z)V", line = 148)
