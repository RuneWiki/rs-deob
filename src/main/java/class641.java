...
public class class641 extends class634 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IIII)Lbda;")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IIILoh;BIZ)V")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ILig;Z)V")
