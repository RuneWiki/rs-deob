...
public class class641 extends class335 {
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(ZZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!iga", name = "b", descriptor = "(Z)V", line = 67)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(ILio;I)V", line = 107)
    ...
    @OriginalMember(owner = "client!iga", name = "c", descriptor = "(B)V", line = 140)
    ...
    @OriginalMember(owner = "client!iga", name = "<init>", descriptor = "()V", line = 380)
    public class641() {
        super(1, true);
    }

    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(B)V", line = 325)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(ILqw;)V", line = 350)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(BI)I", line = 383)
    ...
    @OriginalMember(owner = "client!iga", name = "d", descriptor = "(B)V", line = 394)
    ...
    @OriginalMember(owner = "client!iga", name = "e", descriptor = "(B)V", line = 448)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(IB)[I", line = 468)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(ZI)[I", line = 489)
