...
public class class641 extends class659 {
    ...
    @OriginalMember(owner = "client!mfa", name = "d", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(BLtd;)Z", line = 19)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!mfa", name = "b", descriptor = "(BLtd;)Z", line = 59)
    ...
    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 89)
    public class641(String arg0) {
        this.field8635 = arg0;
        this.field8636 = new class26();
    }

    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(III)Z", line = 105)
