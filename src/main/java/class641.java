...
public abstract class class641 extends class487 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Ljava/lang/String;ZC)I", line = 12)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 62)
