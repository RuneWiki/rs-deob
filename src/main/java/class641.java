...
public class class641 extends class299 {
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "([[BILpj;)V")
    ...
    @OriginalMember(owner = "client!te", name = "<init>", descriptor = "(ILes;)V")
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Ltia;[Ltaa;B)Lqs;")
    ...
    @OriginalMember(owner = "client!te", name = "<init>", descriptor = "(Les;)V")
