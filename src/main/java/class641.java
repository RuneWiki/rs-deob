...
public class class641 extends class5 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Llo;III)V")
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ILes;I)V")
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ILnw;)I")
