...
public class class641 extends class145 {
    ...
    @OriginalMember(owner = "client!kn", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "()V", line = 180)
    public class641() {
        super(0, true);
    }

    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(BLqf;II)V", line = 50)
    ...
    @OriginalMember(owner = "client!kn", name = "b", descriptor = "(B)V", line = 123)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IILrt;)V", line = 135)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(ZI)[I", line = 192)
