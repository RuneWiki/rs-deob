...
public class class641 extends class657 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ILdu;I)V")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lin;IZJIII)V")
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(Lbga;Lin;)V")
