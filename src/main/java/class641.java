...
public class class641 extends class340 {
    ...
    @OriginalMember(owner = "client!hg", name = "c", descriptor = "(I)Lsa;", line = 7)
    ...
    @OriginalMember(owner = "client!hg", name = "d", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "(Lkga;IIIIII)V", line = 103)
