...
public class class641 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ILfd;)V", line = 11)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Z)V", line = 34)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IILfd;)V", line = 47)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I)V", line = 114)
