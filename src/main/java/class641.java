...
public abstract class class641 {
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(IIIIIIIIIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!fca", name = "b", descriptor = "(BI)V", line = 37)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "()V", line = 68)
