...
public class class534 extends class463 {
    ...
    @OriginalMember(owner = "client!nw", name = "<init>", descriptor = "(IIIIIF)V", line = 5)
    public class534(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(IIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(IILep;)I", line = 23)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(ZF)V", line = 37)
    ...
    @OriginalMember(owner = "client!nw", name = "i", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(III[BIII)Z", line = 64)
