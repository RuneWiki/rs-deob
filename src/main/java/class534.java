...
public class class534 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(ILbia;Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "(Lpc;Lmj;Lcea;IIIII)V", line = 277)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lgda;IIIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(BI[BI)V", line = 142)
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(B)V", line = 266)
