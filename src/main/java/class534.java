...
public class class534 {
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Lraa;)B", line = 4)
    private static final byte method3221(class522 arg0) {
        return (byte) method3228(8, arg0);
    }

    @OriginalMember(owner = "client!eb", name = "a", descriptor = "()V", line = 7)
    public static void method3222() {
        field7947 = null;
    }

    @OriginalMember(owner = "client!eb", name = "a", descriptor = "([BI[BII)I", line = 12)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(Lraa;)B", line = 40)
    private static final byte method3224(class522 arg0) {
        return (byte) method3228(1, arg0);
    }

    @OriginalMember(owner = "client!eb", name = "c", descriptor = "(Lraa;)V", line = 52)
    ...
    @OriginalMember(owner = "client!eb", name = "d", descriptor = "(Lraa;)V", line = 207)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "([I[I[I[BIII)V", line = 230)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ILraa;)I", line = 300)
    ...
    @OriginalMember(owner = "client!eb", name = "e", descriptor = "(Lraa;)V", line = 329)
