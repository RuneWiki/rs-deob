...
public class class534 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!de", name = "b", descriptor = "(Z)V", line = 30)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ILjava/lang/Object;ZJ)V", line = 45)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(B)I", line = 79)
    ...
    @OriginalMember(owner = "client!de", name = "b", descriptor = "(B)Ljava/lang/Object;", line = 91)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(III[BII)V", line = 122)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(II)V", line = 153)
    ...
    @OriginalMember(owner = "client!de", name = "c", descriptor = "(B)I", line = 201)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(IJ)V", line = 213)
    ...
    @OriginalMember(owner = "client!de", name = "d", descriptor = "(B)I", line = 227)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 257)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ZII)Luca;", line = 288)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ILqc;)V", line = 304)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(BJLjava/lang/Object;)V", line = 323)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(IB)C", line = 337)
    ...
    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "(I)V", line = 362)
    public class534(int arg0) {
        this(arg0, arg0);
    }

    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "(II)V", line = 413)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(JI)Ljava/lang/Object;", line = 370)
