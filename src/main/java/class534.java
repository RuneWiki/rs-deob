...
public class class534 extends class540 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(ILrv;)Lfba;")
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IIIILkv;)Lbo;")
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Lli;B)V")
