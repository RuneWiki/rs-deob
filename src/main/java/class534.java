...
public class class534 extends class418 {
    ...
    @OriginalMember(owner = "client!cda", name = "f", descriptor = "(IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(II[BI)V", line = 18)
    ...
    @OriginalMember(owner = "client!cda", name = "l", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!cda", name = "D", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!cda", name = "m", descriptor = "(B)Z", line = 53)
    ...
    @OriginalMember(owner = "client!cda", name = "E", descriptor = "(I)I", line = 79)
    ...
    @OriginalMember(owner = "client!cda", name = "<init>", descriptor = "(I)V", line = 100)
    public class534(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!cda", name = "j", descriptor = "(II)I", line = 103)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(I[I)V", line = 115)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(BLcaa;)V", line = 127)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(IILnf;BII)V", line = 137)
    ...
    @OriginalMember(owner = "client!cda", name = "k", descriptor = "(II)I", line = 339)
    ...
    @OriginalMember(owner = "client!cda", name = "b", descriptor = "(Z)V", line = 373)
