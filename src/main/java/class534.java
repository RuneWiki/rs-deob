...
public class class534 extends class416 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(JI)I", line = 4)
    ...
    @OriginalMember(owner = "client!as", name = "b", descriptor = "(I)J", line = 37)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(I)J", line = 54)
    public final long method1351(int arg0) {
        return arg0 == 0 ? this.field7846 : 100L;
    }

    @OriginalMember(owner = "client!as", name = "b", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!as", name = "c", descriptor = "(B)J", line = 80)
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "()V", line = 117)
    public class534() {
