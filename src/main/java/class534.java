...
public class class534 extends class154 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(FI)V", line = 3)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IIIB)V", line = 24)
    ...
    @OriginalMember(owner = "client!qj", name = "e", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!qj", name = "f", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(IIIIIF)V", line = 72)
