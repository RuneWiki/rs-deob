...
public abstract class class534 {
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!iu", name = "b", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!iu", name = "c", descriptor = "(I)Z", line = 43)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Ljava/lang/String;I)[B", line = 63)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(B)Z", line = 95)
    ...
    @OriginalMember(owner = "client!iu", name = "d", descriptor = "(I)Z", line = 118)
