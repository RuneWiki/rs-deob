...
public class class534 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(B[B)[B", line = 6)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(ZIIII)Lcl;", line = 29)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(BILhd;I)V", line = 74)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(II)Lmv;", line = 89)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Z)V", line = 107)
