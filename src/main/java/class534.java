...
public class class534 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(II)V", line = 60)
