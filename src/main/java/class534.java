...
public class class534 extends class719 implements class722 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ILha;BI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ILha;)V", line = 25)
    ...
    @OriginalMember(owner = "client!tp", name = "g", descriptor = "(I)Z", line = 38)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Lgg;BZILha;II)V", line = 49)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(BLha;)Loia;", line = 59)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(I)I", line = 71)
    ...
    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(Lha;Lvha;IIIIIZIII)V", line = 82)
    ...
    @OriginalMember(owner = "client!tp", name = "c", descriptor = "(Lha;I)V", line = 91)
    ...
    @OriginalMember(owner = "client!tp", name = "f", descriptor = "(B)V", line = 118)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Z)Z", line = 129)
    ...
    @OriginalMember(owner = "client!tp", name = "b", descriptor = "(I)I", line = 143)
    public final int method685(int arg0) {
        ++field7235;
        return arg0 != 4657 ? -76 : this.field7251.field471;
    }

    @OriginalMember(owner = "client!tp", name = "c", descriptor = "(Z)I", line = 159)
    public final int method128(boolean arg0) {
        ++field7233;
        return arg0 ? -32 : this.field7251.method270((byte) -102);
    }

    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ILmg;)V", line = 170)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Lha;I)V", line = 183)
    ...
    @OriginalMember(owner = "client!tp", name = "d", descriptor = "(I)Z", line = 194)
    ...
    @OriginalMember(owner = "client!tp", name = "b", descriptor = "(B)I", line = 205)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(B)V", line = 218)
    ...
    @OriginalMember(owner = "client!tp", name = "h", descriptor = "(I)I", line = 229)
    ...
    @OriginalMember(owner = "client!tp", name = "d", descriptor = "(B)Z", line = 240)
    ...
    @OriginalMember(owner = "client!tp", name = "h", descriptor = "(B)V", line = 252)
    ...
    @OriginalMember(owner = "client!tp", name = "b", descriptor = "(Lha;I)Lbd;", line = 266)
