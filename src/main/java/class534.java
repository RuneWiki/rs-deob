...
public class class534 extends class261 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "([BB)Lgn;", line = 3)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(ZB)V", line = 82)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(III)V", line = 112)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Lpt;III)V", line = 140)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IZ)V", line = 167)
    public final void method1022(int arg0, boolean arg1) {
        int var3 = 45 % ((arg0 - 87) / 37);
        ++field7846;
    }

    @OriginalMember(owner = "client!nt", name = "d", descriptor = "(I)V", line = 179)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IILkk;)V", line = 205)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IBI)Z", line = 223)
    ...
    @OriginalMember(owner = "client!nt", name = "<init>", descriptor = "(Lih;Ljq;)V", line = 271)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(B)V", line = 247)
    ...
    @OriginalMember(owner = "client!nt", name = "c", descriptor = "(I)Z", line = 259)
