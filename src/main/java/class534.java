...
public class class534 {
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(II)Lrk;")
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "([IILhfa;[I[I)V")
    ...
    @OriginalMember(owner = "client!hj", name = "<init>", descriptor = "(Lpca;ILbi;)V")
