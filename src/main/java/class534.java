...
public class class534 extends class299 implements class697 {
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(I)Z", line = 21)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!ku", name = "d", descriptor = "(I)I", line = 47)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;", line = 58)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IBI)Z", line = 70)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "()V", line = 87)
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(B)V", line = 265)
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Lqi;Z)V", line = 276)
    public class534(class510 arg0, boolean arg1) {
        super(arg0, 34962, arg1);
    }

    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Ljaclib/memory/Source;III)Z", line = 279)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(ILua;ILjava/lang/String;Lla;Lwv;IIIIILaga;)V", line = 294)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(I)I", line = 341)
