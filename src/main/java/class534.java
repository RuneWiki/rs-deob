...
public class class534 extends class74 {
    ...
    @OriginalMember(owner = "client!jn", name = "<init>", descriptor = "(Len;Lbd;)V")
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(BLqi;)V")
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IILhfa;)V")
