...
public class class534 extends class601 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(I)Z", line = 13)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "(ILgn;)V", line = 42)
    public class534(int arg0, class699 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "(Lgn;)V", line = 45)
    public class534(class699 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ts", name = "c", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(II)I", line = 61)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(B)I", line = 100)
