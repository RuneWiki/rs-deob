...
public class class534 extends class184 implements class679 {
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(BF)F", line = 3)
    public final float method2135(byte arg0, float arg1) {
        ++field7226;
        return arg0 != -84 ? 0.009146209F : arg1 / (float) this.field7223;
    }

    @OriginalMember(owner = "client!uo", name = "g", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!uo", name = "h", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IIIIZILpn;I[B)V", line = 41)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(Ltba;Lpn;IIZ[BII)V", line = 59)
    ...
    @OriginalMember(owner = "client!uo", name = "c", descriptor = "(I)I", line = 83)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(Ltba;IIZ[III)V", line = 94)
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(I)I", line = 113)
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(BF)F", line = 125)
    public final float method2138(byte arg0, float arg1) {
        ++field7229;
        return arg0 <= 94 ? 0.97380596F : arg1 / (float) this.field7222;
    }

    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(Ltba;Lpn;Ljg;II)V", line = 136)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(I)Z", line = 148)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(III[IIIII)V", line = 160)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(ZIZ)V", line = 174)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IIIIIII[FLpn;)V", line = 188)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(Ltba;Lpn;IIZ[FII)V", line = 205)
