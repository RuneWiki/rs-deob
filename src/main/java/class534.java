...
public class class534 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "([BZ)[B", line = 7)
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "()V", line = 27)
    public class534() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Ltn;I[B)V", line = 30)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IIIBI)V", line = 58)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IBILha;)V", line = 123)
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "(III)V", line = 685)
    private class534(int arg0, int arg1, int arg2) {
    }

    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(B)V", line = 702)
