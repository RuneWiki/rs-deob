...
public class class534 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ZZ)V", line = 23)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(BI)V", line = 65)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(II)V", line = 88)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IB)Lkha;", line = 103)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IZ)V", line = 151)
    ...
    @OriginalMember(owner = "client!hk", name = "b", descriptor = "(IZ)V", line = 172)
    ...
    @OriginalMember(owner = "client!hk", name = "b", descriptor = "(I)V", line = 195)
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "(Lwj;IZLwu;Lwu;)V", line = 276)
    ...
    @OriginalMember(owner = "client!hk", name = "c", descriptor = "(I)V", line = 232)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Z)V", line = 250)
