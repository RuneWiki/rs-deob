...
public class class534 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ZLnn;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(BLgh;)V", line = 31)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lnn;B)V", line = 46)
