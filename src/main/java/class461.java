...
public class class461 extends class193 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Lsq;II)V")
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(Lug;)V")
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IILtf;)V")
