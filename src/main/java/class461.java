...
public class class461 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(C)V", line = 7)
    public final void method2761(char arg0) {
        this.field6524.field557.glCallList(this.field6523 + arg0);
    }

    @OriginalMember(owner = "client!jb", name = "a", descriptor = "()V", line = 11)
    public final void method2762() {
        this.field6524.field557.glEndList();
    }

    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Lfu;I)V", line = 15)
