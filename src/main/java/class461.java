...
public class class461 extends class303 implements class323 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lqa;I)V", line = 14)
    ...
    @OriginalMember(owner = "client!et", name = "h", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(B)I", line = 37)
    public final int method1131(byte arg0) {
        field6446++;
        return arg0 <= 72 ? 97 : 0;
    }

    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Z)Z", line = 48)
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(Lqa;B)Lvs;", line = 59)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IILqa;)Lc;", line = 71)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(I)I", line = 82)
    ...
    @OriginalMember(owner = "client!et", name = "d", descriptor = "(I)I", line = 96)
    public final int method415(int arg0) {
        field6441++;
        return arg0 == -15317 ? 0 : -89;
    }

    @OriginalMember(owner = "client!et", name = "a", descriptor = "(BLqa;)V", line = 108)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IZILqa;)Z", line = 119)
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(IIIIILrr;)V", line = 131)
    ...
    @OriginalMember(owner = "client!et", name = "c", descriptor = "(I)V", line = 153)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lqa;B)V", line = 168)
