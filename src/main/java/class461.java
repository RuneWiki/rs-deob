...
public class class461 extends class211 {
    ...
    @OriginalMember(owner = "client!io", name = "c", descriptor = "(I)Lgaa;")
    ...
    @OriginalMember(owner = "client!io", name = "c", descriptor = "(II)Lcn;")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(BILib;)V")
