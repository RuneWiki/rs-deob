...
public class class461 extends class409 {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(ZBLjava/awt/Component;)Loea;")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
