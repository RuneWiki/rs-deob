...
public class class461 extends class82 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "()V", line = 25)
    public class461() {
        this(0);
    }

    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(I)V", line = 28)
    private class461(int arg0) {
        super(0, false);
        this.method2687(arg0, -83);
    }

    @OriginalMember(owner = "client!j", name = "b", descriptor = "(II)[[I", line = 37)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "([II[Ljava/lang/Object;)V", line = 76)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IILos;)V", line = 84)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIIII)V", line = 110)
    ...
    @OriginalMember(owner = "client!j", name = "d", descriptor = "(II)V", line = 692)
