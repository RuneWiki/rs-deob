...
public class class461 extends class173 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(I)J", line = 3)
    public final long method2596(int arg0) {
        field6004++;
        return arg0 == -15493 ? (long) (this.field6008[0].length | this.field6008.length << 0) : -14L;
    }

    @OriginalMember(owner = "client!pt", name = "b", descriptor = "(II)Z", line = 14)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Lfda;I)V", line = 27)
    ...
    @OriginalMember(owner = "client!pt", name = "b", descriptor = "(I)V", line = 135)
    ...
    @OriginalMember(owner = "client!pt", name = "e", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!pt", name = "<init>", descriptor = "([[SD)V", line = 174)
