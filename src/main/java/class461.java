...
public class class461 extends class12 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V", line = 5)
    public final void method55(OggPacket arg0, int arg1) {
        field6571++;
        int var3 = 112 % ((25 - arg1) / 46);
    }

    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 15)
    public class461(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(BIIIIII)Z", line = 18)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Lgh;ILjava/lang/String;ZZ)V", line = 82)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(B)V", line = 150)
    public static void method2811(byte arg0) {
        field6573 = null;
        int var1 = -92 / ((-arg0 - 18) / 50);
    }

    @OriginalMember(owner = "client!qg", name = "f", descriptor = "(I)V", line = 160)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(II)Lqt;", line = 173)
