...
public class class461 extends class109 {
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(Lha;I)Lkn;")
    ...
    @OriginalMember(owner = "client!cca", name = "b", descriptor = "(ILha;)Lgh;")
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(IILha;I)Z")
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(ZILha;Lov;IIZ)V")
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(Lha;II)Z")
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(ILmaa;)V")
    ...
    @OriginalMember(owner = "client!cca", name = "b", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!cca", name = "s", descriptor = "(I)V")
