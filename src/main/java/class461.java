...
public class class461 extends class287 {
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "([B)V", line = 609)
    public class461(byte[] arg0) {
        this.field6674 = arg0;
    }

    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(IILpm;ILjm;Lpf;II)V", line = 621)
