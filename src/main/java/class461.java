...
public class class461 extends class603 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lw;III[Z)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(Llo;Ljava/lang/Object;I)V", line = 39)
    public class461(class686 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field6404 = arg1;
    }

    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(I)Ljava/lang/Object;", line = 50)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(B)Z", line = 61)
    ...
    @OriginalMember(owner = "client!ko", name = "d", descriptor = "(I)V", line = 83)
