...
public class class461 extends class121 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IILfi;BZLya;I)V")
    ...
    @OriginalMember(owner = "client!rs", name = "c", descriptor = "(Lya;I)Lfk;")
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IILya;I)Z")
    ...
    @OriginalMember(owner = "client!rs", name = "b", descriptor = "(Lya;I)V")
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(ILya;I)Z")
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(BLwh;)V")
