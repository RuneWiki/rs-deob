...
public class class461 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lui;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(B)V", line = 257)
