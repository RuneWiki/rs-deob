...
public class class461 {
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "([Lnk;II)V", line = 302)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(II)Lnp;", line = 389)
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "(Ldn;ILr;Lr;)V", line = 481)
