...
public class class461 {
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "([Lufa;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IILjava/lang/String;II)V", line = 30)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(I)V", line = 169)
