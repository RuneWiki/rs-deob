...
public class class461 extends class38 {
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(BII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "()V", line = 16)
    public class461() {
        super(0, true);
    }

    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(Ljava/lang/String;II)Lmda;", line = 20)
    ...
    @OriginalMember(owner = "client!sj", name = "b", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(Z)V", line = 55)
    ...
    @OriginalMember(owner = "client!sj", name = "b", descriptor = "(II)V", line = 83)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IZIIIIIII)Z", line = 111)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(BI)[I", line = 143)
