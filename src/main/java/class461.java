...
public class class461 implements Runnable {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IIII)Z", line = 28)
    ...
    @OriginalMember(owner = "client!rs", name = "b", descriptor = "(II)I", line = 245)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(I)V", line = 257)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Ldh;B)Luf;", line = 269)
    ...
    @OriginalMember(owner = "client!rs", name = "run", descriptor = "()V", line = 281)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(II[Lvg;)V", line = 323)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(ILjava/lang/String;)V", line = 394)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Lvg;III)V", line = 427)
