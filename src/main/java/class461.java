...
public class class461 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Lhn;IIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(FFFIILvo;FIFIB)[B", line = 184)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(B)V", line = 203)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(BI)Lea;", line = 230)
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(B)V", line = 260)
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(II)V", line = 272)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(I)V", line = 288)
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(Ljc;ILgp;)V", line = 309)
    ...
    @OriginalMember(owner = "client!jo", name = "c", descriptor = "(B)V", line = 333)
