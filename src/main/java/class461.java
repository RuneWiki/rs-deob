...
public abstract class class461 {
    ...
    @OriginalMember(owner = "client!gr", name = "c", descriptor = "(I)Ldv;")
    ...
    @OriginalMember(owner = "client!gr", name = "d", descriptor = "(I)Liv;")
    ...
    @OriginalMember(owner = "client!gr", name = "f", descriptor = "(I)Ltda;")
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(B)Lld;")
