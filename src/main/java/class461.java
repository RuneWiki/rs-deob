...
public class class461 extends class114 {
    ...
    @OriginalMember(owner = "client!ck", name = "f", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(Lnj;II)V", line = 51)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(CZ)I", line = 115)
    ...
    @OriginalMember(owner = "client!ck", name = "g", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(B)V", line = 179)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(CB)I", line = 235)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ILnj;)V", line = 266)
