...
public class class461 {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(I[BII[BIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IZB[[ZII)V", line = 47)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(I)V", line = 234)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lmr;IZI)V", line = 263)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ILmr;II)V", line = 333)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIILmr;)Z", line = 405)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIII)V", line = 474)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "([BI[BIIIIII)V", line = 514)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(III[BIII)Z", line = 558)
    ...
    @OriginalMember(owner = "client!c", name = "<init>", descriptor = "(Lqi;Lch;)V", line = 600)
