...
public class class461 {
    ...
    @OriginalMember(owner = "client!maa", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field6289++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(II)Z", line = 26)
    ...
    @OriginalMember(owner = "client!maa", name = "b", descriptor = "(I)Z", line = 45)
    ...
    @OriginalMember(owner = "client!maa", name = "c", descriptor = "(I)V", line = 58)
