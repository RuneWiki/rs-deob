...
public class class461 extends class51 implements class1 {
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(Lbt;ILjaggl/memory/NativeBuffer;IZ)V")
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(Lbt;I[BIZ)V")
