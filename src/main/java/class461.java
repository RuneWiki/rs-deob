...
public class class461 implements class16 {
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(II)Lap;")
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Lfo;Lfo;Lfo;)V")
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IB)Liq;")
