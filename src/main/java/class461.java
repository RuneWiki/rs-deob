...
public class class461 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(II)V", line = 24)
    ...
    @OriginalMember(owner = "client!sg", name = "b", descriptor = "(II)Lsd;", line = 46)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!sg", name = "b", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(Ldh;ILkha;Lkha;)V", line = 120)
