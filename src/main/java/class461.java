...
public class class461 extends class245 implements class722 {
    ...
    @OriginalMember(owner = "client!fea", name = "b", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!fea", name = "f", descriptor = "(I)[Lqk;", line = 25)
    ...
    @OriginalMember(owner = "client!fea", name = "<init>", descriptor = "(Lsb;Lkea;III[B)V", line = 36)
