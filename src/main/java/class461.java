...
public class class461 extends class670 {
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(IIIIIF)V", line = 4)
    public class461(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IIIB)V", line = 12)
    ...
    @OriginalMember(owner = "client!bq", name = "c", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(FI)V", line = 43)
