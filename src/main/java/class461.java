...
public class class461 extends class459 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lwq;B)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!gr", name = "c", descriptor = "(I)Ljava/lang/String;", line = 31)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(BLwq;[I)V", line = 59)
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(B)I", line = 98)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(BII)I", line = 113)
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(II)Ljava/lang/String;", line = 133)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lwq;Z)V", line = 163)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lwq;II)V", line = 206)
    ...
    @OriginalMember(owner = "client!gr", name = "d", descriptor = "(I)V", line = 283)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ZI)Lpe;", line = 306)
