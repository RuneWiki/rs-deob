...
public abstract class class461 implements class682 {
    ...
    @OriginalMember(owner = "client!lda", name = "b", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(IZ)V", line = 77)
    ...
    @OriginalMember(owner = "client!lda", name = "b", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(B)Z", line = 116)
    ...
    @OriginalMember(owner = "client!lda", name = "<init>", descriptor = "(Lpe;Lpe;Lqga;)V", line = 140)
