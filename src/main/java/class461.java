...
public class class461 {
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "([B[BIIII)I", line = 4)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(B)Z", line = 150)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(IIB[B[BI)I", line = 3290)
    ...
    @OriginalMember(owner = "client!ht", name = "b", descriptor = "(B)V", line = 3357)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(III)Lrr;", line = 3371)
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "([B)V", line = 3397)
