...
public class class461 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lha;Lto;Ljo;)V")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(II)Lvu;")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Luu;Lbj;Lpg;Lql;Lib;Lnc;Lmm;)V")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lha;IIII)Lmba;")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lha;IIII[S[B)V")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(II)Lde;")
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(Lha;IIII)V")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lha;Lto;IIII)V")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lha;IIIIIII[S[BZ)V")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lha;Ldc;IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lha;II)V")
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(Lha;)Lmba;")
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(I)Lde;")
    public static final class604 method2823(int arg0) {
        return (class604) field6386.method812(110, (long) arg0);
    }

    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Ld;II)V")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Ld;III)I")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "([B[B[SII)V")
