...
public class class461 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(I)Ljava/io/File;", line = 6)
    ...
    @OriginalMember(owner = "client!rs", name = "b", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!rs", name = "<init>", descriptor = "(Lgq;II)V", line = 564)
    ...
    @OriginalMember(owner = "client!rs", name = "c", descriptor = "(I)J", line = 108)
    ...
    @OriginalMember(owner = "client!rs", name = "b", descriptor = "(B)V", line = 123)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(II[BB)V", line = 143)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "([BB)V", line = 267)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(ZJ)V", line = 283)
    ...
    @OriginalMember(owner = "client!rs", name = "d", descriptor = "(I)V", line = 301)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IIB[B)V", line = 378)
