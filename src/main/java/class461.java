...
public class class461 extends class702 implements class201 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IILua;II)V", line = 10)
    public final void method1080(int arg0, int arg1, class617 arg2, int arg3, int arg4) {
        this.method2886(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!va", name = "a", descriptor = "(FFFFFFILua;II)V", line = 24)
    ...
    @OriginalMember(owner = "client!va", name = "finalize", descriptor = "()V", line = 27)
    ...
    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(Ll;Lm;II)V", line = 32)
    ...
    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(Ll;Lm;IIII)V", line = 38)
    ...
    @OriginalMember(owner = "client!va", name = "xa", descriptor = "(III)V", line = 44)
