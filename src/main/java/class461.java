...
public class class461 extends class14 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IBLmd;)V", line = 4)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IB)[I", line = 47)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(II)[[I", line = 136)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IBI)Z", line = 273)
    ...
    @OriginalMember(owner = "client!rs", name = "e", descriptor = "(I)V", line = 284)
    ...
    @OriginalMember(owner = "client!rs", name = "<init>", descriptor = "()V", line = 298)
    public class461() {
        super(1, false);
    }

    @OriginalMember(owner = "client!rs", name = "d", descriptor = "(B)Z", line = 305)
    ...
    @OriginalMember(owner = "client!rs", name = "b", descriptor = "(II)I", line = 329)
    ...
    @OriginalMember(owner = "client!rs", name = "f", descriptor = "(I)V", line = 332)
