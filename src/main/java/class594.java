...
public class class594 extends class98 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "()Leha;")
    ...
    @OriginalMember(owner = "client!fe", name = "b", descriptor = "()Leha;")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Lefa;)V")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Leha;)V")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Ldn;Lefa;)V")
    ...
    @OriginalMember(owner = "client!fe", name = "b", descriptor = "(Leha;)V")
