...
public class class594 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(ILrq;)I")
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IIII)Ljq;")
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Z)Lpca;")
