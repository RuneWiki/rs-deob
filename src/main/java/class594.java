...
public class class594 {
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!rg", name = "c", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(II)Ltr;", line = 83)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(BLjn;)V", line = 124)
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "(Ler;ILjn;Ljn;)V", line = 145)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IIIIBII)V", line = 161)
