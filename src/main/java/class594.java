...
public class class594 extends class553 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(CB)B", line = 5)
    ...
    @OriginalMember(owner = "client!jl", name = "d", descriptor = "(Z)V", line = 130)
    ...
    @OriginalMember(owner = "client!jl", name = "c", descriptor = "(Z)I", line = 141)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IB[Ljava/awt/Rectangle;)V", line = 155)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(B)I", line = 169)
    ...
    @OriginalMember(owner = "client!jl", name = "b", descriptor = "(I)I", line = 184)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(I)J", line = 196)
    public final long method763(int arg0) {
        field8446++;
        return arg0 == -25909 ? this.field8441 : 86L;
    }

    @OriginalMember(owner = "client!jl", name = "c", descriptor = "(I)I", line = 224)
