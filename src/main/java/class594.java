...
public class class594 extends class350 implements class555 {
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(Lmc;Z)V")
    public class594(class120 arg0, boolean arg1) {
        super(arg0, 34962, arg1);
    }

    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IBILjaclib/memory/Source;)Z")
