...
public class class594 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(III)Z", line = 38)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Z)V", line = 58)
