...
public class class594 extends class490 {
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IIIBLha;ILd;)V")
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IIBILpc;I)Lqt;")
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Les;I)V")
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Lwt;I)V")
