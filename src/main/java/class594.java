...
public class class594 extends class13 {
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(Z)I", line = 3)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!et", name = "d", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!et", name = "e", descriptor = "(I)I", line = 44)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IILqo;Ljava/lang/String;)Ltba;", line = 55)
    ...
    @OriginalMember(owner = "client!et", name = "e", descriptor = "(B)J", line = 105)
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(II)V", line = 117)
    public class594(int arg0, int arg1) {
        super.field5204 = (long) arg0 << 32 | (long) arg1;
    }

    @OriginalMember(owner = "client!et", name = "f", descriptor = "(I)V", line = 126)
