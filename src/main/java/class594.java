...
public class class594 extends InputStream {
    ...
    @OriginalMember(owner = "client!ou", name = "read", descriptor = "()I", line = 4)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IIIIIIIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(BI)Z", line = 78)
