...
public class class594 extends class87 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(IIIIIF)V", line = 20)
    public class594(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!kq", name = "f", descriptor = "(I)Z", line = 23)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(FI)V", line = 40)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IBIIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(II)J", line = 74)
