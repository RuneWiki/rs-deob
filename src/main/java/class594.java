...
public class class594 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(II)Lel;", line = 3)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Z)V", line = 47)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IJ)V", line = 65)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IIIIIZI)V", line = 130)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(I)V", line = 169)
