...
public class class594 extends class682 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IBI)V", line = 4)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IZ)V", line = 64)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(Lnv;Lpr;)V", line = 87)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IIIII)V", line = 121)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Z)Z", line = 194)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Ltha;II)V", line = 206)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(BZ)V", line = 222)
