...
public class class594 extends class175 {
    ...
    @OriginalMember(owner = "client!cv", name = "b", descriptor = "(IIB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!cv", name = "<init>", descriptor = "()V", line = 14)
    public class594() {
        super(1, true);
    }

    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(ZI)[I", line = 19)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(IZLjava/util/Random;)I", line = 61)
    ...
    @OriginalMember(owner = "client!cv", name = "g", descriptor = "(I)I", line = 91)
