...
public class class594 extends class126 implements class614 {
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Lr;Let;IIIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ZI[BLhp;)Lne;")
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(Lr;Z)V")
    ...
    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(ILr;)Lnu;")
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IILr;I)Z")
    ...
    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(Lr;Z)Lkq;")
