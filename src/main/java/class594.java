...
public class class594 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(BLu;)V")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(B)Lu;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lu;B)V")
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(I)Lu;")
    ...
    @OriginalMember(owner = "client!or", name = "d", descriptor = "(I)Lu;")
    ...
    @OriginalMember(owner = "client!or", name = "e", descriptor = "(I)Lu;")
    ...
    @OriginalMember(owner = "client!or", name = "f", descriptor = "(I)Lu;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ILor;)V")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ILor;Lu;)V")
