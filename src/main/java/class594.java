...
public abstract class class594 extends class29 {
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IBI)Z", line = 10)
    ...
    @OriginalMember(owner = "client!hj", name = "c", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(Z)V", line = 111)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(ZI)V", line = 148)
