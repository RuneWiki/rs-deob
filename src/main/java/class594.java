...
public class class594 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(ZI)I", line = 6)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(II)Z", line = 42)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(B[I[III)V", line = 59)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(B)V", line = 117)
