...
public class class594 extends class74 {
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(IILhfa;)V")
    ...
    @OriginalMember(owner = "client!mw", name = "<init>", descriptor = "(Llm;Lpl;)V")
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(BLni;)I")
