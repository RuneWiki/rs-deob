...
public class class594 {
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(BLib;)Lpm;", line = 20)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(III)Z", line = 34)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(IIIII)I", line = 51)
    ...
    @OriginalMember(owner = "client!cv", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 65)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Z)V", line = 79)
