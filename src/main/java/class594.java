...
public class class594 extends class188 {
    ...
    @OriginalMember(owner = "client!qi", name = "e", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(I)Z", line = 39)
    ...
    @OriginalMember(owner = "client!qi", name = "<init>", descriptor = "(Lpa;Laj;)V", line = 50)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IBLbm;)V", line = 84)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IZ)V", line = 119)
    ...
    @OriginalMember(owner = "client!qi", name = "f", descriptor = "(B)V", line = 129)
    ...
    @OriginalMember(owner = "client!qi", name = "d", descriptor = "(I)V", line = 161)
    ...
    @OriginalMember(owner = "client!qi", name = "d", descriptor = "(B)V", line = 176)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IIZ)V", line = 204)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(ZI)V", line = 218)
