...
public class class594 extends class629 {
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(B)Loia;")
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(III)Lnp;")
    ...
    @OriginalMember(owner = "client!lda", name = "<init>", descriptor = "(ILcr;Lcr;Lqv;Lhh;I[BIZ)V")
