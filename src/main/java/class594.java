...
public class class594 {
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(BIC)I", line = 69)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(IC)Z", line = 97)
