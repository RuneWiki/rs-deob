...
public class class594 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IB)V", line = 16)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "([B[BIIIIIII)V", line = 39)
