...
public class class594 {
    ...
    @OriginalMember(owner = "client!g", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field8558++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(ZBZ)V", line = 48)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(I)I", line = 70)
    ...
    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 83)
