...
public abstract class class174 extends class316 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ZILvc;IILuq;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!ro", name = "c", descriptor = "(I)Z", line = 28)
    ...
    @OriginalMember(owner = "client!ro", name = "d", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IILvh;)V", line = 49)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IBI)B", line = 247)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(B)J", line = 266)
