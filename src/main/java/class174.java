...
public class class174 extends class512 implements Runnable {
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(III)V", line = 33)
    ...
    @OriginalMember(owner = "client!to", name = "run", descriptor = "()V", line = 49)
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(Lhn;)V", line = 81)
    public class174(class64 arg0) {
        this.field2687 = arg0;
    }

    @OriginalMember(owner = "client!to", name = "a", descriptor = "(B)V", line = 66)
