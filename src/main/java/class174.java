...
public class class174 extends class147 {
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(ILuf;)V")
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Lno;B)V")
    ...
    @OriginalMember(owner = "client!mb", name = "b", descriptor = "(BLno;)V")
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(BLno;)V")
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Lya;FZII)V")
