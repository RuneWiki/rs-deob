...
public class class174 extends class35 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(III[[ZZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!rn", name = "I", descriptor = "(II)I", line = 20)
    public final int method201(int arg0, int arg1) {
        return this.field2564[arg0][arg1];
    }

    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(II)V", line = 24)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IIZLvf;[I[I[I)V", line = 36)
    ...
    @OriginalMember(owner = "client!rn", name = "SA", descriptor = "(Lj;IIIIZ)V", line = 678)
    public final void method208(class377 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IIIIIII[[ZLvf;[I[I)V", line = 685)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Lj;IIIIZ)Z", line = 815)
    public final boolean method196(class377 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return false;
    }

    @OriginalMember(owner = "client!rn", name = "QA", descriptor = "(III)V", line = 819)
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(Ljs;IIII[[I[[II)V", line = 824)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IIIIIII[[Z)V", line = 877)
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(IIIIIII[[ZLvf;[I[I)V", line = 892)
                ...
                if (arg7[var16 - arg3][var17 - arg4]) {
                    if (this.field2577[var16][var17] != null) {
                        ...
                        for (int var23 = 0; var23 < var21.field7054; ++var23) {
                            ...
                            } else if (var21.field7058 != null && var21.field7058[var23] != -1) {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 1020)
    ...
    @OriginalMember(owner = "client!rn", name = "va", descriptor = "(II)I", line = 1252)
    ...
    @OriginalMember(owner = "client!rn", name = "JA", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 1270)
    ...
    @OriginalMember(owner = "client!rn", name = "f", descriptor = "()V", line = 1764)
    public final void method199() {
        this.field2557 = null;
        this.field2575 = null;
    }

    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(II)I", line = 1771)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IILvf;[I[I[I)V", line = 1803)
    ...
    @OriginalMember(owner = "client!rn", name = "U", descriptor = "(Lj;IIIIZ)V", line = 2157)
    public final void method205(class377 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!rn", name = "O", descriptor = "(IILj;)Lj;", line = 2163)
    public final class377 method197(int arg0, int arg1, class377 arg2) {
        return null;
    }

    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Lkt;[I)V", line = 2169)
    public final void method200(class107 arg0, int[] arg1) {
    }

    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(I)Z", line = 2172)
