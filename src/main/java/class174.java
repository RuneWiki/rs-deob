...
public class class174 extends class56 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(ZLjava/awt/Graphics;II)V", line = 9)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(Ljava/awt/Canvas;Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IIIIILjava/awt/Graphics;)V", line = 40)
