...
public class class174 {
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(IJ[B)V", line = 17)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "([BBI)V", line = 108)
    ...
    @OriginalMember(owner = "client!aba", name = "b", descriptor = "(I)V", line = 174)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(IIIIIIB)V", line = 200)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(Z)V", line = 234)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(ILjda;Ljda;)V", line = 360)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(III)V", line = 388)
