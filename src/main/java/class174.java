...
public class class174 {
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(ILcm;)V")
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(I)Lcm;")
    ...
    @OriginalMember(owner = "client!tca", name = "b", descriptor = "(I)Lcm;")
    ...
    @OriginalMember(owner = "client!tca", name = "d", descriptor = "(I)Lcm;")
    ...
    @OriginalMember(owner = "client!tca", name = "d", descriptor = "(B)Lcm;")
