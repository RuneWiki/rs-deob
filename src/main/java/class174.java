...
public class class174 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(I[I[Ljava/lang/Object;)V", line = 89)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(III)Z", line = 107)
