...
public class class174 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(BLan;Lan;I)Lkc;", line = 10)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lan;ZLan;IZ)Lkc;", line = 22)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Z)V", line = 70)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(I)Z", line = 122)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ILap;)V", line = 176)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Lp;Lps;)V", line = 390)
