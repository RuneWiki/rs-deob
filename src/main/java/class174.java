...
public class class174 {
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Lew;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ru", name = "b", descriptor = "(Lew;)B", line = 27)
    private static final byte method1174(class170 arg0) {
        return (byte) method1180(8, arg0);
    }

    @OriginalMember(owner = "client!ru", name = "c", descriptor = "(Lew;)V", line = 33)
    ...
    @OriginalMember(owner = "client!ru", name = "d", descriptor = "(Lew;)V", line = 192)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "()V", line = 695)
    public static void method1177() {
        field2773 = null;
    }

    @OriginalMember(owner = "client!ru", name = "a", descriptor = "([I[I[I[BIII)V", line = 704)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "([BI[BII)I", line = 770)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(ILew;)I", line = 805)
    ...
    @OriginalMember(owner = "client!ru", name = "e", descriptor = "(Lew;)B", line = 830)
