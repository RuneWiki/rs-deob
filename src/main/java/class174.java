...
public class class174 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ZLri;JBIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(B)Lu;", line = 14)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(BLpba;)I", line = 40)
    ...
    @OriginalMember(owner = "client!op", name = "c", descriptor = "(B)Lu;", line = 71)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "()V", line = 130)
    public class174() {
    }

    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(Lsba;)V", line = 132)
    public class174(class200 arg0) {
        this.field2877 = arg0;
    }

    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IZI[BIILer;I)Lcea;", line = 112)
