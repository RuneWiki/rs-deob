...
public class class174 extends class73 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "()Ltc;")
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ZLtc;)V")
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Ltc;)V")
