...
public class class174 {
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(IIIIIIIZI)Z", line = 19)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(BI)C", line = 53)
