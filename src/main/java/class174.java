...
public class class174 extends class681 {
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(CIB)I", line = 32)
    ...
    @OriginalMember(owner = "client!kk", name = "g", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Z)Z", line = 66)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(DI)V", line = 80)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(ILrga;I)V", line = 106)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(Ltba;Lsea;Lst;)V", line = 123)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(ZI)V", line = 145)
    ...
    @OriginalMember(owner = "client!kk", name = "d", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(ZI)V", line = 204)
