...
public class class174 {
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "()V", line = 6)
    public class174() {
    }

    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "(Luk;)V", line = 8)
    public class174(class174 arg0) {
