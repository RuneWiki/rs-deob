...
public class class174 extends class141 {
    ...
    @OriginalMember(owner = "client!pd", name = "c", descriptor = "(I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!pd", name = "d", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(Lbt;Lpt;)V", line = 62)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Lei;II)V", line = 76)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(ZI)V", line = 94)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IZ)V", line = 105)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(B)V", line = 141)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(III)V", line = 166)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(I)V", line = 211)
