...
public class class174 extends class115 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ILec;)[Ltb;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lba;III[Z)Z")
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(Lcs;)V")
