...
public class class174 extends class97 {
    ...
    @OriginalMember(owner = "client!sh", name = "db", descriptor = "[[Lvf;")
    ...
    @OriginalMember(owner = "client!sh", name = "rb", descriptor = "[[Lvf;")
    ...
    @OriginalMember(owner = "client!sh", name = "V", descriptor = "Lqf;")
    private class154 field3269 = new class154();

    @OriginalMember(owner = "client!sh", name = "Qb", descriptor = "Lmf;")
    private class118 field3316 = new class118(this);

    @OriginalMember(owner = "client!sh", name = "O", descriptor = "Leh;")
    ...
    @OriginalMember(owner = "client!sh", name = "sb", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!sh", name = "Gb", descriptor = "Llf;")
    public static class109 field3306 = class35.method275("", 2);

    @OriginalMember(owner = "client!sh", name = "Jb", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!sh", name = "xb", descriptor = "Loh;")
    public static class138 field3297;

    @OriginalMember(owner = "client!sh", name = "qb", descriptor = "Lbg;")
    public static class18 field3290;

    @OriginalMember(owner = "client!sh", name = "wb", descriptor = "Lvg;")
    public static class200 field3296;

    @OriginalMember(owner = "client!sh", name = "Bb", descriptor = "Ldf;")
    ...
    @OriginalMember(owner = "client!sh", name = "c", descriptor = "()Lkc;")
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(BLvf;)I")
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ZBLs;)V")
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Lvf;ZI)V")
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(I[IILvf;I)Z")
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Lvf;B)I")
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "()Lkc;")
    public final synchronized class97 method613() {
        field3302++;
        return this.field3316;
    }

    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ILs;Lbg;ILcb;)Z")
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(Lvf;B)I")
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(BLvf;)Z")
