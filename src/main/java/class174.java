...
public class class174 extends class43 {
    ...
    @OriginalMember(owner = "client!so", name = "b", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!so", name = "b", descriptor = "(Z)V", line = 61)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(II)I", line = 74)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(ILjava/util/Random;I)I", line = 103)
    ...
    @OriginalMember(owner = "client!so", name = "b", descriptor = "(B)V", line = 133)
    ...
    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "()V", line = 147)
    public class174() {
    }

    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "([B)V", line = 149)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "([IB[BLjm;)Z", line = 798)
