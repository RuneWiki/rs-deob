...
public class class174 {
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(ZB)V", line = 3)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IB)V", line = 19)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(BI)V", line = 46)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(III)Ljo;", line = 69)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IZ)Lul;", line = 92)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Lqa;B)V", line = 124)
    ...
    @OriginalMember(owner = "client!ru", name = "b", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Z)V", line = 172)
    ...
    @OriginalMember(owner = "client!ru", name = "b", descriptor = "(IB)V", line = 195)
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(Lgo;IZLns;Lns;)V", line = 228)
