...
public class class174 extends class631 {
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(Lpda;)V")
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "()Lpda;")
    ...
    @OriginalMember(owner = "client!cda", name = "h", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(ILvl;Z)V")
