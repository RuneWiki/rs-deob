...
public abstract class class174 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Lj;III[Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "([[BLmi;I)V", line = 60)
