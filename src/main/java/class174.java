...
public class class174 {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Lfh;IB)V", line = 75)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(BLfh;)V", line = 137)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(FFFB)I", line = 160)
