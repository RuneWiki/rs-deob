...
public class class174 implements IEnumModesCallback {
    ...
    @OriginalMember(owner = "client!hga", name = "callbackEnumModes", descriptor = "(Lcom/ms/directX/DDSurfaceDesc;Lcom/ms/com/IUnknown;)V", line = 4)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(Ljava/awt/Frame;B)V", line = 21)
    ...
    @OriginalMember(owner = "client!hga", name = "<init>", descriptor = "()V", line = 32)
    public class174() {
        this.field2690.initialize(null);
    }

    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(IILjava/awt/Frame;IZI)V", line = 41)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(B)[I", line = 62)
