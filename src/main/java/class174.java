...
public class class174 extends class69 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lae;Lvt;I)V")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(III)Lwc;")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lul;IZI)Lraa;")
