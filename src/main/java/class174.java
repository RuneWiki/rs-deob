...
public class class174 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ZLjava/lang/String;ILjava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Les;Z)Lpd;", line = 56)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B)V", line = 70)
