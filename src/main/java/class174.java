...
public class class174 extends class183 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(J)V", line = 3)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "()V", line = 10)
    public final void method912() {
        this.field2191 = true;
    }

    @OriginalMember(owner = "client!dp", name = "a", descriptor = "([Loa;Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Lvm;J[Lmd;[Loa;Z)V", line = 100)
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "(I)V", line = 332)
    ...
    @OriginalMember(owner = "client!dp", name = "c", descriptor = "()V", line = 115)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Lvm;J)Z", line = 136)
    ...
    @OriginalMember(owner = "client!dp", name = "d", descriptor = "()Lhc;", line = 186)
    public final class366 method917() {
        return this.field2189;
    }

    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IIIII)V", line = 189)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Lvm;[Lmd;Z)V", line = 199)
    ...
    @OriginalMember(owner = "client!dp", name = "e", descriptor = "()V", line = 271)
    public final void method920() {
        this.field2178 = true;
    }

    @OriginalMember(owner = "client!dp", name = "f", descriptor = "()V", line = 274)
    ...
    @OriginalMember(owner = "client!dp", name = "g", descriptor = "()V", line = 298)
