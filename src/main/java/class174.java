...
public class class174 extends class499 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(B[ILmd;)V", line = 5)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Lmd;II)V", line = 33)
    ...
    @OriginalMember(owner = "client!rn", name = "d", descriptor = "(B)V", line = 108)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(BII)I", line = 124)
    ...
    @OriginalMember(owner = "client!rn", name = "e", descriptor = "(B)I", line = 145)
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(Z)V", line = 159)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Lmd;Z)Ljava/lang/String;", line = 180)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(II)Lra;", line = 213)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(I)Ljava/lang/String;", line = 228)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(III)Z", line = 257)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ILmd;)V", line = 329)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IIB)I", line = 354)
