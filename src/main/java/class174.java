...
public class class174 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Lr;Ljava/lang/String;IIIZ)V")
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Lr;Ljava/lang/String;[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Ljava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Lr;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "(Lr;IZLjava/awt/Component;)V")
