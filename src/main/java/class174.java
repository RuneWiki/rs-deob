...
public class class174 {
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(Lwu;II)Ltca;", line = 7)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "()Lct;", line = 15)
    ...
    @OriginalMember(owner = "client!tca", name = "b", descriptor = "()I", line = 20)
    ...
    @OriginalMember(owner = "client!tca", name = "c", descriptor = "()[B", line = 65)
    ...
    @OriginalMember(owner = "client!tca", name = "<init>", descriptor = "(Lee;)V", line = 129)
    ...
    @OriginalMember(owner = "client!tca", name = "<init>", descriptor = "()V", line = 149)
    private class174() {
    }
}
