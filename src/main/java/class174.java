...
public class class174 implements class669 {
    ...
    @OriginalMember(owner = "client!sfa", name = "b", descriptor = "(B)Lbl;")
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "([I[IB[ILu;)V")
    ...
    @OriginalMember(owner = "client!sfa", name = "<init>", descriptor = "(Lmv;Ljava/lang/String;)V")
