...
public class class697 implements class34 {
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(I)Lil;")
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(Lmk;I)V")
    ...
    @OriginalMember(owner = "client!aga", name = "<init>", descriptor = "(Lgda;Ljava/lang/String;)V")
