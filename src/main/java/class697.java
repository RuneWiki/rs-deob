...
public class class697 extends class665 {
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(I[Lvg;BZII)V", line = 19)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(IIILok;BI)Lot;", line = 70)
    ...
    @OriginalMember(owner = "client!gfa", name = "b", descriptor = "(I)V", line = 114)
