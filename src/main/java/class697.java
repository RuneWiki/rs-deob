...
public class class697 extends class371 implements class546 {
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ov", name = "b", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;", line = 14)
    ...
    @OriginalMember(owner = "client!ov", name = "<init>", descriptor = "(Lcka;Ltn;III[B)V", line = 30)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(BLqt;)V", line = 101)
