...
public class class697 extends class60 {
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(Lhd;)V", line = 17)
    public class697(class773 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!gba", name = "b", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!gba", name = "b", descriptor = "(I)I", line = 32)
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(ILhd;)V", line = 44)
    public class697(int arg0, class773 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!gba", name = "b", descriptor = "(II)I", line = 47)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(BI)V", line = 60)
    ...
    @OriginalMember(owner = "client!gba", name = "c", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Z)I", line = 89)
