...
public class class697 extends class186 {
    ...
    @OriginalMember(owner = "client!gfa", name = "i", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "([BIZ)Ljava/lang/Object;", line = 19)
    ...
    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "(IIIIIF)V", line = 51)
    public class697(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(IIIB)V", line = 54)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(FB)V", line = 68)
