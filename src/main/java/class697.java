...
public class class697 extends class634 {
    ...
    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "()V", line = 6)
    public class697() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ic", name = "f", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(ZII)V", line = 23)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(ILig;Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(BI)[[I", line = 88)
