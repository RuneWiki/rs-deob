...
public class class697 {
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(BJ)V", line = 6)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(III)V", line = 24)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(ILnd;IZILnd;Z)I", line = 36)
