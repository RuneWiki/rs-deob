...
public class class697 implements class669 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(ILjaclib/memory/Source;II)Z")
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(Lhb;Z)V")
