...
public class class697 {
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(BI)Lvd;")
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(ILmp;IIII)Lmha;")
    ...
    @OriginalMember(owner = "client!jha", name = "b", descriptor = "(BI)Z")
    ...
    @OriginalMember(owner = "client!jha", name = "<init>", descriptor = "(Lal;ILnd;)V")
