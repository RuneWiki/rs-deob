...
public class class697 extends class305 {
    ...
    @OriginalMember(owner = "client!jha", name = "b", descriptor = "(I)Z", line = 10)
    ...
    @OriginalMember(owner = "client!jha", name = "<init>", descriptor = "(ILhb;)V", line = 28)
    public class697(int arg0, class728 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!jha", name = "c", descriptor = "(II)I", line = 34)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(B)I", line = 71)
    ...
    @OriginalMember(owner = "client!jha", name = "c", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!jha", name = "d", descriptor = "(I)I", line = 108)
    ...
    @OriginalMember(owner = "client!jha", name = "<init>", descriptor = "(Lhb;)V", line = 119)
    public class697(class728 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jha", name = "b", descriptor = "(B)V", line = 122)
    ...
    @OriginalMember(owner = "client!jha", name = "b", descriptor = "(II)V", line = 143)
