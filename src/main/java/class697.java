...
public class class697 extends class88 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IIII[III)V")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(IIIIIII)V")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(FFFFFFIIII)V")
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "(Lsr;IIZ)V")
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "(Lsr;II[III)V")
