...
public class class697 extends class280 implements class392 {
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(BLha;)V", line = 4)
    ...
    @OriginalMember(owner = "client!gba", name = "d", descriptor = "(I)Z", line = 15)
    public final boolean method30(int arg0) {
        ++field9759;
        return arg0 <= 59 ? false : this.field9763;
    }

    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Lha;B)Lel;", line = 30)
    ...
    @OriginalMember(owner = "client!gba", name = "k", descriptor = "(I)Z", line = 46)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IILjava/lang/String;)V", line = 61)
    ...
    @OriginalMember(owner = "client!gba", name = "d", descriptor = "(B)V", line = 161)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Lha;ZBI)Lhi;", line = 174)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(ILha;I)Lka;", line = 204)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IIILha;)Z", line = 225)
    ...
    @OriginalMember(owner = "client!gba", name = "m", descriptor = "(I)I", line = 249)
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(Lha;Lpu;IIIIIZIIII)V", line = 260)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(ILha;)Ldfa;", line = 285)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Lha;I)V", line = 313)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IB)Z", line = 341)
    ...
    @OriginalMember(owner = "client!gba", name = "c", descriptor = "(I)V", line = 352)
    ...
    @OriginalMember(owner = "client!gba", name = "e", descriptor = "(I)I", line = 373)
    ...
    @OriginalMember(owner = "client!gba", name = "b", descriptor = "(Lha;I)V", line = 387)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IIII)I", line = 415)
    ...
    @OriginalMember(owner = "client!gba", name = "h", descriptor = "(I)Z", line = 434)
    ...
    @OriginalMember(owner = "client!gba", name = "b", descriptor = "(I)I", line = 453)
    ...
    @OriginalMember(owner = "client!gba", name = "p", descriptor = "(I)V", line = 478)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(I)I", line = 498)
    ...
    @OriginalMember(owner = "client!gba", name = "l", descriptor = "(I)I", line = 509)
