...
public class class697 extends OutputStream {
    ...
    @OriginalMember(owner = "client!rj", name = "write", descriptor = "(I)V", line = 5)
    public final void write(int arg0) throws IOException {
        field9584++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Z)V", line = 26)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IIILtc;)V", line = 38)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 121)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IB)[B", line = 166)
