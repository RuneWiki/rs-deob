...
public class class697 extends class51 implements class411 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lkfa;IILjava/lang/String;)Lafa;")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(BLsj;)V")
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(Lkfa;ILjaclib/memory/Buffer;IZ)V")
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(Lkfa;I[BIZ)V")
