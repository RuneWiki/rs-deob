...
public class class697 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(B)Loga;")
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Liv;ILcb;)V")
    public class697(class106 arg0, int arg1, class544 arg2) {
        this.field9845 = arg2;
        this.field9845.method3147(5, 52);
    }

    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ZI)Llw;")
