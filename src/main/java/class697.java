...
public class class697 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IZ)Lgv;", line = 5)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ZI)Z", line = 77)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Z)V", line = 92)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(II)Z", line = 110)
    ...
    @OriginalMember(owner = "client!gv", name = "toString", descriptor = "()Ljava/lang/String;", line = 127)
    public final String toString() {
        field9841++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(IILwq;)V", line = 135)
