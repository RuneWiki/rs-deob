...
public class class697 extends class461 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IC)Z", line = 6)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(BZ)C", line = 30)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(III)V", line = 61)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lbi;BLii;)V", line = 91)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 140)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IIB)V", line = 155)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(BII)V", line = 170)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Z)V", line = 183)
