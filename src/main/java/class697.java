...
public class class697 {
    ...
    @OriginalMember(owner = "client!ab", name = "listmodes", descriptor = "()[I", line = 10)
    ...
    @OriginalMember(owner = "client!ab", name = "exit", descriptor = "()V", line = 33)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(ILjava/awt/Frame;)V", line = 55)
    ...
    @OriginalMember(owner = "client!ab", name = "enter", descriptor = "(Ljava/awt/Frame;IIII)V", line = 98)
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "()V", line = 157)
