...
public abstract class class232 {
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(IILem;[ILih;ILem;I[ZIZZ)V", line = 21)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(IILms;IILvb;Laq;I)V", line = 219)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 263)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Laa;IIZILaa;IBI)V", line = 347)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(ILdh;IBIII)V", line = 394)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "([ZLaa;IIIBILaa;ILaa;IILaa;ZI)V", line = 480)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(B)V", line = 535)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Laa;IILaa;I[IIIIZI)V", line = 568)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(III[IIII[IIZ)V", line = 601)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(IILaa;)V", line = 699)
