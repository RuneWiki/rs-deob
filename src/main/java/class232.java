...
public abstract class class232 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 12)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IZBZI)V", line = 25)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(B)V", line = 72)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IIII)V", line = 92)
