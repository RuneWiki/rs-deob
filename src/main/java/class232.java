...
public class class232 implements class20 {
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(IB)C", line = 7)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(IIIB)I", line = 44)
    ...
    @OriginalMember(owner = "client!wv", name = "b", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(B)V", line = 91)
    ...
    @OriginalMember(owner = "client!wv", name = "b", descriptor = "(B)V", line = 141)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(I)Lvj;", line = 157)
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "(Ljava/lang/String;Lnha;Ljn;IIIIIIIIII)V", line = 176)
