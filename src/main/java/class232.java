...
public class class232 implements class245 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(ILd;ILha;III)V", line = 9)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(I)Luu;", line = 99)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IIIIB)V", line = 113)
    ...
    @OriginalMember(owner = "client!qj", name = "b", descriptor = "(I)V", line = 176)
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(ILrj;Lmq;II)V", line = 187)
