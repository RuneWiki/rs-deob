...
public class class232 extends class149 {
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "()V", line = 4)
    public class232() {
        super(1, false);
    }

    @OriginalMember(owner = "client!dc", name = "e", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IBLtl;)V", line = 22)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(BI)[[I", line = 74)
