...
public class class232 {
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(IIIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!sda", name = "<init>", descriptor = "(Lok;)V", line = 170)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(IIILuc;)Lmp;", line = 56)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(Lpu;Lpu;ILpu;Lpu;)V", line = 128)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(IB)Z", line = 145)
