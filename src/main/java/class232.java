...
public class class232 extends class425 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IZ[Lwca;IBI)V", line = 6)
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Z)V", line = 67)
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(I)V", line = 99)
