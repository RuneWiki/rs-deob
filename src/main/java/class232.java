...
public class class232 extends class219 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!oq", name = "c", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!oq", name = "d", descriptor = "(I)I", line = 71)
    ...
    @OriginalMember(owner = "client!oq", name = "e", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(I)Lvm;", line = 116)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(BJ)V", line = 212)
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "(ILeg;Leg;Lpq;Lha;IIZ)V", line = 896)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(II)I", line = 237)
    ...
    @OriginalMember(owner = "client!oq", name = "b", descriptor = "(II)[B", line = 255)
    ...
    @OriginalMember(owner = "client!oq", name = "c", descriptor = "(II)V", line = 281)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ILtj;)V", line = 311)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ZIIIZ)V", line = 326)
    ...
    @OriginalMember(owner = "client!oq", name = "f", descriptor = "(I)V", line = 341)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/Class;", line = 521)
    ...
    @OriginalMember(owner = "client!oq", name = "g", descriptor = "(I)I", line = 568)
    ...
    @OriginalMember(owner = "client!oq", name = "h", descriptor = "(I)I", line = 580)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(III)Lpd;", line = 598)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IIZILir;I)V", line = 811)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Z)V", line = 835)
