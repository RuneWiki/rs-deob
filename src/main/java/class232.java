...
public class class232 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IBLjava/lang/String;)V", line = 16)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(II)Lqt;", line = 44)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IBIIIIIII)V", line = 88)
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(ILpl;Lpl;)V", line = 144)
