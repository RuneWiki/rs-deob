...
public class class232 extends class573 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Lwc;IB)V")
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "(Lrv;)V")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ILee;)Lvn;")
