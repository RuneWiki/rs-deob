...
public class class232 {
    ...
    @OriginalMember(owner = "client!vh", name = "toString", descriptor = "()Ljava/lang/String;", line = 6)
    public final String toString() {
        field3518++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(Z[FI)[F", line = 32)
    ...
    @OriginalMember(owner = "client!vh", name = "b", descriptor = "(I)Z", line = 46)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(III)Z", line = 56)
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "(I)V", line = 122)
