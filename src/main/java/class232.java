...
public class class232 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(IB)V", line = 17)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(IIIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(IIILkl;)V", line = 129)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(IBILjs;)V", line = 142)
