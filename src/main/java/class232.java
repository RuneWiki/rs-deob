...
public class class232 extends class274 implements class285 {
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Lvm;Z)Ldn;")
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(BLvm;)V")
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Lvm;II)Ljn;")
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Lvm;I)V")
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(ZLvm;)V")
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IIILvm;)Z")
    ...
    @OriginalMember(owner = "client!aq", name = "<init>", descriptor = "(Lvm;Lds;IIIIIIIZIIII)V")
