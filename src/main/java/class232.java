...
public class class232 extends class42 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(ZI)I", line = 25)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;Z)I", line = 65)
    ...
    @OriginalMember(owner = "client!rq", name = "d", descriptor = "(I)V", line = 187)
