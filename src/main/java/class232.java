...
public class class232 extends class274 {
    ...
    @OriginalMember(owner = "client!gca", name = "<init>", descriptor = "(Lqe;)V")
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Lw;III[Z)V")
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Ljava/awt/Frame;Lii;I)V")
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(ILoa;)V")
