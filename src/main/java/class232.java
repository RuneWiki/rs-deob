...
public class class232 extends class496 {
    ...
    @OriginalMember(owner = "client!jd", name = "d", descriptor = "()I", line = 4)
    public final int method1614() {
        field3359++;
        return this.field3376 + this.field3354 + this.field3374;
    }

    @OriginalMember(owner = "client!jd", name = "c", descriptor = "(IIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IIII[III)V", line = 29)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ILcea;)Lou;", line = 37)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "()I", line = 54)
    public final int method1618() {
        field3356++;
        return this.field3373 + this.field3357 + this.field3368;
    }

    @OriginalMember(owner = "client!jd", name = "b", descriptor = "()I", line = 68)
    public final int method1619() {
        field3361++;
        return this.field3374;
    }

    @OriginalMember(owner = "client!jd", name = "b", descriptor = "(III)Lfe;", line = 79)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(FFFFFFIIII)V", line = 99)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IIIIIII)V", line = 167)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(FFFFFFILaa;II)V", line = 375)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(III)V", line = 432)
    ...
    @OriginalMember(owner = "client!jd", name = "c", descriptor = "(III)Z", line = 545)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IIIIIIII)V", line = 562)
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "(Lwga;IIZ)V", line = 740)
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "(Lwga;II[III)V", line = 755)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "([I)V", line = 604)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IIIII)V", line = 616)
    ...
    @OriginalMember(owner = "client!jd", name = "c", descriptor = "()I", line = 651)
    public final int method1626() {
        field3377++;
        return this.field3368;
    }

    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IIIIII)V", line = 659)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IILaa;II)V", line = 693)
