...
public class class232 implements class716 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IB)Ljava/lang/String;", line = 28)
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(I)Z", line = 61)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Lsa;I[[B)V", line = 111)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ZB)V", line = 227)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(Lnd;Lnd;Lnc;)V", line = 262)
