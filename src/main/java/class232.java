...
public class class232 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "([J[IIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IIIIIII)V", line = 94)
