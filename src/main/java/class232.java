...
public class class232 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(ZI)Lkr;", line = 18)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(II)V", line = 52)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IB)V", line = 77)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "(Lgp;ILui;)V", line = 115)
