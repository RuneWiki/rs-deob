...
public class class232 extends class270 {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "([SB)[S", line = 7)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IILjava/lang/String;IIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(III)V", line = 46)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Z)V", line = 61)
    ...
    @OriginalMember(owner = "client!se", name = "<init>", descriptor = "(II)V", line = 75)
