...
public class class232 extends class40 {
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "()V", line = 13)
    public class232() {
        super(0, false);
    }

    @OriginalMember(owner = "client!oh", name = "f", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!oh", name = "c", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Ltj;Ltj;I)V", line = 44)
    ...
    @OriginalMember(owner = "client!oh", name = "d", descriptor = "(I)Z", line = 60)
    ...
    @OriginalMember(owner = "client!oh", name = "d", descriptor = "(B)I", line = 94)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Lhl;IIII)V", line = 107)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(IILlf;)V", line = 268)
