...
public class class232 extends class147 {
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!ac", name = "c", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(IIIIIZ)V", line = 95)
