...
public class class232 extends class145 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Lap;BI)V")
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ILqi;IZII)V")
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ILpg;Lbd;Ljava/awt/Canvas;II)Lpe;")
