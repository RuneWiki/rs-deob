...
public class class232 extends class404 {
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "()Ljc;", line = 4)
    public final class404 method1457() {
        return (class404) this.field3210.method1436(28964);
    }

    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lrp;Lfi;)V", line = 9)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lfi;)V", line = 18)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!se", name = "e", descriptor = "()I", line = 79)
    public final synchronized int method1461() {
        return this.field3210.method1434((byte) -95);
    }

    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Ljc;)V", line = 86)
    public final synchronized void method1462(class404 arg0) {
        this.field3210.method1438(arg0, -32762);
    }

    @OriginalMember(owner = "client!se", name = "f", descriptor = "()V", line = 90)
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(Ljc;)V", line = 110)
    public final synchronized void method1464(class404 arg0) {
        arg0.method2340(99);
    }

    @OriginalMember(owner = "client!se", name = "d", descriptor = "()I", line = 115)
    public final int method1465() {
        return 0;
    }

    @OriginalMember(owner = "client!se", name = "c", descriptor = "()Ljc;", line = 121)
    public final class404 method1466() {
        return (class404) this.field3210.method1443((byte) 6);
    }

    @OriginalMember(owner = "client!se", name = "b", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!se", name = "c", descriptor = "([III)V", line = 137)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "([III)V", line = 150)
