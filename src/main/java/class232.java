...
public class class232 extends class354 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IIB)I", line = 3)
    ...
    @OriginalMember(owner = "client!dj", name = "b", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!dj", name = "b", descriptor = "(BI)[I", line = 36)
    ...
    @OriginalMember(owner = "client!dj", name = "<init>", descriptor = "()V", line = 68)
    public class232() {
        super(0, true);
    }
}
