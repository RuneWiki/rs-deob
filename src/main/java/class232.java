...
public class class232 extends class424 {
    ...
    @OriginalMember(owner = "client!nn", name = "b", descriptor = "(II)V", line = 8)
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "()V", line = 49)
    public class232() {
        super(1, false);
    }

    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ILea;)V", line = 53)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IZ)[[I", line = 69)
    ...
    @OriginalMember(owner = "client!nn", name = "d", descriptor = "(B)V", line = 130)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Lrg;BI)V", line = 155)
    ...
    @OriginalMember(owner = "client!nn", name = "g", descriptor = "(I)V", line = 200)
