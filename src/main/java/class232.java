...
public class class232 extends class154 implements class560 {
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Ljava/lang/Exception;)V", line = 18)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 41)
    ...
    @OriginalMember(owner = "client!p", name = "<init>", descriptor = "(Loa;Ljava/awt/Canvas;II)V", line = 68)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Ljava/awt/Canvas;II)V", line = 75)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "()V", line = 81)
    ...
    @OriginalMember(owner = "client!p", name = "finalize", descriptor = "()V", line = 86)
