...
public abstract class class232 extends class622 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ltq;Ljava/lang/String;II)Loc;")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ILjava/net/Socket;I)Lrd;")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Lpt;IIIII)V")
