...
public class class232 {
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(ZLp;)Z", line = 6)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!cba", name = "b", descriptor = "(I)I", line = 41)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(Lcba;B)Z", line = 63)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(IIILqa;)V", line = 84)
