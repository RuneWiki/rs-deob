...
public class class232 {
    ...
    @OriginalMember(owner = "client!jd", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(B)I", line = 30)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IBIIZ)Lgb;", line = 45)
    ...
    @OriginalMember(owner = "client!jd", name = "c", descriptor = "(I)Z", line = 89)
    ...
    @OriginalMember(owner = "client!jd", name = "d", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IZ)V", line = 130)
    ...
    @OriginalMember(owner = "client!jd", name = "e", descriptor = "(I)Z", line = 159)
    ...
    @OriginalMember(owner = "client!jd", name = "f", descriptor = "(I)V", line = 434)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IIZIFIIBI)[[I", line = 453)
    ...
    @OriginalMember(owner = "client!jd", name = "g", descriptor = "(I)V", line = 486)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Lvt;ZB)V", line = 503)
    ...
    @OriginalMember(owner = "client!jd", name = "h", descriptor = "(I)I", line = 573)
    ...
    @OriginalMember(owner = "client!jd", name = "b", descriptor = "(B)V", line = 587)
    ...
    @OriginalMember(owner = "client!jd", name = "i", descriptor = "(I)Z", line = 615)
    ...
    @OriginalMember(owner = "client!jd", name = "c", descriptor = "(B)V", line = 631)
