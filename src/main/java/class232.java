...
public class class232 extends class289 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIII)V", line = 5)
    public final void method959(int arg0, int arg1, int arg2, int arg3) {
        ...
        float var18 = (float) (class245.field3862 - arg1);
        float var19 = var18 - (float) arg3;
        float var20 = (float) this.field4802 / (float) this.field3693;
        float var21 = (float) this.field4811 / (float) this.field3697;
        var15.glBegin(6);
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IILko;)V", line = 76)
    public final void method1599(int arg0, int arg1, class232 arg2) {
        if (arg2 == null) {
            return;
        }
        class245.method1725();
        ...
        float var7 = (float) (this.field4802 + arg0 - class335.field5430) / (float) arg2.field3693;
        float var8 = (float) (this.field4811 + arg1 - class335.field5427) / (float) arg2.field3697;
        int var9 = this.field4803 + arg0;
        int var10 = this.field4804 + arg1;
        var4.glBegin(6);
        var4.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        float var11 = (float) this.field4802 / (float) this.field3693;
        float var12 = (float) this.field4811 / (float) this.field3697;
        var4.glMultiTexCoord2f(33985, var7, var6);
        var4.glTexCoord2f(var11, 0.0F);
        var4.glVertex2f((float) (this.field4802 + var9), (float) (class245.field3862 - var10));
        ...
        var4.glVertex2f((float) var9, (float) (class245.field3862 - (this.field4811 + var10)));
        var4.glMultiTexCoord2f(33985, var7, var8);
        var4.glTexCoord2f(var11, var12);
        var4.glVertex2f((float) (this.field4802 + var9), (float) (class245.field3862 - (this.field4811 + var10)));
        var4.glEnd();
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIIII)V", line = 126)
    public final void method961(int arg0, int arg1, int arg2, int arg3, int arg4) {
        ...
        float var19 = (float) (class245.field3862 - arg1);
        float var20 = var19 - (float) arg3;
        float var21 = (float) this.field4802 / (float) this.field3693;
        float var22 = (float) this.field4811 / (float) this.field3697;
    ...
    @OriginalMember(owner = "client!ko", name = "c", descriptor = "(II)V", line = 199)
    public final void method963(int arg0, int arg1) {
        ...
        float var6 = (float) this.field4802 / (float) this.field3693;
        float var7 = (float) this.field4811 / (float) this.field3697;
        var5.glBegin(6);
        var5.glTexCoord2f(0.0F, 0.0F);
        var5.glVertex2f((float) this.field4802, 0.0F);
        var5.glTexCoord2f(var6, 0.0F);
        var5.glVertex2f(0.0F, 0.0F);
        var5.glTexCoord2f(var6, var7);
        var5.glVertex2f(0.0F, (float) (-this.field4811));
        var5.glTexCoord2f(0.0F, var7);
        var5.glVertex2f((float) this.field4802, (float) (-this.field4811));
        var5.glEnd();
        var5.glLoadIdentity();
    }

    @OriginalMember(owner = "client!ko", name = "i", descriptor = "(I)V", line = 224)
    public final void method1600(int arg0) {
        if (this.field3698 == arg0) {
            return;
        }
        this.field3698 = arg0;
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(IIIIII[I)V", line = 555)
    public class232(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int[] arg6) {
        ...
        this.field4802 = arg4;
        this.field4811 = arg5;
        this.method1605(arg6);
        this.method1602();
    }

    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(Lle;)V", line = 582)
    public class232(class137 arg0) {
        this.field4805 = arg0.field4805;
        this.field4812 = arg0.field4812;
        this.field4803 = arg0.field4803;
        this.field4804 = arg0.field4804;
        this.field4802 = arg0.field4802;
        this.field4811 = arg0.field4811;
        this.method1605(arg0.field2172);
        this.method1602();
    }

    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIIIII)V", line = 248)
    public final void method956(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        class245.method1725();
        GL var7 = class245.field3884;
        class245.method1729(this.field3695);
        this.method1600(1);
        int var8 = arg0 - (this.field4803 << 4);
        int var9 = arg1 - (this.field4804 << 4);
        var7.glTranslatef((float) arg2 / 16.0F, (float) class245.field3862 - (float) arg3 / 16.0F, 0.0F);
        ...
        var7.glCallList(this.field3699);
        var7.glLoadIdentity();
    }

    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIIIIIIILko;)V", line = 265)
    public final void method1601(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, class232 arg8) {
        if (arg8 == null) {
            return;
        }
        class245.method1725();
        class245.method1729(arg8.field3695);
        arg8.method1600(1);
        ...
        var10.glEnable(3553);
        var10.glBindTexture(3553, arg8.field3695);
        ...
        float var27 = (float) arg8.field4802 / (float) arg8.field3693;
        float var28 = (float) arg8.field4811 / (float) arg8.field3697;
        var10.glBegin(6);
        var10.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        float var29 = (float) this.field3693 * 65536.0F;
        float var30 = (float) (this.field3697 * 65536);
        var10.glMultiTexCoord2f(33985, var27, 0.0F);
        var10.glTexCoord2f((float) var21 / var29, (float) var22 / var30);
        var10.glVertex2f((float) (arg0 + arg2), (float) (class245.field3862 - arg1));
        var10.glMultiTexCoord2f(33985, 0.0F, 0.0F);
        var10.glTexCoord2f((float) var19 / var29, (float) var20 / var30);
        var10.glVertex2f((float) arg0, (float) (class245.field3862 - arg1));
        var10.glMultiTexCoord2f(33985, 0.0F, var28);
        var10.glTexCoord2f((float) var23 / var29, (float) var24 / var30);
        var10.glVertex2f((float) arg0, (float) (class245.field3862 - (arg1 + arg3)));
        var10.glMultiTexCoord2f(33985, var27, var28);
        var10.glTexCoord2f((float) var25 / var29, (float) var26 / var30);
        var10.glVertex2f((float) (arg0 + arg2), (float) (class245.field3862 - (arg1 + arg3)));
        var10.glEnd();
    ...
    @OriginalMember(owner = "client!ko", name = "c", descriptor = "(III)V", line = 339)
    public final void method946(int arg0, int arg1, int arg2) {
        ...
        var6.glCallList(this.field3699);
        var6.glLoadIdentity();
    }

    @OriginalMember(owner = "client!ko", name = "a", descriptor = "()V", line = 355)
    private final void method1602() {
        float var1 = (float) this.field4802 / (float) this.field3693;
        float var2 = (float) this.field4811 / (float) this.field3697;
        GL var3 = class245.field3884;
        if (this.field3699 == -1) {
            this.field3699 = var3.glGenLists(1);
            this.field3696 = class173.field2703;
        }
        var3.glNewList(this.field3699, 4864);
        var3.glBegin(6);
        var3.glTexCoord2f(var1, 0.0F);
        var3.glVertex2f((float) this.field4802, 0.0F);
        var3.glTexCoord2f(0.0F, 0.0F);
        var3.glVertex2f(0.0F, 0.0F);
        var3.glTexCoord2f(0.0F, var2);
        var3.glVertex2f(0.0F, (float) (-this.field4811));
        var3.glTexCoord2f(var1, var2);
        var3.glVertex2f((float) this.field4802, (float) (-this.field4811));
        var3.glEnd();
        var3.glEndList();
    }

    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(II)V", line = 381)
    public final void method966(int arg0, int arg1) {
        ...
        this.method1600(1);
        var5.glTranslatef((float) var3, (float) (class245.field3862 - var4), 0.0F);
        var5.glCallList(this.field3699);
        var5.glLoadIdentity();
    }

    @OriginalMember(owner = "client!ko", name = "finalize", descriptor = "()V", line = 396)
    protected final void finalize() throws Throwable {
        if (this.field3695 != -1) {
            class173.method1191(this.field3695, this.field3694, this.field3696);
            this.field3695 = -1;
            this.field3694 = 0;
        }
        if (this.field3699 != -1) {
            class173.method1195(this.field3699, this.field3696);
            this.field3699 = -1;
        }
        super.finalize();
    }

    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(IIIII)V", line = 412)
    public final void method1603(int arg0, int arg1, int arg2, int arg3, int arg4) {
        class245.method1726();
        GL var6 = class245.field3884;
        class245.method1729(this.field3695);
        this.method1600(1);
        float var7 = (float) this.field4802 / (float) this.field3693;
        float var8 = (float) this.field4811 / (float) this.field3697;
        float var9 = (float) arg3 * var7;
        float var10 = (float) arg4 * var8;
        int var11 = this.field4803 + arg0;
        int var12 = this.field4802 * arg3 + var11;
        int var13 = class245.field3862 - arg1 - this.field4804;
        int var14 = var13 - this.field4811 * arg4;
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(IIII)V", line = 446)
    public final void method1604(int arg0, int arg1, int arg2, int arg3) {
        ...
        float var9 = (float) arg3 * var7;
        int var10 = this.field4803 + arg0;
        int var11 = this.field4802 * arg2 + var10;
        int var12 = class245.field3862 - arg1 - this.field4804;
        int var13 = var12 - this.field4811 * arg3;
        var5.glBegin(6);
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(II)V", line = 477)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "([I)V", line = 489)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(IIIIII)V", line = 566)
    public final void method1606(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        class245.method1725();
        GL var7 = class245.field3884;
        class245.method1729(this.field3695);
        this.method1600(2);
