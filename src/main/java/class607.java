...
public class class607 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(II[BBIII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lwm;I)V", line = 57)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Ltia;I)V", line = 85)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IIIILoq;I)Ljava/awt/Frame;", line = 131)
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "(I)V", line = 202)
