...
public class class607 extends class10 implements class456 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Lgaa;I)V", line = 7)
    public final void method54(class267 arg0, int arg1) {
        super.method54(arg0, arg1);
    }

    @OriginalMember(owner = "client!pb", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 17)
    ...
    @OriginalMember(owner = "client!pb", name = "<init>", descriptor = "(Ltb;Llca;III[B)V", line = 26)
