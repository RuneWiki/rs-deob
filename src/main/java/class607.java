...
public class class607 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Ljava/lang/Object;Lkw;I)V", line = 5)
    public final void method3532(Object arg0, class228 arg1, int arg2) {
        this.method3538(arg0, arg1, arg2, (byte) -116);
        field8635++;
    }

    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Lkw;B)Ljava/lang/Object;", line = 17)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(I)I", line = 69)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IIIII)Z", line = 108)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Lgd;I)V", line = 140)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Ljava/lang/Object;Lkw;IB)V", line = 159)
    ...
    @OriginalMember(owner = "client!mj", name = "b", descriptor = "(Lkw;B)V", line = 188)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Z)I", line = 223)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(II)V", line = 234)
    ...
    @OriginalMember(owner = "client!mj", name = "b", descriptor = "(B)V", line = 282)
    ...
    @OriginalMember(owner = "client!mj", name = "<init>", descriptor = "(I)V", line = 300)
