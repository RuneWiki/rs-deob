...
public class class607 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Throwable;Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(BIII)I", line = 72)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ZLdt;)V", line = 103)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "(Luq;)V", line = 165)
    ...
    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "()V", line = 182)
    protected class607() {
