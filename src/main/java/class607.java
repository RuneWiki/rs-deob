...
public class class607 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Lka;IIIZI)Lka;", line = 4)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(B)V", line = 141)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Lka;BIBIIII)Lka;", line = 273)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IJ)V", line = 338)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(I)V", line = 424)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ILso;)V", line = 461)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IZII)I", line = 505)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Z)V", line = 641)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Lso;IZ)V", line = 680)
