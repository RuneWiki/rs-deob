...
public class class607 extends class694 {
    ...
    @OriginalMember(owner = "client!rda", name = "c", descriptor = "(II)[[I", line = 8)
    ...
    @OriginalMember(owner = "client!rda", name = "<init>", descriptor = "()V", line = 67)
    public class607() {
        super(3, false);
    }

    @OriginalMember(owner = "client!rda", name = "d", descriptor = "(III)V", line = 71)
    ...
    @OriginalMember(owner = "client!rda", name = "g", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(ILjr;B)V", line = 100)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(II)[I", line = 135)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(B)V", line = 185)
