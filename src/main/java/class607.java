...
public class class607 implements Runnable {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IILoa;IILe;I)V", line = 39)
    ...
    @OriginalMember(owner = "client!rn", name = "run", descriptor = "()V", line = 123)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Ljava/lang/String;B)Liw;", line = 163)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Lfaa;I)V", line = 188)
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "()V", line = 204)
    public class607() {
