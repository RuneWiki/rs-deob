...
public class class607 {
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Z)Lgi;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(ILiaa;I)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Liaa;B)V")
