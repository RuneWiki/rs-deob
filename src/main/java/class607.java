...
public class class607 implements class132 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ILhh;)Z", line = 5)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ZZLjava/lang/String;Lnd;)Lgea;", line = 49)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(B)J", line = 111)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(BI)I", line = 140)
