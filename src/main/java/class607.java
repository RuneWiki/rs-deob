...
public class class607 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(I[BI)V", line = 117)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(II)V", line = 164)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Z)V", line = 183)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(B)V", line = 195)
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(II)Z", line = 229)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(JB[B)V", line = 240)
