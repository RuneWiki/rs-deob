...
public class class607 {
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(BC)V", line = 5)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!iw", name = "b", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!iw", name = "<init>", descriptor = "(Lrs;I)V", line = 53)
    public class607(class166 arg0, int arg1) {
        this.field8573 = OpenGL.glGenLists(arg1);
    }

    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 67)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(II)V", line = 89)
