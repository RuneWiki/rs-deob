...
public class class607 extends class738 {
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(FIFF[FF)V", line = 6)
    ...
    @OriginalMember(owner = "client!ou", name = "c", descriptor = "(III[I)V", line = 50)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Z)V", line = 63)
    ...
    @OriginalMember(owner = "client!ou", name = "c", descriptor = "(B)[F", line = 74)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(III)V", line = 97)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "()V", line = 109)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(III[I)V", line = 119)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "([I)V", line = 134)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(ILql;)V", line = 150)
    ...
    @OriginalMember(owner = "client!ou", name = "d", descriptor = "(B)[F", line = 174)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Lql;)V", line = 199)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(I)V", line = 221)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "()Lql;", line = 233)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(III[I)V", line = 256)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IIIIII)V", line = 270)
    ...
    @OriginalMember(owner = "client!ou", name = "e", descriptor = "(I)V", line = 305)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IFFIFII)V", line = 317)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(I)V", line = 352)
    ...
    @OriginalMember(owner = "client!ou", name = "g", descriptor = "(I)V", line = 379)
    ...
    @OriginalMember(owner = "client!ou", name = "c", descriptor = "(I)V", line = 400)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(III)V", line = 414)
    ...
    @OriginalMember(owner = "client!ou", name = "d", descriptor = "(I)V", line = 433)
    ...
    @OriginalMember(owner = "client!ou", name = "f", descriptor = "(I)V", line = 460)
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "()V", line = 501)
    public class607() {
        this.method769();
    }

    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(ILjava/lang/String;IBI)V", line = 509)
