...
public class class607 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lha;IIILof;BII)Loia;", line = 7)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ZI)V", line = 30)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IB)V", line = 46)
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!lj", name = "c", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IIZILha;Lda;Lof;IIZLha;Z)Loia;", line = 115)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Z)V", line = 181)
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(Z)V", line = 197)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(BI)V", line = 211)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IZ)Lnl;", line = 225)
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(Lsaa;IZLfba;Lfp;Lfp;)V", line = 325)
