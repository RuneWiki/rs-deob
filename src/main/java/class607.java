...
public class class607 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(BI)V", line = 22)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(IIIIIIII)V", line = 38)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Lpc;)V", line = 216)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(IZ)Ltu;", line = 274)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Z)V", line = 305)
    ...
    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "(Lbt;ILkda;Lkda;)V", line = 329)
