...
public class class607 extends class54 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "(ILhia;)V", line = 4)
    public class607(int arg0, class73 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ht", name = "c", descriptor = "(Z)I", line = 14)
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "(Lhia;)V", line = 27)
    public class607(class73 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ht", name = "b", descriptor = "(Z)I", line = 30)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(II)V", line = 41)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(IIIILha;IBII)V", line = 52)
    ...
    @OriginalMember(owner = "client!ht", name = "b", descriptor = "(IB)I", line = 190)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(ZB)V", line = 202)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(Z)V", line = 230)
