...
public class class607 extends class528 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "()Ljn;", line = 4)
    ...
    @OriginalMember(owner = "client!ek", name = "c", descriptor = "()I", line = 23)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Ljava/lang/String;ILml;I)Lv;", line = 31)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "([III)V", line = 101)
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "()Ljn;", line = 140)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Ltia;II)V", line = 163)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(B)V", line = 202)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Ltia;I[IIII)V", line = 214)
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "(Lng;)V", line = 291)
