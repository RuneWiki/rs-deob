...
public class class607 extends class60 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Lha;IIIIBII[[[BIIII)V")
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(Lhd;)V")
    public class607(class773 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(ILhd;)V")
