...
public class class607 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IILsl;)V")
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Lsl;Z)V")
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ZIILha;)Ltd;")
