...
public class class607 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(ILji;)V", line = 12)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(I)V", line = 96)
    public class607(int arg0) {
        this.field8816 = arg0;
    }

    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(IIIIII)V", line = 106)
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(I)Lji;", line = 50)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IIIIIZI)V", line = 62)
