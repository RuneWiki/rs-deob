...
public abstract class class607 {
    ...
    @OriginalMember(owner = "client!ic", name = "b", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!ic", name = "c", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Z)V", line = 55)
    ...
    @OriginalMember(owner = "client!ic", name = "d", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "(Ltu;)V", line = 82)
    public class607(class294 arg0) {
        this.field8870 = arg0;
    }

    @OriginalMember(owner = "client!ic", name = "b", descriptor = "(Z)V", line = 90)
