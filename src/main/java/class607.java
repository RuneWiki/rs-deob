...
public class class607 extends class384 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(ZB)V", line = 3)
    ...
    @OriginalMember(owner = "client!pe", name = "c", descriptor = "(I)Z", line = 14)
    ...
    @OriginalMember(owner = "client!pe", name = "d", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(Lln;Lwt;)V", line = 51)
    public class607(class377 arg0, class309 arg1) {
        super(arg0);
        this.field8630 = arg1;
    }

    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(ZI)V", line = 87)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "([[[Lcj;IZIBI)Z", line = 107)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IIZ)V", line = 427)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Lke;BI)V", line = 476)
