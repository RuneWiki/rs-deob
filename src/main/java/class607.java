...
public class class607 extends class249 {
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(IIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(III)V", line = 33)
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(BII)V", line = 48)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(BII)V", line = 59)
