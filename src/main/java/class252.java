...
public class class252 extends class106 {
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(IBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(ZB)V", line = 50)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(IILih;)V", line = 61)
    ...
    @OriginalMember(owner = "client!mv", name = "b", descriptor = "(Z)V", line = 78)
    ...
    @OriginalMember(owner = "client!mv", name = "b", descriptor = "(I)Z", line = 122)
    public final boolean method348(int arg0) {
        ++field3593;
        return arg0 == -22884;
    }

    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(Lvj;Lpo;)V", line = 133)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(ZI)V", line = 147)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!mv", name = "f", descriptor = "(I)V", line = 201)
