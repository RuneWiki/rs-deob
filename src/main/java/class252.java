...
public abstract class class252 implements class383 {
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(BZ)V", line = 48)
    ...
    @OriginalMember(owner = "client!he", name = "c", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!he", name = "d", descriptor = "(I)I", line = 89)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Lza;)V", line = 104)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(III)B", line = 179)
    ...
    @OriginalMember(owner = "client!he", name = "finalize", descriptor = "()V", line = 198)
    ...
    @OriginalMember(owner = "client!he", name = "e", descriptor = "(I)I", line = 207)
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "(B)Z", line = 222)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(II)V", line = 247)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(ZI)V", line = 259)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(JIILta;Ljk;IIII)V", line = 280)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IILkh;)Z", line = 332)
    ...
    @OriginalMember(owner = "client!he", name = "<init>", descriptor = "(Lur;IIIZ)V", line = 492)
