...
public class class252 extends class160 {
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "()V", line = 3)
    public final void method1148() {
        field3636.method3049(this.field3637, (byte) -108);
    }

    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 7)
    ...
    @OriginalMember(owner = "client!mv", name = "d", descriptor = "()V", line = 10)
    public final void method1158() {
        field3636.method3048(-26520, this.field3637);
    }

    @OriginalMember(owner = "client!mv", name = "c", descriptor = "()I", line = 13)
    public final int method1152() {
        return field3636.method3047(this.field3637, (byte) -85);
    }

    @OriginalMember(owner = "client!mv", name = "e", descriptor = "()V", line = 17)
    public static void method1604() {
        field3636 = null;
    }

    @OriginalMember(owner = "client!mv", name = "d", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(Lci;I)V", line = 25)
    public class252(class312 arg0, int arg1) {
        field3636 = arg0.method1960((byte) 43);
        this.field3637 = arg1;
    }

    @OriginalMember(owner = "client!mv", name = "b", descriptor = "()V", line = 30)
