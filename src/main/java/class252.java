...
public class class252 extends class157 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lvd;)V", line = 7)
    public final void method557(class4 arg0) {
        this.field2366.method207(arg0);
    }

    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(Z)V", line = 13)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Z)V", line = 59)
    public final void method556(boolean arg0) {
    }

    @OriginalMember(owner = "client!tq", name = "c", descriptor = "()V", line = 64)
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "()V", line = 89)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "()Z", line = 101)
    public final boolean method555() {
        return true;
    }

    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lhd;Lcf;)V", line = 104)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(I)V", line = 163)
