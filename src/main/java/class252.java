...
public class class252 extends class779 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!tea", name = "b", descriptor = "(I)Ltaa;", line = 15)
    ...
    @OriginalMember(owner = "client!tea", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 27)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        this.method1665(arg0.getX(), arg0.getY(), 84);
        field3699++;
    }

    @OriginalMember(owner = "client!tea", name = "e", descriptor = "(I)Z", line = 35)
    ...
    @OriginalMember(owner = "client!tea", name = "d", descriptor = "(I)Z", line = 47)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(Ljava/awt/Component;Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(B)V", line = 74)
    ...
    @OriginalMember(owner = "client!tea", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 87)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method1665(arg0.getX(), arg0.getY(), 56);
        field3682++;
    }

    @OriginalMember(owner = "client!tea", name = "f", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(IBIII)V", line = 124)
    ...
    @OriginalMember(owner = "client!tea", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 142)
    ...
    @OriginalMember(owner = "client!tea", name = "g", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!tea", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 184)
    public final synchronized void mouseExited(MouseEvent arg0) {
        field3704++;
        this.method1665(arg0.getX(), arg0.getY(), 109);
    }

    @OriginalMember(owner = "client!tea", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 192)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        field3687++;
        this.method1665(arg0.getX(), arg0.getY(), 103);
    }

    @OriginalMember(owner = "client!tea", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 201)
    ...
    @OriginalMember(owner = "client!tea", name = "c", descriptor = "(B)Z", line = 232)
    ...
    @OriginalMember(owner = "client!tea", name = "h", descriptor = "(I)V", line = 243)
    ...
    @OriginalMember(owner = "client!tea", name = "b", descriptor = "(B)I", line = 268)
    ...
    @OriginalMember(owner = "client!tea", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 358)
    public class252(Component arg0, boolean arg1) {
        this.method1656(arg0, false);
        this.field3710 = arg1;
    }

    @OriginalMember(owner = "client!tea", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 285)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;Z)I", line = 301)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(III)V", line = 341)
