...
public abstract class class252 {
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(IIBI)Z", line = 14)
    ...
    @OriginalMember(owner = "client!vca", name = "b", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!vca", name = "c", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!vca", name = "b", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(BI)Lwb;", line = 143)
    ...
    @OriginalMember(owner = "client!vca", name = "<init>", descriptor = "(Lhea;)V", line = 166)
    public class252(class387 arg0) {
        this.field3884 = arg0;
    }

    @OriginalMember(owner = "client!vca", name = "c", descriptor = "(I)V", line = 174)
    ...
    @OriginalMember(owner = "client!vca", name = "d", descriptor = "(I)V", line = 185)
    ...
    @OriginalMember(owner = "client!vca", name = "f", descriptor = "(I)V", line = 198)
    ...
    @OriginalMember(owner = "client!vca", name = "g", descriptor = "(I)V", line = 208)
