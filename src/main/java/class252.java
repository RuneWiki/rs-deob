...
public class class252 extends class337 {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(I[B)[B", line = 16)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(ZII)V", line = 32)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Ljava/lang/String;Z)Ljava/lang/String;", line = 100)
    ...
    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "(Lmh;Lpda;)V", line = 119)
    ...
    @OriginalMember(owner = "client!vt", name = "b", descriptor = "(I)V", line = 171)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(BZ)V", line = 200)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(B)V", line = 250)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(JB)V", line = 268)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Z)V", line = 284)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(IBLuu;)V", line = 296)
    ...
    @OriginalMember(owner = "client!vt", name = "b", descriptor = "(B)Z", line = 314)
