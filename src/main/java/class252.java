...
public class class252 extends class529 {
    ...
    @OriginalMember(owner = "client!fi", name = "f", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IB)[I", line = 112)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "()V", line = 212)
    public class252() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(I)V", line = 222)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IBLtn;)V", line = 237)
    ...
    @OriginalMember(owner = "client!fi", name = "g", descriptor = "(I)V", line = 328)
