...
public class class252 extends class220 {
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "()V", line = 3)
    public class252() {
        super(1, true);
    }

    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IZLqj;)Lhd;", line = 14)
    ...
    @OriginalMember(owner = "client!bj", name = "c", descriptor = "(II)[I", line = 30)
    ...
    @OriginalMember(owner = "client!bj", name = "e", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IILsn;ILqa;ILro;I)V", line = 204)
    ...
    @OriginalMember(owner = "client!bj", name = "f", descriptor = "(I)V", line = 248)
