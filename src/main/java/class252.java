...
public class class252 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IIIIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Z)V", line = 84)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Ljava/util/Random;IB)I", line = 96)
