...
public class class252 {
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(IJ)Lge;", line = 15)
    ...
    @OriginalMember(owner = "client!mv", name = "b", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(IB)V", line = 67)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Lge;BJ)V", line = 95)
    ...
    @OriginalMember(owner = "client!mv", name = "c", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(I)V", line = 181)
