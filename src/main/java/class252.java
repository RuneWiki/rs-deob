...
public class class252 extends class601 {
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(Ljm;)V", line = 6)
    ...
    @OriginalMember(owner = "client!kw", name = "b", descriptor = "(BII)V", line = 99)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(BI)[I", line = 175)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(IIIII)V", line = 210)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(Lee;BI)V", line = 286)
    ...
    @OriginalMember(owner = "client!kw", name = "b", descriptor = "(IZ)[[I", line = 301)
    ...
    @OriginalMember(owner = "client!kw", name = "<init>", descriptor = "()V", line = 343)
    public class252() {
        super(1, false);
    }

    @OriginalMember(owner = "client!kw", name = "e", descriptor = "(I)V", line = 354)
