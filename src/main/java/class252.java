...
public class class252 extends InputStream {
    ...
    @OriginalMember(owner = "client!cca", name = "read", descriptor = "()I", line = 4)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(Z)[Lwea;", line = 29)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(Z[B)[B", line = 43)
