...
public class class252 extends class86 implements class212 {
    ...
    @OriginalMember(owner = "client!po", name = "finalize", descriptor = "()V", line = 10)
    ...
    @OriginalMember(owner = "client!po", name = "c", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Z)V", line = 36)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(III)V", line = 50)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Loa;BLjava/lang/String;Z)V", line = 63)
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Lbv;III)V", line = 169)
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Lbv;IIII)V", line = 184)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IIB)Z", line = 104)
    ...
    @OriginalMember(owner = "client!po", name = "c", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(ICLjava/lang/String;)I", line = 132)
