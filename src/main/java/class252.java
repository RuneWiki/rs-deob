...
public class class252 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IIIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "([BI)[B", line = 123)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IIIIIILhh;IIII)Z", line = 190)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(II)I", line = 540)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(BI)I", line = 554)
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(II)V", line = 575)
