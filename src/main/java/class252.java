...
public class class252 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(ZILmv;IIJB)V", line = 13)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(III)Z", line = 24)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(B)V", line = 37)
