...
public class class252 extends class504 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(IBI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Z)V", line = 36)
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "(II)V", line = 85)
