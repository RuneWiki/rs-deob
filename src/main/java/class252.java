...
public class class252 extends class234 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(BLza;)V", line = 16)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IBLza;I)V", line = 81)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "([Ljava/lang/String;[SI)V", line = 559)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IIIIZ)V", line = 571)
