...
public class class252 extends class476 {
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "([BI)V", line = 4)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(Ldk;)Z", line = 9)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "([B)V", line = 26)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "([I)Lhe;", line = 70)
    ...
    @OriginalMember(owner = "client!na", name = "b", descriptor = "(I)[F", line = 128)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "()V", line = 540)
    ...
    @OriginalMember(owner = "client!na", name = "b", descriptor = "([B)V", line = 561)
    ...
    @OriginalMember(owner = "client!na", name = "c", descriptor = "(I)I", line = 715)
    ...
    @OriginalMember(owner = "client!na", name = "b", descriptor = "()I", line = 749)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(Ldk;I)Lna;", line = 760)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(Ldk;II)Lna;", line = 782)
    ...
    @OriginalMember(owner = "client!na", name = "d", descriptor = "(I)F", line = 797)
    ...
    @OriginalMember(owner = "client!na", name = "<init>", descriptor = "([B)V", line = 816)
