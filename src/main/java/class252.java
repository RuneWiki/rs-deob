...
public class class252 extends class328 {
    ...
    @OriginalMember(owner = "client!lt", name = "f", descriptor = "(I)Lpba;")
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(BILco;)V")
    ...
    @OriginalMember(owner = "client!lt", name = "c", descriptor = "(B)V")
