...
public class class252 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Lkb;III[Z)Z")
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(ZI)Lcr;")
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "(Ldn;ILr;)V")
