...
public abstract class class252 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(IIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(III)V", line = 67)
