...
public abstract class class252 {
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(JLjava/lang/String;IIBLjava/lang/String;II)V", line = 17)
