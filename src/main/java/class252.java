...
public class class252 extends class6 {
    ...
    @OriginalMember(owner = "client!om", name = "f", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!om", name = "g", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Ljava/lang/String;Z)I", line = 55)
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 423)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(I[IIII)Z", line = 73)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(III)V", line = 99)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ZIIIIIIF)[I", line = 113)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 137)
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(III)Z", line = 197)
    ...
    @OriginalMember(owner = "client!om", name = "h", descriptor = "(I)V", line = 229)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IZJIB)Ljava/lang/String;", line = 286)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(I[IIZ)Z", line = 363)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(B[III)Z", line = 391)
