...
public class class252 extends Callback {
    ...
    @OriginalMember(owner = "client!ew", name = "callback", descriptor = "(IIII)I", line = 6)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(ZILjava/awt/Component;)V", line = 48)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(III)V", line = 92)
