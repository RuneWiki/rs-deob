...
public class class252 extends class708 {
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Ljava/lang/String;BIZLjava/lang/String;)V", line = 24)
    ...
    @OriginalMember(owner = "client!kf", name = "c", descriptor = "(B)I", line = 82)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(ZI)[[I", line = 101)
    ...
    @OriginalMember(owner = "client!kf", name = "d", descriptor = "(B)V", line = 155)
