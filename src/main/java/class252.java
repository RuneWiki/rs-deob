...
public class class252 extends class189 {
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!he", name = "c", descriptor = "(II)Z", line = 31)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Lmo;B)V", line = 48)
    ...
    @OriginalMember(owner = "client!he", name = "<init>", descriptor = "(Lia;)V", line = 698)
