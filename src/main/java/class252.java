...
public class class252 extends class232 {
    ...
    @OriginalMember(owner = "client!eia", name = "d", descriptor = "(II)Z", line = 7)
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(IIIIIILha;)V", line = 26)
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(ILwq;I)V", line = 85)
    ...
    @OriginalMember(owner = "client!eia", name = "<init>", descriptor = "()V", line = 131)
    public class252() {
        super(0, true);
    }

    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(IB)[I", line = 134)
    ...
    @OriginalMember(owner = "client!eia", name = "c", descriptor = "(II)V", line = 229)
