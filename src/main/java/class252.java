...
public class class252 {
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(IZ)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(I)Lcga;", line = 32)
    ...
    @OriginalMember(owner = "client!kda", name = "b", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(II)I", line = 58)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(IIILlt;)V", line = 108)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(Ldba;Z)Lgca;", line = 137)
    ...
    @OriginalMember(owner = "client!kda", name = "<init>", descriptor = "(Lga;Lga;)V", line = 186)
