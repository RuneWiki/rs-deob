...
public class class252 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!lk", name = "c", descriptor = "(B)I", line = 33)
    ...
    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "()V", line = 49)
    public class252() {
    }

    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "(Ldc;)V", line = 52)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Ljava/awt/Canvas;I)V", line = 66)
