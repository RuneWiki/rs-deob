...
public class class33 extends class219 {
    ...
    @OriginalMember(owner = "client!mca", name = "b", descriptor = "(Z)V", line = 11)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(B)Z", line = 21)
    ...
    @OriginalMember(owner = "client!mca", name = "<init>", descriptor = "(Lcga;)V", line = 60)
