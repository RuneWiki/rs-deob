...
public class class33 extends class577 {
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!mca", name = "c", descriptor = "(B)I", line = 16)
    public final int method267(byte arg0) {
        field444++;
        return arg0 < 112 ? -80 : class447.method2665(-29242421, this.field441);
    }

    @OriginalMember(owner = "client!mca", name = "d", descriptor = "(B)Z", line = 27)
    ...
    @OriginalMember(owner = "client!mca", name = "b", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!mca", name = "c", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!mca", name = "d", descriptor = "(I)I", line = 124)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(IIIZI)V", line = 140)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Z)V", line = 198)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(ILjava/awt/Canvas;ILd;I)Lha;", line = 215)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(III)I", line = 227)
    ...
    @OriginalMember(owner = "client!mca", name = "<init>", descriptor = "(II)V", line = 274)
    public class33(int arg0, int arg1) {
        this.field441 = arg0;
        this.field442 = arg1;
    }

    @OriginalMember(owner = "client!mca", name = "b", descriptor = "(II)Z", line = 285)
    ...
    @OriginalMember(owner = "client!mca", name = "e", descriptor = "(I)Z", line = 296)
