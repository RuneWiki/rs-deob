...
public class class33 extends class476 {
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(BI[I)V", line = 5)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(IB)V", line = 131)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(II)V", line = 151)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(IIBI)V", line = 160)
    ...
    @OriginalMember(owner = "client!wf", name = "b", descriptor = "(I)V", line = 176)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(IIIIF)V", line = 191)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(BI)V", line = 303)
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "(Lmr;IIIII)V", line = 316)
