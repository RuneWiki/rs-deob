...
public class class33 implements class171 {
    ...
    @OriginalMember(owner = "client!rr", name = "b", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(Z)V", line = 30)
    ...
    @OriginalMember(owner = "client!rr", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 42)
    public class33(String arg0) {
        this.field493 = arg0;
    }

    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(ZILwu;I)Lfl;", line = 51)
    ...
    @OriginalMember(owner = "client!rr", name = "c", descriptor = "(I)Z", line = 79)
    ...
    @OriginalMember(owner = "client!rr", name = "d", descriptor = "(I)I", line = 92)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(I)Lvm;", line = 108)
