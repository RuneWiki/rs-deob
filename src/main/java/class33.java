...
public class class33 extends class114 {
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(Lmm;Lgk;)V", line = 6)
    ...
    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(Z)V", line = 66)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Z)V", line = 112)
    public final void method304(boolean arg0) {
    }

    @OriginalMember(owner = "client!wq", name = "c", descriptor = "()V", line = 116)
    ...
    @OriginalMember(owner = "client!wq", name = "b", descriptor = "()V", line = 144)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Lt;)V", line = 154)
    public final void method307(class321 arg0) {
        this.field1748.method2180(arg0);
    }

    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(I)V", line = 157)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "()Z", line = 200)
