...
public class class33 {
    ...
    @OriginalMember(owner = "client!ud", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V")
    ...
    @OriginalMember(owner = "client!ud", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V")
    ...
    @OriginalMember(owner = "client!ud", name = "movemouse", descriptor = "(II)V")
