...
public class class33 {
    ...
    @OriginalMember(owner = "client!MAPQLTQU", name = "j", descriptor = "[LUHNEGZAI;")
    ...
    @OriginalMember(owner = "client!MAPQLTQU", name = "f", descriptor = "[LMAPQLTQU;")
    ...
    @OriginalMember(owner = "client!MAPQLTQU", name = "i", descriptor = "LDNRIFKTO;")
    ...
    @OriginalMember(owner = "client!MAPQLTQU", name = "a", descriptor = "(LDNRIFKTO;I)V")
    ...
    @OriginalMember(owner = "client!MAPQLTQU", name = "a", descriptor = "(BII)LDNRIFKTO;")
    ...
    @OriginalMember(owner = "client!MAPQLTQU", name = "b", descriptor = "(LDNRIFKTO;I)V")
    ...
    @OriginalMember(owner = "client!MAPQLTQU", name = "a", descriptor = "(II)LDNRIFKTO;")
