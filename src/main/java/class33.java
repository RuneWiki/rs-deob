...
public class class33 {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IB)Lav;", line = 3)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(II)V", line = 36)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ZZ)V", line = 70)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!ud", name = "b", descriptor = "(II)V", line = 100)
    ...
    @OriginalMember(owner = "client!ud", name = "b", descriptor = "(IB)V", line = 120)
    ...
    @OriginalMember(owner = "client!ud", name = "b", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IIIIII)I", line = 160)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(B)V", line = 218)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(III)Z", line = 238)
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Lkr;IZLpu;Lpu;)V", line = 263)
