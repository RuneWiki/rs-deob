...
public class class33 extends class389 implements class366 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(I[BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(III)V", line = 8)
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(Lhd;I[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "()I", line = 17)
