...
public class class33 extends class646 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Lek;IB)V", line = 7)
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "()V", line = 53)
    public class33() {
        super(1, false);
    }

    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ILufa;)V", line = 56)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(Z)V", line = 177)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(II)[[I", line = 191)
