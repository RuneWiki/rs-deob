...
public class class33 extends class393 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(IIIB)V", line = 5)
    ...
    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(II)V", line = 58)
