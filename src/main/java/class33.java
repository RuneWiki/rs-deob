...
public class class33 extends class136 {
    ...
    @OriginalMember(owner = "client!bt", name = "c", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(II)[I", line = 17)
    ...
    @OriginalMember(owner = "client!bt", name = "f", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!bt", name = "<init>", descriptor = "()V", line = 348)
    public class33() {
        super(1, true);
    }

    @OriginalMember(owner = "client!bt", name = "g", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!bt", name = "h", descriptor = "(I)V", line = 250)
    ...
    @OriginalMember(owner = "client!bt", name = "b", descriptor = "(II)[I", line = 270)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IILiv;)V", line = 288)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Z)V", line = 315)
