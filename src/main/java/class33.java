...
public class class33 extends class210 implements class425 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(ZLza;II)Z")
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Lza;Z)V")
    ...
    @OriginalMember(owner = "client!bt", name = "b", descriptor = "(Lza;I)Lnd;")
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(ILza;I)Le;")
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!bt", name = "<init>", descriptor = "(IIIIILne;)V")
