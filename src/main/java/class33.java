...
public class class33 extends class154 {
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(III)V", line = 19)
    ...
    @OriginalMember(owner = "client!mca", name = "<init>", descriptor = "()V", line = 33)
    public class33() {
    }

    @OriginalMember(owner = "client!mca", name = "<init>", descriptor = "(S)V", line = 39)
    public class33(short arg0) {
        this.field560 = arg0;
    }

    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Z)V", line = 49)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(ZLwda;)V", line = 63)
