...
public class class33 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IILoj;IIILza;IILe;IIIII)Le;", line = 4)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(BLjk;)Z", line = 216)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IB)[B", line = 237)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(I)V", line = 292)
