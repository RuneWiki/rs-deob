...
public class class33 implements class300 {
    ...
    @OriginalMember(owner = "client!tfa", name = "b", descriptor = "(I)Ldn;", line = 6)
    ...
    @OriginalMember(owner = "client!tfa", name = "c", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(I)I", line = 67)
    ...
    @OriginalMember(owner = "client!tfa", name = "<init>", descriptor = "(Lfp;Ljava/lang/String;)V", line = 80)
    public class33(class323 arg0, String arg1) {
        this.field432 = arg1;
        this.field433 = arg0;
    }

    @OriginalMember(owner = "client!tfa", name = "d", descriptor = "(I)V", line = 89)
