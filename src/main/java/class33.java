...
public class class33 extends class351 {
    ...
    @OriginalMember(owner = "client!he", name = "<init>", descriptor = "()V", line = 3)
    public class33() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!he", name = "b", descriptor = "(III)[B", line = 6)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IB)V", line = 13)
