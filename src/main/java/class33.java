...
public class class33 {
    ...
    @OriginalMember(owner = "client!LAPJVQGB", name = "c", descriptor = "LKTAHMSMP;")
    public class31 field957 = new class31();

    @OriginalMember(owner = "client!LAPJVQGB", name = "d", descriptor = "LKTAHMSMP;")
    ...
    @OriginalMember(owner = "client!LAPJVQGB", name = "a", descriptor = "(LKTAHMSMP;)V")
    ...
    @OriginalMember(owner = "client!LAPJVQGB", name = "a", descriptor = "()LKTAHMSMP;")
    ...
    @OriginalMember(owner = "client!LAPJVQGB", name = "b", descriptor = "()LKTAHMSMP;")
    ...
    @OriginalMember(owner = "client!LAPJVQGB", name = "a", descriptor = "(Z)LKTAHMSMP;")
