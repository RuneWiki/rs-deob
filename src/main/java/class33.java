...
public class class33 {
    ...
    @OriginalMember(owner = "client!IHAIACWA", name = "c", descriptor = "LIHAIACWA;")
    public class33 field1007;

    @OriginalMember(owner = "client!IHAIACWA", name = "d", descriptor = "LIHAIACWA;")
    public class33 field1008;

    @OriginalMember(owner = "client!IHAIACWA", name = "e", descriptor = "Z")
