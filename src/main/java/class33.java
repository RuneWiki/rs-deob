...
@OriginalClass("client!KVLMMBSC")
public class class33 implements Runnable {

    @OriginalMember(owner = "client!KVLMMBSC", name = "a", descriptor = "Z")
    private boolean field1118 = false;

    @OriginalMember(owner = "client!KVLMMBSC", name = "f", descriptor = "Z")
    private boolean field1123 = false;

    @OriginalMember(owner = "client!KVLMMBSC", name = "k", descriptor = "Z")
    private boolean field1128 = false;

    @OriginalMember(owner = "client!KVLMMBSC", name = "l", descriptor = "Z")
    private boolean field1129 = false;

    @OriginalMember(owner = "client!KVLMMBSC", name = "g", descriptor = "LOGVKVTJB;")
    public class38 field1124;

    @OriginalMember(owner = "client!KVLMMBSC", name = "b", descriptor = "I")
    private int field1119;

    @OriginalMember(owner = "client!KVLMMBSC", name = "e", descriptor = "Ljava/net/Socket;")
    private Socket field1122;

    @OriginalMember(owner = "client!KVLMMBSC", name = "c", descriptor = "Ljava/io/InputStream;")
    private InputStream field1120;

    @OriginalMember(owner = "client!KVLMMBSC", name = "d", descriptor = "Ljava/io/OutputStream;")
    private OutputStream field1121;

    @OriginalMember(owner = "client!KVLMMBSC", name = "i", descriptor = "I")
    private int field1126;

    @OriginalMember(owner = "client!KVLMMBSC", name = "j", descriptor = "I")
    private int field1127;

    @OriginalMember(owner = "client!KVLMMBSC", name = "h", descriptor = "[B")
    private byte[] field1125;

    @OriginalMember(owner = "client!KVLMMBSC", name = "<init>", descriptor = "(Ljava/net/Socket;ZLOGVKVTJB;)V")
    ...
    @OriginalMember(owner = "client!KVLMMBSC", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!KVLMMBSC", name = "c", descriptor = "()I")
    public int method400() throws IOException {
        return this.field1123 ? 0 : this.field1120.available();
    }

    @OriginalMember(owner = "client!KVLMMBSC", name = "a", descriptor = "([BII)V")
    ...
    @OriginalMember(owner = "client!KVLMMBSC", name = "a", descriptor = "(II[BI)V")
    ...
    @OriginalMember(owner = "client!KVLMMBSC", name = "run", descriptor = "()V")
    public void run() {
    ...
    @OriginalMember(owner = "client!KVLMMBSC", name = "a", descriptor = "(I)V")
