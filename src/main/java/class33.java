...
public class class33 {
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(II)Llk;")
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(Lha;IZI)Ljv;")
    ...
    @OriginalMember(owner = "client!tfa", name = "<init>", descriptor = "(Lpo;ILgda;)V")
