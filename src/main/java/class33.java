...
public class class33 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Ljava/lang/String;ILbt;)I", line = 4)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "([[BBLbu;)V", line = 48)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Z)V", line = 141)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ILbt;B)Ljava/lang/String;", line = 177)
