...
public class class33 {
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(IIIZ)I", line = 7)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(ILkk;)V", line = 41)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(IIILdc;)J", line = 274)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(B)V", line = 317)
