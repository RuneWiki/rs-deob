...
public class class33 extends class159 {
    ...
    @OriginalMember(owner = "client!wq", name = "c", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(BI)Lrj;", line = 38)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(III)I", line = 83)
    ...
    @OriginalMember(owner = "client!wq", name = "d", descriptor = "(I)V", line = 109)
