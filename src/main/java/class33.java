...
public class class33 extends class488 {
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(BIII)Lhn;", line = 13)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(ZILtv;)Lgaa;", line = 86)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(IIB)Z", line = 118)
