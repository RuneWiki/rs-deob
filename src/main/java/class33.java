...
public class class33 implements Runnable {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(II)Lvd;", line = 3)
    ...
    @OriginalMember(owner = "client!mca", name = "c", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(BZLjava/lang/String;)Lvd;", line = 25)
    ...
    @OriginalMember(owner = "client!mca", name = "b", descriptor = "(B)Lvd;", line = 40)
    public final class42 method214(byte arg0) {
        return arg0 == -87 ? this.method226((byte) 98, 0, 0, null, 5) : null;
    }

    @OriginalMember(owner = "client!mca", name = "b", descriptor = "(I)Ljava/lang/Object;", line = 50)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(I)Z", line = 61)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;[Ljava/lang/Class;Z)Lvd;", line = 81)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;B)Lvd;", line = 93)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Ljava/lang/String;I)Lvd;", line = 109)
    public final class42 method219(String arg0, int arg1) {
        return arg1 == 6092 ? this.method226((byte) -9, 0, 0, arg0, 16) : null;
    }

    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Ljava/io/File;[BI)Z", line = 122)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(BLjava/net/URL;)Lvd;", line = 142)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(IBLjava/lang/String;Z)Lvd;", line = 163)
    ...
    @OriginalMember(owner = "client!mca", name = "<init>", descriptor = "(ILjava/lang/String;IZ)V", line = 701)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Ljava/lang/String;B)Lqb;", line = 183)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(B)V", line = 193)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Ljava/lang/String;IILjava/lang/String;)Lqb;", line = 257)
    ...
    @OriginalMember(owner = "client!mca", name = "run", descriptor = "()V", line = 299)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(BIILjava/lang/Object;I)Lvd;", line = 609)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(ZLjava/lang/Runnable;I)Lvd;", line = 643)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(I[IIZLjava/awt/Component;Ljava/awt/Point;)Lvd;", line = 653)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Ljava/awt/Frame;B)Lvd;", line = 665)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(IIIZI)Lvd;", line = 692)
