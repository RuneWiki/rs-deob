...
public class class33 extends class164 {
    ...
    @OriginalMember(owner = "client!ud", name = "e", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IBI)I", line = 14)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IIB)Z", line = 34)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(BLun;)V", line = 46)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IILjava/lang/String;)Ljava/lang/String;", line = 71)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IILun;)V", line = 102)
