...
public class class33 extends class211 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IJILqq;Z)V")
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ILqq;Lwn;IIZI)V")
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(Lqq;Loo;Ldd;J)V")
