...
public class class33 extends class615 {
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "(Lqj;IIZ[[I)V", line = 17)
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "(Lqj;II)V", line = 48)
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "(Lqj;IIZ[[BI)V", line = 66)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Lr;ILvb;Lww;)V", line = 99)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(BIIII)V", line = 250)
