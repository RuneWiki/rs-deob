...
public class class33 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(BIZIZILqa;)Lka;")
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ZLqa;)V")
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IIILqa;ZLka;II)V")
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ILco;)Z")
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(Lqa;Lcd;IIIIIIZI)V")
