...
public class class33 extends class17 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Lwm;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!bt", name = "<init>", descriptor = "()V", line = 41)
    public class33() {
        super(1, false);
    }

    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IB)[[I", line = 44)
    ...
    @OriginalMember(owner = "client!bt", name = "h", descriptor = "(I)V", line = 126)
    public static void method195(int arg0) {
        field381 = null;
        int var1 = -38 / ((8 - arg0) / 33);
    }

    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IZIZ)I", line = 142)
