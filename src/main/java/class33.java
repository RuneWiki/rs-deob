...
public class class33 {
    ...
    private int[] field1084 = new int[256];

    @OriginalMember(owner = "client!MRWOUQJV", name = "c", descriptor = "[I")
    private int[] field1083 = new int[256];
    ...
    public final int method335() {
        ...
        return this.field1083[this.field1082];
    }
    ...
    private final void method336() {
        ...
        for (int var1 = 0; var1 < 256; var1++) {
            int var2 = this.field1084[var1];
            if ((var1 & 0x3) == 0) {
                this.field1085 ^= this.field1085 << 13;
            } else if ((var1 & 0x3) == 1) {
                this.field1085 ^= this.field1085 >>> 6;
            } else if ((var1 & 0x3) == 2) {
                this.field1085 ^= this.field1085 << 2;
            } else if ((var1 & 0x3) == 3) {
                this.field1085 ^= this.field1085 >>> 16;
            }
            this.field1085 += this.field1084[var1 + 128 & 0xFF];
            int var3;
            this.field1084[var1] = var3 = this.field1084[var2 >> 2 & 0xFF] + this.field1085 + this.field1086;
            this.field1083[var1] = this.field1086 = this.field1084[var3 >> 8 >> 2 & 0xFF] + var2;
        }
    }
    ...
    private final void method337() {
        ...
        for (int var10 = 0; var10 < 256; var10 += 8) {
            int var36 = this.field1083[var10] + var8;
            int var37 = this.field1083[var10 + 1] + var7;
            int var38 = this.field1083[var10 + 2] + var6;
            int var39 = this.field1083[var10 + 3] + var5;
            int var40 = this.field1083[var10 + 4] + var4;
            int var41 = this.field1083[var10 + 5] + var3;
            int var42 = this.field1083[var10 + 6] + var2;
            int var43 = this.field1083[var10 + 7] + var1;
            ...
            var6 = var1 + var50;
            var8 = var7 + var57;
            this.field1084[var10] = var8;
            this.field1084[var10 + 1] = var7;
            this.field1084[var10 + 2] = var6;
            this.field1084[var10 + 3] = var5;
            this.field1084[var10 + 4] = var4;
            this.field1084[var10 + 5] = var3;
            this.field1084[var10 + 6] = var2;
            this.field1084[var10 + 7] = var1;
        }
        for (int var11 = 0; var11 < 256; var11 += 8) {
            int var12 = this.field1084[var11] + var8;
            int var13 = this.field1084[var11 + 1] + var7;
            int var14 = this.field1084[var11 + 2] + var6;
            int var15 = this.field1084[var11 + 3] + var5;
            int var16 = this.field1084[var11 + 4] + var4;
            int var17 = this.field1084[var11 + 5] + var3;
            int var18 = this.field1084[var11 + 6] + var2;
            int var19 = this.field1084[var11 + 7] + var1;
            ...
            var6 = var1 + var26;
            var8 = var7 + var33;
            this.field1084[var11] = var8;
            this.field1084[var11 + 1] = var7;
            this.field1084[var11 + 2] = var6;
            this.field1084[var11 + 3] = var5;
            this.field1084[var11 + 4] = var4;
            this.field1084[var11 + 5] = var3;
            this.field1084[var11 + 6] = var2;
            this.field1084[var11 + 7] = var1;
        }
        this.method336();
        this.field1082 = 256;
    }
