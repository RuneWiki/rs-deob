...
public class class33 {
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(II)[B", line = 5)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(ZI)Lmca;", line = 54)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(ILes;)Lvn;", line = 77)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(IJ)V", line = 111)
    ...
    @OriginalMember(owner = "client!mca", name = "<init>", descriptor = "(IIII)V", line = 176)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(B)V", line = 191)
