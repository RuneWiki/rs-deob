...
public class class33 {
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(IZIII)V", line = 13)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(II)Z", line = 34)
    ...
    @OriginalMember(owner = "client!wf", name = "b", descriptor = "(II)V", line = 51)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(I)[Lrp;", line = 74)
    ...
    @OriginalMember(owner = "client!wf", name = "c", descriptor = "(II)Lkj;", line = 92)
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "(Lpt;ILum;)V", line = 129)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(B)V", line = 158)
    ...
    @OriginalMember(owner = "client!wf", name = "b", descriptor = "(I)V", line = 171)
