...
public class class33 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IILul;I)Llm;", line = 20)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Lsp;JI)V", line = 43)
    ...
    @OriginalMember(owner = "client!bt", name = "<init>", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(ZJ)Lsp;", line = 93)
