...
public class class33 {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ZIIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IIB)V", line = 31)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(I)V", line = 50)
