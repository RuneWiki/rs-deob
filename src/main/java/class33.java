...
public class class33 extends class378 {
    ...
    @OriginalMember(owner = "client!bt", name = "d", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!bt", name = "c", descriptor = "(B)I", line = 19)
    ...
    @OriginalMember(owner = "client!bt", name = "e", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IIIII)V", line = 49)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Ljava/lang/String;I)J", line = 65)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(I)J", line = 107)
    ...
    @OriginalMember(owner = "client!bt", name = "c", descriptor = "(Z)V", line = 118)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(III)V", line = 135)
    ...
    @OriginalMember(owner = "client!bt", name = "b", descriptor = "(B)I", line = 149)
