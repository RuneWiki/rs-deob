...
public class class33 extends class443 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IIIIIIZILao;II)Z", line = 5)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Lir;ILwh;)Z", line = 379)
    ...
    @OriginalMember(owner = "client!js", name = "d", descriptor = "(I)V", line = 436)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ZILir;ILwh;I)[F", line = 458)
    ...
    @OriginalMember(owner = "client!js", name = "e", descriptor = "(I)V", line = 566)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IDZLwh;BLir;I)[I", line = 583)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ZLwh;DZIILir;I)[I", line = 723)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ICLjava/lang/String;)[Ljava/lang/String;", line = 861)
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "()V", line = 896)
    public class33() {
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(Lfb;)V", line = 915)
