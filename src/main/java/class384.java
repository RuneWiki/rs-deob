...
public class class384 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(BLpe;Z)Lkb;", line = 4)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Lfo;ZZ)Z", line = 36)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(ZLap;I)V", line = 166)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(ILpe;)Lkb;", line = 301)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(I)Z", line = 352)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Lap;I)Ljava/lang/String;", line = 398)
    ...
    @OriginalMember(owner = "client!oo", name = "b", descriptor = "(I)V", line = 414)
    public static void method2384(int arg0) {
        int var1 = -108 % ((arg0 - 55) / 51);
        field5389 = null;
    }

    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(III)I", line = 456)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Z)V", line = 500)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(BLap;)V", line = 542)
