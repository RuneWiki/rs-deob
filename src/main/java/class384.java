...
public class class384 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "()[B", line = 8)
    ...
    @OriginalMember(owner = "client!kl", name = "b", descriptor = "()I", line = 69)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Ldn;II)Lkl;", line = 114)
    ...
    @OriginalMember(owner = "client!kl", name = "c", descriptor = "()Leb;", line = 122)
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "(Lbt;)V", line = 129)
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "()V", line = 149)
    private class384() {
    }
}
