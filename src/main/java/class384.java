...
public class class384 extends class323 {
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(Llb;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Llb;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Lj;II)V")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IILlb;)Llb;")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Lbn;[I)V")
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Lmm;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!eb", name = "c", descriptor = "(Llb;IIIIZ)V")
