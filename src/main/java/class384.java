...
public class class384 extends class227 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IIIZILur;[BI)Lal;", line = 13)
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "()V", line = 255)
    public class384() {
        super(1, false);
    }

    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lug;II)V", line = 38)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lqr;B)Z", line = 106)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(B)V", line = 139)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IZ)[[I", line = 158)
