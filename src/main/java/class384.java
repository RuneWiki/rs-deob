...
public class class384 extends class153 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(ILqa;Lc;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lqa;I)Lpj;", line = 28)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(I)I", line = 58)
    ...
    @OriginalMember(owner = "client!ei", name = "d", descriptor = "(B)I", line = 177)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(IB)V", line = 191)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IILqa;I)Lc;", line = 223)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Z)V", line = 238)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lqv;BLqa;IZII)V", line = 253)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(I)V", line = 265)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 281)
    ...
    @OriginalMember(owner = "client!ei", name = "finalize", descriptor = "()V", line = 309)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IIILqa;)Z", line = 320)
    ...
    @OriginalMember(owner = "client!ei", name = "e", descriptor = "(I)V", line = 332)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(BLqa;)V", line = 347)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(B[Lfk;Lbv;)Lrs;", line = 375)
    ...
    @OriginalMember(owner = "client!ei", name = "d", descriptor = "(I)Z", line = 465)
    ...
    @OriginalMember(owner = "client!ei", name = "c", descriptor = "(IB)V", line = 479)
