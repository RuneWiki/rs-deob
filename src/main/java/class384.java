...
public class class384 extends class346 {
    ...
    @OriginalMember(owner = "client!fp", name = "b", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(IB)Lri;", line = 20)
    ...
    @OriginalMember(owner = "client!fp", name = "b", descriptor = "(II)[I", line = 56)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Lfb;ZI)V", line = 91)
    ...
    @OriginalMember(owner = "client!fp", name = "d", descriptor = "(B)V", line = 137)
    ...
    @OriginalMember(owner = "client!fp", name = "d", descriptor = "(Z)V", line = 296)
    ...
    @OriginalMember(owner = "client!fp", name = "c", descriptor = "(II)[[I", line = 309)
