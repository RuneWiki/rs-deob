...
public class class384 {
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IILha;IIIIIBI)V")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ILha;I)Z")
    ...
    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(I[Lqq;IIII)V")
