...
public class class384 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Ljava/lang/String;IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(IZ)V", line = 107)
    public class384(int arg0, boolean arg1) {
        this.field5764 = arg1;
        this.field5761 = arg0;
    }

    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(II)V", line = 36)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 52)
    ...
    @OriginalMember(owner = "client!kp", name = "toString", descriptor = "()Ljava/lang/String;", line = 72)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(I)[Ljava/lang/String;", line = 97)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IIIII)V", line = 119)
    ...
    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(II)I", line = 198)
