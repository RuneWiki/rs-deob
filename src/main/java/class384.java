...
public class class384 {
    ...
    public int[] field5278 = new int[6];
    ...
    public byte[] field5282 = new byte[4096];

    @OriginalMember(owner = "client!ot", name = "l", descriptor = "[B")
    public byte[] field5289 = new byte[256];

    @OriginalMember(owner = "client!ot", name = "o", descriptor = "[B")
    public byte[] field5292 = new byte[18002];

    @OriginalMember(owner = "client!ot", name = "t", descriptor = "[B")
    public byte[] field5297 = new byte[18002];

    @OriginalMember(owner = "client!ot", name = "u", descriptor = "[I")
    public int[] field5298 = new int[257];

    @OriginalMember(owner = "client!ot", name = "s", descriptor = "[[I")
    public int[][] field5296 = new int[6][258];

    @OriginalMember(owner = "client!ot", name = "f", descriptor = "[Z")
    public boolean[] field5283 = new boolean[16];

    @OriginalMember(owner = "client!ot", name = "n", descriptor = "[Z")
    public boolean[] field5291 = new boolean[256];

    @OriginalMember(owner = "client!ot", name = "j", descriptor = "I")
    public int field5287 = 0;

    @OriginalMember(owner = "client!ot", name = "A", descriptor = "[I")
    public int[] field5304 = new int[16];

    @OriginalMember(owner = "client!ot", name = "k", descriptor = "[[I")
    public int[][] field5288 = new int[6][258];

    @OriginalMember(owner = "client!ot", name = "D", descriptor = "[[B")
    public byte[][] field5307 = new byte[6][258];

    @OriginalMember(owner = "client!ot", name = "E", descriptor = "[[I")
    public int[][] field5308 = new int[6][258];

    @OriginalMember(owner = "client!ot", name = "C", descriptor = "[I")
    public int[] field5306 = new int[256];

    @OriginalMember(owner = "client!ot", name = "F", descriptor = "Ljm;")
    public static class448 field5309 = new class448(128);

    @OriginalMember(owner = "client!ot", name = "H", descriptor = "Lgd;")
    public static class206 field5311 = new class206("Please remove ", "Bitte entferne ", "Veuillez commencer par supprimer ", "Remova ");

    @OriginalMember(owner = "client!ot", name = "I", descriptor = "Lh;")
    public static class434 field5312 = new class434(47, 6);
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(I)V", line = 39)
