...
public class class384 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(B)Lfe;")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Lfh;I)V")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IBLfh;)V")
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(B)Lfe;")
