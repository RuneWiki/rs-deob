...
public class class384 implements class252 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(II)I", line = 36)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(BII)V", line = 79)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IZI)V", line = 110)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(BI)I", line = 137)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ZB)I", line = 148)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(III)I", line = 188)
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(III)V", line = 214)
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(BII)V", line = 252)
