...
public abstract class class384 {
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!kfa", name = "b", descriptor = "(I)[Lmha;", line = 15)
    ...
    @OriginalMember(owner = "client!kfa", name = "c", descriptor = "(I)Z", line = 27)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(B)Z", line = 39)
    ...
    @OriginalMember(owner = "client!kfa", name = "d", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "([B[BIIIBIII)V", line = 65)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(Z)Z", line = 113)
