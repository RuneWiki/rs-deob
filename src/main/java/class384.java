...
public class class384 extends class398 {
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Lnj;II)V", line = 7)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Lps;IIILcq;Lud;II)V", line = 20)
    ...
    @OriginalMember(owner = "client!uo", name = "d", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "()V", line = 244)
    public class384() {
        super(0, false);
    }

    @OriginalMember(owner = "client!uo", name = "c", descriptor = "(Z)Z", line = 85)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(ILjava/lang/String;)J", line = 110)
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(B)I", line = 143)
    ...
    @OriginalMember(owner = "client!uo", name = "c", descriptor = "(B)V", line = 160)
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(II)[[I", line = 174)
