...
public class class384 {
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(Z)Lki;", line = 16)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ILwo;)V", line = 40)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(I)Lki;", line = 56)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ZI)S", line = 79)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(BLss;II)V", line = 112)
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "()V", line = 134)
    public class384() {
    }

    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(Lwo;)V", line = 139)
    public class384(class522 arg0) {
        this.field5400 = arg0;
    }

    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ILem;)I", line = 160)
