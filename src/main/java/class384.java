...
public class class384 extends class41 {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(ILmga;)I")
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(Loga;I)V")
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(ILes;)V")
