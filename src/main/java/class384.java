...
public class class384 {
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(I)Lsf;")
    ...
    @OriginalMember(owner = "client!pda", name = "b", descriptor = "(I)Lsf;")
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(Lrq;I)V")
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(ILoa;)V")
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(IBIIZ)Ll;")
    ...
    @OriginalMember(owner = "client!pda", name = "<init>", descriptor = "(Lnj;)V")
