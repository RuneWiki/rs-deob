...
public class class384 extends class260 {
    ...
    @OriginalMember(owner = "client!uia", name = "b", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!uia", name = "<init>", descriptor = "(Lfca;)V", line = 17)
    public class384(class92 arg0) {
        super(arg0);
        class284.method1822(super.field3868, (byte) -69);
    }

    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(B)I", line = 26)
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(III)Z", line = 59)
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(IB)I", line = 72)
    ...
    @OriginalMember(owner = "client!uia", name = "<init>", descriptor = "(ILfca;)V", line = 85)
    public class384(int arg0, class92 arg1) {
        super(arg0, arg1);
        class284.method1822(super.field3868, (byte) -108);
    }

    @OriginalMember(owner = "client!uia", name = "b", descriptor = "(IB)V", line = 93)
    ...
    @OriginalMember(owner = "client!uia", name = "b", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!uia", name = "c", descriptor = "(I)I", line = 121)
