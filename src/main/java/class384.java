...
public class class384 {
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(BI)Lffa;")
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(IILjava/lang/String;)Lwfa;")
    ...
    @OriginalMember(owner = "client!kfa", name = "<init>", descriptor = "(Lcr;ILla;)V")
