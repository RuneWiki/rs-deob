...
public class class384 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IZIJI)Ljava/lang/String;", line = 26)
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(I)V", line = 102)
    public class384(int arg0) {
        this.field5570 = (byte) arg0;
    }

    @OriginalMember(owner = "client!es", name = "a", descriptor = "(I)V", line = 124)
