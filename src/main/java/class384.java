...
public class class384 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Lr;III[Z)Z")
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(BI)Lbea;")
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(B)Ltga;")
    ...
    @OriginalMember(owner = "client!ll", name = "c", descriptor = "(I)[Ljb;")
    ...
    @OriginalMember(owner = "client!ll", name = "b", descriptor = "(II)Lmu;")
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "(Lkw;ILuq;Luq;Luq;)V")
