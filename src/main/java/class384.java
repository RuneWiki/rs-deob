...
public class class384 extends class392 {
    ...
    @OriginalMember(owner = "client!mba", name = "B", descriptor = "(III[I)V", line = 6)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Lrc;B)I", line = 25)
    ...
    @OriginalMember(owner = "client!mba", name = "na", descriptor = "(IIIIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!mba", name = "w", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!mba", name = "YA", descriptor = "([I)V", line = 174)
    ...
    @OriginalMember(owner = "client!mba", name = "o", descriptor = "(I)V", line = 190)
    ...
    @OriginalMember(owner = "client!mba", name = "wa", descriptor = "(III[I)V", line = 203)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(I[Ljava/lang/String;[S)V", line = 213)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "()Lq;", line = 222)
    ...
    @OriginalMember(owner = "client!mba", name = "U", descriptor = "(III)V", line = 244)
    ...
    @OriginalMember(owner = "client!mba", name = "M", descriptor = "(Lq;)V", line = 262)
    ...
    @OriginalMember(owner = "client!mba", name = "Y", descriptor = "()V", line = 298)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(B)V", line = 311)
    ...
    @OriginalMember(owner = "client!mba", name = "NA", descriptor = "(III)V", line = 321)
    ...
    @OriginalMember(owner = "client!mba", name = "ZA", descriptor = "(I)V", line = 334)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(III[I)V", line = 361)
    ...
    @OriginalMember(owner = "client!mba", name = "J", descriptor = "(I)V", line = 374)
    ...
    @OriginalMember(owner = "client!mba", name = "<init>", descriptor = "()V", line = 387)
    public class384() {
        this.method679();
    }

    @OriginalMember(owner = "client!mba", name = "oa", descriptor = "(I)V", line = 395)
    ...
    @OriginalMember(owner = "client!mba", name = "AA", descriptor = "(I)V", line = 411)
