...
public class class384 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(ZI)Lsha;", line = 5)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(I)Llm;", line = 33)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "()V", line = 65)
    public class384() {
    }

    @OriginalMember(owner = "client!jq", name = "b", descriptor = "(I)Llm;", line = 68)
    ...
    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "(Lwd;)V", line = 89)
