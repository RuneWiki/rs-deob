...
public class class384 extends class675 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Lco;BI)V")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Lfia;IZ)V")
    ...
    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "(Lkv;)V")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(I[Lqda;)V")
