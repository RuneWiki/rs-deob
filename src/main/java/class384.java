...
public class class384 {
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;IILjava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(Z)V", line = 71)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ILuo;I)Z", line = 95)
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(I[Ldb;IIII)V", line = 179)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IIIIIIIILuo;I)V", line = 202)
