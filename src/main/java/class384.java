...
public class class384 extends class228 {
    ...
    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "(Lte;IIZ[[BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!ci", name = "e", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!ci", name = "e", descriptor = "(B)V", line = 869)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(I)V", line = 883)
    ...
    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "(Lte;II)V", line = 898)
    ...
    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "(Lte;IIZ[[I)V", line = 954)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IIIBI)V", line = 933)
