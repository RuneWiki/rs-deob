...
public abstract class class384 implements class278 {
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(ZILjaggl/MapBuffer;)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(BLjaclib/memory/Source;I)Z")
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(ILjaggl/MapBuffer;)Z")
    ...
    @OriginalMember(owner = "client!kfa", name = "<init>", descriptor = "(Lmba;IZ)V")
