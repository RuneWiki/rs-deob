...
public class class384 extends class666 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(ILiaa;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!un", name = "h", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(II)[I", line = 29)
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "()V", line = 82)
    public class384() {
        super(3, false);
    }

    @OriginalMember(owner = "client!un", name = "b", descriptor = "(II)I", line = 88)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(IB)[[I", line = 100)
