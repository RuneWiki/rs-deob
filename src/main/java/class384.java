...
public class class384 extends OutputStream {
    ...
    @OriginalMember(owner = "client!of", name = "write", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(ZILrt;I)J")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IIILlga;)Lifa;")
