...
public class class384 extends class47 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IBLkk;)V", line = 10)
    ...
    @OriginalMember(owner = "client!ed", name = "d", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IBI)I", line = 100)
    ...
    @OriginalMember(owner = "client!ed", name = "d", descriptor = "(I)I", line = 120)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Lkk;I)V", line = 136)
    ...
    @OriginalMember(owner = "client!ed", name = "e", descriptor = "(B)Ljava/lang/String;", line = 156)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(B[ILkk;)V", line = 183)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(ILkk;)Ljava/lang/String;", line = 216)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(II)I", line = 252)
    ...
    @OriginalMember(owner = "client!ed", name = "f", descriptor = "(B)V", line = 282)
