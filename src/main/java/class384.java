...
public class class384 extends class431 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "([BIIIII)Z", line = 18)
    ...
    @OriginalMember(owner = "client!nd", name = "b", descriptor = "(B)I", line = 101)
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "(II)V", line = 124)
    public class384(int arg0, int arg1) {
        this.field5777 = arg1;
        this.field5776 = arg0;
    }

    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IIIIBI)V", line = 133)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IIII)V", line = 235)
