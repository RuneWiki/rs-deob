...
public class class384 extends class83 {
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "()V", line = 5)
    public class384() {
        super(0, true);
    }

    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IB)V", line = 10)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(II)[I", line = 24)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(BLfd;)V", line = 59)
    ...
    @OriginalMember(owner = "client!uo", name = "d", descriptor = "(III)I", line = 97)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(BIII)I", line = 111)
