...
public class class384 {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(ILnda;Lwq;)Ljo;")
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IB)Lfaa;")
    ...
    @OriginalMember(owner = "client!uv", name = "<init>", descriptor = "(Lpo;IZLgda;Lgda;)V")
