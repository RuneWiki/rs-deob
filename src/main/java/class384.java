...
public class class384 extends class372 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(FLih;ILih;)V")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(B)Lih;")
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(Lhj;I)V")
