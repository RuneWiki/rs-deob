...
public class class384 extends class456 {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(ILjava/lang/String;)[B", line = 32)
    ...
    @OriginalMember(owner = "client!wi", name = "h", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Z)V", line = 182)
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "()V", line = 246)
    public class384() {
        super(0, true);
    }

    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IBLre;)V", line = 198)
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(II)[I", line = 253)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IIZ)V", line = 328)
