...
public class class384 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 37)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IILta;Lrr;ILub;Ljava/lang/String;IIILfa;B)V", line = 58)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(III)I", line = 109)
