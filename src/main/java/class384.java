...
public class class384 {
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(IIIIIII)I", line = 8)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(BLdc;)V", line = 40)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Ldc;ILww;)Lsa;", line = 64)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Z)V", line = 113)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(B)Z", line = 131)
