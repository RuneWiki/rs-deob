...
public class class384 extends class263 {
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!hj", name = "<init>", descriptor = "(Lbl;Lmt;)V", line = 37)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(I)Z", line = 76)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(III)V", line = 102)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(ZB)V", line = 158)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(Lce;IZ)V", line = 182)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IZ)V", line = 194)
