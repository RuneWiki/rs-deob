...
public class class384 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lps;I)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(I)Lge;", line = 16)
    ...
    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ZI)V", line = 54)
    ...
    @OriginalMember(owner = "client!mc", name = "c", descriptor = "(I)I", line = 115)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ILge;)V", line = 136)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Z)Lge;", line = 157)
    ...
    @OriginalMember(owner = "client!mc", name = "d", descriptor = "(I)Lge;", line = 183)
    ...
    @OriginalMember(owner = "client!mc", name = "<init>", descriptor = "()V", line = 209)
    public class384() {
        this.field5624.field8203 = this.field5624;
        this.field5624.field8211 = this.field5624;
    }

    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(B)V", line = 220)
