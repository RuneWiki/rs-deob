...
public class class384 extends class478 {
    ...
    @OriginalMember(owner = "client!uf", name = "c", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!uf", name = "c", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IIIZIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "()V", line = 49)
    public class384() {
        super(1, false);
    }

    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(II)[I", line = 60)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ILnp;I)V", line = 147)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ZI)[[I", line = 196)
    ...
    @OriginalMember(owner = "client!uf", name = "f", descriptor = "(I)V", line = 329)
