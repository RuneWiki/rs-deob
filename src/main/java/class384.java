...
public class class384 extends class190 {
    ...
    @OriginalMember(owner = "client!mc", name = "c", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ZI)V", line = 21)
    ...
    @OriginalMember(owner = "client!mc", name = "<init>", descriptor = "(Ljj;Llm;)V", line = 32)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(I)Z", line = 75)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ILaba;I)V", line = 85)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ZB)V", line = 102)
    ...
    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(III)Z", line = 131)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(III)V", line = 152)
    ...
    @OriginalMember(owner = "client!mc", name = "d", descriptor = "(I)V", line = 185)
