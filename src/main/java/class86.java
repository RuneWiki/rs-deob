...
public class class86 {
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(II)Lko;", line = 60)
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(II)V", line = 89)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(ILbw;)V", line = 104)
    ...
    @OriginalMember(owner = "client!kc", name = "c", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lbl;I)V", line = 143)
    ...
    @OriginalMember(owner = "client!kc", name = "d", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 275)
    public void method671(Component arg0) throws Exception {
        field1500++;
    }

    @OriginalMember(owner = "client!kc", name = "a", descriptor = "()V", line = 288)
    public void method672() {
        field1485++;
    }

    @OriginalMember(owner = "client!kc", name = "a", descriptor = "([II)V", line = 300)
    ...
    @OriginalMember(owner = "client!kc", name = "e", descriptor = "(I)V", line = 460)
    public void method674(int arg0) throws Exception {
        field1480++;
    }

    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(BI)Lqn;", line = 469)
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "()V", line = 790)
    public void method676() throws Exception {
        field1506++;
    }

    @OriginalMember(owner = "client!kc", name = "c", descriptor = "()I", line = 808)
    public int method677() throws Exception {
        field1492++;
        return this.field1509;
    }

    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Z)V", line = 822)
    ...
    @OriginalMember(owner = "client!kc", name = "f", descriptor = "(I)V", line = 841)
    ...
    @OriginalMember(owner = "client!kc", name = "d", descriptor = "()V", line = 856)
    public void method680() throws Exception {
        field1502++;
    }

    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(BLbl;I)V", line = 871)
