...
public class class86 extends class122 {
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(ZBIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!eda", name = "b", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(BLmo;)Lap;", line = 166)
