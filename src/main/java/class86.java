...
public class class86 extends InputStream {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Lha;ZIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(ZII)Lwj;", line = 41)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Ljava/io/File;[BII)V", line = 59)
    ...
    @OriginalMember(owner = "client!dk", name = "read", descriptor = "()I", line = 81)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 91)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IIFIIZIII)[[I", line = 143)
