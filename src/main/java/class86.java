...
public class class86 {
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(Lha;III)V")
    ...
    @OriginalMember(owner = "client!vga", name = "b", descriptor = "(II)Lbe;")
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(BI)Lla;")
    ...
    @OriginalMember(owner = "client!vga", name = "<init>", descriptor = "(Lms;ILwu;Lwu;Lwu;)V")
