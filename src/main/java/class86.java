...
public class class86 extends class766 implements class618 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(IBLha;)V", line = 3)
    ...
    @OriginalMember(owner = "client!kj", name = "c", descriptor = "(B)I", line = 110)
    ...
    @OriginalMember(owner = "client!kj", name = "b", descriptor = "(B)J", line = 121)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(B)C", line = 134)
    ...
    @OriginalMember(owner = "client!kj", name = "b", descriptor = "(I)I", line = 144)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(I)I", line = 160)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Z)V", line = 173)
