...
public class class86 {
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(BI)Lak;", line = 7)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(II)V", line = 43)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(IB)Lpf;", line = 79)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(ZII)Lmaa;", line = 112)
    ...
    @OriginalMember(owner = "client!jv", name = "b", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!jv", name = "<init>", descriptor = "(Ldt;ILwia;Lwia;Lwia;)V", line = 168)
