...
public class class86 extends class354 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(ILuo;)I")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IIIILir;ILir;III)V")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(BLtf;II)V")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(ILa;I)V")
