...
public abstract class class86 extends class529 {
    ...
    @OriginalMember(owner = "client!kc", name = "ja", descriptor = "()I", line = 9)
    public final int method151() {
        return this.field1315 + this.field1308 + this.field1320;
    }

    @OriginalMember(owner = "client!kc", name = "ka", descriptor = "(IIII)V", line = 13)
    ...
    @OriginalMember(owner = "client!kc", name = "JA", descriptor = "()I", line = 20)
    public final int method149() {
        return this.field1333 + this.field1327 + this.field1303;
    }

    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(FFFFFFLea;II)V", line = 34)
    ...
    @OriginalMember(owner = "client!kc", name = "qa", descriptor = "()I", line = 46)
    public final int method161() {
        return this.field1333;
    }

    @OriginalMember(owner = "client!kc", name = "UA", descriptor = "()I", line = 75)
    public final int method154() {
        return this.field1308;
    }

    @OriginalMember(owner = "client!kc", name = "aa", descriptor = "(FFFFFFIII)V", line = 80)
    ...
    @OriginalMember(owner = "client!kc", name = "D", descriptor = "(IIIIIII)V", line = 179)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(FFFFFF)V", line = 223)
    ...
    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "(Lhh;II)V", line = 364)
