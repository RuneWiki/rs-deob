...
public class class86 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "([II[III)V")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "([BI[BII)V")
    public static final void method644(byte[] arg0, int arg1, byte[] arg2, int arg3, int arg4) {
        if (arg0 == arg2) {
            if (arg1 == arg3) {
                return;
            }
    ...
    public static final void method645(int[] arg0, int arg1, int arg2, int arg3) {
