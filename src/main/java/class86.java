...
public class class86 extends class13 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(B)[B", line = 7)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(IIB)[B", line = 21)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(I[B)V", line = 37)
