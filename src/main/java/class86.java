...
public class class86 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lsv;IB)V", line = 38)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(BLsv;)V", line = 77)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 99)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(I)V", line = 170)
