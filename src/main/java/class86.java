...
public class class86 extends class729 {
    ...
    @OriginalMember(owner = "client!aka", name = "a", descriptor = "(IIII)[B", line = 3)
    ...
    @OriginalMember(owner = "client!aka", name = "<init>", descriptor = "()V", line = 21)
    public class86() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!aka", name = "a", descriptor = "(IBI)V", line = 26)
    ...
    @OriginalMember(owner = "client!aka", name = "a", descriptor = "(ZLkg;III)V", line = 41)
    ...
    @OriginalMember(owner = "client!aka", name = "b", descriptor = "(IBI)Z", line = 206)
    ...
    @OriginalMember(owner = "client!aka", name = "a", descriptor = "(Les;I)Lfd;", line = 218)
    ...
    @OriginalMember(owner = "client!aka", name = "d", descriptor = "(I)V", line = 251)
    ...
    @OriginalMember(owner = "client!aka", name = "b", descriptor = "(III)Z", line = 268)
    public static final boolean method797(int arg0, int arg1, int arg2) {
        field1142++;
        return arg0 < 7 ? true : (arg2 & 0x18) != 0 | (arg2 & 0x220) == 544;
    }

    @OriginalMember(owner = "client!aka", name = "a", descriptor = "(BLjava/lang/String;)V", line = 286)
