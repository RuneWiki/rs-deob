...
public class class86 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IB)V", line = 42)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Lnt;IILjava/awt/Component;I)Lvn;", line = 170)
