...
public class class86 extends class71 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(JZ)I", line = 3)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(I)J", line = 36)
    public final long method370(int arg0) {
        int var2 = 63 % ((39 - arg0) / 60);
        return this.field865;
    }

    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(I)J", line = 58)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "()V", line = 113)
    public class86() {
    ...
    @OriginalMember(owner = "client!ns", name = "c", descriptor = "(I)J", line = 81)
