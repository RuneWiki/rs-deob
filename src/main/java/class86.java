...
public class class86 extends class98 {
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(ILdg;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!g", name = "b", descriptor = "(II)[[I", line = 51)
    ...
    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "()V", line = 112)
    public class86() {
        super(1, false);
    }

    @OriginalMember(owner = "client!g", name = "c", descriptor = "(II)V", line = 119)
    ...
    @OriginalMember(owner = "client!g", name = "f", descriptor = "(B)V", line = 145)
