...
public class class86 extends class430 implements class161 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IIILaa;)Z")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ILrg;)V")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Laa;Z)V")
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(Laa;B)V")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Laa;B)V")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Laa;ZII)Lvn;")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IZIILaa;ILqh;)V")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Laa;IB)Lhc;")
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(Laa;Lsk;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ZI)Llo;")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ILaa;I)Lhc;")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Laa;I)Lcn;")
