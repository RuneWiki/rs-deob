...
public abstract class class86 {
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(II)Z", line = 34)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Z)V", line = 94)
    ...
    @OriginalMember(owner = "client!hw", name = "<init>", descriptor = "(Lnq;)V", line = 109)
    public class86(class325 arg0) {
        this.field1248 = arg0;
    }

    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IBIII)V", line = 124)
