...
public class class86 extends class353 {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ILqda;I)V")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Lew;ZILjava/lang/String;Z)V")
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Lum;)V")
