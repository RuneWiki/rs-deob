...
public class class86 {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(BI)V", line = 19)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(II)Lch;", line = 32)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Lgn;ILvo;)V", line = 113)
