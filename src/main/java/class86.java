...
public class class86 extends class712 {
    ...
    @OriginalMember(owner = "client!vga", name = "b", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(IILhba;)V", line = 15)
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(ZB)V", line = 57)
    ...
    @OriginalMember(owner = "client!vga", name = "<init>", descriptor = "(Lkfa;Luu;)V", line = 75)
    ...
    @OriginalMember(owner = "client!vga", name = "b", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!vga", name = "c", descriptor = "(Z)V", line = 125)
    ...
    @OriginalMember(owner = "client!vga", name = "e", descriptor = "(Z)V", line = 143)
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!vga", name = "d", descriptor = "(I)V", line = 188)
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(B)V", line = 213)
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(Z)V", line = 233)
    ...
    @OriginalMember(owner = "client!vga", name = "b", descriptor = "(Z)V", line = 269)
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(BZ)V", line = 297)
    ...
    @OriginalMember(owner = "client!vga", name = "d", descriptor = "(Z)Z", line = 306)
