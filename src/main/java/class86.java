...
public class class86 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Lf;ILn;IILua;BI)V", line = 25)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;I)V", line = 87)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!hk", name = "b", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ZBIIIILjn;)V", line = 128)
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "(Ler;ILjn;)V", line = 161)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(II)Liba;", line = 191)
