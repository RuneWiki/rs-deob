...
public abstract class class86 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IC)C", line = 16)
    ...
    @OriginalMember(owner = "client!hh", name = "c", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ZBZ)V", line = 71)
