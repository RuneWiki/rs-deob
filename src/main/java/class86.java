...
public abstract class class86 extends class687 {
    ...
    @OriginalMember(owner = "client!al", name = "h", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(II)V", line = 23)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(IIII)V", line = 62)
