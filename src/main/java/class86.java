...
public class class86 extends class167 {
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 14)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "()V", line = 37)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 71)
    ...
    @OriginalMember(owner = "client!lj", name = "d", descriptor = "()V", line = 108)
    ...
    @OriginalMember(owner = "client!lj", name = "c", descriptor = "()I", line = 122)
    public final int method602() {
        return this.field1323 - (this.field1321.available() >> (class55.field899 ? 2 : 1));
    }

    @OriginalMember(owner = "client!lj", name = "b", descriptor = "()V", line = 136)
