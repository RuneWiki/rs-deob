...
public class class86 extends class454 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IIFFIIFIIF[F)V", line = 4)
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(I[B)[B", line = 132)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(I)V", line = 147)
