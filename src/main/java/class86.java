...
public class class86 {
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(JLjava/lang/String;IZJLjava/lang/String;IIIIZIZ)V", line = 17)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(ZIIIIII)I", line = 35)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(IBIFFIIF)[F", line = 65)
