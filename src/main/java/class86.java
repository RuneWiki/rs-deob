...
public abstract class class86 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IZII)V", line = 110)
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(IIIII)V", line = 325)
