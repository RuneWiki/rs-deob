...
public abstract class class86 {
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(IIILpa;)V")
    ...
    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "(Lsf;)V")
    public class86(class551 arg0) {
        this.field1203 = arg0;
        this.field1200 = this.method73(0);
    }

    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "(ILsf;)V")
