...
public class class86 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "([BI)Loia;", line = 21)
    ...
    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "(IIIIIIIIIZI)V", line = 75)
