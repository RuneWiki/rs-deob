...
public class class86 extends class513 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(BC)Z", line = 4)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(Lwu;III)Lkda;", line = 15)
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "()V", line = 35)
    public class86() {
    }

    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(III)V", line = 38)
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 51)
    public class86(String arg0, int arg1) {
        this.field1188 = arg0;
    }

    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(I)V", line = 61)
