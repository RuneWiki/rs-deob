...
public class class86 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IZI)V", line = 214)
    ...
    @OriginalMember(owner = "client!dl", name = "b", descriptor = "(B)V", line = 292)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(BI)V", line = 305)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Lqa;IBIIII)V", line = 334)
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "()V", line = 344)
    protected class86() {
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(Lqa;Lbt;I)V", line = 358)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IBIII)V", line = 418)
