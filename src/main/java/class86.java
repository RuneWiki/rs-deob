...
public class class86 extends class485 {
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(BILin;)I", line = 7)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Lr;I)V", line = 21)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lsea;Lsea;Lqfa;)V", line = 40)
    public class86(class648 arg0, class648 arg1, class85 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!al", name = "a", descriptor = "(ZIIB)V", line = 47)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "([IIIIIIII)V", line = 66)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(IIZI)V", line = 171)
