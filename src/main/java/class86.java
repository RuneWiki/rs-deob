...
public class class86 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(I[[B[[BZ[[BIILui;Lfp;[[II[[BLui;)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILkg;I)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(ZILkg;)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lpk;)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(BIILfp;)V")
