...
public class class86 {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(I)Ljava/io/File;", line = 22)
    private final File method648(int arg0) {
        field1108++;
        return arg0 <= 24 ? null : this.field1102.method2452(17);
    }

    @OriginalMember(owner = "client!ps", name = "a", descriptor = "([BIII)V", line = 38)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "([BI)V", line = 221)
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(I)V", line = 235)
    ...
    @OriginalMember(owner = "client!ps", name = "c", descriptor = "(I)J", line = 283)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Lqf;I)V", line = 297)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "([BIBI)V", line = 332)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(Lbi;II)V", line = 565)
    ...
    @OriginalMember(owner = "client!ps", name = "d", descriptor = "(I)V", line = 472)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(IJ)V", line = 544)
