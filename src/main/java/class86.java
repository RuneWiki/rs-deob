...
public class class86 extends class318 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Lav;IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!hh", name = "c", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Z)V", line = 49)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ZZ)V", line = 62)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(III)V", line = 112)
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(III)Z", line = 159)
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(I)Z", line = 174)
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "(Lkd;Luo;)V", line = 186)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IZ)V", line = 236)
    public final void method722(int arg0, boolean arg1) {
        int var3 = 82 / ((arg0 - -23) / 46);
        ++field1238;
    }

    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(B)V", line = 248)
