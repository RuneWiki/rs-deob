...
public class class86 implements class47 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ILfc;)V", line = 13)
    public final void method467(int arg0, class141 arg1) {
        this.method470(arg0, arg1, 0);
    }

    @OriginalMember(owner = "client!ib", name = "c", descriptor = "()V", line = 16)
    public final void method295() {
        this.field972.field4752.glBindFramebufferEXT(36160, 0);
    }

    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ILvf;)V", line = 19)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ILbc;II)V", line = 42)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ILfc;I)V", line = 67)
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "()I", line = 89)
    public final int method294() {
        return this.field968;
    }

    @OriginalMember(owner = "client!ib", name = "finalize", descriptor = "()V", line = 94)
    protected final void finalize() throws Throwable {
        this.field972.method2060(this.field969);
        super.finalize();
    }

    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ILbc;I)V", line = 106)
    public final void method472(int arg0, class205 arg1, int arg2) {
        this.method469(arg0, arg1, 0, arg2);
    }

    @OriginalMember(owner = "client!ib", name = "d", descriptor = "()Z", line = 110)
    public final boolean method473() {
        int var1 = this.field972.field4752.glCheckFramebufferStatusEXT(36160);
        return var1 == 36053;
    }

    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(Lpo;)V", line = 127)
