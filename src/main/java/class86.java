...
public class class86 extends class501 implements class603 {
    ...
    @OriginalMember(owner = "client!hk", name = "c", descriptor = "(II)Lkq;")
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "(Lte;III)V")
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "(Lte;IIII)V")
