...
public class class86 extends class21 {
    ...
    @OriginalMember(owner = "client!haa", name = "b", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!haa", name = "c", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!haa", name = "<init>", descriptor = "(Lnba;Ljava/lang/Object;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!haa", name = "b", descriptor = "(Z)Ljava/lang/Object;", line = 37)
