...
public class class86 extends class504 {
    ...
    @OriginalMember(owner = "client!np", name = "f", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!np", name = "e", descriptor = "(I)I", line = 48)
    ...
    @OriginalMember(owner = "client!np", name = "g", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(I)[B", line = 79)
