...
public class class86 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(I)[Lje;")
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ZBLik;Z)V")
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IIZ)Lsd;")
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "(Lda;II)V")
