...
public class class86 extends class527 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!kl", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 34)
    public final void startProduction(ImageConsumer arg0) {
        this.addConsumer(arg0);
        ++field1211;
    }

    @OriginalMember(owner = "client!kl", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 42)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Z)Z", line = 54)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IIIIIIIII)V", line = 66)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(ILjava/awt/Canvas;II)V", line = 77)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IIIIILjava/awt/Graphics;II)V", line = 100)
    ...
    @OriginalMember(owner = "client!kl", name = "d", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!kl", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 146)
    ...
    @OriginalMember(owner = "client!kl", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 165)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field1201;
        return this.field1204 == arg0;
    }

    @OriginalMember(owner = "client!kl", name = "b", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!kl", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 195)
