...
public class class86 extends class623 {
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(ZIILd;DILkha;)[I", line = 9)
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(I)V", line = 143)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(BLd;Lkha;)Z", line = 158)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(ZZIBLd;Lkha;ID)[I", line = 214)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Ld;IZILkha;Z)[F", line = 353)
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "()V", line = 465)
    public class86() {
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(Ltn;)V", line = 488)
