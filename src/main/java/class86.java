...
public class class86 extends class481 implements class161 {
    ...
    @OriginalMember(owner = "client!np", name = "f", descriptor = "(I)Lcl;", line = 3)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lza;IZ)Le;", line = 44)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lza;IIILps;IZ)V", line = 56)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(B)I", line = 67)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(III)Lso;", line = 79)
    ...
    @OriginalMember(owner = "client!np", name = "c", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(Z)V", line = 97)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(B)Z", line = 116)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(ILza;)V", line = 126)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "([BB)[B", line = 149)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(ILza;)Lhp;", line = 165)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lza;B)V", line = 208)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(I)I", line = 223)
    ...
    @OriginalMember(owner = "client!np", name = "d", descriptor = "(I)V", line = 235)
    ...
    @OriginalMember(owner = "client!np", name = "c", descriptor = "(B)Z", line = 247)
    public final boolean method107(byte arg0) {
        ++field1396;
        return arg0 != -88;
    }

    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lza;III)Z", line = 258)
    ...
    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "(Lza;Lii;IIIIIZII)V", line = 277)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(I)I", line = 288)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(II)Ljava/lang/String;", line = 300)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(BLza;)V", line = 320)
