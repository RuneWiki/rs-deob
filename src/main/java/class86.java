...
public class class86 extends class380 {
    ...
    @OriginalMember(owner = "client!qb", name = "g", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!qb", name = "e", descriptor = "(I)Z", line = 21)
    ...
    @OriginalMember(owner = "client!qb", name = "f", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Lni;ILfp;Lii;)V", line = 44)
    ...
    @OriginalMember(owner = "client!qb", name = "f", descriptor = "(I)Ljava/lang/Object;", line = 202)
    public final Object method367(int arg0) {
        field1220++;
        return arg0 == 21800 ? this.field1223 : null;
    }

    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IIIBIII)V", line = 213)
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Ljava/lang/Object;)V", line = 764)
