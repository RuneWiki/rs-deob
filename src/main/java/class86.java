...
public class class86 extends class666 {
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(IIIIIZZ)V", line = 8)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(ILiaa;Z)V", line = 82)
    ...
    @OriginalMember(owner = "client!qfa", name = "<init>", descriptor = "()V", line = 125)
    public class86() {
        super(1, true);
    }

    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!qfa", name = "h", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(II)[I", line = 183)
