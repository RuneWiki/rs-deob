...
public class class86 implements Runnable {
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(II)Lab;", line = 7)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(IBLwv;I)V", line = 23)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!cga", name = "run", descriptor = "()V", line = 59)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(IIIIII[Lwv;III)V", line = 102)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(Z)Z", line = 818)
