...
public class class86 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ILqs;Lza;)V", line = 3)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(I[Ljava/lang/String;ZI[S)V", line = 33)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(II)V", line = 96)
