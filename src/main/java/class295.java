...
public class class295 extends class329 {
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!tha", name = "b", descriptor = "(IB)Z", line = 25)
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(BIIII[B)V", line = 39)
