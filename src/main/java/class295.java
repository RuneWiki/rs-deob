...
public class class295 {
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(BI)V", line = 9)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(Lrga;[Lrc;)V", line = 37)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(B)V", line = 123)
