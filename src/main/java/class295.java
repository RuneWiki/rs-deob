...
public class class295 implements class221 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IBI)V", line = 60)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(JI)V", line = 88)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(BZ)I", line = 105)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(BLhq;)I", line = 144)
    ...
    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(III)V", line = 174)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(II)I", line = 206)
    ...
    @OriginalMember(owner = "client!ss", name = "c", descriptor = "(III)V", line = 217)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IB)I", line = 258)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Z)V", line = 279)
