...
public class class295 extends class615 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IIIIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(II)[[I", line = 61)
    ...
    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "()V", line = 191)
    public class295() {
        super(1, false);
    }

    @OriginalMember(owner = "client!en", name = "f", descriptor = "(I)V", line = 158)
    ...
    @OriginalMember(owner = "client!en", name = "c", descriptor = "(III)Z", line = 179)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(BILeh;)V", line = 195)
