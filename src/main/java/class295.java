...
public abstract class class295 {
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(ILat;)V")
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(ZLat;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(IIZILet;I[IIIIIIII[I)I")
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(IILjava/awt/Canvas;Ll;Lor;B)Lza;")
