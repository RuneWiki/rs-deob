...
public class class295 extends class375 {
    ...
    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(IZIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!wg", name = "c", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!wg", name = "f", descriptor = "(B)I", line = 101)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ILya;II)Z", line = 122)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(B)Z", line = 165)
    ...
    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(I)I", line = 176)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ILfb;)V", line = 197)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(III)V", line = 216)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ILya;I)Z", line = 307)
    ...
    @OriginalMember(owner = "client!wg", name = "i", descriptor = "(B)Z", line = 502)
    ...
    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(B)V", line = 518)
    ...
    @OriginalMember(owner = "client!wg", name = "d", descriptor = "(I)Z", line = 531)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Lgg;IZIIILya;)V", line = 543)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ZLya;)Llo;", line = 559)
    ...
    @OriginalMember(owner = "client!wg", name = "g", descriptor = "(B)I", line = 645)
    ...
    @OriginalMember(owner = "client!wg", name = "e", descriptor = "(I)I", line = 672)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Lya;I)V", line = 683)
