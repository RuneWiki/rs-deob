...
public class class295 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Lol;I)V")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Llm;I)V")
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "(Lol;)V")
