...
public class class295 extends class478 implements class278 {
    ...
    @OriginalMember(owner = "client!ka", name = "<init>", descriptor = "(IIIIIIIIIILtq;)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lkm;BII)Z")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lkm;I)V")
    public final void method216(class487 arg0, int arg1) {
        field4068++;
        int var3 = 113 / ((arg1 + 12) / 60);
    }

    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lms;IIZ)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ZLto;)V")
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(Lkm;I)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lkm;II)Lab;")
    ...
    @OriginalMember(owner = "client!ka", name = "c", descriptor = "(Lkm;I)V")
    ...
    @OriginalMember(owner = "client!ka", name = "g", descriptor = "(I)Lwt;")
    ...
    @OriginalMember(owner = "client!ka", name = "d", descriptor = "(Lkm;I)Lto;")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ILkm;IZILkj;B)V")
