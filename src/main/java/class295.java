...
public class class295 extends class381 {
    ...
    @OriginalMember(owner = "client!tg", name = "c", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!tg", name = "c", descriptor = "(I)Z", line = 40)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IIII)V", line = 62)
    ...
    @OriginalMember(owner = "client!tg", name = "d", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(I[[BLwd;II[[BIBILpe;[ZI[[BLfr;)V", line = 103)
    ...
    @OriginalMember(owner = "client!tg", name = "d", descriptor = "(I)V", line = 581)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILpe;)V", line = 606)
