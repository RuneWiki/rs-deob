...
public class class295 extends class144 implements class21 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ILza;)V")
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IIILdj;Ldj;)V")
    ...
    @OriginalMember(owner = "client!ij", name = "b", descriptor = "(Lza;B)Lkf;")
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IILza;I)Z")
    ...
    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "(Lza;Lfu;IIIIIZIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ILoq;)V")
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Lza;B)V")
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ILza;ILge;IZI)V")
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IILjp;)V")
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ILza;I)Le;")
