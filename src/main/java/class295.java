...
public class class295 implements class393 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IILip;)V")
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(BLud;I)V")
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Lgh;III)V")
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(BIILgh;I)V")
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(Lrl;)V")
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(BILud;I)V")
