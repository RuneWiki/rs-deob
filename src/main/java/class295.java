...
public class class295 extends class596 implements class326 {
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(Lqt;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;", line = 15)
    public final IDirect3DBaseTexture method978(byte arg0) {
        return arg0 == -127 ? this.field4125 : (IDirect3DBaseTexture) null;
    }

    @OriginalMember(owner = "client!pfa", name = "<init>", descriptor = "(Llt;IZ[[I)V", line = 26)
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(I)V", line = 79)
