...
public class class295 extends class324 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Loa;IZLlq;ILgh;ILlm;)V", line = 15)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(I[BZ)Ljava/lang/Object;", line = 59)
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(II)V", line = 97)
