...
public class class295 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(II)Ltq;", line = 262)
    ...
    @OriginalMember(owner = "client!vq", name = "<init>", descriptor = "(Ldn;ILr;)V", line = 295)
    public class295(class329 arg0, int arg1, class110 arg2) {
        this.field3940 = arg2;
        this.field3940.method694(1, (byte) 119);
    }

    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(B)V", line = 313)
