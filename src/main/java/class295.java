...
public class class295 extends class110 implements class666 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(I)Lbt;")
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Llm;Lbt;Z)V")
