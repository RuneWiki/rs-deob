...
public class class295 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(ZIB)Lwu;")
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(ILl;Ljava/awt/Canvas;I)Lza;")
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Lqs;III)Luq;")
