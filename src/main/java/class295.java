...
public class class295 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(BI)V", line = 10)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Z)V", line = 28)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IIBILaba;ZI)V", line = 40)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IB)V", line = 94)
