...
public class class295 extends class395 {
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(BLrn;ZIILqa;I)V")
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!qt", name = "b", descriptor = "(Lqa;B)Lvs;")
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(IZILqa;)Z")
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lde;B)V")
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(ILqa;B)Z")
