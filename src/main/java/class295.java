...
public class class295 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IB)V", line = 5)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(II[IBLmh;Z)Lwo;", line = 38)
