...
public class class295 {
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(ILib;)V", line = 14)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(Lkp;I)V", line = 98)
    ...
    @OriginalMember(owner = "client!vca", name = "<init>", descriptor = "(Lib;)V", line = 144)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(I)V", line = 127)
