...
public class class295 extends class136 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!io", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 5)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field4297;
    }

    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Z)V", line = 12)
    ...
    @OriginalMember(owner = "client!io", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 31)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IIBILjava/awt/Graphics;I)V", line = 41)
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ILmj;Lmj;IZ)I", line = 68)
    ...
    @OriginalMember(owner = "client!io", name = "c", descriptor = "(Z)V", line = 172)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(II)Lun;", line = 197)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Ljava/awt/Canvas;I)V", line = 229)
    ...
    @OriginalMember(owner = "client!io", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 254)
    public final void startProduction(ImageConsumer arg0) {
        this.addConsumer(arg0);
        ++field4287;
    }

    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IIIII)V", line = 263)
    ...
    @OriginalMember(owner = "client!io", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 275)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ILkg;)V", line = 287)
    ...
    @OriginalMember(owner = "client!io", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 317)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field4292;
        return this.field4286 == arg0;
    }

    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ILjava/awt/Graphics;IB)V", line = 325)
