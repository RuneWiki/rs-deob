...
public abstract class class295 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(III)I", line = 17)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(I)Z", line = 45)
    ...
    @OriginalMember(owner = "client!s", name = "b", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(IIB)I", line = 91)
    ...
    @OriginalMember(owner = "client!s", name = "<init>", descriptor = "(III[[I)V", line = 101)
