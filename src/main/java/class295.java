...
public class class295 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(B)Lfs;", line = 4)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(I)Lfs;", line = 30)
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "(I)I", line = 52)
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Z)Lfs;", line = 92)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(ILfs;)V", line = 113)
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "()V", line = 173)
    public class295() {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(II)V", line = 155)
