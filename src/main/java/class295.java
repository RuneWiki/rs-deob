...
public class class295 extends class56 {
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lbv;)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lco;IIII)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IILkv;)V")
