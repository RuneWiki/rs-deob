...
public class class295 extends class225 {
    ...
    @OriginalMember(owner = "client!or", name = "e", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!or", name = "f", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lnj;IB)V", line = 48)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Ln;III)V", line = 121)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(CZ)I", line = 175)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lnj;I)V", line = 215)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(CI)I", line = 236)
