...
public class class295 extends class760 {
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(IC)B", line = 4)
    ...
    @OriginalMember(owner = "client!gga", name = "c", descriptor = "(B)V", line = 129)
    ...
    @OriginalMember(owner = "client!gga", name = "<init>", descriptor = "(ILle;Lqj;III)V", line = 142)
    public class295(int arg0, class311 arg1, class512 arg2, int arg3, int arg4, int arg5) {
        super(arg0, arg1, arg2, arg3, arg4);
        this.field4218 = arg5;
    }

    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(B)Lmha;", line = 152)
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(BLbt;)V", line = 169)
