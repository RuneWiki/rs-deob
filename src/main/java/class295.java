...
public class class295 extends IOException {
    ...
    @OriginalMember(owner = "client!haa", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 4)
    public class295(String arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(IIIZ)Lkha;", line = 7)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(I)V", line = 27)
