...
public class class295 extends class66 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IZIIII)Z", line = 16)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IIIIIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZ)V", line = 70)
