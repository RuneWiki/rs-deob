...
public class class295 extends class105 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(I[Lnt;Lha;I[BI)V")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "([IIIIILvj;IIILha;I)V")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(FIFIIFFIFILgaa;)[B")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(II[Lnt;IILha;IZ[BII)V")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Lnt;ILha;IBIIIIII)V")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ZILha;Lvj;I[I)V")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Lnt;ILha;IBII)V")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Lha;ZZ)V")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IIIBI)Lvea;")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
