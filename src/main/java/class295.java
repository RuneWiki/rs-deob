...
public class class295 {
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(I[BIII[BIII)V")
    ...
    @OriginalMember(owner = "client!pfa", name = "toString", descriptor = "()Ljava/lang/String;")
    public final String toString() {
        field4152++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(BI)Lpfa;")
    ...
    @OriginalMember(owner = "client!pfa", name = "<init>", descriptor = "(IILwt;)V")
