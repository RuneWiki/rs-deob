...
public class class295 extends class168 {
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(Lha;I)V", line = 11)
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "([BB)Liea;", line = 52)
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(BZIII)V", line = 93)
    ...
    @OriginalMember(owner = "client!gga", name = "b", descriptor = "(I)V", line = 372)
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(Z)V", line = 451)
