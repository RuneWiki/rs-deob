...
public abstract class class295 extends class446 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(I[IIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ZI)V", line = 34)
    ...
    @OriginalMember(owner = "client!od", name = "e", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(BIIIIII)V", line = 59)
