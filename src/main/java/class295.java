...
public class class295 extends class234 implements class175 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IIII[BILpe;II)V")
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Lus;Lpe;Ldw;II)V")
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Z)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Lus;Lpe;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Lko;I)V")
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Lus;IIZ[III)V")
