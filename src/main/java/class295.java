...
public class class295 extends class232 {
    ...
    @OriginalMember(owner = "client!wha", name = "<init>", descriptor = "(Lki;Lcb;)V", line = 3)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(ZI)V", line = 31)
    ...
    @OriginalMember(owner = "client!wha", name = "e", descriptor = "(I)Z", line = 40)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(ZB)V", line = 51)
    ...
    @OriginalMember(owner = "client!wha", name = "c", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(III)V", line = 88)
    public final void method569(int arg0, int arg1, int arg2) {
        int var4 = -108 % ((48 - arg0) / 51);
    }

    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!wha", name = "b", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!wha", name = "f", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!wha", name = "d", descriptor = "(I)V", line = 185)
    ...
    @OriginalMember(owner = "client!wha", name = "c", descriptor = "(I)V", line = 225)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(ILdr;I)V", line = 244)
    ...
    @OriginalMember(owner = "client!wha", name = "b", descriptor = "(I)V", line = 279)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(B)V", line = 306)
