...
public class class295 extends class456 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(Lng;I)[Lv;")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IBLre;)V")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(Lcp;Ljava/awt/Canvas;ZI)Ltq;")
