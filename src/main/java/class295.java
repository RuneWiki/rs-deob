...
public class class295 {
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "([Lmc;I)I")
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(Lmc;IJ)V")
    ...
    @OriginalMember(owner = "client!pfa", name = "b", descriptor = "(I)Lmc;")
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(ZJ)Lmc;")
    ...
    @OriginalMember(owner = "client!pfa", name = "c", descriptor = "(I)Lmc;")
    ...
    @OriginalMember(owner = "client!pfa", name = "f", descriptor = "(I)Lmc;")
