...
public abstract class class295 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(BZ)V", line = 16)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(ILvo;)V", line = 64)
    ...
    @OriginalMember(owner = "client!ke", name = "b", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Z)V", line = 125)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IIIII)V", line = 154)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Ltj;IILug;III[[[B[I[I[I[I[IIBIIZ)V", line = 168)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(III)V", line = 323)
