...
public class class300 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IIII)Z", line = 9)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "()V", line = 70)
    public final void method1918() {
        this.field4031 = null;
    }

    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lpe;Lje;)Z", line = 77)
    public final boolean method1919(class391 arg0, class300 arg1) {
        return this.field4031 != null || this.method1921(arg0, arg1);
    }

    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lpe;)V", line = 83)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(Lpe;Lje;)Z", line = 145)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(Lpe;)V", line = 180)
    ...
    @OriginalMember(owner = "client!je", name = "c", descriptor = "(Lpe;Lje;)V", line = 263)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lpe;IIIIII)V", line = 352)
    ...
    @OriginalMember(owner = "client!je", name = "d", descriptor = "(Lpe;Lje;)V", line = 379)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "()V", line = 462)
    ...
    @OriginalMember(owner = "client!je", name = "c", descriptor = "()V", line = 471)
    public static final void method1927() {
        field4034 = null;
        field4033 = null;
    }

    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 478)
