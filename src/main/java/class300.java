...
public class class300 {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(BI)V", line = 75)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(II)Ltq;", line = 119)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(III)Z", line = 155)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(II)Lnl;", line = 166)
    ...
    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(Lgo;ILns;Lns;Lns;)V", line = 624)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(I)V", line = 202)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ZC)C", line = 214)
