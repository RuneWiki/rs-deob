...
public class class300 extends class154 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lhk;[Lhv;B)Lag;", line = 4)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(II)V", line = 72)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(III)Z", line = 125)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIIIIIZII)V", line = 191)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(B)V", line = 253)
