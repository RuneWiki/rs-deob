...
public abstract class class300 extends class256 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(FFFFFF)V", line = 8)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "()I", line = 149)
    public final int method80() {
        return this.field4352;
    }

    @OriginalMember(owner = "client!gq", name = "d", descriptor = "()I", line = 156)
    public final int method75() {
        return this.field4370 + this.field4352 + this.field4351;
    }

    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(IIII)V", line = 170)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "()I", line = 177)
    public final int method87() {
        return this.field4348;
    }

    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(FFFFFFIII)V", line = 189)
    ...
    @OriginalMember(owner = "client!gq", name = "c", descriptor = "()I", line = 285)
    public final int method83() {
        return this.field4363 + this.field4348 + this.field4378;
    }

    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(FFFFFFLsg;II)V", line = 291)
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Ldq;II)V", line = 308)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IIIIIII)V", line = 314)
