...
public class class300 extends class331 {
    ...
    @OriginalMember(owner = "client!gq", name = "e", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(III)Z", line = 42)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(II)V", line = 74)
    ...
    @OriginalMember(owner = "client!gq", name = "c", descriptor = "(B)V", line = 96)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IIII[I)Z", line = 110)
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 379)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(I[III)Z", line = 141)
    ...
    @OriginalMember(owner = "client!gq", name = "f", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(BI[II)Z", line = 338)
