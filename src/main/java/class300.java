...
public class class300 {
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 17)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(ZLjava/lang/String;II[Lho;)I", line = 28)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "([Lho;[Ljava/lang/String;Ljava/lang/String;[IZ)I", line = 46)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "([Lho;Ljava/lang/String;Z)I", line = 293)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(II[Lho;Ljava/lang/String;)I", line = 401)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(ILgs;)V", line = 428)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "([Lho;IILjava/lang/String;)Ljava/lang/String;", line = 635)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(ILjava/lang/String;I[Lho;)I", line = 760)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(I)V", line = 775)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(ICI)I", line = 792)
    ...
    @OriginalMember(owner = "client!hw", name = "<init>", descriptor = "([B)V", line = 812)
