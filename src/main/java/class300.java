...
public class class300 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "([BB)Ljava/lang/String;", line = 8)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIIIILue;IIIII)Z", line = 114)
