...
public class class300 extends class476 {
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(S)V", line = 8)
    public class300(short arg0) {
        this.field4105 = arg0;
    }

    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IIIZIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(I)V", line = 141)
