...
public class class300 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(ILcu;)V", line = 15)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(IILcu;)V", line = 39)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(B)V", line = 66)
