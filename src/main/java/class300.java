...
public class class300 implements class719 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;", line = 6)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(III)Z", line = 31)
    ...
    @OriginalMember(owner = "client!cp", name = "c", descriptor = "(I)I", line = 64)
    public final int method2403(int arg0) {
        return arg0 == 26270 ? this.field4182 : 124;
    }

    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "(Los;Z)V", line = 119)
    public class300(class253 arg0, boolean arg1) {
        this.field4179 = arg0;
        this.field4180 = arg1;
    }

    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(BLjaclib/memory/Source;II)Z", line = 79)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(I)Z", line = 96)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(Z)V", line = 129)
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "(I)I", line = 147)
