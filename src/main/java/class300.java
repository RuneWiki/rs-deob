...
public class class300 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Lnj;B)V")
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Lnj;II)V")
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Lps;IIB)V")
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IBLii;III)Ldc;")
