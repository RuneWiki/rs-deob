...
public class class300 {
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ILfh;Z)V", line = 41)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IIIIB)V", line = 62)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(BLfh;)V", line = 181)
