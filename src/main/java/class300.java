...
public class class300 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(II)I", line = 29)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IIB)V", line = 57)
