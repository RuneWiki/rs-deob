...
public class class300 {
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(ZLkc;)I", line = 34)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(III)I", line = 66)
    ...
    @OriginalMember(owner = "client!hga", name = "b", descriptor = "(I)Z", line = 91)
    ...
    @OriginalMember(owner = "client!hga", name = "<init>", descriptor = "(Z)V", line = 102)
