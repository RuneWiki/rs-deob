...
public class class300 extends class16 {
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(BZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(I)Z", line = 14)
    ...
    @OriginalMember(owner = "client!pba", name = "b", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(IIZ)V", line = 37)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(IILuda;)V", line = 49)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!pba", name = "b", descriptor = "(Z)V", line = 84)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(ZB)V", line = 142)
    ...
    @OriginalMember(owner = "client!pba", name = "<init>", descriptor = "(Lap;)V", line = 153)
