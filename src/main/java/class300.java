...
public class class300 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ILti;)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(II)Lbu;")
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Lmt;ILhh;Lhh;)V")
