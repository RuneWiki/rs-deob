...
public class class300 extends class397 {
    ...
    @OriginalMember(owner = "client!td", name = "c", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "()V", line = 30)
    public class300() {
        super(1, false);
    }

    @OriginalMember(owner = "client!td", name = "e", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(IBLae;)V", line = 140)
    ...
    @OriginalMember(owner = "client!td", name = "c", descriptor = "(II)V", line = 178)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(BI)[[I", line = 432)
