...
public class class300 extends class228 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IIIIILco;IBILco;)V", line = 4)
    ...
    @OriginalMember(owner = "client!af", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 54)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IIIIIII)V", line = 66)
    ...
    @OriginalMember(owner = "client!af", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 84)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field4122;
        return this.field4131 == arg0;
    }

    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IBILjava/awt/Graphics;)V", line = 95)
    ...
    @OriginalMember(owner = "client!af", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 107)
    public final void startProduction(ImageConsumer arg0) {
        this.addConsumer(arg0);
        ++field4116;
    }

    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IIIILjava/awt/Graphics;I)V", line = 115)
    ...
    @OriginalMember(owner = "client!af", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 133)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ILem;IB)V", line = 146)
    ...
    @OriginalMember(owner = "client!af", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 170)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field4126;
    }

    @OriginalMember(owner = "client!af", name = "d", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!af", name = "e", descriptor = "(I)V", line = 190)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 207)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IZB[IILef;)Ltq;", line = 229)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IIIII)V", line = 254)
