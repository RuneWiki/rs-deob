...
public class class300 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(ILua;)V", line = 17)
    public static final void method1978(int arg0, class3 arg1) {
        field4249++;
        arg1.field21 = null;
        int var2 = arg1.field18.length;
        for (int var3 = arg0; var3 < var2; var3++) {
            arg1.field18[var3].field7910 = false;
        }
        class244[] var4 = class754.field10383;
        synchronized (class754.field10383) {
            if (var2 < class754.field10383.length && class51.field757[var2] < 200) {
                class754.field10383[var2].method1643(arg1, 122);
                int var10002 = class51.field757[var2]++;
            }
        }
    }

    @OriginalMember(owner = "client!es", name = "a", descriptor = "(ZIZILjava/lang/String;JBZIJIILjava/lang/String;)V", line = 43)
    public static final void method1979(boolean arg0, int arg1, boolean arg2, int arg3, String arg4, long arg5, byte arg6, boolean arg7, int arg8, long arg9, int arg10, int arg11, String arg12) {
        field4251++;
        if (class25.field320 || class284.field4103 >= 500) {
            return;
        }
        int var15 = arg1 == -1 ? class222.field3007 : arg1;
        class558 var16 = new class558(arg12, arg4, var15, arg11, arg3, arg9, arg10, arg8, arg0, arg2, arg5, arg7);
        if (arg6 == 115) {
            class714.method4011(var16, arg6 ^ 0x4ED7);
        }
    }

    @OriginalMember(owner = "client!es", name = "a", descriptor = "(I)V", line = 66)
    public static final void method1980(int arg0) {
        class166.field2285 = new class616[1000];
        ...
        class316.field4387 = new int[class370.field5229][class61.field877 + 1][class713.field9959 + 1];
        class312.field4339 = 0;
        class233.field3469 = class368.field5213;
        class77.field1127 = new class616[500];
        class625.field8414 = new class616[2000];
        class428.field5984 = class368.field5213;
        class726.field10070 = 0;
        class363.field5183 = new class616[500];
        class491.field6907 = false;
        if (class441.field6132 instanceof class408) {
            class762.field10630 = false;
        } else {
            class762.field10630 = true;
        }
    }
}
