...
public class class300 implements Runnable {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(ILjb;I[B)Llq;")
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(BILjb;)Llq;")
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(BLlq;)V")
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IILjb;)Llq;")
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "(Lud;)V")
