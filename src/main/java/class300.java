...
public class class300 implements class74 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IIZIBII)V", line = 6)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IILen;IZIZLen;Ltc;Leq;ZI)Lkh;", line = 50)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(I)Z", line = 279)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ILsl;BI)J", line = 299)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(II)V", line = 334)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(B[I[J)V", line = 365)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IIBI)I", line = 377)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IJ[IZ)Ljava/lang/String;", line = 401)
