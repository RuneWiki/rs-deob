...
public class class300 extends class507 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lug;IZ)V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IILfo;IIIZ)V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lug;B)V")
    ...
    @OriginalMember(owner = "client!gr", name = "e", descriptor = "(I)[Lbu;")
