...
public class class300 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!di", name = "b", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(II)V", line = 50)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IB)Lei;", line = 64)
    ...
    @OriginalMember(owner = "client!di", name = "<init>", descriptor = "(Llo;ILnl;)V", line = 112)
    public class300(class280 arg0, int arg1, class435 arg2) {
        this.field4253 = arg2;
        this.field4253.method2638(1, 1);
    }

    @OriginalMember(owner = "client!di", name = "b", descriptor = "(II)V", line = 127)
