...
public class class300 {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Lqa;JI)V", line = 5)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(III)Z", line = 49)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(III[BIII)Z", line = 174)
