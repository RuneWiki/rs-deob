...
public class class300 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(BI)Lfba;")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ILor;)V")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lgea;I)I")
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(ILaj;Laj;)V")
