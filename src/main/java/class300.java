...
public class class300 extends class390 {
    ...
    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IBLaa;I)Z", line = 23)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IB)Loa;", line = 50)
