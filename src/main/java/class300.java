...
public class class300 extends class601 {
    ...
    @OriginalMember(owner = "client!sm", name = "b", descriptor = "(I)Z", line = 9)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(III)V", line = 54)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!sm", name = "b", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIB)V", line = 128)
    ...
    @OriginalMember(owner = "client!sm", name = "b", descriptor = "(Z)V", line = 144)
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(IIIIIFFF)V", line = 159)
