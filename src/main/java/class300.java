...
public class class300 extends class633 {
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Lrf;IIII)Lba;")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(II[[I[[IIII)Ld;")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Lpl;IIII)V")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Ljava/lang/Runnable;)Lhi;")
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(Ljava/awt/Canvas;Le;)V")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "([Lba;Lob;Lq;[Lqn;I)V")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "([Lba;Lq;[Lqn;I)V")
