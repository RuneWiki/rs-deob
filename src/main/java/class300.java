...
public class class300 extends class394 {
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(J)V", line = 22)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(JI)V", line = 143)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lwg;IIIIIIIIIIIZ)V", line = 539)
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "()V", line = 557)
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(Lwg;IIIIIIIIIIIZ)V", line = 563)
