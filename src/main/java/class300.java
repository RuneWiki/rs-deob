...
public abstract class class300 implements class562 {
    ...
    @OriginalMember(owner = "client!dh", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!dh", name = "e", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(BI)V", line = 39)
    ...
    @OriginalMember(owner = "client!dh", name = "f", descriptor = "(I)I", line = 52)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(III)Z", line = 151)
    ...
    @OriginalMember(owner = "client!dh", name = "g", descriptor = "(I)V", line = 168)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(Z)I", line = 188)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(Lji;I)Loq;", line = 203)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(III[II)V", line = 218)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "([FIIBI)V", line = 324)
    ...
    @OriginalMember(owner = "client!dh", name = "finalize", descriptor = "()V", line = 421)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(III[BI)V", line = 435)
    ...
    @OriginalMember(owner = "client!dh", name = "c", descriptor = "(I)V", line = 535)
    ...
    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(Lel;ILnh;Ljr;IZ)V", line = 590)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(ILju;)V", line = 570)
