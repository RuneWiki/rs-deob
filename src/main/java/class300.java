...
public class class300 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(III)Z", line = 8)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "([IIII)Lmca;", line = 24)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "([III)Lmca;", line = 78)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(I[II)Lmca;", line = 101)
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Ldda;Ldda;)V", line = 206)
    public class300(class597 arg0, class597 arg1) {
        this.field4399 = arg0;
        this.field4391 = arg1;
    }

    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ILmaa;)Z", line = 131)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "([IBII)Lmca;", line = 160)
