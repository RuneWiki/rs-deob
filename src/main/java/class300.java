...
public class class300 implements class8 {

    @OriginalMember(owner = "client!qh", name = "b", descriptor = "I")
    private int field4712 = -1;

    @OriginalMember(owner = "client!qh", name = "a", descriptor = "Z")
    private boolean field4711 = false;

    @OriginalMember(owner = "client!qh", name = "c", descriptor = "[I")
    private int[] field4713 = null;

    @OriginalMember(owner = "client!qh", name = "c", descriptor = "()V", line = 6)
    public final void method73() {
        GL var1 = class36.field518;
        if (class175.field2589) {
            var1.glCallList(this.field4712 + 1);
        } else {
            var1.glTexEnvi(8960, 34184, 5890);
        }
    }

    @OriginalMember(owner = "client!qh", name = "d", descriptor = "()V", line = 22)
    private final void method2105() {
        GL var1 = class36.field518;
        if (this.field4713 == null) {
            this.field4713 = new int[3];
            var1.glGenTextures(3, this.field4713, 0);
        }
        short var2 = 4096;
        ...
        for (int var6 = 0; var6 < 6; var6++) {
            ...
            var1.glBindTexture(34067, this.field4713[0]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var4));
            var1.glBindTexture(34067, this.field4713[1]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var5));
            var1.glBindTexture(34067, this.field4713[2]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var3));
            class166.field2499 += var2 * 3;
        }
    }

    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(I)V", line = 137)
    public final void method72(int arg0) {
        GL var2 = class36.field518;
        if (class175.field2589 && this.field4713 != null) {
            var2.glActiveTexture(33985);
            var2.glBindTexture(34067, this.field4713[arg0 - 1]);
            var2.glActiveTexture(33984);
        }
    }

    @OriginalMember(owner = "client!qh", name = "b", descriptor = "()I", line = 149)
    public final int method71() {
        return 4;
    }

    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "()V", line = 179)
    public class300() {
        if (class36.field521 && class36.field513 >= 2) {
            this.method2105();
            GL var1 = class36.field518;
            var1.glBindTexture(34067, this.field4713[0]);
            ...
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            this.field4711 = class36.field513 < 3;
        }
        this.method2106();
    }

    @OriginalMember(owner = "client!qh", name = "a", descriptor = "()V", line = 160)
    public final void method70() {
        GL var1 = class36.field518;
        class36.method314(1);
        if (class175.field2589) {
            var1.glCallList(this.field4712);
        } else {
            var1.glTexEnvi(8960, 34184, 34167);
        }
    }

    @OriginalMember(owner = "client!qh", name = "e", descriptor = "()V", line = 210)
    private final void method2106() {
        GL var1 = class36.field518;
        this.field4712 = var1.glGenLists(2);
        var1.glNewList(this.field4712, 4864);
        if (this.field4713 == null) {
            var1.glTexEnvi(8960, 34184, 34167);
        } else {
            ...
            if (this.field4711) {
                ...
                var1.glTexEnvi(8960, 34162, 7681);
                var1.glTexEnvi(8960, 34184, 34167);
                var1.glBindTexture(3553, class36.field535);
                var1.glEnable(3553);
            }
            var1.glActiveTexture(33984);
        }
        var1.glEndList();
        var1.glNewList(this.field4712 + 1, 4864);
        if (this.field4713 == null) {
            var1.glTexEnvi(8960, 34184, 5890);
        } else {
            var1.glActiveTexture(33985);
