...
public class class300 extends class488 implements class105 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Z)I", line = 3)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Lnq;I[BI)V", line = 37)
    public class300(class325 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field4409 = arg1;
    }

    @OriginalMember(owner = "client!li", name = "b", descriptor = "(Z)J", line = 56)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(I)I", line = 68)
    public final int method677(int arg0) {
        ++field4401;
        return arg0 != -9737 ? 80 : 0;
    }

    @OriginalMember(owner = "client!li", name = "a", descriptor = "(BI[BI)V", line = 81)
    ...
    @OriginalMember(owner = "client!li", name = "c", descriptor = "(Z)V", line = 96)
    ...
    @OriginalMember(owner = "client!li", name = "c", descriptor = "(I)V", line = 110)
