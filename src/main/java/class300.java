...
public class class300 extends class175 {
    ...
    @OriginalMember(owner = "client!vv", name = "<init>", descriptor = "(Lbi;Lbi;Llda;)V", line = 7)
    public class300(class449 arg0, class449 arg1, class454 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(IIIZI)V", line = 11)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(IIII)I", line = 32)
    ...
    @OriginalMember(owner = "client!vv", name = "c", descriptor = "(I)V", line = 46)
