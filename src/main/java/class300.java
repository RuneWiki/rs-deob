...
public class class300 extends class54 {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(BII)Z", line = 29)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Lac;B)Lsda;", line = 41)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IIIBIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IZ)Z", line = 496)
    ...
    @OriginalMember(owner = "client!wb", name = "h", descriptor = "(I)V", line = 510)
    ...
    @OriginalMember(owner = "client!wb", name = "i", descriptor = "(I)V", line = 521)
    ...
    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "(Lnv;II)V", line = 555)
