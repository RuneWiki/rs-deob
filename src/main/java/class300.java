...
public class class300 {
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(BIIIIBLka;I)Lka;", line = 17)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(IIILjava/lang/Class;)Llr;", line = 86)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ZIZI)I", line = 120)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Lji;I)V", line = 245)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(B)V", line = 267)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(IIIIII)Z", line = 285)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(II)V", line = 317)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(IIIILka;I)Lka;", line = 334)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(I)V", line = 479)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ILji;I)V", line = 520)
