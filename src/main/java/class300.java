...
public class class300 extends class107 implements class128 {
    ...
    @OriginalMember(owner = "client!j", name = "b", descriptor = "()[Lrea;")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lq;Lht;I)V")
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Lda;La;Lfca;IIII)V")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lq;Lht;II)V")
    ...
    @OriginalMember(owner = "client!j", name = "c", descriptor = "()[Lgi;")
