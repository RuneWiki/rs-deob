...
public class class300 {
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Lfea;B)V")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(I)Lum;")
    ...
    @OriginalMember(owner = "client!d", name = "b", descriptor = "(I)Lum;")
    ...
    @OriginalMember(owner = "client!d", name = "<init>", descriptor = "(Lfea;)V")
