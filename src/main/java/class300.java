...
public class class300 {
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "()V", line = 8)
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "()V", line = 56)
    public static void method1988() {
        field4364 = null;
    }

    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(II)V", line = 59)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lfp;[IIII[I[I)V", line = 99)
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(I)Z", line = 137)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lfp;[II[I[I)V", line = 212)
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(II)V", line = 218)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "([III)V", line = 266)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lfp;[II)V", line = 316)
