...
public class class300 {
    ...
    @OriginalMember(owner = "client!rp", name = "finalize", descriptor = "()V", line = 20)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(II[BI)V", line = 33)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(II[BB)I", line = 51)
    ...
    @OriginalMember(owner = "client!rp", name = "b", descriptor = "(I)Ljava/io/File;", line = 71)
    ...
    @OriginalMember(owner = "client!rp", name = "c", descriptor = "(I)J", line = 82)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(JI)V", line = 92)
