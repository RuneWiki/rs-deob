...
public class class300 extends class309 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IBI)I", line = 5)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(B[FI)[F", line = 39)
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "(II[I[I)V", line = 57)
