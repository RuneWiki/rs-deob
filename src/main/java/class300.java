...
public class class300 extends class657 {
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ILdu;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ZB)V", line = 14)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(III)V", line = 26)
    ...
    @OriginalMember(owner = "client!gaa", name = "<init>", descriptor = "(Lbfa;Lin;Lur;)V", line = 50)
    ...
    @OriginalMember(owner = "client!gaa", name = "b", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!gaa", name = "b", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!gaa", name = "f", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!gaa", name = "e", descriptor = "(I)Z", line = 146)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Z)V", line = 156)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(I)V", line = 177)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(IZ)V", line = 208)
