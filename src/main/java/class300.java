...
public class class300 extends class424 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 35)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IIZLij;IB)V", line = 68)
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(IB)[I", line = 97)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Lrg;BI)V", line = 186)
    ...
    @OriginalMember(owner = "client!wm", name = "g", descriptor = "(I)V", line = 237)
    ...
    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "()V", line = 255)
    public class300() {
        super(0, true);
    }
}
