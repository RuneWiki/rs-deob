...
public class class300 implements Runnable {
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(IB)V", line = 6)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(III)I", line = 43)
    ...
    @OriginalMember(owner = "client!saa", name = "run", descriptor = "()V", line = 83)
