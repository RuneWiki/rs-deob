...
public class class300 extends Exception {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 15)
    public static final void method1846(int arg0, String arg1, int arg2) {
        field4210++;
        class418.method2478(arg0, "", "", arg1, 0, "", arg2);
    }

    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IIIIIZII)V", line = 23)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(I)V", line = 70)
