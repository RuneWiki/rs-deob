...
public class class300 extends class361 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Loi;Lza;I)V")
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Lza;Lge;III)V")
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Ltr;)V")
