...
public class class300 extends class649 implements class7 {
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(III)Z", line = 15)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(I)I", line = 26)
    ...
    @OriginalMember(owner = "client!jp", name = "c", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Z)J", line = 55)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 67)
    ...
    @OriginalMember(owner = "client!jp", name = "<init>", descriptor = "(Lad;I[BI)V", line = 86)
    public class300(class362 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field4417 = arg1;
    }

    @OriginalMember(owner = "client!jp", name = "a", descriptor = "([BIIZ)V", line = 95)
