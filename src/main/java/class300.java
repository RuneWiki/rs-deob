...
public class class300 {
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(IIILha;ILtk;)V")
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(Lwq;II)V")
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(ILwq;)V")
