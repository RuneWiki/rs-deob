...
public abstract class class300 implements class222 {
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ILng;)V")
    ...
    @OriginalMember(owner = "client!gaa", name = "d", descriptor = "(I)Llv;")
    ...
    @OriginalMember(owner = "client!gaa", name = "<init>", descriptor = "(Lqi;ILsk;Lvea;IZ)V")
