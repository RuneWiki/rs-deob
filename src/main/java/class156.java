...
public class class156 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(II)I", line = 6)
    ...
    @OriginalMember(owner = "client!sm", name = "b", descriptor = "(II)I", line = 20)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(I[B)[B", line = 37)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(B)V", line = 113)
    public static void method1030(byte arg0) {
        field2222 = null;
        int var1 = -70 / ((-arg0 - 56) / 58);
    }

    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(II)V", line = 124)
