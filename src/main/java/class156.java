...
public class class156 implements class142 {
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(I)Lwt;", line = 13)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(ILada;)Z", line = 51)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(I)J", line = 90)
