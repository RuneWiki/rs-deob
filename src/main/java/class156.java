...
public class class156 {
    ...
    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "([BIB)V", line = 125)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(JI[B)V", line = 198)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(II)V", line = 285)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(B)V", line = 299)
