...
public class class156 {
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(CII)I", line = 5)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(ILpl;IZ)Leg;", line = 24)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(II)Lkp;", line = 41)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(II[B[BII)I", line = 75)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(B)V", line = 145)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "([BI[BIBI)I", line = 158)
    ...
    @OriginalMember(owner = "client!efa", name = "<init>", descriptor = "([B)V", line = 308)
