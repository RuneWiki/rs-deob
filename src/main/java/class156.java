...
public abstract class class156 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(ICLjava/lang/String;)[Ljava/lang/String;", line = 8)
    ...
    @OriginalMember(owner = "client!mk", name = "e", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Lwd;ILpe;)I", line = 67)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Lbi;Lpe;I)V", line = 92)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Z)V", line = 104)
