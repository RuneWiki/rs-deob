...
public abstract class class156 extends class86 {
    ...
    @OriginalMember(owner = "client!ck", name = "d", descriptor = "(Z)[Lob;")
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(Lco;Ldr;)V")
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Ldt;I)V")
