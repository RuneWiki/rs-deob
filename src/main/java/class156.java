...
public class class156 extends class429 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IIIIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!nl", name = "c", descriptor = "(I)Z", line = 78)
    ...
    @OriginalMember(owner = "client!nl", name = "d", descriptor = "(I)V", line = 109)
