...
public class class156 implements Runnable {
    ...
    @OriginalMember(owner = "client!qh", name = "g", descriptor = "Llf;")
    private static class109 field2937 = class35.method275("Benutzername: ", 2);

    @OriginalMember(owner = "client!qh", name = "k", descriptor = "Llf;")
    private static class109 field2941 = class35.method275("flash2:", 2);

    @OriginalMember(owner = "client!qh", name = "e", descriptor = "Llf;")
    public static class109 field2935 = field2941;

    @OriginalMember(owner = "client!qh", name = "m", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(III)Lei;")
