...
public abstract class class156 extends class656 {
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(III)B", line = 14)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(I)Z", line = 33)
    ...
    @OriginalMember(owner = "client!faa", name = "c", descriptor = "(I)Z", line = 47)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!faa", name = "c", descriptor = "(B)I", line = 161)
    ...
    @OriginalMember(owner = "client!faa", name = "d", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!faa", name = "<init>", descriptor = "(Lrda;)V", line = 181)
    public class156(class663 arg0) {
        this.field2383 = arg0;
    }

    @OriginalMember(owner = "client!faa", name = "e", descriptor = "(I)I", line = 190)
