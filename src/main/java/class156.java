...
public class class156 extends class506 {
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(Z)Ljava/lang/Object;", line = 5)
    ...
    @OriginalMember(owner = "client!faa", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 14)
    public class156(Object arg0, int arg1) {
        super(arg1);
        this.field1996 = new SoftReference(arg0);
    }

    @OriginalMember(owner = "client!faa", name = "c", descriptor = "(I)Z", line = 23)
