...
public class class156 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IIIIZIFII)[[I", line = 18)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IIBII)Lwp;", line = 49)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "(IIIIIIIIIZ)V", line = 88)
