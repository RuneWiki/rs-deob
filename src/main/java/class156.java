...
public class class156 extends class613 implements class49 {
    ...
    @OriginalMember(owner = "client!ci", name = "d", descriptor = "(Lr;I)Llf;", line = 3)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Lr;Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!ci", name = "c", descriptor = "(B)Z", line = 30)
    ...
    @OriginalMember(owner = "client!ci", name = "b", descriptor = "(B)Z", line = 41)
    ...
    @OriginalMember(owner = "client!ci", name = "e", descriptor = "(B)I", line = 52)
    ...
    @OriginalMember(owner = "client!ci", name = "f", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!ci", name = "c", descriptor = "(Z)I", line = 81)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Lr;III)Z", line = 96)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IILr;)Lda;", line = 118)
    ...
    @OriginalMember(owner = "client!ci", name = "j", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Z)I", line = 158)
    ...
    @OriginalMember(owner = "client!ci", name = "g", descriptor = "(I)I", line = 169)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(BLr;)V", line = 196)
    ...
    @OriginalMember(owner = "client!ci", name = "b", descriptor = "(Lr;I)V", line = 254)
    ...
    @OriginalMember(owner = "client!ci", name = "i", descriptor = "(I)Z", line = 282)
    ...
    @OriginalMember(owner = "client!ci", name = "h", descriptor = "(I)Z", line = 300)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(B)I", line = 311)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Lr;I)V", line = 324)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IIIILrb;Lr;Z)V", line = 353)
    ...
    @OriginalMember(owner = "client!ci", name = "c", descriptor = "(Lr;I)Lwj;", line = 386)
    ...
    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "(Lr;Lqp;IIIIIZIIIIIIZ)V", line = 415)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ZIILr;)Lhi;", line = 452)
    ...
    @OriginalMember(owner = "client!ci", name = "b", descriptor = "(I)I", line = 489)
