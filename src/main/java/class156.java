...
public class class156 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(BI)Llfa;", line = 25)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(BIII)V", line = 49)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(BZLjava/lang/String;Lpe;)Loda;", line = 71)
