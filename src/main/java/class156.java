...
public class class156 implements class294 {
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(ILha;IIILts;)V", line = 16)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Lcr;I)Z", line = 74)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(B)J", line = 120)
