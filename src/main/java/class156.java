...
public class class156 extends class254 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Lfc;ILvm;)I")
    ...
    @OriginalMember(owner = "client!jj", name = "c", descriptor = "(I)Lto;")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ILlo;I)V")
