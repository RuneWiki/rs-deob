...
public class class156 extends class117 implements class463 {
    ...
    @OriginalMember(owner = "client!ec", name = "c", descriptor = "(Z)V", line = 12)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(III)V", line = 30)
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(Lqg;III)V", line = 117)
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(Lqg;IIII)V", line = 132)
    ...
    @OriginalMember(owner = "client!ec", name = "c", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IIII)Z", line = 65)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Z)V", line = 80)
    ...
    @OriginalMember(owner = "client!ec", name = "finalize", descriptor = "()V", line = 94)
