...
public class class156 implements class486 {
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(Lss;I)V")
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(BI)Ltd;")
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(ZI)Lnv;")
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "([[BILnq;)V")
    ...
    @OriginalMember(owner = "client!gw", name = "<init>", descriptor = "(Ljo;Ljo;Ljo;)V")
