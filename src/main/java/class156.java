...
public class class156 extends class308 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ILii;)V", line = 4)
    ...
    @OriginalMember(owner = "client!jj", name = "b", descriptor = "(Lii;I)Leb;", line = 15)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Lnj;ZI)Ljava/lang/String;", line = 55)
    ...
    @OriginalMember(owner = "client!jj", name = "b", descriptor = "(II)Z", line = 89)
    ...
    @OriginalMember(owner = "client!jj", name = "c", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!jj", name = "c", descriptor = "(I)V", line = 135)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IIZLii;)Z", line = 153)
