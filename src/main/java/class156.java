...
public class class156 {
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IBIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(II)Lak;", line = 24)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ZZ)V", line = 144)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(B)V", line = 159)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(BZ)V", line = 176)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(BI)V", line = 245)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(I)V", line = 265)
    ...
    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(I)V", line = 281)
    ...
    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(B)V", line = 292)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "([Lec;ZIIII)V", line = 318)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IIZI)V", line = 365)
    ...
    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(II)V", line = 376)
    ...
    @OriginalMember(owner = "client!ck", name = "c", descriptor = "(I)V", line = 393)
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Lwv;IZLqs;Lqs;)V", line = 437)
