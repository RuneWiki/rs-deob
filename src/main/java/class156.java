...
public class class156 {
    ...
    public static final void method1047(int[] arg0, int arg1, int arg2, int arg3) {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "([BI[BII)V")
    public static final void method1048(byte[] arg0, int arg1, byte[] arg2, int arg3, int arg4) {
        if (arg0 == arg2) {
            if (arg1 == arg3) {
                return;
            }
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "([II[III)V")
