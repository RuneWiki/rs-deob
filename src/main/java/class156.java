...
public class class156 {
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(III)Z", line = 7)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!pca", name = "b", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(IILoq;)V", line = 48)
    ...
    @OriginalMember(owner = "client!pca", name = "<init>", descriptor = "(Lpj;Lvda;Lvha;IIIII)V", line = 247)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(B)V", line = 72)
