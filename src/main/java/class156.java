...
public class class156 extends class424 {
    ...
    @OriginalMember(owner = "client!mk", name = "g", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(IB)[I", line = 14)
    ...
    @OriginalMember(owner = "client!mk", name = "c", descriptor = "(III)I", line = 275)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IZ)[[I", line = 313)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(BIIII)V", line = 623)
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "()V", line = 643)
    public class156() {
        super(2, false);
    }

    @OriginalMember(owner = "client!mk", name = "a", descriptor = "([Ljava/lang/Object;[IB)V", line = 650)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Lrg;BI)V", line = 661)
