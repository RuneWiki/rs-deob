...
public class class156 extends class530 {
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(Lah;)V", line = 3)
    public class156(class374 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(ILah;)V", line = 17)
    public class156(int arg0, class374 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(II)I", line = 20)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(II)V", line = 55)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ZI)V", line = 68)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Z)V", line = 107)
    ...
    @OriginalMember(owner = "client!ia", name = "c", descriptor = "(Z)Z", line = 128)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(I)I", line = 146)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(I)I", line = 158)
