...
public class class156 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IJLon;)V", line = 3)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IIIIZI)V", line = 26)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(JI)Lon;", line = 209)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(I)I", line = 240)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "([Lon;Z)I", line = 258)
    ...
    @OriginalMember(owner = "client!jj", name = "b", descriptor = "(I)Lon;", line = 289)
    ...
    @OriginalMember(owner = "client!jj", name = "c", descriptor = "(I)V", line = 304)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(B)Lon;", line = 316)
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(I)V", line = 348)
    ...
    @OriginalMember(owner = "client!jj", name = "d", descriptor = "(I)I", line = 370)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IJZIZIILjava/lang/String;ZLjava/lang/String;I)V", line = 406)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IBLmb;IIIII)V", line = 471)
    ...
    @OriginalMember(owner = "client!jj", name = "e", descriptor = "(I)V", line = 555)
    ...
    @OriginalMember(owner = "client!jj", name = "f", descriptor = "(I)Lon;", line = 592)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IIIIB)V", line = 625)
