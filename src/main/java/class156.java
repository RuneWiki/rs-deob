...
public class class156 extends class522 {
    ...
    @OriginalMember(owner = "client!ib", name = "c", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(III)V", line = 20)
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(III)V", line = 44)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ZII)V", line = 65)
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(IIIIIII)V", line = 84)
