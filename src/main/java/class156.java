...
public class class156 extends class263 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(ZB)V", line = 4)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(III)V", line = 56)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(I)Z", line = 92)
    public final boolean method675(int arg0) {
        ++field2459;
        return arg0 > -112 ? true : this.field2461;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lce;IZ)V", line = 103)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IZ)V", line = 130)
    ...
    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "(Lbl;Lmt;)V", line = 149)
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(I)V", line = 169)
