...
public class class156 extends class13 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIIII)I", line = 7)
    ...
    @OriginalMember(owner = "client!sm", name = "b", descriptor = "(II)V", line = 20)
    ...
    @OriginalMember(owner = "client!sm", name = "c", descriptor = "(II)[I", line = 34)
    ...
    @OriginalMember(owner = "client!sm", name = "d", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "()V", line = 104)
    public class156() {
        super(1, true);
    }

    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lkh;BI)V", line = 107)
    ...
    @OriginalMember(owner = "client!sm", name = "e", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!sm", name = "f", descriptor = "(I)Z", line = 167)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ZI)[I", line = 218)
    ...
    @OriginalMember(owner = "client!sm", name = "g", descriptor = "(I)V", line = 260)
    ...
    @OriginalMember(owner = "client!sm", name = "c", descriptor = "(I)V", line = 443)
    ...
    @OriginalMember(owner = "client!sm", name = "h", descriptor = "(I)V", line = 465)
