...
public class class156 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(II)Lpca;")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ILoa;)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ZIIIILoa;Z)Lba;")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Loa;Lq;IILba;IIBZ)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(BLoa;)V")
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(Loa;Luca;IIIIIIZI)V")
