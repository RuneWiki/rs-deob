...
public class class156 extends class54 {
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(IBIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(I)V", line = 446)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(IIIIIIILmea;ILja;II)V", line = 462)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(IIIII)V", line = 489)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(IBI)Z", line = 508)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(Z)V", line = 528)
    ...
    @OriginalMember(owner = "client!cda", name = "c", descriptor = "(I)V", line = 628)
    ...
    @OriginalMember(owner = "client!cda", name = "<init>", descriptor = "(Ler;II)V", line = 664)
