...
public class class156 extends class504 {
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(Leh;B)Lmaa;", line = 31)
    ...
    @OriginalMember(owner = "client!cfa", name = "b", descriptor = "(I)V", line = 46)
