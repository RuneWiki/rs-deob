...
public class class156 implements class746 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Lbca;IIB)V")
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IIILod;I)V")
    ...
    @OriginalMember(owner = "client!ct", name = "i", descriptor = "(I)Lco;")
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IILbca;)V")
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IIILod;)V")
    ...
    @OriginalMember(owner = "client!ct", name = "e", descriptor = "(I)[Lel;")
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IBLvq;)V")
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IILcn;I)V")
    ...
    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "(Lffa;)V")
