...
public class class156 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IZI)B", line = 22)
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Llq;III)V", line = 54)
