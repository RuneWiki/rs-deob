...
public class class156 {
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(ILoh;)V")
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(IB)Loaa;")
    ...
    @OriginalMember(owner = "client!wea", name = "<init>", descriptor = "(Lnb;ILoh;)V")
