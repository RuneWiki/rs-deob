...
public class class285 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Lvh;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(I)V", line = 328)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(B)V", line = 338)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IIBIIIIII)V", line = 375)
