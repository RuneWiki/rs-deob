...
public class class285 extends class40 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(BI)[I", line = 5)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IILlf;)V", line = 75)
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "()V", line = 151)
    public class285() {
        super(0, true);
    }

    @OriginalMember(owner = "client!kp", name = "c", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(Z)Z", line = 158)
    ...
    @OriginalMember(owner = "client!kp", name = "g", descriptor = "(B)V", line = 216)
