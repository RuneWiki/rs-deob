...
public class class285 extends Canvas {
    ...
    @OriginalMember(owner = "client!im", name = "update", descriptor = "(Ljava/awt/Graphics;)V")
    public final void update(Graphics arg0) {
        this.field3629.update(arg0);
        field3630++;
    }

    @OriginalMember(owner = "client!im", name = "paint", descriptor = "(Ljava/awt/Graphics;)V")
    public final void paint(Graphics arg0) {
        field3632++;
        this.field3629.paint(arg0);
    }

    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(Ljava/awt/Component;)V")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(ILqa;Ldn;Ldn;)V")
