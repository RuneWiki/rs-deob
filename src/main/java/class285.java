...
public class class285 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(B)Lgga;")
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(B)Lgga;")
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Lgga;B)V")
    ...
    @OriginalMember(owner = "client!ca", name = "c", descriptor = "(B)Lgga;")
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Z)Lgga;")
