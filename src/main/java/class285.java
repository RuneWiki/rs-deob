...
public class class285 extends class566 implements class361 {
    ...
    @OriginalMember(owner = "client!tfa", name = "b", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;", line = 4)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(Ltha;B)V", line = 16)
    ...
    @OriginalMember(owner = "client!tfa", name = "<init>", descriptor = "(Lkfa;Liv;III[B)V", line = 36)
