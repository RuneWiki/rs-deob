...
public class class285 {
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(BLtl;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(ILtl;)V", line = 100)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IB)V", line = 172)
