...
public class class285 extends class116 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ZLya;I)Lt;")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lga;Ljava/awt/Canvas;BLdr;I)Lya;")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lya;IZLij;III)V")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ZILya;I)Z")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lya;BLt;)V")
    ...
    @OriginalMember(owner = "client!lg", name = "c", descriptor = "(ILya;)V")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lya;B)Lmf;")
