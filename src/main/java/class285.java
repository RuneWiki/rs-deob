...
public class class285 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(B)Lkp;")
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(I)Lkp;")
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ILvp;)V")
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(Lvp;)V")
