...
public class class285 implements class212 {
    ...
    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(II)Ltf;")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(II)Lau;")
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Lsea;Lsea;Lsea;)V")
