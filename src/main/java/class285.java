...
public abstract class class285 {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(II)V", line = 3)
    public final void method1915(int arg0, int arg1) {
        this.method927(arg0, arg1, 0, 0, 1);
    }

    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(FFIILtm;II)V", line = 13)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(FFIIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(FFFFIILtm;II)V", line = 22)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IIII)V", line = 51)
    public final void method1919(int arg0, int arg1, int arg2, int arg3) {
        this.method929(arg0, arg1, arg2, arg3, 0, 0, 1);
    }

    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(FFFFIIIII)V", line = 58)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(FFII)V", line = 82)
