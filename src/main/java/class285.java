...
public class class285 {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Z)Leea;")
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Lwba;I)Ld;")
    ...
    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(Ljn;Ljn;)V")
