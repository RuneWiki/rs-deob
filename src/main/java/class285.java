...
public class class285 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Lqa;[II[I[I)V")
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Lqa;[IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Lqa;[II)V")
