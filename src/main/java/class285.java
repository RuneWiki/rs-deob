...
public class class285 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IIILr;)V")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ILha;IIIII)Lka;")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lr;III)V")
    ...
    @OriginalMember(owner = "client!f", name = "<init>", descriptor = "(Lpq;Lbda;)V")
    ...
    @OriginalMember(owner = "client!f", name = "b", descriptor = "(Lr;III)Z")
