...
public class class285 {
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(I)Lfl;", line = 17)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(II)Lol;", line = 43)
    ...
    @OriginalMember(owner = "client!ol", name = "<init>", descriptor = "(II)V", line = 53)
