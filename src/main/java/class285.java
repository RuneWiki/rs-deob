...
public class class285 {
    ...
    @OriginalMember(owner = "client!wha", name = "toString", descriptor = "()Ljava/lang/String;", line = 9)
    public final String toString() {
        field3583++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!wha", name = "<init>", descriptor = "(I)V", line = 58)
