...
public class class285 extends class276 {
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(III)I", line = 8)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(ZII[BI[BIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(JILjava/lang/String;Z)V", line = 85)
    ...
    @OriginalMember(owner = "client!bv", name = "b", descriptor = "(B)V", line = 154)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(IC)C", line = 167)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(I)V", line = 573)
