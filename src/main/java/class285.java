...
public class class285 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(II)I", line = 16)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(ZLvv;IZILvv;I)I", line = 34)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(IBII[B[BIII)V", line = 80)
