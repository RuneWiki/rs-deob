...
public class class285 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IIII)I", line = 3)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(II)Lsp;", line = 24)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Ljp;IIIII)Lmd;", line = 66)
    ...
    @OriginalMember(owner = "client!nn", name = "b", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!nn", name = "b", descriptor = "(II)V", line = 114)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(III[BIII)V", line = 127)
    ...
    @OriginalMember(owner = "client!nn", name = "c", descriptor = "(I)V", line = 226)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(BII)I", line = 239)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(B)V", line = 256)
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(Llf;ILvh;)V", line = 276)
