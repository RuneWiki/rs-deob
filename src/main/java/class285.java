...
public class class285 {
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(ZI)I", line = 3)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 45)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(B)V", line = 81)
