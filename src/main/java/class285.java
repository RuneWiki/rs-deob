...
public class class285 extends class529 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Lbk;II)V")
    ...
    @OriginalMember(owner = "client!sn", name = "d", descriptor = "()Lnj;")
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "()Lnj;")
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IILbk;I[II)V")
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(Lrda;)V")
