...
public class class285 extends class57 implements class149 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Le;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!jb", name = "b", descriptor = "(Le;B)V", line = 19)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!jb", name = "f", descriptor = "(I)I", line = 46)
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Le;Lfa;IIIIIIIZIIIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ILe;IIZLhm;I)V", line = 67)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Z)I", line = 80)
    ...
    @OriginalMember(owner = "client!jb", name = "b", descriptor = "(B)Z", line = 91)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IIILe;)Z", line = 104)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Le;I)V", line = 121)
    ...
    @OriginalMember(owner = "client!jb", name = "b", descriptor = "(I)I", line = 136)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "([[BLlf;[[I[[BII[[B[[BIIZLe;Llf;)V", line = 148)
    ...
    @OriginalMember(owner = "client!jb", name = "c", descriptor = "(I)Z", line = 959)
    public final boolean method186(int arg0) {
        ++field4577;
        return arg0 != 0 ? false : false;
    }

    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Le;IB)Lid;", line = 970)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Le;Z)Lum;", line = 982)
    ...
    @OriginalMember(owner = "client!jb", name = "d", descriptor = "(I)V", line = 1019)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(B)I", line = 1031)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lne;IZ)I", line = 1041)
    ...
    @OriginalMember(owner = "client!jb", name = "e", descriptor = "(B)V", line = 1249)
