...
public class class285 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IB)V", line = 56)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "(I)V", line = 139)
    public class285(int arg0) {
        this.field4443 = arg0;
    }

    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "(IIIIII)V", line = 148)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Lcf;B)V", line = 100)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Z)Lcf;", line = 115)
    ...
    @OriginalMember(owner = "client!cf", name = "b", descriptor = "(I)V", line = 129)
