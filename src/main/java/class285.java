...
public class class285 {
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(IIIIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Z)Z", line = 35)
