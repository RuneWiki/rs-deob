...
public class class285 extends class270 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(BLec;I)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ZILbc;)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ILqa;Lrr;Lja;IB)Z")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ZLmb;)Lmb;")
    ...
    @OriginalMember(owner = "client!io", name = "f", descriptor = "(B)V")
