...
public class class285 extends class509 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "([[BLvc;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(I)Z", line = 86)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(II)Lvv;", line = 100)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IZ)V", line = 125)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ZILmn;)V", line = 140)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ZB)V", line = 155)
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(Lkw;)V", line = 197)
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(B)V", line = 308)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IBI)V", line = 356)
    ...
    @OriginalMember(owner = "client!ac", name = "e", descriptor = "(I)Z", line = 374)
