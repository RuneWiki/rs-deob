...
public class class285 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(BLvp;)Lvp;", line = 8)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(ILkda;B)Llg;", line = 26)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(BII)I", line = 80)
