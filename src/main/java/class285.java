...
public class class285 {
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "([[BILwq;)V")
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(BLiia;I)Z")
    ...
    @OriginalMember(owner = "client!uu", name = "<init>", descriptor = "(Loea;)V")
