...
public abstract class class285 extends class11 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "()I", line = 10)
    public final int method52() {
        return this.field4002 + this.field3999 + this.field4008;
    }

    @OriginalMember(owner = "client!np", name = "a", descriptor = "(FFFFFFIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!np", name = "c", descriptor = "()I", line = 108)
    public final int method47() {
        return this.field3996 + this.field3987 + this.field4012;
    }

    @OriginalMember(owner = "client!np", name = "a", descriptor = "(FFFFFFLhm;II)V", line = 138)
    ...
    @OriginalMember(owner = "client!np", name = "d", descriptor = "()I", line = 147)
    public final int method51() {
        return this.field3999;
    }

    @OriginalMember(owner = "client!np", name = "a", descriptor = "(IIII)V", line = 150)
    ...
    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "(Ls;II)V", line = 155)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(IIIIIII)V", line = 164)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "()I", line = 203)
    public final int method49() {
        return this.field3996;
    }

    @OriginalMember(owner = "client!np", name = "a", descriptor = "(FFFFFF)V", line = 216)
