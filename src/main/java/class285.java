...
public class class285 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lae;I)V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IIILrl;II)Loc;")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lae;BI)V")
