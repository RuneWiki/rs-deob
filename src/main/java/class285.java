...
public class class285 {
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(II)Lbda;", line = 16)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!ce", name = "<init>", descriptor = "(ILbi;Lbi;)V", line = 72)
