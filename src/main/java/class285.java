...
public class class285 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(ILgba;)Lba;", line = 6)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(II)V", line = 17)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(I[IIII)V", line = 40)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Ljm;I)Z", line = 69)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(I)V", line = 85)
