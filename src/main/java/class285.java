...
public class class285 extends class65 {
    ...
    @OriginalMember(owner = "client!qaa", name = "c", descriptor = "(II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!qaa", name = "b", descriptor = "(I)I", line = 28)
    public final int method1866(int arg0) {
        field4383++;
        return arg0 == 1092 ? class140.method1096(this.field4391, 260351) : -54;
    }

    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(B)Z", line = 39)
    ...
    @OriginalMember(owner = "client!qaa", name = "e", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!qaa", name = "c", descriptor = "(I)I", line = 64)
    ...
    @OriginalMember(owner = "client!qaa", name = "f", descriptor = "(I)Z", line = 91)
    ...
    @OriginalMember(owner = "client!qaa", name = "g", descriptor = "(I)Z", line = 102)
    ...
    @OriginalMember(owner = "client!qaa", name = "<init>", descriptor = "(II)V", line = 145)
