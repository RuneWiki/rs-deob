...
public class class285 extends class81 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Ldg;I)Ls;", line = 4)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(II)Lro;", line = 30)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(B)V", line = 76)
