...
public class class285 extends class156 {
    ...
    @OriginalMember(owner = "client!fr", name = "c", descriptor = "(II)I", line = 19)
    ...
    @OriginalMember(owner = "client!fr", name = "c", descriptor = "(I)Lnn;", line = 36)
    ...
    @OriginalMember(owner = "client!fr", name = "d", descriptor = "(II)Z", line = 86)
    public final boolean method1783(int arg0, int arg1) {
        ++field4294;
        return ~arg1 == arg0 && !this.field4295 ? super.field2556 : true;
    }

    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "(Llt;)V", line = 445)
    ...
    @OriginalMember(owner = "client!fr", name = "e", descriptor = "(II)Z", line = 105)
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(IZI)Z", line = 120)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lnn;I)V", line = 134)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(BLlt;)V", line = 402)
