...
public class class285 extends class559 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Lgb;B)I")
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Lbt;I)I")
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Lkp;ZZ)V")
