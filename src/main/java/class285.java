...
public class class285 extends class194 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lqj;ILqj;)V")
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(BI)Ldq;")
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IBLsh;)V")
