...
public class class285 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "()Lig;")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Llm;II)Lio;")
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Lnj;)V")
