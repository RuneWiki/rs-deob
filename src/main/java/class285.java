...
public class class285 extends class316 {
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(II)Lne;")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(BLmda;)V")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(ILso;)V")
