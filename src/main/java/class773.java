...
public class class773 extends class67 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(CIIIZLaa;II)V", line = 5)
    public final void method30(char arg0, int arg1, int arg2, int arg3, boolean arg4, class510 arg5, int arg6, int arg7) {
    }

    @OriginalMember(owner = "client!qc", name = "fa", descriptor = "(CIIIZ)V", line = 9)
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Lwk;Lkf;[Lre;Z)V", line = 33)
