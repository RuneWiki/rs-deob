...
public class class773 extends class399 implements class484 {
    ...
    @OriginalMember(owner = "client!hd", name = "d", descriptor = "(Z)Z", line = 17)
    ...
    @OriginalMember(owner = "client!hd", name = "g", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lha;I)Lmaa;", line = 52)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(B)Z", line = 79)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(B)I", line = 89)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IIBIIIIIII)V", line = 101)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(ILha;)V", line = 143)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(Lha;I)Lrn;", line = 170)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(I)I", line = 185)
    ...
    @OriginalMember(owner = "client!hd", name = "c", descriptor = "(Z)Z", line = 198)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Z)I", line = 210)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(ZLje;IIILha;I)V", line = 222)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(BLha;)V", line = 241)
    ...
    @OriginalMember(owner = "client!hd", name = "c", descriptor = "(ILha;)V", line = 272)
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "(Lha;Lkv;IIIIIZIZ)V", line = 282)
    ...
    @OriginalMember(owner = "client!hd", name = "e", descriptor = "(I)I", line = 315)
    ...
    @OriginalMember(owner = "client!hd", name = "f", descriptor = "(I)Z", line = 326)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(ILha;I)Lka;", line = 345)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lha;IZZ)Lbaa;", line = 367)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lha;Lmea;I)V", line = 395)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(Z)I", line = 418)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IIILha;)Z", line = 430)
