...
public class class773 extends class175 {
    ...
    @OriginalMember(owner = "client!qc", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "()V", line = 15)
    public class773() {
        super(1, false);
    }

    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lofa;ILofa;)V", line = 18)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ILuq;)V", line = 38)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IB)[[I", line = 57)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ILdt;Z)V", line = 156)
