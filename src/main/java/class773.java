...
public class class773 extends class123 {
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(IILmja;)V")
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(IBLmja;[III)V")
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "()Lri;")
    ...
    @OriginalMember(owner = "client!oha", name = "d", descriptor = "()Lri;")
    ...
    @OriginalMember(owner = "client!oha", name = "<init>", descriptor = "(Lpt;)V")
