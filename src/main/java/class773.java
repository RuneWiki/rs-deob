...
public class class773 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(II)Leh;", line = 8)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IC)Z", line = 35)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ZB)V", line = 54)
