...
public class class773 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lor;II)I")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(II)Lnv;")
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(II)Llda;")
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "(Lgia;ILaj;Laj;)V")
