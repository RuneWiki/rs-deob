...
public class class103 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(BI)Lpm;", line = 65)
    ...
    @OriginalMember(owner = "client!pm", name = "<init>", descriptor = "(IIII)V", line = 81)
