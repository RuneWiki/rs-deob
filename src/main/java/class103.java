...
public class class103 {
    ...
    @OriginalMember(owner = "client!l", name = "o", descriptor = "Lph;")
    ...
    @OriginalMember(owner = "client!l", name = "f", descriptor = "Loh;")
    public static class138 field2030;

    @OriginalMember(owner = "client!l", name = "g", descriptor = "Lte;")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(BLph;)V")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(ILph;)V")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(II)Llf;")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(B)Lph;")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(B[Llf;)[Llf;")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Llf;IZ)V")
