...
public class class103 extends class296 {
    ...
    @OriginalMember(owner = "client!sd", name = "g", descriptor = "(II)Loda;", line = 4)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ZII[FLeu;III)Lwp;", line = 48)
    ...
    @OriginalMember(owner = "client!sd", name = "k", descriptor = "(II)V", line = 58)
    ...
    @OriginalMember(owner = "client!sd", name = "f", descriptor = "()V", line = 69)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Lrt;IIZ)V", line = 106)
    ...
    @OriginalMember(owner = "client!sd", name = "w", descriptor = "(B)V", line = 139)
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "()Z", line = 150)
    public final boolean method547() {
        return false;
    }

    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Ldea;I)I", line = 157)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(FFF)V", line = 189)
    public final void method497(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ZIIIILeu;[BI)Lwp;", line = 192)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(BLrt;)I", line = 212)
    ...
    @OriginalMember(owner = "client!sd", name = "A", descriptor = "(B)V", line = 235)
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(II)Lnq;", line = 245)
    public final class485 method478(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(ZI)Lsfa;", line = 252)
    ...
    @OriginalMember(owner = "client!sd", name = "h", descriptor = "(Z)V", line = 262)
    ...
    @OriginalMember(owner = "client!sd", name = "q", descriptor = "(I)V", line = 272)
    ...
    @OriginalMember(owner = "client!sd", name = "q", descriptor = "()V", line = 282)
    public final void method591() {
    }

    @OriginalMember(owner = "client!sd", name = "k", descriptor = "(Z)V", line = 287)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(BLli;)I", line = 324)
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/bw;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Lq;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Ld;Lla;I)V", line = 338)
    ...
    @OriginalMember(owner = "client!sd", name = "na", descriptor = "(IIII)[I", line = 386)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Lpj;Leu;I)Z", line = 426)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ILsfa;Z)V", line = 439)
    ...
    @OriginalMember(owner = "client!sd", name = "p", descriptor = "(Z)V", line = 451)
    ...
    @OriginalMember(owner = "client!sd", name = "I", descriptor = "()I", line = 463)
    public final int method546() {
        return 0;
    }

    @OriginalMember(owner = "client!sd", name = "d", descriptor = "(II)V", line = 472)
    ...
    @OriginalMember(owner = "client!sd", name = "M", descriptor = "(I)V", line = 497)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ILjagdx/IDirect3DVertexShader;)V", line = 507)
    ...
    @OriginalMember(owner = "client!sd", name = "GA", descriptor = "(I)V", line = 519)
    public final void method483(int arg0) {
        this.field1151.Clear(1, arg0, 0.0F, 0);
    }

    @OriginalMember(owner = "client!sd", name = "B", descriptor = "(B)V", line = 528)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Leu;BLpj;)Z", line = 564)
    ...
    @OriginalMember(owner = "client!sd", name = "l", descriptor = "(B)V", line = 576)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ILgk;)V", line = 588)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Lpj;Leu;B)I", line = 613)
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(IIIID)V", line = 649)
    public final void method582(int arg0, int arg1, int arg2, int arg3, double arg4) {
    }

    @OriginalMember(owner = "client!sd", name = "q", descriptor = "(B)V", line = 652)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ILeu;ILpj;I)Lwp;", line = 661)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(II[BIILeu;)Loea;", line = 671)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ZLgn;)V", line = 682)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ZB)V", line = 695)
    ...
    @OriginalMember(owner = "client!sd", name = "J", descriptor = "(I)V", line = 708)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ZLup;)I", line = 726)
    ...
    @OriginalMember(owner = "client!sd", name = "d", descriptor = "(B)V", line = 756)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "([Laia;B)Lgn;", line = 786)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Lbda;I)I", line = 797)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ILjava/awt/Canvas;)Ljava/lang/Object;", line = 829)
    ...
    @OriginalMember(owner = "client!sd", name = "u", descriptor = "(B)V", line = 840)
    ...
    @OriginalMember(owner = "client!sd", name = "A", descriptor = "()V", line = 876)
    public final void method501() {
    }

    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ILje;IILdea;IB)V", line = 881)
    ...
    @OriginalMember(owner = "client!sd", name = "m", descriptor = "(I)V", line = 899)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ILbr;)V", line = 917)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Ljagdx/IDirect3DPixelShader;I)V", line = 958)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ILjava/awt/Canvas;Ljava/lang/Object;)V", line = 970)
    ...
    @OriginalMember(owner = "client!sd", name = "i", descriptor = "(Z)V", line = 995)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "()V", line = 1007)
    public final void method470() {
        this.field1165.method5126(17);
        super.method470();
    }

    @OriginalMember(owner = "client!sd", name = "x", descriptor = "()Lmi;", line = 1016)
    ...
    @OriginalMember(owner = "client!sd", name = "H", descriptor = "(I)V", line = 1026)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Ljava/lang/Object;ILjava/awt/Canvas;)V", line = 1039)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Lol;Lol;FLol;)Lol;", line = 1048)
    public final class299 method485(class299 arg0, class299 arg1, float arg2, class299 arg3) {
        return arg2 < 0.5F ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!sd", name = "E", descriptor = "(B)F", line = 1055)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Lgea;)V", line = 1064)
    public final void method592(class82 arg0) {
    }

    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Ldda;I)V", line = 1067)
    ...
    @OriginalMember(owner = "client!sd", name = "x", descriptor = "(B)V", line = 1091)
    ...
    @OriginalMember(owner = "client!sd", name = "Q", descriptor = "(I)V", line = 1102)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ZIZILrt;)V", line = 1118)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ZIII[III)Lwp;", line = 1165)
    ...
    @OriginalMember(owner = "client!sd", name = "e", descriptor = "(B)V", line = 1175)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(BLdea;II)V", line = 1189)
    ...
    @OriginalMember(owner = "client!sd", name = "g", descriptor = "(Z)V", line = 1202)
    ...
    @OriginalMember(owner = "client!sd", name = "ya", descriptor = "()V", line = 1239)
    public final void method586() {
        this.method2473((byte) -121, true);
        this.field1151.Clear(2, 0, 1.0F, 0);
    }

    @OriginalMember(owner = "client!sd", name = "F", descriptor = "(II)V", line = 1246)
    public final void method549(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Ljava/awt/Canvas;Ljava/lang/Object;I)V", line = 1249)
    ...
    @OriginalMember(owner = "client!sd", name = "y", descriptor = "()Z", line = 1259)
    public final boolean method566() {
        return false;
    }

    @OriginalMember(owner = "client!sd", name = "v", descriptor = "(B)V", line = 1266)
    ...
    @OriginalMember(owner = "client!sd", name = "h", descriptor = "()V", line = 1276)
    public final void method484() {
    }

    @OriginalMember(owner = "client!sd", name = "D", descriptor = "(I)Z", line = 1280)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Ljh;I)V", line = 1319)
    ...
    @OriginalMember(owner = "client!sd", name = "g", descriptor = "(B)V", line = 1347)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Z)V", line = 1375)
    public final void method554(boolean arg0) {
    }

    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(IZ)Lje;", line = 1379)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(II)Lrk;", line = 1392)
    public final class35 method486(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IBILjagdx/D3DPRESENT_PARAMETERS;ILjagdx/IDirect3D;)Z", line = 1404)
    ...
    @OriginalMember(owner = "client!sd", name = "n", descriptor = "(Z)V", line = 1507)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIII)V", line = 1518)
    public final void method550(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!sd", name = "d", descriptor = "(I)V", line = 1523)
    ...
    @OriginalMember(owner = "client!sd", name = "h", descriptor = "(B)V", line = 1536)
    ...
    @OriginalMember(owner = "client!sd", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Ld;Lla;Ljava/lang/Integer;)Lha;", line = 1546)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 1649)
    public final void method504(Rectangle[] arg0, int arg1, int arg2, int arg3) throws class382 {
        this.method513(arg2, arg3);
    }

    @OriginalMember(owner = "client!sd", name = "a", descriptor = "([[IIZI)Lrr;", line = 1657)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Lnq;Lrk;)Lgea;", line = 1667)
    public final class82 method507(class485 arg0, class35 arg1) {
        return null;
    }

    @OriginalMember(owner = "client!sd", name = "p", descriptor = "()V", line = 1673)
    public final void method575() {
    }

    @OriginalMember(owner = "client!sd", name = "w", descriptor = "(I)V", line = 1676)
    ...
    @OriginalMember(owner = "client!sd", name = "l", descriptor = "(Z)V", line = 1697)
