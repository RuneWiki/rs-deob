...
public class class103 extends class54 {
    ...
    @OriginalMember(owner = "client!ge", name = "c", descriptor = "(Lve;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lfs;[I)V")
    public final void method270(class349 arg0, int[] arg1) {
        this.field1234.method825(85, new class76(this.field1240, this, arg0, arg1));
    }

    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(Lql;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(Lve;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lac;II)V")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lve;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IILve;)Lve;")
