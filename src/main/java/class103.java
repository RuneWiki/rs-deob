...
public class class103 implements Runnable {
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(Ljava/lang/String;B)Lsk;")
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(ILkd;)V")
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(Lqf;II)V")
