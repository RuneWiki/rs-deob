...
public class class103 extends class96 {
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IIIII)I", line = 7)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "([II)Ljava/lang/String;", line = 65)
    ...
    @OriginalMember(owner = "client!kt", name = "e", descriptor = "(B)Z", line = 112)
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(II)Z", line = 209)
    ...
    @OriginalMember(owner = "client!kt", name = "c", descriptor = "(II)Z", line = 230)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IIBI)I", line = 241)
    ...
    @OriginalMember(owner = "client!kt", name = "d", descriptor = "(II)Z", line = 269)
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(I)V", line = 281)
    public class103(int arg0) {
        this.field1384 = arg0;
    }

    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 289)
