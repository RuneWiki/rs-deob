...
public class class103 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IZILkv;Lkv;)Lrt;", line = 10)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ILkv;ILkv;)Lrt;", line = 54)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(III)Z", line = 66)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(BLmfa;I)V", line = 79)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(B)Z", line = 109)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Z)V", line = 192)
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "(Lth;Lqw;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", line = 231)
