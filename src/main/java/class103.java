...
public class class103 extends class585 {
    ...
    @OriginalMember(owner = "client!ps", name = "c", descriptor = "(I)[Ljb;", line = 3)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ZI)[[I", line = 14)
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(III)Lmb;", line = 92)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Lso;II)V", line = 112)
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(II)[I", line = 125)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "()V", line = 185)
    public class103() {
        super(3, false);
    }

    @OriginalMember(owner = "client!ps", name = "d", descriptor = "(I)V", line = 195)
