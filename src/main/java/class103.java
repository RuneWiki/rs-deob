...
public class class103 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Luga;I)Z")
    ...
    @OriginalMember(owner = "client!hk", name = "b", descriptor = "(Luga;I)V")
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ILao;I)V")
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "(Lwh;)V")
