...
public class class103 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(I)Z", line = 11)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(IJ)V", line = 22)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(BILhm;I)V", line = 37)
    ...
    @OriginalMember(owner = "client!mg", name = "toString", descriptor = "()Ljava/lang/String;", line = 50)
    public final String toString() {
        field1362++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!mg", name = "b", descriptor = "(I)I", line = 59)
    ...
    @OriginalMember(owner = "client!mg", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 70)
