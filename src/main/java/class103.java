...
public class class103 extends class120 implements class143 {
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Lvq;IIB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(ILvq;B)Lni;", line = 34)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(I)I", line = 54)
    public final int method599(int arg0) {
        ++field1310;
        return arg0 != -10450 ? 69 : 65535 & this.field1312;
    }

    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 85)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(B)I", line = 149)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(B)I", line = 161)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Lvq;I)V", line = 174)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Lvq;B)V", line = 201)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(ILvq;)V", line = 214)
    ...
    @OriginalMember(owner = "client!kk", name = "e", descriptor = "(I)V", line = 244)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(ZLvq;IB)Lsl;", line = 279)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Z)Z", line = 311)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(Lvq;Lbi;IIIIZIIZ)V", line = 326)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(BLvq;)Lbf;", line = 361)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(II)Z", line = 387)
    ...
    @OriginalMember(owner = "client!kk", name = "d", descriptor = "(I)Z", line = 447)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Lvq;ZLkm;IIBI)V", line = 459)
    ...
    @OriginalMember(owner = "client!kk", name = "c", descriptor = "(Z)V", line = 490)
    ...
    @OriginalMember(owner = "client!kk", name = "c", descriptor = "(B)V", line = 544)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IILvq;)Lni;", line = 569)
