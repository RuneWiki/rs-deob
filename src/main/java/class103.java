...
public class class103 extends class417 {
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(I[[ZIBI)V", line = 5)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(IS)V", line = 65)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(IIIBIII)V", line = 177)
    ...
    @OriginalMember(owner = "client!laa", name = "<init>", descriptor = "(Lcb;Lih;Lnm;[I)V", line = 369)
