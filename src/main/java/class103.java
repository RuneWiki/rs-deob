...
public class class103 extends class329 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Lfa;Ljava/awt/Canvas;IBLpl;)Lr;", line = 17)
    ...
    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "()V", line = 54)
    public class103() {
    }

    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 56)
