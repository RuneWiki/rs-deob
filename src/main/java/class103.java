...
public class class103 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Lla;)V")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IB)Ljj;")
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(IILjg;)V")
