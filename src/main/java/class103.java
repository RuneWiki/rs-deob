...
public class class103 extends class471 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Lwm;B)V")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Lgn;Lwm;Z)V")
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(Lwm;B)Lnf;")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(ILwm;Z)Lgn;")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IIILwm;ZLhp;Z)V")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IIBLwm;)Z")
