...
public class class103 {
    ...
    @OriginalMember(owner = "client!ho", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field1395++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(Z)I", line = 16)
    public final int method625(boolean arg0) {
        field1393++;
        return arg0 ? -88 : this.field1397;
    }

    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(I[Ljava/lang/String;II)Ljava/lang/String;", line = 29)
    ...
    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(II)V", line = 93)
