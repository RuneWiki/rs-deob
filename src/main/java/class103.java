...
public class class103 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lnr;IILqr;IIB)Lqc;")
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lqr;IBIIIIILnr;I)Lqc;")
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IIIILnr;Lqr;IBI[Lp;Lqr;IZ)Lqc;")
