...
public class class103 {
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(I)[[[I", line = 3)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IIILdn;IIZ)V", line = 28)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(III)I", line = 51)
    ...
    @OriginalMember(owner = "client!st", name = "b", descriptor = "(I)V", line = 68)
    public static void method691(int arg0) {
        int var1 = 0 % ((-arg0 - 32) / 61);
        field1421 = null;
    }

    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "(III)V", line = 216)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(ILdn;)V", line = 124)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(II)[[I", line = 140)
