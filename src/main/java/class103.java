...
public class class103 extends class436 {
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IILeb;)V", line = 9)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "()V", line = 44)
    public class103() {
        super(1, true);
    }

    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Ljava/lang/String;Lrg;IBILdi;Lrj;IIIILtm;)V", line = 47)
    ...
    @OriginalMember(owner = "client!kk", name = "f", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(II)[I", line = 106)
