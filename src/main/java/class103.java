...
public class class103 extends class55 {
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IB)V", line = 20)
    ...
    @OriginalMember(owner = "client!eda", name = "c", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Z[S[Ljava/lang/String;)V", line = 53)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(BI)V", line = 71)
