...
public abstract class class103 extends class333 {
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(Lr;B)V", line = 18)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(Z)I", line = 37)
    ...
    @OriginalMember(owner = "client!aaa", name = "b", descriptor = "(B)[Lnfa;", line = 48)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(ZBIII)V", line = 60)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(ZI)V", line = 82)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(IC)Z", line = 103)
