...
public class class103 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(Ljava/lang/String;Laa;IILor;IILeia;Lda;III)V", line = 3)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(IC)Z", line = 59)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(ZB)V", line = 77)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(B)V", line = 129)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(I)V", line = 142)
