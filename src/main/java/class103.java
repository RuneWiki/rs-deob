...
public class class103 extends class698 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Z)V", line = 49)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(JBIIZ)Ljava/lang/String;", line = 60)
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(I)V", line = 140)
    public class103(int arg0) {
        this.field1541 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(II)V", line = 148)
    ...
    @OriginalMember(owner = "client!gg", name = "b", descriptor = "(B)V", line = 164)
