...
public class class103 extends class303 {
    ...
    @OriginalMember(owner = "client!qda", name = "i", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!qda", name = "d", descriptor = "(B)I", line = 27)
    public static final int method733(byte arg0) {
        ++field1228;
        return arg0 >= -104 ? -100 : class268.field3824.method3992(false);
    }

    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(I)I", line = 39)
    ...
    @OriginalMember(owner = "client!qda", name = "c", descriptor = "(B)[B", line = 53)
    ...
    @OriginalMember(owner = "client!qda", name = "b", descriptor = "(III)Z", line = 72)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(IILjava/lang/String;Ljava/lang/String;)I", line = 83)
    ...
    @OriginalMember(owner = "client!qda", name = "c", descriptor = "(III)Z", line = 211)
