...
public abstract class class103 implements class216 {
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(ILjaclib/memory/Source;I)Z")
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(ILjaggl/MapBuffer;)Z")
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(BZLjaggl/MapBuffer;)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(Ltia;IZ)V")
