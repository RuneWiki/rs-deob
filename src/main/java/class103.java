...
public class class103 extends class469 {
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "(Lml;II[BI)V", line = 8)
    ...
    @OriginalMember(owner = "client!ws", name = "e", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(BZ)V", line = 42)
