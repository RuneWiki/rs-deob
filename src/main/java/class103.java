...
public class class103 extends class115 {
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Len;Lfs;III)V")
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IILen;ILdl;IIIIIZZI)V")
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(BLbk;I)V")
