...
public class class103 implements class153 {
    ...
    @OriginalMember(owner = "client!fc", name = "b", descriptor = "(I)Lwt;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lrl;I)Z")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IIBLoa;Lba;ILfq;IIIIIIII)Lba;")
