...
public class class103 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(BI)Lne;", line = 3)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(IIIIB)V", line = 35)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(ZI)V", line = 56)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!mg", name = "b", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!mg", name = "<init>", descriptor = "(Lee;ILul;Lul;)V", line = 108)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Z)V", line = 125)
