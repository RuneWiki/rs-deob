...
public class class103 {
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(BLpj;)V")
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(ZIILpj;IZ)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
