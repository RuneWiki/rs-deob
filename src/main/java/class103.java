...
public class class103 {
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(ZILls;Lls;I)Lpb;")
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Lls;IZLls;)Lpb;")
    ...
    @OriginalMember(owner = "client!laa", name = "<init>", descriptor = "(Ljq;Lkf;Ljava/math/BigInteger;Ljava/math/BigInteger;)V")
