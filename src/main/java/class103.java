...
public class class103 {
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(ILfv;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(B)Z", line = 71)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(Z)V", line = 81)
    ...
    @OriginalMember(owner = "client!lfa", name = "b", descriptor = "(B)V", line = 96)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!lfa", name = "c", descriptor = "(B)V", line = 137)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(Loa;Lni;IIIII)V", line = 158)
    ...
    @OriginalMember(owner = "client!lfa", name = "d", descriptor = "(B)I", line = 246)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(IZBIB)Lve;", line = 259)
    ...
    @OriginalMember(owner = "client!lfa", name = "b", descriptor = "(I)I", line = 301)
    public final int method788(int arg0) {
        field1533++;
        return arg0 == 3 ? this.field1543.method3393(false) + this.field1544.method3393(false) : 27;
    }

    @OriginalMember(owner = "client!lfa", name = "c", descriptor = "(I)V", line = 318)
    ...
    @OriginalMember(owner = "client!lfa", name = "d", descriptor = "(I)Z", line = 348)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(ZB)V", line = 623)
    ...
    @OriginalMember(owner = "client!lfa", name = "e", descriptor = "(B)Z", line = 652)
    ...
    @OriginalMember(owner = "client!lfa", name = "e", descriptor = "(I)V", line = 663)
