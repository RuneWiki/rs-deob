...
public class class103 {
    ...
    @OriginalMember(owner = "client!vf", name = "toString", descriptor = "()Ljava/lang/String;", line = 31)
    public final String toString() {
        field1511++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lqa;IIII[[[BIIIIIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "(II)V", line = 76)
