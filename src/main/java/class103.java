...
public class class103 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lka;IIIII)Lka;", line = 6)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ZIB)Ljava/lang/String;", line = 170)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IIIIBILka;I)Lka;", line = 185)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ZIII)I", line = 259)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILwu;)V", line = 383)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(B)V", line = 396)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lvj;IZ)V", line = 440)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(CB)I", line = 661)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILvj;)V", line = 679)
