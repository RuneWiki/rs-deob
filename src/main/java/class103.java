...
public class class103 extends class553 {
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!pw", name = "b", descriptor = "(I)I", line = 16)
    ...
    @OriginalMember(owner = "client!pw", name = "c", descriptor = "(Z)I", line = 27)
    public final int method761(boolean arg0) {
        return arg0 ? 11 : this.field1465;
    }

    @OriginalMember(owner = "client!pw", name = "c", descriptor = "(I)I", line = 37)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(I)J", line = 48)
