...
public class class103 extends class449 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(B[III)V", line = 16)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "([IZII)V", line = 39)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(III)Z", line = 53)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(IIZI)Z", line = 68)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lnl;Lnl;I)I", line = 83)
    ...
    @OriginalMember(owner = "client!np", name = "d", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "(IIIIIIIII)V", line = 139)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(IIB)Z", line = 155)
    ...
    @OriginalMember(owner = "client!np", name = "e", descriptor = "(I)V", line = 171)
