...
public class class103 extends class13 {
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "()V", line = 3)
    public class103() {
        super(1, false);
    }

    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(II)[[I", line = 11)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Lkh;BI)V", line = 145)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(ZI)[I", line = 212)
    ...
    @OriginalMember(owner = "client!kk", name = "e", descriptor = "(B)V", line = 300)
