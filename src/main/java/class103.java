...
public class class103 extends class189 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ILsp;)Z", line = 9)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IIIIIIII)V", line = 38)
    ...
    @OriginalMember(owner = "client!jj", name = "e", descriptor = "(I)I", line = 250)
    ...
    @OriginalMember(owner = "client!jj", name = "f", descriptor = "(I)V", line = 265)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(I)[B", line = 282)
