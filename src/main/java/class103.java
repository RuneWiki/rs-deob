...
public class class103 {
    ...
    @OriginalMember(owner = "client!qda", name = "b", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(II)V", line = 34)
    ...
    @OriginalMember(owner = "client!qda", name = "b", descriptor = "(II)Ltga;", line = 57)
    ...
    @OriginalMember(owner = "client!qda", name = "<init>", descriptor = "(Lcw;ILeq;Leq;)V", line = 98)
    ...
    @OriginalMember(owner = "client!qda", name = "c", descriptor = "(I)V", line = 114)
