...
public class class103 {
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "(III)V", line = 164)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(I)[[I", line = 30)
    ...
    @OriginalMember(owner = "client!tb", name = "c", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IB)[I", line = 79)
