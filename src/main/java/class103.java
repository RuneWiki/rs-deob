...
public class class103 extends class312 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(III)Z", line = 11)
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(III)Z", line = 54)
    ...
    @OriginalMember(owner = "client!pm", name = "c", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ILwl;IILwl;IIIII)V", line = 79)
