...
public class class103 {
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Lgga;I)V")
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Lag;B)V")
    ...
    @OriginalMember(owner = "client!wea", name = "<init>", descriptor = "(Lgga;)V")
