...
public class class103 extends class28 {
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(BF)V", line = 5)
    ...
    @OriginalMember(owner = "client!ho", name = "h", descriptor = "(I)V", line = 19)
    public static final void method670(int arg0) {
        class510.field7489 = class291.method1862(35, arg0, 8, 8, 0.4F, -2024, true, 4);
        ++field1487;
    }

    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(IIIIIF)V", line = 28)
    public class103(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!ho", name = "b", descriptor = "(IIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IIII)V", line = 116)
    ...
    @OriginalMember(owner = "client!ho", name = "i", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(Ljava/lang/String;IZJ)V", line = 145)
