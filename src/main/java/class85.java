...
public class class85 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(II)I", line = 6)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(F[FIIIIIZIFI)V", line = 19)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(IIIII)V", line = 72)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(III)Lqv;", line = 119)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(ILuq;)Z", line = 129)
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "(BIIIII)V", line = 152)
