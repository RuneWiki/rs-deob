...
public class class85 extends class611 {
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(BILkq;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!dha", name = "h", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!dha", name = "<init>", descriptor = "(Lwe;Ljava/lang/Object;I)V")
