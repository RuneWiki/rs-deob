...
public class class85 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "([BI[BII)V")
    public static final void method553(byte[] arg0, int arg1, byte[] arg2, int arg3, int arg4) {
        if (arg0 == arg2) {
            if (arg1 == arg3) {
                return;
            }
    ...
    public static final void method554(int[] arg0, int arg1, int arg2, int arg3) {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "([II[III)V")
