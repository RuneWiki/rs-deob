...
public abstract class class85 extends class71 {
    ...
    @OriginalMember(owner = "client!j", name = "v", descriptor = "Llf;")
    public static class109 field1724 = class35.method275("Um ein neues Spielkonto zu erstellen)1 m-Ussen Sie", 2);

    @OriginalMember(owner = "client!j", name = "z", descriptor = "Lpd;")
    public static class143 field1728 = new class143();

    @OriginalMember(owner = "client!j", name = "J", descriptor = "Llf;")
    private static class109 field1738 = class35.method275("flash1:", 2);

    @OriginalMember(owner = "client!j", name = "L", descriptor = "Llf;")
    public static class109 field1740 = field1738;

    @OriginalMember(owner = "client!j", name = "K", descriptor = "Llf;")
    public static class109 field1739 = field1738;

    @OriginalMember(owner = "client!j", name = "O", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!j", name = "H", descriptor = "Lma;")
    public class113 field1736;

    @OriginalMember(owner = "client!j", name = "E", descriptor = "Lcb;")
    public static class23 field1733;

    @OriginalMember(owner = "client!j", name = "q", descriptor = "Ljh;")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(BILja;)V")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IBLoh;ZIII)V")
