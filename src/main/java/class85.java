...
public class class85 extends class235 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Lqj;BII)Lfi;")
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(ILil;Z)V")
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Lil;B)V")
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IBLro;I)V")
