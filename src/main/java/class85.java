...
public class class85 {
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "()Ljn;")
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(Lbt;)V")
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lr;II)Lwk;")
