...
public class class85 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(III)Ldj;")
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Lza;Lge;IIIII)V")
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Lza;II)Z")
