...
public class class85 {
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!vga", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!vga", name = "c", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(III)Z", line = 72)
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(II)Lme;", line = 83)
    ...
    @OriginalMember(owner = "client!vga", name = "<init>", descriptor = "(Loea;Ld;)V", line = 139)
