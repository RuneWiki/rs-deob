...
public abstract class class85 implements class567 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(FFFFFFIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(FFII)V", line = 7)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(FFIILaa;II)V", line = 13)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(FFFFIILaa;II)V", line = 16)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(FFFFFFLaa;II)V", line = 41)
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(IIII)V", line = 51)
    public final void method755(int arg0, int arg1, int arg2, int arg3) {
        this.method10(arg0, arg1, arg2, arg3, 1, 0, 1, 1);
    }

    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(FFFFIIIII)V", line = 54)
    ...
    @OriginalMember(owner = "client!mq", name = "c", descriptor = "(IIII)V", line = 78)
    public final void method757(int arg0, int arg1, int arg2, int arg3) {
        this.method8(arg0, arg1, arg2, arg3, 1, 0, 1);
    }

    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(IIIIIII)V", line = 81)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(II)V", line = 84)
    public final void method759(int arg0, int arg1) {
        this.method6(arg0, arg1, 1, 0, 1);
    }

    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(FFIIIII)V", line = 93)
