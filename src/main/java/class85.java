...
public class class85 extends class335 {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(IF)V", line = 3)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(FI)V", line = 21)
    ...
    @OriginalMember(owner = "client!ps", name = "u", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(I)V", line = 74)
