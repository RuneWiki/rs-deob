...
public class class85 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Z[III)Lwo;", line = 160)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Z)V", line = 196)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Ljava/lang/String;Z)I", line = 214)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(ZIIIIIIZ)V", line = 240)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "([III)Lwo;", line = 449)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(II[II)Lwo;", line = 485)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "([III)Lwo;", line = 529)
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Lam;Lam;)V", line = 830)
    public class85(class286 arg0, class286 arg1) {
        this.field954 = arg0;
        this.field949 = arg1;
    }

    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(ZI)V", line = 572)
