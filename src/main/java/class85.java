...
public class class85 extends class245 {
    ...
    @OriginalMember(owner = "client!eda", name = "c", descriptor = "()I", line = 11)
    public final int method677() {
        return this.field1203 - (this.field1205.available() >> (class658.field9343 ? 2 : 1));
    }

    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 19)
    ...
    @OriginalMember(owner = "client!eda", name = "d", descriptor = "()V", line = 56)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 71)
    ...
    @OriginalMember(owner = "client!eda", name = "b", descriptor = "()V", line = 94)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "()V", line = 134)
