...
public class class85 extends class377 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ILpfa;Lpfa;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ILrr;Loa;)V", line = 21)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Z)V", line = 53)
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "()V", line = 67)
    public class85() {
        super(2, false);
    }
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IILji;)V", line = 387)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(II)[I", line = 428)
