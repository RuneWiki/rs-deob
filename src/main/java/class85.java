...
public class class85 implements class269 {
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(IILjaclib/memory/Source;I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!naa", name = "c", descriptor = "(I)I", line = 21)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!naa", name = "<init>", descriptor = "(Lmba;Z)V", line = 53)
    public class85(class70 arg0, boolean arg1) {
        this.field1143 = arg1;
        this.field1144 = arg0;
    }

    @OriginalMember(owner = "client!naa", name = "b", descriptor = "(I)Z", line = 64)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;", line = 85)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Z)I", line = 106)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(BII)Z", line = 119)
