...
public class class85 {
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Liaa;I)V")
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(ILiaa;I)V")
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IILse;II)V")
