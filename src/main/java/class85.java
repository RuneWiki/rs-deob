...
public class class85 extends class497 {
    ...
    @OriginalMember(owner = "client!qfa", name = "b", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!qfa", name = "<init>", descriptor = "(Lor;Lma;IIIIIIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!qfa", name = "b", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(I)Loh;", line = 41)
