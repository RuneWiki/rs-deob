...
public class class85 extends class96 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Lae;B)V", line = 17)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILae;I)V", line = 42)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(I)V", line = 62)
