...
public class class85 extends class80 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(FFFFFFIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "()I", line = 165)
    public final int method723() {
        return this.field1285.field4300;
    }

    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(IIII)V", line = 168)
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "()I", line = 177)
    public final int method733() {
        return this.field1285.field4299;
    }

    @OriginalMember(owner = "client!pd", name = "d", descriptor = "()I", line = 181)
    public final int method740() {
        return this.field1285.field4300 + this.field1282 + this.field1281;
    }

    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(I)V", line = 186)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IIIIII)V", line = 214)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IILvj;II)V", line = 220)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(FFFFFFLvj;II)V", line = 275)
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(IIIIIII)V", line = 356)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IIIII)V", line = 488)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(Lhd;IIII)V", line = 576)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(Lhd;II[III)V", line = 582)
    ...
    @OriginalMember(owner = "client!pd", name = "c", descriptor = "()I", line = 538)
    public final int method739() {
        return this.field1285.field4299 + this.field1283 + this.field1286;
    }

    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(III)V", line = 555)
    ...
    @OriginalMember(owner = "client!pd", name = "e", descriptor = "()V", line = 589)
