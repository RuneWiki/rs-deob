...
public class class85 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(BI[FIIIIIFI)V", line = 3)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IILnj;)V", line = 253)
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(I)V", line = 286)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(BLnj;)V", line = 304)
