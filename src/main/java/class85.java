...
public class class85 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IBLgg;)Lae;", line = 26)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Z)V", line = 51)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(B)V", line = 65)
