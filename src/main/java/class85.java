...
public class class85 extends class18 {
    ...
    @OriginalMember(owner = "client!dha", name = "e", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!dha", name = "d", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(ZZ)V", line = 71)
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!dha", name = "<init>", descriptor = "(Lhk;II[BI)V", line = 95)
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(IIIIII)I", line = 112)
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(IBII)V", line = 172)
