...
public class class85 extends class424 {
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(IB)[I", line = 6)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "()V", line = 318)
    public class85() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pd", name = "c", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(BI)I", line = 75)
    ...
    @OriginalMember(owner = "client!pd", name = "c", descriptor = "(III)Lal;", line = 134)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(BII)Z", line = 142)
    ...
    @OriginalMember(owner = "client!pd", name = "g", descriptor = "(I)V", line = 160)
    ...
    @OriginalMember(owner = "client!pd", name = "d", descriptor = "(III)V", line = 172)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 185)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Lrg;BI)V", line = 220)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IIZ)Z", line = 299)
