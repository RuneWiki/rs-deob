...
public class class85 {
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(II)Lws;", line = 4)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(I)Lcq;", line = 34)
    ...
    @OriginalMember(owner = "client!fca", name = "b", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!fca", name = "b", descriptor = "(II)V", line = 63)
    ...
    @OriginalMember(owner = "client!fca", name = "c", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(Z)V", line = 92)
    ...
    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "(Lqg;ILvd;)V", line = 129)
