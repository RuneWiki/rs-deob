...
public class class85 extends class508 {
    ...
    @OriginalMember(owner = "client!np", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!np", name = "e", descriptor = "(I)Z", line = 20)
    ...
    @OriginalMember(owner = "client!np", name = "c", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(II)Z", line = 58)
