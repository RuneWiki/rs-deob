...
public class class85 extends class404 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(Lsd;)V", line = 6)
    public final void method353(class233 arg0) {
        this.field5606.method2088(arg0);
    }

    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(Lh;Lsh;)V", line = 13)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "()Z", line = 116)
    public final boolean method350() {
        return true;
    }

    @OriginalMember(owner = "client!km", name = "c", descriptor = "()V", line = 121)
    ...
    @OriginalMember(owner = "client!km", name = "b", descriptor = "(Z)V", line = 145)
    ...
    @OriginalMember(owner = "client!km", name = "b", descriptor = "()V", line = 194)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(Z)V", line = 204)
