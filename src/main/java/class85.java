...
public class class85 extends class243 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(ILji;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(II)[I", line = 44)
    ...
    @OriginalMember(owner = "client!rf", name = "c", descriptor = "(I)V", line = 82)
