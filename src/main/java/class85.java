...
public class class85 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Loj;Lab;B)V")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(ILg;II)Lkp;")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
