...
public class class85 extends class188 {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(ILht;I[II[I)Lvm;")
    ...
    @OriginalMember(owner = "client!hu", name = "<init>", descriptor = "(Lht;II[BI)V")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(II[Lss;IZI)V")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Lss;ZII)V")
