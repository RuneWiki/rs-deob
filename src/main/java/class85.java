...
public class class85 {
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(IIZ)Z", line = 7)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(B)I", line = 20)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Ljw;III)V", line = 36)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(I)V", line = 851)
