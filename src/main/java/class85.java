...
public class class85 extends class372 implements class41 {
    ...
    @OriginalMember(owner = "client!hh", name = "g", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!hh", name = "h", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(I)Z", line = 128)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ILya;)V", line = 139)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Z)I", line = 149)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ZLya;)Llo;", line = 160)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(BZ[B)V", line = 172)
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(I)I", line = 213)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IILya;)Lt;", line = 224)
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "(IIIIILe;)V", line = 235)
    ...
    @OriginalMember(owner = "client!hh", name = "c", descriptor = "(I)I", line = 251)
    ...
    @OriginalMember(owner = "client!hh", name = "c", descriptor = "(B)V", line = 264)
    ...
    @OriginalMember(owner = "client!hh", name = "d", descriptor = "(I)V", line = 287)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ILya;II)Z", line = 299)
    ...
    @OriginalMember(owner = "client!hh", name = "c", descriptor = "(Z)I", line = 314)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Lya;I)V", line = 332)
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(ILya;)V", line = 351)
