...
public class class85 extends class346 {
    ...
    @OriginalMember(owner = "client!hc", name = "b", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!hc", name = "d", descriptor = "(II)Ljava/lang/String;", line = 34)
    ...
    @OriginalMember(owner = "client!hc", name = "d", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!hc", name = "e", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "()V", line = 431)
    public class85() {
        super(0, true);
    }
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(I[BLjava/lang/String;III)I", line = 225)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(Lfb;ZI)V", line = 361)
