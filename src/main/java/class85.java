...
public class class85 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIIIB)V", line = 21)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIIIIIIZI)V", line = 42)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILha;I)V", line = 181)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(B)Z", line = 213)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IILhf;Ljava/awt/Component;I)Lwl;", line = 224)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILha;)V", line = 308)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(B)V", line = 333)
