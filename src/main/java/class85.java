...
public class class85 extends class270 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(BJ)V", line = 3)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "()V", line = 23)
    public class85() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IBI)Z", line = 27)
    ...
    @OriginalMember(owner = "client!pd", name = "e", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Lmb;I)Z", line = 63)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IB)V", line = 116)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(BI)[I", line = 134)
    ...
    @OriginalMember(owner = "client!pd", name = "c", descriptor = "(III)Z", line = 193)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Z)V", line = 217)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(BLec;I)V", line = 234)
    ...
    @OriginalMember(owner = "client!pd", name = "f", descriptor = "(I)Z", line = 314)
