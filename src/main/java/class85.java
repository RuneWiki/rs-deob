...
public class class85 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IIIIILrd;)Ljava/awt/Frame;", line = 23)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(I)V", line = 109)
