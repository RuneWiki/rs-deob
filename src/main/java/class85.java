...
public class class85 {
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(II)Lec;", line = 3)
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(Z)Lob;", line = 32)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(BII)V", line = 62)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(BIILlga;)Lcd;", line = 147)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(II)V", line = 164)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(B)I", line = 181)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(III)Z", line = 352)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(I)V", line = 364)
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "(Lfs;ILlga;)V", line = 382)
