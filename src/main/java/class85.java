...
public class class85 extends class36 {
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(III)Z", line = 7)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(JI)V", line = 19)
    ...
    @OriginalMember(owner = "client!qfa", name = "<init>", descriptor = "(Lsp;)V", line = 83)
    ...
    @OriginalMember(owner = "client!qfa", name = "b", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(B)V", line = 125)
    ...
    @OriginalMember(owner = "client!qfa", name = "b", descriptor = "(III)Z", line = 138)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(Lpj;Z)V", line = 152)
