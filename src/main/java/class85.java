...
public class class85 extends class212 {
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(BII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!fca", name = "b", descriptor = "(I)I", line = 14)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(Lkda;B)V", line = 25)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(Z)V", line = 61)
    ...
    @OriginalMember(owner = "client!fca", name = "b", descriptor = "(II)I", line = 78)
    ...
    @OriginalMember(owner = "client!fca", name = "d", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "(ILdh;)V", line = 107)
    public class85(int arg0, class322 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(IIZLjava/lang/String;)I", line = 121)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(III)Z", line = 197)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(II)V", line = 209)
    ...
    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "(Ldh;)V", line = 219)
    public class85(class322 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fca", name = "e", descriptor = "(I)I", line = 222)
