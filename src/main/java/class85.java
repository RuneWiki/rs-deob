...
public class class85 extends class387 {
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!dha", name = "b", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(ZB)V", line = 56)
    ...
    @OriginalMember(owner = "client!dha", name = "<init>", descriptor = "(Lla;Lcf;)V", line = 77)
    public class85(class476 arg0, class630 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(IIIIBIII)V", line = 84)
