...
public class class85 extends class507 {
    ...
    @OriginalMember(owner = "client!fg", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(B[B)[B", line = 19)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(ILug;)V", line = 41)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Lug;Z)V", line = 86)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(ILug;I)V", line = 106)
    ...
    @OriginalMember(owner = "client!fg", name = "e", descriptor = "(I)V", line = 121)
