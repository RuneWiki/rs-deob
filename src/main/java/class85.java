...
public class class85 {
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(II)I", line = 146)
    ...
    @OriginalMember(owner = "client!naa", name = "b", descriptor = "()[F", line = 154)
    public final float[] method643() {
        return this.field1278[this.method644()];
    }

    @OriginalMember(owner = "client!naa", name = "<init>", descriptor = "()V", line = 157)
    public class85() {
    ...
    @OriginalMember(owner = "client!naa", name = "c", descriptor = "()I", line = 301)
