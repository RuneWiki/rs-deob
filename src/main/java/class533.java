...
public class class533 extends class482 {
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(B)V", line = 142)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(IZI)I", line = 241)
    ...
    @OriginalMember(owner = "client!vw", name = "c", descriptor = "(I)V", line = 259)
