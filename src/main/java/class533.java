...
public class class533 extends class36 {
    ...
    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(Lqo;IIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(Lqo;IIIIZ[FI)V", line = 33)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ZII[IIBIII)V", line = 55)
    ...
    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(Lqo;IIIIZ[IIIZ)V", line = 107)
    ...
    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(Lqo;IIIIZ[BIZ)V", line = 159)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ZZI)V", line = 212)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IIIIBIIII)V", line = 230)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IIIIIBI)V", line = 241)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "()V", line = 260)
    public static final void method3070() {
        class415.method2560(1, class510.field7094);
    }

    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(I)V", line = 266)
    ...
    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(Lqo;IIIII)V", line = 385)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "([BI)Lmi;", line = 285)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IIIZIIII[BI)V", line = 325)
