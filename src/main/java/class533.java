...
public class class533 implements class627 {
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(III)Z", line = 5)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IZ)Z", line = 23)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Z[ILhk;J)Ljava/lang/String;", line = 47)
