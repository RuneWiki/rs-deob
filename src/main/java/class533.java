...
public class class533 extends class349 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Lcga;IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(BI)[I", line = 54)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IILdga;)V", line = 300)
    ...
    @OriginalMember(owner = "client!mk", name = "f", descriptor = "(I)V", line = 335)
    ...
    @OriginalMember(owner = "client!mk", name = "g", descriptor = "(I)V", line = 366)
    ...
    @OriginalMember(owner = "client!mk", name = "d", descriptor = "(B)V", line = 376)
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "()V", line = 727)
    public class533() {
        super(2, false);
    }

    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IB)[[I", line = 408)
