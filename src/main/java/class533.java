...
public class class533 extends class423 {
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(Lr;Z)Lkq;")
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Lmo;B)Ltfa;")
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(ILr;)Lnu;")
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IILr;I)Z")
