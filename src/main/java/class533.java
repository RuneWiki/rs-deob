...
public abstract class class533 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IBIILrj;I)Ljava/awt/Frame;", line = 4)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(ZI)V", line = 95)
