...
public class class533 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IB)V", line = 26)
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(IB)V", line = 49)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(II)Lms;", line = 70)
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(Lei;IZLri;Lri;)V", line = 188)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(BZ)V", line = 129)
    ...
    @OriginalMember(owner = "client!cr", name = "c", descriptor = "(B)V", line = 145)
    ...
    @OriginalMember(owner = "client!cr", name = "d", descriptor = "(B)V", line = 164)
