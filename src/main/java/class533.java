...
public class class533 implements class161 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(BILah;I)V")
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IIIZLhg;)V")
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Lcj;BI)V")
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IBLah;)V")
    ...
    @OriginalMember(owner = "client!jk", name = "d", descriptor = "(II)Lvp;")
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IIILhg;)V")
    public final void method3166(int arg0, int arg1, int arg2, class358 arg3) {
        this.method3153(arg0, arg2, arg1, false, arg3);
        field7817++;
    }

    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(Lih;)V")
