...
public class class533 {
    ...
    @OriginalMember(owner = "client!de", name = "toString", descriptor = "()Ljava/lang/String;", line = 20)
    public final String toString() {
        field7666++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ILjava/lang/String;)V", line = 32)
