...
public class class533 extends class321 {
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(ZIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!lea", name = "<init>", descriptor = "(IIIIIF)V", line = 23)
    public class533(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(FI)V", line = 29)
