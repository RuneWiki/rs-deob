...
public class class533 extends class245 implements class273 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IIII)Z", line = 17)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Lha;B)V", line = 35)
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Lsb;IZ[[I)V", line = 65)
