...
public class class533 extends class89 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(Z)V", line = 25)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IIB)V", line = 40)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(III)V", line = 78)
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(IIIIIFFF)V", line = 116)
