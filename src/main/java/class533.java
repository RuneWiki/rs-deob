...
public class class533 implements Runnable {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(ZI)Z", line = 5)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!du", name = "<init>", descriptor = "(Ljava/io/InputStream;I)V", line = 243)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Ljava/lang/String;IIIIBII)V", line = 75)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(BZ)V", line = 98)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(III[B)I", line = 136)
    ...
    @OriginalMember(owner = "client!du", name = "run", descriptor = "()V", line = 186)
    ...
    @OriginalMember(owner = "client!du", name = "b", descriptor = "(I)V", line = 266)
