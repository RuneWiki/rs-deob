...
public class class533 extends class72 {
    ...
    @OriginalMember(owner = "client!bf", name = "b", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(Lcq;)V", line = 29)
    public class533(class464 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(II)V", line = 37)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(ZI)V", line = 49)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(ILcq;)V", line = 75)
    public class533(int arg0, class464 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!bf", name = "d", descriptor = "(I)I", line = 78)
    ...
    @OriginalMember(owner = "client!bf", name = "b", descriptor = "(I)I", line = 90)
