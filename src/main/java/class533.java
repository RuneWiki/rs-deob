...
public class class533 extends class9 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IILos;)V", line = 3)
    ...
    @OriginalMember(owner = "client!go", name = "c", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Los;I)V", line = 45)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Let;IIZ)V", line = 66)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IIBLr;I)Lso;", line = 144)
