...
public class class533 {
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(B)Ltia;", line = 4)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!bda", name = "b", descriptor = "(I)Ltia;", line = 40)
    ...
    @OriginalMember(owner = "client!bda", name = "<init>", descriptor = "()V", line = 73)
    public class533() {
    }

    @OriginalMember(owner = "client!bda", name = "<init>", descriptor = "(Ldha;)V", line = 75)
