...
public class class533 {
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(ILbv;)I", line = 8)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(Z)V", line = 54)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "([BI)V", line = 65)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(ZI)[B", line = 115)
