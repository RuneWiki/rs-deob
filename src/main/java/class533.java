...
public class class533 extends class567 {
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(I)Lkq;")
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(Lod;Z)V")
    ...
    @OriginalMember(owner = "client!cda", name = "<init>", descriptor = "(Lvn;Lmf;IIIIIIIII)V")
