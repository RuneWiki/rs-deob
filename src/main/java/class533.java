...
public class class533 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Llj;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(BIII)Z", line = 43)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IIBIIIIIIII)V", line = 66)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IIB)Z", line = 99)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IIIII)V", line = 112)
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 147)
