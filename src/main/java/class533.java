...
public class class533 extends class459 {
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(CB)I", line = 4)
    ...
    @OriginalMember(owner = "client!bda", name = "c", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(ILwq;Z)V", line = 56)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!bda", name = "b", descriptor = "(CB)I", line = 146)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(ILwq;)V", line = 185)
