...
public class class533 extends class469 implements class534 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IIILqa;)Z")
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(IIIIILpl;)V")
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(Lqa;B)Lem;")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ILqa;)Lnj;")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(BLqa;)V")
    public final void method557(byte arg0, class167 arg1) {
        field7871++;
        int var3 = 101 % ((arg0 - 13) / 59);
    }

    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lbt;Z[Lbn;)Lej;")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ILqa;I)Lka;")
