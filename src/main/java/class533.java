...
public class class533 extends class513 {
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(II)Lwg;")
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(Lkh;B)Lkh;")
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(Lfca;B[I)V")
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(ILfca;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(BILfca;)V")
    ...
    @OriginalMember(owner = "client!bda", name = "b", descriptor = "(ILfca;)V")
