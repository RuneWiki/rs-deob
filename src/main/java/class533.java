...
public class class533 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ILgs;BIIILza;)Le;")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ILnn;B)V")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IIZLya;IIIILza;Lya;Lgs;II)Le;")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lya;Lya;IBIILgs;IIZILza;IZ)Le;")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IILza;IIILgs;)Le;")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lnn;I)V")
