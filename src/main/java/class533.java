...
public class class533 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(BI)[B", line = 15)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(B)V", line = 72)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(I[B)V", line = 84)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Lgga;B)V", line = 134)
