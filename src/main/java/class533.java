...
public class class533 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "([FII)[F", line = 4)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ILop;)Z", line = 18)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(I)V", line = 47)
