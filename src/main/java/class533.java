...
public abstract class class533 {
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 40)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(III)V", line = 98)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IIZ)I", line = 122)
