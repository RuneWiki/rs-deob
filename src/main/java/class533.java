...
public class class533 {
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(I)V", line = 40)
    public static void method2967(int arg0) {
        field7082 = null;
        int var1 = 29 / ((arg0 + 5) / 48);
    }

    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Leh;I)Loq;", line = 51)
