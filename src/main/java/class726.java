...
public class class726 implements class432 {
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(ILaf;I)V")
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(I)Lkt;")
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(B[[BLcc;)V")
