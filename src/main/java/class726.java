...
public class class726 extends class125 {
    ...
    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "(ILgp;)V", line = 3)
    public class726(int arg0, class549 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ZI)I", line = 6)
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!pf", name = "c", descriptor = "(Z)V", line = 55)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(B)I", line = 69)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ZLeg;I)V", line = 80)
    ...
    @OriginalMember(owner = "client!pf", name = "c", descriptor = "(I)Z", line = 97)
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(Z)V", line = 108)
    ...
    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "(Lgp;)V", line = 134)
    public class726(class549 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!pf", name = "d", descriptor = "(Z)I", line = 137)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(BI)V", line = 148)
