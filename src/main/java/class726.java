...
public class class726 extends class71 {
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(IIB)Z", line = 16)
    ...
    @OriginalMember(owner = "client!uha", name = "b", descriptor = "(III)I", line = 39)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(Lnf;B)V", line = 62)
    ...
    @OriginalMember(owner = "client!uha", name = "<init>", descriptor = "(Lto;)V", line = 202)
    public class726(class717 arg0) {
        this.field10062 = arg0;
    }

    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(Z)I", line = 83)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(B[Lfd;)V", line = 161)
