...
public class class726 extends class224 {
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Lnfa;)V", line = 14)
    public class726(class676 arg0) {
        this.field10159 = arg0;
    }

    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(I)I", line = 22)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 47)
