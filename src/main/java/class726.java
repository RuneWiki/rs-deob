...
public class class726 implements class427 {
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!sfa", name = "b", descriptor = "(I)Z", line = 23)
    ...
    @OriginalMember(owner = "client!sfa", name = "c", descriptor = "(I)Lig;", line = 47)
    public final class258 method2612(int arg0) {
        return arg0 == 21064 ? this.field10099 : (class258) null;
    }

    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(IB)V", line = 60)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;", line = 93)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(B)I", line = 115)
    ...
    @OriginalMember(owner = "client!sfa", name = "<init>", descriptor = "(Lrja;Lig;Z)V", line = 127)
