...
public class class726 extends class601 {
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "()V", line = 83)
    public class726() {
        super(1, true);
    }

    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IB)[I", line = 13)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Lmc;II)V", line = 48)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IIIIIII)Z", line = 88)
    ...
    @OriginalMember(owner = "client!oi", name = "f", descriptor = "(I)V", line = 152)
