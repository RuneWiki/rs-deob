...
public class class726 implements class34 {
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(Lwq;I)Leda;")
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(I)Lil;")
    ...
    @OriginalMember(owner = "client!jha", name = "<init>", descriptor = "(Lgda;)V")
