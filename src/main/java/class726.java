...
public class class726 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Lla;II)Lgu;")
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(Lla;II)[Lgu;")
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Lla;I)Lgu;")
    ...
    @OriginalMember(owner = "client!gu", name = "g", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(Lla;I)[Lgu;")
