...
public class class726 extends Canvas {
    ...
    @OriginalMember(owner = "client!hf", name = "update", descriptor = "(Ljava/awt/Graphics;)V")
    ...
    @OriginalMember(owner = "client!hf", name = "paint", descriptor = "(Ljava/awt/Graphics;)V")
    public final void paint(Graphics arg0) {
        this.field10104.paint(arg0);
        field10108++;
    }

    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Ljava/awt/Component;)V")
