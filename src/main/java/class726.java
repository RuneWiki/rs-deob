...
public class class726 extends class435 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IIII)I", line = 5)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IFFIIFI[FFII)V", line = 29)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IIIB)I", line = 120)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IZI)V", line = 144)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(B)V", line = 166)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(I)V", line = 206)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(II)V", line = 190)
