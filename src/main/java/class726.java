...
public class class726 extends class260 {
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "(Lgn;)V", line = 3)
    ...
    @OriginalMember(owner = "client!dq", name = "d", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IB)V", line = 48)
    ...
    @OriginalMember(owner = "client!dq", name = "c", descriptor = "(II)I", line = 64)
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "(ILgn;)V", line = 95)
    public class726(int arg0, class729 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(I)I", line = 98)
    public final int method123(int arg0) {
        ++field10032;
        return arg0 != 4377 ? -82 : 0;
    }

    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(Z)Z", line = 110)
    ...
    @OriginalMember(owner = "client!dq", name = "e", descriptor = "(I)I", line = 125)
    ...
    @OriginalMember(owner = "client!dq", name = "f", descriptor = "(I)Z", line = 137)
