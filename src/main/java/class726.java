...
public class class726 extends class601 {
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(BI)[I", line = 3)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(JI)I", line = 28)
    ...
    @OriginalMember(owner = "client!pea", name = "<init>", descriptor = "()V", line = 41)
    public class726() {
        super(0, true);
    }
}
