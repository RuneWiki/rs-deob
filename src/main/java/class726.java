...
public class class726 extends class305 {
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "(ILhb;)V")
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "(Lhb;)V")
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(Lsca;B)V")
