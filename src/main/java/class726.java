...
public class class726 extends class345 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(IILcj;)V", line = 4)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "(Lbi;)V", line = 90)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(I)Z", line = 42)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ZII)V", line = 53)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ZB)V", line = 63)
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "(B)V", line = 131)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ZI)V", line = 159)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(Z)V", line = 175)
    ...
    @OriginalMember(owner = "client!cp", name = "c", descriptor = "(B)V", line = 195)
