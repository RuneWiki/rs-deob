...
public class class229 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "([BZ)[B", line = 20)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(II)I", line = 91)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IZ)I", line = 117)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(II)V", line = 131)
