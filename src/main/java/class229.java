...
public class class229 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Lr;ZLfa;)V", line = 8)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IZII)Z", line = 239)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IIIIBIIIIII)V", line = 264)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 289)
