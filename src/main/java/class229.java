...
public class class229 extends class301 implements class223 {
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(ZILea;I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ic", name = "d", descriptor = "(Z)V", line = 25)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IIBIIIIIII)V", line = 43)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Lij;Lij;B)V", line = 101)
    ...
    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "(Lea;Lp;IIIIZIZ)V", line = 137)
    ...
    @OriginalMember(owner = "client!ic", name = "b", descriptor = "(B)V", line = 173)
    public static void method1497(byte arg0) {
        int var1 = 48 % ((arg0 - 56) / 33);
        field3226 = null;
    }

    @OriginalMember(owner = "client!ic", name = "b", descriptor = "(I)I", line = 183)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(ILea;)V", line = 194)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Lea;BI)Lts;", line = 224)
    ...
    @OriginalMember(owner = "client!ic", name = "c", descriptor = "(I)I", line = 238)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Lea;I)V", line = 252)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IILea;)Lts;", line = 264)
    ...
    @OriginalMember(owner = "client!ic", name = "b", descriptor = "(Z)I", line = 286)
    public final int method711(boolean arg0) {
        ++field3203;
        return !arg0 ? -66 : this.field3210 & 65535;
    }

    @OriginalMember(owner = "client!ic", name = "b", descriptor = "(ILea;)Lms;", line = 297)
    ...
    @OriginalMember(owner = "client!ic", name = "d", descriptor = "(I)Z", line = 322)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IILea;Lac;ZII)V", line = 333)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Lne;Ljava/lang/Object;I)V", line = 356)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(ILjq;IILjq;IIIII)V", line = 380)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Z)Z", line = 431)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(I)V", line = 445)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IILde;BILea;Lvg;II)V", line = 459)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IBZLea;)Lto;", line = 559)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(BLea;)V", line = 606)
