...
public class class229 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Laba;I)Lqea;", line = 3)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Lha;IB)V", line = 42)
