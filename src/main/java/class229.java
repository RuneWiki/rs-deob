...
public class class229 extends class108 {
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(IBIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!vba", name = "b", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!vba", name = "b", descriptor = "(III)Lvj;", line = 86)
    ...
    @OriginalMember(owner = "client!vba", name = "<init>", descriptor = "(IIIIIZ)V", line = 109)
