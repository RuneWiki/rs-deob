...
public class class229 extends class354 {
    ...
    @OriginalMember(owner = "client!sja", name = "g", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!sja", name = "a", descriptor = "(BLqf;)Ljava/lang/String;", line = 25)
    ...
    @OriginalMember(owner = "client!sja", name = "a", descriptor = "([[[Lmf;I)V", line = 41)
    ...
    @OriginalMember(owner = "client!sja", name = "b", descriptor = "(II)[[I", line = 114)
