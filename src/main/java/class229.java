...
public class class229 extends class31 {
    ...
    @OriginalMember(owner = "client!ab", name = "b", descriptor = "()Loo;", line = 20)
    ...
    @OriginalMember(owner = "client!ab", name = "b", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(ILjava/lang/String;Lla;Z)V", line = 76)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "()I", line = 100)
    public final int method225() {
        field3215++;
        return 0;
    }

    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(BLer;I)V", line = 123)
    ...
    @OriginalMember(owner = "client!ab", name = "b", descriptor = "([III)V", line = 164)
    ...
    @OriginalMember(owner = "client!ab", name = "d", descriptor = "()Loo;", line = 205)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "([IILer;III)V", line = 235)
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "(Lbr;)V", line = 302)
