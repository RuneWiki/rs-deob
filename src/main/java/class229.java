...
public class class229 extends class263 {
    ...
    public static byte[][] field3226;

    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "()V", line = 3)
    public class229() {
        super(2, false);
    }

    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IZLgk;)V", line = 8)
    public final void method32(int arg0, boolean arg1, class468 arg2) {
        ...
        if (~arg0 != -1) {
            if (~arg0 == -2) {
                super.field3927 = ~arg2.method2765(124) == -2;
            }
        } else {
            this.field3219 = arg2.method2765(68);
        }
    }

    @OriginalMember(owner = "client!vb", name = "b", descriptor = "(IB)[[I", line = 46)
    public final int[][] method34(int arg0, byte arg1) {
        ...
        if (super.field3912.field6681) {
            ...
            int[][] var5 = this.method1646(1, 2, arg0);
            int[] var6 = var3[0];
            int[] var7 = var3[1];
            int[] var8 = var3[2];
            int[] var9 = var4[0];
            ...
            if (~var15 != -2) {
                if (~var15 != -3) {
                    if (~var15 != -4) {
                        if (var15 != 4) {
                            if (~var15 != -6) {
                                if (~var15 != -7) {
                                    if (var15 != 7) {
                                        if (~var15 != -9) {
                                            if (var15 != 9) {
                                                if (var15 != 10) {
                                                    if (~var15 != -12) {
                                                        if (var15 == 12) {
                                                            for (int var16 = 0; class367.field5597 > var16; ++var16) {
                                                                ...
                                                                var6[var16] = var18 - (var18 * var22 >> 11) + var22;
                                                                var7[var16] = -(var17 * var21 >> 11) + var17 + var21;
                                                                var8[var16] = -(var19 * var20 >> 11) + var19 + var20;
                                                            }
                                                        }
                                                    } else {
                                                        for (int var23 = 0; class367.field5597 > var23; ++var23) {
                                                            ...
                                                            var7[var23] = var26 < var28 ? -var26 + var28 : -var28 + var26;
                                                            var8[var23] = var25 < var24 ? var24 - var25 : var25 - var24;
                                                        }
                                                    }
                                                } else {
                                                    for (int var30 = 0; ~class367.field5597 < ~var30; ++var30) {
                                                        ...
                                                        var6[var30] = var36 <= var31 ? var31 : var36;
                                                        var7[var30] = var35 <= var32 ? var32 : var35;
                                                        var8[var30] = var33 <= var34 ? var34 : var33;
                                                    }
                                                }
                                            } else {
                                                for (int var37 = 0; ~class367.field5597 < ~var37; ++var37) {
                                            ...
                                            for (int var44 = 0; class367.field5597 > var44; ++var44) {
                                        ...
                                        for (int var48 = 0; ~class367.field5597 < ~var48; ++var48) {
                                ...
                                for (int var56 = 0; class367.field5597 > var56; ++var56) {
                            ...
                            for (int var57 = 0; class367.field5597 > var57; ++var57) {
                        ...
                        for (int var61 = 0; class367.field5597 > var61; ++var61) {
                    ...
                    for (int var62 = 0; var62 < class367.field5597; ++var62) {
                ...
                for (int var63 = 0; var63 < class367.field5597; ++var63) {
    ...
    @OriginalMember(owner = "client!vb", name = "d", descriptor = "(I)V", line = 360)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(ILok;)V", line = 377)
    public static final void method1424(int arg0, class74 arg1) {
        ++field3222;
        if (arg0 != -2663) {
            method1425((byte) -1, -45L);
        }
        class219.field3143 = arg1.method539((byte) 27, "titlebg");
        class455.field6675 = arg1.method539((byte) 27, "logo");
    }

    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(BJ)V", line = 393)
    public static final void method1425(byte arg0, long arg1) {
        ++field3220;
        if (arg0 == -30) {
            int var3 = class382.field5746;
            int var4 = class444.field6528;
            ...
            if (!class454.field6661.field969) {
                class254.field3443 += (float) arg1 * class161.field2413 / 40.0F * 8.0F;
                class311.field4836 += (float) arg1 * class78.field1085 / 40.0F * 8.0F;
            }
            class221.method1403(-4);
        }
    }

    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IB)[I", line = 478)
                                        ...
                                        if (var6 != 8) {
                                            if (~var6 != -10) {
                                                if (~var6 != -11) {
                                                    ...
                                                    for (int var13 = 0; ~class367.field5597 < ~var13; ++var13) {
                                            ...
                                            for (int var19 = 0; ~class367.field5597 < ~var19; ++var19) {
                                                int var20 = var4[var19];
                                                var3[var19] = var20 != 0 ? -((-var5[var19] + 4096 << 12) / var20) + 4096 : 0;
                                            }
                                        }
                                    } else {
                                        for (int var21 = 0; ~class367.field5597 < ~var21; ++var21) {
                                            int var22 = var4[var21];
                                            var3[var21] = var22 == 4096 ? 4096 : (var5[var21] << 12) / (-var22 + 4096);
                                        }
                                    }
                                } else {
                                    for (int var23 = 0; ~var23 > ~class367.field5597; ++var23) {
                                        int var24 = var5[var23];
                                        var3[var23] = var24 >= 2048 ? -((-var4[var23] + 4096) * (-var24 + 4096) >> 11) + 4096 : var4[var23] * var24 >> 11;
                                    }
                                }
                            } else {
                                for (int var25 = 0; var25 < class367.field5597; ++var25) {
                                    var3[var25] = 4096 - ((-var4[var25] + 4096) * (-var5[var25] + 4096) >> 12);
                                }
                            }
                        } else {
                            for (int var26 = 0; ~class367.field5597 < ~var26; ++var26) {
                                int var27 = var5[var26];
                                var3[var26] = ~var27 != -1 ? (var4[var26] << 12) / var27 : 4096;
                            }
                        }
                    } else {
                        for (int var28 = 0; ~class367.field5597 < ~var28; ++var28) {
                            var3[var28] = var4[var28] * var5[var28] >> 12;
                        }
                    }
                } else {
                    for (int var29 = 0; ~class367.field5597 < ~var29; ++var29) {
                        var3[var29] = var4[var29] + -var5[var29];
                    }
                }
            } else {
                for (int var30 = 0; var30 < class367.field5597; ++var30) {
                    var3[var30] = var4[var30] + var5[var30];
                }
            }
        }
        if (arg1 <= 40) {
            method1425((byte) -3, 75L);
        }
        return var3;
    }
}
