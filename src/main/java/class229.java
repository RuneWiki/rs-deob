...
public class class229 extends class5 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "([[ZIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Ll;ILqa;IIII)V", line = 65)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(BIIII)V", line = 148)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(BS)V", line = 170)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(II)V", line = 201)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IIIIIII)V", line = 217)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(ZI)V", line = 388)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(ILjt;)Z", line = 429)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(I)V", line = 451)
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "(Lnq;Le;Lbe;[I)V", line = 461)
