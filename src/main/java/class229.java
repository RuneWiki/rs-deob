...
public class class229 extends class251 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lsi;I)I", line = 4)
    ...
    @OriginalMember(owner = "client!tg", name = "t", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!tg", name = "C", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!tg", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Ld;Lfp;Ljava/lang/Integer;)Lha;", line = 62)
    ...
    @OriginalMember(owner = "client!tg", name = "U", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!tg", name = "na", descriptor = "(IIII)[I", line = 181)
    ...
    @OriginalMember(owner = "client!tg", name = "m", descriptor = "()V", line = 218)
    public final void method432() {
    }

    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(FFF)V", line = 223)
    public final void method428(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Ljava/awt/Canvas;Ljava/lang/Object;Z)V", line = 226)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ZI)Lada;", line = 235)
    ...
    @OriginalMember(owner = "client!tg", name = "c", descriptor = "(IB)V", line = 246)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILjagdx/IDirect3DPixelShader;)V", line = 258)
    public final void method1431(int arg0, IDirect3DPixelShader arg1) {
        int var3 = -24 / ((-arg0 - 42) / 34);
        this.field3093.SetPixelShader(arg1);
    }

    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lgd;)V", line = 270)
    public final void method478(class339 arg0) {
    }

    @OriginalMember(owner = "client!tg", name = "d", descriptor = "()V", line = 273)
    public final void method389() {
        this.field3092.method3672(false);
        super.method389();
    }

    @OriginalMember(owner = "client!tg", name = "e", descriptor = "(B)V", line = 281)
    ...
    @OriginalMember(owner = "client!tg", name = "F", descriptor = "(I)V", line = 311)
    ...
    @OriginalMember(owner = "client!tg", name = "i", descriptor = "(Z)V", line = 343)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Ljava/awt/Canvas;ILjava/lang/Object;)V", line = 379)
    ...
    @OriginalMember(owner = "client!tg", name = "M", descriptor = "(I)V", line = 406)
    ...
    @OriginalMember(owner = "client!tg", name = "k", descriptor = "()Z", line = 417)
    public final boolean method413() {
        return false;
    }

    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(BLkt;)I", line = 424)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ZLkt;BI)V", line = 451)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lwt;Lbda;I)Z", line = 498)
    ...
    @OriginalMember(owner = "client!tg", name = "ya", descriptor = "()V", line = 511)
    public final void method440() {
        this.method1629(true, (byte) -28);
        this.field3093.Clear(2, 0, 1.0F, 0);
    }

    @OriginalMember(owner = "client!tg", name = "i", descriptor = "(B)V", line = 521)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IIILbda;II[FZ)Ldh;", line = 559)
    ...
    @OriginalMember(owner = "client!tg", name = "m", descriptor = "(B)V", line = 567)
    ...
    @OriginalMember(owner = "client!tg", name = "c", descriptor = "(B)V", line = 579)
    public final void method1443(byte arg0) {
        int var2 = 42 % ((arg0 + 68) / 49);
    }

    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lwt;Lbda;B)Z", line = 587)
    ...
    @OriginalMember(owner = "client!tg", name = "A", descriptor = "()Z", line = 599)
    public final boolean method491() {
        return false;
    }

    @OriginalMember(owner = "client!tg", name = "g", descriptor = "(Z)V", line = 608)
    ...
    @OriginalMember(owner = "client!tg", name = "bb", descriptor = "(I)V", line = 620)
    ...
    @OriginalMember(owner = "client!tg", name = "c", descriptor = "(Z)V", line = 630)
    ...
    @OriginalMember(owner = "client!tg", name = "s", descriptor = "(I)V", line = 642)
    ...
    @OriginalMember(owner = "client!tg", name = "N", descriptor = "(I)V", line = 652)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ZLkt;IZZ)V", line = 674)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(BI)Lraa;", line = 712)
    ...
    @OriginalMember(owner = "client!tg", name = "y", descriptor = "()V", line = 757)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(IIIID)V", line = 781)
    public final void method493(int arg0, int arg1, int arg2, int arg3, double arg4) {
    }

    @OriginalMember(owner = "client!tg", name = "c", descriptor = "()V", line = 783)
    public final void method377() {
    }

    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(BLcd;)V", line = 788)
    ...
    @OriginalMember(owner = "client!tg", name = "q", descriptor = "(B)V", line = 809)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILik;)I", line = 848)
    ...
    @OriginalMember(owner = "client!tg", name = "d", descriptor = "(II)Lgba;", line = 881)
    public final class666 method473(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!tg", name = "k", descriptor = "(B)V", line = 889)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(Z)V", line = 898)
    public final void method449(boolean arg0) {
    }

    @OriginalMember(owner = "client!tg", name = "Z", descriptor = "(I)V", line = 901)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lmf;Lmf;FLmf;)Lmf;", line = 910)
    public final class418 method453(class418 arg0, class418 arg1, float arg2, class418 arg3) {
        return arg2 < 0.5F ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILjagdx/IDirect3D;ILjagdx/D3DPRESENT_PARAMETERS;II)Z", line = 919)
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/faa;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Lgm;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Ld;Lfp;I)V", line = 1018)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IIIII[IZ)Ldh;", line = 1066)
    ...
    @OriginalMember(owner = "client!tg", name = "t", descriptor = "(I)F", line = 1076)
    public final float method1459(int arg0) {
        int var2 = 125 % ((arg0 + 8) / 54);
        return -0.5F;
    }

    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IILada;)V", line = 1085)
    ...
    @OriginalMember(owner = "client!tg", name = "f", descriptor = "(B)V", line = 1098)
    ...
    @OriginalMember(owner = "client!tg", name = "w", descriptor = "(B)V", line = 1134)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(II)Ldw;", line = 1146)
    public final class717 method415(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Ldw;Lgba;)Lgd;", line = 1156)
    public final class339 method467(class717 arg0, class666 arg1) {
        return null;
    }

    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(BLlda;)I", line = 1163)
    ...
    @OriginalMember(owner = "client!tg", name = "l", descriptor = "(B)V", line = 1185)
    ...
    @OriginalMember(owner = "client!tg", name = "j", descriptor = "()V", line = 1195)
    public final void method412() {
    }

    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Ljava/awt/Canvas;B)Ljava/lang/Object;", line = 1199)
    public final Object method1465(Canvas arg0, byte arg1) {
        int var3 = 85 % ((24 - arg1) / 54);
        return null;
    }

    @OriginalMember(owner = "client!tg", name = "a", descriptor = "([Lsj;B)Llb;", line = 1208)
    public final class542 method1466(class459[] arg0, byte arg1) {
        int var3 = -102 / ((20 - arg1) / 36);
        return new dxVertexLayout(this, arg0);
    }

    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(BZ)V", line = 1216)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILjava/awt/Canvas;Ljava/lang/Object;)V", line = 1226)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IBILbda;I[B)Lpa;", line = 1239)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(I)V", line = 1249)
    public final synchronized void method399(int arg0) {
        this.field3092.method3669(false);
        super.method399(arg0);
    }

    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IIII)V", line = 1256)
    public final void method486(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!tg", name = "v", descriptor = "(I)V", line = 1259)
    ...
    @OriginalMember(owner = "client!tg", name = "F", descriptor = "(II)V", line = 1275)
    public final void method492(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(BLjagdx/IDirect3DVertexShader;)V", line = 1278)
    ...
    @OriginalMember(owner = "client!tg", name = "K", descriptor = "(I)V", line = 1291)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IILbda;ILwt;)Ldh;", line = 1301)
    ...
    @OriginalMember(owner = "client!tg", name = "GA", descriptor = "(I)V", line = 1315)
    public final void method429(int arg0) {
        this.field3093.Clear(1, arg0, 0.0F, 0);
    }

    @OriginalMember(owner = "client!tg", name = "r", descriptor = "()Lcf;", line = 1330)
    ...
    @OriginalMember(owner = "client!tg", name = "I", descriptor = "(I)V", line = 1338)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IILik;IILgfa;I)V", line = 1349)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 1369)
    public final void method375(Rectangle[] arg0, int arg1, int arg2, int arg3) throws class76 {
        this.method435(arg2, arg3);
    }

    @OriginalMember(owner = "client!tg", name = "I", descriptor = "()I", line = 1376)
    public final int method382() {
        return 0;
    }

    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lms;I)I", line = 1384)
    ...
    @OriginalMember(owner = "client!tg", name = "r", descriptor = "(I)V", line = 1412)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lht;I)V", line = 1432)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Llb;I)V", line = 1457)
    ...
    @OriginalMember(owner = "client!tg", name = "G", descriptor = "(I)V", line = 1468)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IIILik;)V", line = 1480)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(Lwt;Lbda;I)I", line = 1493)
    ...
    @OriginalMember(owner = "client!tg", name = "w", descriptor = "()V", line = 1529)
    public final void method472() {
    }

    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(I[[IBZ)Lgw;", line = 1534)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILpc;)V", line = 1542)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(BZ)Lgfa;", line = 1584)
    ...
    @OriginalMember(owner = "client!tg", name = "gb", descriptor = "(I)Z", line = 1595)
    ...
    @OriginalMember(owner = "client!tg", name = "h", descriptor = "(Z)V", line = 1635)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILgf;)V", line = 1645)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(III[BZLbda;BI)Ldh;", line = 1669)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(II)V", line = 1679)
