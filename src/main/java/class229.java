...
public class class229 extends class220 {
    ...
    @OriginalMember(owner = "client!nj", name = "d", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!nj", name = "e", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IBLil;)V", line = 82)
    ...
    @OriginalMember(owner = "client!nj", name = "b", descriptor = "(BI)V", line = 170)
    ...
    @OriginalMember(owner = "client!nj", name = "c", descriptor = "(II)[I", line = 192)
    ...
    @OriginalMember(owner = "client!nj", name = "f", descriptor = "(I)V", line = 297)
    ...
    @OriginalMember(owner = "client!nj", name = "d", descriptor = "(II)I", line = 317)
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "()V", line = 331)
    public class229() {
        super(0, true);
    }
}
