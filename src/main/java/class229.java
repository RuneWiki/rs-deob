...
public abstract class class229 extends class86 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(ILtl;)Lts;")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lch;")
    ...
    @OriginalMember(owner = "client!j", name = "c", descriptor = "(I)Lrt;")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lqa;B)V")
