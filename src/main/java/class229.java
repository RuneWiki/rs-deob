...
public class class229 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "([BILkd;I)Loh;", line = 30)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(B)V", line = 108)
    ...
    @OriginalMember(owner = "client!ok", name = "c", descriptor = "(B)Z", line = 121)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Z)V", line = 134)
