...
public class class229 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ZI)Lrd;")
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lja;IZ)V")
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(BLlh;)[Ltn;")
