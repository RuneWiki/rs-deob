...
public class class229 {
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(Leh;I)V", line = 18)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(BLeh;Los;)Lqo;", line = 43)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(B)V", line = 89)
