...
public class class229 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(II)Ljj;")
    ...
    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(II)Lhu;")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Loj;La;IIIII)V")
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "(Lci;ILg;Lg;Lg;)V")
