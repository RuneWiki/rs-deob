...
public class class229 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IIB)Z", line = 5)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!wj", name = "b", descriptor = "(I)V", line = 49)
