...
public class class229 extends class395 implements class722 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!gj", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!gj", name = "m", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(B)I", line = 40)
    ...
    @OriginalMember(owner = "client!gj", name = "d", descriptor = "(B)V", line = 51)
    public static void method1358(byte arg0) {
        int var1 = -49 % ((43 - arg0) / 62);
        field3070 = null;
    }

    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(ZLha;)V", line = 61)
    ...
    @OriginalMember(owner = "client!gj", name = "n", descriptor = "(I)I", line = 73)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(BLha;ZILuq;II)V", line = 88)
    ...
    @OriginalMember(owner = "client!gj", name = "h", descriptor = "(I)Z", line = 120)
    ...
    @OriginalMember(owner = "client!gj", name = "<init>", descriptor = "(Lha;Lts;IIIIIZIIIIIIZ)V", line = 135)
    ...
    @OriginalMember(owner = "client!gj", name = "b", descriptor = "(Lha;B)Liha;", line = 169)
    ...
    @OriginalMember(owner = "client!gj", name = "q", descriptor = "(I)I", line = 184)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lha;ZBI)Lcn;", line = 196)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(ILha;IB)Z", line = 226)
    ...
    @OriginalMember(owner = "client!gj", name = "b", descriptor = "(I)I", line = 249)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lha;I)Lua;", line = 263)
    ...
    @OriginalMember(owner = "client!gj", name = "l", descriptor = "(I)Z", line = 292)
    ...
    @OriginalMember(owner = "client!gj", name = "d", descriptor = "(I)Z", line = 307)
    ...
    @OriginalMember(owner = "client!gj", name = "b", descriptor = "(B)Z", line = 318)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(ZIII)Z", line = 332)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IBLha;)Lka;", line = 358)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(I)I", line = 380)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(ILjava/lang/Object;Z)[B", line = 396)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lha;B)V", line = 433)
    ...
    @OriginalMember(owner = "client!gj", name = "c", descriptor = "(B)I", line = 461)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lha;Z)V", line = 472)
