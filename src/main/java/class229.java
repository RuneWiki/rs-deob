...
public class class229 {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IBIIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(II)V", line = 48)
