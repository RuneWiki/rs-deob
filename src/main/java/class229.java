...
public class class229 extends class478 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ILnp;I)V", line = 44)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ZZI)V", line = 93)
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "()V", line = 181)
    public class229() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ZI)[[I", line = 117)
