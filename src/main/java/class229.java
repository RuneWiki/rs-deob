...
public class class229 extends class14 {
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!sc", name = "e", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Lus;ILql;Lsq;IIII)V", line = 80)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(II)[[I", line = 169)
    ...
    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "()V", line = 212)
    public class229() {
        this(0);
    }

    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IBLmd;)V", line = 216)
    ...
    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "(I)V", line = 243)
    private class229(int arg0) {
        super(0, false);
        this.method1428(arg0, 121);
    }

    @OriginalMember(owner = "client!sc", name = "f", descriptor = "(I)V", line = 251)
    ...
    @OriginalMember(owner = "client!sc", name = "c", descriptor = "(III)I", line = 266)
