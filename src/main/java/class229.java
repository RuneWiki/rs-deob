...
public class class229 {
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(II)Ldr;", line = 48)
