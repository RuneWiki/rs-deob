...
public class class229 implements class762 {
    ...
    @OriginalMember(owner = "client!sba", name = "b", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "()V", line = 19)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "([BZI)Ljava/lang/Object;", line = 95)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(B)V", line = 131)
    public static void method1499(byte arg0) {
        int var1 = 76 / ((arg0 + 79) / 34);
        field3116 = null;
    }

    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(IZ)V", line = 140)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(II)V", line = 153)
    ...
    @OriginalMember(owner = "client!sba", name = "<init>", descriptor = "(Laia;)V", line = 163)
    public class229(class241 arg0) {
        this.field3120 = arg0;
    }

    @OriginalMember(owner = "client!sba", name = "c", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(I)V", line = 190)
