...
public class class229 extends class371 {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Lea;IJIILvg;III)V", line = 4)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IIIIIIIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(III)I", line = 89)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Lkp;ILkp;)V", line = 108)
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(III)Z", line = 125)
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(B)V", line = 136)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IIIIIIII)V", line = 147)
    ...
    @OriginalMember(owner = "client!sc", name = "c", descriptor = "(III)Lvg;", line = 271)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Loq;I)V", line = 293)
