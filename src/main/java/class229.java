...
public abstract class class229 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!up", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 3)
    ...
    @OriginalMember(owner = "client!up", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 20)
    ...
    @OriginalMember(owner = "client!up", name = "stop", descriptor = "()V", line = 31)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Z)Z", line = 45)
    ...
    @OriginalMember(owner = "client!up", name = "start", descriptor = "()V", line = 83)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(B)Ljava/lang/String;", line = 95)
    public String method1304(byte arg0) {
        field2824++;
        return arg0 >= -108 ? null : null;
    }

    @OriginalMember(owner = "client!up", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 106)
    public final void windowClosed(WindowEvent arg0) {
        field2819++;
    }

    @OriginalMember(owner = "client!up", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 114)
    ...
    @OriginalMember(owner = "client!up", name = "b", descriptor = "(I)Z", line = 131)
    ...
    @OriginalMember(owner = "client!up", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 144)
    public final void update(Graphics arg0) {
        this.paint(arg0);
        field2834++;
    }

    @OriginalMember(owner = "client!up", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 154)
    ...
    @OriginalMember(owner = "client!up", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 180)
    public final void windowDeactivated(WindowEvent arg0) {
        field2813++;
    }

    @OriginalMember(owner = "client!up", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 187)
    ...
    @OriginalMember(owner = "client!up", name = "providesignlink", descriptor = "(Lpq;)V", line = 203)
    ...
    @OriginalMember(owner = "client!up", name = "c", descriptor = "(I)V", line = 211)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IIIII)V", line = 257)
    ...
    @OriginalMember(owner = "client!up", name = "e", descriptor = "(I)V", line = 306)
    ...
    @OriginalMember(owner = "client!up", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 356)
    public final void windowDeiconified(WindowEvent arg0) {
        field2821++;
    }

    @OriginalMember(owner = "client!up", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 363)
    public final void windowClosing(WindowEvent arg0) {
        this.destroy();
        field2838++;
    }

    @OriginalMember(owner = "client!up", name = "destroy", descriptor = "()V", line = 371)
    ...
    @OriginalMember(owner = "client!up", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 389)
    public final void windowIconified(WindowEvent arg0) {
        field2836++;
    }

    @OriginalMember(owner = "client!up", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 400)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IZ)V", line = 416)
    ...
    @OriginalMember(owner = "client!up", name = "h", descriptor = "(I)V", line = 493)
    ...
    @OriginalMember(owner = "client!up", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 525)
    public final void focusLost(FocusEvent arg0) {
        class225.field2768 = false;
        field2828++;
    }

    @OriginalMember(owner = "client!up", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 534)
    public final void windowOpened(WindowEvent arg0) {
        field2830++;
    }

    @OriginalMember(owner = "client!up", name = "run", descriptor = "()V", line = 544)
    ...
    @OriginalMember(owner = "client!up", name = "i", descriptor = "(I)Z", line = 666)
    ...
    @OriginalMember(owner = "client!up", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 702)
    ...
    @OriginalMember(owner = "client!up", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 724)
    public final void windowActivated(WindowEvent arg0) {
        field2832++;
    }

    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IIZLjava/lang/String;IIZI)V", line = 731)
