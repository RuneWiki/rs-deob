...
public class class229 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IIIILya;BIIII)V")
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(BLya;I)Z")
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(I[Lmc;IIII)V")
