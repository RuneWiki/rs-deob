...
public class class229 extends class398 {
    ...
    @OriginalMember(owner = "client!oe", name = "f", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "()V", line = 30)
    public class229() {
        this(4096);
    }

    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(II)[I", line = 36)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lnj;II)V", line = 59)
    ...
    @OriginalMember(owner = "client!oe", name = "c", descriptor = "(II)V", line = 90)
