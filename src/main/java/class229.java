...
public class class229 extends class72 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILfca;Luw;Lak;IIII)V")
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(Lcq;)V")
    public class229(class464 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(ILcq;)V")
