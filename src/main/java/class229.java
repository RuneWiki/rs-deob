...
public class class229 extends class481 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(IB)Z", line = 41)
    ...
    @OriginalMember(owner = "client!kg", name = "c", descriptor = "(III)I", line = 59)
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!kg", name = "c", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "(Llp;)V", line = 618)
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(B)I", line = 170)
    ...
    @OriginalMember(owner = "client!kg", name = "e", descriptor = "(II)I", line = 347)
    ...
    @OriginalMember(owner = "client!kg", name = "c", descriptor = "(B)V", line = 367)
    ...
    @OriginalMember(owner = "client!kg", name = "f", descriptor = "(II)I", line = 401)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Llp;B)V", line = 449)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(BI)Z", line = 488)
    ...
    @OriginalMember(owner = "client!kg", name = "g", descriptor = "(I)I", line = 506)
    ...
    @OriginalMember(owner = "client!kg", name = "h", descriptor = "(I)V", line = 572)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Z)V", line = 583)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(BZ)V", line = 704)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lgw;Z)V", line = 719)
