...
public class class229 extends class748 {
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IZLvj;)V", line = 5)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;)V", line = 40)
    ...
    @OriginalMember(owner = "client!gj", name = "b", descriptor = "(II)[[I", line = 50)
    ...
    @OriginalMember(owner = "client!gj", name = "g", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!gj", name = "d", descriptor = "(B)V", line = 144)
    ...
    @OriginalMember(owner = "client!gj", name = "<init>", descriptor = "()V", line = 161)
    public class229() {
        super(1, false);
    }
}
