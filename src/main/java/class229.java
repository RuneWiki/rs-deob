...
public class class229 extends class584 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(ZZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!sr", name = "d", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IIIIIIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!sr", name = "c", descriptor = "(B)Z", line = 79)
    ...
    @OriginalMember(owner = "client!sr", name = "f", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(III)V", line = 117)
    ...
    @OriginalMember(owner = "client!sr", name = "b", descriptor = "(ZI)V", line = 129)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(ILld;B)V", line = 160)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(Lfo;)V", line = 181)
