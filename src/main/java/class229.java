...
public class class229 {
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IIIBII)V", line = 7)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(II)V", line = 111)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IJ)V", line = 136)
