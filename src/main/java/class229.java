...
public class class229 {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(IIIZLtq;)V", line = 15)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(II)V", line = 88)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(BI)Z", line = 105)
    ...
    @OriginalMember(owner = "client!du", name = "b", descriptor = "(B)V", line = 121)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "([Ljava/lang/Object;B[J)V", line = 138)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(IB)Lk;", line = 149)
    ...
    @OriginalMember(owner = "client!du", name = "b", descriptor = "(II)V", line = 177)
    ...
    @OriginalMember(owner = "client!du", name = "<init>", descriptor = "(Lcm;ILlt;)V", line = 195)
