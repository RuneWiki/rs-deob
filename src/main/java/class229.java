...
public class class229 extends class765 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Ldm;)V")
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "()Ldm;")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IIBLka;I)Lmg;")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ZLdm;)V")
