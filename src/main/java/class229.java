...
public class class229 extends class570 {
    ...
    @OriginalMember(owner = "client!rl", name = "c", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!rl", name = "<init>", descriptor = "(Lrs;II[B)V", line = 36)
