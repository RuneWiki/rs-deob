...
public class class229 extends class352 {
    ...
    @OriginalMember(owner = "client!ga", name = "b", descriptor = "(II)Ldi;", line = 5)
    ...
    @OriginalMember(owner = "client!ga", name = "d", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!ga", name = "g", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!ga", name = "h", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!ga", name = "c", descriptor = "(B)I", line = 109)
    ...
    @OriginalMember(owner = "client!ga", name = "f", descriptor = "(I)[B", line = 129)
