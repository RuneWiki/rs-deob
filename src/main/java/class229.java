...
public abstract class class229 {
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "([IIII[ILjava/lang/String;ILjava/util/Random;IBIIII[Ldp;)I", line = 6)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Lak;Lke;)V", line = 83)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Ljava/lang/String;IIIIII)V", line = 1207)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(B)V", line = 1236)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Ljava/lang/String;IIIII)V", line = 1428)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ILjava/lang/String;)V", line = 1445)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IIILjava/lang/String;IILus;[IIIII[Ldp;III)I", line = 1522)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "([I[II[IIILjava/lang/String;[Ldp;)V", line = 1608)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IIIBLjava/lang/String;I)V", line = 1773)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Ljava/lang/String;IB)V", line = 1789)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IZ)V", line = 1826)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ILjava/lang/String;IBII)V", line = 2050)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ILjava/lang/String;IIIII)V", line = 2067)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(I)V", line = 2100)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Ljava/lang/String;IIIIIII)V", line = 2113)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IIB)V", line = 2149)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ZLui;I)Lmd;", line = 2169)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "([BI)[B", line = 2191)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Ljava/lang/String;IIIII[I[Ldp;)V", line = 2243)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IILjava/lang/String;[Ldp;[IIIILus;)V", line = 2262)
    ...
    @OriginalMember(owner = "client!tr", name = "<init>", descriptor = "(Ltq;Lis;)V", line = 2412)
    public class229(class63 arg0, class1 arg1) {
        this.field3350 = arg1;
        this.field3368 = arg0;
    }

    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(III[Ldp;ILjava/lang/String;ZILjava/util/Random;[I)I", line = 2421)
