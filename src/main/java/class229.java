...
public class class229 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IZIII)Lkaa;")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(BI)Lvl;")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lbt;Lha;Z)V")
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Lmja;ILbt;Lls;)V")
