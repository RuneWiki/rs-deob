...
public class class229 extends class137 implements MouseWheelListener {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 5)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Z)I", line = 16)
    ...
    @OriginalMember(owner = "client!ga", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 33)
    public final synchronized void mouseWheelMoved(MouseWheelEvent arg0) {
        this.field3829 += arg0.getWheelRotation();
    }

    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Ljava/awt/Component;Z)V", line = 40)
