...
public class class229 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Z)I", line = 15)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IB)Z", line = 46)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Lps;I)V", line = 93)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIII)V", line = 170)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(BII)Z", line = 269)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Lps;II)V", line = 340)
