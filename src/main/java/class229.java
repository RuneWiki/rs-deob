...
public class class229 extends class66 {
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(IIZI)V", line = 7)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(BI)V", line = 26)
    ...
    @OriginalMember(owner = "client!gca", name = "b", descriptor = "(BI)V", line = 40)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(IIIIF)V", line = 52)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(II)V", line = 173)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(B)V", line = 196)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(I)V", line = 211)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(I[II)V", line = 233)
    ...
    @OriginalMember(owner = "client!gca", name = "<init>", descriptor = "(Lhm;IIIII)V", line = 397)
