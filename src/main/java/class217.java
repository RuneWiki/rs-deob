...
public class class217 extends class144 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IIZZIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(II[I[I)V", line = 35)
    public class217(int arg0, int arg1, int[] arg2, int[] arg3) {
        this.field2954 = arg2;
        this.field2953 = arg3;
    }

    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(B)V", line = 50)
