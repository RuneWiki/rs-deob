...
public abstract class class217 extends class674 {
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(I[Lkb;)I", line = 7)
    ...
    @OriginalMember(owner = "client!fw", name = "b", descriptor = "(Z)Z", line = 85)
    ...
    @OriginalMember(owner = "client!fw", name = "l", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(III)V", line = 111)
    ...
    @OriginalMember(owner = "client!fw", name = "c", descriptor = "(Lha;I)V", line = 126)
    ...
    @OriginalMember(owner = "client!fw", name = "<init>", descriptor = "(IIIIII)V", line = 141)
    ...
    @OriginalMember(owner = "client!fw", name = "i", descriptor = "(I)Z", line = 157)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(IIIII)V", line = 171)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(III[BII)V", line = 231)
