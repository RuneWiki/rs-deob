...
public class class217 {
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IIII)Z", line = 9)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(III)V", line = 60)
