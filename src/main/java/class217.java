...
public class class217 extends class477 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Ldga;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(CI)I", line = 25)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(BILdga;)V", line = 62)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(CI)I", line = 158)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(III)Z", line = 196)
