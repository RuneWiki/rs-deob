...
public class class217 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lpe;[II[I[I)V", line = 48)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(I)Z", line = 52)
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(I)V", line = 135)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "()V", line = 180)
    public static void method1483() {
        field2995 = null;
    }

    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lpe;[II)V", line = 183)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "([III)V", line = 190)
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "()V", line = 240)
    private static final void method1486() {
        field2998 = 0;
    }

    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lpe;[IIII[I[I)V", line = 246)
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(II)V", line = 282)
