...
public abstract class class217 extends class280 {
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(Lqk;ZI)V")
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(ILjw;Lha;BIZI)V")
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(I[Lwh;)I")
