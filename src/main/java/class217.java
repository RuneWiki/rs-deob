...
public class class217 extends class115 {
    ...
    @OriginalMember(owner = "client!bp", name = "e", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(IIIIILdl;IIIII)Z")
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lmr;")
