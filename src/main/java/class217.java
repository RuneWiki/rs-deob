...
public class class217 extends class362 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lkg;")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IB[ILff;)V")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lhs;[I[BI)Z")
