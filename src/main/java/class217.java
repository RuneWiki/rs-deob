...
public class class217 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IBI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ZZLht;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(B)V", line = 87)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(BLqq;)V", line = 98)
