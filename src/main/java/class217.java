...
public class class217 extends class499 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(I)Leu;", line = 5)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(Lja;Lmea;IIIIIIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!lf", name = "c", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(II)V", line = 42)
