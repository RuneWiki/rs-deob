...
public class class217 extends class269 {
    ...
    @OriginalMember(owner = "client!se", name = "g", descriptor = "(I)Ljava/lang/Object;", line = 6)
    public final Object method1429(int arg0) {
        int var2 = -46 / ((-arg0 - 23) / 38);
        return this.field2987.get();
    }

    @OriginalMember(owner = "client!se", name = "a", descriptor = "(I)Z", line = 14)
    ...
    @OriginalMember(owner = "client!se", name = "<init>", descriptor = "(Luk;Ljava/lang/Object;I)V", line = 23)
