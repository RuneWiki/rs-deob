...
public class class217 {
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(BLgga;)V")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(II)Lnga;")
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Ljk;ILae;)V")
