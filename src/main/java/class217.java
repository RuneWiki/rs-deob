...
public class class217 {
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(ILgk;)V", line = 3)
    ...
    @OriginalMember(owner = "client!mba", name = "<init>", descriptor = "()V", line = 46)
    public class217() {
    }

    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(I)Lgga;", line = 50)
    ...
    @OriginalMember(owner = "client!mba", name = "b", descriptor = "(Z)V", line = 70)
    ...
    @OriginalMember(owner = "client!mba", name = "c", descriptor = "(Z)Lgga;", line = 81)
    ...
    @OriginalMember(owner = "client!mba", name = "<init>", descriptor = "(Lgk;)V", line = 100)
