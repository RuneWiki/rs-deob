...
public class class217 implements class336 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(II)V", line = 22)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IILjp;I)V", line = 38)
    ...
    @OriginalMember(owner = "client!bb", name = "e", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ILnm;III)V", line = 97)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IILnm;I)V", line = 130)
    public final void method1435(int arg0, int arg1, class329 arg2, int arg3) {
        field3122++;
        this.method1434(arg3, arg2, -48, arg0, arg1);
    }

    @OriginalMember(owner = "client!bb", name = "finalize", descriptor = "()V", line = 138)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ZI)V", line = 147)
    ...
    @OriginalMember(owner = "client!bb", name = "c", descriptor = "(B)V", line = 175)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Lec;II)V", line = 189)
    ...
    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "(Lqg;)V", line = 423)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Z)I", line = 229)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IIIII)V", line = 241)
    ...
    @OriginalMember(owner = "client!bb", name = "f", descriptor = "(B)V", line = 269)
    ...
    @OriginalMember(owner = "client!bb", name = "g", descriptor = "(B)I", line = 284)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(I)Z", line = 307)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(II)V", line = 332)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(ZI)Lrm;", line = 351)
    ...
    @OriginalMember(owner = "client!bb", name = "d", descriptor = "(B)V", line = 379)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "([IIIII)V", line = 396)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(BLjp;I)V", line = 440)
