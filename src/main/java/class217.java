...
public class class217 {
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!uga", name = "b", descriptor = "(B)Lju;", line = 19)
    ...
    @OriginalMember(owner = "client!uga", name = "<init>", descriptor = "(Lcb;Lcb;)V", line = 36)
    public class217(class544 arg0, class544 arg1) {
        this.field3109 = arg0;
        this.field3112 = arg1;
    }

    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(ILlt;)Llp;", line = 49)
