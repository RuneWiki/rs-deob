...
public class class217 extends class508 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIB)Z", line = 19)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "([B)V", line = 29)
