...
public class class217 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IIZLmg;III)V", line = 4)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IB)I", line = 44)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(II)Z", line = 77)
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(II)V", line = 114)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(III)Leq;", line = 138)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "([Ljava/lang/Object;IBI[J)V", line = 158)
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(I)V", line = 228)
