...
public class class217 extends class205 {
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IIB)V", line = 15)
    ...
    @OriginalMember(owner = "client!oc", name = "c", descriptor = "(III)Z", line = 45)
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(III)V", line = 68)
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 81)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(III)V", line = 99)
