...
public class class217 extends class450 {
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Lup;)V", line = 7)
    public class217(class278 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Z)I", line = 25)
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(Z)I", line = 36)
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(B)V", line = 53)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IIB)Z", line = 63)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(ZI)V", line = 76)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(II)I", line = 87)
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(ILup;)V", line = 98)
