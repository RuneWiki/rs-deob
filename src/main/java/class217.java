...
public abstract class class217 {
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(II)I", line = 3)
    public static int method1381(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IIIIIIIIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(I)V", line = 56)
