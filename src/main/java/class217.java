...
public class class217 extends class335 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(B)J", line = 3)
    public final long method160(byte arg0) {
        return arg0 <= 2 ? 23L : this.field2837;
    }

    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "()V", line = 115)
    public class217() {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IJ)I", line = 30)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(I)J", line = 65)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Z)J", line = 81)
