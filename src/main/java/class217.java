...
public abstract class class217 {
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(IB)V", line = 6)
    ...
    @OriginalMember(owner = "client!cha", name = "<init>", descriptor = "(III)V", line = 34)
    ...
    @OriginalMember(owner = "client!cha", name = "b", descriptor = "(IB)Z", line = 44)
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(Z)V", line = 60)
