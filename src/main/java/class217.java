...
public class class217 extends class471 {
    ...
    @OriginalMember(owner = "client!gg", name = "b", descriptor = "()V", line = 11)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(J)V", line = 23)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(JI)V", line = 151)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Lpj;IIIIIIIIIIIZZ)V", line = 553)
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Lpj;IIIIIIIIIIIZZ)V", line = 571)
