...
public class class217 extends class182 {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(ZZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!mr", name = "c", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(ILvfa;B)V", line = 40)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(III)V", line = 52)
    ...
    @OriginalMember(owner = "client!mr", name = "b", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!mr", name = "b", descriptor = "(B)Z", line = 172)
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(Lag;)V", line = 188)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(ZI)V", line = 304)
