...
public class class217 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ZZI)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IB)Lak;", line = 43)
    ...
    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "(Llf;ILvh;)V", line = 79)
    public class217(class157 arg0, int arg1, class240 arg2) {
        this.field3072 = arg2;
        this.field3072.method1397((byte) -126, 5);
    }

    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(II)V", line = 94)
