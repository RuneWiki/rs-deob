...
public class class217 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(BIIILvk;Lvc;I)Ln;", line = 20)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lve;B)V", line = 125)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ILkk;)V", line = 188)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ILkk;I)V", line = 216)
