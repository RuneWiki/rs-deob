...
public class class217 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!pi", name = "b", descriptor = "(B)V", line = 181)
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(Z)V", line = 302)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(ILrs;)V", line = 194)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(B)V", line = 260)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(ILjc;)Lvaa;", line = 290)
