...
public class class217 extends class284 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 3)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(B)[B", line = 16)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(II)V", line = 111)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(IIB)V", line = 126)
    ...
    @OriginalMember(owner = "client!bb", name = "g", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IIIIIILqa;IZ)V", line = 181)
    ...
    @OriginalMember(owner = "client!bb", name = "e", descriptor = "(I)I", line = 316)
