...
public class class248 implements Runnable {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Ljava/lang/Runnable;BI)Lth;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IZLjava/lang/String;Ljava/lang/String;)Lro;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ZIILjava/lang/String;)Lth;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Ljava/awt/Point;Ljava/awt/Component;[IIII)Lth;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "([Ljava/lang/Class;ILjava/lang/Class;Ljava/lang/String;)Lth;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(BLjava/lang/String;Z)Lth;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Ljava/lang/String;I)Lth;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IIIIB)Lth;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILjava/awt/Frame;)Lth;")
    public final class621 method1551(int arg0, Frame arg1) {
        return arg0 < 101 ? null : this.method1553(0, 0, 7, arg1, (byte) 56);
    }

    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;I)Lth;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IIILjava/lang/Object;B)Lth;")
