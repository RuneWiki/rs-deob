...
public class class248 implements class389 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(II)I", line = 6)
    public static int method1593(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(ZZ)V", line = 41)
    ...
    @OriginalMember(owner = "client!ke", name = "b", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "(Lvo;Lju;)V", line = 96)
    public class248(class345 arg0, class352 arg1) {
        this.field3607 = arg0;
        this.field3605 = arg1;
    }

    @OriginalMember(owner = "client!ke", name = "b", descriptor = "(I)Z", line = 106)
