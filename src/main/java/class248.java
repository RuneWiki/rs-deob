...
public class class248 extends class501 {
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(ILfh;)Z")
    ...
    @OriginalMember(owner = "client!pa", name = "<init>", descriptor = "(Lbo;II[BI)V")
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IBLit;)V")
