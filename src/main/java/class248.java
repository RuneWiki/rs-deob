...
public class class248 extends class696 {
    ...
    @OriginalMember(owner = "client!cka", name = "Q", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(Ltn;BLds;)Z", line = 16)
    ...
    @OriginalMember(owner = "client!cka", name = "l", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!cka", name = "d", descriptor = "(II)V", line = 40)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(IIII)V", line = 64)
    public final void method983(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(Lds;ILtn;)Z", line = 67)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(BILcq;)V", line = 80)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(Lmd;)V", line = 91)
    public final void method905(class649 arg0) {
    }

    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(Ljava/lang/Object;Ljava/awt/Canvas;Z)V", line = 95)
    ...
    @OriginalMember(owner = "client!cka", name = "b", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!cka", name = "b", descriptor = "(Z)V", line = 120)
    public final void method934(boolean arg0) {
    }

    @OriginalMember(owner = "client!cka", name = "jb", descriptor = "(I)Z", line = 124)
    ...
    @OriginalMember(owner = "client!cka", name = "h", descriptor = "(B)V", line = 164)
    ...
    @OriginalMember(owner = "client!cka", name = "r", descriptor = "()Z", line = 174)
    public final boolean method926() {
        return false;
    }

    @OriginalMember(owner = "client!cka", name = "l", descriptor = "(Z)V", line = 181)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(Lmja;I)V", line = 191)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(Ljf;B)I", line = 214)
    ...
    @OriginalMember(owner = "client!cka", name = "y", descriptor = "(I)V", line = 243)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(I[Lls;)Lco;", line = 256)
    public final class753 method1175(int arg0, class592[] arg1) {
        int var3 = -56 % ((arg0 + 52) / 47);
        return new dxVertexLayout(this, arg1);
    }

    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(Ljagdx/D3DPRESENT_PARAMETERS;BIILjagdx/IDirect3D;I)Z", line = 268)
    ...
    @OriginalMember(owner = "client!cka", name = "k", descriptor = "(Z)V", line = 371)
    ...
    @OriginalMember(owner = "client!cka", name = "j", descriptor = "(B)V", line = 388)
    ...
    @OriginalMember(owner = "client!cka", name = "o", descriptor = "(I)V", line = 424)
    ...
    @OriginalMember(owner = "client!cka", name = "I", descriptor = "()I", line = 435)
    public final int method950() {
        return 0;
    }

    @OriginalMember(owner = "client!cka", name = "c", descriptor = "(ZI)V", line = 442)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(Lhu;ZII)V", line = 452)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "([[IIZI)Llha;", line = 469)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(Lco;I)V", line = 480)
    ...
    @OriginalMember(owner = "client!cka", name = "s", descriptor = "(I)V", line = 494)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(Ljagdx/IDirect3DPixelShader;B)V", line = 504)
    ...
    @OriginalMember(owner = "client!cka", name = "na", descriptor = "(IIII)[I", line = 517)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(BLae;)V", line = 557)
    ...
    @OriginalMember(owner = "client!cka", name = "W", descriptor = "(I)V", line = 598)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(Ltea;Ltea;FLtea;)Ltea;", line = 609)
    public final class589 method920(class589 arg0, class589 arg1, float arg2, class589 arg3) {
        return arg2 < 0.5F ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!cka", name = "a", descriptor = "()Lfga;", line = 617)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(BZ)Lcq;", line = 625)
    ...
    @OriginalMember(owner = "client!cka", name = "m", descriptor = "(I)V", line = 636)
    ...
    @OriginalMember(owner = "client!cka", name = "S", descriptor = "(I)V", line = 674)
    ...
    @OriginalMember(owner = "client!cka", name = "f", descriptor = "(ZI)V", line = 685)
    ...
    @OriginalMember(owner = "client!cka", name = "V", descriptor = "(I)V", line = 695)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(Liea;I)V", line = 761)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(Lod;Lic;)Lmd;", line = 784)
    public final class649 method878(class539 arg0, class537 arg1) {
        return null;
    }

    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(Lhu;B)I", line = 792)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(Lov;B)V", line = 824)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(ILds;IILtn;)Lw;", line = 847)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 857)
    public final void method931(Rectangle[] arg0, int arg1, int arg2, int arg3) throws class15 {
        this.method925(arg2, arg3);
    }

    @OriginalMember(owner = "client!cka", name = "g", descriptor = "(B)V", line = 864)
    ...
    @OriginalMember(owner = "client!cka", name = "F", descriptor = "(I)V", line = 874)
    ...
    @OriginalMember(owner = "client!cka", name = "c", descriptor = "(II)Lod;", line = 885)
    public final class539 method1001(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!cka", name = "T", descriptor = "(I)F", line = 894)
    public final float method1169(int arg0) {
        return arg0 <= 115 ? -0.17210132F : -0.5F;
    }

    @OriginalMember(owner = "client!cka", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/iw;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Lsq;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Ld;Lwm;I)V", line = 903)
    ...
    @OriginalMember(owner = "client!cka", name = "d", descriptor = "(B)V", line = 950)
    ...
    @OriginalMember(owner = "client!cka", name = "D", descriptor = "(I)V", line = 972)
    ...
    @OriginalMember(owner = "client!cka", name = "n", descriptor = "()V", line = 981)
    public final void method970() {
    }

    @OriginalMember(owner = "client!cka", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Ld;Lwm;Ljava/lang/Integer;)Lha;", line = 985)
    ...
    @OriginalMember(owner = "client!cka", name = "l", descriptor = "()V", line = 1086)
    public final void method919() {
        this.field3405.method2543(-95);
        super.method919();
    }

    @OriginalMember(owner = "client!cka", name = "k", descriptor = "(B)V", line = 1096)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(IILtn;I[BI)Lii;", line = 1132)
    ...
    @OriginalMember(owner = "client!cka", name = "l", descriptor = "(B)V", line = 1143)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(IZLcja;I)V", line = 1180)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(Lcja;I)I", line = 1222)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(IIILhu;ZLjj;I)V", line = 1248)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(ZLjava/awt/Canvas;)Ljava/lang/Object;", line = 1267)
    public final Object method1183(boolean arg0, Canvas arg1) {
        return arg0 ? null : (Object) null;
    }

    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(Lkka;B)I", line = 1278)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(ILjagdx/IDirect3DVertexShader;)V", line = 1312)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "([BILtn;ZIIIB)Lw;", line = 1324)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(ILds;Ltn;)I", line = 1334)
    ...
    @OriginalMember(owner = "client!cka", name = "ya", descriptor = "()V", line = 1374)
    public final void method937() {
        this.method3766((byte) -25, true);
        this.field3402.Clear(2, 0, 1.0F, 0);
    }

    @OriginalMember(owner = "client!cka", name = "p", descriptor = "(I)V", line = 1382)
    ...
    @OriginalMember(owner = "client!cka", name = "e", descriptor = "(II)Lic;", line = 1391)
    public final class537 method938(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!cka", name = "t", descriptor = "()Z", line = 1399)
    public final boolean method899() {
        return false;
    }

    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(ILjava/lang/Object;Ljava/awt/Canvas;)V", line = 1406)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(BI)Ltu;", line = 1432)
    ...
    @OriginalMember(owner = "client!cka", name = "z", descriptor = "(I)V", line = 1473)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(IZI[FIILtn;I)Lw;", line = 1486)
    ...
    @OriginalMember(owner = "client!cka", name = "o", descriptor = "()V", line = 1498)
    ...
    @OriginalMember(owner = "client!cka", name = "u", descriptor = "()V", line = 1521)
    public final void method999() {
    }

    @OriginalMember(owner = "client!cka", name = "b", descriptor = "(IIIID)V", line = 1524)
    public final void method894(int arg0, int arg1, int arg2, int arg3, double arg4) {
    }

    @OriginalMember(owner = "client!cka", name = "q", descriptor = "(B)V", line = 1527)
    public final void method1171(byte arg0) {
        this.field3402.method4173(7, this.field9174);
        int var2 = -1 % ((-arg0 - 75) / 48);
    }

    @OriginalMember(owner = "client!cka", name = "y", descriptor = "()V", line = 1535)
    public final void method962() {
    }

    @OriginalMember(owner = "client!cka", name = "F", descriptor = "(II)V", line = 1537)
    public final void method988(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(ZI)Ljj;", line = 1541)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(Ljava/lang/Object;Ljava/awt/Canvas;B)V", line = 1551)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(Lqt;B)I", line = 1564)
    ...
    @OriginalMember(owner = "client!cka", name = "w", descriptor = "(I)V", line = 1580)
    ...
    @OriginalMember(owner = "client!cka", name = "z", descriptor = "()V", line = 1619)
    public final void method891() {
    }

    @OriginalMember(owner = "client!cka", name = "fb", descriptor = "(I)V", line = 1622)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(IILcja;ZZ)V", line = 1649)
    ...
    @OriginalMember(owner = "client!cka", name = "n", descriptor = "(B)V", line = 1689)
