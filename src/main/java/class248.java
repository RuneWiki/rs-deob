...
public class class248 extends class529 {
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IZII)[B", line = 7)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(Ljava/lang/String;B)Ljava/lang/Class;", line = 22)
    ...
    @OriginalMember(owner = "client!rr", name = "b", descriptor = "(Z)V", line = 61)
    ...
    @OriginalMember(owner = "client!rr", name = "<init>", descriptor = "()V", line = 74)
    public class248() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(BIB)V", line = 77)
