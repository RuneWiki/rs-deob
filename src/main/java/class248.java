...
public class class248 implements Runnable {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Lv;II[B)Lmn;", line = 6)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/Throwable;)V", line = 64)
    ...
    @OriginalMember(owner = "client!ro", name = "run", descriptor = "()V", line = 116)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ZILv;)Lmn;", line = 162)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(I)V", line = 185)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ILmn;)V", line = 197)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(B)I", line = 213)
    ...
    @OriginalMember(owner = "client!ro", name = "c", descriptor = "(I)V", line = 227)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(BILv;)Lmn;", line = 247)
    ...
    @OriginalMember(owner = "client!ro", name = "<init>", descriptor = "(Lwd;)V", line = 295)
