...
public class class248 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(ILbc;)Z", line = 17)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "([[II)V", line = 59)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(JZII)V", line = 79)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(II)V", line = 123)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Lgh;II)Ljava/lang/String;", line = 135)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IIIII)V", line = 169)
