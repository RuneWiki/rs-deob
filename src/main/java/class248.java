...
public class class248 extends class356 {
    ...
    @OriginalMember(owner = "client!vea", name = "b", descriptor = "(III)Lfj;", line = 4)
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!vea", name = "<init>", descriptor = "(Lme;)V", line = 24)
