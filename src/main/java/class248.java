...
public class class248 extends class314 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(BLie;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(II)[I", line = 47)
    ...
    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "()V", line = 113)
    public class248() {
        super(1, false);
    }

    @OriginalMember(owner = "client!jl", name = "b", descriptor = "(B)V", line = 96)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IB)[[I", line = 117)
