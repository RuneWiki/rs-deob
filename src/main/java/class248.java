...
public class class248 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(BLbt;)V")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(ILbt;I)V")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IILwm;BILgp;I)Lgn;")
