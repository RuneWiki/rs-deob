...
public class class248 extends class55 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IILfe;)V")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lrba;)V")
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(Lij;)V")
