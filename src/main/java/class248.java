...
public class class248 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Lza;)V")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Lza;Lbc;)V")
    ...
    @OriginalMember(owner = "client!bc", name = "b", descriptor = "(Lza;Lbc;)Z")
    public final boolean method1537(class287 arg0, class248 arg1) {
        return this.field3276 != null || this.method1541(arg0, arg1);
    }

    @OriginalMember(owner = "client!bc", name = "b", descriptor = "(Lza;)V")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Lza;IIIIII)V")
    ...
    @OriginalMember(owner = "client!bc", name = "c", descriptor = "(Lza;Lbc;)Z")
    ...
    @OriginalMember(owner = "client!bc", name = "d", descriptor = "(Lza;Lbc;)V")
