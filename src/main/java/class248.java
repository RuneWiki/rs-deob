...
public class class248 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IIIIIII)I", line = 8)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ILbt;)Ljava/lang/String;", line = 57)
