...
public class class248 implements Runnable {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IIIIB)Lnga;", line = 6)
    ...
    @OriginalMember(owner = "client!wd", name = "run", descriptor = "()V", line = 18)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/lang/String;IZ)Lnga;", line = 316)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/lang/String;BLjava/lang/String;I)Lvba;", line = 330)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(B)V", line = 375)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/net/URL;Z)Lnga;", line = 394)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/awt/Frame;I)Lnga;", line = 404)
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(ILjava/lang/String;IZ)V", line = 701)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IZILjava/lang/String;)Lnga;", line = 418)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/lang/String;[Ljava/lang/Class;ILjava/lang/Class;)Lnga;", line = 431)
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(B)Ljava/lang/Object;", line = 443)
    public final Object method1512(byte arg0) {
        return arg0 == 65 ? this.field3417 : null;
    }

    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(BI)Lnga;", line = 453)
    public final class477 method1513(byte arg0, int arg1) {
        return arg0 == -57 ? this.method1517(0, null, 3, arg1, arg0 ^ 0xFFFFFFCD) : null;
    }

    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;I)Lnga;", line = 467)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(I)V", line = 477)
    ...
    @OriginalMember(owner = "client!wd", name = "c", descriptor = "(B)Z", line = 533)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ILjava/lang/Object;III)Lnga;", line = 550)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/lang/String;Z)Lvba;", line = 586)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(B[BLjava/io/File;)Z", line = 602)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/awt/Component;II[ILjava/awt/Point;I)Lnga;", line = 622)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/lang/Runnable;II)Lnga;", line = 656)
    public final class477 method1521(Runnable arg0, int arg1, int arg2) {
        return arg2 <= 43 ? null : this.method1517(0, arg0, 2, arg1, 10);
    }

    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/lang/String;I)Lnga;", line = 669)
    public final class477 method1522(String arg0, int arg1) {
        return arg1 >= -89 ? null : this.method1517(0, arg0, 16, 0, 10);
    }

    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(I)Lnga;", line = 685)
