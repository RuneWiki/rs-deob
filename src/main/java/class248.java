...
public class class248 extends class406 {
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Ltq;ZII)Ltr;", line = 17)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lae;Z)V", line = 40)
