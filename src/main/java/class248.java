...
public class class248 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(ILfp;)V")
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lfp;Lje;III)V")
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(BLkg;)Lkg;")
