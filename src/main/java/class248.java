...
public class class248 extends class362 {
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(ILfca;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "([Lcn;II)V")
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lfca;II)V")
