...
public class class248 extends class136 {
    ...
    @OriginalMember(owner = "client!vk", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IILiv;)V", line = 18)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Lrs;I)V", line = 55)
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "()V", line = 531)
    public class248() {
        super(1, false);
    }

    @OriginalMember(owner = "client!vk", name = "f", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(BI)[[I", line = 534)
