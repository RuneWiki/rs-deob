...
public class class248 {
    ...
    @OriginalMember(owner = "client!jea", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field3690++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(IIZJ)Ljava/lang/String;", line = 13)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(IIIIIII)V", line = 49)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(Laia;Lqk;I)Liaa;", line = 95)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(B)V", line = 131)
    ...
    @OriginalMember(owner = "client!jea", name = "b", descriptor = "(B)I", line = 150)
