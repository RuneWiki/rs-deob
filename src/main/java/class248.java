...
public class class248 extends class184 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Ljava/awt/Component;BZ)Ljs;", line = 37)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "()V", line = 51)
    public static final void method1506() {
        class522.method3102(1, class524.field7753);
    }

    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(B)I", line = 59)
    ...
    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "()V", line = 126)
    public class248() {
        super(1, true);
    }

    @OriginalMember(owner = "client!mn", name = "c", descriptor = "(B)V", line = 74)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(BILfh;)V", line = 85)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(BLjava/lang/String;I[B)I", line = 129)
