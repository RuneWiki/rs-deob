...
public class class248 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ILmi;)V", line = 13)
    public static final void method1509(int arg0, class443 arg1) {
        class398.field5667[arg0] = arg1;
    }

    @OriginalMember(owner = "client!oe", name = "b", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IB)I", line = 36)
