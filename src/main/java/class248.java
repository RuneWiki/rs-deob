...
public class class248 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(Z)Lob;")
    public final class529 method1619(boolean arg0) {
        field3698++;
        return arg0 ? null : class479.method2833(4096, this.field3703);
    }

    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IIII)Leh;")
    ...
    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "(Leh;I)V")
