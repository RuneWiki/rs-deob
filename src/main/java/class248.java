...
public class class248 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Lvj;B)[Lt;")
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(BI)Llo;")
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(BIILmb;)V")
