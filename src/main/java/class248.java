...
public class class248 extends class184 {
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(IIII)I", line = 20)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(ILha;ILada;I)V", line = 51)
    ...
    @OriginalMember(owner = "client!dea", name = "<init>", descriptor = "(II)V", line = 86)
