...
public class class248 implements Runnable {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(BLvj;)Lcaa;")
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(BLvj;)Luv;")
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Lkha;IIII)V")
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(I)Lsp;")
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(ILsp;Ljava/lang/String;JB)V")
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Lfh;I)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
