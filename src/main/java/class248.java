...
public class class248 extends class206 {
    ...
    @OriginalMember(owner = "client!kw", name = "c", descriptor = "(I)F")
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(IIIIIBIIII)V")
    ...
    @OriginalMember(owner = "client!kw", name = "d", descriptor = "(I)Ljava/lang/String;")
    public final String method1582(int arg0) {
        ++field3292;
        return arg0 != 0 ? null : this.field3304;
    }

    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/Throwable;)V")
    ...
    @OriginalMember(owner = "client!kw", name = "b", descriptor = "(B)F")
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(ILjagtheora/ogg/OggPacket;)V")
    ...
    @OriginalMember(owner = "client!kw", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    public class248(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!kw", name = "c", descriptor = "(Z)Ljava/lang/String;")
