...
public class class248 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ILmo;)V")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(I)[Ltf;")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ILgf;)Z")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Z)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(Lmo;)V")
