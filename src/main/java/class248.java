...
public class class248 {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IILwm;)V", line = 22)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IIILjava/lang/Class;)Leq;", line = 37)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(Lwm;I)V", line = 61)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(B)Lbd;", line = 91)
