...
public class class248 extends class354 {
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(BI)V", line = 28)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(Lr;B)V", line = 94)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Lr;B)V", line = 114)
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(BI)Lwh;", line = 139)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(FLdn;ZII)V", line = 172)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Z)V", line = 189)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IBIII)Lsd;", line = 283)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IZ)V", line = 314)
    ...
    @OriginalMember(owner = "client!ni", name = "d", descriptor = "(I)V", line = 324)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(ILr;)V", line = 335)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "([[[Lr;B)V", line = 358)
