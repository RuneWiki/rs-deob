...
public class class248 {
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(I)[Lrn;", line = 6)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(BIIIIIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(Z)V", line = 39)
