...
public class class248 extends class636 {
    ...
    @OriginalMember(owner = "client!vea", name = "<init>", descriptor = "(Lfv;Lhn;IIII)V")
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(BIZ)Lba;")
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(Lha;[Lvea;)Lvea;")
    ...
    @OriginalMember(owner = "client!vea", name = "<init>", descriptor = "(Lfv;)V")
    ...
    @OriginalMember(owner = "client!vea", name = "<init>", descriptor = "(Lfv;[Lvea;)V")
