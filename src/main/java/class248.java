...
public class class248 extends class460 {
    ...
    @OriginalMember(owner = "client!mda", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(ZI)V", line = 15)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(IIB)V", line = 57)
    ...
    @OriginalMember(owner = "client!mda", name = "d", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(IILtj;)V", line = 144)
    public final void method19(int arg0, int arg1, class185 arg2) {
        ++field3201;
        int var4 = -12 % ((arg1 - 25) / 59);
    }

    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(BZ)V", line = 153)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(IIBIIII)V", line = 164)
    ...
    @OriginalMember(owner = "client!mda", name = "b", descriptor = "(I)Z", line = 219)
    public final boolean method16(int arg0) {
        ++field3197;
        return arg0 != -24566 ? true : true;
    }

    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(I)V", line = 233)
    ...
    @OriginalMember(owner = "client!mda", name = "<init>", descriptor = "(Ljaa;Ldk;)V", line = 257)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 272)
