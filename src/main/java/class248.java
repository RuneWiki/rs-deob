...
public class class248 {
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(I)Lvba;")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(B)Lvba;")
    ...
    @OriginalMember(owner = "client!tf", name = "d", descriptor = "(I)Lvba;")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(ILvba;)V")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(ILkea;Loa;)V")
