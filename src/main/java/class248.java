...
public class class248 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(BI)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(III)V", line = 42)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(IIIII)V", line = 68)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(B)Z", line = 95)
