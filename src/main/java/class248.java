...
public class class248 extends class626 implements class60 {
    ...
    @OriginalMember(owner = "client!rw", name = "<init>", descriptor = "(Lad;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(Lkca;[BIIIIIII)V")
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(ZLui;)V")
    ...
    @OriginalMember(owner = "client!rw", name = "<init>", descriptor = "(Lad;Lkca;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!rw", name = "d", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!rw", name = "<init>", descriptor = "(Lad;Lkca;Lwq;II)V")
