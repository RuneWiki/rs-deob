...
public class class248 implements class276 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IIIIIIBII)Z", line = 8)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ICI)C", line = 29)
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(Z)V", line = 115)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lso;Z)Z", line = 134)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Z)J", line = 175)
