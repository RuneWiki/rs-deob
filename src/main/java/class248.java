...
public class class248 extends Canvas {
    ...
    @OriginalMember(owner = "client!ida", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 5)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!ida", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 25)
    ...
    @OriginalMember(owner = "client!ida", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 34)
