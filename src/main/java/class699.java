...
public class class699 extends class645 {
    ...
    @OriginalMember(owner = "client!sea", name = "<init>", descriptor = "(I)V", line = 4)
    public class699(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(BII)Z", line = 7)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(BF)V", line = 25)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(IF)V", line = 69)
    ...
    @OriginalMember(owner = "client!sea", name = "e", descriptor = "(Z)V", line = 85)
