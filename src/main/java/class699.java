...
public class class699 extends class67 {
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!vfa", name = "<init>", descriptor = "(Lcba;Llq;[Liga;[I[I)V")
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(CIIIZLaa;II)V")
