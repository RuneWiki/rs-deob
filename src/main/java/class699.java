...
public abstract class class699 extends class61 {
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(BII)V", line = 17)
    ...
    @OriginalMember(owner = "client!ab", name = "e", descriptor = "(Z)Z", line = 30)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(B[Lkp;)I", line = 41)
    ...
    @OriginalMember(owner = "client!ab", name = "d", descriptor = "(Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Lha;B)Z", line = 63)
    ...
    @OriginalMember(owner = "client!ab", name = "g", descriptor = "(I)Z", line = 79)
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "(IIIII)V", line = 92)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Lgda;Lha;IIZII)V", line = 110)
