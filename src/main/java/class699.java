...
public class class699 {
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(III)Z", line = 17)
    public static final boolean method3926(int arg0, int arg1, int arg2) {
        field9861++;
        return arg1 == -4 ? false : false;
    }

    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(IB)Z", line = 35)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(B)V", line = 48)
