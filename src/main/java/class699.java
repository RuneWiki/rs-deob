...
public abstract class class699 extends class176 {
    ...
    @OriginalMember(owner = "client!ic", name = "d", descriptor = "(Z)Z", line = 229)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Lgg;BZILha;II)V", line = 241)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Lha;B)Z", line = 251)
    ...
    @OriginalMember(owner = "client!ic", name = "b", descriptor = "(I)V", line = 272)
    ...
    @OriginalMember(owner = "client!ic", name = "i", descriptor = "(I)V", line = 286)
    ...
    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "(IIIII)V", line = 388)
    ...
    @OriginalMember(owner = "client!ic", name = "f", descriptor = "(B)V", line = 402)
    ...
    @OriginalMember(owner = "client!ic", name = "d", descriptor = "(B)Z", line = 413)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(I[Lcba;)I", line = 428)
