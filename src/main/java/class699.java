...
public class class699 extends class416 {
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(Lvea;I)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(IIILvda;)V", line = 30)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(IZ)V", line = 97)
    ...
    @OriginalMember(owner = "client!sea", name = "<init>", descriptor = "(I)V", line = 147)
    public class699(int arg0) {
        this.field9727 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!sea", name = "b", descriptor = "(B)V", line = 155)
