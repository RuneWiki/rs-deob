...
public class class699 {
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(Lso;B)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(BLso;)V", line = 31)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(IILso;)V", line = 68)
