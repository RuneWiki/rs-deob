...
public class class699 extends class514 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IIZLjava/lang/String;IILha;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(III)Z", line = 46)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ZLjava/lang/String;Z)V", line = 65)
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(B)V", line = 138)
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Lhk;II[B)V", line = 147)
