...
public class class699 extends class50 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(Z)V", line = 43)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IIIIZ)V", line = 89)
