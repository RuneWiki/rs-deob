...
public class class699 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Ljava/lang/String;ZI)V", line = 8)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Ljava/lang/String;ZLio;)I", line = 39)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(I)V", line = 67)
