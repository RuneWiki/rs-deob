...
public class class699 {
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(BLli;)V", line = 4)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(ILuq;)V", line = 26)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(I)Lmg;", line = 85)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IIFIIFFILkt;FFI[BI)V", line = 108)
    ...
    @OriginalMember(owner = "client!oi", name = "b", descriptor = "(I)Z", line = 162)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Z)V", line = 178)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(BLuq;)V", line = 199)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Ljava/io/File;BI)[B", line = 223)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Lsb;B)V", line = 242)
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 258)
