...
public class class699 extends class74 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Ltf;Ljava/lang/String;ZI)Lwb;", line = 7)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IIIIIIIIII)Z", line = 56)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lr;ILqp;III)V", line = 105)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(BLlw;Lsb;)Lqq;", line = 158)
