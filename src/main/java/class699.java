...
public class class699 extends class330 {
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "()V", line = 3)
    public class699() {
        super(3, false);
    }

    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Lgga;IB)V", line = 10)
    ...
    @OriginalMember(owner = "client!fv", name = "b", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(IZ)[I", line = 61)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(II)[[I", line = 113)
    ...
    @OriginalMember(owner = "client!fv", name = "c", descriptor = "(III)V", line = 169)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(IBIILiaa;)V", line = 181)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Lsda;Lha;ILhv;)V", line = 194)
    ...
    @OriginalMember(owner = "client!fv", name = "d", descriptor = "(B)V", line = 335)
