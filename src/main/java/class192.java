...
public class class192 {
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(BI)V", line = 19)
    ...
    @OriginalMember(owner = "client!uu", name = "b", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(IIII)I", line = 128)
