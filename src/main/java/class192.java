...
public class class192 extends class45 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ZI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!co", name = "c", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!co", name = "b", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!co", name = "d", descriptor = "(I)Z", line = 53)
    ...
    @OriginalMember(owner = "client!co", name = "e", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(II)I", line = 115)
