...
public class class192 extends class418 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(BII)V", line = 5)
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(IIIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(III)V", line = 27)
    public final void method1301(int arg0, int arg1, int arg2) {
        int var4 = -119 % ((arg0 - -67) / 57);
        ++field3099;
    }

    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IZI)V", line = 37)
