...
public class class192 {
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "([I[II)V", line = 3)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(I)Lgda;", line = 38)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(B)Lgda;", line = 65)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(BLkba;)V", line = 86)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(ILem;)V", line = 97)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "()V", line = 166)
    public class192() {
    }

    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(Lkba;)V", line = 168)
