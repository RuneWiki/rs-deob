...
public class class192 {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(Lwt;ILqa;Ldi;)V")
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(ILk;II)V")
    ...
    @OriginalMember(owner = "client!rt", name = "b", descriptor = "(ILk;II)V")
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IIILk;)Z")
    ...
    @OriginalMember(owner = "client!rt", name = "<init>", descriptor = "(Lbda;Lml;)V")
