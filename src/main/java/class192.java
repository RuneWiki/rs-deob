...
public class class192 extends class71 {
    ...
    @OriginalMember(owner = "client!uh", name = "n", descriptor = "[Lda;")
    public class32[] field3664;

    @OriginalMember(owner = "client!uh", name = "p", descriptor = "[Lda;")
    public class32[] field3666;

    @OriginalMember(owner = "client!uh", name = "r", descriptor = "[Ljc;")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(BI)Lsd;")
