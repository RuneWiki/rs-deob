...
public class class192 extends class220 {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(ILqj;Lqj;)V")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(ILai;II)V")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IBLil;)V")
