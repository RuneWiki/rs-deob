...
public class class192 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IBILja;Lfb;I)V", line = 10)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIIIIBIIII)V", line = 68)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Z)Z", line = 146)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(I)V", line = 157)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(II)V", line = 185)
