...
public class class192 implements class711 {
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(II)Lqj;", line = 20)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(I)I", line = 47)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(II)V", line = 67)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(I)Lkea;", line = 87)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(Lin;Ljava/lang/String;)V", line = 101)
