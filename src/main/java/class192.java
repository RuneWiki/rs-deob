...
public class class192 extends class203 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Ldh;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(ZLdh;)V", line = 27)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(BLdh;)V", line = 43)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(II)V", line = 61)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Z)V", line = 95)
    ...
    @OriginalMember(owner = "client!s", name = "c", descriptor = "(II)V", line = 112)
    public final void method1281(int arg0, int arg1) {
        ++field2672;
        int var3 = 103 % ((arg0 - -58) / 40);
    }

    @OriginalMember(owner = "client!s", name = "a", descriptor = "(ZFIILda;)V", line = 130)
    ...
    @OriginalMember(owner = "client!s", name = "b", descriptor = "(B)V", line = 160)
    ...
    @OriginalMember(owner = "client!s", name = "c", descriptor = "(B)V", line = 189)
