...
public class class192 extends class46 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(IIIIIFFF)V", line = 15)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IB)V", line = 27)
    public void method1336(int arg0, byte arg1) {
        field2690++;
        this.field2676[arg0] = arg1;
    }

    @OriginalMember(owner = "client!um", name = "a", descriptor = "(BI)V", line = 41)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IBI)V", line = 62)
    ...
    @OriginalMember(owner = "client!um", name = "e", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(B)V", line = 108)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(ZILjava/lang/String;)I", line = 140)
