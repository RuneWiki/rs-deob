...
public abstract class class192 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Z)V", line = 11)
    ...
    @OriginalMember(owner = "client!sb", name = "finalize", descriptor = "()V", line = 27)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(II[B)V", line = 39)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(I[SI)[S", line = 64)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Lug;I[BIZ)V", line = 77)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Lug;ILjaggl/memory/NativeBuffer;IZ)V", line = 96)
