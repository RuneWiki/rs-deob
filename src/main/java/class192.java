...
public class class192 extends class204 {
    ...
    @OriginalMember(owner = "client!cka", name = "<init>", descriptor = "(ILfs;)V", line = 5)
    public class192(int arg0, class607 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!cka", name = "<init>", descriptor = "(Lfs;)V", line = 8)
    public class192(class607 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!cka", name = "d", descriptor = "(II)V", line = 11)
    ...
    @OriginalMember(owner = "client!cka", name = "b", descriptor = "(Z)V", line = 25)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(B)I", line = 35)
    ...
    @OriginalMember(owner = "client!cka", name = "b", descriptor = "(B)I", line = 50)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(II)I", line = 63)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(I)V", line = 77)
