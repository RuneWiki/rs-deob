...
public class class192 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(JZ)V", line = 22)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(ILjava/lang/String;IILjava/lang/String;Ljava/lang/String;BLjava/lang/String;Ljava/lang/String;)V", line = 63)
    ...
    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V", line = 82)
