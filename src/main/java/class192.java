...
public class class192 extends class62 {
    ...
    @OriginalMember(owner = "client!em", name = "h", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IIIIBI)V", line = 29)
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "()V", line = 185)
    public class192() {
        super(0, true);
    }

    @OriginalMember(owner = "client!em", name = "g", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lgw;II)V", line = 70)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IIIIIFZII)[[I", line = 149)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(B)V", line = 188)
    ...
    @OriginalMember(owner = "client!em", name = "c", descriptor = "(II)[I", line = 203)
