...
public class class192 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "()I", line = 3)
    public int method1186() throws Exception {
        field2763++;
        return this.field2782;
    }

    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IILrb;)V", line = 24)
    ...
    @OriginalMember(owner = "client!dh", name = "b", descriptor = "()V", line = 51)
    public void method1191() {
        field2774++;
    }

    @OriginalMember(owner = "client!dh", name = "b", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!dh", name = "c", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(II)V", line = 103)
    ...
    @OriginalMember(owner = "client!dh", name = "d", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(B)V", line = 241)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "([II)V", line = 261)
    ...
    @OriginalMember(owner = "client!dh", name = "c", descriptor = "()V", line = 419)
    public void method1190() throws Exception {
        field2779++;
    }

    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 429)
    public void method1187(Component arg0) throws Exception {
        field2773++;
    }

    @OriginalMember(owner = "client!dh", name = "e", descriptor = "(I)V", line = 447)
    ...
    @OriginalMember(owner = "client!dh", name = "f", descriptor = "(I)V", line = 495)
    public void method1189(int arg0) throws Exception {
        field2770++;
    }

    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(ILrb;)V", line = 505)
    ...
    @OriginalMember(owner = "client!dh", name = "d", descriptor = "()V", line = 522)
