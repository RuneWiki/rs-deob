...
public class class192 {
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IBI)I", line = 4)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(B)Lia;", line = 57)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Lia;Lsu;B)V", line = 77)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(I)Lia;", line = 99)
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "()V", line = 438)
    public class192() {
        this.field2826.field7315 = this.field2826;
        this.field2826.field7306 = this.field2826;
    }

    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Lia;B)V", line = 124)
    ...
    @OriginalMember(owner = "client!su", name = "c", descriptor = "(B)Z", line = 144)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Lfa;ILoa;IILfaa;III)V", line = 161)
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(I)I", line = 265)
    ...
    @OriginalMember(owner = "client!su", name = "c", descriptor = "(I)V", line = 289)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(BLsu;)V", line = 306)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(II)I", line = 322)
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(Lia;B)V", line = 340)
    ...
    @OriginalMember(owner = "client!su", name = "d", descriptor = "(I)Lia;", line = 358)
    ...
    @OriginalMember(owner = "client!su", name = "e", descriptor = "(I)Lia;", line = 380)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Lw;III[Z)Z", line = 404)
    ...
    @OriginalMember(owner = "client!su", name = "f", descriptor = "(I)Lia;", line = 450)
