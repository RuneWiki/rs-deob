...
public class class192 implements class547 {
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(ILdr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(I)Lwea;")
    ...
    @OriginalMember(owner = "client!qga", name = "<init>", descriptor = "(ILct;Lrc;II)V")
