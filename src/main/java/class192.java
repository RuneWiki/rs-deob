...
public class class192 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IIZIFBII)[I", line = 5)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "([I[I[IBLpf;)V", line = 46)
