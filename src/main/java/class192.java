...
public class class192 {
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(IIB)I", line = 3)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(Lcw;B)V", line = 18)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(I)Lcw;", line = 38)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!cw", name = "<init>", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!cw", name = "<init>", descriptor = "(IIIIII)V", line = 83)
