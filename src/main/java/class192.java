...
public class class192 extends class87 {
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Loea;IIIII)V")
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Loea;IIII)V")
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Loea;IIIIZ[IIIZ)V")
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Loea;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Loea;IIIIZ[FI)V")
