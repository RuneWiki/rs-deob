...
public class class192 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ZI)I", line = 4)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(I)Z", line = 20)
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(III)Z", line = 47)
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "(Z)V", line = 56)
    public class192(boolean arg0) {
        this.field2884 = arg0;
    }

    @OriginalMember(owner = "client!hh", name = "c", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(III)Z", line = 81)
