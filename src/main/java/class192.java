...
public class class192 extends class30 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "()Z", line = 17)
    public final boolean method262() {
        return true;
    }

    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Z)V", line = 20)
    public final void method263(boolean arg0) {
        this.field405.method1679(8448, 7681);
    }

    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(Lnm;)V", line = 23)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lap;)V", line = 59)
    public final void method266(class26 arg0) {
        this.field405.method1653(arg0);
    }

    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(Z)V", line = 63)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(I)V", line = 83)
