...
public class class192 extends class4 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lrp;Ljava/lang/Object;I)V")
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lht;Z)V")
    ...
    @OriginalMember(owner = "client!jb", name = "b", descriptor = "(Ldc;B)V")
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "([IZLdc;)V")
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(II)Ljn;")
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ILdc;Z)V")
    ...
    @OriginalMember(owner = "client!jb", name = "c", descriptor = "(Ldc;B)Ljava/lang/String;")
