...
public class class192 implements class73 {
    ...
    private int[] field3282 = null;

    @OriginalMember(owner = "client!pg", name = "b", descriptor = "I")
    private static int field3279 = 96;

    @OriginalMember(owner = "client!pg", name = "d", descriptor = "I")
    private static int field3281 = 36;

    @OriginalMember(owner = "client!pg", name = "c", descriptor = "I")
    private static int field3280 = 12;

    @OriginalMember(owner = "client!pg", name = "c", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "()I", line = 25)
    public final int method554() {
        return 4;
    }

    @OriginalMember(owner = "client!pg", name = "d", descriptor = "()V", line = 36)
    private final void method1354() {
        GL var1 = class123.field2212;
        if (this.field3282 == null) {
            this.field3282 = new int[3];
            var1.glGenTextures(3, this.field3282, 0);
        }
        short var2 = 4096;
        ...
        for (int var6 = 0; var6 < 6; var6++) {
            ...
            for (int var8 = 0; var8 < 64; var8++) {
                for (int var9 = 0; var9 < 64; var9++) {
                    ...
                    int var18;
                    if (var15 > 0.0F) {
                        var16 = (int) (Math.pow((double) var15, (double) field3279) * 255.0D);
                        var17 = (int) (Math.pow((double) var15, (double) field3281) * 255.0D);
                        var18 = (int) (Math.pow((double) var15, (double) field3280) * 255.0D);
                    } else {
                        var18 = 0;
                        var17 = 0;
                        var16 = 0;
            ...
            var1.glBindTexture(34067, this.field3282[0]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var4));
            var1.glBindTexture(34067, this.field3282[1]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var5));
            var1.glBindTexture(34067, this.field3282[2]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var3));
            class285.field4891 += var2 * 3;
        }
    }

    @OriginalMember(owner = "client!pg", name = "e", descriptor = "()V", line = 151)
    private final void method1355() {
        GL var1 = class123.field2212;
        this.field3278 = var1.glGenLists(2);
        var1.glNewList(this.field3278, 4864);
        if (this.field3282 == null) {
            var1.glTexEnvi(8960, 34184, 34167);
        } else {
            ...
            if (this.field3283) {
                ...
                var1.glTexEnvi(8960, 34162, 7681);
                var1.glTexEnvi(8960, 34184, 34167);
                var1.glBindTexture(3553, class123.field2232);
                var1.glEnable(3553);
            }
            var1.glActiveTexture(33984);
        }
        var1.glEndList();
        var1.glNewList(this.field3278 + 1, 4864);
        if (this.field3282 == null) {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(I)V", line = 253)
    public final void method557(int arg0) {
        GL var2 = class123.field2212;
        if (class274.field4701 && this.field3282 != null) {
            var2.glActiveTexture(33985);
            var2.glBindTexture(34067, this.field3282[arg0 - 1]);
            var2.glActiveTexture(33984);
        }
    }

    @OriginalMember(owner = "client!pg", name = "b", descriptor = "()V", line = 265)
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "()V", line = 281)
    public class192() {
        if (class123.field2213 && class123.field2238 >= 2) {
            this.method1354();
            GL var1 = class123.field2212;
            var1.glBindTexture(34067, this.field3282[0]);
            ...
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            this.field3283 = class123.field2238 < 3;
        }
        this.method1355();
    }
}
