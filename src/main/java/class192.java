...
public class class192 implements Runnable {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IB)Ltj;", line = 3)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Z)Ltj;", line = 24)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IZBLjava/lang/String;)Ltj;", line = 37)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(I)Z", line = 47)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!kk", name = "run", descriptor = "()V", line = 128)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IBIILjava/lang/Object;)Ltj;", line = 428)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "([BLjava/io/File;I)Z", line = 460)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(ZLjava/lang/Class;Ljava/lang/String;)Ltj;", line = 481)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(BLjava/lang/String;)Lcr;", line = 491)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Ljava/lang/String;I)Ltj;", line = 504)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(ILjava/lang/String;IZ)V", line = 707)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(ZILjava/lang/String;)Ltj;", line = 520)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Ljava/lang/String;IILjava/lang/String;)Lcr;", line = 537)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Ljava/lang/Runnable;II)Ltj;", line = 580)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(I)V", line = 590)
    public final void method1312(int arg0) {
        field2891 = class375.method2193(116) + 5000L;
        int var2 = -30 / ((arg0 + 66) / 48);
    }

    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IIIII)Ltj;", line = 601)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Ljava/net/URL;B)Ltj;", line = 612)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(ILjava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)Ltj;", line = 627)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(ILjava/awt/Frame;)Ltj;", line = 650)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(B)Ljava/lang/Object;", line = 660)
    public final Object method1317(byte arg0) {
        int var2 = 64 / ((arg0 - 2) / 36);
        return this.field2877;
    }

    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Ljava/awt/Component;ZILjava/awt/Point;I[I)Ltj;", line = 669)
