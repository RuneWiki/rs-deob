...
public class class192 extends class182 {
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IFFFIIFLrp;IIF)[B")
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Lda;ZILha;Ljava/lang/String;Lur;)V")
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(Lln;II)V")
