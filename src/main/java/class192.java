...
public class class192 extends class601 {
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(B)J", line = 3)
    ...
    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(Z)V", line = 13)
    ...
    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(B)J", line = 40)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(Z)J", line = 74)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(BJ)I", line = 91)
