...
public class class192 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(II[II)Luo;", line = 5)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(I[IB)Luo;", line = 39)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(ZIII)I", line = 71)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(III[I)Luo;", line = 104)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(II[I)Luo;", line = 146)
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(Lpc;Lpc;)V", line = 179)
