...
public class class192 extends class735 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ILfca;)V", line = 3)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I)I", line = 15)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(III)Z", line = 30)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "([IIBLdc;)Luaa;", line = 43)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IILha;ILkh;)V", line = 221)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lrh;Z)V", line = 250)
