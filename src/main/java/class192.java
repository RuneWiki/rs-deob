...
public class class192 {
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "([IB)Ljava/lang/String;", line = 11)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IBLufa;)V", line = 72)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(B)Lsca;", line = 110)
