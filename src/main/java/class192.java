...
public class class192 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(BLrt;)V", line = 5)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(ILrt;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(B)V", line = 81)
