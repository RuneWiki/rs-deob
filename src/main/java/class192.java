...
public class class192 extends class117 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IZI)Lej;", line = 4)
    ...
    @OriginalMember(owner = "client!tf", name = "f", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IILjava/lang/String;Ljava/lang/String;IZJBIZI)V", line = 38)
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "([B)V", line = 56)
    public class192(byte[] arg0) {
        this.field2811 = arg0;
    }

    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(ILir;I)V", line = 70)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(ZF)F", line = 134)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(II[BIII)V", line = 152)
