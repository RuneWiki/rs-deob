...
public class class192 extends class86 {
    ...
    @OriginalMember(owner = "client!dka", name = "<init>", descriptor = "(ILsf;)V")
    public class192(int arg0, class551 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!dka", name = "<init>", descriptor = "(Lsf;)V")
    ...
    @OriginalMember(owner = "client!dka", name = "a", descriptor = "(IZ)V")
    ...
    @OriginalMember(owner = "client!dka", name = "b", descriptor = "(II)I")
    ...
    @OriginalMember(owner = "client!dka", name = "a", descriptor = "(Lwm;Lha;I)V")
