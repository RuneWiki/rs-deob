...
public class class192 {
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(Lmc;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(Z)J", line = 22)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(I)I", line = 64)
    ...
    @OriginalMember(owner = "client!qga", name = "b", descriptor = "(B)Lmc;", line = 91)
    ...
    @OriginalMember(owner = "client!qga", name = "c", descriptor = "(B)V", line = 112)
    ...
    @OriginalMember(owner = "client!qga", name = "<init>", descriptor = "()V", line = 151)
    public class192() {
        this.field3325.field3589 = this.field3325;
        this.field3325.field3587 = this.field3325;
    }

    @OriginalMember(owner = "client!qga", name = "b", descriptor = "(I)Lmc;", line = 127)
