...
public class class192 extends class262 {
    ...
    @OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(Lc;Ljava/lang/Object;)V", line = 3)
    public class192(class100 arg0, Object arg1) {
        super(arg0);
        this.field2674 = arg1;
    }

    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Lqj;ILqj;)V", line = 11)
    ...
    @OriginalMember(owner = "client!tk", name = "e", descriptor = "(B)Ljava/lang/Object;", line = 23)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(II)V", line = 37)
    ...
    @OriginalMember(owner = "client!tk", name = "f", descriptor = "(B)Z", line = 83)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(BZ)I", line = 94)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ZLjava/lang/String;Lqj;I)Laf;", line = 139)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IIII)V", line = 195)
