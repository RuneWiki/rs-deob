...
public class class192 extends class28 {
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(ILu;)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(III)I", line = 23)
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(I)V", line = 70)
