...
public class class192 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IILtf;I)V", line = 26)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IIILtf;)V", line = 60)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(BI)V", line = 84)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IIILka;Lem;I)V", line = 100)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IB)Llq;", line = 113)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(II)V", line = 156)
    ...
    @OriginalMember(owner = "client!ol", name = "<init>", descriptor = "(Lsn;ILci;Lci;)V", line = 204)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(B)V", line = 176)
