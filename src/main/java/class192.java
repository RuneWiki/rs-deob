...
public class class192 {
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IB)Lmr;", line = 16)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(B)I", line = 27)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Ljava/lang/String;ILqj;I)Lue;", line = 40)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(BLmr;)V", line = 115)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Z)V", line = 129)
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(Lmr;)V", line = 143)
    public class192(class133 arg0) {
        this.field2270 = arg0.field1614;
        this.field2272 = 1;
    }

    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "([Lmr;)V", line = 154)
    public class192(class133[] arg0) {
