...
public class class294 {
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ZI)Lqs;", line = 3)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Z)V", line = 37)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!ad", name = "b", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(BI)V", line = 90)
    ...
    @OriginalMember(owner = "client!ad", name = "<init>", descriptor = "(Lae;ILqn;Lqn;)V", line = 116)
