...
public class class294 extends class227 {
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(ILac;)I")
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(ZI)Ljg;")
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(BIII)V")
    ...
    @OriginalMember(owner = "client!iw", name = "<init>", descriptor = "(IIIIIF)V")
