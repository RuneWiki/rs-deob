...
public class class294 extends class627 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IFFIIFII)[F", line = 9)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(B)V", line = 99)
    ...
    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "(I[B)V", line = 112)
