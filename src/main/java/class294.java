...
public class class294 {
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(IILza;)Z")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(IIIILza;IIBII)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ILl;BIIILza;)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lir;Z)I")
    ...
    @OriginalMember(owner = "client!ad", name = "<init>", descriptor = "(I[Lbc;IIII)V")
