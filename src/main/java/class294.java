...
public class class294 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(I)V", line = 39)
    private class294(int arg0) {
        this.field4155 = arg0;
    }

    @OriginalMember(owner = "client!ne", name = "toString", descriptor = "()Ljava/lang/String;", line = 47)
    public final String toString() {
        field4153++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(BII)Z", line = 57)
