...
public class class294 extends class738 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(BIB)V", line = 17)
    ...
    @OriginalMember(owner = "client!tf", name = "c", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "()V", line = 48)
    public class294() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(ZIII)Lkw;", line = 52)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IIZLoh;II)V", line = 84)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IIII)[B", line = 97)
