...
public class class294 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Lpb;I)Z")
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(ILic;III)V")
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Lpb;B)V")
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(Lkd;)V")
