...
public class class294 extends class96 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Ltn;I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!op", name = "e", descriptor = "(B)Z", line = 41)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "()V", line = 204)
    public class294() {
        super(0, false);
    }

    @OriginalMember(owner = "client!op", name = "a", descriptor = "(I)I", line = 69)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IILbt;)V", line = 80)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IB)V", line = 93)
    ...
    @OriginalMember(owner = "client!op", name = "d", descriptor = "(I)V", line = 191)
    ...
    @OriginalMember(owner = "client!op", name = "g", descriptor = "(I)V", line = 208)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(II)[[I", line = 219)
