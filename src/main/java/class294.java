...
public class class294 extends class275 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(FIFF)F", line = 42)
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "(IIIIIFFF)V", line = 59)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(BII)V", line = 73)
    ...
    @OriginalMember(owner = "client!q", name = "d", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(ICI)C", line = 101)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(B)V", line = 191)
    ...
    @OriginalMember(owner = "client!q", name = "c", descriptor = "(B)V", line = 216)
