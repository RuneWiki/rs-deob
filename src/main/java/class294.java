...
public class class294 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(DZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(BZZII)I", line = 52)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(IB)Z", line = 93)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lfb;Z)Z", line = 104)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(III)Z", line = 230)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Lrv;Ld;)V", line = 313)
    public class294(class111 arg0, class152 arg1) {
        this.field4212 = arg0;
        this.field4208 = arg1;
    }

    @OriginalMember(owner = "client!sb", name = "b", descriptor = "(IB)Ltr;", line = 266)
    ...
    @OriginalMember(owner = "client!sb", name = "b", descriptor = "(I)V", line = 322)
    public final void method1824(int arg0) {
        this.field4206.method553(arg0, arg0 ^ 0xFFFFC25F);
        field4209++;
    }

    @OriginalMember(owner = "client!sb", name = "c", descriptor = "(I)V", line = 330)
