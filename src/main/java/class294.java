...
public class class294 {
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(Z)V", line = 41)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(IIIIZII)V", line = 132)
