...
public class class294 extends class472 {
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(Lsm;IIILkm;)V")
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(Lwj;Lwj;IZI)I")
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(ILld;[I[I[I)V")
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(Lkm;JIZI)V")
    ...
    @OriginalMember(owner = "client!me", name = "c", descriptor = "(I)Ls;")
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Lkm;Lqm;Lm;J)V")
