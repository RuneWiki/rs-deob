...
public class class294 extends class148 {
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "()V", line = 4)
    public class294() {
        super(3, false);
    }
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(II)[I", line = 22)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILdh;I)V", line = 74)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ZI)[[I", line = 86)
