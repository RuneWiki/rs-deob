...
public class class294 extends class418 {
    ...
    @OriginalMember(owner = "client!tf", name = "e", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(II[B[IIIIIIIILtf;II)I", line = 17)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "([B[IIIIIIILtf;)I", line = 53)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(II[B[IIIIIIIIIILtf;II)I", line = 80)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "([IIIII)I", line = 123)
    ...
    @OriginalMember(owner = "client!tf", name = "c", descriptor = "()Lep;", line = 178)
    public final class418 method1693() {
        return null;
    }

    @OriginalMember(owner = "client!tf", name = "f", descriptor = "()V", line = 181)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(II[B[IIIIIIILtf;II)I", line = 186)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(I)V", line = 212)
    public final synchronized void method1888(int arg0) {
        this.field4119 = arg0;
    }

    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Z)V", line = 216)
    ...
    @OriginalMember(owner = "client!tf", name = "c", descriptor = "(I)V", line = 223)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "([B[IIIIIIIILtf;)I", line = 235)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "()I", line = 272)
    public final int method1673() {
        return this.field4112 == 0 && this.field4124 == 0 ? 0 : 1;
    }

    @OriginalMember(owner = "client!tf", name = "g", descriptor = "(I)V", line = 279)
    private final synchronized void method1892(int arg0) {
        this.method1920(arg0, this.method1894());
    }

    @OriginalMember(owner = "client!tf", name = "g", descriptor = "()Z", line = 284)
    ...
    @OriginalMember(owner = "client!tf", name = "h", descriptor = "()I", line = 369)
    public final synchronized int method1894() {
        return this.field4114 < 0 ? -1 : this.field4114;
    }

    @OriginalMember(owner = "client!tf", name = "i", descriptor = "()I", line = 372)
    public final synchronized int method1895() {
        return this.field4112 == Integer.MIN_VALUE ? 0 : this.field4112;
    }

    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Lcj;III)Ltf;", line = 375)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "([III)V", line = 381)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(II)I", line = 845)
    private static final int method1900(int arg0, int arg1) {
        return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
    }

    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(I[B[IIIIIIIIIILtf;)I", line = 848)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "([B[IIIIIIILtf;)I", line = 902)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(II[B[IIIIIIIILtf;II)I", line = 927)
    ...
    @OriginalMember(owner = "client!tf", name = "i", descriptor = "(I)V", line = 959)
    public final synchronized void method1904(int arg0) {
        this.method1920(arg0 << 6, this.method1894());
    }

    @OriginalMember(owner = "client!tf", name = "j", descriptor = "(I)V", line = 962)
    ...
    @OriginalMember(owner = "client!tf", name = "c", descriptor = "(II[B[IIIIIIIILtf;II)I", line = 969)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(I[B[IIIIIIIILtf;)I", line = 1002)
    ...
    @OriginalMember(owner = "client!tf", name = "d", descriptor = "()I", line = 1043)
    ...
    @OriginalMember(owner = "client!tf", name = "d", descriptor = "(II[B[IIIIIIIILtf;II)I", line = 1057)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "()Lep;", line = 1091)
    public final class418 method1696() {
        return null;
    }

    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(I[B[IIIIIIIIIILtf;)I", line = 1094)
    ...
    @OriginalMember(owner = "client!tf", name = "c", descriptor = "(II)V", line = 1147)
    public final synchronized void method1911(int arg0, int arg1) {
        this.method1918(arg0, arg1, this.method1894());
    }

    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(I[B[IIIIIIIILtf;)I", line = 1150)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "([B[IIIIIIIILtf;)I", line = 1188)
    ...
    @OriginalMember(owner = "client!tf", name = "k", descriptor = "()I", line = 1222)
    public final synchronized int method1914() {
        return this.field4121 < 0 ? -this.field4121 : this.field4121;
    }

    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(II[B[IIIIIIIIIILtf;II)I", line = 1225)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "([IIIII)I", line = 1266)
    ...
    @OriginalMember(owner = "client!tf", name = "l", descriptor = "()Z", line = 1323)
    public final boolean method1917() {
        return this.field4124 != 0;
    }

    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(III)V", line = 1329)
    ...
    @OriginalMember(owner = "client!tf", name = "k", descriptor = "(I)V", line = 1377)
    ...
    @OriginalMember(owner = "client!tf", name = "d", descriptor = "(II)V", line = 1423)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(II[B[IIIIIIILtf;II)I", line = 1430)
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(Lcj;III)V", line = 1456)
