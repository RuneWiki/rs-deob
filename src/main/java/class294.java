...
public class class294 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Ljava/awt/Frame;Lufa;B)V", line = 6)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(BII)V", line = 33)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Z)Lcw;", line = 58)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IB)V", line = 79)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(IB)Ldk;", line = 93)
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(Lvd;ILpe;)V", line = 153)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(B)V", line = 130)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Loa;I)V", line = 173)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(I)V", line = 189)
