...
public class class294 extends class132 {
    ...
    @OriginalMember(owner = "client!ep", name = "g", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ep", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 15)
    public class294(Object arg0, int arg1) {
        super(arg1);
        this.field4287 = arg0;
    }

    @OriginalMember(owner = "client!ep", name = "c", descriptor = "(B)Z", line = 24)
    ...
    @OriginalMember(owner = "client!ep", name = "f", descriptor = "(I)Ljava/lang/Object;", line = 34)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ILwj;IILwj;IIIII)V", line = 45)
    ...
    @OriginalMember(owner = "client!ep", name = "h", descriptor = "(I)I", line = 94)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(II)I", line = 112)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(IIIII)V", line = 124)
