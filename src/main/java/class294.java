...
public class class294 extends class172 {
    ...
    @OriginalMember(owner = "client!ep", name = "h", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(I)[B", line = 16)
    ...
    @OriginalMember(owner = "client!ep", name = "g", descriptor = "(I)I", line = 41)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(I[BBI)[B", line = 68)
