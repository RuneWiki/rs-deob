...
public class class294 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(IBI)V", line = 7)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(BI)V", line = 48)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(II)V", line = 62)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(IZ)V", line = 90)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(IB)Luca;", line = 106)
    ...
    @OriginalMember(owner = "client!fe", name = "b", descriptor = "(IB)V", line = 159)
    ...
    @OriginalMember(owner = "client!fe", name = "<init>", descriptor = "(Luea;IZLpq;Lpq;)V", line = 256)
    ...
    @OriginalMember(owner = "client!fe", name = "b", descriptor = "(I)V", line = 192)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(ZI)V", line = 203)
    ...
    @OriginalMember(owner = "client!fe", name = "c", descriptor = "(I)V", line = 222)
