...
public class class294 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lbg;ZI)V", line = 76)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BII)Z", line = 216)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(I[B)[B", line = 284)
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(Z)V", line = 315)
