...
public class class294 extends class419 {
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(Lcb;Lgda;[Lpga;[I[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "([B[IIIIIIII)V", line = 45)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(CIIIZLua;II)V", line = 78)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "([B[IIIIIIIIIIILua;II)V", line = 142)
    ...
    @OriginalMember(owner = "client!db", name = "OA", descriptor = "(CIIIZ)V", line = 237)
