...
public class class294 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(BI)I", line = 3)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(I)Lmf;", line = 18)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILjava/lang/String;ZI)I", line = 55)
    ...
    @OriginalMember(owner = "client!li", name = "c", descriptor = "(I)Lda;", line = 141)
