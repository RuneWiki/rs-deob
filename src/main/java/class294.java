...
public class class294 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIIIIIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 83)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ZI)Z", line = 124)
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "(Llv;)V", line = 135)
