...
public class class294 extends class366 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Llf;ZI)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIILtj;)Lqf;")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ZLlf;)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILbr;)V")
