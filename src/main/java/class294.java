...
public class class294 extends class179 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "([[IZILja;I)V")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IIIILja;I)V")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lja;IILpo;III[[[B[I[I[I[I[IIBIIZ)V")
