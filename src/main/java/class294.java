...
public class class294 extends class631 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IILta;)V")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IIIIILjb;JLaa;I)V")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(ZIZI[BLeea;II)Lll;")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Lct;III)V")
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(Leea;Lrc;)V")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IZLjava/lang/Object;)[B")
