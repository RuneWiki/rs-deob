...
public abstract class class294 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(BII)I", line = 4)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(I[BIIIII)Z", line = 44)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(III)I", line = 96)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Ldf;[Luf;)V", line = 112)
    ...
    @OriginalMember(owner = "client!s", name = "<init>", descriptor = "(III[[I)V", line = 192)
