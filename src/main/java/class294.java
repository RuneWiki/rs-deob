...
public class class294 extends class320 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!ss", name = "c", descriptor = "(I)V", line = 187)
    ...
    @OriginalMember(owner = "client!ss", name = "d", descriptor = "(I)V", line = 207)
