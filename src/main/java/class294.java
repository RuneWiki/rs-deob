...
public class class294 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IB)V", line = 7)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(BI)Z", line = 38)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Lsj;I)V", line = 49)
