...
public class class294 extends class225 {
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IILlm;ZIDLfh;Z)[I", line = 17)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ZZB)V", line = 155)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILlm;IZLfh;B)[F", line = 189)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lfh;Llm;I)Z", line = 302)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(II)Lfn;", line = 359)
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "()V", line = 391)
    public class294() {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lfh;DIZILlm;Z)[I", line = 408)
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(Lnj;)V", line = 538)
