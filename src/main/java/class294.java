...
public class class294 {
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "()I", line = 5)
    ...
    @OriginalMember(owner = "client!vv", name = "b", descriptor = "()[F", line = 13)
    public final float[] method1841() {
        return this.field4407[this.method1840()];
    }

    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(II)I", line = 18)
    ...
    @OriginalMember(owner = "client!vv", name = "c", descriptor = "()V", line = 27)
    ...
    @OriginalMember(owner = "client!vv", name = "<init>", descriptor = "()V", line = 165)
    public class294() {
