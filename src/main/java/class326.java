...
public class class326 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IILwm;)V")
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Lwm;I)V")
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(ZILza;I)Lo;")
