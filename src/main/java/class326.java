...
public class class326 {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Lap;I)V")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(II)Lac;")
    ...
    @OriginalMember(owner = "client!bd", name = "<init>", descriptor = "(ILns;Lns;)V")
