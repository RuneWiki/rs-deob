...
public class class326 extends class167 implements class438 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lfba;Z)Lha;")
    ...
    @OriginalMember(owner = "client!a", name = "d", descriptor = "(I)Lu;")
    ...
    @OriginalMember(owner = "client!a", name = "i", descriptor = "()Ldp;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IIIIIF)Luca;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lrl;[Lfba;Z)Lra;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "([Lr;Lsh;Lm;[Lpaa;I)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lkk;Lkk;FLkk;)Lkk;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lld;IIII)Lr;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(I[Luca;)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "()Lm;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lkk;)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "([Lr;Lm;[Lpaa;I)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lsh;)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lsh;Z)V")
    ...
    @OriginalMember(owner = "client!a", name = "c", descriptor = "(IIIIII)Lkk;")
