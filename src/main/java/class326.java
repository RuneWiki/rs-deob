...
public class class326 {
    ...
    @OriginalMember(owner = "client!dja", name = "a", descriptor = "(III)Lkh;", line = 10)
    ...
    @OriginalMember(owner = "client!dja", name = "a", descriptor = "(IIBJIZLgj;)V", line = 32)
    ...
    @OriginalMember(owner = "client!dja", name = "<init>", descriptor = "(J[I[S[S)V", line = 44)
    ...
    @OriginalMember(owner = "client!dja", name = "<init>", descriptor = "()V", line = 54)
    protected class326() {
    }
}
