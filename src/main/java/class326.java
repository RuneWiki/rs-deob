...
public class class326 extends class190 {
    ...
    @OriginalMember(owner = "client!da", name = "c", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIII)V", line = 202)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILoj;Leg;)V", line = 215)
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "(I)V", line = 442)
    ...
    @OriginalMember(owner = "client!da", name = "c", descriptor = "(I)V", line = 453)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIZ)V", line = 499)
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "()V", line = 579)
    protected class326() {
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lvt;)V", line = 591)
