...
public class class326 extends class446 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IIIZ)Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Lkh;I)V", line = 56)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(III)Les;", line = 86)
    ...
    @OriginalMember(owner = "client!el", name = "d", descriptor = "(B)V", line = 93)
    ...
    @OriginalMember(owner = "client!el", name = "e", descriptor = "(B)Z", line = 109)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 123)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IILkh;)V", line = 134)
