...
public class class326 implements IEnumModesCallback {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IIILjava/awt/Frame;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(BLjava/awt/Frame;)V", line = 23)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(I)[I", line = 34)
    ...
    @OriginalMember(owner = "client!rq", name = "callbackEnumModes", descriptor = "(Lcom/ms/directX/DDSurfaceDesc;Lcom/ms/com/IUnknown;)V", line = 55)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "()V", line = 70)
    public class326() {
