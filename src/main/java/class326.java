...
public class class326 implements Runnable {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "([BIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Z)V", line = 73)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(B)V", line = 108)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(I[BIB)V", line = 124)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(III)Z", line = 153)
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(Ljava/net/Socket;Ljs;)V", line = 388)
    ...
    @OriginalMember(owner = "client!qe", name = "c", descriptor = "(I)V", line = 180)
    ...
    @OriginalMember(owner = "client!qe", name = "b", descriptor = "(B)I", line = 217)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lv;IFBFIIIFFF[BII)V", line = 231)
    ...
    @OriginalMember(owner = "client!qe", name = "run", descriptor = "()V", line = 283)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(ZLpc;)I", line = 355)
    ...
    @OriginalMember(owner = "client!qe", name = "finalize", descriptor = "()V", line = 381)
