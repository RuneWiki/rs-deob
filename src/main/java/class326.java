...
public class class326 extends class522 implements class401 {
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(Lya;Lpf;IIIIIZIIIIIIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!wk", name = "d", descriptor = "(B)I", line = 38)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lya;I)V", line = 50)
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(Z)V", line = 60)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(III)Z", line = 78)
    ...
    @OriginalMember(owner = "client!wk", name = "c", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(I)I", line = 108)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lya;B)V", line = 122)
    ...
    @OriginalMember(owner = "client!wk", name = "h", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(B)I", line = 162)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(ILya;I)Lt;", line = 175)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Z)Z", line = 185)
    ...
    @OriginalMember(owner = "client!wk", name = "g", descriptor = "(I)I", line = 197)
    ...
    @OriginalMember(owner = "client!wk", name = "d", descriptor = "(Z)V", line = 208)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(BZILya;)Lro;", line = 225)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lya;II)Lt;", line = 255)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(BLya;)V", line = 275)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lya;IIILqj;IZ)V", line = 304)
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(I)I", line = 334)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(ILya;II)Z", line = 352)
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(Lya;I)Lmo;", line = 377)
    ...
    @OriginalMember(owner = "client!wk", name = "e", descriptor = "(I)Z", line = 403)
