...
public class class326 {
    ...
    @OriginalMember(owner = "client!bf", name = "finalize", descriptor = "()V", line = 7)
    protected final void finalize() throws Throwable {
        this.field4768.method1644(this.field4767);
        super.finalize();
    }

    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Lnf;ILjava/lang/String;)Lbf;", line = 12)
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(Lnf;II)V", line = 47)
