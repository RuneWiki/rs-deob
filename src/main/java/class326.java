...
public class class326 extends class447 {
    ...
    @OriginalMember(owner = "client!nl", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(III)Z", line = 17)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(II)Lbl;", line = 43)
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(Loh;)V", line = 70)
    public class326(class232 arg0) {
        this.field4449 = arg0;
    }

    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(ZI)Z", line = 80)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(CI)Z", line = 110)
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(II)V", line = 165)
