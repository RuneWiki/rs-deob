...
public class class326 {
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(II)Lpl;")
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(ILeo;)V")
    ...
    @OriginalMember(owner = "client!wo", name = "b", descriptor = "(II)Lwo;")
