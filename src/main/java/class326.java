...
public class class326 extends class406 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(B)[B", line = 6)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "([BZ)V", line = 20)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(III)[B", line = 34)
