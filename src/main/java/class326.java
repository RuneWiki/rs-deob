...
public class class326 extends class86 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!rq", name = "c", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!rq", name = "c", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(IIIIIFFF)V", line = 98)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(Z)V", line = 110)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IB)V", line = 134)
    public void method1356(int arg0, byte arg1) {
        field4679++;
        this.field4691[arg0] = arg1;
    }

    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(ILjava/lang/String;)V", line = 146)
