...
public class class326 extends class362 {
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(BZLke;)V", line = 7)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(B)V", line = 177)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(I)V", line = 202)
