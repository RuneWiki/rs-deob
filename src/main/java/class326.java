...
public class class326 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IIIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ILrb;)V", line = 33)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(I)V", line = 65)
