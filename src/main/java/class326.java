...
public class class326 extends class207 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lfq;I)V")
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(BLfq;)V")
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(ILpi;)V")
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(FZILta;I)V")
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(BLkl;)Z")
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(ZLfq;)V")
