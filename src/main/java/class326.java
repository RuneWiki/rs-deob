...
public abstract class class326 {
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Lri;Lri;B)V", line = 8)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(B)Ljava/net/Socket;", line = 26)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Z)V", line = 55)
