...
public class class326 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lfo;B)V", line = 8)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(BI)V", line = 20)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IB)Lti;", line = 71)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(II)V", line = 101)
    ...
    @OriginalMember(owner = "client!bg", name = "c", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(Ld;ILfo;)V", line = 131)
