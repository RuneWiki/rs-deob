...
public class class326 extends class375 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(BLua;ILvg;IIILf;)V")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Lvq;I)V")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(BLvg;)V")
