...
public class class326 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(I)Luj;")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(B)Luj;")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ZLuj;)V")
