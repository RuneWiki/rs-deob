...
public class class326 extends class154 {
    ...
    @OriginalMember(owner = "client!el", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!el", name = "f", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Ls;)V", line = 52)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "()Lel;", line = 68)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "()V", line = 84)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "([I)V", line = 90)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IIIIII)V", line = 101)
    ...
    @OriginalMember(owner = "client!el", name = "c", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(III)V", line = 138)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(III)V", line = 157)
    ...
    @OriginalMember(owner = "client!el", name = "g", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "()V", line = 172)
    public class326() {
        this.method1137();
    }

    @OriginalMember(owner = "client!el", name = "a", descriptor = "(III[I)V", line = 176)
