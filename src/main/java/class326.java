...
public abstract class class326 extends class513 {
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(II[BLjava/lang/String;)I", line = 21)
    ...
    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(B)Z", line = 74)
    ...
    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(Z)V", line = 91)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(III)Z", line = 138)
    ...
    @OriginalMember(owner = "client!vl", name = "d", descriptor = "(I)V", line = 149)
