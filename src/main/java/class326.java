...
public class class326 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(II)Lwf;", line = 3)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(BLeq;J)V", line = 36)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(IB)V", line = 118)
    ...
    @OriginalMember(owner = "client!mi", name = "<init>", descriptor = "(Lci;ILhe;)V", line = 133)
