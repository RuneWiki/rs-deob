...
public class class326 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(I)Lfo;")
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IILbg;)V")
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(BLbg;)V")
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IIZILg;Luo;II)V")
