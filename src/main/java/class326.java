...
public class class326 extends class208 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIILha;Lnfa;ZI)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lha;Ldm;Lka;Z)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lha;III)Lka;")
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(BLha;)Lmg;")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(BIILha;)Z")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lha;I)Luh;")
    ...
    @OriginalMember(owner = "client!ko", name = "c", descriptor = "(ILha;)V")
