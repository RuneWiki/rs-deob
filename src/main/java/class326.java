...
public class class326 extends class12 {
    ...
    @OriginalMember(owner = "client!gh", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Lnj;Z)V", line = 43)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IBIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IB)V", line = 82)
