...
public class class326 extends class188 {
    ...
    @OriginalMember(owner = "client!dja", name = "<init>", descriptor = "(Lai;)V", line = 3)
    public class326(class626 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!dja", name = "a", descriptor = "(IIZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!dja", name = "a", descriptor = "(IZ)V", line = 17)
    ...
    @OriginalMember(owner = "client!dja", name = "a", descriptor = "(ZI)V", line = 28)
    ...
    @OriginalMember(owner = "client!dja", name = "d", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!dja", name = "f", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!dja", name = "g", descriptor = "(B)V", line = 99)
    public static void method2066(byte arg0) {
        field4753 = null;
        int var1 = -26 % ((arg0 - -15) / 34);
    }

    @OriginalMember(owner = "client!dja", name = "a", descriptor = "(IBIIII)V", line = 109)
    ...
    @OriginalMember(owner = "client!dja", name = "a", descriptor = "(I)Z", line = 192)
    ...
    @OriginalMember(owner = "client!dja", name = "a", descriptor = "(IBLbm;)V", line = 204)
