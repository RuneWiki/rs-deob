...
public class class326 extends class57 implements class111 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(I)I", line = 11)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IILpe;I)Z", line = 42)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Lpe;B)Lca;", line = 62)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(BILpe;)Lsj;", line = 89)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Lpe;I)V", line = 112)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(BLpe;)V", line = 140)
    ...
    @OriginalMember(owner = "client!rq", name = "h", descriptor = "(I)V", line = 168)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Lpe;Lkk;IIIIZIIIII)V", line = 235)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Lpe;IILfi;I)V", line = 261)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Lpe;ZIB)Lil;", line = 296)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(B)I", line = 329)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(ILpe;)V", line = 343)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 353)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Lrk;Lrk;I)V", line = 375)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Lpe;II)Lsj;", line = 387)
    ...
    @OriginalMember(owner = "client!rq", name = "c", descriptor = "(I)Z", line = 399)
    ...
    @OriginalMember(owner = "client!rq", name = "g", descriptor = "(I)I", line = 411)
    ...
    @OriginalMember(owner = "client!rq", name = "i", descriptor = "(I)V", line = 423)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(I)I", line = 434)
