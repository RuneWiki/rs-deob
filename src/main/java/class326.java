...
public class class326 extends class261 {
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "([B)V", line = 11)
    public class326(byte[] arg0) {
        this.field4941 = arg0;
    }

    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IILmf;Lza;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(I)V", line = 60)
