...
public class class326 {
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(ZLml;)V", line = 24)
    ...
    @OriginalMember(owner = "client!uia", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 79)
