...
public class class326 {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(BIILie;)V")
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(ZI)Lpca;")
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Lie;II)V")
