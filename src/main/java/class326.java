...
public class class326 {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(IBIIZ)V", line = 26)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(IIIZIIII)V", line = 70)
    ...
    @OriginalMember(owner = "client!du", name = "b", descriptor = "(B)V", line = 92)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Z[BI)V", line = 220)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(I[BJ)V", line = 271)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(ILr;)V", line = 356)
