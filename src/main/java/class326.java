...
public class class326 extends class98 {
    ...
    @OriginalMember(owner = "client!wt", name = "d", descriptor = "()I", line = 5)
    public final int method691() {
        field4873++;
        return 0;
    }

    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(I[ILuw;BII)V", line = 13)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(B)V", line = 73)
    public static void method2114(byte arg0) {
        int var1 = -34 % ((arg0 - 23) / 60);
        field4877 = null;
    }

    @OriginalMember(owner = "client!wt", name = "b", descriptor = "()Leha;", line = 83)
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "([III)V", line = 158)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IILuw;)V", line = 198)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "()Leha;", line = 246)
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(Lhk;)V", line = 273)
