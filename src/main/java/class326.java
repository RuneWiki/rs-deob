...
public class class326 extends class159 {
    ...
    @OriginalMember(owner = "client!as", name = "d", descriptor = "(B)Ldaa;")
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Lwu;II)V")
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(Ldw;Lcd;)V")
