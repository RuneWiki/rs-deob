...
public class class349 extends class356 implements class57 {
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(Loa;I)Lew;", line = 3)
    ...
    @OriginalMember(owner = "client!wl", name = "e", descriptor = "(I)I", line = 14)
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(I)I", line = 31)
    ...
    @OriginalMember(owner = "client!wl", name = "<init>", descriptor = "(Loa;Lqd;IIIIIZIIIIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(I)Z", line = 51)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(ILoa;)V", line = 63)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Loa;B)Laca;", line = 75)
    ...
    @OriginalMember(owner = "client!wl", name = "g", descriptor = "(I)I", line = 121)
    ...
    @OriginalMember(owner = "client!wl", name = "i", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IILoa;I)Z", line = 145)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Lkea;ILkea;Lkea;Lkea;)V", line = 168)
    ...
    @OriginalMember(owner = "client!wl", name = "c", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(II)Lka;", line = 205)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(BLoa;)V", line = 229)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IZLoa;)Lba;", line = 240)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Loa;I)V", line = 253)
