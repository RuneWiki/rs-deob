...
public class class349 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lsu;", line = 6)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(I)Z", line = 28)
    ...
    @OriginalMember(owner = "client!rb", name = "b", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!rb", name = "<init>", descriptor = "(Z)V", line = 58)
