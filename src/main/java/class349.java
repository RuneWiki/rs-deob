...
public class class349 {
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(I)Ljava/lang/String;", line = 12)
    ...
    @OriginalMember(owner = "client!bp", name = "b", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(BII)Z", line = 114)
