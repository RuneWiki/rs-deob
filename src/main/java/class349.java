...
public abstract class class349 extends class449 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lis;IILjava/lang/String;)Lor;", line = 4)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "([BIZ)I", line = 93)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ILwg;)I", line = 104)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IZIIILis;)Ljava/awt/Frame;", line = 156)
