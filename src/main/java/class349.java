...
public class class349 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(BLlh;)Lfj;")
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(Z)[Luf;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lod;I)V")
