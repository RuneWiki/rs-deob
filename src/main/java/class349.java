...
public class class349 extends class341 implements class415 {
    ...
    @OriginalMember(owner = "client!va", name = "D", descriptor = "(IIIIII)V", line = 3)
    public final void method290(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!va", name = "finalize", descriptor = "()V", line = 12)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(FFFFFFLi;II)V", line = 17)
    ...
    @OriginalMember(owner = "client!va", name = "J", descriptor = "(III)V", line = 27)
    public final void method307(int arg0, int arg1, int arg2) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(Lc;Lk;[I[BIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IILi;II)V", line = 37)
