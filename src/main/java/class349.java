...
public class class349 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(I)I", line = 14)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IIILjava/lang/Class;)Lmw;", line = 35)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IIIII)V", line = 59)
