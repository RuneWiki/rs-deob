...
public class class349 extends class494 {
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(I[I)V", line = 5)
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(II[BI)V", line = 25)
    ...
    @OriginalMember(owner = "client!js", name = "o", descriptor = "(II)V", line = 51)
    ...
    @OriginalMember(owner = "client!js", name = "p", descriptor = "(II)I", line = 62)
    ...
    @OriginalMember(owner = "client!js", name = "o", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(BLws;)V", line = 85)
    ...
    @OriginalMember(owner = "client!js", name = "i", descriptor = "(Z)Z", line = 101)
    ...
    @OriginalMember(owner = "client!js", name = "p", descriptor = "(I)I", line = 118)
    ...
    @OriginalMember(owner = "client!js", name = "q", descriptor = "(II)I", line = 138)
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(I)V", line = 168)
    public class349(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!js", name = "q", descriptor = "(I)V", line = 177)
