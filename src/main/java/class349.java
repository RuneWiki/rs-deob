...
public class class349 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(BI)Ljava/lang/String;", line = 33)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "([Lvj;B)V", line = 43)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "([II[Ljava/lang/Object;IB)V", line = 97)
    ...
    @OriginalMember(owner = "client!pm", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 184)
    public class349(String arg0, String arg1, String arg2, String arg3) {
        this.field5082 = new String[] { arg0, arg1, arg2, arg3 };
    }

    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIIIIIIIII)V", line = 208)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIIILjl;)V", line = 228)
    ...
    @OriginalMember(owner = "client!pm", name = "toString", descriptor = "()Ljava/lang/String;", line = 268)
    public final String toString() {
        field5080++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(B)V", line = 276)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(I)V", line = 290)
