...
public class class349 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lqq;ZZI)Lig;")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ILha;B)V")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ILha;)V")
