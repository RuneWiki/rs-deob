...
public class class349 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IIIILmf;)V", line = 3)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(ILbm;IILjava/awt/Canvas;Lam;)Len;", line = 44)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(ZI)Ldb;", line = 83)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IILnj;Lnl;IIILre;)V", line = 116)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(I)Z", line = 209)
    public static final boolean method2225(int arg0) {
        field5103++;
        return arg0 == 128 ? class438.field6421 : false;
    }

    @OriginalMember(owner = "client!id", name = "b", descriptor = "(I)V", line = 232)
