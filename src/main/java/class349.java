...
public class class349 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(BZ)V", line = 18)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ILe;)V", line = 28)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(B)V", line = 79)
