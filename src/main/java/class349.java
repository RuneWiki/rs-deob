...
public class class349 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(ILrg;)Z", line = 17)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Lqj;IZI)Ldi;", line = 126)
