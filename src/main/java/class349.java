...
public class class349 extends class303 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(BLui;)V")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Lui;B)V")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Lui;I)V")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IIFLdh;Z)V")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Lqf;Z)V")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ZLjava/awt/Component;I)Lfs;")
