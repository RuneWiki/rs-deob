...
public class class349 extends class469 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!nu", name = "e", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(III)Z", line = 26)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IIILvo;)V", line = 41)
    ...
    @OriginalMember(owner = "client!nu", name = "<init>", descriptor = "(Lml;IIII)V", line = 113)
    ...
    @OriginalMember(owner = "client!nu", name = "<init>", descriptor = "(Lml;IIII[BI)V", line = 132)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IIIBIIII)V", line = 155)
