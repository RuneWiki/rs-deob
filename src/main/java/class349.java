...
public class class349 extends class374 implements class294 {
    ...
    @OriginalMember(owner = "client!xa", name = "b", descriptor = "()[Lfi;")
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(Lc;Lpr;I)V")
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(Lc;Lpr;II)V")
    ...
    @OriginalMember(owner = "client!xa", name = "d", descriptor = "()[Lkh;")
    ...
    @OriginalMember(owner = "client!xa", name = "<init>", descriptor = "(Lw;Lg;Lpn;IIII)V")
