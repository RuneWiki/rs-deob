...
public class class349 {
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Lha;BII)V")
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(ILos;I)V")
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(BLos;)V")
