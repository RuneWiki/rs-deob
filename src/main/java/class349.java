...
public class class349 extends class309 {
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(ILtq;)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Ltq;III)Z")
    ...
    @OriginalMember(owner = "client!h", name = "f", descriptor = "(B)[Lsh;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(ILtq;I)Z")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(BZLtq;Lhm;III)V")
    ...
    @OriginalMember(owner = "client!h", name = "b", descriptor = "(Ltq;I)Lcj;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Ldr;B)V")
