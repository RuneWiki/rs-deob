...
public class class349 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IIIIIIIBII)V", line = 7)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!gp", name = "b", descriptor = "(I)V", line = 75)
