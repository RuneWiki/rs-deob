...
public class class349 extends class403 implements class113 {
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(IIIIILet;)V", line = 3)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(BLeq;)V", line = 11)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(B)I", line = 22)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIILbp;IZLeq;)V", line = 36)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Z)Z", line = 46)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ILeq;Z)Lva;", line = 57)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Leq;Z)V", line = 69)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ILeq;BI)Z", line = 90)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(Leq;Z)Lgl;", line = 102)
    ...
    @OriginalMember(owner = "client!lh", name = "c", descriptor = "(B)V", line = 123)
    ...
    @OriginalMember(owner = "client!lh", name = "c", descriptor = "(I)V", line = 135)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Leq;I)V", line = 147)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(B)I", line = 161)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(I)I", line = 172)
    ...
    @OriginalMember(owner = "client!lh", name = "f", descriptor = "(I)V", line = 183)
    ...
    @OriginalMember(owner = "client!lh", name = "d", descriptor = "(I)Z", line = 196)
