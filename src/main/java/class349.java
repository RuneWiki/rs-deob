...
public class class349 extends class438 implements class688 {
    ...
    @OriginalMember(owner = "client!bc", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "(Ljc;Lds;Z)V", line = 20)
    public class349(class179 arg0, class73 arg1, boolean arg2) {
        super(arg0, 34963, arg2);
        this.field4264 = arg1;
    }

    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;", line = 30)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(I)Lds;", line = 41)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(II)V", line = 53)
    ...
    @OriginalMember(owner = "client!bc", name = "c", descriptor = "(I)Z", line = 66)
    ...
    @OriginalMember(owner = "client!bc", name = "g", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!bc", name = "h", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(B)V", line = 126)
