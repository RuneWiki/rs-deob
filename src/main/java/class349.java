...
public class class349 extends class606 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(Lfha;Lfp;)V")
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIBILjava/lang/String;IILha;)V")
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Lma;II)V")
