...
public class class349 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Z)Lpn;")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "([Lpn;Z)I")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(IJ)Lpn;")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(I)Lpn;")
    ...
    @OriginalMember(owner = "client!tm", name = "b", descriptor = "(I)Lpn;")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ZLwo;ILwo;I)V")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Lpn;IJ)V")
