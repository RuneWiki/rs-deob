...
public class class349 extends class29 {
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IC)I", line = 22)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Lat;B)V", line = 45)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(CI)I", line = 73)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ILat;I)V", line = 101)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IIII)V", line = 170)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(Z)V", line = 188)
    ...
    @OriginalMember(owner = "client!gl", name = "f", descriptor = "(I)V", line = 215)
