...
public class class349 extends class739 {
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(BLvea;)I")
    ...
    @OriginalMember(owner = "client!gha", name = "e", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(Lsl;II)V")
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(ILei;)V")
