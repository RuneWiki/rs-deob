...
public class class349 extends class723 {
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(III[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!mda", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!mda", name = "b", descriptor = "()V", line = 69)
    ...
    @OriginalMember(owner = "client!mda", name = "b", descriptor = "(III[I)V", line = 78)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(IIIIII)V", line = 91)
    ...
    @OriginalMember(owner = "client!mda", name = "g", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!mda", name = "c", descriptor = "(III[I)V", line = 145)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "()Luha;", line = 159)
    ...
    @OriginalMember(owner = "client!mda", name = "b", descriptor = "(III)V", line = 194)
    ...
    @OriginalMember(owner = "client!mda", name = "e", descriptor = "(I)V", line = 205)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Luha;)V", line = 217)
    ...
    @OriginalMember(owner = "client!mda", name = "<init>", descriptor = "()V", line = 245)
    public class349() {
        this.method860();
    }

    @OriginalMember(owner = "client!mda", name = "d", descriptor = "(I)V", line = 253)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "([I)V", line = 267)
    ...
    @OriginalMember(owner = "client!mda", name = "f", descriptor = "(I)V", line = 285)
    ...
    @OriginalMember(owner = "client!mda", name = "c", descriptor = "(I)V", line = 312)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(III)V", line = 340)
