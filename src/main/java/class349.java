...
public class class349 extends class198 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(ILlm;)V", line = 4)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(BIIII)V", line = 21)
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;I)V", line = 63)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(ZLol;)V", line = 116)
