...
public abstract class class349 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(JB)I", line = 3)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(B)Llo;", line = 28)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(B)V", line = 43)
