...
public class class349 extends class344 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ZIB)Lkv;")
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(Lvf;Lpia;)V")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Lgb;II)V")
