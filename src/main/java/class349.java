...
public class class349 extends class182 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Z)V", line = 26)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(ILvfa;B)V", line = 59)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(ZZ)V", line = 75)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIFIIII[FIFIFI)V", line = 123)
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Lag;Lica;)V", line = 210)
    ...
    @OriginalMember(owner = "client!j", name = "b", descriptor = "(B)Z", line = 259)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(ZI)V", line = 272)
    ...
    @OriginalMember(owner = "client!j", name = "b", descriptor = "(I)V", line = 282)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(III)V", line = 294)
