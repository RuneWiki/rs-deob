...
public class class349 extends OutputStream {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IZIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!sc", name = "write", descriptor = "(I)V", line = 223)
    public final void write(int arg0) throws IOException {
        field4875++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(B)V", line = 233)
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(B)V", line = 250)
