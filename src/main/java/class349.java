...
public class class349 extends class18 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(BLnc;)V")
    ...
    @OriginalMember(owner = "client!pm", name = "c", descriptor = "()Lpm;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lnc;)V")
