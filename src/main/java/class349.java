...
public class class349 extends class669 {
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Lss;Lbi;Lmca;)V", line = 50)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(ZI)V", line = 69)
    ...
    @OriginalMember(owner = "client!ku", name = "d", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!ku", name = "e", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(I)Z", line = 111)
    ...
    @OriginalMember(owner = "client!ku", name = "f", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(ZZ)V", line = 141)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(I)V", line = 160)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IILnq;)V", line = 186)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(BII)V", line = 196)
