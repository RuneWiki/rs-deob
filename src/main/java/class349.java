...
public class class349 extends class454 {
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "(Lkd;IIII[BI)V", line = 21)
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "(Lkd;IIII)V", line = 37)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(IIIIIIII)V", line = 67)
