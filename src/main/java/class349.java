...
public class class349 extends class393 {
    ...
    @OriginalMember(owner = "client!dda", name = "<init>", descriptor = "(Ljaggl/OpenGL;Ljava/awt/Canvas;JLfa;Ljn;I)V")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Lfj;I)V")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(IILel;)V")
    ...
    @OriginalMember(owner = "client!dda", name = "h", descriptor = "()Lik;")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(IIILqf;)V")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(ZIILfca;[BIZI)Lco;")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(IZLuf;Z)V")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(ZIILuf;Z)V")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Lfca;III[FIIZ)Lco;")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Lfca;ILbv;)Z")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(B[Lmm;)Lfj;")
    ...
    @OriginalMember(owner = "client!dda", name = "e", descriptor = "(II)Ljfa;")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "([IIIIIZI)Lco;")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(ILfca;BILbv;)Lco;")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "([BILfca;III)Lck;")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(ILqf;IIILcda;B)V")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(IZ[[II)Lgi;")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(ZI)Lcda;")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Lcaa;Lcaa;FLcaa;)Lcaa;")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Lcr;I)V")
    ...
    @OriginalMember(owner = "client!dda", name = "T", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!dda", name = "b", descriptor = "(BZ)Lel;")
    public final class508 method516(byte arg0, boolean arg1) {
        ++field4625;
        return arg0 < 50 ? null : new class665(this, arg1);
    }

    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Lfca;ZLbv;)Z")
