...
public class class349 extends class314 {
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(Z)J", line = 8)
    public final long method1878(boolean arg0) {
        return arg0 ? this.field4636 : 71L;
    }

    @OriginalMember(owner = "client!gha", name = "e", descriptor = "(I)I", line = 18)
    ...
    @OriginalMember(owner = "client!gha", name = "c", descriptor = "(I)I", line = 29)
    public final int method1879(int arg0) {
        int var2 = 64 % ((arg0 - 72) / 49);
        return this.field4635;
    }

    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(I)I", line = 38)
    public final int method1875(int arg0) {
        return arg0 <= 34 ? 1 : this.field4633;
    }

    @OriginalMember(owner = "client!gha", name = "b", descriptor = "(I)I", line = 50)
