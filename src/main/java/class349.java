...
public class class349 extends class627 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(I)Lgba;", line = 6)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IIB)V", line = 35)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lha;IIIIILrj;ILka;IIIII)Lka;", line = 46)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(JJ)J", line = 220)
    public static long method2046(long arg0, long arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(ILtn;)Lfa;", line = 232)
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "()V", line = 252)
    public class349() {
    }

    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 254)
