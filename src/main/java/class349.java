...
public class class349 extends class551 {
    ...
    @OriginalMember(owner = "client!qm", name = "g", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IZLps;)V")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ILps;)V")
