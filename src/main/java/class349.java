...
public class class349 {
    ...
    @OriginalMember(owner = "client!uj", name = "toString", descriptor = "()Ljava/lang/String;", line = 11)
    public final String toString() {
        field5021++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(IIIIB)V", line = 32)
