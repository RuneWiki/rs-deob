...
public class class349 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(ZLvj;ZI)V")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IB)Lnp;")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IILfs;I)Lcn;")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lya;IILc;III[[[B[I[I[I[I[IIBIIZ)V")
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "(ILfs;Lfs;)V")
