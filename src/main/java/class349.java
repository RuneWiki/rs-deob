...
public class class349 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(III)Lbq;")
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(II)Lqg;")
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(Ljk;ILae;Lae;)V")
