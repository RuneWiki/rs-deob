...
public class class349 extends class216 {
    ...
    @OriginalMember(owner = "client!mda", name = "c", descriptor = "([III)V", line = 5)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "([III)V", line = 18)
    ...
    @OriginalMember(owner = "client!mda", name = "b", descriptor = "()I", line = 63)
    public final int method552() {
        return 0;
    }

    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Lkp;)V", line = 66)
    ...
    @OriginalMember(owner = "client!mda", name = "e", descriptor = "()V", line = 79)
    ...
    @OriginalMember(owner = "client!mda", name = "b", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Laca;)V", line = 109)
    public final synchronized void method2223(class216 arg0) {
        arg0.method636((byte) 97);
    }

    @OriginalMember(owner = "client!mda", name = "c", descriptor = "()Laca;", line = 113)
    public final class216 method531() {
        return (class216) this.field5129.method3469((byte) 107);
    }

    @OriginalMember(owner = "client!mda", name = "a", descriptor = "()Laca;", line = 116)
    public final class216 method532() {
        return (class216) this.field5129.method3463((byte) -50);
    }

    @OriginalMember(owner = "client!mda", name = "f", descriptor = "()I", line = 120)
    public final synchronized int method2224() {
        return this.field5129.method3467(25623);
    }

    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Lds;Lkp;)V", line = 179)
    ...
    @OriginalMember(owner = "client!mda", name = "b", descriptor = "(Laca;)V", line = 193)
