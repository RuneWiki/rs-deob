...
public class class349 extends class383 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Ljava/util/Random;BI)I", line = 14)
    ...
    @OriginalMember(owner = "client!ve", name = "e", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(II)I", line = 78)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "()V", line = 91)
    public class349() {
    }

    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(S)V", line = 94)
