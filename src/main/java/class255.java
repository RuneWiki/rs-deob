...
public class class255 extends class640 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IILub;)V", line = 5)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Ljava/lang/String;Ljava/awt/Color;Ljava/awt/Color;Ljava/awt/Color;II)V", line = 73)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lha;JB)V", line = 161)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(ZLha;IIJ)V", line = 193)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(B)V", line = 450)
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(Lha;Ljk;Lkq;J)V", line = 488)
