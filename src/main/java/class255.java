...
public class class255 {
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!ig", name = "c", descriptor = "()[F", line = 144)
    public final float[] method2157() {
        return this.field3883[this.method2158()];
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "()I", line = 150)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(II)I", line = 159)
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "()V", line = 165)
    public class255() {
