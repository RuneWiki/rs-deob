...
public class class255 extends OutputStream {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "([Luv;II)V", line = 8)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(ZLdc;)V", line = 108)
    ...
    @OriginalMember(owner = "client!wb", name = "write", descriptor = "(I)V", line = 155)
    public final void write(int arg0) throws IOException {
        field3721++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Z)V", line = 165)
