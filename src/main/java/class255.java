...
public class class255 extends class393 implements MouseWheelListener {
    ...
    @OriginalMember(owner = "client!vj", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 4)
    public final synchronized void mouseWheelMoved(MouseWheelEvent arg0) {
        this.field3492 += arg0.getWheelRotation();
    }

    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(I)I", line = 16)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 28)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 40)
