...
public abstract class class255 extends class7 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IBI)V", line = 4)
    ...
    @OriginalMember(owner = "client!os", name = "c", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(II)Lfd;", line = 35)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(I[Lfn;ILe;IZIZII[BI)V", line = 60)
    ...
    @OriginalMember(owner = "client!os", name = "h", descriptor = "(I)V", line = 160)
