...
public class class255 extends class135 {
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(ZI)V", line = 26)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Laj;II)V", line = 50)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IIIIJBLis;Lua;I)V", line = 61)
    ...
    @OriginalMember(owner = "client!ae", name = "g", descriptor = "(I)Z", line = 113)
    public final boolean method379(int arg0) {
        ++field3680;
        return arg0 != -4931 ? true : this.field3684.method2141(-77);
    }

    @OriginalMember(owner = "client!ae", name = "d", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(III)V", line = 149)
    ...
    @OriginalMember(owner = "client!ae", name = "i", descriptor = "(I)V", line = 190)
    public static void method1624(int arg0) {
        int var1 = -15 % ((-39 - arg0) / 38);
        field3682 = null;
    }

    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "(Lnh;Lob;)V", line = 201)
    public class255(class495 arg0, class354 arg1) {
        super(arg0);
        this.field3684 = arg1;
    }

    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Z)V", line = 209)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IZ)V", line = 248)
