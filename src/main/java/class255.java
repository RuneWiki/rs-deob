...
public class class255 extends class85 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ZLbt;[I)V")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ILbt;B)V")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(BI)Ljd;")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ZLbt;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lbt;I)V")
