...
public class class255 extends class82 {
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(Lrf;)V")
    ...
    @OriginalMember(owner = "client!nw", name = "b", descriptor = "()Lms;")
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(Lms;)V")
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(Ldd;Lrf;)V")
    ...
    @OriginalMember(owner = "client!nw", name = "b", descriptor = "(Lms;)V")
    public final synchronized void method1807(class82 arg0) {
        this.field4108.method288(arg0, 28);
    }

    @OriginalMember(owner = "client!nw", name = "a", descriptor = "()Lms;")
