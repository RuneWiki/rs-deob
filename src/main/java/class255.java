...
public class class255 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ILap;I)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(BLap;Ltg;)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lap;I)V")
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(Lap;I)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(BLap;)V")
