...
public class class255 {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ZIIIILdda;)V", line = 8)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(II[BI)V", line = 30)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Z)V", line = 154)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "(Lin;II)V", line = 566)
    ...
    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(I)V", line = 254)
    ...
    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(Z)Ljava/io/File;", line = 304)
    ...
    @OriginalMember(owner = "client!lt", name = "c", descriptor = "(I)J", line = 317)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "([BIII)V", line = 336)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(B[B)V", line = 523)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(JB)V", line = 535)
