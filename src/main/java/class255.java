...
public class class255 extends class443 {
    ...
    @OriginalMember(owner = "client!ul", name = "d", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(II)Z", line = 21)
    ...
    @OriginalMember(owner = "client!ul", name = "e", descriptor = "(I)Z", line = 40)
    ...
    @OriginalMember(owner = "client!ul", name = "c", descriptor = "(II)Z", line = 145)
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "(I)V", line = 155)
