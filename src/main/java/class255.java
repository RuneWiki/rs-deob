...
public class class255 extends class441 implements class143 {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Lvq;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ti", name = "d", descriptor = "(B)I", line = 31)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Lvq;IIB)Z", line = 43)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Lvq;BI)Lni;", line = 63)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(ILvq;)V", line = 84)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Z)Z", line = 114)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IILvq;)Lni;", line = 127)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Lvq;B)V", line = 140)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(BLvq;)Lbf;", line = 150)
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(Lvq;Lbi;IIIIZIIIII)V", line = 190)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(B)I", line = 214)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(I)V", line = 229)
    ...
    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(I)I", line = 242)
    ...
    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(B)I", line = 259)
    public final int method603(byte arg0) {
        ++field3781;
        return arg0 != -62 ? -82 : this.field3796;
    }

    @OriginalMember(owner = "client!ti", name = "g", descriptor = "(I)V", line = 271)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(ZILvq;I)Lsl;", line = 284)
    ...
    @OriginalMember(owner = "client!ti", name = "e", descriptor = "(B)V", line = 319)
