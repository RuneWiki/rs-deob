...
public class class255 {
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(II)V", line = 33)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(IZ)V", line = 48)
    ...
    @OriginalMember(owner = "client!mv", name = "b", descriptor = "(II)Lrs;", line = 63)
    ...
    @OriginalMember(owner = "client!mv", name = "b", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(CB)Z", line = 129)
    ...
    @OriginalMember(owner = "client!mv", name = "c", descriptor = "(B)V", line = 158)
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(Lee;ILul;)V", line = 176)
