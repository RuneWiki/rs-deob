...
public class class255 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Ljq;Z)V")
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Lqt;Z)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Lft;ILjava/lang/String;ZZ)V")
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Lqt;ILjava/lang/Object;I)V")
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Ljava/lang/Object;ILqt;)V")
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Lqt;B)V")
