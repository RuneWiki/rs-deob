...
public class class255 extends class233 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lth;IIIIIIIIIIIZZ)V", line = 147)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Lth;IIIIIIIIIIIZZ)V", line = 571)
