...
public class class255 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(B)Ljs;", line = 29)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ILjs;)V", line = 56)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IIILws;)V", line = 75)
    ...
    @OriginalMember(owner = "client!ot", name = "c", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(I)Ljs;", line = 113)
    ...
    @OriginalMember(owner = "client!ot", name = "d", descriptor = "(B)V", line = 136)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "()V", line = 195)
    public class255() {
        this.field3567.field1638 = this.field3567;
        this.field3567.field1640 = this.field3567;
    }

    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(I)Ljs;", line = 168)
