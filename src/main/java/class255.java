...
public class class255 {
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(IZI)Ldca;", line = 15)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(Lfca;B)V", line = 57)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(ZZ)V", line = 88)
