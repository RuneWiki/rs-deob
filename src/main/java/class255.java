...
public class class255 {
    ...
    @OriginalMember(owner = "client!kd", name = "enter", descriptor = "(Ljava/awt/Frame;IIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!kd", name = "exit", descriptor = "()V", line = 72)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(BLjava/awt/Frame;)V", line = 92)
    ...
    @OriginalMember(owner = "client!kd", name = "listmodes", descriptor = "()[I", line = 139)
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "()V", line = 158)
