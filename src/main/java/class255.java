...
public class class255 {
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IBLrt;)V", line = 110)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Lef;Lgb;Leg;IIIII)V", line = 197)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "([BIII)V", line = 147)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lvj;", line = 161)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(II)I", line = 179)
    public static int method1532(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(I)V", line = 323)
