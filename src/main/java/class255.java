...
public class class255 extends class454 {
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(BZII)V", line = 9)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(Z)I", line = 26)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(CII)C", line = 39)
    ...
    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "([B)V", line = 117)
