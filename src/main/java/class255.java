...
public class class255 implements class456 {
    ...
    @OriginalMember(owner = "client!rr", name = "b", descriptor = "(II)I", line = 24)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(ZI)I", line = 45)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(III)V", line = 87)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IIZII)V", line = 113)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(B)V", line = 229)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(II)I", line = 262)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IBI)V", line = 285)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(BLvc;)V", line = 322)
    ...
    @OriginalMember(owner = "client!rr", name = "b", descriptor = "(III)V", line = 373)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IIB)V", line = 396)
    ...
    @OriginalMember(owner = "client!rr", name = "c", descriptor = "(II)[[[B", line = 439)
