...
public abstract class class255 extends class184 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 14)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Lvd;Ld;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(III)Z", line = 53)
