...
public class class255 {
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(BIII)V", line = 37)
    ...
    @OriginalMember(owner = "client!kf", name = "toString", descriptor = "()Ljava/lang/String;", line = 53)
