...
public class class255 extends class238 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Llia;Lrv;B)Laf;", line = 3)
    ...
    @OriginalMember(owner = "client!nj", name = "c", descriptor = "(I)Ldg;", line = 101)
    public final class430 method1680(int arg0) {
        ++field3584;
        return arg0 != 2 ? null : this.field3578;
    }

    @OriginalMember(owner = "client!nj", name = "g", descriptor = "(I)D", line = 112)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(II)V", line = 171)
    ...
    @OriginalMember(owner = "client!nj", name = "b", descriptor = "(B)I", line = 187)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(ILjagtheora/ogg/OggPacket;)V", line = 199)
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 262)
