...
public class class255 {
    ...
    @OriginalMember(owner = "client!bv", name = "toString", descriptor = "()Ljava/lang/String;", line = 9)
    public final String toString() {
        field3274++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(Let;II)Ljava/lang/String;", line = 26)
    ...
    @OriginalMember(owner = "client!bv", name = "<init>", descriptor = "(II)V", line = 55)
    public class255(int arg0, int arg1) {
        this.field3279 = arg0;
    }

    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(I)V", line = 65)
