...
public class class255 extends class465 {
    ...
    @OriginalMember(owner = "client!up", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IILhf;)V", line = 99)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IZ)V", line = 114)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(BZ)V", line = 125)
    ...
    @OriginalMember(owner = "client!up", name = "d", descriptor = "(I)V", line = 135)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(III)V", line = 146)
    ...
    @OriginalMember(owner = "client!up", name = "b", descriptor = "(I)V", line = 157)
    ...
    @OriginalMember(owner = "client!up", name = "c", descriptor = "(I)Z", line = 168)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(Lno;)V", line = 180)
