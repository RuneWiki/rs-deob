...
public class class255 {
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(II)Lda;", line = 31)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(IIIIIZ)V", line = 58)
    ...
    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "(Llf;ILvh;)V", line = 265)
