...
public class class255 {
    ...
    @OriginalMember(owner = "client!at", name = "b", descriptor = "(B)Lrp;")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(II)Lat;")
    ...
    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "(Lat;I)V")
