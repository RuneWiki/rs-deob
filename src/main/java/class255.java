...
public class class255 {
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!vj", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/String;", line = 57)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(II)I", line = 113)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(ILtq;)V", line = 130)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 145)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(B)V", line = 218)
