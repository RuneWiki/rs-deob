...
public class class255 extends class353 implements class526 {
    ...
    @OriginalMember(owner = "client!kd", name = "k", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!kd", name = "g", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(Lr;I)Lbca;", line = 44)
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(I)Z", line = 100)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ILr;)Lcr;", line = 113)
    ...
    @OriginalMember(owner = "client!kd", name = "h", descriptor = "(B)V", line = 125)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(B)I", line = 136)
    ...
    @OriginalMember(owner = "client!kd", name = "e", descriptor = "(B)Z", line = 147)
    ...
    @OriginalMember(owner = "client!kd", name = "f", descriptor = "(I)I", line = 157)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IIILr;)Z", line = 168)
    ...
    @OriginalMember(owner = "client!kd", name = "d", descriptor = "(I)I", line = 188)
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(Lr;Ljs;IIIIIZIIIII)V", line = 294)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Z)I", line = 202)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lr;I)V", line = 216)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lr;Z)V", line = 227)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(BLr;)V", line = 248)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IIIIIIIIII)V", line = 259)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(I)V", line = 283)
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(B)I", line = 303)
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(Z)Z", line = 313)
