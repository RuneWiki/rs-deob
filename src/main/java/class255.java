...
public abstract class class255 {
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(IB)Z", line = 4)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(BII)V", line = 72)
    ...
    @OriginalMember(owner = "client!lba", name = "b", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(JZIIIIILtf;)V", line = 101)
    ...
    @OriginalMember(owner = "client!lba", name = "d", descriptor = "(I)V", line = 125)
