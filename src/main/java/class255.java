...
public class class255 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Z)Z", line = 24)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ZI)Lko;", line = 96)
    ...
    @OriginalMember(owner = "client!ko", name = "toString", descriptor = "()Ljava/lang/String;", line = 166)
    public final String toString() {
        field3336++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ko", name = "a", descriptor = "([BII)[B", line = 181)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILda;Lhca;ILr;IIBIIIIII)Lda;", line = 195)
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(IILvea;)V", line = 366)
