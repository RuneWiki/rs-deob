...
public class class255 extends class55 {
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 12)
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "()V", line = 33)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "()V", line = 48)
    ...
    @OriginalMember(owner = "client!he", name = "d", descriptor = "()I", line = 102)
    public final int method411() {
        return this.field3531 - (this.field3533.available() >> (class103.field1483 ? 2 : 1));
    }

    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 115)
