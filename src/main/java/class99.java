...
public abstract class class99 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(BII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Lic;IIB)Lqc;", line = 47)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(BIIIIIIIII)V", line = 64)
