...
public class class99 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Lpc;II)I", line = 13)
    public static final int method744(class476 arg0, int arg1, int arg2) {
        field1201++;
        return arg2;
    }

    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IIC)C", line = 23)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IIIILho;)V", line = 113)
