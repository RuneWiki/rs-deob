...
public class class99 extends class200 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(BI)I", line = 4)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IIIII[III)V", line = 18)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Lqa;IILia;III[[[B[I[I[I[I[IIBIIZ)V", line = 126)
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "([B)V", line = 285)
