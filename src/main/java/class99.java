...
public class class99 extends class648 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Lns;Lb;)V")
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Lb;)V")
    ...
    @OriginalMember(owner = "client!db", name = "d", descriptor = "()Lrn;")
