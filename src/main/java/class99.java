...
public class class99 extends Canvas {
    ...
    @OriginalMember(owner = "client!pj", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 11)
    public final void paint(Graphics arg0) {
        field1488++;
        this.field1489.paint(arg0);
    }

    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 20)
    public class99(Component arg0) {
        this.field1489 = arg0;
    }

    @OriginalMember(owner = "client!pj", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 29)
