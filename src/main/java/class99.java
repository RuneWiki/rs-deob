...
public class class99 extends class318 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IZ)V", line = 9)
    public final void method722(int arg0, boolean arg1) {
        ++field1418;
        int var3 = 95 % ((arg0 - -23) / 46);
    }

    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lav;IB)V", line = 18)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(III)V", line = 30)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(I)Z", line = 40)
    ...
    @OriginalMember(owner = "client!qm", name = "c", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(Lkd;)V", line = 78)
    public class99(class188 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ZZ)V", line = 88)
