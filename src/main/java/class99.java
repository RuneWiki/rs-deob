...
public class class99 extends class304 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(Lse;)V", line = 20)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Lgd;)V", line = 61)
    public final void method629(class344 arg0) {
        this.field4557.method1915(arg0);
    }

    @OriginalMember(owner = "client!of", name = "b", descriptor = "()Z", line = 64)
    public final boolean method628() {
        return true;
    }

    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Z)V", line = 67)
    public final void method624(boolean arg0) {
        this.field4557.method1911(8448, 7681);
    }

    @OriginalMember(owner = "client!of", name = "b", descriptor = "(Z)V", line = 71)
