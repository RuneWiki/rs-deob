...
public class class99 implements Runnable {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Lq;IB)Lqg;", line = 20)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ILq;I)Lqg;", line = 54)
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(B)Z", line = 77)
    ...
    @OriginalMember(owner = "client!ls", name = "<init>", descriptor = "(Lis;)V", line = 256)
    ...
    @OriginalMember(owner = "client!ls", name = "c", descriptor = "(B)V", line = 99)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ZLqg;)V", line = 109)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 124)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(I[BILq;)Lqg;", line = 157)
    ...
    @OriginalMember(owner = "client!ls", name = "run", descriptor = "()V", line = 176)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Z)V", line = 221)
