...
public class class99 extends class301 {
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(ILkg;)V", line = 4)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(BI)V", line = 168)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(ZI)V", line = 189)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(ZLsa;FII)V", line = 216)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(B)V", line = 241)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(Lbr;B)V", line = 263)
    ...
    @OriginalMember(owner = "client!aaa", name = "c", descriptor = "(B)V", line = 287)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(ILbr;)V", line = 302)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(IB)V", line = 328)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(ZLbr;)V", line = 383)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(I)V", line = 409)
    ...
    @OriginalMember(owner = "client!aaa", name = "b", descriptor = "(I)Lvg;", line = 434)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(II)V", line = 475)
