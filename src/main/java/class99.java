...
public class class99 extends class511 {
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(BIIII)I", line = 28)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(BZ)Z", line = 44)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(ILot;Lot;I)V", line = 81)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(Lwo;I)I", line = 238)
    ...
    @OriginalMember(owner = "client!aaa", name = "h", descriptor = "(I)Z", line = 267)
    ...
    @OriginalMember(owner = "client!aaa", name = "b", descriptor = "(I)I", line = 304)
    ...
    @OriginalMember(owner = "client!aaa", name = "i", descriptor = "(I)Z", line = 318)
    ...
    @OriginalMember(owner = "client!aaa", name = "c", descriptor = "(B)V", line = 330)
    ...
    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "(Los;)V", line = 351)
    public class99(class468 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(II)V", line = 358)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(III)V", line = 384)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(Ljq;IFFIIFIFIF)[B", line = 460)
