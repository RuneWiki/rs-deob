...
public class class99 extends class11 {
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(Z)[Lqw;")
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(Ldv;BIILba;IILoa;IIIIIII)Lba;")
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(Lok;)V")
