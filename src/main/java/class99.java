...
public class class99 extends class225 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ILnj;)V")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "([Lps;II)V")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(II)Lfp;")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ILma;)V")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ILnj;I)V")
