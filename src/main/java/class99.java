...
public class class99 extends class129 implements MouseWheelListener {
    ...
    @OriginalMember(owner = "client!oe", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 4)
    public final synchronized void mouseWheelMoved(MouseWheelEvent arg0) {
        this.field1565 += arg0.getWheelRotation();
    }

    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Ljava/awt/Component;Z)V", line = 11)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(I)I", line = 22)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(BLjava/awt/Component;)V", line = 32)
