...
public class class99 {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IJ)Lfs;", line = 3)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(B)Lfs;", line = 38)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lfs;IJ)V", line = 71)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(I)Lle;", line = 95)
    ...
    @OriginalMember(owner = "client!c", name = "b", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IB)V", line = 127)
    ...
    @OriginalMember(owner = "client!c", name = "b", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!c", name = "<init>", descriptor = "(I)V", line = 175)
