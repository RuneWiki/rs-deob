...
public class class99 extends class62 {
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(BILfaa;II)V")
    ...
    @OriginalMember(owner = "client!uaa", name = "h", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(Lgw;II)V")
