...
public class class99 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(BLrr;)V")
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(IIBIZ)Lcd;")
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Lji;B)V")
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(ILji;I)V")
