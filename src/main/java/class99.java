...
public class class99 extends class665 {
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/Class;", line = 5)
    ...
    @OriginalMember(owner = "client!lfa", name = "<init>", descriptor = "()V", line = 56)
    public class99() {
    }

    @OriginalMember(owner = "client!lfa", name = "<init>", descriptor = "(J)V", line = 61)
