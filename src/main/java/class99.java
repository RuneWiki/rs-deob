...
public class class99 implements Runnable {
    ...
    @OriginalMember(owner = "client!vf", name = "run", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "([IB)Ljava/lang/String;", line = 55)
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IIIII)V", line = 122)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(II)I", line = 140)
