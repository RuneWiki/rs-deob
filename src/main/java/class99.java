...
public class class99 {
    ...
    @OriginalMember(owner = "client!vc", name = "m", descriptor = "[B")
    ...
    public static final void method690(byte arg0) {
        ...
        field1650++;
        class477.field7052 = null;
        class251.method1704(0, -1, class49.field825, class379.field5881, 0, 0, -1, 0, class358.field5581);
        if (class477.field7052 != null) {
            class111.method801(class529.field7780.field1098, true, 0, -1412584499, 0, class358.field5581, class510.field7419, class477.field7052, class49.field825, class29.field475);
            class477.field7052 = null;
        }
    }
}
