...
public class class99 extends class477 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(BII)V", line = 6)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(B)Z", line = 31)
    public final boolean method264(byte arg0) {
        ++field1383;
        return arg0 < 45 ? true : true;
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Lrh;II)V", line = 43)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ZZ)V", line = 55)
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(Lgk;)V", line = 216)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ZI)V", line = 91)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ZLjava/lang/String;IB)Z", line = 105)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(B)V", line = 180)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 202)
