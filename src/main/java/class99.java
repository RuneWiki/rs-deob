...
public class class99 extends class161 {
    ...
    @OriginalMember(owner = "client!sb", name = "c", descriptor = "()I", line = 18)
    public final int method569() {
        return this.field1323 - (this.field1325.available() >> (class654.field8426 ? 2 : 1));
    }

    @OriginalMember(owner = "client!sb", name = "a", descriptor = "()V", line = 25)
    ...
    @OriginalMember(owner = "client!sb", name = "c", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 40)
    ...
    @OriginalMember(owner = "client!sb", name = "b", descriptor = "()V", line = 64)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 99)
    ...
    @OriginalMember(owner = "client!sb", name = "d", descriptor = "()V", line = 135)
