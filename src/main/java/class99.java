...
public class class99 {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;BILjava/lang/String;I)V", line = 17)
    ...
    @OriginalMember(owner = "client!ud", name = "b", descriptor = "(II)Z", line = 44)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(BI)Lsp;", line = 80)
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Ljk;ILae;)V", line = 116)
    ...
    @OriginalMember(owner = "client!ud", name = "b", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!ud", name = "c", descriptor = "(I)V", line = 147)
