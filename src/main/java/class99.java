...
public class class99 implements Runnable {
    ...
    @OriginalMember(owner = "client!ke", name = "c", descriptor = "Lsa;")
    public class167 field1990 = null;

    @OriginalMember(owner = "client!ke", name = "d", descriptor = "Lsa;")
    public class167 field1991 = null;

    @OriginalMember(owner = "client!ke", name = "a", descriptor = "Lsa;")
    ...
    @OriginalMember(owner = "client!ke", name = "g", descriptor = "Lda;")
    ...
    @OriginalMember(owner = "client!ke", name = "k", descriptor = "Lda;")
    ...
    @OriginalMember(owner = "client!ke", name = "p", descriptor = "Lfg;")
    ...
    @OriginalMember(owner = "client!ke", name = "h", descriptor = "Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!ke", name = "e", descriptor = "Ljava/lang/reflect/Method;")
    public static Method field1992;

    @OriginalMember(owner = "client!ke", name = "r", descriptor = "Ljava/lang/reflect/Method;")
    public static Method field2005;

    @OriginalMember(owner = "client!ke", name = "l", descriptor = "[Lsa;")
    public class167[] field1999;

    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Ljava/lang/Runnable;IB)Lda;")
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(I)Lfg;")
    public final class58 method695(int arg0) {
        int var2 = -65 % ((arg0 + 73) / 32);
        return this.field2003;
    }

    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(ILjava/lang/Object;IBI)Lda;")
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;Z)Lda;")
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Ljava/net/URL;I)Lda;")
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IZLjava/lang/String;)Lda;")
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Ljava/lang/String;[Ljava/lang/Class;Ljava/lang/Class;B)Lda;")
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(II)Lda;")
