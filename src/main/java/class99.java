...
public abstract class class99 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(III)V", line = 11)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(B)[Lnha;", line = 48)
