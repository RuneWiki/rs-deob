...
public class class99 extends class518 {
    ...
    @OriginalMember(owner = "client!hr", name = "f", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!hr", name = "c", descriptor = "(II)[I", line = 195)
    ...
    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "()V", line = 213)
    public class99() {
        super(1, true);
    }

    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(II)[I", line = 216)
    ...
    @OriginalMember(owner = "client!hr", name = "h", descriptor = "(I)V", line = 260)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(I)V", line = 277)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ILjc;I)V", line = 309)
    ...
    @OriginalMember(owner = "client!hr", name = "g", descriptor = "(I)V", line = 335)
