...
public class class99 extends class539 {
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(Lkw;B)V")
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(Ljr;B)V")
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(ZIILct;III)V")
    ...
    @OriginalMember(owner = "client!bba", name = "<init>", descriptor = "(ZLtt;)V")
