...
public class class99 implements class5 {

    @OriginalMember(owner = "client!qo", name = "a", descriptor = "I")
    private int field1643 = -1;

    @OriginalMember(owner = "client!qo", name = "c", descriptor = "[I")
    private int[] field1645 = null;

    @OriginalMember(owner = "client!qo", name = "b", descriptor = "Z")
    private boolean field1644 = false;

    @OriginalMember(owner = "client!qo", name = "d", descriptor = "()V", line = 14)
    private final void method782() {
        GL var1 = class42.field627;
        if (this.field1645 == null) {
            this.field1645 = new int[3];
            var1.glGenTextures(3, this.field1645, 0);
        }
        short var2 = 4096;
        ...
        for (int var6 = 0; var6 < 6; var6++) {
            ...
            var1.glBindTexture(34067, this.field1645[0]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var4));
            var1.glBindTexture(34067, this.field1645[1]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var5));
            var1.glBindTexture(34067, this.field1645[2]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var3));
            class199.field3173 += var2 * 3;
        }
    }

    @OriginalMember(owner = "client!qo", name = "b", descriptor = "()I", line = 131)
    public final int method20() {
        return 4;
    }

    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "()V", line = 260)
    public class99() {
        if (class42.field621 && class42.field603 >= 2) {
            this.method782();
            GL var1 = class42.field627;
            var1.glBindTexture(34067, this.field1645[0]);
            ...
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            this.field1644 = class42.field603 < 3;
        }
        this.method783();
    }

    @OriginalMember(owner = "client!qo", name = "e", descriptor = "()V", line = 140)
    private final void method783() {
        GL var1 = class42.field627;
        this.field1643 = var1.glGenLists(2);
        var1.glNewList(this.field1643, 4864);
        if (this.field1645 == null) {
            ...
            if (this.field1644) {
                ...
                var1.glTexEnvi(8960, 34162, 7681);
                var1.glTexEnvi(8960, 34184, 34167);
                var1.glBindTexture(3553, class42.field641);
                var1.glEnable(3553);
            }
            var1.glActiveTexture(33984);
        }
        var1.glEndList();
        var1.glNewList(this.field1643 + 1, 4864);
        if (this.field1645 == null) {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "()V", line = 234)
    public final void method18() {
        GL var1 = class42.field627;
        if (class3.field36) {
            var1.glCallList(this.field1643 + 1);
        } else {
            var1.glTexEnvi(8960, 34184, 5890);
        }
    }

    @OriginalMember(owner = "client!qo", name = "c", descriptor = "()V", line = 247)
    public final void method21() {
        GL var1 = class42.field627;
        class42.method277(1);
        if (class3.field36) {
            var1.glCallList(this.field1643);
        } else {
            var1.glTexEnvi(8960, 34184, 34167);
        }
    }

    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(I)V", line = 291)
    public final void method19(int arg0) {
        GL var2 = class42.field627;
        if (class3.field36 && this.field1645 != null) {
            var2.glActiveTexture(33985);
            var2.glBindTexture(34067, this.field1645[arg0 - 1]);
