...
public class class99 implements class123 {
    ...
    @OriginalMember(owner = "client!so", name = "b", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(BI)V", line = 14)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(IZLjava/awt/Component;I)V", line = 35)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(II)I", line = 67)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(III)V", line = 103)
    ...
    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "()V", line = 191)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(I[I)V", line = 145)
