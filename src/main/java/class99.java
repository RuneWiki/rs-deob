...
public class class99 extends class386 {
    ...
    @OriginalMember(owner = "client!qca", name = "<init>", descriptor = "()V", line = 5)
    public class99() {
        super(0, true);
    }
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(ILrda;[I[I[I)V", line = 22)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(IBLun;)V", line = 131)
    ...
    @OriginalMember(owner = "client!qca", name = "b", descriptor = "(Z)V", line = 196)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(II)[I", line = 217)
