...
public class class99 {
    ...
    private Robot field1345 = new Robot();

    @OriginalMember(owner = "client!qv", name = "b", descriptor = "Ljava/awt/Component;")
    private Component field1346;

    @OriginalMember(owner = "client!qv", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V", line = 6)
    public final void showcursor(Component arg0, boolean arg1) {
        ...
        if (this.field1346 == arg0) {
            return;
        }
        if (this.field1346 != null) {
            this.field1346.setCursor(null);
            this.field1346 = null;
        }
        if (arg0 != null) {
    ...
    @OriginalMember(owner = "client!qv", name = "movemouse", descriptor = "(II)V", line = 37)
    public final void movemouse(int arg0, int arg1) {
        this.field1345.mouseMove(arg0, arg1);
    }

    @OriginalMember(owner = "client!qv", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V", line = 44)
    ...
    @OriginalMember(owner = "client!qv", name = "<init>", descriptor = "()V", line = 59)
