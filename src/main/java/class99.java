...
public class class99 {
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 3)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(Z)V", line = 92)
    ...
    @OriginalMember(owner = "client!uaa", name = "<init>", descriptor = "(III)V", line = 103)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(I)V", line = 115)
