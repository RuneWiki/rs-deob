...
public class class99 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Lpp;IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(BLjava/lang/String;)V", line = 54)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(B)V", line = 82)
