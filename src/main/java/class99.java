...
public class class99 extends class435 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(IZ)I", line = 6)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(BI)Z", line = 37)
    ...
    @OriginalMember(owner = "client!so", name = "b", descriptor = "(IZ)I", line = 48)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(B)I", line = 68)
    public static final int method831(byte arg0) {
        field1475++;
        return arg0 == 73 ? class201.field3102 : -107;
    }

    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 85)
