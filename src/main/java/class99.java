...
public class class99 extends class362 {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Lfca;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IB)[[I", line = 18)
    ...
    @OriginalMember(owner = "client!in", name = "c", descriptor = "(I)V", line = 60)
    public static void method871(int arg0) {
        field1616 = null;
        int var1 = 82 / ((arg0 - 19) / 50);
    }

    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ZII)V", line = 71)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(II)[I", line = 146)
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "()V", line = 180)
    public class99() {
        super(1, false);
    }
}
