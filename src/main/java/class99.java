...
public class class99 extends class419 {
    ...
    @OriginalMember(owner = "client!sl", name = "b", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!sl", name = "c", descriptor = "(I)Lvi;", line = 18)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(III[[ZZI)V", line = 36)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(III[[ZZII)V", line = 46)
    ...
    @OriginalMember(owner = "client!sl", name = "YA", descriptor = "()V", line = 55)
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "(Lmj;IIII[[I[[II)V", line = 901)
    ...
    @OriginalMember(owner = "client!sl", name = "ka", descriptor = "(III)V", line = 670)
    ...
    @OriginalMember(owner = "client!sl", name = "b", descriptor = "(II)Z", line = 682)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(II)V", line = 693)
    public final void method821(int arg0, int arg1) {
        ++field1453;
    }

    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(I[[ZZIIIII)V", line = 703)
    ...
    @OriginalMember(owner = "client!sl", name = "wa", descriptor = "(Lr;IIIIZ)V", line = 845)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Lr;IIIIZ)Z", line = 867)
    ...
    @OriginalMember(owner = "client!sl", name = "CA", descriptor = "(Lr;IIIIZ)V", line = 885)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 972)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Llja;)V", line = 1058)
    public static final void method827(class724 arg0) {
        class316.field4495 = arg0;
    }

    @OriginalMember(owner = "client!sl", name = "U", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 1061)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(IIILsb;)V", line = 1138)
    ...
    @OriginalMember(owner = "client!sl", name = "fa", descriptor = "(IILr;)Lr;", line = 1199)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Lmfa;[I)V", line = 1228)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(IIIIIII[[Z)V", line = 1236)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "([BBIIII)V", line = 1452)
