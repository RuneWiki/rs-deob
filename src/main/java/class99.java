...
public class class99 extends class738 {
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "()Lql;", line = 15)
    ...
    @OriginalMember(owner = "client!iv", name = "f", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!iv", name = "c", descriptor = "(III)Z", line = 72)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(BII)Z", line = 83)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!iv", name = "e", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(III[I)V", line = 159)
    ...
    @OriginalMember(owner = "client!iv", name = "c", descriptor = "(III[I)V", line = 173)
    ...
    @OriginalMember(owner = "client!iv", name = "d", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "()V", line = 213)
    ...
    @OriginalMember(owner = "client!iv", name = "g", descriptor = "(I)V", line = 222)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "([I)V", line = 235)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Lql;)V", line = 251)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "([[BILjda;)V", line = 275)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(III)V", line = 347)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IIIIII)V", line = 372)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(III[I)V", line = 410)
    ...
    @OriginalMember(owner = "client!iv", name = "c", descriptor = "(I)V", line = 436)
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "()V", line = 452)
    public class99() {
        this.method769();
    }
}
