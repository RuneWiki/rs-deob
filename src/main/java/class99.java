...
public abstract class class99 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(BILwk;ILwk;IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(BIILjava/awt/Component;Lfq;)Ljl;", line = 55)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IIZLfo;)Ltv;", line = 143)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Llr;B)V", line = 173)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(II)V", line = 208)
