...
public class class351 {
    ...
    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "(Lffa;)V", line = 77)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IIIIIIIIII)Z", line = 20)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Z)V", line = 66)
