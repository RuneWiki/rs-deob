...
public class class351 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(I)Lgk;", line = 3)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(B)I", line = 23)
    ...
    @OriginalMember(owner = "client!ln", name = "b", descriptor = "(I)Lgk;", line = 43)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(IIIIIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "([BI)V", line = 104)
    ...
    @OriginalMember(owner = "client!ln", name = "c", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Lgk;Z)V", line = 155)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "()V", line = 180)
    public class351() {
