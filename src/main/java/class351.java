...
public class class351 extends class412 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Lkb;)V")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Lol;)V")
    ...
    @OriginalMember(owner = "client!lk", name = "d", descriptor = "()Lkb;")
    public final class412 method727() {
        return (class412) this.field5087.method2754(-1);
    }

    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(Lkb;)V")
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "()Lkb;")
    public final class412 method725() {
        return (class412) this.field5087.method2752(-124);
    }

    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Lge;Lol;)V")
