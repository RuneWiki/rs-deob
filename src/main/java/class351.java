...
public class class351 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(BJ)V", line = 4)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Lcd;IIIIII)V", line = 88)
