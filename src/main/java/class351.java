...
public class class351 {
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Z)Lvfa;")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lns;I)V")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lkba;I)V")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lu;Z)V")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(ILkba;)V")
