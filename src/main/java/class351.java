...
public class class351 extends class366 {
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(Z)V", line = 75)
    ...
    @OriginalMember(owner = "client!mq", name = "d", descriptor = "(I)La;", line = 116)
    ...
    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "(Lqg;)V", line = 158)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(ZI)V", line = 276)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IIB)V", line = 300)
    ...
    @OriginalMember(owner = "client!mq", name = "c", descriptor = "(Z)V", line = 318)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(ZZ)V", line = 333)
    ...
    @OriginalMember(owner = "client!mq", name = "c", descriptor = "(I)V", line = 347)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(ILgo;B)V", line = 376)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(I)Z", line = 388)
