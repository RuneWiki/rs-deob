...
public class class351 implements Runnable {
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(II[BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(Lvv;Z[[[BIB)Z", line = 49)
    ...
    @OriginalMember(owner = "client!bp", name = "run", descriptor = "()V", line = 85)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(ZI)V", line = 145)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(IILjava/util/Random;)I", line = 188)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(Z)V", line = 218)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(Lsea;ZIIIIZ)V", line = 242)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(I)V", line = 272)
    ...
    @OriginalMember(owner = "client!bp", name = "b", descriptor = "(I)V", line = 288)
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 304)
