...
public class class351 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IIILwl;)V")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IIIILfq;Loa;Lwm;ILmo;Ldd;Lwl;Lqb;)Lba;")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Lfq;ILwl;IIIIIILwm;Loa;I)Lba;")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Ldd;ILwm;IBILfq;[Luu;Lmo;Lwl;Loa;Lfq;IIILlq;Lqb;ZI)Lba;")
