...
public class class351 {
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "([IILpaa;[I[I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Llca;B)I", line = 116)
    ...
    @OriginalMember(owner = "client!ba", name = "toString", descriptor = "()Ljava/lang/String;", line = 152)
    public final String toString() {
        field5065++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ba", name = "<init>", descriptor = "(I)V", line = 160)
    public class351(int arg0) {
        this.field5069 = arg0;
    }

    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(I)V", line = 168)
