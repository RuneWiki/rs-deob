...
public class class351 extends class261 {
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "()V", line = 114)
    public final void method2179() {
        this.field5190 = null;
    }

    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lph;II)Lve;", line = 119)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(Lnn;)V", line = 126)
