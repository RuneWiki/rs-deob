...
public class class351 implements class687 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;I)Ljava/lang/Object;", line = 5)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ZJ)Z", line = 22)
    public final boolean method548(boolean arg0, long arg1) {
        field4486++;
        return !arg0;
    }

    @OriginalMember(owner = "client!ij", name = "b", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ZI)V", line = 67)
    ...
    @OriginalMember(owner = "client!ij", name = "d", descriptor = "(I)V", line = 252)
    ...
    @OriginalMember(owner = "client!ij", name = "e", descriptor = "(I)V", line = 297)
    ...
    @OriginalMember(owner = "client!ij", name = "c", descriptor = "(I)I", line = 339)
    ...
    @OriginalMember(owner = "client!ij", name = "f", descriptor = "(I)V", line = 354)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IZLoa;Z)Lta;", line = 365)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Class;Ljava/lang/Object;)I", line = 387)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(B)I", line = 400)
