...
public class class351 extends class31 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "([B[IIIIIIIIIIILem;II)V")
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(CIIIZLem;II)V")
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(Lco;Lfa;[Liq;[I[I)V")
