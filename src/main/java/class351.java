...
public class class351 extends class292 {
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "(Lnv;II)V")
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "(Lnv;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "(Lnv;IIZ[[BI)V")
