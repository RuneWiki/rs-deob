...
public class class351 extends class719 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!bb", name = "c", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(B)Z", line = 47)
    ...
    @OriginalMember(owner = "client!bb", name = "h", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!bb", name = "g", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ZZ)V", line = 108)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IZ)V", line = 119)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ZLb;I)V", line = 133)
    ...
    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "(Lsha;Luq;Lgaa;)V", line = 158)
    ...
    @OriginalMember(owner = "client!bb", name = "d", descriptor = "(B)V", line = 175)
