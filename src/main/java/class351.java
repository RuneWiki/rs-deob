...
public class class351 extends class175 {
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "([B[IIIIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(CIIIZ)V", line = 41)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "([B[IIIIIIIIIIILvj;II)V", line = 106)
    ...
    @OriginalMember(owner = "client!im", name = "b", descriptor = "([B[IIIIIIII)V", line = 202)
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(Lvn;Lvm;[Ldr;[I[I)V", line = 258)
    ...
    @OriginalMember(owner = "client!im", name = "b", descriptor = "([B[IIIIIIIIIIILvj;II)V", line = 279)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(CIIIZLvj;II)V", line = 365)
