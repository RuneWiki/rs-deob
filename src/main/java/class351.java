...
public class class351 {
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(ILnp;)Lcu;")
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(Lnp;I)Lmd;")
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(I[[[Lru;)V")
    ...
    @OriginalMember(owner = "client!hea", name = "<init>", descriptor = "(Lut;III)V")
