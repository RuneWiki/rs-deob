...
public class class351 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ILbt;)V", line = 4)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ILbt;I)V", line = 64)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ZZILwm;)Ljd;", line = 129)
