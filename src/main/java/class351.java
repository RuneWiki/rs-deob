...
public class class351 extends class343 implements class416 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(FFFFFFLi;II)V", line = 8)
    ...
    @OriginalMember(owner = "client!va", name = "finalize", descriptor = "()V", line = 13)
    ...
    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(Lc;Lk;[I[BIIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!va", name = "J", descriptor = "(III)V", line = 30)
    public final void method369(int arg0, int arg1, int arg2) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IILi;II)V", line = 36)
