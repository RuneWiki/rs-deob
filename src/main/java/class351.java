...
public class class351 implements Runnable {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Ljava/lang/Class;[Ljava/lang/Class;ILjava/lang/String;)Lmq;")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(I)Luh;")
    public final class92 method2237(int arg0) {
        int var2 = -49 / ((-arg0 - 23) / 54);
        return this.field4909;
    }

    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(I)Lmq;")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Ljava/lang/String;II)Lmq;")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(ZLjava/lang/Object;III)Lmq;")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(ILjava/awt/datatransfer/Transferable;)Lmq;")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(ZI)Lmq;")
    ...
    @OriginalMember(owner = "client!kq", name = "d", descriptor = "(I)Lmq;")
    public final class295 method2247(int arg0) {
        return arg0 == 0 ? this.method2243(false, (Object) null, 0, 0, 18) : null;
    }

    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(ZLjava/awt/Frame;)Lmq;")
    ...
    @OriginalMember(owner = "client!kq", name = "e", descriptor = "(I)Lmq;")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Ljava/lang/Class;I)Lmq;")
    public final class295 method2250(Class arg0, int arg1) {
        return arg1 == -2 ? this.method2243(false, arg0, 0, 0, 11) : null;
    }

    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(BZLjava/awt/Component;)Lmq;")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IBIII)Lmq;")
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(Ljava/lang/String;I)Lmq;")
    public final class295 method2253(String arg0, int arg1) {
        return arg1 <= 120 ? null : this.method2243(false, arg0, 0, 0, 21);
    }

    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IIIILjava/lang/Object;)Lmq;")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IIBLjava/awt/Component;)Lmq;")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(ILjava/lang/Class;)Lmq;")
    public final class295 method2258(int arg0, Class arg1) {
        return arg0 == 0 ? this.method2243(false, arg1, 0, 0, 10) : null;
    }

    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(ILjava/lang/Class;)Lmq;")
    public final class295 method2259(int arg0, Class arg1) {
        int var3 = -111 / ((-arg0 - 88) / 37);
        return this.method2243(false, arg1, 0, 0, 20);
    }

    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IILjava/awt/Point;Ljava/awt/Component;I[I)Lmq;")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IILjava/lang/Runnable;)Lmq;")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(ZLjava/lang/Class;Ljava/lang/String;)Lmq;")
