...
public class class351 extends class231 {
    ...
    @OriginalMember(owner = "client!nu", name = "f", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(ZIIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(Liv;Z)V", line = 113)
    ...
    @OriginalMember(owner = "client!nu", name = "c", descriptor = "(B)V", line = 128)
    ...
    @OriginalMember(owner = "client!nu", name = "b", descriptor = "(Lr;I)Lcu;", line = 139)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IZI)V", line = 151)
    ...
    @OriginalMember(owner = "client!nu", name = "c", descriptor = "(Z)I", line = 248)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(I)I", line = 268)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(ZI)V", line = 289)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(Lr;Z)V", line = 307)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(BLr;)Lqw;", line = 330)
    ...
    @OriginalMember(owner = "client!nu", name = "o", descriptor = "(I)Z", line = 459)
    ...
    @OriginalMember(owner = "client!nu", name = "b", descriptor = "(B)I", line = 473)
    ...
    @OriginalMember(owner = "client!nu", name = "b", descriptor = "(IZI)Ltda;", line = 501)
    ...
    @OriginalMember(owner = "client!nu", name = "i", descriptor = "(I)Z", line = 516)
    public final boolean method166(int arg0) {
        ++field4684;
        return arg0 != 0 ? false : false;
    }

    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(ZLr;II)Z", line = 531)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(Lr;II)Z", line = 582)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(ILir;ZILr;IB)V", line = 751)
    ...
    @OriginalMember(owner = "client!nu", name = "g", descriptor = "(B)Z", line = 768)
