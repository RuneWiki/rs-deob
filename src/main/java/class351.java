...
public class class351 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Z)Lmf;", line = 4)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(ILin;)V", line = 30)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(ILat;Lat;)V", line = 41)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(II)V", line = 63)
