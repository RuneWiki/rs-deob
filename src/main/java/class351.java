...
public class class351 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIZIIIIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIIII)V", line = 45)
