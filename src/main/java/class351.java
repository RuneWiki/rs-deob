...
public class class351 {
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(II)V", line = 28)
    ...
    @OriginalMember(owner = "client!hl", name = "b", descriptor = "(II)V", line = 39)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(BI)Lhn;", line = 61)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IZ)V", line = 114)
    ...
    @OriginalMember(owner = "client!hl", name = "c", descriptor = "(II)V", line = 131)
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(Lci;IZLhe;Lhe;)V", line = 218)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ZI)V", line = 165)
    ...
    @OriginalMember(owner = "client!hl", name = "b", descriptor = "(I)V", line = 184)
