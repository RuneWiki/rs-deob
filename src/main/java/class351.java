...
public class class351 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lqa;Ljava/lang/String;[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lqa;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lqa;Ljava/lang/String;IIIZ)V")
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(Lqa;IZLjava/awt/Component;)V")
