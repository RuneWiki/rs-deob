...
public class class351 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I)I", line = 15)
    ...
    @OriginalMember(owner = "client!cs", name = "toString", descriptor = "()Ljava/lang/String;", line = 45)
    public final String toString() {
        field4798++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(II)V", line = 52)
