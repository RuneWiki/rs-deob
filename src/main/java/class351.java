...
public class class351 extends class45 implements class579 {
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Lgf;Lkp;Lvt;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIIIZ)Llc;", line = 17)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(I)I", line = 58)
    public final int method475(int arg0) {
        ++field5008;
        return arg0 < 36 ? 2 : this.field5017;
    }

    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(ZZB)V", line = 70)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IF)F", line = 83)
    ...
    @OriginalMember(owner = "client!dg", name = "g", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIILkp;[BIBII)V", line = 109)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIIIII[II)V", line = 125)
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(I)I", line = 139)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(ZF)F", line = 151)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIII[FBLkp;II)V", line = 162)
    ...
    @OriginalMember(owner = "client!dg", name = "c", descriptor = "(B)Leba;", line = 184)
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Lgf;IIZ[III)V", line = 196)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(BI)Z", line = 215)
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Lgf;Lkp;IIZ[BII)V", line = 238)
    ...
    @OriginalMember(owner = "client!dg", name = "c", descriptor = "(I)Z", line = 260)
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Lgf;Lkp;IIZ[FII)V", line = 271)
