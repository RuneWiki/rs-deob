...
public class class351 {
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ow", name = "finalize", descriptor = "()V", line = 22)
    ...
    @OriginalMember(owner = "client!ow", name = "<init>", descriptor = "(Llaa;II)V", line = 32)
