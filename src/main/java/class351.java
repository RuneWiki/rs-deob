...
public class class351 extends class263 {
    ...
    @OriginalMember(owner = "client!nn", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ZII)V", line = 16)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IBLjava/net/Socket;)Lia;", line = 37)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(Lhr;)V", line = 62)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(III)I", line = 83)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(BII)Z", line = 101)
    ...
    @OriginalMember(owner = "client!nn", name = "d", descriptor = "(I)V", line = 113)
