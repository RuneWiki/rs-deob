...
public class class351 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IIII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(ILpi;)V", line = 65)
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(I)Z", line = 81)
    ...
    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "(Lbo;)V", line = 570)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(II)V", line = 99)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Z)V", line = 114)
    ...
    @OriginalMember(owner = "client!mq", name = "c", descriptor = "(I)V", line = 137)
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(ILpi;)Z", line = 200)
    ...
    @OriginalMember(owner = "client!mq", name = "d", descriptor = "(I)Z", line = 237)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(B)V", line = 374)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IIIII)Z", line = 476)
