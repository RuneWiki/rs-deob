...
public class class351 {
    ...
    @OriginalMember(owner = "client!jo", name = "toString", descriptor = "()Ljava/lang/String;", line = 24)
    public final String toString() {
        field5122++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(I)I", line = 34)
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(II)V", line = 46)
