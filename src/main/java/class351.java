...
public class class351 extends class291 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Lza;J)Z")
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Lza;J[Lck;[Lsd;Z)V")
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "([Lsd;Z)V")
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Lza;[Lck;Z)V")
    ...
    @OriginalMember(owner = "client!lm", name = "f", descriptor = "()Lsj;")
