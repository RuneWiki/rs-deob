...
public class class351 extends class299 {
    ...
    @OriginalMember(owner = "client!bb", name = "d", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(I[I[ILvf;BI)Lhr;", line = 16)
    ...
    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "(ILes;)V", line = 49)
    public class351(int arg0, class404 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "(Les;)V", line = 53)
    public class351(class404 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IZ)V", line = 57)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(Z)I", line = 71)
    ...
    @OriginalMember(owner = "client!bb", name = "c", descriptor = "(I)Z", line = 84)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(II)I", line = 104)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(I)I", line = 121)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(I)V", line = 132)
