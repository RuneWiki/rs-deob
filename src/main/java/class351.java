...
public class class351 {
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Loq;)V", line = 3)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Z)V", line = 31)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(IIIIIIIIII)Z", line = 62)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(B)V", line = 100)
    ...
    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(I)V", line = 115)
