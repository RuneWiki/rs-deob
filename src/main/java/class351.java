...
public class class351 extends class341 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(FFFFFFLi;II)V")
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lnq;IIII)V")
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IILi;II)V")
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lnq;II[III)V")
