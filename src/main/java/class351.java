...
public class class351 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IIIIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IBIIIIII)V", line = 92)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IIIIIIII)V", line = 170)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Z[Ljava/lang/Object;[I)V", line = 351)
