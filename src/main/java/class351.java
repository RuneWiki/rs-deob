...
public class class351 extends class465 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ZF)V", line = 4)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(FZ)V", line = 21)
    ...
    @OriginalMember(owner = "client!ij", name = "q", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "(I)V", line = 57)
