...
public class class351 extends class115 {
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!ia", name = "h", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(III)I", line = 36)
    ...
    @OriginalMember(owner = "client!ia", name = "i", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "()V", line = 80)
    public class351() {
        this(4096);
    }

    @OriginalMember(owner = "client!ia", name = "e", descriptor = "(B)V", line = 87)
    ...
    @OriginalMember(owner = "client!ia", name = "j", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(IIIII)V", line = 119)
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(I)V", line = 228)
    ...
    @OriginalMember(owner = "client!ia", name = "c", descriptor = "(II)I", line = 157)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(BLbk;I)V", line = 169)
    ...
    @OriginalMember(owner = "client!ia", name = "d", descriptor = "(II)V", line = 207)
