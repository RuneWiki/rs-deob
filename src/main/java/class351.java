...
public class class351 extends class400 {
    ...
    @OriginalMember(owner = "client!sr", name = "c", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!sr", name = "b", descriptor = "(Lya;I)Lmo;", line = 25)
    ...
    @OriginalMember(owner = "client!sr", name = "h", descriptor = "(I)I", line = 101)
    ...
    @OriginalMember(owner = "client!sr", name = "j", descriptor = "(I)Z", line = 122)
    ...
    @OriginalMember(owner = "client!sr", name = "b", descriptor = "(I)I", line = 134)
    ...
    @OriginalMember(owner = "client!sr", name = "f", descriptor = "(B)I", line = 156)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(BLla;Ljava/lang/String;Z)V", line = 180)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(ZIBIII)V", line = 208)
    ...
    @OriginalMember(owner = "client!sr", name = "g", descriptor = "(I)I", line = 283)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(III)V", line = 294)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Lya;I)V", line = 385)
    ...
    @OriginalMember(owner = "client!sr", name = "k", descriptor = "(I)Z", line = 410)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(ILya;II)Z", line = 430)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Lya;IIILqj;IZ)V", line = 467)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Lup;B)V", line = 482)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IBLya;)Z", line = 499)
    ...
    @OriginalMember(owner = "client!sr", name = "e", descriptor = "(I)Z", line = 693)
