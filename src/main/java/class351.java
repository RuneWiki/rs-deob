...
public class class351 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ILit;)V", line = 8)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(II)V", line = 30)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IILpj;Ljava/lang/Object;)V", line = 91)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ILpj;)Ljava/lang/Object;", line = 119)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(I)I", line = 171)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Ljava/lang/Object;Lpj;B)V", line = 182)
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(I)V", line = 198)
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(ILpj;)V", line = 215)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Z)V", line = 242)
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(Z)I", line = 267)
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(I)V", line = 285)
