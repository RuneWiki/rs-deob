...
public class class351 {
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(Lrc;Ljava/lang/Object;B)V")
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(BLg;)V")
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(Lrc;I)V")
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(IIIIIIIIIILuda;)Z")
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(IILrc;Ljava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(BLrc;)Ljava/lang/Object;")
