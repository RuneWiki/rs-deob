...
public class class351 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(II)Lgn;", line = 3)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(II)V", line = 61)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(ZI)Lam;", line = 93)
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "(Lwv;ILqs;)V", line = 127)
