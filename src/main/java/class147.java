...
public class class147 {
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(BLtn;)V")
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(I)Lbe;")
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(ILtn;I)V")
