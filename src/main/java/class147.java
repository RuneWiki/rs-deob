...
public class class147 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IIILdq;II)Ljava/awt/Frame;", line = 3)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(B)V", line = 79)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(ILfr;IILji;Lkm;)Z", line = 103)
