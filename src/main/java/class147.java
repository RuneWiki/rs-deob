...
public class class147 extends class152 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(IIB)Z", line = 5)
    public final boolean method889(int arg0, int arg1, byte arg2) {
        int var4 = -115 % ((arg2 - 50) / 52);
        return this.field1803.length >= (arg0 * arg1);
    }

    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(IIIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(IIIBIII)V", line = 40)
    ...
    @OriginalMember(owner = "client!kg", name = "e", descriptor = "(I)V", line = 477)
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "(Lao;II)V", line = 503)
    public class147(class157 arg0, int arg1, int arg2) {
        this.field1803 = new byte[arg1 * arg2];
    }

    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(II[BIII)V", line = 515)
