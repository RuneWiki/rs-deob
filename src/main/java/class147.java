...
public class class147 extends class748 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(I[[IIIIILjava/util/Random;)V", line = 12)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(B)V", line = 209)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(II)[I", line = 221)
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "()V", line = 579)
    public class147() {
        super(0, true);
    }

    @OriginalMember(owner = "client!un", name = "a", descriptor = "(IZLvj;)V", line = 481)
    ...
    @OriginalMember(owner = "client!un", name = "c", descriptor = "(II)V", line = 605)
