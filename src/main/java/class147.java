...
public class class147 extends class136 {
    ...
    @OriginalMember(owner = "client!hm", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(II)[I", line = 15)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IILiv;)V", line = 58)
    ...
    @OriginalMember(owner = "client!hm", name = "<init>", descriptor = "()V", line = 103)
    public class147() {
        super(1, false);
    }

    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(BI)[[I", line = 113)
