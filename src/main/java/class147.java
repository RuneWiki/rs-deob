...
public class class147 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IBI)Lnc;", line = 3)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(II)Z", line = 22)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(I)V", line = 48)
