...
public class class147 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 32)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ZLjava/lang/String;Ljava/lang/String;)V", line = 49)
