...
public class class147 {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IIBII[FIIFI)V", line = 32)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IBLoa;)Z", line = 88)
    ...
    @OriginalMember(owner = "client!eo", name = "<init>", descriptor = "(I[Lel;IIII)V", line = 291)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(III)Lwda;", line = 172)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IIZ)Z", line = 184)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IIILoa;IIIIII)V", line = 198)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "([SII)[S", line = 276)
    ...
    @OriginalMember(owner = "client!eo", name = "b", descriptor = "(I)V", line = 317)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(B)V", line = 334)
