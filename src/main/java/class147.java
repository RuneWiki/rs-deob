...
public class class147 extends class348 implements Runnable {
    ...
    @OriginalMember(owner = "client!qe", name = "c", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(Lok;)V", line = 68)
    public class147(class61 arg0) {
        this.field2273 = arg0;
    }

    @OriginalMember(owner = "client!qe", name = "d", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!qe", name = "run", descriptor = "()V", line = 52)
