...
public class class147 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(I[[[BIIIIIIIILqa;II)V", line = 11)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!nt", name = "b", descriptor = "(I)V", line = 123)
