...
public class class147 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IIILj;)V")
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(IIILj;)Z")
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IILj;I)V")
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "(Lgk;Leh;)V")
