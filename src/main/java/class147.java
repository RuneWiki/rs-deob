...
public class class147 {
    ...
    @OriginalMember(owner = "client!cu", name = "toString", descriptor = "()Ljava/lang/String;", line = 16)
    public final String toString() {
        field1863++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;)V", line = 31)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IIIIII)V", line = 62)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "(II)V", line = 175)
