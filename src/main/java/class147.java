...
public class class147 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(BZIII)Ldp;", line = 24)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(BII)I", line = 69)
