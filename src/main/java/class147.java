...
public abstract class class147 implements class390 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(FFIIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(FFIILaa;II)V", line = 14)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIII)V", line = 18)
    public final void method1101(int arg0, int arg1, int arg2, int arg3) {
        this.method1079(arg0, arg1, arg2, arg3, 1, 0, 1, 1);
    }

    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(II)V", line = 24)
    public final void method1102(int arg0, int arg1) {
        this.method1086(arg0, arg1, 1, 0, 1);
    }

    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(FFFFIILaa;II)V", line = 27)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(IIIIIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(FFFFFFIII)V", line = 59)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(FFII)V", line = 62)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(IIII)V", line = 66)
    public final void method1111(int arg0, int arg1, int arg2, int arg3) {
        this.method1095(arg0, arg1, arg2, arg3, 1, 0, 1);
    }

    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(FFFFFFLaa;II)V", line = 71)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(FFFFIIIII)V", line = 75)
