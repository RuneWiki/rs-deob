...
public class class147 extends class488 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!gb", name = "d", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 73)
