...
public class class147 extends class263 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!dj", name = "b", descriptor = "(IB)[[I", line = 59)
    ...
    @OriginalMember(owner = "client!dj", name = "<init>", descriptor = "()V", line = 135)
    public class147() {
        super(1, false);
    }

    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IZLgk;)V", line = 138)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IIIIBI)V", line = 184)
    ...
    @OriginalMember(owner = "client!dj", name = "b", descriptor = "(IIII)V", line = 293)
    ...
    @OriginalMember(owner = "client!dj", name = "d", descriptor = "(B)V", line = 404)
    ...
    @OriginalMember(owner = "client!dj", name = "e", descriptor = "(B)V", line = 513)
