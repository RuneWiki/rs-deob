...
public class class147 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Ldt;Lgo;)V", line = 4)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IF)I", line = 73)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "()V", line = 133)
    public static void method1035() {
        field1980 = null;
        field1984 = null;
    }

    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIF)F", line = 138)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(F)F", line = 149)
    private static final float method1037(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(IIF)F", line = 154)
