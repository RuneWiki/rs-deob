...
public class class147 extends class477 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IIB)I", line = 8)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 25)
    ...
    @OriginalMember(owner = "client!ec", name = "f", descriptor = "(I)Z", line = 36)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Ljava/io/File;Ljava/lang/String;B)V", line = 51)
    ...
    @OriginalMember(owner = "client!ec", name = "d", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(Lso;Ljava/lang/Object;I)V", line = 82)
