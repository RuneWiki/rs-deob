...
public class class147 implements Runnable {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lui;I)I", line = 15)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(I[BZI)V", line = 87)
    ...
    @OriginalMember(owner = "client!kc", name = "run", descriptor = "()V", line = 120)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(I)V", line = 189)
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(B)V", line = 229)
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(I)V", line = 266)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(III[B)V", line = 288)
    ...
    @OriginalMember(owner = "client!kc", name = "c", descriptor = "(I)Lja;", line = 338)
    ...
    @OriginalMember(owner = "client!kc", name = "c", descriptor = "(B)I", line = 353)
    ...
    @OriginalMember(owner = "client!kc", name = "d", descriptor = "(I)V", line = 369)
    ...
    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "(Ljava/net/Socket;Lng;)V", line = 467)
    ...
    @OriginalMember(owner = "client!kc", name = "d", descriptor = "(B)V", line = 387)
    ...
    @OriginalMember(owner = "client!kc", name = "finalize", descriptor = "()V", line = 405)
    protected final void finalize() {
        field2075++;
        this.method998((byte) -13);
    }

    @OriginalMember(owner = "client!kc", name = "e", descriptor = "(I)I", line = 417)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(III)Lmp;", line = 452)
