...
public abstract class class147 implements class245 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(IILjaclib/memory/Source;)Z", line = 12)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(ZLjaggl/MapBuffer;)Z", line = 53)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Ljaggl/MapBuffer;ZB)Ljaclib/memory/Buffer;", line = 87)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "([BB)Lmha;", line = 132)
    ...
    @OriginalMember(owner = "client!cg", name = "b", descriptor = "(I)V", line = 236)
    ...
    @OriginalMember(owner = "client!cg", name = "c", descriptor = "(B)I", line = 271)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(ZI)V", line = 282)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(IIZLjava/lang/String;)V", line = 311)
    ...
    @OriginalMember(owner = "client!cg", name = "d", descriptor = "(B)J", line = 438)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(B)V", line = 449)
    ...
    @OriginalMember(owner = "client!cg", name = "finalize", descriptor = "()V", line = 470)
    ...
    @OriginalMember(owner = "client!cg", name = "e", descriptor = "(B)V", line = 482)
    ...
    @OriginalMember(owner = "client!cg", name = "c", descriptor = "(I)V", line = 510)
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "(Log;IZ)V", line = 550)
    ...
    @OriginalMember(owner = "client!cg", name = "d", descriptor = "(I)V", line = 529)
