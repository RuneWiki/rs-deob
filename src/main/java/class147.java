...
public class class147 extends class37 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Ldm;)V", line = 6)
    public final synchronized void method939(class37 arg0) {
        this.field2086.method3069(arg0, 2);
    }

    @OriginalMember(owner = "client!nt", name = "c", descriptor = "([III)V", line = 11)
    ...
    @OriginalMember(owner = "client!nt", name = "e", descriptor = "()I", line = 22)
    public final synchronized int method941() {
        return this.field2086.method3064((byte) 124);
    }

    @OriginalMember(owner = "client!nt", name = "b", descriptor = "(Ldm;)V", line = 25)
    public final synchronized void method942(class37 arg0) {
        arg0.method2946(-128);
    }

    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!nt", name = "c", descriptor = "()Ldm;", line = 79)
    public final class37 method242() {
        return (class37) this.field2086.method3072((byte) 30);
    }

    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Lki;Lfu;)V", line = 85)
    ...
    @OriginalMember(owner = "client!nt", name = "d", descriptor = "()Ldm;", line = 92)
    public final class37 method244() {
        return (class37) this.field2086.method3066(2);
    }

    @OriginalMember(owner = "client!nt", name = "d", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Lfu;)V", line = 108)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "()I", line = 121)
    public final int method238() {
        return 0;
    }

    @OriginalMember(owner = "client!nt", name = "a", descriptor = "([III)V", line = 129)
    ...
    @OriginalMember(owner = "client!nt", name = "f", descriptor = "()V", line = 173)
