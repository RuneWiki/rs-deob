...
public abstract class class147 implements class225 {
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(IZLjaggl/MapBuffer;)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(Ljaggl/MapBuffer;I)Z")
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(Lft;I)[Lwl;")
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(ZILjaclib/memory/Source;)Z")
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(BLmw;)Lfv;")
    ...
    @OriginalMember(owner = "client!tba", name = "<init>", descriptor = "(Lhp;IZ)V")
