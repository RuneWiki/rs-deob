...
public class class147 extends class3 {
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(I)Law;")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Loi;I)V")
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Lih;I)V")
    public class147(class503 arg0, int arg1) {
        this.field1961 = arg0;
        this.field1962 = new class55(arg0, 6408, arg1);
    }

    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Law;Law;FI)Z")
