...
public class class147 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Z)Z", line = 3)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IIIIIBI)V", line = 46)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IIIIZZIFI)[[I", line = 74)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(B)V", line = 107)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Ljava/lang/String;BIII[B)I", line = 124)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(ILjava/lang/String;B)V", line = 273)
    ...
    @OriginalMember(owner = "client!pt", name = "b", descriptor = "(B)V", line = 293)
