...
public class class147 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(I)Lwb;", line = 9)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!nr", name = "c", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!nr", name = "d", descriptor = "(I)I", line = 71)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(BLwb;)V", line = 98)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "([II[ILqi;[I)V", line = 115)
    ...
    @OriginalMember(owner = "client!nr", name = "e", descriptor = "(I)Lwb;", line = 211)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "()V", line = 243)
    public class147() {
