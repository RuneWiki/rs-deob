...
public class class147 extends class610 {
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(I)J", line = 3)
    public final long method839(int arg0) {
        int var2 = 11 / ((44 - arg0) / 37);
        return this.field1880;
    }

    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(B)J", line = 30)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IJ)I", line = 47)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Z)J", line = 94)
