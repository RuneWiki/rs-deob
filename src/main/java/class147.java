...
public class class147 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IBLha;)V")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Loa;ZBILoa;)I")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILha;)V")
