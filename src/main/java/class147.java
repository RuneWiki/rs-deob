...
public class class147 extends class346 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(BI)Lks;", line = 8)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(I[B)Lqg;", line = 32)
    ...
    @OriginalMember(owner = "client!wq", name = "d", descriptor = "(B)V", line = 112)
    ...
    @OriginalMember(owner = "client!wq", name = "e", descriptor = "(B)V", line = 125)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Lfb;ZI)V", line = 135)
    ...
    @OriginalMember(owner = "client!wq", name = "d", descriptor = "(II)V", line = 152)
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "()V", line = 193)
    public class147() {
        super(1, true);
    }

    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(II)[I", line = 196)
