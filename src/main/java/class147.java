...
public abstract class class147 extends class291 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(B[BI)I", line = 4)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(BI)V", line = 18)
    ...
    @OriginalMember(owner = "client!hm", name = "j", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!hm", name = "h", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Lya;IZLij;III)V", line = 84)
    ...
    @OriginalMember(owner = "client!hm", name = "<init>", descriptor = "(IIIIIII)V", line = 94)
    ...
    @OriginalMember(owner = "client!hm", name = "f", descriptor = "(I)Z", line = 109)
