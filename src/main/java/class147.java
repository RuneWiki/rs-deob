...
public class class147 extends class411 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IIBZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(III)Z", line = 16)
    ...
    @OriginalMember(owner = "client!ct", name = "c", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IIIZ)V", line = 39)
    ...
    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "(Lni;Lni;Luu;)V", line = 51)
