...
public class class147 extends class233 {
    ...
    @OriginalMember(owner = "client!qe", name = "b", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Z)V", line = 68)
    public final void method827(boolean arg0) {
        this.field3283.method2109(260, 8448);
    }

    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Ldg;)V", line = 72)
    public final void method825(class223 arg0) {
    }

    @OriginalMember(owner = "client!qe", name = "a", descriptor = "()V", line = 75)
    ...
    @OriginalMember(owner = "client!qe", name = "c", descriptor = "()V", line = 94)
    ...
    @OriginalMember(owner = "client!qe", name = "b", descriptor = "()Z", line = 131)
    public final boolean method830() {
        return true;
    }

    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(Lih;Lrj;)V", line = 138)
