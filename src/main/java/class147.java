...
public class class147 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Lza;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(ILza;IIIZLe;I)V", line = 27)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IIBIIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(I)Z", line = 255)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Lha;ZZI)V", line = 267)
    ...
    @OriginalMember(owner = "client!dj", name = "<init>", descriptor = "(Lza;Lpm;IIIIIIZI)V", line = 826)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IB)V", line = 335)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(ZIZLza;IIZ)Le;", line = 347)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Z)I", line = 475)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(B)V", line = 494)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IILjava/lang/String;Lpg;)Lud;", line = 515)
    ...
    @OriginalMember(owner = "client!dj", name = "finalize", descriptor = "()V", line = 544)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IBI)V", line = 554)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(II)V", line = 656)
    ...
    @OriginalMember(owner = "client!dj", name = "b", descriptor = "(II)V", line = 786)
    ...
    @OriginalMember(owner = "client!dj", name = "b", descriptor = "(Lza;I)V", line = 805)
