...
public class class147 extends class71 {
    ...
    @OriginalMember(owner = "client!ph", name = "r", descriptor = "Lph;")
    public class147 field2829;

    @OriginalMember(owner = "client!ph", name = "B", descriptor = "Lph;")
    public class147 field2839;

    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ILvg;)V")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Leb;IIIIII)V")
