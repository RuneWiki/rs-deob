...
public class class147 extends class272 {
    ...
    @OriginalMember(owner = "client!ep", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ep", name = "g", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(IIIII[Lbi;IIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(IZI)I", line = 1081)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ZI)[[I", line = 1103)
