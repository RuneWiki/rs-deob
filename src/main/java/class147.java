...
public class class147 {
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ZII)V", line = 25)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(IIII)Z", line = 52)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(BZZLg;)V", line = 236)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Lti;Z)Z", line = 298)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(B)V", line = 387)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(I[BIB)Z", line = 405)
    ...
    @OriginalMember(owner = "client!ep", name = "<init>", descriptor = "(I)V", line = 499)
