...
public abstract class class147 extends class626 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V")
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(IILaa;ILdm;IIIJ)V")
    ...
    @OriginalMember(owner = "client!mg", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
