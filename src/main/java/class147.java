...
public class class147 extends class397 implements class52 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;Lj;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!v", name = "c", descriptor = "()[Lkw;", line = 24)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IIII)V", line = 31)
    public final void method442(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!v", name = "f", descriptor = "()[Lcea;", line = 37)
    public final class94[] method486() {
        return this.field2499;
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;Lj;I)V", line = 40)
    ...
    @OriginalMember(owner = "client!v", name = "e", descriptor = "()Z", line = 62)
    public final boolean method485() {
        return true;
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(BIZ)Lda;", line = 80)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;)V", line = 88)
    ...
    @OriginalMember(owner = "client!v", name = "b", descriptor = "()V", line = 144)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;IZ)V", line = 158)
    public final void method456(class152 arg0, int arg1, boolean arg2) {
        this.method1126(((class361) arg0).nativeid, arg1, arg2);
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(I[IIIIIZ)V", line = 164)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lda;IIIZ)V", line = 167)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IILq;Z)Z", line = 170)
    ...
    @OriginalMember(owner = "client!v", name = "d", descriptor = "()V", line = 173)
    public final void method444() {
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "()V", line = 176)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IILq;ZI)Z", line = 194)
    public final boolean method482(int arg0, int arg1, class152 arg2, boolean arg3, int arg4) {
        return this.field2498.method1654().method3725(this, arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "([ILq;)V", line = 197)
    private final void method1127(int[] arg0, class152 arg1) {
        this.field2498.method1654().method3723(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(Ll;Lm;Lcr;IIII)V", line = 201)
