...
public abstract class class147 extends class198 {
    ...
    @OriginalMember(owner = "client!jl", name = "d", descriptor = "(I)Z", line = 8)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IIIIZI)V", line = 19)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(I)[Lj;", line = 197)
    ...
    @OriginalMember(owner = "client!jl", name = "c", descriptor = "(B)V", line = 279)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lvq;ZLkm;IIBI)V", line = 291)
