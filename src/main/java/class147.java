...
public class class147 extends class255 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IILjava/awt/Canvas;I)V", line = 10)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IIIILjava/awt/Graphics;III)V", line = 31)
