...
public class class147 extends class390 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Laa;J[Lpd;[Lhp;Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!jl", name = "b", descriptor = "()V", line = 15)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IIIII)V", line = 37)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Laa;J)Z", line = 51)
    ...
    @OriginalMember(owner = "client!jl", name = "c", descriptor = "()V", line = 99)
    public static void method1009() {
        field2129 = null;
        field2128 = null;
    }

    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(I)V", line = 332)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "([Lhp;Z)V", line = 112)
    ...
    @OriginalMember(owner = "client!jl", name = "d", descriptor = "()V", line = 197)
    ...
    @OriginalMember(owner = "client!jl", name = "e", descriptor = "()V", line = 209)
    public final void method1012() {
        this.field2141 = true;
    }

    @OriginalMember(owner = "client!jl", name = "f", descriptor = "()V", line = 218)
    private final void method1013() {
        this.field2133 = false;
    }

    @OriginalMember(owner = "client!jl", name = "g", descriptor = "()Lqd;", line = 221)
    public final class260 method1014() {
        return this.field2143;
    }

    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(J)V", line = 225)
    public final void method1015(long arg0) {
        this.field2135 = arg0;
    }

    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Laa;[Lpd;Z)V", line = 241)
