...
public class class147 extends class129 {
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "(Lsq;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lub;II)V")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Las;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!kg", name = "c", descriptor = "(Las;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(Las;IIIIZ)V")
