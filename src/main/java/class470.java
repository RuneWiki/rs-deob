...
public class class470 {
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lfl;", line = 18)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(II)I", line = 58)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(Z)V", line = 73)
