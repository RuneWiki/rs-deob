...
public class class470 extends class303 {
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(II)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!qi", name = "h", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(BC)C", line = 72)
