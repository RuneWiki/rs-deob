...
public class class470 extends class34 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IB)[I", line = 4)
    ...
    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "()V", line = 57)
    public class470() {
        super(1, false);
    }

    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(BI)[[I", line = 62)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Lsv;II)V", line = 135)
