...
public class class470 extends class539 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(ZII[IIIIZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!rq", name = "d", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IZII)V", line = 66)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Lpq;IIIIZ[IIIZ)V", line = 79)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Lpq;IIII)V", line = 136)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Lpq;IIIII)V", line = 155)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Lpq;IIIIZ[BIZ)V", line = 236)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Lpq;IIIIZ[FI)V", line = 363)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(ZIZ)V", line = 169)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(I)V", line = 188)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 198)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IIIIIII)V", line = 288)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(ZI[BIIIIIII)V", line = 303)
