...
public class class470 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(I)Z", line = 35)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;I)V", line = 46)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IB)I", line = 59)
    ...
    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 67)
