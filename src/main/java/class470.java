...
public class class470 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(II)Lnk;")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IIILle;IIIIIIII)Z")
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Lap;I)V")
