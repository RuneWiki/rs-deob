...
public class class470 extends class667 {
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "()V", line = 98)
    public class470() {
        super(0, true);
    }

    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(ZII)Z", line = 10)
    ...
    @OriginalMember(owner = "client!nm", name = "c", descriptor = "(III)Z", line = 30)
    ...
    @OriginalMember(owner = "client!nm", name = "b", descriptor = "(Z)V", line = 51)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IIILjava/lang/Class;)Lbba;", line = 64)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(BI)[I", line = 101)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(ILdm;Ldm;)V", line = 153)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lud;II)V", line = 173)
