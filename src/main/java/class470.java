...
public abstract class class470 extends class431 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Z)I", line = 3)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(B)I", line = 15)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(I)F", line = 27)
    ...
    @OriginalMember(owner = "client!qp", name = "g", descriptor = "(I)I", line = 41)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(B)I", line = 54)
    ...
    @OriginalMember(owner = "client!qp", name = "h", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!qp", name = "c", descriptor = "(B)I", line = 94)
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(IIIIIF)V", line = 109)
