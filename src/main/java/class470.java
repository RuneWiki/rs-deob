...
public class class470 {
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(BLuv;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(III)I", line = 51)
