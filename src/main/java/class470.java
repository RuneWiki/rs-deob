...
public class class470 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Z)I", line = 6)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ILjava/lang/String;B)I", line = 98)
    ...
    @OriginalMember(owner = "client!fh", name = "toString", descriptor = "()Ljava/lang/String;", line = 109)
    public final String toString() {
        field6814++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(IJ)V", line = 119)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(I)I", line = 142)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(B)V", line = 153)
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 162)
    public class470(String arg0, int arg1) {
        this.field6820 = arg1;
    }

    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(B)[Lft;", line = 172)
