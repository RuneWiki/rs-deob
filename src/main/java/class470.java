...
public abstract class class470 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILws;II[ZLms;Z[IZILws;I)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(BILnt;)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ZBIIILnt;Lnt;ILnt;IIILnt;I[Z)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIILnt;I[IIZLnt;II)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ZIIIILnt;Lnt;II)V")
