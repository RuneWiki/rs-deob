...
public class class470 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(BLga;)Ljava/lang/String;", line = 53)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(I[[[Lsn;IIZI)Z", line = 78)
