...
public class class470 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(BLjava/applet/Applet;Ljava/lang/String;)Ljava/lang/Object;", line = 3)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Ljava/lang/String;ILjava/applet/Applet;)V", line = 12)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "([Ljava/lang/Object;Ljava/lang/String;ZLjava/applet/Applet;)Ljava/lang/Object;", line = 24)
