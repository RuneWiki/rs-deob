...
public class class470 extends class481 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(I)[B", line = 4)
    ...
    @OriginalMember(owner = "client!ve", name = "c", descriptor = "(I)I", line = 61)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(II[BIIIII[B)V", line = 80)
    ...
    @OriginalMember(owner = "client!ve", name = "c", descriptor = "(B)V", line = 124)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(BI)I", line = 139)
