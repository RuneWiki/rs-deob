...
public class class470 extends class162 implements class276 {
    ...
    @OriginalMember(owner = "client!h", name = "b", descriptor = "(IIIIII)Lpv;")
    public final class50 method521(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lgv;[Lmp;Z)Loa;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "([Lc;Lqb;Lia;[Lnh;I)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "([Lc;Lia;[Lnh;I)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lpv;Lpv;FLpv;)Lpv;")
    public final class50 method464(class50 arg0, class50 arg1, float arg2, class50 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lmp;Z)Lf;")
    ...
    @OriginalMember(owner = "client!h", name = "n", descriptor = "()Lia;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lwk;IIII)Lc;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lqb;)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lqb;Z)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIIIIF)Lpe;")
    ...
    @OriginalMember(owner = "client!h", name = "b", descriptor = "(I)Ll;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lpv;)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(I[Lpe;)V")
    ...
    @OriginalMember(owner = "client!h", name = "<init>", descriptor = "(ILjava/awt/Canvas;Lm;Lkj;)V")
