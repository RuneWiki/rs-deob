...
public class class470 extends class361 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(IIIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "(Lsu;)V", line = 118)
