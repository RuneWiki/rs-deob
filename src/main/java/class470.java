...
public class class470 extends class534 {
    ...
    @OriginalMember(owner = "client!ai", name = "E", descriptor = "()I", line = 3)
    public final int method315() {
        field6734++;
        return this.field6728;
    }

    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IIII[III)V", line = 12)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(FFFFFFILua;II)V", line = 21)
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Lmj;IIZ)V", line = 610)
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Lmj;II[III)V", line = 625)
    ...
    @OriginalMember(owner = "client!ai", name = "ca", descriptor = "()I", line = 81)
    public final int method304() {
        field6729++;
        return this.field6736 + this.field6716 + this.field6713;
    }

    @OriginalMember(owner = "client!ai", name = "A", descriptor = "()I", line = 101)
    public final int method312() {
        field6740++;
        return this.field6728 + this.field6714 + this.field6742;
    }

    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IILua;II)V", line = 109)
    ...
    @OriginalMember(owner = "client!ai", name = "V", descriptor = "(IIIII)V", line = 157)
    ...
    @OriginalMember(owner = "client!ai", name = "YA", descriptor = "(IIIIIIII)V", line = 187)
    ...
    @OriginalMember(owner = "client!ai", name = "qa", descriptor = "(FFFFFFIIII)V", line = 224)
    ...
    @OriginalMember(owner = "client!ai", name = "Q", descriptor = "(IIII)V", line = 291)
    ...
    @OriginalMember(owner = "client!ai", name = "u", descriptor = "()I", line = 309)
    public final int method306() {
        field6726++;
        return this.field6716;
    }

    @OriginalMember(owner = "client!ai", name = "xa", descriptor = "(III)V", line = 317)
    public final void method488(int arg0, int arg1, int arg2) {
        field6732++;
    }

    @OriginalMember(owner = "client!ai", name = "DA", descriptor = "(IIIIIII)V", line = 327)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(I)V", line = 539)
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(II)Z", line = 562)
    ...
    @OriginalMember(owner = "client!ai", name = "da", descriptor = "(IIIIII)V", line = 580)
