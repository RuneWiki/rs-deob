...
public class class470 {
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "()V", line = 3)
    public void method2037() throws Exception {
        field6361++;
    }

    @OriginalMember(owner = "client!lv", name = "b", descriptor = "()I", line = 11)
    public int method2038() throws Exception {
        field6367++;
        return this.field6365;
    }

    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(BI)V", line = 21)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(Lri;II)V", line = 60)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 82)
    public void method2040(Component arg0) throws Exception {
        field6352++;
    }

    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(ILri;)V", line = 92)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "([II)V", line = 117)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(III)Z", line = 275)
    ...
    @OriginalMember(owner = "client!lv", name = "c", descriptor = "()V", line = 288)
    public void method2039() throws Exception {
        field6349++;
    }

    @OriginalMember(owner = "client!lv", name = "b", descriptor = "(B)V", line = 301)
    ...
    @OriginalMember(owner = "client!lv", name = "c", descriptor = "(B)V", line = 345)
    ...
    @OriginalMember(owner = "client!lv", name = "b", descriptor = "(I)V", line = 463)
    public void method2036(int arg0) throws Exception {
        field6350++;
    }

    @OriginalMember(owner = "client!lv", name = "d", descriptor = "()V", line = 478)
