...
public class class470 extends class618 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IIILd;Lha;II)V", line = 59)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(ZIIJLha;)V", line = 140)
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(Lha;Lsba;Lnia;J)V", line = 859)
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(I)V", line = 408)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(ILha;J)V", line = 802)
