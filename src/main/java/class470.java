...
public class class470 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Z[I[IIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IILjf;Z)V", line = 34)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IILoba;B)V", line = 50)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IIB)V", line = 72)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(ZI)V", line = 85)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Ljf;ILvha;Lha;Leia;IILoba;ILmk;BLru;)Lka;", line = 103)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Ljf;IIILmk;I[Lhj;Lvha;ILhga;Lmk;IILru;[IILoba;Leia;Lha;IZ)Lka;", line = 300)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(I)V", line = 853)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Z)V", line = 866)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lha;IILru;Ljf;BLmk;IIIII)Lka;", line = 903)
