...
public class class470 extends class296 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(ILjava/awt/Graphics;IIBI)V", line = 9)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 26)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Ljava/awt/Graphics;III)V", line = 48)
