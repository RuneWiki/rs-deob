...
public class class470 extends class357 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Z)V", line = 75)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IIZ)Z", line = 95)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "([FIFIIIIZFFF)V", line = 112)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "([BIIIIIB)V", line = 203)
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(I)V", line = 303)
