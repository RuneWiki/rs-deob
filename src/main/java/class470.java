...
public class class470 extends class54 {
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(Z)I", line = 6)
    ...
    @OriginalMember(owner = "client!pr", name = "d", descriptor = "(I)Z", line = 17)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(II)V", line = 41)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IIIIIIIB)V", line = 53)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(IB)I", line = 98)
    ...
    @OriginalMember(owner = "client!pr", name = "c", descriptor = "(II)V", line = 114)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IIIIILha;IB)V", line = 127)
    ...
    @OriginalMember(owner = "client!pr", name = "c", descriptor = "(Z)I", line = 150)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(ILjava/awt/Canvas;ILd;)Lha;", line = 165)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Z)V", line = 176)
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(ILhia;)V", line = 194)
    public class470(int arg0, class73 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(Lhia;)V", line = 205)
