...
public class class470 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(II)I", line = 8)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(III)Z", line = 44)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(BLk;)Lsw;", line = 56)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(ILpca;Ljava/lang/String;BILla;IILufa;ILua;I)V", line = 67)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(B)V", line = 122)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Lmq;B)Z", line = 146)
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(B)V", line = 172)
