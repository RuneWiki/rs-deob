...
public class class470 extends class287 {
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(BLvj;)V", line = 3)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(IILjava/lang/String;)Z", line = 36)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(BLvj;I)V", line = 93)
