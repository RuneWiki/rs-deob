...
public class class470 extends class214 {
    ...
    @OriginalMember(owner = "client!sp", name = "<init>", descriptor = "()V", line = 4)
    public class470() {
        super(0, true);
    }

    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IIIII[[ILjava/util/Random;)V", line = 10)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IIIIIII)V", line = 215)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(ILofa;I)V", line = 248)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IB)[I", line = 358)
    ...
    @OriginalMember(owner = "client!sp", name = "c", descriptor = "(I)V", line = 626)
