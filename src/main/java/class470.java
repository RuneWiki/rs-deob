...
public class class470 extends class544 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(ILjava/lang/String;BLjava/lang/String;)V", line = 29)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lkj;B)V", line = 43)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(I)V", line = 290)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Z[B)Lpj;", line = 311)
