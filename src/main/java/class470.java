...
public class class470 extends class327 implements class137 {
    ...
    @OriginalMember(owner = "client!j", name = "d", descriptor = "()[Lgl;")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lq;Lsda;I)V")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "()[Lfca;")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lq;Lsda;II)V")
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Lda;La;Lor;IIII)V")
