...
public class class470 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IBLug;)V")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lug;Z)V")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lza;IIZ)Lo;")
