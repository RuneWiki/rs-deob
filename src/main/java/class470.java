...
public class class470 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "([BI)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(II)Lbaa;")
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(Ler;ILjn;Ljn;)V")
