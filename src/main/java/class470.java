...
public class class470 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(II[IBI)V", line = 230)
    ...
    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "(Leq;III)V", line = 259)
