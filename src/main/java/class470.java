...
public class class470 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IIII)I", line = 5)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(I[BLdga;I)Lnh;", line = 38)
    ...
    @OriginalMember(owner = "client!vs", name = "c", descriptor = "(I)Lvk;", line = 65)
    ...
    @OriginalMember(owner = "client!vs", name = "e", descriptor = "(I)Lvk;", line = 91)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(B)V", line = 112)
    ...
    @OriginalMember(owner = "client!vs", name = "b", descriptor = "(Z)Z", line = 136)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(ZB)V", line = 149)
    ...
    @OriginalMember(owner = "client!vs", name = "d", descriptor = "(I)Lvk;", line = 216)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Z)Lvk;", line = 237)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Lvk;I)V", line = 265)
    ...
    @OriginalMember(owner = "client!vs", name = "b", descriptor = "(I)I", line = 284)
    ...
    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "()V", line = 307)
    public class470() {
        try {
