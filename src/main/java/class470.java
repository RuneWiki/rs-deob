...
public abstract class class470 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "([IIIZIIII[II)V", line = 21)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ZIILwc;ILwc;III)V", line = 117)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIBILs;IIII)V", line = 159)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(III)Z", line = 281)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lnfa;IIII[IBLfda;ZLnfa;[ZZ)V", line = 298)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IZ)I", line = 510)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ZIBILwc;IIIILwc;[I)V", line = 580)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IILwc;)V", line = 630)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IZLwc;ILwc;ILwc;ILwc;III[ZII)V", line = 677)
