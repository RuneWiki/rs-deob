...
public class class470 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Li;III[Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IB)Lan;", line = 70)
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(Lpt;ILum;)V", line = 115)
