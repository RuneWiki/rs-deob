...
public class class470 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(BLfd;I)V")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ILfd;)V")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Liaa;[[BB)V")
