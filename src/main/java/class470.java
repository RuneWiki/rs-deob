...
public abstract class class470 {
    ...
    @OriginalMember(owner = "client!ua", name = "b", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IIILsm;)V", line = 24)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Ldh;IB)Ljava/lang/String;", line = 115)
