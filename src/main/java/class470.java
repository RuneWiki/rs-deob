...
public class class470 extends class751 {
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "()V", line = 3)
    public class470() {
        super(1, false);
    }

    @OriginalMember(owner = "client!qd", name = "c", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!qd", name = "e", descriptor = "(B)V", line = 900)
    ...
    @OriginalMember(owner = "client!qd", name = "f", descriptor = "(B)V", line = 911)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ILrv;I)V", line = 921)
    ...
    @OriginalMember(owner = "client!qd", name = "b", descriptor = "(II)I", line = 1012)
    public static int method2786(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(IB)[[I", line = 1019)
