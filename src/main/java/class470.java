...
public class class470 extends class533 {
    ...
    @OriginalMember(owner = "client!bca", name = "c", descriptor = "(I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!bca", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 15)
    public class470(Object arg0, int arg1) {
        super(arg1);
        this.field6684 = new SoftReference(arg0);
    }

    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 24)
