...
public class class203 implements class243 {
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(II)Lkea;", line = 3)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(I)I", line = 29)
    ...
    @OriginalMember(owner = "client!bea", name = "<init>", descriptor = "(Ljn;Ljava/lang/String;)V", line = 47)
    public class203(class668 arg0, String arg1) {
        this.field2444 = arg1;
        this.field2445 = arg0;
    }

    @OriginalMember(owner = "client!bea", name = "b", descriptor = "(I)Luv;", line = 57)
