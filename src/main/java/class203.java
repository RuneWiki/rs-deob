...
public class class203 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;I)V", line = 29)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(I)V", line = 74)
