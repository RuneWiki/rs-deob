...
public class class203 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(Lsk;)V")
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(Lsk;Z)V")
    ...
    @OriginalMember(owner = "client!q", name = "b", descriptor = "(Lsk;)Z")
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "(Lnf;)V")
