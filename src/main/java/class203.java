...
public class class203 extends class37 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(BLpba;Loo;II)V")
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(ILwp;II)V")
    ...
    @OriginalMember(owner = "client!hm", name = "E", descriptor = "(Lha;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!hm", name = "<init>", descriptor = "(Lrr;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!hm", name = "DA", descriptor = "(Lha;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!hm", name = "d", descriptor = "(III)Lim;")
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Lcp;[I)V")
    ...
    @OriginalMember(owner = "client!hm", name = "v", descriptor = "(IILha;)Lha;")
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Lha;IIIIZ)Z")
