...
public class class203 extends class11 {
    ...
    @OriginalMember(owner = "client!wt", name = "d", descriptor = "(II)[I", line = 5)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(ILta;)V", line = 214)
    public static final void method1261(int arg0, class142 arg1) {
        class211.field2950[arg0] = arg1;
    }

    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Lsi;II)V", line = 218)
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(Z)V", line = 297)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Lla;ZLjava/lang/String;I)V", line = 310)
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "()V", line = 393)
    public class203() {
        super(0, true);
    }

    @OriginalMember(owner = "client!wt", name = "c", descriptor = "(B)V", line = 346)
