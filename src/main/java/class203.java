...
public class class203 extends class85 implements class51 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IIIIII[II)V", line = 4)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(Z)Ljagdx/IDirect3DBaseTexture;", line = 44)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IIBII[II)V", line = 54)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(I)I", line = 94)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "(Lrd;Lkea;IIZ[BII)V", line = 103)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "(Lrd;IIZ[III)V", line = 163)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(ZBZ)V", line = 219)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(BF)F", line = 230)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(BLtb;)V", line = 240)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "(Lrd;Lkea;Lkf;II)V", line = 249)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Z)I", line = 269)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(B)Z", line = 280)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(I)V", line = 290)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "([BILkea;IIIIII)V", line = 300)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IF)F", line = 342)
