...
public abstract class class203 {
    ...
    @OriginalMember(owner = "client!rr", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(ILg;)Ljava/lang/String;", line = 22)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(Z)Luq;", line = 37)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(ZLoo;Z)V", line = 71)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(I[[[BIBII)V", line = 372)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(BLnq;)V", line = 514)
