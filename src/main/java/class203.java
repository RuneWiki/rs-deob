...
public class class203 {
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Leq;IIZ)Lqg;")
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(ILae;I)V")
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(ILae;)V")
    ...
    @OriginalMember(owner = "client!fp", name = "b", descriptor = "(ILae;)Ln;")
