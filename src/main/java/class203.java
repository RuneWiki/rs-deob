...
public class class203 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(II)Lqg;", line = 3)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 98)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(ZLmq;B)V", line = 110)
    ...
    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "(IIIIIIIIIIIIII)V", line = 278)
