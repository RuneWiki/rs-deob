...
public class class203 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(II)Luo;")
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Lsk;Z)V")
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "(Lgp;ILui;Lui;)V")
