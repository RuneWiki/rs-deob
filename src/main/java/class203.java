...
public class class203 extends class409 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "([B[IIIIIIIIIIILua;II)V")
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(CIIIZLua;II)V")
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "([B[I[IIIIIIIIIIILua;II)V")
    ...
    @OriginalMember(owner = "client!mi", name = "<init>", descriptor = "(Lrfa;Laga;[Ltq;[I[I)V")
