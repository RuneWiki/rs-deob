...
public class class203 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!po", name = "c", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IZZ)V", line = 122)
