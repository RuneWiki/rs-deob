...
public class class203 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lvl;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(II)I", line = 74)
    public static final int method1315(int arg0, int arg1) {
        return class223.field2984 == null ? 0 : class223.field2984[arg0][arg1] & 0xFF;
    }

    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 78)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ZZ)V", line = 182)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(B)V", line = 195)
