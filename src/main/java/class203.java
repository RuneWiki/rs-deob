...
public class class203 implements class33 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Lrn;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(IILjava/net/Socket;)Llba;")
    ...
    @OriginalMember(owner = "client!fe", name = "<init>", descriptor = "(Leba;)V")
