...
public class class203 implements class637 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(I[[BLms;)V")
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(Lee;Lhaa;IIIIIII)V")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(I)Lhda;")
