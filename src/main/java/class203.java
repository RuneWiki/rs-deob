...
public class class203 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(II)Lum;", line = 58)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(BLjg;)V", line = 101)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Lfn;ILe;IIIII)V", line = 123)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(B)V", line = 206)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Z)Lbr;", line = 223)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ILjg;I)V", line = 265)
