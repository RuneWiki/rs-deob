...
public class class203 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(BI)I", line = 67)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(B)Z", line = 168)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lbt;IB)V", line = 195)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lbt;B)V", line = 226)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(III)Ljava/lang/String;", line = 249)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IILjava/awt/Component;Lhs;I)Lfr;", line = 292)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ILqa;IIZLoa;I)V", line = 376)
