...
public abstract class class203 extends class745 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(I[Lmfa;)I", line = 5)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ILjava/awt/Canvas;Lgga;BLd;)Lha;", line = 19)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(II)I", line = 47)
    public static final int method1426(int arg0, int arg1) {
        return class97.field1386 != null ? class97.field1386[arg0][arg1] & 255 : 0;
    }

    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IILuf;IIJLaa;II)V", line = 50)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(BLha;)Z", line = 104)
    ...
    @OriginalMember(owner = "client!ne", name = "g", descriptor = "(B)Z", line = 116)
    ...
    @OriginalMember(owner = "client!ne", name = "i", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!ne", name = "j", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!ne", name = "d", descriptor = "(Z)V", line = 166)
    ...
    @OriginalMember(owner = "client!ne", name = "k", descriptor = "(I)V", line = 216)
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(IIIIII)V", line = 263)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IIIZ)I", line = 277)
