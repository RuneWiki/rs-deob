...
public class class203 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(II)I", line = 143)
    ...
    @OriginalMember(owner = "client!fq", name = "b", descriptor = "()I", line = 152)
    ...
    @OriginalMember(owner = "client!fq", name = "c", descriptor = "()[F", line = 161)
    public final float[] method1415() {
        return this.field2928[this.method1414()];
    }

    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "()V", line = 165)
    public class203() {
