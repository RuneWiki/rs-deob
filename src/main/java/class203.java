...
public class class203 {
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(IIIB)V", line = 32)
