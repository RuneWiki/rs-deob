...
public class class203 extends class535 {
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(I[FIIIFFFFII)V", line = 5)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "(I)V", line = 136)
