...
public class class203 extends class694 {
    ...
    @OriginalMember(owner = "client!bea", name = "<init>", descriptor = "()V", line = 15)
    public class203() {
        super(0, true);
    }

    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(IIII)I", line = 24)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(IIIIIII)I", line = 55)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(II)[I", line = 132)
    ...
    @OriginalMember(owner = "client!bea", name = "g", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(B)V", line = 196)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(ILjr;B)V", line = 236)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(II[I)V", line = 335)
