...
public abstract class class203 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ILir;)V", line = 8)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(BLfb;)V", line = 24)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(II)V", line = 75)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ZILir;Lir;)V", line = 128)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 152)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(B)V", line = 214)
