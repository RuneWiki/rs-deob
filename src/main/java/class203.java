...
public class class203 extends class56 {
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(ZI)V", line = 8)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(B)Z", line = 58)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(III)V", line = 70)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!cu", name = "c", descriptor = "(I)V", line = 135)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IILkv;)V", line = 146)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(ZI)V", line = 160)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IB)I", line = 174)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(B)V", line = 191)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "(Lbv;Lre;)V", line = 223)
