...
public class class203 extends class362 implements MouseWheelListener {
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Ljava/awt/Component;I)V")
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Ljava/awt/Component;Z)V")
    ...
    @OriginalMember(owner = "client!bs", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V")
