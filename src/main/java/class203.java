...
public class class203 extends class246 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(B)Z", line = 12)
    ...
    @OriginalMember(owner = "client!lr", name = "c", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ZI)V", line = 35)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILfg;I)V", line = 46)
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(BII)V", line = 93)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ZB)V", line = 168)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Lpg;Lrk;)V", line = 217)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I)V", line = 264)
