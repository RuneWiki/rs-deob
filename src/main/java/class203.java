...
public class class203 extends class413 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Lae;I)V")
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(BLqr;)V")
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ILae;)V")
