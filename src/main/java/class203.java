...
public class class203 extends class42 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(ZILcr;IB)V")
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IILhq;)Z")
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(Ltk;)V")
