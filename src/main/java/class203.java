...
public class class203 {
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(IIIIIIZIB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "([Ljava/lang/Object;I[J)V", line = 35)
    public static final void method1374(Object[] arg0, int arg1, long[] arg2) {
        field2714++;
        class183.method1241(arg0, arg2.length - 1, arg1, true, arg2);
    }

    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(BC)Z", line = 55)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(B)V", line = 66)
