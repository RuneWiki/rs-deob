...
public class class203 {
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(ZII)Ljava/lang/String;", line = 7)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(IILya;I)V", line = 22)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(ZI)V", line = 494)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(B)V", line = 595)
