...
public class class203 implements class338 {
    ...
    @OriginalMember(owner = "client!nt", name = "b", descriptor = "(I)Z", line = 3)
    public final boolean method152(int arg0) {
        field2490++;
        return arg0 == -18257 ? true : true;
    }

    @OriginalMember(owner = "client!nt", name = "c", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(II)I", line = 26)
    public static int method1246(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!nt", name = "<init>", descriptor = "(Llr;)V", line = 44)
    public class203(class684 arg0) {
        this.field2489 = arg0;
    }

    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(ZI)V", line = 52)
