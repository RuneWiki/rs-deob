...
public class class203 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(III)Z", line = 31)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(III)Z", line = 43)
