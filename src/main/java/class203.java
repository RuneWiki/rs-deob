...
public class class203 extends class512 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IB)[I", line = 8)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(ZILia;)V", line = 42)
    ...
    @OriginalMember(owner = "client!dh", name = "c", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!dh", name = "b", descriptor = "(II)[[I", line = 73)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(BLqs;I)Lhi;", line = 126)
