...
public class class203 extends class542 implements class438 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Luca;[I)V", line = 7)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Lk;IIIIZ)Z", line = 122)
    ...
    @OriginalMember(owner = "client!s", name = "<init>", descriptor = "(La;Lc;II[[I[[IIII)V", line = 165)
    ...
    @OriginalMember(owner = "client!s", name = "finalize", descriptor = "()V", line = 156)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(II)V", line = 162)
    public final void method693(int arg0, int arg1) {
        this.field2856.method2024().method3124(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!s", name = "a", descriptor = "(IIIIIII[[Z)V", line = 171)
