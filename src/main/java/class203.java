...
public class class203 implements Runnable {
    ...
    @OriginalMember(owner = "client!tw", name = "run", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!tw", name = "<init>", descriptor = "(ILha;)V", line = 168)
    public class203(int arg0, class60 arg1) {
        this.field3025 = arg0;
        this.field3032 = arg1;
    }

    @OriginalMember(owner = "client!tw", name = "a", descriptor = "()J", line = 21)
    public final long method1384() {
        return this.field3029;
    }

    @OriginalMember(owner = "client!tw", name = "b", descriptor = "()V", line = 24)
    ...
    @OriginalMember(owner = "client!tw", name = "c", descriptor = "()V", line = 32)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(Lvba;)V", line = 38)
    ...
    @OriginalMember(owner = "client!tw", name = "d", descriptor = "()Z", line = 54)
    public final boolean method1388() {
        return this.field3033 == null || !this.field3026 && this.field3033.method294(-65);
    }

    @OriginalMember(owner = "client!tw", name = "e", descriptor = "()V", line = 58)
    ...
    @OriginalMember(owner = "client!tw", name = "f", descriptor = "()V", line = 72)
