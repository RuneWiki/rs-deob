...
public class class723 {
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Lwq;BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Lwq;I)V", line = 34)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(I)V", line = 70)
