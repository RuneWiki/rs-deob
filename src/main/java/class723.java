...
public class class723 {
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 7)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(B)V", line = 99)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(IIIBI)V", line = 119)
