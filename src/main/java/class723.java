...
public class class723 extends class66 implements class560 {
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "()Z", line = 3)
    public final boolean method485() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "q", descriptor = "()Z", line = 6)
    public final boolean method566() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "()V", line = 10)
    public final void method489() {
    }

    @OriginalMember(owner = "client!oa", name = "k", descriptor = "()Lsk;", line = 16)
    public final class650 method539() {
        return this.field9938;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lgs;Z)Lnf;", line = 20)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/awt/Canvas;II)V", line = 26)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 33)
    ...
    @OriginalMember(owner = "client!oa", name = "OA", descriptor = "()Ljava/lang/Object;", line = 48)
    private final Object method4000() {
        return new class409(this);
    }

    @OriginalMember(owner = "client!oa", name = "m", descriptor = "()V", line = 57)
    ...
    @OriginalMember(owner = "client!oa", name = "f", descriptor = "(I)V", line = 89)
    public final void method500(int arg0) {
        this.field9943[arg0].method3601();
    }

    @OriginalMember(owner = "client!oa", name = "i", descriptor = "(I)Lza;", line = 93)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 99)
    ...
    @OriginalMember(owner = "client!oa", name = "l", descriptor = "()V", line = 108)
    public final void method541() {
    }

    @OriginalMember(owner = "client!oa", name = "f", descriptor = "()Z", line = 111)
    public final boolean method524() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIF)Lbq;", line = 115)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIIIIIII)V", line = 117)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(IIIIII)V", line = 134)
    ...
    @OriginalMember(owner = "client!oa", name = "g", descriptor = "(I)V", line = 138)
    public final void method545(int arg0) {
        this.field9943[arg0].method3611();
    }

    @OriginalMember(owner = "client!oa", name = "g", descriptor = "()V", line = 141)
    ...
    @OriginalMember(owner = "client!oa", name = "h", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!oa", name = "j", descriptor = "()Z", line = 159)
    public final boolean method534() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lkc;[Lgs;Z)Lda;", line = 165)
    ...
    @OriginalMember(owner = "client!oa", name = "h", descriptor = "()Lsk;", line = 202)
    public final class650 method533() {
        return this.field9940;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lsk;)V", line = 207)
    public final void method503(class650 arg0) {
        this.field9938 = arg0;
        this.method4014(((class294) arg0).nativeid);
    }

    @OriginalMember(owner = "client!oa", name = "t", descriptor = "()Z", line = 212)
    public final boolean method578() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lmf;I)V", line = 215)
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(I)V", line = 219)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[I[I)Laa;", line = 229)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILaa;II)V", line = 232)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([I)V", line = 241)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILaa;IIIII)V", line = 245)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lza;)V", line = 249)
    public final void method475(class437 arg0) {
        this.field9923 = (class59) arg0;
        this.method4001(arg0);
    }

    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ld;II)V", line = 422)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I)V", line = 258)
    public final void method473(int arg0) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "()Z", line = 261)
    public final boolean method479() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZ)Lnf;", line = 266)
    public final class604 method549(int arg0, int arg1, boolean arg2) {
        return new class569(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "u", descriptor = "()V", line = 270)
    public final void method581() {
    }

    @OriginalMember(owner = "client!oa", name = "s", descriptor = "()Z", line = 273)
    public final boolean method577() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIII)V", line = 276)
    public final void method492(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ldc;IIII)Lka;", line = 279)
    ...
    @OriginalMember(owner = "client!oa", name = "n", descriptor = "()V", line = 281)
    public final void method548() {
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(S)Z", line = 284)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[Lbq;)V", line = 296)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Ljava/awt/Canvas;II)V", line = 316)
    ...
    @OriginalMember(owner = "client!oa", name = "B", descriptor = "()La;", line = 341)
    ...
    @OriginalMember(owner = "client!oa", name = "finalize", descriptor = "()V", line = 356)
    ...
    @OriginalMember(owner = "client!oa", name = "v", descriptor = "()Z", line = 364)
    public final boolean method584() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(IIIIZ)Lnf;", line = 369)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(FFF)V", line = 376)
    public final void method501(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(II)Lgh;", line = 379)
    public final class575 method562(int arg0, int arg1) {
        return this.method549(arg0, arg1, false);
    }

    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(IIIIII)V", line = 385)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II)I", line = 393)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lel;)V", line = 401)
    ...
    @OriginalMember(owner = "client!oa", name = "z", descriptor = "()Z", line = 406)
    public final boolean method592() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "A", descriptor = "()Z", line = 409)
    public final boolean method595() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "x", descriptor = "()Laja;", line = 412)
    public final class100 method586() {
        return new class100(0, "SSE", 1, "CPU", 0L);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIII)V", line = 415)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lgh;Loq;)Lel;", line = 450)
    public final class574 method546(class575 arg0, class380 arg1) {
        return new class638(this, (class569) arg0, (class529) arg1);
    }

    @OriginalMember(owner = "client!oa", name = "w", descriptor = "()Z", line = 454)
    public final boolean method585() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(II)Loq;", line = 459)
    public final class380 method540(int arg0, int arg1) {
        return new class529(arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[[I[[IIII)Ls;", line = 465)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Len;)V", line = 467)
    public final void method596(class339 arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([IIIIIZ)Lnf;", line = 470)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Z)V", line = 472)
    public final void method507(boolean arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "d", descriptor = "()I", line = 475)
    public final int method493() {
        return 4;
    }

    @OriginalMember(owner = "client!oa", name = "WA", descriptor = "(S)Z", line = 481)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lmf;Z)V", line = 506)
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(II)V", line = 536)
    ...
    @OriginalMember(owner = "client!oa", name = "r", descriptor = "()Z", line = 546)
    public final boolean method570() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Len;Len;FLen;)Len;", line = 549)
    public final class339 method535(class339 arg0, class339 arg1, float arg2, class339 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 552)
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "()V", line = 574)
    public final void method506() {
        this.method559(this.field9941.field3363);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Z)V", line = 576)
    public final void method486(boolean arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "y", descriptor = "()Z", line = 580)
    public final boolean method588() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "p", descriptor = "()Lsk;", line = 583)
    public final class650 method565() {
        return new class294();
    }

    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(IIIIII)Len;", line = 589)
    public final class339 method564(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIII)V", line = 591)
    public final void method514(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!oa", name = "g", descriptor = "(II)I", line = 594)
    public final int method593(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!oa", name = "o", descriptor = "()V", line = 597)
    public final void method558() {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lmf;)V", line = 612)
