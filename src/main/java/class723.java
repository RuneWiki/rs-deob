...
public class class723 extends class197 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(BII)I", line = 3)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "(I)Leg;", line = 71)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ZI)I", line = 170)
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "(B)V", line = 195)
    ...
    @OriginalMember(owner = "client!cp", name = "c", descriptor = "(B)V", line = 378)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(II)[B", line = 390)
    ...
    @OriginalMember(owner = "client!cp", name = "c", descriptor = "(I)I", line = 410)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(Z)I", line = 425)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(BI)V", line = 453)
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "(ILmda;Lmda;Liq;Lbc;I[BIZ)V", line = 942)
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "(BII)Lvt;", line = 490)
    ...
    @OriginalMember(owner = "client!cp", name = "d", descriptor = "(B)V", line = 749)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ILvc;Lee;B)V", line = 767)
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "(Z)I", line = 882)
    ...
    @OriginalMember(owner = "client!cp", name = "e", descriptor = "(B)I", line = 897)
