...
public class class723 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "([BI)V", line = 44)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(B)V", line = 93)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(ZI)[B", line = 111)
