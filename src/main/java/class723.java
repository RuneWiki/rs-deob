...
public class class723 implements class245 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IZ)I", line = 33)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IIB)V", line = 74)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(III)V", line = 113)
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(III)V", line = 146)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IB)I", line = 170)
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(IB)I", line = 191)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(BLfa;II)V", line = 205)
    ...
    @OriginalMember(owner = "client!rl", name = "c", descriptor = "(III)V", line = 265)
