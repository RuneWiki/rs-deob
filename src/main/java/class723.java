...
public class class723 implements Runnable {
    ...
    @OriginalMember(owner = "client!uha", name = "run", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!uha", name = "b", descriptor = "(I)Ljava/lang/String;", line = 144)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(ZLbia;)V", line = 155)
    ...
    @OriginalMember(owner = "client!uha", name = "c", descriptor = "(I)Z", line = 168)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(Z)I", line = 185)
    ...
    @OriginalMember(owner = "client!uha", name = "d", descriptor = "(I)V", line = 199)
    ...
    @OriginalMember(owner = "client!uha", name = "e", descriptor = "(I)I", line = 212)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(B)V", line = 239)
    public static void method3984(byte arg0) {
        field10141 = null;
        int var1 = 62 / ((1 - arg0) / 45);
    }

    @OriginalMember(owner = "client!uha", name = "b", descriptor = "(Z)Lps;", line = 249)
    public final class432 method3985(boolean arg0) {
        field10151++;
        return arg0 ? this.field10162 : null;
    }

    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/String;Z)V", line = 261)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(Lha;B)V", line = 293)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(ILha;I)Lpia;", line = 309)
    ...
    @OriginalMember(owner = "client!uha", name = "b", descriptor = "(B)I", line = 326)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(JBILps;Ljava/lang/String;)V", line = 340)
    ...
    @OriginalMember(owner = "client!uha", name = "c", descriptor = "(Z)J", line = 355)
