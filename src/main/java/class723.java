...
public class class723 {
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(II)Lri;")
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(BIIIILfl;)Lam;")
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "(Lega;ILwm;)V")
