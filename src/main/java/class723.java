...
public class class723 extends class134 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Z[[[BIBIIZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(I)V", line = 308)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(BLd;Lha;)V", line = 323)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(JZIZJZILjava/lang/String;IIZILjava/lang/String;)V", line = 553)
