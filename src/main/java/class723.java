...
public class class723 {
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Z)V", line = 46)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(I)V", line = 64)
