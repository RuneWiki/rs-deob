...
public class class723 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(I)Lhc;")
    ...
    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(I)Lhc;")
    ...
    @OriginalMember(owner = "client!cj", name = "<init>", descriptor = "(Lut;)V")
