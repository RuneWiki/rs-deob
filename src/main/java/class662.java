...
public class class662 extends class60 {
    ...
    @OriginalMember(owner = "client!gj", name = "<init>", descriptor = "(ILhd;)V")
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(III)Lqja;")
    ...
    @OriginalMember(owner = "client!gj", name = "<init>", descriptor = "(Lhd;)V")
