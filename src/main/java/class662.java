...
public class class662 extends class724 implements class471 {
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(ILtn;IIBI[BII)V")
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Ljc;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Ljc;Ltn;Lds;II)V")
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "([FLtn;IIIIIII)V")
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Ljc;Ltn;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Ljc;Ltn;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(IIBZ)Lwm;")
