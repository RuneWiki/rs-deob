...
public class class662 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IBI)Z", line = 16)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(B)V", line = 40)
