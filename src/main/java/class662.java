...
public class class662 extends class766 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IB)V", line = 31)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(II)Z", line = 45)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "()V", line = 69)
    public class662() {
    }

    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 71)
