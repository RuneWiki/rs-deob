...
public class class662 extends class113 {
    ...
    @OriginalMember(owner = "client!ua", name = "g", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(III)Z", line = 43)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IIIIIII)V", line = 54)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(ILjava/lang/String;)V", line = 493)
    ...
    @OriginalMember(owner = "client!ua", name = "b", descriptor = "(III)B", line = 544)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IIBII)V", line = 567)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IIIIZ)V", line = 608)
    ...
    @OriginalMember(owner = "client!ua", name = "<init>", descriptor = "(Llba;II)V", line = 628)
