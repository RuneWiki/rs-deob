...
public class class662 extends class382 {
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Leu;I)V")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(ILpn;Ljg;)I")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(II[BILpn;I)Ltea;")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(ILeg;II)V")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Lhw;IIZ)V")
    ...
    @OriginalMember(owner = "client!ega", name = "u", descriptor = "()Lho;")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Ljg;Lpn;I)Z")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Z[IIIIII)Lcm;")
    ...
    @OriginalMember(owner = "client!ega", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/fl;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Ldea;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Lfa;Lsea;I)V")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Lpi;I)V")
    ...
    @OriginalMember(owner = "client!ega", name = "d", descriptor = "(II)Lcc;")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(BLpn;ILjg;I)Lcm;")
    ...
    @OriginalMember(owner = "client!ega", name = "b", descriptor = "(Ljg;Lpn;I)Z")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Ljagdx/IDirect3D;Ljagdx/D3DPRESENT_PARAMETERS;IIIB)Z")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Leg;IIIILjea;B)V")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(ZLou;)V")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Lwn;Lwn;FLwn;)Lwn;")
    public final class674 method91(class674 arg0, class674 arg1, float arg2, class674 arg3) {
        return (arg2 < 0.5F) ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Lf;Z)V")
    ...
    @OriginalMember(owner = "client!ega", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Lfa;Lsea;Ljava/lang/Integer;)Lr;")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Leg;I)I")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Lgi;B)I")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(BLhw;)I")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(ILsi;)V")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(BLpn;IZII[BI)Lcm;")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Z[[III)Lhea;")
    ...
    @OriginalMember(owner = "client!ega", name = "e", descriptor = "(ZI)Ljea;")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Ldca;B)I")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Lvc;BI)V")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(ZIZLhw;I)V")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Lmd;Z)V")
    ...
    @OriginalMember(owner = "client!ega", name = "c", descriptor = "(ZI)Lvc;")
    public final class288 method1038(boolean arg0, int arg1) {
        int var3 = 124 % ((arg1 + 2) / 39);
        return new class641(this, arg0);
    }

    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(IZI[FIIILpn;)Lcm;")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "([Lth;B)Lsi;")
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(ILtb;)I")
