...
public class class662 {
    ...
    @OriginalMember(owner = "client!bca", name = "toString", descriptor = "()Ljava/lang/String;", line = 15)
    public final String toString() {
        field8735++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(II)V", line = 28)
    ...
    @OriginalMember(owner = "client!bca", name = "b", descriptor = "(I)I", line = 43)
