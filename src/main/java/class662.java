...
public class class662 extends class431 {
    ...
    @OriginalMember(owner = "client!ot", name = "g", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 14)
    public class662(Object arg0, int arg1) {
        super(arg1);
        this.field9423 = new SoftReference(arg0);
    }

    @OriginalMember(owner = "client!ot", name = "e", descriptor = "(I)Ljava/lang/Object;", line = 23)
