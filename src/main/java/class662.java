...
public class class662 extends class56 {
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(IIII)Z")
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(ZIIBII)V")
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(Ljava/lang/String;I)I")
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(IZ)[I")
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(ILee;I)V")
