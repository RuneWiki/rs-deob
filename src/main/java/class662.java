...
public class class662 extends class440 {
    ...
    @OriginalMember(owner = "client!lga", name = "g", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!lga", name = "b", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!lga", name = "<init>", descriptor = "()V", line = 70)
    public class662() {
        super(0, true);
    }

    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(ILmo;I)V", line = 73)
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(BI)[I", line = 119)
