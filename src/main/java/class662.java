...
public class class662 extends class339 {
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Lfa;Lga;I)Z")
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IZIZILfa;Lga;D)[I")
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IZIILfa;Lga;)[F")
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IILga;ZILfa;D)[I")
    ...
    @OriginalMember(owner = "client!dv", name = "<init>", descriptor = "(Lio;)V")
