...
public class class662 extends class512 {
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(ZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(IIZ)V", line = 13)
    ...
    @OriginalMember(owner = "client!eba", name = "b", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!eba", name = "<init>", descriptor = "(Lpga;)V", line = 42)
    public class662(class492 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!eba", name = "e", descriptor = "(I)Z", line = 46)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(IILlo;)V", line = 56)
