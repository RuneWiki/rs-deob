...
public class class662 extends class125 {
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IZ)V", line = 33)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lgp;)V", line = 45)
    public class662(class549 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ar", name = "c", descriptor = "(I)Z", line = 49)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ZI)I", line = 64)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(B)I", line = 198)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(ILgp;)V", line = 244)
    public class662(int arg0, class549 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(BI)V", line = 215)
    ...
    @OriginalMember(owner = "client!ar", name = "c", descriptor = "(Z)I", line = 229)
