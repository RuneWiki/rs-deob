...
public class class662 extends class508 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IB)Z", line = 7)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Les;B)Loe;", line = 23)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(II)Z", line = 39)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Z)Z", line = 63)
    ...
    @OriginalMember(owner = "client!wa", name = "<init>", descriptor = "(I)V", line = 169)
    public class662(int arg0) {
        this.field9364 = arg0;
    }

    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(I)V", line = 177)
