...
public class class662 {
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;B)V", line = 80)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(BII)Z", line = 93)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(IIIIIIILha;II[[[BII)V", line = 111)
