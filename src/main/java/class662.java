...
public class class662 extends class117 {
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(IIILrja;)V")
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lpf;II)V")
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lwia;BLha;)V")
