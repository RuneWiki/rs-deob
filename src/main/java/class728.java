...
public class class728 implements class158 {
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "([Llo;ILvf;)Lir;")
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(II)Lbq;")
    ...
    @OriginalMember(owner = "client!sea", name = "b", descriptor = "(II)Lmr;")
    ...
    @OriginalMember(owner = "client!sea", name = "<init>", descriptor = "(Lgda;Lgda;Lgda;)V")
