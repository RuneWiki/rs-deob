...
public class class728 extends class24 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILjp;)V", line = 18)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Lke;I)V", line = 34)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(I)V", line = 55)
