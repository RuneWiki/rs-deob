...
public class class728 extends class297 {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lcea;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "()V", line = 385)
    public class728() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cc", name = "e", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(II[[ILjava/util/Random;III)V", line = 118)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(CZLjava/lang/String;)[Ljava/lang/String;", line = 339)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(B)V", line = 375)
    ...
    @OriginalMember(owner = "client!cc", name = "c", descriptor = "(II)[I", line = 394)
