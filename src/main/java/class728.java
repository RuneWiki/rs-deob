...
public class class728 {
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!sha", name = "b", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(IBIIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(II)Ljl;", line = 72)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(IB)V", line = 109)
    ...
    @OriginalMember(owner = "client!sha", name = "b", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(ZI)V", line = 156)
    ...
    @OriginalMember(owner = "client!sha", name = "c", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!sha", name = "d", descriptor = "(I)V", line = 196)
    ...
    @OriginalMember(owner = "client!sha", name = "c", descriptor = "(B)V", line = 221)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(IZ)V", line = 242)
    ...
    @OriginalMember(owner = "client!sha", name = "<init>", descriptor = "(Lrga;IZLni;Lni;)V", line = 278)
