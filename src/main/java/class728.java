...
public class class728 extends class60 {
    ...
    @OriginalMember(owner = "client!ic", name = "c", descriptor = "(II)V", line = 17)
    ...
    @OriginalMember(owner = "client!ic", name = "c", descriptor = "(B)Z", line = 52)
    ...
    @OriginalMember(owner = "client!ic", name = "d", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Z)I", line = 85)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IFII[FFIII[FII)V", line = 100)
    ...
    @OriginalMember(owner = "client!ic", name = "b", descriptor = "(II)I", line = 150)
    ...
    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "(Lhd;)V", line = 165)
    public class728(class773 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "(ILhd;)V", line = 168)
    public class728(int arg0, class773 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ic", name = "b", descriptor = "(B)V", line = 197)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(BI)V", line = 216)
    ...
    @OriginalMember(owner = "client!ic", name = "e", descriptor = "(B)Z", line = 230)
