...
public class class728 extends class409 {
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(IIII)[B", line = 5)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "()V", line = 18)
    public static final void method4032() {
        class676.method3636(1, class126.field1511);
    }

    @OriginalMember(owner = "client!vca", name = "h", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(IIB)V", line = 39)
    ...
    @OriginalMember(owner = "client!vca", name = "i", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!vca", name = "<init>", descriptor = "()V", line = 73)
    public class728() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(BLha;Ld;)V", line = 77)
