...
public abstract class class728 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IIIBI)V", line = 41)
