...
public class class728 extends class298 {
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(Lni;IB)V")
    ...
    @OriginalMember(owner = "client!lga", name = "<init>", descriptor = "(Lrl;IIZ)V")
    ...
    @OriginalMember(owner = "client!lga", name = "<init>", descriptor = "(Lrl;II[III)V")
