...
public class class728 extends class111 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;B)V")
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(ZLofa;Lha;)V")
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    ...
    @OriginalMember(owner = "client!gn", name = "g", descriptor = "(I)Lwo;")
