...
public class class728 {
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(IIB)V", line = 9)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!gda", name = "b", descriptor = "(I)V", line = 36)
