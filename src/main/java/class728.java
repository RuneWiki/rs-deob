...
public class class728 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lnd;I)Lhb;")
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(Lnd;I)[Lhb;")
    public static final class728[] method4058(class547 arg0, int arg1) {
        byte[] var2 = arg0.method3166((byte) 125, arg1);
        return var2 == null ? null : method4060(var2);
    }

    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lnd;II)Lhb;")
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(Lnd;II)[Lhb;")
