...
public abstract class class728 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(BLha;Luf;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!ai", name = "c", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(B)Leu;", line = 94)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(BLjava/io/File;Z)V", line = 118)
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(IIIII)V", line = 399)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IIII)V", line = 161)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IILjava/util/Random;)I", line = 327)
    ...
    @OriginalMember(owner = "client!ai", name = "d", descriptor = "(I)V", line = 355)
