...
public class class728 {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ILsq;[IJ)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IB)Ltk;")
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "(ILoh;Loh;Lev;)V")
