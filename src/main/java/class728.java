...
public class class728 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lkn;Z)I", line = 23)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(III)Lge;", line = 66)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Laa;ILwq;IIIIILkf;Ljava/lang/String;Lda;I)V", line = 76)
