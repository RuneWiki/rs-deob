...
public class class728 extends class341 {
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(I)Liw;", line = 15)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IILqp;)V", line = 26)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IIIILlga;IZ)V", line = 90)
