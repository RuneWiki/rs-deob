...
public class class728 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IBLee;)V")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lee;I)V")
