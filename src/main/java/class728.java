...
public abstract class class728 extends class577 {
    ...
    @OriginalMember(owner = "client!ih", name = "c", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(II[FIFFI[FIIIFII)V", line = 22)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(IIIIIBLha;)Lka;", line = 107)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(ILjagtheora/ogg/OggPacket;)V", line = 157)
    ...
    @OriginalMember(owner = "client!ih", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 170)
