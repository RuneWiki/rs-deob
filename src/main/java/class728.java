...
public abstract class class728 extends class173 {
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(IIII)I", line = 3)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(Lha;ZI)Z", line = 31)
    ...
    @OriginalMember(owner = "client!hfa", name = "<init>", descriptor = "(Lofa;I)V", line = 469)
