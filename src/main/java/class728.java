...
public class class728 {
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(III)Lva;")
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Lfca;I)Ldr;")
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(ZLkka;)V")
