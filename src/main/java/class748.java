...
public class class748 {
    ...
    @OriginalMember(owner = "client!dw", name = "toString", descriptor = "()Ljava/lang/String;", line = 22)
    public final String toString() {
        field10383++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(BI)V", line = 30)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(IILbt;I)Lso;", line = 42)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(ILes;)Ldn;", line = 62)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(BJ)Ljava/lang/String;", line = 74)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(I[B)Ltf;", line = 128)
    ...
    @OriginalMember(owner = "client!dw", name = "<init>", descriptor = "(I)V", line = 170)
