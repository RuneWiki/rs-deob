...
public class class748 {
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(III)Z")
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Lvc;B)Lgca;")
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(ILhda;)Z")
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(BI)Ltp;")
