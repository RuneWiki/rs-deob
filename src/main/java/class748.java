...
public class class748 extends class578 {
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(III)V", line = 9)
    ...
    @OriginalMember(owner = "client!gfa", name = "b", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "(IIIIIII)V", line = 40)
    ...
    @OriginalMember(owner = "client!gfa", name = "c", descriptor = "(III)V", line = 55)
    ...
    @OriginalMember(owner = "client!gfa", name = "b", descriptor = "(III)V", line = 75)
