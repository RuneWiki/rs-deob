...
public class class748 implements Runnable {
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(ILwk;)I", line = 3)
    ...
    @OriginalMember(owner = "client!sda", name = "finalize", descriptor = "()V", line = 33)
    protected final void finalize() {
        field10434++;
        this.method4168(1);
    }

    @OriginalMember(owner = "client!sda", name = "<init>", descriptor = "(Ljava/net/Socket;Lhga;I)V", line = 458)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(I)I", line = 55)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "([BIII)V", line = 70)
    ...
    @OriginalMember(owner = "client!sda", name = "b", descriptor = "(I)I", line = 101)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(III[B)V", line = 116)
    ...
    @OriginalMember(owner = "client!sda", name = "c", descriptor = "(I)V", line = 173)
    ...
    @OriginalMember(owner = "client!sda", name = "run", descriptor = "()V", line = 221)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(B)V", line = 293)
    ...
    @OriginalMember(owner = "client!sda", name = "b", descriptor = "(B)V", line = 316)
    ...
    @OriginalMember(owner = "client!sda", name = "d", descriptor = "(I)V", line = 333)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(ILsl;)Ljava/lang/String;", line = 344)
    ...
    @OriginalMember(owner = "client!sda", name = "e", descriptor = "(I)V", line = 360)
