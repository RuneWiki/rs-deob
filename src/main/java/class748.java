...
public class class748 extends class66 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V", line = 7)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "([B[IIIIIIII)V", line = 94)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(CIIIZLaa;II)V", line = 128)
    ...
    @OriginalMember(owner = "client!nk", name = "b", descriptor = "([B[IIIIIIII)V", line = 197)
    ...
    @OriginalMember(owner = "client!nk", name = "fa", descriptor = "(CIIIZ)V", line = 253)
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(Luga;Leia;[Leu;[I[I)V", line = 315)
    ...
    @OriginalMember(owner = "client!nk", name = "b", descriptor = "([B[IIIIIIIIIIILaa;II)V", line = 336)
