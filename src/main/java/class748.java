...
public class class748 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(I[BII)V", line = 81)
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(B)V", line = 203)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(JI)V", line = 225)
    ...
    @OriginalMember(owner = "client!kr", name = "c", descriptor = "(B)V", line = 243)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(I)J", line = 289)
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(I)Ljava/io/File;", line = 306)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(I[B)V", line = 324)
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(Ldq;II)V", line = 544)
    ...
    @OriginalMember(owner = "client!kr", name = "d", descriptor = "(B)V", line = 341)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(II[BI)V", line = 365)
