...
public class class748 {
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(ILjava/awt/Frame;)V")
    ...
    @OriginalMember(owner = "client!me", name = "enter", descriptor = "(Ljava/awt/Frame;IIII)V")
    ...
    @OriginalMember(owner = "client!me", name = "listmodes", descriptor = "()[I")
    ...
    @OriginalMember(owner = "client!me", name = "exit", descriptor = "()V")
