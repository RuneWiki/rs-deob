...
public class class748 extends class597 implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    @OriginalMember(owner = "client!dw", name = "b", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!dw", name = "c", descriptor = "(B)I", line = 28)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(IIBII)V", line = 39)
    ...
    @OriginalMember(owner = "client!dw", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 55)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        this.method4166(-122, arg0.getY(), arg0.getX());
    }

    @OriginalMember(owner = "client!dw", name = "d", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!dw", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 72)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.method4166(111, arg0.getY(), arg0.getX());
    }

    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(B)Z", line = 80)
    public final boolean method2653(byte arg0) {
        int var2 = -82 % ((arg0 - 28) / 37);
        return (this.field10355 & 0x2) != 0;
    }

    @OriginalMember(owner = "client!dw", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 89)
    ...
    @OriginalMember(owner = "client!dw", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 114)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method4166(112, arg0.getY(), arg0.getX());
    }

    @OriginalMember(owner = "client!dw", name = "f", descriptor = "(I)I", line = 121)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;B)I", line = 131)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(III)V", line = 159)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(I)Z", line = 174)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 185)
    ...
    @OriginalMember(owner = "client!dw", name = "e", descriptor = "(B)V", line = 199)
    ...
    @OriginalMember(owner = "client!dw", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 221)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method4166(120, arg0.getY(), arg0.getX());
    }

    @OriginalMember(owner = "client!dw", name = "c", descriptor = "(I)Z", line = 228)
    ...
    @OriginalMember(owner = "client!dw", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 239)
    ...
    @OriginalMember(owner = "client!dw", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 312)
    public class748(Component arg0, boolean arg1) {
        this.method4167(arg0, -27065);
        this.field10362 = arg1;
    }

    @OriginalMember(owner = "client!dw", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 271)
    ...
    @OriginalMember(owner = "client!dw", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 288)
    ...
    @OriginalMember(owner = "client!dw", name = "b", descriptor = "(I)Lrm;", line = 298)
