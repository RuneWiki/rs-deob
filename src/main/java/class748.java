...
public class class748 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(BIIIIIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(IIB)I", line = 64)
