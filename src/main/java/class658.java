...
public abstract class class658 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(IIIII)V", line = 297)
    ...
    @OriginalMember(owner = "client!ec", name = "d", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IIII)V", line = 107)
