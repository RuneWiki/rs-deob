...
public class class658 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Liaa;I)Lsv;", line = 8)
    ...
    @OriginalMember(owner = "client!hn", name = "<init>", descriptor = "(Lap;)V", line = 149)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IBZIIZ)V", line = 46)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(ILuda;I)Z", line = 109)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(BI)Z", line = 135)
