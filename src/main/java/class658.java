...
public class class658 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ZLpt;)Lpt;", line = 28)
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IIIII)Z", line = 67)
