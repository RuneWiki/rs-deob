...
public class class658 extends class392 {
    ...
    @OriginalMember(owner = "client!tga", name = "<init>", descriptor = "(Lw;)V", line = 11)
    public class658(class675 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!tga", name = "b", descriptor = "(II)I", line = 14)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Z)I", line = 27)
    ...
    @OriginalMember(owner = "client!tga", name = "<init>", descriptor = "(ILw;)V", line = 38)
    public class658(int arg0, class675 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!tga", name = "b", descriptor = "(Z)V", line = 41)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(ZIIIII)V", line = 54)
    ...
    @OriginalMember(owner = "client!tga", name = "b", descriptor = "(I)I", line = 108)
    public final int method3690(int arg0) {
        ++field9283;
        return arg0 != 17539 ? 15 : super.field5452;
    }

    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(BI)V", line = 120)
    ...
    @OriginalMember(owner = "client!tga", name = "c", descriptor = "(I)V", line = 135)
