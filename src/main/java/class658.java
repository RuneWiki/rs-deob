...
public class class658 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(II)Lwm;")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IIILtd;Ltd;)V")
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(Ldh;ILkha;)V")
