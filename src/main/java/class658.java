...
public class class658 extends class125 {
    ...
    @OriginalMember(owner = "client!mia", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(ZI)I", line = 16)
    ...
    @OriginalMember(owner = "client!mia", name = "c", descriptor = "(I)Z", line = 34)
    ...
    @OriginalMember(owner = "client!mia", name = "b", descriptor = "(Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(BIII)I", line = 66)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(B)I", line = 97)
    ...
    @OriginalMember(owner = "client!mia", name = "<init>", descriptor = "(ILgp;)V", line = 115)
    public class658(int arg0, class549 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(BI)V", line = 119)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(IIIZ)I", line = 130)
    ...
    @OriginalMember(owner = "client!mia", name = "<init>", descriptor = "(Lgp;)V", line = 147)
    public class658(class549 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!mia", name = "c", descriptor = "(Z)I", line = 157)
