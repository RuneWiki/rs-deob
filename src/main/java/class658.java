...
public class class658 extends class60 {
    ...
    @OriginalMember(owner = "client!dv", name = "fa", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!dv", name = "b", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(CIIIZLaa;II)V")
    ...
    @OriginalMember(owner = "client!dv", name = "b", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!dv", name = "<init>", descriptor = "(Lao;Loea;[Lrh;[I[I)V")
