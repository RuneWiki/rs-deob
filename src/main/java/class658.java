...
public class class658 extends class601 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IZ)V", line = 31)
    ...
    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!lw", name = "<init>", descriptor = "(ILgn;)V", line = 70)
    public class658(int arg0, class699 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(B)I", line = 73)
    ...
    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(II)I", line = 86)
    public final int method34(int arg0, int arg1) {
        ++field9400;
        return arg1 != 15706 ? 84 : 1;
    }

    @OriginalMember(owner = "client!lw", name = "<init>", descriptor = "(Lgn;)V", line = 97)
    public class658(class699 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(ZLjava/io/File;Z)V", line = 100)
