...
public class class658 {
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(ILjava/lang/String;ILjava/lang/String;J)V", line = 10)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(B)I", line = 23)
