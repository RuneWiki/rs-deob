...
public class class658 extends class263 {
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!dv", name = "<init>", descriptor = "(ILee;Lhaa;III)V", line = 17)
    public class658(int arg0, class676 arg1, class82 arg2, int arg3, int arg4, int arg5) {
        super(arg0, arg1, arg2, arg3, arg4);
        this.field9182 = arg5;
    }

    @OriginalMember(owner = "client!dv", name = "c", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(I)Lhda;", line = 54)
