...
public class class658 implements class509 {
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(ZLkf;B)V", line = 51)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Z)V", line = 216)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(B)Z", line = 227)
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(Z)Z", line = 239)
    ...
    @OriginalMember(owner = "client!pa", name = "<init>", descriptor = "(Lae;Lcb;)V", line = 3710)
