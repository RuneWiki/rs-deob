...
public class class658 {
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(I[Lf;Ljava/lang/String;I)I")
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(IIILjava/lang/String;[Lf;)I")
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "([II[Ljava/lang/String;Ljava/lang/String;[Lf;)I")
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(IILjava/lang/String;[Lf;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "([Lf;Ljava/lang/String;I)I")
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(I[Lf;ILjava/lang/String;)I")
