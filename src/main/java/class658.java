...
public class class658 extends class613 implements class484 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ZLha;II)Lbaa;")
    ...
    @OriginalMember(owner = "client!am", name = "h", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Lha;BI)Lka;")
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(Lha;I)Lrn;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IIILha;)Z")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ZLje;IIILha;I)V")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Lha;I)Lmaa;")
    ...
    @OriginalMember(owner = "client!am", name = "<init>", descriptor = "(Lha;Lkv;IIIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ILha;)V")
