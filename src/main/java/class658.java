...
public class class658 extends class470 {
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(II)I", line = 16)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IILha;I[[[BIIIIIIII)V", line = 36)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lwd;I)I", line = 78)
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "([FIFBIFIIFFI)V", line = 140)
