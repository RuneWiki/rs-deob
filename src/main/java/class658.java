...
public class class658 extends class739 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lsl;II)V", line = 9)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(II)[I", line = 52)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(B)V", line = 175)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "()V", line = 187)
    public class658() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fj", name = "d", descriptor = "(Z)V", line = 212)
    ...
    @OriginalMember(owner = "client!fj", name = "c", descriptor = "(I)V", line = 223)
