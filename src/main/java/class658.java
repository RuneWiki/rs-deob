...
public class class658 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(ZLjk;)V", line = 3)
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(I)V", line = 51)
    public class658(int arg0) {
        this.field8879 = arg0;
    }

    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(IIIIII)V", line = 70)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Z)Ljk;", line = 35)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(B)V", line = 62)
