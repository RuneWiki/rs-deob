...
public class class658 extends class171 implements class283 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(BII[B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lr;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(I)I", line = 45)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(B)I", line = 57)
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "(Lok;ILjaclib/memory/Buffer;)V", line = 67)
    public class658(class228 arg0, int arg1, Buffer arg2) {
        super(arg0, arg2);
        this.field9236 = arg1;
    }

    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "(Lok;I[BI)V", line = 75)
    public class658(class228 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field9236 = arg1;
    }

    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(I)J", line = 85)
