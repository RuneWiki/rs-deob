...
public class class658 {
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(IIIZI)V", line = 27)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!nda", name = "b", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(ILfd;)Lkp;", line = 82)
    ...
    @OriginalMember(owner = "client!nda", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 97)
