...
public class class386 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IIIIIIIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(B[B)V", line = 110)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "([BI)V", line = 281)
