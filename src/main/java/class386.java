...
public class class386 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Lai;IIII)V")
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(Lbt;ILkda;)V")
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(II)Lfea;")
