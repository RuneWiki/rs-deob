...
public class class386 extends class218 implements class518 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(ZLza;II)Ljl;", line = 8)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(I)I", line = 37)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Z)Z", line = 49)
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(ILza;)Lsr;", line = 67)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IILza;IILvl;Z)V", line = 94)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(Lza;Lp;IIIIZIIZ)V", line = 124)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(B)I", line = 161)
    ...
    @OriginalMember(owner = "client!lf", name = "c", descriptor = "(I)V", line = 173)
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(B)Z", line = 185)
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(I)I", line = 195)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(BLza;I)Le;", line = 207)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(ILza;)V", line = 230)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IILjg;I)J", line = 259)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Lza;III)Z", line = 288)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(BLza;)V", line = 311)
    ...
    @OriginalMember(owner = "client!lf", name = "f", descriptor = "(I)V", line = 342)
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(BLza;)V", line = 353)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(ILza;I)Le;", line = 364)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(ILec;BI)V", line = 378)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IIBIZ)V", line = 391)
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(Z)V", line = 414)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IIIIIB)V", line = 425)
