...
public class class386 extends class436 {
    ...
    @OriginalMember(owner = "client!bg", name = "c", descriptor = "(B)J", line = 4)
    public final long method2436(byte arg0) {
        field5643++;
        return arg0 == 74 ? this.field5648 : -95L;
    }

    @OriginalMember(owner = "client!bg", name = "b", descriptor = "(B)I", line = 15)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(II)I", line = 27)
    public static int method2438(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!bg", name = "g", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!bg", name = "d", descriptor = "(I)I", line = 52)
    ...
    @OriginalMember(owner = "client!bg", name = "e", descriptor = "(I)I", line = 68)
