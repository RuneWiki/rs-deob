...
public class class386 extends class540 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!mn", name = "d", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(ZIII)V", line = 60)
    ...
    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "(Luq;Luq;Lbd;)V", line = 92)
    public class386(class172 arg0, class172 arg1, class68 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IIBII)V", line = 98)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IIZI)V", line = 132)
