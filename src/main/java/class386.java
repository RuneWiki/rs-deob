...
public class class386 extends class392 {
    ...
    @OriginalMember(owner = "client!qfa", name = "<init>", descriptor = "(ILw;)V", line = 3)
    public class386(int arg0, class675 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!qfa", name = "<init>", descriptor = "(Lw;)V", line = 7)
    public class386(class675 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(IBI)Z", line = 11)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(Z)I", line = 23)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(IJ)I", line = 34)
    ...
    @OriginalMember(owner = "client!qfa", name = "b", descriptor = "(II)I", line = 46)
    ...
    @OriginalMember(owner = "client!qfa", name = "b", descriptor = "(Z)V", line = 65)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(BI)V", line = 81)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(ZIZIZ)I", line = 94)
    ...
    @OriginalMember(owner = "client!qfa", name = "b", descriptor = "(I)I", line = 133)
    public final int method2326(int arg0) {
        ++field5407;
        return arg0 != 17539 ? -82 : super.field5452;
    }

    @OriginalMember(owner = "client!qfa", name = "c", descriptor = "(Z)V", line = 151)
    ...
    @OriginalMember(owner = "client!qfa", name = "c", descriptor = "(I)Z", line = 167)
