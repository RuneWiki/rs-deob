...
public abstract class class386 implements class101 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Ljaggl/opengl;IIIII[F)V")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Ljaggl/opengl;IIIII[B)V")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Ljaggl/opengl;IIIIII[I)V")
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(Lbf;IIIZ)V")
