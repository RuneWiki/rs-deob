...
public class class386 extends class359 implements class332 {
    ...
    @OriginalMember(owner = "client!ii", name = "b", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(Lod;I[BIZ)V", line = 19)
    public class386(class349 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34963, arg2, arg3, arg4);
        this.field5845 = arg1;
    }

    @OriginalMember(owner = "client!ii", name = "b", descriptor = "(I)I", line = 27)
    ...
    @OriginalMember(owner = "client!ii", name = "c", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(BI[BI)V", line = 52)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(I)J", line = 71)
    public final long method879(int arg0) {
        ++field5847;
        return arg0 < 124 ? -107L : 0L;
    }

    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(B)I", line = 83)
