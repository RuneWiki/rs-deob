...
public class class386 implements class615 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(II)Lde;")
    ...
    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(II)Lur;")
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(Lvo;Lvo;Lvo;)V")
