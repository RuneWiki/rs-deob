...
public class class386 extends class83 {
    ...
    @OriginalMember(owner = "client!cb", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!cb", name = "d", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(ZI)V", line = 29)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IBLtq;)V", line = 44)
    ...
    @OriginalMember(owner = "client!cb", name = "e", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!cb", name = "e", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "()V", line = 94)
    public class386() {
        this(0);
    }

    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(ZI)[[I", line = 101)
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(I)V", line = 141)
    private class386(int arg0) {
        super(0, false);
        this.method2394(true, arg0);
    }

    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lhd;)V", line = 151)
