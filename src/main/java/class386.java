...
public class class386 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IIIZI)V", line = 10)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(BI[BIIIII[B)V", line = 30)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(I)V", line = 81)
