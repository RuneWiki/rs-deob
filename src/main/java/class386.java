...
public class class386 extends class305 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ILae;Lcl;Lza;)V", line = 3)
    ...
    @OriginalMember(owner = "client!kp", name = "f", descriptor = "(I)I", line = 153)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ILfh;B)V", line = 166)
    ...
    @OriginalMember(owner = "client!kp", name = "g", descriptor = "(I)V", line = 205)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IIIIIIIZII)V", line = 217)
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "()V", line = 243)
    public class386() {
        super(1, true);
    }

    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(II)[I", line = 247)
    ...
    @OriginalMember(owner = "client!kp", name = "e", descriptor = "(B)V", line = 284)
