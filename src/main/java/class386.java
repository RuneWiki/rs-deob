...
public class class386 extends class117 implements class503 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lmg;B)V")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(BLya;I)Lt;")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IBLya;Z)Lso;")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(ILya;I)Lt;")
    ...
    @OriginalMember(owner = "client!lq", name = "c", descriptor = "(ILya;)V")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lya;B)Lmf;")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lya;IZLij;III)V")
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(ILya;)V")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(ZILya;I)Z")
    ...
    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "(Lya;Ljo;IIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(ILya;)V")
