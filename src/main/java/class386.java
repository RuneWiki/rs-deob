...
public class class386 extends OutputStream {
    ...
    @OriginalMember(owner = "client!ll", name = "write", descriptor = "(I)V", line = 4)
    public final void write(int arg0) throws IOException {
        field5626++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!ll", name = "b", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 101)
