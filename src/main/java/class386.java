...
public class class386 extends class328 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Ljava/lang/String;IZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!vm", name = "c", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(BILco;)V", line = 91)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IB)[I", line = 123)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!vm", name = "d", descriptor = "(B)V", line = 164)
    ...
    @OriginalMember(owner = "client!vm", name = "f", descriptor = "(I)V", line = 343)
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "()V", line = 387)
    public class386() {
        super(1, true);
    }

    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(I[BII)I", line = 363)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(II)[I", line = 393)
