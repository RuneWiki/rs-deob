...
public class class386 extends class54 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Lgga;B)V", line = 7)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(BI)V", line = 30)
    ...
    @OriginalMember(owner = "client!bl", name = "c", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Z)V", line = 81)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Lag;I)V", line = 470)
