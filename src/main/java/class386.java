...
public class class386 extends class109 {
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "([Lqp;)V")
    public class386(class636[] arg0) {
        this.field5150 = arg0;
    }

    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Lqi;I[BI)Lmn;")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Ldn;B)I")
