...
public class class386 extends class213 {
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(ZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(III)V", line = 47)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IILaw;)V", line = 107)
    ...
    @OriginalMember(owner = "client!es", name = "d", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!es", name = "d", descriptor = "(B)Z", line = 130)
    public final boolean method22(byte arg0) {
        ++field5588;
        return arg0 == 75;
    }

    @OriginalMember(owner = "client!es", name = "c", descriptor = "(ZI)V", line = 141)
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(Lsv;)V", line = 175)
    ...
    @OriginalMember(owner = "client!es", name = "e", descriptor = "(I)I", line = 163)
