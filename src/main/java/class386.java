...
public class class386 extends class404 {
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Loa;ZZLoa;IZI)I")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Lqq;I)V")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(ILha;I)V")
