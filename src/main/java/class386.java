...
public abstract class class386 extends class388 {
    ...
    @OriginalMember(owner = "client!ii", name = "d", descriptor = "(B)Z", line = 12)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(IIIIIIBIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(IIIII)V", line = 108)
    ...
    @OriginalMember(owner = "client!ii", name = "e", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!ii", name = "f", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(IILfi;BZLya;I)V", line = 182)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Ljava/awt/Canvas;I)Lkd;", line = 200)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(ZII)V", line = 224)
    ...
    @OriginalMember(owner = "client!ii", name = "d", descriptor = "(I)V", line = 244)
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(IIIIIII)V", line = 255)
