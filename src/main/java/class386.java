...
public class class386 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Lee;IBI)V", line = 41)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(BI)[[I", line = 52)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(I)[[[I", line = 119)
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(III)V", line = 160)
