...
public class class386 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(BLha;)V", line = 6)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Z)V", line = 25)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(B[Ljava/lang/String;)V", line = 49)
