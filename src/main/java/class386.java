...
public abstract class class386 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "([IIBZIIIII[I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IIII)V", line = 107)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lqg;I[IIIIILqg;IZI)V", line = 137)
    ...
    @OriginalMember(owner = "client!ge", name = "f", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ILqg;II[ZLqg;IIILqg;Lqg;ZIII)V", line = 195)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IZLqg;ILqg;IIII)V", line = 251)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IIILip;BII)V", line = 287)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lqg;II)V", line = 366)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ILea;IZZILuf;[IZLea;I[Z)V", line = 411)
