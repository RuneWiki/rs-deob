...
public class class386 extends class233 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!kda", name = "c", descriptor = "(I)Z", line = 16)
    ...
    @OriginalMember(owner = "client!kda", name = "d", descriptor = "(I)Llga;", line = 28)
    ...
    @OriginalMember(owner = "client!kda", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 40)
    ...
    @OriginalMember(owner = "client!kda", name = "d", descriptor = "(B)V", line = 53)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!kda", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 92)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        this.method2413((byte) -83, arg0.getX(), arg0.getY());
        field5400++;
    }

    @OriginalMember(owner = "client!kda", name = "c", descriptor = "(B)Z", line = 104)
    ...
    @OriginalMember(owner = "client!kda", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 114)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(I)Z", line = 145)
    ...
    @OriginalMember(owner = "client!kda", name = "g", descriptor = "(I)V", line = 157)
    public static void method2412(int arg0) {
        field5398 = null;
        int var1 = 43 % ((arg0 - 35) / 42);
    }

    @OriginalMember(owner = "client!kda", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 167)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.method2413((byte) -83, arg0.getX(), arg0.getY());
        field5407++;
    }

    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(BII)V", line = 179)
    ...
    @OriginalMember(owner = "client!kda", name = "b", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!kda", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 218)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method2413((byte) -83, arg0.getX(), arg0.getY());
        field5414++;
    }

    @OriginalMember(owner = "client!kda", name = "f", descriptor = "(I)I", line = 227)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(BLjava/awt/Component;)V", line = 242)
    ...
    @OriginalMember(owner = "client!kda", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 260)
    ...
    @OriginalMember(owner = "client!kda", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 371)
    public class386(Component arg0, boolean arg1) {
        this.method2414((byte) -88, arg0);
        this.field5421 = arg1;
    }

    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;I)I", line = 301)
    ...
    @OriginalMember(owner = "client!kda", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 336)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        field5401++;
        this.method2413((byte) -83, arg0.getX(), arg0.getY());
    }

    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(IIIII)V", line = 348)
