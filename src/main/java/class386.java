...
public class class386 extends class346 {
    ...
    @OriginalMember(owner = "client!cw", name = "d", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!cw", name = "c", descriptor = "(II)V", line = 18)
    ...
    @OriginalMember(owner = "client!cw", name = "<init>", descriptor = "(Lgk;IIII[I)V", line = 37)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(III)Z", line = 52)
    ...
    @OriginalMember(owner = "client!cw", name = "<init>", descriptor = "(Lgk;IIIII[BI)V", line = 67)
    ...
    @OriginalMember(owner = "client!cw", name = "<init>", descriptor = "(Lgk;IIIIZ[BI)V", line = 81)
    ...
    @OriginalMember(owner = "client!cw", name = "<init>", descriptor = "(Lgk;IIIIIIZ)V", line = 103)
    ...
    @OriginalMember(owner = "client!cw", name = "<init>", descriptor = "(Lgk;IIIZ[I)V", line = 120)
    ...
    @OriginalMember(owner = "client!cw", name = "<init>", descriptor = "(Lgk;IIIIIZ)V", line = 141)
