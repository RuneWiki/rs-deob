...
public class class386 extends class265 implements class184 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IIBLps;)V")
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IILjaclib/memory/Source;I)Z")
    ...
    @OriginalMember(owner = "client!ol", name = "<init>", descriptor = "(Lkd;Z)V")
    public class386(class700 arg0, boolean arg1) {
        super(arg0, 34962, arg1);
    }

    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(III)Lpo;")
