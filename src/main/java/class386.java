...
public class class386 implements Runnable {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Lpe;B)V", line = 889)
    ...
    @OriginalMember(owner = "client!el", name = "run", descriptor = "()V", line = 903)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Ljava/lang/String;I)Lvn;", line = 945)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(B)V", line = 967)
    ...
    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "()V", line = 1020)
    public class386() {
        this.field5609.setDaemon(true);
        this.field5609.start();
    }

    @OriginalMember(owner = "client!el", name = "b", descriptor = "(I)V", line = 990)
