...
public abstract class class386 extends class499 {
    ...
    @OriginalMember(owner = "client!lq", name = "c", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(BII)V", line = 23)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Z)V", line = 56)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IIIIIBI)V", line = 75)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IBI)I", line = 109)
