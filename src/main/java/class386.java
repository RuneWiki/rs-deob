...
public class class386 extends class19 {
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lwr;B)V")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lwr;I)V")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(ILwr;)V")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(FIZLij;B)V")
