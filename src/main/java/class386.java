...
public class class386 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(I)Lwe;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lcu;II)V")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lqa;Lbu;I)V")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lmq;B)Z")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(ILcu;)V")
