...
public class class386 extends class20 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Ltc;Z)V")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ILoa;)V")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(BLpw;)I")
    ...
    @OriginalMember(owner = "client!kp", name = "d", descriptor = "(III)Ltc;")
