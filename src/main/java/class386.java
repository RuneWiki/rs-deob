...
public abstract class class386 implements class697 {
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(B)Z", line = 23)
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(ZI)V", line = 56)
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!ep", name = "c", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(II)V", line = 143)
    ...
    @OriginalMember(owner = "client!ep", name = "d", descriptor = "(I)V", line = 161)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(BLri;)V", line = 181)
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(II)V", line = 205)
    ...
    @OriginalMember(owner = "client!ep", name = "finalize", descriptor = "()V", line = 260)
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(B)I", line = 270)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Z)I", line = 282)
    ...
    @OriginalMember(owner = "client!ep", name = "<init>", descriptor = "(Ler;IIIZ)V", line = 297)
