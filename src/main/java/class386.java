...
public class class386 extends class638 {
    ...
    @OriginalMember(owner = "client!cg", name = "b", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "(Lha;Lou;Lem;J)V", line = 399)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Lha;IJ)V", line = 62)
    ...
    @OriginalMember(owner = "client!cg", name = "c", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(ZZLha;JI)V", line = 124)
