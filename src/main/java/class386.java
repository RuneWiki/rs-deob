...
public class class386 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lmg;JI)V", line = 11)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ZLgn;)V", line = 53)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ZJ)Lmg;", line = 68)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "(I)V", line = 117)
