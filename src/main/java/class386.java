...
public class class386 extends class292 {
    ...
    @OriginalMember(owner = "client!gh", name = "f", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IBB)V", line = 21)
    ...
    @OriginalMember(owner = "client!gh", name = "g", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "()V", line = 57)
    public class386() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(BIII)[B", line = 63)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Lqn;Lya;B)V", line = 78)
