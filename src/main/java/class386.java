...
public class class386 extends class169 implements class401 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILya;II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(Lya;Lpf;IIIIZIIIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(BLya;)V", line = 48)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IILya;)Lt;", line = 75)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lya;B)V", line = 110)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(B)I", line = 143)
    ...
    @OriginalMember(owner = "client!bi", name = "g", descriptor = "(I)V", line = 158)
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(Lya;I)Lmo;", line = 171)
    ...
    @OriginalMember(owner = "client!bi", name = "c", descriptor = "(B)I", line = 196)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lya;I)V", line = 207)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ZBLya;I)Lro;", line = 217)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Z)Z", line = 248)
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(I)I", line = 262)
    public final int method240(int arg0) {
        ++field5816;
        return arg0 != -15578 ? 14 : this.field5825 & 65535;
    }

    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(I)I", line = 274)
    public final int method223(int arg0) {
        ++field5804;
        return arg0 != -19634 ? 12 : this.field5824;
    }

    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILya;I)Lt;", line = 285)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IIB)I", line = 295)
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(Z)V", line = 310)
