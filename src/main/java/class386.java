...
public class class386 extends class232 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ILdg;)V")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lsa;IIZF)V")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ILgba;)V")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Ldg;Z)V")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Ldg;B)V")
