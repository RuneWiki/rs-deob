...
public class class435 extends class649 implements class624 {
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(Lha;IIB)Z")
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(ZLha;)V")
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(Lkf;Lha;IIIZI)V")
    ...
    @OriginalMember(owner = "client!uba", name = "i", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!uba", name = "<init>", descriptor = "(Lha;Lqfa;IIIIIZIII)V")
    ...
    @OriginalMember(owner = "client!uba", name = "b", descriptor = "(ILha;)Lww;")
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(BLbk;)V")
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(BLha;)Lck;")
