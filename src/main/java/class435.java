...
public class class435 extends class218 {
    ...
    @OriginalMember(owner = "client!ve", name = "c", descriptor = "(I)[Lsi;")
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lwm;BI)V")
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "([ILwm;IZII)V")
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "()Lho;")
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "()Lho;")
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(Lwo;)V")
