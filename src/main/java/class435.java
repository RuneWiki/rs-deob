...
public class class435 extends class359 {
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lra;I)V", line = 19)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(BI)I", line = 40)
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(II)V", line = 486)
    public class435(int arg0, int arg1) {
        this.field6374 = arg0;
        this.field6381 = arg1;
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IIII)I", line = 501)
