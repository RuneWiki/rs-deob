...
public class class435 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IIIIIIIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lps;B)V", line = 54)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(ILps;I)V", line = 86)
    ...
    @OriginalMember(owner = "client!uk", name = "b", descriptor = "(I)V", line = 321)
