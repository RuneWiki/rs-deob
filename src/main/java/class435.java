...
public abstract class class435 extends class96 {
    ...
    @OriginalMember(owner = "client!or", name = "c", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "([[[Lhg;I)V", line = 26)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ZI)V", line = 99)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IZII)V", line = 144)
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(I)V", line = 174)
