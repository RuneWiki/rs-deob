...
public class class435 {
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIIIIIIIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIII)Z", line = 47)
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 76)
