...
public class class435 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Luo;Ljava/lang/String;[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Luo;Ljava/lang/String;IIIZ)V")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Luo;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
    ...
    @OriginalMember(owner = "client!bo", name = "<init>", descriptor = "(Luo;IZLjava/awt/Component;)V")
