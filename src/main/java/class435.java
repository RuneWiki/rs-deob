...
public class class435 extends class649 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!fg", name = "c", descriptor = "(I)I", line = 15)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(B)V", line = 27)
    public static void method2690(byte arg0) {
        int var1 = 124 / ((arg0 - -29) / 47);
        field6353 = null;
    }

    @OriginalMember(owner = "client!fg", name = "d", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(II)I", line = 65)
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "(ILhs;)V", line = 83)
    public class435(int arg0, class358 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(II)V", line = 86)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(I)I", line = 103)
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "(Lhs;)V", line = 114)
