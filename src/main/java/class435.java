...
public class class435 extends class501 implements class161 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Lza;IZ)Le;")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Lza;IIILps;IZ)V")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ILza;)V")
    ...
    @OriginalMember(owner = "client!tl", name = "<init>", descriptor = "(IIIIILem;)V")
    ...
    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(ILza;)Lhp;")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Lza;B)V")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Lza;III)Z")
