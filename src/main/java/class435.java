...
public class class435 implements class160 {
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(I[I)V", line = 9)
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(IB)V", line = 40)
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "()V", line = 188)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(II)I", line = 65)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(III)V", line = 99)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(ILjava/awt/Component;ZB)V", line = 120)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IB)V", line = 158)
