...
public class class435 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "(Lih;J[Lkt;)V", line = 43)
    public class435(class503 arg0, long arg1, class110[] arg2) {
        this.field6111 = arg1;
        this.field6114 = arg0;
    }

    @OriginalMember(owner = "client!re", name = "finalize", descriptor = "()V", line = 55)
