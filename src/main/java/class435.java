...
public class class435 extends class306 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "([B[IIIIIIIIIIILta;II)V", line = 7)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(CIIIZLta;II)V", line = 92)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "([B[I[IIIIIIIIIIILta;II)V", line = 159)
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(Lms;Lkt;[Lau;[I[I)V", line = 246)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "([B[IIIIIIII)V", line = 269)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "([B[I[IIIIIII)V", line = 327)
    ...
    @OriginalMember(owner = "client!gr", name = "B", descriptor = "(CIIIZ)V", line = 385)
