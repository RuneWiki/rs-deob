...
public class class435 {
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(II)Lgd;")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Lgd;I)V")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Lha;IIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(Lgd;)V")
