...
public class class435 extends class464 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;Z)V", line = 12)
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(I)Liia;", line = 82)
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 93)
    public class435(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!et", name = "e", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(III)Lfa;", line = 116)
    ...
    @OriginalMember(owner = "client!et", name = "f", descriptor = "(I)D", line = 127)
    ...
    @OriginalMember(owner = "client!et", name = "g", descriptor = "(I)I", line = 160)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(I)V", line = 171)
