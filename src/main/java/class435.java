...
public class class435 {
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(III)Z", line = 36)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!te", name = "<init>", descriptor = "(I)V", line = 67)
