...
public class class435 {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(ZILaba;II[Lpba;Loa;Lnaa;ILdv;Ldv;Luc;Lvd;IILfaa;ILgr;I)Lba;")
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(ILuc;IIILoa;IIILdv;Lnaa;I)Lba;")
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IILfaa;I)V")
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(ILoa;ILaba;ILuc;Lvd;ILdv;Lnaa;Lfaa;I)Lba;")
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(ILnaa;II)V")
