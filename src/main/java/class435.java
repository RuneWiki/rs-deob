...
public class class435 extends class518 implements class83 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ILr;ILcaa;ZII)V", line = 3)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Lr;I)Lhr;", line = 23)
    ...
    @OriginalMember(owner = "client!di", name = "c", descriptor = "(I)Z", line = 53)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ZILr;I)Ldg;", line = 64)
    ...
    @OriginalMember(owner = "client!di", name = "b", descriptor = "(Lr;I)V", line = 96)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Lr;II)Lda;", line = 107)
    ...
    @OriginalMember(owner = "client!di", name = "c", descriptor = "(Lr;I)Lifa;", line = 128)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(III)V", line = 143)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Lr;Z)V", line = 210)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(B)I", line = 239)
    ...
    @OriginalMember(owner = "client!di", name = "d", descriptor = "(B)V", line = 252)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(BLr;)V", line = 266)
    ...
    @OriginalMember(owner = "client!di", name = "b", descriptor = "(Z)I", line = 294)
    ...
    @OriginalMember(owner = "client!di", name = "d", descriptor = "(Z)Z", line = 307)
    ...
    @OriginalMember(owner = "client!di", name = "h", descriptor = "(I)Z", line = 318)
    public final boolean method270(int arg0) {
        ++field6305;
        return arg0 <= -42;
    }

    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IIZLr;)Z", line = 330)
    ...
    @OriginalMember(owner = "client!di", name = "f", descriptor = "(I)I", line = 356)
    ...
    @OriginalMember(owner = "client!di", name = "b", descriptor = "(B)I", line = 367)
    public final int method277(byte arg0) {
        ++field6310;
        return arg0 != 95 ? 72 : this.field6296 & 65535;
    }

    @OriginalMember(owner = "client!di", name = "b", descriptor = "(I)I", line = 382)
    ...
    @OriginalMember(owner = "client!di", name = "e", descriptor = "(I)Z", line = 397)
    ...
    @OriginalMember(owner = "client!di", name = "<init>", descriptor = "(Lr;Llt;IIIIIZIZ)V", line = 413)
