...
public class class435 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lup;IIIII)V")
    ...
    @OriginalMember(owner = "client!nl", name = "i", descriptor = "(I)[Ljd;")
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(Lbb;ZI)V")
