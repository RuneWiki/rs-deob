...
public class class435 {
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "()V", line = 174)
    public static final void method2698() {
        class434.method2695(1, class388.field5464);
    }

    @OriginalMember(owner = "client!ah", name = "c", descriptor = "(I)V", line = 180)
