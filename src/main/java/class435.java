...
public class class435 extends class291 {
    ...
    @OriginalMember(owner = "client!mha", name = "b", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!mha", name = "b", descriptor = "(Z)I", line = 193)
    ...
    @OriginalMember(owner = "client!mha", name = "c", descriptor = "(Z)I", line = 210)
    ...
    @OriginalMember(owner = "client!mha", name = "d", descriptor = "(Z)V", line = 221)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(I)V", line = 265)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(Z)Lwk;", line = 285)
    ...
    @OriginalMember(owner = "client!mha", name = "b", descriptor = "(BI)I", line = 389)
    ...
    @OriginalMember(owner = "client!mha", name = "b", descriptor = "(I)V", line = 411)
    ...
    @OriginalMember(owner = "client!mha", name = "<init>", descriptor = "(ILnaa;Lnaa;Lff;Lcr;I[BIZ)V", line = 844)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(IB)[B", line = 439)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(BI)V", line = 458)
    ...
    @OriginalMember(owner = "client!mha", name = "c", descriptor = "(B)I", line = 486)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(ZII)Luc;", line = 510)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(IZ)Ljava/lang/String;", line = 772)
    ...
    @OriginalMember(owner = "client!mha", name = "d", descriptor = "(B)I", line = 805)
