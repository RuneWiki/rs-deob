...
public class class435 {
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(BIII)I", line = 4)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "([BB)V", line = 30)
    ...
    @OriginalMember(owner = "client!mha", name = "<init>", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!mha", name = "<init>", descriptor = "(IIIIII)V", line = 140)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(I)Lmha;", line = 119)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(IIIIIII)V", line = 153)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(ILmha;)V", line = 205)
