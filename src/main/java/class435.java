...
public class class435 extends class148 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(ILdh;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(III)Z", line = 60)
    ...
    @OriginalMember(owner = "client!a", name = "e", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(ZI)[[I", line = 84)
    ...
    @OriginalMember(owner = "client!a", name = "<init>", descriptor = "()V", line = 131)
    public class435() {
        super(1, false);
    }

    @OriginalMember(owner = "client!a", name = "b", descriptor = "(IIIIII)V", line = 137)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(II)[I", line = 159)
