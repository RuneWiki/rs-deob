...
public class class435 extends class444 {
    ...
    @OriginalMember(owner = "client!bo", name = "c", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Lhl;BZ)V", line = 21)
    ...
    @OriginalMember(owner = "client!bo", name = "c", descriptor = "(Z)I", line = 327)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "()V", line = 343)
    ...
    @OriginalMember(owner = "client!bo", name = "b", descriptor = "(I)[B", line = 369)
