...
public class class435 implements class264 {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(ILal;)V", line = 3)
    public final void method2561(int arg0, class58 arg1) {
        this.method2564(arg0, arg1, 0);
    }

    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(ILqd;II)V", line = 7)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(ILal;I)V", line = 36)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(ILpq;)V", line = 107)
    ...
    @OriginalMember(owner = "client!ua", name = "<init>", descriptor = "(Lbf;)V", line = 131)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(ILqd;I)V", line = 140)
