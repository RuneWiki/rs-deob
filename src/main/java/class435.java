...
public class class435 {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ILuu;)V")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Lps;I)V")
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(I)Lps;")
