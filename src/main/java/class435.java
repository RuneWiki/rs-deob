...
public class class435 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(ILdp;Z)Lmi;")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lvj;ILjava/lang/String;I)Lue;")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
