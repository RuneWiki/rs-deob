...
public class class435 extends class82 {
    ...
    @OriginalMember(owner = "client!uca", name = "b", descriptor = "(II)[[I", line = 6)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(BI)V", line = 44)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Let;B)V", line = 56)
    ...
    @OriginalMember(owner = "client!uca", name = "<init>", descriptor = "()V", line = 87)
    public class435() {
        super(1, false);
    }

    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 95)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(B)V", line = 107)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(IIB)V", line = 117)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(IILos;)V", line = 190)
    ...
    @OriginalMember(owner = "client!uca", name = "c", descriptor = "(II)[I", line = 207)
