...
public class class435 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IIIBIIIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lpc;Z)V", line = 68)
