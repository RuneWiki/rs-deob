...
public class class435 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Ljava/lang/String;ZI)V", line = 9)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lpt;Luaa;)V", line = 85)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(I)V", line = 1196)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ZI)V", line = 1274)
