...
public class class435 extends class218 implements class518 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IILza;IILvl;Z)V")
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(IIIIILhc;)V")
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Lza;III)Z")
    public final boolean method27(class491 arg0, int arg1, int arg2, int arg3) {
        field6503++;
        return arg1 <= 121;
    }

    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ILza;)V")
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ILza;I)Le;")
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(ILza;)Lsr;")
