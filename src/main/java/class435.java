...
public class class435 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(BLfaa;)V", line = 3)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(ILgw;)V", line = 38)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Lgw;II)V", line = 74)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(BLbn;)V", line = 92)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(B)V", line = 736)
