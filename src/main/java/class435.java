...
public class class435 implements Runnable {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IIIIIBII)V", line = 17)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(ZIII)I", line = 32)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(ILda;)V", line = 72)
    public static final void method2717(int arg0, class193 arg1) {
        class266.field3950[arg0] = arg1;
    }

    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(ILob;)V", line = 78)
    ...
    @OriginalMember(owner = "client!kn", name = "run", descriptor = "()V", line = 96)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IZIIII)V", line = 136)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(ILjava/lang/String;)Loh;", line = 285)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IIII)V", line = 307)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(I)V", line = 332)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IBIII)V", line = 352)
    ...
    @OriginalMember(owner = "client!kn", name = "b", descriptor = "(I)V", line = 374)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Ltj;IIILbd;Lw;)Z", line = 391)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "()V", line = 609)
    public class435() {
