...
public class class435 implements Runnable {
    ...
    @OriginalMember(owner = "client!maa", name = "run", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(IB)C", line = 56)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(I)Z", line = 85)
    ...
    @OriginalMember(owner = "client!maa", name = "b", descriptor = "(IB)I", line = 127)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(II)Lbm;", line = 138)
