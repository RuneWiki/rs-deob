...
public class class435 extends class261 {
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(Lig;)V", line = 49)
    public class435(class163 arg0) {
        this.field6471 = arg0;
    }

    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(II)Ltc;", line = 60)
