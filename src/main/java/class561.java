...
public class class561 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(III)Z", line = 18)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(I)V", line = 123)
