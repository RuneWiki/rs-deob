...
public class class561 extends class744 implements class722 {
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ILha;BI)Z")
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IIZLha;)Lsfa;")
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(Lha;I)Lbd;")
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(BLha;)Loia;")
    ...
    @OriginalMember(owner = "client!tv", name = "<init>", descriptor = "(Lha;Lvha;IIIIIZIIII)V")
    ...
    @OriginalMember(owner = "client!tv", name = "c", descriptor = "(Lha;I)V")
    public final void method136(class60 arg0, int arg1) {
        int var3 = 14 / ((arg1 - 53) / 46);
        ++field7948;
    }

    @OriginalMember(owner = "client!tv", name = "j", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Ljga;ZI)V")
