...
public abstract class class561 implements class100 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lig;III)V", line = 7)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ZZ)V", line = 72)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(I)Z", line = 91)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IIII)I", line = 113)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Lwu;Lwu;Lwia;)V", line = 136)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Z)I", line = 146)
