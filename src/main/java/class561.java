...
public class class561 extends class321 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(BI)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!si", name = "d", descriptor = "(III)B", line = 51)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ILjava/lang/String;)I", line = 77)
