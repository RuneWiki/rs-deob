...
public class class561 {
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lhr;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lrg;IIILrg;IIZII)V", line = 49)
