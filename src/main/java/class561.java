...
public class class561 extends class344 {
    ...
    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(Lvf;)V")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Lgb;II)V")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(BLha;)V")
