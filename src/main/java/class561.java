...
public class class561 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(I)I", line = 45)
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 63)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(II)I", line = 91)
