...
public abstract class class561 implements class60 {
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Ljd;Ljd;B)V")
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Lqq;I)V")
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "(Lqba;ILjt;Llc;IZ)V")
