...
public class class561 extends class155 {
    ...
    @OriginalMember(owner = "client!tp", name = "g", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ZZ)V", line = 17)
    ...
    @OriginalMember(owner = "client!tp", name = "b", descriptor = "(I)Z", line = 28)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Lbr;II)V", line = 38)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IZ)V", line = 48)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IIB)V", line = 64)
    ...
    @OriginalMember(owner = "client!tp", name = "e", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(Loia;Lgj;Luw;)V", line = 109)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IB)V", line = 125)
