...
public class class561 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ILdba;)V")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Ldba;I)Z")
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lml;)V")
