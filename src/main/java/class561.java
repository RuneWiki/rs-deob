...
public class class561 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 33)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(BIIIII)V", line = 99)
