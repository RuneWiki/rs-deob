...
public class class561 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(BLjava/lang/String;Lji;)I")
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IIIIIBILd;Lsa;IILd;Loa;Z)Lba;")
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IIBILd;IILsa;Ld;IIZLoa;)Lba;")
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IZLji;)V")
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IIIILsa;Loa;I)Lba;")
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Lji;B)V")
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IILsa;IILoa;B)Lba;")
