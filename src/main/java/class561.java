...
public class class561 extends class344 {
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Ljava/awt/Canvas;B)Ljava/lang/Object;", line = 4)
    ...
    @OriginalMember(owner = "client!eda", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/tc;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Laca;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Lfa;Ltf;I)V", line = 13)
    ...
    @OriginalMember(owner = "client!eda", name = "h", descriptor = "(IIII)[I", line = 56)
    ...
    @OriginalMember(owner = "client!eda", name = "p", descriptor = "()Laj;", line = 96)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(BLbs;)I", line = 104)
    ...
    @OriginalMember(owner = "client!eda", name = "i", descriptor = "(Z)V", line = 137)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IZ[[IB)Lica;", line = 155)
    ...
    @OriginalMember(owner = "client!eda", name = "u", descriptor = "(I)V", line = 166)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IZZZLgb;)V", line = 193)
    ...
    @OriginalMember(owner = "client!eda", name = "v", descriptor = "(I)V", line = 229)
    ...
    @OriginalMember(owner = "client!eda", name = "c", descriptor = "(Z)V", line = 267)
    ...
    @OriginalMember(owner = "client!eda", name = "l", descriptor = "()V", line = 277)
    ...
    @OriginalMember(owner = "client!eda", name = "T", descriptor = "(I)V", line = 303)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Lsu;II)V", line = 334)
    ...
    @OriginalMember(owner = "client!eda", name = "k", descriptor = "(I)V", line = 346)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IBI[BILsq;)Ln;", line = 356)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(FFF)V", line = 365)
    public final void method975(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!eda", name = "q", descriptor = "(B)V", line = 368)
    ...
    @OriginalMember(owner = "client!eda", name = "d", descriptor = "(Z)V", line = 381)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Ldj;I)I", line = 417)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Lal;B)V", line = 437)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IB)Lnm;", line = 460)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Ldh;B)V", line = 506)
    ...
    @OriginalMember(owner = "client!eda", name = "u", descriptor = "()V", line = 527)
    public final void method967() {
    }

    @OriginalMember(owner = "client!eda", name = "DA", descriptor = "()I", line = 530)
    public final int method1021() {
        return 0;
    }

    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Lgb;Z)I", line = 539)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IZ)Lmda;", line = 568)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(ILtw;)V", line = 581)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(BLsea;)I", line = 602)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Lbs;IZI)V", line = 635)
    ...
    @OriginalMember(owner = "client!eda", name = "e", descriptor = "()Z", line = 646)
    public final boolean method1044() {
        return false;
    }

    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IIILrt;Lsq;)Lpm;", line = 654)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Lrt;Lsq;B)Z", line = 663)
    ...
    @OriginalMember(owner = "client!eda", name = "d", descriptor = "()V", line = 676)
    public final void method1011() {
    }

    @OriginalMember(owner = "client!eda", name = "f", descriptor = "(II)V", line = 679)
    ...
    @OriginalMember(owner = "client!eda", name = "gb", descriptor = "(I)Z", line = 691)
    ...
    @OriginalMember(owner = "client!eda", name = "s", descriptor = "(I)V", line = 730)
    ...
    @OriginalMember(owner = "client!eda", name = "l", descriptor = "(Z)V", line = 751)
    ...
    @OriginalMember(owner = "client!eda", name = "g", descriptor = "()V", line = 764)
    public final void method1045() {
    }

    @OriginalMember(owner = "client!eda", name = "m", descriptor = "(B)V", line = 767)
    ...
    @OriginalMember(owner = "client!eda", name = "x", descriptor = "()V", line = 777)
    public final void method1049() {
    }

    @OriginalMember(owner = "client!eda", name = "f", descriptor = "()Z", line = 780)
    public final boolean method977() {
        return false;
    }

    @OriginalMember(owner = "client!eda", name = "a", descriptor = "([BIZIIILsq;I)Lpm;", line = 787)
    ...
    @OriginalMember(owner = "client!eda", name = "r", descriptor = "(B)V", line = 797)
    ...
    @OriginalMember(owner = "client!eda", name = "e", descriptor = "(I)V", line = 835)
    public final synchronized void method948(int arg0) {
        this.field8018.method3488(-21326);
        super.method948(arg0);
    }

    @OriginalMember(owner = "client!eda", name = "ja", descriptor = "(I)V", line = 843)
    public final void method1002(int arg0) {
        this.field8021.Clear(1, arg0, 0.0F, 0);
    }

    @OriginalMember(owner = "client!eda", name = "h", descriptor = "(Z)V", line = 850)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Lsq;ZLrt;)I", line = 862)
    ...
    @OriginalMember(owner = "client!eda", name = "b", descriptor = "(ZB)V", line = 902)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IILsq;IZII[F)Lpm;", line = 912)
    ...
    @OriginalMember(owner = "client!eda", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Lfa;Ltf;Ljava/lang/Integer;)Lr;", line = 923)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Lgb;IIZ)V", line = 1034)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(ILkfa;)V", line = 1069)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(ILrt;Lsq;)Z", line = 1109)
    ...
    @OriginalMember(owner = "client!eda", name = "b", descriptor = "(Z)V", line = 1120)
    public final void method954(boolean arg0) {
    }

    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(ZI)Lsu;", line = 1123)
    public final class155 method1283(boolean arg0, int arg1) {
        return arg1 == -1 ? new class67(this, arg0) : (class155) null;
    }

    @OriginalMember(owner = "client!eda", name = "f", descriptor = "(Z)V", line = 1134)
    ...
    @OriginalMember(owner = "client!eda", name = "ab", descriptor = "(I)V", line = 1148)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Lnd;I)I", line = 1158)
    ...
    @OriginalMember(owner = "client!eda", name = "o", descriptor = "(B)V", line = 1188)
    public final void method1318(byte arg0) {
        this.field8021.method2521(174, this.field4637);
        int var2 = -28 % ((-arg0 - 3) / 37);
    }

    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(ZLada;)V", line = 1199)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IIIZLbs;Lmda;I)V", line = 1213)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Llj;Llj;FLlj;)Llj;", line = 1230)
    public final class60 method959(class60 arg0, class60 arg1, float arg2, class60 arg3) {
        return (arg2 < 0.5F) ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!eda", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 1238)
    public final void method958(Rectangle[] arg0, int arg1) throws class20 {
        this.method979();
    }

    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IIII)V", line = 1244)
    public final void method976(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(ILjagdx/D3DPRESENT_PARAMETERS;ILjagdx/IDirect3D;II)Z", line = 1249)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(I[Luaa;)Lada;", line = 1354)
    public final class278 method1279(int arg0, class436[] arg1) {
        int var3 = 100 % ((22 - arg0) / 63);
        return new dxVertexLayout(this, arg1);
    }

    @OriginalMember(owner = "client!eda", name = "g", descriptor = "(Z)V", line = 1362)
    ...
    @OriginalMember(owner = "client!eda", name = "A", descriptor = "()V", line = 1375)
    ...
    @OriginalMember(owner = "client!eda", name = "A", descriptor = "(I)V", line = 1398)
    ...
    @OriginalMember(owner = "client!eda", name = "B", descriptor = "(I)V", line = 1407)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(ILjava/awt/Canvas;Ljava/lang/Object;)V", line = 1418)
    ...
    @OriginalMember(owner = "client!eda", name = "ya", descriptor = "()V", line = 1427)
    public final void method969() {
        this.method2029(7, true);
        this.field8021.Clear(2, 0, 1.0F, 0);
    }

    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Lf;Z)V", line = 1435)
    public final void method990(class534 arg0, boolean arg1) {
    }

    @OriginalMember(owner = "client!eda", name = "l", descriptor = "(B)V", line = 1439)
    ...
    @OriginalMember(owner = "client!eda", name = "y", descriptor = "(I)V", line = 1450)
    ...
    @OriginalMember(owner = "client!eda", name = "x", descriptor = "(I)V", line = 1468)
    public final void method1297(int arg0) {
        this.field8021.method2521(27, this.field4530);
        int var2 = 38 % ((arg0 - 53) / 38);
    }

    @OriginalMember(owner = "client!eda", name = "J", descriptor = "(I)V", line = 1477)
    ...
    @OriginalMember(owner = "client!eda", name = "M", descriptor = "(I)V", line = 1515)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(BZIII[II)Lpm;", line = 1534)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Ljava/awt/Canvas;Ljava/lang/Object;Z)V", line = 1544)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "()V", line = 1554)
    public final void method1029() {
        this.field8018.method3487(true);
        super.method1029();
    }

    @OriginalMember(owner = "client!eda", name = "n", descriptor = "(I)V", line = 1565)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(ZLjava/awt/Canvas;Ljava/lang/Object;)V", line = 1576)
    ...
    @OriginalMember(owner = "client!eda", name = "X", descriptor = "(I)V", line = 1602)
    ...
    @OriginalMember(owner = "client!eda", name = "q", descriptor = "(I)F", line = 1612)
    ...
    @OriginalMember(owner = "client!eda", name = "Y", descriptor = "(I)V", line = 1625)
