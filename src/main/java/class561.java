...
public class class561 extends class31 implements class460 {
    ...
    @OriginalMember(owner = "client!via", name = "<init>", descriptor = "(Lhl;IZ[[I)V")
    ...
    @OriginalMember(owner = "client!via", name = "b", descriptor = "(Z)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(Lqo;I)V")
