...
public class class561 extends class277 {
    ...
    @OriginalMember(owner = "client!lu", name = "b", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!lu", name = "d", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!lu", name = "<init>", descriptor = "(Lqj;Lpea;)V", line = 51)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IZ)V", line = 116)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(II[BBILjava/lang/String;)I", line = 128)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IILr;)V", line = 267)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IILrg;)V", line = 372)
    ...
    @OriginalMember(owner = "client!lu", name = "b", descriptor = "(IZ)V", line = 385)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IIIIIZ)V", line = 430)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(B)Z", line = 534)
    public final boolean method284(byte arg0) {
        ++field7806;
        return arg0 < -93;
    }

    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IIILvda;)J", line = 547)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(III)V", line = 572)
