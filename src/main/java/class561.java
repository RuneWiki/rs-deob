...
public class class561 {
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(I)Loia;")
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "([JI[Ljava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(ILdc;)V")
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(ILdc;I)V")
