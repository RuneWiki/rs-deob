...
public class class561 extends class530 {
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(IIIIIF)V", line = 3)
    public class561(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!iq", name = "h", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(BF)V", line = 18)
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(III)Z", line = 30)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "([BZI)V", line = 40)
    ...
    @OriginalMember(owner = "client!iq", name = "i", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IIIZ)V", line = 106)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "([BIB)[B", line = 120)
    ...
    @OriginalMember(owner = "client!iq", name = "j", descriptor = "(I)V", line = 134)
