...
public class class561 {
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(I)[Lnaa;", line = 3)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!jaa", name = "<init>", descriptor = "(BIIIII)V", line = 37)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(Z)Z", line = 54)
