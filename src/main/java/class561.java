...
public class class561 extends class267 implements class65 {
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IC)C", line = 17)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Ltm;Lg;III[B)V", line = 428)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(B)V", line = 445)
