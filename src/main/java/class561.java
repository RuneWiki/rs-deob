...
public class class561 {
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(IIIIIIIIIILiaa;I)Z", line = 16)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(B)V", line = 449)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(ILoa;IIILlt;)V", line = 463)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(I)Lrv;", line = 529)
