...
public class class561 extends class335 {
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(ILio;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "()V", line = 48)
    public class561() {
        super(1, false);
    }

    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(ILr;I)Laga;", line = 54)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IZ)[[I", line = 77)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IILio;)Ljava/lang/String;", line = 209)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(ZI)[I", line = 239)
