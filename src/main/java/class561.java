...
public class class561 extends class451 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lha;I)Lie;", line = 6)
    ...
    @OriginalMember(owner = "client!ar", name = "c", descriptor = "(B)Z", line = 52)
    ...
    @OriginalMember(owner = "client!ar", name = "e", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ZILmb;Lha;III)V", line = 75)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(II)V", line = 86)
    ...
    @OriginalMember(owner = "client!ar", name = "finalize", descriptor = "()V", line = 117)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 179)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ILha;IB)Lka;", line = 138)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(Lha;B)Lufa;", line = 154)
    public final class152 method520(class454 arg0, byte arg1) {
        ++field7831;
        return arg1 <= 114 ? null : null;
    }

    @OriginalMember(owner = "client!ar", name = "f", descriptor = "(B)Z", line = 166)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IIBLha;)Z", line = 204)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lka;Lwc;ILha;)V", line = 222)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(I)V", line = 250)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ZLha;)V", line = 265)
    ...
    @OriginalMember(owner = "client!ar", name = "e", descriptor = "(B)I", line = 291)
    ...
    @OriginalMember(owner = "client!ar", name = "f", descriptor = "(I)I", line = 306)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(B)Lida;", line = 317)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(B)V", line = 332)
    ...
    @OriginalMember(owner = "client!ar", name = "d", descriptor = "(B)Z", line = 362)
