...
public class class561 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!bf", name = "b", descriptor = "(B)Lgn;", line = 34)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(I)V", line = 92)
