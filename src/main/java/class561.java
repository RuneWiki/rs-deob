...
public class class561 extends class356 implements class57 {
    ...
    @OriginalMember(owner = "client!lca", name = "<init>", descriptor = "(IIIIILmf;)V")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(Loa;B)Laca;")
    public final class630 method88(class605 arg0, byte arg1) {
        field8001++;
        return arg1 >= -127 ? null : null;
    }

    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(IBIZLeca;)V")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(BLoa;)V")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(ILoa;)V")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(IZLoa;)Lba;")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(IILoa;I)Z")
    ...
    @OriginalMember(owner = "client!lca", name = "b", descriptor = "(Loa;I)Lew;")
