...
public class class561 extends class663 implements class343 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Lcc;[[BB)V")
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "([Lmca;Lsha;I)Ljd;")
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "(Llf;I[BI)V")
