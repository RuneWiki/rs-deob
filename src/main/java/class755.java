...
public class class755 {
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(Lcs;Llga;IIILha;IILii;)V", line = 19)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(IF)F", line = 65)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(B)Lpo;", line = 77)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "()V", line = 90)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(BI)Leca;", line = 166)
    public final class755 method4217(byte arg0, int arg1) {
        field10538++;
        return arg0 < 61 ? null : new class755(this.field10542, arg1);
    }

    @OriginalMember(owner = "client!eca", name = "<init>", descriptor = "(II)V", line = 191)
