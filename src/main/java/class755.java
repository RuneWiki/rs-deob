...
public class class755 extends class423 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(I)Lki;")
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(BLjagtheora/ogg/OggPacket;)V")
    ...
    @OriginalMember(owner = "client!rl", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Lsg;ILha;Lrfa;)V")
