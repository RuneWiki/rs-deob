...
public class class755 {
    ...
    @OriginalMember(owner = "client!lr", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V")
    ...
    @OriginalMember(owner = "client!lr", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V")
    ...
    @OriginalMember(owner = "client!lr", name = "movemouse", descriptor = "(II)V")
