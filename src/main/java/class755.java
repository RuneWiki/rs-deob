...
public class class755 extends class497 {
    ...
    @OriginalMember(owner = "client!bq", name = "b", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(Lpp;)V", line = 28)
    public class755(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bq", name = "b", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!bq", name = "c", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(BI)I", line = 56)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(II)V", line = 69)
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(ILpp;)V", line = 81)
    public class755(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(I)I", line = 85)
