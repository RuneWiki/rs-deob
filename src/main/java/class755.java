...
public class class755 extends class325 {
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "()V", line = 6)
    public class755() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ZIJI)Ljava/lang/String;", line = 9)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(BI)[I", line = 46)
