...
public class class755 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lrv;B)V", line = 9)
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "(Lcb;)V", line = 59)
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "()V", line = 78)
    protected class755() {
