...
public class class755 extends class430 {
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "([BZ)[B", line = 3)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(III)V", line = 66)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(ZBI)V", line = 78)
    ...
    @OriginalMember(owner = "client!rw", name = "c", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!rw", name = "<init>", descriptor = "(IIIIIF)V", line = 121)
    ...
    @OriginalMember(owner = "client!rw", name = "e", descriptor = "(I)V", line = 138)
    ...
    @OriginalMember(owner = "client!rw", name = "c", descriptor = "(Z)V", line = 177)
    ...
    @OriginalMember(owner = "client!rw", name = "b", descriptor = "(III)Z", line = 187)
