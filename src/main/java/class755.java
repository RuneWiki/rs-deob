...
public class class755 extends class111 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;B)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lfq;)V")
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
