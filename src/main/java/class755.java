...
public class class755 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(I)V", line = 21)
    public static void method4095(int arg0) {
        int var1 = 82 / ((arg0 - 78) / 45);
        field10287 = null;
    }

    @OriginalMember(owner = "client!wc", name = "b", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!wc", name = "c", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(III)Z", line = 62)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IC)B", line = 76)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(B)V", line = 202)
    ...
    @OriginalMember(owner = "client!wc", name = "b", descriptor = "(II)Lmm;", line = 219)
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(Lega;ILwm;)V", line = 252)
