...
public class class755 extends class586 {
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(B)Luia;")
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(IIILjava/lang/Class;)Loda;")
    ...
    @OriginalMember(owner = "client!nca", name = "b", descriptor = "(III)Lcu;")
    ...
    @OriginalMember(owner = "client!nca", name = "<init>", descriptor = "(ILnp;Lnp;Lro;Lhfa;I[BIZ)V")
