...
public class class350 extends class535 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(II)[[I", line = 4)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(ILwn;I)V", line = 53)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(III)Z", line = 71)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(II)[I", line = 86)
    ...
    @OriginalMember(owner = "client!mi", name = "<init>", descriptor = "()V", line = 119)
    public class350() {
        super(1, false);
    }

    @OriginalMember(owner = "client!mi", name = "c", descriptor = "(II)V", line = 125)
    ...
    @OriginalMember(owner = "client!mi", name = "c", descriptor = "(I)V", line = 139)
