...
public class class350 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(II)I", line = 29)
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "(I)V", line = 45)
