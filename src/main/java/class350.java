...
public class class350 extends class183 {
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(Z)J", line = 7)
    public final long method1216(boolean arg0) {
        field5179++;
        return arg0 ? -124L : this.field5167;
    }

    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ZILjava/lang/String;)V", line = 19)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(I)I", line = 89)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Z)Z", line = 101)
    public final boolean method1214(boolean arg0) {
        field5166++;
        return arg0 ? this.field5172 : true;
    }

    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(II)Lwg;", line = 114)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(B)I", line = 136)
    ...
    @OriginalMember(owner = "client!ve", name = "d", descriptor = "(I)C", line = 147)
    public final char method1221(int arg0) {
        field5165++;
        return arg0 == 15030 ? this.field5180 : '\u0011';
    }

    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(B)V", line = 160)
