...
public class class350 {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Llc;Z)Lpga;", line = 8)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(JIB)Ljca;", line = 21)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(ILwb;)Z", line = 69)
