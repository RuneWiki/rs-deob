...
public class class350 extends class435 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Lvo;II)Lbl;", line = 7)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "()V", line = 14)
    public final void method2127() {
        this.field4933 = null;
    }

    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(Lek;)V", line = 20)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "()V", line = 501)
