...
public class class350 extends class194 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(ILjava/lang/String;)I", line = 4)
    ...
    @OriginalMember(owner = "client!uh", name = "<init>", descriptor = "()V", line = 17)
    public class350() {
        super(1, false);
    }

    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(II)[I", line = 32)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IIBI)I", line = 67)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(II)[[I", line = 89)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IILbg;)V", line = 141)
    ...
    @OriginalMember(owner = "client!uh", name = "d", descriptor = "(III)I", line = 153)
