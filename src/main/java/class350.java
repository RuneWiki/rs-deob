...
public class class350 extends class116 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IILpa;II)V")
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(I)[Lhh;")
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(FFFFFFLpa;II)V")
    ...
    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "(Lkw;IIZ)V")
    ...
    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "(Lkw;II[III)V")
