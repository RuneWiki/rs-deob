...
public class class350 extends class386 {
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "()V", line = 5)
    public class350() {
        super(0, true);
    }

    @OriginalMember(owner = "client!es", name = "e", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "([[II)V", line = 22)
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(II)[[I", line = 71)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IBLun;)V", line = 132)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(II)[I", line = 208)
