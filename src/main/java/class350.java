...
public class class350 extends class265 implements class122 {
    ...
    @OriginalMember(owner = "client!id", name = "d", descriptor = "(Lq;)V")
    ...
    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "(Ltb;ILjava/nio/ByteBuffer;)V")
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(Lq;)V")
    ...
    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "(Ltb;I[BI)V")
    public class350(class227 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field4809 = arg1;
    }

    @OriginalMember(owner = "client!id", name = "c", descriptor = "(Lq;)V")
