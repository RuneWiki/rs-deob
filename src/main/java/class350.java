...
public class class350 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Lec;Lza;IIIBI)Le;")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Lsv;Z)V")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Lya;IIIIILya;Lza;ILec;IIZ)Le;")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Lec;IIBIIIZLya;IBLya;Lza;I)Le;")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IIILza;Lec;II)Le;")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IBLsv;)V")
