...
public class class350 {
    ...
    @OriginalMember(owner = "client!im", name = "finalize", descriptor = "()V", line = 22)
    ...
    @OriginalMember(owner = "client!im", name = "b", descriptor = "(I)Ljava/io/File;", line = 36)
    public final File method2305(int arg0) {
        return arg0 == -1 ? this.field5081 : null;
    }

    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Z[BII)V", line = 46)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(B)J", line = 66)
    public final long method2307(byte arg0) throws IOException {
        int var2 = 106 % ((arg0 - 39) / 47);
        return this.field5079.length();
    }

    @OriginalMember(owner = "client!im", name = "a", descriptor = "([BIII)I", line = 75)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IJ)V", line = 92)
