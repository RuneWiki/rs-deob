...
public class class350 extends class184 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Liia;ZI)V", line = 15)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IIZ)V", line = 28)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(ZI)V", line = 42)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(I)Z", line = 52)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Loea;)V", line = 65)
    public class350(class594 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Z)V", line = 68)
