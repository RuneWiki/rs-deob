...
public class class350 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Lbd;I)V")
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "([[[Lwq;IIZII)Z")
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Ljava/lang/String;I)V")
