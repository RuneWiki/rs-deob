...
public class class350 {
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(B)I", line = 7)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(IB)V", line = 29)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(IIIIZI)V", line = 41)
    ...
    @OriginalMember(owner = "client!gha", name = "b", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(IIII)Z", line = 84)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(IIIIIII)V", line = 224)
