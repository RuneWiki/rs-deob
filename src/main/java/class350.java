...
public class class350 extends class582 implements class514 {
    ...
    @OriginalMember(owner = "client!dh", name = "d", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(Leda;Lsq;III[B)V")
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(Ldj;B)V")
