...
public class class350 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(BI)I", line = 3)
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "([I)V", line = 45)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(B)V", line = 81)
