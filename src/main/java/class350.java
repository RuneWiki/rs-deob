...
public class class350 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lya;IIIIIII[S[BZ)V")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lya;Lhq;IIII)V")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lya;IIII)V")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lya;)V")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lga;II)V")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "([B[B[SII)V")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(II)Lom;")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lga;III)I")
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "(Lya;IIII)Lar;")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lya;Lsi;IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lya;IIII[S[B)V")
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "(Lya;)Lar;")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lya;II)V")
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "(II)Lcn;")
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "(I)Lom;")
    public static final class252 method2100(int arg0) {
        return (class252) field5103.method1492((long) arg0, 6340);
    }

    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lmg;Lks;Lcs;Lmq;Lrk;Lim;Lvk;)V")
