...
public class class350 extends class449 implements class285 {
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(Lvm;Lds;IIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Lvm;Z)Ldn;")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(ILlh;)V")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(ZIIILai;ILvm;)V")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(ZIILvm;)Lf;")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Lvm;II)Ljn;")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(BLvm;)V")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(ZLvm;)V")
    ...
    @OriginalMember(owner = "client!im", name = "b", descriptor = "(Lvm;II)Ljn;")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Lvm;I)V")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IIILvm;)Z")
