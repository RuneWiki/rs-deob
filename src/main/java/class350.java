...
public class class350 extends class744 {
    ...
    @OriginalMember(owner = "client!bo", name = "e", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!bo", name = "f", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!bo", name = "b", descriptor = "(IIII)[B", line = 38)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(IIB)V", line = 51)
    ...
    @OriginalMember(owner = "client!bo", name = "<init>", descriptor = "()V", line = 67)
    public class350() {
