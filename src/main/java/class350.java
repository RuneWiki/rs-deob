...
public class class350 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(JI)V", line = 4)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "([B[BIIII)I", line = 94)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(B)V", line = 245)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "([BII[BII)I", line = 263)
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "([B)V", line = 340)
