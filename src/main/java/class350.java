...
public abstract class class350 {
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Lro;Lro;ZIIIIIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "([IIIIILro;Lro;IIIZ)V", line = 41)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "([III[IIIBIZI)V", line = 107)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IIIII[ZLro;Lro;Lro;ILro;IZII)V", line = 206)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Lro;II)V", line = 274)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(II[IZ[ZLpf;Lju;IILpf;IZ)V", line = 319)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IILd;BIIIII)V", line = 527)
