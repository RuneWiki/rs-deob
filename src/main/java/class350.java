...
public class class350 extends class559 {
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IZIII[Luv;)V", line = 21)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IIIIIII)V", line = 69)
    ...
    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "(Ldw;IIIIZ[BIZ)V", line = 86)
    ...
    @OriginalMember(owner = "client!fba", name = "f", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(ILmg;Lmg;)V", line = 155)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(I)V", line = 174)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(I[BIIZIIZII)V", line = 184)
    ...
    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "(Ldw;IIIII)V", line = 247)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IIII)V", line = 264)
    ...
    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "(Ldw;IIIIZ[FI)V", line = 277)
    ...
    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "(Ldw;IIIIZ[IIIZ)V", line = 353)
    ...
    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "(Ldw;IIII)V", line = 406)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(ZIIIIIII[I)V", line = 303)
