...
public class class350 implements class15 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(BI)Lib;", line = 3)
    ...
    @OriginalMember(owner = "client!pi", name = "b", descriptor = "(BI)Z", line = 30)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IFIZIB)[F", line = 49)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(II)Ljl;", line = 59)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IZIIFB)[I", line = 84)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IIIZIF)[I", line = 100)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IIIIIII)V", line = 111)
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(Luu;Luu;Luu;)V", line = 247)
