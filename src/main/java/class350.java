...
public class class350 extends class173 {
    ...
    @OriginalMember(owner = "client!is", name = "b", descriptor = "(II)Z", line = 15)
    ...
    @OriginalMember(owner = "client!is", name = "c", descriptor = "(II)Z", line = 29)
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "(I)V", line = 40)
    public class350(int arg0) {
        this.field4280 = arg0;
    }

    @OriginalMember(owner = "client!is", name = "a", descriptor = "(BLfda;)V", line = 48)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!is", name = "b", descriptor = "(I)Z", line = 86)
    ...
    @OriginalMember(owner = "client!is", name = "d", descriptor = "(II)Z", line = 197)
