...
public class class350 extends class325 {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(BIILha;II)V", line = 140)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Z)V", line = 170)
    public final void method101(boolean arg0) {
        ++field5136;
        class38.method266(arg0);
    }

    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Ljp;IB)V", line = 186)
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(I)V", line = 253)
