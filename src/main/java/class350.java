...
public class class350 extends class42 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "()Z", line = 5)
    public final boolean method287() {
        return true;
    }

    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lee;)V", line = 8)
    public final void method286(class404 arg0) {
        this.field582.method888(arg0);
    }

    @OriginalMember(owner = "client!id", name = "b", descriptor = "()V", line = 11)
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Z)V", line = 47)
    public final void method288(boolean arg0) {
        this.field582.method926(8448, 7681);
    }

    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "(Lig;)V", line = 52)
