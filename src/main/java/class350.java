...
public abstract class class350 extends class693 {
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "([Lih;Z)I")
    ...
    @OriginalMember(owner = "client!pba", name = "g", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!pba", name = "i", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!pba", name = "b", descriptor = "(ILha;)Z")
