...
public class class350 {
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(ILib;)V", line = 7)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(IIIBII)V", line = 27)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(BI)V", line = 44)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(IILib;)V", line = 135)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(IILla;)Llq;", line = 184)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(ZIIIFFFI)[F", line = 205)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(Ljava/lang/String;CB)[Ljava/lang/String;", line = 287)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(BII)Z", line = 329)
