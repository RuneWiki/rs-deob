...
public abstract class class350 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(II)Lef;", line = 8)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(II)V", line = 98)
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(B)V", line = 135)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "([BI)Lq;", line = 155)
