...
public class class350 extends class44 {
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(Z)V", line = 5)
    public final void method230(boolean arg0) {
        this.field540.method981(260, 8448);
    }

    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "(Lao;Lim;)V", line = 35)
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "()Z", line = 42)
    public final boolean method232() {
        return true;
    }

    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Llp;)V", line = 45)
    public final void method231(class220 arg0) {
    }

    @OriginalMember(owner = "client!id", name = "a", descriptor = "()V", line = 48)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!id", name = "c", descriptor = "()V", line = 108)
