...
public class class350 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIIIIII)Lkc;", line = 3)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(I)Lfr;", line = 45)
    ...
    @OriginalMember(owner = "client!ko", name = "c", descriptor = "(I)V", line = 68)
