...
public class class350 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IB)[B", line = 15)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IIIIIIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Z)V", line = 91)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IIIB)I", line = 104)
