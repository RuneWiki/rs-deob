...
public class class350 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(ILdn;)V", line = 29)
    public static final void method2114(int arg0, class323 arg1) {
        class436.field6160[arg0] = arg1;
    }

    @OriginalMember(owner = "client!br", name = "a", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IZ)Z", line = 77)
    ...
    @OriginalMember(owner = "client!br", name = "b", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!br", name = "c", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IB)Lfk;", line = 138)
