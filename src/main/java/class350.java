...
public abstract class class350 implements class5 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(BILjaclib/memory/Source;)Z", line = 38)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(B)V", line = 96)
    ...
    @OriginalMember(owner = "client!ah", name = "c", descriptor = "(Z)V", line = 111)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Z)I", line = 136)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;", line = 148)
    ...
    @OriginalMember(owner = "client!ah", name = "c", descriptor = "(B)J", line = 201)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IIILlt;I)V", line = 213)
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(Z)V", line = 251)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IB)V", line = 267)
    ...
    @OriginalMember(owner = "client!ah", name = "finalize", descriptor = "()V", line = 299)
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lmc;IZ)V", line = 336)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(II)I", line = 317)
