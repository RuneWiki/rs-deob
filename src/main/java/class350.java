...
public class class350 {
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(ZILjava/lang/String;I)I", line = 6)
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(Lkv;)V", line = 168)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(I)I", line = 96)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IIII)Z", line = 120)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IZLjfa;)Z", line = 143)
