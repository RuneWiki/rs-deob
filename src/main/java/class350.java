...
public class class350 extends class49 {
    ...
    @OriginalMember(owner = "client!wja", name = "a", descriptor = "(I)[Lld;")
    ...
    @OriginalMember(owner = "client!wja", name = "<init>", descriptor = "(Lcd;)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!wja", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
