...
public class class350 extends class544 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(FLoj;Loj;I)Z")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Z)Loj;")
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "(Ljj;I)V")
    public class350(class66 arg0, int arg1) {
        this.field5005 = arg0;
        this.field5011 = new class498(arg0, 6408, arg1);
    }

    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ILbj;IIIIIIIZIIILqa;Lr;)Lr;")
