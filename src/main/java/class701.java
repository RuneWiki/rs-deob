...
public class class701 {
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(ZI)Lsl;")
    ...
    @OriginalMember(owner = "client!vfa", name = "b", descriptor = "(I)Lfca;")
    ...
    @OriginalMember(owner = "client!vfa", name = "<init>", descriptor = "(Lgia;ILaj;)V")
