...
public class class701 {
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(BI[II)Ljda;", line = 33)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "([IIB)Ljda;", line = 69)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(I)Llb;", line = 94)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(Z)V", line = 121)
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Lla;Lla;)V", line = 273)
    public class701(class423 arg0, class423 arg1) {
        this.field9878 = arg1;
        this.field9880 = arg0;
    }

    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(B[III)Ljda;", line = 159)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ILvo;BLjw;)V", line = 203)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "([IZI)Ljda;", line = 282)
