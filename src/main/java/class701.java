...
public class class701 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(ILrba;)V")
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(ZLqq;)V")
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IBLqq;Ljava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(BLqq;)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Ljava/lang/Object;Lqq;B)V")
