...
public class class701 extends class132 {
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(Lmv;Lmv;Lpc;)V", line = 4)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IZII)V", line = 23)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Lcea;[[BB)V", line = 57)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(B)Z", line = 130)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(ZIII)V", line = 167)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(I)V", line = 203)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IIIII)V", line = 220)
