...
public abstract class class701 extends class215 {
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(III)V", line = 7)
    ...
    @OriginalMember(owner = "client!sw", name = "b", descriptor = "(Z)Z", line = 30)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 42)
    ...
    @OriginalMember(owner = "client!sw", name = "k", descriptor = "(I)Z", line = 60)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(I[Lrc;)I", line = 78)
    ...
    @OriginalMember(owner = "client!sw", name = "<init>", descriptor = "(IIIIII)V", line = 88)
    ...
    @OriginalMember(owner = "client!sw", name = "c", descriptor = "(B)V", line = 102)
    public static void method3905(byte arg0) {
        int var1 = -46 / ((arg0 - 49) / 61);
        field9907 = null;
    }

    @OriginalMember(owner = "client!sw", name = "d", descriptor = "(B)V", line = 112)
