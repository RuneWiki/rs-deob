...
public class class701 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IB)V", line = 14)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ILli;Z)V", line = 34)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(I)V", line = 360)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(B)V", line = 377)
