...
public class class701 extends Exception {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(BLha;IZ)Lio;", line = 4)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(I)[Ljha;", line = 73)
    ...
    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "([Lgn;Loea;I)Las;", line = 100)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Z)Ljp;", line = 168)
