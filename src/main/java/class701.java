...
public class class701 extends class397 {
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Z)[F", line = 5)
    ...
    @OriginalMember(owner = "client!hda", name = "la", descriptor = "(Lq;)V", line = 32)
    ...
    @OriginalMember(owner = "client!hda", name = "S", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!hda", name = "O", descriptor = "([I)V", line = 80)
    ...
    @OriginalMember(owner = "client!hda", name = "XA", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(IIIFFFI)V", line = 110)
    ...
    @OriginalMember(owner = "client!hda", name = "Y", descriptor = "()V", line = 144)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(III[I)V", line = 155)
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(B)[F", line = 165)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(I)V", line = 194)
    ...
    @OriginalMember(owner = "client!hda", name = "R", descriptor = "(III[I)V", line = 206)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Lq;I)V", line = 216)
    ...
    @OriginalMember(owner = "client!hda", name = "ra", descriptor = "(I)V", line = 244)
    ...
    @OriginalMember(owner = "client!hda", name = "d", descriptor = "(I)V", line = 258)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(IBIILqd;)V", line = 269)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Lae;IIZILae;Z)I", line = 323)
    ...
    @OriginalMember(owner = "client!hda", name = "P", descriptor = "(I)V", line = 352)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "([BB)Ljava/lang/String;", line = 379)
    ...
    @OriginalMember(owner = "client!hda", name = "pa", descriptor = "(IIIIII)V", line = 460)
    ...
    @OriginalMember(owner = "client!hda", name = "G", descriptor = "(III)V", line = 504)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(IIZ[B)[B", line = 520)
    ...
    @OriginalMember(owner = "client!hda", name = "<init>", descriptor = "()V", line = 552)
    public class701() {
        this.method580();
    }

    @OriginalMember(owner = "client!hda", name = "a", descriptor = "()Lq;", line = 560)
    ...
    @OriginalMember(owner = "client!hda", name = "GA", descriptor = "(III)V", line = 582)
