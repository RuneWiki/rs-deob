...
public class class701 extends class766 {
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(Lol;Z)Lica;")
    ...
    @OriginalMember(owner = "client!dia", name = "<init>", descriptor = "(Lal;IIIII)V")
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(IIZLm;)V")
