...
public class class701 extends class659 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ZIBILuq;Ld;)[F")
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ILd;Luq;DZIZ)[I")
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ILd;Luq;)Z")
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IIZLuq;IDLd;Z)[I")
    ...
    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "(Ldt;)V")
