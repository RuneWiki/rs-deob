...
public class class701 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(B)Lig;")
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(I)Lig;")
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(Ldp;)V")
