...
public class class701 extends class300 {
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(Lph;)Lnga;", line = 3)
    ...
    @OriginalMember(owner = "client!nga", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!nga", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
