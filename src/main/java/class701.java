...
public class class701 implements class341 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IIILgfa;I)V")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ILgfa;IZ)V")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IIILvga;)V")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IILwj;)V")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lvga;IB)V")
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(Lji;)V")
