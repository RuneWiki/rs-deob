...
public class class701 extends class204 {
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!dia", name = "<init>", descriptor = "(Lfs;)V")
    public class701(class607 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!dia", name = "<init>", descriptor = "(ILfs;)V")
