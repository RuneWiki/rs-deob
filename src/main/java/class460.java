...
public class class460 extends class142 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lba;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "(Lcv;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(IIIIIII[[ZLbe;[I[I)V")
    ...
    @OriginalMember(owner = "client!fh", name = "p", descriptor = "(Lba;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(IIZLbe;[I[I[I)V")
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(IIIIIII[[ZLbe;[I[I)V")
                    ...
                    if (this.field6753[var16][var17] != null) {
                        ...
                        for (int var23 = 0; var23 < var21.field121; ++var23) {
                            ...
                            if (var21.field124 == null || var21.field124[var23] == 0 || var21.field123 != null && (var21.field123 == null || var21.field123[var23] != -1)) {
                                if (var21.field123 != null && var21.field123[var23] != -1) {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Ljd;[I)V")
    public final void method364(class153 arg0, int[] arg1) {
    }

    @OriginalMember(owner = "client!fh", name = "k", descriptor = "(IILba;)Lba;")
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(Lba;IIIIZ)V")
    public final void method352(class263 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(IILbe;[I[I[I)V")
