...
public class class460 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lig;ZZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(II)V", line = 40)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(I)V", line = 61)
