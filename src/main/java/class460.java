...
public class class460 extends class446 {
    ...
    @OriginalMember(owner = "client!ac", name = "k", descriptor = "()Z", line = 5)
    public final boolean method271() {
        ++field6343;
        return true;
    }

    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIIBIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!ac", name = "v", descriptor = "()V", line = 40)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Ljava/lang/Runnable;)Lvc;", line = 69)
    ...
    @OriginalMember(owner = "client!ac", name = "f", descriptor = "(I)V", line = 89)
    public final void method275(int arg0) {
        super.field6153[arg0].method1470(true, (Runnable) null);
        ++field6357;
    }

    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIIIIIIIII)V", line = 98)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIIIIII)V", line = 141)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Lei;IIII)Lr;", line = 218)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "([Lr;Lka;Lm;[Lcf;I)V", line = 227)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "([Lr;Lm;[Lcf;I)V", line = 249)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(II[[I[[IIII)Lsa;", line = 265)
    ...
    @OriginalMember(owner = "client!ac", name = "n", descriptor = "(I)V", line = 278)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 292)
    ...
    @OriginalMember(owner = "client!ac", name = "c", descriptor = "(I)V", line = 318)
    public final void method278(int arg0) {
        ++field6347;
        super.field6153[arg0].method1470(true, Thread.currentThread());
    }

    @OriginalMember(owner = "client!ac", name = "F", descriptor = "()V", line = 328)
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ln;)V", line = 377)
    public class460(Canvas arg0, class17 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(I)V", line = 382)
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 400)
