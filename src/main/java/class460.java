...
public class class460 {
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Lms;B)V", line = 20)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "()V", line = 37)
    public void method912() throws Exception {
        field6821++;
    }

    @OriginalMember(owner = "client!sl", name = "b", descriptor = "()V", line = 46)
    public void method915() throws Exception {
        field6818++;
    }

    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(I)V", line = 174)
    ...
    @OriginalMember(owner = "client!sl", name = "c", descriptor = "()V", line = 224)
    public void method917() {
        field6820++;
    }

    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(BLms;I)V", line = 232)
    ...
    @OriginalMember(owner = "client!sl", name = "b", descriptor = "(I)V", line = 253)
    public void method916(int arg0) throws Exception {
        field6819++;
    }

    @OriginalMember(owner = "client!sl", name = "a", descriptor = "([IIIIIIII)V", line = 260)
    ...
    @OriginalMember(owner = "client!sl", name = "c", descriptor = "(I)V", line = 372)
    ...
    @OriginalMember(owner = "client!sl", name = "d", descriptor = "()I", line = 391)
    public int method913() throws Exception {
        field6814++;
        return this.field6836;
    }

    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 400)
    public void method911(Component arg0) throws Exception {
        field6822++;
    }

    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(ILum;Lum;)V", line = 416)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "([II)V", line = 429)
