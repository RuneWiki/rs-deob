...
public abstract class class460 implements class664 {
    ...
    @OriginalMember(owner = "client!nq", name = "c", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(Z)J", line = 27)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Z)I", line = 41)
    ...
    @OriginalMember(owner = "client!nq", name = "d", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(BLjaggl/MapBuffer;)Z", line = 69)
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Lfha;IZ)V", line = 306)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(IB)V", line = 106)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ILha;IIIII)Lka;", line = 141)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ZLjaggl/MapBuffer;B)Ljaclib/memory/Buffer;", line = 187)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(I)V", line = 231)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Ljaclib/memory/Source;II)Z", line = 250)
    ...
    @OriginalMember(owner = "client!nq", name = "finalize", descriptor = "()V", line = 291)
