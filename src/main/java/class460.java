...
public class class460 extends class5 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lub;I[I[I[I)V", line = 6)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(B)V", line = 101)
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(II)V", line = 112)
