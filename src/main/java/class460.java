...
public class class460 extends class542 {
    ...
    @OriginalMember(owner = "client!hm", name = "<init>", descriptor = "(Lnd;IIII[[I[[II)V", line = 4)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IIIIIII[[Z)V", line = 75)
    ...
    @OriginalMember(owner = "client!hm", name = "IA", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 269)
    ...
    @OriginalMember(owner = "client!hm", name = "F", descriptor = "(Lk;IIIIZ)V", line = 334)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 352)
    ...
    @OriginalMember(owner = "client!hm", name = "X", descriptor = "(IILk;)Lk;", line = 458)
    ...
    @OriginalMember(owner = "client!hm", name = "N", descriptor = "()V", line = 487)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Luca;[I)V", line = 1089)
    ...
    @OriginalMember(owner = "client!hm", name = "Q", descriptor = "(III)V", line = 1097)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IIILjava/lang/Class;)Ltv;", line = 1109)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Lae;I)[Lmh;", line = 1135)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(III[[ZZ)V", line = 1180)
    ...
    @OriginalMember(owner = "client!hm", name = "ba", descriptor = "(II)I", line = 1191)
    public final int method694(int arg0, int arg1) {
        ++field6635;
        return this.field6638[arg0][arg1];
    }

    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(BLlo;II)V", line = 1201)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(ILjava/lang/Throwable;)Ljava/lang/String;", line = 1265)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IIIZII[[Z)V", line = 1337)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(II)V", line = 1478)
    public final void method693(int arg0, int arg1) {
        ++field6629;
    }

    @OriginalMember(owner = "client!hm", name = "aa", descriptor = "(II)I", line = 1487)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Lk;IIIIZ)Z", line = 1512)
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "(I)V", line = 1530)
    ...
    @OriginalMember(owner = "client!hm", name = "ya", descriptor = "(Lk;IIIIZ)V", line = 1545)
