...
public abstract class class460 implements class605 {
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!iga", name = "b", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(II)V", line = 30)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(IZ)V", line = 44)
    ...
    @OriginalMember(owner = "client!iga", name = "b", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(ZI)V", line = 103)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(ZZ)V", line = 124)
    ...
    @OriginalMember(owner = "client!iga", name = "c", descriptor = "(B)Z", line = 142)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(BLha;)V", line = 168)
    ...
    @OriginalMember(owner = "client!iga", name = "c", descriptor = "(I)V", line = 259)
    ...
    @OriginalMember(owner = "client!iga", name = "<init>", descriptor = "(Lrda;IIIZ)V", line = 300)
    ...
    @OriginalMember(owner = "client!iga", name = "finalize", descriptor = "()V", line = 278)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(IC)Z", line = 288)
