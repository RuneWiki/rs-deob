...
public class class460 extends class89 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Ln;Lpa;Lde;Lr;I)V")
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ltq;I)V")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lpa;)V")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IIIIIILoj;II)V")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lrp;)V")
    ...
    @OriginalMember(owner = "client!et", name = "D", descriptor = "()Lde;")
    ...
    @OriginalMember(owner = "client!et", name = "h", descriptor = "(IIIIII)Lrp;")
    public final class419 method297(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!et", name = "a", descriptor = "(II[[I[[IIII)Lij;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lkg;[Lgm;Z)Lam;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lvm;III)V")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IIIIZ)Lrn;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ILoj;II)V")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(I[Lnq;)V")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lhb;)V")
    ...
    @OriginalMember(owner = "client!et", name = "e", descriptor = "(I)Lhb;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "([IIIII)Lrn;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lgm;Z)Lrn;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "([Ln;Lde;[Lr;I)V")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(II[I[I)Loj;")
    ...
    @OriginalMember(owner = "client!et", name = "s", descriptor = "()Lde;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Ljava/lang/Runnable;)Lsq;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lqi;IIII)Ln;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lde;)V")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lrp;Lrp;FLrp;)Lrp;")
