...
public class class460 extends class337 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "([[IB)V", line = 7)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!rs", name = "b", descriptor = "(Lkf;I)V", line = 42)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(ZI)V", line = 58)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 69)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IZ)V", line = 81)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Lkf;B)V", line = 98)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Lkf;I)V", line = 118)
    ...
    @OriginalMember(owner = "client!rs", name = "b", descriptor = "(B)V", line = 133)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(ZFBLna;I)V", line = 233)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(I)V", line = 252)
