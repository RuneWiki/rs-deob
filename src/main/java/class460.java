...
public class class460 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lmd;I)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ILqa;Z)Lf;")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(I)[Lwv;")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lmd;BI)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ZLjava/awt/Canvas;Lm;I)Lqa;")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ILrd;)Z")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lqa;I)Lf;")
