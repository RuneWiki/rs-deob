...
public class class460 extends class192 {
    ...
    @OriginalMember(owner = "client!rd", name = "c", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!rd", name = "b", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IB)[I", line = 33)
    ...
    @OriginalMember(owner = "client!rd", name = "b", descriptor = "(IB)[[I", line = 85)
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "()V", line = 141)
    public class460() {
        super(3, false);
    }

    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ILfd;I)V", line = 149)
