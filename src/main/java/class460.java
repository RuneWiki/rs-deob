...
public class class460 {
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IILha;IIIIIII)V")
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(ILha;I)Z")
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "(I[Lah;IIII)V")
