...
public class class460 extends class270 {
    ...
    @OriginalMember(owner = "client!a", name = "b", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!a", name = "<init>", descriptor = "(Lli;)V", line = 228)
    public class460(class134 arg0) {
        this.field6820 = arg0;
    }

    @OriginalMember(owner = "client!a", name = "c", descriptor = "(II)Z", line = 236)
    ...
    @OriginalMember(owner = "client!a", name = "b", descriptor = "(IBI)Z", line = 257)
