...
public abstract class class460 {
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(ZII)Z", line = 7)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(III)Z", line = 18)
    ...
    @OriginalMember(owner = "client!raa", name = "<init>", descriptor = "(Lkfa;)V", line = 32)
    public class460(class382 arg0) {
        this.field6621 = arg0;
    }

    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(II)I", line = 43)
    public static int method2676(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!raa", name = "a", descriptor = "([II[I)V", line = 55)
