...
public class class460 extends class283 {
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!sl", name = "c", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(ZI)V", line = 29)
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "(Lac;Ldja;)V", line = 46)
    ...
    @OriginalMember(owner = "client!sl", name = "b", descriptor = "(I)Z", line = 79)
    ...
    @OriginalMember(owner = "client!sl", name = "d", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Lcu;ZI)V", line = 106)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(III)V", line = 118)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(ZZ)V", line = 174)
