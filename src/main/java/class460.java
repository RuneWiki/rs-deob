...
public class class460 extends class28 {
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Lur;I)V")
    ...
    @OriginalMember(owner = "client!al", name = "b", descriptor = "(I)Lch;")
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lua;IIIII)V")
