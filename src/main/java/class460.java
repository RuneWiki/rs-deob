...
public class class460 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Ljava/lang/String;IILvd;)Lae;", line = 3)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(B)V", line = 52)
