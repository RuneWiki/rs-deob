...
public class class460 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lqa;IIIIIII[S[BZ)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(I)Luq;")
    public static final class111 method2752(int arg0) {
        return (class111) field6799.method2605(false, (long) arg0);
    }

    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lqa;IIII)Lvp;")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lqa;)Lvp;")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(II)Luq;")
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(Lqa;)V")
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(II)Lwf;")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "([B[B[SII)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lqa;II)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lm;II)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lm;III)I")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lqa;Lcn;IIII)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lqa;IIII[S[B)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lqa;Ldh;IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lic;Lbr;Lbc;Lgj;Lhc;Lkg;Ltn;)V")
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(Lqa;IIII)V")
