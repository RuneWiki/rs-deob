...
public class class460 extends class40 {
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(Lvk;Ljava/lang/Object;I)V", line = 4)
    public class460(class308 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field6504 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!em", name = "g", descriptor = "(I)Ljava/lang/Object;", line = 13)
    public final Object method306(int arg0) {
        return arg0 == -7728 ? this.field6504.get() : (Object) null;
    }

    @OriginalMember(owner = "client!em", name = "a", descriptor = "(B)Z", line = 23)
