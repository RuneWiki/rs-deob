...
public class class460 extends class31 {
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "(Lgk;IIII[BI)V", line = 26)
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "(Lgk;IIII)V", line = 77)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IIIZIIII)V", line = 64)
