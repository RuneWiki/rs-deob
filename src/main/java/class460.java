...
public abstract class class460 extends class766 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ILjava/lang/String;)I", line = 6)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lr;III[Z)V", line = 33)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIZIIIIIII)Z", line = 79)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IZIZI[Luf;)V", line = 721)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ZZ)V", line = 775)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIIIII)I", line = 844)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(B)V", line = 904)
