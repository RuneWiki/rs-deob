...
public class class460 {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(ILqn;)V", line = 28)
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Llc;III)V", line = 170)
