...
public class class460 extends class45 implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    @OriginalMember(owner = "client!maa", name = "b", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!maa", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 15)
    ...
    @OriginalMember(owner = "client!maa", name = "c", descriptor = "(B)I", line = 37)
    public final int method354(byte arg0) {
        return arg0 == -20 ? this.field6434 : 53;
    }

    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(BLjava/awt/Component;)V", line = 47)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(B)Z", line = 60)
    ...
    @OriginalMember(owner = "client!maa", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 70)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        this.method2769((byte) -64, arg0.getY(), arg0.getX());
    }

    @OriginalMember(owner = "client!maa", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 77)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method2769((byte) -64, arg0.getY(), arg0.getX());
    }

    @OriginalMember(owner = "client!maa", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 87)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(I)I", line = 99)
    public final int method351(int arg0) {
        return arg0 == -25269 ? this.field6433 : 60;
    }

    @OriginalMember(owner = "client!maa", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 109)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(BII)V", line = 121)
    ...
    @OriginalMember(owner = "client!maa", name = "c", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!maa", name = "d", descriptor = "(I)Lpea;", line = 149)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(IIIII)V", line = 160)
    ...
    @OriginalMember(owner = "client!maa", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 178)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.method2769((byte) -64, arg0.getY(), arg0.getX());
    }

    @OriginalMember(owner = "client!maa", name = "e", descriptor = "(I)V", line = 185)
    ...
    @OriginalMember(owner = "client!maa", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 208)
    ...
    @OriginalMember(owner = "client!maa", name = "f", descriptor = "(B)V", line = 235)
    ...
    @OriginalMember(owner = "client!maa", name = "e", descriptor = "(B)Z", line = 255)
    ...
    @OriginalMember(owner = "client!maa", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 266)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method2769((byte) -64, arg0.getY(), arg0.getX());
    }

    @OriginalMember(owner = "client!maa", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 310)
    public class460(Component arg0, boolean arg1) {
        this.method2768((byte) -2, arg0);
        this.field6440 = arg1;
    }

    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(BLjava/awt/event/MouseEvent;)I", line = 279)
