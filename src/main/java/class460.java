...
public class class460 extends class480 implements class248 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ILqa;ZLto;III)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ZLqa;)Lae;")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lqa;II)Lc;")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(IILbu;)Leu;")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "(Lqa;Lgm;IIIIIZII)V")
