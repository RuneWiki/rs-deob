...
public class class460 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IIII)I", line = 4)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "([II[ILtt;[I)V", line = 29)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IIIIIII)V", line = 124)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(I)V", line = 193)
