...
public class class460 extends class728 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Lha;B)Ljd;")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IIIIBLmb;ZI[IIIII[II)I")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ZLjc;B)V")
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V")
