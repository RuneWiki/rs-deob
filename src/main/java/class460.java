...
public class class460 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(III)V", line = 53)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IZI)Ljava/lang/String;", line = 73)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(II)[I", line = 129)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(ILir;)I", line = 199)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(B)[[I", line = 228)
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "(III)V", line = 275)
