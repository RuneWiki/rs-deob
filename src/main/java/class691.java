...
public abstract class class691 implements class768 {
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(Ljaggl/MapBuffer;ZI)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(IILjaclib/memory/Source;)Z")
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(BLjaggl/MapBuffer;)Z")
    ...
    @OriginalMember(owner = "client!bca", name = "<init>", descriptor = "(Lnv;IZ)V")
