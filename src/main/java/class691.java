...
public class class691 extends class766 {
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(SB)V", line = 8)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(ZIII[[Z)V", line = 49)
    ...
    @OriginalMember(owner = "client!fa", name = "b", descriptor = "(IIIIIII)V", line = 113)
    ...
    @OriginalMember(owner = "client!fa", name = "b", descriptor = "(I)V", line = 300)
    ...
    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "(Lmj;Lsl;Lmfa;[I)V", line = 309)
