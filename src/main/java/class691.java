...
public class class691 {
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lcea;II)V")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lka;IIBIIII)Lka;")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lcea;Z)V")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(ILka;IIII)Lka;")
