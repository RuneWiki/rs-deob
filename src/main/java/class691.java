...
public class class691 {
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(Lvk;BII)V", line = 4)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(Lwh;IIIIIBLuaa;IILvq;Lha;)Lka;", line = 30)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(ZIIB[I[I[Lae;)V", line = 193)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(B)V", line = 214)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(Lvq;Lbha;ILwh;Lha;ILii;ZIILuaa;Lvk;)Lka;", line = 340)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(ILwh;ZI)V", line = 550)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(IBI)V", line = 575)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(Z)V", line = 597)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(ZB)V", line = 615)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(Luaa;Lcd;Lii;ILwh;Lbha;Lvk;IIIB[Lfo;ILvq;ILvq;Lha;IZI[I)Lka;", line = 627)
