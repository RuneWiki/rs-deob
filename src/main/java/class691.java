...
public class class691 implements class205 {
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(Z)Lww;", line = 20)
    ...
    @OriginalMember(owner = "client!oda", name = "<init>", descriptor = "(I)V", line = 30)
    public class691(int arg0) {
        this.field9618 = arg0;
    }

    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(IB)Lbk;", line = 41)
