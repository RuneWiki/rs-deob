...
public class class691 extends class584 implements class393 {
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(Ljaa;ILjaclib/memory/Buffer;)V", line = 3)
    public class691(class576 arg0, int arg1, Buffer arg2) {
        super(arg0, arg2);
        this.field9588 = arg1;
    }

    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(III[B)V", line = 11)
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(Ljaa;I[BI)V", line = 25)
    public class691(class576 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field9588 = arg1;
    }

    @OriginalMember(owner = "client!ob", name = "b", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(B)I", line = 52)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(I)I", line = 62)
    ...
    @OriginalMember(owner = "client!ob", name = "b", descriptor = "(B)J", line = 76)
