...
public class class691 extends class667 implements class407 {
    ...
    @OriginalMember(owner = "client!ica", name = "<init>", descriptor = "(Lffa;ILjaclib/memory/Buffer;IZ)V")
    ...
    @OriginalMember(owner = "client!ica", name = "<init>", descriptor = "(Lffa;I[BIZ)V")
