...
public class class422 extends class694 {
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(BLkf;)I", line = 3)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "()V", line = 52)
    public class422() {
        super(0, false);
    }

    @OriginalMember(owner = "client!sj", name = "f", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!sj", name = "b", descriptor = "(I)I", line = 67)
    ...
    @OriginalMember(owner = "client!sj", name = "c", descriptor = "(II)[[I", line = 78)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(ILjr;B)V", line = 143)
    ...
    @OriginalMember(owner = "client!sj", name = "b", descriptor = "(III)V", line = 155)
