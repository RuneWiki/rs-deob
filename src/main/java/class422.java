...
public class class422 extends class296 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(III)V", line = 16)
    ...
    @OriginalMember(owner = "client!nu", name = "<init>", descriptor = "(IIIIIF)V", line = 28)
    ...
    @OriginalMember(owner = "client!nu", name = "d", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!nu", name = "b", descriptor = "(I)V", line = 159)
    ...
    @OriginalMember(owner = "client!nu", name = "b", descriptor = "(B)V", line = 173)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(B)V", line = 184)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IZLsf;)V", line = 204)
