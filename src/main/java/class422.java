...
public class class422 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(ILpu;IIII)Lnda;")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IB)Lor;")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(ZLkt;)Z")
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "(Lnq;ILga;)V")
