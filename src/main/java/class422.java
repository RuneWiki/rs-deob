...
public class class422 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(III)Z", line = 7)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(I)Z", line = 19)
    ...
    @OriginalMember(owner = "client!ke", name = "b", descriptor = "(III)I", line = 38)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IIIZFZII)[I", line = 67)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(B)V", line = 93)
    public static void method2432(byte arg0) {
        field5779 = null;
        int var1 = 125 / ((arg0 - 9) / 33);
    }

    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Lmd;I)Lbw;", line = 102)
