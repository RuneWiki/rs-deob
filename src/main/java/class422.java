...
public abstract class class422 implements class471 {
    ...
    @OriginalMember(owner = "client!ks", name = "d", descriptor = "(I)J", line = 12)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Z)I", line = 24)
    ...
    @OriginalMember(owner = "client!ks", name = "e", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(IB)V", line = 92)
    ...
    @OriginalMember(owner = "client!ks", name = "finalize", descriptor = "()V", line = 124)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(I)Z", line = 135)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(B)V", line = 166)
    ...
    @OriginalMember(owner = "client!ks", name = "<init>", descriptor = "(Lia;IZ)V", line = 303)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;", line = 180)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(ZI[BI)[B", line = 226)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(ILjaclib/memory/Source;Z)Z", line = 259)
