...
public class class422 extends class634 {
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(BI)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!hea", name = "b", descriptor = "(BI)[I", line = 54)
    ...
    @OriginalMember(owner = "client!hea", name = "<init>", descriptor = "()V", line = 90)
    public class422() {
        super(1, false);
    }

    @OriginalMember(owner = "client!hea", name = "f", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(ILig;Z)V", line = 107)
