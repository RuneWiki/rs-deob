...
public class class422 extends class551 {
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(BZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ZZLuba;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!ep", name = "<init>", descriptor = "(Lin;Lwg;)V", line = 93)
    public class422(class91 arg0, class427 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Z)V", line = 99)
    ...
    @OriginalMember(owner = "client!ep", name = "c", descriptor = "(I)V", line = 129)
