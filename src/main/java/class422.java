...
public class class422 extends class55 {
    ...
    @OriginalMember(owner = "client!rq", name = "c", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(ILjava/awt/Canvas;Lfa;)Lr;", line = 36)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(ZIILjava/lang/String;B)V", line = 50)
    ...
    @OriginalMember(owner = "client!rq", name = "d", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IB)I", line = 79)
