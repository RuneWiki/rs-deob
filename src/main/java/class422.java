...
public class class422 extends class222 {
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IIIIIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(Ljj;IIII[BI)V", line = 25)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IIIIIIIIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(Ljj;IIII)V", line = 80)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(I)V", line = 65)
