...
public class class422 extends class219 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(IIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "(I)V", line = 578)
    ...
    @OriginalMember(owner = "client!td", name = "c", descriptor = "(I)V", line = 591)
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(Lkea;II[B)V", line = 631)
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(Lkea;II[I)V", line = 643)
