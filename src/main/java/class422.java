...
public class class422 {
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "()V", line = 9)
    public static void method2716() {
        field6287 = null;
        field6291 = null;
    }

    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IF)I", line = 15)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(F)F", line = 78)
    private static final float method2718(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IIF)F", line = 88)
    ...
    @OriginalMember(owner = "client!sp", name = "b", descriptor = "(IIF)F", line = 104)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lil;Lbd;)V", line = 113)
