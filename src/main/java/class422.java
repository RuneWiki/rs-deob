...
public class class422 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ILma;Lla;ILli;IIIIILjava/lang/String;Lhd;)V", line = 9)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(II)Z", line = 54)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(I)V", line = 73)
    public static void method2480(int arg0) {
        field5984 = null;
        int var1 = -105 / ((-arg0 - 14) / 60);
    }

    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ILfh;)Lvv;", line = 87)
