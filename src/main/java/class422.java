...
public class class422 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(BLhc;Lhc;I)Lp;")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ZLhc;ILhc;I)Lp;")
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lua;Ltt;)V")
