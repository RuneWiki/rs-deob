...
public class class422 extends class207 {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Lika;)V")
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(ILrd;)V")
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(Lrd;)V")
