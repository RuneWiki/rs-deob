...
public class class422 {
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(IILwm;)V", line = 27)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(III)Z", line = 48)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(Lwm;B)V", line = 73)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 95)
