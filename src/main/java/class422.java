...
public class class422 extends class305 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!ep", name = "c", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(II)V", line = 18)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(B)I", line = 30)
    ...
    @OriginalMember(owner = "client!ep", name = "e", descriptor = "(II)I", line = 45)
    ...
    @OriginalMember(owner = "client!ep", name = "<init>", descriptor = "(ILhb;)V", line = 56)
    public class422(int arg0, class728 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Lbu;B)V", line = 60)
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(B)V", line = 101)
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(I)I", line = 115)
    public final int method2650(int arg0) {
        ++field6290;
        return arg0 != 17503 ? -63 : super.field4320;
    }

    @OriginalMember(owner = "client!ep", name = "<init>", descriptor = "(Lhb;)V", line = 127)
