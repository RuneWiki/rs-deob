...
public class class422 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Lqs;I[[B)V")
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(I)Loo;")
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(I)Loo;")
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Lcv;)V")
