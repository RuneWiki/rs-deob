...
public class class422 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IBI)Ljava/lang/String;", line = 14)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Z)V", line = 61)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(ILjava/io/File;)[B", line = 89)
