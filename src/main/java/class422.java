...
public class class422 {
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Les;IB)V", line = 64)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Lni;II)V", line = 121)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(BLes;)V", line = 204)
