...
public class class422 extends class438 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Z)Z", line = 4)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(B)V", line = 2779)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(Z)V", line = 2792)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(II)V", line = 2818)
