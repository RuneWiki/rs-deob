...
public class class422 extends class541 {
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Los;IIII[BI)V", line = 56)
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Los;IIII)V", line = 86)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(IIIIIIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(IIZII)I", line = 71)
