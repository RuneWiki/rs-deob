...
public class class422 extends class279 implements class448 {
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(BLza;)Luc;")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(ILza;)V")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IBLza;)Le;")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(ILza;BI)Z")
    ...
    @OriginalMember(owner = "client!kq", name = "c", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lza;ZII)Luu;")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IIIZILot;Lza;)V")
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(Lza;Ler;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(ILza;B)Le;")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(BLza;)V")
