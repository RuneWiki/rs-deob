...
public class class422 extends class27 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(BIIIIII)I", line = 3)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Lhq;Ljava/lang/String;IZ)V", line = 36)
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!of", name = "c", descriptor = "(I)V", line = 84)
