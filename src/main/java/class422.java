...
public class class422 extends class448 {
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Lha;IIIIIIIIILka;IILvo;)Lka;", line = 16)
    ...
    @OriginalMember(owner = "client!ce", name = "b", descriptor = "(I)V", line = 189)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Z[B)Z", line = 202)
    ...
    @OriginalMember(owner = "client!ce", name = "<init>", descriptor = "([Len;)V", line = 226)
