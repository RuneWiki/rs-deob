...
public class class422 extends class276 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Lae;ZIZILsj;Lqe;IIILae;I)Lgj;", line = 4)
    ...
    @OriginalMember(owner = "client!ed", name = "c", descriptor = "(B)I", line = 239)
    ...
    @OriginalMember(owner = "client!ed", name = "d", descriptor = "(B)J", line = 253)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Throwable;I)V", line = 266)
    ...
    @OriginalMember(owner = "client!ed", name = "e", descriptor = "(B)V", line = 318)
    ...
    @OriginalMember(owner = "client!ed", name = "d", descriptor = "(I)I", line = 328)
    ...
    @OriginalMember(owner = "client!ed", name = "f", descriptor = "(B)V", line = 350)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(II)Z", line = 365)
    ...
    @OriginalMember(owner = "client!ed", name = "e", descriptor = "(I)I", line = 389)
