...
public class class422 {
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ZIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(IB)[[[B", line = 52)
