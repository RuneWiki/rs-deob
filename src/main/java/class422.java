...
public class class422 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(BII)Z", line = 10)
    ...
    @OriginalMember(owner = "client!pi", name = "finalize", descriptor = "()V", line = 35)
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(Lmh;J[Lnt;)V", line = 45)
