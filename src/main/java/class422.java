...
public class class422 extends class149 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Z[B)[B", line = 4)
    ...
    @OriginalMember(owner = "client!wj", name = "e", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!wj", name = "b", descriptor = "(BII)I", line = 80)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IIILbv;II)Log;", line = 94)
    ...
    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "()V", line = 115)
    public class422() {
        super(0, true);
    }

    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(II)[I", line = 119)
    ...
    @OriginalMember(owner = "client!wj", name = "c", descriptor = "(III)Ldr;", line = 151)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IIIIII)V", line = 165)
    ...
    @OriginalMember(owner = "client!wj", name = "f", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IBI)I", line = 195)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IIIBIII)V", line = 209)
    ...
    @OriginalMember(owner = "client!wj", name = "d", descriptor = "(III)Z", line = 234)
