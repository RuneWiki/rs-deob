...
public class class422 {
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IIILjava/awt/Canvas;)Lrha;", line = 19)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(II)V", line = 44)
