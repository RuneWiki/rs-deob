...
public class class422 implements class410 {
    ...
    @OriginalMember(owner = "client!ga", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(I)Z", line = 71)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Z)V", line = 94)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(ZB)V", line = 109)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "([Ljava/lang/String;I[S)V", line = 150)
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(Lla;Lpm;)V", line = 159)
