...
public class class422 extends class204 {
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(B)I", line = 3)
    public final int method2542(byte arg0) {
        ++field5868;
        return arg0 != -98 ? -78 : super.field2852;
    }

    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(B)I", line = 14)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(II)I", line = 26)
    ...
    @OriginalMember(owner = "client!gt", name = "d", descriptor = "(II)V", line = 37)
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "(ILfs;)V", line = 48)
    public class422(int arg0, class607 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "(Lfs;)V", line = 100)
