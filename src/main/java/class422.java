...
public class class422 extends class223 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(BJ)V", line = 3)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Z)V", line = 100)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "([BIILjava/lang/String;II)I", line = 122)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(I)V", line = 262)
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "(IIIIIFFF)V", line = 276)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Ljava/lang/Object;ILap;)V", line = 288)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IB)V", line = 312)
    public void method133(int arg0, byte arg1) {
        field6246++;
        this.field6230[arg0] = arg1;
    }

    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IIB)V", line = 320)
    ...
    @OriginalMember(owner = "client!ki", name = "c", descriptor = "(Z)V", line = 373)
