...
public class class422 {
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(I)V", line = 15)
    public static void method2627(int arg0) {
        int var1 = 111 % ((-arg0 - 78) / 33);
        field6190 = null;
    }

    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IIII)V", line = 32)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Llh;Ljava/awt/Canvas;IILal;Z)Lvm;", line = 44)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(ZI)V", line = 70)
