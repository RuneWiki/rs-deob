...
public abstract class class422 implements class684 {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "([Lmv;ILqfa;)Lhw;")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(ILtda;)V")
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(Lko;ILvea;Lbja;IZ)V")
