...
public class class422 extends class335 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "([B[I[IIIIIIIIIIILsg;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(Ldq;Lbb;[Lk;[I[I)V", line = 95)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "([B[IIIIIIIIIIILsg;II)V", line = 120)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(CIIIZ)V", line = 205)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "([B[IIIIIIII)V", line = 268)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "([B[I[IIIIIII)V", line = 325)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(CIIIZLsg;II)V", line = 383)
