...
public class class247 implements class241 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "()V", line = 6)
    public final void method1538() {
        this.field3166 = null;
        this.method1541();
    }

    @OriginalMember(owner = "client!ma", name = "finalize", descriptor = "()V", line = 18)
    protected final void finalize() {
        class313.method1863(this, 104);
    }

    @OriginalMember(owner = "client!ma", name = "b", descriptor = "()V", line = 37)
    public final void method1551() {
        this.field3166 = Thread.currentThread();
        this.method1543();
    }

    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lp;BIZ)Lc;", line = 43)
