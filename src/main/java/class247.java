...
public abstract class class247 extends class343 {
    ...
    @OriginalMember(owner = "client!ec", name = "m", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IIIZLeea;Lha;I)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(I[I[I)V")
    ...
    @OriginalMember(owner = "client!ec", name = "c", descriptor = "(I)Leea;")
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(IIZ)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lha;ZLqq;B[Lka;)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lka;B)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(I[B)Lfs;")
