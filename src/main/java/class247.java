...
public abstract class class247 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(I[[BLpg;)V", line = 17)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Lup;Lwr;)V", line = 49)
