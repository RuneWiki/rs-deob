...
public class class247 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "([BI)[B", line = 15)
    ...
    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 32)
