...
public class class247 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Ljava/lang/String;Z)I", line = 11)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(ILab;ILcr;Ljava/lang/String;IIBLhg;ILbg;I)V", line = 39)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IBLve;ILcj;)V", line = 86)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(I)V", line = 475)
    ...
    @OriginalMember(owner = "client!nj", name = "b", descriptor = "(I)V", line = 572)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IC)C", line = 598)
