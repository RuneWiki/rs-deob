...
public class class247 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IIIIIIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(B[Luj;)I", line = 44)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(B)I", line = 78)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IJLuj;)V", line = 113)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(I)Luj;", line = 134)
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(B)V", line = 164)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Z)V", line = 176)
    ...
    @OriginalMember(owner = "client!mn", name = "c", descriptor = "(B)I", line = 210)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(JI)Luj;", line = 222)
    ...
    @OriginalMember(owner = "client!mn", name = "d", descriptor = "(B)Luj;", line = 253)
    ...
    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "(I)V", line = 291)
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(I)Luj;", line = 314)
