...
public class class247 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Lza;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(BILnn;)V", line = 112)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(I)V", line = 151)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(IIII)V", line = 162)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Lnn;I)V", line = 184)
    ...
    @OriginalMember(owner = "client!ll", name = "b", descriptor = "(I)Z", line = 209)
