...
public class class247 extends class217 {
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!cca", name = "<init>", descriptor = "(IIIIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(IIZ)V", line = 34)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(III)V", line = 67)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(IIB)V", line = 93)
