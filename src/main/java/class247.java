...
public class class247 extends class31 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!uha", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 18)
    public final synchronized void keyPressed(KeyEvent arg0) {
        this.method1531((byte) -67, arg0, 0);
        field3170++;
    }

    @OriginalMember(owner = "client!uha", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 26)
    ...
    @OriginalMember(owner = "client!uha", name = "c", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(CIII)V", line = 169)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(IIIII)V", line = 188)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(BLjava/awt/event/KeyEvent;I)V", line = 199)
    ...
    @OriginalMember(owner = "client!uha", name = "d", descriptor = "(I)I", line = 236)
    ...
    @OriginalMember(owner = "client!uha", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 257)
    public final synchronized void keyReleased(KeyEvent arg0) {
        this.method1531((byte) -67, arg0, 1);
        field3177++;
    }

    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 265)
    ...
    @OriginalMember(owner = "client!uha", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 346)
    public class247(Component arg0) {
        class2.method5(11336);
        this.method1533(arg0, 12445);
    }

    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(I)Lno;", line = 300)
    ...
    @OriginalMember(owner = "client!uha", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 312)
    public final void focusGained(FocusEvent arg0) {
        field3172++;
    }

    @OriginalMember(owner = "client!uha", name = "b", descriptor = "(I)V", line = 319)
    ...
    @OriginalMember(owner = "client!uha", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 330)
