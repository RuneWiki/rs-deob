...
public class class247 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(IIF)F", line = 5)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Lhp;Lht;)V", line = 20)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(IF)I", line = 86)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "()V", line = 145)
    public static void method1673() {
        field3871 = null;
        field3872 = null;
    }

    @OriginalMember(owner = "client!ll", name = "b", descriptor = "(IIF)F", line = 154)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(F)F", line = 167)
