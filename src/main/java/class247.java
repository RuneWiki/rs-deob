...
public class class247 extends class88 {
    ...
    @OriginalMember(owner = "client!os", name = "c", descriptor = "(IILw;)Lw;")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lpn;[I)V")
    ...
    @OriginalMember(owner = "client!os", name = "aa", descriptor = "(Lw;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IILfw;I)V")
    ...
    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "(Lfc;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!os", name = "FA", descriptor = "(Lw;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Ltc;I)V")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lw;IIIIZ)Z")
