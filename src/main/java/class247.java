...
public class class247 extends class284 implements class2 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILih;ZII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lka;IIIZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(BIZ)Lka;", line = 14)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lih;)V", line = 18)
    ...
    @OriginalMember(owner = "client!i", name = "e", descriptor = "()[Lmv;", line = 73)
    public final class44[] method1662() {
        return this.field3642;
    }

    @OriginalMember(owner = "client!i", name = "c", descriptor = "()Z", line = 77)
    public final boolean method1664() {
        return true;
    }

    @OriginalMember(owner = "client!i", name = "d", descriptor = "()V", line = 83)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILih;ZI)Z", line = 94)
    ...
    @OriginalMember(owner = "client!i", name = "finalize", descriptor = "()V", line = 106)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "()V", line = 115)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(I[IIIIIZ)V", line = 132)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lih;Lkia;II)V", line = 137)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lih;Lkia;I)V", line = 156)
    ...
    @OriginalMember(owner = "client!i", name = "f", descriptor = "()[Lnba;", line = 173)
    public final class491[] method1688() {
        return this.field3641;
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "([ILih;)V", line = 185)
    private final void method1695(int[] arg0, class744 arg1) {
        this.field3640.method2547().method1049(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lih;IZ)V", line = 191)
    public final void method1699(class744 arg0, int arg1, boolean arg2) {
        this.method1692(((class136) arg0).nativeid, arg1, arg2);
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IIII)V", line = 193)
    public final void method1700(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!i", name = "b", descriptor = "()V", line = 200)
    public final void method1705() {
    }

    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;Lya;Lvo;IIII)V", line = 204)
