...
public class class247 implements class371 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(BII)V", line = 6)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(I[IBJ)Ljava/lang/String;", line = 30)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IIIIBI)I", line = 65)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(BLjava/lang/String;)V", line = 139)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(ILki;)V", line = 163)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IIIII)V", line = 194)
