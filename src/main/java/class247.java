...
public class class247 extends class404 {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IZ)[I", line = 9)
    ...
    @OriginalMember(owner = "client!oj", name = "d", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(ILha;I)V", line = 50)
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "()V", line = 292)
    public class247() {
        super(1, true);
    }

    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(II)[I", line = 110)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(BLjava/lang/String;)[B", line = 151)
    ...
    @OriginalMember(owner = "client!oj", name = "h", descriptor = "(I)V", line = 295)
    ...
    @OriginalMember(owner = "client!oj", name = "b", descriptor = "(III)Z", line = 315)
    ...
    @OriginalMember(owner = "client!oj", name = "b", descriptor = "(B)V", line = 329)
