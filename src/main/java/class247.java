...
public class class247 extends class483 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IIILjava/awt/Graphics;)V", line = 5)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(ZIILjava/awt/Graphics;II)V", line = 21)
    ...
    @OriginalMember(owner = "client!up", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 40)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field3822;
    }

    @OriginalMember(owner = "client!up", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 48)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(I)Z", line = 60)
    ...
    @OriginalMember(owner = "client!up", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 78)
    public final void startProduction(ImageConsumer arg0) {
        ++field3823;
        this.addConsumer(arg0);
    }

    @OriginalMember(owner = "client!up", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 86)
    ...
    @OriginalMember(owner = "client!up", name = "b", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 107)
    ...
    @OriginalMember(owner = "client!up", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 131)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field3826;
        return this.field3821 == arg0;
    }

    @OriginalMember(owner = "client!up", name = "a", descriptor = "(BIIII)V", line = 151)
    ...
    @OriginalMember(owner = "client!up", name = "c", descriptor = "(I)V", line = 166)
