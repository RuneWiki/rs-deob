...
public class class247 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lii;IZLwl;ZII)V", line = 30)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Ln;I)V", line = 67)
