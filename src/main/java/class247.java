...
public class class247 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lsaa;Lsaa;IB)Lko;")
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lsaa;IZLsaa;I)Lko;")
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "(Lfs;Ldk;Ljava/math/BigInteger;Ljava/math/BigInteger;)V")
