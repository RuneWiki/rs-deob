...
public class class247 extends class331 {
    ...
    @OriginalMember(owner = "client!ss", name = "e", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ILdg;)V", line = 18)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(II)I", line = 40)
    public static final int method1682(int arg0, int arg1) {
        return class87.field992 == null ? 0 : class87.field992[arg0][arg1] & 0xFFFFFF;
    }

    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(BILdg;)V", line = 43)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(BII)I", line = 91)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ZLon;)V", line = 112)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(BI)Le;", line = 134)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IILjava/lang/String;)Ljava/lang/String;", line = 166)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ZIIIZ)Ltq;", line = 188)
