...
public class class247 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lpn;)B", line = 4)
    private static final byte method1570(class743 arg0) {
        return (byte) method1576(1, arg0);
    }

    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(Lpn;)V", line = 17)
    ...
    @OriginalMember(owner = "client!qa", name = "c", descriptor = "(Lpn;)V", line = 174)
    ...
    @OriginalMember(owner = "client!qa", name = "d", descriptor = "(Lpn;)B", line = 676)
    private static final byte method1573(class743 arg0) {
        return (byte) method1576(8, arg0);
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "([I[I[I[BIII)V", line = 686)
    ...
    @OriginalMember(owner = "client!qa", name = "e", descriptor = "(Lpn;)V", line = 753)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(ILpn;)I", line = 773)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "([BI[BII)I", line = 804)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "()V", line = 830)
