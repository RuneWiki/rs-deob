...
public abstract class class247 extends class429 {
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IB)C", line = 4)
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(II)V", line = 55)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IIILva;Loa;ZI)V", line = 69)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IIII)V", line = 82)
    ...
    @OriginalMember(owner = "client!tr", name = "f", descriptor = "(I)Z", line = 111)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IBIIII)V", line = 123)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(I)V", line = 154)
