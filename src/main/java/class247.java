...
public class class247 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(BI)V", line = 14)
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "(Ler;ILjn;)V", line = 82)
    public class247(class90 arg0, int arg1, class668 arg2) {
        this.field3384 = arg2;
        this.field3385 = this.field3384.method3805(4, false);
    }

    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(IB)Lqm;", line = 48)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lwd;Ljn;B)V", line = 96)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(B)V", line = 157)
