...
public class class247 extends class14 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!vk", name = "e", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!vk", name = "f", descriptor = "(I)Lbk;", line = 38)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IBLmd;)V", line = 79)
    ...
    @OriginalMember(owner = "client!vk", name = "d", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(II)[[I", line = 112)
    ...
    @OriginalMember(owner = "client!vk", name = "c", descriptor = "(B)V", line = 176)
    ...
    @OriginalMember(owner = "client!vk", name = "d", descriptor = "(I)I", line = 191)
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "()V", line = 202)
    public class247() {
        super(0, false);
    }
}
