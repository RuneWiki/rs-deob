...
public class class247 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!nj", name = "b", descriptor = "(I)Z", line = 42)
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(BIIIIIILvs;)V", line = 52)
