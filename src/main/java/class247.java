...
public class class247 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(II)Lun;")
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IB)Lpp;")
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(Lgp;ILui;Lui;Lui;)V")
