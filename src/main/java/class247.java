...
public class class247 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(II[BI)V", line = 24)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IILtj;)V", line = 70)
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(Llea;Lpga;Lal;IIIII)V", line = 95)
    ...
    @OriginalMember(owner = "client!tf", name = "c", descriptor = "(I)V", line = 219)
