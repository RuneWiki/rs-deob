...
public class class247 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IIIIIIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(I)[[I", line = 57)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IB)V", line = 76)
    ...
    @OriginalMember(owner = "client!wp", name = "b", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "(III)V", line = 220)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ZI)V", line = 123)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(II)[I", line = 145)
