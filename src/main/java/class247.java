...
public class class247 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljr;B)Lqp;", line = 3)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ZIII)V", line = 27)
