...
public class class247 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Lnp;III)V")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(ILnp;I)V")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(ILot;Lr;)I")
