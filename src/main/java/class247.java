...
public class class247 extends class141 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!vh", name = "c", descriptor = "(I)Z", line = 33)
    public final boolean method55(int arg0) {
        ++field3694;
        return arg0 == 0;
    }

    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IIBI)V", line = 44)
    ...
    @OriginalMember(owner = "client!vh", name = "d", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(ZI)V", line = 88)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(Lei;II)V", line = 99)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(II[I[IZ)V", line = 113)
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "(Lbt;)V", line = 173)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(I)V", line = 211)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(III)V", line = 235)
