...
public class class247 extends class416 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(III)Z", line = 30)
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(I)V", line = 54)
    public class247(int arg0) {
        this.field3211 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(II)Z", line = 62)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Ljava/lang/String;IB)V", line = 73)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IIIZIIIIII)V", line = 83)
