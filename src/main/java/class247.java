...
public class class247 {
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(IIIILoia;Lgf;Lgf;Z[Lnw;Lpd;Lgia;ILha;Lkd;ILvfa;ILfg;[III)Lka;")
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(BILgia;I)V")
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(Lgia;Lgf;Lkd;ILoia;ILfg;Lpd;IIILha;)Lka;")
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(I[IIZ[IB[Lsd;)V")
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(ILpd;Lha;IIILfg;ILgf;IIB)Lka;")
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(IZILfg;)V")
