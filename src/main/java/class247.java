...
public class class247 extends class159 {
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IILoq;)Z", line = 10)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(III)Z", line = 28)
    ...
    @OriginalMember(owner = "client!fa", name = "b", descriptor = "(III)Z", line = 39)
    ...
    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "([B)V", line = 52)
    public class247(byte[] arg0) {
        this.field3221 = arg0;
    }

    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Z)V", line = 68)
