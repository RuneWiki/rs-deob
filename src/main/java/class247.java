...
public class class247 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "([Z[[BIII[[BLli;II[[BILph;BLvq;)V")
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IIILlf;)V")
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILlf;I)V")
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IZILao;BZLao;)I")
