...
public class class247 implements Runnable {
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZIILjava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIIIIII)Ldd;")
