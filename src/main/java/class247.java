...
public class class247 extends class214 implements class193 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IILuo;I)Z")
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Luo;Lgm;IIIIIIIZIIII)V")
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILuo;I)Lmj;")
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(Luo;I)V")
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ZLuo;)Laj;")
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Luo;I)V")
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILuo;)V")
