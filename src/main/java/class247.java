...
public class class247 implements class226 {
    ...
    @OriginalMember(owner = "client!dia", name = "c", descriptor = "(I)Lso;")
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!dia", name = "<init>", descriptor = "(Laia;Lso;Z)V")
