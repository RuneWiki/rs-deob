...
public class class247 extends class198 {
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "(Lza;Lsu;Ldl;J)V", line = 379)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ZJ)V", line = 108)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Z)V", line = 130)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(JIILza;Z)V", line = 141)
    ...
    @OriginalMember(owner = "client!ll", name = "c", descriptor = "(I)V", line = 315)
