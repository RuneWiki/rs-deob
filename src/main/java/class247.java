...
public class class247 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IIIILah;)V", line = 6)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IIIB)V", line = 58)
    ...
    @OriginalMember(owner = "client!bc", name = "b", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IIIIBI)V", line = 116)
