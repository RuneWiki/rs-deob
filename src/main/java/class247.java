...
public class class247 {
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(BI)V", line = 20)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(ZI)V", line = 54)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(II)Lep;", line = 73)
    ...
    @OriginalMember(owner = "client!nba", name = "<init>", descriptor = "(Lre;ILdn;Ldn;)V", line = 122)
