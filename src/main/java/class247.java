...
public abstract class class247 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(B)Z", line = 18)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(I)Z", line = 42)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Z)V", line = 57)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IIILud;II)Ljava/awt/Frame;", line = 72)
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!ni", name = "c", descriptor = "(I)Z", line = 155)
    ...
    @OriginalMember(owner = "client!ni", name = "d", descriptor = "(I)Z", line = 166)
