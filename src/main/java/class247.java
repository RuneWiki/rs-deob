...
public class class247 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "([Lsk;BLad;)Lig;", line = 3)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "(I)V", line = 209)
    public class247(int arg0) {
        this.field3601 = arg0;
    }

    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "(IIIIII)V", line = 216)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(BLos;)V", line = 129)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lwv;ILjava/awt/Frame;)V", line = 155)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(B)Los;", line = 183)
    ...
    @OriginalMember(owner = "client!os", name = "c", descriptor = "(I)[Lkq;", line = 195)
