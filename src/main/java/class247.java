...
public class class247 extends class171 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILhk;)V")
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILuk;)V")
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Luk;I)V")
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Lsm;ZBIF)V")
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(BLuk;)V")
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IZII[[[Luk;I)Z")
