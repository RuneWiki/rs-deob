...
public class class247 extends class278 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Llh;II)V")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ILss;IB)V")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ILuo;)V")
