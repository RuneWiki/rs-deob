...
public class class247 extends class299 {
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(ILes;)V", line = 4)
    public class247(int arg0, class404 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(I)I", line = 10)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(Les;)V", line = 34)
    public class247(class404 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(II)I", line = 42)
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(Z)I", line = 53)
    ...
    @OriginalMember(owner = "client!lf", name = "c", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IZ)V", line = 77)
