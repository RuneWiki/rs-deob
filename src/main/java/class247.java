...
public class class247 extends class71 implements class46 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Z)I", line = 6)
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "(Lbv;ILjaggl/memory/NativeBuffer;)V", line = 18)
    public class247(class282 arg0, int arg1, NativeBuffer arg2) {
        super(arg0, arg2);
        this.field3439 = arg1;
    }

    @OriginalMember(owner = "client!df", name = "b", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(B)J", line = 38)
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "(Lbv;I[BI)V", line = 50)
    public class247(class282 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field3439 = arg1;
    }

    @OriginalMember(owner = "client!df", name = "a", descriptor = "(I)I", line = 58)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(I[BII)V", line = 70)
