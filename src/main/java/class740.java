...
public class class740 extends class512 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(JI)V", line = 3)
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(Lpga;)V", line = 37)
    public class740(class492 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(ZZ)V", line = 40)
    ...
    @OriginalMember(owner = "client!pu", name = "f", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(II)V", line = 61)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(ILrea;BII)V", line = 79)
    ...
    @OriginalMember(owner = "client!pu", name = "e", descriptor = "(I)Z", line = 91)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IILlo;)V", line = 106)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IIZ)V", line = 118)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IZ)V", line = 130)
