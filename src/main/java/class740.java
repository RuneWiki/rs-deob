...
public class class740 extends class46 {
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Lib;II)V", line = 20)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(ILib;)V", line = 67)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(ILjava/lang/String;I)Ljava/lang/String;", line = 90)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(BII)I", line = 114)
