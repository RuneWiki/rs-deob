...
public class class740 {
    ...
    @OriginalMember(owner = "client!ufa", name = "toString", descriptor = "()Ljava/lang/String;", line = 6)
    public final String toString() {
        field10334++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!ufa", name = "b", descriptor = "(I)[Lmfa;", line = 29)
    ...
    @OriginalMember(owner = "client!ufa", name = "<init>", descriptor = "(II)V", line = 43)
