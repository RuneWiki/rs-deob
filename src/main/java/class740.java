...
public class class740 {
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(II)Lgfa;", line = 3)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!gfa", name = "b", descriptor = "(I)Lis;", line = 63)
    ...
    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "(II)V", line = 75)
