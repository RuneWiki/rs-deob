...
public class class740 extends class105 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lnl;ZZI)V", line = 22)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IIII)I", line = 92)
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(Z)V", line = 127)
