...
public class class740 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Z)Lpp;", line = 5)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!kl", name = "toString", descriptor = "()Ljava/lang/String;", line = 82)
