...
public class class740 {
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(IBI)I", line = 9)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(IB)Lnca;", line = 57)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "()V", line = 88)
    public static final void method4097() {
        class258.method1713(1, class315.field4541);
    }

    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(II)Lrda;", line = 91)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(IZ)V", line = 124)
    ...
    @OriginalMember(owner = "client!ega", name = "<init>", descriptor = "(Lgia;ILaj;)V", line = 169)
    public class740(class285 arg0, int arg1, class333 arg2) {
        this.field10217 = arg2;
        this.field10217.method2090(31, false);
    }

    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Z)V", line = 155)
