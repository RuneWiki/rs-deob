...
public class class740 extends class38 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IILrg;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "()V", line = 386)
    public class740() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ob", name = "f", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(II)[[I", line = 72)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(BI)[I", line = 205)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Lvs;Z[[[BIB)Z", line = 301)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(ZIIIIJLvd;I)V", line = 364)
