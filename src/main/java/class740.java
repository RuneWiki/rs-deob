...
public class class740 extends class60 {
    ...
    @OriginalMember(owner = "client!lga", name = "<init>", descriptor = "(ILhd;)V")
    ...
    @OriginalMember(owner = "client!lga", name = "<init>", descriptor = "(Lhd;)V")
    public class740(class773 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(Lbn;I)V")
