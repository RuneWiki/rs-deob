...
public class class740 extends class649 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(I[J[Ljava/lang/Object;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!pu", name = "c", descriptor = "(I)I", line = 62)
    public final int method4141(int arg0) {
        ++field10387;
        return arg0 != 3 ? 52 : super.field9223;
    }

    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(ILhs;)V", line = 74)
    public class740(int arg0, class358 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!pu", name = "d", descriptor = "(I)Z", line = 78)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(I)I", line = 105)
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(Lhs;)V", line = 116)
    public class740(class358 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IB)V", line = 120)
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Z)V", line = 153)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "([IB)Ljava/lang/String;", line = 164)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(II)I", line = 215)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(B)V", line = 233)
