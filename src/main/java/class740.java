...
public abstract class class740 extends class112 {
    ...
    @OriginalMember(owner = "client!lu", name = "b", descriptor = "()I", line = 5)
    public final int method781() {
        return this.field10343 + this.field10329 + this.field10331;
    }

    @OriginalMember(owner = "client!lu", name = "b", descriptor = "(IIIIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(FFFFFFILaa;II)V", line = 60)
    ...
    @OriginalMember(owner = "client!lu", name = "c", descriptor = "()I", line = 90)
    public final int method789() {
        return this.field10335;
    }

    @OriginalMember(owner = "client!lu", name = "a", descriptor = "([I)V", line = 104)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "()I", line = 111)
    public final int method777() {
        return this.field10343;
    }

    @OriginalMember(owner = "client!lu", name = "d", descriptor = "()I", line = 114)
    public final int method792() {
        return this.field10335 + this.field10315 + this.field10316;
    }

    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(FFFFFF)Z", line = 130)
    ...
    @OriginalMember(owner = "client!lu", name = "b", descriptor = "(IIII)V", line = 264)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(FFFFFFIIII)V", line = 278)
    ...
    @OriginalMember(owner = "client!lu", name = "<init>", descriptor = "(Lni;II)V", line = 376)
