...
public class class740 {
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Ljava/lang/String;IZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(IIIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(B)V", line = 53)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "([BI)V", line = 72)
    ...
    @OriginalMember(owner = "client!ega", name = "<init>", descriptor = "([BI[B)V", line = 277)
