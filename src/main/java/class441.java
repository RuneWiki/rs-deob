...
public class class441 implements Runnable {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(II)Lqd;", line = 5)
    public final class277 method2604(int arg0, int arg1) {
        return arg0 == 4479 ? this.method2611(arg1, null, 21, 0, 3) : null;
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Ljava/lang/String;I)Lqd;", line = 15)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(B)Lqd;", line = 26)
    public final class277 method2606(byte arg0) {
        return arg0 == -65 ? this.method2611(0, null, 21, 0, 18) : null;
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ILjava/net/URL;)Lqd;", line = 38)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;B)Lqd;", line = 51)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(Ljava/lang/String;I)Ljava/io/File;", line = 61)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIBLjava/lang/Object;I)Lqd;", line = 73)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ILjava/lang/Object;III)Lqd;", line = 110)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Ljava/awt/Component;III)Lqd;", line = 140)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Ljava/lang/String;[Ljava/lang/Class;BLjava/lang/Class;)Lqd;", line = 155)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;II)Ljava/io/File;", line = 169)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ZLjava/lang/Class;)Lqd;", line = 259)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ILjava/awt/Frame;)Lqd;", line = 270)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Ljava/lang/String;Z)[B", line = 283)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(I)Lqd;", line = 295)
    public final class277 method2618(int arg0) {
        return arg0 == 0 ? this.method2611(0, null, arg0 + 21, 0, 5) : null;
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Ljava/lang/String;B)Lqd;", line = 311)
    public final class277 method2619(String arg0, byte arg1) {
        return arg1 < 113 ? null : this.method2611(0, arg0, 21, 0, 21);
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Ljava/lang/Runnable;II)Lqd;", line = 322)
    public final class277 method2620(Runnable arg0, int arg1, int arg2) {
        return arg2 < 51 ? null : this.method2611(arg1, arg0, 21, 0, 2);
    }

    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;I)V", line = 694)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(B)Lgm;", line = 344)
    public final class101 method2621(byte arg0) {
        return arg0 == 38 ? this.field6143 : null;
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Ljava/lang/String;II)Lqd;", line = 364)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(I)V", line = 374)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIIBI)Lqd;", line = 384)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Ljava/awt/Component;Ljava/awt/Point;[IIII)Lqd;", line = 397)
    ...
    @OriginalMember(owner = "client!hs", name = "c", descriptor = "(I)V", line = 407)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(BLjava/lang/Class;)Lqd;", line = 465)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Ljava/lang/Class;I)V", line = 479)
    ...
    @OriginalMember(owner = "client!hs", name = "run", descriptor = "()V", line = 517)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(Ljava/lang/String;Z)Lqd;", line = 638)
    public final class277 method2629(String arg0, boolean arg1) {
        return arg1 ? null : this.method2611(0, arg0, 21, 0, 12);
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;I)Lqd;", line = 651)
    ...
    @OriginalMember(owner = "client!hs", name = "d", descriptor = "(I)Z", line = 667)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(BLjava/awt/Component;Z)Lqd;", line = 684)
