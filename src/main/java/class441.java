...
public abstract class class441 extends class270 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IIIIIIIIBI)V", line = 5)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IIIIIIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(I)V", line = 67)
    public class441(int arg0) {
        this.field6572 = arg0;
    }

    @OriginalMember(owner = "client!ns", name = "e", descriptor = "(I)V", line = 81)
