...
public class class441 implements Runnable {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Llp;II)Lom;")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "([BZILlp;)Lom;")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Lom;I)V")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(BILlp;)Lom;")
    ...
    @OriginalMember(owner = "client!pt", name = "<init>", descriptor = "(Lhga;)V")
