...
public class class441 extends class35 {
    ...
    @OriginalMember(owner = "client!up", name = "c", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IIZ)V", line = 116)
    ...
    @OriginalMember(owner = "client!up", name = "d", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(ILdp;Lja;Ldp;)V", line = 183)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(IIIIIZ)V", line = 201)
    ...
    @OriginalMember(owner = "client!up", name = "e", descriptor = "(I)V", line = 216)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IIIIIIII)V", line = 247)
