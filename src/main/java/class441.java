...
public class class441 extends class383 {
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "([Ljava/lang/Object;I[III)V", line = 27)
    ...
    @OriginalMember(owner = "client!sk", name = "<init>", descriptor = "()V", line = 86)
    public class441() {
    }

    @OriginalMember(owner = "client!sk", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 88)
