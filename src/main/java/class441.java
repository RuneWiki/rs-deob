...
public class class441 extends class359 {
    ...
    @OriginalMember(owner = "client!hd", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(III)I", line = 36)
    ...
    @OriginalMember(owner = "client!hd", name = "c", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IB)V", line = 70)
    public void method604(int arg0, byte arg1) {
        field6386++;
        this.field6389[arg0] = arg1;
    }

    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(B)V", line = 79)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(BII)V", line = 92)
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "(IIIIIFFF)V", line = 126)
