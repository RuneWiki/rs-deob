...
public class class441 extends class417 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(ILqa;II)Z")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(BILkf;IZII)V")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(ILqa;ZLto;III)V")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(BILqa;I)Lc;")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IIILag;)V")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(BLbu;)V")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Lc;Lqa;I)V")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(ZLqa;)Lae;")
