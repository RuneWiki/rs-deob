...
public class class441 extends class307 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "([B[IIIIIIIIIIILma;II)V", line = 7)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(CIIIZLma;II)V", line = 101)
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(Ldg;Ldu;[Lul;[I[I)V", line = 165)
    ...
    @OriginalMember(owner = "client!ef", name = "OA", descriptor = "(CIIIZ)V", line = 188)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "([B[IIIIIIII)V", line = 246)
