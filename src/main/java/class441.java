...
public class class441 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(JB)V", line = 34)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(B)I", line = 127)
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "()V", line = 144)
    public class441() {
    }

    @OriginalMember(owner = "client!cb", name = "c", descriptor = "(I)I", line = 147)
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(Los;)V", line = 157)
    ...
    @OriginalMember(owner = "client!cb", name = "d", descriptor = "(I)V", line = 170)
