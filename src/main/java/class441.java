...
public class class441 {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Lkk;BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IB)C", line = 41)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(ILpg;[[B)V", line = 75)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Lkk;Z)V", line = 185)
