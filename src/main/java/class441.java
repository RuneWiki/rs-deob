...
public class class441 extends class311 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(BLjava/lang/String;IZ)Z", line = 3)
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "([B)V", line = 99)
