...
public class class441 {
    ...
    @OriginalMember(owner = "client!qja", name = "a", descriptor = "([BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!qja", name = "<init>", descriptor = "(Lpq;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!qja", name = "<init>", descriptor = "(Lpq;Ljaclib/memory/Buffer;)V", line = 21)
