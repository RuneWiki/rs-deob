...
public class class441 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(BII)I", line = 3)
    ...
    @OriginalMember(owner = "client!es", name = "toString", descriptor = "()Ljava/lang/String;", line = 39)
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 69)
