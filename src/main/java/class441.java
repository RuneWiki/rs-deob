...
public abstract class class441 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!bda", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 39)
    public final void update(Graphics arg0) {
        field6195++;
        this.paint(arg0);
    }

    @OriginalMember(owner = "client!bda", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 47)
    public final void windowClosing(WindowEvent arg0) {
        field6193++;
        this.destroy();
    }

    @OriginalMember(owner = "client!bda", name = "b", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!bda", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 111)
    public final void windowOpened(WindowEvent arg0) {
        field6214++;
    }

    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(II)Z", line = 118)
    ...
    @OriginalMember(owner = "client!bda", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 130)
    public final void focusLost(FocusEvent arg0) {
        class24.field192 = false;
        field6212++;
    }

    @OriginalMember(owner = "client!bda", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 139)
    public final void windowIconified(WindowEvent arg0) {
        field6207++;
    }

    @OriginalMember(owner = "client!bda", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 146)
    public final void windowDeiconified(WindowEvent arg0) {
        field6204++;
    }

    @OriginalMember(owner = "client!bda", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 154)
    public final void windowDeactivated(WindowEvent arg0) {
        field6189++;
    }

    @OriginalMember(owner = "client!bda", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 164)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(Z)V", line = 179)
    ...
    @OriginalMember(owner = "client!bda", name = "b", descriptor = "(Z)V", line = 231)
    ...
    @OriginalMember(owner = "client!bda", name = "provideLoaderApplet", descriptor = "(Ljava/applet/Applet;)V", line = 242)
    public static final void provideLoaderApplet(Applet arg0) {
        field6185++;
        class591.field8347 = arg0;
    }

    @OriginalMember(owner = "client!bda", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 251)
    ...
    @OriginalMember(owner = "client!bda", name = "d", descriptor = "(B)Z", line = 275)
    ...
    @OriginalMember(owner = "client!bda", name = "d", descriptor = "(I)Z", line = 317)
    ...
    @OriginalMember(owner = "client!bda", name = "stop", descriptor = "()V", line = 328)
    ...
    @OriginalMember(owner = "client!bda", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 350)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(IIILjava/lang/String;III)V", line = 368)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(IZ)V", line = 417)
    ...
    @OriginalMember(owner = "client!bda", name = "e", descriptor = "(B)Z", line = 490)
    public final boolean method2558(byte arg0) {
        field6206++;
        return arg0 == 4 ? class166.method908("jaclib", (byte) 127) : false;
    }

    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(Ljava/lang/String;IIIBZII)V", line = 501)
    ...
    @OriginalMember(owner = "client!bda", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 543)
    ...
    @OriginalMember(owner = "client!bda", name = "destroy", descriptor = "()V", line = 559)
    ...
    @OriginalMember(owner = "client!bda", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 575)
    ...
    @OriginalMember(owner = "client!bda", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 590)
    ...
    @OriginalMember(owner = "client!bda", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 604)
    public final void windowActivated(WindowEvent arg0) {
        field6201++;
    }

    @OriginalMember(owner = "client!bda", name = "start", descriptor = "()V", line = 611)
    ...
    @OriginalMember(owner = "client!bda", name = "c", descriptor = "(Z)Ljava/lang/String;", line = 623)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(BLjava/lang/String;)V", line = 634)
    ...
    @OriginalMember(owner = "client!bda", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 665)
    public final void windowClosed(WindowEvent arg0) {
        field6191++;
    }

    @OriginalMember(owner = "client!bda", name = "run", descriptor = "()V", line = 672)
