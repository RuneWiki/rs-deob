...
public class class441 extends class30 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Ljg;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 40)
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "()V", line = 54)
    public class441() {
        super(2, false);
    }

    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IB)[I", line = 63)
    ...
    @OriginalMember(owner = "client!hd", name = "f", descriptor = "(I)[Lwa;", line = 309)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(II)V", line = 399)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(BI)[[I", line = 420)
    ...
    @OriginalMember(owner = "client!hd", name = "g", descriptor = "(I)V", line = 747)
