...
public class class441 extends class1 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IZIJLha;)V", line = 4)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(I)V", line = 266)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(JILha;)V", line = 276)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Ljava/lang/String;IBLjava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V", line = 297)
    ...
    @OriginalMember(owner = "client!pt", name = "<init>", descriptor = "(Lha;Lhr;Lpba;J)V", line = 393)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(B)V", line = 334)
