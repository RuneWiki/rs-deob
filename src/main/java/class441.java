...
public class class441 {
    ...
    @OriginalMember(owner = "client!mja", name = "toString", descriptor = "()Ljava/lang/String;", line = 7)
    public final String toString() {
        field5925++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!mja", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!mja", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;I)V", line = 33)
