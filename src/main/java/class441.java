...
public abstract class class441 extends class198 {
    ...
    @OriginalMember(owner = "client!fl", name = "c", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!fl", name = "e", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!fl", name = "d", descriptor = "(I)Z", line = 74)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(II[Ljava/lang/Object;I[J)V", line = 87)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Lvq;ZLkm;IIBI)V", line = 143)
    ...
    @OriginalMember(owner = "client!fl", name = "f", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "(IIIIIII)V", line = 171)
