...
public class class441 {
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(IB)Lpu;")
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(ILdt;)V")
    ...
    @OriginalMember(owner = "client!mba", name = "<init>", descriptor = "(Lkw;ILuq;Lpf;)V")
