...
public class class441 extends class380 {
    ...
    @OriginalMember(owner = "client!os", name = "f", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IIILha;)V", line = 16)
    ...
    @OriginalMember(owner = "client!os", name = "b", descriptor = "(ILha;)Llca;", line = 566)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lha;I)V", line = 579)
    public final void method990(class58 arg0, int arg1) {
        ++field6391;
        int var3 = -73 / ((arg1 - -2) / 62);
    }

    @OriginalMember(owner = "client!os", name = "g", descriptor = "(I)Z", line = 589)
    public final boolean method989(int arg0) {
        ++field6413;
        return arg0 >= -112 ? false : this.field6409;
    }

    @OriginalMember(owner = "client!os", name = "a", descriptor = "(B)V", line = 601)
    ...
    @OriginalMember(owner = "client!os", name = "c", descriptor = "(I)Z", line = 617)
    ...
    @OriginalMember(owner = "client!os", name = "e", descriptor = "(Z)I", line = 627)
    ...
    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "(IIIII)V", line = 1052)
    public class441(int arg0, int arg1, int arg2, int arg3, int arg4) {
        super(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!os", name = "a", descriptor = "(BLha;)Llba;", line = 650)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IIIIIIIIII)V", line = 815)
    ...
    @OriginalMember(owner = "client!os", name = "d", descriptor = "(Z)I", line = 894)
    ...
    @OriginalMember(owner = "client!os", name = "j", descriptor = "(I)V", line = 929)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IILha;I)Z", line = 940)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IZLwg;Z)V", line = 991)
