...
public class class441 extends class262 {
    ...
    @OriginalMember(owner = "client!dga", name = "<init>", descriptor = "(Lag;IIIIZ[BIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(IIIIIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!dga", name = "b", descriptor = "(III)V", line = 73)
    ...
    @OriginalMember(owner = "client!dga", name = "<init>", descriptor = "(Lag;IIIIZ[FI)V", line = 99)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(III[BIZIIII)V", line = 136)
    ...
    @OriginalMember(owner = "client!dga", name = "<init>", descriptor = "(Lag;IIII)V", line = 194)
    ...
    @OriginalMember(owner = "client!dga", name = "<init>", descriptor = "(Lag;IIIIZ[IZ)V", line = 211)
    ...
    @OriginalMember(owner = "client!dga", name = "<init>", descriptor = "(Lag;IIIII)V", line = 313)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(II[IIZIIII)V", line = 263)
    ...
    @OriginalMember(owner = "client!dga", name = "c", descriptor = "(B)V", line = 327)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(ZZB)V", line = 339)
    ...
    @OriginalMember(owner = "client!dga", name = "b", descriptor = "(IIII)V", line = 357)
