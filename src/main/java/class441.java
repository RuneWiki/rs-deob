...
public abstract class class441 extends class318 {
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "([Ltj;B)I")
    ...
    @OriginalMember(owner = "client!uda", name = "c", descriptor = "(Lha;B)Z")
    ...
    @OriginalMember(owner = "client!uda", name = "d", descriptor = "(B)V")
