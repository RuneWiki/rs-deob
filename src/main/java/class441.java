...
public abstract class class441 extends class402 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lkg;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!on", name = "<init>", descriptor = "(IIIZZ)V", line = 104)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(IIILir;IZI)V", line = 36)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Z)V", line = 63)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(II)V", line = 77)
