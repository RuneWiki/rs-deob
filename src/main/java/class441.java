...
public class class441 implements Runnable {
    ...
    @OriginalMember(owner = "client!nh", name = "run", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(I)Lph;", line = 126)
    public final class315 method2710(int arg0) {
        return arg0 == 0 ? this.method2737((Object) null, 0, 13, arg0 - 108, 0) : null;
    }

    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IIILjava/lang/Object;I)Lph;", line = 140)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(ILjava/lang/Class;)Lph;", line = 178)
    public final class315 method2712(int arg0, Class arg1) {
        int var3 = -46 % ((arg0 + 16) / 49);
        return this.method2737(arg1, 0, 10, -85, 0);
    }

    @OriginalMember(owner = "client!nh", name = "b", descriptor = "(I)Lph;", line = 188)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IZLjava/lang/String;)Lph;", line = 199)
    public final class315 method2714(int arg0, boolean arg1, String arg2) {
        return arg1 ? null : this.method2737(arg2, 0, 1, 90, arg0);
    }

    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;I)V", line = 557)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Ljava/lang/Class;Z)Lph;", line = 212)
    public final class315 method2715(Class arg0, boolean arg1) {
        return arg1 ? this.method2737(arg0, 0, 11, 113, 0) : null;
    }

    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(BLjava/awt/Component;II)Lph;", line = 223)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;I)Lph;", line = 235)
    ...
    @OriginalMember(owner = "client!nh", name = "c", descriptor = "(I)V", line = 246)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(BLjava/net/URL;)Lph;", line = 262)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Z)Z", line = 272)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(ZBLjava/awt/Component;)Lph;", line = 286)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Ljava/lang/String;B)[B", line = 299)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Ljava/lang/Class;[Ljava/lang/Class;Ljava/lang/String;I)Lph;", line = 313)
    ...
    @OriginalMember(owner = "client!nh", name = "d", descriptor = "(I)Lph;", line = 328)
    ...
    @OriginalMember(owner = "client!nh", name = "b", descriptor = "(Z)Lph;", line = 344)
    ...
    @OriginalMember(owner = "client!nh", name = "e", descriptor = "(I)Lfq;", line = 354)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(ZLjava/awt/Frame;)Lph;", line = 365)
    public final class315 method2727(boolean arg0, Frame arg1) {
        return arg0 ? this.method2737(arg1, 0, 7, 83, 0) : null;
    }

    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IIIII)Lph;", line = 375)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(ILjava/awt/Point;II[ILjava/awt/Component;)Lph;", line = 386)
    ...
    @OriginalMember(owner = "client!nh", name = "b", descriptor = "(ILjava/lang/Class;)Lph;", line = 400)
    public final class315 method2730(int arg0, Class arg1) {
        return arg0 < 76 ? null : this.method2737(arg1, 0, 20, -100, 0);
    }

    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Ljava/lang/String;I)Lph;", line = 410)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(B)V", line = 437)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(ILjava/lang/Runnable;I)Lph;", line = 494)
    public final class315 method2733(int arg0, Runnable arg1, int arg2) {
        return arg0 == 0 ? this.method2737(arg1, 0, 2, arg0 - 56, arg2) : null;
    }

    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(II)Lph;", line = 504)
    public final class315 method2734(int arg0, int arg1) {
        return arg1 == 0 ? this.method2737((Object) null, 0, 3, arg1 ^ 0x6A, arg0) : null;
    }

    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(ZLjava/lang/Class;Ljava/lang/String;)Lph;", line = 520)
    ...
    @OriginalMember(owner = "client!nh", name = "b", descriptor = "(Ljava/lang/String;B)Lph;", line = 531)
    public final class315 method2736(String arg0, byte arg1) {
        int var3 = 45 % ((arg1 + 51) / 60);
        return this.method2737(arg0, 0, 16, -41, 0);
    }

    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Ljava/lang/Object;IIII)Lph;", line = 637)
