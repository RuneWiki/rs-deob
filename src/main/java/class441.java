...
public class class441 extends class451 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Lud;[I[I[II)V", line = 37)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IIIIIII)V", line = 132)
    ...
    @OriginalMember(owner = "client!uh", name = "g", descriptor = "(I)V", line = 569)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(III)Z", line = 608)
    ...
    @OriginalMember(owner = "client!uh", name = "<init>", descriptor = "(Lpea;II)V", line = 622)
