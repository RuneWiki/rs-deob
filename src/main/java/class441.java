...
public class class441 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(ILgo;)V")
    ...
    @OriginalMember(owner = "client!go", name = "c", descriptor = "(I)Lgo;")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(B)[Lid;")
