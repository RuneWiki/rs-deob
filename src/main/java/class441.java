...
public class class441 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(Ljj;)V", line = 534)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ILcg;)Z", line = 50)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Lcg;Z)V", line = 90)
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(Z)V", line = 104)
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(B)Z", line = 218)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(I)V", line = 231)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(III)Z", line = 296)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IIIII)Z", line = 335)
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(I)Z", line = 381)
