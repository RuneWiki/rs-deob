...
public class class441 implements Runnable {
    ...
    @OriginalMember(owner = "client!ee", name = "finalize", descriptor = "()V", line = 6)
    protected final void finalize() {
        this.method2736(5000);
        field6344++;
    }

    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(I)I", line = 15)
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(Ljava/net/Socket;Lbd;)V", line = 379)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(I[BII)V", line = 35)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IILbi;)I", line = 62)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lrk;I)V", line = 80)
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "([BIII)V", line = 129)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(BLbi;Z)V", line = 181)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Z)V", line = 207)
    ...
    @OriginalMember(owner = "client!ee", name = "run", descriptor = "()V", line = 217)
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(Z)V", line = 287)
    ...
    @OriginalMember(owner = "client!ee", name = "c", descriptor = "(I)V", line = 308)
    ...
    @OriginalMember(owner = "client!ee", name = "d", descriptor = "(I)I", line = 324)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(B)V", line = 344)
