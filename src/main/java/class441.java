...
public class class441 extends class553 {
    ...
    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(ILqa;)Lin;")
    ...
    @OriginalMember(owner = "client!cn", name = "c", descriptor = "(III)Lnj;")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(ILqa;IB)Z")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(Lqa;I)Lpl;")
