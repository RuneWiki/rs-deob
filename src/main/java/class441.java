...
public class class441 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(II)Lhc;", line = 6)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IZI)I", line = 42)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Z)V", line = 73)
    ...
    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(I)V", line = 159)
    ...
    @OriginalMember(owner = "client!wg", name = "c", descriptor = "(I)V", line = 181)
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Ldk;ILfc;)V", line = 222)
    public class441(class328 arg0, int arg1, class343 arg2) {
        this.field6046 = arg2;
        this.field6051 = this.field6046.method2054(0, 4);
    }

    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(II)V", line = 198)
