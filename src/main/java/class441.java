...
public class class441 extends class202 implements class161 {
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(ILza;)Lhp;")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lza;ZIZ)Lhw;")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lza;IZ)Le;")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lza;III)Z")
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Lza;Lii;IIIIZIIIII)V")
