...
public class class441 implements class655 {

    @OriginalMember(owner = "client!kda", name = "n", descriptor = "Lvea;")
    public class305 field6413;
    ...
    @OriginalMember(owner = "client!kda", name = "f", descriptor = "Ltca;")
    public class545 field6405;
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(I)Lmh;", line = 7)
    public final class139 method599(int arg0) {
        int var2 = 7 / ((-arg0 - 89) / 34);
        field6406++;
        return class350.field5178;
    }

    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(IZ)V", line = 39)
    public static final void method2609(int arg0, boolean arg1) {
        class76.field1242 = arg0;
        field6416++;
    ...
    @OriginalMember(owner = "client!kda", name = "<init>", descriptor = "(ILtca;Lvea;IIIIIIIZ)V", line = 59)
    public class441(int arg0, class545 arg1, class305 arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, boolean arg10) {
        this.field6413 = arg2;
        this.field6415 = arg0;
        this.field6414 = arg9;
        this.field6402 = arg10;
        this.field6412 = arg4;
        this.field6404 = arg5;
        this.field6400 = arg3;
        this.field6411 = arg8;
