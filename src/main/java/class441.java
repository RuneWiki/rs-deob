...
public class class441 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(JLge;I)V", line = 17)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IJ)Lge;", line = 38)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(I)Lge;", line = 101)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(BLmd;)Luc;", line = 139)
    ...
    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "(I)V", line = 164)
