...
public class class441 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "([B[BBIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(ILoc;II)V", line = 48)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IIILoc;)Z", line = 115)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "([BIZI[BIIII)V", line = 186)
    ...
    @OriginalMember(owner = "client!up", name = "b", descriptor = "(ILoc;II)V", line = 231)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IIIII)V", line = 300)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IIIZ[[ZI)V", line = 335)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(I)V", line = 516)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IIII[BII)Z", line = 550)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(Lih;Lms;)V", line = 593)
