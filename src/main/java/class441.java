...
public class class441 extends class127 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "()V", line = 5)
    public final void method152() {
    }

    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IZ)V", line = 11)
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "(Ltb;II[BI)V", line = 19)
