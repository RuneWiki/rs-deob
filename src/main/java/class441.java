...
public class class441 {
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Lha;I)Lvr;", line = 16)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(BI)Ljava/lang/String;", line = 38)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(Lha;I)Lvr;", line = 65)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ILjp;I)V", line = 94)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ILha;)V", line = 165)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(ILha;)Lvr;", line = 223)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Ljp;B)V", line = 259)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IILcj;)Z", line = 281)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IFFFFFIF)F", line = 307)
    ...
    @OriginalMember(owner = "client!nv", name = "c", descriptor = "(Lha;I)Lvr;", line = 385)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IZBLjava/lang/String;Ljava/lang/String;)V", line = 422)
