...
public class class520 implements class498 {
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(IB)Ltba;", line = 4)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(BLjava/awt/Component;Lqj;II)Laj;", line = 16)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(FIIIZI)[I", line = 100)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(IZ)Z", line = 113)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(B)I", line = 126)
    public final int method2719(byte arg0) {
        field6574++;
        return arg0 < 118 ? 36 : this.field6565;
    }

    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(Z)V", line = 139)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(IFIIZI)[F", line = 151)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(IIIFZZ)[I", line = 172)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(BI)Lrm;", line = 183)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(I)V", line = 211)
    ...
    @OriginalMember(owner = "client!jw", name = "<init>", descriptor = "(Lpfa;Lpfa;Lpfa;)V", line = 226)
