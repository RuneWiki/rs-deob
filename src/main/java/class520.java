...
public class class520 extends class56 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(BILes;)V", line = 3)
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "()V", line = 48)
    public class520() {
        super(0, true);
    }

    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(II)[I", line = 60)
    ...
    @OriginalMember(owner = "client!jb", name = "d", descriptor = "(Z)V", line = 129)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IZII)Ljava/lang/String;", line = 150)
    ...
    @OriginalMember(owner = "client!jb", name = "b", descriptor = "(B)V", line = 204)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(B)V", line = 227)
