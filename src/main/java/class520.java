...
public class class520 extends class146 implements class176 {
    ...
    @OriginalMember(owner = "client!rj", name = "e", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!rj", name = "c", descriptor = "(I)I", line = 18)
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(I)J", line = 31)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IZIIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(Z)V", line = 148)
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(Lbv;I[BIZ)V", line = 166)
    public class520(class282 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34963, arg2, arg3, arg4);
        this.field7701 = arg1;
    }

    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(III[B)V", line = 178)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(I)I", line = 189)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Lns;Lns;Lqa;B)V", line = 200)
