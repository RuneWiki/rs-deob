...
public class class520 extends class431 {
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(Lrea;[IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(Lrea;[III)V")
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(Lrea;II)V")
