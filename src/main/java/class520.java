...
public class class520 extends class355 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(IIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(BLjava/awt/Color;Ljava/awt/Color;Ljava/awt/Color;ZLjava/lang/String;I)V", line = 32)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(IIIZ)[B", line = 112)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ILul;ILjava/awt/Component;I)Led;", line = 123)
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "()V", line = 205)
    public class520() {
