...
public class class520 {
    ...
    @OriginalMember(owner = "client!hja", name = "a", descriptor = "(BI)Ldv;", line = 3)
    ...
    @OriginalMember(owner = "client!hja", name = "a", descriptor = "(Lfl;I[[B)V", line = 35)
    ...
    @OriginalMember(owner = "client!hja", name = "a", descriptor = "(BLha;ZI)Lee;", line = 142)
    ...
    @OriginalMember(owner = "client!hja", name = "c", descriptor = "(I)V", line = 214)
    ...
    @OriginalMember(owner = "client!hja", name = "b", descriptor = "(I)V", line = 225)
    ...
    @OriginalMember(owner = "client!hja", name = "a", descriptor = "(I)V", line = 244)
    ...
    @OriginalMember(owner = "client!hja", name = "a", descriptor = "(II)V", line = 260)
    ...
    @OriginalMember(owner = "client!hja", name = "<init>", descriptor = "(Lfs;ILlga;)V", line = 276)
