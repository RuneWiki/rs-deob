...
public class class520 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IIIIILt;)Lt;")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(ILgk;I)V")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IIBIIILt;I)Lt;")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(ZLgk;)V")
