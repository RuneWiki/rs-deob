...
public class class520 extends class296 {
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(Lr;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!ew", name = "fa", descriptor = "(IILr;)Lr;")
    ...
    @OriginalMember(owner = "client!ew", name = "CA", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(Luca;[I)V")
    ...
    @OriginalMember(owner = "client!ew", name = "<init>", descriptor = "(Lai;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!ew", name = "wa", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(BILde;I)V")
