...
public class class520 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Lrt;)V", line = 24)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "()V", line = 40)
    ...
    @OriginalMember(owner = "client!ke", name = "b", descriptor = "(Lrt;)V", line = 50)
    ...
    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "()V", line = 56)
    public class520() {
        this.field7559[0] = 0;
