...
public class class520 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ZLtj;IILtj;)I", line = 19)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 125)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;B)V", line = 158)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IIB)Z", line = 173)
