...
public class class520 extends class18 {
    ...
    @OriginalMember(owner = "client!ew", name = "<init>", descriptor = "(Lhk;IIII[BI)V", line = 190)
    ...
    @OriginalMember(owner = "client!ew", name = "<init>", descriptor = "(Lhk;IIII)V", line = 206)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(IIIIIIIB)V", line = 11)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(I[Ljava/lang/String;)V", line = 25)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(III)Z", line = 95)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(Lha;Z)V", line = 106)
