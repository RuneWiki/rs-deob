...
public class class520 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lnc;)B")
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(Lnc;)B")
    ...
    @OriginalMember(owner = "client!tg", name = "c", descriptor = "(Lnc;)V")
    ...
    @OriginalMember(owner = "client!tg", name = "d", descriptor = "(Lnc;)V")
    ...
    @OriginalMember(owner = "client!tg", name = "e", descriptor = "(Lnc;)V")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILnc;)I")
