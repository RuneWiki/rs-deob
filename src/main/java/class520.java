...
public class class520 extends class354 implements class670 {
    ...
    @OriginalMember(owner = "client!hj", name = "e", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(ILoa;)Lgr;", line = 17)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(BLlt;I)V", line = 30)
    ...
    @OriginalMember(owner = "client!hj", name = "d", descriptor = "(B)Z", line = 220)
    ...
    @OriginalMember(owner = "client!hj", name = "g", descriptor = "(I)I", line = 232)
    ...
    @OriginalMember(owner = "client!hj", name = "b", descriptor = "(IILoa;)Lba;", line = 243)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(Loa;I)V", line = 265)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IILoa;)Lba;", line = 292)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(B)I", line = 307)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IILoa;I)Z", line = 320)
    ...
    @OriginalMember(owner = "client!hj", name = "c", descriptor = "(Loa;I)V", line = 342)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(Loa;B)V", line = 352)
    ...
    @OriginalMember(owner = "client!hj", name = "b", descriptor = "(B)I", line = 380)
    ...
    @OriginalMember(owner = "client!hj", name = "b", descriptor = "(I)Z", line = 391)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(ZIZIILfl;Loa;)V", line = 409)
    ...
    @OriginalMember(owner = "client!hj", name = "b", descriptor = "(Loa;I)Lok;", line = 440)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(I)V", line = 473)
    ...
    @OriginalMember(owner = "client!hj", name = "f", descriptor = "(B)V", line = 488)
    ...
    @OriginalMember(owner = "client!hj", name = "d", descriptor = "(I)V", line = 500)
    ...
    @OriginalMember(owner = "client!hj", name = "c", descriptor = "(B)I", line = 516)
    ...
    @OriginalMember(owner = "client!hj", name = "<init>", descriptor = "(Loa;Lbfa;IIIIIZIIIIIIZ)V", line = 527)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(ZLoa;II)Lau;", line = 560)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "()V", line = 603)
