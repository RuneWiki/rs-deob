...
public class class520 {
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(BII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(III)I", line = 15)
    ...
    @OriginalMember(owner = "client!kga", name = "toString", descriptor = "()Ljava/lang/String;", line = 34)
    public final String toString() {
        field7674++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(I)I", line = 42)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(B)V", line = 53)
    ...
    @OriginalMember(owner = "client!kga", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 76)
