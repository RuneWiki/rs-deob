...
public class class520 extends class645 implements class60 {
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(Lmba;II[III)V", line = 3)
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(Lmba;Lkca;II[BII)V", line = 17)
    ...
    @OriginalMember(owner = "client!ii", name = "b", descriptor = "(B)I", line = 35)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(III)Z", line = 46)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lkca;[BIIIIIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!ii", name = "b", descriptor = "(II)Z", line = 81)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(I)I", line = 93)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(BF)F", line = 107)
    ...
    @OriginalMember(owner = "client!ii", name = "e", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(Lmba;Lkca;Lwq;II)V", line = 130)
    ...
    @OriginalMember(owner = "client!ii", name = "c", descriptor = "(B)Z", line = 142)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "([IIIIBIII)V", line = 154)
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(Lmba;Lkca;II[FII)V", line = 178)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(IB)C", line = 192)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(FI)F", line = 227)
    public final float method567(float arg0, int arg1) {
        ++field7504;
        return arg1 != 17714 ? -0.55688465F : arg0;
    }

    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(ZIZ)V", line = 238)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "([IIIIIII)V", line = 253)
