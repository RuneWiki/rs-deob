...
public class class520 extends class128 {
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(IZIIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!gha", name = "<init>", descriptor = "(Lck;IIII)V", line = 36)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(Z[IIIIIIII)V", line = 50)
    ...
    @OriginalMember(owner = "client!gha", name = "f", descriptor = "(B)V", line = 99)
    ...
    @OriginalMember(owner = "client!gha", name = "<init>", descriptor = "(Lck;IIIIZ[FI)V", line = 118)
    ...
    @OriginalMember(owner = "client!gha", name = "d", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!gha", name = "<init>", descriptor = "(Lck;IIIIZ[IIIZ)V", line = 154)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(IIII)V", line = 207)
    ...
    @OriginalMember(owner = "client!gha", name = "<init>", descriptor = "(Lck;IIIIZ[BIZ)V", line = 234)
    ...
    @OriginalMember(owner = "client!gha", name = "<init>", descriptor = "(Lck;IIIII)V", line = 287)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(II)I", line = 223)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(Ltia;II)V", line = 303)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(IZZ)V", line = 327)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(BI[BIIIIIZI)V", line = 362)
