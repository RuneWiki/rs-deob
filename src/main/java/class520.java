...
public class class520 extends class134 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(II)V", line = 20)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Loh;I)V", line = 38)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IIILvp;)V", line = 51)
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(II)V", line = 83)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IIII)V", line = 99)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IIIFI)V", line = 122)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(II[I)V", line = 235)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IZ)V", line = 365)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "([[[Lcj;I)V", line = 377)
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "(Leo;IIIII)V", line = 456)
