...
public class class520 extends class184 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(III)Z", line = 21)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(I)Lrt;", line = 32)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(II)V", line = 51)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(III)V", line = 81)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IIIIIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!hv", name = "c", descriptor = "(I)V", line = 545)
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "(Lrv;II)V", line = 574)
    public class520(class111 arg0, int arg1, int arg2) {
        this.field6934 = new byte[arg1 * arg2];
    }

    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IIIIIIZLha;)V", line = 585)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IIIII)V", line = 598)
