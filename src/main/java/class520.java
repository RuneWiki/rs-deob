...
public class class520 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Liv;B)V", line = 10)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(BIC)I", line = 94)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IIIIIII)V", line = 129)
