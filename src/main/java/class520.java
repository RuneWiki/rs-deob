...
public class class520 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "()[B", line = 4)
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "()Lud;", line = 66)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lgga;II)Lgb;", line = 73)
    ...
    @OriginalMember(owner = "client!gb", name = "c", descriptor = "()I", line = 83)
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(Lol;)V", line = 129)
