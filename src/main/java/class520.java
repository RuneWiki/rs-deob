...
public class class520 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IIIIB)V", line = 8)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IIIII)V", line = 45)
