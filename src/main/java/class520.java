...
public class class520 extends class233 implements class74 {
    ...
    @OriginalMember(owner = "client!kn", name = "d", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(B[BII)V", line = 17)
    ...
    @OriginalMember(owner = "client!kn", name = "b", descriptor = "(B)I", line = 29)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(Lht;I[BIZ)V", line = 40)
    public class520(class410 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field7655 = arg1;
    }

    @OriginalMember(owner = "client!kn", name = "c", descriptor = "(B)I", line = 49)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(Lht;ILjaggl/memory/NativeBuffer;IZ)V", line = 60)
    public class520(class410 arg0, int arg1, NativeBuffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field7655 = arg1;
    }

    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(II)V", line = 68)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Z)V", line = 84)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(B)J", line = 99)
