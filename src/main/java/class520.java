...
public class class520 extends class71 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(II)V", line = 41)
    public class520(int arg0, int arg1) {
        this.field7251 = arg1;
        this.field7246 = arg0;
    }

    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(I[I[JII)V", line = 50)
