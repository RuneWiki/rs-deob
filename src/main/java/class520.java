...
public class class520 extends class140 implements class68 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ILqa;I)Lka;")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "(Lqa;Lcd;IIIIIZIIIIIII)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ILa;IIILqa;Z)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ILqa;)Lou;")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(BIILqa;)Z")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ZLqa;)V")
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(ZLqa;)V")
