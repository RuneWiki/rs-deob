...
public class class520 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Lgk;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!pt", name = "b", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IIIIIIIIII)V", line = 83)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IILgk;)V", line = 129)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(II)V", line = 174)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IZI)V", line = 275)
