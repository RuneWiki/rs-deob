...
public class class520 {
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(JLrc;B)V", line = 8)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(B)Lrc;", line = 30)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "([Lrc;I)I", line = 63)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(Z)V", line = 91)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(I)Lrc;", line = 103)
    ...
    @OriginalMember(owner = "client!jw", name = "b", descriptor = "(B)V", line = 118)
    ...
    @OriginalMember(owner = "client!jw", name = "c", descriptor = "(B)I", line = 153)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(JB)Lrc;", line = 167)
    ...
    @OriginalMember(owner = "client!jw", name = "d", descriptor = "(B)Lrc;", line = 195)
    ...
    @OriginalMember(owner = "client!jw", name = "b", descriptor = "(Z)I", line = 232)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(IBI)Z", line = 265)
    ...
    @OriginalMember(owner = "client!jw", name = "<init>", descriptor = "(I)V", line = 275)
