...
public class class520 extends class231 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Lql;Z)V")
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "([Lfaa;IIIIIIIIB)V")
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(IIILti;Lti;)V")
