...
public class class520 extends class626 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(ILjava/lang/String;)V", line = 11)
    ...
    @OriginalMember(owner = "client!sf", name = "<init>", descriptor = "(I[B)V", line = 29)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(III)Z", line = 93)
