...
public class class520 extends class328 {
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "()V", line = 77)
    public class520() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(II[I[II)V", line = 21)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!ek", name = "f", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(II)[I", line = 171)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(BILco;)V", line = 286)
