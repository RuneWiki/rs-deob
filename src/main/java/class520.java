...
public class class520 extends class452 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(ILhp;I)V")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(BLul;I)Llm;")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(ILhp;)V")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Luq;III)V")
