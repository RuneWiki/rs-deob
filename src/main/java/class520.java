...
public class class520 extends class241 {
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(IB)Ltf;")
    ...
    @OriginalMember(owner = "client!hha", name = "f", descriptor = "(I)Lef;")
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(Ljda;I)V")
