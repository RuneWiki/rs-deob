...
public class class520 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ILrl;BLjava/lang/Object;)V", line = 3)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ILlfa;)V", line = 34)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IBI)V", line = 62)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(I)I", line = 77)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Lrl;I)V", line = 88)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Z)I", line = 114)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ILrl;)Ljava/lang/Object;", line = 139)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Ljava/lang/Object;ILrl;)V", line = 194)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(Z)V", line = 207)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ZLud;I)V", line = 234)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(I)V", line = 398)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(II)V", line = 415)
