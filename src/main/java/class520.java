...
public class class520 extends class491 implements class406 {
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(IIILua;II[BII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ew", name = "<init>", descriptor = "(Ler;IIZ[III)V", line = 44)
    ...
    @OriginalMember(owner = "client!ew", name = "b", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(ILse;)V", line = 115)
    public final void method1170(int arg0, class267 arg1) {
        super.method1170(arg0, arg1);
    }

    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(I)Z", line = 123)
    ...
    @OriginalMember(owner = "client!ew", name = "<init>", descriptor = "(Ler;Lua;Ldn;II)V", line = 132)
    ...
    @OriginalMember(owner = "client!ew", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 152)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(B)I", line = 162)
    public final int method3162(byte arg0) {
        return arg0 == 112 ? this.field7691 : 23;
    }

    @OriginalMember(owner = "client!ew", name = "<init>", descriptor = "(Ler;Lua;IIZ[BII)V", line = 171)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(FZ)F", line = 230)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(ZIZ)V", line = 240)
    ...
    @OriginalMember(owner = "client!ew", name = "b", descriptor = "(B)I", line = 251)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(FI)F", line = 261)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(III[IIBII)V", line = 271)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(I[IIIIII)V", line = 309)
