...
public abstract class class520 {
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "([BZI)V", line = 48)
    ...
    @OriginalMember(owner = "client!si", name = "e", descriptor = "(I)V", line = 98)
    public static void method3134(int arg0) {
        int var1 = 6 % ((arg0 + 75) / 42);
        field7517 = null;
    }

    @OriginalMember(owner = "client!si", name = "a", descriptor = "(II)Z", line = 108)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Lri;I)V", line = 119)
    ...
    @OriginalMember(owner = "client!si", name = "h", descriptor = "(I)Z", line = 137)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Z)V", line = 147)
