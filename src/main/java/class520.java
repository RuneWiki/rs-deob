...
public class class520 {
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(ZJ[B)V", line = 51)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(ZI[B)V", line = 141)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(IBIII[B)Z", line = 196)
    ...
    @OriginalMember(owner = "client!iaa", name = "b", descriptor = "(I)V", line = 279)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(IIIIIIIIII)V", line = 400)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(IIII)V", line = 476)
