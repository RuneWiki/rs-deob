...
public class class520 extends class261 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Les;Les;B)V", line = 7)
    ...
    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "()V", line = 23)
    public class520() {
    }

    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "(J)V", line = 26)
    public class520(long arg0) {
        this.field7557 = arg0;
    }

    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!ql", name = "c", descriptor = "(I)V", line = 69)
