...
public class IdkType {
    ...
    @OriginalMember(owner = "client!dc", name = "b", descriptor = "[Ldc;")
    public static IdkType[] field863;

    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(ZLub;)V")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(ILkb;)V")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "()Leb;")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(I)Leb;")
