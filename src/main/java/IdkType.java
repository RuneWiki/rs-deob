...
public class IdkType {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Ltb;I)V")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(BLjb;)V")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "()Ldb;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(I)Ldb;")
