...
public class IdkType {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lxb;I)V")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Llb;B)V")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Z)Leb;")
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(B)Leb;")
