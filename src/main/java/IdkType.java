...
public class IdkType {
    ...
    @OriginalMember(owner = "client!gc", name = "e", descriptor = "[Lgc;")
    public static IdkType[] field950;

    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(Lub;I)V")
    public static void method318(Jagfile arg0, int arg1) {
        Packet var2 = new Packet(363, arg0.method257("idk.dat", null, (byte) 2));
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(ZLkb;)V")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "()Leb;")
