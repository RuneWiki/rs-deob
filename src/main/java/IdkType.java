...
public class IdkType {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(ZLlb;)V")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(B)Leb;")
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(I)Leb;")
