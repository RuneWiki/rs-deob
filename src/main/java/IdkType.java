...
public class IdkType {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ILyb;)V")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(BLmb;)V")
    ...
    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(I)Leb;")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Z)Leb;")
