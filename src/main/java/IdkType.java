...
public class IdkType {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lyb;B)V")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(ZLmb;)V")
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(I)Lfb;")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(B)Lfb;")
