...
public class IdkType {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(ZLyb;)V")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(ILmb;)V")
    ...
    @OriginalMember(owner = "client!lc", name = "c", descriptor = "(I)Lfb;")
