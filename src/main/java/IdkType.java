...
public class IdkType {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lyb;I)V")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lmb;B)V")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(I)Lfb;")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Z)Lfb;")
