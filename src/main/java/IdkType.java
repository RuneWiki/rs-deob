...
public class IdkType {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(ILxb;)V")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Llb;I)V")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(I)Leb;")
    ...
    @OriginalMember(owner = "client!lc", name = "c", descriptor = "(I)Leb;")
