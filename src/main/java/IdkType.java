...
public class IdkType {
    ...
    @OriginalMember(owner = "client!gc", name = "c", descriptor = "[Lgc;")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(Lkb;I)V")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(I)Leb;")
