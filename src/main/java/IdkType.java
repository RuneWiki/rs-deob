...
public class IdkType {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(ILyb;)V")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(ZLmb;)V")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(B)Lfb;")
