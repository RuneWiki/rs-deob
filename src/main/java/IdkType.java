...
public class IdkType {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(ILmb;)V")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(I)Lfb;")
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(Z)Lfb;")
