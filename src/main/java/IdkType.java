...
public class IdkType {
    ...
    @OriginalMember(owner = "client!gc", name = "d", descriptor = "[Lgc;")
    public static IdkType[] field943;

    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(ILub;)V")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(Lkb;Z)V")
