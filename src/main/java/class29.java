...
public class class29 implements class129 {
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(Ljaclib/memory/Source;IBI)Z")
    ...
    @OriginalMember(owner = "client!qaa", name = "<init>", descriptor = "(Lus;Z)V")
