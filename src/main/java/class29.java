...
public class class29 extends class420 {
    ...
    @OriginalMember(owner = "client!be", name = "b", descriptor = "(B)C", line = 4)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Lci;II)I", line = 15)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ZLjava/awt/Component;)Loh;", line = 28)
    ...
    @OriginalMember(owner = "client!be", name = "b", descriptor = "(III)Z", line = 39)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ILci;ILjava/lang/String;)Lmg;", line = 51)
    ...
    @OriginalMember(owner = "client!be", name = "e", descriptor = "(B)Z", line = 140)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(II)I", line = 154)
    public static int method239(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!be", name = "c", descriptor = "(III)Leb;", line = 162)
    ...
    @OriginalMember(owner = "client!be", name = "f", descriptor = "(B)V", line = 172)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Z)J", line = 185)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(I)V", line = 201)
    ...
    @OriginalMember(owner = "client!be", name = "c", descriptor = "(B)I", line = 213)
    ...
    @OriginalMember(owner = "client!be", name = "d", descriptor = "(B)I", line = 227)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IIIIBII)V", line = 237)
