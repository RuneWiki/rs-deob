...
public abstract class class29 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(BII)V", line = 4)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ZIB)V", line = 22)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IB)Z", line = 134)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(II)I", line = 147)
