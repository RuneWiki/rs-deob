...
public class class29 implements class630 {
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(I)Lag;", line = 5)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(Lkp;Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!mga", name = "<init>", descriptor = "(I)V", line = 47)
