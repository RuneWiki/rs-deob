...
public class class29 extends class578 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!o", name = "c", descriptor = "(III)V", line = 14)
    ...
    @OriginalMember(owner = "client!o", name = "b", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!o", name = "b", descriptor = "(III)V", line = 45)
    ...
    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "(IIIIII)V", line = 58)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ILcea;)Lot;", line = 74)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(BILmf;IZZLmf;)I", line = 112)
