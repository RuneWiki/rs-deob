...
public class class29 {
    ...
    @OriginalMember(owner = "client!aba", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!aba", name = "b", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(B)V", line = 205)
    ...
    @OriginalMember(owner = "client!aba", name = "<init>", descriptor = "(Ljj;Lbd;Leh;IIIII)V", line = 286)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(ILuba;B)V", line = 267)
