...
public class class29 extends class211 {
    ...
    @OriginalMember(owner = "client!qaa", name = "<init>", descriptor = "()V", line = 3)
    public class29() {
        super(1, true);
    }

    @OriginalMember(owner = "client!qaa", name = "b", descriptor = "(II)[I", line = 6)
    ...
    @OriginalMember(owner = "client!qaa", name = "g", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(IJIIZIILla;)V", line = 58)
    ...
    @OriginalMember(owner = "client!qaa", name = "c", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(BILib;)V", line = 100)
