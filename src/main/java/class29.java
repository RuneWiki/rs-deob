...
public class class29 extends class47 implements class218 {
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "(Ltq;Lvc;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(BZLtq;Lhm;III)V")
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Ltq;IIIIIIIIILns;)Lns;")
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(Ltq;I)Lcj;")
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(BILtq;)Lns;")
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(BLtq;)V")
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Ltq;I)V")
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Ltq;III)Z")
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(ILtq;)V")
