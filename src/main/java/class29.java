...
@OriginalClass("client!KWSXZIVG")
public class class29 extends class50 {

    @OriginalMember(owner = "client!KWSXZIVG", name = "qb", descriptor = "J")
    public long field847 = -1L;

    @OriginalMember(owner = "client!KWSXZIVG", name = "rb", descriptor = "Z")
    public boolean field848 = false;

    @OriginalMember(owner = "client!KWSXZIVG", name = "ub", descriptor = "Z")
    public boolean field851 = false;

    @OriginalMember(owner = "client!KWSXZIVG", name = "vb", descriptor = "I")
    private int field852 = 613;

    @OriginalMember(owner = "client!KWSXZIVG", name = "wb", descriptor = "Z")
    private boolean field853 = true;

    @OriginalMember(owner = "client!KWSXZIVG", name = "Ab", descriptor = "[I")
    public int[] field857 = new int[5];

    @OriginalMember(owner = "client!KWSXZIVG", name = "Cb", descriptor = "B")
    private byte field859 = 4;

    @OriginalMember(owner = "client!KWSXZIVG", name = "Qb", descriptor = "[I")
    public int[] field873 = new int[12];

    @OriginalMember(owner = "client!KWSXZIVG", name = "zb", descriptor = "LECXUVDNP;")
    public static class12 field856 = new class12(0, 260);

    @OriginalMember(owner = "client!KWSXZIVG", name = "ob", descriptor = "I")
    public int field845;

    @OriginalMember(owner = "client!KWSXZIVG", name = "pb", descriptor = "I")
    public int field846;

    @OriginalMember(owner = "client!KWSXZIVG", name = "xb", descriptor = "I")
    private int field854;

    @OriginalMember(owner = "client!KWSXZIVG", name = "yb", descriptor = "I")
    public int field855;

    @OriginalMember(owner = "client!KWSXZIVG", name = "Db", descriptor = "I")
    public int field860;

    @OriginalMember(owner = "client!KWSXZIVG", name = "Eb", descriptor = "I")
    public int field861;

    @OriginalMember(owner = "client!KWSXZIVG", name = "Fb", descriptor = "I")
    public int field862;

    @OriginalMember(owner = "client!KWSXZIVG", name = "Hb", descriptor = "I")
    public int field864;

    @OriginalMember(owner = "client!KWSXZIVG", name = "Ib", descriptor = "I")
    public int field865;

    @OriginalMember(owner = "client!KWSXZIVG", name = "Jb", descriptor = "I")
    public int field866;

    @OriginalMember(owner = "client!KWSXZIVG", name = "Kb", descriptor = "I")
    public int field867;

    @OriginalMember(owner = "client!KWSXZIVG", name = "Lb", descriptor = "I")
    public int field868;

    @OriginalMember(owner = "client!KWSXZIVG", name = "Mb", descriptor = "I")
    public int field869;

    @OriginalMember(owner = "client!KWSXZIVG", name = "Nb", descriptor = "I")
    public int field870;
    ...
    @OriginalMember(owner = "client!KWSXZIVG", name = "tb", descriptor = "J")
    public long field850;

    @OriginalMember(owner = "client!KWSXZIVG", name = "Bb", descriptor = "LCOIHKGSL;")
    public class6 field858;

    @OriginalMember(owner = "client!KWSXZIVG", name = "Gb", descriptor = "LYYHPBDED;")
    public class70 field863;

    @OriginalMember(owner = "client!KWSXZIVG", name = "sb", descriptor = "Ljava/lang/String;")
    public String field849;

    @OriginalMember(owner = "client!KWSXZIVG", name = "a", descriptor = "(BLMQZHAILV;)V")
    ...
    @OriginalMember(owner = "client!KWSXZIVG", name = "b", descriptor = "(I)LYYHPBDED;")
    ...
    @OriginalMember(owner = "client!KWSXZIVG", name = "b", descriptor = "(Z)LYYHPBDED;")
    ...
    @OriginalMember(owner = "client!KWSXZIVG", name = "a", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!KWSXZIVG", name = "a", descriptor = "(Z)LYYHPBDED;")
