...
public class class29 extends class306 {
    ...
    @OriginalMember(owner = "client!be", name = "c", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!be", name = "f", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!be", name = "c", descriptor = "(I)I", line = 34)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ZC)Z", line = 46)
    ...
    @OriginalMember(owner = "client!be", name = "d", descriptor = "(B)J", line = 81)
    ...
    @OriginalMember(owner = "client!be", name = "e", descriptor = "(B)I", line = 98)
