...
public class class29 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ILtc;)V", line = 3)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(B)Lmh;", line = 20)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ILkq;)V", line = 42)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "()V", line = 90)
    public class29() {
    }

    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(Ltc;)V", line = 92)
    public class29(class196 arg0) {
        this.field463 = arg0;
    }

    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(I)Lmh;", line = 104)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(I)V", line = 125)
