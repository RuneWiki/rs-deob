...
public class class29 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Lwm;III)V")
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IILwm;)V")
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Ldu;I)V")
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Lza;)V")
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Loi;Lza;I)V")
