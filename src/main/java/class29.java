...
public class class29 extends class338 {
    ...
    @OriginalMember(owner = "client!ms", name = "c", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(Lfu;)V", line = 96)
    ...
    @OriginalMember(owner = "client!ms", name = "b", descriptor = "(Z)V", line = 77)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Ltp;)V", line = 204)
    public final void method188(class375 arg0) {
        this.field4685.method303(arg0);
    }

    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(I)V", line = 207)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Z)V", line = 216)
    public final void method190(boolean arg0) {
        this.field4685.method353(8448, 7681);
    }

    @OriginalMember(owner = "client!ms", name = "b", descriptor = "()Z", line = 219)
    public final boolean method191() {
        return true;
    }

    @OriginalMember(owner = "client!ms", name = "a", descriptor = "()V", line = 222)
