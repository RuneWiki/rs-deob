...
public class class29 implements class457 {
    ...
    @OriginalMember(owner = "client!qaa", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(Lst;I)Z", line = 23)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(B)J", line = 69)
