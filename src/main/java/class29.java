...
public class class29 extends class497 {
    ...
    @OriginalMember(owner = "client!qaa", name = "b", descriptor = "(ZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!qaa", name = "c", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(III)V", line = 71)
    ...
    @OriginalMember(owner = "client!qaa", name = "<init>", descriptor = "(Ldia;Lmha;)V", line = 220)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(ILil;I)V", line = 115)
    ...
    @OriginalMember(owner = "client!qaa", name = "d", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!qaa", name = "b", descriptor = "(I)Z", line = 186)
    public final boolean method157(int arg0) {
        ++field422;
        return arg0 != -6808 ? true : this.field421;
    }

    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(IZ)V", line = 198)
    ...
    @OriginalMember(owner = "client!qaa", name = "b", descriptor = "(III)Z", line = 208)
