...
public class class29 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(BLqa;Lm;)V")
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ILmd;)V")
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(BLmd;)Ljava/lang/String;")
