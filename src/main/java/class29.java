...
@OriginalClass("client!LRDFYKJP")
public class class29 {

    @OriginalMember(owner = "client!LRDFYKJP", name = "a", descriptor = "I")
    private int field889;

    @OriginalMember(owner = "client!LRDFYKJP", name = "d", descriptor = "I")
    public int field892;

    @OriginalMember(owner = "client!LRDFYKJP", name = "e", descriptor = "I")
    public int field893;

    @OriginalMember(owner = "client!LRDFYKJP", name = "f", descriptor = "I")
    public int field894;

    @OriginalMember(owner = "client!LRDFYKJP", name = "g", descriptor = "I")
    private int field895;

    @OriginalMember(owner = "client!LRDFYKJP", name = "h", descriptor = "I")
    private int field896;

    @OriginalMember(owner = "client!LRDFYKJP", name = "i", descriptor = "I")
    private int field897;

    @OriginalMember(owner = "client!LRDFYKJP", name = "j", descriptor = "I")
    private int field898;

    @OriginalMember(owner = "client!LRDFYKJP", name = "k", descriptor = "I")
    private int field899;

    @OriginalMember(owner = "client!LRDFYKJP", name = "l", descriptor = "I")
    public static int field900;

    @OriginalMember(owner = "client!LRDFYKJP", name = "b", descriptor = "[I")
    private int[] field890;

    @OriginalMember(owner = "client!LRDFYKJP", name = "c", descriptor = "[I")
    private int[] field891;

    @OriginalMember(owner = "client!LRDFYKJP", name = "a", descriptor = "(LMUKVLYLC;Z)V")
    ...
    @OriginalMember(owner = "client!LRDFYKJP", name = "b", descriptor = "(LMUKVLYLC;Z)V")
    ...
    @OriginalMember(owner = "client!LRDFYKJP", name = "a", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!LRDFYKJP", name = "a", descriptor = "(II)I")
