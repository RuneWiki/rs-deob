...
public class class29 extends class724 implements class445 {
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(Ljc;IZ[[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "([BZII[BIIII)V", line = 115)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(DI)V", line = 159)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ZI)V", line = 190)
    ...
    @OriginalMember(owner = "client!ta", name = "c", descriptor = "(Z)V", line = 205)
