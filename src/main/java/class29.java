...
public class class29 extends class56 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ILee;I)V", line = 15)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ZBLem;)V", line = 58)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(II)[[I", line = 74)
    ...
    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "()V", line = 203)
    public class29() {
        super(1, false);
    }

    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IIII)V", line = 148)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Z)V", line = 212)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IIBI)V", line = 245)
    ...
    @OriginalMember(owner = "client!o", name = "c", descriptor = "(B)V", line = 352)
