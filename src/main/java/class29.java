...
public class class29 extends class302 {
    ...
    @OriginalMember(owner = "client!qaa", name = "g", descriptor = "(I)Lsp;")
    ...
    @OriginalMember(owner = "client!qaa", name = "b", descriptor = "(III)Ltc;")
    ...
    @OriginalMember(owner = "client!qaa", name = "<init>", descriptor = "(Lwf;Ljava/lang/Object;I)V")
