...
public class class29 {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "(III)V", line = 170)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IZ)[I", line = 47)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(I)[[I", line = 144)
