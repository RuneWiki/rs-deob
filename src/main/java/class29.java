...
public class class29 {
    ...
    @OriginalMember(owner = "client!HSZHZJQR", name = "d", descriptor = "[LIHAIACWA;")
    ...
    @OriginalMember(owner = "client!HSZHZJQR", name = "a", descriptor = "(J)LIHAIACWA;")
    ...
    @OriginalMember(owner = "client!HSZHZJQR", name = "a", descriptor = "(BJLIHAIACWA;)V")
