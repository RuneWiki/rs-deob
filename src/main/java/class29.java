...
public class class29 extends class283 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!be", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 21)
    ...
    @OriginalMember(owner = "client!be", name = "b", descriptor = "(Z)V", line = 32)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Ljava/awt/Canvas;I)V", line = 43)
    ...
    @OriginalMember(owner = "client!be", name = "d", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!be", name = "b", descriptor = "(II)V", line = 82)
    ...
    @OriginalMember(owner = "client!be", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 97)
    public final void startProduction(ImageConsumer arg0) {
        ++field482;
        this.addConsumer(arg0);
    }

    @OriginalMember(owner = "client!be", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 107)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field485;
    }

    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IIILjava/awt/Graphics;)V", line = 117)
    ...
    @OriginalMember(owner = "client!be", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 129)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field477;
        return this.field472 == arg0;
    }

    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ILjava/awt/Graphics;IIII)V", line = 137)
    ...
    @OriginalMember(owner = "client!be", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 158)
