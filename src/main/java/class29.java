...
public class class29 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(B)Lpha;")
    ...
    @OriginalMember(owner = "client!o", name = "c", descriptor = "(B)Lpha;")
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ZLpha;)V")
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Z)Lpha;")
    ...
    @OriginalMember(owner = "client!o", name = "d", descriptor = "(B)Lpha;")
