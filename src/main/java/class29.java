...
public class class29 extends class176 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IZBLqa;J)V")
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ILnj;)Loc;")
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "(Lqa;Llq;Ljg;J)V")
