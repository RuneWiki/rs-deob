...
public class class29 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IIIIIFFF)[F", line = 3)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ILjava/lang/String;BLjava/lang/String;Ljava/lang/String;ILjava/lang/String;I)V", line = 83)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Z)V", line = 126)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "([JI[Ljava/lang/Object;BI)V", line = 181)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IIZII)I", line = 244)
