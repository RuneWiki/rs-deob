...
public class class29 {
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(Z)Ljava/io/File;", line = 5)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(ZII[B)V", line = 18)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!qaa", name = "finalize", descriptor = "()V", line = 56)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 69)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "([BIII)I", line = 100)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(BJ)V", line = 122)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(CLjava/lang/String;I)[Ljava/lang/String;", line = 135)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(B)J", line = 170)
    ...
    @OriginalMember(owner = "client!qaa", name = "<init>", descriptor = "(Ljava/io/File;Ljava/lang/String;J)V", line = 180)
