...
public class class29 extends InputStream {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "([JB[Ljava/lang/Object;)V", line = 17)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!rc", name = "read", descriptor = "()I", line = 52)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IILjava/io/File;)[B", line = 62)
