...
public class class29 {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!bw", name = "b", descriptor = "(Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(BLdaa;J)V", line = 80)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(JI)V", line = 110)
    ...
    @OriginalMember(owner = "client!bw", name = "<init>", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IJ)Ldaa;", line = 138)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(BI)Z", line = 175)
