...
public abstract class class29 {
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(IJ)I", line = 5)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(IBILsea;)Lnba;", line = 22)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(III[IIIIILnn;IIZ[III)I", line = 42)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(I)V", line = 217)
