...
public class class29 extends class201 {
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "()V", line = 67)
    public class29() {
    ...
    @OriginalMember(owner = "client!vd", name = "c", descriptor = "(B)J", line = 7)
    ...
    @OriginalMember(owner = "client!vd", name = "b", descriptor = "(I)J", line = 41)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(II)I", line = 83)
