...
public class class29 extends class656 {
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(ZS)V", line = 5)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(IIIIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(Lkk;ILjava/lang/Object;)V", line = 196)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(FBFF)F", line = 237)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(I)V", line = 250)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(I[[ZIII)V", line = 267)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(BI)V", line = 323)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(B)V", line = 338)
    ...
    @OriginalMember(owner = "client!iha", name = "<init>", descriptor = "(Lrv;Lvia;Ltn;[I)V", line = 352)
