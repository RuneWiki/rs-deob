...
public class class29 {
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(ZILjava/lang/Object;J)V", line = 179)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(Z)I", line = 211)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(Lrfa;ILsg;Lha;Lvb;IIZI)V", line = 235)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(Lwj;Z)V", line = 276)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(B)V", line = 296)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(II)V", line = 307)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(ZJLjava/lang/Object;)V", line = 361)
    ...
    @OriginalMember(owner = "client!iha", name = "<init>", descriptor = "(I)V", line = 373)
    public class29(int arg0) {
        this(arg0, arg0);
    }

    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(I)I", line = 376)
    ...
    @OriginalMember(owner = "client!iha", name = "f", descriptor = "(I)I", line = 390)
    ...
    @OriginalMember(owner = "client!iha", name = "e", descriptor = "(I)V", line = 401)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(BI)Z", line = 432)
    ...
    @OriginalMember(owner = "client!iha", name = "b", descriptor = "(IJ)V", line = 460)
    ...
    @OriginalMember(owner = "client!iha", name = "<init>", descriptor = "(II)V", line = 510)
    ...
    @OriginalMember(owner = "client!iha", name = "d", descriptor = "(I)Ljava/lang/Object;", line = 480)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(IJ)Ljava/lang/Object;", line = 525)
    ...
    @OriginalMember(owner = "client!iha", name = "b", descriptor = "(I)Ljava/lang/Object;", line = 568)
    ...
    @OriginalMember(owner = "client!iha", name = "c", descriptor = "(I)V", line = 599)
