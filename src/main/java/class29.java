...
public class class29 extends class694 {
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!mca", name = "d", descriptor = "(III)Z", line = 17)
    ...
    @OriginalMember(owner = "client!mca", name = "<init>", descriptor = "()V", line = 81)
    public class29() {
        super(0, true);
    }

    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(ILjr;B)V", line = 34)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(II)[I", line = 88)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(IIIIIII)I", line = 175)
