...
public class class29 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IB)V", line = 35)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Ljava/awt/Component;B)Laa;", line = 69)
