...
public class class29 extends class148 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!be", name = "e", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IIB)V", line = 63)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Z)V", line = 84)
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "()V", line = 97)
    public class29() {
        super(0, true);
    }

    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Lse;[I[II[I)V", line = 100)
