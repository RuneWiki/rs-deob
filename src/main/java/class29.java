...
public class class29 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ILug;I)V", line = 34)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Lug;I)V", line = 268)
    ...
    @OriginalMember(owner = "client!be", name = "b", descriptor = "(I)V", line = 290)
