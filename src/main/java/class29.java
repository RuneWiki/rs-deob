...
public class class29 {
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(II)Lpv;", line = 14)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(III)Laf;", line = 60)
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(Luea;ILpq;)V", line = 83)
