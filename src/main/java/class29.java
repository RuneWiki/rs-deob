...
public class class29 extends class609 {
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "()V", line = 4)
    public static void method326() {
        field436 = null;
        field438 = null;
    }

    @OriginalMember(owner = "client!mca", name = "b", descriptor = "()V", line = 8)
    private final void method327() {
        this.field435 = false;
    }

    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(J)V", line = 12)
    public final void method328(long arg0) {
        this.field439 = arg0;
    }

    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(IZ)Lmca;", line = 16)
    ...
    @OriginalMember(owner = "client!mca", name = "c", descriptor = "()V", line = 30)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "([Lin;Z)V", line = 68)
    ...
    @OriginalMember(owner = "client!mca", name = "b", descriptor = "(IZ)V", line = 156)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(IIIII)V", line = 163)
    public final void method333(int arg0, int arg1, int arg2, int arg3, int arg4) {
        this.field447 = arg0;
    }

    @OriginalMember(owner = "client!mca", name = "d", descriptor = "()V", line = 174)
    public final void method334() {
        this.field435 = true;
    }

    @OriginalMember(owner = "client!mca", name = "e", descriptor = "()Lvi;", line = 178)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Lr;J[Llea;[Lin;Z)V", line = 195)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Lr;J)Z", line = 203)
    ...
    @OriginalMember(owner = "client!mca", name = "f", descriptor = "()V", line = 251)
    public final void method338() {
        this.field444 = true;
    }

    @OriginalMember(owner = "client!mca", name = "<init>", descriptor = "(IZ)V", line = 394)
    private class29(int arg0, boolean arg1) {
        this.method332(arg0, arg1);
    }

    @OriginalMember(owner = "client!mca", name = "g", descriptor = "()Lvi;", line = 262)
    public final class499 method339() {
        return this.field443;
    }

    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Lr;[Llea;Z)V", line = 270)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Lr;)V", line = 345)
