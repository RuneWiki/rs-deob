...
public class class29 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Lnc;IIIILqq;I)Lcd;")
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Lfo;IZILfo;BLnc;IIILqq;III)Lcd;")
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ILqq;IZIIIILfo;Lnc;IILfo;)Lcd;")
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IILha;)V")
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Lqq;Lnc;IIIII)Lcd;")
