...
public class class29 extends class516 {
    ...
    @OriginalMember(owner = "client!mca", name = "c", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Lpb;II)V")
    ...
    @OriginalMember(owner = "client!mca", name = "<init>", descriptor = "(Lcb;)V")
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(ZIILuh;I)V")
