...
public abstract class class29 {
    ...
    @OriginalMember(owner = "client!ch", name = "c", descriptor = "Lsc;")
    public static class169 field619;

    @OriginalMember(owner = "client!ch", name = "i", descriptor = "Lbg;")
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IB[Llf;I)Llf;")
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IIIIIIILja;)V")
