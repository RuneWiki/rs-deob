...
public class class29 extends class89 implements class149 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ILe;IIZLhm;I)V", line = 14)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(Le;IB)Lid;", line = 47)
    ...
    @OriginalMember(owner = "client!gs", name = "c", descriptor = "(I)Z", line = 67)
    ...
    @OriginalMember(owner = "client!gs", name = "f", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IIILe;)Z", line = 90)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Le;Z)Lum;", line = 109)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(B)Z", line = 136)
    public final boolean method190(byte arg0) {
        ++field348;
        return arg0 > -126 ? false : this.field327;
    }

    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IILe;Z)Lns;", line = 151)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(II)Lls;", line = 182)
    ...
    @OriginalMember(owner = "client!gs", name = "d", descriptor = "(I)V", line = 212)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(Le;Lfa;IIIIZIIZ)V", line = 233)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Le;I)V", line = 272)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(I)I", line = 305)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(Le;B)V", line = 321)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Z)I", line = 331)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(I)V", line = 347)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Le;B)V", line = 365)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Le;IB)Lid;", line = 392)
