...
public class class29 {
    ...
    @OriginalMember(owner = "client!JDDBCSRY", name = "m", descriptor = "I")
    ...
    @OriginalMember(owner = "client!JDDBCSRY", name = "a", descriptor = "(ZLXGRGMPUQ;)V")
    ...
    @OriginalMember(owner = "client!JDDBCSRY", name = "a", descriptor = "(LXGRGMPUQ;I)V")
