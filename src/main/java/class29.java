...
public class class29 extends class134 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IIBI)V", line = 4)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IB)V", line = 27)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(BI)V", line = 40)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(BI[I)V", line = 58)
    ...
    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "(Lum;IIIII)V", line = 364)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(B)V", line = 223)
    public static void method149(byte arg0) {
        field321 = null;
        int var1 = -57 / ((arg0 + 38) / 62);
    }

    @OriginalMember(owner = "client!o", name = "a", descriptor = "(II)V", line = 232)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ZIFII)V", line = 245)
