...
public class class29 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IILkh;)V", line = 4)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Lkh;B)V", line = 20)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Z)V", line = 89)
