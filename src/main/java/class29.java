...
public class class29 {
    ...
    @OriginalMember(owner = "client!mga", name = "c", descriptor = "()Ljda;")
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(Lla;II)Lmga;")
    ...
    @OriginalMember(owner = "client!mga", name = "<init>", descriptor = "(Lsl;)V")
