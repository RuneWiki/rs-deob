...
@OriginalClass("client!IDSYSMIG")
public class class29 {

    @OriginalMember(owner = "client!IDSYSMIG", name = "a", descriptor = "I")
    private int field1049 = -4942;

    @OriginalMember(owner = "client!IDSYSMIG", name = "e", descriptor = "I")
    public int field1053 = -1;

    @OriginalMember(owner = "client!IDSYSMIG", name = "g", descriptor = "[I")
    public int[] field1055 = new int[6];

    @OriginalMember(owner = "client!IDSYSMIG", name = "h", descriptor = "[I")
    public int[] field1056 = new int[6];

    @OriginalMember(owner = "client!IDSYSMIG", name = "i", descriptor = "[I")
    public int[] field1057 = new int[] { -1, -1, -1, -1, -1 };

    @OriginalMember(owner = "client!IDSYSMIG", name = "j", descriptor = "Z")
    public boolean field1058 = false;

    @OriginalMember(owner = "client!IDSYSMIG", name = "c", descriptor = "I")
    public static int field1051;

    @OriginalMember(owner = "client!IDSYSMIG", name = "b", descriptor = "Z")
    private static boolean field1050;

    @OriginalMember(owner = "client!IDSYSMIG", name = "f", descriptor = "[I")
    public int[] field1054;

    @OriginalMember(owner = "client!IDSYSMIG", name = "d", descriptor = "[LIDSYSMIG;")
    public static class29[] field1052;

    @OriginalMember(owner = "client!IDSYSMIG", name = "a", descriptor = "(ZLEAXVDNXA;)V")
    ...
    @OriginalMember(owner = "client!IDSYSMIG", name = "a", descriptor = "(BLCKBTFRZM;)V")
    ...
    @OriginalMember(owner = "client!IDSYSMIG", name = "a", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!IDSYSMIG", name = "b", descriptor = "(I)LGFYXEFQY;")
    ...
    @OriginalMember(owner = "client!IDSYSMIG", name = "a", descriptor = "(B)Z")
    ...
    @OriginalMember(owner = "client!IDSYSMIG", name = "b", descriptor = "(B)LGFYXEFQY;")
    ...
    @OriginalMember(owner = "client!IDSYSMIG", name = "<init>", descriptor = "()V")
    public class29() {
