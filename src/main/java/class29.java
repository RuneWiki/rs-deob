...
public class class29 {
    ...
    @OriginalMember(owner = "client!ICYTWAKR", name = "b", descriptor = "LICYTWAKR;")
    public class29 field876;

    @OriginalMember(owner = "client!ICYTWAKR", name = "c", descriptor = "LICYTWAKR;")
    public class29 field877;

    @OriginalMember(owner = "client!ICYTWAKR", name = "d", descriptor = "Z")
