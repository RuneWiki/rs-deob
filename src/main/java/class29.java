...
public class class29 extends class83 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IBLtq;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ff", name = "d", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(II)[I", line = 80)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(ZI)I", line = 213)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(Z)V", line = 224)
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "()V", line = 334)
    public class29() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ff", name = "d", descriptor = "(II)V", line = 245)
    ...
    @OriginalMember(owner = "client!ff", name = "c", descriptor = "(Z)V", line = 281)
