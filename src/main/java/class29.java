...
public class class29 extends class55 {
    ...
    @OriginalMember(owner = "client!o", name = "g", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "(Ltk;Lnd;Ltn;)V", line = 35)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IZ)V", line = 51)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ZB)V", line = 64)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IIBI)I", line = 75)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IIZ)V", line = 88)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IILfe;)V", line = 121)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Z)V", line = 132)
    ...
    @OriginalMember(owner = "client!o", name = "f", descriptor = "(I)Z", line = 146)
