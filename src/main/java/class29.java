...
public class class29 {
    ...
    private int[] field931 = new int[256];

    @OriginalMember(owner = "client!KDQJDBED", name = "b", descriptor = "[I")
    private int[] field930 = new int[256];
    ...
    public final int method317() {
        ...
        return this.field930[this.field929];
    }

    @OriginalMember(owner = "client!KDQJDBED", name = "b", descriptor = "()V")
    private final void method318() {
        this.field933 += ++this.field934;
        for (int var1 = 0; var1 < 256; var1++) {
            int var2 = this.field931[var1];
            if ((var1 & 0x3) == 0) {
                this.field932 ^= this.field932 << 13;
            } else if ((var1 & 0x3) == 1) {
                this.field932 ^= this.field932 >>> 6;
            } else if ((var1 & 0x3) == 2) {
                this.field932 ^= this.field932 << 2;
            } else if ((var1 & 0x3) == 3) {
                this.field932 ^= this.field932 >>> 16;
            }
            this.field932 += this.field931[var1 + 128 & 0xFF];
            int var3;
            this.field931[var1] = var3 = this.field931[var2 >> 2 & 0xFF] + this.field932 + this.field933;
            this.field930[var1] = this.field933 = this.field931[var3 >> 8 >> 2 & 0xFF] + var2;
        }
    }
    ...
    private final void method319() {
        ...
        for (int var10 = 0; var10 < 256; var10 += 8) {
            int var36 = this.field930[var10] + var8;
            int var37 = this.field930[var10 + 1] + var7;
            int var38 = this.field930[var10 + 2] + var6;
            int var39 = this.field930[var10 + 3] + var5;
            int var40 = this.field930[var10 + 4] + var4;
            int var41 = this.field930[var10 + 5] + var3;
            int var42 = this.field930[var10 + 6] + var2;
            int var43 = this.field930[var10 + 7] + var1;
            ...
            var6 = var1 + var50;
            var8 = var7 + var57;
            this.field931[var10] = var8;
            this.field931[var10 + 1] = var7;
            this.field931[var10 + 2] = var6;
            this.field931[var10 + 3] = var5;
            this.field931[var10 + 4] = var4;
            this.field931[var10 + 5] = var3;
            this.field931[var10 + 6] = var2;
            this.field931[var10 + 7] = var1;
        }
        for (int var11 = 0; var11 < 256; var11 += 8) {
            int var12 = this.field931[var11] + var8;
            int var13 = this.field931[var11 + 1] + var7;
            int var14 = this.field931[var11 + 2] + var6;
            int var15 = this.field931[var11 + 3] + var5;
            int var16 = this.field931[var11 + 4] + var4;
            int var17 = this.field931[var11 + 5] + var3;
            int var18 = this.field931[var11 + 6] + var2;
            int var19 = this.field931[var11 + 7] + var1;
            ...
            var6 = var1 + var26;
            var8 = var7 + var33;
            this.field931[var11] = var8;
            this.field931[var11 + 1] = var7;
            this.field931[var11 + 2] = var6;
            this.field931[var11 + 3] = var5;
            this.field931[var11 + 4] = var4;
            this.field931[var11 + 5] = var3;
            this.field931[var11 + 6] = var2;
            this.field931[var11 + 7] = var1;
        }
        this.method318();
        this.field929 = 256;
    }
