...
public class class29 {
    ...
    @OriginalMember(owner = "client!KIZBPSHZ", name = "s", descriptor = "I")
    ...
    @OriginalMember(owner = "client!KIZBPSHZ", name = "c", descriptor = "[LKIZBPSHZ;")
    public static class29[] field1014;

    @OriginalMember(owner = "client!KIZBPSHZ", name = "a", descriptor = "(ILQDHHNYHL;)V")
    ...
    @OriginalMember(owner = "client!KIZBPSHZ", name = "a", descriptor = "(LPGNBHFUF;I)V")
