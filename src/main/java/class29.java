...
public class class29 extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!HXQNMAEJ", name = "p", descriptor = "[LDUMEPGRH;")
    ...
    @OriginalMember(owner = "client!HXQNMAEJ", name = "o", descriptor = "LTWKZMYGD;")
    public class55 field965;

    @OriginalMember(owner = "client!HXQNMAEJ", name = "q", descriptor = "LDQQGYYJG;")
