...
public class class357 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IB)I", line = 22)
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!ek", name = "c", descriptor = "(I)V", line = 57)
