...
public class class357 extends class373 implements class237 {
    ...
    @OriginalMember(owner = "client!rd", name = "b", descriptor = "(BLha;)Lhga;")
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IBZLha;)Lcb;")
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lha;Lcn;IIBZI)V")
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!rd", name = "b", descriptor = "(Lha;B)Ldg;")
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ILha;I)Lka;")
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lha;III)Z")
    ...
    @OriginalMember(owner = "client!rd", name = "m", descriptor = "(I)[Laca;")
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "(Lha;Lij;IIIIIZIIZ)V")
