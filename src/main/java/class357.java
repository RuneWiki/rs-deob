...
public class class357 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIIIIIB)Z", line = 37)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ZB)V", line = 105)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(IIIIIIIIIZI)V", line = 122)
