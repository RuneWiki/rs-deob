...
public class class357 extends class111 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Lrh;Lrh;BF)Z")
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(I)Lrh;")
    public final class633 method748(int arg0) {
        field4586++;
        return arg0 == 8448 ? this.field4583 : null;
    }

    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "(Lep;I)V")
