...
public class class357 {
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IB)I", line = 4)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(JI)Llf;", line = 18)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(I)Llf;", line = 61)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IZIZ)Ljava/lang/String;", line = 105)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(II)V", line = 157)
    ...
    @OriginalMember(owner = "client!jr", name = "c", descriptor = "(I)Llf;", line = 196)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IZIIZ)V", line = 229)
    ...
    @OriginalMember(owner = "client!jr", name = "d", descriptor = "(I)Llf;", line = 247)
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(B)I", line = 285)
    ...
    @OriginalMember(owner = "client!jr", name = "e", descriptor = "(I)I", line = 296)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(JLlf;B)V", line = 333)
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(I)V", line = 356)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(B[Llf;)I", line = 378)
