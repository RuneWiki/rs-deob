...
public class class357 extends class35 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "()V", line = 55)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "([I)Lhk;", line = 74)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "()I", line = 133)
    ...
    @OriginalMember(owner = "client!md", name = "c", descriptor = "(I)[F", line = 141)
    ...
    @OriginalMember(owner = "client!md", name = "d", descriptor = "(I)F", line = 565)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Ldp;II)Lmd;", line = 580)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Ldp;)Z", line = 596)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "([BI)V", line = 613)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "([B)V", line = 620)
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "([B)V", line = 775)
    private class357(byte[] arg0) {
        this.method2283(arg0);
    }

    @OriginalMember(owner = "client!md", name = "e", descriptor = "(I)I", line = 781)
