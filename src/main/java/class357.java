...
public class class357 {
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(IJ)Llo;")
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(IIIILps;)V")
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Llo;JI)V")
