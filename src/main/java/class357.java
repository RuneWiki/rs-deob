...
public class class357 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IB)Lsm;")
    ...
    @OriginalMember(owner = "client!jq", name = "b", descriptor = "(IB)Lir;")
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Z)Ljh;")
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Luq;I)V")
    ...
    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "(Lee;ILul;Lul;Lul;)V")
