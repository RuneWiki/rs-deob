...
public class class357 extends class189 {
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Lpea;Lgda;B)Lhha;", line = 3)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Lee;II)V", line = 43)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Lafa;ILha;Lek;)V", line = 72)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Z)V", line = 226)
