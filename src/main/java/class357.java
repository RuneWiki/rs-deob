...
public class class357 extends class214 {
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Llk;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "()V", line = 42)
    public class357() {
        super(1, false);
    }

    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IB)[[I", line = 49)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(BI)[I", line = 128)
    ...
    @OriginalMember(owner = "client!kk", name = "f", descriptor = "(I)V", line = 183)
