...
public class class357 {
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Lraa;)V")
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Lkg;II)V")
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Lraa;I)V")
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Lwga;I)V")
