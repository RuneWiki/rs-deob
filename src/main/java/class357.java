...
public class class357 extends class35 {
    ...
    @OriginalMember(owner = "client!bi", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(B)V", line = 217)
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(IIIIIZ)V", line = 229)
