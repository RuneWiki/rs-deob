...
public class class357 {
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(II)Lgq;")
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lgq;B)V")
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "(Lgq;)V")
