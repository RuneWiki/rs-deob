...
public class class357 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IIBLha;)V", line = 9)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(II)Lsba;", line = 27)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(I)V", line = 66)
