...
public class class357 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IIIBII)V", line = 17)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IIIIII)Z", line = 44)
    ...
    @OriginalMember(owner = "client!dn", name = "toString", descriptor = "()Ljava/lang/String;", line = 80)
    public final String toString() {
        field5210++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(B)V", line = 92)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IIIIIIII)V", line = 112)
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 282)
    public class357(String arg0, int arg1) {
        this.field5213 = arg1;
    }

    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(II)S", line = 292)
