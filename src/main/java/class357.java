...
public class class357 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(I)Lnfa;")
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(BLds;Lds;)V")
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Lla;IIB)Lb;")
