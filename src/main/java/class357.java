...
public class class357 {
    ...
    @OriginalMember(owner = "client!tda", name = "<init>", descriptor = "(III)V", line = 192)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(B)[[I", line = 35)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(II)[I", line = 56)
    ...
    @OriginalMember(owner = "client!tda", name = "b", descriptor = "(B)V", line = 126)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;II)V", line = 142)
