...
public class class357 {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IILqj;I)Lm;", line = 36)
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(Z)V", line = 54)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(I)Z", line = 65)
