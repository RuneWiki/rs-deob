...
public class class357 {
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(J[IZLdc;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(IB)Ldn;")
    ...
    @OriginalMember(owner = "client!mea", name = "<init>", descriptor = "(ILvo;Lvo;Llca;)V")
