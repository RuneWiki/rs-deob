...
public class class357 extends class263 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Z[Lrr;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Z)Z", line = 85)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(B)I", line = 96)
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(II)Z", line = 123)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(I)I", line = 134)
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(II)V", line = 144)
    public class357(int arg0, int arg1) {
        this.field4602 = arg1;
        this.field4604 = arg0;
    }

    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(I)Z", line = 153)
    ...
    @OriginalMember(owner = "client!ah", name = "d", descriptor = "(I)Z", line = 165)
