...
public class class357 extends class409 {
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "(Lbt;Lbt;Lew;)V")
    public class357(class48 arg0, class48 arg1, class519 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IIZI)V")
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IIIILkg;II)V")
    ...
    @OriginalMember(owner = "client!vu", name = "c", descriptor = "(I)Lmd;")
