...
public class class357 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ILgga;Lgga;)V", line = 11)
    ...
    @OriginalMember(owner = "client!wd", name = "toString", descriptor = "()Ljava/lang/String;", line = 28)
    public final String toString() {
        field4790++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ILjava/lang/String;)V", line = 42)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IIZIZLjava/lang/String;Ljava/lang/String;)V", line = 96)
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(IIII)V", line = 209)
