...
public class class357 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IB)Lbn;", line = 28)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ILfh;)Lmm;", line = 89)
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Lae;ILqn;Lqn;)V", line = 129)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(II)V", line = 145)
