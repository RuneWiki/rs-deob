...
public class class357 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(BLti;)V", line = 51)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IIZI)I", line = 74)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IIIIBILc;I)Lc;", line = 201)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ILti;B)V", line = 273)
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(I)V", line = 432)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IIIILc;B)Lc;", line = 450)
