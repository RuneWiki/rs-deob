...
public class class357 extends class132 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Llr;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IIIZ)Lmv;", line = 77)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IZII)V", line = 102)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(ZIII)V", line = 116)
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Lmv;Lmv;Liaa;)V", line = 129)
    public class357(class295 arg0, class295 arg1, class100 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(II[BIZI)V", line = 135)
    ...
    @OriginalMember(owner = "client!vb", name = "b", descriptor = "(B)V", line = 165)
