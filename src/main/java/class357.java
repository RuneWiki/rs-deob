...
public class class357 extends class144 {
    ...
    @OriginalMember(owner = "client!jq", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(B)[Lit;", line = 25)
    ...
    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "(Lur;II[B)V", line = 105)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IBIZZ)I", line = 117)
