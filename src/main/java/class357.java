...
public class class357 extends class354 implements class381 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(BLwm;)V", line = 3)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IIBLwm;)Z", line = 89)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lwm;B)V", line = 140)
    ...
    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "(Lwm;Lct;IIIIIZII)V", line = 168)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(ILwm;I)Lgn;", line = 179)
    ...
    @OriginalMember(owner = "client!lq", name = "i", descriptor = "(I)V", line = 194)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IIILwm;ZLhp;Z)V", line = 230)
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(Lwm;B)Lnf;", line = 241)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lwm;I)V", line = 283)
