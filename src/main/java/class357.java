...
public class class357 extends class363 {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(ZB)V", line = 39)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(IIIIIIIILvb;III)Z", line = 53)
    ...
    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(Lod;Lqh;)V", line = 595)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Ljk;IB)V", line = 496)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Z)V", line = 513)
    ...
    @OriginalMember(owner = "client!fo", name = "c", descriptor = "(I)V", line = 534)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(III)V", line = 554)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(ILdh;)Lke;", line = 616)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(B)V", line = 628)
    ...
    @OriginalMember(owner = "client!fo", name = "b", descriptor = "(I)Z", line = 638)
