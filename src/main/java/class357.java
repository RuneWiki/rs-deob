...
public abstract class class357 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ZJ)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(BIIILjava/lang/String;I)V", line = 59)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IIIIILjava/lang/String;)V", line = 75)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Z)V", line = 87)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IILjava/lang/String;IIB)V", line = 101)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IIIIIILjava/lang/String;ZIIII[IILep;[Lsg;)I", line = 121)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Ljava/lang/String;IB)V", line = 213)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IILjava/lang/String;ZIII)V", line = 252)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ILjava/util/Random;ILjava/lang/String;IIIIII[Lsg;[I[III)I", line = 286)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(BIII[Lsg;[IIILjava/util/Random;Ljava/lang/String;)I", line = 369)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ILjava/lang/String;)V", line = 408)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Ljava/lang/String;IIIIII)V", line = 488)
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Luo;Lk;)V", line = 512)
    public class357(class345 arg0, class337 arg1) {
        this.field4884 = arg1;
        this.field4879 = arg0;
    }

    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Lkh;I)Ljava/lang/String;", line = 525)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IIIIIIILjava/lang/String;)V", line = 537)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(I[ILjava/lang/String;[Lsg;I[II[I)V", line = 570)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(III[Lsg;I[IILjava/lang/String;)V", line = 732)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IZI)V", line = 747)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "([Lsg;II[IILep;Ljava/lang/String;II)V", line = 766)
