...
public abstract class class357 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Z)Z", line = 11)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(B)Z", line = 34)
    ...
    @OriginalMember(owner = "client!dk", name = "b", descriptor = "(I)Z", line = 47)
    ...
    @OriginalMember(owner = "client!dk", name = "b", descriptor = "(B)Z", line = 58)
