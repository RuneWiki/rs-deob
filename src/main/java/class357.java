...
public class class357 extends class539 {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(SI)V", line = 8)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IIIIIIZ)V", line = 30)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(I)V", line = 195)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "([[ZIIII)V", line = 224)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ZI)V", line = 282)
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(Len;Lot;Lld;[I)V", line = 306)
