...
public class class357 {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IZ)Llp;", line = 6)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(I)Lkba;", line = 36)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(B)Z", line = 58)
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(II)V", line = 106)
