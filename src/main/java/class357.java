...
public class class357 implements class649 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(II)I", line = 29)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(I[I)V", line = 61)
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "()V", line = 192)
    ...
    @OriginalMember(owner = "client!pp", name = "c", descriptor = "(II)V", line = 107)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(Ljava/awt/Component;IBZ)V", line = 127)
    ...
    @OriginalMember(owner = "client!pp", name = "b", descriptor = "(II)V", line = 167)
