...
public class class357 {
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(ZI)Lvw;", line = 3)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(BI)V", line = 47)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!dea", name = "b", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!dea", name = "<init>", descriptor = "(Lgp;ILuu;Luu;)V", line = 123)
