...
public class class357 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(I)Z", line = 16)
    ...
    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(I)V", line = 40)
