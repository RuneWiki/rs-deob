...
public class class357 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IB)V", line = 6)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(ZI)V", line = 31)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(II)V", line = 75)
    ...
    @OriginalMember(owner = "client!vq", name = "<init>", descriptor = "(Lpt;IZLum;Lum;)V", line = 268)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(ZI)V", line = 91)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(IB)V", line = 106)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(BI)V", line = 128)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(II)Lii;", line = 139)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(B)V", line = 188)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(B)V", line = 215)
