...
public class class357 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(CI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IIIZIII)Lqs;", line = 15)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!en", name = "b", descriptor = "(I)V", line = 63)
