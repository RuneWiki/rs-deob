...
public class PlayerEntity extends PathingEntity {
    ...
    @OriginalMember(owner = "client!z", name = "Bb", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!z", name = "a", descriptor = "(I)Leb;")
    ...
    @OriginalMember(owner = "client!z", name = "c", descriptor = "(I)Leb;")
    ...
    @OriginalMember(owner = "client!z", name = "a", descriptor = "(Z)Leb;")
