...
public class PlayerEntity extends PathingEntity {
    ...
    @OriginalMember(owner = "client!ab", name = "Tb", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!ab", name = "Kb", descriptor = "Leb;")
    public Model field473;

    @OriginalMember(owner = "client!ab", name = "Rb", descriptor = "Lgc;")
