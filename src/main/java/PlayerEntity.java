...
public class PlayerEntity extends PathingEntity {
    ...
    @OriginalMember(owner = "client!bb", name = "Nb", descriptor = "Lt;")
    ...
    @OriginalMember(owner = "client!bb", name = "Gb", descriptor = "Lfb;")
    ...
    @OriginalMember(owner = "client!bb", name = "d", descriptor = "(I)Lfb;")
