...
public class PlayerEntity extends PathingEntity {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(B)Lfb;")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Z)Lfb;")
