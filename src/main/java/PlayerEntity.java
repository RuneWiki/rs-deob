...
public class PlayerEntity extends PathingEntity {
    ...
    @OriginalMember(owner = "client!bb", name = "Pb", descriptor = "Lt;")
    ...
    @OriginalMember(owner = "client!bb", name = "Hb", descriptor = "Lfb;")
    public Model field482;

    @OriginalMember(owner = "client!bb", name = "Ob", descriptor = "Lgc;")
    public NpcType field489;

    @OriginalMember(owner = "client!bb", name = "tb", descriptor = "Ljava/lang/String;")
    public String field468;

    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Lmb;Z)V")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(I)Lfb;")
    ...
    @OriginalMember(owner = "client!bb", name = "c", descriptor = "(I)Lfb;")
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(Z)Lfb;")
