...
public class PlayerEntity extends PathingEntity {
    ...
    @OriginalMember(owner = "client!ab", name = "Yb", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!ab", name = "Pb", descriptor = "Leb;")
    public Model field486;

    @OriginalMember(owner = "client!ab", name = "Wb", descriptor = "Lgc;")
    public NpcType field493;

    @OriginalMember(owner = "client!ab", name = "Ab", descriptor = "Ljava/lang/String;")
    public String field471;

    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Llb;B)V")
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(I)Leb;")
    ...
    @OriginalMember(owner = "client!ab", name = "b", descriptor = "(Z)Leb;")
