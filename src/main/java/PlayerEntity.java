...
public class PlayerEntity extends PathingEntity {
    ...
    @OriginalMember(owner = "client!ab", name = "Ub", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!ab", name = "Lb", descriptor = "Leb;")
    public Model field473;

    @OriginalMember(owner = "client!ab", name = "Sb", descriptor = "Lgc;")
