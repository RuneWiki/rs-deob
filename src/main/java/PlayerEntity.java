...
public class PlayerEntity extends PathingEntity {
    ...
    @OriginalMember(owner = "client!y", name = "Cb", descriptor = "Lr;")
    ...
    @OriginalMember(owner = "client!y", name = "a", descriptor = "(I)Ldb;")
    ...
    @OriginalMember(owner = "client!y", name = "b", descriptor = "(I)Ldb;")
    ...
    @OriginalMember(owner = "client!y", name = "c", descriptor = "(I)Ldb;")
