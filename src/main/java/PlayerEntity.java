...
public class PlayerEntity extends PathingEntity {
    ...
    @OriginalMember(owner = "client!ab", name = "Qb", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Llb;I)V")
    ...
    @OriginalMember(owner = "client!ab", name = "c", descriptor = "(Z)Leb;")
    ...
    @OriginalMember(owner = "client!ab", name = "d", descriptor = "(Z)Leb;")
