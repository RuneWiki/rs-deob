...
@OriginalClass("DLZHLHNK")
public class PlayerEntity extends PathingEntity {

    @OriginalMember(owner = "DLZHLHNK", name = "sb", descriptor = "J")
    public long modelUid = -1L;

    @OriginalMember(owner = "DLZHLHNK", name = "ub", descriptor = "Z")
    public boolean lowmem = false;

    @OriginalMember(owner = "DLZHLHNK", name = "vb", descriptor = "[I")
    public int[] colors = new int[5];

    @OriginalMember(owner = "DLZHLHNK", name = "Fb", descriptor = "Z")
    public boolean visible = false;

    @OriginalMember(owner = "DLZHLHNK", name = "Kb", descriptor = "I")
    private int _flowObfuscator1 = 9;

    @OriginalMember(owner = "DLZHLHNK", name = "Lb", descriptor = "Z")
    private boolean _flowObfuscator2 = true;

    @OriginalMember(owner = "DLZHLHNK", name = "Mb", descriptor = "[I")
    public int[] appearances = new int[12];

    @OriginalMember(owner = "DLZHLHNK", name = "zb", descriptor = "LGCPOSBWX;")
    public static LruCache modelCache = new LruCache(false, 260);

    @OriginalMember(owner = "DLZHLHNK", name = "Ab", descriptor = "I")
    public int combatLevel;

    @OriginalMember(owner = "DLZHLHNK", name = "xb", descriptor = "I")
    public int gender;

    @OriginalMember(owner = "DLZHLHNK", name = "Bb", descriptor = "I")
    public int headicons;

    @OriginalMember(owner = "DLZHLHNK", name = "Gb", descriptor = "I")
    public int locOffsetX;

    @OriginalMember(owner = "DLZHLHNK", name = "Hb", descriptor = "I")
    public int locOffsetY;

    @OriginalMember(owner = "DLZHLHNK", name = "Ib", descriptor = "I")
    public int locOffsetZ;

    @OriginalMember(owner = "DLZHLHNK", name = "Cb", descriptor = "I")
    public int locStartCycle;

    @OriginalMember(owner = "DLZHLHNK", name = "Db", descriptor = "I")
    public int locStopCycle;

    @OriginalMember(owner = "DLZHLHNK", name = "Qb", descriptor = "I")
    public int maxTileX;

    @OriginalMember(owner = "DLZHLHNK", name = "Rb", descriptor = "I")
    public int maxTileZ;

    @OriginalMember(owner = "DLZHLHNK", name = "Ob", descriptor = "I")
    public int minTileX;

    @OriginalMember(owner = "DLZHLHNK", name = "Pb", descriptor = "I")
    public int minTileZ;

    @OriginalMember(owner = "DLZHLHNK", name = "Sb", descriptor = "I")
    public int skillLevel;

    @OriginalMember(owner = "DLZHLHNK", name = "wb", descriptor = "I")
    public int team;

    @OriginalMember(owner = "DLZHLHNK", name = "Eb", descriptor = "I")
    public int y;

    @OriginalMember(owner = "DLZHLHNK", name = "Nb", descriptor = "J")
    public long appearanceHashcode;

    @OriginalMember(owner = "DLZHLHNK", name = "Jb", descriptor = "LZKARKDQW;")
    public Model locModel;

    @OriginalMember(owner = "DLZHLHNK", name = "tb", descriptor = "LCKDEJADD;")
    public NpcType npc;

    @OriginalMember(owner = "DLZHLHNK", name = "yb", descriptor = "Ljava/lang/String;")
    public String name;

    @OriginalMember(owner = "DLZHLHNK", name = "a", descriptor = "(I)LZKARKDQW;")
    ...
    @OriginalMember(owner = "DLZHLHNK", name = "a", descriptor = "(ILMBMGIXGO;)V")
        ...
        if (arg0 == 0) {
            ...
            for (int var7 = 0; var7 < 12; ++var7) {
                ...
                if (this.appearances[var7] >= 256) {
                    this.appearanceHashcode += (long) (this.appearances[var7] - 256);
                }
            }
            ...
            for (int var8 = 0; var8 < 5; ++var8) {
                ...
                this.appearanceHashcode += (long) this.colors[var8];
            }
    ...
    @OriginalMember(owner = "DLZHLHNK", name = "b", descriptor = "(I)LZKARKDQW;")
    private final Model getSequencedModel(int arg0) {
        if (this.npc != null) {
            ...
            return this.npc.getModel(0, -1, var2, (int[]) null);
        } else {
    ...
    @OriginalMember(owner = "DLZHLHNK", name = "b", descriptor = "(Z)Z")
    ...
    @OriginalMember(owner = "DLZHLHNK", name = "a", descriptor = "(B)LZKARKDQW;")
