...
public class PlayerEntity extends PathingEntity {
    ...
    @OriginalMember(owner = "client!ab", name = "Ob", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!ab", name = "Gb", descriptor = "Leb;")
    public Model field476;

    @OriginalMember(owner = "client!ab", name = "Nb", descriptor = "Lhc;")
    public NpcType field483;

    @OriginalMember(owner = "client!ab", name = "sb", descriptor = "Ljava/lang/String;")
    public String field462;

    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Lmb;I)V")
