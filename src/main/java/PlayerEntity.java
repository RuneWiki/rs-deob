...
public class PlayerEntity extends PathingEntity {
    ...
    @OriginalMember(owner = "client!ab", name = "Sb", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!ab", name = "Jb", descriptor = "Leb;")
    public Model field475;

    @OriginalMember(owner = "client!ab", name = "Qb", descriptor = "Lgc;")
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(B)Leb;")
