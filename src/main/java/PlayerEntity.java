...
public class PlayerEntity extends PathingEntity {
    ...
    @OriginalMember(owner = "client!z", name = "Gb", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!z", name = "a", descriptor = "(B)Leb;")
