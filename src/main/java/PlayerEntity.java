...
public class PlayerEntity extends PathingEntity {
    ...
    @OriginalMember(owner = "client!z", name = "Cb", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!z", name = "c", descriptor = "(Z)Leb;")
