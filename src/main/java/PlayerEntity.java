...
public class PlayerEntity extends PathingEntity {
    ...
    @OriginalMember(owner = "client!ab", name = "Rb", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!ab", name = "Ib", descriptor = "Leb;")
    public Model field477;

    @OriginalMember(owner = "client!ab", name = "Pb", descriptor = "Lgc;")
    public NpcType field484;

    @OriginalMember(owner = "client!ab", name = "tb", descriptor = "Ljava/lang/String;")
    public String field462;

    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Llb;Z)V")
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Z)Leb;")
    ...
    @OriginalMember(owner = "client!ab", name = "b", descriptor = "(I)Leb;")
    ...
    @OriginalMember(owner = "client!ab", name = "c", descriptor = "(I)Leb;")
