...
public class class512 extends class487 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Ljava/lang/Object;IZ)[B", line = 16)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lrs;IIII)V", line = 70)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IIIIIIII)V", line = 85)
    ...
    @OriginalMember(owner = "client!tq", name = "c", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lrs;IIII[BI)V", line = 126)
