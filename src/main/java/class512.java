...
public class class512 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(ILub;)V")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(BLkga;)V")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(ILq;IIIIZLda;Lr;)V")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(ZZIZLr;)Lda;")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lr;B)V")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "(Lr;Lfga;IIIILub;ZI)V")
