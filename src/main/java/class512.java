...
public class class512 extends class184 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(BILfh;)V", line = 3)
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(II)[[I", line = 37)
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "()V", line = 115)
    public class512() {
        super(3, false);
    }

    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(II)[I", line = 118)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IIBLqi;I)V", line = 170)
