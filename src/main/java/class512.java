...
public class class512 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(IIIB)Z", line = 5)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ZI)V", line = 34)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(IILgk;)V", line = 61)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ILgk;II)V", line = 86)
