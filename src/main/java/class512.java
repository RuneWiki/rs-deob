...
public abstract class class512 extends class276 {
    ...
    @OriginalMember(owner = "client!pj", name = "b", descriptor = "(II)[[I", line = 18)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IB)[I", line = 29)
    ...
    @OriginalMember(owner = "client!pj", name = "c", descriptor = "(I)I", line = 47)
    public int method2457(int arg0) {
        field7502++;
        return arg0 == -1 ? -1 : 115;
    }

    @OriginalMember(owner = "client!pj", name = "d", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(BII)V", line = 69)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(III)[[I", line = 96)
    ...
    @OriginalMember(owner = "client!pj", name = "e", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(ZII)[I", line = 160)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(ZILia;)V", line = 181)
    ...
    @OriginalMember(owner = "client!pj", name = "b", descriptor = "(B)I", line = 201)
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "(IZ)V", line = 212)
