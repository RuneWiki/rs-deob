...
public class class512 extends Canvas {
    ...
    @OriginalMember(owner = "client!lea", name = "update", descriptor = "(Ljava/awt/Graphics;)V")
    public final void update(Graphics arg0) {
        this.field7611.update(arg0);
        field7615++;
    }

    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(ILrca;)Z")
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(Ljava/lang/String;ZLvo;B)Lbs;")
    ...
    @OriginalMember(owner = "client!lea", name = "paint", descriptor = "(Ljava/awt/Graphics;)V")
    public final void paint(Graphics arg0) {
        field7614++;
        this.field7611.paint(arg0);
    }

    @OriginalMember(owner = "client!lea", name = "<init>", descriptor = "(Ljava/awt/Component;)V")
