...
public class class512 extends class42 {
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "(Lmd;)V", line = 12)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lpc;II)Lcc;", line = 494)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "()V", line = 501)
