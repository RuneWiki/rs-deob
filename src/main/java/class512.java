...
public class class512 implements class447 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(I)Ljw;")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(Leq;Z)V")
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(Ljava/lang/String;Ljg;Ljha;IIIIIIIIII)V")
