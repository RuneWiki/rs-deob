...
public class class512 {
    ...
    @OriginalMember(owner = "client!nk", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(ILm;)V", line = 44)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(ZB)V", line = 77)
