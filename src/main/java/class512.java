...
public class class512 {
    ...
    @OriginalMember(owner = "client!si", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field7598++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IILqa;IIIB)Lc;", line = 12)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!si", name = "<init>", descriptor = "(II)V", line = 85)
    public class512(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Ltl;I)V", line = 96)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(II)Lmb;", line = 143)
