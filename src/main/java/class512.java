...
public class class512 extends class398 {
    ...
    @OriginalMember(owner = "client!uca", name = "c", descriptor = "()V", line = 13)
    ...
    @OriginalMember(owner = "client!uca", name = "b", descriptor = "()I", line = 32)
    public final int method2017() {
        return this.field7317 - (this.field7314.available() >> (class673.field9127 ? 2 : 1));
    }

    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 40)
    ...
    @OriginalMember(owner = "client!uca", name = "c", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 79)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "()V", line = 103)
    ...
    @OriginalMember(owner = "client!uca", name = "d", descriptor = "()V", line = 123)
