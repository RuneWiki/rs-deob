...
public class class512 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "([Lvfa;IB)V", line = 25)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lfha;IZ)V", line = 124)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(BII)I", line = 273)
    ...
    @OriginalMember(owner = "client!qj", name = "toString", descriptor = "()Ljava/lang/String;", line = 297)
