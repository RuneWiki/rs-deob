...
public class class512 extends class287 {
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(II)I", line = 19)
    ...
    @OriginalMember(owner = "client!pg", name = "d", descriptor = "(I)J", line = 57)
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "(I)J", line = 90)
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "()V", line = 106)
    public class512() {
