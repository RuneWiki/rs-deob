...
public class class512 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(III)Z", line = 20)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IIIIIZII)V", line = 38)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(BIIII)V", line = 72)
    ...
    @OriginalMember(owner = "client!kl", name = "b", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(BII)Z", line = 129)
