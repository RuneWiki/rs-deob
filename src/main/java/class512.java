...
public class class512 {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Ljava/lang/String;Ljava/applet/Applet;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Ljava/applet/Applet;ZLjava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", line = 13)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(Ljava/lang/String;Ljava/applet/Applet;B)Ljava/lang/Object;", line = 23)
