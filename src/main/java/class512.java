...
public abstract class class512 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(BLnw;[I[I[I)V", line = 38)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(I)V", line = 138)
