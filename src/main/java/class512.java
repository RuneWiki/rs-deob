...
public class class512 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Ljava/lang/String;BZLjava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(B)[Lea;", line = 38)
    ...
    @OriginalMember(owner = "client!ea", name = "toString", descriptor = "()Ljava/lang/String;", line = 60)
    public final String toString() {
        field6840++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(IILne;)V", line = 71)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(B)V", line = 85)
