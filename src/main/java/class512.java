...
public class class512 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Lwt;I)I", line = 7)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 51)
