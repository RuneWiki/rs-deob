...
public class class512 extends class78 {
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Lqa;)V")
    ...
    @OriginalMember(owner = "client!lu", name = "c", descriptor = "(I)Lhp;")
    ...
    @OriginalMember(owner = "client!lu", name = "<init>", descriptor = "(Lbt;IIIIII)V")
