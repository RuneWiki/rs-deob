...
public class class512 extends class145 {
    ...
    @OriginalMember(owner = "client!ia", name = "c", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(IILrt;)V", line = 19)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(IIIIIII)V", line = 59)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Ljava/lang/String;CZ)I", line = 188)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(BI)[[I", line = 218)
