...
public class class512 {
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(ZI)V", line = 19)
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(II)V", line = 37)
    ...
    @OriginalMember(owner = "client!gia", name = "b", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(ILpfa;IIIILha;I)Lho;", line = 102)
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(BI)Llv;", line = 120)
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(ZZ)Z", line = 203)
    public static boolean method3052(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(Lha;ZIBIILha;ZLda;Lpfa;II)Lho;", line = 211)
    ...
    @OriginalMember(owner = "client!gia", name = "<init>", descriptor = "(Ljk;IZLud;Lae;Lae;)V", line = 328)
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(B)V", line = 289)
    ...
    @OriginalMember(owner = "client!gia", name = "b", descriptor = "(II)V", line = 313)
