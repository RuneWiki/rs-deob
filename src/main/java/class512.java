...
public class class512 extends class584 implements class308 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IZLjava/lang/String;I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(B)J", line = 99)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(I)I", line = 111)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Ljaa;I[BI)V", line = 123)
    public class512(class576 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field6423 = arg1;
    }

    @OriginalMember(owner = "client!ea", name = "a", descriptor = "()V", line = 132)
    public static final void method2790() {
        class247.method1479(1, class709.field9904);
    }

    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(B)I", line = 138)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(II[BI)V", line = 149)
