...
public class class512 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(ILlh;I)V")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(BLht;)V")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(ILlh;)V")
