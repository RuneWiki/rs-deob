...
public class class512 {
    ...
    @OriginalMember(owner = "client!lo", name = "b", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lha;[II[I[I)V")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lha;[IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lha;[II)V")
