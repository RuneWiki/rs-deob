...
public class class512 extends class569 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ZZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(II)Z", line = 38)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(III)Lhha;", line = 49)
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(III)V", line = 69)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 86)
    public static final int method3114(String arg0, int arg1) {
        field7422++;
        return arg1 == 6406 ? arg0.length() + 2 : -27;
    }

    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lkw;II[B)V", line = 96)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ILqk;IZ)V", line = 109)
