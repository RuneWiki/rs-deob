...
public class class512 extends class297 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Lcea;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!jq", name = "c", descriptor = "(II)[I", line = 96)
    ...
    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "()V", line = 118)
    public class512() {
        super(0, true);
    }

    @OriginalMember(owner = "client!jq", name = "e", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!jq", name = "b", descriptor = "(B)V", line = 156)
    ...
    @OriginalMember(owner = "client!jq", name = "f", descriptor = "(I)V", line = 194)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(I[IB)V", line = 212)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IIIIIZI)I", line = 393)
