...
public class class512 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(I)V", line = 8)
    public static final void method3059(int arg0) {
        field7081++;
        class333.method2131((byte) -58, 255, arg0);
    }

    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(ZI)V", line = 41)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(II)Lwf;", line = 57)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IIB)Z", line = 87)
    ...
    @OriginalMember(owner = "client!vq", name = "<init>", descriptor = "(Lgp;ILuu;Luu;)V", line = 121)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(I)V", line = 102)
