...
public class class512 extends class328 {
    ...
    @OriginalMember(owner = "client!uu", name = "f", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(BILco;)V", line = 21)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(ILjava/lang/String;Z)V", line = 59)
    ...
    @OriginalMember(owner = "client!uu", name = "<init>", descriptor = "()V", line = 134)
    public class512() {
        super(1, false);
    }

    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(II)[I", line = 144)
    ...
    @OriginalMember(owner = "client!uu", name = "b", descriptor = "(II)[[I", line = 199)
    ...
    @OriginalMember(owner = "client!uu", name = "c", descriptor = "(B)V", line = 266)
