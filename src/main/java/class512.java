...
public class class512 extends class389 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lcp;IIIII)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(JLoa;I)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(JBLoa;IZ)V")
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(Loa;Lgi;Lru;J)V")
