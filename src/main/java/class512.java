...
public class class512 extends class358 {
    ...
    @OriginalMember(owner = "client!rj", name = "d", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!rj", name = "d", descriptor = "(II)V", line = 44)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IILea;Lea;)V", line = 82)
    ...
    @OriginalMember(owner = "client!rj", name = "e", descriptor = "(B)Z", line = 243)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IZI)V", line = 253)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(I)Z", line = 333)
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(B)I", line = 349)
    ...
    @OriginalMember(owner = "client!rj", name = "c", descriptor = "(B)V", line = 364)
    ...
    @OriginalMember(owner = "client!rj", name = "c", descriptor = "(II)V", line = 384)
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(Lte;)V", line = 404)
    public class512(class527 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(Z)V", line = 408)
