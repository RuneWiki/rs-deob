...
public class class512 {
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(BII)Z", line = 23)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(II)Led;", line = 37)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(IIILgq;II)Leo;", line = 67)
    ...
    @OriginalMember(owner = "client!iba", name = "<init>", descriptor = "(Luea;ILpq;)V", line = 126)
    public class512(class484 arg0, int arg1, class159 arg2) {
        this.field6901 = arg2;
        this.field6901.method1076(29, 0);
    }

    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(Z)V", line = 117)
