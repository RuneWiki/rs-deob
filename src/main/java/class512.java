...
public class class512 extends class404 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(ILha;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!mp", name = "h", descriptor = "(I)Lfb;", line = 23)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(BII)V", line = 41)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(I[[[Loh;IIIZ)Z", line = 64)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(B)V", line = 383)
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(II)[[I", line = 396)
    ...
    @OriginalMember(owner = "client!mp", name = "f", descriptor = "(I)I", line = 463)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "()V", line = 491)
    public class512() {
        super(0, false);
    }

    @OriginalMember(owner = "client!mp", name = "e", descriptor = "(I)V", line = 479)
