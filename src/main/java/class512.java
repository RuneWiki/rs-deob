...
public class class512 {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ILjp;)V", line = 4)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(BI)V", line = 39)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lsl;I)V", line = 93)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(B)I", line = 119)
    ...
    @OriginalMember(owner = "client!cc", name = "c", descriptor = "(B)V", line = 130)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ILsl;)Ljava/lang/Object;", line = 146)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lsl;IZLjava/lang/Object;)V", line = 200)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lsl;Ljava/lang/Object;I)V", line = 237)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Z)V", line = 248)
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "(I)V", line = 299)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(I)V", line = 278)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(Z)I", line = 289)
