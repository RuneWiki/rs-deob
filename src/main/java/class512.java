...
public class class512 {
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(ZZIBII)V", line = 3)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(BILit;)Z", line = 59)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(II)Z", line = 82)
    ...
    @OriginalMember(owner = "client!nda", name = "<init>", descriptor = "(Len;)V", line = 129)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(I)V", line = 103)
