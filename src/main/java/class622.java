...
public class class622 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Ljl;BI)Z", line = 6)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(II)Z", line = 28)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILn;Lqa;)V", line = 47)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Lte;)V", line = 362)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IIBZZI)V", line = 282)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IZIII)V", line = 340)
