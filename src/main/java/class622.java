...
public class class622 extends class172 {
    ...
    @OriginalMember(owner = "client!od", name = "g", descriptor = "(I)I", line = 8)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(II)V", line = 19)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ZIBLr;Llo;II)V", line = 52)
    ...
    @OriginalMember(owner = "client!od", name = "finalize", descriptor = "()V", line = 63)
    ...
    @OriginalMember(owner = "client!od", name = "h", descriptor = "(B)Z", line = 80)
    public final boolean method79(byte arg0) {
        ++field8702;
        return arg0 >= -26;
    }

    @OriginalMember(owner = "client!od", name = "c", descriptor = "(I)I", line = 91)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Z)V", line = 104)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IIILr;)Lda;", line = 117)
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 266)
    ...
    @OriginalMember(owner = "client!od", name = "e", descriptor = "(B)Z", line = 138)
    public final boolean method83(byte arg0) {
        ++field8675;
        return arg0 != 23 ? true : this.field8694;
    }

    @OriginalMember(owner = "client!od", name = "a", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!od", name = "g", descriptor = "(B)Z", line = 167)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ZLr;)Log;", line = 178)
    ...
    @OriginalMember(owner = "client!od", name = "d", descriptor = "(I)V", line = 221)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IILr;I)Z", line = 238)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lr;I)Lsd;", line = 255)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lq;Lda;BLr;)V", line = 295)
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(ZLr;)V", line = 334)
