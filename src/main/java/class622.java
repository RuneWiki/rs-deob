...
public class class622 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(BILee;)V")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Z)Ljn;")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(BLee;)V")
