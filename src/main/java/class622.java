...
public class class622 extends class524 implements class237 {
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(BLha;)Lhga;")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ILha;ZI)Lcb;")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ILha;I)Lka;")
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(Lha;B)Ldg;")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Lha;III)Z")
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(Lha;Lij;IIIIIZIIII)V")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Lr;III[Z)V")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(BLha;)V")
