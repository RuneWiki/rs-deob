...
public class class622 extends class618 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Lmc;Z)Lrj;", line = 16)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Llq;ZZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(JZ)V", line = 66)
