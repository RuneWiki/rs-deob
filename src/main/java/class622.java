...
public class class622 extends class489 {
    ...
    @OriginalMember(owner = "client!kia", name = "b", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(ID)V", line = 25)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(IIZZIII)V", line = 37)
    ...
    @OriginalMember(owner = "client!kia", name = "<init>", descriptor = "(Lbi;II[B)V", line = 54)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(Z)V", line = 65)
