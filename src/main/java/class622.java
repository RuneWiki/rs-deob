...
public class class622 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Lge;JI)V")
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Z)Lge;")
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IJ)Lge;")
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "([BIZIIILos;I)Lgg;")
