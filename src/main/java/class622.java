...
public class class622 extends class66 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ZIIZLjava/lang/String;Ljava/lang/String;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(B)V", line = 121)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(I)[Lws;", line = 132)
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(I)V", line = 143)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(BI)I", line = 175)
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(IIIIIZ)V", line = 220)
