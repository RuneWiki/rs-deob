...
public class class622 extends class7 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(BILjava/awt/Graphics;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(I[Lfca;Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!qc", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 89)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IIIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Ljava/awt/Graphics;IIIII)V", line = 118)
    ...
    @OriginalMember(owner = "client!qc", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 134)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field8454;
    }

    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Ljava/lang/String;I)[B", line = 142)
    ...
    @OriginalMember(owner = "client!qc", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 282)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field8451;
        return this.field8458 == arg0;
    }

    @OriginalMember(owner = "client!qc", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 291)
    public final void startProduction(ImageConsumer arg0) {
        ++field8456;
        this.addConsumer(arg0);
    }

    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Ljava/awt/Canvas;I)V", line = 299)
    ...
    @OriginalMember(owner = "client!qc", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 324)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(I)V", line = 334)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IIIIBIIII)V", line = 355)
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(Z)V", line = 397)
