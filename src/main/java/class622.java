...
public class class622 {
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(II)V", line = 24)
    ...
    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IIILsba;)V", line = 51)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ILsba;II)V", line = 77)
    ...
    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(II)Lgp;", line = 90)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(B)V", line = 127)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(BI)V", line = 143)
    ...
    @OriginalMember(owner = "client!sk", name = "<init>", descriptor = "(Lrga;ILni;Lni;)V", line = 173)
