...
public class class622 extends class454 implements class614 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(BLr;I)Lda;")
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(Lr;Z)Lkq;")
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IZLr;I)Lpa;")
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(ILr;)Lnu;")
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Lr;Let;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lr;Z)V")
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IILr;I)Z")
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IZLr;Lrga;IIZ)V")
