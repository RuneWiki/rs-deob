...
public class class622 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lwv;Lr;III)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(BI)Lfq;")
    ...
    @OriginalMember(owner = "client!ka", name = "<init>", descriptor = "(Lnq;ILga;)V")
