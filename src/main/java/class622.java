...
public class class622 extends class751 {
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lml;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!qd", name = "CA", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Lr;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Lta;[I)V")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(IILsc;I)V")
    ...
    @OriginalMember(owner = "client!qd", name = "fa", descriptor = "(IILr;)Lr;")
    ...
    @OriginalMember(owner = "client!qd", name = "wa", descriptor = "(Lr;IIIIZ)V")
