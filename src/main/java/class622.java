...
public class class622 implements class499 {
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(II)Lrq;", line = 22)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(III)B", line = 59)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IIIIIIZZ)V", line = 77)
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(IIIIIIZZ)V", line = 87)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Laa;IIIIJLkq;II)V", line = 103)
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(Lbs;Ltf;Ltn;)V", line = 163)
