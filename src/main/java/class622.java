...
public class class622 extends class69 {
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(Lae;)Z")
    ...
    @OriginalMember(owner = "client!qw", name = "b", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(Lae;II)Lqw;")
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(Lae;I)Lqw;")
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "([I)Lfk;")
    ...
    @OriginalMember(owner = "client!qw", name = "<init>", descriptor = "([B)V")
