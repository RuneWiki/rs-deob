...
public class class622 {
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(ILha;II)V")
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(ILha;IB)Z")
    ...
    @OriginalMember(owner = "client!vg", name = "<init>", descriptor = "(Lnh;Lsq;)V")
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IILha;Z)V")
