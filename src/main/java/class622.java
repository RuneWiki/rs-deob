...
public class class622 {
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IIIIIB)V", line = 5)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IB)I", line = 67)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IIIIIII)V", line = 86)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(I)I", line = 131)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(BIII)I", line = 149)
