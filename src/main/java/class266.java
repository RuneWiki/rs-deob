...
public abstract class class266 extends class274 {
    ...
    @OriginalMember(owner = "client!un", name = "c", descriptor = "(I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!un", name = "d", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(IILoa;ILcq;ZI)V", line = 45)
