...
public class class266 {
    ...
    @OriginalMember(owner = "client!ob", name = "b", descriptor = "(I)I", line = 26)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(B)Ldb;", line = 38)
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 51)
    public class266(String arg0, int arg1) {
        this.field3708 = arg1;
    }

    @OriginalMember(owner = "client!ob", name = "toString", descriptor = "()Ljava/lang/String;", line = 65)
