...
public class class266 implements Runnable {
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IIZLnl;I)V")
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IBLwq;)Lds;")
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "([BIILwq;)Lds;")
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(Lds;B)V")
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(ILwq;I)Lds;")
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "(Lam;)V")
