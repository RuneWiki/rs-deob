...
public class class266 extends class578 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(ZIZLsea;IILfa;D)[I", line = 3)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(ILsea;Lfa;)Z", line = 137)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(B)V", line = 188)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Lsea;Lfa;IIZI)[F", line = 216)
    ...
    @OriginalMember(owner = "client!tf", name = "d", descriptor = "(I)V", line = 328)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(ZIILsea;IDLfa;)[I", line = 377)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Lin;Lr;BII)V", line = 514)
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "()V", line = 834)
    public class266() {
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(Lac;)V", line = 852)
