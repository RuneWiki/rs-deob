...
public class class266 implements class419 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lci;IIB)V")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(BILhk;)V")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IZLci;II)V")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(BLvp;IILpa;IIIJ)V")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IILea;I)V")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ZLea;I)V")
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(Lte;)V")
