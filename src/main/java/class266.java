...
public abstract class class266 {
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IIILjava/util/Random;I[Lgj;IILjava/lang/String;[I)I")
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IZLhb;IIII[I[Lgj;IIIILjava/lang/String;II)I")
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "([IILjava/lang/String;I[II[I[Lgj;)V")
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(I[III[Lgj;IIIII[ILjava/lang/String;IILjava/util/Random;)I")
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "([IIIILjava/lang/String;I[Lgj;I)V")
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "(Lae;Lth;)V")
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IILjava/lang/String;Lhb;[Lgj;I[III)V")
