...
public class class266 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(I)Llq;")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(III)Lfha;")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Llq;ILok;)V")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Llq;B)V")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(ILlq;)V")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Lok;B)V")
    ...
    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(B)Llq;")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Z)Llq;")
    ...
    @OriginalMember(owner = "client!ok", name = "c", descriptor = "(B)Llq;")
    ...
    @OriginalMember(owner = "client!ok", name = "c", descriptor = "(I)Llq;")
