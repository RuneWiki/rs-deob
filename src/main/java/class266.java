...
public class class266 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 86)
