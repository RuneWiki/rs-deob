...
public class class266 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Lufa;IIBI)V", line = 7)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(BFLfp;Lfp;)Z", line = 170)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(ILsj;I)V", line = 245)
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(Lkfa;)V", line = 268)
    public class266(class382 arg0) {
        this.field3819 = arg0;
    }

    @OriginalMember(owner = "client!un", name = "a", descriptor = "(B)Z", line = 276)
