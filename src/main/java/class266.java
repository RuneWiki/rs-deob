...
public class class266 extends class581 {
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(Lhq;)V", line = 5)
    ...
    @OriginalMember(owner = "client!oca", name = "b", descriptor = "()Lgu;", line = 18)
    public final class581 method33() {
        return (class581) this.field3701.method21(2);
    }

    @OriginalMember(owner = "client!oca", name = "c", descriptor = "([III)V", line = 24)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(Lgu;)V", line = 39)
    public final synchronized void method1608(class581 arg0) {
        this.field3701.method13(arg0, 593);
    }

    @OriginalMember(owner = "client!oca", name = "d", descriptor = "()I", line = 42)
    public final int method49() {
        return 0;
    }

    @OriginalMember(owner = "client!oca", name = "e", descriptor = "()I", line = 45)
    public final synchronized int method1609() {
        return this.field3701.method14(0);
    }

    @OriginalMember(owner = "client!oca", name = "a", descriptor = "([III)V", line = 53)
    ...
    @OriginalMember(owner = "client!oca", name = "b", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(Lpb;Lhq;)V", line = 109)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!oca", name = "b", descriptor = "(Lgu;)V", line = 175)
    public final synchronized void method1612(class581 arg0) {
        arg0.method3564(true);
    }

    @OriginalMember(owner = "client!oca", name = "a", descriptor = "()Lgu;", line = 178)
    public final class581 method53() {
        return (class581) this.field3701.method9(-128);
    }

    @OriginalMember(owner = "client!oca", name = "f", descriptor = "()V", line = 185)
