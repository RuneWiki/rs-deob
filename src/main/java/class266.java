...
public class class266 extends class114 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(FIIIIIIZI)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Z)V", line = 41)
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Los;)V", line = 54)
