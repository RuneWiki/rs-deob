...
public class class266 extends class287 {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IIIIIIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(BLsv;)V", line = 28)
    ...
    @OriginalMember(owner = "client!sc", name = "c", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(ILsv;I)V", line = 63)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(JI)V", line = 79)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IIIII)V", line = 97)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IIZ)Z", line = 128)
