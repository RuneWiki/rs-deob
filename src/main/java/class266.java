...
public class class266 {
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(BZLjava/lang/String;ZLwd;)V", line = 3)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ILun;)V", line = 74)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(I)Lkk;", line = 94)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Z)Z", line = 168)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IIIIIII)V", line = 198)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(B)Z", line = 270)
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(B)Lkk;", line = 296)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Lun;BI)V", line = 370)
