...
public class class266 {
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(IZ)Z", line = 3)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(IZII)I", line = 22)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(Ljava/lang/String;B)J", line = 58)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(IZLr;)Z", line = 102)
    ...
    @OriginalMember(owner = "client!vfa", name = "<init>", descriptor = "(I[Lka;IIII)V", line = 285)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(IIIIILr;IIII)V", line = 190)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(Z)V", line = 266)
