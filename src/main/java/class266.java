...
public class class266 extends class60 {
    ...
    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "(ILhd;)V", line = 5)
    public class266(int arg0, class773 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "(Lhd;)V", line = 23)
    public class266(class773 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Z)I", line = 29)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(II)I", line = 53)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(BI)V", line = 64)
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(I)I", line = 80)
