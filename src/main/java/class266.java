...
public class class266 {
    ...
    @OriginalMember(owner = "client!tia", name = "a", descriptor = "(Z)Z")
    public final boolean method1735(boolean arg0) {
        field3809++;
        return arg0 ? class228.field3061 == this | class125.field1519 == this : true;
    }

    @OriginalMember(owner = "client!tia", name = "toString", descriptor = "()Ljava/lang/String;")
    public final String toString() {
        field3808++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!tia", name = "a", descriptor = "(ZIIIIB)V")
    ...
    @OriginalMember(owner = "client!tia", name = "a", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!tia", name = "a", descriptor = "(ILml;)V")
    ...
    @OriginalMember(owner = "client!tia", name = "a", descriptor = "(Ljava/lang/String;I)Z")
