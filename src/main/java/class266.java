...
public class class266 {
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(BC)C", line = 7)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(B)V", line = 402)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(I)V", line = 415)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(III)V", line = 426)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Z)V", line = 458)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(IIBIII)V", line = 561)
