...
public class class266 extends class310 {
    ...
    @OriginalMember(owner = "client!vn", name = "B", descriptor = "(CIIIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(CIIIZLta;II)V", line = 27)
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(Ltt;Lap;[Lrr;Z)V", line = 70)
