...
public class class266 extends class612 {
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(ILlea;BILdfa;)V")
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(ILd;ILjava/awt/Canvas;I)Lha;")
    ...
    @OriginalMember(owner = "client!jaa", name = "e", descriptor = "(I)Ldia;")
