...
public class class266 extends class194 {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(IIIIZILlt;)V")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(BLtq;II)V")
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(Lbl;IIII[BI)V")
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(Lbl;IIII)V")
