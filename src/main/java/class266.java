...
public class class266 {
    ...
    @OriginalMember(owner = "client!fh", name = "toString", descriptor = "()Ljava/lang/String;", line = 11)
    public final String toString() {
        field3378++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "(II)V", line = 23)
    public class266(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Z)Z", line = 34)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(B)V", line = 67)
