...
public class class266 extends class29 {
    ...
    @OriginalMember(owner = "client!nf", name = "f", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!nf", name = "b", descriptor = "(BI)Z", line = 20)
    ...
    @OriginalMember(owner = "client!nf", name = "g", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!nf", name = "h", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IILva;Lva;IIIIIZ)V", line = 168)
    ...
    @OriginalMember(owner = "client!nf", name = "i", descriptor = "(I)V", line = 218)
    ...
    @OriginalMember(owner = "client!nf", name = "<init>", descriptor = "(Ljo;Ldj;)V", line = 1072)
