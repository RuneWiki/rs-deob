...
public class class266 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!wp", name = "b", descriptor = "()V", line = 57)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IIII)Z", line = 134)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Ljg;)V", line = 242)
    public final void method1612(class295 arg0) {
        this.method1613(arg0, true);
    }

    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "(Lic;)V", line = 361)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Ljg;Z)V", line = 251)
    ...
    @OriginalMember(owner = "client!wp", name = "b", descriptor = "(Ljg;)Z", line = 261)
    ...
    @OriginalMember(owner = "client!wp", name = "c", descriptor = "()Z", line = 289)
    private final boolean method1615() {
        return this.field3827.method1356() == this.field3822;
    }

    @OriginalMember(owner = "client!wp", name = "d", descriptor = "()V", line = 302)
