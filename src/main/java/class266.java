...
public class class266 {
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(Z)V", line = 55)
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(II)V", line = 75)
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(BLlp;)Llp;", line = 87)
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(Lha;BLvs;I)V", line = 107)
