...
public class class266 extends class153 {
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(FILds;Lds;)V")
    ...
    @OriginalMember(owner = "client!sl", name = "b", descriptor = "(B)Lds;")
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "(Ltb;I)V")
