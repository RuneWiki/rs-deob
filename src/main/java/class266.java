...
public class class266 extends class338 implements class226 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ILpe;)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lha;I)Luh;")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(BIILha;)Z")
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(BLha;)Lmg;")
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(Lha;Lsea;IIIIIZIII)V")
    ...
    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IIILha;Lnfa;ZI)V")
