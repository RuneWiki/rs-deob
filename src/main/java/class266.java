...
public class class266 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IBIILjava/lang/String;III)V", line = 8)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Z)Lffa;", line = 30)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Lsl;B)V", line = 53)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Lsl;BI)V", line = 83)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(I)V", line = 108)
