...
public abstract class class266 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(II)I", line = 3)
    public static int method1624(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!tf", name = "c", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!tf", name = "f", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(II)Lfaa;", line = 96)
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(Lgj;)V", line = 121)
