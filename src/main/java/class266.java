...
public class class266 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(I[SI)[S", line = 21)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(I)V", line = 48)
