...
public class class266 implements class438 {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(ILjaclib/memory/Source;II)Z")
    ...
    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "(Laia;Z)V")
    public class266(class242 arg0, boolean arg1) {
        this.field3744 = arg0;
        this.field3747 = arg1;
    }

    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;")
