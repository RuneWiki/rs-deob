...
public class class266 extends class206 {
    ...
    @OriginalMember(owner = "client!oca", name = "d", descriptor = "(I)J", line = 5)
    public final long method70(int arg0) {
        int var2 = -11 / ((arg0 - 30) / 63);
        return this.field3356;
    }

    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(I)J", line = 14)
    ...
    @OriginalMember(owner = "client!oca", name = "e", descriptor = "(I)J", line = 30)
    ...
    @OriginalMember(owner = "client!oca", name = "b", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!oca", name = "b", descriptor = "(JI)I", line = 90)
