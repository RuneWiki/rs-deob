...
public class class266 {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(B)Lbd;", line = 3)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Lfb;II)V", line = 33)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Throwable;)V", line = 57)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(II)I", line = 112)
    public static final int method1781(int arg0, int arg1) {
        field3955++;
        return arg0 > -126 ? -7 : arg1 & 0x3FF;
    }

    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ILfb;II)V", line = 138)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(I)V", line = 190)
