...
public class class266 implements class118 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;", line = 4)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(II)V", line = 31)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(Luda;Lwj;Z)V", line = 128)
    ...
    @OriginalMember(owner = "client!sr", name = "c", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(B)Lwj;", line = 84)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(I)I", line = 94)
    ...
    @OriginalMember(owner = "client!sr", name = "b", descriptor = "(I)Z", line = 107)
