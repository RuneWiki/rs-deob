...
public class class266 extends class618 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(BII)Leo;", line = 21)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Lha;III)Z", line = 43)
