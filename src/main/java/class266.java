...
public class class266 extends class85 implements class273 {
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(BLtb;)V")
    ...
    @OriginalMember(owner = "client!uga", name = "b", descriptor = "(Z)Ljagdx/IDirect3DBaseTexture;")
    public final IDirect3DBaseTexture method522(boolean arg0) {
        return arg0 ? (IDirect3DBaseTexture) null : this.field3621;
    }

    @OriginalMember(owner = "client!uga", name = "<init>", descriptor = "(Lrd;IZ[[I)V")
