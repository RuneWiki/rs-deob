...
public class class266 extends class449 {
    ...
    @OriginalMember(owner = "client!id", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "(I)V", line = 143)
    public class266(int arg0) {
        this.field3826 = arg0;
    }

    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IIILip;Lip;)V", line = 36)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Z)V", line = 46)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IIIILfo;IIBILfo;)V", line = 65)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IIB)I", line = 119)
