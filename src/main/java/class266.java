...
public class class266 {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Lqa;Llp;)Z")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Lqa;)V")
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(Lqa;Llp;)Z")
    public final boolean method1709(class162 arg0, class266 arg1) {
        return this.field3834 != null || this.method1706(arg0, arg1);
    }

    @OriginalMember(owner = "client!lp", name = "c", descriptor = "(Lqa;Llp;)V")
    ...
    @OriginalMember(owner = "client!lp", name = "d", descriptor = "(Lqa;Llp;)V")
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(Lqa;)V")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Lqa;IIIIII)V")
