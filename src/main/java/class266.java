...
public class class266 extends class270 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(III)I", line = 14)
    ...
    @OriginalMember(owner = "client!ij", name = "d", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ij", name = "e", descriptor = "(I)I", line = 50)
    public final int method1779(int arg0) {
        ++field4461;
        return arg0 != -143924128 ? 18 : (int) (255L & super.field4542 >>> 32);
    }

    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "(II)V", line = 60)
    public class266(int arg0, int arg1) {
        super.field4542 = (long) arg0 << 32 | (long) arg1;
    }

    @OriginalMember(owner = "client!ij", name = "f", descriptor = "(I)J", line = 68)
    ...
    @OriginalMember(owner = "client!ij", name = "d", descriptor = "(B)V", line = 84)
