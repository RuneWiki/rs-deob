...
public class class266 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(I)I", line = 48)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Lml;I)Z", line = 67)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(BLtl;)V", line = 85)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(B)V", line = 102)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(B[S)[S", line = 119)
