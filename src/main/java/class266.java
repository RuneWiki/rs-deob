...
public class class266 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(BI)Lfo;", line = 22)
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Lkd;Lga;)V", line = 78)
    public class266(class188 arg0, class279 arg1) {
        this.field4076 = arg1;
        this.field4079 = arg0;
    }

    @OriginalMember(owner = "client!ml", name = "b", descriptor = "(B)V", line = 87)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IBI)Z", line = 99)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(I)V", line = 112)
