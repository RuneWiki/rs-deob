...
public class class266 extends class223 {
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(Lih;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(Lih;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(Lih;II)V")
