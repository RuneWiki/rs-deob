...
public class class266 extends class33 implements class55 {
    ...
    @OriginalMember(owner = "client!lp", name = "i", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IILco;ILqa;ZZ)V", line = 15)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IILqa;)Lc;", line = 47)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ILqa;)V", line = 58)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Lqa;III)Z", line = 86)
    ...
    @OriginalMember(owner = "client!lp", name = "f", descriptor = "(I)I", line = 111)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Lqa;IIZ)Ltt;", line = 123)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Z)Z", line = 159)
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(B)I", line = 171)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(B)I", line = 185)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Lqa;I)Lip;", line = 195)
    ...
    @OriginalMember(owner = "client!lp", name = "c", descriptor = "(ILqa;)V", line = 222)
    public final void method400(int arg0, class162 arg1) {
        int var3 = -78 / ((arg0 - -29) / 33);
        ++field3640;
    }

    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(I)I", line = 232)
    ...
    @OriginalMember(owner = "client!lp", name = "c", descriptor = "(B)I", line = 246)
    ...
    @OriginalMember(owner = "client!lp", name = "j", descriptor = "(I)V", line = 258)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IIIIIBIII)V", line = 271)
    ...
    @OriginalMember(owner = "client!lp", name = "c", descriptor = "(I)V", line = 282)
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(Lqa;Lpk;IIIIIZIIIIIIZ)V", line = 296)
    ...
    @OriginalMember(owner = "client!lp", name = "e", descriptor = "(I)V", line = 329)
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(ILqa;)V", line = 347)
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(I)Z", line = 381)
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(IILqa;)Lc;", line = 392)
