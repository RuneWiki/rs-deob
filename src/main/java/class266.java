...
public class class266 extends class279 {
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(IIIIB)V", line = 14)
    ...
    @OriginalMember(owner = "client!uu", name = "c", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(IIIIIII)V", line = 60)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(III)Z", line = 501)
    ...
    @OriginalMember(owner = "client!uu", name = "d", descriptor = "(I)V", line = 514)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(IB)V", line = 532)
    ...
    @OriginalMember(owner = "client!uu", name = "<init>", descriptor = "(Ljaa;II)V", line = 545)
