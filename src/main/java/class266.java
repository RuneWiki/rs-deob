...
public class class266 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(ILsr;II)V")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(BLsr;II)V")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lsr;III)Z")
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "(Lge;Lwh;)V")
