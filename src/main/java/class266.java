...
public abstract class class266 {
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(I)Ljava/net/Socket;", line = 20)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(ZLjava/lang/Throwable;)Ljava/lang/String;", line = 33)
