...
public class class266 extends class28 {
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(IB)Lbea;", line = 4)
    ...
    @OriginalMember(owner = "client!sca", name = "<init>", descriptor = "(II)V", line = 31)
    public class266(int arg0, int arg1) {
        this.field3648 = arg0;
        this.field3647 = arg1;
    }

    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(IIIBIILoa;II)V", line = 44)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(I)Z", line = 181)
    ...
    @OriginalMember(owner = "client!sca", name = "b", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(Z)I", line = 207)
    public final int method1644(boolean arg0) {
        field3654++;
        return arg0 ? this.field3648 >> 18 & 0x7 : -125;
    }

    @OriginalMember(owner = "client!sca", name = "b", descriptor = "(Z)I", line = 219)
    ...
    @OriginalMember(owner = "client!sca", name = "c", descriptor = "(I)Z", line = 234)
    ...
    @OriginalMember(owner = "client!sca", name = "b", descriptor = "(IB)Z", line = 245)
    ...
    @OriginalMember(owner = "client!sca", name = "f", descriptor = "(I)Z", line = 256)
