...
public class class76 implements Runnable {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Ljava/lang/Runnable;BI)Lbc;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ILjava/net/URL;)Lbc;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(BILjava/lang/String;)Lbc;")
    public final class285 method588(byte arg0, int arg1, String arg2) {
        return arg0 >= -37 ? null : this.method598(-12773, 0, arg1, 1, arg2);
    }

    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IIIII)Lbc;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(I)Lbc;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(BLjava/awt/Component;Z)Lbc;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ZLjava/lang/Class;[Ljava/lang/Class;Ljava/lang/String;)Lbc;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ILjava/awt/Frame;)Lbc;")
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(I)Lbc;")
    public final class285 method595(int arg0) {
        return arg0 < 68 ? null : this.method598(-12773, 0, 0, 18, (Object) null);
    }

    @OriginalMember(owner = "client!ne", name = "c", descriptor = "(I)Lbc;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IIIILjava/lang/Object;)Lbc;")
    ...
    @OriginalMember(owner = "client!ne", name = "d", descriptor = "(I)Lbc;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;B)Lbc;")
    ...
    @OriginalMember(owner = "client!ne", name = "e", descriptor = "(I)Lkl;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IILjava/lang/Object;II)Lbc;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Ljava/awt/Component;IILjava/awt/Point;[II)Lbc;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Ljava/lang/Class;I)Lbc;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ZLjava/lang/Class;)Lbc;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ILjava/lang/Class;)Lbc;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(II)Lbc;")
    public final class285 method608(int arg0, int arg1) {
        return arg0 < 119 ? null : this.method598(-12773, 0, arg1, 3, (Object) null);
    }

    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Ljava/lang/String;B)Lbc;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ZLjava/lang/String;Ljava/lang/Class;)Lbc;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IIILjava/awt/Component;)Lbc;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ZLjava/lang/String;)Lbc;")
