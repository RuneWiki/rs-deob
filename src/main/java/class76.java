...
public class class76 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lmd;BI)V", line = 8)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lmd;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(I)V", line = 48)
