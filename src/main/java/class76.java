...
public class class76 extends class152 {
    ...
    @OriginalMember(owner = "client!wk", name = "c", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(Lig;I)V", line = 15)
    public class76(class132 arg0, int arg1) {
        this.field993 = arg0;
        this.field992 = new class234(arg0, 6408, arg1);
    }

    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(ILwl;FLwl;)V", line = 29)
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(I)Lwl;", line = 111)
