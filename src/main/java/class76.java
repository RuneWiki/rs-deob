...
public class class76 extends class96 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(ILae;)V")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Ljo;Z)Z")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Lae;IZ)V")
