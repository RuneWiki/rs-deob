...
public class class76 extends class370 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIIZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!co", name = "d", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(III)I", line = 62)
    ...
    @OriginalMember(owner = "client!co", name = "c", descriptor = "(Lqa;I)V", line = 79)
    ...
    @OriginalMember(owner = "client!co", name = "b", descriptor = "(Z)I", line = 103)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "(IIIIIIIIIIIZ)V", line = 114)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIILqa;)Z", line = 141)
    public final boolean method122(int arg0, int arg1, int arg2, class162 arg3) {
        ++field1290;
        return arg1 != -1;
    }

    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lc;BLqa;)V", line = 160)
    ...
    @OriginalMember(owner = "client!co", name = "e", descriptor = "(I)Z", line = 187)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Z)V", line = 199)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ILqa;)Lbw;", line = 212)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IILqa;)Lc;", line = 245)
    ...
    @OriginalMember(owner = "client!co", name = "finalize", descriptor = "()V", line = 263)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(B)V", line = 280)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IILqa;IZLha;I)V", line = 295)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IB)V", line = 307)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(I)V", line = 382)
    ...
    @OriginalMember(owner = "client!co", name = "c", descriptor = "(B)V", line = 573)
