...
public class class76 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ZLdh;)V", line = 27)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(B)[Lgo;", line = 58)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IILdh;)V", line = 69)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IZIIII)V", line = 89)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIZII)Lls;", line = 147)
