...
public class class76 extends class118 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(BZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Lbaa;IB)V", line = 14)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ZB)V", line = 47)
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!gh", name = "c", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IBI)V", line = 102)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(B)Z", line = 120)
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(Los;)V", line = 131)
    ...
    @OriginalMember(owner = "client!gh", name = "c", descriptor = "(B)V", line = 149)
