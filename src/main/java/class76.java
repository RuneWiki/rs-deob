...
public abstract class class76 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(II)I", line = 23)
    ...
    @OriginalMember(owner = "client!jb", name = "b", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/String;C)Ljava/lang/String;", line = 60)
