...
public class class76 extends class264 {
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "([J[IB)V", line = 13)
    ...
    @OriginalMember(owner = "client!sj", name = "b", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(Lat;Ljava/lang/String;I)I", line = 48)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(BLjava/lang/String;)[B", line = 68)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(ZLjava/lang/String;ZLdf;)V", line = 210)
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "(IIIIIZ)V", line = 236)
