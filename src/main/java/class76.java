...
public class class76 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Lc;III)Z")
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(Lc;III)V")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IILc;B)V")
    ...
    @OriginalMember(owner = "client!am", name = "<init>", descriptor = "(Lse;Lsb;)V")
