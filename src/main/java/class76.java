...
public class class76 {
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(ILkh;)V")
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lwk;I)Z")
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(Lkh;)V")
