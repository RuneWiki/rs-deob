...
public class class76 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Lbt;BI)V")
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IIILbw;ILqa;Z)Lc;")
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(BLbt;)V")
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(ZLna;ILna;Lqa;ILbw;BIIIIII)Lc;")
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IILna;ILna;ILqa;ZIIIILbw;)Lc;")
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IILqa;ILbw;BI)Lc;")
