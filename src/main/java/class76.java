...
public class class76 extends class386 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "()V", line = 91)
    public class76() {
        super(1, false);
    }

    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(II)[[I", line = 94)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(IIII)V", line = 228)
    ...
    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(Z)V", line = 241)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(IBLun;)V", line = 279)
