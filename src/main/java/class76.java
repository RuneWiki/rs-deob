...
public class class76 extends class147 {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(JB)V", line = 4)
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(Z)Lwd;", line = 29)
    ...
    @OriginalMember(owner = "client!rh", name = "c", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "(II)V", line = 67)
