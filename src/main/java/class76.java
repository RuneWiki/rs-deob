...
public class class76 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ILia;)Ljava/lang/String;", line = 44)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(III)Lhc;", line = 58)
