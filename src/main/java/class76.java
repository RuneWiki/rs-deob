...
public class class76 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lio;I)V", line = 15)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IILio;)V", line = 72)
