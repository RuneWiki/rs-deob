...
public class class76 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lnr;IIII[S[B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "()V", line = 63)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lnr;Lil;IIII[I[I)V", line = 84)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(II)Lrr;", line = 220)
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "()V", line = 236)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lnr;)Lmi;", line = 258)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lqj;)V", line = 269)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lnr;IIIIIII[S[BZ)V", line = 289)
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(Lnr;)V", line = 451)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lnr;IIII)V", line = 462)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lfl;II)V", line = 806)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lfl;III)I", line = 816)
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(Lnr;IIII)Lmi;", line = 874)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IIIIIIII)V", line = 884)
    ...
    @OriginalMember(owner = "client!ne", name = "c", descriptor = "()V", line = 894)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lnr;II)V", line = 907)
    ...
    @OriginalMember(owner = "client!ne", name = "d", descriptor = "()V", line = 1091)
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(II)Las;", line = 1249)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "([B[B[SII)V", line = 1270)
    ...
    @OriginalMember(owner = "client!ne", name = "e", descriptor = "()V", line = 1415)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lnr;Llo;IIII)V", line = 1429)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(I)V", line = 1433)
    public static final void method487(int arg0) {
        field1019 = (class177) field1020.method954(79, (long) arg0);
    }

    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(I)Las;", line = 1445)
