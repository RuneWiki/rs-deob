...
public class class76 implements Runnable {
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(ILdm;)V")
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(Lwc;I)I")
    ...
    @OriginalMember(owner = "client!qw", name = "<init>", descriptor = "(Ljava/net/Socket;Lvk;I)V")
