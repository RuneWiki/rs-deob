...
public class class76 extends class748 {
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "()V", line = 37)
    public class76() {
        super(0, true);
    }

    @OriginalMember(owner = "client!tc", name = "c", descriptor = "(Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(II)[I", line = 69)
    ...
    @OriginalMember(owner = "client!tc", name = "c", descriptor = "(II)V", line = 188)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IZLvj;)V", line = 207)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(BIZIII)V", line = 253)
