...
public class class76 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IIIIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IIIIIILuo;III)V", line = 60)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(ZILuo;)Z", line = 140)
    ...
    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "(I[Lcs;IIII)V", line = 1083)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Z)V", line = 222)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(ILla;)V", line = 241)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(I)V", line = 961)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(I)V", line = 991)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(ILjava/lang/String;B)V", line = 1003)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(B)V", line = 1019)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(B)V", line = 1110)
