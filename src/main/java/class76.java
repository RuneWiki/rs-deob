...
public class class76 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Ljava/lang/String;II[Laq;I)I")
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "([Laq;Ljava/lang/String;[I[Ljava/lang/String;B)I")
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "([Laq;Ljava/lang/String;I)I")
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Ljava/lang/String;IB[Laq;)I")
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Ljava/lang/String;II[Laq;)I")
