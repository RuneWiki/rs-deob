...
public class class76 extends class195 {
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "(Lwh;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "(Lwh;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "(Lwh;IIIIZ[IIIZ)V")
    ...
    @OriginalMember(owner = "client!aw", name = "h", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "(Lwh;IIIII)V")
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "(Lwh;IIII)V")
