...
public class class76 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ILbi;IILpe;)V", line = 24)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(B)V", line = 320)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(JB)V", line = 340)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(III)Z", line = 354)
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(III)Lgl;", line = 373)
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(B)V", line = 382)
