...
public class class76 extends OutputStream {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(BIILkv;II)V", line = 7)
    ...
    @OriginalMember(owner = "client!jj", name = "write", descriptor = "(I)V", line = 133)
    public final void write(int arg0) throws IOException {
        field1105++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IIIII)V", line = 145)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(B)V", line = 168)
