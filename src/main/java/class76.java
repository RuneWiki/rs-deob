...
public class class76 {
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(IBI)I", line = 5)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(IIB)Z", line = 22)
    ...
    @OriginalMember(owner = "client!sga", name = "d", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!sga", name = "e", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!sga", name = "f", descriptor = "(I)V", line = 86)
