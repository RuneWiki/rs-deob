...
public class class76 {
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(IB)Lee;")
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(BI)Lhfa;")
    ...
    @OriginalMember(owner = "client!hka", name = "<init>", descriptor = "(Ljk;ILae;)V")
    public class76(class788 arg0, int arg1, class283 arg2) {
        this.field844 = arg2;
        this.field844.method1867(30, (byte) 49);
    }

    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(Laa;Lsha;ILha;IIIIZ)V")
