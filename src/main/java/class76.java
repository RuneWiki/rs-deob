...
public class class76 extends Exception {
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(IIIBI[B)V", line = 4)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(BLwm;)V", line = 48)
    ...
    @OriginalMember(owner = "client!qw", name = "b", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(ILmq;)V", line = 130)
