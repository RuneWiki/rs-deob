...
public class class76 {
    ...
    @OriginalMember(owner = "client!kca", name = "<init>", descriptor = "(Loa;IZLjava/awt/Component;)V", line = 176)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "()I", line = 10)
    public final int method595() {
        return this.field1202;
    }

    @OriginalMember(owner = "client!kca", name = "b", descriptor = "()I", line = 14)
    public final int method596() {
        return this.field1198 - 1;
    }

    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(Loa;Ljava/lang/String;IIIZ)V", line = 18)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(Loa;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 39)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(Ljava/lang/String;)I", line = 132)
    ...
    @OriginalMember(owner = "client!kca", name = "c", descriptor = "()V", line = 148)
    public static void method600() {
        field1201 = null;
    }

    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(Loa;Ljava/lang/String;[IIIIZ)V", line = 156)
