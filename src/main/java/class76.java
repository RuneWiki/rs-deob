...
public class class76 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(III[I)Ljc;", line = 10)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "([IIB)Ljc;", line = 58)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(I[IIB)Ljc;", line = 91)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IIIBIIII)V", line = 138)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(I[II)Ljc;", line = 259)
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(Lqn;Lqn;)V", line = 288)
