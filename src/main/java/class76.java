...
public class class76 extends class192 {
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(IB)[I", line = 4)
    ...
    @OriginalMember(owner = "client!rda", name = "<init>", descriptor = "()V", line = 38)
    public class76() {
        super(1, false);
    }

    @OriginalMember(owner = "client!rda", name = "b", descriptor = "(IB)[[I", line = 41)
    ...
    @OriginalMember(owner = "client!rda", name = "c", descriptor = "(I)Lkq;", line = 88)
    ...
    @OriginalMember(owner = "client!rda", name = "c", descriptor = "(B)V", line = 123)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(ILfd;I)V", line = 138)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(ILoa;II)V", line = 181)
