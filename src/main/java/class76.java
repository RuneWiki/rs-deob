...
public class class76 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IZLjava/lang/String;Ldp;)Ld;", line = 52)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(II)V", line = 94)
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!ne", name = "c", descriptor = "(I)Ljo;", line = 145)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ILnc;)V", line = 160)
    public static final void method601(int arg0, class126 arg1) {
        class50.field816[arg0] = arg1;
    }

    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IIBLkq;I)V", line = 164)
