...
public class class76 {
    ...
    @OriginalMember(owner = "client!aa", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(I)[Lpe;", line = 30)
    ...
    @OriginalMember(owner = "client!aa", name = "c", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(B)I", line = 62)
    ...
    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(II)V", line = 73)
    public class76(int arg0, int arg1) {
        this.field1070 = arg0;
    }

    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(II)I", line = 84)
