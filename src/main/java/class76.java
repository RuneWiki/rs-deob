...
public class class76 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(III)I", line = 8)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Lrt;)V", line = 29)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "()V", line = 119)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(II)[I", line = 132)
