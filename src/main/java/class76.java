...
public class class76 extends class417 {
    ...
    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "(ZLlp;)V", line = 77)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(BLgw;)V", line = 199)
