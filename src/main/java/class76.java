...
public class class76 extends class307 {
    ...
    @OriginalMember(owner = "client!lea", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 4)
    public class76(Object arg0, int arg1) {
        super(arg1);
        this.field954 = new SoftReference(arg0);
    }

    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 14)
    public final Object method434(int arg0) {
        return arg0 > -26 ? (Object) null : this.field954.get();
    }

    @OriginalMember(owner = "client!lea", name = "g", descriptor = "(I)Z", line = 24)
