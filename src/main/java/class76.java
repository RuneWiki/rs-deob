...
public class class76 extends class535 {
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(II)[[I", line = 7)
    ...
    @OriginalMember(owner = "client!bm", name = "b", descriptor = "(II)[I", line = 78)
    ...
    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "()V", line = 131)
    public class76() {
        super(1, false);
    }

    @OriginalMember(owner = "client!bm", name = "f", descriptor = "(B)V", line = 134)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(IIIII)V", line = 147)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(JB)Ljava/lang/String;", line = 163)
    ...
    @OriginalMember(owner = "client!bm", name = "c", descriptor = "(II)Z", line = 200)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(ILwn;I)V", line = 211)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(IILjava/lang/String;BIIII)V", line = 246)
