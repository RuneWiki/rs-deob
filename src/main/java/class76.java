...
public class class76 extends class297 {
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Lcea;II)V", line = 9)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(IZ)V", line = 47)
    ...
    @OriginalMember(owner = "client!aw", name = "d", descriptor = "(II)[[I", line = 81)
    ...
    @OriginalMember(owner = "client!aw", name = "b", descriptor = "(B)V", line = 135)
    ...
    @OriginalMember(owner = "client!aw", name = "e", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!aw", name = "e", descriptor = "(II)V", line = 167)
    ...
    @OriginalMember(owner = "client!aw", name = "f", descriptor = "(I)V", line = 418)
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "()V", line = 524)
    public class76() {
        super(1, false);
    }
}
