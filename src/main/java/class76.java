...
public class class76 extends class311 {
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(Lmn;Ljava/lang/Object;)V", line = 8)
    public class76(class205 arg0, Object arg1) {
        super(arg0);
        this.field899 = arg1;
    }

    @OriginalMember(owner = "client!mr", name = "i", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!mr", name = "e", descriptor = "(I)Z", line = 35)
    ...
    @OriginalMember(owner = "client!mr", name = "h", descriptor = "(I)Ljava/lang/Object;", line = 46)
    public final Object method423(int arg0) {
        field895++;
        return arg0 == -27364 ? this.field899 : null;
    }

    @OriginalMember(owner = "client!mr", name = "j", descriptor = "(I)V", line = 62)
