...
public class class76 extends class17 {
    ...
    @OriginalMember(owner = "client!bm", name = "h", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "()V", line = 125)
    public class76() {
        super(0, false);
    }

    @OriginalMember(owner = "client!bm", name = "i", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!bm", name = "j", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!bm", name = "k", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(IB)[[I", line = 128)
    ...
    @OriginalMember(owner = "client!bm", name = "b", descriptor = "(III)V", line = 193)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Lwm;II)V", line = 215)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(B)I", line = 230)
