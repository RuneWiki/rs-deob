...
public class class76 {
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(ILjava/lang/String;ZB)I", line = 7)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(BD)V", line = 85)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(Ltp;III)V", line = 115)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(Z)V", line = 147)
