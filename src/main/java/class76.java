...
public class class76 extends class11 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(II)[[I", line = 10)
    ...
    @OriginalMember(owner = "client!jj", name = "d", descriptor = "(II)[I", line = 88)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Lsi;II)V", line = 142)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ILjava/lang/String;)V", line = 166)
    ...
    @OriginalMember(owner = "client!jj", name = "e", descriptor = "(II)I", line = 267)
    ...
    @OriginalMember(owner = "client!jj", name = "c", descriptor = "(Z)V", line = 285)
