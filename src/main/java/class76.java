...
public class class76 implements class334 {
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 17)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(BJ)Z", line = 93)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(B)I", line = 104)
    ...
    @OriginalMember(owner = "client!sga", name = "d", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!sga", name = "b", descriptor = "(B)V", line = 154)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Ljava/lang/Class;ILjava/lang/String;)Ljava/lang/Object;", line = 165)
    ...
    @OriginalMember(owner = "client!sga", name = "c", descriptor = "(I)V", line = 186)
    ...
    @OriginalMember(owner = "client!sga", name = "e", descriptor = "(I)V", line = 213)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Class;Ljava/lang/Object;)Z", line = 227)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(BI)I", line = 244)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(ZB)V", line = 265)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/String;B)I", line = 456)
    ...
    @OriginalMember(owner = "client!sga", name = "b", descriptor = "(BI)I", line = 469)
    ...
    @OriginalMember(owner = "client!sga", name = "b", descriptor = "(I)V", line = 488)
