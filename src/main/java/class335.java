...
public class class335 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(II)I", line = 74)
    ...
    @OriginalMember(owner = "client!qk", name = "c", descriptor = "(II)Laf;", line = 144)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(BLpe;I)V", line = 184)
