...
public class class335 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILfs;I)Lqh;", line = 19)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IZLya;IIBZ)Lt;", line = 37)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IB)V", line = 170)
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(Lya;Lrd;IIIIIIZI)V", line = 566)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(B)I", line = 293)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(BF)F", line = 305)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILya;)V", line = 322)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lr;I)V", line = 333)
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(I)Z", line = 368)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(III)V", line = 384)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ZIILt;ILya;II)V", line = 485)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(II)V", line = 527)
    ...
    @OriginalMember(owner = "client!bi", name = "finalize", descriptor = "()V", line = 553)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ZLya;)V", line = 586)
