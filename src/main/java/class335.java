...
public class class335 extends class477 implements class387 {
    ...
    @OriginalMember(owner = "client!ga", name = "finalize", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(IIIIIIZII)V", line = 15)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(II)I", line = 53)
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(Lpea;III)V", line = 257)
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(Lpea;IIII)V", line = 276)
    ...
    @OriginalMember(owner = "client!ga", name = "g", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(III)V", line = 116)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(IIIIIIII)V", line = 129)
    ...
    @OriginalMember(owner = "client!ga", name = "h", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!ga", name = "c", descriptor = "(B)V", line = 217)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(I)V", line = 240)
