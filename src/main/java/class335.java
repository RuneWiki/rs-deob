...
public class class335 extends class295 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ILnq;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ug", name = "f", descriptor = "(I)Z", line = 31)
    public final boolean method1209(int arg0) {
        field4611++;
        return arg0 != -7;
    }

    @OriginalMember(owner = "client!ug", name = "d", descriptor = "(I)Ljava/lang/Object;", line = 45)
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(II)I", line = 57)
    public static final int method2147(int arg0, int arg1) {
        field4608++;
        return arg1 > -123 ? -89 : arg0 >>> 7;
    }

    @OriginalMember(owner = "client!ug", name = "g", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(Ljava/lang/Object;)V", line = 90)
