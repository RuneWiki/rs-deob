...
public class class335 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IIII)Lpi;", line = 3)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(I)V", line = 22)
    public static void method2056(int arg0) {
        field4773 = null;
        int var1 = -77 % ((arg0 - 48) / 61);
    }

    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(III)Z", line = 33)
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(IIIIB)V", line = 65)
    ...
    @OriginalMember(owner = "client!pi", name = "b", descriptor = "(I)Lqw;", line = 77)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IILow;ILha;)V", line = 93)
