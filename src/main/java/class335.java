...
public class class335 extends class478 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(ZB)V", line = 6)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(III)Lgq;", line = 19)
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(Lih;II[BI)V", line = 26)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IIIZI)V", line = 45)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(I)V", line = 303)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lmk;IIII[IZIIIII[IBI)I", line = 313)
    ...
    @OriginalMember(owner = "client!nm", name = "f", descriptor = "(I)V", line = 490)
