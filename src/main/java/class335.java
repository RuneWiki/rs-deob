...
public class class335 extends class202 {
    ...
    @OriginalMember(owner = "client!ol", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ol", name = "d", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(III)V", line = 36)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "()V", line = 42)
    ...
    @OriginalMember(owner = "client!ol", name = "f", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(III)V", line = 77)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(III[I)V", line = 84)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "()Lol;", line = 90)
    ...
    @OriginalMember(owner = "client!ol", name = "e", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Lpo;)V", line = 117)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "([I)V", line = 134)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IIIIII)V", line = 147)
    ...
    @OriginalMember(owner = "client!ol", name = "<init>", descriptor = "()V", line = 177)
    public class335() {
        this.method1531();
    }
}
