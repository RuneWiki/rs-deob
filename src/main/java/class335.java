...
public class class335 extends class245 implements class51 {
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lsb;Lkea;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lsb;Lkea;Lkf;II)V")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ZILkea;I[FIIII)V")
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lsb;Lkea;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "([BILkea;IIIIII)V")
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lsb;IIZ[III)V")
