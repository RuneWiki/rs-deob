...
public class class335 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "([Lwq;IIIILtl;I)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lqa;Lna;ILna;BLna;[[I)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lna;Lqa;BLna;)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Ltl;IIIII[Lwq;III)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ZIIIIIIILtl;II)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lqa;[[BII[ZII[[B[[BIILao;ILcw;)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lqa;Z[Lwq;[[[I)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lqa;Lna;ILna;[[ILna;Z)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lns;BLns;)I")
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(IIIZLhs;Lbl;)V")
