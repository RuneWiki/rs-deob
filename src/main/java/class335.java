...
public class class335 extends class354 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(ILqo;IIIIIIIII)Z")
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Lhe;Lhe;ILbk;Lhe;)Z")
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Lso;ILmd;II)V")
