...
public class class335 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IIIIILqg;)Lls;", line = 14)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(I)V", line = 88)
