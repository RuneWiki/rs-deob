...
public class class335 extends class394 implements class9 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ILae;I)Lbk;")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(BLae;)Ljg;")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ILae;)V")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Lae;B)V")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ILae;II)Z")
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(Lae;Ljh;IIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Lae;I)V")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ZBIILna;ILae;)V")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Lae;ZI)Lbk;")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IZLae;I)Lsk;")
