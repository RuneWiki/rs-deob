...
public class class335 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(B)[[[I", line = 8)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(BI)[[I", line = 31)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(ZI)[B", line = 103)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Z)V", line = 154)
    ...
    @OriginalMember(owner = "client!ol", name = "<init>", descriptor = "(III)V", line = 218)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(B)V", line = 195)
