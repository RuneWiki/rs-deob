...
public class class335 {
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(ZLwe;)Ljava/lang/Object;", line = 15)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Lwe;B)V", line = 72)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(ILwe;Ljava/lang/Object;)V", line = 97)
    public final void method1980(int arg0, class428 arg1, Object arg2) {
        this.method1987(0, arg1, arg2, arg0);
        field4146++;
    }

    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Z)I", line = 116)
    ...
    @OriginalMember(owner = "client!iw", name = "b", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!iw", name = "b", descriptor = "(B)V", line = 157)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(BI)V", line = 169)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(ILpm;)V", line = 224)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(ILwe;Ljava/lang/Object;I)V", line = 242)
    ...
    @OriginalMember(owner = "client!iw", name = "<init>", descriptor = "(I)V", line = 592)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(IB)Laea;", line = 275)
