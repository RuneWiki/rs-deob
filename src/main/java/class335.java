...
public class class335 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(ILha;)V", line = 30)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(II)Luq;", line = 71)
    ...
    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "(IIII)V", line = 82)
