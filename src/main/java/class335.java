...
public class class335 extends class14 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Lqa;II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!aa", name = "c", descriptor = "(III)Lgv;", line = 413)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(II)[[I", line = 421)
    ...
    @OriginalMember(owner = "client!aa", name = "e", descriptor = "(I)V", line = 507)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IIIIIII)I", line = 517)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IILqa;IIB)V", line = 551)
    ...
    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "()V", line = 649)
    public class335() {
        super(1, false);
    }

    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IBLmd;)V", line = 657)
