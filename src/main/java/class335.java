...
public class class335 extends InputStream {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!qq", name = "read", descriptor = "()I", line = 19)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(BI)Lje;", line = 29)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(III)Lne;", line = 62)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(I)V", line = 70)
