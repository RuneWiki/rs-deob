...
public class class335 {
    ...
    @OriginalMember(owner = "client!ef", name = "toString", descriptor = "()Ljava/lang/String;", line = 6)
    public final String toString() {
        field5056++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "([BI)[B", line = 35)
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(IIII)V", line = 50)
