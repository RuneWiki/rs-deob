...
public class class335 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IIIIZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(I)V", line = 202)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(II)V", line = 215)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IIZ)I", line = 239)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(I)V", line = 257)
