...
public class class335 extends class93 {
    ...
    @OriginalMember(owner = "client!iw", name = "e", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(FZ)V", line = 21)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Lr;III[Z)Z", line = 44)
    ...
    @OriginalMember(owner = "client!iw", name = "<init>", descriptor = "(I)V", line = 82)
    public class335(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!iw", name = "f", descriptor = "(Z)V", line = 87)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(IF)V", line = 98)
