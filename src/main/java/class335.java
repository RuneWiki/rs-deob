...
public class class335 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ILha;I)Z")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIIIILha;IIII)V")
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(I[Lpg;IIII)V")
