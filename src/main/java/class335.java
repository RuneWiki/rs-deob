...
public class class335 extends class386 {
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "()V", line = 3)
    public class335() {
        super(0, true);
    }

    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IBLun;)V", line = 8)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(II)[I", line = 86)
    ...
    @OriginalMember(owner = "client!bc", name = "c", descriptor = "(III)Z", line = 135)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!bc", name = "e", descriptor = "(I)V", line = 174)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(ZII)Z", line = 216)
