...
public abstract class class335 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(BI[ILjava/lang/String;IIILsg;[Lvj;)V", line = 7)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 158)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IIILjava/lang/String;II)V", line = 199)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IIII[III[Lvj;I[IIILjava/util/Random;ILjava/lang/String;)I", line = 215)
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(Lvq;Lbb;)V", line = 296)
    public class335(class269 arg0, class182 arg1) {
        this.field4857 = arg0;
        this.field4859 = arg1;
    }

    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(II[I[Lvj;IILjava/lang/String;I)V", line = 306)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IIIBLjava/lang/String;I)V", line = 322)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IIII[[[BIIIIBILvq;I)V", line = 337)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Ljava/lang/String;IIIIIII)V", line = 371)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ILjava/lang/String;)V", line = 405)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "([I[Lvj;[IZI[ILjava/lang/String;I)V", line = 480)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ILjava/lang/String;IIIII)V", line = 644)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(BII)V", line = 674)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IIILjava/lang/String;IIIILsg;III[III[Lvj;)I", line = 695)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IIILjava/lang/String;BII)V", line = 785)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IILjava/lang/String;BII)V", line = 816)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Ljava/lang/String;I[Lvj;[IILjava/util/Random;IIII)I", line = 832)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(B)V", line = 877)
