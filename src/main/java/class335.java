...
public class class335 extends class206 {
    ...
    @OriginalMember(owner = "client!eq", name = "d", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!eq", name = "c", descriptor = "(I)Ljava/lang/Object;", line = 15)
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Lgj;Ljava/lang/Object;I)V", line = 25)
