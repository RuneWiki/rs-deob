...
public class class335 {
    ...
    @OriginalMember(owner = "client!st", name = "b", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!st", name = "toString", descriptor = "()Ljava/lang/String;", line = 41)
    public final String toString() {
        field4721++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "(II)V", line = 48)
