...
public class class335 extends class507 {
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ZLfo;ZIIBLl;D)[I", line = 7)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Lfo;Ll;B)Z", line = 145)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ILl;ZILfo;I)[F", line = 200)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(III)Z", line = 314)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Ll;Lfo;DBIIZ)[I", line = 330)
    ...
    @OriginalMember(owner = "client!ap", name = "d", descriptor = "(I)Lja;", line = 468)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Loq;III)Lnc;", line = 512)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(II)I", line = 594)
    public static int method1958(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "()V", line = 600)
    public class335() {
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(Lug;)V", line = 615)
