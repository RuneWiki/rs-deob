...
public class class335 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(ZLnj;)Lko;")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lia;III[Z)Z")
