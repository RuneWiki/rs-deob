...
public class class335 extends class148 {
    ...
    @OriginalMember(owner = "client!mn", name = "f", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "()V", line = 17)
    public class335() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IIII)[B", line = 26)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(BII)V", line = 39)
