...
public class class335 extends class582 {
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Lpda;)V", line = 5)
    public final synchronized void method2107(class582 arg0) {
        this.field4955.method479((byte) -127, arg0);
    }

    @OriginalMember(owner = "client!bfa", name = "e", descriptor = "()V", line = 8)
    ...
    @OriginalMember(owner = "client!bfa", name = "c", descriptor = "([III)V", line = 27)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "()Lpda;", line = 36)
    public final class582 method397() {
        return (class582) this.field4955.method472((byte) -24);
    }

    @OriginalMember(owner = "client!bfa", name = "b", descriptor = "()I", line = 40)
    public final int method406() {
        return 0;
    }

    @OriginalMember(owner = "client!bfa", name = "f", descriptor = "()I", line = 43)
    public final synchronized int method2110() {
        return this.field4955.method477(15650);
    }

    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Lwa;)V", line = 46)
    ...
    @OriginalMember(owner = "client!bfa", name = "b", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Lpca;Lwa;)V", line = 75)
    ...
    @OriginalMember(owner = "client!bfa", name = "b", descriptor = "(Lpda;)V", line = 85)
    public final synchronized void method2114(class582 arg0) {
        arg0.method3678(-1);
    }

    @OriginalMember(owner = "client!bfa", name = "c", descriptor = "()Lpda;", line = 88)
    public final class582 method403() {
        return (class582) this.field4955.method482(119);
    }

    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "([III)V", line = 95)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(I)V", line = 150)
