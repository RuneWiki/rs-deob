...
public class class335 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IIIILuo;Lgd;I)V")
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(B)Lhm;")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(I[I[ILbe;[I)V")
