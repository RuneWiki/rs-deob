...
public class class335 {
    ...
    @OriginalMember(owner = "client!vc", name = "finalize", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Lffa;J[Lwj;)V", line = 44)
