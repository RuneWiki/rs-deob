...
public class class335 implements class450 {
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IIII)I", line = 8)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(ZII)Z", line = 33)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(I)Z", line = 46)
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!b", name = "c", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(Lkn;)V", line = 662)
    public class335(class742 arg0) {
        this.field4828 = arg0;
    }

    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IZ)V", line = 670)
