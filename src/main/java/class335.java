...
public class class335 extends class403 implements class9 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(ILud;)Lhl;", line = 4)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(IIIIIZI)V", line = 21)
    ...
    @OriginalMember(owner = "client!on", name = "<init>", descriptor = "(Loea;I[BI)V", line = 40)
    public class335(class594 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field4741 = arg1;
    }

    @OriginalMember(owner = "client!on", name = "a", descriptor = "(B)J", line = 49)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(I)I", line = 60)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lha;I)V", line = 77)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(IIII[IIII)Z", line = 93)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lha;Ld;I)V", line = 189)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Z)I", line = 417)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(III[B)V", line = 428)
