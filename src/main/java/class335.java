...
public class class335 extends class263 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(B)[Luc;", line = 9)
    ...
    @OriginalMember(owner = "client!vh", name = "b", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "(II)V", line = 30)
