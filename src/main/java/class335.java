...
public class class335 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IIIIIILvm;Llb;IB)Ljn;")
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Lvm;IIIILlb;I)Ljn;")
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IZLlb;IIILvm;Llb;[Lsc;IIII)Ljn;")
