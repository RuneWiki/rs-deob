...
public class class335 extends class199 {
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Lfu;Lkg;[Lgm;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(CIIIZ)V", line = 210)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(CIIIZLoj;II)V", line = 235)
