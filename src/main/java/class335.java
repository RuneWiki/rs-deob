...
public class class335 {
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(I)Lua;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Ljava/awt/Canvas;B)Lve;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Llk;I)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lfc;Z)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(ILlk;B)V")
