...
public class class335 extends class321 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Lui;Lui;Lui;ILui;)V")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IILvg;)Z")
    ...
    @OriginalMember(owner = "client!ph", name = "d", descriptor = "(I)Lfl;")
