...
public class class335 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IILgk;)V", line = 11)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(B)V", line = 91)
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(B)V", line = 118)
    public static void method2056(byte arg0) {
        int var1 = -93 % ((arg0 - 47) / 53);
        field4872 = null;
    }

    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(BLgk;)V", line = 134)
