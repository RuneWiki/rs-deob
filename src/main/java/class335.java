...
public class class335 extends class81 {
    ...
    @OriginalMember(owner = "client!nb", name = "e", descriptor = "(I)Ljava/lang/Object;", line = 6)
    public final Object method653(int arg0) {
        return arg0 == -1 ? this.field4534.get() : (Object) null;
    }

    @OriginalMember(owner = "client!nb", name = "c", descriptor = "(B)Z", line = 16)
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "(Ljava/lang/Object;)V", line = 24)
