...
public class class335 extends class107 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Ld;ILwia;)Z")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Lwia;DZILd;IZB)[I")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(ZIDILd;ZLwia;)[I")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(ILwia;Ld;ZII)[F")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(III)Leba;")
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Lso;)V")
