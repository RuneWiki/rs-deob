...
public class class335 extends Canvas {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!hk", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 17)
    public final void paint(Graphics arg0) {
        this.field4798.paint(arg0);
        field4797++;
    }

    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ZZ)Z", line = 43)
    public static boolean method2062(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 53)
    public class335(Component arg0) {
        this.field4798 = arg0;
    }

    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IIII)I", line = 64)
    ...
    @OriginalMember(owner = "client!hk", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 87)
