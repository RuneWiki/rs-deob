...
public class class335 {
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(IBLnd;)Ljl;", line = 26)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "()V", line = 43)
