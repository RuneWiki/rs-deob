...
public class class335 {
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(ILbi;)I", line = 7)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(III)Z", line = 51)
    ...
    @OriginalMember(owner = "client!pba", name = "b", descriptor = "(I)V", line = 66)
