...
public class class335 {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(II)[I", line = 6)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(III)I", line = 287)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Lnp;)V", line = 316)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "()V", line = 398)
