...
public class class335 {
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(B)I", line = 16)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(ZLjava/awt/Component;)Lhw;", line = 28)
    public static final class141 method2150(boolean arg0, Component arg1) {
        field4730++;
        return arg0 ? new class525(arg1) : null;
    }

    @OriginalMember(owner = "client!uea", name = "b", descriptor = "(B)Z", line = 40)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(II)J", line = 51)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(Z)I", line = 62)
    ...
    @OriginalMember(owner = "client!uea", name = "<init>", descriptor = "(ZIIZ)V", line = 82)
