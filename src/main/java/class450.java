...
public class class450 extends class96 {
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IILbt;)V", line = 4)
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "()V", line = 232)
    public class450() {
        super(0, true);
    }

    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(Z)V", line = 70)
    ...
    @OriginalMember(owner = "client!tc", name = "e", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!tc", name = "c", descriptor = "(II)V", line = 160)
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(II)[I", line = 174)
