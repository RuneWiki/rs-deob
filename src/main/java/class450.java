...
public class class450 extends class446 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Z[J[Ljava/lang/Object;)V", line = 15)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(IZ)V", line = 30)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(BI)Lid;", line = 48)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "(Lod;II[BI)V", line = 82)
