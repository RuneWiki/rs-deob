...
public class class450 extends class354 {
    ...
    @OriginalMember(owner = "client!or", name = "e", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IB)[I", line = 40)
    ...
    @OriginalMember(owner = "client!or", name = "f", descriptor = "(I)V", line = 254)
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "()V", line = 376)
    public class450() {
        super(0, true);
    }

    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ILti;I)V", line = 276)
    ...
    @OriginalMember(owner = "client!or", name = "g", descriptor = "(I)V", line = 360)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Z)V", line = 392)
