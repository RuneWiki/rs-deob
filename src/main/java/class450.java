...
public abstract class class450 extends class276 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IIIIIII)Lug;", line = 5)
    ...
    @OriginalMember(owner = "client!ja", name = "b", descriptor = "(Z)I", line = 25)
    ...
    @OriginalMember(owner = "client!ja", name = "b", descriptor = "(B)I", line = 41)
    ...
    @OriginalMember(owner = "client!ja", name = "c", descriptor = "(B)I", line = 57)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(I)I", line = 77)
    public final int method2697(int arg0) {
        field6708++;
        return arg0 < 117 ? -14 : this.field6703;
    }

    @OriginalMember(owner = "client!ja", name = "c", descriptor = "(I)F", line = 92)
    ...
    @OriginalMember(owner = "client!ja", name = "d", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "(IIIIIF)V", line = 112)
    ...
    @OriginalMember(owner = "client!ja", name = "c", descriptor = "(Z)I", line = 125)
