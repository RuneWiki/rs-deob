...
public class class450 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIIIBII)V", line = 21)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(IIIIBII)V", line = 61)
