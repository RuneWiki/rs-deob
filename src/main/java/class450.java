...
public class class450 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIII)Llh;")
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(B)Lgn;")
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(II)Lin;")
