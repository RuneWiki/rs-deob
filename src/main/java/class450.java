...
public class class450 extends class331 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIII)I", line = 4)
    ...
    @OriginalMember(owner = "client!lr", name = "c", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Lhp;)V", line = 64)
    public class450(class178 arg0) {
        this.field6448 = arg0;
    }

    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(BC)C", line = 72)
    ...
    @OriginalMember(owner = "client!lr", name = "f", descriptor = "(I)V", line = 87)
