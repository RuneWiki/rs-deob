...
public class class450 extends class55 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ILji;)Ldk;", line = 6)
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "()V", line = 37)
    public class450() {
    }
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 56)
    ...
    @OriginalMember(owner = "client!qd", name = "b", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(S)V", line = 96)
    public class450(short arg0) {
        this.field6288 = arg0;
    }

    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Lbq;ILuca;IILha;)Z", line = 104)
