...
public class class450 extends class35 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIZIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Lng;Ljava/lang/Object;I)V", line = 35)
    ...
    @OriginalMember(owner = "client!pf", name = "d", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "([Ljava/lang/String;B)[Ljava/lang/String;", line = 78)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IILtf;IIIIIIIII)Z", line = 106)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(II)Z", line = 544)
