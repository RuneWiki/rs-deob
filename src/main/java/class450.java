...
public class class450 extends class606 {
    ...
    @OriginalMember(owner = "client!jea", name = "<init>", descriptor = "(Lfha;Lfp;Lic;)V", line = 5)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(Lma;II)V", line = 25)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(ZI)V", line = 42)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(III)V", line = 75)
    ...
    @OriginalMember(owner = "client!jea", name = "f", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(IZ)V", line = 137)
    ...
    @OriginalMember(owner = "client!jea", name = "c", descriptor = "(I)Z", line = 148)
