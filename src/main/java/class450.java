...
public class class450 implements Runnable {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIBILjava/lang/Object;)Ldj;", line = 4)
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;I)V", line = 592)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Ljava/net/URL;I)Ldj;", line = 60)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;I)Ldj;", line = 71)
    public final class304 method2775(Transferable arg0, int arg1) {
        return arg1 > -112 ? null : this.method2772(19, 0, (byte) -66, 0, arg0);
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Ljava/lang/String;[Ljava/lang/Class;Ljava/lang/Class;I)Ldj;", line = 87)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(BLjava/lang/String;)Ldj;", line = 102)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ILjava/lang/Class;)Ldj;", line = 116)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(I)Ldj;", line = 126)
    ...
    @OriginalMember(owner = "client!lh", name = "run", descriptor = "()V", line = 140)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ZILjava/awt/Component;)Ldj;", line = 261)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(BLjava/awt/Frame;)Ldj;", line = 270)
    public final class304 method2781(byte arg0, Frame arg1) {
        int var3 = -64 / ((arg0 + 51) / 43);
        return this.method2772(7, 0, (byte) -66, 0, arg1);
    }

    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(I)Ldj;", line = 283)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IILjava/lang/String;)Ldj;", line = 293)
    public final class304 method2783(int arg0, int arg1, String arg2) {
        return arg1 == 0 ? this.method2772(1, arg0, (byte) -66, 0, arg2) : null;
    }

    @OriginalMember(owner = "client!lh", name = "c", descriptor = "(I)Lpl;", line = 307)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIILjava/awt/Component;)Ldj;", line = 318)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIIII)Ldj;", line = 331)
    ...
    @OriginalMember(owner = "client!lh", name = "d", descriptor = "(I)Ldj;", line = 342)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Ljava/lang/Runnable;II)Ldj;", line = 353)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(B)V", line = 362)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IILjava/lang/Object;IZ)Ldj;", line = 417)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ZLjava/lang/String;)Ldj;", line = 457)
    public final class304 method2791(boolean arg0, String arg1) {
        return arg0 ? null : this.method2772(21, 0, (byte) -66, 0, arg1);
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(II)Ldj;", line = 468)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(B)Ldj;", line = 478)
    public final class304 method2793(byte arg0) {
        int var2 = 60 / ((arg0 + 55) / 50);
        return this.method2772(18, 0, (byte) -66, 0, (Object) null);
    }

    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(ILjava/lang/Class;)Ldj;", line = 496)
    public final class304 method2794(int arg0, Class arg1) {
        return arg0 == 200 ? this.method2772(11, 0, (byte) -66, 0, arg1) : null;
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Ljava/lang/Class;I)Ldj;", line = 508)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(Z)Z", line = 522)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(BLjava/lang/String;)[B", line = 537)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;I)Ldj;", line = 555)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(II[IILjava/awt/Component;Ljava/awt/Point;)Ldj;", line = 569)
