...
public class class450 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Lnj;)V", line = 5)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(Lnj;)V", line = 15)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "()V", line = 30)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(I)I", line = 54)
