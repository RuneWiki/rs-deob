...
public class class450 extends class381 {
    ...
    @OriginalMember(owner = "client!f", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!f", name = "d", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(B[S)[S", line = 44)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IB)[B", line = 65)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IIB)Ldn;", line = 86)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Z)I", line = 314)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(II)I", line = 340)
    ...
    @OriginalMember(owner = "client!f", name = "b", descriptor = "(B)I", line = 360)
    ...
    @OriginalMember(owner = "client!f", name = "e", descriptor = "(I)V", line = 373)
    ...
    @OriginalMember(owner = "client!f", name = "f", descriptor = "(I)V", line = 417)
    ...
    @OriginalMember(owner = "client!f", name = "g", descriptor = "(I)I", line = 597)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(BI)V", line = 618)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(I)Lmd;", line = 649)
    ...
    @OriginalMember(owner = "client!f", name = "h", descriptor = "(I)I", line = 756)
    ...
    @OriginalMember(owner = "client!f", name = "<init>", descriptor = "(ILrb;Lrb;Lul;Lmr;IIZ)V", line = 810)
