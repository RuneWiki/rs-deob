...
public class class450 {
    ...
    @OriginalMember(owner = "client!q", name = "b", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 15)
    public class450(IDirect3DSwapChain arg0, IDirect3DSurface arg1) {
        this.method3458(arg1, -12378, arg0);
    }

    @OriginalMember(owner = "client!q", name = "a", descriptor = "(Ljagdx/IDirect3DSurface;ILjagdx/IDirect3DSwapChain;)V", line = 24)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(II)I", line = 64)
