...
public class class450 extends class86 {
    ...
    @OriginalMember(owner = "client!gj", name = "d", descriptor = "()Lhu;")
    public final synchronized class86 method692() {
        field6493++;
        return null;
    }

    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Ljj;Lqn;Lhr;II)Z")
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lrt;I)I")
    ...
    @OriginalMember(owner = "client!gj", name = "b", descriptor = "(Lrt;I)I")
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "()Lhu;")
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lrt;[IIII)Z")
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IZLhr;)V")
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lrt;B)I")
    ...
    @OriginalMember(owner = "client!gj", name = "c", descriptor = "(Lrt;I)Z")
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(ZBLrt;)V")
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lqn;IBI)Llf;")
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(BZLhr;Z)V")
