...
public abstract class class450 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IB)Lkd;")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IIBII)Lvp;")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Laq;ILuo;)V")
