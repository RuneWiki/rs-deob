...
public class class450 extends class91 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!lr", name = "f", descriptor = "(I)Lmh;")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(BLkb;)V")
    ...
    @OriginalMember(owner = "client!lr", name = "l", descriptor = "(I)V")
