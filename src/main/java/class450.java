...
public class class450 extends class9 {
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(ILvp;)I")
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(ILos;I)V")
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(BLos;)V")
