...
public class class450 {
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(I)Lrs;", line = 11)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(ZLcf;)V", line = 32)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "()V", line = 43)
    ...
    @OriginalMember(owner = "client!gj", name = "b", descriptor = "(I)Lrs;", line = 272)
    ...
    @OriginalMember(owner = "client!gj", name = "<init>", descriptor = "()V", line = 291)
    public class450() {
    }

    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(B)V", line = 294)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lis;Ljava/awt/Canvas;IILtq;I)Lvc;", line = 310)
    ...
    @OriginalMember(owner = "client!gj", name = "<init>", descriptor = "(Lcf;)V", line = 337)
