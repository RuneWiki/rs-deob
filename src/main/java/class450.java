...
public class class450 extends class681 {
    ...
    @OriginalMember(owner = "client!aa", name = "g", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(ILrga;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Z)Z", line = 35)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IIB)V", line = 48)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(ZI)V", line = 75)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IFFF)F", line = 86)
    ...
    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(ZI)V", line = 97)
    ...
    @OriginalMember(owner = "client!aa", name = "d", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!aa", name = "h", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(Ltba;Lsea;Lst;)V", line = 140)
