...
public class class450 extends class706 {
    ...
    @OriginalMember(owner = "client!w", name = "b", descriptor = "(B)[Ljf;", line = 5)
    ...
    @OriginalMember(owner = "client!w", name = "d", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(II)I", line = 52)
    public static int method2703(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "(BIIIIII)V", line = 59)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(BIIII)V", line = 494)
    ...
    @OriginalMember(owner = "client!w", name = "e", descriptor = "(B)V", line = 515)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(IBLvea;I)J", line = 529)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(IBI)Z", line = 560)
    ...
    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "(Lpga;II)V", line = 570)
    public class450(class492 arg0, int arg1, int arg2) {
        this.field6187 = new byte[arg1 * arg2];
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "(III)Z", line = 582)
