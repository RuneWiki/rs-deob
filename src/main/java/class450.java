...
public class class450 {
    ...
    @OriginalMember(owner = "client!qt", name = "<init>", descriptor = "([I)V", line = 35)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lpp;IIIII)V", line = 74)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(I)V", line = 143)
