...
public class class450 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lgga;I)V", line = 40)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(III)Ldja;", line = 95)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Z)V", line = 105)
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(Lae;)V", line = 117)
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "()V", line = 129)
    protected class450() {
