...
public class class450 extends class422 implements class498 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IIIBI[III)V", line = 3)
    ...
    @OriginalMember(owner = "client!li", name = "d", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Lko;Lvea;IIZ[BII)V", line = 27)
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Lko;IIZ[III)V", line = 48)
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Lko;Lvea;IIZ[FII)V", line = 69)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IILvea;IIII[BI)V", line = 89)
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Lko;Lvea;Lbja;II)V", line = 106)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(I)I", line = 118)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Lvea;I[FIIIIII)V", line = 130)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ZZB)V", line = 147)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(B)I", line = 163)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(FI)F", line = 180)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IIBI[III)V", line = 191)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(FI)F", line = 214)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Z)Z", line = 229)
