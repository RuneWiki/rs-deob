...
public class class450 {
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lha;[II[I[I)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lha;[IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lha;[II)V")
