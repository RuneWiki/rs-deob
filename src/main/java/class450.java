...
public class class450 extends class261 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Ljs;)Lug;", line = 3)
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(I[BII)V", line = 24)
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(I[BIIZ)V", line = 30)
