...
public class class450 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 28)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IILuq;I)Lc;", line = 125)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IFFF)I", line = 175)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(II)Z", line = 220)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(BIIIIII)V", line = 246)
