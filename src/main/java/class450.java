...
public class class450 extends class431 implements class529 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Lya;I)V")
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IILya;I)Z")
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IILfi;BZLya;I)V")
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IILya;ILuu;ILma;II)V")
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "(IIIIIIIIIILpe;)V")
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(ZLya;)V")
    ...
    @OriginalMember(owner = "client!av", name = "c", descriptor = "(Lya;I)Lfk;")
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Lya;II)Lt;")
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(Lya;I)V")
