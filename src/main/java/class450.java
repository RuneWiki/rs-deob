...
public class class450 extends class465 implements class662 {
    ...
    @OriginalMember(owner = "client!lda", name = "c", descriptor = "(I)V", line = 3)
    public static void method2839(int arg0) {
        field6772 = null;
        int var1 = 35 / ((-20 - arg0) / 52);
    }

    @OriginalMember(owner = "client!lda", name = "<init>", descriptor = "(Ler;I[BI)V", line = 15)
    public class450(class92 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field6775 = arg1;
    }

    @OriginalMember(owner = "client!lda", name = "b", descriptor = "(I)I", line = 24)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(I)J", line = 36)
    public final long method693(int arg0) {
        ++field6773;
        return arg0 != -32459 ? -85L : super.field6933.getAddress();
    }

    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(II[BI)V", line = 47)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(B)I", line = 61)
