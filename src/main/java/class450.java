...
public class class450 extends class192 {
    ...
    @OriginalMember(owner = "client!qp", name = "f", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!qp", name = "g", descriptor = "(I)Lh;", line = 172)
    ...
    @OriginalMember(owner = "client!qp", name = "h", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!qp", name = "i", descriptor = "(I)V", line = 205)
