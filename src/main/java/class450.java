...
public class class450 {
    ...
    @OriginalMember(owner = "client!cba", name = "<init>", descriptor = "()V", line = 6)
    public class450() {
    }

    @OriginalMember(owner = "client!cba", name = "<init>", descriptor = "(Lcba;)V", line = 8)
    public class450(class450 arg0) {
        this.field6150 = arg0.field6150;
        this.field6149 = arg0.field6149;
