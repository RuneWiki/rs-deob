...
public class class450 {
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(Z)Z", line = 14)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(II)V", line = 25)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(Liaa;I)V", line = 49)
    ...
    @OriginalMember(owner = "client!ew", name = "b", descriptor = "(II)V", line = 72)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(BILiaa;)V", line = 90)
