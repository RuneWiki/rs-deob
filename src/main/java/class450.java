...
public class class450 extends class19 {
    ...
    @OriginalMember(owner = "client!qd", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!qd", name = "c", descriptor = "(II)V", line = 18)
    ...
    @OriginalMember(owner = "client!qd", name = "d", descriptor = "(I)I", line = 32)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(B)I", line = 46)
    ...
    @OriginalMember(owner = "client!qd", name = "b", descriptor = "(B)J", line = 62)
    ...
    @OriginalMember(owner = "client!qd", name = "f", descriptor = "(I)I", line = 73)
