...
public class class450 extends class396 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(II)Lgn;", line = 3)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lls;Lra;BLra;)V", line = 16)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(BI)Z", line = 36)
    ...
    @OriginalMember(owner = "client!f", name = "d", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!f", name = "b", descriptor = "(BI)I", line = 78)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lbk;IZ)V", line = 102)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ILbk;)V", line = 155)
    ...
    @OriginalMember(owner = "client!f", name = "c", descriptor = "(BI)Ljava/lang/String;", line = 176)
    ...
    @OriginalMember(owner = "client!f", name = "b", descriptor = "(Z)V", line = 196)
    ...
    @OriginalMember(owner = "client!f", name = "e", descriptor = "(I)V", line = 221)
    ...
    @OriginalMember(owner = "client!f", name = "f", descriptor = "(I)V", line = 245)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 270)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Ljava/lang/String;IZ)V", line = 308)
