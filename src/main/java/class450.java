...
public class class450 {
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(BLfh;)V", line = 4)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(IILfh;)V", line = 38)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(Z)Z", line = 69)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(IIILem;Lem;)V", line = 84)
