...
public class class450 extends class337 {
    ...
    @OriginalMember(owner = "client!jk", name = "i", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Ltr;I)V", line = 18)
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "()V", line = 640)
    public class450() {
        super(1, true);
    }

    @OriginalMember(owner = "client!jk", name = "j", descriptor = "(I)V", line = 643)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(BILhp;)V", line = 702)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IB)[I", line = 740)
