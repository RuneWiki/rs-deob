...
public class class538 extends class81 {
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IBI)Z", line = 12)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Z)V", line = 25)
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "([Leda;)V", line = 59)
