...
public class class538 extends OutputStream {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Lii;IIIIIIIIIII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!dk", name = "write", descriptor = "(I)V", line = 436)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Lmj;Z)V", line = 444)
