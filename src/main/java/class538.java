...
public class class538 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "([BZ)[B", line = 3)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(II)I", line = 74)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IB)I", line = 91)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "(II)V", line = 119)
