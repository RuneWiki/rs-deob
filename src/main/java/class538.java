...
public class class538 {
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(ILjava/lang/String;)J", line = 145)
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(J[BB)V", line = 189)
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(I[BZ)V", line = 275)
    ...
    @OriginalMember(owner = "client!gja", name = "b", descriptor = "(I)Z", line = 349)
    ...
    @OriginalMember(owner = "client!gja", name = "c", descriptor = "(I)V", line = 363)
