...
public class class538 implements class285 {
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(ILic;)I")
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(I)Lvaa;")
    ...
    @OriginalMember(owner = "client!uca", name = "<init>", descriptor = "(Ljava/lang/String;Llk;Lvea;IIIIIIIIII)V")
