...
public class class538 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Ljava/lang/String;ZIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IIBJIILua;ILwp;)V", line = 19)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(I[B)V", line = 78)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(B)V", line = 289)
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "([BI[B)V", line = 302)
