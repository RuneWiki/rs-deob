...
public class class538 extends class217 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIB)V", line = 5)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIZ)V", line = 39)
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(IIIIII)V", line = 50)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(III)V", line = 69)
