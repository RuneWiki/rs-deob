...
public abstract class class538 {
    ...
    @OriginalMember(owner = "client!gu", name = "finalize", descriptor = "()V", line = 24)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(I[BI)V", line = 33)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IIB)Z", line = 57)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(Llj;I[BIZ)V", line = 111)
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(Llj;ILjaclib/memory/Buffer;IZ)V", line = 133)
