...
public class class538 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IILha;IIIBI)V", line = 5)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ZI)V", line = 18)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IIB)V", line = 36)
