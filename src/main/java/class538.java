...
public class class538 {
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(II)Lri;", line = 7)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(ILln;)V", line = 37)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(I)V", line = 52)
