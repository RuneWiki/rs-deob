...
public class class538 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IIBLka;I)Ldg;", line = 22)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(ILjava/lang/String;B)V", line = 40)
    ...
    @OriginalMember(owner = "client!dk", name = "b", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Z)V", line = 100)
    ...
    @OriginalMember(owner = "client!dk", name = "c", descriptor = "(I)Z", line = 116)
    ...
    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "(Z)V", line = 138)
