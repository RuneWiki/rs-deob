...
public class class538 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(ILwn;B)V", line = 17)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IIIB)I", line = 63)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Lwn;Z)V", line = 262)
