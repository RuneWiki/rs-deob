...
public class class538 implements Runnable {
    ...
    @OriginalMember(owner = "client!ht", name = "b", descriptor = "()V", line = 9)
    ...
    @OriginalMember(owner = "client!ht", name = "c", descriptor = "()Z", line = 15)
    public final boolean method3055() {
        return this.field7528 == null || !this.field7531 && this.field7528.method3211(109);
    }

    @OriginalMember(owner = "client!ht", name = "d", descriptor = "()J", line = 19)
    public final long method3056() {
        return this.field7530;
    }

    @OriginalMember(owner = "client!ht", name = "e", descriptor = "()V", line = 22)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(Liq;)V", line = 34)
    ...
    @OriginalMember(owner = "client!ht", name = "run", descriptor = "()V", line = 43)
    ...
    @OriginalMember(owner = "client!ht", name = "f", descriptor = "()V", line = 52)
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "(ILr;)V", line = 168)
