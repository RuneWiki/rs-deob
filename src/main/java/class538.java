...
public class class538 extends class339 {
    ...
    @OriginalMember(owner = "client!wi", name = "finalize", descriptor = "()V", line = 17)
    ...
    @OriginalMember(owner = "client!wi", name = "d", descriptor = "(I)J", line = 29)
    ...
    @OriginalMember(owner = "client!wi", name = "e", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!wi", name = "f", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IIII)I", line = 74)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Ljo;I)V", line = 97)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IILga;I)Laga;", line = 120)
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(B)V", line = 136)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(II)Lmo;", line = 157)
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(Lag;II)V", line = 182)
