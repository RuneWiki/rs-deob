...
public class class538 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(BI)Z", line = 6)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(I)J", line = 28)
