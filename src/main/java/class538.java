...
public class class538 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Lil;II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IIZIIZ)V", line = 19)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(BI)Z", line = 85)
    ...
    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "(Ldia;)V", line = 117)
