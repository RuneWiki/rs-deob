...
public class class538 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Ldw;B)V", line = 6)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IIIILlj;)V", line = 27)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ZILdw;)V", line = 61)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ILdw;ILik;)V", line = 416)
    ...
    @OriginalMember(owner = "client!ci", name = "b", descriptor = "(Ldw;B)V", line = 586)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IILdw;)V", line = 608)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(I)V", line = 628)
    ...
    @OriginalMember(owner = "client!ci", name = "c", descriptor = "(Ldw;B)V", line = 640)
