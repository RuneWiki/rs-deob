...
public class class538 {
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(ILqa;)V", line = 10)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(ID)V", line = 61)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(IIIIIIB)V", line = 88)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(Z)V", line = 129)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(II)I", line = 154)
    public static final int method3162(int arg0, int arg1) {
        field7958++;
        return arg0 == -11412 ? arg1 >>> 8 : 28;
    }

    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(ZIZZI)I", line = 177)
