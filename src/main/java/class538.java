...
public class class538 {
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!iia", name = "b", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(Ljava/lang/String;ZII)Z", line = 81)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(II)V", line = 153)
    ...
    @OriginalMember(owner = "client!iia", name = "b", descriptor = "(II)Ljha;", line = 174)
    ...
    @OriginalMember(owner = "client!iia", name = "<init>", descriptor = "(Lmca;ILgga;Lgga;)V", line = 240)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(ZI)V", line = 214)
