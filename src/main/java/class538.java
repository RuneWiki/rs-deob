...
public class class538 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Z)Z", line = 3)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ILeh;I)V", line = 34)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(BLeh;)V", line = 71)
