...
public class class538 extends class494 {
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(FB)V", line = 4)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(Lha;IBIII[[[BIIIIII)V", line = 21)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(II[BZ)[B", line = 55)
    ...
    @OriginalMember(owner = "client!nga", name = "<init>", descriptor = "(I)V", line = 71)
    public class538(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(FZ)V", line = 79)
    ...
    @OriginalMember(owner = "client!nga", name = "i", descriptor = "(Z)J", line = 95)
