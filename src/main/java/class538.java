...
public abstract class class538 extends class50 {
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(B[[BLcea;)V", line = 4)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 46)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(IIB[Ltg;)I", line = 72)
    ...
    @OriginalMember(owner = "client!caa", name = "g", descriptor = "(I)V", line = 117)
