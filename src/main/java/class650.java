...
public class class650 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IIII)I", line = 6)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 22)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(III)I", line = 64)
