...
public class class650 implements class285 {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(IIB)V", line = 34)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(III)V", line = 62)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(BI)I", line = 96)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(B)V", line = 118)
    ...
    @OriginalMember(owner = "client!ih", name = "b", descriptor = "(III)V", line = 146)
    ...
    @OriginalMember(owner = "client!ih", name = "c", descriptor = "(III)V", line = 171)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(BZ)I", line = 200)
    ...
    @OriginalMember(owner = "client!ih", name = "b", descriptor = "(BI)I", line = 239)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/String;C)Ljava/lang/String;", line = 250)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(I[IZLrr;I[I)Lue;", line = 306)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(IIIZI)V", line = 367)
