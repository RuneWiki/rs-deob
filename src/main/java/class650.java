...
public class class650 {
    ...
    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "(ILeq;Leq;Loha;)V", line = 82)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(JI[ILqca;)Ljava/lang/String;", line = 15)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(II)Lom;", line = 38)
