...
public class class650 extends class3 {
    ...
    @OriginalMember(owner = "client!sga", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Lua;)V", line = 64)
    public final synchronized void method3760(class3 arg0) {
        this.field9195.method3124(arg0, (byte) 48);
    }

    @OriginalMember(owner = "client!sga", name = "b", descriptor = "(Lua;)V", line = 67)
    public final synchronized void method3761(class3 arg0) {
        arg0.method3065(-17363);
    }

    @OriginalMember(owner = "client!sga", name = "b", descriptor = "()I", line = 70)
    public final int method5() {
        return 0;
    }

    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Laba;)V", line = 75)
    ...
    @OriginalMember(owner = "client!sga", name = "e", descriptor = "()V", line = 92)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "()Lua;", line = 109)
    public final class3 method4() {
        return (class3) this.field9195.method3111(127);
    }

    @OriginalMember(owner = "client!sga", name = "f", descriptor = "()I", line = 115)
    public final synchronized int method3764() {
        return this.field9195.method3113((byte) -70);
    }

    @OriginalMember(owner = "client!sga", name = "d", descriptor = "()Lua;", line = 120)
    public final class3 method8() {
        return (class3) this.field9195.method3118((byte) 73);
    }

    @OriginalMember(owner = "client!sga", name = "b", descriptor = "([III)V", line = 129)
    ...
    @OriginalMember(owner = "client!sga", name = "c", descriptor = "([III)V", line = 176)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Ltq;Laba;)V", line = 185)
