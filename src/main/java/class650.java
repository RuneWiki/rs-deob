...
public class class650 {
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ILhq;)V", line = 37)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IIIII)V", line = 102)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ZBLjava/lang/Object;)[B", line = 127)
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Z)V", line = 172)
