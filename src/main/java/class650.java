...
public class class650 extends class31 {
    ...
    @OriginalMember(owner = "client!ih", name = "<init>", descriptor = "(Lut;Lgi;IIIIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(B)Lrw;", line = 15)
    public final class703 method351(byte arg0) {
        field9110++;
        return arg0 < 73 ? null : class188.field2710;
    }

    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(ILjava/lang/String;Ljava/io/File;)V", line = 27)
