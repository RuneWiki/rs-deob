...
public class class650 extends class69 {
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(IIB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(IIIIII)V", line = 90)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(III)Z", line = 113)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(IIII)Z", line = 130)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "([IIIZ)V", line = 148)
    ...
    @OriginalMember(owner = "client!paa", name = "b", descriptor = "(I)V", line = 173)
    ...
    @OriginalMember(owner = "client!paa", name = "<init>", descriptor = "(IIIIIIIII)V", line = 186)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "([IIBI)V", line = 207)
