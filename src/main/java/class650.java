...
public class class650 extends class408 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IZI)Lc;")
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "(Ldf;)V")
    public class650(class402 arg0) {
        this.field9154 = arg0;
    }

    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lha;I)V")
