...
public class class650 extends class314 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IIBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(II)Z", line = 14)
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(IIII)[B", line = 36)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Ljava/lang/String;ZI)V", line = 52)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IIB)V", line = 120)
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "()V", line = 137)
    public class650() {
