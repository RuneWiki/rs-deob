...
public class class650 extends class329 {
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(ILrj;ILes;)V", line = 14)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(IB)V", line = 130)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(BII)Z", line = 143)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(I)V", line = 163)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(III)V", line = 189)
