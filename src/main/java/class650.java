...
public class class650 {
    ...
    @OriginalMember(owner = "client!nq", name = "toString", descriptor = "()Ljava/lang/String;", line = 9)
    public final String toString() {
        field8975++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 26)
    public class650(String arg0, int arg1) {
        this.field8978 = arg0;
        this.field8976 = arg1;
    }

    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(III)I", line = 35)
