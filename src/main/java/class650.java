...
public class class650 {
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(IBZI)V", line = 46)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(ZILeca;)V", line = 107)
