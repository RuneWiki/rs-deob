...
public class class650 extends class212 {
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(ILdh;)V", line = 24)
    public class650(int arg0, class322 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Z)V", line = 28)
    ...
    @OriginalMember(owner = "client!bl", name = "d", descriptor = "(I)Z", line = 49)
    ...
    @OriginalMember(owner = "client!bl", name = "e", descriptor = "(I)I", line = 64)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(II)I", line = 77)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IIILin;)Loea;", line = 92)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(II)V", line = 113)
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(Ldh;)V", line = 123)
