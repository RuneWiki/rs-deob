...
public class class650 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(IILha;)Z", line = 4)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(BZ)V", line = 79)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(IIIIIIIIILha;)V", line = 131)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(I)V", line = 208)
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "(I[Lid;IIII)V", line = 271)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(BLjava/lang/String;)V", line = 260)
