...
public class class650 extends class627 {
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(ZB)V", line = 8)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!ida", name = "b", descriptor = "(I)V", line = 101)
