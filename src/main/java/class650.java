...
public class class650 {
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(ILaja;)V", line = 76)
    ...
    @OriginalMember(owner = "client!aja", name = "b", descriptor = "(I)Laja;", line = 93)
    ...
    @OriginalMember(owner = "client!aja", name = "<init>", descriptor = "(I)V", line = 132)
    public class650(int arg0) {
        this.field9239 = arg0;
    }

    @OriginalMember(owner = "client!aja", name = "<init>", descriptor = "(IIIIII)V", line = 139)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(III)Z", line = 117)
