...
public class class650 extends class155 implements class447 {
    ...
    @OriginalMember(owner = "client!ika", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!ika", name = "<init>", descriptor = "(Lck;ILjaclib/memory/Buffer;IZ)V", line = 16)
    public class650(class733 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field8281 = arg1;
    }

    @OriginalMember(owner = "client!ika", name = "b", descriptor = "(B)I", line = 28)
    ...
    @OriginalMember(owner = "client!ika", name = "b", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!ika", name = "a", descriptor = "(B)J", line = 49)
    ...
    @OriginalMember(owner = "client!ika", name = "<init>", descriptor = "(Lck;I[BIZ)V", line = 60)
    public class650(class733 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field8281 = arg1;
    }

    @OriginalMember(owner = "client!ika", name = "a", descriptor = "(III)Z", line = 73)
    ...
    @OriginalMember(owner = "client!ika", name = "d", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!ika", name = "c", descriptor = "(I)I", line = 95)
    ...
    @OriginalMember(owner = "client!ika", name = "a", descriptor = "(IIIZ)I", line = 107)
    ...
    @OriginalMember(owner = "client!ika", name = "a", descriptor = "([BIII)V", line = 131)
