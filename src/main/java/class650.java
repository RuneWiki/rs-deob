...
public abstract class class650 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(ZII)B", line = 24)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIII)V", line = 81)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(III)Z", line = 104)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lxa;B)V", line = 118)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Le;ILpfa;ILjava/awt/Canvas;I)Loa;", line = 130)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(BIIIII)V", line = 172)
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(B)V", line = 183)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIZI)V", line = 221)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIZI)V", line = 232)
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Le;)V", line = 268)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(IIIII)V", line = 341)
    ...
    @OriginalMember(owner = "client!oa", name = "finalize", descriptor = "()V", line = 352)
    protected void finalize() {
        field8786++;
        this.method3623((byte) -60);
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(III)I", line = 365)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIB)V", line = 386)
