...
public class class650 implements class175 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IB)Lnt;", line = 40)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(ZZ)V", line = 386)
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(IB)V", line = 411)
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(Lgda;Lgda;Ljaa;)V", line = 433)
