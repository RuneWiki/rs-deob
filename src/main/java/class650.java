...
public class class650 extends class89 {
    ...
    @OriginalMember(owner = "client!lha", name = "e", descriptor = "(I)Ljava/lang/Object;", line = 7)
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(I)Z", line = 20)
    ...
    @OriginalMember(owner = "client!lha", name = "<init>", descriptor = "(Ldr;Ljava/lang/Object;I)V", line = 32)
    public class650(class750 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field9078 = arg1;
    }

    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(IIIIIII)V", line = 40)
    ...
    @OriginalMember(owner = "client!lha", name = "g", descriptor = "(I)V", line = 168)
