...
public class class52 extends class179 {
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Lec;B)V")
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Lec;II)V")
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(ZLdp;)I")
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Lvj;ILec;B)V")
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(ILmb;)Z")
