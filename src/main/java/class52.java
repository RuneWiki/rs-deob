...
public class class52 {
    ...
    @OriginalMember(owner = "client!SXDNVMNH", name = "b", descriptor = "[LSXDNVMNH;")
    public static class52[] field1444;

    @OriginalMember(owner = "client!SXDNVMNH", name = "a", descriptor = "(LGWOEELWB;B)V")
    ...
    @OriginalMember(owner = "client!SXDNVMNH", name = "a", descriptor = "(LMLYYHULT;B)V")
