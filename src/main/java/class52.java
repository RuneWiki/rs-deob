...
public class class52 extends class370 implements class232 {
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "(Lqa;Lbo;IIIIIZIIIIIII)V")
    ...
    @OriginalMember(owner = "client!u", name = "b", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IILqa;IZLha;I)V")
    ...
    @OriginalMember(owner = "client!u", name = "c", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ILqa;)Lbw;")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IIILqa;)Z")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IILqa;)Lc;")
