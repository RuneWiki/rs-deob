...
public class class52 {
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(IIIII)I", line = 4)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(B)V", line = 21)
    public static void method460(byte arg0) {
        int var1 = 41 / ((-arg0 - 52) / 41);
        field716 = null;
    }

    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Z)Z", line = 31)
