...
public class class52 {
    ...
    @OriginalMember(owner = "client!UHDZKWZT", name = "a", descriptor = "LGJHPCNMU;")
    ...
    @OriginalMember(owner = "client!UHDZKWZT", name = "a", descriptor = "(LGJHPCNMU;)V")
    ...
    @OriginalMember(owner = "client!UHDZKWZT", name = "b", descriptor = "(LGJHPCNMU;)V")
    ...
    @OriginalMember(owner = "client!UHDZKWZT", name = "c", descriptor = "(LGJHPCNMU;)B")
    private static byte method502(class15 arg0) {
        return (byte) method504(8, arg0);
    }

    @OriginalMember(owner = "client!UHDZKWZT", name = "d", descriptor = "(LGJHPCNMU;)B")
    private static byte method503(class15 arg0) {
        return (byte) method504(1, arg0);
    }

    @OriginalMember(owner = "client!UHDZKWZT", name = "a", descriptor = "(ILGJHPCNMU;)I")
    ...
    @OriginalMember(owner = "client!UHDZKWZT", name = "e", descriptor = "(LGJHPCNMU;)V")
