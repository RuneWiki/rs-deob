...
public class class52 extends class278 {
    ...
    @OriginalMember(owner = "client!u", name = "c", descriptor = "(III)V", line = 6)
    ...
    @OriginalMember(owner = "client!u", name = "g", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!u", name = "d", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!u", name = "c", descriptor = "(II)V", line = 134)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Llh;II)V", line = 386)
    ...
    @OriginalMember(owner = "client!u", name = "h", descriptor = "(I)V", line = 424)
    ...
    @OriginalMember(owner = "client!u", name = "d", descriptor = "(III)Z", line = 436)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(II)[[I", line = 448)
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "()V", line = 510)
    public class52() {
        super(1, false);
    }
}
