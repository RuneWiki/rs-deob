...
public class class52 {
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(Ltf;II)Lcaa;")
    ...
    @OriginalMember(owner = "client!caa", name = "c", descriptor = "()Lug;")
    ...
    @OriginalMember(owner = "client!caa", name = "<init>", descriptor = "(Lnp;)V")
