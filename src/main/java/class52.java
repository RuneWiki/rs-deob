...
public class class52 implements Runnable {
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(II)Lgo;")
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Ljava/lang/String;B)Lkk;")
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Lea;I)V")
