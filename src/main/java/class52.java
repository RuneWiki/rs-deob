...
public class class52 implements class512 {
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(Z)V", line = 130)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!pv", name = "b", descriptor = "(B)[Lrd;", line = 163)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(Lya;I)V", line = 247)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(B)J", line = 273)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(ZLjava/lang/String;Z)V", line = 310)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(ILcp;)Z", line = 384)
