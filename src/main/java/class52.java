...
public class class52 {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IIIILji;I)Ljava/awt/Frame;", line = 16)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IZI)Z", line = 89)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IIII)Lu;", line = 130)
    ...
    @OriginalMember(owner = "client!u", name = "b", descriptor = "(I)Lkb;", line = 143)
    ...
    @OriginalMember(owner = "client!u", name = "b", descriptor = "(IIII)Lme;", line = 154)
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "(IIIIB)V", line = 223)
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "(Lu;I)V", line = 234)
