...
public class class52 {
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(II[I)Ldg;", line = 4)
    ...
    @OriginalMember(owner = "client!wo", name = "b", descriptor = "(II[I)Ldg;", line = 28)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(II[II)Ldg;", line = 49)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(II)Laj;", line = 111)
    ...
    @OriginalMember(owner = "client!wo", name = "b", descriptor = "(II)V", line = 138)
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(Lij;Lij;)V", line = 223)
    public class52(class316 arg0, class316 arg1) {
        this.field662 = arg1;
        this.field670 = arg0;
    }

    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(IBI)V", line = 164)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Z[III)Ldg;", line = 183)
