...
public class class52 extends class325 {
    ...
    @OriginalMember(owner = "client!ar", name = "c", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ILvt;)V")
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lrs;IIII)V")
