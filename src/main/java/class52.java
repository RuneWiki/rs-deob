...
public abstract class class52 extends class113 {
    ...
    @OriginalMember(owner = "client!vg", name = "<init>", descriptor = "()V", line = 1239)
    public class52() {
        super(0, 0, 0, 0, 0, 0, 0, 0, 0, false, (byte) 0);
    }

    @OriginalMember(owner = "client!vg", name = "b", descriptor = "(IZI)V", line = 18)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IIIZII)V", line = 46)
    ...
    @OriginalMember(owner = "client!vg", name = "d", descriptor = "(B)I", line = 178)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(B)Lis;", line = 192)
    ...
    @OriginalMember(owner = "client!vg", name = "f", descriptor = "(B)Z", line = 208)
    ...
    @OriginalMember(owner = "client!vg", name = "b", descriptor = "(B)V", line = 219)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(III)Z", line = 230)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Lkd;B[Lka;Lha;Z)V", line = 335)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IIILha;IIII)V", line = 533)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IIBI)V", line = 545)
    ...
    @OriginalMember(owner = "client!vg", name = "b", descriptor = "(II)V", line = 578)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(I)V", line = 590)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Lka;I)V", line = 609)
    ...
    @OriginalMember(owner = "client!vg", name = "c", descriptor = "(II)V", line = 647)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IIIIII)V", line = 678)
    ...
    @OriginalMember(owner = "client!vg", name = "i", descriptor = "(I)V", line = 794)
    ...
    @OriginalMember(owner = "client!vg", name = "j", descriptor = "(I)I", line = 864)
    ...
    @OriginalMember(owner = "client!vg", name = "k", descriptor = "(I)Z", line = 954)
    ...
    @OriginalMember(owner = "client!vg", name = "m", descriptor = "(I)I", line = 1081)
    ...
    @OriginalMember(owner = "client!vg", name = "n", descriptor = "(I)V", line = 1128)
    ...
    @OriginalMember(owner = "client!vg", name = "g", descriptor = "(B)Z", line = 1151)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Z)I", line = 1173)
    public int method482(boolean arg0) {
        ++field975;
        return arg0 ? 77 : this.field941;
    }

    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Z[I[I)V", line = 1187)
    ...
    @OriginalMember(owner = "client!vg", name = "finalize", descriptor = "()V", line = 1247)
    ...
    @OriginalMember(owner = "client!vg", name = "h", descriptor = "(I)I", line = 1258)
