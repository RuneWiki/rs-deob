...
public class class52 {
    ...
    @OriginalMember(owner = "client!SXXYSOJW", name = "c", descriptor = "[LSXXYSOJW;")
    public static class52[] field1350;

    @OriginalMember(owner = "client!SXXYSOJW", name = "a", descriptor = "(LBYZSQZUF;Z)V")
    ...
    @OriginalMember(owner = "client!SXXYSOJW", name = "a", descriptor = "(LIMUIZRAF;II)V")
