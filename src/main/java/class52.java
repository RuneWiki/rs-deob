...
public class class52 {
    ...
    @OriginalMember(owner = "client!RKSMLTCN", name = "b", descriptor = "LLMGYBGQR;")
    public class30 field1263 = new class30();

    @OriginalMember(owner = "client!RKSMLTCN", name = "c", descriptor = "LLMGYBGQR;")
    ...
    @OriginalMember(owner = "client!RKSMLTCN", name = "a", descriptor = "(LLMGYBGQR;)V")
    ...
    @OriginalMember(owner = "client!RKSMLTCN", name = "a", descriptor = "()LLMGYBGQR;")
    ...
    @OriginalMember(owner = "client!RKSMLTCN", name = "a", descriptor = "(B)LLMGYBGQR;")
