...
@OriginalClass("client!TUODRVGB")
public class class52 {

    @OriginalMember(owner = "client!TUODRVGB", name = "a", descriptor = "I")
    private int field1453 = 4;

    @OriginalMember(owner = "client!TUODRVGB", name = "b", descriptor = "B")
    private byte field1454 = -113;

    @OriginalMember(owner = "client!TUODRVGB", name = "c", descriptor = "B")
    private byte field1455 = -120;

    @OriginalMember(owner = "client!TUODRVGB", name = "d", descriptor = "B")
    private byte field1456 = -120;

    @OriginalMember(owner = "client!TUODRVGB", name = "e", descriptor = "I")
    private int field1457 = 986;

    @OriginalMember(owner = "client!TUODRVGB", name = "f", descriptor = "Z")
    private boolean field1458 = true;

    @OriginalMember(owner = "client!TUODRVGB", name = "g", descriptor = "[I")
    public int[] field1459 = new int[2];

    @OriginalMember(owner = "client!TUODRVGB", name = "h", descriptor = "[[[I")
    public int[][][] field1460 = new int[2][2][4];

    @OriginalMember(owner = "client!TUODRVGB", name = "i", descriptor = "[[[I")
    public int[][][] field1461 = new int[2][2][4];

    @OriginalMember(owner = "client!TUODRVGB", name = "j", descriptor = "[I")
    public int[] field1462 = new int[2];

    @OriginalMember(owner = "client!TUODRVGB", name = "k", descriptor = "[[F")
    public static float[][] field1463 = new float[2][8];

    @OriginalMember(owner = "client!TUODRVGB", name = "l", descriptor = "[[I")
    public static int[][] field1464 = new int[2][8];

    @OriginalMember(owner = "client!TUODRVGB", name = "m", descriptor = "F")
    public static float field1465;

    @OriginalMember(owner = "client!TUODRVGB", name = "n", descriptor = "I")
    public static int field1466;

    @OriginalMember(owner = "client!TUODRVGB", name = "a", descriptor = "(BIIF)F")
    ...
    @OriginalMember(owner = "client!TUODRVGB", name = "a", descriptor = "(FI)F")
    ...
    @OriginalMember(owner = "client!TUODRVGB", name = "a", descriptor = "(FBII)F")
    ...
    @OriginalMember(owner = "client!TUODRVGB", name = "a", descriptor = "(IIF)I")
    ...
    @OriginalMember(owner = "client!TUODRVGB", name = "a", descriptor = "(LXCOYGYOS;ILZOMNSJJM;)V")
    ...
    @OriginalMember(owner = "client!TUODRVGB", name = "<init>", descriptor = "()V")
    public class52() {
