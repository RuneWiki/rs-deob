...
public class class52 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ZI)V", line = 10)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ILofa;)V", line = 108)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lbfa;IILjl;BILcca;I)V", line = 130)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lofa;II)V", line = 230)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(I)V", line = 273)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IIIIIII)V", line = 294)
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(IIIIIII)Z", line = 322)
