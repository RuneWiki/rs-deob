...
public class class52 extends class306 {
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(CIIIZLta;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!pq", name = "B", descriptor = "(CIIIZ)V", line = 51)
    ...
    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "(Lpg;Lkt;[Lau;Z)V", line = 68)
