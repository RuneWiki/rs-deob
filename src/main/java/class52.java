...
public class class52 extends class62 {
    ...
    @OriginalMember(owner = "client!nr", name = "h", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!nr", name = "c", descriptor = "(II)[I", line = 30)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "()V", line = 69)
    public class52() {
        super(1, true);
    }

    @OriginalMember(owner = "client!nr", name = "i", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(IBI)Z", line = 88)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Lup;IIZ)J", line = 104)
