...
public class class52 extends class371 {
    ...
    @OriginalMember(owner = "client!fb", name = "g", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(BI)[I", line = 18)
    ...
    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "()V", line = 94)
    public class52() {
        super(1, true);
    }

    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IBLps;)V", line = 80)
