...
public class class52 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IIILpda;Lpda;)V")
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(BI)Lui;")
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(Ldh;ILkha;)V")
