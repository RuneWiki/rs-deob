...
public class class52 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ILat;BI)V", line = 19)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(B)Ltr;", line = 45)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Z)V", line = 71)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ILat;I)V", line = 108)
