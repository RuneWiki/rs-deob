...
public class class52 {
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(III)V", line = 9)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(IIII[FII)V", line = 79)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(B)V", line = 176)
