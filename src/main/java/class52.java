...
public class class52 extends class85 {
    ...
    @OriginalMember(owner = "client!fa", name = "db", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!fa", name = "eb", descriptor = "Llf;")
    private static class109 field1062 = class35.method275("flash3:", 2);

    @OriginalMember(owner = "client!fa", name = "S", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!fa", name = "ib", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!fa", name = "hb", descriptor = "Lbg;")
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(BILja;)V")
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(BI)Llf;")
