...
@OriginalClass("client!RVCZOCZG")
public class class52 extends class63 {

    @OriginalMember(owner = "client!RVCZOCZG", name = "q", descriptor = "I")
    private int field1397 = -533;

    @OriginalMember(owner = "client!RVCZOCZG", name = "C", descriptor = "Z")
    public boolean field1409 = false;

    @OriginalMember(owner = "client!RVCZOCZG", name = "K", descriptor = "I")
    private int field1417 = 6;

    @OriginalMember(owner = "client!RVCZOCZG", name = "y", descriptor = "LFULHVSIU;")
    private class21 field1405;

    @OriginalMember(owner = "client!RVCZOCZG", name = "x", descriptor = "I")
    public int field1404;

    @OriginalMember(owner = "client!RVCZOCZG", name = "r", descriptor = "I")
    public int field1398;

    @OriginalMember(owner = "client!RVCZOCZG", name = "s", descriptor = "I")
    public int field1399;

    @OriginalMember(owner = "client!RVCZOCZG", name = "t", descriptor = "I")
    public int field1400;

    @OriginalMember(owner = "client!RVCZOCZG", name = "o", descriptor = "I")
    public int field1395;

    @OriginalMember(owner = "client!RVCZOCZG", name = "p", descriptor = "I")
    public int field1396;

    @OriginalMember(owner = "client!RVCZOCZG", name = "l", descriptor = "I")
    public int field1392;

    @OriginalMember(owner = "client!RVCZOCZG", name = "m", descriptor = "I")
    public int field1393;

    @OriginalMember(owner = "client!RVCZOCZG", name = "n", descriptor = "I")
    public int field1394;

    @OriginalMember(owner = "client!RVCZOCZG", name = "u", descriptor = "I")
    public int field1401;

    @OriginalMember(owner = "client!RVCZOCZG", name = "z", descriptor = "D")
    private double field1406;

    @OriginalMember(owner = "client!RVCZOCZG", name = "D", descriptor = "D")
    public double field1410;

    @OriginalMember(owner = "client!RVCZOCZG", name = "E", descriptor = "D")
    public double field1411;

    @OriginalMember(owner = "client!RVCZOCZG", name = "F", descriptor = "D")
    public double field1412;

    @OriginalMember(owner = "client!RVCZOCZG", name = "G", descriptor = "D")
    private double field1413;

    @OriginalMember(owner = "client!RVCZOCZG", name = "H", descriptor = "D")
    private double field1414;

    @OriginalMember(owner = "client!RVCZOCZG", name = "I", descriptor = "D")
    private double field1415;

    @OriginalMember(owner = "client!RVCZOCZG", name = "J", descriptor = "D")
    private double field1416;

    @OriginalMember(owner = "client!RVCZOCZG", name = "v", descriptor = "I")
    private int field1402;

    @OriginalMember(owner = "client!RVCZOCZG", name = "w", descriptor = "I")
    private int field1403;

    @OriginalMember(owner = "client!RVCZOCZG", name = "A", descriptor = "I")
    public int field1407;

    @OriginalMember(owner = "client!RVCZOCZG", name = "B", descriptor = "I")
    public int field1408;

    @OriginalMember(owner = "client!RVCZOCZG", name = "a", descriptor = "(IIIII)V")
    ...
    @OriginalMember(owner = "client!RVCZOCZG", name = "<init>", descriptor = "(IIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!RVCZOCZG", name = "a", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!RVCZOCZG", name = "a", descriptor = "(I)LKPUOCBCE;")
