...
@OriginalClass("client!SYTONBKT")
public class class52 {

    @OriginalMember(owner = "client!SYTONBKT", name = "e", descriptor = "I")
    public int field1341 = -1;

    @OriginalMember(owner = "client!SYTONBKT", name = "f", descriptor = "Z")
    public boolean field1342 = false;

    @OriginalMember(owner = "client!SYTONBKT", name = "g", descriptor = "Z")
    public boolean field1343 = true;

    @OriginalMember(owner = "client!SYTONBKT", name = "a", descriptor = "I")
    public static int field1337;

    @OriginalMember(owner = "client!SYTONBKT", name = "d", descriptor = "I")
    public int field1340;

    @OriginalMember(owner = "client!SYTONBKT", name = "h", descriptor = "I")
    public int field1344;

    @OriginalMember(owner = "client!SYTONBKT", name = "i", descriptor = "I")
    public int field1345;

    @OriginalMember(owner = "client!SYTONBKT", name = "j", descriptor = "I")
    public int field1346;

    @OriginalMember(owner = "client!SYTONBKT", name = "k", descriptor = "I")
    public int field1347;

    @OriginalMember(owner = "client!SYTONBKT", name = "l", descriptor = "I")
    public int field1348;

    @OriginalMember(owner = "client!SYTONBKT", name = "m", descriptor = "I")
    public int field1349;

    @OriginalMember(owner = "client!SYTONBKT", name = "c", descriptor = "Ljava/lang/String;")
    public String field1339;

    @OriginalMember(owner = "client!SYTONBKT", name = "b", descriptor = "[LSYTONBKT;")
    public static class52[] field1338;

    @OriginalMember(owner = "client!SYTONBKT", name = "a", descriptor = "(ILBBMKAXRK;)V")
    ...
    @OriginalMember(owner = "client!SYTONBKT", name = "a", descriptor = "(LEILHLJCE;B)V")
    ...
    @OriginalMember(owner = "client!SYTONBKT", name = "a", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!SYTONBKT", name = "a", descriptor = "(III)I")
