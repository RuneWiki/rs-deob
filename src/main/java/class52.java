...
public class class52 extends class108 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IILjava/awt/Canvas;Ln;)Lqa;", line = 4)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IILnd;[I[IB)Lfk;", line = 21)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Z)V", line = 81)
    ...
    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "()V", line = 95)
    public class52() {
    }

    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "(J)V", line = 101)
