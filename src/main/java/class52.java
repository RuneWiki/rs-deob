...
@OriginalClass("client!UHMILBUY")
public class class52 {

    @OriginalMember(owner = "client!UHMILBUY", name = "a", descriptor = "Z")
    private static boolean field1309;

    @OriginalMember(owner = "client!UHMILBUY", name = "b", descriptor = "Z")
    private static boolean field1310;

    @OriginalMember(owner = "client!UHMILBUY", name = "a", descriptor = "(IIII)I")
    ...
    @OriginalMember(owner = "client!UHMILBUY", name = "b", descriptor = "(IIII)I")
    ...
    @OriginalMember(owner = "client!UHMILBUY", name = "a", descriptor = "(IZIIII)I")
    ...
    @OriginalMember(owner = "client!UHMILBUY", name = "a", descriptor = "(IIIBII)I")
