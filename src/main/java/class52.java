...
public class class52 extends class535 implements class68 {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ILqa;I)Lka;")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ZLqa;)V")
    ...
    @OriginalMember(owner = "client!u", name = "b", descriptor = "(ZLqa;)V")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ILa;IIILqa;Z)V")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "(Lqa;Lcd;IIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ILqa;ZB)Lkj;")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ILqa;B)Lka;")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(BIILqa;)Z")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ILik;)I")
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ILqa;)Lou;")
