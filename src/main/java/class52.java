...
public class class52 {
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(ILtb;ZI)V")
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(ILcg;Lcg;)V")
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Lso;I)I")
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(IILih;Leq;Lqs;ILwd;I)V")
