...
@OriginalClass("client!SAYOFZIJ")
public class class52 {

    @OriginalMember(owner = "client!SAYOFZIJ", name = "a", descriptor = "LIQGLDNEJ;")
    private static class23 field1393 = new class23();

    @OriginalMember(owner = "client!SAYOFZIJ", name = "a", descriptor = "([BI[BII)I")
    ...
    @OriginalMember(owner = "client!SAYOFZIJ", name = "a", descriptor = "(LIQGLDNEJ;)V")
    ...
    @OriginalMember(owner = "client!SAYOFZIJ", name = "b", descriptor = "(LIQGLDNEJ;)V")
    ...
    @OriginalMember(owner = "client!SAYOFZIJ", name = "c", descriptor = "(LIQGLDNEJ;)B")
    private static byte method521(class23 arg0) {
        return (byte) method523(8, arg0);
    }

    @OriginalMember(owner = "client!SAYOFZIJ", name = "d", descriptor = "(LIQGLDNEJ;)B")
    private static byte method522(class23 arg0) {
        return (byte) method523(1, arg0);
    }

    @OriginalMember(owner = "client!SAYOFZIJ", name = "a", descriptor = "(ILIQGLDNEJ;)I")
    ...
    @OriginalMember(owner = "client!SAYOFZIJ", name = "e", descriptor = "(LIQGLDNEJ;)V")
    ...
    @OriginalMember(owner = "client!SAYOFZIJ", name = "a", descriptor = "([I[I[I[BIII)V")
