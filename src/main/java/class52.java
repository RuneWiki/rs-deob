...
public class class52 extends class67 {
    ...
    @OriginalMember(owner = "client!TTWFVYGB", name = "<init>", descriptor = "(LQDHHNYHL;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!TTWFVYGB", name = "a", descriptor = "(IIILKWBPZBYX;)V")
