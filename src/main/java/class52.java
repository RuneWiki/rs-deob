...
public class class52 {
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(BJ)Ljava/lang/Object;", line = 19)
    ...
    @OriginalMember(owner = "client!al", name = "b", descriptor = "(B)Ljava/lang/Object;", line = 64)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(ZJ)V", line = 103)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 124)
    ...
    @OriginalMember(owner = "client!al", name = "c", descriptor = "(B)V", line = 155)
    ...
    @OriginalMember(owner = "client!al", name = "b", descriptor = "(I)V", line = 189)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(IB)V", line = 214)
    ...
    @OriginalMember(owner = "client!al", name = "c", descriptor = "(I)I", line = 263)
    ...
    @OriginalMember(owner = "client!al", name = "d", descriptor = "(B)I", line = 277)
    ...
    @OriginalMember(owner = "client!al", name = "d", descriptor = "(I)I", line = 288)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(IJLjava/lang/Object;)V", line = 310)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(I)V", line = 343)
