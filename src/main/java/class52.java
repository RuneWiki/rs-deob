...
public class class52 extends class504 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(B)I", line = 14)
    ...
    @OriginalMember(owner = "client!mk", name = "c", descriptor = "(B)[Llt;", line = 31)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(I)Z", line = 42)
    ...
    @OriginalMember(owner = "client!mk", name = "c", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!mk", name = "d", descriptor = "(B)I", line = 74)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Z)Z", line = 89)
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(II)V", line = 102)
