...
public class class52 extends class502 {
    ...
    @OriginalMember(owner = "client!wba", name = "b", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(ZLnc;ZB)V", line = 22)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(II)V", line = 95)
