...
public abstract class class52 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(FFIIIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(FFIILpa;II)V", line = 14)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(FFFFIILpa;II)V", line = 17)
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(IIII)V", line = 49)
    public final void method293(int arg0, int arg1, int arg2, int arg3) {
        this.method296(arg0, arg1, arg2, arg3, 1, 0, 1);
    }

    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(FFFFIIIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(FFII)V", line = 76)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(II)V", line = 84)
