...
public class class52 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "([BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Lse;[BI)V", line = 16)
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Lse;Ljava/nio/ByteBuffer;)V", line = 27)
