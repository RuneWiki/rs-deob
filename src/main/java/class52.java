...
public class class52 {
    ...
    @OriginalMember(owner = "client!UMMMVDGS", name = "a", descriptor = "Z")
    ...
    @OriginalMember(owner = "client!UMMMVDGS", name = "c", descriptor = "[LUMMMVDGS;")
    public static class52[] field1463;

    @OriginalMember(owner = "client!UMMMVDGS", name = "a", descriptor = "(ILINOFEYKQ;)V")
    ...
    @OriginalMember(owner = "client!UMMMVDGS", name = "a", descriptor = "(ZLNHEPCMLW;)V")
