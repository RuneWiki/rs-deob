...
public class class52 extends class151 {
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "()V", line = 3)
    public class52() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!al", name = "a", descriptor = "(III)[B", line = 7)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(IB)V", line = 13)
