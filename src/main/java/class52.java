...
public class class52 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IB)Ltca;")
    ...
    @OriginalMember(owner = "client!gp", name = "b", descriptor = "(B)Ljp;")
    ...
    @OriginalMember(owner = "client!gp", name = "b", descriptor = "(I)[Lhv;")
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(Ldia;Ld;)V")
