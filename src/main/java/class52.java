...
public class class52 {
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(BI)Ld;")
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(Ldh;ZII)V")
    ...
    @OriginalMember(owner = "client!pv", name = "<init>", descriptor = "(Lle;ILoi;)V")
