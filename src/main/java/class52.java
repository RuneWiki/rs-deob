...
public class class52 extends class379 {
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(IIB)Z", line = 62)
