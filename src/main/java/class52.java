...
public class class52 {
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IILi;Ltf;ILjava/lang/String;Lba;IIILgg;I)V")
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IBZII)Lij;")
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Lbj;ZI)V")
