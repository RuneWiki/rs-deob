...
public class class52 extends class383 {
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(BC)Z", line = 4)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(I)Z", line = 49)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Lqn;Lgj;Lqn;ILqn;)Z", line = 72)
    ...
    @OriginalMember(owner = "client!oi", name = "e", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(III)Z", line = 106)
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "(Ldt;)V", line = 165)
