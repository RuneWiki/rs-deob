...
public class class52 extends class583 {
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(II)I", line = 41)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(I[IIB)Z", line = 52)
    ...
    @OriginalMember(owner = "client!vg", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 292)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(I[III)Z", line = 88)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IIBI[I)Z", line = 118)
    ...
    @OriginalMember(owner = "client!vg", name = "b", descriptor = "(III)Z", line = 159)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IIZ)Z", line = 182)
    ...
    @OriginalMember(owner = "client!vg", name = "c", descriptor = "(B)V", line = 203)
    ...
    @OriginalMember(owner = "client!vg", name = "b", descriptor = "(II)V", line = 214)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Lum;Z)V", line = 241)
