...
public class class52 implements Runnable {
    ...
    @OriginalMember(owner = "client!QHZQTTDB", name = "f", descriptor = "LXHFSQKPU;")
    ...
    @OriginalMember(owner = "client!QHZQTTDB", name = "<init>", descriptor = "(Ljava/net/Socket;LXHFSQKPU;B)V")
