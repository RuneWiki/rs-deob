...
public class class52 {
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(ILnr;)V", line = 13)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Lkb;I)Z", line = 95)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(ILai;)I", line = 127)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 172)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "([BI)V", line = 204)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(BZ)V", line = 374)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(I)V", line = 416)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(IIBII)V", line = 427)
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "([BI)V", line = 451)
