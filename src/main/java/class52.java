...
public class class52 extends class40 {
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "()V", line = 287)
    public class52() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(IILlf;)V", line = 13)
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(III)I", line = 96)
    ...
    @OriginalMember(owner = "client!ps", name = "g", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(IIZ)Z", line = 120)
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(IZI)Z", line = 140)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(BI)[I", line = 159)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(IBII)V", line = 209)
    ...
    @OriginalMember(owner = "client!ps", name = "h", descriptor = "(B)V", line = 246)
