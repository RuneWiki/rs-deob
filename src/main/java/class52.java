...
public class class52 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IC)Z", line = 5)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(III)V", line = 18)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(B)V", line = 32)
