...
public class class52 extends class349 {
    ...
    @OriginalMember(owner = "client!kaa", name = "b", descriptor = "(Z)Ljava/lang/Object;", line = 6)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Z)Z", line = 16)
    ...
    @OriginalMember(owner = "client!kaa", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 25)
