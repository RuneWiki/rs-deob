...
public class class52 {
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Lfh;B)V")
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ILpq;)Z")
    ...
    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "(Lfh;)V")
