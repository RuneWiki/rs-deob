...
public class class52 extends Callback {
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(ZLjava/awt/Component;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!kaa", name = "callback", descriptor = "(IIII)I", line = 47)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(III)V", line = 88)
