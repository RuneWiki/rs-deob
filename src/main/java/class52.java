...
public class class52 extends class276 {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Lia;I)Lpm;", line = 3)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IIBI)I", line = 40)
