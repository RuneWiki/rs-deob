...
public class class52 extends class627 {
    ...
    @OriginalMember(owner = "client!tja", name = "a", descriptor = "(BLig;Lig;)V")
    ...
    @OriginalMember(owner = "client!tja", name = "a", descriptor = "(Ljc;I)V")
    ...
    @OriginalMember(owner = "client!tja", name = "a", descriptor = "(Lkj;I)V")
