...
public class class52 extends class207 {
    ...
    @OriginalMember(owner = "client!kaa", name = "<init>", descriptor = "(Lrd;)V", line = 4)
    public class52(class355 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!kaa", name = "<init>", descriptor = "(ILrd;)V", line = 7)
    public class52(int arg0, class355 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(IBILjava/awt/Component;Lec;)Lbr;", line = 10)
    ...
    @OriginalMember(owner = "client!kaa", name = "b", descriptor = "(IB)I", line = 96)
    public final int method39(int arg0, byte arg1) {
        ++field629;
        return arg1 != 69 ? 24 : 1;
    }

    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(IB)V", line = 111)
    ...
    @OriginalMember(owner = "client!kaa", name = "c", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!kaa", name = "d", descriptor = "(I)I", line = 137)
    public final int method331(int arg0) {
        ++field628;
        return arg0 != 43 ? -86 : super.field2669;
    }

    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!kaa", name = "b", descriptor = "(I)I", line = 169)
