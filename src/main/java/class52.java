...
public class class52 extends class354 {
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(ILwo;)V", line = 3)
    ...
    @OriginalMember(owner = "client!dm", name = "c", descriptor = "(II)V", line = 22)
    ...
    @OriginalMember(owner = "client!dm", name = "c", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(II)I", line = 47)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(B)I", line = 58)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(B)I", line = 79)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IBLsl;)Ljava/lang/String;", line = 94)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IIIIIIIII)V", line = 122)
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(Lwo;)V", line = 164)
