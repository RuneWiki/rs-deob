...
public class class52 extends class473 implements class784 {
    ...
    @OriginalMember(owner = "client!oa", name = "WA", descriptor = "(S)Z", line = 5)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILaa;IIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 34)
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(Z)V", line = 48)
    public final void method239(boolean arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIZ)Lho;", line = 54)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Loo;)V", line = 58)
    public final void method194(class12 arg0) {
        this.field628 = arg0;
        this.method436(((class667) arg0).nativeid);
    }

    @OriginalMember(owner = "client!oa", name = "k", descriptor = "()Loo;", line = 62)
    public final class12 method159() {
        return new class667();
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[Lsca;)V", line = 66)
    ...
    @OriginalMember(owner = "client!oa", name = "p", descriptor = "()Z", line = 84)
    public final boolean method206() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "h", descriptor = "()Loo;", line = 87)
    public final class12 method153() {
        return this.field631;
    }

    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(II)V", line = 90)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(II)I", line = 102)
    public final int method198(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!oa", name = "u", descriptor = "()V", line = 106)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[[I[[IIII)Ls;", line = 136)
    ...
    @OriginalMember(owner = "client!oa", name = "f", descriptor = "(I)V", line = 146)
    public final void method185(int arg0) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "()V", line = 148)
    public final void method167() {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([I)V", line = 152)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIII)V", line = 156)
    public final void method189(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
    }

    @OriginalMember(owner = "client!oa", name = "g", descriptor = "()V", line = 159)
    ...
    @OriginalMember(owner = "client!oa", name = "OA", descriptor = "()Ljava/lang/Object;", line = 164)
    private final Object method442() {
        return new class125(this);
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "()Lrb;", line = 167)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIF)Lsca;", line = 174)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Z)V", line = 179)
    public final void method203(boolean arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "f", descriptor = "()V", line = 182)
    public final void method184() {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lok;)V", line = 184)
    public final void method173(class255 arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 187)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lhda;)V", line = 201)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "()Z", line = 208)
    public final boolean method222() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lmia;)V", line = 214)
    ...
    @OriginalMember(owner = "client!oa", name = "h", descriptor = "(I)V", line = 221)
    public final void method170(int arg0) {
        this.field634[arg0].method3896();
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Ljava/awt/Canvas;II)V", line = 226)
    ...
    @OriginalMember(owner = "client!oa", name = "r", descriptor = "()V", line = 233)
    public final void method210() {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/awt/Canvas;II)V", line = 237)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIII)Lok;", line = 260)
    ...
    @OriginalMember(owner = "client!oa", name = "w", descriptor = "()Z", line = 274)
    public final boolean method199() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "y", descriptor = "()Z", line = 279)
    public final boolean method200() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "z", descriptor = "()Z", line = 284)
    public final boolean method156() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "g", descriptor = "(I)V", line = 294)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lhw;[Lfm;Z)Lda;", line = 308)
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(I)V", line = 346)
    public final void method237(int arg0) {
        this.field634[arg0].method3877();
    }

    @OriginalMember(owner = "client!oa", name = "s", descriptor = "()Z", line = 351)
    public final boolean method201() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lhda;I)V", line = 355)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lhda;Z)V", line = 362)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIII)V", line = 398)
    public final void method197(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(S)Z", line = 407)
    ...
    @OriginalMember(owner = "client!oa", name = "v", descriptor = "()V", line = 426)
    public final void method227() {
        this.method155(this.field630.field705);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(FFF)V", line = 428)
    public final void method186(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!oa", name = "A", descriptor = "()I", line = 432)
    public final int method143() {
        return 4;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZ)Lho;", line = 435)
    public final class318 method183(int arg0, int arg1, boolean arg2) {
        return new class331(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II)Lcn;", line = 439)
    public final class621 method236(int arg0, int arg1) {
        return this.method183(arg0, arg1, false);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIIIIIII)V", line = 441)
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ld;II)V", line = 444)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lao;IIII)Lka;", line = 476)
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(IIIIII)V", line = 479)
    ...
    @OriginalMember(owner = "client!oa", name = "finalize", descriptor = "()V", line = 487)
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "()Z", line = 493)
    public final boolean method175() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "o", descriptor = "()V", line = 495)
    public final void method250() {
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(I)V", line = 498)
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(II)I", line = 518)
    ...
    @OriginalMember(owner = "client!oa", name = "i", descriptor = "(I)V", line = 524)
    ...
    @OriginalMember(owner = "client!oa", name = "j", descriptor = "()Z", line = 539)
    public final boolean method147() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "l", descriptor = "()Z", line = 542)
    public final boolean method223() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "B", descriptor = "()La;", line = 547)
    ...
    @OriginalMember(owner = "client!oa", name = "n", descriptor = "()Z", line = 560)
    public final boolean method161() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[I[I)Laa;", line = 563)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(I)Lza;", line = 571)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lcn;Lrca;)Lmia;", line = 579)
    public final class684 method247(class621 arg0, class36 arg1) {
        return new class355(this, (class331) arg0, (class569) arg1);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIII)V", line = 582)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lok;Lok;FLok;)Lok;", line = 585)
    public final class255 method209(class255 arg0, class255 arg1, float arg2, class255 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(IIIIII)V", line = 590)
    ...
    @OriginalMember(owner = "client!oa", name = "m", descriptor = "()V", line = 593)
    public final void method145() {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILaa;II)V", line = 599)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lfm;Z)Lho;", line = 605)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([IIIIIZ)Lho;", line = 610)
    ...
    @OriginalMember(owner = "client!oa", name = "t", descriptor = "()Loo;", line = 615)
    public final class12 method187() {
        return this.field628;
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(II)Lrca;", line = 621)
    public final class36 method246(int arg0, int arg1) {
        return new class569(arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "x", descriptor = "()Z", line = 635)
    public final boolean method193() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "q", descriptor = "()Z", line = 643)
