...
public class class599 {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(II)Log;", line = 21)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "(Lci;ILsea;)V", line = 122)
    public class599(class414 arg0, int arg1, class648 arg2) {
        this.field8371 = arg2;
        this.field8371.method3653(30, true);
    }

    @OriginalMember(owner = "client!it", name = "a", descriptor = "(B)V", line = 110)
