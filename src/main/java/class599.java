...
public class class599 {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(I[B)V", line = 40)
    ...
    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "([BI[B)V", line = 245)
