...
public abstract class class599 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(ILha;)V", line = 6)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(B)Ljava/net/Socket;", line = 27)
    public final Socket method3490(byte arg0) throws IOException {
        field8538++;
        return arg0 == 123 ? new Socket(this.field8543, this.field8544) : null;
    }

    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(B)I", line = 43)
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(I)V", line = 238)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Ljava/lang/String;ZZ)V", line = 252)
