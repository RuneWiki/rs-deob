...
public class class599 extends class56 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "()V", line = 39)
    public class599() {
        super(2, false);
    }

    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BI)[[I", line = 45)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lbn;I)I", line = 364)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BILes;)V", line = 408)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(II)[I", line = 443)
