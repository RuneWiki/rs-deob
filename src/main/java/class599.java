...
public class class599 extends class337 {
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(IIZIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(IILha;I)V", line = 16)
    ...
    @OriginalMember(owner = "client!bfa", name = "<init>", descriptor = "()V", line = 559)
    public class599() {
    }

    @OriginalMember(owner = "client!bfa", name = "<init>", descriptor = "(J)V", line = 563)
    public class599(long arg0) {
        this.field7616 = arg0;
    }

    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(I)V", line = 571)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Z)V", line = 601)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(II[S[Ljava/lang/String;I)V", line = 616)
