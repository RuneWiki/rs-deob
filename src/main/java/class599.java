...
public class class599 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(I)Llv;")
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(B)Llv;")
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IILmg;III)V")
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Lji;IB)V")
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(ZLji;)V")
