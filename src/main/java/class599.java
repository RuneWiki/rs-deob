...
public class class599 extends class543 {
    ...
    @OriginalMember(owner = "client!vc", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Z)J", line = 18)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IJ)I", line = 36)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(I)J", line = 75)
