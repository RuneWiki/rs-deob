...
public class class599 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ILjava/lang/String;[Lxa;ZI)I")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Ljava/lang/String;I[Lxa;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ILjava/lang/String;I[Lxa;)I")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "([Ljava/lang/String;Ljava/lang/String;[Lxa;[II)I")
    ...
    @OriginalMember(owner = "client!mj", name = "b", descriptor = "(Ljava/lang/String;I[Lxa;I)I")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(BLjava/lang/String;[Lxa;)I")
