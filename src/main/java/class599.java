...
public abstract class class599 extends class429 {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Llm;I)Z", line = 31)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 64)
    ...
    @OriginalMember(owner = "client!bw", name = "<init>", descriptor = "(IIII)V", line = 96)
    ...
    @OriginalMember(owner = "client!bw", name = "g", descriptor = "(I)V", line = 107)
