...
public class class599 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lrt;Z)I", line = 5)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lub;I)V", line = 43)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(III)Lqa;", line = 120)
