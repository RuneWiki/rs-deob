...
public class class599 implements class147 {
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(IZLjava/awt/Component;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(II)V", line = 43)
    ...
    @OriginalMember(owner = "client!nea", name = "<init>", descriptor = "()V", line = 193)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(I[I)V", line = 79)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(III)V", line = 110)
    ...
    @OriginalMember(owner = "client!nea", name = "b", descriptor = "(II)V", line = 135)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(BI)I", line = 156)
