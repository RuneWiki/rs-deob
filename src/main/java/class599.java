...
public class class599 extends class415 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(I)V", line = 25)
    public class599(int arg0) {
        this.field8213 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!ai", name = "d", descriptor = "(I)V", line = 43)
