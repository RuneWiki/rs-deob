...
public class class599 extends class489 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(BLkp;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(B)Z", line = 34)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(IZ)V", line = 83)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(III)V", line = 98)
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(Leq;Lfaa;)V", line = 168)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(I)V", line = 216)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IZ)V", line = 331)
