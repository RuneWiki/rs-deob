...
public class class599 extends class133 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "(Lrv;IIZ)V")
    ...
    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "(Lrv;II[III)V")
