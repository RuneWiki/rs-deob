...
public class class599 extends class518 {
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!vw", name = "<init>", descriptor = "(Lpea;)V", line = 21)
    ...
    @OriginalMember(owner = "client!vw", name = "d", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(ZB)V", line = 50)
    ...
    @OriginalMember(owner = "client!vw", name = "e", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(II)I", line = 76)
    public static int method3320(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(BLwq;I)V", line = 83)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(IZI)V", line = 102)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(Z)Z", line = 115)
    ...
    @OriginalMember(owner = "client!vw", name = "f", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(ZI)V", line = 158)
    ...
    @OriginalMember(owner = "client!vw", name = "g", descriptor = "(I)V", line = 169)
