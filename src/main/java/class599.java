...
public class class599 {
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(III)I", line = 17)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(BLjava/io/File;Z)V", line = 44)
