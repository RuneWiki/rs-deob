...
public class class599 extends class606 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IZ)V", line = 49)
    ...
    @OriginalMember(owner = "client!ai", name = "c", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(B)V", line = 92)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(III)V", line = 112)
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Ltg;Lfp;Lic;)V", line = 136)
    ...
    @OriginalMember(owner = "client!ai", name = "d", descriptor = "(I)V", line = 153)
    ...
    @OriginalMember(owner = "client!ai", name = "c", descriptor = "(I)Z", line = 172)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ZI)V", line = 182)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(B)V", line = 200)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Lma;II)V", line = 214)
