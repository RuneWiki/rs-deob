...
public class class599 extends class577 implements class281 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(BLha;)Llba;")
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(ILha;)Llca;")
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IILha;I)Z")
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "(Lha;Lvc;IIIIIZIIIII)V")
