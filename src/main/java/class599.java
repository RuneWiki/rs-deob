...
public class class599 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ILbfa;)V", line = 32)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Z)V", line = 59)
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(Z)V", line = 71)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ILjava/net/Socket;I)Ljaa;", line = 85)
