...
public class class599 {
    ...
    @OriginalMember(owner = "client!tka", name = "a", descriptor = "(ZI)Z", line = 6)
    ...
    @OriginalMember(owner = "client!tka", name = "a", descriptor = "(Ljava/lang/String;IBLjava/lang/String;Lft;)Lvn;", line = 45)
    ...
    @OriginalMember(owner = "client!tka", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z", line = 125)
    ...
    @OriginalMember(owner = "client!tka", name = "a", descriptor = "(B)V", line = 148)
