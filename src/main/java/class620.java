...
public class class620 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Los;III)V")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(BILos;)V")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Ldn;B)V")
