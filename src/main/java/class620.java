...
public class class620 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Lha;Lth;)V")
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(Lha;Lth;)Z")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!th", name = "c", descriptor = "(Lha;Lth;)V")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Lha;IIIIII)V")
    ...
    @OriginalMember(owner = "client!th", name = "d", descriptor = "(Lha;Lth;)Z")
