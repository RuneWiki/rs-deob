...
public class class620 {
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(B)Ljha;", line = 9)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "([BB)V", line = 30)
    ...
    @OriginalMember(owner = "client!kia", name = "<init>", descriptor = "(IIIIIIIIIIIIII)V", line = 110)
