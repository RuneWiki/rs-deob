...
public class class620 {
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(Lst;)V")
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(Lst;I)V")
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(Ljg;I)V")
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(Lpw;II)V")
