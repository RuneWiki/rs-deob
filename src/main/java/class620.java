...
public class class620 extends class496 {
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(BS)V", line = 18)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IIBI[[Z)V", line = 46)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IIIBIII)V", line = 115)
    ...
    @OriginalMember(owner = "client!sp", name = "<init>", descriptor = "(Los;Lnba;Lat;[I)V", line = 285)
