...
public class class620 extends class386 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(ZILjava/io/File;)V", line = 90)
    ...
    @OriginalMember(owner = "client!ab", name = "e", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "()V", line = 191)
    public class620() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(IBLun;)V", line = 142)
