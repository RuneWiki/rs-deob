...
public class class620 extends class65 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(IIIIB)V", line = 7)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "(I[B)V", line = 39)
