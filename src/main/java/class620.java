...
public class class620 {
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(I[Lqf;I)V", line = 14)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(IIIZII)V", line = 117)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(Leba;IILeba;Z)I", line = 174)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(Leca;I)V", line = 277)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(II)V", line = 313)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(B)V", line = 377)
