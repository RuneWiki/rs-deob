...
public class class620 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IBILjava/lang/String;I[B)I", line = 21)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IILjava/lang/String;Ljava/lang/String;)I", line = 157)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(III)Z", line = 281)
