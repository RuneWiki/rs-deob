...
public abstract class class620 extends class210 {
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(Lha;I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(ZI)V", line = 15)
    ...
    @OriginalMember(owner = "client!hd", name = "i", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!hd", name = "f", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!hd", name = "d", descriptor = "(Z)V", line = 68)
    ...
    @OriginalMember(owner = "client!hd", name = "c", descriptor = "(I)Z", line = 86)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "([Lgu;I)I", line = 127)
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "(IIIIIIIIIZB)V", line = 295)
