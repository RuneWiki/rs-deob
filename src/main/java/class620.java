...
public class class620 implements class535 {
    ...
    @OriginalMember(owner = "client!a", name = "finalize", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "()V", line = 8)
    private final void method3460() {
        this.method3469(this.nativeid);
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILpda;ZI)Z", line = 11)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;[ILpda;)V", line = 14)
    ...
    @OriginalMember(owner = "client!a", name = "w", descriptor = "(Z)V", line = 17)
    public final void method123(boolean arg0) {
        this.method3484(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;IIIIIII[[Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILpda;Z)Z", line = 27)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lha;[I[I[I[SI)V", line = 32)
    ...
    @OriginalMember(owner = "client!a", name = "b", descriptor = "()V", line = 35)
    public final void method3468() {
        this.field8554 = null;
        this.method3477();
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;III)V", line = 51)
    ...
    @OriginalMember(owner = "client!a", name = "d", descriptor = "()V", line = 60)
    public final void method3478() {
        this.field8554 = Thread.currentThread();
        this.method3460();
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Li;BIZ)Lka;", line = 68)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lka;IIIZ)V", line = 115)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lpda;[II)V", line = 119)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;II)V", line = 122)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lha;IIIIIII)V", line = 126)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lpda;[III)V", line = 131)
