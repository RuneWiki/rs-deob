...
public class class620 extends class212 {
    ...
    @OriginalMember(owner = "client!tl", name = "<init>", descriptor = "(ILdh;)V", line = 5)
    public class620(int arg0, class322 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!tl", name = "d", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(II)I", line = 22)
    ...
    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(I)I", line = 40)
    ...
    @OriginalMember(owner = "client!tl", name = "e", descriptor = "(I)I", line = 51)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Z)V", line = 64)
    ...
    @OriginalMember(owner = "client!tl", name = "f", descriptor = "(I)Z", line = 81)
    ...
    @OriginalMember(owner = "client!tl", name = "g", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(II)V", line = 131)
    ...
    @OriginalMember(owner = "client!tl", name = "<init>", descriptor = "(Ldh;)V", line = 142)
