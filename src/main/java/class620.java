...
public class class620 extends class659 {
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IIIIIII)V", line = 32)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Leq;IIIIIIIIIB)Z", line = 63)
    ...
    @OriginalMember(owner = "client!rj", name = "c", descriptor = "(I)V", line = 315)
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(Lrea;Lls;)V", line = 324)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IFIBFFII)[F", line = 336)
