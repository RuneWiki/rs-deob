...
public class class620 extends class281 implements class75 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IZLfg;)V")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(I[B)Lvr;")
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(Ldia;III)V")
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(Ldia;IIII)V")
