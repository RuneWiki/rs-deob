...
public class class620 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IJLjava/lang/Object;)V", line = 5)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(JI)Ljava/lang/Object;", line = 15)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(BI)V", line = 58)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(B)I", line = 106)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IJ)V", line = 146)
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(I)I", line = 157)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IJLjava/lang/Object;I)V", line = 185)
    ...
    @OriginalMember(owner = "client!of", name = "c", descriptor = "(I)I", line = 216)
    public final int method3545(int arg0) {
        field8880++;
        return arg0 == 0 ? this.field8881 : 60;
    }

    @OriginalMember(owner = "client!of", name = "d", descriptor = "(I)V", line = 231)
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(II)V", line = 348)
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(I)V", line = 246)
    public class620(int arg0) {
        this(arg0, arg0);
    }

    @OriginalMember(owner = "client!of", name = "e", descriptor = "(I)Ljava/lang/Object;", line = 250)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(ILlm;)V", line = 281)
    ...
    @OriginalMember(owner = "client!of", name = "f", descriptor = "(I)V", line = 298)
    ...
    @OriginalMember(owner = "client!of", name = "g", descriptor = "(I)Ljava/lang/Object;", line = 311)
