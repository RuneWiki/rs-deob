...
public class class620 extends class27 {
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IILvf;)V")
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Lhb;BZ)V")
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(Llj;Lud;)V")
