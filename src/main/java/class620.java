...
public class class620 {
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(B)Ldaa;", line = 3)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(Ldaa;Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!rda", name = "b", descriptor = "(B)Ldaa;", line = 46)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(Z)I", line = 65)
    ...
    @OriginalMember(owner = "client!rda", name = "c", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(Ldaa;I)V", line = 118)
    ...
    @OriginalMember(owner = "client!rda", name = "b", descriptor = "(Z)Lo;", line = 143)
    ...
    @OriginalMember(owner = "client!rda", name = "c", descriptor = "(Z)V", line = 155)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(BII)Z", line = 177)
    ...
    @OriginalMember(owner = "client!rda", name = "d", descriptor = "(B)Ldaa;", line = 193)
    ...
    @OriginalMember(owner = "client!rda", name = "b", descriptor = "(I)Ldaa;", line = 210)
    ...
    @OriginalMember(owner = "client!rda", name = "<init>", descriptor = "()V", line = 235)
    public class620() {
