...
public class class620 extends class518 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lha;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Laa;Lvo;Ltb;IIIII)V", line = 94)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "()V", line = 139)
    public class620() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(II)[I", line = 142)
    ...
    @OriginalMember(owner = "client!fi", name = "f", descriptor = "(I)V", line = 235)
    ...
    @OriginalMember(owner = "client!fi", name = "d", descriptor = "(B)V", line = 253)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ILjc;I)V", line = 264)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ZBLjava/lang/String;)V", line = 308)
