...
public class class620 extends class491 implements class584 {
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!jia", name = "<init>", descriptor = "(Lfi;IZ[[I)V", line = 13)
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(BLej;)V", line = 68)
    ...
    @OriginalMember(owner = "client!jia", name = "c", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;", line = 78)
