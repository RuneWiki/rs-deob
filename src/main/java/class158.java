...
public class class158 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IB)Lsn;", line = 3)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(I)Ltda;", line = 14)
    public final class338 method1179(int arg0) {
        field2447++;
        return arg0 == 20416 ? class257.method1733(arg0 - 48137, this.field2446) : null;
    }

    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(II)V", line = 49)
