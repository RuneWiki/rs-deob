...
public class class158 extends class573 {
    ...
    @OriginalMember(owner = "client!wea", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(ZZ)V", line = 22)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Z)V", line = 73)
    ...
    @OriginalMember(owner = "client!wea", name = "<init>", descriptor = "(Lmh;Lwu;Lwda;)V", line = 99)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Lwc;IB)V", line = 122)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(B)V", line = 137)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(ZI)V", line = 161)
    ...
    @OriginalMember(owner = "client!wea", name = "b", descriptor = "(I)Z", line = 170)
    public final boolean method605(int arg0) {
        return arg0 == 4095 ? this.field2391 : true;
    }

    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(III)V", line = 180)
    ...
    @OriginalMember(owner = "client!wea", name = "b", descriptor = "(Z)V", line = 208)
    ...
    @OriginalMember(owner = "client!wea", name = "e", descriptor = "(I)V", line = 229)
