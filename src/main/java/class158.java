...
public class class158 extends class308 implements class415 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Ltba;Ljg;Z)V", line = 21)
    public class158(class147 arg0, class309 arg1, boolean arg2) {
        super(arg0, 34963, arg2);
        this.field2300 = arg1;
    }

    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ILgi;)I", line = 29)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Lfc;I)Z", line = 61)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;", line = 72)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Z)I", line = 90)
    ...
    @OriginalMember(owner = "client!gg", name = "b", descriptor = "(II)I", line = 101)
    ...
    @OriginalMember(owner = "client!gg", name = "b", descriptor = "(Z)Z", line = 113)
    ...
    @OriginalMember(owner = "client!gg", name = "b", descriptor = "(I)V", line = 124)
    public final void method1122(int arg0) {
        ++field2309;
        super.method1122(arg0);
    }

    @OriginalMember(owner = "client!gg", name = "c", descriptor = "(B)V", line = 133)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(I)Ljg;", line = 145)
