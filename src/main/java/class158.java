...
public class class158 extends class4 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IIB)V", line = 77)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IIIIZ)V", line = 92)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(II)Z", line = 129)
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(Lsi;)V", line = 146)
