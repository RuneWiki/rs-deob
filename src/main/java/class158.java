...
public class class158 extends class507 {
    ...
    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(Lad;II)V")
    ...
    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(Lad;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(Lad;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(ILkr;B)V")
