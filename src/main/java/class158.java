...
public class class158 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Ljp;I)Ljl;")
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(II)Lgd;")
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Lgia;ILaj;Laj;)V")
