...
public class class158 extends class334 implements class415 {
    ...
    @OriginalMember(owner = "client!fa", name = "finalize", descriptor = "()V", line = 10)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Ln;Lst;II)V", line = 15)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "()Z", line = 33)
    public final boolean method76() {
        return true;
    }

    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lka;IIIZ)V", line = 40)
    ...
    @OriginalMember(owner = "client!fa", name = "b", descriptor = "()[Lhd;", line = 47)
    public final class531[] method87() {
        return this.field2048;
    }

    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IILn;Z)Z", line = 59)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Ln;Lst;I)V", line = 62)
    ...
    @OriginalMember(owner = "client!fa", name = "d", descriptor = "()V", line = 80)
    public final void method83() {
    }

    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(BIZ)Lka;", line = 88)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(ILn;)V", line = 92)
    ...
    @OriginalMember(owner = "client!fa", name = "c", descriptor = "()[Llq;", line = 154)
    public final class392[] method72() {
        return this.field2046;
    }

    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IIII)V", line = 158)
    public final void method78(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "(Lc;Lk;Lnd;IIII)V", line = 160)
    ...
    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "(Lc;)V", line = 231)
