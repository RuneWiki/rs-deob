...
public class class158 extends class489 {
    ...
    @OriginalMember(owner = "client!dt", name = "<init>", descriptor = "(Lhh;Lre;[Lfq;[I[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(CIIIZLea;II)V", line = 25)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "([B[I[IIIIIII)V", line = 97)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "([B[IIIIIIIIIIILea;II)V", line = 155)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "([B[IIIIIIII)V", line = 243)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "([B[I[IIIIIIIIIIILea;II)V", line = 302)
    ...
    @OriginalMember(owner = "client!dt", name = "B", descriptor = "(CIIIZ)V", line = 389)
