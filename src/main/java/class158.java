...
public class class158 extends class147 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!ws", name = "b", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!ws", name = "c", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!ws", name = "d", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(III)I", line = 129)
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZ)V", line = 151)
