...
public class class158 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lra;I)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(ILbk;Z)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIBLbk;)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IZ)Lja;")
