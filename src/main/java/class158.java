...
public abstract class class158 implements class754 {
    ...
    @OriginalMember(owner = "client!ou", name = "finalize", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IZ)V", line = 17)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(II)Ljj;", line = 36)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(B)Z", line = 64)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!ou", name = "c", descriptor = "(B)I", line = 106)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(IZ)V", line = 119)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(I)V", line = 138)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(BZ)V", line = 162)
    ...
    @OriginalMember(owner = "client!ou", name = "c", descriptor = "(I)I", line = 189)
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(Lkw;IIIZ)V", line = 203)
