...
public class class158 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IILbt;Z)Lbq;")
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(BLjv;)V")
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IBLlc;Ljava/lang/String;)Lpga;")
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "(Lnv;JI)V")
