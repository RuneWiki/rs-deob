...
public class class158 extends class300 implements class691 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(ILsk;IBIIII[F)V", line = 3)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(BF)F", line = 19)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(ZBZ)V", line = 31)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(FB)F", line = 45)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(IIIIII[BLsk;I)V", line = 56)
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(Lqi;Lsk;IIZ[FII)V", line = 72)
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(Lqi;Lsk;IIZ[BII)V", line = 92)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(I)Z", line = 113)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Z)I", line = 124)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(B)I", line = 138)
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(Lqi;Lsk;Lvea;II)V", line = 153)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(III[IIBII)V", line = 164)
    ...
    @OriginalMember(owner = "client!un", name = "g", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(Lqi;IIZ[III)V", line = 196)
