...
public class class158 extends class159 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "([FII)[F", line = 9)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IIILmd;Lmd;)V", line = 24)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IB)V", line = 86)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(III)Z", line = 104)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(I)V", line = 114)
