...
public class class158 extends class599 {
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(ZIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(Lkv;IIIIZ[BIZ)V", line = 21)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IIIIIBI)V", line = 73)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(II[IZIIIII)V", line = 88)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(B)V", line = 141)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IBII)V", line = 158)
    ...
    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(Lkv;IIII)V", line = 172)
    ...
    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(Lkv;IIIIZ[FI)V", line = 189)
    ...
    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(Lkv;IIIII)V", line = 278)
    ...
    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(Lkv;IIIIZ[IIIZ)V", line = 317)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(BIIIIII[BIZ)V", line = 218)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(ZILcb;)Lqda;", line = 293)
