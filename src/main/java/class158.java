...
public abstract class class158 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(BI)I", line = 4)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Lui;B)V", line = 51)
