...
public class class158 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Ltt;IILjava/lang/String;)Loaa;")
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Lta;)V")
    public class158(class194 arg0) {
        this.field2376 = arg0;
    }

    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Lta;Lmj;)V")
