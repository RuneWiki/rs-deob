...
public class class158 extends class83 implements class28 {
    ...
    @OriginalMember(owner = "client!ufa", name = "b", descriptor = "(IB)I", line = 3)
    ...
    @OriginalMember(owner = "client!ufa", name = "<init>", descriptor = "(Loaa;Lpb;Loea;II)V", line = 22)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(B)I", line = 33)
    public final int method124(byte arg0) {
        ++field2045;
        return arg0 != 95 ? 105 : this.field2053;
    }

    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(ZZZ)V", line = 44)
    ...
    @OriginalMember(owner = "client!ufa", name = "b", descriptor = "(B)I", line = 54)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(II[BLpb;IIIII)V", line = 65)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(IIII[III)V", line = 89)
    ...
    @OriginalMember(owner = "client!ufa", name = "c", descriptor = "(B)V", line = 113)
    public static void method1016(byte arg0) {
        field2049 = null;
        int var1 = -77 / ((arg0 - -56) / 32);
    }

    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(FI)F", line = 124)
    ...
    @OriginalMember(owner = "client!ufa", name = "<init>", descriptor = "(Loaa;Lpb;II[BII)V", line = 135)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(I[IIIIZII)V", line = 150)
    ...
    @OriginalMember(owner = "client!ufa", name = "c", descriptor = "(IB)V", line = 176)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(BLsha;ILha;I)V", line = 196)
    ...
    @OriginalMember(owner = "client!ufa", name = "<init>", descriptor = "(Loaa;II[III)V", line = 510)
    ...
    @OriginalMember(owner = "client!ufa", name = "<init>", descriptor = "(Loaa;Lpb;II[FII)V", line = 524)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(FZ)F", line = 542)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(IIIILwc;)Z", line = 553)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(I)Z", line = 679)
