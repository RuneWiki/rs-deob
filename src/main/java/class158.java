...
public class class158 {
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(III)I", line = 8)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Ljava/lang/String;II)Ljava/lang/String;", line = 42)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ILqa;)Lf;", line = 106)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Ldh;II)V", line = 140)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Lqa;IZ)Lf;", line = 303)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Z)V", line = 337)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Ldh;B)V", line = 351)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ILdh;)V", line = 398)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ILtn;)Z", line = 457)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(I)V", line = 495)
