...
public abstract class class158 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Lde;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IIIII[B)V", line = 23)
    ...
    @OriginalMember(owner = "client!gg", name = "b", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(JI)I", line = 78)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IBI)Z", line = 107)
    public static final boolean method1102(int arg0, byte arg1, int arg2) {
        field2275++;
        return arg1 >= -17;
    }

    @OriginalMember(owner = "client!gg", name = "d", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!gg", name = "e", descriptor = "(I)V", line = 136)
