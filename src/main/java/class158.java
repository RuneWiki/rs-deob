...
public class class158 {
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(I)Lmk;", line = 26)
    ...
    @OriginalMember(owner = "client!oga", name = "b", descriptor = "(Z)I", line = 47)
    ...
    @OriginalMember(owner = "client!oga", name = "b", descriptor = "(I)Lmk;", line = 71)
    ...
    @OriginalMember(owner = "client!oga", name = "c", descriptor = "(Z)V", line = 93)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(B)Lmk;", line = 106)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(ILmk;)V", line = 127)
    ...
    @OriginalMember(owner = "client!oga", name = "c", descriptor = "(I)Lmk;", line = 145)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(IIZI)I", line = 165)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(Lmk;I)V", line = 188)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(I[B[BIIIIII)V", line = 214)
    ...
    @OriginalMember(owner = "client!oga", name = "<init>", descriptor = "()V", line = 266)
    public class158() {
