...
public class class158 extends class397 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(IBI)I", line = 6)
    ...
    @OriginalMember(owner = "client!kf", name = "e", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(IBLae;)V", line = 38)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(BI)[[I", line = 81)
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "()V", line = 148)
    public class158() {
        super(1, false);
    }

    @OriginalMember(owner = "client!kf", name = "f", descriptor = "(I)V", line = 151)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(II)[I", line = 606)
