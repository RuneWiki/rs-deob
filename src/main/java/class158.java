...
public class class158 extends class157 {
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(Z)[B", line = 4)
    ...
    @OriginalMember(owner = "client!lf", name = "e", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Lfs;I)V", line = 36)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(I)I", line = 55)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(I[SI)[S", line = 74)
