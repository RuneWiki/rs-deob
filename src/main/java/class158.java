...
public class class158 extends class421 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(II)Lrr;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IILfb;ZIIIIIIZB)V")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lsj;I)Lsj;")
