...
public class class158 implements Runnable {
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IB)Z", line = 83)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IIBI)I", line = 117)
    ...
    @OriginalMember(owner = "client!ue", name = "b", descriptor = "(B)V", line = 147)
    ...
    @OriginalMember(owner = "client!ue", name = "<init>", descriptor = "(Ljava/io/InputStream;I)V", line = 233)
    ...
    @OriginalMember(owner = "client!ue", name = "c", descriptor = "(B)V", line = 179)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(I[BZI)I", line = 190)
