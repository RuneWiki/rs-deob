...
public class class158 extends class381 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(II)V", line = 8)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IB)V", line = 21)
    public final void method1198(int arg0, byte arg1) {
        int var3 = -114 % ((arg1 - 58) / 50);
        this.field2374 = ByteBuffer.allocateDirect(arg0 * 4);
    }

    @OriginalMember(owner = "client!jj", name = "b", descriptor = "(II)V", line = 29)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(BIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(I[II)V", line = 53)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IIIFI)V", line = 189)
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(Lag;IIII)V", line = 299)
