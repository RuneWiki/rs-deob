...
public class class158 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Ljava/lang/Object;Luk;B)V")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(BLuk;)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(ILuk;)V")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(III)Lqc;")
