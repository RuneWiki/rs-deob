...
public class class158 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Lbda;IB)V")
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(I)Lqd;")
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Lr;III[Z)V")
