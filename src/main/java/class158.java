...
public class class158 {
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILns;)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lhu;ILjava/awt/Frame;)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lcw;ILqa;)I")
