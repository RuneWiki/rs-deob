...
public class class158 implements Runnable {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(IIIIB)Lof;", line = 5)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "([Ljava/lang/Class;ILjava/lang/Class;Ljava/lang/String;)Lof;", line = 17)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Ljava/lang/String;I)Lso;", line = 32)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(II)Lof;", line = 44)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(BLjava/lang/String;Z)Lof;", line = 55)
    ...
    @OriginalMember(owner = "client!wea", name = "run", descriptor = "()V", line = 69)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(B)V", line = 365)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(ZILjava/lang/String;I)Lof;", line = 423)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Ljava/lang/Runnable;II)Lof;", line = 433)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Ljava/net/URL;I)Lof;", line = 444)
    public final class622 method1211(URL arg0, int arg1) {
        return arg1 == 8362 ? this.method1220(8, 0, 4, 0, arg0) : null;
    }

    @OriginalMember(owner = "client!wea", name = "<init>", descriptor = "(ILjava/lang/String;IZ)V", line = 706)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(I[IILjava/awt/Point;Ljava/awt/Component;I)Lof;", line = 465)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(I)V", line = 483)
    ...
    @OriginalMember(owner = "client!wea", name = "b", descriptor = "(I)Lof;", line = 493)
    public final class622 method1214(int arg0) {
        return arg0 == 972476528 ? this.method1220(8, 0, 5, 0, null) : null;
    }

    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;I)Lso;", line = 527)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "([BBLjava/io/File;)Z", line = 573)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Class;)Lof;", line = 595)
    ...
    @OriginalMember(owner = "client!wea", name = "c", descriptor = "(I)Ljava/lang/Object;", line = 611)
    ...
    @OriginalMember(owner = "client!wea", name = "b", descriptor = "(Ljava/lang/String;I)Lof;", line = 622)
    public final class622 method1219(String arg0, int arg1) {
        return arg1 == 16 ? this.method1220(arg1 - 8, 0, 16, 0, arg0) : null;
    }

    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(IIIILjava/lang/Object;)Lof;", line = 636)
    ...
    @OriginalMember(owner = "client!wea", name = "d", descriptor = "(I)Z", line = 665)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(BLjava/awt/Frame;)Lof;", line = 684)
