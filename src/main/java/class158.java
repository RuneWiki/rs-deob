...
public class class158 extends class85 {
    ...
    @OriginalMember(owner = "client!ra", name = "T", descriptor = "Llf;")
    public static class109 field2968 = class35.method275("<col=ffff00>", 2);

    @OriginalMember(owner = "client!ra", name = "X", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ra", name = "Q", descriptor = "Ldf;")
    public static class37 field2965;

    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(BILja;)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IB)Lvg;")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Led;)V")
