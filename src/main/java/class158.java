...
public class class158 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "([Lis;Lfb;Lau;Llb;Lks;IILr;Loj;ILbg;ILnv;Llb;BIZII)Lda;", line = 5)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(ILau;ZI)V", line = 513)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(B)V", line = 530)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IILfb;I)V", line = 541)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(ILau;ZLr;Loj;ILlb;IIIII)Lda;", line = 563)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(ZI)I", line = 711)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Lks;IILoj;Lau;Lnv;Llb;Lfb;IIZLr;)Lda;", line = 723)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(I)V", line = 926)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(ZII)V", line = 972)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "([IIBI[IZ)V", line = 984)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(B)V", line = 1006)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(I)Ljava/lang/String;", line = 1052)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(ZB)V", line = 1067)
