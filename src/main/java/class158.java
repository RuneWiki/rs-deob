...
public class class158 extends class96 {
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "()V", line = 200)
    public class158() {
        super(1, false);
    }

    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(II)[[I", line = 13)
    ...
    @OriginalMember(owner = "client!bs", name = "e", descriptor = "(B)V", line = 106)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IILbt;)V", line = 116)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IB)Z", line = 189)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(B[I)Ljava/lang/String;", line = 203)
