...
public class class158 extends class417 implements class274 {
    ...
    @OriginalMember(owner = "client!bu", name = "c", descriptor = "(ILha;)Lid;", line = 4)
    ...
    @OriginalMember(owner = "client!bu", name = "e", descriptor = "(I)I", line = 14)
    public final int method747(int arg0) {
        ++field2060;
        return arg0 != 15258 ? -117 : this.field2042.method3443(-1);
    }

    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(Z)I", line = 26)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(IILha;I)Z", line = 37)
    ...
    @OriginalMember(owner = "client!bu", name = "e", descriptor = "(B)I", line = 58)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(B)Z", line = 69)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(ILmea;)V", line = 81)
    ...
    @OriginalMember(owner = "client!bu", name = "b", descriptor = "(ILha;)Lpi;", line = 94)
    ...
    @OriginalMember(owner = "client!bu", name = "c", descriptor = "(Z)Z", line = 145)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(I)I", line = 156)
    ...
    @OriginalMember(owner = "client!bu", name = "b", descriptor = "(III)V", line = 170)
    ...
    @OriginalMember(owner = "client!bu", name = "d", descriptor = "(B)Z", line = 189)
    ...
    @OriginalMember(owner = "client!bu", name = "c", descriptor = "(B)V", line = 200)
    ...
    @OriginalMember(owner = "client!bu", name = "b", descriptor = "(B)I", line = 210)
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "(Lha;Lih;IIIIIZII)V", line = 223)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(ILha;)V", line = 232)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(BLha;)V", line = 244)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(Lha;I)V", line = 255)
    ...
    @OriginalMember(owner = "client!bu", name = "d", descriptor = "(I)Z", line = 280)
    ...
    @OriginalMember(owner = "client!bu", name = "b", descriptor = "(I)V", line = 292)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(ZIBLlq;Lha;II)V", line = 303)
