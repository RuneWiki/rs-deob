...
public class class158 extends class177 {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!c", name = "b", descriptor = "()Lc;", line = 9)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(III[I)V", line = 32)
    ...
    @OriginalMember(owner = "client!c", name = "b", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!c", name = "b", descriptor = "(III)V", line = 59)
    ...
    @OriginalMember(owner = "client!c", name = "e", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIIII)V", line = 77)
    ...
    @OriginalMember(owner = "client!c", name = "d", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!c", name = "c", descriptor = "(III)V", line = 115)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lvj;)V", line = 128)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "([I)V", line = 145)
    ...
    @OriginalMember(owner = "client!c", name = "c", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!c", name = "<init>", descriptor = "()V", line = 177)
    public class158() {
        this.method976();
    }
}
