...
public abstract class class158 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!wh", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 6)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(BIIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!wh", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 63)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(B)Ljava/lang/String;", line = 73)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(ZI)V", line = 90)
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(B)V", line = 165)
    ...
    @OriginalMember(owner = "client!wh", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 210)
    ...
    @OriginalMember(owner = "client!wh", name = "f", descriptor = "(B)Z", line = 236)
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(I)Z", line = 247)
    ...
    @OriginalMember(owner = "client!wh", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 261)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IIIBIZILjava/lang/String;)V", line = 271)
    ...
    @OriginalMember(owner = "client!wh", name = "f", descriptor = "(I)Z", line = 320)
    ...
    @OriginalMember(owner = "client!wh", name = "start", descriptor = "()V", line = 358)
    ...
    @OriginalMember(owner = "client!wh", name = "d", descriptor = "(I)V", line = 370)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 402)
    ...
    @OriginalMember(owner = "client!wh", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 427)
    ...
    @OriginalMember(owner = "client!wh", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 434)
    ...
    @OriginalMember(owner = "client!wh", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 442)
    ...
    @OriginalMember(owner = "client!wh", name = "e", descriptor = "(B)V", line = 456)
    ...
    @OriginalMember(owner = "client!wh", name = "provideLoaderApplet", descriptor = "(Ljava/applet/Applet;)V", line = 509)
    ...
    @OriginalMember(owner = "client!wh", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 522)
    ...
    @OriginalMember(owner = "client!wh", name = "run", descriptor = "()V", line = 535)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IIIILjava/lang/String;II)V", line = 657)
    ...
    @OriginalMember(owner = "client!wh", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 707)
    ...
    @OriginalMember(owner = "client!wh", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 714)
    ...
    @OriginalMember(owner = "client!wh", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 721)
    ...
    @OriginalMember(owner = "client!wh", name = "destroy", descriptor = "()V", line = 729)
    ...
    @OriginalMember(owner = "client!wh", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 746)
    ...
    @OriginalMember(owner = "client!wh", name = "c", descriptor = "(B)Z", line = 762)
    ...
    @OriginalMember(owner = "client!wh", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 774)
    ...
    @OriginalMember(owner = "client!wh", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 792)
    ...
    @OriginalMember(owner = "client!wh", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 814)
    ...
    @OriginalMember(owner = "client!wh", name = "stop", descriptor = "()V", line = 822)
