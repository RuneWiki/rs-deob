...
public class class158 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IZLtq;Ltq;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(II)I", line = 19)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Z)V", line = 55)
