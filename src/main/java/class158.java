...
public class class158 extends class525 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(II[III)Z", line = 37)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(III)Z", line = 64)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(II[II)Z", line = 87)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "([IIII)Z", line = 118)
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 215)
    ...
    @OriginalMember(owner = "client!tg", name = "c", descriptor = "(I)V", line = 162)
