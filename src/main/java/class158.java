...
public class class158 extends class404 {
    ...
    @OriginalMember(owner = "client!sr", name = "b", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(II)[I", line = 15)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IIIIIIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IIIIIIIIII)V", line = 86)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "()V", line = 161)
    public class158() {
        super(0, true);
    }

    @OriginalMember(owner = "client!sr", name = "h", descriptor = "(I)V", line = 168)
    ...
    @OriginalMember(owner = "client!sr", name = "b", descriptor = "(II)[[I", line = 184)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(ILha;I)V", line = 258)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(I[[I)V", line = 329)
