...
public class class158 extends class38 implements class294 {
    ...
    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "(Lw;Lg;II[[I[[IIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(II)V", line = 15)
    public final void method190(int arg0, int arg1) {
        this.field2571.method1332().method2482(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IIIIIII[[Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lbk;[I)V", line = 28)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Li;IIIIZ)Z", line = 33)
    public final boolean method182(class31 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return true;
    }

    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(III[[ZZ)V", line = 43)
