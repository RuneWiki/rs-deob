...
public class class158 extends class419 {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(BII)I", line = 4)
    ...
    @OriginalMember(owner = "client!c", name = "k", descriptor = "(I)Z", line = 19)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lvm;I)V", line = 35)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ZI)Ljava/lang/String;", line = 61)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ZIIILai;ILvm;)V", line = 109)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ILtq;)V", line = 121)
    ...
    @OriginalMember(owner = "client!c", name = "c", descriptor = "(B)I", line = 317)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IBIZI)V", line = 334)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IILjn;IILvm;Lib;I)V", line = 349)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ZZ)Ljava/lang/String;", line = 377)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lvm;II)Z", line = 398)
    ...
    @OriginalMember(owner = "client!c", name = "c", descriptor = "(I)V", line = 550)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lvm;Z)Ldn;", line = 561)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(B)I", line = 699)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIILvm;)Z", line = 721)
    ...
    @OriginalMember(owner = "client!c", name = "d", descriptor = "(B)Z", line = 760)
    ...
    @OriginalMember(owner = "client!c", name = "f", descriptor = "(B)I", line = 777)
    ...
    @OriginalMember(owner = "client!c", name = "l", descriptor = "(I)V", line = 788)
    ...
    @OriginalMember(owner = "client!c", name = "g", descriptor = "(B)V", line = 820)
    ...
    @OriginalMember(owner = "client!c", name = "e", descriptor = "(I)I", line = 846)
    ...
    @OriginalMember(owner = "client!c", name = "h", descriptor = "(B)V", line = 858)
