...
public class class158 {
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Lgw;II)V", line = 56)
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(II)V", line = 123)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(ILgw;)V", line = 164)
