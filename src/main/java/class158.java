...
public class class158 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(I)Ljda;", line = 4)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ZIIII)Z", line = 24)
    ...
    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(I)I", line = 61)
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "()V", line = 189)
    public class158() {
        this.field2357.field3202 = this.field2357;
        this.field2357.field3201 = this.field2357;
    }

    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Z)V", line = 89)
    ...
    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(Z)Ljda;", line = 114)
    ...
    @OriginalMember(owner = "client!jh", name = "c", descriptor = "(Z)V", line = 136)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(III)Lht;", line = 155)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Ljda;I)V", line = 171)
    ...
    @OriginalMember(owner = "client!jh", name = "d", descriptor = "(Z)Ljda;", line = 199)
