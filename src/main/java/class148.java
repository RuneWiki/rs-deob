...
public class class148 extends class589 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IIILjava/awt/Graphics;BI)V", line = 36)
    ...
    @OriginalMember(owner = "client!fd", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 51)
    public final void startProduction(ImageConsumer arg0) {
        ++field1916;
        this.addConsumer(arg0);
    }

    @OriginalMember(owner = "client!fd", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 64)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IILjava/awt/Graphics;B)V", line = 75)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 93)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(III)Z", line = 115)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IIBII)V", line = 129)
    ...
    @OriginalMember(owner = "client!fd", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 151)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field1906;
    }

    @OriginalMember(owner = "client!fd", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 158)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(ZII)V", line = 171)
    ...
    @OriginalMember(owner = "client!fd", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 191)
