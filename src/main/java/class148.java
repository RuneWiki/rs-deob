...
public class class148 extends class96 {
    ...
    @OriginalMember(owner = "client!be", name = "c", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!be", name = "b", descriptor = "(II)[I", line = 19)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IILbt;)V", line = 53)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(II)[[I", line = 64)
    ...
    @OriginalMember(owner = "client!be", name = "b", descriptor = "(Z)V", line = 105)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "([JZ[I)V", line = 117)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IBI)V", line = 131)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IIIIII)V", line = 208)
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "()V", line = 325)
    public class148() {
        super(1, false);
    }

    @OriginalMember(owner = "client!be", name = "a", descriptor = "(BB)C", line = 328)
