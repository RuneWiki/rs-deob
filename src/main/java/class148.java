...
public class class148 extends class283 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ZZLjava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!vr", name = "h", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(Ljava/lang/String;I)V", line = 88)
    ...
    @OriginalMember(owner = "client!vr", name = "<init>", descriptor = "(Lpt;Ljava/lang/Object;I)V", line = 142)
    ...
    @OriginalMember(owner = "client!vr", name = "g", descriptor = "(I)Ljava/lang/Object;", line = 150)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(I)Z", line = 168)
    ...
    @OriginalMember(owner = "client!vr", name = "c", descriptor = "(III)Z", line = 179)
