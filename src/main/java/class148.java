...
public class class148 extends class287 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(B[ILsv;)V")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(IB)Lde;")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(ILsv;I)V")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Lsv;B)V")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Lsv;I)Ljava/lang/String;")
