...
public class class148 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IIIIIIIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IC)Z", line = 24)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ZLkb;BIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ILgh;)V", line = 108)
    public static final void method897(int arg0, class327 arg1) {
        class161.field2122[arg0] = arg1;
    }

    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Z)V", line = 116)
