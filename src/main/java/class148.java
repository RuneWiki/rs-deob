...
public class class148 extends class293 {

    @OriginalMember(owner = "client!bb", name = "w", descriptor = "I")
    private int field1798 = 0;

    @OriginalMember(owner = "client!bb", name = "E", descriptor = "Lrs;")
    private class258 field1806 = new class258();
    ...
    public static final void method707(int arg0, int arg1, int arg2, int arg3) {
        ...
        if (~class358.field5167 == -3) {
            ...
            class120.field1490 = var6;
            class401.field5718 = var5;
        }
        class349.field5021 = (float) var4;
        class31.field389 = (float) var6;
        class426.method2539(arg3 ^ -2710);
    ...
    public final void method708(int arg0, int arg1) {
        ++field1790;
        if (arg0 != 14) {
            this.method713(91, (class263) null);
        }
    }

    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IIZLmi;F)V")
    public final void method709(int arg0, int arg1, boolean arg2, class443 arg3, float arg4) {
        ...
        ++super.field4362;
        if (arg0 != 5) {
            this.method715((class263) null, 127);
        }
        if (super.field4362 >= 5000) {
            super.field4362 = 0;
        }
    ...
    public final void method710(int arg0) {
        ...
        ++field1801;
        while (~super.field4362 != ~super.field4351) {
            this.method711(-1);
        }
    }
    ...
    private final void method711(int arg0) {
        ...
        ++field1791;
        int var2 = super.field4351++;
        if (~super.field4351 <= -5001) {
            super.field4351 = 0;
        }
        this.field1798 = super.field4353[var2];
        Object var3 = super.field4358[var2];
        super.field4358[var2] = null;
        if (this.field1798 == 21) {
            class80.method402(this.field1806, (class263) var3);
        } else if (this.field1798 != 20) {
            if (this.field1798 >= 30 && ~this.field1798 >= -34) {
                class415.field5985.method1498(3000.0F, super.field4357[var2] * 1.5F);
                ((class443) var3).method1867(class352.field5065, class25.field345, class218.field3071, class115.field1413, ~(this.field1798 + -30) == -1);
            } else if (~this.field1798 <= -41 && ~this.field1798 >= -44) {
                class415.field5985.method1498(3000.0F, super.field4357[var2] * 1.5F);
                ((class443) var3).method1867(class352.field5065, class25.field345, class218.field3071, class241.field3311, ~(this.field1798 - 40) == -1);
            } else if (this.field1798 != 22) {
                if (this.field1798 != 23) {
                    if (~this.field1798 == -25) {
            ...
            class263 var4 = (class263) var3;
            if (var4.field3783 != null) {
                var4.field3783.method27(0, class415.field5985);
            }
            if (var4.field3780 != null) {
                var4.field3780.method27(0, class415.field5985);
            }
            if (var4.field3784 != null) {
                var4.field3784.method27(0, class415.field5985);
            }
            if (var4.field3782 != null) {
                var4.field3782.method27(~arg0, class415.field5985);
            }
            if (var4.field3798 != null) {
                var4.field3798.method27(0, class415.field5985);
            }
            for (class248 var5 = var4.field3801; var5 != null; var5 = var5.field3490) {
                var5.field3487.method27(0, class415.field5985);
            }
        }
    }
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ILqa;)V")
    public final void method713(int arg0, class263 arg1) {
        ...
        int var3 = 113 / ((7 - arg0) / 57);
    }

    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Lqa;I)V")
    ...
    public final void method716(int arg0) {
        if (arg0 != -31042) {
            method707(118, -97, -71, 31);
        }
        ++field1809;
    }

    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ZILjava/lang/String;JZIZIILjava/lang/String;Z)V")
    public static final void method717(boolean arg0, int arg1, String arg2, long arg3, boolean arg4, int arg5, boolean arg6, int arg7, int arg8, String arg9, boolean arg10) {
        ++field1805;
        int[] var12 = new int[4];
        for (int var13 = 0; ~var13 > -4; ++var13) {
            var12[var13] = (int) (9.9999999E7D * Math.random());
        }
        class179 var14 = new class179(128);
        var14.method909(10, -1);
        var14.method884((arg10 ? 1 : 0) | (arg6 ? 2 : 0) | (arg4 ? 4 : 0), true);
        var14.method929((byte) -93, arg3);
        var14.method897(var12[0], -116);
        var14.method935(arg9, 90);
        var14.method897(var12[1], -111);
        var14.method884(class62.field772, true);
        var14.method909(arg1, -1);
        var14.method909(arg7, -1);
        var14.method897(var12[2], -106);
        var14.method884(arg5, true);
        var14.method884(arg8, arg0);
        var14.method897(var12[3], -106);
        var14.method914(1350202472, class196.field2707, class99.field1211);
        class179 var15 = new class179(350);
        var15.method935(arg2, -103);
        int var16 = 8 - class183.method995((byte) 23, arg2) % 8;
        for (int var17 = 0; ~var17 > ~var16; ++var17) {
            var15.method909((int) (Math.random() * 255.0D), -1);
        }
        var15.method892(-981467133, var12);
        class230.field3185.field2206 = 0;
        class230.field3185.method909(class214.field2954.field4563, -1);
        class230.field3185.method884(2 - -var15.field2206 + var14.field2206, true);
        class230.field3185.method884(574, true);
        class230.field3185.method934((byte) -93, var14.field2159, 0, var14.field2206);
        class230.field3185.method934((byte) -126, var15.field2159, 0, var15.field2206);
