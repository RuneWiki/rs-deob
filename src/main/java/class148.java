...
public class class148 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(II)Lefa;")
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ILefa;)V")
    ...
    @OriginalMember(owner = "client!ls", name = "<init>", descriptor = "(Lefa;)V")
