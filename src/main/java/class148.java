...
public class class148 extends class170 {
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(B)Ljava/lang/String;", line = 28)
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(Z)Ljava/lang/String;", line = 38)
    ...
    @OriginalMember(owner = "client!bi", name = "c", descriptor = "(I)F", line = 49)
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(B)F", line = 61)
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(ILjagtheora/ogg/OggPacket;)V", line = 77)
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 155)
