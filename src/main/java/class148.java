...
public class class148 extends class42 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(Z)V", line = 28)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IIZ)Z", line = 46)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(BII[I)V", line = 61)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IIII)Z", line = 75)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(II)Lfm;", line = 90)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(B)Z", line = 127)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(II)I", line = 140)
    public static final int method1022(int arg0, int arg1) {
        field2099++;
        return arg1 == -1981755129 ? arg0 >>> 7 : 117;
    }

    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(ZZ)V", line = 156)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(II[II)V", line = 195)
    ...
    @OriginalMember(owner = "client!qb", name = "c", descriptor = "(B)V", line = 208)
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(IIIIIIIII)V", line = 234)
