...
public class class148 extends class649 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!dfa", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 29)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field1808;
        return this.field1817 == arg0;
    }

    @OriginalMember(owner = "client!dfa", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 39)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IZII)I", line = 52)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IIILjava/awt/Graphics;II)V", line = 96)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IBIII)V", line = 113)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Ljava/awt/Graphics;IIB)V", line = 141)
    ...
    @OriginalMember(owner = "client!dfa", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 153)
    public final void startProduction(ImageConsumer arg0) {
        ++field1823;
        this.addConsumer(arg0);
    }

    @OriginalMember(owner = "client!dfa", name = "b", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!dfa", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 179)
    ...
    @OriginalMember(owner = "client!dfa", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 190)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field1819;
    }

    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 201)
