...
public class class148 extends class275 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(JI)V", line = 12)
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Lnr;IZJI)V", line = 125)
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(Lnr;Ldn;Lqp;J)V", line = 314)
