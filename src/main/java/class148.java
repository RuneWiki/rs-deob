...
public class class148 extends class175 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(ILdt;Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(IB)[[I", line = 54)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(ZI)[I", line = 119)
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "()V", line = 161)
    public class148() {
        super(1, false);
    }

    @OriginalMember(owner = "client!cg", name = "g", descriptor = "(I)V", line = 170)
