...
public class class148 {
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "()[B", line = 11)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Loi;II)Lp;", line = 70)
    ...
    @OriginalMember(owner = "client!p", name = "<init>", descriptor = "(Lwm;)V", line = 123)
    ...
    @OriginalMember(owner = "client!p", name = "b", descriptor = "()I", line = 82)
    ...
    @OriginalMember(owner = "client!p", name = "c", descriptor = "()Lcj;", line = 145)
