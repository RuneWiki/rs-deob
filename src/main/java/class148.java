...
public class class148 extends class398 {
    ...
    @OriginalMember(owner = "client!uk", name = "c", descriptor = "(B)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lnj;II)V", line = 32)
    ...
    @OriginalMember(owner = "client!uk", name = "d", descriptor = "(B)V", line = 106)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IILps;)I", line = 124)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(I[II)[I", line = 334)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IZ)V", line = 398)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IILii;)V", line = 417)
    ...
    @OriginalMember(owner = "client!uk", name = "b", descriptor = "(II)[[I", line = 708)
