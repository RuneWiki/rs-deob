...
public class class148 implements Runnable {
    ...
    @OriginalMember(owner = "client!bs", name = "run", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(B)Z", line = 62)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(II)Lnda;", line = 105)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(I)V", line = 145)
