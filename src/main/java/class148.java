...
public class class148 extends class85 {
    ...
    @OriginalMember(owner = "client!q", name = "cb", descriptor = "Ltf;")
    public static class181 field2854 = new class181();

    @OriginalMember(owner = "client!q", name = "ib", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!q", name = "pb", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IZIILvg;III)V")
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(BILja;)V")
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(Lke;ILjava/lang/Object;)V")
