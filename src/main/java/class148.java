...
public class class148 extends class512 {
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "()V", line = 5)
    public class148() {
        super(1, false);
    }

    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(II)[[I", line = 12)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(ZILia;)V", line = 93)
