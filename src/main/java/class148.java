...
public class class148 extends Canvas {
    ...
    @OriginalMember(owner = "client!pj", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 18)
    public final void update(Graphics arg0) {
        this.field2332.update(arg0);
        field2331++;
    }

    @OriginalMember(owner = "client!pj", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 27)
    public final void paint(Graphics arg0) {
        field2327++;
        this.field2332.paint(arg0);
    }

    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(B)Ljw;", line = 35)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Lli;I)V", line = 59)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IBI)Z", line = 121)
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 132)
