...
public class class148 extends class300 implements class691 {
    ...
    @OriginalMember(owner = "client!nfa", name = "<init>", descriptor = "(Lqi;Lsk;Lvea;II)V")
    ...
    @OriginalMember(owner = "client!nfa", name = "<init>", descriptor = "(Lqi;II[III)V")
    ...
    @OriginalMember(owner = "client!nfa", name = "<init>", descriptor = "(Lqi;Lsk;II[BII)V")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(IIIIII[BLsk;I)V")
    ...
    @OriginalMember(owner = "client!nfa", name = "<init>", descriptor = "(Lqi;Lsk;II[FII)V")
