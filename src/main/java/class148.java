...
public class class148 {
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(III)V", line = 27)
    ...
    @OriginalMember(owner = "client!bu", name = "b", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "(III)V", line = 198)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(B)[[I", line = 90)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(II)[I", line = 128)
