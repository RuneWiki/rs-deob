...
public class class148 extends class176 implements class89 {
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(Lhj;[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(II)V", line = 10)
    public final void method155(int arg0, int arg1) {
        this.field1871.method3767().method878(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 21)
    ...
    @OriginalMember(owner = "client!ya", name = "<init>", descriptor = "(Lda;La;II[[I[[IIII)V", line = 134)
    ...
    @OriginalMember(owner = "client!ya", name = "finalize", descriptor = "()V", line = 139)
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(III[[ZZ)V", line = 146)
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(IIIIIII[[Z)V", line = 162)
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(Lw;IIIIZ)Z", line = 165)
