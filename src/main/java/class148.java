...
public class class148 extends class360 implements class558 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "([BIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!mg", name = "b", descriptor = "(I)J", line = 18)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(I)I", line = 32)
    ...
    @OriginalMember(owner = "client!mg", name = "c", descriptor = "(I)I", line = 43)
    ...
    @OriginalMember(owner = "client!mg", name = "d", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Ljava/lang/String;BILgh;)Lsb;", line = 65)
    ...
    @OriginalMember(owner = "client!mg", name = "<init>", descriptor = "(Lnv;I[BIZ)V", line = 143)
