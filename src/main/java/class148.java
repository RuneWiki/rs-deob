...
public class class148 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "()I", line = 4)
    public final int method1054() {
        return this.field2331;
    }

    @OriginalMember(owner = "client!wd", name = "b", descriptor = "()V", line = 7)
    public static void method1055() {
        field2334 = null;
    }

    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/lang/String;)I", line = 11)
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(Le;IZLjava/awt/Component;)V", line = 54)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Le;Ljava/lang/String;IIIZ)V", line = 38)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Le;Ljava/lang/String;[IIIIZ)V", line = 98)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Le;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 120)
    ...
    @OriginalMember(owner = "client!wd", name = "c", descriptor = "()I", line = 213)
