...
public class class148 extends class279 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Ljava/awt/Canvas;Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(B)Z", line = 27)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ZI)V", line = 38)
    ...
    @OriginalMember(owner = "client!iq", name = "f", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lpj;)V", line = 64)
    public class148(class38 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(III)V", line = 68)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(BZ)V", line = 78)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IZLiu;)V", line = 89)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Z)V", line = 101)
