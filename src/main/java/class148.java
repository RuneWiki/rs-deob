...
public class class148 extends class615 {
    ...
    @OriginalMember(owner = "client!jh", name = "d", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!jh", name = "e", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IB)[I", line = 37)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IB[Lgba;IZI)V", line = 91)
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "()V", line = 143)
    public class148() {
        super(1, false);
    }

    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ZIIII[B)V", line = 148)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IZ)V", line = 180)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Ldw;III)V", line = 232)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(II)[[I", line = 259)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(BILeh;)V", line = 333)
