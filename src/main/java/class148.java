...
public class class148 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(ILfa;Lqa;ILgb;IILfm;)V")
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Lco;II)V")
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(ILco;)V")
