...
public class class148 extends class109 {
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Ljaa;IIIIIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(III)Z", line = 17)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(III)I", line = 28)
    ...
    @OriginalMember(owner = "client!hq", name = "d", descriptor = "(II)V", line = 53)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Ljaa;IIIZ[I)V", line = 70)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Ljaa;IIIIIZ)V", line = 93)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Ljaa;IIII)V", line = 114)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Ljaa;IIII[I)V", line = 135)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Ljaa;IIIII)V", line = 153)
    public class148(class576 arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Ljaa;IIIII[BI)V", line = 167)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Ljaa;IIIIZ[BI)V", line = 181)
