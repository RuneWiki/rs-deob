...
public class class148 implements class422 {
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(B)Lvj;", line = 3)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "([Lrga;II)V", line = 16)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(IIII)I", line = 54)
    ...
    @OriginalMember(owner = "client!ada", name = "<init>", descriptor = "(Lpu;)V", line = 67)
    public class148(class522 arg0) {
        this.field2164 = arg0;
    }

    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(I)I", line = 78)
