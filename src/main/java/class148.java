...
public class class148 extends class478 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ILnp;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "([[BBLuk;)V", line = 38)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(II)[I", line = 72)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "()V", line = 169)
    public class148() {
        super(1, true);
    }

    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IIIIII)Z", line = 111)
    ...
    @OriginalMember(owner = "client!nr", name = "c", descriptor = "(I)V", line = 145)
    public static void method813(int arg0) {
        int var1 = -47 / ((30 - arg0) / 37);
        field1633 = null;
    }

    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IBI)Z", line = 155)
