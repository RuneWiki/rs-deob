...
public class class148 extends class517 {
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "(Luca;II[BI)V")
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IIIIIIII[Lps;I)V")
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IIIIBIIII[[[BLr;II)V")
