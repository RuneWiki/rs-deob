...
public class class148 extends class297 {
    ...
    @OriginalMember(owner = "client!pj", name = "b", descriptor = "(Z)Z", line = 3)
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "()V", line = 30)
    public class148() {
        super(0, false);
    }

    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Lcea;II)V", line = 34)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(I)I", line = 48)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!pj", name = "d", descriptor = "(II)[[I", line = 86)
    ...
    @OriginalMember(owner = "client!pj", name = "c", descriptor = "(Z)V", line = 157)
