...
public class class148 extends class182 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Lej;Z)Z", line = 6)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(I[I)Ljava/lang/String;", line = 42)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(III)Z", line = 99)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Z)Ldf;", line = 110)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Lkw;IIIIII)V", line = 171)
