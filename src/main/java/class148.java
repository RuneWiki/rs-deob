...
public class class148 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lnc;Lnc;)Z", line = 4)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lnc;)Z", line = 64)
    public final boolean method1019(class75 arg0) {
        return this.method1020(arg0, 8, 8.0F, 8.0F, 8.0F, 2.0F, 2.0F, 2.0F, 0.5F, 0.5F);
    }

    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lnc;IFFFFFFFF)Z", line = 70)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lnc;Lb;FFFFFFFF)Z", line = 77)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "()Z", line = 132)
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "()Z", line = 148)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lse;)V", line = 164)
