...
public class class148 extends class208 implements class226 {
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(ILha;)V", line = 4)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(B)Z", line = 16)
    ...
    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "(Lha;Lsea;IIIIIZIIIIIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!g", name = "b", descriptor = "(B)I", line = 37)
    ...
    @OriginalMember(owner = "client!g", name = "c", descriptor = "(ILha;)V", line = 48)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(I)I", line = 68)
    ...
    @OriginalMember(owner = "client!g", name = "f", descriptor = "(I)I", line = 80)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(BLea;)V", line = 92)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(IIILha;Lnfa;ZI)V", line = 118)
    ...
    @OriginalMember(owner = "client!g", name = "b", descriptor = "(ILha;)V", line = 129)
    ...
    @OriginalMember(owner = "client!g", name = "b", descriptor = "(BLha;)Lmg;", line = 140)
    ...
    @OriginalMember(owner = "client!g", name = "d", descriptor = "(I)Z", line = 152)
    ...
    @OriginalMember(owner = "client!g", name = "e", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!g", name = "c", descriptor = "(Z)Z", line = 176)
    ...
    @OriginalMember(owner = "client!g", name = "e", descriptor = "(Z)V", line = 190)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(BIILha;)Z", line = 203)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Lha;I)Luh;", line = 222)
    ...
    @OriginalMember(owner = "client!g", name = "c", descriptor = "(B)V", line = 279)
    ...
    @OriginalMember(owner = "client!g", name = "b", descriptor = "(Z)I", line = 294)
    public final int method1173(boolean arg0) {
        ++field2379;
        return !arg0 ? -41 : this.field2387.method2159(-112);
    }

    @OriginalMember(owner = "client!g", name = "d", descriptor = "(B)I", line = 306)
    ...
    @OriginalMember(owner = "client!g", name = "f", descriptor = "(B)Z", line = 316)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Lpe;B)V", line = 330)
