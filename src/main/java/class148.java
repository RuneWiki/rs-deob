...
public class class148 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(BLjava/lang/Object;Lgl;)V")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(BLgl;)V")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Llg;III[Z)Z")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Len;III)V")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(ILra;Lra;Z)V")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lgl;I)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lir;I)V")
