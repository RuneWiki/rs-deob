...
public class class148 extends class479 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(III)Z", line = 5)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IBIII)I", line = 53)
