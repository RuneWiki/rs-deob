...
public class class148 {
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(II)Leu;", line = 10)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(Lfp;IIB)J", line = 37)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(B)V", line = 92)
    ...
    @OriginalMember(owner = "client!tca", name = "b", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!tca", name = "<init>", descriptor = "(Lre;ILdn;)V", line = 125)
    public class148(class515 arg0, int arg1, class438 arg2) {
        this.field1768 = arg2;
        this.field1768.method2554(30, 123);
    }

    @OriginalMember(owner = "client!tca", name = "b", descriptor = "(II)V", line = 140)
