...
public class class646 extends class591 {
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "(Len;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "(Len;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "(Len;IIIIZ[IZ)V")
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "(Len;IIIII)V")
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "(Len;IIII)V")
