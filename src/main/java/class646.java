...
public class class646 {
    ...
    @OriginalMember(owner = "client!oja", name = "e", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!oja", name = "b", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!oja", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!oja", name = "c", descriptor = "(I)I", line = 87)
    ...
    @OriginalMember(owner = "client!oja", name = "b", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!oja", name = "a", descriptor = "(B)V", line = 150)
    ...
    @OriginalMember(owner = "client!oja", name = "a", descriptor = "(Z)I", line = 180)
    ...
    @OriginalMember(owner = "client!oja", name = "d", descriptor = "(I)V", line = 198)
    ...
    @OriginalMember(owner = "client!oja", name = "<init>", descriptor = "()V", line = 346)
    private class646() {
    }

    @OriginalMember(owner = "client!oja", name = "<init>", descriptor = "([I)V", line = 352)
