...
public class class646 implements class559 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lka;IIIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;IIIIIII[[Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;II)V", line = 16)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "()V", line = 24)
    public final void method3593() {
        this.field8972 = Thread.currentThread();
        this.method3606();
    }

    @OriginalMember(owner = "client!a", name = "w", descriptor = "(Z)V", line = 28)
    public final void method151(boolean arg0) {
        this.method3591(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!a", name = "b", descriptor = "()V", line = 31)
    public final void method3594() {
        this.field8972 = null;
        this.method3602();
    }

    @OriginalMember(owner = "client!a", name = "finalize", descriptor = "()V", line = 36)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Li;BIZ)Lka;", line = 43)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;[ILuu;)V", line = 91)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Luu;[II)V", line = 95)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lha;IIIIIII)V", line = 99)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Luu;[III)V", line = 102)
    ...
    @OriginalMember(owner = "client!a", name = "c", descriptor = "()V", line = 105)
    private final void method3602() {
        this.method3610(this.nativeid);
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILuu;ZI)Z", line = 109)
    ...
    @OriginalMember(owner = "client!a", name = "d", descriptor = "()V", line = 115)
    private final void method3606() {
        this.method3583(this.nativeid);
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;III)V", line = 120)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILuu;Z)Z", line = 131)
