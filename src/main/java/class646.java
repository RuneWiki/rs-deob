...
public class class646 extends class219 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Lkj;BLjava/awt/Frame;)V", line = 3)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(B)J", line = 31)
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "([[SD)V", line = 55)
