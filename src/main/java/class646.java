...
public class class646 implements class559 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lnh;[III)V", line = 3)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "()V", line = 17)
    private final void method3611() {
        this.method3616(this.nativeid);
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lha;[I[I[I[SI)V", line = 22)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Li;BIZ)Lka;", line = 33)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lnh;[II)V", line = 93)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILnh;Z)Z", line = 96)
    ...
    @OriginalMember(owner = "client!a", name = "c", descriptor = "()V", line = 101)
    ...
    @OriginalMember(owner = "client!a", name = "d", descriptor = "()V", line = 110)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;II)V", line = 118)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;IIIIIII[[Z)V", line = 121)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;[ILnh;)V", line = 124)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILnh;ZI)Z", line = 127)
