...
public class class646 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "()V", line = 22)
    public class646() {
    }

    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(I)I", line = 25)
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(Lrg;)V", line = 35)
