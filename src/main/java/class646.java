...
public class class646 extends OutputStream {
    ...
    @OriginalMember(owner = "client!sfa", name = "write", descriptor = "(I)V", line = 5)
    public final void write(int arg0) throws IOException {
        field9075++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(ZLdh;)V", line = 16)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(ILoo;)V", line = 31)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(I)V", line = 84)
