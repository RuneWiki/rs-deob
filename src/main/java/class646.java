...
public class class646 {
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "()V", line = 3)
    public static void method3643() {
        field9203 = null;
    }

    @OriginalMember(owner = "client!fia", name = "a", descriptor = "([III)V", line = 9)
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(II)V", line = 59)
    ...
    @OriginalMember(owner = "client!fia", name = "b", descriptor = "()V", line = 104)
    private static final void method3646() {
        field9204 = 0;
    }

    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(Lha;[II)V", line = 155)
    public static final void method3648(class544 arg0, int[] arg1, int arg2) {
        method3649(arg0, arg1, 0, arg1.length, arg2, null, null);
    }

    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(Lha;[IIII[I[I)V", line = 163)
    ...
    @OriginalMember(owner = "client!fia", name = "b", descriptor = "(II)V", line = 201)
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(Lha;[II[I[I)V", line = 238)
    ...
    @OriginalMember(owner = "client!fia", name = "b", descriptor = "(I)Z", line = 243)
