...
public class class646 implements class560 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILsj;Z)Z", line = 3)
    ...
    @OriginalMember(owner = "client!a", name = "finalize", descriptor = "()V", line = 58)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lha;IIIIIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;II)V", line = 66)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lka;IIIZ)V", line = 70)
    ...
    @OriginalMember(owner = "client!a", name = "c", descriptor = "()V", line = 73)
    private final void method4683() {
        this.method4693(this.nativeid);
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;[ILsj;)V", line = 77)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;IIIIIII[[Z)V", line = 81)
    ...
    @OriginalMember(owner = "client!a", name = "d", descriptor = "()V", line = 84)
    public final void method4688() {
        this.field9265 = null;
        this.method4698();
    }

    @OriginalMember(owner = "client!a", name = "b", descriptor = "()V", line = 88)
    public final void method4689() {
        this.field9265 = Thread.currentThread();
        this.method4683();
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lsj;[II)V", line = 94)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lha;[I[I[I[SI)V", line = 97)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;III)V", line = 100)
    ...
    @OriginalMember(owner = "client!a", name = "w", descriptor = "(Z)V", line = 110)
    public final void method121(boolean arg0) {
        this.method4678(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "()V", line = 114)
    private final void method4698() {
        this.method4679(this.nativeid);
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILsj;ZI)Z", line = 122)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lsj;[III)V", line = 128)
