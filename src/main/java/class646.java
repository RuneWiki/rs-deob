...
public class class646 extends class524 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IIILha;)Lka;")
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(ILha;)Lkj;")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(ZLha;IILkba;II)V")
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "(IIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lha;III)Z")
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(BLha;)Lml;")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(BLka;Lnga;Lha;)V")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(BLha;)V")
