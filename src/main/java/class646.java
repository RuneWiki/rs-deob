...
public class class646 extends class623 {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Ld;ZLoh;III)[F", line = 16)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Lmfa;)V", line = 132)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Ld;Loh;B)Z", line = 227)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IIDLoh;BLd;Z)[I", line = 281)
    ...
    @OriginalMember(owner = "client!og", name = "f", descriptor = "(I)V", line = 416)
    public static final void method3679(int arg0) {
        class682.field9652 = arg0;
    }

    @OriginalMember(owner = "client!og", name = "b", descriptor = "(B)V", line = 419)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(II[BIII[BII)V", line = 445)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IBIII[BI)V", line = 489)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(DIBZILd;ZLoh;)[I", line = 586)
    ...
    @OriginalMember(owner = "client!og", name = "g", descriptor = "(I)V", line = 725)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IZLefa;)V", line = 749)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Lrr;IIIII)V", line = 904)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "()V", line = 991)
    public class646() {
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Lig;)V", line = 1006)
