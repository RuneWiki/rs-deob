...
public class class646 {
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(Lcc;I)I", line = 7)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(III[B)V", line = 42)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(BLg;I)V", line = 58)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(IIZ)Ljava/lang/String;", line = 74)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!lca", name = "b", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!lca", name = "c", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!lca", name = "<init>", descriptor = "(Lbi;Lnr;Led;IIIII)V", line = 241)
