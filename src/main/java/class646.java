...
public class class646 extends class544 {
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "()V", line = 3)
    public class646() {
    }

    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 7)
    public class646(String arg0) {
        this.field9396 = arg0;
    }

    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IIII)V", line = 29)
