...
public class class646 implements class560 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;[ILsk;)V", line = 3)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;IIIIIII[[Z)V", line = 12)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILsk;ZI)Z", line = 19)
    ...
    @OriginalMember(owner = "client!a", name = "finalize", descriptor = "()V", line = 22)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lha;[I[I[I[SI)V", line = 27)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lsk;[III)V", line = 34)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lsk;[II)V", line = 37)
    ...
    @OriginalMember(owner = "client!a", name = "c", descriptor = "()V", line = 41)
    public final void method3611() {
        this.field8933 = Thread.currentThread();
        this.method3603();
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILsk;Z)Z", line = 45)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lka;IIIZ)V", line = 51)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lha;IIIIIII)V", line = 54)
    ...
    @OriginalMember(owner = "client!a", name = "w", descriptor = "(Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;II)V", line = 68)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Li;BIZ)Lka;", line = 81)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;III)V", line = 128)
