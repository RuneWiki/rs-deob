...
public class class646 extends class530 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!hf", name = "c", descriptor = "(II)Z", line = 17)
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(I)I", line = 31)
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(Z)Z", line = 42)
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Lah;)V", line = 63)
    public class646(class374 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(ILah;)V", line = 66)
    public class646(int arg0, class374 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Lha;I)V", line = 70)
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(II)V", line = 151)
    ...
    @OriginalMember(owner = "client!hf", name = "c", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Z)V", line = 177)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(II)I", line = 196)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(BLwu;)V", line = 217)
