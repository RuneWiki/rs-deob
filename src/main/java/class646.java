...
public class class646 {
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(Ldf;Z[[[BIB)Z", line = 5)
    ...
    @OriginalMember(owner = "client!kia", name = "toString", descriptor = "()Ljava/lang/String;", line = 75)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(III[BIII)Z", line = 89)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(BILjava/lang/String;Z)Z", line = 138)
    ...
    @OriginalMember(owner = "client!kia", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V", line = 221)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(Lib;Lko;I)Lrja;", line = 235)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(B)V", line = 333)
