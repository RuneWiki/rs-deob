...
public class class646 extends class665 {
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(IIII[[Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(IS)V", line = 63)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(IIIIIII)V", line = 92)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(B)V", line = 260)
    ...
    @OriginalMember(owner = "client!sfa", name = "<init>", descriptor = "(Lok;Lvfa;Lrc;[I)V", line = 273)
