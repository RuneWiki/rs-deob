...
public class class646 {
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(IBLdga;)V")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Lpq;III)Lrf;")
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Ldga;Z)V")
