...
public class class646 extends class546 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "()Ldk;")
    public final class472 method3598() {
        return this.field8933;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([Llp;Z)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lr;J[Lns;[Llp;Z)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IZ)Loa;")
    ...
    @OriginalMember(owner = "client!oa", name = "f", descriptor = "()Ldk;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lr;J)Z")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lr;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lr;[Lns;Z)V")
