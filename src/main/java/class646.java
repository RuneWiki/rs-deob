...
public class class646 extends class461 {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IZIB)V", line = 7)
    ...
    @OriginalMember(owner = "client!eo", name = "c", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IIIII)V", line = 58)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "([BZ)[B", line = 90)
    ...
    @OriginalMember(owner = "client!eo", name = "<init>", descriptor = "(Lpe;Lpe;Lrw;)V", line = 109)
    public class646(class615 arg0, class615 arg1, class485 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(BILjava/lang/String;)V", line = 114)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(B)Z", line = 151)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(ZIII)V", line = 194)
