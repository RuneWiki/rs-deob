...
public class class646 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Llr;I)I")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lmv;B)I")
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(Luca;I)V")
