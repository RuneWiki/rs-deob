...
public class class646 extends class430 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(III)Z", line = 67)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "([IIIB)V", line = 82)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(III[I)V", line = 110)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IIIIIB)V", line = 125)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IBI)Z", line = 208)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IIIB)Z", line = 223)
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "(IIIIIIIII)V", line = 243)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(I)V", line = 259)
