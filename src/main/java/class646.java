...
public class class646 implements class46 {
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(B)Lsq;", line = 16)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "([JB[I)V", line = 29)
    ...
    @OriginalMember(owner = "client!sea", name = "<init>", descriptor = "(ILpe;Lop;II)V", line = 54)
