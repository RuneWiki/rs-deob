...
public class class392 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(Ljb;IIII)Z")
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(IIIIIILcaa;IIII)Z")
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(IIILrc;Lm;Lha;Laia;II)V")
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(IIILd;Ljava/awt/Canvas;)Lha;")
