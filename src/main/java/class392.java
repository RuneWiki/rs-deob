...
public class class392 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IIII)Llq;")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(B)Lun;")
    ...
    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "(Llq;I)V")
