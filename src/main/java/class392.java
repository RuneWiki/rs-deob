...
public class class392 {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Z)I", line = 3)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(I)I", line = 15)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(II)V", line = 30)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(ILjava/lang/Object;ILjo;)V", line = 77)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Lnb;I)V", line = 105)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Ljo;Z)V", line = 124)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(Z)V", line = 151)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(B)V", line = 171)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(ILjo;)Ljava/lang/Object;", line = 200)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(III)I", line = 257)
    ...
    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "(I)V", line = 300)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(I)V", line = 278)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(ILjava/lang/Object;Ljo;)V", line = 290)
