...
public class class392 extends class615 {
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(Lqj;IIII)V", line = 32)
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(Lqj;IIII[BI)V", line = 142)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "([BI)Z", line = 9)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Lqi;I)V", line = 50)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!gba", name = "d", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IIIIIIII)V", line = 97)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IZLjava/io/File;)V", line = 114)
