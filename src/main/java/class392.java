...
public abstract class class392 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Ljf;I)Ljf;", line = 3)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(II)Lqd;", line = 46)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Ljava/lang/String;ZB)V", line = 94)
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(II)Z", line = 170)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(IB)C", line = 202)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(CI)Z", line = 233)
