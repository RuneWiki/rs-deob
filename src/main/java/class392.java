...
public class class392 implements class240 {
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Lda;BIZ)Lt;", line = 10)
    ...
    @OriginalMember(owner = "client!n", name = "finalize", descriptor = "()V", line = 59)
    protected final void finalize() {
        class371.method2212((byte) -72, this);
    }

    @OriginalMember(owner = "client!n", name = "b", descriptor = "()V", line = 79)
