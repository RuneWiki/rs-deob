...
public class class392 extends class371 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(JI)V", line = 13)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Ltd;[[BB)V", line = 39)
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(Lqa;Lu;Lce;J)V", line = 364)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Z)V", line = 107)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IJZLqa;B)V", line = 119)
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(Z)V", line = 282)
