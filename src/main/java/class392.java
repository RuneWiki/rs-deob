...
public class class392 extends class397 {
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IBLae;)V", line = 84)
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "()V", line = 113)
    public class392() {
        super(0, true);
    }

    @OriginalMember(owner = "client!gu", name = "c", descriptor = "(Z)V", line = 118)
