...
public class class392 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(ZLfp;)V")
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(ILbe;)I")
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(ILgfa;I)V")
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(Lsr;Llr;Laca;IIIII)V")
