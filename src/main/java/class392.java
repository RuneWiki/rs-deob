...
public class class392 extends class265 implements class668 {
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!kda", name = "d", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 19)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(ILcg;)V", line = 29)
    public final void method694(int arg0, class140 arg1) {
        super.method694(arg0, arg1);
    }

    @OriginalMember(owner = "client!kda", name = "<init>", descriptor = "(Lul;Let;III[B)V", line = 36)
