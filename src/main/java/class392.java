...
public class class392 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(JLqa;I)V")
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Lqa;Lcea;IIIII)V")
    ...
    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "(Lfca;II)V")
