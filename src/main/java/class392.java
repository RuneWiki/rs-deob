...
public class class392 extends class159 {
    ...
    @OriginalMember(owner = "client!ada", name = "<init>", descriptor = "(Ldw;Lcd;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ada", name = "b", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(BZ)V", line = 47)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(ZB)V", line = 60)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(IIB)Z", line = 92)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(Lwu;II)V", line = 102)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(Z)Z", line = 128)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(ZII)V", line = 139)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(ILjava/lang/String;)I", line = 178)
