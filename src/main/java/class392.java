...
public class class392 {
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Lrv;)V", line = 8)
    ...
    @OriginalMember(owner = "client!mv", name = "b", descriptor = "(Lrv;)V", line = 14)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "()V", line = 47)
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "()V", line = 55)
    public class392() {
        this.field5564[0] = 0;
