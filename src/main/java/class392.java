...
public abstract class class392 implements class545 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(FFFFIILaa;II)V", line = 11)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(FFFFIIIII)V", line = 40)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(FFFFFFIII)V", line = 65)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IIII)V", line = 68)
    public final void method3069(int arg0, int arg1, int arg2, int arg3) {
        this.method876(arg0, arg1, arg2, arg3, 1, 0, 1, 1);
    }

    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(FFIILaa;II)V", line = 76)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(FFFFFFLaa;II)V", line = 80)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(FFIIIII)V", line = 83)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(IIIIIII)V", line = 87)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(II)V", line = 90)
    public final void method3074(int arg0, int arg1) {
        this.method874(arg0, arg1, 1, 0, 1);
    }

    @OriginalMember(owner = "client!tb", name = "c", descriptor = "(IIII)V", line = 93)
    public final void method3075(int arg0, int arg1, int arg2, int arg3) {
        this.method1382(arg0, arg1, arg2, arg3, 1, 0, 1);
    }

    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(FFII)V", line = 96)
