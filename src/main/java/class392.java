...
public class class392 extends class120 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ILjava/util/Random;I)I", line = 3)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Z)V", line = 31)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IIIIIIII)V", line = 46)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IIII)V", line = 58)
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(II)Lnj;", line = 72)
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(Z)V", line = 105)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(I[[[BIBII)V", line = 117)
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(Lbt;IIII[BI)V", line = 258)
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(Lbt;IIII)V", line = 280)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(BIILkj;)Lhu;", line = 300)
