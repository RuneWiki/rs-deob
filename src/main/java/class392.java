...
public class class392 {
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Lhw;IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IIIILua;Lr;Lis;II)V", line = 164)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IIIB)I", line = 268)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(I)V", line = 295)
