...
public class class392 extends class361 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(ILro;)V")
    ...
    @OriginalMember(owner = "client!jl", name = "b", descriptor = "(Lnr;Z)Lg;")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lnr;II)Lqc;")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(BLnr;IIZLcb;I)V")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lqc;Lnr;Z)V")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(ILnr;II)Z")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lnr;I)V")
