...
public class class392 {
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Lpaa;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!dda", name = "c", descriptor = "(II)Lnp;")
    ...
    @OriginalMember(owner = "client!dda", name = "<init>", descriptor = "(Lwj;ILwu;)V")
