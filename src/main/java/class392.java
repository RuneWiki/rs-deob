...
public abstract class class392 {
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IIII)I", line = 4)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IIILvba;IIIIIIII)Z", line = 29)
    ...
    @OriginalMember(owner = "client!sj", name = "b", descriptor = "(Z)Z", line = 461)
    ...
    @OriginalMember(owner = "client!sj", name = "d", descriptor = "(I)V", line = 480)
