...
public class class392 extends class496 implements class454 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Z)I", line = 3)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IIILdda;)Lts;", line = 15)
    ...
    @OriginalMember(owner = "client!pd", name = "g", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(I)C", line = 64)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(CI)Z", line = 84)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(B)J", line = 112)
    ...
    @OriginalMember(owner = "client!pd", name = "h", descriptor = "(I)Z", line = 122)
    ...
    @OriginalMember(owner = "client!pd", name = "c", descriptor = "(I)I", line = 132)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(I)I", line = 150)
