...
public class class392 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ILqg;)V", line = 7)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IZIIIZI)V", line = 25)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(I)I", line = 90)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Lmq;I)V", line = 109)
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(I)Lqg;", line = 144)
    ...
    @OriginalMember(owner = "client!ug", name = "c", descriptor = "(I)Lqg;", line = 171)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Lqg;ILug;)V", line = 190)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(BI[BIII)V", line = 214)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Z)Lqg;", line = 244)
    ...
    @OriginalMember(owner = "client!ug", name = "d", descriptor = "(I)Lqg;", line = 268)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(BLqg;)V", line = 288)
    ...
    @OriginalMember(owner = "client!ug", name = "e", descriptor = "(I)V", line = 305)
    ...
    @OriginalMember(owner = "client!ug", name = "f", descriptor = "(I)Z", line = 318)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Lug;B)V", line = 335)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ZZB)V", line = 348)
    ...
    @OriginalMember(owner = "client!ug", name = "g", descriptor = "(I)Lqg;", line = 373)
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "()V", line = 397)
    public class392() {
