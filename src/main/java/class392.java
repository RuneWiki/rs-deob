...
public class class392 extends class40 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(BI)[I", line = 7)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(II)[[I", line = 41)
    ...
    @OriginalMember(owner = "client!rs", name = "c", descriptor = "(I)Z", line = 90)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(CI)C", line = 111)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IILlf;)V", line = 140)
    ...
    @OriginalMember(owner = "client!rs", name = "h", descriptor = "(B)V", line = 154)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "([IB[J)V", line = 166)
