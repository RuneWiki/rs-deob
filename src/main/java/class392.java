...
public abstract class class392 extends class45 {
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(B)I", line = 16)
    public final int method2258(byte arg0) {
        field5251++;
        return arg0 >= -18 ? -75 : this.field5244;
    }

    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(Z)F", line = 28)
    ...
    @OriginalMember(owner = "client!qea", name = "b", descriptor = "(I)I", line = 48)
    ...
    @OriginalMember(owner = "client!qea", name = "b", descriptor = "(B)I", line = 61)
    ...
    @OriginalMember(owner = "client!qea", name = "c", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!qea", name = "c", descriptor = "(I)I", line = 89)
    ...
    @OriginalMember(owner = "client!qea", name = "<init>", descriptor = "(IIIIIF)V", line = 105)
