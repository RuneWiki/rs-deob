...
public abstract class class392 {
    ...
    @OriginalMember(owner = "client!fi", name = "finalize", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ZBZ)V", line = 14)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(II[B)V", line = 45)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IIIIIIII)V", line = 71)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(Z)V", line = 89)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "([Ljava/lang/Object;I[JII)V", line = 103)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(Lur;I[BIZ)V", line = 170)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(Lur;ILjaggl/memory/NativeBuffer;IZ)V", line = 197)
