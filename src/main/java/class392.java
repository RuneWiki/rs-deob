...
public class class392 extends class34 {
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!dda", name = "<init>", descriptor = "(Lrs;IIZ)V")
    ...
    @OriginalMember(owner = "client!dda", name = "<init>", descriptor = "(Lrs;IIII)V")
    ...
    @OriginalMember(owner = "client!dda", name = "<init>", descriptor = "(Lrs;II[III)V")
