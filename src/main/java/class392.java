...
public class class392 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(BI)Lgd;", line = 23)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Ltq;IIIIIILcu;)Ldp;", line = 100)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IIIIII)V", line = 119)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Z)V", line = 144)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ZB)V", line = 185)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(Z)V", line = 204)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IZIIIILtq;Ltr;ZILtq;Lcu;)Ldp;", line = 223)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(I)V", line = 291)
    ...
    @OriginalMember(owner = "client!hq", name = "c", descriptor = "(I)V", line = 304)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(BLui;)V", line = 321)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Lgp;IZLcs;Lui;Lui;)V", line = 426)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(II)V", line = 359)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IB)V", line = 391)
