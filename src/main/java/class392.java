...
public class class392 {
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(ZJ)V", line = 8)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(I)V", line = 31)
    public static void method2543(int arg0) {
        field6131 = null;
        int var1 = 65 / ((-arg0 - 40) / 61);
    }

    @OriginalMember(owner = "client!ifa", name = "b", descriptor = "(I)Ldda;", line = 45)
    ...
    @OriginalMember(owner = "client!ifa", name = "<init>", descriptor = "(IIIIIIIIIZI)V", line = 72)
