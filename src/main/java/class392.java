...
public class class392 extends class38 {
    ...
    @OriginalMember(owner = "client!fu", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IILrg;)V", line = 13)
    ...
    @OriginalMember(owner = "client!fu", name = "b", descriptor = "(III)V", line = 81)
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "()V", line = 122)
    public class392() {
        super(1, false);
    }

    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(II)[[I", line = 129)
