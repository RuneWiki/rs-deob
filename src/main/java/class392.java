...
public class class392 {
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ZI)V", line = 20)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(I)V", line = 35)
