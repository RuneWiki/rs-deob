...
public class class392 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Z)Lqp;")
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Lqp;B)V")
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(Z)Lqp;")
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(I)Lqp;")
    ...
    @OriginalMember(owner = "client!li", name = "c", descriptor = "(Z)Lqp;")
