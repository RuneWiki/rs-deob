...
public class class392 extends class255 implements class196 {
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(ILqa;)V", line = 4)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(ILqa;B)Lc;", line = 110)
    ...
    @OriginalMember(owner = "client!wb", name = "g", descriptor = "(I)I", line = 120)
    ...
    @OriginalMember(owner = "client!wb", name = "c", descriptor = "(B)V", line = 131)
    public final void method59(byte arg0) {
        field5966++;
        int var2 = 20 / ((27 - arg0) / 63);
    }

    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(ILqa;)V", line = 140)
    public final void method67(int arg0, class496 arg1) {
        field5949++;
        int var3 = 59 / ((59 - arg0) / 60);
    }

    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IIB)I", line = 151)
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(I)I", line = 165)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IBLns;I)Lse;", line = 176)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IIILqa;)Z", line = 198)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(ILpi;)V", line = 209)
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(B)Z", line = 228)
    ...
    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "(IIIIILjo;)V", line = 240)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(I)I", line = 250)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Lqa;I)Lpj;", line = 262)
    public final class507 method51(class496 arg0, int arg1) {
        field5956++;
        return arg1 == -150 ? null : null;
    }

    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(BLqa;)V", line = 274)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(B)I", line = 284)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(BLqa;)V", line = 296)
    ...
    @OriginalMember(owner = "client!wb", name = "h", descriptor = "(I)V", line = 309)
