...
public class class392 extends class187 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IZ)V", line = 16)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Z)V", line = 26)
    ...
    @OriginalMember(owner = "client!he", name = "d", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IBLqk;)V", line = 60)
    ...
    @OriginalMember(owner = "client!he", name = "<init>", descriptor = "(Lhk;Lol;)V", line = 80)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(ZB)V", line = 107)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IZI)V", line = 139)
