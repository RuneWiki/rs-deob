...
public class class392 extends class29 {
    ...
    @OriginalMember(owner = "client!cm", name = "f", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IILfp;)V", line = 18)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Lor;)V", line = 302)
