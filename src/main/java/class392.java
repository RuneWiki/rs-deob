...
public class class392 extends class24 {
    ...
    @OriginalMember(owner = "client!wu", name = "d", descriptor = "(B)Ljava/lang/Object;", line = 5)
    ...
    @OriginalMember(owner = "client!wu", name = "e", descriptor = "(B)Z", line = 15)
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "(Lst;Ljava/lang/Object;I)V", line = 24)
