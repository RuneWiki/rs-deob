...
public class class392 extends class338 {
    ...
    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "()V", line = 3)
    public class392() {
    }

    @OriginalMember(owner = "client!o", name = "a", descriptor = "(BLfd;)Z", line = 6)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IIIIIBIIII)V", line = 80)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(II)I", line = 155)
    public static int method2441(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!o", name = "d", descriptor = "(I)V", line = 166)
    ...
    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "(J)V", line = 187)
