...
public class class392 extends class777 {
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Lha;J)V", line = 16)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Lbj;IIIIIIIIIIIZZ)V", line = 190)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(JI)V", line = 209)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "()V", line = 605)
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(Lbj;IIIIIIIIIIIZZ)V", line = 616)
