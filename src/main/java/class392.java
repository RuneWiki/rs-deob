...
public class class392 extends class524 {
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(BIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(ZZ)Z", line = 107)
    public static boolean method2466(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(B)Lad;", line = 115)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IBLin;)Lmi;", line = 126)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(BLjava/lang/Object;Lwea;)V", line = 155)
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(Lsd;Lec;IIIIIIIIIIIIII)V", line = 186)
