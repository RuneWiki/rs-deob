...
public class class392 extends class735 {
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Lle;Lqj;IIIIIIIIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ljava/lang/String;IILjava/lang/String;)I", line = 12)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(B)Lmha;", line = 152)
    public final class419 method112(byte arg0) {
        field5472++;
        return arg0 == 62 ? class565.field7433 : null;
    }

    @OriginalMember(owner = "client!ml", name = "b", descriptor = "(I)V", line = 163)
