...
public class class291 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IIIIILri;)Lpo;", line = 38)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(II)I", line = 71)
    ...
    @OriginalMember(owner = "client!vc", name = "b", descriptor = "(II)Lld;", line = 83)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IZ)V", line = 114)
    ...
    @OriginalMember(owner = "client!vc", name = "b", descriptor = "(B)V", line = 124)
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Lkr;ILok;)V", line = 146)
