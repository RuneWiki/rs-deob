...
public class class291 extends class339 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(CB)I", line = 8)
    ...
    @OriginalMember(owner = "client!co", name = "b", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lio;I)V", line = 69)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(CI)Z", line = 106)
    ...
    @OriginalMember(owner = "client!co", name = "b", descriptor = "(CI)I", line = 151)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IILio;)V", line = 183)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Z)V", line = 247)
