...
public class class291 {
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(ILdn;Ldn;)V", line = 29)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IB)Lnk;", line = 55)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 88)
