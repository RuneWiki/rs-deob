...
public class class291 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IIIIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IIIIFIZI)[I", line = 26)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Z)V", line = 51)
