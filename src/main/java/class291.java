...
public class class291 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(BILya;)Z")
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(I)Lkf;")
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(I[Lad;IIII)V")
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(IIIIILya;IIII)V")
