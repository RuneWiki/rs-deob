...
public class class291 extends class174 implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    @OriginalMember(owner = "client!vja", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 5)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method1854(arg0.getX(), (byte) -84, arg0.getY());
    }

    @OriginalMember(owner = "client!vja", name = "b", descriptor = "(Z)Lhl;", line = 12)
    ...
    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!vja", name = "d", descriptor = "(B)I", line = 44)
    public final int method1326(byte arg0) {
        int var2 = -11 / ((62 - arg0) / 34);
        return this.field4006;
    }

    @OriginalMember(owner = "client!vja", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 54)
    ...
    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;Z)I", line = 78)
    ...
    @OriginalMember(owner = "client!vja", name = "c", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(IIIII)V", line = 116)
    ...
    @OriginalMember(owner = "client!vja", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 135)
    ...
    @OriginalMember(owner = "client!vja", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 148)
    ...
    @OriginalMember(owner = "client!vja", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 158)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method1854(arg0.getX(), (byte) -84, arg0.getY());
    }

    @OriginalMember(owner = "client!vja", name = "b", descriptor = "(I)Z", line = 165)
    ...
    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 175)
    ...
    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(IBI)V", line = 189)
    ...
    @OriginalMember(owner = "client!vja", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 205)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        this.method1854(arg0.getX(), (byte) -84, arg0.getY());
    }

    @OriginalMember(owner = "client!vja", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 212)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.method1854(arg0.getX(), (byte) -84, arg0.getY());
    }

    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(Z)Z", line = 222)
    ...
    @OriginalMember(owner = "client!vja", name = "b", descriptor = "(B)I", line = 232)
    ...
    @OriginalMember(owner = "client!vja", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 310)
    public class291(Component arg0, boolean arg1) {
        this.method1853(6, arg0);
        this.field4013 = arg1;
    }

    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(I)Z", line = 247)
    ...
    @OriginalMember(owner = "client!vja", name = "d", descriptor = "(I)V", line = 257)
    ...
    @OriginalMember(owner = "client!vja", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 283)
