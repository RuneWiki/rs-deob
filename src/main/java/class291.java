...
public abstract class class291 {
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Z)Lnaa;")
    ...
    @OriginalMember(owner = "client!jfa", name = "d", descriptor = "(I)Ljm;")
    ...
    @OriginalMember(owner = "client!jfa", name = "e", descriptor = "(I)Lts;")
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Lse;I)Z")
    ...
    @OriginalMember(owner = "client!jfa", name = "h", descriptor = "(I)Lau;")
