...
public class class291 extends class672 implements class484 {
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!gf", name = "g", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!gf", name = "c", descriptor = "(Z)Z", line = 36)
    ...
    @OriginalMember(owner = "client!gf", name = "k", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(Z)I", line = 58)
    public final int method916(boolean arg0) {
        ++field4248;
        return !arg0 ? -127 : this.field4262.method3811((byte) 110);
    }

    @OriginalMember(owner = "client!gf", name = "d", descriptor = "(Z)Z", line = 69)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(B)Z", line = 81)
    ...
    @OriginalMember(owner = "client!gf", name = "c", descriptor = "(ILha;)V", line = 91)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IILqe;Lbr;Lgj;Lha;III)V", line = 113)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Z)I", line = 157)
    ...
    @OriginalMember(owner = "client!gf", name = "f", descriptor = "(I)Z", line = 173)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Lha;I)Lmaa;", line = 185)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ILmi;)V", line = 231)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(I)I", line = 243)
    public final int method1483(int arg0) {
        ++field4274;
        return arg0 != 24853 ? 88 : this.field4262.field9332;
    }

    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ILha;)V", line = 254)
    ...
    @OriginalMember(owner = "client!gf", name = "e", descriptor = "(I)I", line = 265)
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(Lha;Lkv;IIIIIZIIIIIII)V", line = 276)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(Lha;I)Lrn;", line = 286)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(I)V", line = 297)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IIILha;)Z", line = 311)
    ...
    @OriginalMember(owner = "client!gf", name = "i", descriptor = "(B)V", line = 330)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(BLha;)V", line = 340)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ZLje;IIILha;I)V", line = 359)
