...
public class class291 {
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(ILjava/lang/String;)J")
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(II)Lpba;")
    ...
    @OriginalMember(owner = "client!gga", name = "<init>", descriptor = "(Lsaa;ILfp;)V")
