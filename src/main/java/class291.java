...
public class class291 extends class315 {
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!ej", name = "d", descriptor = "()I", line = 25)
    public final int method202() {
        return this.field4399.field1874;
    }

    @OriginalMember(owner = "client!ej", name = "b", descriptor = "()I", line = 28)
    public final int method208() {
        return this.field4399.field1873;
    }

    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "(Lse;IIII)V", line = 504)
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "(Lse;II[III)V", line = 591)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IIIIII)V", line = 65)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IIIII)V", line = 69)
    ...
    @OriginalMember(owner = "client!ej", name = "b", descriptor = "(IIIIIII)V", line = 115)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IIIIIII)V", line = 213)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(FFFFFFIII)V", line = 347)
    ...
    @OriginalMember(owner = "client!ej", name = "e", descriptor = "()V", line = 408)
    ...
    @OriginalMember(owner = "client!ej", name = "c", descriptor = "()I", line = 417)
    public final int method207() {
        return this.field4399.field1874 + this.field4400 + this.field4403;
    }

    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IILsf;II)V", line = 427)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "()I", line = 481)
    public final int method199() {
        return this.field4399.field1873 + this.field4397 + this.field4396;
    }

    @OriginalMember(owner = "client!ej", name = "b", descriptor = "(IIII)V", line = 495)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(FFFFFFLsf;II)V", line = 512)
