...
public class class291 extends class30 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IIZIII)I", line = 16)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "()V", line = 74)
    public class291() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ve", name = "e", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(Z)V", line = 120)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Ljg;II)V", line = 131)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IB)[I", line = 148)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(BI)[[I", line = 182)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ZIIII)V", line = 229)
