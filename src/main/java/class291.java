...
public class class291 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "([IIII[Ljava/lang/Object;)V", line = 101)
