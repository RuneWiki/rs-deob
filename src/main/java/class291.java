...
public class class291 extends class98 {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;II)I", line = 4)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(ILdg;I)V", line = 126)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(ILjava/awt/Component;)Lji;", line = 139)
    ...
    @OriginalMember(owner = "client!is", name = "e", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(IIIIIIZ)V", line = 395)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(BLtq;Lae;)V", line = 422)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(IBILfj;III)V", line = 446)
    ...
    @OriginalMember(owner = "client!is", name = "f", descriptor = "(I)V", line = 457)
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "()V", line = 468)
    public class291() {
        super(1, false);
    }

    @OriginalMember(owner = "client!is", name = "a", descriptor = "(II)[I", line = 472)
    ...
    @OriginalMember(owner = "client!is", name = "b", descriptor = "(II)[[I", line = 508)
