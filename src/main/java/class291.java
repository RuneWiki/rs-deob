...
public class class291 extends class200 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IB)Z", line = 7)
    public final boolean method1837(int arg0, byte arg1) {
        field4147++;
        return arg1 == 84 ? this.field4143[arg0].field2844 : true;
    }

    @OriginalMember(owner = "client!wg", name = "e", descriptor = "(I)Z", line = 21)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(II)Z", line = 119)
    ...
    @OriginalMember(owner = "client!wg", name = "f", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(I)V", line = 153)
    public class291(int arg0) {
        this.field4142 = arg0;
    }

    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(II)Z", line = 162)
