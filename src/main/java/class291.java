...
public class class291 {
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(IIIIIBIIII)V", line = 21)
    ...
    @OriginalMember(owner = "client!sfa", name = "toString", descriptor = "()Ljava/lang/String;", line = 98)
    public final String toString() {
        field3622++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!sfa", name = "b", descriptor = "(I)Z", line = 106)
