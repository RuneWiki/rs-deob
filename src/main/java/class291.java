...
public class class291 extends class497 {
    ...
    @OriginalMember(owner = "client!qb", name = "c", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(ZI)V", line = 100)
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(ILpp;)V", line = 131)
    public class291(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Lpp;)V", line = 134)
    public class291(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(II)V", line = 139)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(BI)I", line = 150)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(I)I", line = 163)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IIIII)V", line = 174)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(I)I", line = 192)
