...
public class class291 extends class24 {
    ...
    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(IILvq;)V")
    ...
    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(ILjp;)V")
    ...
    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(Lke;I)V")
