...
public class class291 extends class212 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(BLva;III)V", line = 9)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(Z)V", line = 173)
    ...
    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(II[I[I)V", line = 182)
    public class291(int arg0, int arg1, int[] arg2, int[] arg3) {
        this.field4384 = arg3;
        this.field4386 = arg2;
    }

    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(II)V", line = 203)
