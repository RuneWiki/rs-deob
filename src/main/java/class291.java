...
public class class291 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(II)I", line = 23)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IBI)V", line = 30)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IIIIIII)V", line = 52)
