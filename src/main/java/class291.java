...
public class class291 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 35)
    public class291(Throwable arg0, String arg1) {
        this.field4164 = arg1;
        this.field4171 = arg0;
    }

    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IC)C", line = 45)
