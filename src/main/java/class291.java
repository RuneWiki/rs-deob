...
public class class291 extends class10 implements class65 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Llca;IIZIIII[B)V")
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(Ltb;Llca;Lig;II)V")
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(Ltb;Llca;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Lgaa;I)V")
    ...
    @OriginalMember(owner = "client!db", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(Ltb;IIZ[III)V")
