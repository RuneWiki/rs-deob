...
public class class291 extends class486 implements class560 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IIIIII)V", line = 70)
    ...
    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "()V", line = 76)
    public class291() {
        this.method2460();
    }

    @OriginalMember(owner = "client!ja", name = "b", descriptor = "(III)V", line = 80)
    public final void method2480(int arg0, int arg1, int arg2) {
        this.method2451(this.nativeid, arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!ja", name = "finalize", descriptor = "()V", line = 86)
