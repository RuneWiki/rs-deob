...
public class class291 {
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(B)V", line = 9)
    public static void method1834(byte arg0) {
        field4252 = null;
        int var1 = 11 % ((arg0 + 30) / 49);
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!l", name = "b", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!l", name = "c", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!l", name = "d", descriptor = "(I)I", line = 92)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(BIIIZ)Lfu;", line = 103)
    ...
    @OriginalMember(owner = "client!l", name = "e", descriptor = "(I)I", line = 146)
    public final int method1840(int arg0) {
        field4256++;
        return arg0 < 63 ? 8 : this.field4253.method252(false) + this.field4259.method252(false);
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(BLed;Z)V", line = 160)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IZ)V", line = 227)
    ...
    @OriginalMember(owner = "client!l", name = "f", descriptor = "(I)Z", line = 255)
    ...
    @OriginalMember(owner = "client!l", name = "b", descriptor = "(B)Z", line = 266)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IBII)Z", line = 543)
    ...
    @OriginalMember(owner = "client!l", name = "c", descriptor = "(B)V", line = 594)
    ...
    @OriginalMember(owner = "client!l", name = "d", descriptor = "(B)Z", line = 606)
    ...
    @OriginalMember(owner = "client!l", name = "g", descriptor = "(I)V", line = 618)
