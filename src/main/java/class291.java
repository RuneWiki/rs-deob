...
public class class291 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(ILjp;Lcw;BLec;Lza;Lwc;Lmt;IIILwn;)Le;")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Lcw;III)V")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IILnf;)V")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IIILza;Lec;IIIILjp;BLcw;)Le;")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Lcw;IIILjp;ILjp;Lwn;[Lpp;ILls;Lwc;ZIILec;Lza;Lmt;I)Le;")
