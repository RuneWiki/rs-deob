...
public class class291 extends class204 {
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(ILfs;)V", line = 3)
    public class291(int arg0, class607 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(B)I", line = 7)
    public final int method1929(byte arg0) {
        ++field4281;
        return arg0 != -98 ? -46 : super.field2852;
    }

    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(B)I", line = 18)
    ...
    @OriginalMember(owner = "client!ou", name = "d", descriptor = "(II)V", line = 46)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(II)I", line = 59)
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(Lfs;)V", line = 69)
