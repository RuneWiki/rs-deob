...
public class class291 extends class750 {
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(B)Lsaa;")
    ...
    @OriginalMember(owner = "client!gga", name = "d", descriptor = "(I)Llda;")
    ...
    @OriginalMember(owner = "client!gga", name = "<init>", descriptor = "(Lgt;IIIIII)V")
