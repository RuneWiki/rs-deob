...
public class class291 extends class397 {
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "()V", line = 200)
    public class291() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ti", name = "c", descriptor = "(Z)I", line = 23)
    ...
    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(II)[I", line = 115)
    ...
    @OriginalMember(owner = "client!ti", name = "f", descriptor = "(III)V", line = 150)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IBLae;)V", line = 163)
