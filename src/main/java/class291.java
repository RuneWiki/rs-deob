...
public class class291 extends class11 implements class338 {
    ...
    @OriginalMember(owner = "client!ad", name = "c", descriptor = "(I)I", line = 5)
    public final int method345(int arg0) {
        field3812++;
        return arg0 == -1736 ? 0 : -82;
    }

    @OriginalMember(owner = "client!ad", name = "d", descriptor = "(I)Z", line = 17)
    public final boolean method338(int arg0) {
        field3813++;
        return arg0 > -8 ? false : false;
    }

    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(I)V", line = 35)
    public final void method342(int arg0) {
        field3810++;
        int var2 = -98 / ((arg0 - 56) / 52);
    }

    @OriginalMember(owner = "client!ad", name = "f", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(IILqa;I)Z", line = 61)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lqa;Z)V", line = 72)
    ...
    @OriginalMember(owner = "client!ad", name = "b", descriptor = "(I)I", line = 82)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ILqa;)V", line = 94)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(BLqa;I)Lc;", line = 105)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lqa;I)V", line = 117)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(FIIF[BFLv;FIZIIF)V", line = 129)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Ldc;IIIIIZ)V", line = 149)
    ...
    @OriginalMember(owner = "client!ad", name = "b", descriptor = "(ILqa;)Lfm;", line = 201)
    public final class514 method339(int arg0, class162 arg1) {
        field3811++;
        return arg0 == 9124 ? null : null;
    }

    @OriginalMember(owner = "client!ad", name = "c", descriptor = "(B)I", line = 213)
    ...
    @OriginalMember(owner = "client!ad", name = "<init>", descriptor = "(IIIIILvl;)V", line = 224)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(B)I", line = 234)
