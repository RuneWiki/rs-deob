...
public class class291 extends class465 {
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(BLki;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 15)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(CI)B", line = 27)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(IILic;)Lsh;", line = 155)
    ...
    @OriginalMember(owner = "client!ad", name = "<init>", descriptor = "(Lvs;Ljava/lang/Object;I)V", line = 173)
    public class291(class416 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field4177 = arg1;
    }

    @OriginalMember(owner = "client!ad", name = "c", descriptor = "(B)Z", line = 184)
    ...
    @OriginalMember(owner = "client!ad", name = "g", descriptor = "(I)V", line = 197)
