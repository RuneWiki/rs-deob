...
public abstract class class291 {
    ...
    @OriginalMember(owner = "client!ij", name = "g", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ZLdw;Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Lya;Lij;IIIII)V", line = 201)
