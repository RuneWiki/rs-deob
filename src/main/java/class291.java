...
public class class291 {
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Luk;I)V")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Lgl;II)V")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Lci;I)V")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Luk;)V")
