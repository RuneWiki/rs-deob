...
public class class291 extends class354 {
    ...
    @OriginalMember(owner = "client!ad", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ad", name = "d", descriptor = "(Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!ad", name = "d", descriptor = "(B)V", line = 58)
    public static void method1808(byte arg0) {
        int var1 = 64 % ((23 - arg0) / 36);
        field4170 = null;
    }

    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ILti;I)V", line = 69)
    ...
    @OriginalMember(owner = "client!ad", name = "<init>", descriptor = "()V", line = 268)
    public class291() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ILjava/lang/String;BII)V", line = 143)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(BI)[[I", line = 274)
