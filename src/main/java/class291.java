...
public abstract class class291 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!jc", name = "providesignlink", descriptor = "(Lhf;)V", line = 4)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(BLjava/lang/String;)V", line = 21)
    ...
    @OriginalMember(owner = "client!jc", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 49)
    public final void windowClosing(WindowEvent arg0) {
        this.destroy();
        field4436++;
    }

    @OriginalMember(owner = "client!jc", name = "run", descriptor = "()V", line = 59)
    ...
    @OriginalMember(owner = "client!jc", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 175)
    public final void windowActivated(WindowEvent arg0) {
        field4411++;
    }

    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(B)V", line = 182)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(IBIII)V", line = 214)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ZB)V", line = 266)
    ...
    @OriginalMember(owner = "client!jc", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 345)
    ...
    @OriginalMember(owner = "client!jc", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 363)
    public final void windowDeactivated(WindowEvent arg0) {
        field4418++;
    }

    @OriginalMember(owner = "client!jc", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 371)
    public final void focusLost(FocusEvent arg0) {
        class116.field1957 = false;
        field4432++;
    }

    @OriginalMember(owner = "client!jc", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 379)
    ...
    @OriginalMember(owner = "client!jc", name = "c", descriptor = "(I)V", line = 396)
    ...
    @OriginalMember(owner = "client!jc", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 449)
    public final void windowOpened(WindowEvent arg0) {
        field4419++;
    }

    @OriginalMember(owner = "client!jc", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 458)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(B)Z", line = 467)
    ...
    @OriginalMember(owner = "client!jc", name = "e", descriptor = "(I)V", line = 505)
    ...
    @OriginalMember(owner = "client!jc", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 518)
    public final void windowDeiconified(WindowEvent arg0) {
        field4409++;
    }

    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(BLha;)Llr;", line = 532)
    ...
    @OriginalMember(owner = "client!jc", name = "start", descriptor = "()V", line = 547)
    ...
    @OriginalMember(owner = "client!jc", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 558)
    public final void windowIconified(WindowEvent arg0) {
        field4406++;
    }

    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(BIIZLjava/lang/String;III)V", line = 566)
    ...
    @OriginalMember(owner = "client!jc", name = "g", descriptor = "(I)V", line = 609)
    ...
    @OriginalMember(owner = "client!jc", name = "h", descriptor = "(I)V", line = 659)
    ...
    @OriginalMember(owner = "client!jc", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 699)
    ...
    @OriginalMember(owner = "client!jc", name = "stop", descriptor = "()V", line = 722)
    ...
    @OriginalMember(owner = "client!jc", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 733)
    ...
    @OriginalMember(owner = "client!jc", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 755)
    ...
    @OriginalMember(owner = "client!jc", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 774)
    public final void update(Graphics arg0) {
        field4422++;
        this.paint(arg0);
    }

    @OriginalMember(owner = "client!jc", name = "destroy", descriptor = "()V", line = 782)
    ...
    @OriginalMember(owner = "client!jc", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 797)
