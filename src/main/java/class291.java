...
public class class291 {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ZLlt;)V")
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Lfd;Z)Lrw;")
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(B)Llt;")
