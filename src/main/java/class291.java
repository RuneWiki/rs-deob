...
public class class291 extends class176 {
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(Ldba;Lpa;IIIIIIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!md", name = "c", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(B)Lib;", line = 30)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ILjava/lang/String;I)Z", line = 46)
