...
public class class291 {
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IZ)V", line = 18)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lil;II)V", line = 52)
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lil;III)V", line = 359)
