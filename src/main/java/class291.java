...
public class class291 extends class518 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IIIBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!db", name = "finalize", descriptor = "()V", line = 34)
    protected final void finalize() {
        this.method1642(-1);
        field3732++;
    }

    @OriginalMember(owner = "client!db", name = "a", descriptor = "([BIII)I", line = 43)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(III[B)V", line = 55)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(III)Z", line = 86)
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 99)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(II)Z", line = 112)
    ...
    @OriginalMember(owner = "client!db", name = "b", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!db", name = "b", descriptor = "(II)V", line = 136)
