...
public class class291 extends class409 {
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IIIIIIIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(III)V", line = 35)
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "(IIIIIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(IBI)V", line = 68)
    ...
    @OriginalMember(owner = "client!fs", name = "c", descriptor = "(I)Lcl;", line = 87)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(II)V", line = 115)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(BIII)I", line = 127)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IBI)V", line = 146)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Ljava/awt/Component;B)Ltu;", line = 176)
    ...
    @OriginalMember(owner = "client!fs", name = "d", descriptor = "(I)V", line = 193)
