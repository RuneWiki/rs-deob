...
public class class291 {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(BLnj;)I")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Lra;ZLra;)V")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Lnf;I)V")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Lnf;IB)V")
