...
public class class291 {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IZ)Lfd;")
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IIIIIIILpe;III)Z")
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(ZLcr;Ljava/lang/String;Z)V")
    ...
    @OriginalMember(owner = "client!eo", name = "<init>", descriptor = "(Lci;ILg;Lg;)V")
