...
public class class696 {
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(I[B)[B", line = 10)
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "()V", line = 38)
    public class696() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(IIIIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Lwv;II)V", line = 63)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Lji;[BB)V", line = 94)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 124)
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(III)V", line = 158)
