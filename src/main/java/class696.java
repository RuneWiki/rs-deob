...
public class class696 {
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(II)V", line = 48)
    ...
    @OriginalMember(owner = "client!jha", name = "b", descriptor = "(II)Ldba;", line = 66)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(IZ)V", line = 98)
    ...
    @OriginalMember(owner = "client!jha", name = "<init>", descriptor = "(Lms;ILwu;Lwu;)V", line = 148)
