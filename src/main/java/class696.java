...
public class class696 extends class60 implements class534 {
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "()Lkaa;")
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(IIIIII)Lom;")
    public final class374 method503(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([IIIIIZ)Lpga;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lof;Z)V")
    ...
    @OriginalMember(owner = "client!oa", name = "q", descriptor = "()Lql;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIZ)Lpga;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lpk;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lql;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lom;Lom;FLom;)Lom;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[Lraa;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lom;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ldh;IIII)Lka;")
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "()Lql;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lbi;Ldk;)Lpk;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lhia;[Lfg;Z)Lda;")
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(II)Lbi;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II)Ldk;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZ)Lpga;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lfg;Z)Lpga;")
    ...
    @OriginalMember(owner = "client!oa", name = "s", descriptor = "()Lql;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lof;I)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIF)Lraa;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lof;)V")
