...
public class class696 implements class161 {
    ...
    @OriginalMember(owner = "client!sea", name = "b", descriptor = "(I)Z", line = 9)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(Z)I", line = 30)
    public final int method1564(boolean arg0) {
        return arg0 ? this.field9587 : -105;
    }

    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!sea", name = "c", descriptor = "(I)I", line = 57)
    public final int method3921(int arg0) {
        return arg0 == -1611 ? this.field9588 : 65;
    }

    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(Ljaclib/memory/Source;BII)Z", line = 68)
    ...
    @OriginalMember(owner = "client!sea", name = "<init>", descriptor = "(Ltg;Z)V", line = 143)
    public class696(class229 arg0, boolean arg1) {
        this.field9585 = arg0;
        this.field9584 = arg1;
    }

    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(III)Z", line = 87)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;", line = 121)
