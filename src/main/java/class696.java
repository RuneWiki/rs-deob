...
public class class696 extends class136 {
    ...
    @OriginalMember(owner = "client!hda", name = "<init>", descriptor = "(Llj;IIZ[[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(IIIII)V", line = 48)
    ...
    @OriginalMember(owner = "client!hda", name = "<init>", descriptor = "(Llj;IIZ[[BI)V", line = 68)
    ...
    @OriginalMember(owner = "client!hda", name = "<init>", descriptor = "(Llj;II)V", line = 91)
    ...
    @OriginalMember(owner = "client!hda", name = "f", descriptor = "(B)V", line = 108)
    ...
    @OriginalMember(owner = "client!hda", name = "d", descriptor = "(I)V", line = 133)
