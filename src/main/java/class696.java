...
public class class696 extends class60 implements class535 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([IIIIIZ)Liea;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[Llaa;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "r", descriptor = "()Lnia;")
    ...
    @OriginalMember(owner = "client!oa", name = "n", descriptor = "()Lpda;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lnl;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lmda;Lmda;FLmda;)Lmda;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZ)Liea;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lpda;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lfl;I)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Llga;IIII)Lka;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIZ)Liea;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIF)Llaa;")
    ...
    @OriginalMember(owner = "client!oa", name = "y", descriptor = "()Lpda;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II)Llda;")
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(II)Lhca;")
    public final class492 method523(int arg0, int arg1) {
        return this.method551(arg0, arg1, false);
    }

    @OriginalMember(owner = "client!oa", name = "s", descriptor = "()Lpda;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lfl;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(IIIIII)Lmda;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lfl;Z)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lhb;Z)Liea;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljl;[Lhb;Z)Lda;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lhca;Llda;)Lnl;")
