...
public class class696 extends class294 implements class557 {
    ...
    @OriginalMember(owner = "client!t", name = "finalize", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(Loa;Lya;II[[I[[IIII)V", line = 12)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lqm;[I)V", line = 22)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(II)V", line = 26)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IIIIIII[[Z)V", line = 34)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lr;IIIIZ)Z", line = 39)
    public final boolean method1905(class194 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return true;
    }

    @OriginalMember(owner = "client!t", name = "a", descriptor = "(III[[ZZII)V", line = 47)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(III[[ZZI)V", line = 95)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 146)
