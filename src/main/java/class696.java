...
public class class696 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IB)V", line = 6)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(BLek;)Lpga;", line = 43)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!kq", name = "toString", descriptor = "()Ljava/lang/String;", line = 83)
    public final String toString() {
        field9880++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(II)V", line = 91)
