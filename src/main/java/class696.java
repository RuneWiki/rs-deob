...
public class class696 extends class498 {
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(Lr;III)Z")
    ...
    @OriginalMember(owner = "client!lv", name = "c", descriptor = "(Lr;I)Lwj;")
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(BLrn;)V")
    ...
    @OriginalMember(owner = "client!lv", name = "d", descriptor = "(Lr;I)Llf;")
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(Lr;Z)V")
