...
public class class696 {
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IIII)Lvi;", line = 6)
    ...
    @OriginalMember(owner = "client!uo", name = "toString", descriptor = "()Ljava/lang/String;", line = 37)
    public final String toString() {
        field9793++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IBLlea;Ljava/lang/String;)Lhu;", line = 46)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(II)V", line = 76)
