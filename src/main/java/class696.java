...
public class class696 extends class320 {
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(I)Ljava/net/Socket;", line = 17)
    ...
    @OriginalMember(owner = "client!hda", name = "httpProxyConnect", descriptor = "(Ljava/lang/String;ILjava/lang/String;)Ljava/net/Socket;", line = 85)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Ljava/net/Proxy;I)Ljava/net/Socket;", line = 159)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 191)
