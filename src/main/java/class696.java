...
public class class696 extends class602 implements class196 {
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "(Ldga;Lhh;II[BII)V")
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Lhh;I[BIIIIII)V")
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "(Ldga;Lhh;Lon;II)V")
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "(Ldga;Lhh;II[FII)V")
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "(Ldga;II[III)V")
