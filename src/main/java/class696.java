...
public class class696 {
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!hfa", name = "toString", descriptor = "()Ljava/lang/String;", line = 46)
    public final String toString() {
        field9839++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!hfa", name = "<init>", descriptor = "(II)V", line = 61)
    public class696(int arg0, int arg1) {
        this.field9838 = arg0;
    }

    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(BLl;II)V", line = 71)
