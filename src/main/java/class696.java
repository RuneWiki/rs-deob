...
public class class696 extends class391 {
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(BLpaa;)I")
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(ZBLde;)V")
    ...
    @OriginalMember(owner = "client!hda", name = "M", descriptor = "(Lq;)V")
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(ILq;)V")
