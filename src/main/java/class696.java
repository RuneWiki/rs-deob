...
public class class696 extends class294 implements class558 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(III[[ZZI)V", line = 7)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lr;IIIIZ)Z", line = 55)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Luf;[I)V", line = 72)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 78)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(III[[ZZII)V", line = 194)
