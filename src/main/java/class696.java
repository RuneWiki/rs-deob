...
public class class696 {
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(Lr;Ljn;I)V", line = 9)
    ...
    @OriginalMember(owner = "client!gfa", name = "toString", descriptor = "()Ljava/lang/String;", line = 140)
    public final String toString() {
        field9862++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(Ln;Z)Ln;", line = 149)
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "([Lub;II)V", line = 166)
    ...
    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "(IIII)V", line = 204)
