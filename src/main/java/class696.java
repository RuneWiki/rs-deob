...
public class class696 extends class362 {
    ...
    @OriginalMember(owner = "client!gba", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(II)[I", line = 27)
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "()V", line = 86)
    public class696() {
        super(0, true);
    }

    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Lfca;II)V", line = 100)
