...
public class class782 extends class629 implements class602 {
    ...
    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(ILha;I)Lka;")
    ...
    @OriginalMember(owner = "client!fja", name = "c", descriptor = "(Lha;B)Lpia;")
    ...
    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(ILfq;BIILha;Z)V")
    ...
    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(III)Lvda;")
    ...
    @OriginalMember(owner = "client!fja", name = "l", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(ZILha;I)Lsw;")
    ...
    @OriginalMember(owner = "client!fja", name = "e", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!fja", name = "d", descriptor = "(Lha;B)Lln;")
    ...
    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(ILjava/awt/Canvas;BLd;)Lha;")
    ...
    @OriginalMember(owner = "client!fja", name = "b", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!fja", name = "<init>", descriptor = "(Lha;Llp;IIIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!fja", name = "a", descriptor = "(ILha;II)Z")
