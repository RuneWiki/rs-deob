...
public class class9 {
    ...
    @OriginalMember(owner = "client!CLCMCMIN", name = "d", descriptor = "LXNCSKJMM;")
    public class67 field88 = new class67();

    @OriginalMember(owner = "client!CLCMCMIN", name = "e", descriptor = "LXNCSKJMM;")
    ...
    @OriginalMember(owner = "client!CLCMCMIN", name = "a", descriptor = "(LXNCSKJMM;)V")
    ...
    @OriginalMember(owner = "client!CLCMCMIN", name = "a", descriptor = "(ILXNCSKJMM;)V")
    ...
    @OriginalMember(owner = "client!CLCMCMIN", name = "a", descriptor = "()LXNCSKJMM;")
    ...
    @OriginalMember(owner = "client!CLCMCMIN", name = "b", descriptor = "()LXNCSKJMM;")
    ...
    @OriginalMember(owner = "client!CLCMCMIN", name = "a", descriptor = "(B)LXNCSKJMM;")
    ...
    @OriginalMember(owner = "client!CLCMCMIN", name = "a", descriptor = "(I)LXNCSKJMM;")
    ...
    @OriginalMember(owner = "client!CLCMCMIN", name = "b", descriptor = "(I)LXNCSKJMM;")
