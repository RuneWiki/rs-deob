...
public class class9 extends class544 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(BLjava/awt/Component;)Lud;", line = 3)
    ...
    @OriginalMember(owner = "client!ff", name = "c", descriptor = "(B)Z", line = 32)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!ff", name = "d", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(III)Z", line = 78)
