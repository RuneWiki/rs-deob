...
public class class9 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Lfaa;IJ)V", line = 12)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(JI)Lfaa;", line = 32)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Z)Lfaa;", line = 63)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(B)Lfaa;", line = 127)
    ...
    @OriginalMember(owner = "client!bc", name = "b", descriptor = "(B)I", line = 140)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(ILjd;II)V", line = 174)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Ljava/net/Socket;II)Lts;", line = 191)
    ...
    @OriginalMember(owner = "client!bc", name = "b", descriptor = "(I)Lfaa;", line = 202)
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "(I)V", line = 232)
    ...
    @OriginalMember(owner = "client!bc", name = "c", descriptor = "(I)I", line = 254)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(I[Lfaa;)I", line = 269)
