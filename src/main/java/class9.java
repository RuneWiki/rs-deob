...
public class class9 extends class246 {
    ...
    @OriginalMember(owner = "client!of", name = "d", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(Lkw;IIIZ[III)V", line = 18)
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(Lkw;IIIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(Lkw;IIIIIIZ)V", line = 53)
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(Lkw;IIIII[BI)V", line = 67)
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(Lkw;IIIIIZ)V", line = 84)
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(Lkw;IIII[I)V", line = 105)
    public class9(class346 arg0, int arg1, int arg2, int arg3, int arg4, int[] arg5) {
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(Lkw;IIII)V", line = 119)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(III)I", line = 140)
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(Lkw;IIIIZ[BI)V", line = 157)
