...
public class class9 implements class534 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Class;I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(I)I", line = 36)
    ...
    @OriginalMember(owner = "client!ff", name = "c", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(ILaj;BLaj;)V", line = 62)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(II)I", line = 81)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;Ljava/lang/Object;B)I", line = 95)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;I)Ljava/lang/Object;", line = 109)
    ...
    @OriginalMember(owner = "client!ff", name = "d", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(Z)V", line = 141)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IB)I", line = 165)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IJ)Z", line = 181)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(I)I", line = 194)
    public final int method79(int arg0) {
        field131++;
        return arg0 == -4076 ? 0 : -88;
    }

    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(ZZ)V", line = 206)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(B)V", line = 410)
