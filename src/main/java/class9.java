...
public class class9 {
    ...
    @OriginalMember(owner = "client!CIVOPMKV", name = "p", descriptor = "LWMYPWVZI;")
    ...
    @OriginalMember(owner = "client!CIVOPMKV", name = "h", descriptor = "LZKWMIVTX;")
    public class71 field140;

    @OriginalMember(owner = "client!CIVOPMKV", name = "d", descriptor = "[LCIVOPMKV;")
    public static class9[] field136;

    @OriginalMember(owner = "client!CIVOPMKV", name = "a", descriptor = "(LBYZSQZUF;Z)V")
    ...
    @OriginalMember(owner = "client!CIVOPMKV", name = "a", descriptor = "(ILIMUIZRAF;)V")
    ...
    @OriginalMember(owner = "client!CIVOPMKV", name = "a", descriptor = "()LYABPKWWG;")
