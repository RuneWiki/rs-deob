...
public class class9 extends class427 {
    ...
    @OriginalMember(owner = "client!lq", name = "d", descriptor = "()Lps;")
    public final class427 method36() {
        return (class427) this.field83.method420(false);
    }

    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lps;)V")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lav;)V")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lum;Lav;)V")
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(Lps;)V")
    public final synchronized void method44(class427 arg0) {
        arg0.method911(-52);
    }

    @OriginalMember(owner = "client!lq", name = "a", descriptor = "()Lps;")
