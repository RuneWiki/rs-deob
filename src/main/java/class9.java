...
public class class9 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(BI)Lpd;")
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IILjf;B)V")
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "(Llo;ILnl;)V")
