...
public class class9 {
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(IBIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(IIII[FI[FFIFIZ)V", line = 102)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(I)V", line = 167)
