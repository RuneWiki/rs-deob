...
public class class9 extends class5 {
    ...
    public class9(class15 arg0, String arg1, boolean arg2) {
    ...
    public void method40(String arg0, int arg1, int arg2, int arg3) {
        this.method39(arg0, arg1 - this.method38(arg0), arg2, arg3);
    }

    @OriginalMember(owner = "mapview!i", name = "c", descriptor = "(Ljava/lang/String;III)V")
    public void method41(String arg0, int arg1, int arg2, int arg3) {
        this.method39(arg0, arg1 - this.method38(arg0) / 2, arg2, arg3);
    }
    ...
    private void method42(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        int var7 = class5.field38 * arg2 + arg1;
        int var8 = class5.field38 - arg3;
        int var9 = 0;
        int var10 = 0;
        if (arg2 < class5.field40) {
            int var11 = class5.field40 - arg2;
            arg4 -= var11;
            arg2 = class5.field40;
            var10 += arg3 * var11;
            var7 += class5.field38 * var11;
        }
        if (arg2 + arg4 >= class5.field41) {
            arg4 -= arg2 + arg4 + 1 - class5.field41;
        }
        if (arg1 < class5.field42) {
            int var12 = class5.field42 - arg1;
            arg3 -= var12;
            arg1 = class5.field42;
            var10 += var12;
            var7 += var12;
        ...
        if (arg1 + arg3 >= class5.field43) {
            int var13 = arg1 + arg3 + 1 - class5.field43;
            arg3 -= var13;
            var9 += var13;
            var8 += var13;
        }
        if (arg3 > 0 && arg4 > 0) {
            this.method43(class5.field37, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }
