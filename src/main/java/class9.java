...
public class class9 extends class224 {
    ...
    @OriginalMember(owner = "client!ff", name = "d", descriptor = "()Lll;", line = 5)
    ...
    @OriginalMember(owner = "client!ff", name = "c", descriptor = "(I)V", line = 25)
    public static void method54(int arg0) {
        field123 = null;
        int var1 = -117 % (arg0 / 53);
    }

    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lej;II)V", line = 35)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "()Lll;", line = 74)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IBIZILr;)V", line = 94)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(II[IIBLej;)V", line = 158)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IIILcj;Lcj;)V", line = 224)
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "(Lod;)V", line = 305)
