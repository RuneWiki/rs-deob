...
public class class9 extends class90 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(BZ)V", line = 17)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(BICI)V", line = 94)
    ...
    @OriginalMember(owner = "client!ff", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 111)
    public final synchronized void focusLost(FocusEvent arg0) {
        this.method36((byte) -96, -1, '\u0000', 0);
        field84++;
    }

    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!ff", name = "c", descriptor = "(B)V", line = 212)
    ...
    @OriginalMember(owner = "client!ff", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 252)
    public final synchronized void keyPressed(KeyEvent arg0) {
        field80++;
        this.method43(0, arg0, 2);
    }

    @OriginalMember(owner = "client!ff", name = "c", descriptor = "(I)I", line = 264)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(BLjava/awt/Component;)V", line = 289)
    ...
    @OriginalMember(owner = "client!ff", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 316)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IIIIIII)V", line = 331)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(ILjava/awt/event/KeyEvent;I)V", line = 349)
    ...
    @OriginalMember(owner = "client!ff", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 386)
    public final void focusGained(FocusEvent arg0) {
        field92++;
    }

    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(B)Ljo;", line = 393)
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 471)
    public class9(Component arg0) {
        class17.method85(false);
        this.method41((byte) 4, arg0);
    }

    @OriginalMember(owner = "client!ff", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 411)
    public final synchronized void keyReleased(KeyEvent arg0) {
        this.method43(1, arg0, 2);
        field79++;
    }

    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IBIII)V", line = 419)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(B)V", line = 446)
