...
public class class9 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(III[B)V", line = 123)
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "(Lkd;Ler;Llk;IIIII)V", line = 337)
    ...
    @OriginalMember(owner = "client!ff", name = "c", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lpl;II)V", line = 170)
    ...
    @OriginalMember(owner = "client!ff", name = "d", descriptor = "(I)V", line = 187)
