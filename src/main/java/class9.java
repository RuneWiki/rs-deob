...
public class class9 implements Runnable {
    ...
    @OriginalMember(owner = "client!DUZSRFJE", name = "g", descriptor = "LAMTYETOI;")
    ...
    @OriginalMember(owner = "client!DUZSRFJE", name = "<init>", descriptor = "(LAMTYETOI;ZLjava/net/Socket;)V")
