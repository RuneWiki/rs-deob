...
public class class9 extends class541 {
    ...
    @OriginalMember(owner = "client!ff", name = "c", descriptor = "(I)F", line = 4)
    ...
    @OriginalMember(owner = "client!ff", name = "e", descriptor = "(I)J", line = 29)
    public final long method56(int arg0) {
        field119++;
        return arg0 == 1 ? this.field114 : 36L;
    }

    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(ILha;)Liea;", line = 45)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(BLjagtheora/ogg/OggPacket;)V", line = 68)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(B)Z", line = 142)
    public final boolean method59(byte arg0) {
        field108++;
        return arg0 >= -33 ? true : this.field123;
    }

    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 153)
    public class9(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ff", name = "f", descriptor = "(I)D", line = 164)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(BI)V", line = 176)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Z)V", line = 201)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(B)V", line = 236)
