...
public class class9 extends class172 implements class339 {
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(ZLr;)V")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(I[IILqi;)V")
    ...
    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "(Lr;Lbda;IIIIIZIIIIIII)V")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(BLr;)V")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(ZLr;)Log;")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IILr;I)Z")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(ZIBLr;Llo;II)V")
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(BLr;)V")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lr;I)Lsd;")
