...
public class class9 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lfda;[[BZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IZ)V", line = 77)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(II)Llt;", line = 96)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IIB)V", line = 124)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(B)V", line = 150)
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "(Lcda;ILkea;Lkea;)V", line = 193)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(I)V", line = 178)
