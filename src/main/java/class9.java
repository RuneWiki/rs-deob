...
public class class9 extends class297 {
    ...
    @OriginalMember(owner = "client!ff", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ff", name = "d", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "(I)V", line = 35)
    public class9(int arg0) {
        this.field144 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IIIIIIIZ)V", line = 43)
