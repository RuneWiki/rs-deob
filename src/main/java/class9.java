...
@OriginalClass("client!CUQKGTCO")
public class class9 {

    @OriginalMember(owner = "client!CUQKGTCO", name = "a", descriptor = "I")
    private int field558 = 34;

    @OriginalMember(owner = "client!CUQKGTCO", name = "f", descriptor = "[LAQBPXQWT;")
    private class2[] field563 = new class2[10];

    @OriginalMember(owner = "client!CUQKGTCO", name = "b", descriptor = "[LCUQKGTCO;")
    private static class9[] field559 = new class9[5000];

    @OriginalMember(owner = "client!CUQKGTCO", name = "c", descriptor = "[I")
    public static int[] field560 = new int[5000];

    @OriginalMember(owner = "client!CUQKGTCO", name = "g", descriptor = "I")
    private int field564;

    @OriginalMember(owner = "client!CUQKGTCO", name = "h", descriptor = "I")
    private int field565;

    @OriginalMember(owner = "client!CUQKGTCO", name = "e", descriptor = "LXQPFGONL;")
    private static class62 field562;

    @OriginalMember(owner = "client!CUQKGTCO", name = "d", descriptor = "[B")
    private static byte[] field561;

    @OriginalMember(owner = "client!CUQKGTCO", name = "<init>", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!CUQKGTCO", name = "a", descriptor = "(ZLXQPFGONL;)V")
    ...
    @OriginalMember(owner = "client!CUQKGTCO", name = "a", descriptor = "(III)LXQPFGONL;")
    ...
    @OriginalMember(owner = "client!CUQKGTCO", name = "a", descriptor = "(LXQPFGONL;I)V")
    ...
    @OriginalMember(owner = "client!CUQKGTCO", name = "a", descriptor = "(I)I")
    ...
    @OriginalMember(owner = "client!CUQKGTCO", name = "a", descriptor = "(IZ)LXQPFGONL;")
    ...
    @OriginalMember(owner = "client!CUQKGTCO", name = "b", descriptor = "(I)I")
