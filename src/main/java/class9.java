...
public class class9 extends class34 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ILmk;I)V")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lta;JIIIIIILat;)V")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lsv;II)V")
