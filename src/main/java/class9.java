...
public class class9 extends class11 {
    ...
    @OriginalMember(owner = "client!ff", name = "c", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(II)[[I", line = 17)
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "()V", line = 178)
    public class9() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(Z)V", line = 77)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lsi;II)V", line = 92)
    ...
    @OriginalMember(owner = "client!ff", name = "d", descriptor = "(II)[I", line = 135)
