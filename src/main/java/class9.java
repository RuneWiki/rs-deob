...
public class class9 extends class513 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(B)[Liv;", line = 8)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IBIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!ff", name = "c", descriptor = "(B)Lke;", line = 59)
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "(I)V", line = 100)
    public class9(int arg0) {
        this.field90 = arg0;
    }

    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IZ)V", line = 110)
