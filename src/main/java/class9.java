...
public class class9 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IZ)Lnk;")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IIBILlw;Lr;II)Lf;")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IIIIZIZILr;Llw;Lla;Lr;)Lf;")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "(Lgn;IZLfi;Lvo;Lvo;)V")
