...
public class class9 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IB)Lpha;")
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IIBZB)Lqga;")
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lij;BZ)V")
