...
public class class9 {
    ...
    @OriginalMember(owner = "client!DTFBSXNF", name = "d", descriptor = "LIYPTVTAD;")
    public class30 field622 = new class30();

    @OriginalMember(owner = "client!DTFBSXNF", name = "e", descriptor = "LIYPTVTAD;")
    ...
    @OriginalMember(owner = "client!DTFBSXNF", name = "a", descriptor = "(LIYPTVTAD;)V")
    ...
    @OriginalMember(owner = "client!DTFBSXNF", name = "a", descriptor = "()LIYPTVTAD;")
    ...
    @OriginalMember(owner = "client!DTFBSXNF", name = "b", descriptor = "()LIYPTVTAD;")
    ...
    @OriginalMember(owner = "client!DTFBSXNF", name = "a", descriptor = "(B)LIYPTVTAD;")
