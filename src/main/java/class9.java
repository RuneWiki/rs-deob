...
public class class9 extends class390 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ff", name = "m", descriptor = "(I)Z", line = 21)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lha;IZLga;IBI)V", line = 33)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lha;III)Z", line = 55)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(III)V", line = 107)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(ILha;)Ljda;", line = 201)
    ...
    @OriginalMember(owner = "client!ff", name = "f", descriptor = "(B)I", line = 330)
    ...
    @OriginalMember(owner = "client!ff", name = "l", descriptor = "(I)I", line = 351)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IZIIII)V", line = 372)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(Lha;I)Lhw;", line = 458)
    ...
    @OriginalMember(owner = "client!ff", name = "i", descriptor = "(B)Z", line = 469)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(I)I", line = 483)
    ...
    @OriginalMember(owner = "client!ff", name = "j", descriptor = "(I)Z", line = 504)
    public final boolean method35(int arg0) {
        ++field123;
        return arg0 > -65;
    }

    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(I)I", line = 517)
    ...
    @OriginalMember(owner = "client!ff", name = "c", descriptor = "(Lha;I)V", line = 538)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(CB)Z", line = 576)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IILha;)Z", line = 587)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lbb;I)V", line = 867)
