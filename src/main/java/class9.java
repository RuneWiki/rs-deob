...
public abstract class class9 {
    ...
    @OriginalMember(owner = "client!fp", name = "b", descriptor = "(IIIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(IIIIIBIIII)V", line = 40)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(B)V", line = 119)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Lat;I)V", line = 161)
    ...
    @OriginalMember(owner = "client!fp", name = "d", descriptor = "(IIIII)V", line = 194)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(IIIBI)V", line = 206)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(IIIIBI)V", line = 217)
    ...
    @OriginalMember(owner = "client!fp", name = "finalize", descriptor = "()V", line = 234)
    protected final void finalize() {
        this.method136(123);
        field114++;
    }

    @OriginalMember(owner = "client!fp", name = "e", descriptor = "(I)V", line = 245)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(ILge;I)V", line = 263)
    ...
    @OriginalMember(owner = "client!fp", name = "e", descriptor = "(IIIIII)V", line = 296)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(IIILic;Lgt;Ljava/awt/Canvas;)Lfp;", line = 308)
    ...
    @OriginalMember(owner = "client!fp", name = "e", descriptor = "(IIIII)V", line = 356)
