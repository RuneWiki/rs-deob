...
@OriginalClass("client!CXHZUTUD")
public class class9 extends class30 implements Runnable {

    @OriginalMember(owner = "client!CXHZUTUD", name = "b", descriptor = "[B")
    private byte[] field561 = new byte[500];

    @OriginalMember(owner = "client!CXHZUTUD", name = "i", descriptor = "LROXEPOUC;")
    private class51 field568 = new class51(0);

    @OriginalMember(owner = "client!CXHZUTUD", name = "n", descriptor = "Z")
    private boolean field573 = true;

    @OriginalMember(owner = "client!CXHZUTUD", name = "p", descriptor = "Z")
    private boolean field575 = true;

    @OriginalMember(owner = "client!CXHZUTUD", name = "q", descriptor = "Z")
    private boolean field576 = false;

    @OriginalMember(owner = "client!CXHZUTUD", name = "t", descriptor = "Ljava/lang/String;")
    public String field579 = "";

    @OriginalMember(owner = "client!CXHZUTUD", name = "u", descriptor = "[[I")
    private int[][] field580 = new int[4][];

    @OriginalMember(owner = "client!CXHZUTUD", name = "y", descriptor = "Z")
    private boolean field584 = true;

    @OriginalMember(owner = "client!CXHZUTUD", name = "C", descriptor = "[[I")
    private int[][] field588 = new int[4][];

    @OriginalMember(owner = "client!CXHZUTUD", name = "D", descriptor = "I")
    private int field589 = 4;

    @OriginalMember(owner = "client!CXHZUTUD", name = "E", descriptor = "I")
    private int field590 = 870;

    @OriginalMember(owner = "client!CXHZUTUD", name = "F", descriptor = "LROXEPOUC;")
    private class51 field591 = new class51(0);

    @OriginalMember(owner = "client!CXHZUTUD", name = "G", descriptor = "[[B")
    private byte[][] field592 = new byte[4][];

    @OriginalMember(owner = "client!CXHZUTUD", name = "H", descriptor = "LKMFVYEKJ;")
    private class37 field593 = new class37(0);

    @OriginalMember(owner = "client!CXHZUTUD", name = "I", descriptor = "LROXEPOUC;")
    private class51 field594 = new class51(0);

    @OriginalMember(owner = "client!CXHZUTUD", name = "J", descriptor = "[B")
    private byte[] field595 = new byte[65000];

    @OriginalMember(owner = "client!CXHZUTUD", name = "K", descriptor = "LROXEPOUC;")
    private class51 field596 = new class51(0);

    @OriginalMember(owner = "client!CXHZUTUD", name = "L", descriptor = "Ljava/util/zip/CRC32;")
    private CRC32 field597 = new CRC32();

    @OriginalMember(owner = "client!CXHZUTUD", name = "M", descriptor = "LROXEPOUC;")
    ...
    @OriginalMember(owner = "client!CXHZUTUD", name = "h", descriptor = "I")
    private int field567;

    @OriginalMember(owner = "client!CXHZUTUD", name = "o", descriptor = "I")
    private int field574;

    @OriginalMember(owner = "client!CXHZUTUD", name = "v", descriptor = "I")
    private int field581;

    @OriginalMember(owner = "client!CXHZUTUD", name = "w", descriptor = "I")
    private int field582;

    @OriginalMember(owner = "client!CXHZUTUD", name = "x", descriptor = "I")
    private int field583;

    @OriginalMember(owner = "client!CXHZUTUD", name = "z", descriptor = "I")
    private int field585;

    @OriginalMember(owner = "client!CXHZUTUD", name = "A", descriptor = "I")
    private int field586;

    @OriginalMember(owner = "client!CXHZUTUD", name = "B", descriptor = "I")
    private int field587;

    @OriginalMember(owner = "client!CXHZUTUD", name = "O", descriptor = "I")
    public int field600;

    @OriginalMember(owner = "client!CXHZUTUD", name = "a", descriptor = "J")
    private long field560;

    @OriginalMember(owner = "client!CXHZUTUD", name = "l", descriptor = "LCNNODYJR;")
    private class6 field571;

    @OriginalMember(owner = "client!CXHZUTUD", name = "r", descriptor = "Lclient;")
    private client field577;

    @OriginalMember(owner = "client!CXHZUTUD", name = "P", descriptor = "Ljava/io/InputStream;")
    private InputStream field601;

    @OriginalMember(owner = "client!CXHZUTUD", name = "s", descriptor = "Ljava/io/OutputStream;")
    private OutputStream field578;

    @OriginalMember(owner = "client!CXHZUTUD", name = "f", descriptor = "Ljava/net/Socket;")
    private Socket field565;

    @OriginalMember(owner = "client!CXHZUTUD", name = "R", descriptor = "[B")
    private byte[] field603;

    @OriginalMember(owner = "client!CXHZUTUD", name = "c", descriptor = "[I")
    private int[] field562;

    @OriginalMember(owner = "client!CXHZUTUD", name = "g", descriptor = "[I")
    private int[] field566;

    @OriginalMember(owner = "client!CXHZUTUD", name = "j", descriptor = "[I")
    private int[] field569;

    @OriginalMember(owner = "client!CXHZUTUD", name = "k", descriptor = "[I")
    private int[] field570;

    @OriginalMember(owner = "client!CXHZUTUD", name = "m", descriptor = "[I")
    private int[] field572;

    @OriginalMember(owner = "client!CXHZUTUD", name = "N", descriptor = "[I")
    private int[] field599;

    @OriginalMember(owner = "client!CXHZUTUD", name = "a", descriptor = "(ZI)I")
    public final int method165(boolean arg0, int arg1) {
        return arg0 ? 1 : this.field603[arg1] & 0xFF;
    }

    @OriginalMember(owner = "client!CXHZUTUD", name = "a", descriptor = "()V")
    public final void method166() {
        this.field573 = false;
    }

    @OriginalMember(owner = "client!CXHZUTUD", name = "a", descriptor = "(IIB[B)Z")
    ...
    @OriginalMember(owner = "client!CXHZUTUD", name = "a", descriptor = "(IZ)V")
    ...
    @OriginalMember(owner = "client!CXHZUTUD", name = "a", descriptor = "(IIII)I")
    ...
    @OriginalMember(owner = "client!CXHZUTUD", name = "a", descriptor = "(LDYBMLHQM;Lclient;)V")
    ...
    @OriginalMember(owner = "client!CXHZUTUD", name = "a", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!CXHZUTUD", name = "a", descriptor = "(IBI)V")
    ...
    @OriginalMember(owner = "client!CXHZUTUD", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!CXHZUTUD", name = "a", descriptor = "(IIBI)V")
    ...
    @OriginalMember(owner = "client!CXHZUTUD", name = "a", descriptor = "(I)V")
    public final void method175(int arg0) {
        this.method171(0, arg0);
    }

    @OriginalMember(owner = "client!CXHZUTUD", name = "a", descriptor = "(IB)Z")
    ...
    @OriginalMember(owner = "client!CXHZUTUD", name = "a", descriptor = "(Z)I")
    ...
    @OriginalMember(owner = "client!CXHZUTUD", name = "a", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!CXHZUTUD", name = "run", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!CXHZUTUD", name = "c", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!CXHZUTUD", name = "b", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!CXHZUTUD", name = "c", descriptor = "()LCNNODYJR;")
    ...
    @OriginalMember(owner = "client!CXHZUTUD", name = "a", descriptor = "(LCNNODYJR;I)V")
    ...
    @OriginalMember(owner = "client!CXHZUTUD", name = "b", descriptor = "(II)Z")
    ...
    @OriginalMember(owner = "client!CXHZUTUD", name = "d", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!CXHZUTUD", name = "a", descriptor = "(BI)I")
