...
public class class9 extends class16 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IIZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IILuda;)V", line = 38)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(Z)V", line = 49)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(BZ)V", line = 62)
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "(Lap;)V", line = 72)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "([S[Ljava/lang/String;B)V", line = 91)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(ZB)V", line = 147)
    ...
    @OriginalMember(owner = "client!ff", name = "c", descriptor = "(B)V", line = 159)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(I)Z", line = 176)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 189)
