...
public class class9 {
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lre;B)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lre;II)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lbg;B)V")
