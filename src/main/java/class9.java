...
@OriginalClass("client!CGWBYVFN")
public class class9 {

    @OriginalMember(owner = "client!CGWBYVFN", name = "a", descriptor = "B")
    private byte field159 = 44;

    @OriginalMember(owner = "client!CGWBYVFN", name = "j", descriptor = "I")
    public int field168 = -1;

    @OriginalMember(owner = "client!CGWBYVFN", name = "l", descriptor = "Z")
    public boolean field170 = false;

    @OriginalMember(owner = "client!CGWBYVFN", name = "m", descriptor = "I")
    public int field171 = 5;

    @OriginalMember(owner = "client!CGWBYVFN", name = "n", descriptor = "I")
    public int field172 = -1;

    @OriginalMember(owner = "client!CGWBYVFN", name = "o", descriptor = "I")
    public int field173 = -1;

    @OriginalMember(owner = "client!CGWBYVFN", name = "p", descriptor = "I")
    public int field174 = 99;

    @OriginalMember(owner = "client!CGWBYVFN", name = "q", descriptor = "I")
    public int field175 = -1;

    @OriginalMember(owner = "client!CGWBYVFN", name = "r", descriptor = "I")
    public int field176 = -1;

    @OriginalMember(owner = "client!CGWBYVFN", name = "s", descriptor = "I")
    public int field177 = 2;

    @OriginalMember(owner = "client!CGWBYVFN", name = "d", descriptor = "I")
    public static int field162;

    @OriginalMember(owner = "client!CGWBYVFN", name = "f", descriptor = "I")
    public int field164;

    @OriginalMember(owner = "client!CGWBYVFN", name = "t", descriptor = "I")
    public int field178;

    @OriginalMember(owner = "client!CGWBYVFN", name = "u", descriptor = "I")
    public static int field179;

    @OriginalMember(owner = "client!CGWBYVFN", name = "b", descriptor = "Z")
    private static boolean field160;

    @OriginalMember(owner = "client!CGWBYVFN", name = "c", descriptor = "Z")
    private static boolean field161;

    @OriginalMember(owner = "client!CGWBYVFN", name = "g", descriptor = "[I")
    public int[] field165;

    @OriginalMember(owner = "client!CGWBYVFN", name = "h", descriptor = "[I")
    public int[] field166;

    @OriginalMember(owner = "client!CGWBYVFN", name = "i", descriptor = "[I")
    private int[] field167;

    @OriginalMember(owner = "client!CGWBYVFN", name = "k", descriptor = "[I")
    public int[] field169;

    @OriginalMember(owner = "client!CGWBYVFN", name = "e", descriptor = "[LCGWBYVFN;")
    public static class9[] field163;

    @OriginalMember(owner = "client!CGWBYVFN", name = "a", descriptor = "(LOTSGNSQM;Z)V")
    ...
    @OriginalMember(owner = "client!CGWBYVFN", name = "a", descriptor = "(BI)I")
    ...
    @OriginalMember(owner = "client!CGWBYVFN", name = "a", descriptor = "(BLYOXDZEVD;)V")
