...
public class class9 extends class115 {
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(IIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(Lkja;B)V", line = 33)
    ...
    @OriginalMember(owner = "client!kw", name = "b", descriptor = "(B)V", line = 219)
    ...
    @OriginalMember(owner = "client!kw", name = "b", descriptor = "(IIIIIII)V", line = 249)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(III)Z", line = 687)
    ...
    @OriginalMember(owner = "client!kw", name = "<init>", descriptor = "(Llea;II)V", line = 698)
