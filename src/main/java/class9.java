...
public class class9 extends class576 {
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(B)J", line = 6)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(JB)I", line = 40)
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(I)J", line = 73)
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "()V", line = 116)
    public class9() {
        this.field93 = System.nanoTime();
        this.field94 = System.nanoTime();
    }

    @OriginalMember(owner = "client!of", name = "a", descriptor = "(B)J", line = 93)
