...
@OriginalClass("client!EJHGNUGE")
public class class9 {

    @OriginalMember(owner = "client!EJHGNUGE", name = "a", descriptor = "I")
    private int field680 = -439;

    @OriginalMember(owner = "client!EJHGNUGE", name = "h", descriptor = "I")
    public int field687 = -1;

    @OriginalMember(owner = "client!EJHGNUGE", name = "j", descriptor = "Z")
    public boolean field689 = false;

    @OriginalMember(owner = "client!EJHGNUGE", name = "k", descriptor = "I")
    public int field690 = 5;

    @OriginalMember(owner = "client!EJHGNUGE", name = "l", descriptor = "I")
    public int field691 = -1;

    @OriginalMember(owner = "client!EJHGNUGE", name = "m", descriptor = "I")
    public int field692 = -1;

    @OriginalMember(owner = "client!EJHGNUGE", name = "n", descriptor = "I")
    public int field693 = 99;

    @OriginalMember(owner = "client!EJHGNUGE", name = "o", descriptor = "I")
    public int field694 = -1;

    @OriginalMember(owner = "client!EJHGNUGE", name = "p", descriptor = "I")
    public int field695 = -1;

    @OriginalMember(owner = "client!EJHGNUGE", name = "q", descriptor = "I")
    public int field696 = 2;

    @OriginalMember(owner = "client!EJHGNUGE", name = "b", descriptor = "I")
    public static int field681;

    @OriginalMember(owner = "client!EJHGNUGE", name = "d", descriptor = "I")
    public int field683;

    @OriginalMember(owner = "client!EJHGNUGE", name = "r", descriptor = "I")
    public int field697;

    @OriginalMember(owner = "client!EJHGNUGE", name = "s", descriptor = "I")
    public static int field698;

    @OriginalMember(owner = "client!EJHGNUGE", name = "e", descriptor = "[I")
    public int[] field684;

    @OriginalMember(owner = "client!EJHGNUGE", name = "f", descriptor = "[I")
    public int[] field685;

    @OriginalMember(owner = "client!EJHGNUGE", name = "g", descriptor = "[I")
    private int[] field686;

    @OriginalMember(owner = "client!EJHGNUGE", name = "i", descriptor = "[I")
    public int[] field688;

    @OriginalMember(owner = "client!EJHGNUGE", name = "c", descriptor = "[LEJHGNUGE;")
    public static class9[] field682;

    @OriginalMember(owner = "client!EJHGNUGE", name = "a", descriptor = "(ILSYUGXMZF;)V")
    ...
    @OriginalMember(owner = "client!EJHGNUGE", name = "a", descriptor = "(ZI)I")
    ...
    @OriginalMember(owner = "client!EJHGNUGE", name = "a", descriptor = "(LKHOMSBHW;I)V")
