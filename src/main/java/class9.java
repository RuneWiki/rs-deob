...
public class class9 extends class28 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IBI)I", line = 3)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(CI)B", line = 157)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lud;ILdw;ILuca;IZI)V", line = 287)
