...
public class class9 extends class601 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IIII)I", line = 45)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(I)I", line = 69)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(I)Z", line = 79)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(B)I", line = 94)
    public final int method39(byte arg0) {
        ++field66;
        return arg0 != -17 ? -70 : 1;
    }

    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "(Lgn;)V", line = 105)
    public class9(class699 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "(ILgn;)V", line = 108)
    public class9(int arg0, class699 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IZ)V", line = 111)
    ...
    @OriginalMember(owner = "client!ff", name = "c", descriptor = "(B)V", line = 122)
