...
public class class9 extends class147 {
    ...
    @OriginalMember(owner = "client!fp", name = "b", descriptor = "(I)[F", line = 3)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "()V", line = 422)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "([B)V", line = 440)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "([I)Ljk;", line = 602)
    ...
    @OriginalMember(owner = "client!fp", name = "c", descriptor = "(I)I", line = 663)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Lg;)Z", line = 695)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Lg;II)Lfp;", line = 716)
    ...
    @OriginalMember(owner = "client!fp", name = "b", descriptor = "()I", line = 732)
    ...
    @OriginalMember(owner = "client!fp", name = "d", descriptor = "(I)F", line = 743)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "([BI)V", line = 754)
    ...
    @OriginalMember(owner = "client!fp", name = "b", descriptor = "([B)V", line = 760)
    ...
    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "([B)V", line = 803)
