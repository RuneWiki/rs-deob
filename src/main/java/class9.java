...
public class class9 extends class406 {
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(I)Lrh;")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lrh;FLrh;I)Z")
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(Ltt;I)V")
