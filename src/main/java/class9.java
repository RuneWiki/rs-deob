...
public class class9 extends class95 implements class415 {
    ...
    @OriginalMember(owner = "client!ad", name = "<init>", descriptor = "(Lh;ILjava/nio/ByteBuffer;)V")
    public class9(class327 arg0, int arg1, ByteBuffer arg2) {
        super(arg0, arg2);
        this.field123 = arg1;
    }

    @OriginalMember(owner = "client!ad", name = "d", descriptor = "(Lig;)V")
    ...
    @OriginalMember(owner = "client!ad", name = "b", descriptor = "(Lig;)V")
    ...
    @OriginalMember(owner = "client!ad", name = "c", descriptor = "(Lig;)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lig;)V")
    ...
    @OriginalMember(owner = "client!ad", name = "<init>", descriptor = "(Lh;I[BI)V")
