...
public class class9 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(II)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(ZI)V", line = 59)
    ...
    @OriginalMember(owner = "client!ff", name = "c", descriptor = "(B)V", line = 74)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(II)Lrk;", line = 105)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Z)V", line = 136)
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "(Ljk;ILfs;)V", line = 164)
