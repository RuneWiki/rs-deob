...
public class class9 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lha;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "()V", line = 184)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Ld;III)I", line = 209)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lha;Les;IIII[I[I)V", line = 266)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(II)Lut;", line = 401)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IIIIIIII)V", line = 416)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "()V", line = 426)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(I)Lbj;", line = 453)
    public static final class257 method153(int arg0) {
        return (class257) field144.method2121(62, (long) arg0);
    }

    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lha;)Lifa;", line = 457)
    ...
    @OriginalMember(owner = "client!ff", name = "c", descriptor = "()V", line = 467)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lha;IIIIIII[S[BZ)V", line = 479)
    ...
    @OriginalMember(owner = "client!ff", name = "d", descriptor = "()V", line = 641)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lha;Lke;IIII)V", line = 651)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lha;Lke;Loaa;)V", line = 655)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(I)V", line = 764)
    public static final void method160(int arg0) {
        field140 = (class257) field144.method2121(62, (long) arg0);
    }

    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lha;IIII)Lifa;", line = 771)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Ld;II)V", line = 783)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "([B[B[SII)V", line = 793)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lbt;Llk;Lib;Ldr;Ldd;Lgf;Lbh;)V", line = 940)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(Lha;)V", line = 972)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lha;IIII[S[B)V", line = 982)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(II)Lbj;", line = 1043)
    ...
    @OriginalMember(owner = "client!ff", name = "e", descriptor = "()V", line = 1059)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(Lha;IIII)V", line = 1220)
