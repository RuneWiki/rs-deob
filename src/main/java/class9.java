...
public class class9 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IIII)I", line = 8)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(ILur;BI)V", line = 40)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 99)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(I)V", line = 135)
