...
public class class9 extends class585 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lso;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(ZLip;)I", line = 81)
    ...
    @OriginalMember(owner = "client!ff", name = "e", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "()V", line = 120)
    public class9() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IZB)V", line = 124)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(II)[I", line = 135)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(I[[I)V", line = 163)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(ZI)[[I", line = 213)
