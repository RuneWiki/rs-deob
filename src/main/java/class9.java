...
public class class9 {
    ...
    @OriginalMember(owner = "client!CSHXCUHU", name = "d", descriptor = "[LCSHXCUHU;")
    public static class9[] field617;

    @OriginalMember(owner = "client!CSHXCUHU", name = "a", descriptor = "(LFNOQZAYQ;I)V")
    ...
    @OriginalMember(owner = "client!CSHXCUHU", name = "a", descriptor = "(LDNRIFKTO;I)V")
    ...
    @OriginalMember(owner = "client!CSHXCUHU", name = "b", descriptor = "(I)LSNMMQNPZ;")
    ...
    @OriginalMember(owner = "client!CSHXCUHU", name = "a", descriptor = "(Z)LSNMMQNPZ;")
