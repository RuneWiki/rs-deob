...
public class class9 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lvh;Lqa;Lvh;Z)V")
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(ILsq;)V")
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(ILqa;)V")
