...
public class class9 extends class45 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lln;Z)I", line = 5)
    ...
    @OriginalMember(owner = "client!ff", name = "f", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(II)[[I", line = 42)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lcu;II)V", line = 121)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IIIZ)I", line = 135)
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "()V", line = 150)
    public class9() {
        super(3, false);
    }

    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(II)[I", line = 156)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Z[B)[B", line = 208)
