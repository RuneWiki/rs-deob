...
public class class9 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(I[III[J)V", line = 18)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(BI)Lpba;", line = 78)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(B)[Ltca;", line = 112)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IIILfg;Lfg;)V", line = 126)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(II)V", line = 165)
    ...
    @OriginalMember(owner = "client!bc", name = "b", descriptor = "(B)V", line = 178)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IZZII)V", line = 193)
    ...
    @OriginalMember(owner = "client!bc", name = "c", descriptor = "(B)V", line = 203)
    ...
    @OriginalMember(owner = "client!bc", name = "d", descriptor = "(B)V", line = 287)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Leh;II)Z", line = 304)
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "(Lsea;ILmv;)V", line = 330)
