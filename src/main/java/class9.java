...
public class class9 extends class276 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IZZII)Lqs;")
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Lec;Lec;Z)V")
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(BIILch;)V")
