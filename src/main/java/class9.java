...
public class class9 extends class283 implements class212 {
    ...
    @OriginalMember(owner = "client!ff", name = "d", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IIIZIILnh;I[B)V")
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "(Ltga;Lnh;Ljr;II)V")
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "(Ltga;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "(Ltga;Lnh;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(ILju;)V")
