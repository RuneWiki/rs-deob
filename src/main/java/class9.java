...
public class class9 {
    ...
    @OriginalMember(owner = "client!ah", name = "B", descriptor = "[Lkc;")
    ...
    @OriginalMember(owner = "client!ah", name = "L", descriptor = "[Lkc;")
    ...
    @OriginalMember(owner = "client!ah", name = "f", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ah", name = "g", descriptor = "Lbg;")
    public static class18 field126;

    @OriginalMember(owner = "client!ah", name = "o", descriptor = "Lkc;")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(BLkc;I)V")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(ILkc;)V")
