...
public class class316 extends class348 {
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(CIIIZLfs;II)V")
    ...
    @OriginalMember(owner = "client!gk", name = "b", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "([B[IIIIIIIIIIILfs;II)V")
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(Llg;Lmo;[Lpi;[I[I)V")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!gk", name = "b", descriptor = "([B[IIIIIIIIIIILfs;II)V")
