...
public class class316 extends class344 {
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Lvf;Lpia;)V", line = 3)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(III)V", line = 42)
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(IZ)V", line = 142)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Lgb;II)V", line = 177)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BZ)V", line = 194)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Z)Z", line = 206)
