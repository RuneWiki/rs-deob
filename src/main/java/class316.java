...
public class class316 extends class601 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Lha;IIIIIIZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(B)V", line = 122)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IB)[I", line = 136)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "()V", line = 169)
    public class316() {
        super(1, false);
    }

    @OriginalMember(owner = "client!er", name = "c", descriptor = "(II)I", line = 173)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(I[B)Ljava/lang/String;", line = 206)
    ...
    @OriginalMember(owner = "client!er", name = "d", descriptor = "(B)V", line = 220)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(ZLtia;)V", line = 232)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Lmc;II)V", line = 310)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Z)V", line = 358)
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(II)[[I", line = 382)
