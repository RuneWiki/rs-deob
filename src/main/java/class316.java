...
public class class316 extends class156 {
    ...
    @OriginalMember(owner = "client!ho", name = "g", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IB)S", line = 23)
    ...
    @OriginalMember(owner = "client!ho", name = "b", descriptor = "(B)Ljava/lang/Object;", line = 54)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(B)Z", line = 65)
    public final boolean method1063(byte arg0) {
        field4748++;
        return arg0 == -120 ? false : false;
    }

    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 77)
