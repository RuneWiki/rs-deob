...
public class class316 extends class712 {
    ...
    @OriginalMember(owner = "client!qca", name = "b", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(IILhba;)V", line = 34)
    ...
    @OriginalMember(owner = "client!qca", name = "b", descriptor = "(III)V", line = 71)
    ...
    @OriginalMember(owner = "client!qca", name = "<init>", descriptor = "(Lhj;Luu;)V", line = 86)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(ZB)V", line = 112)
    ...
    @OriginalMember(owner = "client!qca", name = "d", descriptor = "(B)V", line = 132)
    ...
    @OriginalMember(owner = "client!qca", name = "d", descriptor = "(Z)Z", line = 151)
    ...
    @OriginalMember(owner = "client!qca", name = "e", descriptor = "(Z)V", line = 168)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(BZ)V", line = 199)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(Z)V", line = 222)
