...
public class class316 extends class748 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Lvj;ILmr;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(ZILjava/io/File;)V", line = 116)
    ...
    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "()V", line = 148)
    public class316() {
        super(1, false);
    }

    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IZLvj;)V", line = 153)
    ...
    @OriginalMember(owner = "client!uq", name = "g", descriptor = "(I)V", line = 201)
    ...
    @OriginalMember(owner = "client!uq", name = "b", descriptor = "(II)[[I", line = 213)
