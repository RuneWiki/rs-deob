...
public abstract class class316 implements class172 {
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(BLjaggl/MapBuffer;)Z")
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(Ljaggl/MapBuffer;ZB)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(BLjaclib/memory/Source;I)Z")
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(ZLpba;)V")
    ...
    @OriginalMember(owner = "client!afa", name = "<init>", descriptor = "(Lbea;IZ)V")
