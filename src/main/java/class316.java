...
public class class316 extends class301 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ZLsa;FII)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ILgp;B)Ldba;")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lbr;B)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ILbr;)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ZLbr;)V")
