...
public class class316 extends class24 implements class175 {
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(III)Lko;")
    ...
    @OriginalMember(owner = "client!vl", name = "e", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(ILek;)Ljf;")
    ...
    @OriginalMember(owner = "client!vl", name = "<init>", descriptor = "(Lad;Lqda;Z)V")
    public class316(class669 arg0, class689 arg1, boolean arg2) {
        super(arg0, 34963, arg2);
        this.field4370 = arg1;
    }

    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(I)Lqda;")
