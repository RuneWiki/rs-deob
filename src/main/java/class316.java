...
public class class316 {
   ...
   private static final String[] field4889 = new String[]{method2622(method2621("2.N\tL%`")), method2622(method2621("#2_\u0018N\"3HC@(2W\u0004Fz\u007f")), method2622(method2621("|}J\bQ44S\u0003\u001evf\u001c\u001dB35\u0001B\u0018g9S\u0000B.3\u0001")), method2622(method2621("/4]Cao")), method2622(method2621("$2S\u0006J\"5S\u001eW")), method2622(method2621("/4]C`o")), method2622(method2621("/4]Cbo"))};
   @OriginalMember(
      owner = "client!hia",
      name = "c",
      descriptor = "I"
   ...
   public static class678 field4879;
   ...
   public static final void method2618(int arg0) {
      try {
         ++field4887;
         int var1 = 83 / ((arg0 - -68) / 45);
         if (class684.field10176 != null) {
            try {
               String var2 = class684.field10176.getParameter(field4889[4]);
               int var3 = (int)(class162.method1442(14080) / 86400000L) - 11745;
               String var4 = field4889[0] + var3 + field4889[2] + var2;
               class676.method4987(false, class684.field10176, field4889[1] + var4 + "\"");
            } catch (Throwable var6) {
            }
         }
      } catch (RuntimeException var7) {
         throw class482.method3757(var7, field4889[3] + arg0 + ')');
      }
   }
   ...
   public static void method2619(byte arg0) {
      try {
         ...
         throw class482.method3757(var2, field4889[6] + arg0 + ')');
      }
   }
   ...
   public static final boolean method2620(boolean arg0, int arg1) {
      try {
         ++field4883;
         if (!arg0) {
            return true;
         ...
         throw class482.method3757(var3, field4889[5] + arg0 + ',' + arg1 + ')');
      }
   }
