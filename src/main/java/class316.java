...
public class class316 extends class422 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IBIIIII)I", line = 3)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(B)Ljv;", line = 54)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Lmc;[BII)Lwaa;", line = 82)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Loa;Lbo;IIIII)V", line = 114)
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(ILrn;Lhv;III)V", line = 203)
