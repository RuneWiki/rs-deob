...
public class class316 {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(II)V", line = 36)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(BILp;II)V", line = 55)
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "(II)Lsi;", line = 94)
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "(Lwv;ILqs;Lqs;)V", line = 178)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IBI)V", line = 130)
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "(I)V", line = 151)
