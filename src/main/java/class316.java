...
public class class316 {
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(IILnp;I)V")
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(Lha;IILvr;ZLaaa;Lfs;Lnp;ILbh;Lnq;I)Lka;")
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(ILnp;ILfs;Laaa;IIIILha;II)Lka;")
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(I[II[IZI[Lca;)V")
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(ILfg;I)V")
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(IILnq;I)V")
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(ILha;Laaa;ILvr;IILfs;I[ILbh;ILnq;BILfs;[Lhb;Lnp;ILjf;Z)Lka;")
