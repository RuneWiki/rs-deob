...
public class class316 extends class60 {
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Lbi;Ldk;)Lpk;")
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Lkga;IIII)V")
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(IIIIZ)Lpga;")
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Lom;)V")
    public final void method440(class374 arg0) {
    }

    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Lfg;Z)Lpga;")
    ...
    @OriginalMember(owner = "client!iw", name = "e", descriptor = "()Lql;")
    ...
    @OriginalMember(owner = "client!iw", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ld;II)V")
    ...
    @OriginalMember(owner = "client!iw", name = "s", descriptor = "()Lql;")
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(I[Lraa;)V")
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(II)Ldk;")
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(II[I[I)Laa;")
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Lof;)V")
    ...
    @OriginalMember(owner = "client!iw", name = "q", descriptor = "()Lql;")
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Lql;)V")
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(IIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!iw", name = "A", descriptor = "(ILaa;II)V")
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(IIZ)Lpga;")
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "([IIIIIZ)Lpga;")
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Lom;Lom;FLom;)Lom;")
    public final class374 method499(class374 arg0, class374 arg1, float arg2, class374 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Ljava/lang/Runnable;)Lmd;")
    ...
    @OriginalMember(owner = "client!iw", name = "b", descriptor = "()Lkaa;")
    public final class48 method432() {
        return new class48(0, "Pure Java", 1, "CPU", 0L);
    }

    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(IIIIIF)Lraa;")
    ...
    @OriginalMember(owner = "client!iw", name = "<init>", descriptor = "(Ld;)V")
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Lhia;[Lfg;Z)Lda;")
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Lza;)V")
    public final void method445(class415 arg0) {
    }

    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Ldh;IIII)Lka;")
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(II[[I[[IIII)Ls;")
    ...
    @OriginalMember(owner = "client!iw", name = "d", descriptor = "(IIIIII)Lom;")
    public final class374 method503(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!iw", name = "c", descriptor = "(II)Lbi;")
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Lpk;)V")
    ...
    @OriginalMember(owner = "client!iw", name = "i", descriptor = "(I)Lza;")
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(IIIIIILaa;IIIII)V")
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Lof;I)V")
