...
public class class316 extends class142 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ILya;)V")
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(B[I[ILig;[I)V")
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Lsq;Lsq;IB)V")
