...
public class class316 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(B)Z", line = 7)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(I)V", line = 24)
    public static void method2019(int arg0) {
        field4776 = null;
        int var1 = 83 / ((arg0 - 55) / 40);
    }

    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IILjq;ILya;II)Lt;", line = 34)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Ljq;IIILta;IZIIILta;Lya;I)Lt;", line = 55)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(BLhp;I)V", line = 75)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IIIII)V", line = 201)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Lhp;I)V", line = 213)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IIZIILya;Ljq;)Lt;", line = 238)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Lta;ZILjq;ILya;ILta;IIIZIB)Lt;", line = 258)
