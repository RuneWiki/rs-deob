...
public class class316 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(III)V", line = 32)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IBI)I", line = 64)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(I)V", line = 87)
