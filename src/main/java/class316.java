...
public class class316 extends class476 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(BLws;)I")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IILza;)Le;")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
