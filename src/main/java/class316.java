...
public abstract class class316 extends class528 {
    ...
    @OriginalMember(owner = "client!wr", name = "ka", descriptor = "(IIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!wr", name = "D", descriptor = "(IIIIIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!wr", name = "JA", descriptor = "()I", line = 77)
    public final int method131() {
        return this.field4533 + this.field4522 + this.field4519;
    }

    @OriginalMember(owner = "client!wr", name = "qa", descriptor = "()I", line = 80)
    public final int method139() {
        return this.field4533;
    }

    @OriginalMember(owner = "client!wr", name = "ja", descriptor = "()I", line = 83)
    public final int method134() {
        return this.field4537 + this.field4512 + this.field4529;
    }

    @OriginalMember(owner = "client!wr", name = "aa", descriptor = "(FFFFFFIII)V", line = 86)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(FFFFFF)V", line = 184)
    ...
    @OriginalMember(owner = "client!wr", name = "UA", descriptor = "()I", line = 322)
    public final int method137() {
        return this.field4512;
    }

    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(FFFFFFLea;II)V", line = 350)
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(Lin;II)V", line = 364)
