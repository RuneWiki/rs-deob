...
public class class316 extends class30 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IIZLe;ILfa;)V")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Ljg;II)V")
    ...
    @OriginalMember(owner = "client!rc", name = "c", descriptor = "(III)Ltk;")
