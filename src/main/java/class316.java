...
public class class316 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(ILpe;BIII)Ljava/awt/Frame;", line = 3)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Liaa;I)V", line = 75)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(ILiaa;B)V", line = 112)
