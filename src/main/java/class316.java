...
public class class316 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ZB)V", line = 24)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(II)Lfu;", line = 73)
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(II)V", line = 119)
    ...
    @OriginalMember(owner = "client!uf", name = "c", descriptor = "(II)V", line = 139)
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(I)V", line = 166)
    ...
    @OriginalMember(owner = "client!uf", name = "d", descriptor = "(II)V", line = 187)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Ljava/lang/String;BLih;I)Lkt;", line = 199)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Z)V", line = 237)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ZI)V", line = 259)
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "(Lle;IZLoi;Loi;)V", line = 308)
