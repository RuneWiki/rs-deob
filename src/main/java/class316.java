...
public class class316 {
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(IIIIILwca;IIIII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(ILfd;I)V", line = 356)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(B)V", line = 373)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(ILfd;)V", line = 388)
