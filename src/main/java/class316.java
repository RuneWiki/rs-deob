...
public class class316 extends class446 implements class4 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;", line = 8)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(B)V", line = 23)
    public final void method24(byte arg0) {
        field4346++;
        super.method24(arg0);
    }

    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(III)Z", line = 31)
    ...
    @OriginalMember(owner = "client!cs", name = "e", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I)Z", line = 63)
    public final boolean method28(int arg0) {
        field4347++;
        return arg0 == 11390 ? super.method28(11390) : false;
    }

    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Ldc;Lne;Z)V", line = 75)
    public class316(class5 arg0, class294 arg1, boolean arg2) {
        super(arg0, 34963, arg2);
        this.field4348 = arg1;
    }

    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIZ)V", line = 83)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(B)Lne;", line = 108)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(I)I", line = 120)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(II)V", line = 143)
