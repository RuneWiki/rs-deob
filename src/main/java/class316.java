...
public class class316 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(ZLjava/lang/Object;B)[B", line = 21)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(BILtq;I)V", line = 59)
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 91)
