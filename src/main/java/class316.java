...
public class class316 extends class55 {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "()[I", line = 7)
    public final int[] method1889() {
        return this.field4256;
    }

    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(II)V", line = 10)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "()V", line = 56)
    public static void method1891() {
        field4258 = null;
    }

    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(II[IZ)V", line = 59)
