...
public abstract class class316 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIIILjava/lang/String;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIII[Lo;ILta;Ljava/lang/String;[I)V", line = 32)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(BLlr;Z)V", line = 188)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I)V", line = 345)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "([I[II[IIILjava/lang/String;[Lo;)V", line = 356)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIII[I[Lo;Ljava/lang/String;ILjava/util/Random;I)I", line = 523)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(JZ)V", line = 560)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IILjava/lang/String;)V", line = 581)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "([IIIIIIILjava/util/Random;[II[Lo;Ljava/lang/String;III)I", line = 624)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(II[II[Lo;ILta;BIIIIILjava/lang/String;II)I", line = 702)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIILjava/lang/String;II)V", line = 713)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IILjava/lang/String;IIB)V", line = 731)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Z)Lql;", line = 746)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIBILjava/lang/String;I)V", line = 773)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILjava/lang/String;BIII[II[Lo;IIIILta;III)I", line = 799)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "([Lo;IIILjava/lang/String;[IBI)V", line = 903)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(BLjava/lang/String;)V", line = 931)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/lang/String;IIIIIB)V", line = 1010)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIILjava/lang/String;I)V", line = 1046)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(BII)V", line = 1061)
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(Lza;Lgf;)V", line = 1082)
