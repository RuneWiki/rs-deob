...
public class class316 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(F)F", line = 4)
    private static final float method1947(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!k", name = "a", descriptor = "(IIF)F", line = 19)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "()V", line = 24)
    public static void method1949() {
        field4620 = null;
        field4617 = null;
    }

    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Lvt;Lng;)V", line = 45)
    ...
    @OriginalMember(owner = "client!k", name = "b", descriptor = "(IIF)F", line = 111)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(IF)I", line = 120)
