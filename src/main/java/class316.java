...
public abstract class class316 extends class577 {
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(III)Z", line = 9)
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(III)Z", line = 21)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(I)V", line = 53)
