...
public class class316 implements Runnable {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IIILjava/lang/Object;I)Lgca;")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Ljava/lang/String;B)Lsga;")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IB[ILjava/awt/Point;Ljava/awt/Component;I)Lgca;")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(I)Lgca;")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Ljava/net/URL;I)Lgca;")
    public final class249 method2040(URL arg0, int arg1) {
        int var3 = -110 / ((arg1 - 71) / 45);
        return this.method2036(-1, 4, 0, arg0, 0);
    }

    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;I)Lgca;")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Ljava/lang/String;IZI)Lgca;")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(ILjava/lang/String;)Lgca;")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(ILjava/lang/String;[Ljava/lang/Class;Ljava/lang/Class;)Lgca;")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(ILjava/lang/Runnable;I)Lgca;")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(ZLjava/lang/String;I)Lgca;")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(ILjava/io/File;[B)Z")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IIIII)Lgca;")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IB)Lgca;")
    public final class249 method2052(int arg0, byte arg1) {
        return arg1 == 0 ? this.method2036(-1, 3, arg0, null, 0) : null;
    }

    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(B)Ljava/lang/Object;")
    public final Object method2053(byte arg0) {
        return arg0 < 101 ? null : this.field4373;
    }

    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Ljava/awt/Frame;I)Lgca;")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;I)Lsga;")
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(ILjava/lang/String;IZ)V")
