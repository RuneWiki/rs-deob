...
public class class316 {
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(IILr;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(Llaa;Ljava/lang/String;II)Lkl;", line = 493)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(I)V", line = 576)
