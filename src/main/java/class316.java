...
public class class316 extends class361 implements class351 {
    ...
    @OriginalMember(owner = "client!fm", name = "i", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;ILjava/lang/String;I)V", line = 14)
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(B)I", line = 49)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(I)I", line = 61)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ILnr;II)Z", line = 72)
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "(Lnr;Lta;IIIIIIIZIIIII)V", line = 95)
    ...
    @OriginalMember(owner = "client!fm", name = "c", descriptor = "(B)I", line = 106)
    public final int method148(byte arg0) {
        ++field4533;
        return arg0 != -68 ? -103 : this.field4527.field1458;
    }

    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(BILnr;)Lqc;", line = 119)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "([BB)[B", line = 130)
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(Lnr;Z)Lg;", line = 185)
    ...
    @OriginalMember(owner = "client!fm", name = "j", descriptor = "(I)V", line = 219)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "([[II)V", line = 239)
    ...
    @OriginalMember(owner = "client!fm", name = "g", descriptor = "(I)I", line = 251)
    ...
    @OriginalMember(owner = "client!fm", name = "d", descriptor = "(B)V", line = 270)
    ...
    @OriginalMember(owner = "client!fm", name = "e", descriptor = "(B)Z", line = 280)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Lnr;I)V", line = 294)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(BLnr;IIZLcb;I)V", line = 309)
    ...
    @OriginalMember(owner = "client!fm", name = "d", descriptor = "(I)V", line = 321)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Lnr;Z)V", line = 332)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ILnr;)V", line = 343)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(B)Z", line = 361)
