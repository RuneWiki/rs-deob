...
public class class316 extends class5 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IIII)Z", line = 16)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ZIIIZ)Luu;", line = 31)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(BZ)V", line = 54)
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "(IIIIIZ)V", line = 97)
