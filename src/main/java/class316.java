...
public class class316 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Lqaa;I)V")
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(IZ)Lpi;")
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "(Lkr;ILpu;)V")
