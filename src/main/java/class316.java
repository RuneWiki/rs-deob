...
public class class316 extends class111 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IILvq;I)Z")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(BI)Lrj;")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IZILbr;)V")
