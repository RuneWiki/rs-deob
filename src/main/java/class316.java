...
public class class316 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IB)Lkn;")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ZLvs;)V")
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "(Lgt;ILdn;)V")
