...
public class class316 extends class208 {
    ...
    @OriginalMember(owner = "client!hc", name = "b", descriptor = "(BLha;)Lmg;")
    ...
    @OriginalMember(owner = "client!hc", name = "c", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IILha;)Lka;")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(Lha;I)Luh;")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(BIILha;)Z")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(Lha;Ldm;Lka;B)V")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IIILha;Lnfa;ZI)V")
