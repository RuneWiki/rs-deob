...
public class class316 extends class374 {
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(Lvd;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ob", name = "c", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(I)V", line = 183)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(B)Z", line = 212)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(III)V", line = 225)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(ZII)Z", line = 250)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(ZZ)V", line = 261)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IIIB)I", line = 288)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Z)V", line = 337)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IILjava/lang/String;Z)Z", line = 355)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(ZI)V", line = 429)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(ZLew;I)V", line = 451)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(II)I", line = 464)
