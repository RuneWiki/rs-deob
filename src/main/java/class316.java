...
public class class316 extends class501 {
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(Lbo;IIIIZ[FI)V", line = 4)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IBIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IIIIIII)V", line = 62)
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(Lbo;IIIII)V", line = 77)
    ...
    @OriginalMember(owner = "client!wr", name = "f", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(Lbo;IIII)V", line = 109)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ILjava/lang/String;)[B", line = 121)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ZZZ)V", line = 265)
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(Lbo;IIIIZ[IZ)V", line = 282)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IZB[BIIIIII)V", line = 333)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IIII)V", line = 393)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IZIIIBII[I)V", line = 408)
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(Lbo;IIIIZ[BIZ)V", line = 461)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(II)I", line = 515)
