...
public class class316 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(III)I", line = 22)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(I[BIZ)Ljava/lang/String;", line = 38)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(B)V", line = 127)
    ...
    @OriginalMember(owner = "client!uq", name = "b", descriptor = "(III)Laca;", line = 139)
