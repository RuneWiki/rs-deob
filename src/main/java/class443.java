...
public class class443 extends class456 {
    ...
    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "()V", line = 5)
    public class443() {
        super(3, false);
    }

    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IBLre;)V", line = 9)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IBI)V", line = 24)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(BLjb;[[B)V", line = 38)
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(B)V", line = 108)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IILre;Lng;)V", line = 123)
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(Z)V", line = 237)
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(II)[I", line = 249)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(II)[[I", line = 307)
