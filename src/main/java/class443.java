...
public class class443 extends class227 {
    ...
    @OriginalMember(owner = "client!eb", name = "j", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!eb", name = "g", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "()V", line = 28)
    public class443() {
        super(0, false);
    }

    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ZBJLjava/lang/String;)V", line = 33)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IZ)[[I", line = 107)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(B)Z", line = 175)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Lug;II)V", line = 205)
    ...
    @OriginalMember(owner = "client!eb", name = "i", descriptor = "(I)I", line = 219)
    ...
    @OriginalMember(owner = "client!eb", name = "c", descriptor = "(III)V", line = 234)
