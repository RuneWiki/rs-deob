...
public class class443 extends class573 {
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Loa;Lbo;III)V", line = 52)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(I)V", line = 105)
