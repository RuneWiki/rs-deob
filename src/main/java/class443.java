...
public class class443 extends class401 implements class419 {
    ...
    @OriginalMember(owner = "client!baa", name = "g", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!baa", name = "d", descriptor = "(I)Z", line = 92)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(II)V", line = 110)
    ...
    @OriginalMember(owner = "client!baa", name = "<init>", descriptor = "(Ltm;Lvp;Z)V", line = 123)
    public class443(class327 arg0, class160 arg1, boolean arg2) {
        super(arg0, 34963, arg2);
        this.field6113 = arg1;
    }

    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;B)V", line = 136)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(I)I", line = 190)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;", line = 208)
    ...
    @OriginalMember(owner = "client!baa", name = "b", descriptor = "(I)V", line = 227)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(IBIII)V", line = 239)
    ...
    @OriginalMember(owner = "client!baa", name = "h", descriptor = "(I)V", line = 282)
    ...
    @OriginalMember(owner = "client!baa", name = "c", descriptor = "(I)Lvp;", line = 294)
