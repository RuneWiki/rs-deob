...
public class class443 extends class629 {
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(IBI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(IILcp;Lrt;BIIIIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!oga", name = "d", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!oga", name = "c", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!oga", name = "b", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(IZI)V", line = 98)
    ...
    @OriginalMember(owner = "client!oga", name = "<init>", descriptor = "(IIIIIF)V", line = 124)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(BIB)V", line = 154)
