...
public class class443 {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(BIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(IIIIIII)Lks;", line = 71)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(IZZIJ)Ljava/lang/String;", line = 99)
