...
public class class443 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(I)Ldg;")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Ldg;JZ)V")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(JI)Ldg;")
