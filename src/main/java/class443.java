...
public class class443 extends class282 {
    ...
    @OriginalMember(owner = "client!mja", name = "<init>", descriptor = "(Ljk;Ltda;IIIIIIIIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!mja", name = "a", descriptor = "(IBI[J[Ljava/lang/Object;)V", line = 14)
    ...
    @OriginalMember(owner = "client!mja", name = "a", descriptor = "(Z)Lwh;", line = 70)
    ...
    @OriginalMember(owner = "client!mja", name = "a", descriptor = "(I)Ljava/lang/String;", line = 81)
