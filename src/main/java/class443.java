...
public class class443 extends class780 {
    ...
    @OriginalMember(owner = "client!mja", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!mja", name = "<init>", descriptor = "(ILur;Lcf;III)V", line = 21)
    public class443(int arg0, class564 arg1, class631 arg2, int arg3, int arg4, int arg5) {
        super(arg0, arg1, arg2, arg3, arg4);
        this.field6226 = arg5;
    }

    @OriginalMember(owner = "client!mja", name = "a", descriptor = "(Lgaa;II)V", line = 33)
    ...
    @OriginalMember(owner = "client!mja", name = "a", descriptor = "(B)Lhv;", line = 55)
    ...
    @OriginalMember(owner = "client!mja", name = "a", descriptor = "(Z)V", line = 72)
