...
public class class443 extends class262 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(CIIIZLpa;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "([B[IIIIIIIIIIILpa;II)V", line = 67)
    ...
    @OriginalMember(owner = "client!sq", name = "HA", descriptor = "(CIIIZ)V", line = 162)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Lfg;Ldd;[Lqr;[I[I)V", line = 219)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "([B[IIIIIIII)V", line = 262)
