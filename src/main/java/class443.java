...
public class class443 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(II)Z", line = 38)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Lji;Z)[Lpp;", line = 49)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Lvg;I)V", line = 100)
