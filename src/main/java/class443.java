...
public class class443 extends class418 {
    ...
    @OriginalMember(owner = "client!lo", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Ltj;I)V", line = 22)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!lo", name = "b", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!lo", name = "c", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!lo", name = "c", descriptor = "(B)Z", line = 103)
