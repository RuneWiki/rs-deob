...
public class class443 extends class188 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(ILjava/awt/event/MouseEvent;)I", line = 16)
    ...
    @OriginalMember(owner = "client!wa", name = "b", descriptor = "(B)Z", line = 51)
    ...
    @OriginalMember(owner = "client!wa", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 61)
    ...
    @OriginalMember(owner = "client!wa", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 87)
    ...
    @OriginalMember(owner = "client!wa", name = "e", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(BLev;Lev;)V", line = 111)
    ...
    @OriginalMember(owner = "client!wa", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 130)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method2598(arg0, -100);
        field6217++;
    }

    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Z)I", line = 139)
    ...
    @OriginalMember(owner = "client!wa", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 152)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        field6202++;
        this.method2598(arg0, -78);
    }

    @OriginalMember(owner = "client!wa", name = "c", descriptor = "(I)Lke;", line = 164)
    ...
    @OriginalMember(owner = "client!wa", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 175)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        this.method2598(arg0, -121);
        field6188++;
    }

    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;I)V", line = 183)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(BZ)Z", line = 204)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IBI)I", line = 246)
    ...
    @OriginalMember(owner = "client!wa", name = "f", descriptor = "(I)V", line = 263)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(B)V", line = 287)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(I)I", line = 300)
    ...
    @OriginalMember(owner = "client!wa", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 311)
    ...
    @OriginalMember(owner = "client!wa", name = "d", descriptor = "(I)V", line = 337)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Lnt;Ljava/lang/String;ZIZ)V", line = 360)
    ...
    @OriginalMember(owner = "client!wa", name = "c", descriptor = "(B)Z", line = 429)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IIBI)V", line = 443)
    ...
    @OriginalMember(owner = "client!wa", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 461)
    ...
    @OriginalMember(owner = "client!wa", name = "e", descriptor = "(I)Z", line = 477)
    ...
    @OriginalMember(owner = "client!wa", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 514)
