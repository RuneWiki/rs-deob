...
public class class443 extends class86 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IBII)I", line = 20)
    ...
    @OriginalMember(owner = "client!pl", name = "c", descriptor = "(I)Ljq;", line = 43)
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(II)V", line = 88)
