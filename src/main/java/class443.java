...
public class class443 extends class306 implements class377 {
    ...
    @OriginalMember(owner = "client!up", name = "b", descriptor = "()V", line = 3)
    public final void method574() {
        this.field4157.method2178(this);
    }

    @OriginalMember(owner = "client!up", name = "a", descriptor = "()I", line = 7)
    public final int method578() {
        return super.method578();
    }

    @OriginalMember(owner = "client!up", name = "a", descriptor = "(I[BI)V", line = 11)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(Lmm;I[BIZ)V", line = 16)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(III)V", line = 21)
