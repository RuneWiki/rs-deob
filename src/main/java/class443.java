...
public class class443 extends class270 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(BLec;I)V", line = 21)
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "()V", line = 101)
    public class443() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ch", name = "f", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(I[B)[B", line = 128)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(BI)[I", line = 164)
    ...
    @OriginalMember(owner = "client!ch", name = "e", descriptor = "(B)V", line = 422)
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(II)Lcg;", line = 455)
