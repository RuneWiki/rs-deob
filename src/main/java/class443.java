...
public class class443 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "()I", line = 3)
    public final int method2645() {
        return this.field6075;
    }

    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lha;Ljava/lang/String;IIIZ)V", line = 8)
    ...
    @OriginalMember(owner = "client!cj", name = "<init>", descriptor = "(Lha;IZLjava/awt/Component;)V", line = 192)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lha;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Ljava/lang/String;)I", line = 120)
    ...
    @OriginalMember(owner = "client!cj", name = "b", descriptor = "()V", line = 137)
    public static void method2649() {
        field6079 = null;
    }

    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lha;Ljava/lang/String;[IIIIZ)V", line = 145)
    ...
    @OriginalMember(owner = "client!cj", name = "c", descriptor = "()I", line = 173)
