...
public class class443 extends class46 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Lla;ILd;DIIZZ)[I", line = 42)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(DILd;Lla;ZII)[I", line = 179)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(III)Z", line = 314)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IILd;Lla;ZI)[F", line = 325)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Ld;Lla;I)Z", line = 441)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Z)V", line = 500)
    ...
    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "()V", line = 518)
    public class443() {
        try {
    ...
    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "(Lib;)V", line = 541)
