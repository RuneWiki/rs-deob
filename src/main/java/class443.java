...
public class class443 extends class398 {
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(Ljw;I)Ljava/lang/String;", line = 40)
    ...
    @OriginalMember(owner = "client!sk", name = "<init>", descriptor = "(Luca;Lal;)V", line = 59)
    ...
    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ILvaa;B)V", line = 102)
    public final void method93(int arg0, class517 arg1, byte arg2) {
        ++field6431;
        int var4 = -115 / ((76 - arg2) / 41);
    }

    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(Z)V", line = 111)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IBI)V", line = 126)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IZ)V", line = 174)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(I)Z", line = 185)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IILpo;II)Z", line = 202)
    ...
    @OriginalMember(owner = "client!sk", name = "c", descriptor = "(I)V", line = 330)
