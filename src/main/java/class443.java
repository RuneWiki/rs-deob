...
public class class443 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(BIIILts;)V", line = 39)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(B)V", line = 79)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(BLdc;)V", line = 113)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IBLdc;)V", line = 135)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(II)V", line = 381)
