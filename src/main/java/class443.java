...
public class class443 implements class416 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "()V", line = 7)
    public final void method2607() {
        this.field6310 = Thread.currentThread();
        this.method2616();
    }

    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Lfa;BIZ)Lka;", line = 13)
    ...
    @OriginalMember(owner = "client!wa", name = "finalize", descriptor = "()V", line = 79)
    ...
    @OriginalMember(owner = "client!wa", name = "b", descriptor = "()V", line = 84)
    public final void method2620() {
        this.field6310 = null;
        this.method2609();
    }

    @OriginalMember(owner = "client!wa", name = "<init>", descriptor = "(Lc;II)V", line = 89)
