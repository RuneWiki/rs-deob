...
public class class443 extends class461 implements class217 {
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(Lega;Lpn;III[B)V")
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Ldca;B)V")
