...
public class class443 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(II)V", line = 33)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IIIIILtf;)Lun;", line = 51)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IB)Loh;", line = 84)
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(B)V", line = 111)
    public static void method2704(byte arg0) {
        field6572 = null;
        int var1 = 107 / ((-arg0 - 56) / 41);
    }

    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(Ljk;ILfs;)V", line = 128)
