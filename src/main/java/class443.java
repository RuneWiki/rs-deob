...
public class class443 extends class96 {
    ...
    @OriginalMember(owner = "client!ev", name = "b", descriptor = "(II)[I", line = 10)
    ...
    @OriginalMember(owner = "client!ev", name = "<init>", descriptor = "()V", line = 33)
    public class443() {
        this(4096);
    }

    @OriginalMember(owner = "client!ev", name = "g", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(IILbt;)V", line = 49)
    ...
    @OriginalMember(owner = "client!ev", name = "<init>", descriptor = "(I)V", line = 78)
