...
public class class443 extends class214 {
    ...
    @OriginalMember(owner = "client!bk", name = "<init>", descriptor = "()V", line = 3)
    public class443() {
        super(1, false);
    }

    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ILofa;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!bk", name = "f", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IIB)V", line = 32)
    ...
    @OriginalMember(owner = "client!bk", name = "g", descriptor = "(I)Ljava/lang/String;", line = 107)
    ...
    @OriginalMember(owner = "client!bk", name = "c", descriptor = "(II)[[I", line = 138)
    ...
    @OriginalMember(owner = "client!bk", name = "h", descriptor = "(I)[Lln;", line = 188)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IB)[I", line = 199)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Lov;ZZ)V", line = 233)
