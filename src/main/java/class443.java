...
public class class443 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(ILwda;Z)V")
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IBIIZ)Lbm;")
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(BLqf;)Lqf;")
