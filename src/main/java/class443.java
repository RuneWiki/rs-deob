...
public class class443 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IIB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(BLso;)Lvha;", line = 25)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(II)V", line = 41)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Lad;I)I", line = 56)
