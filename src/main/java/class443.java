...
public class class443 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lvm;II)V", line = 14)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(I)V", line = 192)
    public static final void method2733(int arg0) {
        field6447 = (class180) field6448.method308((long) arg0, (byte) -95);
    }

    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lvm;IIII)Lmk;", line = 197)
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(I)Lin;", line = 208)
    public static final class180 method2735(int arg0) {
        return (class180) field6448.method308((long) arg0, (byte) 40);
    }

    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lam;)V", line = 211)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lvm;IIII[S[B)V", line = 231)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(II)Lrh;", line = 290)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "()V", line = 307)
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "()V", line = 329)
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(II)Lin;", line = 351)
    ...
    @OriginalMember(owner = "client!ch", name = "c", descriptor = "()V", line = 365)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lvm;)Lmk;", line = 493)
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(Lvm;IIII)V", line = 504)
    ...
    @OriginalMember(owner = "client!ch", name = "d", descriptor = "()V", line = 846)
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(Lvm;)V", line = 859)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lal;II)V", line = 871)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "([B[B[SII)V", line = 881)
    ...
    @OriginalMember(owner = "client!ch", name = "e", descriptor = "()V", line = 1024)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lal;III)I", line = 1041)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lvm;Ltq;IIII[I[I)V", line = 1098)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lvm;IIIIIII[S[BZ)V", line = 1237)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lvm;Lir;IIII)V", line = 1401)
