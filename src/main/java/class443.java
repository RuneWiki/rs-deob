...
public abstract class class443 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(IIILv;Lv;)V", line = 33)
    ...
    @OriginalMember(owner = "client!mi", name = "<init>", descriptor = "(II)V", line = 55)
