...
public class class443 implements Runnable {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(B)I", line = 48)
    ...
    @OriginalMember(owner = "client!ij", name = "b", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "(Ljava/net/Socket;Lec;I)V", line = 304)
    ...
    @OriginalMember(owner = "client!ij", name = "c", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(I[BIZ)V", line = 133)
    ...
    @OriginalMember(owner = "client!ij", name = "run", descriptor = "()V", line = 162)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ZI[BI)V", line = 236)
    ...
    @OriginalMember(owner = "client!ij", name = "d", descriptor = "(I)V", line = 289)
    ...
    @OriginalMember(owner = "client!ij", name = "finalize", descriptor = "()V", line = 319)
