...
public class class443 extends class145 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lap;BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lbi;IIIIILvj;II)V", line = 18)
    ...
    @OriginalMember(owner = "client!rf", name = "c", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "([III)V", line = 85)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(BII)V", line = 117)
    ...
    @OriginalMember(owner = "client!rf", name = "e", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Z)I", line = 154)
    ...
    @OriginalMember(owner = "client!rf", name = "f", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "()V", line = 177)
    public class443() {
        super(0, false);
    }

    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 185)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(ZI)[[I", line = 216)
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(ZI)I", line = 290)
