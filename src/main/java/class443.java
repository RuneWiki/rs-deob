...
public class class443 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(ZIZILfp;IZ)Lbi;", line = 165)
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(Lfp;Lgn;IIIIIIZI)V", line = 725)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(ZIII)I", line = 293)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(IBIIZLfp;Lbi;I)V", line = 311)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(II)Ltd;", line = 351)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(B)V", line = 379)
    ...
    @OriginalMember(owner = "client!oh", name = "b", descriptor = "(II)V", line = 399)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Lfp;I)V", line = 523)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(III)V", line = 537)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(ILfp;)V", line = 635)
    ...
    @OriginalMember(owner = "client!oh", name = "c", descriptor = "(II)V", line = 658)
    ...
    @OriginalMember(owner = "client!oh", name = "finalize", descriptor = "()V", line = 671)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(I)I", line = 683)
    ...
    @OriginalMember(owner = "client!oh", name = "b", descriptor = "(I)Z", line = 706)
