...
public class class443 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(I)Lag;")
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(BLsm;)V")
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(Z)Lag;")
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(Lsm;)V")
