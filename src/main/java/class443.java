...
public class class443 extends class339 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lr;IIIIZ)Z", line = 6)
    ...
    @OriginalMember(owner = "client!cj", name = "CA", descriptor = "(Lr;IIIIZ)V", line = 22)
    ...
    @OriginalMember(owner = "client!cj", name = "<init>", descriptor = "(Lch;IIII[[I[[II)V", line = 334)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(II)V", line = 43)
    public final void method33(int arg0, int arg1) {
        ++field6299;
    }

    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(BI)Z", line = 54)
    ...
    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(I)Luea;", line = 78)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(III[[ZZII)V", line = 106)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 114)
    ...
    @OriginalMember(owner = "client!cj", name = "ka", descriptor = "(III)V", line = 206)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIILhm;)V", line = 221)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Ljava/lang/String;Z)I", line = 280)
    ...
    @OriginalMember(owner = "client!cj", name = "fa", descriptor = "(IILr;)Lr;", line = 305)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIZI[[ZIII)V", line = 409)
    ...
    @OriginalMember(owner = "client!cj", name = "c", descriptor = "(I)V", line = 554)
    ...
    @OriginalMember(owner = "client!cj", name = "U", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 576)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(III[[ZZI)V", line = 652)
    ...
    @OriginalMember(owner = "client!cj", name = "YA", descriptor = "()V", line = 660)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIIIIII[[Z)V", line = 1264)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(B)V", line = 1461)
    public static void method2709(byte arg0) {
        int var1 = -14 / ((arg0 - 89) / 34);
        field6323 = null;
    }

    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lwh;[I)V", line = 1470)
    ...
    @OriginalMember(owner = "client!cj", name = "wa", descriptor = "(Lr;IIIIZ)V", line = 1478)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIIIIIII)V", line = 1500)
