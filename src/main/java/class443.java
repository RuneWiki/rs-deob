...
public class class443 extends class702 {
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ZI)V", line = 31)
    ...
    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(Lkga;Lwca;)V", line = 111)
    ...
    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(Z)Z", line = 126)
    ...
    @OriginalMember(owner = "client!ap", name = "c", descriptor = "(B)V", line = 140)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ZZ)V", line = 151)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(III)V", line = 163)
    ...
    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(II)V", line = 207)
    ...
    @OriginalMember(owner = "client!ap", name = "c", descriptor = "(II)I", line = 220)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Ljf;II)V", line = 231)
    ...
    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(I)[I", line = 241)
