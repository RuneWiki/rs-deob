...
public class class443 extends class767 implements class181 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(II)Lu;", line = 4)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "()V", line = 33)
    public static final void method3446() {
        class80.field1125 = class80.field1124;
    }

    @OriginalMember(owner = "client!km", name = "d", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(III[B)V", line = 48)
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(Lml;I[BIZ)V", line = 61)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(III)I", line = 69)
    ...
    @OriginalMember(owner = "client!km", name = "b", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IFIFFIII)[F", line = 98)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(Lqo;IIII)V", line = 181)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(B)J", line = 360)
    ...
    @OriginalMember(owner = "client!km", name = "b", descriptor = "(I)I", line = 373)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(I)I", line = 386)
