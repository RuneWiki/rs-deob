...
public class class443 extends class383 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;IZLjava/lang/String;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Lhs;FIFFIFFI[BIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(BI)I", line = 38)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IBI)I", line = 50)
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "([B)V", line = 61)
    public class443(byte[] arg0) {
        this.field6356 = arg0;
    }

    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(I)V", line = 74)
