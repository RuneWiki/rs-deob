...
public class class301 extends class120 implements Runnable {
    ...
    @OriginalMember(owner = "client!pr", name = "run", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(I)Z", line = 26)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(Lbk;)V", line = 92)
