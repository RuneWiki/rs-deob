...
public class class301 extends class376 implements class249 {
    ...
    @OriginalMember(owner = "client!io", name = "finalize", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ZII)V", line = 16)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(III)Z", line = 44)
    ...
    @OriginalMember(owner = "client!io", name = "d", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IIIILrd;)V", line = 128)
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Lfd;III)V", line = 182)
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Lfd;IIII)V", line = 197)
