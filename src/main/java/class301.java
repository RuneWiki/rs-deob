...
public class class301 {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(ZII)Z")
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(BI)Lqm;")
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(Loda;ILdda;)V")
