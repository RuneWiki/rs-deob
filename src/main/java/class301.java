...
public abstract class class301 extends class216 {
    ...
    @OriginalMember(owner = "client!je", name = "c", descriptor = "(Z)V", line = 11)
    ...
    @OriginalMember(owner = "client!je", name = "f", descriptor = "(I)Z", line = 23)
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "(IIIZZ)V", line = 89)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(ZLim;)V", line = 42)
