...
public abstract class class301 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(III)Lrr;")
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IILeo;Lqa;I)V")
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Lsj;I)V")
