...
public class class301 extends class449 {
    ...
    @OriginalMember(owner = "client!qm", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ILae;)V", line = 16)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(II)V", line = 39)
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "()V", line = 57)
    public class301() {
    }

    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(J)V", line = 65)
