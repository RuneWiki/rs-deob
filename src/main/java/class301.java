...
public class class301 {
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(Lek;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(IIIIIZ)V", line = 60)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(BLek;)V", line = 156)
