...
public class class301 {
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(IB)V", line = 9)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 51)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(Z)V", line = 63)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(ILji;)V", line = 81)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(IILji;)V", line = 101)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(II)Z", line = 194)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(B)V", line = 226)
