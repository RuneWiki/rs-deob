...
public class class301 {
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lud;IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lud;B)V", line = 235)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(II)V", line = 255)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(I)V", line = 305)
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(I)V", line = 321)
    ...
    @OriginalMember(owner = "client!nb", name = "c", descriptor = "(I)I", line = 342)
