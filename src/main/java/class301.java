...
public class class301 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IIIBIII)Llj;", line = 4)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(ILal;)I", line = 28)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IIILjava/lang/String;I)V", line = 54)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(II)V", line = 189)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Lsp;I)I", line = 211)
