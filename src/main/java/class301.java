...
public class class301 {
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(Le;I)V", line = 23)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!ofa", name = "b", descriptor = "(I)V", line = 70)
