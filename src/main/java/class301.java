...
public class class301 extends class515 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "()Lef;", line = 3)
    public final class515 method1136() {
        return (class515) this.field4866.method3216(true);
    }

    @OriginalMember(owner = "client!ao", name = "b", descriptor = "([III)V", line = 13)
    ...
    @OriginalMember(owner = "client!ao", name = "c", descriptor = "([III)V", line = 62)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!ao", name = "f", descriptor = "()V", line = 84)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lac;Lnf;)V", line = 101)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(Lef;)V", line = 109)
    public final synchronized void method2594(class515 arg0) {
        arg0.method4173(-1);
    }

    @OriginalMember(owner = "client!ao", name = "c", descriptor = "()I", line = 112)
    public final int method1108() {
        return 0;
    }

    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lnf;)V", line = 169)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lef;)V", line = 185)
    public final synchronized void method2596(class515 arg0) {
        this.field4866.method3221(arg0, (byte) 81);
    }

    @OriginalMember(owner = "client!ao", name = "e", descriptor = "()I", line = 188)
    public final synchronized int method2597() {
        return this.field4866.method3222(false);
    }

    @OriginalMember(owner = "client!ao", name = "d", descriptor = "()Lef;", line = 191)
