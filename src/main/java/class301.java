...
public class class301 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IIIIIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(Z)V", line = 54)
