...
public abstract class class301 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(III)Z", line = 8)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IIZIIIII)V", line = 35)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(B)V", line = 100)
