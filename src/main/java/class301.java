...
public class class301 {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(II)Lea;", line = 3)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(IZII)I", line = 37)
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(Lci;ILg;)V", line = 75)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(B)V", line = 103)
