...
public class class301 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(III)I", line = 4)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(Ldg;)V", line = 46)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "()V", line = 106)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(II)[I", line = 116)
