...
public class class301 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IILvg;)V", line = 5)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(B)V", line = 334)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(BII)V", line = 345)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(BI)V", line = 358)
