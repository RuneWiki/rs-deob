...
public class class301 extends class739 {
    ...
    @OriginalMember(owner = "client!ofa", name = "b", descriptor = "(II)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!ofa", name = "d", descriptor = "(Z)V", line = 101)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(Lsl;IB)V", line = 113)
    ...
    @OriginalMember(owner = "client!ofa", name = "<init>", descriptor = "()V", line = 269)
    public class301() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(IZBII)V", line = 191)
    ...
    @OriginalMember(owner = "client!ofa", name = "c", descriptor = "(III)B", line = 222)
    ...
    @OriginalMember(owner = "client!ofa", name = "c", descriptor = "(I)V", line = 241)
    ...
    @OriginalMember(owner = "client!ofa", name = "e", descriptor = "(Z)V", line = 274)
