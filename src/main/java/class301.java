...
public class class301 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(ILum;ILuo;)V", line = 5)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(BILum;)V", line = 164)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(ILum;I)V", line = 552)
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(Lum;)V", line = 720)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(ILum;)V", line = 576)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Lum;I)V", line = 589)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IIIIZIII)V", line = 610)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IIB)Z", line = 665)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(BLum;)V", line = 679)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(I)V", line = 704)
