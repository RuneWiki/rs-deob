...
public class class301 extends class489 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "([B[I[IIIIIIIIIIILea;II)V")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(CIIIZLea;II)V")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "([B[IIIIIIIIIIILea;II)V")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "([B[I[IIIIIII)V")
    ...
    @OriginalMember(owner = "client!jc", name = "B", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "(Lo;Leu;[Lwe;[I[I)V")
