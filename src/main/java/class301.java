...
public class class301 extends class194 {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ZILjava/lang/String;Lwo;)Lv;", line = 3)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "()V", line = 415)
    public class301() {
        super(1, false);
    }

    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IIBI)V", line = 72)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(II)[[I", line = 189)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ZIBIII)V", line = 263)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IIII)V", line = 421)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IILbg;)V", line = 445)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(IIII)V", line = 501)
    ...
    @OriginalMember(owner = "client!cc", name = "h", descriptor = "(I)I", line = 555)
