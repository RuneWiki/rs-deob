...
public class class301 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(II)Lkb;", line = 3)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(IZ)I", line = 76)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(B)V", line = 112)
