...
public class class301 extends class420 {
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!es", name = "c", descriptor = "(B)I", line = 67)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(BI)V", line = 83)
    ...
    @OriginalMember(owner = "client!es", name = "c", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!es", name = "d", descriptor = "(B)I", line = 142)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(B)Lmc;", line = 167)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IBI)Lvl;", line = 262)
    ...
    @OriginalMember(owner = "client!es", name = "d", descriptor = "(I)I", line = 474)
    ...
    @OriginalMember(owner = "client!es", name = "e", descriptor = "(B)V", line = 486)
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(ILcq;Lcq;Lsp;Lnb;IIZ)V", line = 763)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(II)I", line = 677)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IZ)[B", line = 700)
    ...
    @OriginalMember(owner = "client!es", name = "e", descriptor = "(I)I", line = 719)
