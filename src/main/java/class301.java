...
public class class301 {
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "([Lrfa;II)V")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(II)Lsaa;")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(Lu;Z)Z")
