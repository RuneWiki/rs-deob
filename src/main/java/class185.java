...
public abstract class class185 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!ua", name = "y", descriptor = "Lwa;")
    public static class203 field3512 = new class203(5000);

    @OriginalMember(owner = "client!ua", name = "M", descriptor = "I")
    public static int field3524 = 0;

    @OriginalMember(owner = "client!ua", name = "J", descriptor = "Llf;")
    private static class109 field3521 = class35.method275("Login", 2);

    @OriginalMember(owner = "client!ua", name = "O", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ua", name = "L", descriptor = "Llf;")
    public static class109 field3523 = class35.method275("hitmarks", 2);

    @OriginalMember(owner = "client!ua", name = "T", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ua", name = "S", descriptor = "Lbg;")
    ...
    @OriginalMember(owner = "client!ua", name = "providesignlink", descriptor = "(Lke;)V")
