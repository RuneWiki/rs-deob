...
public class class185 extends class40 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(BLpn;)I")
    ...
    @OriginalMember(owner = "client!on", name = "h", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(IILlf;)V")
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(IIBLvq;IIIII)V")
