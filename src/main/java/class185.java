...
public class class185 extends class42 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(Lau;)V", line = 84)
    public class185(class528 arg0) {
        this.field2736 = arg0;
    }

    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IZI)Z", line = 23)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Z)V", line = 59)
