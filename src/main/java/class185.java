...
public class class185 extends class45 {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Llm;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ILnj;)Llj;", line = 20)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(I[B)Lep;", line = 36)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(II)V", line = 115)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Lcd;IIZ)V", line = 159)
    ...
    @OriginalMember(owner = "client!u", name = "d", descriptor = "(I)V", line = 217)
