...
public class class185 extends class499 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IILmd;)V", line = 12)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(III)Lht;", line = 29)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ILmd;)V", line = 45)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(I)V", line = 65)
