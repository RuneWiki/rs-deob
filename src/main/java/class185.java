...
public class class185 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(II)Loq;", line = 3)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(BI)V", line = 44)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IIB)B", line = 80)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "(Lee;ILul;)V", line = 129)
