...
public abstract class class185 {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ILtq;)Lsd;", line = 13)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "([BB)Z", line = 24)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(B)V", line = 49)
