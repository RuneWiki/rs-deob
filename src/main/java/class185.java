...
public class class185 extends class14 implements class415 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "()Ln;", line = 9)
    ...
    @OriginalMember(owner = "client!ja", name = "finalize", descriptor = "()V", line = 23)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(III[I)V", line = 29)
    public final void method142(int arg0, int arg1, int arg2, int[] arg3) {
        this.method1250(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "()V", line = 31)
    public class185() {
        this.method1251();
    }
