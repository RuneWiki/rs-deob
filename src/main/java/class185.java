...
public class class185 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(IIZ)Z", line = 4)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(IB)V", line = 15)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(BI)Ljn;", line = 58)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!fq", name = "b", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ILoa;Le;)V", line = 117)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(B[B)Ljava/lang/String;", line = 345)
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(Ljda;ILjo;)V", line = 429)
