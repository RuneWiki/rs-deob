...
public class class185 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lgk;)V", line = 16)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(I)I", line = 23)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "()V", line = 41)
    public class185() {
        this.field2729[0] = 0;
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "(Lgk;)V", line = 55)
