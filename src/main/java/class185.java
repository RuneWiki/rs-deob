...
public abstract class class185 {
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(I)I", line = 18)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(ILsl;IIIIIIIII)Z", line = 38)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "([BBI)I", line = 285)
