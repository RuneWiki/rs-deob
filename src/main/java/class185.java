...
public class class185 implements Runnable {
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(I)Lqo;", line = 5)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(B)I", line = 20)
    ...
    @OriginalMember(owner = "client!efa", name = "b", descriptor = "(I)I", line = 32)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(Lsa;Z)V", line = 51)
    ...
    @OriginalMember(owner = "client!efa", name = "c", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!efa", name = "b", descriptor = "(B)J", line = 82)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(ICB)I", line = 93)
    ...
    @OriginalMember(owner = "client!efa", name = "c", descriptor = "(B)I", line = 111)
    ...
    @OriginalMember(owner = "client!efa", name = "d", descriptor = "(B)Z", line = 136)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(Ljava/lang/String;ILqo;JI)V", line = 148)
    ...
    @OriginalMember(owner = "client!efa", name = "run", descriptor = "()V", line = 174)
    ...
    @OriginalMember(owner = "client!efa", name = "e", descriptor = "(B)V", line = 304)
    ...
    @OriginalMember(owner = "client!efa", name = "f", descriptor = "(B)Ljava/lang/String;", line = 315)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(IZI)Z", line = 331)
