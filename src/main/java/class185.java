...
public class class185 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(II)Lmaa;")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IIIILjava/lang/String;Ldd;ILra;Lpa;Lwca;BI)V")
    ...
    @OriginalMember(owner = "client!dj", name = "<init>", descriptor = "(Loda;ILdda;Ldda;)V")
