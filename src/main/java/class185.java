...
public class class185 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(I)Z", line = 10)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IIII)I", line = 38)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IIIIIII)V", line = 60)
