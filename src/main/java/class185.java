...
public class class185 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lqi;I)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lqi;)V")
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(Lqi;)V")
    ...
    @OriginalMember(owner = "client!ko", name = "c", descriptor = "(Lqi;)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lqi;Lnd;)V")
