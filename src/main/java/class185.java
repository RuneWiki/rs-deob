...
public class class185 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 11)
    public class185(Throwable arg0, String arg1) {
        this.field2532 = arg0;
        this.field2533 = arg1;
    }

    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!jk", name = "b", descriptor = "(I)V", line = 41)
