...
public class class185 {
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(I[B)Lht;")
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(I)Ltw;")
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(Ltw;Z)V")
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(IIII)Lec;")
