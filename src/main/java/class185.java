...
public class class185 extends class81 {
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(IBIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(IILka;II)Loia;", line = 42)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(IIIIIIII)V", line = 66)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(IB)I", line = 269)
    ...
    @OriginalMember(owner = "client!efa", name = "b", descriptor = "(I)V", line = 317)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(I)Ltd;", line = 328)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(Z)[Lhda;", line = 395)
    ...
    @OriginalMember(owner = "client!efa", name = "<init>", descriptor = "(Luv;IIIIII)V", line = 409)
