...
public class class185 extends class11 {
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "()V", line = 3)
    public class185() {
        super(1, false);
    }

    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lsi;II)V", line = 8)
    ...
    @OriginalMember(owner = "client!kd", name = "d", descriptor = "(II)[I", line = 46)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(II)[[I", line = 99)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "([I[ILdw;[II)V", line = 179)
