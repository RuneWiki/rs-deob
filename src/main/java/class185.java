...
public class class185 extends class134 {
    ...
    @OriginalMember(owner = "client!u", name = "c", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!u", name = "d", descriptor = "(Z)I", line = 23)
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "(II[I[I)V", line = 45)
