...
public class class185 extends class411 {
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(II[IIIZIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(Z)V", line = 65)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(IIILha;ILqg;)V", line = 78)
    ...
    @OriginalMember(owner = "client!hga", name = "<init>", descriptor = "(Leq;IIIIZ[BIZ)V", line = 134)
    ...
    @OriginalMember(owner = "client!hga", name = "<init>", descriptor = "(Leq;IIIII)V", line = 190)
    ...
    @OriginalMember(owner = "client!hga", name = "<init>", descriptor = "(Leq;IIIIZ[FI)V", line = 204)
    ...
    @OriginalMember(owner = "client!hga", name = "<init>", descriptor = "(Leq;IIII)V", line = 232)
    ...
    @OriginalMember(owner = "client!hga", name = "d", descriptor = "(B)V", line = 246)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(IIIIIII)V", line = 256)
    ...
    @OriginalMember(owner = "client!hga", name = "e", descriptor = "(Z)Lkl;", line = 271)
    ...
    @OriginalMember(owner = "client!hga", name = "b", descriptor = "(II)V", line = 293)
    ...
    @OriginalMember(owner = "client!hga", name = "<init>", descriptor = "(Leq;IIIIZ[IIIZ)V", line = 316)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(IZI)B", line = 371)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(IIZ[BIIIIII)V", line = 390)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(IZZ)V", line = 446)
