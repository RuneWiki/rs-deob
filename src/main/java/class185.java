...
public class class185 {
    ...
    @OriginalMember(owner = "client!tca", name = "b", descriptor = "(II)Ljj;")
    ...
    @OriginalMember(owner = "client!tca", name = "<init>", descriptor = "(Lmja;ILbt;)V")
    public class185(class441 arg0, int arg1, class48 arg2) {
        this.field2237 = arg2;
        this.field2237.method431(4, 29);
    }

    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(IIIIILpaa;)Lsj;")
