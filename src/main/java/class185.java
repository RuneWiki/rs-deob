...
public class class185 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IZII)V", line = 5)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Leo;I)V", line = 36)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IIZ)Z", line = 78)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IIIII)Llb;", line = 92)
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(IIIIIIIIIZ)V", line = 113)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(B)V", line = 133)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IIILnm;Lnm;)V", line = 148)
