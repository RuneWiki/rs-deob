...
public class class185 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(ILtj;)V")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(ILkg;BI)V")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IZLsj;)V")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Ljava/lang/String;Lde;II)Lvc;")
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Lqa;ZI)V")
