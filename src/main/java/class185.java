...
public class class185 extends class279 implements class448 {
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(B)Z", line = 3)
    public final boolean method38(byte arg0) {
        ++field2414;
        return arg0 != -89 ? true : this.field2412.method2545(11802);
    }

    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(B)I", line = 15)
    public final int method48(byte arg0) {
        ++field2399;
        return arg0 != -70 ? 72 : this.field2412.field5977;
    }

    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(BLza;)V", line = 27)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ILza;)V", line = 38)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(I)I", line = 49)
    ...
    @OriginalMember(owner = "client!mm", name = "c", descriptor = "(B)Z", line = 60)
    ...
    @OriginalMember(owner = "client!mm", name = "c", descriptor = "(Z)V", line = 75)
    ...
    @OriginalMember(owner = "client!mm", name = "e", descriptor = "(I)I", line = 92)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IBLza;)Le;", line = 113)
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Lza;Ler;IIIIIZIIIIIII)V", line = 124)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IIIZILot;Lza;)V", line = 133)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(BLza;)Luc;", line = 143)
    ...
    @OriginalMember(owner = "client!mm", name = "d", descriptor = "(B)V", line = 185)
    ...
    @OriginalMember(owner = "client!mm", name = "c", descriptor = "(BLza;)V", line = 197)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ILza;BI)Z", line = 228)
    ...
    @OriginalMember(owner = "client!mm", name = "c", descriptor = "(I)I", line = 248)
