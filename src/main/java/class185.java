...
public class class185 extends OutputStream {
    ...
    @OriginalMember(owner = "client!sba", name = "write", descriptor = "(I)V", line = 7)
    public final void write(int arg0) throws IOException {
        field2776++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!sba", name = "b", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(IBI)I", line = 68)
