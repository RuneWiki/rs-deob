...
public abstract class class185 extends class68 {
    ...
    @OriginalMember(owner = "client!sm", name = "f", descriptor = "(B)Lid;", line = 3)
    ...
    @OriginalMember(owner = "client!sm", name = "d", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIZZB)V", line = 29)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ZLmv;)V", line = 255)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IBIIII)V", line = 328)
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(IIIZZ)V", line = 382)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(II)I", line = 365)
