...
public class class185 extends class27 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(IILvf;)V")
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(Llj;)V")
    ...
    @OriginalMember(owner = "client!fq", name = "c", descriptor = "(B)[Lbaa;")
