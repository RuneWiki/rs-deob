...
public class class185 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIIILqa;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIIZ)I", line = 120)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(I)V", line = 149)
