...
public class class185 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(BLnn;)Lnf;")
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Z)Lpn;")
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(I)Lpn;")
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IBLnn;)V")
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Lnn;I)V")
