...
public abstract class class185 extends class693 {
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(ILmk;)V", line = 3)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(BC)Z", line = 57)
    ...
    @OriginalMember(owner = "client!aba", name = "d", descriptor = "(I)Z", line = 72)
    ...
    @OriginalMember(owner = "client!aba", name = "b", descriptor = "(ILha;)Z", line = 115)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "([Lih;Z)I", line = 128)
    ...
    @OriginalMember(owner = "client!aba", name = "j", descriptor = "(I)V", line = 298)
    ...
    @OriginalMember(owner = "client!aba", name = "<init>", descriptor = "(IIIIIIIIIZB)V", line = 308)
    ...
    @OriginalMember(owner = "client!aba", name = "i", descriptor = "(I)V", line = 329)
