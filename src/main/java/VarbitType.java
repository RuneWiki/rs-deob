...
public class VarbitType {
    ...
    @OriginalMember(owner = "client!rc", name = "e", descriptor = "[Lrc;")
    public static VarbitType[] field1175;

    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ILyb;)V")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lmb;IZ)V")
