...
public class VarbitType {
    ...
    @OriginalMember(owner = "client!qc", name = "c", descriptor = "[Lqc;")
    public static VarbitType[] field1172;

    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lxb;I)V")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ZLlb;I)V")
