...
public class VarbitType {
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "[Lqc;")
    public static VarbitType[] field1144;

    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lyb;Z)V")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IILmb;)V")
