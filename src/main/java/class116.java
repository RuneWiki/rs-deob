...
public abstract class class116 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ILin;I)V")
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ILin;ILin;ILin;III[ZZILin;BI)V")
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ILin;ZIIIILin;[III)V")
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IIILdn;III)V")
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IZIIILin;Lin;II)V")
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ZIILak;ZI[IB[ZLog;Log;I)V")
