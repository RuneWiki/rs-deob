...
public class class116 {
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "([BIII)Ljava/lang/String;", line = 15)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Lfh;I)V", line = 108)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(BLfh;I)V", line = 139)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Z)V", line = 386)
