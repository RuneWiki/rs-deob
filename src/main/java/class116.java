...
public class class116 extends class129 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Ldm;I)V")
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Lya;Z)V")
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(IILya;ILor;IZ)V")
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Lya;II)Z")
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Lya;I)Lag;")
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(BLya;II)Z")
