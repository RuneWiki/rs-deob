...
public class class116 {
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(II)Lhg;", line = 29)
    ...
    @OriginalMember(owner = "client!lfa", name = "b", descriptor = "(II)V", line = 62)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(IZII)I", line = 77)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!lfa", name = "c", descriptor = "(II)Lgw;", line = 116)
    ...
    @OriginalMember(owner = "client!lfa", name = "<init>", descriptor = "(Lsj;ILin;Lin;Lin;)V", line = 149)
