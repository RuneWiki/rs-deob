...
public class class116 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lap;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(ZLao;)Z", line = 18)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "()V", line = 61)
    public class116() {
        this.field1630 = 0;
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Lap;)V", line = 77)
