...
public class class116 {
    ...
    @OriginalMember(owner = "client!jja", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!jja", name = "a", descriptor = "(III)V", line = 16)
    ...
    @OriginalMember(owner = "client!jja", name = "a", descriptor = "([SZ[Ljava/lang/String;)V", line = 35)
    ...
    @OriginalMember(owner = "client!jja", name = "a", descriptor = "(IIIIIII)V", line = 49)
