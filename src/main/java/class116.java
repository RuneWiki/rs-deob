...
public class class116 {
    ...
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(ZLmca;)[Lpi;")
    ...
    @OriginalMember(owner = "client!rja", name = "<init>", descriptor = "(Lko;)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!rja", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
