...
public class class116 {
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(BLlo;)V")
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Lam;I)V")
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Lam;B)V")
