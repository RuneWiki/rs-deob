...
public class class116 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 13)
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "(I)V", line = 44)
    public class116(int arg0) {
        this.field1343 = arg0;
    }

    @OriginalMember(owner = "client!hh", name = "toString", descriptor = "()Ljava/lang/String;", line = 53)
