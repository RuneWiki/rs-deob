...
public class class116 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IBIIILhe;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;I)V", line = 48)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Ljava/lang/Object;ZB)[B", line = 63)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(III)Lri;", line = 102)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IIIIBII)V", line = 109)
    ...
    @OriginalMember(owner = "client!ed", name = "toString", descriptor = "()Ljava/lang/String;", line = 171)
