...
public class class116 extends class516 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lpb;II)V")
    ...
    @OriginalMember(owner = "client!mc", name = "<init>", descriptor = "(Lcb;)V")
    ...
    @OriginalMember(owner = "client!mc", name = "c", descriptor = "(B)Z")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lqa;ILls;)I")
