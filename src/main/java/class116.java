...
public class class116 extends class239 implements class743 {
    ...
    @OriginalMember(owner = "client!qda", name = "b", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(BI)V", line = 16)
    ...
    @OriginalMember(owner = "client!qda", name = "b", descriptor = "(B)Z", line = 30)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;", line = 41)
    ...
    @OriginalMember(owner = "client!qda", name = "<init>", descriptor = "(Lom;Lal;Z)V", line = 58)
    public class116(class642 arg0, class121 arg1, boolean arg2) {
        super(arg0, 34963, arg2);
        this.field1795 = arg1;
    }

    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(B)I", line = 66)
    ...
    @OriginalMember(owner = "client!qda", name = "b", descriptor = "(I)V", line = 86)
    public final void method697(int arg0) {
        super.method697(arg0);
        ++field1803;
    }

    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(I)Lal;", line = 96)
