...
public class class116 extends class30 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(I)J", line = 56)
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(B)J", line = 90)
