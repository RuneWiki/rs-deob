...
public class class116 {
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(II)V", line = 19)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(I)I", line = 49)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(IIIIIIIIBI)Z", line = 60)
    ...
    @OriginalMember(owner = "client!bba", name = "<init>", descriptor = "()V", line = 98)
    public class116() {
    }

    @OriginalMember(owner = "client!bba", name = "b", descriptor = "(I)I", line = 107)
    ...
    @OriginalMember(owner = "client!bba", name = "<init>", descriptor = "(Lsl;)V", line = 117)
