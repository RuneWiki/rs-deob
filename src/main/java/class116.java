...
public class class116 {
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(III)I", line = 7)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(CI)Z", line = 24)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(B)V", line = 70)
