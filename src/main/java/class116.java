...
public class class116 implements Runnable {
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!eea", name = "run", descriptor = "()V", line = 46)
    ...
    @OriginalMember(owner = "client!eea", name = "b", descriptor = "(B)V", line = 89)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(IB)Leq;", line = 102)
