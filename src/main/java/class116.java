...
public class class116 {
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(BLjava/awt/Frame;Lfq;)V", line = 7)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IIBI)I", line = 42)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!ld", name = "b", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IIIII)V", line = 90)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IIIIIIIBII)V", line = 109)
