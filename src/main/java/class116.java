...
public class class116 {
    ...
    @OriginalMember(owner = "client!qv", name = "b", descriptor = "(I)V", line = 279)
    ...
    @OriginalMember(owner = "client!qv", name = "c", descriptor = "(I)I", line = 291)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Z)V", line = 303)
    ...
    @OriginalMember(owner = "client!qv", name = "d", descriptor = "(I)I", line = 317)
    ...
    @OriginalMember(owner = "client!qv", name = "e", descriptor = "(I)V", line = 329)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(ZILqu;)V", line = 358)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(IB)V", line = 423)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Lfi;I)V", line = 435)
    ...
    @OriginalMember(owner = "client!qv", name = "f", descriptor = "(I)V", line = 446)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(ZIBII)Lkd;", line = 477)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(B)Z", line = 520)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(BZ)V", line = 531)
    ...
    @OriginalMember(owner = "client!qv", name = "g", descriptor = "(I)V", line = 561)
    ...
    @OriginalMember(owner = "client!qv", name = "h", descriptor = "(I)V", line = 588)
    ...
    @OriginalMember(owner = "client!qv", name = "b", descriptor = "(B)V", line = 602)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Llq;III)V", line = 620)
    ...
    @OriginalMember(owner = "client!qv", name = "i", descriptor = "(I)Z", line = 667)
    ...
    @OriginalMember(owner = "client!qv", name = "j", descriptor = "(I)V", line = 678)
