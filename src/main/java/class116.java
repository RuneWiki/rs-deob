...
public class class116 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IILjava/lang/String;IIIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(I[Lf;)V", line = 49)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(ILoq;IBB)V", line = 77)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 113)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(BI)Z", line = 147)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(II)I", line = 171)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(BLdh;)V", line = 191)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(ILdh;I)V", line = 215)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(II)Ljava/lang/String;", line = 268)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(I)V", line = 288)
