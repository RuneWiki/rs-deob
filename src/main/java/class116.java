...
public class class116 {
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(IZ[[ZIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(III)Z", line = 211)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(B)V", line = 222)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(IIIII)V", line = 258)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(Lr;IBI)V", line = 303)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(Lr;BII)V", line = 389)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(I)V", line = 461)
    ...
    @OriginalMember(owner = "client!bba", name = "<init>", descriptor = "(Luv;Lsi;)V", line = 474)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(ILr;II)Z", line = 489)
