...
public class class116 extends class14 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IZI)Z", line = 7)
    ...
    @OriginalMember(owner = "client!ei", name = "e", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(BLjs;)[Lfg;", line = 36)
    ...
    @OriginalMember(owner = "client!ei", name = "c", descriptor = "(III)Z", line = 79)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "()V", line = 229)
    public class116() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(ILjava/lang/String;III)V", line = 109)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(II)I", line = 246)
    public static final int method797(int arg0, int arg1) {
        ++field1644;
        return arg1 != 255 ? -74 : arg0 & 255;
    }

    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IB)[I", line = 265)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(B)V", line = 315)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lpc;IIB)Lwp;", line = 325)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IBLmd;)V", line = 342)
