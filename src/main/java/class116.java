...
public class class116 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(B)[[I", line = 11)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!so", name = "b", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(BI)[I", line = 83)
    ...
    @OriginalMember(owner = "client!so", name = "b", descriptor = "(B)V", line = 151)
    ...
    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "(III)V", line = 274)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(ZLjava/lang/String;B)V", line = 180)
