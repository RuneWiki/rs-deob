...
public class class116 extends class276 {
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ILec;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "([IZII)V", line = 28)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(IIIIIII)I", line = 43)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "([IIBI)V", line = 90)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(BII)Z", line = 103)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(III)Z", line = 118)
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(IIII)Z", line = 136)
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(IIIIIIIII)V", line = 161)
