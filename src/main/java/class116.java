...
public class class116 extends class366 {
    ...
    @OriginalMember(owner = "client!eda", name = "c", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(III)I", line = 19)
    ...
    @OriginalMember(owner = "client!eda", name = "d", descriptor = "(I)Lrk;", line = 37)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IIBI)Loda;", line = 53)
