...
public class class116 extends class69 {
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(II[BI)Ljava/lang/String;", line = 12)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(IIIZ)V", line = 87)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(II)J", line = 104)
