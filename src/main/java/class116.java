...
public class class116 extends class748 {
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Lpaa;I)V")
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(IZLvj;)V")
    ...
    @OriginalMember(owner = "client!wea", name = "g", descriptor = "(I)Lqc;")
    ...
    @OriginalMember(owner = "client!wea", name = "d", descriptor = "(B)V")
