...
public class class116 {
    ...
    @OriginalMember(owner = "client!nu", name = "listmodes", descriptor = "()[I", line = 8)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(ILjava/awt/Frame;)V", line = 31)
    ...
    @OriginalMember(owner = "client!nu", name = "exit", descriptor = "()V", line = 77)
    ...
    @OriginalMember(owner = "client!nu", name = "enter", descriptor = "(Ljava/awt/Frame;IIII)V", line = 99)
    ...
    @OriginalMember(owner = "client!nu", name = "<init>", descriptor = "()V", line = 158)
