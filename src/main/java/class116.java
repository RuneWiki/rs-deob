...
public abstract class class116 implements class615 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Ljaclib/memory/Source;II)Z")
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(BLjaggl/MapBuffer;)Z")
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(ZLjaggl/MapBuffer;B)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(Lko;IZ)V")
