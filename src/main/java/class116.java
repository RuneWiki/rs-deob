...
public class class116 extends class113 {
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Lgk;II[B)V", line = 6)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(BII)Lbm;", line = 18)
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(Z)V", line = 40)
