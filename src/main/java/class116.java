...
public class class116 extends class604 {
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(Lmfa;Lmfa;IB)V")
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(Ljava/io/File;I)[B")
    ...
    @OriginalMember(owner = "client!oda", name = "d", descriptor = "(B)Z")
    ...
    @OriginalMember(owner = "client!oda", name = "<init>", descriptor = "(Leea;)V")
    public class116(class131 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(IIC)C")
    ...
    @OriginalMember(owner = "client!oda", name = "c", descriptor = "(B)I")
    ...
    @OriginalMember(owner = "client!oda", name = "b", descriptor = "(B)Z")
