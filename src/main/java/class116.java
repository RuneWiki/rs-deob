...
public class class116 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lsq;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lsq;Ljp;)V", line = 348)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lsq;)V", line = 581)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(Lsq;)V", line = 589)
    ...
    @OriginalMember(owner = "client!ta", name = "c", descriptor = "(Lsq;)V", line = 596)
