...
public class class116 extends class25 {
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "(Lnq;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "(Lnq;IIII[I)V")
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "(Lnq;IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "(Lnq;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "(Lnq;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "(Lnq;IIIZ[I)V")
