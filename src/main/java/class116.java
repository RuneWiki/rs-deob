...
public class class116 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Ldp;II)Lao;", line = 10)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "()Lhk;", line = 19)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "()I", line = 24)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Lec;)V", line = 129)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "()V", line = 149)
    private class116() {
    }

    @OriginalMember(owner = "client!ao", name = "c", descriptor = "()[B", line = 71)
