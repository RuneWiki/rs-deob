...
public class class116 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(BILui;)Lis;")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lvk;BILjava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lvk;I)V")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ILje;)Z")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lvk;Ljava/lang/Object;I)V")
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(Lvk;I)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lmn;Z)V")
