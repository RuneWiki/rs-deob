...
public class class116 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "Llf;")
    public static class109 field2293 = class35.method275("leuchten1:", 2);

    @OriginalMember(owner = "client!md", name = "d", descriptor = "Llf;")
    public static class109 field2296 = null;

    @OriginalMember(owner = "client!md", name = "b", descriptor = "I")
    public static int field2294 = 0;

    @OriginalMember(owner = "client!md", name = "k", descriptor = "[Llf;")
    public static class109[] field2303 = new class109[100];

    @OriginalMember(owner = "client!md", name = "g", descriptor = "Llf;")
    public static class109 field2299 = class35.method275("Stufe)2", 2);

    @OriginalMember(owner = "client!md", name = "h", descriptor = "[Llf;")
    public static class109[] field2300 = new class109[1000];

    @OriginalMember(owner = "client!md", name = "l", descriptor = "Llf;")
    private static class109 field2304 = class35.method275("scroll:", 2);

    @OriginalMember(owner = "client!md", name = "j", descriptor = "Llf;")
    public static class109 field2302 = field2304;

    @OriginalMember(owner = "client!md", name = "i", descriptor = "Llf;")
    public static class109 field2301 = field2304;

    @OriginalMember(owner = "client!md", name = "m", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(BLbg;I)Lmb;")
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IILoh;)V")
