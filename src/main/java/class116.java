...
public class class116 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ILjf;IILen;IILhm;I)V", line = 34)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(BIIIILen;Lbb;)Lmj;", line = 136)
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(I)V", line = 325)
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(III)V", line = 368)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Lbb;II[Lok;IIIILbb;IZBLen;)Lmj;", line = 390)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ZB)V", line = 884)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Z[II[III)V", line = 898)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IILbb;IIIIILen;I)Lmj;", line = 949)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(B)V", line = 1095)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IIIIIZ)V", line = 1115)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(II)V", line = 1308)
