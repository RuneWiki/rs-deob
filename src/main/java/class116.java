...
public class class116 implements class23 {
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(IIIIIIZZ)V", line = 8)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(ILkn;BII)V", line = 16)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(I)V", line = 180)
    public static final void method956(int arg0) {
        class362.field5097.method558(arg0);
        field1881++;
    }

    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(B)V", line = 189)
    ...
    @OriginalMember(owner = "client!lfa", name = "b", descriptor = "(IIIIIIZZ)V", line = 204)
    ...
    @OriginalMember(owner = "client!lfa", name = "b", descriptor = "(I)V", line = 212)
    ...
    @OriginalMember(owner = "client!lfa", name = "<init>", descriptor = "(Lgf;Lhu;Lve;)V", line = 225)
