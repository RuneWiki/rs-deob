...
public class class663 {
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(IIIIBII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/String;", line = 88)
    ...
    @OriginalMember(owner = "client!tda", name = "toString", descriptor = "()Ljava/lang/String;", line = 142)
