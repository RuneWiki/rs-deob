...
public class class663 extends class504 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lqc;Z)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lwm;II)Lne;")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IIILjha;ILft;ILih;)V")
