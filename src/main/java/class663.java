...
public class class663 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IIZIII)V", line = 174)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(CI)C", line = 269)
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "()V", line = 862)
    public class663() {
        this.field9343.field334 = this.field9343;
        this.field9343.field329 = this.field9343;
    }

    @OriginalMember(owner = "client!wn", name = "b", descriptor = "(I)Z", line = 673)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(B)Lir;", line = 685)
    ...
    @OriginalMember(owner = "client!wn", name = "c", descriptor = "(I)V", line = 705)
    ...
    @OriginalMember(owner = "client!wn", name = "d", descriptor = "(I)Lir;", line = 719)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Lir;I)V", line = 737)
    ...
    @OriginalMember(owner = "client!wn", name = "e", descriptor = "(I)Lir;", line = 756)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Z)I", line = 777)
    ...
    @OriginalMember(owner = "client!wn", name = "f", descriptor = "(I)Lir;", line = 808)
    ...
    @OriginalMember(owner = "client!wn", name = "g", descriptor = "(I)V", line = 836)
