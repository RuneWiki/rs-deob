...
public class class663 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Leea;Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "([BBZ)Ljava/lang/Object;", line = 216)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(I)V", line = 257)
    ...
    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "(I)V", line = 268)
