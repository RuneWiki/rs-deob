...
public class class663 extends class739 {
    ...
    @OriginalMember(owner = "client!bca", name = "b", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!bca", name = "c", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(Lsl;II)V", line = 36)
    ...
    @OriginalMember(owner = "client!bca", name = "d", descriptor = "(III)Z", line = 115)
    ...
    @OriginalMember(owner = "client!bca", name = "b", descriptor = "(II)V", line = 134)
    ...
    @OriginalMember(owner = "client!bca", name = "<init>", descriptor = "()V", line = 149)
    public class663() {
        super(0, true);
    }

    @OriginalMember(owner = "client!bca", name = "e", descriptor = "(B)V", line = 161)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(II)[I", line = 214)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(IIB)Z", line = 272)
