...
public class class663 extends class334 {
    ...
    @OriginalMember(owner = "client!wda", name = "g", descriptor = "(I)[B", line = 4)
    ...
    @OriginalMember(owner = "client!wda", name = "h", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!wda", name = "c", descriptor = "(I)I", line = 65)
    ...
    @OriginalMember(owner = "client!wda", name = "i", descriptor = "(I)V", line = 82)
