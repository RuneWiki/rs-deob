...
public class class663 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(ILgga;I)Lmq;", line = 3)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(BI)Lfp;", line = 32)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(II)V", line = 62)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "(Lmca;ILgga;)V", line = 96)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!jt", name = "b", descriptor = "(II)V", line = 125)
    ...
    @OriginalMember(owner = "client!jt", name = "b", descriptor = "(B)V", line = 142)
