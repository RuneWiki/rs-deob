...
public abstract class class663 {
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!sp", name = "b", descriptor = "(III)Lni;", line = 32)
