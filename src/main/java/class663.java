...
public class class663 extends class59 implements class532 {
    ...
    @OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Loa;Lya;Lqm;[Ldga;[Loia;)V", line = 3)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(CIIIZLaa;II)V", line = 31)
