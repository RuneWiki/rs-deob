...
public class class663 extends class657 {
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(IZLjava/awt/Component;)Lej;")
    ...
    @OriginalMember(owner = "client!tda", name = "<init>", descriptor = "(Lffa;)V")
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(IBLmw;)V")
