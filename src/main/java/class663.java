...
public class class663 {
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "([BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!wda", name = "<init>", descriptor = "(Llf;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!wda", name = "<init>", descriptor = "(Llf;Ljaclib/memory/Buffer;)V", line = 21)
