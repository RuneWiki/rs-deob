...
public class class663 extends class503 {
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lha;J[Lcba;[Lkw;Z)V")
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "([Lkw;Z)V")
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lha;J)Z")
    ...
    @OriginalMember(owner = "client!sp", name = "b", descriptor = "(IZ)Lsp;")
    ...
    @OriginalMember(owner = "client!sp", name = "e", descriptor = "()Lef;")
    public final class515 method3671() {
        return this.field9172;
    }

    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lha;[Lcba;Z)V")
    ...
    @OriginalMember(owner = "client!sp", name = "g", descriptor = "()Lef;")
