...
public class class663 {
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lwq;I)V")
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!gj", name = "<init>", descriptor = "(Lgda;)V")
