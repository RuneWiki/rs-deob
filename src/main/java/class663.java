...
public class class663 extends class192 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IB)[I", line = 5)
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(Z)V", line = 28)
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(BII)Z", line = 44)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IBIIIIIII)Z", line = 55)
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "()V", line = 74)
    public class663() {
        super(0, true);
    }
}
