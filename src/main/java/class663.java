...
public class class663 extends class366 {
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(CI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!lu", name = "c", descriptor = "(I)Lrda;", line = 26)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Z)Z", line = 37)
    public final boolean method1137(boolean arg0) {
        ++field9226;
        return !arg0;
    }

    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(ZI)V", line = 48)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(ZZ)V", line = 62)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(ILep;I)V", line = 72)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!lu", name = "b", descriptor = "(Z)V", line = 99)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IIZIIII)V", line = 115)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(III)V", line = 145)
    ...
    @OriginalMember(owner = "client!lu", name = "<init>", descriptor = "(Ler;)V", line = 157)
    public class663(class92 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Liaa;Z)V", line = 163)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IIIIIIIII)V", line = 212)
