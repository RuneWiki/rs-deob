...
public class class663 implements class243 {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(I)Lhs;")
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IIIIIIIIIILcu;Lkda;)V")
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IB[Ltp;)V")
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Lr;III[Z)Z")
