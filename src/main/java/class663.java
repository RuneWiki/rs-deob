...
public class class663 implements class52 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lv;BIZ)Lda;", line = 7)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "()V", line = 59)
    public final void method3729() {
        this.field9315 = Thread.currentThread();
        this.method3727();
    }

    @OriginalMember(owner = "client!qa", name = "b", descriptor = "()V", line = 71)
    public final void method3733() {
        this.field9315 = null;
        this.method3730();
    }

    @OriginalMember(owner = "client!qa", name = "finalize", descriptor = "()V", line = 83)
