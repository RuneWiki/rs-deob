...
public class class663 extends class619 {
    ...
    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "(Lgq;Lkfa;IIIIIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(ILjava/lang/String;)I", line = 16)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(III)Lfu;", line = 39)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(ILgaa;)V", line = 52)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(ILkha;)V", line = 68)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Z)Lqi;", line = 86)
