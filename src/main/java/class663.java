...
public class class663 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Lr;BII)V", line = 5)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ZI[[ZIZI)V", line = 96)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Lr;III)V", line = 294)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(II)V", line = 365)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ILr;II)Z", line = 383)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IIIII)V", line = 456)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(I)V", line = 500)
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(Lpga;Lsba;)V", line = 534)
