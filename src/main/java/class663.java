...
public class class663 {
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 3)
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(Lrv;B)V", line = 34)
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(BJ)V", line = 61)
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(JILjava/lang/Object;I)V", line = 75)
    ...
    @OriginalMember(owner = "client!lga", name = "b", descriptor = "(B)I", line = 102)
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(I)I", line = 113)
    ...
    @OriginalMember(owner = "client!lga", name = "b", descriptor = "(BJ)Ljava/lang/Object;", line = 140)
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(JLjava/lang/Object;I)V", line = 183)
    ...
    @OriginalMember(owner = "client!lga", name = "b", descriptor = "(I)V", line = 194)
    ...
    @OriginalMember(owner = "client!lga", name = "c", descriptor = "(B)I", line = 207)
    ...
    @OriginalMember(owner = "client!lga", name = "<init>", descriptor = "(I)V", line = 223)
    public class663(int arg0) {
        this(arg0, arg0);
    }

    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(CI)Z", line = 227)
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(BLac;)Lpe;", line = 249)
    ...
    @OriginalMember(owner = "client!lga", name = "d", descriptor = "(B)Ljava/lang/Object;", line = 275)
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(IZ)V", line = 315)
    ...
    @OriginalMember(owner = "client!lga", name = "c", descriptor = "(I)V", line = 366)
    ...
    @OriginalMember(owner = "client!lga", name = "<init>", descriptor = "(II)V", line = 394)
