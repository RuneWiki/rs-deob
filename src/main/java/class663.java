...
public class class663 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "([[BLgl;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(II)Lmca;", line = 55)
