...
public class class663 extends class362 implements class366 {
    ...
    @OriginalMember(owner = "client!ica", name = "b", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(B)C", line = 19)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!ica", name = "b", descriptor = "(B)J", line = 45)
    ...
    @OriginalMember(owner = "client!ica", name = "e", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 68)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(Z)I", line = 102)
