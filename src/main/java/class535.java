...
public class class535 extends class201 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "([B[IIIIIIIIIIILfa;II)V")
    ...
    @OriginalMember(owner = "client!fe", name = "q", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!fe", name = "<init>", descriptor = "(Llea;Lub;[Liba;[I[I)V")
    ...
    @OriginalMember(owner = "client!fe", name = "b", descriptor = "([B[IIIIIIIIIIILfa;II)V")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(CIIIZLfa;II)V")
