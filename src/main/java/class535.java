...
public class class535 implements class318 {
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(ILjava/lang/String;ILkw;)Ltn;", line = 3)
    ...
    @OriginalMember(owner = "client!rba", name = "b", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(B)V", line = 93)
    ...
    @OriginalMember(owner = "client!rba", name = "b", descriptor = "(Z)V", line = 105)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(IZLjava/lang/Object;)[B", line = 120)
    ...
    @OriginalMember(owner = "client!rba", name = "<init>", descriptor = "(Lla;Lfk;)V", line = 160)
    public class535(class423 arg0, class313 arg1) {
        this.field7782 = arg0;
        this.field7784 = arg1;
    }

    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Z)Z", line = 169)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(ZB)V", line = 184)
