...
public class class535 extends class55 implements class199 {
    ...
    @OriginalMember(owner = "client!v", name = "b", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IIII)V", line = 24)
    public final void method77(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!v", name = "e", descriptor = "()[Lfk;", line = 27)
    public final class604[] method85() {
        return this.field7802;
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IILq;Z)Z", line = 33)
    ...
    @OriginalMember(owner = "client!v", name = "finalize", descriptor = "()V", line = 37)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lda;IIIZ)V", line = 43)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "()V", line = 49)
    ...
    @OriginalMember(owner = "client!v", name = "d", descriptor = "()[Lnba;", line = 63)
    public final class271[] method95() {
        return this.field7801;
    }

    @OriginalMember(owner = "client!v", name = "f", descriptor = "()V", line = 77)
    public final void method114() {
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "([ILq;)V", line = 80)
    private final void method3146(int[] arg0, class394 arg1) {
        this.field7803.method282().method1371(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(I[IIIIIZ)V", line = 85)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;IZ)V", line = 95)
    public final void method86(class394 arg0, int arg1, boolean arg2) {
        this.method3144(((class92) arg0).nativeid, arg1, arg2);
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;Lmj;II)V", line = 98)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;Lmj;I)V", line = 116)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(BIZ)Lda;", line = 132)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;)V", line = 136)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IILq;ZI)Z", line = 191)
    public final boolean method124(int arg0, int arg1, class394 arg2, boolean arg3, int arg4) {
        return this.field7803.method282().method1363(this, arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!v", name = "g", descriptor = "()Z", line = 195)
    public final boolean method110() {
        return true;
    }

    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(Ll;Lm;Lkk;IIII)V", line = 201)
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(Ll;)V", line = 272)
