...
public class class535 extends class601 {
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IB)I", line = 21)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(II)V", line = 43)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(ILqea;)V", line = 53)
    public class535(int arg0, class339 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(I)I", line = 57)
    public final int method45(int arg0) {
        ++field7422;
        return super.field8137.method2161(arg0 ^ arg0) ? 1 : 0;
    }

    @OriginalMember(owner = "client!pd", name = "c", descriptor = "(I)I", line = 70)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(Lqea;)V", line = 84)
