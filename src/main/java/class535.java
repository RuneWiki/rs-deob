...
public abstract class class535 extends class42 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(BII)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(I)I", line = 44)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(B)I", line = 60)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(II)[[I", line = 101)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IZI)V", line = 114)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(III)[I", line = 139)
    ...
    @OriginalMember(owner = "client!pn", name = "d", descriptor = "(B)V", line = 159)
    public static void method3159(byte arg0) {
        int var1 = -69 / ((-arg0 - 72) / 32);
        field7882 = null;
    }

    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(II)[I", line = 168)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ILwn;I)V", line = 179)
    ...
    @OriginalMember(owner = "client!pn", name = "e", descriptor = "(B)V", line = 196)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(IZ)V", line = 210)
