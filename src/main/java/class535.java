...
public class class535 extends class296 {
    ...
    @OriginalMember(owner = "client!ek", name = "fa", descriptor = "(IILr;)Lr;")
    ...
    @OriginalMember(owner = "client!ek", name = "wa", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IIILip;)V")
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "(Lsf;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!ek", name = "CA", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lbq;[I)V")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lr;IIIIZ)Z")
