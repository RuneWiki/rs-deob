...
public class class535 implements class385 {
    ...
    @OriginalMember(owner = "client!ct", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(I)Z", line = 15)
    public final boolean method17(int arg0) {
        field7440++;
        return arg0 >= -93 ? true : this.field7443.method3005(this.field7442.field5789, (byte) -69);
    }

    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(BLaia;)V", line = 27)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(JIIBZ)Ljava/lang/String;", line = 63)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Lha;IIIILtd;IIIIII)V", line = 142)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(BII)Z", line = 158)
    ...
    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "(Lgga;Lvba;)V", line = 172)
    public class535(class513 arg0, class417 arg1) {
        this.field7442 = arg1;
        this.field7443 = arg0;
    }

    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(ZI)V", line = 182)
