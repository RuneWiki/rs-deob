...
public class class535 extends class34 {
    ...
    @OriginalMember(owner = "client!aq", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Lsv;II)V", line = 109)
    ...
    @OriginalMember(owner = "client!aq", name = "<init>", descriptor = "()V", line = 154)
    public class535() {
        super(1, false);
    }

    @OriginalMember(owner = "client!aq", name = "c", descriptor = "(B)V", line = 159)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(II)V", line = 174)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(BI)[[I", line = 427)
    ...
    @OriginalMember(owner = "client!aq", name = "f", descriptor = "(I)V", line = 487)
