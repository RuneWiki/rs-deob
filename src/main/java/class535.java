...
public class class535 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(CBI)I", line = 33)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Leg;ZB)V", line = 63)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(I)V", line = 77)
