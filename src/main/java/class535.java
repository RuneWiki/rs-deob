...
public class class535 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IIIIII[B[BI)V", line = 14)
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IIZI)I", line = 71)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(B)V", line = 91)
