...
public class class535 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(B)Lea;", line = 3)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Lfr;B)V", line = 27)
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(B)Lea;", line = 38)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!am", name = "<init>", descriptor = "()V", line = 91)
    public class535() {
    }

    @OriginalMember(owner = "client!am", name = "<init>", descriptor = "(Lfr;)V", line = 93)
