...
public abstract class class535 extends class43 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IIILrc;Lrc;)V")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(BILha;Lgs;ZII)V")
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "([Lbh;I)I")
