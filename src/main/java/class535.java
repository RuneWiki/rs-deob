...
public class class535 extends class734 {
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 4)
    public class535(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(B)F", line = 17)
    ...
    @OriginalMember(owner = "client!ts", name = "e", descriptor = "(B)F", line = 29)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(III)Z", line = 41)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(BLjagtheora/ogg/OggPacket;)V", line = 54)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(I)Ljava/lang/String;", line = 137)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IIIII)V", line = 152)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Z)V", line = 210)
    ...
    @OriginalMember(owner = "client!ts", name = "d", descriptor = "(I)Ljava/lang/String;", line = 224)
    ...
    @OriginalMember(owner = "client!ts", name = "f", descriptor = "(B)V", line = 238)
