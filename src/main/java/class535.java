...
public class class535 {
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(BILta;Lfca;ILil;Ljava/lang/String;IILfa;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!rw", name = "b", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(IJ)Llj;", line = 87)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(JLlj;B)V", line = 117)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(ZIILpq;III)V", line = 151)
    ...
    @OriginalMember(owner = "client!rw", name = "<init>", descriptor = "(I)V", line = 186)
