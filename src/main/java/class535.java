...
public class class535 extends class751 {
    ...
    @OriginalMember(owner = "client!jq", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "()V", line = 17)
    public class535() {
        super(3, false);
    }

    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IZLjava/lang/String;Lkv;)Llv;", line = 21)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(II)[I", line = 61)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(ZLjava/lang/String;)I", line = 113)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IIIIIIILmja;IIZ)Z", line = 140)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(ILrv;)Lbu;", line = 387)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(ILrv;I)V", line = 401)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IB)[[I", line = 413)
