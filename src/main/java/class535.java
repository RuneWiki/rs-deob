...
public class class535 extends class724 implements class546 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IIILwu;)Lfba;", line = 3)
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "(Ljc;Ltn;III[B)V", line = 85)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(BI)V", line = 116)
