...
public class class535 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(JJ)J", line = 5)
    public static long method3181(long arg0, long arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(I[BIIIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IILkg;)V", line = 134)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(I)V", line = 173)
