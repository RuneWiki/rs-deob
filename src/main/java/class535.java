...
public class class535 {
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(Ln;BLjava/awt/Canvas;I)Lqa;", line = 22)
    ...
    @OriginalMember(owner = "client!pda", name = "<init>", descriptor = "(Lmh;)V", line = 59)
