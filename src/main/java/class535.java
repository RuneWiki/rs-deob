...
public class class535 extends class424 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ZILoa;)Lba;", line = 4)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(B)V", line = 96)
    public static void method2848(byte arg0) {
        field6958 = null;
        int var1 = -100 / ((56 - arg0) / 59);
    }

    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(IIB)V", line = 112)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(JJ)J", line = 137)
