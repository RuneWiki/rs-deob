...
public class class535 implements class206 {
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(ZB)V", line = 5)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(I)I", line = 63)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(IIIIFFFI)[F", line = 92)
    ...
    @OriginalMember(owner = "client!pga", name = "b", descriptor = "(I)I", line = 176)
    ...
    @OriginalMember(owner = "client!pga", name = "c", descriptor = "(I)V", line = 188)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(JI)Z", line = 198)
    ...
    @OriginalMember(owner = "client!pga", name = "<init>", descriptor = "(Llo;Lar;)V", line = 214)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(Lee;I)Lmf;", line = 232)
