...
public class class535 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "([I[IIIIIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "([I[IIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!oo", name = "b", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!oo", name = "b", descriptor = "([I[IIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!oo", name = "b", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "(Law;)V")
