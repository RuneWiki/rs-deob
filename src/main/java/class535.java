...
public class class535 {
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(BII)V", line = 6)
    ...
    @OriginalMember(owner = "client!pga", name = "<init>", descriptor = "(Lda;)V", line = 34)
    public class535(class61 arg0) {
        this.field7254 = arg0;
    }

    @OriginalMember(owner = "client!pga", name = "<init>", descriptor = "(Lda;Lmv;)V", line = 41)
    public class535(class61 arg0, class377 arg1) {
        this.field7253 = arg1;
        this.field7254 = arg0;
    }

    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(I)V", line = 50)
