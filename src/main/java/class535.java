...
public class class535 extends class337 {
    ...
    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "(Lkfa;IIII[BI)V")
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Lfu;IILrca;Lr;B)Z")
    ...
    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "(Lkfa;IIII)V")
