...
public class class535 extends class277 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "([BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(B)[B", line = 21)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(BII)[B", line = 35)
