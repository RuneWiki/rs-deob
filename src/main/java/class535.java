...
public abstract class class535 extends class420 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Ldf;IZIIILha;)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "([Luf;Z)I")
    ...
    @OriginalMember(owner = "client!qj", name = "d", descriptor = "(ILha;)Z")
