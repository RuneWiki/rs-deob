...
public class class535 extends class38 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Li;IIIIZ)Z", line = 232)
    public final boolean method212(class31 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return false;
    }

    @OriginalMember(owner = "client!mp", name = "ba", descriptor = "(Li;IIIIZ)V", line = 237)
    public final void method209(class31 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!mp", name = "ua", descriptor = "(II)I", line = 240)
    public final int method217(int arg0, int arg1) {
        return this.field7870[arg0][arg1];
    }

    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IIIIIII[[Z)V", line = 244)
    ...
    @OriginalMember(owner = "client!mp", name = "c", descriptor = "(I)Z", line = 261)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(III[[ZZ)V", line = 278)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IILof;[I[I[I)V", line = 295)
    ...
    @OriginalMember(owner = "client!mp", name = "ca", descriptor = "(II)I", line = 651)
    ...
    @OriginalMember(owner = "client!mp", name = "H", descriptor = "(Li;IIIIZ)V", line = 670)
    public final void method214(class31 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!mp", name = "aa", descriptor = "()V", line = 673)
    public final void method206() {
        this.field7860 = null;
        this.field7868 = null;
    }

    @OriginalMember(owner = "client!mp", name = "OA", descriptor = "(IILi;)Li;", line = 681)
    public final class31 method221(int arg0, int arg1, class31 arg2) {
        return null;
    }

    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Lbn;[I)V", line = 684)
    public final void method215(class309 arg0, int[] arg1) {
    }

    @OriginalMember(owner = "client!mp", name = "qa", descriptor = "(III)V", line = 689)
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(II)I", line = 698)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IIZLof;[I[I[I)V", line = 729)
    ...
    @OriginalMember(owner = "client!mp", name = "pa", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 1368)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(Lcd;IIII[[I[[II)V", line = 1863)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IIIIIII[[ZLof;[I[I)V", line = 1916)
                ...
                if (arg7[var16 - arg3][var17 - arg4]) {
                    if (this.field7869[var16][var17] != null) {
                        ...
                        for (int var23 = 0; var23 < var21.field2084; ++var23) {
                            ...
                            } else if (var21.field2086 != null && var21.field2086[var23] != -1) {
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(IIIIIII[[ZLof;[I[I)V", line = 2048)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(II)V", line = 2180)
