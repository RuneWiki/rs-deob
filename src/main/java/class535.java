...
public class class535 {
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(ILr;IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(ZIZIIII)V", line = 97)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(ILjava/io/File;Ljava/lang/String;)V", line = 141)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(I)V", line = 163)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(Lio;I)V", line = 188)
