...
public class class535 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(ZLha;ZIZ)Lka;")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(BLwc;[II)V")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lwea;I)V")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(ILhj;)V")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lha;ZIIIILuu;Lka;B)V")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "(Lha;Lpu;IIIILwea;ZI)V")
