...
public class class535 implements class497 {
    ...
    @OriginalMember(owner = "client!jaa", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(ILvda;IIZ)V", line = 20)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(ILcs;II)V", line = 57)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(II)V", line = 90)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(ZLvda;II)V", line = 105)
    public final void method3122(boolean arg0, class158 arg1, int arg2, int arg3) {
        this.method3119(0, arg1, arg3, arg2, arg0);
        field7721++;
    }

    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(IILpg;)V", line = 129)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(IB)V", line = 159)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(Z)I", line = 174)
    ...
    @OriginalMember(owner = "client!jaa", name = "d", descriptor = "(I)V", line = 188)
    ...
    @OriginalMember(owner = "client!jaa", name = "<init>", descriptor = "(Lad;)V", line = 398)
    ...
    @OriginalMember(owner = "client!jaa", name = "b", descriptor = "(I)V", line = 210)
    ...
    @OriginalMember(owner = "client!jaa", name = "c", descriptor = "(B)Z", line = 224)
    ...
    @OriginalMember(owner = "client!jaa", name = "b", descriptor = "(II)V", line = 245)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(ILcs;B)V", line = 260)
    ...
    @OriginalMember(owner = "client!jaa", name = "finalize", descriptor = "()V", line = 271)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(B)V", line = 280)
    ...
    @OriginalMember(owner = "client!jaa", name = "c", descriptor = "(II)V", line = 294)
    ...
    @OriginalMember(owner = "client!jaa", name = "c", descriptor = "(I)V", line = 306)
    ...
    @OriginalMember(owner = "client!jaa", name = "f", descriptor = "(I)I", line = 324)
    ...
    @OriginalMember(owner = "client!jaa", name = "e", descriptor = "(I)V", line = 344)
