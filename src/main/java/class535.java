...
public class class535 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(FIFFB)F", line = 17)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(II)I", line = 51)
    public static final int method3044(int arg0, int arg1) {
        return class217.field2625 == null ? 0 : class217.field2625[arg0][arg1] & 0xFF;
    }

    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 56)
