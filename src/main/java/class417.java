...
public class class417 extends class712 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(II)[B", line = 3)
    ...
    @OriginalMember(owner = "client!et", name = "d", descriptor = "(Z)Z", line = 52)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(BZ)V", line = 64)
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(III)V", line = 76)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ZB)V", line = 87)
    ...
    @OriginalMember(owner = "client!et", name = "d", descriptor = "(B)V", line = 100)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ILjava/lang/String;)V", line = 112)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IILhba;)V", line = 177)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ZBIIIIIF)[I", line = 190)
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(Lrl;)V", line = 215)
    public class417(class232 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!et", name = "b", descriptor = "(Z)V", line = 218)
