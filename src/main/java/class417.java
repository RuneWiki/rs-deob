...
public class class417 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IIII)Lnn;", line = 11)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(B)Lqb;", line = 24)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(IIIIB)V", line = 78)
