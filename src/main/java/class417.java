...
public class class417 extends class435 {
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "(II)V", line = 26)
    public class417(int arg0, int arg1) {
        this.field5939 = arg1;
        this.field5941 = arg0;
    }

    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(BI)V", line = 35)
