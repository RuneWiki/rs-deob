...
public class class417 extends class147 implements class532 {
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "(Log;Lkn;Z)V")
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(B)Lkn;")
