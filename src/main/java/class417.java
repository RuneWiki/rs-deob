...
public class class417 extends class187 {
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Ltq;ZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ILvm;)V", line = 22)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ILam;I)Ljp;", line = 87)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Ltq;B)V", line = 105)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IIBII)V", line = 126)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lvm;IBIIIIII)V", line = 204)
