...
public class class417 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIB)I", line = 3)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILne;Ljava/lang/String;B)Lbc;", line = 34)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 115)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(I)V", line = 189)
