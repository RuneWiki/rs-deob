...
public class class417 extends class397 implements class500 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(Lgk;ILjaggl/memory/NativeBuffer;)V", line = 19)
    public class417(class463 arg0, int arg1, NativeBuffer arg2) {
        super(arg0, arg2);
        this.field5553 = arg1;
    }

    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lwt;II)V", line = 28)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lps;I)V", line = 350)
    ...
    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(I)J", line = 369)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(CI)Z", line = 380)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(Lgk;I[BI)V", line = 391)
    public class417(class463 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field5553 = arg1;
    }

    @OriginalMember(owner = "client!qo", name = "c", descriptor = "(I)V", line = 399)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(I[BII)V", line = 409)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(I)I", line = 425)
