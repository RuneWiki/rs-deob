...
public class class417 extends class381 {
    ...
    @OriginalMember(owner = "client!mg", name = "c", descriptor = "(I)Ltj;")
    ...
    @OriginalMember(owner = "client!mg", name = "c", descriptor = "(B)Lap;")
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Ltg;Ltg;I)V")
