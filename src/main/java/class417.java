...
public class class417 implements class444 {
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(B)Lhl;", line = 3)
    ...
    @OriginalMember(owner = "client!vba", name = "<init>", descriptor = "(I)V", line = 15)
    public class417(int arg0) {
        this.field5789 = arg0;
    }

    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(I)Ljava/lang/String;", line = 24)
