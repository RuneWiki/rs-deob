...
public abstract class class417 extends class210 {
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "([Lgu;I)I")
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(BLvba;)I")
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(BLuaa;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(Lha;I)Z")
