...
public class class417 {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(IIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Lu;I)V", line = 34)
    ...
    @OriginalMember(owner = "client!fo", name = "toString", descriptor = "()Ljava/lang/String;", line = 52)
    public final String toString() {
        field5817++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!fo", name = "b", descriptor = "(IIII)V", line = 73)
