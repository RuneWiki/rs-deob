...
public abstract class class417 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(FFFFIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(FFII)V", line = 32)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(II)V", line = 36)
    public final void method2493(int arg0, int arg1) {
        this.method722(arg0, arg1, 0, 0, 1);
    }

    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(FFIILoj;II)V", line = 42)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(FFIIIII)V", line = 45)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(FFFFIILoj;II)V", line = 53)
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(IIII)V", line = 81)
