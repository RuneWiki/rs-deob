...
public class class417 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(B)I", line = 7)
    ...
    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(B)I", line = 36)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lfa;Z)Ljava/lang/String;", line = 95)
    ...
    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!lg", name = "c", descriptor = "(B)V", line = 118)
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "()V", line = 264)
    private class417() {
    }
