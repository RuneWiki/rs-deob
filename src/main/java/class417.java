...
public class class417 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ZIIII)V", line = 131)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(B)V", line = 152)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(I)V", line = 187)
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(IIIIIIIIIIIIII)V", line = 209)
