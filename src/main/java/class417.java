...
public class class417 extends class536 {
    ...
    @OriginalMember(owner = "client!eca", name = "b", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!eca", name = "A", descriptor = "()I", line = 38)
    public final int method160() {
        field5239++;
        return this.field5238.field116 - (-this.field5247 - this.field5234);
    }

    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(IILua;II)V", line = 46)
    ...
    @OriginalMember(owner = "client!eca", name = "YA", descriptor = "(IIIIIIII)V", line = 105)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(Lkp;IZ)I", line = 209)
    ...
    @OriginalMember(owner = "client!eca", name = "u", descriptor = "()I", line = 233)
    public final int method162() {
        field5227++;
        return this.field5238.field110;
    }

    @OriginalMember(owner = "client!eca", name = "DA", descriptor = "(IIIIIII)V", line = 241)
    ...
    @OriginalMember(owner = "client!eca", name = "<init>", descriptor = "(Lqj;IIZ)V", line = 780)
    ...
    @OriginalMember(owner = "client!eca", name = "<init>", descriptor = "(Lqj;IIII)V", line = 790)
    ...
    @OriginalMember(owner = "client!eca", name = "<init>", descriptor = "(Lqj;II[III)V", line = 800)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(FFFFFFILua;II)V", line = 380)
    ...
    @OriginalMember(owner = "client!eca", name = "xa", descriptor = "(III)V", line = 469)
    ...
    @OriginalMember(owner = "client!eca", name = "da", descriptor = "(IIIIII)V", line = 495)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(B)V", line = 510)
    ...
    @OriginalMember(owner = "client!eca", name = "ca", descriptor = "()I", line = 527)
    public final int method166() {
        field5233++;
        return this.field5238.field110 + this.field5242 + this.field5244;
    }

    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(Llo;Z)V", line = 539)
    ...
    @OriginalMember(owner = "client!eca", name = "Q", descriptor = "(IIII)V", line = 572)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(BLr;)V", line = 586)
    ...
    @OriginalMember(owner = "client!eca", name = "V", descriptor = "(IIIII)V", line = 637)
    ...
    @OriginalMember(owner = "client!eca", name = "E", descriptor = "()I", line = 693)
    public final int method167() {
        field5246++;
        return this.field5238.field116;
    }

    @OriginalMember(owner = "client!eca", name = "qa", descriptor = "(FFFFFFIIII)V", line = 709)
