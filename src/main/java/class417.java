...
public class class417 extends class478 {
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(Lih;IIIIZ[BIZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ILl;Lza;)V", line = 59)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IZZ)V", line = 285)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IIIIIII)V", line = 303)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IBII)V", line = 316)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IIZIZ[BIIII)V", line = 329)
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(Lih;IIII)V", line = 390)
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(Lih;IIIII)V", line = 466)
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(Lih;IIIIZ[FI)V", line = 485)
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(Lih;IIIIZ[IZ)V", line = 508)
    ...
    @OriginalMember(owner = "client!gu", name = "f", descriptor = "(I)V", line = 405)
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(IIIIIII)I", line = 416)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(I)V", line = 453)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IIZIIII[II)V", line = 563)
