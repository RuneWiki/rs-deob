...
public abstract class class417 extends class8 {
    ...
    @OriginalMember(owner = "client!nu", name = "e", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(Lua;Lbu;Lbu;Lbu;I)Z", line = 20)
    ...
    @OriginalMember(owner = "client!nu", name = "e", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!nu", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 79)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IIIIIBII)V", line = 96)
