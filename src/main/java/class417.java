...
public class class417 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(BLeb;)Lka;")
    ...
    @OriginalMember(owner = "client!gn", name = "b", descriptor = "(BLeb;)V")
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IILeb;)V")
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(II)Lvf;")
