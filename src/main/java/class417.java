...
public class class417 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IZBII[Ltn;)V", line = 4)
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(B)V", line = 72)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lhh;I)V", line = 92)
