...
public abstract class class417 {
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(ILkh;)Lls;")
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(BLij;[[IIZ[[BI[[B[[BILij;[[BLuo;)V")
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Lnq;BLnq;)V")
