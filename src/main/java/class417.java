...
public class class417 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(BC)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(BII)Z", line = 14)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "()V", line = 75)
