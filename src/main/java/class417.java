...
public class class417 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Lvt;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Z)Z", line = 45)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(ZLvt;)V", line = 56)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(ZJ[II)Ljava/lang/String;", line = 80)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IIIIILgn;ILgn;BI)V", line = 107)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IILoj;Z)Lrg;", line = 157)
