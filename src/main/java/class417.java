...
public class class417 extends class145 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Lqp;[I)V")
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(Lba;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Lah;I)V")
    ...
    @OriginalMember(owner = "client!lk", name = "p", descriptor = "(Lba;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "(Lkd;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Lba;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!lk", name = "k", descriptor = "(IILba;)Lba;")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IILaa;I)V")
