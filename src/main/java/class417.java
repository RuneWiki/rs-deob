...
public abstract class class417 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(BLr;)V")
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ZLbca;)V")
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "([IZIIII[Lf;Ljava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "([ILua;[Lf;IIIIILjava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILjava/util/Random;Ljava/lang/String;I[Lf;II[III)I")
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(Lr;Lvn;)V")
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(B[ILjava/lang/String;I[I[Lf;[II)V")
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(II[Lf;IIILua;I[IIILjava/lang/String;IIIII)I")
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "([ILjava/util/Random;IIII[Lf;IILjava/lang/String;III[II)I")
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IILua;III[IIIIIBIILjava/lang/String;[Lf;)I")
