...
public class class417 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lqb;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(I)Lrc;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Lgj;Z)V")
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(I)Lrc;")
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "(Lgj;)V")
