...
public class class417 extends class445 {
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(IILr;)Lne;", line = 52)
    ...
    @OriginalMember(owner = "client!qt", name = "b", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lbt;II)V", line = 110)
