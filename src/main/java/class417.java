...
public class class417 extends class642 {
    ...
    @OriginalMember(owner = "client!ew", name = "d", descriptor = "(I)J", line = 3)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(B)J", line = 53)
    public final long method1772(byte arg0) {
        return arg0 <= 119 ? 88L : this.field5426;
    }

    @OriginalMember(owner = "client!ew", name = "b", descriptor = "(I)J", line = 71)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(BJ)I", line = 98)
