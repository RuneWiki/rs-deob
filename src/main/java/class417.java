...
public class class417 extends class46 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(II)I", line = 27)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(IIIIB)V", line = 51)
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZJZ)V", line = 243)
