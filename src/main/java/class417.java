...
public abstract class class417 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(ZZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(III)Ljava/lang/String;", line = 32)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(IBLjava/lang/String;)V", line = 75)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(IIIIB)V", line = 91)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Z)V", line = 116)
    ...
    @OriginalMember(owner = "client!s", name = "b", descriptor = "(Z)V", line = 327)
