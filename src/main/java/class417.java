...
public class class417 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(III)Lqs;")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(IB)Lqd;")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "([Lrr;II)V")
