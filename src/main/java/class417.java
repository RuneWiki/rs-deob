...
public class class417 {
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(Lha;IB)Z", line = 9)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!mha", name = "<init>", descriptor = "(I[Ldn;IIII)V", line = 386)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(III)B", line = 119)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(IIIIIIILha;II)V", line = 138)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 215)
    ...
    @OriginalMember(owner = "client!mha", name = "b", descriptor = "(I)V", line = 265)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "()V", line = 293)
