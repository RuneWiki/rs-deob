...
public class class417 extends class117 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(ILqa;IB)Lc;")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(Lc;BLqa;)V")
    ...
    @OriginalMember(owner = "client!nu", name = "b", descriptor = "(ILqa;)Lnf;")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IILqa;B)Z")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(ZIILer;Lqa;IB)V")
