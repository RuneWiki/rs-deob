...
public class class417 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lmo;I)V", line = 26)
    ...
    @OriginalMember(owner = "client!gn", name = "b", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(BLjg;)V", line = 54)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(ZIII)I", line = 74)
    ...
    @OriginalMember(owner = "client!gn", name = "c", descriptor = "(I)I", line = 183)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IBIIILid;)Lid;", line = 313)
    ...
    @OriginalMember(owner = "client!gn", name = "d", descriptor = "(I)V", line = 435)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Ljg;IZ)V", line = 469)
    ...
    @OriginalMember(owner = "client!gn", name = "e", descriptor = "(I)V", line = 636)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IBIIILid;II)Lid;", line = 662)
