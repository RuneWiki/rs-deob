...
public class class417 extends class406 {
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Ltq;II)Lic;", line = 112)
    ...
    @OriginalMember(owner = "client!ic", name = "b", descriptor = "()V", line = 119)
    public final void method2651() {
        this.field5970 = null;
    }

    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "(Ldg;)V", line = 125)
