...
public class class417 extends class270 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(SZ)V", line = 31)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(B[[ZIII)V", line = 48)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ILjava/lang/String;)I", line = 105)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IIIIIII)V", line = 128)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IZ)I", line = 291)
    public static final int method2259(int arg0, boolean arg1) {
        field5537++;
        return arg1 ? 93 : arg0 & 0xFF;
    }

    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(I)V", line = 311)
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(Lap;Lmh;Lod;[I)V", line = 323)
