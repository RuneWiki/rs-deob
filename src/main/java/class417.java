...
public class class417 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(I)Z", line = 10)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(BFLbc;Lbc;)Z", line = 27)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Z)V", line = 105)
    ...
    @OriginalMember(owner = "client!wa", name = "b", descriptor = "(I)Z", line = 116)
    ...
    @OriginalMember(owner = "client!wa", name = "<init>", descriptor = "(Lrl;)V", line = 144)
    public class417(class487 arg0) {
        this.field6188 = arg0;
    }

    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IIIIII)V", line = 152)
