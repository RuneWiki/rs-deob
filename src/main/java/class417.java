...
public class class417 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Z)Z", line = 5)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Lew;ILew;F)Z", line = 47)
    ...
    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(Lhk;)V", line = 124)
