...
public class class417 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "()Lve;", line = 5)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Lwo;II)Lgl;", line = 14)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "()I", line = 22)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(Lbg;)V", line = 129)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "()V", line = 149)
    private class417() {
    }

    @OriginalMember(owner = "client!gl", name = "c", descriptor = "()[B", line = 71)
