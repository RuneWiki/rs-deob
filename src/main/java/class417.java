...
public class class417 extends class149 {
    ...
    @OriginalMember(owner = "client!cn", name = "e", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "()V", line = 244)
    public class417() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(II)[I", line = 32)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IILjava/lang/String;)V", line = 256)
    ...
    @OriginalMember(owner = "client!cn", name = "f", descriptor = "(I)V", line = 272)
    ...
    @OriginalMember(owner = "client!cn", name = "g", descriptor = "(I)[Lss;", line = 306)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IBLtl;)V", line = 319)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IZLjava/lang/String;)V", line = 395)
    ...
    @OriginalMember(owner = "client!cn", name = "d", descriptor = "(B)Z", line = 501)
    ...
    @OriginalMember(owner = "client!cn", name = "d", descriptor = "(I)V", line = 536)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(FBFF)I", line = 568)
