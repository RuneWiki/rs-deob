...
public class class417 {
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IIIIIIILha;II)V")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Lha;IB)Z")
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(I[Llaa;IIII)V")
