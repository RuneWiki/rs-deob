...
public class class417 {
    ...
    @OriginalMember(owner = "client!oc", name = "c", descriptor = "(I)Lln;")
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(ZI)Lio;")
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(Lad;ILdk;)V")
