...
public class class417 {
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(II)Lwda;", line = 12)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(Z)V", line = 45)
    ...
    @OriginalMember(owner = "client!jea", name = "b", descriptor = "(Z)V", line = 59)
    ...
    @OriginalMember(owner = "client!jea", name = "c", descriptor = "(Z)V", line = 71)
    ...
    @OriginalMember(owner = "client!jea", name = "b", descriptor = "(II)V", line = 85)
    ...
    @OriginalMember(owner = "client!jea", name = "<init>", descriptor = "(Ler;ILjn;)V", line = 106)
