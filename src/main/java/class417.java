...
public class class417 extends class524 implements class706 {
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Lha;III)Z")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(BLha;)V")
    public final void method753(byte arg0, class58 arg1) {
        ++field5900;
        int var3 = 59 / ((18 - arg0) / 40);
    }

    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(ILha;)Lkj;")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ZLha;IILkba;II)V")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!nv", name = "c", descriptor = "(B)I")
    ...
    @OriginalMember(owner = "client!nv", name = "i", descriptor = "(I)I")
    ...
    @OriginalMember(owner = "client!nv", name = "e", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ILha;I)Lka;")
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(BLha;)Lml;")
    ...
    @OriginalMember(owner = "client!nv", name = "g", descriptor = "(B)I")
    ...
    @OriginalMember(owner = "client!nv", name = "<init>", descriptor = "(Lha;Lhba;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IZLha;B)Lqha;")
