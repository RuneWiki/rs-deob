...
public class class417 extends class45 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(ILkj;Z)V")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(II)Ljv;")
    ...
    @OriginalMember(owner = "client!nu", name = "<init>", descriptor = "(Lfd;Lm;)V")
