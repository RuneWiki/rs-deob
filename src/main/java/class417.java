...
public class class417 extends class98 {

    @OriginalMember(owner = "client!uda", name = "E", descriptor = "[I")
    public static int[] field6373 = new int[1];

    @OriginalMember(owner = "client!uda", name = "F", descriptor = "I")
    public static int field6374 = 104;
    ...
    @OriginalMember(owner = "client!uda", name = "P", descriptor = "Ljo;")
    public class307 field6384;

    @OriginalMember(owner = "client!uda", name = "H", descriptor = "Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!uda", name = "O", descriptor = "[Lsba;")
    public class200[] field6383;

    @OriginalMember(owner = "client!uda", name = "K", descriptor = "[Ljava/lang/String;")
    public String[] field6379;

    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(Z)V", line = 3)
    public static void method2650(boolean arg0) {
        if (!arg0) {
            field6373 = null;
        }
    }

    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(II)[[[B", line = 23)
    public static final byte[][][] method2651(int arg0, int arg1) {
        field6381++;
