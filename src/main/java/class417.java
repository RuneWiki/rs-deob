...
public class class417 extends class276 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(BLza;Lco;Lmo;)V", line = 3)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(I)V", line = 151)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(III)Z", line = 164)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Lpt;IIII)V", line = 185)
    ...
    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "(Lmo;)V", line = 271)
