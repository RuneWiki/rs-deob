...
public class class196 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "Lta;")
    private class176 field3738;

    @OriginalMember(owner = "client!vc", name = "f", descriptor = "Lta;")
    private class176 field3743;

    @OriginalMember(owner = "client!vc", name = "h", descriptor = "Lta;")
    private class176 field3745;

    @OriginalMember(owner = "client!vc", name = "i", descriptor = "Lta;")
    private class176 field3746;

    @OriginalMember(owner = "client!vc", name = "j", descriptor = "Lta;")
    private class176 field3747;

    @OriginalMember(owner = "client!vc", name = "m", descriptor = "Lta;")
    private class176 field3750;

    @OriginalMember(owner = "client!vc", name = "n", descriptor = "Lta;")
    private class176 field3751;

    @OriginalMember(owner = "client!vc", name = "q", descriptor = "Lta;")
    private class176 field3754;

    @OriginalMember(owner = "client!vc", name = "w", descriptor = "Lta;")
    private class176 field3760;

    @OriginalMember(owner = "client!vc", name = "o", descriptor = "Lwe;")
    private class207 field3752;

    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Lja;)V")
