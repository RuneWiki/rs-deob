...
public class class196 extends class7 {
    ...
    @OriginalMember(owner = "client!efa", name = "<init>", descriptor = "(Ldia;II)V", line = 10)
    ...
    @OriginalMember(owner = "client!efa", name = "<init>", descriptor = "(Ldia;IIZ[[I)V", line = 222)
    ...
    @OriginalMember(owner = "client!efa", name = "<init>", descriptor = "(Ldia;IIZ[[BI)V", line = 285)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(BLjava/lang/String;)[B", line = 27)
    ...
    @OriginalMember(owner = "client!efa", name = "b", descriptor = "(II)V", line = 166)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "([Ljava/lang/String;I[S)V", line = 194)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(IIIIB)V", line = 205)
    ...
    @OriginalMember(owner = "client!efa", name = "b", descriptor = "(Z)V", line = 258)
