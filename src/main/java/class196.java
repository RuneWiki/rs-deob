...
public class class196 {
    ...
    @OriginalMember(owner = "client!me", name = "b", descriptor = "(II)Lgaa;")
    ...
    @OriginalMember(owner = "client!me", name = "c", descriptor = "(II)Ljea;")
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Lrga;ILni;Lni;Lni;)V")
