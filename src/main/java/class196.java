...
public class class196 implements class660 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(FI)F", line = 11)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(B)Lgp;", line = 22)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IIFFIIFI)[F", line = 46)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(ZII)I", line = 131)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(III)Lmf;", line = 168)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IIB)Z", line = 197)
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(Ljava/lang/String;Lpf;Ldg;IIIIIIIIII)V", line = 215)
