...
public class class196 {
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BLiv;)V")
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "([Lwl;Lfd;I)Lru;")
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BLmu;)Z")
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Liv;)V")
