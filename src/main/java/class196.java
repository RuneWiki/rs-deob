...
public class class196 extends class161 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IIIIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!rb", name = "d", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!rb", name = "b", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IBIIIIIII)V", line = 132)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IBIIZLgn;)V", line = 158)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IB)Lne;", line = 215)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(BI)V", line = 244)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IILjava/lang/String;)V", line = 258)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IIIIIIZZILjg;II)V", line = 337)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(ILjg;)Lrf;", line = 475)
