...
public class class196 extends class220 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IBLil;)V", line = 4)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!mo", name = "c", descriptor = "(II)[I", line = 31)
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "()V", line = 91)
    public class196() {
        super(3, false);
    }

    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(II)[[I", line = 96)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(BI)S", line = 176)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(III)V", line = 208)
