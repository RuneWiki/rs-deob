...
public class class196 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(ILdk;)V")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(ILml;Z)V")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Ljp;IZBIII)V")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(ILjava/awt/Frame;Lor;)V")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(BIIZI)Lop;")
