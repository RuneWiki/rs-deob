...
public class class196 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Ljagdx/IDirect3DSurface;ZLjagdx/IDirect3DSwapChain;)V")
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V")
