...
public class class196 {
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(JII)Lgaa;")
    ...
    @OriginalMember(owner = "client!qga", name = "<init>", descriptor = "(Lto;ILla;)V")
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(II)Lap;")
