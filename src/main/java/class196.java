...
public class class196 extends class66 implements class201 {
    ...
    @OriginalMember(owner = "client!ta", name = "finalize", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 15)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "()V", line = 42)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "()V", line = 47)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Ljava/lang/Exception;)V", line = 57)
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(Ll;Ljava/awt/Canvas;)V", line = 77)
