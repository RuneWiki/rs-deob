...
public class class196 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(I)Lpn;")
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(B)Lpn;")
    ...
    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "(Ltm;)V")
