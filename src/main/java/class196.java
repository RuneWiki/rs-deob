...
public class class196 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(BLrg;)V")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(I)Lfg;")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(ZIIILjava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Lrg;II)V")
