...
public class class196 extends class555 {
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Lvj;IIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Lvj;IIIIZ[BI)V", line = 27)
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Lvj;IIIZ[I)V", line = 50)
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Lvj;IIII[I)V", line = 71)
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Lvj;IIIIIZ)V", line = 86)
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Lvj;IIIII[BI)V", line = 107)
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Lvj;IIIII)V", line = 123)
    public class196(class422 arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        super(arg0, 3553, arg1, arg4, arg5);
        this.field2266 = (float) arg2 / (float) arg4;
        this.field2267 = (float) arg3 / (float) arg5;
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Lvj;IIIIIIZ)V", line = 137)
    ...
    @OriginalMember(owner = "client!br", name = "f", descriptor = "(I)V", line = 151)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Ltf;Lfa;I)V", line = 163)
