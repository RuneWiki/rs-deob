...
public class class196 extends class559 implements class523 {
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(Lha;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(B)Z", line = 23)
    public final boolean method88(byte arg0) {
        ++field3378;
        return arg0 < 44 ? true : this.field3372.method827((byte) -74);
    }

    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(BLha;)V", line = 34)
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(I)I", line = 45)
    ...
    @OriginalMember(owner = "client!lq", name = "c", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lha;I)Lkn;", line = 71)
    public final class516 method93(class544 arg0, int arg1) {
        ++field3385;
        return arg1 != 1 ? null : this.field3375;
    }

    @OriginalMember(owner = "client!lq", name = "h", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lha;Z)V", line = 94)
    ...
    @OriginalMember(owner = "client!lq", name = "d", descriptor = "(B)I", line = 108)
    ...
    @OriginalMember(owner = "client!lq", name = "g", descriptor = "(I)Z", line = 118)
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(B)I", line = 129)
    ...
    @OriginalMember(owner = "client!lq", name = "j", descriptor = "(I)I", line = 140)
    ...
    @OriginalMember(owner = "client!lq", name = "f", descriptor = "(B)V", line = 152)
    ...
    @OriginalMember(owner = "client!lq", name = "g", descriptor = "(B)V", line = 163)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(ZILha;Lov;IIZ)V", line = 293)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "([BI)[B", line = 304)
    ...
    @OriginalMember(owner = "client!lq", name = "i", descriptor = "(I)Z", line = 365)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IILha;I)Z", line = 381)
    ...
    @OriginalMember(owner = "client!lq", name = "k", descriptor = "(I)Z", line = 399)
    public final boolean method95(int arg0) {
        ++field3377;
        return arg0 != 0;
    }

    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "(Lha;Ljl;IIIIIZIIIIIII)V", line = 433)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(I)I", line = 422)
    public final int method98(int arg0) {
        ++field3361;
        return arg0 != -12194 ? -67 : this.field3372.field1521;
    }

    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Ljava/awt/Canvas;ILla;ILd;)Lha;", line = 443)
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(ILha;)Lgh;", line = 471)
