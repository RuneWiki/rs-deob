...
public class class196 extends class144 {
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IILza;I)Z")
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ILza;ILge;IZI)V")
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Le;ZLza;)V")
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Lza;III)Le;")
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(Lza;B)Lkf;")
