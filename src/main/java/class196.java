...
public class class196 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(I[Ll;)V", line = 8)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Ljava/lang/String;ZILjava/lang/String;)I", line = 37)
