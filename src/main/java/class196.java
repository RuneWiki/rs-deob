...
public abstract class class196 {
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IIIIIIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IILmq;I)V", line = 84)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IIZILli;I)Ljava/awt/Frame;", line = 101)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IZI)Z", line = 175)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(I)V", line = 188)
