...
public class class196 extends InputStream {
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lql;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IF)F", line = 38)
    ...
    @OriginalMember(owner = "client!nb", name = "read", descriptor = "()I", line = 49)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(I)V", line = 58)
