...
public class class196 extends class460 {
    ...
    @OriginalMember(owner = "client!rea", name = "b", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(IIB)V", line = 15)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(I[I[I)V", line = 40)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(BZ)V", line = 68)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(IILtj;)V", line = 80)
    ...
    @OriginalMember(owner = "client!rea", name = "<init>", descriptor = "(Ljaa;)V", line = 92)
    public class196(class576 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(Lji;I)Lie;", line = 95)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(ZI)V", line = 128)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(IIIIZI)V", line = 141)
