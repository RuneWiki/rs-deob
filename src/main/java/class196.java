...
public class class196 extends class435 {
    ...
    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 4)
    public class196(Object arg0, int arg1) {
        super(arg1);
        this.field2768 = new SoftReference(arg0);
    }

    @OriginalMember(owner = "client!aj", name = "d", descriptor = "(Z)Z", line = 14)
    public final boolean method1225(boolean arg0) {
        return arg0 ? true : true;
    }

    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 24)
