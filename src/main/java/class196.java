...
public abstract class class196 {
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IIIILhm;Ljava/lang/String;III[IIIII[Lkh;I)I", line = 3)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lhm;[Lkh;[IBIILjava/lang/String;II)V", line = 88)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IIIILjava/lang/String;II)V", line = 243)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(I[IIIIIIILjava/lang/String;[Lkh;II[IILjava/util/Random;)I", line = 267)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IILjava/lang/String;ZII)V", line = 343)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(ILjava/lang/String;IIIIII)V", line = 363)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(ILjava/util/Random;[Lkh;Ljava/lang/String;III[III)I", line = 395)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Ljava/lang/String;II[IIII[Lkh;)V", line = 438)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(I)V", line = 454)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(B)V", line = 470)
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "(Len;Lnm;)V", line = 481)
    public class196(class174 arg0, class277 arg1) {
        this.field2657 = arg1;
        this.field2664 = arg0;
    }

    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IBIIILjava/lang/String;)V", line = 490)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(III)V", line = 511)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IIILjava/lang/String;II)V", line = 533)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 551)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "([IILjava/lang/String;[Lkh;IIII)V", line = 626)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Ljava/lang/String;III[I[I[I[Lkh;)V", line = 647)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IZLjava/lang/String;IIII)V", line = 812)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "([Lkh;ILjava/lang/String;IIII[I)V", line = 844)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 860)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(II)Lng;", line = 902)
