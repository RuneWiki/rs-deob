...
public class class196 {
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Lkr;)V")
    ...
    @OriginalMember(owner = "client!pq", name = "b", descriptor = "(Lkr;)B")
    private static final byte method1391(class123 arg0) {
        return (byte) method1393(8, arg0);
    }

    @OriginalMember(owner = "client!pq", name = "c", descriptor = "(Lkr;)V")
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ILkr;)I")
    ...
    @OriginalMember(owner = "client!pq", name = "d", descriptor = "(Lkr;)V")
    ...
    @OriginalMember(owner = "client!pq", name = "e", descriptor = "(Lkr;)B")
