...
public abstract class class196 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(FB)F", line = 5)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IIIILza;IIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IIFIIFIF)[F", line = 176)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(ZZ)Z", line = 256)
