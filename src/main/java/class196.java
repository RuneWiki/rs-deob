...
public class class196 implements class486 {
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(IIIIIIB)V", line = 12)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!efa", name = "<init>", descriptor = "(I)V", line = 40)
    public class196(int arg0) {
        this.field2541 = arg0;
    }

    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(B)Leo;", line = 48)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(BJ)I", line = 63)
    public static final int method1288(byte arg0, long arg1) {
        field2538++;
        return arg0 == 33 ? (int) (arg1 / 86400000L) - 11745 : 15;
    }

    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(BLgm;)Z", line = 74)
