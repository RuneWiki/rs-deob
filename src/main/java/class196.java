...
public class class196 extends class694 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ILoa;)V")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(B)Lhd;")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ILjr;B)V")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IIIIIIIIILiaa;I)Z")
