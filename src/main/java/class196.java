...
public class class196 {
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(IIIIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(IBI)Z", line = 55)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(I)V", line = 68)
