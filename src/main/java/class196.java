...
public class class196 implements class257 {
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(IILjb;I)V")
    ...
    @OriginalMember(owner = "client!wfa", name = "<init>", descriptor = "(ILdp;Lfv;II)V")
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(Z)Lg;")
