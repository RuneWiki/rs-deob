...
public class class196 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(IIIIZZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(ZI)Z", line = 61)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(IBLei;)Z", line = 72)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Lbt;)V", line = 412)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(ILeu;)V", line = 117)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lue;IIIIIIIIII)Z", line = 138)
    ...
    @OriginalMember(owner = "client!sb", name = "b", descriptor = "(I)V", line = 393)
