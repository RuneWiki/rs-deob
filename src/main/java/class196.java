...
public class class196 extends class75 {
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(ILkm;IZILkj;B)V", line = 30)
    ...
    @OriginalMember(owner = "client!ld", name = "c", descriptor = "(Lkm;I)V", line = 44)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Lkm;BII)Z", line = 68)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Z)I", line = 101)
    ...
    @OriginalMember(owner = "client!ld", name = "i", descriptor = "(I)Z", line = 123)
    ...
    @OriginalMember(owner = "client!ld", name = "j", descriptor = "(I)I", line = 145)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Lvl;I)V", line = 156)
    ...
    @OriginalMember(owner = "client!ld", name = "k", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(B)V", line = 182)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IILkm;)Z", line = 193)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IIIBZI)V", line = 306)
    ...
    @OriginalMember(owner = "client!ld", name = "c", descriptor = "(I)I", line = 377)
    ...
    @OriginalMember(owner = "client!ld", name = "c", descriptor = "(B)I", line = 399)
    ...
    @OriginalMember(owner = "client!ld", name = "f", descriptor = "(B)Z", line = 410)
    ...
    @OriginalMember(owner = "client!ld", name = "e", descriptor = "(I)Z", line = 422)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(III)V", line = 433)
    ...
    @OriginalMember(owner = "client!ld", name = "e", descriptor = "(B)I", line = 518)
    ...
    @OriginalMember(owner = "client!ld", name = "d", descriptor = "(Lkm;I)Lto;", line = 540)
