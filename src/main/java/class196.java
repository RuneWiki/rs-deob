...
public class class196 {
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(ILmh;)V")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Ltc;I)V")
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(I)Lmh;")
    ...
    @OriginalMember(owner = "client!tc", name = "c", descriptor = "(I)Lmh;")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lmh;I)V")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lkq;Z)[Lqi;")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lie;IIZLaa;IIIZIIII)V")
    ...
    @OriginalMember(owner = "client!tc", name = "c", descriptor = "(B)Lmh;")
    ...
    @OriginalMember(owner = "client!tc", name = "e", descriptor = "(I)Lmh;")
    ...
    @OriginalMember(owner = "client!tc", name = "d", descriptor = "(B)Lmh;")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Ltc;BLmh;)V")
