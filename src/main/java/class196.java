...
public class class196 extends class155 {
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 5)
    public class196(Object arg0, int arg1) {
        super(arg1);
        this.field2378 = arg0;
    }

    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(II)V", line = 16)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Z)Z", line = 28)
    ...
    @OriginalMember(owner = "client!gb", name = "f", descriptor = "(I)Ljava/lang/Object;", line = 40)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(BI)V", line = 51)
    ...
    @OriginalMember(owner = "client!gb", name = "g", descriptor = "(I)V", line = 69)
