...
public class class196 extends class156 {
    ...
    @OriginalMember(owner = "client!fd", name = "f", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "(III)V", line = 26)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "()V", line = 37)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IIIIII)V", line = 45)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(III[I)V", line = 74)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Lmk;)V", line = 80)
    ...
    @OriginalMember(owner = "client!fd", name = "c", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "()Lfd;", line = 127)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(III)V", line = 145)
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "()V", line = 152)
    public class196() {
        this.method311();
    }

    @OriginalMember(owner = "client!fd", name = "a", descriptor = "([I)V", line = 157)
    ...
    @OriginalMember(owner = "client!fd", name = "d", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(I)V", line = 174)
