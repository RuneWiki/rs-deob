...
public class class196 implements class202 {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IZBIIF)[F", line = 19)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(BI)Z", line = 32)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "([[BI[BI[I[[BI[I)I", line = 48)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(I)Z", line = 106)
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "(II)Lmr;", line = 224)
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "(B)V", line = 254)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(II)Lva;", line = 307)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IIIZFI)[I", line = 322)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(ZFIIBI)[I", line = 342)
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "(Lij;Lij;Lij;)V", line = 364)
