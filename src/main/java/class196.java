...
public class class196 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ILiq;Ljava/lang/Object;)V", line = 3)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Lbq;B)V", line = 48)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Liq;Ljava/lang/Object;II)V", line = 81)
    ...
    @OriginalMember(owner = "client!hs", name = "c", descriptor = "(I)V", line = 188)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ILiq;)V", line = 221)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Liq;I)Ljava/lang/Object;", line = 334)
