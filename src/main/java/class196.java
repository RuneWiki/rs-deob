...
public class class196 extends class257 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(II)Lvh;", line = 18)
    ...
    @OriginalMember(owner = "client!vn", name = "g", descriptor = "(I)[B", line = 49)
    ...
    @OriginalMember(owner = "client!vn", name = "h", descriptor = "(I)I", line = 76)
