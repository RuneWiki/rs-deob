...
public class class196 extends class8 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(I)J", line = 15)
    ...
    @OriginalMember(owner = "client!wc", name = "d", descriptor = "(B)I", line = 25)
    public final int method55(byte arg0) {
        return arg0 == 71 ? this.field2596 : -5;
    }

    @OriginalMember(owner = "client!wc", name = "c", descriptor = "(B)I", line = 35)
    ...
    @OriginalMember(owner = "client!wc", name = "e", descriptor = "(B)I", line = 47)
