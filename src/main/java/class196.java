...
public class class196 extends class296 {
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(B)J", line = 16)
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(ZJ)I", line = 49)
    ...
    @OriginalMember(owner = "client!uga", name = "<init>", descriptor = "()V", line = 114)
    public class196() {
    ...
    @OriginalMember(owner = "client!uga", name = "b", descriptor = "(I)J", line = 85)
    ...
    @OriginalMember(owner = "client!uga", name = "d", descriptor = "(I)J", line = 95)
