...
public class class196 {
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(ZI)V", line = 31)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(Le;B)V", line = 65)
