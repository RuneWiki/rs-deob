...
public class class196 extends class644 {
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(IBIIIIII)V", line = 67)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ZJ)V", line = 113)
    ...
    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "(Liga;)V", line = 203)
