...
public class class121 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIIIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!sq", name = "c", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(FIFBLgl;FIIFIF)[B", line = 71)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(II)V", line = 85)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(II)V", line = 102)
    ...
    @OriginalMember(owner = "client!sq", name = "c", descriptor = "(II)Lmo;", line = 116)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIILbl;Lbl;)V", line = 152)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIIIZ[IZIII[IIILue;I)I", line = 167)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Lsn;ILci;)V", line = 349)
