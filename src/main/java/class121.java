...
public class class121 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Lr;[IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Lr;[II[I[I)V")
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Lr;[II)V")
