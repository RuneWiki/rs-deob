...
public abstract class class121 extends class210 {
    ...
    @OriginalMember(owner = "client!cda", name = "b", descriptor = "(Lha;I)Z", line = 8)
    ...
    @OriginalMember(owner = "client!cda", name = "c", descriptor = "(I)Z", line = 19)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(ZIBLlq;Lha;II)V", line = 30)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "([Lgu;I)I", line = 43)
    ...
    @OriginalMember(owner = "client!cda", name = "f", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!cda", name = "d", descriptor = "(I)Z", line = 70)
    ...
    @OriginalMember(owner = "client!cda", name = "b", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!cda", name = "<init>", descriptor = "(IIIIIII)V", line = 93)
