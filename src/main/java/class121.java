...
public class class121 extends class385 implements class306 {
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(Lcba;I)V", line = 6)
    public final void method166(class516 arg0, int arg1) {
        super.method166(arg0, arg1);
    }

    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 13)
    ...
    @OriginalMember(owner = "client!eea", name = "c", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!eea", name = "<init>", descriptor = "(Lss;Lhi;III[B)V", line = 36)
