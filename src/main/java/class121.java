...
public class class121 extends class270 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ILia;)V")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IIILec;)V")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ILia;Z)V")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lou;Z)I")
