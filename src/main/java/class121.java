...
public class class121 extends class702 {
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(IILua;II)V")
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(FFFFFFILua;II)V")
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "(Lrr;IIZ)V")
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "(Lrr;II[III)V")
