...
public class class121 extends class338 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(I)V", line = 3)
    public final void method189(int arg0) {
    }

    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Ltp;)V", line = 5)
    public final void method188(class375 arg0) {
        this.field4685.method303(arg0);
    }

    @OriginalMember(owner = "client!li", name = "b", descriptor = "()Z", line = 11)
    public final boolean method191() {
        return true;
    }

    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Z)V", line = 14)
    public final void method190(boolean arg0) {
        this.field4685.method353(8448, 7681);
    }

    @OriginalMember(owner = "client!li", name = "a", descriptor = "()V", line = 18)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(Z)V", line = 33)
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Lfu;)V", line = 56)
