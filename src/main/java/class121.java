...
public class class121 {
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(ILtn;)V", line = 11)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(B)V", line = 34)
    public static void method795(byte arg0) {
        int var1 = 26 % ((arg0 - 50) / 57);
        field1453 = null;
    }

    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(ILha;IIIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IILtn;)V", line = 115)
