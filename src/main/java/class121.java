...
public class class121 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(II)Lon;", line = 26)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(ZLek;)V", line = 69)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IB)V", line = 121)
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "(Lgn;ILvo;)V", line = 139)
    public class121(class529 arg0, int arg1, class345 arg2) {
        this.field1974 = arg2;
        this.field1974.method2098(0, 32);
    }

    @OriginalMember(owner = "client!nd", name = "b", descriptor = "(B)V", line = 156)
    ...
    @OriginalMember(owner = "client!nd", name = "b", descriptor = "(I)V", line = 171)
