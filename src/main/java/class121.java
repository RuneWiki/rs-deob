...
public class class121 extends class334 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IIILfe;ILmp;IIIIII)V")
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IZIIIILgga;)V")
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(BLm;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IZLol;)V")
