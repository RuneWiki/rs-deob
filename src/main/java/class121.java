...
public class class121 extends class366 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(BII)V", line = 3)
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 13)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IIZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(ZII)V", line = 58)
    ...
    @OriginalMember(owner = "client!gd", name = "d", descriptor = "(I)I", line = 88)
