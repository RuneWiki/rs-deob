...
public class class121 {
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(ILae;)V")
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Lru;I)Z")
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(Lae;)V")
