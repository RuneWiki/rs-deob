...
public class class121 extends class350 implements class3 {
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(Lha;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!bba", name = "<init>", descriptor = "(Lha;Ltk;IIIIIZIIZ)V", line = 39)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(IIILha;)Z", line = 72)
    ...
    @OriginalMember(owner = "client!bba", name = "h", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(Lha;B)Lkv;", line = 101)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(BLha;)V", line = 127)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(ILjava/lang/String;B)V", line = 138)
    ...
    @OriginalMember(owner = "client!bba", name = "b", descriptor = "(Lha;B)Lrga;", line = 152)
    ...
    @OriginalMember(owner = "client!bba", name = "b", descriptor = "(I)I", line = 166)
    ...
    @OriginalMember(owner = "client!bba", name = "e", descriptor = "(I)Z", line = 180)
    ...
    @OriginalMember(owner = "client!bba", name = "e", descriptor = "(B)I", line = 191)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(IBLha;Z)Lvh;", line = 202)
    ...
    @OriginalMember(owner = "client!bba", name = "j", descriptor = "(I)V", line = 232)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(ILha;)V", line = 245)
    ...
    @OriginalMember(owner = "client!bba", name = "b", descriptor = "(B)I", line = 278)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(Lha;IB)Lka;", line = 289)
    ...
    @OriginalMember(owner = "client!bba", name = "g", descriptor = "(I)I", line = 316)
    ...
    @OriginalMember(owner = "client!bba", name = "f", descriptor = "(I)Z", line = 328)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(I)V", line = 346)
    ...
    @OriginalMember(owner = "client!bba", name = "f", descriptor = "(B)Z", line = 361)
    ...
    @OriginalMember(owner = "client!bba", name = "c", descriptor = "(B)I", line = 376)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(ZILha;ILrda;II)V", line = 387)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(B)Z", line = 417)
    ...
    @OriginalMember(owner = "client!bba", name = "d", descriptor = "(B)V", line = 430)
