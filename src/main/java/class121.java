...
public class class121 {
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(IB)V", line = 38)
    ...
    @OriginalMember(owner = "client!fv", name = "b", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(II)Lnb;", line = 65)
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "(Lcw;ILeq;)V", line = 102)
