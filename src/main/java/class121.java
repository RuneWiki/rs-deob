...
public class class121 extends class424 implements class258 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IILha;)Lka;")
    ...
    @OriginalMember(owner = "client!co", name = "b", descriptor = "(ILha;)Ljda;")
    ...
    @OriginalMember(owner = "client!co", name = "p", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lha;III)Z")
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!co", name = "c", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!co", name = "b", descriptor = "(Lha;I)Lhw;")
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(BZILha;)Lak;")
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "(Lha;Liv;IIIIIZIIII)V")
