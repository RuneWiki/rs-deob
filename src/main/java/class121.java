...
public class class121 extends class68 implements class182 {
    ...
    @OriginalMember(owner = "client!lk", name = "d", descriptor = "(Lam;)V")
    ...
    @OriginalMember(owner = "client!lk", name = "c", descriptor = "(Lam;)V")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Lam;)V")
    ...
    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "(Lih;I[BIZ)V")
    public class121(class330 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field1620 = arg1;
    }

    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "(Lih;ILjava/nio/ByteBuffer;Z)V")
    public class121(class330 arg0, int arg1, ByteBuffer arg2, boolean arg3) {
        super(arg0, 34962, arg2, arg3);
        this.field1620 = arg1;
    }

    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(Lam;)V")
