...
public class class121 extends class409 {
    ...
    @OriginalMember(owner = "client!hm", name = "c", descriptor = "(I)J", line = 3)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!hm", name = "f", descriptor = "(I)J", line = 27)
    ...
    @OriginalMember(owner = "client!hm", name = "<init>", descriptor = "()V", line = 105)
    public class121() {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(BI)I", line = 65)
