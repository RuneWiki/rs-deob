...
public class class121 extends class190 {
    ...
    @OriginalMember(owner = "client!n", name = "l", descriptor = "Llf;")
    public static class109 field2345 = class35.method275("Regeln versto-8en hat)3", 2);

    @OriginalMember(owner = "client!n", name = "m", descriptor = "[Led;")
    ...
    @OriginalMember(owner = "client!n", name = "k", descriptor = "[Lkf;")
