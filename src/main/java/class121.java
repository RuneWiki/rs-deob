...
public class class121 extends class344 {
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Lse;IIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Lse;IIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIII[BIIIZ)V", line = 30)
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Lse;IIIIZ[IZ)V", line = 76)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIII)V", line = 125)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II)V", line = 131)
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Lse;IIIIZ[FI)V", line = 135)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(ZZ)V", line = 157)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIII[IIIZ)V", line = 168)
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Lse;IIIIZ[BIZ)V", line = 210)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "()V", line = 261)
