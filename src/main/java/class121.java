...
public class class121 extends class324 {
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(Loea;IIIIIIIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(Lha;J)V")
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(Loea;IIIIIIIIIIIZZ)V")
