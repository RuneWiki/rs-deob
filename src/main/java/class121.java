...
public abstract class class121 {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIBILna;III)V", line = 18)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lwg;IZILwg;I[IBIII)V", line = 145)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(BIZ[IIII[III)V", line = 185)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(II)I", line = 290)
    public static int method909(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!c", name = "a", descriptor = "(III)V", line = 298)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ZLki;IILtr;[IZIIILtr;[Z)V", line = 348)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lwg;ZLwg;IIIIII)V", line = 553)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Z)V", line = 589)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIIII)V", line = 623)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lwg;IIZILwg;I[ZLwg;IIIIILwg;)V", line = 676)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lwg;II)V", line = 743)
