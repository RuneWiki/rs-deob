...
public abstract class class121 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!r", name = "providesignlink", descriptor = "(Ldr;)V", line = 56)
    ...
    @OriginalMember(owner = "client!r", name = "b", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!r", name = "c", descriptor = "(I)[Ljt;", line = 77)
    ...
    @OriginalMember(owner = "client!r", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 157)
    ...
    @OriginalMember(owner = "client!r", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 173)
    public final void windowDeactivated(WindowEvent arg0) {
        field1779++;
    }

    @OriginalMember(owner = "client!r", name = "a", descriptor = "([BI[BIIIIBI)V", line = 185)
    ...
    @OriginalMember(owner = "client!r", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 229)
    public final void focusLost(FocusEvent arg0) {
        class30.field399 = false;
        field1781++;
    }

    @OriginalMember(owner = "client!r", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 237)
    public final void windowClosing(WindowEvent arg0) {
        field1812++;
        this.destroy();
    }

    @OriginalMember(owner = "client!r", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 246)
    public final void windowIconified(WindowEvent arg0) {
        field1800++;
    }

    @OriginalMember(owner = "client!r", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 254)
    public final void windowDeiconified(WindowEvent arg0) {
        field1788++;
    }

    @OriginalMember(owner = "client!r", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 261)
    public final void windowActivated(WindowEvent arg0) {
        field1784++;
    }

    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IIZII)V", line = 269)
    ...
    @OriginalMember(owner = "client!r", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 318)
    ...
    @OriginalMember(owner = "client!r", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 327)
    ...
    @OriginalMember(owner = "client!r", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 348)
    ...
    @OriginalMember(owner = "client!r", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 366)
    public final void update(Graphics arg0) {
        field1783++;
        this.paint(arg0);
    }

    @OriginalMember(owner = "client!r", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 376)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "([BI)Z", line = 390)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(ZB)V", line = 417)
    ...
    @OriginalMember(owner = "client!r", name = "run", descriptor = "()V", line = 496)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(B[Ljava/lang/String;)[Ljava/lang/String;", line = 611)
    ...
    @OriginalMember(owner = "client!r", name = "stop", descriptor = "()V", line = 640)
    ...
    @OriginalMember(owner = "client!r", name = "start", descriptor = "()V", line = 652)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(ILjava/lang/String;)V", line = 663)
    ...
    @OriginalMember(owner = "client!r", name = "g", descriptor = "(I)V", line = 689)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Z)V", line = 735)
    ...
    @OriginalMember(owner = "client!r", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 771)
    public final void windowClosed(WindowEvent arg0) {
        field1801++;
    }

    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IBI)Z", line = 780)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(ZLjava/lang/String;IIIIII)V", line = 795)
    ...
    @OriginalMember(owner = "client!r", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 836)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(B)V", line = 857)
    ...
    @OriginalMember(owner = "client!r", name = "i", descriptor = "(I)Z", line = 888)
    ...
    @OriginalMember(owner = "client!r", name = "b", descriptor = "(Z)Ljava/lang/String;", line = 924)
    ...
    @OriginalMember(owner = "client!r", name = "destroy", descriptor = "()V", line = 941)
    ...
    @OriginalMember(owner = "client!r", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 956)
