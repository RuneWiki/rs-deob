...
public class class121 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(II)V", line = 7)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(IJZII)Ljava/lang/String;", line = 24)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Ljava/lang/String;ICLjava/lang/String;)Ljava/lang/String;", line = 104)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(IIIZ)Z", line = 159)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Z)V", line = 295)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(B)V", line = 308)
    ...
    @OriginalMember(owner = "client!rv", name = "b", descriptor = "(Z)I", line = 320)
