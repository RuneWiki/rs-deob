...
public class class121 extends class96 {
    ...
    @OriginalMember(owner = "client!pe", name = "g", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!pe", name = "e", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "()V", line = 225)
    public class121() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(I[IB)V", line = 65)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IIIIIII)I", line = 228)
    ...
    @OriginalMember(owner = "client!pe", name = "e", descriptor = "(B)V", line = 301)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(ILjava/awt/Canvas;)Lrm;", line = 312)
    ...
    @OriginalMember(owner = "client!pe", name = "b", descriptor = "(Z)V", line = 335)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IILbt;)V", line = 382)
    ...
    @OriginalMember(owner = "client!pe", name = "b", descriptor = "(II)[I", line = 482)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(ZLqa;)V", line = 511)
