...
public class class121 extends class148 implements class395 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(BIZLdp;II)V")
    ...
    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "(Lja;Lfb;IIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Lja;II)Lrc;")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Lmb;III)V")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(BLja;)Lkh;")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IIZLja;)Lob;")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(ILja;)V")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Lja;I)V")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(ILja;II)Z")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(ZLja;)V")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IBZIILnf;Lja;)V")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(BILja;)Lrc;")
