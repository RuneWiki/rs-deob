...
public class class121 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIIJZLwu;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(I)Z", line = 26)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ZLjava/lang/String;BLjava/lang/String;)V", line = 43)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ZB)V", line = 78)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "(BIIIIIILkf;)V", line = 160)
