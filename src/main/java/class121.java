...
public class class121 implements class217 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Lpl;II)Lf;", line = 34)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Lks;B)V", line = 60)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ZI)V", line = 92)
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(Lpl;Lmk;)V", line = 133)
