...
public class class121 extends class774 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IIIIIIIIIIIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!kr", name = "g", descriptor = "(I)Z", line = 25)
    public final boolean method855(int arg0) {
        field1608++;
        return arg0 != -16309;
    }

    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IIII)V", line = 40)
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 64)
    public class121(Object arg0, int arg1) {
        super(arg1);
        this.field1610 = arg0;
    }

    @OriginalMember(owner = "client!kr", name = "h", descriptor = "(I)Ljava/lang/Object;", line = 72)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(FFIF)I", line = 83)
