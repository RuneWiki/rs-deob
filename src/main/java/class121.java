...
public class class121 extends class497 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Lmaa;B)V")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ZILqfa;Ljava/lang/String;)Lnk;")
    ...
    @OriginalMember(owner = "client!ri", name = "<init>", descriptor = "(Lko;Lwia;Lui;)V")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Lfb;I)V")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Lwia;BII)Lie;")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(BILkja;)V")
