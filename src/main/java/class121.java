...
public abstract class class121 {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIILd;ZLd;III)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "([IIILd;BIILd;ZII)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IBLd;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIIIILna;BI)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "([ZIIILgr;Lvb;ZZLvb;II[I)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IZIZLd;IIILd;Ld;I[ZLd;II)V")
