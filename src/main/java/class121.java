...
public class class121 implements class535 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(BII)V", line = 3)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(III)V", line = 56)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(BII)V", line = 85)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IZ)I", line = 112)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(BI)I", line = 125)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(I)V", line = 153)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(BZ)I", line = 169)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(III)V", line = 209)
