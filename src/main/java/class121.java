...
public abstract class class121 {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IZBLdr;ILdr;III)V", line = 7)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ILdr;I)V", line = 40)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIZLdr;Ldr;ILdr;[ZIILdr;IIII)V", line = 81)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(II)Ljava/lang/String;", line = 154)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(III)Z", line = 179)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(II[ZZ[IIIILpf;Lpf;Lqs;Z)V", line = 191)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(I)V", line = 397)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(II[III[IIIZI)V", line = 412)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(I[IIIZLdr;Ldr;IIII)V", line = 520)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIILna;IIII)V", line = 571)
