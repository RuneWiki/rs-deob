...
public class class121 extends class477 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ILjava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(I)Lji;", line = 35)
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(Lmq;)V", line = 55)
    public class121(class542 arg0) {
        this.field1563 = arg0;
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(II)V", line = 63)
