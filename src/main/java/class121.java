...
public class class121 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IC)B", line = 17)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(II)Z", line = 143)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIIBII)V", line = 157)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(III)I", line = 276)
