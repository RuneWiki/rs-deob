...
public class class121 {
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(IIBII)I", line = 5)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(ILrea;)Z", line = 18)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(ILdc;)V", line = 50)
    ...
    @OriginalMember(owner = "client!rea", name = "<init>", descriptor = "()V", line = 86)
    public class121() {
    ...
    @OriginalMember(owner = "client!rea", name = "<init>", descriptor = "(Ldc;)V", line = 102)
