...
public class class121 extends class153 implements class196 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IIILqa;)Z")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ILqa;B)Lc;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IILqa;)Lc;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lqa;I)Lpj;")
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(Lqa;Leu;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lqa;ZIB)Lfo;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lqv;BLqa;IZII)V")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(BLqa;)V")
