...
public class class121 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(BLgw;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Lin;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(B)Lmb;", line = 52)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(B)V", line = 134)
    public static void method868(byte arg0) {
        int var1 = -114 / ((32 - arg0) / 61);
        field1713 = null;
    }

    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(BLgw;I)V", line = 150)
