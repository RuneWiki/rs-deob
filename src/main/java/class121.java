...
public class class121 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(ILtf;IILha;)V", line = 3)
    ...
    @OriginalMember(owner = "client!uc", name = "b", descriptor = "(B)I", line = 37)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(BI)I", line = 50)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Luja;I)Z", line = 81)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(BLdd;)V", line = 109)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(II)Ldd;", line = 120)
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "(Ldd;)V", line = 133)
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "([Ldd;)V", line = 142)
    public class121(class212[] arg0) {
        try {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(BILjava/lang/String;)V", line = 156)
