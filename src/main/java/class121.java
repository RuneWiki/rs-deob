...
public class class121 extends class86 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IILwm;)Z")
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IIILwm;ZLhp;Z)V")
    ...
    @OriginalMember(owner = "client!oe", name = "b", descriptor = "(Lwm;B)Lnf;")
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IIBLwm;)Z")
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lwm;B)V")
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lfk;I)V")
