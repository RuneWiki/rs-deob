...
public class class23 extends class694 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(II)[I", line = 9)
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "()V", line = 41)
    public class23() {
        super(1, false);
    }

    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(ILpj;Lpj;Lso;Lpj;)Z", line = 45)
    ...
    @OriginalMember(owner = "client!nc", name = "i", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!nc", name = "c", descriptor = "(II)[[I", line = 77)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(ILjr;B)V", line = 127)
