...
public class class23 extends class465 {
    ...
    private class68 field386;

    @OriginalMember(owner = "client!nc", name = "u", descriptor = "[Lfp;")
    public static class299[] field388;
    ...
    public final void method210(int arg0, boolean arg1) {
        ...
        if (this.field386 != null) {
            int var3 = 49 % ((-30 - arg0) / 38);
            this.field386.method536((byte) 115, '\u0000');
            super.field6268.method3629((byte) 23, 1);
            OpenGL.glMatrixMode(5890);
            OpenGL.glLoadMatrixf(super.field6268.field9226.method3875(true), 0);
            OpenGL.glRotatef(-180.0F, 1.0F, 0.0F, 0.0F);
            OpenGL.glMatrixMode(5888);
            super.field6268.method3629((byte) -128, 0);
            if (~super.field6268.field9186 != ~this.field380) {
                int var4 = super.field6268.field9186 % 5120 * 128 / 5120;
                int var5 = var4 * 128;
                for (int var6 = 0; var6 < 64; ++var6) {
                    OpenGL.glProgramLocalParameter4fvARB(34336, var6, this.field385, var5);
                    var5 += 2;
                }
                if (this.field375.field2976) {
                    this.field384 = (float) (super.field6268.field9186 % 4000) / 4000.0F;
                } else {
                    OpenGL.glProgramLocalParameter4fARB(34336, 65, 0.0F, 0.0F, 0.0F, 1.0F);
                }
                this.field380 = super.field6268.field9186;
            }
        }
    }

    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(ZBI)V")
    public static final void method211(boolean arg0, byte arg1, int arg2) {
        ++field391;
        int var3 = -94 % ((-28 - arg1) / 38);
        class521 var4 = class265.method1620(arg2, arg0, false);
        if (var4 != null) {
            var4.method2797(-123);
        }
    }

    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IILhf;)V")
    ...
    public final void method213(int arg0) {
        ...
        if (this.field386 != null) {
            if (arg0 == 15495) {
                this.field386.method536((byte) 116, '\u0001');
                super.field6268.method3629((byte) -120, 1);
                super.field6268.method3630((class367) null, -2);
                super.field6268.method3629((byte) -100, 0);
            }
        }
    }

    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Lno;Lhm;)V")
    public class23(class658 arg0, class207 arg1) {
        super(arg0);
        this.field375 = arg1;
        if (super.field6268.field9251 && super.field6268.field9237 >= 2) {
            this.field376 = class364.method2150(61, 34336, super.field6268, "!!ARBvp1.0\nOPTION  ARB_position_invariant;\nATTRIB  iPos         = vertex.position;\nATTRIB  iColour      = vertex.color;\nATTRIB  iTexCoord    = vertex.texcoord[0];\nOUTPUT  oColour      = result.color;\nOUTPUT  oTexCoord0   = result.texcoord[0];\nOUTPUT  oTexCoord1   = result.texcoord[1];\nOUTPUT  oFogCoord    = result.fogcoord;\nPARAM   time         = program.local[65];\nPARAM   turbulence   = program.local[64];\nPARAM   lightAmbient = program.local[66]; \nPARAM   pMatrix[4]   = { state.matrix.projection };\nPARAM   mvMatrix[4]  = { state.matrix.modelview };\nPARAM   ivMatrix[4]  = { state.matrix.texture[1] };\nPARAM   texMatrix[4]  = { state.matrix.texture[0] };\nPARAM   fNoise[64]   = { program.local[0..63] };\nTEMP    noise, viewPos, worldPos, texCoord;\nADDRESS noiseAddr;\nDP4   viewPos.x, mvMatrix[0], iPos;\nDP4   viewPos.y, mvMatrix[1], iPos;\nDP4   viewPos.z, mvMatrix[2], iPos;\nDP4   viewPos.w, mvMatrix[3], iPos;\nMOV   oFogCoord.x, -viewPos.z;\nDP4   worldPos.x, ivMatrix[0], viewPos;\nDP4   worldPos.y, ivMatrix[1], viewPos;\nDP4   worldPos.z, ivMatrix[2], viewPos;\nDP4   worldPos.w, ivMatrix[3], viewPos;\nADD   noise.x, worldPos.x, worldPos.z;SUB   noise.y, worldPos.z, worldPos.x;MUL   noise, noise, 0.0001220703125;\nFRC   noise, noise;\nMUL   noise, noise, 64;\nARL   noiseAddr.x, noise.x;\nMOV   noise.x, fNoise[noiseAddr.x].x;\nARL   noiseAddr.x, noise.y;\nMOV   noise.y, fNoise[noiseAddr.x].y;\nMUL   noise, noise, turbulence.x;\nDP4   texCoord.x, texMatrix[0], iTexCoord;\nDP4   texCoord.y, texMatrix[1], iTexCoord;\nADD   oTexCoord0.xy, texCoord, noise;\nMOV   oTexCoord0.z, 0;\nMOV   oTexCoord0.w, 1;\nMUL   oTexCoord1.xy, texCoord, 0.125;\nMOV   oTexCoord1.zw, time.xxxw;\nMUL   oColour.xyz, iColour, lightAmbient;\nMOV   oColour.w, iColour.w;\nEND");
            if (this.field376 != null) {
                int[][] var3 = class675.method3771(256, 4, 4096, 0, 0.4F, false, 64, 8, 3);
                int[][] var4 = class675.method3771(256, 4, 4096, 8, 0.4F, false, 64, 8, 3);
                this.field385 = new float[32768];
                int var5 = 0;
                for (int var6 = 0; ~var6 > -257; ++var6) {
                    int[] var7 = var3[var6];
                    int[] var8 = var4[var6];
                    for (int var9 = 0; ~var9 > -65; ++var9) {
                        this.field385[var5++] = (float) var7[var9] / 4096.0F;
                        this.field385[var5++] = (float) var8[var9] / 4096.0F;
                    }
                }
                this.method217(-11209);
            }
        }
    }
    ...
    public final void method215(int arg0, int arg1, int arg2) {
        ++field374;
        if (this.field386 != null) {
            super.field6268.method3629((byte) 78, 1);
            if (~(128 & arg2) == -1) {
                if ((arg0 & 1) == 1) {
                    if (!this.field375.field2976) {
                        int var4 = super.field6268.field9186 % 4000 * 16 / 4000;
                        super.field6268.method3630(this.field375.field2979[var4], arg1 + -2);
                        OpenGL.glProgramLocalParameter4fARB(34336, 65, 0.0F, 0.0F, 0.0F, 1.0F);
                    } else {
                        super.field6268.method3630(this.field375.field2975, -2);
                        OpenGL.glProgramLocalParameter4fARB(34336, 65, this.field384, 0.0F, 0.0F, 1.0F);
                    }
                } else {
                    if (!this.field375.field2976) {
                        super.field6268.method3630(this.field375.field2979[0], -2);
                    } else {
                        super.field6268.method3630(this.field375.field2975, arg1 ^ -2);
                    }
                    OpenGL.glProgramLocalParameter4fARB(34336, 65, 0.0F, 0.0F, 0.0F, 1.0F);
                }
            } else {
            ...
            super.field6268.method3629((byte) 97, 0);
            if ((arg2 & 64) != arg1) {
                OpenGL.glProgramLocalParameter4fARB(34336, 66, 1.0F, 1.0F, 1.0F, 1.0F);
            } else {
                OpenGL.glGetFloatv(2899, class708.field9931, 0);
                OpenGL.glProgramLocalParameter4fvARB(34336, 66, class708.field9931, 0);
            }
            int var5 = arg2 & 3;
            if (~var5 == -3) {
    ...
    private final void method217(int arg0) {
        ++field377;
        this.field386 = new class68(super.field6268, 2);
        this.field386.method537(0, (byte) 3);
        super.field6268.method3629((byte) 60, 1);
        super.field6268.method3628(-3672, -16777216);
        super.field6268.method3644(7681, 23560, 260);
        super.field6268.method3672(770, 0, 34166, -6491);
        super.field6268.method3629((byte) -97, 0);
        OpenGL.glBindProgramARB(34336, this.field376.field2738);
        OpenGL.glEnable(34336);
        this.field386.method539(true);
        this.field386.method537(1, (byte) 3);
        super.field6268.method3629((byte) -108, 1);
        OpenGL.glMatrixMode(5890);
        OpenGL.glLoadIdentity();
        OpenGL.glMatrixMode(5888);
        super.field6268.method3603((byte) -34, 0);
        super.field6268.method3672(770, 0, 5890, -6491);
        super.field6268.method3629((byte) -120, 0);
