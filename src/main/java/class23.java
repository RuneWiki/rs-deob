...
public class class23 extends class292 {
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!an", name = "e", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(I)V", line = 27)
    public final void method66(int arg0) {
        int var2 = 3 % ((arg0 - 80) / 44);
        ++field212;
    }

    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IJ)V", line = 41)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Lnv;II[BI)V", line = 54)
