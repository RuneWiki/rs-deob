...
public class class23 extends class465 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IZ)V", line = 14)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(ZBI)V", line = 64)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IILhf;)V", line = 86)
    ...
    @OriginalMember(owner = "client!nc", name = "b", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Lno;Lhm;)V", line = 120)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(BZ)V", line = 182)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(III)V", line = 192)
    ...
    @OriginalMember(owner = "client!nc", name = "d", descriptor = "(I)V", line = 260)
    ...
    @OriginalMember(owner = "client!nc", name = "e", descriptor = "(I)V", line = 276)
    ...
    @OriginalMember(owner = "client!nc", name = "c", descriptor = "(I)Z", line = 311)
