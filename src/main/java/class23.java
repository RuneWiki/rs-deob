...
public class class23 extends class179 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(I[II)V", line = 3)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "([FFIFIBIIIIIIF)V", line = 128)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(II)V", line = 215)
    ...
    @OriginalMember(owner = "client!uc", name = "d", descriptor = "(I)V", line = 228)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(ZI)V", line = 245)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IIIIF)V", line = 258)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(BI)V", line = 372)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IIII)V", line = 391)
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "(Ltn;IIIII)V", line = 421)
