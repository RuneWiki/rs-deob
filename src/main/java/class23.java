...
public abstract class class23 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Z)Z", line = 3)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ILmk;)Z", line = 90)
    ...
    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "(III)V", line = 117)
