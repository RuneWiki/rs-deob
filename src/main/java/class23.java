...
public class class23 extends class34 {
    ...
    @OriginalMember(owner = "client!JMUIRIHZ", name = "vb", descriptor = "LVWKJSKWX;")
    ...
    @OriginalMember(owner = "client!JMUIRIHZ", name = "b", descriptor = "(Z)LCADBNSXE;")
    ...
    @OriginalMember(owner = "client!JMUIRIHZ", name = "a", descriptor = "(I)LCADBNSXE;")
