...
public class class23 extends class34 {
    ...
    @OriginalMember(owner = "client!JBYEFPCA", name = "A", descriptor = "LRIUJHZLL;")
    ...
    @OriginalMember(owner = "client!JBYEFPCA", name = "q", descriptor = "Lclient;")
    public static client field818;

    @OriginalMember(owner = "client!JBYEFPCA", name = "a", descriptor = "(I)LBQKZHFKO;")
    ...
    @OriginalMember(owner = "client!JBYEFPCA", name = "a", descriptor = "(Z)LWEVRTBOZ;")
