...
public class class23 implements Runnable {
    ...
    @OriginalMember(owner = "client!qia", name = "run", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!qia", name = "b", descriptor = "(I)Z", line = 167)
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(II)Lst;", line = 212)
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(IBILkq;)V", line = 229)
