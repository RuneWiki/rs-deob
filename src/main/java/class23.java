...
public class class23 {
    ...
    @OriginalMember(owner = "client!HUPZKMWH", name = "d", descriptor = "[LHUPZKMWH;")
    public static class23[] field884;

    @OriginalMember(owner = "client!HUPZKMWH", name = "a", descriptor = "(ZLMJLXHQTQ;)V")
    ...
    @OriginalMember(owner = "client!HUPZKMWH", name = "a", descriptor = "(IILXGRGMPUQ;)V")
