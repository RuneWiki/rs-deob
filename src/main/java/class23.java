...
public class class23 {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IILpe;)V")
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(Lrs;)V")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Lnba;IZ)Z")
