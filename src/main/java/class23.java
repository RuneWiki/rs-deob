...
public class class23 extends class235 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(IILza;Luh;III)V")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(IZLza;Lfh;[II)V")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(IZIIIILuh;IILza;I)V")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Lza;B)V")
    ...
    @OriginalMember(owner = "client!ks", name = "c", descriptor = "(I)Lwr;")
    public static final class537 method147(int arg0) {
        ++field260;
        return arg0 != 19042 ? null : class362.field5327;
    }

    @OriginalMember(owner = "client!ks", name = "a", descriptor = "([BLza;IIIIIIIB[Luh;)V")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(II[IIILza;IBIILfh;)V")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "([BILza;[Luh;BI)V")
