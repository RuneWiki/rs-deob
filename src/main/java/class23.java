...
public class class23 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lf;B)V")
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(ZIILha;)Lufa;")
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lji;Z)V")
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Lji;BI)V")
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(II[Lsba;)V")
