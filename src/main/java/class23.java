...
public class class23 implements class171 {
    ...
    @OriginalMember(owner = "client!dr", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!dr", name = "c", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "([J[IIIB)V", line = 46)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(I)Lvm;", line = 105)
    ...
    @OriginalMember(owner = "client!dr", name = "b", descriptor = "(Z)V", line = 117)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IILpaa;I)V", line = 140)
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(Lwu;Ljava/lang/String;)V", line = 215)
