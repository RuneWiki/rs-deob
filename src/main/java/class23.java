...
public class class23 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(JB)Lmt;")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Ljd;III)V")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Ldt;B)Z")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(ILmt;J)V")
