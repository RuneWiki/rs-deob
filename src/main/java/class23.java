...
public abstract class class23 {
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!qia", name = "c", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!qia", name = "d", descriptor = "(I)V", line = 82)
