...
public class class23 extends class522 implements class401 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(B)I", line = 6)
    public final int method222(byte arg0) {
        field350++;
        return arg0 > -99 ? -17 : 0;
    }

    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Lya;IIILqj;IZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Lya;B)V", line = 44)
    public final void method225(class11 arg0, byte arg1) {
        field344++;
        int var3 = 116 / ((42 - arg1) / 36);
    }

    @OriginalMember(owner = "client!ks", name = "d", descriptor = "(B)V", line = 53)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Lrm;IIIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 129)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(Z)V", line = 159)
    ...
    @OriginalMember(owner = "client!ks", name = "e", descriptor = "(I)Z", line = 170)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(BLya;)V", line = 181)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Z)Z", line = 191)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(ILya;II)Z", line = 202)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Lya;I)V", line = 213)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(IIB)I", line = 223)
    ...
    @OriginalMember(owner = "client!ks", name = "<init>", descriptor = "(IIIIIIIIIILmv;)V", line = 246)
    ...
    @OriginalMember(owner = "client!ks", name = "g", descriptor = "(I)I", line = 258)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(BLjava/lang/String;)V", line = 269)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(Lya;I)Lmo;", line = 365)
    ...
    @OriginalMember(owner = "client!ks", name = "c", descriptor = "(I)V", line = 376)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(I)I", line = 387)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(ILya;I)Lt;", line = 409)
