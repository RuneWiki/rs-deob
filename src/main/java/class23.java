...
public class class23 implements Runnable {
    ...
    @OriginalMember(owner = "client!HUWYSFFT", name = "f", descriptor = "LVZUGTFOW;")
    ...
    @OriginalMember(owner = "client!HUWYSFFT", name = "<init>", descriptor = "(ZLjava/net/Socket;LVZUGTFOW;)V")
