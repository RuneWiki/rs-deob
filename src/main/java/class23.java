...
public class class23 extends class61 {
    ...
    @OriginalMember(owner = "client!FHQGDDHF", name = "Pb", descriptor = "LLSQNLJTA;")
    ...
    @OriginalMember(owner = "client!FHQGDDHF", name = "xb", descriptor = "LLFTMDGKK;")
    public class37 field732;

    @OriginalMember(owner = "client!FHQGDDHF", name = "Nb", descriptor = "LOMIIKHIV;")
    public class47 field748;

    @OriginalMember(owner = "client!FHQGDDHF", name = "yb", descriptor = "Ljava/lang/String;")
    public String field733;

    @OriginalMember(owner = "client!FHQGDDHF", name = "c", descriptor = "(Z)LLFTMDGKK;")
    ...
    @OriginalMember(owner = "client!FHQGDDHF", name = "d", descriptor = "(Z)LLFTMDGKK;")
    ...
    @OriginalMember(owner = "client!FHQGDDHF", name = "a", descriptor = "(LCFARFRSG;I)V")
    ...
    @OriginalMember(owner = "client!FHQGDDHF", name = "a", descriptor = "(I)LLFTMDGKK;")
