...
public class class23 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(B)Lnfa;", line = 4)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Z)Lnfa;", line = 20)
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "(B)Lnfa;", line = 41)
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "(Z)V", line = 61)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(I)I", line = 89)
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "(I)Lnfa;", line = 110)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(ZZB)V", line = 133)
    ...
    @OriginalMember(owner = "client!an", name = "c", descriptor = "(B)Z", line = 165)
    ...
    @OriginalMember(owner = "client!an", name = "c", descriptor = "(I)V", line = 176)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(ILnfa;)V", line = 198)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "()V", line = 231)
    public class23() {
