...
public class class23 {
    ...
    @OriginalMember(owner = "client!gaa", name = "b", descriptor = "(Z)I", line = 9)
    ...
    @OriginalMember(owner = "client!gaa", name = "c", descriptor = "(I)Z", line = 20)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(IIII)V", line = 34)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(IIIIIIII)V", line = 59)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!gaa", name = "b", descriptor = "(I)I", line = 119)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(III)Z", line = 131)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(I)Z", line = 150)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Z)V", line = 161)
    ...
    @OriginalMember(owner = "client!gaa", name = "<init>", descriptor = "(ZIIZ)V", line = 173)
