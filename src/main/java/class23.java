...
public class class23 extends class256 {
    ...
    @OriginalMember(owner = "client!uc", name = "h", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IF)V", line = 23)
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "(IIIIIF)V", line = 34)
    public class23(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IIII)V", line = 37)
