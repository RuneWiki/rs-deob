...
public class class23 {
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(B)Lts;", line = 5)
    ...
    @OriginalMember(owner = "client!vha", name = "b", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(Lha;I)V", line = 69)
