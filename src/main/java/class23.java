...
public class class23 {
    ...
    @OriginalMember(owner = "client!IEVJZYTE", name = "b", descriptor = "Z")
    ...
    @OriginalMember(owner = "client!IEVJZYTE", name = "d", descriptor = "[LIEVJZYTE;")
    public static class23[] field904;

    @OriginalMember(owner = "client!IEVJZYTE", name = "a", descriptor = "(ILQDHHNYHL;)V")
    ...
    @OriginalMember(owner = "client!IEVJZYTE", name = "a", descriptor = "(LPGNBHFUF;I)V")
    ...
    @OriginalMember(owner = "client!IEVJZYTE", name = "a", descriptor = "(Z)LPOJFANDE;")
    ...
    @OriginalMember(owner = "client!IEVJZYTE", name = "a", descriptor = "(B)LPOJFANDE;")
