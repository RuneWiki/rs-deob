...
public abstract class class23 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Lsv;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(IBI[B)[B", line = 47)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(ZIIII)V", line = 71)
