...
public abstract class class23 extends class315 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(FFFFFFLsf;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "()I", line = 18)
    public final int method199() {
        return this.field425 + this.field419 + this.field407;
    }

    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(FFFFFF)V", line = 24)
    ...
    @OriginalMember(owner = "client!pn", name = "d", descriptor = "()I", line = 157)
    public final int method202() {
        return this.field412;
    }

    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(IIII)V", line = 186)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(FFFFFFIII)V", line = 192)
    ...
    @OriginalMember(owner = "client!pn", name = "c", descriptor = "()I", line = 269)
    public final int method207() {
        return this.field412 + this.field400 + this.field396;
    }

    @OriginalMember(owner = "client!pn", name = "b", descriptor = "()I", line = 272)
    public final int method208() {
        return this.field419;
    }

    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(Llh;II)V", line = 297)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IIIIIII)V", line = 304)
