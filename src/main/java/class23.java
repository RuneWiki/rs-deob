...
public class class23 {
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(III[I)Lud;")
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "([III)Lud;")
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(BI[II)Lud;")
    ...
    @OriginalMember(owner = "client!ria", name = "<init>", descriptor = "(Lgga;Lgga;)V")
    public class23(class513 arg0, class513 arg1) {
        this.field261 = arg1;
        this.field258 = arg0;
    }

    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(II[I)Lud;")
