...
public class class23 implements class451 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(I)J", line = 4)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(ILgo;)Z", line = 33)
    ...
    @OriginalMember(owner = "client!uc", name = "b", descriptor = "(I)V", line = 74)
