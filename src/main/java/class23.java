...
public class class23 extends class184 {
    ...
    @OriginalMember(owner = "client!uc", name = "e", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(II)[I", line = 20)
    ...
    @OriginalMember(owner = "client!uc", name = "f", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "()V", line = 185)
    public class23() {
        super(1, true);
    }

    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(BILfh;)V", line = 129)
    ...
    @OriginalMember(owner = "client!uc", name = "b", descriptor = "(Z)V", line = 189)
