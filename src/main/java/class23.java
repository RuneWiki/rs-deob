...
public class class23 {
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "([BBII)I", line = 4)
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 47)
    ...
    @OriginalMember(owner = "client!qia", name = "b", descriptor = "(I)Ljava/io/File;", line = 78)
    ...
    @OriginalMember(owner = "client!qia", name = "finalize", descriptor = "()V", line = 91)
    ...
    @OriginalMember(owner = "client!qia", name = "b", descriptor = "(IJ)V", line = 104)
    ...
    @OriginalMember(owner = "client!qia", name = "b", descriptor = "(B)J", line = 116)
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(III[B)V", line = 130)
    ...
    @OriginalMember(owner = "client!qia", name = "<init>", descriptor = "(Ljava/io/File;Ljava/lang/String;J)V", line = 185)
