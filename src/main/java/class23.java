...
public class class23 {
    ...
    @OriginalMember(owner = "client!cb", name = "d", descriptor = "Leh;")
    ...
    @OriginalMember(owner = "client!cb", name = "i", descriptor = "Lbg;")
    private class18 field515;

    @OriginalMember(owner = "client!cb", name = "k", descriptor = "Lbg;")
    private class18 field517;

    @OriginalMember(owner = "client!cb", name = "b", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!cb", name = "h", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!cb", name = "e", descriptor = "Llf;")
    private static class109 field511 = class35.method275("Error connecting to server)3", 2);

    @OriginalMember(owner = "client!cb", name = "r", descriptor = "Llf;")
    public static class109 field524 = class35.method275("hel", 2);

    @OriginalMember(owner = "client!cb", name = "o", descriptor = "Llf;")
    public static class109 field521 = field520;

    @OriginalMember(owner = "client!cb", name = "c", descriptor = "Llf;")
    public static class109 field509 = field511;

    @OriginalMember(owner = "client!cb", name = "x", descriptor = "Llf;")
    public static class109 field530 = field514;

    @OriginalMember(owner = "client!cb", name = "u", descriptor = "Llf;")
    private static class109 field527 = class35.method275("Loading config )2 ", 2);

    @OriginalMember(owner = "client!cb", name = "t", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "([IIII)Lk;")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lvg;I)Z")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "([IBI)Lk;")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(II[I)Lk;")
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "([IIII)Lk;")
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(Lbg;Lbg;)V")
