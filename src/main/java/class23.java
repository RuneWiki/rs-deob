...
public class class23 {
    ...
    @OriginalMember(owner = "client!GBMZYMFW", name = "c", descriptor = "[LGBMZYMFW;")
    public static class23[] field785;

    @OriginalMember(owner = "client!GBMZYMFW", name = "a", descriptor = "(ILTKEGJSFV;)V")
    ...
    @OriginalMember(owner = "client!GBMZYMFW", name = "a", descriptor = "(LEGCCHUZS;II)V")
