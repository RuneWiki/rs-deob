...
public class class23 extends class62 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "([BB)[B", line = 11)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IIII)V", line = 40)
    ...
    @OriginalMember(owner = "client!ml", name = "d", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(II)V", line = 63)
    ...
    @OriginalMember(owner = "client!ml", name = "e", descriptor = "(I)V", line = 74)
