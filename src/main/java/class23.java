...
public class class23 extends class20 {
    ...
    @OriginalMember(owner = "client!HALGFRSE", name = "l", descriptor = "LLCRVYGCP;")
    ...
    @OriginalMember(owner = "client!HALGFRSE", name = "q", descriptor = "Lclient;")
    public static client field755;

    @OriginalMember(owner = "client!HALGFRSE", name = "a", descriptor = "(I)LRTQSBWRH;")
    ...
    @OriginalMember(owner = "client!HALGFRSE", name = "a", descriptor = "(Z)LSYTHBZWG;")
