...
public class class23 extends class362 {
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(Lfca;II)V")
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(ILkh;BI)V")
    ...
    @OriginalMember(owner = "client!qia", name = "d", descriptor = "(B)V")
