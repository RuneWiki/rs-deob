...
public class class23 extends class376 {
    ...
    @OriginalMember(owner = "client!ud", name = "c", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!ud", name = "c", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Laa;I[Lie;IZI[B)V", line = 75)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(II)V", line = 149)
    ...
    @OriginalMember(owner = "client!ud", name = "d", descriptor = "(I)Z", line = 176)
    ...
    @OriginalMember(owner = "client!ud", name = "b", descriptor = "(II)V", line = 198)
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "()V", line = 210)
    public class23() {
    }

    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(I)V", line = 212)
