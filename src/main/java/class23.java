...
public class class23 extends class361 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lnr;I)V", line = 9)
    ...
    @OriginalMember(owner = "client!fk", name = "d", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(BLnr;IIZLcb;I)V", line = 57)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lqc;Lnr;I)V", line = 72)
    ...
    @OriginalMember(owner = "client!fk", name = "e", descriptor = "(B)Z", line = 99)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!fk", name = "g", descriptor = "(I)I", line = 131)
    ...
    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "(IIIIIIIIIII)V", line = 154)
    ...
    @OriginalMember(owner = "client!fk", name = "f", descriptor = "(B)V", line = 185)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(BI)I", line = 197)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Z)V", line = 211)
    ...
    @OriginalMember(owner = "client!fk", name = "finalize", descriptor = "()V", line = 231)
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(II)V", line = 245)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(ILnr;II)Z", line = 305)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lnr;II)Lqc;", line = 319)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(IIIII)V", line = 332)
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(Lnr;Z)Lg;", line = 372)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(ILil;)Luq;", line = 404)
