...
public class class23 extends class139 {
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Lel;Lpfa;Ltca;)V", line = 3)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(III)V", line = 26)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(BILgl;)V", line = 71)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IZ)V", line = 83)
    ...
    @OriginalMember(owner = "client!nc", name = "b", descriptor = "(I)Z", line = 98)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(ZI)V", line = 109)
