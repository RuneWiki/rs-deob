...
public class class23 extends class198 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(II)Lnc;")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IIILza;)Z")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(BLlr;)V")
