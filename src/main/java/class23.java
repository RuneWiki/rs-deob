...
public class class23 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IIIIIBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(III)V", line = 40)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Z)V", line = 62)
