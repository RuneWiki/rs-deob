...
public class class23 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(ZLpn;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(IIFFIIIF)[F", line = 59)
