...
public class class23 implements Runnable {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IZ)Lem;", line = 11)
    ...
    @OriginalMember(owner = "client!ud", name = "run", descriptor = "()V", line = 40)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(B)I", line = 84)
