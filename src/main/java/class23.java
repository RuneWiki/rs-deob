...
public abstract class class23 extends class295 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(II)Laa;")
    ...
    @OriginalMember(owner = "client!fk", name = "f", descriptor = "(B)Ltj;")
    ...
    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "(Lpc;)V")
