...
public class class23 {
    ...
    @OriginalMember(owner = "client!HTWOTIWO", name = "q", descriptor = "LWIUIWDML;")
    ...
    @OriginalMember(owner = "client!HTWOTIWO", name = "i", descriptor = "LDWUJPTWU;")
    public class14 field870;

    @OriginalMember(owner = "client!HTWOTIWO", name = "e", descriptor = "[LHTWOTIWO;")
    public static class23[] field866;

    @OriginalMember(owner = "client!HTWOTIWO", name = "a", descriptor = "(ILTXPLZUUI;)V")
    ...
    @OriginalMember(owner = "client!HTWOTIWO", name = "a", descriptor = "(LPKHWFJLM;Z)V")
    ...
    @OriginalMember(owner = "client!HTWOTIWO", name = "a", descriptor = "()LPSGMMDJS;")
