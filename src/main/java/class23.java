...
public class class23 extends class145 {
    ...
    @OriginalMember(owner = "client!fba", name = "i", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fba", name = "f", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(ZI)[I", line = 25)
    ...
    @OriginalMember(owner = "client!fba", name = "j", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "()V", line = 151)
    public class23() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IILrt;)V", line = 154)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(BJ)V", line = 216)
