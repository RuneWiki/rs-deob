...
public class class23 {
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(Lpn;ZILpn;I)Lmg;")
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(ILpn;Lpn;I)Lmg;")
    ...
    @OriginalMember(owner = "client!ria", name = "<init>", descriptor = "(Ldu;Leda;Ljava/math/BigInteger;Ljava/math/BigInteger;)V")
