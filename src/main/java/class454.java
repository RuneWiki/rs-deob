...
public class class454 {
    ...
    @OriginalMember(owner = "client!t", name = "b", descriptor = "(I)I", line = 34)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(ZILbn;)V", line = 45)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(B)V", line = 378)
    ...
    @OriginalMember(owner = "client!t", name = "c", descriptor = "(I)I", line = 409)
    public final int method2642(int arg0) {
        field6610++;
        return arg0 == 3703 ? this.field6603.method2343(true) + this.field6609.method2343(true) : 118;
    }

    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IIBBZ)Lrb;", line = 425)
    ...
    @OriginalMember(owner = "client!t", name = "b", descriptor = "(B)V", line = 467)
    ...
    @OriginalMember(owner = "client!t", name = "d", descriptor = "(I)Z", line = 484)
    ...
    @OriginalMember(owner = "client!t", name = "e", descriptor = "(I)V", line = 760)
    ...
    @OriginalMember(owner = "client!t", name = "f", descriptor = "(I)V", line = 776)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(BZLfd;)V", line = 789)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Z)V", line = 863)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IIIIIZZ)V", line = 881)
    ...
    @OriginalMember(owner = "client!t", name = "g", descriptor = "(I)Z", line = 937)
    ...
    @OriginalMember(owner = "client!t", name = "h", descriptor = "(I)Z", line = 948)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(ZB)V", line = 969)
