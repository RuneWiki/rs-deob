...
public class class454 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Ljj;IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Z)V", line = 85)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IZ)V", line = 101)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(II)V", line = 124)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(BI)Llg;", line = 140)
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(II)I", line = 169)
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(Ljk;ILfs;)V", line = 205)
