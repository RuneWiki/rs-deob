...
public class class454 extends class417 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Lmha;)V", line = 6)
    public final synchronized void method2539(class417 arg0) {
        this.field6311.method729(-2, arg0);
    }

    @OriginalMember(owner = "client!la", name = "b", descriptor = "([III)V", line = 13)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Lgda;Lpr;)V", line = 59)
    ...
    @OriginalMember(owner = "client!la", name = "b", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!la", name = "b", descriptor = "(Lmha;)V", line = 127)
    public final synchronized void method2542(class417 arg0) {
        arg0.method315(44);
    }

    @OriginalMember(owner = "client!la", name = "e", descriptor = "()V", line = 130)
    ...
    @OriginalMember(owner = "client!la", name = "d", descriptor = "()Lmha;", line = 149)
    public final class417 method1991() {
        return (class417) this.field6311.method723(106);
    }

    @OriginalMember(owner = "client!la", name = "c", descriptor = "()I", line = 160)
    public final int method1979() {
        return 0;
    }

    @OriginalMember(owner = "client!la", name = "c", descriptor = "([III)V", line = 165)
    ...
    @OriginalMember(owner = "client!la", name = "f", descriptor = "()I", line = 175)
    public final synchronized int method2545() {
        return this.field6311.method730(0);
    }

    @OriginalMember(owner = "client!la", name = "a", descriptor = "()Lmha;", line = 181)
    public final class417 method1989() {
        return (class417) this.field6311.method724(32);
    }

    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Lpr;)V", line = 185)
