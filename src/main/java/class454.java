...
public class class454 extends class637 {
    ...
    @OriginalMember(owner = "client!rha", name = "i", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!rha", name = "g", descriptor = "(I)[B", line = 17)
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(ZZ)V", line = 58)
