...
public abstract class class454 {
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!jea", name = "b", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(Z)Z", line = 36)
    ...
    @OriginalMember(owner = "client!jea", name = "c", descriptor = "(I)Z", line = 48)
    ...
    @OriginalMember(owner = "client!jea", name = "d", descriptor = "(I)Z", line = 59)
    ...
    @OriginalMember(owner = "client!jea", name = "e", descriptor = "(I)Z", line = 85)
