...
public class class454 extends class400 {
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(CIIIZLaa;II)V")
    ...
    @OriginalMember(owner = "client!us", name = "fa", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!us", name = "<init>", descriptor = "(Lsa;Lqt;[Lffa;[I[I)V")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
