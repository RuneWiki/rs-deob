...
public class class454 {
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(ILph;I)Let;", line = 8)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(ZIIIIII)V", line = 43)
