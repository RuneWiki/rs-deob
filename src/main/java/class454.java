...
public class class454 {
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(ILr;ZLhq;Lr;Lla;ZIIIII)Lf;")
    ...
    @OriginalMember(owner = "client!hca", name = "b", descriptor = "(IB)Lhu;")
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(IIIILr;Lhq;II)Lf;")
    ...
    @OriginalMember(owner = "client!hca", name = "<init>", descriptor = "(Lei;IZLbca;Lri;Lri;)V")
