...
public class class454 extends class491 implements class242 {
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lug;)V")
    ...
    @OriginalMember(owner = "client!w", name = "c", descriptor = "(IIIIII)Lug;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "([Le;Ld;Lc;[Ltq;I)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lwh;Z)Lo;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(IIIIIF)Lja;")
    ...
    @OriginalMember(owner = "client!w", name = "d", descriptor = "(I)Ln;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lug;Lug;FLug;)Lug;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "([Le;Lc;[Ltq;I)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lko;IIII)Le;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Ld;)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Ld;Z)V")
    ...
    @OriginalMember(owner = "client!w", name = "e", descriptor = "()Lc;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(I[Lja;)V")
    ...
    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "(ILjava/awt/Canvas;Ll;Lnv;)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lqm;[Lwh;Z)Lla;")
