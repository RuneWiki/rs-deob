...
public class class454 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ZLvp;IZLvp;)Lida;", line = 64)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lvp;IILvp;)Lida;", line = 108)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IIB)I", line = 122)
    ...
    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(B)Z", line = 208)
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(Luh;Lqc;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", line = 283)
