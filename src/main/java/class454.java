...
public class class454 extends class107 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(III)Lbda;", line = 4)
    ...
    @OriginalMember(owner = "client!tb", name = "c", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!tb", name = "d", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IIZI)Ljava/lang/String;", line = 145)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IIIIIIIIIILnea;)Z", line = 190)
