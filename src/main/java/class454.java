...
public class class454 extends class34 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ZZ)V", line = 9)
    ...
    @OriginalMember(owner = "client!ge", name = "d", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IB)[I", line = 32)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(I[[[BIBII)V", line = 59)
