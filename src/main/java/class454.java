...
public class class454 {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(BILns;)Lse;", line = 22)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!fo", name = "b", descriptor = "(I)Z", line = 50)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(IZ)V", line = 106)
