...
public class class454 {
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(I)Ltm;")
    ...
    @OriginalMember(owner = "client!gt", name = "c", descriptor = "(I)Ltm;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(BLtm;)V")
    ...
    @OriginalMember(owner = "client!gt", name = "e", descriptor = "(I)Ltm;")
    ...
    @OriginalMember(owner = "client!gt", name = "f", descriptor = "(I)Ltm;")
