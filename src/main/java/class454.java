...
public class class454 extends class683 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lhr;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Ldt;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ZLdt;)Lbu;", line = 146)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(B)V", line = 160)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ZIILofa;I)V", line = 181)
