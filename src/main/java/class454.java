...
public class class454 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Ljava/awt/Canvas;IILl;Ldq;)Lqa;", line = 23)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IIIIIIBIIILkg;)Z", line = 37)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ILga;Lga;)V", line = 287)
