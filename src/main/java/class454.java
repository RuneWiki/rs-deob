...
public abstract class class454 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ILac;)V")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lkha;Ld;Ljava/awt/Canvas;IIIIB)Lha;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lkha;ZIZII)V")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIB[III)Lac;")
