...
public class class454 extends class585 {
    ...
    @OriginalMember(owner = "client!nja", name = "e", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!nja", name = "a", descriptor = "(Lso;ZLbca;)Lfn;")
    ...
    @OriginalMember(owner = "client!nja", name = "a", descriptor = "(Lso;II)V")
