...
public class class454 extends class24 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Lke;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILjp;)V", line = 18)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILaj;I)Lvr;", line = 35)
    ...
    @OriginalMember(owner = "client!li", name = "e", descriptor = "(B)V", line = 84)
