...
public class class454 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(JI)Lag;", line = 7)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(B)Lag;", line = 37)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Z)Lag;", line = 50)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I)I", line = 81)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "([Lag;I)I", line = 93)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(B)Lag;", line = 125)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(JLag;Z)V", line = 159)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(I)I", line = 182)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IBI)V", line = 213)
    ...
    @OriginalMember(owner = "client!sq", name = "c", descriptor = "(B)V", line = 236)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(I)V", line = 270)
    ...
    @OriginalMember(owner = "client!sq", name = "c", descriptor = "(I)V", line = 302)
