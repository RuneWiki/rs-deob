...
public class class454 extends class429 {
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(I)Laca;")
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(III)Ltc;")
    ...
    @OriginalMember(owner = "client!mea", name = "<init>", descriptor = "(Leaa;Lcq;IIIIIIIIIIIIII)V")
