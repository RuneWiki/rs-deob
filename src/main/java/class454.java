...
public class class454 extends class13 {
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(B[ILcea;)V", line = 27)
    ...
    @OriginalMember(owner = "client!td", name = "e", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!td", name = "c", descriptor = "(II)Loaa;", line = 79)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(IIZ)I", line = 94)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(ILcea;I)V", line = 122)
    ...
    @OriginalMember(owner = "client!td", name = "f", descriptor = "(B)I", line = 202)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Lcea;B)Ljava/lang/String;", line = 218)
    ...
    @OriginalMember(owner = "client!td", name = "g", descriptor = "(B)V", line = 248)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Lcea;I)V", line = 259)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(I)Ljava/lang/String;", line = 285)
