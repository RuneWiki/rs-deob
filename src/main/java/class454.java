...
public abstract class class454 extends class215 {
    ...
    @OriginalMember(owner = "client!mw", name = "k", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!mw", name = "l", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(I[Lrc;)I", line = 25)
    ...
    @OriginalMember(owner = "client!mw", name = "m", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!mw", name = "b", descriptor = "(Z)Z", line = 285)
    ...
    @OriginalMember(owner = "client!mw", name = "n", descriptor = "(I)V", line = 331)
    ...
    @OriginalMember(owner = "client!mw", name = "<init>", descriptor = "(IIIIIIIIIZB)V", line = 343)
