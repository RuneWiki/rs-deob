...
public class class454 {
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(I)Lko;")
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(ILfca;)V")
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(B)Lko;")
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "(Lfca;)V")
