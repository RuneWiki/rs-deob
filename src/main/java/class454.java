...
public class class454 extends class456 {
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(II)[I", line = 7)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "()V", line = 257)
    public class454() {
        super(0, true);
    }

    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IIIBI[[ILjava/util/Random;)V", line = 261)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Z)V", line = 461)
    ...
    @OriginalMember(owner = "client!gl", name = "h", descriptor = "(I)V", line = 471)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IBLre;)V", line = 490)
