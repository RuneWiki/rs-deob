...
public class class454 extends class354 {
    ...
    @OriginalMember(owner = "client!it", name = "e", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IBZIIZI)V", line = 60)
    ...
    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "()V", line = 368)
    public class454() {
        super(0, true);
    }

    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Z)V", line = 107)
    public final void method771(boolean arg0) {
        ++field6723;
        class291.method1807(arg0);
    }

    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IB)[I", line = 117)
    ...
    @OriginalMember(owner = "client!it", name = "f", descriptor = "(I)Z", line = 253)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(III)I", line = 265)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(ILti;I)V", line = 287)
    ...
    @OriginalMember(owner = "client!it", name = "c", descriptor = "(B)V", line = 351)
