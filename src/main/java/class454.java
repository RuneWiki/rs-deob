...
public class class454 extends class499 implements class458 {
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(Lug;I[BI)V", line = 3)
    public class454(class395 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field6549 = arg1;
    }

    @OriginalMember(owner = "client!or", name = "a", descriptor = "(B)I", line = 13)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(III[B)V", line = 30)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lhd;IBI)V", line = 42)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(III)Z", line = 65)
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(B)I", line = 80)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(I)J", line = 92)
