...
public class class454 extends class606 {
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(ZI)V")
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Lma;II)V")
    ...
    @OriginalMember(owner = "client!rca", name = "<init>", descriptor = "(Lfha;Lfp;Lic;)V")
