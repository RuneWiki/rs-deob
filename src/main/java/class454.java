...
public class class454 extends class264 {
    ...
    @OriginalMember(owner = "client!up", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(CI)C", line = 40)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(ZC)Z", line = 76)
    ...
    @OriginalMember(owner = "client!up", name = "e", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(II)V", line = 106)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Z)V", line = 170)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(ZI)Lnk;", line = 190)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(ILfp;B)Lbi;", line = 218)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(JI)V", line = 313)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(BII)I", line = 330)
    ...
    @OriginalMember(owner = "client!up", name = "f", descriptor = "(I)V", line = 355)
