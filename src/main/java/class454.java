...
public class class454 extends class241 {
    ...
    @OriginalMember(owner = "client!t", name = "h", descriptor = "(I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!t", name = "g", descriptor = "(I)Ljava/lang/Object;", line = 17)
    public final Object method1449(int arg0) {
        int var2 = -13 / ((83 - arg0) / 34);
        return this.field6974.get();
    }

    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 24)
