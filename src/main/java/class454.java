...
public class class454 {
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Lkb;IIB)V")
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IILkb;I)Z")
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(ILkb;II)V")
    ...
    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "(Lbf;Lah;)V")
