...
public class class454 extends class566 {
    ...
    @OriginalMember(owner = "client!lda", name = "<init>", descriptor = "(Lrt;Lcp;IIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(B)Los;")
    ...
    @OriginalMember(owner = "client!lda", name = "b", descriptor = "(I)[Lge;")
