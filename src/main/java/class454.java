...
public class class454 extends class361 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Ljava/lang/String;Lih;IB)Lug;", line = 3)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(II)Z", line = 28)
    public final boolean method2648(int arg0, int arg1) {
        field6366++;
        return arg0 == 13834 ? this.field6364[arg1].field2875 : true;
    }

    @OriginalMember(owner = "client!mh", name = "b", descriptor = "(II)Z", line = 41)
    ...
    @OriginalMember(owner = "client!mh", name = "b", descriptor = "(Z)Z", line = 60)
    ...
    @OriginalMember(owner = "client!mh", name = "c", descriptor = "(II)Z", line = 152)
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(I)V", line = 162)
    public class454(int arg0) {
        this.field6367 = arg0;
    }

    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(BI)Lbe;", line = 173)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(B)V", line = 201)
