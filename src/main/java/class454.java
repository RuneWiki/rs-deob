...
public class class454 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(III)Lem;", line = 25)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Lfh;I)V", line = 37)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(BLfh;I)V", line = 58)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(CILjava/lang/String;)[Ljava/lang/String;", line = 82)
