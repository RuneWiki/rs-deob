...
public class class454 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(II)V", line = 8)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IB)V", line = 55)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ZI)V", line = 71)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(B)V", line = 89)
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(II)Las;", line = 106)
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(Lai;ILic;Lic;)V", line = 161)
