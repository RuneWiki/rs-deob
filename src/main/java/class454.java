...
public class class454 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IZ)Z", line = 8)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IIB)Z", line = 20)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(I[BII)[B", line = 33)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(I)V", line = 75)
