...
public class class447 extends class398 {
    ...
    @OriginalMember(owner = "client!pf", name = "c", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIIILps;BII)V", line = 17)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(II)[I", line = 86)
    ...
    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "()V", line = 173)
    public class447() {
        super(1, false);
    }

    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(IB)I", line = 178)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Lnj;II)V", line = 195)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(JB)V", line = 241)
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(II)[[I", line = 313)
