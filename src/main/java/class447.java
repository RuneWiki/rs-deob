...
public class class447 implements class379 {
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IIZLus;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!sk", name = "c", descriptor = "(B)I", line = 51)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IBLwv;)V", line = 72)
    ...
    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!sk", name = "e", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ILo;)V", line = 122)
    public static final void method2710(int arg0, class23 arg1) {
        class306.field4447[arg0] = arg1;
    }

    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(II)V", line = 126)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ILus;II)V", line = 145)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(B)V", line = 156)
    ...
    @OriginalMember(owner = "client!sk", name = "c", descriptor = "(I)V", line = 168)
    ...
    @OriginalMember(owner = "client!sk", name = "f", descriptor = "(I)Z", line = 181)
    ...
    @OriginalMember(owner = "client!sk", name = "d", descriptor = "(I)V", line = 200)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ILwv;II)V", line = 216)
    ...
    @OriginalMember(owner = "client!sk", name = "<init>", descriptor = "(Lnq;)V", line = 422)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IZLin;)V", line = 256)
    ...
    @OriginalMember(owner = "client!sk", name = "finalize", descriptor = "()V", line = 287)
    ...
    @OriginalMember(owner = "client!sk", name = "g", descriptor = "(I)I", line = 302)
    public final int method2716(int arg0) {
        field6710++;
        return arg0 == -27190 ? this.field6699 : 2;
    }

    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IB)V", line = 318)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ILwj;)V", line = 333)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(BC)Z", line = 393)
    ...
    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(IB)V", line = 404)
