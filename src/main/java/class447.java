...
public class class447 {
    ...
    @OriginalMember(owner = "client!ika", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ika", name = "a", descriptor = "(Lha;BI)Lie;", line = 23)
    ...
    @OriginalMember(owner = "client!ika", name = "a", descriptor = "(II)I", line = 40)
    ...
    @OriginalMember(owner = "client!ika", name = "a", descriptor = "(IIZ)Lsw;", line = 53)
    ...
    @OriginalMember(owner = "client!ika", name = "b", descriptor = "(I)V", line = 70)
