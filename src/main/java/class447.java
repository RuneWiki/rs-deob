...
public class class447 extends class527 {
    ...
    @OriginalMember(owner = "client!rda", name = "c", descriptor = "(ILha;)V", line = 6)
    public final void method271(int arg0, class545 arg1) {
        int var3 = 18 % ((-15 - arg0) / 57);
        ++field6104;
    }

    @OriginalMember(owner = "client!rda", name = "b", descriptor = "(ILha;)Lgp;", line = 17)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(Lha;III)Z", line = 29)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(IB)Lou;", line = 74)
    ...
    @OriginalMember(owner = "client!rda", name = "d", descriptor = "(B)Z", line = 101)
    ...
    @OriginalMember(owner = "client!rda", name = "<init>", descriptor = "(IIIII)V", line = 385)
    public class447(int arg0, int arg1, int arg2, int arg3, int arg4) {
        super(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!rda", name = "h", descriptor = "(I)I", line = 125)
    ...
    @OriginalMember(owner = "client!rda", name = "b", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!rda", name = "j", descriptor = "(I)Z", line = 173)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(II)Z", line = 189)
    ...
    @OriginalMember(owner = "client!rda", name = "b", descriptor = "(Lha;I)Ljl;", line = 207)
    ...
    @OriginalMember(owner = "client!rda", name = "g", descriptor = "(I)I", line = 374)
    public final int method282(int arg0) {
        ++field6101;
        return arg0 != -1 ? 72 : this.field6115;
    }

    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(IIBIIII)Lcd;", line = 388)
    ...
    @OriginalMember(owner = "client!rda", name = "f", descriptor = "(I)I", line = 412)
