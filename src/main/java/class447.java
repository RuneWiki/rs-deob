...
public abstract class class447 extends class203 {
    ...
    @OriginalMember(owner = "client!kr", name = "e", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(II)I", line = 21)
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 48)
    ...
    @OriginalMember(owner = "client!kr", name = "f", descriptor = "(I)V", line = 71)
