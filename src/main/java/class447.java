...
public class class447 extends class338 {
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Lfu;Ls;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Z)V", line = 11)
    public final void method190(boolean arg0) {
        this.field4685.method353(260, 8448);
    }

    @OriginalMember(owner = "client!ai", name = "a", descriptor = "()V", line = 15)
    ...
    @OriginalMember(owner = "client!ai", name = "c", descriptor = "()V", line = 34)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "()Z", line = 110)
    public final boolean method191() {
        return true;
    }

    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Ltp;)V", line = 115)
    public final void method188(class375 arg0) {
    }

    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(Z)V", line = 119)
