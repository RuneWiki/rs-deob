...
public class class447 extends class11 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(B)Z", line = 28)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ZZ)V", line = 39)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IIB)V", line = 55)
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "(Lad;Lme;)V", line = 100)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IILpm;)V", line = 111)
    ...
    @OriginalMember(owner = "client!dn", name = "c", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IZ)V", line = 171)
