...
public class class447 extends class220 {
    ...
    @OriginalMember(owner = "client!pf", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(I[[ILjava/util/Random;IIIB)V", line = 13)
    ...
    @OriginalMember(owner = "client!pf", name = "d", descriptor = "(II)V", line = 212)
    ...
    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "()V", line = 225)
    public class447() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ILnr;Lqr;IIIZILqc;IIIIIB)Lqc;", line = 228)
    ...
    @OriginalMember(owner = "client!pf", name = "f", descriptor = "(B)V", line = 447)
    ...
    @OriginalMember(owner = "client!pf", name = "e", descriptor = "(I)V", line = 479)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IBLil;)V", line = 496)
    ...
    @OriginalMember(owner = "client!pf", name = "c", descriptor = "(II)[I", line = 588)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ZLqj;)V", line = 844)
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(III)Z", line = 866)
