...
public class class447 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Lsj;IIILpe;IIZ)V")
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Lpe;I)V")
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(ILpe;ZIIIZ)Lsj;")
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Lpe;B)V")
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(BLbd;)V")
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(II)Lfr;")
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(Lpe;Lkk;IIIIIIZI)V")
