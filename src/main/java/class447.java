...
public class class447 extends class210 {
    ...
    @OriginalMember(owner = "client!cga", name = "f", descriptor = "(I)[B", line = 3)
    ...
    @OriginalMember(owner = "client!cga", name = "e", descriptor = "(I)I", line = 24)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!cga", name = "g", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(B[B)[B", line = 119)
