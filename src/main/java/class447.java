...
public class class447 extends class490 {
    ...
    @OriginalMember(owner = "client!jk", name = "B", descriptor = "(CIIIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(Lht;Lgv;[Lmp;Z)V", line = 26)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(CIIIZLea;II)V", line = 231)
