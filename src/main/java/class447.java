...
public class class447 extends class217 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IF)V", line = 14)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!vk", name = "f", descriptor = "(B)Z", line = 43)
    ...
    @OriginalMember(owner = "client!vk", name = "g", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(IIIIIF)V", line = 128)
