...
public class class447 {
    ...
    @OriginalMember(owner = "client!ika", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ika", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!ika", name = "b", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!ika", name = "<init>", descriptor = "(Lqb;II)V", line = 593)
    ...
    @OriginalMember(owner = "client!ika", name = "a", descriptor = "(I[B)V", line = 76)
    ...
    @OriginalMember(owner = "client!ika", name = "b", descriptor = "(IIII)V", line = 88)
    ...
    @OriginalMember(owner = "client!ika", name = "c", descriptor = "(I)Ljava/io/File;", line = 114)
    ...
    @OriginalMember(owner = "client!ika", name = "a", descriptor = "(IIII)I", line = 129)
    ...
    @OriginalMember(owner = "client!ika", name = "a", descriptor = "(JB)V", line = 144)
    ...
    @OriginalMember(owner = "client!ika", name = "d", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!ika", name = "a", descriptor = "(IB[BI)V", line = 242)
    ...
    @OriginalMember(owner = "client!ika", name = "a", descriptor = "(IBI)Z", line = 363)
    ...
    @OriginalMember(owner = "client!ika", name = "a", descriptor = "(B)J", line = 374)
    ...
    @OriginalMember(owner = "client!ika", name = "a", descriptor = "(III[B)V", line = 386)
