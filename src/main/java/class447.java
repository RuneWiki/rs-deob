...
public class class447 {
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 11)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(II)Z", line = 66)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(I)V", line = 77)
