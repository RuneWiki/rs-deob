...
public class class447 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(IIIILmj;Lha;)V", line = 3)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "([JI[Ljava/lang/Object;)V", line = 48)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Lwq;I)V", line = 60)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(ZILvf;III[II)Lub;", line = 93)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(II)V", line = 117)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(IILwq;)V", line = 211)
