...
public class class447 extends class119 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(BII)V", line = 22)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IIIIIB)V", line = 33)
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(Lbg;B)V", line = 136)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IBI)V", line = 370)
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(III)I", line = 380)
    ...
    @OriginalMember(owner = "client!rl", name = "<init>", descriptor = "(IIIIII)V", line = 394)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(B)V", line = 418)
