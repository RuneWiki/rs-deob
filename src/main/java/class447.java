...
public class class447 extends class65 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IIB)V", line = 9)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(I)V", line = 196)
