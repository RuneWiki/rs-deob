...
public class class447 extends class264 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(B[I)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!ah", name = "d", descriptor = "(I)V", line = 72)
