...
public class class447 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Lek;I)Lpaa;", line = 33)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "([BB)[B", line = 54)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(B)V", line = 120)
