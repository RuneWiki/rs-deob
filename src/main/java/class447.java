...
public class class447 extends class238 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIIIIIZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ILdn;II)Lei;", line = 21)
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(Lmh;IIII)V", line = 59)
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(Lmh;IIII[BI)V", line = 91)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(III)V", line = 73)
    ...
    @OriginalMember(owner = "client!lh", name = "c", descriptor = "(B)V", line = 114)
