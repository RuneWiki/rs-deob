...
public class class447 implements class415 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(I)Z", line = 15)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Lwu;)V", line = 39)
    public class447(class404 arg0) {
        this.field6132 = arg0;
    }

    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(ZB)V", line = 47)
