...
public class class447 extends class433 {
    ...
    @OriginalMember(owner = "client!eu", name = "h", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!eu", name = "g", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IB)V", line = 35)
    ...
    @OriginalMember(owner = "client!eu", name = "f", descriptor = "(I)Z", line = 52)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(ZLco;ILco;)V", line = 65)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(III)V", line = 227)
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(I)I", line = 308)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(B)V", line = 318)
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(Ljaa;)V", line = 334)
    public class447(class576 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(Z)Z", line = 337)
