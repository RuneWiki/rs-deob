...
public class class447 {
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "([BZLmd;)V", line = 34)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(II)I", line = 58)
    ...
    @OriginalMember(owner = "client!gj", name = "<init>", descriptor = "()V", line = 70)
    public class447() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!gj", name = "<init>", descriptor = "(III)V", line = 74)
