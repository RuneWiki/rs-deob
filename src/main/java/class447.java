...
public class class447 extends class202 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IIII[I)V", line = 13)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IB)[[I", line = 41)
    ...
    @OriginalMember(owner = "client!of", name = "i", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IIIZIIIII)V", line = 103)
