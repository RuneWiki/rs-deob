...
public class class447 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IIIB)I", line = 3)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lee;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(I)Z", line = 78)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(CI)Z", line = 95)
    ...
    @OriginalMember(owner = "client!os", name = "b", descriptor = "(I)V", line = 115)
