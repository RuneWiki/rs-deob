...
public class class447 {
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(ILev;)Lef;")
    ...
    @OriginalMember(owner = "client!hea", name = "<init>", descriptor = "(Lgj;Lgj;)V")
    public class447(class662 arg0, class662 arg1) {
        this.field6139 = arg0;
        this.field6135 = arg1;
    }

    @OriginalMember(owner = "client!hea", name = "b", descriptor = "(I)Lnt;")
    ...
    @OriginalMember(owner = "client!hea", name = "c", descriptor = "(I)I")
