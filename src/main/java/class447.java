...
public class class447 extends class601 {
    ...
    @OriginalMember(owner = "client!oha", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!oha", name = "<init>", descriptor = "(Lqea;)V", line = 20)
    public class447(class339 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!oha", name = "c", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(I)I", line = 42)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(IB)I", line = 82)
    ...
    @OriginalMember(owner = "client!oha", name = "d", descriptor = "(I)Z", line = 96)
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(IIIIZI[BI[B)V", line = 111)
    ...
    @OriginalMember(owner = "client!oha", name = "b", descriptor = "(II)V", line = 155)
    ...
    @OriginalMember(owner = "client!oha", name = "<init>", descriptor = "(ILqea;)V", line = 166)
