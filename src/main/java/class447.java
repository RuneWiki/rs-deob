...
public class class447 extends class32 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Lak;Z)V")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ILt;)V")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ILak;)V")
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(ILak;)V")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IZFBLgh;)V")
