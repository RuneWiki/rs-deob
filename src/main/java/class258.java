...
public class class258 extends class407 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(ILtj;I)Lqb;")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lqb;ILtj;)V")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(BLie;)I")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(ILtj;II)Z")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(ILtj;BIZLkm;I)V")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(BLtj;)V")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Ltj;I)Lri;")
