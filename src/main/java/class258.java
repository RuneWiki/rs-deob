...
public class class258 {
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(I)V", line = 200)
    public static final void method1550(int arg0) {
        class223.field2880 = arg0;
    }

    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(II)Lke;", line = 204)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(BI)V", line = 232)
    ...
    @OriginalMember(owner = "client!fga", name = "b", descriptor = "(I)V", line = 247)
    ...
    @OriginalMember(owner = "client!fga", name = "c", descriptor = "(I)V", line = 260)
    ...
    @OriginalMember(owner = "client!fga", name = "b", descriptor = "(B)V", line = 274)
    ...
    @OriginalMember(owner = "client!fga", name = "d", descriptor = "(I)Ljga;", line = 285)
    public static final class716 method1556(int arg0) {
        field3382++;
        return arg0 >= -36 ? null : class68.field755;
    }

    @OriginalMember(owner = "client!fga", name = "<init>", descriptor = "(Lrga;ILni;Lni;)V", line = 307)
