...
public class class258 extends class6 {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IIJILma;IILem;I)V")
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "(Lkt;)V")
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IIIILid;)V")
