...
public class class258 extends class45 {
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(BII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!es", name = "e", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Lcu;II)V", line = 53)
    ...
    @OriginalMember(owner = "client!es", name = "c", descriptor = "(III)Z", line = 131)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(II)[I", line = 155)
    ...
    @OriginalMember(owner = "client!es", name = "d", descriptor = "(I)V", line = 205)
