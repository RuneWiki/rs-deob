...
public class class258 extends class148 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IIBIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!es", name = "e", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(II)[I", line = 76)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Z)V", line = 138)
    ...
    @OriginalMember(owner = "client!es", name = "f", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(ILdh;I)V", line = 169)
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "()V", line = 181)
    public class258() {
        super(1, true);
    }

    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IIIIBII)V", line = 187)
