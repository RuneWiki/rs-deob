...
public class class258 extends class177 implements class232 {
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(Lqa;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IIILqa;)Z", line = 15)
    ...
    @OriginalMember(owner = "client!es", name = "c", descriptor = "(Lqa;I)V", line = 34)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(I)Z", line = 57)
    ...
    @OriginalMember(owner = "client!es", name = "j", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(Z)I", line = 81)
    ...
    @OriginalMember(owner = "client!es", name = "c", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IILju;IBI)V", line = 102)
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(I)I", line = 229)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Lqa;I)V", line = 241)
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(Lqa;Lbo;IIIIIZIIIIII)V", line = 252)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(B)I", line = 264)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(III)Z", line = 279)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(ILqa;)Lbw;", line = 348)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(II)V", line = 401)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Z)I", line = 415)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IILqa;)Lc;", line = 428)
