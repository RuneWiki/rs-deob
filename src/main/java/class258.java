...
public class class258 {
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "()I", line = 5)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(II)I", line = 13)
    ...
    @OriginalMember(owner = "client!uu", name = "b", descriptor = "()[F", line = 22)
    public final float[] method1584() {
        return this.field3517[this.method1582()];
    }

    @OriginalMember(owner = "client!uu", name = "c", descriptor = "()V", line = 27)
    ...
    @OriginalMember(owner = "client!uu", name = "<init>", descriptor = "()V", line = 165)
    public class258() {
