...
public class class258 extends class33 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Loa;)V", line = 3)
    public final synchronized void method1734(class33 arg0) {
        arg0.method1821((byte) 32);
    }

    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Ljp;Lfj;)V", line = 7)
    ...
    @OriginalMember(owner = "client!jo", name = "c", descriptor = "()Loa;", line = 14)
    public final class33 method256() {
        return (class33) this.field4337.method2538(-3);
    }

    @OriginalMember(owner = "client!jo", name = "e", descriptor = "()I", line = 20)
    public final synchronized int method1736() {
        return this.field4337.method2542(-105);
    }

    @OriginalMember(owner = "client!jo", name = "a", descriptor = "([III)V", line = 29)
    ...
    @OriginalMember(owner = "client!jo", name = "f", descriptor = "()V", line = 75)
    ...
    @OriginalMember(owner = "client!jo", name = "d", descriptor = "()I", line = 93)
    public final int method257() {
        return 0;
    }

    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Lfj;)V", line = 97)
    ...
    @OriginalMember(owner = "client!jo", name = "c", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(Loa;)V", line = 125)
    public final synchronized void method1740(class33 arg0) {
        this.field4337.method2545(arg0, 4009);
    }

    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!jo", name = "c", descriptor = "([III)V", line = 177)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "()Loa;", line = 200)
