...
public class class258 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(I)V", line = 22)
    private class258(int arg0) {
        this.field3842 = arg0;
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(II)V", line = 36)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!ig", name = "toString", descriptor = "()Ljava/lang/String;", line = 138)
    public final String toString() {
        field3844++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(I)V", line = 146)
