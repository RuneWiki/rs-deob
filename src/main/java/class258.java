...
public class class258 extends class128 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(J)V", line = 4)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(JI)V", line = 134)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Lwg;IIIIIIIIIIIZ)V", line = 530)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "()V", line = 551)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "()V", line = 562)
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(Lwg;IIIIIIIIIIIZ)V", line = 569)
