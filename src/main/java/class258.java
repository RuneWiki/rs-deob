...
public class class258 extends class452 {
    ...
    @OriginalMember(owner = "client!fga", name = "<init>", descriptor = "(Leha;Loea;IIIIIIIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!fga", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(I)Lhm;", line = 37)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(Ljava/io/File;ZI)[B", line = 55)
