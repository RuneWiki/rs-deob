...
public class class258 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Z)Lfi;")
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(B)Lfi;")
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(Lfa;)V")
