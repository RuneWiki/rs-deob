...
public class class258 extends class665 {
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 15)
    ...
    @OriginalMember(owner = "client!uu", name = "b", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(ZIZLsba;)V", line = 57)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(Ljr;B)Lni;", line = 117)
