...
public class class258 extends class386 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(II[[IILjava/util/Random;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(II)[I", line = 202)
    ...
    @OriginalMember(owner = "client!ol", name = "<init>", descriptor = "()V", line = 450)
    public class258() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ol", name = "e", descriptor = "(B)V", line = 484)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(I)V", line = 500)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IBLun;)V", line = 510)
