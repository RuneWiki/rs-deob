...
public class class258 extends class36 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IILrt;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Lrt;I)V", line = 84)
    ...
    @OriginalMember(owner = "client!ca", name = "g", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IC)I", line = 137)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IIIIZ)V", line = 162)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(CI)I", line = 431)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(ZIZII)I", line = 459)
