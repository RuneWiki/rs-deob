...
public class class258 implements Runnable {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(II[BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(I)I", line = 57)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IIIIIIILie;BIII)Z", line = 74)
    ...
    @OriginalMember(owner = "client!pr", name = "finalize", descriptor = "()V", line = 508)
    protected final void finalize() {
        field3517++;
        this.method1593(3);
    }

    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(II)I", line = 516)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(I)V", line = 524)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(I[BII)V", line = 537)
    ...
    @OriginalMember(owner = "client!pr", name = "c", descriptor = "(I)V", line = 562)
    ...
    @OriginalMember(owner = "client!pr", name = "d", descriptor = "(I)V", line = 663)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(II)V", line = 856)
    ...
    @OriginalMember(owner = "client!pr", name = "e", descriptor = "(I)V", line = 867)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(CI)Z", line = 889)
    ...
    @OriginalMember(owner = "client!pr", name = "f", descriptor = "(I)V", line = 901)
    ...
    @OriginalMember(owner = "client!pr", name = "g", descriptor = "(I)I", line = 916)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IIIILaa;Lhc;IIIII)Lhc;", line = 931)
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(Ljava/net/Socket;Lkq;)V", line = 1309)
    ...
    @OriginalMember(owner = "client!pr", name = "h", descriptor = "(I)V", line = 986)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(B)Z", line = 1023)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Ljava/awt/Canvas;ILsr;I)Laa;", line = 1042)
    ...
    @OriginalMember(owner = "client!pr", name = "run", descriptor = "()V", line = 1055)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Laa;Z)V", line = 1131)
