...
public class class258 {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(III[I)Ljs;", line = 6)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(I[IBI)Ljs;", line = 59)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "([III)Ljs;", line = 107)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(III)V", line = 131)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IILuu;B)V", line = 179)
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "(Lfs;Lfs;)V", line = 248)
    public class258(class387 arg0, class387 arg1) {
        this.field3796 = arg1;
        this.field3803 = arg0;
    }

    @OriginalMember(owner = "client!oj", name = "b", descriptor = "([III)Ljs;", line = 222)
