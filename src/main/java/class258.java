...
public class class258 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ZLjava/lang/String;)Z", line = 28)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(BI)Ljava/lang/String;", line = 94)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Ltn;BI)V", line = 140)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(II)Z", line = 194)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Ltn;I)V", line = 214)
