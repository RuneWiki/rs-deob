...
public class class258 extends class617 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(CI)I", line = 6)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ZLnp;)V", line = 35)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IILnp;)V", line = 56)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(CB)I", line = 138)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IZ)I", line = 162)
    ...
    @OriginalMember(owner = "client!vr", name = "f", descriptor = "(I)V", line = 214)
