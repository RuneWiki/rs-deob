...
public class class258 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IIIII)Lnu;")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(ZLza;J)V")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IIILbp;Lbp;)V")
