...
public abstract class class258 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 7)
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "(IIIII)V", line = 376)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IILjava/lang/String;Ljava/lang/String;)V", line = 46)
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(B)V", line = 111)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IIII)V", line = 131)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(II)I", line = 319)
    ...
    @OriginalMember(owner = "client!bn", name = "c", descriptor = "(B)V", line = 340)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(ZLjava/lang/String;Z)V", line = 395)
