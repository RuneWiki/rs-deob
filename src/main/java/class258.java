...
public class class258 extends class264 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(II[F)[F", line = 3)
    ...
    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "(Lmfa;)V", line = 17)
    public class258(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(B)I", line = 20)
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(BI)V", line = 32)
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!qa", name = "c", descriptor = "(I)Z", line = 64)
    ...
    @OriginalMember(owner = "client!qa", name = "d", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(BI)I", line = 90)
    ...
    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "(ILmfa;)V", line = 109)
    public class258(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(ZIZ[[[BIIIIB[I[I[I[I[IIBII)V", line = 112)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lr;III[Z)V", line = 555)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(B)I", line = 583)
