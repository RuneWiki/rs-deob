...
public class class258 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(I)I", line = 19)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(BII)V", line = 31)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 83)
