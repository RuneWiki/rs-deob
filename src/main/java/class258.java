...
public class class258 extends class227 {
    ...
    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "()V", line = 8)
    public class258() {
        super(0, true);
    }

    @OriginalMember(owner = "client!at", name = "j", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Lug;II)V", line = 27)
    ...
    @OriginalMember(owner = "client!at", name = "e", descriptor = "(I)V", line = 164)
