...
public class class258 extends class443 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILjava/lang/String;)V", line = 6)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Lik;)V", line = 68)
    public class258(class642 arg0) {
        this.field3746 = arg0;
    }

    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I)V", line = 79)
