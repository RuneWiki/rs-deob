...
public class class258 {
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(I[Lpd;ILhp;IIBIII)V")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Lta;ILya;Lta;Lta;I[[I)V")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(ZLta;Lya;Lta;)V")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(IIIILhp;IIIZII)V")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(II[Lpd;BIILhp;)V")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(B[Lpd;Lya;[[[I)V")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(ZLjava/lang/String;ZLla;)V")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "([[ILya;Lta;ILta;Lta;I)V")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(I[[B[[B[[BLst;IILya;I[ZLsd;III)V")
    ...
    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "(IIIZLcq;Lr;)V")
