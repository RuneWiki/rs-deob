...
public class class258 extends class472 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Ljava/lang/String;IZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!wj", name = "b", descriptor = "(IIII)I", line = 104)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 125)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(FI)V", line = 220)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IIII)V", line = 231)
    ...
    @OriginalMember(owner = "client!wj", name = "f", descriptor = "(B)V", line = 244)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 256)
    ...
    @OriginalMember(owner = "client!wj", name = "b", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 279)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(ILjava/awt/Canvas;)Lsr;", line = 337)
    ...
    @OriginalMember(owner = "client!wj", name = "g", descriptor = "(B)V", line = 362)
    ...
    @OriginalMember(owner = "client!wj", name = "h", descriptor = "(I)V", line = 375)
    ...
    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(IIIIIF)V", line = 395)
    public class258(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(ILeq;II)V", line = 399)
