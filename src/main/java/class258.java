...
public class class258 extends class48 {
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Lna;)V", line = 4)
    ...
    @OriginalMember(owner = "client!mb", name = "b", descriptor = "()Z", line = 16)
    public final boolean method74() {
        return this.field3513;
    }

    @OriginalMember(owner = "client!mb", name = "b", descriptor = "(Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Z)V", line = 52)
    public final void method70(boolean arg0) {
    }

    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "(Lql;)V", line = 54)
