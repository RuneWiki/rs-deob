...
public class class258 extends class322 {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!fc", name = "b", descriptor = "(Z)I", line = 15)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(III)Lsl;", line = 28)
    ...
    @OriginalMember(owner = "client!fc", name = "b", descriptor = "(II)V", line = 36)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(Lch;)V", line = 65)
    public class258(class463 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(II)I", line = 68)
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(ILch;)V", line = 81)
