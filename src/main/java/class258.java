...
public class class258 extends class204 {
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(Lfs;)V")
    public class258(class607 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(ILfs;)V")
    ...
    @OriginalMember(owner = "client!ru", name = "b", descriptor = "(Z)V")
