...
public class class258 extends class321 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(II)Lda;")
    ...
    @OriginalMember(owner = "client!pr", name = "c", descriptor = "()Lj;")
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Lmm;III[Z)Z")
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IBLge;)V")
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "([IIIBLge;I)V")
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(Leo;)V")
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "()Lj;")
