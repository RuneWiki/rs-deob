...
public class class258 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(Lwu;II)Leh;", line = 4)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "()[B", line = 17)
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "()I", line = 77)
    ...
    @OriginalMember(owner = "client!eh", name = "c", descriptor = "()Laaa;", line = 122)
    ...
    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "(Lvj;)V", line = 128)
    ...
    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "()V", line = 149)
    private class258() {
    }
}
