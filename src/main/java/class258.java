...
public class class258 extends class18 implements class511 {
    ...
    @OriginalMember(owner = "client!daa", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!daa", name = "d", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(II)V", line = 34)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(BI[BI)V", line = 56)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(B)I", line = 68)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(Z)J", line = 78)
    ...
    @OriginalMember(owner = "client!daa", name = "<init>", descriptor = "(Lag;ILjaclib/memory/Buffer;IZ)V", line = 89)
    public class258(class469 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field3370 = arg1;
    }

    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(I)I", line = 97)
    ...
    @OriginalMember(owner = "client!daa", name = "b", descriptor = "(II)Z", line = 108)
    ...
    @OriginalMember(owner = "client!daa", name = "<init>", descriptor = "(Lag;I[BIZ)V", line = 126)
    public class258(class469 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field3370 = arg1;
    }

    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(IBILda;I)Lcu;", line = 134)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(ILga;II)Lcca;", line = 154)
