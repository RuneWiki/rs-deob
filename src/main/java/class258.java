...
public class class258 extends class381 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(II)V", line = 17)
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ILfa;Ljava/awt/Canvas;ILmv;)Lr;", line = 83)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(CZ)Z", line = 120)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "()V", line = 131)
    public class258() {
    }

    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(I)V", line = 133)
