...
public class class221 extends class258 {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(BLmc;)V", line = 6)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Lim;B)V", line = 45)
