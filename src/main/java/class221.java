...
public class class221 extends class439 {
    ...
    @OriginalMember(owner = "client!rd", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!rd", name = "b", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lqa;II)Lc;", line = 78)
