...
public class class221 extends class120 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(BI)C", line = 54)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Lbt;II)V", line = 81)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Lbt;IIZ[[I)V", line = 183)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Lbt;IIZ[[BI)V", line = 214)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IIIII)V", line = 112)
    ...
    @OriginalMember(owner = "client!hp", name = "f", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Z)V", line = 134)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IIB)Z", line = 151)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IIIBI)V", line = 165)
