...
public class class221 extends class306 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "()Lca;")
    ...
    @OriginalMember(owner = "client!hm", name = "c", descriptor = "()Lca;")
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Lhea;I)V")
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(ZDI)Lhea;")
    ...
    @OriginalMember(owner = "client!hm", name = "f", descriptor = "(I)Lhea;")
