...
public abstract class class221 implements class737 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Z)I", line = 27)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(I)I", line = 39)
    ...
    @OriginalMember(owner = "client!cu", name = "c", descriptor = "(I)Z", line = 52)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IZ)V", line = 78)
    ...
    @OriginalMember(owner = "client!cu", name = "finalize", descriptor = "()V", line = 98)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(ZZ)V", line = 108)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Lms;I[[B)V", line = 128)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "(Lac;IIIZ)V", line = 227)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(Z)V", line = 210)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(BLji;)Lsh;", line = 244)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(II)V", line = 264)
