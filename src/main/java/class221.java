...
public class class221 extends class192 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(BLtc;)V", line = 4)
    ...
    @OriginalMember(owner = "client!mg", name = "e", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!mg", name = "b", descriptor = "(IBI)V", line = 58)
    ...
    @OriginalMember(owner = "client!mg", name = "<init>", descriptor = "()V", line = 132)
    public class221() {
        super(1, false);
    }

    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(IB)[I", line = 135)
    ...
    @OriginalMember(owner = "client!mg", name = "f", descriptor = "(B)I", line = 171)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(ILfd;I)V", line = 188)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(ILtc;)Ltc;", line = 206)
    ...
    @OriginalMember(owner = "client!mg", name = "b", descriptor = "(IB)[[I", line = 240)
