...
public class class221 extends class727 implements class466 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(I)I", line = 8)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Lha;I)V", line = 21)
    ...
    @OriginalMember(owner = "client!bb", name = "e", descriptor = "(I)Z", line = 48)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ILha;)Lrk;", line = 63)
    ...
    @OriginalMember(owner = "client!bb", name = "c", descriptor = "(Lha;I)Ltja;", line = 94)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ILns;)V", line = 111)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ZIILha;)Luaa;", line = 168)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(B)Z", line = 198)
    public final boolean method755(byte arg0) {
        ++field3011;
        return arg0 != -111 ? false : this.field3020;
    }

    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Lha;Z)V", line = 210)
    ...
    @OriginalMember(owner = "client!bb", name = "d", descriptor = "(B)I", line = 239)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(B)I", line = 251)
    ...
    @OriginalMember(owner = "client!bb", name = "d", descriptor = "(Z)Z", line = 263)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ILha;II)Z", line = 277)
    ...
    @OriginalMember(owner = "client!bb", name = "g", descriptor = "(B)V", line = 302)
    ...
    @OriginalMember(owner = "client!bb", name = "c", descriptor = "(I)I", line = 316)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(Lha;I)V", line = 327)
    public final void method76(class473 arg0, int arg1) {
        int var3 = -71 % ((arg1 - -30) / 42);
        ++field3003;
    }

    @OriginalMember(owner = "client!bb", name = "e", descriptor = "(B)V", line = 336)
    ...
    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "(Lha;Lro;IIIIIZIZ)V", line = 355)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Loq;IZILha;II)V", line = 390)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IIIIIILha;)V", line = 411)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(BLha;I)Lka;", line = 468)
    ...
    @OriginalMember(owner = "client!bb", name = "d", descriptor = "(I)Z", line = 489)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Z)I", line = 504)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(Z)V", line = 522)
