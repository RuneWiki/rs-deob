...
public class class221 implements class669 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Lrg;B)I")
    ...
    @OriginalMember(owner = "client!mg", name = "b", descriptor = "(B)Lbl;")
    ...
    @OriginalMember(owner = "client!mg", name = "<init>", descriptor = "(Lmv;Ljava/lang/String;)V")
