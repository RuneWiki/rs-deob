...
public class class221 extends class701 implements class614 {
    ...
    @OriginalMember(owner = "client!cca", name = "b", descriptor = "(ILr;)Lnu;", line = 5)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(Lr;BI)Lda;", line = 19)
    ...
    @OriginalMember(owner = "client!cca", name = "g", descriptor = "(I)I", line = 43)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(Lr;I)V", line = 55)
    ...
    @OriginalMember(owner = "client!cca", name = "b", descriptor = "(Lr;Z)Lkq;", line = 83)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(IZLr;Lrga;IIZ)V", line = 112)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(Lr;Z)V", line = 131)
    ...
    @OriginalMember(owner = "client!cca", name = "j", descriptor = "(I)Z", line = 161)
    ...
    @OriginalMember(owner = "client!cca", name = "h", descriptor = "(I)Z", line = 174)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(IIII)V", line = 189)
    ...
    @OriginalMember(owner = "client!cca", name = "<init>", descriptor = "(Lr;Let;IIIIIZIZ)V", line = 213)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(B)I", line = 246)
    ...
    @OriginalMember(owner = "client!cca", name = "d", descriptor = "(I)Z", line = 259)
    ...
    @OriginalMember(owner = "client!cca", name = "c", descriptor = "(I)V", line = 272)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(ILr;)V", line = 285)
    ...
    @OriginalMember(owner = "client!cca", name = "i", descriptor = "(I)Z", line = 295)
    ...
    @OriginalMember(owner = "client!cca", name = "b", descriptor = "(I)I", line = 308)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(Z)I", line = 319)
    public final int method1179(boolean arg0) {
        ++field3112;
        return !arg0 ? 51 : this.field3115 & 65535;
    }

    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(I)I", line = 336)
    public final int method1175(int arg0) {
        ++field3107;
        return arg0 != 24563 ? -74 : this.field3110;
    }

    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(IZLr;I)Lpa;", line = 348)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(IILr;I)Z", line = 380)
    ...
    @OriginalMember(owner = "client!cca", name = "f", descriptor = "(I)V", line = 407)
    ...
    @OriginalMember(owner = "client!cca", name = "e", descriptor = "(B)V", line = 425)
