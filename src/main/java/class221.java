...
public class class221 extends class108 {
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "()V", line = 23)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(Lr;Lkm;IIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(B[I[BLjt;)Z", line = 62)
    ...
    @OriginalMember(owner = "client!dba", name = "<init>", descriptor = "()V", line = 118)
    public class221() {
    }

    @OriginalMember(owner = "client!dba", name = "<init>", descriptor = "([B)V", line = 120)
