...
public class class221 extends class492 {
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "(Lvj;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "(Lvj;II)V")
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lmq;IBI)V")
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "(Lvj;IIZ[[I)V")
