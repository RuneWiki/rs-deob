...
public class class221 extends class294 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IZZII)Lam;", line = 22)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lii;I)V", line = 44)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Z)V", line = 59)
