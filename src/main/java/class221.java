...
public class class221 extends class264 {
    ...
    @OriginalMember(owner = "client!nb", name = "c", descriptor = "(IBI)V", line = 4)
    ...
    @OriginalMember(owner = "client!nb", name = "h", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "()V", line = 90)
    public class221() {
        super(1, false);
    }

    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(BLnl;)V", line = 97)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(BLkk;I)V", line = 108)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(II)[I", line = 122)
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(BI)[[I", line = 160)
