...
public class class221 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "([Ljava/lang/String;I)[Ljava/lang/String;", line = 11)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(I)V", line = 46)
