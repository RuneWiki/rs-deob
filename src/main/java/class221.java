...
public class class221 extends class179 {
    ...
    @OriginalMember(owner = "client!iq", name = "e", descriptor = "(I)J", line = 4)
    public final long method1688(int arg0) {
        ++field3293;
        return arg0 != -32174 ? -24L : super.field2671 & Long.MAX_VALUE;
    }

    @OriginalMember(owner = "client!iq", name = "f", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Z)V", line = 31)
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(Z)I", line = 45)
    ...
    @OriginalMember(owner = "client!iq", name = "g", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(II)V", line = 74)
    ...
    @OriginalMember(owner = "client!iq", name = "e", descriptor = "(B)I", line = 91)
    ...
    @OriginalMember(owner = "client!iq", name = "h", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(II)V", line = 118)
