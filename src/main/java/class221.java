...
public class class221 extends class65 {
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(IIIIZ)Lvr;")
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(II[I[I)Laa;")
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(Leu;Z)Lvr;")
    ...
    @OriginalMember(owner = "client!uga", name = "f", descriptor = "()Luu;")
    public final class303 method472() {
        return new class549();
    }

    @OriginalMember(owner = "client!uga", name = "A", descriptor = "(ILaa;II)V")
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(Lvj;IIII)V")
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(Lef;)V")
    ...
    @OriginalMember(owner = "client!uga", name = "x", descriptor = "()Lcja;")
    public final class45 method558() {
        return new class45(0, "Pure Java", 1, "CPU", 0L);
    }

    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(Ldn;Ldn;FLdn;)Ldn;")
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(Lvv;)V")
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(Ldn;)V")
    ...
    @OriginalMember(owner = "client!uga", name = "e", descriptor = "(II)Ltq;")
    ...
    @OriginalMember(owner = "client!uga", name = "d", descriptor = "(II)Lbfa;")
    public final class390 method528(int arg0, int arg1) {
        return this.method508(arg0, arg1, false);
    }

    @OriginalMember(owner = "client!uga", name = "<init>", descriptor = "(Ld;)V")
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(Leia;[Leu;Z)Lda;")
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(II[[I[[IIII)Ls;")
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(Lza;)V")
    ...
    @OriginalMember(owner = "client!uga", name = "b", descriptor = "(IIIIII)Ldn;")
    public final class544 method467(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!uga", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ld;II)V")
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(Lgfa;IIII)Lka;")
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(Lef;I)V")
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(IIIIIF)Luca;")
    public final class540 method530(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        return null;
    }

    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(Luu;)V")
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(IIIIIILaa;IIIII)V")
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(I[Luca;)V")
    ...
    @OriginalMember(owner = "client!uga", name = "z", descriptor = "()Luu;")
    ...
    @OriginalMember(owner = "client!uga", name = "c", descriptor = "(I)Lza;")
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(IIZ)Lvr;")
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(IIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(Ljava/lang/Runnable;)Lrga;")
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "()Luu;")
    public final class303 method450() {
        class253 var1 = this.method1473(Thread.currentThread());
        return var1.field3746;
    }

    @OriginalMember(owner = "client!uga", name = "a", descriptor = "([IIIIIZ)Lvr;")
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(Lbfa;Ltq;)Lvv;")
