...
public class class221 extends class296 {
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Lge;Z)Z", line = 13)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(III)V", line = 36)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(IBI)V", line = 47)
    ...
    @OriginalMember(owner = "client!dt", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(BII)V", line = 76)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(I)V", line = 132)
