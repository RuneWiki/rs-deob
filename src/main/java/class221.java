...
public class class221 extends class533 {
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IIIIILya;)V", line = 3)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(ILya;J)V", line = 101)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(BJ)V", line = 133)
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "(B)V", line = 211)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IIIIZLul;I)V", line = 231)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(I)Lgl;", line = 251)
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(Lkd;IIIIII)V", line = 317)
