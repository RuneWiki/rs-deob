...
public abstract class class221 implements class395 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(BII)V", line = 3)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Lps;BLeq;)V", line = 15)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(ZB)V", line = 243)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Z)V", line = 265)
    ...
    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(Z)V", line = 288)
    ...
    @OriginalMember(owner = "client!tu", name = "finalize", descriptor = "()V", line = 298)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(III)V", line = 311)
    ...
    @OriginalMember(owner = "client!tu", name = "c", descriptor = "(Z)V", line = 327)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(B)I", line = 354)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(B[B)[B", line = 369)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(ZI)I", line = 429)
    ...
    @OriginalMember(owner = "client!tu", name = "d", descriptor = "(Z)I", line = 440)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(IZ)V", line = 454)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(II)V", line = 474)
    ...
    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(II)I", line = 486)
    ...
    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(I)Z", line = 538)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(B[II[II)V", line = 565)
    ...
    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(B)V", line = 621)
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "(Lrl;IIIZ)V", line = 642)
