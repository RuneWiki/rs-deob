...
public class class221 extends class311 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIB)B", line = 3)
    ...
    @OriginalMember(owner = "client!ak", name = "c", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(ILea;BZ[[I)V", line = 453)
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(I[B)V", line = 553)
    ...
    @OriginalMember(owner = "client!ak", name = "d", descriptor = "(I)V", line = 612)
