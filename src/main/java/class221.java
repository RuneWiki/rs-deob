...
public class class221 extends class351 {
    ...
    @OriginalMember(owner = "client!ida", name = "<init>", descriptor = "()V", line = 3)
    public class221() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(IIII)Z", line = 6)
    ...
    @OriginalMember(owner = "client!ida", name = "e", descriptor = "(I)V", line = 221)
    public static void method1264(int arg0) {
        int var1 = -21 / ((arg0 + 44) / 43);
        field2567 = null;
    }

    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(IBII)[B", line = 230)
    ...
    @OriginalMember(owner = "client!ida", name = "b", descriptor = "(IBI)V", line = 245)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(IIB)V", line = 261)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(BLrr;II)V", line = 402)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(IIIIIIIB)V", line = 417)
