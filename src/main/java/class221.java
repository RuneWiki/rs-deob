...
public class class221 {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IZ)Ljava/lang/String;", line = 8)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(B)Laf;", line = 45)
