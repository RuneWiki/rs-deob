...
public class class221 extends class376 implements class185 {
    ...
    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "(Lqq;Lin;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(ZLqq;)V")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Lqq;I)V")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Lqq;ZI)Lcd;")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Lqq;BII)Z")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(BLqq;)Lkm;")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Ltq;I)V")
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(ZLqq;)V")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(ILqq;Lps;ZZII)V")
