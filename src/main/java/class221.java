...
public class class221 {
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(I)Ldn;")
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lga;B)V")
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Z)Ldn;")
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(Lga;)V")
