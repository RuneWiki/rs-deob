...
public class class221 extends class324 implements class112 {
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(BF)F", line = 14)
    public final float method652(byte arg0, float arg1) {
        return arg0 >= -126 ? 0.34478074F : arg1 / (float) this.field2726;
    }

    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(ILie;)V", line = 24)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(ZZB)V", line = 34)
    ...
    @OriginalMember(owner = "client!mda", name = "b", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 45)
    public final IDirect3DBaseTexture method1273(int arg0) {
        return arg0 == -26670 ? this.field2724 : (IDirect3DBaseTexture) null;
    }

    @OriginalMember(owner = "client!mda", name = "c", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!mda", name = "<init>", descriptor = "(Lhg;Lg;Lvp;II)V", line = 64)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(FZ)F", line = 84)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(B)I", line = 95)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "([IIIIIIII)V", line = 105)
    ...
    @OriginalMember(owner = "client!mda", name = "<init>", descriptor = "(Lhg;Lg;IIZ[BII)V", line = 143)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(BIIILg;III[B)V", line = 202)
    ...
    @OriginalMember(owner = "client!mda", name = "<init>", descriptor = "(Lhg;IIZ[III)V", line = 245)
    ...
    @OriginalMember(owner = "client!mda", name = "b", descriptor = "(B)I", line = 304)
