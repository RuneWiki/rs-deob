...
public class class221 {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(I)Lqs;", line = 4)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(B)Lqs;", line = 16)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Z)V", line = 47)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ICLjava/lang/String;)I", line = 63)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IIIII)V", line = 91)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IB)[[[B", line = 112)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Ljava/lang/Object;ZB)[B", line = 890)
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(Lcs;)V", line = 929)
