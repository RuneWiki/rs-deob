...
public class class221 extends class43 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IIIII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Luo;)V", line = 29)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(II)V", line = 108)
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(I)V", line = 134)
