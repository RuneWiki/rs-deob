...
public class class221 extends class371 {
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(BI)[I", line = 15)
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "()V", line = 55)
    public class221() {
        super(1, false);
    }

    @OriginalMember(owner = "client!pu", name = "g", descriptor = "(I)Lob;", line = 59)
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(B)V", line = 89)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IBLps;)V", line = 103)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IB)I", line = 147)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IIBIZI)V", line = 162)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IZII)I", line = 215)
    ...
    @OriginalMember(owner = "client!pu", name = "c", descriptor = "(B)V", line = 240)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(BI)[[I", line = 252)
    ...
    @OriginalMember(owner = "client!pu", name = "h", descriptor = "(I)Ljava/lang/String;", line = 321)
