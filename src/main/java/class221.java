...
public class class221 extends class415 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(I[BLbga;I)Lqr;", line = 11)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(ZLkda;)V", line = 41)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(I)V", line = 143)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "(I)V", line = 170)
