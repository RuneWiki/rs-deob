...
public class class221 extends class214 {
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(ILofa;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(ZII)I", line = 86)
    ...
    @OriginalMember(owner = "client!qu", name = "f", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!qu", name = "c", descriptor = "(I)V", line = 185)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IB)[I", line = 197)
    ...
    @OriginalMember(owner = "client!qu", name = "<init>", descriptor = "()V", line = 275)
    public class221() {
        super(1, true);
    }
}
