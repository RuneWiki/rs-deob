...
public class class221 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Lwh;IILha;IIII)Lfd;", line = 23)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(BZ)V", line = 41)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(BLip;)I", line = 70)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(II)V", line = 99)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IZ)Lov;", line = 113)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(I)V", line = 196)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(I)V", line = 215)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Z)V", line = 229)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IIILda;ZZLwh;ILha;ILha;I)Lfd;", line = 251)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(II)V", line = 320)
    ...
    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "(Lgp;IZLlv;Luu;Luu;)V", line = 364)
