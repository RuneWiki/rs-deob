...
public class class221 extends class351 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(I)Ljava/net/Socket;", line = 13)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(ILjava/net/Proxy;)Ljava/net/Socket;", line = 82)
    ...
    @OriginalMember(owner = "client!nj", name = "httpProxyConnect", descriptor = "(Ljava/lang/String;I)Ljava/net/Socket;", line = 126)
