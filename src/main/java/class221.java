...
public class class221 extends class261 implements class294 {
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(Ljava/lang/Exception;)V", line = 4)
    ...
    @OriginalMember(owner = "client!b", name = "finalize", descriptor = "()V", line = 26)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "()V", line = 31)
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "()V", line = 42)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 48)
