...
public class class107 extends class134 implements class55 {
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(ILqa;)V", line = 18)
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(I)Z", line = 28)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Z)Z", line = 39)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Lqa;I)Lip;", line = 51)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IILqa;)Lc;", line = 62)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Lqa;III)Z", line = 73)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(ILqa;)V", line = 84)
    ...
    @OriginalMember(owner = "client!kt", name = "e", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!kt", name = "d", descriptor = "(B)V", line = 106)
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(B)I", line = 118)
    ...
    @OriginalMember(owner = "client!kt", name = "c", descriptor = "(ILqa;)V", line = 131)
    public final void method400(int arg0, class162 arg1) {
        int var3 = -95 / ((-arg0 - 29) / 33);
        field1454++;
    }

    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IIIIIZ)V", line = 140)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(B)I", line = 283)
    ...
    @OriginalMember(owner = "client!kt", name = "c", descriptor = "(I)V", line = 293)
    public final void method361(int arg0) {
        field1457++;
        int var2 = -5 / ((-arg0 - 36) / 36);
    }

    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(IIIIILfq;)V", line = 305)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IILco;ILqa;ZZ)V", line = 313)
