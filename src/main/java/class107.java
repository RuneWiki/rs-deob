...
public class class107 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(ZZLjb;)V", line = 17)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(I[B)Ljava/lang/String;", line = 44)
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "(Z)V", line = 72)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "([BZ)V", line = 83)
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "([BI[B)V", line = 281)
