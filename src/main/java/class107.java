...
public class class107 extends class252 {
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Lbb;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(ZI)V", line = 13)
    ...
    @OriginalMember(owner = "client!ej", name = "h", descriptor = "(I)I", line = 44)
    ...
    @OriginalMember(owner = "client!ej", name = "e", descriptor = "(I)Z", line = 59)
    ...
    @OriginalMember(owner = "client!ej", name = "b", descriptor = "(ZI)V", line = 70)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Z)V", line = 81)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(III)V", line = 108)
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "(Lhea;)V", line = 128)
