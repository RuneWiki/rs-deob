...
public class class107 extends class93 {
    ...
    @OriginalMember(owner = "client!kt", name = "c", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Lcu;B)Ltm;", line = 16)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Z)Lrd;", line = 29)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(BFLrd;Lrd;)Z", line = 41)
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(Lvj;I)V", line = 189)
    public class107(class303 arg0, int arg1) {
        this.field1774 = arg0;
        this.field1783 = new class221(arg0, 6408, arg1);
    }

    @OriginalMember(owner = "client!kt", name = "d", descriptor = "(B)V", line = 198)
