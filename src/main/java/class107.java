...
public class class107 {
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!cq", name = "b", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(ZI)V", line = 33)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(IIBLgba;II)Ljava/awt/Frame;", line = 45)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(II)Lje;", line = 120)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(BI)V", line = 146)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(IIIIIII)V", line = 159)
    ...
    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "(Lnq;ILga;)V", line = 181)
