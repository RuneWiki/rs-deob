...
public class class107 extends class431 {
    ...
    @OriginalMember(owner = "client!g", name = "c", descriptor = "(Lya;I)Lfk;")
    ...
    @OriginalMember(owner = "client!g", name = "b", descriptor = "(Lya;I)V")
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(ILt;Lya;)V")
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(ILya;I)Lt;")
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(IILya;I)Z")
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(IILfi;BZLya;I)V")
