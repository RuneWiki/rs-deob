...
public class class107 extends class98 {
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(ILri;IILfa;Z)[F")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(ILfa;DBZILri;)[I")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Lri;ZLfa;)Z")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(ILr;Lpca;)V")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Lri;ZIDIILfa;Z)[I")
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "(Lie;)V")
