...
public class class107 extends class170 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(BLvg;)V")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "([IILrg;)V")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Lrg;B)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Lrg;BI)V")
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "(Lrg;B)V")
