...
public class class107 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lfb;B)V", line = 30)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 61)
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ILde;ILjava/awt/Canvas;Lwh;I)Ltj;", line = 117)
