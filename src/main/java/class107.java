...
public class class107 extends class615 {
    ...
    @OriginalMember(owner = "client!jj", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IB)[I", line = 16)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(II)[[I", line = 263)
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "()V", line = 583)
    public class107() {
        super(2, false);
    }

    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(BILeh;)V", line = 596)
