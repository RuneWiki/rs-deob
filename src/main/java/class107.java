...
public class class107 extends class656 {
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "([[[Lih;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;ZI)V", line = 77)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(B)V", line = 134)
    ...
    @OriginalMember(owner = "client!kba", name = "<init>", descriptor = "(ILoe;IZ)V", line = 144)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(I)V", line = 158)
