...
public class class107 extends class659 {
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(ILjagtheora/ogg/OggPacket;)V")
    ...
    @OriginalMember(owner = "client!sga", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
