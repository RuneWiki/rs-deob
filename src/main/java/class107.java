...
public class class107 extends class391 implements class466 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILha;)Lrk;")
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Laka;I)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILha;II)Z")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(BLib;)I")
    ...
    @OriginalMember(owner = "client!ec", name = "c", descriptor = "(Lha;I)Ltja;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lha;Z)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Loq;IZILha;II)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILgga;)Luo;")
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(Lha;Lro;IIIIIZIII)V")
