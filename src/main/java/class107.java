...
public class class107 extends class451 implements class559 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ILrj;Lmb;I)V")
    ...
    @OriginalMember(owner = "client!mj", name = "b", descriptor = "(Lha;B)Lufa;")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Lha;I)Lie;")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ZILmb;Lha;III)V")
    ...
    @OriginalMember(owner = "client!mj", name = "<init>", descriptor = "(Lha;Lqg;IIIIIZIIIIIII)V")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IIBLha;)Z")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ZLha;)V")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Lha;B)V")
