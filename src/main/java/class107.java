...
public class class107 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ZLwaa;)Z", line = 12)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IILjava/lang/String;)Ljava/lang/String;", line = 78)
    ...
    @OriginalMember(owner = "client!di", name = "b", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Lqa;I)Lha;", line = 141)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Lqa;ZI)Lha;", line = 177)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(BII)I", line = 212)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IILos;)V", line = 256)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ILos;)V", line = 437)
