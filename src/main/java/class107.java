...
public class class107 extends class525 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(IIIIIFII[FFI)V", line = 19)
    ...
    @OriginalMember(owner = "client!as", name = "c", descriptor = "(Z)V", line = 73)
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(Lmq;)V", line = 138)
