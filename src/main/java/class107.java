...
public class class107 extends class212 {
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(II)V", line = 25)
    ...
    @OriginalMember(owner = "client!kba", name = "d", descriptor = "(I)Z", line = 35)
    ...
    @OriginalMember(owner = "client!kba", name = "<init>", descriptor = "(Ldh;)V", line = 54)
    public class107(class322 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!kba", name = "b", descriptor = "(I)I", line = 59)
    ...
    @OriginalMember(owner = "client!kba", name = "e", descriptor = "(I)I", line = 70)
    ...
    @OriginalMember(owner = "client!kba", name = "b", descriptor = "(II)I", line = 82)
    ...
    @OriginalMember(owner = "client!kba", name = "f", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!kba", name = "<init>", descriptor = "(ILdh;)V", line = 123)
