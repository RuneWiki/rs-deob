...
public class class107 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IIIBIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(II)Z", line = 56)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ZBLdq;Ljava/lang/String;Z)V", line = 81)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IIILuu;)Lji;", line = 153)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(I)V", line = 181)
