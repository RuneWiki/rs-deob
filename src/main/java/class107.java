...
public abstract class class107 implements class575 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(FFFFIILaa;II)V")
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(FFFFFFLaa;II)V")
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(FFIILaa;II)V")
