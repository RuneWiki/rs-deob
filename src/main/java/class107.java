...
public class class107 extends class507 {
    ...
    @OriginalMember(owner = "client!ut", name = "b", descriptor = "(IZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!ut", name = "b", descriptor = "(Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!ut", name = "<init>", descriptor = "(Lad;II[BI)V", line = 50)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(ILmm;III)V", line = 65)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Ljava/util/Random;ZI)I", line = 118)
