...
public class class107 extends class414 {
    ...
    @OriginalMember(owner = "client!ev", name = "d", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!ev", name = "f", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Lo;)V", line = 29)
    ...
    @OriginalMember(owner = "client!ev", name = "b", descriptor = "(B)I", line = 121)
    ...
    @OriginalMember(owner = "client!ev", name = "c", descriptor = "(I)J", line = 131)
    ...
    @OriginalMember(owner = "client!ev", name = "b", descriptor = "(I)I", line = 149)
