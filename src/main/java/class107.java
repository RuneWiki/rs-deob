...
public class class107 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(ILud;I)V")
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(ILud;)V")
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(BZZII)V")
