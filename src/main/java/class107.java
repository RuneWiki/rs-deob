...
public class class107 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(II)Lhf;", line = 5)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Lig;Lbk;)V", line = 63)
