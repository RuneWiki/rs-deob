...
public class class107 extends class219 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "()V", line = 103)
    public class107() {
        this.field1533 = System.nanoTime();
        this.field1534 = System.nanoTime();
    }

    @OriginalMember(owner = "client!td", name = "a", descriptor = "(I)J", line = 45)
    ...
    @OriginalMember(owner = "client!td", name = "c", descriptor = "(I)J", line = 56)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "(I)V", line = 89)
