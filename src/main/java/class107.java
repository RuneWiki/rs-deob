...
public class class107 extends class390 {
    ...
    @OriginalMember(owner = "client!vb", name = "b", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(ILoo;III)V", line = 838)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Laj;B)V", line = 999)
    ...
    @OriginalMember(owner = "client!vb", name = "c", descriptor = "(I)V", line = 1032)
