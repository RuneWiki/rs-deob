...
public class class107 extends class205 {
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(Llf;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(Llf;II)V")
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IIILha;IIII)V")
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(Llf;IIZ[[BI)V")
