...
public class class107 {
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!nf", name = "b", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!nf", name = "<init>", descriptor = "(I)V", line = 46)
