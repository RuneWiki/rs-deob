...
public class class107 extends class71 implements class2 {
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Ljava/lang/Exception;)V", line = 10)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(II)V", line = 33)
    ...
    @OriginalMember(owner = "client!p", name = "finalize", descriptor = "()V", line = 70)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Ljava/awt/Canvas;II)V", line = 82)
