...
public class class107 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(IZILqc;Lnr;IZI)V")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(ILnr;IIZZI)Lqc;")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Lme;)V")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Lnr;I)V")
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "(II)Lro;")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Lnr;B)V")
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(Lnr;Lta;IIIIIIZI)V")
