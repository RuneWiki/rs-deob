...
public class class107 extends class125 {
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(III)Lpj;", line = 17)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "([Ljava/lang/Object;[JB)V", line = 26)
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(ZI)V", line = 38)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(I)Z", line = 50)
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(Lur;)V", line = 88)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ZI)V", line = 128)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ILhe;I)V", line = 155)
