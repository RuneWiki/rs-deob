...
public abstract class class107 extends class337 {
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!kt", name = "e", descriptor = "(I)I", line = 76)
    ...
    @OriginalMember(owner = "client!kt", name = "f", descriptor = "(I)F", line = 92)
    ...
    @OriginalMember(owner = "client!kt", name = "g", descriptor = "(I)I", line = 110)
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(B)I", line = 123)
    ...
    @OriginalMember(owner = "client!kt", name = "c", descriptor = "(B)I", line = 133)
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(IIIIIF)V", line = 152)
    ...
    @OriginalMember(owner = "client!kt", name = "h", descriptor = "(I)I", line = 169)
    ...
    @OriginalMember(owner = "client!kt", name = "i", descriptor = "(I)V", line = 180)
