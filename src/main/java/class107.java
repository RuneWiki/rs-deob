...
public class class107 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Z)Les;", line = 4)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(I)Les;", line = 19)
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(Lmn;)V", line = 112)
    public class107(class249 arg0) {
        this.field1976 = arg0;
    }

    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Lgh;B)V", line = 67)
