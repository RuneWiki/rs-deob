...
public class class107 extends class244 implements class670 {
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(IILoa;I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!laa", name = "c", descriptor = "(B)I", line = 16)
    ...
    @OriginalMember(owner = "client!laa", name = "b", descriptor = "(Loa;I)Lok;", line = 31)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(IILoa;)Lba;", line = 42)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(B)I", line = 55)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Loa;B)V", line = 67)
    ...
    @OriginalMember(owner = "client!laa", name = "<init>", descriptor = "(IIIIILkv;)V", line = 77)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(ILjava/lang/String;I)I", line = 85)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(ZIZIILfl;Loa;)V", line = 96)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Ljava/lang/String;IC)[Ljava/lang/String;", line = 106)
    ...
    @OriginalMember(owner = "client!laa", name = "d", descriptor = "(B)Z", line = 142)
    ...
    @OriginalMember(owner = "client!laa", name = "f", descriptor = "(B)V", line = 155)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(ILoa;)Lgr;", line = 176)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Loa;I)V", line = 188)
    ...
    @OriginalMember(owner = "client!laa", name = "b", descriptor = "(I)Z", line = 200)
    ...
    @OriginalMember(owner = "client!laa", name = "c", descriptor = "(Loa;I)V", line = 213)
    ...
    @OriginalMember(owner = "client!laa", name = "b", descriptor = "(B)I", line = 223)
    ...
    @OriginalMember(owner = "client!laa", name = "d", descriptor = "(I)V", line = 236)
