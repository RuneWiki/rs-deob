...
public class class107 extends class370 {
    ...
    @OriginalMember(owner = "client!mu", name = "c", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Lpea;)V", line = 18)
    public class107(class641 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!mu", name = "d", descriptor = "(Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(I)Z", line = 39)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(ILjava/lang/String;)I", line = 76)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(IBI)V", line = 101)
    ...
    @OriginalMember(owner = "client!mu", name = "f", descriptor = "(I)Z", line = 184)
    ...
    @OriginalMember(owner = "client!mu", name = "g", descriptor = "(I)V", line = 199)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(JJ)J", line = 239)
    public static long method573(long arg0, long arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!mu", name = "c", descriptor = "(B)V", line = 249)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Lqw;Lqw;II)V", line = 267)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(II)V", line = 419)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BII)Z", line = 430)
    ...
    @OriginalMember(owner = "client!mu", name = "c", descriptor = "(Z)Z", line = 442)
