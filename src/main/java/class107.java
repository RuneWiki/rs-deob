...
public class class107 extends class618 {
    ...
    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IC)B", line = 34)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(B)V", line = 162)
