...
public class class107 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(IIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Z)V", line = 35)
