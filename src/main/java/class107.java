...
public class class107 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(Lpe;IIII)V")
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(ZLaca;)V")
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(Laca;II)V")
