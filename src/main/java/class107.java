...
public class class107 extends class448 implements class323 {
    ...
    @OriginalMember(owner = "client!ec", name = "j", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(I)I", line = 14)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Z)Z", line = 27)
    public final boolean method417(boolean arg0) {
        ++field1447;
        return arg0 ? false : this.field1448;
    }

    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(I)I", line = 53)
    ...
    @OriginalMember(owner = "client!ec", name = "i", descriptor = "(I)I", line = 65)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lqa;B)V", line = 76)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IILqa;)Lc;", line = 105)
    ...
    @OriginalMember(owner = "client!ec", name = "e", descriptor = "(I)Z", line = 116)
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(Lqa;B)Lvs;", line = 130)
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(IZILqa;)Ldf;", line = 156)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILqa;I)Lc;", line = 202)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lqa;I)V", line = 223)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IZILqa;)Z", line = 263)
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(Lqa;Ljt;IIIIIZIIIIIIZ)V", line = 291)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(BLrn;ZIILqa;I)V", line = 325)
    ...
    @OriginalMember(owner = "client!ec", name = "c", descriptor = "(I)V", line = 358)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(BLqa;)V", line = 371)
    ...
    @OriginalMember(owner = "client!ec", name = "d", descriptor = "(I)I", line = 381)
