...
public class class107 extends class577 {
    ...
    @OriginalMember(owner = "client!al", name = "c", descriptor = "(B)Lrh;", line = 8)
    ...
    @OriginalMember(owner = "client!al", name = "d", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(ZIIIII[B)V", line = 54)
    ...
    @OriginalMember(owner = "client!al", name = "b", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(JB)V", line = 173)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Z)V", line = 196)
    ...
    @OriginalMember(owner = "client!al", name = "c", descriptor = "(I)Z", line = 213)
