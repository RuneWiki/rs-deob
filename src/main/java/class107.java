...
public class class107 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(I)Lsq;", line = 3)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "(I)Lsq;", line = 27)
    ...
    @OriginalMember(owner = "client!td", name = "c", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!td", name = "d", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Z)V", line = 97)
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "()V", line = 237)
    public class107() {
        this.field1556.field480 = this.field1556;
        this.field1556.field471 = this.field1556;
    }

    @OriginalMember(owner = "client!td", name = "b", descriptor = "(B)Lsq;", line = 121)
    ...
    @OriginalMember(owner = "client!td", name = "e", descriptor = "(I)Lsq;", line = 138)
    ...
    @OriginalMember(owner = "client!td", name = "c", descriptor = "(B)Z", line = 168)
    ...
    @OriginalMember(owner = "client!td", name = "d", descriptor = "(B)I", line = 179)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(ZLsq;)V", line = 205)
