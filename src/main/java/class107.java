...
public abstract class class107 extends class638 {
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "([IIIII)Lxa;")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(IIIIII)Lka;")
    public final class434 method454(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!fv", name = "B", descriptor = "()Lq;")
    public final class391 method459() {
        return new class193();
    }

    @OriginalMember(owner = "client!fv", name = "c", descriptor = "()Lq;")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Lka;Lka;FLka;)Lka;")
    ...
    @OriginalMember(owner = "client!fv", name = "L", descriptor = "(ILfa;II)V")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(IIIIIF)Lld;")
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "(Ljava/awt/Canvas;Le;)V")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Lhfa;)V")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(IIIIIILfa;II)V")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(I)Li;")
    public final class37 method438(int arg0) {
        return null;
    }

    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(I[Lld;)V")
    public final void method398(int arg0, class154[] arg1) {
    }

    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Lkq;Z)Lxa;")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(II[I[I)Lfa;")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(IIIIZ)Lxa;")
    ...
    @OriginalMember(owner = "client!fv", name = "b", descriptor = "(Li;)V")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Lka;)V")
    public final void method432(class434 arg0) {
    }

    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Lq;)V")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Lmj;[Lkq;Z)Lta;")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "()Lfea;")
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "(Le;)V")
