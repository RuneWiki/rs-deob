...
public class class107 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Lqa;[II)V")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Lqa;[IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Lqa;[II[I[I)V")
