...
public abstract class class107 {
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Ltc;II)I", line = 16)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(ZLga;IIIIILga;I)V", line = 38)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(ZI[ZIBILga;Lga;IILga;ILga;II)V", line = 96)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IZI[I[IIIIII)V", line = 158)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IIIIIIILd;I)V", line = 257)
    ...
    @OriginalMember(owner = "client!ba", name = "b", descriptor = "(I)V", line = 374)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(ILga;I)V", line = 391)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "([ILsfa;Leea;IIZLeea;[ZIIZI)V", line = 440)
    ...
    @OriginalMember(owner = "client!ba", name = "c", descriptor = "(I)V", line = 661)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(ZLga;BIILga;[IIIII)V", line = 683)
