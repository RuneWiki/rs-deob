...
public class class251 {
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(IILqa;IBLcn;)V")
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(JI[ILjs;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(II)Lnaa;")
    ...
    @OriginalMember(owner = "client!caa", name = "<init>", descriptor = "(ILdn;Ldn;Lje;)V")
