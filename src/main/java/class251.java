...
public abstract class class251 extends class69 {
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!sca", name = "b", descriptor = "(I)I", line = 15)
    ...
    @OriginalMember(owner = "client!sca", name = "c", descriptor = "(I)I", line = 26)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(Z)I", line = 39)
    ...
    @OriginalMember(owner = "client!sca", name = "g", descriptor = "(I)I", line = 51)
    ...
    @OriginalMember(owner = "client!sca", name = "h", descriptor = "(I)F", line = 68)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(IIII)V", line = 81)
    ...
    @OriginalMember(owner = "client!sca", name = "<init>", descriptor = "(IIIIIF)V", line = 181)
