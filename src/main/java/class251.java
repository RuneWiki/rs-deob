...
public class class251 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(B)Lvr;", line = 11)
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(II)[B", line = 43)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(III)Z", line = 78)
