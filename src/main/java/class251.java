...
public class class251 extends class435 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IBII)I", line = 16)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(II)V", line = 34)
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "([BLap;[IB)Z", line = 72)
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "()V", line = 134)
    public class251() {
    }

    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "([B)V", line = 136)
