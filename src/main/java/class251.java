...
public class class251 extends class160 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IIILcj;[II)V")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "()Lbs;")
    ...
    @OriginalMember(owner = "client!ji", name = "d", descriptor = "()Lbs;")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Lcj;II)V")
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(Lrl;)V")
