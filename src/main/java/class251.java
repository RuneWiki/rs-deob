...
public class class251 extends class305 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(IB)[[I", line = 6)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(ILfh;B)V", line = 84)
    ...
    @OriginalMember(owner = "client!ma", name = "<init>", descriptor = "()V", line = 98)
    public class251() {
        super(3, false);
    }

    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(II)[I", line = 101)
