...
public class class251 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ILmd;)V")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Lit;B)V")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Lmd;II)V")
