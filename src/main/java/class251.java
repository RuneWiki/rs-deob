...
public class class251 extends class365 {
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(I)V", line = 3)
    public class251(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IF)V", line = 7)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(FB)V", line = 25)
    ...
    @OriginalMember(owner = "client!om", name = "n", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!om", name = "k", descriptor = "(II)V", line = 51)
