...
public class class251 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(II)I", line = 34)
    ...
    @OriginalMember(owner = "client!en", name = "b", descriptor = "(II)V", line = 49)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!en", name = "b", descriptor = "(B)V", line = 88)
