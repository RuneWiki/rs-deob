...
public class class251 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ILun;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 32)
    public static final int method1534(String arg0, byte arg1) {
        field3436++;
        return arg1 <= 94 ? 117 : arg0.length() + 1;
    }

    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Ljn;[IILjn;)V", line = 50)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(BLun;)V", line = 85)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Lec;I)V", line = 113)
