...
public class class251 extends class461 implements class141 {
    ...
    @OriginalMember(owner = "client!ja", name = "t", descriptor = "(III)V", line = 13)
    public final void method182(int arg0, int arg1, int arg2) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "(Lda;La;[IIIII)V", line = 21)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(FFFFFFLfa;II)V", line = 28)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IILfa;II)V", line = 37)
    public final void method23(int arg0, int arg1, class212 arg2, int arg3, int arg4) {
        this.method1550(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "(Lda;La;IIII)V", line = 40)
