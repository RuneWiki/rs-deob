...
public class class251 extends class42 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(IIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(IIIIBII)V", line = 30)
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "(I[B)V", line = 48)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(I)V", line = 109)
