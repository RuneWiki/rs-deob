...
public class class251 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "()V", line = 9)
    private static final void method1392() {
        field3436 = 0;
    }

    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(II)V", line = 12)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lvm;[IIII[I[I)V", line = 59)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lvm;[II[I[I)V", line = 95)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(II)V", line = 98)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(I)V", line = 135)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "()V", line = 180)
    public static void method1398() {
        field3435 = null;
    }

    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(I)Z", line = 184)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lvm;[II)V", line = 262)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "([III)V", line = 271)
