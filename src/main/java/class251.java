...
public class class251 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IIIIIIIIII)V", line = 21)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(BI)Lmv;", line = 43)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(III)V", line = 104)
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(B)V", line = 118)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IIIIIZZ)V", line = 137)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IIBII)V", line = 193)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Z)V", line = 311)
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "(Lad;ILdk;Ldk;)V", line = 518)
