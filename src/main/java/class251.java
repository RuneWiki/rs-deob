...
public class class251 extends class13 implements class713 {
    ...
    @OriginalMember(owner = "client!kw", name = "finalize", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(Lha;IIIIIIZZ)V", line = 14)
    ...
    @OriginalMember(owner = "client!kw", name = "d", descriptor = "(I)V", line = 135)
    ...
    @OriginalMember(owner = "client!kw", name = "<init>", descriptor = "(Lqo;III)V", line = 190)
    ...
    @OriginalMember(owner = "client!kw", name = "<init>", descriptor = "(Lqo;IIII)V", line = 208)
    ...
    @OriginalMember(owner = "client!kw", name = "b", descriptor = "(III)V", line = 155)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(I)V", line = 175)
