...
public class class251 extends class394 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(JI)V", line = 6)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "()V", line = 400)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Llm;IIIIIIIIIIIZ)V", line = 412)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "()V", line = 431)
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(Llm;IIIIIIIIIIIZ)V", line = 441)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(J)V", line = 461)
