...
public class class251 implements Runnable {
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Ldda;)V", line = 10)
    ...
    @OriginalMember(owner = "client!wda", name = "b", descriptor = "()V", line = 20)
    ...
    @OriginalMember(owner = "client!wda", name = "c", descriptor = "()Z", line = 27)
    public final boolean method1472() {
        return this.field3086 == null || !this.field3078 && this.field3086.method3662(73);
    }

    @OriginalMember(owner = "client!wda", name = "run", descriptor = "()V", line = 31)
    ...
    @OriginalMember(owner = "client!wda", name = "d", descriptor = "()V", line = 40)
    ...
    @OriginalMember(owner = "client!wda", name = "<init>", descriptor = "(ILr;)V", line = 168)
    public class251(int arg0, class566 arg1) {
        this.field3081 = arg0;
        this.field3080 = arg1;
    }

    @OriginalMember(owner = "client!wda", name = "e", descriptor = "()J", line = 142)
    public final long method1474() {
        return this.field3079;
    }

    @OriginalMember(owner = "client!wda", name = "f", descriptor = "()V", line = 155)
