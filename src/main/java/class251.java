...
public class class251 extends class379 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IIIZ)I", line = 6)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(II)V", line = 29)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "([BZ)[B", line = 42)
    ...
    @OriginalMember(owner = "client!wu", name = "c", descriptor = "(I)V", line = 103)
