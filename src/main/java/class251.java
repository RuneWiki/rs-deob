...
public class class251 {
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(IB)V", line = 18)
    ...
    @OriginalMember(owner = "client!kw", name = "b", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!kw", name = "b", descriptor = "(IB)Lnha;", line = 50)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!kw", name = "c", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(CLjava/lang/String;I)I", line = 110)
    ...
    @OriginalMember(owner = "client!kw", name = "b", descriptor = "(B)V", line = 137)
    ...
    @OriginalMember(owner = "client!kw", name = "<init>", descriptor = "(Lqg;ILvd;)V", line = 157)
