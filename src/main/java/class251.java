...
public class class251 implements class480 {
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(Lofa;III)J")
    ...
    @OriginalMember(owner = "client!vea", name = "b", descriptor = "(I)Lcj;")
    ...
    @OriginalMember(owner = "client!vea", name = "<init>", descriptor = "(Lri;Ljava/lang/String;)V")
    public class251(class97 arg0, String arg1) {
        this.field4008 = arg0;
        this.field4007 = arg1;
    }

    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(BI)Lwg;")
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(Lll;IIILda;I)V")
