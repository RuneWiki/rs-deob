...
public class class251 extends class167 {
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Ltca;Lvea;IIIIIIIIIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(I)Lmh;", line = 39)
    ...
    @OriginalMember(owner = "client!pc", name = "c", descriptor = "(I)V", line = 57)
