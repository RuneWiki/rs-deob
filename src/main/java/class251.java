...
public class class251 extends class204 {
    ...
    @OriginalMember(owner = "client!iaa", name = "b", descriptor = "(I)J", line = 3)
    public final long method1459(int arg0) {
        return arg0 == -1045 ? this.field3643 : -65L;
    }

    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(I)J", line = 13)
    ...
    @OriginalMember(owner = "client!iaa", name = "d", descriptor = "(I)J", line = 29)
    ...
    @OriginalMember(owner = "client!iaa", name = "c", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(JI)I", line = 94)
