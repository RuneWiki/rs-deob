...
public class class251 extends class117 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IIZLm;ILhh;)[F", line = 28)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Lhh;ZIDBLm;IZ)[I", line = 140)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IIIIZIII)V", line = 280)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(BLhh;Lm;)Z", line = 331)
    ...
    @OriginalMember(owner = "client!om", name = "f", descriptor = "(I)V", line = 384)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IIIZDLhh;Lm;)[I", line = 397)
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(II)V", line = 540)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IIILqa;III)Lc;", line = 551)
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "()V", line = 602)
    public class251() {
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(Lti;)V", line = 620)
