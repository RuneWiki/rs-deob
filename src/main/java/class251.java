...
public class class251 extends class467 {
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(III)V", line = 15)
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "(II)V", line = 32)
