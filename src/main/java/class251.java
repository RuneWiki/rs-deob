...
public class class251 {
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(ILdc;)V")
    ...
    @OriginalMember(owner = "client!rw", name = "b", descriptor = "(I)Lvo;")
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(IILdc;)V")
    ...
    @OriginalMember(owner = "client!rw", name = "c", descriptor = "(I)Lvo;")
