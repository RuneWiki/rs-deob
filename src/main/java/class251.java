...
public class class251 extends class198 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(ZLol;)V")
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(ZZLcv;Z)V")
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(ILlm;)V")
