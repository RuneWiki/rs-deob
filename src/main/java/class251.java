...
public class class251 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IB)Lmh;", line = 15)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(II)I", line = 98)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ILqp;Lqp;)V", line = 133)
