...
public class class251 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!i", name = "b", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILco;)V", line = 65)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lco;Z)V", line = 120)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(B)V", line = 143)
