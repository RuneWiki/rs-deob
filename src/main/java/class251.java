...
public class class251 extends class69 {
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(ZLvl;)V")
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(IIII)Lvl;")
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(IIILim;Lim;)V")
