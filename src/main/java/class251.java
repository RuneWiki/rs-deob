...
public class class251 extends class152 implements MouseWheelListener {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Ljava/awt/Component;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 14)
    ...
    @OriginalMember(owner = "client!bj", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 28)
    public final synchronized void mouseWheelMoved(MouseWheelEvent arg0) {
        this.field3449 += arg0.getWheelRotation();
    }

    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(I)I", line = 36)
