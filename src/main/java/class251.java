...
public class class251 extends class180 {
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "([IIIB)V", line = 5)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IIILqr;B)V", line = 19)
    ...
    @OriginalMember(owner = "client!ej", name = "c", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Z)V", line = 53)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IIZ)Z", line = 72)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(III)Z", line = 92)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IIII)Z", line = 111)
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "(IIIIIIIII)V", line = 126)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(B[III)V", line = 142)
