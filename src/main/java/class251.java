...
public class class251 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Le;[II)V", line = 5)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(I)Z", line = 9)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "()V", line = 88)
    private static final void method1740() {
        field4099 = 0;
    }

    @OriginalMember(owner = "client!ks", name = "a", descriptor = "([III)V", line = 95)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Le;[IIII[I[I)V", line = 149)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Le;[II[I[I)V", line = 186)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(I)V", line = 190)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(II)V", line = 235)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "()V", line = 279)
    public static void method1746() {
        field4094 = null;
    }

    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(II)V", line = 282)
