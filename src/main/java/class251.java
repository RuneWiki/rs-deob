...
public class class251 extends class401 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 20)
    ...
    @OriginalMember(owner = "client!ja", name = "b", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IIIIILr;)V", line = 73)
