...
public class class251 extends class458 implements class142 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(FFFFFFLfa;II)V", line = 11)
    ...
    @OriginalMember(owner = "client!ja", name = "t", descriptor = "(III)V", line = 24)
    public final void method414(int arg0, int arg1, int arg2) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "(Lda;La;[IIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "(Lda;La;IIII)V", line = 36)
    ...
    @OriginalMember(owner = "client!ja", name = "finalize", descriptor = "()V", line = 40)
