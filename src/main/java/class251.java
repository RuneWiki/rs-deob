...
public class class251 {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(I)Z", line = 21)
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(B)V", line = 91)
