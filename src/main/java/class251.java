...
public class class251 extends class392 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(B)Lqw;", line = 3)
    ...
    @OriginalMember(owner = "client!mu", name = "e", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(B)I", line = 27)
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(IIII)V", line = 40)
    ...
    @OriginalMember(owner = "client!mu", name = "c", descriptor = "(I)Z", line = 61)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(III)V", line = 73)
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BLjava/awt/event/MouseEvent;)I", line = 113)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Ljava/awt/Component;B)V", line = 150)
    ...
    @OriginalMember(owner = "client!mu", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 163)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(I)I", line = 192)
    ...
    @OriginalMember(owner = "client!mu", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 206)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method1590(arg0.getY(), 119, arg0.getX());
        field3606++;
    }

    @OriginalMember(owner = "client!mu", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 216)
    ...
    @OriginalMember(owner = "client!mu", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 230)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.method1590(arg0.getY(), 36, arg0.getX());
        field3595++;
    }

    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Z)Z", line = 238)
    ...
    @OriginalMember(owner = "client!mu", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 250)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        this.method1590(arg0.getY(), 78, arg0.getX());
        field3593++;
    }

    @OriginalMember(owner = "client!mu", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 261)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method1590(arg0.getY(), 93, arg0.getX());
        field3604++;
    }

    @OriginalMember(owner = "client!mu", name = "c", descriptor = "(B)V", line = 269)
    ...
    @OriginalMember(owner = "client!mu", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 281)
    ...
    @OriginalMember(owner = "client!mu", name = "d", descriptor = "(B)Z", line = 311)
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 360)
    public class251(Component arg0, boolean arg1) {
        this.method1593(arg0, (byte) -127);
        this.field3618 = arg1;
    }

    @OriginalMember(owner = "client!mu", name = "f", descriptor = "(B)V", line = 330)
