...
public class class251 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(II)Ljka;")
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Lsfa;IIIBI)Laf;")
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(Lim;ILgj;)V")
