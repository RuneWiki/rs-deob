...
public class class251 extends class147 {
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IIIIIIBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!aq", name = "b", descriptor = "(Z)V", line = 49)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(ILg;I)Lbg;", line = 60)
    ...
    @OriginalMember(owner = "client!aq", name = "<init>", descriptor = "()V", line = 76)
    public class251() {
    }

    @OriginalMember(owner = "client!aq", name = "<init>", descriptor = "(S)V", line = 78)
    public class251(short arg0) {
        this.field3521 = arg0;
    }

    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(II)V", line = 87)
