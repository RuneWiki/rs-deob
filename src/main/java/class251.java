...
public class class251 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(BI)[B", line = 6)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "([BI)V", line = 95)
    ...
    @OriginalMember(owner = "client!vk", name = "b", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IB)V", line = 168)
