...
public class class251 {
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(ZILlp;ILlp;)Loga;", line = 3)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(B)Z", line = 59)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 134)
    ...
    @OriginalMember(owner = "client!tea", name = "b", descriptor = "(B)V", line = 155)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(ZLib;)Lph;", line = 194)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(IILum;I)Lnf;", line = 212)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(Llp;ILlp;I)Loga;", line = 303)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(ZI)V", line = 315)
    ...
    @OriginalMember(owner = "client!tea", name = "<init>", descriptor = "(Lcg;Lwd;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", line = 331)
