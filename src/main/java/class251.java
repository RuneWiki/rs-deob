...
public class class251 extends class403 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(ILbt;I)V")
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lbt;I[I)V")
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(BLbt;)V")
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lbt;B)Ljava/lang/String;")
