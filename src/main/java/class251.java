...
public class class251 implements Runnable {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(II)I", line = 23)
    public static int method1501(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!wu", name = "run", descriptor = "()V", line = 34)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Ljava/lang/String;B)Lqq;", line = 73)
    ...
    @OriginalMember(owner = "client!wu", name = "b", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Luj;I)V", line = 109)
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "()V", line = 130)
    public class251() {
