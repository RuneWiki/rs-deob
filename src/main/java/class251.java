...
public class class251 extends class203 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "([III[ILkea;I)Ltd;", line = 8)
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(Lpfa;Lqg;)V", line = 167)
    public class251(class275 arg0, class431 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(Z)Z", line = 69)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ZB)V", line = 176)
    ...
    @OriginalMember(owner = "client!rn", name = "d", descriptor = "(I)V", line = 195)
