...
public class class568 extends class540 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lcb;I)V")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lvfa;)V")
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "(Lwk;Lmg;Ljw;[I)V")
