...
public class class568 {
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(Lo;IIIII)V")
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(B)Lnp;")
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(III[BIZLok;I)Lot;")
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(I)Lnw;")
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(IIII)Llea;")
