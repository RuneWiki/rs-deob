...
public class class568 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(II)Lkia;", line = 8)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(B)V", line = 28)
    public static void method3306(byte arg0) {
        int var1 = -125 % ((arg0 - 21) / 48);
        field8080 = null;
    }

    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(ILcs;)Ljba;", line = 46)
