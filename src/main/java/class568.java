...
public class class568 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(BJ)V", line = 7)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(I[BBI)I", line = 23)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(I)Ljava/io/File;", line = 42)
    ...
    @OriginalMember(owner = "client!sr", name = "finalize", descriptor = "()V", line = 58)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(Ljava/io/File;Ljava/lang/String;J)V", line = 71)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Z)J", line = 120)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(II[BZ)V", line = 132)
    ...
    @OriginalMember(owner = "client!sr", name = "b", descriptor = "(B)V", line = 156)
