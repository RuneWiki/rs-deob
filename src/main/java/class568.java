...
public class class568 {
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(IIB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Z)[[I", line = 20)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(IB)[I", line = 43)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!cv", name = "b", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(BI)Z", line = 149)
    ...
    @OriginalMember(owner = "client!cv", name = "<init>", descriptor = "(III)V", line = 174)
