...
public class class568 {
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(I)[Liv;")
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Lfd;Z)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(IILlj;)V")
