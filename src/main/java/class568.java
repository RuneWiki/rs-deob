...
public class class568 implements class250 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(I)Lud;", line = 5)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(III)Z", line = 16)
    ...
    @OriginalMember(owner = "client!lb", name = "b", descriptor = "(I)I", line = 29)
    ...
    @OriginalMember(owner = "client!lb", name = "c", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Lla;Ljava/lang/String;)V", line = 73)
