...
public class class568 extends class147 implements class559 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(FFFFFFIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IILaa;II)V", line = 16)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(III)V", line = 37)
    public final void method1081(int arg0, int arg1, int arg2) {
        this.method3182(this.nativeid, arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!j", name = "c", descriptor = "()I", line = 41)
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Loa;II)V", line = 52)
    ...
    @OriginalMember(owner = "client!j", name = "c", descriptor = "(IIII)V", line = 63)
    public final void method1112(int arg0, int arg1, int arg2, int arg3) {
        this.method3172(this.nativeid, arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Loa;[IIIIIZ)V", line = 69)
    ...
    @OriginalMember(owner = "client!j", name = "w", descriptor = "(Z)V", line = 81)
    public final void method151(boolean arg0) {
        this.method3174(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIIIII)V", line = 84)
