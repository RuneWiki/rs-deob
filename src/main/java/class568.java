...
public class class568 {
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(II)Lhd;", line = 40)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Z)V", line = 67)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(II)V", line = 92)
    ...
    @OriginalMember(owner = "client!qi", name = "<init>", descriptor = "(Lrga;ILni;)V", line = 116)
