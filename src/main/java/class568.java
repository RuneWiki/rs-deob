...
public class class568 extends class623 {
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(ZLtn;)V", line = 5)
    ...
    @OriginalMember(owner = "client!bu", name = "b", descriptor = "(I)V", line = 25)
    public static void method3198(int arg0) {
        field7928 = null;
        int var1 = 52 / ((arg0 + 51) / 56);
    }

    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(ZI)I", line = 34)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(BII)Z", line = 63)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(ILtn;B)V", line = 74)
