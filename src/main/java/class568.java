...
public class class568 {
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(BI)I", line = 3)
    public static final int method3326(byte arg0, int arg1) {
        field8307++;
        return arg0 == 29 ? arg1 >>> 8 : -35;
    }

    @OriginalMember(owner = "client!te", name = "<init>", descriptor = "(IIIIIIIIIIIIII)V", line = 40)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;IIILjava/lang/String;Ljava/lang/String;)V", line = 86)
