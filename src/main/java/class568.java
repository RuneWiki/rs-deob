...
public class class568 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(BI)Lbda;")
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lpl;IBI)Leaa;")
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "(Lrf;IZLpl;Lpl;)V")
