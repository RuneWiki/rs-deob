...
public class class568 extends class63 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ILco;[IILqa;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(I)V", line = 393)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lgp;BLqa;Lgp;)V", line = 490)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ZLqa;)V", line = 508)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ILqa;ILaea;III)V", line = 799)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ILqa;IIIBLaea;IIII)V", line = 912)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "([Laea;Lqa;I[BBI)V", line = 1623)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IIIILco;[ILqa;IIBI)V", line = 1701)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IILqa;IIII[Laea;[BII)V", line = 1996)
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(IIIZ)V", line = 2078)
