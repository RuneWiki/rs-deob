...
public class class568 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!of", name = "toString", descriptor = "()Ljava/lang/String;", line = 61)
    public final String toString() {
        field7646++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(II)V", line = 68)
