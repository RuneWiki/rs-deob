...
public class class568 implements class343 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(B)Ldea;")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Lqq;B)V")
    ...
    @OriginalMember(owner = "client!tl", name = "<init>", descriptor = "(Ltf;Ljava/lang/String;)V")
