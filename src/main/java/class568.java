...
public class class568 extends class544 {
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(Ldn;II)Lica;")
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(Ldn;)Z")
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(Ldn;I)Lica;")
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "([I)Lmr;")
    ...
    @OriginalMember(owner = "client!ica", name = "b", descriptor = "()V")
