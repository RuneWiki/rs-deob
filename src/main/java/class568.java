...
public class class568 extends class557 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Ltn;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(BLdt;)V", line = 14)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IBZ)Lpia;", line = 29)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(I)V", line = 66)
