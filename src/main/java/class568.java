...
public class class568 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "([SI[Ljava/lang/String;II)V", line = 55)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Leh;B)V", line = 133)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(BLeh;I)V", line = 160)
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(Z)V", line = 418)
