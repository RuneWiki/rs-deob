...
public class class568 {
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Lns;Z)I", line = 10)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(II)V", line = 102)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(BLgga;)V", line = 115)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Lgga;ZI)V", line = 140)
    ...
    @OriginalMember(owner = "client!sv", name = "b", descriptor = "(II)Lqha;", line = 182)
    ...
    @OriginalMember(owner = "client!sv", name = "b", descriptor = "(I)V", line = 213)
