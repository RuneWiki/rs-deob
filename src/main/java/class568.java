...
public class class568 {
    ...
    @OriginalMember(owner = "client!ac", name = "g", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ac", name = "i", descriptor = "(I)I", line = 20)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(II)Z", line = 35)
    ...
    @OriginalMember(owner = "client!ac", name = "f", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!ac", name = "h", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ILjava/lang/String;[BZ)I", line = 91)
