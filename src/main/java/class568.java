...
public class class568 extends class681 implements class461 {
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(Lta;IZ[[I)V")
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ILtda;)V")
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(Z)Ljagdx/IDirect3DBaseTexture;")
