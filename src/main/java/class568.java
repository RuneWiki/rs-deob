...
public class class568 extends class525 implements class628 {
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(ILjava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IIIILlp;I)Ljava/awt/Frame;", line = 13)
    ...
    @OriginalMember(owner = "client!lw", name = "<init>", descriptor = "(Lag;Z)V", line = 86)
    public class568(class587 arg0, boolean arg1) {
        super(arg0, 34962, arg1);
    }

    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IIB)Z", line = 90)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;", line = 107)
    public final Buffer method282(int arg0, boolean arg1) {
        field8383++;
        return arg0 == -13803 ? super.method282(-13803, arg1) : null;
    }

    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(FFIIIIIF[FIIII)V", line = 120)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Lgba;I)V", line = 208)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(I)Z", line = 279)
    public final boolean method280(int arg0) {
        field8376++;
        return arg0 == 28596 ? this.method280(arg0) : false;
    }

    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(I)I", line = 293)
    ...
    @OriginalMember(owner = "client!lw", name = "e", descriptor = "(I)V", line = 304)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IILjaclib/memory/Source;I)Z", line = 317)
    ...
    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(B)V", line = 339)
