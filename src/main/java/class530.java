...
public class class530 extends class428 {
    ...
    @OriginalMember(owner = "client!is", name = "f", descriptor = "(I)Z", line = 30)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(IIIIIIIIIZ)V", line = 44)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(BLjava/lang/String;Lwq;)I", line = 64)
    ...
    @OriginalMember(owner = "client!is", name = "h", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(ZI)V", line = 102)
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "(Ltia;Lgda;Lb;)V", line = 119)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(IZ)V", line = 136)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Lln;BI)V", line = 147)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Z)V", line = 162)
