...
public class class530 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(I)Lcf;")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Lcg;Lfq;)V")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Z)Lcf;")
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(Lgu;)V")
