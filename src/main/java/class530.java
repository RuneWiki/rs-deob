...
public abstract class class530 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!kn", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 4)
    public final void update(Graphics arg0) {
        this.paint(arg0);
        field7788++;
    }

    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(ZI)V", line = 15)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Z)V", line = 96)
    ...
    @OriginalMember(owner = "client!kn", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 143)
    public final void windowClosed(WindowEvent arg0) {
        field7787++;
    }

    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!kn", name = "destroy", descriptor = "()V", line = 165)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IIIILjava/lang/String;IIZ)V", line = 180)
    ...
    @OriginalMember(owner = "client!kn", name = "b", descriptor = "(ZI)Lou;", line = 222)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(BIIII)V", line = 256)
    ...
    @OriginalMember(owner = "client!kn", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 304)
    public final void windowDeactivated(WindowEvent arg0) {
        field7766++;
    }

    @OriginalMember(owner = "client!kn", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 311)
    ...
    @OriginalMember(owner = "client!kn", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 333)
    ...
    @OriginalMember(owner = "client!kn", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 350)
    ...
    @OriginalMember(owner = "client!kn", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 365)
    public final void windowIconified(WindowEvent arg0) {
        field7785++;
    }

    @OriginalMember(owner = "client!kn", name = "run", descriptor = "()V", line = 377)
    ...
    @OriginalMember(owner = "client!kn", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 498)
    ...
    @OriginalMember(owner = "client!kn", name = "start", descriptor = "()V", line = 513)
    ...
    @OriginalMember(owner = "client!kn", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 528)
    ...
    @OriginalMember(owner = "client!kn", name = "d", descriptor = "(I)V", line = 546)
    ...
    @OriginalMember(owner = "client!kn", name = "e", descriptor = "(I)Ljava/lang/String;", line = 582)
    ...
    @OriginalMember(owner = "client!kn", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 596)
    ...
    @OriginalMember(owner = "client!kn", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 610)
    public final void windowOpened(WindowEvent arg0) {
        field7773++;
    }

    @OriginalMember(owner = "client!kn", name = "f", descriptor = "(I)Z", line = 619)
    ...
    @OriginalMember(owner = "client!kn", name = "providesignlink", descriptor = "(Ldq;)V", line = 655)
    ...
    @OriginalMember(owner = "client!kn", name = "g", descriptor = "(I)V", line = 663)
    ...
    @OriginalMember(owner = "client!kn", name = "h", descriptor = "(I)V", line = 709)
    ...
    @OriginalMember(owner = "client!kn", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 741)
    public final void focusLost(FocusEvent arg0) {
        class540.field7916 = false;
        field7765++;
    }

    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 751)
    ...
    @OriginalMember(owner = "client!kn", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 780)
    public final void windowActivated(WindowEvent arg0) {
        field7768++;
    }

    @OriginalMember(owner = "client!kn", name = "stop", descriptor = "()V", line = 793)
    ...
    @OriginalMember(owner = "client!kn", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 809)
    public final void windowClosing(WindowEvent arg0) {
        this.destroy();
        field7779++;
    }

    @OriginalMember(owner = "client!kn", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 821)
