...
public abstract class class530 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IIIIIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Lbo;ILjava/lang/String;Z)Lbm;", line = 57)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(ILcl;IIIIIIIIII)Z", line = 89)
