...
public class class530 extends class349 {
    ...
    @OriginalMember(owner = "client!ks", name = "<init>", descriptor = "()V", line = 4)
    public class530() {
        super(0, false);
    }

    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(IIZII)V", line = 7)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(IB)[[I", line = 23)
    ...
    @OriginalMember(owner = "client!ks", name = "f", descriptor = "(I)Z", line = 92)
    ...
    @OriginalMember(owner = "client!ks", name = "c", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!ks", name = "g", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(IILdga;)V", line = 150)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(I)I", line = 169)
