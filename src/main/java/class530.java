...
public class class530 extends class82 {
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Lwda;Lwda;I)V")
    ...
    @OriginalMember(owner = "client!paa", name = "h", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(IILos;)V")
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(ZIILdn;)Lfc;")
