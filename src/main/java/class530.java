...
public class class530 extends class497 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(ZZLvo;)V", line = 3)
    ...
    @OriginalMember(owner = "client!re", name = "c", descriptor = "(Z)I", line = 33)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(BI)I", line = 44)
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(I)I", line = 77)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(Z)V", line = 104)
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "(ILpp;)V", line = 119)
    public class530(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "(Lpp;)V", line = 129)
    public class530(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!re", name = "a", descriptor = "(II)V", line = 132)
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(I)I", line = 155)
