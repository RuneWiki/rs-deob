...
public class class530 extends class448 {
    ...
    @OriginalMember(owner = "client!ms", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(Lqa;Lvj;Lvc;J)V", line = 464)
    ...
    @OriginalMember(owner = "client!ms", name = "c", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!ms", name = "d", descriptor = "(I)V", line = 138)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IJLqa;ZI)V", line = 161)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Z)V", line = 331)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(BJ)V", line = 348)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Ljb;)V", line = 368)
