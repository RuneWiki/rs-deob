...
public class class530 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "([BI)[B", line = 33)
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(Lod;)V", line = 49)
    public class530(class349 arg0) {
        this.field7815 = arg0;
    }

    @OriginalMember(owner = "client!ms", name = "b", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Lmi;Lmi;BF)Z", line = 72)
