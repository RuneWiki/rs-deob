...
public abstract class class530 {
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "([IZIIII[IIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(III[ZIIILdl;ILdl;IZILdl;Ldl;)V", line = 104)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(III[ILdl;ZLdl;IIII)V", line = 159)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(Z)V", line = 195)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(Ldl;IIIZLdl;III)V", line = 211)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(ZILdl;)V", line = 243)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(II[IZZLae;IILpr;ILpr;[Z)V", line = 324)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(IIIIIIILya;I)V", line = 540)
