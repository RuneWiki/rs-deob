...
public class class530 extends class739 {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(CZ)Z", line = 3)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(I[S[Ljava/lang/String;II)V", line = 30)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(BI)[[I", line = 86)
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "()V", line = 189)
    public class530() {
        super(1, false);
    }

    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Lsl;II)V", line = 202)
