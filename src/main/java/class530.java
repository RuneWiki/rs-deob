...
public class class530 {
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(IIB)Z", line = 13)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Ljava/lang/String;Lha;Lda;ZILne;)V", line = 24)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(IIIIIIII)V", line = 139)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(IIIIIII)I", line = 164)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(II)V", line = 215)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(BLjava/lang/String;)I", line = 229)
