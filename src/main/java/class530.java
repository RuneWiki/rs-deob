...
public class class530 {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Lhk;IIII)Lvq;", line = 5)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(II)I", line = 25)
    public static int method3011(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Z)V", line = 34)
