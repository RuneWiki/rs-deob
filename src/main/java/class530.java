...
public class class530 extends InputStream {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!ms", name = "read", descriptor = "()I", line = 49)
    ...
    @OriginalMember(owner = "client!ms", name = "b", descriptor = "(I)V", line = 61)
