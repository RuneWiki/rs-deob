...
public abstract class class530 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Lqa;Lha;III)V")
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Lon;Lqa;I)I")
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IIILps;Lqf;)V")
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(ILbo;III)V")
