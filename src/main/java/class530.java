...
public class class530 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IBI)V")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Ljava/lang/String;I)I")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(BI)Lafa;")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(BLjb;)Ljb;")
    ...
    @OriginalMember(owner = "client!pt", name = "<init>", descriptor = "(Lsaa;ILfp;Lfp;)V")
    ...
    @OriginalMember(owner = "client!pt", name = "b", descriptor = "(BI)V")
