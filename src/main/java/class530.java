...
public class class530 implements class545 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Ljaclib/memory/Source;BII)Z", line = 9)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(B)Z", line = 39)
    ...
    @OriginalMember(owner = "client!de", name = "b", descriptor = "(B)I", line = 61)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;", line = 71)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(III)Z", line = 98)
    ...
    @OriginalMember(owner = "client!de", name = "b", descriptor = "(Z)I", line = 132)
    ...
    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "(Lhl;Z)V", line = 144)
