...
public class class530 extends class334 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IIIII)Z", line = 7)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ZI)[[I", line = 31)
    ...
    @OriginalMember(owner = "client!tt", name = "g", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!tt", name = "<init>", descriptor = "()V", line = 152)
    public class530() {
        super(1, false);
    }

    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IZLol;)V", line = 155)
    ...
    @OriginalMember(owner = "client!tt", name = "h", descriptor = "(I)V", line = 224)
