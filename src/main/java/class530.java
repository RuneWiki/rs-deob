...
public class class530 extends class478 {
    ...
    @OriginalMember(owner = "client!iw", name = "b", descriptor = "(II)[I", line = 9)
    ...
    @OriginalMember(owner = "client!iw", name = "b", descriptor = "(B)V", line = 258)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(IILvj;Z[IZ)Lbr;", line = 276)
    ...
    @OriginalMember(owner = "client!iw", name = "<init>", descriptor = "()V", line = 302)
    public class530() {
        super(0, true);
    }

    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(B)V", line = 312)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(ILnp;I)V", line = 326)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(IIILjava/util/Random;II[[I)V", line = 425)
    ...
    @OriginalMember(owner = "client!iw", name = "c", descriptor = "(I)V", line = 625)
