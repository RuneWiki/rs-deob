...
public class class530 extends class369 {
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(Lfk;[Lpe;)V")
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(Lfk;Lor;IIII)V")
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(Lfk;)V")
    public class530(class569 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Lhv;[Lpe;)Lpe;")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(BIZ)Lba;")
