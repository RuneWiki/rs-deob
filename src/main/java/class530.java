...
public class class530 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Lvo;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IZ)Ldca;", line = 31)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "([BI[BIIBIII)V", line = 74)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(B)V", line = 121)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Z)V", line = 151)
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Lnh;Lfa;)V", line = 165)
