...
public class class530 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(IILw;B)V", line = 7)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!k", name = "b", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(II)I", line = 122)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(ZI[[ZIII)V", line = 140)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(IBILw;)V", line = 323)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(IIIIB)V", line = 396)
    ...
    @OriginalMember(owner = "client!k", name = "<init>", descriptor = "(Ljaa;Lrk;)V", line = 441)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(ILw;II)Z", line = 457)
