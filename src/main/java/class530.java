...
public class class530 extends class203 {
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(I[Ljava/lang/String;)[Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(IIZ)V", line = 43)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(ZB)V", line = 118)
    ...
    @OriginalMember(owner = "client!wga", name = "c", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!wga", name = "<init>", descriptor = "(Lpq;Lsa;)V", line = 144)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(BZ)V", line = 177)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(IZLwha;)V", line = 195)
