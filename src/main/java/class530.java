...
public class class530 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(I)Z", line = 19)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!gs", name = "c", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ZZIIIII)V", line = 72)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Lqa;)V", line = 117)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(Z)V", line = 192)
