...
public class class530 extends class446 implements class234 {
    ...
    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(Leea;Lti;Z)V")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(I)Lti;")
    ...
    @OriginalMember(owner = "client!tp", name = "c", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;")
