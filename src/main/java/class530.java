...
public class class530 extends class208 implements class28 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lqm;Z)Lha;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lr;Lrd;Lm;Lpr;I)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lfd;IIII)Lr;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lrd;Z)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(I[Lnm;)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "([Lr;Lm;[Lpr;I)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lrd;)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lqba;)V")
    ...
    @OriginalMember(owner = "client!a", name = "y", descriptor = "()Lcr;")
    ...
    @OriginalMember(owner = "client!a", name = "c", descriptor = "(IIIIII)Lqba;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lqba;Lqba;FLqba;)Lqba;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IIIIIF)Lnm;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Llg;[Lqm;Z)Lra;")
