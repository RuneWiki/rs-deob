...
public class class530 extends class15 {
    ...
    @OriginalMember(owner = "client!fl", name = "K", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(I)[F", line = 12)
    ...
    @OriginalMember(owner = "client!fl", name = "ya", descriptor = "(Ln;)V", line = 35)
    ...
    @OriginalMember(owner = "client!fl", name = "SA", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!fl", name = "IA", descriptor = "(IIIIII)V", line = 84)
    ...
    @OriginalMember(owner = "client!fl", name = "C", descriptor = "(III)V", line = 119)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(III[I)V", line = 134)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IFFIIIF)V", line = 145)
    ...
    @OriginalMember(owner = "client!fl", name = "b", descriptor = "(I)V", line = 176)
    ...
    @OriginalMember(owner = "client!fl", name = "M", descriptor = "([I)V", line = 272)
    ...
    @OriginalMember(owner = "client!fl", name = "WA", descriptor = "(I)V", line = 290)
    ...
    @OriginalMember(owner = "client!fl", name = "N", descriptor = "(III[I)V", line = 302)
    ...
    @OriginalMember(owner = "client!fl", name = "J", descriptor = "(III)V", line = 312)
    ...
    @OriginalMember(owner = "client!fl", name = "CA", descriptor = "(I)V", line = 333)
    ...
    @OriginalMember(owner = "client!fl", name = "c", descriptor = "(B)[F", line = 365)
    ...
    @OriginalMember(owner = "client!fl", name = "c", descriptor = "(I)V", line = 388)
    ...
    @OriginalMember(owner = "client!fl", name = "s", descriptor = "(I)V", line = 407)
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "()V", line = 418)
    public class530() {
        this.method34();
    }

    @OriginalMember(owner = "client!fl", name = "ba", descriptor = "(I)V", line = 426)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "()Ln;", line = 454)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Ln;I)V", line = 481)
