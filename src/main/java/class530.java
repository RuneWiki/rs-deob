...
public class class530 extends Canvas {
    ...
    @OriginalMember(owner = "client!gr", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 4)
    public final void paint(Graphics arg0) {
        field7617++;
        this.field7622.paint(arg0);
    }

    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IIILraa;)V", line = 12)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!gr", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 107)
    public final void update(Graphics arg0) {
        this.field7622.update(arg0);
        field7621++;
    }

    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 114)
