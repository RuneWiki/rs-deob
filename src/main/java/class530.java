...
public class class530 extends class279 {
    ...
    @OriginalMember(owner = "client!mo", name = "d", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(ILza;BI)Z", line = 17)
    ...
    @OriginalMember(owner = "client!mo", name = "c", descriptor = "(Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!mo", name = "d", descriptor = "(Z)V", line = 249)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(BLza;)Luc;", line = 266)
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 488)
    ...
    @OriginalMember(owner = "client!mo", name = "e", descriptor = "(I)I", line = 307)
    public final int method132(int arg0) {
        ++field7758;
        return arg0 >= -103 ? 11 : this.field7777;
    }

    @OriginalMember(owner = "client!mo", name = "c", descriptor = "(B)Z", line = 325)
    ...
    @OriginalMember(owner = "client!mo", name = "finalize", descriptor = "()V", line = 336)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(BLjava/lang/String;)I", line = 353)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(II)V", line = 387)
    ...
    @OriginalMember(owner = "client!mo", name = "c", descriptor = "(BLza;)V", line = 418)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IIIZILot;Lza;)V", line = 433)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IILza;B)Le;", line = 443)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Lza;Le;I)V", line = 460)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(I)V", line = 523)
