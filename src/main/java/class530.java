...
public class class530 extends class539 implements class141 {
    ...
    @OriginalMember(owner = "client!v", name = "b", descriptor = "()V", line = 10)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 21)
    ...
    @OriginalMember(owner = "client!v", name = "finalize", descriptor = "()V", line = 73)
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(Lda;Ljava/awt/Canvas;)V", line = 77)
