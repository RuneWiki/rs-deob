...
public class class530 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IIII)I", line = 5)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IIIZ[Lqk;IIIIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IB)Ldj;", line = 883)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IIB)Z", line = 909)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Z)V", line = 920)
    ...
    @OriginalMember(owner = "client!gr", name = "toString", descriptor = "()Ljava/lang/String;", line = 945)
    public final String toString() {
        field7722++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IILcs;)V", line = 953)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(I)I", line = 983)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(B)V", line = 996)
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(II)V", line = 1040)
