...
public class class530 extends class417 {
    ...
    @OriginalMember(owner = "client!fe", name = "<init>", descriptor = "(Lkt;Lvn;[Lqga;[I[I)V", line = 6)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "([B[IIIIIIIIIIILua;II)V", line = 29)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "([B[IIIIIIII)V", line = 114)
    ...
    @OriginalMember(owner = "client!fe", name = "b", descriptor = "([B[IIIIIIII)V", line = 172)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(CIIIZLua;II)V", line = 206)
    ...
    @OriginalMember(owner = "client!fe", name = "b", descriptor = "([B[IIIIIIIIIIILua;II)V", line = 273)
    ...
    @OriginalMember(owner = "client!fe", name = "OA", descriptor = "(CIIIZ)V", line = 368)
