...
public class class530 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(I)Luj;", line = 9)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Lmg;Luj;B)V", line = 33)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(B)Luj;", line = 58)
    ...
    @OriginalMember(owner = "client!mg", name = "b", descriptor = "(I)Z", line = 77)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(ZLgk;ILgk;Z)I", line = 88)
    ...
    @OriginalMember(owner = "client!mg", name = "c", descriptor = "(I)Luj;", line = 185)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(BIII)I", line = 207)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(ILuj;)V", line = 232)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Lmg;B)V", line = 249)
    ...
    @OriginalMember(owner = "client!mg", name = "b", descriptor = "(ILuj;)V", line = 264)
    ...
    @OriginalMember(owner = "client!mg", name = "d", descriptor = "(I)Luj;", line = 285)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Z)V", line = 306)
    ...
    @OriginalMember(owner = "client!mg", name = "e", descriptor = "(I)V", line = 330)
    ...
    @OriginalMember(owner = "client!mg", name = "<init>", descriptor = "()V", line = 391)
    public class530() {
        this.field7789.field6884 = this.field7789;
        this.field7789.field6879 = this.field7789;
    }

    @OriginalMember(owner = "client!mg", name = "f", descriptor = "(I)Luj;", line = 348)
    ...
    @OriginalMember(owner = "client!mg", name = "b", descriptor = "(B)I", line = 370)
