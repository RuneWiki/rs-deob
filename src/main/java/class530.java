...
public class class530 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(BI)[[I", line = 7)
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(III)V", line = 183)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(B)[[[I", line = 78)
    ...
    @OriginalMember(owner = "client!ms", name = "b", descriptor = "(B)V", line = 107)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(ILya;II)V", line = 117)
    ...
    @OriginalMember(owner = "client!ms", name = "c", descriptor = "(B)V", line = 134)
