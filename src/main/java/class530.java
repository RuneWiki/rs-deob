...
public class class530 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(IB)Lkca;", line = 3)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(II)Z", line = 72)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(I)V", line = 83)
