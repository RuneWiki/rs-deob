...
public class class530 extends class65 {
    ...
    @OriginalMember(owner = "client!iba", name = "c", descriptor = "()V", line = 15)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 21)
    ...
    @OriginalMember(owner = "client!iba", name = "b", descriptor = "()I", line = 36)
    public final int method504() {
        return this.field7202 - (this.field7203.available() >> (class460.field6375 ? 2 : 1));
    }

    @OriginalMember(owner = "client!iba", name = "a", descriptor = "()V", line = 45)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 80)
    ...
    @OriginalMember(owner = "client!iba", name = "b", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!iba", name = "d", descriptor = "()V", line = 140)
