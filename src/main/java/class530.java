...
public class class530 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 8)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I)Ldc;", line = 37)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lbf;Z)I", line = 52)
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IB)V", line = 145)
