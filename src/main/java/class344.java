...
public class class344 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(II)[[I", line = 49)
    ...
    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(I)[[[I", line = 120)
    ...
    @OriginalMember(owner = "client!ri", name = "<init>", descriptor = "(III)V", line = 176)
