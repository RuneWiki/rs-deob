...
public class class344 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Lkk;I)V")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IILkk;)V")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(I)[Lrc;")
