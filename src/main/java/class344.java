...
public class class344 {
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!daa", name = "b", descriptor = "(I)V", line = 233)
    public static void method2206(int arg0) {
        int var1 = 79 % ((-arg0 - 53) / 47);
        field5093 = null;
    }

    @OriginalMember(owner = "client!daa", name = "a", descriptor = "([SII)[S", line = 243)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(Lfc;Lla;B)V", line = 257)
