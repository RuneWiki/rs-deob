...
public abstract class class344 implements class5 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Ljaggl/opengl;IIIIII[I)V")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Ljaggl/opengl;IIIII[B)V")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Ljaggl/opengl;IIIII[F)V")
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "(Lse;IIIZ)V")
