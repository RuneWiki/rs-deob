...
public class class344 extends class577 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ILso;)V")
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Ltf;I)V")
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(Lso;)V")
