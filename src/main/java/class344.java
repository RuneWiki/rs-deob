...
public class class344 {
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(IIBLea;II)Lts;", line = 5)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Lrg;I)V", line = 113)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(BI)I", line = 176)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Lrg;ZI)V", line = 197)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(B)V", line = 294)
