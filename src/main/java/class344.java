...
public class class344 extends OutputStream {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(II)Lvl;", line = 4)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(BJ)Ljava/lang/String;", line = 325)
    ...
    @OriginalMember(owner = "client!pi", name = "write", descriptor = "(I)V", line = 366)
