...
public class class344 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(II)Lbba;")
    ...
    @OriginalMember(owner = "client!ln", name = "c", descriptor = "(II)Lrk;")
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(Lkr;ILpu;Lpu;Lpu;)V")
