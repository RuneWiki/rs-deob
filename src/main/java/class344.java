...
public class class344 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IBI[B)V", line = 4)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IILok;)V", line = 17)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(Ltb;Lhr;Lfq;IIIII)V", line = 163)
