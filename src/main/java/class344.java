...
public class class344 extends class223 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Ljj;III)V", line = 7)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(III)Lrb;", line = 45)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IIIIB)I", line = 59)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IBII)V", line = 76)
    ...
    @OriginalMember(owner = "client!lm", name = "c", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(I)V", line = 138)
