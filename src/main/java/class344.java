...
public class class344 extends class539 implements class602 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(BLjca;)V", line = 3)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(B)Z", line = 22)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(I)I", line = 33)
    ...
    @OriginalMember(owner = "client!hs", name = "l", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Z)V", line = 55)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ILfq;BIILha;Z)V", line = 65)
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(Lha;Llp;IIIIIZIIIIIII)V", line = 76)
    ...
    @OriginalMember(owner = "client!hs", name = "i", descriptor = "(I)Z", line = 85)
    ...
    @OriginalMember(owner = "client!hs", name = "c", descriptor = "(Lha;B)Lpia;", line = 95)
    ...
    @OriginalMember(owner = "client!hs", name = "h", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(I)I", line = 153)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(Lha;B)V", line = 167)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(B)Z", line = 180)
    ...
    @OriginalMember(owner = "client!hs", name = "c", descriptor = "(I)I", line = 196)
    ...
    @OriginalMember(owner = "client!hs", name = "e", descriptor = "(Lha;B)V", line = 207)
    ...
    @OriginalMember(owner = "client!hs", name = "g", descriptor = "(I)Z", line = 230)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ILha;II)Z", line = 249)
    ...
    @OriginalMember(owner = "client!hs", name = "d", descriptor = "(Lha;B)Lln;", line = 268)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IBI)V", line = 280)
    ...
    @OriginalMember(owner = "client!hs", name = "d", descriptor = "(B)I", line = 423)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Lha;B)V", line = 438)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(Z)I", line = 449)
