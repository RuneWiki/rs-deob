...
public class class344 extends class220 {
    ...
    @OriginalMember(owner = "client!ef", name = "e", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ef", name = "f", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!ef", name = "d", descriptor = "(II)[I", line = 79)
    ...
    @OriginalMember(owner = "client!ef", name = "d", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "()V", line = 130)
    public class344() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ef", name = "c", descriptor = "(II)[I", line = 135)
    ...
    @OriginalMember(owner = "client!ef", name = "g", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!ef", name = "f", descriptor = "(B)V", line = 187)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IIIIZZ)V", line = 384)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IBLil;)V", line = 430)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "([III)V", line = 461)
