...
public class class344 extends class213 {
    ...
    @OriginalMember(owner = "client!ub", name = "c", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(III)V", line = 14)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(ZI)V", line = 58)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(III)V", line = 77)
    ...
    @OriginalMember(owner = "client!ub", name = "d", descriptor = "(B)Z", line = 92)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IILaw;)V", line = 105)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "(Lsv;Lrba;)V", line = 168)
