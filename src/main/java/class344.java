...
public class class344 {
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(BI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(JB)V", line = 80)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Len;Lng;I)I", line = 184)
