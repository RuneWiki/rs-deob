...
public class class344 implements Runnable {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(II)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!np", name = "run", descriptor = "()V", line = 38)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(BI)V", line = 95)
