...
public class class344 extends class325 {
    ...
    @OriginalMember(owner = "client!fp", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(BI)[I", line = 22)
    ...
    @OriginalMember(owner = "client!fp", name = "b", descriptor = "(BI)Lhs;", line = 46)
    ...
    @OriginalMember(owner = "client!fp", name = "d", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Ljava/lang/String;ZILjava/lang/String;IZI)V", line = 80)
    ...
    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 202)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Ljp;IB)V", line = 224)
    ...
    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "()V", line = 254)
    public class344() {
        this(4096);
    }
}
