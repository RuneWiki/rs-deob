...
public abstract class class344 {
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!ht", name = "b", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!ht", name = "b", descriptor = "(I)I", line = 78)
