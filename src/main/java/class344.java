...
public class class344 implements Runnable {
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lcq;II)Lpg;")
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IBLcq;)Lpg;")
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lcq;Z[BI)Lpg;")
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(BLpg;)V")
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "(Lgt;)V")
