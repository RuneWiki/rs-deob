...
public class class344 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lvq;IIIIII)V")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lvq;Lcr;)Z")
    public final boolean method2256(class269 arg0, class344 arg1) {
        return this.field4977 != null || this.method2257(arg0, arg1);
    }

    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(Lvq;Lcr;)Z")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lvq;)V")
    ...
    @OriginalMember(owner = "client!cr", name = "c", descriptor = "(Lvq;Lcr;)V")
    ...
    @OriginalMember(owner = "client!cr", name = "d", descriptor = "(Lvq;Lcr;)V")
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(Lvq;)V")
