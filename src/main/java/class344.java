...
public abstract class class344 extends class130 {
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IIIIIIIIIILuh;)Z", line = 6)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(I)F", line = 252)
    ...
    @OriginalMember(owner = "client!rd", name = "b", descriptor = "(I)I", line = 263)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Z)V", line = 275)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(B)I", line = 297)
    ...
    @OriginalMember(owner = "client!rd", name = "c", descriptor = "(B)V", line = 308)
    ...
    @OriginalMember(owner = "client!rd", name = "f", descriptor = "(I)I", line = 319)
    ...
    @OriginalMember(owner = "client!rd", name = "b", descriptor = "(Z)I", line = 334)
    ...
    @OriginalMember(owner = "client!rd", name = "g", descriptor = "(I)I", line = 352)
    ...
    @OriginalMember(owner = "client!rd", name = "h", descriptor = "(I)V", line = 364)
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "(IIIIIF)V", line = 415)
