...
public class class344 {
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IIBII)V", line = 22)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(II)V", line = 42)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(BI)Ljs;", line = 56)
