...
public class class344 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(ILpi;)V", line = 156)
