...
public class class344 {
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(BIIZZ)V", line = 23)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(II)Z", line = 36)
    ...
    @OriginalMember(owner = "client!at", name = "b", descriptor = "(II)Llr;", line = 48)
    ...
    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "(Ldd;ILpj;)V", line = 81)
    public class344(class647 arg0, int arg1, class132 arg2) {
        this.field4976 = arg2;
        this.field4976.method936(5, -121);
    }

    @OriginalMember(owner = "client!at", name = "a", descriptor = "(BI)I", line = 96)
