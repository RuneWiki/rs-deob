...
public class class344 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(ZIIILza;ILqp;BLza;ILla;Z)Lo;")
    ...
    @OriginalMember(owner = "client!dj", name = "d", descriptor = "(II)Lmh;")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(ILza;IIIILqp;I)Lo;")
    ...
    @OriginalMember(owner = "client!dj", name = "f", descriptor = "(II)I")
    public static int method2224(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!dj", name = "<init>", descriptor = "(Lwv;IZLbn;Lqs;Lqs;)V")
