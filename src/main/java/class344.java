...
public class class344 extends class673 {
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(IIIB)[B", line = 9)
    ...
    @OriginalMember(owner = "client!qaa", name = "e", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!qaa", name = "<init>", descriptor = "()V", line = 63)
    public class344() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(IBB)V", line = 76)
