...
public class class344 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IIZII)V", line = 55)
