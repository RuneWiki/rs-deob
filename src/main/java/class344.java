...
public class class344 {
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(III)I", line = 4)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IZ)I", line = 25)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!nf", name = "b", descriptor = "(III)V", line = 60)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 78)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IIIIIFIZ)[I", line = 92)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(II)Ldp;", line = 133)
