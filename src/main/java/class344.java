...
public class class344 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(B)V", line = 11)
    public static void method2148(byte arg0) {
        int var1 = 111 / ((-arg0 - 12) / 41);
        field5092 = null;
    }

    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(III)V", line = 27)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(I)V", line = 73)
