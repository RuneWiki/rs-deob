...
public class class344 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ILeu;)I")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(II)Lwi;")
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(Lsn;ILci;)V")
