...
public class class344 extends class499 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Lm;Lqa;B)V", line = 24)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(III)I", line = 253)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 291)
