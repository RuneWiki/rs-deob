...
public class class344 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(II)Lus;", line = 8)
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(II)V", line = 55)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ZI)V", line = 66)
    ...
    @OriginalMember(owner = "client!lm", name = "c", descriptor = "(II)V", line = 82)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lrb;IZLpc;Lpc;)V", line = 277)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(B)V", line = 152)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(BI)V", line = 177)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IIIII)V", line = 202)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IIZI)V", line = 221)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ZB)V", line = 238)
