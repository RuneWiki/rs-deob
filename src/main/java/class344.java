...
public class class344 extends class168 {
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(I)V", line = 138)
    public class344(int arg0) {
        this.field4349 = arg0;
    }

    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I)V", line = 146)
