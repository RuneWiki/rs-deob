...
public class class344 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(BLpc;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ILpc;)Ljava/lang/Object;", line = 34)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!ef", name = "b", descriptor = "(I)I", line = 101)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IB)V", line = 114)
    ...
    @OriginalMember(owner = "client!ef", name = "c", descriptor = "(I)V", line = 163)
    ...
    @OriginalMember(owner = "client!ef", name = "d", descriptor = "(I)I", line = 174)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lao;IBI)V", line = 189)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(B)V", line = 202)
    ...
    @OriginalMember(owner = "client!ef", name = "b", descriptor = "(IB)V", line = 241)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Ljava/lang/Object;ILpc;)V", line = 256)
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(I)V", line = 290)
