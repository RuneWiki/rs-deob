...
public class class344 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ILka;IIII)Lka;")
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ILib;)V")
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Lib;IB)V")
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIIBIBILka;)Lka;")
