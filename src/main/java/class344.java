...
public class class344 {
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(ILbda;III)V")
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(II)Laia;")
    ...
    @OriginalMember(owner = "client!afa", name = "<init>", descriptor = "(Lnb;ILoh;Loh;)V")
