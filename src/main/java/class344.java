...
public class class344 {
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(IIII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(Z)I", line = 154)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(B)V", line = 165)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(ZI)V", line = 190)
