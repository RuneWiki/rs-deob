...
public class class344 extends class305 {
    ...
    @OriginalMember(owner = "client!dj", name = "<init>", descriptor = "(ILhb;)V")
    public class344(int arg0, class728 arg1) {
        super(arg1);
    }

    @OriginalMember(owner = "client!dj", name = "<init>", descriptor = "(Lhb;)V")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IIBZI[Lsca;)V")
