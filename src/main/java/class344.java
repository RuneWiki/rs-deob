...
public class class344 extends class600 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIB)Z", line = 12)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(JZLr;II)V", line = 24)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ZLjava/awt/Canvas;)Lpba;", line = 287)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(I)V", line = 311)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(I)V", line = 351)
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(Lr;Lkw;Lhda;J)V", line = 412)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ILr;J)V", line = 368)
