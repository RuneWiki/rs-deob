...
public class class344 extends class266 {
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(Lpk;Lth;[Lgo;[I[I)V", line = 5)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(CIIIZLhb;II)V", line = 27)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "([B[I[IIIIIIIIIIILhb;II)V", line = 96)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "([B[I[IIIIIII)V", line = 184)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "([B[IIIIIIII)V", line = 245)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(CIIIZ)V", line = 303)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "([B[IIIIIIIIIIILhb;II)V", line = 364)
