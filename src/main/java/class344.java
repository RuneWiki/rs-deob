...
public class class344 extends class144 implements class57 {
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(Loa;I)Lew;", line = 4)
    ...
    @OriginalMember(owner = "client!ns", name = "e", descriptor = "(I)I", line = 19)
    ...
    @OriginalMember(owner = "client!ns", name = "e", descriptor = "(B)I", line = 36)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Loa;I)V", line = 47)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(I)I", line = 57)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(BLoa;)V", line = 71)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IILoa;I)Z", line = 99)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IBLoa;)Lba;", line = 121)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(I)Z", line = 143)
    ...
    @OriginalMember(owner = "client!ns", name = "d", descriptor = "(I)I", line = 154)
    ...
    @OriginalMember(owner = "client!ns", name = "f", descriptor = "(B)V", line = 167)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IIILva;Loa;ZI)V", line = 178)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(B)V", line = 213)
    ...
    @OriginalMember(owner = "client!ns", name = "f", descriptor = "(I)Z", line = 229)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Loa;Lqd;IIIIIZIIIIIIZ)V", line = 244)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ILoa;)V", line = 279)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ILjava/lang/String;)V", line = 316)
    ...
    @OriginalMember(owner = "client!ns", name = "c", descriptor = "(I)V", line = 329)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IZLoa;)Lba;", line = 343)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Z)I", line = 354)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Loa;B)Laca;", line = 366)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IILoa;Z)Llo;", line = 392)
