...
public class class344 extends class457 implements class526 {
    ...
    @OriginalMember(owner = "client!ku", name = "h", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(ILr;)Lcr;")
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(Lr;I)Lbca;")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Lvv;IIZLr;II)V")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IIILr;)Z")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IBLr;)Lda;")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(BLr;)V")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Lr;Z)V")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Lr;Ljs;IIIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(ZIBLr;)Lfh;")
