...
public class class344 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(Lug;)V", line = 5)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(Lug;)V", line = 13)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "()V", line = 29)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(I)I", line = 37)
    ...
    @OriginalMember(owner = "client!mi", name = "<init>", descriptor = "()V", line = 56)
    public class344() {
        this.field4600[0] = 0;
