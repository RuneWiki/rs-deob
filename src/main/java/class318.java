...
public abstract class class318 {
    ...
    @OriginalMember(owner = "client!qq", name = "c", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!qq", name = "d", descriptor = "(II)I")
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "(ILvl;)V")
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IIILvl;Lhf;Ljava/awt/Canvas;)Lqq;")
