...
public class class318 implements class392 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(I[IIJ)Ljava/lang/String;", line = 7)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(II)Lno;", line = 56)
