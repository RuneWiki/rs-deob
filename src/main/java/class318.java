...
public class class318 extends class354 {
    ...
    @OriginalMember(owner = "client!cd", name = "c", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IIZII)V", line = 17)
    ...
    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(B)I", line = 38)
    ...
    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(II)I", line = 52)
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(ILwo;)V", line = 76)
    public class318(int arg0, class746 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Lwo;)V", line = 102)
    public class318(class746 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!cd", name = "d", descriptor = "(I)Z", line = 105)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(B)I", line = 125)
    ...
    @OriginalMember(owner = "client!cd", name = "c", descriptor = "(II)V", line = 135)
