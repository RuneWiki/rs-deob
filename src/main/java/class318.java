...
public class class318 extends class685 {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "([BIBI)I", line = 3)
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!sc", name = "c", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 63)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(III[B)V", line = 77)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(II)Z", line = 87)
    ...
    @OriginalMember(owner = "client!sc", name = "finalize", descriptor = "()V", line = 98)
