...
public class class318 extends class395 {
    ...
    @OriginalMember(owner = "client!ul", name = "g", descriptor = "(I)Ljava/lang/Object;", line = 6)
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 15)
    public class318(Object arg0, int arg1) {
        super(arg1);
        this.field4322 = new SoftReference(arg0);
    }

    @OriginalMember(owner = "client!ul", name = "f", descriptor = "(I)Z", line = 24)
