...
public abstract class class318 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(I)[Lhn;", line = 6)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(Lkd;)V", line = 29)
