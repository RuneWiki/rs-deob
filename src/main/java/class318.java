...
public class class318 implements Runnable {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lhfa;I)V")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lkf;II[B)Lhfa;")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(BLkf;I)Lhfa;")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ILkf;Z)Lhfa;")
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lqj;)V")
