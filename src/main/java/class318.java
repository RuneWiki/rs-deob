...
public class class318 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(B)[Lmc;")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Ltl;B)V")
    ...
    @OriginalMember(owner = "client!mc", name = "<init>", descriptor = "(Lev;)V")
    ...
    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(I)Ltl;")
