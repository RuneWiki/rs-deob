...
public class class318 extends class456 {
    ...
    @OriginalMember(owner = "client!u", name = "b", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "()V", line = 25)
    public class318() {
        super(0, true);
    }

    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IBLre;)V", line = 29)
    ...
    @OriginalMember(owner = "client!u", name = "b", descriptor = "(II)[I", line = 98)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Z)V", line = 233)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IBLjava/util/Random;)I", line = 259)
