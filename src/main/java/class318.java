...
public class class318 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;)V", line = 45)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(III)V", line = 90)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(II)I", line = 103)
