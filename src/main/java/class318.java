...
public class class318 {
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(BLqa;I)Z", line = 13)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(III)V", line = 459)
