...
public abstract class class318 extends class498 {
    ...
    @OriginalMember(owner = "client!uq", name = "i", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!uq", name = "j", descriptor = "(I)I", line = 19)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(BII[Ltj;)I", line = 40)
