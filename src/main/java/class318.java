...
public class class318 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Luca;I)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Low;II)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lnfa;I)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Luca;)V")
