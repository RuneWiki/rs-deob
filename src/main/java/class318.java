...
public class class318 {
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(ILib;)V")
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(ILwca;)V")
    ...
    @OriginalMember(owner = "client!caa", name = "<init>", descriptor = "(Lib;)V")
