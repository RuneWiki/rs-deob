...
public class class318 extends class555 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(III)V", line = 49)
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "(Lhb;Lga;Lln;)V", line = 76)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ZI)V", line = 100)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!ki", name = "e", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Z)V", line = 151)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lot;BI)V", line = 168)
    ...
    @OriginalMember(owner = "client!ki", name = "c", descriptor = "(I)Z", line = 177)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ZZ)V", line = 188)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(B)V", line = 219)
