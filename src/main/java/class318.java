...
public class class318 {
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(II)Lpa;", line = 24)
    ...
    @OriginalMember(owner = "client!uea", name = "<init>", descriptor = "(Lsj;ILin;)V", line = 69)
