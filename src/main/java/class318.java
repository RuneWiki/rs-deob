...
public class class318 {
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(II)Lks;", line = 5)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Z)V", line = 53)
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(IB)V", line = 84)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ILjava/lang/String;ZI)Z", line = 98)
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Loq;ILbu;)V", line = 176)
