...
public class class318 extends class614 {
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(B)I", line = 13)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(III)V", line = 26)
    ...
    @OriginalMember(owner = "client!paa", name = "g", descriptor = "(I)[B", line = 83)
    ...
    @OriginalMember(owner = "client!paa", name = "c", descriptor = "(B)V", line = 105)
