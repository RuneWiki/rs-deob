...
public class class318 implements class284 {
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(B)J", line = 8)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Lrb;I)Z", line = 38)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(JB)Ljava/lang/String;", line = 79)
