...
public class class318 {
    ...
    @OriginalMember(owner = "client!mt", name = "b", descriptor = "(I)Ljp;", line = 15)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Lqs;Lqs;BLza;)V", line = 53)
    ...
    @OriginalMember(owner = "client!mt", name = "c", descriptor = "(I)Ljp;", line = 69)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "(Lbu;)V", line = 105)
