...
public class class318 implements class159 {
    ...
    @OriginalMember(owner = "client!vw", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(IB)Z", line = 15)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(IIIZFI)[I", line = 29)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(IIIFZI)[I", line = 40)
    ...
    @OriginalMember(owner = "client!vw", name = "b", descriptor = "(IB)Ltca;", line = 53)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(II)Lnw;", line = 70)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(IFIZBI)[F", line = 92)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(B)I", line = 102)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "([I[IIII)V", line = 139)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(I)I", line = 197)
    ...
    @OriginalMember(owner = "client!vw", name = "<init>", descriptor = "(Lcb;Lcb;Lcb;)V", line = 268)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 222)
