...
public abstract class class318 {
    ...
    @OriginalMember(owner = "client!rq", name = "finalize", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Lap;I[BIZ)V", line = 24)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Lap;ILjaclib/memory/Buffer;IZ)V", line = 43)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(II[B)V", line = 63)
