...
public class class318 {
    ...
    @OriginalMember(owner = "client!cb", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field4642++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(II)V", line = 26)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IBIILng;)V", line = 49)
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(B)V", line = 104)
