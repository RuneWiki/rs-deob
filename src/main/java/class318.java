...
public abstract class class318 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ILip;)V", line = 43)
    public static final void method1990(int arg0, class279 arg1) {
        class304.field4096[arg0] = arg1;
    }

    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lnh;I)[Ltr;", line = 48)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Z)V", line = 100)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ZZ)Z", line = 114)
