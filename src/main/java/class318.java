...
public class class318 extends class48 implements class297 {
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Llaa;Lqda;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(I[FLqda;IIIIII)V")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(ILqda;IBIIII[B)V")
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Llaa;Lqda;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Llaa;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Llaa;Lqda;Lns;II)V")
