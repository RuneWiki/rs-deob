...
public class class318 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 4)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(B)Ld;", line = 22)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "([SB[Ljava/lang/String;)V", line = 39)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(I)V", line = 57)
