...
public class class318 extends class210 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IILat;)V", line = 5)
    ...
    @OriginalMember(owner = "client!vc", name = "b", descriptor = "(II)V", line = 57)
    ...
    @OriginalMember(owner = "client!vc", name = "g", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "()V", line = 179)
    public class318() {
        super(0, true);
    }

    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(BI)I", line = 103)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IB)[I", line = 115)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(DB)V", line = 182)
