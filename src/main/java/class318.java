...
public class class318 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(ILha;IB)V", line = 5)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(ILud;B)V", line = 36)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(Lud;I)V", line = 59)
