...
public class class318 {
    ...
    @OriginalMember(owner = "client!nb", name = "toString", descriptor = "()Ljava/lang/String;", line = 7)
    public final String toString() {
        field4625++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 40)
