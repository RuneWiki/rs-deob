...
public class class318 {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(IB)Lds;", line = 3)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Lkb;III[Z)V", line = 32)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Loe;B)V", line = 62)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "(Ldn;ILr;)V", line = 274)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "([I[I[IILnh;)V", line = 171)
