...
public class class318 extends class143 implements class265 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Len;IZB)Lgi;", line = 10)
    ...
    @OriginalMember(owner = "client!vi", name = "c", descriptor = "(I)I", line = 40)
    ...
    @OriginalMember(owner = "client!vi", name = "i", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(BLen;)V", line = 67)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Len;II)Lmj;", line = 100)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IIIIII)V", line = 125)
    ...
    @OriginalMember(owner = "client!vi", name = "h", descriptor = "(I)I", line = 144)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Len;I)V", line = 158)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(BILen;)Lmj;", line = 173)
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(Len;Lnl;IIIIZIIIII)V", line = 184)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Len;B)V", line = 213)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IIZLen;)Z", line = 241)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(I)Z", line = 262)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(ILen;)Lir;", line = 299)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(I)I", line = 326)
    ...
    @OriginalMember(owner = "client!vi", name = "d", descriptor = "(I)I", line = 339)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(B)V", line = 350)
