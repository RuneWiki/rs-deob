...
public class class318 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IB)Lts;", line = 16)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(BI)V", line = 51)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIILgd;II)Liea;", line = 65)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Z)V", line = 105)
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(Ldd;ILpj;)V", line = 133)
    public class318(class647 arg0, int arg1, class132 arg2) {
        this.field4717 = arg2;
        this.field4717.method936(29, -117);
    }

    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(I)V", line = 151)
