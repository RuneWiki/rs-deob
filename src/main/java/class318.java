...
public abstract class class318 implements class621 {
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(FFFFIILaa;II)V")
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(FFFFFFLaa;II)V")
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(FFIILaa;II)V")
