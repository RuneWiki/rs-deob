...
public class class318 {
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(ILofa;)V", line = 10)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "([BI)Z", line = 56)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(III)Z", line = 105)
