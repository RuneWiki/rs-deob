...
public class class318 extends class71 {
    ...
    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "(Law;[Lat;)V")
    private class318(class67 arg0, class318[] arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "(Law;Lfd;IIII)V")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Llc;[Lat;)Lat;")
    ...
    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "(Law;)V")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(BIZ)Lr;")
