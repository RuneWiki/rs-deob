...
public class class318 extends class148 {
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(BZZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(II)[I", line = 36)
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "()V", line = 203)
    public class318() {
        super(0, true);
    }

    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(ILdh;I)V", line = 133)
    ...
    @OriginalMember(owner = "client!sj", name = "e", descriptor = "(I)V", line = 176)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IB)V", line = 189)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(Ljava/lang/String;II)I", line = 206)
