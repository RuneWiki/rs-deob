...
public class class369 extends class390 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ZLqa;)V")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ILoi;)V")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IILqa;ILkm;ILgm;I)V")
