...
public class class369 extends class419 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "([B[IIIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "([B[IIIIIIIIIIILua;II)V", line = 63)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(CIIIZLua;II)V", line = 158)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "([B[IIIIIIIIIIILua;II)V", line = 226)
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "(Lcb;Lgda;[Lpga;[I[I)V", line = 311)
    ...
    @OriginalMember(owner = "client!je", name = "OA", descriptor = "(CIIIZ)V", line = 331)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "([B[IIIIIIII)V", line = 395)
