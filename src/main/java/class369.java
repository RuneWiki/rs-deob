...
public abstract class class369 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!nm", name = "b", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!nm", name = "c", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(Lmj;)V", line = 67)
    public class369(class344 arg0) {
        this.field5047 = arg0;
    }

    @OriginalMember(owner = "client!nm", name = "d", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!nm", name = "d", descriptor = "(I)V", line = 88)
