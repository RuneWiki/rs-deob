...
public class class369 extends class550 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(ZJ)I", line = 3)
    ...
    @OriginalMember(owner = "client!po", name = "d", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(I)J", line = 52)
    ...
    @OriginalMember(owner = "client!po", name = "c", descriptor = "(B)J", line = 86)
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(B)J", line = 107)
