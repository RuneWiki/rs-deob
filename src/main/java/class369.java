...
public class class369 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(ZLae;)V", line = 3)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(III)I", line = 24)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lae;II)V", line = 38)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IB)V", line = 89)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IILhe;I)Luj;", line = 125)
