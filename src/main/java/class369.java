...
public class class369 extends class123 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Lae;IILnc;III[[[B[I[I[I[I[IIBIIZ)V")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(BII)Luc;")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ILdg;)V")
