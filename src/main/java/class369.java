...
public class class369 {
    ...
    @OriginalMember(owner = "client!ak", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IILae;II)V", line = 43)
