...
public class class369 extends class161 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Luf;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "([Lpfa;)V", line = 49)
