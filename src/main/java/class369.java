...
public class class369 extends class649 {
    ...
    @OriginalMember(owner = "client!tha", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!tha", name = "c", descriptor = "(I)Z", line = 16)
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(II)I", line = 33)
    ...
    @OriginalMember(owner = "client!tha", name = "<init>", descriptor = "(Lhs;)V", line = 48)
    public class369(class358 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(IB)V", line = 55)
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(IIIIIII)V", line = 66)
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(I)I", line = 92)
    ...
    @OriginalMember(owner = "client!tha", name = "<init>", descriptor = "(ILhs;)V", line = 105)
    public class369(int arg0, class358 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!tha", name = "d", descriptor = "(I)I", line = 108)
