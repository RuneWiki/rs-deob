...
public class class369 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ILbs;ILvt;I)V")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(II)Lvk;")
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(IILok;)V")
