...
public class class369 {
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(B)Lff;")
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Z)Lff;")
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Lff;I)V")
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(III)Let;")
    ...
    @OriginalMember(owner = "client!rp", name = "c", descriptor = "(Z)Lff;")
