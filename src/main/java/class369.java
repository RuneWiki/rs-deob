...
public class class369 {
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(Z)Z", line = 10)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!qba", name = "b", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(J[BB)V", line = 257)
    ...
    @OriginalMember(owner = "client!qba", name = "c", descriptor = "(I)V", line = 344)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(IB[B)V", line = 384)
