...
public class class369 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lgw;I)V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IBLgw;)V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(BLlp;Ljava/lang/Object;)V")
