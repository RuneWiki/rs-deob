...
public abstract class class369 extends class42 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(B)F", line = 13)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(I)I", line = 25)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Z)I", line = 35)
    public final int method2260(boolean arg0) {
        field5334++;
        return arg0 ? this.field5324 : 92;
    }

    @OriginalMember(owner = "client!ni", name = "d", descriptor = "(B)I", line = 48)
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "(IIIIIF)V", line = 61)
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(I)I", line = 75)
    ...
    @OriginalMember(owner = "client!ni", name = "e", descriptor = "(B)V", line = 87)
    ...
    @OriginalMember(owner = "client!ni", name = "f", descriptor = "(B)I", line = 100)
