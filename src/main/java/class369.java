...
public class class369 extends class321 {
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(ZLeda;Leda;BI)I", line = 15)
    ...
    @OriginalMember(owner = "client!rr", name = "d", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(BIZI)I", line = 126)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(Lgk;BI)V", line = 150)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(II)V", line = 178)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(ILgk;)V", line = 188)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(Lu;I)I", line = 209)
