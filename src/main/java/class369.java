...
public class class369 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(II)I", line = 27)
    ...
    @OriginalMember(owner = "client!tu", name = "toString", descriptor = "()Ljava/lang/String;", line = 77)
    public final String toString() {
        field4591++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "(I)V", line = 86)
    public class369(int arg0) {
        this.field4593 = arg0;
    }

    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Z)V", line = 94)
