...
public class class369 extends class316 {
    ...
    @OriginalMember(owner = "client!fd", name = "B", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "([B[IIIIIIIIIIILta;II)V")
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "([B[IIIIIIIIIIILta;II)V")
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(CIIIZLta;II)V")
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "(Lcd;Lgf;[Lev;[I[I)V")
