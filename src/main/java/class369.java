...
public class class369 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIII)I", line = 12)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(CII)I", line = 28)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(BI)V", line = 52)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IZ)Lpp;", line = 66)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(II)V", line = 103)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!ao", name = "c", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Loda;ILdda;Ldda;)V", line = 186)
