...
public class class369 extends class43 {
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ek", name = "c", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IIII)I", line = 75)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IZ)V", line = 93)
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "()V", line = 189)
    public class369() {
    }

    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "(I)V", line = 191)
