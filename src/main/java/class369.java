...
public class class369 extends class747 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Ldc;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "()V", line = 40)
    public class369() {
        super(2, false);
    }

    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(II)[[I", line = 43)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(II)[I", line = 357)
