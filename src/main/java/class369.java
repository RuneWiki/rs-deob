...
public class class369 implements class318 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(BI)I", line = 69)
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(III)V", line = 80)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IILza;)Z", line = 103)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lfh;B)V", line = 517)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IIZ)V", line = 561)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IZI)V", line = 589)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(BZ)I", line = 614)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ILza;)V", line = 654)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(II)I", line = 858)
