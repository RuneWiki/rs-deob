...
public class class369 extends class502 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(II[F)[F", line = 5)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(I[BIBII)V", line = 17)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(ILeh;)Loi;", line = 48)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(Ldw;IIIII)V", line = 95)
