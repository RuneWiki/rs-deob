...
public class class369 extends class143 {
    ...
    @OriginalMember(owner = "client!qba", name = "c", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!qba", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 232)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(IIIZ[I)Z", line = 58)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(I[III)Z", line = 86)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(IIZ)Z", line = 112)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(BLek;)Lom;", line = 159)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "([IIII)Z", line = 185)
