...
public class class369 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lhj;Lhj;)Z")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lhj;Lge;FFFFFFFF)Z")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lhj;)Z")
    public final boolean method2303(class106 arg0) {
        return this.method2304(arg0, 8, 8.0F, 8.0F, 8.0F, 2.0F, 2.0F, 2.0F, 0.5F, 0.5F);
    }

    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lhj;IFFFFFFFF)Z")
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(Lhd;)V")
