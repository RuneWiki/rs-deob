...
public class class369 extends class506 implements class248 {
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(B)I", line = 7)
    public final int method19(byte arg0) {
        ++field5595;
        return arg0 != -69 ? -45 : this.field5584.field2192;
    }

    @OriginalMember(owner = "client!e", name = "b", descriptor = "(B)I", line = 28)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(ZLqa;)Lae;", line = 40)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(ILqa;)V", line = 78)
    ...
    @OriginalMember(owner = "client!e", name = "b", descriptor = "(I)I", line = 89)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(Lqa;II)Lc;", line = 100)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(IIII)V", line = 111)
    ...
    @OriginalMember(owner = "client!e", name = "e", descriptor = "(B)V", line = 191)
    ...
    @OriginalMember(owner = "client!e", name = "<init>", descriptor = "(Lqa;Lgm;IIIIIZIIIIII)V", line = 205)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(I)Z", line = 214)
    public final boolean method8(int arg0) {
        ++field5573;
        return arg0 < 94 ? true : this.field5584.method1034(15361);
    }

    @OriginalMember(owner = "client!e", name = "a", descriptor = "(BLqa;)V", line = 225)
    ...
    @OriginalMember(owner = "client!e", name = "c", descriptor = "(I)V", line = 247)
    public final void method26(int arg0) {
        ++field5587;
        int var2 = 91 % ((-46 - arg0) / 44);
    }

    @OriginalMember(owner = "client!e", name = "a", descriptor = "(ILqa;II)Z", line = 258)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(Lqa;I)V", line = 276)
    ...
    @OriginalMember(owner = "client!e", name = "c", descriptor = "(Z)V", line = 294)
    ...
    @OriginalMember(owner = "client!e", name = "d", descriptor = "(I)I", line = 310)
