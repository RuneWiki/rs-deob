...
public class class369 extends class292 {
    ...
    @OriginalMember(owner = "client!mt", name = "d", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 12)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "()V", line = 34)
    ...
    @OriginalMember(owner = "client!mt", name = "b", descriptor = "()I", line = 48)
    public final int method1754() {
        return this.field4767 - (this.field4763.available() >> (class487.field6095 ? 2 : 1));
    }

    @OriginalMember(owner = "client!mt", name = "c", descriptor = "()V", line = 56)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 76)
    ...
    @OriginalMember(owner = "client!mt", name = "d", descriptor = "()V", line = 115)
