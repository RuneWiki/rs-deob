...
public abstract class class369 {
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(I)I", line = 26)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Ljc;B)Lrea;", line = 173)
