...
public class class369 extends class270 {
    ...
    @OriginalMember(owner = "client!al", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "()V", line = 20)
    public class369() {
        super(0, true);
    }

    @OriginalMember(owner = "client!al", name = "c", descriptor = "(III)I", line = 24)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Lec;I)V", line = 38)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(BZZ)V", line = 86)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 109)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(BI)[I", line = 119)
