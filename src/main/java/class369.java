...
public class class369 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lac;I)Lss;", line = 14)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(I)Ldf;", line = 33)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IIII)Lns;", line = 58)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(IIIIB)V", line = 70)
