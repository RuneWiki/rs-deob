...
public class class369 extends class450 implements class220 {
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(Lqi;I[BI)V")
    public class369(class458 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field5230 = arg1;
    }

    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Luk;)V")
    ...
    @OriginalMember(owner = "client!td", name = "c", descriptor = "(Luk;)V")
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(Lqi;ILjava/nio/ByteBuffer;)V")
    public class369(class458 arg0, int arg1, ByteBuffer arg2) {
        super(arg0, arg2);
        this.field5230 = arg1;
    }

    @OriginalMember(owner = "client!td", name = "b", descriptor = "(Luk;)V")
    ...
    @OriginalMember(owner = "client!td", name = "d", descriptor = "(Luk;)V")
