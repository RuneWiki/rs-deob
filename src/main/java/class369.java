...
public abstract class class369 extends class235 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ZZ)Z", line = 7)
    public static boolean method2433(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!wr", name = "e", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lo;Lo;I)V", line = 41)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(BLjava/lang/String;C)[Ljava/lang/String;", line = 59)
