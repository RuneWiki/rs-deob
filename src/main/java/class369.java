...
public class class369 {
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(IZLcr;Lcr;I)Llda;", line = 6)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Lmc;I)Lwja;", line = 46)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Ljava/lang/String;IBLjava/lang/String;)V", line = 106)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(ILcr;ILcr;)Llda;", line = 119)
    ...
    @OriginalMember(owner = "client!mda", name = "b", descriptor = "(B)Z", line = 130)
    ...
    @OriginalMember(owner = "client!mda", name = "<init>", descriptor = "(Lqv;Lhh;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", line = 210)
