...
public class class582 {
    ...
    @OriginalMember(owner = "client!ht", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field7632++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(Lha;II)Lrc;", line = 23)
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "(II)V", line = 53)
