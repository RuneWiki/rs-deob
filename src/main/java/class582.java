...
public class class582 extends class108 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(B[B)Z", line = 6)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IIIIIIIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!ri", name = "<init>", descriptor = "([B)V", line = 104)
    public class582(byte[] arg0) {
        this.field8304 = arg0;
    }

    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(II)I", line = 116)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IB)Z", line = 127)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(BLjava/awt/Canvas;Ln;)Lqa;", line = 140)
