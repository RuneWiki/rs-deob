...
public class class582 extends class345 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ZB)V", line = 34)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IIILvl;B)V", line = 61)
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(Lbi;)V", line = 227)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ZLrl;I)V", line = 344)
    ...
    @OriginalMember(owner = "client!gu", name = "c", descriptor = "(I)V", line = 492)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ZII)V", line = 527)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Lii;Z)Z", line = 547)
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(B)V", line = 672)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ZI)V", line = 707)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(I)Z", line = 719)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IILcj;)V", line = 730)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Z)V", line = 743)
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(Z)V", line = 754)
    ...
    @OriginalMember(owner = "client!gu", name = "c", descriptor = "(B)V", line = 773)
