...
public class class582 extends class748 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IZLvj;)V", line = 5)
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "()V", line = 40)
    public class582() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(II)[[I", line = 57)
    ...
    @OriginalMember(owner = "client!ff", name = "g", descriptor = "(I)Lpl;", line = 126)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(II)[I", line = 144)
