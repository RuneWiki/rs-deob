...
public class class582 extends class143 {
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(Lnea;IZIII[IIIIIIII[I)I", line = 8)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(IIIIIIBII)V", line = 187)
    ...
    @OriginalMember(owner = "client!jca", name = "b", descriptor = "(III)Z", line = 230)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(I)I", line = 242)
    public static final int method3370(int arg0) {
        field8516++;
        return arg0 == -1 ? class199.method1396(true, false) : 119;
    }

    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "(Liq;)V", line = 255)
