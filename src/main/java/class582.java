...
public class class582 extends class385 implements class324 {
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 4)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(Z)I", line = 14)
    public final int method944(boolean arg0) {
        return arg0 ? this.field7737 : 110;
    }

    @OriginalMember(owner = "client!sk", name = "<init>", descriptor = "(Lss;Lhi;Lne;II)V", line = 24)
    ...
    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(B)I", line = 45)
    public final int method939(byte arg0) {
        int var2 = 19 / ((arg0 - 26) / 33);
        return this.field7734;
    }

    @OriginalMember(owner = "client!sk", name = "<init>", descriptor = "(Lss;IIZ[III)V", line = 52)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(B)Z", line = 110)
    public final boolean method946(byte arg0) {
        int var2 = -47 % ((69 - arg0) / 48);
        return true;
    }

    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IIIIIII[I)V", line = 118)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IF)F", line = 157)
    public final float method948(int arg0, float arg1) {
        return arg0 == 22051 ? arg1 / (float) this.field7737 : -0.0029653173F;
    }

    @OriginalMember(owner = "client!sk", name = "<init>", descriptor = "(Lss;Lhi;IIZ[BII)V", line = 168)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(FZ)F", line = 226)
    ...
    @OriginalMember(owner = "client!sk", name = "c", descriptor = "(B)V", line = 236)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IBII[BLhi;III)V", line = 247)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(Lcba;I)V", line = 289)
    public final void method166(class516 arg0, int arg1) {
        super.method166(arg0, arg1);
    }

    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(BZZ)V", line = 296)
