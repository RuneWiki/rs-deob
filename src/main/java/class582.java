...
public class class582 {
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!kga", name = "b", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(IZ)Ltw;", line = 34)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(IILha;B)V", line = 67)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(II)V", line = 99)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(Lsv;BLjf;)Lvi;", line = 115)
    ...
    @OriginalMember(owner = "client!kga", name = "<init>", descriptor = "(Lmca;ILgga;)V", line = 156)
