...
public class class582 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(I)Lwda;")
    ...
    @OriginalMember(owner = "client!qf", name = "c", descriptor = "(I)Lwda;")
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(Lpt;)V")
