...
public class class582 implements class134 {
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(I)Z", line = 10)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(BZ)V", line = 34)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(Lvo;)V", line = 68)
    public class582(class39 arg0) {
        this.field8476 = arg0;
    }

    @OriginalMember(owner = "client!sn", name = "c", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ZII)Ljava/lang/String;", line = 116)
