...
public class class582 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(BI)Ltt;", line = 14)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(BI)Lin;", line = 58)
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(II)V", line = 95)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(B)V", line = 118)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lci;ILsea;Lsea;)V", line = 137)
