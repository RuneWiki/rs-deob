...
public class class582 extends class331 {
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "(ILts;)V", line = 5)
    public class582(int arg0, class41 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Lgaa;I)V", line = 9)
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "(Lts;)V", line = 36)
    public class582(class41 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!fs", name = "c", descriptor = "(II)V", line = 64)
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(B)I", line = 82)
    ...
    @OriginalMember(owner = "client!fs", name = "c", descriptor = "(B)I", line = 94)
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(II)I", line = 108)
