...
public class class582 extends class263 {
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IIB)Z", line = 4)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!sk", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 54)
