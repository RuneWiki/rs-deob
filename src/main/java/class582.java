...
public class class582 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Les;B)V", line = 32)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IIILka;IB)Lka;", line = 52)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IZIZ)I", line = 192)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IIIBIILka;Z)Lka;", line = 330)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IZLes;)V", line = 390)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 599)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(B)V", line = 625)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Lqh;B)V", line = 669)
