...
public class class582 extends class142 implements class309 {
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Lgv;I)V")
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "(Lmba;Lpw;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "(Lmba;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "(Lmba;Lpw;Llj;II)V")
    ...
    @OriginalMember(owner = "client!ab", name = "c", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;")
    public final IDirect3DBaseTexture method1070(byte arg0) {
        return arg0 == -72 ? this.field7916 : (IDirect3DBaseTexture) null;
    }

    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(ILpw;I[BIIIII)V")
