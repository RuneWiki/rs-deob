...
public abstract class class190 extends class198 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ZLmj;)V", line = 14)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ILqa;IIZLse;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(I[Lwca;B)V", line = 42)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IZIIIII)V", line = 119)
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(Z)Z", line = 149)
    public final boolean method167(boolean arg0) {
        field2891++;
        return !arg0;
    }

    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(B)V", line = 160)
