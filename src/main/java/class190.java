...
public class class190 extends class254 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lya;J[Lqc;[Lpd;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(I)V", line = 331)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lya;J)Z", line = 16)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IIIII)V", line = 65)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "()V", line = 76)
    public static void method1191() {
        field2736 = null;
        field2730 = null;
    }

    @OriginalMember(owner = "client!bq", name = "b", descriptor = "()V", line = 81)
    public final void method1192() {
        this.field2739 = true;
    }

    @OriginalMember(owner = "client!bq", name = "c", descriptor = "()Lpn;", line = 84)
    public final class523 method1193() {
        return this.field2742;
    }

    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(J)V", line = 87)
    public final void method1194(long arg0) {
        this.field2734 = arg0;
    }

    @OriginalMember(owner = "client!bq", name = "d", descriptor = "()V", line = 93)
    private final void method1195() {
        this.field2728 = false;
    }

    @OriginalMember(owner = "client!bq", name = "e", descriptor = "()V", line = 96)
    ...
    @OriginalMember(owner = "client!bq", name = "f", descriptor = "()V", line = 117)
    public final void method1197() {
        this.field2728 = true;
    }

    @OriginalMember(owner = "client!bq", name = "g", descriptor = "()V", line = 120)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lya;[Lqc;Z)V", line = 134)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "([Lpd;Z)V", line = 209)
