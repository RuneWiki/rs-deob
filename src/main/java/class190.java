...
public class class190 extends class216 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(I[BILnf;IIIZ)Ldh;")
    ...
    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(Lnf;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IIIIILnf;)Ldh;")
    ...
    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(Lnf;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(Lnf;IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(Lnf;IIII[I)V")
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(II[IZBLnf;)Ldh;")
    ...
    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(Lnf;IIIZ[I)V")
    ...
    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(Lnf;IIIII[BI)V")
