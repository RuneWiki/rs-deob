...
public class class190 extends class47 {
    ...
    @OriginalMember(owner = "client!ff", name = "d", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!ff", name = "d", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IIIII)Z", line = 89)
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "(Llh;Lan;)V", line = 110)
