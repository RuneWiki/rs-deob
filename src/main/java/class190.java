...
public abstract class class190 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Ljj;[IZ[III)Len;", line = 22)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Ljj;)V", line = 57)
