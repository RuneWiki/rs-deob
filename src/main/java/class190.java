...
public class class190 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lga;ILhg;I)V", line = 10)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Ljava/lang/String;B)J", line = 77)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(B)V", line = 99)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(JIIIILat;IILaa;)V", line = 110)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(ZLad;Lcea;)Laf;", line = 169)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lcea;I)V", line = 216)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(CI)C", line = 241)
