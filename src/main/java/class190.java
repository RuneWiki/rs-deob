...
public class class190 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(III)Lgb;")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IILsa;IBLpe;Lsa;Z[[I[[B[[B[[B[[B)V")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ILap;B)V")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Z)Lu;")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IILap;I)V")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(I[BZZII[Loa;IILpe;II)[I")
