...
public class class190 extends class134 {
    ...
    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "(ILkda;)V")
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IZI)Lbc;")
    ...
    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "(Lkda;)V")
