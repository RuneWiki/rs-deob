...
public class class190 extends class149 {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(BIZZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(ZIIIII)V", line = 233)
    ...
    @OriginalMember(owner = "client!ae", name = "e", descriptor = "(I)V", line = 378)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IIIIIII)V", line = 394)
    ...
    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "()V", line = 423)
    public class190() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IZZII)Lns;", line = 426)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(II)[I", line = 460)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IBLtl;)V", line = 500)
