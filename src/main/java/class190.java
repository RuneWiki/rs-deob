...
public class class190 extends class266 {
    ...
    @OriginalMember(owner = "client!rea", name = "<init>", descriptor = "(Lgj;)V")
    public class190(class580 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(Lek;IB)V")
    ...
    @OriginalMember(owner = "client!rea", name = "b", descriptor = "(IZ)V")
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(Loa;ILfaa;II)V")
