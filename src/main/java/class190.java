...
public abstract class class190 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Ljg;I)V")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIBLeb;IZI)V")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(I[Lo;)V")
