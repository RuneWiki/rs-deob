...
public class class190 implements class334 {
    ...
    @OriginalMember(owner = "client!ne", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lkha;Lkha;Lkha;ILkha;)V", line = 46)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IZ)V", line = 75)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Z)I", line = 100)
    public final int method238(boolean arg0) {
        field2490++;
        return arg0 ? -53 : this.field2494.field1241;
    }

    @OriginalMember(owner = "client!ne", name = "c", descriptor = "(I)I", line = 115)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IJ)Z", line = 143)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lha;IIIIIII)V", line = 155)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "([[BBLtha;)V", line = 173)
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(Ljha;Lnm;)V", line = 250)
