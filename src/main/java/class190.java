...
public class class190 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ILkf;Lpf;I[Luga;ILha;Lbk;Ljv;ILpf;ZIILob;Lib;I[ILnj;II)Lka;")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IILib;IILjv;Lpf;Lha;IIII)Lka;")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ILnj;II)V")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I[Lfn;IIZ[I[I)V")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lib;III)V")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ILjv;Lbk;Lnj;Lob;Lha;IIBLib;ILpf;)Lka;")
