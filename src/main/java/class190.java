...
public class class190 {
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(I[BB)V", line = 5)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(J[BI)V", line = 81)
    ...
    @OriginalMember(owner = "client!mfa", name = "b", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!mfa", name = "c", descriptor = "(I)V", line = 227)
