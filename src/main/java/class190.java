...
public abstract class class190 {
    ...
    @OriginalMember(owner = "client!vt", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "(IIIII)V", line = 280)
    ...
    @OriginalMember(owner = "client!vt", name = "c", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(BIII)V", line = 74)
    ...
    @OriginalMember(owner = "client!vt", name = "d", descriptor = "(I)V", line = 258)
