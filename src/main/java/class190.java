...
public abstract class class190 extends class27 {
    ...
    @OriginalMember(owner = "client!ia", name = "e", descriptor = "(B)[Lfn;")
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "([Lqea;B)I")
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Llr;ZZIBILlr;)I")
