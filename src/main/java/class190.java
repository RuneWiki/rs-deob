...
public class class190 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(III)Z", line = 16)
    ...
    @OriginalMember(owner = "client!hh", name = "finalize", descriptor = "()V", line = 27)
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "(Lpq;JI)V", line = 46)
