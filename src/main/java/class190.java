...
public class class190 extends class50 implements class425 {
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(Lza;Z)V")
    ...
    @OriginalMember(owner = "client!uu", name = "b", descriptor = "(Lza;I)Lnd;")
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(ZIILza;)Lrn;")
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(IBILvs;Lza;ZI)V")
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(ILza;I)Le;")
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(ZLza;II)Z")
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(IBLza;)Le;")
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!uu", name = "<init>", descriptor = "(Lza;Ljc;IIIIZIIZ)V")
