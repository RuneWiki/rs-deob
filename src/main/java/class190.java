...
public class class190 extends class272 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!fq", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ZIZLcd;)V", line = 48)
