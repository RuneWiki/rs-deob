...
public class class190 extends class377 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(I)Z", line = 6)
    public final boolean method1060(int arg0) {
        int var2 = -83 / ((arg0 + 68) / 57);
        return true;
    }

    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 13)
    public class190(Object arg0, int arg1) {
        super(arg1);
        this.field2484 = new SoftReference(arg0);
    }

    @OriginalMember(owner = "client!fh", name = "d", descriptor = "(B)Ljava/lang/Object;", line = 22)
