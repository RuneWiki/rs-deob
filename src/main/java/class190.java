...
public class class190 extends class35 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IC)Z", line = 6)
    ...
    @OriginalMember(owner = "client!dn", name = "d", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "(II)V", line = 42)
