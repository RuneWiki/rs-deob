...
public class class190 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Lkb;B)V")
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IILbr;IIIILsg;I)V")
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IILkb;)V")
