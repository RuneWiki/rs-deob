...
public class class190 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IB)Lsp;", line = 16)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Z[[[BIBIIZ)V", line = 50)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(B)V", line = 351)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(II[BFFFFIIILoia;IF)V", line = 361)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(I)V", line = 387)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(II)V", line = 402)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(Lqg;ILvd;)V", line = 427)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Ljava/lang/String;B)Ljava/lang/String;", line = 445)
