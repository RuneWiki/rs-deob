...
public class class190 {
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(BLvg;I)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(ILhea;I)V", line = 36)
    ...
    @OriginalMember(owner = "client!rea", name = "<init>", descriptor = "(Lhea;)V", line = 708)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(IBI)Z", line = 426)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(ZLhea;)V", line = 437)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(I)V", line = 453)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(ILhea;)V", line = 464)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(IBLvi;Lhea;)V", line = 482)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(IILhea;)V", line = 647)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(BLhea;)V", line = 666)
    ...
    @OriginalMember(owner = "client!rea", name = "b", descriptor = "(I)V", line = 682)
