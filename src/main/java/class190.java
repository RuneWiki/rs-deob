...
public class class190 implements class314 {
    ...
    @OriginalMember(owner = "client!cw", name = "c", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(I)J", line = 49)
    ...
    @OriginalMember(owner = "client!cw", name = "b", descriptor = "(I)[Lpf;", line = 79)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(B)V", line = 166)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(B[B)Lkca;", line = 179)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(ILrv;IILip;)V", line = 283)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(III)I", line = 651)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(Lnba;Z)Z", line = 685)
