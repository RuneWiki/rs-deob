...
public class class190 extends class187 {
    ...
    @OriginalMember(owner = "client!dca", name = "<init>", descriptor = "(Lhk;)V", line = 3)
    ...
    @OriginalMember(owner = "client!dca", name = "d", descriptor = "(I)V", line = 116)
    public static void method1395(int arg0) {
        int var1 = 23 / ((arg0 - 32) / 45);
        field2925 = null;
    }

    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(IZ)V", line = 125)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(I)Z", line = 137)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(Z)V", line = 153)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(IZI)V", line = 182)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(IBLqk;)V", line = 201)
    ...
    @OriginalMember(owner = "client!dca", name = "c", descriptor = "(Z)V", line = 214)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(ZB)V", line = 284)
