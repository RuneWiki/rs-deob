...
public abstract class class190 {
    ...
    @OriginalMember(owner = "client!uf", name = "c", descriptor = "Llf;")
    private static class109 field3643 = class35.method275("You are standing in a members)2only area)3", 2);

    @OriginalMember(owner = "client!uf", name = "e", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IB)Ltd;")
