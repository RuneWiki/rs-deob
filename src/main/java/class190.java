...
public class class190 extends class76 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lza;III)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ko", name = "c", descriptor = "(B)Z", line = 16)
    public final boolean method107(byte arg0) {
        ++field2893;
        return arg0 != -88;
    }

    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IZJII)Ljava/lang/String;", line = 27)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(B)Lsg;", line = 104)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILza;II)Le;", line = 127)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(BI)V", line = 148)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(ILza;)Lhp;", line = 180)
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 213)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(I)V", line = 244)
    ...
    @OriginalMember(owner = "client!ko", name = "d", descriptor = "(I)V", line = 257)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(BLza;Le;)V", line = 267)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILza;)V", line = 291)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Z)I", line = 319)
    ...
    @OriginalMember(owner = "client!ko", name = "finalize", descriptor = "()V", line = 339)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(I)V", line = 354)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lfi;IBI)V", line = 373)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lza;IIILps;IZ)V", line = 461)
