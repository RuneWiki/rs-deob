...
public abstract class class190 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ZZLki;)V", line = 19)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IIIII)V", line = 166)
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(B)V", line = 203)
