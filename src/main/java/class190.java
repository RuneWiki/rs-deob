...
public class class190 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(III)I", line = 10)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "()V", line = 34)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(II)[I", line = 55)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lgk;)V", line = 346)
