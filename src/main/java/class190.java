...
public class class190 extends class613 {
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!ov", name = "b", descriptor = "()Llea;", line = 452)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "([ILgga;IIII)V", line = 472)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "([III)V", line = 536)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(I)V", line = 575)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(II[BI)Ljava/lang/String;", line = 610)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(ILgga;I)V", line = 651)
    ...
    @OriginalMember(owner = "client!ov", name = "b", descriptor = "(I)V", line = 689)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "()Llea;", line = 708)
    ...
    @OriginalMember(owner = "client!ov", name = "<init>", descriptor = "(Lcea;)V", line = 745)
    public class190(class216 arg0) {
        this.field2621 = arg0;
    }

    @OriginalMember(owner = "client!ov", name = "d", descriptor = "()I", line = 731)
