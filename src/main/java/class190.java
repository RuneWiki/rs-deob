...
public class class190 implements Runnable {
    ...
    @OriginalMember(owner = "client!uja", name = "a", descriptor = "(ILdf;)V")
    ...
    @OriginalMember(owner = "client!uja", name = "a", descriptor = "(JLob;IILjava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!uja", name = "c", descriptor = "(I)Lob;")
    ...
    @OriginalMember(owner = "client!uja", name = "a", descriptor = "(II)Laca;")
