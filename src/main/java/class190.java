...
public class class190 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(IIIIBIIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(B)V", line = 92)
    public static void method1222(byte arg0) {
        int var1 = 62 % ((19 - arg0) / 36);
        field2473 = null;
    }

    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(I)Lun;", line = 101)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(BI)Lpp;", line = 112)
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(II)V", line = 127)
    public class190(int arg0, int arg1) {
        this.field2482 = arg0;
        this.field2477 = arg1;
    }

    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(Lpp;I)V", line = 135)
