...
public class class190 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IBLrg;I)V")
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Lcn;I)V")
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Laa;IILci;III[[[B[I[I[I[I[IIBIIZ)V")
