...
public abstract class class190 {
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ol", name = "<init>", descriptor = "(IIIII)V", line = 283)
    ...
    @OriginalMember(owner = "client!ol", name = "c", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IIII)V", line = 114)
