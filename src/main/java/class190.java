...
public class class190 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "([BI)Lpe;", line = 17)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Lbb;ILuo;IZ)V", line = 98)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ILjava/lang/String;ZLak;)V", line = 136)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Lwo;I)V", line = 173)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ILwo;)V", line = 187)
