...
public class class190 extends class192 {
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(IB)[I", line = 5)
    ...
    @OriginalMember(owner = "client!mfa", name = "c", descriptor = "(B)V", line = 262)
    ...
    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "()V", line = 695)
    public class190() {
        super(0, true);
    }

    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(IIIIILjava/util/Random;[[I)V", line = 277)
    ...
    @OriginalMember(owner = "client!mfa", name = "c", descriptor = "(I)V", line = 474)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(IIILtc;ILoa;IILfa;)V", line = 496)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(ILfd;I)V", line = 599)
