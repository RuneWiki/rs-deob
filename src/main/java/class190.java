...
public class class190 extends class642 {
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!mfa", name = "b", descriptor = "(B)Z", line = 16)
    ...
    @OriginalMember(owner = "client!mfa", name = "b", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "()V", line = 55)
    public class190() {
        super(0, false);
    }

    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(II)[[I", line = 62)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(ILgk;B)V", line = 129)
