...
public class Pix8 extends Draw2D {
    ...
    public void method198(int arg0, int arg1, int arg2) {
        ...
        int var7 = Draw2D.field615 * var5 + var4;
        int var8 = 0;
        ...
        if (var5 < Draw2D.field617) {
            int var13 = Draw2D.field617 - var5;
            var9 -= var13;
            var5 = Draw2D.field617;
            var8 += var10 * var13;
            var7 += Draw2D.field615 * var13;
        }
        if (var5 + var9 > Draw2D.field618) {
            var9 -= var5 + var9 - Draw2D.field618;
        }
        if (var4 < Draw2D.field619) {
            int var14 = Draw2D.field619 - var4;
            var10 -= var14;
        ...
        if (var4 + var10 > Draw2D.field620) {
            int var15 = var4 + var10 - Draw2D.field620;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method199(this.field669, (byte) -84, Draw2D.field614, var10, this.field670, var11, var8, var7, var9, var12);
        }
    }
