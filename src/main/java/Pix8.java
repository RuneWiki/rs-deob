...
public class Pix8 extends Draw2D {
    ...
    public void method211(int arg0, int arg1, int arg2) {
        ...
        if (var5 < Draw2D.field633) {
            int var13 = Draw2D.field633 - var5;
            var9 -= var13;
            var5 = Draw2D.field633;
            var7 += var10 * var13;
            var6 += Draw2D.field631 * var13;
        }
        if (var5 + var9 > Draw2D.field634) {
            var9 -= var5 + var9 - Draw2D.field634;
        }
        if (var4 < Draw2D.field635) {
            int var14 = Draw2D.field635 - var4;
            var10 -= var14;
        ...
        if (var4 + var10 > Draw2D.field636) {
            int var15 = var4 + var10 - Draw2D.field636;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method212(this.field683, var9, this.field682, Draw2D.field630, 68, var12, var6, var7, var10, var11);
        }
    }
