...
public class Pix8 extends Draw2D {
    ...
    public void method198(int arg0, byte arg1, int arg2) {
        ...
        int var8 = Draw2D.field621 * var7 + var4;
        int var9 = 0;
        ...
        if (var4 < Draw2D.field625) {
            int var15 = Draw2D.field625 - var4;
            var11 -= var15;
        ...
        if (var4 + var11 > Draw2D.field626) {
            int var16 = var4 + var11 - Draw2D.field626;
            var11 -= var16;
            var13 += var16;
            var12 += var16;
        }
        if (var11 > 0 && var10 > 0) {
            this.method199(Draw2D.field620, var8, var10, var12, var13, this.field674, var11, 6, this.field673, var9);
        }
    }
