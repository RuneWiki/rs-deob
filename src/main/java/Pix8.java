...
public class Pix8 extends Draw2D {
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(Lub;Ljava/lang/String;I)V")
    ...
    public void method189(int arg0, int arg1, boolean arg2) {
        ...
        if (var9 > 0 && var8 > 0) {
            this.method190(Draw2D.field533, var7, var11, this.field588, var8, 0, var9, var6, var10, this.field589);
            if (!arg2) {
                ;
            }
        }
