...
public class Pix8 extends Draw2D {
    ...
    public void method198(byte arg0, int arg1, int arg2) {
        ...
        int var12 = Draw2D.field622 - var11;
        int var13 = 0;
        if (var5 < Draw2D.field624) {
            int var14 = Draw2D.field624 - var5;
            var10 -= var14;
            var5 = Draw2D.field624;
            var7 += var11 * var14;
            var6 += Draw2D.field622 * var14;
        }
        if (var5 + var10 > Draw2D.field625) {
            var10 -= var5 + var10 - Draw2D.field625;
        }
        if (var4 < Draw2D.field626) {
            int var15 = Draw2D.field626 - var4;
            var11 -= var15;
        ...
        if (var4 + var11 > Draw2D.field627) {
            int var16 = var4 + var11 - Draw2D.field627;
            var11 -= var16;
            var13 += var16;
            var12 += var16;
        }
        if (var11 > 0 && var10 > 0) {
            this.method199(this.field676, var11, this.field675, var6, true, var12, var10, Draw2D.field621, var7, var13);
        }
    }
