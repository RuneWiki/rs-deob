...
public class Pix8 extends Draw2D {
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "(ILtb;Ljava/lang/String;I)V")
    ...
    public void method166(int arg0, boolean arg1, int arg2) {
        ...
        if (var9 > 0 && var8 > 0) {
            this.method167(var8, this.field557, this.field558, var9, var6, var7, Draw2D.field506, 92, var10, var11);
        }
    }
