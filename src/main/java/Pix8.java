...
public class Pix8 extends Draw2D {
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(Lyb;Ljava/lang/String;I)V")
    ...
    public void method204(int arg0, int arg1, int arg2) {
        ...
        int var7 = Draw2D.field609 * var6 + var4;
        int var8 = 0;
        ...
        if (var4 < Draw2D.field613) {
            int var14 = Draw2D.field613 - var4;
            var10 -= var14;
        ...
        if (var4 + var10 > Draw2D.field614) {
            int var15 = var4 + var10 - Draw2D.field614;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method205((byte) 115, Draw2D.field608, var9, this.field660, var7, var8, var10, this.field661, var11, var12);
        }
    }
