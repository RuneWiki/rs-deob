...
public class class416 implements class64 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Lsaa;III)V")
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ZLsaa;I)V")
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ILsa;III)V")
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ILoaa;I)V")
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ILsa;II)V")
    ...
    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "(Lkga;)V")
