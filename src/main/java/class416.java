...
public class class416 extends class704 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IILd;IILha;I)V")
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(ILsl;)Lnj;")
    ...
    @OriginalMember(owner = "client!hm", name = "<init>", descriptor = "(Lch;II)V")
