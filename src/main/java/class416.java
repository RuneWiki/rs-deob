...
public abstract class class416 extends class179 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ZI)Lsb;", line = 6)
    ...
    @OriginalMember(owner = "client!gi", name = "b", descriptor = "(I)V", line = 327)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(BLaq;II)V", line = 344)
    ...
    @OriginalMember(owner = "client!gi", name = "d", descriptor = "(B)V", line = 367)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ILwo;)V", line = 400)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IB)V", line = 415)
    ...
    @OriginalMember(owner = "client!gi", name = "c", descriptor = "(I)V", line = 433)
