...
public class class416 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Leq;I)V")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(ILfm;)V")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Lfm;B)Z")
