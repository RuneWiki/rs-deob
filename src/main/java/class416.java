...
public class class416 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(II)Lre;")
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(BIFII[BFIFFIIFLifa;)V")
    ...
    @OriginalMember(owner = "client!bt", name = "<init>", descriptor = "(Lcr;ILla;Lla;)V")
