...
public class class416 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lada;I)Lbq;", line = 3)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IILkba;IIIIIILkba;)V", line = 82)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Z)Lpia;", line = 131)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 155)
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(Lkha;Lkha;)V", line = 187)
    public class416(class687 arg0, class687 arg1) {
        this.field5923 = arg0;
        this.field5922 = arg1;
    }

    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(B)V", line = 196)
