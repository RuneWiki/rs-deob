...
public class class416 {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "()Lkr;")
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Lmo;II)Lih;")
    ...
    @OriginalMember(owner = "client!ih", name = "<init>", descriptor = "(Ljg;)V")
