...
public class class416 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(BLt;)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Ljava/lang/Object;Lt;B)V")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Lt;I)V")
