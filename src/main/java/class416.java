...
public class class416 {
    ...
    @OriginalMember(owner = "client!uda", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(BII)I", line = 30)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(IIB)V", line = 56)
