...
public class class416 extends class325 implements class210 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(ILvc;II)Z")
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lvc;IIZ)Lco;")
    ...
    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(Lvc;Lnm;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lvc;I)Lep;")
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lvc;B)V")
    ...
    @OriginalMember(owner = "client!t", name = "b", descriptor = "(ZLvc;)V")
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(BILvc;)Ln;")
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(ILvc;I)Ln;")
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(ZLvc;)V")
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(ZILvc;IILuq;I)V")
