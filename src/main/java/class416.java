...
public class class416 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(ZLjm;)V")
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Ljm;)V")
    public class416(class162 arg0) {
        this.field5762 = arg0;
    }

    @OriginalMember(owner = "client!ca", name = "c", descriptor = "(I)Lvi;")
    ...
    @OriginalMember(owner = "client!ca", name = "d", descriptor = "(I)Lvi;")
