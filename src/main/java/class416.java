...
public class class416 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Lno;B)V")
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Lno;I)V")
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Lno;II)V")
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(BLno;Lc;)V")
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(ILno;)V")
