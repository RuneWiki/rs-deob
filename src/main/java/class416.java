...
public class class416 extends class86 {
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(ILsf;)V")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Ljava/lang/String;Lck;II)Loca;")
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(Lsf;)V")
