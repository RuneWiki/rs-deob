...
public class class416 extends class207 {
    ...
    @OriginalMember(owner = "client!hf", name = "c", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(ILrd;)V", line = 14)
    public class416(int arg0, class355 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IB)V", line = 17)
    ...
    @OriginalMember(owner = "client!hf", name = "d", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!hf", name = "c", descriptor = "(IB)Lab;", line = 133)
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(I)I", line = 147)
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Lrd;)V", line = 160)
    public class416(class355 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Z)V", line = 165)
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(II)I", line = 179)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(I)V", line = 191)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IIIIZIZ)V", line = 208)
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(IB)I", line = 230)
    ...
    @OriginalMember(owner = "client!hf", name = "e", descriptor = "(I)V", line = 251)
