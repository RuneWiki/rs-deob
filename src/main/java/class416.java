...
public class class416 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IIIIILoba;I)Z", line = 23)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IIBILkg;ILkg;III)V", line = 104)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 156)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(B)V", line = 169)
