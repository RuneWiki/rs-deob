...
public class class416 extends class105 {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(I[II[IILtn;[I[I)V")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Ltn;I[IIIZII[[ZI[II)V")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IILwm;)V")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "([IIZLtn;IIIII[II[[Z)V")
                ...
                if (arg11[-arg8 + var18][-arg10 + var19]) {
                    if (super.field1149[var18][var19] != null) {
                        ...
                        for (int var25 = 0; var23.field4417 > var25; ++var25) {
                            ...
                            } else if (var23.field4421 != null && ~var23.field4421[var25] != 0) {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "([I[I[IILtn;IZ[II)V")
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "(Luq;IIII[[I[[II)V")
