...
public class class416 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IILcu;)V")
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(ILmq;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Lcu;B)V")
