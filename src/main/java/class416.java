...
public class class416 extends class133 {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(III)V", line = 6)
    ...
    @OriginalMember(owner = "client!ih", name = "<init>", descriptor = "(Lhj;IIZ[[I)V", line = 12)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "()V", line = 45)
    public final void method333() {
        this.field1844.field4607.glFramebufferTexture2DEXT(36160, this.field6022, 3553, 0, 0);
        this.field6022 = -1;
    }

    @OriginalMember(owner = "client!ih", name = "<init>", descriptor = "(Lhj;II)V", line = 49)
    ...
    @OriginalMember(owner = "client!ih", name = "<init>", descriptor = "(Lhj;IIZ[[BI)V", line = 64)
