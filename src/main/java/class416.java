...
public class class416 extends class656 {
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(ILvfa;IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!dg", name = "c", descriptor = "(B)Z", line = 20)
    ...
    @OriginalMember(owner = "client!dg", name = "c", descriptor = "(Z)V", line = 37)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "()V", line = 57)
    ...
    @OriginalMember(owner = "client!dg", name = "d", descriptor = "(B)V", line = 161)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIIBZ)Lff;", line = 182)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIIII[B[BII)V", line = 231)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(Lfha;B)I", line = 275)
