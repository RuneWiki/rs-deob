...
public class class416 extends class33 {
    ...
    @OriginalMember(owner = "client!he", name = "<init>", descriptor = "(Lbv;Lse;[Lrl;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!he", name = "B", descriptor = "(CIIIZ)V", line = 211)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(CIIIZLea;II)V", line = 231)
