...
public class class416 extends class791 implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    @OriginalMember(owner = "client!ne", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 4)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.method3253(24215, arg0.getX(), arg0.getY());
    }

    @OriginalMember(owner = "client!ne", name = "f", descriptor = "(I)Z", line = 11)
    ...
    @OriginalMember(owner = "client!ne", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 22)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method3253(24215, arg0.getX(), arg0.getY());
    }

    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!ne", name = "d", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Z)Z", line = 66)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(I)Lvha;", line = 86)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(BLjava/awt/Component;)V", line = 96)
    ...
    @OriginalMember(owner = "client!ne", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 110)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method3253(24215, arg0.getX(), arg0.getY());
    }

    @OriginalMember(owner = "client!ne", name = "c", descriptor = "(B)V", line = 118)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ILjava/awt/event/MouseEvent;)I", line = 138)
    ...
    @OriginalMember(owner = "client!ne", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 168)
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(I)I", line = 193)
    ...
    @OriginalMember(owner = "client!ne", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 204)
    ...
    @OriginalMember(owner = "client!ne", name = "d", descriptor = "(I)Z", line = 228)
    ...
    @OriginalMember(owner = "client!ne", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 239)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(III)V", line = 248)
    ...
    @OriginalMember(owner = "client!ne", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 265)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        this.method3253(24215, arg0.getX(), arg0.getY());
    }

    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 313)
    public class416(Component arg0, boolean arg1) {
        this.method3251((byte) 103, arg0);
        this.field6007 = arg1;
    }

    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IIIII)V", line = 277)
    ...
    @OriginalMember(owner = "client!ne", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 294)
