...
public class class416 {
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(IBI)B", line = 4)
    ...
    @OriginalMember(owner = "client!jea", name = "c", descriptor = "(I)V", line = 23)
    public static void method2647(int arg0) {
        field6368 = null;
        int var1 = -56 / ((-arg0 - 9) / 46);
    }

    @OriginalMember(owner = "client!jea", name = "d", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(IZ)Z", line = 66)
