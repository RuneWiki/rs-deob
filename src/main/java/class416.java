...
public class class416 extends class577 {
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(IIII)V", line = 12)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(IIFII)V", line = 23)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(I)V", line = 138)
    ...
    @OriginalMember(owner = "client!mt", name = "b", descriptor = "(II)V", line = 152)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(BI)V", line = 171)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(IZ)V", line = 183)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(ZI)V", line = 207)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(I[II)V", line = 223)
    ...
    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "(Lre;IIIII)V", line = 347)
