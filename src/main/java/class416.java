...
public class class416 {
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(I)V", line = 33)
    public class416(int arg0) {
        this.field5835 = (byte) arg0;
    }

    @OriginalMember(owner = "client!mf", name = "c", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(III)Lqn;", line = 63)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Ljava/lang/String;IIZ)V", line = 75)
