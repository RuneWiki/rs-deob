...
public class class416 extends class679 {
    ...
    @OriginalMember(owner = "client!hi", name = "d", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(IIZ)V", line = 32)
    ...
    @OriginalMember(owner = "client!hi", name = "b", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(BF)F", line = 71)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(IBZ)V", line = 84)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(IZIZI)Lpe;", line = 99)
    ...
    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "(IIIIIF)V", line = 136)
