...
public class class416 {
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(ILjava/lang/Throwable;)Ljava/lang/String;", line = 7)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(JJ)J", line = 110)
