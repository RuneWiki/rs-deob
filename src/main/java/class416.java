...
public class class416 extends class44 {
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "()Z", line = 53)
    public final boolean method232() {
        return true;
    }

    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(Z)V", line = 58)
    public final void method230(boolean arg0) {
    }

    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Z)V", line = 62)
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "(Lao;Lim;)V", line = 72)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Llp;)V", line = 103)
    public final void method231(class220 arg0) {
        this.field540.method1003(arg0);
    }

    @OriginalMember(owner = "client!dq", name = "a", descriptor = "()V", line = 106)
