...
public class class416 extends class130 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Lza;B)V", line = 19)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IIBI)I", line = 37)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Lbc;IIIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "(I[B)V", line = 131)
