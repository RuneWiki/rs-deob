...
public class class416 extends class793 {
    ...
    @OriginalMember(owner = "client!br", name = "c", descriptor = "()V", line = 10)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "()V", line = 22)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 29)
    ...
    @OriginalMember(owner = "client!br", name = "c", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 69)
    ...
    @OriginalMember(owner = "client!br", name = "b", descriptor = "()V", line = 107)
    ...
    @OriginalMember(owner = "client!br", name = "d", descriptor = "()I", line = 141)
