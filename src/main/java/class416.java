...
public class class416 extends class14 {
    ...
    @OriginalMember(owner = "client!gu", name = "ya", descriptor = "(Ln;)V")
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Ln;I)V")
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "()Ln;")
