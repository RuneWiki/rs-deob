...
public class class416 extends class322 {
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IZ)Z", line = 19)
    ...
    @OriginalMember(owner = "client!uw", name = "<init>", descriptor = "(ILch;)V", line = 32)
    public class416(int arg0, class463 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!uw", name = "<init>", descriptor = "(Lch;)V", line = 104)
    public class416(class463 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!uw", name = "b", descriptor = "(Z)I", line = 47)
    ...
    @OriginalMember(owner = "client!uw", name = "b", descriptor = "(B)Z", line = 58)
    ...
    @OriginalMember(owner = "client!uw", name = "c", descriptor = "(I)Z", line = 73)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(II)I", line = 85)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(ZZ)V", line = 110)
    ...
    @OriginalMember(owner = "client!uw", name = "b", descriptor = "(II)V", line = 121)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(B)I", line = 137)
