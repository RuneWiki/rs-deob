...
public class class416 extends class333 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(I[Ljava/lang/String;)[Ljava/lang/String;", line = 13)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;)V", line = 36)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "(I[B)V", line = 81)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(I)V", line = 144)
