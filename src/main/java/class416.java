...
public class class416 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Lbt;)V", line = 22)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "()V", line = 37)
    ...
    @OriginalMember(owner = "client!dk", name = "b", descriptor = "(Lbt;)V", line = 46)
    ...
    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "()V", line = 56)
    public class416() {
        this.field5540[0] = 0;
