...
public class class416 {
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!uw", name = "toString", descriptor = "()Ljava/lang/String;", line = 18)
    public final String toString() {
        field5691++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!uw", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 27)
    public class416(String arg0, int arg1) {
        this.field5690 = arg1;
    }

    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(Lpk;IILefa;ILvc;BI)V", line = 74)
