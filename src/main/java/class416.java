...
public class class416 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Ljava/lang/String;ILsv;)I")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Luj;BLuj;)V")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IIBILpf;)V")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IIILza;[[[BIIIIIIBI)V")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IIIIZ[Lat;)V")
