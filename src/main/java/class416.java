...
public class class416 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(II)Lrw;", line = 3)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(II)V", line = 39)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Luv;I)V", line = 67)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(BII)V", line = 114)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "(Lgp;ILuu;Luu;)V", line = 162)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(B)V", line = 150)
    ...
    @OriginalMember(owner = "client!av", name = "c", descriptor = "(II)Z", line = 178)
