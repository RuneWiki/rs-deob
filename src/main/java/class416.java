...
public class class416 extends class221 implements class64 {
    ...
    @OriginalMember(owner = "client!bd", name = "e", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 5)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Ltd;B)V", line = 17)
    public final void method172(class691 arg0, byte arg1) {
        super.method172(arg0, (byte) -105);
        int var3 = 23 % ((2 - arg1) / 53);
    }

    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!bd", name = "<init>", descriptor = "(Lui;IZ[[I)V", line = 36)
