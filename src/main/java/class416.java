...
public class class416 {
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(Lr;III)V")
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(IBILr;)Z")
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(ZILd;ILjava/awt/Canvas;Lin;)Lha;")
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(IIBLr;)V")
    ...
    @OriginalMember(owner = "client!mha", name = "<init>", descriptor = "(Lqo;Led;)V")
