...
public class class416 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lza;IIII[S[B)V", line = 4)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "()V", line = 62)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lza;IIII)V", line = 75)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lza;II)V", line = 419)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(I)V", line = 597)
    public static final void method2556(int arg0) {
        field5983 = (class395) field5986.method295((long) arg0, -110);
    }

    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lza;Lql;IIII)V", line = 600)
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(I)Ltv;", line = 604)
    public static final class395 method2558(int arg0) {
        return (class395) field5986.method295((long) arg0, -100);
    }

    @OriginalMember(owner = "client!id", name = "b", descriptor = "()V", line = 611)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lfo;Lua;Lum;Lfb;Lok;Lwf;Lro;)V", line = 771)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lza;)V", line = 802)
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(Lza;IIII)Lsr;", line = 814)
    ...
    @OriginalMember(owner = "client!id", name = "c", descriptor = "()V", line = 825)
    ...
    @OriginalMember(owner = "client!id", name = "d", descriptor = "()V", line = 846)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Ll;III)I", line = 874)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Ll;II)V", line = 932)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lza;IIIIIII[S[BZ)V", line = 941)
    ...
    @OriginalMember(owner = "client!id", name = "e", descriptor = "()V", line = 1102)
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(Lza;)Lsr;", line = 1114)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lza;Lug;IIII[I[I)V", line = 1126)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "([B[B[SII)V", line = 1262)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(II)Lso;", line = 1406)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IIIIIIII)V", line = 1421)
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(II)Ltv;", line = 1433)
