...
public class class416 extends class329 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Lpl;I)Lgo;")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "([I)Loaa;")
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Lpl;II)Lgo;")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Lpl;)Z")
