...
public class class416 extends class270 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(BLis;)V")
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(ILmb;B)I")
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(BLec;I)V")
