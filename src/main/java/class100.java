...
public abstract class class100 {
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(II)V", line = 31)
    ...
    @OriginalMember(owner = "client!eda", name = "b", descriptor = "(I)Z", line = 46)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(BI)Z", line = 60)
