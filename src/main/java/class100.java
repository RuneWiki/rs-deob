...
public class class100 {
    ...
    @OriginalMember(owner = "client!aja", name = "<init>", descriptor = "(ILjava/lang/String;ILjava/lang/String;J)V", line = 11)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(Z)V", line = 27)
