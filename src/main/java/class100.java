...
public class class100 extends class2 {
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(IILua;II)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "([I[III)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "xa", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "da", descriptor = "(IIIIII)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "(Lve;[IIIII)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "(Lve;II)V")
    public class100(class578 arg0, int arg1, int arg2) {
        super(arg0, arg1, arg2);
        this.field1484 = new int[arg1 * arg2];
    }

    @OriginalMember(owner = "client!iaa", name = "V", descriptor = "(IIIII)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "YA", descriptor = "(IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "(Lve;[III)V")
