...
public class class100 extends class119 {
    ...
    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IIIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(III)Z", line = 46)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Lpl;Lpl;II)V", line = 61)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IIIIIII)V", line = 75)
    ...
    @OriginalMember(owner = "client!ok", name = "i", descriptor = "(I)V", line = 515)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Len;II)V", line = 547)
