...
public class class100 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IILdj;III)Llt;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IB)Lwda;")
    ...
    @OriginalMember(owner = "client!tt", name = "<init>", descriptor = "(Lgia;ILaj;)V")
