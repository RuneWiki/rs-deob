...
public class class100 extends class298 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "([B[IIIIIIIIIIILgo;II)V")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(CIIIZLgo;II)V")
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "(Lhm;Ljp;[Lv;[I[I)V")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "([B[IIIIIIII)V")
