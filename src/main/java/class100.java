...
public class class100 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Len;ZI)Z", line = 11)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(BLbk;I)V", line = 428)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(I)V", line = 448)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lbk;I)V", line = 472)
    ...
    @OriginalMember(owner = "client!c", name = "b", descriptor = "(I)V", line = 498)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIZI)Ljava/lang/String;", line = 510)
