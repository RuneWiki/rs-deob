...
public class class100 {
    ...
    @OriginalMember(owner = "client!aja", name = "f", descriptor = "Lnv;")
    private class439 field1305;
    ...
    public static int field1301 = 2;

    @OriginalMember(owner = "client!aja", name = "a", descriptor = "[[I")
    public static int[][] field1300 = new int[][] { { 12, 12, 12, 12 }, { 12, 12, 12, 12, 12, 5 }, { 5, 5, 1, 1 }, { 5, 1, 1, 5 }, { 5, 5, 5 }, { 5, 5, 5 }, { 12, 12, 12, 12, 12, 12 }, { 1, 12, 12, 12, 12, 12 }, { 1, 1, 7, 1 }, { 8, 9, 9, 8, 8, 3, 1, 9 }, { 8, 8, 9, 8, 9, 9 }, { 10, 10, 11, 11, 11, 7, 3, 7 }, { 12, 12, 12, 12 } };

    @OriginalMember(owner = "client!aja", name = "i", descriptor = "[Llt;")
    public static class705[] field1308 = null;
    ...
    @OriginalMember(owner = "client!aja", name = "e", descriptor = "Lib;")
    public static class165 field1304;

    @OriginalMember(owner = "client!aja", name = "g", descriptor = "Lwo;")
    public static class775 field1306;

    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(IB)[[[B", line = 12)
    public static final byte[][][] method846(int arg0, byte arg1) {
        field1303++;
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(I)V", line = 790)
    ...
    @OriginalMember(owner = "client!aja", name = "finalize", descriptor = "()V", line = 806)
    protected final void finalize() throws Throwable {
        this.field1305.method2593(this.field1302, -125);
        field1307++;
        super.finalize();
    }

    @OriginalMember(owner = "client!aja", name = "<init>", descriptor = "(Lnv;II)V", line = 819)
    public class100(class439 arg0, int arg1, int arg2) {
        this.field1305 = arg0;
        this.field1302 = arg2;
    }
}
