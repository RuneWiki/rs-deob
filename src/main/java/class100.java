...
public class class100 {
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!lfa", name = "b", descriptor = "(I)V", line = 282)
    ...
    @OriginalMember(owner = "client!lfa", name = "c", descriptor = "(I)Z", line = 311)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(Z)V", line = 324)
    ...
    @OriginalMember(owner = "client!lfa", name = "b", descriptor = "(Z)V", line = 338)
    ...
    @OriginalMember(owner = "client!lfa", name = "d", descriptor = "(I)I", line = 365)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(BZ)V", line = 376)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(B)I", line = 405)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(IZIBI)Lqb;", line = 417)
    ...
    @OriginalMember(owner = "client!lfa", name = "b", descriptor = "(B)Z", line = 463)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(IIIIIIZ)V", line = 478)
    ...
    @OriginalMember(owner = "client!lfa", name = "e", descriptor = "(I)V", line = 1062)
    ...
    @OriginalMember(owner = "client!lfa", name = "f", descriptor = "(I)I", line = 1080)
    public final int method733(int arg0) {
        field1400++;
        return arg0 == 9670 ? this.field1395.method2128(true) + this.field1407.method2128(true) : 35;
    }

    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(ZZLwo;)V", line = 1096)
    ...
    @OriginalMember(owner = "client!lfa", name = "g", descriptor = "(I)V", line = 1169)
    ...
    @OriginalMember(owner = "client!lfa", name = "c", descriptor = "(Z)V", line = 1182)
