...
public class class100 extends class95 {
    ...
    @OriginalMember(owner = "client!bk", name = "b", descriptor = "(B)Lqh;")
    ...
    @OriginalMember(owner = "client!bk", name = "<init>", descriptor = "(Lqi;I)V")
    public class100(class458 arg0, int arg1) {
        this.field1407 = arg0;
        this.field1408 = new class452(arg0, 6408, arg1);
    }

    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Lqh;FILqh;)V")
