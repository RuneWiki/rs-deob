...
public class class100 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IZLnv;)I", line = 5)
    public static final int method691(int arg0, boolean arg1, class493 arg2) {
        field1661++;
        return arg1 ? 44 : -1;
    }

    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(II)V", line = 47)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Z)V", line = 61)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(I)V", line = 73)
