...
public class class100 extends class145 {
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(IILrt;)V", line = 3)
    ...
    @OriginalMember(owner = "client!oda", name = "i", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!oda", name = "<init>", descriptor = "()V", line = 59)
    public class100() {
        super(1, false);
    }

    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(BI)[[I", line = 62)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(Lqf;BLoa;)V", line = 129)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(ZI)[I", line = 149)
    ...
    @OriginalMember(owner = "client!oda", name = "j", descriptor = "(I)V", line = 202)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(IBLjava/lang/String;[B)I", line = 228)
