...
public class class100 {
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(IIZII)V")
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(BI)Lsp;")
    ...
    @OriginalMember(owner = "client!qca", name = "<init>", descriptor = "(Lkr;ILpu;Lpu;)V")
