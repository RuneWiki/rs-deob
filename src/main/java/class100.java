...
public class class100 extends class237 implements class438 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(ILqa;)Llb;", line = 3)
    ...
    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Lqa;Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(BILqa;)Lr;", line = 74)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Lqa;B)V", line = 86)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(ILqa;IIZLse;I)V", line = 97)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(Z)Z", line = 121)
    ...
    @OriginalMember(owner = "client!aa", name = "e", descriptor = "(I)I", line = 132)
    ...
    @OriginalMember(owner = "client!aa", name = "g", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(I)Z", line = 158)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(ILqa;IB)Z", line = 169)
    ...
    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(Lqa;Lih;IIIIIZIIIIIII)V", line = 189)
    ...
    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(Lqa;B)V", line = 201)
    ...
    @OriginalMember(owner = "client!aa", name = "c", descriptor = "(I)I", line = 212)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Z)I", line = 223)
    ...
    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(I)I", line = 237)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(BLqa;)Led;", line = 255)
