...
public class class100 extends class366 {
    ...
    @OriginalMember(owner = "client!pj", name = "f", descriptor = "(I)Ljava/lang/Object;", line = 6)
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "(Lsv;Ljava/lang/Object;I)V", line = 18)
    public class100(class477 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field1462 = arg1;
    }

    @OriginalMember(owner = "client!pj", name = "g", descriptor = "(I)Z", line = 38)
