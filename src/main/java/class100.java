...
public class class100 extends class478 {
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Lnp;I)Lur;", line = 3)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(ZI)[[I", line = 37)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!qv", name = "c", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!qv", name = "b", descriptor = "(ZI)V", line = 215)
    ...
    @OriginalMember(owner = "client!qv", name = "f", descriptor = "(I)V", line = 469)
    public static void method543(int arg0) {
        field1077 = null;
        int var1 = -37 / ((-32 - arg0) / 45);
    }

    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(ILnp;I)V", line = 479)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(BII)I", line = 524)
    ...
    @OriginalMember(owner = "client!qv", name = "<init>", descriptor = "()V", line = 548)
    public class100() {
        super(1, false);
    }
}
