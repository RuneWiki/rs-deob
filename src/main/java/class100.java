...
public class class100 extends class261 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(CI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ct", name = "b", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "()V", line = 93)
    public class100() {
    }

    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "(I)V", line = 95)
