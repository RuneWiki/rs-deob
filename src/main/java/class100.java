...
public class class100 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(II)V", line = 7)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Ljp;B)V", line = 50)
