...
public class class100 extends class715 {
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(ZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!eda", name = "d", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!eda", name = "e", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(B)Z", line = 70)
    ...
    @OriginalMember(owner = "client!eda", name = "c", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!eda", name = "b", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!eda", name = "<init>", descriptor = "(Llt;Leq;Lwv;)V", line = 151)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(BZ)V", line = 174)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(III)V", line = 184)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(ILdu;I)V", line = 213)
    public final void method693(int arg0, class355 arg1, int arg2) {
        int var4 = -53 % ((arg0 - 31) / 50);
    }

    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Z)V", line = 224)
