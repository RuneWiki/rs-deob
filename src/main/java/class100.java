...
public class class100 implements class283 {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ILaa;)Z", line = 6)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(I)J", line = 49)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIZLtj;I)V", line = 81)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lvq;IILbr;I)V", line = 108)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(BLjava/lang/String;)I", line = 402)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(B)V", line = 424)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(BI)Lhk;", line = 438)
