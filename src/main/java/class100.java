...
public abstract class class100 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IILnc;IIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lb;BI[ZIIZZLq;ILq;[I)V", line = 96)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "([ZIIIILkf;ZLkf;ILkf;IBLkf;II)V", line = 293)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lkf;IIZILkf;III)V", line = 352)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IIIII[IZ[IZI)V", line = 391)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(BII)V", line = 505)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ZLkf;I)V", line = 524)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ILkf;Lkf;[IIIIIIIZ)V", line = 597)
