...
public class class100 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(BI)Ldp;")
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IILou;I)J")
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "(Lgo;ILns;Lns;)V")
