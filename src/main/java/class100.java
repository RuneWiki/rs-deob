...
public class class100 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IIILdk;Ldk;)V", line = 5)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ZIZIIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ZB)V", line = 100)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ZLe;Ljava/awt/Canvas;)Loa;", line = 148)
