...
public class class100 {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ZLjava/lang/String;BLnq;)Luh;", line = 38)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ZI)I", line = 96)
