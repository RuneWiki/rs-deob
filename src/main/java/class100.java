...
public class class100 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(IIIBI)Lmg;", line = 7)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!mg", name = "b", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(IIIIZI)V", line = 182)
    ...
    @OriginalMember(owner = "client!mg", name = "<init>", descriptor = "(IIIIIIIIIZ)V", line = 289)
