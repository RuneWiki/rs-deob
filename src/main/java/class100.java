...
public abstract class class100 extends class419 {
    ...
    @OriginalMember(owner = "client!pj", name = "d", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IIIZILot;Lza;)V", line = 21)
    ...
    @OriginalMember(owner = "client!pj", name = "c", descriptor = "(B)Z", line = 31)
    ...
    @OriginalMember(owner = "client!pj", name = "e", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Ljava/lang/String;IB)V", line = 53)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IILer;ZLza;I)V", line = 71)
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "(IIIIIII)V", line = 137)
