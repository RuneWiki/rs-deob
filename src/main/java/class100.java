...
public class class100 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IIIILiu;I)Lqj;")
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(BI)Lsc;")
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(I[[[Lev;)V")
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Lae;ILqn;)V")
