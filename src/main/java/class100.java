...
public class class100 extends class278 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IIB)V", line = 22)
    public void method713(int arg0, int arg1, byte arg2) {
        ++field1165;
        this.field1168[this.field1162++] = (byte) (arg1 + (class407.method2490(arg2, 255) >> 1));
    }

    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "(IIIIIF)V", line = 33)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IBI)V", line = 52)
    ...
    @OriginalMember(owner = "client!vf", name = "c", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(B)V", line = 119)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(III)V", line = 131)
    ...
    @OriginalMember(owner = "client!vf", name = "c", descriptor = "(B)I", line = 143)
