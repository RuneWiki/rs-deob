...
public class class100 extends class583 {
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "()V", line = 6)
    public class100() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Ljava/io/File;IZ)V", line = 17)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IIII)[B", line = 64)
