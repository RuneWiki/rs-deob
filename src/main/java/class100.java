...
public class class100 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IJ)Ltl;", line = 9)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(I)Ltl;", line = 55)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Z)V", line = 86)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IJLtl;)V", line = 121)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Lwm;I)V", line = 189)
