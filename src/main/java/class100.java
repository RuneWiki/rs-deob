...
public class class100 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lmo;II)[Lvp;")
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "([B)[Lvp;")
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lmo;I)[Lvp;")
