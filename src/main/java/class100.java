...
public class class100 implements Runnable {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lnr;ILqj;)V")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ILo;)V")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IIIZII)V")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lfl;Lnr;I)V")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Ljava/lang/String;Z)Lsa;")
