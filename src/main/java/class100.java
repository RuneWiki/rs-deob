...
public class class100 extends class27 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IIZJLpe;)V")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(II)Lol;")
    ...
    @OriginalMember(owner = "client!rc", name = "<init>", descriptor = "(Lpe;Lds;Lha;J)V")
