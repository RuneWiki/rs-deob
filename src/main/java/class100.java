...
public abstract class class100 extends class352 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!mp", name = "c", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!mp", name = "d", descriptor = "(B)Z", line = 93)
    ...
    @OriginalMember(owner = "client!mp", name = "d", descriptor = "(Z)V", line = 104)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(IIII)V", line = 189)
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(II)Les;", line = 203)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IIZZ)V", line = 231)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IIILpq;)V", line = 258)
