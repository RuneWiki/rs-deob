...
public class class100 implements Runnable {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Lvt;B)V")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Lcg;I)V")
    ...
    @OriginalMember(owner = "client!is", name = "b", descriptor = "(I)Luf;")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(JILjava/lang/String;ILuf;)V")
