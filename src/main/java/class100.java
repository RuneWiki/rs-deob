...
public class class100 extends class228 {
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(Lvp;IZ)V")
    ...
    @OriginalMember(owner = "client!oda", name = "<init>", descriptor = "(Lte;II[BI)V")
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(ILvba;IIIIBIIII)Z")
