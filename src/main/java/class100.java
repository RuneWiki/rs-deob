...
public class class100 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Z)I", line = 105)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(CI)Z", line = 175)
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(I)V", line = 194)
