...
public class class100 extends class262 {
    ...
    @OriginalMember(owner = "client!og", name = "g", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Lag;II[BI)V", line = 34)
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(ZI)V", line = 47)
    ...
    @OriginalMember(owner = "client!og", name = "c", descriptor = "(B)V", line = 58)
