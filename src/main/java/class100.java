...
public class class100 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(BLsf;)V", line = 18)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lun;Z)V", line = 40)
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(BLsf;)V", line = 51)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(BLw;)V", line = 73)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "([Ljava/awt/Rectangle;II)V", line = 94)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ILpg;)I", line = 112)
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(I)I", line = 136)
    ...
    @OriginalMember(owner = "client!tt", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 158)
    public class100(String arg0) {
        this.field1262 = arg0;
    }

    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(B)Lsga;", line = 171)
