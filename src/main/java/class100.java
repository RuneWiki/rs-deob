...
public class class100 extends class254 {
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(ILd;)V", line = 4)
    public static final void method543(int arg0, class176 arg1) {
        class397.field5666[arg0] = arg1;
    }

    @OriginalMember(owner = "client!ofa", name = "b", descriptor = "(IZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(I)V", line = 19)
    public final void method545(int arg0) {
        ++field1219;
        int var2 = 94 % ((-59 - arg0) / 52);
    }

    @OriginalMember(owner = "client!ofa", name = "<init>", descriptor = "(Lpea;II[BI)V", line = 30)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(III)Z", line = 43)
    ...
    @OriginalMember(owner = "client!ofa", name = "c", descriptor = "(I)V", line = 62)
