...
public class class100 extends class75 {
    ...
    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "()V", line = 118)
    public class100() {
        this.field1729 = System.nanoTime();
        this.field1728 = System.nanoTime();
    }

    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(ZJ)I", line = 8)
    ...
    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(I)J", line = 41)
    ...
    @OriginalMember(owner = "client!aa", name = "c", descriptor = "(I)J", line = 59)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Z)V", line = 92)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(I)J", line = 106)
