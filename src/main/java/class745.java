...
public class class745 extends class409 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 3)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(B)Z", line = 16)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 27)
    public class745(Object arg0, int arg1) {
        super(arg1);
        this.field10383 = arg0;
    }

    @OriginalMember(owner = "client!cl", name = "g", descriptor = "(I)V", line = 39)
