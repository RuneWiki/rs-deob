...
public class class745 extends class573 {
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(III)I", line = 3)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(B)[Lgga;", line = 21)
    ...
    @OriginalMember(owner = "client!ufa", name = "e", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(II)V", line = 43)
    ...
    @OriginalMember(owner = "client!ufa", name = "b", descriptor = "(II)Ljava/lang/String;", line = 108)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(IIB)Z", line = 149)
    ...
    @OriginalMember(owner = "client!ufa", name = "<init>", descriptor = "(II[I[I)V", line = 159)
