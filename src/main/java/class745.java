...
public abstract class class745 extends class91 {
    ...
    @OriginalMember(owner = "client!nfa", name = "g", descriptor = "(I)I", line = 13)
    ...
    @OriginalMember(owner = "client!nfa", name = "h", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 60)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "([Lmfa;IBI)I", line = 85)
