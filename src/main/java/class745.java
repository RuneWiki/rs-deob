...
public class class745 extends class134 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(Lib;Z)V")
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(ILcn;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!jga", name = "b", descriptor = "(I)Lbk;")
