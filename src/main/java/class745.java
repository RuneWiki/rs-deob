...
public class class745 extends class571 {
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(Lvn;B)V")
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(Lha;IIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(Ltd;Ljava/lang/Object;I)V")
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(ILtea;)V")
