...
public class class745 extends class123 {
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(IDI)Lcha;")
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(ILcha;)V")
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "()Lri;")
    ...
    @OriginalMember(owner = "client!lja", name = "g", descriptor = "(I)Lcha;")
    ...
    @OriginalMember(owner = "client!lja", name = "d", descriptor = "()Lri;")
