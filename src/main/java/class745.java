...
public class class745 {
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(IIII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(I)I", line = 142)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(III)I", line = 155)
    ...
    @OriginalMember(owner = "client!wga", name = "b", descriptor = "(I)V", line = 179)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(II)V", line = 189)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(ZI)V", line = 199)
    ...
    @OriginalMember(owner = "client!wga", name = "c", descriptor = "(I)V", line = 214)
    ...
    @OriginalMember(owner = "client!wga", name = "d", descriptor = "(I)V", line = 225)
