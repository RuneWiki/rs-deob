...
public class class745 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "([IIII)Lso;")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(III)Lraa;")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(II[I)Lso;")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(BI[I)Lso;")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(III[I)Lso;")
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Lla;Lla;)V")
