...
public class class745 extends class219 {
    ...
    @OriginalMember(owner = "client!jga", name = "b", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(IBI)Z", line = 27)
    ...
    @OriginalMember(owner = "client!jga", name = "<init>", descriptor = "([B)V", line = 37)
    public class745(byte[] arg0) {
        this.field10370 = arg0;
    }

    @OriginalMember(owner = "client!jga", name = "c", descriptor = "(I)V", line = 46)
