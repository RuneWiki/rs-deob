...
public class class745 {
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(IIIIILha;II)V")
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(IILka;IILro;)V")
    ...
    @OriginalMember(owner = "client!jaa", name = "<init>", descriptor = "(Llca;III)V")
