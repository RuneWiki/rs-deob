...
public class class745 {
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(I[ILkf;Z)V", line = 34)
