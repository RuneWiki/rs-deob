...
public class class745 extends class343 implements class721 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Lha;Lsu;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ZLfe;)V")
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(Lha;B)Lc;")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IBLha;I)Z")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lha;Z)V")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lha;I)Lria;")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ILvs;ZILha;II)V")
