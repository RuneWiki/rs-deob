...
public class class682 implements class185 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IIIILefa;)V")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IBLtca;)V")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Lefa;III)V")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ILtca;ZI)V")
    ...
    @OriginalMember(owner = "client!mj", name = "e", descriptor = "(I)Lqs;")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ILkq;I)V")
    ...
    @OriginalMember(owner = "client!mj", name = "<init>", descriptor = "(Ldia;)V")
