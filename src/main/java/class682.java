...
public class class682 extends class715 {
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(BZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(ILdu;I)V", line = 15)
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(III)V", line = 49)
    ...
    @OriginalMember(owner = "client!vha", name = "b", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!vha", name = "c", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(B)Z", line = 160)
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(ZI)V", line = 173)
    ...
    @OriginalMember(owner = "client!vha", name = "<init>", descriptor = "(Leea;Leq;)V", line = 193)
