...
public class class682 {
    ...
    @OriginalMember(owner = "client!vd", name = "c", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!vd", name = "d", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Lmt;B)V", line = 142)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Lmt;I)Z", line = 156)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IIIII)Z", line = 193)
    ...
    @OriginalMember(owner = "client!vd", name = "e", descriptor = "(I)V", line = 238)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(B)Z", line = 342)
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "(Leq;)V", line = 568)
    ...
    @OriginalMember(owner = "client!vd", name = "b", descriptor = "(B)Z", line = 494)
