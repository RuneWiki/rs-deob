...
public class class682 extends class675 {
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(IIIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!ag", name = "l", descriptor = "(B)I", line = 43)
    ...
    @OriginalMember(owner = "client!ag", name = "h", descriptor = "(IB)I", line = 69)
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "(I)V", line = 100)
    public class682(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ag", name = "m", descriptor = "(B)Z", line = 104)
    ...
    @OriginalMember(owner = "client!ag", name = "n", descriptor = "(B)V", line = 121)
    ...
    @OriginalMember(owner = "client!ag", name = "j", descriptor = "(II)V", line = 135)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(III)Lnu;", line = 152)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lpea;I)V", line = 172)
    ...
    @OriginalMember(owner = "client!ag", name = "o", descriptor = "(B)V", line = 184)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "([II)V", line = 196)
    ...
    @OriginalMember(owner = "client!ag", name = "k", descriptor = "(II)I", line = 214)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ZII[B)V", line = 227)
    ...
    @OriginalMember(owner = "client!ag", name = "B", descriptor = "(I)V", line = 244)
