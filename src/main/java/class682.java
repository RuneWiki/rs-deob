...
public class class682 implements class264 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(BLk;Lri;)V")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(I)Leu;")
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(ILja;Lmea;II)V")
