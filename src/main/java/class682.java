...
public abstract class class682 extends class421 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(I[Lqm;)I")
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(ZLje;IIILha;I)V")
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(ILha;)Z")
