...
public class class682 extends class386 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IIBII)V", line = 28)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Ljava/lang/String;ILec;I)Lth;", line = 57)
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(Luq;Luq;Lar;)V", line = 135)
