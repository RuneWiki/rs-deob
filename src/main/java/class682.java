...
public class class682 extends class362 {
    ...
    @OriginalMember(owner = "client!ar", name = "w", descriptor = "[Lmi;")
    public static class496[] field9238;

    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(I)V", line = 15)
    public static void method3823(int arg0) {
        field9237 = null;
        field9238 = null;
        field9240 = null;
        field9245 = null;
        int var1 = -33 % ((-arg0 - 16) / 53);
        field9239 = null;
        field9232 = null;
        field9236 = null;
    }

    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(III)Z", line = 31)
    public final boolean method3824(int arg0, int arg1, int arg2) {
        field9235++;
        if (this.field9243 <= arg1 && this.field9246 >= arg1 && arg0 >= this.field9242 && this.field9231 >= arg0) {
            return true;
        } else if (this.field9241 <= arg1 && this.field9233 >= arg1 && this.field9249 <= arg0 && this.field9234 >= arg0) {
            return true;
        } else {
            if (arg2 < 60) {
                this.method3824(8, 24, -128);
            }
            return false;
        }
    }

    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Llga;)V", line = 147)
    public class682(class710 arg0) {
        this.field9247 = arg0;
    }

    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IIIIIIIIBI)V", line = 57)
    public static final void method3825(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, byte arg8, int arg9) {
        field9230++;
        if (arg8 < 118) {
            return;
        }
        class55 var10 = null;
        for (class55 var11 = (class55) class336.field4743.method1269(4); var11 != null; var11 = (class55) class336.field4743.method1264((byte) 50)) {
            if (var11.field1120 == arg0 && var11.field1126 == arg9 && var11.field1117 == arg2 && var11.field1125 == arg5) {
                var10 = var11;
                break;
            }
        }
        if (var10 == null) {
            var10 = new class55();
            var10.field1120 = arg0;
            var10.field1125 = arg5;
            var10.field1117 = arg2;
            var10.field1126 = arg9;
            if (arg9 >= 0 && arg2 >= 0 && class376.field5325 > arg9 && arg2 < class175.field2711) {
                class129.method1071(-69, var10);
            }
            class336.field4743.method1273(var10, -20180);
        }
        var10.field1114 = arg3;
        var10.field1121 = arg6;
        var10.field1116 = arg4;
        var10.field1115 = arg1;
        var10.field1128 = arg7;
    }
}
