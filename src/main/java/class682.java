...
public class class682 extends class510 {
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(ILria;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!ufa", name = "<init>", descriptor = "(Leha;Loea;IIIIIIIIIIIIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!ufa", name = "b", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(I)Lhm;", line = 38)
    ...
    @OriginalMember(owner = "client!ufa", name = "c", descriptor = "(I)V", line = 50)
