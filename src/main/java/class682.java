...
public class class682 extends class65 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(IIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(BFIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!oh", name = "c", descriptor = "(II)V", line = 139)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(BI)V", line = 150)
    ...
    @OriginalMember(owner = "client!oh", name = "d", descriptor = "(II)V", line = 164)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(B)V", line = 186)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(I[IB)V", line = 199)
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(Lvha;IIIII)V", line = 359)
