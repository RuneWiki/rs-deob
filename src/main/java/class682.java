...
public class class682 extends class689 implements class89 {
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Ljava/awt/Canvas;Le;)V", line = 4)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 31)
    ...
    @OriginalMember(owner = "client!da", name = "d", descriptor = "()V", line = 46)
    public final void method827() {
    }

    @OriginalMember(owner = "client!da", name = "b", descriptor = "()V", line = 48)
    public final void method821() {
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I[Lhj;)V", line = 53)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lob;)V", line = 72)
    ...
    @OriginalMember(owner = "client!da", name = "d", descriptor = "(IIIIII)V", line = 77)
    ...
    @OriginalMember(owner = "client!da", name = "i", descriptor = "()V", line = 82)
    public final void method801() {
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIILfa;II)V", line = 86)
    ...
    @OriginalMember(owner = "client!da", name = "g", descriptor = "()Z", line = 96)
    public final boolean method1899() {
        return false;
    }

    @OriginalMember(owner = "client!da", name = "b", descriptor = "(Li;)V", line = 99)
    public final void method1877(class173 arg0) {
        this.field9682 = (class405) arg0;
        this.method3766(arg0);
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II[[I[[IIII)Ld;", line = 105)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lme;Z)Lxa;", line = 109)
    ...
    @OriginalMember(owner = "client!da", name = "w", descriptor = "()Z", line = 186)
    public final boolean method1791() {
        return false;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIII)V", line = 192)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIII)V", line = 195)
    ...
    @OriginalMember(owner = "client!da", name = "j", descriptor = "()Z", line = 198)
    public final boolean method1992() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "b", descriptor = "(I)V", line = 204)
    public final void method1794(int arg0) {
        this.field9704[arg0].method889();
    }

    @OriginalMember(owner = "client!da", name = "h", descriptor = "()Z", line = 207)
    public final boolean method1930() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "d", descriptor = "(Ljava/awt/Canvas;)V", line = 211)
    ...
    @OriginalMember(owner = "client!da", name = "e", descriptor = "()Z", line = 222)
    public final boolean method1989() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "b", descriptor = "(II)I", line = 226)
    ...
    @OriginalMember(owner = "client!da", name = "C", descriptor = "()V", line = 231)
    public final void method1929() {
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "()Z", line = 236)
    public final boolean method1942() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "x", descriptor = "()Z", line = 240)
    public final boolean method1945() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "E", descriptor = "()Lt;", line = 246)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(FFF)V", line = 257)
    public final void method851(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!da", name = "d", descriptor = "(Z)V", line = 260)
    public final void method1798(boolean arg0) {
    }

    @OriginalMember(owner = "client!da", name = "t", descriptor = "()Z", line = 263)
    public final boolean method842() {
        return false;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "([IIIII)Lxa;", line = 267)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Lba;Lq;[Lqn;I)V", line = 302)
    ...
    @OriginalMember(owner = "client!da", name = "s", descriptor = "()V", line = 321)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II[I[I)Lfa;", line = 327)
    ...
    @OriginalMember(owner = "client!da", name = "HA", descriptor = "()Ljava/lang/Object;", line = 330)
    private final Object method3769() {
        return new class183(this);
    }

    @OriginalMember(owner = "client!da", name = "D", descriptor = "()Z", line = 334)
    public final boolean method1901() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "qa", descriptor = "(S)Z", line = 337)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIF)Lhj;", line = 348)
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 353)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Laq;Laq;FLaq;)Laq;", line = 374)
    public final class108 method796(class108 arg0, class108 arg1, float arg2, class108 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 377)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Laq;)V", line = 394)
    public final void method1952(class108 arg0) {
    }

    @OriginalMember(owner = "client!da", name = "u", descriptor = "()Z", line = 397)
    public final boolean method811() {
        return false;
    }

    @OriginalMember(owner = "client!da", name = "r", descriptor = "()Z", line = 400)
    public final boolean method1933() {
        return false;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Lba;Lob;Lq;[Lqn;I)V", line = 413)
    ...
    @OriginalMember(owner = "client!da", name = "e", descriptor = "(Z)V", line = 456)
    public final void method778(boolean arg0) {
    }

    @OriginalMember(owner = "client!da", name = "m", descriptor = "()V", line = 459)
    ...
    @OriginalMember(owner = "client!da", name = "c", descriptor = "()I", line = 489)
    public final int method1962() {
        return 4;
    }

    @OriginalMember(owner = "client!da", name = "B", descriptor = "()Z", line = 492)
    public final boolean method1988() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIZ)Lxa;", line = 495)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lba;Lob;Lq;Lqn;I)V", line = 504)
    ...
    @OriginalMember(owner = "client!da", name = "d", descriptor = "(I)V", line = 521)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lq;)V", line = 535)
    public final void method1887(class111 arg0) {
        this.field9696 = arg0;
        this.method3774(arg0);
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIIIIII)V", line = 539)
    ...
    @OriginalMember(owner = "client!da", name = "A", descriptor = "()V", line = 544)
    public final void method839() {
    }

    @OriginalMember(owner = "client!da", name = "d", descriptor = "(S)Z", line = 549)
    ...
    @OriginalMember(owner = "client!da", name = "c", descriptor = "(IIIIII)Laq;", line = 573)
    public final class108 method1954(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lil;[Lme;Z)Lta;", line = 578)
    ...
    @OriginalMember(owner = "client!da", name = "n", descriptor = "()Z", line = 617)
    public final boolean method1976() {
        return true;
    }

    @OriginalMember(owner = "client!da", name = "e", descriptor = "(I)V", line = 621)
    public final void method1797(int arg0) {
        this.field9704[arg0].method885();
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIII)V", line = 623)
    public final void method834(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!da", name = "q", descriptor = "()Z", line = 627)
    public final boolean method1903() {
        return false;
    }

    @OriginalMember(owner = "client!da", name = "l", descriptor = "()Lru;", line = 630)
    public final class276 method794() {
        return new class276(0, "SSE", 1, "CPU", 0L);
    }

    @OriginalMember(owner = "client!da", name = "z", descriptor = "()Lq;", line = 633)
    public final class111 method1922() {
        return new class337();
    }

    @OriginalMember(owner = "client!da", name = "g", descriptor = "(I)V", line = 636)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II)I", line = 649)
    public final int method1987(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!da", name = "finalize", descriptor = "()V", line = 652)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lrf;IIII)Lba;", line = 660)
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "(Z)V", line = 678)
    public final void method1897(boolean arg0) {
    }

    @OriginalMember(owner = "client!da", name = "y", descriptor = "()Z", line = 682)
    public final boolean method1973() {
        return false;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lob;Z)V", line = 686)
    ...
    @OriginalMember(owner = "client!da", name = "f", descriptor = "()Lq;", line = 717)
    public final class111 method1972() {
        return this.field9697;
    }

    @OriginalMember(owner = "client!da", name = "o", descriptor = "()V", line = 733)
    ...
    @OriginalMember(owner = "client!da", name = "f", descriptor = "(I)Li;", line = 745)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I)V", line = 750)
    public final void method1983(int arg0) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!da", name = "p", descriptor = "()V", line = 762)
