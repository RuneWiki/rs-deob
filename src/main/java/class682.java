...
public class class682 implements class33 {
    ...
    @OriginalMember(owner = "client!tj", name = "b", descriptor = "(I)Lwq;")
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "(Lad;Lwq;Z)V")
