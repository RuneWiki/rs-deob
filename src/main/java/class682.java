...
public class class682 implements class784 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Ldm;[II)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILdm;Z)Z")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILdm;ZI)Z")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;[ILdm;)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Ldm;[III)V")
