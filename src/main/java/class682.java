...
public class class682 implements class784 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILoo;ZI)Z")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;[ILoo;)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Loo;[II)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Loo;[III)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILoo;Z)Z")
