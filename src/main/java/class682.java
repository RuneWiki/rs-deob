...
public class class682 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(ILha;ILee;Lha;ZLda;IIIZI)Lfs;", line = 5)
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(II)V", line = 72)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(ZI)V", line = 92)
    ...
    @OriginalMember(owner = "client!fj", name = "c", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IB)Lko;", line = 158)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lee;IIIILha;II)Lfs;", line = 240)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(I)V", line = 259)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(B)V", line = 270)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(II)V", line = 290)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Lto;IZLun;Lla;Lla;)V", line = 327)
