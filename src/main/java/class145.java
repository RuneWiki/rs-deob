...
public class class145 {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(IILnl;B)Lfl;", line = 3)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "([Ljava/lang/Object;[IB)V", line = 32)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(IZIIII)V", line = 54)
