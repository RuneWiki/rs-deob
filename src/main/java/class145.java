...
public class class145 extends class354 {
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(Lao;IIIZ[I)V")
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(Lao;IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IZLao;[BZIII)Lrn;")
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(Lao;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ILao;IB[IZ)Lrn;")
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ILao;IIIB)Lrn;")
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(Lao;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(Lao;IIII[I)V")
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(Lao;IIIIIZ)V")
