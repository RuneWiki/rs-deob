...
public class class145 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Ljava/lang/String;BLjava/lang/String;IILjava/lang/String;Ljava/lang/String;)V", line = 21)
    ...
    @OriginalMember(owner = "client!un", name = "b", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(ZB)V", line = 234)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Ljava/lang/String;ZIZLjava/lang/String;IIJIJIIZ)V", line = 282)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(II)Z", line = 300)
