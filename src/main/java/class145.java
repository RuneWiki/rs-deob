...
public class class145 {
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(ILjava/lang/String;)I", line = 25)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(II)I", line = 117)
