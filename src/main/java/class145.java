...
public class class145 extends class278 {
    ...
    @OriginalMember(owner = "client!cu", name = "g", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(ILdm;)V", line = 28)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Llh;II)V", line = 49)
    ...
    @OriginalMember(owner = "client!cu", name = "d", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!cu", name = "h", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 125)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(II)[I", line = 147)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(BILpk;ILqa;I)V", line = 220)
