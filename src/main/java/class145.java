...
public class class145 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(IIIIILoe;IILha;IILka;II)Lka;", line = 17)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(IILwq;)V", line = 187)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(BLwq;)V", line = 216)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(B)V", line = 239)
