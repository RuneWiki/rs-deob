...
public class class145 implements Runnable {
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(IZLcaa;JLjava/lang/String;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(I)Ljava/lang/String;", line = 18)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(B)Z", line = 29)
    ...
    @OriginalMember(owner = "client!ofa", name = "b", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(Z)V", line = 51)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(BLcv;)V", line = 64)
    ...
    @OriginalMember(owner = "client!ofa", name = "b", descriptor = "(Z)I", line = 81)
    ...
    @OriginalMember(owner = "client!ofa", name = "c", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!ofa", name = "run", descriptor = "()V", line = 121)
    ...
    @OriginalMember(owner = "client!ofa", name = "d", descriptor = "(I)I", line = 247)
    ...
    @OriginalMember(owner = "client!ofa", name = "b", descriptor = "(B)Lcaa;", line = 258)
    ...
    @OriginalMember(owner = "client!ofa", name = "c", descriptor = "(Z)J", line = 268)
    ...
    @OriginalMember(owner = "client!ofa", name = "e", descriptor = "(I)I", line = 304)
