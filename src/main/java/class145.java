...
public class class145 extends class15 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ZBLg;ZLeg;DII)[I", line = 27)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ZILeg;Lg;BDI)[I", line = 166)
    ...
    @OriginalMember(owner = "client!rn", name = "e", descriptor = "(B)V", line = 303)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ILeg;Lg;)Z", line = 314)
    ...
    @OriginalMember(owner = "client!rn", name = "c", descriptor = "(III)V", line = 365)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Leg;ZILg;II)[F", line = 379)
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(IZI)V", line = 503)
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "()V", line = 528)
    public class145() {
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(Lvt;)V", line = 544)
