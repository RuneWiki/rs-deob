...
public class class145 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lza;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lza;Ljava/lang/String;[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lza;Ljava/lang/String;IIIZ)V")
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(Lza;IZLjava/awt/Component;)V")
