...
public class class145 extends class513 {
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "([III)V", line = 25)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IIBI)V", line = 179)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(Lsba;IIIII)V", line = 354)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(BI)V", line = 208)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IIBFI)V", line = 222)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IB)V", line = 342)
