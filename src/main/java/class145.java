...
public class class145 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ILsv;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(B)Z", line = 35)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(BLsv;)V", line = 52)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lmg;IILza;I)V", line = 96)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(II)V", line = 137)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ZZLjava/lang/String;Ldk;)Lek;", line = 154)
