...
public class class145 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IZII)I", line = 4)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ILia;)V", line = 138)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(B)V", line = 160)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(B)Lhd;", line = 189)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lia;II)V", line = 204)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Le;IIIIBBI)Le;", line = 377)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IILe;III)Le;", line = 456)
