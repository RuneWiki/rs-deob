...
public abstract class class145 extends class343 {
    ...
    @OriginalMember(owner = "client!eq", name = "V", descriptor = "()I", line = 4)
    public final int method367() {
        return this.field2235;
    }

    @OriginalMember(owner = "client!eq", name = "PA", descriptor = "(IIIIIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!eq", name = "d", descriptor = "()I", line = 66)
    public final int method376() {
        return this.field2238 + this.field2230 + this.field2226;
    }

    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(FFFFFF)Z", line = 76)
    ...
    @OriginalMember(owner = "client!eq", name = "ga", descriptor = "()I", line = 220)
    public final int method374() {
        return this.field2239 + this.field2235 + this.field2233;
    }

    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(FFFFFFLi;II)V", line = 224)
    ...
    @OriginalMember(owner = "client!eq", name = "ta", descriptor = "(FFFFFFIII)V", line = 252)
    ...
    @OriginalMember(owner = "client!eq", name = "l", descriptor = "(IIII)V", line = 351)
    ...
    @OriginalMember(owner = "client!eq", name = "TA", descriptor = "()I", line = 358)
    public final int method378() {
        return this.field2238;
    }

    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Lfg;II)V", line = 363)
