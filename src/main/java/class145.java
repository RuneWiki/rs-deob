...
public class class145 extends class82 {
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "()V", line = 5)
    public class145() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ld", name = "h", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IILos;)V", line = 18)
    ...
    @OriginalMember(owner = "client!ld", name = "c", descriptor = "(II)[I", line = 63)
