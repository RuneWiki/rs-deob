...
public class class145 extends class117 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IBI)Z", line = 6)
    public static final boolean method1041(int arg0, byte arg1, int arg2) {
        field2138++;
        return arg1 == 108 ? (arg2 & 0x18) != 0 | (arg2 & 0x220) == 544 : false;
    }

    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IIIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(ZII)Z", line = 121)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IIZI[I)Z", line = 143)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(II[II)Z", line = 171)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 314)
    ...
    @OriginalMember(owner = "client!cu", name = "f", descriptor = "(I)V", line = 208)
    ...
    @OriginalMember(owner = "client!cu", name = "g", descriptor = "(I)V", line = 250)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(I[III)Z", line = 262)
