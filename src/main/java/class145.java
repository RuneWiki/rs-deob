...
public class class145 extends class601 {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IB)I", line = 6)
    ...
    @OriginalMember(owner = "client!bw", name = "b", descriptor = "(I)Z", line = 25)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Lha;BI)Lej;", line = 43)
    ...
    @OriginalMember(owner = "client!bw", name = "c", descriptor = "(I)I", line = 59)
    ...
    @OriginalMember(owner = "client!bw", name = "d", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(I)I", line = 85)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IZLni;)V", line = 99)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(B)V", line = 416)
    ...
    @OriginalMember(owner = "client!bw", name = "<init>", descriptor = "(Lqea;)V", line = 435)
    public class145(class339 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bw", name = "b", descriptor = "(II)V", line = 438)
    ...
    @OriginalMember(owner = "client!bw", name = "<init>", descriptor = "(ILqea;)V", line = 450)
