...
public class class145 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(I)Z", line = 23)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Ljava/lang/String;Z)J", line = 39)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(II)Lao;", line = 66)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Ltj;I)V", line = 82)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(B)Lfq;", line = 96)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ILfq;)V", line = 113)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "()V", line = 207)
    public class145() {
        this.field2170.field1436 = this.field2170;
        this.field2170.field1433 = this.field2170;
    }

    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Z)V", line = 141)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(Z)Lfq;", line = 153)
    ...
    @OriginalMember(owner = "client!cl", name = "c", descriptor = "(Z)Lfq;", line = 173)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ILtj;)V", line = 194)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IB)V", line = 216)
    ...
    @OriginalMember(owner = "client!cl", name = "c", descriptor = "(I)Lfq;", line = 229)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(B)V", line = 256)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(III)Lfl;", line = 283)
