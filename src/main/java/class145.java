...
public class class145 implements Runnable {
    ...
    @OriginalMember(owner = "client!cl", name = "run", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lr;II)Lrs;", line = 59)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ILr;B)Lrs;", line = 82)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(Lko;)V", line = 177)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lrs;I)V", line = 130)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(I[BLr;I)Lrs;", line = 200)
