...
public class class145 implements class466 {
    ...
    @OriginalMember(owner = "client!mh", name = "toString", descriptor = "()Ljava/lang/String;", line = 5)
    public final String toString() {
        field1876++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(II)V", line = 15)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IBI)Z", line = 43)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 67)
