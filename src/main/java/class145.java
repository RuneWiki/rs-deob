...
public class class145 extends class314 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IILr;)Lufa;")
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Lie;I)Lpda;")
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(BLie;I)V")
