...
public abstract class class145 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(BI)Lpd;")
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "(Len;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "(Len;ILjaclib/memory/Buffer;IZ)V")
