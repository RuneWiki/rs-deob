...
public class class145 extends class545 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "()V", line = 15)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Lr;J)V", line = 30)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(JI)V", line = 203)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Lod;IIIIIIIIIIIZZ)V", line = 598)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(Lod;IIIIIIIIIIIZZ)V", line = 616)
