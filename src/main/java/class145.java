...
public class class145 {
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(II)Llj;")
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(ILwq;II)V")
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "(Liv;ILcb;)V")
