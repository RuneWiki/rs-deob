...
public class class145 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Ljava/lang/String;Z[I[Lnf;[Ljava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Ljava/lang/String;I[Lnf;)I")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "([Lnf;ILjava/lang/String;II)I")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(BI[Lnf;Ljava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IIIBLuv;II)V")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IILjava/lang/String;[Lnf;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lfca;B)Luu;")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Ljava/lang/String;II[Lnf;)I")
