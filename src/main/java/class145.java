...
public abstract class class145 extends class381 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(II)[I", line = 8)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Z)I", line = 21)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(ILgd;)Z", line = 34)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(ZI)[[I", line = 56)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(BII)V", line = 68)
    ...
    @OriginalMember(owner = "client!nl", name = "c", descriptor = "(B)V", line = 92)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(III)[I", line = 117)
    ...
    @OriginalMember(owner = "client!nl", name = "d", descriptor = "(B)V", line = 152)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lap;BI)V", line = 166)
    public void method2(class289 arg0, byte arg1, int arg2) {
        field2208++;
        int var4 = -21 / ((arg1 - 11) / 52);
    }

    @OriginalMember(owner = "client!nl", name = "c", descriptor = "(I)I", line = 178)
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(IZ)V", line = 190)
    public class145(int arg0, boolean arg1) {
        this.field2204 = new class145[arg0];
        this.field2205 = arg1;
    }

    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(III)[[I", line = 199)
    ...
    @OriginalMember(owner = "client!nl", name = "d", descriptor = "(I)V", line = 237)
