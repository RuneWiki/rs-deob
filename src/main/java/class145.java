...
public class class145 extends class329 {
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(ILni;IIIII)V", line = 35)
    ...
    @OriginalMember(owner = "client!bfa", name = "b", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(IIJZI)Ljava/lang/String;", line = 62)
    ...
    @OriginalMember(owner = "client!bfa", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZ)V", line = 144)
