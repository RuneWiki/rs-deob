...
public class class145 extends class79 implements class113 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(BLeq;)V")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ILeq;BI)Z")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Leq;I)V")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Leq;Z)V")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ILeq;Z)Lva;")
    ...
    @OriginalMember(owner = "client!jd", name = "b", descriptor = "(Leq;Z)Lgl;")
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "(Leq;Lhn;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IIILbp;IZLeq;)V")
