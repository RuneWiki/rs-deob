...
public class class145 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Lja;Lla;)Z", line = 3)
    public final boolean method1141(class90 arg0, class145 arg1) {
        return this.field2269 != null || this.method1142(arg0, arg1);
    }

    @OriginalMember(owner = "client!la", name = "b", descriptor = "(Lja;Lla;)Z", line = 9)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Lja;)V", line = 43)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIII)Z", line = 128)
    ...
    @OriginalMember(owner = "client!la", name = "b", descriptor = "(Lja;)V", line = 186)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "()V", line = 246)
    ...
    @OriginalMember(owner = "client!la", name = "c", descriptor = "(Lja;Lla;)V", line = 252)
    ...
    @OriginalMember(owner = "client!la", name = "b", descriptor = "()V", line = 341)
    public final void method1148() {
        this.field2269 = null;
    }

    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Lja;IIIIII)V", line = 354)
    ...
    @OriginalMember(owner = "client!la", name = "d", descriptor = "(Lja;Lla;)V", line = 381)
    ...
    @OriginalMember(owner = "client!la", name = "c", descriptor = "()V", line = 469)
    public static final void method1151() {
        field2263 = null;
        field2271 = null;
    }

    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 479)
