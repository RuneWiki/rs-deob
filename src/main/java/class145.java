...
public class class145 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ILqj;I)Lkf;", line = 9)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lqj;ILaa;)V", line = 57)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Laa;IIIIIIIII)V", line = 78)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ILaa;B)Z", line = 153)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(B)V", line = 234)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IIIIIIBLaa;I)V", line = 252)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(I[Lbf;IIII)V", line = 404)
