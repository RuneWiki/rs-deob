...
public class class145 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lms;IZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(I)Z", line = 342)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(B)V", line = 353)
