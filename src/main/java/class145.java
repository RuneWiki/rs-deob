...
public class class145 extends class405 {
    ...
    @OriginalMember(owner = "client!qf", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ILgk;I)V", line = 22)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(III)Z", line = 106)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lgk;I)Ljava/lang/String;", line = 124)
    ...
    @OriginalMember(owner = "client!qf", name = "d", descriptor = "(B)Ljava/lang/String;", line = 152)
    ...
    @OriginalMember(owner = "client!qf", name = "e", descriptor = "(I)I", line = 183)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lsr;I)V", line = 201)
    ...
    @OriginalMember(owner = "client!qf", name = "e", descriptor = "(B)V", line = 237)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Z[ILgk;)V", line = 262)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(II)Lfp;", line = 289)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "([Lrv;Lvd;Z)Lij;", line = 306)
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(Lgk;I)V", line = 378)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IIB)I", line = 406)
