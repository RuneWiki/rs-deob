...
public class class145 extends class346 {
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ZB)V", line = 46)
    ...
    @OriginalMember(owner = "client!qm", name = "d", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!qm", name = "d", descriptor = "(II)[I", line = 242)
    ...
    @OriginalMember(owner = "client!qm", name = "e", descriptor = "(I)V", line = 260)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IZ)I", line = 277)
    ...
    @OriginalMember(owner = "client!qm", name = "d", descriptor = "(Z)Z", line = 291)
    ...
    @OriginalMember(owner = "client!qm", name = "f", descriptor = "(I)V", line = 398)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lir;I)V", line = 410)
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "()V", line = 422)
    public class145() {
        super(1, true);
    }

    @OriginalMember(owner = "client!qm", name = "e", descriptor = "(Z)V", line = 427)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IBILdd;II)V", line = 709)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lfb;ZI)V", line = 838)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(B)V", line = 874)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lnb;IIII)V", line = 903)
    ...
    @OriginalMember(owner = "client!qm", name = "f", descriptor = "(Z)V", line = 959)
