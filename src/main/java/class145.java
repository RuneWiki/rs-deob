...
public class class145 {
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(I)Lgk;")
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(B)Lgk;")
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Leb;B)V")
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Leb;)V")
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IILwc;IB)V")
