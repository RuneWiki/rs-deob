...
public class class145 extends class787 {
    ...
    @OriginalMember(owner = "client!mc", name = "c", descriptor = "(Lha;B)Lpia;")
    ...
    @OriginalMember(owner = "client!mc", name = "d", descriptor = "(Lha;B)Lln;")
    ...
    @OriginalMember(owner = "client!mc", name = "e", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ILha;II)Z")
