...
public class class145 {
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(BII)Z", line = 9)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(Lnp;I)V", line = 21)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(ZLr;IB)Lf;", line = 60)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(Lnp;BI)V", line = 108)
    ...
    @OriginalMember(owner = "client!gw", name = "b", descriptor = "(I)Z", line = 137)
    public final boolean method800(int arg0) {
        field1609++;
        return arg0 == 0 ? this.field1599.field2063.method3849(this.field1608, false) : true;
    }

    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(IIZI)Ltf;", line = 151)
