...
public class class145 implements class655 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(II)I", line = 15)
    public static int method1006(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "(I)V", line = 29)
    public class145(int arg0) {
        this.field2082 = arg0;
    }

    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(I)Lmh;", line = 37)
