...
public class class145 extends class499 implements class459 {
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Lug;ILjaggl/memory/NativeBuffer;)V")
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Lug;I[BI)V")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(BLwf;Lwf;)V")
