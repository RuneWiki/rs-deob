...
public abstract class class145 extends class324 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IIB)[I", line = 4)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(IIB)[[I", line = 24)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(BI)[[I", line = 92)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(Z)V", line = 103)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IILrt;)V", line = 113)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(ZI)[I", line = 123)
    ...
    @OriginalMember(owner = "client!uh", name = "e", descriptor = "(I)I", line = 135)
    ...
    @OriginalMember(owner = "client!uh", name = "f", descriptor = "(I)V", line = 146)
    public void method145(int arg0) {
        int var2 = -7 % ((arg0 + 46) / 45);
        field1794++;
    }

    @OriginalMember(owner = "client!uh", name = "g", descriptor = "(I)I", line = 165)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(BLcm;)V", line = 177)
    ...
    @OriginalMember(owner = "client!uh", name = "h", descriptor = "(I)V", line = 195)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(III)V", line = 238)
    ...
    @OriginalMember(owner = "client!uh", name = "<init>", descriptor = "(IZ)V", line = 267)
