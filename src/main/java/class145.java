...
public class class145 implements class763 {
    ...
    @OriginalMember(owner = "client!aga", name = "c", descriptor = "(I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!aga", name = "b", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(ILjava/awt/Color;Ljava/lang/String;Ljava/awt/Color;Ljava/awt/Color;I)V", line = 35)
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(I)Luw;", line = 122)
    ...
    @OriginalMember(owner = "client!aga", name = "d", descriptor = "(I)V", line = 135)
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(III)Z", line = 148)
    ...
    @OriginalMember(owner = "client!aga", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 159)
