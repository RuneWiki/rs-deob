...
public class class145 extends class615 {
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(IB)[I", line = 3)
    ...
    @OriginalMember(owner = "client!wea", name = "c", descriptor = "(III)Z", line = 56)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(IIIIIIII)V", line = 71)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(ZB)V", line = 116)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(BILeh;)V", line = 221)
    ...
    @OriginalMember(owner = "client!wea", name = "f", descriptor = "(I)V", line = 237)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(II)[[I", line = 251)
    ...
    @OriginalMember(owner = "client!wea", name = "<init>", descriptor = "()V", line = 329)
    public class145() {
        super(3, false);
    }

    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Lii;ILjava/lang/String;B)Lsa;", line = 332)
