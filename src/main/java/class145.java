...
public class class145 extends class85 {
    ...
    @OriginalMember(owner = "client!pf", name = "Y", descriptor = "Llf;")
    public static class109 field2795 = class35.method275("", 2);

    @OriginalMember(owner = "client!pf", name = "Q", descriptor = "Llf;")
    public static class109 field2787 = field2795;

    @OriginalMember(owner = "client!pf", name = "fb", descriptor = "Llf;")
    public static class109 field2802 = class35.method275("oder ung-Ultiges Passwort)3", 2);

    @OriginalMember(owner = "client!pf", name = "ib", descriptor = "Llf;")
    public static class109 field2805 = field2795;

    @OriginalMember(owner = "client!pf", name = "X", descriptor = "Llf;")
    public static class109 field2794 = field2795;

    @OriginalMember(owner = "client!pf", name = "jb", descriptor = "Llf;")
    public static class109 field2806 = field2795;

    @OriginalMember(owner = "client!pf", name = "kb", descriptor = "Llf;")
    public static class109 field2807 = field2795;

    @OriginalMember(owner = "client!pf", name = "qb", descriptor = "Llf;")
    private static class109 field2813 = class35.method275("Members only world", 2);

    @OriginalMember(owner = "client!pf", name = "S", descriptor = "Llf;")
    public static class109 field2789 = field2813;

    @OriginalMember(owner = "client!pf", name = "nb", descriptor = "Llf;")
    private static class109 field2810 = class35.method275("FULL", 2);

    @OriginalMember(owner = "client!pf", name = "hb", descriptor = "Llf;")
    public static class109 field2804 = class35.method275("Fps:", 2);

    @OriginalMember(owner = "client!pf", name = "ab", descriptor = "Llf;")
    public static class109 field2797 = field2795;

    @OriginalMember(owner = "client!pf", name = "mb", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!pf", name = "V", descriptor = "[Lvg;")
    public static class200[] field2792;

    @OriginalMember(owner = "client!pf", name = "bb", descriptor = "[Ldf;")
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(BILja;)V")
    ...
    @OriginalMember(owner = "client!pf", name = "g", descriptor = "(I)Luf;")
