...
public class class145 {
    ...
    @OriginalMember(owner = "client!cu", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field2065++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(I)I", line = 15)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IIZILqa;Loa;I)V", line = 30)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "(II)V", line = 59)
