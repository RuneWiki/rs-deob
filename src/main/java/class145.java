...
public class class145 extends class102 implements Runnable {
    ...
    @OriginalMember(owner = "client!rn", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(Lhb;)V", line = 61)
    public class145(class431 arg0) {
        this.field2280 = arg0;
    }

    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(II)Ljk;", line = 28)
    ...
    @OriginalMember(owner = "client!rn", name = "e", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!rn", name = "f", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!rn", name = "run", descriptor = "()V", line = 107)
