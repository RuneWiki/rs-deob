...
public class class145 implements class121 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(B)Z", line = 7)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Z)I", line = 19)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IIIBII)Z", line = 38)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(I)Lev;", line = 70)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Ljava/lang/String;B)[B", line = 84)
    ...
    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 220)
    public class145(String arg0) {
        this.field1897 = arg0;
    }

    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(Z)V", line = 232)
