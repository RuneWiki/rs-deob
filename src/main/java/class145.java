...
public class class145 implements class257 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Z)Lg;", line = 4)
    public final class153 method769(boolean arg0) {
        field2083++;
        return arg0 ? null : class456.field6439;
    }

    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(III)V", line = 24)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "(ILdp;Lfv;IIIIIIIZ)V", line = 61)
