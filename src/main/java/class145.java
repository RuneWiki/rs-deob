...
public class class145 extends class38 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!qm", name = "c", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "()V", line = 142)
    public class145() {
        super(1, true);
    }

    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(BI)[I", line = 53)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IILrg;)V", line = 88)
