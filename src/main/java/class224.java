...
public class class224 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IIILwu;ZII)V")
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(ILnt;)Z")
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(I)Lrs;")
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Lee;B)V")
    ...
    @OriginalMember(owner = "client!nt", name = "<init>", descriptor = "(Lee;)V")
