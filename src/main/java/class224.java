...
public class class224 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(II)Lwba;")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(BLaj;ZZ)V")
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Liv;ILcb;Lcb;)V")
