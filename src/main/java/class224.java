...
public class class224 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Lgga;I)Ljava/lang/String;", line = 11)
    public static final String method1511(class511 arg0, int arg1) {
        field3412++;
        return arg1 < 91 ? null : class284.method1874(32767, arg0, (byte) -112);
    }

    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(B)V", line = 222)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(BII)V", line = 235)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(FFBF)F", line = 375)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 390)
