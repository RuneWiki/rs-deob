...
public class class224 {
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(Z)Lida;")
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(ILol;I)V")
    ...
    @OriginalMember(owner = "client!bda", name = "b", descriptor = "(I)Lida;")
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(Lol;I)V")
