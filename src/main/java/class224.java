...
public abstract class class224 implements class736 {
    ...
    @OriginalMember(owner = "client!gb", name = "finalize", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IZ)V", line = 32)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Z)I", line = 49)
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!gb", name = "c", descriptor = "(I)Z", line = 94)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(B)V", line = 118)
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(Lvf;IIIZ)V", line = 160)
    ...
    @OriginalMember(owner = "client!gb", name = "d", descriptor = "(I)I", line = 150)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ZZ)V", line = 179)
