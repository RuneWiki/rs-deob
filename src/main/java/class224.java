...
public class class224 extends class316 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(CIIIZLma;II)V")
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "([B[IIIIIIIIIIILma;II)V")
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "(Lji;Lli;[Lqv;[I[I)V")
    ...
    @OriginalMember(owner = "client!vu", name = "OA", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "([B[IIIIIIII)V")
