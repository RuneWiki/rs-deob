...
public class class224 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IIIIZZ)V", line = 18)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IB)Lov;", line = 171)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IIII)I", line = 208)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(B)V", line = 236)
    ...
    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "(ILci;Lci;)V", line = 258)
