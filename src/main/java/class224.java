...
public class class224 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Ljava/lang/String;BLjava/lang/String;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Z)V", line = 148)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(ILof;)V", line = 165)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(I)V", line = 186)
    ...
    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(B)V", line = 199)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(ZI)V", line = 212)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(II)Luf;", line = 228)
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "(Lrb;ILpc;)V", line = 261)
