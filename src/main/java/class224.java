...
public class class224 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(II)Lsk;", line = 5)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(II)V", line = 48)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Z)V", line = 63)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(BLkw;)[I", line = 96)
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Lnb;ILoh;)V", line = 146)
