...
public class class224 extends class626 {
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(Laia;I)V")
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(Lul;BLha;)I")
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(Lud;I)Lpca;")
