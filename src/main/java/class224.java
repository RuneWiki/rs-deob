...
public class class224 {
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(Z)V", line = 11)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(JI)V", line = 27)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(B)J", line = 89)
