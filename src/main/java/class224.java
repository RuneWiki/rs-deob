...
public class class224 extends class126 {
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(IIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!cca", name = "<init>", descriptor = "(Ljo;Lwo;)V", line = 40)
    public class224(class303 arg0, class677 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!cca", name = "d", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(ZI)V", line = 62)
