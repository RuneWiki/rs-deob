...
public class class224 {
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(ILps;I)V")
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(BILr;IBIII)Lr;")
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(IIIILr;Z)Lr;")
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(BLps;)V")
