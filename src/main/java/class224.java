...
public class class224 implements IEnumModesCallback {
    ...
    @OriginalMember(owner = "client!nt", name = "callbackEnumModes", descriptor = "(Lcom/ms/directX/DDSurfaceDesc;Lcom/ms/com/IUnknown;)V", line = 4)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Z)[I", line = 20)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IIIIILjava/awt/Frame;)V", line = 39)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Ljava/awt/Frame;I)V", line = 59)
    ...
    @OriginalMember(owner = "client!nt", name = "<init>", descriptor = "()V", line = 66)
    public class224() {
