...
public class class224 extends class472 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!su", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 4)
    public final void focusGained(FocusEvent arg0) {
        field3286++;
    }

    @OriginalMember(owner = "client!su", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 101)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Z)V", line = 128)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(B)Lofa;", line = 140)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(II)Z", line = 151)
    ...
    @OriginalMember(owner = "client!su", name = "d", descriptor = "(I)I", line = 166)
    ...
    @OriginalMember(owner = "client!su", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 190)
    public final synchronized void keyPressed(KeyEvent arg0) {
        this.method1535(105, 0, arg0);
        field3264++;
    }

    @OriginalMember(owner = "client!su", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 199)
    public final synchronized void keyReleased(KeyEvent arg0) {
        field3281++;
        this.method1535(52, 1, arg0);
    }

    @OriginalMember(owner = "client!su", name = "b", descriptor = "(II)Z", line = 210)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(BI)[I", line = 222)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IILjava/awt/event/KeyEvent;)V", line = 240)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IIZC)V", line = 276)
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(B)V", line = 293)
    ...
    @OriginalMember(owner = "client!su", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 322)
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(Z)V", line = 347)
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 404)
    public class224(Component arg0) {
        class101.method885(190);
        this.method1528(-51, arg0);
    }

    @OriginalMember(owner = "client!su", name = "c", descriptor = "(Z)V", line = 372)
    ...
    @OriginalMember(owner = "client!su", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 383)
