...
public class class224 implements class90 {
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Lwt;IIZ)V")
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Lvg;I)Lvg;")
    ...
    @OriginalMember(owner = "client!gca", name = "<init>", descriptor = "(Lpu;Lul;)V")
    public class224(class522 arg0, class531 arg1) {
        this.field3164 = arg0;
        this.field3159 = arg1;
    }

    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(ZZZLrb;)V")
