...
public class class224 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(IILiv;)V", line = 10)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Liv;III)V", line = 39)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(IZ)V", line = 107)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(I)V", line = 130)
