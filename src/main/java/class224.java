...
public abstract class class224 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(IIII)V", line = 58)
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(III)V", line = 66)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(ILtm;IILsd;Lfa;II)V", line = 80)
