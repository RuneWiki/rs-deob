...
public class class224 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lfb;)V", line = 25)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(II)[I", line = 88)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(III)I", line = 369)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "()V", line = 403)
