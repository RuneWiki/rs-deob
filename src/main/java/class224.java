...
public class class224 implements class196 {
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(BLfa;Lr;)V")
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(I)Loh;")
    public final class370 method640(int arg0) {
        field3114++;
        return arg0 == 58 ? class198.field2803 : null;
    }

    @OriginalMember(owner = "client!cca", name = "<init>", descriptor = "(Ljava/lang/String;Lor;Lma;IIIIIIIIII)V")
