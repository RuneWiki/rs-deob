...
public class class224 implements class479 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 16)
    ...
    @OriginalMember(owner = "client!id", name = "toString", descriptor = "()Ljava/lang/String;", line = 47)
    public final String toString() {
        field3354++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 61)
