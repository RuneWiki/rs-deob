...
public class class224 {
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(BI)V", line = 70)
    ...
    @OriginalMember(owner = "client!iba", name = "b", descriptor = "(II)V", line = 87)
    ...
    @OriginalMember(owner = "client!iba", name = "b", descriptor = "(B)V", line = 99)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(IIIIIZI[B[B)V", line = 122)
    ...
    @OriginalMember(owner = "client!iba", name = "c", descriptor = "(II)Lat;", line = 168)
    ...
    @OriginalMember(owner = "client!iba", name = "b", descriptor = "(I)V", line = 198)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(ZI)V", line = 227)
    ...
    @OriginalMember(owner = "client!iba", name = "<init>", descriptor = "(Ldh;IZLkha;Lkha;)V", line = 255)
