...
public class class224 extends class498 {
    ...
    @OriginalMember(owner = "client!jo", name = "e", descriptor = "(I)Lat;")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(ILza;I)Le;")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
