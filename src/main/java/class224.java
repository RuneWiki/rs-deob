...
public class class224 extends class386 {
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(IBLun;)V", line = 5)
    ...
    @OriginalMember(owner = "client!cca", name = "e", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(IZIIIIII)V", line = 54)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!cca", name = "e", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(IB)V", line = 217)
    ...
    @OriginalMember(owner = "client!cca", name = "b", descriptor = "(II)[[I", line = 477)
    ...
    @OriginalMember(owner = "client!cca", name = "<init>", descriptor = "()V", line = 538)
    public class224() {
        super(1, false);
    }
}
