...
public class class224 {
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(II)Lua;")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(ZZI)Lsc;")
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "(Lci;ILhe;)V")
