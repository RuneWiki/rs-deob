...
public abstract class class224 extends class71 {
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(I)Z", line = 16)
    ...
    @OriginalMember(owner = "client!qu", name = "c", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!qu", name = "d", descriptor = "(Z)I", line = 45)
    ...
    @OriginalMember(owner = "client!qu", name = "d", descriptor = "(I)Z", line = 57)
    ...
    @OriginalMember(owner = "client!qu", name = "<init>", descriptor = "(Ldw;)V", line = 72)
