...
public class class224 extends class353 {
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(Lkd;Lmv;)V")
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(ILqda;I)V")
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Lr;JB)V")
