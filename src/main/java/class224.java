...
public class class224 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(II)Lee;")
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(IILeg;Loj;IIB)V")
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(Lci;ILg;)V")
