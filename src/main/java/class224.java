...
public class class224 extends class305 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IIILjava/lang/Object;)[B", line = 25)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(ILfh;B)V", line = 56)
    ...
    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IIILso;Lso;)V", line = 92)
