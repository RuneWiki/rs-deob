...
public class class224 extends class156 {
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(II)Lkfa;", line = 5)
    public final class627 method481(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!ta", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Ld;Lwia;Ljava/lang/Integer;)Lha;", line = 13)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Ljava/lang/Object;Ljava/awt/Canvas;Z)V", line = 111)
    ...
    @OriginalMember(owner = "client!ta", name = "e", descriptor = "(B)V", line = 121)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(BLjagdx/IDirect3DPixelShader;)V", line = 133)
    ...
    @OriginalMember(owner = "client!ta", name = "k", descriptor = "(B)V", line = 146)
    ...
    @OriginalMember(owner = "client!ta", name = "S", descriptor = "(I)V", line = 220)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IBLhl;)V", line = 232)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Ltda;I)I", line = 244)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "()Z", line = 263)
    public final boolean method431() {
        return false;
    }

    @OriginalMember(owner = "client!ta", name = "L", descriptor = "(I)V", line = 271)
    ...
    @OriginalMember(owner = "client!ta", name = "I", descriptor = "()I", line = 286)
    public final int method476() {
        return 0;
    }

    @OriginalMember(owner = "client!ta", name = "h", descriptor = "(Z)V", line = 294)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IIII)V", line = 304)
    public final void method448(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!ta", name = "f", descriptor = "(Z)V", line = 309)
    ...
    @OriginalMember(owner = "client!ta", name = "y", descriptor = "()V", line = 351)
    ...
    @OriginalMember(owner = "client!ta", name = "r", descriptor = "(I)V", line = 375)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lbja;Lvea;I)Z", line = 391)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(BLef;)I", line = 402)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 433)
    public final void method498(Rectangle[] arg0, int arg1, int arg2, int arg3) throws class736 {
        this.method463(arg2, arg3);
    }

    @OriginalMember(owner = "client!ta", name = "l", descriptor = "()V", line = 439)
    public final void method468() {
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(BLjava/lang/Object;Ljava/awt/Canvas;)V", line = 446)
    public final void method1196(byte arg0, Object arg1, Canvas arg2) {
        int var4 = -76 / ((40 - arg0) / 60);
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(BZ)Lhl;", line = 453)
    public final class553 method1074(byte arg0, boolean arg1) {
        return arg0 == 46 ? new class91(this, arg1) : (class553) null;
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lvea;Lbja;III)Loga;", line = 463)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(ZZ)V", line = 473)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ZILcfa;I)V", line = 487)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(IB)Lnm;", line = 499)
    ...
    @OriginalMember(owner = "client!ta", name = "p", descriptor = "(B)V", line = 546)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(I[IIIIBZ)Loga;", line = 560)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ZII[[I)Lks;", line = 570)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ILcfa;)I", line = 580)
    ...
    @OriginalMember(owner = "client!ta", name = "e", descriptor = "()V", line = 611)
    public final void method447() {
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Ljava/lang/Object;Ljava/awt/Canvas;I)V", line = 614)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lpt;)V", line = 639)
    public final void method528(class555 arg0) {
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(BLvea;Lbja;)I", line = 642)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(Z)V", line = 682)
    public final void method554(boolean arg0) {
    }

    @OriginalMember(owner = "client!ta", name = "v", descriptor = "(B)V", line = 685)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ILad;)V", line = 696)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lip;ZII)V", line = 718)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IB)V", line = 766)
    ...
    @OriginalMember(owner = "client!ta", name = "n", descriptor = "(B)V", line = 777)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IIIBI[BZLvea;)Loga;", line = 814)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(IIIID)V", line = 821)
    public final void method460(int arg0, int arg1, int arg2, int arg3, double arg4) {
    }

    @OriginalMember(owner = "client!ta", name = "d", descriptor = "(I)V", line = 824)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lkfa;Lts;)Lpt;", line = 834)
    public final class555 method443(class627 arg0, class560 arg1) {
        return null;
    }

    @OriginalMember(owner = "client!ta", name = "t", descriptor = "(B)V", line = 842)
    ...
    @OriginalMember(owner = "client!ta", name = "l", descriptor = "(Z)V", line = 853)
    ...
    @OriginalMember(owner = "client!ta", name = "F", descriptor = "(I)V", line = 863)
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/bd;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Lhja;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Ld;Lwia;I)V", line = 880)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(BLkq;)V", line = 928)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lwe;I)V", line = 939)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(II)V", line = 964)
    ...
    @OriginalMember(owner = "client!ta", name = "GA", descriptor = "(I)V", line = 988)
    public final void method509(int arg0) {
        this.field3450.Clear(1, arg0, 0.0F, 0);
    }

    @OriginalMember(owner = "client!ta", name = "d", descriptor = "(IZ)Ldk;", line = 1000)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IILjagdx/IDirect3D;Ljagdx/D3DPRESENT_PARAMETERS;BI)Z", line = 1011)
    ...
    @OriginalMember(owner = "client!ta", name = "o", descriptor = "(I)V", line = 1114)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lde;B)I", line = 1131)
    ...
    @OriginalMember(owner = "client!ta", name = "A", descriptor = "()Lcq;", line = 1162)
    ...
    @OriginalMember(owner = "client!ta", name = "I", descriptor = "(I)V", line = 1171)
    ...
    @OriginalMember(owner = "client!ta", name = "o", descriptor = "()V", line = 1207)
    public final void method484() {
        this.field3446.method3958(26288);
        super.method484();
    }

    @OriginalMember(owner = "client!ta", name = "na", descriptor = "(IIII)[I", line = 1216)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lqaa;Lqaa;FLqaa;)Lqaa;", line = 1256)
    public final class29 method470(class29 arg0, class29 arg1, float arg2, class29 arg3) {
        return (arg2 < 0.5F) ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!ta", name = "E", descriptor = "(I)F", line = 1263)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(I[Lwk;)Lkq;", line = 1273)
    public final class618 method1151(int arg0, class152[] arg1) {
        return arg0 == 12 ? new dxVertexLayout(this, arg1) : (class618) null;
    }

    @OriginalMember(owner = "client!ta", name = "u", descriptor = "(B)V", line = 1283)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ILqf;)V", line = 1296)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Ljagdx/IDirect3DVertexShader;Z)V", line = 1319)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ILvea;Lbja;)Z", line = 1332)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ILpb;)V", line = 1343)
    ...
    @OriginalMember(owner = "client!ta", name = "M", descriptor = "(I)V", line = 1383)
    ...
    @OriginalMember(owner = "client!ta", name = "r", descriptor = "(B)V", line = 1412)
    ...
    @OriginalMember(owner = "client!ta", name = "q", descriptor = "(I)V", line = 1422)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ILdk;IIILcfa;B)V", line = 1456)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(BLjava/awt/Canvas;)Ljava/lang/Object;", line = 1474)
    ...
    @OriginalMember(owner = "client!ta", name = "d", descriptor = "(II)Lts;", line = 1484)
    public final class560 method532(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!ta", name = "z", descriptor = "()V", line = 1490)
    public final void method548() {
    }

    @OriginalMember(owner = "client!ta", name = "N", descriptor = "(I)V", line = 1493)
    ...
    @OriginalMember(owner = "client!ta", name = "ab", descriptor = "(I)Z", line = 1505)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(I)V", line = 1543)
    public final synchronized void method454(int arg0) {
        this.field3446.method3960((byte) 69);
        super.method454(arg0);
    }

    @OriginalMember(owner = "client!ta", name = "F", descriptor = "(II)V", line = 1551)
    public final void method450(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IILvea;ZI[FZI)Loga;", line = 1554)
    ...
    @OriginalMember(owner = "client!ta", name = "f", descriptor = "()Z", line = 1564)
    public final boolean method451() {
        return false;
    }

    @OriginalMember(owner = "client!ta", name = "D", descriptor = "(I)V", line = 1573)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(FFF)V", line = 1585)
    public final void method499(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!ta", name = "c", descriptor = "(B)V", line = 1588)
    ...
    @OriginalMember(owner = "client!ta", name = "t", descriptor = "()V", line = 1605)
    public final void method506() {
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lip;Z)I", line = 1608)
    ...
    @OriginalMember(owner = "client!ta", name = "m", descriptor = "(B)V", line = 1634)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ZZBLip;I)V", line = 1646)
    ...
    @OriginalMember(owner = "client!ta", name = "e", descriptor = "(Z)V", line = 1694)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lvea;[BIZII)Lgga;", line = 1706)
