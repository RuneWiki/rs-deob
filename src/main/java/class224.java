...
public class class224 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(ILve;)V", line = 28)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Lhh;ILhh;Lhh;Lhh;)V", line = 45)
    ...
    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(I)Lve;", line = 64)
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "()V", line = 195)
    public class224() {
        this.field3238.field5259 = this.field3238;
        this.field3238.field5262 = this.field3238;
    }

    @OriginalMember(owner = "client!gd", name = "c", descriptor = "(I)Lve;", line = 90)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(CB)C", line = 113)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Lps;I)V", line = 148)
    ...
    @OriginalMember(owner = "client!gd", name = "d", descriptor = "(I)I", line = 175)
    ...
    @OriginalMember(owner = "client!gd", name = "e", descriptor = "(I)V", line = 204)
