...
public class class224 {
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!dg", name = "c", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(III)V", line = 103)
