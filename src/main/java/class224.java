...
public class class224 {
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IBZII)V", line = 9)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(I)Lso;", line = 287)
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(I)V", line = 362)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Les;II)V", line = 372)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(ILes;)V", line = 455)
    ...
    @OriginalMember(owner = "client!su", name = "c", descriptor = "(I)Z", line = 478)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(B)Z", line = 508)
    ...
    @OriginalMember(owner = "client!su", name = "d", descriptor = "(I)V", line = 537)
    ...
    @OriginalMember(owner = "client!su", name = "e", descriptor = "(I)Lso;", line = 569)
