...
public class class224 extends class536 {
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(IIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!bea", name = "d", descriptor = "()I", line = 27)
    public final int method1504() {
        field3292++;
        return this.field3298 - (-this.field3283 - this.field3294);
    }

    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(IIII)V", line = 36)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(IIIII)V", line = 48)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(III)V", line = 89)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(IILaa;II)V", line = 201)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "([I)V", line = 246)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(FFFFFFIIII)V", line = 258)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(ILjava/lang/String;)V", line = 324)
    ...
    @OriginalMember(owner = "client!bea", name = "b", descriptor = "()I", line = 359)
    public final int method1510() {
        field3286++;
        return this.field3274;
    }

    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(IIII[III)V", line = 368)
    ...
    @OriginalMember(owner = "client!bea", name = "b", descriptor = "(III)V", line = 377)
    ...
    @OriginalMember(owner = "client!bea", name = "b", descriptor = "(IIIIIII)V", line = 403)
    ...
    @OriginalMember(owner = "client!bea", name = "<init>", descriptor = "(Lwu;IIZ)V", line = 947)
    ...
    @OriginalMember(owner = "client!bea", name = "<init>", descriptor = "(Lwu;II[III)V", line = 962)
    ...
    @OriginalMember(owner = "client!bea", name = "c", descriptor = "()I", line = 615)
    public final int method1514() {
        field3291++;
        return this.field3274 + this.field3285 + this.field3296;
    }

    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(IIIBIIII)V", line = 623)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(IIIIIIII)V", line = 792)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(IILjava/lang/String;)V", line = 841)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "()I", line = 860)
    public final int method1517() {
        field3277++;
        return this.field3298;
    }

    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(FFFFFFILaa;II)V", line = 868)
