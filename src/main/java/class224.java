...
public class class224 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II)Ltw;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IILbl;Lr;ZZIBIILr;Lla;)Lf;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIILr;IBILbl;)Lf;")
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Lnq;IZLka;Lga;Lga;)V")
