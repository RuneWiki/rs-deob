...
public class class224 extends class489 {
    ...
    @OriginalMember(owner = "client!gd", name = "B", descriptor = "(CIIIZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "(Lvj;Leu;[Lwe;Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(CIIIZLea;II)V", line = 230)
