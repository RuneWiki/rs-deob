...
public abstract class class224 implements class346 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!nj", name = "b", descriptor = "(B)V", line = 72)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(B)Z", line = 100)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(ZI)V", line = 128)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 152)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 179)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(BI[Ljava/lang/Object;I[I)V", line = 291)
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(Lri;Lri;Lrc;)V", line = 347)
