...
public class class224 {
    ...
    @OriginalMember(owner = "client!br", name = "c", descriptor = "(I)Lefa;")
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Ljava/lang/String;B)Z")
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IB)Liaa;")
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Luea;ILpq;Lpq;)V")
