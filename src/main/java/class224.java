...
public class class224 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!rv", name = "finalize", descriptor = "()V", line = 29)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(IIB)V", line = 39)
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "(Lvd;JI)V", line = 63)
    public class224(class258 arg0, long arg1, int arg2) {
        this.field3166 = arg0;
        this.field3165 = arg1;
    }

    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(B)V", line = 74)
