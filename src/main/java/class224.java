...
public class class224 {
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(III)B", line = 6)
    ...
    @OriginalMember(owner = "client!pea", name = "b", descriptor = "(III)I", line = 25)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!pea", name = "c", descriptor = "(III)V", line = 64)
