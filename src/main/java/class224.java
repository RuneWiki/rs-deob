...
public class class224 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IILvh;I)Lji;")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(JI)Lut;")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(JILut;)V")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(ZLvh;)I")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Lem;I)Ljava/lang/String;")
