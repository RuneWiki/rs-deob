...
public class class224 extends class220 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IBLil;)V")
    ...
    @OriginalMember(owner = "client!er", name = "d", descriptor = "(II)Lki;")
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(ILqj;)V")
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(ILil;I)Ljava/lang/String;")
