...
public class class224 extends class283 {
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ILqga;)V", line = 3)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Z)V", line = 177)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(II)V", line = 205)
    ...
    @OriginalMember(owner = "client!dt", name = "b", descriptor = "(II)V", line = 231)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "([I[II)V", line = 261)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(IIIIII)V", line = 290)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Lfba;I)V", line = 372)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Lfba;B)V", line = 397)
    ...
    @OriginalMember(owner = "client!dt", name = "b", descriptor = "(Z)V", line = 423)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(IB)V", line = 446)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ZI)V", line = 497)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ILfba;)V", line = 525)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(BLd;IZ)V", line = 560)
