...
public class class224 extends class42 {
    ...
    @OriginalMember(owner = "client!rd", name = "e", descriptor = "(I)[B", line = 6)
    ...
    @OriginalMember(owner = "client!rd", name = "f", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!rd", name = "d", descriptor = "(I)I", line = 51)
