...
public class class224 {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IIZZ)I", line = 3)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ILia;)Lpj;", line = 28)
    ...
    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ZLpd;ILpd;I)Lhs;", line = 115)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Z)Z", line = 158)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Lpd;IZLpd;)Lhs;", line = 191)
    ...
    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "(Llq;Ldk;)V", line = 202)
