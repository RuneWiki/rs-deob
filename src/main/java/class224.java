...
public class class224 {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(ZJ)Lpm;", line = 24)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Lpm;BJ)V", line = 63)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IIBII)V", line = 86)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(I)Lpm;", line = 109)
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "(I)V", line = 146)
