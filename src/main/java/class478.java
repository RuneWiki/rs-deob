...
public class class478 {
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Lha;Llaa;)Z")
    ...
    @OriginalMember(owner = "client!laa", name = "b", descriptor = "(Lha;Llaa;)V")
    ...
    @OriginalMember(owner = "client!laa", name = "c", descriptor = "(Lha;Llaa;)Z")
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Lha;IIIIII)V")
    ...
    @OriginalMember(owner = "client!laa", name = "d", descriptor = "(Lha;Llaa;)V")
