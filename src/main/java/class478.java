...
public class class478 extends class116 implements class439 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(FFFFFFLpa;II)V", line = 9)
    ...
    @OriginalMember(owner = "client!t", name = "BA", descriptor = "(III)V", line = 17)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IILpa;II)V", line = 31)
    public final void method236(int arg0, int arg1, class594 arg2, int arg3, int arg4) {
        this.method2902(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(La;Lc;[IIIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(La;Lc;IIII)V", line = 42)
