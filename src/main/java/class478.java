...
public class class478 {
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(III)I", line = 5)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(Lgw;)V", line = 35)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "()V", line = 99)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(II)[I", line = 131)
