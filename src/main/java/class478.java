...
public abstract class class478 extends class333 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Z)I", line = 28)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(III)[I", line = 67)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(Z)V", line = 87)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(ILnp;I)V", line = 113)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(I)I", line = 123)
    public int method109(int arg0) {
        field6885++;
        return arg0 == -1 ? -1 : -126;
    }

    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IIB)[[I", line = 140)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(BLjava/lang/String;)V", line = 172)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(II)[I", line = 207)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(ZI)[[I", line = 221)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "(IZ)V", line = 243)
