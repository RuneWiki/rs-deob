...
public class class478 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;)V", line = 19)
