...
public class class478 implements class590 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIIBIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IZ)V", line = 48)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(B)Z", line = 74)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(I)V", line = 200)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Lmv;Lru;)V", line = 217)
    public class478(class295 arg0, class231 arg1) {
        this.field6849 = arg0;
        this.field6847 = arg1;
    }

    @OriginalMember(owner = "client!ao", name = "c", descriptor = "(I)V", line = 226)
