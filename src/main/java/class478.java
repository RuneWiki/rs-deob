...
public class class478 {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(BLhf;)V")
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ILhf;)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Ljava/lang/Object;IILhf;)V")
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Lqf;I)V")
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Lqn;ILqn;)V")
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Lhf;ILjava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ILmv;Lmv;IZ)I")
