...
public class class478 {
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(IZ)I", line = 9)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!rca", name = "<init>", descriptor = "(IIIIIIIIIIIIII)V", line = 78)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 109)
