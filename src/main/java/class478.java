...
public class class478 extends class430 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(BLla;)V", line = 10)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(I)I", line = 26)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(I)Z", line = 37)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(BI)Z", line = 48)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(II)V", line = 59)
    public class478(int arg0, int arg1) {
        this.field6793 = arg0;
        this.field6790 = arg1;
    }

    @OriginalMember(owner = "client!ea", name = "c", descriptor = "(I)Z", line = 68)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(Z)Z", line = 79)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(BII)Z", line = 90)
    ...
    @OriginalMember(owner = "client!ea", name = "c", descriptor = "(Z)I", line = 102)
