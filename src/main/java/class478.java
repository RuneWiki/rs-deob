...
public class class478 extends class11 implements class338 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lqa;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!qf", name = "c", descriptor = "(I)I", line = 22)
    ...
    @OriginalMember(owner = "client!qf", name = "d", descriptor = "(I)Z", line = 34)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IBII)I", line = 45)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(B)I", line = 72)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(I)V", line = 86)
    public final void method342(int arg0) {
        ++field6590;
        int var2 = 109 % ((56 - arg0) / 52);
    }

    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(Lqa;Lus;IIIIIZIIIIII)V", line = 95)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IIIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(ILqa;)Lfm;", line = 119)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IILqa;I)Z", line = 160)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(BLqa;I)Lc;", line = 178)
    ...
    @OriginalMember(owner = "client!qf", name = "c", descriptor = "(B)I", line = 191)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ILqa;)V", line = 207)
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(I)I", line = 218)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lqa;I)V", line = 231)
    ...
    @OriginalMember(owner = "client!qf", name = "f", descriptor = "(I)V", line = 242)
