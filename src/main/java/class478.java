...
public class class478 extends class386 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IBLun;)V", line = 5)
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "()V", line = 55)
    public class478() {
        super(1, true);
    }

    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(BI)[I", line = 60)
    ...
    @OriginalMember(owner = "client!gq", name = "e", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(BII)I", line = 90)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(II)[I", line = 114)
    ...
    @OriginalMember(owner = "client!gq", name = "f", descriptor = "(I)V", line = 159)
    ...
    @OriginalMember(owner = "client!gq", name = "g", descriptor = "(I)V", line = 339)
