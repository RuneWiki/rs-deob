...
public class class478 extends class335 {
    ...
    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "()V", line = 6)
    public class478() {
        super(0, true);
    }

    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ZI)[I", line = 10)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ILio;I)V", line = 217)
    ...
    @OriginalMember(owner = "client!o", name = "b", descriptor = "(Z)V", line = 293)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Lga;B)V", line = 330)
    ...
    @OriginalMember(owner = "client!o", name = "d", descriptor = "(I)V", line = 358)
    public static void method2753(int arg0) {
        field6647 = null;
        int var1 = -13 % ((arg0 - -56) / 52);
    }

    @OriginalMember(owner = "client!o", name = "a", descriptor = "(B)V", line = 384)
