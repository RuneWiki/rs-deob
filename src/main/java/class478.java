...
public class class478 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ZI)Lqu;")
    ...
    @OriginalMember(owner = "client!fb", name = "c", descriptor = "(II)Ler;")
    ...
    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "(Ld;IZLfo;Lfo;)V")
