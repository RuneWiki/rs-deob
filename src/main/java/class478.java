...
public class class478 extends class513 {
    ...
    @OriginalMember(owner = "client!oja", name = "a", descriptor = "(Z)Z", line = 3)
    ...
    @OriginalMember(owner = "client!oja", name = "b", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!oja", name = "<init>", descriptor = "(Lwg;II[B)V", line = 43)
    ...
    @OriginalMember(owner = "client!oja", name = "<init>", descriptor = "(Lwg;II[I)V", line = 55)
