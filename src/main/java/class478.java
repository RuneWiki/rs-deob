...
public class class478 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lfca;IZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(B)V", line = 160)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(I)V", line = 186)
