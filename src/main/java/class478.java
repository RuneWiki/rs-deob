...
public class class478 extends class107 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIILpba;Lpba;)V")
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(Lgca;IIZ)V")
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(Lgca;II[III)V")
