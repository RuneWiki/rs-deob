...
public class class478 extends class454 {
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(ILgga;I)Lrt;", line = 4)
    ...
    @OriginalMember(owner = "client!mw", name = "<init>", descriptor = "(Lko;)V", line = 20)
    public class478(class326 arg0) {
        this.field6576 = arg0;
    }

    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(BB)C", line = 32)
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(Z)V", line = 59)
