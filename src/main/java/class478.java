...
public class class478 extends class659 {
    ...
    @OriginalMember(owner = "client!td", name = "d", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(IB)I", line = 35)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(ZILka;Lln;II)V", line = 75)
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZJZ)V", line = 89)
