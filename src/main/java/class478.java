...
public class class478 extends class401 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Lin;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "()V", line = 44)
    public class478() {
    }

    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "(J)V", line = 46)
