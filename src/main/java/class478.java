...
public class class478 extends class739 {
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(Log;Lega;IIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(I)[Lega;")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(B)Lio;")
