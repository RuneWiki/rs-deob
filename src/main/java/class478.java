...
public class class478 extends class338 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 5)
    public static final void method2736(String arg0, int arg1) {
        class648.method3634(0, arg0, (byte) -13, "", "", arg1, "");
        field6462++;
    }

    @OriginalMember(owner = "client!la", name = "a", descriptor = "(BI)Lot;", line = 18)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/lang/String;CI)[Ljava/lang/String;", line = 44)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I)Laca;", line = 79)
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(ILeaa;Lcq;III)V", line = 90)
    public class478(int arg0, class528 arg1, class494 arg2, int arg3, int arg4, int arg5) {
        super(arg0, arg1, arg2, arg3, arg4);
        this.field6460 = arg5;
    }

    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IZI)V", line = 98)
    ...
    @OriginalMember(owner = "client!la", name = "b", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(III)V", line = 131)
