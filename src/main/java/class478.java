...
public abstract class class478 implements class233 {
    ...
    @OriginalMember(owner = "client!sv", name = "finalize", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!sv", name = "b", descriptor = "(I)I", line = 16)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!sv", name = "c", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(ZI)V", line = 64)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(II)V", line = 84)
    ...
    @OriginalMember(owner = "client!sv", name = "d", descriptor = "(I)I", line = 98)
    ...
    @OriginalMember(owner = "client!sv", name = "b", descriptor = "(B)Z", line = 110)
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "(Lih;IIIZ)V", line = 198)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IZ)V", line = 140)
    ...
    @OriginalMember(owner = "client!sv", name = "e", descriptor = "(I)V", line = 161)
