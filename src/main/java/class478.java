...
public class class478 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ILph;)I", line = 10)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IIII)V", line = 79)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IIIIILta;Lza;Lgh;I)V", line = 93)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(III)Z", line = 194)
