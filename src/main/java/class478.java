...
public class class478 implements class659 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(I)Lps;")
    public final class82 method775(int arg0) {
        int var2 = -4 % ((-arg0 - 31) / 57);
        return this.field6675;
    }

    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(Lvg;Lps;Z)V")
