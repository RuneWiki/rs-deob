...
public class class478 extends class345 {
    ...
    @OriginalMember(owner = "client!qq", name = "c", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IIIIIIIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "(Lbi;)V", line = 33)
    public class478(class483 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qq", name = "d", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ZB)V", line = 86)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(I)Z", line = 107)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ZI)V", line = 118)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IILcj;)V", line = 128)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ZII)V", line = 142)
