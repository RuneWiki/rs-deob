...
public class class478 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Ldn;Ldn;Lli;Ldn;I)Z")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Lsc;IIIII)V")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(III)Ltg;")
