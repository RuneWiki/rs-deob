...
public class class478 extends class34 {
    ...
    @OriginalMember(owner = "client!sm", name = "b", descriptor = "(IB)[I", line = 3)
    ...
    @OriginalMember(owner = "client!sm", name = "c", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IB)[I", line = 45)
    ...
    @OriginalMember(owner = "client!sm", name = "e", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "()V", line = 274)
    public class478() {
        super(1, true);
    }

    @OriginalMember(owner = "client!sm", name = "f", descriptor = "(I)V", line = 278)
    ...
    @OriginalMember(owner = "client!sm", name = "g", descriptor = "(I)V", line = 298)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lsv;II)V", line = 329)
