...
public class class478 extends class377 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IBIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!qf", name = "c", descriptor = "(B)V", line = 442)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IBIIIIIIII)V", line = 474)
    ...
    @OriginalMember(owner = "client!qf", name = "f", descriptor = "(I)V", line = 555)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lvg;ZZ)V", line = 567)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IZI)Z", line = 593)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IIIII)V", line = 612)
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(Lod;II)V", line = 633)
