...
public class class478 implements class121 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(I)Lev;")
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Ltc;BLtc;)V")
    ...
    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "(Lpe;Ljava/lang/String;)V")
