...
public class class478 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Lr;)V")
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Lr;Lvs;)Z")
    public final boolean method2799(class98 arg0, class478 arg1) {
        return this.field6848 != null || this.method2800(arg0, arg1);
    }

    @OriginalMember(owner = "client!vs", name = "b", descriptor = "(Lr;Lvs;)Z")
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Lr;IIIIII)V")
    ...
    @OriginalMember(owner = "client!vs", name = "c", descriptor = "(Lr;Lvs;)V")
    ...
    @OriginalMember(owner = "client!vs", name = "b", descriptor = "(Lr;)V")
    ...
    @OriginalMember(owner = "client!vs", name = "d", descriptor = "(Lr;Lvs;)V")
