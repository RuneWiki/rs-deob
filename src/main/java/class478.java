...
public class class478 extends class10 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(III)Lkp;")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(B)Lms;")
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(ILce;Lce;Lgm;Lwo;IIZ)V")
