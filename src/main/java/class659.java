...
public class class659 extends class353 implements class526 {
    ...
    @OriginalMember(owner = "client!ki", name = "e", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(III)I", line = 20)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILr;)Lcr;", line = 109)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Z)I", line = 127)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IZLr;)Lda;", line = 139)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(I)V", line = 158)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(Lr;I)Lbca;", line = 175)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(Z)Z", line = 206)
    public final boolean method216(boolean arg0) {
        ++field9143;
        return !arg0 ? true : true;
    }

    @OriginalMember(owner = "client!ki", name = "d", descriptor = "(I)I", line = 217)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(I)Z", line = 228)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IIILr;)Z", line = 239)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IIIBI)Z", line = 263)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(B)I", line = 285)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lr;I)V", line = 295)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(B)I", line = 322)
    ...
    @OriginalMember(owner = "client!ki", name = "k", descriptor = "(I)V", line = 340)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lr;Z)V", line = 353)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(BLr;)V", line = 363)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IZILr;)Lfh;", line = 390)
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "(Lr;Ljs;IIIIIZIIII)V", line = 424)
    ...
    @OriginalMember(owner = "client!ki", name = "f", descriptor = "(I)I", line = 451)
