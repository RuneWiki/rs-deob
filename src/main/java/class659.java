...
public class class659 extends class154 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(ZLfca;)V")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(B[Lnf;)V")
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(ZLlu;)V")
