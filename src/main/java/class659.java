...
public class class659 extends class379 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IIIBLlc;I)Ljava/awt/Frame;", line = 3)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Lbt;Lbt;I[I)V", line = 95)
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(II)V", line = 110)
