...
public class class659 extends class38 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(II[F)[F", line = 3)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IILrg;)V", line = 24)
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(BI)Z", line = 59)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "()V", line = 200)
    public class659() {
        super(1, false);
    }

    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(BI)[I", line = 75)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(II)[[I", line = 129)
