...
public class class659 implements class48 {
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(B)Lvca;")
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(Loh;BLgh;)V")
    ...
    @OriginalMember(owner = "client!bca", name = "<init>", descriptor = "(Loh;Ljava/lang/String;)V")
