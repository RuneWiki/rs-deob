...
public class class659 extends class508 {
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(B)J", line = 7)
    ...
    @OriginalMember(owner = "client!fj", name = "c", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!fj", name = "d", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!fj", name = "finalize", descriptor = "()V", line = 46)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Lqj;II)V", line = 64)
