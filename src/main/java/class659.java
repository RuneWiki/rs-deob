...
public class class659 extends class530 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(II)I", line = 15)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(I)I", line = 41)
    ...
    @OriginalMember(owner = "client!jj", name = "c", descriptor = "(I)I", line = 56)
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(ILah;)V", line = 67)
    public class659(int arg0, class374 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!jj", name = "b", descriptor = "(II)V", line = 70)
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(Lah;)V", line = 82)
