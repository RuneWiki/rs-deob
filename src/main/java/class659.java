...
public class class659 {
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IIII)V", line = 12)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(III[I)Lib;", line = 49)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(II[I)Lib;", line = 105)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(I[III)Lib;", line = 128)
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "(Lni;Lni;)V", line = 202)
    public class659(class522 arg0, class522 arg1) {
        this.field9188 = arg0;
        this.field9187 = arg1;
    }

    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IZ[I)Lib;", line = 167)
