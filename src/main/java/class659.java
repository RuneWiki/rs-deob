...
public class class659 extends class335 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(ILio;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(ZI)[I", line = 77)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(ZIIIII)V", line = 103)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(II)Z", line = 230)
    ...
    @OriginalMember(owner = "client!wa", name = "<init>", descriptor = "()V", line = 241)
    public class659() {
        super(0, true);
    }

    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IZ)[[I", line = 244)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "([[IB)V", line = 309)
