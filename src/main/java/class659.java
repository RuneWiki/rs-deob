...
public abstract class class659 implements class644 {
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(ILfw;)V")
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(ZILrda;)V")
    ...
    @OriginalMember(owner = "client!mga", name = "<init>", descriptor = "(Ldda;ILfca;Lbv;IZ)V")
