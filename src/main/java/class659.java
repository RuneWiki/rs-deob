...
public class class659 extends class390 {
    ...
    @OriginalMember(owner = "client!dw", name = "<init>", descriptor = "(Leda;Lcga;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Lr;III[Z)V")
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(I[Lqk;Z)V")
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(II)Lsn;")
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(I)Lhr;")
