...
public class class659 extends class66 {
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(Lkt;)V", line = 92)
    public class659(class143 arg0) {
        this.field9179 = arg0;
    }

    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(IBII)V", line = 16)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(III)Z", line = 33)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(I)V", line = 61)
