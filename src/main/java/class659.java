...
public class class659 {
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(III[[ZIZ)V", line = 32)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(IIBII)V", line = 217)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(I[SI)[S", line = 257)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Lw;III)Z", line = 273)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(IIIIZ)V", line = 355)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(IILw;I)V", line = 629)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(I)V", line = 700)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(ILw;II)V", line = 740)
    ...
    @OriginalMember(owner = "client!waa", name = "b", descriptor = "(I)V", line = 811)
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "(Lno;Lsm;)V", line = 820)
