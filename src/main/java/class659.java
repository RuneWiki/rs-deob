...
public abstract class class659 extends class578 {
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 5)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V", line = 31)
