...
public abstract class class659 extends class333 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IBI)Z", line = 6)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(B)Z", line = 20)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ILi;)V", line = 33)
    public static final void method3656(int arg0, class274 arg1) {
        class156.field1743[arg0] = arg1;
    }

    @OriginalMember(owner = "client!oq", name = "c", descriptor = "(I)I", line = 41)
    ...
    @OriginalMember(owner = "client!oq", name = "b", descriptor = "(B)Z", line = 54)
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "(Lvj;)V", line = 70)
    public class659(class422 arg0) {
        this.field9248 = arg0;
    }

    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Z)I", line = 81)
