...
public class class659 extends class514 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(ZB)I", line = 19)
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(Lai;II[B)V", line = 61)
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(Lai;II[I)V", line = 74)
