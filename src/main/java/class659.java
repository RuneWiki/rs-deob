...
public class class659 extends class345 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IILcj;)V")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lnd;Lbl;ZLnd;Lnd;Lcea;)Z")
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(Lbi;Llha;)V")
    ...
    @OriginalMember(owner = "client!qp", name = "d", descriptor = "(I)Llk;")
