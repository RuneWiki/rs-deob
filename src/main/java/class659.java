...
public class class659 extends class50 implements class612 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "([BIIIIIIILjb;)V")
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(Lad;Ljb;II[BII)V")
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(Lad;Ljb;II[FII)V")
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(Lad;Ljb;Lqda;II)V")
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(Lad;II[III)V")
