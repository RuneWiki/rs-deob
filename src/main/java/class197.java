...
public class class197 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IIII)Lqq;", line = 26)
    ...
    @OriginalMember(owner = "client!dj", name = "toString", descriptor = "()Ljava/lang/String;", line = 66)
    public final String toString() {
        field2276++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!dj", name = "b", descriptor = "(I)V", line = 79)
