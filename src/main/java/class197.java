...
public class class197 extends class130 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ZLjava/lang/String;Ljava/lang/Throwable;)V", line = 22)
