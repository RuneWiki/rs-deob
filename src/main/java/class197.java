...
public class class197 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Llf;II)V")
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lvq;Ltj;I)V")
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IILlf;I)V")
