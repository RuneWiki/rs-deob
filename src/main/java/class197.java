...
public abstract class class197 implements class694 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(II)V", line = 9)
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(I)Z", line = 40)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Z)I", line = 64)
    ...
    @OriginalMember(owner = "client!jf", name = "c", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!jf", name = "d", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IILfga;BI)V", line = 119)
    ...
    @OriginalMember(owner = "client!jf", name = "finalize", descriptor = "()V", line = 159)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(I[J[Ljava/lang/Object;BI)V", line = 168)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(ZB)V", line = 226)
    ...
    @OriginalMember(owner = "client!jf", name = "e", descriptor = "(I)V", line = 248)
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Lkga;IIIZ)V", line = 317)
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(B)I", line = 283)
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(ZB)V", line = 294)
