...
public abstract class class197 extends class204 {
    ...
    @OriginalMember(owner = "client!bda", name = "k", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!bda", name = "b", descriptor = "(B)Z", line = 20)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(I[Lam;)I", line = 32)
    ...
    @OriginalMember(owner = "client!bda", name = "f", descriptor = "(I)Z", line = 114)
    ...
    @OriginalMember(owner = "client!bda", name = "d", descriptor = "(Z)V", line = 125)
    ...
    @OriginalMember(owner = "client!bda", name = "<init>", descriptor = "(IIIIII)V", line = 190)
