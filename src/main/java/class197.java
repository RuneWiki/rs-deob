...
public class class197 extends class499 {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(IIIIZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!vt", name = "d", descriptor = "(I)I", line = 134)
    ...
    @OriginalMember(owner = "client!vt", name = "e", descriptor = "(I)Z", line = 146)
    ...
    @OriginalMember(owner = "client!vt", name = "f", descriptor = "(I)Z", line = 157)
    ...
    @OriginalMember(owner = "client!vt", name = "c", descriptor = "(B)Z", line = 169)
    ...
    @OriginalMember(owner = "client!vt", name = "b", descriptor = "(II)Z", line = 180)
    ...
    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "(II)V", line = 201)
    public class197(int arg0, int arg1) {
        this.field2835 = arg1;
        this.field2833 = arg0;
    }

    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Z)I", line = 214)
