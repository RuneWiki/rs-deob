...
public class class197 extends class85 {
    ...
    @OriginalMember(owner = "client!vd", name = "U", descriptor = "Llf;")
    public static class109 field3767 = class35.method275("::autoshadow off", 2);

    @OriginalMember(owner = "client!vd", name = "V", descriptor = "Llf;")
    private static class109 field3768 = class35.method275("Connecting to server)3)3)3", 2);

    @OriginalMember(owner = "client!vd", name = "db", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!vd", name = "W", descriptor = "[Llf;")
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(BILja;)V")
