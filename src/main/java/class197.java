...
public class class197 extends class119 {
    ...
    @OriginalMember(owner = "client!me", name = "b", descriptor = "(B)[B", line = 4)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(I[B[BIIIIII)V", line = 34)
    ...
    @OriginalMember(owner = "client!me", name = "c", descriptor = "(I)I", line = 78)
    ...
    @OriginalMember(owner = "client!me", name = "e", descriptor = "(I)V", line = 92)
