...
public class class197 {
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(Lep;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(Leda;BZZ)V", line = 21)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IBLep;)V", line = 78)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IILep;Lev;)V", line = 95)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(Lep;IZ)V", line = 260)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(B)V", line = 622)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(B[BZ)V", line = 633)
    ...
    @OriginalMember(owner = "client!uw", name = "b", descriptor = "(Lep;I)V", line = 674)
    ...
    @OriginalMember(owner = "client!uw", name = "c", descriptor = "(Lep;I)V", line = 695)
