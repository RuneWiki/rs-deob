...
public class class197 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIILvga;IIILka;ILha;IIII)Lka;")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILaca;)V")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ZLii;ZB)V")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(II)Lma;")
    ...
    @OriginalMember(owner = "client!vr", name = "<init>", descriptor = "(Lcr;ILla;)V")
