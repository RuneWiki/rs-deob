...
public class class197 extends class133 {
    ...
    @OriginalMember(owner = "client!cea", name = "<init>", descriptor = "(Ler;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!cea", name = "<init>", descriptor = "(Ler;IIII)V")
    ...
    @OriginalMember(owner = "client!cea", name = "<init>", descriptor = "(Ler;IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!cea", name = "<init>", descriptor = "(Ler;IIIII)V")
    ...
    @OriginalMember(owner = "client!cea", name = "<init>", descriptor = "(Ler;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!cea", name = "<init>", descriptor = "(Ler;IIIZ[III)V")
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(IIILlr;ILr;)V")
    ...
    @OriginalMember(owner = "client!cea", name = "<init>", descriptor = "(Ler;IIII[I)V")
    public class197(class92 arg0, int arg1, int arg2, int arg3, int arg4, int[] arg5) {
    ...
    @OriginalMember(owner = "client!cea", name = "<init>", descriptor = "(Ler;IIIIIZ)V")
