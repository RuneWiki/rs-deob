...
public class class197 implements Runnable {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(ILqs;)V", line = 4)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lki;I)V", line = 48)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(BLjava/lang/String;)Lce;", line = 61)
    ...
    @OriginalMember(owner = "client!rb", name = "<init>", descriptor = "()V", line = 85)
    public class197() {
        this.field2678.setDaemon(true);
        this.field2678.start();
    }

    @OriginalMember(owner = "client!rb", name = "run", descriptor = "()V", line = 97)
