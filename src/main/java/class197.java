...
public class class197 {
    ...
    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "()V", line = 5)
    public class197() {
    }

    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "(Lvt;)V", line = 7)
    public class197(class197 arg0) {
