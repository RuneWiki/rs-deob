...
public class class197 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(ZBII)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!uk", name = "b", descriptor = "(I)V", line = 181)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Z)[Lje;", line = 197)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lro;Z)Z", line = 280)
    ...
    @OriginalMember(owner = "client!uk", name = "c", descriptor = "(I)V", line = 367)
    ...
    @OriginalMember(owner = "client!uk", name = "d", descriptor = "(I)V", line = 435)
