...
public class class197 extends class575 {
    ...
    @OriginalMember(owner = "client!rfa", name = "b", descriptor = "(IB)[B", line = 4)
    ...
    @OriginalMember(owner = "client!rfa", name = "b", descriptor = "(II)V", line = 26)
    ...
    @OriginalMember(owner = "client!rfa", name = "c", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(B)I", line = 76)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(Z)I", line = 99)
    ...
    @OriginalMember(owner = "client!rfa", name = "b", descriptor = "(B)I", line = 114)
    ...
    @OriginalMember(owner = "client!rfa", name = "b", descriptor = "(I)Lsv;", line = 126)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(II)I", line = 228)
    ...
    @OriginalMember(owner = "client!rfa", name = "d", descriptor = "(I)V", line = 255)
    ...
    @OriginalMember(owner = "client!rfa", name = "c", descriptor = "(B)I", line = 266)
    ...
    @OriginalMember(owner = "client!rfa", name = "<init>", descriptor = "(ILpk;Lpk;Lkha;Ltl;I[BIZ)V", line = 833)
    ...
    @OriginalMember(owner = "client!rfa", name = "e", descriptor = "(I)V", line = 292)
    ...
    @OriginalMember(owner = "client!rfa", name = "f", descriptor = "(I)V", line = 474)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(IBI)Lkt;", line = 549)
