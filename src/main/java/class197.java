...
public class class197 {
    ...
    @OriginalMember(owner = "client!o", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field2531++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Let;B)I", line = 13)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(B)V", line = 92)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Lha;IBI)V", line = 130)
    ...
    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "(II)V", line = 155)
