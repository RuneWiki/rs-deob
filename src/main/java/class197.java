...
public class class197 extends class401 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lac;B)V")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IBII)V")
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(ZLlaa;)V")
