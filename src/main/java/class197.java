...
public class class197 extends class585 {
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(ZI)[[I", line = 9)
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(IBI)V", line = 78)
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(Lso;II)V", line = 98)
    ...
    @OriginalMember(owner = "client!ffa", name = "c", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!ffa", name = "d", descriptor = "(B)I", line = 125)
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(BIIIIIIIII)V", line = 136)
    ...
    @OriginalMember(owner = "client!ffa", name = "<init>", descriptor = "()V", line = 213)
    public class197() {
        super(0, false);
    }

    @OriginalMember(owner = "client!ffa", name = "b", descriptor = "(IIB)Z", line = 216)
    ...
    @OriginalMember(owner = "client!ffa", name = "c", descriptor = "(I)V", line = 232)
