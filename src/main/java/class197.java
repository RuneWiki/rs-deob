...
public class class197 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IZIBI)Lbg;", line = 4)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(B)Z", line = 64)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lkh;Ljava/lang/String;I)I", line = 75)
    ...
    @OriginalMember(owner = "client!rb", name = "b", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!rb", name = "b", descriptor = "(B)Z", line = 124)
    ...
    @OriginalMember(owner = "client!rb", name = "c", descriptor = "(B)V", line = 135)
    ...
    @OriginalMember(owner = "client!rb", name = "d", descriptor = "(B)I", line = 149)
    ...
    @OriginalMember(owner = "client!rb", name = "c", descriptor = "(I)Z", line = 162)
    ...
    @OriginalMember(owner = "client!rb", name = "e", descriptor = "(B)I", line = 447)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IIII)V", line = 459)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(BI)Z", line = 472)
    ...
    @OriginalMember(owner = "client!rb", name = "f", descriptor = "(B)V", line = 490)
    ...
    @OriginalMember(owner = "client!rb", name = "d", descriptor = "(I)V", line = 517)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IZLpf;)V", line = 530)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IZ)V", line = 601)
