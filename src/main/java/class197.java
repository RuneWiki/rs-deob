...
public class class197 extends class532 {
    ...
    @OriginalMember(owner = "client!efa", name = "<init>", descriptor = "(Lnv;Lbt;Lrfa;)V", line = 4)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(ZB)V", line = 21)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(ZILgaa;)V", line = 34)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(III)V", line = 50)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(Z)V", line = 70)
    ...
    @OriginalMember(owner = "client!efa", name = "d", descriptor = "(B)Z", line = 88)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(ZI)V", line = 99)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(IBI)V", line = 110)
