...
public class class197 extends class220 {
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IBLil;)V")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Lal;I)V")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Lvp;I)I")
