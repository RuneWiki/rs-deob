...
public class class197 {
    ...
    @OriginalMember(owner = "client!ov", name = "b", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(ZII)Ljava/lang/String;", line = 38)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(IZI)B", line = 53)
