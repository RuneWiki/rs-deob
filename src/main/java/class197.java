...
public class class197 extends class478 implements class278 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ILkm;IZILkj;B)V")
    ...
    @OriginalMember(owner = "client!lg", name = "d", descriptor = "(Lkm;I)Lto;")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lkm;II)Lab;")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lkm;I)V")
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(Lkm;Lcj;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IZLkm;I)Llt;")
    ...
    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(Lkm;I)V")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ILkm;I)Lab;")
    ...
    @OriginalMember(owner = "client!lg", name = "c", descriptor = "(Lkm;I)V")
    public final void method197(class487 arg0, int arg1) {
        int var3 = -18 / ((64 - arg1) / 59);
        ++field2827;
    }

    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lkm;BII)Z")
