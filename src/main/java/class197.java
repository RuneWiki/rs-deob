...
public class class197 extends class62 {
    ...
    @OriginalMember(owner = "client!ue", name = "h", descriptor = "(I)V", line = 6)
    public static final void method1324(int arg0) {
        class487.field6920.method2800(arg0 ^ arg0);
        ++field2906;
    }

    @OriginalMember(owner = "client!ue", name = "i", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!ue", name = "<init>", descriptor = "()V", line = 34)
    public class197() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Lqa;III)V", line = 37)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 55)
    public static final int method1327(String arg0, int arg1) {
        ++field2909;
        return arg1 > -39 ? 48 : class528.method3187(true, 10, arg0, (byte) -106);
    }

    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IB)[[I", line = 67)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IIIIIII)V", line = 151)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Lgw;II)V", line = 182)
