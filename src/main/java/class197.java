...
public class class197 {
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Lhd;I)Z", line = 64)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(I[[[BIBII)V", line = 92)
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(Z)V", line = 229)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Lqn;ILya;Lqn;)V", line = 241)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(III)V", line = 257)
