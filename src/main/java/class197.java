...
public class class197 implements class205 {
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(Z)Lww;")
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IB)Lwe;")
    ...
    @OriginalMember(owner = "client!uw", name = "b", descriptor = "(I)[Lmga;")
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(BLnfa;III[IIIIII[IIZI)I")
    ...
    @OriginalMember(owner = "client!uw", name = "<init>", descriptor = "(ILrg;Lal;IIIIIIIZ)V")
