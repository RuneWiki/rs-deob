...
public class class197 extends class335 {
    ...
    @OriginalMember(owner = "client!be", name = "c", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "()V", line = 23)
    public class197() {
        super(0, false);
    }

    @OriginalMember(owner = "client!be", name = "b", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ILio;I)V", line = 41)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(I)I", line = 54)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IZ)[[I", line = 75)
    ...
    @OriginalMember(owner = "client!be", name = "d", descriptor = "(I)V", line = 141)
