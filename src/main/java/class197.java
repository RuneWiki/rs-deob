...
public class class197 extends class499 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(ILsfa;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IZ)V", line = 30)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Lck;I)V", line = 74)
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(ZZ)V", line = 134)
    ...
    @OriginalMember(owner = "client!wl", name = "<init>", descriptor = "(Ljc;Lwm;Ljga;)V", line = 145)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Z)Z", line = 165)
    public final boolean method200(boolean arg0) {
        ++field2745;
        return !arg0 ? true : this.field2742;
    }

    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(BII)V", line = 181)
