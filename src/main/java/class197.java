...
public class class197 extends class288 implements class294 {
    ...
    @OriginalMember(owner = "client!w", name = "f", descriptor = "(I)Ln;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "([Le;Lc;[Lpr;I)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lfj;[Lef;Z)Lla;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lip;)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(I[Lbk;)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lpn;IIII)Le;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(IIIIIF)Lbk;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lqg;Lqg;FLqg;)Lqg;")
    ...
    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "(ILjava/awt/Canvas;Ll;Llt;)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "([Le;Lip;Lc;[Lpr;I)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lip;Z)V")
    ...
    @OriginalMember(owner = "client!w", name = "d", descriptor = "(IIIIII)Lqg;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lef;Z)Lo;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lqg;)V")
