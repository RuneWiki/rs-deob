...
public class class197 implements Runnable {
    ...
    @OriginalMember(owner = "client!vt", name = "run", descriptor = "()V", line = 25)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!vt", name = "b", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Ljava/lang/String;B)Lcw;", line = 103)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(FIFF)I", line = 125)
    ...
    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "()V", line = 189)
    public class197() {
        this.field2876.setDaemon(true);
        this.field2876.start();
    }

    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Lkp;B)V", line = 176)
