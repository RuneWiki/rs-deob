...
public class class197 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(II)Lmn;", line = 3)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Ltq;I)[Lng;", line = 45)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(III)Z", line = 107)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(BI)V", line = 124)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IIIIB)V", line = 138)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(II)V", line = 274)
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(Lcda;ILkea;)V", line = 327)
