...
public class class197 {
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(I)J", line = 4)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(Lcn;III)V", line = 30)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(I[BI)I", line = 79)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(B)V", line = 90)
