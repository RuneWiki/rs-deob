...
public class class197 extends class287 implements class350 {
    ...
    @OriginalMember(owner = "client!w", name = "d", descriptor = "()Lc;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Leu;Z)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Leu;)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(I[Lbn;)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "([Le;Leu;Lc;[Lut;I)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lob;)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lob;Lob;FLob;)Lob;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "([Le;Lc;[Lut;I)V")
    ...
    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "(ILjava/awt/Canvas;Ll;Lfq;)V")
    ...
    @OriginalMember(owner = "client!w", name = "g", descriptor = "()Lc;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lgf;[Lev;Z)Lla;")
    ...
    @OriginalMember(owner = "client!w", name = "g", descriptor = "(I)Ln;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lpq;IIII)Le;")
    ...
    @OriginalMember(owner = "client!w", name = "b", descriptor = "(IIIIZ)Lo;")
    ...
    @OriginalMember(owner = "client!w", name = "b", descriptor = "(IIIIII)Lob;")
    public final class521 method1230(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "(IIIIIF)Lbn;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lev;Z)Lo;")
