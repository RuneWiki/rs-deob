...
public class class197 extends class374 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(III)V", line = 8)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(ZZ)V", line = 92)
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "(Lvd;Lbt;)V", line = 119)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(ZI)V", line = 152)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(ZLew;I)V", line = 167)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(B)Z", line = 176)
