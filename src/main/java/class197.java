...
public class class197 {
    ...
    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!ik", name = "c", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(ZI)Lhr;", line = 43)
    ...
    @OriginalMember(owner = "client!ik", name = "d", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(ILjava/lang/String;Z)V", line = 90)
    ...
    @OriginalMember(owner = "client!ik", name = "<init>", descriptor = "(Lpca;ILbi;)V", line = 123)
    public class197(class671 arg0, int arg1, class449 arg2) {
        this.field2879 = arg2;
        this.field2879.method2527(0, 1);
    }

    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(II)V", line = 111)
