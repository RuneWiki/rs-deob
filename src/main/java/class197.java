...
public class class197 extends class504 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(ZLha;I)Z")
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(ILsaa;)V")
    ...
    @OriginalMember(owner = "client!pk", name = "q", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IILha;I)Z")
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(ZLha;Lrr;IIII)V")
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(BLha;)Llba;")
    ...
    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(ILha;)Llca;")
