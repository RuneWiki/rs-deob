...
public class class197 extends class473 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IZI[IZII)Lae;")
    ...
    @OriginalMember(owner = "client!gb", name = "e", descriptor = "(II)Lor;")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lup;I)I")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lvd;B)I")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ILpg;)V")
    ...
    @OriginalMember(owner = "client!gb", name = "p", descriptor = "()Lhl;")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IIBLvd;Ltj;II)V")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lvw;B)I")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lnb;Lvj;I)I")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ILoh;)I")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(B[Lada;)Leh;")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(I[BIZILvj;II)Lae;")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ZZLcea;II)V")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lvj;Lnb;B)Z")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IILjagdx/IDirect3D;Ljagdx/D3DPRESENT_PARAMETERS;II)Z")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ILeh;)V")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IIILvd;)V")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ILdj;)V")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Ldga;Ldga;FLdga;)Ldga;")
    public final class190 method290(class190 arg0, class190 arg1, float arg2, class190 arg3) {
        return arg2 < 0.5F ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!gb", name = "b", descriptor = "(BZ)Ltj;")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(BLmv;)V")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IBILvj;Lnb;)Lae;")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "([BILvj;BII)Lte;")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ILcea;IZ)V")
    ...
    @OriginalMember(owner = "client!gb", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Le;Ljo;Ljava/lang/Integer;)Loa;")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lvj;Lnb;I)Z")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Z[[III)Lvfa;")
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/hr;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Lcga;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Le;Ljo;I)V")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ZLcea;)I")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IBLtfa;)V")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(I[FZIIZILvj;)Lae;")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Les;I)V")
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "(ZZ)Ltfa;")
