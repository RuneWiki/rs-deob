...
public class class197 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(II)Ldk;")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IIILja;II)Lpf;")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(B[I[IILih;I)Leo;")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IIILir;)V")
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(Lle;ILoi;)V")
