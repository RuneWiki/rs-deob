...
public class class197 extends class77 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(FFFFFFLde;II)V")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(FFFFFFIII)V")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IILde;II)V")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IIIIII)V")
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(Lmm;IIII)V")
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(Lmm;II[III)V")
