...
public class class342 extends class115 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BLbk;I)V", line = 26)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ZLra;Lra;Z)V", line = 60)
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "()V", line = 291)
    public class342() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(II)[[I", line = 83)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILdh;ZILdh;)I", line = 169)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IB)Loo;", line = 268)
    ...
    @OriginalMember(owner = "client!ul", name = "h", descriptor = "(I)V", line = 294)
