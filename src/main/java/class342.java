...
public abstract class class342 extends class361 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IIIIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ef", name = "b", descriptor = "(III)Z", line = 85)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!ef", name = "b", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(Lgo;I)V", line = 138)
    public class342(class451 arg0, int arg1) {
        this.field4968 = arg0;
        this.field4966 = arg1;
    }

    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IZ)V", line = 147)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IIILeb;IIILza;IIIILe;II)Le;", line = 163)
