...
public class class342 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Ljr;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(B)Lkq;", line = 29)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Ljr;Z)V", line = 71)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(JB)V", line = 95)
