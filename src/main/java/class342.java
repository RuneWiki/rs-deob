...
public class class342 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(ILti;)V", line = 10)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Lti;II)V", line = 31)
    ...
    @OriginalMember(owner = "client!va", name = "b", descriptor = "(I)V", line = 95)
    public static final void method2232(int arg0) {
        field5216++;
        class22.field343.method2349(arg0);
    }

    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IBIIIII)V", line = 108)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(ZLjava/lang/String;)Ljava/lang/String;", line = 158)
