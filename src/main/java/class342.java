...
public class class342 extends class232 {
    ...
    @OriginalMember(owner = "client!fp", name = "d", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(ILwq;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!fp", name = "e", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(IB)[I", line = 58)
    ...
    @OriginalMember(owner = "client!fp", name = "c", descriptor = "(III)V", line = 81)
    ...
    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "()V", line = 99)
    public class342() {
        this(4096);
    }
