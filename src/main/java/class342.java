...
public class class342 {
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(I)Ljb;")
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(IIII)Lew;")
    ...
    @OriginalMember(owner = "client!ew", name = "<init>", descriptor = "(Lew;I)V")
