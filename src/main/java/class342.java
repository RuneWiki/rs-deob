...
public class class342 {
    ...
    @OriginalMember(owner = "client!vja", name = "a", descriptor = "([BB)[B", line = 17)
    ...
    @OriginalMember(owner = "client!vja", name = "<init>", descriptor = "()V", line = 37)
    public class342() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(CI)Z", line = 40)
    ...
    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(BLkf;)I", line = 51)
    ...
    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(Lgga;[BI)V", line = 92)
    ...
    @OriginalMember(owner = "client!vja", name = "<init>", descriptor = "(III)V", line = 116)
    private class342(int arg0, int arg1, int arg2) {
    }

    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(ILpq;Ljava/lang/String;I)Lhh;", line = 129)
