...
public class class342 extends class514 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lgk;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lok;IZ)Ldu;", line = 37)
    ...
    @OriginalMember(owner = "client!bq", name = "c", descriptor = "(I)I", line = 56)
    ...
    @OriginalMember(owner = "client!bq", name = "d", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IBLjava/lang/String;)I", line = 79)
