...
public class class342 {
    ...
    @OriginalMember(owner = "client!ri", name = "toString", descriptor = "()Ljava/lang/String;", line = 5)
    public final String toString() {
        field5053++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ZZI)V", line = 28)
