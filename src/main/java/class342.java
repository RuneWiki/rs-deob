...
public class class342 {
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 32)
    ...
    @OriginalMember(owner = "client!fp", name = "b", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Lha;II)Z", line = 67)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(ILha;IIIIBIII)V", line = 147)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(ILuq;)V", line = 226)
    ...
    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "(I[Lfw;IIII)V", line = 265)
