...
public class class342 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(ZILjava/awt/Component;)Lgt;", line = 17)
    ...
    @OriginalMember(owner = "client!fn", name = "b", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(BI)Lbc;", line = 43)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(II)V", line = 71)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(IILwc;III)V", line = 84)
    ...
    @OriginalMember(owner = "client!fn", name = "b", descriptor = "(II)I", line = 211)
    public static final int method2079(int arg0, int arg1) {
        field4897++;
        return arg0 == 19552 ? arg1 & 0xFF : -98;
    }

    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(I)V", line = 227)
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "(Lci;ILg;)V", line = 255)
