...
public class class342 extends class7 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lmo;BLah;ZII)[F", line = 12)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(DZLah;IIZILmo;)[I", line = 124)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IB)V", line = 263)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(DIBLah;Lmo;ZI)[I", line = 287)
    ...
    @OriginalMember(owner = "client!cr", name = "f", descriptor = "(I)V", line = 425)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(BLmo;Lah;)Z", line = 437)
    ...
    @OriginalMember(owner = "client!cr", name = "g", descriptor = "(I)V", line = 499)
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "()V", line = 514)
    public class342() {
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(Ljg;)V", line = 529)
