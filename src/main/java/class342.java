...
public class class342 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lha;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "()I", line = 94)
    public final int method2157() {
        return this.field4807;
    }

    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lha;IZLjava/awt/Component;)V", line = 176)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lha;Ljava/lang/String;[IIIIZ)V", line = 106)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "()V", line = 127)
    public static void method2159() {
        field4809 = null;
    }

    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lha;Ljava/lang/String;IIIZ)V", line = 132)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Ljava/lang/String;)I", line = 150)
    ...
    @OriginalMember(owner = "client!cs", name = "c", descriptor = "()I", line = 165)
