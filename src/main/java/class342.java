...
public class class342 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(IZI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(I)V", line = 40)
