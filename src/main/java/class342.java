...
public class class342 implements class257 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IZIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(II)Z", line = 40)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Z)Lg;", line = 60)
    ...
    @OriginalMember(owner = "client!dj", name = "<init>", descriptor = "(Ljava/lang/String;Ldp;Lfv;IIIIIIIIII)V", line = 80)
