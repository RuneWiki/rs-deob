...
public class class342 extends class437 {
    ...
    @OriginalMember(owner = "client!nha", name = "<init>", descriptor = "(I)V", line = 5)
    public class342(int arg0) {
        this.field4607 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!nha", name = "b", descriptor = "(I)V", line = 35)
