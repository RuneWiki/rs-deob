...
public class class342 extends class300 implements class212 {
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(Lel;Lnh;II[BII)V")
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(Lel;Lnh;Ljr;II)V")
    ...
    @OriginalMember(owner = "client!vk", name = "h", descriptor = "(I)Lfca;")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IIIZIILnh;I[B)V")
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(Lel;Lnh;II[FII)V")
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(Lel;II[III)V")
