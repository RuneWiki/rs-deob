...
public class class342 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILci;)V", line = 54)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(III)V", line = 66)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(I[B)Lhu;", line = 215)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Ltf;I)Ljava/lang/String;", line = 296)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(B)V", line = 317)
