...
public class class342 extends class13 {
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(B)J", line = 3)
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(I)J", line = 15)
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "()V", line = 104)
    public class342() {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IB)I", line = 65)
