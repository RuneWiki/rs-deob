...
public class class342 extends class417 {
    ...
    @OriginalMember(owner = "client!oq", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(B)J", line = 20)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(BI)I", line = 54)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(I)J", line = 90)
