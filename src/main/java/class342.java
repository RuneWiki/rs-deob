...
public class class342 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ILlp;ILlp;Z)Lrl;", line = 9)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(I)Z", line = 89)
    ...
    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(B)V", line = 169)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Llp;BILlp;)Lrl;", line = 182)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(FFFIFIFF)F", line = 195)
    ...
    @OriginalMember(owner = "client!ri", name = "<init>", descriptor = "(Loh;Lpt;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", line = 263)
