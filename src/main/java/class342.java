...
public class class342 {
    ...
    @OriginalMember(owner = "client!fp", name = "c", descriptor = "(I)Lme;")
    ...
    @OriginalMember(owner = "client!fp", name = "b", descriptor = "(I)Lme;")
    ...
    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "(Lqha;)V")
