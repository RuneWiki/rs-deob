...
public class class342 {
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(I)Z", line = 17)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(BI)I", line = 30)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IIIIIZZ)V", line = 64)
