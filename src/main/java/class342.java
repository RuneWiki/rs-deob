...
public class class342 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(IIILfda;ILfda;IBII)V", line = 7)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(I)I", line = 60)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(III)V", line = 513)
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "(I)V", line = 524)
    ...
    @OriginalMember(owner = "client!cp", name = "c", descriptor = "(I)V", line = 541)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(II)Leja;", line = 557)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(B)V", line = 590)
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "(II)V", line = 601)
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "(Lega;ILwm;Lwm;)V", line = 637)
