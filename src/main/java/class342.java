...
public class class342 extends class369 {
    ...
    @OriginalMember(owner = "client!uq", name = "e", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(III)V", line = 16)
    ...
    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "(Lmj;Ltt;)V", line = 238)
    public class342(class344 arg0, class341 arg1) {
        super(arg0);
        this.field4319 = arg1;
    }

    @OriginalMember(owner = "client!uq", name = "d", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!uq", name = "b", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!uq", name = "c", descriptor = "(I)Z", line = 108)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IZ)V", line = 118)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(ZI)V", line = 130)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(BILlc;)V", line = 150)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Ljava/lang/Throwable;I)Ljava/lang/String;", line = 161)
