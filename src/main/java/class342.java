...
public class class342 {
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Ldda;Ldda;ILcc;Ldda;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(II)I", line = 25)
    public static int method2119(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Lhca;BBII)V", line = 36)
