...
public class class342 extends class127 {
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(Ltb;IIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IIIIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(II)V", line = 25)
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(Ltb;IIIIZ[IZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IIII[BIIIZ)V", line = 78)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IIII[IIIZ)V", line = 129)
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(Ltb;IIIIZ[FI)V", line = 171)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "()V", line = 191)
    public final void method152() {
        this.field1787.field3184.glFramebufferTexture2DEXT(36160, this.field4669, this.field1789, 0, 0);
        this.field4669 = -1;
    }

    @OriginalMember(owner = "client!im", name = "a", descriptor = "(ZZ)V", line = 197)
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(Ltb;IIIIZ[BIZ)V", line = 207)
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(Ltb;IIIII)V", line = 257)
