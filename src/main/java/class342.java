...
public class class342 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!fo", name = "b", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Ljava/lang/String;Lhe;BZ)Lq;", line = 91)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Z)V", line = 148)
