...
public class class342 implements class666 {
    ...
    @OriginalMember(owner = "client!bia", name = "b", descriptor = "(I)V", line = 6)
    public static void method2100(int arg0) {
        int var1 = 14 % ((arg0 + 4) / 50);
        field4863 = null;
    }

    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(III)I", line = 15)
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(I)I", line = 54)
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(ILjava/lang/String;)J", line = 69)
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(B)Lpw;", line = 114)
    ...
    @OriginalMember(owner = "client!bia", name = "<init>", descriptor = "(Lgga;)V", line = 124)
