...
public class class342 extends class497 {
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(ILpp;)V")
    public class342(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(Lpp;)V")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ILrt;)Z")
