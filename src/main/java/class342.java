...
public class class342 implements Runnable {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Ljava/lang/String;Z)Lcc;", line = 3)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IB)Lqd;", line = 24)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(BLdu;)V", line = 53)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "()V", line = 110)
    public class342() {
        this.field5061.setDaemon(true);
        this.field5061.start();
    }

    @OriginalMember(owner = "client!lh", name = "run", descriptor = "()V", line = 125)
