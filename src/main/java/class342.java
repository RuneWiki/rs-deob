...
public class class342 extends class237 implements class502 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(I)J", line = 4)
    ...
    @OriginalMember(owner = "client!va", name = "b", descriptor = "(I)I", line = 16)
    ...
    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(Lht;I[BI)V", line = 27)
    public class342(class410 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field4719 = arg1;
    }

    @OriginalMember(owner = "client!va", name = "a", descriptor = "([BIII)V", line = 36)
    ...
    @OriginalMember(owner = "client!va", name = "c", descriptor = "(I)I", line = 56)
