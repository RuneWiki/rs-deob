...
public class class342 extends class349 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(JI)V", line = 17)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!ah", name = "c", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(ZJILtj;I)V", line = 137)
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Ltj;Ljq;Lnd;J)V", line = 434)
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(B)V", line = 321)
