...
public class class342 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Lji;I)Ldv;", line = 7)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(ILs;)V", line = 23)
    public static final void method2014(int arg0, class281 arg1) {
        class25.field188[arg0] = arg1;
    }

    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(BI)Lit;", line = 38)
