...
public class class342 {
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(IIILnk;)V")
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ILvm;)V")
    ...
    @OriginalMember(owner = "client!pq", name = "c", descriptor = "(I)Lir;")
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Lnj;Z)Z")
