...
public class class342 {
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(IB)V", line = 47)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(BI)Ljl;", line = 65)
    ...
    @OriginalMember(owner = "client!mi", name = "<init>", descriptor = "(Lal;ILmg;)V", line = 111)
    ...
    @OriginalMember(owner = "client!mi", name = "c", descriptor = "(I)V", line = 99)
