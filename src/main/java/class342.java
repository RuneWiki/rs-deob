...
public class class342 extends class302 {
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(ZI)V", line = 10)
    ...
    @OriginalMember(owner = "client!mu", name = "d", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!mu", name = "c", descriptor = "(B)I", line = 41)
    ...
    @OriginalMember(owner = "client!mu", name = "h", descriptor = "(I)[B", line = 56)
    ...
    @OriginalMember(owner = "client!mu", name = "d", descriptor = "(II)I", line = 75)
