...
public class class342 implements class233 {
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(I)Lhm;", line = 28)
    ...
    @OriginalMember(owner = "client!jg", name = "<init>", descriptor = "(ILeha;Loea;IIIIIIIZ)V", line = 46)
