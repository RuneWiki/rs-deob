...
public class class342 extends class408 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lvd;IIB)Ldh;", line = 3)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZJZ)V", line = 35)
