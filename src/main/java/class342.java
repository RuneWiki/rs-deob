...
public class class342 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(ILbg;)V")
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(BLpo;)Z")
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Lbg;)V")
