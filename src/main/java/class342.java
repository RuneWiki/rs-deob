...
public class class342 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lod;IIIII)Ler;", line = 24)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(II)V", line = 71)
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(Liv;ILuu;)V", line = 90)
    public class342(class65 arg0, int arg1, class191 arg2) {
        this.field5270 = arg2;
        this.field5270.method1290(false, 29);
    }

    @OriginalMember(owner = "client!ef", name = "b", descriptor = "(II)Lhh;", line = 107)
    ...
    @OriginalMember(owner = "client!ef", name = "b", descriptor = "(I)V", line = 138)
