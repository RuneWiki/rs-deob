...
public class class342 {
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(BLmb;)I")
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(I)Luc;")
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(ILuc;)V")
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(B)Luc;")
