...
public class class380 extends class694 {
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(I[[I)V", line = 22)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(ILva;)V", line = 74)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IZ)V", line = 104)
    ...
    @OriginalMember(owner = "client!uw", name = "c", descriptor = "(II)[[I", line = 118)
    ...
    @OriginalMember(owner = "client!uw", name = "d", descriptor = "(III)I", line = 180)
    ...
    @OriginalMember(owner = "client!uw", name = "<init>", descriptor = "()V", line = 195)
    public class380() {
        super(0, true);
    }

    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(ILjr;B)V", line = 200)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(II)[I", line = 273)
