...
public class class380 extends class40 {
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(Lef;IIII)V")
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(Lef;IIII[BI)V")
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Ljn;B)Z")
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ZLsi;)Ljava/lang/String;")
