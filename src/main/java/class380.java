...
public abstract class class380 extends class225 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Llm;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Lps;III)V", line = 21)
    ...
    @OriginalMember(owner = "client!s", name = "d", descriptor = "(B)V", line = 350)
    ...
    @OriginalMember(owner = "client!s", name = "e", descriptor = "(B)V", line = 361)
