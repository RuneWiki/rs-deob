...
public class class380 extends class301 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(III)V", line = 23)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(B)Z", line = 52)
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(IZ)V", line = 63)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Z)V", line = 73)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IZ)V", line = 87)
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(III)Z", line = 119)
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "(Lck;Lwo;)V", line = 131)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Lwj;II)V", line = 156)
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(B)V", line = 182)
