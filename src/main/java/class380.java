...
public class class380 extends class386 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IIB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(II)[I", line = 25)
    ...
    @OriginalMember(owner = "client!lg", name = "e", descriptor = "(B)V", line = 96)
    public static void method2200(byte arg0) {
        field5091 = null;
        int var1 = -69 % ((-48 - arg0) / 41);
    }

    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "()V", line = 178)
    public class380() {
        super(0, true);
    }

    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IBLun;)V", line = 115)
    ...
    @OriginalMember(owner = "client!lg", name = "c", descriptor = "(III)Z", line = 159)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(I)V", line = 182)
