...
public class class380 extends class198 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "([ILur;IIZI)Lal;")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ZLjk;III)V")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(BLkh;)V")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Lwk;I)V")
