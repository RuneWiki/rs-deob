...
public class class380 {
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(IIIIIII)Ldi;", line = 5)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Z)V", line = 26)
    ...
    @OriginalMember(owner = "client!at", name = "b", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(II)Loba;", line = 56)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(B)V", line = 89)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Ljava/lang/Throwable;B)Ljava/lang/String;", line = 105)
    ...
    @OriginalMember(owner = "client!at", name = "b", descriptor = "(II)V", line = 176)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(III)Z", line = 189)
    ...
    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "(Lrga;ILni;)V", line = 213)
