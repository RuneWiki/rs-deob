...
public class class380 extends class52 implements class323 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "()I", line = 5)
    public final int method282() {
        return 0;
    }

    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(I[BI)V", line = 8)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(III)V", line = 13)
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(Lse;I[BI)V", line = 16)
