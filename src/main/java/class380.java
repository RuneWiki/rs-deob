...
public class class380 extends class642 {
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(II)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(ILgk;B)V", line = 101)
    ...
    @OriginalMember(owner = "client!kfa", name = "<init>", descriptor = "()V", line = 206)
    public class380() {
        super(1, false);
    }

    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(IILjava/lang/String;)Lmd;", line = 168)
    ...
    @OriginalMember(owner = "client!kfa", name = "f", descriptor = "(I)V", line = 189)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(ILr;II)V", line = 209)
