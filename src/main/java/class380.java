...
public class class380 extends class15 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(FI)F", line = 3)
    ...
    @OriginalMember(owner = "client!bf", name = "e", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIIIIFIII[F)V", line = 57)
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(I)V", line = 112)
