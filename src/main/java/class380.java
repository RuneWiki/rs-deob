...
public class class380 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IZ)V", line = 26)
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(I)V", line = 41)
