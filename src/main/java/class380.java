...
public class class380 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ZIZLtk;Ltk;)Ltf;")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(BILtk;Ltk;)Ltf;")
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "(Ltv;Lnja;Ljava/math/BigInteger;Ljava/math/BigInteger;)V")
