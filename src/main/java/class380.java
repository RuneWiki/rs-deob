...
public class class380 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Lbr;ZI)V", line = 17)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(II)V", line = 38)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Ltj;Ltj;ILtj;Lmn;)Z", line = 50)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(BI)V", line = 67)
    ...
    @OriginalMember(owner = "client!jk", name = "b", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IIII)Z", line = 113)
    ...
    @OriginalMember(owner = "client!jk", name = "c", descriptor = "(I)I", line = 253)
