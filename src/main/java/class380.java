...
public class class380 extends class294 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(ILuu;Lya;)V")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lwn;I[[B)V")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "([ILrs;[IZ[I)V")
