...
public class class380 {
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Lsl;B)V", line = 20)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(IIII)Z", line = 65)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(BLjava/io/File;)[B", line = 93)
