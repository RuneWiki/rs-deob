...
public class class380 {
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Loh;ZII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(BII)Laea;", line = 37)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(IC)Z", line = 59)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(I)V", line = 101)
