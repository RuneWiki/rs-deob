...
public class class380 extends class793 implements class525 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(BLer;[[B)V")
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "(Lpc;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(BIIIIILwj;IIIII)Z")
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IIIILpc;)Lqt;")
