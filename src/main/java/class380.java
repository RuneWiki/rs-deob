...
public class class380 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ZLjava/lang/String;Z)V", line = 13)
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(Z)V", line = 667)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(II)V", line = 714)
