...
public class class380 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(I[I[Ljava/lang/Object;)V", line = 4)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(II)V", line = 16)
    ...
    @OriginalMember(owner = "client!nd", name = "b", descriptor = "(II)V", line = 47)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(I)V", line = 86)
    public static void method2254(int arg0) {
        int var1 = -17 % ((arg0 + 29) / 57);
        field5194 = null;
    }

    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IZ)V", line = 97)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IZLjava/lang/Object;)[B", line = 112)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(B)V", line = 149)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(BI)Lco;", line = 163)
    ...
    @OriginalMember(owner = "client!nd", name = "b", descriptor = "(B)V", line = 195)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IB)V", line = 216)
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "(Lrb;ILpc;)V", line = 233)
