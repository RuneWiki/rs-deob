...
public class class380 {
    ...
    @OriginalMember(owner = "client!eaa", name = "finalize", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(Lip;I)I", line = 29)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(III)V", line = 112)
    ...
    @OriginalMember(owner = "client!eaa", name = "<init>", descriptor = "(Lmba;J[Lms;)V", line = 134)
