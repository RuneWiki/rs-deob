...
public class class380 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IIIIIILqa;III)V")
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Lqa;IB)Z")
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(I[Lvs;IIII)V")
