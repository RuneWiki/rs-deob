...
public class class380 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lmh;Ln;)V", line = 184)
    public class380(class537 arg0, class17 arg1) {
        this.field5038 = arg1;
        this.field5039 = arg0;
    }

    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(II)Lrr;", line = 23)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Lgn;Z)Z", line = 72)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(I)V", line = 174)
    ...
    @OriginalMember(owner = "client!qd", name = "b", descriptor = "(B)V", line = 193)
