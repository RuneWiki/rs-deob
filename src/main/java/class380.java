...
public class class380 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(BIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(I)V", line = 230)
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "(Lai;ILic;)V", line = 250)
