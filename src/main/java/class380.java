...
public class class380 extends class454 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(Lkd;II[BI)V", line = 30)
    ...
    @OriginalMember(owner = "client!ac", name = "f", descriptor = "(I)V", line = 45)
