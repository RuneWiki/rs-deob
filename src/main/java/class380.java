...
public class class380 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Lcv;I)V")
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(III)Llf;")
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(B)Lcv;")
    ...
    @OriginalMember(owner = "client!br", name = "c", descriptor = "(I)Lcv;")
    ...
    @OriginalMember(owner = "client!br", name = "d", descriptor = "(I)Lcv;")
    ...
    @OriginalMember(owner = "client!br", name = "e", descriptor = "(I)Lcv;")
