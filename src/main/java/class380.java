...
public class class380 extends class160 {
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "([III)V", line = 3)
    ...
    @OriginalMember(owner = "client!td", name = "e", descriptor = "()Z", line = 240)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(III)V", line = 328)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Llv;II)Ltd;", line = 374)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Z)V", line = 382)
    ...
    @OriginalMember(owner = "client!td", name = "f", descriptor = "()I", line = 391)
    public final synchronized int method2245() {
        return this.field5725 < 0 ? -1 : this.field5725;
    }

    @OriginalMember(owner = "client!td", name = "d", descriptor = "()Lbs;", line = 395)
    public final class160 method1137() {
        return null;
    }

    @OriginalMember(owner = "client!td", name = "a", descriptor = "([IIIII)I", line = 400)
    ...
    @OriginalMember(owner = "client!td", name = "c", descriptor = "(I)V", line = 455)
    private final synchronized void method2247(int arg0) {
        this.method2272(arg0, this.method2245());
    }

    @OriginalMember(owner = "client!td", name = "d", descriptor = "(I)V", line = 459)
    public final synchronized void method2248(int arg0) {
        this.method2272(arg0 << 6, this.method2245());
    }

    @OriginalMember(owner = "client!td", name = "a", descriptor = "([B[IIIIIIIILtd;)I", line = 462)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "()Lbs;", line = 496)
    public final class160 method1131() {
        return null;
    }

    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Llv;III)Ltd;", line = 500)
    ...
    @OriginalMember(owner = "client!td", name = "e", descriptor = "(I)V", line = 507)
    public final synchronized void method2251(int arg0) {
        this.field5720 = arg0;
    }

    @OriginalMember(owner = "client!td", name = "a", descriptor = "(I[B[IIIIIIIILtd;)I", line = 510)
    ...
    @OriginalMember(owner = "client!td", name = "f", descriptor = "(I)V", line = 550)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(II[B[IIIIIIIILtd;II)I", line = 596)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "(II[B[IIIIIIIILtd;II)I", line = 631)
    ...
    @OriginalMember(owner = "client!td", name = "g", descriptor = "()V", line = 664)
    ...
    @OriginalMember(owner = "client!td", name = "c", descriptor = "(II[B[IIIIIIIILtd;II)I", line = 669)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(I)V", line = 703)
    ...
    @OriginalMember(owner = "client!td", name = "h", descriptor = "()V", line = 922)
    ...
    @OriginalMember(owner = "client!td", name = "g", descriptor = "(I)V", line = 934)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(II)I", line = 944)
    private static final int method2260(int arg0, int arg1) {
        return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
    }

    @OriginalMember(owner = "client!td", name = "d", descriptor = "(II[B[IIIIIIIILtd;II)I", line = 949)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(I[B[IIIIIIIIIILtd;)I", line = 982)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(II[B[IIIIIIILtd;II)I", line = 1035)
    ...
    @OriginalMember(owner = "client!td", name = "i", descriptor = "()I", line = 1063)
    public final synchronized int method2264() {
        return this.field5715 < 0 ? -this.field5715 : this.field5715;
    }

    @OriginalMember(owner = "client!td", name = "b", descriptor = "()I", line = 1067)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(II[B[IIIIIIIIIILtd;II)I", line = 1079)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "(II[B[IIIIIIILtd;II)I", line = 1120)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "([B[IIIIIIIILtd;)I", line = 1146)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "(I[B[IIIIIIIIIILtd;)I", line = 1180)
    ...
    @OriginalMember(owner = "client!td", name = "j", descriptor = "()Z", line = 1233)
    public final boolean method2269() {
        return this.field5724 < 0 || this.field5724 >= ((class528) super.field2400).field7782.length << 8;
    }

    @OriginalMember(owner = "client!td", name = "b", descriptor = "(II[B[IIIIIIIIIILtd;II)I", line = 1237)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "(I[B[IIIIIIIILtd;)I", line = 1279)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "(II)V", line = 1317)
    ...
    @OriginalMember(owner = "client!td", name = "k", descriptor = "()I", line = 1325)
    public final synchronized int method2273() {
        return this.field5713 == Integer.MIN_VALUE ? 0 : this.field5713;
    }

    @OriginalMember(owner = "client!td", name = "a", descriptor = "([B[IIIIIIILtd;)I", line = 1328)
    ...
    @OriginalMember(owner = "client!td", name = "c", descriptor = "(II)I", line = 1354)
    private static final int method2275(int arg0, int arg1) {
        return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
    }

    @OriginalMember(owner = "client!td", name = "d", descriptor = "(II)V", line = 1357)
    public final synchronized void method2276(int arg0, int arg1) {
        this.method2242(arg0, arg1, this.method2245());
    }

    @OriginalMember(owner = "client!td", name = "h", descriptor = "(I)V", line = 1360)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "([IIIII)I", line = 1367)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "([B[IIIIIIILtd;)I", line = 1422)
    ...
    @OriginalMember(owner = "client!td", name = "l", descriptor = "()Z", line = 1448)
    public final boolean method2280() {
        return this.field5718 != 0;
    }

    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(Llv;II)V", line = 1452)
    ...
    @OriginalMember(owner = "client!td", name = "c", descriptor = "()I", line = 1464)
    public final int method1134() {
        return this.field5713 == 0 && this.field5718 == 0 ? 0 : 1;
    }

    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(Llv;III)V", line = 1469)
