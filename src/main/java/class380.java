...
public class class380 extends class189 {
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(IZ)I")
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(IB)V")
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(IFIII)V")
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(IB[I)V")
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(IIIB)V")
    ...
    @OriginalMember(owner = "client!aha", name = "<init>", descriptor = "(Lio;IIIII)V")
