...
public class class380 extends class511 {
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(IILfa;II)V")
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(FFFFFFLfa;II)V")
    ...
    @OriginalMember(owner = "client!bv", name = "<init>", descriptor = "(Lfc;IIZ)V")
    ...
    @OriginalMember(owner = "client!bv", name = "<init>", descriptor = "(Lfc;II[III)V")
