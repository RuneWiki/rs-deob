...
public class class380 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ZI)Lraa;", line = 34)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IB)V", line = 84)
    ...
    @OriginalMember(owner = "client!qm", name = "c", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(Lqh;ILtf;Ltf;)V", line = 135)
