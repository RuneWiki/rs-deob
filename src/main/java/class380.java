...
public class class380 {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 22)
    ...
    @OriginalMember(owner = "client!in", name = "b", descriptor = "(I)J", line = 49)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(B)I", line = 60)
    ...
    @OriginalMember(owner = "client!in", name = "toString", descriptor = "()Ljava/lang/String;", line = 71)
    public final String toString() {
        field5327++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ILjava/lang/String;B)V", line = 79)
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(II)V", line = 95)
    public class380(int arg0, int arg1) {
        this.field5326 = arg0;
        this.field5324 = arg1;
    }

    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ZLjava/lang/String;)Ljava/lang/String;", line = 107)
