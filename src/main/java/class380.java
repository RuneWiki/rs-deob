...
public class class380 extends class177 {
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Throwable;)V", line = 19)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(B)Z", line = 76)
