...
public class class380 {
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(ILrg;)Lck;", line = 22)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(II)Leo;", line = 43)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(B)V", line = 69)
