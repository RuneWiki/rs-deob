...
public abstract class class380 extends class361 {
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(Lha;ZJ)V", line = 3)
    ...
    @OriginalMember(owner = "client!aha", name = "d", descriptor = "(I)Z", line = 40)
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(ZLha;Lrr;IIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!aha", name = "h", descriptor = "(I)Z", line = 69)
    ...
    @OriginalMember(owner = "client!aha", name = "<init>", descriptor = "(IIIII)V", line = 83)
    ...
    @OriginalMember(owner = "client!aha", name = "b", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(III)Z", line = 112)
    ...
    @OriginalMember(owner = "client!aha", name = "i", descriptor = "(I)Z", line = 123)
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(B[Lada;)I", line = 163)
    ...
    @OriginalMember(owner = "client!aha", name = "e", descriptor = "(I)Z", line = 174)
