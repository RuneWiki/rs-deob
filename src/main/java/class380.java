...
public class class380 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(BILkn;Lkn;)Lnr;")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IIIIILea;Ltn;JI)V")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lkn;Lkn;IZI)Lnr;")
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "(Lml;Lik;)V")
