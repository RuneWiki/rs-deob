...
public class class380 extends class364 implements class171 {

    @OriginalMember(owner = "client!hs", name = "F", descriptor = "Llc;")
    public class444 field5168;
    ...
    public final int method420(byte arg0) {
        ++field5171;
        int var2 = 71 / ((-21 - arg0) / 44);
        return this.field5168.field6163;
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IZ)V")
    public static final void method2360(int arg0, boolean arg1) {
        ++field5177;
        if (!arg1) {
            field5182 = 54;
        }
        class12 var2 = class390.method2422(341555040, arg0, 12);
        var2.method65(-118);
    }

    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(Luo;Lnd;IIIIIIIZIIII)V")
    public class380(class118 arg0, class446 arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, boolean arg9, int arg10, int arg11, int arg12, int arg13) {
        super(arg6, arg7, arg8, arg10, arg11, arg12, class282.method1775(arg2, 20441, arg3));
        this.field5168 = new class444(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg8, arg9, arg13);
        this.field5166 = arg1.field6235 != 0 && !arg9;
    }
    ...
    public final boolean method412(int arg0) {
        ...
        return this.field5168.method2755(-1);
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(II)Lnd;")
    public static final class446 method2361(int arg0, int arg1) {
        ++field5178;
        class365 var2 = class219.field2706;
        class446 var3;
        synchronized (class219.field2706) {
            var3 = (class446) class219.field2706.method2295((long) arg0, (byte) 74);
        }
        if (var3 != null) {
            return var3;
        } else {
            byte[] var4 = class279.field3615.method1794(5860, class4.method16(arg0, 2000492488), class8.method42(255, arg0));
            ...
            var5.field6209 = arg0;
            if (var4 != null) {
                var5.method2762(new class242(var4), -1);
            }
            var5.method2767(0);
            if (var5.field6222) {
                var5.field6238 = false;
                var5.field6179 = 0;
            }
            if (!class252.field3303 && var5.field6203) {
                var5.field6214 = null;
                var5.field6220 = null;
            }
            class365 var6 = class219.field2706;
            synchronized (class219.field2706) {
                class219.field2706.method2294(var5, (byte) 87, (long) arg0);
                return var5;
            }
        }
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(BLuo;)V")
    public final void method138(byte arg0, class118 arg1) {
        if (arg0 < 78) {
            field5176 = null;
        }
        ++field5175;
        class386 var3 = this.field5168.method2746(131072, arg1, super.field4953, super.field4948, true, false, false);
        if (var3 != null) {
            this.field5168.method2754((byte) -32, arg1, var3, super.field4953 >> 7, super.field4948 >> 7, false, super.field4953 >> 7, super.field4948 >> 7);
        }
    }
    ...
    public final int method417(byte arg0) {
        if (arg0 != -116) {
            ...
            ++field5181;
            return this.field5168.field6136;
        }
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Luo;II)Lge;")
    public final class386 method419(class118 arg0, int arg1, int arg2) {
        ++field5183;
        if (arg1 != -20264) {
            this.method422((class118) null, (byte) 50);
        }
        return this.field5168.method2746(arg2, arg0, 0, 0, false, false, false);
    }

    @OriginalMember(owner = "client!hs", name = "c", descriptor = "(Luo;B)Lkj;")
    public final class175 method130(class118 arg0, byte arg1) {
        ++field5173;
        class386 var3 = this.field5168.method2746(1024, arg0, super.field4953, super.field4948, true, false, false);
        if (var3 == null) {
            return null;
        } else {
            int var4 = -86 / ((11 - arg1) / 37);
            class450 var5 = arg0.method742();
            var5.method929(super.field4948 - -super.field4949, super.field4944, super.field4953 + super.field4942);
            class175 var6 = null;
            if (this.field5166) {
                var6 = class68.method392((byte) -106, 1);
            }
            if (this.field5168.field6131 != null) {
                class291 var7 = this.field5168.field6131.method404();
                arg0.method729(var3, var7, var5, var6 == null ? null : var6.field2030[0], 0);
            } else {
                var3.method1441(var5, var6 == null ? null : var6.field2030[0], 0);
            }
            this.field5168.method2754((byte) -32, arg0, var3, super.field4953 >> 7, super.field4948 >> 7, true, super.field4953 >> 7, super.field4948 >> 7);
            return var6;
        }
    }
    ...
    public final int method414(int arg0) {
        ++field5170;
        if (arg0 != 4096) {
            this.method411((class118) null, (byte) 8);
        }
        return this.field5168.method2745((byte) -124);
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Luo;B)V")
    public final void method411(class118 arg0, byte arg1) {
        if (arg1 == 88) {
            ++field5167;
            this.field5168.method2747(arg0, 13694);
        }
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Luo;IIZ)Z")
    public final boolean method134(class118 arg0, int arg1, int arg2, boolean arg3) {
        ++field5180;
        class386 var5 = this.field5168.method2746(65536, arg0, super.field4953, super.field4948, false, !arg3, false);
        if (var5 == null) {
            return false;
        } else {
            ...
            var6.method929(super.field4949 + super.field4948, super.field4944, super.field4953 + super.field4942);
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(Luo;B)V")
    public final void method422(class118 arg0, byte arg1) {
        ++field5174;
        this.field5168.method2750(-125, arg0);
        if (arg1 != -7) {
            field5176 = null;
        }
    }
    ...
    public static final void method2363(int arg0) {
        ...
        try {
            ...
            while (~var2.field4244 == -1) {
                class219.method1330(1L, true);
            }
            if (var2.field4244 == 1) {
                var1 = (class7) var2.field4243;
                class242 var3 = new class242(class405.field5612 * 6 + 3);
                var3.method1593(1, -108);
                var3.method1573(arg0 ^ -7126, class405.field5612);
                for (int var4 = 0; class198.field2338.length > var4; ++var4) {
                    if (class53.field618[var4]) {
                        var3.method1573(arg0 + -7206, var4);
                        var3.method1560(arg0 ^ -25952, class198.field2338[var4]);
                    }
                }
                var1.method31(var3.field3211, false, 0, var3.field3188);
            }
            if (arg0 != 940) {
                method2360(63, false);
            }
        ...
        try {
            if (var1 != null) {
                var1.method32((byte) -125);
            }
        } catch (Exception var5) {
        }
        class368.field5015 = class164.method1038(8635);
        class181.field2109 = false;
    }
    ...
    public final int method409(int arg0) {
        ...
        return this.field5168.field6132;
    }
}
