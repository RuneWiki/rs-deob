...
public class class380 extends class393 {
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(Lqa;Lsm;Lwp;J)V", line = 334)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(JB)V", line = 31)
    ...
    @OriginalMember(owner = "client!pp", name = "b", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(ILqa;ZIJ)V", line = 136)
    ...
    @OriginalMember(owner = "client!pp", name = "c", descriptor = "(B)V", line = 309)
