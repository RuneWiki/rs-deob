...
public class class380 extends class428 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Loj;J[Ltn;[Lgp;Z)V")
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "()Lcd;")
    public final class46 method2272() {
        return this.field5391;
    }

    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Loj;J)Z")
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "([Lgp;Z)V")
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Loj;[Ltn;Z)V")
