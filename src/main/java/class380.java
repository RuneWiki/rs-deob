...
public class class380 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Ljava/lang/String;Z)Z", line = 26)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IIBI)V", line = 58)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(ZIIIII)V", line = 88)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(ILnj;)V", line = 120)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IILnj;)V", line = 163)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Ldq;I)[Lsd;", line = 233)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(ZI)I", line = 274)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Z)V", line = 293)
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(ZI)Ljava/lang/String;", line = 321)
