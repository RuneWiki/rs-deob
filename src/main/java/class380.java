...
public class class380 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(BLha;)V", line = 3)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(IILha;)V", line = 29)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Z)V", line = 48)
