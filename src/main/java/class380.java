...
public class class380 implements class249 {
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(ILgw;)Lig;", line = 4)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Z)J", line = 15)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Lnba;I)Z", line = 53)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!qv", name = "b", descriptor = "(I)V", line = 130)
