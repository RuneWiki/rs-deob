...
public class class380 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ZI)V", line = 38)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(ZI)V", line = 58)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Z)V", line = 75)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IZ)V", line = 96)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(II)Lti;", line = 116)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IIIBI)Z", line = 175)
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "(Lsn;IZLci;Lci;)V", line = 213)
