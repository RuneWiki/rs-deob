...
public class class765 extends class497 {
    ...
    @OriginalMember(owner = "client!fm", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ZB)V", line = 15)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(I)Z", line = 67)
    ...
    @OriginalMember(owner = "client!fm", name = "d", descriptor = "(I)I", line = 90)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(BILkja;)V", line = 111)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IBI)V", line = 124)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IZ)V", line = 142)
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "(Lpj;)V", line = 187)
