...
public class class765 extends class129 {
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(IIB)V", line = 5)
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!sia", name = "<init>", descriptor = "(Lkd;Lcda;)V", line = 112)
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(ZI)V", line = 85)
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(ZB)V", line = 101)
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(Z)Z", line = 121)
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(IILrca;)V", line = 139)
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(I)V", line = 150)
