...
public class class765 implements class721 {
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(I)Laca;", line = 9)
    ...
    @OriginalMember(owner = "client!eja", name = "<init>", descriptor = "(Ljava/lang/String;Leaa;Lcq;IIIIIIIIII)V", line = 32)
