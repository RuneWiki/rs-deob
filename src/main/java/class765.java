...
public abstract class class765 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(ZIIIIILha;)Lka;", line = 29)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IJ)V", line = 82)
