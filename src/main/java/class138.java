...
public class class138 implements class104 {
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Z)V", line = 33)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lla;ILjava/lang/String;IBI)I", line = 94)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(B)Z", line = 106)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(BLlj;[Ln;)Lwba;", line = 118)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ZZ)V", line = 185)
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(Lmaa;Lkp;)V", line = 220)
