...
public class class138 {
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Leq;B)V", line = 6)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(IIII)Z", line = 71)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Lbn;I)V", line = 89)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(I)V", line = 145)
