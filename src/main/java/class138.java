...
public class class138 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IILiaa;)V", line = 14)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Liaa;Z)V", line = 110)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(BZZII)V", line = 136)
