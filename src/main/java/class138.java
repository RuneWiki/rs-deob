...
public class class138 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(BILbg;)V", line = 19)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lbg;III)V", line = 42)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(I)Liq;", line = 64)
