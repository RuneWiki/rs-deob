...
public class class138 extends class656 implements class675 {
    ...
    @OriginalMember(owner = "client!sfa", name = "d", descriptor = "(Z)Z", line = 6)
    ...
    @OriginalMember(owner = "client!sfa", name = "c", descriptor = "(B)I", line = 22)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(ILha;)V", line = 33)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(Lha;I)V", line = 61)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(ZLha;)V", line = 72)
    ...
    @OriginalMember(owner = "client!sfa", name = "<init>", descriptor = "(Lha;Lfw;IIIIIZIIII)V", line = 99)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(Lha;III)Z", line = 124)
    ...
    @OriginalMember(owner = "client!sfa", name = "e", descriptor = "(Z)Z", line = 150)
    ...
    @OriginalMember(owner = "client!sfa", name = "b", descriptor = "(I)I", line = 165)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(Lha;B)Lsba;", line = 177)
    ...
    @OriginalMember(owner = "client!sfa", name = "b", descriptor = "(ZLha;)Lrs;", line = 193)
    ...
    @OriginalMember(owner = "client!sfa", name = "b", descriptor = "(Z)V", line = 222)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(Lha;II)Lka;", line = 237)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(Z)I", line = 262)
    ...
    @OriginalMember(owner = "client!sfa", name = "e", descriptor = "(B)V", line = 273)
    ...
    @OriginalMember(owner = "client!sfa", name = "h", descriptor = "(I)V", line = 295)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(I)Z", line = 305)
    ...
    @OriginalMember(owner = "client!sfa", name = "c", descriptor = "(I)I", line = 322)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(III)Lgb;", line = 334)
    ...
    @OriginalMember(owner = "client!sfa", name = "c", descriptor = "(Z)I", line = 342)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(Lha;ZIB)Lni;", line = 358)
