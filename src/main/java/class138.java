...
public class class138 extends class719 implements class722 {
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(Lha;I)Lbd;", line = 5)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(I)I", line = 31)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(BLha;)Loia;", line = 43)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Lha;IIZ)Lsfa;", line = 58)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILha;BI)Z", line = 88)
    ...
    @OriginalMember(owner = "client!vr", name = "d", descriptor = "(I)Z", line = 117)
    ...
    @OriginalMember(owner = "client!vr", name = "c", descriptor = "(Z)I", line = 133)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Lgg;BZILha;II)V", line = 145)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(B)V", line = 175)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Z)Z", line = 189)
    public final boolean method682(boolean arg0) {
        ++field1760;
        return !arg0 ? false : this.field1753;
    }

    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(B)I", line = 202)
    ...
    @OriginalMember(owner = "client!vr", name = "d", descriptor = "(B)Z", line = 213)
    ...
    @OriginalMember(owner = "client!vr", name = "c", descriptor = "(Lha;I)V", line = 225)
    public final void method136(class60 arg0, int arg1) {
        int var3 = -10 / ((53 - arg1) / 46);
        ++field1752;
    }

    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(I)I", line = 237)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IBLha;)Lka;", line = 250)
    ...
    @OriginalMember(owner = "client!vr", name = "<init>", descriptor = "(Lha;Lvha;IIIIIZIIZ)V", line = 270)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Lha;I)V", line = 304)
    ...
    @OriginalMember(owner = "client!vr", name = "f", descriptor = "(B)V", line = 333)
    ...
    @OriginalMember(owner = "client!vr", name = "h", descriptor = "(I)I", line = 349)
    ...
    @OriginalMember(owner = "client!vr", name = "c", descriptor = "(II)Lafa;", line = 363)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(II[F)[F", line = 390)
    ...
    @OriginalMember(owner = "client!vr", name = "g", descriptor = "(I)Z", line = 404)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILha;)V", line = 419)
