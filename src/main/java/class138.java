...
public class class138 extends class214 {
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "()V", line = 54)
    public class138() {
        super(0, true);
    }

    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(II)I", line = 10)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Llk;II)V", line = 57)
    ...
    @OriginalMember(owner = "client!jk", name = "e", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!jk", name = "b", descriptor = "(B)V", line = 134)
    ...
    @OriginalMember(owner = "client!jk", name = "c", descriptor = "(B)V", line = 154)
    ...
    @OriginalMember(owner = "client!jk", name = "f", descriptor = "(I)V", line = 174)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(BI)[I", line = 338)
