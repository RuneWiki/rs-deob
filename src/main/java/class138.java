...
public class class138 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(II)Lsba;", line = 16)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(B)J", line = 40)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IZ)V", line = 53)
    ...
    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(II)Llk;", line = 93)
    ...
    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(B)V", line = 135)
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "(Lre;ILdn;Ldn;Ldn;)V", line = 158)
