...
public class class138 {
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(IIF)F", line = 7)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(IF)I", line = 15)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "()V", line = 76)
    public static void method913() {
        field1740 = null;
        field1741 = null;
    }

    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(F)F", line = 84)
    private static final float method914(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!faa", name = "b", descriptor = "(IIF)F", line = 89)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(Lun;Lkc;)V", line = 96)
