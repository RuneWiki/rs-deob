...
public class class138 extends class381 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IIIBI)V", line = 13)
    ...
    @OriginalMember(owner = "client!od", name = "c", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!od", name = "c", descriptor = "(B)V", line = 79)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lrk;I)V", line = 104)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IILrk;ZII)V", line = 121)
