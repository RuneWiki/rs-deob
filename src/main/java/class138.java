...
public class class138 extends class18 {
    ...
    @OriginalMember(owner = "client!oh", name = "nb", descriptor = "Lwb;")
    private class204 field2673;

    @OriginalMember(owner = "client!oh", name = "yb", descriptor = "Lwb;")
    private class204 field2684;

    @OriginalMember(owner = "client!oh", name = "jb", descriptor = "I")
    private int field2669;

    @OriginalMember(owner = "client!oh", name = "mb", descriptor = "Llf;")
    public static class109 field2672 = class35.method275("Anmelde)2Zeitlimit -Uberschritten)3", 2);

    @OriginalMember(owner = "client!oh", name = "fb", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!oh", name = "ub", descriptor = "Llf;")
    private static class109 field2680 = class35.method275(" from your friend list first)3", 2);

    @OriginalMember(owner = "client!oh", name = "ob", descriptor = "Llf;")
    public static class109 field2674 = field2680;

    @OriginalMember(owner = "client!oh", name = "zb", descriptor = "Llf;")
    private static class109 field2685 = class35.method275("wave2:", 2);

    @OriginalMember(owner = "client!oh", name = "rb", descriptor = "Llf;")
    public static class109 field2677 = field2685;

    @OriginalMember(owner = "client!oh", name = "Bb", descriptor = "Llf;")
    private static class109 field2687 = class35.method275("Your account has been disabled)3", 2);

    @OriginalMember(owner = "client!oh", name = "wb", descriptor = "Llf;")
    public static class109 field2682 = field2687;

    @OriginalMember(owner = "client!oh", name = "cb", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "([BLwb;ZZI)V")
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(Lwb;Lwb;IZZZ)V")
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(IIIILbg;ZI)V")
