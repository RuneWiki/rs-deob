...
public class class138 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(III)I", line = 24)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(I)V", line = 109)
