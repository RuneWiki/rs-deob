...
public class class138 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "([Lgs;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ILjava/lang/Object;BI)[B", line = 43)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ZI)Z", line = 118)
