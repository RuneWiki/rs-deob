...
public class class138 {
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IB)Ltha;")
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IIILjava/awt/Canvas;)Lwga;")
    ...
    @OriginalMember(owner = "client!hw", name = "<init>", descriptor = "(Lpo;ILgda;)V")
