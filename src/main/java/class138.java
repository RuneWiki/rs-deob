...
public class class138 {
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Lfo;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(ZZ)V", line = 49)
