...
public class class138 extends class398 {
    ...
    @OriginalMember(owner = "client!bi", name = "c", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(II)[I", line = 22)
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "()V", line = 111)
    public class138() {
        super(0, true);
    }

    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lnj;II)V", line = 128)
