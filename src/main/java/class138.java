...
public class class138 {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(ILe;I)V", line = 11)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IILjg;I)V", line = 297)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(ZIBLe;)Lgl;", line = 328)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lkk;IIIII)V", line = 378)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(B)V", line = 435)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(ILjg;I)V", line = 445)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(I)Z", line = 474)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IIIIII)V", line = 485)
