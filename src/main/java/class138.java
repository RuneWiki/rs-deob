...
public class class138 extends Canvas {
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!vj", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 19)
    public class138(Component arg0) {
        this.field1918 = arg0;
    }

    @OriginalMember(owner = "client!vj", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 42)
    public final void update(Graphics arg0) {
        this.field1918.update(arg0);
        field1917++;
    }

    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IIBLwg;)V", line = 51)
    ...
    @OriginalMember(owner = "client!vj", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 112)
