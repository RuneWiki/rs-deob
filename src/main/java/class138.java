...
public class class138 {
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(ILjava/awt/Canvas;II)Llm;")
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(IIIIILha;Z)V")
    ...
    @OriginalMember(owner = "client!qea", name = "<init>", descriptor = "(Lpa;JI)V")
