...
public class class138 extends class54 {
    ...
    @OriginalMember(owner = "client!di", name = "c", descriptor = "(II)Lnl;")
    ...
    @OriginalMember(owner = "client!di", name = "<init>", descriptor = "(Lhia;)V")
    public class138(class73 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!di", name = "<init>", descriptor = "(ILhia;)V")
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Ld;IILjava/awt/Canvas;I)Lha;")
