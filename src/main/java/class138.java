...
public class class138 extends class232 {
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "()Lsc;", line = 3)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IILpg;)V", line = 25)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "([III)V", line = 67)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "([Ljava/lang/Object;[IB)V", line = 107)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(Lrv;)V", line = 263)
    public class138(class73 arg0) {
        this.field2312 = arg0;
    }

    @OriginalMember(owner = "client!oc", name = "c", descriptor = "()Lsc;", line = 161)
    ...
    @OriginalMember(owner = "client!oc", name = "c", descriptor = "(I)V", line = 180)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IILpg;[III)V", line = 191)
    ...
    @OriginalMember(owner = "client!oc", name = "d", descriptor = "()I", line = 250)
