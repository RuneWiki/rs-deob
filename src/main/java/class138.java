...
public class class138 extends class388 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IIDZLd;Lla;Z)[I")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(BLd;ZDZLla;II)[I")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IIILd;Lla;Z)[F")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lla;ILd;)Z")
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(Lsl;)V")
