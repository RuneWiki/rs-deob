...
public class class138 extends class337 {
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(Lba;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lba;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(I[[[BZLya;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(Lvd;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lwr;[I)V")
    ...
    @OriginalMember(owner = "client!ne", name = "k", descriptor = "(IILba;)Lba;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(BILds;I)V")
    ...
    @OriginalMember(owner = "client!ne", name = "p", descriptor = "(Lba;IIIIZ)V")
