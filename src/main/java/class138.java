...
public class class138 extends class180 {
    ...
    @OriginalMember(owner = "client!nd", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!nd", name = "c", descriptor = "(Z)Z", line = 26)
    ...
    @OriginalMember(owner = "client!nd", name = "e", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IIB)Z", line = 60)
    ...
    @OriginalMember(owner = "client!nd", name = "f", descriptor = "(I)Lrr;", line = 79)
