...
public class class138 implements Runnable {
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(ILpf;)V")
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(ILkn;[BZ)Lpf;")
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IBLkn;)Lpf;")
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(BILkn;)Lpf;")
    ...
    @OriginalMember(owner = "client!ik", name = "<init>", descriptor = "(Lci;)V")
