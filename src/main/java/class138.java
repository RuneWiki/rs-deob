...
public class class138 {
    ...
    @OriginalMember(owner = "client!fq", name = "e", descriptor = "Lkt;")
    public static class110 field2098;

    @OriginalMember(owner = "client!fq", name = "h", descriptor = "Lfq;")
    public class138 field2101;

    @OriginalMember(owner = "client!fq", name = "m", descriptor = "Lsr;")
    public class168 field2106;

    @OriginalMember(owner = "client!fq", name = "v", descriptor = "Lsr;")
    public class168 field2115;

    @OriginalMember(owner = "client!fq", name = "l", descriptor = "Lse;")
    public class171 field2105;

    @OriginalMember(owner = "client!fq", name = "i", descriptor = "Lrp;")
    public class303 field2102;

    @OriginalMember(owner = "client!fq", name = "k", descriptor = "Lqv;")
    public class312 field2104;

    @OriginalMember(owner = "client!fq", name = "u", descriptor = "Lqv;")
    public class312 field2114;

    @OriginalMember(owner = "client!fq", name = "y", descriptor = "Lbg;")
    public class327 field2118;

    @OriginalMember(owner = "client!fq", name = "q", descriptor = "Lkp;")
    public class341 field2110;

    @OriginalMember(owner = "client!fq", name = "a", descriptor = "Lfh;")
    public static class464 field2094;
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(B)V", line = 3)
    public final void method1006(byte arg0) {
        field2096++;
        while (this.field2118 != null) {
            class327 var2 = this.field2118.field4922;
            this.field2118.method2082(true);
            this.field2118 = var2;
        }
        this.field2109 = 0;
        if (arg0 < 22) {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(III)V", line = 60)
    public class138(int arg0, int arg1, int arg2) {
        this.field2117 = (short) arg1;
        this.field2113 = (short) arg2;
        this.field2119 = this.field2099 = (byte) arg0;
    }
}
