...
public class class138 extends class145 {
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(II[I[I)V", line = 17)
    public class138(int arg0, int arg1, int[] arg2, int[] arg3) {
        this.field1811 = arg2;
        this.field1812 = arg3;
    }

    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(IILet;IILir;ILfu;)V", line = 41)
