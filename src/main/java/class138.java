...
public class class138 extends class414 {
    ...
    @OriginalMember(owner = "client!ik", name = "Q", descriptor = "(IIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(III[I)V", line = 40)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "()Lia;", line = 51)
    ...
    @OriginalMember(owner = "client!ik", name = "HA", descriptor = "()V", line = 74)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(ZZ)Z", line = 87)
    public static boolean method980(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!ik", name = "ma", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(I)[F", line = 114)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(ILia;)V", line = 138)
    ...
    @OriginalMember(owner = "client!ik", name = "X", descriptor = "([I)V", line = 162)
    ...
    @OriginalMember(owner = "client!ik", name = "c", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!ik", name = "ba", descriptor = "(Lia;)V", line = 209)
    ...
    @OriginalMember(owner = "client!ik", name = "E", descriptor = "(III[I)V", line = 231)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IZFIIFF)V", line = 241)
    ...
    @OriginalMember(owner = "client!ik", name = "na", descriptor = "(I)V", line = 275)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(B)[F", line = 304)
    ...
    @OriginalMember(owner = "client!ik", name = "YA", descriptor = "(I)V", line = 330)
    ...
    @OriginalMember(owner = "client!ik", name = "ZA", descriptor = "(III)V", line = 343)
    ...
    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(B)V", line = 354)
    ...
    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(I)V", line = 385)
    ...
    @OriginalMember(owner = "client!ik", name = "<init>", descriptor = "()V", line = 396)
    public class138() {
        this.method964();
    }

    @OriginalMember(owner = "client!ik", name = "O", descriptor = "(I)V", line = 404)
    ...
    @OriginalMember(owner = "client!ik", name = "R", descriptor = "(III)V", line = 416)
