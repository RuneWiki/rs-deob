...
public class class138 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IB)V", line = 7)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(II)V", line = 38)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(BC)C", line = 82)
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(Lci;ILg;)V", line = 129)
    public class138(class421 arg0, int arg1, class470 arg2) {
        this.field1673 = arg2;
        this.field1673.method2755(-79, 26);
    }

    @OriginalMember(owner = "client!om", name = "b", descriptor = "(II)Lje;", line = 104)
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(I)V", line = 144)
