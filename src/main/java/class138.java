...
public abstract class class138 {
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(IIIBIIIIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!lca", name = "<init>", descriptor = "(IIIII)V", line = 341)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(ILqg;)Z", line = 84)
    ...
    @OriginalMember(owner = "client!lca", name = "c", descriptor = "(B)V", line = 100)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(IIII)V", line = 155)
    ...
    @OriginalMember(owner = "client!lca", name = "d", descriptor = "(B)V", line = 320)
