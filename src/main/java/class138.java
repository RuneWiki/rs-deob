...
public class class138 extends class418 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(BII)Lwl;")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(I)Lss;")
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(ILwf;Lwf;Loi;Lum;IIZ)V")
