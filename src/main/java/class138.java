...
public class class138 {
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IBLqa;IIZLc;I)V")
    ...
    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IIZLqa;IZI)Lc;")
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(ILjq;IILgj;Lqa;)Z")
    ...
    @OriginalMember(owner = "client!ik", name = "<init>", descriptor = "(Lqa;Lgm;IIIIIIZI)V")
