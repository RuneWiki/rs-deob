...
public class class138 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IIIIZ)V", line = 20)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!ls", name = "<init>", descriptor = "(Lsaa;ILfp;Lfp;)V", line = 167)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IB)Llo;", line = 87)
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(B)V", line = 117)
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(IB)V", line = 135)
