...
public class class138 extends class665 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Ljava/io/File;ZZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(JZ)V", line = 47)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IZIILr;IBLkga;ILrk;)Lda;", line = 61)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ZI[IB[I)J", line = 311)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(BII)Z", line = 359)
