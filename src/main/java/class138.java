...
public class class138 {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(BLfs;J)V")
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IB)Lsf;")
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lqr;B)V")
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(JB)Lfs;")
