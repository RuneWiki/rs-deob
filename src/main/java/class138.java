...
public class class138 {
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(II)Lud;", line = 69)
    ...
    @OriginalMember(owner = "client!ui", name = "c", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(Ldn;ILr;)V", line = 123)
