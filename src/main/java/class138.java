...
public class class138 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IJ)Lmo;", line = 14)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IIIIIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(JLmo;I)V", line = 78)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IIILqj;)Ljd;", line = 99)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(B)Lmo;", line = 151)
