...
public class class138 extends class585 {
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "()V", line = 4)
    public class138() {
        super(1, true);
    }

    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Lso;II)V", line = 16)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!fg", name = "c", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(II)[I", line = 252)
    ...
    @OriginalMember(owner = "client!fg", name = "d", descriptor = "(I)V", line = 294)
    ...
    @OriginalMember(owner = "client!fg", name = "e", descriptor = "(I)V", line = 313)
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(BI)[I", line = 326)
