...
public class class138 {
    ...
    @OriginalMember(owner = "client!pda", name = "b", descriptor = "(BI)I")
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(ILnr;)V")
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(Lnr;II)V")
