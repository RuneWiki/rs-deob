...
public class class138 extends class496 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IB)[B", line = 16)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "([B)V", line = 71)
