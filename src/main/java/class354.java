...
public class class354 {
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(IIZ)Lvd;", line = 5)
    ...
    @OriginalMember(owner = "client!dda", name = "toString", descriptor = "()Ljava/lang/String;", line = 28)
    public final String toString() {
        field4574++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(I)V", line = 46)
