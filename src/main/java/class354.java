...
public class class354 extends class204 {
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "(ILfs;)V", line = 3)
    public class354(int arg0, class607 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!nb", name = "c", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(B)I", line = 19)
    ...
    @OriginalMember(owner = "client!nb", name = "d", descriptor = "(I)Z", line = 30)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(II)I", line = 41)
    ...
    @OriginalMember(owner = "client!nb", name = "d", descriptor = "(II)V", line = 57)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(B)I", line = 69)
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "(Lfs;)V", line = 80)
    public class354(class607 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 84)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(I)V", line = 105)
