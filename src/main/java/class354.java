...
public class class354 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Z)V", line = 131)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(ILom;)Z", line = 143)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(B)V", line = 181)
    ...
    @OriginalMember(owner = "client!ob", name = "b", descriptor = "(B)V", line = 246)
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(Lji;)V", line = 1106)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IFIFFI[FIBIIII)V", line = 282)
    ...
    @OriginalMember(owner = "client!ob", name = "b", descriptor = "(ILom;)V", line = 370)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(ZIILoa;)V", line = 407)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(ZIIII)Z", line = 883)
    ...
    @OriginalMember(owner = "client!ob", name = "b", descriptor = "(I)V", line = 929)
    ...
    @OriginalMember(owner = "client!ob", name = "c", descriptor = "(I)Z", line = 1034)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IBI)I", line = 1045)
