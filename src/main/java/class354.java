...
public class class354 extends class98 {
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(II[II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(I[IIII)Z", line = 90)
    ...
    @OriginalMember(owner = "client!ba", name = "d", descriptor = "(B)V", line = 118)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IIZ)Z", line = 153)
    ...
    @OriginalMember(owner = "client!ba", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 285)
    ...
    @OriginalMember(owner = "client!ba", name = "c", descriptor = "(I)V", line = 199)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(ZII[I)Z", line = 212)
    ...
    @OriginalMember(owner = "client!ba", name = "e", descriptor = "(B)V", line = 244)
