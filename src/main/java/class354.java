...
public abstract class class354 extends class197 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Lr;BLr;)V", line = 3)
    ...
    @OriginalMember(owner = "client!el", name = "h", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "([[[Lf;ZIIII)Z", line = 46)
