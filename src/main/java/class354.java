...
public class class354 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(II[[ZIZB)V", line = 6)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Lfq;III)V", line = 194)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IIBLfq;)Z", line = 262)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(ILfq;II)V", line = 334)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IIII[BBI)Z", line = 407)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IIIIB)V", line = 456)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "([BIIIBII[BI)V", line = 495)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(I)V", line = 537)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "([BBIIIII[BI)V", line = 566)
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(Lnm;Llg;)V", line = 607)
