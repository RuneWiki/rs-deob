...
public abstract class class354 extends class5 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(BI)[I", line = 31)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Z)I", line = 100)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(BII)[[I", line = 144)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(BII)[I", line = 178)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(III)V", line = 202)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lnj;II)V", line = 227)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIIIIII)I", line = 240)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IZI)I", line = 272)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IB)[[I", line = 308)
    ...
    @OriginalMember(owner = "client!ko", name = "f", descriptor = "(I)I", line = 319)
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(IZ)V", line = 336)
    public class354(int arg0, boolean arg1) {
        this.field5466 = arg1;
        this.field5462 = new class354[arg0];
    }

    @OriginalMember(owner = "client!ko", name = "g", descriptor = "(I)V", line = 359)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(B)V", line = 370)
