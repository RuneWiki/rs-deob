...
public class class354 extends class601 {
    ...
    @OriginalMember(owner = "client!cs", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(II)[[I", line = 17)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "()V", line = 86)
    public class354() {
        super(0, false);
    }

    @OriginalMember(owner = "client!cs", name = "d", descriptor = "(B)Z", line = 94)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(B)V", line = 121)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I)I", line = 133)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lmc;II)V", line = 144)
