...
public class class354 extends class5 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(BLjava/io/File;I)[B", line = 6)
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "()V", line = 23)
    public class354() {
        super(0, true);
    }

    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IIIIIII)I", line = 27)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ILes;I)V", line = 113)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(II)[I", line = 216)
    ...
    @OriginalMember(owner = "client!vd", name = "i", descriptor = "(I)V", line = 237)
    ...
    @OriginalMember(owner = "client!vd", name = "b", descriptor = "(III)Z", line = 295)
    ...
    @OriginalMember(owner = "client!vd", name = "j", descriptor = "(I)V", line = 309)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IB[I)V", line = 321)
    ...
    @OriginalMember(owner = "client!vd", name = "b", descriptor = "(I)V", line = 483)
