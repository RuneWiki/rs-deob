...
public class class354 extends class276 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Lqs;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "([B)V", line = 18)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(I)F", line = 62)
    ...
    @OriginalMember(owner = "client!bt", name = "b", descriptor = "([B)V", line = 74)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "()V", line = 231)
    ...
    @OriginalMember(owner = "client!bt", name = "c", descriptor = "(I)I", line = 250)
    ...
    @OriginalMember(owner = "client!bt", name = "d", descriptor = "(I)[F", line = 288)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "([I)Lmg;", line = 700)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Lqs;I)Lbt;", line = 762)
    ...
    @OriginalMember(owner = "client!bt", name = "b", descriptor = "()I", line = 782)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Lqs;II)Lbt;", line = 789)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "([BI)V", line = 811)
    ...
    @OriginalMember(owner = "client!bt", name = "<init>", descriptor = "([B)V", line = 816)
