...
public class class354 extends class513 {
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!ba", name = "b", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!ba", name = "<init>", descriptor = "([B)V", line = 110)
    public class354(byte[] arg0) {
        this.field4735 = arg0;
    }

    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IIILrh;Lrh;)V", line = 121)
