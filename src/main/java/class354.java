...
public class class354 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ILg;)I")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Z)Llaa;")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(B)Llaa;")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(BLet;)V")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Llaa;I)V")
    ...
    @OriginalMember(owner = "client!mf", name = "d", descriptor = "(I)Llaa;")
    ...
    @OriginalMember(owner = "client!mf", name = "e", descriptor = "(I)Llaa;")
