...
public class class354 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(I)Lle;")
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(III)Ljo;")
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Lle;B)V")
