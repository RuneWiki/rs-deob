...
public class class354 {
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(II)Lrs;")
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(ILoba;)V")
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(Lgia;ILaj;Laj;)V")
