...
public class class354 extends class15 {
    ...
    @OriginalMember(owner = "client!ih", name = "b", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!ih", name = "f", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(II)V", line = 79)
