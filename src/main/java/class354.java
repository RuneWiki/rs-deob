...
public class class354 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(ZI)Ldf;")
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Lpc;Lpc;Z)V")
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(II)Lsm;")
    ...
    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "(Lrb;ILpc;)V")
