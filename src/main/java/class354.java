...
public class class354 extends class179 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ILbg;I)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IIIIILki;I)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ILbg;)V")
