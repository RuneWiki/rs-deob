...
public class class354 extends class224 {
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(B)J", line = 4)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!jp", name = "h", descriptor = "(I)I", line = 27)
    ...
    @OriginalMember(owner = "client!jp", name = "c", descriptor = "(B)I", line = 39)
    public final int method2218(byte arg0) {
        ++field4987;
        return arg0 > -30 ? -109 : (int) (255L & super.field8991 >>> 32);
    }

    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(ILeq;)V", line = 52)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Ldm;I)V", line = 65)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(BII)Z", line = 78)
    ...
    @OriginalMember(owner = "client!jp", name = "i", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!jp", name = "<init>", descriptor = "(II)V", line = 112)
