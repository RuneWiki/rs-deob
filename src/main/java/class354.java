...
public class class354 extends class605 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!tm", name = "b", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(Lok;)V", line = 77)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Z)Z", line = 105)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(IILr;)Z", line = 117)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(IIII)V", line = 563)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ILip;I)V", line = 576)
    ...
    @OriginalMember(owner = "client!tm", name = "c", descriptor = "(I)V", line = 602)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ZB)V", line = 617)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(B)V", line = 628)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(IZI)V", line = 656)
