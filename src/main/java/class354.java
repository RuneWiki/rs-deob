...
public class class354 extends class673 {
    ...
    @OriginalMember(owner = "client!ada", name = "<init>", descriptor = "(Lrl;Ljava/lang/Object;I)V", line = 5)
    public class354(class153 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field5162 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!ada", name = "g", descriptor = "(I)Z", line = 14)
    public final boolean method2206(int arg0) {
        return arg0 == -1842 ? true : true;
    }

    @OriginalMember(owner = "client!ada", name = "c", descriptor = "(B)Ljava/lang/Object;", line = 25)
