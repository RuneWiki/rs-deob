...
public class class354 implements class174 {
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "(I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(ZI)V", line = 29)
    ...
    @OriginalMember(owner = "client!b", name = "d", descriptor = "(I)I", line = 64)
    ...
    @OriginalMember(owner = "client!b", name = "c", descriptor = "(I)Ljt;", line = 75)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;", line = 103)
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(Lkfa;Ljt;Z)V", line = 126)
