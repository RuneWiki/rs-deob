...
public class class354 extends class323 implements class231 {
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(Lqa;I)Lpl;")
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(ILqa;IB)Z")
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(Lkda;BLqa;)V")
    ...
    @OriginalMember(owner = "client!uw", name = "e", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(BILqa;)Lr;")
    ...
    @OriginalMember(owner = "client!uw", name = "b", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!uw", name = "<init>", descriptor = "(Lqa;Luh;IIIIIZIIIIII)V")
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(Lkda;IBI)Llo;")
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!uw", name = "b", descriptor = "(ILqa;)Lin;")
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(ILqa;)V")
