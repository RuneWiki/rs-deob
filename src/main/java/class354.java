...
public class class354 extends class366 {
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IBI)I", line = 3)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ILjava/lang/String;B)Ljava/lang/String;", line = 24)
    ...
    @OriginalMember(owner = "client!rj", name = "d", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ZI)V", line = 65)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ZLlf;I)V", line = 149)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Llf;I)V", line = 198)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;", line = 218)
