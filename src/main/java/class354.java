...
public class class354 {
    ...
    @OriginalMember(owner = "client!ng", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V")
    ...
    @OriginalMember(owner = "client!ng", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V")
    ...
    @OriginalMember(owner = "client!ng", name = "movemouse", descriptor = "(II)V")
