...
public class class354 {
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IIZ)V", line = 13)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IZIIIIII)V", line = 38)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(III)V", line = 92)
    ...
    @OriginalMember(owner = "client!kh", name = "toString", descriptor = "()Ljava/lang/String;", line = 109)
