...
public abstract class class354 {
    ...
    @OriginalMember(owner = "client!rq", name = "d", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Lwo;)V")
    public class354(class746 arg0) {
        this.field4544 = arg0;
        this.field4545 = this.method393((byte) 117);
    }

    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(ILwo;)V")
