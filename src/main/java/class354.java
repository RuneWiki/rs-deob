...
public class class354 extends class260 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "()V", line = 12)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 47)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "()V", line = 82)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 100)
    ...
    @OriginalMember(owner = "client!vq", name = "c", descriptor = "()I", line = 129)
    public final int method1638() {
        return this.field5435 - (this.field5436.available() >> (class116.field1749 ? 2 : 1));
    }

    @OriginalMember(owner = "client!vq", name = "d", descriptor = "()V", line = 136)
