...
public class class354 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lya;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(ILya;)V")
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(I[Ltt;IIII)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lya;IZ)Z")
