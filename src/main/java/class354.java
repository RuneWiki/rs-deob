...
public class class354 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Z)Z", line = 16)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Lvj;IIIII)V", line = 93)
    ...
    @OriginalMember(owner = "client!ob", name = "b", descriptor = "(I)Z", line = 183)
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(Lnh;)V", line = 271)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(BI)V", line = 202)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IIIII[B)V", line = 239)
