...
public class class354 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(CB)Z", line = 41)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(BILjg;)V", line = 70)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IZ)V", line = 102)
