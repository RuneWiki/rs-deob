...
public abstract class class354 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IIB)Z", line = 44)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;BZI)V", line = 54)
    ...
    @OriginalMember(owner = "client!rq", name = "e", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(II[B)V", line = 80)
    ...
    @OriginalMember(owner = "client!rq", name = "finalize", descriptor = "()V", line = 102)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Lac;I[BIZ)V", line = 122)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Lac;ILjaclib/memory/Buffer;IZ)V", line = 141)
