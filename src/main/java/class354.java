...
public class class354 {
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Luo;Lkh;IIII[I[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(II)Lfk;", line = 139)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IIIIIIII)V", line = 154)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "()V", line = 165)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Lja;III)I", line = 187)
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "()V", line = 245)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(I)V", line = 401)
    public static final void method2264(int arg0) {
        field4829 = (class405) field4827.method886((long) arg0, 25651);
    }

    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Luo;)Laq;", line = 405)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Luo;II)V", line = 417)
    ...
    @OriginalMember(owner = "client!rj", name = "c", descriptor = "()V", line = 596)
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(II)Lgi;", line = 618)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "([B[B[SII)V", line = 633)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Luo;IIII)V", line = 779)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Luo;Lco;IIII)V", line = 1121)
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(I)Lgi;", line = 1125)
    public static final class405 method2272(int arg0) {
        return (class405) field4827.method886((long) arg0, 25651);
    }

    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(Luo;)V", line = 1129)
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(Luo;IIII)Laq;", line = 1143)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Lnq;)V", line = 1153)
    ...
    @OriginalMember(owner = "client!rj", name = "d", descriptor = "()V", line = 1173)
    ...
    @OriginalMember(owner = "client!rj", name = "e", descriptor = "()V", line = 1183)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Luo;IIII[S[B)V", line = 1195)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Lja;II)V", line = 1267)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Luo;IIIIIII[S[BZ)V", line = 1290)
