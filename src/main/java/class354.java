...
public class class354 extends class236 {
    ...
    @OriginalMember(owner = "client!e", name = "b", descriptor = "(III)I", line = 4)
    public static final int method2145(int arg0, int arg1, int arg2) {
        field5117++;
        return ~arg1 == arg0 || arg1 == 5 ? class83.field1134[arg2 & 0x3] : 256;
    }

    @OriginalMember(owner = "client!e", name = "b", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(I)V", line = 42)
