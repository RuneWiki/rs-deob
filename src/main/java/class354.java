...
public class class354 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(II)V", line = 103)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ZLen;)V", line = 120)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IB)V", line = 144)
    ...
    @OriginalMember(owner = "client!th", name = "finalize", descriptor = "()V", line = 270)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IIII)I", line = 286)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(I)V", line = 300)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Len;I)V", line = 315)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IIIZBLen;ILmj;)V", line = 330)
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(I)Z", line = 370)
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(Len;Lnl;IIIIIIZI)V", line = 568)
    ...
    @OriginalMember(owner = "client!th", name = "c", descriptor = "(I)I", line = 392)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IZLen;ZIBI)Lmj;", line = 403)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(III)Ljf;", line = 534)
