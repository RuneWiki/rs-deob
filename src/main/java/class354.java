...
public class class354 extends class29 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Luk;IIIII)V")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ILfp;)V")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IBLat;)V")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ZLat;)V")
