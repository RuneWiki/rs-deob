...
public class class354 extends class745 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(IB)Lbea;", line = 10)
    ...
    @OriginalMember(owner = "client!on", name = "b", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(I[I)Ljava/lang/String;", line = 40)
