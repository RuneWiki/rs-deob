...
public class class354 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(III)I", line = 41)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Ljava/awt/Color;IILjava/awt/Color;Ljava/awt/Color;Ljava/lang/String;Z)V", line = 90)
    ...
    @OriginalMember(owner = "client!be", name = "b", descriptor = "(III)V", line = 171)
