...
public class class354 extends class59 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Lya;[Luj;Z)V")
    ...
    @OriginalMember(owner = "client!mq", name = "d", descriptor = "()Lkp;")
    public final class341 method2221() {
        return this.field5252;
    }

    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Lya;J)Z")
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Lya;J[Luj;[Ldv;Z)V")
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "([Ldv;Z)V")
    ...
    @OriginalMember(owner = "client!mq", name = "f", descriptor = "()V")
