...
public class class354 extends class144 implements class57 {
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!uw", name = "h", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(BLoa;)V")
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IILoa;I)Z")
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(ILoa;)V")
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IIILva;Loa;ZI)V")
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(Loa;B)Laca;")
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IZLoa;)Lba;")
    ...
    @OriginalMember(owner = "client!uw", name = "<init>", descriptor = "(Loa;Lqd;IIIIIZIIIIIII)V")
    ...
    @OriginalMember(owner = "client!uw", name = "b", descriptor = "(Loa;I)Lew;")
