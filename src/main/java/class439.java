...
public class class439 {
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(ZLjava/awt/Frame;Ltt;)V")
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(IIIIIIIILoa;B)V")
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(Loa;II)Z")
    ...
    @OriginalMember(owner = "client!iea", name = "<init>", descriptor = "(I[Lce;IIII)V")
