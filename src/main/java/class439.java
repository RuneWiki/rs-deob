...
public class class439 extends class169 {
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(ZB)V", line = 3)
    ...
    @OriginalMember(owner = "client!qn", name = "e", descriptor = "(I)V", line = 17)
    public static void method2720(int arg0) {
        int var1 = 24 % ((-9 - arg0) / 58);
        field6546 = null;
    }

    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(ZLkt;IIBII)V", line = 27)
    ...
    @OriginalMember(owner = "client!qn", name = "<init>", descriptor = "(Ltt;II[BI)V", line = 85)
    ...
    @OriginalMember(owner = "client!qn", name = "f", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(I)V", line = 209)
