...
public class class439 extends class96 {
    ...
    @OriginalMember(owner = "client!at", name = "e", descriptor = "(III)V", line = 12)
    ...
    @OriginalMember(owner = "client!at", name = "b", descriptor = "(Z)V", line = 25)
    ...
    @OriginalMember(owner = "client!at", name = "e", descriptor = "(B)I", line = 40)
    ...
    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "()V", line = 133)
    public class439() {
        super(0, true);
    }

    @OriginalMember(owner = "client!at", name = "a", descriptor = "(IILbt;)V", line = 87)
    ...
    @OriginalMember(owner = "client!at", name = "b", descriptor = "(II)[I", line = 142)
