...
public class class439 extends class294 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ILpn;II)V")
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lpj;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!mf", name = "wa", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!mf", name = "fa", descriptor = "(IILr;)Lr;")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Ltd;I)[Lmm;")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Lqm;[I)V")
    ...
    @OriginalMember(owner = "client!mf", name = "CA", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Lr;IIIIZ)Z")
