...
public class class439 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(B)I", line = 6)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Lir;ILir;)V", line = 32)
