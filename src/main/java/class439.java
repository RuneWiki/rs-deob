...
public class class439 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(BILfp;I)Lqm;", line = 21)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(I)V", line = 39)
    public static final void method2652(int arg0) {
        class622.field8668 = arg0;
    }

    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 43)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(IB)Las;", line = 76)
