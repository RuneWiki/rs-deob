...
public class class439 extends class358 implements class248 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IBI[IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(Lrja;Lsw;Lig;II)V", line = 42)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(B)I", line = 62)
    public final int method1665(byte arg0) {
        return arg0 == 84 ? this.field6176 : 8;
    }

    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(Lrja;Lsw;IIZ[BII)V", line = 72)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ZZI)V", line = 130)
    ...
    @OriginalMember(owner = "client!nn", name = "b", descriptor = "(I)Z", line = 142)
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(Lrja;IIZ[III)V", line = 151)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Z)I", line = 208)
    ...
    @OriginalMember(owner = "client!nn", name = "b", descriptor = "(IF)F", line = 220)
    public final float method1670(int arg0, float arg1) {
        int var3 = 47 / ((arg0 - 68) / 53);
        return arg1 / (float) this.field6176;
    }

    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(I)V", line = 228)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Lsw;IIII[BIII)V", line = 239)
    ...
    @OriginalMember(owner = "client!nn", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 280)
    public final IDirect3DBaseTexture method2252(int arg0) {
        return arg0 == 15901 ? this.field6172 : (IDirect3DBaseTexture) null;
    }

    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IIII[III)V", line = 291)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IF)F", line = 330)
    public final float method1666(int arg0, float arg1) {
        return arg0 == -18982 ? arg1 / (float) this.field6175 : 0.6968257F;
    }

    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ILwga;)V", line = 340)
