...
public class class439 extends class538 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(Lnq;IIII[BI)V", line = 19)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IIIIIIII)V", line = 36)
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(Lnq;IIII)V", line = 59)
    ...
    @OriginalMember(owner = "client!lj", name = "c", descriptor = "(B)V", line = 72)
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(II)V", line = 82)
    public static final void method2660(int arg0, int arg1) {
        class513.field7540 = arg1 / arg0;
        ++field6626;
    }

    @OriginalMember(owner = "client!lj", name = "e", descriptor = "(I)V", line = 90)
