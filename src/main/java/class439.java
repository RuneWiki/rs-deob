...
public class class439 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(ILlm;)V")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(ILfh;Lii;)V")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(IBIIILii;IIII)V")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(ILii;I)Z")
    ...
    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "(I[Lcg;IIII)V")
