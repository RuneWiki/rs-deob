...
public class class439 extends class381 {
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Lod;II[B)V", line = 192)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BLjava/lang/String;)J", line = 203)
