...
public class class439 extends class40 {
    ...
    @OriginalMember(owner = "client!ql", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(IILlf;)V", line = 19)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(IIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(Z)V", line = 123)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ZZBLml;Ljava/lang/String;)V", line = 143)
    ...
    @OriginalMember(owner = "client!ql", name = "d", descriptor = "(I)Z", line = 210)
    ...
    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(IIII)V", line = 223)
    ...
    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "()V", line = 329)
    public class439() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(II)[[I", line = 339)
