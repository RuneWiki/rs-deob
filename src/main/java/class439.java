...
public class class439 extends class195 {
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(Ljava/awt/Canvas;B)V", line = 9)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ILjava/awt/Graphics;II)V", line = 34)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(Ljava/awt/Graphics;IIIII)V", line = 44)
