...
public class class439 {
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ILiv;B)V")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Liv;B)V")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Luu;ZLuu;)V")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BILpe;)Lag;")
