...
public abstract class class439 implements class446 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Ljaggl/opengl;IIIII[F)V")
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Ljaggl/opengl;IIIII[B)V")
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "(Lpo;IIIZ)V")
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Ljaggl/opengl;IIIIII[I)V")
