...
public class class439 extends class336 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 5)
    ...
    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "(Ldc;Ljava/lang/Object;I)V", line = 14)
    public class439(class23 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field5827 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Z)Z", line = 24)
