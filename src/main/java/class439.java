...
public class class439 extends class431 {
    ...
    @OriginalMember(owner = "client!a", name = "b", descriptor = "()V", line = 113)
    public final void method2704() {
        this.field6447 = null;
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lul;II)La;", line = 117)
    ...
    @OriginalMember(owner = "client!a", name = "<init>", descriptor = "(Lhp;)V", line = 126)
