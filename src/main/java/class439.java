...
public class class439 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!io", name = "toString", descriptor = "()Ljava/lang/String;", line = 18)
    public final String toString() {
        field6505++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(II)V", line = 37)
