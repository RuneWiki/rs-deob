...
public class class439 extends class20 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(II)Z", line = 16)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(B[BII)V", line = 27)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(III)Ldc;", line = 43)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 55)
    ...
    @OriginalMember(owner = "client!la", name = "finalize", descriptor = "()V", line = 87)
    protected final void finalize() {
        field6091++;
        this.method183((byte) 88);
    }

    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I[BII)I", line = 95)
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 113)
    ...
    @OriginalMember(owner = "client!la", name = "c", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(B)V", line = 141)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IBI)Z", line = 157)
