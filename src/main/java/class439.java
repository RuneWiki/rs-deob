...
public class class439 {
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "()I", line = 4)
    public int method463() throws Exception {
        field6470++;
        return this.field6499;
    }

    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IILad;)V", line = 15)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 52)
    public void method464(Component arg0) throws Exception {
        field6482++;
    }

    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BLad;)V", line = 62)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "()V", line = 87)
    public void method462() throws Exception {
        field6485++;
    }

    @OriginalMember(owner = "client!eb", name = "a", descriptor = "([II)V", line = 96)
    ...
    @OriginalMember(owner = "client!eb", name = "c", descriptor = "(I)V", line = 255)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IIILei;)V", line = 372)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(B)V", line = 379)
    ...
    @OriginalMember(owner = "client!eb", name = "c", descriptor = "()V", line = 424)
    public void method465() throws Exception {
        field6476++;
    }

    @OriginalMember(owner = "client!eb", name = "d", descriptor = "()V", line = 432)
    public void method460() {
        field6474++;
    }

    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(II)V", line = 440)
    ...
    @OriginalMember(owner = "client!eb", name = "d", descriptor = "(I)V", line = 457)
    public void method461(int arg0) throws Exception {
        field6479++;
    }

    @OriginalMember(owner = "client!eb", name = "e", descriptor = "(I)V", line = 468)
    ...
    @OriginalMember(owner = "client!eb", name = "f", descriptor = "(I)V", line = 489)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(II)V", line = 508)
