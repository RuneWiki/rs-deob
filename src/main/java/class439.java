...
public class class439 extends class634 {
    ...
    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(III)V", line = 9)
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "()V", line = 183)
    public class439() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(BI)[[I", line = 99)
    ...
    @OriginalMember(owner = "client!ti", name = "f", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(ILig;Z)V", line = 192)
    ...
    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(BI)[I", line = 236)
