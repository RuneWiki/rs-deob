...
public class class439 {
    ...
    @OriginalMember(owner = "client!cga", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V")
    public class439(IDirect3DSwapChain arg0, IDirect3DSurface arg1) {
        this.method2421(arg1, true, arg0);
    }

    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(Ljagdx/IDirect3DSurface;ZLjagdx/IDirect3DSwapChain;)V")
