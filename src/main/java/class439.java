...
public class class439 extends class751 {
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!mba", name = "c", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(II)[I", line = 28)
    ...
    @OriginalMember(owner = "client!mba", name = "<init>", descriptor = "()V", line = 149)
    public class439() {
        super(0, true);
    }

    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(ILrv;I)V", line = 106)
