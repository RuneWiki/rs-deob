...
public class class439 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(II)Lps;")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Lnr;IIILtb;III)Lqa;")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(I)Lc;")
