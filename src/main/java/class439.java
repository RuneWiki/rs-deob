...
public class class439 extends class395 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(FFFFFFLhg;II)V")
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IILhg;II)V")
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(Lic;IIII)V")
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(Lic;II[III)V")
