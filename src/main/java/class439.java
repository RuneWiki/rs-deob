...
public class class439 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(BILrg;I)V", line = 10)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ZI)V", line = 40)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(II)Lqf;", line = 57)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/Class;", line = 82)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(BLrg;I)V", line = 132)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Z)Ljf;", line = 160)
