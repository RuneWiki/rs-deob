...
public class class439 extends class489 {
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Lo;Leu;[Lwe;[I[I)V")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "([B[IIIIIIIIIIILea;II)V")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(CIIIZLea;II)V")
