...
public class class439 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "([Lhh;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(B)[Leo;", line = 36)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Ld;Ljava/awt/Canvas;BII)Lha;", line = 48)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(II)Z", line = 69)
