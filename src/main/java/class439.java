...
public class class439 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(I)Lvi;")
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(Z)Lvi;")
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ILvi;)V")
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(B)Lvi;")
    ...
    @OriginalMember(owner = "client!gs", name = "c", descriptor = "(I)Lvi;")
