...
public class class439 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IIBI)V", line = 5)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "([I[I[I[[F)V", line = 58)
