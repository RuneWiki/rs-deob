...
public class class439 {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Ltf;IBI)J", line = 5)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Lha;B)Let;", line = 54)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(BI)Lkp;", line = 92)
    ...
    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "(Lcm;ILlt;)V", line = 140)
