...
public class class439 extends class47 implements class218 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Ltq;I)V")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Ltq;III)Z")
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Ltq;Lvc;IIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(Ltq;I)Lcj;")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(BZLtq;Lhm;III)V")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Ljava/lang/String;ILre;)I")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(ILtq;)V")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IILtq;Z)Lri;")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(BLtq;)V")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(ZLh;)V")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Ltq;II)Lns;")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(BILtq;)Lns;")
