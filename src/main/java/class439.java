...
public class class439 extends class460 {
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(Lrda;IIII[BI)V")
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(Lrda;IIII)V")
    ...
    @OriginalMember(owner = "client!gr", name = "e", descriptor = "(I)[Lle;")
