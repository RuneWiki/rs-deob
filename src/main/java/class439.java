...
public class class439 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IILwn;)V", line = 6)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(I)Z", line = 102)
    ...
    @OriginalMember(owner = "client!iq", name = "c", descriptor = "(I)Z", line = 139)
    ...
    @OriginalMember(owner = "client!iq", name = "d", descriptor = "(I)Lch;", line = 168)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lwn;I)V", line = 244)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(B)Lch;", line = 284)
