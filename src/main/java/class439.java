...
public class class439 extends class163 {
    ...
    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 5)
    public class439(Object arg0, int arg1) {
        super(arg1);
        this.field6383 = new SoftReference(arg0);
    }

    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(Z)Z", line = 14)
    ...
    @OriginalMember(owner = "client!rk", name = "d", descriptor = "(B)Ljava/lang/Object;", line = 24)
