...
public class class439 extends class180 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 9)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIBLvp;I)V", line = 35)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II)V", line = 161)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(B)V", line = 207)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Z)Llk;", line = 220)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/lang/String;ZI)V", line = 268)
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "()V", line = 367)
    public class439() {
    }

    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 369)
