...
public class class439 {
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(II)Lbm;", line = 19)
    ...
    @OriginalMember(owner = "client!uda", name = "b", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(BFIFFFLqi;IIFI)[B", line = 67)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(III)V", line = 83)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(B)V", line = 96)
    ...
    @OriginalMember(owner = "client!uda", name = "b", descriptor = "(II)V", line = 116)
    ...
    @OriginalMember(owner = "client!uda", name = "<init>", descriptor = "(Lmp;ILla;Lla;)V", line = 139)
