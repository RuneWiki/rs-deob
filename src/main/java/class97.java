...
public class class97 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Lvw;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ILjr;B)V", line = 34)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ILjr;II)V", line = 65)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(I)V", line = 113)
