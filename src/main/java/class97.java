...
public class class97 {
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "()V", line = 6)
    public class97() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IIII)I", line = 10)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Z[BLee;)V", line = 24)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "([BB)[B", line = 54)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(I)Ljava/lang/String;", line = 94)
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(III)V", line = 118)
