...
public class class97 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Ljc;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lvo;I)V", line = 49)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(ZILjc;)V", line = 69)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(II)V", line = 109)
