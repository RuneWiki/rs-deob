...
public class class97 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(II)V", line = 9)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ILsj;II)V", line = 33)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IIIII[I[IIIIIIIZLao;)I", line = 53)
