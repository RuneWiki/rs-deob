...
public class class97 {
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(ZLwm;)Lsh;")
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lbp;")
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(ILie;Lie;I)V")
