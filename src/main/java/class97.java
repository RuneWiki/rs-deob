...
public class class97 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ILdg;)V", line = 9)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "([I[B[[BI[I[[BBI)I", line = 31)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ILae;IBII)Lbk;", line = 124)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ILdg;I)V", line = 236)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(B)V", line = 333)
