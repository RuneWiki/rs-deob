...
public class class97 extends class477 {
    ...
    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(Lgk;Lwl;)V")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lrh;II)V")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(ILgf;Lgf;IIIIIIB)V")
