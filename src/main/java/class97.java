...
public class class97 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Len;II)V")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Lga;I)V")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Lir;I)V")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Lga;)V")
