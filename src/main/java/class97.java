...
public class class97 extends class680 {
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!pia", name = "<init>", descriptor = "(Luv;IIZ)V")
    ...
    @OriginalMember(owner = "client!pia", name = "<init>", descriptor = "(Luv;II[III)V")
