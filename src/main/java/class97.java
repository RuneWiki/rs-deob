...
public class class97 extends class6 {
    ...
    @OriginalMember(owner = "client!qm", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!qm", name = "g", descriptor = "(I)I", line = 18)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IBIIIIIII)V", line = 43)
    ...
    @OriginalMember(owner = "client!qm", name = "c", descriptor = "(B)I", line = 54)
    ...
    @OriginalMember(owner = "client!qm", name = "h", descriptor = "(I)J", line = 75)
    public final long method715(int arg0) {
        ++field1466;
        return arg0 < 44 ? -128L : Long.MAX_VALUE & super.field115;
    }

    @OriginalMember(owner = "client!qm", name = "i", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(II)V", line = 99)
