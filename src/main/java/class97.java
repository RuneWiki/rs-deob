...
public class class97 extends class164 {
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(ILfq;Lfq;F)V", line = 6)
    ...
    @OriginalMember(owner = "client!e", name = "c", descriptor = "(I)I", line = 95)
    ...
    @OriginalMember(owner = "client!e", name = "b", descriptor = "(I)Lfq;", line = 106)
    ...
    @OriginalMember(owner = "client!e", name = "<init>", descriptor = "(Lmm;I)V", line = 115)
