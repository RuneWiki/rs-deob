...
public class class97 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Ltb;ILjava/lang/String;)Lsq;", line = 5)
    ...
    @OriginalMember(owner = "client!sq", name = "finalize", descriptor = "()V", line = 29)
    protected final void finalize() throws Throwable {
        this.field1351.method1546(this.field1350);
        super.finalize();
    }

    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Ltb;II)V", line = 35)
