...
public class class97 extends class256 {
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "(I)V", line = 17)
    public class97(int arg0) {
        this.field1404 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!nb", name = "f", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!nb", name = "g", descriptor = "(I)V", line = 153)
