...
public class class97 {
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(Lsl;Z)V")
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(Lsl;II)V")
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(IIILqca;)V")
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(IIIIBIIII[Lria;Z)V")
