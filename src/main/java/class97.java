...
public class class97 {
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(ILib;Lvaa;)Ljl;", line = 7)
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(Lib;I)V", line = 71)
