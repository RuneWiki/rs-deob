...
public class class97 extends class33 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ILbl;BI)V")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(IILbv;)V")
    ...
    @OriginalMember(owner = "client!fq", name = "c", descriptor = "()Loa;")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ILqs;ZIIII)V")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "()Loa;")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(I[ILbv;III)V")
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(Ltd;)V")
