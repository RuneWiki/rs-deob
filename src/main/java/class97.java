...
public class class97 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "()V", line = 8)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IIIII)V", line = 21)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(ILlh;I)V", line = 162)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Z)Lmp;", line = 185)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Llh;B)V", line = 212)
