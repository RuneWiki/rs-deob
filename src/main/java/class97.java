...
public class class97 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(B)J", line = 22)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(III)B", line = 45)
