...
public class class97 extends class371 implements class210 {
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(B)I", line = 16)
    ...
    @OriginalMember(owner = "client!ub", name = "c", descriptor = "(B)Z", line = 33)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Lvc;I)Lep;", line = 44)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Lvc;B)V", line = 82)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ILvc;II)Z", line = 99)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(I)I", line = 165)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(BILvc;)Ln;", line = 176)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ZLvc;)V", line = 189)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Lvc;IIILoj;Lae;III)V", line = 201)
    ...
    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "(Lvc;Lnm;IIIIIZIIIIII)V", line = 303)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(ZLvc;)V", line = 312)
    ...
    @OriginalMember(owner = "client!ub", name = "e", descriptor = "(I)I", line = 325)
    public final int method803(int arg0) {
        ++field1361;
        return arg0 != -15823 ? 116 : this.field1369.method2282(-119);
    }

    @OriginalMember(owner = "client!ub", name = "f", descriptor = "(I)V", line = 338)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(B)I", line = 353)
