...
public class class97 extends class441 {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Lha;J)V", line = 25)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Lrba;IIIIIIIIIIIZZ)V", line = 201)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(JI)V", line = 221)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(Lrba;IIIIIIIIIIIZZ)V", line = 616)
