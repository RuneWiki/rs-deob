...
public class class97 {
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(Lcb;II)Loia;")
    ...
    @OriginalMember(owner = "client!oia", name = "c", descriptor = "()Lbc;")
    ...
    @OriginalMember(owner = "client!oia", name = "<init>", descriptor = "(Lrv;)V")
