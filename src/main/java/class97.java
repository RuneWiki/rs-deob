...
public class class97 extends class194 {
    ...
    @OriginalMember(owner = "client!mh", name = "b", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IIIIIIIILg;II)Z", line = 18)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(II)[I", line = 264)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "([BI)[B", line = 278)
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "()V", line = 333)
    public class97() {
        super(0, true);
    }
}
