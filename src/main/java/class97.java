...
public class class97 extends class205 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ILt;Lya;)V")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lya;I)V")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ZLya;)Llo;")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lgg;IZIIILya;)V")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ILya;IZ)Lt;")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ILya;II)Z")
