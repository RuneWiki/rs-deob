...
public class class97 {
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IIIIIILeq;III)V", line = 8)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(B)V", line = 91)
    ...
    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(I[Lka;IIII)V", line = 224)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(ZILeq;)Z", line = 144)
