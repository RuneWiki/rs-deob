...
public class class97 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(II)I", line = 3)
    public static int method519(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IBZLen;)Lkh;", line = 10)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IILjava/lang/String;)I", line = 53)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 68)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lbk;II)V", line = 94)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIILbk;)V", line = 117)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I)Z", line = 148)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(I)V", line = 181)
