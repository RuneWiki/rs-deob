...
public class class97 extends class308 implements class21 {
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "([BIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IIIIILjava/lang/String;II)V", line = 17)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(B[BII)[B", line = 38)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(I)I", line = 74)
    ...
    @OriginalMember(owner = "client!gj", name = "b", descriptor = "(I)I", line = 84)
    public final int method98(int arg0) {
        ++field1053;
        return arg0 != 14463 ? 68 : 0;
    }

    @OriginalMember(owner = "client!gj", name = "<init>", descriptor = "(Lvj;I[BI)V", line = 96)
    public class97(class422 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field1050 = arg1;
    }

    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Z)J", line = 104)
