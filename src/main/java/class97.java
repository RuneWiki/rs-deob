...
public class class97 {
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(IIIZI)V", line = 7)
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!eha", name = "b", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!eha", name = "c", descriptor = "(I)Ldm;", line = 86)
