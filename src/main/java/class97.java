...
public class class97 extends class45 {
    ...
    @OriginalMember(owner = "client!ct", name = "b", descriptor = "(II)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(II)[I", line = 51)
    ...
    @OriginalMember(owner = "client!ct", name = "f", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "()V", line = 100)
    public class97() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Lbu;I)V", line = 103)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IFFF)I", line = 115)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Lcu;II)V", line = 158)
