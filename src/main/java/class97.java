...
public class class97 {
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(BLnga;)[Lrha;", line = 17)
    ...
    @OriginalMember(owner = "client!pw", name = "b", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!pw", name = "c", descriptor = "(B)J", line = 77)
