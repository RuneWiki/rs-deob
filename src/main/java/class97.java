...
public class class97 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IIII)I", line = 3)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(II)I", line = 30)
    public static final int method768(int arg0, int arg1) {
        return class273.field3951 == null ? 0 : (class273.field3951[arg0][arg1] & 0xFF) << 3;
    }

    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IIB)Z", line = 44)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Z)V", line = 61)
