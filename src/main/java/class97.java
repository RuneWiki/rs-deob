...
public class class97 extends class615 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(BILeh;)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ILoa;)V")
    ...
    @OriginalMember(owner = "client!ra", name = "g", descriptor = "(I)Lub;")
