...
public class class97 {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "([BI)Ljd;", line = 3)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IIB)I", line = 48)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ILnq;II)J", line = 74)
    ...
    @OriginalMember(owner = "client!in", name = "toString", descriptor = "()Ljava/lang/String;", line = 104)
    public final String toString() {
        field1105++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!in", name = "a", descriptor = "(I)V", line = 113)
