...
public class class97 {
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(IIILeba;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!bba", name = "finalize", descriptor = "()V", line = 22)
    ...
    @OriginalMember(owner = "client!bba", name = "<init>", descriptor = "(Lkga;JI)V", line = 33)
    public class97(class506 arg0, long arg1, int arg2) {
        this.field1311 = arg0;
        this.field1312 = arg1;
    }

    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(Lsj;Lsj;I)V", line = 60)
