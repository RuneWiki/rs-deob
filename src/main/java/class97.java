...
public class class97 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IIBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(II)Ldd;", line = 84)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!ct", name = "b", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!ct", name = "b", descriptor = "(II)V", line = 147)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(B)V", line = 163)
    ...
    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "(Lrb;ILpc;)V", line = 181)
