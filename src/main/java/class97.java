...
public class class97 extends class561 implements class391 {
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Lqba;Ljt;II[BII)V")
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Lqba;Ljt;II[FII)V")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(ILjt;I[BIIIII)V")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Ljava/lang/String;Ldda;BZ)Lfe;")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IILps;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Lqba;Ljt;Llc;II)V")
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Lqba;II[III)V")
