...
public class class97 extends class311 {
    ...
    @OriginalMember(owner = "client!bba", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!bba", name = "c", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!bba", name = "<init>", descriptor = "(Lte;II[B)V", line = 30)
