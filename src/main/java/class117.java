...
public class class117 {
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(Lqa;Ljava/lang/String;[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(Lqa;Ljava/lang/String;IIIZ)V")
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(Lqa;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
    ...
    @OriginalMember(owner = "client!gw", name = "<init>", descriptor = "(Lqa;IZLjava/awt/Component;)V")
