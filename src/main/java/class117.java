...
public class class117 extends class115 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(BLbk;I)V")
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(BI)Llm;")
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ILra;)V")
