...
public class class117 extends class13 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ZI)[I", line = 5)
    ...
    @OriginalMember(owner = "client!ta", name = "d", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IB)V", line = 35)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(II)Lkb;", line = 85)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(BII)V", line = 110)
    ...
    @OriginalMember(owner = "client!ta", name = "e", descriptor = "(B)V", line = 133)
