...
public class class117 extends class439 {
    ...
    @OriginalMember(owner = "client!sq", name = "c", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(II)V", line = 32)
    ...
    @OriginalMember(owner = "client!sq", name = "d", descriptor = "(I)Z", line = 56)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(B)Lks;", line = 73)
    ...
    @OriginalMember(owner = "client!sq", name = "e", descriptor = "(I)V", line = 93)
