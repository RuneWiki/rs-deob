...
public class class117 implements class200 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "([Ljava/lang/String;I[S)V", line = 5)
    public static final void method851(String[] arg0, int arg1, short[] arg2) {
        field1620++;
        class201.method1394(arg0.length + arg1, arg0, 1, arg2, 0);
    }

    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Z)Z", line = 15)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(I)J", line = 30)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lvh;B)Z", line = 62)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IILe;Lne;I)V", line = 102)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(B)V", line = 157)
