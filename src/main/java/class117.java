...
public class class117 extends class45 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Z)Z", line = 55)
    public final boolean method280(boolean arg0) {
        ++field1628;
        return !arg0 ? true : true;
    }

    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(ZB)V", line = 67)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(III)V", line = 78)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(ILkj;Z)V", line = 142)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(Lfd;Lm;)V", line = 158)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IIII)I", line = 209)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(B)V", line = 237)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 269)
