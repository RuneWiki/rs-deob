...
public class class117 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IZ)Lci;", line = 3)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(III)Z", line = 35)
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(Lsaa;ILfp;)V", line = 70)
