...
public class class117 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(I)Lvs;", line = 3)
    ...
    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(IJ)Lvs;", line = 53)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(JBLvs;)V", line = 93)
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lr;II)Lho;", line = 140)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(IBI)V", line = 156)
