...
public class class117 extends class424 {
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "()V", line = 5)
    public class117() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ao", name = "g", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(BI)V", line = 32)
    ...
    @OriginalMember(owner = "client!ao", name = "c", descriptor = "(III)Z", line = 49)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIIIIII)V", line = 75)
    ...
    @OriginalMember(owner = "client!ao", name = "h", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!ao", name = "i", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!ao", name = "d", descriptor = "(B)V", line = 164)
    ...
    @OriginalMember(owner = "client!ao", name = "j", descriptor = "(I)V", line = 200)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lrg;BI)V", line = 221)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(ILij;)V", line = 306)
    ...
    @OriginalMember(owner = "client!ao", name = "c", descriptor = "(I)V", line = 325)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(Z)V", line = 337)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(II)Lae;", line = 356)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(IB)[I", line = 379)
