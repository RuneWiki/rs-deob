...
public class class117 extends class203 {
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(Ljava/lang/String;IZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(Ljava/lang/String;II[B)I", line = 103)
    ...
    @OriginalMember(owner = "client!oda", name = "<init>", descriptor = "([Lofa;)V", line = 153)
    public class117(class328[] arg0) {
        this.field1850 = arg0;
    }

    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(IIZ)V", line = 161)
    ...
    @OriginalMember(owner = "client!oda", name = "b", descriptor = "(I)V", line = 178)
