...
public class class117 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ZLtt;)V")
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ILi;)V")
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ZLek;)Lgaa;")
