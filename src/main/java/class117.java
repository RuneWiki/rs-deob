...
public class class117 extends class616 {
    ...
    @OriginalMember(owner = "client!qca", name = "e", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(Z)Z", line = 40)
    public final boolean method36(boolean arg0) {
        field1604++;
        return arg0 ? false : false;
    }

    @OriginalMember(owner = "client!qca", name = "b", descriptor = "(Z)V", line = 51)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(IBI)V", line = 64)
    ...
    @OriginalMember(owner = "client!qca", name = "b", descriptor = "(B)Ljava/lang/Object;", line = 87)
    ...
    @OriginalMember(owner = "client!qca", name = "<init>", descriptor = "(Lvm;Ljava/lang/Object;I)V", line = 98)
