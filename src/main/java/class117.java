...
public class class117 extends class512 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(ZILia;)V")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(ILal;FFFIZIIFF)[B")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lec;ZII)V")
