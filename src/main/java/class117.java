...
public class class117 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lha;Lso;IIII[I[I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lha;IIII)V", line = 141)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lwia;Lufa;Lgba;Laga;Lg;Leca;Lob;)V", line = 485)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lha;II)V", line = 516)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IIIIIIII)V", line = 694)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(II)Lsha;", line = 706)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(I)Lsha;", line = 718)
    public static final class758 method878(int arg0) {
        return (class758) field1787.method2242((long) arg0, -1);
    }

    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lha;IIII[S[B)V", line = 721)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "()V", line = 780)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lha;)Lok;", line = 802)
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(Lha;IIII)Lok;", line = 815)
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(II)Ldha;", line = 826)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lha;IIIIIII[S[BZ)V", line = 843)
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(I)V", line = 1009)
    public static final void method885(int arg0) {
        field1791 = (class758) field1787.method2242((long) arg0, -1);
    }

    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lha;Lqe;IIII)V", line = 1013)
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "()V", line = 1017)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Ld;II)V", line = 1031)
    ...
    @OriginalMember(owner = "client!ra", name = "c", descriptor = "()V", line = 1040)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Ld;III)I", line = 1067)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "([B[B[SII)V", line = 1125)
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(Lha;)V", line = 1271)
    ...
    @OriginalMember(owner = "client!ra", name = "d", descriptor = "()V", line = 1284)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lha;Lqe;Lbr;)V", line = 1445)
    ...
    @OriginalMember(owner = "client!ra", name = "e", descriptor = "()V", line = 1563)
