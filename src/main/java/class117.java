...
public class class117 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IB)I", line = 4)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "([I[JI)V", line = 30)
    public static final void method912(int[] arg0, long[] arg1, int arg2) {
        class257.method1740(arg1, arg2, 1, arg0, arg1.length - 1);
        field1619++;
    }

    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Lnl;ILvg;Lnl;Lnl;)Z", line = 44)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 64)
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(I)V", line = 89)
