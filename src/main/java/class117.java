...
public class class117 extends class671 {
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(BZI)V", line = 24)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!eea", name = "<init>", descriptor = "(IIIIIFFF)V", line = 51)
    ...
    @OriginalMember(owner = "client!eea", name = "b", descriptor = "(IIII)Z", line = 63)
    ...
    @OriginalMember(owner = "client!eea", name = "d", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(IIB)V", line = 132)
    ...
    @OriginalMember(owner = "client!eea", name = "b", descriptor = "(B)V", line = 171)
