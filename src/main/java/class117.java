...
public class class117 implements Runnable {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "()V", line = 102)
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(ILha;)V", line = 168)
    public class117(int arg0, class543 arg1) {
        this.field1607 = arg0;
        this.field1605 = arg1;
    }

    @OriginalMember(owner = "client!bi", name = "c", descriptor = "()J", line = 116)
    public final long method826() {
        return this.field1610;
    }

    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lre;)V", line = 119)
    ...
    @OriginalMember(owner = "client!bi", name = "d", descriptor = "()V", line = 131)
    ...
    @OriginalMember(owner = "client!bi", name = "e", descriptor = "()V", line = 139)
    ...
    @OriginalMember(owner = "client!bi", name = "f", descriptor = "()Z", line = 148)
    public final boolean method830() {
        return this.field1609 == null || !this.field1608 && this.field1609.method1786(1);
    }

    @OriginalMember(owner = "client!bi", name = "run", descriptor = "()V", line = 157)
