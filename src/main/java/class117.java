...
public class class117 extends class202 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(III)I", line = 3)
    ...
    @OriginalMember(owner = "client!cg", name = "e", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Ldn;Ldn;I)I", line = 34)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(ILqa;)V", line = 74)
    ...
    @OriginalMember(owner = "client!cg", name = "b", descriptor = "(ILqa;)Lso;", line = 84)
    ...
    @OriginalMember(owner = "client!cg", name = "c", descriptor = "(ILqa;)Loj;", line = 95)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(ILqa;II)Z", line = 144)
