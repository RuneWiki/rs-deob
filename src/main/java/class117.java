...
public class class117 extends class176 {
    ...
    @OriginalMember(owner = "client!rv", name = "t", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(ILwha;)V", line = 17)
    ...
    @OriginalMember(owner = "client!rv", name = "B", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "(I)V", line = 44)
    public class117(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!rv", name = "x", descriptor = "(I)Z", line = 48)
    ...
    @OriginalMember(owner = "client!rv", name = "A", descriptor = "(I)I", line = 65)
    ...
    @OriginalMember(owner = "client!rv", name = "y", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!rv", name = "z", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(II[BIII[BII)V", line = 112)
    ...
    @OriginalMember(owner = "client!rv", name = "b", descriptor = "(I[BII)V", line = 161)
    ...
    @OriginalMember(owner = "client!rv", name = "s", descriptor = "(II)I", line = 180)
    ...
    @OriginalMember(owner = "client!rv", name = "u", descriptor = "(II)I", line = 217)
    ...
    @OriginalMember(owner = "client!rv", name = "b", descriptor = "([IB)V", line = 229)
