...
public class class117 extends class593 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lco;I)V")
    ...
    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "(Lnd;II[B)V")
    ...
    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "(Lnd;II[I)V")
