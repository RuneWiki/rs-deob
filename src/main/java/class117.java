...
public class class117 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "()I", line = 3)
    public final int method679() {
        return this.field1345 - 1;
    }

    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Luo;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 9)
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(Luo;IZLjava/awt/Component;)V", line = 189)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Luo;Ljava/lang/String;IIIZ)V", line = 104)
    ...
    @OriginalMember(owner = "client!jk", name = "b", descriptor = "()V", line = 121)
    public static void method682() {
        field1350 = null;
    }

    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Ljava/lang/String;)I", line = 128)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Luo;Ljava/lang/String;[IIIIZ)V", line = 144)
    ...
    @OriginalMember(owner = "client!jk", name = "c", descriptor = "()I", line = 232)
