...
public class class117 extends class469 {
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(I[BIIIZIIBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "(Lml;IIIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(ZBZ)V", line = 78)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(IBII)V", line = 99)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(IIIIIBI)V", line = 115)
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "(Lml;IIIIZ[BIZ)V", line = 132)
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "(Lml;IIIIZ[IIIZ)V", line = 184)
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "(Lml;IIII)V", line = 237)
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "(Lml;IIIIZ[FI)V", line = 249)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(III[IZIIII)V", line = 276)
    ...
    @OriginalMember(owner = "client!bp", name = "c", descriptor = "(B)V", line = 326)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(I)V", line = 337)
