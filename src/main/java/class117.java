...
public class class117 extends class399 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IZ)Ltp;")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Loa;J[Ljq;[Lpp;Z)V")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Loa;[Ljq;Z)V")
    ...
    @OriginalMember(owner = "client!tp", name = "e", descriptor = "()Lob;")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Loa;J)Z")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Loa;)V")
    ...
    @OriginalMember(owner = "client!tp", name = "g", descriptor = "()Lob;")
    public final class309 method721() {
        return this.field1509;
    }

    @OriginalMember(owner = "client!tp", name = "a", descriptor = "([Lpp;Z)V")
