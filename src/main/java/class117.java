...
public class class117 extends class178 implements class19 {
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(IIILiv;[BIIZI)V")
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Lht;Z)Z")
    ...
    @OriginalMember(owner = "client!wea", name = "<init>", descriptor = "(Lhj;II[III)V")
    ...
    @OriginalMember(owner = "client!wea", name = "<init>", descriptor = "(Lhj;Liv;Ljt;II)V")
    ...
    @OriginalMember(owner = "client!wea", name = "<init>", descriptor = "(Lhj;Liv;II[BII)V")
    ...
    @OriginalMember(owner = "client!wea", name = "<init>", descriptor = "(Lhj;Liv;II[FII)V")
    ...
    @OriginalMember(owner = "client!wea", name = "g", descriptor = "(I)V")
