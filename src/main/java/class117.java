...
public class class117 extends class637 {
    ...
    @OriginalMember(owner = "client!eea", name = "c", descriptor = "()V", line = 3)
    public final void method830() {
        field1591.method1018((byte) -79, this.field1590);
    }

    @OriginalMember(owner = "client!eea", name = "d", descriptor = "()I", line = 6)
    public final int method831() {
        return field1591.method1019(this.field1590, 65535);
    }

    @OriginalMember(owner = "client!eea", name = "e", descriptor = "()V", line = 9)
    public static void method832() {
        field1591 = null;
    }

    @OriginalMember(owner = "client!eea", name = "b", descriptor = "()V", line = 13)
    public final void method833() {
        field1591.method1016(this.field1590, 0);
    }

    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 16)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "()V", line = 19)
    public final void method835() {
        field1591.method1020(this.field1590, super.field8821);
    }

    @OriginalMember(owner = "client!eea", name = "d", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!eea", name = "<init>", descriptor = "(Llaa;I)V", line = 28)
