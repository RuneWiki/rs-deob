...
public class class117 {
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(IIIIIIIIIIII)V", line = 35)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(ILcea;)Lo;", line = 55)
    ...
    @OriginalMember(owner = "client!qca", name = "b", descriptor = "(I)V", line = 66)
