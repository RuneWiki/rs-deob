...
public abstract class class117 extends class68 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(BII)V", line = 7)
    ...
    @OriginalMember(owner = "client!sq", name = "d", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Z)V", line = 34)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 55)
