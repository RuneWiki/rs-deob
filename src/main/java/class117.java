...
public class class117 extends class501 implements class161 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!db", name = "c", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Lza;IIILps;IZ)V", line = 28)
    ...
    @OriginalMember(owner = "client!db", name = "b", descriptor = "(B)Z", line = 39)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Lza;III)Z", line = 50)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(I)I", line = 69)
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(Lza;Lii;IIIIIZIII)V", line = 81)
    ...
    @OriginalMember(owner = "client!db", name = "b", descriptor = "(I)I", line = 95)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Lza;B)V", line = 110)
    ...
    @OriginalMember(owner = "client!db", name = "b", descriptor = "(ILza;)Lhp;", line = 121)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(BLza;)V", line = 161)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Lza;IZ)Le;", line = 175)
    ...
    @OriginalMember(owner = "client!db", name = "d", descriptor = "(I)V", line = 186)
    ...
    @OriginalMember(owner = "client!db", name = "c", descriptor = "(B)Z", line = 196)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(ILza;)V", line = 208)
