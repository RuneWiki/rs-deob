...
public class class117 extends class467 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(ZII)V", line = 4)
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lbv;Ljava/lang/String;II)Lfk;", line = 47)
    ...
    @OriginalMember(owner = "client!cb", name = "c", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 140)
    public class117(String arg0) {
        this.field1645 = arg0;
    }

    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(B)V", line = 125)
