...
public class class117 extends class455 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lqa;Z)V")
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(ILqa;)Lfm;")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lrl;B)V")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(BLqa;I)Z")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IILqa;I)Z")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IILqa;Leq;IIZ)V")
