...
public class class117 extends class180 {
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!js", name = "c", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IIII)I", line = 47)
    ...
    @OriginalMember(owner = "client!js", name = "d", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IIIZ)V", line = 94)
    ...
    @OriginalMember(owner = "client!js", name = "e", descriptor = "(I)V", line = 119)
