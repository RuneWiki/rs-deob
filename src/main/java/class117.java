...
public class class117 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Lpj;Lpj;BF)Z", line = 24)
    ...
    @OriginalMember(owner = "client!jn", name = "b", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Z)Z", line = 124)
    ...
    @OriginalMember(owner = "client!jn", name = "<init>", descriptor = "(Luca;)V", line = 151)
    public class117(class287 arg0) {
        this.field1747 = arg0;
    }

    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IB)Lcq;", line = 161)
    ...
    @OriginalMember(owner = "client!jn", name = "c", descriptor = "(I)V", line = 189)
