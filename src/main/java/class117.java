...
public class class117 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "([BLsha;BI)Lmca;", line = 7)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(IIIZIII)I", line = 65)
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(Lak;)V", line = 102)
