...
public class class117 extends class54 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!er", name = "c", descriptor = "(Z)I", line = 17)
    ...
    @OriginalMember(owner = "client!er", name = "d", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IIIIIIIII)V", line = 38)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(FIFIFFIFILjf;I)[B", line = 49)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Lla;IZIZII)V", line = 60)
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(Z)I", line = 91)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IIB)Z", line = 102)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "([JI[I)V", line = 114)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(ILhia;)V", line = 127)
    public class117(int arg0, class73 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Z)V", line = 131)
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(IB)I", line = 150)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(Lhia;)V", line = 173)
