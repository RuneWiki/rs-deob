...
public class class117 {
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Luf;ILuf;ZI)Los;", line = 50)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Z)V", line = 101)
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "(Lka;Lid;)V", line = 111)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(ILuf;ILuf;)Los;", line = 125)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(B)Z", line = 145)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IIIII)V", line = 176)
    ...
    @OriginalMember(owner = "client!ld", name = "b", descriptor = "(I)V", line = 189)
