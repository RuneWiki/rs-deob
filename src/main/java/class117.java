...
public class class117 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lun;)V", line = 4)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "()V", line = 19)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(I)I", line = 32)
    ...
    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "()V", line = 50)
    public class117() {
        this.field1513[0] = 0;
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(Lun;)V", line = 63)
