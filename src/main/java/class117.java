...
public class class117 extends class436 implements class237 {
    ...
    @OriginalMember(owner = "client!er", name = "i", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(ZLha;IZ)Lcb;", line = 16)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Lha;III)Z", line = 46)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Z)I", line = 67)
    ...
    @OriginalMember(owner = "client!er", name = "c", descriptor = "(I)I", line = 81)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(I)I", line = 99)
    public final int method1034(int arg0) {
        ++field2151;
        return arg0 >= -125 ? 91 : 22;
    }

    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Lha;Lcn;IIBZI)V", line = 110)
    ...
    @OriginalMember(owner = "client!er", name = "j", descriptor = "(I)Z", line = 135)
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(Lha;B)Ldg;", line = 150)
    ...
    @OriginalMember(owner = "client!er", name = "h", descriptor = "(I)I", line = 164)
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(BLha;)Lhga;", line = 175)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(BLha;)V", line = 201)
    ...
    @OriginalMember(owner = "client!er", name = "g", descriptor = "(I)I", line = 212)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(BLjava/lang/String;ZZ)V", line = 223)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(B)Z", line = 1212)
    ...
    @OriginalMember(owner = "client!er", name = "d", descriptor = "(I)V", line = 1223)
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(I)V", line = 1237)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(ILha;B)Lka;", line = 1252)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Lha;I)V", line = 1277)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Lha;B)V", line = 1305)
    ...
    @OriginalMember(owner = "client!er", name = "m", descriptor = "(I)V", line = 1336)
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(Z)Z", line = 1346)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(Lha;Lij;IIIIIZIZ)V", line = 1365)
