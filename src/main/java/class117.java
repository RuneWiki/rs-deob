...
public class class117 extends class261 implements class116 {
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(ILoj;)V", line = 5)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(ILoj;IZ)Lpr;", line = 33)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IIZLa;IBLoj;)V", line = 67)
    ...
    @OriginalMember(owner = "client!vg", name = "b", descriptor = "(I)Z", line = 98)
    ...
    @OriginalMember(owner = "client!vg", name = "d", descriptor = "(I)Z", line = 120)
    ...
    @OriginalMember(owner = "client!vg", name = "b", descriptor = "(ILoj;)V", line = 132)
    ...
    @OriginalMember(owner = "client!vg", name = "b", descriptor = "(B)I", line = 159)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Z)I", line = 169)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IILoj;)Lqh;", line = 183)
    ...
    @OriginalMember(owner = "client!vg", name = "d", descriptor = "(ILoj;)V", line = 209)
    ...
    @OriginalMember(owner = "client!vg", name = "e", descriptor = "(I)V", line = 219)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(ILoj;B)Lqh;", line = 235)
    public final class352 method21(int arg0, class280 arg1, byte arg2) {
        ++field1444;
        return arg2 != -98 ? null : this.method569(arg0, 78, arg1);
    }

    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(I)V", line = 246)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(ILoj;II)Z", line = 260)
    ...
    @OriginalMember(owner = "client!vg", name = "c", descriptor = "(ILoj;)Lmg;", line = 282)
    ...
    @OriginalMember(owner = "client!vg", name = "h", descriptor = "(I)V", line = 308)
    ...
    @OriginalMember(owner = "client!vg", name = "<init>", descriptor = "(Loj;Lcu;IIIIZIIZ)V", line = 319)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(B)I", line = 355)
