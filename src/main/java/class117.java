...
public class class117 extends class263 {
    ...
    @OriginalMember(owner = "client!db", name = "d", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IB)[I", line = 32)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(ZZII)I", line = 117)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IZLgk;)V", line = 142)
