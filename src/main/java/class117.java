...
public abstract class class117 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "([[BBLft;)V", line = 3)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 76)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ILis;IIIIIIIII)Z", line = 103)
    ...
    @OriginalMember(owner = "client!gg", name = "b", descriptor = "(Z)V", line = 463)
