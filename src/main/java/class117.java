...
public class class117 extends class71 {
    ...
    @OriginalMember(owner = "client!me", name = "s", descriptor = "Llf;")
    private static class109 field2311 = class35.method275("Continue", 2);

    @OriginalMember(owner = "client!me", name = "o", descriptor = "Llf;")
    public static class109 field2307 = field2311;

    @OriginalMember(owner = "client!me", name = "q", descriptor = "Lrc;")
    public static class160 field2309 = new class160(30);

    @OriginalMember(owner = "client!me", name = "x", descriptor = "Llf;")
    private static class109 field2316 = class35.method275("Loading )2 please wait)3", 2);

    @OriginalMember(owner = "client!me", name = "w", descriptor = "Llf;")
    public static class109 field2315 = field2316;

    @OriginalMember(owner = "client!me", name = "v", descriptor = "Lrc;")
    public static class160 field2314 = new class160(30);

    @OriginalMember(owner = "client!me", name = "y", descriptor = "Lrc;")
    ...
    @OriginalMember(owner = "client!me", name = "u", descriptor = "Lbg;")
    public static class18 field2313;

    @OriginalMember(owner = "client!me", name = "z", descriptor = "Lbg;")
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(Llf;Lbg;BLlf;)[Lkf;")
