...
public class class330 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(II)Llk;")
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "([BIIZLih;IIB)Lgq;")
    ...
    @OriginalMember(owner = "client!di", name = "<init>", descriptor = "(Lwv;ILqs;)V")
