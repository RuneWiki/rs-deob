...
public class class330 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(IIILof;)V", line = 12)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(ZII[[[Lui;II)Z", line = 58)
    ...
    @OriginalMember(owner = "client!ii", name = "b", descriptor = "(I)V", line = 374)
