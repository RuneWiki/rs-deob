...
public class class330 implements class749 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(I)Lwt;")
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(Ltg;Lwt;Z)V")
