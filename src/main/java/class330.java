...
public class class330 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IIIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IBIIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(BLjava/lang/String;)I", line = 56)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IZILll;)V", line = 67)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(III)V", line = 137)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Lpp;ILg;IIILhq;Lqs;Ltq;ILll;Lei;)Lns;", line = 169)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IBILpp;Ltq;Lll;IIILei;II)Lns;", line = 353)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(III)V", line = 498)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IZILei;Lpp;Lg;Lpp;IIIILqs;Ltq;Lll;Z[Lhs;Lnk;Lhq;I)Lns;", line = 513)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "([IIIIZ[I)V", line = 1018)
