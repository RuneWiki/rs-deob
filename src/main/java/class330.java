...
public class class330 extends class119 {
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ILjb;ZI)J", line = 22)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(II)V", line = 53)
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(IIII)I", line = 92)
