...
public class class330 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IIF)F", line = 6)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IF)I", line = 17)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "()V", line = 76)
    public static void method2132() {
        field5118 = null;
        field5116 = null;
    }

    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Ltl;Lov;)V", line = 89)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(IIF)F", line = 161)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(F)F", line = 172)
