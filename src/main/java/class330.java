...
public class class330 implements Runnable {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(I[BIB)I", line = 4)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(ZI)Z", line = 47)
    ...
    @OriginalMember(owner = "client!vh", name = "run", descriptor = "()V", line = 96)
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "(Ljava/io/InputStream;I)V", line = 205)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(Z)V", line = 164)
    ...
    @OriginalMember(owner = "client!vh", name = "b", descriptor = "(I)V", line = 185)
