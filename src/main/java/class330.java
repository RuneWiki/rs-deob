...
public class class330 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IZIII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(I)Z", line = 49)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(B)V", line = 185)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(II)Z", line = 248)
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "(Lkw;)V", line = 678)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Z)V", line = 266)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Lf;I)Z", line = 296)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(ZLha;Lla;)V", line = 334)
    ...
    @OriginalMember(owner = "client!bc", name = "b", descriptor = "(I)Z", line = 469)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(CLjava/lang/String;B)[Ljava/lang/String;", line = 485)
    ...
    @OriginalMember(owner = "client!bc", name = "b", descriptor = "(B)V", line = 543)
    ...
    @OriginalMember(owner = "client!bc", name = "b", descriptor = "(Lf;I)V", line = 661)
