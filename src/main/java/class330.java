...
public class class330 {
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IZI)I", line = 40)
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 59)
