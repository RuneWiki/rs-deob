...
public class class330 extends class338 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(III)Z", line = 22)
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(Lir;)V", line = 225)
    public class330(class216 arg0) {
        this.field4402 = arg0;
    }

    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Z)I", line = 69)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IIIIBIIIII)V", line = 106)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lfd;B)Z", line = 181)
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(III)Z", line = 205)
