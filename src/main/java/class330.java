...
public class class330 extends class221 {
    ...
    @OriginalMember(owner = "client!ih", name = "b", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Ldg;I)V", line = 33)
    ...
    @OriginalMember(owner = "client!ih", name = "c", descriptor = "(II)V", line = 58)
    ...
    @OriginalMember(owner = "client!ih", name = "c", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(BLdg;)V", line = 354)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(III)I", line = 377)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(ILlb;)V", line = 391)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(ILvj;IILjava/lang/String;ILhq;IILbi;ILvm;)V", line = 565)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(B)V", line = 611)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(ZI)V", line = 635)
    ...
    @OriginalMember(owner = "client!ih", name = "d", descriptor = "(II)Lqr;", line = 685)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(ILdg;)V", line = 715)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(ILjava/lang/String;)J", line = 738)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(II)V", line = 760)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "([IB)Ljava/lang/String;", line = 784)
    ...
    @OriginalMember(owner = "client!ih", name = "b", descriptor = "(B)V", line = 836)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(IFZILsa;)V", line = 868)
    ...
    @OriginalMember(owner = "client!ih", name = "b", descriptor = "(I)V", line = 897)
