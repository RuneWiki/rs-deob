...
public class class330 extends class74 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(II)I", line = 38)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(BII)I", line = 54)
    ...
    @OriginalMember(owner = "client!pr", name = "d", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(Z)V", line = 90)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(ZZ)V", line = 100)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IZ)V", line = 113)
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(Llm;Lpl;Lbd;)V", line = 141)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IILhfa;)V", line = 166)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(I)Z", line = 182)
