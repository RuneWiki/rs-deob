...
public class class330 extends class435 {
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(Z)Z", line = 6)
    ...
    @OriginalMember(owner = "client!qca", name = "b", descriptor = "(Z)Z", line = 19)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(IZ)Z", line = 33)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(Lhw;Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(I)I", line = 73)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!qca", name = "<init>", descriptor = "(II)V", line = 101)
    public class330(int arg0, int arg1) {
        this.field4572 = arg0;
        this.field4567 = arg1;
    }

    @OriginalMember(owner = "client!qca", name = "e", descriptor = "(B)I", line = 113)
    ...
    @OriginalMember(owner = "client!qca", name = "b", descriptor = "(I)V", line = 123)
    public static void method1959(int arg0) {
        int var1 = -68 % ((-arg0 - 38) / 48);
        field4563 = null;
    }

    @OriginalMember(owner = "client!qca", name = "c", descriptor = "(Z)Z", line = 132)
