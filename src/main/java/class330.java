...
public class class330 implements class346 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IIIIBI[F)V", line = 3)
    ...
    @OriginalMember(owner = "client!vh", name = "b", descriptor = "(B)V", line = 115)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(B)Z", line = 144)
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "(Lri;Lri;Lio;)V", line = 163)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(ZI)V", line = 177)
