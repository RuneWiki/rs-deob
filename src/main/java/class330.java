...
public class class330 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(B)I", line = 14)
    ...
    @OriginalMember(owner = "client!vn", name = "toString", descriptor = "()Ljava/lang/String;", line = 32)
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(II)V", line = 42)
