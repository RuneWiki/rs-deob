...
public class class330 extends class321 {
    ...
    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "(Lmm;II[BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(ZI)V", line = 23)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "()V", line = 34)
