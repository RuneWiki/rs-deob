...
public class class330 extends class134 {
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(IILjava/awt/Canvas;B)Lnca;")
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(ILkda;)V")
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(Lkda;)V")
    public class330(class391 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!saa", name = "d", descriptor = "(I)V")
