...
public class class330 implements class16 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IZ)Laj;")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(II)Lvm;")
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(Lph;Lph;Lph;)V")
