...
public class class330 extends class379 {
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(Les;)V", line = 293)
    public class330(class403 arg0) {
        this.method1964(arg0, -60);
    }

    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(II)Z", line = 14)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 27)
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(I)[I", line = 120)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IB)V", line = 151)
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(II)V", line = 177)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Ltw;I)V", line = 193)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(B)V", line = 214)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Les;I)V", line = 229)
