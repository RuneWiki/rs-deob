...
public class class330 {
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(ILcm;Lcm;I)V")
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(ZI)Ltf;")
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Lqc;I)V")
