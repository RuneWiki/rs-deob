...
public class class330 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ILrfa;BLrfa;)Lmn;")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ZILrfa;ILrfa;)Lmn;")
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(Lgd;Loj;Ljava/math/BigInteger;Ljava/math/BigInteger;)V")
