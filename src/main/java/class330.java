...
public class class330 extends class284 {
    ...
    @OriginalMember(owner = "client!fi", name = "c", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "()Z", line = 78)
    public final boolean method694() {
        return true;
    }

    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lnj;)V", line = 83)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "()V", line = 94)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(Z)V", line = 114)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(Lhj;)V", line = 135)
