...
public class class330 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "()V", line = 34)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(III)I", line = 53)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Lfh;)V", line = 78)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(II)[I", line = 167)
