...
public class class330 extends class224 {
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(Lud;I)V", line = 21)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Lrca;B)V", line = 42)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ILud;I)V", line = 115)
    ...
    @OriginalMember(owner = "client!js", name = "h", descriptor = "(I)V", line = 179)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(CI)I", line = 191)
    ...
    @OriginalMember(owner = "client!js", name = "i", descriptor = "(I)V", line = 225)
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(CI)I", line = 254)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Z)V", line = 284)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(BIILjava/awt/Canvas;Ld;)Lha;", line = 1154)
