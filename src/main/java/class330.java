...
public class class330 extends class84 implements class145 {
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(Ltk;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(Ltk;Let;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(Ltk;Let;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(I[FILet;BIIII)V")
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(Ltk;Let;Lwha;II)V")
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(ILet;III[BIII)V")
