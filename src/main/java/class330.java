...
public class class330 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lnq;II)Lii;", line = 5)
    ...
    @OriginalMember(owner = "client!ii", name = "b", descriptor = "()[B", line = 61)
    ...
    @OriginalMember(owner = "client!ii", name = "c", descriptor = "()Lvj;", line = 120)
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(Lkh;)V", line = 129)
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "()V", line = 149)
    private class330() {
    }
}
