...
public class class330 extends class185 {
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!ka", name = "<init>", descriptor = "(II[I[I)V", line = 36)
    public class330(int arg0, int arg1, int[] arg2, int[] arg3) {
        this.field4837 = arg2;
        this.field4833 = arg3;
    }

    @OriginalMember(owner = "client!ka", name = "c", descriptor = "(I)Z", line = 49)
