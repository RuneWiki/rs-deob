...
public class class330 extends class744 {
    ...
    @OriginalMember(owner = "client!bg", name = "b", descriptor = "()Lih;")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lih;)V")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ILiha;)Z")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Ltga;I[[B)V")
