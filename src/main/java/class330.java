...
public class class330 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(I)Ljn;", line = 3)
    ...
    @OriginalMember(owner = "client!so", name = "b", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(B)Ljn;", line = 60)
    ...
    @OriginalMember(owner = "client!so", name = "c", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!so", name = "b", descriptor = "(B)I", line = 93)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Z)Ljn;", line = 115)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(ZLjn;)V", line = 141)
    ...
    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "()V", line = 173)
    public class330() {
