...
public class class330 extends class145 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(IZ)Z", line = 16)
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "()V", line = 269)
    public class330() {
        super(0, true);
    }

    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ZI)[I", line = 37)
    ...
    @OriginalMember(owner = "client!tm", name = "i", descriptor = "(I)V", line = 179)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(IILrt;)V", line = 192)
    ...
    @OriginalMember(owner = "client!tm", name = "c", descriptor = "(IIB)Z", line = 257)
    ...
    @OriginalMember(owner = "client!tm", name = "f", descriptor = "(I)V", line = 281)
