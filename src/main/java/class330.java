...
public class class330 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IILdu;BIILya;)Lt;", line = 3)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(BLiv;)V", line = 17)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lta;ZIILya;IILta;IZLdu;II)Lt;", line = 56)
    ...
    @OriginalMember(owner = "client!nm", name = "b", descriptor = "(B)[Ljc;", line = 83)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(BLiv;I)V", line = 94)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IILdu;ILta;ZLya;IBZIIILta;)Lt;", line = 228)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lya;BILdu;III)Lt;", line = 349)
