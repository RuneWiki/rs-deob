...
public class class330 extends class502 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IBILkh;)V")
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(ILeka;)V")
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(Leka;)V")
