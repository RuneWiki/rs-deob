...
public class class330 extends class316 {
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(Lbo;IIIIIIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(Lbo;IIIZ[I)V", line = 18)
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(Lbo;IIIIZ[BI)V", line = 42)
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(Lbo;IIIII[BI)V", line = 69)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(BC)Z", line = 83)
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(Lbo;IIII[I)V", line = 106)
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(Lbo;IIIIIZ)V", line = 120)
