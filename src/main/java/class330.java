...
public class class330 {
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(Lmc;Z)V")
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(BLjha;)V")
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(BILmc;)V")
