...
public class class330 extends class122 {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IIBI)[B", line = 3)
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "()V", line = 16)
    public class330() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(II)Lqj;", line = 33)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(BII)V", line = 121)
