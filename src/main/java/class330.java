...
public class class330 extends class393 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "()V", line = 3)
    private final void method1963() {
        this.field4233 = false;
    }

    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(J)V", line = 6)
    public final void method1964(long arg0) {
        this.field4230 = arg0;
    }

    @OriginalMember(owner = "client!wp", name = "b", descriptor = "()V", line = 9)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Lqa;J[Lsm;[Lot;Z)V", line = 33)
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "(I)V", line = 331)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Lqa;J)Z", line = 45)
    ...
    @OriginalMember(owner = "client!wp", name = "c", descriptor = "()V", line = 93)
    public final void method1968() {
        this.field4244 = true;
    }

    @OriginalMember(owner = "client!wp", name = "d", descriptor = "()Liv;", line = 97)
    public final class287 method1969() {
        return this.field4247;
    }

    @OriginalMember(owner = "client!wp", name = "a", descriptor = "([Lot;Z)V", line = 103)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Lqa;[Lsm;Z)V", line = 190)
    ...
    @OriginalMember(owner = "client!wp", name = "e", descriptor = "()V", line = 262)
    public final void method1972() {
        this.field4233 = true;
    }

    @OriginalMember(owner = "client!wp", name = "f", descriptor = "()V", line = 274)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IIIII)V", line = 293)
    ...
    @OriginalMember(owner = "client!wp", name = "g", descriptor = "()V", line = 300)
