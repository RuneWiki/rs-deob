...
public class class330 extends class651 {
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(I)V", line = 3)
    public final void method955(int arg0) {
        this.field4100.field8091 = (arg0 & 1) == 0;
        this.field4100.field8092 = false;
    }

    @OriginalMember(owner = "client!jp", name = "c", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!jp", name = "<init>", descriptor = "(Llea;)V", line = 57)
    public class330(class574 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jp", name = "d", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(ZZIIZI)V", line = 233)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(BIZ)Lba;", line = 328)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Ljava/lang/Thread;)V", line = 372)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IZZ)V", line = 378)
    ...
    @OriginalMember(owner = "client!jp", name = "e", descriptor = "(I)V", line = 473)
    ...
    @OriginalMember(owner = "client!jp", name = "j", descriptor = "()V", line = 722)
    ...
    @OriginalMember(owner = "client!jp", name = "l", descriptor = "()V", line = 727)
    public final void method956() {
        this.field4100 = null;
    }

    @OriginalMember(owner = "client!jp", name = "<init>", descriptor = "(Llea;Lnj;IIII)V", line = 731)
