...
public class class330 extends class202 {
    ...
    @OriginalMember(owner = "client!fr", name = "f", descriptor = "(I)Lvj;")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IILth;Lha;)V")
    ...
    @OriginalMember(owner = "client!fr", name = "c", descriptor = "()Lfja;")
    public final class202 method1420() {
        field4695++;
        return null;
    }

    @OriginalMember(owner = "client!fr", name = "d", descriptor = "()Lfja;")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(DII)Lvj;")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lvj;B)V")
