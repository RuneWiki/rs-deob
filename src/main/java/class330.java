...
public class class330 {
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "([BB)Z", line = 7)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(Ltc;III)V", line = 35)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(II)V", line = 60)
