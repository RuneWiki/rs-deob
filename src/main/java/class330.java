...
public abstract class class330 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(ILqa;B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!pp", name = "b", descriptor = "(B)V", line = 451)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(BI)Z", line = 477)
    ...
    @OriginalMember(owner = "client!pp", name = "c", descriptor = "(B)Z", line = 488)
