...
public class class330 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(II)I", line = 7)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(III)Z", line = 21)
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(II)I", line = 35)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "([BB)[B", line = 50)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(BI)I", line = 133)
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(II)V", line = 157)
