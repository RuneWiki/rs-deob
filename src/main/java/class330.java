...
public abstract class class330 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(II)Lsg;", line = 25)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Ljava/lang/String;ZLjava/lang/String;IILjava/lang/String;)V", line = 52)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IIIFIIIZI)[[I", line = 64)
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "(B)V", line = 106)
