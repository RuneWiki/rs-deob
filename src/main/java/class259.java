...
public class class259 extends class397 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IBLae;)V", line = 4)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!hf", name = "c", descriptor = "(II)Llc;", line = 108)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(BI)[[I", line = 133)
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "()V", line = 203)
    public class259() {
        super(1, false);
    }

    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(IIII)V", line = 210)
    ...
    @OriginalMember(owner = "client!hf", name = "e", descriptor = "(I)V", line = 326)
