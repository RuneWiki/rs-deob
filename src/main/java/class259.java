...
public class class259 extends class393 {
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IIIILhl;)V", line = 5)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(ILjava/lang/String;)I", line = 54)
    ...
    @OriginalMember(owner = "client!mb", name = "c", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIJII)V", line = 99)
