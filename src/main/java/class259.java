...
public class class259 extends class264 {
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(ILjava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(III)Lev;", line = 34)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(BI)I", line = 41)
    ...
    @OriginalMember(owner = "client!kw", name = "b", descriptor = "(B)I", line = 65)
    ...
    @OriginalMember(owner = "client!kw", name = "<init>", descriptor = "(ILmfa;)V", line = 79)
    public class259(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!kw", name = "c", descriptor = "(I)Z", line = 82)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(IIIZII)V", line = 98)
    ...
    @OriginalMember(owner = "client!kw", name = "b", descriptor = "(BI)V", line = 202)
    ...
    @OriginalMember(owner = "client!kw", name = "d", descriptor = "(I)V", line = 214)
    ...
    @OriginalMember(owner = "client!kw", name = "<init>", descriptor = "(Lmfa;)V", line = 230)
    public class259(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(IIIIII[[[BIIBIILha;)V", line = 233)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(B)I", line = 271)
    ...
    @OriginalMember(owner = "client!kw", name = "e", descriptor = "(I)V", line = 285)
    ...
    @OriginalMember(owner = "client!kw", name = "b", descriptor = "(I)V", line = 297)
