...
public class class259 extends class238 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IIIZII)V", line = 24)
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(I)V", line = 250)
