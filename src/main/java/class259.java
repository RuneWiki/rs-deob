...
public class class259 extends class258 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(BLmc;)V", line = 4)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Lim;B)V", line = 28)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Z)V", line = 67)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Ljava/lang/String;ZIIIZJIIJILjava/lang/String;Z)V", line = 87)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(IIIZBI)V", line = 104)
