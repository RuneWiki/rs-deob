...
public class class259 extends class155 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IILkh;I)V")
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(Lsf;Luw;)V")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lbr;II)V")
