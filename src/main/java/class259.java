...
public class class259 extends class748 {
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(BLjava/lang/String;Lwu;Z)Leea;")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(Lam;B)I")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(IZLvj;)V")
