...
public class class259 extends class384 {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IBIIII)V")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lke;BI)V")
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(Lln;)V")
