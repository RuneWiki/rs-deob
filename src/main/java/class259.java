...
public class class259 extends class303 implements class323 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IZILqa;)Z")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(ZLqa;I)Lc;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(I[[[Ltg;)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(ZIILqa;)Ldf;")
    ...
    @OriginalMember(owner = "client!a", name = "b", descriptor = "(Lqa;B)Lvs;")
    ...
    @OriginalMember(owner = "client!a", name = "<init>", descriptor = "(Lqa;Ljt;IIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lmv;ZI)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IILqa;)Lc;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(BLqa;)V")
