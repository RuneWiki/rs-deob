...
public class class259 extends class668 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lat;IIIIIIIIIIIZZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!uk", name = "b", descriptor = "()V", line = 27)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lha;J)V", line = 37)
    ...
    @OriginalMember(owner = "client!uk", name = "c", descriptor = "()V", line = 212)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(JI)V", line = 222)
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "(Lat;IIIIIIIIIIIZZ)V", line = 616)
