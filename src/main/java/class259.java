...
public class class259 extends class145 {
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(Leba;BZILeba;IZ)I", line = 4)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(IZ)Z", line = 38)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(IIIB)V", line = 55)
    ...
    @OriginalMember(owner = "client!bv", name = "<init>", descriptor = "()V", line = 69)
    public class259() {
        super(0, true);
    }

    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(II)Lqf;", line = 72)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(Ljava/lang/Throwable;B)Ljava/lang/String;", line = 98)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(ZI)[I", line = 172)
    public final int[] method27(boolean arg0, int arg1) {
        field3688++;
        return arg0 ? null : class601.field8779;
    }

    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(B)V", line = 187)
