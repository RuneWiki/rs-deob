...
public class class259 extends class511 {
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!cca", name = "b", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(BLso;)Lgi;", line = 74)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(III)V", line = 107)
    ...
    @OriginalMember(owner = "client!cca", name = "<init>", descriptor = "(Lpj;II[B)V", line = 132)
    ...
    @OriginalMember(owner = "client!cca", name = "<init>", descriptor = "(Lpj;II[I)V", line = 144)
