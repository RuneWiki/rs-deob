...
public class class259 extends class334 {
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(IILcea;Ljava/awt/Component;B)Liv;")
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(ILus;I)V")
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(IZLol;)V")
