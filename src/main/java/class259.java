...
public class class259 extends class264 {
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(II)I", line = 6)
    ...
    @OriginalMember(owner = "client!hn", name = "<init>", descriptor = "()V", line = 17)
    public class259() {
        super(3, false);
    }

    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IIIIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!hn", name = "h", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IB)V", line = 74)
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(BI)[[I", line = 109)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(II)[I", line = 190)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(BLkk;I)V", line = 242)
