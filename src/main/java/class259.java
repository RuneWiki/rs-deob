...
public class class259 {
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(IB)C", line = 7)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!dea", name = "toString", descriptor = "()Ljava/lang/String;", line = 51)
