...
public class class259 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IB)V", line = 19)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IIII)V", line = 130)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(BLbe;)V", line = 144)
