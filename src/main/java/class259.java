...
public class class259 extends class228 {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(ILjava/awt/Graphics;II)V", line = 10)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Ljava/awt/Canvas;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IIILjava/awt/Graphics;II)V", line = 42)
