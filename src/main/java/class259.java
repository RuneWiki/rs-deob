...
public class class259 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Lbo;Lps;Lqa;Z)V")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(BI)Lhm;")
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "(Lgo;ILns;)V")
