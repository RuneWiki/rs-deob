...
public class class259 extends class404 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lag;II[III)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lag;II)V")
    ...
    @OriginalMember(owner = "client!ao", name = "c", descriptor = "()Ljc;")
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "()Ljc;")
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Ljba;)V")
