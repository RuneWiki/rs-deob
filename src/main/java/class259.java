...
public class class259 {
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(IIIB)V", line = 6)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Lfa;Ljava/awt/Canvas;B)Lr;", line = 22)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 39)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Lqi;Z)I", line = 68)
    ...
    @OriginalMember(owner = "client!wea", name = "toString", descriptor = "()Ljava/lang/String;", line = 95)
    public final String toString() {
        field3169++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!wea", name = "<init>", descriptor = "(II)V", line = 103)
