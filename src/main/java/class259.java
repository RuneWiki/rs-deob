...
public class class259 extends class65 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(BIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!s", name = "<init>", descriptor = "(IIIIIF)V", line = 17)
    public class259(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!s", name = "a", descriptor = "(FB)V", line = 22)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;B)V", line = 38)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(JI)V", line = 91)
    ...
    @OriginalMember(owner = "client!s", name = "e", descriptor = "(B)V", line = 174)
