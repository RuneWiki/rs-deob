...
public class class259 implements class246 {
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(B)Lew;")
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(Lcu;Lew;Z)V")
