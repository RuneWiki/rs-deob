...
public class class259 {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lee;I)V", line = 23)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 103)
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IILee;)V", line = 136)
