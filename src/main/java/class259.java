...
public class class259 extends class232 {
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Lue;)V", line = 24)
    public final void method356(class127 arg0) {
        this.field3348.method1559(arg0);
    }

    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(Ltb;)V", line = 27)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Z)V", line = 63)
    public final void method357(boolean arg0) {
        this.field3348.method1542(8448, 7681);
    }

    @OriginalMember(owner = "client!pr", name = "b", descriptor = "()V", line = 66)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "()Z", line = 81)
    public final boolean method358() {
        return true;
    }

    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(I)V", line = 84)
