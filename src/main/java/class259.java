...
public class class259 extends class431 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/String;)V", line = 5)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Z)V", line = 40)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(I)Ljava/lang/String;", line = 51)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "()V", line = 79)
    public class259() {
    }

    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(J)V", line = 81)
