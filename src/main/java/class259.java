...
public class class259 extends class481 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IIIZ)V", line = 8)
    ...
    @OriginalMember(owner = "client!wd", name = "c", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IIIIIIIII)V", line = 114)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/lang/Throwable;B)Ljava/lang/String;", line = 149)
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(I)V", line = 225)
    ...
    @OriginalMember(owner = "client!wd", name = "d", descriptor = "(B)V", line = 238)
    ...
    @OriginalMember(owner = "client!wd", name = "c", descriptor = "(I)V", line = 250)
