...
public abstract class class259 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IIILjava/lang/String;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IIIILjava/lang/String;II)V", line = 32)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Ljava/lang/String;IIILjava/util/Random;IZ[Lha;I[I)I", line = 65)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Ljava/lang/String;IIIII)V", line = 102)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Z)V", line = 118)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "([Lha;[ILjava/lang/String;BIIII)V", line = 130)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ILjava/lang/String;Z[Lha;[IIIILpa;)V", line = 150)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ILpa;IIIIIIII[Lha;II[IILjava/lang/String;)I", line = 311)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 322)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IILjava/lang/String;)V", line = 394)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IBIILjava/lang/String;I)V", line = 434)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(BIILjava/lang/String;III)V", line = 448)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IIIZIIILjava/lang/String;)V", line = 474)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "([Lha;IBLjava/util/Random;IILjava/lang/String;III[IIII[I)I", line = 507)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IIBLjava/lang/String;I[I[Lha;IIIIIIIIILpa;)I", line = 585)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "([Lha;[I[IIII[ILjava/lang/String;)V", line = 685)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(III)V", line = 849)
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(Lqa;Lrl;)V", line = 883)
