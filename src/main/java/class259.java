...
public class class259 {
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(I)Lto;", line = 3)
    ...
    @OriginalMember(owner = "client!jw", name = "b", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!jw", name = "c", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!jw", name = "toString", descriptor = "()Ljava/lang/String;", line = 66)
    public final String toString() {
        field3387++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!jw", name = "<init>", descriptor = "(II)V", line = 75)
    public class259(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!jw", name = "d", descriptor = "(I)[Lrb;", line = 90)
