...
public class class259 extends class41 {
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(Lnm;IIIZ[I)V", line = 6)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(Lnm;IIII[I)V", line = 27)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(Lnm;IIIII[BI)V", line = 44)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IIILnm;II)Lup;", line = 59)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(Lnm;IIIIZ[BI)V", line = 76)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "([BIZIIILnm;I)Lup;", line = 98)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(Lnm;IIIIIZ)V", line = 115)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(Lnm;IIIIIIZ)V", line = 136)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "([IIIIZLnm;)Lup;", line = 150)
