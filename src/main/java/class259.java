...
public class class259 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(BZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IZIZ)V", line = 20)
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "(Lao;)V", line = 100)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ILlp;)Z", line = 63)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(II)Z", line = 88)
