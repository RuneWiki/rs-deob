...
public class class259 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(I)Lle;", line = 6)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(BIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Lle;I)V", line = 54)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(B)Lle;", line = 81)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 99)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(II)I", line = 112)
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "(I)V", line = 211)
    ...
    @OriginalMember(owner = "client!uj", name = "c", descriptor = "(I)I", line = 234)
    ...
    @OriginalMember(owner = "client!uj", name = "d", descriptor = "(I)Lle;", line = 256)
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "(B)V", line = 276)
    ...
    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "()V", line = 300)
    public class259() {
