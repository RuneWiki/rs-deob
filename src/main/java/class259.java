...
public class class259 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Z)Ldu;")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(BLdu;)V")
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "(I)Ldu;")
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "(B)Ldu;")
    ...
    @OriginalMember(owner = "client!uj", name = "c", descriptor = "(B)Ldu;")
