...
public class class259 {
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(I)Lrba;")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(JI)Lrba;")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(ILmj;II)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lrba;JI)V")
