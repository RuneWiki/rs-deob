...
public class class259 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ILrs;ILjava/lang/String;)Lica;", line = 8)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IIILpe;III)V", line = 31)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(B)V", line = 44)
