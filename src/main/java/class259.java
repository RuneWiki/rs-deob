...
public class class259 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(BJ)V", line = 3)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(III)V", line = 37)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/Class;", line = 54)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IBIII)V", line = 91)
