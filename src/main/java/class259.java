...
public class class259 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(J[ILkl;B)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(II)Lni;")
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(II)Lkl;")
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(ILmg;Lmg;Ldt;)V")
