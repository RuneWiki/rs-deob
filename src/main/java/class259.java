...
public class class259 extends class371 {
    ...
    @OriginalMember(owner = "client!uc", name = "b", descriptor = "(BI)[I", line = 19)
    ...
    @OriginalMember(owner = "client!uc", name = "c", descriptor = "(Z)V", line = 123)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Lhaa;III)V", line = 229)
    ...
    @OriginalMember(owner = "client!uc", name = "d", descriptor = "(Z)V", line = 260)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(BLdda;ILjava/awt/Canvas;Ln;)Lqa;", line = 279)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 308)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IBLps;)V", line = 332)
    ...
    @OriginalMember(owner = "client!uc", name = "g", descriptor = "(I)V", line = 424)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Lfc;)V", line = 496)
