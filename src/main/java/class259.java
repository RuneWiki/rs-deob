...
public class class259 extends OutputStream {
    ...
    @OriginalMember(owner = "client!j", name = "write", descriptor = "(I)V", line = 15)
    public final void write(int arg0) throws IOException {
        field4154++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIII)V", line = 34)
