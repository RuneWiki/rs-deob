...
public abstract class class259 extends class419 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(III)B", line = 7)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IIIIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!nu", name = "c", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IIIIZI)V", line = 148)
    ...
    @OriginalMember(owner = "client!nu", name = "<init>", descriptor = "(IIIIZZ)V", line = 255)
