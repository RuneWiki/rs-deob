...
public class class259 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ZLtp;Ltp;IILfp;II[Lpn;ILwj;III)Lbi;")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ILwj;IILtp;IILfp;)Lbi;")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ILfp;IIIILtp;III)Lbi;")
