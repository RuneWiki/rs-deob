...
public class class259 extends class261 {
    ...
    @OriginalMember(owner = "client!ln", name = "c", descriptor = "(I)Z", line = 41)
    ...
    @OriginalMember(owner = "client!ln", name = "b", descriptor = "(B)V", line = 53)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(II)V", line = 74)
