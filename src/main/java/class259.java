...
public class class259 extends class315 implements class309 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "([IIBIIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ZZI)V", line = 33)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IIIIIIIII)V", line = 46)
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(I)Z", line = 57)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IIIIILpw;[FII)V", line = 69)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(Lia;Lpw;IIZ[FII)V", line = 84)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IF)F", line = 103)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ILpw;I[BIIIII)V", line = 115)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(Lia;IIZ[III)V", line = 135)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(Lia;Lpw;IIZ[BII)V", line = 154)
    ...
    @OriginalMember(owner = "client!sh", name = "f", descriptor = "(I)V", line = 177)
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(B)I", line = 187)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(Lia;Lpw;Llj;II)V", line = 203)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(FB)F", line = 215)
