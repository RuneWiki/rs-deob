...
public class class259 extends class261 {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ZB)V", line = 8)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(III)V", line = 19)
    public final void method1021(int arg0, int arg1, int arg2) {
        int var4 = 125 % ((82 - arg1) / 41);
        ++field4345;
    }

    @OriginalMember(owner = "client!in", name = "c", descriptor = "(I)Z", line = 28)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IILkk;)V", line = 40)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!in", name = "d", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IZ)V", line = 77)
    public final void method1022(int arg0, boolean arg1) {
        ++field4342;
        int var3 = -39 / ((87 - arg0) / 37);
    }

    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(Lih;)V", line = 91)
