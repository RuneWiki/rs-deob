...
public class class259 {
    ...
    @OriginalMember(owner = "client!sm", name = "finalize", descriptor = "()V", line = 15)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Liaa;Z)Z", line = 26)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIZ)Z", line = 137)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ZZ)V", line = 148)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "()V", line = 166)
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(Lbea;II)V", line = 388)
    public class259(class205 arg0, int arg1, int arg2) {
        this.field4141 = arg0;
        this.field4144 = arg2;
    }

    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Z)V", line = 399)
