...
public class class259 {
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(IIIIII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(IBLam;IIIZ)V", line = 66)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(Lbv;Loa;Lhk;Z)V", line = 142)
