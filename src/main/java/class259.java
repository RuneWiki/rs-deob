...
public class class259 extends class468 implements class145 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(FFFFFFLfa;II)V", line = 12)
    ...
    @OriginalMember(owner = "client!ja", name = "t", descriptor = "(III)V", line = 19)
    public final void method1550(int arg0, int arg1, int arg2) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ja", name = "finalize", descriptor = "()V", line = 24)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IILfa;II)V", line = 34)
