...
public abstract class class259 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IIIILpia;IIILka;IIILha;I)Lka;", line = 5)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(BLha;)V", line = 205)
