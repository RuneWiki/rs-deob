...
public class class259 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(IB)V", line = 13)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "(IB)Lwr;", line = 65)
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(IIIII)V", line = 128)
    ...
    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "(Lbo;Lm;)V", line = 147)
