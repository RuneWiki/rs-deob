...
public class class198 extends class467 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIIIII[BI[B)V", line = 59)
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "()V", line = 110)
    public class198() {
    }

    @OriginalMember(owner = "client!sd", name = "a", descriptor = "([Ljb;ZI)V", line = 116)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(II)Lud;", line = 204)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIIIZI)V", line = 229)
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "(S)V", line = 312)
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(I)V", line = 335)
