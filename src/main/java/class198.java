...
public class class198 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IIZIB)V", line = 5)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(II)I", line = 20)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IIILjava/lang/Class;)Lgn;", line = 44)
