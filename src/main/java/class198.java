...
public class class198 extends class456 {
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(ILak;)V", line = 4)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(IZIIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BI)V", line = 169)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/Class;", line = 190)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Lak;I)V", line = 228)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BLak;)V", line = 245)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(I)V", line = 261)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(FIZLya;I)V", line = 282)
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(II)V", line = 300)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(B)V", line = 314)
    ...
    @OriginalMember(owner = "client!mu", name = "c", descriptor = "(I)V", line = 409)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BLda;)V", line = 424)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Z)V", line = 462)
