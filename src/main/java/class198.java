...
public class class198 {
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Lmm;ILjava/lang/String;)Lqn;", line = 9)
    ...
    @OriginalMember(owner = "client!qn", name = "finalize", descriptor = "()V", line = 40)
    protected final void finalize() throws Throwable {
        this.field2863.method2208(this.field2862);
        super.finalize();
    }

    @OriginalMember(owner = "client!qn", name = "<init>", descriptor = "(Lmm;II)V", line = 48)
