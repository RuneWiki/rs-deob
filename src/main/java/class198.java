...
public class class198 {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Lya;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!vt", name = "b", descriptor = "(I)V", line = 82)
