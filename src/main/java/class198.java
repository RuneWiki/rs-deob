...
public class class198 extends class518 {
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(Lwfa;BLpq;Lpq;Lpq;)Z", line = 6)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(Z)Z", line = 23)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!lba", name = "d", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!lba", name = "<init>", descriptor = "(Lpea;Lpba;)V", line = 105)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(ZB)V", line = 118)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(BLwq;I)V", line = 151)
    ...
    @OriginalMember(owner = "client!lba", name = "e", descriptor = "(I)V", line = 161)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(IZI)V", line = 174)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(B)Lhe;", line = 219)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(ZI)V", line = 242)
