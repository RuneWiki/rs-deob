...
public class class198 {
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(BIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!qn", name = "c", descriptor = "(I)I", line = 95)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(BIII)V", line = 127)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(II)I", line = 145)
