...
public class class198 implements class715 {
    ...
    @OriginalMember(owner = "client!wfa", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;Z)Ljava/lang/Object;", line = 29)
    ...
    @OriginalMember(owner = "client!wfa", name = "d", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!wfa", name = "e", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!wfa", name = "b", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(II)I", line = 121)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(JI)Z", line = 137)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(ZI)V", line = 160)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(Ljava/lang/Object;ILjava/lang/String;Ljava/lang/Class;)I", line = 353)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(ILjava/lang/Object;Ljava/lang/String;Ljava/lang/Class;)Z", line = 367)
    ...
    @OriginalMember(owner = "client!wfa", name = "b", descriptor = "(B)I", line = 389)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(B)V", line = 400)
    ...
    @OriginalMember(owner = "client!wfa", name = "b", descriptor = "(II)I", line = 416)
