...
public class class198 extends class311 {
    ...
    @OriginalMember(owner = "client!ega", name = "<init>", descriptor = "(Lkha;Lkha;Luv;)V", line = 5)
    public class198(class687 arg0, class687 arg1, class25 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(IIIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 23)
    ...
    @OriginalMember(owner = "client!ega", name = "c", descriptor = "(I)V", line = 45)
