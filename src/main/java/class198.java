...
public class class198 extends class566 implements class19 {
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(ZZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(IF)F", line = 16)
    ...
    @OriginalMember(owner = "client!pba", name = "<init>", descriptor = "(Lkfa;Liv;Ljt;II)V", line = 25)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(B)I", line = 45)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(FI)F", line = 55)
    public final float method96(float arg0, int arg1) {
        return arg1 == -21696 ? arg0 / (float) this.field2660 : -0.75210816F;
    }

    @OriginalMember(owner = "client!pba", name = "<init>", descriptor = "(Lkfa;IIZ[III)V", line = 65)
    ...
    @OriginalMember(owner = "client!pba", name = "b", descriptor = "(I)I", line = 122)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(II[IIIIII)V", line = 133)
    ...
    @OriginalMember(owner = "client!pba", name = "b", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;", line = 173)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(I)Z", line = 183)
    ...
    @OriginalMember(owner = "client!pba", name = "<init>", descriptor = "(Lkfa;Liv;IIZ[BII)V", line = 192)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(Ltha;B)V", line = 251)
    public final void method1121(class372 arg0, byte arg1) {
        super.method1121(arg0, arg1);
    }

    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(IIILiv;[BIIZI)V", line = 259)
    ...
    @OriginalMember(owner = "client!pba", name = "c", descriptor = "(I)V", line = 301)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(III[IIII)V", line = 312)
