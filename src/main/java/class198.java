...
public class class198 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(BLjc;)V", line = 26)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(BLjc;I)V", line = 49)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(I)Lcu;", line = 75)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Z)V", line = 96)
