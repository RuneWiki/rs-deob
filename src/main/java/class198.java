...
public abstract class class198 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IIIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!km", name = "c", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IIIIIIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 87)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IILbr;)Ljava/lang/String;", line = 123)
