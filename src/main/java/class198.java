...
public class class198 extends class618 implements class125 {
    ...
    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "(Ltia;IZ[[I)V")
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lhu;IZLhu;B)I")
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lka;IIII)Lrga;")
