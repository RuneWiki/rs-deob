...
public class class198 extends class276 implements class265 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(Len;B)V")
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(ILen;IBLfs;IZ)V")
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(BILen;)Lmj;")
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IIZLen;)Z")
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(Len;Lnl;IIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(Len;I)V")
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(ILen;)Lir;")
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(BLen;)V")
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IILen;)Lmj;")
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(ZILen;I)Lgi;")
