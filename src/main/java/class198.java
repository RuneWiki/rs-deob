...
public class class198 extends class317 {
    ...
    @OriginalMember(owner = "client!ol", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IB)Z", line = 14)
    ...
    @OriginalMember(owner = "client!ol", name = "i", descriptor = "(I)Z", line = 26)
    ...
    @OriginalMember(owner = "client!ol", name = "<init>", descriptor = "(Lbg;Ljava/lang/Object;I)V", line = 41)
    public class198(class278 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field3095 = arg1;
    }

    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Z)Ljava/lang/Object;", line = 53)
