...
public class class198 extends class264 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IBFII)V", line = 5)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(II)V", line = 117)
    public final void method1373(int arg0, int arg1) {
        this.field2796 = ByteBuffer.allocateDirect(arg0 * arg1);
    }

    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(BI)V", line = 124)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IIII)V", line = 140)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(BI[I)V", line = 149)
    ...
    @OriginalMember(owner = "client!dh", name = "b", descriptor = "(BI)V", line = 275)
    ...
    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(Ldl;IIII)V", line = 287)
