...
public class class198 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(II)Lhc;", line = 18)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!so", name = "b", descriptor = "(B)V", line = 79)
    ...
    @OriginalMember(owner = "client!so", name = "b", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "(Lgt;ILdn;)V", line = 121)
