...
public class class198 extends class439 {
    ...
    @OriginalMember(owner = "client!vt", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "()I", line = 9)
    public final int method463() {
        return field2816.method1330(this.field2817, 104);
    }

    @OriginalMember(owner = "client!vt", name = "d", descriptor = "()V", line = 12)
    public final void method460() {
        field2816.method1332(this.field2817, true);
    }

    @OriginalMember(owner = "client!vt", name = "e", descriptor = "()V", line = 15)
    public static void method1240() {
        field2816 = null;
    }

    @OriginalMember(owner = "client!vt", name = "c", descriptor = "()V", line = 18)
    public final void method465() {
        field2816.method1331(8770, this.field2817);
    }

    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 23)
    ...
    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "(Ldr;I)V", line = 25)
    public class198(class504 arg0, int arg1) {
        field2816 = arg0.method2965((byte) 43);
        this.field2817 = arg1;
    }

    @OriginalMember(owner = "client!vt", name = "b", descriptor = "()V", line = 30)
