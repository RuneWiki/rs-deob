...
public class class198 extends class485 {
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IIIBIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(I)V", line = 443)
    ...
    @OriginalMember(owner = "client!fa", name = "b", descriptor = "(Z)V", line = 473)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(III)Z", line = 489)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IIIII)V", line = 510)
    ...
    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "(Lte;II)V", line = 527)
