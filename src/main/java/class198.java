...
public class class198 extends class33 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Lnd;I)V")
    ...
    @OriginalMember(owner = "client!vb", name = "b", descriptor = "(B)Lnn;")
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Lij;IIIIII)V")
