...
public class class198 extends class60 {
    ...
    @OriginalMember(owner = "client!qga", name = "c", descriptor = "(B)Z", line = 15)
    ...
    @OriginalMember(owner = "client!qga", name = "b", descriptor = "(I)I", line = 30)
    public final int method1290(int arg0) {
        ++field2362;
        return arg0 != 0 ? -82 : super.field799;
    }

    @OriginalMember(owner = "client!qga", name = "<init>", descriptor = "(Lhd;)V", line = 41)
    public class198(class773 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qga", name = "b", descriptor = "(II)I", line = 44)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(ILkq;)V", line = 59)
    ...
    @OriginalMember(owner = "client!qga", name = "<init>", descriptor = "(ILhd;)V", line = 101)
    public class198(int arg0, class773 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!qga", name = "b", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(BI)V", line = 126)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(Les;B)Llh;", line = 147)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(Z)I", line = 176)
