...
public class class198 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lqa;[IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lqa;[II)V")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lqa;[II[I[I)V")
