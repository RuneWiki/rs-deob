...
public class class198 extends class184 {
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(II)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(BILfh;)V", line = 97)
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "()V", line = 168)
    public class198() {
        super(1, false);
    }

    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(ILjava/awt/Component;)Lts;", line = 171)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "([Ljava/lang/String;I)[Ljava/lang/String;", line = 209)
