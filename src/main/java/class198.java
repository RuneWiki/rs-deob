...
public class class198 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Lms;I)Lms;", line = 5)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "([BB)[B", line = 33)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(B)V", line = 88)
    public static void method1260(byte arg0) {
        int var1 = -98 / ((-arg0 - 37) / 60);
        field2837 = null;
    }

    @OriginalMember(owner = "client!jn", name = "b", descriptor = "(Lms;I)Z", line = 100)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ZZ)Z", line = 121)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Lfc;B)V", line = 165)
