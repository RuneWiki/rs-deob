...
public class class198 extends class512 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IIIILoa;II)Lba;")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(I)Lhc;")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IIB)Lqt;")
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(ILqn;Lqn;Lnp;Lsc;I[BIZ)V")
