...
public class class198 {
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(IIIIII[[[BIILha;III)V", line = 20)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(Z)V", line = 63)
    ...
    @OriginalMember(owner = "client!kba", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 75)
