...
public class class198 extends class540 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lcb;II)Lvp;")
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lcb;)Z")
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lcb;I)Lvp;")
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "([I)Lbc;")
