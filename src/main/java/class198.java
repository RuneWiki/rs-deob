...
public class class198 extends class1 {
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!pba", name = "b", descriptor = "()Lev;")
    ...
    @OriginalMember(owner = "client!pba", name = "c", descriptor = "()V")
    public static void method1337() {
        field2866 = null;
        field2868 = null;
    }

    @OriginalMember(owner = "client!pba", name = "a", descriptor = "([Loo;Z)V")
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(Lha;J)Z")
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(Lha;[Lhr;Z)V")
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(IZ)Lpba;")
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(Lha;J[Lhr;[Loo;Z)V")
    ...
    @OriginalMember(owner = "client!pba", name = "f", descriptor = "()Lev;")
