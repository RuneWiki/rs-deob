...
public class class198 extends class325 {
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(Ljp;IB)V", line = 6)
    ...
    @OriginalMember(owner = "client!ffa", name = "<init>", descriptor = "()V", line = 62)
    public class198() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(Lwea;ZZ)V", line = 71)
    ...
    @OriginalMember(owner = "client!ffa", name = "b", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(BI)[I", line = 124)
