...
public class class763 extends class413 implements class380 {
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(ZLli;)V")
    ...
    @OriginalMember(owner = "client!eja", name = "<init>", descriptor = "(Lsd;IZ[[I)V")
    ...
    @OriginalMember(owner = "client!eja", name = "c", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;")
