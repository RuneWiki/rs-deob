...
public class class763 {
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(IBLha;)V")
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(IILofa;Z)V")
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(Ljs;I)Z")
