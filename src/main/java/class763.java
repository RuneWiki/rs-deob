...
public class class763 extends class363 implements class627 {
    ...
    @OriginalMember(owner = "client!ww", name = "<init>", descriptor = "(Laia;Lul;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!ww", name = "<init>", descriptor = "(Laia;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!ww", name = "<init>", descriptor = "(Laia;Lul;Lso;II)V")
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(Lws;B)V")
    ...
    @OriginalMember(owner = "client!ww", name = "d", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "([BIIILul;IIII)V")
