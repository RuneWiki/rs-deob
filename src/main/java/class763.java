...
public abstract class class763 implements class123 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ILwga;)V")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ILjp;)Lfl;")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lor;Z)V")
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(Lpa;ILsw;Lig;IZ)V")
