...
public class class763 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(IIIIZI)V", line = 21)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(III)Z", line = 241)
