...
public class class763 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Lrg;IB)V")
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Lvd;B)V")
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Lrg;Z)V")
