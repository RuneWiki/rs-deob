...
public class class571 extends class335 {
    ...
    @OriginalMember(owner = "client!gt", name = "c", descriptor = "(BLha;)Lro;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ZILha;)Z")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Lfha;I)V")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(BLha;)Lqs;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ILjw;Lha;BIZI)V")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IIILha;)Z")
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Lqk;ILqk;)V")
