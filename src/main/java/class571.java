...
public class class571 extends class28 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(ILoa;I)Lba;", line = 5)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(BILjava/util/Random;)I", line = 94)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(B)Z", line = 141)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(I)V", line = 165)
