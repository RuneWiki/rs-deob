...
public class class571 {
    ...
    @OriginalMember(owner = "client!ea", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ea", name = "d", descriptor = "(I)I", line = 22)
    ...
    @OriginalMember(owner = "client!ea", name = "c", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IIIZ)I", line = 48)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(III)I", line = 88)
    ...
    @OriginalMember(owner = "client!ea", name = "d", descriptor = "(B)Z", line = 110)
