...
public class class571 extends class626 {
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(IIZ)Z", line = 17)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(BLdm;)Ldm;", line = 35)
    ...
    @OriginalMember(owner = "client!bha", name = "<init>", descriptor = "(II)V", line = 50)
