...
public class class571 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(BLrv;)Lgea;", line = 11)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(JI)Lsu;", line = 48)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(ILsu;J)V", line = 80)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Z)V", line = 101)
    ...
    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(I)Lsu;", line = 143)
