...
public class class571 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Z)V", line = 468)
