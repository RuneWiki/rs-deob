...
public class class571 extends class591 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(BLtba;)V")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IILr;IILhi;Lks;Lhh;)V")
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(Lum;II[B)V")
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(Lum;II[I)V")
