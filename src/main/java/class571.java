...
public abstract class class571 extends class720 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(IZIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(I)I", line = 20)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(Z)V", line = 49)
    ...
    @OriginalMember(owner = "client!kga", name = "b", descriptor = "(II)I", line = 73)
