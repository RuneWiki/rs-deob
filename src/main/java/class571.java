...
public class class571 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(B)V", line = 9)
    public static void method3261(byte arg0) {
        field8151 = null;
        int var1 = 123 % ((-arg0 - 14) / 44);
    }

    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIII)I", line = 127)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lqa;I)V", line = 154)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!ka", name = "<init>", descriptor = "(Ljj;Lmr;Lvh;IIIII)V", line = 232)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(I[BZI)V", line = 196)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lgw;BI)V", line = 214)
