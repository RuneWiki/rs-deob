...
public class class571 extends class712 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Z)Ljc;")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Ljc;Ljc;BF)Z")
    ...
    @OriginalMember(owner = "client!fe", name = "<init>", descriptor = "(Lrda;I)V")
