...
public class class571 extends class134 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!fe", name = "<init>", descriptor = "(ILkda;)V", line = 16)
    public class571(int arg0, class391 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!fe", name = "b", descriptor = "(B)I", line = 22)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!fe", name = "<init>", descriptor = "(Lkda;)V", line = 52)
    public class571(class391 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(I)I", line = 55)
    ...
    @OriginalMember(owner = "client!fe", name = "c", descriptor = "(II)I", line = 66)
    ...
    @OriginalMember(owner = "client!fe", name = "c", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!fe", name = "b", descriptor = "(III)Z", line = 91)
