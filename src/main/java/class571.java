...
public class class571 extends class164 {
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(ZIBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(Lfp;Lfp;Lvea;)V", line = 17)
    public class571(class323 arg0, class323 arg1, class273 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!im", name = "b", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IIZB)V", line = 34)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Lee;B)Lhg;", line = 55)
