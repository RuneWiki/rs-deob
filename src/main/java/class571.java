...
public abstract class class571 extends class379 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lfj;I)V")
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "(Lpc;)V")
