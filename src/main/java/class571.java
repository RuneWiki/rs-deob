...
public class class571 extends class384 {
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Lbia;BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!fp", name = "e", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!fp", name = "d", descriptor = "(B)Z", line = 28)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(IBI)V", line = 42)
    ...
    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "(Lbm;)V", line = 61)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(IZ)V", line = 173)
    ...
    @OriginalMember(owner = "client!fp", name = "b", descriptor = "(B)V", line = 192)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(III)Z", line = 234)
    ...
    @OriginalMember(owner = "client!fp", name = "f", descriptor = "(B)I", line = 244)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(ZB)V", line = 270)
