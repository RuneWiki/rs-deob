...
public class class571 extends class134 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Loh;I)Lcr;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Loh;)Z")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Loh;II)Lcr;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "([I)Lcba;")
