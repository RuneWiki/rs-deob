...
public class class571 {
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(I)J", line = 3)
    ...
    @OriginalMember(owner = "client!us", name = "b", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(IJ)V", line = 39)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "([Lkp;IZ)V", line = 62)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(ILjava/lang/String;)I", line = 133)
