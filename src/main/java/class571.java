...
public abstract class class571 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(III)Z", line = 11)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(I)[Lln;", line = 79)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Z)V", line = 164)
