...
public class class571 extends class39 {
    ...
    @OriginalMember(owner = "client!pb", name = "c", descriptor = "(III)Ldr;")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(I[Lqf;I)V")
    ...
    @OriginalMember(owner = "client!pb", name = "b", descriptor = "(I)Lbs;")
    ...
    @OriginalMember(owner = "client!pb", name = "<init>", descriptor = "(ILls;Lls;Ljq;Lkf;I[BIZ)V")
