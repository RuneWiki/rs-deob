...
public class class571 extends class617 {
    ...
    @OriginalMember(owner = "client!gr", name = "finalize", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ILsf;I)Z", line = 78)
    ...
    @OriginalMember(owner = "client!gr", name = "d", descriptor = "(B)J", line = 99)
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(Lvj;II)V", line = 109)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(I[BIIIIII[B)V", line = 119)
    ...
    @OriginalMember(owner = "client!gr", name = "f", descriptor = "(I)V", line = 163)
