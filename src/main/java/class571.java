...
public class class571 {
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(BLdc;)V")
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(IILjava/awt/Canvas;Ld;Z)Lha;")
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(IILdc;)V")
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(Z)Laea;")
