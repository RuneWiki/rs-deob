...
public class class559 extends class66 {
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(ZIIBZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(II)V", line = 32)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(III)Z", line = 43)
    ...
    @OriginalMember(owner = "client!kfa", name = "<init>", descriptor = "(II)V", line = 54)
