...
public class class559 {
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(IIILdda;)Lbt;", line = 6)
    ...
    @OriginalMember(owner = "client!oda", name = "toString", descriptor = "()Ljava/lang/String;", line = 30)
    public final String toString() {
        field8302++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(II)V", line = 38)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(III)Z", line = 56)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!oda", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 86)
