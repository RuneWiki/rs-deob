...
public class class559 implements class114 {
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(ILaaa;I)V")
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(ILeg;II)V")
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(IILeg;II)V")
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(Ldh;IZ)V")
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(Laaa;BII)V")
    ...
    @OriginalMember(owner = "client!ffa", name = "<init>", descriptor = "(Luca;)V")
