...
public class class559 {
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(Lae;Lae;Lae;BLae;)V")
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(ZLd;Lha;)V")
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(IILgga;)V")
    ...
    @OriginalMember(owner = "client!oha", name = "a", descriptor = "(Lgga;B)V")
