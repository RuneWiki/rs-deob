...
public class class559 {
    ...
    @OriginalMember(owner = "client!pu", name = "toString", descriptor = "()Ljava/lang/String;", line = 22)
    public final String toString() {
        field7951++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(BLvg;)I", line = 33)
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(II)V", line = 120)
