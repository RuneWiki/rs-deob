...
public abstract class class559 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ILjava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(IIII)I", line = 36)
