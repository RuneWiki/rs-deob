...
public class class559 extends class660 {
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(JJ)J", line = 4)
    public static long method3171(long arg0, long arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Ljava/lang/Class;ILjava/lang/String;)Z", line = 11)
    ...
    @OriginalMember(owner = "client!lu", name = "c", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Lfa;ILjava/awt/Canvas;)Lr;", line = 96)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(I)Lica;", line = 116)
    ...
    @OriginalMember(owner = "client!lu", name = "<init>", descriptor = "(Lmj;IIIIII)V", line = 179)
