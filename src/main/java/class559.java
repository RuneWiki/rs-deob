...
public class class559 extends class571 {
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(I[[[Lcja;IIZI)Z")
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(IJLha;)V")
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(Lha;JIZZ)V")
    ...
    @OriginalMember(owner = "client!pga", name = "<init>", descriptor = "(Lha;Lgv;Lcv;J)V")
