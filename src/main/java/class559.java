...
public class class559 extends class207 {
    ...
    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(Lrd;)V")
    public class559(class355 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IZI)Lgd;")
    ...
    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(ILrd;)V")
