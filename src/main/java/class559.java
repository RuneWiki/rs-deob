...
public abstract class class559 implements class635 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(ZZ)V", line = 8)
    ...
    @OriginalMember(owner = "client!wu", name = "b", descriptor = "(I)I", line = 31)
    public final int method3286(int arg0) {
        field7781++;
        return arg0 == -28451 ? this.field7785 : -29;
    }

    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!wu", name = "c", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!wu", name = "d", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!wu", name = "b", descriptor = "(B)I", line = 99)
    ...
    @OriginalMember(owner = "client!wu", name = "e", descriptor = "(I)Z", line = 112)
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "(Ldw;IIIZ)V", line = 210)
    ...
    @OriginalMember(owner = "client!wu", name = "finalize", descriptor = "()V", line = 144)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IZ)V", line = 153)
    ...
    @OriginalMember(owner = "client!wu", name = "b", descriptor = "(II)V", line = 194)
