...
public class class559 extends class601 {
    ...
    @OriginalMember(owner = "client!hk", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IZ)Z", line = 196)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IB)[I", line = 207)
    ...
    @OriginalMember(owner = "client!hk", name = "d", descriptor = "(B)V", line = 234)
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "()V", line = 257)
    public class559() {
        super(0, true);
    }
}
