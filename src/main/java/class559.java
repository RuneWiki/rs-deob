...
public class class559 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(II)Lbca;")
    ...
    @OriginalMember(owner = "client!cf", name = "b", descriptor = "(II)Lwt;")
    ...
    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "(Ler;ILjn;Ljn;Ljn;)V")
