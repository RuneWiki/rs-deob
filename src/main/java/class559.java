...
public abstract class class559 extends class668 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lofa;I)Lnda;", line = 6)
    ...
    @OriginalMember(owner = "client!vp", name = "c", descriptor = "(B)Z", line = 29)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "([Lvt;I)I", line = 73)
    ...
    @OriginalMember(owner = "client!vp", name = "e", descriptor = "(B)V", line = 242)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(ILha;)Z", line = 254)
    ...
    @OriginalMember(owner = "client!vp", name = "l", descriptor = "(I)V", line = 268)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lcca;ZZ)V", line = 282)
    ...
    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "(IIIIIIIIIZB)V", line = 452)
