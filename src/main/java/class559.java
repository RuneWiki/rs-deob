...
public class class559 extends class94 implements class202 {
    ...
    @OriginalMember(owner = "client!oea", name = "<init>", descriptor = "(Lno;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(Lpe;I)V")
    ...
    @OriginalMember(owner = "client!oea", name = "<init>", descriptor = "(Lno;ILjaclib/memory/Buffer;IZ)V")
    public class559(class658 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field7420 = arg1;
    }

    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(Loa;IBZ)Lwb;")
