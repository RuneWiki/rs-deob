...
public class class559 extends class627 {
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(Lkj;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "()V", line = 29)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(II)Z", line = 108)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(Ljc;I)V", line = 119)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(B)V", line = 145)
    ...
    @OriginalMember(owner = "client!bea", name = "b", descriptor = "(Z)Z", line = 171)
