...
public class class559 extends class648 {
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(ZILha;IIII)V")
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(II)Lcda;")
    ...
    @OriginalMember(owner = "client!nda", name = "<init>", descriptor = "(Lwu;)V")
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(Lk;B)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(Lbca;II)V")
