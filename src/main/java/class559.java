...
public class class559 extends class335 {
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(ILio;I)V", line = 10)
    ...
    @OriginalMember(owner = "client!eda", name = "<init>", descriptor = "()V", line = 121)
    public class559() {
        super(0, true);
    }

    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(B)V", line = 126)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(ZI)[I", line = 139)
    ...
    @OriginalMember(owner = "client!eda", name = "b", descriptor = "(Z)V", line = 244)
    ...
    @OriginalMember(owner = "client!eda", name = "d", descriptor = "(I)V", line = 254)
