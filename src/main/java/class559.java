...
public class class559 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IILcda;)Z", line = 42)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Lfd;I)V", line = 200)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(BII)Z", line = 210)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IIILoi;)V", line = 228)
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "()V", line = 1074)
    public class559() {
        this.field7294 = 1.2F;
        this.field7301 = -50;
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "(Lfd;)V", line = 1090)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(BLjd;)Z", line = 1045)
