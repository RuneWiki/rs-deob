...
public class class559 extends class514 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Class;)Z", line = 5)
    ...
    @OriginalMember(owner = "client!de", name = "b", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(II)I", line = 189)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;BIIZZ)V", line = 207)
    ...
    @OriginalMember(owner = "client!de", name = "c", descriptor = "(B)V", line = 320)
    ...
    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "(II[I[I)V", line = 331)
