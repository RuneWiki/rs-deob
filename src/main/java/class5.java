...
public class class5 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ZII[I)Lvo;", line = 6)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ZI[I)Lvo;", line = 63)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Ldg;I)Lr;", line = 92)
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "([IZI)Lvo;", line = 161)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(II)V", line = 187)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(II[II)Lvo;", line = 205)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Ljava/awt/Frame;ILrd;)V", line = 260)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Ltq;Ltq;)V", line = 296)
