...
public class class5 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IILmd;)V", line = 13)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Lc;IIIII)Lc;", line = 178)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(I)V", line = 311)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(ILmd;)V", line = 350)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(III)Z", line = 376)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(BLc;IBIIII)Lc;", line = 387)
    ...
    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(I)V", line = 475)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IZII)I", line = 492)
