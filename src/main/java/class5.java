...
public class class5 extends class276 {
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(IIIII)Z", line = 21)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ILia;I)V", line = 42)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!ps", name = "c", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "([Ljava/lang/String;B)[Ljava/lang/String;", line = 220)
    ...
    @OriginalMember(owner = "client!ps", name = "c", descriptor = "(I)V", line = 246)
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(II)V", line = 273)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(II)V", line = 286)
    public class5(int arg0, int arg1) {
        this.field49 = arg1;
        this.field54 = arg0;
    }

    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(BLza;Lqs;)V", line = 295)
