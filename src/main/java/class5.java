...
public class class5 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(II)Luaa;", line = 6)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(Lsj;ILin;)V", line = 89)
    ...
    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(II)V", line = 77)
