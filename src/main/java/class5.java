...
public class class5 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IZ)Lrl;", line = 18)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(II)Lpn;", line = 70)
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(Lsn;ILci;)V", line = 392)
