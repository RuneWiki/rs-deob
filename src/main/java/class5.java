...
public class class5 extends class11 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Lpo;IIII)V", line = 594)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Lpo;II[III)V", line = 600)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(III)V", line = 56)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IIIIIII)V", line = 77)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(FFFFFFIII)V", line = 211)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IIII)V", line = 277)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IILhm;II)V", line = 286)
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(IIIIIII)V", line = 345)
    ...
    @OriginalMember(owner = "client!il", name = "c", descriptor = "()I", line = 446)
    public final int method47() {
        return this.field62.field174 + this.field59 + this.field56;
    }

    @OriginalMember(owner = "client!il", name = "a", descriptor = "(I)V", line = 452)
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "()I", line = 478)
    public final int method49() {
        return this.field62.field174;
    }

    @OriginalMember(owner = "client!il", name = "e", descriptor = "()V", line = 485)
    ...
    @OriginalMember(owner = "client!il", name = "d", descriptor = "()I", line = 495)
    public final int method51() {
        return this.field62.field175;
    }

    @OriginalMember(owner = "client!il", name = "a", descriptor = "()I", line = 499)
    public final int method52() {
        return this.field62.field175 + this.field61 + this.field55;
    }

    @OriginalMember(owner = "client!il", name = "a", descriptor = "(FFFFFFLhm;II)V", line = 503)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IIIIII)V", line = 586)
