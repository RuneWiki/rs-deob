...
public class class5 extends class557 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(BLdt;)V")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Ltn;I)V")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IB)Lgm;")
