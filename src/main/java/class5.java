...
public class class5 implements Runnable {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!ps", name = "run", descriptor = "()V", line = 57)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "([BIIZ)V", line = 124)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 175)
