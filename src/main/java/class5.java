...
public class class5 extends class389 {
    ...
    @OriginalMember(owner = "client!dc", name = "f", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(II)V", line = 26)
    ...
    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Z)V", line = 78)
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 225)
    ...
    @OriginalMember(owner = "client!dc", name = "finalize", descriptor = "()V", line = 101)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Lt;Lya;B)V", line = 113)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IILya;ILor;IZ)V", line = 142)
    ...
    @OriginalMember(owner = "client!dc", name = "g", descriptor = "(I)I", line = 157)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Lya;Z)V", line = 172)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IILya;I)Lt;", line = 187)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(BLya;II)Z", line = 207)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "([[BILjs;)V", line = 251)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Lya;I)Lag;", line = 284)
