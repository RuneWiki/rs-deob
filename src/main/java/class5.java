...
public class class5 extends class220 {
    ...
    @OriginalMember(owner = "client!ti", name = "c", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "()V", line = 38)
    public class5() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(II)[[I", line = 43)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(ZLjava/lang/String;)I", line = 89)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IIIIII)I", line = 112)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IBLil;)V", line = 175)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(ZI)V", line = 189)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Loq;IIIII)V", line = 209)
