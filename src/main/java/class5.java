...
public class class5 extends class30 {
    ...
    @OriginalMember(owner = "client!AZNRLUAT", name = "l", descriptor = "LMJVHTYCA;")
    ...
    @OriginalMember(owner = "client!AZNRLUAT", name = "s", descriptor = "Lclient;")
    public static client field49;

    @OriginalMember(owner = "client!AZNRLUAT", name = "a", descriptor = "(Z)LBMWIVHMF;")
    ...
    @OriginalMember(owner = "client!AZNRLUAT", name = "a", descriptor = "(I)LVYUQHOMO;")
