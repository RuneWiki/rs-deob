...
public class class5 extends class145 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(ZI)[I", line = 4)
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "()V", line = 30)
    public class5() {
        this(4096);
    }

    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IILrt;)V", line = 47)
