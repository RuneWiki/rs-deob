...
public class class5 extends class389 {
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(I)V", line = 8)
    public class5(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!dc", name = "x", descriptor = "(I)Z", line = 19)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "([IB)V", line = 35)
    ...
    @OriginalMember(owner = "client!dc", name = "k", descriptor = "(II)I", line = 54)
    ...
    @OriginalMember(owner = "client!dc", name = "y", descriptor = "(I)V", line = 84)
    public final void method26(int arg0) {
        ++field28;
        this.field29 = super.field5195 * arg0;
    }

    @OriginalMember(owner = "client!dc", name = "z", descriptor = "(I)I", line = 93)
    ...
    @OriginalMember(owner = "client!dc", name = "f", descriptor = "(IB)I", line = 106)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(ZLip;)V", line = 124)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(BLjava/lang/String;)V", line = 135)
    ...
    @OriginalMember(owner = "client!dc", name = "A", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!dc", name = "o", descriptor = "(B)V", line = 160)
    ...
    @OriginalMember(owner = "client!dc", name = "g", descriptor = "(IB)V", line = 172)
    ...
    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(II[BI)V", line = 186)
    ...
    @OriginalMember(owner = "client!dc", name = "l", descriptor = "(II)V", line = 204)
