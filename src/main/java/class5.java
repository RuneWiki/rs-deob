...
public class class5 {
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Z)J", line = 14)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(III[B)V", line = 48)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(JB)V", line = 68)
    ...
    @OriginalMember(owner = "client!mca", name = "b", descriptor = "(I)Ljava/io/File;", line = 83)
    ...
    @OriginalMember(owner = "client!mca", name = "finalize", descriptor = "()V", line = 93)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "([BIII)I", line = 109)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(III)Z", line = 125)
    ...
    @OriginalMember(owner = "client!mca", name = "<init>", descriptor = "(Ljava/io/File;Ljava/lang/String;J)V", line = 135)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(B)[Lko;", line = 169)
