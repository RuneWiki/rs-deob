...
public class class5 extends class43 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IC)Z", line = 3)
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(I)V", line = 27)
    public static void method19(int arg0) {
        field38 = null;
        int var1 = -32 / ((-arg0 - 50) / 35);
    }

    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(B)V", line = 37)
