...
public class class5 extends class45 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Lcu;II)V")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Lgj;Z)Z")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "([Lhq;ZLvj;)Lwf;")
