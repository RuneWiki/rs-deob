...
public class class5 extends class360 implements class583 {
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(Lnv;ILjaclib/memory/Buffer;IZ)V", line = 5)
    public class5(class417 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field31 = arg1;
    }

    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(I[BII)V", line = 13)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(B)I", line = 25)
    ...
    @OriginalMember(owner = "client!dc", name = "d", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(Lnv;I[BIZ)V", line = 50)
    public class5(class417 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field31 = arg1;
    }

    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(I)J", line = 69)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(BI)V", line = 81)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Z)I", line = 94)
