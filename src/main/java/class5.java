...
public class class5 extends class55 implements class601 {
    ...
    @OriginalMember(owner = "client!uha", name = "<init>", descriptor = "(Lfc;Z)V", line = 3)
    public class5(class642 arg0, boolean arg1) {
        super(arg0, 34962, arg1);
    }

    @OriginalMember(owner = "client!uha", name = "b", descriptor = "(I)V", line = 12)
    public final void method32(int arg0) {
        super.method32(arg0);
        ++field72;
    }

    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(III)V", line = 21)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(ILkm;)Lbc;", line = 35)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(B)I", line = 58)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(I)Z", line = 71)
    ...
    @OriginalMember(owner = "client!uha", name = "b", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(BILjaclib/memory/Source;I)Z", line = 102)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;", line = 118)
    ...
    @OriginalMember(owner = "client!uha", name = "g", descriptor = "(B)I", line = 129)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(IBI)Z", line = 145)
