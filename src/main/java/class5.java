...
public class class5 {
    ...
    @OriginalMember(owner = "client!ad", name = "c", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ad", name = "n", descriptor = "Llf;")
    private static class109 field74 = class35.method275("No reply from loginserver)3", 2);

    @OriginalMember(owner = "client!ad", name = "t", descriptor = "Llf;")
    public static class109 field80 = field74;

    @OriginalMember(owner = "client!ad", name = "v", descriptor = "Llf;")
    private static class109 field82 = class35.method275("Please wait 1 minute and try again)3", 2);

    @OriginalMember(owner = "client!ad", name = "w", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ad", name = "u", descriptor = "Lnd;")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ZZIIZ)Loh;")
