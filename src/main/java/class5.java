...
public class class5 extends class748 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ILhg;I)V")
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IZLvj;)V")
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IIILep;IIZ[I)Ldd;")
