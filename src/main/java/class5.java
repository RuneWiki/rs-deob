...
public class class5 extends class626 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Leq;)Z")
    ...
    @OriginalMember(owner = "client!dc", name = "c", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "([I)Lcj;")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Leq;II)Ldc;")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Leq;I)Ldc;")
