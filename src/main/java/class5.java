...
public class class5 extends class374 {
    ...
    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(B)V", line = 3)
    public static void method17(byte arg0) {
        field47 = null;
        int var1 = 37 / ((49 - arg0) / 42);
    }

    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ZLew;I)V", line = 12)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ZI)V", line = 25)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(III)V", line = 46)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(B)Z", line = 64)
    ...
    @OriginalMember(owner = "client!ck", name = "c", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!ck", name = "c", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Lvd;)V", line = 115)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(I)V", line = 135)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ZZ)V", line = 153)
