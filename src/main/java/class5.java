...
public class class5 {
    ...
    @OriginalMember(owner = "client!BZONLWPM", name = "s", descriptor = "I")
    ...
    @OriginalMember(owner = "client!BZONLWPM", name = "c", descriptor = "[LBZONLWPM;")
    public static class5[] field67;

    @OriginalMember(owner = "client!BZONLWPM", name = "a", descriptor = "(ILTKEGJSFV;)V")
    ...
    @OriginalMember(owner = "client!BZONLWPM", name = "a", descriptor = "(LEGCCHUZS;Z)V")
