...
@OriginalClass("client!BYTDRQNR")
public class class5 {

    @OriginalMember(owner = "client!BYTDRQNR", name = "a", descriptor = "I")
    private int field48 = 496;

    @OriginalMember(owner = "client!BYTDRQNR", name = "b", descriptor = "Z")
    private boolean field49 = false;

    @OriginalMember(owner = "client!BYTDRQNR", name = "f", descriptor = "I")
    public int field53 = -1;

    @OriginalMember(owner = "client!BYTDRQNR", name = "h", descriptor = "[I")
    public int[] field55 = new int[6];

    @OriginalMember(owner = "client!BYTDRQNR", name = "i", descriptor = "[I")
    public int[] field56 = new int[6];

    @OriginalMember(owner = "client!BYTDRQNR", name = "j", descriptor = "[I")
    public int[] field57 = new int[] { -1, -1, -1, -1, -1 };

    @OriginalMember(owner = "client!BYTDRQNR", name = "k", descriptor = "Z")
    public boolean field58 = false;

    @OriginalMember(owner = "client!BYTDRQNR", name = "c", descriptor = "I")
    private int field50;

    @OriginalMember(owner = "client!BYTDRQNR", name = "d", descriptor = "I")
    public static int field51;

    @OriginalMember(owner = "client!BYTDRQNR", name = "g", descriptor = "[I")
    public int[] field54;

    @OriginalMember(owner = "client!BYTDRQNR", name = "e", descriptor = "[LBYTDRQNR;")
    public static class5[] field52;

    @OriginalMember(owner = "client!BYTDRQNR", name = "a", descriptor = "(ZLXMRRKSSB;)V")
    ...
    @OriginalMember(owner = "client!BYTDRQNR", name = "a", descriptor = "(LXQPFGONL;I)V")
    ...
    @OriginalMember(owner = "client!BYTDRQNR", name = "a", descriptor = "(Z)Z")
    ...
    @OriginalMember(owner = "client!BYTDRQNR", name = "a", descriptor = "(I)LITSMSHJO;")
    ...
    @OriginalMember(owner = "client!BYTDRQNR", name = "b", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!BYTDRQNR", name = "a", descriptor = "(B)LITSMSHJO;")
    ...
    @OriginalMember(owner = "client!BYTDRQNR", name = "<init>", descriptor = "()V")
    public class5() {
        if (class15.field717) {
        }
    }
