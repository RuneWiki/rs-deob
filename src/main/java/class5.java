...
public class class5 extends class56 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(ILee;I)V", line = 60)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 74)
    ...
    @OriginalMember(owner = "client!dc", name = "c", descriptor = "(B)V", line = 102)
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "()V", line = 113)
    public class5() {
        super(3, false);
    }

    @OriginalMember(owner = "client!dc", name = "e", descriptor = "(III)Z", line = 116)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(II)[[I", line = 128)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IIIII)V", line = 207)
