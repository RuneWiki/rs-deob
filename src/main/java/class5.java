...
public class class5 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 4)
    ...
    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(I)I", line = 36)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(ILor;)V", line = 58)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(ILjava/lang/Object;J)V", line = 102)
    ...
    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(B)Ljava/lang/Object;", line = 114)
    ...
    @OriginalMember(owner = "client!dc", name = "c", descriptor = "(B)V", line = 146)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(ZI)V", line = 161)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IJ)Ljava/lang/Object;", line = 211)
    ...
    @OriginalMember(owner = "client!dc", name = "c", descriptor = "(I)I", line = 256)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Ljava/lang/Object;IBJ)V", line = 269)
    ...
    @OriginalMember(owner = "client!dc", name = "d", descriptor = "(I)V", line = 298)
    ...
    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(IJ)V", line = 310)
    ...
    @OriginalMember(owner = "client!dc", name = "e", descriptor = "(I)I", line = 329)
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(I)V", line = 343)
