...
public class class5 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IBIII)V", line = 38)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(II)V", line = 54)
