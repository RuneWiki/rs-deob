...
@OriginalClass("client!BWSGQYNU")
public class class5 {

    @OriginalMember(owner = "client!BWSGQYNU", name = "a", descriptor = "I")
    private static int field40;

    @OriginalMember(owner = "client!BWSGQYNU", name = "c", descriptor = "I")
    public int field42;

    @OriginalMember(owner = "client!BWSGQYNU", name = "e", descriptor = "I")
    public int field44;

    @OriginalMember(owner = "client!BWSGQYNU", name = "d", descriptor = "LJRQJNVRC;")
    public class36 field43;

    @OriginalMember(owner = "client!BWSGQYNU", name = "f", descriptor = "[I")
    public int[] field45;

    @OriginalMember(owner = "client!BWSGQYNU", name = "g", descriptor = "[I")
    public int[] field46;

    @OriginalMember(owner = "client!BWSGQYNU", name = "h", descriptor = "[I")
    public int[] field47;

    @OriginalMember(owner = "client!BWSGQYNU", name = "i", descriptor = "[I")
    public int[] field48;

    @OriginalMember(owner = "client!BWSGQYNU", name = "b", descriptor = "[LBWSGQYNU;")
    private static class5[] field41;

    @OriginalMember(owner = "client!BWSGQYNU", name = "j", descriptor = "[Z")
    private static boolean[] field49;

    @OriginalMember(owner = "client!BWSGQYNU", name = "a", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!BWSGQYNU", name = "a", descriptor = "([BZ)V")
    ...
    @OriginalMember(owner = "client!BWSGQYNU", name = "a", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!BWSGQYNU", name = "a", descriptor = "(II)LBWSGQYNU;")
    ...
    @OriginalMember(owner = "client!BWSGQYNU", name = "a", descriptor = "(IZ)Z")
