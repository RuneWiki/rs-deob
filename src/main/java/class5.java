...
public class class5 {
    ...
    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!dc", name = "c", descriptor = "(I)[[I", line = 17)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(III)V", line = 167)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(BI)[I", line = 68)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IIII)I", line = 135)
