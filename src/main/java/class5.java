...
@OriginalClass("client!AWOZVMFS")
public class class5 extends class3 {

    @OriginalMember(owner = "client!AWOZVMFS", name = "sb", descriptor = "I")
    public int field109 = -1;

    @OriginalMember(owner = "client!AWOZVMFS", name = "ub", descriptor = "Z")
    private boolean field111 = true;

    @OriginalMember(owner = "client!AWOZVMFS", name = "vb", descriptor = "[I")
    public int[] field112 = new int[5];

    @OriginalMember(owner = "client!AWOZVMFS", name = "wb", descriptor = "Z")
    public boolean field113 = false;

    @OriginalMember(owner = "client!AWOZVMFS", name = "Fb", descriptor = "[I")
    public int[] field122 = new int[12];

    @OriginalMember(owner = "client!AWOZVMFS", name = "Lb", descriptor = "B")
    private byte field128 = 29;

    @OriginalMember(owner = "client!AWOZVMFS", name = "Ob", descriptor = "J")
    public long field131 = -1L;

    @OriginalMember(owner = "client!AWOZVMFS", name = "Pb", descriptor = "Z")
    public boolean field132 = false;

    @OriginalMember(owner = "client!AWOZVMFS", name = "Rb", descriptor = "I")
    public int field134 = -1;

    @OriginalMember(owner = "client!AWOZVMFS", name = "Qb", descriptor = "LDSMCVRKW;")
    public static class15 field133 = new class15((byte) 7, 260);

    @OriginalMember(owner = "client!AWOZVMFS", name = "qb", descriptor = "I")
    public int field107;

    @OriginalMember(owner = "client!AWOZVMFS", name = "rb", descriptor = "I")
    public int field108;

    @OriginalMember(owner = "client!AWOZVMFS", name = "xb", descriptor = "I")
    public int field114;

    @OriginalMember(owner = "client!AWOZVMFS", name = "yb", descriptor = "I")
    public int field115;

    @OriginalMember(owner = "client!AWOZVMFS", name = "zb", descriptor = "I")
    public int field116;

    @OriginalMember(owner = "client!AWOZVMFS", name = "Ab", descriptor = "I")
    public int field117;

    @OriginalMember(owner = "client!AWOZVMFS", name = "Bb", descriptor = "I")
    public int field118;

    @OriginalMember(owner = "client!AWOZVMFS", name = "Cb", descriptor = "I")
    public int field119;

    @OriginalMember(owner = "client!AWOZVMFS", name = "Db", descriptor = "I")
    public int field120;

    @OriginalMember(owner = "client!AWOZVMFS", name = "Eb", descriptor = "I")
    public int field121;

    @OriginalMember(owner = "client!AWOZVMFS", name = "Gb", descriptor = "I")
    public int field123;

    @OriginalMember(owner = "client!AWOZVMFS", name = "Hb", descriptor = "I")
    public int field124;

    @OriginalMember(owner = "client!AWOZVMFS", name = "Ib", descriptor = "I")
    public int field125;

    @OriginalMember(owner = "client!AWOZVMFS", name = "Nb", descriptor = "I")
    public int field130;

    @OriginalMember(owner = "client!AWOZVMFS", name = "tb", descriptor = "J")
    public long field110;

    @OriginalMember(owner = "client!AWOZVMFS", name = "Jb", descriptor = "LKBEXSZSN;")
    public class31 field126;

    @OriginalMember(owner = "client!AWOZVMFS", name = "Kb", descriptor = "LNPWLDXJE;")
    public class37 field127;

    @OriginalMember(owner = "client!AWOZVMFS", name = "Mb", descriptor = "Ljava/lang/String;")
    public String field129;

    @OriginalMember(owner = "client!AWOZVMFS", name = "a", descriptor = "(Z)Z")
    ...
    @OriginalMember(owner = "client!AWOZVMFS", name = "b", descriptor = "(B)LKBEXSZSN;")
    ...
    @OriginalMember(owner = "client!AWOZVMFS", name = "b", descriptor = "(I)LKBEXSZSN;")
    ...
    @OriginalMember(owner = "client!AWOZVMFS", name = "a", descriptor = "(LEILHLJCE;I)V")
    ...
    @OriginalMember(owner = "client!AWOZVMFS", name = "a", descriptor = "(I)LKBEXSZSN;")
