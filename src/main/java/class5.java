...
public class class5 {
    ...
    @OriginalMember(owner = "client!BUYMNSFH", name = "b", descriptor = "[LBUYMNSFH;")
    public static class5[] field36;

    @OriginalMember(owner = "client!BUYMNSFH", name = "a", descriptor = "(LMNPBQFWE;B)V")
    ...
    @OriginalMember(owner = "client!BUYMNSFH", name = "a", descriptor = "(LBJPWOXRJ;II)V")
