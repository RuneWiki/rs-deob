...
public class class5 extends class295 {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(ZLjava/lang/Object;Lbd;)V")
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(I[[[Ldg;)V")
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Lbi;II)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(Lnr;)V")
