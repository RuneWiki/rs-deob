...
public class class5 extends class147 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(BLvq;)Lbf;", line = 7)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Lvq;IIB)Z", line = 49)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "([IIIBI)V", line = 91)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Z)V", line = 121)
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IB)V", line = 146)
    ...
    @OriginalMember(owner = "client!il", name = "e", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Lvq;B)V", line = 197)
