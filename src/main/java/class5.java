...
public class class5 extends class467 {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(BLqa;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(I)V", line = 206)
    public class5(int arg0) {
        this.field65 = arg0;
    }

    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(B)V", line = 189)
