...
public class class5 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ILvl;)Z")
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Lvl;I)V")
    ...
    @OriginalMember(owner = "client!di", name = "<init>", descriptor = "(Lrs;)V")
