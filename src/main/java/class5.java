...
public class class5 extends class270 {
    ...
    @OriginalMember(owner = "client!di", name = "c", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!di", name = "<init>", descriptor = "(I)V", line = 33)
