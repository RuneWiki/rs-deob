...
public class class5 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IBI)Z", line = 6)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(FFFI)I", line = 18)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(BII)Z", line = 71)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(B)V", line = 97)
