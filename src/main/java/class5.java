...
public class class5 extends class305 {
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Lrm;)Lmca;", line = 3)
    ...
    @OriginalMember(owner = "client!mca", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!mca", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
