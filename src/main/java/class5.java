...
public class class5 {
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(I)Lmca;", line = 6)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(IILjj;IZZ[BI)Log;", line = 17)
    ...
    @OriginalMember(owner = "client!mca", name = "b", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(IIIZI)V", line = 51)
    ...
    @OriginalMember(owner = "client!mca", name = "<init>", descriptor = "(I)V", line = 139)
    public class5(int arg0) {
        this.field43 = arg0;
    }

    @OriginalMember(owner = "client!mca", name = "<init>", descriptor = "(IIIIII)V", line = 147)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(ILmca;)V", line = 114)
