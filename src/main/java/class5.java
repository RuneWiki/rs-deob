...
public class class5 extends class314 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "([B[IIIIIIIIIIILma;II)V")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(CIIIZLma;II)V")
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(Lbc;Lgt;[Lbb;[I[I)V")
