...
public class class5 implements Runnable {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IB)I", line = 28)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(I)I", line = 78)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(II[BB)V", line = 94)
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(I)I", line = 118)
    ...
    @OriginalMember(owner = "client!se", name = "finalize", descriptor = "()V", line = 135)
    protected final void finalize() {
        this.method27(false);
        field42++;
    }

    @OriginalMember(owner = "client!se", name = "run", descriptor = "()V", line = 143)
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(B)V", line = 218)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(ZIBLgaa;I)V", line = 233)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Ljava/net/Socket;BI)Lcr;", line = 309)
    ...
    @OriginalMember(owner = "client!se", name = "<init>", descriptor = "(Ljava/net/Socket;Lnga;I)V", line = 453)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "([BIII)V", line = 328)
    ...
    @OriginalMember(owner = "client!se", name = "c", descriptor = "(I)V", line = 388)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Z)V", line = 406)
