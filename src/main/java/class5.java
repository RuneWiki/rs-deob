...
public class class5 {
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(Lm;Lqa;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IB)Z", line = 232)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IJ)V", line = 257)
    ...
    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(IB)V", line = 279)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(Z)V", line = 293)
