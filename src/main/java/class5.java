...
public class class5 extends class43 {
    ...
    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(I)Lqd;")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(FLqd;BLqd;)V")
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(Lbf;I)V")
