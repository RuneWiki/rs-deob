...
@OriginalClass("client!DFJABDHX")
public class class5 {

    @OriginalMember(owner = "client!DFJABDHX", name = "a", descriptor = "Z")
    private boolean field621 = false;

    @OriginalMember(owner = "client!DFJABDHX", name = "b", descriptor = "Z")
    private boolean field622 = true;

    @OriginalMember(owner = "client!DFJABDHX", name = "c", descriptor = "Z")
    private boolean field623 = false;

    @OriginalMember(owner = "client!DFJABDHX", name = "e", descriptor = "Z")
    private boolean field625 = false;

    @OriginalMember(owner = "client!DFJABDHX", name = "f", descriptor = "I")
    private int field626 = 564;

    @OriginalMember(owner = "client!DFJABDHX", name = "g", descriptor = "B")
    private byte field627 = 82;

    @OriginalMember(owner = "client!DFJABDHX", name = "h", descriptor = "I")
    private int field628 = 581;

    @OriginalMember(owner = "client!DFJABDHX", name = "i", descriptor = "Z")
    private boolean field629 = false;

    @OriginalMember(owner = "client!DFJABDHX", name = "j", descriptor = "Z")
    private boolean field630 = false;

    @OriginalMember(owner = "client!DFJABDHX", name = "l", descriptor = "I")
    public int field632 = 0;

    @OriginalMember(owner = "client!DFJABDHX", name = "m", descriptor = "I")
    public int field633 = 0;

    @OriginalMember(owner = "client!DFJABDHX", name = "n", descriptor = "I")
    public int field634;

    @OriginalMember(owner = "client!DFJABDHX", name = "o", descriptor = "I")
    public int field635;

    @OriginalMember(owner = "client!DFJABDHX", name = "p", descriptor = "[[I")
    public int[][] field636;

    @OriginalMember(owner = "client!DFJABDHX", name = "d", descriptor = "I")
    private int field624;

    @OriginalMember(owner = "client!DFJABDHX", name = "k", descriptor = "I")
    private int field631;

    @OriginalMember(owner = "client!DFJABDHX", name = "<init>", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!DFJABDHX", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!DFJABDHX", name = "a", descriptor = "(IZIZII)V")
    ...
    @OriginalMember(owner = "client!DFJABDHX", name = "a", descriptor = "(IZIIIII)V")
    ...
    @OriginalMember(owner = "client!DFJABDHX", name = "a", descriptor = "(BII)V")
    ...
    @OriginalMember(owner = "client!DFJABDHX", name = "a", descriptor = "(III)V")
    private void method212(int arg0, int arg1, int arg2) {
        this.field636[arg0][arg1] |= arg2;
    }

    @OriginalMember(owner = "client!DFJABDHX", name = "a", descriptor = "(ZIIIZI)V")
    ...
    @OriginalMember(owner = "client!DFJABDHX", name = "b", descriptor = "(IZIIIII)V")
    ...
    @OriginalMember(owner = "client!DFJABDHX", name = "a", descriptor = "(IIIZ)V")
    ...
    @OriginalMember(owner = "client!DFJABDHX", name = "b", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!DFJABDHX", name = "a", descriptor = "(IBIIIII)Z")
    ...
    @OriginalMember(owner = "client!DFJABDHX", name = "a", descriptor = "(IIIIIIB)Z")
    ...
    @OriginalMember(owner = "client!DFJABDHX", name = "a", descriptor = "(IIIIIIII)Z")
