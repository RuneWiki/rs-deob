...
public class class5 extends class13 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ILuo;)V", line = 4)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ZI)[I", line = 55)
    ...
    @OriginalMember(owner = "client!il", name = "d", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Lkh;BI)V", line = 222)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "()V", line = 314)
    public class5() {
        super(0, true);
    }

    @OriginalMember(owner = "client!il", name = "e", descriptor = "(I)V", line = 328)
    ...
    @OriginalMember(owner = "client!il", name = "c", descriptor = "(I)V", line = 344)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IB)V", line = 366)
    ...
    @OriginalMember(owner = "client!il", name = "f", descriptor = "(I)V", line = 386)
