...
public class class5 implements Runnable {
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "([BIIZ)V", line = 25)
    ...
    @OriginalMember(owner = "client!js", name = "run", descriptor = "()V", line = 70)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(B)V", line = 143)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(II)V", line = 153)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "()V", line = 173)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(I)V", line = 267)
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 286)
