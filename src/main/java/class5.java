...
public class class5 {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(BZIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(I)V", line = 203)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Z)V", line = 241)
