...
public class class5 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(I)[[[I", line = 3)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(BI)[[I", line = 26)
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(III)V", line = 205)
    ...
    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!dc", name = "c", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!dc", name = "d", descriptor = "(I)V", line = 168)
