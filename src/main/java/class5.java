...
public class class5 extends class430 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IBIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!di", name = "b", descriptor = "(Z)V", line = 188)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IIII[[Z)V", line = 211)
    ...
    @OriginalMember(owner = "client!di", name = "<init>", descriptor = "(Lch;Lcj;Lwh;[I)V", line = 270)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(SZ)V", line = 530)
