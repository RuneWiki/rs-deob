...
public class class5 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(ZII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(BI)I", line = 15)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(JILol;)V", line = 49)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Z)V", line = 79)
    ...
    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(Z)V", line = 95)
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(I)V", line = 217)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(JB)Lol;", line = 112)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(III)Z", line = 135)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(I)V", line = 150)
    public static void method40(int arg0) {
        field92 = null;
        int var1 = -39 / ((33 - arg0) / 50);
    }

    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(I)V", line = 159)
