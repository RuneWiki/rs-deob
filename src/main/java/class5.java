...
public class class5 extends class130 {
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IZI[[[Lvt;II)Z")
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Lpv;)V")
