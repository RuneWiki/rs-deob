...
public class class5 extends class216 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "([Lae;I)V")
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Log;B)V")
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ILog;)V")
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IFZILui;)V")
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Log;I)V")
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ZLat;)Ljava/lang/String;")
