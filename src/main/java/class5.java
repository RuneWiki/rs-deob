...
public class class5 implements Runnable {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!dc", name = "run", descriptor = "()V", line = 17)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 51)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(B)Z", line = 86)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "([J[Ljava/lang/Object;B)V", line = 111)
