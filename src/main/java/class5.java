...
public class class5 {
    ...
    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(II)Lev;")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(I[S[Ljava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(Ldt;ILwia;)V")
