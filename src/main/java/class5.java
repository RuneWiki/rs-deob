...
public class class5 implements class685 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(B)Lsaa;")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lbha;Z)V")
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(Lwu;Ljava/lang/String;)V")
