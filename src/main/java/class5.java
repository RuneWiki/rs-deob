...
public abstract class class5 implements class306 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Ljaggl/opengl;IIIII[B)V")
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Ljaggl/opengl;IIIII[F)V")
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Ljaggl/opengl;IIIIII[I)V")
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "(Lic;IIIZ)V")
