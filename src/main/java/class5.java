...
public class class5 implements IEnumModesCallback {
    ...
    @OriginalMember(owner = "client!dc", name = "callbackEnumModes", descriptor = "(Lcom/ms/directX/DDSurfaceDesc;Lcom/ms/com/IUnknown;)V", line = 3)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Ljava/awt/Frame;I)V", line = 19)
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "()V", line = 32)
    public class5() {
        this.field56.initialize(null);
    }

    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(I)[I", line = 41)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Ljava/awt/Frame;IBIII)V", line = 56)
