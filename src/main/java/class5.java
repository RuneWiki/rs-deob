...
public class class5 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(FI)F", line = 4)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IIBIIIIIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(Ltk;JI)V", line = 104)
    public class5(class347 arg0, long arg1, int arg2) {
        this.field46 = arg1;
        this.field50 = arg0;
    }

    @OriginalMember(owner = "client!dc", name = "finalize", descriptor = "()V", line = 123)
