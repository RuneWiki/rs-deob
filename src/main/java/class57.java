...
public class class57 {
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!hka", name = "finalize", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(Lru;IZBZILru;)I", line = 44)
    ...
    @OriginalMember(owner = "client!hka", name = "<init>", descriptor = "(Lko;II)V", line = 82)
    public class57(class529 arg0, int arg1, int arg2) {
        this.field714 = arg0;
        this.field720 = arg2;
    }

    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(IBLjava/lang/String;)V", line = 97)
