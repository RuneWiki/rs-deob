...
public class class57 extends class156 {
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(Lir;III)V", line = 8)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(Z)V", line = 36)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(B[I)Ljava/lang/String;", line = 69)
