...
public class class57 extends class297 {
    ...
    @OriginalMember(owner = "client!tga", name = "<init>", descriptor = "()V", line = 146)
    public class57() {
        super(0, true);
    }

    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Lcea;II)V", line = 11)
    ...
    @OriginalMember(owner = "client!tga", name = "c", descriptor = "(II)[I", line = 78)
    ...
    @OriginalMember(owner = "client!tga", name = "f", descriptor = "(I)V", line = 136)
