...
public class class57 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Z)V", line = 494)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IZLha;I)Lhk;", line = 509)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(ILwq;)V", line = 555)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(ZILjava/awt/Component;)Ljm;", line = 577)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(FBIZIIII)[I", line = 602)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(I)Z", line = 632)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Lwq;II)V", line = 654)
