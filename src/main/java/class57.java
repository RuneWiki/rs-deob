...
public class class57 {
    ...
    @OriginalMember(owner = "client!UIVLSYQW", name = "p", descriptor = "LCZWVRQJW;")
    ...
    @OriginalMember(owner = "client!UIVLSYQW", name = "h", descriptor = "LXKEHWKFH;")
    public class66 field1388;

    @OriginalMember(owner = "client!UIVLSYQW", name = "d", descriptor = "[LUIVLSYQW;")
    public static class57[] field1384;

    @OriginalMember(owner = "client!UIVLSYQW", name = "a", descriptor = "(ILSPZBTZXL;)V")
    ...
    @OriginalMember(owner = "client!UIVLSYQW", name = "a", descriptor = "(LLDILQFVA;I)V")
    ...
    @OriginalMember(owner = "client!UIVLSYQW", name = "a", descriptor = "()LHEQROJXW;")
