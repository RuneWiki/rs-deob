...
public class class57 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lcs;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!hr", name = "toString", descriptor = "()Ljava/lang/String;", line = 113)
    public final String toString() {
        field966++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(B)V", line = 121)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(III)I", line = 133)
    ...
    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "(II)V", line = 160)
    public class57(int arg0, int arg1) {
        this.field964 = arg1;
    }

    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IBI)V", line = 170)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "([Lqk;BI)V", line = 210)
