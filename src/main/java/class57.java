...
public class class57 {
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(ZLrg;[B)V", line = 23)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "([BZ)[B", line = 48)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(IIILwh;[I[I)Lei;", line = 72)
    ...
    @OriginalMember(owner = "client!fw", name = "<init>", descriptor = "()V", line = 108)
    public class57() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!fw", name = "<init>", descriptor = "(III)V", line = 115)
