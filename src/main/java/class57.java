...
public class class57 {
    ...
    @OriginalMember(owner = "client!UNSYPSHF", name = "b", descriptor = "[LUNSYPSHF;")
    public static class57[] field1497;

    @OriginalMember(owner = "client!UNSYPSHF", name = "a", descriptor = "(ILRVLWVPJQ;)V")
    ...
    @OriginalMember(owner = "client!UNSYPSHF", name = "a", descriptor = "(LUAWAYCTK;II)V")
