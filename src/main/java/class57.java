...
public class class57 extends class101 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Ljava/lang/String;IZ)Z", line = 22)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(I)V", line = 126)
