...
public abstract class class57 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(II[BIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IIIIZIILha;I)V", line = 44)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IJ)I", line = 181)
