...
public abstract class class57 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ILql;II)V", line = 179)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(I)V", line = 236)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IILkq;Ljava/lang/String;)Lmq;", line = 248)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(III)Lti;", line = 328)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Ljava/awt/Canvas;I)Lra;", line = 339)
