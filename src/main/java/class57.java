...
public class class57 extends class450 implements class28 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(Lqi;I[BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(I[BI)V", line = 11)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "()I", line = 18)
