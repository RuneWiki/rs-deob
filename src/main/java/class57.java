...
public class class57 {
    ...
    @OriginalMember(owner = "client!VHKTMNAT", name = "b", descriptor = "LWLTWEDNK;")
    public class61 field1461 = new class61();

    @OriginalMember(owner = "client!VHKTMNAT", name = "c", descriptor = "LWLTWEDNK;")
    ...
    @OriginalMember(owner = "client!VHKTMNAT", name = "a", descriptor = "(LWLTWEDNK;)V")
    ...
    @OriginalMember(owner = "client!VHKTMNAT", name = "a", descriptor = "()LWLTWEDNK;")
    ...
    @OriginalMember(owner = "client!VHKTMNAT", name = "a", descriptor = "(B)LWLTWEDNK;")
