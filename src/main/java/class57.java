...
public class class57 {
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(Lmc;B)V")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(Lmc;II)V")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(Lpi;I)V")
