...
public abstract class class57 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(B)[Lju;")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(ILjava/lang/String;Les;)I")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(II)Lcj;")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(ILqi;Lbda;ILac;III)V")
