...
public class class57 extends class650 implements class145 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Liba;Z)Lxa;")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lig;Z)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lnj;IIII)Lba;")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lip;Lip;FLip;)Lip;")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lub;[Liba;Z)Lta;")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lba;Lig;Lq;Lpo;I)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIF)Lbj;")
    ...
    @OriginalMember(owner = "client!da", name = "t", descriptor = "()Ltaa;")
    ...
    @OriginalMember(owner = "client!da", name = "q", descriptor = "()Lq;")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I[Lbj;)V")
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "(IIIIII)Lip;")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lig;)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Lba;Lq;[Lpo;I)V")
