...
public class class57 {
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Lnn;BI)V")
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(IIIBIILe;I)Le;")
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(IILe;III)Le;")
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(ILnn;)V")
