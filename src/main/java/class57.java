...
public class class57 {
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(III)V", line = 7)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(IIBII)V", line = 22)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(B)V", line = 58)
