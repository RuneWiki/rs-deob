...
@OriginalClass("client!WLDGGJJE")
public class class57 {

    @OriginalMember(owner = "client!WLDGGJJE", name = "a", descriptor = "LRBCDFWXD;")
    private static class45 field1548 = new class45();

    @OriginalMember(owner = "client!WLDGGJJE", name = "a", descriptor = "([BI[BII)I")
    ...
    @OriginalMember(owner = "client!WLDGGJJE", name = "a", descriptor = "(LRBCDFWXD;)V")
    ...
    @OriginalMember(owner = "client!WLDGGJJE", name = "b", descriptor = "(LRBCDFWXD;)V")
    ...
    @OriginalMember(owner = "client!WLDGGJJE", name = "c", descriptor = "(LRBCDFWXD;)B")
    private static byte method541(class45 arg0) {
        return (byte) method543(8, arg0);
    }

    @OriginalMember(owner = "client!WLDGGJJE", name = "d", descriptor = "(LRBCDFWXD;)B")
    private static byte method542(class45 arg0) {
        return (byte) method543(1, arg0);
    }

    @OriginalMember(owner = "client!WLDGGJJE", name = "a", descriptor = "(ILRBCDFWXD;)I")
    ...
    @OriginalMember(owner = "client!WLDGGJJE", name = "e", descriptor = "(LRBCDFWXD;)V")
    ...
    @OriginalMember(owner = "client!WLDGGJJE", name = "a", descriptor = "([I[I[I[BIII)V")
