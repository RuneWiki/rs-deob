...
public class class57 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(ILie;)V", line = 3)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(ZLjava/lang/String;)Z", line = 23)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(II)I", line = 54)
    ...
    @OriginalMember(owner = "client!dl", name = "b", descriptor = "(II)Ljava/lang/String;", line = 74)
    ...
    @OriginalMember(owner = "client!dl", name = "c", descriptor = "(II)Z", line = 95)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Lie;IB)V", line = 147)
    ...
    @OriginalMember(owner = "client!dl", name = "b", descriptor = "(I)V", line = 201)
    ...
    @OriginalMember(owner = "client!dl", name = "c", descriptor = "(I)V", line = 223)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Llr;IIIB)V", line = 237)
