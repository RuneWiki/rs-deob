...
public class class57 extends class387 {
    ...
    @OriginalMember(owner = "client!bl", name = "d", descriptor = "(II)S", line = 3)
    ...
    @OriginalMember(owner = "client!bl", name = "c", descriptor = "(B)[B", line = 34)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(III)B", line = 54)
    ...
    @OriginalMember(owner = "client!bl", name = "i", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IIIIIILfp;BILtp;ZLbi;III)Lbi;", line = 95)
    ...
    @OriginalMember(owner = "client!bl", name = "h", descriptor = "(I)I", line = 308)
