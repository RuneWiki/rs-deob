...
public class class57 {
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(IIIIILmk;IIIIII)Z")
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Lwm;B)V")
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Lwm;II)V")
