...
public class class57 extends class699 {
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(IZ)I", line = 3)
    ...
    @OriginalMember(owner = "client!hka", name = "b", descriptor = "(Z)I", line = 36)
    ...
    @OriginalMember(owner = "client!hka", name = "b", descriptor = "(Lha;I)V", line = 74)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(IBILha;)Z", line = 92)
    ...
    @OriginalMember(owner = "client!hka", name = "<init>", descriptor = "(IIIII)V", line = 386)
    public class57(int arg0, int arg1, int arg2, int arg3, int arg4) {
        super(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!hka", name = "b", descriptor = "(ILha;)Lrk;", line = 145)
    ...
    @OriginalMember(owner = "client!hka", name = "c", descriptor = "(Z)Z", line = 313)
    ...
    @OriginalMember(owner = "client!hka", name = "d", descriptor = "(B)Z", line = 325)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(ZII)I", line = 336)
    ...
    @OriginalMember(owner = "client!hka", name = "c", descriptor = "(III)Z", line = 374)
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(ZLha;)Loba;", line = 389)
    public final class276 method507(boolean arg0, class66 arg1) {
        ++field782;
        return arg0 ? null : null;
    }

    @OriginalMember(owner = "client!hka", name = "e", descriptor = "(I)I", line = 415)
    ...
    @OriginalMember(owner = "client!hka", name = "f", descriptor = "(I)I", line = 429)
