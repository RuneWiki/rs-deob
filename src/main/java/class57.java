...
public class class57 {
    ...
    @OriginalMember(owner = "client!VYBZTNTY", name = "e", descriptor = "LCDEGFOQA;")
    public class4 field1557 = new class4();

    @OriginalMember(owner = "client!VYBZTNTY", name = "f", descriptor = "LCDEGFOQA;")
    ...
    @OriginalMember(owner = "client!VYBZTNTY", name = "a", descriptor = "(LCDEGFOQA;)V")
    ...
    @OriginalMember(owner = "client!VYBZTNTY", name = "a", descriptor = "(LCDEGFOQA;B)V")
    ...
    @OriginalMember(owner = "client!VYBZTNTY", name = "a", descriptor = "()LCDEGFOQA;")
    ...
    @OriginalMember(owner = "client!VYBZTNTY", name = "b", descriptor = "()LCDEGFOQA;")
    ...
    @OriginalMember(owner = "client!VYBZTNTY", name = "a", descriptor = "(I)LCDEGFOQA;")
    ...
    @OriginalMember(owner = "client!VYBZTNTY", name = "b", descriptor = "(I)LCDEGFOQA;")
    ...
    @OriginalMember(owner = "client!VYBZTNTY", name = "a", descriptor = "(B)LCDEGFOQA;")
