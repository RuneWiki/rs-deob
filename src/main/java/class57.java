...
public class class57 extends class136 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IILiv;)V", line = 14)
    ...
    @OriginalMember(owner = "client!gv", name = "c", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(BLfs;)V", line = 65)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(II)[I", line = 94)
