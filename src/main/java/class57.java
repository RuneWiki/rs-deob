...
public class class57 extends class424 {
    ...
    @OriginalMember(owner = "client!oi", name = "b", descriptor = "(BII)Z", line = 75)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Z)V", line = 87)
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZ)V", line = 111)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IZIIZ)V", line = 131)
