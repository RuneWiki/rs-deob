...
public class class57 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Ljb;ZI)V")
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(IB)Lkf;")
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(ILgd;IIII)Ljk;")
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Lgo;ILns;)V")
