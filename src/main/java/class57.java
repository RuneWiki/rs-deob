...
public class class57 extends class344 {
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(IZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!wo", name = "c", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!wo", name = "e", descriptor = "(B)[B", line = 217)
    ...
    @OriginalMember(owner = "client!wo", name = "b", descriptor = "(I)I", line = 237)
    ...
    @OriginalMember(owner = "client!wo", name = "c", descriptor = "(Z)V", line = 256)
    ...
    @OriginalMember(owner = "client!wo", name = "d", descriptor = "(Z)V", line = 340)
    ...
    @OriginalMember(owner = "client!wo", name = "d", descriptor = "(I)V", line = 351)
