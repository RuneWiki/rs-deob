...
public class class57 {
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(III)V", line = 20)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(BI)V", line = 55)
