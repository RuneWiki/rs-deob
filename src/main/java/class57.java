...
public abstract class class57 extends class120 {
    ...
    @OriginalMember(owner = "client!jr", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(II)V", line = 21)
    ...
    @OriginalMember(owner = "client!jr", name = "g", descriptor = "(I)V", line = 46)
    public void method375(int arg0) {
        field719++;
        int var2 = -34 % ((arg0 + 35) / 55);
    }

    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(CI)Z", line = 55)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(Lne;Ljava/lang/String;Z)Ljava/lang/String;", line = 108)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(ZJ)V", line = 198)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IBIIII)V", line = 291)
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 411)
