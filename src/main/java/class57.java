...
public class class57 extends class250 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "([IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!ea", name = "n", descriptor = "(II)V", line = 15)
    ...
    @OriginalMember(owner = "client!ea", name = "z", descriptor = "(I)I", line = 28)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(ZIIZI)V", line = 56)
    ...
    @OriginalMember(owner = "client!ea", name = "j", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!ea", name = "A", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(I)V", line = 96)
    public class57(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ea", name = "f", descriptor = "(IB)Lfd;", line = 101)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "([BBII)V", line = 128)
    ...
    @OriginalMember(owner = "client!ea", name = "k", descriptor = "(B)V", line = 145)
    ...
    @OriginalMember(owner = "client!ea", name = "o", descriptor = "(II)I", line = 163)
    public final int method304(int arg0, int arg1) {
        ++field582;
        return arg0 > -100 ? 122 : arg1 * 8 + -this.field583;
    }

    @OriginalMember(owner = "client!ea", name = "p", descriptor = "(II)I", line = 180)
    ...
    @OriginalMember(owner = "client!ea", name = "l", descriptor = "(B)V", line = 211)
