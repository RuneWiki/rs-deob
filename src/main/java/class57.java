...
public class class57 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(ZLeg;)V", line = 23)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IBIIIIIIII)V", line = 45)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IIII)V", line = 67)
