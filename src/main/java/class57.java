...
public class class57 {
    ...
    @OriginalMember(owner = "client!ff", name = "e", descriptor = "Llf;")
    private static class109 field1156 = class35.method275("Cancel", 2);

    @OriginalMember(owner = "client!ff", name = "c", descriptor = "Llf;")
    public static class109 field1154 = field1156;

    @OriginalMember(owner = "client!ff", name = "d", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ff", name = "k", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ff", name = "j", descriptor = "Loh;")
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Loe;III)V")
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lja;B)Llf;")
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(B)[Lkf;")
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lbg;ILbg;Ljava/awt/Component;)V")
