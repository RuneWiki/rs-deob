...
public class class57 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(IIZ)Z", line = 40)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(JI)V", line = 72)
