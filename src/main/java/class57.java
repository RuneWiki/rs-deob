...
public class class57 extends class13 {
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "()V", line = 3)
    public class57() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lkh;BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lms;B)V", line = 95)
    ...
    @OriginalMember(owner = "client!ra", name = "d", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(II)[[I", line = 150)
