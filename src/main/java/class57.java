...
public class class57 extends class36 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!nr", name = "h", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(FI)V", line = 34)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(IIIIIF)V", line = 48)
    public class57(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IIZZI)I", line = 55)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 97)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(Z)V", line = 152)
