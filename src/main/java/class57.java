...
public class class57 extends class535 {
    ...
    @OriginalMember(owner = "client!jv", name = "<init>", descriptor = "()V", line = 24)
    public class57() {
        super(0, false);
    }

    @OriginalMember(owner = "client!jv", name = "f", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(II)[[I", line = 29)
    ...
    @OriginalMember(owner = "client!jv", name = "c", descriptor = "(I)Z", line = 99)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "([I[JIII)V", line = 126)
    ...
    @OriginalMember(owner = "client!jv", name = "b", descriptor = "(I)V", line = 183)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(ILwn;I)V", line = 194)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(I)I", line = 208)
    public final int method485(int arg0) {
        ++field1024;
        return arg0 > -68 ? -105 : this.field1013;
    }

    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Z)V", line = 220)
