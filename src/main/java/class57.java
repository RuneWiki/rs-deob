...
public abstract class class57 {
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Llq;", line = 3)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(II)V", line = 42)
