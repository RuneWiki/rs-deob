...
public class class57 extends class598 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ILqa;II)Z", line = 6)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ZLqa;Lr;)V", line = 17)
    ...
    @OriginalMember(owner = "client!qr", name = "d", descriptor = "(I)Z", line = 42)
    ...
    @OriginalMember(owner = "client!qr", name = "c", descriptor = "(ILqa;)Loj;", line = 56)
    ...
    @OriginalMember(owner = "client!qr", name = "d", descriptor = "(B)V", line = 92)
    ...
    @OriginalMember(owner = "client!qr", name = "e", descriptor = "(I)I", line = 107)
    ...
    @OriginalMember(owner = "client!qr", name = "finalize", descriptor = "()V", line = 118)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(IIIIIIIIIIIZ)V", line = 177)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(I)V", line = 151)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ZLoe;ILqa;III)V", line = 166)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IILqa;)Lr;", line = 204)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ILqa;)V", line = 217)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IZ)V", line = 245)
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(ILqa;)Lso;", line = 264)
    public final class398 method328(int arg0, class206 arg1) {
        ++field502;
        return arg0 != 12 ? null : null;
    }

    @OriginalMember(owner = "client!qr", name = "c", descriptor = "(B)V", line = 277)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IIIII)V", line = 290)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Ln;Ljava/awt/Canvas;I)Lqa;", line = 333)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(BI)V", line = 353)
