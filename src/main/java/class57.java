...
public class class57 implements class669 {
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(ILnb;)Z")
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Lmv;I)V")
    ...
    @OriginalMember(owner = "client!oi", name = "b", descriptor = "(B)Lbl;")
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "(Lmv;)V")
