...
@OriginalClass("client!SDZHMORV")
public class class57 extends class18 {

    @OriginalMember(owner = "client!SDZHMORV", name = "F", descriptor = "I")
    private int field1444 = 654;

    @OriginalMember(owner = "client!SDZHMORV", name = "G", descriptor = "Z")
    public boolean field1445 = false;

    @OriginalMember(owner = "client!SDZHMORV", name = "H", descriptor = "LYTBPTACV;")
    private class70 field1446;

    @OriginalMember(owner = "client!SDZHMORV", name = "q", descriptor = "I")
    public int field1429;

    @OriginalMember(owner = "client!SDZHMORV", name = "s", descriptor = "I")
    public int field1431;

    @OriginalMember(owner = "client!SDZHMORV", name = "t", descriptor = "I")
    public int field1432;

    @OriginalMember(owner = "client!SDZHMORV", name = "u", descriptor = "I")
    public int field1433;

    @OriginalMember(owner = "client!SDZHMORV", name = "w", descriptor = "I")
    public int field1435;

    @OriginalMember(owner = "client!SDZHMORV", name = "x", descriptor = "I")
    public int field1436;

    @OriginalMember(owner = "client!SDZHMORV", name = "l", descriptor = "I")
    public int field1424;

    @OriginalMember(owner = "client!SDZHMORV", name = "m", descriptor = "I")
    public int field1425;

    @OriginalMember(owner = "client!SDZHMORV", name = "n", descriptor = "I")
    public int field1426;

    @OriginalMember(owner = "client!SDZHMORV", name = "v", descriptor = "I")
    public int field1434;

    @OriginalMember(owner = "client!SDZHMORV", name = "r", descriptor = "D")
    private double field1430;

    @OriginalMember(owner = "client!SDZHMORV", name = "y", descriptor = "D")
    private double field1437;

    @OriginalMember(owner = "client!SDZHMORV", name = "z", descriptor = "D")
    private double field1438;

    @OriginalMember(owner = "client!SDZHMORV", name = "A", descriptor = "D")
    private double field1439;

    @OriginalMember(owner = "client!SDZHMORV", name = "B", descriptor = "D")
    private double field1440;

    @OriginalMember(owner = "client!SDZHMORV", name = "C", descriptor = "D")
    public double field1441;

    @OriginalMember(owner = "client!SDZHMORV", name = "D", descriptor = "D")
    public double field1442;

    @OriginalMember(owner = "client!SDZHMORV", name = "E", descriptor = "D")
    public double field1443;

    @OriginalMember(owner = "client!SDZHMORV", name = "o", descriptor = "I")
    private int field1427;

    @OriginalMember(owner = "client!SDZHMORV", name = "p", descriptor = "I")
    private int field1428;

    @OriginalMember(owner = "client!SDZHMORV", name = "I", descriptor = "I")
    public int field1447;

    @OriginalMember(owner = "client!SDZHMORV", name = "J", descriptor = "I")
    public int field1448;

    @OriginalMember(owner = "client!SDZHMORV", name = "<init>", descriptor = "(IIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!SDZHMORV", name = "a", descriptor = "(IIIII)V")
    ...
    @OriginalMember(owner = "client!SDZHMORV", name = "a", descriptor = "(ZI)V")
    ...
    @OriginalMember(owner = "client!SDZHMORV", name = "a", descriptor = "(B)LDHUPIIUL;")
