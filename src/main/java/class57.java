...
public class class57 extends class71 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!f", name = "c", descriptor = "(B)J", line = 45)
    ...
    @OriginalMember(owner = "client!f", name = "b", descriptor = "(B)J", line = 81)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(I)V", line = 94)
