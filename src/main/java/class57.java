...
@OriginalClass("client!TDFMBTLA")
public class class57 {

    @OriginalMember(owner = "client!TDFMBTLA", name = "a", descriptor = "I")
    private static int field1440 = 8;

    @OriginalMember(owner = "client!TDFMBTLA", name = "c", descriptor = "I")
    public int field1442;

    @OriginalMember(owner = "client!TDFMBTLA", name = "e", descriptor = "I")
    public int field1444;

    @OriginalMember(owner = "client!TDFMBTLA", name = "d", descriptor = "LVLFCQHDE;")
    public class64 field1443;

    @OriginalMember(owner = "client!TDFMBTLA", name = "f", descriptor = "[I")
    public int[] field1445;

    @OriginalMember(owner = "client!TDFMBTLA", name = "g", descriptor = "[I")
    public int[] field1446;

    @OriginalMember(owner = "client!TDFMBTLA", name = "h", descriptor = "[I")
    public int[] field1447;

    @OriginalMember(owner = "client!TDFMBTLA", name = "i", descriptor = "[I")
    public int[] field1448;

    @OriginalMember(owner = "client!TDFMBTLA", name = "b", descriptor = "[LTDFMBTLA;")
    private static class57[] field1441;

    @OriginalMember(owner = "client!TDFMBTLA", name = "j", descriptor = "[Z")
    private static boolean[] field1449;

    @OriginalMember(owner = "client!TDFMBTLA", name = "a", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!TDFMBTLA", name = "a", descriptor = "(I[B)V")
    ...
    @OriginalMember(owner = "client!TDFMBTLA", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!TDFMBTLA", name = "a", descriptor = "(II)LTDFMBTLA;")
    ...
    @OriginalMember(owner = "client!TDFMBTLA", name = "b", descriptor = "(II)Z")
