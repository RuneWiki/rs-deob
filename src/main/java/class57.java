...
public class class57 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(BLil;I)V")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(II)Lji;")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ZIILnr;)Lqa;")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IIBLil;)V")
