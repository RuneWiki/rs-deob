...
public class class57 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Ljc;Lpga;B)Lvq;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Llga;Lft;B)V")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ZI)Lqm;")
    ...
    @OriginalMember(owner = "client!am", name = "<init>", descriptor = "(Lfs;ILlga;)V")
