...
public class class57 extends class354 {
    ...
    @OriginalMember(owner = "client!gv", name = "c", descriptor = "(BI)I", line = 4)
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "()V", line = 73)
    public class57() {
        super(1, false);
    }

    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IB)[[I", line = 27)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Lnj;II)V", line = 81)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(BI)[I", line = 125)
    ...
    @OriginalMember(owner = "client!gv", name = "g", descriptor = "(I)V", line = 160)
