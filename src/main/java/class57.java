...
public class class57 {
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(IIIIIBLka;I)Lka;")
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(IIILka;II)Lka;")
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(Ldc;B)V")
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(Ldc;II)V")
