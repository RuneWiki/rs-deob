...
public class class57 extends class648 implements Runnable {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(IIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!kg", name = "run", descriptor = "()V", line = 48)
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(III)Z", line = 73)
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(BIII)I", line = 95)
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "(Laaa;)V", line = 133)
