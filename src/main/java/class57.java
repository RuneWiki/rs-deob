...
public class class57 extends class371 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(IIBII)V", line = 14)
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "()V", line = 71)
    public class57() {
        super(3, false);
    }

    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(B)V", line = 74)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(IBLps;)V", line = 85)
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(BI)[I", line = 120)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(BI)[[I", line = 170)
