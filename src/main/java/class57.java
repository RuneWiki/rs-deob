...
public class class57 implements Runnable {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ILfb;)V", line = 4)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(I)V", line = 17)
    public static void method394(int arg0) {
        int var1 = 68 / ((-arg0 - 69) / 53);
        field775 = null;
    }

    @OriginalMember(owner = "client!f", name = "run", descriptor = "()V", line = 26)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Ljava/lang/String;I)Loq;", line = 90)
    ...
    @OriginalMember(owner = "client!f", name = "b", descriptor = "(B)V", line = 119)
    ...
    @OriginalMember(owner = "client!f", name = "<init>", descriptor = "()V", line = 176)
    public class57() {
