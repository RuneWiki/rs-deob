...
public class class57 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(I)Lnd;", line = 5)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(I)Lnd;", line = 15)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Lek;)V", line = 166)
