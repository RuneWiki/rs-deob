...
public class class57 extends class49 {
    ...
    @OriginalMember(owner = "client!WWTUXVKR", name = "l", descriptor = "Z")
    public static boolean field1488;

    @OriginalMember(owner = "client!WWTUXVKR", name = "j", descriptor = "[LXEISCDXD;")
    ...
    @OriginalMember(owner = "client!WWTUXVKR", name = "a", descriptor = "(Z)LPOJFANDE;")
