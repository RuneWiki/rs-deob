...
public class class57 extends class485 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(BLjava/io/File;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(Lsea;Lsea;Lpe;)V", line = 30)
    public class57(class648 arg0, class648 arg1, class566 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IIIII)V", line = 34)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(B)Z", line = 52)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!dl", name = "c", descriptor = "(I)V", line = 105)
    public static void method477(int arg0) {
        field651 = null;
        int var1 = -78 % ((72 - arg0) / 44);
    }

    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(B[Ljava/lang/String;)V", line = 115)
    ...
    @OriginalMember(owner = "client!dl", name = "d", descriptor = "(I)J", line = 159)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(ZIIB)V", line = 170)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IIZI)V", line = 204)
