...
@OriginalClass("client!TUJJLJTQ")
public class class57 extends class66 {

    @OriginalMember(owner = "client!TUJJLJTQ", name = "s", descriptor = "I")
    private int field1392 = 31;

    @OriginalMember(owner = "client!TUJJLJTQ", name = "w", descriptor = "Z")
    private boolean field1396 = true;

    @OriginalMember(owner = "client!TUJJLJTQ", name = "k", descriptor = "I")
    private int field1384;

    @OriginalMember(owner = "client!TUJJLJTQ", name = "l", descriptor = "I")
    private int field1385;

    @OriginalMember(owner = "client!TUJJLJTQ", name = "m", descriptor = "I")
    private int field1386;

    @OriginalMember(owner = "client!TUJJLJTQ", name = "o", descriptor = "I")
    private int field1388;

    @OriginalMember(owner = "client!TUJJLJTQ", name = "p", descriptor = "I")
    private int field1389;

    @OriginalMember(owner = "client!TUJJLJTQ", name = "q", descriptor = "I")
    private int field1390;

    @OriginalMember(owner = "client!TUJJLJTQ", name = "r", descriptor = "I")
    private int field1391;

    @OriginalMember(owner = "client!TUJJLJTQ", name = "t", descriptor = "LODMBIHRM;")
    private class41 field1393;

    @OriginalMember(owner = "client!TUJJLJTQ", name = "x", descriptor = "I")
    private int field1397;

    @OriginalMember(owner = "client!TUJJLJTQ", name = "n", descriptor = "I")
    private int field1387;

    @OriginalMember(owner = "client!TUJJLJTQ", name = "y", descriptor = "I")
    public int field1398;

    @OriginalMember(owner = "client!TUJJLJTQ", name = "z", descriptor = "I")
    public int field1399;

    @OriginalMember(owner = "client!TUJJLJTQ", name = "u", descriptor = "[I")
    public int[] field1394;

    @OriginalMember(owner = "client!TUJJLJTQ", name = "v", descriptor = "Lclient;")
    public static client field1395;

    @OriginalMember(owner = "client!TUJJLJTQ", name = "<init>", descriptor = "(IIIIIZIIBI)V")
    ...
    @OriginalMember(owner = "client!TUJJLJTQ", name = "b", descriptor = "(I)LDQLJXYPC;")
    ...
    @OriginalMember(owner = "client!TUJJLJTQ", name = "a", descriptor = "(I)LKBEXSZSN;")
