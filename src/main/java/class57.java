...
public class class57 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Z)Lda;", line = 11)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lpc;IZ)Lre;", line = 55)
    ...
    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "(Lub;)V", line = 112)
    public class57(class18 arg0) {
        this.field894 = arg0;
    }

    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(I)Lda;", line = 101)
