...
public class class57 extends class55 {
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "([I)Lib;")
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Lni;)Z")
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Lni;I)Lfw;")
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Lni;II)Lfw;")
    ...
    @OriginalMember(owner = "client!fw", name = "<init>", descriptor = "([B)V")
