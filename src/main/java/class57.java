...
public class class57 implements class117 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(I)Lof;", line = 3)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(I)V", line = 37)
    public class57(int arg0) {
        this.field671 = arg0;
    }

    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ZLjava/lang/String;)Z", line = 49)
