...
public class class57 extends class67 {
    ...
    @OriginalMember(owner = "client!hka", name = "fa", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "([B[I[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!hka", name = "<init>", descriptor = "(Ljr;Leb;[Lvf;[I[I)V")
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "(CIIIZLaa;II)V")
    ...
    @OriginalMember(owner = "client!hka", name = "a", descriptor = "([B[I[IIIIIII)V")
