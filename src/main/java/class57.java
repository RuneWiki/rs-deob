...
public class class57 extends class311 {
    ...
    @OriginalMember(owner = "client!f", name = "c", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ZI[I[II)J", line = 25)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IZII)I", line = 72)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ILcc;ZZIILi;IILea;)Lts;", line = 98)
