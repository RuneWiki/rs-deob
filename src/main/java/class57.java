...
public class class57 {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(ILep;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IIB)Z", line = 28)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(ZILjava/net/Socket;)Lqi;", line = 38)
    ...
    @OriginalMember(owner = "client!bd", name = "toString", descriptor = "()Ljava/lang/String;", line = 58)
