...
public abstract class class57 extends class184 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(BII)V", line = 3)
    ...
    @OriginalMember(owner = "client!f", name = "e", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(CB)Z", line = 41)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ZILhh;Lpe;III)V", line = 53)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ZILap;)V", line = 63)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IIIII)V", line = 90)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ILsb;)V", line = 124)
    ...
    @OriginalMember(owner = "client!f", name = "e", descriptor = "(I)Z", line = 184)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(BLcc;)V", line = 196)
    ...
    @OriginalMember(owner = "client!f", name = "f", descriptor = "(B)V", line = 329)
    ...
    @OriginalMember(owner = "client!f", name = "<init>", descriptor = "(IIIIIII)V", line = 357)
