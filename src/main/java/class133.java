...
public class class133 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(I)[Lvg;")
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ILgk;)V")
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Lgk;II)V")
