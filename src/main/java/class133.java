...
public class class133 extends class666 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(II)[I", line = 15)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(ILjava/lang/String;)V", line = 151)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(ILiaa;Z)V", line = 203)
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "()V", line = 265)
    public class133() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(JB)Ljava/lang/String;", line = 277)
    ...
    @OriginalMember(owner = "client!pj", name = "h", descriptor = "(I)V", line = 338)
