...
public class class133 extends class386 {
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Ler;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Ler;IIII)V")
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Ler;IIIII)V")
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Ler;IIIIZ[IIIZ)V")
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Ler;IIIIZ[FI)V")
