...
public class class133 extends class184 {
    ...
    @OriginalMember(owner = "client!tj", name = "e", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IIZZIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!tj", name = "d", descriptor = "(III)I", line = 94)
    ...
    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "()V", line = 117)
    public class133() {
        super(0, true);
    }
}
