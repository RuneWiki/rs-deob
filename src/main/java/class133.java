...
public class class133 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IBI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(III)Z", line = 14)
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(III)Z", line = 24)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IIZ)Z", line = 34)
    ...
    @OriginalMember(owner = "client!gr", name = "c", descriptor = "(III)Z", line = 44)
    ...
    @OriginalMember(owner = "client!gr", name = "d", descriptor = "(III)Z", line = 54)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ZII)Z", line = 64)
    ...
    @OriginalMember(owner = "client!gr", name = "e", descriptor = "(III)Z", line = 74)
    ...
    @OriginalMember(owner = "client!gr", name = "f", descriptor = "(III)Z", line = 84)
    ...
    @OriginalMember(owner = "client!gr", name = "g", descriptor = "(III)Z", line = 94)
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(ZII)Z", line = 104)
    ...
    @OriginalMember(owner = "client!gr", name = "h", descriptor = "(III)Z", line = 115)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IIB)Z", line = 126)
    ...
    @OriginalMember(owner = "client!gr", name = "i", descriptor = "(III)Z", line = 136)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(BII)Z", line = 148)
    ...
    @OriginalMember(owner = "client!gr", name = "j", descriptor = "(III)Z", line = 158)
    ...
    @OriginalMember(owner = "client!gr", name = "c", descriptor = "(ZII)Z", line = 168)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IZI)Z", line = 178)
    ...
    @OriginalMember(owner = "client!gr", name = "k", descriptor = "(III)Z", line = 188)
    ...
    @OriginalMember(owner = "client!gr", name = "l", descriptor = "(III)Z", line = 198)
    ...
    @OriginalMember(owner = "client!gr", name = "d", descriptor = "(ZII)Z", line = 208)
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(IIZ)Z", line = 218)
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(IBI)Z", line = 229)
    public static final boolean method1061(int arg0, byte arg1, int arg2) {
        int var3 = -61 / ((arg1 - 19) / 38);
        return (arg0 & 0x400) != 0;
    }

    @OriginalMember(owner = "client!gr", name = "m", descriptor = "(III)Z", line = 237)
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(IZI)Z", line = 247)
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(BII)Z", line = 257)
    ...
    @OriginalMember(owner = "client!gr", name = "n", descriptor = "(III)Z", line = 274)
    public static final boolean method1065(int arg0, int arg1, int arg2) {
        return arg0 == 0 ? (arg1 & 0x220) == 544 | (arg1 & 0x18) != 0 : false;
    }

    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(IIB)Z", line = 284)
    ...
    @OriginalMember(owner = "client!gr", name = "o", descriptor = "(III)Z", line = 294)
    ...
    @OriginalMember(owner = "client!gr", name = "p", descriptor = "(III)Z", line = 304)
    ...
    @OriginalMember(owner = "client!gr", name = "q", descriptor = "(III)Z", line = 314)
