...
public class class133 extends class665 implements class121 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!mg", name = "b", descriptor = "(B)I", line = 14)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(I)I", line = 27)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(II[BIII)Z", line = 41)
    ...
    @OriginalMember(owner = "client!mg", name = "b", descriptor = "(I)J", line = 124)
    public final long method922(int arg0) {
        field1962++;
        return arg0 <= 102 ? -127L : this.field1967;
    }

    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Lr;IIIIBI)Lda;", line = 137)
    ...
    @OriginalMember(owner = "client!mg", name = "c", descriptor = "(I)C", line = 186)
