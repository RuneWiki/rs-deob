...
public class class133 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IIIBIIIZII[Lvo;)V")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(BLlga;)V")
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "(Lrv;II)V")
