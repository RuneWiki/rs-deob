...
public class class133 extends class56 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ZI)V", line = 8)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!ef", name = "b", descriptor = "(ZI)V", line = 41)
    ...
    @OriginalMember(owner = "client!ef", name = "c", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!ef", name = "d", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(Lbv;)V", line = 88)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(B)Z", line = 108)
    ...
    @OriginalMember(owner = "client!ef", name = "e", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(III)V", line = 133)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IILkv;)V", line = 151)
