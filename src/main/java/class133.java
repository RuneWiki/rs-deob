...
public class class133 extends class202 {
    ...
    @OriginalMember(owner = "client!ub", name = "d", descriptor = "()V", line = 11)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 17)
    ...
    @OriginalMember(owner = "client!ub", name = "d", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 56)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "()I", line = 94)
    public final int method838() {
        return this.field1863 - (this.field1860.available() >> (class407.field6043 ? 2 : 1));
    }

    @OriginalMember(owner = "client!ub", name = "c", descriptor = "()V", line = 101)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "()V", line = 118)
