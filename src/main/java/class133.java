...
public class class133 extends class190 {
    ...
    @OriginalMember(owner = "client!lca", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(ILaba;I)V", line = 17)
    ...
    @OriginalMember(owner = "client!lca", name = "b", descriptor = "(III)V", line = 29)
    ...
    @OriginalMember(owner = "client!lca", name = "<init>", descriptor = "(Ljj;)V", line = 46)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(Lbda;Z)I", line = 158)
    ...
    @OriginalMember(owner = "client!lca", name = "b", descriptor = "(I)Z", line = 185)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(ZI)V", line = 195)
    ...
    @OriginalMember(owner = "client!lca", name = "c", descriptor = "(I)V", line = 209)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(ZB)V", line = 289)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(B)V", line = 314)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(III)V", line = 342)
