...
public class class133 {
    ...
    @OriginalMember(owner = "client!jr", name = "finalize", descriptor = "()V", line = 10)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(Lsb;JI)V", line = 47)
