...
public class class133 extends class26 {
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(B)Z", line = 5)
    public final boolean method192(byte arg0) {
        return arg0 == 17;
    }

    @OriginalMember(owner = "client!kc", name = "h", descriptor = "(I)Ljava/lang/Object;", line = 15)
    ...
    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "(Lrf;Ljava/lang/Object;I)V", line = 24)
