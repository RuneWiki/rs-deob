...
public class class133 extends class111 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IIIB)[B", line = 3)
    ...
    @OriginalMember(owner = "client!gm", name = "d", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IBI)V", line = 105)
