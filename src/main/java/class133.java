...
public class class133 {
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Ljava/lang/String;I)J", line = 22)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IIIIIIII)V", line = 67)
