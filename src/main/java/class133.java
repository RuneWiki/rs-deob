...
public class class133 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(I)Z", line = 9)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IIIIIII)I", line = 61)
