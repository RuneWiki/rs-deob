...
public class class133 extends class219 {
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(ILjagtheora/ogg/OggPacket;)V")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Lha;B)Ltf;")
