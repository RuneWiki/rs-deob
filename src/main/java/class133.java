...
public class class133 {
    ...
    @OriginalMember(owner = "client!qaa", name = "finalize", descriptor = "()V", line = 8)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!qaa", name = "<init>", descriptor = "(Lqi;II)V", line = 40)
