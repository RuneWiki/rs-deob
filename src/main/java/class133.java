...
public class class133 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IZLtc;)V")
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IIILlga;Llga;)V")
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Lpe;I)V")
