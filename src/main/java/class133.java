...
public class class133 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(ILhfa;Len;)V")
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(ILen;I)V")
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Len;I)V")
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(BLen;)V")
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(Len;I)V")
