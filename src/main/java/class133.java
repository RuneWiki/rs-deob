...
public class class133 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lic;ILjava/lang/String;)Lhr;", line = 5)
    ...
    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "(Lic;II)V", line = 41)
    private class133(class246 arg0, int arg1, int arg2) {
        this.field1617 = arg0;
        this.field1616 = arg1;
    }

    @OriginalMember(owner = "client!hr", name = "finalize", descriptor = "()V", line = 48)
