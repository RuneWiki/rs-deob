...
public class class133 extends class240 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "([[BBLeda;)V", line = 4)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!qm", name = "d", descriptor = "()Lsda;", line = 108)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "([III)V", line = 127)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(I[IIIZLcfa;)V", line = 166)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lcfa;ZI)V", line = 230)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(I)V", line = 271)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "()Lsda;", line = 281)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "()I", line = 304)
    public final int method163() {
        field2178++;
        return 0;
    }

    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(Lnb;)V", line = 321)
