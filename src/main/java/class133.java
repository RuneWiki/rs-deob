...
public class class133 extends class143 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IIIBI)V", line = 8)
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "(Lup;)V", line = 25)
    public class133(class489 arg0) {
        this.field2152 = arg0;
    }

    @OriginalMember(owner = "client!kl", name = "e", descriptor = "(B)V", line = 42)
