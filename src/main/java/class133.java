...
public class class133 {
    ...
    @OriginalMember(owner = "client!oe", name = "c", descriptor = "()Lbq;")
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lbu;II)Loe;")
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(Lcu;)V")
