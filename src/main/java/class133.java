...
public class class133 extends class351 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 24)
    ...
    @OriginalMember(owner = "client!rn", name = "c", descriptor = "()I", line = 61)
    public final int method719() {
        return this.field1715 - (this.field1712.available() >> (class67.field689 ? 2 : 1));
    }

    @OriginalMember(owner = "client!rn", name = "a", descriptor = "()V", line = 74)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 80)
    ...
    @OriginalMember(owner = "client!rn", name = "d", descriptor = "()V", line = 95)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(I)V", line = 130)
