...
public class class133 extends class607 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(III)V", line = 18)
    ...
    @OriginalMember(owner = "client!vf", name = "c", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "(Ltu;)V", line = 38)
    public class133(class294 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(ZB)V", line = 45)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(III[Ljava/lang/String;)Ljava/lang/String;", line = 55)
    ...
    @OriginalMember(owner = "client!vf", name = "e", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IBLiu;)V", line = 129)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IZ)V", line = 148)
