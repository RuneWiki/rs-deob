...
public abstract class class133 implements class268 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Ljaggl/opengl;IIIII[B)V")
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Ljaggl/opengl;IIIIII[I)V")
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Ljaggl/opengl;IIIII[F)V")
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(Lhj;IIIZ)V")
