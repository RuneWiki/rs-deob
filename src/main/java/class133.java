...
public class class133 implements Runnable {
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(II)I", line = 14)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Lnda;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IBLpn;)Lnda;", line = 41)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IILpn;[B)Lnda;", line = 60)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IIIII)V", line = 76)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IILpn;)Lnda;", line = 89)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "([Lsha;IZ)V", line = 128)
    ...
    @OriginalMember(owner = "client!eda", name = "run", descriptor = "()V", line = 219)
    ...
    @OriginalMember(owner = "client!eda", name = "b", descriptor = "(B)V", line = 265)
    ...
    @OriginalMember(owner = "client!eda", name = "<init>", descriptor = "(Lvt;)V", line = 302)
