...
public class class133 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IIIZ)I", line = 17)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ILjava/lang/String;ZI)I", line = 51)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(B)V", line = 130)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 144)
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(IIIIB)V", line = 161)
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(B)V", line = 176)
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Lai;I)V", line = 187)
