...
public class class133 extends class7 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(BLmo;)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IILjg;)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(BLe;II)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lne;III)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(ILjg;)V")
