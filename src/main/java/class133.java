...
public class class133 {
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(B)[Lvv;", line = 3)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(III)Z", line = 15)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(I)Ljd;", line = 33)
    ...
    @OriginalMember(owner = "client!lca", name = "b", descriptor = "(III)V", line = 65)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(B[Ljava/lang/String;)[Ljava/lang/String;", line = 83)
    ...
    @OriginalMember(owner = "client!lca", name = "b", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!lca", name = "<init>", descriptor = "()V", line = 142)
    public class133() {
    }

    @OriginalMember(owner = "client!lca", name = "<init>", descriptor = "(Lica;)V", line = 161)
    public class133(class205 arg0) {
        this.field1757 = arg0;
    }

    @OriginalMember(owner = "client!lca", name = "b", descriptor = "(I)Ljd;", line = 150)
