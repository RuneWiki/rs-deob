...
public class class133 implements class359 {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "([IBJLln;)Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IIIIBIIIII)V", line = 51)
