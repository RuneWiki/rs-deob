...
public class class133 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(I)Lcn;", line = 56)
    ...
    @OriginalMember(owner = "client!oe", name = "b", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!oe", name = "c", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(B)V", line = 158)
