...
public class class133 extends class402 implements class425 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(B)Z", line = 8)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Lza;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!vb", name = "f", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(ZLza;II)Z", line = 44)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IB)V", line = 61)
    ...
    @OriginalMember(owner = "client!vb", name = "c", descriptor = "(I)I", line = 92)
    ...
    @OriginalMember(owner = "client!vb", name = "b", descriptor = "(I)Z", line = 103)
    public final boolean method228(int arg0) {
        ++field2226;
        return arg0 != 1396 ? true : this.field2240.method1563(1);
    }

    @OriginalMember(owner = "client!vb", name = "d", descriptor = "(I)I", line = 114)
    ...
    @OriginalMember(owner = "client!vb", name = "h", descriptor = "(I)I", line = 125)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(ILza;I)Le;", line = 136)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!vb", name = "b", descriptor = "(Lza;I)Lnd;", line = 162)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(BLza;)V", line = 200)
    ...
    @OriginalMember(owner = "client!vb", name = "j", descriptor = "(I)V", line = 215)
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Lza;Ljc;IIIIIZIIIIIII)V", line = 258)
    ...
    @OriginalMember(owner = "client!vb", name = "k", descriptor = "(I)V", line = 268)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Lza;Z)V", line = 278)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Z)I", line = 289)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IBILvs;Lza;ZI)V", line = 300)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Lph;Ll;I)V", line = 315)
