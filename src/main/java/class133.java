...
public class class133 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IIII[B[B)I", line = 8)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(III[B[BI)I", line = 78)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(II)V", line = 232)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IZLjava/lang/String;ILjava/lang/String;ZI)V", line = 246)
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "([B)V", line = 364)
