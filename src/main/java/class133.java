...
public class class133 {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(B[B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(I)[Lmr;", line = 55)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Z)V", line = 66)
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(IILjr;)V", line = 89)
    ...
    @OriginalMember(owner = "client!mr", name = "toString", descriptor = "()Ljava/lang/String;", line = 103)
    public final String toString() {
        field1613++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(IIZI[Lrr;I)V", line = 123)
