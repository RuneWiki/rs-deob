...
public class class133 implements class59 {
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IZ)Lop;")
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(IZ)Lcm;")
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(III)Lab;")
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "(Lhe;Lhe;Lhe;)V")
