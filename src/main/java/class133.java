...
public abstract class class133 {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(II[Lgo;)V", line = 18)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IZLvd;I[II)Lwq;", line = 104)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 123)
