...
public abstract class class133 implements class655 {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(FFIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(FFII)V", line = 6)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(FFFFIILaa;II)V", line = 10)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(IIIIIII)V", line = 37)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(II)V", line = 41)
    public final void method1035(int arg0, int arg1) {
        this.method1045(arg0, arg1, 1, 0, 1);
    }

    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(FFIILaa;II)V", line = 47)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(FFFFFFLaa;II)V", line = 50)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(FFFFIIIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(FFFFFFIII)V", line = 77)
    ...
    @OriginalMember(owner = "client!hu", name = "b", descriptor = "(IIII)V", line = 89)
    public final void method1049(int arg0, int arg1, int arg2, int arg3) {
        this.method1047(arg0, arg1, arg2, arg3, 1, 0, 1);
    }

    @OriginalMember(owner = "client!hu", name = "c", descriptor = "(IIII)V", line = 96)
