...
public class class133 extends class360 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(BLae;)Lae;", line = 6)
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(III)V", line = 41)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IIZI)I", line = 56)
    ...
    @OriginalMember(owner = "client!vm", name = "c", descriptor = "(III)La;", line = 105)
