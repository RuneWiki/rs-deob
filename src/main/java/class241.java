...
public class class241 implements class601 {
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Ljaclib/memory/Source;III)Z")
    ...
    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "(Lto;Z)V")
