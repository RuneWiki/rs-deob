...
public class class241 extends class367 implements class278 {
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Lkm;II)Lab;")
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Lkm;BII)Z")
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Lkm;I)V")
    ...
    @OriginalMember(owner = "client!pq", name = "c", descriptor = "(Lkm;I)V")
    public final void method197(class487 arg0, int arg1) {
        int var3 = 109 % ((64 - arg1) / 59);
        ++field3401;
    }

    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "(Lkm;Lcj;IIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Lkm;IIZ)Llt;")
    ...
    @OriginalMember(owner = "client!pq", name = "b", descriptor = "(Lkm;I)V")
    ...
    @OriginalMember(owner = "client!pq", name = "d", descriptor = "(Lkm;I)Lto;")
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ILkm;IZILkj;B)V")
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ILkm;I)Lab;")
