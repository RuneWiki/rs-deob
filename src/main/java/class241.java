...
public class class241 extends class312 {
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "(ILea;)Lms;", line = 5)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 42)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lea;I)V", line = 71)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ZILea;I)Z", line = 83)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Z)V", line = 124)
