...
public class class241 {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IZ)[B", line = 6)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "([BIII)Z", line = 95)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(I[BIZI)Z", line = 121)
    ...
    @OriginalMember(owner = "client!rt", name = "toString", descriptor = "()Ljava/lang/String;", line = 259)
    public final String toString() {
        field3424++;
        return "Cache:" + this.field3434;
    }

    @OriginalMember(owner = "client!rt", name = "b", descriptor = "(I)V", line = 268)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(BI)I", line = 295)
    ...
    @OriginalMember(owner = "client!rt", name = "<init>", descriptor = "(ILnn;Lnn;I)V", line = 330)
