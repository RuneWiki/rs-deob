...
public abstract class class241 {
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Luo;[[B[[BBLij;IZ[[III[[BLij;[[B)V", line = 11)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(I)V", line = 296)
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(I)V", line = 318)
