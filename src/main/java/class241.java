...
public class class241 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Llm;ZLlm;I)V")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lil;[[BII[[BLii;[ZIIIII[[BLrc;)V")
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(ILqp;Lqp;I)V")
