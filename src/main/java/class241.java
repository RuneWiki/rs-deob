...
public class class241 extends class739 {
    ...
    @OriginalMember(owner = "client!kea", name = "c", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!kea", name = "e", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(II)[I", line = 44)
    ...
    @OriginalMember(owner = "client!kea", name = "f", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(IIII)V", line = 108)
    ...
    @OriginalMember(owner = "client!kea", name = "g", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(Lsl;II)V", line = 315)
    ...
    @OriginalMember(owner = "client!kea", name = "<init>", descriptor = "()V", line = 348)
    public class241() {
        super(1, true);
    }

    @OriginalMember(owner = "client!kea", name = "b", descriptor = "(II)[I", line = 351)
    ...
    @OriginalMember(owner = "client!kea", name = "c", descriptor = "(II)V", line = 366)
