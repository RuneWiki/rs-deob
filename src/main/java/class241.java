...
public class class241 {
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(BI)Lcc;")
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IILnk;IIB)Ldp;")
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Lci;ILg;)V")
