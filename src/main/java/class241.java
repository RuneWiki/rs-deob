...
public class class241 extends class224 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lwc;B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(ILwc;)Z", line = 53)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Z[B)[B", line = 81)
    ...
    @OriginalMember(owner = "client!bj", name = "h", descriptor = "(I)I", line = 98)
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 112)
