...
public class class241 extends class793 {
    ...
    @OriginalMember(owner = "client!be", name = "g", descriptor = "(I)J", line = 5)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(B)I", line = 15)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(I)I", line = 27)
    public final int method1591(int arg0) {
        int var2 = 37 % ((arg0 - 41) / 41);
        return this.field3329;
    }

    @OriginalMember(owner = "client!be", name = "b", descriptor = "(I)I", line = 36)
    ...
    @OriginalMember(owner = "client!be", name = "e", descriptor = "(I)I", line = 47)
