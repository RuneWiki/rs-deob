...
public class class241 extends class435 {
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Lkh;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Z[III)V", line = 315)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(B)V", line = 329)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(III)Z", line = 346)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(ZII)I", line = 360)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(III[I)V", line = 383)
    ...
    @OriginalMember(owner = "client!ws", name = "b", descriptor = "(III)Z", line = 398)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(IIII)Z", line = 412)
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "(IIIIIIIII)V", line = 428)
