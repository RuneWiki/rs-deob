...
public abstract class class241 {
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(II[FIIZI)V", line = 25)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(B)V", line = 128)
