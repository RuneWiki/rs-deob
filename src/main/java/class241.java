...
public abstract class class241 implements class627 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(FFFFFFLaa;II)V")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(FFIILaa;II)V")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(FFFFIILaa;II)V")
