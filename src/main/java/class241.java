...
public class class241 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(I)Ldt;")
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(BLti;)V")
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(Lti;II)V")
