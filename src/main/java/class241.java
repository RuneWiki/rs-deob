...
public class class241 extends class406 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Luj;I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ij", name = "c", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IB)V", line = 48)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ILtq;)V", line = 63)
