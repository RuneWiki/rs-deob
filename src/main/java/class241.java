...
public class class241 extends class540 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Ljava/awt/Canvas;IIB)V", line = 10)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IIIIBIILjava/awt/Graphics;)V", line = 32)
