...
public class class241 extends class102 {
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(III)[B", line = 6)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "([BI)V", line = 17)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(I)[B", line = 29)
