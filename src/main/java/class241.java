...
public class class241 extends class142 {
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Lpg;IIIZ[I)V")
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Lpg;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Lpg;IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Lpg;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Lpg;IIII[I)V")
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Lpg;IIIII[BI)V")
