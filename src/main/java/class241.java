...
public class class241 implements Runnable {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ILjava/lang/Object;ZII)Lcc;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IILjava/awt/Component;Z)Lcc;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ljava/lang/Class;ILjava/lang/String;[Ljava/lang/Class;)Lcc;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IIIZI)Lcc;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(I)Lcc;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ljava/lang/String;II)Lcc;")
    public final class474 method1333(String arg0, int arg1, int arg2) {
        return arg2 == 1 ? this.method1349(arg0, -8257, arg1, 1, 0) : null;
    }

    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ILjava/lang/Class;)Lcc;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(BLjava/lang/String;)Lcc;")
    public final class474 method1335(byte arg0, String arg1) {
        int var3 = -95 / ((32 - arg0) / 42);
        return this.method1349(arg1, -8257, 0, 21, 0);
    }

    @OriginalMember(owner = "client!ml", name = "b", descriptor = "(ILjava/lang/Class;)Lcc;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ILjava/lang/String;)[B")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(B)Lcc;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(BI)Lcc;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ZILjava/awt/Component;)Lcc;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;I)Lcc;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ljava/lang/String;B)Lcc;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;B)Lcc;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ljava/awt/Frame;I)Lcc;")
    ...
    @OriginalMember(owner = "client!ml", name = "b", descriptor = "(I)Lfc;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ZLjava/net/URL;)Lcc;")
    public final class474 method1348(boolean arg0, URL arg1) {
        return arg0 ? this.method1349(arg1, -8257, 0, 4, 0) : null;
    }

    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ljava/lang/Object;IIII)Lcc;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IILjava/lang/Runnable;)Lcc;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ILjava/awt/Point;I[ILjava/awt/Component;I)Lcc;")
