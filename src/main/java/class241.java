...
public class class241 extends class135 {
    ...
    @OriginalMember(owner = "client!v", name = "f", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(BIIII[B)V", line = 37)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IIIII)V", line = 66)
    ...
    @OriginalMember(owner = "client!v", name = "b", descriptor = "(III)Z", line = 84)
    public final boolean method1759(int arg0, int arg1, int arg2) {
        int var4 = 47 / ((2 - arg2) / 59);
        return (arg0 * arg1) <= this.field3478.length;
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IIIIIII)V", line = 94)
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(Lge;II)V", line = 532)
