...
public class class241 extends class149 {
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(II)[I", line = 5)
    ...
    @OriginalMember(owner = "client!hl", name = "d", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IBLtl;)V", line = 97)
