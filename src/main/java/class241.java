...
public class class241 extends class696 {
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(Lha;ZJ)V")
    ...
    @OriginalMember(owner = "client!aaa", name = "b", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(Lfc;)V")
