...
public class class241 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(CI)Z", line = 5)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "([BI)V", line = 69)
    ...
    @OriginalMember(owner = "client!km", name = "b", descriptor = "(B)V", line = 243)
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "([BI)V", line = 261)
