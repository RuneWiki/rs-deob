...
public class class241 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lam;I)Lv;")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lam;II)Lv;")
    ...
    @OriginalMember(owner = "client!v", name = "b", descriptor = "(Lam;II)[Lv;")
    ...
    @OriginalMember(owner = "client!v", name = "b", descriptor = "(Lam;I)[Lv;")
