...
public class class241 extends class598 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(I)Lvm;", line = 55)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIII)Z", line = 156)
    ...
    @OriginalMember(owner = "client!ko", name = "c", descriptor = "(II)V", line = 172)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IZI)Lnaa;", line = 204)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Z)I", line = 476)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(Z)I", line = 496)
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(ILsaa;Lsaa;Lfs;Ldk;I[BIZ)V", line = 848)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIILvf;Lvf;)V", line = 526)
    ...
    @OriginalMember(owner = "client!ko", name = "c", descriptor = "(Z)V", line = 535)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(II)[B", line = 582)
    ...
    @OriginalMember(owner = "client!ko", name = "f", descriptor = "(I)V", line = 610)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(II)I", line = 793)
    ...
    @OriginalMember(owner = "client!ko", name = "g", descriptor = "(I)I", line = 809)
