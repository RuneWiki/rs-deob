...
public class class241 extends class379 implements class732 {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(I)I", line = 4)
    public final int method1451(int arg0) {
        field2835++;
        return arg0 >= -22 ? -87 : this.field2849;
    }

    @OriginalMember(owner = "client!rt", name = "d", descriptor = "(I)I", line = 18)
    ...
    @OriginalMember(owner = "client!rt", name = "c", descriptor = "(I)C", line = 31)
    ...
    @OriginalMember(owner = "client!rt", name = "g", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(ZILha;I)Lda;", line = 57)
    ...
    @OriginalMember(owner = "client!rt", name = "h", descriptor = "(I)I", line = 74)
    ...
    @OriginalMember(owner = "client!rt", name = "b", descriptor = "(I)J", line = 84)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(B)I", line = 94)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(II)I", line = 106)
    public static int method1459(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!rt", name = "b", descriptor = "(B)V", line = 119)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IIII)V", line = 153)
