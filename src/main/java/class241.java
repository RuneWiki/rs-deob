...
public class class241 extends class328 {
    ...
    @OriginalMember(owner = "client!daa", name = "<init>", descriptor = "()V", line = 114)
    public class241() {
        super(0, true);
    }

    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(BILco;)V", line = 19)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(III[[IIILjava/util/Random;)V", line = 123)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(I)V", line = 325)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(II)[I", line = 345)
    ...
    @OriginalMember(owner = "client!daa", name = "f", descriptor = "(I)V", line = 597)
