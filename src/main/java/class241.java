...
public class class241 extends class130 {
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(II)Lm;", line = 4)
    ...
    @OriginalMember(owner = "client!vl", name = "<init>", descriptor = "(II)V", line = 31)
    public class241(int arg0, int arg1) {
        this.field3614 = arg1;
        this.field3617 = arg0;
    }

    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Laa;)V", line = 45)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(B)V", line = 96)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(ZLhp;)V", line = 110)
