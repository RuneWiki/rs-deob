...
public class class241 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(II)Lsk;", line = 35)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(BII)Z", line = 66)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(Lpo;ILgda;)V", line = 95)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IB)V", line = 116)
