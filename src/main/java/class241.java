...
public class class241 extends class366 {
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(IB)V", line = 19)
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ZLtj;Ltj;)V", line = 51)
    ...
    @OriginalMember(owner = "client!ep", name = "c", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!ep", name = "<init>", descriptor = "(Lrl;Lnl;)V", line = 89)
