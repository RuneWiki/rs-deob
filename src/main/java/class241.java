...
public class class241 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Lji;I)Lmea;", line = 7)
    ...
    @OriginalMember(owner = "client!pd", name = "toString", descriptor = "()Ljava/lang/String;", line = 55)
    public final String toString() {
        field3115++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(III)I", line = 68)
