...
public class class408 extends class219 {
    ...
    @OriginalMember(owner = "client!mi", name = "<init>", descriptor = "()V", line = 104)
    public class408() {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(I)J", line = 43)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!mi", name = "c", descriptor = "(I)J", line = 71)
