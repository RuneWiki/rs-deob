...
public class class408 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Lcc;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Ljava/lang/String;BC)I", line = 37)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(ILria;IZI)V", line = 66)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(B)V", line = 147)
