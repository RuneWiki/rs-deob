...
public class class408 extends class11 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lsi;II)V")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lsk;IZ)V")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(ZLsi;)V")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(ILdr;ILsi;)V")
