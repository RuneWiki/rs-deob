...
public class class408 {
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!rr", name = "toString", descriptor = "()Ljava/lang/String;", line = 20)
    public final String toString() {
        field5365++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!rr", name = "<init>", descriptor = "(I)V", line = 31)
