...
public class class408 extends class646 {
    ...
    @OriginalMember(owner = "client!wp", name = "b", descriptor = "(IB)[I", line = 3)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Lek;IB)V", line = 28)
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IIIIILvo;Z)V", line = 60)
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "()V", line = 99)
    public class408() {
        this(4096);
    }
}
