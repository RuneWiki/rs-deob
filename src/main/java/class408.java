...
public class class408 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IB)Ljg;", line = 6)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(III)Z", line = 37)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IBI)Z", line = 51)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(Lgo;ILns;)V", line = 80)
