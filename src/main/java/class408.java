...
public class class408 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Ljava/lang/String;BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IBI[IIIII)Z", line = 53)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V", line = 148)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIIB)V", line = 175)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIIIIIIII)Z", line = 275)
