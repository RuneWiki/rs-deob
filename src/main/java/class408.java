...
public class class408 extends class756 {
    ...
    @OriginalMember(owner = "client!du", name = "<init>", descriptor = "(IIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(IIIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(I[[[Lfu;)V", line = 259)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(IIB)V", line = 333)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(III)V", line = 353)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(BII)V", line = 379)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(ZIILjava/lang/Object;)[B", line = 398)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(BLjava/util/Random;I)I", line = 434)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Lkl;B)V", line = 465)
