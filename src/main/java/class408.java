...
public class class408 {
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(IILgga;)V")
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(Lgga;I)V")
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(IBZLha;)Lho;")
