...
public class class408 extends class414 {
    ...
    @OriginalMember(owner = "client!gu", name = "E", descriptor = "(III[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!gu", name = "na", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!gu", name = "c", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!gu", name = "HA", descriptor = "()V", line = 54)
    ...
    @OriginalMember(owner = "client!gu", name = "R", descriptor = "(III)V", line = 58)
    ...
    @OriginalMember(owner = "client!gu", name = "ZA", descriptor = "(III)V", line = 68)
    ...
    @OriginalMember(owner = "client!gu", name = "O", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(III[I)V", line = 83)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "()Lia;", line = 90)
    ...
    @OriginalMember(owner = "client!gu", name = "ba", descriptor = "(Lia;)V", line = 109)
    ...
    @OriginalMember(owner = "client!gu", name = "ma", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!gu", name = "X", descriptor = "([I)V", line = 134)
    ...
    @OriginalMember(owner = "client!gu", name = "Q", descriptor = "(IIIIII)V", line = 147)
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "()V", line = 175)
    public class408() {
        this.method964();
    }

    @OriginalMember(owner = "client!gu", name = "YA", descriptor = "(I)V", line = 179)
