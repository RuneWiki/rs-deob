...
public class class408 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(ZLjava/lang/String;Lkea;Z)Lfaa;")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lrt;II)V")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(ILrt;)V")
