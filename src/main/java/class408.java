...
public class class408 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "([ILio;JZ)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(II)Ldm;")
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "(ILgp;Lgp;Lwh;)V")
