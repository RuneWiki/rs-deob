...
public class class408 extends class417 {
    ...
    @OriginalMember(owner = "client!ho", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(BI)I", line = 19)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(I)J", line = 57)
    public final long method1568(int arg0) {
        int var2 = 93 / ((arg0 + 20) / 62);
        return this.field5646;
    }

    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "()V", line = 104)
    public class408() {
        this.field5646 = System.nanoTime();
        this.field5647 = System.nanoTime();
    }

    @OriginalMember(owner = "client!ho", name = "c", descriptor = "(I)J", line = 69)
