...
public class class408 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I)J", line = 3)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(BJ)V", line = 14)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIB[B)I", line = 25)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(III[B)V", line = 39)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(I)Ljava/io/File;", line = 77)
    ...
    @OriginalMember(owner = "client!cs", name = "finalize", descriptor = "()V", line = 89)
