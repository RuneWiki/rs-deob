...
public class class408 {
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "(Lep;)V", line = 535)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lgga;Z)V", line = 76)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(IIIIZ)Z", line = 96)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lgga;I)Z", line = 142)
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!kg", name = "c", descriptor = "(I)V", line = 287)
    ...
    @OriginalMember(owner = "client!kg", name = "d", descriptor = "(I)V", line = 302)
    ...
    @OriginalMember(owner = "client!kg", name = "e", descriptor = "(I)Z", line = 329)
    ...
    @OriginalMember(owner = "client!kg", name = "f", descriptor = "(I)Z", line = 342)
