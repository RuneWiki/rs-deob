...
public class class408 {
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(II)Ljm;")
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(BILje;I)V")
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "(Lgp;ILui;)V")
