...
public abstract class class408 implements class13 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(BLjaggl/MapBuffer;Z)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ljaggl/MapBuffer;Z)Z")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ljaclib/memory/Source;II)Z")
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Lsha;IZ)V")
