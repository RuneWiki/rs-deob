...
public class class408 extends class396 {
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IIJI)V", line = 4)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(BF)V", line = 48)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IF)V", line = 67)
    ...
    @OriginalMember(owner = "client!uo", name = "n", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!uo", name = "t", descriptor = "(I)V", line = 168)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(I)V", line = 185)
    public class408(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!uo", name = "c", descriptor = "(Ljava/lang/String;I)J", line = 193)
