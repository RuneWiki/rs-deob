...
public class class408 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Lta;IIILo;ILfi;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 66)
    public class408(String arg0, int arg1) {
        this.field6035 = arg1;
    }

    @OriginalMember(owner = "client!nj", name = "toString", descriptor = "()Ljava/lang/String;", line = 76)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(B)Z", line = 109)
