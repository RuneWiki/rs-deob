...
public abstract class class408 {
    ...
    @OriginalMember(owner = "client!sc", name = "d", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!sc", name = "e", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Lct;ZLct;)V", line = 92)
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(B)I", line = 112)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(ILva;)I", line = 208)
