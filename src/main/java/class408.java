...
public class class408 extends class618 implements class532 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Loa;BI)Lba;")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(ILoa;ILni;ZZI)V")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Loa;Z)V")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(ILoa;)Ldd;")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(BILoa;I)Z")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(BLoa;)Lpe;")
    ...
    @OriginalMember(owner = "client!ks", name = "<init>", descriptor = "(Loa;Lbd;IIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Loa;B)V")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Loa;IZZ)Lun;")
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(Loa;BI)Lba;")
