...
public class class408 extends class437 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(Z)J", line = 21)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(I)J", line = 31)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(II)I", line = 73)
