...
public class class408 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Ljava/lang/String;Z)I", line = 72)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Lqs;Lqs;Lqs;ILqs;)V", line = 99)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(I)V", line = 120)
