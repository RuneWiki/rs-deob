...
public class class408 {
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(Lkd;)V", line = 62)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(III)I", line = 12)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(ZIIII)Z", line = 25)
