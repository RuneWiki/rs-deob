...
public class class408 implements class241 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IIILza;Lwk;Lrk;Lvp;I)V")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lwk;BLrk;Lza;)V")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lza;Z)V")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ILws;)Z")
