...
public class class408 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(I)Lqha;", line = 6)
    ...
    @OriginalMember(owner = "client!ml", name = "b", descriptor = "(I)Lqha;", line = 30)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!ml", name = "b", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!ml", name = "c", descriptor = "(B)I", line = 80)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ILqha;)V", line = 100)
    ...
    @OriginalMember(owner = "client!ml", name = "d", descriptor = "(B)Z", line = 119)
    ...
    @OriginalMember(owner = "client!ml", name = "e", descriptor = "(B)Lqha;", line = 134)
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "()V", line = 188)
    public class408() {
        this.field5352.field1406 = this.field5352;
        this.field5352.field1407 = this.field5352;
    }

    @OriginalMember(owner = "client!ml", name = "c", descriptor = "(I)Lqha;", line = 160)
