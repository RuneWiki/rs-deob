...
public class class408 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(BILsea;Ljava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(BLsea;)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Lsea;ILjava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Lkb;B)V")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Lsea;I)V")
