...
public class class408 {
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(Llh;)Z")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Llh;Z)V")
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "(Ltb;)V")
