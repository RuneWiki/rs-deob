...
public class class408 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(III)I", line = 4)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(III)V", line = 49)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IIIIII)V", line = 80)
