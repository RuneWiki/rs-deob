...
public class class408 extends class413 {
    ...
    @OriginalMember(owner = "client!ht", name = "ba", descriptor = "(Lia;)V")
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(B)[Ldq;")
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "([[BBLqs;)V")
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(BLia;)V")
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "()Lia;")
