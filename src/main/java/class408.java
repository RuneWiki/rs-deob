...
public class class408 {
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Lk;III)Z")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Lk;IBI)V")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ILk;II)V")
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(Lcb;Lih;)V")
