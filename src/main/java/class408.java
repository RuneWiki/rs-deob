...
public class class408 extends class200 {
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(Ljava/lang/String;BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(Z)V", line = 26)
    ...
    @OriginalMember(owner = "client!hj", name = "<init>", descriptor = "(I)V", line = 37)
    public class408(int arg0) {
        this.field5784 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!hj", name = "d", descriptor = "(B)V", line = 57)
