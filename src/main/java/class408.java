...
public class class408 {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(II)Lo;", line = 31)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IB)V", line = 67)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Z)V", line = 85)
    ...
    @OriginalMember(owner = "client!ua", name = "<init>", descriptor = "(Llo;ILnl;)V", line = 101)
