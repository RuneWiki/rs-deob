...
public class class408 extends InputStream {
    ...
    @OriginalMember(owner = "client!lw", name = "read", descriptor = "()I", line = 15)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 37)
