...
public class class408 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(BF)F", line = 4)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(I)Lmc;", line = 37)
