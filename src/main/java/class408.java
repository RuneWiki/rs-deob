...
public class class408 extends class166 {
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(JLha;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(Lha;ZJII)V", line = 25)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(Lac;Z[IIBIII)Liaa;", line = 289)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(I)V", line = 309)
    ...
    @OriginalMember(owner = "client!qba", name = "b", descriptor = "(I)V", line = 326)
    ...
    @OriginalMember(owner = "client!qba", name = "<init>", descriptor = "(Lha;Lfk;Llba;J)V", line = 418)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(BII)Lsba;", line = 381)
