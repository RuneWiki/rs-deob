...
public class class408 {
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(II[BZ)V", line = 55)
    ...
    @OriginalMember(owner = "client!lv", name = "<init>", descriptor = "(Lfn;II)V", line = 1048)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(IILoa;I)V", line = 190)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(B)Ljava/io/File;", line = 657)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(B[B)V", line = 668)
    ...
    @OriginalMember(owner = "client!lv", name = "b", descriptor = "(I)J", line = 688)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "([BIII)V", line = 702)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(Ljr;I)V", line = 890)
    ...
    @OriginalMember(owner = "client!lv", name = "c", descriptor = "(I)V", line = 937)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(IJ)V", line = 948)
    ...
    @OriginalMember(owner = "client!lv", name = "b", descriptor = "(B)V", line = 969)
