...
public class class408 extends class548 implements class2 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([IIIIIZ)Lfd;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Loia;Z)Lfd;")
    ...
    @OriginalMember(owner = "client!oa", name = "l", descriptor = "()Lih;")
    ...
    @OriginalMember(owner = "client!oa", name = "v", descriptor = "()Lih;")
    ...
    @OriginalMember(owner = "client!oa", name = "h", descriptor = "()Ler;")
    ...
    @OriginalMember(owner = "client!oa", name = "x", descriptor = "()Lih;")
    public final class744 method1385() {
        return this.field5821;
    }

    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(I)Lza;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIF)Ltj;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lik;I)V")
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(II)Lpw;")
    public final class106 method299(int arg0, int arg1) {
        return this.method1471(arg0, arg1, false);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lpw;Llh;)Ldi;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIZ)Lfd;")
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(II)Llh;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lhe;Lhe;FLhe;)Lhe;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lik;Z)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lik;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZ)Lfd;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lej;[Loia;Z)Lda;")
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(IIIIII)Lhe;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lih;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[Ltj;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lhe;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lvo;IIII)Lka;")
