...
public class class408 extends class436 {
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Laj;IIILto;[[B[[BLaa;IIII[[B[Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 485)
    ...
    @OriginalMember(owner = "client!bs", name = "d", descriptor = "(I)V", line = 544)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Z)V", line = 555)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(II[BIILjava/lang/String;)I", line = 571)
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "()V", line = 713)
    public class408() {
        super(0, true);
    }

    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(II)[I", line = 716)
    ...
    @OriginalMember(owner = "client!bs", name = "f", descriptor = "(I)V", line = 840)
    ...
    @OriginalMember(owner = "client!bs", name = "g", descriptor = "(I)V", line = 871)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IILeb;)V", line = 883)
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(III)I", line = 927)
