...
public class class408 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(B)Lo;", line = 3)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(I)Lo;", line = 23)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(I)Lo;", line = 44)
    ...
    @OriginalMember(owner = "client!mi", name = "c", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(ILmi;)V", line = 81)
    ...
    @OriginalMember(owner = "client!mi", name = "d", descriptor = "(I)I", line = 91)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(Lmi;Lo;I)V", line = 112)
    ...
    @OriginalMember(owner = "client!mi", name = "e", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(CI)Z", line = 164)
    ...
    @OriginalMember(owner = "client!mi", name = "<init>", descriptor = "()V", line = 247)
    public class408() {
        this.field6108.field5898 = this.field6108;
        this.field6108.field5895 = this.field6108;
    }

    @OriginalMember(owner = "client!mi", name = "f", descriptor = "(I)Lo;", line = 216)
    ...
    @OriginalMember(owner = "client!mi", name = "g", descriptor = "(I)Z", line = 236)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(Lo;I)V", line = 268)
    ...
    @OriginalMember(owner = "client!mi", name = "h", descriptor = "(I)Lo;", line = 290)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(BLo;)V", line = 315)
    ...
    @OriginalMember(owner = "client!mi", name = "i", descriptor = "(I)V", line = 336)
