...
public class class408 extends class751 {
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "()V", line = 3)
    public class408() {
        super(1, true);
    }

    @OriginalMember(owner = "client!fu", name = "b", descriptor = "(II)V", line = 7)
    ...
    @OriginalMember(owner = "client!fu", name = "c", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!fu", name = "e", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(II)[I", line = 92)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(ILrv;I)V", line = 164)
