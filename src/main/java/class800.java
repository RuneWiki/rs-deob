...
public class class800 extends class122 implements class675 {
    ...
    @OriginalMember(owner = "client!eq", name = "c", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Lha;Lfw;IIIIIZII)V", line = 15)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ILon;)I", line = 25)
    ...
    @OriginalMember(owner = "client!eq", name = "d", descriptor = "(Z)Z", line = 70)
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(ZLha;)Lrs;", line = 87)
    ...
    @OriginalMember(owner = "client!eq", name = "e", descriptor = "(Z)Z", line = 140)
    ...
    @OriginalMember(owner = "client!eq", name = "c", descriptor = "(I)I", line = 151)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Lha;III)Z", line = 162)
    ...
    @OriginalMember(owner = "client!eq", name = "d", descriptor = "(B)V", line = 181)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ILha;)V", line = 195)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ZLha;)V", line = 206)
    ...
    @OriginalMember(owner = "client!eq", name = "c", descriptor = "(Z)I", line = 217)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 228)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Z)I", line = 261)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Lha;B)Lsba;", line = 272)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(I)Z", line = 285)
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(I)I", line = 300)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(BLao;)V", line = 311)
    ...
    @OriginalMember(owner = "client!eq", name = "g", descriptor = "(I)Z", line = 329)
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(Z)V", line = 341)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IBILrfa;ZILha;)V", line = 353)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Lha;I)V", line = 363)
