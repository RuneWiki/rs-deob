...
public class class708 extends class100 implements class258 {
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(Lha;Liv;IIIIIZIIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(I)I", line = 39)
    ...
    @OriginalMember(owner = "client!ge", name = "c", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lha;III)Z", line = 65)
    ...
    @OriginalMember(owner = "client!ge", name = "c", descriptor = "(Lha;I)V", line = 90)
    ...
    @OriginalMember(owner = "client!ge", name = "d", descriptor = "(I)I", line = 100)
    public final int method588(int arg0) {
        ++field9614;
        return arg0 != -32228 ? 1 : this.field9589;
    }

    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(Z)V", line = 112)
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(Lha;I)Lhw;", line = 127)
    ...
    @OriginalMember(owner = "client!ge", name = "e", descriptor = "(I)I", line = 142)
    public final int method589(int arg0) {
        ++field9615;
        return arg0 > -62 ? -96 : this.field9608 & 65535;
    }

    @OriginalMember(owner = "client!ge", name = "i", descriptor = "(I)I", line = 155)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(I)Z", line = 166)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lha;IZLga;IBI)V", line = 180)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ILha;)V", line = 214)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ZIILha;)Lak;", line = 245)
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(ILha;)Ljda;", line = 276)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lha;BI)Lka;", line = 300)
    ...
    @OriginalMember(owner = "client!ge", name = "c", descriptor = "(Z)I", line = 325)
    ...
    @OriginalMember(owner = "client!ge", name = "j", descriptor = "(I)Z", line = 343)
    public final boolean method35(int arg0) {
        ++field9616;
        return arg0 > -65 ? true : this.field9617;
    }

    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(B)Z", line = 355)
    ...
    @OriginalMember(owner = "client!ge", name = "g", descriptor = "(I)Z", line = 370)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lha;I)V", line = 387)
