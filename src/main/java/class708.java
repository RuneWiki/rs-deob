...
public class class708 extends class154 implements class349 {
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!nfa", name = "c", descriptor = "(B)Lcl;", line = 14)
    ...
    @OriginalMember(owner = "client!nfa", name = "b", descriptor = "(I)I", line = 56)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Z)I", line = 70)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(I)J", line = 89)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(BLkh;ZII)V", line = 100)
    ...
    @OriginalMember(owner = "client!nfa", name = "c", descriptor = "(I)C", line = 182)
