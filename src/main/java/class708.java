...
public class class708 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(II)V", line = 20)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "([ILkc;[II[I)V", line = 60)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(BLvj;)Lida;", line = 162)
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(II)Lbq;", line = 196)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ZI)V", line = 238)
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Lwj;ILwu;Lwu;)V", line = 269)
