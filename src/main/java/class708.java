...
public class class708 {
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Z)V", line = 157)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(BI)V", line = 173)
