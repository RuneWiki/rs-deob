...
public class class708 extends class61 {
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "(Ljf;Lmv;[Ltw;[I[I)V")
    ...
    @OriginalMember(owner = "client!ki", name = "fa", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(CIIIZLaa;II)V")
