...
public class class708 {
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(Lrba;B)V", line = 28)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(IIZ)B", line = 50)
    ...
    @OriginalMember(owner = "client!wca", name = "b", descriptor = "(I)Lrba;", line = 69)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(Loi;I)V", line = 97)
    ...
    @OriginalMember(owner = "client!wca", name = "<init>", descriptor = "()V", line = 195)
    public class708() {
        try {
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(Z)I", line = 142)
    ...
    @OriginalMember(owner = "client!wca", name = "b", descriptor = "(B)Lrba;", line = 163)
    ...
    @OriginalMember(owner = "client!wca", name = "c", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(B)Lrba;", line = 205)
