...
public class class708 {
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(II)Ljp;", line = 34)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!ufa", name = "<init>", descriptor = "(Ldt;ILwia;)V", line = 90)
