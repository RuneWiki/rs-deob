...
public class class708 {
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(Lmca;)V")
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(JI)Lbo;")
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(JBLbo;)V")
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(Ljq;IZ)V")
