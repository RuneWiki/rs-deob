...
public class class708 extends class126 {
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "(Lada;Loe;IIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lsha;I)Lsha;")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(I)Lof;")
