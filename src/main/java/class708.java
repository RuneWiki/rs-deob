...
public class class708 extends class513 {
    ...
    @OriginalMember(owner = "client!gi", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(CBLjava/lang/String;)[Ljava/lang/String;", line = 23)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(III[BIII)Z", line = 64)
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(II[I[I)V", line = 108)
