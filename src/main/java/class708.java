...
public class class708 extends class94 implements class60 {
    ...
    @OriginalMember(owner = "client!rw", name = "c", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(B)I", line = 21)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(I)J", line = 36)
    public final long method492(int arg0) {
        ++field9930;
        return arg0 >= -80 ? 76L : 0L;
    }

    @OriginalMember(owner = "client!rw", name = "d", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(IIZ[B)V", line = 58)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(Z)I", line = 74)
    ...
    @OriginalMember(owner = "client!rw", name = "<init>", descriptor = "(Lno;I[BIZ)V", line = 85)
    public class708(class658 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34963, arg2, arg3, arg4);
        this.field9928 = arg1;
    }

    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(IZZI)I", line = 94)
