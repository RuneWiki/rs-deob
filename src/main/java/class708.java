...
public class class708 extends class112 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "()I", line = 3)
    public final int method777() {
        field9989++;
        return this.field9974.field10474;
    }

    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IB)V", line = 13)
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(Lkv;IIZ)V", line = 734)
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(Lkv;IIII)V", line = 744)
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(Lkv;II[III)V", line = 754)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IILaa;II)V", line = 52)
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(IIII)V", line = 112)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IIIII)V", line = 124)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IIII[III)V", line = 176)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IIIIII)V", line = 187)
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(IIIIIII)V", line = 217)
    ...
    @OriginalMember(owner = "client!qf", name = "d", descriptor = "()I", line = 354)
    public final int method792() {
        field9966++;
        return this.field9983 + this.field9980 + this.field9974.field10470;
    }

    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(III)V", line = 368)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(FFFFFFIIII)V", line = 385)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(FFFFFFILaa;II)V", line = 453)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(III)V", line = 539)
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "()I", line = 564)
    public final int method781() {
        field9968++;
        return this.field9974.field10474 + this.field9977 + this.field9988;
    }

    @OriginalMember(owner = "client!qf", name = "a", descriptor = "([I)V", line = 573)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IIIIIIII)V", line = 589)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(I)V", line = 693)
    ...
    @OriginalMember(owner = "client!qf", name = "c", descriptor = "()I", line = 709)
