...
public class class708 extends class463 {
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(B[B)V", line = 7)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(III)[B", line = 19)
    ...
    @OriginalMember(owner = "client!pw", name = "b", descriptor = "(B)[B", line = 32)
