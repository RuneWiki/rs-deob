...
public class class708 extends class667 {
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ega", name = "<init>", descriptor = "()V", line = 13)
    public class708() {
        super(0, false);
    }

    @OriginalMember(owner = "client!ega", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!ega", name = "c", descriptor = "(Z)I", line = 30)
    ...
    @OriginalMember(owner = "client!ega", name = "c", descriptor = "(I)Z", line = 42)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(ZI)[[I", line = 71)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Lud;II)V", line = 147)
