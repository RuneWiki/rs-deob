...
public class class708 {
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(III)I", line = 4)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(Lji;)V", line = 25)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "()V", line = 91)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(II)[I", line = 116)
