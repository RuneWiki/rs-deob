...
public class class708 extends class487 {
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Lrs;IIZ[[I)V", line = 18)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IIIII)V", line = 49)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IIBILjava/lang/String;III)V", line = 64)
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Lrs;IIZ[[BI)V", line = 93)
    ...
    @OriginalMember(owner = "client!io", name = "c", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(B)V", line = 131)
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Lrs;II)V", line = 150)
