...
public class class708 extends class497 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(Ldia;Lmha;)V", line = 74)
    ...
    @OriginalMember(owner = "client!gi", name = "d", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!gi", name = "b", descriptor = "(ZZ)V", line = 153)
    ...
    @OriginalMember(owner = "client!gi", name = "e", descriptor = "(I)V", line = 201)
    ...
    @OriginalMember(owner = "client!gi", name = "b", descriptor = "(I)Z", line = 213)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IZ)V", line = 224)
    ...
    @OriginalMember(owner = "client!gi", name = "c", descriptor = "(I)V", line = 240)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ILil;I)V", line = 258)
