...
public class class708 extends class682 {
    ...
    @OriginalMember(owner = "client!mga", name = "b", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(Ltha;II)V", line = 16)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(IBI)V", line = 48)
    ...
    @OriginalMember(owner = "client!mga", name = "<init>", descriptor = "(Lnv;)V", line = 137)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(IZ)V", line = 71)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(BZ)V", line = 82)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(Z)Z", line = 109)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(BC)Z", line = 121)
