...
public class class708 extends class121 implements class274 {
    ...
    @OriginalMember(owner = "client!wia", name = "<init>", descriptor = "(Lha;Lih;IIIIIZIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(Lha;ZII)Lsa;", line = 26)
    ...
    @OriginalMember(owner = "client!wia", name = "d", descriptor = "(B)Z", line = 57)
    ...
    @OriginalMember(owner = "client!wia", name = "c", descriptor = "(ILha;)Lid;", line = 75)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(IILha;I)Z", line = 92)
    ...
    @OriginalMember(owner = "client!wia", name = "b", descriptor = "(ILha;)Lpi;", line = 112)
    ...
    @OriginalMember(owner = "client!wia", name = "c", descriptor = "(B)V", line = 138)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(B)Z", line = 152)
    ...
    @OriginalMember(owner = "client!wia", name = "b", descriptor = "(B)I", line = 166)
    ...
    @OriginalMember(owner = "client!wia", name = "e", descriptor = "(I)I", line = 178)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(ILha;)V", line = 197)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(Lha;I)V", line = 227)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(I)I", line = 238)
    ...
    @OriginalMember(owner = "client!wia", name = "c", descriptor = "(Z)Z", line = 249)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(Lha;II)Lka;", line = 265)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(Z)I", line = 286)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(ILft;I[I)V", line = 298)
    ...
    @OriginalMember(owner = "client!wia", name = "e", descriptor = "(B)I", line = 388)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(BLha;)V", line = 402)
