...
public class class191 extends class652 {
    ...
    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(Z)Lof;", line = 4)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(I)I", line = 100)
    ...
    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(B)I", line = 115)
    ...
    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(I)V", line = 135)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(II)V", line = 154)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Lrt;I)I", line = 184)
    ...
    @OriginalMember(owner = "client!bd", name = "c", descriptor = "(B)I", line = 234)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IB)[B", line = 259)
    ...
    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(II)I", line = 284)
    ...
    @OriginalMember(owner = "client!bd", name = "d", descriptor = "(B)I", line = 302)
    ...
    @OriginalMember(owner = "client!bd", name = "c", descriptor = "(I)V", line = 316)
    ...
    @OriginalMember(owner = "client!bd", name = "c", descriptor = "(Z)V", line = 499)
    ...
    @OriginalMember(owner = "client!bd", name = "<init>", descriptor = "(ILat;Lat;Lql;Lmv;I[BIZ)V", line = 867)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IILda;II)Llf;", line = 558)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(III)Lng;", line = 580)
