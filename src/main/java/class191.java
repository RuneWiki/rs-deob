...
public class class191 {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(ILtq;I)V")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lt;IIIII)V")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lam;ILam;)I")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IIILtq;)V")
