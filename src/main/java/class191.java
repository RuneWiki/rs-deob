...
public class class191 extends class375 {
    ...
    @OriginalMember(owner = "client!su", name = "d", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!su", name = "e", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(I)I", line = 34)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IIIIIIILcp;III)Z", line = 51)
    ...
    @OriginalMember(owner = "client!su", name = "c", descriptor = "(I)J", line = 410)
    public final long method1288(int arg0) {
        ++field2759;
        return arg0 != -7415 ? 127L : super.field5344 & Long.MAX_VALUE;
    }

    @OriginalMember(owner = "client!su", name = "f", descriptor = "(B)V", line = 422)
    ...
    @OriginalMember(owner = "client!su", name = "e", descriptor = "(I)I", line = 433)
    public final int method1290(int arg0) {
        ++field2762;
        return arg0 != 8 ? -21 : (int) super.field9386;
    }

    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "(II)V", line = 448)
