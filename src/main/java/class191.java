...
public class class191 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(IIIIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(BI)V", line = 39)
    ...
    @OriginalMember(owner = "client!fe", name = "<init>", descriptor = "(I)V", line = 49)
