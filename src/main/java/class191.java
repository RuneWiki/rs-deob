...
public class class191 {
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(III)V", line = 23)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IIBIIII)V", line = 48)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(B)V", line = 122)
