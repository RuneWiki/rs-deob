...
public class class191 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Lir;Z)V", line = 100)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(BII)Z", line = 130)
