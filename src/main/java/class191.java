...
public class class191 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(ILza;)V")
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(ILza;)V")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(ILza;BZZII)Le;")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IILza;ZLe;III)V")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(I[Lo;)V")
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lza;Lii;IIIIIIZI)V")
