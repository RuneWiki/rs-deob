...
public class class191 extends class214 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(ILjava/lang/String;)I", line = 4)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IIIIZIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "()V", line = 148)
    public class191() {
        super(0, true);
    }

    @OriginalMember(owner = "client!el", name = "a", descriptor = "(BI)[I", line = 152)
    ...
    @OriginalMember(owner = "client!el", name = "f", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!el", name = "g", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!el", name = "c", descriptor = "(Z)Lji;", line = 214)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IILms;)Ljava/lang/String;", line = 241)
