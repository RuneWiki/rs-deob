...
public class class191 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "()V", line = 5)
    public static void method1339() {
        field2800 = null;
    }

    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lya;Ljava/lang/String;[IIIIZ)V", line = 8)
    ...
    @OriginalMember(owner = "client!sb", name = "b", descriptor = "()I", line = 29)
    public final int method1341() {
        return this.field2795 - 1;
    }

    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Lya;IZLjava/awt/Component;)V", line = 172)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lya;Ljava/lang/String;IIIZ)V", line = 38)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Ljava/lang/String;)I", line = 57)
    ...
    @OriginalMember(owner = "client!sb", name = "c", descriptor = "()I", line = 72)
    public final int method1344() {
        return this.field2798;
    }

    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lya;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 76)
