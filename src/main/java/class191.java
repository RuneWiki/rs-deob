...
public class class191 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(JI)Lge;")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Lge;JI)V")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(B)Lge;")
    ...
    @OriginalMember(owner = "client!dj", name = "b", descriptor = "(I)Lge;")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Lpl;IIII)V")
    ...
    @OriginalMember(owner = "client!dj", name = "c", descriptor = "(I)Lge;")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "([Lge;I)I")
