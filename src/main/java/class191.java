...
public class class191 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "()Lck;")
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lmg;II)Lsb;")
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Lsi;)V")
