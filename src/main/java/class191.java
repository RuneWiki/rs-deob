...
public class class191 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(I)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IIII)Loi;", line = 22)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(II)V", line = 84)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(B)Ltw;", line = 99)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!op", name = "c", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ILji;I)V", line = 158)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ZLji;)V", line = 183)
