...
public class class191 implements class370 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(B)Lui;")
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Lwda;Lui;Z)V")
