...
public class class191 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 34)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IIBIII)V", line = 55)
