...
public class class191 extends class392 {
    ...
    @OriginalMember(owner = "client!pv", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!pv", name = "<init>", descriptor = "(Lw;)V", line = 14)
    public class191(class675 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!pv", name = "<init>", descriptor = "(ILw;)V", line = 18)
    public class191(int arg0, class675 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!pv", name = "b", descriptor = "(II)I", line = 27)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(III)Z", line = 44)
    ...
    @OriginalMember(owner = "client!pv", name = "b", descriptor = "(Z)V", line = 55)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(BI)V", line = 69)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(Z)I", line = 106)
