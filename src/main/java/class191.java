...
public class class191 extends class13 {
    ...
    @OriginalMember(owner = "client!dj", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Lms;Luo;Z)V", line = 26)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Lnq;I)I", line = 42)
    ...
    @OriginalMember(owner = "client!dj", name = "<init>", descriptor = "()V", line = 184)
    public class191() {
        super(0, true);
    }

    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Lkh;BI)V", line = 115)
    ...
    @OriginalMember(owner = "client!dj", name = "e", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(I[IJI)Ljava/lang/String;", line = 188)
    ...
    @OriginalMember(owner = "client!dj", name = "f", descriptor = "(I)V", line = 210)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(ZI)[I", line = 228)
