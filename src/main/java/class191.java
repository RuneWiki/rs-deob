...
public class class191 extends class337 {
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(BLuo;)V", line = 21)
    ...
    @OriginalMember(owner = "client!bm", name = "b", descriptor = "(II)I", line = 31)
    public static int method1183(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Luo;IIZ)Z", line = 40)
    ...
    @OriginalMember(owner = "client!bm", name = "c", descriptor = "(Luo;B)Lkj;", line = 80)
