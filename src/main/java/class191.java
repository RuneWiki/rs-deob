...
public class class191 extends class366 implements class162 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(BLcw;)V", line = 11)
    public final void method280(byte arg0, class144 arg1) {
        int var3 = -75 % ((arg0 - 18) / 60);
        super.method280((byte) -75, arg1);
    }

    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Lsga;Lpb;III[B)V", line = 18)
    ...
    @OriginalMember(owner = "client!an", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 89)
    ...
    @OriginalMember(owner = "client!an", name = "b", descriptor = "(I)V", line = 99)
