...
public class class191 extends class276 {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IIIZIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IZLhd;Lhd;ZII)I", line = 36)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "(I[B)V", line = 89)
