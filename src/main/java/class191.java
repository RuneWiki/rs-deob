...
public class class191 extends class445 {
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(Z)V", line = 121)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IIIIIIIILdg;II)Z", line = 161)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "([BLbk;I[I)Z", line = 509)
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "()V", line = 578)
    public class191() {
    }

    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "([B)V", line = 580)
