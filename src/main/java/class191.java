...
public class class191 extends class18 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lha;J)V")
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Leu;IIIIIIIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "(Leu;IIIIIIIIIIIZZ)V")
