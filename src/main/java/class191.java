...
public class class191 extends IOException {
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(JB)V", line = 3)
    ...
    @OriginalMember(owner = "client!dga", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 18)
    public class191(String arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(B)V", line = 25)
