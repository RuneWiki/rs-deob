...
public class class191 extends class615 {
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "()V", line = 3)
    public class191() {
        super(1, false);
    }

    @OriginalMember(owner = "client!oc", name = "f", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(II)V", line = 18)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IIIIIIIIII)V", line = 36)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Z)V", line = 111)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IB)[I", line = 123)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IIIIII)V", line = 156)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(II)[[I", line = 175)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(BILeh;)V", line = 230)
