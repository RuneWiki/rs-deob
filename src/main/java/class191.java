...
public class class191 extends class307 {
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(IIIIIF)V", line = 3)
    public class191(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!ei", name = "g", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(BF)V", line = 31)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IIII)V", line = 44)
