...
public class class191 extends class476 {
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "(Lti;)V", line = 141)
    public class191(class237 arg0) {
        this.field2786 = arg0;
    }

    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(III)Z", line = 39)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(III)Loa;", line = 60)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Z)V", line = 94)
    ...
    @OriginalMember(owner = "client!fh", name = "c", descriptor = "(III)V", line = 125)
