...
public class class191 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Ljagdx/IDirect3DSurface;Ljagdx/IDirect3DSwapChain;B)V")
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V")
