...
public class class191 extends class305 {
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!kk", name = "c", descriptor = "(I)I", line = 19)
    public final int method1327(int arg0) {
        ++field2887;
        return arg0 != 17503 ? 3 : super.field4320;
    }

    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(III)Z", line = 30)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(ILhb;)V", line = 42)
    public class191(int arg0, class728 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!kk", name = "c", descriptor = "(II)I", line = 46)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(II)V", line = 82)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(Lhb;)V", line = 94)
    public class191(class728 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(B)I", line = 97)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(B)V", line = 108)
    ...
    @OriginalMember(owner = "client!kk", name = "d", descriptor = "(I)Z", line = 137)
