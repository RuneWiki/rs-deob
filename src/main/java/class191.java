...
public class class191 {
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(ILhp;)V", line = 9)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(Ljava/lang/Object;ZI)[B", line = 30)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(IIBIIII)V", line = 81)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(BILhp;)V", line = 125)
    ...
    @OriginalMember(owner = "client!uu", name = "b", descriptor = "(I)V", line = 164)
