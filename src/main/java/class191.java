...
public class class191 extends class85 {
    ...
    @OriginalMember(owner = "client!ug", name = "V", descriptor = "Llf;")
    public static class109 field3653 = class35.method275("leuchten3:", 2);

    @OriginalMember(owner = "client!ug", name = "Y", descriptor = "Lrc;")
    public static class160 field3656 = new class160(64);

    @OriginalMember(owner = "client!ug", name = "eb", descriptor = "Llf;")
    public static class109 field3662 = class35.method275("(U3", 2);

    @OriginalMember(owner = "client!ug", name = "Z", descriptor = "Llf;")
    public static class109 field3657 = class35.method275(":assistreq:", 2);

    @OriginalMember(owner = "client!ug", name = "cb", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ug", name = "fb", descriptor = "Llf;")
    public static class109 field3663 = class35.method275("b12_full", 2);

    @OriginalMember(owner = "client!ug", name = "db", descriptor = "Llf;")
    private static class109 field3661 = class35.method275("You have only just left another world)3", 2);

    @OriginalMember(owner = "client!ug", name = "ab", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(BILja;)V")
