...
public class class191 extends class101 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IZI)V", line = 32)
