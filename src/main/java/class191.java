...
public class class191 extends class335 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(JIIZI)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ILio;I)V", line = 81)
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(Z)V", line = 122)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(BII)V", line = 161)
    ...
    @OriginalMember(owner = "client!qf", name = "c", descriptor = "(B)V", line = 176)
    ...
    @OriginalMember(owner = "client!qf", name = "d", descriptor = "(III)V", line = 190)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ZI)[I", line = 264)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IZ)[[I", line = 297)
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "()V", line = 348)
    public class191() {
        super(1, false);
    }
}
