...
public class class191 extends class28 {
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!ega", name = "<init>", descriptor = "([B)V", line = 11)
    public class191(byte[] arg0) {
        this.field2484 = arg0;
    }

    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(IIII)I", line = 21)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(III)Z", line = 32)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(I)V", line = 43)
