...
public class class191 extends class359 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IIIIILjf;II)V")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(I[[[BIILen;IIIIBIII)V")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IILen;Lac;[[B[[B[[BZLac;I[[BI[[I)V")
