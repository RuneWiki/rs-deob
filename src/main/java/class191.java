...
public class class191 extends class159 {
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(BZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Z)Z", line = 15)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IIIIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Lwu;II)V", line = 45)
    ...
    @OriginalMember(owner = "client!ue", name = "<init>", descriptor = "(Ldw;)V", line = 100)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(ZII)V", line = 67)
    ...
    @OriginalMember(owner = "client!ue", name = "b", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(ZB)V", line = 139)
