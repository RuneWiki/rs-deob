...
public class class191 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IZLcf;Lcf;I)I", line = 4)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(BI)Ljava/lang/String;", line = 116)
