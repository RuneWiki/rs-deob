...
public class class191 extends class540 {
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Luq;Luq;Lpca;)V", line = 6)
    public class191(class172 arg0, class172 arg1, class744 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ZIII)V", line = 12)
    ...
    @OriginalMember(owner = "client!sq", name = "d", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIZI)V", line = 40)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IB)Z", line = 52)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 69)
