...
public class class191 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IILoj;)Z")
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IIIIILoj;IIII)V")
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "(I[Llq;IIII)V")
