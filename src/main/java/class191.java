...
public class class191 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(B)Lmh;")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(I)Lmh;")
    ...
    @OriginalMember(owner = "client!dj", name = "<init>", descriptor = "(Lbr;)V")
