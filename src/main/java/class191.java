...
public class class191 extends class189 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "([SBI)[S", line = 5)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(III[I)Z", line = 19)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 246)
    ...
    @OriginalMember(owner = "client!ao", name = "c", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIB[I)Z", line = 137)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(BI[III)Z", line = 168)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(BII)Z", line = 198)
