...
public class class191 {
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Llh;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(III)I", line = 52)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ILvd;)Z", line = 78)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Llh;II)V", line = 127)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ILqa;)Lf;", line = 307)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Ljava/lang/String;ZI)Ljava/lang/String;", line = 337)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(B)V", line = 376)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(I)V", line = 388)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ZBLqa;)Lf;", line = 430)
