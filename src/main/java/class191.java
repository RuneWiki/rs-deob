...
public class class191 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ILap;)Lno;", line = 91)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Ljava/lang/String;CI)I", line = 115)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ILpe;Lwe;IIIII)Lkb;", line = 141)
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(B)V", line = 161)
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "()V", line = 178)
    public class191() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ILap;[B)V", line = 191)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(II)I", line = 228)
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(III)V", line = 240)
