...
public class class734 extends class334 {
    ...
    @OriginalMember(owner = "client!jka", name = "a", descriptor = "(Lnfa;ZZ)V")
    ...
    @OriginalMember(owner = "client!jka", name = "a", descriptor = "(Lnba;IIII)V")
    ...
    @OriginalMember(owner = "client!jka", name = "a", descriptor = "(IZLol;)V")
