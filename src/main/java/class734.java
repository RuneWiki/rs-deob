...
public class class734 extends class539 {
    ...
    @OriginalMember(owner = "client!jka", name = "c", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!jka", name = "<init>", descriptor = "(Lpq;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!jka", name = "<init>", descriptor = "(Lpq;II)V")
    ...
    @OriginalMember(owner = "client!jka", name = "<init>", descriptor = "(Lpq;IIZ[[BI)V")
