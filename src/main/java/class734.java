...
public class class734 extends class155 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Lbea;IZI)J")
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(Loia;Lgj;Luw;)V")
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Lbr;II)V")
