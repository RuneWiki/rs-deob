...
public class class734 {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(I[Lac;)V", line = 16)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Lug;Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "(Lug;)V", line = 79)
    public class734(class453 arg0) {
        this.field10275 = arg0.field6347;
        this.field10268 = 1;
    }

    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "([Lug;)V", line = 87)
    public class734(class453[] arg0) {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IB)I", line = 101)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IIIIIZI)V", line = 114)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(IB)Lug;", line = 131)
