...
public class class734 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(BLjp;)V", line = 25)
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "(Laj;)V", line = 78)
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "()V", line = 90)
    protected class734() {
