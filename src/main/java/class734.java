...
public class class734 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IZ)Lrn;", line = 25)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(B)V", line = 61)
    public static void method4086(byte arg0) {
        int var1 = -10 % ((arg0 - 65) / 40);
        field10292 = null;
    }

    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IIZ)V", line = 71)
    ...
    @OriginalMember(owner = "client!le", name = "b", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!le", name = "b", descriptor = "(IZ)V", line = 102)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(III)Z", line = 120)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "(Lmp;ILla;Lla;)V", line = 166)
