...
public class class734 extends class41 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Loga;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(ILes;)V", line = 17)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Lcf;ZIIZLcf;I)I", line = 35)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(I)V", line = 74)
