...
public abstract class class734 extends class362 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(ZI)I", line = 4)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V", line = 65)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Ljava/lang/String;IZI)V", line = 84)
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 201)
    public class734(OggStreamState arg0) {
        this.field9906 = arg0;
    }

    @OriginalMember(owner = "client!au", name = "a", descriptor = "(IIZ)V", line = 209)
