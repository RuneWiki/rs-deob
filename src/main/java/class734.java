...
public class class734 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ILvw;)Z")
    ...
    @OriginalMember(owner = "client!ip", name = "b", descriptor = "(ILvw;)V")
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ILic;BI)V")
    ...
    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "(Lffa;)V")
