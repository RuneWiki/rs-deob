...
public class class734 extends class322 {
    ...
    @OriginalMember(owner = "client!sia", name = "b", descriptor = "(B)V", line = 3)
    public static void method4105(byte arg0) {
        field10229 = null;
        int var1 = 1 % ((31 - arg0) / 33);
    }

    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(I[I[ILkd;[I)V", line = 14)
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(Lfp;I)V", line = 115)
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(B)I", line = 144)
    ...
    @OriginalMember(owner = "client!sia", name = "b", descriptor = "(Z)I", line = 164)
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(Z)V", line = 176)
    ...
    @OriginalMember(owner = "client!sia", name = "<init>", descriptor = "(Lch;)V", line = 198)
    public class734(class463 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!sia", name = "b", descriptor = "(BI)V", line = 201)
    ...
    @OriginalMember(owner = "client!sia", name = "b", descriptor = "(II)V", line = 214)
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(II)I", line = 225)
    ...
    @OriginalMember(owner = "client!sia", name = "<init>", descriptor = "(ILch;)V", line = 248)
    public class734(int arg0, class463 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!sia", name = "c", descriptor = "(B)Z", line = 253)
