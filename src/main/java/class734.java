...
public class class734 extends class86 {
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!jfa", name = "b", descriptor = "(II)I", line = 21)
    public final int method72(int arg0, int arg1) {
        ++field9965;
        return arg1 != -2 ? -46 : 1;
    }

    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Z)I", line = 32)
    ...
    @OriginalMember(owner = "client!jfa", name = "b", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!jfa", name = "b", descriptor = "(I)I", line = 96)
    ...
    @OriginalMember(owner = "client!jfa", name = "<init>", descriptor = "(ILsf;)V", line = 110)
    public class734(int arg0, class551 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!jfa", name = "<init>", descriptor = "(Lsf;)V", line = 115)
    public class734(class551 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(IZ)V", line = 121)
    ...
    @OriginalMember(owner = "client!jfa", name = "c", descriptor = "(B)V", line = 132)
    ...
    @OriginalMember(owner = "client!jfa", name = "d", descriptor = "(B)V", line = 145)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Ljava/io/File;BI)[B", line = 227)
    ...
    @OriginalMember(owner = "client!jfa", name = "c", descriptor = "(I)I", line = 249)
