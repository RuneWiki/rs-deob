...
public class class734 extends class466 implements class523 {
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(IIILfp;Lfp;)V", line = 5)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(B)Z", line = 65)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(I)I", line = 78)
    ...
    @OriginalMember(owner = "client!vba", name = "c", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(ILha;ZB)Leo;", line = 111)
    ...
    @OriginalMember(owner = "client!vba", name = "<init>", descriptor = "(Lha;Ljl;IIIIIZIIII)V", line = 144)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(Lha;I)Lkn;", line = 167)
    ...
    @OriginalMember(owner = "client!vba", name = "b", descriptor = "(I)I", line = 182)
    public final int method87(int arg0) {
        ++field10325;
        return arg0 != 2836 ? 69 : this.field10332 & 65535;
    }

    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(Ljava/lang/String;ZIZ)V", line = 195)
    ...
    @OriginalMember(owner = "client!vba", name = "k", descriptor = "(I)Z", line = 1190)
    ...
    @OriginalMember(owner = "client!vba", name = "b", descriptor = "(ILha;)Lgh;", line = 1205)
    ...
    @OriginalMember(owner = "client!vba", name = "j", descriptor = "(I)I", line = 1231)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(IILha;I)Z", line = 1242)
    ...
    @OriginalMember(owner = "client!vba", name = "b", descriptor = "(Lha;I)V", line = 1266)
    ...
    @OriginalMember(owner = "client!vba", name = "b", descriptor = "(B)I", line = 1277)
    ...
    @OriginalMember(owner = "client!vba", name = "i", descriptor = "(I)Z", line = 1298)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(Lha;Z)V", line = 1313)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(Lha;ZI)Lka;", line = 1341)
    ...
    @OriginalMember(owner = "client!vba", name = "d", descriptor = "(B)I", line = 1359)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(BLha;)V", line = 1371)
