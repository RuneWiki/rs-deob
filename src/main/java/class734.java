...
public class class734 extends class119 implements class721 {
    ...
    @OriginalMember(owner = "client!ww", name = "e", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ww", name = "b", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(B)Z", line = 29)
    ...
    @OriginalMember(owner = "client!ww", name = "e", descriptor = "(B)Z", line = 41)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(Lha;I)Lria;", line = 54)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(III)I", line = 70)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(IBLha;I)Z", line = 116)
    ...
    @OriginalMember(owner = "client!ww", name = "h", descriptor = "(B)I", line = 136)
    ...
    @OriginalMember(owner = "client!ww", name = "j", descriptor = "(B)I", line = 147)
    ...
    @OriginalMember(owner = "client!ww", name = "b", descriptor = "(Lha;B)Lc;", line = 159)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(ILfe;)V", line = 205)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(ILha;)V", line = 218)
    ...
    @OriginalMember(owner = "client!ww", name = "k", descriptor = "(B)Z", line = 228)
    ...
    @OriginalMember(owner = "client!ww", name = "f", descriptor = "(I)V", line = 241)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(ILvs;ZILha;II)V", line = 251)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(Lha;B)V", line = 262)
    ...
    @OriginalMember(owner = "client!ww", name = "i", descriptor = "(B)Z", line = 277)
    ...
    @OriginalMember(owner = "client!ww", name = "<init>", descriptor = "(Lha;Lsu;IIIIIZIIIIIII)V", line = 290)
    ...
    @OriginalMember(owner = "client!ww", name = "b", descriptor = "(I)I", line = 299)
    public final int method327(int arg0) {
        ++field10273;
        return arg0 > -116 ? -11 : this.field10277.field1696;
    }

    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(I)I", line = 317)
    public final int method317(int arg0) {
        ++field10276;
        return arg0 < 112 ? 34 : this.field10277.field1709;
    }

    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(Lkd;Z)V", line = 328)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(Lha;Z)V", line = 363)
    ...
    @OriginalMember(owner = "client!ww", name = "c", descriptor = "(B)I", line = 386)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "([Lwj;Lwh;I)Lrv;", line = 404)
