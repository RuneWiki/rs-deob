...
public class class331 {
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(Lee;I)V")
    ...
    @OriginalMember(owner = "client!pba", name = "b", descriptor = "(IB)I")
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(I[B)Z")
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(II)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(Ljava/lang/String;I)Z")
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(ZILee;)V")
    ...
    @OriginalMember(owner = "client!pba", name = "b", descriptor = "(II)I")
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(BLff;)V")
