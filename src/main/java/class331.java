...
public class class331 {
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 9)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(Lrt;I)V", line = 41)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(BILrt;)V", line = 64)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(B)V", line = 100)
