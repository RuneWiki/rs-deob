...
public class class331 {
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "(Lkw;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "(Lkw;Ljaclib/memory/Buffer;)V", line = 21)
