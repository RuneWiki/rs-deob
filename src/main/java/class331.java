...
public class class331 extends class264 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "(J)V", line = 28)
