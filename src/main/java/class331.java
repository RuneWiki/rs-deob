...
public class class331 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(I)Ljava/lang/Object;", line = 15)
    ...
    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(BJ)V", line = 63)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(JILjava/lang/Object;)V", line = 97)
    ...
    @OriginalMember(owner = "client!fi", name = "d", descriptor = "(I)I", line = 122)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IJ)Ljava/lang/Object;", line = 149)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lbk;I)Lsr;", line = 195)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(I)V", line = 248)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Z)Ljava/lang/Object;", line = 213)
    ...
    @OriginalMember(owner = "client!fi", name = "f", descriptor = "(I)V", line = 263)
    ...
    @OriginalMember(owner = "client!fi", name = "g", descriptor = "(I)I", line = 289)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(II)V", line = 311)
