...
public class class331 extends class63 {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Lr;III[Z)Z")
    ...
    @OriginalMember(owner = "client!is", name = "j", descriptor = "(I)V")
