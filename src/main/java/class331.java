...
public class class331 extends class747 {
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(Lhj;[Lws;B)Ljp;", line = 9)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 85)
    ...
    @OriginalMember(owner = "client!eca", name = "c", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(II)[I", line = 154)
