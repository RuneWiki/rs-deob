...
public class class331 {
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(IIIZBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(B)V", line = 137)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(II)Z", line = 147)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(ILsj;)V", line = 158)
    ...
    @OriginalMember(owner = "client!hfa", name = "b", descriptor = "(II)Lhfa;", line = 347)
    ...
    @OriginalMember(owner = "client!hfa", name = "c", descriptor = "(II)V", line = 358)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 370)
    ...
    @OriginalMember(owner = "client!hfa", name = "<init>", descriptor = "(IIII)V", line = 384)
