...
public class class331 extends class626 {
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!pba", name = "b", descriptor = "(I)Z", line = 28)
    ...
    @OriginalMember(owner = "client!pba", name = "c", descriptor = "(I)Z", line = 40)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(BI)Z", line = 51)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(Z)Z", line = 62)
    ...
    @OriginalMember(owner = "client!pba", name = "b", descriptor = "(Z)I", line = 75)
    ...
    @OriginalMember(owner = "client!pba", name = "<init>", descriptor = "(II)V", line = 87)
    public class331(int arg0, int arg1) {
        this.field4679 = arg0;
        this.field4675 = arg1;
    }

    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(Ld;IIIIILha;)V", line = 99)
