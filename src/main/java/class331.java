...
public class class331 extends class120 {
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Ltd;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!iw", name = "<init>", descriptor = "(I)V", line = 26)
    public class331(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!iw", name = "b", descriptor = "(III[B)V", line = 31)
    ...
    @OriginalMember(owner = "client!iw", name = "z", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!iw", name = "f", descriptor = "(IB)I", line = 61)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(ZI)I", line = 91)
    ...
    @OriginalMember(owner = "client!iw", name = "n", descriptor = "(II)V", line = 107)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(B[I)V", line = 120)
    ...
    @OriginalMember(owner = "client!iw", name = "e", descriptor = "(Z)I", line = 136)
    ...
    @OriginalMember(owner = "client!iw", name = "l", descriptor = "(B)V", line = 155)
    ...
    @OriginalMember(owner = "client!iw", name = "A", descriptor = "(I)Z", line = 170)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(B[BLog;I)Lut;", line = 185)
    ...
    @OriginalMember(owner = "client!iw", name = "f", descriptor = "(Z)V", line = 231)
