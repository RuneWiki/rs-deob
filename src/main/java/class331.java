...
public abstract class class331 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(B)Ljaa;", line = 4)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(IIIZLqg;)V", line = 16)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Ljava/lang/String;B)J", line = 76)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(IIIIIII)V", line = 121)
    ...
    @OriginalMember(owner = "client!fe", name = "<init>", descriptor = "(Lts;)V", line = 197)
    public class331(class41 arg0) {
        this.field4203 = arg0;
        this.field4202 = this.method226((byte) 13);
    }

    @OriginalMember(owner = "client!fe", name = "<init>", descriptor = "(ILts;)V", line = 205)
    public class331(int arg0, class41 arg1) {
        this.field4203 = arg1;
        this.field4202 = arg0;
    }

    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Z)V", line = 220)
