...
public class class331 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(ILvq;Z)Z")
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IIIIIIIILvq;I)V")
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "(I[Lcr;IIII)V")
