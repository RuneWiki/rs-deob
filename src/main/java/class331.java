...
public class class331 extends class333 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "()V", line = 38)
    public class331() {
    }

    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IBLtf;I)Lef;", line = 41)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 58)
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(S)V", line = 80)
