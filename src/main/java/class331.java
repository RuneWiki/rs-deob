...
public class class331 {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ZI[BI)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ILbo;BIILqa;)V", line = 45)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(B)V", line = 108)
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(B)V", line = 118)
