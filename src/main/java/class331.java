...
public class class331 {
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(IBIILrk;)V", line = 111)
