...
public class class331 extends class145 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "([BI)[B", line = 4)
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IZIIIIZ)V", line = 33)
    ...
    @OriginalMember(owner = "client!kd", name = "d", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "()V", line = 214)
    public class331() {
        super(3, false);
    }

    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(II)[I", line = 100)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ZI)[[I", line = 148)
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(II)I", line = 207)
    public static int method2109(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lu;Lu;IZZZI)I", line = 218)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lap;BI)V", line = 255)
