...
public class class331 extends class741 {
    ...
    @OriginalMember(owner = "client!hfa", name = "<init>", descriptor = "(Laj;Laj;Lmba;)V", line = 3)
    public class331(class333 arg0, class333 arg1, class444 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(IZII)V", line = 10)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(ZBII)V", line = 28)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(FIIIIIFF)[F", line = 41)
