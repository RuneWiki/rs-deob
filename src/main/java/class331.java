...
public class class331 extends class314 {
    ...
    @OriginalMember(owner = "client!eh", name = "c", descriptor = "(III)Z", line = 9)
    ...
    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "()V", line = 24)
    public class331() {
        super(0, true);
    }

    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(II)[I", line = 27)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IIIIII[Lpca;IZI)V", line = 50)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IIIBIII)I", line = 770)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(BLie;I)V", line = 845)
    ...
    @OriginalMember(owner = "client!eh", name = "h", descriptor = "(I)V", line = 937)
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(Z)V", line = 988)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(I[II)V", line = 1001)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(B)V", line = 1188)
