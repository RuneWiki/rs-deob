...
public class class331 {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(BLoa;)V", line = 10)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(III)I", line = 36)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(IIILap;)V", line = 53)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!du", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 78)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Z)V", line = 101)
    ...
    @OriginalMember(owner = "client!du", name = "b", descriptor = "(I)V", line = 129)
