...
public class class331 {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IZILc;IIIIIIII)Z")
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(JI)Lm;")
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lqo;B)V")
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lm;JI)V")
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(I)Lm;")
