...
public class class331 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ZLjava/lang/String;)Z", line = 17)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(I)Z", line = 55)
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(Lnd;)V", line = 102)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Ljava/lang/String;Z)Z", line = 77)
