...
public class class331 {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!is", name = "b", descriptor = "(I)Lwr;")
    ...
    @OriginalMember(owner = "client!is", name = "c", descriptor = "(I)Lwr;")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(ILha;B)V")
