...
public class class331 extends class277 {
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(IILrg;)V", line = 3)
    ...
    @OriginalMember(owner = "client!qw", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!qw", name = "b", descriptor = "(IZ)V", line = 498)
    ...
    @OriginalMember(owner = "client!qw", name = "<init>", descriptor = "(Lqj;Lpea;)V", line = 553)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(IIIII)V", line = 535)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(III)V", line = 571)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(I)V", line = 610)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(B)Z", line = 632)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(IZ)V", line = 654)
