...
public class class331 extends class429 {
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(IIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!bga", name = "b", descriptor = "(IIIZ)V", line = 17)
    ...
    @OriginalMember(owner = "client!bga", name = "<init>", descriptor = "(Lbi;Lbi;Ltq;)V", line = 30)
    public class331(class449 arg0, class449 arg1, class587 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(IBIIII)V", line = 43)
