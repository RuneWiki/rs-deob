...
public class class331 extends class401 implements class305 {
    ...
    @OriginalMember(owner = "client!rr", name = "b", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(I)J", line = 17)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(B)I", line = 29)
    ...
    @OriginalMember(owner = "client!rr", name = "d", descriptor = "(I)I", line = 44)
    ...
    @OriginalMember(owner = "client!rr", name = "c", descriptor = "(I)C", line = 59)
