...
public class class331 extends class145 implements class682 {
    ...
    @OriginalMember(owner = "client!uv", name = "<init>", descriptor = "(Len;I[BIZ)V", line = 5)
    public class331(class289 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field4871 = arg1;
    }

    @OriginalMember(owner = "client!uv", name = "d", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(II[BI)V", line = 24)
    ...
    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(B)I", line = 37)
    public final int method2002(byte arg0) {
        ++field4865;
        return arg0 >= -103 ? 74 : super.field2160;
    }

    @OriginalMember(owner = "client!uv", name = "<init>", descriptor = "(Len;ILjaclib/memory/Buffer;IZ)V", line = 49)
    public class331(class289 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field4871 = arg1;
    }

    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(Z)J", line = 60)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(B)I", line = 71)
    ...
    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(Z)V", line = 84)
