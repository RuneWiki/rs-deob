...
public class class331 implements Runnable {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IIIILjava/lang/Object;)Lqo;")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(BLjava/net/URL;)Lqo;")
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(I)Lqo;")
    public final class21 method2002(int arg0) {
        int var2 = 89 / ((arg0 + 79) / 42);
        return this.method2020(0, (byte) -30, null, 5, 0);
    }

    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(BLjava/lang/String;[Ljava/lang/Class;Ljava/lang/Class;)Lqo;")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IILjava/lang/Runnable;)Lqo;")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IILjava/awt/Component;I)Lqo;")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IZLjava/awt/Component;)Lqo;")
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(B)Lhba;")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ILjava/awt/Frame;)Lqo;")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Ljava/awt/Component;Ljava/awt/Point;I[III)Lqo;")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/Class;)Lqo;")
    ...
    @OriginalMember(owner = "client!lp", name = "c", descriptor = "(I)Lqo;")
    ...
    @OriginalMember(owner = "client!lp", name = "c", descriptor = "(Ljava/lang/String;I)Lqo;")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IIIII)Lqo;")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ILjava/awt/datatransfer/Transferable;)Lqo;")
    public final class21 method2018(int arg0, Transferable arg1) {
        return arg0 == 0 ? this.method2020(0, (byte) -30, arg1, 19, 0) : null;
    }

    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Ljava/lang/String;ZZ)Lqo;")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IBLjava/lang/Object;II)Lqo;")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(BLjava/lang/String;)Lqo;")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Ljava/lang/String;II)Lqo;")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(II)Lqo;")
