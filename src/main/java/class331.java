...
public class class331 extends class400 {
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!hfa", name = "f", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!hfa", name = "g", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!hfa", name = "<init>", descriptor = "(Lpc;II)V", line = 129)
    ...
    @OriginalMember(owner = "client!hfa", name = "<init>", descriptor = "(Lpc;IIZ[[I)V", line = 147)
    ...
    @OriginalMember(owner = "client!hfa", name = "h", descriptor = "(I)I", line = 179)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(IIIII)V", line = 192)
    ...
    @OriginalMember(owner = "client!hfa", name = "<init>", descriptor = "(Lpc;IIZ[[BI)V", line = 204)
    ...
    @OriginalMember(owner = "client!hfa", name = "i", descriptor = "(I)V", line = 235)
