...
public class class331 extends class274 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lya;IIILjo;I)V")
    ...
    @OriginalMember(owner = "client!nm", name = "b", descriptor = "(I)Lvg;")
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(Lef;IIIIII)V")
