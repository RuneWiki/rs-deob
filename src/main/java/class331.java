...
public class class331 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(Lr;B)V")
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(II)Lbt;")
    ...
    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "(Ler;ILjn;)V")
