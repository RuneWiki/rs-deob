...
public class class331 extends class417 implements class248 {
    ...
    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Lqa;ZII)Lmr;", line = 17)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ILqa;)V", line = 49)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ILqa;B)Lc;", line = 79)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IILck;)V", line = 100)
    ...
    @OriginalMember(owner = "client!ap", name = "c", descriptor = "(I)V", line = 292)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ILqa;ZLto;III)V", line = 305)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ZLqa;)Lae;", line = 338)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(BLqa;)V", line = 365)
    public final void method25(byte arg0, class162 arg1) {
        ++field5001;
        int var3 = 55 % ((-45 - arg0) / 48);
    }

    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(B)I", line = 379)
    public final int method19(byte arg0) {
        ++field4987;
        return arg0 != -69 ? -44 : this.field4999;
    }

    @OriginalMember(owner = "client!ap", name = "f", descriptor = "(I)I", line = 391)
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(Lqa;Lgm;IIIIIZIIIIIIZ)V", line = 402)
    ...
    @OriginalMember(owner = "client!ap", name = "d", descriptor = "(I)I", line = 438)
    ...
    @OriginalMember(owner = "client!ap", name = "c", descriptor = "(B)V", line = 450)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(III)I", line = 466)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Lqa;I)V", line = 483)
    ...
    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(B)I", line = 511)
    ...
    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(Z)Z", line = 521)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(I)Z", line = 533)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ILqa;II)Z", line = 545)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Lqa;II)Lc;", line = 565)
