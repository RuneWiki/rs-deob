...
public class class331 extends class481 implements class161 {
    ...
    @OriginalMember(owner = "client!ce", name = "b", descriptor = "(ILza;)Lhp;")
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Lza;III)Z")
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Lza;IIILps;IZ)V")
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(ZBILza;)Lhw;")
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Lza;IZ)Le;")
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(BIILsj;I)V")
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(ILza;)V")
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(ILza;Z)Le;")
    ...
    @OriginalMember(owner = "client!ce", name = "<init>", descriptor = "(Lza;Lii;IIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Lza;B)V")
