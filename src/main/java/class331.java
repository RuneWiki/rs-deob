...
public class class331 {
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(Lee;I)Lta;", line = 6)
    ...
    @OriginalMember(owner = "client!saa", name = "toString", descriptor = "()Ljava/lang/String;", line = 20)
    public final String toString() {
        field4719++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "([JII[II)V", line = 56)
