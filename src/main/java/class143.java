...
public class class143 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(II)[B", line = 3)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(III)Z", line = 64)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "([BB)V", line = 80)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(ILcea;)Lcea;", line = 131)
