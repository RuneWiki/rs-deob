...
public class class143 extends class455 implements class185 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(ILqq;Lps;ZZII)V")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lqq;I)V")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lqq;ZI)Lcd;")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lqq;BII)Z")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(BLqq;)Lkm;")
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(Lqq;Lin;IIIIIZIII)V")
    ...
    @OriginalMember(owner = "client!em", name = "b", descriptor = "(ZLqq;)V")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(ZLqq;)V")
