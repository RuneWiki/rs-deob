...
public class class143 {
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(BZLas;Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Z)V", line = 84)
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(I)I", line = 102)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(ILns;II)Lro;", line = 114)
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "()V", line = 133)
    public class143() {
    }

    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Ltl;)V", line = 135)
