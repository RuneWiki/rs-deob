...
public class class143 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Lha;II)Lac;")
    ...
    @OriginalMember(owner = "client!vc", name = "b", descriptor = "(IZ)Lqg;")
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Ldh;IZLkha;Lkha;)V")
