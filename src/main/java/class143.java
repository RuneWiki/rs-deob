...
public class class143 {
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 7)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(III)Z", line = 41)
    public static final boolean method995(int arg0, int arg1, int arg2) {
        field1912++;
        return arg2 == -1 ? (arg1 & 0x220) == 544 | (arg1 & 0x18) != 0 : false;
    }

    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(Leea;B)V", line = 53)
    ...
    @OriginalMember(owner = "client!eea", name = "<init>", descriptor = "(I)V", line = 169)
    public class143(int arg0) {
        this.field1917 = arg0;
    }

    @OriginalMember(owner = "client!eea", name = "<init>", descriptor = "(IIIIII)V", line = 176)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(IIIILec;I)Ljava/awt/Frame;", line = 78)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(I)Leea;", line = 151)
