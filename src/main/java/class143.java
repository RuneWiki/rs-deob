...
public class class143 extends class435 {
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!jga", name = "b", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(B)Z", line = 46)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(BLqe;)V", line = 60)
