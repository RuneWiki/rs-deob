...
public class class143 {
    ...
    @OriginalMember(owner = "client!fea", name = "toString", descriptor = "()Ljava/lang/String;", line = 9)
    public final String toString() {
        field2276++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(BFIFF)F", line = 42)
    ...
    @OriginalMember(owner = "client!fea", name = "<init>", descriptor = "(IILns;)V", line = 54)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(BIIILfha;)V", line = 69)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(IB)Lfea;", line = 110)
