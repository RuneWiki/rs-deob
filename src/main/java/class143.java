...
public class class143 extends class514 {
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!we", name = "c", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 52)
