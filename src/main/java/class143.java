...
public class class143 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(I)Lo;")
    ...
    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(I)Lo;")
    ...
    @OriginalMember(owner = "client!sf", name = "d", descriptor = "(I)Lo;")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IJ)Lo;")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(ZJLo;)V")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Lqj;I)V")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "([Lo;I)I")
