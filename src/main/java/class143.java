...
public class class143 extends class494 implements class258 {
    ...
    @OriginalMember(owner = "client!fea", name = "g", descriptor = "(I)Z", line = 3)
    public final boolean method45(int arg0) {
        ++field2358;
        return arg0 > -12 ? false : false;
    }

    @OriginalMember(owner = "client!fea", name = "<init>", descriptor = "(Lha;Liv;IIIIIZIIIIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!fea", name = "i", descriptor = "(I)I", line = 27)
    ...
    @OriginalMember(owner = "client!fea", name = "j", descriptor = "(I)Z", line = 38)
    public final boolean method35(int arg0) {
        ++field2367;
        return arg0 > -65 ? false : false;
    }

    @OriginalMember(owner = "client!fea", name = "c", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(Lha;III)Z", line = 61)
    ...
    @OriginalMember(owner = "client!fea", name = "d", descriptor = "(I)I", line = 83)
    ...
    @OriginalMember(owner = "client!fea", name = "b", descriptor = "(Lha;I)Lhw;", line = 95)
    public final class132 method40(class59 arg0, int arg1) {
        ++field2370;
        return arg1 != 7 ? null : this.field2368;
    }

    @OriginalMember(owner = "client!fea", name = "b", descriptor = "(B)Z", line = 111)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(Lha;I)V", line = 125)
    ...
    @OriginalMember(owner = "client!fea", name = "b", descriptor = "(ILha;)Ljda;", line = 136)
    ...
    @OriginalMember(owner = "client!fea", name = "b", descriptor = "(I)I", line = 184)
    ...
    @OriginalMember(owner = "client!fea", name = "b", descriptor = "(Z)V", line = 194)
    ...
    @OriginalMember(owner = "client!fea", name = "e", descriptor = "(I)I", line = 206)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(ILha;)V", line = 217)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(Lha;IZLga;IBI)V", line = 233)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(I)Z", line = 244)
    ...
    @OriginalMember(owner = "client!fea", name = "c", descriptor = "(Lha;I)V", line = 258)
    ...
    @OriginalMember(owner = "client!fea", name = "c", descriptor = "(Z)I", line = 283)
