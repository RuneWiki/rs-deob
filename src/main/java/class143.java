...
public class class143 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IIILba;)V")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IILba;I)V")
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lba;IIB)Z")
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(Lef;Leg;)V")
