...
public class class143 extends OutputStream {
    ...
    @OriginalMember(owner = "client!jf", name = "write", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(ILti;)Lie;", line = 32)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(II)V", line = 44)
