...
public class class143 {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(BJLwfa;)V")
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(B)Lwfa;")
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(JI)Lwfa;")
