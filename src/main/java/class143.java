...
public class class143 implements MouseListener, MouseMotionListener, FocusListener {
    ...
    @OriginalMember(owner = "client!pd", name = "w", descriptor = "Llf;")
    public static class109 field2768 = class35.method275("Ihr Spielkonto wird bereits benutzt)3", 2);

    @OriginalMember(owner = "client!pd", name = "x", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!pd", name = "y", descriptor = "Lbg;")
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Llf;I)I")
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IILu;BI)V")
