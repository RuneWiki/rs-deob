...
public class class143 extends class72 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(B)J", line = 4)
    public final long method474(byte arg0) {
        return arg0 == 90 ? this.field2050 : 112L;
    }

    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "()V", line = 104)
    public class143() {
        this.field2050 = System.nanoTime();
        this.field2051 = System.nanoTime();
    }

    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(II)I", line = 20)
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(B)J", line = 58)
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(I)V", line = 89)
