...
public class class143 extends class199 {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(I[B)V", line = 5)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IZI)[B", line = 18)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(I)[B", line = 32)
