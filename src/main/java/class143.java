...
public class class143 extends class98 {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(ILdg;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!rh", name = "e", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "()V", line = 130)
    public class143() {
        super(0, true);
    }

    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!rh", name = "f", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!rh", name = "g", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(II)[I", line = 189)
