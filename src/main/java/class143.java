...
public class class143 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!fk", name = "c", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(ZI)Lsd;", line = 83)
    ...
    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "(Lsv;Le;)V", line = 130)
    public class143(class312 arg0, class479 arg1) {
        this.field1822 = arg1;
        this.field1812 = arg0;
    }

    @OriginalMember(owner = "client!fk", name = "d", descriptor = "(I)V", line = 139)
