...
public class class143 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "([[[Lru;IBZII)Z", line = 27)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(BII)Z", line = 345)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(ZLnp;)Ljava/lang/String;", line = 357)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IB)[I", line = 371)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(III)V", line = 508)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(I)V", line = 446)
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(I)[[I", line = 464)
    ...
    @OriginalMember(owner = "client!mp", name = "c", descriptor = "(I)V", line = 496)
