...
public class class143 extends class62 {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(B)V", line = 248)
    ...
    @OriginalMember(owner = "client!mr", name = "d", descriptor = "(I)V", line = 271)
    ...
    @OriginalMember(owner = "client!mr", name = "b", descriptor = "(B)V", line = 292)
