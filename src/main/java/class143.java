...
public class class143 extends class180 implements class55 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IILco;ILqa;ZZ)V")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lqa;BI)Lc;")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lkj;ILm;Ljava/awt/Canvas;II)Lqa;")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(ZBILqa;)Ltt;")
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Lqa;Lpk;IIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lqa;III)Z")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lqa;I)Lip;")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IILqa;)Lc;")
    ...
    @OriginalMember(owner = "client!jf", name = "c", descriptor = "(ILqa;)V")
