...
public class class143 extends class460 {
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(I)I", line = 15)
    ...
    @OriginalMember(owner = "client!wea", name = "c", descriptor = "(I)I", line = 25)
    public final int method786(int arg0) {
        return arg0 == 22461 ? this.field1614 : 117;
    }

    @OriginalMember(owner = "client!wea", name = "b", descriptor = "(I)I", line = 36)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Z)J", line = 46)
