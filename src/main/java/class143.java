...
public class class143 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(CI)Z", line = 51)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Lcl;FBLcl;)Z", line = 63)
    ...
    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "(Lpg;)V", line = 131)
