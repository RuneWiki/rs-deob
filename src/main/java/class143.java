...
public class class143 extends class13 {
    ...
    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "()V", line = 8)
    public class143() {
        super(0, true);
    }

    @OriginalMember(owner = "client!mb", name = "b", descriptor = "(II)V", line = 11)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(ZI)[I", line = 38)
    ...
    @OriginalMember(owner = "client!mb", name = "c", descriptor = "(III)Lms;", line = 171)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IIZILjava/lang/String;Ljava/lang/String;ZJIIZ)V", line = 191)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Lkh;BI)V", line = 247)
    ...
    @OriginalMember(owner = "client!mb", name = "e", descriptor = "(B)V", line = 298)
