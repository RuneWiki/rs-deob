...
public abstract class class143 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IIIIILnp;ZILnp;B[I)V")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IZLnp;)V")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lui;IIIBII)V")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IIZZ[Z[ILed;IILvb;Lvb;I)V")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ZIIILnp;[ZILnp;Lnp;Lnp;IIIII)V")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILnp;IIIZIILnp;)V")
