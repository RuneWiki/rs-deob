...
public abstract class class143 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Z)Z", line = 4)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(I)Z", line = 17)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(B)Z", line = 35)
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "(I)Z", line = 48)
