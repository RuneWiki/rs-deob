...
public class class143 extends class227 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Ljava/util/Random;[[IZIIII)V", line = 258)
    ...
    @OriginalMember(owner = "client!eq", name = "j", descriptor = "(I)V", line = 458)
    ...
    @OriginalMember(owner = "client!eq", name = "e", descriptor = "(I)V", line = 471)
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "()V", line = 503)
    public class143() {
        super(0, true);
    }

    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Lug;II)V", line = 508)
