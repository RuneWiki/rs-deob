...
public class class143 extends class338 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(ILqb;[I[B)Z")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(III)Lhs;")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Ltq;I)Lmr;")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "([Lfd;II)V")
