...
public class class143 extends class544 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IIFII)V", line = 3)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IIB)I", line = 120)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(BI)V", line = 134)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(BIII)V", line = 156)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(II)Loj;", line = 170)
    ...
    @OriginalMember(owner = "client!uh", name = "c", descriptor = "(II)V", line = 207)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Z)V", line = 222)
    ...
    @OriginalMember(owner = "client!uh", name = "<init>", descriptor = "(Lml;IIIII)V", line = 425)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(ZI[I)V", line = 244)
    ...
    @OriginalMember(owner = "client!uh", name = "d", descriptor = "(II)V", line = 407)
