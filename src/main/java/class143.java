...
public class class143 extends class335 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(ZLfl;)V", line = 4)
    ...
    @OriginalMember(owner = "client!jf", name = "c", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(ILfl;)V", line = 125)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(II)V", line = 144)
    ...
    @OriginalMember(owner = "client!jf", name = "d", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(I)V", line = 181)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IB)V", line = 198)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(BFLna;IZ)V", line = 213)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lqa;BII)V", line = 238)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lfl;B)V", line = 265)
