...
public class class143 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "([[BILea;[[BZI[[B[[I[[BLdn;IILdn;)V", line = 4)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(I)V", line = 290)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Z)V", line = 326)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IB)V", line = 350)
