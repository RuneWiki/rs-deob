...
public class class143 {
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(I)Lsp;", line = 5)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(BII)I", line = 24)
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "()V", line = 148)
    public class143() {
        this.field2189.field6603 = this.field2189;
        this.field2189.field6598 = this.field2189;
    }

    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Lsp;I)V", line = 48)
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(I)Lsp;", line = 70)
    ...
    @OriginalMember(owner = "client!su", name = "c", descriptor = "(I)I", line = 91)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(B)Lsp;", line = 112)
    ...
    @OriginalMember(owner = "client!su", name = "d", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!su", name = "e", descriptor = "(I)V", line = 164)
