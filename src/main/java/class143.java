...
public class class143 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Lac;I)V")
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(I)Lqga;")
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Lac;BI)V")
