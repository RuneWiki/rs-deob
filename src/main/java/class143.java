...
public class class143 {
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(ILta;ZLoa;ZIILoa;ILwi;II)Lxa;")
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(ILwi;ILoa;IIIB)Lxa;")
    ...
    @OriginalMember(owner = "client!faa", name = "b", descriptor = "(II)Lmfa;")
    ...
    @OriginalMember(owner = "client!faa", name = "<init>", descriptor = "(Lpca;IZLia;Lbi;Lbi;)V")
