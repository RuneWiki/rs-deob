...
public class class143 extends class144 {
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(B)Z", line = 17)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!su", name = "d", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "(IIIIIIIIIIIZ)V", line = 406)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(BZIIII)V", line = 96)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Lza;BI)Le;", line = 291)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Le;Lza;Z)V", line = 305)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Lza;I)V", line = 329)
    ...
    @OriginalMember(owner = "client!su", name = "f", descriptor = "(I)V", line = 352)
    ...
    @OriginalMember(owner = "client!su", name = "c", descriptor = "(B)I", line = 364)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(ILza;ILge;IZI)V", line = 381)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IILza;I)Z", line = 392)
    public final boolean method129(int arg0, int arg1, class290 arg2, int arg3) {
        ++field1859;
        return arg0 != 3 ? false : false;
    }

    @OriginalMember(owner = "client!su", name = "e", descriptor = "(I)V", line = 440)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(III)V", line = 451)
    ...
    @OriginalMember(owner = "client!su", name = "d", descriptor = "(Z)V", line = 466)
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(Lza;B)Lkf;", line = 477)
    ...
    @OriginalMember(owner = "client!su", name = "finalize", descriptor = "()V", line = 512)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IB)V", line = 526)
