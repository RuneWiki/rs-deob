...
public class class143 extends class75 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lua;I)V")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lgk;Z)V")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lgk;B)V")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(FIZILck;)V")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lwm;Z)V")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(ZLgk;)V")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lwd;IIIII)Ljava/awt/Frame;")
