...
public abstract class class143 extends class330 {
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Lra;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!mb", name = "b", descriptor = "(Z)V", line = 13)
    ...
    @OriginalMember(owner = "client!mb", name = "g", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!mb", name = "e", descriptor = "(I)Z", line = 104)
    ...
    @OriginalMember(owner = "client!mb", name = "f", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(ILen;IBLfs;IZ)V", line = 135)
    ...
    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "(IIIIIII)V", line = 172)
