...
public class class143 extends class86 implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    @OriginalMember(owner = "client!ik", name = "h", descriptor = "(I)Lsm;", line = 5)
    public final class191 method647(int arg0) {
        int var2 = 60 / ((arg0 - 39) / 58);
        return (class191) this.field2200.method862(-93);
    }

    @OriginalMember(owner = "client!ik", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 14)
    ...
    @OriginalMember(owner = "client!ik", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 37)
    ...
    @OriginalMember(owner = "client!ik", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 50)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method1033(4, arg0);
    }

    @OriginalMember(owner = "client!ik", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 57)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        this.method1033(4, arg0);
    }

    @OriginalMember(owner = "client!ik", name = "i", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!ik", name = "e", descriptor = "(I)Z", line = 90)
    public final boolean method642(int arg0) {
        int var2 = 30 / ((arg0 - 18) / 48);
        return (this.field2198 & 0x4) != 0;
    }

    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(B)I", line = 119)
    public final int method639(byte arg0) {
        int var2 = -33 % ((arg0 + 30) / 48);
        return this.field2199;
    }

    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(I)Z", line = 129)
    public final boolean method637(int arg0) {
        int var2 = -74 % ((arg0 - 64) / 58);
        return (this.field2198 & 0x2) != 0;
    }

    @OriginalMember(owner = "client!ik", name = "f", descriptor = "(I)Z", line = 138)
    ...
    @OriginalMember(owner = "client!ik", name = "d", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!ik", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 159)
    ...
    @OriginalMember(owner = "client!ik", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 186)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method1033(4, arg0);
    }

    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IIIII)V", line = 197)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(Ljava/awt/Component;Z)V", line = 214)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(ILjava/awt/event/MouseEvent;)V", line = 228)
    ...
    @OriginalMember(owner = "client!ik", name = "g", descriptor = "(I)I", line = 247)
    ...
    @OriginalMember(owner = "client!ik", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 260)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.field2202 = -1;
        this.field2203 = -1;
    }

    @OriginalMember(owner = "client!ik", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 315)
    public class143(Component arg0, boolean arg1) {
        this.method1032(arg0, true);
        this.field2205 = arg1;
    }

    @OriginalMember(owner = "client!ik", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 271)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;I)I", line = 285)
