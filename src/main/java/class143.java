...
public class class143 extends class418 {
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IBIIILtj;ZIIIIZLao;)V", line = 21)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lir;B)I", line = 634)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(I)V", line = 657)
    ...
    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "()V", line = 673)
    public class143() {
    }

    @OriginalMember(owner = "client!hr", name = "c", descriptor = "(II)V", line = 676)
    ...
    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 691)
    public class143(String arg0) {
        this.field1813 = arg0;
    }

    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(BI)V", line = 699)
