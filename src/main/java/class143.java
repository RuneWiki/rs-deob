...
public class class143 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ZZIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(II)I", line = 57)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(BI)Lig;", line = 60)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(IIII)V", line = 91)
