...
public class class143 extends class66 {
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Lha;III[Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(ZI)Lui;", line = 31)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(ILri;IBZI)V", line = 65)
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(I)V", line = 106)
    public class143(int arg0) {
        this.field2408 = arg0;
    }

    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(II)V", line = 87)
