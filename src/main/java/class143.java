...
public class class143 extends class119 {
    ...
    @OriginalMember(owner = "client!rh", name = "d", descriptor = "(B)Ljava/lang/Object;", line = 26)
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "(Lvh;Ljava/lang/Object;)V", line = 37)
    public class143(class200 arg0, Object arg1) {
        super(arg0);
        this.field2258 = arg1;
    }

    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(BI)V", line = 45)
    ...
    @OriginalMember(owner = "client!rh", name = "c", descriptor = "(B)Z", line = 94)
    ...
    @OriginalMember(owner = "client!rh", name = "g", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!rh", name = "c", descriptor = "(Z)V", line = 125)
