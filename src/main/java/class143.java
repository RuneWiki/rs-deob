...
public class class143 extends class444 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ILqa;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!qf", name = "f", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "()V", line = 459)
    public class143() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IIII)[B", line = 464)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(BII)V", line = 477)
    ...
    @OriginalMember(owner = "client!qf", name = "c", descriptor = "(B)V", line = 493)
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(III)I", line = 510)
