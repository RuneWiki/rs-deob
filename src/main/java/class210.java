...
public class class210 {
    ...
    @OriginalMember(owner = "client!ta", name = "movemouse", descriptor = "(II)V")
    public final void movemouse(int arg0, int arg1) {
        this.field3041.mouseMove(arg0, arg1);
    }

    @OriginalMember(owner = "client!ta", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V")
    ...
    @OriginalMember(owner = "client!ta", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V")
