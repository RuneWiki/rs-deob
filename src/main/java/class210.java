...
public class class210 implements Runnable {
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(III)I", line = 3)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(IIII)V", line = 73)
    ...
    @OriginalMember(owner = "client!d", name = "b", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(ZILjava/lang/String;)V", line = 118)
    ...
    @OriginalMember(owner = "client!d", name = "run", descriptor = "()V", line = 559)
