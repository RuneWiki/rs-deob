...
public class class210 extends class541 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "([BI)[B", line = 3)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IZZ)V", line = 62)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Los;IIIII)V", line = 83)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IIIIIII)V", line = 101)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IIII)V", line = 113)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(III[IZIIII)V", line = 126)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(B)V", line = 177)
    ...
    @OriginalMember(owner = "client!ot", name = "e", descriptor = "(B)V", line = 191)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(ZI)Llb;", line = 202)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Los;IIIIZ[BIZ)V", line = 238)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Los;IIIIZ[FI)V", line = 290)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Los;IIII)V", line = 312)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IIZ[BIZIIII)V", line = 324)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Los;IIIIZ[IZ)V", line = 385)
