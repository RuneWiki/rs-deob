...
public class class210 extends class456 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IBLre;)V")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ZLui;Lui;)V")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIZILpp;II)V")
