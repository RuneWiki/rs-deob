...
public class class210 extends class669 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(BII)V", line = 3)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IILnq;)V", line = 31)
    ...
    @OriginalMember(owner = "client!em", name = "d", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(ZZ)V", line = 58)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(ZI)V", line = 72)
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(Ldc;Lbi;Lmca;)V", line = 85)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IIIIIII)Ldn;", line = 114)
    ...
    @OriginalMember(owner = "client!em", name = "b", descriptor = "(I)Z", line = 136)
