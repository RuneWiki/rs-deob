...
public class class210 implements Runnable {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lpu;Lft;I)V", line = 14)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(BI)Z", line = 65)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(III)Z", line = 97)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILpu;I)Los;", line = 108)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IBI[B)I", line = 126)
    ...
    @OriginalMember(owner = "client!ec", name = "run", descriptor = "()V", line = 177)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(I)V", line = 234)
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(Ljava/io/InputStream;I)V", line = 274)
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(Z)V", line = 298)
