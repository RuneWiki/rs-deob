...
public class class210 extends class608 implements class342 {
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(Llh;Z)V")
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ILjaclib/memory/Source;II)Z")
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Lqa;I)V")
