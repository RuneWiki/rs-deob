...
public class class210 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ZLhp;)V")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(B)Ltp;")
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(I)Ltp;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(BILhp;)V")
