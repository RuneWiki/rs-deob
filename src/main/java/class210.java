...
public class class210 extends class134 {
    ...
    @OriginalMember(owner = "client!uga", name = "c", descriptor = "(I)V", line = 5)
    public static void method1172(int arg0) {
        int var1 = -2 / ((28 - arg0) / 57);
        field2521 = null;
    }

    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(I)I", line = 15)
    public final int method58(int arg0) {
        ++field2517;
        return arg0 != 0 ? -68 : 1;
    }

    @OriginalMember(owner = "client!uga", name = "<init>", descriptor = "(Lkda;)V", line = 27)
    public class210(class391 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!uga", name = "<init>", descriptor = "(ILkda;)V", line = 30)
    public class210(int arg0, class391 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(II)V", line = 34)
    ...
    @OriginalMember(owner = "client!uga", name = "b", descriptor = "(B)I", line = 44)
    ...
    @OriginalMember(owner = "client!uga", name = "c", descriptor = "(II)I", line = 59)
    ...
    @OriginalMember(owner = "client!uga", name = "d", descriptor = "(II)I", line = 71)
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(B)V", line = 88)
