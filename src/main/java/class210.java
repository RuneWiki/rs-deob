...
public class class210 extends class400 {
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IIILoaa;Lke;ILha;ILhu;)V", line = 15)
    ...
    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "(Lpc;IIII[BI)V", line = 61)
    ...
    @OriginalMember(owner = "client!tj", name = "f", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "(Lpc;IIII)V", line = 131)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(BLiaa;)V", line = 90)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(I)V", line = 117)
