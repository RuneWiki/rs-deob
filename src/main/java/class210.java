...
public class class210 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ILcm;)V")
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lkt;I[[B)V")
    ...
    @OriginalMember(owner = "client!co", name = "e", descriptor = "(B)V")
