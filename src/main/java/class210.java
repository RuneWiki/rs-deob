...
public abstract class class210 extends class295 {
    ...
    @OriginalMember(owner = "client!tg", name = "f", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "([Ltw;I)I", line = 19)
    ...
    @OriginalMember(owner = "client!tg", name = "g", descriptor = "(B)V", line = 189)
    ...
    @OriginalMember(owner = "client!tg", name = "h", descriptor = "(B)V", line = 199)
    ...
    @OriginalMember(owner = "client!tg", name = "h", descriptor = "(I)Z", line = 218)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(BLjava/io/File;I)[B", line = 258)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILla;Lvn;ILua;Lin;IIILjava/lang/String;IB)V", line = 278)
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(IIIIIIIIIZB)V", line = 325)
