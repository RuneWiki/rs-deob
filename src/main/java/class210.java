...
public abstract class class210 extends class170 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "([BB)[B", line = 4)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(CI)Z", line = 67)
    ...
    @OriginalMember(owner = "client!lb", name = "b", descriptor = "(II)V", line = 98)
    ...
    @OriginalMember(owner = "client!lb", name = "b", descriptor = "(Z)V", line = 135)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(BIIZI)V", line = 146)
