...
public class class210 extends class173 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lwk;B)V", line = 15)
    ...
    @OriginalMember(owner = "client!jb", name = "b", descriptor = "(I)Ljava/lang/String;", line = 60)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IIC)I", line = 90)
    ...
    @OriginalMember(owner = "client!jb", name = "d", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(I)V", line = 126)
