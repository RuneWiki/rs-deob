...
public class class210 extends class394 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IZZI)I", line = 14)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(II)I", line = 37)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Lvj;Ljava/lang/String;II)Ltq;", line = 81)
    ...
    @OriginalMember(owner = "client!db", name = "d", descriptor = "(B)Ljava/lang/Object;", line = 105)
    public final Object method1267(byte arg0) {
        field3029++;
        return arg0 == -94 ? this.field3024 : null;
    }

    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(Lue;Ljava/lang/Object;I)V", line = 116)
