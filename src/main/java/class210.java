...
public abstract class class210 extends class421 {
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(B)Z", line = 19)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(I[BIIII)V", line = 34)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IBILvs;Lza;ZI)V", line = 65)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 80)
    ...
    @OriginalMember(owner = "client!ne", name = "f", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(IIIIIII)V", line = 115)
