...
public class class210 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "([Ljava/lang/String;Z)[Ljava/lang/String;", line = 8)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Lvb;Z)Lkd;", line = 44)
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(I)Lvf;", line = 96)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Lwu;Lwu;)V", line = 122)
