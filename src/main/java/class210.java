...
public class class210 {
    ...
    @OriginalMember(owner = "client!db", name = "b", descriptor = "(I)Lnh;")
    ...
    @OriginalMember(owner = "client!db", name = "c", descriptor = "(I)Lnh;")
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Lnh;Z)V")
