...
public class class210 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(ZI)V", line = 7)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(I)V", line = 25)
    public static void method1396(int arg0) {
        int var1 = -112 % ((-arg0 - 54) / 53);
        field2781 = null;
    }

    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IIIIII)V", line = 36)
