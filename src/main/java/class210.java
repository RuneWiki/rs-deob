...
public class class210 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(BLfo;Lfo;)V")
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(II)Lfn;")
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(Ld;ILfo;Lfo;)V")
