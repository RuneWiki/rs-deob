...
public abstract class class210 implements class264 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!ta", name = "finalize", descriptor = "()V", line = 46)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IZ)V", line = 71)
    ...
    @OriginalMember(owner = "client!ta", name = "c", descriptor = "(I)I", line = 96)
    ...
    @OriginalMember(owner = "client!ta", name = "d", descriptor = "(I)Z", line = 109)
    ...
    @OriginalMember(owner = "client!ta", name = "e", descriptor = "(I)I", line = 134)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lkba;[Lwi;)V", line = 153)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IB[F)[F", line = 223)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ZILeea;Ljava/lang/String;)Lpo;", line = 238)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lfp;BLd;)V", line = 266)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(BII)Z", line = 278)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ZZ)V", line = 290)
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(Leea;IIIZ)V", line = 330)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(II)V", line = 311)
