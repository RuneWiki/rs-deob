...
public abstract class class210 {
    ...
    @OriginalMember(owner = "client!om", name = "finalize", descriptor = "()V", line = 6)
    protected final void finalize() throws Throwable {
        this.field2997.method916(this.field3000, this.field2996);
        super.finalize();
    }

    @OriginalMember(owner = "client!om", name = "a", descriptor = "([BI)V", line = 21)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "()I", line = 37)
    public int method34() {
        return this.field3000;
    }

    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(Lig;I[BIZ)V", line = 40)
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(Lig;ILjava/nio/ByteBuffer;Z)V", line = 57)
