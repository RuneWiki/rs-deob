...
public class class210 {
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(BILria;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(ILria;Lria;)V")
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(ILsl;)V")
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(Lrea;Z)Z")
    ...
    @OriginalMember(owner = "client!rea", name = "<init>", descriptor = "(Lsl;)V")
