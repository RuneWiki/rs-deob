...
public class class210 extends class363 {
    ...
    @OriginalMember(owner = "client!bea", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!bea", name = "e", descriptor = "(I)Lsaa;", line = 19)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(IILwda;)Lqe;", line = 38)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(III[B)[B", line = 68)
    ...
    @OriginalMember(owner = "client!bea", name = "<init>", descriptor = "(Lwj;)V", line = 81)
