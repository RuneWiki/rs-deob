...
public abstract class class210 extends class164 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IIIBI)V", line = 10)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(III)Z", line = 35)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IIZIZI)V", line = 47)
