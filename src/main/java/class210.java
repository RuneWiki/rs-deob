...
public class class210 extends class238 {
    ...
    @OriginalMember(owner = "client!om", name = "c", descriptor = "(IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!om", name = "f", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IIII[BI)V", line = 50)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(III)Z", line = 82)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IZIIIII)V", line = 98)
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(Lpo;II)V", line = 529)
