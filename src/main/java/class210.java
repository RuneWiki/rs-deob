...
public class class210 extends class34 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lsv;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!fn", name = "e", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(BI)[[I", line = 84)
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "()V", line = 174)
    public class210() {
        super(1, false);
    }

    @OriginalMember(owner = "client!fn", name = "d", descriptor = "(B)V", line = 181)
