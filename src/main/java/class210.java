...
public class class210 extends class513 {
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(I)Lwaa;")
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IILfca;)V")
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ZII)Ljq;")
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ILfca;)V")
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "([I[I[IBLfl;)V")
