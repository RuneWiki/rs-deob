...
public class class210 extends class400 {
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(CIIIZLaa;II)V", line = 3)
    public final void method1275(char arg0, int arg1, int arg2, int arg3, boolean arg4, class569 arg5, int arg6, int arg7) {
    }

    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(Lch;Lqt;[Lffa;Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!ho", name = "fa", descriptor = "(CIIIZ)V", line = 313)
