...
public abstract class class210 extends class618 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(I[Lgu;II)I")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(ILd;Ljava/awt/Canvas;B)Lha;")
    ...
    @OriginalMember(owner = "client!lq", name = "h", descriptor = "(B)V")
