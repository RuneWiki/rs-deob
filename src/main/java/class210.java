...
public class class210 extends class376 {
    ...
    @OriginalMember(owner = "client!om", name = "c", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ZLqj;)V", line = 28)
    ...
    @OriginalMember(owner = "client!om", name = "d", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IIIIB)V", line = 70)
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(II)V", line = 95)
    public class210(int arg0, int arg1) {
        this.field2829 = arg0;
        this.field2827 = arg1;
    }

    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IB)I", line = 105)
