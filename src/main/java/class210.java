...
public class class210 extends class204 {
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Lfs;)V")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IZIIIII)V")
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(ILfs;)V")
