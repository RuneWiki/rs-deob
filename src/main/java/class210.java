...
public class class210 {
    ...
    @OriginalMember(owner = "client!wh", name = "c", descriptor = "[Ldf;")
    public static class37[] field4081;

    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(ILsd;III)V")
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IIIILlb;ZIII)V")
