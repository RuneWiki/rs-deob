...
public class class210 extends class257 {
    ...
    @OriginalMember(owner = "client!dh", name = "b", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 12)
    ...
    @OriginalMember(owner = "client!dh", name = "d", descriptor = "()V", line = 37)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "()I", line = 71)
    public final int method1453() {
        return this.field3047 - (this.field3044.available() >> (class241.field3572 ? 2 : 1));
    }

    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 82)
    ...
    @OriginalMember(owner = "client!dh", name = "c", descriptor = "()V", line = 116)
    ...
    @OriginalMember(owner = "client!dh", name = "b", descriptor = "()V", line = 136)
