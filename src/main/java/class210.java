...
public class class210 extends OutputStream {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Lp;I)V")
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(BIILkg;)V")
    ...
    @OriginalMember(owner = "client!bn", name = "write", descriptor = "(I)V")
