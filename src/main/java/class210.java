...
public class class210 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(I)[Lub;")
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IB)Lvq;")
    ...
    @OriginalMember(owner = "client!db", name = "b", descriptor = "(IB)Lmv;")
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(BLjava/lang/String;ZLvh;)Lte;")
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(Llf;ILvh;)V")
