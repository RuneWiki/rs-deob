...
public class class210 {
    ...
    @OriginalMember(owner = "client!oe", name = "b", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lka;BIIIBII)Lka;", line = 37)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(BILwq;)V", line = 98)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lwq;B)V", line = 300)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ZB)V", line = 331)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IILka;IIB)Lka;", line = 343)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(BZII)I", line = 479)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(III)I", line = 614)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(I)V", line = 661)
