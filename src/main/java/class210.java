...
public class class210 {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IILjc;III)V", line = 9)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ILnh;II)V", line = 136)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(I)V", line = 187)
