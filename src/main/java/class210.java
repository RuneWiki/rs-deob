...
public class class210 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(I[BII)V", line = 3)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(I)Ljava/io/File;", line = 21)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(JI)V", line = 48)
    ...
    @OriginalMember(owner = "client!en", name = "finalize", descriptor = "()V", line = 60)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(II[BI)I", line = 73)
    ...
    @OriginalMember(owner = "client!en", name = "b", descriptor = "(I)J", line = 88)
