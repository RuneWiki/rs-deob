...
public class class210 extends class180 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(ZII)I", line = 31)
    ...
    @OriginalMember(owner = "client!qa", name = "c", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IZ)I", line = 57)
    ...
    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "([B)V", line = 95)
    public class210(byte[] arg0) {
        this.field2965 = arg0;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(III)Z", line = 107)
    ...
    @OriginalMember(owner = "client!qa", name = "d", descriptor = "(I)[Lll;", line = 228)
