...
public class class210 extends class501 {
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(BIIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!gca", name = "<init>", descriptor = "(Lln;)V", line = 36)
