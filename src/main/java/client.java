...
public class client extends class395 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lgba;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lgba;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lgba;)Lmk;")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lgba;)Lgba;")
