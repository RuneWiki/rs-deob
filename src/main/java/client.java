...
public class client extends class221 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lne;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(IZLne;I)V")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lne;)Lhk;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lne;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lne;)Lne;")
