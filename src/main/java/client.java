...
public class client extends GameShell {
                                    ...
                                    if (var36 != -1) {
                                        ...
                                        for (int var42 = 0; var42 < this.sceneMapIndex.length; ++var42) {
                                            if (this.sceneMapIndex[var42] == var41 && this.sceneMapLocData[var42] != null) {
                                                var6.readLocRegion(this.levelCollisionMap, this.scene, var37, var34 * 8, (var40 & 7) * 8, true, var33, this.sceneMapLocData[var42], (var39 & 7) * 8, var38, var35 * 8);
                                                break;
                                            }
                                        }
                                    }
                            ...
                            if (var23 != -1) {
                                ...
                                for (int var29 = 0; var29 < this.sceneMapIndex.length; ++var29) {
                                    if (this.sceneMapIndex[var29] == var28 && this.sceneMapLandData[var29] != null) {
                                        var6.readLandRegion(var24, var25, this.levelCollisionMap, 9, var21 * 8, (var26 & 7) * 8, this.sceneMapLandData[var29], (var27 & 7) * 8, var20, var22 * 8);
                                        break;
                                    }
                                }
                            }
            ...
            if (var19 != null && var19.isVisible(_flowObfuscator41)) {
                ...
                if (var19.combatCycle > loopCycle) {
                    ...
                    if (this.projectX > -1) {
                        ...
                        Draw2D.fillRect(5, this.projectY - 3, this.projectX - 15, 65280, var25, 0);
                        Draw2D.fillRect(5, this.projectY - 3, this.projectX - 15 + var25, 16711680, 30 - var25, 0);
                    }
                }
    ...
    public final void loadTitleBackground(int arg0) {
        ...
        if (arg0 == 0) {
            var3.blitOpaque(-180, -171, -32357);
            Pix24 var6 = new Pix24(this.archiveTitle, "logo", 0);
            this.imageTitle2.bind(0);
    ...
    public final void drawProgress(int arg0, byte arg1, String arg2) {
        ...
        if (this.archiveTitle == null) {
            ...
            Draw2D.fillRect(30, var7 + 2, arg0 * 3 + (var4 / 2 - 150), 0, 300 - arg0 * 3, 0);
        ...
        if (started) {
            ...
            if (!var1) {
                ...
                try {
                    ...
                    this.imageCompass = new Pix24(var6, "compass", 0);
                    this.imageMapedge = new Pix24(var6, "mapedge", 0);
                    ...
                    try {
                        for (int var30 = 0; var30 < 100; ++var30) {
                            this.imageMapfunction[var30] = new Pix24(var6, "mapfunction", var30);
                        }
                    } catch (Exception var73) {
                    }
                    try {
                        for (int var31 = 0; var31 < 20; ++var31) {
                            this.imageHitmarks[var31] = new Pix24(var6, "hitmarks", var31);
                        }
                    } catch (Exception var72) {
                    }
                    try {
                        for (int var32 = 0; var32 < 20; ++var32) {
                            this.imageHeadicons[var32] = new Pix24(var6, "headicons", var32);
                        }
                    } catch (Exception var71) {
                    }
                    this.imageMapmarker0 = new Pix24(var6, "mapmarker", 0);
                    this.imageMapmarker1 = new Pix24(var6, "mapmarker", 1);
                    for (int var33 = 0; var33 < 8; ++var33) {
                        this.imageCrosses[var33] = new Pix24(var6, "cross", var33);
                    }
                    this.imageMapdot0 = new Pix24(var6, "mapdots", 0);
                    this.imageMapdot1 = new Pix24(var6, "mapdots", 1);
                    this.imageMapdot2 = new Pix24(var6, "mapdots", 2);
                    this.imageMapdot3 = new Pix24(var6, "mapdots", 3);
                    this.imageMapdot4 = new Pix24(var6, "mapdots", 4);
    ...
    public final void drawInterface(int arg0, int arg1, int arg2, Component arg3, int arg4) {
        ...
        if (arg3.type == 0 && arg3.children != null) {
            if (!arg3.hide || this.viewportHoveredInterfaceIndex == arg3.id || this.sidebarHoveredInterfaceIndex == arg3.id || this.chatHoveredInterfaceIndex == arg3.id) {
                ...
                Draw2D.setBounds(arg3.height + arg4, arg2, false, arg3.width + arg2, arg4);
                ...
                for (int var11 = 0; var11 < var10; ++var11) {
                    ...
                    if (var14.type == 0) {
                        ...
                        if (var14.type == 2) {
                            ...
                            for (int var18 = 0; var18 < var14.height; ++var18) {
                                for (int var19 = 0; var19 < var14.width; ++var19) {
                                    ...
                                    if (var14.invSlotObjId[var17] <= 0) {
                                        ...
                                        if (var20 > Draw2D.left - 32 && var20 < Draw2D.right && var21 > Draw2D.top - 32 && var21 < Draw2D.bottom || this.objDragArea != 0 && this.objDragSlot == var17) {
                                            int var25 = 0;
                                            if (this.objSelected == 1 && this.objSelectedSlot == var17 && this.objSelectedInterface == var14.id) {
                                                var25 = 16777215;
                                            }
                                            Pix24 var26 = ObjType.getIcon(var24, var14.invSlotObjCount[var17], var25, 9);
                                            if (var26 != null) {
                                                if (this.objDragArea != 0 && this.objDragSlot == var17 && this.objDragInterfaceId == var14.id) {
                                                    ...
                                                    if (var21 + var23 < Draw2D.top && arg3.scrollPosition > 0) {
                                                        int var27 = (Draw2D.top - var21 - var23) * this.sceneDelta / 3;
                                                    ...
                                                    if (var21 + var23 + 32 > Draw2D.bottom && arg3.scrollPosition < arg3.scroll - arg3.height) {
                                                        int var28 = (var21 + var23 + 32 - Draw2D.bottom) * this.sceneDelta / 3;
                            ...
                            if (var14.alpha == 0) {
                                if (var14.fill) {
                                    Draw2D.fillRect(var14.height, var16, var15, var32, var14.width, 0);
                                } else {
                                    Draw2D.drawRect(var15, var14.width, var14.height, var32, var16, true);
                                }
                            } else if (var14.fill) {
                                Draw2D.fillRect(var32, var16, var14.width, var14.height, 256 - (var14.alpha & 255), 0, var15);
                            } else {
                                Draw2D.drawRect(var16, var14.height, 256 - (var14.alpha & 255), var32, var14.width, var15, -17319);
                            }
                            ...
                            Draw3D.centerX = var14.width / 2 + var15;
                            Draw3D.centerY = var14.height / 2 + var16;
                            int var48 = Draw3D.sin[var14.xan] * var14.zoom >> 16;
                            int var49 = Draw3D.cos[var14.xan] * var14.zoom >> 16;
    ...
    private final void updateTemporaryLocs(byte arg0) {
        ...
        if (this.sceneState == 2) {
            for (LocSpawned var3 = (LocSpawned) this.temporaryLocs.head(); var3 != null; var3 = (LocSpawned) this.temporaryLocs.next(false)) {
                if (var3.duration > 0) {
                    --var3.duration;
                }
                if (var3.duration == 0) {
    ...
    public final void projectFromGround(int arg0, int arg1, int arg2, int arg3) {
        if (arg0 >= 128 && arg3 >= 128 && arg0 <= 13056 && arg3 <= 13056) {
            ...
            if (var17 >= 50) {
                this.projectX = (var13 << 9) / var17 + Draw3D.centerX;
                this.projectY = (var16 << 9) / var17 + Draw3D.centerY;
            } else {
                this.projectX = -1;
                this.projectY = -1;
            }
        ...
        if (arg2 == 84) {
            ...
            if (arg2 == 215) {
                ...
                if (var33 >= 0 && var34 >= 0 && var33 < 103 && var34 < 103) {
                    ...
                    if (var38 == 1) {
                        WallDecoration var46 = this.scene.getWallDecoration(var33, 866, var34, this.currentLevel);
                        if (var46 != null) {
                            var46.model = new LocEntity(var46.bitset >> 14 & 32767, 0, 4, var41, (byte) 7, var42, var40, var43, var39, false);
                        }
                    }
                    if (var38 == 2) {
                        Loc var47 = this.scene.getLoc(var33, var34, (byte) 4, this.currentLevel);
                        if (var36 == 11) {
                            var36 = 10;
                        }
                        if (var47 != null) {
                    ...
                    if (var38 == 3) {
                        GroundDecoration var48 = this.scene.getGroundDecoration(var34, var33, this.currentLevel, 0);
                        if (var48 != null) {
        ...
        if (this.stream == null) {
            ...
            try {
                ...
                if (this.packetType == 64) {
                    ...
                    for (LocSpawned var7 = (LocSpawned) this.temporaryLocs.head(); var7 != null; var7 = (LocSpawned) this.temporaryLocs.next(false)) {
                ...
                if (this.packetType == 73 || this.packetType == 241) {
                    ...
                    for (LocSpawned var76 = (LocSpawned) this.temporaryLocs.head(); var76 != null; var76 = (LocSpawned) this.temporaryLocs.next(false)) {
                        var76.localX -= var57;
                        var76.localZ -= var58;
