...
public class client extends class229 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(IIIIILqa;III)V")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Let;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Let;)Let;")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Let;)Ldb;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Let;IIIIIIIII)V")
