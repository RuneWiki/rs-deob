...
public class client extends class471 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lgo;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(III)Luc;")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lgo;)Lff;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lgo;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lgo;)Lgo;")
