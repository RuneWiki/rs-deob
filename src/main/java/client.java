...
public class client extends class305 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lor;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lor;IIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lor;)Lor;")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lor;)Lqha;")
