...
public class client extends class407 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lbr;)Ld;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(ZLjava/lang/String;ILtj;)Lna;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lbr;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lbr;)Lbr;")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lbr;)Z")
