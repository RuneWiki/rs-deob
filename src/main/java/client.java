...
public class client extends class281 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lrg;BZ)V")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lps;)Liga;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lps;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lps;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lps;)Lps;")
