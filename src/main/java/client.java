...
public class client extends class359 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lvfa;)Lvfa;")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lvfa;)Lwfa;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lvfa;IIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lvfa;)Z")
