...
public class client extends class341 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Ljb;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Ljb;)Llia;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Ljb;IIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Ljb;)Ljb;")
