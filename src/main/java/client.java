...
public class client extends class237 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lps;IIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lps;)Lps;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(II)Lsc;")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lps;)Ldj;")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lps;)Z")
