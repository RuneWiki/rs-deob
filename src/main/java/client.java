...
public class client extends class448 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(ILaa;ILrg;I)V")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lrg;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lrg;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lrg;)Lrg;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(IB)Lui;")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lrg;)Lsj;")
