...
public class client extends class530 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lga;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Luu;Luu;Lqa;B)V")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lga;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lga;)Lga;")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lga;)Ltl;")
