...
public class client extends class355 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lat;)Lwb;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lat;IIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lat;)Lat;")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lat;)Z")
