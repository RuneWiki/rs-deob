...
public class client extends class286 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lza;BJ)V")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lgh;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lgh;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lgh;)Lqm;")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lgh;)Lgh;")
