...
public class client extends class529 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lep;)Lep;")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lep;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lep;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lep;)Ltf;")
