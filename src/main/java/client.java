...
public class client extends class95 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Luq;)Luq;")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Luq;)Lel;")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Luq;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Luq;IIIIIIIII)V")
