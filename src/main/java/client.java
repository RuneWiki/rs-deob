...
public class client extends class526 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lwca;)Lwca;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lwca;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lwca;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lwca;)Lqe;")
