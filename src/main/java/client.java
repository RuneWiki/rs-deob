...
public class client extends class291 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Ltq;)Ltq;")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Ltq;)Lrf;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Ltq;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lut;B)V")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Ltq;)Z")
