...
public class client extends class234 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lsba;)Lsba;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lsba;IIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lsba;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lsba;)Lwaa;")
