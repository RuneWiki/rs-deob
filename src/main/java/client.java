...
public class client extends class93 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lec;)Lnj;")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lec;)Lec;")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lec;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lec;IIIIIIIII)V")
