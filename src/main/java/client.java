...
public class client extends class303 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Ljk;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Ljk;)Ljo;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Ljk;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Ljava/lang/Object;Lfq;I)V")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Ljk;)Ljk;")
