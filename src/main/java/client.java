...
public class client extends class121 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lem;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lem;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lem;)Luu;")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lem;)Lem;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(ILsk;II)V")
