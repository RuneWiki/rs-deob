...
public class client extends class144 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lsca;)Lue;")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lsca;)Lsca;")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lsca;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lsca;IIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lsca;II)I")
