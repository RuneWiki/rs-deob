...
public class client extends class285 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lab;)Lmb;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lab;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lab;)Lab;")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lab;)Z")
