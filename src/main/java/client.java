...
public class client extends class387 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lat;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lat;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lat;)Leo;")
