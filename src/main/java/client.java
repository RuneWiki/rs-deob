...
public class client extends class705 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lpaa;)Lrm;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(IIIILep;I)Ldd;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lpaa;IIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lpaa;)Lpaa;")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lpaa;)Z")
