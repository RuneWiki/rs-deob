...
public class client extends class388 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lon;)Lon;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lon;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lon;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lon;)Lbi;")
