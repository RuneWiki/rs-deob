...
public class client extends class281 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Laq;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Laq;)Laq;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Laq;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Laq;)Lwi;")
