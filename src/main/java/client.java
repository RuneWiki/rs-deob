...
public class client extends class6 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lmb;IIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lmb;)Lrd;")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lmb;)Lmb;")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lmb;)Z")
