...
public class client extends class598 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(ZLpca;)V")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lpca;)Lpca;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lpca;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lpca;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lpca;)Lgv;")
