...
public class client extends GameShell {
    ...
    @OriginalMember(owner = "client!client", name = "Wb", descriptor = "[[[Lob;")
    ...
    @OriginalMember(owner = "client!client", name = "Qc", descriptor = "Lob;")
    ...
    @OriginalMember(owner = "client!client", name = "id", descriptor = "[Ljc;")
    ...
    private Pix24[] field1365 = new Pix24[8];

    @OriginalMember(owner = "client!client", name = "yd", descriptor = "Lob;")
    ...
    @OriginalMember(owner = "client!client", name = "Hd", descriptor = "[Lib;")
    private Pix24[] field1379 = new Pix24[20];

    @OriginalMember(owner = "client!client", name = "Id", descriptor = "Llb;")
    ...
    @OriginalMember(owner = "client!client", name = "ue", descriptor = "Llb;")
    ...
    @OriginalMember(owner = "client!client", name = "Le", descriptor = "[Lib;")
    private Pix24[] field1435 = new Pix24[1000];
    ...
    @OriginalMember(owner = "client!client", name = "Af", descriptor = "[Lab;")
    ...
    @OriginalMember(owner = "client!client", name = "Ff", descriptor = "[Llb;")
    private Packet[] field1480 = new Packet[this.field1473];

    @OriginalMember(owner = "client!client", name = "Gf", descriptor = "[Lib;")
    private Pix24[] field1481 = new Pix24[100];
    ...
    @OriginalMember(owner = "client!client", name = "pg", descriptor = "Ld;")
    ...
    @OriginalMember(owner = "client!client", name = "ci", descriptor = "Lob;")
    ...
    @OriginalMember(owner = "client!client", name = "ii", descriptor = "Llb;")
    ...
    @OriginalMember(owner = "client!client", name = "yi", descriptor = "[Lib;")
    private Pix24[] field1629 = new Pix24[20];
    ...
    @OriginalMember(owner = "client!client", name = "Aj", descriptor = "[Lz;")
    ...
    @OriginalMember(owner = "client!client", name = "gb", descriptor = "Le;")
    private ClientStream field1248;

    @OriginalMember(owner = "client!client", name = "ke", descriptor = "Lwb;")
    private Isaac field1408;

    @OriginalMember(owner = "client!client", name = "Yb", descriptor = "Lxb;")
    private Jagfile field1292;

    @OriginalMember(owner = "client!client", name = "Kj", descriptor = "Lfc;")
    public MouseTracking field1693;

    @OriginalMember(owner = "client!client", name = "Bg", descriptor = "Lub;")
    private OnDemand field1528;

    @OriginalMember(owner = "client!client", name = "jc", descriptor = "Lib;")
    private Pix24 field1303;

    @OriginalMember(owner = "client!client", name = "kc", descriptor = "Lib;")
    private Pix24 field1304;

    @OriginalMember(owner = "client!client", name = "lc", descriptor = "Lib;")
    private Pix24 field1305;

    @OriginalMember(owner = "client!client", name = "mc", descriptor = "Lib;")
    private Pix24 field1306;

    @OriginalMember(owner = "client!client", name = "rc", descriptor = "Lib;")
    private Pix24 field1311;

    @OriginalMember(owner = "client!client", name = "qd", descriptor = "Lib;")
    private Pix24 field1362;

    @OriginalMember(owner = "client!client", name = "me", descriptor = "Lib;")
    private Pix24 field1410;

    @OriginalMember(owner = "client!client", name = "Nf", descriptor = "Lib;")
    private Pix24 field1488;

    @OriginalMember(owner = "client!client", name = "Of", descriptor = "Lib;")
    private Pix24 field1489;

    @OriginalMember(owner = "client!client", name = "Ng", descriptor = "Lib;")
    private Pix24 field1540;

    @OriginalMember(owner = "client!client", name = "Og", descriptor = "Lib;")
    private Pix24 field1541;

    @OriginalMember(owner = "client!client", name = "gh", descriptor = "Lib;")
    private Pix24 field1559;

    @OriginalMember(owner = "client!client", name = "hh", descriptor = "Lib;")
    private Pix24 field1560;
    ...
    @OriginalMember(owner = "client!client", name = "zd", descriptor = "Ljb;")
    private Pix8 field1371;

    @OriginalMember(owner = "client!client", name = "Ad", descriptor = "Ljb;")
    private Pix8 field1372;

    @OriginalMember(owner = "client!client", name = "Bd", descriptor = "Ljb;")
    private Pix8 field1373;

    @OriginalMember(owner = "client!client", name = "pe", descriptor = "Ljb;")
    private Pix8 field1413;

    @OriginalMember(owner = "client!client", name = "qe", descriptor = "Ljb;")
    private Pix8 field1414;

    @OriginalMember(owner = "client!client", name = "re", descriptor = "Ljb;")
    ...
    @OriginalMember(owner = "client!client", name = "Yf", descriptor = "Ljb;")
    ...
    @OriginalMember(owner = "client!client", name = "qj", descriptor = "Lkb;")
    private PixFont field1673;

    @OriginalMember(owner = "client!client", name = "rj", descriptor = "Lkb;")
    private PixFont field1674;

    @OriginalMember(owner = "client!client", name = "sj", descriptor = "Lkb;")
    private PixFont field1675;

    @OriginalMember(owner = "client!client", name = "tj", descriptor = "Lkb;")
    private PixFont field1676;

    @OriginalMember(owner = "client!client", name = "Cb", descriptor = "Lqb;")
    ...
    @OriginalMember(owner = "client!client", name = "kh", descriptor = "Lqb;")
    private PixMap field1563;

    @OriginalMember(owner = "client!client", name = "lh", descriptor = "Lqb;")
    private PixMap field1564;

    @OriginalMember(owner = "client!client", name = "mh", descriptor = "Lqb;")
    private PixMap field1565;

    @OriginalMember(owner = "client!client", name = "Qi", descriptor = "Lqb;")
    private PixMap field1647;

    @OriginalMember(owner = "client!client", name = "Ri", descriptor = "Lqb;")
    private PixMap field1648;

    @OriginalMember(owner = "client!client", name = "Si", descriptor = "Lqb;")
    private PixMap field1649;

    @OriginalMember(owner = "client!client", name = "Ti", descriptor = "Lqb;")
    private PixMap field1650;

    @OriginalMember(owner = "client!client", name = "Ui", descriptor = "Lqb;")
    private PixMap field1651;

    @OriginalMember(owner = "client!client", name = "Vi", descriptor = "Lqb;")
    ...
    @OriginalMember(owner = "client!client", name = "ij", descriptor = "Lqb;")
    private PixMap field1665;

    @OriginalMember(owner = "client!client", name = "jj", descriptor = "Lqb;")
    private PixMap field1666;

    @OriginalMember(owner = "client!client", name = "kj", descriptor = "Lqb;")
    private PixMap field1667;

    @OriginalMember(owner = "client!client", name = "lj", descriptor = "Lqb;")
    private PixMap field1668;

    @OriginalMember(owner = "client!client", name = "mj", descriptor = "Lqb;")
    private PixMap field1669;

    @OriginalMember(owner = "client!client", name = "nj", descriptor = "Lqb;")
    private PixMap field1670;

    @OriginalMember(owner = "client!client", name = "xd", descriptor = "Lab;")
    public static PlayerEntity field1369;

    @OriginalMember(owner = "client!client", name = "ji", descriptor = "Lr;")
    ...
    public final void method448(byte arg0) {
        ...
        Draw3D.field645 = this.field1615;
        ...
        if (this.field1639) {
            ...
            int var4 = 0;
            Draw2D.method154(0, 463, 0, (byte) 2, 77);
        ...
        this.field1272.method258(this.field1310);
        Draw3D.field645 = this.field1617;
    }
    ...
    public final void method452(int arg0, Pix24 arg1, int arg2, int arg3) {
        if (arg2 <= 0) {
            this.field1544 = -1;
        }
            ...
            if (var19 != null && var19.method113((byte) -84)) {
                ...
                if (var19.field418 > field1401) {
                    ...
                    if (this.field1583 > -1) {
                        ...
                        Draw2D.method157(this.field1584 - 3, 5, 65280, false, var25, this.field1583 - 15);
                        Draw2D.method157(this.field1584 - 3, 5, 16711680, false, 30 - var25, this.field1583 - 15 + var25);
                    }
                }
        ...
        for (int var3 = 0; var3 < this.field1596; ++var3) {
            ...
            if (this.field1438 == 0) {
                ...
                if (this.field1603[var3] == 4) {
                    ...
                    Draw2D.method154(this.field1583 - 50, this.field1583 + 50, 0, (byte) 2, 334);
                ...
                if (this.field1603[var3] == 5) {
                    ...
                    Draw2D.method154(0, 512, this.field1584 - this.field1675.field702 - 1, (byte) 2, this.field1584 + 5);
    ...
    public final void method455(byte arg0) {
        ...
        Draw3D.field645 = this.field1616;
    ...
    public final void method456(int arg0) {
        ...
        if (this.field1493 == 2) {
            ...
            Draw2D.method157(78, 3, 16777215, false, 3, 97);
            this.field1272.method258(this.field1310);
        }
    }
        ...
        if (arg2 != 136 && arg2 != 211) {
            if (arg2 == 2) {
                ...
                if (var5 >= 0 && var6 >= 0 && var5 < 103 && var6 < 103) {
                    ...
                    if (var10 == 1) {
                        WallDecoration var18 = this.field1614.method73(-38749, var5, this.field1295, var6);
                        if (var18 != null) {
                            var18.field165 = new LocEntity(var15, false, 4, 0, var12, var13, var14, 0, var18.field166 >> 14 & 32767, var11);
                        }
                    }
                    if (var10 == 2) {
                        Loc var19 = this.field1614.method74(var6, this.field1295, -709, var5);
                        if (var8 == 11) {
                            var8 = 10;
                        }
                        if (var19 != null) {
                    ...
                    if (var10 == 3) {
                        GroundDecoration var20 = this.field1614.method75(this.field1295, 3, var6, var5);
                        if (var20 != null) {
    ...
    public final void method469(boolean arg0, Pix24 arg1, int arg2, int arg3) {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(ILlb;Lab;II)V")
    ...
    public final void method479(int arg0, int arg1, int arg2, int arg3) {
        if (arg2 >= 128 && arg0 >= 128 && arg2 <= 13056 && arg0 <= 13056) {
            ...
            if (var18 >= 50) {
                this.field1583 = (var14 << 9) / var18 + Draw3D.field639;
                this.field1584 = (var17 << 9) / var18 + Draw3D.field640;
            } else {
                this.field1583 = -1;
                this.field1584 = -1;
            }
    ...
    public final void method489(boolean arg0, int arg1) {
        ...
        if (!field1512) {
            if (Draw3D.field653[17] >= arg1) {
                ...
                var3.field679 = var7;
                this.field1331 = var6;
                Draw3D.method171(17, -571);
            }
            if (Draw3D.field653[24] >= arg1) {
                ...
                Draw3D.method171(24, -571);
            }
            if (Draw3D.field653[34] >= arg1) {
        ...
        if (field1494) {
            ...
            if (!var1) {
                ...
                try {
                    ...
                    this.field1362 = new Pix24(512, 512);
                    ...
                    this.field1410 = new Pix24(var6, "compass", 0);
                    this.field1311 = new Pix24(var6, "mapedge", 0);
                    ...
                    try {
                        for (int var30 = 0; var30 < 100; ++var30) {
                            this.field1481[var30] = new Pix24(var6, "mapfunction", var30);
                        }
                    } catch (Exception var73) {
                    }
                    try {
                        for (int var31 = 0; var31 < 20; ++var31) {
                            this.field1379[var31] = new Pix24(var6, "hitmarks", var31);
                        }
                    } catch (Exception var72) {
                    }
                    try {
                        for (int var32 = 0; var32 < 20; ++var32) {
                            this.field1629[var32] = new Pix24(var6, "headicons", var32);
                        }
                    } catch (Exception var71) {
                    }
                    this.field1540 = new Pix24(var6, "mapmarker", 0);
                    this.field1541 = new Pix24(var6, "mapmarker", 1);
                    for (int var33 = 0; var33 < 8; ++var33) {
                        this.field1365[var33] = new Pix24(var6, "cross", var33);
                    }
                    this.field1303 = new Pix24(var6, "mapdots", 0);
                    this.field1304 = new Pix24(var6, "mapdots", 1);
                    this.field1305 = new Pix24(var6, "mapdots", 2);
                    this.field1306 = new Pix24(var6, "mapdots", 3);
                    ...
                    Draw3D.method169(var7, -776);
                    Draw3D.method173(field1439, 0.8D);
                    Draw3D.method168(7, 20);
                    ...
                    Draw3D.method166(479, 96, field1230);
                    this.field1615 = Draw3D.field645;
                    Draw3D.method166(190, 261, field1230);
                    this.field1616 = Draw3D.field645;
                    Draw3D.method166(512, 334, field1230);
                    this.field1617 = Draw3D.field645;
                    int[] var60 = new int[9];
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(ILlb;B)V")
    ...
    public final void method522(int arg0) {
        ...
        this.field1488 = new Pix24(128, 265);
        this.field1489 = new Pix24(128, 265);
        ...
        if (this.field1493 == 0) {
            if (super.field30 == 1) {
                ...
                if (var3 >= 0 && var4 >= 0 && var3 < 146 && var4 < 151) {
                    ...
                    var4 -= 75;
                    int var5 = this.field1660 + this.field1588 & 2047;
                    int var6 = Draw3D.field643[var5];
                    int var7 = Draw3D.field644[var5];
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(ILd;IIBII)V")
    ...
    public final void method13(byte arg0, int arg1, String arg2) {
        ...
        if (this.field1292 == null) {
            ...
            Draw2D.method158(var4 / 2 - 152, var7, 304, 531, 9179409, 34);
            Draw2D.method158(var4 / 2 - 151, var7 + 1, 302, 531, 0, 32);
            Draw2D.method157(var7 + 2, 30, 9179409, false, arg1 * 3, var4 / 2 - 150);
            Draw2D.method157(var7 + 2, 30, 0, false, 300 - arg1 * 3, arg1 * 3 + (var4 / 2 - 150));
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(ILy;)V")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Ljava/lang/String;IIIILjava/lang/String;)Lxb;")
    ...
    public final void method537(int arg0, int arg1, int arg2, boolean arg3, int arg4, int arg5) {
        ...
        Draw2D.method157(arg4 + 16, arg5 - 32, this.field1458, false, 16, arg0);
        this.field1398 &= arg3;
        ...
        Draw2D.method157(arg4 + 16 + var8, var7, this.field1294, false, 16, arg0);
        Draw2D.method162(this.field1339, var7, arg0, 11, arg4 + 16 + var8);
        Draw2D.method162(this.field1339, var7, arg0 + 1, 11, arg4 + 16 + var8);
        Draw2D.method160(arg4 + 16 + var8, 5, arg0, this.field1339, 16);
        Draw2D.method160(arg4 + 17 + var8, 5, arg0, this.field1339, 16);
        Draw2D.method162(this.field1503, var7, arg0 + 15, 11, arg4 + 16 + var8);
        Draw2D.method162(this.field1503, var7 - 1, arg0 + 14, 11, arg4 + 17 + var8);
        Draw2D.method160(arg4 + 15 + var8 + var7, 5, arg0, this.field1503, 16);
        Draw2D.method160(arg4 + 14 + var8 + var7, 5, arg0 + 1, this.field1503, 15);
    }
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(IBIILd;)V")
    public final void method546(int arg0, byte arg1, int arg2, int arg3, Component arg4) {
        if (arg4.field78 == 0 && arg4.field93 != null) {
            if (!arg4.field92 || this.field1307 == arg4.field76 || this.field1507 == arg4.field76 || this.field1277 == arg4.field76) {
                ...
                Draw2D.method154(arg0, arg4.field81 + arg0, arg3, (byte) 2, arg4.field82 + arg3);
                ...
                for (int var11 = 0; var11 < var10; ++var11) {
                    ...
                    if (var14.field78 == 0) {
                        ...
                        if (var14.field78 == 2) {
                                ...
                                for (int var19 = 0; var19 < var14.field81; ++var19) {
                                    ...
                                    if (var14.field72[var17] <= 0) {
                                        if (var14.field104 != null && var17 < 20) {
                                            Pix24 var30 = var14.field104[var17];
                                            if (var30 != null) {
                                        ...
                                        if (var20 > Draw2D.field626 - 32 && var20 < Draw2D.field627 && var21 > Draw2D.field624 - 32 && var21 < Draw2D.field625 || this.field1623 != 0 && this.field1622 == var17) {
                                            int var25 = 0;
                                            if (this.field1258 == 1 && this.field1259 == var17 && this.field1260 == var14.field76) {
                                                var25 = 16777215;
                                            }
                                            Pix24 var26 = ObjType.method354(var14.field73[var17], this.field1432, var25, var24);
                                            if (var26 != null) {
                                                if (this.field1623 != 0 && this.field1622 == var17 && this.field1621 == var14.field76) {
                                                    ...
                                                    if (var21 + var23 < Draw2D.field624 && arg4.field91 > 0) {
                                                        int var27 = (Draw2D.field624 - var21 - var23) * this.field1228 / 3;
                                                    ...
                                                    if (var21 + var23 + 32 > Draw2D.field625 && arg4.field91 < arg4.field90 - arg4.field82) {
                                                        int var28 = (var21 + var23 + 32 - Draw2D.field625) * this.field1228 / 3;
                            ...
                            if (var14.field83 == 0) {
                                if (var14.field108) {
                                    Draw2D.method157(var16, var14.field82, var32, false, var14.field81, var15);
                                } else {
                                    Draw2D.method158(var15, var16, var14.field81, 531, var32, var14.field82);
                                }
                            } else if (var14.field108) {
                                Draw2D.method156(var14.field81, var16, var14.field82, var15, 256 - (var14.field83 & 255), false, var32);
                            } else {
                                Draw2D.method159(var32, var16, true, 256 - (var14.field83 & 255), var14.field82, var15, var14.field81);
                            }
                            ...
                            Draw3D.field639 = var14.field81 / 2 + var15;
                            Draw3D.field640 = var14.field82 / 2 + var16;
                            int var48 = Draw3D.field643[var14.field127] * var14.field126 >> 16;
                            int var49 = Draw3D.field644[var14.field127] * var14.field126 >> 16;
                ...
                Draw2D.method154(var6, var8, var7, (byte) 2, var9);
                if (arg1 != 7) {
                    this.field1290 = null;
                }
            }
    ...
    public final void method550(int arg0, byte arg1) {
        ...
        if (var3 != 0) {
            ...
            if (var3 == 1) {
                if (var4 == 1) {
                    Draw3D.method173(field1439, 0.9D);
                }
                if (var4 == 2) {
                    Draw3D.method173(field1439, 0.8D);
                }
                if (var4 == 3) {
                    Draw3D.method173(field1439, 0.7D);
                }
                if (var4 == 4) {
                    Draw3D.method173(field1439, 0.6D);
                }
                ObjType.field1097.method103();
                this.field1430 = true;
            }
    ...
    public final void method552(int arg0) {
        ...
        this.field1670.method258(this.field1310);
        var3.method184(-180, -171, 1);
        Pix24 var6 = new Pix24(this.field1292, "logo", 0);
        this.field1662.method258(this.field1310);
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(ILlb;B)V")
    ...
    public final void method557(boolean arg0) {
        ...
        int var6 = 6116423;
        Draw2D.method157(var3, var5, var6, false, var4, var2);
        this.field1398 &= arg0;
        Draw2D.method157(var3 + 1, 16, 0, false, var4 - 2, var2 + 1);
        Draw2D.method158(var2 + 1, var3 + 18, var4 - 2, 531, 0, var5 - 19);
