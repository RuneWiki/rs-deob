...
public class client extends class374 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lcr;)Lek;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lcr;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lcr;)Lcr;")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lcr;)Z")
