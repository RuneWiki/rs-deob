...
public class client extends class658 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lkp;)Lkp;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lkp;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lkp;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lkp;)Lnm;")
