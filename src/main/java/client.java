...
public class client extends class319 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lfca;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lfca;)Lfca;")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lfca;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lfca;)Lsca;")
