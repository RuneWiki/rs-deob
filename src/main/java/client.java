...
public class client extends class437 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lhd;)Ljr;")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lhd;)Lhd;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(IBLtf;)V")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lhd;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lhd;IIIIIIIII)V")
