...
public class client extends class267 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lnk;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lnk;)Z")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lnk;)Leh;")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lnk;)Lnk;")
