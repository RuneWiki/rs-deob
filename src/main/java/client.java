...
public class client extends class764 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lsha;)Lnp;")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lsha;)Lsha;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lsha;IIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lsha;)Z")
