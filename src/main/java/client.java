...
public class client extends class444 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lae;)Lae;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lae;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lae;)Lcc;")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lae;)Z")
