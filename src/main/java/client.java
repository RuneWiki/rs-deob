...
public class client extends class223 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Lss;)Lvt;")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Lss;)Lss;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Lss;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Lss;)Z")
