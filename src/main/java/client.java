...
public class client extends class414 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Ltp;)Ltp;")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Ltp;)Llo;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Ltp;IIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "c", descriptor = "(Ltp;)Z")
