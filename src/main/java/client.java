...
public class client extends GameShell {
    ...
    @OriginalMember(owner = "client", name = "N", descriptor = "[[[LLHGXPZPG;")
    ...
    @OriginalMember(owner = "client", name = "U", descriptor = "LMBMGIXGO;")
    private Packet chatBuffer = new Packet(new byte[5000], 891);

    @OriginalMember(owner = "client", name = "V", descriptor = "[LCWNCPMLX;")
    ...
    @OriginalMember(owner = "client", name = "hb", descriptor = "LMBMGIXGO;")
    ...
    @OriginalMember(owner = "client", name = "Yb", descriptor = "[LDLZHLHNK;")
    ...
    @OriginalMember(owner = "client", name = "dc", descriptor = "[LMBMGIXGO;")
    ...
    @OriginalMember(owner = "client", name = "Fc", descriptor = "B")
    ...
    @OriginalMember(owner = "client", name = "Mc", descriptor = "Ljava/util/zip/CRC32;")
    ...
    @OriginalMember(owner = "client", name = "dd", descriptor = "[LDSMJIEPN;")
    ...
    @OriginalMember(owner = "client", name = "Ad", descriptor = "[LIGSLDTHC;")
    ...
    @OriginalMember(owner = "client", name = "Rd", descriptor = "[LCXGZMTJK;")
    ...
    @OriginalMember(owner = "client", name = "re", descriptor = "LLHGXPZPG;")
    ...
    @OriginalMember(owner = "client", name = "Le", descriptor = "[LCXGZMTJK;")
    private Pix32[] imageMapfunction = new Pix32[100];
    ...
    @OriginalMember(owner = "client", name = "jf", descriptor = "LLHGXPZPG;")
    ...
    @OriginalMember(owner = "client", name = "mf", descriptor = "LDUCMKFAY;")
    private Component chatInterface = new Component();

    @OriginalMember(owner = "client", name = "nf", descriptor = "[LDSMJIEPN;")
    ...
    @OriginalMember(owner = "client", name = "Kf", descriptor = "LMBMGIXGO;")
    ...
    @OriginalMember(owner = "client", name = "Wf", descriptor = "[LCXGZMTJK;")
    ...
    @OriginalMember(owner = "client", name = "Pg", descriptor = "[LCXGZMTJK;")
    ...
    @OriginalMember(owner = "client", name = "Zg", descriptor = "[LCXGZMTJK;")
    ...
    @OriginalMember(owner = "client", name = "Ch", descriptor = "LLHGXPZPG;")
    private LinkList spawnedLocs = new LinkList(169);
    ...
    @OriginalMember(owner = "client", name = "Ph", descriptor = "LMBMGIXGO;")
    ...
    @OriginalMember(owner = "client", name = "qi", descriptor = "[LDSMJIEPN;")
    ...
    @OriginalMember(owner = "client", name = "Bi", descriptor = "[LFTPNODIB;")
    ...
    @OriginalMember(owner = "client", name = "Ke", descriptor = "Ljava/math/BigInteger;")
    ...
    @OriginalMember(owner = "client", name = "mi", descriptor = "J")
    private long serverSeed;

    @OriginalMember(owner = "client", name = "jd", descriptor = "J")
    private long socialName37;

    @OriginalMember(owner = "client", name = "rh", descriptor = "LNQABEVLK;")
    private ClientStream stream;

    @OriginalMember(owner = "client", name = "ee", descriptor = "LJOCFVBOI;")
    private Isaac randomIn;

    @OriginalMember(owner = "client", name = "ff", descriptor = "LXTGLDHGX;")
    private Jagfile archiveTitle;

    @OriginalMember(owner = "client", name = "Nb", descriptor = "LZIJPRJEC;")
    public MouseTracking mouseTracking;

    @OriginalMember(owner = "client", name = "vf", descriptor = "LGHOWLKWN;")
    private OnDemand ondemand;

    @OriginalMember(owner = "client", name = "Nc", descriptor = "LCXGZMTJK;")
    private Pix32 genderButtonImage0;

    @OriginalMember(owner = "client", name = "Oc", descriptor = "LCXGZMTJK;")
    private Pix32 genderButtonImage1;

    @OriginalMember(owner = "client", name = "xg", descriptor = "LCXGZMTJK;")
    private Pix32 imageCompass;

    @OriginalMember(owner = "client", name = "Yh", descriptor = "LCXGZMTJK;")
    private Pix32 imageFlamesLeft;

    @OriginalMember(owner = "client", name = "Zh", descriptor = "LCXGZMTJK;")
    private Pix32 imageFlamesRight;

    @OriginalMember(owner = "client", name = "Bf", descriptor = "LCXGZMTJK;")
    private Pix32 imageMapdot0;

    @OriginalMember(owner = "client", name = "Cf", descriptor = "LCXGZMTJK;")
    private Pix32 imageMapdot1;

    @OriginalMember(owner = "client", name = "Df", descriptor = "LCXGZMTJK;")
    private Pix32 imageMapdot2;

    @OriginalMember(owner = "client", name = "Ef", descriptor = "LCXGZMTJK;")
    private Pix32 imageMapdot3;

    @OriginalMember(owner = "client", name = "Ff", descriptor = "LCXGZMTJK;")
    private Pix32 imageMapdot4;

    @OriginalMember(owner = "client", name = "fe", descriptor = "LCXGZMTJK;")
    private Pix32 imageMapedge;

    @OriginalMember(owner = "client", name = "Eb", descriptor = "LCXGZMTJK;")
    private Pix32 imageMapmarker0;

    @OriginalMember(owner = "client", name = "Fb", descriptor = "LCXGZMTJK;")
    private Pix32 imageMapmarker1;

    @OriginalMember(owner = "client", name = "ij", descriptor = "LCXGZMTJK;")
    private Pix32 imageMinimap;

    @OriginalMember(owner = "client", name = "Fe", descriptor = "LDSMJIEPN;")
    private Pix8 imageBackbase1;

    @OriginalMember(owner = "client", name = "Ge", descriptor = "LDSMJIEPN;")
    private Pix8 imageBackbase2;

    @OriginalMember(owner = "client", name = "He", descriptor = "LDSMJIEPN;")
    private Pix8 imageBackhmid1;

    @OriginalMember(owner = "client", name = "Vh", descriptor = "LDSMJIEPN;")
    private Pix8 imageChatback;

    @OriginalMember(owner = "client", name = "Th", descriptor = "LDSMJIEPN;")
    private Pix8 imageInvback;

    @OriginalMember(owner = "client", name = "Uh", descriptor = "LDSMJIEPN;")
    private Pix8 imageMapback;

    @OriginalMember(owner = "client", name = "Sg", descriptor = "LDSMJIEPN;")
    private Pix8 imageRedstone1;

    @OriginalMember(owner = "client", name = "Vg", descriptor = "LDSMJIEPN;")
    private Pix8 imageRedstone1h;

    @OriginalMember(owner = "client", name = "Cb", descriptor = "LDSMJIEPN;")
    private Pix8 imageRedstone1hv;

    @OriginalMember(owner = "client", name = "zb", descriptor = "LDSMJIEPN;")
    private Pix8 imageRedstone1v;

    @OriginalMember(owner = "client", name = "Tg", descriptor = "LDSMJIEPN;")
    private Pix8 imageRedstone2;

    @OriginalMember(owner = "client", name = "Wg", descriptor = "LDSMJIEPN;")
    private Pix8 imageRedstone2h;

    @OriginalMember(owner = "client", name = "Db", descriptor = "LDSMJIEPN;")
    private Pix8 imageRedstone2hv;

    @OriginalMember(owner = "client", name = "Ab", descriptor = "LDSMJIEPN;")
    private Pix8 imageRedstone2v;

    @OriginalMember(owner = "client", name = "Ug", descriptor = "LDSMJIEPN;")
    private Pix8 imageRedstone3;

    @OriginalMember(owner = "client", name = "Bb", descriptor = "LDSMJIEPN;")
    private Pix8 imageRedstone3v;

    @OriginalMember(owner = "client", name = "Ce", descriptor = "LDSMJIEPN;")
    private Pix8 imageScrollbar0;

    @OriginalMember(owner = "client", name = "De", descriptor = "LDSMJIEPN;")
    private Pix8 imageScrollbar1;

    @OriginalMember(owner = "client", name = "wd", descriptor = "LDSMJIEPN;")
    private Pix8 imageTitlebox;

    @OriginalMember(owner = "client", name = "xd", descriptor = "LDSMJIEPN;")
    private Pix8 imageTitlebutton;

    @OriginalMember(owner = "client", name = "rj", descriptor = "LYXVQXWYR;")
    private PixFont fontBold12;

    @OriginalMember(owner = "client", name = "pj", descriptor = "LYXVQXWYR;")
    private PixFont fontPlain11;

    @OriginalMember(owner = "client", name = "qj", descriptor = "LYXVQXWYR;")
    private PixFont fontPlain12;

    @OriginalMember(owner = "client", name = "sj", descriptor = "LYXVQXWYR;")
    private PixFont fontQuill8;

    @OriginalMember(owner = "client", name = "yg", descriptor = "LIVIFZQBK;")
    private PixMap areaBackbase1;

    @OriginalMember(owner = "client", name = "zg", descriptor = "LIVIFZQBK;")
    private PixMap areaBackbase2;

    @OriginalMember(owner = "client", name = "Ag", descriptor = "LIVIFZQBK;")
    private PixMap areaBackhmid1;

    @OriginalMember(owner = "client", name = "tc", descriptor = "LIVIFZQBK;")
    private PixMap areaBackhmid2;

    @OriginalMember(owner = "client", name = "lc", descriptor = "LIVIFZQBK;")
    private PixMap areaBackleft1;

    @OriginalMember(owner = "client", name = "mc", descriptor = "LIVIFZQBK;")
    private PixMap areaBackleft2;

    @OriginalMember(owner = "client", name = "nc", descriptor = "LIVIFZQBK;")
    private PixMap areaBackright1;

    @OriginalMember(owner = "client", name = "oc", descriptor = "LIVIFZQBK;")
    private PixMap areaBackright2;

    @OriginalMember(owner = "client", name = "pc", descriptor = "LIVIFZQBK;")
    private PixMap areaBacktop1;

    @OriginalMember(owner = "client", name = "qc", descriptor = "LIVIFZQBK;")
    private PixMap areaBackvmid1;

    @OriginalMember(owner = "client", name = "rc", descriptor = "LIVIFZQBK;")
    private PixMap areaBackvmid2;

    @OriginalMember(owner = "client", name = "sc", descriptor = "LIVIFZQBK;")
    private PixMap areaBackvmid3;

    @OriginalMember(owner = "client", name = "ph", descriptor = "LIVIFZQBK;")
    private PixMap areaChatback;

    @OriginalMember(owner = "client", name = "nh", descriptor = "LIVIFZQBK;")
    private PixMap areaMapback;

    @OriginalMember(owner = "client", name = "mh", descriptor = "LIVIFZQBK;")
    private PixMap areaSidebar;

    @OriginalMember(owner = "client", name = "oh", descriptor = "LIVIFZQBK;")
    private PixMap areaViewport;

    @OriginalMember(owner = "client", name = "lg", descriptor = "LIVIFZQBK;")
    private PixMap imageTitle0;

    @OriginalMember(owner = "client", name = "mg", descriptor = "LIVIFZQBK;")
    private PixMap imageTitle1;

    @OriginalMember(owner = "client", name = "ig", descriptor = "LIVIFZQBK;")
    private PixMap imageTitle2;

    @OriginalMember(owner = "client", name = "jg", descriptor = "LIVIFZQBK;")
    private PixMap imageTitle3;

    @OriginalMember(owner = "client", name = "kg", descriptor = "LIVIFZQBK;")
    private PixMap imageTitle4;

    @OriginalMember(owner = "client", name = "ng", descriptor = "LIVIFZQBK;")
    private PixMap imageTitle5;

    @OriginalMember(owner = "client", name = "og", descriptor = "LIVIFZQBK;")
    private PixMap imageTitle6;

    @OriginalMember(owner = "client", name = "pg", descriptor = "LIVIFZQBK;")
    private PixMap imageTitle7;

    @OriginalMember(owner = "client", name = "qg", descriptor = "LIVIFZQBK;")
    private PixMap imageTitle8;

    @OriginalMember(owner = "client", name = "Bg", descriptor = "LDLZHLHNK;")
    public static PlayerEntity localPlayer;

    @OriginalMember(owner = "client", name = "cd", descriptor = "LNYFUGYQS;")
    ...
    @OriginalMember(owner = "client", name = "S", descriptor = "Ljava/net/Socket;")
    ...
    @OriginalMember(owner = "client", name = "bh", descriptor = "[LDSMJIEPN;")
    ...
    public final void drawChat(int arg0) {
        ...
        this.imageChatback.plot(0, 16083, 0);
        if (this.showSocialInput) {
            ...
            int var3 = 0;
            Pix2D.setClipping(77, 0, false, 463, 0);
                ...
                if (this.messageText[var4] != null) {
                    ...
                    if ((var6 == 1 || var6 == 2) && (var6 == 1 || this.publicChatSetting == 0 || this.publicChatSetting == 1 && this.isFriend(false, var8))) {
                        if (var7 > 0 && var7 < 110) {
                            int var10 = 4;
                            if (var9 == 1) {
                                this.imageModIcons[0].plot(var10, 16083, var7 - 12);
                                var10 += 14;
                            }
                            if (var9 == 2) {
                                this.imageModIcons[1].plot(var10, 16083, var7 - 12);
                                var10 += 14;
                            }
                    ...
                    if ((var6 == 3 || var6 == 7) && this.splitPrivateChat == 0 && (var6 == 7 || this.privateChatSetting == 0 || this.privateChatSetting == 1 && this.isFriend(false, var8))) {
                        if (var7 > 0 && var7 < 110) {
                            ...
                            if (var9 == 1) {
                                this.imageModIcons[0].plot(var13, 16083, var7 - 12);
                                var13 += 14;
                            }
                            if (var9 == 2) {
                                this.imageModIcons[1].plot(var13, 16083, var7 - 12);
                                var13 += 14;
                            }
                    ...
                    if (var6 == 6 && this.splitPrivateChat == 0 && this.privateChatSetting < 2) {
                        if (var7 > 0 && var7 < 110) {
                            ...
                            var2.drawString(8388608, this.messageText[var4], var7, 822, 12 + var2.stringWidthTag(this._flowObfuscator32, "To " + var8));
                        }
                        ++var3;
                    }
            ...
            var2.drawString(255, this.chatTyped + "*", 90, 822, 6 + var2.stringWidthTag(this._flowObfuscator32, var5 + ": "));
            Pix2D.hline(77, 0, 479, 0, (byte) 4);
        }
        ...
        try {
            ...
            if (!this.sceneInstanced) {
                for (int var8 = 0; var8 < var7; ++var8) {
                    ...
                    int var10 = (this.sceneMapIndex[var8] & 255) * 64 - this.sceneBaseTileZ;
                    byte[] var11 = this.sceneMapLandData[var8];
                    if (var11 != null) {
                        var6.loadGround(var11, var10, var9, (this.sceneCenterZoneX - 6) * 8, (this.sceneCenterZoneZ - 6) * 8, (byte) 4, this.levelCollisionMap);
                    }
                }
                for (int var12 = 0; var12 < var7; ++var12) {
                    int var13 = (this.sceneMapIndex[var12] >> 8) * 64 - this.sceneBaseTileX;
                    int var14 = (this.sceneMapIndex[var12] & 255) * 64 - this.sceneBaseTileZ;
                ...
                for (int var16 = 0; var16 < var7; ++var16) {
                    ...
                    if (var17 != null) {
                        ...
                        int var19 = (this.sceneMapIndex[var16] & 255) * 64 - this.sceneBaseTileZ;
                        var6.loadLocations(var18, this.levelCollisionMap, var19, 7, this.scene, var17);
                    }
                }
            }
            if (this.sceneInstanced) {
                                    ...
                                    if (var36 != -1) {
                                        ...
                                        for (int var42 = 0; var42 < this.sceneMapIndex.length; ++var42) {
                                            if (this.sceneMapIndex[var42] == var41 && this.sceneMapLocData[var42] != null) {
                                                var6.loadLocationsRegion(this.levelCollisionMap, this.scene, var37, var34 * 8, (var40 & 7) * 8, true, var33, this.sceneMapLocData[var42], (var39 & 7) * 8, var38, var35 * 8);
                                                break;
                                            }
                                        }
                                    }
                            ...
                            if (var23 != -1) {
                                ...
                                for (int var29 = 0; var29 < this.sceneMapIndex.length; ++var29) {
                                    if (this.sceneMapIndex[var29] == var28 && this.sceneMapLandData[var29] != null) {
                                        var6.loadGroundRegion(var24, var25, this.levelCollisionMap, 9, var21 * 8, (var26 & 7) * 8, this.sceneMapLandData[var29], (var27 & 7) * 8, var20, var22 * 8);
                                        break;
                                    }
                                }
                            }
    ...
    public final void createMinimap(boolean arg0, int arg1) {
        ...
        for (int var6 = 1; var6 < 103; ++var6) {
            ...
            for (int var24 = 1; var24 < 103; ++var24) {
                if ((this.levelTileFlags[arg1][var24][var6] & 24) == 0) {
                    this.scene.drawMinimapTile(var3, var23, 512, arg1, var24, var6);
                }
                if (arg1 < 3 && (this.levelTileFlags[arg1 + 1][var24][var6] & 8) != 0) {
        ...
        for (int var9 = 1; var9 < 103; ++var9) {
            for (int var22 = 1; var22 < 103; ++var22) {
                if ((this.levelTileFlags[arg1][var22][var9] & 24) == 0) {
                    this.drawMinimapLoc(var9, -960, var7, var22, var8, arg1);
                }
                if (arg1 < 3 && (this.levelTileFlags[arg1 + 1][var22][var9] & 8) != 0) {
    ...
    @OriginalMember(owner = "client", name = "a", descriptor = "(IILDUCMKFAY;IIII)V")
    public final void handleInterfaceInput(int arg0, int arg1, Component arg2, int arg3, int arg4, int arg5, int arg6) {
        if (arg2.type == 0 && arg2.children != null && !arg2.hide) {
            if (arg3 >= arg0 && arg5 >= arg4 && arg3 <= arg2.width + arg0 && arg5 <= arg2.height + arg4) {
    ...
    public final void drawScrollbar(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        this.imageScrollbar0.plot(arg4, 16083, arg3);
        this.imageScrollbar1.plot(arg4, 16083, arg1 + arg3 - 16);
        ...
        Pix2D.vline(arg3 + 16 + var8, this.SCROLLBAR_GRIP_HIGHLIGHT, var7, arg4, this._flowObfuscator35);
        Pix2D.vline(arg3 + 16 + var8, this.SCROLLBAR_GRIP_HIGHLIGHT, var7, arg4 + 1, this._flowObfuscator35);
        Pix2D.hline(arg3 + 16 + var8, this.SCROLLBAR_GRIP_HIGHLIGHT, 16, arg4, (byte) 4);
        Pix2D.hline(arg3 + 17 + var8, this.SCROLLBAR_GRIP_HIGHLIGHT, 16, arg4, (byte) 4);
        if (arg0 <= 0) {
            this._flowObfuscator30 = this.randomIn.nextInt();
        }
        Pix2D.vline(arg3 + 16 + var8, this.SCROLLBAR_GRIP_LOWLIGHT, var7, arg4 + 15, this._flowObfuscator35);
        Pix2D.vline(arg3 + 17 + var8, this.SCROLLBAR_GRIP_LOWLIGHT, var7 - 1, arg4 + 14, this._flowObfuscator35);
        Pix2D.hline(arg3 + 15 + var8 + var7, this.SCROLLBAR_GRIP_LOWLIGHT, 16, arg4, (byte) 4);
        Pix2D.hline(arg3 + 14 + var8 + var7, this.SCROLLBAR_GRIP_LOWLIGHT, 15, arg4 + 1, (byte) 4);
    }

    @OriginalMember(owner = "client", name = "a", descriptor = "(LMBMGIXGO;II)V")
    private final void getNpcPos(Packet arg0, int arg1, int arg2) {
        this.entityRemovalCount = 0;
        this.entityUpdateCount = 0;
        if (arg2 <= 0) {
            this._flowObfuscator10 = this.randomIn.nextInt();
        }
        this.getNpcPosOldVis(arg0, -45, arg1);
        this.getNpcPosNewVis(arg1, arg0, (byte) 2);
        this.getNpcPosExtended(arg1, arg0, true);
            ...
            if (var19 != null && var19.isVisible(_flowObfuscator41)) {
                ...
                if (var2 >= this.playerCount) {
                    ...
                    if (var24.headicon >= 0 && var24.headicon < this.imageHeadicons.length) {
                        ...
                        if (this.projectX > -1) {
                            this.imageHeadicons[var24.headicon].plot(this.projectX - 12, 16083, this.projectY - 30);
                        }
                    }
                    if (this.hintType == 1 && this.npcIds[var2 - this.playerCount] == this.hintNpc && loopCycle % 20 < 10) {
                        this.projectFromGround(true, var19, var19.height + 15);
                        if (this.projectX > -1) {
                            this.imageHeadicons[2].plot(this.projectX - 12, 16083, this.projectY - 28);
                        }
                    }
                } else {
                    int var21 = 30;
                    ...
                    if (var22.headicons != 0) {
                        ...
                        if (this.projectX > -1) {
                            for (int var23 = 0; var23 < 8; ++var23) {
                                if ((var22.headicons & 1 << var23) != 0) {
                                    this.imageHeadicons[var23].plot(this.projectX - 12, 16083, this.projectY - var21);
                                    var21 -= 25;
                                }
                            }
                        }
                    ...
                    if (var2 >= 0 && this.hintType == 10 && this.playerIds[var2] == this.hintPlayer) {
                        this.projectFromGround(true, var19, var19.height + 15);
                        if (this.projectX > -1) {
                            this.imageHeadicons[7].plot(this.projectX - 12, 16083, this.projectY - var21);
                        }
                    }
                }
                ...
                for (int var26 = 0; var26 < 4; ++var26) {
                    if (var19.damageCycle[var26] > loopCycle) {
                        ...
                        if (this.projectX > -1) {
                            ...
                            this.imageHitmarks[var19.damageType[var26]].plot(this.projectX - 12, 16083, this.projectY - 12);
        ...
        for (int var3 = 0; var3 < this.chatCount; ++var3) {
            ...
            while (var8) {
                ...
                for (int var18 = 0; var18 < var3; ++var18) {
                    if (var5 + 2 > this.chatY[var18] - this.chatHeight[var18] && var5 - var7 < this.chatY[var18] + 2 && var4 - var6 < this.chatX[var18] + this.chatWidth[var18] && var4 + var6 > this.chatX[var18] - this.chatWidth[var18] && this.chatY[var18] - this.chatHeight[var18] < var5) {
            ...
            if (this.chatEffects == 0) {
                ...
                if (this.chatStyles[var3] == 4) {
                    ...
                    Pix2D.setClipping(334, this.projectX - 50, false, this.projectX + 50, 0);
                ...
                if (this.chatStyles[var3] == 5) {
                    ...
                    Pix2D.setClipping(this.projectY + 5, 0, false, 512, this.projectY - this.fontBold12.height - 1);
    ...
    public final void drawSidebar(byte arg0) {
        ...
        if (arg0 == -81) {
            this.imageInvback.plot(0, 16083, 0);
    ...
    public final void updateTextures(int arg0, int arg1) {
        ...
        if (!lowMemory) {
            if (Pix3D.textureCycle[17] >= arg1) {
                ...
                int var4 = var3.cropRight * var3.cropBottom - 1;
            ...
            if (Pix3D.textureCycle[24] >= arg1) {
                ...
                int var11 = var10.cropRight * var10.cropBottom - 1;
            ...
            if (Pix3D.textureCycle[34] >= arg1) {
                ...
                int var17 = var16.cropRight * var16.cropBottom - 1;
    ...
    @OriginalMember(owner = "client", name = "a", descriptor = "(ILMBMGIXGO;B)V")
    private final void getNpcPosNewVis(int arg0, Packet arg1, byte arg2) {
        if (arg2 != 2) {
    ...
    public final void pushPlayers(int arg0, boolean arg1) {
        ...
        for (int var5 = 0; var5 < var3; ++var5) {
            ...
            if (var6 != null && var6.isVisible(_flowObfuscator41)) {
                var6.lowmem = false;
                if ((lowMemory && this.playerCount > 50 || this.playerCount > 200) && !arg1 && var6.seqStandId == var6.secondarySeqId) {
                    var6.lowmem = true;
                }
                int var8 = var6.x >> 7;
                int var9 = var6.z >> 7;
                if (var8 >= 0 && var8 < 104 && var9 >= 0 && var9 < 104) {
                    if (var6.locModel != null && loopCycle >= var6.locStartCycle && loopCycle < var6.locStopCycle) {
                        ...
                        if ((var6.x & 127) == 64 && (var6.z & 127) == 64) {
    ...
    @OriginalMember(owner = "client", name = "a", descriptor = "(ILDUCMKFAY;)Z")
    ...
    @OriginalMember(owner = "client", name = "a", descriptor = "(IBLMBMGIXGO;)V")
    private final void getPlayerExtended(int arg0, byte arg1, Packet arg2) {
        if (arg1 == 2) {
            boolean var4 = false;
            for (int var5 = 0; var5 < this.entityUpdateCount; ++var5) {
                ...
                this.getPlayerExtended(var8, var6, arg2, this._flowObfuscator17, var7);
            }
        }
    }
            ...
            if (var7 != 0) {
                ...
                if (var15.mapscene != -1) {
                    ...
                    if (var16 != null) {
                        ...
                        var16.plot(arg3 * 4 + 48 + var17, 16083, (104 - arg0 - var15.length) * 4 + 48 + var18);
                    }
                } else {
                    if (var10 == 0 || var10 == 2) {
                        if (var9 == 0) {
            ...
            if (var19 != 0) {
                ...
                if (var24.mapscene != -1) {
                    ...
                    if (var25 != null) {
                        ...
                        var25.plot(arg3 * 4 + 48 + var26, 16083, (104 - arg0 - var24.length) * 4 + 48 + var27);
                    }
                } else if (var22 == 9) {
                    int var28 = 15658734;
                    if (var19 > 0) {
            ...
            if (var31 != 0) {
                ...
                if (var33.mapscene != -1) {
                    ...
                    if (var34 != null) {
                        ...
                        var34.plot(arg3 * 4 + 48 + var35, 16083, (104 - arg0 - var33.length) * 4 + 48 + var36);
                        return;
                    }
                }
            }
    ...
    public final void loadTitleImages(int arg0) {
        ...
        if (var2 == 0) {
            ...
            for (int var4 = 0; var4 < 12; ++var4) {
                this.imageRunes[var4] = new Pix8(this.archiveTitle, "runes", (var4 & 3) + 12);
            }
        }
    ...
    public final void loadTitleBackground(int arg0) {
        ...
        var3.plotQuick(0, 0, -32357);
        this.imageTitle1.bind(0);
        var3.plotQuick(-637, 0, -32357);
        this.imageTitle2.bind(0);
        var3.plotQuick(-128, 0, -32357);
        this.imageTitle3.bind(0);
        var3.plotQuick(-202, -371, -32357);
        this.imageTitle4.bind(0);
        var3.plotQuick(-202, -171, -32357);
        this.imageTitle5.bind(0);
        var3.plotQuick(0, -265, -32357);
        this.imageTitle6.bind(0);
        var3.plotQuick(-562, -265, -32357);
        this.imageTitle7.bind(0);
        var3.plotQuick(-128, -171, -32357);
        this.imageTitle8.bind(0);
        var3.plotQuick(-562, -171, -32357);
        ...
        this.imageTitle0.bind(0);
        var3.plotQuick(382, 0, -32357);
        this.imageTitle1.bind(0);
        var3.plotQuick(-255, 0, -32357);
        this.imageTitle2.bind(0);
        var3.plotQuick(254, 0, -32357);
        this.imageTitle3.bind(0);
        var3.plotQuick(180, -371, -32357);
        this.imageTitle4.bind(0);
        var3.plotQuick(180, -171, -32357);
        this.imageTitle5.bind(0);
        var3.plotQuick(382, -265, -32357);
        this.imageTitle6.bind(0);
        var3.plotQuick(-180, -265, -32357);
        this.imageTitle7.bind(0);
        var3.plotQuick(254, -171, -32357);
        this.imageTitle8.bind(0);
        if (arg0 == 0) {
            var3.plotQuick(-180, -171, -32357);
            Pix32 var6 = new Pix32(this.archiveTitle, "logo", 0);
            this.imageTitle2.bind(0);
            var6.plot(382 - var6.cropRight / 2 - 128, 16083, 18);
            Object var7 = null;
            Object var8 = null;
            Object var9 = null;
            System.gc();
    ...
    private final void clearTemporaryLocs(int arg0) {
        LocSpawned var2 = (LocSpawned) this.spawnedLocs.head();
        while (arg0 >= 0) {
        ...
        while (var2 != null) {
            ...
            var2 = (LocSpawned) this.spawnedLocs.next(false);
        }
    }
    ...
    @OriginalMember(owner = "client", name = "a", descriptor = "(IIIILDUCMKFAY;IZII)V")
    public final void handleScrollInput(int arg0, int arg1, int arg2, int arg3, Component arg4, int arg5, boolean arg6, int arg7, int arg8) {
        ...
        if (arg2 >= arg0 && arg2 < arg0 + 16 && arg3 >= arg5 && arg3 < arg5 + 16) {
            ...
            if (arg2 < arg0 - this.scrollInputPadding || arg2 >= arg0 + 16 + this.scrollInputPadding || arg3 < arg5 + 16 || arg3 >= arg1 + arg5 - 16 || this.dragCycles <= 0) {
                return;
            }
    ...
    @OriginalMember(owner = "client", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;IBI)LXTGLDHGX;")
    ...
    @OriginalMember(owner = "client", name = "b", descriptor = "(ILDUCMKFAY;)V")
            ...
            for (int var4 = 0; var4 < 100; ++var4) {
                if (this.messageText[var4] != null) {
                    ...
                    if ((var5 == 3 || var5 == 7) && (var5 == 7 || this.privateChatSetting == 0 || this.privateChatSetting == 1 && this.isFriend(false, var6))) {
                        ...
                        if (var7 == 1) {
                            this.imageModIcons[0].plot(var10, 16083, var8 - 12);
                            var10 += 14;
                        }
                        if (var7 == 2) {
                            this.imageModIcons[1].plot(var10, 16083, var8 - 12);
                            var10 += 14;
                        }
    ...
    public final void prepareGameScreen(int arg0) {
        if (this.areaChatback == null) {
            ...
            Pix2D.clear(this._flowObfuscator38);
            this.imageMapback.plot(0, 16083, 0);
    ...
    @OriginalMember(owner = "client", name = "a", descriptor = "(LCXGZMTJK;III)V")
    public final void drawMinimapHint(Pix32 arg0, int arg1, int arg2, int arg3) {
        ...
        if (var5 > 4225 && var5 < 90000) {
            ...
            this.imageMapedge.rotatePlot(83 - var16 - 20, 15, 20, 15, 41960, 256, 20, var13, var15 + 94 + 4 - 10);
        } else {
    ...
    public final void login(String arg0, String arg1, boolean arg2) {
        ...
        try {
            ...
            if (var8 == 1) {
                ...
                this.spawnedLocs = new LinkList(169);
    ...
    @OriginalMember(owner = "client", name = "a", descriptor = "(ILMBMGIXGO;Z)V")
    private final void getNpcPosExtended(int arg0, Packet arg1, boolean arg2) {
        for (int var4 = 0; var4 < this.entityUpdateCount; ++var4) {
            ...
            if ((var7 & 128) != 0) {
                ...
                var6.spotanimLastCycle = (var13 & 65535) + loopCycle;
            ...
            if ((var7 & 4) != 0) {
                ...
                var6.targetTileZ = arg1.g2_alt1((byte) 108);
            }
        }
        this.ingame &= arg2;
    }

    @OriginalMember(owner = "client", name = "a", descriptor = "(LCKDEJADD;IZII)V")
    ...
    @OriginalMember(owner = "client", name = "a", descriptor = "(IILDLZHLHNK;ZI)V")
    ...
    @OriginalMember(owner = "client", name = "a", descriptor = "(ZLDYMVKFXP;)V")
            ...
            if (!var1) {
                ...
                try {
                    ...
                    if (!lowMemory) {
                        ...
                        byte[] var49 = var9.read("sounds.dat", (byte[]) null);
    ...
    @OriginalMember(owner = "client", name = "a", descriptor = "(LMBMGIXGO;IB)V")
    private final void getPlayerNewVis(Packet arg0, int arg1, byte arg2) {
        if (arg2 == 8) {
            boolean var4 = false;
        } else {
    ...
    @OriginalMember(owner = "client", name = "a", descriptor = "(IILGQOSZKJC;)V")
    ...
    @OriginalMember(owner = "client", name = "a", descriptor = "(LGQOSZKJC;Z)V")
    public final void updateForceMovement(PathingEntity arg0, boolean arg1) {
        int var3 = arg0.forceMoveEndCycle - loopCycle;
        int var4 = arg0.size * 64 + arg0.forceMoveStartSceneTileX * 128;
        int var5 = arg0.size * 64 + arg0.forceMoveStartSceneTileZ * 128;
    ...
    @OriginalMember(owner = "client", name = "a", descriptor = "(LGQOSZKJC;B)V")
    public final void startForceMovement(PathingEntity arg0, byte arg1) {
        if (loopCycle == arg0.forceMoveStartCycle || arg0.primarySeqId == -1 || arg0.primarySeqDelay != 0 || arg0.primarySeqCycle + 1 > SeqType.instances[arg0.primarySeqId].getFrameDuration(arg0.primarySeqFrame, (byte) -39)) {
            ...
            int var5 = arg0.size * 64 + arg0.forceMoveStartSceneTileX * 128;
            int var6 = arg0.size * 64 + arg0.forceMoveStartSceneTileZ * 128;
            int var7 = arg0.size * 64 + arg0.forceMoveEndSceneTileX * 128;
            int var8 = arg0.size * 64 + arg0.forceMoveEndSceneTileZ * 128;
    ...
    @OriginalMember(owner = "client", name = "a", descriptor = "(BLGQOSZKJC;)V")
    public final void updateMovement(byte arg0, PathingEntity arg1) {
        ...
        if (arg1.pathLength == 0) {
            ...
            if (var6 - var4 <= 256 && var6 - var4 >= -256 && var7 - var5 <= 256 && var7 - var5 >= -256) {
                ...
                int var8 = arg1.dstYaw - arg1.yaw & 2047;
                if (var8 > 1024) {
                    var8 -= 2048;
                }
    ...
    @OriginalMember(owner = "client", name = "a", descriptor = "(LGQOSZKJC;I)V")
            ...
            if (arg0.turnSpeed != 0) {
                ...
                if (arg0.targetId >= 32768) {
                    ...
                    if (var7 != null) {
                        ...
                        if (var8 != 0 || var9 != 0) {
                            arg0.dstYaw = (int) (Math.atan2((double) var8, (double) var9) * 325.949D) & 2047;
                        }
                    }
                }
                if ((arg0.targetTileX != 0 || arg0.targetTileZ != 0) && (arg0.pathLength == 0 || arg0.seqTrigger > 0)) {
                    ...
                    if (var10 != 0 || var11 != 0) {
                        arg0.dstYaw = (int) (Math.atan2((double) var10, (double) var11) * 325.949D) & 2047;
                    }
                    arg0.targetTileX = 0;
                    arg0.targetTileZ = 0;
                }
                int var12 = arg0.dstYaw - arg0.yaw & 2047;
                if (var12 != 0) {
                    ...
                    arg0.yaw &= 2047;
                    if (arg0.seqStandId == arg0.secondarySeqId && arg0.yaw != arg0.dstYaw) {
                        if (arg0.seqTurnId != -1) {
    ...
    @OriginalMember(owner = "client", name = "b", descriptor = "(LGQOSZKJC;I)V")
    ...
    public final void drawGame(boolean arg0) {
        ...
        if (this.redrawSideicons) {
            ...
            this.imageBackhmid1.plot(0, 16083, 0);
            if (this.sidebarInterfaceId == -1) {
                if (this.tabInterfaceId[this.selectedTab] != -1) {
                    if (this.selectedTab == 0) {
                        this.imageRedstone1.plot(22, 16083, 10);
                    }
                    if (this.selectedTab == 1) {
                        this.imageRedstone2.plot(54, 16083, 8);
                    }
                    if (this.selectedTab == 2) {
                        this.imageRedstone2.plot(82, 16083, 8);
                    }
                    if (this.selectedTab == 3) {
                        this.imageRedstone3.plot(110, 16083, 8);
                    }
                    if (this.selectedTab == 4) {
                        this.imageRedstone2h.plot(153, 16083, 8);
                    }
                    if (this.selectedTab == 5) {
                        this.imageRedstone2h.plot(181, 16083, 8);
                    }
                    if (this.selectedTab == 6) {
                        this.imageRedstone1h.plot(209, 16083, 9);
                    }
                }
                if (this.tabInterfaceId[0] != -1 && (this.flashingTab != 0 || loopCycle % 20 < 10)) {
                    this.imageSideicons[0].plot(29, 16083, 13);
                }
                if (this.tabInterfaceId[1] != -1 && (this.flashingTab != 1 || loopCycle % 20 < 10)) {
                    this.imageSideicons[1].plot(53, 16083, 11);
                }
                if (this.tabInterfaceId[2] != -1 && (this.flashingTab != 2 || loopCycle % 20 < 10)) {
                    this.imageSideicons[2].plot(82, 16083, 11);
                }
                if (this.tabInterfaceId[3] != -1 && (this.flashingTab != 3 || loopCycle % 20 < 10)) {
                    this.imageSideicons[3].plot(115, 16083, 12);
                }
                if (this.tabInterfaceId[4] != -1 && (this.flashingTab != 4 || loopCycle % 20 < 10)) {
                    this.imageSideicons[4].plot(153, 16083, 13);
                }
                if (this.tabInterfaceId[5] != -1 && (this.flashingTab != 5 || loopCycle % 20 < 10)) {
                    this.imageSideicons[5].plot(180, 16083, 11);
                }
                if (this.tabInterfaceId[6] != -1 && (this.flashingTab != 6 || loopCycle % 20 < 10)) {
                    this.imageSideicons[6].plot(208, 16083, 13);
                }
            }
            this.areaBackhmid1.draw(160, 23680, super.graphics, 516);
            this.areaBackbase2.bind(0);
            this.imageBackbase2.plot(0, 16083, 0);
            if (this.sidebarInterfaceId == -1) {
                if (this.tabInterfaceId[this.selectedTab] != -1) {
                    if (this.selectedTab == 7) {
                        this.imageRedstone1v.plot(42, 16083, 0);
                    }
                    if (this.selectedTab == 8) {
                        this.imageRedstone2v.plot(74, 16083, 0);
                    }
                    if (this.selectedTab == 9) {
                        this.imageRedstone2v.plot(102, 16083, 0);
                    }
                    if (this.selectedTab == 10) {
                        this.imageRedstone3v.plot(130, 16083, 1);
                    }
                    if (this.selectedTab == 11) {
                        this.imageRedstone2hv.plot(173, 16083, 0);
                    }
                    if (this.selectedTab == 12) {
                        this.imageRedstone2hv.plot(201, 16083, 0);
                    }
                    if (this.selectedTab == 13) {
                        this.imageRedstone1hv.plot(229, 16083, 0);
                    }
                }
                if (this.tabInterfaceId[8] != -1 && (this.flashingTab != 8 || loopCycle % 20 < 10)) {
                    this.imageSideicons[7].plot(74, 16083, 2);
                }
                if (this.tabInterfaceId[9] != -1 && (this.flashingTab != 9 || loopCycle % 20 < 10)) {
                    this.imageSideicons[8].plot(102, 16083, 3);
                }
                if (this.tabInterfaceId[10] != -1 && (this.flashingTab != 10 || loopCycle % 20 < 10)) {
                    this.imageSideicons[9].plot(137, 16083, 4);
                }
                if (this.tabInterfaceId[11] != -1 && (this.flashingTab != 11 || loopCycle % 20 < 10)) {
                    this.imageSideicons[10].plot(174, 16083, 2);
                }
                if (this.tabInterfaceId[12] != -1 && (this.flashingTab != 12 || loopCycle % 20 < 10)) {
                    this.imageSideicons[11].plot(201, 16083, 2);
                }
                if (this.tabInterfaceId[13] != -1 && (this.flashingTab != 13 || loopCycle % 20 < 10)) {
                    this.imageSideicons[12].plot(226, 16083, 2);
                }
            }
        ...
        if (this.redrawPrivacySettings) {
            ...
            this.imageBackbase1.plot(0, 16083, 0);
    ...
    @OriginalMember(owner = "client", name = "a", descriptor = "(LDUCMKFAY;Z)Z")
    ...
    @OriginalMember(owner = "client", name = "a", descriptor = "(IIILDUCMKFAY;I)V")
    public final void drawInterface(int arg0, int arg1, int arg2, Component arg3, int arg4) {
        ...
        if (arg3.type == 0 && arg3.children != null) {
            if (!arg3.hide || this.viewportHoveredInterfaceIndex == arg3.id || this.sidebarHoveredInterfaceIndex == arg3.id || this.chatHoveredInterfaceIndex == arg3.id) {
                ...
                Pix2D.setClipping(arg3.height + arg4, arg2, false, arg3.width + arg2, arg4);
                    ...
                    if (var14.type == 0) {
                        ...
                        if (var14.type == 2) {
                                        ...
                                        if (var20 > Pix2D.boundLeft - 32 && var20 < Pix2D.boundRight && var21 > Pix2D.boundTop - 32 && var21 < Pix2D.boundBottom || this.objDragArea != 0 && this.objDragSlot == var17) {
                                            ...
                                            if (var26 != null) {
                                                if (this.objDragArea != 0 && this.objDragSlot == var17 && this.objDragInterfaceId == var14.id) {
                                                    ...
                                                    var26.plotTrans(var20 + var22, var21 + var23, 128, this._flowObfuscator25);
                                                    if (var21 + var23 < Pix2D.boundTop && arg3.scrollPosition > 0) {
                                                        int var27 = (Pix2D.boundTop - var21 - var23) * this.sceneDelta / 3;
                                                    ...
                                                    if (var21 + var23 + 32 > Pix2D.boundBottom && arg3.scrollPosition < arg3.scroll - arg3.height) {
                                                        int var28 = (var21 + var23 + 32 - Pix2D.boundBottom) * this.sceneDelta / 3;
                                                    ...
                                                    var26.plotTrans(var20, var21, 128, this._flowObfuscator25);
                                                } else {
                                                    var26.plot(var20, 16083, var21);
                                                }
                            ...
                            if (var14.alpha == 0) {
                                ...
                                Pix2D.fillRectTrans(var32, var16, var14.width, var14.height, 256 - (var14.alpha & 255), 0, var15);
                            } else {
                                Pix2D.drawRectTrans(var16, var14.height, 256 - (var14.alpha & 255), var32, var14.width, var15, -17319);
                            }
                            ...
                            if (var45 != null) {
                                var45.plot(var15, 16083, var16);
                            }
                        } else if (var14.type == 6) {
                            int var46 = Pix3D.centerW3D;
                            int var47 = Pix3D.centerH3D;
                            Pix3D.centerW3D = var14.width / 2 + var15;
                            Pix3D.centerH3D = var14.height / 2 + var16;
                            ...
                            Pix3D.centerW3D = var46;
                            Pix3D.centerH3D = var47;
                ...
                Pix2D.setClipping(var9, var6, false, var8, var7);
            }
        }
    }

    @OriginalMember(owner = "client", name = "a", descriptor = "(LDSMJIEPN;I)V")
    ...
    @OriginalMember(owner = "client", name = "a", descriptor = "(IILMBMGIXGO;BLDLZHLHNK;)V")
    private final void getPlayerExtended(int arg0, int arg1, Packet arg2, byte arg3, PlayerEntity arg4) {
        if (arg3 != 25) {
            this.levelObjStacks = null;
        }
        if ((arg0 & 1024) != 0) {
        ...
        if ((arg0 & 256) != 0) {
            ...
            arg4.spotanimLastCycle = (var6 & 65535) + loopCycle;
        ...
        if ((arg0 & 2) != 0) {
            ...
            arg4.targetTileZ = arg2.g2_alt1((byte) 108);
        }
        if ((arg0 & 32) != 0) {
            int var24 = arg2.g1();
    ...
    public final void updateOrbitCamera(int arg0) {
        ...
        try {
            ...
            this.orbitCameraYaw = this.orbitCameraYawVelocity / 2 + this.orbitCameraYaw & 2047;
    ...
    public final void draw3DEntityElements(int arg0) {
        ...
        if (this.crossMode == 1) {
            this.imageCrosses[this.crossCycle / 100].plot(this.crossX - 8 - 4, 16083, this.crossY - 8 - 4);
            ++gamelogic6;
            if (gamelogic6 > 67) {
                gamelogic6 = 0;
        ...
        if (this.crossMode == 2) {
            this.imageCrosses[this.crossCycle / 100 + 4].plot(this.crossX - 8 - 4, 16083, this.crossY - 8 - 4);
        }
        ...
        if (this.inMultizone == 1) {
            this.imageHeadicons[1].plot(472, 16083, 296);
        }
        if (showFps) {
            short var2 = 507;
            byte var3 = 20;
    ...
    private final void updateTemporaryLocs(byte arg0) {
        ...
        if (this.sceneState == 2) {
            for (LocSpawned var3 = (LocSpawned) this.spawnedLocs.head(); var3 != null; var3 = (LocSpawned) this.spawnedLocs.next(false)) {
                if (var3.duration > 0) {
                    --var3.duration;
                }
                if (var3.duration == 0) {
                    if (var3.previousType < 0 || World.isLocReady(var3.previousType, var3.previousShape, 8)) {
                    ...
                    if (var3.delay == 0 && var3.localX >= 1 && var3.localZ >= 1 && var3.localX <= 102 && var3.localZ <= 102 && (var3.type < 0 || World.isLocReady(var3.type, var3.shape, 8))) {
                        ...
                        var3.delay = -1;
                        if (var3.type == var3.previousType && var3.previousType == -1) {
                            var3.unlink();
                        } else if (var3.type == var3.previousType && var3.rotation == var3.previousRotation && var3.shape == var3.previousShape) {
                            var3.unlink();
                        }
                    }
                }
    ...
    @OriginalMember(owner = "client", name = "b", descriptor = "(LMBMGIXGO;IB)V")
    private final void getPlayerLocal(Packet arg0, int arg1, byte arg2) {
    ...
    @OriginalMember(owner = "client", name = "c", descriptor = "(IZI)Z")
    ...
    @OriginalMember(owner = "client", name = "a", descriptor = "(ILDUCMKFAY;I)I")
    ...
    public final void drawMinimap(boolean arg0) {
        if (!arg0) {
            ...
            if (this.minimapState == 2) {
                ...
                this.imageCompass.rotatePlotMasked(33, this.orbitCameraYaw, this.compassMaskLineLengths, 256, this.compassMaskLineOffsets, -236, 25, 0, 0, 33, 25);
                this.areaViewport.bind(0);
            } else {
                int var6 = this.orbitCameraYaw + this.minimapAnticheatAngle & 2047;
                int var7 = localPlayer.x / 32 + 48;
                int var8 = 464 - localPlayer.z / 32;
                this.imageMinimap.rotatePlotMasked(151, var6, this.minimapMaskLineLengths, this.minimapZoom + 256, this.minimapMaskLineOffsets, -236, var8, 5, 25, 146, var7);
                this.imageCompass.rotatePlotMasked(33, this.orbitCameraYaw, this.compassMaskLineLengths, 256, this.compassMaskLineOffsets, -236, 25, 0, 0, 33, 25);
    ...
    @OriginalMember(owner = "client", name = "a", descriptor = "(ZLGQOSZKJC;I)V")
    ...
    public final void projectFromGround(int arg0, int arg1, int arg2, int arg3) {
        if (arg0 >= 128 && arg3 >= 128 && arg0 <= 13056 && arg3 <= 13056) {
            ...
            if (var17 >= 50) {
                this.projectX = (var13 << 9) / var17 + Pix3D.centerW3D;
                this.projectY = (var16 << 9) / var17 + Pix3D.centerH3D;
            } else {
                this.projectX = -1;
                this.projectY = -1;
            }
    ...
    private final void appendLoc(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9) {
        ...
        for (LocSpawned var12 = (LocSpawned) this.spawnedLocs.head(); var12 != null; var12 = (LocSpawned) this.spawnedLocs.next(false)) {
        ...
        if (var11 == null) {
            ...
            this.spawnedLocs.addTail(var11);
        }
        var11.type = arg2;
        var11.shape = arg6;
        var11.rotation = arg3;
    ...
    @OriginalMember(owner = "client", name = "b", descriptor = "(LDUCMKFAY;Z)Z")
        ...
        for (int var9 = 1; var9 < var2 - 1; ++var9) {
            ...
            for (int var25 = var24; var25 < 128; ++var25) {
                ...
                if (var26 != 0) {
                    ...
                    this.imageTitle0.data[var8++] = ((var29 & 16711935) * var26 + (var30 & 16711935) * var28 & -16711936) + ((var29 & 65280) * var26 + (var30 & 65280) * var28 & 16711680) >> 8;
                } else {
                    ++var8;
                }
            }
        ...
        for (int var13 = 1; var13 < var2 - 1; ++var13) {
            ...
            for (int var17 = 0; var17 < var15; ++var17) {
                ...
                if (var18 != 0) {
                    ...
                    this.imageTitle1.data[var16++] = ((var21 & 16711935) * var18 + (var22 & 16711935) * var20 & -16711936) + ((var21 & 65280) * var18 + (var22 & 65280) * var20 & 16711680) >> 8;
                } else {
                    ++var16;
                }
            }
    ...
    @OriginalMember(owner = "client", name = "a", descriptor = "(BILMBMGIXGO;)V")
    private final void getPlayerOldVis(byte arg0, int arg1, Packet arg2) {
    ...
    public final void drawTitleScreen(boolean arg0, boolean arg1) {
        this.loadTitle(0);
        this.imageTitle4.bind(0);
        this.imageTitlebox.plot(0, 16083, 0);
        short var3 = 360;
        short var4 = 200;
        if (!arg1) {
            if (this.titleScreenState == 0) {
                ...
                int var7 = var3 / 2 - 80;
                int var8 = var4 / 2 + 20;
                this.imageTitlebutton.plot(var7 - 73, 16083, var8 - 20);
                this.fontBold12.drawStringCenterTag(16777215, var7, this._flowObfuscator18, "New User", var8 + 5, true);
                int var9 = var3 / 2 + 80;
                this.imageTitlebutton.plot(var9 - 73, 16083, var8 - 20);
            ...
            if (this.titleScreenState == 2) {
                ...
                if (!arg0) {
                    int var11 = var3 / 2 - 80;
                    int var12 = var4 / 2 + 50;
                    this.imageTitlebutton.plot(var11 - 73, 16083, var12 - 20);
                    this.fontBold12.drawStringCenterTag(16777215, var11, this._flowObfuscator18, "Login", var12 + 5, true);
                    int var13 = var3 / 2 + 80;
                    this.imageTitlebutton.plot(var13 - 73, 16083, var12 - 20);
            ...
            if (this.titleScreenState == 3) {
                ...
                int var15 = var3 / 2;
                int var16 = var4 / 2 + 50;
                this.imageTitlebutton.plot(var15 - 73, 16083, var16 - 20);
    ...
    @OriginalMember(owner = "client", name = "a", descriptor = "(ILMBMGIXGO;I)V")
    public final void readZonePacket(int arg0, Packet arg1, int arg2) {
        ...
        if (arg2 == 84) {
            int var4 = arg1.g1();
            int var5 = (var4 >> 4 & 7) + this.baseX;
            int var6 = (var4 & 7) + this.baseZ;
            int var7 = arg1.g2();
            int var8 = arg1.g2();
            int var9 = arg1.g2();
            if (var5 >= 0 && var6 >= 0 && var5 < 104 && var6 < 104) {
                ...
                if (var10 != null) {
                    for (ObjStackEntity var11 = (ObjStackEntity) var10.head(); var11 != null; var11 = (ObjStackEntity) var10.next(false)) {
                        if ((var7 & 32767) == var11.type && var11.count == var8) {
                            var11.count = var9;
                            break;
                        }
                    }
            ...
            if (arg2 == 105) {
                int var12 = arg1.g1();
                int var13 = (var12 >> 4 & 7) + this.baseX;
                int var14 = (var12 & 7) + this.baseZ;
                int var15 = arg1.g2();
                int var16 = arg1.g1();
            ...
            if (arg2 == 215) {
                ...
                int var21 = (var20 >> 4 & 7) + this.baseX;
                int var22 = (var20 & 7) + this.baseZ;
                ...
                int var27 = (var26 >> 4 & 7) + this.baseX;
                int var28 = (var26 & 7) + this.baseZ;
                int var29 = arg1.g2();
                ...
                int var33 = (var32 >> 4 & 7) + this.baseX;
                int var34 = (var32 & 7) + this.baseZ;
                int var35 = arg1.g1_alt3(2);
                int var36 = var35 >> 2;
                int var37 = var35 & 3;
                int var38 = this.LOC_SHAPE_TO_LAYER[var36];
                ...
                if (var33 >= 0 && var34 >= 0 && var33 < 103 && var34 < 103) {
                    ...
                    if (var38 == 0) {
                        ...
                        if (var44 != null) {
                            int var45 = var44.bitset >> 14 & 32767;
                            if (var36 == 2) {
                                var44.modelA = new LocEntity(var45, var37 + 4, 2, var41, (byte) 7, var42, var40, var43, var39, false);
                                var44.modelB = new LocEntity(var45, var37 + 1 & 3, 2, var41, (byte) 7, var42, var40, var43, var39, false);
                            } else {
                    ...
                    if (var38 == 1) {
                        ...
                        if (var46 != null) {
                            var46.model = new LocEntity(var46.bitset >> 14 & 32767, 0, 4, var41, (byte) 7, var42, var40, var43, var39, false);
                        }
                    }
                    if (var38 == 2) {
                        ...
                        if (var47 != null) {
                            var47.model = new LocEntity(var47.bitset >> 14 & 32767, var37, var36, var41, (byte) 7, var42, var40, var43, var39, false);
                        }
                    }
                    if (var38 == 3) {
                        GroundDecor var48 = this.scene.getGroundDecoration(var34, var33, this.currentLevel, 0);
                        if (var48 != null) {
                            var48.model = new LocEntity(var48.bitset >> 14 & 32767, var37, 22, var41, (byte) 7, var42, var40, var43, var39, false);
                        }
                    }
                }
            } else {
                if (arg2 == 147) {
                    ...
                    int var50 = (var49 >> 4 & 7) + this.baseX;
                    int var51 = (var49 & 7) + this.baseZ;
                    int var52 = arg1.g2();
                    ...
                    int var58 = var57 >> 2;
                    int var59 = var57 & 3;
                    int var60 = this.LOC_SHAPE_TO_LAYER[var58];
                    byte var61 = arg1.g1b();
                    int var62 = arg1.g2();
                ...
                if (arg2 == 151) {
                    ...
                    int var93 = arg1.g2();
                    int var94 = arg1.g1();
                    int var95 = (var94 >> 4 & 7) + this.baseX;
                    int var96 = (var94 & 7) + this.baseZ;
                    ...
                    int var99 = var98 >> 2;
                    int var100 = var98 & 3;
                    int var101 = this.LOC_SHAPE_TO_LAYER[var99];
                    int var102 = arg1.g1();
                    int var103 = (var102 >> 4 & 7) + this.baseX;
                    int var104 = (var102 & 7) + this.baseZ;
                    if (var103 >= 0 && var104 >= 0 && var103 < 104 && var104 < 104) {
                        this.appendLoc(404, -1, -1, var100, var101, var104, var99, this.currentLevel, var103, 0);
                    }
                } else if (arg2 == 117) {
                    int var105 = arg1.g1();
                    int var106 = (var105 >> 4 & 7) + this.baseX;
                    int var107 = (var105 & 7) + this.baseZ;
    ...
    @OriginalMember(owner = "client", name = "b", descriptor = "(LMBMGIXGO;II)V")
    private final void getNpcPosOldVis(Packet arg0, int arg1, int arg2) {
        if (arg1 >= 0) {
    ...
    @OriginalMember(owner = "client", name = "a", descriptor = "(LCXGZMTJK;IIZ)V")
    public final void drawOnMinimap(Pix32 arg0, int arg1, int arg2, boolean arg3) {
        ...
        if (!arg3) {
            if (var6 <= 6400) {
                ...
                if (var6 > 2500) {
                    arg0.plotMasked(this.imageMapback, false, 83 - var12 - arg0.height / 2 - 4, var11 + 94 - arg0.width / 2 + 4);
                } else {
                    arg0.plot(var11 + 94 - arg0.width / 2 + 4, 16083, 83 - var12 - arg0.height / 2 - 4);
                }
            }
        }
    }
    ...
    @OriginalMember(owner = "client", name = "b", descriptor = "(ILMBMGIXGO;I)V")
    private final void getPlayer(int arg0, Packet arg1, int arg2) {
        this.entityRemovalCount = 0;
        if (arg2 != 9759) {
            this.packetType = arg1.g1();
        }
        this.entityUpdateCount = 0;
        this.getPlayerLocal(arg1, arg0, (byte) 5);
        this.getPlayerOldVis((byte) 2, arg0, arg1);
        this.getPlayerNewVis(arg1, arg0, (byte) 8);
        this.getPlayerExtended(arg0, (byte) 2, arg1);
        for (int var4 = 0; var4 < this.entityRemovalCount; ++var4) {
            int var6 = this.entityRemovalIds[var4];
        ...
        if (this.stream == null) {
            ...
            try {
                ...
                if (this.packetType == 81) {
                    this.getPlayer(this.packetSize, this.in, 9759);
                ...
                if (this.packetType == 64) {
                    ...
                    for (LocSpawned var7 = (LocSpawned) this.spawnedLocs.head(); var7 != null; var7 = (LocSpawned) this.spawnedLocs.next(false)) {
                ...
                if (this.packetType == 73 || this.packetType == 241) {
                        ...
                        label1053: while (true) {
                            ...
                            for (int var44 = 0; var44 < 13; ++var44) {
                                for (int var45 = 0; var45 < 13; ++var45) {
                                    ...
                                    if (var46 != -1) {
                                        int var47 = var46 >> 14 & 1023;
                                        int var48 = var46 >> 3 & 2047;
                    ...
                    for (LocSpawned var76 = (LocSpawned) this.spawnedLocs.head(); var76 != null; var76 = (LocSpawned) this.spawnedLocs.next(false)) {
                        var76.localX -= var57;
                        var76.localZ -= var58;
                ...
                if (this.packetType == 68) {
                    for (int var126 = 0; var126 < this.varps.length; ++var126) {
                        if (this.varps[var126] != this.varCache[var126]) {
                ...
                if (this.packetType == 122) {
                    ...
                    int var149 = var148 >> 10 & 31;
                    int var150 = var148 >> 5 & 31;
                    int var151 = var148 & 31;
                ...
                if (this.packetType == 177) {
                    ...
                    if (this.cutsceneRotateAcceleration >= 100) {
                        ...
                        this.cameraPitch = (int) (Math.atan2((double) var166, (double) var168) * 325.949D) & 2047;
                        this.cameraYaw = (int) (Math.atan2((double) var165, (double) var167) * -325.949D) & 2047;
                ...
                if (this.packetType == 65) {
                    this.getNpcPos(this.in, this.packetSize, 973);
                    this.packetType = -1;
                    return true;
                }
    ...
    public final void drawScene(byte arg0) {
        ...
        if (!this.cutscene) {
            ...
            int var3 = this.orbitCameraYaw + this.cameraAnticheatAngle & 2047;
        ...
        for (int var10 = 0; var10 < 5; ++var10) {
            if (this.cameraModifierEnabled[var10]) {
                ...
                if (var10 == 3) {
                    this.cameraYaw = this.cameraYaw + var12 & 2047;
                }
                if (var10 == 4) {
                    this.cameraPitch += var12;
                    if (this.cameraPitch < 128) {
