...
public class client extends class116 {
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "(Ljb;)Ljb;")
    ...
    @OriginalMember(owner = "client!client", name = "a", descriptor = "([Ljb;IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!client", name = "b", descriptor = "(Ljb;)Lqj;")
