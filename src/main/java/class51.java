...
public class class51 {
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(Lpj;)V")
    public class51(class132 arg0) {
        this.field739 = arg0;
    }

    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Lms;I)Lqt;")
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(I)Lfd;")
