...
public class class51 {
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(JI)V", line = 23)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!gda", name = "<init>", descriptor = "(Lgb;III)V", line = 58)
