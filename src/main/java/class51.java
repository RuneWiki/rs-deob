...
public class class51 extends class45 {
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "()V", line = 46)
    public class51() {
        super(1, false);
    }

    @OriginalMember(owner = "client!oi", name = "f", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Lcu;II)V", line = 61)
    ...
    @OriginalMember(owner = "client!oi", name = "c", descriptor = "(II)I", line = 104)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(ILcu;)Lqn;", line = 133)
    ...
    @OriginalMember(owner = "client!oi", name = "b", descriptor = "(II)[[I", line = 171)
