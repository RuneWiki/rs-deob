...
public class class51 extends class741 {
    ...
    @OriginalMember(owner = "client!ic", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ic", name = "b", descriptor = "(B)Z", line = 33)
    public final boolean method425(byte arg0) {
        return arg0 > -37 ? false : this.field607;
    }

    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!ic", name = "b", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "(Lsga;Lae;Loca;)V", line = 78)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Z)V", line = 101)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(BZ)V", line = 122)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IZ)V", line = 154)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(III)V", line = 181)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IILml;)V", line = 210)
    ...
    @OriginalMember(owner = "client!ic", name = "d", descriptor = "(I)V", line = 222)
