...
@OriginalClass("client!ROXEPOUC")
public class class51 {

    @OriginalMember(owner = "client!ROXEPOUC", name = "a", descriptor = "Z")
    private boolean field1338 = true;

    @OriginalMember(owner = "client!ROXEPOUC", name = "b", descriptor = "I")
    private int field1339 = 581;

    @OriginalMember(owner = "client!ROXEPOUC", name = "c", descriptor = "I")
    private int field1340 = 7;

    @OriginalMember(owner = "client!ROXEPOUC", name = "d", descriptor = "LDLMMHADP;")
    public class13 field1341 = new class13();

    @OriginalMember(owner = "client!ROXEPOUC", name = "e", descriptor = "LDLMMHADP;")
    private class13 field1342;

    @OriginalMember(owner = "client!ROXEPOUC", name = "<init>", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!ROXEPOUC", name = "a", descriptor = "(LDLMMHADP;)V")
    ...
    @OriginalMember(owner = "client!ROXEPOUC", name = "a", descriptor = "(ILDLMMHADP;)V")
    ...
    @OriginalMember(owner = "client!ROXEPOUC", name = "a", descriptor = "()LDLMMHADP;")
    ...
    @OriginalMember(owner = "client!ROXEPOUC", name = "b", descriptor = "()LDLMMHADP;")
    ...
    @OriginalMember(owner = "client!ROXEPOUC", name = "a", descriptor = "(I)LDLMMHADP;")
    ...
    @OriginalMember(owner = "client!ROXEPOUC", name = "b", descriptor = "(I)LDLMMHADP;")
    ...
    @OriginalMember(owner = "client!ROXEPOUC", name = "a", descriptor = "(Z)LDLMMHADP;")
    ...
    @OriginalMember(owner = "client!ROXEPOUC", name = "c", descriptor = "()V")
