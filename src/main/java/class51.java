...
@OriginalClass("client!SYRXWHZM")
public class class51 {

    @OriginalMember(owner = "client!SYRXWHZM", name = "a", descriptor = "LYLJOEYBF;")
    public class68 field1255 = new class68();

    @OriginalMember(owner = "client!SYRXWHZM", name = "b", descriptor = "LYLJOEYBF;")
    private class68 field1256;

    @OriginalMember(owner = "client!SYRXWHZM", name = "<init>", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!SYRXWHZM", name = "a", descriptor = "(LYLJOEYBF;)V")
    ...
    @OriginalMember(owner = "client!SYRXWHZM", name = "a", descriptor = "(I)LYLJOEYBF;")
    ...
    @OriginalMember(owner = "client!SYRXWHZM", name = "c", descriptor = "()I")
