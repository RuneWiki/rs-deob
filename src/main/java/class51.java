...
public class class51 {
    ...
    @OriginalMember(owner = "client!PTMGRPAM", name = "e", descriptor = "[LPTMGRPAM;")
    public static class51[] field1311;

    @OriginalMember(owner = "client!PTMGRPAM", name = "a", descriptor = "(LVSUYIIVA;I)V")
    ...
    @OriginalMember(owner = "client!PTMGRPAM", name = "a", descriptor = "(LCFARFRSG;I)V")
    ...
    @OriginalMember(owner = "client!PTMGRPAM", name = "b", descriptor = "(I)LLFTMDGKK;")
    ...
    @OriginalMember(owner = "client!PTMGRPAM", name = "a", descriptor = "(B)LLFTMDGKK;")
