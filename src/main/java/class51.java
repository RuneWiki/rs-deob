...
public class class51 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Lrm;Lrr;)V")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(II)Lfh;")
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lkr;ILok;)V")
