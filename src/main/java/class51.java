...
public class class51 extends class494 implements class258 {
    ...
    @OriginalMember(owner = "client!dm", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!dm", name = "c", descriptor = "(Z)I", line = 20)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(ILha;)V", line = 31)
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(Lha;Liv;IIIIIZIIIIIIZ)V", line = 58)
    ...
    @OriginalMember(owner = "client!dm", name = "i", descriptor = "(I)I", line = 91)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I)Z", line = 106)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Lha;III)Z", line = 117)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(ILha;I)Lka;", line = 138)
    ...
    @OriginalMember(owner = "client!dm", name = "c", descriptor = "(Lha;I)V", line = 158)
    ...
    @OriginalMember(owner = "client!dm", name = "m", descriptor = "(I)V", line = 169)
    public static void method586(int arg0) {
        field1061 = null;
        int var1 = 93 / ((arg0 - -62) / 35);
    }

    @OriginalMember(owner = "client!dm", name = "n", descriptor = "(I)I", line = 178)
    ...
    @OriginalMember(owner = "client!dm", name = "j", descriptor = "(I)Z", line = 190)
    public final boolean method35(int arg0) {
        ++field1086;
        return arg0 > -65 ? true : this.field1070;
    }

    @OriginalMember(owner = "client!dm", name = "d", descriptor = "(I)I", line = 201)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Lha;IZLga;IBI)V", line = 214)
    ...
    @OriginalMember(owner = "client!dm", name = "e", descriptor = "(I)I", line = 248)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(Z)V", line = 260)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(Lha;I)Lhw;", line = 281)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(ILha;IZ)Lak;", line = 297)
    ...
    @OriginalMember(owner = "client!dm", name = "g", descriptor = "(I)Z", line = 331)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(B)Z", line = 346)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Lha;I)V", line = 360)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 397)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(BI)I", line = 419)
    public static final int method593(byte arg0, int arg1) {
        ++field1069;
        return arg0 < 122 ? -49 : arg1 >>> 8;
    }

    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(I)I", line = 430)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(ILha;)Ljda;", line = 440)
