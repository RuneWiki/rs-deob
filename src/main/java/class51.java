...
public class class51 extends class45 {
    ...
    @OriginalMember(owner = "client!pv", name = "<init>", descriptor = "(Lfd;)V")
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(ILkj;Z)V")
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(Lfs;ILfs;)V")
