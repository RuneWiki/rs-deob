...
public class class51 {
    ...
    @OriginalMember(owner = "client!TTZHVWEG", name = "f", descriptor = "LAECNGNXZ;")
    ...
    @OriginalMember(owner = "client!TTZHVWEG", name = "d", descriptor = "[LTTZHVWEG;")
    ...
    @OriginalMember(owner = "client!TTZHVWEG", name = "a", descriptor = "(BI)LTTZHVWEG;")
