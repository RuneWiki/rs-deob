...
public class class51 {
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(ZIZIZLda;Lha;ILuaa;Lha;II)Lhk;")
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(IB)Lnda;")
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(Lgda;ZLgda;Lgda;Lgda;)V")
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(III)Lqea;")
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!gja", name = "a", descriptor = "(IIILuaa;ILha;II)Lhk;")
    ...
    @OriginalMember(owner = "client!gja", name = "<init>", descriptor = "(Lpo;IZLvl;Lgda;Lgda;)V")
