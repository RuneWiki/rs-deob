...
public class class51 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(IIII)Lmf;")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(I)Llv;")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ZLpg;)V")
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lmf;I)V")
