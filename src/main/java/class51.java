...
public class class51 {
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Lqa;BIILjt;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Z)V", line = 62)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Lbt;II)V", line = 77)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ZLbt;)V", line = 112)
