...
public class class51 extends class305 {
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!mf", name = "f", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Lla;Ljava/lang/String;IZ)V", line = 26)
    ...
    @OriginalMember(owner = "client!mf", name = "g", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(IZIIIII)V", line = 60)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Lum;Lum;Lum;Lum;B)V", line = 647)
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "()V", line = 670)
    public class51() {
        super(0, true);
    }

    @OriginalMember(owner = "client!mf", name = "c", descriptor = "(II)V", line = 674)
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(III)Z", line = 693)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(II)[I", line = 704)
