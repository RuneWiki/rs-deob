...
public class class51 extends class65 {
    ...
    @OriginalMember(owner = "client!lca", name = "<init>", descriptor = "(II)V", line = 17)
    public class51(int arg0, int arg1) {
        this.field823 = arg0;
        this.field819 = arg1;
    }

    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(Ljava/lang/String;IZZLjava/lang/String;)V", line = 26)
