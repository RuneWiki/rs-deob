...
public class class51 extends class56 implements class338 {
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Lqa;Z)V")
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(BLqa;I)Lc;")
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IILqa;I)Z")
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!oi", name = "b", descriptor = "(ILqa;)Lfm;")
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IILqa;Leq;IIZ)V")
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Lqa;ZII)Len;")
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(ILqa;I)Lc;")
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(BLge;Lge;)V")
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "(Lqa;Lus;IIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Lqa;I)V")
