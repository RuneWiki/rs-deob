...
public class class51 {
    ...
    @OriginalMember(owner = "client!kl", name = "b", descriptor = "(I)Z", line = 21)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(B)[Lnd;", line = 47)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Lha;II)V", line = 70)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Lha;B)V", line = 90)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IZI)I", line = 116)
