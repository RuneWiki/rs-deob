...
public class class51 implements class407 {
    ...
    @OriginalMember(owner = "client!bq", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lwa;B)Z", line = 15)
    ...
    @OriginalMember(owner = "client!bq", name = "c", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 79)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(B)V", line = 128)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(I)J", line = 221)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 251)
