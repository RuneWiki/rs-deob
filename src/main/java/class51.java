...
public class class51 extends class489 {
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(IIII)Lida;")
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(IIIB)Lkba;")
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(BLkp;I)V")
    ...
    @OriginalMember(owner = "client!aha", name = "<init>", descriptor = "(Leq;)V")
