...
public class class51 extends class85 {
    ...
    @OriginalMember(owner = "client!f", name = "U", descriptor = "[Loh;")
    ...
    @OriginalMember(owner = "client!f", name = "S", descriptor = "Lkf;")
    public static class100 field1033;

    @OriginalMember(owner = "client!f", name = "V", descriptor = "[I")
    public static int[] field1036;

    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lbg;I)V")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(BILja;)V")
