...
public class class51 extends class372 implements class41 {
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(ILya;)V")
    ...
    @OriginalMember(owner = "client!pv", name = "b", descriptor = "(ILya;)V")
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(ILya;II)Z")
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(IILya;)Lt;")
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(ZLya;)Llo;")
    ...
    @OriginalMember(owner = "client!pv", name = "<init>", descriptor = "(Lya;Lho;IIIIIZIIIIII)V")
