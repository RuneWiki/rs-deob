...
public class class51 extends class270 {
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "()[I", line = 4)
    public final int[] method257() {
        return this.field539;
    }

    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(II)V", line = 7)
    ...
    @OriginalMember(owner = "client!gda", name = "b", descriptor = "()V", line = 57)
    public static void method259() {
        field536 = null;
    }

    @OriginalMember(owner = "client!gda", name = "<init>", descriptor = "(II[IZ)V", line = 59)
