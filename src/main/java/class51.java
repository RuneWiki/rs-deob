...
public class class51 extends class425 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "([B[Lqr;ZILvq;II)V", line = 201)
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "()V", line = 278)
    public class51() {
    }

    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ILml;)V", line = 284)
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "(S)V", line = 366)
