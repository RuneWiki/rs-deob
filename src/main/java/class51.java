...
@OriginalClass("client!PKMPUSCK")
public class class51 {

    @OriginalMember(owner = "client!PKMPUSCK", name = "a", descriptor = "I")
    private int field1310 = 7603;

    @OriginalMember(owner = "client!PKMPUSCK", name = "c", descriptor = "B")
    private byte field1312 = 6;

    @OriginalMember(owner = "client!PKMPUSCK", name = "d", descriptor = "Z")
    private boolean field1313 = false;

    @OriginalMember(owner = "client!PKMPUSCK", name = "i", descriptor = "[LUFAEFFVJ;")
    private class58[] field1318 = new class58[10];

    @OriginalMember(owner = "client!PKMPUSCK", name = "b", descriptor = "B")
    private static byte field1311 = 6;

    @OriginalMember(owner = "client!PKMPUSCK", name = "e", descriptor = "[LPKMPUSCK;")
    private static class51[] field1314 = new class51[5000];

    @OriginalMember(owner = "client!PKMPUSCK", name = "f", descriptor = "[I")
    public static int[] field1315 = new int[5000];

    @OriginalMember(owner = "client!PKMPUSCK", name = "j", descriptor = "I")
    private int field1319;

    @OriginalMember(owner = "client!PKMPUSCK", name = "k", descriptor = "I")
    private int field1320;

    @OriginalMember(owner = "client!PKMPUSCK", name = "h", descriptor = "LCKBTFRZM;")
    private static class5 field1317;

    @OriginalMember(owner = "client!PKMPUSCK", name = "g", descriptor = "[B")
    private static byte[] field1316;

    @OriginalMember(owner = "client!PKMPUSCK", name = "<init>", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!PKMPUSCK", name = "a", descriptor = "(ZLCKBTFRZM;)V")
    ...
    @OriginalMember(owner = "client!PKMPUSCK", name = "a", descriptor = "(IZI)LCKBTFRZM;")
    ...
    @OriginalMember(owner = "client!PKMPUSCK", name = "a", descriptor = "(BLCKBTFRZM;)V")
    ...
    @OriginalMember(owner = "client!PKMPUSCK", name = "a", descriptor = "(B)I")
    ...
    @OriginalMember(owner = "client!PKMPUSCK", name = "a", descriptor = "(BI)LCKBTFRZM;")
    ...
    @OriginalMember(owner = "client!PKMPUSCK", name = "a", descriptor = "(I)I")
