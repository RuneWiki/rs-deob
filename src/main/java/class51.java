...
public class class51 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(BLrc;IIIIII)Lrc;")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Z)Lis;")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lec;II)V")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lec;I)V")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IIIIILrc;)Lrc;")
