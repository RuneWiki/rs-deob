...
public class class51 {
    ...
    @OriginalMember(owner = "client!RPWOWYDL", name = "c", descriptor = "LNFNHZJTP;")
    private class36 field1296 = new class36();

    @OriginalMember(owner = "client!RPWOWYDL", name = "g", descriptor = "LQUHNUHWS;")
    ...
    @OriginalMember(owner = "client!RPWOWYDL", name = "f", descriptor = "LEKGZTZOT;")
    ...
    @OriginalMember(owner = "client!RPWOWYDL", name = "a", descriptor = "(J)LNFNHZJTP;")
    ...
    @OriginalMember(owner = "client!RPWOWYDL", name = "a", descriptor = "(BJLNFNHZJTP;)V")
