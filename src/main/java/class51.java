...
public class class51 extends class210 {
    ...
    @OriginalMember(owner = "client!ha", name = "g", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/String;", line = 36)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IILkg;I)V", line = 86)
    ...
    @OriginalMember(owner = "client!ha", name = "c", descriptor = "(B)V", line = 99)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ILjb;)Z", line = 133)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lct;Z)V", line = 153)
    ...
    @OriginalMember(owner = "client!ha", name = "h", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IILat;)V", line = 178)
    ...
    @OriginalMember(owner = "client!ha", name = "<init>", descriptor = "()V", line = 194)
    public class51() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(II)[[I", line = 197)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IB)[I", line = 245)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(BI)Lla;", line = 278)
    ...
    @OriginalMember(owner = "client!ha", name = "i", descriptor = "(I)V", line = 311)
