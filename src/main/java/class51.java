...
public class class51 {
    ...
    @OriginalMember(owner = "client!UFBSEXDM", name = "o", descriptor = "LLOQKYCGM;")
    private class26 field1506;

    @OriginalMember(owner = "client!UFBSEXDM", name = "b", descriptor = "LTMVRZUVH;")
    private class49 field1493;

    @OriginalMember(owner = "client!UFBSEXDM", name = "c", descriptor = "LTMVRZUVH;")
    private class49 field1494;

    @OriginalMember(owner = "client!UFBSEXDM", name = "d", descriptor = "LTMVRZUVH;")
    private class49 field1495;

    @OriginalMember(owner = "client!UFBSEXDM", name = "e", descriptor = "LTMVRZUVH;")
    private class49 field1496;

    @OriginalMember(owner = "client!UFBSEXDM", name = "f", descriptor = "LTMVRZUVH;")
    private class49 field1497;

    @OriginalMember(owner = "client!UFBSEXDM", name = "g", descriptor = "LTMVRZUVH;")
    private class49 field1498;

    @OriginalMember(owner = "client!UFBSEXDM", name = "h", descriptor = "LTMVRZUVH;")
    private class49 field1499;

    @OriginalMember(owner = "client!UFBSEXDM", name = "i", descriptor = "LTMVRZUVH;")
    private class49 field1500;

    @OriginalMember(owner = "client!UFBSEXDM", name = "p", descriptor = "LTMVRZUVH;")
    ...
    @OriginalMember(owner = "client!UFBSEXDM", name = "a", descriptor = "(LGHHPHSRU;I)V")
