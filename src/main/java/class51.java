...
public class class51 extends class440 {
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IIIIFIII[FIF)V", line = 157)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Ljava/lang/Throwable;I)Ljava/lang/String;", line = 208)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(BI)[I", line = 281)
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "()V", line = 306)
    public class51() {
        super(0, true);
    }

    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IIIZZBI)V", line = 309)
