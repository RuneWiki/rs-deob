...
public class class51 {
    ...
    @OriginalMember(owner = "client!RHGWIWMQ", name = "c", descriptor = "[LRHGWIWMQ;")
    public static class51[] field1447;

    @OriginalMember(owner = "client!RHGWIWMQ", name = "a", descriptor = "(LMNPBQFWE;B)V")
    ...
    @OriginalMember(owner = "client!RHGWIWMQ", name = "a", descriptor = "(ILBJPWOXRJ;)V")
    ...
    @OriginalMember(owner = "client!RHGWIWMQ", name = "b", descriptor = "(I)LJLNSJQDR;")
    ...
    @OriginalMember(owner = "client!RHGWIWMQ", name = "d", descriptor = "(I)LJLNSJQDR;")
