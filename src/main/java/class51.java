...
public class class51 extends class7 {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ZIBLoh;Loh;)I")
    ...
    @OriginalMember(owner = "client!ps", name = "c", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Ljg;IB)V")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ZLjg;)V")
