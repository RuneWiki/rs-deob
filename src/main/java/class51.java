...
public class class51 extends class408 implements class18 {
    ...
    @OriginalMember(owner = "client!aea", name = "finalize", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(IIII)Lns;", line = 17)
    ...
    @OriginalMember(owner = "client!aea", name = "b", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(Lvs;)V", line = 97)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(I)V", line = 179)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(III)V", line = 192)
    ...
    @OriginalMember(owner = "client!aea", name = "e", descriptor = "(I)V", line = 202)
    ...
    @OriginalMember(owner = "client!aea", name = "<init>", descriptor = "(Lwh;III)V", line = 328)
    ...
    @OriginalMember(owner = "client!aea", name = "<init>", descriptor = "(Lwh;IIII)V", line = 347)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(IZIII)V", line = 225)
    ...
    @OriginalMember(owner = "client!aea", name = "f", descriptor = "(I)I", line = 284)
