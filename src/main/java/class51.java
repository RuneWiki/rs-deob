...
public class class51 extends class110 implements class401 {
    ...
    @OriginalMember(owner = "client!caa", name = "f", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!caa", name = "<init>", descriptor = "(Llm;Z)V")
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(ILqi;BI)V")
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(Lrca;B)I")
