...
public class class51 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(ILer;I[I[II)Lmba;", line = 7)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(II)V", line = 42)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(I)[Lhl;", line = 86)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(BI)V", line = 97)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(III)Z", line = 108)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(B)V", line = 119)
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(Lvd;III)V", line = 141)
