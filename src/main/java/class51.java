...
public class class51 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lkk;IB)V")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lvc;ZIB)Lrn;")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(BLkk;)V")
