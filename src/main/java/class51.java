...
public abstract class class51 {
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "([BBI)V", line = 5)
    ...
    @OriginalMember(owner = "client!pv", name = "c", descriptor = "(Z)V", line = 30)
    ...
    @OriginalMember(owner = "client!pv", name = "finalize", descriptor = "()V", line = 56)
    ...
    @OriginalMember(owner = "client!pv", name = "<init>", descriptor = "(Lbt;I[BIZ)V", line = 67)
    ...
    @OriginalMember(owner = "client!pv", name = "<init>", descriptor = "(Lbt;ILjaggl/memory/NativeBuffer;IZ)V", line = 86)
