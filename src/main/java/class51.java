...
public class class51 extends class159 {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ZII)V", line = 3)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lwu;II)V", line = 31)
    ...
    @OriginalMember(owner = "client!c", name = "b", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(BZ)V", line = 70)
    ...
    @OriginalMember(owner = "client!c", name = "b", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!c", name = "<init>", descriptor = "(Ldw;Lcd;)V", line = 101)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Z)Z", line = 124)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ZB)V", line = 145)
