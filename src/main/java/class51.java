...
@OriginalClass("client!SRLFLGUY")
public class class51 {

    @OriginalMember(owner = "client!SRLFLGUY", name = "h", descriptor = "Z")
    public boolean field1333 = false;

    @OriginalMember(owner = "client!SRLFLGUY", name = "i", descriptor = "I")
    public int field1334 = -1;

    @OriginalMember(owner = "client!SRLFLGUY", name = "k", descriptor = "Z")
    public boolean field1336 = true;

    @OriginalMember(owner = "client!SRLFLGUY", name = "a", descriptor = "I")
    private static int field1326 = -23379;

    @OriginalMember(owner = "client!SRLFLGUY", name = "b", descriptor = "I")
    public static int field1327;

    @OriginalMember(owner = "client!SRLFLGUY", name = "e", descriptor = "I")
    public int field1330;

    @OriginalMember(owner = "client!SRLFLGUY", name = "f", descriptor = "I")
    public int field1331;

    @OriginalMember(owner = "client!SRLFLGUY", name = "g", descriptor = "I")
    public int field1332;

    @OriginalMember(owner = "client!SRLFLGUY", name = "j", descriptor = "I")
    public int field1335;

    @OriginalMember(owner = "client!SRLFLGUY", name = "d", descriptor = "Ljava/lang/String;")
    public String field1329;

    @OriginalMember(owner = "client!SRLFLGUY", name = "c", descriptor = "[LSRLFLGUY;")
    public static class51[] field1328;

    @OriginalMember(owner = "client!SRLFLGUY", name = "a", descriptor = "(ILBBMKAXRK;)V")
    ...
    @OriginalMember(owner = "client!SRLFLGUY", name = "a", descriptor = "(ILEILHLJCE;I)V")
