...
public class class51 {
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(II)[B", line = 3)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "([BI)V", line = 80)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(BII)Z", line = 131)
