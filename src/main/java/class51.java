...
public class class51 extends class509 {
    ...
    @OriginalMember(owner = "client!fw", name = "c", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!fw", name = "<init>", descriptor = "(Lhv;)V", line = 18)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(B)V", line = 39)
