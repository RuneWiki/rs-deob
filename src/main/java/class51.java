...
public class class51 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(BLkh;)V")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ILkh;I)V")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(BI)Lqs;")
