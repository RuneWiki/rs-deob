...
public class class51 {
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Lti;I)V")
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IILti;)V")
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IIILjava/lang/Class;)Ltp;")
