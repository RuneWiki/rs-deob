...
public class class51 extends class108 {
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(I[BB)I", line = 16)
    public static final int method440(int arg0, byte[] arg1, byte arg2) {
        field756++;
        return arg2 <= 73 ? 124 : class386.method2346(arg0, arg1, -101, 0);
    }

    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(BLjava/lang/String;)I", line = 27)
