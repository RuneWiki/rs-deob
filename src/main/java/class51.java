...
public class class51 {
    ...
    @OriginalMember(owner = "client!SNQOEFQG", name = "o", descriptor = "LADELCBNY;")
    private class1 field1336;

    @OriginalMember(owner = "client!SNQOEFQG", name = "b", descriptor = "LTDXKKGZV;")
    private class54 field1323;

    @OriginalMember(owner = "client!SNQOEFQG", name = "c", descriptor = "LTDXKKGZV;")
    private class54 field1324;

    @OriginalMember(owner = "client!SNQOEFQG", name = "d", descriptor = "LTDXKKGZV;")
    private class54 field1325;

    @OriginalMember(owner = "client!SNQOEFQG", name = "e", descriptor = "LTDXKKGZV;")
    private class54 field1326;

    @OriginalMember(owner = "client!SNQOEFQG", name = "f", descriptor = "LTDXKKGZV;")
    private class54 field1327;

    @OriginalMember(owner = "client!SNQOEFQG", name = "g", descriptor = "LTDXKKGZV;")
    private class54 field1328;

    @OriginalMember(owner = "client!SNQOEFQG", name = "h", descriptor = "LTDXKKGZV;")
    private class54 field1329;

    @OriginalMember(owner = "client!SNQOEFQG", name = "i", descriptor = "LTDXKKGZV;")
    private class54 field1330;

    @OriginalMember(owner = "client!SNQOEFQG", name = "p", descriptor = "LTDXKKGZV;")
    ...
    @OriginalMember(owner = "client!SNQOEFQG", name = "a", descriptor = "(ILIMUIZRAF;)V")
