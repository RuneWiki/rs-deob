...
public class class51 implements Runnable {
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(Z)V", line = 12)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(IIZ[B)V", line = 28)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(B)I", line = 93)
    ...
    @OriginalMember(owner = "client!caa", name = "b", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "([BIII)V", line = 133)
    ...
    @OriginalMember(owner = "client!caa", name = "finalize", descriptor = "()V", line = 158)
    protected final void finalize() {
        this.method264((byte) 127);
        field605++;
    }

    @OriginalMember(owner = "client!caa", name = "c", descriptor = "(I)V", line = 166)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(II)V", line = 193)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(IIB)I", line = 208)
    ...
    @OriginalMember(owner = "client!caa", name = "b", descriptor = "(Z)V", line = 224)
    ...
    @OriginalMember(owner = "client!caa", name = "b", descriptor = "(B)V", line = 250)
    ...
    @OriginalMember(owner = "client!caa", name = "<init>", descriptor = "(Ljava/net/Socket;Luf;)V", line = 402)
    ...
    @OriginalMember(owner = "client!caa", name = "d", descriptor = "(I)I", line = 306)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(Ljda;IIB)V", line = 324)
    ...
    @OriginalMember(owner = "client!caa", name = "run", descriptor = "()V", line = 336)
