...
public class class51 {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ILmm;II)V")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(BLmm;II)V")
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(ILmm;II)Z")
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(Lao;Lje;)V")
