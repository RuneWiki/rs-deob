...
@OriginalClass("client!RVDLUGTG")
public class class51 extends class6 {

    @OriginalMember(owner = "client!RVDLUGTG", name = "y", descriptor = "I")
    private int field1381 = 2578;

    @OriginalMember(owner = "client!RVDLUGTG", name = "z", descriptor = "Z")
    public boolean field1382 = false;

    @OriginalMember(owner = "client!RVDLUGTG", name = "F", descriptor = "LIDBAHLFM;")
    private class22 field1388;

    @OriginalMember(owner = "client!RVDLUGTG", name = "A", descriptor = "I")
    public int field1383;

    @OriginalMember(owner = "client!RVDLUGTG", name = "s", descriptor = "I")
    public int field1375;

    @OriginalMember(owner = "client!RVDLUGTG", name = "t", descriptor = "I")
    public int field1376;

    @OriginalMember(owner = "client!RVDLUGTG", name = "u", descriptor = "I")
    public int field1377;

    @OriginalMember(owner = "client!RVDLUGTG", name = "D", descriptor = "I")
    public int field1386;

    @OriginalMember(owner = "client!RVDLUGTG", name = "E", descriptor = "I")
    public int field1387;

    @OriginalMember(owner = "client!RVDLUGTG", name = "l", descriptor = "I")
    public int field1368;

    @OriginalMember(owner = "client!RVDLUGTG", name = "m", descriptor = "I")
    public int field1369;

    @OriginalMember(owner = "client!RVDLUGTG", name = "n", descriptor = "I")
    public int field1370;

    @OriginalMember(owner = "client!RVDLUGTG", name = "v", descriptor = "I")
    public int field1378;

    @OriginalMember(owner = "client!RVDLUGTG", name = "o", descriptor = "D")
    public double field1371;

    @OriginalMember(owner = "client!RVDLUGTG", name = "p", descriptor = "D")
    public double field1372;

    @OriginalMember(owner = "client!RVDLUGTG", name = "q", descriptor = "D")
    public double field1373;

    @OriginalMember(owner = "client!RVDLUGTG", name = "r", descriptor = "D")
    private double field1374;

    @OriginalMember(owner = "client!RVDLUGTG", name = "G", descriptor = "D")
    private double field1389;

    @OriginalMember(owner = "client!RVDLUGTG", name = "H", descriptor = "D")
    private double field1390;

    @OriginalMember(owner = "client!RVDLUGTG", name = "I", descriptor = "D")
    private double field1391;

    @OriginalMember(owner = "client!RVDLUGTG", name = "J", descriptor = "D")
    private double field1392;

    @OriginalMember(owner = "client!RVDLUGTG", name = "w", descriptor = "I")
    private int field1379;

    @OriginalMember(owner = "client!RVDLUGTG", name = "x", descriptor = "I")
    private int field1380;

    @OriginalMember(owner = "client!RVDLUGTG", name = "B", descriptor = "I")
    public int field1384;

    @OriginalMember(owner = "client!RVDLUGTG", name = "C", descriptor = "I")
    public int field1385;

    @OriginalMember(owner = "client!RVDLUGTG", name = "<init>", descriptor = "(IIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!RVDLUGTG", name = "a", descriptor = "(IZIII)V")
    ...
    @OriginalMember(owner = "client!RVDLUGTG", name = "a", descriptor = "(ZI)V")
    ...
    @OriginalMember(owner = "client!RVDLUGTG", name = "a", descriptor = "(B)LGEUHTGZJ;")
