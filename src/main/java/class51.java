...
public class class51 extends class185 {
    ...
    @OriginalMember(owner = "client!gda", name = "<init>", descriptor = "(Ljaa;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!gda", name = "<init>", descriptor = "(Ljaa;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!gda", name = "<init>", descriptor = "(Ljaa;II)V")
