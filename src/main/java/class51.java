...
public class class51 extends class578 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IBLui;)Z", line = 21)
    ...
    @OriginalMember(owner = "client!mk", name = "c", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!mk", name = "d", descriptor = "(B)J", line = 64)
    ...
    @OriginalMember(owner = "client!mk", name = "d", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!mk", name = "g", descriptor = "(I)I", line = 87)
    public final int method405(int arg0) {
        ++field595;
        return arg0 != 255 ? 47 : (int) super.field5623;
    }

    @OriginalMember(owner = "client!mk", name = "c", descriptor = "(Z)I", line = 101)
    public final int method406(boolean arg0) {
        ++field594;
        return !arg0 ? -114 : (int) (255L & super.field5623 >>> 32);
    }

    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(II)V", line = 112)
