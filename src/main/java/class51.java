...
public class class51 extends class56 {
    ...
    @OriginalMember(owner = "client!SWNASVGQ", name = "<init>", descriptor = "(LGWOEELWB;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!SWNASVGQ", name = "a", descriptor = "(IIILNUXLZYAZ;)V")
