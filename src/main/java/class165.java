...
public class class165 implements Runnable {
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(IIILjava/lang/Object;B)Lvs;", line = 3)
    ...
    @OriginalMember(owner = "client!pq", name = "run", descriptor = "()V", line = 35)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Ljava/lang/String;B)Lvs;", line = 157)
    public final class506 method898(String arg0, byte arg1) {
        return arg1 == -44 ? this.method897(21, 0, 0, arg0, (byte) -103) : null;
    }

    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(IIILjava/lang/Object;I)Lvs;", line = 167)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(IIILjava/awt/Component;)Lvs;", line = 203)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(BILjava/lang/Runnable;)Lvs;", line = 217)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "([Ljava/lang/Class;BLjava/lang/String;Ljava/lang/Class;)Lvs;", line = 227)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ILjava/io/File;[B)Z", line = 242)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Ljava/awt/Frame;I)Lvs;", line = 265)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(I)Z", line = 275)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Z)V", line = 290)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ILjava/lang/Class;)V", line = 347)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(B)Lvs;", line = 381)
    ...
    @OriginalMember(owner = "client!pq", name = "b", descriptor = "(I)Lvs;", line = 394)
    ...
    @OriginalMember(owner = "client!pq", name = "c", descriptor = "(I)V", line = 404)
    ...
    @OriginalMember(owner = "client!pq", name = "b", descriptor = "(Ljava/lang/String;B)Lvs;", line = 414)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Ljava/lang/String;IZ)Lvs;", line = 424)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ILjava/awt/datatransfer/Transferable;)Lvs;", line = 438)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;B)Lvs;", line = 448)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(IILjava/awt/Component;Ljava/awt/Point;I[I)Lvs;", line = 458)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(II)Lvs;", line = 467)
    ...
    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;I)V", line = 705)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ILjava/lang/String;)Ljava/io/File;", line = 499)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;IZ)Ljava/io/File;", line = 512)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ILjava/net/URL;)Lvs;", line = 603)
    ...
    @OriginalMember(owner = "client!pq", name = "b", descriptor = "(ILjava/lang/String;)[B", line = 613)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ZLjava/awt/Component;I)Lvs;", line = 626)
    ...
    @OriginalMember(owner = "client!pq", name = "d", descriptor = "(I)Lch;", line = 639)
    public final class392 method922(int arg0) {
        int var2 = -35 % ((arg0 + 11) / 55);
        return this.field2020;
    }

    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(BIIII)Lvs;", line = 656)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ILjava/lang/String;I)Lvs;", line = 678)
