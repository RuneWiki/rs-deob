...
public class class165 extends class66 {
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(IIIIBIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(IIIIII)V", line = 175)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(I)V", line = 296)
