...
public abstract class class165 {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(IIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!mr", name = "b", descriptor = "(I)V", line = 180)
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(IIIII)V", line = 281)
    ...
    @OriginalMember(owner = "client!mr", name = "b", descriptor = "(Z)V", line = 241)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(B)V", line = 266)
