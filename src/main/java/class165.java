...
public class class165 {
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "([Ldfa;I)I", line = 7)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(Ldfa;JI)V", line = 39)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(B)I", line = 56)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!tba", name = "b", descriptor = "(I)Ldfa;", line = 87)
    ...
    @OriginalMember(owner = "client!tba", name = "b", descriptor = "(B)Ljava/lang/String;", line = 101)
    ...
    @OriginalMember(owner = "client!tba", name = "c", descriptor = "(I)Ldfa;", line = 116)
    ...
    @OriginalMember(owner = "client!tba", name = "c", descriptor = "(B)I", line = 148)
    ...
    @OriginalMember(owner = "client!tba", name = "<init>", descriptor = "(I)V", line = 180)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(JI)Ldfa;", line = 205)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(Z)V", line = 238)
    ...
    @OriginalMember(owner = "client!tba", name = "d", descriptor = "(I)Ldfa;", line = 277)
