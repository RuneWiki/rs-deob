...
public class class165 extends class406 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ZLod;)V")
    ...
    @OriginalMember(owner = "client!ib", name = "c", descriptor = "(B)Lrda;")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ZLgca;)V")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lfca;Z)V")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lkh;IIIZLha;)V")
