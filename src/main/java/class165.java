...
public class class165 {
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(CZ)Z", line = 43)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Lhh;BLhh;)I", line = 55)
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "(III)V", line = 94)
