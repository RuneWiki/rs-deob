...
public class class165 {
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Z[[I)V", line = 19)
    ...
    @OriginalMember(owner = "client!ev", name = "<init>", descriptor = "(ILjava/lang/String;ILjava/lang/String;J)V", line = 30)
