...
public class class165 extends class210 {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!c", name = "g", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!c", name = "h", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ZI)I", line = 51)
    ...
    @OriginalMember(owner = "client!c", name = "b", descriptor = "(Z)V", line = 93)
    ...
    @OriginalMember(owner = "client!c", name = "<init>", descriptor = "()V", line = 112)
    public class165() {
        super(1, true);
    }

    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IB)[I", line = 120)
