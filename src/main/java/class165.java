...
public class class165 extends class411 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ILaia;)Z")
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(IILwm;I)Lne;")
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Luaa;ILuaa;)V")
