...
public class class165 extends class57 implements class149 {
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Le;Lfa;IIIIIZIIIIIIZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(B)Z", line = 41)
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(Le;B)V", line = 54)
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(Z)V", line = 80)
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(I)I", line = 134)
    ...
    @OriginalMember(owner = "client!ca", name = "f", descriptor = "(I)I", line = 149)
    ...
    @OriginalMember(owner = "client!ca", name = "c", descriptor = "(I)Z", line = 160)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Le;Z)Lum;", line = 171)
    ...
    @OriginalMember(owner = "client!ca", name = "d", descriptor = "(I)V", line = 198)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IIILe;)Z", line = 212)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(ILe;B)Lid;", line = 232)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(ILe;IIZLhm;I)V", line = 254)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Le;B)V", line = 286)
    ...
    @OriginalMember(owner = "client!ca", name = "e", descriptor = "(B)I", line = 314)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(ZLe;ZI)Lns;", line = 325)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Z)I", line = 355)
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(II)Lvg;", line = 368)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Le;I)V", line = 380)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(B)I", line = 406)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Le;IB)Lid;", line = 420)
