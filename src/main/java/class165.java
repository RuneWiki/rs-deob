...
public class class165 implements Runnable {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(BLoc;I)Lbq;")
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(ILoc;I)Lbq;")
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(I[BBLoc;)Lbq;")
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Lbq;Z)V")
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "(Lji;)V")
