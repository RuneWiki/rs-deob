...
public class class165 {
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IBLhf;ILjava/awt/Canvas;Lvl;)Lqq;", line = 64)
    ...
    @OriginalMember(owner = "client!mb", name = "b", descriptor = "(B)V", line = 77)
