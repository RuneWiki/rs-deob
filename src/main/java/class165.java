...
public class class165 {
    ...
    @OriginalMember(owner = "client!ae", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field2103++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(ZI)V", line = 28)
    ...
    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 42)
