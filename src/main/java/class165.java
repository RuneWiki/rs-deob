...
public class class165 extends class127 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IIIIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(B)V", line = 24)
    public static void method1130(byte arg0) {
        field2607 = null;
        int var1 = 76 % ((arg0 + 7) / 36);
    }

    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IFIIIBF[FFFI)V", line = 39)
    ...
    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lza;Lec;Z)V", line = 176)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ZZ)V", line = 195)
