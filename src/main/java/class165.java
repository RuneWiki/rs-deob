...
public class class165 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IIII)Lng;", line = 14)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(I)Ldc;", line = 35)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IIIII)I", line = 48)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(IIIIB)V", line = 74)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(Lng;I)V", line = 85)
