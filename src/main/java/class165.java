...
public class class165 extends class13 {
    ...
    @OriginalMember(owner = "client!nb", name = "d", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(ZI)[I", line = 19)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(II)[[I", line = 52)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lkh;BI)V", line = 99)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IC)Z", line = 125)
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "()V", line = 136)
    public class165() {
        super(1, false);
    }
}
