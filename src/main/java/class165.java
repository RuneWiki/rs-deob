...
public class class165 extends class54 {
    ...
    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "(ILhia;)V", line = 3)
    public class165(int arg0, class73 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!g", name = "a", descriptor = "(ZLha;)V", line = 8)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Z)V", line = 30)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(ILjava/lang/String;)V", line = 47)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(ZI)V", line = 78)
    ...
    @OriginalMember(owner = "client!g", name = "d", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!g", name = "b", descriptor = "(Z)I", line = 109)
    ...
    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "(Lhia;)V", line = 121)
    public class165(class73 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!g", name = "b", descriptor = "(IB)I", line = 124)
    ...
    @OriginalMember(owner = "client!g", name = "c", descriptor = "(Z)I", line = 135)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(II)V", line = 152)
