...
public abstract class class165 extends class540 {
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Lrv;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(ILada;)I", line = 53)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(IIILwq;ILaa;IJI)V", line = 85)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "([BBIILjava/lang/String;I)I", line = 142)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(I[ILkia;[I[I)V", line = 282)
