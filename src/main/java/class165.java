...
public class class165 extends class443 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lfb;I)Lwf;", line = 3)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "()V", line = 17)
    ...
    @OriginalMember(owner = "client!ki", name = "d", descriptor = "(I)V", line = 243)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(I[I[ILqc;[I)V", line = 253)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Ljava/lang/String;B)[B", line = 357)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(I[ZIILtj;[[B[[BLpc;IIILa;I[[B)V", line = 499)
    ...
    @OriginalMember(owner = "client!ki", name = "d", descriptor = "(B)V", line = 979)
