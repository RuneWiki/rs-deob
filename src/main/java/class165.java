...
public class class165 extends class85 {
    ...
    @OriginalMember(owner = "client!rh", name = "T", descriptor = "Llf;")
    public static class109 field3099 = class35.method275("::clientdrop", 2);

    @OriginalMember(owner = "client!rh", name = "V", descriptor = "I")
    public static int field3101 = 0;

    @OriginalMember(owner = "client!rh", name = "Y", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(BILja;)V")
