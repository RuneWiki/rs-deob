...
public class class165 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(IIIILit;)V", line = 32)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(B)V", line = 193)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "([Ljava/lang/String;Z)[Ljava/lang/String;", line = 206)
