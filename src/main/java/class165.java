...
public class class165 extends class124 implements class294 {
    ...
    @OriginalMember(owner = "client!qa", name = "finalize", descriptor = "()V", line = 12)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "()Lc;", line = 18)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(III[I)V", line = 30)
    public final void method837(int arg0, int arg1, int arg2, int[] arg3) {
        this.method1166(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "()V", line = 34)
    public class165() {
        this.method1165();
    }
