...
public abstract class class165 {
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "([BB)[B", line = 7)
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(Z)V", line = 64)
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!eha", name = "<init>", descriptor = "(Lep;)V", line = 106)
