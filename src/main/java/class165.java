...
public abstract class class165 {
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(BLjava/lang/String;)V", line = 29)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 101)
