...
public class class165 extends class384 {
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(Lbia;BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!wfa", name = "e", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(II)I", line = 29)
    public static final int method1017(int arg0, int arg1) {
        return class340.field4391 != null ? class340.field4391[arg0][arg1] & 65535 : 0;
    }

    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(IZ)V", line = 32)
    ...
    @OriginalMember(owner = "client!wfa", name = "<init>", descriptor = "(Lbm;Leb;)V", line = 43)
    public class165(class684 arg0, class9 arg1) {
        super(arg0);
        this.field2108 = arg1;
    }

    @OriginalMember(owner = "client!wfa", name = "b", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(ZB)V", line = 72)
    ...
    @OriginalMember(owner = "client!wfa", name = "d", descriptor = "(B)Z", line = 91)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/String;", line = 102)
    ...
    @OriginalMember(owner = "client!wfa", name = "e", descriptor = "(B)V", line = 163)
    ...
    @OriginalMember(owner = "client!wfa", name = "b", descriptor = "(Z)Ljava/lang/String;", line = 187)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(IBI)V", line = 202)
    ...
    @OriginalMember(owner = "client!wfa", name = "f", descriptor = "(B)V", line = 246)
    ...
    @OriginalMember(owner = "client!wfa", name = "f", descriptor = "(I)V", line = 262)
