...
public class class165 {
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(IBI)I", line = 12)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(II)Lkaa;", line = 35)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(B)V", line = 103)
