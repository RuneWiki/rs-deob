...
public class class165 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(IIILjava/lang/Class;)Lhd;", line = 7)
    ...
    @OriginalMember(owner = "client!ks", name = "<init>", descriptor = "()V", line = 161)
    public class165() {
        this.field2098.field6280 = this.field2098;
        this.field2098.field6279 = this.field2098;
    }

    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Z)V", line = 40)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(Z)Lwk;", line = 62)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Lwk;I)V", line = 91)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(III)B", line = 118)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(I)Lwk;", line = 141)
