...
public class class165 extends class70 {
    ...
    @OriginalMember(owner = "client!wda", name = "<init>", descriptor = "(Lnha;Ljn;IIIIIIIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(I)Lvj;", line = 20)
    public final class26 method117(int arg0) {
        field2536++;
        return arg0 == 1 ? class197.field3392 : null;
    }

    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(IIIIIBIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(B)V", line = 50)
