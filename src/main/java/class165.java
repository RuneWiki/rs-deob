...
public class class165 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(II)Lot;", line = 20)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(I)Lit;", line = 31)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(II)V", line = 52)
    public class165(int arg0, int arg1) {
        this.field2131 = arg1;
        this.field2132 = arg0;
    }

    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Lot;I)V", line = 60)
