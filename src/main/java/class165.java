...
public class class165 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(ILiv;)V")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Liv;II)V")
