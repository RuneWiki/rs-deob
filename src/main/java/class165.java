...
public class class165 extends class145 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Lap;BI)V")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Lrk;I)V")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(IIILcc;)V")
