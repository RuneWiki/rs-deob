...
public abstract class class165 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIIIB)V", line = 5)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Laf;", line = 17)
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(B)V", line = 107)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIII)V", line = 119)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(BB)C", line = 151)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IZIIII)V", line = 184)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIILub;ILcd;ILwk;)V", line = 203)
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(B)V", line = 333)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IBIII)V", line = 349)
    ...
    @OriginalMember(owner = "client!qa", name = "finalize", descriptor = "()V", line = 366)
    protected void finalize() {
        field2228++;
        this.method1120((byte) -121);
    }

    @OriginalMember(owner = "client!qa", name = "c", descriptor = "(B)V", line = 381)
    ...
    @OriginalMember(owner = "client!qa", name = "d", descriptor = "(IIIIII)V", line = 406)
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(IIIII)V", line = 419)
    ...
    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "(ILl;)V", line = 452)
    public class165(int arg0, class15 arg1) {
        this.field2233 = arg0;
        this.field2235 = arg1;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Ldq;IBLjava/awt/Canvas;Ll;I)Lqa;", line = 461)
