...
public class class165 extends class41 implements class283 {
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(I)J", line = 4)
    ...
    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(Lok;ILjaclib/memory/Buffer;IZ)V", line = 15)
    public class165(class228 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field2367 = arg1;
    }

    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(ILmo;)Ljo;", line = 28)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(B)I", line = 39)
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(IBLmo;)Ljava/lang/String;", line = 63)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(I)I", line = 93)
    public final int method1142(int arg0) {
        ++field2364;
        return arg0 != -22806 ? -80 : super.field677;
    }

    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(BII[B)V", line = 105)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Lea;)V", line = 116)
    ...
    @OriginalMember(owner = "client!vda", name = "c", descriptor = "(I)V", line = 209)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Z)Z", line = 219)
    ...
    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(Lok;I[BIZ)V", line = 233)
