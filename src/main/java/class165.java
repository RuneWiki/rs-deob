...
public class class165 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILqu;)V", line = 4)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(I)I", line = 44)
