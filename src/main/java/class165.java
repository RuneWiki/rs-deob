...
public class class165 implements class682 {
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IZ)V", line = 95)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(B)Z", line = 134)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IIIIIIILjava/lang/String;)V", line = 157)
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "(Lpe;Lpe;Ldv;)V", line = 177)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(I[BILia;)Lne;", line = 188)
