...
public class class165 extends class135 {
    ...
    @OriginalMember(owner = "client!cc", name = "g", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!cc", name = "c", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "(Lad;Lvo;Lob;)V", line = 27)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(III)V", line = 68)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IZILpn;Lvo;ZI)V", line = 105)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Laj;II)V", line = 129)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ZI)V", line = 146)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;I)V", line = 175)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IZ)V", line = 185)
