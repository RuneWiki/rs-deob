...
public class class165 extends class98 {
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "()V", line = 3)
    public class165() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(II)[I", line = 11)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(ILdg;I)V", line = 54)
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(II)[[I", line = 97)
