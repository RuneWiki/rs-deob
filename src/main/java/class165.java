...
public class class165 extends class168 implements class164 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(ZLya;)V", line = 14)
    ...
    @OriginalMember(owner = "client!nj", name = "j", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!nj", name = "c", descriptor = "(I)I", line = 42)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IIIB)V", line = 66)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Lya;ZI)Lt;", line = 77)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(BII)I", line = 88)
    ...
    @OriginalMember(owner = "client!nj", name = "d", descriptor = "(I)Z", line = 109)
    public final boolean method614(int arg0) {
        field2418++;
        return arg0 != -1086;
    }

    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IIIIIII)Lpc;", line = 120)
    ...
    @OriginalMember(owner = "client!nj", name = "g", descriptor = "(I)I", line = 143)
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(IIIIILsr;)V", line = 154)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(BLya;II)Z", line = 172)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IIIIILkd;)Loi;", line = 186)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(ILya;)V", line = 205)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(I)I", line = 215)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Lya;Z)V", line = 226)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Lya;I)Lag;", line = 237)
