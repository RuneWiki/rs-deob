...
public class class165 extends class283 {
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Ljc;B)V", line = 14)
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(B)V", line = 199)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(I)Z", line = 211)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 223)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Lou;II)V", line = 277)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(B)V", line = 291)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(III)I", line = 302)
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Lkw;)V", line = 319)
    public class165(class346 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(IZ)V", line = 325)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(ZII)V", line = 341)
