...
public class jagmisc {
    ...
    @OriginalMember(owner = "client!jagex3/jagmisc/jagmisc", name = "quit", descriptor = "()V", line = 7)
    public static void quit() {
        Quit0();
    }

    @OriginalMember(owner = "client!jagex3/jagmisc/jagmisc", name = "ping", descriptor = "(BBBBJ)I", line = 15)
