...
public class NativeInterface {
   @OriginalMember(
      owner = "client!jagex3/graphics2/hw/NativeInterface",
      name = "peer",
      descriptor = "J"
   )
   public long peer;
   ...
   @OriginalMember(
      owner = "client!jagex3/graphics2/hw/NativeInterface",
      name = "copyLighting",
      descriptor = "([S[B[S[S[S[S[BII[SIIIJ)V"
   )
