...
public class class213 implements class283 {
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(III)V", line = 58)
    ...
    @OriginalMember(owner = "client!kv", name = "b", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(B)Ltj;", line = 84)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(I)I", line = 95)
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(Lpl;)V", line = 114)
