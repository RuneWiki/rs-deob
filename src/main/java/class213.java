...
public class class213 extends class70 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Lwe;I)V", line = 16)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Llf;ZFIZ)V", line = 147)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Lne;I)Lne;", line = 167)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IZZ)V", line = 201)
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(Lwe;I)V", line = 223)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Le;)V", line = 243)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Z)V", line = 327)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(BLwe;)V", line = 383)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(II)V", line = 404)
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(I)V", line = 424)
    ...
    @OriginalMember(owner = "client!es", name = "d", descriptor = "(I)V", line = 444)
