...
public class class213 {
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(ZJZI)Ljava/lang/String;", line = 30)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IZ)V", line = 85)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(II)Lcaa;", line = 105)
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(Lmca;ILgga;)V", line = 139)
