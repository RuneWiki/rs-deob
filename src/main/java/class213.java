...
public class class213 {
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(BLpca;J)V")
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(JB)Lpca;")
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(I)Lpca;")
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "([Lpca;B)I")
    ...
    @OriginalMember(owner = "client!kea", name = "f", descriptor = "(B)Lpca;")
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(IILvg;I)V")
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(Z)Lpca;")
