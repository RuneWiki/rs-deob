...
public class class213 extends class431 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Lya;Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(I)V", line = 124)
    public static void method1477(int arg0) {
        field3480 = null;
        int var1 = -36 % ((arg0 - 45) / 41);
    }

    @OriginalMember(owner = "client!db", name = "a", descriptor = "(II[Ljava/lang/Object;I[J)V", line = 135)
    ...
    @OriginalMember(owner = "client!db", name = "g", descriptor = "(I)V", line = 205)
    ...
    @OriginalMember(owner = "client!db", name = "h", descriptor = "(I)V", line = 217)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(I[ILbk;[B)Z", line = 227)
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "()V", line = 282)
    public class213() {
    }

    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "([B)V", line = 284)
