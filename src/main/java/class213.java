...
public class class213 {
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(ZI)Ljg;", line = 3)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(JI)V", line = 46)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "([II)Ljava/lang/String;", line = 76)
