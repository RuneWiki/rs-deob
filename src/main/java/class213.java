...
public class class213 extends class241 implements class248 {
    ...
    @OriginalMember(owner = "client!hs", name = "c", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ILqa;)V", line = 22)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ILqa;I)Lc;", line = 50)
    ...
    @OriginalMember(owner = "client!hs", name = "e", descriptor = "(B)V", line = 74)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Lqa;II)Lc;", line = 88)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ILqa;II)Z", line = 99)
    ...
    @OriginalMember(owner = "client!hs", name = "e", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(Z)Z", line = 155)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(BLqa;)V", line = 166)
    public final void method25(byte arg0, class162 arg1) {
        ++field3072;
        int var3 = 24 % ((arg0 - -45) / 48);
    }

    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(B)I", line = 175)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Lqa;I)V", line = 186)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(I)I", line = 215)
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(Lqa;Lgm;IIIIZIIZ)V", line = 227)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ZLqa;)Lae;", line = 260)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(B)I", line = 287)
    public final int method19(byte arg0) {
        ++field3054;
        return arg0 != -69 ? -17 : this.field3055;
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(I)Z", line = 301)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIZ)V", line = 312)
    ...
    @OriginalMember(owner = "client!hs", name = "c", descriptor = "(I)V", line = 331)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(BZILqa;)Lmr;", line = 368)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ILqa;ZLto;III)V", line = 401)
    ...
    @OriginalMember(owner = "client!hs", name = "d", descriptor = "(Z)V", line = 432)
