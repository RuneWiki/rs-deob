...
public abstract class class213 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ZI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(B)V", line = 15)
    public void method871(byte arg0) {
        field2772++;
        int var2 = 19 / ((arg0 - 38) / 46);
    }

    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Z)V", line = 37)
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(II)Z", line = 61)
    ...
    @OriginalMember(owner = "client!qr", name = "c", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!qr", name = "c", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(Lsv;)V", line = 100)
