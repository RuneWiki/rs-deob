...
public class class213 {
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(Z)Leh;")
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(I[Leh;)I")
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(I)Llga;")
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(JI)Leh;")
    ...
    @OriginalMember(owner = "client!eq", name = "d", descriptor = "(I)Leh;")
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(BJLeh;)V")
    ...
    @OriginalMember(owner = "client!eq", name = "e", descriptor = "(I)Leh;")
