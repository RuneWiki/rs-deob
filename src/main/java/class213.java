...
public class class213 implements class196 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Ljava/awt/Canvas;I)Lll;", line = 21)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(I)Loh;", line = 48)
    public final class370 method640(int arg0) {
        field2987++;
        return arg0 == 58 ? client.field3715 : null;
    }

    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(I)V", line = 58)
    public class213(int arg0) {
        this.field2985 = arg0;
    }

    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IIZ)Z", line = 67)
