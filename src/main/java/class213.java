...
public class class213 extends class69 {
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(ZI)V", line = 34)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IIII)V", line = 48)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(I[IB)V", line = 65)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(B)Llp;", line = 199)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IIIIF)V", line = 212)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IB)V", line = 322)
    ...
    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(B)V", line = 350)
    ...
    @OriginalMember(owner = "client!lw", name = "<init>", descriptor = "(Lbda;IIIII)V", line = 360)
