...
public class class213 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(ZLep;)V")
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Lep;B)Z")
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(IIIIZ)Lbq;")
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "(Lte;)V")
