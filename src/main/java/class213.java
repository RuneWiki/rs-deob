...
public class class213 extends class12 {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 20)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 31)
    ...
    @OriginalMember(owner = "client!oj", name = "c", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(II)Lqr;", line = 106)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Lbk;I)V", line = 133)
