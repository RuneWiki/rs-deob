...
public class class213 extends class264 {
    ...
    @OriginalMember(owner = "client!fe", name = "<init>", descriptor = "()V", line = 5)
    public class213() {
        super(1, false);
    }

    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(II)[I", line = 9)
    ...
    @OriginalMember(owner = "client!fe", name = "b", descriptor = "(BI)[[I", line = 50)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(BLkk;I)V", line = 118)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Z)V", line = 167)
