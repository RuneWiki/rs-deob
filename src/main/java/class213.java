...
public class class213 extends class333 implements class142 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(B)J", line = 16)
    ...
    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "(Lih;I[BI)V", line = 29)
    public class213(class503 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field3079 = arg1;
    }

    @OriginalMember(owner = "client!en", name = "a", descriptor = "(ILhm;II)V", line = 37)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(I[B)Ljava/lang/String;", line = 109)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(Z)I", line = 187)
    ...
    @OriginalMember(owner = "client!en", name = "b", descriptor = "(B)V", line = 200)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IB[BI)V", line = 220)
