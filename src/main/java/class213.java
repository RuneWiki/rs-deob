...
public class class213 extends class42 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Lqa;II)Lka;", line = 27)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Z)V", line = 113)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(BII)Lbr;", line = 136)
