...
public class class213 extends class548 {
    ...
    @OriginalMember(owner = "client!oe", name = "b", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ZI)V", line = 32)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(III)V", line = 43)
    ...
    @OriginalMember(owner = "client!oe", name = "c", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(Llf;)V", line = 110)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ZZ)V", line = 154)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(JIZ)Ljava/lang/String;", line = 180)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lru;II)V", line = 195)
