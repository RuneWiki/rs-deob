...
public class class213 extends class458 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!hs", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 5)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(III)Z", line = 20)
    ...
    @OriginalMember(owner = "client!hs", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 31)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Ljava/awt/Graphics;IBI)V", line = 47)
    ...
    @OriginalMember(owner = "client!hs", name = "d", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Ljava/awt/Canvas;I)V", line = 78)
    ...
    @OriginalMember(owner = "client!hs", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 100)
    public final void startProduction(ImageConsumer arg0) {
        this.addConsumer(arg0);
        ++field3078;
    }

    @OriginalMember(owner = "client!hs", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 110)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field3082;
    }

    @OriginalMember(owner = "client!hs", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 118)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field3080;
        return this.field3070 == arg0;
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIILjava/awt/Graphics;II)V", line = 128)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIIII)V", line = 144)
