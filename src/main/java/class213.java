...
public class class213 implements class83 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lrf;B)Z", line = 20)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(B)J", line = 64)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(I)V", line = 100)
