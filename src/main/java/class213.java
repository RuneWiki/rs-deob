...
public class class213 {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(III)Ljava/lang/String;", line = 9)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "([ILkfa;IZIIII)Lbb;", line = 52)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(ILvo;Lvo;)V", line = 142)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(II)Lck;", line = 109)
