...
public abstract class class213 extends class318 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(BLha;ZILuq;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(IIIII)V", line = 13)
    ...
    @OriginalMember(owner = "client!lj", name = "c", descriptor = "(Lha;B)Z", line = 26)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(FIZFFFFF)F", line = 43)
    ...
    @OriginalMember(owner = "client!lj", name = "m", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "([Ltj;B)I", line = 128)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!lj", name = "k", descriptor = "(I)Z", line = 151)
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(B)Z", line = 163)
