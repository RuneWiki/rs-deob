...
public class class213 extends class232 {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "()Z", line = 3)
    public final boolean method358() {
        return true;
    }

    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Lue;)V", line = 7)
    public final void method356(class127 arg0) {
        this.field3348.method1559(arg0);
    }

    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Z)V", line = 13)
    public final void method357(boolean arg0) {
    }

    @OriginalMember(owner = "client!oj", name = "b", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!oj", name = "b", descriptor = "()V", line = 28)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "(Ltb;Lrl;)V", line = 84)
