...
public class class213 extends class513 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(II)V", line = 9)
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(II)V", line = 27)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ZIIFI)V", line = 45)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Ljava/lang/String;BIZI)V", line = 154)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ILjava/lang/String;Lep;I)Lsea;", line = 165)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "([III)V", line = 192)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(I)V", line = 315)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ZI)V", line = 328)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IIIB)V", line = 345)
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(Ldn;IIIII)V", line = 369)
