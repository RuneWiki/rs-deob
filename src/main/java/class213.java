...
public class class213 extends OutputStream {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(II)V", line = 25)
    ...
    @OriginalMember(owner = "client!ac", name = "write", descriptor = "(I)V", line = 38)
