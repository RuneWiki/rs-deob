...
public class class213 extends class449 {
    ...
    @OriginalMember(owner = "client!db", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!db", name = "c", descriptor = "(I)J", line = 15)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Z)J", line = 51)
