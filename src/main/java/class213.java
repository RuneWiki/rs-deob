...
public class class213 {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Z[B)V", line = 4)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(III)Z", line = 24)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IBI[B)V", line = 42)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(JI)V", line = 226)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(I)V", line = 240)
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(III)Z", line = 283)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(B)V", line = 299)
    ...
    @OriginalMember(owner = "client!se", name = "<init>", descriptor = "(Lob;II)V", line = 532)
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(I)Ljava/io/File;", line = 391)
    private final File method1222(int arg0) {
        field2585++;
        return arg0 == -1 ? this.field2604.method3592(true) : null;
    }

    @OriginalMember(owner = "client!se", name = "a", descriptor = "([BIBI)V", line = 408)
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(B)J", line = 553)
