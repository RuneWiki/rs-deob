...
public class class213 extends class322 {
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(B)Z")
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Lch;)V")
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(ILch;)V")
    public class213(int arg0, class463 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(BILmq;I)V")
