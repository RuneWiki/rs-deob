...
public class class213 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IIILia;)V", line = 3)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IIZ[[ZIB)V", line = 72)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(I)V", line = 260)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(Z)V", line = 290)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IBILia;)Z", line = 312)
    ...
    @OriginalMember(owner = "client!en", name = "b", descriptor = "(IIILia;)V", line = 387)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IIIII)V", line = 460)
    ...
    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "(Lnq;Le;)V", line = 511)
