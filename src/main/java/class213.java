...
public class class213 extends class283 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Lcu;ZI)V")
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Lac;Ldja;)V")
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Ljava/awt/Component;ZI)Lsga;")
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Lpha;Lpha;B)V")
