...
public class class213 extends class509 {
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "(Ltt;)V")
    public class213(class249 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(BILin;)V")
    ...
    @OriginalMember(owner = "client!fn", name = "d", descriptor = "(I)Ldk;")
