...
public class class213 implements class497 {
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(I)I", line = 23)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Z)Z", line = 36)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;", line = 59)
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(B)Lwha;", line = 81)
    public final class285 method1370(byte arg0) {
        int var2 = -32 % ((arg0 + 21) / 47);
        return this.field2816;
    }

    @OriginalMember(owner = "client!su", name = "a", descriptor = "(II)V", line = 90)
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "(Lul;Lwha;Z)V", line = 124)
