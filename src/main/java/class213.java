...
public class class213 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(B)Lcg;")
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(ILum;)V")
    ...
    @OriginalMember(owner = "client!vu", name = "c", descriptor = "(I)Lcg;")
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "(Lum;)V")
