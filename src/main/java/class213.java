...
public class class213 extends class208 {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Luaa;Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(II)V", line = 48)
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(Z)V", line = 76)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(ZLuaa;)V", line = 103)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Z)V", line = 130)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IB)V", line = 169)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IZ)V", line = 202)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Ld;IBZ)V", line = 250)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Lln;B)V", line = 282)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Luaa;B)V", line = 459)
