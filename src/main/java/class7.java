...
public class class7 extends class384 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(ZB)V", line = 25)
    ...
    @OriginalMember(owner = "client!il", name = "c", descriptor = "(I)Z", line = 103)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Lln;)V", line = 117)
    public class7(class377 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Lke;BI)V", line = 121)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(II)V", line = 133)
    ...
    @OriginalMember(owner = "client!il", name = "e", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ZB)V", line = 175)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(B)V", line = 191)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IIZ)V", line = 202)
