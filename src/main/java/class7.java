...
public class class7 extends class390 {
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ff", name = "c", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!ff", name = "d", descriptor = "(I)Z", line = 32)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IIIIIIIIII)V", line = 46)
