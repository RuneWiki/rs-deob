...
@OriginalClass("client!BDNJGDVN")
public class class7 {

    @OriginalMember(owner = "client!BDNJGDVN", name = "a", descriptor = "Z")
    private boolean field143 = true;

    @OriginalMember(owner = "client!BDNJGDVN", name = "f", descriptor = "I")
    public int field148 = 65000;

    @OriginalMember(owner = "client!BDNJGDVN", name = "e", descriptor = "I")
    public int field147;

    @OriginalMember(owner = "client!BDNJGDVN", name = "c", descriptor = "Ljava/io/RandomAccessFile;")
    public RandomAccessFile field145;

    @OriginalMember(owner = "client!BDNJGDVN", name = "d", descriptor = "Ljava/io/RandomAccessFile;")
    public RandomAccessFile field146;

    @OriginalMember(owner = "client!BDNJGDVN", name = "b", descriptor = "[B")
    public static byte[] field144 = new byte[520];

    @OriginalMember(owner = "client!BDNJGDVN", name = "<init>", descriptor = "(Ljava/io/RandomAccessFile;BLjava/io/RandomAccessFile;II)V")
    ...
    @OriginalMember(owner = "client!BDNJGDVN", name = "a", descriptor = "(IB)[B")
    ...
    @OriginalMember(owner = "client!BDNJGDVN", name = "a", descriptor = "(I[BBI)Z")
    ...
    @OriginalMember(owner = "client!BDNJGDVN", name = "a", descriptor = "(ZI[BZI)Z")
    ...
    @OriginalMember(owner = "client!BDNJGDVN", name = "a", descriptor = "(IILjava/io/RandomAccessFile;)V")
