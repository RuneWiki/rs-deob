...
public class class7 {
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(IIIIIIZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(BII)Z", line = 57)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(II)Lls;", line = 84)
    ...
    @OriginalMember(owner = "client!sda", name = "b", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!sda", name = "c", descriptor = "(I)V", line = 171)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(BI)Ljava/lang/String;", line = 184)
    ...
    @OriginalMember(owner = "client!sda", name = "d", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!sda", name = "<init>", descriptor = "(Len;Lfa;)V", line = 244)
