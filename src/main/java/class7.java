...
public class class7 extends class362 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ILvq;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Ljba;I)V")
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(ILqc;IZ)V")
