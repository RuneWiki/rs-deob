...
public class class7 {
    ...
    @OriginalMember(owner = "client!CANZHIOT", name = "d", descriptor = "LAQXKJVRI;")
    ...
    @OriginalMember(owner = "client!CANZHIOT", name = "b", descriptor = "[LCANZHIOT;")
    ...
    @OriginalMember(owner = "client!CANZHIOT", name = "a", descriptor = "(II)LCANZHIOT;")
