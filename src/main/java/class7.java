...
@OriginalClass("client!CGCAZMIE")
public class class7 {

    @OriginalMember(owner = "client!CGCAZMIE", name = "a", descriptor = "Z")
    private boolean field68 = true;

    @OriginalMember(owner = "client!CGCAZMIE", name = "b", descriptor = "B")
    private byte field69 = -100;

    @OriginalMember(owner = "client!CGCAZMIE", name = "c", descriptor = "Z")
    private boolean field70 = true;

    @OriginalMember(owner = "client!CGCAZMIE", name = "d", descriptor = "I")
    private int field71 = -443;

    @OriginalMember(owner = "client!CGCAZMIE", name = "e", descriptor = "[I")
    public int[] field72 = new int[2];

    @OriginalMember(owner = "client!CGCAZMIE", name = "f", descriptor = "[[[I")
    public int[][][] field73 = new int[2][2][4];

    @OriginalMember(owner = "client!CGCAZMIE", name = "g", descriptor = "[[[I")
    public int[][][] field74 = new int[2][2][4];

    @OriginalMember(owner = "client!CGCAZMIE", name = "h", descriptor = "[I")
    public int[] field75 = new int[2];

    @OriginalMember(owner = "client!CGCAZMIE", name = "i", descriptor = "[[F")
    public static float[][] field76 = new float[2][8];

    @OriginalMember(owner = "client!CGCAZMIE", name = "j", descriptor = "[[I")
    public static int[][] field77 = new int[2][8];

    @OriginalMember(owner = "client!CGCAZMIE", name = "k", descriptor = "F")
    public static float field78;

    @OriginalMember(owner = "client!CGCAZMIE", name = "l", descriptor = "I")
    public static int field79;

    @OriginalMember(owner = "client!CGCAZMIE", name = "a", descriptor = "(IIFI)F")
    ...
    @OriginalMember(owner = "client!CGCAZMIE", name = "a", descriptor = "(ZF)F")
    ...
    @OriginalMember(owner = "client!CGCAZMIE", name = "a", descriptor = "(IFIB)F")
    ...
    @OriginalMember(owner = "client!CGCAZMIE", name = "a", descriptor = "(FII)I")
    ...
    @OriginalMember(owner = "client!CGCAZMIE", name = "a", descriptor = "(ZLXQPFGONL;LQOBPOZUC;)V")
    ...
    @OriginalMember(owner = "client!CGCAZMIE", name = "<init>", descriptor = "()V")
    public class7() {
        if (class15.field717) {
        }
    }
