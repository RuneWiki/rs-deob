...
public class class7 extends class263 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(ZLya;)V", line = 3)
    ...
    @OriginalMember(owner = "client!tu", name = "d", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(BLjava/awt/Component;Z)Lde;", line = 82)
    ...
    @OriginalMember(owner = "client!tu", name = "c", descriptor = "(III)V", line = 94)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(IZLgk;)V", line = 171)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(IB)[I", line = 184)
    ...
    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(IB)[[I", line = 218)
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "()V", line = 266)
    public class7() {
        super(1, false);
    }
}
