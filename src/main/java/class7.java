...
public class class7 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(III)Lkg;")
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Lqa;ILoa;IZIZ)V")
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Lti;)V")
