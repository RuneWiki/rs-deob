...
public abstract class class7 implements class75 {
    ...
    @OriginalMember(owner = "client!il", name = "d", descriptor = "(B)Ljp;")
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Lgfa;ZI[I)Lvd;")
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Ldia;IIIZ)V")
