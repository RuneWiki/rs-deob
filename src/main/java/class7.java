...
public class class7 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IZ)Lfr;")
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ILld;)V")
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Lwk;B)Z")
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(Ldk;ILfc;Lfc;)V")
