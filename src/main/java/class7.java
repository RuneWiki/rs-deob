...
public class class7 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IIIB)I", line = 19)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(II)V", line = 50)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(I)V", line = 67)
