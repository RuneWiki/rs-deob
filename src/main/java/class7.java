...
public class class7 extends class345 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ZB)V", line = 5)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IIIII)V", line = 36)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IILcj;)V", line = 96)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ZII)V", line = 117)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(I)Z", line = 157)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Lbi;Llha;)V", line = 168)
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(ZI)I", line = 187)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ZI)V", line = 227)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(B)V", line = 243)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Ljava/lang/String;ZILjava/lang/String;I)V", line = 272)
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(B)V", line = 327)
