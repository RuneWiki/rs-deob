...
public class class7 extends class71 {
    ...
    @OriginalMember(owner = "client!af", name = "n", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!af", name = "s", descriptor = "Lrc;")
    ...
    @OriginalMember(owner = "client!af", name = "q", descriptor = "Llf;")
    public class109 field101;

    @OriginalMember(owner = "client!af", name = "w", descriptor = "Lpa;")
    public static class140 field107;

    @OriginalMember(owner = "client!af", name = "u", descriptor = "Lbg;")
    public static class18 field105;

    @OriginalMember(owner = "client!af", name = "v", descriptor = "Lvg;")
    public static class200 field106;

    @OriginalMember(owner = "client!af", name = "a", descriptor = "(BI)Llf;")
    ...
    @OriginalMember(owner = "client!af", name = "c", descriptor = "(BI)Lhh;")
