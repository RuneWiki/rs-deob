...
public class class7 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IZIIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(ZILha;B)Lfd;", line = 20)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(ILdc;)V", line = 63)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(ILdc;I)V", line = 84)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IIIIIIIII)V", line = 112)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(B)Z", line = 136)
