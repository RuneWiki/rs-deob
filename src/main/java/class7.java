...
public class class7 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Ldh;)V", line = 23)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(III)I", line = 86)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(II)[I", line = 126)
