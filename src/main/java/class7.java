...
public class class7 extends class161 {
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(Z)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ff", name = "d", descriptor = "(I)I", line = 26)
    ...
    @OriginalMember(owner = "client!ff", name = "e", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(B)V", line = 53)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(BI)V", line = 80)
