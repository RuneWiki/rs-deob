...
public class class7 extends class531 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(CB)Z", line = 17)
    ...
    @OriginalMember(owner = "client!db", name = "c", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(ZILwu;)Lcw;", line = 87)
