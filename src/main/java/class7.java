...
public class class7 {
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Lqj;Lqj;Lqj;Lqj;B)V")
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Lil;IZ)V")
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(BLil;)V")
