...
public class class7 extends class651 implements class166 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(B)I", line = 8)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Lwq;B)V", line = 19)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Log;II[III)V", line = 33)
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(IF)F", line = 47)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Log;Lofa;Lkn;II)V", line = 63)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "([IZIIIII)V", line = 75)
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(I)I", line = 95)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Log;Lofa;II[BII)V", line = 105)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IF)F", line = 120)
    ...
    @OriginalMember(owner = "client!il", name = "c", descriptor = "(I)Z", line = 131)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IIIIIZI[I)V", line = 142)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ZBZ)V", line = 166)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IIIILofa;[BIZI)V", line = 180)
    ...
    @OriginalMember(owner = "client!il", name = "c", descriptor = "(B)V", line = 208)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Log;Lofa;II[FII)V", line = 218)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IILcb;I)Lkf;", line = 232)
