...
public class class7 extends class365 {
    ...
    @OriginalMember(owner = "client!eb", name = "h", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!eb", name = "d", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!eb", name = "f", descriptor = "(I)Z", line = 67)
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 81)
    public class7(Object arg0, int arg1) {
        super(arg1);
        this.field47 = arg0;
    }

    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ZIIIIIIII)V", line = 90)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(II)Z", line = 132)
    ...
    @OriginalMember(owner = "client!eb", name = "e", descriptor = "(I)Ljava/lang/Object;", line = 145)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(III)Z", line = 166)
