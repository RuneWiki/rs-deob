...
public class class7 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ILgi;)V")
    ...
    @OriginalMember(owner = "client!il", name = "d", descriptor = "(I)Lgi;")
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(B)Lgi;")
