...
public class class7 extends class346 {
    ...
    @OriginalMember(owner = "client!wl", name = "d", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IILps;IIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Lqc;I)I", line = 37)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Lfb;ZI)V", line = 73)
    ...
    @OriginalMember(owner = "client!wl", name = "d", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(ZI)V", line = 127)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IIIIIIII)V", line = 147)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IB)V", line = 179)
    ...
    @OriginalMember(owner = "client!wl", name = "<init>", descriptor = "(I)V", line = 297)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IIIILtj;ILqb;IBII)Lqb;", line = 199)
    ...
    @OriginalMember(owner = "client!wl", name = "<init>", descriptor = "()V", line = 243)
    public class7() {
        this(4096);
    }

    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IC)Z", line = 254)
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(II)[I", line = 275)
