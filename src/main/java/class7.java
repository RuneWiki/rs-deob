...
public class class7 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Z)Llf;", line = 18)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(IB)I", line = 39)
    public static final int method40(int arg0, byte arg1) {
        field63++;
        return arg1 >= -69 ? -103 : arg0 >>> 8;
    }

    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(ILlf;)V", line = 52)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Llf;I)V", line = 71)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Ltu;I)V", line = 88)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Ltu;Llf;I)V", line = 104)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(I)I", line = 127)
    ...
    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(B)Llf;", line = 148)
    ...
    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(I)V", line = 179)
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "()V", line = 242)
    public class7() {
        this.field64.field7454 = this.field64;
        this.field64.field7455 = this.field64;
    }

    @OriginalMember(owner = "client!tu", name = "c", descriptor = "(I)V", line = 206)
    ...
    @OriginalMember(owner = "client!tu", name = "d", descriptor = "(I)Llf;", line = 218)
    ...
    @OriginalMember(owner = "client!tu", name = "c", descriptor = "(B)Llf;", line = 254)
    ...
    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(IB)V", line = 278)
    ...
    @OriginalMember(owner = "client!tu", name = "d", descriptor = "(B)Llf;", line = 292)
