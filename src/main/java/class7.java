...
public class class7 {
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(IIIB)Lkw;", line = 30)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(ZI)V", line = 51)
    ...
    @OriginalMember(owner = "client!kw", name = "<init>", descriptor = "(IIIIB)V", line = 64)
    ...
    @OriginalMember(owner = "client!kw", name = "b", descriptor = "(I)Lgi;", line = 76)
