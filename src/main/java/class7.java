...
public abstract class class7 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IJ)I", line = 7)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(I)Z", line = 24)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IB)V", line = 123)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IIIIIII)J", line = 139)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(B)V", line = 165)
