...
public class class7 extends class376 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(ILwr;)V")
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Lya;IZZF)V")
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(ILbj;)V")
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(ILjm;)I")
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Lwr;I)V")
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(BLwr;)V")
