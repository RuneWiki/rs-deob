...
@OriginalClass("client!DXQCGOAI")
public class class7 extends class6 {

    @OriginalMember(owner = "client!DXQCGOAI", name = "n", descriptor = "Z")
    public boolean field643 = false;

    @OriginalMember(owner = "client!DXQCGOAI", name = "s", descriptor = "Z")
    private boolean field648 = false;

    @OriginalMember(owner = "client!DXQCGOAI", name = "t", descriptor = "I")
    private int field649 = -7552;

    @OriginalMember(owner = "client!DXQCGOAI", name = "w", descriptor = "I")
    private int field652 = 8;

    @OriginalMember(owner = "client!DXQCGOAI", name = "m", descriptor = "LIDBAHLFM;")
    private class22 field642;

    @OriginalMember(owner = "client!DXQCGOAI", name = "o", descriptor = "I")
    public int field644;

    @OriginalMember(owner = "client!DXQCGOAI", name = "p", descriptor = "I")
    public int field645;

    @OriginalMember(owner = "client!DXQCGOAI", name = "q", descriptor = "I")
    public int field646;

    @OriginalMember(owner = "client!DXQCGOAI", name = "r", descriptor = "I")
    public int field647;

    @OriginalMember(owner = "client!DXQCGOAI", name = "l", descriptor = "I")
    public int field641;

    @OriginalMember(owner = "client!DXQCGOAI", name = "u", descriptor = "I")
    private int field650;

    @OriginalMember(owner = "client!DXQCGOAI", name = "v", descriptor = "I")
    private int field651;

    @OriginalMember(owner = "client!DXQCGOAI", name = "<init>", descriptor = "(IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!DXQCGOAI", name = "a", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!DXQCGOAI", name = "a", descriptor = "(B)LGEUHTGZJ;")
