...
public abstract class class7 extends class256 {
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(BLri;)V")
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(IBZIILnf;Lja;)V")
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Ldp;I)V")
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(IIIIIILpe;)V")
    ...
    @OriginalMember(owner = "client!fp", name = "b", descriptor = "(B)Z")
