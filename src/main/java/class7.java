...
public class class7 {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Lgga;B)V", line = 40)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(Z)V", line = 78)
