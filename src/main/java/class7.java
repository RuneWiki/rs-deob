...
public class class7 extends class497 {
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(Z)I", line = 7)
    public final int method30(boolean arg0) {
        return arg0 ? this.field62 : -62;
    }

    @OriginalMember(owner = "client!sda", name = "g", descriptor = "(I)I", line = 18)
    public final int method31(int arg0) {
        return arg0 < 1 ? -126 : this.field60;
    }

    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(B)I", line = 29)
    public final int method32(byte arg0) {
        int var2 = 3 % ((arg0 + 70) / 43);
        return this.field61;
    }

    @OriginalMember(owner = "client!sda", name = "b", descriptor = "(I)J", line = 37)
    ...
    @OriginalMember(owner = "client!sda", name = "c", descriptor = "(I)I", line = 47)
