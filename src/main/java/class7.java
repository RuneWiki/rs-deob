...
public class class7 extends class262 implements class448 {
    ...
    @OriginalMember(owner = "client!il", name = "c", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ILza;BI)Z")
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IBLza;)Le;")
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IIIZILot;Lza;)V")
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Lza;Ler;IIIIIZIII)V")
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(BLza;)Luc;")
