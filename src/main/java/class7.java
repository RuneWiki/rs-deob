...
public class class7 implements IEnumModesCallback {
    ...
    @OriginalMember(owner = "client!il", name = "callbackEnumModes", descriptor = "(Lcom/ms/directX/DDSurfaceDesc;Lcom/ms/com/IUnknown;)V", line = 4)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ILjava/awt/Frame;)V", line = 20)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(BLjava/awt/Frame;IIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(I)[I", line = 60)
