...
public class class7 {
    ...
    // $FF: synthetic field
    @OriginalMember(owner = "client!il", name = "j", descriptor = "Ljava/lang/Class;")
    public static Class field62;

    @OriginalMember(owner = "client!il", name = "g", descriptor = "[Lha;")
    public static class52[] field59;
    ...
    public static final void method40(int arg0, int arg1) {
        field58++;
        class557 var2 = class93.method564(arg0, -14073, arg1);
        var2.method3264(-1037624096);
    }

    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Lsp;I)V")
    public static final void method41(class541 arg0, int arg1) {
        field61++;
        ...
        class269 var2 = null;
        if (arg0.field7912 == 0) {
            var2 = (class269) class19.method124(arg0.field7914, arg0.field7913, arg0.field7901);
        }
        if (arg0.field7912 == 1) {
            var2 = (class269) class31.method181(arg0.field7914, arg0.field7913, arg0.field7901);
        }
        int var3 = 63 % ((7 - arg1) / 62);
        if (arg0.field7912 == 2) {
            var2 = (class269) class198.method1072(arg0.field7914, arg0.field7913, arg0.field7901, field62 == null ? (field62 = method42("fp")) : field62);
        }
        if (arg0.field7912 == 3) {
            var2 = (class269) class543.method3171(arg0.field7914, arg0.field7913, arg0.field7901);
        }
        if (var2 == null) {
            arg0.field7903 = 0;
            arg0.field7906 = 0;
            ...
            arg0.field7911 = var2.method342(-2329);
            arg0.field7906 = var2.method337(true);
            arg0.field7903 = var2.method333((byte) 70);
        }
    }
    ...
    public class7(String arg0, int arg1) {
        this.field57 = arg1;
    }
    ...
    static {
        new class180("You can't reach that.", "Da kommst du nicht hin.", "Vous ne pouvez pas l'atteindre.", "Você não consegue alcançar isso.");
        field60 = new int[2];
    }
}
