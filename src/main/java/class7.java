...
@OriginalClass("client!CRBPLXHF")
public class class7 extends class23 {

    @OriginalMember(owner = "client!CRBPLXHF", name = "qb", descriptor = "I")
    private int field529 = -44;

    @OriginalMember(owner = "client!CRBPLXHF", name = "rb", descriptor = "Z")
    private boolean field530 = false;

    @OriginalMember(owner = "client!CRBPLXHF", name = "sb", descriptor = "LDOBKXCMM;")
    public class14 field531;

    @OriginalMember(owner = "client!CRBPLXHF", name = "a", descriptor = "(B)LDHUPIIUL;")
    ...
    @OriginalMember(owner = "client!CRBPLXHF", name = "a", descriptor = "(I)LDHUPIIUL;")
    ...
    @OriginalMember(owner = "client!CRBPLXHF", name = "b", descriptor = "(B)Z")
