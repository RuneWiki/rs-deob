...
public class class7 extends class188 {
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Lht;IIZ[[BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Lht;II)V", line = 26)
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(II)I", line = 44)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Lht;IIZ[[I)V", line = 112)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(III)V", line = 86)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IBIII)V", line = 99)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Lbt;Z)Z", line = 144)
    ...
    @OriginalMember(owner = "client!il", name = "g", descriptor = "(I)V", line = 246)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(I)V", line = 260)
