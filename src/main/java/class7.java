...
public class class7 {
    ...
    @OriginalMember(owner = "client!BLFCIBLQ", name = "f", descriptor = "[LBLFCIBLQ;")
    public static class7[] field79;

    @OriginalMember(owner = "client!BLFCIBLQ", name = "a", descriptor = "(ZLMJLXHQTQ;)V")
    ...
    @OriginalMember(owner = "client!BLFCIBLQ", name = "a", descriptor = "(ZLXGRGMPUQ;)V")
    ...
    @OriginalMember(owner = "client!BLFCIBLQ", name = "a", descriptor = "(B)LVYUQHOMO;")
    ...
    @OriginalMember(owner = "client!BLFCIBLQ", name = "b", descriptor = "(B)LVYUQHOMO;")
