...
public abstract class class7 implements class563 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ILte;)V")
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Lpw;I)V")
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Lag;ILaq;Lui;IZ)V")
