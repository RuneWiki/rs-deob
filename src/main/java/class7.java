...
public class class7 extends class694 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Loa;BLe;)V", line = 4)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ILjr;B)V", line = 226)
    ...
    @OriginalMember(owner = "client!il", name = "i", descriptor = "(I)V", line = 307)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Loa;B)V", line = 319)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "()V", line = 424)
    public class7() {
        super(0, true);
    }

    @OriginalMember(owner = "client!il", name = "a", descriptor = "(II)[I", line = 431)
    ...
    @OriginalMember(owner = "client!il", name = "g", descriptor = "(I)V", line = 655)
    ...
    @OriginalMember(owner = "client!il", name = "j", descriptor = "(I)V", line = 682)
