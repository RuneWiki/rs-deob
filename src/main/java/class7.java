...
public class class7 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Lya;Lkn;IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Lga;III)I", line = 11)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Lya;II)V", line = 68)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "()V", line = 247)
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "()V", line = 270)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Lul;Lcq;Lr;Lip;Lfm;Lrt;Lov;)V", line = 426)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(I)V", line = 456)
    public static final void method42(int arg0) {
        field80 = (class48) field78.method2585((byte) 114, (long) arg0);
    }

    @OriginalMember(owner = "client!il", name = "a", descriptor = "(II)Lsu;", line = 465)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Lya;IIII)Loe;", line = 482)
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(II)Lqr;", line = 494)
    ...
    @OriginalMember(owner = "client!il", name = "c", descriptor = "()V", line = 506)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Lya;)V", line = 520)
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(Lya;IIII)V", line = 532)
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(Lya;)Loe;", line = 877)
    ...
    @OriginalMember(owner = "client!il", name = "d", descriptor = "()V", line = 887)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "([B[B[SII)V", line = 914)
    ...
    @OriginalMember(owner = "client!il", name = "e", descriptor = "()V", line = 1057)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Lya;Lhp;IIII[I[I)V", line = 1070)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Lya;IIII[S[B)V", line = 1204)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Lya;IIIIIII[S[BZ)V", line = 1262)
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(I)Lqr;", line = 1434)
    public static final class48 method56(int arg0) {
        return (class48) field78.method2585((byte) 114, (long) arg0);
    }

    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Lga;II)V", line = 1444)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IIIIIIII)V", line = 1455)
