...
@OriginalClass("client!CNLPNPVK")
public class class7 extends class54 {

    @OriginalMember(owner = "client!CNLPNPVK", name = "o", descriptor = "I")
    private int field586 = 3;

    @OriginalMember(owner = "client!CNLPNPVK", name = "z", descriptor = "Z")
    public boolean field597 = false;

    @OriginalMember(owner = "client!CNLPNPVK", name = "t", descriptor = "LZSSCYSIO;")
    private class71 field591;

    @OriginalMember(owner = "client!CNLPNPVK", name = "l", descriptor = "I")
    public int field583;

    @OriginalMember(owner = "client!CNLPNPVK", name = "p", descriptor = "I")
    public int field587;

    @OriginalMember(owner = "client!CNLPNPVK", name = "q", descriptor = "I")
    public int field588;

    @OriginalMember(owner = "client!CNLPNPVK", name = "r", descriptor = "I")
    public int field589;

    @OriginalMember(owner = "client!CNLPNPVK", name = "F", descriptor = "I")
    public int field603;

    @OriginalMember(owner = "client!CNLPNPVK", name = "G", descriptor = "I")
    public int field604;

    @OriginalMember(owner = "client!CNLPNPVK", name = "H", descriptor = "I")
    public int field605;

    @OriginalMember(owner = "client!CNLPNPVK", name = "I", descriptor = "I")
    public int field606;

    @OriginalMember(owner = "client!CNLPNPVK", name = "J", descriptor = "I")
    public int field607;

    @OriginalMember(owner = "client!CNLPNPVK", name = "s", descriptor = "I")
    public int field590;

    @OriginalMember(owner = "client!CNLPNPVK", name = "u", descriptor = "D")
    public double field592;

    @OriginalMember(owner = "client!CNLPNPVK", name = "v", descriptor = "D")
    public double field593;

    @OriginalMember(owner = "client!CNLPNPVK", name = "w", descriptor = "D")
    public double field594;

    @OriginalMember(owner = "client!CNLPNPVK", name = "A", descriptor = "D")
    private double field598;

    @OriginalMember(owner = "client!CNLPNPVK", name = "B", descriptor = "D")
    private double field599;

    @OriginalMember(owner = "client!CNLPNPVK", name = "C", descriptor = "D")
    private double field600;

    @OriginalMember(owner = "client!CNLPNPVK", name = "D", descriptor = "D")
    private double field601;

    @OriginalMember(owner = "client!CNLPNPVK", name = "E", descriptor = "D")
    private double field602;

    @OriginalMember(owner = "client!CNLPNPVK", name = "m", descriptor = "I")
    private int field584;

    @OriginalMember(owner = "client!CNLPNPVK", name = "n", descriptor = "I")
    private int field585;

    @OriginalMember(owner = "client!CNLPNPVK", name = "x", descriptor = "I")
    public int field595;

    @OriginalMember(owner = "client!CNLPNPVK", name = "y", descriptor = "I")
    public int field596;

    @OriginalMember(owner = "client!CNLPNPVK", name = "<init>", descriptor = "(IIIIIIIIIIIB)V")
    ...
    @OriginalMember(owner = "client!CNLPNPVK", name = "a", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!CNLPNPVK", name = "a", descriptor = "(B)LCCYECDYX;")
    ...
    @OriginalMember(owner = "client!CNLPNPVK", name = "a", descriptor = "(IIIIB)V")
