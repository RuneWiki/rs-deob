...
public class class7 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Z)Lcca;")
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IB)Llr;")
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Lei;IZLri;Lri;)V")
