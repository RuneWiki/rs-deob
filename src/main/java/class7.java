...
public class class7 extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!BTXFPMEV", name = "q", descriptor = "[LDLNMSHLT;")
    ...
    @OriginalMember(owner = "client!BTXFPMEV", name = "r", descriptor = "LMOPGUTIE;")
    public class42 field98;

    @OriginalMember(owner = "client!BTXFPMEV", name = "p", descriptor = "LCMFQLMCT;")
