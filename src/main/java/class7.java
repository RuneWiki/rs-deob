...
@OriginalClass("client!CVNWKEAW")
public class class7 {

    @OriginalMember(owner = "client!CVNWKEAW", name = "a", descriptor = "Z")
    private boolean field552 = false;

    @OriginalMember(owner = "client!CVNWKEAW", name = "b", descriptor = "I")
    private int field553 = 1;

    @OriginalMember(owner = "client!CVNWKEAW", name = "c", descriptor = "Z")
    private boolean field554 = false;

    @OriginalMember(owner = "client!CVNWKEAW", name = "d", descriptor = "Z")
    private boolean field555 = true;

    @OriginalMember(owner = "client!CVNWKEAW", name = "f", descriptor = "I")
    public int field557;

    @OriginalMember(owner = "client!CVNWKEAW", name = "k", descriptor = "Z")
    private boolean field562;

    @OriginalMember(owner = "client!CVNWKEAW", name = "e", descriptor = "[B")
    public byte[] field556;

    @OriginalMember(owner = "client!CVNWKEAW", name = "g", descriptor = "[I")
    public int[] field558;

    @OriginalMember(owner = "client!CVNWKEAW", name = "h", descriptor = "[I")
    public int[] field559;

    @OriginalMember(owner = "client!CVNWKEAW", name = "i", descriptor = "[I")
    public int[] field560;

    @OriginalMember(owner = "client!CVNWKEAW", name = "j", descriptor = "[I")
    public int[] field561;

    @OriginalMember(owner = "client!CVNWKEAW", name = "<init>", descriptor = "(I[B)V")
    ...
    @OriginalMember(owner = "client!CVNWKEAW", name = "a", descriptor = "(I[B)V")
    ...
    @OriginalMember(owner = "client!CVNWKEAW", name = "a", descriptor = "(Ljava/lang/String;[B)[B")
