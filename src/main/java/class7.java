...
public class class7 {
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(II)Lrca;")
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(Lmv;J[IB)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!kw", name = "<init>", descriptor = "(ILpe;Lpe;Lso;)V")
