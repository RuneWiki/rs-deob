...
public class class7 implements class152 {
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IIFZII)[I", line = 17)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IZIIFI)[F", line = 34)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ZI)Lm;", line = 48)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(I)I", line = 88)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IB)Lsw;", line = 99)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ZBIIFI)[I", line = 111)
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(Lwu;Lwu;Lwu;)V", line = 125)
