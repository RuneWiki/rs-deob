...
public class class7 implements Runnable {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!il", name = "run", descriptor = "()V", line = 19)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(III)Z", line = 56)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ILdc;)V", line = 71)
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(III)Lse;", line = 147)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ILec;)V", line = 166)
