...
public class class7 extends class87 {
    ...
    @OriginalMember(owner = "client!il", name = "c", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "()V", line = 25)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(BLza;Ll;)V", line = 278)
