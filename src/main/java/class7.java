...
public class class7 extends class193 implements class454 {
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(Lwi;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ff", name = "c", descriptor = "(Lwi;)V", line = 8)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "()I", line = 11)
    public final int method34() {
        return 0;
    }

    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(I[BI)V", line = 14)
    public final void method35(int arg0, byte[] arg1, int arg2) {
        this.method1386(arg1, arg2);
        this.field96 = arg0;
    }

    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "(Lig;I[BI)V", line = 18)
    public class7(class132 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field96 = arg1;
    }

    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lwi;)V", line = 23)
    ...
    @OriginalMember(owner = "client!ff", name = "d", descriptor = "(Lwi;)V", line = 26)
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "(Lig;ILjava/nio/ByteBuffer;)V", line = 29)
