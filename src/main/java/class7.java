...
public class class7 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(JZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Z)Ljava/io/File;", line = 15)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IZI[B)V", line = 28)
    ...
    @OriginalMember(owner = "client!ib", name = "finalize", descriptor = "()V", line = 47)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(III[B)I", line = 75)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(I)J", line = 92)
