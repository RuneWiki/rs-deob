...
public class class7 extends class376 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IIIIIIII)V", line = 34)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(III[B)I", line = 62)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(III)Z", line = 90)
    ...
    @OriginalMember(owner = "client!il", name = "b", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IZI)Z", line = 130)
