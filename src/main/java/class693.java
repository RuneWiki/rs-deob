...
public class class693 extends class338 {
    ...
    @OriginalMember(owner = "client!rj", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!rj", name = "c", descriptor = "(II)[[[B", line = 22)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(BLgk;)V", line = 804)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IZ)I", line = 858)
