...
public class class693 extends class335 {
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(IIIIIII)I", line = 4)
    ...
    @OriginalMember(owner = "client!uca", name = "<init>", descriptor = "()V", line = 666)
    public class693() {
        super(0, true);
    }

    @OriginalMember(owner = "client!uca", name = "c", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(ILio;)V", line = 94)
    ...
    @OriginalMember(owner = "client!uca", name = "d", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(ILio;I)V", line = 188)
    ...
    @OriginalMember(owner = "client!uca", name = "e", descriptor = "(I)J", line = 280)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(B)V", line = 293)
    ...
    @OriginalMember(owner = "client!uca", name = "b", descriptor = "(IIIIIII)V", line = 332)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "([III)V", line = 462)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(ZI)[I", line = 626)
