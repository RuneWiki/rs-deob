...
public class class693 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(BLim;)V", line = 19)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lmc;)V", line = 181)
    public class693(class234 arg0) {
        this.method3702((byte) 80, arg0);
    }

    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(BLmc;)V", line = 52)
