...
public class class693 extends class184 {
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(I[III)V", line = 7)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IIII)Z", line = 32)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(III)Z", line = 50)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(I[IIZ)V", line = 65)
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(III)Z", line = 78)
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(B)V", line = 125)
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "(IIIIIIIII)V", line = 143)
