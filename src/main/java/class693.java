...
public class class693 extends class58 implements class532 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZ)Loia;")
    public final class88 method380(int arg0, int arg1, boolean arg2) {
        return new class541(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "p", descriptor = "()Lnga;")
    public final class513 method439() {
        return this.field9553;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lmf;Lmf;FLmf;)Lmf;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ldm;Z)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[Lwi;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ldm;I)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lnga;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIZ)Loia;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ldga;Z)Loia;")
    ...
    @OriginalMember(owner = "client!oa", name = "r", descriptor = "()Lcf;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lgd;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(II)Lgba;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lqm;[Ldga;Z)Lda;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ldw;Lgba;)Lgd;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II)Ldw;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIF)Lwi;")
    ...
    @OriginalMember(owner = "client!oa", name = "l", descriptor = "()Lnga;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ldm;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lie;IIII)Lka;")
    ...
    @OriginalMember(owner = "client!oa", name = "n", descriptor = "()Lnga;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([IIIIIZ)Loia;")
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(IIIIII)Lmf;")
