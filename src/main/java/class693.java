...
public class class693 extends class417 {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Lso;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Lhs;Z)V", line = 37)
    ...
    @OriginalMember(owner = "client!ua", name = "c", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(II[BILjava/lang/String;I)I", line = 76)
