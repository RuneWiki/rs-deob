...
public class class693 extends class173 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(I)Ljka;", line = 7)
    ...
    @OriginalMember(owner = "client!fn", name = "b", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "(Lpq;IIIIII)V", line = 87)
