...
public class class693 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIIIIIIIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!cj", name = "<init>", descriptor = "([I)V", line = 103)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(II)I", line = 138)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Z)V", line = 167)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(BLdb;)Ljava/lang/String;", line = 180)
    ...
    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(I)V", line = 206)
