...
public class class693 {
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(II)I", line = 8)
    ...
    @OriginalMember(owner = "client!ica", name = "<init>", descriptor = "([I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(I)V", line = 68)
