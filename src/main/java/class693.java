...
public abstract class class693 extends class182 {
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(II[B)[B", line = 6)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(ZBIZI)V", line = 26)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(Z[Lih;II)I", line = 40)
    ...
    @OriginalMember(owner = "client!rda", name = "h", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(Z)I", line = 118)
