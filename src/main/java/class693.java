...
public class class693 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(B)Lia;", line = 20)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(CBLjava/lang/String;)I", line = 41)
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(B)Lia;", line = 68)
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "()V", line = 195)
    public class693() {
        this.field9867.field7404 = this.field9867;
        this.field9867.field7399 = this.field9867;
    }

    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(I)Lia;", line = 92)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Z)Lia;", line = 109)
    ...
    @OriginalMember(owner = "client!kr", name = "c", descriptor = "(B)I", line = 139)
    ...
    @OriginalMember(owner = "client!kr", name = "d", descriptor = "(B)Z", line = 163)
    ...
    @OriginalMember(owner = "client!kr", name = "e", descriptor = "(B)V", line = 173)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Lia;B)V", line = 204)
