...
public class class693 {
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(B)[[I", line = 10)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Lpe;Z)I", line = 32)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "(III)V", line = 269)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(II)[I", line = 139)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 209)
    ...
    @OriginalMember(owner = "client!ws", name = "b", descriptor = "(I)V", line = 280)
