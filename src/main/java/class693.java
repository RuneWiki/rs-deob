...
public class class693 {
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(II)S", line = 4)
    ...
    @OriginalMember(owner = "client!hg", name = "toString", descriptor = "()Ljava/lang/String;", line = 32)
    public final String toString() {
        field9630++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(I)I", line = 44)
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "(II)V", line = 58)
