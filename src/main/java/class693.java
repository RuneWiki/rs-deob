...
public class class693 extends class219 {
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(Lrv;I[I)V")
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(II)Lrh;")
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(Lrv;B)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(IILrv;)V")
    ...
    @OriginalMember(owner = "client!aga", name = "d", descriptor = "(B)Lrq;")
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(Lrv;I)V")
