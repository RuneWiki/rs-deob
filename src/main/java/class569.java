...
public class class569 extends class627 {
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(B)Lhw;")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(BLhw;FLhw;)Z")
    ...
    @OriginalMember(owner = "client!cv", name = "<init>", descriptor = "(Lac;I)V")
