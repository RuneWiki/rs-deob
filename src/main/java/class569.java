...
public class class569 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Les;B)V")
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Les;)V")
    public class569(class403 arg0) {
        this.method3288(arg0, (byte) -21);
    }

    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(ZIII)Lbt;")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lwt;B)V")
