...
public class class569 {
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(I)Ljava/io/File;", line = 3)
    ...
    @OriginalMember(owner = "client!cv", name = "b", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!cv", name = "b", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(BJ)V", line = 149)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(ZI[BI)V", line = 163)
    ...
    @OriginalMember(owner = "client!cv", name = "c", descriptor = "(I)J", line = 292)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(I[BIZ)V", line = 318)
    ...
    @OriginalMember(owner = "client!cv", name = "<init>", descriptor = "(Lcr;II)V", line = 552)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Z[B)V", line = 506)
    public final void method3142(boolean arg0, byte[] arg1) throws IOException {
        this.method3141(arg1.length, arg1, 0, arg0);
        field7482++;
    }

    @OriginalMember(owner = "client!cv", name = "d", descriptor = "(I)V", line = 518)
