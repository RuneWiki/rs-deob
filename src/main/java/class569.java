...
public class class569 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Lr;III[Z)V")
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(Lr;III[Z)Z")
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ILsn;IBII)Lhb;")
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(II)Ljea;")
    ...
    @OriginalMember(owner = "client!ls", name = "<init>", descriptor = "(Lgp;ILuu;)V")
