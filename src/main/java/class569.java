...
public class class569 extends class604 implements class560 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "([I)V", line = 15)
    public final void method212(int[] arg0) {
        this.method3297(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!j", name = "finalize", descriptor = "()V", line = 21)
    ...
    @OriginalMember(owner = "client!j", name = "w", descriptor = "(Z)V", line = 26)
    public final void method131(boolean arg0) {
        this.method3302(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!j", name = "b", descriptor = "()I", line = 29)
    public final int method220() {
        return this.method3303(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "()I", line = 37)
    public final int method224() {
        return this.method3291(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIIIII)V", line = 40)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(FFFFFFILaa;II)V", line = 44)
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Loa;II)V", line = 46)
    public class569(class723 arg0, int arg1, int arg2) {
        this.method3294(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIII)V", line = 54)
    ...
    @OriginalMember(owner = "client!j", name = "c", descriptor = "(IIII)V", line = 57)
    public final void method213(int arg0, int arg1, int arg2, int arg3) {
        this.method3304(this.nativeid, arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IILaa;II)V", line = 60)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIIII)V", line = 69)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(III)V", line = 83)
