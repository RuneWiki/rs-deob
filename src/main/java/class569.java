...
public class class569 extends class482 implements class437 {
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "(Lpea;ILjaclib/memory/Buffer;IZ)V")
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "(Lpea;I[BIZ)V")
    public class569(class641 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field7874 = arg1;
    }

    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Ldga;I)Ljt;")
