...
public class class569 extends class615 {
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(II)[[I", line = 6)
    ...
    @OriginalMember(owner = "client!raa", name = "d", descriptor = "(B)V", line = 89)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(ZLjava/lang/String;)Ljava/lang/Class;", line = 101)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(BILeh;)V", line = 139)
    ...
    @OriginalMember(owner = "client!raa", name = "<init>", descriptor = "()V", line = 180)
    public class569() {
        super(1, false);
    }

    @OriginalMember(owner = "client!raa", name = "e", descriptor = "(B)V", line = 190)
