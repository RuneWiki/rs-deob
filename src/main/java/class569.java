...
public class class569 {
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(IILvj;)V")
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(ILkp;IB)V")
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(ILvj;)V")
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(BLvj;)V")
