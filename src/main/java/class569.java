...
public abstract class class569 implements class301 {
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Lqp;ILqp;)V")
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Lgaa;I)V")
    ...
    @OriginalMember(owner = "client!te", name = "<init>", descriptor = "(Lhp;ILlca;Lig;IZ)V")
