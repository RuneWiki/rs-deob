...
public class class569 {
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(Lbfa;Lr;Lri;Lwt;BIILrg;ILqk;ILcf;)Lda;", line = 46)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "([III[IIZ)V", line = 243)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(BZ)V", line = 266)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(IILwt;[IIIIZLjr;Lcf;ILwt;ILbfa;ILr;ILqk;Lri;Lrg;[Lgw;)Lda;", line = 278)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(III)V", line = 823)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(B)V", line = 834)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(Lr;IILcf;ILwt;ILrg;IIII)Lda;", line = 845)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(Lqk;IZI)V", line = 1012)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(IILrg;I)V", line = 1034)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(IIZ)Z", line = 1055)
