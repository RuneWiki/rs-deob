...
public class class569 extends class130 {
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(ZLci;Lci;F)Z", line = 3)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(I)Lci;", line = 198)
    ...
    @OriginalMember(owner = "client!bca", name = "c", descriptor = "(B)V", line = 211)
    ...
    @OriginalMember(owner = "client!bca", name = "d", descriptor = "(B)I", line = 227)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(IIIIIILqa;IIZI[[[BI)V", line = 243)
    ...
    @OriginalMember(owner = "client!bca", name = "<init>", descriptor = "(Lte;I)V", line = 279)
