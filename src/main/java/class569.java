...
public abstract class class569 extends class214 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ILfq;BIILha;Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Lha;Z)Z", line = 18)
    ...
    @OriginalMember(owner = "client!md", name = "f", descriptor = "(I)Z", line = 30)
    ...
    @OriginalMember(owner = "client!md", name = "h", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(B[Luaa;)I", line = 53)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(B)Z", line = 65)
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(IIIIIII)V", line = 75)
