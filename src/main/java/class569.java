...
public class class569 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(II)Lmaa;", line = 28)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(IZ)V", line = 60)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(II)V", line = 106)
    ...
    @OriginalMember(owner = "client!md", name = "c", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Z)V", line = 145)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IZ)V", line = 234)
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(Lto;IZLla;Lla;)V", line = 266)
