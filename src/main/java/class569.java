...
public class class569 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IILud;)V")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILud;)V")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "([BIBLeea;)Ltea;")
