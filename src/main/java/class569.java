...
public abstract class class569 implements class33 {
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(ZI)V", line = 23)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(B)I", line = 48)
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Z)Z", line = 106)
    ...
    @OriginalMember(owner = "client!us", name = "<init>", descriptor = "(Ltf;Ltf;Ldd;)V", line = 126)
