...
public class class569 extends Canvas {
    ...
    @OriginalMember(owner = "client!h", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 13)
    public final void paint(Graphics arg0) {
        this.field8367.paint(arg0);
        field8364++;
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(ZB)V", line = 21)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(BI)Z", line = 75)
    ...
    @OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 100)
    public class569(Component arg0) {
        this.field8367 = arg0;
    }

    @OriginalMember(owner = "client!h", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 108)
