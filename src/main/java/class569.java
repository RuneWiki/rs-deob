...
public class class569 extends class567 implements class310 {
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(Loa;B)V")
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(Loa;BI)Lba;")
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(BILoa;I)Z")
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(ZLoa;Lnt;IIII)V")
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(IILoa;)Lba;")
    ...
    @OriginalMember(owner = "client!raa", name = "<init>", descriptor = "(Loa;Lpg;IIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!raa", name = "b", descriptor = "(Loa;B)V")
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(ILoa;)Lww;")
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(ZILoa;I)Lm;")
    ...
    @OriginalMember(owner = "client!raa", name = "b", descriptor = "(Loa;I)Lqt;")
