...
public class class569 {
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(B)Lbm;")
    public final class115 method3265(byte arg0) {
        field8016++;
        return arg0 == -26 ? class556.method3212(0, this.field8010) : null;
    }

    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IIII)Lqi;")
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(ILvea;IIILha;IIBIII)V")
