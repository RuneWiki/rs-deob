...
public class class569 {
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!nba", name = "b", descriptor = "(II)I", line = 72)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "([BI)V", line = 91)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "([BB)[B", line = 121)
    ...
    @OriginalMember(owner = "client!nba", name = "<init>", descriptor = "(II)V", line = 192)
