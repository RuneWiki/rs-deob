...
public class class569 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(II[IIIIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!lk", name = "finalize", descriptor = "()V", line = 116)
    ...
    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "(Luca;II)V", line = 127)
    public class569(class287 arg0, int arg1, int arg2) {
        this.field8285 = arg0;
        this.field8289 = arg2;
    }

    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(ILps;ZI)V", line = 138)
