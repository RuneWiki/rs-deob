...
public class class569 {
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(B)Lmk;", line = 8)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(I)Lhj;", line = 19)
    ...
    @OriginalMember(owner = "client!hj", name = "<init>", descriptor = "(I)V", line = 75)
    public class569(int arg0) {
        this.field8075 = arg0;
    }

    @OriginalMember(owner = "client!hj", name = "<init>", descriptor = "(IIIIII)V", line = 82)
    ...
    @OriginalMember(owner = "client!hj", name = "b", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(ILhj;)V", line = 56)
