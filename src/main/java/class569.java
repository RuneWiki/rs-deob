...
public class class569 extends class599 {
    ...
    @OriginalMember(owner = "client!gm", name = "httpProxyConnect", descriptor = "(Ljava/lang/String;ILjava/lang/String;)Ljava/net/Socket;", line = 14)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(I)Ljava/net/Socket;", line = 89)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Ljava/net/Proxy;I)Ljava/net/Socket;", line = 168)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 191)
