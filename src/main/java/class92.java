...
public class class92 extends class644 implements class324 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ILjw;Lha;BIZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Lha;I)V", line = 15)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(BLha;)Lqs;", line = 25)
    ...
    @OriginalMember(owner = "client!rm", name = "c", descriptor = "(BLha;)Lro;", line = 77)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(I)I", line = 89)
    ...
    @OriginalMember(owner = "client!rm", name = "c", descriptor = "(B)V", line = 100)
    ...
    @OriginalMember(owner = "client!rm", name = "g", descriptor = "(I)I", line = 111)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Lqk;BLha;)V", line = 122)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(BLha;)V", line = 142)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(I)Z", line = 167)
    ...
    @OriginalMember(owner = "client!rm", name = "g", descriptor = "(B)Z", line = 178)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Lha;Z)V", line = 189)
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(Lha;Lrq;IIIIIZII)V", line = 324)
    ...
    @OriginalMember(owner = "client!rm", name = "d", descriptor = "(B)I", line = 204)
    ...
    @OriginalMember(owner = "client!rm", name = "e", descriptor = "(B)Z", line = 217)
    ...
    @OriginalMember(owner = "client!rm", name = "e", descriptor = "(I)V", line = 232)
    ...
    @OriginalMember(owner = "client!rm", name = "i", descriptor = "(B)V", line = 243)
    ...
    @OriginalMember(owner = "client!rm", name = "d", descriptor = "(I)Z", line = 258)
    public final boolean method715(int arg0) {
        ++field1318;
        return arg0 != -12888;
    }

    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(B)I", line = 274)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IIILha;)Z", line = 286)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(B)I", line = 309)
