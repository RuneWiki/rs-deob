...
public class class92 extends class337 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 4)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IIIIB)V", line = 16)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IIIII)V", line = 59)
