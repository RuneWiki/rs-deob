...
public class class92 implements class650 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(BLkf;I)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IILgfa;I)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IIILil;)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IZLgfa;II)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(BLil;I)V")
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(Lkfa;)V")
