...
public abstract class class92 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IB)Ltg;", line = 4)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(BLjava/lang/String;Z)V", line = 86)
    ...
    @OriginalMember(owner = "client!uh", name = "<init>", descriptor = "(II)V", line = 187)
