...
public class class92 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lga;II)Ltq;")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lga;I)Ltq;")
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(Lga;II)[Ltq;")
    public static final class92[] method512(class332 arg0, int arg1, int arg2) {
        byte[] var3 = arg0.method1938(arg2, arg1, -17);
        return var3 == null ? null : method509(var3);
    }

    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(Lga;I)[Ltq;")
