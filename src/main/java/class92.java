...
public class class92 extends class423 {
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(ZIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!iga", name = "e", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!iga", name = "<init>", descriptor = "(Lgga;Lgga;Llca;)V", line = 35)
    public class92(class513 arg0, class513 arg1, class110 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(I)Z", line = 39)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(ZIIB)V", line = 56)
    ...
    @OriginalMember(owner = "client!iga", name = "b", descriptor = "(I)V", line = 69)
