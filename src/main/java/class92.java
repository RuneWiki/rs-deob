...
public class class92 extends class667 {
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(ZII)I", line = 4)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(IIIIIIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(BI)[I", line = 34)
    ...
    @OriginalMember(owner = "client!dba", name = "b", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!dba", name = "<init>", descriptor = "()V", line = 81)
    public class92() {
        super(0, true);
    }
}
