...
public class class92 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(II)Lwp;", line = 6)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Z)V", line = 33)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Lk;I)Z", line = 44)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Lrb;Z)V", line = 62)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(I)Z", line = 98)
