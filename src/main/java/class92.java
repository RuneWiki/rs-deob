...
public class class92 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(I)Lrs;", line = 3)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IZLjava/lang/String;I)Z", line = 31)
    ...
    @OriginalMember(owner = "client!cf", name = "b", descriptor = "(I)Z", line = 105)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Lrs;I)V", line = 116)
    ...
    @OriginalMember(owner = "client!cf", name = "c", descriptor = "(I)Lrs;", line = 137)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Z)I", line = 157)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(B)V", line = 178)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(BLfo;)V", line = 197)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IIZ)I", line = 518)
    ...
    @OriginalMember(owner = "client!cf", name = "b", descriptor = "(B)V", line = 537)
    ...
    @OriginalMember(owner = "client!cf", name = "d", descriptor = "(I)V", line = 547)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Lrs;B)V", line = 569)
    ...
    @OriginalMember(owner = "client!cf", name = "e", descriptor = "(I)Lrs;", line = 589)
    ...
    @OriginalMember(owner = "client!cf", name = "c", descriptor = "(B)Lrs;", line = 614)
    ...
    @OriginalMember(owner = "client!cf", name = "f", descriptor = "(I)Lrs;", line = 631)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(ILcf;)V", line = 652)
    ...
    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "()V", line = 673)
    public class92() {
        this.field1299.field6388 = this.field1299;
        this.field1299.field6385 = this.field1299;
    }

    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Lcf;ILrs;)V", line = 684)
