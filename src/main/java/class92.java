...
public class class92 extends class601 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(II)I", line = 9)
    public static int method583(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ZLoa;JII)V", line = 45)
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(Loa;Lfca;Lkw;J)V", line = 332)
    ...
    @OriginalMember(owner = "client!ra", name = "c", descriptor = "(B)V", line = 218)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(BLoa;J)V", line = 302)
