...
public class class92 {
    ...
    @OriginalMember(owner = "client!sl", name = "b", descriptor = "(II)Lds;")
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(IIIBLkba;)V")
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "(Ldh;ILkha;)V")
