...
public abstract class class92 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "([Lha;IIIII[IILpa;IIBIIILjava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ILjava/util/Random;[Lha;II[ILjava/lang/String;III)I")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "([II[Lha;Ljava/lang/String;[III[I)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lpa;Ljava/lang/String;I[III[Lha;ZI)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(I[IILjava/lang/String;II[II[Lha;IIIIILjava/util/Random;)I")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Ljava/lang/String;ILpa;IIIII[IIIIIII[Lha;I)I")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(II[Lha;BLjava/lang/String;[III)V")
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(Lqa;Llg;)V")
