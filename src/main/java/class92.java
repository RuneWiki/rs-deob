...
public class class92 extends class71 {
    ...
    @OriginalMember(owner = "client!jg", name = "t", descriptor = "Llf;")
    private static class109 field1893 = class35.method275("Ok", 2);

    @OriginalMember(owner = "client!jg", name = "z", descriptor = "Llf;")
    private static class109 field1899 = class35.method275("Prepared visibility map", 2);

    @OriginalMember(owner = "client!jg", name = "u", descriptor = "Llf;")
    public static class109 field1894 = class35.method275("::errortest", 2);

    @OriginalMember(owner = "client!jg", name = "B", descriptor = "Llf;")
    private static class109 field1901 = class35.method275("level)2", 2);

    @OriginalMember(owner = "client!jg", name = "w", descriptor = "Llf;")
    public static class109 field1896 = field1893;

    @OriginalMember(owner = "client!jg", name = "D", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!jg", name = "p", descriptor = "Lvg;")
    public static class200 field1889;

    @OriginalMember(owner = "client!jg", name = "r", descriptor = "Ldb;")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "([III[Lfd;I[I)V")
