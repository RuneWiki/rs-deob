...
public class class92 {
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(BI)V", line = 19)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(Z)V", line = 43)
