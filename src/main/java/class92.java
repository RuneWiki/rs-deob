...
public class class92 extends class485 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(CIIIZLvb;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "([B[IIIIIIII)V", line = 70)
    ...
    @OriginalMember(owner = "client!vr", name = "<init>", descriptor = "(Lfu;Lss;[Lua;[I[I)V", line = 102)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "([B[IIIIIIIIIIILvb;II)V", line = 125)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(CIIIZ)V", line = 220)
