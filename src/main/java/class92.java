...
public class class92 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lid;B)V")
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(Lid;B)Z")
    ...
    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "(Lvd;)V")
