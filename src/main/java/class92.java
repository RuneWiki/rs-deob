...
public class class92 extends class129 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!rf", name = "e", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(ZB)V", line = 48)
    ...
    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "(Lsd;Lla;Lcda;)V", line = 59)
    ...
    @OriginalMember(owner = "client!rf", name = "d", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(IIB)V", line = 98)
    ...
    @OriginalMember(owner = "client!rf", name = "c", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(IILrca;)V", line = 153)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(B)V", line = 162)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Z)Z", line = 190)
    ...
    @OriginalMember(owner = "client!rf", name = "c", descriptor = "(B)V", line = 200)
