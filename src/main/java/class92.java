...
public class class92 extends class591 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IILmv;Lmv;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(II[I[I)V", line = 69)
