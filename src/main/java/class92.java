...
public class class92 extends class641 implements class532 {
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(ILoa;ILni;ZZI)V")
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(Loa;B)V")
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(BLoa;)Lpe;")
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(Loa;BI)Lba;")
    ...
    @OriginalMember(owner = "client!qda", name = "<init>", descriptor = "(IIIIIIIIIILag;)V")
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(Loa;Z)V")
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(ILoa;)Ldd;")
    public final class660 method143(int arg0, class651 arg1) {
        field1391++;
        return arg0 == 31358 ? this.field1389.method143(arg0, arg1) : null;
    }

    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(BILoa;I)Z")
    ...
    @OriginalMember(owner = "client!qda", name = "e", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(Loa;I)V")
