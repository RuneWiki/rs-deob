...
public class class92 extends class206 implements class285 {
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Lvm;I)V", line = 15)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(ZIIILai;ILvm;)V", line = 26)
    ...
    @OriginalMember(owner = "client!oc", name = "c", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Lvm;IB)Ljn;", line = 60)
    ...
    @OriginalMember(owner = "client!oc", name = "c", descriptor = "(B)I", line = 81)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(ZLvm;)V", line = 93)
    ...
    @OriginalMember(owner = "client!oc", name = "d", descriptor = "(B)Z", line = 129)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(BLtq;)V", line = 140)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IIILvm;)Z", line = 190)
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(B)V", line = 214)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Lvm;II)Ljn;", line = 236)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Z)V", line = 247)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(ZLvm;IB)Lf;", line = 265)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(B)Z", line = 296)
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(I)I", line = 307)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(BLvm;)V", line = 317)
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(Lvm;Lds;IIIIZIZ)V", line = 344)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/Class;", line = 380)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Lvm;Z)Ldn;", line = 421)
