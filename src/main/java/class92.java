...
public class class92 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(ILoo;IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!uh", name = "<init>", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Ljava/awt/Frame;BLko;)V", line = 56)
