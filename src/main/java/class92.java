...
public class class92 extends class210 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IB)[I", line = 3)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(ZLwe;Z)V", line = 56)
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(Z)V", line = 221)
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "()V", line = 234)
    public class92() {
        super(1, true);
    }

    @OriginalMember(owner = "client!kq", name = "g", descriptor = "(I)[Lmg;", line = 237)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IILat;)V", line = 321)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IIII)I", line = 337)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 362)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(ILjava/lang/String;)I", line = 383)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IZ)V", line = 402)
