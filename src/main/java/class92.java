...
public class class92 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lfw;I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(B)V", line = 28)
    public static void method715(byte arg0) {
        int var1 = -52 / ((arg0 + 17) / 41);
        field1123 = null;
    }

    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lfh;B)V", line = 38)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(ILfh;I)V", line = 62)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(IILhd;ZI)V", line = 86)
