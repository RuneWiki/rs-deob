...
public class class92 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(IIII)I", line = 4)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(IILza;Lae;ILcl;)Z", line = 31)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(I)V", line = 285)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 305)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lue;I)I", line = 365)
