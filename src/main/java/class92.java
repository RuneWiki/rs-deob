...
public class class92 extends class623 {
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(I[IIZ)Z", line = 5)
    ...
    @OriginalMember(owner = "client!dba", name = "b", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(IIB)Z", line = 78)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(IIB[I)Z", line = 105)
    ...
    @OriginalMember(owner = "client!dba", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 205)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(IIII[I)Z", line = 149)
    ...
    @OriginalMember(owner = "client!dba", name = "c", descriptor = "(B)V", line = 184)
