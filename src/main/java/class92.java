...
public class class92 extends class450 {
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(ZI)V")
    ...
    @OriginalMember(owner = "client!aja", name = "b", descriptor = "(Z)I")
    ...
    @OriginalMember(owner = "client!aja", name = "c", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(BLvfa;Lvfa;)V")
    ...
    @OriginalMember(owner = "client!aja", name = "<init>", descriptor = "(Lup;)V")
    public class92(class278 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!aja", name = "<init>", descriptor = "(ILup;)V")
