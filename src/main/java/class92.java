...
public class class92 implements Runnable {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(BLjava/lang/String;)Lnc;", line = 9)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Lpc;Lpc;Z)I", line = 51)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(III)Z", line = 86)
    ...
    @OriginalMember(owner = "client!ls", name = "run", descriptor = "()V", line = 121)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Lda;I)V", line = 166)
    ...
    @OriginalMember(owner = "client!ls", name = "<init>", descriptor = "()V", line = 186)
    public class92() {
