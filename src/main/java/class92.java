...
public class class92 extends class149 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IBLtl;)V", line = 5)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(II)[I", line = 59)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ILhu;I)I", line = 101)
    public static final int method645(int arg0, class469 arg1, int arg2) {
        ++field1340;
        return arg0;
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(CI)Z", line = 112)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(BI)[[I", line = 125)
