...
public class class92 extends class499 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ls", name = "<init>", descriptor = "(I)V", line = 45)
    public class92(int arg0) {
        this.field1236 = arg0;
    }

    @OriginalMember(owner = "client!ls", name = "d", descriptor = "(I)V", line = 34)
