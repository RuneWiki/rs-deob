...
public class class92 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Liv;I)V")
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lmu;ZII)V")
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(IILiv;)V")
    ...
    @OriginalMember(owner = "client!fn", name = "b", descriptor = "(I)Lbb;")
