...
public class class92 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(I[II)Ljj;")
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(III[I)Ljj;")
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "([IBI)Ljj;")
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "([IIBI)Ljj;")
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "(Lfo;Lfo;)V")
