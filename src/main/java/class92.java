...
public class class92 extends class124 {
    ...
    @OriginalMember(owner = "client!vr", name = "EA", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!vr", name = "v", descriptor = "()V", line = 29)
    ...
    @OriginalMember(owner = "client!vr", name = "ha", descriptor = "(Lc;)V", line = 35)
    ...
    @OriginalMember(owner = "client!vr", name = "K", descriptor = "(III[I)V", line = 52)
    ...
    @OriginalMember(owner = "client!vr", name = "ea", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!vr", name = "wa", descriptor = "([I)V", line = 81)
    ...
    @OriginalMember(owner = "client!vr", name = "ca", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "()Lc;", line = 100)
    ...
    @OriginalMember(owner = "client!vr", name = "W", descriptor = "(III)V", line = 116)
    ...
    @OriginalMember(owner = "client!vr", name = "U", descriptor = "(III)V", line = 121)
    ...
    @OriginalMember(owner = "client!vr", name = "A", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(III[I)V", line = 139)
    ...
    @OriginalMember(owner = "client!vr", name = "g", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!vr", name = "YA", descriptor = "(IIIIII)V", line = 154)
    ...
    @OriginalMember(owner = "client!vr", name = "<init>", descriptor = "()V", line = 183)
    public class92() {
        this.method827();
    }
}
