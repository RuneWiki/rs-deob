...
public class class92 extends class320 {
    ...
    @OriginalMember(owner = "client!ls", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ls", name = "<init>", descriptor = "()V", line = 19)
    public class92() {
    }

    @OriginalMember(owner = "client!ls", name = "<init>", descriptor = "(J)V", line = 24)
