...
public class class92 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "([Lsf;II)V", line = 15)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(I)Loha;", line = 54)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "([SB)[S", line = 65)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(IZ)Lrf;", line = 83)
    public final class92 method658(int arg0, boolean arg1) {
        field1198++;
        return arg1 ? null : new class92(this.field1206, arg0);
    }

    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "(II)V", line = 94)
