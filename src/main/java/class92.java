...
public class class92 {
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(ILfb;)V", line = 17)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(ILsj;)V", line = 53)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(ILfb;I)V", line = 75)
    ...
    @OriginalMember(owner = "client!ue", name = "b", descriptor = "(I)V", line = 102)
