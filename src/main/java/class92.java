...
public class class92 extends class424 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Lrg;BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Ljava/util/Random;II)I", line = 86)
    ...
    @OriginalMember(owner = "client!ur", name = "c", descriptor = "(III)Z", line = 116)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(ILon;)V", line = 185)
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(IB)[I", line = 196)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IIIBII)V", line = 221)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IZ)[[I", line = 334)
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "()V", line = 399)
    public class92() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ur", name = "d", descriptor = "(B)V", line = 402)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "([[IB)V", line = 416)
