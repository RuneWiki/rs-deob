...
public class class92 extends class301 {
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(Lck;)V", line = 5)
    ...
    @OriginalMember(owner = "client!pp", name = "b", descriptor = "(IZ)V", line = 38)
    ...
    @OriginalMember(owner = "client!pp", name = "b", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(Z)V", line = 92)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(Lwj;II)V", line = 118)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(B)Z", line = 156)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(III)V", line = 167)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(IBI)Z", line = 178)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(IZ)V", line = 199)
    ...
    @OriginalMember(owner = "client!pp", name = "b", descriptor = "(Z)V", line = 222)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(IB)V", line = 250)
    ...
    @OriginalMember(owner = "client!pp", name = "b", descriptor = "(I)V", line = 286)
