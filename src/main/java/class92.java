...
public class class92 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(II)Luia;", line = 8)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(ILuia;)V", line = 18)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(I)Lho;", line = 31)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(IZ)I", line = 47)
    ...
    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "(Luia;)V", line = 60)
    public class92(class382 arg0) {
        this.field1291 = arg0.field5549;
        this.field1296 = 1;
    }

    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "([Luia;)V", line = 72)
    public class92(class382[] arg0) {
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(I)I", line = 87)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(B)V", line = 97)
