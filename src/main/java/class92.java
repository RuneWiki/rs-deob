...
public abstract class class92 extends class177 {
    ...
    public abstract void method651(class151 arg0, int arg1);

    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(III)V")
    public abstract void method652(int arg0, int arg1, int arg2);

    @OriginalMember(owner = "client!sf", name = "d", descriptor = "()V")
    public abstract void method653();

    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(ZZ)Lsf;")
    public abstract class92 method654(boolean arg0, boolean arg1);
    ...
    public abstract void method658(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6);

    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Lbj;ILbj;I[IZ)V")
    public abstract void method659(class151 arg0, int arg1, class151 arg2, int arg3, int[] arg4, boolean arg5);
    ...
    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(ZZ)Lsf;")
    public abstract class92 method662(boolean arg0, boolean arg1);

    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(I)V")
    public abstract void method663(int arg0);
    ...
    public final void method664(int[][] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        ...
        int var10 = -arg4 / 2;
        int var11 = -arg5 / 2;
        int var12 = method666(arg0, arg1 + var10, arg3 + var11);
        int var13 = arg4 / 2;
        int var14 = -arg5 / 2;
        int var15 = method666(arg0, arg1 + var13, arg3 + var14);
        int var16 = -arg4 / 2;
        int var17 = arg5 / 2;
        int var18 = method666(arg0, arg1 + var16, arg3 + var17);
        int var19 = arg4 / 2;
        int var20 = arg5 / 2;
        int var21 = method666(arg0, arg1 + var19, arg3 + var20);
        ...
        if (arg5 != 0) {
            ...
            if (var26 != 0) {
                this.method663(var26);
            }
        }
        if (arg4 != 0) {
            int var27 = (int) (Math.atan2((double) (var25 - var24), (double) arg4) * 325.95D) & 0x7FF;
            if (var27 != 0) {
                this.method668(var27);
            }
        }
    ...
    private static final int method666(int[][] arg0, int arg1, int arg2) {
        int var3 = arg1 >> 7;
        int var4 = arg2 >> 7;
    ...
    public abstract void method668(int arg0);

    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Lbj;IZ)V")
    public abstract void method669(class151 arg0, int arg1, boolean arg2);
