...
public class class92 {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(III)Z", line = 7)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ZILiaa;)V", line = 20)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Lqg;Lnd;Z)V", line = 61)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(JJZZLjava/lang/String;IIIILjava/lang/String;ZIZ)V", line = 109)
    ...
    @OriginalMember(owner = "client!in", name = "b", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!in", name = "c", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(Lij;Loo;Llp;IIIII)V", line = 310)
