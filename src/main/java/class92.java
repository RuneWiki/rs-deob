...
public class class92 implements class353 {
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(Z)I", line = 5)
    ...
    @OriginalMember(owner = "client!aja", name = "b", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(IBI)Z", line = 38)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;", line = 74)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(Ljaclib/memory/Source;IIB)Z", line = 95)
    ...
    @OriginalMember(owner = "client!aja", name = "<init>", descriptor = "(Lbfa;Z)V", line = 145)
    public class92(class370 arg0, boolean arg1) {
        this.field1633 = arg0;
        this.field1630 = arg1;
    }

    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(I)Z", line = 113)
    ...
    @OriginalMember(owner = "client!aja", name = "c", descriptor = "(I)I", line = 136)
