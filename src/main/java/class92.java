...
public class class92 extends class182 {
    ...
    @OriginalMember(owner = "client!tn", name = "c", descriptor = "()V", line = 4)
    public final void method891() {
        this.field1357 = true;
    }

    @OriginalMember(owner = "client!tn", name = "b", descriptor = "()V", line = 9)
    public final void method892() {
        this.field1361 = true;
    }

    @OriginalMember(owner = "client!tn", name = "d", descriptor = "()Lsn;", line = 12)
    public final class659 method893() {
        return this.field1363;
    }

    @OriginalMember(owner = "client!tn", name = "g", descriptor = "()V", line = 15)
    public static void method894() {
        field1352 = null;
        field1349 = null;
    }

    @OriginalMember(owner = "client!tn", name = "a", descriptor = "([Lok;Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Lha;J[Lui;[Lok;Z)V", line = 113)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Lha;J)Z", line = 121)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(J)V", line = 169)
    public final void method898(long arg0) {
        this.field1350 = arg0;
    }

    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Lha;)V", line = 172)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Lha;[Lui;Z)V", line = 186)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(IZ)V", line = 262)
    ...
    @OriginalMember(owner = "client!tn", name = "e", descriptor = "()Lsn;", line = 272)
    ...
    @OriginalMember(owner = "client!tn", name = "f", descriptor = "()V", line = 289)
    private final void method903() {
        this.field1357 = false;
    }

    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(IIIII)V", line = 293)
    public final void method904(int arg0, int arg1, int arg2, int arg3, int arg4) {
        this.field1360 = arg0;
    }

    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "(IZ)V", line = 394)
    private class92(int arg0, boolean arg1) {
        this.method901(arg0, arg1);
    }

    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(IZ)Ltn;", line = 311)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "()V", line = 324)
