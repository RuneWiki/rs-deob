...
public class class92 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(II)Lvs;")
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lkg;I)V")
    ...
    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "(Lmja;ILbt;)V")
