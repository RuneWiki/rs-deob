...
public class class92 extends class89 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IIIIZZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "([SI)[S", line = 57)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "([[[Lgk;IIIIZ)Z", line = 75)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(II)V", line = 402)
    ...
    @OriginalMember(owner = "client!ur", name = "c", descriptor = "(I)Lpj;", line = 420)
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(Z)V", line = 434)
