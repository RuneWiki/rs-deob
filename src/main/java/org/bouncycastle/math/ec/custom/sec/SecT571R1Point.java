...
public class SecT571R1Point extends ECPoint.AbstractF2m {
     ...
     * @deprecated
     */
    public SecT571R1Point(ECCurve arg0, ECFieldElement arg1, ECFieldElement arg2, boolean arg3) {
    ...
    public SecT571R1Point(ECCurve arg0, ECFieldElement arg1, ECFieldElement arg2, ECFieldElement[] arg3, boolean arg4) {
     ...
     * @deprecated
     */
    public SecT571R1Point(ECCurve arg0, ECFieldElement arg1, ECFieldElement arg2) {
    ...
    public ECPoint add(ECPoint arg0) {
        if (this.isInfinity()) {
            ...
            if (var4.isZero()) {
                ...
                var22 = var21.square().add(var21).add(var18).addOne();
                if (var22.isZero()) {
                    return new SecT571R1Point(var2, var22, SecT571R1Curve.SecT571R1_B_SQRT, this.withCompression);
                }
            ...
            return new SecT571R1Point(var2, var22, var24, new ECFieldElement[] { var25 }, this.withCompression);
        }
    }
