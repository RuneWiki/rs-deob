...
public class SecT193R2Point extends ECPoint.AbstractF2m {
     ...
     * @deprecated
     */
    public SecT193R2Point(ECCurve arg0, ECFieldElement arg1, ECFieldElement arg2, boolean arg3) {
    ...
    public SecT193R2Point(ECCurve arg0, ECFieldElement arg1, ECFieldElement arg2, ECFieldElement[] arg3, boolean arg4) {
     ...
     * @deprecated
     */
    public SecT193R2Point(ECCurve arg0, ECFieldElement arg1, ECFieldElement arg2) {
    ...
    public ECPoint add(ECPoint arg0) {
        if (this.isInfinity()) {
            ...
            if (var4.isZero()) {
                ...
                var22 = var21.square().add(var21).add(var18).add(var2.getA());
                if (var22.isZero()) {
                    return new SecT193R2Point(var2, var22, var2.getB().sqrt(), this.withCompression);
                }
            ...
            return new SecT193R2Point(var2, var22, var24, new ECFieldElement[] { var25 }, this.withCompression);
        }
    }
