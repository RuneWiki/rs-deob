...
public class SecT239K1Point extends ECPoint.AbstractF2m {
     ...
     * @deprecated
     */
    public SecT239K1Point(ECCurve arg0, ECFieldElement arg1, ECFieldElement arg2, boolean arg3) {
    ...
    public SecT239K1Point(ECCurve arg0, ECFieldElement arg1, ECFieldElement arg2, ECFieldElement[] arg3, boolean arg4) {
    ...
    public ECPoint add(ECPoint arg0) {
        if (this.isInfinity()) {
            ...
            if (var4.isZero()) {
                ...
                if (var22.isZero()) {
                    return new SecT239K1Point(var2, var22, var2.getB(), this.withCompression);
                }
            ...
            return new SecT239K1Point(var2, var22, var24, new ECFieldElement[] { var25 }, this.withCompression);
        }
    }
     ...
     * @deprecated
     */
    public SecT239K1Point(ECCurve arg0, ECFieldElement arg1, ECFieldElement arg2) {
