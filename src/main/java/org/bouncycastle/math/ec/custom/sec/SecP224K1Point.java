...
public class SecP224K1Point extends ECPoint.AbstractFp {
     ...
     * @deprecated
     */
    public SecP224K1Point(ECCurve arg0, ECFieldElement arg1, ECFieldElement arg2) {
     ...
     * @deprecated
     */
    public SecP224K1Point(ECCurve arg0, ECFieldElement arg1, ECFieldElement arg2, boolean arg3) {
    ...
    public SecP224K1Point(ECCurve arg0, ECFieldElement arg1, ECFieldElement arg2, ECFieldElement[] arg3, boolean arg4) {
    ...
    public ECPoint add(ECPoint arg0) {
        if (this.isInfinity()) {
            ...
            SecP224K1FieldElement var5 = (SecP224K1FieldElement) arg0.getXCoord();
            SecP224K1FieldElement var6 = (SecP224K1FieldElement) arg0.getYCoord();
            SecP224K1FieldElement var7 = (SecP224K1FieldElement) this.zs[0];
            SecP224K1FieldElement var8 = (SecP224K1FieldElement) arg0.getZCoord(0);
    ...
    public ECPoint twice() {
        ...
        int var10 = Nat.shiftUpBits(7, var5, 2, 0);
        SecP224K1Field.reduce32(var10, var5);
        int[] var11 = Nat224.create();
        int var12 = Nat.shiftUpBits(7, var6, 3, 0, var11);
        SecP224K1Field.reduce32(var12, var11);
        SecP224K1FieldElement var13 = new SecP224K1FieldElement(var6);
        SecP224K1Field.square(var7, var13.x);
        SecP224K1Field.subtract(var13.x, var5, var13.x);
        SecP224K1Field.subtract(var13.x, var5, var13.x);
        SecP224K1FieldElement var14 = new SecP224K1FieldElement(var5);
        SecP224K1Field.subtract(var5, var13.x, var14.x);
        SecP224K1Field.multiply(var14.x, var7, var14.x);
        SecP224K1Field.subtract(var14.x, var11, var14.x);
        SecP224K1FieldElement var15 = new SecP224K1FieldElement(var7);
        SecP224K1Field.twice(var2.x, var15.x);
        if (!var4.isOne()) {
            SecP224K1Field.multiply(var15.x, var4.x, var15.x);
        }
        return new SecP224K1Point(var1, var13, var14, new ECFieldElement[] { var15 }, this.withCompression);
    }
