...
public abstract class ECPoint {
    ...
    public String agx() {
        ...
        StringBuffer var1 = new StringBuffer();
        var1.append((char) -242339208);
        var1.append(this.getRawXCoord());
        var1.append(',');
        var1.append(this.getRawYCoord());
        for (int var2 = 0; var2 < this.zs.length; var2++) {
            var1.append((char) 1309824693);
            var1.append(this.zs[var2]);
        }
        var1.append((char) 1469130113);
        return var1.toString();
    }
    ...
    public int agp() {
        ...
        if (!this.isInfinity()) {
            ECPoint var3 = this.normalize();
            int var4 = var2 ^ var3.getXCoord().hashCode() * 17;
            var2 = var4 ^ var3.getYCoord().hashCode() * -255057698;
        }
        return var2;
    }
    ...
    public int age() {
        ...
        if (!this.isInfinity()) {
            ECPoint var3 = this.normalize();
            int var4 = var2 ^ var3.getXCoord().hashCode() * 17;
            var2 = var4 ^ var3.getYCoord().hashCode() * -1198310894;
        }
        return var2;
    }
    ...
    public String agt() {
        ...
        var1.append('(');
        var1.append(this.getRawXCoord());
        var1.append((char) -921874604);
        var1.append(this.getRawYCoord());
        for (int var2 = 0; var2 < this.zs.length; var2++) {
            var1.append(',');
            var1.append(this.zs[var2]);
        }
        var1.append((char) 679213424);
        return var1.toString();
    }
