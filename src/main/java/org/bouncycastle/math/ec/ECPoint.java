...
public abstract class ECPoint {
    ...
    public int aja() {
        ...
        if (!this.isInfinity()) {
            ECPoint var3 = this.normalize();
            int var4 = var2 ^ var3.getXCoord().hashCode() * 17;
            var2 = var4 ^ var3.getYCoord().hashCode() * 2073535858;
        }
        return var2;
    }
    ...
    public int ajf() {
        ...
        if (!this.isInfinity()) {
            ECPoint var3 = this.normalize();
            int var4 = var2 ^ var3.getXCoord().hashCode() * 17;
            var2 = var4 ^ var3.getYCoord().hashCode() * 1981317079;
        }
        return var2;
    }
