...
public abstract class ECPoint {
    ...
    public String akn() {
        ...
        var1.append('(');
        var1.append(this.getRawXCoord());
        var1.append((char) 1537736708);
        var1.append(this.getRawYCoord());
        for (int var2 = 0; var2 < this.zs.length; var2++) {
            var1.append((char) -533499773);
            var1.append(this.zs[var2]);
        }
        var1.append((char) -1030448054);
        return var1.toString();
    }
    ...
    public String aky() {
        ...
        StringBuffer var1 = new StringBuffer();
        var1.append((char) -1487265680);
        var1.append(this.getRawXCoord());
        var1.append((char) -1535157483);
        var1.append(this.getRawYCoord());
        for (int var2 = 0; var2 < this.zs.length; var2++) {
            var1.append(',');
            var1.append(this.zs[var2]);
