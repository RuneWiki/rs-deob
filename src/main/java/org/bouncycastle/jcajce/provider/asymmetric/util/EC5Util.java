...
public class EC5Util {
    ...
    public static ECPoint convertPoint(ECParameterSpec arg0, java.security.spec.ECPoint arg1, boolean arg2) {
        return convertPoint(convertCurve(arg0.getCurve()), arg1, arg2);
    }

    public static ECParameterSpec convertToSpec(X9ECParameters arg0) {
        return new ECParameterSpec(convertCurve(arg0.getCurve(), (byte[]) null), new java.security.spec.ECPoint(arg0.getG().getAffineXCoord().toBigInteger(), arg0.getG().getAffineYCoord().toBigInteger()), arg0.getN(), arg0.getH().intValue());
    }
    ...
    public static ECParameterSpec convertToSpec(X962Parameters arg0, ECCurve arg1) {
        ...
        if (arg0.isNamedCurve()) {
            ...
            var6 = new ECNamedCurveSpec(ECUtil.getCurveName(var2), var5, new java.security.spec.ECPoint(var3.getG().getAffineXCoord().toBigInteger(), var3.getG().getAffineYCoord().toBigInteger()), var3.getN(), var3.getH());
            ...
            if (var7.getH() == null) {
                var6 = new ECParameterSpec(var8, new java.security.spec.ECPoint(var7.getG().getAffineXCoord().toBigInteger(), var7.getG().getAffineYCoord().toBigInteger()), var7.getN(), 1);
            } else {
                var6 = new ECParameterSpec(var8, new java.security.spec.ECPoint(var7.getG().getAffineXCoord().toBigInteger(), var7.getG().getAffineYCoord().toBigInteger()), var7.getN(), var7.getH().intValue());
            }
        }
        return var6;
    }
    ...
    public static ECParameterSpec convertSpec(EllipticCurve arg0, org.bouncycastle.jce.spec.ECParameterSpec arg1) {
        return arg1 instanceof ECNamedCurveParameterSpec ? new ECNamedCurveSpec(((ECNamedCurveParameterSpec) arg1).getName(), arg0, new java.security.spec.ECPoint(arg1.getG().getAffineXCoord().toBigInteger(), arg1.getG().getAffineYCoord().toBigInteger()), arg1.getN(), arg1.getH()) : new ECParameterSpec(arg0, new java.security.spec.ECPoint(arg1.getG().getAffineXCoord().toBigInteger(), arg1.getG().getAffineYCoord().toBigInteger()), arg1.getN(), arg1.getH().intValue());
    }
    ...
    public static ECPoint convertPoint(ECCurve arg0, java.security.spec.ECPoint arg1, boolean arg2) {
