...
public class EC5Util {
    ...
    public static ECParameterSpec convertSpec(java.security.spec.ECParameterSpec arg0, boolean arg1) {
        ECCurve var2 = convertCurve(arg0.getCurve());
        return new ECParameterSpec(var2, convertPoint(var2, arg0.getGenerator(), arg1), arg0.getOrder(), BigInteger.valueOf((long) arg0.getCofactor()), arg0.getCurve().getSeed());
    }
    ...
    public static ECDomainParameters getDomainParameters(ProvConf arg0, java.security.spec.ECParameterSpec arg1) {
        ECDomainParameters var3;
        if (arg1 == null) {
            ECParameterSpec var2 = arg0.getEcImplicitlyCa();
    ...
    public static java.security.spec.ECParameterSpec convertToSpec(X962Parameters arg0, ECCurve arg1) {
        java.security.spec.ECParameterSpec var6;
        if (arg0.isNamedCurve()) {
            ...
            if (var7.getH() == null) {
                var6 = new java.security.spec.ECParameterSpec(var8, new ECPoint(var7.getG().getAffineXCoord().toBigInteger(), var7.getG().getAffineYCoord().toBigInteger()), var7.getN(), 1);
            } else {
                var6 = new java.security.spec.ECParameterSpec(var8, new ECPoint(var7.getG().getAffineXCoord().toBigInteger(), var7.getG().getAffineYCoord().toBigInteger()), var7.getN(), var7.getH().intValue());
            }
        }
        return var6;
    }

    public static org.bouncycastle.math.ec.ECPoint convertPoint(java.security.spec.ECParameterSpec arg0, ECPoint arg1, boolean arg2) {
    ...
    public static java.security.spec.ECParameterSpec convertSpec(EllipticCurve arg0, ECParameterSpec arg1) {
        return arg1 instanceof ECNamedCurveParameterSpec ? new ECNamedCurveSpec(((ECNamedCurveParameterSpec) arg1).getName(), arg0, new ECPoint(arg1.getG().getAffineXCoord().toBigInteger(), arg1.getG().getAffineYCoord().toBigInteger()), arg1.getN(), arg1.getH()) : new java.security.spec.ECParameterSpec(arg0, new ECPoint(arg1.getG().getAffineXCoord().toBigInteger(), arg1.getG().getAffineYCoord().toBigInteger()), arg1.getN(), arg1.getH().intValue());
    }

    public static java.security.spec.ECParameterSpec convertToSpec(X9ECParameters arg0) {
        return new java.security.spec.ECParameterSpec(convertCurve(arg0.getCurve(), (byte[]) null), new ECPoint(arg0.getG().getAffineXCoord().toBigInteger(), arg0.getG().getAffineYCoord().toBigInteger()), arg0.getN(), arg0.getH().intValue());
    }
