...
public class KeyUsage extends ASN1Object {
    ...
    public String aej() {
        byte[] var1 = this.bitString.getBytes();
        return var1.length == 1 ? "KeyUsage: 0x" + Integer.toHexString(var1[0] & 0xF9BDB74E) : "KeyUsage: 0x" + Integer.toHexString((var1[1] & 0xFF) << 8 | var1[0] & 0xFDAD00D7);
    }

    public String aeh() {
        byte[] var1 = this.bitString.getBytes();
        return var1.length == 1 ? "KeyUsage: 0x" + Integer.toHexString(var1[0] & 0xD76BF81B) : "KeyUsage: 0x" + Integer.toHexString((var1[1] & 0xCE743FA7) << 8 | var1[0] & 0xFF);
    }
}
