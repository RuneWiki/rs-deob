...
public class KeyUsage extends ASN1Object {
    ...
    public String ajb() {
        byte[] var1 = this.bitString.getBytes();
        return var1.length == 1 ? "KeyUsage: 0x" + Integer.toHexString(var1[0] & 0x94CA5EA3) : "KeyUsage: 0x" + Integer.toHexString((var1[1] & 0x57902177) << 8 | var1[0] & 0xFF);
    }

    public String ajc() {
        byte[] var1 = this.bitString.getBytes();
        return var1.length == 1 ? "KeyUsage: 0x" + Integer.toHexString(var1[0] & 0xA5D1BB1D) : "KeyUsage: 0x" + Integer.toHexString((var1[1] & 0x1FA63100) << 8 | var1[0] & 0xFF);
    }
