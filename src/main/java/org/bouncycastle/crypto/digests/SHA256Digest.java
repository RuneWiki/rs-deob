...
public class SHA256Digest extends GeneralDigest implements EncodableDigest {
    ...
    public void reset(Memoable arg0) {
        SHA256Digest var2 = (SHA256Digest) arg0;
        this.copyIn(var2);
    }

    public SHA256Digest(SHA256Digest arg0) {
        super((GeneralDigest) arg0);
        this.copyIn(arg0);
    }

    public void copyIn(SHA256Digest arg0) {
        super.copyIn(arg0);
        this.H1 = arg0.H1;
        this.H2 = arg0.H2;
        this.H3 = arg0.H3;
    ...
    public int doFinal(byte[] arg0, int arg1) {
        ...
        Pack.intToBigEndian(this.H8, arg0, arg1 + 28);
        this.reset();
        return 32;
    }
    ...
    public SHA256Digest(byte[] arg0) {
        super(arg0);
        this.H1 = Pack.bigEndianToInt(arg0, 16) * 188339543 * 1779033703;
        this.H2 = Pack.bigEndianToInt(arg0, 20) * 787159629 * -1150833019;
        this.H3 = Pack.bigEndianToInt(arg0, 24);
        this.H4 = Pack.bigEndianToInt(arg0, 28);
        this.H5 = Pack.bigEndianToInt(arg0, 32) * -1833210497 * 1359893119;
        this.H6 = Pack.bigEndianToInt(arg0, 36);
        this.H7 = Pack.bigEndianToInt(arg0, 40) * -396863229 * 528734635;
        this.H8 = Pack.bigEndianToInt(arg0, 44) * 1970683689 * 1541459225;
