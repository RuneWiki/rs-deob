...
public class HashAlgorithm {
    ...
    public static String getText(short arg0) {
        return getName(arg0) + "(" + arg0 + ")";
    }

    public static String getName(short arg0) {
        switch(arg0) {
            case 0:
                return "none";
            case 1:
    ...
    public static boolean isPrivate(short arg0) {
        return 224 <= arg0 && arg0 <= 255;
    }
}
