...
public class JSONArray {
    ...
    public JSONArray(Object arg0) throws JSONException {
        ...
        for (int var3 = 0; var3 < var2; var3++) {
            this.put(JSONObject.wrap(Array.get(arg0, var3)));
        }
    }
    ...
    public String getString(int arg0) throws JSONException {
        ...
        if (!var2 instanceof String) {
            throw new JSONException("JSONArray[" + arg0 + "] not a string.");
        }
        return (String) var2;
    }
    ...
    public String optString(int arg0, String arg1) {
        ...
        return JSONObject.NULL.equals(var3) ? arg1 : var3.toString();
    }
    ...
    public Writer write(Writer arg0, int arg1, int arg2) throws JSONException {
        try {
            ...
            arg0.write(91);
            if (var5 == 1) {
                JSONObject.writeValue(arg0, this.myArrayList.get(0), arg1, arg2);
            } else if (var5 != 0) {
                int var6 = arg1 + arg2;
                for (int var7 = 0; var7 < var5; var7++) {
                    ...
                    JSONObject.indent(arg0, var6);
                    JSONObject.writeValue(arg0, this.myArrayList.get(var7), arg1, var6);
                    var4 = true;
                }
                if (arg1 > 0) {
                    arg0.write(10);
                }
                JSONObject.indent(arg0, arg2);
            }
            arg0.write(93);
            return arg0;
