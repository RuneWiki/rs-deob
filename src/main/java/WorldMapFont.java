...
public class WorldMapFont extends Draw2D {
    ...
    public byte[] field58 = new byte[100000];

    @OriginalMember(owner = "mapview!g", name = "s", descriptor = "[I")
    public static int[] field59 = new int[256];

    @OriginalMember(owner = "mapview!g", name = "a", descriptor = "(Ljava/awt/Font;Ljava/awt/FontMetrics;CIZLa;)V")
    private void method33(Font arg0, FontMetrics arg1, char arg2, int arg3, boolean arg4, GameShell arg5) {
        ...
        this.field58[arg3 * 9] = (byte) (this.field57 / 16384);
        this.field58[arg3 * 9 + 1] = (byte) (this.field57 / 128 & 0x7F);
        this.field58[arg3 * 9 + 2] = (byte) (this.field57 & 0x7F);
        this.field58[arg3 * 9 + 3] = (byte) (var21 - var19);
        this.field58[arg3 * 9 + 4] = (byte) (var22 - var20);
        this.field58[arg3 * 9 + 5] = (byte) var19;
        this.field58[arg3 * 9 + 6] = (byte) (var10 - var20);
        this.field58[arg3 * 9 + 7] = (byte) var8;
        this.field58[arg3 * 9 + 8] = (byte) var12;
        for (int var35 = var20; var35 < var22; var35++) {
            for (int var36 = var19; var36 < var21; var36++) {
                ...
                this.field58[this.field57++] = (byte) var37;
            }
        }
    }

    @OriginalMember(owner = "mapview!g", name = "a", descriptor = "(Ljava/lang/String;IIIZ)V")
    public void method34(String arg0, int arg1, int arg2, int arg3, boolean arg4) {
        try {
            if (this.field56 || arg3 == 0) {
                arg4 = false;
            }
            for (int var6 = 0; var6 < arg0.length(); var6++) {
                int var7 = field59[arg0.charAt(var6)];
                if (arg4) {
                    this.method39(var7, arg1 + 1, arg2, 0, this.field58, this.field56);
                    this.method39(var7, arg1, arg2 + 1, 0, this.field58, this.field56);
                }
                this.method39(var7, arg1, arg2, arg3, this.field58, this.field56);
                arg1 += this.field58[var7 + 7];
            }
    ...
    @OriginalMember(owner = "mapview!g", name = "<init>", descriptor = "(IZLa;)V")
    public WorldMapFont(int arg0, boolean arg1, GameShell arg2) {
        ...
        for (int var6 = 0; var6 < 95; var6++) {
            this.method33(var4, var5, "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"£$%^&*()-_=+[{]};:'@#~,<.>/?\\| ".charAt(var6), var6, false, arg2);
        }
        if (arg1 && this.field56) {
            this.field57 = 855;
            this.field56 = false;
            Font var7 = new Font("Helvetica", 0, arg0);
            FontMetrics var8 = arg2.getFontMetrics(var7);
            for (int var9 = 0; var9 < 95; var9++) {
                this.method33(var7, var8, "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"£$%^&*()-_=+[{]};:'@#~,<.>/?\\| ".charAt(var9), var9, false, arg2);
            }
            if (!this.field56) {
                this.field57 = 855;
                this.field56 = false;
                for (int var10 = 0; var10 < 95; var10++) {
                    this.method33(var7, var8, "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"£$%^&*()-_=+[{]};:'@#~,<.>/?\\| ".charAt(var10), var10, true, arg2);
                }
            }
        }
    ...
    public void method35(String arg0, int arg1, int arg2, int arg3, boolean arg4) {
        int var6 = this.method38(arg0) / 2;
        int var7 = this.method41();
        if (arg1 - var6 <= Draw2D.field51 && (arg1 + var6 >= Draw2D.field50 && (arg2 - var7 <= Draw2D.field49 && arg2 >= 0))) {
            this.method34(arg0, arg1 - var6, arg2, arg3, arg4);
        }
    }

    @OriginalMember(owner = "mapview!g", name = "a", descriptor = "([I[BIIIIIII)V")
    private void method36(int[] arg0, byte[] arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
    ...
    public int method38(String arg0) {
        ...
        for (int var3 = 0; var3 < arg0.length(); var3++) {
            if (arg0.charAt(var3) == '@' && var3 + 4 < arg0.length() && arg0.charAt(var3 + 4) == '@') {
                ...
                var2 += this.field58[field59[arg0.charAt(var3)] + 7];
            }
        }
        return var2;
    }
    ...
    private void method39(int arg0, int arg1, int arg2, int arg3, byte[] arg4, boolean arg5) {
        ...
        int var12 = Draw2D.field46 * var8 + var7;
        int var13 = Draw2D.field46 - var9;
        int var14 = 0;
        if (var8 < Draw2D.field48) {
            int var15 = Draw2D.field48 - var8;
            var10 -= var15;
            var8 = Draw2D.field48;
            var11 += var9 * var15;
            var12 += Draw2D.field46 * var15;
        }
        if (var8 + var10 >= Draw2D.field49) {
            var10 -= var8 + var10 + 1 - Draw2D.field49;
        }
        if (var7 < Draw2D.field50) {
            int var16 = Draw2D.field50 - var7;
            var9 -= var16;
            var7 = Draw2D.field50;
            var11 += var16;
            var12 += var16;
        ...
        if (var7 + var9 >= Draw2D.field51) {
            int var17 = var7 + var9 + 1 - Draw2D.field51;
            var9 -= var17;
            var14 += var17;
            var13 += var17;
        }
        ...
        if (arg5) {
            this.method36(Draw2D.field45, arg4, arg3, var11, var12, var9, var10, var13, var14);
        } else {
            this.method40(Draw2D.field45, arg4, arg3, var11, var12, var9, var10, var13, var14);
        }
    }

    @OriginalMember(owner = "mapview!g", name = "b", descriptor = "([I[BIIIIIII)V")
    private void method40(int[] arg0, byte[] arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
        try {
            int var10 = -(arg5 >> 2);
            int var11 = -(arg5 & 0x3);
