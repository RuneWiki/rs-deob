...
public class class690 implements class515 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(B)Ljd;", line = 11)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(Ltl;Lpd;IIIIIII)V", line = 34)
