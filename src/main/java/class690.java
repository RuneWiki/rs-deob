...
public class class690 implements class17 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(B)Lrt;")
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!rl", name = "<init>", descriptor = "(Leda;Lrt;Z)V")
