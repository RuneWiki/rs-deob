...
public class class690 extends class426 implements class116 {
    ...
    @OriginalMember(owner = "client!wo", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(Lkw;I[BIZ)V", line = 15)
    public class690(class346 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34963, arg2, arg3, arg4);
        this.field9789 = arg1;
    }

    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Z)I", line = 23)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(I)J", line = 43)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(B)I", line = 55)
    ...
    @OriginalMember(owner = "client!wo", name = "e", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(II[BB)V", line = 78)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(II)I", line = 93)
