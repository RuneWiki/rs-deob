...
public class class690 extends class504 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Lgba;Lgba;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(ZI)I", line = 26)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(IIZI)I", line = 38)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Lfg;B)Ljava/lang/String;", line = 60)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(IIIIIIII)V", line = 75)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(II)V", line = 130)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(I)V", line = 143)
