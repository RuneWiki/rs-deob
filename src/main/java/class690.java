...
public class class690 implements class454 {
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(IIIIIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(I)I", line = 201)
    ...
    @OriginalMember(owner = "client!ica", name = "c", descriptor = "(I)Z", line = 219)
    ...
    @OriginalMember(owner = "client!ica", name = "b", descriptor = "(I)Lbja;", line = 236)
    ...
    @OriginalMember(owner = "client!ica", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 246)
