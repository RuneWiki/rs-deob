...
public class class690 extends class213 {
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 5)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(IIIIBIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!eca", name = "<init>", descriptor = "(Lap;II[B)V", line = 90)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "()V", line = 103)
    ...
    @OriginalMember(owner = "client!eca", name = "b", descriptor = "(I)V", line = 355)
