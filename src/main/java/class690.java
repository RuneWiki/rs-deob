...
public class class690 {
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(B[B)[B", line = 102)
    ...
    @OriginalMember(owner = "client!wo", name = "b", descriptor = "(B)V", line = 164)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(I[B)[B", line = 182)
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(II)V", line = 198)
    public class690(int arg0, int arg1) {
        this.field9839 = arg1;
        this.field9834 = arg0;
    }

    @OriginalMember(owner = "client!wo", name = "toString", descriptor = "()Ljava/lang/String;", line = 208)
    public final String toString() {
        field9840++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Z)I", line = 222)
