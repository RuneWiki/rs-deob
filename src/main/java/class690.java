...
public class class690 {
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(IIII)Z", line = 6)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "()V", line = 66)
    public static final void method3685() {
        field8864 = null;
        field8874 = null;
    }

    @OriginalMember(owner = "client!dw", name = "b", descriptor = "()V", line = 74)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Lha;Ldw;)V", line = 81)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Lha;)V", line = 166)
    ...
    @OriginalMember(owner = "client!dw", name = "b", descriptor = "(Lha;Ldw;)V", line = 245)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Lha;IIIIII)V", line = 331)
    ...
    @OriginalMember(owner = "client!dw", name = "c", descriptor = "(Lha;Ldw;)Z", line = 356)
    public final boolean method3691(class570 arg0, class690 arg1) {
        return this.field8865 != null || this.method3693(arg0, arg1);
    }

    @OriginalMember(owner = "client!dw", name = "c", descriptor = "()V", line = 361)
    public final void method3692() {
        this.field8865 = null;
    }

    @OriginalMember(owner = "client!dw", name = "d", descriptor = "(Lha;Ldw;)Z", line = 367)
    ...
    @OriginalMember(owner = "client!dw", name = "b", descriptor = "(Lha;)V", line = 411)
    ...
    @OriginalMember(owner = "client!dw", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 470)
