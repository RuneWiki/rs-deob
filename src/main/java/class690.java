...
public class class690 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(BLjc;)V", line = 15)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Ljc;BI)V", line = 36)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(B)V", line = 94)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(I)V", line = 110)
