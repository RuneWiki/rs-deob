...
public class class690 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lin;BLin;Lin;Lin;)V")
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(II)Lbda;")
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(Lsj;ILin;)V")
