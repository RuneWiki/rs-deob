...
public abstract class class690 extends class108 {
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(Loa;IILrh;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(IIIZII)V", line = 40)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(ZI)V", line = 93)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(B)V", line = 127)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(ZLe;ILjava/awt/Canvas;)Loa;", line = 140)
