...
public class class690 extends class710 {
    ...
    @OriginalMember(owner = "client!sp", name = "<init>", descriptor = "(Lji;IIII[BI)V")
    ...
    @OriginalMember(owner = "client!sp", name = "<init>", descriptor = "(Lji;IIII)V")
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Ldt;I)Z")
