...
public class class690 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lbi;I)V", line = 103)
    ...
    @OriginalMember(owner = "client!kb", name = "c", descriptor = "(I)V", line = 142)
