...
public class class690 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IB)Lsda;", line = 4)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IIIIIIII)V", line = 48)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(I)V", line = 213)
