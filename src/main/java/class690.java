...
public class class690 extends class681 {
    ...
    @OriginalMember(owner = "client!qc", name = "d", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Z)Z", line = 76)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ILrga;I)V", line = 86)
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(ZI)V", line = 96)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IIB)V", line = 129)
    ...
    @OriginalMember(owner = "client!qc", name = "e", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!qc", name = "c", descriptor = "(I)V", line = 179)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ZI)V", line = 195)
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(B)V", line = 204)
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Lega;Lsea;Lst;)V", line = 223)
