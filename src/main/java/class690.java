...
public class class690 extends class650 {
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(III)V", line = 6)
    ...
    @OriginalMember(owner = "client!bca", name = "d", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!bca", name = "e", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!bca", name = "b", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!bca", name = "c", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!bca", name = "f", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!bca", name = "b", descriptor = "(III)V", line = 119)
    ...
    @OriginalMember(owner = "client!bca", name = "c", descriptor = "(III[I)V", line = 131)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "([I)V", line = 145)
    ...
    @OriginalMember(owner = "client!bca", name = "b", descriptor = "()Lsk;", line = 166)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(IIIIII)V", line = 190)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(I)V", line = 230)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(III[I)V", line = 257)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(Lsk;)V", line = 272)
    ...
    @OriginalMember(owner = "client!bca", name = "b", descriptor = "(III[I)V", line = 303)
    ...
    @OriginalMember(owner = "client!bca", name = "<init>", descriptor = "()V", line = 320)
    public class690() {
        this.method1862();
    }

    @OriginalMember(owner = "client!bca", name = "a", descriptor = "()V", line = 336)
