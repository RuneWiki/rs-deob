...
public class class124 extends class488 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "([B[IIIIIIIIIIILbe;II)V")
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Llo;Lpm;[Lfd;[I[I)V")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(CIIIZLbe;II)V")
