...
public class class124 {
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ej", name = "toString", descriptor = "()Ljava/lang/String;", line = 33)
    public final String toString() {
        field2126++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(I)I", line = 45)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Z)V", line = 56)
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "(II)V", line = 71)
