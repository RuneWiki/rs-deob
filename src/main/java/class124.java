...
public class class124 {
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(II)Lfs;", line = 47)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(ILvd;Lvd;)V", line = 96)
