...
public class class124 extends class86 {
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(Lsf;)V", line = 3)
    public class124(class551 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!lo", name = "b", descriptor = "(II)I", line = 17)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Z)I", line = 28)
    public final int method731(boolean arg0) {
        ++field1652;
        return arg0 ? -122 : super.field1200;
    }

    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!lo", name = "b", descriptor = "(I)I", line = 56)
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(ILsf;)V", line = 70)
    public class124(int arg0, class551 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!lo", name = "c", descriptor = "(II)Z", line = 74)
