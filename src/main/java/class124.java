...
public class class124 extends class446 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!ui", name = "d", descriptor = "(I)V", line = 176)
    ...
    @OriginalMember(owner = "client!ui", name = "e", descriptor = "(I)V", line = 199)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(BIIILgm;)V", line = 224)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IB)Ljava/lang/String;", line = 271)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Lkh;I)V", line = 291)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Ljava/lang/String;IB)I", line = 315)
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(IB)I", line = 327)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(BLkh;I)V", line = 351)
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(II)Z", line = 409)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 433)
    ...
    @OriginalMember(owner = "client!ui", name = "f", descriptor = "(I)V", line = 468)
    ...
    @OriginalMember(owner = "client!ui", name = "g", descriptor = "(I)V", line = 479)
