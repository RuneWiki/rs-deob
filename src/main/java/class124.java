...
public class class124 {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(B)Lst;")
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(Ltq;ZJ)V")
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IIILgo;Lgo;)V")
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IIBLbg;)V")
