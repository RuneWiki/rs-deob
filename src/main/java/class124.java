...
public class class124 extends class638 {
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(IIILha;)Z")
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(ILjw;Lha;BIZI)V")
    ...
    @OriginalMember(owner = "client!sfa", name = "c", descriptor = "(BLha;)Lro;")
    ...
    @OriginalMember(owner = "client!sfa", name = "b", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(BLha;)Lqs;")
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(IILha;I)Lka;")
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(ILka;Lsk;Lha;)V")
