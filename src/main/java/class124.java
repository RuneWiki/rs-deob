...
public class class124 {
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "([BILnv;I)Laja;", line = 25)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(IB)V", line = 53)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(B)Z", line = 67)
