...
public class class124 {
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(II)V", line = 12)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Loa;[II[I[I)V", line = 56)
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "()V", line = 59)
    public static void method763() {
        field1545 = null;
    }

    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(I)Z", line = 64)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Loa;[II)V", line = 139)
    public static final void method765(class605 arg0, int[] arg1, int arg2) {
        method769(arg0, arg1, 0, arg1.length, arg2, null, null);
    }

    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(II)V", line = 145)
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(I)V", line = 183)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "([III)V", line = 232)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Loa;[IIII[I[I)V", line = 284)
