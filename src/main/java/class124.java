...
public class class124 extends class264 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(II[J[Ljava/lang/Object;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IZI)V", line = 62)
    ...
    @OriginalMember(owner = "client!be", name = "b", descriptor = "(BI)[[I", line = 132)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IIIII)I", line = 265)
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "()V", line = 286)
    public class124() {
        super(1, false);
    }

    @OriginalMember(owner = "client!be", name = "a", descriptor = "(BLkk;I)V", line = 293)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(II)[I", line = 336)
    ...
    @OriginalMember(owner = "client!be", name = "b", descriptor = "(B)V", line = 433)
