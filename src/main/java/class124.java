...
public class class124 extends class11 {
    ...
    @OriginalMember(owner = "client!nc", name = "ib", descriptor = "F")
    ...
    @OriginalMember(owner = "client!nc", name = "Z", descriptor = "Laa;")
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(FII)V")
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "([I[IIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(F)V")
    ...
    @OriginalMember(owner = "client!nc", name = "b", descriptor = "([I[IIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(Laa;)V")
    ...
    @OriginalMember(owner = "client!nc", name = "b", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
