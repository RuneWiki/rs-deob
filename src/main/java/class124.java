...
public class class124 {
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(BLwc;J)V", line = 6)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(FI)F", line = 27)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(BJ)Lwc;", line = 40)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(I)Lwc;", line = 73)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(B)V", line = 106)
    ...
    @OriginalMember(owner = "client!pv", name = "<init>", descriptor = "(I)V", line = 125)
