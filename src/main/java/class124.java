...
public class class124 {
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Ljp;B)V", line = 6)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(II)Ljava/lang/String;", line = 77)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!r", name = "b", descriptor = "(I)V", line = 171)
