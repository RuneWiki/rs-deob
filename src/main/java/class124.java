...
public class class124 extends class24 {
    ...
    @OriginalMember(owner = "client!dv", name = "e", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!dv", name = "h", descriptor = "(I)I", line = 21)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(ILat;)V", line = 35)
    ...
    @OriginalMember(owner = "client!dv", name = "k", descriptor = "(I)Z", line = 51)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(BILha;)Z", line = 62)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IIBLha;)Z", line = 338)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(ZLha;)V", line = 393)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(B)I", line = 422)
    ...
    @OriginalMember(owner = "client!dv", name = "l", descriptor = "(I)V", line = 443)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(ZIIIII)V", line = 457)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IIB)V", line = 542)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(CILjava/lang/String;)[Ljava/lang/String;", line = 639)
    ...
    @OriginalMember(owner = "client!dv", name = "b", descriptor = "(Lha;B)Lufa;", line = 673)
    ...
    @OriginalMember(owner = "client!dv", name = "j", descriptor = "(I)I", line = 699)
    ...
    @OriginalMember(owner = "client!dv", name = "c", descriptor = "(B)Z", line = 724)
    public final boolean method516(byte arg0) {
        ++field1482;
        return arg0 >= -67 ? false : false;
    }

    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Lha;I)Lie;", line = 736)
    ...
    @OriginalMember(owner = "client!dv", name = "m", descriptor = "(I)Z", line = 864)
    ...
    @OriginalMember(owner = "client!dv", name = "c", descriptor = "(I)I", line = 879)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(ZILmb;Lha;III)V", line = 901)
