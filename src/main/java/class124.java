...
public class class124 implements class48 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Z)I", line = 8)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(B)Lvca;", line = 35)
    public final class279 method279(byte arg0) {
        field1307++;
        return arg0 == -127 ? class279.field3420 : null;
    }

    @OriginalMember(owner = "client!ut", name = "<init>", descriptor = "(Loh;)V", line = 50)
    public class124(class404 arg0) {
        this.field1304 = arg0;
    }

    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Ljava/awt/Component;I)Lvw;", line = 58)
