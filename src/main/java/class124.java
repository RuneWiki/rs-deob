...
public class class124 extends class165 implements class415 {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIIII)Llo;")
    ...
    @OriginalMember(owner = "client!c", name = "e", descriptor = "(I)Lw;")
    ...
    @OriginalMember(owner = "client!c", name = "o", descriptor = "()Ln;")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lmn;Z)Laa;")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lfq;Z)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lfq;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Llo;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "([Lka;Lfq;Ln;[Lst;I)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "([Lka;Ln;[Lst;I)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIIIF)Lbe;")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lnd;IIII)Lka;")
    ...
    @OriginalMember(owner = "client!c", name = "<init>", descriptor = "(ILjava/awt/Canvas;Ll;Ldq;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lju;[Lmn;Z)Lba;")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Llo;Llo;FLlo;)Llo;")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(I[Lbe;)V")
