...
public class class124 {
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lya;IILc;III[[[B[I[I[I[I[IIBIIZ)V")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IILod;III)Ljava/awt/Frame;")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(II)Lsd;")
    ...
    @OriginalMember(owner = "client!r", name = "<init>", descriptor = "(Lee;ILul;)V")
