...
public class class124 implements class257 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Z)Lg;", line = 5)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(B)V", line = 435)
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "(I)V", line = 465)
    public class124(int arg0) {
        this.field1497 = arg0;
    }

    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(I)V", line = 476)
