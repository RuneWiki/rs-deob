...
public class class124 extends class766 {
    ...
    @OriginalMember(owner = "client!bk", name = "b", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(II[I)V", line = 19)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(B)V", line = 175)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(II)V", line = 378)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 393)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IIIIF)V", line = 422)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(I)V", line = 541)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IIII)V", line = 551)
    ...
    @OriginalMember(owner = "client!bk", name = "b", descriptor = "(II)V", line = 563)
    ...
    @OriginalMember(owner = "client!bk", name = "<init>", descriptor = "(Lsl;IIIII)V", line = 594)
