...
public class class124 extends class585 {
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(Ljk;ZFLjk;)Z")
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(I)Ljk;")
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "(Lno;I)V")
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(IILoa;I)V")
