...
public class class124 extends class424 {
    ...
    @OriginalMember(owner = "client!hr", name = "g", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!hr", name = "d", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!hr", name = "h", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(Z)V", line = 60)
    ...
    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "()V", line = 214)
    public class124() {
        super(1, false);
    }

    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IZ)[[I", line = 145)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lrg;BI)V", line = 218)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(IB)[I", line = 259)
