...
public class class124 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(ZLjl;)V", line = 13)
    ...
    @OriginalMember(owner = "client!jl", name = "b", descriptor = "(I)Ljl;", line = 35)
    ...
    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(I)V", line = 64)
    public class124(int arg0) {
        this.field1730 = arg0;
    }

    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(IIIIII)V", line = 72)
