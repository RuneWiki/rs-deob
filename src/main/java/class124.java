...
public class class124 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(II[I)Lua;")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "([IIII)Lua;")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(II[II)Lua;")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(I[IB)Lua;")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lco;")
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "(Lct;Lct;)V")
