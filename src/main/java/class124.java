...
public class class124 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(I)Ljava/io/File;", line = 9)
    ...
    @OriginalMember(owner = "client!fn", name = "b", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "([BIII)V", line = 38)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;I)Z", line = 59)
    ...
    @OriginalMember(owner = "client!fn", name = "c", descriptor = "(I)J", line = 124)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(JB)V", line = 135)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(BII[B)I", line = 149)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(IBI)I", line = 166)
    ...
    @OriginalMember(owner = "client!fn", name = "finalize", descriptor = "()V", line = 196)
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "(Ljava/io/File;Ljava/lang/String;J)V", line = 209)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Z)V", line = 242)
