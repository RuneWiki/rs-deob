...
public class class124 extends class596 implements class636 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;")
    public final IDirect3DBaseTexture method978(byte arg0) {
        return arg0 == -127 ? this.field1908 : (IDirect3DBaseTexture) null;
    }

    @OriginalMember(owner = "client!ut", name = "<init>", descriptor = "(Llt;Lkca;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!ut", name = "<init>", descriptor = "(Llt;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Lqt;I)V")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(IIIIILkca;Z[BI)V")
    ...
    @OriginalMember(owner = "client!ut", name = "<init>", descriptor = "(Llt;Lkca;Lti;II)V")
