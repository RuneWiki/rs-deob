...
public class class124 extends class677 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(ILjava/awt/Canvas;BI)V", line = 8)
    ...
    @OriginalMember(owner = "client!bba", name = "b", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(IIIILjava/awt/Graphics;III)V", line = 48)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(BIIII)V", line = 67)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(II)I", line = 86)
    ...
    @OriginalMember(owner = "client!bba", name = "c", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!bba", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 121)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field1622;
    }

    @OriginalMember(owner = "client!bba", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 129)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(B)V", line = 140)
    ...
    @OriginalMember(owner = "client!bba", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 153)
    ...
    @OriginalMember(owner = "client!bba", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 169)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field1609;
        return this.field1616 == arg0;
    }

    @OriginalMember(owner = "client!bba", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 185)
    public final void startProduction(ImageConsumer arg0) {
        ++field1621;
        this.addConsumer(arg0);
    }

    @OriginalMember(owner = "client!bba", name = "b", descriptor = "(II)Z", line = 193)
