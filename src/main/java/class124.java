...
public class class124 extends class503 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IIIB[Lts;IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(ZZ)V", line = 663)
    public final void method625(boolean arg0, boolean arg1) {
        super.field7679.method2919(7681, 8448, arg0);
        ++field1609;
    }

    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IBLtu;)V", line = 672)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(ZI)V", line = 684)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(B)Z", line = 711)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Z)V", line = 724)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IIILjava/lang/Class;)Ljo;", line = 737)
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Lrl;)V", line = 795)
    ...
    @OriginalMember(owner = "client!vb", name = "b", descriptor = "(B)V", line = 765)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(III)V", line = 838)
