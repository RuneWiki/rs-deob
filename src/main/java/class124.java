...
public class class124 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(II)I", line = 8)
    public static final int method785(int arg0, int arg1) {
        return class187.field2443 == null ? 0 : (class187.field2443[arg0][arg1] & 0xFF) << 3;
    }

    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(I[Ljava/lang/String;)[Ljava/lang/String;", line = 21)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(II)I", line = 45)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IIIILus;)V", line = 64)
