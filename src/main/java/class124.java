...
public class class124 {
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(II)Lfba;", line = 5)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(ILvl;)V", line = 33)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(I)V", line = 76)
