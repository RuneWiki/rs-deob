...
public abstract class class124 extends class223 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(Z)F", line = 21)
    ...
    @OriginalMember(owner = "client!vp", name = "c", descriptor = "(Z)I", line = 35)
    public final int method980(boolean arg0) {
        field1816++;
        return arg0 ? -94 : this.field1812;
    }

    @OriginalMember(owner = "client!vp", name = "c", descriptor = "(B)I", line = 47)
    public final int method981(byte arg0) {
        field1815++;
        return arg0 == 27 ? this.field1819 : 4;
    }

    @OriginalMember(owner = "client!vp", name = "d", descriptor = "(B)I", line = 60)
    public final int method982(byte arg0) {
        field1817++;
        return arg0 > -108 ? -110 : this.field1809;
    }

    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "(IIIIIF)V", line = 80)
    ...
    @OriginalMember(owner = "client!vp", name = "e", descriptor = "(B)I", line = 93)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(I)I", line = 104)
