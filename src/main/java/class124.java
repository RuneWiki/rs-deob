...
public class class124 extends class509 {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(BILin;)V")
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(III)Lso;")
    ...
    @OriginalMember(owner = "client!ih", name = "<init>", descriptor = "(Ltt;Lmm;)V")
