...
public class class124 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ZIIIII)V", line = 49)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(III)Lsw;", line = 170)
