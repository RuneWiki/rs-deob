...
public class class124 extends class278 {
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!op", name = "g", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "()V", line = 149)
    public class124() {
        super(0, true);
    }

    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Llh;II)V", line = 153)
    ...
    @OriginalMember(owner = "client!op", name = "d", descriptor = "(I)V", line = 243)
