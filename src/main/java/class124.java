...
public class class124 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Ljava/awt/Canvas;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(BILjc;)V", line = 21)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(BLjc;)V", line = 57)
