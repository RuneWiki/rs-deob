...
public class class124 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(BZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Z)V", line = 49)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ILo;)V", line = 59)
