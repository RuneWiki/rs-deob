...
public class class124 {
    ...
    @OriginalMember(owner = "client!ig", name = "finalize", descriptor = "()V", line = 8)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(III)Llba;", line = 19)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(II[Lis;)V", line = 43)
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(Lad;J[Lsk;)V", line = 137)
