...
public class class124 extends class37 implements class338 {
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!op", name = "c", descriptor = "(I)I", line = 39)
    ...
    @OriginalMember(owner = "client!op", name = "d", descriptor = "(I)Z", line = 51)
    public final boolean method338(int arg0) {
        field1832++;
        return arg0 >= -8 ? false : false;
    }

    @OriginalMember(owner = "client!op", name = "a", descriptor = "([Ljava/lang/Object;B[J)V", line = 62)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ILqa;)V", line = 75)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(II[FIIII)V", line = 87)
    ...
    @OriginalMember(owner = "client!op", name = "e", descriptor = "(B)V", line = 185)
    ...
    @OriginalMember(owner = "client!op", name = "g", descriptor = "(I)Lof;", line = 197)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IILqa;Leq;IIZ)V", line = 217)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(I)I", line = 227)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(ILqa;)Lfm;", line = 239)
    ...
    @OriginalMember(owner = "client!op", name = "h", descriptor = "(I)V", line = 251)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lvp;", line = 316)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(I)V", line = 335)
    public final void method342(int arg0) {
        int var2 = -80 / ((56 - arg0) / 52);
        field1815++;
    }

    @OriginalMember(owner = "client!op", name = "b", descriptor = "(B)Z", line = 347)
    ...
    @OriginalMember(owner = "client!op", name = "c", descriptor = "(B)I", line = 360)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Lqa;I)V", line = 371)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(IIIIIIIIIILdm;)V", line = 390)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Lqa;Z)V", line = 401)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IILqa;I)Z", line = 411)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(BLqa;I)Lc;", line = 422)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Z)V", line = 433)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(B)I", line = 443)
