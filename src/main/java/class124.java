...
public class class124 extends class324 {
    ...
    @OriginalMember(owner = "client!lfa", name = "e", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!lfa", name = "d", descriptor = "(I)Ljava/lang/Object;", line = 16)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(I)Z", line = 27)
    ...
    @OriginalMember(owner = "client!lfa", name = "e", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!lfa", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 50)
    public class124(Object arg0, int arg1) {
        super(arg1);
        this.field1927 = arg0;
    }

    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(III)Z", line = 66)
