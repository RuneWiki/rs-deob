...
public class class124 extends class398 {
    ...
    @OriginalMember(owner = "client!nq", name = "h", descriptor = "(I)Lqn;")
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(IIZZI)Lmj;")
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Lnj;II)V")
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Lic;)V")
