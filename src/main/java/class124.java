...
public class class124 {
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(III)I", line = 7)
    ...
    @OriginalMember(owner = "client!bm", name = "b", descriptor = "(III)Z", line = 35)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Lha;IB)Z", line = 51)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(I)V", line = 500)
