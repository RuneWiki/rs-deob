...
public class class124 extends class243 {
    ...
    @OriginalMember(owner = "client!ej", name = "c", descriptor = "(I)Lgga;", line = 4)
    ...
    @OriginalMember(owner = "client!ej", name = "d", descriptor = "(III)I", line = 16)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(II)[I", line = 40)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Z)V", line = 73)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(BI)Lvg;", line = 88)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IBI)I", line = 115)
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "()V", line = 131)
    public class124() {
        super(0, true);
    }
}
