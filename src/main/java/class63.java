...
public class class63 {
    ...
    @OriginalMember(owner = "client!nv", name = "toString", descriptor = "()Ljava/lang/String;", line = 5)
    public final String toString() {
        field801++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(BC)B", line = 30)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(I)V", line = 159)
    ...
    @OriginalMember(owner = "client!nv", name = "<init>", descriptor = "(II)V", line = 170)
