...
public class class63 extends class251 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Lbe;IIILwn;BILjava/lang/String;Ltq;Lpm;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "([B)V", line = 55)
    public class63(byte[] arg0) {
        this.field1049 = arg0;
    }

    @OriginalMember(owner = "client!hk", name = "f", descriptor = "(I)V", line = 63)
