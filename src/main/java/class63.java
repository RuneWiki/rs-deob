...
public class class63 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(III)Z", line = 95)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Lhp;II)V", line = 105)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(BLhp;)V", line = 177)
