...
@OriginalClass("client!XPEMEMUL")
public class class63 extends class14 {

    @OriginalMember(owner = "client!XPEMEMUL", name = "j", descriptor = "I")
    public int field1593 = 1000;

    @OriginalMember(owner = "client!XPEMEMUL", name = "k", descriptor = "Z")
    public static boolean field1594;

    @OriginalMember(owner = "client!XPEMEMUL", name = "i", descriptor = "[LXKISFGSQ;")
    public class61[] field1592;

    @OriginalMember(owner = "client!XPEMEMUL", name = "a", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!XPEMEMUL", name = "a", descriptor = "(I)LKPUOCBCE;")
