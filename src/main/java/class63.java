...
public class class63 extends class33 implements class55 {
    ...
    @OriginalMember(owner = "client!qu", name = "<init>", descriptor = "(IIIIIIIIIILbt;)V", line = 5)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IILco;ILqa;ZZ)V", line = 16)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(I)I", line = 26)
    public final int method355(int arg0) {
        field865++;
        return arg0 == 13599 ? 0 : -128;
    }

    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IILqa;)Lc;", line = 39)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(BLvh;Lsf;Lvh;Lvh;)Z", line = 50)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(II)I", line = 67)
    public static int method396(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(ILss;B)I", line = 78)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(B)I", line = 94)
    public final int method359(byte arg0) {
        field860++;
        return arg0 == -8 ? 0 : -103;
    }

    @OriginalMember(owner = "client!qu", name = "e", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(ILqa;)V", line = 117)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(Z)Z", line = 130)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(ILqa;)V", line = 142)
    ...
    @OriginalMember(owner = "client!qu", name = "f", descriptor = "(I)I", line = 154)
    ...
    @OriginalMember(owner = "client!qu", name = "c", descriptor = "(ILqa;)V", line = 165)
    public final void method400(int arg0, class162 arg1) {
        int var3 = 4 / ((-arg0 - 29) / 33);
        field854++;
    }

    @OriginalMember(owner = "client!qu", name = "i", descriptor = "(I)V", line = 174)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(I)Z", line = 187)
    public final boolean method360(int arg0) {
        field856++;
        return arg0 < 34 ? false : false;
    }

    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(B)I", line = 198)
    ...
    @OriginalMember(owner = "client!qu", name = "c", descriptor = "(I)V", line = 208)
    public final void method361(int arg0) {
        field853++;
        int var2 = -78 / ((arg0 + 36) / 36);
    }

    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(Lqa;I)Lip;", line = 217)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(Lqa;III)Z", line = 228)
