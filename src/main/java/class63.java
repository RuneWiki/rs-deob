...
public class class63 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(II)V", line = 146)
    ...
    @OriginalMember(owner = "client!ej", name = "b", descriptor = "(I)V", line = 198)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(ILqr;IILvq;III)V", line = 222)
