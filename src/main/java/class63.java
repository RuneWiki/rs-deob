...
public class class63 extends class627 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Lmb;)V", line = 3)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Lcca;Lcca;B)V", line = 22)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(B)V", line = 62)
