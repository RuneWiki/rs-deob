...
public class class63 extends class260 {
    ...
    @OriginalMember(owner = "client!ps", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(BIIIIII)V", line = 32)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(B)V", line = 53)
    public static void method514(byte arg0) {
        field790 = null;
        int var1 = -128 / ((arg0 + 50) / 50);
    }

    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Ljava/awt/Component;I)Ltj;", line = 63)
