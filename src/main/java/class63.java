...
public class class63 {
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Ltd;Z)Lhu;")
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(IBLfb;I)V")
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(ILtga;)Z")
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(III)Lmea;")
