...
public class class63 {
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(Lcr;III)V", line = 4)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(II)I", line = 40)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IIIII)Z", line = 53)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IIZ)Z", line = 77)
