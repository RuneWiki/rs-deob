...
public class class63 {
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lja;)V")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(B)Lln;")
    ...
    @OriginalMember(owner = "client!r", name = "<init>", descriptor = "(Lum;II)V")
