...
public class class63 extends class439 {
    ...
    @OriginalMember(owner = "client!qu", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(III)V", line = 14)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(II)I", line = 30)
