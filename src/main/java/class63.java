...
public class class63 {
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(Z[B)Lf;", line = 14)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(B)V", line = 87)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(Luca;I)V", line = 118)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(ILuca;)Z", line = 135)
    ...
    @OriginalMember(owner = "client!pv", name = "b", descriptor = "(B)Z", line = 172)
    ...
    @OriginalMember(owner = "client!pv", name = "b", descriptor = "(Z)V", line = 184)
    ...
    @OriginalMember(owner = "client!pv", name = "c", descriptor = "(B)V", line = 255)
    ...
    @OriginalMember(owner = "client!pv", name = "<init>", descriptor = "(Llj;)V", line = 799)
    ...
    @OriginalMember(owner = "client!pv", name = "c", descriptor = "(Z)V", line = 374)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(IZLjava/lang/Object;I)[B", line = 465)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(IIIIB)Z", line = 497)
    ...
    @OriginalMember(owner = "client!pv", name = "b", descriptor = "(I)Z", line = 542)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(II)Lgo;", line = 673)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(IIFBI[FFIIII)V", line = 696)
