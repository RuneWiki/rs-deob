...
public class class63 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(B)Lki;")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(II)Lsd;")
    public final class63 method505(int arg0, int arg1) {
        field799++;
        return arg0 == 6530 ? new class63(this.field796, arg1) : null;
    }

    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ZILhm;)Ljava/lang/String;")
