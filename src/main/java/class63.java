...
public class class63 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(I[SII[Ljava/lang/String;)V", line = 28)
    ...
    @OriginalMember(owner = "client!sd", name = "toString", descriptor = "()Ljava/lang/String;", line = 84)
    public final String toString() {
        field728++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIIIIIII)V", line = 93)
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "(IIII)V", line = 264)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIZ)V", line = 275)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IB)Lu;", line = 291)
