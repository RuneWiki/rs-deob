...
public class class63 extends class17 implements class285 {
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(Lvm;Lds;IIIIIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Lor;III)V")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IILja;Z)V")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IIILvm;)Z")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(BLvm;)V")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Lvm;II)Ljn;")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Lvm;I)V")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(ZIIILai;ILvm;)V")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Lvm;Z)Ldn;")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(ZLvm;)V")
