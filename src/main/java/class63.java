...
public class class63 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Lol;IIIII)V", line = 38)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(B)V", line = 95)
