...
public class class63 {
    ...
    @OriginalMember(owner = "client!r", name = "b", descriptor = "(I)Lnj;", line = 20)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IIII)V", line = 71)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IIII[Lps;IIIII)V", line = 85)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(ZLlm;)V", line = 1144)
