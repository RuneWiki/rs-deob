...
public class class63 {
    ...
    @OriginalMember(owner = "client!mia", name = "toString", descriptor = "()Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(ILjava/lang/String;)V", line = 41)
    public final void method575(int arg0, String arg1) {
        field880++;
        this.method576(91, arg1, this.field884 + arg0);
    }

    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 56)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(I)I", line = 76)
    ...
    @OriginalMember(owner = "client!mia", name = "<init>", descriptor = "(IZ)V", line = 172)
    public class63(int arg0, boolean arg1) {
        this.field883 = arg1;
        this.field876 = arg0;
    }

    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(II)I", line = 90)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(III)Z", line = 120)
    ...
    @OriginalMember(owner = "client!mia", name = "b", descriptor = "(II)V", line = 131)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(B)[Ljava/lang/String;", line = 145)
