...
@OriginalClass("client!UYLUCQNM")
public class class63 {

    @OriginalMember(owner = "client!UYLUCQNM", name = "a", descriptor = "I")
    private int field1586 = -247;

    @OriginalMember(owner = "client!UYLUCQNM", name = "f", descriptor = "I")
    public int field1591 = -1;

    @OriginalMember(owner = "client!UYLUCQNM", name = "h", descriptor = "[I")
    public int[] field1593 = new int[6];

    @OriginalMember(owner = "client!UYLUCQNM", name = "i", descriptor = "[I")
    public int[] field1594 = new int[6];

    @OriginalMember(owner = "client!UYLUCQNM", name = "j", descriptor = "I")
    public int field1595 = 128;

    @OriginalMember(owner = "client!UYLUCQNM", name = "k", descriptor = "I")
    public int field1596 = 128;

    @OriginalMember(owner = "client!UYLUCQNM", name = "o", descriptor = "LASORKPAH;")
    public static class2 field1600 = new class2(48975, 30);

    @OriginalMember(owner = "client!UYLUCQNM", name = "b", descriptor = "I")
    public static int field1587;

    @OriginalMember(owner = "client!UYLUCQNM", name = "d", descriptor = "I")
    public int field1589;

    @OriginalMember(owner = "client!UYLUCQNM", name = "e", descriptor = "I")
    public int field1590;

    @OriginalMember(owner = "client!UYLUCQNM", name = "l", descriptor = "I")
    public int field1597;

    @OriginalMember(owner = "client!UYLUCQNM", name = "m", descriptor = "I")
    public int field1598;

    @OriginalMember(owner = "client!UYLUCQNM", name = "n", descriptor = "I")
    public int field1599;

    @OriginalMember(owner = "client!UYLUCQNM", name = "g", descriptor = "LKIRTNGZJ;")
    public class39 field1592;

    @OriginalMember(owner = "client!UYLUCQNM", name = "c", descriptor = "[LUYLUCQNM;")
    public static class63[] field1588;

    @OriginalMember(owner = "client!UYLUCQNM", name = "a", descriptor = "(ZLEAXVDNXA;)V")
    ...
    @OriginalMember(owner = "client!UYLUCQNM", name = "a", descriptor = "(BLCKBTFRZM;)V")
    ...
    @OriginalMember(owner = "client!UYLUCQNM", name = "a", descriptor = "()LGFYXEFQY;")
