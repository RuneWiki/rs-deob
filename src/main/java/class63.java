...
public class class63 extends class183 implements class116 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(III)Lv;", line = 10)
    ...
    @OriginalMember(owner = "client!f", name = "h", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IZZ)V", line = 31)
    ...
    @OriginalMember(owner = "client!f", name = "b", descriptor = "(B)I", line = 96)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(B)I", line = 108)
    public final int method26(byte arg0) {
        ++field789;
        return arg0 != 73 ? 4 : this.field776.field1341;
    }

    @OriginalMember(owner = "client!f", name = "c", descriptor = "(ILoj;)Lmg;", line = 120)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 159)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ILoj;B)Lqh;", line = 209)
    ...
    @OriginalMember(owner = "client!f", name = "g", descriptor = "(I)I", line = 221)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Z)I", line = 232)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ILoj;)V", line = 246)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ILoj;II)Z", line = 258)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(I)V", line = 277)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ICI)I", line = 287)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IIIIZ[Lab;)V", line = 312)
    ...
    @OriginalMember(owner = "client!f", name = "<init>", descriptor = "(Loj;Lcu;IIIIIZIIIIII)V", line = 360)
    ...
    @OriginalMember(owner = "client!f", name = "b", descriptor = "(I)Z", line = 370)
    ...
    @OriginalMember(owner = "client!f", name = "b", descriptor = "(ILoj;)V", line = 382)
    ...
    @OriginalMember(owner = "client!f", name = "d", descriptor = "(ILoj;)V", line = 396)
