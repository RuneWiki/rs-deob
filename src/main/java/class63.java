...
public class class63 {
    ...
    @OriginalMember(owner = "client!mia", name = "toString", descriptor = "()Ljava/lang/String;", line = 5)
    public final String toString() {
        field912++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!mia", name = "b", descriptor = "(B)I", line = 54)
    ...
    @OriginalMember(owner = "client!mia", name = "<init>", descriptor = "(II)V", line = 71)
