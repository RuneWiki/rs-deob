...
public class class63 {
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(Loc;BZILoc;)Lsl;", line = 3)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(Lqa;Ler;III)V", line = 43)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(I)Z", line = 125)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 155)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(FFFFFILuv;IZII)[B", line = 192)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IILoc;Loc;)Lsl;", line = 210)
    ...
    @OriginalMember(owner = "client!qu", name = "<init>", descriptor = "(Lbd;Lkf;)V", line = 224)
