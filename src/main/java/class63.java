...
public class class63 {
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 40)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IZ)V", line = 51)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(II)V", line = 66)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Z)V", line = 102)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(II)V", line = 125)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(III)Z", line = 143)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ILr;IIILfa;I)V", line = 155)
    ...
    @OriginalMember(owner = "client!nv", name = "c", descriptor = "(II)Lpw;", line = 237)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(IZ)Ljava/lang/String;", line = 272)
    ...
    @OriginalMember(owner = "client!nv", name = "c", descriptor = "(I)V", line = 300)
    ...
    @OriginalMember(owner = "client!nv", name = "<init>", descriptor = "(Lqh;IZLtf;Ltf;)V", line = 350)
    ...
    @OriginalMember(owner = "client!nv", name = "d", descriptor = "(II)Lgu;", line = 327)
