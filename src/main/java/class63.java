...
public abstract class class63 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lgda;IILjava/awt/Canvas;Ld;III)Lha;", line = 11)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(II[Ljava/awt/Rectangle;)V", line = 53)
    ...
    @OriginalMember(owner = "client!ha", name = "e", descriptor = "(IIIIII)V", line = 72)
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(IIIII)V", line = 116)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIII)V", line = 132)
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(Z)V", line = 143)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIIII)V", line = 154)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IBIII)V", line = 165)
    ...
    @OriginalMember(owner = "client!ha", name = "finalize", descriptor = "()V", line = 181)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Z)[Lwh;", line = 215)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIIIZ)V", line = 239)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIII[II)Lhk;", line = 250)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(B)V", line = 275)
    ...
    @OriginalMember(owner = "client!ha", name = "<init>", descriptor = "(Ld;)V", line = 293)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(BLhk;)V", line = 337)
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(I)V", line = 360)
