...
public class class63 {
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Lha;[II[I[I)V", line = 49)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Lha;[IIII[I[I)V", line = 104)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "()V", line = 143)
    public static void method476() {
        field645 = null;
    }

    @OriginalMember(owner = "client!qn", name = "a", descriptor = "([III)V", line = 149)
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(I)Z", line = 200)
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "()V", line = 276)
    private static final void method479() {
        field644 = 0;
    }

    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(II)V", line = 279)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Lha;[II)V", line = 317)
