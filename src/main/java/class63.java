...
public class class63 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "()V", line = 9)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IIB)Z", line = 22)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IZ)V", line = 74)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IB)Lmi;", line = 184)
