...
public class class63 extends class96 {
    ...
    @OriginalMember(owner = "client!fg", name = "d", descriptor = "(I)Lmh;")
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(IZLica;)V")
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "(Lml;)V")
