...
public class class63 {
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Lou;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(IIIII)V", line = 38)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(IZ)Z", line = 62)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(II)I", line = 80)
