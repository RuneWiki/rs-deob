...
public class class63 {
    ...
    @OriginalMember(owner = "client!VSVAEWAC", name = "h", descriptor = "[LGJBKSAZL;")
    private class25[] field1598 = new class25[10];

    @OriginalMember(owner = "client!VSVAEWAC", name = "d", descriptor = "[LVSVAEWAC;")
    ...
    @OriginalMember(owner = "client!VSVAEWAC", name = "g", descriptor = "LCFARFRSG;")
    ...
    @OriginalMember(owner = "client!VSVAEWAC", name = "a", descriptor = "(LCFARFRSG;I)V")
    ...
    @OriginalMember(owner = "client!VSVAEWAC", name = "a", descriptor = "(III)LCFARFRSG;")
    ...
    @OriginalMember(owner = "client!VSVAEWAC", name = "b", descriptor = "(LCFARFRSG;I)V")
    ...
    @OriginalMember(owner = "client!VSVAEWAC", name = "a", descriptor = "(II)LCFARFRSG;")
