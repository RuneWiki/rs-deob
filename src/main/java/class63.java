...
public class class63 extends class539 {
    ...
    @OriginalMember(owner = "client!pv", name = "b", descriptor = "(Z)V", line = 76)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(Ltt;IILjr;)V", line = 91)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(B)V", line = 214)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "([IZLme;[B)Z", line = 384)
    ...
    @OriginalMember(owner = "client!pv", name = "b", descriptor = "(B)V", line = 445)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(IIIII)V", line = 456)
    ...
    @OriginalMember(owner = "client!pv", name = "<init>", descriptor = "()V", line = 472)
    public class63() {
    }

    @OriginalMember(owner = "client!pv", name = "<init>", descriptor = "([B)V", line = 474)
