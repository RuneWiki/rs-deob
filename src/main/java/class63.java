...
public class class63 {
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "([I)V", line = 34)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Luq;I)V", line = 75)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Z)V", line = 93)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(III)I", line = 103)
