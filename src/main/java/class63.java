...
public class class63 {
    ...
    @OriginalMember(owner = "client!gea", name = "b", descriptor = "(I)Luk;")
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(BLuk;)V")
    ...
    @OriginalMember(owner = "client!gea", name = "c", descriptor = "(I)Luk;")
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(ZZLl;I)V")
