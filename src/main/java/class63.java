...
public class class63 {
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(II)[I", line = 16)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(III)I", line = 297)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "()V", line = 340)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(Lmo;)V", line = 351)
