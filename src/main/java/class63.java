...
public class class63 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(IZLgi;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(BIII[[ZZ)V", line = 76)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Lgi;IBI)V", line = 263)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(II[BIII[BII)V", line = 335)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(IIII[BII)Z", line = 378)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(IIIBI)V", line = 424)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(III[BIIII[B)V", line = 460)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(IBLgi;I)Z", line = 504)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(Lh;Lef;)V", line = 576)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(I)V", line = 592)
