...
public class class63 {
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(IBLes;)V", line = 15)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(II)I", line = 103)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(BLes;)V", line = 124)
    ...
    @OriginalMember(owner = "client!fw", name = "b", descriptor = "(I)V", line = 146)
