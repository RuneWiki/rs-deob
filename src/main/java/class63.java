...
public abstract class class63 extends class43 {
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(BILha;Lgs;ZII)V")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Lud;Z)Lgu;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "([Lbh;I)I")
