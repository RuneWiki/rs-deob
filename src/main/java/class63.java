...
public class class63 {
    ...
    @OriginalMember(owner = "client!YGUBUIIU", name = "c", descriptor = "LKWULTEKW;")
    public class28 field1658 = new class28();

    @OriginalMember(owner = "client!YGUBUIIU", name = "d", descriptor = "LKWULTEKW;")
    ...
    @OriginalMember(owner = "client!YGUBUIIU", name = "a", descriptor = "(LKWULTEKW;)V")
    ...
    @OriginalMember(owner = "client!YGUBUIIU", name = "a", descriptor = "()LKWULTEKW;")
    ...
    @OriginalMember(owner = "client!YGUBUIIU", name = "b", descriptor = "()LKWULTEKW;")
    ...
    @OriginalMember(owner = "client!YGUBUIIU", name = "a", descriptor = "(I)LKWULTEKW;")
