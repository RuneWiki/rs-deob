...
public class class63 {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Ltl;I)Lot;", line = 6)
    ...
    @OriginalMember(owner = "client!ud", name = "toString", descriptor = "()Ljava/lang/String;", line = 23)
    public final String toString() {
        field890++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 36)
