...
public class class63 extends class513 implements class233 {
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Lod;III)V")
    ...
    @OriginalMember(owner = "client!fw", name = "<init>", descriptor = "(Lhk;III)V")
    ...
    @OriginalMember(owner = "client!fw", name = "<init>", descriptor = "(Lhk;IIII)V")
