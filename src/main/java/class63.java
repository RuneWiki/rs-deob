...
@OriginalClass("client!XWKFKQRL")
public class class63 {

    @OriginalMember(owner = "client!XWKFKQRL", name = "a", descriptor = "Z")
    private boolean field1521 = true;

    @OriginalMember(owner = "client!XWKFKQRL", name = "b", descriptor = "I")
    private int field1522 = 798;

    @OriginalMember(owner = "client!XWKFKQRL", name = "d", descriptor = "I")
    private int field1524 = 3;

    @OriginalMember(owner = "client!XWKFKQRL", name = "e", descriptor = "LJJFDBATQ;")
    public class30 field1525 = new class30();

    @OriginalMember(owner = "client!XWKFKQRL", name = "c", descriptor = "I")
    private int field1523;

    @OriginalMember(owner = "client!XWKFKQRL", name = "f", descriptor = "LJJFDBATQ;")
    private class30 field1526;

    @OriginalMember(owner = "client!XWKFKQRL", name = "<init>", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!XWKFKQRL", name = "a", descriptor = "(LJJFDBATQ;)V")
    ...
    @OriginalMember(owner = "client!XWKFKQRL", name = "a", descriptor = "()LJJFDBATQ;")
    ...
    @OriginalMember(owner = "client!XWKFKQRL", name = "b", descriptor = "()LJJFDBATQ;")
    ...
    @OriginalMember(owner = "client!XWKFKQRL", name = "a", descriptor = "(Z)LJJFDBATQ;")
