...
public class class63 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ZIIZIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIIIIIIB)Z", line = 85)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(III)V", line = 273)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(II)V", line = 291)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(BII)V", line = 304)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ZIZIIII)V", line = 322)
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(B)V", line = 626)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IBII)V", line = 657)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIIIIBII)Z", line = 670)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIII)V", line = 1032)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Ljava/awt/Component;I)Ltu;", line = 1044)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ZIIIIIZ)V", line = 1055)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIIIIIIIII)Z", line = 1375)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIIIIIII)V", line = 1468)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIIZZIII)V", line = 1520)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IZI)V", line = 1573)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIIZIIIII)Z", line = 1599)
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(III)V", line = 1674)
