...
public class class63 {
    ...
    @OriginalMember(owner = "client!WDDURNZH", name = "e", descriptor = "[LWDDURNZH;")
    public static class63[] field1576;

    @OriginalMember(owner = "client!WDDURNZH", name = "a", descriptor = "(ILSPZBTZXL;)V")
    ...
    @OriginalMember(owner = "client!WDDURNZH", name = "a", descriptor = "(LLDILQFVA;I)V")
