...
public class class63 extends class381 {
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lpe;Lhh;III)V", line = 97)
    ...
    @OriginalMember(owner = "client!r", name = "c", descriptor = "(B)V", line = 151)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(ILrk;Lrk;)V", line = 164)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(BLap;)V", line = 180)
    ...
    @OriginalMember(owner = "client!r", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIJII)V", line = 217)
