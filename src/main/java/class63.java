...
public class class63 extends class396 {
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IIIBLbb;IZILen;IIIIILmj;)Lmj;", line = 3)
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "(Ldr;)V", line = 223)
    public class63(class426 arg0) {
        this.field724 = arg0;
    }

    @OriginalMember(owner = "client!ej", name = "d", descriptor = "(I)V", line = 232)
