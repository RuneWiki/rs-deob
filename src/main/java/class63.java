...
public class class63 {
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(IB)Z", line = 15)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!naa", name = "b", descriptor = "(I)V", line = 39)
