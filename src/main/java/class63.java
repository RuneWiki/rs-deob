...
public class class63 {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(I)Lie;", line = 3)
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(I)I", line = 23)
    ...
    @OriginalMember(owner = "client!ps", name = "c", descriptor = "(I)Lie;", line = 48)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ILie;)V", line = 66)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(III)Z", line = 86)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Z)Lie;", line = 132)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Lps;B)V", line = 157)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(BLie;)V", line = 174)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "()V", line = 242)
    public class63() {
        this.field906.field39 = this.field906;
        this.field906.field36 = this.field906;
    }

    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(B)V", line = 194)
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(Z)Z", line = 206)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Lie;ILps;)V", line = 217)
    ...
    @OriginalMember(owner = "client!ps", name = "d", descriptor = "(I)Lie;", line = 254)
    ...
    @OriginalMember(owner = "client!ps", name = "c", descriptor = "(B)Lie;", line = 279)
    ...
    @OriginalMember(owner = "client!ps", name = "d", descriptor = "(B)J", line = 298)
