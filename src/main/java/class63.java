...
@OriginalClass("client!XSQWUDHM")
public class class63 {

    @OriginalMember(owner = "client!XSQWUDHM", name = "a", descriptor = "Z")
    private boolean field1555 = false;

    @OriginalMember(owner = "client!XSQWUDHM", name = "b", descriptor = "I")
    private int field1556 = 1;

    @OriginalMember(owner = "client!XSQWUDHM", name = "c", descriptor = "I")
    private int field1557 = 496;

    @OriginalMember(owner = "client!XSQWUDHM", name = "d", descriptor = "I")
    private int field1558 = 34;

    @OriginalMember(owner = "client!XSQWUDHM", name = "e", descriptor = "Z")
    private boolean field1559 = true;

    @OriginalMember(owner = "client!XSQWUDHM", name = "f", descriptor = "Z")
    private boolean field1560 = false;

    @OriginalMember(owner = "client!XSQWUDHM", name = "g", descriptor = "Z")
    private boolean field1561 = false;

    @OriginalMember(owner = "client!XSQWUDHM", name = "h", descriptor = "Z")
    private boolean field1562 = true;

    @OriginalMember(owner = "client!XSQWUDHM", name = "i", descriptor = "I")
    public int field1563 = 0;

    @OriginalMember(owner = "client!XSQWUDHM", name = "j", descriptor = "I")
    public int field1564 = 0;

    @OriginalMember(owner = "client!XSQWUDHM", name = "k", descriptor = "I")
    public int field1565;

    @OriginalMember(owner = "client!XSQWUDHM", name = "l", descriptor = "I")
    public int field1566;

    @OriginalMember(owner = "client!XSQWUDHM", name = "m", descriptor = "[[I")
    public int[][] field1567;

    @OriginalMember(owner = "client!XSQWUDHM", name = "<init>", descriptor = "(BII)V")
    ...
    @OriginalMember(owner = "client!XSQWUDHM", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!XSQWUDHM", name = "a", descriptor = "(IIZIII)V")
    ...
    @OriginalMember(owner = "client!XSQWUDHM", name = "a", descriptor = "(IIIIIZI)V")
    ...
    @OriginalMember(owner = "client!XSQWUDHM", name = "a", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!XSQWUDHM", name = "b", descriptor = "(III)V")
    private void method518(int arg0, int arg1, int arg2) {
        this.field1567[arg0][arg1] |= arg2;
    }

    @OriginalMember(owner = "client!XSQWUDHM", name = "a", descriptor = "(IIIIZI)V")
    ...
    @OriginalMember(owner = "client!XSQWUDHM", name = "a", descriptor = "(IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!XSQWUDHM", name = "a", descriptor = "(IIII)V")
    ...
    @OriginalMember(owner = "client!XSQWUDHM", name = "c", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!XSQWUDHM", name = "a", descriptor = "(IIIIIII)Z")
    ...
    @OriginalMember(owner = "client!XSQWUDHM", name = "b", descriptor = "(IIIIIII)Z")
    ...
    @OriginalMember(owner = "client!XSQWUDHM", name = "a", descriptor = "(IIIIIIII)Z")
