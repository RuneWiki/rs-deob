...
public class class63 extends class299 {
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(Lfd;IIIII[BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(Lfd;IIIIZ[BI)V", line = 19)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(Lfd;IIII[I)V", line = 43)
    ...
    @OriginalMember(owner = "client!ps", name = "g", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(Lfd;IIIIIIZ)V", line = 73)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(Lfd;IIIIIZ)V", line = 87)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(Lfd;IIIZ[I)V", line = 113)
