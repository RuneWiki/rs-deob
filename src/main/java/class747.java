...
public abstract class class747 extends class71 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Z)I", line = 3)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Ldc;II)V", line = 16)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(II)[I", line = 27)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(II)[[I", line = 38)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Luu;Ljava/awt/Canvas;IBLd;)Lha;", line = 76)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(B)I", line = 112)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(III)[I", line = 123)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IIB)V", line = 144)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(III)[[I", line = 180)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(I)V", line = 227)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(IZ)V", line = 251)
