...
public class class747 extends class548 {
    ...
    @OriginalMember(owner = "client!dw", name = "<init>", descriptor = "(Llf;Ltf;)V")
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(ZLqba;B)V")
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Lru;II)V")
