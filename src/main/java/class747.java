...
public class class747 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "()[B", line = 5)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(Lrg;)V", line = 128)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "()V", line = 149)
    private class747() {
    }

    @OriginalMember(owner = "client!pn", name = "b", descriptor = "()I", line = 70)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lvd;II)Lpn;", line = 115)
    ...
    @OriginalMember(owner = "client!pn", name = "c", descriptor = "()Lut;", line = 124)
