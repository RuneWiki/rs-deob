...
public class class747 {
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Ltn;IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(I)V", line = 208)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ILka;IIII)Lka;", line = 220)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IIIILka;IIB)Lka;", line = 388)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Ltn;B)V", line = 466)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IIIZ)I", line = 496)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Z)V", line = 621)
