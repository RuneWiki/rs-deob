...
public class class747 extends class437 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 3)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(B)Z", line = 14)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 28)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(II)V", line = 79)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(Lek;Ljava/lang/Object;I)V", line = 145)
    public class747(class510 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field10395 = arg1;
    }

    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(I)V", line = 153)
