...
public class class747 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IILha;Ltfa;IIII)Lufa;")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(III)Ljn;")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Lhl;I[Lon;)Lfg;")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IB)Lsea;")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Lda;ZIIILtfa;Lha;IZILha;Z)Lufa;")
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(Lrga;IZLwba;Lni;Lni;)V")
