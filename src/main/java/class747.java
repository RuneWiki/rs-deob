...
public class class747 {
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(BLtp;)V")
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(IB)Lkj;")
    ...
    @OriginalMember(owner = "client!hda", name = "<init>", descriptor = "(Lnb;ILoh;)V")
