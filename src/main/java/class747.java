...
public class class747 extends class568 {
    ...
    @OriginalMember(owner = "client!lja", name = "b", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(ILwq;)V")
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(III)Lii;")
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(B)Lsf;")
    ...
    @OriginalMember(owner = "client!lja", name = "c", descriptor = "(B)[Lhm;")
    ...
    @OriginalMember(owner = "client!lja", name = "<init>", descriptor = "(ZLtga;)V")
