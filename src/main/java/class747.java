...
public class class747 extends class137 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(ILha;)Lmq;")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V")
    ...
    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
