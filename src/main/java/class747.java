...
public class class747 {
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(BLria;)V")
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(Lwf;B)V")
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(II)I")
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(ILwf;)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(Lwf;BLjava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(Lwf;Ljava/lang/Object;II)V")
