...
public abstract class class747 {
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(Ljava/lang/String;B)J", line = 8)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(BLkn;)Z", line = 31)
    ...
    @OriginalMember(owner = "client!jaa", name = "b", descriptor = "(I)V", line = 45)
