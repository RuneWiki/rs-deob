...
public class class747 extends class227 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ILjava/lang/String;)I", line = 7)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "()V", line = 30)
    public class747() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(IIII)[B", line = 34)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Ljava/lang/String;IZZ)V", line = 47)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IBB)V", line = 1036)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IZLcc;)V", line = 1055)
