...
public class class747 extends class415 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "([Ljava/lang/Object;[JI)V", line = 40)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(ILwm;Lwm;[I)V", line = 52)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(I)V", line = 74)
