...
public class class747 {
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(I)Lkba;", line = 3)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Lkba;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(I)Z", line = 59)
    ...
    @OriginalMember(owner = "client!hda", name = "c", descriptor = "(I)Lkba;", line = 71)
    ...
    @OriginalMember(owner = "client!hda", name = "d", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(B)Lkba;", line = 105)
    ...
    @OriginalMember(owner = "client!hda", name = "e", descriptor = "(I)I", line = 126)
    ...
    @OriginalMember(owner = "client!hda", name = "<init>", descriptor = "()V", line = 201)
    public class747() {
        this.field10447.field1746 = this.field10447;
        this.field10447.field1750 = this.field10447;
    }

    @OriginalMember(owner = "client!hda", name = "f", descriptor = "(I)Lkba;", line = 158)
    ...
    @OriginalMember(owner = "client!hda", name = "c", descriptor = "(B)V", line = 180)
