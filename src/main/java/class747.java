...
public abstract class class747 implements class357 {
    ...
    @OriginalMember(owner = "client!hda", name = "c", descriptor = "(I)I", line = 38)
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(Z)V", line = 135)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(II[BII)V", line = 158)
    ...
    @OriginalMember(owner = "client!hda", name = "d", descriptor = "(I)I", line = 256)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Lha;BZI)Lda;", line = 270)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(II[III)V", line = 291)
    ...
    @OriginalMember(owner = "client!hda", name = "e", descriptor = "(I)V", line = 398)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(IB)V", line = 414)
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "(IB)V", line = 435)
    ...
    @OriginalMember(owner = "client!hda", name = "c", descriptor = "(Z)V", line = 450)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Lria;I)V", line = 463)
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(III[FI)V", line = 480)
    ...
    @OriginalMember(owner = "client!hda", name = "finalize", descriptor = "()V", line = 577)
    ...
    @OriginalMember(owner = "client!hda", name = "<init>", descriptor = "(Lbga;ILwq;Lbaa;IZ)V", line = 601)
