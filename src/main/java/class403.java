...
public class class403 extends class666 {
    ...
    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "()V", line = 564)
    public class403() {
        super(0, true);
    }

    @OriginalMember(owner = "client!os", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IIIII[BII[B)V", line = 24)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(II)[I", line = 72)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(B)V", line = 331)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(II[[IIILjava/util/Random;I)V", line = 352)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(BLiaa;)Llr;", line = 550)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ILiaa;Z)V", line = 568)
