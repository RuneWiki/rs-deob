...
public class class403 extends class233 implements class9 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(B)I", line = 3)
    public final int method71(byte arg0) {
        ++field5782;
        return arg0 > -36 ? 123 : this.field5774.field5820;
    }

    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Ltq;I)V", line = 16)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ILae;)V", line = 36)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Lae;I)V", line = 47)
    ...
    @OriginalMember(owner = "client!fb", name = "c", descriptor = "(I)I", line = 58)
    public final int method68(int arg0) {
        ++field5773;
        return arg0 < 118 ? -26 : this.field5774.field5835;
    }

    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Lae;ZI)Lbk;", line = 75)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IB)Lsr;", line = 91)
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(I)Z", line = 121)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ZBIILna;ILae;)V", line = 132)
    ...
    @OriginalMember(owner = "client!fb", name = "d", descriptor = "(I)I", line = 145)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Lae;B)V", line = 156)
    ...
    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "(Lae;Ljh;IIIIIIIZIIIII)V", line = 172)
    ...
    @OriginalMember(owner = "client!fb", name = "i", descriptor = "(I)V", line = 187)
    ...
    @OriginalMember(owner = "client!fb", name = "j", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!fb", name = "h", descriptor = "(I)I", line = 225)
    public final int method61(int arg0) {
        ++field5776;
        return arg0 != 131910471 ? -5 : this.field5774.method2578(-62);
    }

    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(BLae;)Ljg;", line = 236)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(I)V", line = 274)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Z)Z", line = 290)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ILae;II)Z", line = 302)
