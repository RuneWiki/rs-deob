...
public class class403 implements class46 {
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(III)Lkj;")
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Lr;IIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(B)Lsq;")
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(I)Lom;")
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "(Ljava/lang/String;Lpe;Lop;IIIIIIIIII)V")
