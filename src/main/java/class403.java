...
public class class403 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lgga;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILjava/lang/String;)V", line = 49)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IILgga;)V", line = 69)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(III)Z", line = 86)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(II)I", line = 104)
