...
public class class403 implements class149 {
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(ZBII)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!dw", name = "toString", descriptor = "()Ljava/lang/String;", line = 52)
    public final String toString() {
        field6123++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(I)Lhd;", line = 60)
    ...
    @OriginalMember(owner = "client!dw", name = "b", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!dw", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 109)
