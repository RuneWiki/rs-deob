...
public abstract class class403 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!cr", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 4)
    ...
    @OriginalMember(owner = "client!cr", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 25)
    ...
    @OriginalMember(owner = "client!cr", name = "run", descriptor = "()V", line = 49)
    ...
    @OriginalMember(owner = "client!cr", name = "stop", descriptor = "()V", line = 166)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(II)V", line = 177)
    ...
    @OriginalMember(owner = "client!cr", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 190)
    ...
    @OriginalMember(owner = "client!cr", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 204)
    public final void windowDeactivated(WindowEvent arg0) {
        field5918++;
    }

    @OriginalMember(owner = "client!cr", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 212)
    public final void update(Graphics arg0) {
        field5939++;
        this.paint(arg0);
    }

    @OriginalMember(owner = "client!cr", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 225)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ILjava/lang/String;)V", line = 241)
    ...
    @OriginalMember(owner = "client!cr", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 268)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 284)
    ...
    @OriginalMember(owner = "client!cr", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 311)
    public final void windowDeiconified(WindowEvent arg0) {
        field5905++;
    }

    @OriginalMember(owner = "client!cr", name = "d", descriptor = "(I)V", line = 318)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ZB)V", line = 367)
    ...
    @OriginalMember(owner = "client!cr", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 444)
    public final void windowIconified(WindowEvent arg0) {
        field5933++;
    }

    @OriginalMember(owner = "client!cr", name = "e", descriptor = "(I)V", line = 453)
    ...
    @OriginalMember(owner = "client!cr", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 462)
    public final void windowClosed(WindowEvent arg0) {
        field5911++;
    }

    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(B)V", line = 469)
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(B)Z", line = 500)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IIIZI)V", line = 541)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Ljava/lang/String;IZIIIIZ)V", line = 591)
    ...
    @OriginalMember(owner = "client!cr", name = "start", descriptor = "()V", line = 630)
    ...
    @OriginalMember(owner = "client!cr", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 648)
    public final void windowActivated(WindowEvent arg0) {
        field5929++;
    }

    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(BII)V", line = 660)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Z)V", line = 674)
    ...
    @OriginalMember(owner = "client!cr", name = "c", descriptor = "(B)V", line = 685)
    ...
    @OriginalMember(owner = "client!cr", name = "providesignlink", descriptor = "(Lci;)V", line = 731)
    ...
    @OriginalMember(owner = "client!cr", name = "h", descriptor = "(I)V", line = 739)
    ...
    @OriginalMember(owner = "client!cr", name = "destroy", descriptor = "()V", line = 771)
    ...
    @OriginalMember(owner = "client!cr", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 789)
    public final void windowClosing(WindowEvent arg0) {
        field5938++;
        this.destroy();
    }

    @OriginalMember(owner = "client!cr", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 800)
    public final void windowOpened(WindowEvent arg0) {
        field5908++;
    }

    @OriginalMember(owner = "client!cr", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 809)
    public final void focusLost(FocusEvent arg0) {
        class20.field288 = false;
        field5935++;
    }

    @OriginalMember(owner = "client!cr", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 817)
    ...
    @OriginalMember(owner = "client!cr", name = "i", descriptor = "(I)Ljava/lang/String;", line = 832)
