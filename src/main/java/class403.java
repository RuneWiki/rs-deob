...
public class class403 extends class107 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(CI)I", line = 36)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(ZC)I", line = 65)
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "(Z)V", line = 91)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Lso;IB)V", line = 113)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(BLso;)V", line = 179)
