...
public class class403 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(III[IILtf;I[IIBIIIZI)I", line = 4)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(B)Lhg;", line = 190)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(I)V", line = 217)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(BLhg;)V", line = 239)
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "()V", line = 307)
    public class403() {
        this.field5876.field5116 = this.field5876;
        this.field5876.field5114 = this.field5876;
    }

    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(B)V", line = 261)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Z)Lhg;", line = 271)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(II)I", line = 292)
