...
public class class403 extends class670 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IIIIII[FIFF[FIFI)V", line = 21)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(I)V", line = 113)
