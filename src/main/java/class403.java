...
public class class403 extends class440 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(II)[[I", line = 10)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ILr;IBII)V", line = 73)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ILmo;I)V", line = 170)
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "()V", line = 224)
    public class403() {
        super(1, false);
    }
}
