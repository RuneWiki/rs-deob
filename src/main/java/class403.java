...
public class class403 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(BLe;II)V")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Lff;IJ)V")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IIIILe;ILid;IZII)Lid;")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IJ)Lff;")
    ...
    @OriginalMember(owner = "client!gi", name = "b", descriptor = "(I)Lff;")
