...
public class class403 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(IBIILda;I)Lda;")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Lha;III[Z)V")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(ZILac;)V")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(ZLac;)V")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(BIIILda;IIB)Lda;")
