...
public class class403 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(II)V", line = 8)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(BC)V", line = 31)
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(Lbl;I)V", line = 64)
