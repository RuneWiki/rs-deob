...
public class class403 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Lib;B)V")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(I)Lju;")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(IILib;)V")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(B)Lju;")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Lffa;IIIIB)Lgda;")
