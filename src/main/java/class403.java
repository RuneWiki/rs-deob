...
public class class403 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(II)Lw;")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Lhd;B)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!fe", name = "<init>", descriptor = "(Lae;ILqn;)V")
