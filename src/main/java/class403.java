...
public class class403 extends class233 implements class438 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Lfp;Z)V")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Lfp;III)Z")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Lfp;I)V")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(ILfp;)Luq;")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Lfp;II)Lbi;")
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(IIIIILds;)V")
    ...
    @OriginalMember(owner = "client!pe", name = "b", descriptor = "(ILfp;)V")
