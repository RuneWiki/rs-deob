...
public class class403 {
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(B)V", line = 209)
    ...
    @OriginalMember(owner = "client!ul", name = "c", descriptor = "(I)V", line = 255)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IIBI)Lir;", line = 271)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(III)I", line = 329)
