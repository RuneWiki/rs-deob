...
public class class403 {
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(BI)Lin;")
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(IIIILlq;I)Lsv;")
    ...
    @OriginalMember(owner = "client!cv", name = "<init>", descriptor = "(Lkp;ILph;)V")
