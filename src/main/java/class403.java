...
public class class403 extends class354 {
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "(Lwo;)V", line = 4)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(II)I", line = 19)
    public final int method391(int arg0, int arg1) {
        ++field5101;
        return arg0 != 3 ? -85 : 1;
    }

    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(B)I", line = 30)
    ...
    @OriginalMember(owner = "client!tb", name = "c", descriptor = "(II)V", line = 42)
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "(ILwo;)V", line = 54)
    public class403(int arg0, class746 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(B)I", line = 74)
