...
public abstract class class403 {
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(Luq;IIZI)V")
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(I)Lh;")
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(ILcl;II)V")
