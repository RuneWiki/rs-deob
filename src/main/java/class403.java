...
public abstract class class403 extends class134 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!ns", name = "f", descriptor = "(I)Z", line = 29)
    ...
    @OriginalMember(owner = "client!ns", name = "g", descriptor = "(I)Z", line = 41)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Ljava/lang/String;BLjava/lang/String;)V", line = 66)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(B)I", line = 79)
    ...
    @OriginalMember(owner = "client!ns", name = "j", descriptor = "(I)I", line = 90)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Lnv;)V", line = 105)
