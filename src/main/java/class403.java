...
public class class403 implements class264 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(II)V", line = 22)
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(I)Leu;", line = 53)
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Ljava/lang/String;Lja;Lmea;IIIIIIIIII)V", line = 81)
