...
public class class403 extends class82 implements class49 {
    ...
    @OriginalMember(owner = "client!fe", name = "c", descriptor = "(Lbb;)V", line = 4)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(ILbb;)V", line = 7)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "()I", line = 11)
    public final int method225() {
        return 0;
    }

    @OriginalMember(owner = "client!fe", name = "<init>", descriptor = "(Lql;ILjava/nio/ByteBuffer;)V", line = 15)
    public class403(class346 arg0, int arg1, ByteBuffer arg2) {
        super(arg0, arg2);
        this.field5880 = arg1;
    }

    @OriginalMember(owner = "client!fe", name = "b", descriptor = "(Lbb;)V", line = 19)
    ...
    @OriginalMember(owner = "client!fe", name = "<init>", descriptor = "(Lql;I[BI)V", line = 22)
    public class403(class346 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field5880 = arg1;
    }

    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(I[BI)V", line = 26)
    public final void method227(int arg0, byte[] arg1, int arg2) {
        this.method448(arg1, arg2);
        this.field5880 = arg0;
    }

    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Lbb;)V", line = 31)
