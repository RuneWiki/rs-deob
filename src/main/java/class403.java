...
public class class403 extends class501 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BFILta;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IB)V", line = 29)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IILcu;Lya;ILhq;)Z", line = 55)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(II)V", line = 274)
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(II)V", line = 323)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lhg;I)V", line = 346)
    ...
    @OriginalMember(owner = "client!ul", name = "d", descriptor = "(I)V", line = 373)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lef;I[I[IBI)Lsj;", line = 385)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILhg;)V", line = 416)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lhk;I)V", line = 442)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lhg;Z)V", line = 609)
    ...
    @OriginalMember(owner = "client!ul", name = "c", descriptor = "(I)V", line = 634)
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(I)V", line = 657)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BI)V", line = 695)
