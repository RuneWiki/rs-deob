...
public class class403 extends class578 implements class438 {
    ...
    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "(Lqa;Lih;IIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IIILlaa;Llaa;)V")
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Lqa;IIZ)Lrp;")
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(ILqa;IB)Z")
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(ILqa;IIZLse;I)V")
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(BLqa;)Led;")
    ...
    @OriginalMember(owner = "client!le", name = "b", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Lqa;Z)V")
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Lqa;II)Lr;")
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(BILqa;)Lr;")
    public final class520 method161(byte arg0, int arg1, class167 arg2) {
        ++field5773;
        return arg0 != -127 ? null : this.method2418(arg2, arg1, 0);
    }

    @OriginalMember(owner = "client!le", name = "a", descriptor = "(ILqa;)Llb;")
