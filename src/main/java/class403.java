...
public class class403 extends class198 {
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(ILlm;)V")
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(ZLol;)V")
