...
public class class403 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(BI)I", line = 6)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Ljagdx/IDirect3DSwapChain;BLjagdx/IDirect3DSurface;)V", line = 43)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(I)Z", line = 56)
    public final boolean method2519(int arg0) {
        int var2 = -21 / ((7 - arg0) / 51);
        return this.field5918 != null;
    }

    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 63)
