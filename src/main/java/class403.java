...
public class class403 extends class334 {
    ...
    @OriginalMember(owner = "client!cr", name = "l", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(Lod;)V", line = 18)
    public class403(class349 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!cr", name = "h", descriptor = "(I)Z", line = 23)
    ...
    @OriginalMember(owner = "client!cr", name = "m", descriptor = "(I)Z", line = 64)
    ...
    @OriginalMember(owner = "client!cr", name = "f", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(BII)V", line = 96)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Z)V", line = 181)
    ...
    @OriginalMember(owner = "client!cr", name = "g", descriptor = "(I)I", line = 195)
    public final int method2037(int arg0) {
        ++field6059;
        return arg0 != 0 ? -70 : 1;
    }

    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(Z)Ljava/lang/String;", line = 206)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ILah;ILah;)V", line = 237)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(BI)V", line = 394)
    ...
    @OriginalMember(owner = "client!cr", name = "k", descriptor = "(I)Z", line = 408)
