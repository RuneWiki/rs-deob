...
public class class403 implements Runnable {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lsj;I)V")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IILhc;)Lsj;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ZLhc;I)Lsj;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lg;ILoj;)V")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lhc;[BIB)Lsj;")
    ...
    @OriginalMember(owner = "client!tt", name = "<init>", descriptor = "(Lkd;)V")
