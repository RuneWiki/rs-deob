...
public class class403 extends class646 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(II)[[I", line = 4)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Lek;IB)V", line = 324)
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "()V", line = 361)
    public class403() {
        super(2, false);
    }

    @OriginalMember(owner = "client!bh", name = "d", descriptor = "(I)V", line = 365)
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(IB)[I", line = 376)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(BILvo;I)Lqba;", line = 630)
