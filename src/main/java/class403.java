...
public class class403 {
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(Lvp;B)V")
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(II)Lpv;")
    ...
    @OriginalMember(owner = "client!maa", name = "<init>", descriptor = "(Lsp;III)V")
