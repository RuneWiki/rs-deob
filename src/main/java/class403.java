...
public class class403 {
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(IIII)I", line = 5)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(ILco;)V", line = 35)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(IIIIII)Z", line = 57)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(ILco;I)V", line = 118)
