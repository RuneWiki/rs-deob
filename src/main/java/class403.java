...
public class class403 extends class231 {
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(ILtca;Lvea;III)V", line = 3)
    public class403(int arg0, class545 arg1, class305 arg2, int arg3, int arg4, int arg5) {
        super(arg0, arg1, arg2, arg3, arg4);
        this.field6053 = arg5;
    }

    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(BI)V", line = 11)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(I)Lmh;", line = 30)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(III)Z", line = 41)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ILeda;Leda;ZIIZ)I", line = 52)
    ...
    @OriginalMember(owner = "client!lo", name = "b", descriptor = "(BI)I", line = 90)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(B)V", line = 107)
