...
public class class403 extends class508 {
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(CI)I", line = 5)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(ILww;Loj;Lr;IILvb;I)V", line = 34)
    ...
    @OriginalMember(owner = "client!qt", name = "b", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(BC)I", line = 123)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(IILes;)V", line = 146)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Les;I)V", line = 209)
