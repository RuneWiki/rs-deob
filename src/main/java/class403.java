...
public class class403 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IIII[FIIIFI)V", line = 14)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lrt;I)V", line = 63)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Llk;B)I", line = 87)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lrt;IB)V", line = 120)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(III)I", line = 148)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(B)Z", line = 164)
