...
public class class403 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(BLen;)V")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ILjf;Ljava/lang/String;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Ljava/awt/Canvas;B)Lfk;")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IB)Lch;")
