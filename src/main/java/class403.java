...
public class class403 extends class173 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IIIIIIIIIIILeo;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(I)I", line = 443)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lvba;I)Z", line = 460)
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(I)V", line = 495)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ILvba;)Z", line = 514)
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 539)
