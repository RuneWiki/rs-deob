...
public class class403 extends class64 {
    ...
    @OriginalMember(owner = "client!dda", name = "fa", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!dda", name = "<init>", descriptor = "(Lfba;Lkaa;[Luh;[I[I)V")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(CIIIZLaa;II)V")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
