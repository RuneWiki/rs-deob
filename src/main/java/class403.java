...
public class class403 extends class468 implements class534 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(ILqa;I)Lka;", line = 4)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Lqa;I)V", line = 19)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IIILqa;)Z", line = 47)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Z)V", line = 69)
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(Lqa;B)Lem;", line = 83)
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(B)I", line = 97)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(I)I", line = 109)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Lqa;B)V", line = 122)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IIIIIIII)V", line = 134)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(B)I", line = 342)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(BILqa;)Lka;", line = 353)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(ZLqa;BI)Lso;", line = 372)
    ...
    @OriginalMember(owner = "client!wm", name = "e", descriptor = "(B)V", line = 415)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(BLqa;)V", line = 429)
    ...
    @OriginalMember(owner = "client!wm", name = "d", descriptor = "(I)Z", line = 457)
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(I)V", line = 469)
    ...
    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "(Lqa;Lku;IIIIZIIZ)V", line = 482)
    ...
    @OriginalMember(owner = "client!wm", name = "c", descriptor = "(I)Z", line = 524)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(ILjava/lang/String;)V", line = 534)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(ILqa;)Lnj;", line = 601)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IIILqa;ZLee;Z)V", line = 625)
