...
public class class403 extends class168 {
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!hj", name = "b", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!hj", name = "<init>", descriptor = "()V", line = 106)
    public class403() {
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(Z)J", line = 59)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(I)J", line = 97)
