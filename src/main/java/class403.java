...
public abstract class class403 extends class710 {
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(IIIIBII)V", line = 21)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(BD)V", line = 50)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(IZIILli;)V", line = 63)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(III[J[Ljava/lang/Object;)V", line = 227)
