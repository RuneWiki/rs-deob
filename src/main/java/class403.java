...
public class class403 extends class267 implements class112 {
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "(Ltm;II[III)V", line = 6)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(FZ)F", line = 19)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(I)Z", line = 30)
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "(Ltm;Lg;Lvp;II)V", line = 41)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "([IIIIIIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IIFIFIBI[FFIII)V", line = 75)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(BIIILg;III[B)V", line = 165)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(BF)F", line = 194)
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(B)I", line = 206)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ZZB)V", line = 217)
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "(Ltm;Lg;II[FII)V", line = 227)
    ...
    @OriginalMember(owner = "client!qq", name = "h", descriptor = "(B)V", line = 241)
    public static void method2301(byte arg0) {
        field5290 = null;
        int var1 = -65 % ((33 - arg0) / 58);
    }

    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Lqa;Loe;IIIII)V", line = 252)
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "(Ltm;Lg;II[BII)V", line = 341)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(B)I", line = 356)
