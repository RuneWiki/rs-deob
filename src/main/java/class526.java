...
public class class526 extends InputStream {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ZLap;Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(II)V", line = 340)
    ...
    @OriginalMember(owner = "client!ph", name = "read", descriptor = "()I", line = 369)
