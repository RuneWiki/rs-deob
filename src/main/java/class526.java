...
public abstract class class526 extends class105 {
    ...
    @OriginalMember(owner = "client!lh", name = "g", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(IIIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ZIIIIIIIII[Ljb;)V", line = 32)
    ...
    @OriginalMember(owner = "client!lh", name = "j", descriptor = "(I)Z", line = 883)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "([Lwi;I)I", line = 895)
