...
public class class526 extends class390 {
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "()V", line = 4)
    public class526() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(ILsq;)V", line = 21)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(BII)V", line = 54)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(IIII)[B", line = 73)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IB)V", line = 87)
