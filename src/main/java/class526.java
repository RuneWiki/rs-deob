...
public class class526 extends class232 {
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IBIIIIILvi;III)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ou", name = "c", descriptor = "(I)V", line = 261)
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(Ltu;IIIIII)V", line = 279)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(I)Lwn;", line = 293)
