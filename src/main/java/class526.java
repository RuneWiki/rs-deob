...
public class class526 {
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IIIZII)V", line = 11)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IZ)V", line = 91)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IILbi;)Lec;", line = 108)
