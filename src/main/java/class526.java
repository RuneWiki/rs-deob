...
public class class526 implements class682 {
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;", line = 4)
    ...
    @OriginalMember(owner = "client!bia", name = "b", descriptor = "(Z)I", line = 25)
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(IIILjaclib/memory/Source;)Z", line = 36)
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(Z)I", line = 53)
    ...
    @OriginalMember(owner = "client!bia", name = "<init>", descriptor = "(Ler;Z)V", line = 148)
    public class526(class113 arg0, boolean arg1) {
        this.field7750 = arg0;
        this.field7747 = arg1;
    }

    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(B)Z", line = 88)
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(BII)Z", line = 113)
