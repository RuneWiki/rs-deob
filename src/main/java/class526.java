...
public class class526 extends class730 implements class181 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "([BZ)[B", line = 3)
    ...
    @OriginalMember(owner = "client!cm", name = "c", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(III[B)V", line = 35)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(I)I", line = 47)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Lml;I[BI)V", line = 58)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILjc;)Lgja;", line = 73)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(II)V", line = 92)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(Z)V", line = 104)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(B)J", line = 119)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Z)V", line = 130)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(I)I", line = 166)
