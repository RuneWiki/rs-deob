...
public class class526 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Ljava/awt/Color;IZLjava/lang/String;ILjava/awt/Color;Ljava/awt/Color;)V", line = 20)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(II)V", line = 105)
    ...
    @OriginalMember(owner = "client!gn", name = "toString", descriptor = "()Ljava/lang/String;", line = 234)
    public final String toString() {
        field7773++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(II)V", line = 241)
