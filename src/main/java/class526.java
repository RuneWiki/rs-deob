...
public class class526 extends class206 implements class28 {
    ...
    @OriginalMember(owner = "client!a", name = "y", descriptor = "()Lfd;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lei;IIII)Lr;")
    ...
    @OriginalMember(owner = "client!a", name = "j", descriptor = "()Lm;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "([Lr;Lm;[Lcf;I)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lmv;)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IIIIII)Lmv;")
    public final class313 method1136(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lfc;[Ldp;Z)Lra;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "([Lr;Lka;Lm;[Lcf;I)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(I[Lcba;)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lmv;Lmv;FLmv;)Lmv;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Z)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ldp;Z)Lha;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IIIIIF)Lcba;")
    ...
    @OriginalMember(owner = "client!a", name = "b", descriptor = "(IIIIZ)Lha;")
