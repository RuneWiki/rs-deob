...
public class class526 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lph;I)V")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lnn;Z)V")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IBLnn;)V")
