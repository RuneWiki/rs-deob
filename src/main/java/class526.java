...
public class class526 extends class517 {
    ...
    @OriginalMember(owner = "client!lc", name = "U", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!lc", name = "W", descriptor = "(III)V", line = 12)
    ...
    @OriginalMember(owner = "client!lc", name = "ea", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!lc", name = "K", descriptor = "(III[I)V", line = 40)
    ...
    @OriginalMember(owner = "client!lc", name = "v", descriptor = "()V", line = 46)
    ...
    @OriginalMember(owner = "client!lc", name = "A", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "()Lc;", line = 58)
    ...
    @OriginalMember(owner = "client!lc", name = "ca", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!lc", name = "wa", descriptor = "([I)V", line = 84)
    ...
    @OriginalMember(owner = "client!lc", name = "g", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!lc", name = "ha", descriptor = "(Lc;)V", line = 104)
    ...
    @OriginalMember(owner = "client!lc", name = "EA", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(III[I)V", line = 149)
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "()V", line = 153)
    public class526() {
        this.method964();
    }

    @OriginalMember(owner = "client!lc", name = "YA", descriptor = "(IIIIII)V", line = 158)
