...
public class class526 implements Runnable {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!kj", name = "b", descriptor = "()V", line = 11)
    ...
    @OriginalMember(owner = "client!kj", name = "c", descriptor = "()Z", line = 109)
    public final boolean method3188() {
        return this.field7689 == null || !this.field7686 && this.field7689.method2432(-119);
    }

    @OriginalMember(owner = "client!kj", name = "d", descriptor = "()J", line = 114)
    public final long method3189() {
        return this.field7684;
    }

    @OriginalMember(owner = "client!kj", name = "<init>", descriptor = "(ILr;)V", line = 162)
    public class526(int arg0, class167 arg1) {
        this.field7690 = arg0;
        this.field7685 = arg1;
    }

    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Ltb;)V", line = 135)
    ...
    @OriginalMember(owner = "client!kj", name = "e", descriptor = "()V", line = 145)
    ...
    @OriginalMember(owner = "client!kj", name = "run", descriptor = "()V", line = 151)
    ...
    @OriginalMember(owner = "client!kj", name = "f", descriptor = "()V", line = 167)
