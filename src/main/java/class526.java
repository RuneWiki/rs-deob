...
public class class526 extends class354 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILti;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "()V", line = 48)
    public class526() {
        super(1, false);
    }

    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(BI)[[I", line = 52)
    ...
    @OriginalMember(owner = "client!lr", name = "c", descriptor = "(B)V", line = 123)
    ...
    @OriginalMember(owner = "client!lr", name = "d", descriptor = "(Z)V", line = 147)
