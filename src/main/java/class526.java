...
public class class526 implements class738 {
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(Lqca;BJ[I)Ljava/lang/String;", line = 7)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(BLvk;)[Lbk;", line = 38)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(ZI)I", line = 97)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 142)
