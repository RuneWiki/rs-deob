...
public class class526 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(I[BJ)V", line = 119)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(BI[B)V", line = 203)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(B)V", line = 270)
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(I)V", line = 283)
