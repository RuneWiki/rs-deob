...
public class class526 {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(II)Loaa;", line = 4)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(II[S[Ljava/lang/String;B)V", line = 36)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(IIIIBII)I", line = 93)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(B)V", line = 129)
    public static void method2966(byte arg0) {
        int var1 = -128 / ((arg0 + 5) / 37);
        field7420 = null;
    }

    @OriginalMember(owner = "client!hu", name = "<init>", descriptor = "(Lqh;ILtf;)V", line = 140)
