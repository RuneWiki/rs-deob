...
public class class526 implements class167 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IZ)V", line = 9)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(I)Z", line = 40)
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(II)V", line = 75)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lbt;Lbt;Lii;)V", line = 97)
