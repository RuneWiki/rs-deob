...
public class class526 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(I)[Lsh;", line = 30)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Ltaa;Z)V", line = 659)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(B)V", line = 686)
    ...
    @OriginalMember(owner = "client!lh", name = "c", descriptor = "(B)Ltaa;", line = 711)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 734)
    ...
    @OriginalMember(owner = "client!lh", name = "c", descriptor = "(I)Ltaa;", line = 745)
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "()V", line = 773)
    public class526() {
