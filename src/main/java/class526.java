...
public class class526 {
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(II)I", line = 15)
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(IIILha;Lkh;)V", line = 44)
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(III)V", line = 360)
    ...
    @OriginalMember(owner = "client!bia", name = "<init>", descriptor = "([I)V", line = 385)
