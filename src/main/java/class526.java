...
public class class526 extends class4 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Z)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(III)Z", line = 110)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!ro", name = "<init>", descriptor = "(I)V", line = 136)
    public class526(int arg0) {
        this.field7304 = arg0;
    }

    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IZ)Z", line = 146)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(II)Z", line = 158)
    ...
    @OriginalMember(owner = "client!ro", name = "f", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ZI)I", line = 211)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(II)Z", line = 234)
