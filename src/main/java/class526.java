...
public class class526 extends class325 {
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(Ljp;IB)V")
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(Lha;ZIB)Lvga;")
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(IILha;III)V")
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(ILsaa;Z)V")
