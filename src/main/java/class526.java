...
public class class526 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(BLcu;[B)V", line = 5)
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "()V", line = 34)
    public class526() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(BI)I", line = 38)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(III)V", line = 71)
    private class526(int arg0, int arg1, int arg2) {
    }

    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Z[Lf;)V", line = 84)
