...
public class class526 extends class129 {
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!eaa", name = "<init>", descriptor = "(Lkd;)V")
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(IILrca;)V")
