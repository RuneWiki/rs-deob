...
public class class526 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(II)I", line = 7)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "()I", line = 16)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "()V", line = 23)
    public class526() {
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "()V", line = 167)
    ...
    @OriginalMember(owner = "client!pn", name = "c", descriptor = "()[F", line = 305)
