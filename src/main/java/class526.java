...
public class class526 extends class631 {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "(B)Lqu;", line = 18)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(BLjava/lang/String;)[B", line = 37)
