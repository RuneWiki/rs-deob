...
public class class526 implements class671 {
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(I[I)V", line = 8)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(BI)V", line = 41)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(ZIILjava/awt/Component;)V", line = 54)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(II)V", line = 94)
    ...
    @OriginalMember(owner = "client!rfa", name = "<init>", descriptor = "()V", line = 195)
    ...
    @OriginalMember(owner = "client!rfa", name = "b", descriptor = "(II)I", line = 117)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(III)V", line = 152)
