...
public class class526 implements class171 {
    ...
    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(ILjava/lang/String;I)I", line = 20)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(I)Lvm;", line = 31)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 44)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(B)V", line = 65)
    public static void method3134(byte arg0) {
        int var1 = 124 / ((-arg0 - 53) / 62);
        field7362 = null;
    }

    @OriginalMember(owner = "client!sf", name = "<init>", descriptor = "(Lwu;Ljava/lang/String;)V", line = 76)
    public class526(class557 arg0, String arg1) {
        this.field7358 = arg1;
        this.field7359 = arg0;
    }

    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(BII)Z", line = 85)
