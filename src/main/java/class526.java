...
public class class526 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Lvr;[IJI)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Lm;)V")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(II)Lbp;")
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "(ILci;Lci;Lke;)V")
