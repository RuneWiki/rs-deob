...
public class class526 extends Canvas {
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(JLoa;I)V")
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(II)Lok;")
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(Liaa;I)Lwo;")
