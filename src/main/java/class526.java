...
public class class526 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Lia;I)V")
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IILtl;Lza;III)Le;")
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(ILza;IIILtl;I)Le;")
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(ILya;IIIZILtl;BILya;IILza;)Le;")
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(BLia;I)V")
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Lya;ZIIILya;IIILza;IILtl;)Le;")
