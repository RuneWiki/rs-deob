...
public class class526 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Lip;I)V", line = 19)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Lqa;IZI)Lf;", line = 52)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Llh;I)V", line = 97)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(I)Z", line = 122)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Llh;II)V", line = 139)
