...
public class class526 extends class216 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 4)
    ...
    @OriginalMember(owner = "client!wa", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 17)
    public class526(Object arg0, int arg1) {
        super(arg1);
        this.field7526 = arg0;
    }

    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(B)Z", line = 26)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IIIILlca;)V", line = 40)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Lwca;I)I", line = 82)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(I[II[II)V", line = 156)
    ...
    @OriginalMember(owner = "client!wa", name = "g", descriptor = "(I)V", line = 212)
