...
public class class526 extends class305 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!um", name = "c", descriptor = "(II)I", line = 20)
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(B)I", line = 54)
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "(I)Z", line = 65)
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(ILhb;)V", line = 76)
    public class526(int arg0, class728 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!um", name = "c", descriptor = "(I)I", line = 80)
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "(II)V", line = 91)
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Lhb;)V", line = 103)
