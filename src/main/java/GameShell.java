...
public class GameShell extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    public final void method1(int arg0, int arg1, int arg2) {
        ...
        this.field11 = arg2;
        this.field12 = arg1;
        this.field16 = new ViewBox(this.field12, this, this.field11, (byte) 4);
        this.field13 = this.method11(-66).getGraphics();
        this.field14 = new PixMap(this.field12, this.method11(-66), 0, this.field11);
    ...
    public void run() {
        this.method11(-66).addMouseListener(this);
        this.method11(-66).addMouseMotionListener(this);
        this.method11(-66).addKeyListener(this);
        this.method11(-66).addFocusListener(this);
        if (this.field16 != null) {
            this.field16.addWindowListener(this);
        }
        this.method13((byte) 7, "Loading...", 0);
        this.method6();
        int var1 = 0;
        int var2 = 256;
        int var3 = 1;
    ...
    public final void mousePressed(MouseEvent arg0) {
        ...
        if (InputTracking.field150) {
            InputTracking.method49(var3, arg0.isMetaDown() ? 1 : 0, var2, -241);
        }
    }
    ...
    public final void mouseReleased(MouseEvent arg0) {
        ...
        this.field20 = 0;
        if (InputTracking.field150) {
            InputTracking.method50(0, arg0.isMetaDown() ? 1 : 0);
        }
    }
    ...
    public final void mouseEntered(MouseEvent arg0) {
        if (InputTracking.field150) {
            InputTracking.method56((byte) 73);
        }
    }
    ...
    public final void mouseDragged(MouseEvent arg0) {
        ...
        this.field22 = var3;
        if (InputTracking.field150) {
            InputTracking.method51(true, var2, var3);
        }
    }
    ...
    public final void keyPressed(KeyEvent arg0) {
        ...
        if (InputTracking.field150) {
            InputTracking.method52(var3, false);
        }
    }
    ...
    public void method13(byte arg0, String arg1, int arg2) {
        ...
        FontMetrics var5 = this.method11(-66).getFontMetrics(var4);
        Font var6 = new Font("Helvetica", 0, 13);
        this.method11(-66).getFontMetrics(var6);
        if (this.field17) {
