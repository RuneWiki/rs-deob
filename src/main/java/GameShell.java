...
public class GameShell extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!a", name = "o", descriptor = "[Lib;")
    ...
    public final void method1(int arg0, int arg1, int arg2) {
        this.field11 = arg0;
        this.field12 = arg2;
        this.field16 = new ViewBox(this, -20349, this.field11, this.field12);
        this.field13 = this.method11(-125).getGraphics();
        this.field14 = new PixMap(this.field11, this.field12, 47904, this.method11(-125));
        if (arg1 < 2 || arg1 > 2) {
    ...
    public void run() {
        this.method11(-125).addMouseListener(this);
        this.method11(-125).addMouseMotionListener(this);
        this.method11(-125).addKeyListener(this);
        this.method11(-125).addFocusListener(this);
        if (this.field16 != null) {
            this.field16.addWindowListener(this);
        }
        this.method13(0, "Loading...", 7);
        this.method6();
        int var1 = 0;
        int var2 = 256;
        int var3 = 1;
    ...
    public void method13(int arg0, String arg1, int arg2) {
        ...
        FontMetrics var5 = this.method11(-125).getFontMetrics(var4);
        Font var6 = new Font("Helvetica", 0, 13);
        this.method11(-125).getFontMetrics(var6);
        if (this.field17) {
        ...
        this.field13.fillRect(this.field11 / 2 - 150, var8 + 2, arg0 * 3, 30);
        this.field13.setColor(Color.black);
        if (arg2 == 7) {
            this.field13.fillRect(arg0 * 3 + this.field11 / 2 - 150, var8 + 2, 300 - arg0 * 3, 30);
