...
public class GameShell extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "mapview!a", name = "k", descriptor = "[Lh;")
    public Pix24[] field11 = new Pix24[6];
    ...
    @OriginalMember(owner = "mapview!a", name = "j", descriptor = "Lm;")
    public PixMap field10;

    @OriginalMember(owner = "mapview!a", name = "l", descriptor = "Lb;")
    public ViewBox field12;
    ...
    public final void mouseReleased(MouseEvent arg0) {
        this.field15 = 0;
        this.field16 = 0;
        if (EventTracking.field33) {
            EventTracking.method18(arg0.isMetaDown() ? 1 : 0);
        }
    }
    ...
    public final void method6(int arg0, int arg1) {
        this.field7 = arg0;
        this.field8 = arg1;
        this.field12 = new ViewBox(this, this.field7, this.field8);
        this.field9 = this.method9().getGraphics();
        this.field10 = new PixMap(this.field7, this.field8, this.method9());
        this.method3(this, 1);
    }
    ...
    public final void mousePressed(MouseEvent arg0) {
        ...
        if (EventTracking.field33) {
            EventTracking.method16(var2, var3, arg0.isMetaDown() ? 1 : 0);
        }
    }
    ...
    public final void mouseDragged(MouseEvent arg0) {
        ...
        this.field18 = var3;
        if (EventTracking.field33) {
            EventTracking.method14(var2, var3);
        }
    }
