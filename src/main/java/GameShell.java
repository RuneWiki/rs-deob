...
public class GameShell extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    public final void method1(int arg0, int arg1, int arg2) {
        ...
        this.field12 = arg0;
        if (arg2 > 0) {
            this.field16 = new ViewBox(this.field11, -284, this.field12, this);
            this.field13 = this.method11(37639).getGraphics();
            this.field14 = new PixMap(this.field12, this.field11, this.method11(37639), false);
    ...
    public void run() {
        this.method11(37639).addMouseListener(this);
        this.method11(37639).addMouseMotionListener(this);
        this.method11(37639).addKeyListener(this);
        this.method11(37639).addFocusListener(this);
        if (this.field16 != null) {
            this.field16.addWindowListener(this);
        }
        this.method13(9, 0, "Loading...");
        this.method6();
        int var1 = 0;
        int var2 = 256;
        int var3 = 1;
    ...
    public void method13(int arg0, int arg1, String arg2) {
        ...
        FontMetrics var5 = this.method11(37639).getFontMetrics(var4);
        Font var6 = new Font("Helvetica", 0, 13);
        this.method11(37639).getFontMetrics(var6);
        if (this.field17) {
        ...
        this.field13.setColor(Color.black);
        if (arg0 >= this.field2 && arg0 <= this.field2) {
