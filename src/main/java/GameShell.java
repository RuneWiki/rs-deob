...
public class GameShell extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!a", name = "p", descriptor = "[Lib;")
    ...
    public final void method1(int arg0, int arg1, int arg2) {
        ...
        this.field12 = arg0;
        this.field13 = arg1;
        this.field17 = new ViewBox(this.field13, this.field12, false, this);
        this.field14 = this.method11((byte) -114).getGraphics();
        this.field15 = new PixMap(this.field2, this.field12, this.field13, this.method11((byte) -114));
    ...
    public void run() {
        this.method11((byte) -114).addMouseListener(this);
        this.method11((byte) -114).addMouseMotionListener(this);
        this.method11((byte) -114).addKeyListener(this);
        this.method11((byte) -114).addFocusListener(this);
        if (this.field17 != null) {
            this.field17.addWindowListener(this);
        }
        this.method13(0, "Loading...", (byte) 7);
        this.method6();
        int var1 = 0;
        int var2 = 256;
        int var3 = 1;
    ...
    public void method13(int arg0, String arg1, byte arg2) {
        while (this.field14 == null) {
            this.field14 = this.method11((byte) -114).getGraphics();
            try {
                this.method11((byte) -114).repaint();
        ...
        FontMetrics var5 = this.method11((byte) -114).getFontMetrics(var4);
        Font var6 = new Font("Helvetica", 0, 13);
        this.method11((byte) -114).getFontMetrics(var6);
        if (this.field18) {
        ...
        this.field14.fillRect(this.field12 / 2 - 150, var9 + 2, arg0 * 3, 30);
        this.field14.setColor(Color.black);
        this.field14.fillRect(arg0 * 3 + this.field12 / 2 - 150, var9 + 2, 300 - arg0 * 3, 30);
        this.field14.setFont(var4);
        this.field14.setColor(Color.white);
        this.field14.drawString(arg1, (this.field12 - var5.stringWidth(arg1)) / 2, var9 + 22);
    }
}
