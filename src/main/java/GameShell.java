...
public class GameShell extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    public final void method1(int arg0, int arg1, int arg2) {
        ...
        this.field17 = new ViewBox(this.screenHeight, 35731, this, this.screenWidth);
        this.graphics = this.method11(this.field5).getGraphics();
        this.field15 = new PixMap(this.method11(this.field5), this.screenWidth, 299, this.screenHeight);
