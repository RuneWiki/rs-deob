...
public class GameShell extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!a", name = "u", descriptor = "[Ljb;")
    public Pix24[] field21 = new Pix24[6];
    ...
    @OriginalMember(owner = "client!a", name = "t", descriptor = "Lrb;")
    public PixMap field20;

    @OriginalMember(owner = "client!a", name = "v", descriptor = "Lb;")
