...
public class GameShell extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!a", name = "q", descriptor = "[Lib;")
    public Pix24[] field17 = new Pix24[6];
    ...
    @OriginalMember(owner = "client!a", name = "p", descriptor = "Lqb;")
    public PixMap field16;

    @OriginalMember(owner = "client!a", name = "r", descriptor = "Lb;")
    ...
    public final void method1(int arg0, int arg1, int arg2) {
        ...
        this.field18 = new ViewBox(this.field13, (byte) -80, this, this.field14);
        this.field15 = this.method11(19330).getGraphics();
        this.field16 = new PixMap(500, this.field13, this.method11(19330), this.field14);
    ...
    public void run() {
        this.method11(19330).addMouseListener(this);
        this.method11(19330).addMouseMotionListener(this);
        this.method11(19330).addKeyListener(this);
        this.method11(19330).addFocusListener(this);
        if (this.field18 != null) {
            this.field18.addWindowListener(this);
        }
        this.method13(0, (byte) -37, "Loading...");
        this.method6();
        int var1 = 0;
        int var2 = 256;
        int var3 = 1;
    ...
    @OriginalMember(owner = "client!a", name = "b", descriptor = "(I)Ljava/awt/Component;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IBLjava/lang/String;)V")
    public void method13(int arg0, byte arg1, String arg2) {
        while (this.field15 == null) {
            this.field15 = this.method11(19330).getGraphics();
            try {
                this.method11(19330).repaint();
        ...
        FontMetrics var5 = this.method11(19330).getFontMetrics(var4);
        Font var6 = new Font("Helvetica", 0, 13);
        this.method11(19330).getFontMetrics(var6);
        if (this.field19) {
        ...
        this.field15.fillRect(this.field13 / 2 - 150, var8 + 2, arg0 * 3, 30);
        this.field15.setColor(Color.black);
        this.field15.fillRect(arg0 * 3 + this.field13 / 2 - 150, var8 + 2, 300 - arg0 * 3, 30);
