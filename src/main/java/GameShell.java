...
public class GameShell extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    private int field2 = -96;

    @OriginalMember(owner = "client!a", name = "c", descriptor = "I")
    private int field3 = -602;
    ...
    @OriginalMember(owner = "client!a", name = "o", descriptor = "[Ljb;")
    public Pix24[] field15 = new Pix24[6];
    ...
    @OriginalMember(owner = "client!a", name = "n", descriptor = "Lrb;")
    public PixMap field14;

    @OriginalMember(owner = "client!a", name = "p", descriptor = "Lb;")
    ...
    public final void method1(int arg0, int arg1, int arg2) {
        this.field11 = arg2;
        this.field12 = arg0;
        this.field16 = new ViewBox((byte) 3, this, this.field12, this.field11);
        this.field13 = this.method11(437).getGraphics();
        this.field14 = new PixMap((byte) -82, this.field12, this.method11(437), this.field11);
        if (arg1 >= 0) {
    ...
    public void run() {
        this.method11(437).addMouseListener(this);
        this.method11(437).addMouseMotionListener(this);
        this.method11(437).addKeyListener(this);
        this.method11(437).addFocusListener(this);
        if (this.field16 != null) {
            this.field16.addWindowListener(this);
        }
        this.method13(638, "Loading...", 0);
        this.method6();
        int var1 = 0;
        int var2 = 256;
        int var3 = 1;
    ...
    public final void mousePressed(MouseEvent arg0) {
        ...
        if (InputTracking.field145) {
            InputTracking.method49(arg0.isMetaDown() ? 1 : 0, 39216, var3, var2);
        }
    }
    ...
    public final void mouseDragged(MouseEvent arg0) {
        ...
        this.field22 = var3;
        if (InputTracking.field145) {
            InputTracking.method51(var3, var2, 0);
        }
    }
    ...
    public final void keyPressed(KeyEvent arg0) {
        ...
        if (InputTracking.field145) {
            InputTracking.method52(878, var3);
        }
    }
    ...
    public final void keyReleased(KeyEvent arg0) {
        ...
        if (InputTracking.field145) {
            InputTracking.method53(var3, this.field2);
        }
    }
    ...
    public void method13(int arg0, String arg1, int arg2) {
        ...
        FontMetrics var5 = this.method11(437).getFontMetrics(var4);
        Font var6 = new Font("Helvetica", 0, 13);
        this.method11(437).getFontMetrics(var6);
        if (this.field17) {
        ...
        this.field13.fillRect(this.field11 / 2 - 150, var8 + 2, arg2 * 3, 30);
        this.field13.setColor(Color.black);
        this.field13.fillRect(arg2 * 3 + this.field11 / 2 - 150, var8 + 2, 300 - arg2 * 3, 30);
        this.field13.setFont(var4);
        this.field13.setColor(Color.white);
        this.field13.drawString(arg1, (this.field11 - var5.stringWidth(arg1)) / 2, var8 + 22);
    }
}
