...
public class GameShell extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!a", name = "r", descriptor = "[Lib;")
    public Pix24[] field18 = new Pix24[6];
    ...
    @OriginalMember(owner = "client!a", name = "q", descriptor = "Lqb;")
    public PixMap field17;

    @OriginalMember(owner = "client!a", name = "s", descriptor = "Lb;")
    ...
    public final void method1(int arg0, int arg1, int arg2) {
        this.field14 = arg2;
        this.field15 = arg1;
        this.field19 = new ViewBox(this, this.field14, this.field15, 12861);
        this.field16 = this.method11(-914).getGraphics();
        if (arg0 != 0) {
            this.field2 = !this.field2;
        }
        this.field17 = new PixMap(this.field14, 5, this.field15, this.method11(-914));
    ...
    public void run() {
        this.method11(-914).addMouseListener(this);
        this.method11(-914).addMouseMotionListener(this);
        this.method11(-914).addKeyListener(this);
        this.method11(-914).addFocusListener(this);
        if (this.field19 != null) {
            this.field19.addWindowListener(this);
        }
        this.method13("Loading...", -761, 0);
        this.method6();
        int var1 = 0;
        int var2 = 256;
        int var3 = 1;
    ...
    public void method13(String arg0, int arg1, int arg2) {
        ...
        FontMetrics var5 = this.method11(-914).getFontMetrics(var4);
        Font var6 = new Font("Helvetica", 0, 13);
        this.method11(-914).getFontMetrics(var6);
        if (this.field20) {
        ...
        this.field16.fillRect(this.field14 / 2 - 150, var8 + 2, arg2 * 3, 30);
        this.field16.setColor(Color.black);
        if (arg1 >= 0) {
            for (int var9 = 1; var9 > 0; var9++) {
            }
        }
        this.field16.fillRect(arg2 * 3 + this.field14 / 2 - 150, var8 + 2, 300 - arg2 * 3, 30);
        this.field16.setFont(var4);
        this.field16.setColor(Color.white);
        this.field16.drawString(arg0, (this.field14 - var5.stringWidth(arg0)) / 2, var8 + 22);
    }
}
