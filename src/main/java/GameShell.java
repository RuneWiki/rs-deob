...
public class GameShell extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    public final void method1(int arg0, byte arg1, int arg2) {
        this.field12 = arg0;
        this.field13 = arg2;
        this.field17 = new ViewBox(this.field13, this, this.field12, (byte) 87);
        if (arg1 != -12) {
            for (int var4 = 1; var4 > 0; var4++) {
            }
        }
        this.field14 = this.method11(0).getGraphics();
        this.field15 = new PixMap(this.field12, false, this.method11(0), this.field13);
    ...
    public void method13(int arg0, int arg1, String arg2) {
        ...
        this.field14.drawString(arg2, (this.field12 - var5.stringWidth(arg2)) / 2, var9 + 22);
    }
}
