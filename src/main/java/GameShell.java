...
public class GameShell extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!a", name = "t", descriptor = "[Lhb;")
    public Pix24[] field20 = new Pix24[6];
    ...
    @OriginalMember(owner = "client!a", name = "s", descriptor = "Lqb;")
    public PixMap field19;

    @OriginalMember(owner = "client!a", name = "u", descriptor = "Lb;")
