...
public class GameShell extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!a", name = "q", descriptor = "[Ljb;")
    ...
    @OriginalMember(owner = "client!a", name = "p", descriptor = "Lrb;")
    ...
    public void method13(byte arg0, String arg1, int arg2) {
        ...
        this.field15.setColor(Color.black);
        this.field15.fillRect(arg2 * 3 + this.field13 / 2 - 150, var8 + 2, 300 - arg2 * 3, 30);
