...
public class GameShell extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!a", name = "s", descriptor = "[Ljb;")
    public Pix24[] field19 = new Pix24[6];
    ...
    @OriginalMember(owner = "client!a", name = "r", descriptor = "Lrb;")
    public PixMap field18;

    @OriginalMember(owner = "client!a", name = "t", descriptor = "Lb;")
