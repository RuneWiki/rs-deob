...
public class class750 extends class83 implements class28 {
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Loaa;IIZ[III)V", line = 4)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(II[BLpb;IIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(II)[B", line = 39)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(I[IIIIZII)V", line = 87)
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Loaa;Lpb;IIZ[FII)V", line = 101)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IILjava/lang/String;IIIII)V", line = 124)
    ...
    @OriginalMember(owner = "client!jb", name = "b", descriptor = "(B)I", line = 144)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ZZZ)V", line = 155)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IIII[FLpb;III)V", line = 168)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(FI)F", line = 179)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(I)Z", line = 190)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(FZ)F", line = 201)
    public final float method128(float arg0, boolean arg1) {
        ++field10352;
        return !arg1 ? -2.8800128F : arg0 / (float) this.field10355;
    }

    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IIII[III)V", line = 213)
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Loaa;Lpb;IIZ[BII)V", line = 238)
    ...
    @OriginalMember(owner = "client!jb", name = "i", descriptor = "(I)V", line = 265)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(B)I", line = 278)
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Loaa;Lpb;Loea;II)V", line = 298)
