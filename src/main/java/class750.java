...
public class class750 extends class76 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IIZII)V", line = 4)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(II)[[I", line = 20)
    ...
    @OriginalMember(owner = "client!hn", name = "c", descriptor = "(II)S", line = 67)
    ...
    @OriginalMember(owner = "client!hn", name = "g", descriptor = "(I)V", line = 103)
