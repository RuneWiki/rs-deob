...
public class class750 extends class619 {
    ...
    @OriginalMember(owner = "client!jaa", name = "b", descriptor = "(Ljagtheora/ogg/OggPacket;I)V")
    ...
    @OriginalMember(owner = "client!jaa", name = "c", descriptor = "(B)Lfea;")
    ...
    @OriginalMember(owner = "client!jaa", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
