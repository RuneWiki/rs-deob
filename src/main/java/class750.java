...
public class class750 extends class634 {
    ...
    @OriginalMember(owner = "client!nca", name = "d", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!nca", name = "c", descriptor = "(B)V", line = 190)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(IBI)Z", line = 214)
    ...
    @OriginalMember(owner = "client!nca", name = "b", descriptor = "(BI)[I", line = 226)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(Z)V", line = 269)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(ILig;Z)V", line = 282)
    ...
    @OriginalMember(owner = "client!nca", name = "<init>", descriptor = "()V", line = 310)
    public class750() {
        super(1, true);
    }

    @OriginalMember(owner = "client!nca", name = "c", descriptor = "(BI)[I", line = 319)
    ...
    @OriginalMember(owner = "client!nca", name = "b", descriptor = "(Z)V", line = 338)
