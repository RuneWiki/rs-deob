...
public class class750 implements class105 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(Z)Lwh;", line = 4)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(I)V", line = 66)
