...
public class class750 {
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!wga", name = "b", descriptor = "(B)V", line = 123)
    ...
    @OriginalMember(owner = "client!wga", name = "b", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(BILas;)V", line = 359)
    ...
    @OriginalMember(owner = "client!wga", name = "<init>", descriptor = "(Lrda;Ljl;Lmu;IIIII)V", line = 570)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(Laha;B[[B)V", line = 379)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(IBI)I", line = 494)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(BI[BI)V", line = 556)
