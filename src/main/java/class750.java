...
public class class750 extends class497 {
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "(ILpp;)V", line = 8)
    public class750(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(ZJII)Ljava/lang/String;", line = 12)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(BI)I", line = 52)
    ...
    @OriginalMember(owner = "client!cg", name = "b", descriptor = "(I)I", line = 64)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(III)Z", line = 75)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(I)I", line = 87)
    ...
    @OriginalMember(owner = "client!cg", name = "c", descriptor = "(II)S", line = 102)
    ...
    @OriginalMember(owner = "client!cg", name = "c", descriptor = "(B)Lld;", line = 134)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(B)V", line = 154)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(IBIII)V", line = 165)
    ...
    @OriginalMember(owner = "client!cg", name = "c", descriptor = "(I)V", line = 221)
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "(Lpp;)V", line = 231)
    ...
    @OriginalMember(owner = "client!cg", name = "b", descriptor = "(B)[Lrj;", line = 248)
