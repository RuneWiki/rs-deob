...
public abstract class class750 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!jn", name = "<init>", descriptor = "(IIIII)V", line = 330)
    ...
    @OriginalMember(owner = "client!jn", name = "b", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IIII)V", line = 79)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(II)I", line = 255)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(I)V", line = 307)
