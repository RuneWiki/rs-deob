...
public class class750 extends class331 {
    ...
    @OriginalMember(owner = "client!kq", name = "c", descriptor = "(II)V", line = 20)
    ...
    @OriginalMember(owner = "client!kq", name = "c", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!kq", name = "d", descriptor = "(B)Z", line = 49)
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(ILts;)V", line = 67)
    public class750(int arg0, class41 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!kq", name = "a", descriptor = "([Lmb;II)V", line = 75)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(BI)Ljt;", line = 112)
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(II)I", line = 137)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IZ)V", line = 155)
    ...
    @OriginalMember(owner = "client!kq", name = "e", descriptor = "(B)I", line = 175)
    public final int method4191(byte arg0) {
        ++field10493;
        return arg0 >= -119 ? -101 : super.field4202;
    }

    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(B)I", line = 186)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(BII[FIII)V", line = 202)
    ...
    @OriginalMember(owner = "client!kq", name = "f", descriptor = "(B)Z", line = 301)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lkha;I)V", line = 315)
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(Lts;)V", line = 347)
    public class750(class41 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(IZ)V", line = 329)
