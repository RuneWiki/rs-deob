...
public class class750 implements Runnable {
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(Ljia;)V", line = 3)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!wga", name = "b", descriptor = "()J", line = 22)
    public final long method4174() {
        return this.field10478;
    }

    @OriginalMember(owner = "client!wga", name = "<init>", descriptor = "(ILha;)V", line = 153)
    public class750(int arg0, class60 arg1) {
        this.field10479 = arg0;
        this.field10480 = arg1;
    }

    @OriginalMember(owner = "client!wga", name = "c", descriptor = "()V", line = 35)
    ...
    @OriginalMember(owner = "client!wga", name = "d", descriptor = "()V", line = 45)
    ...
    @OriginalMember(owner = "client!wga", name = "e", descriptor = "()Z", line = 143)
    public final boolean method4177() {
        return this.field10482 == null || !this.field10481 && this.field10482.method3455((byte) -111);
    }

    @OriginalMember(owner = "client!wga", name = "run", descriptor = "()V", line = 158)
    ...
    @OriginalMember(owner = "client!wga", name = "f", descriptor = "()V", line = 167)
