...
public class class750 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lr;III)Z")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIBZ[[ZI)V")
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILr;BI)V")
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Lsr;Laca;)V")
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(Lr;III)V")
