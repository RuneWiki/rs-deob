...
public class class282 extends class328 {
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(II)[[I", line = 34)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Lgp;I)I", line = 83)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Lgp;II)Lrl;", line = 152)
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "()V", line = 166)
    public class282() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(BILco;)V", line = 189)
