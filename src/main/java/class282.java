...
public class class282 {
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(II)I", line = 6)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(I[B)[B", line = 21)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(II[J[II)V", line = 90)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(Lvo;IILfa;Ljava/awt/Canvas;)Lr;", line = 149)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(Z)V", line = 206)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(II)I", line = 217)
    ...
    @OriginalMember(owner = "client!qu", name = "<init>", descriptor = "(II)V", line = 234)
