...
public class class282 extends class212 {
    ...
    @OriginalMember(owner = "client!vca", name = "b", descriptor = "(I)I", line = 13)
    ...
    @OriginalMember(owner = "client!vca", name = "b", descriptor = "(II)I", line = 24)
    ...
    @OriginalMember(owner = "client!vca", name = "<init>", descriptor = "(ILdh;)V", line = 39)
    public class282(int arg0, class322 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!vca", name = "d", descriptor = "(I)Z", line = 42)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!vca", name = "<init>", descriptor = "(Ldh;)V", line = 73)
    public class282(class322 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!vca", name = "e", descriptor = "(I)I", line = 76)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(II)V", line = 90)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(Z)V", line = 100)
