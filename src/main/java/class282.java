...
public class class282 {
    ...
    @OriginalMember(owner = "client!sea", name = "finalize", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(II)Z", line = 51)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!sea", name = "b", descriptor = "(II)V", line = 91)
    ...
    @OriginalMember(owner = "client!sea", name = "<init>", descriptor = "(Lep;II)V", line = 129)
