...
public class class282 extends class601 {
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(Lmc;II)V")
    ...
    @OriginalMember(owner = "client!uga", name = "d", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(IIZILha;I)V")
