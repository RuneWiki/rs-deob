...
public class class282 extends class72 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IZI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!sm", name = "b", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(II)V", line = 32)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!sm", name = "b", descriptor = "(II)I", line = 72)
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(Lcq;)V", line = 119)
    public class282(class464 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(ILcq;)V", line = 138)
    public class282(int arg0, class464 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ZI)V", line = 92)
    ...
    @OriginalMember(owner = "client!sm", name = "d", descriptor = "(I)I", line = 104)
    public final int method1843(int arg0) {
        ++field4016;
        return arg0 != 27669 ? 39 : super.field1282;
    }

    @OriginalMember(owner = "client!sm", name = "e", descriptor = "(I)Z", line = 127)
