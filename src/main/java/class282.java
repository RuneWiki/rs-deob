...
public abstract class class282 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(BIILs;IIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIII[II[IZII)V", line = 149)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(BLjava/lang/String;Z)V", line = 260)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ILgba;I)V", line = 272)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IILgba;IIII[ILgba;IZ)V", line = 321)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IZLgba;IILgba;III)V", line = 365)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ILgba;Lgba;I[ZBLgba;IIIIILgba;IZ)V", line = 427)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lcv;[II[ZLed;Lcv;IIZIZB)V", line = 489)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(B)V", line = 699)
