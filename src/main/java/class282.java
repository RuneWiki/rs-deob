...
public class class282 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lcp;IZILcp;)I")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IILti;I)V")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(BILti;)V")
