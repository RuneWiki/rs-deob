...
public class class282 extends class245 implements class334 {
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(ZILca;)V")
    ...
    @OriginalMember(owner = "client!vca", name = "<init>", descriptor = "(Lhl;Lkt;II[BII)V")
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(IIIIII[BLkt;I)V")
    ...
    @OriginalMember(owner = "client!vca", name = "<init>", descriptor = "(Lhl;II[III)V")
    ...
    @OriginalMember(owner = "client!vca", name = "<init>", descriptor = "(Lhl;Lkt;II[FII)V")
    ...
    @OriginalMember(owner = "client!vca", name = "<init>", descriptor = "(Lhl;Lkt;Lkq;II)V")
