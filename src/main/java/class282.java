...
public class class282 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Lpn;)V", line = 14)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!le", name = "b", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(II)Lwh;", line = 47)
    ...
    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "(Ler;Lfa;)V", line = 106)
