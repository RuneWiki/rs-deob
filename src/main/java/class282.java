...
public class class282 extends class29 {
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(B)[B")
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(BII)[B")
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "([BB)V")
