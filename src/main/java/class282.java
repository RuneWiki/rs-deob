...
public class class282 extends class223 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "([B)V", line = 18)
    public class282(byte[] arg0) {
        this.field4107 = arg0;
    }

    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(III)Lhr;", line = 27)
