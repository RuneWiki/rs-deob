...
public class class282 implements class127 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(II)Loc;")
    ...
    @OriginalMember(owner = "client!qd", name = "b", descriptor = "(II)Lno;")
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lum;Lum;Lum;)V")
