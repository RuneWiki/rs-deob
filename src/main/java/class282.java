...
public class class282 extends class287 implements class218 {
    ...
    @OriginalMember(owner = "client!pt", name = "d", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IBLsk;II)V", line = 15)
    ...
    @OriginalMember(owner = "client!pt", name = "c", descriptor = "(Z)I", line = 176)
    public final int method257(boolean arg0) {
        field4265++;
        return arg0 ? -117 : 0;
    }

    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Z)Z", line = 188)
    public final boolean method254(boolean arg0) {
        field4257++;
        return !arg0;
    }

    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(ILtq;)V", line = 200)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Ltq;I)V", line = 211)
    ...
    @OriginalMember(owner = "client!pt", name = "b", descriptor = "(Ltq;I)Lcj;", line = 225)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(B)I", line = 237)
    ...
    @OriginalMember(owner = "client!pt", name = "<init>", descriptor = "(IIIIILgo;)V", line = 247)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(BLtq;)V", line = 261)
    ...
    @OriginalMember(owner = "client!pt", name = "f", descriptor = "(I)V", line = 272)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Ltq;III)Z", line = 285)
    ...
    @OriginalMember(owner = "client!pt", name = "b", descriptor = "(Z)V", line = 295)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "([JB[Ljava/lang/Object;)V", line = 305)
    ...
    @OriginalMember(owner = "client!pt", name = "b", descriptor = "(B)I", line = 316)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(BILtq;)Lns;", line = 327)
