...
public class class282 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ZIILpe;II)Lsj;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ILap;)V")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IILap;)V")
