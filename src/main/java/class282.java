...
public class class282 extends class424 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Lrg;BI)V", line = 4)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Liq;I)Z", line = 97)
    ...
    @OriginalMember(owner = "client!hm", name = "g", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "(IB)[I", line = 140)
    ...
    @OriginalMember(owner = "client!hm", name = "<init>", descriptor = "()V", line = 412)
    public class282() {
        super(0, true);
    }

    @OriginalMember(owner = "client!hm", name = "d", descriptor = "(B)V", line = 401)
    ...
    @OriginalMember(owner = "client!hm", name = "c", descriptor = "(I)V", line = 415)
    ...
    @OriginalMember(owner = "client!hm", name = "c", descriptor = "(III)V", line = 425)
    ...
    @OriginalMember(owner = "client!hm", name = "h", descriptor = "(I)V", line = 444)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IIIBIII)V", line = 687)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "([[IBIIILjava/util/Random;I)V", line = 726)
