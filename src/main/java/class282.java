...
public class class282 extends class319 implements class392 {
    ...
    @OriginalMember(owner = "client!wja", name = "a", descriptor = "(Lha;Lwea;ZIIII)V")
    ...
    @OriginalMember(owner = "client!wja", name = "a", descriptor = "(Lha;B)Lel;")
    ...
    @OriginalMember(owner = "client!wja", name = "a", descriptor = "(ILha;)Ldfa;")
    ...
    @OriginalMember(owner = "client!wja", name = "b", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!wja", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!wja", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!wja", name = "<init>", descriptor = "(Lha;Lpu;IIIIIZIIIIIII)V")
    ...
    @OriginalMember(owner = "client!wja", name = "a", descriptor = "(Lhj;I)V")
    ...
    @OriginalMember(owner = "client!wja", name = "a", descriptor = "(IIILha;)Z")
