...
public class class282 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IIIIIIIIII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(I)V", line = 645)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Z)I", line = 668)
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(J[I[S[S)V", line = 678)
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "()V", line = 691)
    protected class282() {
    }
