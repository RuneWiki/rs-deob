...
public class class282 extends class439 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IIIIIBII)V", line = 9)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IBI)V", line = 71)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(III)V", line = 92)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(BII)V", line = 105)
    ...
    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "(IIIIIII)V", line = 138)
