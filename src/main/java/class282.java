...
public class class282 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(ZIBILps;)V", line = 3)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(ZII)I", line = 113)
