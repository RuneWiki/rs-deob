...
public class class282 extends class424 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IILfa;II)V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Loa;B)V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lfca;I)V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(FFFFFFLfa;II)V")
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(Lsv;IIZ)V")
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(Lsv;II[III)V")
