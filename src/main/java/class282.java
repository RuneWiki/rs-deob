...
public class class282 extends class317 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "([B[IIIIIIIIIIILta;II)V")
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!we", name = "B", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "(Lsr;Lfj;[Lef;[I[I)V")
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "([B[IIIIIIIIIIILta;II)V")
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(CIIIZLta;II)V")
