...
public class class282 extends class207 {
    ...
    @OriginalMember(owner = "client!wja", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!wja", name = "a", descriptor = "(IB)V", line = 24)
    ...
    @OriginalMember(owner = "client!wja", name = "a", descriptor = "(B)Z", line = 36)
    ...
    @OriginalMember(owner = "client!wja", name = "c", descriptor = "(I)I", line = 51)
    ...
    @OriginalMember(owner = "client!wja", name = "d", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!wja", name = "<init>", descriptor = "(Lrd;)V", line = 73)
    public class282(class355 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!wja", name = "a", descriptor = "(Lda;)V", line = 81)
    public static final void method1842(class67 arg0) {
        class157.field2118 = arg0;
    }

    @OriginalMember(owner = "client!wja", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!wja", name = "b", descriptor = "(IB)I", line = 107)
    ...
    @OriginalMember(owner = "client!wja", name = "<init>", descriptor = "(ILrd;)V", line = 127)
