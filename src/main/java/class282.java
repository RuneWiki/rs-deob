...
public class class282 extends class241 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "()Leia;")
    public final class241 method681() {
        return (class241) this.field3434.method1723(-20665);
    }

    @OriginalMember(owner = "client!sm", name = "d", descriptor = "()Leia;")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lmc;Lte;)V")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lte;)V")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Leia;)V")
    public final synchronized void method1689(class241 arg0) {
        this.field3434.method1731(arg0, (byte) 119);
    }

    @OriginalMember(owner = "client!sm", name = "b", descriptor = "(Leia;)V")
