...
public class class282 extends class270 {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(II)I", line = 23)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Z)V", line = 62)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(Z)V", line = 80)
