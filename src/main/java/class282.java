...
public class class282 extends class17 {
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "()V", line = 19)
    public class282() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ns", name = "h", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(II)[I", line = 54)
    ...
    @OriginalMember(owner = "client!ns", name = "i", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lwm;II)V", line = 188)
    ...
    @OriginalMember(owner = "client!ns", name = "g", descriptor = "(I)V", line = 237)
