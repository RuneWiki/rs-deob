...
public class class282 implements class589 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "([IIJLhj;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ILft;)[Lsha;")
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(B)Liga;")
