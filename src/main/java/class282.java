...
public class class282 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(ILda;IZII)Lda;", line = 4)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(ZIII)I", line = 154)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Lun;I)V", line = 285)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IBLun;)V", line = 306)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(I)V", line = 521)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(B)V", line = 551)
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(I)V", line = 585)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IIIZLda;IBI)Lda;", line = 632)
