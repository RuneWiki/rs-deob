...
public class class282 extends class515 {
    ...
    @OriginalMember(owner = "client!tia", name = "a", descriptor = "(IF)V", line = 6)
    ...
    @OriginalMember(owner = "client!tia", name = "<init>", descriptor = "(IIIIIF)V", line = 17)
    public class282(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!tia", name = "b", descriptor = "(B)V", line = 21)
    public static void method1623(byte arg0) {
        field3277 = null;
        int var1 = 2 % ((arg0 - 39) / 55);
    }

    @OriginalMember(owner = "client!tia", name = "a", descriptor = "(BIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!tia", name = "a", descriptor = "(II)I", line = 50)
