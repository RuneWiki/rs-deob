...
public class class282 implements class196 {
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(I)Loh;", line = 5)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(II)V", line = 21)
    ...
    @OriginalMember(owner = "client!hfa", name = "b", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(Ljava/io/File;Ljava/lang/String;B)V", line = 74)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(III)Z", line = 89)
    ...
    @OriginalMember(owner = "client!hfa", name = "<init>", descriptor = "(ILor;Lma;II)V", line = 101)
