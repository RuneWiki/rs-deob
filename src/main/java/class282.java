...
public class class282 extends class148 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(ILdh;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!fr", name = "e", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(III)V", line = 31)
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "()V", line = 106)
    public class282() {
        super(1, false);
    }

    @OriginalMember(owner = "client!fr", name = "f", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(II)[I", line = 128)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(BI)V", line = 165)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(ZI)[[I", line = 180)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Ldh;I)Ljava/lang/String;", line = 224)
