...
public class class282 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(II)I", line = 7)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IBI)Z", line = 20)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 38)
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "(I)V", line = 90)
    public class282(int arg0) {
        this.field3703 = arg0;
    }

    @OriginalMember(owner = "client!fr", name = "toString", descriptor = "()Ljava/lang/String;", line = 98)
    public final String toString() {
        field3700++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(B)V", line = 115)
