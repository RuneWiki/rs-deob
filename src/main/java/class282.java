...
public class class282 extends class270 {
    ...
    @OriginalMember(owner = "client!de", name = "d", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!de", name = "d", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "(Lhv;Lcc;)V", line = 67)
