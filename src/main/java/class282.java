...
public abstract class class282 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIILlk;ZLlk;III)V", line = 20)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lth;BLth;IIIZ[ZIZLdf;[I)V", line = 62)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Ls;IBIIIIII)V", line = 277)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ZIIIILlk;III[ILlk;)V", line = 395)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Llk;ZI[ZILlk;ILlk;BIIILlk;II)V", line = 443)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ZI[IIBII[III)V", line = 521)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Llk;IB)V", line = 624)
