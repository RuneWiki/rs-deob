...
public class class282 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(ILvt;)Laa;", line = 26)
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(II)V", line = 70)
    public class282(int arg0, int arg1) {
        this.field4099 = arg0;
        this.field4100 = arg1;
    }

    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(Lgp;I)V", line = 81)
