...
public class class282 {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(II[[[BIILr;IIIIIII)V")
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ILmo;I)V")
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Lmo;I)V")
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ILvg;)V")
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Lvg;B)V")
