...
public class class282 extends class405 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IBLha;I)Z")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lha;Z)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ILvs;ZILha;II)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IILha;)Z")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lvd;Ljava/awt/Canvas;Ld;III)Lha;")
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(Lha;B)Lc;")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ILow;)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lha;I)Lria;")
