...
public class class282 implements class369 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IB)Lne;")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(II)Lko;")
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Lam;Lam;Lam;)V")
