...
public class class282 extends class43 {
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(ILnh;)V", line = 25)
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(II)V", line = 109)
    public class282(int arg0, int arg1) {
        this.field3677 = arg0;
        this.field3680 = arg1;
    }

    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(BILjava/lang/String;)V", line = 144)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(BC)Z", line = 226)
