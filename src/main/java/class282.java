...
public class class282 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(I)I", line = 15)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(BI)I", line = 29)
    private final int method1753(byte arg0, int arg1) {
        field3997++;
        return arg0 > -70 ? 89 : (int) (this.field3998 >> class512.field6851 * arg1) & 0xF;
    }

    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Lea;I)V", line = 41)
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Lea;)V", line = 51)
    public class282(class512 arg0) {
        this.field3998 = arg0.field6841;
        this.field4000 = 1;
    }

    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(II)Lea;", line = 60)
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "([Lea;)V", line = 70)
    public class282(class512[] arg0) {
