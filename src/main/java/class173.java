...
public class class173 extends class337 {
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(III)Z", line = 25)
    ...
    @OriginalMember(owner = "client!kh", name = "d", descriptor = "(B)Z", line = 39)
