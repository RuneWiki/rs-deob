...
public class class173 implements class238 {
    ...
    @OriginalMember(owner = "client!pja", name = "<init>", descriptor = "()V", line = 196)
    ...
    @OriginalMember(owner = "client!pja", name = "a", descriptor = "(III)V", line = 12)
    ...
    @OriginalMember(owner = "client!pja", name = "a", descriptor = "(I[I)V", line = 42)
    ...
    @OriginalMember(owner = "client!pja", name = "a", descriptor = "(IB)I", line = 75)
    ...
    @OriginalMember(owner = "client!pja", name = "a", descriptor = "(II)V", line = 110)
    ...
    @OriginalMember(owner = "client!pja", name = "a", descriptor = "(ILjava/awt/Component;ZB)V", line = 127)
    ...
    @OriginalMember(owner = "client!pja", name = "b", descriptor = "(II)V", line = 164)
