...
public class class173 extends class136 {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IILiv;)V", line = 3)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IIII)Z", line = 17)
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "()V", line = 32)
    public class173() {
        super(3, false);
    }

    @OriginalMember(owner = "client!rh", name = "f", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(II)[I", line = 51)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(ZIII)I", line = 102)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(BI)[[I", line = 116)
