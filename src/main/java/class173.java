...
public class class173 extends class168 implements class164 {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lya;Z)V")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lya;ZI)Lt;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(ZLya;)V")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(BLya;II)Z")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(ILya;)V")
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(Lya;Ljt;IIIIIZIIIIII)V")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lya;I)Lag;")
