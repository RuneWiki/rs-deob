...
public class class173 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Lja;[II[I[I)V")
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Lja;[II)V")
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Lja;[IIII[I[I)V")
