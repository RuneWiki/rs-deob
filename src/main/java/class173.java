...
public class class173 extends class158 {
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(Ljs;I)I", line = 23)
    ...
    @OriginalMember(owner = "client!ada", name = "c", descriptor = "(I)Z", line = 52)
    ...
    @OriginalMember(owner = "client!ada", name = "d", descriptor = "(I)V", line = 76)
