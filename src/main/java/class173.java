...
public class class173 extends class223 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IJ)V", line = 10)
    ...
    @OriginalMember(owner = "client!en", name = "e", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IB)V", line = 105)
    public void method159(int arg0, byte arg1) {
        this.field2876[this.field2890++] = (byte) ((class37.method242(255, arg1) >> 1) + 127);
        ++field2881;
    }

    @OriginalMember(owner = "client!en", name = "b", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(Z)V", line = 130)
    ...
    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "(IIIIIF)V", line = 149)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IZI)I", line = 173)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IIB)V", line = 195)
    ...
    @OriginalMember(owner = "client!en", name = "c", descriptor = "(Z)V", line = 206)
