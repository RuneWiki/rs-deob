...
public class class173 {
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(I)Llo;")
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(B)Llo;")
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Llo;I)V")
    ...
    @OriginalMember(owner = "client!tr", name = "d", descriptor = "(I)Llo;")
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "([Lsj;ZI)V")
