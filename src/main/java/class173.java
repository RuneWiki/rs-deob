...
public class class173 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(II)V", line = 166)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(ILwo;)V", line = 198)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IZLaq;IILc;Lem;I)V", line = 221)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(I)V", line = 274)
