...
public class class173 extends class147 {
    ...
    @OriginalMember(owner = "client!gg", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(B)Ljava/lang/String;", line = 20)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 42)
    public class173(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ZLjagtheora/ogg/OggPacket;)V", line = 53)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Z)F", line = 128)
    public final float method1263(boolean arg0) {
        ++field2517;
        return !arg0 ? -0.14213197F : this.field2503;
    }

    @OriginalMember(owner = "client!gg", name = "c", descriptor = "(I)Ljava/lang/String;", line = 139)
    public final String method1264(int arg0) {
        ++field2504;
        return arg0 >= -28 ? null : this.field2514;
    }

    @OriginalMember(owner = "client!gg", name = "g", descriptor = "(I)F", line = 158)
