...
public class class173 implements class409 {
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(ZB)V", line = 5)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Lwk;III[I[I)Llga;", line = 24)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Z)V", line = 82)
    ...
    @OriginalMember(owner = "client!dfa", name = "b", descriptor = "(B)V", line = 106)
    ...
    @OriginalMember(owner = "client!dfa", name = "<init>", descriptor = "(Lcb;Lcb;Ltp;)V", line = 118)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(B)Z", line = 129)
