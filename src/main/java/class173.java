...
public class class173 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(B)Ldh;", line = 4)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lac;I[[BI[[BILac;Z[[I[[B[[BILen;)V", line = 39)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IZ)V", line = 51)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 67)
