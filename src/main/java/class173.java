...
public class class173 extends class38 {
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ILrw;)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lkca;BLwq;)I")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lfg;IB)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lup;Lrga;)Ldv;")
    ...
    @OriginalMember(owner = "client!ad", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Ld;Lla;Ljava/lang/Integer;)Lha;")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(BLew;)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ZZBILaf;)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Ljagdx/IDirect3D;IBILjagdx/D3DPRESENT_PARAMETERS;I)Z")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(IIZI[III)Lug;")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lwk;B)I")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lem;I)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Ldv;)V")
    ...
    @OriginalMember(owner = "client!ad", name = "c", descriptor = "(ZZ)Lfg;")
    ...
    @OriginalMember(owner = "client!ad", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/ep;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Lvda;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Ld;Lla;I)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lkca;BII[BI)Liv;")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(BI)Lsha;")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Luia;I)I")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ILjagdx/IDirect3DPixelShader;)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Laf;IIZ)V")
    ...
    @OriginalMember(owner = "client!ad", name = "c", descriptor = "(BZ)Lrr;")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Leu;B)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lrf;IIB)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ILlea;)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lkca;IIB[BIZI)Lug;")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(BI[[IZ)Lau;")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lrf;IIILrr;II)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ILwq;Lkca;)Z")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ILrf;)I")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ILkca;Lwq;)Z")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lss;Lss;FLss;)Lss;")
    public final class506 method1251(class506 arg0, class506 arg1, float arg2, class506 arg3) {
        return arg2 < 0.5F ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(IIBLwq;Lkca;)Lug;")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lui;B)I")
    ...
    @OriginalMember(owner = "client!ad", name = "c", descriptor = "(II)Lup;")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(II)Lrga;")
    public final class290 method1255(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(BLjagdx/IDirect3DVertexShader;)V")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(IIBZIILkca;[F)Lug;")
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(I[Len;)Leu;")
