...
public class class173 extends class183 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(III)Lsn;", line = 11)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ILvm;Lwm;IILol;IIZLvm;ZI)Llg;", line = 18)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(I)V", line = 250)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Lam;Lam;Z)V", line = 264)
