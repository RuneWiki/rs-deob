...
public class class173 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ILfo;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "(Lla;)V", line = 124)
    public class173(class395 arg0) {
        this.field2791 = arg0;
    }

    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "(Lla;Lll;)V", line = 131)
    public class173(class395 arg0, class490 arg1) {
        this.field2791 = arg0;
        this.field2787 = arg1;
    }

    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ILjava/lang/String;I)Z", line = 57)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(I)V", line = 108)
