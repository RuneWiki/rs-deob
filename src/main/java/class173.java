...
public abstract class class173 {
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(ILji;)V", line = 8)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(Z)V", line = 57)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(B)Ljava/net/Socket;", line = 70)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(I[BI)I", line = 84)
