...
public class class173 {
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IIZ)I", line = 7)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(B)V", line = 91)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!kk", name = "c", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(I[BLjava/lang/String;I)I", line = 138)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IB)V", line = 180)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(II)Ltq;", line = 194)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(Ldd;ILpj;)V", line = 234)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(II)V", line = 258)
