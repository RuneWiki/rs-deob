...
public class class173 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IBI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "([[BZLer;)V", line = 50)
    ...
    @OriginalMember(owner = "client!uq", name = "b", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "(IIIIIIIIIZI)V", line = 135)
