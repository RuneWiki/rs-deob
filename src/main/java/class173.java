...
public class class173 extends class140 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lih;I[BIZIII)Lns;")
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Lih;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ILih;II[IZ)Lns;")
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Lih;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Lih;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Lih;IIIZ[I)V")
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Lih;IIII[I)V")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ILih;IIIB)Lns;")
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Lih;IIIIIIZ)V")
