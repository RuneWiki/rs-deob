...
public class class173 {
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(IIBI)I", line = 3)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(ZIIII)I", line = 35)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(BI)V", line = 57)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(I)V", line = 96)
