...
public class class173 extends class184 {
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(Ljava/awt/Component;ZB)Lst;")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
