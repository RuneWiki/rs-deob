...
public class class173 extends class32 {
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(IIIIIF)V", line = 10)
    ...
    @OriginalMember(owner = "client!hq", name = "d", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!hq", name = "e", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IB)V", line = 106)
    public void method578(int arg0, byte arg1) {
        ++field2321;
        this.field2319[this.field2308++] = (byte) (127 + class183.method1117(arg1 >> 1, 127));
    }

    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IBI)V", line = 119)
