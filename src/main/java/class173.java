...
public class class173 extends class432 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(B)I", line = 6)
    public final int method1080(byte arg0) {
        return arg0 < 81 ? 70 : this.field2500;
    }

    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(I)J", line = 17)
    ...
    @OriginalMember(owner = "client!pd", name = "f", descriptor = "(I)I", line = 31)
    ...
    @OriginalMember(owner = "client!pd", name = "e", descriptor = "(I)I", line = 41)
    ...
    @OriginalMember(owner = "client!pd", name = "c", descriptor = "(B)I", line = 51)
