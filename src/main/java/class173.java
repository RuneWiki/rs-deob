...
public class class173 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ILjn;[IJ)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ZI)Ljb;")
    ...
    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "(ILuu;Luu;Luk;)V")
