...
public class class173 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(ZLuq;)V", line = 5)
    ...
    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "(I)V", line = 83)
    public class173(int arg0) {
        this.field2756 = arg0;
    }

    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "(IIIIII)V", line = 90)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(ZLqj;)V", line = 33)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!uq", name = "b", descriptor = "(Z)Luq;", line = 69)
