...
public class class173 extends class80 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(ILha;)I")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IILnn;)V")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lgh;B)V")
