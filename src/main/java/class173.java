...
public class class173 extends class31 {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(BLsg;)V", line = 4)
    ...
    @OriginalMember(owner = "client!se", name = "<init>", descriptor = "(Lbt;II[B)V", line = 42)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lsg;Z)I", line = 54)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(B)V", line = 93)
