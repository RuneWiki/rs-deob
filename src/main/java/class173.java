...
public class class173 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(BI)Lul;")
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ZI)Ldn;")
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(Lmt;ILhh;Lhh;Lhh;)V")
