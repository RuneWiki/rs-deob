...
public class class173 implements Runnable {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IIIILjava/lang/Object;)Lgp;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ILjava/awt/datatransfer/Transferable;)Lgp;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Ljava/net/URL;I)Lgp;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(I)Lgp;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Ljava/lang/String;II)Lgp;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Ljava/lang/Runnable;BI)Lgp;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Class;)Lgp;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IIZLjava/awt/Component;)Lgp;")
    ...
    @OriginalMember(owner = "client!or", name = "c", descriptor = "(I)Ldh;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Ljava/lang/String;Z)Lgp;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ILjava/lang/String;)Lgp;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Ljava/lang/Class;I)Lgp;")
    public final class464 method1190(Class arg0, int arg1) {
        return arg1 <= 33 ? null : this.method1195((byte) 45, 0, 0, arg0, 20);
    }

    @OriginalMember(owner = "client!or", name = "d", descriptor = "(I)Lgp;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(II)Lgp;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Ljava/awt/Frame;I)Lgp;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(BIILjava/lang/Object;I)Lgp;")
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(Ljava/lang/Class;I)Lgp;")
    public final class464 method1196(Class arg0, int arg1) {
        return arg1 == 10 ? this.method1195((byte) 45, 0, 0, arg0, 11) : null;
    }

    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ILjava/awt/Component;Z)Lgp;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ILjava/lang/String;Z)Lgp;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ILjava/awt/Component;IZ[ILjava/awt/Point;)Lgp;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;I[Ljava/lang/Class;)Lgp;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IIIII)Lgp;")
