...
public class class173 extends class327 implements class381 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lwm;B)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(ILwm;I)Lgn;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIILwm;ZLhp;Z)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIBLwm;)Z")
    public final boolean method14(int arg0, int arg1, byte arg2, class364 arg3) {
        field2363++;
        return arg2 >= -107;
    }

    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(IIIIILgq;)V")
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(Lwm;B)Lnf;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(BLwm;)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lwm;I)V")
