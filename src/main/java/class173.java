...
public class class173 extends class354 implements class670 {
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(Loa;I)Lok;", line = 3)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Loa;B)V", line = 45)
    ...
    @OriginalMember(owner = "client!op", name = "e", descriptor = "(I)I", line = 57)
    ...
    @OriginalMember(owner = "client!op", name = "c", descriptor = "(B)I", line = 67)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(Loa;Lbfa;IIIIIZIIIIIII)V", line = 83)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IILoa;I)Z", line = 97)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Loa;I)V", line = 117)
    ...
    @OriginalMember(owner = "client!op", name = "d", descriptor = "(B)Z", line = 129)
    ...
    @OriginalMember(owner = "client!op", name = "g", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(B)I", line = 152)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ZIZIILfl;Loa;)V", line = 163)
    ...
    @OriginalMember(owner = "client!op", name = "c", descriptor = "(Loa;I)V", line = 175)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(I)V", line = 198)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 208)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IILoa;)Lba;", line = 285)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(BLjo;I)Lu;", line = 298)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(I)Z", line = 314)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(B)I", line = 325)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ILoa;)Lgr;", line = 336)
    ...
    @OriginalMember(owner = "client!op", name = "d", descriptor = "(I)V", line = 351)
