...
public abstract class class173 extends class28 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!i", name = "c", descriptor = "(B)I", line = 69)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Z)[Lsaa;", line = 80)
