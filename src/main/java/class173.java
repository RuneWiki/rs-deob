...
public class class173 {
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(BLig;)Lcn;")
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(I)Lwm;")
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(Z)Lwm;")
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(Lwm;I)V")
