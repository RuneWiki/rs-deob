...
public class class173 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "([BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(Lte;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(Lte;Ljaclib/memory/Buffer;)V", line = 21)
