...
public class class173 extends class208 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lkh;B)Lul;")
    ...
    @OriginalMember(owner = "client!ne", name = "c", descriptor = "(II)Lmh;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ILms;I)I")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lms;III)V")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(III)Leo;")
    ...
    @OriginalMember(owner = "client!ne", name = "c", descriptor = "(I)Lvk;")
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(ILr;Lr;Lrb;Lcl;IIZ)V")
