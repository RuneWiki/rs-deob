...
public class class173 extends class376 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(BILeb;)Ljava/lang/String;", line = 8)
    ...
    @OriginalMember(owner = "client!ne", name = "c", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Laa;)V", line = 51)
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(I)V", line = 150)
