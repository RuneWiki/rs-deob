...
public class class173 extends class366 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(B[IIII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(I[IIB)Z", line = 37)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IIB)Z", line = 67)
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 282)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IIIII)Z", line = 98)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IJ)V", line = 130)
    ...
    @OriginalMember(owner = "client!ne", name = "d", descriptor = "(B)V", line = 203)
    ...
    @OriginalMember(owner = "client!ne", name = "e", descriptor = "(B)V", line = 241)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(III[I)Z", line = 253)
