...
public class LruCache {
    ...
    @OriginalMember(owner = "client!s", name = "e", descriptor = "Lw;")
    private DoublyLinkable field347 = new DoublyLinkable();

    @OriginalMember(owner = "client!s", name = "i", descriptor = "Lpb;")
    ...
    @OriginalMember(owner = "client!s", name = "h", descriptor = "Lt;")
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Lw;IJ)V")
