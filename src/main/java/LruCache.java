...
public class LruCache {
    ...
    @OriginalMember(owner = "client!t", name = "g", descriptor = "Lx;")
    private DoublyLinkable field368 = new DoublyLinkable();

    @OriginalMember(owner = "client!t", name = "j", descriptor = "Lu;")
    private HashTable field371 = new HashTable(1024, 0);

    @OriginalMember(owner = "client!t", name = "k", descriptor = "Lqb;")
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(ZLx;J)V")
