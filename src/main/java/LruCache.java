...
public class LruCache {
    ...
    @OriginalMember(owner = "client!s", name = "e", descriptor = "Lt;")
    private HashTable field293 = new HashTable(3, 1024);

    @OriginalMember(owner = "client!s", name = "f", descriptor = "Lpb;")
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(J)Ldb;")
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Ldb;JZ)V")
