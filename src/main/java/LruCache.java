...
public class LruCache {
    ...
    @OriginalMember(owner = "client!t", name = "e", descriptor = "Lx;")
    private DoublyLinkable field362 = new DoublyLinkable();

    @OriginalMember(owner = "client!t", name = "h", descriptor = "Lu;")
    private HashTable field365 = new HashTable(1024, 0);

    @OriginalMember(owner = "client!t", name = "i", descriptor = "Lqb;")
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IJLx;)V")
