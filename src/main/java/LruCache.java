...
public class LruCache {
    ...
    @OriginalMember(owner = "client!s", name = "d", descriptor = "Lt;")
    private HashTable field288 = new HashTable((byte) 84, 1024);

    @OriginalMember(owner = "client!s", name = "e", descriptor = "Lpb;")
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(JLdb;B)V")
