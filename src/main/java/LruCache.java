...
public class LruCache {
    ...
    @OriginalMember(owner = "client!s", name = "f", descriptor = "Lw;")
    private DoublyLinkable field357 = new DoublyLinkable();

    @OriginalMember(owner = "client!s", name = "j", descriptor = "Lpb;")
    ...
    @OriginalMember(owner = "client!s", name = "i", descriptor = "Lt;")
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Lw;JZ)V")
