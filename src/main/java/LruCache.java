...
public class LruCache {
    ...
    @OriginalMember(owner = "client!r", name = "d", descriptor = "Ls;")
    private HashTable field268 = new HashTable(false, 1024);

    @OriginalMember(owner = "client!r", name = "e", descriptor = "Lob;")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(J)Lcb;")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lcb;JB)V")
