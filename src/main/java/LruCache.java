...
public class LruCache {
    ...
    @OriginalMember(owner = "client!s", name = "f", descriptor = "Lt;")
    private HashTable field292 = new HashTable(1024, 0);

    @OriginalMember(owner = "client!s", name = "g", descriptor = "Lpb;")
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Ldb;JI)V")
