...
public class LruCache {
    ...
    @OriginalMember(owner = "client!t", name = "f", descriptor = "Lx;")
    private DoublyLinkable field364 = new DoublyLinkable();

    @OriginalMember(owner = "client!t", name = "i", descriptor = "Lu;")
    private HashTable field367 = new HashTable(1024, (byte) 1);

    @OriginalMember(owner = "client!t", name = "j", descriptor = "Lqb;")
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(J)Lx;")
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lx;JB)V")
