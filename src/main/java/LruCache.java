...
public class LruCache {
    ...
    @OriginalMember(owner = "client!t", name = "c", descriptor = "Lx;")
    private DoublyLinkable field357 = new DoublyLinkable();

    @OriginalMember(owner = "client!t", name = "f", descriptor = "Lu;")
    private HashTable field360 = new HashTable((byte) 81, 1024);

    @OriginalMember(owner = "client!t", name = "g", descriptor = "Lqb;")
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lx;JI)V")
