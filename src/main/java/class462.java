...
public class class462 {
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(BJ)Lww;", line = 10)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(JB)V", line = 57)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(JLww;I)V", line = 86)
    ...
    @OriginalMember(owner = "client!cca", name = "<init>", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(BI)Z", line = 119)
