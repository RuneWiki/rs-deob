...
public class class462 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IILbt;)V")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lbt;I)V")
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(Z)Lpr;")
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(I)Lpr;")
