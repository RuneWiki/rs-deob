...
public class class462 extends class201 {
    ...
    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(B)J", line = 5)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(BJ)I", line = 21)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Z)V", line = 59)
    ...
    @OriginalMember(owner = "client!ri", name = "c", descriptor = "(B)J", line = 73)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(B)J", line = 112)
