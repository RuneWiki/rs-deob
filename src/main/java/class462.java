...
public class class462 implements class346 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I)Lqfa;")
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(Leq;Ljava/lang/String;)V")
    private class462(class209 arg0, String arg1) {
        this.field6658 = arg1;
        this.field6657 = arg0;
    }

    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lvk;Leq;B)V")
