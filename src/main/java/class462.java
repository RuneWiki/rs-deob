...
public class class462 extends class85 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IIB)Z", line = 21)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(III)V", line = 35)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IIBII)V", line = 55)
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(Luu;Luu;Lbl;)V", line = 77)
