...
public class class462 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(II)V", line = 48)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lia;II)V", line = 63)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IIILia;)V", line = 87)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lch;I)V", line = 132)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(III)V", line = 165)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(B)V", line = 189)
