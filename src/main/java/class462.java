...
public class class462 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(ILoq;)I")
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lqa;)V")
