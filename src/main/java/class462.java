...
public class class462 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Lfk;B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(BI)[B", line = 32)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "([BLsv;B)V", line = 81)
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "()V", line = 105)
    public class462() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(III)V", line = 143)
    private class462(int arg0, int arg1, int arg2) {
    }

    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IZ)I", line = 159)
