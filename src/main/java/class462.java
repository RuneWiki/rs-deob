...
public class class462 extends class613 implements class49 {
    ...
    @OriginalMember(owner = "client!mu", name = "d", descriptor = "(Lr;I)Llf;")
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Lr;Lqp;IIIIIZIIIIIII)V")
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(IIIILrb;Lr;Z)V")
    ...
    @OriginalMember(owner = "client!mu", name = "m", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Lr;Z)V")
    ...
    @OriginalMember(owner = "client!mu", name = "c", descriptor = "(Lr;I)Lwj;")
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Lr;III)Z")
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(Lr;I)V")
