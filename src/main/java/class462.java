...
public class class462 extends class552 implements class624 {
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(I)Z", line = 5)
    public final boolean method1761(int arg0) {
        ++field6354;
        return arg0 != -28823 ? false : this.field6330.method1151((byte) -128);
    }

    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!sl", name = "e", descriptor = "(B)I", line = 27)
    ...
    @OriginalMember(owner = "client!sl", name = "b", descriptor = "(ILha;)Lww;", line = 38)
    ...
    @OriginalMember(owner = "client!sl", name = "b", descriptor = "(B)I", line = 92)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(BLha;)Lck;", line = 103)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(B)I", line = 115)
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "(Lha;Lqfa;IIIIIZII)V", line = 126)
    ...
    @OriginalMember(owner = "client!sl", name = "g", descriptor = "(B)Z", line = 138)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(ZLha;)V", line = 149)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Lbk;B)V", line = 161)
    ...
    @OriginalMember(owner = "client!sl", name = "c", descriptor = "(B)I", line = 172)
    ...
    @OriginalMember(owner = "client!sl", name = "d", descriptor = "(I)Z", line = 182)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(ILha;)V", line = 192)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(IB)V", line = 203)
    ...
    @OriginalMember(owner = "client!sl", name = "h", descriptor = "(I)I", line = 224)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Lha;B)V", line = 238)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Lha;IIB)Z", line = 262)
    ...
    @OriginalMember(owner = "client!sl", name = "c", descriptor = "(Z)V", line = 286)
    ...
    @OriginalMember(owner = "client!sl", name = "b", descriptor = "(Z)Z", line = 298)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Lkf;Lha;IIIZI)V", line = 312)
    ...
    @OriginalMember(owner = "client!sl", name = "g", descriptor = "(I)V", line = 335)
