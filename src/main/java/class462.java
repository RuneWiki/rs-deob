...
public class class462 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ZLjava/lang/String;ILjava/lang/String;)Ljava/io/File;", line = 29)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/io/File;", line = 131)
