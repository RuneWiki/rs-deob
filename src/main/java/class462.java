...
public class class462 extends class731 {
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(IIII)I", line = 3)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!vv", name = "b", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!vv", name = "c", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!vv", name = "g", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!vv", name = "h", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!vv", name = "<init>", descriptor = "(I)V", line = 177)
