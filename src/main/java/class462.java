...
public class class462 extends class375 implements class317 {
    ...
    @OriginalMember(owner = "client!eaa", name = "d", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!eaa", name = "finalize", descriptor = "()V", line = 23)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(BLpu;Lpu;Lpu;Lbh;)Z", line = 44)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(IC)Z", line = 63)
    ...
    @OriginalMember(owner = "client!eaa", name = "e", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!eaa", name = "<init>", descriptor = "(Lok;III)V", line = 124)
    ...
    @OriginalMember(owner = "client!eaa", name = "<init>", descriptor = "(Lok;IIII)V", line = 141)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(III)V", line = 102)
