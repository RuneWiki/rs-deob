...
public class class462 {
    ...
    @OriginalMember(owner = "client!qg", name = "toString", descriptor = "()Ljava/lang/String;", line = 5)
    public final String toString() {
        field6502++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "(II)V", line = 15)
    public class462(int arg0, int arg1) {
        this.field6501 = arg0;
    }

    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(III)I", line = 109)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!qg", name = "b", descriptor = "(III)V", line = 147)
