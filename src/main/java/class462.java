...
public class class462 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ZLjava/lang/String;IB)V", line = 9)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Lbt;ILd;)V", line = 58)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ILkq;)V", line = 75)
