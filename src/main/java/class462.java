...
public class class462 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(I)Lgk;", line = 8)
    ...
    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(I)I", line = 31)
    ...
    @OriginalMember(owner = "client!jh", name = "c", descriptor = "(I)Lgk;", line = 53)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Z)Lgk;", line = 76)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ILgk;)V", line = 96)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(B)V", line = 118)
    ...
    @OriginalMember(owner = "client!jh", name = "d", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IIIIII)V", line = 159)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(II)Lrp;", line = 275)
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "()V", line = 305)
    public class462() {
