...
public abstract class class462 extends class404 {
    ...
    @OriginalMember(owner = "client!ij", name = "aa", descriptor = "(FFFFFFIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ij", name = "JA", descriptor = "()I", line = 100)
    public final int method369() {
        return this.field6475 + this.field6458 + this.field6453;
    }

    @OriginalMember(owner = "client!ij", name = "ja", descriptor = "()I", line = 107)
    public final int method370() {
        return this.field6464 + this.field6460 + this.field6478;
    }

    @OriginalMember(owner = "client!ij", name = "ka", descriptor = "(IIII)V", line = 127)
    ...
    @OriginalMember(owner = "client!ij", name = "UA", descriptor = "()I", line = 136)
    public final int method375() {
        return this.field6464;
    }

    @OriginalMember(owner = "client!ij", name = "qa", descriptor = "()I", line = 147)
    public final int method378() {
        return this.field6475;
    }

    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(FFFFFF)V", line = 159)
    ...
    @OriginalMember(owner = "client!ij", name = "D", descriptor = "(IIIIIII)V", line = 298)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(FFFFFFLea;II)V", line = 336)
    ...
    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "(Lfe;II)V", line = 364)
