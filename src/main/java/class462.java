...
public class class462 extends class701 implements class199 {
    ...
    @OriginalMember(owner = "client!va", name = "finalize", descriptor = "()V", line = 15)
    ...
    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(Ll;Lm;II)V", line = 19)
    ...
    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(Ll;Lm;[IIIII)V", line = 34)
    ...
    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(Ll;Lm;IIII)V", line = 39)
