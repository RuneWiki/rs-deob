...
public class class462 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(B)V", line = 112)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IJ[B)V", line = 141)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Z)V", line = 244)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(II[B)V", line = 261)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Ljava/awt/Component;Z)Len;", line = 330)
