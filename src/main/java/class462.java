...
public class class462 extends class195 {
    ...
    @OriginalMember(owner = "client!lm", name = "c", descriptor = "()Leq;")
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IIII[ILefa;)V")
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Lefa;IZ)V")
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lqk;)V")
