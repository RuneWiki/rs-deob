...
public class class462 extends class141 {
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Lbt;Lpt;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(Lei;II)V", line = 39)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!ck", name = "d", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IZ)V", line = 80)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ZI)V", line = 99)
    ...
    @OriginalMember(owner = "client!ck", name = "c", descriptor = "(I)Z", line = 113)
    public final boolean method55(int arg0) {
        ++field6684;
        return arg0 == 0;
    }

    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IBI)I", line = 124)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(B)V", line = 138)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IIIII)V", line = 163)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(III)V", line = 181)
