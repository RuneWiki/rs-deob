...
public class class462 {
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(I)Lui;", line = 11)
    ...
    @OriginalMember(owner = "client!ck", name = "b", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IIII)Lck;", line = 55)
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(IIIIB)V", line = 67)
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Lck;I)V", line = 78)
