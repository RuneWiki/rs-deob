...
public class class462 extends class100 {
    ...
    @OriginalMember(owner = "client!h", name = "d", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!h", name = "c", descriptor = "(I)I", line = 15)
    ...
    @OriginalMember(owner = "client!h", name = "f", descriptor = "(B)I", line = 112)
    ...
    @OriginalMember(owner = "client!h", name = "c", descriptor = "(B)I", line = 249)
    ...
    @OriginalMember(owner = "client!h", name = "b", descriptor = "(Z)J", line = 261)
    ...
    @OriginalMember(owner = "client!h", name = "c", descriptor = "(Z)V", line = 275)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(BILjava/lang/String;Z)Z", line = 287)
    ...
    @OriginalMember(owner = "client!h", name = "b", descriptor = "(I)I", line = 363)
