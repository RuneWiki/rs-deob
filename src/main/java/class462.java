...
public class class462 extends class82 {
    ...
    @OriginalMember(owner = "client!lb", name = "g", descriptor = "(I)I", line = 4)
    public final int method492(int arg0) {
        ++field6373;
        return arg0 != -1 ? 42 : this.field6374;
    }

    @OriginalMember(owner = "client!lb", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "()V", line = 40)
    public class462() {
        super(0, false);
    }

    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(JB)V", line = 43)
    ...
    @OriginalMember(owner = "client!lb", name = "h", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!lb", name = "b", descriptor = "(II)[[I", line = 86)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(B)Z", line = 155)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IILos;)V", line = 195)
