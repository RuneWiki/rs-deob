...
public class class462 extends class165 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!ch", name = "e", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(III[I)V", line = 30)
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!ch", name = "c", descriptor = "(III[I)V", line = 61)
    ...
    @OriginalMember(owner = "client!ch", name = "g", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "()V", line = 85)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(III[I)V", line = 96)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!ch", name = "d", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(III)V", line = 162)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "()Ldfa;", line = 172)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IIIIII)V", line = 196)
    ...
    @OriginalMember(owner = "client!ch", name = "f", descriptor = "(I)V", line = 231)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Ldfa;)V", line = 260)
    ...
    @OriginalMember(owner = "client!ch", name = "c", descriptor = "(I)V", line = 283)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(ILpt;)I", line = 322)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "([I)V", line = 349)
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "()V", line = 371)
    public class462() {
        this.method1026();
    }
}
