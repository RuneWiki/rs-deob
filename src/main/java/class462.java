...
public class class462 {
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(BZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(JJ)J", line = 36)
    public static long method2628(long arg0, long arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(ILiaa;)V", line = 62)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(II)V", line = 93)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(ILiaa;I)V", line = 185)
