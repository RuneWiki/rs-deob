...
public class class462 extends class10 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(IIB)V", line = 5)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(ILlf;IIII)Lfu;", line = 17)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(ZIB)V", line = 43)
    ...
    @OriginalMember(owner = "client!ks", name = "<init>", descriptor = "(IIIIIF)V", line = 54)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!ks", name = "d", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(II)Z", line = 99)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(B)V", line = 111)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Lfq;ZZ)V", line = 126)
