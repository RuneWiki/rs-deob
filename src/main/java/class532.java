...
public class class532 extends class546 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IZLwq;)V")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IIII[IILnc;[IIIZIBII)I")
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "(Lrr;)V")
