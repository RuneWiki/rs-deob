...
public class class532 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(II)[B", line = 7)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "(Z)V", line = 707)
    public class532(boolean arg0) {
        this.field7534 = arg0;
    }

    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(I)V", line = 666)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(I)V", line = 695)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ILvw;)V", line = 715)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "([BB)Lkr;", line = 783)
