...
public class class532 implements Runnable {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IIIIZILoi;)V", line = 5)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(I[BIB)V", line = 27)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Ljava/net/Socket;Lnt;)V", line = 333)
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(I)I", line = 103)
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(B)V", line = 121)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(II[BI)V", line = 157)
    ...
    @OriginalMember(owner = "client!qc", name = "finalize", descriptor = "()V", line = 204)
    protected final void finalize() {
        this.method3138((byte) -12);
        field7803++;
    }

    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IIIII)V", line = 212)
    ...
    @OriginalMember(owner = "client!qc", name = "c", descriptor = "(I)I", line = 238)
    ...
    @OriginalMember(owner = "client!qc", name = "run", descriptor = "()V", line = 254)
