...
public class class532 {
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Z)V", line = 18)
    public static final void method2871(boolean arg0) {
        field6725++;
        class698.field9679 = arg0;
    }

    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IIIIIIF[FFII)V", line = 30)
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Loa;IILrr;I)V", line = 120)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(III)Z", line = 428)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(B)V", line = 441)
