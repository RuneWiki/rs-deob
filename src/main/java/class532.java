...
public class class532 extends class164 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(II[[I[[IIII)Lsa;")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lbt;IIII)Lr;")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ILdda;I)Ldd;")
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ln;)V")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "([Lr;Loaa;Lm;[Lgr;I)V")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Ljava/lang/Runnable;)Lrs;")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "([Lr;Lm;[Lgr;I)V")
    ...
    @OriginalMember(owner = "client!ef", name = "n", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IIILwca;)V")
