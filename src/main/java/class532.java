...
public class class532 extends class305 {
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "()V", line = 7)
    public class532() {
        super(0, true);
    }

    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(ILfh;B)V", line = 10)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "([[II)V", line = 89)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lza;IILc;III[[[B[I[I[I[I[IIBIIZ)V", line = 138)
    ...
    @OriginalMember(owner = "client!gn", name = "e", descriptor = "(B)V", line = 293)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(II)[I", line = 305)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IB)[[I", line = 332)
