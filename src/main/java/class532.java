...
public class class532 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IIIIIII)V", line = 111)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(II)Z", line = 241)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IB)I", line = 254)
