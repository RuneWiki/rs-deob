...
public class class532 extends class592 implements class368 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(I)J", line = 10)
    ...
    @OriginalMember(owner = "client!pd", name = "f", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!pd", name = "g", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(I)I", line = 55)
    ...
    @OriginalMember(owner = "client!pd", name = "d", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(Lep;I[BIZ)V", line = 79)
    public class532(class371 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34963, arg2, arg3, arg4);
        this.field7470 = arg1;
    }

    @OriginalMember(owner = "client!pd", name = "a", descriptor = "([BIII)V", line = 87)
    ...
    @OriginalMember(owner = "client!pd", name = "c", descriptor = "(I)I", line = 103)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(BII)I", line = 115)
