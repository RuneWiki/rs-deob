...
public class class532 extends class545 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!hk", name = "f", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!hk", name = "e", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!hk", name = "g", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!hk", name = "h", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(B)V", line = 112)
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "(Lad;Lla;)V", line = 137)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IILec;)V", line = 165)
    ...
    @OriginalMember(owner = "client!hk", name = "b", descriptor = "(I)Z", line = 201)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(BZ)V", line = 214)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ZZ)V", line = 234)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(III)V", line = 243)
    ...
    @OriginalMember(owner = "client!hk", name = "d", descriptor = "(I)V", line = 257)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Z)V", line = 292)
