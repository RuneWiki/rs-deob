...
public class class532 {
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(ILjava/lang/String;)I", line = 3)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(IZI)Z", line = 28)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 39)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(Z)I", line = 97)
    ...
    @OriginalMember(owner = "client!iba", name = "b", descriptor = "(I)V", line = 295)
