...
public class class532 extends class227 {
    ...
    @OriginalMember(owner = "client!pca", name = "c", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(Z)I", line = 24)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(ZILoa;)Z", line = 45)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(III)V", line = 243)
    ...
    @OriginalMember(owner = "client!pca", name = "b", descriptor = "(Z)I", line = 336)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(IILoa;ILcq;ZI)V", line = 357)
    ...
    @OriginalMember(owner = "client!pca", name = "d", descriptor = "(I)I", line = 368)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(IIIIZI)V", line = 380)
    ...
    @OriginalMember(owner = "client!pca", name = "d", descriptor = "(Loa;I)Lcd;", line = 460)
    public final class564 method72(class43 arg0, int arg1) {
        ++field6920;
        return arg1 != 21098 ? null : null;
    }

    @OriginalMember(owner = "client!pca", name = "d", descriptor = "(B)V", line = 471)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(B)I", line = 485)
    ...
    @OriginalMember(owner = "client!pca", name = "f", descriptor = "(B)Z", line = 509)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(BLjf;)V", line = 525)
    ...
    @OriginalMember(owner = "client!pca", name = "c", descriptor = "(Loa;I)V", line = 546)
    ...
    @OriginalMember(owner = "client!pca", name = "c", descriptor = "(I)Z", line = 570)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(Loa;B)Lpl;", line = 581)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(IILoa;I)Z", line = 655)
