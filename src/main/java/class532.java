...
public class class532 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIZLha;)Lvr;", line = 6)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(I)Z", line = 54)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILjp;I)V", line = 68)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIBLml;)Ltg;", line = 99)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(BLjp;)V", line = 183)
