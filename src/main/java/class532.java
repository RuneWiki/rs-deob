...
public class class532 implements Runnable {
    ...
    @OriginalMember(owner = "client!hd", name = "run", descriptor = "()V", line = 48)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(B)V", line = 108)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 179)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(I)V", line = 156)
