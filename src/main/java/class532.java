...
public class class532 extends class628 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Ldn;Ldn;BLwb;Ldn;)Z")
    ...
    @OriginalMember(owner = "client!oo", name = "b", descriptor = "(I)Llm;")
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "(Lbda;IIIIII)V")
