...
public abstract class class532 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(FFIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(FFFFIILua;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(FFFFFFLua;II)V", line = 39)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(FFFFIIIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(FFII)V", line = 66)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(II)V", line = 70)
    public final void method2990(int arg0, int arg1) {
        this.method217(arg0, arg1, 1, 0, 1);
    }

    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IIIIIII)V", line = 75)
