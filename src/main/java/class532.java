...
public class class532 extends class188 {
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "(Lqfa;IIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IIIIIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "(Lqfa;IIII[BI)V", line = 551)
    ...
    @OriginalMember(owner = "client!ek", name = "e", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!ek", name = "d", descriptor = "(I)V", line = 68)
