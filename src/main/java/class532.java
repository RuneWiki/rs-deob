...
public class class532 implements Runnable {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IBLvc;)Lsp;")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "([BLvc;ZI)Lsp;")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ZILvc;)Lsp;")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ILsp;)V")
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Ldq;)V")
