...
public class class532 {
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(III)V", line = 13)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Ljava/lang/String;IILjava/lang/String;)V", line = 27)
    ...
    @OriginalMember(owner = "client!wr", name = "b", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lza;B)V", line = 81)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ILdc;)I", line = 138)
