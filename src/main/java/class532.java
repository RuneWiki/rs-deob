...
public abstract class class532 {
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "([[BLer;B)V", line = 15)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(B)V", line = 47)
    public void method698(byte arg0) {
        int var2 = -49 % ((68 - arg0) / 40);
        field7499++;
    }

    @OriginalMember(owner = "client!bda", name = "b", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!bda", name = "b", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(IILjava/lang/String;)Lwn;", line = 80)
    ...
    @OriginalMember(owner = "client!bda", name = "c", descriptor = "(B)V", line = 101)
    ...
    @OriginalMember(owner = "client!bda", name = "c", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!bda", name = "d", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!bda", name = "<init>", descriptor = "(Lwg;)V", line = 143)
