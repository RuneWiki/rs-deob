...
public class class532 extends class517 {
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(Lffa;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(Lffa;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(Lffa;II)V")
