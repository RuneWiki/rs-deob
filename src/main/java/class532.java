...
public class class532 extends class43 implements class691 {
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(ILr;)V", line = 3)
    ...
    @OriginalMember(owner = "client!uo", name = "c", descriptor = "(B)Z", line = 14)
    ...
    @OriginalMember(owner = "client!uo", name = "c", descriptor = "(I)I", line = 26)
    ...
    @OriginalMember(owner = "client!uo", name = "l", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!uo", name = "e", descriptor = "(B)I", line = 53)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Lr;Z)V", line = 64)
    ...
    @OriginalMember(owner = "client!uo", name = "d", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Ln;I)Ln;", line = 93)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(B)I", line = 125)
    ...
    @OriginalMember(owner = "client!uo", name = "g", descriptor = "(I)Z", line = 136)
    public final boolean method175(int arg0) {
        ++field7767;
        return arg0 != 0 ? false : false;
    }

    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(BLr;)Lsr;", line = 147)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Lr;B)Llt;", line = 161)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Lr;III)Z", line = 210)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(I)I", line = 232)
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(I)Z", line = 245)
    ...
    @OriginalMember(owner = "client!uo", name = "h", descriptor = "(I)V", line = 261)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(BLr;)V", line = 271)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(Lr;Lfga;IIIIIZIIIIIII)V", line = 282)
    ...
    @OriginalMember(owner = "client!uo", name = "m", descriptor = "(I)I", line = 291)
    ...
    @OriginalMember(owner = "client!uo", name = "f", descriptor = "(I)I", line = 306)
    ...
    @OriginalMember(owner = "client!uo", name = "f", descriptor = "(B)Z", line = 318)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IIZLr;ILub;I)V", line = 336)
