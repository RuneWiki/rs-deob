...
public class class532 extends class108 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lgp;I)Lnl;")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "([I)Lar;")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lgp;)Z")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lgp;II)Lnl;")
