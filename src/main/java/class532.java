...
public class class532 extends class364 implements class137 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "()Lq;", line = 6)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(III[I)V", line = 19)
    public final void method2018(int arg0, int arg1, int arg2, int[] arg3) {
        this.method3115(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!wa", name = "finalize", descriptor = "()V", line = 28)
    ...
    @OriginalMember(owner = "client!wa", name = "<init>", descriptor = "()V", line = 36)
    public class532() {
        this.method3116();
    }
