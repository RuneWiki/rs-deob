...
public class class532 extends class283 {
    ...
    @OriginalMember(owner = "client!oaa", name = "e", descriptor = "(I)J", line = 5)
    public final long method1704(int arg0) {
        int var2 = 105 / ((25 - arg0) / 45);
        return this.field7482;
    }

    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(B)I", line = 13)
    public final int method1702(byte arg0) {
        return arg0 > -26 ? -3 : this.field7484;
    }

    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(Z)I", line = 26)
    ...
    @OriginalMember(owner = "client!oaa", name = "f", descriptor = "(I)I", line = 36)
    public final int method1705(int arg0) {
        return arg0 == -3668 ? this.field7483 : -72;
    }

    @OriginalMember(owner = "client!oaa", name = "b", descriptor = "(I)I", line = 47)
