...
public class class532 extends class362 {
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "()V", line = 12)
    public class532() {
        this(4096);
    }

    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lfca;II)V", line = 16)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lkka;BIILfl;)V", line = 45)
    ...
    @OriginalMember(owner = "client!ko", name = "d", descriptor = "(B)Laba;", line = 410)
    ...
    @OriginalMember(owner = "client!ko", name = "c", descriptor = "(I)V", line = 426)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(II)[I", line = 438)
