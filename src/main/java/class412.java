...
public class class412 extends class719 {
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    public class412(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;B)V")
