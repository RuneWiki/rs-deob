...
public class class412 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Lw;BII)V")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(IIILw;)V")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ZILw;I)Z")
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lgj;Lkb;)V")
