...
public class class412 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(B[Lcf;)I")
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(BJ)Lcf;")
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(I)Lcf;")
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(B)Lcf;")
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(JLcf;B)V")
    ...
    @OriginalMember(owner = "client!gu", name = "c", descriptor = "(I)Lcf;")
