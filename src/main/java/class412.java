...
public class class412 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(IZIIB)Lgq;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Ltc;ZI)V")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lvc;Z)V")
