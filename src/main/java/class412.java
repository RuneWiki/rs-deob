...
public class class412 {
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(I)V", line = 59)
