...
public class class412 extends class646 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIBII)V", line = 6)
    ...
    @OriginalMember(owner = "client!ag", name = "d", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(II)[[I", line = 35)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lek;IB)V", line = 119)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(II)I", line = 155)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IZI)V", line = 169)
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "()V", line = 192)
    public class412() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(BI)I", line = 201)
