...
public class class412 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(BI)Ldf;", line = 21)
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(BI)Lbo;", line = 49)
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "(Lci;ILsea;)V", line = 110)
    public class412(class414 arg0, int arg1, class648 arg2) {
        this.field5839 = arg2;
        this.field5838 = this.field5839.method3653(19, true);
    }

    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(III)Z", line = 95)
