...
public class class412 extends class59 {
    ...
    @OriginalMember(owner = "client!id", name = "d", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!id", name = "e", descriptor = "(I)Lcu;", line = 20)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lnm;Lqa;IILc;ZIBIIIIIII)Lc;", line = 32)
