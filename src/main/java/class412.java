...
public class class412 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(ILdga;I)V")
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Lsf;Lsf;I)V")
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Ldga;I)V")
