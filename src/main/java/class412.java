...
public class class412 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;)Ljava/lang/Object;", line = 5)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "([Ljava/lang/Object;Ljava/lang/String;BLjava/applet/Applet;)Ljava/lang/Object;", line = 15)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Ljava/lang/String;ILjava/applet/Applet;)V", line = 25)
