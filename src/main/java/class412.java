...
public class class412 extends class446 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lkh;BI)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lkh;Z)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IZ)Lgh;")
    ...
    @OriginalMember(owner = "client!kb", name = "d", descriptor = "(B)Lbf;")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lnq;I)V")
