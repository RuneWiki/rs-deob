...
public class class412 extends class101 {
    ...
    @OriginalMember(owner = "client!ef", name = "c", descriptor = "(B)V", line = 9)
    public static void method2352(byte arg0) {
        field5358 = null;
        int var1 = -23 % ((arg0 + 29) / 49);
    }

    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lkj;I)I", line = 18)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(I[SI)[S", line = 47)
    ...
    @OriginalMember(owner = "client!ef", name = "d", descriptor = "(B)V", line = 67)
