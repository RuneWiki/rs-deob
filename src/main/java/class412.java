...
public class class412 extends class65 {
    ...
    @OriginalMember(owner = "client!f", name = "f", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!f", name = "<init>", descriptor = "(Ltt;IIIIIZ)V", line = 58)
    ...
    @OriginalMember(owner = "client!f", name = "<init>", descriptor = "(Ltt;IIIIZ[BI)V", line = 79)
    ...
    @OriginalMember(owner = "client!f", name = "<init>", descriptor = "(Ltt;IIIZ[I)V", line = 102)
    ...
    @OriginalMember(owner = "client!f", name = "g", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!f", name = "<init>", descriptor = "(Ltt;IIIIIIZ)V", line = 137)
    ...
    @OriginalMember(owner = "client!f", name = "<init>", descriptor = "(Ltt;IIII[I)V", line = 152)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(III)I", line = 171)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IIB)I", line = 208)
    ...
    @OriginalMember(owner = "client!f", name = "<init>", descriptor = "(Ltt;IIIII[BI)V", line = 229)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IIIII)V", line = 244)
