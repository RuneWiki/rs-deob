...
public class class412 {
    ...
    @OriginalMember(owner = "client!tm", name = "c", descriptor = "(I)Ldba;")
    ...
    @OriginalMember(owner = "client!tm", name = "d", descriptor = "(I)Ldba;")
    ...
    @OriginalMember(owner = "client!tm", name = "e", descriptor = "(I)Ldba;")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ILdba;)V")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Ltm;I)V")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Ldba;Ltm;I)V")
    ...
    @OriginalMember(owner = "client!tm", name = "f", descriptor = "(I)Ldba;")
    ...
    @OriginalMember(owner = "client!tm", name = "b", descriptor = "(ILdba;)V")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(B)Ldba;")
