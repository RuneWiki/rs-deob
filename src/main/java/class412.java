...
public class class412 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(I)Lac;")
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(B)Lac;")
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ILac;)V")
