...
public class class412 extends class263 {
    ...
    @OriginalMember(owner = "client!ku", name = "d", descriptor = "(B)[Loo;", line = 6)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IZLgk;)V", line = 20)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IB)[I", line = 64)
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(IB)[[I", line = 102)
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "()V", line = 166)
    public class412() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(IBI)V", line = 169)
