...
public class class412 extends class311 implements class232 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IILqa;IZLha;I)V")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(ILqa;)Lbw;")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "(Lqa;Lbo;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IIILqa;)Z")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IILqa;)Lc;")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(BLbw;)V")
    ...
    @OriginalMember(owner = "client!lk", name = "c", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(Lqa;I)V")
