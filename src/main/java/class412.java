...
public class class412 extends class341 {
    ...
    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(BII[Ljava/lang/String;)Ljava/lang/String;", line = 34)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(II)V", line = 97)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(I[S)[S", line = 110)
