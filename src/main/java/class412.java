...
public class class412 extends class365 implements class216 {
    ...
    @OriginalMember(owner = "client!fr", name = "c", descriptor = "(I)Lok;")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "(Lno;Lok;Z)V")
