...
public class class412 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IBLwm;)V")
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(Z)Lti;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lwm;Z)V")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ZLwm;I)V")
