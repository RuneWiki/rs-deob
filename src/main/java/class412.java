...
public class class412 {
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(II)Ltea;")
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ILkca;IIII)Lcs;")
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(Lcr;ILla;)V")
