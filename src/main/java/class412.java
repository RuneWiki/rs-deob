...
public class class412 extends class719 implements class362 {
    ...
    @OriginalMember(owner = "client!wj", name = "b", descriptor = "(Lha;B)Lpw;")
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(ILsf;Lha;BIIZ)V")
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Lha;B)Lhq;")
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IZLha;I)Z")
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!wj", name = "b", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(BLpi;)V")
    ...
    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(Lha;Ldja;IIIIIZIII)V")
