...
public class class412 {
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(B)Lfi;", line = 5)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(ILat;)V", line = 28)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(BLfi;)V", line = 41)
    ...
    @OriginalMember(owner = "client!at", name = "b", descriptor = "(B)Lfi;", line = 59)
    ...
    @OriginalMember(owner = "client!at", name = "c", descriptor = "(B)V", line = 86)
    public static void method2455(byte arg0) {
        int var1 = 116 / ((-arg0 - 77) / 32);
        field5962 = null;
    }

    @OriginalMember(owner = "client!at", name = "a", descriptor = "(I)Lfi;", line = 97)
    ...
    @OriginalMember(owner = "client!at", name = "d", descriptor = "(B)Lfi;", line = 117)
    ...
    @OriginalMember(owner = "client!at", name = "b", descriptor = "(I)Z", line = 138)
    ...
    @OriginalMember(owner = "client!at", name = "c", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(III)I", line = 190)
    ...
    @OriginalMember(owner = "client!at", name = "d", descriptor = "(I)Lfi;", line = 212)
    ...
    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "()V", line = 393)
    public class412() {
        this.field5951.field435 = this.field5951;
        this.field5951.field434 = this.field5951;
    }

    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Ljava/lang/String;ILjava/awt/Color;Ljava/awt/Color;ILjava/awt/Color;Z)V", line = 236)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(II)I", line = 318)
    public static int method2463(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Z)I", line = 328)
    ...
    @OriginalMember(owner = "client!at", name = "b", descriptor = "(BLfi;)V", line = 349)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(ILfi;Lat;)V", line = 367)
