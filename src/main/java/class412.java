...
public class class412 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(I)V", line = 137)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Llb;I)V", line = 201)
    ...
    @OriginalMember(owner = "client!rm", name = "c", descriptor = "(I)V", line = 216)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "([Lgg;II)V", line = 324)
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(Lac;)V", line = 826)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(Llb;I)Z", line = 367)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IIIII)Z", line = 402)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(B)V", line = 453)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ILjava/awt/Color;Ljava/awt/Color;Ljava/awt/Color;Ljava/lang/String;I)V", line = 483)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Ljha;IZLjha;ZII)I", line = 571)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Z)Z", line = 605)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IIIILka;Loia;)V", line = 616)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IIZIIIII)V", line = 635)
    ...
    @OriginalMember(owner = "client!rm", name = "d", descriptor = "(I)V", line = 762)
