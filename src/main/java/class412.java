...
public class class412 extends class80 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Llh;B[I)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ILlh;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IBLlh;)V")
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(ILlh;)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ZLir;)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IB)Ltk;")
