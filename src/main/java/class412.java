...
public class class412 extends class83 {
    ...
    @OriginalMember(owner = "client!kl", name = "d", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "()V", line = 67)
    public class412() {
        super(1, false);
    }

    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IZIILvm;IIIILjn;I)Ljn;", line = 70)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IBLtq;)V", line = 115)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(ZI)[[I", line = 158)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(II)[I", line = 226)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(ZLam;Lam;)V", line = 268)
