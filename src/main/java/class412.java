...
public class class412 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IIIZ)I", line = 4)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ILae;IIII)V", line = 115)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IIIILbk;I)Lbk;", line = 215)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(I)V", line = 338)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(BLdg;)V", line = 384)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(B)V", line = 419)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IIIIIBILbk;)Lbk;", line = 431)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IBLdg;)V", line = 498)
