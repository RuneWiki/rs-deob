...
public class class412 extends class37 implements class323 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "()I", line = 3)
    public final int method282() {
        return super.method282();
    }

    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "(Lse;I[BIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(I[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(III)V", line = 18)
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "()V", line = 21)
