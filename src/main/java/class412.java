...
public class class412 {
    ...
    @OriginalMember(owner = "client!maa", name = "b", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(IIIIII)Z", line = 56)
    ...
    @OriginalMember(owner = "client!maa", name = "c", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(BI)Lnea;", line = 138)
    ...
    @OriginalMember(owner = "client!maa", name = "<init>", descriptor = "(Lvd;ILpe;)V", line = 168)
