...
public class class412 extends class330 {
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "()V", line = 159)
    public class412() {
        super(0, true);
    }

    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IBI)Z", line = 12)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IZ)[I", line = 30)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(BII)Z", line = 82)
    ...
    @OriginalMember(owner = "client!sj", name = "c", descriptor = "(III)Z", line = 114)
    ...
    @OriginalMember(owner = "client!sj", name = "d", descriptor = "(B)V", line = 128)
    ...
    @OriginalMember(owner = "client!sj", name = "e", descriptor = "(B)V", line = 143)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(Lgga;IB)V", line = 165)
