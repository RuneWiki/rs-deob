...
public class class412 extends class436 implements class237 {
    ...
    @OriginalMember(owner = "client!tm", name = "b", descriptor = "(Lha;B)Ldg;", line = 4)
    ...
    @OriginalMember(owner = "client!tm", name = "d", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Lha;B)V", line = 44)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(BLha;)V", line = 55)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(BLdja;)V", line = 80)
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(Lha;Lij;IIIIIZII)V", line = 94)
    ...
    @OriginalMember(owner = "client!tm", name = "g", descriptor = "(I)I", line = 107)
    public final int method907(int arg0) {
        ++field5632;
        return arg0 != -20425 ? -27 : this.field5636.method2048(true);
    }

    @OriginalMember(owner = "client!tm", name = "i", descriptor = "(I)Z", line = 118)
    public final boolean method904(int arg0) {
        ++field5644;
        return arg0 != 0;
    }

    @OriginalMember(owner = "client!tm", name = "b", descriptor = "(Z)Z", line = 129)
    ...
    @OriginalMember(owner = "client!tm", name = "h", descriptor = "(I)I", line = 140)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Z)I", line = 152)
    ...
    @OriginalMember(owner = "client!tm", name = "j", descriptor = "(I)Z", line = 164)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Lha;Lcn;IIBZI)V", line = 181)
    ...
    @OriginalMember(owner = "client!tm", name = "b", descriptor = "(BLha;)Lhga;", line = 197)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(I)I", line = 249)
    ...
    @OriginalMember(owner = "client!tm", name = "m", descriptor = "(I)V", line = 267)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Lha;III)Z", line = 296)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(B)Z", line = 315)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Lha;I)V", line = 326)
    ...
    @OriginalMember(owner = "client!tm", name = "c", descriptor = "(I)I", line = 337)
