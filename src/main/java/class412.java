...
public abstract class class412 implements class640 {
    ...
    @OriginalMember(owner = "client!uda", name = "<init>", descriptor = "(Lap;IIIZ)V", line = 169)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!uda", name = "b", descriptor = "(B)Z", line = 44)
    ...
    @OriginalMember(owner = "client!uda", name = "b", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;II)V", line = 96)
    ...
    @OriginalMember(owner = "client!uda", name = "finalize", descriptor = "()V", line = 123)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(BZ)V", line = 133)
    ...
    @OriginalMember(owner = "client!uda", name = "b", descriptor = "(BZ)V", line = 153)
    ...
    @OriginalMember(owner = "client!uda", name = "c", descriptor = "(B)I", line = 186)
    ...
    @OriginalMember(owner = "client!uda", name = "d", descriptor = "(B)I", line = 199)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(BI)V", line = 210)
    ...
    @OriginalMember(owner = "client!uda", name = "c", descriptor = "(I)V", line = 222)
