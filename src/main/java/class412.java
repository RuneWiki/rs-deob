...
public class class412 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lc;Lqa;IZIIIZ)V")
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lcr;B)V")
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(ZZLqa;IIII)Lc;")
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "(Lqa;Lus;IIIIIIZI)V")
