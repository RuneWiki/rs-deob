...
public class class412 implements class300 {
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(Lfp;)V")
    public class412(class323 arg0) {
        this.field5813 = arg0;
    }

    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(I)Ldn;")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IIB)Luu;")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lr;III[Z)V")
