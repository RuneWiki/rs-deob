...
public class class412 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(JI)V", line = 8)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(I[BII)V", line = 24)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Z)J", line = 148)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(I)Ljava/io/File;", line = 162)
    private final File method2582(int arg0) {
        field5941++;
        return arg0 >= -63 ? null : this.field5942.method1105(true);
    }

    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(ZI)V", line = 187)
    ...
    @OriginalMember(owner = "client!cj", name = "<init>", descriptor = "(Lle;II)V", line = 563)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "([BIII)V", line = 214)
    ...
    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(I)V", line = 398)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(B)V", line = 472)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(B[B)V", line = 518)
    ...
    @OriginalMember(owner = "client!cj", name = "c", descriptor = "(I)V", line = 540)
