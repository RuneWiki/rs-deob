...
public class class412 extends class385 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "([Ljava/lang/String;B)[Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!cr", name = "e", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!cr", name = "e", descriptor = "(I)Z", line = 46)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IIII)I", line = 58)
    ...
    @OriginalMember(owner = "client!cr", name = "d", descriptor = "(B)Ljava/lang/Object;", line = 77)
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(Ltp;Ljava/lang/Object;I)V", line = 92)
    public class412(class379 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field5834 = arg1;
    }

    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Luc;ZI)V", line = 108)
