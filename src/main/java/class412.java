...
public class class412 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(BILof;)V", line = 23)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(II)I", line = 351)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IB)V", line = 371)
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 384)
