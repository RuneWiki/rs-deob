...
public class class412 extends class601 {
    ...
    @OriginalMember(owner = "client!taa", name = "<init>", descriptor = "()V", line = 155)
    public class412() {
        super(0, false);
    }

    @OriginalMember(owner = "client!taa", name = "c", descriptor = "(I)I", line = 9)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(II)Z", line = 21)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(IBI)V", line = 35)
    ...
    @OriginalMember(owner = "client!taa", name = "b", descriptor = "(IZ)[[I", line = 61)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(ZI)V", line = 128)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(Lee;BI)V", line = 140)
    ...
    @OriginalMember(owner = "client!taa", name = "c", descriptor = "(Z)V", line = 159)
