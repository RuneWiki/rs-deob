...
public class class412 implements class283 {
    ...
    @OriginalMember(owner = "client!rr", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(B)Ltj;", line = 16)
    public final class31 method1265(byte arg0) {
        field5143++;
        return arg0 == -58 ? class31.field440 : null;
    }

    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IIII)Z", line = 44)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(I)I", line = 77)
    ...
    @OriginalMember(owner = "client!rr", name = "<init>", descriptor = "(Lpl;Ljava/lang/String;)V", line = 93)
