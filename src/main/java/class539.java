...
public class class539 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ILjava/lang/String;I[Lhu;I)I", line = 6)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Ljava/lang/String;B[Lhu;I)I", line = 21)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IIC)I", line = 33)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ILjava/lang/String;)I", line = 49)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Ljava/lang/String;I[Lhu;I)I", line = 72)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ILjava/lang/String;[Lhu;)I", line = 101)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "([Lhu;Ljava/lang/String;II)Ljava/lang/String;", line = 204)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Ljava/lang/String;I[I[Ljava/lang/String;[Lhu;)I", line = 323)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(I)V", line = 572)
    ...
    @OriginalMember(owner = "client!rc", name = "<init>", descriptor = "([B)V", line = 615)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(II)I", line = 739)
