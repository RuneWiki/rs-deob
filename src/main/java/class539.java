...
public class class539 extends class129 {
    ...
    @OriginalMember(owner = "client!nga", name = "<init>", descriptor = "(Lsd;Lla;Lcda;)V", line = 5)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(IILrca;)V", line = 28)
    ...
    @OriginalMember(owner = "client!nga", name = "c", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(ZB)V", line = 78)
    ...
    @OriginalMember(owner = "client!nga", name = "e", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!nga", name = "d", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(ZI)V", line = 145)
    ...
    @OriginalMember(owner = "client!nga", name = "c", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(Z)Z", line = 205)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(IIB)V", line = 219)
