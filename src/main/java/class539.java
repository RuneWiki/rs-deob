...
public class class539 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(BZJILtf;II)V", line = 9)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ILce;)V", line = 20)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(B)V", line = 209)
    ...
    @OriginalMember(owner = "client!jd", name = "toString", descriptor = "()Ljava/lang/String;", line = 226)
