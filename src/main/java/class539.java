...
public class class539 extends class417 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IFIBIIFF)[F", line = 19)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Ljava/lang/String;Z)I", line = 104)
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(IIIIIZ)V", line = 138)
