...
public abstract class class539 extends class692 {
    ...
    @OriginalMember(owner = "client!ht", name = "f", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "(IIIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!ht", name = "e", descriptor = "(I)Z", line = 40)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(B[Lcp;)I", line = 58)
