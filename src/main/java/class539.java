...
public class class539 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IZ)V", line = 45)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(B[B)V", line = 58)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(BI)Lraa;", line = 133)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(B)V", line = 165)
    ...
    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "(Lkr;ILpu;Lpu;)V", line = 299)
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(B)V", line = 188)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ZB)V", line = 229)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(III)V", line = 287)
