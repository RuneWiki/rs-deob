...
public class class539 extends class687 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Ljc;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Ljava/lang/String;IB)Ljava/lang/String;", line = 24)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Ljc;II)V", line = 51)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "([BI)Z", line = 109)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(III)I", line = 139)
