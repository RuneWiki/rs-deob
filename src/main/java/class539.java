...
public class class539 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(BI)Lvk;", line = 8)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(II)V", line = 40)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!cn", name = "c", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IIZ)I", line = 100)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IIILqh;II)Lfj;", line = 135)
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(Liv;ILcb;)V", line = 170)
