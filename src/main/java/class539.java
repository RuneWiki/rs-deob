...
public class class539 extends class125 {
    ...
    @OriginalMember(owner = "client!sr", name = "c", descriptor = "(Z)I", line = 15)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IILha;Lmr;Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(ZI)I", line = 60)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(ILgp;)V", line = 74)
    public class539(int arg0, class549 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(BI)V", line = 78)
    ...
    @OriginalMember(owner = "client!sr", name = "b", descriptor = "(Z)V", line = 93)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(B)I", line = 112)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(Lgp;)V", line = 127)
