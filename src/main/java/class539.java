...
public class class539 extends class392 {
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(ILw;)V")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IIIIIIILha;I)V")
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(Lw;)V")
