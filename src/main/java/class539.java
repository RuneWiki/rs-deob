...
public class class539 {
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(Lfd;B)V", line = 27)
    ...
    @OriginalMember(owner = "client!nea", name = "b", descriptor = "(II)Ljava/lang/String;", line = 48)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(IILfd;)V", line = 68)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!nea", name = "c", descriptor = "(II)Z", line = 147)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(B)V", line = 174)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 196)
