...
public class class539 {
    ...
    @OriginalMember(owner = "client!ia", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(III)Z", line = 30)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!ia", name = "d", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!ia", name = "e", descriptor = "(I)Z", line = 90)
