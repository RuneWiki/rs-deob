...
public class class539 {
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(BLhw;IZI)V")
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Lwl;B)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
