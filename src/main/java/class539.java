...
public abstract class class539 extends class130 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(B)Z", line = 17)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(I)I", line = 29)
    ...
    @OriginalMember(owner = "client!tf", name = "h", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IBLjava/lang/String;)V", line = 57)
    ...
    @OriginalMember(owner = "client!tf", name = "c", descriptor = "(B)Z", line = 139)
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(Ltt;)V", line = 157)
