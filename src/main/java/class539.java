...
public class class539 extends class490 {
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(IBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Les;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(III)V", line = 42)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(B)V", line = 60)
    public static void method3198(byte arg0) {
        int var1 = -36 / ((arg0 + 56) / 44);
        field7586 = null;
    }

    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(ZII)Z", line = 71)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Lwt;I)V", line = 88)
