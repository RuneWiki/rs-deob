...
public abstract class class539 implements class695 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(FIFIF)F", line = 4)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(ILjaggl/MapBuffer;Z)Ljaclib/memory/Buffer;", line = 19)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(ILjaclib/memory/Source;I)Z", line = 63)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!vi", name = "c", descriptor = "(I)J", line = 122)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Ljaggl/MapBuffer;I)Z", line = 136)
    ...
    @OriginalMember(owner = "client!vi", name = "d", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(II)V", line = 183)
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(Lbga;IZ)V", line = 301)
    ...
    @OriginalMember(owner = "client!vi", name = "e", descriptor = "(I)V", line = 216)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Z)I", line = 254)
    ...
    @OriginalMember(owner = "client!vi", name = "finalize", descriptor = "()V", line = 265)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(B)V", line = 277)
