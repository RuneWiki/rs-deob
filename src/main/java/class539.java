...
public class class539 extends class255 implements Runnable {
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(IIII)I", line = 6)
    ...
    @OriginalMember(owner = "client!ab", name = "run", descriptor = "()V", line = 36)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Z)V", line = 48)
    public final void method3037(boolean arg0) {
        field7387++;
        this.field7385 = arg0;
    }

    @OriginalMember(owner = "client!ab", name = "b", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "(Loi;)V", line = 88)
    public class539(class674 arg0) {
        this.field7381 = arg0;
    }

    @OriginalMember(owner = "client!ab", name = "c", descriptor = "(I)V", line = 72)
