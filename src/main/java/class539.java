...
public class class539 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ILih;)V")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(BLih;)V")
    ...
    @OriginalMember(owner = "client!lo", name = "b", descriptor = "(ILih;)V")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lsj;ILih;)V")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ILih;B)V")
