...
public class class539 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(III)Z", line = 3)
    public static final boolean method3093(int arg0, int arg1, int arg2) {
        field7472++;
        return arg1 <= 22;
    }

    @OriginalMember(owner = "client!bf", name = "toString", descriptor = "()Ljava/lang/String;", line = 18)
    public final String toString() {
        field7470++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIIIZ[B)V", line = 26)
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(II)V", line = 57)
