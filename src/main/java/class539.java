...
public abstract class class539 extends class209 {
    ...
    @OriginalMember(owner = "client!uo", name = "c", descriptor = "(Loa;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(ZLoa;Lnt;IIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!uo", name = "c", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IZLjava/awt/Component;)Lpf;", line = 86)
    ...
    @OriginalMember(owner = "client!uo", name = "c", descriptor = "(I)Z", line = 104)
    ...
    @OriginalMember(owner = "client!uo", name = "e", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IB)I", line = 130)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(IIIIIII)V", line = 149)
