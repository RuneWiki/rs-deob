...
public abstract class class539 extends class214 {
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(B[Luaa;)I")
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(Lsu;ILjs;Lha;)V")
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(Lha;Z)Z")
