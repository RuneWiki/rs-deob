...
public class class539 extends class91 implements class722 {
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Lha;Z)V")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Lha;I)Lua;")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(ZILha;)Lka;")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(BLha;ZILuq;II)V")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(ILha;IB)Z")
    ...
    @OriginalMember(owner = "client!dfa", name = "<init>", descriptor = "(Lha;Lts;IIIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(ZLha;)V")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IZLha;B)Lcn;")
    ...
    @OriginalMember(owner = "client!dfa", name = "b", descriptor = "(Lha;B)Liha;")
