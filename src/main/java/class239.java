...
public class class239 implements class113 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IIBLjava/lang/String;ILta;)I")
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(I)[Lnga;")
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(Lum;Loi;)V")
