...
public class class239 {
    ...
    @OriginalMember(owner = "client!n", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V", line = 7)
    ...
    @OriginalMember(owner = "client!n", name = "movemouse", descriptor = "(II)V", line = 24)
    public final void movemouse(int arg0, int arg1) {
        this.field3146.mouseMove(arg0, arg1);
    }

    @OriginalMember(owner = "client!n", name = "<init>", descriptor = "()V", line = 29)
    public class239() throws Exception {
    }

    @OriginalMember(owner = "client!n", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V", line = 38)
