...
public abstract class class239 extends class117 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IIZIZ)Lfc;")
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ILms;)V")
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ILbn;)Ljava/lang/String;")
