...
public class class239 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Ljb;ZILjb;I)Lkk;", line = 7)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(BILjb;Ljb;)Lkk;", line = 109)
    ...
    @OriginalMember(owner = "client!rs", name = "<init>", descriptor = "(Lse;Lje;)V", line = 123)
    ...
    @OriginalMember(owner = "client!rs", name = "b", descriptor = "(B)Z", line = 136)
