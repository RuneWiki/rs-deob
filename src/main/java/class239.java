...
public class class239 extends class314 {
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "()V", line = 3)
    public class239() {
        this(0);
    }

    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(JJ)J", line = 12)
    public static long method1718(long arg0, long arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!uk", name = "b", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IB)[[I", line = 33)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(BLie;I)V", line = 72)
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "(I)V", line = 120)
    private class239(int arg0) {
        super(0, false);
        this.method1720(arg0, -1);
    }

    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IIIIII)V", line = 128)
