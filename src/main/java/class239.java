...
public class class239 {
    ...
    @OriginalMember(owner = "client!lf", name = "toString", descriptor = "()Ljava/lang/String;", line = 10)
    public final String toString() {
        field3122++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IIIIB)V", line = 25)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(I)V", line = 206)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IB)Llf;", line = 222)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(IILkq;)V", line = 327)
