...
public class class239 {
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(IIIIIIIIII)Z", line = 36)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(I)V", line = 66)
