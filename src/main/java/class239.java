...
public class class239 extends class701 {
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IILua;II)V")
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(FFFFFFILua;II)V")
    ...
    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "(Lkga;IIZ)V")
    ...
    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "(Lkga;IIII)V")
    ...
    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "(Lkga;II[III)V")
