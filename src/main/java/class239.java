...
public class class239 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IBLec;)V", line = 4)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(BLdp;)V", line = 27)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lja;Lcj;B)V", line = 113)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(I)Lll;", line = 349)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ZILja;I)Lof;", line = 372)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ILec;II)V", line = 419)
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "(I)Z", line = 466)
    ...
    @OriginalMember(owner = "client!gb", name = "c", descriptor = "(B)V", line = 483)
