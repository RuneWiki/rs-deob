...
public class class239 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(B)Lgv;")
    ...
    @OriginalMember(owner = "client!em", name = "c", descriptor = "(B)Lgv;")
    ...
    @OriginalMember(owner = "client!em", name = "d", descriptor = "(B)Lgv;")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lgv;I)V")
    ...
    @OriginalMember(owner = "client!em", name = "b", descriptor = "(I)Lgv;")
