...
public class class239 {
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(IIIZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(Les;I)V", line = 29)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(Lr;Lng;I)I", line = 51)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(Les;II)V", line = 82)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(B)V", line = 100)
