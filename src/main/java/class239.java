...
public class class239 extends class137 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(III)[B", line = 3)
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "()V", line = 8)
    public class239() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IB)V", line = 13)
