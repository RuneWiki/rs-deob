...
public class class239 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Lmo;I)V")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Ljr;Z)Z")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ZIZZLoh;ILoh;)I")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Le;Lhm;IIIII)V")
