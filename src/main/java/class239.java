...
public class class239 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IILti;)V", line = 25)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(BLjava/lang/String;)V", line = 46)
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "(Lmt;ILhh;)V", line = 63)
