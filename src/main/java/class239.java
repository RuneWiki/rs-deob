...
public class class239 {
    ...
    @OriginalMember(owner = "client!rb", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!rb", name = "<init>", descriptor = "(III)V", line = 120)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(II)I", line = 143)
    public static int method1507(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(B)V", line = 150)
    ...
    @OriginalMember(owner = "client!rb", name = "c", descriptor = "(I)V", line = 163)
