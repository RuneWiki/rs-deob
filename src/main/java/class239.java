...
public class class239 extends class467 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lns;II)Lcl;", line = 112)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "()V", line = 124)
    public final void method1610() {
        this.field3385 = null;
    }

    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(Ltl;)V", line = 126)
