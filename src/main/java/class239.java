...
public class class239 extends class642 {
    ...
    @OriginalMember(owner = "client!ada", name = "f", descriptor = "(I)Lhd;")
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(IILmq;ILlr;)V")
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(ILgk;B)V")
