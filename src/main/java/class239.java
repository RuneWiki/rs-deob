...
public class class239 extends class710 {
    ...
    @OriginalMember(owner = "client!vga", name = "<init>", descriptor = "(Lji;IIIII)V")
    ...
    @OriginalMember(owner = "client!vga", name = "<init>", descriptor = "(Lji;IIIIZ[IZ)V")
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(ZILpca;)V")
    ...
    @OriginalMember(owner = "client!vga", name = "<init>", descriptor = "(Lji;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!vga", name = "d", descriptor = "(B)[Loca;")
    ...
    @OriginalMember(owner = "client!vga", name = "<init>", descriptor = "(Lji;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(Lufa;IBIII)Ljava/awt/Frame;")
    ...
    @OriginalMember(owner = "client!vga", name = "<init>", descriptor = "(Lji;IIII)V")
