...
public class class239 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IZLcw;ZLcw;)Lfe;")
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Lcw;ILcw;I)Lfe;")
    ...
    @OriginalMember(owner = "client!ol", name = "<init>", descriptor = "(Lhca;Lje;Ljava/math/BigInteger;Ljava/math/BigInteger;)V")
