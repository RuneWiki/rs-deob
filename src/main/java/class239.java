...
public class class239 extends class372 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(ILg;)V")
    ...
    @OriginalMember(owner = "client!pi", name = "b", descriptor = "(B)Lr;")
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Lpt;Lpt;Z)V")
