...
public class class239 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(BLni;)V", line = 32)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(I)V", line = 404)
