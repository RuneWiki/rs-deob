...
public class class239 extends class446 {
    ...
    @OriginalMember(owner = "client!nn", name = "d", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!nn", name = "e", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!nn", name = "d", descriptor = "(B)Z", line = 31)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Z)J", line = 51)
    ...
    @OriginalMember(owner = "client!nn", name = "b", descriptor = "(III)V", line = 62)
    ...
    @OriginalMember(owner = "client!nn", name = "e", descriptor = "(B)I", line = 209)
    public final int method1626(byte arg0) {
        ++field3405;
        return arg0 >= -92 ? -81 : (int) super.field5600;
    }

    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ILnq;)V", line = 220)
    ...
    @OriginalMember(owner = "client!nn", name = "f", descriptor = "(I)V", line = 232)
    ...
    @OriginalMember(owner = "client!nn", name = "g", descriptor = "(I)I", line = 244)
    ...
    @OriginalMember(owner = "client!nn", name = "h", descriptor = "(I)V", line = 255)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ZIIZ)I", line = 274)
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(II)V", line = 292)
