...
public class class239 extends class17 {
    ...
    @OriginalMember(owner = "client!aia", name = "b", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(BIB)V", line = 28)
    ...
    @OriginalMember(owner = "client!aia", name = "<init>", descriptor = "(IIIIIFFF)V", line = 39)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(IZI)V", line = 86)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(IIJZ)Ljava/lang/String;", line = 125)
