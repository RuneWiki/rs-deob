...
public class class239 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ZLmq;)Z")
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(BLtj;IIIZI)V")
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(BLsp;)Ljava/lang/String;")
