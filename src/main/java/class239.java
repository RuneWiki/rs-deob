...
public class class239 {
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(Lbt;ZI)V")
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(ZLjava/awt/Component;I)Llh;")
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(ZLbt;)V")
