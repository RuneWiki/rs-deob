...
public abstract class class239 implements class591 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ILjaggl/MapBuffer;Z)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ILjaggl/MapBuffer;)Z")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IILjaclib/memory/Source;)Z")
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(Lom;IZ)V")
