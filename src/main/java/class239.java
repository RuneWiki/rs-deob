...
public class class239 {
    ...
    @OriginalMember(owner = "client!jda", name = "b", descriptor = "(II)Lcia;")
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(Lnq;)V")
    public static final void method1514(class485 arg0) {
        class627.field8492 = arg0;
    }

    @OriginalMember(owner = "client!jda", name = "<init>", descriptor = "(Lkw;ILuq;Luq;)V")
