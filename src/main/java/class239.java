...
public class class239 {
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!rga", name = "b", descriptor = "(II)Lmu;", line = 40)
    ...
    @OriginalMember(owner = "client!rga", name = "b", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(BI)V", line = 88)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(Ljava/lang/String;Z)Ljava/lang/Class;", line = 103)
    ...
    @OriginalMember(owner = "client!rga", name = "c", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!rga", name = "<init>", descriptor = "(Lnb;ILoh;)V", line = 159)
