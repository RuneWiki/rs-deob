...
public class class239 {
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IIIILza;ZZ)Le;")
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(II)Lmd;")
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IIIIILe;ZLza;)V")
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(ILig;II)V")
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!jp", name = "<init>", descriptor = "(Lza;Ljc;IIIIIIZI)V")
