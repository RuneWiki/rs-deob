...
public class class239 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(BI)Z", line = 7)
    ...
    @OriginalMember(owner = "client!lf", name = "finalize", descriptor = "()V", line = 22)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IIIIIIZ)V", line = 33)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(III)Lvfa;", line = 105)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Z)V", line = 127)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(Llaa;JI)V", line = 139)
