...
public class class239 extends class169 implements class401 {
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Lya;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!vl", name = "f", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(I)I", line = 55)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(B)I", line = 66)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Lya;B)V", line = 77)
    public final void method225(class11 arg0, byte arg1) {
        field3351++;
        int var3 = -36 % ((arg1 - 42) / 36);
    }

    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(Lya;I)Lmo;", line = 86)
    public final class268 method238(class11 arg0, int arg1) {
        field3349++;
        return arg1 == -1 ? null : null;
    }

    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(BLya;)V", line = 101)
    ...
    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(Z)V", line = 113)
    ...
    @OriginalMember(owner = "client!vl", name = "<init>", descriptor = "(IIIIILoa;)V", line = 125)
    ...
    @OriginalMember(owner = "client!vl", name = "g", descriptor = "(B)V", line = 133)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(IIIIIILya;)Lt;", line = 150)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(ILya;II)Z", line = 198)
    public final boolean method233(int arg0, class11 arg1, int arg2, int arg3) {
        field3350++;
        return arg2 != 2;
    }

    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(I)I", line = 209)
    ...
    @OriginalMember(owner = "client!vl", name = "c", descriptor = "(B)I", line = 220)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(ILya;I)Lt;", line = 231)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Z)Z", line = 252)
