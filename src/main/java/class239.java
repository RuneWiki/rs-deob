...
public class class239 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ILjava/lang/String;ZIBZLjava/lang/String;)V", line = 28)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ZLpk;)V", line = 140)
