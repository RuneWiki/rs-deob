...
public class class239 extends class375 {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(III)V", line = 6)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IIIILet;)V", line = 16)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(I)Ljava/lang/String;", line = 61)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(ILmo;)V", line = 92)
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(ILmo;)Ljava/lang/String;", line = 114)
    ...
    @OriginalMember(owner = "client!rh", name = "c", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(III)I", line = 155)
    ...
    @OriginalMember(owner = "client!rh", name = "e", descriptor = "(I)V", line = 177)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "([ILmo;B)V", line = 203)
    ...
    @OriginalMember(owner = "client!rh", name = "f", descriptor = "(I)I", line = 231)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IIII)I", line = 248)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Lmo;IB)V", line = 276)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(II)Lff;", line = 350)
