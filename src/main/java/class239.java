...
public class class239 extends class29 {
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(Lfp;IIIILth;IB)V")
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(Lat;I)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
