...
public class class239 {
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(Lav;)V", line = 3)
    public static final void method1494(class641 arg0) {
        class386.field4924 = arg0;
    }

    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(ZLjava/io/File;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(I)V", line = 39)
