...
public class class239 extends class626 {
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ZLvg;)V", line = 14)
    ...
    @OriginalMember(owner = "client!dt", name = "<init>", descriptor = "()V", line = 486)
    public class239() {
    }

    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(I)V", line = 489)
    ...
    @OriginalMember(owner = "client!dt", name = "<init>", descriptor = "(S)V", line = 498)
