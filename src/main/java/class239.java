...
public abstract class class239 extends class547 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Z[Ljw;)I")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ILsf;Lha;BIIZ)V")
    ...
    @OriginalMember(owner = "client!jd", name = "c", descriptor = "(ILha;)Z")
