...
public class class239 implements class237 {
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(Lep;IZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(IIB)V", line = 42)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(BII)V", line = 70)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(III)V", line = 98)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(Z)V", line = 130)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(IB)I", line = 190)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(ZB)I", line = 211)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(II)I", line = 259)
    public final int method1371(int arg0, int arg1) {
        field3016++;
        return arg1 == -13366 ? this.field3020[arg0] : -53;
    }

    @OriginalMember(owner = "client!oca", name = "b", descriptor = "(III)V", line = 270)
