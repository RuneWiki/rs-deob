...
public class class239 extends class389 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IZ)I", line = 47)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(I)J", line = 104)
