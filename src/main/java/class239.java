...
public class class239 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Lqa;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Z)Lha;", line = 22)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(BI)I", line = 37)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(Z)Lha;", line = 47)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Lhl;)V", line = 81)
