...
public class class239 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IIZI)Lui;", line = 5)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Z)Lnka;", line = 46)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(IIIIB)V", line = 60)
