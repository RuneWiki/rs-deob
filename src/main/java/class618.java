...
public class class618 extends class26 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IZI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "([Lrd;)V", line = 18)
    public class618(class357[] arg0) {
        this.field8332 = arg0;
    }

    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(III)Lgs;", line = 38)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(ZZLqb;I)V", line = 62)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IB)V", line = 128)
