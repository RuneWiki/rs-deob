...
public class class618 extends class335 implements class166 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "([IZIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(Lki;IIZ[III)V", line = 45)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IF)F", line = 101)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IIIILofa;[BIZI)V", line = 111)
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(I)I", line = 155)
    public final int method38(int arg0) {
        int var2 = 32 / ((45 - arg0) / 51);
        return this.field8713;
    }

    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lcr;Z)V", line = 163)
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(Lki;Lofa;Lkn;II)V", line = 172)
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(IF)F", line = 194)
    public final float method36(int arg0, float arg1) {
        int var3 = 104 % ((65 - arg0) / 61);
        return arg1 / (float) this.field8713;
    }

    @OriginalMember(owner = "client!et", name = "c", descriptor = "(I)Z", line = 202)
    public final boolean method40(int arg0) {
        return arg0 == 27610 ? true : true;
    }

    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(Lki;Lofa;IIZ[BII)V", line = 211)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ZBZ)V", line = 270)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(I)V", line = 282)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IIIIIZI[I)V", line = 292)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(B)I", line = 332)
    public final int method34(byte arg0) {
        return arg0 == -109 ? this.field8715 : -8;
    }

    @OriginalMember(owner = "client!et", name = "d", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 342)
