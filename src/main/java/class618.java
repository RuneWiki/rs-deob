...
public class class618 implements class533 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "()V", line = 10)
    private final void method3479() {
        this.method3492(this.nativeid);
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;III)V", line = 14)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Li;BIZ)Lka;", line = 20)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lha;IIIIIII)V", line = 65)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lka;IIIZ)V", line = 76)
    ...
    @OriginalMember(owner = "client!a", name = "c", descriptor = "()V", line = 81)
    public final void method3489() {
        this.field8662 = Thread.currentThread();
        this.method3479();
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lha;[I[I[I[SI)V", line = 85)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;[ILhba;)V", line = 91)
    ...
    @OriginalMember(owner = "client!a", name = "d", descriptor = "()V", line = 96)
    private final void method3495() {
        this.method3499(this.nativeid);
    }

    @OriginalMember(owner = "client!a", name = "w", descriptor = "(Z)V", line = 100)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lhba;[III)V", line = 113)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILhba;ZI)Z", line = 121)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;IIIIIII[[Z)V", line = 124)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lhba;[II)V", line = 127)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILhba;Z)Z", line = 130)
