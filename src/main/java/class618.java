...
public class class618 extends class297 {
    ...
    @OriginalMember(owner = "client!jia", name = "d", descriptor = "(II)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(IIZIIIIZ[Lat;II)V", line = 67)
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(Lcea;II)V", line = 909)
    ...
    @OriginalMember(owner = "client!jia", name = "<init>", descriptor = "()V", line = 957)
    public class618() {
        super(1, false);
    }

    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(IZI)V", line = 966)
    ...
    @OriginalMember(owner = "client!jia", name = "c", descriptor = "(II)[I", line = 984)
    ...
    @OriginalMember(owner = "client!jia", name = "f", descriptor = "(I)V", line = 1026)
