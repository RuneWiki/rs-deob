...
public class class618 {
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 17)
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(IIILjava/lang/Class;)Liaa;", line = 55)
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(BI)Lpl;", line = 80)
    ...
    @OriginalMember(owner = "client!aga", name = "b", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!aga", name = "c", descriptor = "(I)V", line = 131)
    public static void method3592(int arg0) {
        field8746 = null;
        int var1 = 45 / ((-arg0 - 23) / 50);
    }

    @OriginalMember(owner = "client!aga", name = "<init>", descriptor = "(Lei;ILri;)V", line = 150)
