...
public class class618 extends class125 {
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(BZI)I", line = 5)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(ZI)I", line = 41)
    ...
    @OriginalMember(owner = "client!jv", name = "b", descriptor = "(II)Z", line = 55)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(BI)V", line = 66)
    ...
    @OriginalMember(owner = "client!jv", name = "c", descriptor = "(Z)I", line = 78)
    ...
    @OriginalMember(owner = "client!jv", name = "<init>", descriptor = "(Lgp;)V", line = 89)
    public class618(class549 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jv", name = "b", descriptor = "(Z)V", line = 92)
    ...
    @OriginalMember(owner = "client!jv", name = "b", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Laj;B)V", line = 117)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(B)I", line = 149)
    ...
    @OriginalMember(owner = "client!jv", name = "<init>", descriptor = "(ILgp;)V", line = 164)
