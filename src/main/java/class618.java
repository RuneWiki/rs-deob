...
public class class618 {
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IB)Ljava/lang/String;", line = 10)
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "()V", line = 178)
    public class618() {
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(Lun;)V", line = 194)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Lun;I)V", line = 50)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IZII)Ljava/lang/String;", line = 64)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Lgba;I)Z", line = 130)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IIII)V", line = 144)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Z)V", line = 169)
