...
public abstract class class618 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IBII)V", line = 8)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IIIIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(II)Z", line = 44)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IIB)Z", line = 66)
