...
public class class618 extends class631 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(I[BIILjava/lang/String;I)I", line = 6)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ZIJILr;)V", line = 146)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(I)V", line = 404)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(JBLr;)V", line = 415)
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(Lr;Lmp;Lii;J)V", line = 516)
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(I)V", line = 457)
