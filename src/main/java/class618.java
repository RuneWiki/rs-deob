...
public class class618 {
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(III)Z", line = 28)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IZ[S)[S", line = 43)
