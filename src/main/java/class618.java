...
public abstract class class618 extends class487 {
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "([BB)Z", line = 6)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(II)Lwm;", line = 40)
    ...
    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Lag;Z)Z", line = 76)
    ...
    @OriginalMember(owner = "client!lw", name = "<init>", descriptor = "(IIIIZZ)V", line = 200)
