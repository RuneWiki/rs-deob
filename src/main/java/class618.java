...
public class class618 extends class614 {
    ...
    @OriginalMember(owner = "client!aaa", name = "c", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!aaa", name = "b", descriptor = "(I)I", line = 22)
    ...
    @OriginalMember(owner = "client!aaa", name = "e", descriptor = "(B)I", line = 33)
    ...
    @OriginalMember(owner = "client!aaa", name = "f", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(BIZ)V", line = 57)
    ...
    @OriginalMember(owner = "client!aaa", name = "e", descriptor = "(I)I", line = 81)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(I)J", line = 94)
