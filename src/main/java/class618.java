...
public class class618 {
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(BI)Lqba;")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(III)Lul;")
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(Luea;IZLpq;Lpq;)V")
