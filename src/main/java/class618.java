...
public abstract class class618 implements class399 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(ILse;)V")
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(ILvn;Lwha;)Lnq;")
    ...
    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "(Ltia;ILua;Ldn;IZ)V")
