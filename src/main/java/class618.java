...
public class class618 {
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!kia", name = "b", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(III)Z", line = 44)
