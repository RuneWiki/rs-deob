...
public class class618 {
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(ILjagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V")
    ...
    @OriginalMember(owner = "client!jia", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V")
