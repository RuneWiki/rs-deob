...
public class class618 extends class353 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(ILqda;I)V")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Lcea;B[[B)V")
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(Lum;Lgb;)V")
