...
public class class618 {
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(Llp;IIIII)V")
    ...
    @OriginalMember(owner = "client!aca", name = "<init>", descriptor = "(ILdn;Ldn;)V")
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(II)Laea;")
