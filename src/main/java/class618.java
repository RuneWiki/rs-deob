...
public class class618 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Ljava/lang/String;BLkfa;I)Lru;", line = 8)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 47)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(B[[BLn;)V", line = 91)
