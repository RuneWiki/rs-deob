...
public class class618 extends class330 {
    ...
    @OriginalMember(owner = "client!he", name = "<init>", descriptor = "()V", line = 5)
    public class618() {
        super(0, true);
    }

    @OriginalMember(owner = "client!he", name = "d", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "(Z)V", line = 82)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Lgga;IB)V", line = 117)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IIIIIII)I", line = 215)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(BI[I)V", line = 291)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IZ)[I", line = 451)
