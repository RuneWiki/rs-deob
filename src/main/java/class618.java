...
public class class618 implements class532 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;III)V", line = 8)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILnga;ZI)Z", line = 12)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "()V", line = 15)
    public final void method3455() {
        this.field8627 = Thread.currentThread();
        this.method3457();
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lha;IIIIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!a", name = "b", descriptor = "()V", line = 23)
    private final void method3457() {
        this.method3459(this.nativeid);
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lka;IIIZ)V", line = 34)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;[ILnga;)V", line = 37)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILnga;Z)Z", line = 41)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lnga;[III)V", line = 44)
    ...
    @OriginalMember(owner = "client!a", name = "w", descriptor = "(Z)V", line = 94)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;IIIIIII[[Z)V", line = 109)
    ...
    @OriginalMember(owner = "client!a", name = "finalize", descriptor = "()V", line = 121)
    ...
    @OriginalMember(owner = "client!a", name = "d", descriptor = "()V", line = 126)
    private final void method3479() {
        this.method3460(this.nativeid);
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lnga;[II)V", line = 131)
