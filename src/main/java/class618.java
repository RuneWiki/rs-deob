...
public class class618 extends class513 {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "()[I", line = 5)
    public final int[] method3624() {
        return this.field8787;
    }

    @OriginalMember(owner = "client!lt", name = "b", descriptor = "()V", line = 9)
    public static void method3625() {
        field8785 = null;
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(II)V", line = 12)
    ...
    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "(II[IZ)V", line = 59)
