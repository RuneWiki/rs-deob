...
public class class618 {
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(IIIIIZLpu;)V")
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(IIBBZ)Luh;")
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(IZLmea;)V")
