...
public class class618 extends class608 {
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(Lha;Z)V")
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(IBLha;I)Z")
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(Lha;I)Lria;")
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(Lns;B)V")
    ...
    @OriginalMember(owner = "client!mfa", name = "b", descriptor = "(Lha;B)Lc;")
