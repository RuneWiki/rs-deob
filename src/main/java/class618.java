...
public class class618 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(II)Z", line = 9)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 32)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IB[BLnv;)Lpj;", line = 63)
    ...
    @OriginalMember(owner = "client!vs", name = "b", descriptor = "(II)Ljava/lang/String;", line = 108)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(B)V", line = 146)
    ...
    @OriginalMember(owner = "client!vs", name = "b", descriptor = "(I)V", line = 168)
    public static void method3503(int arg0) {
        int var1 = 68 / ((15 - arg0) / 43);
        field8324 = null;
    }

    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(ILes;I)V", line = 178)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Les;I)V", line = 233)
    ...
    @OriginalMember(owner = "client!vs", name = "c", descriptor = "(I)V", line = 254)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IZ)I", line = 279)
