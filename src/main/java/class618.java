...
public class class618 extends class735 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IIB)B", line = 5)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "()V", line = 39)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(ILfca;)V", line = 132)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Lrh;Z)V", line = 155)
    ...
    @OriginalMember(owner = "client!vs", name = "b", descriptor = "(II)Z", line = 170)
