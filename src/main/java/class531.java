...
public class class531 {
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BLjava/lang/Object;ILada;)V", line = 4)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(I)I", line = 33)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Lpk;I)V", line = 86)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(B)I", line = 105)
    public final int method3033(byte arg0) {
        field7471++;
        return arg0 == -48 ? this.field7459 : -26;
    }

    @OriginalMember(owner = "client!eb", name = "c", descriptor = "(B)V", line = 128)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BI)V", line = 143)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Ljava/lang/Object;Lada;I)V", line = 191)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Lada;I)V", line = 211)
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(I)V", line = 325)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "([I[[B[[BI[BI[II)I", line = 240)
    ...
    @OriginalMember(owner = "client!eb", name = "c", descriptor = "(I)V", line = 301)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BLada;)Ljava/lang/Object;", line = 341)
