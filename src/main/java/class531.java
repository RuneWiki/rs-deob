...
public class class531 {
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(IILwc;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(I)V", line = 39)
