...
public class class531 {
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(ILps;Lr;)V")
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(BI)Ldw;")
    ...
    @OriginalMember(owner = "client!cda", name = "<init>", descriptor = "(Lsea;ILmv;Lmv;)V")
