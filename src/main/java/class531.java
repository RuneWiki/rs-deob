...
public abstract class class531 extends class115 {
    ...
    @OriginalMember(owner = "client!wr", name = "c", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!wr", name = "d", descriptor = "(B)F", line = 15)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(I)I", line = 28)
    ...
    @OriginalMember(owner = "client!wr", name = "c", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Z)I", line = 66)
    public final int method3154(boolean arg0) {
        field7828++;
        return arg0 ? 54 : this.field7820;
    }

    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lkh;B)V", line = 82)
    ...
    @OriginalMember(owner = "client!wr", name = "d", descriptor = "(I)I", line = 115)
    ...
    @OriginalMember(owner = "client!wr", name = "e", descriptor = "(I)I", line = 130)
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(IIIIIF)V", line = 150)
