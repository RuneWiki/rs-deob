...
public class class531 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lha;)Lfha;")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lha;IIIIIII[S[BZ)V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Ld;II)V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(II)Lfl;")
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lha;Lvj;IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "([B[B[SII)V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lha;II)V")
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(II)Ldm;")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lha;Lgfa;IIII)V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lha;Lgfa;Ljk;)V")
    ...
    @OriginalMember(owner = "client!gr", name = "c", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lha;IIII)V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(I)Lfl;")
    public static final class520 method3167(int arg0) {
        return (class520) field7424.method1381(true, (long) arg0);
    }

    @OriginalMember(owner = "client!gr", name = "d", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lwu;Leq;Lob;Lhk;Lkq;Llg;Laca;)V")
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(Lha;IIII)Lfha;")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lha;IIII[S[B)V")
    ...
    @OriginalMember(owner = "client!gr", name = "e", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Ld;III)I")
