...
public class class531 extends class483 implements class443 {
    ...
    @OriginalMember(owner = "client!vw", name = "<init>", descriptor = "(Lhb;Lsk;III[B)V", line = 5)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(ILng;)V", line = 78)
    public final void method390(int arg0, class219 arg1) {
        super.method390(arg0, arg1);
    }

    @OriginalMember(owner = "client!vw", name = "b", descriptor = "(Z)V", line = 85)
    ...
    @OriginalMember(owner = "client!vw", name = "b", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 96)
