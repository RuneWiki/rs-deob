...
public class class531 extends class30 {
    ...
    @OriginalMember(owner = "client!im", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(BILac;)V", line = 18)
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "()V", line = 47)
    public class531() {
        super(0, true);
    }

    @OriginalMember(owner = "client!im", name = "a", descriptor = "(II)[I", line = 56)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IIIIIII)Lwn;", line = 136)
