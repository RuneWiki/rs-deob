...
public class class531 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "([Ltf;I)V", line = 45)
    ...
    @OriginalMember(owner = "client!ko", name = "toString", descriptor = "()Ljava/lang/String;", line = 74)
    public final String toString() {
        field7488++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(FIIFIFLfba;IFFB)[B", line = 116)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(B)V", line = 131)
    public static void method3166(byte arg0) {
        int var1 = -3 % ((arg0 - 29) / 47);
        field7485 = null;
    }

    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IZII)V", line = 143)
