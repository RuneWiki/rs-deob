...
public class class531 extends class583 {
    ...
    @OriginalMember(owner = "client!ve", name = "c", descriptor = "(B)J", line = 3)
    public final long method604(byte arg0) {
        return arg0 <= 63 ? -114L : this.field7240;
    }

    @OriginalMember(owner = "client!ve", name = "d", descriptor = "(B)J", line = 13)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(JI)I", line = 61)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "()V", line = 117)
    public class531() {
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(B)J", line = 97)
