...
public class class531 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IB)Lnb;")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Lee;Z)Lhc;")
    ...
    @OriginalMember(owner = "client!pt", name = "<init>", descriptor = "(Lms;ILwu;)V")
