...
public class class531 extends class305 {
    ...
    @OriginalMember(owner = "client!fv", name = "e", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(ILfh;B)V", line = 18)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "()V", line = 159)
    public class531() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fv", name = "b", descriptor = "(III)Z", line = 115)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(IBLum;I)Lwr;", line = 132)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(II)[I", line = 163)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(BIII[BI)V", line = 225)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(IBI)Z", line = 257)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 279)
