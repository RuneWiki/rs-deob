...
public class class531 implements class277 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(FIIZII)[F", line = 4)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IBIZFI)[I", line = 26)
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(II)Lkf;", line = 38)
    ...
    @OriginalMember(owner = "client!mp", name = "c", descriptor = "(II)Ldd;", line = 59)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IIZFZI)[I", line = 84)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(III)V", line = 95)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(Lmg;Lmg;Lmg;)V", line = 254)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(II)Z", line = 241)
