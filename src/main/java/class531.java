...
public abstract class class531 {
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IILrq;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Ldga;I)Lns;", line = 71)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IIIIII)Z", line = 90)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(I)V", line = 149)
