...
public class class531 extends class430 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "([BI)V", line = 4)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Lla;)Z", line = 10)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(I)I", line = 42)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "([B)V", line = 69)
    ...
    @OriginalMember(owner = "client!pd", name = "c", descriptor = "()I", line = 232)
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "([B)V", line = 240)
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(I)[F", line = 286)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Lla;I)Lpd;", line = 699)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Lla;II)Lpd;", line = 715)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "([I)Ljda;", line = 731)
    ...
    @OriginalMember(owner = "client!pd", name = "c", descriptor = "(I)F", line = 797)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "([B)V", line = 816)
