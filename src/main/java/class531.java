...
public class class531 extends class646 {
    ...
    @OriginalMember(owner = "client!pca", name = "b", descriptor = "(IB)[I", line = 4)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(B)V", line = 257)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(Ld;Lhw;IIIIILnf;)V", line = 268)
    ...
    @OriginalMember(owner = "client!pca", name = "<init>", descriptor = "()V", line = 568)
    public class531() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(BLjava/util/Random;I[[IIII)V", line = 372)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(IZI)Z", line = 571)
    ...
    @OriginalMember(owner = "client!pca", name = "c", descriptor = "(I)V", line = 590)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(Lek;IB)V", line = 608)
