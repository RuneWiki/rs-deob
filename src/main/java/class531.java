...
public class class531 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(III)V", line = 6)
    ...
    @OriginalMember(owner = "client!cr", name = "toString", descriptor = "()Ljava/lang/String;", line = 28)
    public final String toString() {
        field7749++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(B)I", line = 40)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(BILec;)V", line = 483)
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(B)V", line = 520)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lr;B)V", line = 532)
