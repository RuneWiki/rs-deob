...
public class class531 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(B)V", line = 11)
    public static void method3140(byte arg0) {
        field7727 = null;
        int var1 = 120 / ((arg0 - 33) / 47);
    }

    @OriginalMember(owner = "client!mo", name = "toString", descriptor = "()Ljava/lang/String;", line = 22)
    public final String toString() {
        field7726++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(II)V", line = 34)
