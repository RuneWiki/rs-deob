...
public class class531 implements Runnable {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(II[[[Llha;IBZ)Z")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(BILbg;)Lrba;")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(III)Lhc;")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "([BBLbg;I)Lrba;")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IIILsba;Z)V")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Lni;I)V")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(ILrba;)V")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(ILbg;I)Lrba;")
    ...
    @OriginalMember(owner = "client!pt", name = "<init>", descriptor = "(Lfl;)V")
