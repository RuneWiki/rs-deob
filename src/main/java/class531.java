...
public abstract class class531 extends class540 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(B)I", line = 6)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(I)I", line = 17)
    public static final int method3082(int arg0) {
        field7520++;
        return arg0 == 0 ? class211.field3063 : 23;
    }

    @OriginalMember(owner = "client!ek", name = "d", descriptor = "(B)Z", line = 31)
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "(I)I", line = 49)
    ...
    @OriginalMember(owner = "client!ek", name = "c", descriptor = "(I)Z", line = 60)
    ...
    @OriginalMember(owner = "client!ek", name = "g", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "(Lkv;)V", line = 90)
