...
public class class531 implements class653 {
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "(I)V", line = 9)
    public class531(int arg0) {
        this.field7445 = arg0;
    }

    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IIILsw;)V", line = 19)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(III)Lcp;", line = 40)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(B)Lrw;", line = 59)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IIIIIII)I", line = 71)
