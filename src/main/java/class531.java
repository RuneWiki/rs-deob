...
public class class531 {
    ...
    @OriginalMember(owner = "client!mp", name = "c", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!mp", name = "d", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Lvh;I)Lmp;")
    ...
    @OriginalMember(owner = "client!mp", name = "e", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(Lvh;I)[Lmp;")
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Lvh;II)[Lmp;")
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "([B)[Lmp;")
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(Lvh;II)Lmp;")
