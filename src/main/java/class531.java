...
public class class531 {
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!vv", name = "b", descriptor = "(Z)Lfs;", line = 37)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(ILfs;)V", line = 77)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(IIII)I", line = 95)
    ...
    @OriginalMember(owner = "client!vv", name = "<init>", descriptor = "()V", line = 157)
    public class531() {
        this.field7812.field3888 = this.field7812;
        this.field7812.field3890 = this.field7812;
    }

    @OriginalMember(owner = "client!vv", name = "c", descriptor = "(Z)Lfs;", line = 112)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(B)Lfs;", line = 136)
