...
public class class531 extends class695 {
    ...
    @OriginalMember(owner = "client!um", name = "e", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IZ)V", line = 178)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Z)Z", line = 191)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(ZB)V", line = 203)
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Lfc;)V", line = 234)
    public class531(class575 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Lnm;ZI)V", line = 237)
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "(I)V", line = 249)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(III)V", line = 279)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IIIII[BB)Z", line = 290)
