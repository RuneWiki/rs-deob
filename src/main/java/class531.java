...
public class class531 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "([III)V", line = 50)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "()V", line = 99)
    private static final void method3123() {
        field7815 = 0;
    }

    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(II)V", line = 102)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Lqa;[II)V", line = 139)
    public static final void method3125(class162 arg0, int[] arg1, int arg2) {
        method3126(arg0, arg1, 0, arg1.length, arg2, null, null);
    }

    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Lqa;[IIII[I[I)V", line = 145)
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "()V", line = 182)
    public static void method3127() {
        field7816 = null;
    }

    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Lqa;[II[I[I)V", line = 188)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(I)Z", line = 199)
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(I)V", line = 275)
