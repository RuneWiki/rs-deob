...
public class class531 extends class535 {
    ...
    @OriginalMember(owner = "client!kn", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(II)[[I", line = 14)
    ...
    @OriginalMember(owner = "client!kn", name = "e", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/Class;", line = 118)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(ILwn;I)V", line = 168)
