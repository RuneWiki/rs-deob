...
public class class531 {
    ...
    @OriginalMember(owner = "client!pga", name = "finalize", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(BII)Z", line = 17)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!pga", name = "<init>", descriptor = "(Leea;J[Lib;)V", line = 48)
