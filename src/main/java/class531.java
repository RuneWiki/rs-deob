...
public class class531 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(B)Lff;")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(II)Lhd;")
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "(Lhd;I)V")
