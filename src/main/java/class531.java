...
public class class531 extends class159 {
    ...
    @OriginalMember(owner = "client!ef", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!ef", name = "c", descriptor = "(II)V", line = 21)
    ...
    @OriginalMember(owner = "client!ef", name = "c", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!ef", name = "b", descriptor = "(II)[B", line = 74)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(B)Lbo;", line = 94)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Z)Ltn;", line = 113)
    ...
    @OriginalMember(owner = "client!ef", name = "d", descriptor = "(I)V", line = 209)
    ...
    @OriginalMember(owner = "client!ef", name = "e", descriptor = "(I)I", line = 388)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(BII)Lau;", line = 411)
    ...
    @OriginalMember(owner = "client!ef", name = "f", descriptor = "(I)I", line = 679)
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(ILgg;Lgg;Lcq;Lpt;I[BIZ)V", line = 1259)
    ...
    @OriginalMember(owner = "client!ef", name = "d", descriptor = "(II)I", line = 703)
    public static final int method2989(int arg0, int arg1) {
        return class99.field1716 == null ? 0 : class99.field1716[arg0][arg1] & 0xFFFFFF;
    }

    @OriginalMember(owner = "client!ef", name = "b", descriptor = "(B)V", line = 706)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IIIIIILaea;IIII)Z", line = 750)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(II)I", line = 1107)
    ...
    @OriginalMember(owner = "client!ef", name = "c", descriptor = "(B)I", line = 1123)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(III)B", line = 1148)
    ...
    @OriginalMember(owner = "client!ef", name = "g", descriptor = "(I)V", line = 1173)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ILjava/lang/String;)V", line = 1208)
    ...
    @OriginalMember(owner = "client!ef", name = "d", descriptor = "(B)V", line = 1231)
