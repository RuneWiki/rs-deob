...
public class class531 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Lkba;ZZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(IIII)Lde;", line = 48)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ZLee;)Lwfa;", line = 62)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Z)V", line = 84)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(I)Lef;", line = 100)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(IZLjava/lang/String;IIIII)V", line = 111)
    ...
    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "(IIIIB)V", line = 142)
