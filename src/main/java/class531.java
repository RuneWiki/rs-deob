...
public class class531 {
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IIILgga;IZ)V")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(B)Lqn;")
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(BLqn;)V")
