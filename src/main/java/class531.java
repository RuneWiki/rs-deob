...
public class class531 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(ILfa;Ljava/awt/Canvas;I)Lr;")
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Lnp;I)V")
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "([I[IIILmj;I)Lpp;")
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Lnp;IB)V")
