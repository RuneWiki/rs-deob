...
public class class531 {
    ...
    @OriginalMember(owner = "client!de", name = "b", descriptor = "(B)Z", line = 21)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(IJ)V", line = 35)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ILjava/io/File;I)[B", line = 51)
