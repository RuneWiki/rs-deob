...
public class class531 {
    ...
    public static int[] field7805 = new int[1];

    @OriginalMember(owner = "client!mp", name = "a", descriptor = "Liv;")
    public static class64 field7803 = new class64(16, 9);

    @OriginalMember(owner = "client!mp", name = "s", descriptor = "I")
    public static int field7821 = 0;

    @OriginalMember(owner = "client!mp", name = "v", descriptor = "Lrn;")
    public static class174 field7824 = new class174(53, -1);
