...
public class class531 {
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IBI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IC)Z", line = 16)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "([Ljava/lang/String;I)V", line = 30)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(B)[Lhw;", line = 74)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "()V", line = 103)
    public static final void method3215() {
        class127.method1110(1, class524.field7649);
    }

    @OriginalMember(owner = "client!im", name = "b", descriptor = "(Z)V", line = 107)
