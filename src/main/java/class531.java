...
public class class531 extends class150 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "([IB)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(BII)I", line = 56)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IIIIII)V", line = 73)
    ...
    @OriginalMember(owner = "client!nj", name = "b", descriptor = "(I)V", line = 180)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(BLr;I)Lsa;", line = 208)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(II)V", line = 225)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IIIIILwd;IIIII)Z", line = 240)
