...
public class class93 extends class298 {
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!qb", name = "c", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "()V", line = 35)
    public class93() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(ILvt;)Lgd;", line = 40)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Loj;BJ)V", line = 51)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IZ)[I", line = 93)
    ...
    @OriginalMember(owner = "client!qb", name = "d", descriptor = "(III)I", line = 115)
