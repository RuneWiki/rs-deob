...
public class class93 extends class449 {
    ...
    @OriginalMember(owner = "client!bi", name = "d", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(I[B)[B", line = 26)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IIIII)V", line = 48)
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "()V", line = 61)
    public class93() {
    }

    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 63)
