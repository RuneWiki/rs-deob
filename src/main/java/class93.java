...
public class class93 extends class55 implements class425 {
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(ILii;I)Ldc;", line = 4)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Lii;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!oc", name = "h", descriptor = "(I)I", line = 53)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(BLii;)V", line = 65)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(I)I", line = 93)
    ...
    @OriginalMember(owner = "client!oc", name = "d", descriptor = "(I)I", line = 112)
    public final int method105(int arg0) {
        ++field1308;
        return arg0 > -4 ? 91 : this.field1311;
    }

    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(I)I", line = 125)
    public final int method120(int arg0) {
        ++field1330;
        return arg0 != 25940 ? 96 : this.field1322;
    }

    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IIZLii;)Z", line = 136)
    ...
    @OriginalMember(owner = "client!oc", name = "d", descriptor = "(B)V", line = 157)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(I[Lps;B)V", line = 176)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(B)V", line = 245)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Lii;ZIB)Lcb;", line = 259)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IBLii;)Ldc;", line = 289)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(ILii;)V", line = 313)
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(Lii;Lge;IIIIIZIIIIIIZ)V", line = 323)
    ...
    @OriginalMember(owner = "client!oc", name = "e", descriptor = "(I)Z", line = 355)
    public final boolean method166(int arg0) {
        ++field1336;
        return arg0 != -17506 ? true : this.field1319;
    }

    @OriginalMember(owner = "client!oc", name = "c", descriptor = "(I)Z", line = 375)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Z)V", line = 386)
    ...
    @OriginalMember(owner = "client!oc", name = "i", descriptor = "(I)V", line = 398)
    ...
    @OriginalMember(owner = "client!oc", name = "f", descriptor = "(I)I", line = 412)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "([BI)[B", line = 429)
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(Lii;I)Leb;", line = 446)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Lii;IIIILnc;Z)V", line = 475)
