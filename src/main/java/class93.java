...
public class class93 {
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(ZLjava/lang/String;)Ljava/lang/String;", line = 49)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(BC)V", line = 126)
    ...
    @OriginalMember(owner = "client!qda", name = "b", descriptor = "(I)V", line = 137)
    ...
    @OriginalMember(owner = "client!qda", name = "b", descriptor = "(Z)V", line = 153)
    ...
    @OriginalMember(owner = "client!qda", name = "<init>", descriptor = "(Ljaa;I)V", line = 166)
