...
public abstract class class93 {
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(Lbo;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(Lbo;ILjaggl/memory/NativeBuffer;IZ)V")
