...
public class class93 extends class249 implements class289 {
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ILoa;)V", line = 32)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(ILoa;)V", line = 62)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(I)I", line = 93)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(B)V", line = 107)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIIIIIIIIB)V", line = 119)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(B)I", line = 146)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IILoa;)Lba;", line = 159)
    public final class629 method124(int arg0, int arg1, class689 arg2) {
        ++field1160;
        return arg1 != 17925 ? null : this.method521(arg0, (byte) 63, arg2);
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Z)Z", line = 170)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Loa;IIZ)Ltaa;", line = 181)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IBLoa;)Lba;", line = 213)
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(Loa;Luca;IIIIZIIIII)V", line = 235)
    ...
    @OriginalMember(owner = "client!hs", name = "f", descriptor = "(I)I", line = 262)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(BLoa;)V", line = 273)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(BLoa;)Lvg;", line = 285)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIILoa;)Z", line = 302)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Loa;B)Llt;", line = 325)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(I[BBI)Ljava/lang/String;", line = 352)
