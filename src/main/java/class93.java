...
public class class93 extends class264 {
    ...
    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "(ILmfa;)V")
    public class93(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(IIIILha;I)V")
    ...
    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "(Lmfa;)V")
