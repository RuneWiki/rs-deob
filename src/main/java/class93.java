...
public class class93 extends class287 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(IZLjava/lang/String;)Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(IILsv;)V", line = 28)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ILsv;)Lds;", line = 76)
    ...
    @OriginalMember(owner = "client!fq", name = "b", descriptor = "(ILsv;)V", line = 87)
    ...
    @OriginalMember(owner = "client!fq", name = "f", descriptor = "(I)V", line = 114)
    public static void method763(int arg0) {
        field1520 = null;
        int var1 = 114 % ((arg0 + 37) / 59);
    }

    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(III)I", line = 124)
