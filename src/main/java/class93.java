...
public class class93 extends class243 {
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(II)[I", line = 17)
    ...
    @OriginalMember(owner = "client!aja", name = "<init>", descriptor = "()V", line = 39)
    public class93() {
        super(0, true);
    }

    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(Lha;B)V", line = 44)
