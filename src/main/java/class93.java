...
public class class93 extends class507 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(IBILqf;)V")
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "(Lad;IIII)V")
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "(Lad;IIII[BI)V")
