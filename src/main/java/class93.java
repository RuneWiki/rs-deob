...
public class class93 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ILtv;I)V")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Ld;ILoh;IILjava/awt/Canvas;)Lha;")
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "(Lnv;Lou;Leo;IIIII)V")
