...
public class class93 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "()Lwo;", line = 6)
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "(Ltq;)V", line = 129)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "()I", line = 14)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lam;II)Lki;", line = 59)
    ...
    @OriginalMember(owner = "client!ki", name = "c", descriptor = "()[B", line = 71)
