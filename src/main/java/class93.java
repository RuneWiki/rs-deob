...
public class class93 extends class325 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(Z)J", line = 16)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Z)J", line = 52)
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "()V", line = 67)
    public class93() {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(II)I", line = 78)
