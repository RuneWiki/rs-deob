...
public class class93 extends class270 {
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IZI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!oc", name = "e", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "()V", line = 47)
    public class93() {
        super(0, true);
    }

    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(BLec;I)V", line = 51)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;Z)V", line = 139)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(BI)[I", line = 180)
    ...
    @OriginalMember(owner = "client!oc", name = "f", descriptor = "(I)V", line = 296)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(BZ)V", line = 360)
