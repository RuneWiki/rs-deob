...
public class class93 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lv;I)V", line = 49)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(IZ)V", line = 71)
