...
public class class93 {
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(IILr;I)Z")
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Lr;IBI)V")
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(ILr;II)V")
    ...
    @OriginalMember(owner = "client!cea", name = "<init>", descriptor = "(Lkw;Lmt;)V")
