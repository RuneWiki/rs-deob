...
public class class93 {
    ...
    @OriginalMember(owner = "client!vh", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(II)Lgu;", line = 32)
    ...
    @OriginalMember(owner = "client!vh", name = "b", descriptor = "(II)V", line = 68)
    ...
    @OriginalMember(owner = "client!vh", name = "c", descriptor = "(II)V", line = 83)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(ILbp;)V", line = 105)
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "(Lgo;ILns;)V", line = 148)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(Z)V", line = 136)
