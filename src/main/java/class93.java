...
public class class93 extends class281 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(ILtq;)V")
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Lpl;BI)V")
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(III[ILpl;I)V")
    ...
    @OriginalMember(owner = "client!ct", name = "b", descriptor = "()Lwg;")
    ...
    @OriginalMember(owner = "client!ct", name = "d", descriptor = "()Lwg;")
    ...
    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "(Lls;)V")
