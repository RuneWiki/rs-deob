...
public class class93 extends class556 implements class457 {
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(Lha;I)V", line = 14)
    ...
    @OriginalMember(owner = "client!aja", name = "h", descriptor = "(I)I", line = 26)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(B)I", line = 39)
    ...
    @OriginalMember(owner = "client!aja", name = "b", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!aja", name = "i", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(IZBLha;)Lok;", line = 76)
    ...
    @OriginalMember(owner = "client!aja", name = "f", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!aja", name = "d", descriptor = "(ILha;)Lwg;", line = 125)
    ...
    @OriginalMember(owner = "client!aja", name = "d", descriptor = "(B)I", line = 139)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(ILha;I)Lka;", line = 154)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(BILha;I)Z", line = 175)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(ILwha;)I", line = 197)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(IILrba;Lha;ZII)V", line = 240)
    ...
    @OriginalMember(owner = "client!aja", name = "b", descriptor = "(Lha;I)Ljk;", line = 272)
    ...
    @OriginalMember(owner = "client!aja", name = "<init>", descriptor = "(Lha;Lac;IIIIIZIIIIIIZ)V", line = 298)
    ...
    @OriginalMember(owner = "client!aja", name = "b", descriptor = "(I)Z", line = 329)
    public final boolean method756(int arg0) {
        ++field1289;
        return arg0 > -52 ? true : this.field1290;
    }

    @OriginalMember(owner = "client!aja", name = "c", descriptor = "(Z)I", line = 341)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(Z)I", line = 352)
    ...
    @OriginalMember(owner = "client!aja", name = "e", descriptor = "(I)Z", line = 366)
    ...
    @OriginalMember(owner = "client!aja", name = "g", descriptor = "(B)Z", line = 383)
    ...
    @OriginalMember(owner = "client!aja", name = "f", descriptor = "(I)Z", line = 399)
    ...
    @OriginalMember(owner = "client!aja", name = "b", descriptor = "(ILha;)V", line = 419)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(ILha;)V", line = 448)
