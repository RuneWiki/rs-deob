...
public class class93 {
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(BI)Lkga;", line = 4)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(II)V", line = 47)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(I[Lgaa;B)V", line = 83)
    ...
    @OriginalMember(owner = "client!naa", name = "b", descriptor = "(B)V", line = 151)
    ...
    @OriginalMember(owner = "client!naa", name = "b", descriptor = "(II)Lrj;", line = 168)
    ...
    @OriginalMember(owner = "client!naa", name = "<init>", descriptor = "(Ldh;ILkha;Lkha;Lkha;)V", line = 211)
