...
public class class93 {
    ...
    @OriginalMember(owner = "client!vga", name = "<init>", descriptor = "(Lda;)V", line = 54)
    public class93(class66 arg0) {
        this.field1326 = arg0;
    }

    @OriginalMember(owner = "client!vga", name = "<init>", descriptor = "(Lda;Leia;)V", line = 61)
    public class93(class66 arg0, class255 arg1) {
        this.field1331 = arg1;
        this.field1326 = arg0;
    }

    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!vga", name = "b", descriptor = "(I)V", line = 23)
