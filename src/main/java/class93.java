...
public class class93 extends class466 implements class523 {
    ...
    @OriginalMember(owner = "client!nb", name = "l", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!nb", name = "d", descriptor = "(B)I", line = 16)
    ...
    @OriginalMember(owner = "client!nb", name = "i", descriptor = "(I)Z", line = 27)
    ...
    @OriginalMember(owner = "client!nb", name = "j", descriptor = "(I)I", line = 40)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(BLha;)V", line = 50)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(I)I", line = 61)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(B)Z", line = 72)
    public final boolean method88(byte arg0) {
        ++field1379;
        return arg0 < 44 ? false : this.field1397.method827((byte) -74);
    }

    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(Lha;I)V", line = 83)
    ...
    @OriginalMember(owner = "client!nb", name = "c", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IILha;I)Z", line = 118)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(BI[ILrs;I[I)Lrl;", line = 140)
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(B)I", line = 172)
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "(Lha;Ljl;IIIIIZIIIII)V", line = 185)
    ...
    @OriginalMember(owner = "client!nb", name = "k", descriptor = "(I)Z", line = 198)
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(I)I", line = 209)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IZILjava/lang/String;I)V", line = 221)
    ...
    @OriginalMember(owner = "client!nb", name = "m", descriptor = "(I)I", line = 351)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lha;I)Lkn;", line = 371)
    ...
    @OriginalMember(owner = "client!nb", name = "f", descriptor = "(B)[Laia;", line = 382)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IIII)V", line = 394)
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(ILha;)Lgh;", line = 417)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lha;Z)V", line = 472)
