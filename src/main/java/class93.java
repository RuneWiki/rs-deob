...
public abstract class class93 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!vh", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 3)
    public final void focusLost(FocusEvent arg0) {
        field1551++;
        class209.field3318 = false;
    }

    @OriginalMember(owner = "client!vh", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 13)
    public final void windowDeactivated(WindowEvent arg0) {
        field1539++;
    }

    @OriginalMember(owner = "client!vh", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 21)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IIIII)V", line = 35)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(B)Ljava/lang/String;", line = 82)
    ...
    @OriginalMember(owner = "client!vh", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 95)
    ...
    @OriginalMember(owner = "client!vh", name = "run", descriptor = "()V", line = 112)
    ...
    @OriginalMember(owner = "client!vh", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 227)
    ...
    @OriginalMember(owner = "client!vh", name = "c", descriptor = "(I)V", line = 246)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(BZ)V", line = 294)
    ...
    @OriginalMember(owner = "client!vh", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 376)
    public final void windowClosing(WindowEvent arg0) {
        this.destroy();
        field1540++;
    }

    @OriginalMember(owner = "client!vh", name = "d", descriptor = "(I)V", line = 387)
    ...
    @OriginalMember(owner = "client!vh", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 398)
    public final void update(Graphics arg0) {
        field1531++;
        this.paint(arg0);
    }

    @OriginalMember(owner = "client!vh", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 406)
    ...
    @OriginalMember(owner = "client!vh", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 420)
    ...
    @OriginalMember(owner = "client!vh", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 446)
    public final void windowActivated(WindowEvent arg0) {
        field1536++;
    }

    @OriginalMember(owner = "client!vh", name = "c", descriptor = "(B)Z", line = 454)
    ...
    @OriginalMember(owner = "client!vh", name = "providesignlink", descriptor = "(Lnv;)V", line = 493)
    ...
    @OriginalMember(owner = "client!vh", name = "start", descriptor = "()V", line = 508)
    ...
    @OriginalMember(owner = "client!vh", name = "e", descriptor = "(I)V", line = 519)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(BLjava/lang/String;)V", line = 551)
    ...
    @OriginalMember(owner = "client!vh", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 577)
    public final void windowIconified(WindowEvent arg0) {
        field1541++;
    }

    @OriginalMember(owner = "client!vh", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 585)
    public final void windowOpened(WindowEvent arg0) {
        field1529++;
    }

    @OriginalMember(owner = "client!vh", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 594)
    public final void windowClosed(WindowEvent arg0) {
        field1537++;
    }

    @OriginalMember(owner = "client!vh", name = "e", descriptor = "(B)V", line = 601)
    ...
    @OriginalMember(owner = "client!vh", name = "f", descriptor = "(B)V", line = 636)
    ...
    @OriginalMember(owner = "client!vh", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 698)
    public final void windowDeiconified(WindowEvent arg0) {
        field1534++;
    }

    @OriginalMember(owner = "client!vh", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 705)
    ...
    @OriginalMember(owner = "client!vh", name = "destroy", descriptor = "()V", line = 721)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(ZILjava/lang/String;ZIIII)V", line = 736)
    ...
    @OriginalMember(owner = "client!vh", name = "stop", descriptor = "()V", line = 775)
