...
public class class93 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(B)Z", line = 9)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IIIIIZ)Z", line = 39)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(III)Lkg;", line = 71)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(ILti;)V", line = 88)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(BILti;)V", line = 114)
