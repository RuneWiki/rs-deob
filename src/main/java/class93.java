...
public class class93 implements class172 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(ILds;II)V")
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(ILim;I)V")
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(ILwm;)V")
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(ILim;)V")
    public final void method663(int arg0, class342 arg1) {
        this.method657(arg0, arg1, 0);
    }

    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(Ltb;)V")
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(ILds;I)V")
