...
public class class93 extends class98 {
    ...
    @OriginalMember(owner = "client!ld", name = "f", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IIIBIIIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(II)[I", line = 61)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IIIIIII)I", line = 74)
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "()V", line = 109)
    public class93() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IC)Z", line = 112)
