...
public class class93 extends class391 implements class198 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(III[I)V", line = 10)
    public final void method239(int arg0, int arg1, int arg2, int[] arg3) {
        this.method774(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!ra", name = "finalize", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "()V", line = 29)
    public class93() {
        this.method773();
    }
