...
public class class93 extends class175 {
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(Lvn;Lvm;[Ldr;[I[I)V")
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "([B[IIIIIIIIIIILvj;II)V")
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(CIIIZLvj;II)V")
