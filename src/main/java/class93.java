...
public class class93 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(II)Lhn;", line = 15)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IB)V", line = 77)
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!sd", name = "c", descriptor = "(II)Leca;", line = 111)
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "(Lcw;ILeq;Leq;Leq;)V", line = 159)
