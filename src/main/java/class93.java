...
public class class93 extends class569 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lr;J)Z")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lr;J[Lhi;[Lqg;Z)V")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "()Lir;")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lr;)V")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IZ)Ltq;")
    ...
    @OriginalMember(owner = "client!tq", name = "g", descriptor = "()Lir;")
    public final class27 method545() {
        return this.field1302;
    }

    @OriginalMember(owner = "client!tq", name = "a", descriptor = "([Lqg;Z)V")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lr;[Lhi;Z)V")
