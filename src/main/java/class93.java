...
public class class93 {
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(IIIIILhka;)Leq;")
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(II)Lvca;")
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(IIILae;)Lao;")
    ...
    @OriginalMember(owner = "client!kia", name = "<init>", descriptor = "(Ljk;ILae;)V")
