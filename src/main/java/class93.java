...
public class class93 extends class88 implements class678 {
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(IIIIB[FILg;I)V", line = 11)
    ...
    @OriginalMember(owner = "client!fca", name = "e", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(IIIII[BLg;IB)V", line = 38)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(FZ)F", line = 54)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(IF)F", line = 65)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(I[IIIIII)V", line = 80)
    ...
    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "(Lsha;Lg;Lwj;II)V", line = 101)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(I)Z", line = 112)
    ...
    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "(Lsha;Lg;IIZ[FII)V", line = 123)
    ...
    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "(Lsha;Lg;IIZ[BII)V", line = 146)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(Z)I", line = 168)
    public final int method623(boolean arg0) {
        ++field1300;
        return arg0 ? 38 : this.field1305;
    }

    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "(Lsha;IIZ[III)V", line = 180)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(IIIII[III)V", line = 199)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(ZZZ)V", line = 213)
    ...
    @OriginalMember(owner = "client!fca", name = "b", descriptor = "(I)I", line = 254)
