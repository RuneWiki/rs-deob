...
public class class93 {
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Lol;II)V", line = 21)
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(I)Z", line = 49)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(ILol;)V", line = 66)
