...
public class class93 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(ILqi;)Z")
    ...
    @OriginalMember(owner = "client!jt", name = "b", descriptor = "(B)Lih;")
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IIZI)Ljt;")
    ...
    @OriginalMember(owner = "client!jt", name = "b", descriptor = "(III)Ldk;")
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "(Ljt;I)V")
