...
public class class93 extends class96 {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IILbt;)V")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Ljava/lang/String;Leo;Loa;IIIILov;Lea;III)V")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ILqa;)V")
