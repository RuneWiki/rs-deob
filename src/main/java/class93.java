...
public class class93 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Z[B)[B", line = 52)
    ...
    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(Z)V", line = 124)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(III)Lrs;", line = 140)
    ...
    @OriginalMember(owner = "client!ri", name = "c", descriptor = "(II)I", line = 160)
    ...
    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(III)Z", line = 174)
    ...
    @OriginalMember(owner = "client!ri", name = "<init>", descriptor = "(II)V", line = 187)
