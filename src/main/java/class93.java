...
public class class93 {
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(ILcj;Lcj;I)V", line = 432)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(II)[B", line = 24)
    ...
    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(I)Lgk;", line = 107)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Z[[IBLen;I)V", line = 137)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(B)I", line = 212)
    ...
    @OriginalMember(owner = "client!wq", name = "toString", descriptor = "()Ljava/lang/String;", line = 231)
    public final String toString() {
        field1019++;
        return "Cache:" + this.field1034;
    }

    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(I[BII)Z", line = 255)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(I[BZII)Z", line = 277)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(IBIIIII)V", line = 401)
