...
public class class93 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(ILph;)V")
    ...
    @OriginalMember(owner = "client!cg", name = "b", descriptor = "(II)Lsh;")
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "(Lkp;IZLph;Lph;)V")
