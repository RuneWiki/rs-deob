...
public class class93 extends class89 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(I)I", line = 14)
    ...
    @OriginalMember(owner = "client!ls", name = "f", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!ls", name = "<init>", descriptor = "(Lfs;Lhk;)V", line = 50)
    ...
    @OriginalMember(owner = "client!ls", name = "g", descriptor = "(I)V", line = 62)
