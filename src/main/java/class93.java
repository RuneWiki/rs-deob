...
public class class93 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(BLwk;)V")
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(ILug;)V")
    ...
    @OriginalMember(owner = "client!fn", name = "b", descriptor = "(I)Lev;")
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lug;II)V")
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lkh;II)V")
