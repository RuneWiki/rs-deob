...
public class class93 extends class28 {
    ...
    @OriginalMember(owner = "client!cea", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!cea", name = "h", descriptor = "(I)J", line = 14)
    ...
    @OriginalMember(owner = "client!cea", name = "finalize", descriptor = "()V", line = 25)
    ...
    @OriginalMember(owner = "client!cea", name = "i", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!cea", name = "j", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!cea", name = "<init>", descriptor = "(Lji;II)V", line = 70)
