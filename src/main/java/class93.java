...
public class class93 {
    ...
    @OriginalMember(owner = "client!ow", name = "b", descriptor = "(I)Lld;")
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(IIII)Low;")
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(ILjava/awt/Component;Z)Lek;")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
