...
public class class93 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(ZIIIILvb;IIIII)Z")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IB)Ldt;")
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(Lai;ILic;Lic;)V")
