...
public class class93 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Lso;II)V")
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(I)Lwja;")
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Lso;I)V")
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(IZIII[IILqfa;)Lcw;")
