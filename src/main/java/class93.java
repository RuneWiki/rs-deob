...
public class class93 extends class532 implements class247 {
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(FFFFFFILua;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!w", name = "finalize", descriptor = "()V", line = 18)
    ...
    @OriginalMember(owner = "client!w", name = "da", descriptor = "(IIIIII)V", line = 26)
    public final void method215(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "(IILua;II)V", line = 29)
    public final void method219(int arg0, int arg1, class596 arg2, int arg3, int arg4) {
        this.method521(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "(Ll;Lm;[I[BIIII)V", line = 31)
