...
public class class566 extends class496 {
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(SB)V", line = 33)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IIIIIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "([[ZIBII)V", line = 233)
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(Lkw;Leo;Lat;[I)V", line = 302)
