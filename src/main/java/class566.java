...
public class class566 extends class297 {
    ...
    @OriginalMember(owner = "client!kj", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!kj", name = "<init>", descriptor = "()V", line = 15)
    public class566() {
        super(1, true);
    }

    @OriginalMember(owner = "client!kj", name = "e", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Lcea;II)V", line = 61)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(IIB)Z", line = 74)
    ...
    @OriginalMember(owner = "client!kj", name = "c", descriptor = "(II)[I", line = 91)
