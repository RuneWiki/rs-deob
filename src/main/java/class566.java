...
public class class566 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "([BBIIII)Z", line = 24)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(ZI)V", line = 109)
    ...
    @OriginalMember(owner = "client!pe", name = "b", descriptor = "(I)V", line = 157)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(BLjava/lang/String;)I", line = 170)
    ...
    @OriginalMember(owner = "client!pe", name = "c", descriptor = "(I)Ljava/lang/String;", line = 185)
