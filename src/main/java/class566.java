...
public abstract class class566 {
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(BIIIILha;)V")
    ...
    @OriginalMember(owner = "client!hj", name = "c", descriptor = "(I)Lgg;")
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(Z)Lmg;")
    ...
    @OriginalMember(owner = "client!hj", name = "f", descriptor = "(I)Lfda;")
    ...
    @OriginalMember(owner = "client!hj", name = "h", descriptor = "(I)Ldp;")
