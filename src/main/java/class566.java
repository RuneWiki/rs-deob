...
public class class566 extends class288 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Loa;BLbi;)V")
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IIIB)V")
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(B)Los;")
    ...
    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "(Lrt;Lcp;IIIIIIIIIIIII)V")
