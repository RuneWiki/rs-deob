...
public class class566 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IILdfa;)V")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(ZIILkha;)Lid;")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Lr;III[Z)V")
