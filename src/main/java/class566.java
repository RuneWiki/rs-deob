...
public class class566 {
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(ILsa;)V", line = 10)
    public static final void method3297(int arg0, class174 arg1) {
        class128.field1574[arg0] = arg1;
    }

    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(IIIBI)Z", line = 16)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "([BZI)V", line = 50)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "([BBJ)V", line = 104)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!bca", name = "b", descriptor = "(I)V", line = 311)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 325)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(III)Z", line = 423)
    ...
    @OriginalMember(owner = "client!bca", name = "c", descriptor = "(I)V", line = 440)
