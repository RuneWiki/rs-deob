...
public class class566 {
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Lep;IIII)Ldd;", line = 18)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IFI[FI[FFIIIIIIF)V", line = 66)
