...
public class class566 extends class528 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lma;)V")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Ljn;)V")
    public final synchronized void method4230(class528 arg0) {
        this.field8253.method3983(81, arg0);
    }

    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lwb;Lma;)V")
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "()Ljn;")
    public final class528 method919() {
        return (class528) this.field8253.method3987(0);
    }

    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(Ljn;)V")
