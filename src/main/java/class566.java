...
public class class566 extends class513 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Luv;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!rc", name = "<init>", descriptor = "(Lqr;Lf;)V", line = 407)
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(Z)V", line = 419)
