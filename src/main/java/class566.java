...
public class class566 implements Runnable {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Ljg;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "()V", line = 15)
    ...
    @OriginalMember(owner = "client!ls", name = "<init>", descriptor = "(ILha;)V", line = 168)
    public class566(int arg0, class544 arg1) {
        this.field8019 = arg0;
        this.field8021 = arg1;
    }

    @OriginalMember(owner = "client!ls", name = "b", descriptor = "()V", line = 116)
    ...
    @OriginalMember(owner = "client!ls", name = "c", descriptor = "()J", line = 123)
    public final long method3288() {
        return this.field8018;
    }

    @OriginalMember(owner = "client!ls", name = "run", descriptor = "()V", line = 126)
    ...
    @OriginalMember(owner = "client!ls", name = "d", descriptor = "()V", line = 135)
    ...
    @OriginalMember(owner = "client!ls", name = "e", descriptor = "()Z", line = 143)
    public final boolean method3290() {
        return this.field8023 == null || !this.field8022 && this.field8023.method1688(-34);
    }

    @OriginalMember(owner = "client!ls", name = "f", descriptor = "()V", line = 146)
