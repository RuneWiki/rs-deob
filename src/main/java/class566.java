...
public class class566 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(IIIB)Z", line = 4)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;IZI)V", line = 35)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(IIIIIIIIIII)V", line = 95)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Z)V", line = 116)
    ...
    @OriginalMember(owner = "client!kj", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 127)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(II)I", line = 145)
