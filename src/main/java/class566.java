...
public class class566 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IIIILwv;II)V")
    ...
    @OriginalMember(owner = "client!cf", name = "b", descriptor = "(B)Lmc;")
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(I)Lun;")
