...
public class class566 extends class211 {
    ...
    @OriginalMember(owner = "client!ac", name = "g", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ac", name = "c", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "()V", line = 159)
    public class566() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(BILib;)V", line = 120)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(I)V", line = 166)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(II)[[I", line = 184)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "()V", line = 237)
    ...
    @OriginalMember(owner = "client!ac", name = "c", descriptor = "(II)V", line = 411)
