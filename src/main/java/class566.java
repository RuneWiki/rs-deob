...
public class class566 extends class241 implements class557 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!j", name = "b", descriptor = "(IIII)V", line = 12)
    public final void method1506(int arg0, int arg1, int arg2, int arg3) {
        this.method3333(this.nativeid, arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "([I)V", line = 21)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IIIIII)V", line = 32)
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Loa;II)V", line = 35)
    public class566(class722 arg0, int arg1, int arg2) {
        this.method3340(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!j", name = "b", descriptor = "()I", line = 40)
    public final int method1507() {
        return this.method3334(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IILaa;II)V", line = 45)
    ...
    @OriginalMember(owner = "client!j", name = "b", descriptor = "(IIIIIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!j", name = "d", descriptor = "()I", line = 75)
    public final int method1508() {
        return this.method3336(this.nativeid);
    }

    @OriginalMember(owner = "client!j", name = "w", descriptor = "(Z)V", line = 78)
