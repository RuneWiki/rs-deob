...
public class class566 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(I)V", line = 38)
