...
public class class566 extends class719 {
    ...
    @OriginalMember(owner = "client!ac", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(III)V", line = 31)
    ...
    @OriginalMember(owner = "client!ac", name = "e", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IZ)V", line = 122)
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ZZ)V", line = 159)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ZLb;I)V", line = 168)
    ...
    @OriginalMember(owner = "client!ac", name = "f", descriptor = "(I)V", line = 204)
    ...
    @OriginalMember(owner = "client!ac", name = "g", descriptor = "(I)V", line = 223)
    ...
    @OriginalMember(owner = "client!ac", name = "c", descriptor = "(B)V", line = 253)
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(Luda;Luq;)V", line = 278)
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(B)Z", line = 306)
