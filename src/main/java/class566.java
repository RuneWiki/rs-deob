...
public abstract class class566 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IZII)V", line = 37)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!ek", name = "g", descriptor = "(I)Z", line = 88)
