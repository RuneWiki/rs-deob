...
public class class566 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(BLjava/lang/String;)J", line = 5)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 42)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Z)Z", line = 69)
    ...
    @OriginalMember(owner = "client!k", name = "b", descriptor = "(Z)Z", line = 81)
    ...
    @OriginalMember(owner = "client!k", name = "b", descriptor = "(I)I", line = 95)
    ...
    @OriginalMember(owner = "client!k", name = "c", descriptor = "(I)I", line = 114)
    ...
    @OriginalMember(owner = "client!k", name = "<init>", descriptor = "(ZIIZ)V", line = 130)
