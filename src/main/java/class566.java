...
public class class566 {
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(III)Lkga;", line = 7)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(Lps;BI)Ljava/lang/String;", line = 17)
    ...
    @OriginalMember(owner = "client!nba", name = "b", descriptor = "(III)Z", line = 42)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(BLlr;)V", line = 53)
    ...
    @OriginalMember(owner = "client!nba", name = "finalize", descriptor = "()V", line = 260)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(ILrg;IIIII)V", line = 269)
    ...
    @OriginalMember(owner = "client!nba", name = "<init>", descriptor = "(Luca;J[Lg;)V", line = 281)
    public class566(class287 arg0, long arg1, class129[] arg2) {
        this.field8262 = arg1;
        this.field8265 = arg0;
    }

    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(IIIZI)V", line = 294)
