...
public abstract class class442 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IILjava/lang/String;III)V", line = 5)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I[IILjava/lang/String;III[Lho;Ljava/util/Random;I)I", line = 31)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([IIIII[Lho;Ljava/lang/String;B)V", line = 74)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILjava/lang/String;IIIIII)V", line = 94)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(III)V", line = 126)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Lho;Ljava/lang/String;IIILaa;I[II)V", line = 143)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIII[Lho;Ljava/lang/String;IBLaa;III[I)I", line = 300)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILjava/lang/String;)V", line = 311)
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "(IILjava/lang/String;III)V", line = 386)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IBIIIILjava/lang/String;)V", line = 403)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(BIILaa;Ljava/lang/String;[Lho;IIII[IIIIIII)I", line = 435)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIILjava/util/Random;III[ILjava/lang/String;I[II[Lho;I)I", line = 539)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Lho;[IZ[ILjava/lang/String;I[II)V", line = 617)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 781)
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lha;Lhw;)V", line = 820)
    public class442(class473 arg0, class300 arg1) {
        this.field6091 = arg0;
        this.field6079 = arg1;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIILjava/lang/String;I)V", line = 829)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I)V", line = 859)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIILjava/lang/String;)V", line = 892)
