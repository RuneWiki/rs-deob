...
public class class442 extends class261 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IILkk;)V")
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ILnv;ILjava/awt/Component;I)Lfl;")
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Lih;Ljq;)V")
