...
public class class442 extends class80 {
    ...
    @OriginalMember(owner = "client!of", name = "c", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IILnn;)V", line = 26)
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "()V", line = 70)
    public class442() {
        super(1, false);
    }

    @OriginalMember(owner = "client!of", name = "d", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!of", name = "c", descriptor = "(II)[[I", line = 124)
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(II)[I", line = 171)
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(ZI)I", line = 207)
