...
public class class442 extends class334 {
    ...
    @OriginalMember(owner = "client!qja", name = "<init>", descriptor = "()V", line = 4)
    public class442() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qja", name = "b", descriptor = "(II)V", line = 13)
    ...
    @OriginalMember(owner = "client!qja", name = "a", descriptor = "(II)[I", line = 66)
    ...
    @OriginalMember(owner = "client!qja", name = "b", descriptor = "(B)V", line = 315)
    ...
    @OriginalMember(owner = "client!qja", name = "a", descriptor = "(IZLol;)V", line = 327)
    ...
    @OriginalMember(owner = "client!qja", name = "c", descriptor = "(B)V", line = 423)
    ...
    @OriginalMember(owner = "client!qja", name = "a", descriptor = "(Ljava/util/Random;IIII[[II)V", line = 441)
    ...
    @OriginalMember(owner = "client!qja", name = "a", descriptor = "(B[B)[B", line = 645)
    ...
    @OriginalMember(owner = "client!qja", name = "a", descriptor = "(ZBILjava/lang/String;)V", line = 672)
