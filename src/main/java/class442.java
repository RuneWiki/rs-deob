...
public class class442 {
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(BI)Lww;")
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ILjava/lang/String;I)Lfda;")
    ...
    @OriginalMember(owner = "client!ep", name = "<init>", descriptor = "(Lkw;ILuq;)V")
