...
public class class442 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ILvc;IIIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "(I[Ljp;IIII)V", line = 245)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Lvc;IB)Z", line = 146)
    ...
    @OriginalMember(owner = "client!ci", name = "b", descriptor = "(B)V", line = 223)
