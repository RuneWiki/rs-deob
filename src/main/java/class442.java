...
public class class442 implements class415 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "()V", line = 3)
    public final void method2674() {
        this.field6661 = Thread.currentThread();
        this.method2677();
    }

    @OriginalMember(owner = "client!wa", name = "b", descriptor = "()V", line = 15)
    public final void method2678() {
        this.field6661 = null;
        this.method2676();
    }

    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Lfa;BIZ)Lka;", line = 34)
    ...
    @OriginalMember(owner = "client!wa", name = "finalize", descriptor = "()V", line = 80)
    ...
    @OriginalMember(owner = "client!wa", name = "<init>", descriptor = "(Lc;II)V", line = 90)
