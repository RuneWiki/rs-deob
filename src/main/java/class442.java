...
public class class442 {
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Ljc;I)V")
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Ldm;IIII)V")
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(BLkj;)V")
    ...
    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(Ljc;)V")
