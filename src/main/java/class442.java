...
public class class442 extends class507 {
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(Lug;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ILug;)V")
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(BLug;I)V")
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(II)Lsd;")
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "([ILug;B)V")
