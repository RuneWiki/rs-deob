...
public class class442 extends class264 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(BI)Z", line = 7)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lef;IIII[I)V", line = 26)
    ...
    @OriginalMember(owner = "client!tq", name = "c", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!tq", name = "g", descriptor = "(I)Z", line = 52)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lef;IIIIZ[BI)V", line = 78)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lef;IIIII[BI)V", line = 101)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(III)Z", line = 117)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lef;IIIZ[I)V", line = 141)
    ...
    @OriginalMember(owner = "client!tq", name = "d", descriptor = "(B)V", line = 164)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lef;IIIIIZ)V", line = 181)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lef;IIIIIIZ)V", line = 202)
