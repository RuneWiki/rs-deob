...
public class class442 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Lir;Z)V")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Lwm;I)V")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Lwm;ZI)V")
