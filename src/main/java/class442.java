...
public class class442 implements class685 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ZLvfa;)Lvfa;")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(B)Lsaa;")
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Lwu;Ljava/lang/String;)V")
