...
public class class442 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lln;Z)V")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(III)Lkl;")
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lvj;II)V")
