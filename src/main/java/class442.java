...
public class class442 implements Runnable {
    ...
    @OriginalMember(owner = "client!un", name = "b", descriptor = "()V", line = 10)
    ...
    @OriginalMember(owner = "client!un", name = "c", descriptor = "()V", line = 20)
    ...
    @OriginalMember(owner = "client!un", name = "d", descriptor = "()V", line = 26)
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(ILha;)V", line = 168)
    public class442(int arg0, class66 arg1) {
        this.field6309 = arg0;
        this.field6304 = arg1;
    }

    @OriginalMember(owner = "client!un", name = "e", descriptor = "()Z", line = 129)
    public final boolean method2668() {
        return this.field6302 == null || !this.field6308 && this.field6302.method697(2);
    }

    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Ltt;)V", line = 132)
    ...
    @OriginalMember(owner = "client!un", name = "f", descriptor = "()J", line = 142)
    public final long method2670() {
        return this.field6307;
    }

    @OriginalMember(owner = "client!un", name = "run", descriptor = "()V", line = 160)
