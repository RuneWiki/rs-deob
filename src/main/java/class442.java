...
public class class442 implements class321 {
    ...
    @OriginalMember(owner = "client!tj", name = "b", descriptor = "()I", line = 4)
    public final int method1147() {
        return this.field6424;
    }

    @OriginalMember(owner = "client!tj", name = "d", descriptor = "()Z", line = 8)
    public final boolean method2709() {
        int var1 = this.field6426.field2253.glCheckFramebufferStatusEXT(36160);
        return var1 == 36053;
    }

    @OriginalMember(owner = "client!tj", name = "a", descriptor = "()V", line = 20)
    public final void method1140() {
        this.field6426.field2253.glBindFramebufferEXT(36160, 0);
    }

    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!tj", name = "c", descriptor = "()V", line = 29)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ILea;I)V", line = 46)
    public final void method2712(int arg0, class61 arg1, int arg2) {
        this.method2714(arg0, arg1, 0, arg2);
    }

    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ILqb;)V", line = 49)
    public final void method2713(int arg0, class89 arg1) {
        this.method2715(arg0, arg1, 0);
    }

    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ILea;II)V", line = 52)
    ...
    @OriginalMember(owner = "client!tj", name = "finalize", descriptor = "()V", line = 75)
    protected final void finalize() throws Throwable {
        this.field6426.method1158(this.field6428);
        super.finalize();
    }

    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ILqb;I)V", line = 79)
    ...
    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "(Lks;)V", line = 134)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ILq;)V", line = 110)
