...
public class class442 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(ZII)V", line = 5)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(ICI)C", line = 42)
