...
public class class442 {
    ...
    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "(Lht;)V", line = 62)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(B)V", line = 29)
