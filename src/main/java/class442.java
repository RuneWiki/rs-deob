...
public class class442 extends class119 {
    ...
    @OriginalMember(owner = "client!cj", name = "<init>", descriptor = "(IIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIZ)V", line = 17)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(III)V", line = 51)
    ...
    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(Z)V", line = 70)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(ZII)V", line = 80)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IILgba;)Z", line = 99)
