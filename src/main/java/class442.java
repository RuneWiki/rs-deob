...
public class class442 implements class758 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(ZI)V", line = 17)
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "(Loh;Llk;)V", line = 71)
    public class442(class404 arg0, class585 arg1) {
        this.field6416 = arg0;
        this.field6418 = arg1;
    }

    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(I)V", line = 81)
