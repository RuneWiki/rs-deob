...
public class class442 extends class391 implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    @OriginalMember(owner = "client!os", name = "f", descriptor = "(I)Les;")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;Z)I")
    ...
    @OriginalMember(owner = "client!os", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ILjava/awt/Component;)V")
    ...
    @OriginalMember(owner = "client!os", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V")
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.method2665(arg0.getX(), arg0.getY(), -12617);
    }

    @OriginalMember(owner = "client!os", name = "h", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!os", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V")
    ...
    @OriginalMember(owner = "client!os", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V")
    ...
    @OriginalMember(owner = "client!os", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V")
    ...
    @OriginalMember(owner = "client!os", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V")
    ...
    @OriginalMember(owner = "client!os", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V")
    ...
    @OriginalMember(owner = "client!os", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V")
    ...
    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V")
