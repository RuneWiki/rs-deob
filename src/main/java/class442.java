...
public class class442 extends class324 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(I)[Lcc;", line = 7)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IB)V", line = 20)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IIBI)V", line = 33)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(B)I", line = 45)
    ...
    @OriginalMember(owner = "client!dk", name = "b", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IIFII)V", line = 66)
    ...
    @OriginalMember(owner = "client!dk", name = "b", descriptor = "(IB)V", line = 190)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IZ)V", line = 209)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(I[FIIIIFIIIFFI)V", line = 223)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(II[I)V", line = 311)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Lkp;I)I", line = 471)
    ...
    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "(Lha;IIIII)V", line = 516)
