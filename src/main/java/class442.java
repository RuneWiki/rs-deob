...
public class class442 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lcp;)V")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lgq;B)V")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(I)Lgq;")
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(B)Lgq;")
