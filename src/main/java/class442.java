...
public class class442 {
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "([III)V", line = 6)
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "()V", line = 55)
    private static final void method3392() {
        field6500 = 0;
    }

    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(II)V", line = 60)
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(II)V", line = 106)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(I)Z", line = 145)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Lha;[II[I[I)V", line = 220)
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(I)V", line = 225)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "()V", line = 270)
    public static void method3398() {
        field6496 = null;
    }

    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Lha;[IIII[I[I)V", line = 277)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Lha;[II)V", line = 315)
