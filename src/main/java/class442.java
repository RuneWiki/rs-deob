...
public class class442 extends class393 {
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(III)V", line = 16)
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(II)V", line = 32)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lil;II)V", line = 46)
    ...
    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "()V", line = 66)
    public class442() {
    }

    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 68)
    public class442(String arg0) {
        this.field6451 = arg0;
    }

    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lud;I)[Ldk;", line = 83)
