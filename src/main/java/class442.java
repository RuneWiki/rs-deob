...
public class class442 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(I)Lge;", line = 3)
    ...
    @OriginalMember(owner = "client!kn", name = "b", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Lkn;B)V", line = 46)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!kn", name = "c", descriptor = "(I)Lge;", line = 68)
    ...
    @OriginalMember(owner = "client!kn", name = "b", descriptor = "(B)Lge;", line = 92)
    ...
    @OriginalMember(owner = "client!kn", name = "d", descriptor = "(I)Lge;", line = 116)
    ...
    @OriginalMember(owner = "client!kn", name = "e", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(ILge;)V", line = 160)
    ...
    @OriginalMember(owner = "client!kn", name = "f", descriptor = "(I)I", line = 181)
    ...
    @OriginalMember(owner = "client!kn", name = "b", descriptor = "(ILge;)V", line = 204)
    ...
    @OriginalMember(owner = "client!kn", name = "g", descriptor = "(I)Z", line = 225)
    ...
    @OriginalMember(owner = "client!kn", name = "h", descriptor = "(I)Lge;", line = 258)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "()V", line = 308)
    public class442() {
        this.field6329.field6072 = this.field6329;
        this.field6329.field6074 = this.field6329;
    }

    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Lkn;Lge;I)V", line = 284)
