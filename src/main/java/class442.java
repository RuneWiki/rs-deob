...
public class class442 extends class335 {
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(ILio;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ce", name = "<init>", descriptor = "()V", line = 75)
    public class442() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(IZ)[[I", line = 86)
    ...
    @OriginalMember(owner = "client!ce", name = "d", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(ILjava/lang/String;)V", line = 198)
