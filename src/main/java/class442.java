...
public class class442 extends class636 {
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Leg;FLeg;B)Z")
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(I)Leg;")
    ...
    @OriginalMember(owner = "client!aq", name = "<init>", descriptor = "(Luca;I)V")
