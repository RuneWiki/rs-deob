...
public class class442 implements Runnable {
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(IIBI)V", line = 18)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(I[BII)V", line = 102)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(Z)V", line = 168)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(III[B)V", line = 193)
    ...
    @OriginalMember(owner = "client!cga", name = "<init>", descriptor = "(Ljava/net/Socket;Ltt;)V", line = 1234)
    ...
    @OriginalMember(owner = "client!cga", name = "b", descriptor = "(B)V", line = 250)
    ...
    @OriginalMember(owner = "client!cga", name = "b", descriptor = "(Z)V", line = 266)
    ...
    @OriginalMember(owner = "client!cga", name = "run", descriptor = "()V", line = 288)
    ...
    @OriginalMember(owner = "client!cga", name = "finalize", descriptor = "()V", line = 359)
    protected final void finalize() {
        this.method2529(-22272);
        field6224++;
    }

    @OriginalMember(owner = "client!cga", name = "b", descriptor = "(I)I", line = 367)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(ILfaa;)V", line = 381)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(IB)[[[B", line = 423)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(ILuea;)I", line = 1205)
