...
public class class442 implements Runnable {
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(II)Lrr;", line = 21)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(JLjava/lang/String;BLkk;I)V", line = 47)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(BLib;)V", line = 61)
    ...
    @OriginalMember(owner = "client!oga", name = "b", descriptor = "(I)I", line = 75)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(B)I", line = 86)
    ...
    @OriginalMember(owner = "client!oga", name = "c", descriptor = "(I)Lkk;", line = 99)
    public final class179 method2426(int arg0) {
        field5557++;
        return arg0 == -6221 ? this.field5566 : null;
    }

    @OriginalMember(owner = "client!oga", name = "d", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!oga", name = "e", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!oga", name = "b", descriptor = "(B)Ljava/lang/String;", line = 148)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(Z)I", line = 159)
    ...
    @OriginalMember(owner = "client!oga", name = "f", descriptor = "(I)J", line = 189)
    public final long method2431(int arg0) {
        field5560++;
        return arg0 < 11 ? 1L : this.field5569;
    }

    @OriginalMember(owner = "client!oga", name = "g", descriptor = "(I)Z", line = 207)
    ...
    @OriginalMember(owner = "client!oga", name = "run", descriptor = "()V", line = 225)
