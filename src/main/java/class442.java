...
public class class442 extends class133 implements class171 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(BLuo;)V")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Luo;IIZ)Z")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(BLuo;ZI)Lcb;")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Luo;IIIZBLpc;)V")
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(Luo;B)V")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(ILuo;I)Lge;")
    ...
    @OriginalMember(owner = "client!qb", name = "c", descriptor = "(Luo;B)Lkj;")
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Luo;Lnd;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Luo;B)V")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Luo;II)Lge;")
