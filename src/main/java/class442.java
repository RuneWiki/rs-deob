...
public class class442 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(BLrl;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Lrl;B)V", line = 361)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(B)Z", line = 378)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(I)V", line = 405)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Leq;Z)V", line = 422)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(ILrl;)V", line = 441)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Lrl;ILbv;)V", line = 458)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(BLrl;)V", line = 746)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(BIILhe;)Lmo;", line = 775)
