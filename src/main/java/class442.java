...
public class class442 extends class672 implements class484 {
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(IIILha;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Lha;I)Lmaa;", line = 29)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(I)I", line = 56)
    public final int method1483(int arg0) {
        ++field6021;
        return arg0 != 24853 ? -75 : 65535 & this.field6008;
    }

    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ILha;)V", line = 69)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Lqfa;I)V", line = 96)
    ...
    @OriginalMember(owner = "client!ep", name = "k", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(BLha;I)Lka;", line = 143)
    ...
    @OriginalMember(owner = "client!ep", name = "e", descriptor = "(I)I", line = 164)
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(I)V", line = 176)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(B)Z", line = 189)
    ...
    @OriginalMember(owner = "client!ep", name = "c", descriptor = "(Z)Z", line = 199)
    ...
    @OriginalMember(owner = "client!ep", name = "<init>", descriptor = "(Lha;Lkv;IIIIIZIIIIIIZ)V", line = 210)
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(Lha;I)Lrn;", line = 252)
    ...
    @OriginalMember(owner = "client!ep", name = "d", descriptor = "(Z)Z", line = 268)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(IIIIII)V", line = 283)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ZLje;IIILha;I)V", line = 301)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(BLha;)V", line = 331)
    ...
    @OriginalMember(owner = "client!ep", name = "g", descriptor = "(I)V", line = 363)
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(B)I", line = 379)
    public final int method1478(byte arg0) {
        ++field6033;
        return arg0 < 108 ? -59 : this.field6003;
    }

    @OriginalMember(owner = "client!ep", name = "c", descriptor = "(ILha;)V", line = 390)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ILha;IZ)Lbaa;", line = 400)
    ...
    @OriginalMember(owner = "client!ep", name = "i", descriptor = "(B)I", line = 430)
    ...
    @OriginalMember(owner = "client!ep", name = "f", descriptor = "(I)Z", line = 442)
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(III)V", line = 457)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Z)I", line = 492)
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(Z)I", line = 504)
