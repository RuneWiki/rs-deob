...
public class class442 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ZJ)Lqp;", line = 3)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(I)Lqp;", line = 33)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Z)V", line = 72)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(BLqp;J)V", line = 91)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IZIII)I", line = 138)
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(I)V", line = 161)
