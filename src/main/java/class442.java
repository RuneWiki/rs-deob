...
public class class442 extends class550 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IIZ)Ltg;", line = 3)
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(IIIIIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(IBI)V", line = 45)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IBI)V", line = 76)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ZII)V", line = 101)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ILjava/lang/String;)I", line = 115)
