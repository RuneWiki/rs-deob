...
public class class442 {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(BLha;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IZ)Z", line = 22)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Lti;I)V", line = 46)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Ljava/lang/String;I)[B", line = 64)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(B)Lti;", line = 96)
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(I)V", line = 161)
    public class442(int arg0) {
        this.field6583 = arg0;
    }

    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(IIIIII)V", line = 168)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(III)Liq;", line = 113)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Z)V", line = 126)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IIIILwh;I)Liba;", line = 138)
