...
public class class442 implements Runnable {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(BLnf;I)Lsb;")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lsb;I)V")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ILnf;I)Lsb;")
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(Lne;)V")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lnf;[BIZ)Lsb;")
