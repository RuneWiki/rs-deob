...
public class class442 extends class212 {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "([BIII)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(II)I", line = 93)
    public final int method417(int arg0, int arg1) {
        ++field6283;
        return arg0 != 3 ? 49 : 1;
    }

    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(II)V", line = 104)
    ...
    @OriginalMember(owner = "client!ti", name = "d", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Z)V", line = 130)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "([BZ)Ljava/lang/String;", line = 144)
    ...
    @OriginalMember(owner = "client!ti", name = "d", descriptor = "(II)Z", line = 157)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IILat;B)V", line = 168)
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(Ldh;)V", line = 248)
    public class442(class322 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(ILdh;)V", line = 252)
    public class442(int arg0, class322 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ti", name = "e", descriptor = "(I)I", line = 258)
    public final int method2662(int arg0) {
        ++field6288;
        return arg0 != -32350 ? 61 : super.field3006;
    }

    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(I)I", line = 270)
