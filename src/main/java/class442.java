...
public class class442 extends class702 {
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(IIILml;Lml;)V")
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(ZIJZLsea;II)V")
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(FFFFFFILua;II)V")
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(IILua;II)V")
    ...
    @OriginalMember(owner = "client!iea", name = "<init>", descriptor = "(Llj;IIZ)V")
    ...
    @OriginalMember(owner = "client!iea", name = "<init>", descriptor = "(Llj;IIII)V")
    ...
    @OriginalMember(owner = "client!iea", name = "<init>", descriptor = "(Llj;II[III)V")
