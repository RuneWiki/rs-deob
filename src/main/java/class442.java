...
public class class442 extends class148 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(BLwp;)I", line = 3)
    ...
    @OriginalMember(owner = "client!tq", name = "e", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ILdh;I)V", line = 81)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "()V", line = 106)
    public class442() {
        super(0, true);
    }

    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(II)[I", line = 118)
