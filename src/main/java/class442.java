...
public class class442 extends class145 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(II)[I", line = 5)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Lap;BI)V", line = 57)
    ...
    @OriginalMember(owner = "client!up", name = "e", descriptor = "(B)V", line = 91)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "()V", line = 108)
    public class442() {
        super(1, false);
    }

    @OriginalMember(owner = "client!up", name = "a", descriptor = "(ZI)[[I", line = 121)
    ...
    @OriginalMember(owner = "client!up", name = "f", descriptor = "(B)V", line = 202)
