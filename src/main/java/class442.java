...
public class class442 extends class452 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(CIIIZLq;II)V")
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Lkd;Lgh;[Lvp;[I[I)V")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "([B[IIIIIIIIIIILq;II)V")
