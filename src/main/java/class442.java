...
public class class442 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IBIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(BI)Let;", line = 41)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(ZIBI)I", line = 87)
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(Lkr;IZLpu;Lpu;)V", line = 248)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IZ)V", line = 116)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(II)V", line = 134)
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(BI)V", line = 179)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(BZ)V", line = 202)
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(II)V", line = 217)
