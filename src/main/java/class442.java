...
public class class442 extends class225 {
    ...
    @OriginalMember(owner = "client!rf", name = "e", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(BI)Z", line = 21)
    public final boolean method2782(byte arg0, int arg1) {
        field6479++;
        return arg0 == 87 ? this.field6476[arg1].field4906 : false;
    }

    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(IB)Z", line = 35)
    ...
    @OriginalMember(owner = "client!rf", name = "f", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(DZ)V", line = 70)
    ...
    @OriginalMember(owner = "client!rf", name = "d", descriptor = "(B)Z", line = 98)
    ...
    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "(I)V", line = 195)
