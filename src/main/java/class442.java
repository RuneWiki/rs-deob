...
public class class442 {
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IIIIIZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(B)Z", line = 99)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(BI)I", line = 229)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(I)V", line = 240)
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(B)V", line = 304)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IIIII)Z", line = 329)
    ...
    @OriginalMember(owner = "client!to", name = "c", descriptor = "(I)V", line = 379)
    ...
    @OriginalMember(owner = "client!to", name = "d", descriptor = "(I)Z", line = 389)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Ljo;B)Z", line = 403)
    ...
    @OriginalMember(owner = "client!to", name = "e", descriptor = "(I)V", line = 438)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Ljo;Z)V", line = 550)
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(Lpea;)V", line = 651)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(JJ)J", line = 571)
    public static long method2545(long arg0, long arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!to", name = "f", descriptor = "(I)V", line = 581)
