...
public class class442 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IB)Lwr;")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lui;ILcp;)V")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIIILtq;I)V")
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(Lgp;ILui;)V")
