...
public class class256 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ILfo;Lfo;Lfo;Lfo;)V", line = 16)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IIIZI)Ldn;", line = 45)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IBZ)V", line = 87)
