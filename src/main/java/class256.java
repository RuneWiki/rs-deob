...
public class class256 extends class704 {
    ...
    @OriginalMember(owner = "client!eh", name = "d", descriptor = "(Z)Lcc;")
    ...
    @OriginalMember(owner = "client!eh", name = "c", descriptor = "(III)Lnf;")
    ...
    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "(Lkw;II)V")
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IIIB)Ldk;")
