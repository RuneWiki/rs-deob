...
public abstract class class256 extends class499 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(IIIZI)V", line = 11)
    ...
    @OriginalMember(owner = "client!kf", name = "d", descriptor = "(B)I", line = 36)
    ...
    @OriginalMember(owner = "client!kf", name = "f", descriptor = "(I)I", line = 84)
    public int method1451(int arg0) {
        field3501++;
        return arg0 > 0 ? 55 : 0;
    }

    @OriginalMember(owner = "client!kf", name = "f", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "([Ltn;IBI)I", line = 134)
