...
public class class256 implements Runnable {
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(ILjava/lang/String;)Lis;")
    ...
    @OriginalMember(owner = "client!nga", name = "b", descriptor = "(B)Lwp;")
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "([IILjava/awt/Component;Ljava/awt/Point;II)Lwp;")
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(IZLjava/lang/String;)Lwp;")
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(Ljava/lang/String;I[Ljava/lang/Class;Ljava/lang/Class;)Lwp;")
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(IZLjava/lang/Runnable;)Lwp;")
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(Ljava/lang/String;ZII)Lwp;")
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;)Lis;")
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(IBILjava/lang/Object;I)Lwp;")
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(II)Lwp;")
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(Ljava/lang/Class;BLjava/lang/String;)Lwp;")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
