...
public class class256 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IB)V", line = 6)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(I[IB)Lfv;", line = 37)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "([IIIZ)Lfv;", line = 76)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(I[IZ)Lfv;", line = 115)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(III[I)Lfv;", line = 138)
    ...
    @OriginalMember(owner = "client!bk", name = "<init>", descriptor = "(Lul;Lul;)V", line = 188)
