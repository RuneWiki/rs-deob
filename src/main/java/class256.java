...
public class class256 extends class374 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(ZZ)V", line = 15)
    public final void method25(boolean arg0, boolean arg1) {
        super.field5646.method1548(arg1, (byte) 82);
        ++field3469;
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(ZLew;I)V", line = 24)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(III)V", line = 36)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(B)Z", line = 49)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(ZI)V", line = 60)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Lvd;)V", line = 82)
    public class256(class258 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!j", name = "b", descriptor = "(III)Lep;", line = 86)
