...
public class class256 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(BI)Z", line = 23)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(ILmi;ILat;Laa;III)V", line = 35)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IIII)V", line = 76)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;I)V", line = 104)
