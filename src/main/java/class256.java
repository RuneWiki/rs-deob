...
public class class256 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(III)B", line = 7)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(I)V", line = 231)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ZIII)Ljava/lang/String;", line = 254)
    ...
    @OriginalMember(owner = "client!gf", name = "toString", descriptor = "()Ljava/lang/String;", line = 307)
