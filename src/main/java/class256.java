...
public class class256 {
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!at", name = "b", descriptor = "(B)I", line = 77)
    public static final int method1536(byte arg0) {
        field3554++;
        return arg0 >= -14 ? -53 : 6;
    }

    @OriginalMember(owner = "client!at", name = "a", descriptor = "(ILya;IZ)Ll;", line = 91)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Lsi;I)V", line = 137)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Lsi;BI)V", line = 158)
    ...
    @OriginalMember(owner = "client!at", name = "b", descriptor = "(II)Z", line = 191)
    ...
    @OriginalMember(owner = "client!at", name = "c", descriptor = "(B)Z", line = 213)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Lya;ILbh;)I", line = 228)
