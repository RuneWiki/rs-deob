...
public class class256 extends class675 {
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(ZLcb;I)Lsja;")
    ...
    @OriginalMember(owner = "client!dea", name = "<init>", descriptor = "(Lkv;)V")
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(Lfia;IZ)V")
