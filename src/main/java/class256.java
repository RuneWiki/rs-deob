...
public class class256 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Ljava/net/Socket;II)Lgea;")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lso;B)V")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ILbja;)I")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lmda;I)V")
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(Lso;)V")
