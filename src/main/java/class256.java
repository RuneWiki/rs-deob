...
public class class256 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IZI)Ljava/lang/String;", line = 53)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(JLtf;I)V", line = 69)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Ltm;[I[I[IZ)V", line = 92)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IIIIIIIIII)V", line = 188)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(I[IBII)V", line = 230)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IJ)Ltf;", line = 261)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Z)Ltf;", line = 291)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(B[Ltf;)I", line = 327)
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(I)Ltf;", line = 362)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Lmo;Luj;Lmo;ILmo;)Z", line = 394)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IB)Lic;", line = 421)
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(Z)Ltf;", line = 445)
    ...
    @OriginalMember(owner = "client!bn", name = "c", descriptor = "(I)V", line = 458)
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "(I)V", line = 476)
    ...
    @OriginalMember(owner = "client!bn", name = "d", descriptor = "(I)I", line = 500)
