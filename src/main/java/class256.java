...
public class class256 {
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(I)Lwj;", line = 3)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(B)Z", line = 24)
    ...
    @OriginalMember(owner = "client!g", name = "b", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Lnk;IILnk;)Lks;", line = 73)
    ...
    @OriginalMember(owner = "client!g", name = "c", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Lnk;Lnk;IIZ)Lks;", line = 118)
    ...
    @OriginalMember(owner = "client!g", name = "b", descriptor = "(B)V", line = 160)
    ...
    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "(Lbo;Lfb;)V", line = 176)
