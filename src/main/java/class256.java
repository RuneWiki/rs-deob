...
public class class256 extends class65 implements MouseWheelListener {
    ...
    @OriginalMember(owner = "client!ur", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 4)
    public final synchronized void mouseWheelMoved(MouseWheelEvent arg0) {
        this.field3315 += arg0.getWheelRotation();
    }

    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(ZLjava/awt/Component;)V", line = 12)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(BLjava/awt/Component;)V", line = 22)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(B)I", line = 33)
