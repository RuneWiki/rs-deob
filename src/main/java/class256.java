...
public class class256 extends class272 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Lwm;J)Z")
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Lwm;[Ljf;Z)V")
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Lwm;J[Ljf;[Lnm;Z)V")
    ...
    @OriginalMember(owner = "client!oh", name = "e", descriptor = "()Ltp;")
    ...
    @OriginalMember(owner = "client!oh", name = "g", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "([Lnm;Z)V")
