...
public class class256 implements class189 {
    ...
    @OriginalMember(owner = "client!pp", name = "toString", descriptor = "()Ljava/lang/String;", line = 6)
    public final String toString() {
        field3676++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 24)
    public class256(String arg0, int arg1) {
        this.field3675 = arg1;
    }

    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(Z)V", line = 34)
