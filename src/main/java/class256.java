...
public class class256 {
    ...
    @OriginalMember(owner = "client!ok", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field3669++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IIILha;IIIB)V", line = 13)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(ZIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(I)V", line = 71)
    private class256(int arg0) {
        this.field3673 = arg0;
    }

    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Lsca;IZ)V", line = 82)
