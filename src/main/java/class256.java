...
public class class256 extends class433 {
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Lio;)Lvj;", line = 8)
    ...
    @OriginalMember(owner = "client!vj", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!vj", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
