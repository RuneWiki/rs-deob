...
public class class256 extends class208 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(II[BI)[B", line = 4)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(BZ[B)Ljava/lang/Object;", line = 34)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IBZ)Lct;", line = 66)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(FB)F", line = 83)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(B)Lkh;", line = 98)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IIIBII)V", line = 164)
    ...
    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "(Lmh;IIIIII)V", line = 281)
