...
public class class256 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(II)Lel;")
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(IIBLfl;Ljava/awt/Component;)Lqn;")
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "(Lrga;ILni;)V")
