...
public class class256 extends class525 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Lwn;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(ZLwn;)V", line = 51)
    ...
    @OriginalMember(owner = "client!he", name = "d", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(ILqa;)V", line = 84)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IILjava/lang/String;)Ljava/lang/String;", line = 106)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(BII)I", line = 131)
    ...
    @OriginalMember(owner = "client!he", name = "c", descriptor = "(I)Z", line = 158)
