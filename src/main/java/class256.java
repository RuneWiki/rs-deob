...
public class class256 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(BLti;)V", line = 7)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(IIIII[B)Z", line = 27)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(III)Z", line = 112)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Z)V", line = 123)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(ILti;B)V", line = 156)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(II)I", line = 183)
