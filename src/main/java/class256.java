...
public class class256 {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "Lvt;")
    public static class256 field3646 = new class256(1);

    @OriginalMember(owner = "client!vt", name = "d", descriptor = "Lvt;")
    public static class256 field3649 = new class256(2);

    @OriginalMember(owner = "client!vt", name = "f", descriptor = "Lvt;")
    public static class256 field3651 = new class256(4);

    @OriginalMember(owner = "client!vt", name = "h", descriptor = "Lvt;")
    public static class256 field3653 = new class256(1);

    @OriginalMember(owner = "client!vt", name = "i", descriptor = "Lvt;")
    public static class256 field3654 = new class256(2);

    @OriginalMember(owner = "client!vt", name = "j", descriptor = "Lvt;")
    public static class256 field3655 = new class256(4);

    @OriginalMember(owner = "client!vt", name = "k", descriptor = "Lvt;")
    public static class256 field3656 = new class256(2);

    @OriginalMember(owner = "client!vt", name = "l", descriptor = "Lvt;")
    public static class256 field3657 = new class256(4);

    @OriginalMember(owner = "client!vt", name = "m", descriptor = "Lfea;")
    public static class123 field3658 = new class123();
    ...
    public static final byte[][][] method1711(int arg0, int arg1) {
        field3648++;
    ...
    public static final boolean method1712(int arg0, String arg1) {
        field3650++;
        if (arg1 == null) {
            return false;
        } else if (arg0 < 99) {
            ...
            return arg1.equalsIgnoreCase(class439.field6548.field9452);
        }
    }
