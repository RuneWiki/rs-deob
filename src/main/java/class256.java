...
public class class256 extends class557 {
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!lm", name = "c", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(B)I", line = 33)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IZLjava/lang/String;)V", line = 63)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IIIIIII)V", line = 77)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IIZ)Lml;", line = 104)
    ...
    @OriginalMember(owner = "client!lm", name = "c", descriptor = "(B)I", line = 365)
    ...
    @OriginalMember(owner = "client!lm", name = "d", descriptor = "(I)V", line = 392)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(B)Lnaa;", line = 436)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IZ)I", line = 539)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(II)[B", line = 561)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ZI)V", line = 578)
    ...
    @OriginalMember(owner = "client!lm", name = "d", descriptor = "(B)I", line = 609)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(III)I", line = 622)
    ...
    @OriginalMember(owner = "client!lm", name = "e", descriptor = "(B)I", line = 638)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(BLlt;)V", line = 653)
    ...
    @OriginalMember(owner = "client!lm", name = "e", descriptor = "(I)V", line = 687)
    ...
    @OriginalMember(owner = "client!lm", name = "f", descriptor = "(I)V", line = 724)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(ILvh;Lvh;Lkl;Lmca;I[BIZ)V", line = 923)
