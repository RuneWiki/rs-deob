...
public class class256 {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(ZLtp;I)Ljava/lang/String;", line = 20)
    ...
    @OriginalMember(owner = "client!se", name = "toString", descriptor = "()Ljava/lang/String;", line = 49)
    public final String toString() {
        field3129++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!se", name = "a", descriptor = "(BIII)V", line = 59)
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!se", name = "<init>", descriptor = "(II)V", line = 165)
    public class256(int arg0, int arg1) {
        this.field3126 = arg0;
    }

    @OriginalMember(owner = "client!se", name = "a", descriptor = "(II)Z", line = 180)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IIIIIII)V", line = 191)
