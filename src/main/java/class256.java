...
public class class256 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ILhs;)[Lhk;")
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ILhs;I)I")
    ...
    @OriginalMember(owner = "client!vd", name = "c", descriptor = "(II)Ltt;")
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "(Lgt;ILdn;)V")
