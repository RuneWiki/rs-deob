...
public class class256 extends class339 {
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ah", name = "c", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(I)I", line = 33)
    ...
    @OriginalMember(owner = "client!ah", name = "d", descriptor = "(B)J", line = 44)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Z)I", line = 75)
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(II)V", line = 85)
