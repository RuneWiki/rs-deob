...
public class class256 extends class381 {
    ...
    @OriginalMember(owner = "client!gk", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(BLrk;)V", line = 14)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(ZIIIIIIIIZI)Z", line = 26)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IIIILgb;)V", line = 49)
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(II)V", line = 93)
