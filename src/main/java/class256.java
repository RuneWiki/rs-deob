...
public class class256 extends class305 {
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(IB)[[I", line = 6)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(CBI)I", line = 74)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(ILfh;B)V", line = 99)
    ...
    @OriginalMember(owner = "client!na", name = "<init>", descriptor = "()V", line = 197)
    public class256() {
        super(1, false);
    }

    @OriginalMember(owner = "client!na", name = "a", descriptor = "(Lbc;IIII)V", line = 146)
    ...
    @OriginalMember(owner = "client!na", name = "f", descriptor = "(I)V", line = 203)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(II)[I", line = 220)
