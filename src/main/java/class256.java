...
public class class256 extends class334 {
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lha;ILgga;)V", line = 5)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Z)V", line = 136)
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(B)V", line = 147)
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "()V", line = 159)
    public class256() {
        super(0, true);
    }

    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(IZLol;)V", line = 170)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(BLkja;)I", line = 230)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(II)[I", line = 273)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 411)
