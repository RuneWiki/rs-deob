...
public class class256 extends class694 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(II)[I", line = 5)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ZZI)V", line = 141)
    ...
    @OriginalMember(owner = "client!sm", name = "g", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ILjr;B)V", line = 180)
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "()V", line = 243)
    public class256() {
        super(0, true);
    }

    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ZIILoo;II)V", line = 258)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ZZZ)V", line = 464)
