...
public class class256 extends class187 {
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(Ltq;II)V", line = 7)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(ZLtq;)V", line = 54)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(Z)V", line = 78)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(BII)I", line = 88)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IIIIII)I", line = 110)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IILjava/lang/String;)Ljava/lang/String;", line = 177)
