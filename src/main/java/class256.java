...
public class class256 extends class53 implements class28 {
    ...
    @OriginalMember(owner = "client!ca", name = "BA", descriptor = "(III)V", line = 7)
    public final void method321(int arg0, int arg1, int arg2) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ca", name = "P", descriptor = "(IIIIII)V", line = 11)
    public final void method320(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IILpa;II)V", line = 15)
    ...
    @OriginalMember(owner = "client!ca", name = "finalize", descriptor = "()V", line = 29)
