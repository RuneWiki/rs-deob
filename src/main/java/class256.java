...
public class class256 extends class539 implements class602 {
    ...
    @OriginalMember(owner = "client!bj", name = "c", descriptor = "(Lha;B)Lpia;")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(ILha;ZB)Lsw;")
    ...
    @OriginalMember(owner = "client!bj", name = "d", descriptor = "(Lha;B)Lln;")
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(Lha;Llp;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(ILha;II)Z")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(ILfq;BIILha;Z)V")
    ...
    @OriginalMember(owner = "client!bj", name = "e", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(ILha;I)Lka;")
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(Lha;B)V")
