...
public class class256 {
    ...
    public static final void method1743(int[] arg0, int arg1, int arg2, int arg3) {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "([II[III)V")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "([BI[BII)V")
    public static final void method1746(byte[] arg0, int arg1, byte[] arg2, int arg3, int arg4) {
        if (arg0 == arg2) {
            if (arg1 == arg3) {
                return;
            }
