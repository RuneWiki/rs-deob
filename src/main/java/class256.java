...
public class class256 implements class447 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(I)Ljw;")
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(BLeq;)V")
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(Ljg;Ljha;IIIIIII)V")
