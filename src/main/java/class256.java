...
public class class256 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Ljava/lang/String;ZBLjava/lang/String;)V", line = 20)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Ljava/awt/Component;Z)Lle;", line = 54)
    public static final class280 method1560(Component arg0, boolean arg1) {
        field3476++;
        return arg1 ? null : new class423(arg0);
    }

    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(III)V", line = 213)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ZILjava/lang/String;Ljava/lang/String;B)V", line = 71)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Z)V", line = 82)
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(I)[[I", line = 103)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IZ)[I", line = 125)
