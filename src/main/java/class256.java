...
public class class256 extends class401 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "()V", line = 16)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "([FII)[F", line = 239)
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "()V", line = 253)
    public class256() {
    }

    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 255)
