...
public abstract class class256 {
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(FFFFIILsg;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(II)V", line = 28)
    public final void method1772(int arg0, int arg1) {
        this.method86(arg0, arg1, 0, 0, 1);
    }

    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(FFIILsg;II)V", line = 40)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(IIII)V", line = 43)
    public final void method1774(int arg0, int arg1, int arg2, int arg3) {
        this.method74(arg0, arg1, arg2, arg3, 0, 0, 1);
    }

    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(FFIIIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(FFII)V", line = 56)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(FFFFIIIII)V", line = 60)
