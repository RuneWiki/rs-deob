...
public class class256 extends class215 implements class158 {
    ...
    @OriginalMember(owner = "client!kf", name = "c", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "(Lbi;I[BI)V", line = 17)
    public class256(class483 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field3252 = arg1;
    }

    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(B)J", line = 28)
    public final long method1105(byte arg0) {
        ++field3251;
        return arg0 > -85 ? 60L : super.field2847.getAddress();
    }

    @OriginalMember(owner = "client!kf", name = "a", descriptor = "()V", line = 41)
    public static final void method1559() {
        class4.method18(1, class29.field515);
    }

    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(I[BII)V", line = 44)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(I)I", line = 57)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(B)I", line = 67)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(ZLha;J)V", line = 78)
