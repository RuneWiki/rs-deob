...
public class class256 {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IILvl;IILqq;I)V")
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IIIIILhf;)Ljava/awt/Frame;")
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(Lko;II)V")
