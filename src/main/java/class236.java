...
public class class236 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!gv", name = "c", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ILpf;)V", line = 49)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(II)Llh;", line = 76)
    ...
    @OriginalMember(owner = "client!gv", name = "d", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(II)V", line = 129)
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Lad;ILdk;)V", line = 154)
