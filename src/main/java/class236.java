...
public class class236 extends class202 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IIB[ILmn;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!er", name = "d", descriptor = "()Lfja;", line = 100)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(I[BILfc;)Loga;", line = 118)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "()I", line = 149)
    public final int method1418() {
        field3422++;
        return 0;
    }

    @OriginalMember(owner = "client!er", name = "a", descriptor = "(BLmn;I)V", line = 161)
    ...
    @OriginalMember(owner = "client!er", name = "c", descriptor = "()Lfja;", line = 202)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(II[FIIZI)V", line = 222)
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "([III)V", line = 320)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(III)Z", line = 367)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(Lof;)V", line = 389)
