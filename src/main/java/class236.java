...
public class class236 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IZZ)Ldn;", line = 35)
    ...
    @OriginalMember(owner = "client!uk", name = "b", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Z[[I)V", line = 63)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(ILep;)Ljava/lang/String;", line = 74)
