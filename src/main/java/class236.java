...
public class class236 extends class416 {
    ...
    @OriginalMember(owner = "client!fa", name = "d", descriptor = "(Z)V", line = 12)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lli;B)Z", line = 23)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(I)I", line = 58)
    ...
    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 79)
    public class236(String arg0) {
        this.field3320 = arg0;
        this.field3322 = new class721();
    }

    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lli;I)Z", line = 88)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lvfa;I)V", line = 114)
