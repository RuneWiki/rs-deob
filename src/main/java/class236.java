...
public class class236 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(BLdn;Ljava/lang/String;Z)Loh;")
    ...
    @OriginalMember(owner = "client!sm", name = "b", descriptor = "(IB)Lrh;")
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(Lre;ILdn;)V")
