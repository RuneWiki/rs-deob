...
public abstract class class236 extends class511 {
    ...
    @OriginalMember(owner = "client!jj", name = "EA", descriptor = "(IIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!jj", name = "ba", descriptor = "(IIIIIII)V", line = 13)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(FFFFFFLfa;II)V", line = 56)
    ...
    @OriginalMember(owner = "client!jj", name = "QA", descriptor = "()I", line = 69)
    public final int method608() {
        return this.field3165;
    }

    @OriginalMember(owner = "client!jj", name = "sa", descriptor = "(FFFFFFIII)V", line = 74)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(FFFFFF)Z", line = 174)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "()I", line = 319)
    public final int method595() {
        return this.field3180 + this.field3154 + this.field3153;
    }

    @OriginalMember(owner = "client!jj", name = "b", descriptor = "()I", line = 333)
    public final int method607() {
        return this.field3154;
    }

    @OriginalMember(owner = "client!jj", name = "AA", descriptor = "()I", line = 340)
    public final int method602() {
        return this.field3171 + this.field3165 + this.field3167;
    }

    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(Lql;II)V", line = 342)
