...
public class class236 {
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(I[[[BIBII)V", line = 45)
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(B)V", line = 194)
