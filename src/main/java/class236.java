...
public class class236 extends class329 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(Z)Z", line = 16)
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(II)V", line = 40)
