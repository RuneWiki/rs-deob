...
public class class236 extends class659 {
    ...
    @OriginalMember(owner = "client!bea", name = "d", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(II)Z", line = 116)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(IB)Z", line = 127)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(BI)Z", line = 152)
    ...
    @OriginalMember(owner = "client!bea", name = "b", descriptor = "(II)Z", line = 164)
    ...
    @OriginalMember(owner = "client!bea", name = "e", descriptor = "(B)V", line = 184)
    ...
    @OriginalMember(owner = "client!bea", name = "<init>", descriptor = "(I)V", line = 247)
