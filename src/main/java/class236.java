...
public class class236 extends class170 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIZLcs;III)V")
    ...
    @OriginalMember(owner = "client!pm", name = "c", descriptor = "()Los;")
    public final class170 method1065() {
        field3534++;
        return null;
    }

    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(BDI)Lfl;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lfl;I)V")
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "()Los;")
    ...
    @OriginalMember(owner = "client!pm", name = "d", descriptor = "(I)Lfl;")
