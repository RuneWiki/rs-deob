...
public class class236 extends class371 implements class210 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(I)I", line = 8)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ZLvc;)V", line = 19)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Lvc;B)V", line = 48)
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "(Lvc;Lnm;IIIIZIIIII)V", line = 76)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Lvc;IIZ)Lco;", line = 100)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(B)I", line = 127)
    public final int method71(byte arg0) {
        ++field3425;
        return arg0 < 81 ? 76 : this.field3429;
    }

    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ILvc;II)Z", line = 142)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ILvc;I)Ln;", line = 166)
    ...
    @OriginalMember(owner = "client!vo", name = "b", descriptor = "(B)I", line = 192)
    public final int method83(byte arg0) {
        ++field3438;
        return arg0 < 70 ? 28 : this.field3441;
    }

    @OriginalMember(owner = "client!vo", name = "c", descriptor = "(B)Z", line = 204)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(BILvc;)Ln;", line = 215)
    ...
    @OriginalMember(owner = "client!vo", name = "b", descriptor = "(ZLvc;)V", line = 226)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Lvc;I)Lep;", line = 236)
    ...
    @OriginalMember(owner = "client!vo", name = "e", descriptor = "(I)I", line = 263)
    ...
    @OriginalMember(owner = "client!vo", name = "b", descriptor = "(I)V", line = 275)
    ...
    @OriginalMember(owner = "client!vo", name = "f", descriptor = "(I)V", line = 299)
