...
public class class236 extends class396 {
    ...
    @OriginalMember(owner = "client!em", name = "b", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(CI)Z", line = 36)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(II)Z", line = 72)
    ...
    @OriginalMember(owner = "client!em", name = "c", descriptor = "(III)V", line = 83)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(III)V", line = 106)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Z)Lgaa;", line = 133)
