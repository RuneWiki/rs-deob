...
public class class236 extends class727 implements class466 {
    ...
    @OriginalMember(owner = "client!iba", name = "d", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!iba", name = "b", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(ILha;)Lrk;", line = 29)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(Loq;IZILha;II)V", line = 83)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(Lha;Z)V", line = 94)
    ...
    @OriginalMember(owner = "client!iba", name = "e", descriptor = "(B)V", line = 107)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(ILaka;)V", line = 122)
    ...
    @OriginalMember(owner = "client!iba", name = "d", descriptor = "(Z)Z", line = 132)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(B)I", line = 146)
    ...
    @OriginalMember(owner = "client!iba", name = "b", descriptor = "(B)Z", line = 156)
    ...
    @OriginalMember(owner = "client!iba", name = "i", descriptor = "(I)I", line = 167)
    ...
    @OriginalMember(owner = "client!iba", name = "c", descriptor = "(Lha;I)Ltja;", line = 184)
    public final class491 method72(class473 arg0, int arg1) {
        ++field3553;
        return arg1 != -5047 ? null : this.field3540;
    }

    @OriginalMember(owner = "client!iba", name = "c", descriptor = "(I)I", line = 195)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(Z)I", line = 205)
    ...
    @OriginalMember(owner = "client!iba", name = "d", descriptor = "(B)I", line = 219)
    ...
    @OriginalMember(owner = "client!iba", name = "<init>", descriptor = "(Lha;Lro;IIIIIZII)V", line = 365)
    ...
    @OriginalMember(owner = "client!iba", name = "b", descriptor = "(Lha;I)V", line = 237)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(IIBI)Liaa;", line = 261)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(Lha;I)V", line = 294)
    ...
    @OriginalMember(owner = "client!iba", name = "e", descriptor = "(I)Z", line = 304)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(I)I", line = 315)
    public final int method760(int arg0) {
        ++field3552;
        return arg0 != -27640 ? 94 : this.field3548.field6111;
    }

    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(IIIIIBIIII)V", line = 326)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(ILha;II)Z", line = 374)
