...
public class class236 {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(III)Z", line = 21)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(BLeo;II)V", line = 37)
