...
public class class236 extends class641 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Loa;Z)V")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Loa;Lq;ILba;)V")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(ILoa;)Ldd;")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(BILoa;I)Z")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(BLoa;)Lpe;")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Loa;III)Lba;")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(BLeh;)V")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(ILoa;ILni;ZZI)V")
