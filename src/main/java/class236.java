...
public class class236 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IIB)Lts;", line = 36)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(BIIIIII)V", line = 58)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Z)V", line = 109)
