...
public class class236 extends class463 implements class405 {
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(ZF)F", line = 16)
    public final float method1531(boolean arg0, float arg1) {
        return arg0 ? -0.7535977F : arg1 / (float) this.field3475;
    }

    @OriginalMember(owner = "client!kda", name = "<init>", descriptor = "(Lde;Lkl;Lvt;II)V", line = 25)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(IF)F", line = 45)
    public final float method1532(int arg0, float arg1) {
        return arg0 == -8221 ? arg1 / (float) this.field3474 : -0.57473934F;
    }

    @OriginalMember(owner = "client!kda", name = "b", descriptor = "(I)I", line = 55)
    public final int method1533(int arg0) {
        return arg0 < 114 ? 34 : this.field3474;
    }

    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(IILkl;III[BII)V", line = 65)
    ...
    @OriginalMember(owner = "client!kda", name = "<init>", descriptor = "(Lde;Lkl;IIZ[BII)V", line = 105)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(ZZI)V", line = 165)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(Lem;I)V", line = 174)
    public final void method840(class599 arg0, int arg1) {
        super.method840(arg0, 109);
        int var3 = -94 % ((-arg1 - 72) / 48);
    }

    @OriginalMember(owner = "client!kda", name = "d", descriptor = "(I)V", line = 183)
    ...
    @OriginalMember(owner = "client!kda", name = "c", descriptor = "(I)Z", line = 195)
    public final boolean method1536(int arg0) {
        return arg0 == -5845 ? true : true;
    }

    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(IIZI[IIII)V", line = 205)
    ...
    @OriginalMember(owner = "client!kda", name = "<init>", descriptor = "(Lde;IIZ[III)V", line = 244)
    ...
    @OriginalMember(owner = "client!kda", name = "e", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 301)
