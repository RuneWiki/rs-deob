...
public class class236 extends class90 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ILug;B)Ljc;", line = 3)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "([ILbg;[IZ[I)V", line = 32)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lui;ZLcp;ZDII)[I", line = 128)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(B)V", line = 265)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lui;Lcp;Z)Z", line = 282)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ILcp;Lui;ZII)[F", line = 338)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ILcp;ILui;ZIZD)[I", line = 446)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IIIIIZZ)V", line = 583)
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "()V", line = 650)
    public class236() {
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "(Lre;)V", line = 665)
