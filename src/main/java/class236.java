...
public class class236 {
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Z)Lrn;")
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(II)Lbo;")
    ...
    @OriginalMember(owner = "client!jp", name = "<init>", descriptor = "(Llf;ILvh;)V")
