...
public class class236 extends class743 {
    ...
    @OriginalMember(owner = "client!lw", name = "g", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(Lha;I)Ljl;", line = 14)
    ...
    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(ILha;)Lgp;", line = 58)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!lw", name = "j", descriptor = "(I)Z", line = 106)
    ...
    @OriginalMember(owner = "client!lw", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 271)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IIILha;)Lka;", line = 123)
    ...
    @OriginalMember(owner = "client!lw", name = "c", descriptor = "(ILha;)V", line = 140)
    ...
    @OriginalMember(owner = "client!lw", name = "e", descriptor = "(B)V", line = 163)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Luha;BLka;Lha;)V", line = 178)
    ...
    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(II)V", line = 205)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(BILjava/lang/String;)Lip;", line = 239)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IBZILha;ILig;)V", line = 260)
    ...
    @OriginalMember(owner = "client!lw", name = "finalize", descriptor = "()V", line = 301)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(ZI)V", line = 311)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Lha;III)Z", line = 323)
    ...
    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(B)Z", line = 340)
    ...
    @OriginalMember(owner = "client!lw", name = "f", descriptor = "(I)I", line = 359)
    ...
    @OriginalMember(owner = "client!lw", name = "g", descriptor = "(B)V", line = 370)
    ...
    @OriginalMember(owner = "client!lw", name = "d", descriptor = "(B)Z", line = 386)
