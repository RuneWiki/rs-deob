...
public class class236 extends class626 {
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!kea", name = "b", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!kea", name = "<init>", descriptor = "(ILcfa;IZ)V", line = 82)
