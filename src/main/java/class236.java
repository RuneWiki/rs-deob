...
public class class236 extends class218 {
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(Z)Z", line = 18)
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(I)Ljava/lang/Object;", line = 29)
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(Lvl;Ljava/lang/Object;I)V", line = 55)
