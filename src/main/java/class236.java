...
public class class236 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Leb;II)V")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(BILeb;I)V")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(ILrg;II)V")
