...
public abstract class class236 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(ZLjp;)I", line = 10)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Lhm;III)V", line = 37)
    ...
    @OriginalMember(owner = "client!ak", name = "c", descriptor = "(B)V", line = 122)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IFIFF)F", line = 183)
