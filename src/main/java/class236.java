...
public class class236 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(II)Lck;", line = 16)
    ...
    @OriginalMember(owner = "client!jj", name = "b", descriptor = "(II)I", line = 47)
    ...
    @OriginalMember(owner = "client!jj", name = "c", descriptor = "(II)V", line = 66)
    ...
    @OriginalMember(owner = "client!jj", name = "b", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(III)Z", line = 110)
    ...
    @OriginalMember(owner = "client!jj", name = "c", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(Lsea;ILmv;)V", line = 149)
