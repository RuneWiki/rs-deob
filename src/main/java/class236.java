...
public class class236 {
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "()V", line = 5)
    public class236() {
    }

    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "(Lfr;)V", line = 7)
    public class236(class236 arg0) {
