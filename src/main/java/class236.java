...
public class class236 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(ZIIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Z)V", line = 203)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(II)V", line = 217)
