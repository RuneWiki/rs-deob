...
public class class236 extends class381 {
    ...
    @OriginalMember(owner = "client!w", name = "c", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lpe;Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Z)V", line = 63)
