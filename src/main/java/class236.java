...
public class class236 extends class454 {
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!mb", name = "g", descriptor = "(I)I", line = 32)
    ...
    @OriginalMember(owner = "client!mb", name = "c", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!mb", name = "i", descriptor = "(I)Z", line = 57)
    public final boolean method1181(int arg0) {
        ++field3660;
        return arg0 != -1;
    }

    @OriginalMember(owner = "client!mb", name = "finalize", descriptor = "()V", line = 69)
    ...
    @OriginalMember(owner = "client!mb", name = "j", descriptor = "(I)Z", line = 79)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 223)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(B)I", line = 107)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IIIII)V", line = 137)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(II)V", line = 161)
    ...
    @OriginalMember(owner = "client!mb", name = "b", descriptor = "(ILr;)Lnu;", line = 193)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IILr;I)Z", line = 208)
    ...
    @OriginalMember(owner = "client!mb", name = "f", descriptor = "(I)V", line = 254)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(ILr;BI)Lda;", line = 264)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IZLr;Lrga;IIZ)V", line = 289)
    ...
    @OriginalMember(owner = "client!mb", name = "h", descriptor = "(I)Z", line = 300)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(ILr;)V", line = 317)
    ...
    @OriginalMember(owner = "client!mb", name = "b", descriptor = "(Lr;Z)Lkq;", line = 335)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Lq;Lr;Lda;I)V", line = 384)
