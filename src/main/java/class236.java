...
public class class236 extends class299 {
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!jda", name = "d", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!jda", name = "<init>", descriptor = "(Les;)V", line = 45)
    public class236(class404 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(IZ)V", line = 51)
    ...
    @OriginalMember(owner = "client!jda", name = "c", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!jda", name = "b", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(IIIIIII)Llia;", line = 95)
    ...
    @OriginalMember(owner = "client!jda", name = "b", descriptor = "(Z)I", line = 117)
    ...
    @OriginalMember(owner = "client!jda", name = "<init>", descriptor = "(ILes;)V", line = 128)
