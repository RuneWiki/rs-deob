...
public class class236 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IIBII)V", line = 26)
    ...
    @OriginalMember(owner = "client!km", name = "finalize", descriptor = "()V", line = 76)
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(Lef;II)V", line = 97)
    public class236(class338 arg0, int arg1, int arg2) {
        this.field3343 = arg0;
        this.field3344 = arg2;
    }

    @OriginalMember(owner = "client!km", name = "a", descriptor = "(B)V", line = 108)
