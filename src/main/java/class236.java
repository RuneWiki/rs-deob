...
public class class236 extends class215 {
    ...
    @OriginalMember(owner = "client!bea", name = "<init>", descriptor = "(Luga;[IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!bea", name = "<init>", descriptor = "(Luga;[III)V")
    ...
    @OriginalMember(owner = "client!bea", name = "<init>", descriptor = "(Luga;II)V")
