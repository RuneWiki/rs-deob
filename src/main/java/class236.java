...
public class class236 {
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(III)Lwe;", line = 15)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Lkm;BII)V", line = 35)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(IIIIIZIII)Z", line = 63)
