...
public class class236 extends class33 {
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "(Lrh;Lse;[Lrl;[I[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "([B[IIIIIIIIIIILea;II)V", line = 26)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(CIIIZLea;II)V", line = 120)
    ...
    @OriginalMember(owner = "client!hd", name = "B", descriptor = "(CIIIZ)V", line = 187)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "([B[IIIIIIII)V", line = 245)
