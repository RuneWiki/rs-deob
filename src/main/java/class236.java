...
public class class236 extends class274 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lta;IIFZ)V")
    ...
    @OriginalMember(owner = "client!rb", name = "b", descriptor = "(ILev;)V")
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lev;I)V")
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(ILev;)V")
