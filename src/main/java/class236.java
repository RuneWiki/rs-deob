...
public class class236 extends class324 {
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(B[BI)[B", line = 19)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IB)Lbg;", line = 42)
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(II)V", line = 71)
