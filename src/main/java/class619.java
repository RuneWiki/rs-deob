...
public class class619 extends class640 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lha;J[Ljk;[Lhja;Z)V")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!kq", name = "e", descriptor = "()Ljw;")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lha;J)Z")
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(IZ)Lkq;")
    ...
    @OriginalMember(owner = "client!kq", name = "g", descriptor = "()Ljw;")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lha;[Ljk;Z)V")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "([Lhja;Z)V")
