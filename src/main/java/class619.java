...
public class class619 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IIII[B[B)I", line = 3)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IIZZI)V", line = 153)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(III)Z", line = 176)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(I[B[BIII)I", line = 187)
    ...
    @OriginalMember(owner = "client!nu", name = "<init>", descriptor = "([B)V", line = 257)
