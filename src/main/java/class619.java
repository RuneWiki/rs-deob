...
public class class619 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(ZIB)V", line = 22)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(Z)V", line = 45)
    public class619(boolean arg0) {
        this.field9029 = arg0;
    }

    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(B)Z", line = 77)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(ILwca;)V", line = 88)
