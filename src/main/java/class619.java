...
public class class619 extends class217 implements class649 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "(Lha;Lkha;IIIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!ur", name = "c", descriptor = "(ILha;)V")
    public final void method271(int arg0, class545 arg1) {
        ++field8802;
        int var3 = 62 / ((arg0 - -15) / 57);
    }

    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Lha;III)Z")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Lha;IBZ)Lws;")
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(ILha;)Lgp;")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IZLha;)Lka;")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IBZILha;ILig;)V")
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(Lha;I)Ljl;")
