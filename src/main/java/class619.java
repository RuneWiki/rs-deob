...
public class class619 extends class569 implements class602 {
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!et", name = "d", descriptor = "(Lha;B)Lln;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ILha;II)Z")
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(Lha;Llp;IIIIIZIIII)V")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ILha;I)Lka;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ZIILha;)Lsw;")
    ...
    @OriginalMember(owner = "client!et", name = "c", descriptor = "(Lha;B)Lpia;")
    ...
    @OriginalMember(owner = "client!et", name = "e", descriptor = "(Lha;B)V")
