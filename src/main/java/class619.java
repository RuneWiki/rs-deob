...
public class class619 {
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(III)Z", line = 16)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(Z)V", line = 43)
