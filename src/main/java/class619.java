...
public class class619 extends class145 {
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(Lqf;III)V", line = 29)
    ...
    @OriginalMember(owner = "client!nea", name = "<init>", descriptor = "()V", line = 43)
    public class619() {
        super(1, false);
    }

    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(IZII)I", line = 49)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(B)V", line = 94)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(BI)[[I", line = 104)
    ...
    @OriginalMember(owner = "client!nea", name = "i", descriptor = "(I)V", line = 153)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(IILrt;)V", line = 165)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(ZI)[I", line = 178)
