...
public class class619 extends class429 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Llw;IIIIIIIIIIIZZ)V", line = 14)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(JI)V", line = 35)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Loa;J)V", line = 431)
    ...
    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "(Llw;IIIIIIIIIIIZZ)V", line = 625)
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "()V", line = 646)
