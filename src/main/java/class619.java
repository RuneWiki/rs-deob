...
public class class619 {
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(Z)Lnfa;")
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(ILrba;)V")
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(BLwga;)V")
    ...
    @OriginalMember(owner = "client!jia", name = "b", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!jia", name = "b", descriptor = "(ILrba;)V")
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(Lir;Z)V")
