...
public class class619 {
    ...
    @OriginalMember(owner = "client!tl", name = "<init>", descriptor = "(Luv;Ld;)V", line = 44)
    public class619(class367 arg0, class152 arg1) {
        this.field8680 = arg0;
        this.field8675 = arg1;
    }

    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Z)Z", line = 56)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(II)Ljs;", line = 76)
    ...
    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(I)V", line = 123)
