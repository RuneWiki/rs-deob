...
public class class619 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ZII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ZI)Z", line = 15)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IIII)I", line = 38)
