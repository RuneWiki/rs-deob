...
public class class619 implements class533 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;[ILofa;)V", line = 14)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lofa;[II)V", line = 17)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Li;BIZ)Lka;", line = 26)
    ...
    @OriginalMember(owner = "client!a", name = "b", descriptor = "()V", line = 74)
    private final void method3392() {
        this.method3409(this.nativeid);
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lha;[I[I[I[SI)V", line = 80)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lha;IIIIIII)V", line = 83)
    ...
    @OriginalMember(owner = "client!a", name = "c", descriptor = "()V", line = 88)
    public final void method3398() {
        this.field8262 = Thread.currentThread();
        this.method3392();
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lka;IIIZ)V", line = 92)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;II)V", line = 99)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILofa;ZI)Z", line = 102)
    ...
    @OriginalMember(owner = "client!a", name = "d", descriptor = "()V", line = 106)
    private final void method3405() {
        this.method3407(this.nativeid);
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;III)V", line = 113)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lofa;[III)V", line = 117)
    ...
    @OriginalMember(owner = "client!a", name = "w", descriptor = "(Z)V", line = 124)
    public final void method116(boolean arg0) {
        this.method3391(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILofa;Z)Z", line = 129)
