...
public abstract class class619 extends class45 {
    ...
    @OriginalMember(owner = "client!lga", name = "b", descriptor = "(I)I", line = 12)
    ...
    @OriginalMember(owner = "client!lga", name = "c", descriptor = "(I)Z", line = 25)
    ...
    @OriginalMember(owner = "client!lga", name = "c", descriptor = "(B)Z", line = 37)
    ...
    @OriginalMember(owner = "client!lga", name = "d", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!lga", name = "d", descriptor = "(I)I", line = 62)
    ...
    @OriginalMember(owner = "client!lga", name = "<init>", descriptor = "(Lag;)V", line = 74)
