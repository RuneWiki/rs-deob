...
public class class619 {
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Lha;Ljava/lang/String;IIIZ)V")
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Lha;Ljava/lang/String;[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Lha;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
    ...
    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "(Lha;IZLjava/awt/Component;)V")
