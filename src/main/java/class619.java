...
public class class619 extends class442 {
    ...
    @OriginalMember(owner = "client!nca", name = "fa", descriptor = "(CIIIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!nca", name = "<init>", descriptor = "(Llba;Lhw;[Lfm;Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(CIIIZLaa;II)V", line = 333)
