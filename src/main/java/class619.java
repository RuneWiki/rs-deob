...
public class class619 extends class585 {
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!et", name = "c", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ZI)[[I", line = 44)
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(II)[I", line = 89)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lqe;ILbr;ILha;I)Z", line = 126)
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "()V", line = 314)
    public class619() {
        super(1, false);
    }

    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lso;II)V", line = 318)
    ...
    @OriginalMember(owner = "client!et", name = "d", descriptor = "(I)V", line = 332)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IZI)V", line = 344)
