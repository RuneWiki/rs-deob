...
public class class619 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Lfm;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(III)I", line = 89)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(II)V", line = 118)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Z)V", line = 131)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(ZI)V", line = 155)
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "(I)V", line = 171)
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "(II)Lls;", line = 185)
    ...
    @OriginalMember(owner = "client!he", name = "<init>", descriptor = "(Lmca;ILgga;)V", line = 224)
