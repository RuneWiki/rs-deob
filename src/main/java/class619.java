...
public abstract class class619 extends class71 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IBI)Z", line = 112)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IIIIBII)I", line = 128)
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 159)
    public class619(OggStreamState arg0) {
        this.field8305 = arg0;
    }

    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V", line = 167)
