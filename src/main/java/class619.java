...
public class class619 extends class17 implements class29 {
    ...
    @OriginalMember(owner = "client!gba", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(ZZB)V", line = 13)
    public final void method364(boolean arg0, boolean arg1, byte arg2) {
        int var4 = -3 % ((53 - arg2) / 47);
        ++field8765;
    }

    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(I)I", line = 22)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(ILos;II[BIIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(FB)F", line = 59)
    ...
    @OriginalMember(owner = "client!gba", name = "b", descriptor = "(I)Z", line = 70)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(II[IIIIII)V", line = 82)
    ...
    @OriginalMember(owner = "client!gba", name = "b", descriptor = "(IB)I", line = 109)
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(Lbea;Los;II[FII)V", line = 119)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IF)F", line = 137)
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(Lbea;Los;Lmg;II)V", line = 149)
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(Lbea;II[III)V", line = 161)
    ...
    @OriginalMember(owner = "client!gba", name = "c", descriptor = "(I)I", line = 179)
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(Lbea;Los;II[BII)V", line = 190)
