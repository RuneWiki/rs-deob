...
public class class619 extends class222 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(III)Z", line = 20)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(ZZ)V", line = 31)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IIIIIBIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!lf", name = "e", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(Ljj;II[BI)V", line = 67)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(I)V", line = 80)
