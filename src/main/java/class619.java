...
public class class619 implements class255 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Z)Lqi;", line = 12)
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Ljava/awt/Component;IIILnga;)Lvm;", line = 84)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(Lgq;Lkfa;IIIIIII)V", line = 169)
