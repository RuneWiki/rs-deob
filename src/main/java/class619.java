...
public class class619 implements class532 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILbca;ZI)Z", line = 8)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lka;IIIZ)V", line = 11)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lbca;[II)V", line = 23)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILbca;Z)Z", line = 27)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;III)V", line = 30)
    ...
    @OriginalMember(owner = "client!a", name = "w", descriptor = "(Z)V", line = 34)
    public final void method129(boolean arg0) {
        this.method3508(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;IIIIIII[[Z)V", line = 38)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lbca;[III)V", line = 41)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lha;IIIIIII)V", line = 47)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;[ILbca;)V", line = 52)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Li;BIZ)Lka;", line = 57)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "()V", line = 104)
    private final void method3526() {
        this.method3510(this.nativeid);
    }

    @OriginalMember(owner = "client!a", name = "b", descriptor = "()V", line = 108)
    public final void method3527() {
        this.field8434 = Thread.currentThread();
        this.method3534();
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lha;[I[I[I[SI)V", line = 118)
    ...
    @OriginalMember(owner = "client!a", name = "c", descriptor = "()V", line = 125)
    public final void method3533() {
        this.field8434 = null;
        this.method3526();
    }

    @OriginalMember(owner = "client!a", name = "d", descriptor = "()V", line = 131)
