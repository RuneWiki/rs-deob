...
public class class619 extends class82 {
    ...
    @OriginalMember(owner = "client!cm", name = "c", descriptor = "(II)[I", line = 5)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "()V", line = 27)
    public class619() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILet;Z)V", line = 30)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ZZ)Z", line = 55)
