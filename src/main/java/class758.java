...
public class class758 extends class345 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ILrba;ILmk;)V")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IIIILha;IIIILvda;II)V")
    ...
    @OriginalMember(owner = "client!f", name = "<init>", descriptor = "(Lbi;Llha;)V")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IILcj;)V")
