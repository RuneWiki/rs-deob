...
public class class758 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ILjava/lang/String;Lwh;B)Lwj;")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lrg;I)V")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(BLio;Lrg;)Ltb;")
