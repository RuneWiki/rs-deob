...
public class class758 {
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(IIBII)V", line = 16)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(Z)I", line = 193)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 235)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(I[Ljava/lang/Object;[JII)V", line = 256)
    ...
    @OriginalMember(owner = "client!aca", name = "toString", descriptor = "()Ljava/lang/String;", line = 313)
    public final String toString() {
        field10449++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!aca", name = "<init>", descriptor = "(II)V", line = 322)
