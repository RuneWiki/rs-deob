...
public class class758 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(I[Ltq;)I", line = 6)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(ZJ)Ltq;", line = 48)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(II)V", line = 112)
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(I)I", line = 122)
    ...
    @OriginalMember(owner = "client!mp", name = "c", descriptor = "(I)Ltq;", line = 143)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Z)I", line = 174)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(I)V", line = 204)
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(Z)Ltq;", line = 227)
    ...
    @OriginalMember(owner = "client!mp", name = "d", descriptor = "(I)Ltq;", line = 242)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Ltq;BJ)V", line = 283)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IIIIILjava/lang/String;Lha;I)V", line = 304)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "()V", line = 348)
