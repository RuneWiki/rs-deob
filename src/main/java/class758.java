...
public class class758 {
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(BLpea;)Z")
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(Lwq;B)V")
    ...
    @OriginalMember(owner = "client!pea", name = "<init>", descriptor = "(Lwq;)V")
