...
public abstract class class758 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IC)Z", line = 5)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Luv;Z)Ljava/lang/String;", line = 20)
    ...
    @OriginalMember(owner = "client!nh", name = "b", descriptor = "(B)V", line = 44)
