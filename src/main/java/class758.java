...
public class class758 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "([BIB)[B", line = 9)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(I)I", line = 35)
