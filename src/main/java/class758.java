...
public class class758 extends class101 {
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!aca", name = "b", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(II)Z", line = 76)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(IIII)I", line = 93)
    ...
    @OriginalMember(owner = "client!aca", name = "<init>", descriptor = "(II)V", line = 119)
