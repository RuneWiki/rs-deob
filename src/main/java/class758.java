...
public class class758 {
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(IIIIIIIIIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!eca", name = "<init>", descriptor = "(ILjava/lang/String;ILjava/lang/String;J)V", line = 46)
