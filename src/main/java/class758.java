...
public class class758 extends class559 {
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(ILha;)Lgh;")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IILha;I)Z")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lha;I)Lkn;")
    public final class516 method93(class544 arg0, int arg1) {
        ++field10555;
        return arg1 != 1 ? null : null;
    }

    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ZILha;Lov;IIZ)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lka;Ltc;Lha;B)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lha;IIB)Lka;")
