...
public class class634 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ILkha;IB)Lng;", line = 30)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(II)V", line = 69)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Z)V", line = 82)
    ...
    @OriginalMember(owner = "client!co", name = "b", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IZLkha;Ljava/lang/String;)Ldca;", line = 109)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "(Ldh;ILkha;)V", line = 189)
    ...
    @OriginalMember(owner = "client!co", name = "b", descriptor = "(II)Lic;", line = 161)
