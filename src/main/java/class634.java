...
public class class634 extends class429 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(B)Z", line = 25)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(III)V", line = 36)
    ...
    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!ie", name = "f", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Len;ZI)V", line = 110)
    ...
    @OriginalMember(owner = "client!ie", name = "d", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(IZ)V", line = 136)
    ...
    @OriginalMember(owner = "client!ie", name = "c", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(Llj;Lgga;Lnc;)V", line = 177)
    ...
    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(B)V", line = 197)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(ZZ)V", line = 210)
