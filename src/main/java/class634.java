...
public class class634 extends class280 {
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(Lwh;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!mh", name = "wa", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!mh", name = "CA", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!mh", name = "fa", descriptor = "(IILr;)Lr;")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IIBLoca;)V")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Lraa;[I)V")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Lr;IIIIZ)Z")
