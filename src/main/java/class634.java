...
public class class634 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(I[BIZ)V", line = 14)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(JZII)Ljava/lang/String;", line = 28)
    ...
    @OriginalMember(owner = "client!pe", name = "c", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(Llf;Lwg;Lbja;IIIII)V", line = 238)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(ILvv;I)V", line = 195)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(JJ)J", line = 218)
    public static long method3500(long arg0, long arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(III)Liga;", line = 226)
