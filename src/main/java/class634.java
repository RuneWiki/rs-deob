...
public class class634 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(I[B)V", line = 9)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(B)V", line = 208)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "([BI[B)V", line = 229)
