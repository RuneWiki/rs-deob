...
public class class634 {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Ldc;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(BI)V", line = 27)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Ldc;IB)V", line = 48)
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Luv;I)Luv;", line = 127)
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(BI)V", line = 152)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IIB)I", line = 244)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Z)V", line = 300)
