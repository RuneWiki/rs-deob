...
public class class634 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ILbda;)V")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Lbda;II)V")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Lbda;Z)V")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Lka;ZLbda;)V")
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(Lbda;Z)V")
    public final void method3647(class428 arg0, boolean arg1) {
        field9130++;
        this.field9133.method444(arg1, 196584, 24);
    }

    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(Lbda;)V")
