...
public abstract class class634 extends class134 {
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(BI)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(ILig;Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(I)I", line = 51)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(I[Lhu;)V", line = 66)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(III)[I", line = 94)
    ...
    @OriginalMember(owner = "client!qt", name = "b", descriptor = "(B)V", line = 117)
    ...
    @OriginalMember(owner = "client!qt", name = "b", descriptor = "(BI)[I", line = 149)
    ...
    @OriginalMember(owner = "client!qt", name = "c", descriptor = "(B)V", line = 162)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(IIB)V", line = 182)
    ...
    @OriginalMember(owner = "client!qt", name = "<init>", descriptor = "(IZ)V", line = 204)
    public class634(int arg0, boolean arg1) {
        this.field9121 = arg1;
        this.field9129 = new class634[arg0];
    }

    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(IIZ)[[I", line = 213)
    ...
    @OriginalMember(owner = "client!qt", name = "b", descriptor = "(I)I", line = 254)
