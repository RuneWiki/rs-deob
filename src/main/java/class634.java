...
public class class634 extends class502 {
    ...
    @OriginalMember(owner = "client!raa", name = "<init>", descriptor = "(Leka;)V")
    ...
    @OriginalMember(owner = "client!raa", name = "c", descriptor = "(B)I")
    ...
    @OriginalMember(owner = "client!raa", name = "c", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!raa", name = "<init>", descriptor = "(ILeka;)V")
