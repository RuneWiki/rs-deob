...
public class class634 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Ljava/lang/String;IZ)Ljava/lang/String;", line = 77)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ZLst;Z)V", line = 99)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(B)V", line = 251)
    ...
    @OriginalMember(owner = "client!ee", name = "c", descriptor = "(Z)V", line = 276)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(III)I", line = 292)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ZLoa;B)Lxa;", line = 321)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(BILeh;)V", line = 369)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Laba;Z)Z", line = 543)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Loa;I)Lxa;", line = 590)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IIZ)I", line = 639)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ZLeh;)V", line = 675)
