...
public class class634 {
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(Lpj;Lve;Lmf;IIIII)V", line = 227)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!pe", name = "b", descriptor = "(B)V", line = 186)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Ldk;IZ)V", line = 201)
