...
public class class634 extends class232 {
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(IB)[I", line = 4)
    ...
    @OriginalMember(owner = "client!raa", name = "<init>", descriptor = "()V", line = 87)
    public class634() {
        super(1, true);
    }

    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(ILwq;I)V", line = 98)
    ...
    @OriginalMember(owner = "client!raa", name = "c", descriptor = "(B)V", line = 141)
    ...
    @OriginalMember(owner = "client!raa", name = "b", descriptor = "(B)Lhu;", line = 171)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(B)V", line = 186)
    ...
    @OriginalMember(owner = "client!raa", name = "d", descriptor = "(I)V", line = 201)
