...
public class class634 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IIII)I", line = 27)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(II)V", line = 77)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IB)V", line = 93)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "()V", line = 108)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ZI)Lpaa;", line = 194)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(I)V", line = 224)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(B)V", line = 244)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lei;ILri;Lri;)V", line = 272)
