...
public class class634 extends class136 {
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(II)Lrp;")
    ...
    @OriginalMember(owner = "client!kb", name = "aa", descriptor = "(Lw;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(Lgj;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IILlb;I)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lld;[I)V")
    ...
    @OriginalMember(owner = "client!kb", name = "c", descriptor = "(IILw;)Lw;")
    ...
    @OriginalMember(owner = "client!kb", name = "FA", descriptor = "(Lw;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lw;IIIIZ)Z")
