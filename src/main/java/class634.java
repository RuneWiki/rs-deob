...
public class class634 extends class120 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IBI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIIIIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(III)I", line = 455)
    ...
    @OriginalMember(owner = "client!re", name = "f", descriptor = "(B)V", line = 487)
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "(Lmj;II)V", line = 524)
    public class634(class344 arg0, int arg1, int arg2) {
        this.field8933 = new byte[arg1 * arg2];
    }

    @OriginalMember(owner = "client!re", name = "a", descriptor = "(Lpi;IILjava/lang/String;)Lbp;", line = 534)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIIII)V", line = 608)
