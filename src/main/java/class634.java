...
public class class634 {
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!rea", name = "b", descriptor = "(I)Lrea;", line = 124)
    ...
    @OriginalMember(owner = "client!rea", name = "<init>", descriptor = "(I)V", line = 198)
    public class634(int arg0) {
        this.field8645 = arg0;
    }

    @OriginalMember(owner = "client!rea", name = "<init>", descriptor = "(IIIIII)V", line = 205)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(Lfca;B)V", line = 144)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(Lrea;I)V", line = 178)
