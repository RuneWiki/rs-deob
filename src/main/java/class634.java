...
public class class634 {
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(III)Z", line = 7)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(II)Lfe;", line = 17)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(I)Lcq;", line = 45)
    ...
    @OriginalMember(owner = "client!qt", name = "toString", descriptor = "()Ljava/lang/String;", line = 105)
    public final String toString() {
        field9084++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!qt", name = "b", descriptor = "(III)Z", line = 113)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Z)V", line = 131)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(IB)I", line = 145)
