...
public class class634 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Lga;B)V")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(BIILtc;Lr;I)V")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ILga;I)Lifa;")
