...
public class class634 extends class13 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Lro;)V", line = 8)
    ...
    @OriginalMember(owner = "client!jk", name = "e", descriptor = "(B)V", line = 102)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(I)V", line = 120)
