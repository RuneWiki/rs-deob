...
public class class634 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(IZLjava/io/File;)V", line = 21)
