...
public class class634 extends class578 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!jk", name = "c", descriptor = "(I)[B", line = 31)
    ...
    @OriginalMember(owner = "client!jk", name = "b", descriptor = "(I)I", line = 54)
