...
public class class634 extends class287 {
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(ZDLd;ZIIILwu;)[I")
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(Lwu;ILd;)Z")
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(Ld;ZLwu;IIB)[F")
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(Ld;Lwu;ZIBID)[I")
    ...
    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "(Lvj;)V")
