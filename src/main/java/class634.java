...
public class class634 extends class20 {
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!nl", name = "c", descriptor = "(III)V", line = 18)
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(IIIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(III)V", line = 41)
