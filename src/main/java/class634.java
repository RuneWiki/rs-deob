...
public class class634 extends class392 {
    ...
    @OriginalMember(owner = "client!gj", name = "e", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(ILji;)Ljava/lang/String;", line = 46)
    ...
    @OriginalMember(owner = "client!gj", name = "f", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IILji;)V", line = 89)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lji;[II)V", line = 163)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(II)Lvea;", line = 195)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(BLji;)Ldt;", line = 209)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Z)Ljava/lang/String;", line = 245)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(III)I", line = 272)
    ...
    @OriginalMember(owner = "client!gj", name = "b", descriptor = "(BLji;)V", line = 290)
