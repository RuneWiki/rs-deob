...
public class class634 extends class438 {
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!me", name = "b", descriptor = "(ZI)V", line = 29)
    ...
    @OriginalMember(owner = "client!me", name = "b", descriptor = "(Z)I", line = 49)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(ZI)[B", line = 64)
    ...
    @OriginalMember(owner = "client!me", name = "b", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!me", name = "b", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!me", name = "c", descriptor = "(I)I", line = 141)
    ...
    @OriginalMember(owner = "client!me", name = "c", descriptor = "(B)I", line = 165)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(II)V", line = 179)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(Z)Luj;", line = 209)
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(ILid;Lid;Lrt;Lih;I[BIZ)V", line = 874)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(ILjava/awt/Canvas;BLd;I)Lha;", line = 309)
    ...
    @OriginalMember(owner = "client!me", name = "d", descriptor = "(I)V", line = 324)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(III)Lfo;", line = 342)
    ...
    @OriginalMember(owner = "client!me", name = "d", descriptor = "(B)V", line = 607)
    ...
    @OriginalMember(owner = "client!me", name = "b", descriptor = "(II)I", line = 664)
    ...
    @OriginalMember(owner = "client!me", name = "e", descriptor = "(I)V", line = 686)
