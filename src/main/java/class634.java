...
public class class634 extends class772 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!ca", name = "c", descriptor = "(I)Lvc;")
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(B)Lfi;")
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Lck;IIZ)V")
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Lck;IIII)V")
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Lck;II[III)V")
