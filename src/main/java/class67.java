...
public abstract class class67 extends class208 {
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "(Ln;)V")
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ln;)V")
    ...
    @OriginalMember(owner = "client!aw", name = "c", descriptor = "(IIIIII)Lqba;")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Lqba;)V")
    public final void method426(class345 arg0) {
    }

    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Lsi;III)V")
    ...
    @OriginalMember(owner = "client!aw", name = "C", descriptor = "()Lm;")
    public final class165 method428() {
        class30 var1 = this.method505(Thread.currentThread());
        return var1.field338;
    }

    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(I[Lnm;)V")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Lqba;Lqba;FLqba;)Lqba;")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(IIIIIILpa;II)V")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(IIIIZ)Lha;")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Lu;)V")
    ...
    @OriginalMember(owner = "client!aw", name = "g", descriptor = "(I)Lu;")
    ...
    @OriginalMember(owner = "client!aw", name = "G", descriptor = "(ILpa;II)V")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "([IIIII)Lha;")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(IIIIIF)Lnm;")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Lqm;Z)Lha;")
    ...
    @OriginalMember(owner = "client!aw", name = "y", descriptor = "()Lcr;")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Lm;)V")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Lrd;)V")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Llg;[Lqm;Z)Lra;")
    ...
    @OriginalMember(owner = "client!aw", name = "D", descriptor = "()Lm;")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(II[I[I)Lpa;")
