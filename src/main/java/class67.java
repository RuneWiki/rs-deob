...
public class class67 {
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Lrr;I)Lrr;")
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Lnaa;B)V")
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(I)Lnaa;")
