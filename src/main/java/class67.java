...
public abstract class class67 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(B[Ltf;IIII[ILjava/util/Random;Ljava/lang/String;III[III)I")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Ltf;IIII[IILjava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([II[Ltf;[I[IIILjava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIILjava/lang/String;[Ltf;BILaa;[I)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Ltf;IILjava/lang/String;IIIIIIIII[IBLaa;I)I")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIZIIIILjava/lang/String;II[Ltf;Laa;I[III)I")
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lha;Lbq;)V")
    public class67(class66 arg0, class307 arg1) {
        this.field924 = arg1;
        this.field922 = arg0;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II[I[Ltf;ILjava/lang/String;ILjava/util/Random;II)I")
