...
public abstract class class67 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/lang/String;IIIIIIB)V", line = 10)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IILjava/lang/String;)V", line = 46)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IILjava/lang/String;IIIIIIIBILaa;[Lqda;[II)I", line = 87)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILaa;IIIILjava/lang/String;III[Lqda;I[IIIII)I", line = 101)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIILjava/lang/String;II)V", line = 205)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(B[I[I[Lqda;II[ILjava/lang/String;)V", line = 237)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(BII)V", line = 399)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/util/Random;I[ILjava/lang/String;[IIIIIIB[Lqda;III)I", line = 418)
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lha;Lkf;)V", line = 496)
    public class67(class66 arg0, class263 arg1) {
        this.field887 = arg1;
        this.field897 = arg0;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II[Lqda;ILjava/lang/String;I[II)V", line = 507)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IILjava/lang/String;IZI)V", line = 520)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IB[IILjava/lang/String;I[Lqda;Laa;I)V", line = 540)
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "(IIIILjava/lang/String;II)V", line = 689)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIBI)V", line = 718)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/lang/String;IIIII)V", line = 741)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 760)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILjava/lang/String;BIII)V", line = 836)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(B)V", line = 856)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([ILjava/util/Random;Ljava/lang/String;IIBIII[Lqda;)I", line = 867)
