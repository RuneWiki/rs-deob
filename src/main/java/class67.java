...
public class class67 {
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(II)Lhu;", line = 5)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(IIII)V", line = 38)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(ILoi;Loi;Lqd;)V", line = 106)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "([ILmt;JI)Ljava/lang/String;", line = 59)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(B)V", line = 82)
