...
public class class67 extends class51 {
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(III)V", line = 9)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(CB)Z", line = 19)
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 80)
    ...
    @OriginalMember(owner = "client!ra", name = "c", descriptor = "(III)V", line = 98)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(III)V", line = 108)
