...
public class class67 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IB)I", line = 3)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ZLqq;Llt;)V", line = 29)
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(B)Lra;", line = 161)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IIIIBLbl;Z[B)Ljs;", line = 183)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(BLra;)V", line = 208)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ILha;)Lmc;", line = 225)
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(I)V", line = 246)
    public class67(int arg0) {
        this.field1093 = arg0;
    }

    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(IIIIII)V", line = 256)
