...
public class class67 extends class180 {
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(II)Z", line = 15)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lag;Lag;I)V", line = 27)
    ...
    @OriginalMember(owner = "client!tc", name = "c", descriptor = "(I)I", line = 46)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(ILkm;Lji;ILfr;ILpc;I)V", line = 56)
    ...
    @OriginalMember(owner = "client!tc", name = "c", descriptor = "(B)I", line = 100)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(ZIII)I", line = 119)
    ...
    @OriginalMember(owner = "client!tc", name = "d", descriptor = "(B)Z", line = 143)
    ...
    @OriginalMember(owner = "client!tc", name = "d", descriptor = "(I)Z", line = 156)
    ...
    @OriginalMember(owner = "client!tc", name = "e", descriptor = "(B)Z", line = 166)
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "(II)V", line = 177)
