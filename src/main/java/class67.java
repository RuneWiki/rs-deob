...
@OriginalClass("client!YCBPJRVN")
public class class67 extends class5 implements Runnable {

    @OriginalMember(owner = "client!YCBPJRVN", name = "c", descriptor = "LPUBJBHOK;")
    private class42 field1499 = new class42(-591);

    @OriginalMember(owner = "client!YCBPJRVN", name = "e", descriptor = "LPUBJBHOK;")
    private class42 field1501 = new class42(-591);

    @OriginalMember(owner = "client!YCBPJRVN", name = "g", descriptor = "[[B")
    private byte[][] field1503 = new byte[4][];

    @OriginalMember(owner = "client!YCBPJRVN", name = "h", descriptor = "LPUBJBHOK;")
    private class42 field1504 = new class42(-591);

    @OriginalMember(owner = "client!YCBPJRVN", name = "i", descriptor = "[[I")
    private int[][] field1505 = new int[4][];

    @OriginalMember(owner = "client!YCBPJRVN", name = "j", descriptor = "Z")
    private boolean field1506 = true;

    @OriginalMember(owner = "client!YCBPJRVN", name = "l", descriptor = "Z")
    private boolean field1508 = false;

    @OriginalMember(owner = "client!YCBPJRVN", name = "n", descriptor = "[B")
    private byte[] field1510 = new byte[65000];

    @OriginalMember(owner = "client!YCBPJRVN", name = "p", descriptor = "LPUBJBHOK;")
    private class42 field1512 = new class42(-591);

    @OriginalMember(owner = "client!YCBPJRVN", name = "u", descriptor = "Z")
    private boolean field1517 = false;

    @OriginalMember(owner = "client!YCBPJRVN", name = "A", descriptor = "LPUBJBHOK;")
    private class42 field1523 = new class42(-591);

    @OriginalMember(owner = "client!YCBPJRVN", name = "B", descriptor = "LSYRXWHZM;")
    private class51 field1524 = new class51(false);

    @OriginalMember(owner = "client!YCBPJRVN", name = "C", descriptor = "Z")
    private boolean field1525 = false;

    @OriginalMember(owner = "client!YCBPJRVN", name = "D", descriptor = "I")
    private int field1526 = 8;

    @OriginalMember(owner = "client!YCBPJRVN", name = "F", descriptor = "I")
    private int field1528 = -929;

    @OriginalMember(owner = "client!YCBPJRVN", name = "H", descriptor = "[[I")
    private int[][] field1530 = new int[4][];

    @OriginalMember(owner = "client!YCBPJRVN", name = "M", descriptor = "[B")
    private byte[] field1535 = new byte[500];

    @OriginalMember(owner = "client!YCBPJRVN", name = "N", descriptor = "Ljava/util/zip/CRC32;")
    private CRC32 field1536 = new CRC32();

    @OriginalMember(owner = "client!YCBPJRVN", name = "R", descriptor = "Z")
    private boolean field1540 = true;

    @OriginalMember(owner = "client!YCBPJRVN", name = "S", descriptor = "Ljava/lang/String;")
    public String field1541 = "";

    @OriginalMember(owner = "client!YCBPJRVN", name = "T", descriptor = "Z")
    private boolean field1542 = true;

    @OriginalMember(owner = "client!YCBPJRVN", name = "f", descriptor = "I")
    private int field1502;

    @OriginalMember(owner = "client!YCBPJRVN", name = "k", descriptor = "I")
    private int field1507;

    @OriginalMember(owner = "client!YCBPJRVN", name = "q", descriptor = "I")
    public int field1513;

    @OriginalMember(owner = "client!YCBPJRVN", name = "t", descriptor = "I")
    private int field1516;

    @OriginalMember(owner = "client!YCBPJRVN", name = "v", descriptor = "I")
    private int field1518;

    @OriginalMember(owner = "client!YCBPJRVN", name = "w", descriptor = "I")
    private int field1519;

    @OriginalMember(owner = "client!YCBPJRVN", name = "z", descriptor = "I")
    public int field1522;

    @OriginalMember(owner = "client!YCBPJRVN", name = "G", descriptor = "I")
    private int field1529;

    @OriginalMember(owner = "client!YCBPJRVN", name = "I", descriptor = "I")
    private int field1531;

    @OriginalMember(owner = "client!YCBPJRVN", name = "O", descriptor = "I")
    private int field1537;

    @OriginalMember(owner = "client!YCBPJRVN", name = "P", descriptor = "I")
    private int field1538;

    @OriginalMember(owner = "client!YCBPJRVN", name = "Q", descriptor = "J")
    private long field1539;

    @OriginalMember(owner = "client!YCBPJRVN", name = "m", descriptor = "LJLWEKARN;")
    private class24 field1509;

    @OriginalMember(owner = "client!YCBPJRVN", name = "L", descriptor = "Lclient;")
    private client field1534;

    @OriginalMember(owner = "client!YCBPJRVN", name = "E", descriptor = "Ljava/io/InputStream;")
    private InputStream field1527;

    @OriginalMember(owner = "client!YCBPJRVN", name = "r", descriptor = "Ljava/io/OutputStream;")
    private OutputStream field1514;

    @OriginalMember(owner = "client!YCBPJRVN", name = "s", descriptor = "Ljava/net/Socket;")
    private Socket field1515;

    @OriginalMember(owner = "client!YCBPJRVN", name = "J", descriptor = "[B")
    private byte[] field1532;

    @OriginalMember(owner = "client!YCBPJRVN", name = "b", descriptor = "[I")
    ...
    @OriginalMember(owner = "client!YCBPJRVN", name = "x", descriptor = "[I")
    private int[] field1520;

    @OriginalMember(owner = "client!YCBPJRVN", name = "y", descriptor = "[I")
    private int[] field1521;

    @OriginalMember(owner = "client!YCBPJRVN", name = "K", descriptor = "[I")
    private int[] field1533;

    @OriginalMember(owner = "client!YCBPJRVN", name = "a", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!YCBPJRVN", name = "a", descriptor = "(IBIB)V")
    ...
    @OriginalMember(owner = "client!YCBPJRVN", name = "a", descriptor = "(IZ)V")
    ...
    @OriginalMember(owner = "client!YCBPJRVN", name = "a", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!YCBPJRVN", name = "b", descriptor = "(IZ)Z")
    ...
    @OriginalMember(owner = "client!YCBPJRVN", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!YCBPJRVN", name = "c", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!YCBPJRVN", name = "a", descriptor = "(IIIB)I")
    ...
    @OriginalMember(owner = "client!YCBPJRVN", name = "a", descriptor = "(LJLWEKARN;Z)V")
    ...
    @OriginalMember(owner = "client!YCBPJRVN", name = "run", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!YCBPJRVN", name = "a", descriptor = "(I)V")
    public final void method164(int arg0) {
        this.method533(0, arg0);
    }

    @OriginalMember(owner = "client!YCBPJRVN", name = "a", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!YCBPJRVN", name = "a", descriptor = "()LJLWEKARN;")
    ...
    @OriginalMember(owner = "client!YCBPJRVN", name = "b", descriptor = "(II)I")
    ...
    @OriginalMember(owner = "client!YCBPJRVN", name = "a", descriptor = "(LCXFTMSCH;Lclient;)V")
    ...
    @OriginalMember(owner = "client!YCBPJRVN", name = "d", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!YCBPJRVN", name = "b", descriptor = "()V")
    public final void method538() {
        this.field1540 = false;
    }

    @OriginalMember(owner = "client!YCBPJRVN", name = "a", descriptor = "([BIII)Z")
    ...
    @OriginalMember(owner = "client!YCBPJRVN", name = "c", descriptor = "(II)I")
    ...
    @OriginalMember(owner = "client!YCBPJRVN", name = "c", descriptor = "()I")
    ...
    @OriginalMember(owner = "client!YCBPJRVN", name = "c", descriptor = "(IZ)Z")
    ...
    @OriginalMember(owner = "client!YCBPJRVN", name = "b", descriptor = "(Z)I")
    ...
    @OriginalMember(owner = "client!YCBPJRVN", name = "e", descriptor = "(I)V")
