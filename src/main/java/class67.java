...
public class class67 extends class425 {
    ...
    public final void method771(int arg0, int arg1) {
        ...
        if (field1452 == null || field1452.length != this.field1454.length) {
            field1452 = new int[this.field1454.length];
        }
        int var3 = this.field1454.length;
        int var4 = arg0;
        int var5 = this.field1455 - 1;
        int var6 = this.field1455 * arg1;
        int var7 = var3 - 1;
        for (int var8 = 0; var8 < var3; var8 += this.field1455) {
            int var10 = var6 + var8 & var7;
            for (int var11 = 0; var11 < this.field1455; var11++) {
                int var12 = var8 + var11;
                int var13 = (var4 + var11 & var5) + var10;
                field1452[var12] = this.field1454[var13];
            }
        }
        int[] var9 = this.field1454;
        this.field1454 = field1452;
        field1452 = var9;
    }

    @OriginalMember(owner = "client!gea", name = "<init>", descriptor = "(II[IZ)V")
    public class67(int arg0, int arg1, int[] arg2, boolean arg3) {
        this.field1451 = arg0;
        this.field1455 = arg1;
        this.field1454 = arg2;
        if (arg3) {
            int[] var5 = new int[this.field1455];
            int[] var6 = new int[this.field1455];
            int[] var7 = new int[this.field1455];
            if (field1452 == null || field1452.length < this.field1454.length) {
                field1452 = new int[this.field1454.length];
            }
            ...
            for (int var15 = 2; var15 >= 0; var15--) {
                for (int var32 = var10; var32 >= 0; var32--) {
                    var13--;
                    int var33 = this.field1454[var13];
            ...
            for (int var17 = var11; var17 >= 0; var17--) {
                ...
                for (int var25 = var10; var25 >= 0; var25--) {
                    ...
                    int var31 = var22 / 9;
                    var16--;
                    field1452[var16] = var29 << 16 | var30 << 8 | var31;
                ...
                for (int var26 = var10; var26 >= 0; var26--) {
                    var13--;
                    int var27 = this.field1454[var13];
                    var14--;
                    int var28 = this.field1454[var14];
