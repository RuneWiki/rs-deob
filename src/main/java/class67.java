...
public abstract class class67 {
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(FFII)V")
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(FFFFIIIII)V")
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(FFFFIILud;II)V")
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(FFIILud;II)V")
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(FFIIIII)V")
    ...
    @OriginalMember(owner = "client!cq", name = "b", descriptor = "(IIII)V")
