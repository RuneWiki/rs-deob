...
public class class67 implements class687 {
    ...
    @OriginalMember(owner = "client!qh", name = "c", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(B)I", line = 48)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(ZJ)Z", line = 77)
    ...
    @OriginalMember(owner = "client!qh", name = "b", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "(Lsi;Lem;)V", line = 101)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(ZI)V", line = 119)
