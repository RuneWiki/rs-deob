...
public class class67 extends class5 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!rfa", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(II)Z", line = 95)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(B)Lnb;", line = 114)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(IIIC)V", line = 127)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 144)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(Z)V", line = 168)
    ...
    @OriginalMember(owner = "client!rfa", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 179)
    public final synchronized void keyReleased(KeyEvent arg0) {
        field877++;
        this.method404((byte) -99, arg0, 1);
    }

    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(I)V", line = 187)
    ...
    @OriginalMember(owner = "client!rfa", name = "d", descriptor = "(I)V", line = 198)
    ...
    @OriginalMember(owner = "client!rfa", name = "b", descriptor = "(B)I", line = 225)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(BLjava/awt/event/KeyEvent;I)V", line = 251)
    ...
    @OriginalMember(owner = "client!rfa", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 289)
    public final synchronized void keyPressed(KeyEvent arg0) {
        this.method404((byte) -5, arg0, 0);
        field875++;
    }

    @OriginalMember(owner = "client!rfa", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 297)
    ...
    @OriginalMember(owner = "client!rfa", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 311)
    public final void focusGained(FocusEvent arg0) {
        field873++;
    }

    @OriginalMember(owner = "client!rfa", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 346)
    public class67(Component arg0) {
        class343.method2167((byte) 72);
        this.method400(arg0, -11901);
    }

    @OriginalMember(owner = "client!rfa", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 333)
