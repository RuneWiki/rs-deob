...
public class class67 {
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(II)Lvaa;")
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(IIBLaa;IJIILria;)V")
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(III)Lim;")
    ...
    @OriginalMember(owner = "client!hia", name = "<init>", descriptor = "(Lal;ILnd;)V")
