...
public class class67 extends class766 {
    ...
    @OriginalMember(owner = "client!bd", name = "c", descriptor = "([III)V", line = 5)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Lst;)V", line = 15)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Ldba;Lst;)V", line = 28)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Lsia;)V", line = 38)
    public final synchronized void method590(class766 arg0) {
        arg0.method792((byte) -106);
    }

    @OriginalMember(owner = "client!bd", name = "b", descriptor = "()I", line = 44)
    public final int method591() {
        return 0;
    }

    @OriginalMember(owner = "client!bd", name = "d", descriptor = "()Lsia;", line = 48)
    public final class766 method592() {
        return (class766) this.field953.method2542(-106);
    }

    @OriginalMember(owner = "client!bd", name = "a", descriptor = "([III)V", line = 56)
    ...
    @OriginalMember(owner = "client!bd", name = "e", descriptor = "()I", line = 101)
    public final synchronized int method594() {
        return this.field953.method2538(41);
    }

    @OriginalMember(owner = "client!bd", name = "a", descriptor = "()Lsia;", line = 105)
    public final class766 method595() {
        return (class766) this.field953.method2551((byte) -108);
    }

    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(Lsia;)V", line = 181)
    public final synchronized void method598(class766 arg0) {
        this.field953.method2550(0, arg0);
    }

    @OriginalMember(owner = "client!bd", name = "f", descriptor = "()V", line = 192)
