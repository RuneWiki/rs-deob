...
@OriginalClass("client!VQRBOQUI")
public class class67 {

    @OriginalMember(owner = "client!VQRBOQUI", name = "a", descriptor = "Z")
    private boolean field1677 = false;

    @OriginalMember(owner = "client!VQRBOQUI", name = "b", descriptor = "I")
    private int field1678 = 7;

    @OriginalMember(owner = "client!VQRBOQUI", name = "c", descriptor = "Z")
    private boolean field1679 = true;

    @OriginalMember(owner = "client!VQRBOQUI", name = "d", descriptor = "I")
    private int field1680;

    @OriginalMember(owner = "client!VQRBOQUI", name = "g", descriptor = "I")
    public int field1683;

    @OriginalMember(owner = "client!VQRBOQUI", name = "h", descriptor = "I")
    public int field1684;

    @OriginalMember(owner = "client!VQRBOQUI", name = "i", descriptor = "I")
    public int field1685;

    @OriginalMember(owner = "client!VQRBOQUI", name = "j", descriptor = "I")
    private int field1686;

    @OriginalMember(owner = "client!VQRBOQUI", name = "k", descriptor = "I")
    private int field1687;

    @OriginalMember(owner = "client!VQRBOQUI", name = "l", descriptor = "I")
    private int field1688;

    @OriginalMember(owner = "client!VQRBOQUI", name = "m", descriptor = "I")
    private int field1689;

    @OriginalMember(owner = "client!VQRBOQUI", name = "n", descriptor = "I")
    private int field1690;

    @OriginalMember(owner = "client!VQRBOQUI", name = "o", descriptor = "I")
    public static int field1691;

    @OriginalMember(owner = "client!VQRBOQUI", name = "e", descriptor = "[I")
    private int[] field1681;

    @OriginalMember(owner = "client!VQRBOQUI", name = "f", descriptor = "[I")
    private int[] field1682;

    @OriginalMember(owner = "client!VQRBOQUI", name = "a", descriptor = "(BLCKBTFRZM;)V")
    ...
    @OriginalMember(owner = "client!VQRBOQUI", name = "a", descriptor = "(ILCKBTFRZM;)V")
    ...
    @OriginalMember(owner = "client!VQRBOQUI", name = "a", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!VQRBOQUI", name = "a", descriptor = "(ZI)I")
