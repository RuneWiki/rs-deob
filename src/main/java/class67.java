...
public class class67 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(ZII)I", line = 23)
    ...
    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!dc", name = "c", descriptor = "(I)Ldc;", line = 88)
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(I)V", line = 131)
    public class67(int arg0) {
        this.field881 = arg0;
    }

    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(IIIIII)V", line = 138)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Ldc;I)V", line = 111)
