...
public class class67 {
    ...
    @OriginalMember(owner = "client!gg", name = "n", descriptor = "Lsh;")
    public static class174 field1309;

    @OriginalMember(owner = "client!gg", name = "j", descriptor = "Lbg;")
    public static class18 field1305;

    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ILlf;Llf;Llf;)V")
