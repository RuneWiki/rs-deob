...
public class class67 extends class127 implements class240 {
    ...
    @OriginalMember(owner = "client!k", name = "t", descriptor = "(IIIIII)V", line = 4)
    public final void method298(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!k", name = "finalize", descriptor = "()V", line = 16)
    protected final void finalize() {
        class371.method2212((byte) -72, this);
    }

    @OriginalMember(owner = "client!k", name = "a", descriptor = "(IILma;II)V", line = 20)
    public final void method294(int arg0, int arg1, class249 arg2, int arg3, int arg4) {
        this.method466(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!k", name = "BA", descriptor = "(III)V", line = 26)
    public final void method295(int arg0, int arg1, int arg2) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!k", name = "<init>", descriptor = "(Lqa;Lna;[I[BIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!k", name = "b", descriptor = "(FFFFFFLma;II)V", line = 34)
