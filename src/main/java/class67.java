...
public class class67 implements class21 {
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(B)Los;", line = 20)
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "(ILrt;Lcp;IIIIIIIZ)V", line = 35)
    ...
    @OriginalMember(owner = "client!oi", name = "b", descriptor = "(B)V", line = 53)
