...
public class class67 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!jt", name = "b", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!jt", name = "b", descriptor = "(I)V", line = 57)
