...
public class class67 extends class68 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Lya;J[Lew;[Lfs;Z)V")
    ...
    @OriginalMember(owner = "client!hk", name = "d", descriptor = "()Lfm;")
    public final class517 method594() {
        return this.field872;
    }

    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Lya;J)Z")
    ...
    @OriginalMember(owner = "client!hk", name = "f", descriptor = "()V")
    public static void method597() {
        field859 = null;
        field862 = null;
    }

    @OriginalMember(owner = "client!hk", name = "a", descriptor = "([Lfs;Z)V")
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Lya;[Lew;Z)V")
