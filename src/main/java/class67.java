...
public class class67 extends class238 {
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lur;IIIZ[I)V", line = 6)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lur;IIII[I)V", line = 29)
    ...
    @OriginalMember(owner = "client!al", name = "b", descriptor = "(II)V", line = 49)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lur;IIIIIZ)V", line = 76)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lur;IIIII[BI)V", line = 98)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lur;IIIIZ[BI)V", line = 113)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lur;IIIIIIZ)V", line = 134)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Z)V", line = 153)
