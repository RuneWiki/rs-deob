...
public class class67 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IBI)Lgea;", line = 5)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(BLjava/lang/String;)V", line = 29)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(I)V", line = 143)
