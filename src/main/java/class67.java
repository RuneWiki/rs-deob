...
public class class67 {
    ...
    @OriginalMember(owner = "client!VSLUEINI", name = "b", descriptor = "[LVSLUEINI;")
    public static class67[] field1619;

    @OriginalMember(owner = "client!VSLUEINI", name = "a", descriptor = "(ILQKFGLETG;)V")
    ...
    @OriginalMember(owner = "client!VSLUEINI", name = "a", descriptor = "(LXJCNBMKS;II)V")
