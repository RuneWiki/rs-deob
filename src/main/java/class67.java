...
public class class67 extends class436 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IZ)V", line = 11)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Z)V", line = 80)
    ...
    @OriginalMember(owner = "client!hh", name = "f", descriptor = "(I)Z", line = 92)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IILeb;)V", line = 112)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IIILkq;Ljava/awt/Component;)Lwe;", line = 147)
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "()V", line = 1246)
    public class67() {
        super(1, false);
    }

    @OriginalMember(owner = "client!hh", name = "g", descriptor = "(I)V", line = 239)
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(Z)V", line = 271)
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(II)[[I", line = 1256)
