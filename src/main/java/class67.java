...
public class class67 extends class120 {
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lda;IIIZ[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Lgh;I)Ljava/lang/String;", line = 24)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lda;IIIIZ[BI)V", line = 50)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lda;IIIII[BI)V", line = 71)
    ...
    @OriginalMember(owner = "client!al", name = "d", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lda;IIIIIIZ)V", line = 109)
    ...
    @OriginalMember(owner = "client!al", name = "e", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lda;IIIIIZ)V", line = 145)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lda;IIII[I)V", line = 169)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(IBI)V", line = 183)
