...
public class class67 {
    ...
    @OriginalMember(owner = "client!XNCSKJMM", name = "d", descriptor = "LXNCSKJMM;")
    public class67 field1666;

    @OriginalMember(owner = "client!XNCSKJMM", name = "e", descriptor = "LXNCSKJMM;")
    public class67 field1667;

    @OriginalMember(owner = "client!XNCSKJMM", name = "f", descriptor = "Z")
