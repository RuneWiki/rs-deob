...
public class class67 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(ZLjava/lang/String;ILgt;)Llf;")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Lfp;ILkg;II)V")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Lct;Lct;Lrs;B)V")
