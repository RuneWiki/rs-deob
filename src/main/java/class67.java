...
public class class67 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IBI)V", line = 10)
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(IBI)V", line = 27)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IIB)V", line = 42)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IIIIIIZI)Z", line = 58)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(I)V", line = 434)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IIII)V", line = 450)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IIZIIIZ)V", line = 467)
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(IIB)V", line = 772)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IIIZIZII)V", line = 785)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ZIZIIII)V", line = 840)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IBIIIIIIII)Z", line = 1147)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Ljava/lang/String;B)J", line = 1240)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IIIIIIII)Z", line = 1290)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ZZIIIII)V", line = 1478)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IIIIBIIII)Z", line = 1524)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ZIII)V", line = 1576)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(B)V", line = 1589)
