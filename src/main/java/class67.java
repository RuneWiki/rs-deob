...
public class class67 {
    ...
    @OriginalMember(owner = "client!rba", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field817++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(IBI)I", line = 22)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(BI)V", line = 39)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(I)V", line = 53)
