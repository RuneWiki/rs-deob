...
public class class67 extends class47 implements Runnable {
    ...
    @OriginalMember(owner = "client!VCPXACGS", name = "b", descriptor = "LOUZUCGGU;")
    ...
    @OriginalMember(owner = "client!VCPXACGS", name = "u", descriptor = "LOUZUCGGU;")
    ...
    @OriginalMember(owner = "client!VCPXACGS", name = "z", descriptor = "LBOZWYCIO;")
    ...
    @OriginalMember(owner = "client!VCPXACGS", name = "K", descriptor = "LOUZUCGGU;")
    private class48 field1687 = new class48(-392);

    @OriginalMember(owner = "client!VCPXACGS", name = "L", descriptor = "LOUZUCGGU;")
    ...
    @OriginalMember(owner = "client!VCPXACGS", name = "T", descriptor = "LOUZUCGGU;")
    ...
    @OriginalMember(owner = "client!VCPXACGS", name = "A", descriptor = "LLMSXRUPQ;")
    private class37 field1677;

    @OriginalMember(owner = "client!VCPXACGS", name = "V", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!VCPXACGS", name = "a", descriptor = "(ILLMSXRUPQ;)V")
    ...
    @OriginalMember(owner = "client!VCPXACGS", name = "a", descriptor = "(LHRXSNEYZ;Lclient;)V")
