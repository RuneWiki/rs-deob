...
public class class67 implements class194 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Lxa;BIZ)Le;", line = 19)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "()V", line = 78)
    public final void method446() {
        this.field961 = null;
        this.method443();
    }

    @OriginalMember(owner = "client!k", name = "b", descriptor = "()V", line = 83)
