...
public class class67 {
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Z)Z", line = 7)
    ...
    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(Lpj;)V", line = 108)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(B)Z", line = 163)
