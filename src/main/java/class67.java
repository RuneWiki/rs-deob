...
public abstract class class67 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II[Lhh;[IIBLjava/lang/String;IIILaa;IIIII)I", line = 5)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II[I[Lhh;IIILjava/lang/String;)V", line = 15)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/lang/String;IIIIII)V", line = 32)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIBIILjava/lang/String;)V", line = 64)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/lang/String;[IIBIIILjava/util/Random;[Lhh;I)I", line = 107)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I[IIILjava/util/Random;IZ[I[Lhh;IILjava/lang/String;III)I", line = 145)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ZI[IIII[Lhh;Laa;Ljava/lang/String;)V", line = 223)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Lhh;Ljava/lang/String;I[IIB[I[I)V", line = 371)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(III)V", line = 535)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IILjava/lang/String;)V", line = 554)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIILjava/lang/String;IZ)V", line = 598)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IC)Z", line = 611)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIILjava/lang/String;I[IIIIII[Lhh;IIILaa;)I", line = 632)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIIILjava/lang/String;)V", line = 731)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIILjava/lang/String;III)V", line = 761)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(BLjava/lang/String;)V", line = 791)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I)V", line = 866)
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lha;Leb;)V", line = 883)
