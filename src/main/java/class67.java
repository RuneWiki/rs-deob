...
public abstract class class67 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIB[Lfs;ILjava/lang/String;I[IIILaa;II)I")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([ILaa;IIIIILjava/lang/String;[Lfs;)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lib;II)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/util/Random;Ljava/lang/String;Z[IIIII[Lfs;I)I")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILjava/lang/String;[I[Lfs;IIII)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([I[IIIILjava/lang/String;[I[Lfs;)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([IIIILjava/lang/String;IIIIII[Lfs;Ljava/util/Random;I[I)I")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Lfs;IIILjava/lang/String;IIIIIIIIIILaa;[I)I")
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lha;Llq;)V")
