...
public class class67 extends class65 {
    ...
    @OriginalMember(owner = "client!hk", name = "t", descriptor = "(I)[Lbg;")
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Lya;B)V")
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Llh;I)V")
