...
public class class67 extends class293 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "([Lrda;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(II)V", line = 43)
    ...
    @OriginalMember(owner = "client!dl", name = "wa", descriptor = "(Lr;IIIIZ)V", line = 51)
    ...
    @OriginalMember(owner = "client!dl", name = "YA", descriptor = "()V", line = 69)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(III[[ZZII)V", line = 648)
    ...
    @OriginalMember(owner = "client!dl", name = "b", descriptor = "(I)V", line = 666)
    ...
    @OriginalMember(owner = "client!dl", name = "U", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 679)
    ...
    @OriginalMember(owner = "client!dl", name = "ka", descriptor = "(III)V", line = 761)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(B)V", line = 774)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(BIIIII[[ZZ)V", line = 789)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Lor;III)V", line = 932)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IIIIIII[[Z)V", line = 991)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(III[[ZZI)V", line = 1162)
    ...
    @OriginalMember(owner = "client!dl", name = "fa", descriptor = "(IILr;)Lr;", line = 1175)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Lih;[I)V", line = 1203)
    ...
    @OriginalMember(owner = "client!dl", name = "CA", descriptor = "(Lr;IIIIZ)V", line = 1213)
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(Lvf;IIII[[I[[II)V", line = 1233)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 1298)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Lr;IIIIZ)Z", line = 1384)
