...
public class class67 extends class252 {
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(III)V", line = 16)
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "(IIIIIII)V", line = 35)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(III)V", line = 53)
    ...
    @OriginalMember(owner = "client!sd", name = "c", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ZII)V", line = 91)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(BII)Z", line = 104)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IZZ)V", line = 118)
