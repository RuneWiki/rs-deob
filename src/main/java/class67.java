...
public class class67 extends class339 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Llr;FLlr;I)Z")
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(B)Llr;")
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(Lbv;I)V")
