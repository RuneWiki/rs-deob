...
public class class67 {
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Ljava/lang/String;ZLjava/lang/String;Ljava/lang/String;)Ljava/lang/String;", line = 23)
