...
@OriginalClass("client!YRQDGGKN")
public class class67 extends class53 {

    @OriginalMember(owner = "client!YRQDGGKN", name = "l", descriptor = "B")
    private byte field1605 = 0;

    @OriginalMember(owner = "client!YRQDGGKN", name = "q", descriptor = "Z")
    public boolean field1610 = false;

    @OriginalMember(owner = "client!YRQDGGKN", name = "r", descriptor = "I")
    private int field1611 = -15;

    @OriginalMember(owner = "client!YRQDGGKN", name = "A", descriptor = "LFPSNPMMW;")
    private class17 field1620;

    @OriginalMember(owner = "client!YRQDGGKN", name = "I", descriptor = "I")
    public int field1628;

    @OriginalMember(owner = "client!YRQDGGKN", name = "E", descriptor = "I")
    public int field1624;

    @OriginalMember(owner = "client!YRQDGGKN", name = "F", descriptor = "I")
    public int field1625;

    @OriginalMember(owner = "client!YRQDGGKN", name = "G", descriptor = "I")
    public int field1626;

    @OriginalMember(owner = "client!YRQDGGKN", name = "s", descriptor = "I")
    public int field1612;

    @OriginalMember(owner = "client!YRQDGGKN", name = "t", descriptor = "I")
    public int field1613;

    @OriginalMember(owner = "client!YRQDGGKN", name = "J", descriptor = "I")
    public int field1629;

    @OriginalMember(owner = "client!YRQDGGKN", name = "K", descriptor = "I")
    public int field1630;

    @OriginalMember(owner = "client!YRQDGGKN", name = "L", descriptor = "I")
    public int field1631;

    @OriginalMember(owner = "client!YRQDGGKN", name = "H", descriptor = "I")
    public int field1627;

    @OriginalMember(owner = "client!YRQDGGKN", name = "m", descriptor = "D")
    private double field1606;

    @OriginalMember(owner = "client!YRQDGGKN", name = "n", descriptor = "D")
    private double field1607;

    @OriginalMember(owner = "client!YRQDGGKN", name = "o", descriptor = "D")
    private double field1608;

    @OriginalMember(owner = "client!YRQDGGKN", name = "p", descriptor = "D")
    private double field1609;

    @OriginalMember(owner = "client!YRQDGGKN", name = "x", descriptor = "D")
    public double field1617;

    @OriginalMember(owner = "client!YRQDGGKN", name = "y", descriptor = "D")
    public double field1618;

    @OriginalMember(owner = "client!YRQDGGKN", name = "z", descriptor = "D")
    public double field1619;

    @OriginalMember(owner = "client!YRQDGGKN", name = "B", descriptor = "D")
    private double field1621;

    @OriginalMember(owner = "client!YRQDGGKN", name = "u", descriptor = "I")
    private int field1614;

    @OriginalMember(owner = "client!YRQDGGKN", name = "v", descriptor = "I")
    private int field1615;

    @OriginalMember(owner = "client!YRQDGGKN", name = "w", descriptor = "I")
    private int field1616;

    @OriginalMember(owner = "client!YRQDGGKN", name = "C", descriptor = "I")
    public int field1622;

    @OriginalMember(owner = "client!YRQDGGKN", name = "D", descriptor = "I")
    public int field1623;

    @OriginalMember(owner = "client!YRQDGGKN", name = "a", descriptor = "(IIZII)V")
    ...
    @OriginalMember(owner = "client!YRQDGGKN", name = "<init>", descriptor = "(IIIIIIIIIIBI)V")
    ...
    @OriginalMember(owner = "client!YRQDGGKN", name = "a", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!YRQDGGKN", name = "a", descriptor = "(Z)LITSMSHJO;")
