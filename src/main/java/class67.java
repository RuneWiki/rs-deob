...
public class class67 extends class58 {
    ...
    @OriginalMember(owner = "client!ZLSEKGJR", name = "sb", descriptor = "LGALAVQEJ;")
    ...
    @OriginalMember(owner = "client!ZLSEKGJR", name = "c", descriptor = "(I)LCSGBDGDY;")
    ...
    @OriginalMember(owner = "client!ZLSEKGJR", name = "a", descriptor = "(Z)LCSGBDGDY;")
