...
public class class67 {
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(JZ)Lob;", line = 15)
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(B)Lob;", line = 48)
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(JLob;B)V", line = 88)
    ...
    @OriginalMember(owner = "client!vha", name = "b", descriptor = "(B)V", line = 112)
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(IIIILuu;ZJ)V", line = 127)
    ...
    @OriginalMember(owner = "client!vha", name = "<init>", descriptor = "(I)V", line = 146)
