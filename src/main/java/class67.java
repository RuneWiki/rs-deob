...
public class class67 extends class184 {
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(IZ)V", line = 18)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Liia;ZI)V", line = 37)
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "(Loea;)V", line = 78)
    ...
    @OriginalMember(owner = "client!qh", name = "b", descriptor = "(B)V", line = 106)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Z)V", line = 135)
    ...
    @OriginalMember(owner = "client!qh", name = "b", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(ZI)V", line = 182)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(IIZ)V", line = 200)
    ...
    @OriginalMember(owner = "client!qh", name = "c", descriptor = "(B)V", line = 212)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Lgs;[Lbh;)V", line = 294)
    ...
    @OriginalMember(owner = "client!qh", name = "d", descriptor = "(B)V", line = 366)
