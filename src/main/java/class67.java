...
public class class67 extends class440 {
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(Lda;IILrk;IIIIIIILr;II)Lda;", line = 5)
    ...
    @OriginalMember(owner = "client!gea", name = "g", descriptor = "(I)V", line = 171)
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(IIIII)I", line = 187)
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(BI)[I", line = 212)
    ...
    @OriginalMember(owner = "client!gea", name = "<init>", descriptor = "()V", line = 297)
    public class67() {
        super(0, true);
    }

    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(ILmo;I)V", line = 303)
