...
public class class67 {
    ...
    @OriginalMember(owner = "client!VZMNLGCR", name = "a", descriptor = "(LXGRGMPUQ;ZLLAQKYZGL;)V")
    ...
    @OriginalMember(owner = "client!VZMNLGCR", name = "a", descriptor = "([BI[LGQSCEHQI;ILYDQEOBYY;IIIIII)V")
    ...
    @OriginalMember(owner = "client!VZMNLGCR", name = "a", descriptor = "([LGQSCEHQI;IIBI[BI)V")
    ...
    @OriginalMember(owner = "client!VZMNLGCR", name = "a", descriptor = "([LGQSCEHQI;LYDQEOBYY;B)V")
    ...
    @OriginalMember(owner = "client!VZMNLGCR", name = "a", descriptor = "(LGQSCEHQI;IIIILYDQEOBYY;III)V")
    ...
    @OriginalMember(owner = "client!VZMNLGCR", name = "a", descriptor = "(III[BIIIZI[LGQSCEHQI;)V")
    ...
    @OriginalMember(owner = "client!VZMNLGCR", name = "a", descriptor = "(IIIIIZLYDQEOBYY;LGQSCEHQI;I[[[II)V")
    ...
    @OriginalMember(owner = "client!VZMNLGCR", name = "a", descriptor = "(I[LGQSCEHQI;I[BBLYDQEOBYY;)V")
    ...
    @OriginalMember(owner = "client!VZMNLGCR", name = "a", descriptor = "(IIIILXGRGMPUQ;III)V")
