...
public class class67 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IB)Lsda;", line = 19)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IZ)V", line = 56)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IIB)V", line = 105)
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Ljk;ILae;Lae;)V", line = 132)
