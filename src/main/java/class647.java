...
public class class647 extends class268 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(III)V", line = 14)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "([Lwea;II)V", line = 46)
    ...
    @OriginalMember(owner = "client!tl", name = "e", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ZIB)V", line = 99)
    ...
    @OriginalMember(owner = "client!tl", name = "f", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IIB)Z", line = 158)
    ...
    @OriginalMember(owner = "client!tl", name = "<init>", descriptor = "(IIIIIFFF)V", line = 177)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IILwp;Lpu;Lwc;III)V", line = 188)
    ...
    @OriginalMember(owner = "client!tl", name = "d", descriptor = "(I)V", line = 288)
    ...
    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(I)V", line = 301)
