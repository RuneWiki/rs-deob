...
public class class647 extends class577 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "([[ZIIIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(ZI)I", line = 73)
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Z[[[BIBIIZ)V", line = 288)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IIBIIII)V", line = 589)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(BS)V", line = 777)
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(Lpj;Lmf;Lqm;[I)V", line = 799)
