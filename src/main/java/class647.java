...
public class class647 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lbo;JI)V")
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(I)Lbo;")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(JI)Lbo;")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lwk;B)V")
