...
public class class647 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Leh;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Loa;Lgba;III)V", line = 28)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(I)V", line = 359)
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(I)V", line = 381)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 396)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Leh;II)V", line = 469)
