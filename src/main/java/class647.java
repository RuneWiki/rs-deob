...
public class class647 extends class176 {
    ...
    @OriginalMember(owner = "client!mka", name = "x", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!mka", name = "a", descriptor = "(ILwq;)V")
    ...
    @OriginalMember(owner = "client!mka", name = "a", descriptor = "(ILrv;)V")
    ...
    @OriginalMember(owner = "client!mka", name = "a", descriptor = "(Laa;IILmj;IIILjava/lang/String;Lkaa;ILda;Z)V")
