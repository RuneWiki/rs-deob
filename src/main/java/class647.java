...
public class class647 {
    ...
    @OriginalMember(owner = "client!hg", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field8753++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(BLrr;)V", line = 30)
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "(I)V", line = 69)
