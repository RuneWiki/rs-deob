...
public class class647 extends class252 {
    ...
    @OriginalMember(owner = "client!sea", name = "h", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(Lbd;[[BB)V", line = 13)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(ILvg;BI)V", line = 88)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(Z)V", line = 112)
    ...
    @OriginalMember(owner = "client!sea", name = "b", descriptor = "(ZI)V", line = 123)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(ZI)V", line = 134)
    ...
    @OriginalMember(owner = "client!sea", name = "<init>", descriptor = "(Lhea;)V", line = 145)
    public class647(class387 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(II)I", line = 153)
    ...
    @OriginalMember(owner = "client!sea", name = "e", descriptor = "(I)Z", line = 263)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(Lbb;II)V", line = 276)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(III)V", line = 288)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(Llt;Lr;ILsp;)V", line = 298)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(Lmo;I)Lqb;", line = 449)
