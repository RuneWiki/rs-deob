...
public class class647 {
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(ILr;)Lf;", line = 5)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(ILjava/lang/String;I)Ljava/lang/String;", line = 33)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(Lhaa;Z)Z", line = 54)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(ILes;B)V", line = 94)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(ILr;Z)Lf;", line = 256)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(ILes;)V", line = 298)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(I)V", line = 365)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(IIIIII)V", line = 419)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(BII)I", line = 537)
