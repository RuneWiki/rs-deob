...
public class class647 extends class173 {
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Lmc;Z)V")
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(IILmc;)V")
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(B)Lrha;")
