...
public class class647 implements class401 {
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(I[BI)[B", line = 48)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(IB)[B", line = 75)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(B)Lio;", line = 123)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(ILvd;I)Lhia;", line = 133)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(Lns;IIII)V", line = 155)
    ...
    @OriginalMember(owner = "client!lca", name = "b", descriptor = "(I)V", line = 322)
    ...
    @OriginalMember(owner = "client!lca", name = "<init>", descriptor = "(Ljava/lang/String;Log;Lega;IIIIIIIIII)V", line = 332)
