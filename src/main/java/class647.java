...
public class class647 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(BI)I", line = 5)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!dd", name = "toString", descriptor = "()Ljava/lang/String;", line = 29)
    public final String toString() {
        field9180++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 39)
    public class647(String arg0, int arg1) {
        this.field9177 = arg0;
        this.field9181 = arg1;
    }

    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ZI)V", line = 48)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IIIIII)Z", line = 66)
