...
public class class647 extends class49 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(ILjava/lang/String;)I", line = 20)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(BB)Z", line = 41)
    ...
    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(B)Ljava/lang/String;", line = 69)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(BII)I", line = 99)
    ...
    @OriginalMember(owner = "client!pk", name = "d", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IILgga;)V", line = 142)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "([ILgga;I)V", line = 217)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(BLgga;)V", line = 243)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IB)Lo;", line = 271)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(ILgga;)Ljava/lang/String;", line = 285)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IIIII)V", line = 316)
    ...
    @OriginalMember(owner = "client!pk", name = "g", descriptor = "(I)I", line = 369)
