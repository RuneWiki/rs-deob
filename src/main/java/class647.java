...
public class class647 extends class497 {
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(BI)I", line = 17)
    ...
    @OriginalMember(owner = "client!oea", name = "<init>", descriptor = "(ILpp;)V", line = 34)
    public class647(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!oea", name = "d", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!oea", name = "c", descriptor = "(I)Z", line = 48)
    ...
    @OriginalMember(owner = "client!oea", name = "e", descriptor = "(I)Z", line = 63)
    ...
    @OriginalMember(owner = "client!oea", name = "b", descriptor = "(I)I", line = 74)
    ...
    @OriginalMember(owner = "client!oea", name = "<init>", descriptor = "(Lpp;)V", line = 91)
    public class647(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!oea", name = "b", descriptor = "(B)V", line = 94)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(I)I", line = 121)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(B)V", line = 143)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(BZ)V", line = 166)
