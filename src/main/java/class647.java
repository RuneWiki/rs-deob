...
public class class647 implements Runnable {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IIB)Z", line = 6)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(I)Ljava/lang/String;", line = 17)
    ...
    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(I)J", line = 32)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Lnc;JILjava/lang/String;I)V", line = 45)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Lsn;I)V", line = 60)
    ...
    @OriginalMember(owner = "client!tl", name = "run", descriptor = "()V", line = 73)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(B)I", line = 199)
    ...
    @OriginalMember(owner = "client!tl", name = "c", descriptor = "(I)V", line = 225)
    ...
    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(B)V", line = 235)
    ...
    @OriginalMember(owner = "client!tl", name = "c", descriptor = "(B)V", line = 253)
    ...
    @OriginalMember(owner = "client!tl", name = "d", descriptor = "(I)Z", line = 266)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IIII)V", line = 277)
    ...
    @OriginalMember(owner = "client!tl", name = "d", descriptor = "(B)I", line = 307)
    ...
    @OriginalMember(owner = "client!tl", name = "e", descriptor = "(B)Lnc;", line = 318)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(II)Z", line = 337)
    ...
    @OriginalMember(owner = "client!tl", name = "e", descriptor = "(I)I", line = 393)
