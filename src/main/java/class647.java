...
public class class647 extends class284 {
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(Z)J", line = 3)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(IJ)I", line = 20)
    ...
    @OriginalMember(owner = "client!lv", name = "b", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!lv", name = "b", descriptor = "(B)J", line = 66)
    ...
    @OriginalMember(owner = "client!lv", name = "<init>", descriptor = "()V", line = 116)
    public class647() {
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(I)J", line = 103)
