...
public class class647 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ILgj;ZLgj;)V", line = 4)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ZI)Ldv;", line = 21)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(B)V", line = 53)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IIILjia;Lha;)V", line = 63)
    ...
    @OriginalMember(owner = "client!tl", name = "<init>", descriptor = "(Lim;ILgj;)V", line = 106)
