...
public class class647 extends class751 {
    ...
    @OriginalMember(owner = "client!sk", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!sk", name = "<init>", descriptor = "()V", line = 393)
    public class647() {
        super(0, true);
    }

    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(II)V", line = 396)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ILmja;IIIIIIIII)Z", line = 414)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IZI)I", line = 765)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(II)[I", line = 781)
