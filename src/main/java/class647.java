...
public class class647 {
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(II)Lvea;")
    public final class647 method3735(int arg0, int arg1) {
        field9328++;
        return arg0 == 1 ? new class647(this.field9324, arg1) : null;
    }

    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(I)Lhl;")
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(BLsl;)Ldw;")
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(Leg;I)Leg;")
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!vea", name = "b", descriptor = "(II)Lnca;")
