...
public class class647 extends class496 {
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(IB)Z", line = 5)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(III)I", line = 23)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!tba", name = "<init>", descriptor = "()V", line = 72)
    public class647() {
    }

    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(BII)Z", line = 75)
    ...
    @OriginalMember(owner = "client!tba", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 85)
