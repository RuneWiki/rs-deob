...
public class class647 extends class3 {
    ...
    @OriginalMember(owner = "client!fia", name = "d", descriptor = "()Lua;")
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(III[IILve;)V")
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(IILve;)V")
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "()Lua;")
    ...
    @OriginalMember(owner = "client!fia", name = "<init>", descriptor = "(Lqc;)V")
