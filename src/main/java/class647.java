...
public class class647 extends class478 {
    ...
    @OriginalMember(owner = "client!cfa", name = "c", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(ZI)[[I", line = 18)
    ...
    @OriginalMember(owner = "client!cfa", name = "c", descriptor = "(III)Z", line = 81)
    ...
    @OriginalMember(owner = "client!cfa", name = "<init>", descriptor = "()V", line = 94)
    public class647() {
        super(1, false);
    }

    @OriginalMember(owner = "client!cfa", name = "b", descriptor = "(BLjava/lang/String;)V", line = 101)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(ILnp;I)V", line = 211)
