...
public class class364 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Ljava/awt/Component;IBLec;I)Lwd;", line = 18)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Z)Z", line = 108)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IILkh;IBII)V", line = 217)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(BLjava/lang/String;)V", line = 229)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(III[B[BIIII)V", line = 241)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(CLjava/lang/String;Z)I", line = 285)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I[[I)V", line = 325)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Ldr;I)I", line = 335)
