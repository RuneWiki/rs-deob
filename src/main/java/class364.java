...
public class class364 extends class719 {
    ...
    @OriginalMember(owner = "client!ija", name = "g", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(III)V", line = 48)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(ZZ)V", line = 66)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(IZ)V", line = 77)
    ...
    @OriginalMember(owner = "client!ija", name = "<init>", descriptor = "(Lee;)V", line = 121)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(IB)V", line = 235)
    ...
    @OriginalMember(owner = "client!ija", name = "b", descriptor = "(B)Z", line = 254)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(ZLb;I)V", line = 270)
