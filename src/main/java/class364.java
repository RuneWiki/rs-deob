...
public class class364 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Ljava/lang/String;BIZ)I", line = 5)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIIIIII)V", line = 92)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Lfh;ILtk;Lqa;)V", line = 140)
