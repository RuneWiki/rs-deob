...
public abstract class class364 extends class68 {
    ...
    @OriginalMember(owner = "client!lh", name = "d", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIILjava/lang/String;[BI)I", line = 20)
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(IIII)V", line = 171)
