...
public class class364 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(I)Lfaa;", line = 3)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(BLfaa;)V", line = 24)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Ljava/awt/Color;ILjava/awt/Color;Ljava/awt/Color;ILjava/lang/String;)V", line = 45)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILki;)V", line = 135)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(B)V", line = 149)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(B)Lfaa;", line = 170)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lfaa;I)V", line = 194)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(I)Lfaa;", line = 213)
    ...
    @OriginalMember(owner = "client!ki", name = "c", descriptor = "(B)V", line = 243)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Z)Lfaa;", line = 254)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lfaa;ILki;)V", line = 278)
    ...
    @OriginalMember(owner = "client!ki", name = "d", descriptor = "(B)Lfaa;", line = 302)
    ...
    @OriginalMember(owner = "client!ki", name = "c", descriptor = "(I)Z", line = 328)
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "()V", line = 364)
    public class364() {
        this.field4702.field5500 = this.field4702;
        this.field4702.field5497 = this.field4702;
    }

    @OriginalMember(owner = "client!ki", name = "e", descriptor = "(B)I", line = 343)
