...
public class class364 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(I[II)Lcj;", line = 9)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(III[I)Lcj;", line = 27)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(I[IBI)Lcj;", line = 71)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Z)V", line = 107)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(B[S)[S", line = 117)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IB)V", line = 141)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "([[[Lrb;B)V", line = 153)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ILtj;ZILtj;BZ)I", line = 227)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "([IZI)Lcj;", line = 270)
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "(Loi;Loi;)V", line = 303)
