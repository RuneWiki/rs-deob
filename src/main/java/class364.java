...
public abstract class class364 extends class22 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ILbg;B)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IZIIFIIZ)[I", line = 34)
    ...
    @OriginalMember(owner = "client!qo", name = "f", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Luo;IIIZBLpc;)V", line = 76)
    ...
    @OriginalMember(owner = "client!qo", name = "d", descriptor = "(I)Z", line = 88)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Z)V", line = 108)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(IIIIIII)V", line = 126)
