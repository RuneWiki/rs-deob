...
public class class364 extends class431 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(II)I", line = 7)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(IIIII)I", line = 42)
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "()V", line = 62)
    public class364() {
    }

    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 64)
