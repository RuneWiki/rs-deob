...
public class class364 extends class517 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(IILwg;IIIIIIII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(Luca;IIZ[[BI)V", line = 360)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(B)V", line = 379)
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(Luca;IIZ[[I)V", line = 393)
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(Luca;II)V", line = 424)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(IBIII)V", line = 445)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(IIB)Z", line = 463)
    ...
    @OriginalMember(owner = "client!eg", name = "c", descriptor = "(B)V", line = 477)
