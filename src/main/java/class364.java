...
public abstract class class364 {
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(III)V", line = 21)
    ...
    @OriginalMember(owner = "client!rg", name = "c", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(B)V", line = 135)
    ...
    @OriginalMember(owner = "client!rg", name = "c", descriptor = "(B)V", line = 249)
