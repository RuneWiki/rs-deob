...
public class class364 extends class266 {
    ...
    @OriginalMember(owner = "client!jba", name = "<init>", descriptor = "(Lmc;Lpj;Ldb;)V")
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(Lek;IB)V")
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(Ljava/lang/String;ILta;Z)V")
