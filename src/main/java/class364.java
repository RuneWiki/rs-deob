...
public class class364 {
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "()V", line = 3)
    public class364() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IB)V", line = 7)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(II)V", line = 22)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ZIZII)V", line = 51)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ILat;[B)V", line = 266)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(III)V", line = 297)
