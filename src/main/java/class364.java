...
public class class364 {
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(Lha;Lija;)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(Lha;)V", line = 40)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "()V", line = 100)
    public final void method2283() {
        this.field5083 = null;
    }

    @OriginalMember(owner = "client!ija", name = "b", descriptor = "(Lha;Lija;)Z", line = 104)
    public final boolean method2284(class65 arg0, class364 arg1) {
        return this.field5083 != null || this.method2281(arg0, arg1);
    }

    @OriginalMember(owner = "client!ija", name = "b", descriptor = "()V", line = 110)
    public static final void method2285() {
        field5089 = null;
        field5086 = null;
    }

    @OriginalMember(owner = "client!ija", name = "c", descriptor = "(Lha;Lija;)V", line = 116)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(Lha;IIIIII)V", line = 207)
    ...
    @OriginalMember(owner = "client!ija", name = "d", descriptor = "(Lha;Lija;)V", line = 231)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(IIII)Z", line = 319)
    ...
    @OriginalMember(owner = "client!ija", name = "b", descriptor = "(Lha;)V", line = 379)
    ...
    @OriginalMember(owner = "client!ija", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 459)
    ...
    @OriginalMember(owner = "client!ija", name = "c", descriptor = "()V", line = 476)
