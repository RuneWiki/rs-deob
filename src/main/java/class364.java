...
public class class364 {
    ...
    @OriginalMember(owner = "client!qu", name = "toString", descriptor = "()Ljava/lang/String;", line = 6)
    public final String toString() {
        field5238++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(III)B", line = 15)
    ...
    @OriginalMember(owner = "client!qu", name = "<init>", descriptor = "(II)V", line = 38)
    public class364(int arg0, int arg1) {
        this.field5240 = arg0;
    }

    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(I)I", line = 150)
