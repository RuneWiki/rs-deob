...
public class class364 implements Runnable {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(BLjava/awt/datatransfer/Transferable;)Lvc;")
    public final class225 method2384(byte arg0, Transferable arg1) {
        return arg0 > -94 ? null : this.method2387(arg1, 0, 0, 19, 0);
    }

    @OriginalMember(owner = "client!de", name = "a", descriptor = "(IILjava/lang/String;)Lvc;")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(BIIILjava/lang/Object;)Lvc;")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Ljava/lang/Object;IIII)Lvc;")
    ...
    @OriginalMember(owner = "client!de", name = "b", descriptor = "(I)Lvc;")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Ljava/awt/Frame;I)Lvc;")
    public final class225 method2391(Frame arg0, int arg1) {
        int var3 = 98 % ((arg1 - 26) / 33);
        return this.method2387(arg0, 0, 0, 7, 0);
    }

    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Class;)Lvc;")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ILjava/awt/Component;ILjava/awt/Point;I[I)Lvc;")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ILjava/awt/Component;II)Lvc;")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Z)Lvc;")
    public final class225 method2396(boolean arg0) {
        return arg0 ? this.method2387((Object) null, 0, 0, 13, 0) : null;
    }

    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Ljava/lang/Runnable;ZI)Lvc;")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ZI)Lvc;")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Ljava/net/URL;I)Lvc;")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ILjava/lang/String;)Lvc;")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Ljava/lang/Class;I)Lvc;")
    public final class225 method2402(Class arg0, int arg1) {
        return arg1 == 0 ? this.method2387(arg0, 0, 0, 10, 0) : null;
    }

    @OriginalMember(owner = "client!de", name = "a", descriptor = "(IIIIB)Lvc;")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Ljava/lang/String;I)Lvc;")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ZLjava/lang/Class;)Lvc;")
    public final class225 method2405(boolean arg0, Class arg1) {
        return arg0 ? this.method2387(arg1, 0, 0, 11, 0) : null;
    }

    @OriginalMember(owner = "client!de", name = "b", descriptor = "(Ljava/lang/Class;I)Lvc;")
    ...
    @OriginalMember(owner = "client!de", name = "e", descriptor = "(I)Lvc;")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;[Ljava/lang/Class;Z)Lvc;")
    ...
    @OriginalMember(owner = "client!de", name = "b", descriptor = "(Z)Lla;")
    public final class221 method2409(boolean arg0) {
        return arg0 ? null : this.field5377;
    }

    @OriginalMember(owner = "client!de", name = "a", descriptor = "(B)Lvc;")
    public final class225 method2410(byte arg0) {
        int var2 = 61 % ((-arg0 - 16) / 51);
        return this.method2387((Object) null, 0, 0, 5, 0);
    }

    @OriginalMember(owner = "client!de", name = "a", descriptor = "(BZLjava/awt/Component;)Lvc;")
