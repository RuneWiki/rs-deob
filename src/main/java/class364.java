...
public class class364 extends class163 {
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "(IIIIIF)V", line = 4)
    public class364(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(IF)V", line = 8)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(BIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 38)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Lha;B)V", line = 102)
