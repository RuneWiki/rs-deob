...
public class class364 extends class535 implements class121 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IIIIIII)Lbn;")
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(Ltt;ILjaggl/memory/NativeBuffer;)V")
    public class364(class249 arg0, int arg1, NativeBuffer arg2) {
        super(arg0, arg2);
        this.field5368 = arg1;
    }

    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lfi;Lfi;I)V")
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(Ltt;I[BI)V")
