...
public class class364 extends class646 {
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(Lsea;Ljava/lang/Object;I)V", line = 3)
    public class364(class652 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field4659 = arg1;
    }

    @OriginalMember(owner = "client!lp", name = "d", descriptor = "(I)Z", line = 15)
    ...
    @OriginalMember(owner = "client!lp", name = "d", descriptor = "(II)I", line = 27)
    public static int method2113(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!lp", name = "e", descriptor = "(II)V", line = 34)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 46)
    ...
    @OriginalMember(owner = "client!lp", name = "e", descriptor = "(I)V", line = 61)
