...
public class class364 extends class61 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(CIIIZLde;II)V")
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "([B[IIIIIIIIIIILde;II)V")
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(Lsq;Lci;[Ljf;[I[I)V")
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "([B[IIIIIIIIIIILde;II)V")
