...
public class class364 extends class16 {
    ...
    @OriginalMember(owner = "client!tda", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 3)
    public class364(Object arg0, int arg1) {
        super(arg1);
        this.field5168 = arg0;
    }

    @OriginalMember(owner = "client!tda", name = "e", descriptor = "(I)Z", line = 14)
    ...
    @OriginalMember(owner = "client!tda", name = "f", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(Lgaa;I)Lgaa;", line = 45)
    ...
    @OriginalMember(owner = "client!tda", name = "c", descriptor = "(I)Ljava/lang/Object;", line = 64)
