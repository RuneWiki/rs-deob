...
public class class364 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IJII)V", line = 31)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IB)Llu;", line = 75)
