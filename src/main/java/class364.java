...
public class class364 extends class54 {
    ...
    @OriginalMember(owner = "client!gha", name = "c", descriptor = "(Z)I")
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(IIIZLqa;)Z")
    ...
    @OriginalMember(owner = "client!gha", name = "<init>", descriptor = "(Lhia;)V")
    ...
    @OriginalMember(owner = "client!gha", name = "b", descriptor = "(IB)I")
    ...
    @OriginalMember(owner = "client!gha", name = "<init>", descriptor = "(ILhia;)V")
