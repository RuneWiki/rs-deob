...
public abstract class class364 extends class766 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lol;B)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IIIIIIIIIILkn;I)Z")
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Llea;)V")
