...
public class class364 extends class337 {
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(Ljha;I)I", line = 11)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(B)I", line = 47)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(ZIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(Lft;B)I", line = 89)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(IZ)Z", line = 127)
    ...
    @OriginalMember(owner = "client!ija", name = "b", descriptor = "(B)V", line = 140)
    ...
    @OriginalMember(owner = "client!ija", name = "a", descriptor = "(Lmc;B)V", line = 175)
    ...
    @OriginalMember(owner = "client!ija", name = "<init>", descriptor = "()V", line = 207)
    public class364() {
    }

    @OriginalMember(owner = "client!ija", name = "<init>", descriptor = "(ZLoq;)V", line = 209)
