...
public class class364 extends class297 {
    ...
    @OriginalMember(owner = "client!uia", name = "d", descriptor = "(II)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!uia", name = "c", descriptor = "(II)[I", line = 82)
    ...
    @OriginalMember(owner = "client!uia", name = "b", descriptor = "(B)V", line = 139)
    ...
    @OriginalMember(owner = "client!uia", name = "<init>", descriptor = "()V", line = 151)
    public class364() {
        super(3, false);
    }

    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(Lcea;II)V", line = 155)
