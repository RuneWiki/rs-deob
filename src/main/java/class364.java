...
public class class364 extends class274 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(B)Lcd;")
    public final class60 method399(byte arg0) {
        int var2 = 90 % ((17 - arg0) / 42);
        return this.field5514;
    }

    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(ILcd;Lcd;F)V")
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(Lnm;I)V")
