...
public class class364 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BLvj;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Z)Lei;", line = 21)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lul;Z)Z", line = 43)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(I)Z", line = 58)
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "()V", line = 86)
    public class364() {
        this.field4663 = -60;
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "(Lvj;)V", line = 102)
