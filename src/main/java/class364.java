...
public class class364 extends class398 {
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(BLn;)V")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Llm;Llm;Llm;Z)V")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lpl;I)V")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lnj;II)V")
