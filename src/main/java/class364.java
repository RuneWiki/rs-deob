...
public class class364 extends class615 {
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "(Leea;IIIZ[III)V", line = 3)
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "(Leea;IIIIIZ)V", line = 25)
    ...
    @OriginalMember(owner = "client!ll", name = "b", descriptor = "(BII)Z", line = 47)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ZI)V", line = 65)
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "(Leea;IIIIIIZ)V", line = 76)
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "(Leea;IIIIZ[BI)V", line = 90)
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "(Leea;IIIII[BI)V", line = 111)
    ...
    @OriginalMember(owner = "client!ll", name = "g", descriptor = "(I)V", line = 126)
    public static void method2321(int arg0) {
        int var1 = 43 / ((-48 - arg0) / 49);
        field5160 = null;
    }

    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "(Leea;IIII[I)V", line = 135)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(IB)Z", line = 158)
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "(Leea;IIII)V", line = 170)
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "(Leea;IIIII)V", line = 192)
    public class364(class131 arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        super(arg0, 3553, arg1, arg4, arg5);
        this.field5156 = false;
        this.field5158 = arg2;
