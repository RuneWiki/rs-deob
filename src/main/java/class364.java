...
public class class364 extends class23 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Lih;B)V")
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(ZIIIILqs;I)V")
    ...
    @OriginalMember(owner = "client!ct", name = "t", descriptor = "(I)V")
