...
public class class364 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(B)[Lsv;", line = 124)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(I)I", line = 136)
    public final int method2335(int arg0) {
        field5477++;
        return arg0 < 56 ? -63 : this.field5466;
    }

    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(JI)V", line = 149)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(I)Ljava/lang/Object;", line = 165)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IBLjava/lang/Object;J)V", line = 196)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IJ)Ljava/lang/Object;", line = 227)
    ...
    @OriginalMember(owner = "client!lh", name = "c", descriptor = "(I)V", line = 270)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(BIII)V", line = 283)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(JLjava/lang/Object;I)V", line = 298)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ILcg;)V", line = 309)
    ...
    @OriginalMember(owner = "client!lh", name = "d", descriptor = "(I)I", line = 328)
    ...
    @OriginalMember(owner = "client!lh", name = "e", descriptor = "(I)I", line = 340)
    ...
    @OriginalMember(owner = "client!lh", name = "f", descriptor = "(I)Ljava/lang/Object;", line = 367)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(BLir;)V", line = 398)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(II)V", line = 464)
    ...
    @OriginalMember(owner = "client!lh", name = "g", descriptor = "(I)V", line = 517)
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(I)V", line = 558)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(B)V", line = 533)
