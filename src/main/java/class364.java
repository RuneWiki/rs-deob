...
public class class364 extends class463 implements class55 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ILqa;)V", line = 5)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ILwo;ILqa;I)V", line = 33)
    ...
    @OriginalMember(owner = "client!hr", name = "c", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lqa;I)Lip;", line = 81)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(ILqa;)V", line = 107)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(I)I", line = 135)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IILqa;)Lc;", line = 146)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IILqa;Z)Ltt;", line = 158)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(I)Z", line = 190)
    ...
    @OriginalMember(owner = "client!hr", name = "g", descriptor = "(I)I", line = 205)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(B)I", line = 218)
    ...
    @OriginalMember(owner = "client!hr", name = "i", descriptor = "(I)V", line = 230)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(B)I", line = 247)
    ...
    @OriginalMember(owner = "client!hr", name = "c", descriptor = "(ILqa;)V", line = 259)
    public final void method400(int arg0, class162 arg1) {
        int var3 = -74 % ((-29 - arg0) / 33);
        ++field5048;
    }

    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(CB)Z", line = 270)
    ...
    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "(Lqa;Lpk;IIIIZIIIII)V", line = 305)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ILm;ILjava/awt/Canvas;)Lqa;", line = 330)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lqa;III)Z", line = 344)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IBLqa;)Lc;", line = 371)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(BLvh;Lvh;)I", line = 402)
