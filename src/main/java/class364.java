...
public class class364 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ke", name = "b", descriptor = "(Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(II)V", line = 35)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!ke", name = "b", descriptor = "(I)[Lea;", line = 63)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(BI)Lqf;", line = 79)
    ...
    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "(Lad;ILdk;)V", line = 1234)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Lmb;Lwr;)V", line = 113)
