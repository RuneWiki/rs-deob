...
public class class364 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(FFIFF[BIIIZILqi;F)V", line = 59)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(B)V", line = 89)
