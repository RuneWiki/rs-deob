...
public class class364 {
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(B)Lre;")
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(IBLrv;)V")
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(Lcb;BII)Lhm;")
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(BLrv;)V")
