...
public class class364 {
    ...
    @OriginalMember(owner = "client!qca", name = "movemouse", descriptor = "(II)V")
    public final void movemouse(int arg0, int arg1) {
        this.field5253.mouseMove(arg0, arg1);
    }

    @OriginalMember(owner = "client!qca", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V")
    ...
    @OriginalMember(owner = "client!qca", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V")
