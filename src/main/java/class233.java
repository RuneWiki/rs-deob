...
public class class233 extends class247 {
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(III)Lmc;")
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(B)Lvn;")
    ...
    @OriginalMember(owner = "client!rr", name = "<init>", descriptor = "(ILek;Lek;Lt;Lqc;IIZ)V")
