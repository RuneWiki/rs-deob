...
public class class233 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Lvh;B)I")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IZ)Llg;")
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(Llo;ILnl;)V")
