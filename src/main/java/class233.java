...
public class class233 extends class447 {
    ...
    @OriginalMember(owner = "client!at", name = "e", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!at", name = "c", descriptor = "(B)Lwj;", line = 247)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Ljava/awt/Frame;ILml;)V", line = 273)
