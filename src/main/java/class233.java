...
public class class233 extends class190 {
    ...
    @OriginalMember(owner = "client!wda", name = "b", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!wda", name = "<init>", descriptor = "(Ljj;Llm;)V", line = 19)
    ...
    @OriginalMember(owner = "client!wda", name = "b", descriptor = "(I)Z", line = 38)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(ZB)V", line = 51)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(IBIIIIIZI)Z", line = 84)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(III)V", line = 141)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(ILaba;I)V", line = 186)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(ZI)V", line = 207)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(IIIZIZI)V", line = 217)
