...
public class class233 extends class239 {
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Ljava/awt/Canvas;B)V", line = 12)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILjava/awt/Graphics;IZ)V", line = 32)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IILjava/awt/Graphics;IBI)V", line = 44)
