...
public class class233 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IIILqb;II)Lqb;", line = 3)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(BIIIIIILqb;)Lqb;", line = 134)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(I)V", line = 189)
    public static void method1514(int arg0) {
        int var1 = 65 % ((arg0 + 62) / 59);
        field3232 = null;
    }

    @OriginalMember(owner = "client!md", name = "b", descriptor = "(I)V", line = 205)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(BILfb;)V", line = 237)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ZIBI)I", line = 405)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Lfb;B)V", line = 532)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IZLmd;IIIILqb;ILtj;IIIII)Lqb;", line = 569)
