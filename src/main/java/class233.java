...
public class class233 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(B)Ljn;")
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Ljn;I)V")
    ...
    @OriginalMember(owner = "client!kn", name = "c", descriptor = "(I)Ljn;")
    ...
    @OriginalMember(owner = "client!kn", name = "e", descriptor = "(I)Ljn;")
