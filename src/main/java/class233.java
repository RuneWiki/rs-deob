...
public class class233 extends class204 {

    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(IIIIII)V", line = 3)
        ...
        if (var43 == 0) {
            if (var42 == 0) {
                ...
                while (var48 < 0) {
                    ...
                    if (var46 >= 0 && var47 >= 0 && var46 - (this.field1828 << 12) < 0 && var47 - (this.field1821 << 12) < 0) {
                        while (var52 < 0) {
                            ...
                            int var54 = class78.field1357[var49];
                            int var55 = var53 >>> 24;
                            int var56 = 256 - var55;
                            class78.field1357[var49++] = ((var53 & 0xFF00FF) * var55 + (var54 & 0xFF00FF) * var56 & 0xFF00FF00) + ((var53 & 0xFF00) * var55 + (var54 & 0xFF00) * var56 & 0xFF0000) >> 8;
                            var52++;
                        }
                    }
                    var48++;
                ...
                while (var57 < 0) {
                    ...
                    if (var46 >= 0 && var46 - (this.field1828 << 12) < 0) {
                        int var62;
                        if ((var62 = var60 - (this.field1821 << 12)) >= 0) {
                        ...
                        while (var61 < 0) {
                            int var65 = this.field3484[(var59 >> 12) + (var60 >> 12) * this.field1828];
                            int var66 = class78.field1357[var58];
                            int var67 = var65 >>> 24;
                            int var68 = 256 - var67;
                            class78.field1357[var58++] = ((var65 & 0xFF00FF) * var67 + (var66 & 0xFF00FF) * var68 & 0xFF00FF00) + ((var65 & 0xFF00) * var67 + (var66 & 0xFF00) * var68 & 0xFF0000) >> 8;
                            var60 += var42;
                            var61++;
                        }
                    }
                ...
                while (var69 < 0) {
                    ...
                    if (var46 >= 0 && var46 - (this.field1828 << 12) < 0) {
                        ...
                        int var75;
                        if ((var75 = (var72 + 1 - (this.field1821 << 12) - var42) / var42) > var73) {
                            var73 = var75;
                        }
                        while (var73 < 0) {
                            int var76 = this.field3484[(var71 >> 12) + (var72 >> 12) * this.field1828];
                            int var77 = class78.field1357[var70];
                            int var78 = var76 >>> 24;
                            int var79 = 256 - var78;
                            class78.field1357[var70++] = ((var76 & 0xFF00FF) * var78 + (var77 & 0xFF00FF) * var79 & 0xFF00FF00) + ((var76 & 0xFF00) * var78 + (var77 & 0xFF00) * var79 & 0xFF0000) >> 8;
                            var72 += var42;
                            var73++;
                        }
                    }
            ...
            if (var42 == 0) {
                ...
                while (var80 < 0) {
                    ...
                    if (var47 >= 0 && var47 - (this.field1821 << 12) < 0) {
                        ...
                        while (var84 < 0) {
                            int var88 = this.field3484[(var82 >> 12) + (var83 >> 12) * this.field1828];
                            int var89 = class78.field1357[var81];
                            int var90 = var88 >>> 24;
                            int var91 = 256 - var90;
                            class78.field1357[var81++] = ((var88 & 0xFF00FF) * var90 + (var89 & 0xFF00FF) * var91 & 0xFF00FF00) + ((var88 & 0xFF00) * var90 + (var89 & 0xFF00) * var91 & 0xFF0000) >> 8;
                            var82 += var43;
                            var84++;
                        }
                    }
                ...
                while (var92 < 0) {
                    ...
                    int var100;
                    if ((var100 = var95 - (this.field1821 << 12)) >= 0) {
                    ...
                    while (var96 < 0) {
                        int var103 = this.field3484[(var94 >> 12) + (var95 >> 12) * this.field1828];
                        int var104 = class78.field1357[var93];
                        int var105 = var103 >>> 24;
                        int var106 = 256 - var105;
                        class78.field1357[var93++] = ((var103 & 0xFF00FF) * var105 + (var104 & 0xFF00FF) * var106 & 0xFF00FF00) + ((var103 & 0xFF00) * var105 + (var104 & 0xFF00) * var106 & 0xFF0000) >> 8;
                        var94 += var43;
                        var95 += var42;
                        var96++;
                    }
                ...
                while (var107 < 0) {
                    ...
                    int var111 = var37;
                    int var112;
                    if ((var112 = var109 - (this.field1828 << 12)) >= 0) {
                    ...
                    int var116;
                    if ((var116 = (var110 + 1 - (this.field1821 << 12) - var42) / var42) > var111) {
                        var111 = var116;
                    }
                    while (var111 < 0) {
                        int var117 = this.field3484[(var109 >> 12) + (var110 >> 12) * this.field1828];
                        int var118 = class78.field1357[var108];
                        int var119 = var117 >>> 24;
                        int var120 = 256 - var119;
                        class78.field1357[var108++] = ((var117 & 0xFF00FF) * var119 + (var118 & 0xFF00FF) * var120 & 0xFF00FF00) + ((var117 & 0xFF00) * var119 + (var118 & 0xFF00) * var120 & 0xFF0000) >> 8;
                        var109 += var43;
                        var110 += var42;
                        var111++;
                    }
            ...
            while (var121 < 0) {
                ...
                if (var47 >= 0 && var47 - (this.field1821 << 12) < 0) {
                    ...
                    int var127;
                    if ((var127 = (var123 + 1 - (this.field1828 << 12) - var43) / var43) > var125) {
                        var125 = var127;
                    }
                    while (var125 < 0) {
                        int var128 = this.field3484[(var123 >> 12) + (var124 >> 12) * this.field1828];
                        int var129 = class78.field1357[var122];
                        int var130 = var128 >>> 24;
                        int var131 = 256 - var130;
                        class78.field1357[var122++] = ((var128 & 0xFF00FF) * var130 + (var129 & 0xFF00FF) * var131 & 0xFF00FF00) + ((var128 & 0xFF00) * var130 + (var129 & 0xFF00) * var131 & 0xFF0000) >> 8;
                        var123 += var43;
                        var125++;
                    }
                }
            ...
            while (var132 < 0) {
                ...
                int var138;
                if ((var138 = (var134 + 1 - (this.field1828 << 12) - var43) / var43) > var136) {
                    var136 = var138;
                }
                int var139;
                if ((var139 = var135 - (this.field1821 << 12)) >= 0) {
                ...
                while (var136 < 0) {
                    int var142 = this.field3484[(var134 >> 12) + (var135 >> 12) * this.field1828];
                    int var143 = class78.field1357[var133];
                    int var144 = var142 >>> 24;
                    int var145 = 256 - var144;
                    class78.field1357[var133++] = ((var142 & 0xFF00FF) * var144 + (var143 & 0xFF00FF) * var145 & 0xFF00FF00) + ((var142 & 0xFF00) * var144 + (var143 & 0xFF00) * var145 & 0xFF0000) >> 8;
                    var134 += var43;
                    var135 += var42;
                    var136++;
                }
            ...
            while (var146 < 0) {
                ...
                int var152;
                if ((var152 = (var148 + 1 - (this.field1828 << 12) - var43) / var43) > var150) {
                    var150 = var152;
                }
                if (var149 < 0) {
                ...
                int var154;
                if ((var154 = (var149 + 1 - (this.field1821 << 12) - var42) / var42) > var150) {
                    var150 = var154;
                }
                while (var150 < 0) {
                    int var155 = this.field3484[(var148 >> 12) + (var149 >> 12) * this.field1828];
                    int var156 = class78.field1357[var147];
                    int var157 = var155 >>> 24;
                    int var158 = 256 - var157;
                    class78.field1357[var147++] = ((var155 & 0xFF00FF) * var157 + (var156 & 0xFF00FF) * var158 & 0xFF00FF00) + ((var155 & 0xFF00) * var157 + (var156 & 0xFF00) * var158 & 0xFF0000) >> 8;
                    var148 += var43;
                    var149 += var42;
                    var150++;
                }
    ...
    @OriginalMember(owner = "client!ce", name = "<init>", descriptor = "(IIIIII[I)V", line = 654)
    public class233(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int[] arg6) {
        super(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
    }

    @OriginalMember(owner = "client!ce", name = "b", descriptor = "([I[IIIIIII)V", line = 660)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(II)V", line = 685)
    public final void method708(int arg0, int arg1) {
        ...
        if (var8 > 0 && var7 > 0) {
            method1568(class78.field1357, this.field3484, var6, var5, var8, var7, var9, var10);
        }
    }

    @OriginalMember(owner = "client!ce", name = "b", descriptor = "([I[IIIIIIIII)V", line = 742)
    private static final void method1569(int[] arg0, int[] arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9) {
    ...
    @OriginalMember(owner = "client!ce", name = "b", descriptor = "(III)V", line = 772)
    public final void method720(int arg0, int arg1, int arg2) {
        ...
        if (var9 > 0 && var8 > 0) {
            method1569(class78.field1357, this.field3484, 0, var7, var6, var9, var8, var10, var11, arg2);
        }
    }

    @OriginalMember(owner = "client!ce", name = "b", descriptor = "([I[IIIIIIIIIIII)V", line = 827)
    private static final void method1570(int[] arg0, int[] arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12) {
        int var13 = arg3;
    ...
    @OriginalMember(owner = "client!ce", name = "b", descriptor = "(II)V", line = 868)
    public final void method711(int arg0, int arg1) {
        ...
        if (var8 > 0 && var7 > 0) {
            method1571(class78.field1357, this.field3484, 0, var6, var5, var8, var7, var9, var10);
        }
    }

    @OriginalMember(owner = "client!ce", name = "b", descriptor = "([I[IIIIIIII)V", line = 924)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(IIIII)V", line = 955)
    public final void method718(int arg0, int arg1, int arg2, int arg3, int arg4) {
        ...
        method1570(class78.field1357, this.field3484, 0, var8, var9, var16, var17, arg2, arg3, var12, var13, var6, arg4);
    }
}
