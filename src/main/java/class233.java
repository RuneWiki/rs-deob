...
public class class233 extends class431 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(IZIB)V", line = 31)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(ILjava/lang/String;)I", line = 96)
