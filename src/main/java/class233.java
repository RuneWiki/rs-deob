...
public class class233 extends class337 {
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IIZII)V", line = 3)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(II)V", line = 27)
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "(II)V", line = 69)
    public class233(int arg0, int arg1) {
        this.field3463 = arg1;
        this.field3462 = arg0;
    }

    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lod;B)V", line = 88)
