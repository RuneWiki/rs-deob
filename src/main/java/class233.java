...
public abstract class class233 implements class248 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Ljaggl/opengl;IIIII[B)V")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Ljaggl/opengl;IIIII[F)V")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Ljaggl/opengl;IIIIII[I)V")
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "(Lh;IIIZ)V")
