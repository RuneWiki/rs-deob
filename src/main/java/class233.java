...
public class class233 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Ljj;IIIII)V")
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lmn;")
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Ljk;ILfs;)V")
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(BI)Lhv;")
