...
public abstract class class233 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lsk;IB)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ILsk;IZIILsk;II)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(I[ZIZILaw;Law;Lvca;ZB[II)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "([IIIIBILsk;Lsk;IIZ)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ZZIIILsk;[ZLsk;Lsk;Lsk;IIIII)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIIIIIIILs;)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIILmb;Lmb;)V")
