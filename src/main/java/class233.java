...
public class class233 extends class314 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(BLie;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "()V", line = 57)
    public class233() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IB)[[I", line = 66)
    ...
    @OriginalMember(owner = "client!ok", name = "d", descriptor = "(B)V", line = 124)
    ...
    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(II)V", line = 229)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(B)V", line = 481)
