...
public class class233 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(ZLjava/awt/Component;)Lhn;")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(B)Lkp;")
    ...
    @OriginalMember(owner = "client!kg", name = "c", descriptor = "(I)Lkp;")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lvt;IB)V")
