...
public class class233 implements class72 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Luh;[IIJ)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(ZZZII)I", line = 55)
