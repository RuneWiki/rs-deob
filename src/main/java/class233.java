...
public abstract class class233 extends class309 {
    ...
    @OriginalMember(owner = "client!ds", name = "d", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IIIIIZFI)[I", line = 30)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Lfp;Lje;ZIIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!ds", name = "d", descriptor = "(B)Z", line = 71)
    ...
    @OriginalMember(owner = "client!ds", name = "f", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(IIIIIII)V", line = 93)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IC)C", line = 111)
