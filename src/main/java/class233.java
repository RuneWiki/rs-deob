...
public class class233 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IIILha;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(I)Z", line = 98)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(I)I", line = 109)
    ...
    @OriginalMember(owner = "client!cu", name = "c", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!cu", name = "d", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IBII)Lkg;", line = 164)
    ...
    @OriginalMember(owner = "client!cu", name = "e", descriptor = "(I)Z", line = 223)
    public final boolean method1437(int arg0) {
        field2773++;
        return arg0 > -58 ? false : this.field2771;
    }

    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Z)I", line = 236)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "(ZIIZ)V", line = 248)
