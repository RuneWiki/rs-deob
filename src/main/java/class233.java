...
public class class233 extends class193 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(ILbf;)V")
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(Lug;Lpl;)V")
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Lsq;II)V")
