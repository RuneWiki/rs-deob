...
public class class233 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lw;III)V")
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(ILw;II)V")
    ...
    @OriginalMember(owner = "client!rb", name = "b", descriptor = "(Lw;III)Z")
    ...
    @OriginalMember(owner = "client!rb", name = "<init>", descriptor = "(Lfc;Los;)V")
