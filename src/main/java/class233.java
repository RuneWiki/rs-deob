...
public class class233 implements Runnable {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Z)I", line = 26)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!uq", name = "finalize", descriptor = "()V", line = 53)
    protected final void finalize() {
        field3096++;
        this.method1398((byte) 115);
    }

    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "(Ljava/net/Socket;Lwd;)V", line = 323)
    ...
    @OriginalMember(owner = "client!uq", name = "b", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(ZI[BI)V", line = 98)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(B)V", line = 123)
    ...
    @OriginalMember(owner = "client!uq", name = "run", descriptor = "()V", line = 158)
    ...
    @OriginalMember(owner = "client!uq", name = "c", descriptor = "(I)I", line = 233)
    ...
    @OriginalMember(owner = "client!uq", name = "b", descriptor = "(B)V", line = 249)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(III[B)V", line = 264)
