...
public class class233 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(ILta;IILta;IIIIB)V")
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IIIIILqq;I)V")
    ...
    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "(Lqq;Lha;I)V")
