...
public abstract class class233 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 12)
    ...
    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(II)Z", line = 26)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(I[BI)[B", line = 36)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Lza;I)V", line = 50)
