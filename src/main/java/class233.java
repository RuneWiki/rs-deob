...
public class class233 {
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lwm;BIII)V")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(BLqa;I)Z")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(II)Lss;")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IILqa;IIIBIII)V")
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "(I[Lah;IIII)V")
