...
public class class233 extends class478 {
    ...
    @OriginalMember(owner = "client!us", name = "c", descriptor = "(Lkm;I)V")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lpf;II)V")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lkm;BII)Z")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(ILab;Lkm;)V")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(ILkm;IZILkj;B)V")
    ...
    @OriginalMember(owner = "client!us", name = "a", descriptor = "(Lkm;II)Lab;")
    ...
    @OriginalMember(owner = "client!us", name = "d", descriptor = "(Lkm;I)Lto;")
