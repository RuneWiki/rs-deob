...
public class class233 {
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(B)Lta;", line = 5)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lta;I)V", line = 27)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(I)I", line = 53)
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(B)Lta;", line = 78)
    ...
    @OriginalMember(owner = "client!tc", name = "c", descriptor = "(B)V", line = 100)
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "()V", line = 131)
    public class233() {
        this.field3397.field2238 = this.field3397;
        this.field3397.field2236 = this.field3397;
    }

    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(I)V", line = 140)
