...
public abstract class class233 {
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "(Lht;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "(Lht;ILjaggl/memory/NativeBuffer;IZ)V")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(ILvh;)V")
