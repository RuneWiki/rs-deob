...
public abstract class class233 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!we", name = "providesignlink", descriptor = "(Lam;)V")
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(BILbo;)V")
    ...
    @OriginalMember(owner = "client!we", name = "f", descriptor = "(B)V")
