...
public class class233 extends class27 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(II[Ljava/lang/String;I)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(ZI)V", line = 67)
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(B)V", line = 79)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(Llj;Lud;)V", line = 110)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Z)Z", line = 158)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IILvf;)V", line = 172)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(III)V", line = 185)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(BZ)V", line = 265)
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(Z)V", line = 313)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IB[BI)[B", line = 328)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(B)V", line = 342)
