...
public class class233 extends class331 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IB)I", line = 3)
    ...
    @OriginalMember(owner = "client!tf", name = "c", descriptor = "(B)I", line = 47)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(II)I", line = 60)
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(Lts;)V", line = 72)
    public class233(class41 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(ILts;)V", line = 75)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(Z)V", line = 95)
    ...
    @OriginalMember(owner = "client!tf", name = "c", descriptor = "(II)V", line = 108)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(B)I", line = 124)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IIZFIIIIZ)[[I", line = 139)
