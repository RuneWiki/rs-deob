...
public class class233 extends class35 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(IIII)I", line = 24)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(ILjava/lang/String;)I", line = 56)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(BLsk;)V", line = 87)
