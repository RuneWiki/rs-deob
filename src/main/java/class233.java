...
public class class233 extends class467 {
    ...
    @OriginalMember(owner = "client!dj", name = "b", descriptor = "(Lqa;B)Lem;")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(ILqa;)Lnj;")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Lqa;B)V")
