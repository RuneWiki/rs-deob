...
public class class233 extends class642 {
    ...
    @OriginalMember(owner = "client!rb", name = "<init>", descriptor = "()V", line = 7)
    public class233() {
        this(0);
    }

    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(BI)V", line = 13)
    ...
    @OriginalMember(owner = "client!rb", name = "<init>", descriptor = "(I)V", line = 27)
    private class233(int arg0) {
        super(0, false);
        this.method1440((byte) -100, arg0);
    }

    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(II)[[I", line = 36)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(ILgk;B)V", line = 76)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IB)V", line = 107)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(ZI)Z", line = 131)
