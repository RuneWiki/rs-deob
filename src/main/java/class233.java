...
public class class233 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(BLkea;)V", line = 46)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(II)Lqd;", line = 75)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(BZ)V", line = 134)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IB)V", line = 150)
    ...
    @OriginalMember(owner = "client!up", name = "b", descriptor = "(II)V", line = 165)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(I)V", line = 185)
    ...
    @OriginalMember(owner = "client!up", name = "b", descriptor = "(IB)V", line = 210)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(Lcda;IZLkea;Lkea;)V", line = 260)
