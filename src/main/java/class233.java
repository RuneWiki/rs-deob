...
public class class233 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(ILtj;IZLtj;)V")
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(IIILjava/lang/Class;)Lsf;")
    ...
    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "(ILup;Lup;I)V")
