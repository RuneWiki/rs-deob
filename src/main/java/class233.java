...
public class class233 extends class755 {
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "([Lcn;IB)V", line = 6)
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(ILwca;)V", line = 100)
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(BLib;)V", line = 134)
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(B)V", line = 156)
