...
public class class233 {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IZ)Llt;", line = 20)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ILqa;)V", line = 78)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Z)V", line = 130)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;B)Ljava/lang/String;", line = 147)
    ...
    @OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(Liv;ILuu;)V", line = 179)
