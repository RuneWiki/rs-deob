...
public class class109 extends class443 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Lfb;Z)V", line = 65)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Lfb;IB)V", line = 93)
    ...
    @OriginalMember(owner = "client!jm", name = "d", descriptor = "(B)V", line = 117)
