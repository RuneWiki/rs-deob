...
public class class109 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "([BIIIIII[BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IIIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IILdh;I)Z", line = 120)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(I[[ZIIZI)V", line = 194)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(I[BIIIII)Z", line = 381)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(BLdh;II)V", line = 429)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IIIII[BII[B)V", line = 498)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ILdh;BI)V", line = 543)
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(Lfu;Lka;)V", line = 611)
