...
public class class109 extends class571 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "(I)V", line = 131)
