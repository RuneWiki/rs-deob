...
public class class109 {
    ...
    @OriginalMember(owner = "client!hj", name = "toString", descriptor = "()Ljava/lang/String;", line = 11)
    public final String toString() {
        field1476++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!hj", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 20)
    public class109(String arg0, int arg1) {
        this.field1478 = arg1;
        this.field1475 = arg0;
    }

    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(Z)V", line = 30)
