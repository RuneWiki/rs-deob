...
public class class109 extends class86 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Z)I", line = 6)
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(II)I", line = 18)
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(Lsf;)V", line = 29)
    public class109(class551 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(I)I", line = 32)
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(ILsf;)V", line = 43)
    public class109(int arg0, class551 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IZ)V", line = 64)
