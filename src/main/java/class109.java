...
public class class109 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(I[Lvi;)I", line = 11)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(BZ)V", line = 42)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(I)I", line = 78)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(ILvi;J)V", line = 92)
    ...
    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(I)Lvi;", line = 112)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(BJ)Lvi;", line = 145)
    ...
    @OriginalMember(owner = "client!tn", name = "c", descriptor = "(I)Lvi;", line = 182)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(IIZI)Ljava/lang/String;", line = 213)
    ...
    @OriginalMember(owner = "client!tn", name = "d", descriptor = "(I)V", line = 266)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(BI)Lvk;", line = 280)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(B)Lvi;", line = 311)
    ...
    @OriginalMember(owner = "client!tn", name = "e", descriptor = "(I)V", line = 324)
    ...
    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(B)I", line = 359)
    ...
    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "(I)V", line = 391)
