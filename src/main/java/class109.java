...
public class class109 implements Runnable {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Class;)Ltf;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(I)Ltf;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(I[Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Class;)Ltf;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(BIIILjava/lang/Object;)Ltf;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "([ILjava/awt/Point;ILjava/awt/Component;BI)Ltf;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILjava/lang/Object;III)Ltf;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Ljava/net/URL;Z)Ltf;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILjava/lang/String;Z)Ltf;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILjava/lang/Class;)Ltf;")
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(ILjava/lang/String;)Ltf;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Ljava/lang/Runnable;II)Ltf;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IIIIB)Ltf;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ZLjava/awt/Component;II)Ltf;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILjava/awt/Frame;)Ltf;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Ljava/lang/String;II)Ltf;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Ljava/lang/String;I)Ltf;")
    public final class533 method833(String arg0, int arg1) {
        return arg1 == -15248 ? this.method821(0, arg0, 0, 16, -3) : null;
    }

    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(I)Ltf;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILjava/awt/Component;Z)Ltf;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IZ)Ltf;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(B)Lin;")
    public final class168 method839(byte arg0) {
        int var2 = 61 % ((arg0 - 40) / 32);
        return this.field1627;
    }

    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;B)Ltf;")
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(BLjava/lang/Class;)Ltf;")
