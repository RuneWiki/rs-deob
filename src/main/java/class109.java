...
public class class109 implements class447 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(I)Ljw;", line = 6)
    ...
    @OriginalMember(owner = "client!rv", name = "b", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "(ILjg;Ljha;II)V", line = 31)
