...
public class class109 implements MouseListener, MouseMotionListener, FocusListener {
    ...
    @OriginalMember(owner = "client!dm", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 4)
    ...
    @OriginalMember(owner = "client!dm", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 20)
    ...
    @OriginalMember(owner = "client!dm", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 38)
    ...
    @OriginalMember(owner = "client!dm", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 55)
    ...
    @OriginalMember(owner = "client!dm", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 70)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(B)V", line = 91)
    ...
    @OriginalMember(owner = "client!dm", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 107)
    ...
    @OriginalMember(owner = "client!dm", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 165)
    ...
    @OriginalMember(owner = "client!dm", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 210)
    public final void focusGained(FocusEvent arg0) {
        field1345++;
    }

    @OriginalMember(owner = "client!dm", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 218)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(ZI)V", line = 229)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Lfd;IBI)V", line = 264)
