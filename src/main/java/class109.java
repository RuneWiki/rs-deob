...
public class class109 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Lbk;Lqp;IBILqf;Lvd;Lkk;ILtu;ILqa;)Lc;")
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IIIILtu;Lqs;IILqa;IIZLqf;Lkk;Lvd;[Lkh;Lqp;Lbk;Lqp;)Lc;")
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Ltu;Lbk;IIIIILqp;IILqa;I)Lc;")
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(BLtu;II)V")
