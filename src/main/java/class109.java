...
public class class109 extends class404 {
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Z)V", line = 14)
    public final void method349(boolean arg0) {
    }

    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(Lh;Lsh;)V", line = 16)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lsd;)V", line = 46)
    public final void method353(class233 arg0) {
        this.field5606.method2088(arg0);
    }

    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "()Z", line = 100)
    public final boolean method350() {
        return true;
    }

    @OriginalMember(owner = "client!ee", name = "b", descriptor = "()V", line = 104)
