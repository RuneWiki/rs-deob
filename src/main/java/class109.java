...
public class class109 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(ILri;)V", line = 7)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(BI)Z", line = 50)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Ltl;B)V", line = 115)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Ltl;II)V", line = 140)
    ...
    @OriginalMember(owner = "client!v", name = "b", descriptor = "(I)Z", line = 180)
