...
public class class109 {
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(II)Lae;", line = 3)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!ej", name = "b", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IIB)Z", line = 68)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "(Lfo;Le;)V", line = 96)
    public class109(class473 arg0, class486 arg1) {
        this.field1260 = arg0;
        this.field1268 = arg1;
    }

    @OriginalMember(owner = "client!ej", name = "b", descriptor = "(B)Ljava/lang/String;", line = 106)
