...
public class class109 extends class92 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Ld;IZI)V")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Ldga;II)V")
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(Laf;I)V")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Laf;I)V")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(ILaf;)V")
