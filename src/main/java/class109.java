...
public class class109 extends class47 implements class218 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(BLtq;)V")
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(IIILpq;)V")
    public class109(int arg0, int arg1, int arg2, class47 arg3) {
        super(arg0, arg1, arg2, false, false);
        this.field1527 = arg3;
    }

    @OriginalMember(owner = "client!io", name = "a", descriptor = "(BILtq;)Lns;")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Ltq;III)Z")
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(Ltq;I)Lcj;")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ILtq;)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Lje;ILdp;Lus;IIII)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(BZLtq;Lhm;III)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Ltq;I)V")
