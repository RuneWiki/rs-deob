...
public class class109 extends class690 {
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(IIB)V", line = 18)
    ...
    @OriginalMember(owner = "client!cea", name = "<init>", descriptor = "()V", line = 37)
    public class109() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(BIII)[B", line = 44)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(IIII)I", line = 58)
    ...
    @OriginalMember(owner = "client!cea", name = "f", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(ZIIII[Lsha;)V", line = 88)
