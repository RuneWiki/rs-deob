...
public class class109 extends class5 {
    ...
    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "()V", line = 7)
    public class109() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(ILes;I)V", line = 10)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(IZ)[[I", line = 85)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(II)[I", line = 147)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 169)
    public static final int method611(String arg0, byte arg1) {
        ++field1437;
        return arg1 != 2 ? 39 : 1 + arg0.length();
    }

    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(B[[I)V", line = 180)
    ...
    @OriginalMember(owner = "client!cq", name = "b", descriptor = "(IZI)Ljava/lang/String;", line = 230)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(IIB)Lwd;", line = 272)
