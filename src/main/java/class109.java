...
public class class109 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IIIIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(B)Lpk;", line = 27)
    ...
    @OriginalMember(owner = "client!di", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 45)
