...
public class class109 implements class607 {
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(IIBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(BLmha;[IJ)Ljava/lang/String;", line = 48)
