...
public class class109 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IB)Lwh;", line = 5)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Ldk;ZLdk;)I", line = 32)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(IB)Ljp;", line = 101)
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(Lad;ILdk;Ldk;Ldk;)V", line = 221)
    ...
    @OriginalMember(owner = "client!ec", name = "c", descriptor = "(I)[Lvr;", line = 147)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(II)V", line = 157)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lat;Lza;B)V", line = 173)
    ...
    @OriginalMember(owner = "client!ec", name = "d", descriptor = "(I)V", line = 192)
