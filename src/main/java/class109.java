...
public class class109 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Ljd;I)Lnea;")
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(Lnd;Lnd;)V")
    public class109(class547 arg0, class547 arg1) {
        this.field1576 = arg1;
        this.field1578 = arg0;
    }

    @OriginalMember(owner = "client!er", name = "c", descriptor = "(I)Lwda;")
