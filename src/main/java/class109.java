...
public class class109 extends class210 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "(B)Lab;", line = 5)
    ...
    @OriginalMember(owner = "client!fd", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 15)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method725((byte) 79, arg0);
        field1509++;
    }

    @OriginalMember(owner = "client!fd", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 23)
    ...
    @OriginalMember(owner = "client!fd", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 51)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        field1506++;
        this.method725((byte) 79, arg0);
    }

    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 62)
    ...
    @OriginalMember(owner = "client!fd", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 73)
    ...
    @OriginalMember(owner = "client!fd", name = "d", descriptor = "(B)I", line = 85)
    public final int method717(byte arg0) {
        field1504++;
        return arg0 == 82 ? this.field1500 : -97;
    }

    @OriginalMember(owner = "client!fd", name = "f", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!fd", name = "g", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "(I)Z", line = 120)
    ...
    @OriginalMember(owner = "client!fd", name = "c", descriptor = "(B)I", line = 131)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Ljava/awt/Component;B)V", line = 142)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Z)V", line = 157)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(I)V", line = 180)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(BLjava/awt/event/MouseEvent;)V", line = 209)
    ...
    @OriginalMember(owner = "client!fd", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 231)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IIBI)V", line = 244)
    ...
    @OriginalMember(owner = "client!fd", name = "e", descriptor = "(B)Z", line = 261)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;I)I", line = 275)
    ...
    @OriginalMember(owner = "client!fd", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 316)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method725((byte) 79, arg0);
        field1505++;
    }

    @OriginalMember(owner = "client!fd", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 324)
    ...
    @OriginalMember(owner = "client!fd", name = "c", descriptor = "(I)Z", line = 351)
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 386)
