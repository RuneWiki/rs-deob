...
public class class109 {
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(B)Ldi;", line = 17)
    ...
    @OriginalMember(owner = "client!ju", name = "c", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IIIBIILjava/lang/String;I)V", line = 47)
