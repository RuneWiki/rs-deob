...
public class class109 {
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(B)Z", line = 8)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Lbi;Lbi;ILbi;Lnb;)Z", line = 36)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(IIILed;IIIIZII)Z", line = 53)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(I)V", line = 299)
    ...
    @OriginalMember(owner = "client!laa", name = "<init>", descriptor = "(Lno;)V", line = 308)
    public class109(class658 arg0) {
        this.field1592 = arg0;
    }

    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(IFLij;Lij;)Z", line = 324)
