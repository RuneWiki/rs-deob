...
public class class109 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(ZIIIIII)V", line = 67)
    ...
    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(B)V", line = 115)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(IIII)I", line = 127)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(ILja;I)Z", line = 176)
