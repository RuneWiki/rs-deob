...
public class class109 extends class227 {
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "()V", line = 3)
    public class109() {
        super(3, false);
    }

    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IZ)[[I", line = 15)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Lug;II)V", line = 94)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(II)[I", line = 139)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IIZ)V", line = 192)
