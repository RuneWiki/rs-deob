...
public class class109 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(ZB)V", line = 6)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(II)V", line = 85)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(Lwu;Loaa;Llw;IIIII)V", line = 334)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Z)V", line = 276)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Ljf;II)V", line = 291)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(III)V", line = 312)
