...
public class class109 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IZ)I", line = 5)
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "([I)V", line = 32)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(B)V", line = 103)
