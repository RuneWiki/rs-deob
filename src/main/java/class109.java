...
public class class109 extends class535 implements class68 {
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(Z)Z", line = 3)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(ILqa;I)Lka;", line = 14)
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(I)I", line = 26)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Lnj;Z)Ljava/lang/String;", line = 43)
    ...
    @OriginalMember(owner = "client!kt", name = "f", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(ILa;IIILqa;Z)V", line = 64)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(ILqa;)Lou;", line = 75)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Lqa;I)V", line = 86)
    ...
    @OriginalMember(owner = "client!kt", name = "d", descriptor = "(I)I", line = 101)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(I)Z", line = 113)
    public final boolean method339(int arg0) {
        field1526++;
        return arg0 != 3583;
    }

    @OriginalMember(owner = "client!kt", name = "g", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(B)V", line = 136)
    ...
    @OriginalMember(owner = "client!kt", name = "c", descriptor = "(I)I", line = 186)
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(ZLqa;)V", line = 199)
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(IIIIILkr;)V", line = 214)
    ...
    @OriginalMember(owner = "client!kt", name = "e", descriptor = "(I)V", line = 230)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(ZLqa;)V", line = 241)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(BIILqa;)Z", line = 251)
