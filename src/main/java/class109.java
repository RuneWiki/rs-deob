...
public class class109 extends class578 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(IB)Z", line = 6)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(BI)Z", line = 21)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(ZI)V", line = 32)
    ...
    @OriginalMember(owner = "client!ut", name = "d", descriptor = "(I)Z", line = 48)
    ...
    @OriginalMember(owner = "client!ut", name = "b", descriptor = "(BI)Z", line = 158)
    public final boolean method788(byte arg0, int arg1) {
        field1515++;
        return arg0 <= 114 ? false : this.field1510[arg1].field2585;
    }

    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 172)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(IB[F)[F", line = 278)
    ...
    @OriginalMember(owner = "client!ut", name = "g", descriptor = "(I)V", line = 293)
    ...
    @OriginalMember(owner = "client!ut", name = "<init>", descriptor = "(I)V", line = 316)
