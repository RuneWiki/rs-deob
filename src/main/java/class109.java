...
public class class109 extends class130 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILfh;)V", line = 16)
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "()V", line = 63)
    public class109() {
    }

    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 67)
