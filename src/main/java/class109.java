...
public class class109 extends class634 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Lmc;BLmc;)V", line = 3)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(ILig;Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!rv", name = "f", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!rv", name = "c", descriptor = "(B)V", line = 124)
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "()V", line = 310)
    public class109() {
        super(0, true);
    }

    @OriginalMember(owner = "client!rv", name = "b", descriptor = "(BI)[I", line = 141)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Z)V", line = 246)
