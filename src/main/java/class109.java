...
public class class109 extends class185 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IZZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "(Ljaa;IIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!co", name = "c", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIIIIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IBII)V", line = 70)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "(Ljaa;IIIIZ[FI)V", line = 87)
    ...
    @OriginalMember(owner = "client!co", name = "c", descriptor = "(II)I", line = 109)
    public static int method762(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!co", name = "a", descriptor = "([[[Lqs;ZIIII)Z", line = 116)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "(Ljaa;IIII)V", line = 432)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIZIIII[II)V", line = 444)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "(Ljaa;IIIIZ[BIZ)V", line = 497)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "(Ljaa;IIIIZ[IZ)V", line = 562)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(B)V", line = 617)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIIZ[BZIIII)V", line = 630)
