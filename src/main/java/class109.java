...
public class class109 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(ZI)Lgv;")
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(Lgv;B)V")
    ...
    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "(Lgv;)V")
