...
public class class109 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ILjagdx/IDirect3DSurface;Ljagdx/IDirect3DSwapChain;)V", line = 34)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(II)I", line = 44)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 52)
    public class109(IDirect3DSwapChain arg0, IDirect3DSurface arg1) {
        this.method1024(0, arg1, arg0);
    }

    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(I)Z", line = 61)
