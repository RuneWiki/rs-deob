...
public class class109 extends class260 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(II[FIIFIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(I)V", line = 92)
    public class109(int arg0) {
        this.field1639 = arg0;
    }

    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Lmg;III)Lkq;", line = 73)
