...
public abstract class class109 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(II)Lsg;", line = 17)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ILtq;)V", line = 40)
    ...
    @OriginalMember(owner = "client!oe", name = "b", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(III)Ltn;", line = 75)
