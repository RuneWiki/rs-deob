...
public abstract class class515 implements class239 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(FFFFFFLaa;II)V")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(FFFFIILaa;II)V")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(FFIILaa;II)V")
