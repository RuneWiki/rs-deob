...
public class class515 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(B)Lfca;")
    ...
    @OriginalMember(owner = "client!qd", name = "c", descriptor = "(I)Lfca;")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Lfd;B)V")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Lfd;II)V")
