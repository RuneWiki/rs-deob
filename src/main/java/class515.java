...
public class class515 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(III)Lrh;")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(II)Lvc;")
    public static final class337 method2993(int arg0, int arg1) {
        field7048++;
        return arg0 == -3 ? new class337(arg1, false) : null;
    }

    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lha;II)Z")
