...
public class class515 extends class215 implements class448 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(IBLza;)Le;")
    ...
    @OriginalMember(owner = "client!bo", name = "c", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!bo", name = "b", descriptor = "(BLza;)Luc;")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(IIIZILot;Lza;)V")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(ILza;)V")
    ...
    @OriginalMember(owner = "client!bo", name = "<init>", descriptor = "(Lza;Ler;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(ILza;BI)Z")
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(IB)Z")
