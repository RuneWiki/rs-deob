...
public class class515 extends class417 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ILjava/lang/Object;II)[B", line = 6)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 57)
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(II)V", line = 72)
