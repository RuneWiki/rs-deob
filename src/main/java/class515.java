...
public class class515 extends class530 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(I)I", line = 3)
    public final int method74(int arg0) {
        ++field7183;
        return arg0 != 0 ? 51 : 2;
    }

    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(ILah;)V", line = 32)
    public class515(int arg0, class374 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!od", name = "b", descriptor = "(I)Lfj;", line = 42)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lha;II)Lcw;", line = 63)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IBC)C", line = 89)
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(II)V", line = 169)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(II)I", line = 180)
    ...
    @OriginalMember(owner = "client!od", name = "c", descriptor = "(I)I", line = 190)
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(Lah;)V", line = 202)
