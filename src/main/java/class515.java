...
public class class515 extends class661 {
    ...
    @OriginalMember(owner = "client!gq", name = "j", descriptor = "(I)I")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Lbca;)V")
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "()Lbca;")
