...
public class class515 extends class61 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(CIIIZLaa;II)V", line = 2)
    public final void method76(char arg0, int arg1, int arg2, int arg3, boolean arg4, class487 arg5, int arg6, int arg7) {
    }

    @OriginalMember(owner = "client!gq", name = "fa", descriptor = "(CIIIZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Luv;Lmv;[Ltw;Z)V", line = 31)
