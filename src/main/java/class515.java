...
public class class515 {
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "([IZIII[I[Laf;)V")
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(I[ILco;IBZLds;Lgf;Lco;IILme;Lgl;ILit;Lqi;Lha;III[Lgda;)Lka;")
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(Lco;IILha;Lds;Lqi;Lgl;Lme;Lgf;III)Lka;")
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(Lha;ILds;ILgf;Lco;IIIIIB)Lka;")
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(Lds;III)V")
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(IBILgl;)V")
