...
public class class515 extends class168 {
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(IILha;Lqe;ZZIIILmk;)Lka;", line = 3)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(IILria;I)V", line = 247)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(II)V", line = 322)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(B)V", line = 342)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "([IIZI[I)J", line = 354)
