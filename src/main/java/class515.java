...
public class class515 {
    ...
    @OriginalMember(owner = "client!eo", name = "b", descriptor = "(I)[Lnn;")
    ...
    @OriginalMember(owner = "client!eo", name = "b", descriptor = "(II)Ltk;")
    ...
    @OriginalMember(owner = "client!eo", name = "<init>", descriptor = "(Ljc;IZLgp;Lgp;)V")
