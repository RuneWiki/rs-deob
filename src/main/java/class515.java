...
public class class515 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(II)Lco;", line = 7)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(IB)V", line = 37)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(IB)V", line = 78)
    ...
    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "(Lai;ILic;)V", line = 120)
