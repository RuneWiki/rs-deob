...
public class class515 extends class539 {
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Ljava/io/File;Ljava/lang/String;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!tv", name = "<init>", descriptor = "(II)V", line = 57)
    public class515(int arg0, int arg1) {
        this.field7039 = arg1;
        this.field7033 = arg0;
    }

    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IIIIII)V", line = 66)
