...
public class class515 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(BILvg;)V", line = 7)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(III)Z", line = 74)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IB)Z", line = 85)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 99)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(I)V", line = 131)
