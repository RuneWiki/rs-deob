...
public class class515 extends class184 {
    ...
    @OriginalMember(owner = "client!cc", name = "e", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(II)[[I", line = 27)
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "()V", line = 163)
    public class515() {
        super(1, false);
    }

    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(BILfh;)V", line = 175)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(II)[I", line = 219)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;IBI)V", line = 318)
    ...
    @OriginalMember(owner = "client!cc", name = "c", descriptor = "(B)V", line = 352)
