...
public class class515 implements class690 {
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(B)Lam;")
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(Lkba;B)I")
    ...
    @OriginalMember(owner = "client!wha", name = "<init>", descriptor = "(Lkha;)V")
