...
public class class515 {
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(II)V", line = 12)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(III[IIIII)Z", line = 28)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(B)V", line = 138)
