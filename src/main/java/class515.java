...
public class class515 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Lov;Z[[[BIB)Z", line = 46)
