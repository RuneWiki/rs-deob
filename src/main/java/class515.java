...
public class class515 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Liaa;I)V")
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Lwm;I)Z")
    ...
    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "(Liaa;)V")
