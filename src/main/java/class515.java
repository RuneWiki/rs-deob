...
public class class515 {
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(IIILk;II)Ljava/awt/Frame;", line = 35)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(III)Z", line = 104)
