...
public class class515 extends class508 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(IZLjava/lang/String;)V", line = 21)
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "(II)V", line = 93)
