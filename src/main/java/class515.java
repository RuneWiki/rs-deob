...
public class class515 extends class322 {
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(Lch;)V")
    ...
    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(Z)I")
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(ILch;)V")
