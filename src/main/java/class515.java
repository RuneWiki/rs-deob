...
public class class515 {
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(ILjava/lang/String;)J", line = 6)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(Lkk;Ljava/awt/Frame;I)V", line = 26)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(IIIIIIIII)V", line = 51)
