...
public class class515 extends class255 implements Runnable {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Lqa;Lha;IIIII)V")
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(Lms;)V")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(IIIIFLee;FFIFFI[B)V")
