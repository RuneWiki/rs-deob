...
public class class515 extends class481 implements class602 {
    ...
    @OriginalMember(owner = "client!hca", name = "h", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!hca", name = "b", descriptor = "(B)Z", line = 18)
    public final boolean method126(byte arg0) {
        ++field7173;
        return arg0 != -34;
    }

    @OriginalMember(owner = "client!hca", name = "e", descriptor = "(Lha;B)V", line = 29)
    ...
    @OriginalMember(owner = "client!hca", name = "c", descriptor = "(Lha;B)Lpia;", line = 55)
    ...
    @OriginalMember(owner = "client!hca", name = "d", descriptor = "(Lha;B)Lln;", line = 105)
    public final class398 method119(class66 arg0, byte arg1) {
        ++field7157;
        return arg1 > -35 ? null : this.field7164;
    }

    @OriginalMember(owner = "client!hca", name = "c", descriptor = "(I)I", line = 116)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(ILfq;BIILha;Z)V", line = 127)
    ...
    @OriginalMember(owner = "client!hca", name = "i", descriptor = "(I)Z", line = 140)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(I)I", line = 150)
    ...
    @OriginalMember(owner = "client!hca", name = "j", descriptor = "(I)V", line = 161)
    ...
    @OriginalMember(owner = "client!hca", name = "b", descriptor = "(Z)I", line = 195)
    ...
    @OriginalMember(owner = "client!hca", name = "<init>", descriptor = "(Lha;Llp;IIIIIZIII)V", line = 207)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Z)V", line = 216)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Ldt;B)Lps;", line = 230)
    ...
    @OriginalMember(owner = "client!hca", name = "g", descriptor = "(I)Z", line = 242)
    public final boolean method769(int arg0) {
        ++field7158;
        return arg0 >= -70 ? false : false;
    }

    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(B)Z", line = 257)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(II)V", line = 271)
    ...
    @OriginalMember(owner = "client!hca", name = "d", descriptor = "(B)I", line = 285)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Lha;B)V", line = 298)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Ljca;Z)V", line = 309)
    public final void method3009(class711 arg0, boolean arg1) {
        this.field7179.method2349(arg0, arg1);
        ++field7168;
    }

    @OriginalMember(owner = "client!hca", name = "b", descriptor = "(I)I", line = 317)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(ILha;II)Z", line = 328)
    ...
    @OriginalMember(owner = "client!hca", name = "b", descriptor = "(Lha;B)V", line = 349)
    ...
    @OriginalMember(owner = "client!hca", name = "c", descriptor = "(Z)V", line = 360)
