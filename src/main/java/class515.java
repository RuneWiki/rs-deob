...
public class class515 extends class552 {
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "()V", line = 12)
    ...
    @OriginalMember(owner = "client!hw", name = "b", descriptor = "()I", line = 47)
    public final int method2922() {
        return this.field7162 - (this.field7163.available() >> (class59.field747 ? 2 : 1));
    }

    @OriginalMember(owner = "client!hw", name = "c", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 59)
    ...
    @OriginalMember(owner = "client!hw", name = "d", descriptor = "()V", line = 81)
    ...
    @OriginalMember(owner = "client!hw", name = "c", descriptor = "()V", line = 95)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 115)
