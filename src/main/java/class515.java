...
public class class515 {
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(Lfu;IILrca;Lr;Llq;II)V", line = 20)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(IIII)V", line = 68)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(B)V", line = 98)
