...
public class class515 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(IB)I", line = 3)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Z)V", line = 68)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Ljava/lang/Throwable;I)Ljava/lang/String;", line = 80)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(I)V", line = 153)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Luu;B)Ljava/lang/String;", line = 307)
