...
public class class515 extends class259 implements class401 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(ILya;II)Z")
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(BLya;)V")
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(ILya;I)Lt;")
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Lya;IIILqj;IZ)V")
    ...
    @OriginalMember(owner = "client!wl", name = "<init>", descriptor = "(Lya;Lpf;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Lya;B)V")
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(Lya;I)Lmo;")
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Lya;I)V")
