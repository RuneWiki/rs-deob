...
public class class515 extends class321 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(FI)V")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(Lkea;B)V")
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(ZIII)V")
