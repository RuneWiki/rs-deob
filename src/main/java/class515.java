...
public class class515 {
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(BLoc;)V")
    ...
    @OriginalMember(owner = "client!hca", name = "b", descriptor = "(I)Loc;")
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(B)Loc;")
