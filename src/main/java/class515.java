...
public class class515 extends class478 implements class447 {
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(Luaa;III)V")
    ...
    @OriginalMember(owner = "client!pga", name = "<init>", descriptor = "(Lck;ILjaclib/memory/Buffer;)V")
    ...
    @OriginalMember(owner = "client!pga", name = "<init>", descriptor = "(Lck;I[BI)V")
