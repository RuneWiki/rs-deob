...
public class class515 extends class114 {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Lqq;[[BB)V", line = 8)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IIB)I", line = 41)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ILnj;)V", line = 63)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Lnj;II)V", line = 90)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IB)V", line = 136)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Ljava/lang/String;II)Ljava/lang/String;", line = 151)
    ...
    @OriginalMember(owner = "client!dr", name = "b", descriptor = "(B)V", line = 171)
