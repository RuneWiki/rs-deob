...
public class class746 extends class91 implements class722 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Lha;I)Lua;")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(BLha;ZILuq;II)V")
    ...
    @OriginalMember(owner = "client!oq", name = "b", descriptor = "(Lha;B)Liha;")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Lkea;I)V")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ILha;IB)Z")
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "(Lha;Lts;IIIIIZIII)V")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Lha;Z)V")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ZLha;)V")
