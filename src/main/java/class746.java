...
public class class746 extends class310 {
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(JI)I", line = 3)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(Z)J", line = 36)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(I)J", line = 56)
    ...
    @OriginalMember(owner = "client!jga", name = "c", descriptor = "(I)J", line = 75)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(B)V", line = 112)
