...
public class class746 extends class107 {
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(BLso;)Lno;")
    ...
    @OriginalMember(owner = "client!jga", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZJZ)V")
