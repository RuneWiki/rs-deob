...
public class class746 extends class524 implements class706 {
    ...
    @OriginalMember(owner = "client!wga", name = "e", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(Ljb;III)V", line = 14)
    ...
    @OriginalMember(owner = "client!wga", name = "c", descriptor = "(B)I", line = 29)
    ...
    @OriginalMember(owner = "client!wga", name = "d", descriptor = "(I)Z", line = 40)
    ...
    @OriginalMember(owner = "client!wga", name = "i", descriptor = "(I)I", line = 51)
    public final int method749(int arg0) {
        ++field10370;
        return arg0 != 32767 ? 99 : this.field10381.method3760((byte) -111);
    }

    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(BLha;)V", line = 65)
    ...
    @OriginalMember(owner = "client!wga", name = "g", descriptor = "(B)I", line = 86)
    public final int method750(byte arg0) {
        ++field10383;
        return arg0 != 14 ? 49 : this.field10381.method3766(-95);
    }

    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(I)I", line = 102)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(ZLha;IILkba;II)V", line = 113)
    ...
    @OriginalMember(owner = "client!wga", name = "l", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!wga", name = "b", descriptor = "(B)I", line = 136)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(ILha;)V", line = 150)
    ...
    @OriginalMember(owner = "client!wga", name = "b", descriptor = "(ILha;)Lkj;", line = 163)
    ...
    @OriginalMember(owner = "client!wga", name = "<init>", descriptor = "(Lha;Lhba;IIIIIZIIIIIII)V", line = 175)
    ...
    @OriginalMember(owner = "client!wga", name = "b", descriptor = "(BLha;)Lml;", line = 185)
    ...
    @OriginalMember(owner = "client!wga", name = "k", descriptor = "(I)V", line = 234)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(Lha;III)Z", line = 246)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(B)Z", line = 266)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(Z)Z", line = 281)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(III)V", line = 292)
    ...
    @OriginalMember(owner = "client!wga", name = "d", descriptor = "(B)V", line = 430)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(Lha;B)V", line = 440)
