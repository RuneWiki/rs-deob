...
public class PixFont extends Pix2D {
	...
	@ObfuscatedName("YXVQXWYR.x")
	public boolean _flowObfuscator9 = false;

	@ObfuscatedName("YXVQXWYR.y")
	public int _flowObfuscator10 = 445;

	@ObfuscatedName("YXVQXWYR.z")
	public int _flowObfuscator11 = -471;

	@ObfuscatedName("YXVQXWYR.A")
	public int _flowObfuscator12 = -471;

	@ObfuscatedName("YXVQXWYR.B")
	public boolean _flowObfuscator13 = false;

	@ObfuscatedName("YXVQXWYR.C")
	public int _flowObfuscator14 = 3;

	@ObfuscatedName("YXVQXWYR.D")
	public boolean _flowObfuscator15 = false;

	@ObfuscatedName("YXVQXWYR.E")
	public byte[][] charMask = new byte[256][];

	@ObfuscatedName("YXVQXWYR.F")
	public int[] charMaskWidth = new int[256];

	@ObfuscatedName("YXVQXWYR.G")
	public int[] charMaskHeight = new int[256];

	@ObfuscatedName("YXVQXWYR.H")
	public int[] charOffsetX = new int[256];

	@ObfuscatedName("YXVQXWYR.I")
	public int[] charOffsetY = new int[256];

	@ObfuscatedName("YXVQXWYR.J")
	public int[] charAdvance = new int[256];

	@ObfuscatedName("YXVQXWYR.L")
	public Random random = new Random();

	@ObfuscatedName("YXVQXWYR.M")
	public boolean strikethrough = false;

	@ObfuscatedName("YXVQXWYR.K")
	public int height;
	...
	@ObfuscatedName("YXVQXWYR.a(Ljava/lang/String;IIBI)V")
	...
	@ObfuscatedName("YXVQXWYR.a(ILjava/lang/String;III)V")
	...
	@ObfuscatedName("YXVQXWYR.a(IIILjava/lang/String;IZ)V")
	...
	@ObfuscatedName("YXVQXWYR.a(ILjava/lang/String;)I")
	...
	@ObfuscatedName("YXVQXWYR.a(Ljava/lang/String;Z)I")
	...
	@ObfuscatedName("YXVQXWYR.b(ILjava/lang/String;III)V")
	public void drawString(int arg0, String arg1, int arg2, int arg3, int arg4) {
		...
		for (int var7 = 0; var7 < arg1.length(); var7++) {
			...
			if (var9 != ' ') {
				this.drawChar(this.charMask[var9], this.charOffsetX[var9] + arg4, this.charOffsetY[var9] + var6, this.charMaskWidth[var9], this.charMaskHeight[var9], arg0);
			}
	...
	@ObfuscatedName("YXVQXWYR.a(IZLjava/lang/String;III)V")
	public void drawStringWave(int arg0, boolean arg1, String arg2, int arg3, int arg4, int arg5) {
		...
		for (int var9 = 0; var9 < arg2.length(); var9++) {
			...
			if (var10 != ' ') {
				this.drawChar(this.charMask[var10], this.charOffsetX[var10] + var7, this.charOffsetY[var10] + var8 + (int) (Math.sin((double) arg4 / 5.0D + (double) var9 / 2.0D) * 5.0D), this.charMaskWidth[var10], this.charMaskHeight[var10], arg0);
			}
			var7 += this.charAdvance[var10];
		}
	}

	@ObfuscatedName("YXVQXWYR.a(ILjava/lang/String;IIBI)V")
	public void drawStringWave2(int arg0, String arg1, int arg2, int arg3, byte arg4, int arg5) {
		...
		for (int var9 = 0; var9 < arg1.length(); var9++) {
			...
			if (var10 != ' ') {
				this.drawChar(this.charMask[var10], this.charOffsetX[var10] + var7 + (int) (Math.sin((double) arg2 / 5.0D + (double) var9 / 5.0D) * 5.0D), this.charOffsetY[var10] + var8 + (int) (Math.sin((double) arg2 / 5.0D + (double) var9 / 3.0D) * 5.0D), this.charMaskWidth[var10], this.charMaskHeight[var10], arg5);
			}
			var7 += this.charAdvance[var10];
		}
	}

	@ObfuscatedName("YXVQXWYR.a(ILjava/lang/String;ZIIII)V")
	public void drawStringShake(int arg0, String arg1, boolean arg2, int arg3, int arg4, int arg5, int arg6) {
		...
		for (int var13 = 0; var13 < arg1.length(); var13++) {
			...
			if (var14 != ' ') {
				this.drawChar(this.charMask[var14], this.charOffsetX[var14] + var11, this.charOffsetY[var14] + var12 + (int) (Math.sin((double) var13 / 1.5D + (double) arg3) * var9), this.charMaskWidth[var14], this.charMaskHeight[var14], arg6);
			}
			var11 += this.charAdvance[var14];
		}
	}

	@ObfuscatedName("YXVQXWYR.a(ZZIILjava/lang/String;I)V")
	public void drawStringTag(boolean arg0, boolean arg1, int arg2, int arg3, String arg4, int arg5) {
		...
		for (int var9 = 0; var9 < arg4.length(); var9++) {
			if (arg4.charAt(var9) == '@' && var9 + 4 < arg4.length() && arg4.charAt(var9 + 4) == '@') {
				...
				if (var11 != ' ') {
					if (arg1) {
						this.drawChar(this.charMask[var11], this.charOffsetX[var11] + arg2 + 1, this.charOffsetY[var11] + var8 + 1, this.charMaskWidth[var11], this.charMaskHeight[var11], 0);
					}
					this.drawChar(this.charMask[var11], this.charOffsetX[var11] + arg2, this.charOffsetY[var11] + var8, this.charMaskWidth[var11], this.charMaskHeight[var11], arg3);
				}
				arg2 += this.charAdvance[var11];
			}
		}
		if (!arg0 && this.strikethrough) {
			Pix2D.drawHorizontalLine((int) ((double) this.height * 0.7D) + var8, 8388608, arg2 - var7, var7, (byte) 4);
		}
	}

	@ObfuscatedName("YXVQXWYR.a(ZIILjava/lang/String;III)V")
	public void drawStringTooltip(boolean arg0, int arg1, int arg2, String arg3, int arg4, int arg5, int arg6) {
		...
		for (int var11 = 0; var11 < arg3.length(); var11++) {
			if (arg3.charAt(var11) == '@' && var11 + 4 < arg3.length() && arg3.charAt(var11 + 4) == '@') {
				...
				if (var13 != ' ') {
					if (arg0) {
						this.drawCharAlpha(192, this.charOffsetX[var13] + arg1 + 1, this.charMask[var13], this.charMaskWidth[var13], this.charOffsetY[var13] + var9 + 1, this.charMaskHeight[var13], false, 0);
					}
					this.drawCharAlpha(var8, this.charOffsetX[var13] + arg1, this.charMask[var13], this.charMaskWidth[var13], this.charOffsetY[var13] + var9, this.charMaskHeight[var13], false, arg2);
				}
	...
	@ObfuscatedName("YXVQXWYR.a(Ljava/lang/String;I)I")
	...
	@ObfuscatedName("YXVQXWYR.a([BIIIII)V")
	...
	@ObfuscatedName("YXVQXWYR.a([I[BIIIIIII)V")
	...
	@ObfuscatedName("YXVQXWYR.a(II[BIIIZI)V")
	public void drawCharAlpha(int arg0, int arg1, byte[] arg2, int arg3, int arg4, int arg5, boolean arg6, int arg7) {
		...
		if (arg1 + arg3 >= Pix2D.right) {
			int var15 = arg1 + arg3 - Pix2D.right + 1;
			arg3 -= var15;
			var11 += var15;
			var10 += var15;
		}
		...
		this.copyPixelsAlpha(arg2, arg5, var9, Pix2D.data, 520, var12, arg3, var11, var10, arg7, arg0);
		if (arg6) {
	...
	@ObfuscatedName("YXVQXWYR.a([BII[IIIIIIII)V")
	public void copyPixelsAlpha(byte[] arg0, int arg1, int arg2, int[] arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10) {
		int var12 = 98 / arg4;
