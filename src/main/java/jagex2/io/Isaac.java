...
public class Isaac {
	...
	@ObfuscatedName("JOCFVBOI.a")
	public int _flowObfuscator1 = -436;

	@ObfuscatedName("JOCFVBOI.b")
	public int _flowObfuscator2 = -431;

	@ObfuscatedName("JOCFVBOI.e")
	public int[] mem = new int[256];

	@ObfuscatedName("JOCFVBOI.d")
	public int[] rsl = new int[256];

	@ObfuscatedName("JOCFVBOI.c")
	public int count;

	@ObfuscatedName("JOCFVBOI.f")
	public int a;

	@ObfuscatedName("JOCFVBOI.g")
	public int b;

	@ObfuscatedName("JOCFVBOI.h")
	public int c;
