...
public class class249 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IFFF)I", line = 3)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(II)V", line = 46)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IBI)V", line = 65)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(II)Lsl;", line = 115)
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(B)V", line = 156)
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(Lgt;ILdn;Ldn;)V", line = 180)
