...
public class class249 extends class578 implements class141 {
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(ILha;Lfd;ILgba;IBILnd;)V", line = 7)
    ...
    @OriginalMember(owner = "client!gca", name = "h", descriptor = "(B)Z", line = 52)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(B)I", line = 63)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Lha;Z)Ltb;", line = 73)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(BILha;Lgs;ZII)V", line = 89)
    ...
    @OriginalMember(owner = "client!gca", name = "f", descriptor = "(B)Z", line = 109)
    ...
    @OriginalMember(owner = "client!gca", name = "c", descriptor = "(BLha;)V", line = 124)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(BLha;ZI)Lnj;", line = 134)
    ...
    @OriginalMember(owner = "client!gca", name = "g", descriptor = "(B)Z", line = 165)
    ...
    @OriginalMember(owner = "client!gca", name = "b", descriptor = "(BLha;)Lvw;", line = 180)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Lha;ZI)Lka;", line = 210)
    ...
    @OriginalMember(owner = "client!gca", name = "b", descriptor = "(B)I", line = 230)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Lha;I)V", line = 240)
    ...
    @OriginalMember(owner = "client!gca", name = "f", descriptor = "(I)V", line = 266)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(ZBI)V", line = 283)
    ...
    @OriginalMember(owner = "client!gca", name = "b", descriptor = "(I)V", line = 313)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(I)Z", line = 329)
    public final boolean method1113(int arg0) {
        ++field3478;
        return arg0 != -24333 ? true : this.field3490;
    }

    @OriginalMember(owner = "client!gca", name = "d", descriptor = "(B)I", line = 342)
    ...
    @OriginalMember(owner = "client!gca", name = "h", descriptor = "(I)I", line = 353)
    ...
    @OriginalMember(owner = "client!gca", name = "i", descriptor = "(I)V", line = 365)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(BLha;)V", line = 375)
    ...
    @OriginalMember(owner = "client!gca", name = "<init>", descriptor = "(Lha;Luw;IIIIIZIZ)V", line = 404)
    ...
    @OriginalMember(owner = "client!gca", name = "i", descriptor = "(B)V", line = 441)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Z)I", line = 475)
    public final int method1111(boolean arg0) {
        ++field3489;
        return arg0 ? 116 : this.field3492;
    }

    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Lha;IZI)Z", line = 486)
