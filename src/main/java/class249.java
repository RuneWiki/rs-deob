...
public class class249 extends class14 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IBLmd;)V", line = 3)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!he", name = "e", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(II)[[I", line = 128)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IIZI)V", line = 202)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IIIIIIIBII)V", line = 309)
