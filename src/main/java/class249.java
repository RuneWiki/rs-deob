...
public abstract class class249 extends class276 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!kf", name = "e", descriptor = "(I)I", line = 80)
    public final int method1688(int arg0) {
        field4248++;
        return arg0 > -21 ? -114 : 1;
    }

    @OriginalMember(owner = "client!kf", name = "f", descriptor = "(I)Z", line = 91)
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "(Lih;)V", line = 103)
    public class249(class214 arg0) {
        this.field4249 = arg0;
    }

    @OriginalMember(owner = "client!kf", name = "g", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!kf", name = "h", descriptor = "(I)Z", line = 198)
