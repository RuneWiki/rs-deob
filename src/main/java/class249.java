...
public class class249 extends class135 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Lqq;BII)Z")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(I[[[Loh;)V")
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "(ZLqq;)V")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(BLqq;)Lkm;")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(ILqq;Lps;ZZII)V")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(BLat;)V")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(ILqq;I)Z")
