...
public abstract class class249 extends class578 {
    ...
    @OriginalMember(owner = "client!up", name = "g", descriptor = "(I)[Lfc;")
    ...
    @OriginalMember(owner = "client!up", name = "c", descriptor = "(B)[Lch;")
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(Loga;I)V")
