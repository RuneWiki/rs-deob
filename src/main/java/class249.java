...
public class class249 extends class255 implements class196 {
    ...
    @OriginalMember(owner = "client!hp", name = "h", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lqa;I)Lpj;", line = 14)
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(I)I", line = 56)
    ...
    @OriginalMember(owner = "client!hp", name = "g", descriptor = "(I)I", line = 84)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(B)I", line = 95)
    public final int method63(byte arg0) {
        ++field3465;
        return arg0 != 63 ? -89 : this.field3447.field6432;
    }

    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(BLqa;)V", line = 107)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ILqa;)V", line = 121)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(I)I", line = 131)
    ...
    @OriginalMember(owner = "client!hp", name = "i", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!hp", name = "c", descriptor = "(B)V", line = 215)
    public final void method59(byte arg0) {
        int var2 = -73 % ((arg0 - 27) / 63);
        ++field3452;
    }

    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IIILqa;)Z", line = 227)
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(BLqa;)V", line = 250)
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(B)Z", line = 272)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Lqa;Leu;IIIIIZIIIIII)V", line = 288)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ILqa;B)Lc;", line = 297)
