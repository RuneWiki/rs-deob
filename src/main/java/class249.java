...
public class class249 implements Runnable {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(ILjava/lang/String;)Lmn;")
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(ILvm;III[BZBI[Lqs;)[I")
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(ILgl;)V")
