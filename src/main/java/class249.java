...
public class class249 {
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(I)Lcf;")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(BLoe;)V")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(B)Lcf;")
    ...
    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "(Loe;)V")
