...
public class class249 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lsm;BLag;)V", line = 5)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(BLag;)V", line = 33)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Ltq;Z)Z", line = 52)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(I)Lag;", line = 156)
    ...
    @OriginalMember(owner = "client!sm", name = "b", descriptor = "(I)Lag;", line = 178)
    ...
    @OriginalMember(owner = "client!sm", name = "c", descriptor = "(I)Lag;", line = 209)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(B)Lag;", line = 233)
    ...
    @OriginalMember(owner = "client!sm", name = "d", descriptor = "(I)I", line = 253)
    ...
    @OriginalMember(owner = "client!sm", name = "e", descriptor = "(I)Lag;", line = 275)
    ...
    @OriginalMember(owner = "client!sm", name = "f", descriptor = "(I)Z", line = 293)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ILsm;)V", line = 304)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Ljava/lang/String;Z)Z", line = 320)
    ...
    @OriginalMember(owner = "client!sm", name = "b", descriptor = "(B)V", line = 357)
    ...
    @OriginalMember(owner = "client!sm", name = "b", descriptor = "(BLag;)V", line = 380)
    ...
    @OriginalMember(owner = "client!sm", name = "g", descriptor = "(I)V", line = 401)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lms;B)Lms;", line = 417)
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "()V", line = 440)
    public class249() {
