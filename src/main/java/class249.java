...
public abstract class class249 {
    ...
    @OriginalMember(owner = "client!cca", name = "<init>", descriptor = "(Lwh;)V", line = 17)
    public class249(class148 arg0) {
        this.field3613 = arg0;
    }

    @OriginalMember(owner = "client!cca", name = "c", descriptor = "(I)V", line = 28)
    public static void method1647(int arg0) {
        field3611 = null;
        int var1 = 104 % ((arg0 + 53) / 32);
    }

    @OriginalMember(owner = "client!cca", name = "b", descriptor = "(III)V", line = 37)
