...
public class class249 extends class45 {
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Lr;BLwv;)V")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Ljava/lang/String;II)Lew;")
    ...
    @OriginalMember(owner = "client!wda", name = "<init>", descriptor = "(Lag;Lal;Lqea;[I)V")
