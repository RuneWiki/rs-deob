...
public class class249 extends class134 {
    ...
    @OriginalMember(owner = "client!dea", name = "b", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(IJ)V", line = 20)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(IC)I", line = 100)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(I)I", line = 115)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(B)V", line = 130)
    ...
    @OriginalMember(owner = "client!dea", name = "<init>", descriptor = "(Lkda;)V", line = 147)
    public class249(class391 arg0) {
        super(arg0);
        class727.method4077(-119, super.field1708);
    }

    @OriginalMember(owner = "client!dea", name = "<init>", descriptor = "(ILkda;)V", line = 159)
    public class249(int arg0, class391 arg1) {
        super(arg0, arg1);
        class727.method4077(-44, super.field1708);
    }

    @OriginalMember(owner = "client!dea", name = "c", descriptor = "(I)Z", line = 167)
    public final boolean method1493(int arg0) {
        ++field3233;
        return super.field1712.method2280(-100).method3189(arg0) >= 96;
    }

    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(II)V", line = 182)
    ...
    @OriginalMember(owner = "client!dea", name = "c", descriptor = "(II)I", line = 193)
