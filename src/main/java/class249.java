...
public class class249 extends class105 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(ILm;)V", line = 18)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!ol", name = "KA", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(B)[F", line = 65)
    ...
    @OriginalMember(owner = "client!ol", name = "EA", descriptor = "(Lm;)V", line = 90)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "()Lm;", line = 112)
    ...
    @OriginalMember(owner = "client!ol", name = "k", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(III[I)V", line = 164)
    ...
    @OriginalMember(owner = "client!ol", name = "TA", descriptor = "(III)V", line = 174)
    ...
    @OriginalMember(owner = "client!ol", name = "c", descriptor = "(I)[F", line = 184)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IIIIFFF)V", line = 207)
    ...
    @OriginalMember(owner = "client!ol", name = "B", descriptor = "(IIIIII)V", line = 242)
    ...
    @OriginalMember(owner = "client!ol", name = "I", descriptor = "(III[I)V", line = 283)
    ...
    @OriginalMember(owner = "client!ol", name = "d", descriptor = "(I)Z", line = 293)
    ...
    @OriginalMember(owner = "client!ol", name = "XA", descriptor = "(I)V", line = 304)
    ...
    @OriginalMember(owner = "client!ol", name = "ha", descriptor = "()V", line = 332)
    ...
    @OriginalMember(owner = "client!ol", name = "va", descriptor = "([I)V", line = 345)
    ...
    @OriginalMember(owner = "client!ol", name = "oa", descriptor = "(III)V", line = 362)
    ...
    @OriginalMember(owner = "client!ol", name = "ta", descriptor = "(I)V", line = 376)
    ...
    @OriginalMember(owner = "client!ol", name = "ma", descriptor = "(I)V", line = 390)
    ...
    @OriginalMember(owner = "client!ol", name = "<init>", descriptor = "()V", line = 401)
    public class249() {
        this.method883();
    }

    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IILoh;)I", line = 410)
