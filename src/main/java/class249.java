...
public class class249 implements IEnumModesCallback {
    ...
    @OriginalMember(owner = "client!lf", name = "callbackEnumModes", descriptor = "(Lcom/ms/directX/DDSurfaceDesc;Lcom/ms/com/IUnknown;)V", line = 4)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Ljava/awt/Frame;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(B)[I", line = 31)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(BIILjava/awt/Frame;II)V", line = 49)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "()V", line = 70)
    public class249() {
