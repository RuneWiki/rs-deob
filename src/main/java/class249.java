...
public class class249 extends class461 {
    ...
    @OriginalMember(owner = "client!he", name = "c", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!he", name = "g", descriptor = "(I)I", line = 29)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "([BIIZII)Z", line = 41)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IBLqv;Lqv;)V", line = 138)
    ...
    @OriginalMember(owner = "client!he", name = "h", descriptor = "(I)Z", line = 293)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(BLjava/awt/Canvas;)Lmu;", line = 332)
    ...
    @OriginalMember(owner = "client!he", name = "f", descriptor = "(I)Z", line = 355)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(III)V", line = 371)
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "(Z)V", line = 450)
    ...
    @OriginalMember(owner = "client!he", name = "<init>", descriptor = "(Lht;)V", line = 469)
    public class249(class410 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IB)V", line = 473)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(BII)Z", line = 488)
