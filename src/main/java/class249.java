...
public class class249 extends class566 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!vba", name = "h", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!vba", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 16)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(I)V", line = 44)
    public final void method243(int arg0) {
        this.method1469(arg0);
        field3101++;
    }

    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(ILjava/awt/event/MouseEvent;)I", line = 56)
    ...
    @OriginalMember(owner = "client!vba", name = "f", descriptor = "(I)Z", line = 95)
    ...
    @OriginalMember(owner = "client!vba", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 109)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        this.method1472((byte) 31, arg0.getX(), arg0.getY());
        field3099++;
    }

    @OriginalMember(owner = "client!vba", name = "c", descriptor = "(I)I", line = 117)
    ...
    @OriginalMember(owner = "client!vba", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 129)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        field3098++;
        this.method1472((byte) 95, arg0.getX(), arg0.getY());
    }

    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(Lha;III[Z)V", line = 137)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 163)
    ...
    @OriginalMember(owner = "client!vba", name = "i", descriptor = "(I)V", line = 177)
    ...
    @OriginalMember(owner = "client!vba", name = "b", descriptor = "(I)V", line = 198)
    ...
    @OriginalMember(owner = "client!vba", name = "b", descriptor = "(B)V", line = 220)
    ...
    @OriginalMember(owner = "client!vba", name = "c", descriptor = "(B)V", line = 251)
    ...
    @OriginalMember(owner = "client!vba", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 280)
    ...
    @OriginalMember(owner = "client!vba", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 293)
    public final synchronized void mouseExited(MouseEvent arg0) {
        field3091++;
        this.method1472((byte) 55, arg0.getX(), arg0.getY());
    }

    @OriginalMember(owner = "client!vba", name = "e", descriptor = "(I)Laaa;", line = 301)
    public final class103 method249(int arg0) {
        field3107++;
        return arg0 < 69 ? null : (class103) this.field3100.method3440((byte) 114);
    }

    @OriginalMember(owner = "client!vba", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 312)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        field3111++;
        this.method1472((byte) 31, arg0.getX(), arg0.getY());
    }

    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(BII)V", line = 325)
    ...
    @OriginalMember(owner = "client!vba", name = "d", descriptor = "(I)Z", line = 348)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(Z)I", line = 362)
    ...
    @OriginalMember(owner = "client!vba", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 377)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(IIIII)V", line = 409)
    ...
    @OriginalMember(owner = "client!vba", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 443)
