...
public class class249 extends class116 {
    ...
    @OriginalMember(owner = "client!he", name = "d", descriptor = "()Lei;")
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "()Lei;")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IBLdg;)V")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(ILdg;[IIII)V")
    ...
    @OriginalMember(owner = "client!he", name = "<init>", descriptor = "(Lqe;)V")
