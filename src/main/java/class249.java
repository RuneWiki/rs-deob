...
public class class249 extends class161 {
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Le;Lhm;III)V", line = 3)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(ZILjava/lang/String;B)Z", line = 50)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Lkp;I)V", line = 127)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(BI)I", line = 148)
    public static final int method1724(byte arg0, int arg1) {
        field4068++;
        return arg0 == -104 ? arg1 & 0xFF : 34;
    }

    @OriginalMember(owner = "client!rp", name = "b", descriptor = "(B)V", line = 161)
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "()V", line = 173)
    public class249() {
    }

    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 175)
