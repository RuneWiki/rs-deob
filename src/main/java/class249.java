...
public class class249 implements class496 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(I)Ljea;", line = 28)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(Lae;)V", line = 45)
