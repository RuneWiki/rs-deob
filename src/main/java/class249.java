...
public abstract class class249 {
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(IIIIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(IIB)Z", line = 55)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(Loba;III)V", line = 70)
    ...
    @OriginalMember(owner = "client!ida", name = "<init>", descriptor = "(III)V", line = 924)
