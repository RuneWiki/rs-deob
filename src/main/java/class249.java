...
public class class249 extends class66 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "([I)Lqr;")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lri;)Z")
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lri;II)Lkg;")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lri;I)Lkg;")
