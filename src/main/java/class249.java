...
public class class249 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ILaf;)Z")
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Lbk;I)V")
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Lbk;)V")
