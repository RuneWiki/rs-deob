...
public class class249 extends class210 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(ILfp;)V", line = 3)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IB)[I", line = 104)
    ...
    @OriginalMember(owner = "client!v", name = "c", descriptor = "(B)V", line = 128)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lct;I)V", line = 139)
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "()V", line = 175)
    public class249() {
        this(4096);
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IILat;)V", line = 190)
