...
public class class249 extends class463 {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Lmi;)V")
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "()Lmi;")
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(Lmi;)V")
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Lbn;)V")
    ...
    @OriginalMember(owner = "client!rh", name = "c", descriptor = "()Lmi;")
    public final class463 method1496() {
        return (class463) this.field3204.method1909(true);
    }

    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Lkd;Lbn;)V")
