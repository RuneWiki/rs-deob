...
public class class249 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(I)Luj;")
    public static final class248 method1549(int arg0) {
        return (class248) field3570.method2310((byte) 107, (long) arg0);
    }

    @OriginalMember(owner = "client!ah", name = "a", descriptor = "([B[B[SII)V")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Leq;Lqs;IIII)V")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lhe;Lvo;Lkb;Lhl;Lna;Lhp;Lno;)V")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Leq;IIII)Lum;")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(II)Luj;")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Leq;)V")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Leq;IIIIIII[S[BZ)V")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Leq;Lae;IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(Leq;IIII)V")
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(Leq;)Lum;")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Leq;II)V")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Leq;IIII[S[B)V")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lps;III)I")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lps;II)V")
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(II)Lnf;")
