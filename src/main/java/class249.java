...
public class class249 extends class530 {
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(II)I", line = 14)
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(II)V", line = 25)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Z)V", line = 46)
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(Lah;)V", line = 61)
    public class249(class374 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(III)Z", line = 68)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(I)I", line = 79)
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(ILah;)V", line = 98)
