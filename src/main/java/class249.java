...
public class class249 extends class449 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IIIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "([IILgf;[I[I)V", line = 26)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IB)V", line = 120)
