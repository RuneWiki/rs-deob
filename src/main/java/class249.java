...
public class class249 extends class260 {
    ...
    @OriginalMember(owner = "client!ll", name = "e", descriptor = "(I)J", line = 6)
    ...
    @OriginalMember(owner = "client!ll", name = "c", descriptor = "(I)J", line = 36)
    ...
    @OriginalMember(owner = "client!ll", name = "b", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(BI)I", line = 60)
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "()V", line = 100)
    public class249() {
