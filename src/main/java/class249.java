...
public class class249 extends class260 {
    ...
    @OriginalMember(owner = "client!kea", name = "<init>", descriptor = "(Lgn;)V", line = 3)
    public class249(class729 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(Z[Ljava/lang/Object;[III)V", line = 6)
    ...
    @OriginalMember(owner = "client!kea", name = "b", descriptor = "(I)I", line = 63)
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!kea", name = "d", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!kea", name = "e", descriptor = "(I)I", line = 103)
    public final int method1642(int arg0) {
        ++field3684;
        return arg0 > -14 ? -114 : super.field3828;
    }

    @OriginalMember(owner = "client!kea", name = "<init>", descriptor = "(ILgn;)V", line = 115)
    public class249(int arg0, class729 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!kea", name = "f", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(ILjava/awt/Canvas;ILd;)Lha;", line = 133)
    ...
    @OriginalMember(owner = "client!kea", name = "c", descriptor = "(II)I", line = 145)
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(IB)V", line = 157)
