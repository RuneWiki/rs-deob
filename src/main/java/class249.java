...
public class class249 extends class599 implements class57 {

    @OriginalMember(owner = "client!eo", name = "A", descriptor = "Lbw;")
    public class599 field3538;

    @OriginalMember(owner = "client!eo", name = "E", descriptor = "Lkca;")
    public static class73 field3542 = new class73(8, -1);
    ...
    @OriginalMember(owner = "client!eo", name = "<init>", descriptor = "(IIIIILbw;)V")
    public class249(int arg0, int arg1, int arg2, int arg3, int arg4, class599 arg5) {
        super(arg2, arg3, arg4, class527.method3100(-5721, arg1, arg0));
        this.field3538 = arg5;
    }

    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IZLoa;)Lba;")
    ...
    public static void method1648(byte arg0) {
        int var1 = -49 % ((arg0 - 6) / 45);
        field3542 = null;
    }

    @OriginalMember(owner = "client!eo", name = "b", descriptor = "(Loa;I)Lew;")
    public final class425 method100(class605 arg0, int arg1) {
        if (arg1 != 28286) {
            field3542 = null;
        }
        field3530++;
        return this.field3538.method100(arg0, arg1);
    }

    @OriginalMember(owner = "client!eo", name = "c", descriptor = "(I)V")
    public final void method87(int arg0) {
        if (arg0 != 7511) {
            this.method88(null, (byte) -43);
        }
        field3531++;
    }

    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IILoa;I)Z")
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IIILva;Loa;ZI)V")
    ...
    public final int method89(int arg0) {
        int var2 = 61 % ((arg0 - 11) / 51);
        field3529++;
        return 0;
    }

    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(ILoa;)V")
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(BLoa;)V")
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Loa;B)Laca;")
