...
public abstract class class249 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IIZI)V", line = 8)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(JI)V", line = 41)
