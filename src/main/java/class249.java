...
public class class249 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(I)Lwk;", line = 38)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Z)V", line = 68)
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(I)Les;", line = 115)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(I[Les;)I", line = 126)
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(Z)I", line = 163)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Les;JI)V", line = 174)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(ILlt;Lnn;I)V", line = 191)
    ...
    @OriginalMember(owner = "client!mn", name = "c", descriptor = "(I)Les;", line = 305)
    ...
    @OriginalMember(owner = "client!mn", name = "c", descriptor = "(B)Les;", line = 340)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(JI)Les;", line = 372)
    ...
    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "(I)V", line = 408)
