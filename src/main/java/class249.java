...
public class class249 extends class262 implements class448 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(ILza;)V", line = 3)
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(B)Z", line = 41)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(ZIILza;)Luu;", line = 54)
    ...
    @OriginalMember(owner = "client!mn", name = "c", descriptor = "(I)I", line = 84)
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(I)I", line = 96)
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(BLza;)Luc;", line = 110)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IIII[FFIFIII)V", line = 140)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Lza;BI)Le;", line = 193)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IIIZILot;Lza;)V", line = 213)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(ILza;BI)Z", line = 244)
    ...
    @OriginalMember(owner = "client!mn", name = "d", descriptor = "(B)V", line = 266)
    ...
    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "(Lza;Ler;IIIIZIIZ)V", line = 280)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(I)V", line = 315)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(III)V", line = 328)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(BLza;)V", line = 339)
    ...
    @OriginalMember(owner = "client!mn", name = "f", descriptor = "(I)V", line = 367)
    ...
    @OriginalMember(owner = "client!mn", name = "c", descriptor = "(BLza;)V", line = 381)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IBLza;)Le;", line = 392)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(B)I", line = 405)
    public final int method48(byte arg0) {
        ++field3308;
        return arg0 != -70 ? 15 : this.field3293;
    }

    @OriginalMember(owner = "client!mn", name = "c", descriptor = "(B)Z", line = 416)
