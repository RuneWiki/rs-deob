...
public class class249 {
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(ZI)I", line = 9)
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(I)I", line = 21)
    ...
    @OriginalMember(owner = "client!pfa", name = "b", descriptor = "(ZI)Lua;", line = 36)
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(IILha;)Lmq;", line = 62)
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(ZLol;)Lia;", line = 93)
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(ILua;)V", line = 106)
    ...
    @OriginalMember(owner = "client!pfa", name = "<init>", descriptor = "(Lua;)V", line = 121)
    public class249(class664 arg0) {
        this.field3581 = arg0.field9343;
        this.field3585 = 1;
    }

    @OriginalMember(owner = "client!pfa", name = "<init>", descriptor = "([Lua;)V", line = 129)
    public class249(class664[] arg0) {
