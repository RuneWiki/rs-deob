...
public class class249 implements Runnable {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(II)V", line = 18)
    ...
    @OriginalMember(owner = "client!uv", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 207)
    ...
    @OriginalMember(owner = "client!uv", name = "run", descriptor = "()V", line = 71)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(I[BII)V", line = 131)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(Z)V", line = 172)
    ...
    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(I)V", line = 187)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(BIILga;)V", line = 222)
