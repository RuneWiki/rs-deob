...
public class class249 extends class88 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IIZLls;Lls;)I")
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(ZLdda;)V")
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "(Lkw;II)V")
