...
public class class249 extends class62 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(B)Z", line = 52)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IB)I", line = 65)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ILae;IILbk;IIIIIZLkb;III)Lbk;", line = 83)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(B)V", line = 291)
