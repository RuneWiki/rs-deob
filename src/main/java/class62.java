...
public class class62 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ZLhe;I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(BLug;)Lic;", line = 24)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(II)I", line = 39)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ZIBZII)V", line = 87)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Z)V", line = 144)
    ...
    @OriginalMember(owner = "client!tt", name = "<init>", descriptor = "(Lur;)V", line = 183)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(BI)Z", line = 163)
