...
public class class62 {
    ...
    @OriginalMember(owner = "client!ga", name = "f", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ga", name = "b", descriptor = "Loh;")
    public static class138 field1199;

    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Lbg;ZLbg;)V")
