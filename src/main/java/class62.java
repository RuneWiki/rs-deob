...
public class class62 implements class235 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(ZIIIFI)[F", line = 10)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IZIIFB)[I", line = 21)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(II)Z", line = 54)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IZIIIF)[I", line = 67)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IIII)V", line = 88)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IB)Lhp;", line = 93)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Z)V", line = 118)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(BI)Lqr;", line = 131)
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "(Lct;Lct;Lct;)V", line = 158)
