...
public class class62 extends class80 implements class122 {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!ps", name = "finalize", descriptor = "()V", line = 22)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(BII)V", line = 38)
    ...
    @OriginalMember(owner = "client!ps", name = "g", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!ps", name = "h", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(Lht;III)V", line = 87)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(Lht;IIII)V", line = 102)
