...
public class class62 extends class656 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(ZB)V", line = 5)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(III)I", line = 24)
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(Lcb;Lde;)V", line = 53)
    public class62(class544 arg0, class555 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!mk", name = "c", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 66)
