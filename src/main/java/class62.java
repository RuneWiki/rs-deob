...
public class class62 extends class778 {
    ...
    @OriginalMember(owner = "client!pp", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(IIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(Lae;Lae;Ldd;)V", line = 30)
