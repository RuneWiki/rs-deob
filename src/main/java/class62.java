...
public class class62 extends class220 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "([BB)[B", line = 4)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "()V", line = 25)
    public class62() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(BIB)V", line = 31)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Ljava/lang/String;ZI)V", line = 50)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ILjava/lang/String;)V", line = 64)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IIII)[B", line = 78)
