...
public class class62 {
    ...
    @OriginalMember(owner = "client!WMYPWVZI", name = "d", descriptor = "LWLTWEDNK;")
    private class61 field1572 = new class61();

    @OriginalMember(owner = "client!WMYPWVZI", name = "h", descriptor = "LVHKTMNAT;")
    ...
    @OriginalMember(owner = "client!WMYPWVZI", name = "g", descriptor = "LSAEPCADT;")
    ...
    @OriginalMember(owner = "client!WMYPWVZI", name = "a", descriptor = "(J)LWLTWEDNK;")
    ...
    @OriginalMember(owner = "client!WMYPWVZI", name = "a", descriptor = "(JILWLTWEDNK;)V")
