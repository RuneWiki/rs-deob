...
public class class62 extends class11 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!sd", name = "c", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Lsi;II)V", line = 28)
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "()V", line = 215)
    public class62() {
        super(1, true);
    }

    @OriginalMember(owner = "client!sd", name = "d", descriptor = "(II)[I", line = 87)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIIII)V", line = 157)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Lsi;I)Lvl;", line = 174)
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(Z)V", line = 219)
    ...
    @OriginalMember(owner = "client!sd", name = "d", descriptor = "(B)V", line = 231)
