...
public class class62 extends class458 {
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(IILfa;II)V")
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(FFFFFFLfa;II)V")
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "(Lfo;IIZ)V")
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "(Lfo;II[III)V")
