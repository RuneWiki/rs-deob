...
@OriginalClass("client!UTWNPFGW")
public class class62 {

    @OriginalMember(owner = "client!UTWNPFGW", name = "a", descriptor = "Z")
    private boolean field1493 = true;

    @OriginalMember(owner = "client!UTWNPFGW", name = "b", descriptor = "I")
    private int field1494 = 8;

    @OriginalMember(owner = "client!UTWNPFGW", name = "c", descriptor = "I")
    private int field1495 = 1;

    @OriginalMember(owner = "client!UTWNPFGW", name = "d", descriptor = "Z")
    private boolean field1496 = true;

    @OriginalMember(owner = "client!UTWNPFGW", name = "e", descriptor = "I")
    private int field1497 = -43804;

    @OriginalMember(owner = "client!UTWNPFGW", name = "f", descriptor = "Z")
    private boolean field1498 = false;

    @OriginalMember(owner = "client!UTWNPFGW", name = "g", descriptor = "I")
    public int field1499 = 0;

    @OriginalMember(owner = "client!UTWNPFGW", name = "h", descriptor = "I")
    public int field1500 = 0;

    @OriginalMember(owner = "client!UTWNPFGW", name = "i", descriptor = "I")
    public int field1501;

    @OriginalMember(owner = "client!UTWNPFGW", name = "j", descriptor = "I")
    public int field1502;

    @OriginalMember(owner = "client!UTWNPFGW", name = "k", descriptor = "[[I")
    public int[][] field1503;

    @OriginalMember(owner = "client!UTWNPFGW", name = "<init>", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!UTWNPFGW", name = "a", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!UTWNPFGW", name = "a", descriptor = "(ZIIBII)V")
    ...
    @OriginalMember(owner = "client!UTWNPFGW", name = "a", descriptor = "(IIIIIZI)V")
    ...
    @OriginalMember(owner = "client!UTWNPFGW", name = "a", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!UTWNPFGW", name = "b", descriptor = "(III)V")
    private void method488(int arg0, int arg1, int arg2) {
        this.field1503[arg0][arg1] |= arg2;
    }

    @OriginalMember(owner = "client!UTWNPFGW", name = "a", descriptor = "(ZIZIII)V")
    ...
    @OriginalMember(owner = "client!UTWNPFGW", name = "b", descriptor = "(IIIIIZI)V")
    ...
    @OriginalMember(owner = "client!UTWNPFGW", name = "a", descriptor = "(IIII)V")
    ...
    @OriginalMember(owner = "client!UTWNPFGW", name = "a", descriptor = "(ZII)V")
    ...
    @OriginalMember(owner = "client!UTWNPFGW", name = "a", descriptor = "(IIIIIII)Z")
    ...
    @OriginalMember(owner = "client!UTWNPFGW", name = "b", descriptor = "(IIIIIII)Z")
    ...
    @OriginalMember(owner = "client!UTWNPFGW", name = "a", descriptor = "(IIIIIIII)Z")
