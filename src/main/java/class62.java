...
public class class62 {
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(IIIIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Lmea;II)I", line = 31)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(ZI)V", line = 98)
    ...
    @OriginalMember(owner = "client!fw", name = "b", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!fw", name = "<init>", descriptor = "(IIIIIIIIIZI)V", line = 129)
