...
public abstract class class62 extends class417 {
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(Lgw;II)V")
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(Lpp;I)V")
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(BI)Lfp;")
