...
public class class62 extends class306 {
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Lms;Lkt;[Lau;[I[I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(CIIIZLta;II)V", line = 30)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "([B[IIIIIIII)V", line = 94)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "([B[IIIIIIIIIIILta;II)V", line = 128)
    ...
    @OriginalMember(owner = "client!ns", name = "B", descriptor = "(CIIIZ)V", line = 223)
