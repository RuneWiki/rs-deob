...
public class class62 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(I)Lsh;", line = 3)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IIIIZ)V", line = 23)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(B)V", line = 42)
    public static void method511(byte arg0) {
        field821 = null;
        int var1 = -128 / ((arg0 + 65) / 43);
    }

    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Lsh;I)V", line = 52)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(I)V", line = 78)
    public class62(int arg0) {
        this.field824 = arg0;
    }

    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(IIIIII)V", line = 85)
