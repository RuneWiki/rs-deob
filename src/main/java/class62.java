...
public class class62 extends class251 {
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Lha;II)V")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Lqh;B)V")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(BLha;)V")
