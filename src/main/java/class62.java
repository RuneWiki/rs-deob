...
public class class62 extends class230 implements class163 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "()I", line = 3)
    public final int method380() {
        return super.method380();
    }

    @OriginalMember(owner = "client!co", name = "a", descriptor = "(III)V", line = 6)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(I[BI)V", line = 10)
    ...
    @OriginalMember(owner = "client!co", name = "b", descriptor = "()V", line = 15)
    public final void method383() {
        this.field3122.method2120(this);
    }

    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "(Lpo;I[BIZ)V", line = 18)
