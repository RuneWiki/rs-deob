...
public class class62 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Llea;I)I")
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(ILqb;)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
