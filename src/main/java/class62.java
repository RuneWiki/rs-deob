...
public class class62 extends class9 {
    ...
    @OriginalMember(owner = "client!naa", name = "b", descriptor = "(II)Ljs;", line = 3)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Los;[II)V", line = 32)
    ...
    @OriginalMember(owner = "client!naa", name = "c", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!naa", name = "c", descriptor = "(III)I", line = 81)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Los;I)Ljava/lang/String;", line = 101)
    ...
    @OriginalMember(owner = "client!naa", name = "f", descriptor = "(I)I", line = 130)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(BI)I", line = 145)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(ILos;I)V", line = 156)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(IIII)V", line = 234)
    ...
    @OriginalMember(owner = "client!naa", name = "b", descriptor = "(Los;I)V", line = 246)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(III[II)V", line = 274)
    ...
    @OriginalMember(owner = "client!naa", name = "g", descriptor = "(I)Ljava/lang/String;", line = 303)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;BLjava/lang/String;ILjava/lang/String;I)V", line = 333)
