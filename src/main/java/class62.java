...
public class class62 extends class55 implements class425 {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IIZLii;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!lp", name = "c", descriptor = "(I)Z", line = 22)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(BLii;)V", line = 34)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IZ)V", line = 47)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(BLps;)Z", line = 115)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IIIIIII)V", line = 135)
    ...
    @OriginalMember(owner = "client!lp", name = "h", descriptor = "(I)V", line = 181)
    ...
    @OriginalMember(owner = "client!lp", name = "i", descriptor = "(I)V", line = 194)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ZI)I", line = 204)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Z)V", line = 215)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(I)I", line = 228)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Lii;I)V", line = 243)
    ...
    @OriginalMember(owner = "client!lp", name = "f", descriptor = "(I)I", line = 256)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(B)V", line = 270)
    ...
    @OriginalMember(owner = "client!lp", name = "c", descriptor = "(II)S", line = 280)
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(Lii;I)Leb;", line = 310)
    ...
    @OriginalMember(owner = "client!lp", name = "e", descriptor = "(I)Z", line = 346)
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(Lii;Lge;IIIIIIIZIIIII)V", line = 358)
    ...
    @OriginalMember(owner = "client!lp", name = "d", descriptor = "(I)I", line = 369)
    public final int method105(int arg0) {
        ++field829;
        return arg0 >= -4 ? 46 : this.field824.field5059;
    }

    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ILii;I)Ldc;", line = 389)
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(I)I", line = 402)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ILjava/lang/String;)I", line = 417)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ILii;)V", line = 437)
    ...
    @OriginalMember(owner = "client!lp", name = "d", descriptor = "(B)V", line = 453)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Lii;IIIILnc;Z)V", line = 496)
