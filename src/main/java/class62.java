...
public class class62 extends class686 {
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(IIIILcg;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(ILpl;)V", line = 187)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(III)V", line = 222)
    ...
    @OriginalMember(owner = "client!ifa", name = "c", descriptor = "(I)V", line = 236)
    ...
    @OriginalMember(owner = "client!ifa", name = "<init>", descriptor = "(I)V", line = 251)
    public class62(int arg0) {
        this.field850 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!ifa", name = "h", descriptor = "(I)I", line = 259)
