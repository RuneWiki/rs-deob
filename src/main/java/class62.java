...
public class class62 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Z)Z", line = 5)
    public static final boolean method548(boolean arg0) {
        field935++;
        return arg0 ? class280.field4130 : false;
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IIB)I", line = 116)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(B)V", line = 134)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(IIB)V", line = 146)
