...
public class class62 extends class428 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(B)I", line = 16)
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(I)I", line = 28)
    public final int method377(int arg0) {
        int var2 = 31 % ((arg0 + 12) / 53);
        return this.field790;
    }

    @OriginalMember(owner = "client!mk", name = "c", descriptor = "(B)J", line = 38)
    public final long method378(byte arg0) {
        int var2 = 25 % ((-arg0 - 26) / 54);
        return this.field794;
    }

    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Z)I", line = 49)
