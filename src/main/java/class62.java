...
public class class62 {
    ...
    @OriginalMember(owner = "client!VSTUETUV", name = "q", descriptor = "LERCNIFTI;")
    private class16 field1560;

    @OriginalMember(owner = "client!VSTUETUV", name = "d", descriptor = "LNXAZLFDC;")
    private class41 field1547;

    @OriginalMember(owner = "client!VSTUETUV", name = "e", descriptor = "LNXAZLFDC;")
    private class41 field1548;

    @OriginalMember(owner = "client!VSTUETUV", name = "f", descriptor = "LNXAZLFDC;")
    private class41 field1549;

    @OriginalMember(owner = "client!VSTUETUV", name = "g", descriptor = "LNXAZLFDC;")
    private class41 field1550;

    @OriginalMember(owner = "client!VSTUETUV", name = "h", descriptor = "LNXAZLFDC;")
    private class41 field1551;

    @OriginalMember(owner = "client!VSTUETUV", name = "i", descriptor = "LNXAZLFDC;")
    private class41 field1552;

    @OriginalMember(owner = "client!VSTUETUV", name = "j", descriptor = "LNXAZLFDC;")
    private class41 field1553;

    @OriginalMember(owner = "client!VSTUETUV", name = "k", descriptor = "LNXAZLFDC;")
    private class41 field1554;

    @OriginalMember(owner = "client!VSTUETUV", name = "r", descriptor = "LNXAZLFDC;")
    ...
    @OriginalMember(owner = "client!VSTUETUV", name = "a", descriptor = "(LLDILQFVA;I)V")
