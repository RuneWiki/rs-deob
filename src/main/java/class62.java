...
public class class62 {
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Ldda;B)Z")
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(II[IIZI[IIIILoga;IIII)I")
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(ZLaga;)I")
    ...
    @OriginalMember(owner = "client!fw", name = "b", descriptor = "(Ldda;B)V")
    ...
    @OriginalMember(owner = "client!fw", name = "<init>", descriptor = "(Ldia;)V")
