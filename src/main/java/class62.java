...
public class class62 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(II)I", line = 9)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(II[Lga;)V", line = 15)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(B)V", line = 111)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ILjava/lang/String;)V", line = 128)
