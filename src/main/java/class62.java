...
@OriginalClass("client!XDCFWJPT")
public class class62 {

    @OriginalMember(owner = "client!XDCFWJPT", name = "a", descriptor = "B")
    private byte field1505 = 44;

    @OriginalMember(owner = "client!XDCFWJPT", name = "b", descriptor = "Z")
    private boolean field1506 = false;

    @OriginalMember(owner = "client!XDCFWJPT", name = "h", descriptor = "I")
    public int field1512 = -1;

    @OriginalMember(owner = "client!XDCFWJPT", name = "i", descriptor = "Z")
    public boolean field1513 = false;

    @OriginalMember(owner = "client!XDCFWJPT", name = "j", descriptor = "Z")
    public boolean field1514 = true;

    @OriginalMember(owner = "client!XDCFWJPT", name = "d", descriptor = "I")
    public static int field1508;

    @OriginalMember(owner = "client!XDCFWJPT", name = "g", descriptor = "I")
    public int field1511;

    @OriginalMember(owner = "client!XDCFWJPT", name = "k", descriptor = "I")
    public int field1515;

    @OriginalMember(owner = "client!XDCFWJPT", name = "l", descriptor = "I")
    public int field1516;

    @OriginalMember(owner = "client!XDCFWJPT", name = "m", descriptor = "I")
    public int field1517;

    @OriginalMember(owner = "client!XDCFWJPT", name = "n", descriptor = "I")
    public int field1518;

    @OriginalMember(owner = "client!XDCFWJPT", name = "o", descriptor = "I")
    public int field1519;

    @OriginalMember(owner = "client!XDCFWJPT", name = "p", descriptor = "I")
    public int field1520;

    @OriginalMember(owner = "client!XDCFWJPT", name = "f", descriptor = "Ljava/lang/String;")
    public String field1510;

    @OriginalMember(owner = "client!XDCFWJPT", name = "c", descriptor = "Z")
    private static boolean field1507;

    @OriginalMember(owner = "client!XDCFWJPT", name = "e", descriptor = "[LXDCFWJPT;")
    public static class62[] field1509;

    @OriginalMember(owner = "client!XDCFWJPT", name = "a", descriptor = "(LOTSGNSQM;Z)V")
    ...
    @OriginalMember(owner = "client!XDCFWJPT", name = "a", descriptor = "(BLYOXDZEVD;)V")
    ...
    @OriginalMember(owner = "client!XDCFWJPT", name = "a", descriptor = "(ZI)V")
    ...
    @OriginalMember(owner = "client!XDCFWJPT", name = "a", descriptor = "(III)I")
