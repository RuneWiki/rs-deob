...
public class class62 extends class40 {
    ...
    @OriginalMember(owner = "client!UPHLHIWQ", name = "k", descriptor = "Z")
    public static boolean field1521;

    @OriginalMember(owner = "client!UPHLHIWQ", name = "i", descriptor = "[LICFMSSJN;")
    ...
    @OriginalMember(owner = "client!UPHLHIWQ", name = "a", descriptor = "(I)LPSGMMDJS;")
