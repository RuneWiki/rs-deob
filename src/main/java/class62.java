...
public class class62 {
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(I)Leaa;")
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(ZLaf;)Laaa;")
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(Lin;I)V")
    ...
    @OriginalMember(owner = "client!mia", name = "<init>", descriptor = "(Lin;Lin;)V")
