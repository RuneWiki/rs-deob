...
public class class62 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Lq;ILoa;ZZLba;III)V")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ZLoa;)V")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Loa;IIZZII)Lba;")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ILoa;)V")
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(Loa;Lbd;IIIIIIZI)V")
