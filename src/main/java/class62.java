...
public class class62 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ILie;)V")
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(B)Luo;")
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Lie;BI)V")
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(I)Luo;")
