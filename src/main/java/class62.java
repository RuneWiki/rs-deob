...
public class class62 extends class185 implements class3 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(BLha;)V", line = 3)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(I)I", line = 24)
    ...
    @OriginalMember(owner = "client!nr", name = "e", descriptor = "(B)I", line = 40)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ILha;)V", line = 53)
    ...
    @OriginalMember(owner = "client!nr", name = "e", descriptor = "(I)Z", line = 64)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(B)I", line = 75)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(Lha;Ltk;IIIIIZIIIIIII)V", line = 86)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ZILha;ILrda;II)V", line = 96)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Lha;I)V", line = 118)
    ...
    @OriginalMember(owner = "client!nr", name = "d", descriptor = "(B)V", line = 128)
    ...
    @OriginalMember(owner = "client!nr", name = "f", descriptor = "(B)Z", line = 143)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Ldq;I)V", line = 155)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(B)Z", line = 166)
    ...
    @OriginalMember(owner = "client!nr", name = "g", descriptor = "(B)V", line = 177)
    ...
    @OriginalMember(owner = "client!nr", name = "f", descriptor = "(I)Z", line = 190)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IIILha;)Z", line = 204)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IIIII)V", line = 220)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Lha;B)Lkv;", line = 266)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(I)V", line = 316)
    ...
    @OriginalMember(owner = "client!nr", name = "c", descriptor = "(B)I", line = 327)
    ...
    @OriginalMember(owner = "client!nr", name = "g", descriptor = "(I)I", line = 340)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(Lha;B)Lrga;", line = 361)
