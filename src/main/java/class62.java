...
public class class62 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(B[BZ)Ljava/lang/Object;", line = 21)
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(II)Lhk;", line = 53)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(B)V", line = 100)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(Lkr;ILpu;)V", line = 115)
