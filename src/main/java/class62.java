...
public class class62 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ILcj;)I", line = 56)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(III)Ljava/lang/String;", line = 83)
