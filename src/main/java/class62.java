...
public class class62 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ZLjava/lang/String;)Z", line = 6)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ZI)Ljava/lang/String;", line = 59)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Lkk;I)V", line = 81)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Lvc;B)V", line = 110)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(II)Z", line = 132)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "()V", line = 158)
    ...
    @OriginalMember(owner = "client!mj", name = "b", descriptor = "(I)V", line = 174)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(I[Lrn;)V", line = 198)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IILkk;)V", line = 223)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(B)V", line = 282)
    ...
    @OriginalMember(owner = "client!mj", name = "b", descriptor = "(II)I", line = 301)
