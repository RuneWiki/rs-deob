...
public class class62 {
    ...
    @OriginalMember(owner = "client!VUJNNHKQ", name = "a", descriptor = "LMMADHCLT;")
    private class32 field1532;

    @OriginalMember(owner = "client!VUJNNHKQ", name = "b", descriptor = "LMMADHCLT;")
    private class32 field1533;

    @OriginalMember(owner = "client!VUJNNHKQ", name = "c", descriptor = "LMMADHCLT;")
    private class32 field1534;

    @OriginalMember(owner = "client!VUJNNHKQ", name = "d", descriptor = "LMMADHCLT;")
    private class32 field1535;

    @OriginalMember(owner = "client!VUJNNHKQ", name = "e", descriptor = "LMMADHCLT;")
    private class32 field1536;

    @OriginalMember(owner = "client!VUJNNHKQ", name = "f", descriptor = "LMMADHCLT;")
    private class32 field1537;

    @OriginalMember(owner = "client!VUJNNHKQ", name = "g", descriptor = "LMMADHCLT;")
    private class32 field1538;

    @OriginalMember(owner = "client!VUJNNHKQ", name = "h", descriptor = "LMMADHCLT;")
    private class32 field1539;

    @OriginalMember(owner = "client!VUJNNHKQ", name = "o", descriptor = "LMMADHCLT;")
    private class32 field1546;

    @OriginalMember(owner = "client!VUJNNHKQ", name = "n", descriptor = "LRMKIQWOG;")
    ...
    @OriginalMember(owner = "client!VUJNNHKQ", name = "a", descriptor = "(ILUAWAYCTK;)V")
