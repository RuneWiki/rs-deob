...
public class class62 {
    ...
    @OriginalMember(owner = "client!VOWJQLLT", name = "c", descriptor = "LXGRGMPUQ;")
    ...
    @OriginalMember(owner = "client!VOWJQLLT", name = "a", descriptor = "(LXGRGMPUQ;II)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!VOWJQLLT", name = "a", descriptor = "(Ljava/lang/String;LXGRGMPUQ;Z)V")
