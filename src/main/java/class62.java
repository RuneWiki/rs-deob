...
public class class62 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IIILdm;)V")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(II)Lul;")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Ldm;ZII)V")
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(Lcw;ILeq;)V")
