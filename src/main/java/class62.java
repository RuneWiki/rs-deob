...
public class class62 {
    ...
    @OriginalMember(owner = "client!VCTVXSNH", name = "o", descriptor = "LAKUDQPZE;")
    ...
    @OriginalMember(owner = "client!VCTVXSNH", name = "g", descriptor = "LBZONLWPM;")
    public class5 field1574;

    @OriginalMember(owner = "client!VCTVXSNH", name = "c", descriptor = "[LVCTVXSNH;")
    public static class62[] field1570;

    @OriginalMember(owner = "client!VCTVXSNH", name = "a", descriptor = "(ILTKEGJSFV;)V")
    ...
    @OriginalMember(owner = "client!VCTVXSNH", name = "a", descriptor = "(LEGCCHUZS;Z)V")
    ...
    @OriginalMember(owner = "client!VCTVXSNH", name = "a", descriptor = "()LIGXVZOHI;")
