...
public class class62 extends class264 {
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(II)Z", line = 25)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Z)V", line = 47)
    ...
    @OriginalMember(owner = "client!ns", name = "c", descriptor = "(II)Z", line = 76)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Lgt;)V", line = 464)
    ...
    @OriginalMember(owner = "client!ns", name = "d", descriptor = "(II)I", line = 95)
    ...
    @OriginalMember(owner = "client!ns", name = "e", descriptor = "(II)I", line = 109)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ZI)V", line = 127)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lfh;Z)V", line = 142)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IZBI)V", line = 410)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lgt;I)V", line = 426)
    ...
    @OriginalMember(owner = "client!ns", name = "c", descriptor = "(I)Lfh;", line = 554)
