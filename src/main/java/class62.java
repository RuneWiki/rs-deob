...
@OriginalClass("client!WMEYNQIL")
public class class62 implements Runnable {

    @OriginalMember(owner = "client!WMEYNQIL", name = "a", descriptor = "Z")
    private boolean field1425 = false;

    @OriginalMember(owner = "client!WMEYNQIL", name = "b", descriptor = "I")
    private int field1426 = 696;

    @OriginalMember(owner = "client!WMEYNQIL", name = "f", descriptor = "Z")
    private boolean field1430 = false;

    @OriginalMember(owner = "client!WMEYNQIL", name = "k", descriptor = "Z")
    private boolean field1435 = false;

    @OriginalMember(owner = "client!WMEYNQIL", name = "l", descriptor = "Z")
    private boolean field1436 = false;

    @OriginalMember(owner = "client!WMEYNQIL", name = "g", descriptor = "LZAMJOSBM;")
    public class71 field1431;

    @OriginalMember(owner = "client!WMEYNQIL", name = "e", descriptor = "Ljava/net/Socket;")
    private Socket field1429;

    @OriginalMember(owner = "client!WMEYNQIL", name = "c", descriptor = "Ljava/io/InputStream;")
    private InputStream field1427;

    @OriginalMember(owner = "client!WMEYNQIL", name = "d", descriptor = "Ljava/io/OutputStream;")
    private OutputStream field1428;

    @OriginalMember(owner = "client!WMEYNQIL", name = "i", descriptor = "I")
    private int field1433;

    @OriginalMember(owner = "client!WMEYNQIL", name = "j", descriptor = "I")
    private int field1434;

    @OriginalMember(owner = "client!WMEYNQIL", name = "h", descriptor = "[B")
    private byte[] field1432;

    @OriginalMember(owner = "client!WMEYNQIL", name = "<init>", descriptor = "(Ljava/net/Socket;ILZAMJOSBM;)V")
    ...
    @OriginalMember(owner = "client!WMEYNQIL", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!WMEYNQIL", name = "c", descriptor = "()I")
    public int method516() throws IOException {
        return this.field1430 ? 0 : this.field1427.available();
    }

    @OriginalMember(owner = "client!WMEYNQIL", name = "a", descriptor = "([BII)V")
    ...
    @OriginalMember(owner = "client!WMEYNQIL", name = "a", descriptor = "([BIII)V")
    ...
    @OriginalMember(owner = "client!WMEYNQIL", name = "run", descriptor = "()V")
    public void run() {
    ...
    @OriginalMember(owner = "client!WMEYNQIL", name = "a", descriptor = "(I)V")
