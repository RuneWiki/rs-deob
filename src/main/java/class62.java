...
public class class62 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(II)Lne;")
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IILjn;I)Lhw;")
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Lke;I)V")
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(Ler;ILjn;)V")
