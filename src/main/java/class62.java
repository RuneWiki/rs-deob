...
public class class62 {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(ZLrg;I)V", line = 30)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Lrg;I)V", line = 276)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(I)V", line = 307)
