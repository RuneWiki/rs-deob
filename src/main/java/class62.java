...
public class class62 extends class184 {
    ...
    @OriginalMember(owner = "client!sd", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(II)[I", line = 17)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(BILfh;)V", line = 74)
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "()V", line = 128)
    public class62() {
        super(0, true);
    }

    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(BZ)V", line = 132)
    ...
    @OriginalMember(owner = "client!sd", name = "f", descriptor = "(I)V", line = 186)
