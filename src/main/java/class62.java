...
public class class62 extends class455 implements class113 {
    ...
    @OriginalMember(owner = "client!al", name = "b", descriptor = "(Leq;Z)Lgl;")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Leq;Z)V")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Leq;I)V")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(ILeq;BI)Z")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(BLeq;)V")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(IILbn;II)V")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(ILeq;Z)Lva;")
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Leq;Lhn;IIIIIZIIIIII)V")
