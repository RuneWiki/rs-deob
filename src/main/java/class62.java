...
public class class62 implements class149 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IIZFII)[I")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(BI)Lis;")
    ...
    @OriginalMember(owner = "client!dl", name = "b", descriptor = "(II)Loea;")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(ZIIIFI)[I")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IIIIFZ)[F")
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(Lfp;Lfp;Lfp;)V")
