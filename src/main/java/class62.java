...
public class class62 extends class362 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Lfca;II)V")
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IILkh;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(BLkh;II)V")
