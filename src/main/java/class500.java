...
public class class500 extends class154 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "([FII)[F", line = 10)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(II)Z", line = 25)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Z)V", line = 37)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(III)V", line = 54)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(BLea;[B[I)Z", line = 82)
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "()V", line = 141)
    public class500() {
    }

    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "([B)V", line = 148)
