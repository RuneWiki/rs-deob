...
public class class500 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(BLgs;)Z")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ILep;)V")
    ...
    @OriginalMember(owner = "client!gh", name = "c", descriptor = "(II)Liv;")
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(Ljda;ILjo;)V")
