...
public class class500 {
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(I)V", line = 483)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(II)Ljava/lang/String;", line = 508)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(ILjava/lang/String;B)V", line = 538)
