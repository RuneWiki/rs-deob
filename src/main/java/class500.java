...
public class class500 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lgh;I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "([Ljava/lang/String;BII[S)V", line = 27)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(I)V", line = 94)
