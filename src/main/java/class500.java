...
public class class500 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Lfe;II)V", line = 19)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Z[BII)V", line = 49)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IIIIIBI)Lob;", line = 65)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(BI)Z", line = 85)
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(Lur;Lru;Lsp;IIIII)V", line = 219)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(B)V", line = 112)
