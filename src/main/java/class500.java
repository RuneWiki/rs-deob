...
public class class500 extends class28 {
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(Lfd;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(ILfd;)V", line = 54)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(IIIII)V", line = 74)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(ILjava/lang/String;B)Ljava/lang/String;", line = 95)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(IIZ)I", line = 117)
