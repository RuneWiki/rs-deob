...
public class class500 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(B)V", line = 17)
