...
public class class500 implements Runnable {
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(IILvh;)Luda;")
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Lpq;II)Lhfa;")
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(II)Lbc;")
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Luda;I)V")
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(ILvh;B)Luda;")
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "([BIILvh;)Luda;")
    ...
    @OriginalMember(owner = "client!mca", name = "<init>", descriptor = "(Lcr;)V")
