...
public class class500 extends class136 {
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IILiv;)V", line = 51)
    ...
    @OriginalMember(owner = "client!lu", name = "<init>", descriptor = "()V", line = 88)
    public class500() {
        super(3, false);
    }

    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IIIIILsd;IIIIII)Z", line = 97)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Z)V", line = 534)
    ...
    @OriginalMember(owner = "client!lu", name = "f", descriptor = "(I)V", line = 545)
    ...
    @OriginalMember(owner = "client!lu", name = "c", descriptor = "(B)V", line = 560)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(BI)[[I", line = 575)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IB)V", line = 633)
