...
public class class500 extends class583 {
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(ILee;)V")
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(Lee;II)V")
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(CI)I")
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(Lee;I)V")
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(BC)I")
