...
public class class500 implements class502 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;", line = 4)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(II)I", line = 35)
    ...
    @OriginalMember(owner = "client!pi", name = "d", descriptor = "(I)I", line = 54)
    ...
    @OriginalMember(owner = "client!pi", name = "b", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!pi", name = "e", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Object;I)Z", line = 133)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Ljava/lang/Object;BLjava/lang/Class;Ljava/lang/String;)I", line = 147)
    ...
    @OriginalMember(owner = "client!pi", name = "c", descriptor = "(I)I", line = 168)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IJ)Z", line = 193)
    ...
    @OriginalMember(owner = "client!pi", name = "b", descriptor = "(II)I", line = 205)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IZ)V", line = 220)
