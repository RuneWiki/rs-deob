...
public class class500 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Lha;BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Ljava/awt/Canvas;Z)Lpr;", line = 33)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IIII)I", line = 62)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Lha;III)V", line = 88)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(B)V", line = 149)
