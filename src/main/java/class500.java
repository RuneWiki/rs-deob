...
public class class500 extends class386 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IBLun;)V", line = 6)
    ...
    @OriginalMember(owner = "client!vi", name = "e", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "()V", line = 69)
    public class500() {
        super(1, false);
    }

    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IIIII)Z", line = 72)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(BI[BI)[B", line = 94)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(II)[[I", line = 133)
