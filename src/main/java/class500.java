...
public class class500 extends class578 {
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(Ljava/awt/Canvas;Ld;IZ)Lha;", line = 6)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!lea", name = "<init>", descriptor = "(ILfk;IZ)V", line = 46)
