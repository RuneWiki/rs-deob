...
public class class500 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(BI)Lrl;", line = 7)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(B)V", line = 53)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(II)V", line = 67)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IB[J[II)V", line = 82)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Lwv;ILqs;)V", line = 218)
    public class500(class535 arg0, int arg1, class496 arg2) {
        this.field7318 = arg2;
        this.field7318.method2940(1, -10511);
    }

    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IIIII)V", line = 145)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(I)V", line = 162)
