...
public class class500 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(BIIILya;Lov;Lmg;ILbd;Lsm;Lit;Ljq;)Lt;")
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Ljq;Lsm;BLit;IIILya;Lfh;[Lsq;ILbd;ILsm;Lov;IILmg;Z)Lt;")
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IIILmg;)V")
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(BLsm;ILjq;ILya;IIIILmg;I)Lt;")
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "([BI)Lrg;")
