...
public class class500 extends IOException {
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(ZIILjava/lang/String;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!ria", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 134)
