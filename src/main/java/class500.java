...
public abstract class class500 {
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Lqf;IIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IIIILqa;II)Lc;", line = 76)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IIIZIII)I", line = 123)
    ...
    @OriginalMember(owner = "client!lu", name = "b", descriptor = "(I)V", line = 155)
