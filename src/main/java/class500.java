...
public class class500 {
    ...
    @OriginalMember(owner = "client!nk", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field7353++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 37)
