...
public class class500 {
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(Lr;Ljs;IIIILvv;ZI)V", line = 605)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(ILvv;)V", line = 12)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Lr;B)V", line = 115)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(I)I", line = 129)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(ZILda;Lr;IILq;IZ)V", line = 140)
    ...
    @OriginalMember(owner = "client!vi", name = "finalize", descriptor = "()V", line = 185)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(ZIILr;Z)Lda;", line = 197)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Lr;I)V", line = 334)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(I)I", line = 352)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(II)V", line = 364)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IB)V", line = 501)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IBLls;)V", line = 513)
    ...
    @OriginalMember(owner = "client!vi", name = "c", descriptor = "(I)Z", line = 592)
