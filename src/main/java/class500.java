...
public class class500 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(B)Loq;", line = 11)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "(I)V", line = 68)
    public class500(int arg0) {
        this.field7326 = arg0;
    }

    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "(IIIIII)V", line = 75)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Loq;I)V", line = 47)
