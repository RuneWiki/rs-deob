...
public class class500 extends class267 implements Runnable {
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ge", name = "run", descriptor = "()V", line = 17)
    ...
    @OriginalMember(owner = "client!ge", name = "c", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(BLir;)V", line = 43)
    ...
    @OriginalMember(owner = "client!ge", name = "d", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Z)V", line = 85)
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(Lph;)V", line = 114)
