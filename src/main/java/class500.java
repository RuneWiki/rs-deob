...
public class class500 extends class413 implements class623 {
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(Lsd;Leu;III[B)V", line = 4)
    ...
    @OriginalMember(owner = "client!gk", name = "c", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;", line = 76)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(ZLli;)V", line = 98)
