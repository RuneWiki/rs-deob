...
public class class500 extends class513 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(ILgaa;FI[BIBFFIIFF)V", line = 4)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(ILkc;IB)V", line = 34)
    ...
    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(II)V", line = 45)
