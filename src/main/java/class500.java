...
public class class500 {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(BI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IB)Ldk;", line = 22)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(B)V", line = 41)
