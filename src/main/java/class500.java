...
public class class500 extends class395 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(III)Lbl;", line = 12)
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(B)Z", line = 43)
