...
public class class500 extends class665 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(B)[Lrca;", line = 3)
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(B)V", line = 15)
    public static void method2891(byte arg0) {
        int var1 = -24 % ((-arg0 - 87) / 33);
        field7080 = null;
    }

    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(Z)V", line = 30)
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "()V", line = 51)
    public class500() {
    }

    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 61)
