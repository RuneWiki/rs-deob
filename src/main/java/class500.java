...
public class class500 extends class143 {
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(IILek;)V", line = 6)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(IIIZIIIIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(IBI)I", line = 127)
    ...
    @OriginalMember(owner = "client!oaa", name = "e", descriptor = "(B)V", line = 147)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(BLek;)V", line = 159)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(II)I", line = 180)
    public static final int method2992(int arg0, int arg1) {
        field7428++;
        return arg0 == -30141 ? (arg1 & 0x3FDA2) >> 11 : -15;
    }

    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(Ljava/lang/String;II)Ljava/lang/String;", line = 191)
