...
public class class500 implements Runnable {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ZILjava/lang/String;)Low;", line = 3)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;I)Low;", line = 18)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(BLjava/lang/Class;)V", line = 29)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ZLjava/lang/String;)Ljava/io/File;", line = 66)
    ...
    @OriginalMember(owner = "client!dq", name = "run", descriptor = "()V", line = 76)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILjava/lang/String;BLjava/lang/String;)Ljava/io/File;", line = 199)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILjava/lang/String;)[B", line = 287)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILjava/lang/Class;)Low;", line = 302)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(BLjava/net/URL;)Low;", line = 312)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B)Z", line = 322)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Z)Lpv;", line = 341)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IILjava/awt/Component;Ljava/awt/Point;I[I)Low;", line = 351)
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(B)V", line = 361)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "([Ljava/lang/Class;Ljava/lang/String;ZLjava/lang/Class;)Low;", line = 419)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Ljava/awt/Component;IZ)Low;", line = 430)
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;I)V", line = 704)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILjava/awt/Component;IZ)Low;", line = 450)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(I)Low;", line = 462)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILjava/lang/String;I)Low;", line = 474)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Ljava/awt/Frame;I)Low;", line = 485)
    public final class234 method2992(Frame arg0, int arg1) {
        int var3 = -78 / ((-arg1 - 59) / 48);
        return this.method3003(arg0, 7, 0, (byte) 36, 0);
    }

    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(I)V", line = 505)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(II)Low;", line = 564)
    public final class234 method2998(int arg0, int arg1) {
        return arg1 > -113 ? null : this.method3003(null, 3, arg0, (byte) 36, 0);
    }

    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(BLjava/lang/Class;)Low;", line = 574)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IIIII)Low;", line = 584)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILjava/lang/Runnable;I)Low;", line = 597)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IIBLjava/lang/Object;I)Low;", line = 611)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Ljava/lang/Object;IIBI)Low;", line = 656)
