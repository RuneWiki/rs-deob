...
public class class500 extends class634 {
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(IIIIIIIII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!pga", name = "c", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(Lpv;III)V", line = 43)
    ...
    @OriginalMember(owner = "client!pga", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 69)
