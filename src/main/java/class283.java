...
public abstract class class283 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ILnea;I)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIII[IZILnea;Lnea;II)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lnea;IIIILnea;IZI)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIILnea;IBILnea;Lnea;IZII[ZLnea;)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lkk;IIII[IZZLri;[ZLri;I)V")
