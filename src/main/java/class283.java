...
public class class283 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Lec;I)V")
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "(Lec;)V")
