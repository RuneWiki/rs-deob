...
public class class283 implements class80 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(ILkb;)Z", line = 12)
    ...
    @OriginalMember(owner = "client!bc", name = "b", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(I)J", line = 203)
    ...
    @OriginalMember(owner = "client!bc", name = "c", descriptor = "(I)V", line = 233)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(B)V", line = 247)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(BI)Lor;", line = 276)
    ...
    @OriginalMember(owner = "client!bc", name = "d", descriptor = "(I)V", line = 307)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IB)V", line = 332)
