...
public class class283 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(Lvf;Ldh;Ldl;IIIII)V", line = 166)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IIZ[B)V", line = 122)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IILbv;)V", line = 132)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(I)V", line = 151)
