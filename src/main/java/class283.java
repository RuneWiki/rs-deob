...
public class class283 extends class403 {
    ...
    @OriginalMember(owner = "client!wja", name = "<init>", descriptor = "(I)V", line = 5)
    public class283(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!wja", name = "a", descriptor = "(BII)Z", line = 8)
    ...
    @OriginalMember(owner = "client!wja", name = "a", descriptor = "(FI)V", line = 19)
    ...
    @OriginalMember(owner = "client!wja", name = "x", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!wja", name = "b", descriptor = "(FI)V", line = 51)
