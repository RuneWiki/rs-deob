...
public class class283 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(I)I", line = 9)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(II)Z", line = 24)
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(I)V", line = 35)
