...
public class class283 extends class509 {
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(ZILmn;)V")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(II)Z")
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lqba;Ldda;Lui;)V")
