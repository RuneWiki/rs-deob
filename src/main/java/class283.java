...
public class class283 extends class276 {
    ...
    @OriginalMember(owner = "client!s", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!s", name = "c", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(ZB)V", line = 101)
