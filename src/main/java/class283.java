...
public class class283 extends class303 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IIIZIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(BLya;II)Z", line = 46)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Lya;I)Lag;", line = 86)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Lya;Z)V", line = 143)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Ll;IIIILuq;Lma;I)V", line = 158)
