...
public class class283 extends class311 {
    ...
    @OriginalMember(owner = "client!ol", name = "finalize", descriptor = "()V", line = 9)
    protected final void finalize() {
        this.method1691(116);
        field3440++;
    }

    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "([BIII)I", line = 34)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Z)V", line = 45)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(II)Z", line = 55)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "([BIII)V", line = 67)
    ...
    @OriginalMember(owner = "client!ol", name = "c", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!ol", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 93)
