...
public class class283 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Ldga;BI)V", line = 9)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(BLdga;)V", line = 108)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(I)V", line = 172)
