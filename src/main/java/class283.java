...
public class class283 implements class112 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Lpe;I)V")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(BIIILvj;ILbi;Lpe;I)V")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(BI)Lb;")
    ...
    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(BI)Lue;")
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Lrk;Lrk;Lrk;)V")
