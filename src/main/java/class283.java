...
public class class283 extends class164 {
    ...
    @OriginalMember(owner = "client!ns", name = "z", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ns", name = "A", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IF)V", line = 56)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IIIIIIIIBI)V", line = 83)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(IF)V", line = 100)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(I)V", line = 119)
