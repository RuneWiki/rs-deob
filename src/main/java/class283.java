...
public class class283 extends class448 {
    ...
    @OriginalMember(owner = "client!uf", name = "e", descriptor = "(I)Ljava/lang/Object;", line = 6)
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "(Lm;Ljava/lang/Object;)V", line = 15)
    public class283(class181 arg0, Object arg1) {
        super(arg0);
        this.field3857 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!uf", name = "c", descriptor = "(B)Z", line = 24)
