...
public class class283 extends class499 {
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIIIII)I", line = 15)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(ZIIII)Lks;", line = 75)
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Lur;)V", line = 125)
