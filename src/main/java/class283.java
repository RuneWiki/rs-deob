...
public class class283 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(BLkv;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lkv;Lhea;IB)V", line = 20)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lkv;I)V", line = 189)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(BLkv;)V", line = 207)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(B)V", line = 224)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lkv;BI)V", line = 240)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(ILkv;)V", line = 603)
