...
public class class283 extends class325 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(BLkf;)[I")
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Lgaa;Z)V")
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Lgw;Laj;Ldr;Laj;Laj;I)Z")
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Ljp;IB)V")
