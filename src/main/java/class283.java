...
public class class283 extends class687 implements class123 {
    ...
    @OriginalMember(owner = "client!tfa", name = "<init>", descriptor = "(Lhb;Llw;III[B)V", line = 15)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(Lgca;I)V", line = 90)
    public final void method204(class206 arg0, int arg1) {
        int var3 = -43 / ((-arg1 - 2) / 39);
        super.method204(arg0, 77);
    }

    @OriginalMember(owner = "client!tfa", name = "c", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;", line = 98)
