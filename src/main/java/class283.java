...
public class class283 {
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(III)I", line = 17)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(B)V", line = 101)
    ...
    @OriginalMember(owner = "client!rd", name = "b", descriptor = "(Z)I", line = 128)
