...
public class class283 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(II)V", line = 16)
    ...
    @OriginalMember(owner = "client!fr", name = "finalize", descriptor = "()V", line = 32)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(BLya;)V", line = 48)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(I)Z", line = 63)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(ZILya;IIILt;B)V", line = 74)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(III)V", line = 113)
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(II)V", line = 211)
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "(Lya;Ljo;IIIIIIZI)V", line = 548)
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(I)I", line = 337)
    ...
    @OriginalMember(owner = "client!fr", name = "c", descriptor = "(I)Z", line = 349)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(BI)Lhc;", line = 360)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(BZZIILya;I)Lt;", line = 388)
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(BLya;)V", line = 525)
