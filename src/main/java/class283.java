...
public class class283 {
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(III)V", line = 18)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(Lqa;B)V", line = 120)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(Lqa;I)V", line = 134)
    ...
    @OriginalMember(owner = "client!dg", name = "finalize", descriptor = "()V", line = 155)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IBI)I", line = 168)
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(I)I", line = 198)
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Lqa;Lkn;IIIIIIZI)V", line = 545)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(B)Z", line = 219)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(ZI)V", line = 230)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(ZLqa;IIZBI)Lc;", line = 248)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(II)V", line = 376)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIIILc;Lqa;IZ)V", line = 499)
