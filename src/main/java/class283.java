...
public class class283 extends class96 {
    ...
    @OriginalMember(owner = "client!uf", name = "g", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IILbt;)V", line = 16)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(II)[[I", line = 65)
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(II)[I", line = 133)
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "()V", line = 176)
    public class283() {
        super(1, false);
    }

    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IILtu;ILqa;)V", line = 179)
