...
public abstract class class283 extends class96 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(I[S)[S", line = 7)
    ...
    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(III)V", line = 21)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IZ[B)Ljava/lang/Object;", line = 67)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lrl;I)V", line = 113)
