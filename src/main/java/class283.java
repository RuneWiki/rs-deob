...
public class class283 extends class136 {
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "()V", line = 89)
    public class283() {
        super(0, true);
    }

    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIBII)V", line = 7)
    ...
    @OriginalMember(owner = "client!dg", name = "f", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IILiv;)V", line = 37)
    ...
    @OriginalMember(owner = "client!dg", name = "g", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!dg", name = "h", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(I[Ljava/lang/String;[S)V", line = 118)
    public static final void method1807(int arg0, String[] arg1, short[] arg2) {
        ++field4114;
        class12.method83(118, arg2, arg1, arg0, arg1.length + -1);
    }

    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(II)[I", line = 128)
