...
public abstract class class283 {
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(IZ)Z", line = 8)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(ILfu;[IZ)Lje;", line = 30)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(Lla;I)V", line = 208)
    ...
    @OriginalMember(owner = "client!tfa", name = "b", descriptor = "(I)V", line = 221)
    ...
    @OriginalMember(owner = "client!tfa", name = "<init>", descriptor = "(Lkw;)V", line = 235)
