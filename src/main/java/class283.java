...
public class class283 {
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(Lr;III)V")
    ...
    @OriginalMember(owner = "client!wha", name = "b", descriptor = "(Lr;III)V")
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(BLjava/lang/String;)Z")
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(IILr;I)Z")
    ...
    @OriginalMember(owner = "client!wha", name = "<init>", descriptor = "(Lwh;Lmh;)V")
