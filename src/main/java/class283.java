...
public class class283 extends InputStream {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(ZLba;Ljava/lang/String;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Lqa;Lau;Lrg;B)V", line = 55)
    ...
    @OriginalMember(owner = "client!ga", name = "read", descriptor = "()I", line = 205)
