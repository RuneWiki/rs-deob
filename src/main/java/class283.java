...
public class class283 {
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(B)Lbm;")
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(I)Lbm;")
    ...
    @OriginalMember(owner = "client!ce", name = "d", descriptor = "(I)Lbm;")
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Z)Lbm;")
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(ILbm;)V")
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Lbm;I)V")
