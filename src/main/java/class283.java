...
public class class283 implements class617 {
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(BZ)V", line = 16)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(B)Z", line = 45)
    ...
    @OriginalMember(owner = "client!kd", name = "c", descriptor = "(I)Z", line = 63)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(Lin;Lin;Lot;)V", line = 98)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "([Lga;II)V", line = 111)
