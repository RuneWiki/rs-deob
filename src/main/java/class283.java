...
public class class283 extends class185 {
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(IIZ)Z", line = 9)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(IIIBI)V", line = 24)
    ...
    @OriginalMember(owner = "client!vca", name = "c", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!vca", name = "e", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!vca", name = "f", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(IIIIIBI)V", line = 114)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(IILjava/lang/String;)V", line = 553)
    ...
    @OriginalMember(owner = "client!vca", name = "<init>", descriptor = "(Lij;II)V", line = 563)
