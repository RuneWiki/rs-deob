...
public class class283 implements class321 {
    ...
    public final void method854(int arg0) {
        ...
        if (class302.field4753 && this.field4362 != null) {
            var2.glActiveTexture(33985);
            var2.glBindTexture(34067, this.field4362[arg0 - 1]);
            var2.glActiveTexture(33984);
        }
    }

    @OriginalMember(owner = "client!cb", name = "b", descriptor = "()I", line = 21)
    ...
    public class283() {
        if (class265.field4114 && class265.field4116 >= 2) {
            this.method2011();
            GL var1 = class265.field4099;
            var1.glBindTexture(34067, this.field4362[0]);
            ...
            var1.glBindTexture(34067, this.field4362[1]);
            var1.glTexParameteri(34067, 10241, 9729);
            var1.glTexParameteri(34067, 10240, 9729);
            var1.glTexParameteri(34067, 32882, 33071);
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            var1.glBindTexture(34067, this.field4362[2]);
            var1.glTexParameteri(34067, 10241, 9729);
            var1.glTexParameteri(34067, 10240, 9729);
            var1.glTexParameteri(34067, 32882, 33071);
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            this.field4361 = class265.field4116 < 3;
        }
        this.method2010();
    }

    @OriginalMember(owner = "client!cb", name = "d", descriptor = "()V", line = 31)
    private final void method2010() {
        GL var1 = class265.field4099;
        this.field4363 = var1.glGenLists(2);
        var1.glNewList(this.field4363, 4864);
        if (this.field4362 == null) {
            ...
            if (this.field4361) {
                ...
                var1.glTexEnvi(8960, 34162, 7681);
                var1.glTexEnvi(8960, 34184, 34167);
                var1.glBindTexture(3553, class265.field4110);
                var1.glEnable(3553);
            }
            var1.glActiveTexture(33984);
        }
        var1.glEndList();
        var1.glNewList(this.field4363 + 1, 4864);
        if (this.field4362 == null) {
    ...
    @OriginalMember(owner = "client!cb", name = "e", descriptor = "()V", line = 130)
    private final void method2011() {
        GL var1 = class265.field4099;
        if (this.field4362 == null) {
            this.field4362 = new int[3];
            var1.glGenTextures(3, this.field4362, 0);
        }
        short var2 = 4096;
        ...
        for (int var6 = 0; var6 < 6; var6++) {
            ...
            class214.field3410 += var2 * 3;
        }
    }

    @OriginalMember(owner = "client!cb", name = "c", descriptor = "()V", line = 246)
    public final void method857() {
        GL var1 = class265.field4099;
        if (class302.field4753) {
            var1.glCallList(this.field4363 + 1);
        } else {
            var1.glTexEnvi(8960, 34184, 5890);
        }
    }

    @OriginalMember(owner = "client!cb", name = "a", descriptor = "()V", line = 260)
    public final void method855() {
        GL var1 = class265.field4099;
        class265.method1898(1);
        if (class302.field4753) {
            var1.glCallList(this.field4363);
        } else {
            var1.glTexEnvi(8960, 34184, 34167);
        }
    }
