...
public class class283 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(B)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IZ)[I", line = 25)
    ...
    @OriginalMember(owner = "client!le", name = "b", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IIIIIIIIII)V", line = 140)
    ...
    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "(III)V", line = 204)
    ...
    @OriginalMember(owner = "client!le", name = "c", descriptor = "(I)Lr;", line = 169)
