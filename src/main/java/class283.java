...
public class class283 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ILbk;B)V", line = 30)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lre;I)V", line = 46)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(BLbk;)V", line = 79)
