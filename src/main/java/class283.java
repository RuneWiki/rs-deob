...
public class class283 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ILsq;I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(II)Z", line = 27)
    public final boolean method1672(int arg0, int arg1) {
        field3592++;
        return arg0 == -18491 ? this.field3590[arg1].method93(false) : true;
    }

    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(III)V", line = 40)
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(Lug;)V", line = 139)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ZIIZ)V", line = 70)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(I)V", line = 113)
