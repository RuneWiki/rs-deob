...
public class class208 extends class719 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(ZIILqba;I)V")
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Lee;)V")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(ZLb;I)V")
