...
public class class208 extends class518 {
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(IBI)Z", line = 55)
    ...
    @OriginalMember(owner = "client!fh", name = "f", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "()V", line = 213)
    public class208() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ILjc;I)V", line = 111)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(IIZ)Z", line = 192)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(I)V", line = 219)
