...
public class class208 implements class173 {

    @OriginalMember(owner = "client!bg", name = "b", descriptor = "[I")
    private int[] field3301 = null;
    ...
    @OriginalMember(owner = "client!bg", name = "d", descriptor = "()V", line = 16)
    private final void method1528() {
        GL var1 = class109.field1456;
        if (this.field3301 == null) {
            this.field3301 = new int[3];
            var1.glGenTextures(3, this.field3301, 0);
        }
        short var2 = 4096;
        ...
        for (int var6 = 0; var6 < 6; var6++) {
            ...
            var1.glBindTexture(34067, this.field3301[0]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var4));
            var1.glBindTexture(34067, this.field3301[1]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var5));
            var1.glBindTexture(34067, this.field3301[2]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var3));
            class103.field1374 += var2 * 3;
        }
    }

    @OriginalMember(owner = "client!bg", name = "a", descriptor = "()V", line = 131)
    public final void method355() {
        GL var1 = class109.field1456;
        if (class220.field3482) {
            var1.glCallList(this.field3300 + 1);
        } else {
            var1.glTexEnvi(8960, 34184, 5890);
        }
    }

    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I)V", line = 141)
    public final void method353(int arg0) {
        GL var2 = class109.field1456;
        if (class220.field3482 && this.field3301 != null) {
            var2.glActiveTexture(33985);
            var2.glBindTexture(34067, this.field3301[arg0 - 1]);
            var2.glActiveTexture(33984);
        }
    }

    @OriginalMember(owner = "client!bg", name = "c", descriptor = "()I", line = 154)
    public final int method352() {
        return 4;
    }

    @OriginalMember(owner = "client!bg", name = "e", descriptor = "()V", line = 158)
    private final void method1529() {
        GL var1 = class109.field1456;
        this.field3300 = var1.glGenLists(2);
        var1.glNewList(this.field3300, 4864);
        if (this.field3301 == null) {
            ...
            if (this.field3302) {
                ...
                var1.glTexEnvi(8960, 34162, 7681);
                var1.glTexEnvi(8960, 34184, 34167);
                var1.glBindTexture(3553, class109.field1476);
                var1.glEnable(3553);
            }
            var1.glActiveTexture(33984);
        }
        var1.glEndList();
        var1.glNewList(this.field3300 + 1, 4864);
        if (this.field3301 == null) {
            var1.glTexEnvi(8960, 34184, 5890);
        } else {
            var1.glActiveTexture(33985);
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "()V", line = 271)
    public class208() {
        if (class109.field1491 && class109.field1489 >= 2) {
            this.method1528();
            GL var1 = class109.field1456;
            var1.glBindTexture(34067, this.field3301[0]);
            ...
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            this.field3302 = class109.field1489 < 3;
        }
        this.method1529();
    }

    @OriginalMember(owner = "client!bg", name = "b", descriptor = "()V", line = 255)
    public final void method354() {
        GL var1 = class109.field1456;
        class109.method756(1);
        if (class220.field3482) {
            var1.glCallList(this.field3300);
        } else {
            var1.glTexEnvi(8960, 34184, 34167);
        }
    }
