...
public class class208 extends class287 {
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lpq;IIII)Le;")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(I[Lbn;)V")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IIIIIILta;II)V")
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(ILjava/awt/Canvas;Ll;)V")
    ...
    @OriginalMember(owner = "client!cd", name = "SA", descriptor = "(Lc;)V")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(II[I[I)Lta;")
    public final class144 method1215(int arg0, int arg1, int[] arg2, int[] arg3) {
        return new class217(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lob;Lob;FLob;)Lob;")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(II[[I[[IIII)Lya;")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IIIIIF)Lbn;")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lob;)V")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lgf;[Lev;Z)Lla;")
    ...
    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(IIIIII)Lob;")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "([Le;Leu;Lc;[Lut;I)V")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lev;Z)Lo;")
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(ILl;)V")
    ...
    @OriginalMember(owner = "client!cd", name = "d", descriptor = "()Lc;")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Ln;)V")
    public final void method1225(class15 arg0) {
    }

    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Ljava/lang/Runnable;)Llb;")
    ...
    @OriginalMember(owner = "client!cd", name = "g", descriptor = "(I)Ln;")
    ...
    @OriginalMember(owner = "client!cd", name = "ra", descriptor = "(ILta;II)V")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "([IIIII)Lo;")
    ...
    @OriginalMember(owner = "client!cd", name = "g", descriptor = "()Lc;")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "([Le;Lc;[Lut;I)V")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lls;III)V")
    ...
    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(IIIIZ)Lo;")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Leu;)V")
