...
public class class208 extends class443 {
    ...
    @OriginalMember(owner = "client!dt", name = "b", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!dt", name = "c", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!dt", name = "<init>", descriptor = "(Ltf;Lqp;)V", line = 50)
