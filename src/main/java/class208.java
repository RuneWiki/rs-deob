...
public class class208 extends class184 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(BILfh;)V", line = 4)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(ILtf;)V", line = 38)
    ...
    @OriginalMember(owner = "client!vc", name = "d", descriptor = "(III)I", line = 70)
    ...
    @OriginalMember(owner = "client!vc", name = "e", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(BIIII)V", line = 98)
    ...
    @OriginalMember(owner = "client!vc", name = "b", descriptor = "(II)[[I", line = 114)
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "()V", line = 285)
    public class208() {
        super(1, false);
    }

    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lci;", line = 208)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IIIIII)Z", line = 225)
