...
public class class208 extends class262 {
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(Lbl;IIIIZ[BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!js", name = "f", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!js", name = "g", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(Lbl;IIIIIIZ)V", line = 98)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Lh;III[Z)Z", line = 114)
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(Lbl;IIIIIZ)V", line = 149)
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(Lbl;IIII[I)V", line = 171)
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(Lbl;IIIZ[I)V", line = 186)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Ljava/awt/Color;IZILjava/awt/Color;Ljava/lang/String;Ljava/awt/Color;)V", line = 208)
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(III)Z", line = 286)
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(Lbl;IIIII[BI)V", line = 309)
