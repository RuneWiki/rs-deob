...
public class class208 extends class55 {
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(ZB)V", line = 49)
    ...
    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "(Lij;)V", line = 59)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(IILfe;)V", line = 170)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Z)V", line = 183)
    ...
    @OriginalMember(owner = "client!hi", name = "f", descriptor = "(I)Z", line = 227)
    ...
    @OriginalMember(owner = "client!hi", name = "g", descriptor = "(I)Z", line = 244)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(IIZ)V", line = 265)
    ...
    @OriginalMember(owner = "client!hi", name = "h", descriptor = "(I)V", line = 283)
