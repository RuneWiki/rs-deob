...
public class class208 extends class31 {
    ...
    @OriginalMember(owner = "client!ui", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ILjr;)Los;", line = 102)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(B)V", line = 115)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(I)V", line = 287)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Loa;Lgfa;III)V", line = 129)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(III)I", line = 175)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IFIIFBFFI[FI)V", line = 198)
