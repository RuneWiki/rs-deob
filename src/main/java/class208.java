...
public class class208 extends class578 implements class141 {
    ...
    @OriginalMember(owner = "client!su", name = "f", descriptor = "(B)Z", line = 6)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(I)Z", line = 17)
    ...
    @OriginalMember(owner = "client!su", name = "f", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Lha;I)V", line = 48)
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Lha;IZI)Z", line = 69)
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "(Lha;Luw;IIIIIZII)V", line = 88)
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(BLha;)Lvw;", line = 98)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Z)I", line = 150)
    ...
    @OriginalMember(owner = "client!su", name = "h", descriptor = "(I)I", line = 163)
    ...
    @OriginalMember(owner = "client!su", name = "g", descriptor = "(B)Z", line = 174)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(BLha;)V", line = 186)
    ...
    @OriginalMember(owner = "client!su", name = "c", descriptor = "(BLha;)V", line = 203)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(ZI)V", line = 228)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Lha;Z)Ltb;", line = 245)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(BILha;Lgs;ZII)V", line = 260)
    ...
    @OriginalMember(owner = "client!su", name = "h", descriptor = "(B)Z", line = 271)
    public final boolean method402(byte arg0) {
        ++field2984;
        return arg0 < 28;
    }

    @OriginalMember(owner = "client!su", name = "a", descriptor = "(B)I", line = 287)
    ...
    @OriginalMember(owner = "client!su", name = "i", descriptor = "(B)V", line = 301)
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(B)I", line = 314)
    ...
    @OriginalMember(owner = "client!su", name = "d", descriptor = "(B)I", line = 324)
