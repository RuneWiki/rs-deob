...
public class class208 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lam;III)Lpe;")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IILtq;)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Ljn;IIIII)Ljn;")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(ILtq;)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IZIIILjn;IB)Ljn;")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lam;I)V")
