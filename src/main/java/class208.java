...
public class class208 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IZ)V", line = 17)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(ILtq;)V", line = 91)
