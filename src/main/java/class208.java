...
public class class208 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Lvc;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(B)V", line = 131)
