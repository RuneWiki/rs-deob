...
public abstract class class208 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lvg;IB)I", line = 5)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(I)Z", line = 20)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(B)Z", line = 34)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(CBLjava/lang/String;)[Ljava/lang/String;", line = 45)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Z)Z", line = 89)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(B)Z", line = 101)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(I)V", line = 132)
