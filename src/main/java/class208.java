...
public class class208 extends class270 {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!rt", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZ)V", line = 36)
