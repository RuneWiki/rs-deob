...
public class class208 extends class50 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(B[IILwh;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "()Lar;", line = 67)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Lwh;BI)V", line = 85)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(B)V", line = 124)
    ...
    @OriginalMember(owner = "client!gf", name = "d", descriptor = "()I", line = 136)
    public final int method284() {
        field2931++;
        return 0;
    }

    @OriginalMember(owner = "client!gf", name = "d", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(J[IZI)Ljava/lang/String;", line = 178)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "([III)V", line = 201)
    ...
    @OriginalMember(owner = "client!gf", name = "c", descriptor = "()Lar;", line = 257)
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(Lnr;)V", line = 314)
