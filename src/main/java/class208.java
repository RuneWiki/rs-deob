...
public class class208 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(ZIIBILmo;)V")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IILgn;Le;ZII)Lid;")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IIIIILgn;ILe;II)Lid;")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "([Lac;IIIILgn;IIILe;ILgn;Z)Lid;")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IIBIILe;)V")
