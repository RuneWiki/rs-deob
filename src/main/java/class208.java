...
public class class208 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(I)Lsr;")
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(B)Lsr;")
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Lsr;I)V")
