...
public class class208 extends class459 implements class302 {
    ...
    @OriginalMember(owner = "client!jda", name = "k", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(B)I", line = 17)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(I)Z", line = 28)
    ...
    @OriginalMember(owner = "client!jda", name = "c", descriptor = "(B)I", line = 39)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(ILr;)V", line = 50)
    ...
    @OriginalMember(owner = "client!jda", name = "b", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!jda", name = "b", descriptor = "(B)I", line = 75)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(Lr;I)V", line = 86)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(BLr;)Lll;", line = 96)
    ...
    @OriginalMember(owner = "client!jda", name = "g", descriptor = "(B)I", line = 108)
    ...
    @OriginalMember(owner = "client!jda", name = "h", descriptor = "(I)Z", line = 119)
    ...
    @OriginalMember(owner = "client!jda", name = "<init>", descriptor = "(Lr;Llr;IIIIIZIIIIIII)V", line = 130)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(ILri;Lri;B)V", line = 140)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(ZILr;I)Z", line = 156)
    ...
    @OriginalMember(owner = "client!jda", name = "g", descriptor = "(I)I", line = 174)
    ...
    @OriginalMember(owner = "client!jda", name = "f", descriptor = "(B)V", line = 189)
    ...
    @OriginalMember(owner = "client!jda", name = "e", descriptor = "(B)Z", line = 202)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(Lr;Z)V", line = 213)
    ...
    @OriginalMember(owner = "client!jda", name = "b", descriptor = "(ILr;)Lod;", line = 236)
    ...
    @OriginalMember(owner = "client!jda", name = "h", descriptor = "(B)V", line = 285)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(III)V", line = 433)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(IIILr;ZILpn;)V", line = 449)
    ...
    @OriginalMember(owner = "client!jda", name = "i", descriptor = "(I)Z", line = 462)
