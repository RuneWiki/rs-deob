...
public class class208 extends class436 {
    ...
    @OriginalMember(owner = "client!lb", name = "b", descriptor = "(Z)V", line = 5)
    public final void method161(boolean arg0) {
        this.field6402.method1627(260, 8448);
    }

    @OriginalMember(owner = "client!lb", name = "c", descriptor = "()V", line = 9)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "()Z", line = 47)
    public final boolean method159() {
        return true;
    }

    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lme;)V", line = 50)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!lb", name = "b", descriptor = "()V", line = 121)
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Lnf;Lqg;)V", line = 138)
