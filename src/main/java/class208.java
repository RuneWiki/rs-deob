...
public class class208 extends class406 {
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(Lfca;Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(ZLgca;)V", line = 33)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(I)V", line = 54)
