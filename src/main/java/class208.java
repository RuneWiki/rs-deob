...
public class class208 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IIIIIIB)V", line = 25)
    ...
    @OriginalMember(owner = "client!o", name = "toString", descriptor = "()Ljava/lang/String;", line = 49)
    public final String toString() {
        field2900++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IIIIBIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(I)V", line = 180)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "([J[IB)V", line = 191)
    ...
    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "(IIII)V", line = 203)
