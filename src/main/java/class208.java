...
public class class208 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IZIIFIIII)[[I", line = 22)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(II)V", line = 81)
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(Lsn;ILci;Lci;)V", line = 167)
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(II)Lpe;", line = 126)
