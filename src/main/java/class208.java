...
public class class208 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(II)V", line = 21)
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(II)Lie;", line = 63)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Z)V", line = 94)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(Ldn;ILr;)V", line = 133)
