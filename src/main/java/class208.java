...
public class class208 extends class205 {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Lraa;I)V")
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZJZ)V")
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(ZLoj;)Ljava/lang/String;")
