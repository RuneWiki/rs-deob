...
public class class208 {
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(I)Ldga;", line = 162)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Lee;I)V", line = 186)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IILee;)V", line = 212)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IIZI[BII)Z", line = 235)
