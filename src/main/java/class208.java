...
public class class208 extends class352 {
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(IIIILwh;)Liba;", line = 81)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(III[[[BIIIILha;IIII)V", line = 106)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(IIII)V", line = 140)
    ...
    @OriginalMember(owner = "client!rea", name = "b", descriptor = "(I)V", line = 156)
