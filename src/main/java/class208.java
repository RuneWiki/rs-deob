...
public class class208 extends class478 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Lrb;)V", line = 17)
    ...
    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "()V", line = 36)
    public class208() {
        this(4096);
    }

    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(ILnp;I)V", line = 40)
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(II)[I", line = 82)
