...
public class class208 extends class271 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(ZILm;Lic;IB)[F", line = 3)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IZ)Z", line = 154)
    ...
    @OriginalMember(owner = "client!en", name = "f", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!en", name = "g", descriptor = "(I)V", line = 198)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(Lm;ILic;)Z", line = 225)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IIIIB)V", line = 279)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(ZLic;DZLm;III)[I", line = 298)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IIIZIII)I", line = 439)
    ...
    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "()V", line = 469)
    public class208() {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(BLjava/lang/String;)I", line = 489)
    ...
    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "(Ldh;)V", line = 509)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(ZIDIILm;Lic;)[I", line = 596)
