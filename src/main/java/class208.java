...
public class class208 extends class195 {
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Lge;IIII)V")
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Lge;IIIIZ[IZ)V")
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Lge;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Lge;IIIII)V")
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Lge;IIIIZ[BIZ)V")
