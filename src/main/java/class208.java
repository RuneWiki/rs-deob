...
public class class208 extends class188 implements class281 {
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(ZII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!uga", name = "d", descriptor = "(B)I", line = 17)
    ...
    @OriginalMember(owner = "client!uga", name = "b", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(Lha;B)V", line = 42)
    ...
    @OriginalMember(owner = "client!uga", name = "c", descriptor = "(I)Z", line = 53)
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(BLha;)Llba;", line = 63)
    ...
    @OriginalMember(owner = "client!uga", name = "e", descriptor = "(Z)I", line = 114)
    ...
    @OriginalMember(owner = "client!uga", name = "<init>", descriptor = "(Lha;Lvc;IIIIIZII)V", line = 127)
    ...
    @OriginalMember(owner = "client!uga", name = "f", descriptor = "(I)I", line = 138)
    public final int method985(int arg0) {
        ++field2455;
        return arg0 != 4 ? 16 : this.field2441.method2860(true);
    }

    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(Z)Z", line = 149)
    ...
    @OriginalMember(owner = "client!uga", name = "f", descriptor = "(Z)V", line = 163)
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(Lha;I)V", line = 176)
    ...
    @OriginalMember(owner = "client!uga", name = "c", descriptor = "(B)I", line = 200)
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(IILha;I)Z", line = 211)
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(CI)Z", line = 233)
    ...
    @OriginalMember(owner = "client!uga", name = "g", descriptor = "(I)Z", line = 248)
    ...
    @OriginalMember(owner = "client!uga", name = "h", descriptor = "(I)Z", line = 266)
    ...
    @OriginalMember(owner = "client!uga", name = "b", descriptor = "(ILha;)Llca;", line = 276)
    public final class642 method983(int arg0, class58 arg1) {
        ++field2442;
        return arg0 != 0 ? null : this.field2446;
    }

    @OriginalMember(owner = "client!uga", name = "b", descriptor = "(I)V", line = 287)
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(B)I", line = 299)
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(ZLha;Lrr;IIII)V", line = 314)
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(ILha;)V", line = 328)
