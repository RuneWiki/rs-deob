...
public class class208 extends class371 {
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(BI)[I", line = 3)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IBLps;)V", line = 83)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "()V", line = 109)
    public class208() {
        super(0, true);
    }
}
