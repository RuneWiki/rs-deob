...
public class class208 {
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(Lfb;Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "([[BILaha;)V", line = 67)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(Z)Z", line = 107)
    ...
    @OriginalMember(owner = "client!dga", name = "b", descriptor = "(I)V", line = 131)
