...
public class class208 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ILjava/applet/Applet;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;", line = 3)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Ljava/lang/String;BLjava/applet/Applet;)V", line = 14)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Ljava/lang/String;Ljava/applet/Applet;I)Ljava/lang/Object;", line = 24)
