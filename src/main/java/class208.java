...
public class class208 implements Runnable {
    ...
    @OriginalMember(owner = "client!dga", name = "b", descriptor = "(B)Les;")
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(BLffa;)V")
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(JBILes;Ljava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!dga", name = "d", descriptor = "(I)[Lqca;")
