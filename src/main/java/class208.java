...
public abstract class class208 extends class745 {
    ...
    @OriginalMember(owner = "client!km", name = "d", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(I[Lmfa;)I")
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(BLha;)Z")
