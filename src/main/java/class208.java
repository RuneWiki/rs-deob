...
public class class208 extends class263 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Lrm;III)V")
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(ILfe;IZIZLfe;)I")
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(IZLgk;)V")
