...
public class class208 extends class196 {
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(CIIIZLhm;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "([B[IIIIIIIIIIILhm;II)V", line = 69)
    ...
    @OriginalMember(owner = "client!pa", name = "<init>", descriptor = "(Ls;Lnm;[Lcl;[I[I)V", line = 167)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "([B[IIIIIIII)V", line = 190)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(CIIIZ)V", line = 223)
