...
public class class208 extends class570 {
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(IZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(IIIIIIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!uea", name = "b", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!uea", name = "c", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(BLwv;)V", line = 216)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(Z)V", line = 257)
