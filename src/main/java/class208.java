...
public class class208 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "()V", line = 6)
    public void method574() throws Exception {
        field2653++;
    }

    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(I)V", line = 13)
    public void method571(int arg0) throws Exception {
        field2664++;
    }

    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(BLha;)V", line = 144)
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(I)V", line = 159)
    ...
    @OriginalMember(owner = "client!vm", name = "c", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!vm", name = "d", descriptor = "(I)V", line = 191)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(ILrn;)V", line = 212)
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "()I", line = 223)
    public int method572() throws Exception {
        field2666++;
        return this.field2671;
    }

    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Lrn;II)V", line = 231)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "([II)V", line = 256)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 414)
    public void method570(Component arg0) throws Exception {
        field2665++;
    }

    @OriginalMember(owner = "client!vm", name = "c", descriptor = "()V", line = 425)
    public void method573() throws Exception {
        field2670++;
    }

    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(II)V", line = 434)
    ...
    @OriginalMember(owner = "client!vm", name = "d", descriptor = "()V", line = 458)
    public void method575() {
        field2655++;
    }

    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(B)V", line = 465)
