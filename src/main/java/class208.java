...
public class class208 {
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(II)V", line = 40)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(II)Lwc;", line = 60)
    ...
    @OriginalMember(owner = "client!aj", name = "c", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ILnq;IZI[I)Lld;", line = 114)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IILjava/lang/String;IIIII)V", line = 135)
    ...
    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(Liv;ILuu;Luu;)V", line = 175)
