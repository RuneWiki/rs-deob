...
public class class208 extends class298 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(II)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(Lqo;[I[II[I)V", line = 80)
    ...
    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "()V", line = 175)
    public class208() {
        super(1, false);
    }

    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 180)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IILvt;)V", line = 208)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(ILvt;)Le;", line = 252)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(ZLcj;)V", line = 267)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IZ)[I", line = 293)
    ...
    @OriginalMember(owner = "client!dh", name = "d", descriptor = "(Z)V", line = 347)
