...
public class class208 extends class417 {
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ILko;I)V", line = 44)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(BILko;[III)V", line = 85)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(II)V", line = 146)
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Ltm;)V", line = 404)
    public class208(class20 arg0) {
        this.field2826 = arg0;
    }

    @OriginalMember(owner = "client!af", name = "c", descriptor = "(Z)V", line = 164)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "([III)V", line = 262)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "()Lmq;", line = 303)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "()Lmq;", line = 327)
    ...
    @OriginalMember(owner = "client!af", name = "c", descriptor = "(II)Lwe;", line = 347)
    ...
    @OriginalMember(owner = "client!af", name = "d", descriptor = "()I", line = 359)
    public final int method152() {
        field2831++;
        return 0;
    }

    @OriginalMember(owner = "client!af", name = "d", descriptor = "(II)Lil;", line = 371)
