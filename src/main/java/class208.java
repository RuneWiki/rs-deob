...
public class class208 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ZI[B)V", line = 4)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ILjava/lang/String;ZB)I", line = 49)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(I)V", line = 148)
