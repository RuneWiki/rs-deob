...
public class class208 extends class499 {
    ...
    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "(Lls;)V", line = 74)
    public class208(class92 arg0) {
        this.field2950 = arg0;
    }

    @OriginalMember(owner = "client!en", name = "c", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IIB)Z", line = 52)
