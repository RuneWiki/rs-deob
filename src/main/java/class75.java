...
public class class75 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(ILbfa;I[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(II)V", line = 104)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Lov;III)V", line = 118)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(I)V", line = 166)
