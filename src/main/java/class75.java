...
public class class75 {
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!vg", name = "b", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Lo;I)V", line = 59)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IZ)V", line = 81)
