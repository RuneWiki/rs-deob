...
public class class75 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IILec;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(BLec;I)V", line = 32)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(III)V", line = 58)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IIII)V", line = 102)
