...
public class class75 extends class427 {
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(ILl;Lqa;)V", line = 11)
    ...
    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 246)
    public class75(String arg0, int arg1) {
        this.field1104 = arg0;
        this.field1100 = (short) arg1;
    }

    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(IIIIIIIIB)V", line = 256)
    ...
    @OriginalMember(owner = "client!bm", name = "d", descriptor = "(I)V", line = 270)
