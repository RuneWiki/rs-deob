...
public class class75 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(BJ)Ljava/lang/String;", line = 7)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!vm", name = "toString", descriptor = "()Ljava/lang/String;", line = 76)
