...
public class class75 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IIILvg;)V", line = 5)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(ZI)V", line = 76)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Ljq;BI)V", line = 90)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lij;B)V", line = 149)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(II)Lbh;", line = 175)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IIIIII)Z", line = 207)
