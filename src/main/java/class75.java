...
public class class75 extends class243 {
    ...
    @OriginalMember(owner = "client!u", name = "d", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(B[II)V", line = 68)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ILji;B)V", line = 231)
    ...
    @OriginalMember(owner = "client!u", name = "c", descriptor = "(I)V", line = 323)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(II)[I", line = 367)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IIIIIII)I", line = 391)
