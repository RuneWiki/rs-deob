...
public class class75 extends class205 implements class185 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ILqq;Lps;ZZII)V")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IZLqq;Z)Ldi;")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Lqq;I)V")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ZLqq;)V")
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Lqq;Lin;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(BLqq;)Lkm;")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ILqq;I)Lcd;")
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(ZLqq;)V")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Lqq;BII)Z")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Lqq;ZI)Lcd;")
