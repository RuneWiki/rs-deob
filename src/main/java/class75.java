...
public class class75 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Ldn;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(II)V", line = 16)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Lgf;B)I", line = 50)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Lso;IIIII)Lbv;", line = 124)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(BI)Lvr;", line = 161)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Z)V", line = 189)
    ...
    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(I)V", line = 212)
    ...
    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(Lgt;ILdn;)V", line = 229)
