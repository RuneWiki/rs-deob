...
public class class75 extends class642 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(B)J", line = 3)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Z)J", line = 32)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(JI)I", line = 72)
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(I)J", line = 110)
