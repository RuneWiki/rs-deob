...
public class class75 extends class577 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IZII)Lwia;", line = 24)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ZIII)V", line = 43)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "()V", line = 64)
    public class75() {
    }

    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(S)V", line = 67)
    public class75(short arg0) {
        this.field853 = arg0;
    }

    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(I)V", line = 75)
