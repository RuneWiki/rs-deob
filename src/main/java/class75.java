...
public class class75 extends class210 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(BI)I", line = 3)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Luk;IIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IIIIII)V", line = 72)
    ...
    @OriginalMember(owner = "client!a", name = "b", descriptor = "(II)I", line = 174)
    public static final int method530(int arg0, int arg1) {
        return class299.field4360 != null ? class299.field4360[arg0][arg1] >>> 21 & 2040 : 0;
    }

    @OriginalMember(owner = "client!a", name = "<init>", descriptor = "()V", line = 330)
    public class75() {
        super(1, false);
    }

    @OriginalMember(owner = "client!a", name = "g", descriptor = "(I)V", line = 180)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(II)[[I", line = 197)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IB)[I", line = 334)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IILat;)V", line = 443)
