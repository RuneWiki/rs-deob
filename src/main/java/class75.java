...
public class class75 {
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(IIIB)Lfca;")
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(I)Lgk;")
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(ILoa;Le;)V")
    ...
    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "(Lfca;I)V")
