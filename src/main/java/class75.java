...
public class class75 {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(BLpq;)V", line = 8)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(IZ)Lgda;", line = 50)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(B)V", line = 107)
