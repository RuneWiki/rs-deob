...
public class class75 extends class335 {
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(I)J", line = 4)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(B)J", line = 21)
    ...
    @OriginalMember(owner = "client!aw", name = "c", descriptor = "(B)J", line = 43)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(IJ)I", line = 79)
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "()V", line = 117)
    public class75() {
