...
public class class75 extends class264 {
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!tr", name = "<init>", descriptor = "()V", line = 72)
    public class75() {
        super(0, true);
    }

    @OriginalMember(owner = "client!tr", name = "f", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(BLkk;I)V", line = 87)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IB)V", line = 134)
    ...
    @OriginalMember(owner = "client!tr", name = "h", descriptor = "(I)V", line = 153)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(II)[I", line = 167)
