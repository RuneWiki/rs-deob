...
public class class75 extends class130 {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IIILwl;III)V", line = 4)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "()V", line = 12)
    public class75() {
    }
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(J)V", line = 24)
