...
public class class75 {
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(B)[Lio;", line = 12)
    public static final class439[] method629(byte arg0) {
        if (arg0 <= 115) {
            return null;
        } else {
            field1044++;
            return new class439[] { class622.field8731, class529.field7543, class463.field6817, class76.field1065, class307.field4353, class247.field3593, class575.field8145, class457.field6746, class189.field2867, class45.field500 };
        }
    }
}
