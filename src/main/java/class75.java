...
public class class75 extends class143 implements class265 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(BLen;)V")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(ILen;)Lir;")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(Len;B)V")
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(Len;Lnl;IIIIIIIZIIII)V")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(BILen;)Lmj;")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IIZLen;)Z")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(Len;I)V")
