...
public class class75 extends class573 {
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(ZLft;Z)V")
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(Lwc;IB)V")
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(ZIILli;)V")
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(BILwu;Lwu;)V")
    ...
    @OriginalMember(owner = "client!gea", name = "<init>", descriptor = "(Lrv;)V")
