...
public class class75 {
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(IIIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(IILvu;I)J", line = 53)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(ZI)V", line = 81)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(IIIIIZI)V", line = 232)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(Lha;II[[[BIIBIIIIII)V", line = 248)
