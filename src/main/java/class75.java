...
public class class75 extends class223 {
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(BLlh;)I", line = 20)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(IIILrs;)V", line = 52)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(IZ)V", line = 109)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(BILsd;IIIIIIII)Z", line = 153)
    ...
    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "()V", line = 509)
    public class75() {
    }

    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 517)
