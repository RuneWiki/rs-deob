...
public class class75 extends class207 {
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(BII)Z", line = 18)
    ...
    @OriginalMember(owner = "client!qh", name = "b", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "(Lrd;)V", line = 61)
    public class75(class355 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(IB)V", line = 65)
    ...
    @OriginalMember(owner = "client!qh", name = "c", descriptor = "(I)I", line = 77)
    ...
    @OriginalMember(owner = "client!qh", name = "b", descriptor = "(IB)I", line = 88)
    ...
    @OriginalMember(owner = "client!qh", name = "b", descriptor = "(I)I", line = 103)
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "(ILrd;)V", line = 116)
