...
public class class75 extends class311 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Llh;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IZ)Z", line = 263)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Lkj;B)V", line = 278)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(B)V", line = 314)
    ...
    @OriginalMember(owner = "client!jj", name = "b", descriptor = "(B)Llh;", line = 330)
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(Lkj;)V", line = 416)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(BI)Z", line = 383)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ZB)V", line = 399)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(II)I", line = 503)
