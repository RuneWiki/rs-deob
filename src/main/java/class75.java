...
public abstract class class75 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ZIBII)Lcq;", line = 20)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Lhe;Lps;Z)V", line = 62)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(I)V", line = 94)
