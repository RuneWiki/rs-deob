...
public class class75 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Ljava/lang/String;I)[B", line = 5)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(I)V", line = 143)
    public static void method583(int arg0) {
        int var1 = 100 % ((arg0 + 55) / 34);
        field990 = null;
    }

    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(IZIIB)V", line = 158)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lfa;Ljava/awt/Canvas;B)Lr;", line = 179)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(II)Lir;", line = 191)
