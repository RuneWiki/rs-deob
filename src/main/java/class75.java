...
public class class75 extends class194 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(B[[I)V", line = 5)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(JI)V", line = 55)
    ...
    @OriginalMember(owner = "client!rf", name = "d", descriptor = "(III)V", line = 144)
    ...
    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "()V", line = 168)
    public class75() {
        super(0, true);
    }

    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(B)V", line = 172)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lwo;I)V", line = 193)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(IILbg;)V", line = 204)
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(II)[[I", line = 279)
    ...
    @OriginalMember(owner = "client!rf", name = "h", descriptor = "(I)V", line = 344)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(II)[I", line = 358)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(IB)Lrn;", line = 380)
