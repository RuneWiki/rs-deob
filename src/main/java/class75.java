...
public class class75 extends IOException {
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 15)
    public class75(String arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(Lr;BIILet;I)V", line = 35)
