...
public class class75 extends class344 {
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Lse;IIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Lse;IIII[BI)V", line = 21)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(III)V", line = 32)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "()V", line = 37)
