...
public class class75 {
    ...
    @OriginalMember(owner = "client!hf", name = "B", descriptor = "Lsa;")
    ...
    @OriginalMember(owner = "client!hf", name = "x", descriptor = "[Llf;")
    public static class109[] field1450 = new class109[100];

    @OriginalMember(owner = "client!hf", name = "q", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Lsa;II)V")
