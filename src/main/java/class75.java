...
public class class75 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(III)I", line = 4)
    ...
    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!ri", name = "<init>", descriptor = "(Lkp;ILph;)V", line = 130)
    public class75(class341 arg0, int arg1, class459 arg2) {
        this.field1528 = arg2;
        this.field1528.method2763(1, -3);
    }

    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IIBI)Lms;", line = 71)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(II)Lqc;", line = 151)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IB)V", line = 181)
    ...
    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(I)V", line = 197)
