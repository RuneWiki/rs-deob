...
public class class75 {
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(II)V", line = 15)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(BI)Lpaa;", line = 34)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Z)V", line = 78)
    ...
    @OriginalMember(owner = "client!qh", name = "b", descriptor = "(Z)V", line = 99)
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "(Liv;ILcb;)V", line = 118)
