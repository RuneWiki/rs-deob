...
public class class75 {
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(IBI)Z", line = 15)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(BLji;)Ljava/lang/String;", line = 31)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(Lji;Z)Loaa;", line = 49)
