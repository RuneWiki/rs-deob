...
public class class75 extends class390 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IIZI)I", line = 21)
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "()V", line = 57)
    public class75() {
    }

    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(J)V", line = 59)
    public class75(long arg0) {
        this.field1071 = arg0;
    }

    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(Lkm;I)I", line = 72)
    ...
    @OriginalMember(owner = "client!hc", name = "b", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!hc", name = "b", descriptor = "(III)V", line = 123)
