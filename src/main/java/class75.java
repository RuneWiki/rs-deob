...
public class class75 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Z)Z", line = 24)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(I)V", line = 183)
    ...
    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "(I)V", line = 199)
