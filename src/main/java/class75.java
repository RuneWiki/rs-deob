...
public abstract class class75 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IIIBLsm;II)V")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(Lbl;II)V")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(Luo;Luo;Lpf;I[IIIIZZ[ZB)V")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IIIZLbl;IILbl;B)V")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(ZLbl;[IILbl;IIIIII)V")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(ILbl;IZLbl;ILbl;Lbl;III[ZIII)V")
