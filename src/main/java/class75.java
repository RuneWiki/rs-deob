...
public class class75 extends class433 {
    ...
    @OriginalMember(owner = "client!gea", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(III[B)V", line = 20)
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(IIIIBLhf;)V", line = 43)
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(B)V", line = 306)
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(IIB[B)I", line = 323)
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(II)Z", line = 340)
    ...
    @OriginalMember(owner = "client!gea", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 356)
    ...
    @OriginalMember(owner = "client!gea", name = "finalize", descriptor = "()V", line = 368)
