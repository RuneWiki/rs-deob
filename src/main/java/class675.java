...
public class class675 implements class481 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lfa;ILjn;Ljava/awt/Canvas;I)Lr;")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(B[ILgfa;J)Ljava/lang/String;")
