...
public class class675 implements class23 {
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(BIII)Lto;")
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(BLdc;)Z")
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(ZIIZ)Lga;")
