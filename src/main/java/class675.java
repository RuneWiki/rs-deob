...
public abstract class class675 extends class256 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(BII)I", line = 4)
    ...
    @OriginalMember(owner = "client!fb", name = "e", descriptor = "(I)Z", line = 21)
    ...
    @OriginalMember(owner = "client!fb", name = "i", descriptor = "(I)Lmfa;", line = 64)
    public static final class616 method3759(int arg0) {
        ++field9362;
        return arg0 != 1 ? null : class98.method729(-108, 1);
    }

    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(III)I", line = 84)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "([Ltn;B)I", line = 104)
    ...
    @OriginalMember(owner = "client!fb", name = "h", descriptor = "(B)V", line = 274)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Ljava/awt/Component;ZB)Lqha;", line = 285)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IIIIZ)V", line = 302)
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(Lha;B)Z", line = 316)
    ...
    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "(IIIIIIIIIZB)V", line = 330)
