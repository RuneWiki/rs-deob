...
public class class675 extends class125 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(ZI)I", line = 3)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(BI)V", line = 35)
    ...
    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(III)Lnf;", line = 47)
    ...
    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(Z)V", line = 57)
    ...
    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(I)Z", line = 86)
    ...
    @OriginalMember(owner = "client!vu", name = "c", descriptor = "(Z)I", line = 97)
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "(ILgp;)V", line = 108)
    public class675(int arg0, class549 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(B)I", line = 112)
    ...
    @OriginalMember(owner = "client!vu", name = "c", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!vu", name = "d", descriptor = "(I)Z", line = 143)
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "(Lgp;)V", line = 154)
