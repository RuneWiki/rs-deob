...
public class class675 extends class49 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IZII[Lsha;IIIIII)V")
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(BLgga;)V")
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Lgga;II)V")
