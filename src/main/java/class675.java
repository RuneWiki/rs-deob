...
public class class675 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(II)Z", line = 5)
    ...
    @OriginalMember(owner = "client!bl", name = "toString", descriptor = "()Ljava/lang/String;", line = 23)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(II)V", line = 50)
