...
public class class675 extends class381 implements class439 {
    ...
    @OriginalMember(owner = "client!vca", name = "b", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(BLjava/lang/String;)V", line = 20)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(III)Z", line = 74)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(I)J", line = 85)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(Z)I", line = 98)
    public final int method2606(boolean arg0) {
        field9513++;
        return arg0 ? this.field9521 : -32;
    }

    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(B)I", line = 109)
    ...
    @OriginalMember(owner = "client!vca", name = "b", descriptor = "(I)C", line = 124)
