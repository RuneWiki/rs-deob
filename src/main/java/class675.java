...
public class class675 {
    ...
    @OriginalMember(owner = "client!dr", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field9223++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IZ)V", line = 13)
    ...
    @OriginalMember(owner = "client!dr", name = "b", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(B)V", line = 100)
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(II)V", line = 121)
    public class675(int arg0, int arg1) {
        this.field9217 = arg1;
        this.field9214 = arg0;
    }

    @OriginalMember(owner = "client!dr", name = "c", descriptor = "(I)I", line = 135)
