...
public class class675 extends class86 {
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!fia", name = "<init>", descriptor = "(Lsf;)V", line = 13)
    public class675(class551 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(IZ)V", line = 22)
    ...
    @OriginalMember(owner = "client!fia", name = "b", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!fia", name = "<init>", descriptor = "(ILsf;)V", line = 45)
    public class675(int arg0, class551 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!fia", name = "c", descriptor = "(II)Ldl;", line = 48)
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(Z)I", line = 72)
    ...
    @OriginalMember(owner = "client!fia", name = "b", descriptor = "(II)I", line = 85)
    ...
    @OriginalMember(owner = "client!fia", name = "c", descriptor = "(I)Z", line = 99)
    ...
    @OriginalMember(owner = "client!fia", name = "b", descriptor = "(I)I", line = 111)
