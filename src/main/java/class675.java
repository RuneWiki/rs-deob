...
public class class675 {
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(ILim;)Z")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(ILcr;)Lrp;")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
