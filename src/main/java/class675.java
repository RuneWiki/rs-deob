...
public class class675 {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IIIIIIIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ILjava/lang/String;)V", line = 83)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(I)V", line = 185)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(B)V", line = 196)
