...
public class class675 {
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(JI)Ljga;", line = 47)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(JILjga;)V", line = 70)
    ...
    @OriginalMember(owner = "client!vca", name = "<init>", descriptor = "(I)V", line = 113)
