...
public class class675 {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Ljava/awt/Canvas;Ld;Lin;II)Lha;", line = 21)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IB[B)[B", line = 50)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(I[BII)[B", line = 64)
