...
public class class675 implements Runnable {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(BLjava/net/URL;)Lpga;")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Ljava/lang/Class;[Ljava/lang/Class;Ljava/lang/String;B)Lpga;")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Ljava/lang/String;IIZ)Lpga;")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(ZZLjava/lang/String;)Lpga;")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Ljava/lang/String;I)Lpga;")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "([IILjava/awt/Component;Ljava/awt/Point;II)Lpga;")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;I)Lea;")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Ljava/awt/Frame;I)Lpga;")
    public final class561 method3796(Frame arg0, int arg1) {
        return arg1 >= -96 ? null : this.method3801(0, 0, 7, 0, arg0);
    }

    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Ljava/lang/Class;ILjava/lang/String;)Lpga;")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Ljava/lang/String;B)Lea;")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IIIII)Lpga;")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IIIILjava/lang/Object;)Lpga;")
    ...
    @OriginalMember(owner = "client!lc", name = "c", descriptor = "(Z)Lpga;")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(II)Lpga;")
    public final class561 method3804(int arg0, int arg1) {
        return arg0 < 65 ? null : this.method3801(0, 0, 3, arg1, null);
    }

    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IILjava/lang/Runnable;)Lpga;")
