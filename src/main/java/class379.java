...
public class class379 {
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(IB)Liga;", line = 3)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(ZI)Z", line = 29)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(II)I", line = 48)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Lha;ZLjava/lang/String;BLda;Lfp;)V", line = 65)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(ILjava/lang/String;Ljava/io/File;)V", line = 163)
    ...
    @OriginalMember(owner = "client!dda", name = "<init>", descriptor = "(Ltda;III)V", line = 175)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(B)V", line = 187)
