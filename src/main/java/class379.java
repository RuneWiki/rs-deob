...
public class class379 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(III)Z", line = 51)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Lm;Ljava/awt/Canvas;ILhu;B)Lqa;", line = 63)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IBLtl;)V", line = 77)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(B)V", line = 96)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(BLtl;)V", line = 125)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Z)V", line = 151)
