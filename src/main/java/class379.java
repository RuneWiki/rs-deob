...
public class class379 extends class318 {
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(Lkd;)V")
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IIILse;)V")
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Lav;IB)V")
