...
public class class379 extends class629 {
    ...
    @OriginalMember(owner = "client!oj", name = "b", descriptor = "()Lpda;")
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Lnp;III)Loj;")
    ...
    @OriginalMember(owner = "client!oj", name = "d", descriptor = "()Lpda;")
    ...
    @OriginalMember(owner = "client!oj", name = "j", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "(Lnp;III)V")
