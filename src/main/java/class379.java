...
public class class379 extends class187 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(II)I", line = 6)
    public static int method2318(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!cm", name = "c", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "([B)V", line = 76)
