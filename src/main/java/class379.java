...
public abstract class class379 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(BI)Lnc;")
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ILps;II)V")
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(II)Lcp;")
