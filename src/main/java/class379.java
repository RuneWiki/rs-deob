...
public class class379 extends class539 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(BLfaa;Loa;)V", line = 6)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "([Lfaa;BI)V", line = 112)
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "()V", line = 202)
    public class379() {
    }

    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(S)V", line = 204)
