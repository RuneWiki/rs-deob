...
public class class379 extends class315 {
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Lef;Ldq;[Lft;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!lb", name = "OA", descriptor = "(CIIIZ)V", line = 212)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(CIIIZLma;II)V", line = 231)
