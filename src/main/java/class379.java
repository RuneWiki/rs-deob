...
public class class379 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "()V", line = 277)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IZ)V", line = 297)
    ...
    @OriginalMember(owner = "client!vh", name = "b", descriptor = "(IZ)V", line = 4494)
