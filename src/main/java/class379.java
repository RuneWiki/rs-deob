...
public class class379 {
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lkm;IIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!qt", name = "b", descriptor = "(Lkm;IIII)Lsm;", line = 348)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(I)V", line = 358)
    public static final void method2259(int arg0) {
        field5359 = (class200) field5357.method2614((long) arg0, 101);
    }

    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lkm;IIIIIII[S[BZ)V", line = 361)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(II)Lwt;", line = 525)
    ...
    @OriginalMember(owner = "client!qt", name = "b", descriptor = "(I)Lwt;", line = 537)
    public static final class200 method2262(int arg0) {
        return (class200) field5357.method2614((long) arg0, -82);
    }

    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(IIIIIIII)V", line = 542)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "()V", line = 553)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lbc;II)V", line = 581)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lkm;)V", line = 591)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lkm;IIII[S[B)V", line = 603)
    ...
    @OriginalMember(owner = "client!qt", name = "b", descriptor = "()V", line = 662)
    ...
    @OriginalMember(owner = "client!qt", name = "b", descriptor = "(Lkm;)Lsm;", line = 690)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lkm;Llk;IIII[I[I)V", line = 701)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lkm;Lji;IIII)V", line = 837)
    ...
    @OriginalMember(owner = "client!qt", name = "c", descriptor = "()V", line = 841)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lfc;Lwg;Li;Ljf;Lsn;Lpp;Lfh;)V", line = 851)
    ...
    @OriginalMember(owner = "client!qt", name = "d", descriptor = "()V", line = 877)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lkm;II)V", line = 890)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lbc;III)I", line = 1069)
    ...
    @OriginalMember(owner = "client!qt", name = "b", descriptor = "(II)Lot;", line = 1126)
    ...
    @OriginalMember(owner = "client!qt", name = "e", descriptor = "()V", line = 1143)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "([B[B[SII)V", line = 1301)
