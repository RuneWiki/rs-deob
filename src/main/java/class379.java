...
public class class379 {
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(ILjp;)V", line = 19)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(ID)V", line = 62)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Z)V", line = 89)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(II)V", line = 239)
