...
public class class379 extends class529 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IILea;II)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(FFFFFFLea;II)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lvh;B)V")
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Lht;IIII)V")
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Lht;II[III)V")
