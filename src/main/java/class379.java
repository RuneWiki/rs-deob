...
public class class379 extends class4 {
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(IIIIIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "([BBII)Ljava/lang/String;", line = 145)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Lco;I)V", line = 242)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(BLni;III)V", line = 265)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(II)Z", line = 429)
    ...
    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "(Lio;)V", line = 445)
