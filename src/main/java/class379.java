...
public class class379 implements class81 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Z)V", line = 47)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(II)V", line = 62)
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(Llga;Lgca;)V", line = 77)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(B)Z", line = 86)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IIIIB)V", line = 113)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(III)I", line = 129)
