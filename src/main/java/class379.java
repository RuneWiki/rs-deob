...
public class class379 implements class401 {
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(III)Z", line = 7)
    ...
    @OriginalMember(owner = "client!ov", name = "b", descriptor = "(B)I", line = 43)
    public final int method2058(byte arg0) {
        return arg0 == -102 ? this.field4791 : 82;
    }

    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Ljaclib/memory/Source;IIB)Z", line = 54)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(I)Z", line = 71)
    ...
    @OriginalMember(owner = "client!ov", name = "<init>", descriptor = "(Lgaa;Z)V", line = 145)
    public class379(class302 arg0, boolean arg1) {
        this.field4793 = arg1;
        this.field4794 = arg0;
    }

    @OriginalMember(owner = "client!ov", name = "b", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(B)I", line = 115)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;", line = 125)
