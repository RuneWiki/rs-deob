...
public class class379 extends class400 {
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!md", name = "c", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!md", name = "e", descriptor = "()V", line = 17)
    public static void method2321() {
        field5768 = null;
    }

    @OriginalMember(owner = "client!md", name = "c", descriptor = "()I", line = 20)
    public final int method2322() {
        return field5768.method1891(6777, this.field5769);
    }

    @OriginalMember(owner = "client!md", name = "d", descriptor = "()V", line = 23)
    public final void method2323() {
        field5768.method1888((byte) 106, this.field5769);
    }

    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 26)
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(Lji;I)V", line = 28)
