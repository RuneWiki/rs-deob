...
public class class379 extends class435 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "([I[BLcg;B)Z", line = 21)
    ...
    @OriginalMember(owner = "client!vi", name = "c", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(BLwk;)I", line = 106)
    ...
    @OriginalMember(owner = "client!vi", name = "d", descriptor = "(I)V", line = 189)
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "()V", line = 199)
    public class379() {
    }

    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "([B)V", line = 201)
