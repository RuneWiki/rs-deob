...
public class class379 implements MouseListener, MouseMotionListener, FocusListener {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IIILmg;II)V")
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(ILbk;)V")
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Ljf;IZII)V")
