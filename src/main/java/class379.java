...
public class class379 extends class546 implements class128 {
    ...
    @OriginalMember(owner = "client!ku", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(II[BB)V", line = 13)
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Lbi;ILjaclib/memory/Buffer;IZ)V", line = 26)
    public class379(class483 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field4843 = arg1;
    }

    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Lbi;I[BIZ)V", line = 34)
    public class379(class483 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field4843 = arg1;
    }

    @OriginalMember(owner = "client!ku", name = "c", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Z)J", line = 57)
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(I)I", line = 68)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(II[I[I[B[[B[[BI)I", line = 79)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(I)I", line = 136)
