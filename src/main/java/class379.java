...
public class class379 extends class334 {
    ...
    @OriginalMember(owner = "client!tda", name = "<init>", descriptor = "()V", line = 4)
    public class379() {
        super(1, false);
    }

    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(II[III)V", line = 10)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(IZLol;)V", line = 50)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(ZI)[[I", line = 98)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(IZII)V", line = 180)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(IIII)V", line = 239)
