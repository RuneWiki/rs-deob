...
public class class379 extends class96 {
    ...
    @OriginalMember(owner = "client!kp", name = "e", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "()V", line = 232)
    public class379() {
        super(0, true);
    }

    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(II)[I", line = 39)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IILbt;)V", line = 155)
    ...
    @OriginalMember(owner = "client!kp", name = "e", descriptor = "(I)V", line = 207)
    ...
    @OriginalMember(owner = "client!kp", name = "f", descriptor = "(B)V", line = 221)
