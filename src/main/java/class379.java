...
public class class379 implements Runnable {
    ...
    @OriginalMember(owner = "client!ru", name = "b", descriptor = "(B)[Lrl;", line = 21)
    ...
    @OriginalMember(owner = "client!ru", name = "c", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(ILbh;)V", line = 51)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(I[BILcn;)Lbh;", line = 66)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(ILcn;B)Lbh;", line = 91)
    ...
    @OriginalMember(owner = "client!ru", name = "run", descriptor = "()V", line = 108)
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(Lgt;)V", line = 219)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Lcn;II)Lbh;", line = 155)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IIIII)Z", line = 190)
