...
public class class379 extends class172 {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(BLhia;)V", line = 3)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(III)I", line = 14)
    ...
    @OriginalMember(owner = "client!in", name = "b", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!in", name = "c", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ILgga;)V", line = 78)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ZII)I", line = 99)
