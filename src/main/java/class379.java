...
public class class379 extends InputStream {
    ...
    @OriginalMember(owner = "client!wm", name = "read", descriptor = "()I", line = 57)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IIZ)Z", line = 66)
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(I)V", line = 88)
