...
public class class379 extends class445 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "([I)Ljn;")
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Lr;II)Lpf;")
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Lr;)Z")
