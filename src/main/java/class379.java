...
public class class379 extends class225 {
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(III)I", line = 12)
    ...
    @OriginalMember(owner = "client!cm", name = "e", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lnj;B)V", line = 71)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lk;Llm;Llm;Z)V", line = 93)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(II)I", line = 121)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lnj;II)V", line = 136)
    ...
    @OriginalMember(owner = "client!cm", name = "f", descriptor = "(I)I", line = 209)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(Lnj;B)Ljava/lang/String;", line = 223)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IZIIIIIIIIZLnj;)V", line = 251)
    ...
    @OriginalMember(owner = "client!cm", name = "g", descriptor = "(I)V", line = 384)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IZI)I", line = 399)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "([IBLnj;)V", line = 422)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IB)Z", line = 459)
    ...
    @OriginalMember(owner = "client!cm", name = "h", descriptor = "(I)Ljava/lang/String;", line = 476)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IIIIZILjava/lang/String;)V", line = 504)
