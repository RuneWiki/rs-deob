...
public class class379 {
    ...
    @OriginalMember(owner = "client!rr", name = "<init>", descriptor = "(I)V", line = 14)
    public class379(int arg0) {
        this.field5440 = (byte) arg0;
    }

    @OriginalMember(owner = "client!rr", name = "b", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!rr", name = "c", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "([BIIIII)V", line = 66)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(Lofa;I)I", line = 97)
