...
public class class379 extends class356 {
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(BLe;Ljo;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ZIILe;Ljo;I)[F", line = 64)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(DZILe;ILjo;IZ)[I", line = 177)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Lnfa;[BBI)Luaa;", line = 316)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(B)V", line = 350)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(DZLjo;IBLe;I)[I", line = 381)
    ...
    @OriginalMember(owner = "client!nv", name = "<init>", descriptor = "()V", line = 518)
    public class379() {
    ...
    @OriginalMember(owner = "client!nv", name = "<init>", descriptor = "(Liaa;)V", line = 533)
