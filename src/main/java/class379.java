...
public class class379 extends class21 implements class337 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(IIB)Z", line = 22)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(IZI)Lof;", line = 37)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(ILza;)V", line = 51)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(I)I", line = 109)
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(Lpg;I[BI)V", line = 119)
    public class379(class333 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field5449 = arg1;
    }

    @OriginalMember(owner = "client!td", name = "b", descriptor = "(I)J", line = 127)
    ...
    @OriginalMember(owner = "client!td", name = "d", descriptor = "(I)V", line = 138)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(III[B)V", line = 166)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(BLdk;)V", line = 183)
    ...
    @OriginalMember(owner = "client!td", name = "c", descriptor = "(I)I", line = 196)
