...
public class class379 extends class254 {
    ...
    @OriginalMember(owner = "client!qw", name = "f", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!qw", name = "<init>", descriptor = "(Lpea;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(ILpq;)I")
    ...
    @OriginalMember(owner = "client!qw", name = "<init>", descriptor = "(Lpea;IIIIZ[IZ)V")
    ...
    @OriginalMember(owner = "client!qw", name = "<init>", descriptor = "(Lpea;IIIII)V")
    ...
    @OriginalMember(owner = "client!qw", name = "<init>", descriptor = "(Lpea;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!qw", name = "<init>", descriptor = "(Lpea;IIII)V")
