...
public class class379 {
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(IIII)I", line = 20)
    ...
    @OriginalMember(owner = "client!taa", name = "<init>", descriptor = "(ILjava/lang/String;ILjava/lang/String;J)V", line = 49)
