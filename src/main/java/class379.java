...
public class class379 extends class366 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Llf;BI)V")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(II)Lmq;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Llf;I)V")
