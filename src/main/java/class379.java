...
public class class379 {
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(BII)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Lfca;I)Lng;", line = 47)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(II)Lkh;", line = 83)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(IZ)V", line = 107)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!ws", name = "toString", descriptor = "()Ljava/lang/String;", line = 145)
    public final String toString() {
        field5162++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(BCI)C", line = 153)
