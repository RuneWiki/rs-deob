...
public class class379 extends class101 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(FIIFIIBFIF[F)V", line = 4)
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ZILgh;)V", line = 112)
    ...
    @OriginalMember(owner = "client!rc", name = "<init>", descriptor = "(I)V", line = 536)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(III)Z", line = 140)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ZIIII)V", line = 151)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IILjava/lang/String;II)V", line = 416)
