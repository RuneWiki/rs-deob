...
public class class379 implements Runnable {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IILrfa;)Lsa;")
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(I[BLrfa;Z)Lsa;")
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Lsa;I)V")
    ...
    @OriginalMember(owner = "client!oj", name = "b", descriptor = "(I)Lnr;")
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Lrfa;II)Lsa;")
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "(Lgh;)V")
