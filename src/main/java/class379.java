...
public class class379 {
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(BLe;)V", line = 19)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(BLjg;)V", line = 108)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IIIILe;I)Lid;", line = 136)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(I)V", line = 248)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IILjg;)V", line = 323)
    ...
    @OriginalMember(owner = "client!gj", name = "b", descriptor = "(I)V", line = 409)
