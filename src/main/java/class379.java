...
public class class379 {
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!dg", name = "finalize", descriptor = "()V", line = 21)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(II)I", line = 30)
    public static final int method2497(int arg0, int arg1) {
        return class479.field7078 == null ? 0 : class479.field7078[arg0][arg1] & 0xFFFF;
    }

    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Lbea;JI)V", line = 42)
