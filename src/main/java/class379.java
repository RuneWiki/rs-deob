...
public class class379 extends class111 implements class593 {
    ...
    @OriginalMember(owner = "client!dg", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 7)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(ILfw;)V", line = 19)
    public final void method798(int arg0, class52 arg1) {
        super.method798(arg0, arg1);
    }

    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Lkaa;Lfca;III[B)V", line = 26)
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(I)V", line = 98)
