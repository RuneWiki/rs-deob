...
public class class379 extends class47 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(ZILnl;ZLtq;I)[F")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(ZILtq;DIBLnl;)[I")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(ILnl;ILtq;IZZD)[I")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Lnl;ZLtq;)Z")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Lgf;I)V")
    ...
    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "(Lkk;)V")
