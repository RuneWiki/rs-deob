...
public class class379 {
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(Z)[Lic;", line = 23)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(I)V", line = 131)
