...
public class class260 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Los;Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ZILos;)V", line = 31)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(II)V", line = 386)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IIIII[FIFII)V", line = 398)
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(Los;Z)V", line = 452)
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(II)I", line = 468)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Lhaa;IIII)V", line = 484)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Loaa;BLos;)V", line = 535)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ILos;)V", line = 810)
