...
public class class260 extends class325 {
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "(IIIIIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!gt", name = "c", descriptor = "(I)Z", line = 26)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ILae;)Ljava/lang/String;", line = 36)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IIIII)V", line = 71)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IB)V", line = 108)
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(ZLvc;)V", line = 165)
    ...
    @OriginalMember(owner = "client!gt", name = "d", descriptor = "(B)V", line = 192)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ILvc;II)Z", line = 204)
    public final boolean method77(int arg0, class89 arg1, int arg2, int arg3) {
        ++field3720;
        return arg0 != 0;
    }

    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(I)V", line = 217)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Lvc;II)Ln;", line = 236)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Lvc;I)Lep;", line = 251)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ILvc;Ln;)V", line = 283)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Z)V", line = 327)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ZILvc;IILuq;I)V", line = 339)
    ...
    @OriginalMember(owner = "client!gt", name = "e", descriptor = "(B)I", line = 357)
    ...
    @OriginalMember(owner = "client!gt", name = "finalize", descriptor = "()V", line = 376)
