...
public class class260 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!ef", name = "b", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Le;Z)V", line = 51)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(B)V", line = 78)
