...
public abstract class class260 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(II)V", line = 31)
    ...
    @OriginalMember(owner = "client!qa", name = "c", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "(Lgn;)V", line = 281)
    public class260(class729 arg0) {
        this.field3829 = arg0;
        this.field3828 = this.method123(4377);
    }

    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "(ILgn;)V", line = 290)
