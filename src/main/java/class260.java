...
public class class260 {
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!jfa", name = "b", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(II)Leb;", line = 62)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Liaa;B)Llfa;", line = 93)
    ...
    @OriginalMember(owner = "client!jfa", name = "b", descriptor = "(II)V", line = 126)
    ...
    @OriginalMember(owner = "client!jfa", name = "<init>", descriptor = "(Ljda;ILjo;)V", line = 167)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!jfa", name = "c", descriptor = "(B)V", line = 153)
