...
public class class260 {
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(I)Lag;", line = 21)
    ...
    @OriginalMember(owner = "client!fr", name = "c", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lld;I)V", line = 51)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(B)Lag;", line = 65)
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "(Lld;)V", line = 90)
