...
public class class260 extends class38 {
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(BLaa;IILsca;Lpga;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!sda", name = "b", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(BI)[I", line = 62)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(II)[[I", line = 95)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(IILrg;)V", line = 142)
    ...
    @OriginalMember(owner = "client!sda", name = "<init>", descriptor = "()V", line = 156)
    public class260() {
        super(1, false);
    }
}
