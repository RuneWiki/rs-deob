...
public class class260 extends class446 {
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lod;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lod;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lod;IIII)V")
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lod;IIIIZ[IZ)V")
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lod;IIIII)V")
