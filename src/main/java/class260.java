...
public class class260 extends class7 implements class422 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(II[BIIILaq;IB)V")
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(Lag;Laq;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(Lag;Laq;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(Lag;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(Lag;Laq;Lui;II)V")
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IIILaq;ZI[FII)V")
