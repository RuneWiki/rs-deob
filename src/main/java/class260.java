...
public class class260 extends class183 {
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Ltq;I)V")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(BJIZLvm;)V")
    ...
    @OriginalMember(owner = "client!l", name = "<init>", descriptor = "(Lvm;Lmd;Ldp;J)V")
