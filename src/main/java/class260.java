...
public class class260 {
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!aia", name = "b", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(ILdc;)Lnia;", line = 29)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(Lwq;I)I", line = 118)
