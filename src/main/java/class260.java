...
public class class260 extends class210 implements class343 {
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(I[BBI)V", line = 14)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(Lofa;III)V", line = 26)
    ...
    @OriginalMember(owner = "client!dea", name = "d", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!dea", name = "<init>", descriptor = "(Llf;I[BIZ)V", line = 53)
    public class260(class250 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34963, arg2, arg3, arg4);
        this.field3851 = arg1;
    }

    @OriginalMember(owner = "client!dea", name = "b", descriptor = "(I)I", line = 61)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(B)J", line = 71)
    ...
    @OriginalMember(owner = "client!dea", name = "c", descriptor = "(I)V", line = 83)
