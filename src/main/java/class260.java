...
public class class260 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(ZLoia;)V")
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Lha;IBILkq;I)V")
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Loia;II)V")
