...
public abstract class class260 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(Z)V", line = 47)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(III)V", line = 101)
