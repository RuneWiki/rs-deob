...
public class class260 {
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(ILcea;B)V", line = 9)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!sda", name = "b", descriptor = "(B)Lrh;", line = 49)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(Lcea;Z)V", line = 75)
