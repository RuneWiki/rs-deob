...
public class class260 extends class336 implements class438 {
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(ILfp;)V")
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(IIIIIIIIIILbf;)V")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lfp;Z)V")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lfp;I)V")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lfp;Lje;ZIIII)V")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lfp;III)Z")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(ILfp;)Luq;")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lfp;II)Lbi;")
