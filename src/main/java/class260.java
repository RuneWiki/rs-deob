...
public class class260 extends class220 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "()V", line = 16)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Luba;IIIIIIIIIIIZZ)V", line = 25)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(JI)V", line = 46)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Loa;J)V", line = 442)
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "(Luba;IIIIIIIIIIIZZ)V", line = 636)
