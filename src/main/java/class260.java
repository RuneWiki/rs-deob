...
public class class260 extends class452 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(CIIIZLq;II)V")
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "([B[IIIIIIIIIIILq;II)V")
    ...
    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "(Lkd;Lgh;[Lvp;[I[I)V")
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "([B[I[IIIIIIIIIIILq;II)V")
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "([B[I[IIIIIII)V")
