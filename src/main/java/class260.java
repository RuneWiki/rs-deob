...
public class class260 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(I)Lab;", line = 11)
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "()V", line = 34)
    public class260() {
    }

    @OriginalMember(owner = "client!md", name = "a", descriptor = "(B)Lab;", line = 37)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(Lbj;)V", line = 88)
