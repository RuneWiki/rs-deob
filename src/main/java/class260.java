...
public class class260 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(III)Lie;", line = 16)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Z)V", line = 40)
