...
public class class260 extends class425 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(II[II)V", line = 19)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IIII)Z", line = 29)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "([IIIB)V", line = 46)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(BII)Z", line = 68)
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "(IIIIIIIII)V", line = 94)
