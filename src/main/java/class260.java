...
public class class260 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!a", name = "b", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(ILjs;)V", line = 54)
