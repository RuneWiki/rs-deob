...
public class class260 {
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!vca", name = "finalize", descriptor = "()V", line = 16)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(BII[B)Ljava/lang/String;", line = 25)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(Leh;IB)Ljava/lang/String;", line = 103)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(JJ)J", line = 135)
    public static long method1592(long arg0, long arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(IBIIIII)V", line = 145)
    ...
    @OriginalMember(owner = "client!vca", name = "<init>", descriptor = "(Lno;J[Lte;)V", line = 168)
