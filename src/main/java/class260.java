...
public class class260 implements Runnable {
    ...
    @OriginalMember(owner = "client!nj", name = "run", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IIIIIILjo;ZI[II[IIII)I", line = 62)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(I)V", line = 233)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(B)V", line = 260)
    ...
    @OriginalMember(owner = "client!nj", name = "b", descriptor = "(B)V", line = 270)
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 299)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "([BIBI)V", line = 314)
