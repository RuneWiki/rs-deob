...
public class class260 extends class739 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(II)[I", line = 5)
    ...
    @OriginalMember(owner = "client!pd", name = "d", descriptor = "(III)I", line = 39)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "()V", line = 52)
    public class260() {
        super(0, true);
    }
}
