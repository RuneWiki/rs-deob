...
public class class260 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IB)V", line = 6)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(ZI)Lio;", line = 20)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!ah", name = "c", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Llf;ILvh;)V", line = 100)
