...
public class class260 extends class168 {
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(Lgs;)V", line = 10)
    ...
    @OriginalMember(owner = "client!oba", name = "b", descriptor = "(I)Z", line = 84)
    ...
    @OriginalMember(owner = "client!oba", name = "c", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IIIIIIII)V", line = 106)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(III)Z", line = 276)
