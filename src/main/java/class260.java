...
public class class260 extends class508 {
    ...
    @OriginalMember(owner = "client!kr", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!kr", name = "d", descriptor = "(I)I", line = 75)
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(ZI)Z", line = 86)
    ...
    @OriginalMember(owner = "client!kr", name = "e", descriptor = "(I)Z", line = 98)
    ...
    @OriginalMember(owner = "client!kr", name = "d", descriptor = "(B)I", line = 110)
    ...
    @OriginalMember(owner = "client!kr", name = "f", descriptor = "(I)Z", line = 121)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(II)Z", line = 134)
    ...
    @OriginalMember(owner = "client!kr", name = "g", descriptor = "(I)Z", line = 148)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lnh;", line = 165)
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(II)V", line = 182)
