...
public class class260 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IZI)Z", line = 38)
