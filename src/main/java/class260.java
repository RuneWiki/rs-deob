...
public class class260 extends class45 {
    ...
    @OriginalMember(owner = "client!ah", name = "e", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ah", name = "f", descriptor = "(I)V", line = 213)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(ILqa;IIIIIZLc;IIILkf;II)Lc;", line = 226)
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "()V", line = 436)
    public class260() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ah", name = "c", descriptor = "(III)Z", line = 444)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(CI)Z", line = 455)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Z)V", line = 470)
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(II)[[I", line = 496)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lcu;II)V", line = 602)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(B[B)Ldj;", line = 666)
