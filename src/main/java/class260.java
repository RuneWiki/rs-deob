...
public class class260 {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(ILya;ZILla;II)V")
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(ILhp;)V")
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IILhp;)V")
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Luq;B)Ljava/lang/String;")
