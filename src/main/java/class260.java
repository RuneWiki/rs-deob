...
public abstract class class260 {
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(I)Z", line = 18)
    ...
    @OriginalMember(owner = "client!oaa", name = "b", descriptor = "(I)Z", line = 34)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(ILjava/lang/String;)I", line = 47)
    ...
    @OriginalMember(owner = "client!oaa", name = "c", descriptor = "(I)Z", line = 71)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(BI)V", line = 84)
    ...
    @OriginalMember(owner = "client!oaa", name = "b", descriptor = "(B)V", line = 103)
    public static void method1595(byte arg0) {
        int var1 = -6 / ((91 - arg0) / 35);
        field3537 = null;
    }

    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(ZLjava/awt/Canvas;Lfa;)Lr;", line = 119)
