...
public class class260 extends class56 {
    ...
    @OriginalMember(owner = "client!oba", name = "e", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(ILee;I)V", line = 15)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(II)[[I", line = 54)
    ...
    @OriginalMember(owner = "client!oba", name = "b", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 126)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 218)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IZ)[I", line = 252)
    ...
    @OriginalMember(owner = "client!oba", name = "h", descriptor = "(I)V", line = 304)
    ...
    @OriginalMember(owner = "client!oba", name = "<init>", descriptor = "()V", line = 323)
    public class260() {
        super(3, false);
    }
}
