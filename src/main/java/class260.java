...
public class class260 extends class222 {
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(III)V", line = 4)
    public final void method1268(int arg0, int arg1, int arg2) {
        int var4 = -90 % ((arg0 - -3) / 32);
        ++field3407;
    }

    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(BII)V", line = 22)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(III)V", line = 48)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(II)V", line = 59)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(ILha;)V", line = 71)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(BI)I", line = 121)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 132)
