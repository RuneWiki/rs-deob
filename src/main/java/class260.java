...
public class class260 {
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(III)V", line = 19)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "([BI)V", line = 55)
    ...
    @OriginalMember(owner = "client!l", name = "<init>", descriptor = "([BI)V", line = 228)
