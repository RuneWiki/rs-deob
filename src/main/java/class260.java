...
public class class260 {
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!mt", name = "finalize", descriptor = "()V", line = 20)
    ...
    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "(Lrl;JI)V", line = 35)
