...
public class class260 extends class198 {
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(ILlm;)V")
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Leba;)V")
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(ZLol;)V")
