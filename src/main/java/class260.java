...
public class class260 implements Runnable {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Ljava/awt/Canvas;IILfa;)Lr;", line = 4)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!ao", name = "run", descriptor = "()V", line = 51)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 185)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "([BBII)V", line = 129)
