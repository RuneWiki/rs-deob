...
public class class260 extends class299 implements class2 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "()[Lsba;")
    public final class581[] method1247() {
        return this.field3492;
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Loha;Lvu;II)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Loha;IZ)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Loha;Lvu;I)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "([ILoha;)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILoha;ZII)Z")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILoha;ZI)Z")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Loha;)V")
    ...
    @OriginalMember(owner = "client!i", name = "d", descriptor = "()[Lld;")
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;Lya;Lsu;IIII)V")
