...
public class class260 implements Runnable {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(I)Ltd;", line = 3)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(ZLjava/awt/Component;I)Luu;", line = 14)
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(I)Luu;", line = 29)
    public final class180 method1559(int arg0) {
        return arg0 <= 107 ? null : this.method1577(0, 5, null, (byte) 96, 0);
    }

    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(ILjava/awt/Component;BI)Luu;", line = 39)
    ...
    @OriginalMember(owner = "client!hf", name = "c", descriptor = "(I)Z", line = 51)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(BLjava/awt/Frame;)Luu;", line = 68)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(BLjava/awt/datatransfer/Transferable;)Luu;", line = 80)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IZ)Luu;", line = 94)
    public final class180 method1564(int arg0, boolean arg1) {
        return arg1 ? null : this.method1577(0, 3, null, (byte) 96, arg0);
    }

    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(B)Luu;", line = 107)
    public final class180 method1565(byte arg0) {
        return arg0 == -49 ? this.method1577(0, 18, null, (byte) 96, 0) : null;
    }

    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(BLjava/lang/Class;)Luu;", line = 117)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Ljava/lang/Object;IIII)Luu;", line = 127)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(BLjava/lang/String;)Luu;", line = 163)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(ILjava/lang/Class;)Luu;", line = 173)
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;I)V", line = 660)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(ILjava/lang/Class;Ljava/lang/String;)Luu;", line = 194)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;)Ljava/io/File;", line = 205)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IILjava/awt/Component;[IBLjava/awt/Point;)Luu;", line = 312)
    ...
    @OriginalMember(owner = "client!hf", name = "run", descriptor = "()V", line = 322)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Ljava/lang/Class;B[Ljava/lang/Class;Ljava/lang/String;)Luu;", line = 445)
    ...
    @OriginalMember(owner = "client!hf", name = "d", descriptor = "(I)V", line = 459)
    public final void method1574(int arg0) {
        field3951 = class344.method2111((byte) -82) + (long) arg0;
    }

    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Ljava/lang/String;B)Luu;", line = 467)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(ILjava/lang/String;)Luu;", line = 478)
    public final class180 method1576(int arg0, String arg1) {
        return arg0 == -1 ? this.method1577(0, 21, arg1, (byte) 96, 0) : null;
    }

    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IILjava/lang/Object;BI)Luu;", line = 488)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Ljava/lang/String;Z)[B", line = 518)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(ILjava/lang/Runnable;I)Luu;", line = 530)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Ljava/net/URL;I)Luu;", line = 543)
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(BLjava/lang/String;)Ljava/io/File;", line = 553)
    public final File method1581(byte arg0, String arg1) {
        return arg0 == 121 ? method1571(this.field3930, this.field3941, 16, arg1) : null;
    }

    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IIBII)Luu;", line = 568)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Ljava/lang/String;IB)Luu;", line = 582)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Z)V", line = 591)
