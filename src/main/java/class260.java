...
public class class260 extends Callback {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ZLjava/awt/Component;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!mm", name = "callback", descriptor = "(IIII)I", line = 51)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(III)V", line = 91)
