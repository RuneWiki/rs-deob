...
public class class187 extends class350 implements class395 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ILja;II)Z")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ZZLjo;IILjo;I)I")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Lmb;B)V")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(BILja;)Lrc;")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Lja;II)Lrc;")
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(Lja;Lfb;IIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Ljo;ZLjo;II)I")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ZLja;)V")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(BIZLja;)Lob;")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(BLja;)Lkh;")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Lja;I)V")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ILja;)V")
