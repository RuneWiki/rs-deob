...
public abstract class class187 {
    ...
    @OriginalMember(owner = "client!cka", name = "b", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!cka", name = "c", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(BI)V", line = 42)
    ...
    @OriginalMember(owner = "client!cka", name = "<init>", descriptor = "(Lhk;)V", line = 53)
    public class187(class111 arg0) {
        this.field2885 = arg0;
    }

    @OriginalMember(owner = "client!cka", name = "b", descriptor = "(Z)V", line = 76)
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 165)
