...
public class class187 extends class8 {
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(Lti;B)V")
    ...
    @OriginalMember(owner = "client!uu", name = "b", descriptor = "(I)Lti;")
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(BLci;)V")
    ...
    @OriginalMember(owner = "client!uu", name = "<init>", descriptor = "(Lci;)V")
