...
public class class187 extends class338 {
    ...
    @OriginalMember(owner = "client!tm", name = "d", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ZI)V", line = 124)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(B)V", line = 159)
    ...
    @OriginalMember(owner = "client!tm", name = "e", descriptor = "(I)Z", line = 183)
