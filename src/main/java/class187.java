...
public class class187 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(BLjava/lang/String;)J", line = 19)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIZIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!vr", name = "toString", descriptor = "()Ljava/lang/String;", line = 68)
    public final String toString() {
        field2757++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 88)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;I)V", line = 107)
    ...
    @OriginalMember(owner = "client!vr", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 158)
