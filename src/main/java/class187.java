...
public class class187 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IIIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!ml", name = "b", descriptor = "(I)V", line = 116)
