...
public class class187 {
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(B)Lok;", line = 38)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(II)V", line = 54)
