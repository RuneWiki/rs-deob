...
public class class187 extends class450 {
    ...
    @OriginalMember(owner = "client!ffa", name = "<init>", descriptor = "(ILup;)V")
    public class187(int arg0, class278 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(I[BLlaa;B)Low;")
    ...
    @OriginalMember(owner = "client!ffa", name = "<init>", descriptor = "(Lup;)V")
