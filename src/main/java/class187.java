...
public class class187 {
    ...
    @OriginalMember(owner = "client!nt", name = "finalize", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!nt", name = "<init>", descriptor = "(Lmh;JI)V", line = 65)
