...
public class class187 extends class366 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(ILlf;)V")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(IBLlf;)V")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(ZLmb;)Z")
