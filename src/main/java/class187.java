...
public class class187 implements class555 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Z)I", line = 5)
    public final int method21(boolean arg0) {
        return arg0 ? -11 : this.field2769;
    }

    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IBILjaclib/memory/Source;)Z", line = 15)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(B)I", line = 31)
    public final int method1248(byte arg0) {
        int var2 = 32 % ((arg0 + 57) / 38);
        return this.field2771;
    }

    @OriginalMember(owner = "client!sa", name = "b", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;", line = 58)
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(Lvg;Z)V", line = 146)
    public class187(class49 arg0, boolean arg1) {
        this.field2773 = arg0;
        this.field2772 = arg1;
    }

    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(I)Z", line = 87)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IIB)Z", line = 114)
