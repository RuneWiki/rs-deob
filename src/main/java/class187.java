...
public class class187 extends class197 {
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(Lkga;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(Lkga;IIZ[[BI)V", line = 41)
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(Lkga;IIZ[[I)V", line = 76)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IIIII)V", line = 61)
    ...
    @OriginalMember(owner = "client!sa", name = "f", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(BII)Z", line = 121)
