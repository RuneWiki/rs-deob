...
public class class187 extends class179 {
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lih;IIII)V")
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lih;IIIII)V")
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lih;IIIIZ[IZ)V")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(BLnv;ILjava/awt/Canvas;Ll;)Lza;")
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lih;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(BLap;)V")
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lih;IIIIZ[FI)V")
