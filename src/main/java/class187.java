...
public class class187 extends class535 implements class141 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lha;IZI)Z")
    ...
    @OriginalMember(owner = "client!vp", name = "c", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(JIILeq;BZI)V")
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "(Lha;Luw;IIIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(BLha;)Lvw;")
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lha;Z)Ltb;")
