...
public class class187 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(BI)V", line = 29)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(BIIZ[[[Ljd;I)Z", line = 58)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(II)V", line = 383)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(ZILjava/lang/String;)V", line = 428)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(B)V", line = 521)
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(BI)V", line = 537)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(IIIIIZILuo;Luo;ZLnj;Lai;)Lsg;", line = 556)
