...
public class class187 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(I)Lmg;", line = 5)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IIB)V", line = 51)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(II)Ljava/lang/String;", line = 70)
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "()V", line = 95)
    public class187() {
    }

    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Ltca;)V", line = 110)
    public class187(class184 arg0) {
        this.field2454 = arg0;
    }

    @OriginalMember(owner = "client!gg", name = "b", descriptor = "(I)Lmg;", line = 99)
