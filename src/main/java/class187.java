...
public class class187 extends class405 {
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(Ljava/lang/String;ZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!na", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(IBIIIFZII)[[I", line = 50)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(BC)B", line = 81)
    ...
    @OriginalMember(owner = "client!na", name = "<init>", descriptor = "(II[I[I)V", line = 205)
