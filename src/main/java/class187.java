...
public class class187 extends class71 {
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(Luu;II)Lkba;")
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(Luu;I)Lkba;")
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(Luu;)Z")
    ...
    @OriginalMember(owner = "client!kba", name = "<init>", descriptor = "([B)V")
    private class187(byte[] arg0) {
        this.method1172(arg0);
    }

    @OriginalMember(owner = "client!kba", name = "a", descriptor = "([I)Lwo;")
