...
public class class187 extends class349 {
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(BI)[I", line = 3)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Ljava/awt/Canvas;Le;I)Loa;", line = 71)
    public static final class689 method1197(Canvas arg0, class479 arg1, int arg2) {
        ++field2287;
        return arg2 != 4092 ? null : new class682(arg0, arg1);
    }

    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IZIIZ)I", line = 82)
    ...
    @OriginalMember(owner = "client!ol", name = "d", descriptor = "(B)V", line = 120)
    public static void method1199(byte arg0) {
        field2290 = null;
        int var1 = -71 / ((arg0 - 8) / 41);
    }

    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IILdga;)V", line = 132)
    ...
    @OriginalMember(owner = "client!ol", name = "<init>", descriptor = "()V", line = 196)
    public class187() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ol", name = "c", descriptor = "(B)V", line = 184)
