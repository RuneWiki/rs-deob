...
public class class187 implements class162 {
    ...
    @OriginalMember(owner = "client!cka", name = "b", descriptor = "(II)Lgd;")
    ...
    @OriginalMember(owner = "client!cka", name = "a", descriptor = "(IB)Lmea;")
    ...
    @OriginalMember(owner = "client!cka", name = "<init>", descriptor = "(Lbt;Lbt;Lbt;)V")
