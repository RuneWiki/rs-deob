...
public class class187 extends class15 implements class416 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "()Ln;", line = 4)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(III[I)V", line = 33)
    public final void method43(int arg0, int arg1, int arg2, int[] arg3) {
        this.method1285(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "()V", line = 36)
    public class187() {
        this.method1286();
    }
