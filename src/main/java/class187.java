...
public class class187 extends class260 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ILha;ZILor;I)V")
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(ILfca;)V")
    public class187(int arg0, class92 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Lfca;)V")
    public class187(class92 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!gg", name = "b", descriptor = "(IB)V")
