...
public class class187 extends class264 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lbg;I[[B)V")
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(ILmfa;)V")
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(Lmfa;)V")
