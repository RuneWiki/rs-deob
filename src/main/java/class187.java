...
public class class187 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IB)Lhr;", line = 14)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IIZIBIIF)[I", line = 48)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "([Ljava/lang/String;B)V", line = 84)
