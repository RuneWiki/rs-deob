...
public class class187 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Loq;B)Z")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ILoq;)V")
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(Lvj;)V")
