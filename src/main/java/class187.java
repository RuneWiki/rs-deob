...
public class class187 implements Runnable {
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(Lu;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!tw", name = "run", descriptor = "()V", line = 34)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(BLjava/lang/String;)Lji;", line = 73)
    ...
    @OriginalMember(owner = "client!tw", name = "<init>", descriptor = "()V", line = 95)
    public class187() {
        this.field3123.setDaemon(true);
        this.field3123.start();
    }

    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(Z)I", line = 110)
    ...
    @OriginalMember(owner = "client!tw", name = "b", descriptor = "(I)V", line = 131)
