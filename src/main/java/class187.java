...
public class class187 {
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(I[[[BIBII)V", line = 3)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(B)V", line = 137)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(BI)[B", line = 152)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(IZIIZI)V", line = 208)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(II)V", line = 261)
