...
public abstract class class187 extends class95 {
    ...
    @OriginalMember(owner = "client!uc", name = "Sb", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!uc", name = "fc", descriptor = "Z")
    public boolean field3601 = false;

    @OriginalMember(owner = "client!uc", name = "Zb", descriptor = "I")
    public int field3595 = 0;

    @OriginalMember(owner = "client!uc", name = "Xb", descriptor = "[Z")
    ...
    @OriginalMember(owner = "client!uc", name = "mc", descriptor = "Llf;")
    private static class109 field3608 = class35.method275("Loaded fonts", 2);

    @OriginalMember(owner = "client!uc", name = "Qb", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(ZIZI)V")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IZLbg;Lbg;I)Ltd;")
