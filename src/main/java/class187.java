...
public class class187 extends class644 {
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(ILsl;I)V")
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "([IILsl;)V")
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(Lsl;I)V")
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(ZLsl;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(II)Lfia;")
