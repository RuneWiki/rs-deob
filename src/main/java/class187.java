...
public class class187 extends class151 {
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(J)V", line = 19)
    ...
    @OriginalMember(owner = "client!uu", name = "b", descriptor = "()V", line = 148)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(Lms;IIIIIIIIIIIZZ)V", line = 158)
    ...
    @OriginalMember(owner = "client!uu", name = "b", descriptor = "(JI)V", line = 177)
    ...
    @OriginalMember(owner = "client!uu", name = "<init>", descriptor = "(Lms;IIIIIIIIIIIZZ)V", line = 571)
