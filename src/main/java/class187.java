...
public class class187 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!sa", name = "b", descriptor = "(I)Z", line = 18)
    ...
    @OriginalMember(owner = "client!sa", name = "c", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(B)V", line = 133)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Lrga;Z)V", line = 253)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IZLwo;ILwo;)Luaa;", line = 287)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IILwo;Lwo;)Luaa;", line = 333)
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(Laga;Ln;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", line = 351)
