...
public class class187 extends class232 {
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(II)[[I", line = 10)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "()V", line = 75)
    public class187() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 83)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(B)I", line = 111)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(ILwq;I)V", line = 128)
    ...
    @OriginalMember(owner = "client!ei", name = "d", descriptor = "(I)V", line = 175)
