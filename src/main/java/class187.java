...
public class class187 extends class460 {
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(ILjava/lang/String;)[B", line = 40)
    ...
    @OriginalMember(owner = "client!uu", name = "b", descriptor = "(Z)Lid;", line = 178)
    ...
    @OriginalMember(owner = "client!uu", name = "c", descriptor = "(I)V", line = 194)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(B)V", line = 354)
