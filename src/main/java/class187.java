...
public abstract class class187 extends class13 {
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 18)
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(IIILqfa;Lqfa;)V", line = 45)
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(I[BIZLjava/lang/String;I)I", line = 102)
    ...
    @OriginalMember(owner = "client!ffa", name = "d", descriptor = "(I)I", line = 239)
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(II[F)[F", line = 266)
