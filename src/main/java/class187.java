...
public class class187 extends class371 {
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 4)
    public class187(Object arg0, int arg1) {
        super(arg1);
        this.field2427 = new SoftReference(arg0);
    }

    @OriginalMember(owner = "client!kd", name = "d", descriptor = "(I)Ljava/lang/Object;", line = 13)
    ...
    @OriginalMember(owner = "client!kd", name = "e", descriptor = "(I)Z", line = 24)
