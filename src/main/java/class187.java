...
public abstract class class187 {
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Ljava/lang/String;B)Ljava/lang/String;", line = 28)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(B)V", line = 46)
