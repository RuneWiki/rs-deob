...
public class class187 extends class33 implements class438 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Ljava/lang/Throwable;I)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!ut", name = "c", descriptor = "(I)I", line = 75)
    ...
    @OriginalMember(owner = "client!ut", name = "b", descriptor = "(Lqa;B)V", line = 93)
    ...
    @OriginalMember(owner = "client!ut", name = "b", descriptor = "(B)V", line = 122)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(IILqa;Z)Lrp;", line = 137)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(ILqa;IB)Z", line = 167)
    ...
    @OriginalMember(owner = "client!ut", name = "b", descriptor = "(I)I", line = 188)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(ILqa;)Llb;", line = 199)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Z)I", line = 225)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(BLqa;)Led;", line = 237)
    ...
    @OriginalMember(owner = "client!ut", name = "b", descriptor = "(Z)Z", line = 260)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Lqa;IB)Lr;", line = 271)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(B)V", line = 293)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(BILqa;)Lr;", line = 308)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Lqa;Z)V", line = 319)
    ...
    @OriginalMember(owner = "client!ut", name = "<init>", descriptor = "(Lqa;Lih;IIIIZIZ)V", line = 329)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(ILqa;IIZLse;I)V", line = 365)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(I)Z", line = 385)
    public final boolean method162(int arg0) {
        ++field2834;
        return arg0 != -177 ? true : this.field2845;
    }

    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Lqa;B)V", line = 412)
