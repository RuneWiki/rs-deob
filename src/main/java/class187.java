...
public class class187 {
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(Z)Z", line = 7)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(BCI)C", line = 29)
    ...
    @OriginalMember(owner = "client!aba", name = "b", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!aba", name = "<init>", descriptor = "(Z)V", line = 131)
