...
public class class187 extends class117 {
    ...
    @OriginalMember(owner = "client!bd", name = "e", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(III)V", line = 26)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IBIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(ZII)Z", line = 57)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IIIIIBI)V", line = 69)
    ...
    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(B)V", line = 516)
    ...
    @OriginalMember(owner = "client!bd", name = "<init>", descriptor = "(Lag;II)V", line = 549)
