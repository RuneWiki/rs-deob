...
public class class187 extends class55 {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ILvd;IZII)V", line = 3)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "([BIIIIZII[B)V", line = 19)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ILha;II)Z", line = 77)
