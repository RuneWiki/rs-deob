...
public class class187 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ZLql;)Z", line = 13)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(BLnga;)Lwp;", line = 29)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Ldfa;I)V", line = 97)
