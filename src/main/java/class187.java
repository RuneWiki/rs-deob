...
public class class187 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "([III)V", line = 51)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Laa;[IIII[I[I)V", line = 103)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "()V", line = 143)
    private static final void method1225() {
        field2600 = 0;
    }

    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(I)Z", line = 147)
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(II)V", line = 224)
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "()V", line = 261)
    public static void method1228() {
        field2606 = null;
    }

    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Laa;[II[I[I)V", line = 266)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Laa;[II)V", line = 269)
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(I)V", line = 274)
