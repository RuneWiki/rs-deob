...
public class class187 {
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(IILha;IIII)V", line = 12)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(BIIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(IIZ)V", line = 41)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(FI[FIIIIIII[F)V", line = 117)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(III)V", line = 379)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(IIBII)Z", line = 405)
    ...
    @OriginalMember(owner = "client!lia", name = "<init>", descriptor = "()V", line = 435)
    protected class187() {
    ...
    @OriginalMember(owner = "client!lia", name = "<init>", descriptor = "(Lha;Lsl;I)V", line = 445)
