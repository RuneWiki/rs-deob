...
public class class187 extends class91 {
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "()V", line = 3)
    private final void method1341() {
        this.field2821 = false;
    }

    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(Lha;[Lpi;Z)V", line = 12)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(J)V", line = 88)
    public final void method1343(long arg0) {
        this.field2819 = arg0;
    }

    @OriginalMember(owner = "client!eea", name = "b", descriptor = "()V", line = 91)
    public final void method1344() {
        this.field2821 = true;
    }

    @OriginalMember(owner = "client!eea", name = "c", descriptor = "()V", line = 94)
    ...
    @OriginalMember(owner = "client!eea", name = "d", descriptor = "()Lgka;", line = 133)
    public final class667 method1346() {
        return this.field2827;
    }

    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(Lha;J[Lpi;[Lgfa;Z)V", line = 137)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(Lha;)V", line = 145)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(IZ)Leea;", line = 157)
    ...
    @OriginalMember(owner = "client!eea", name = "e", descriptor = "()Lgka;", line = 170)
    ...
    @OriginalMember(owner = "client!eea", name = "f", descriptor = "()V", line = 185)
    public static void method1351() {
        field2817 = null;
        field2815 = null;
    }

    @OriginalMember(owner = "client!eea", name = "g", descriptor = "()V", line = 189)
    public final void method1352() {
        this.field2828 = true;
    }

    @OriginalMember(owner = "client!eea", name = "<init>", descriptor = "(IZ)V", line = 394)
    private class187(int arg0, boolean arg1) {
        this.method1354(arg0, arg1);
    }

    @OriginalMember(owner = "client!eea", name = "a", descriptor = "([Lgfa;Z)V", line = 198)
    ...
    @OriginalMember(owner = "client!eea", name = "b", descriptor = "(IZ)V", line = 289)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(IIIII)V", line = 296)
    public final void method1355(int arg0, int arg1, int arg2, int arg3, int arg4) {
        this.field2825 = arg0;
    }

    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(Lha;J)Z", line = 311)
