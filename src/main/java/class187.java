...
public class class187 {
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(FFIF)I", line = 31)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(II)Z", line = 79)
