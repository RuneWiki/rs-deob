...
public class class187 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Z)Lkd;", line = 7)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lnn;B)V", line = 22)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(I)V", line = 953)
    public class187(int arg0) {
        this.field2995 = arg0;
    }

    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(IIIIII)V", line = 994)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(III)V", line = 961)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ILkd;)V", line = 975)
