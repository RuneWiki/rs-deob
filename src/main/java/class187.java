...
public class class187 extends class325 {
    ...
    @OriginalMember(owner = "client!mu", name = "f", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!mu", name = "e", descriptor = "(I)Z", line = 16)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;II)V", line = 27)
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(II)Lph;", line = 68)
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Lqa;Ljava/lang/Object;I)V", line = 96)
    public class187(class155 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field2649 = arg1;
    }

    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 105)
