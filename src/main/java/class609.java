...
public class class609 extends class412 {
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(IIB)Z", line = 5)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(IIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!lea", name = "b", descriptor = "(Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!lea", name = "<init>", descriptor = "(Leq;Leq;Lhl;)V", line = 42)
