...
public class class609 extends class418 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIZ)Z", line = 4)
    ...
    @OriginalMember(owner = "client!pf", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 15)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field8511;
        return this.field8499 == arg0;
    }

    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIBII)V", line = 23)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 39)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ILjava/awt/Graphics;IIIIII)V", line = 121)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ILjava/awt/Canvas;II)V", line = 161)
    ...
    @OriginalMember(owner = "client!pf", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 196)
    ...
    @OriginalMember(owner = "client!pf", name = "c", descriptor = "(B)V", line = 208)
    ...
    @OriginalMember(owner = "client!pf", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 231)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field8498;
    }

    @OriginalMember(owner = "client!pf", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 238)
    public final void startProduction(ImageConsumer arg0) {
        this.addConsumer(arg0);
        ++field8497;
    }

    @OriginalMember(owner = "client!pf", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 246)
