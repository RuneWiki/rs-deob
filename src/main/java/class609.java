...
public class class609 {
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(I)[Luv;")
    ...
    @OriginalMember(owner = "client!iha", name = "b", descriptor = "(I)Lul;")
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(BLbia;)Lko;")
    ...
    @OriginalMember(owner = "client!iha", name = "<init>", descriptor = "(Lla;Lla;)V")
