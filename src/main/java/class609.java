...
public class class609 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(B)Lww;", line = 31)
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "()V", line = 51)
    public class609() {
    }

    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(I)Lww;", line = 55)
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(Ldm;)V", line = 76)
