...
public class class609 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ZII)I", line = 5)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "([BIZ)Ljava/lang/Object;", line = 34)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Z)I", line = 65)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ZLica;Z)V", line = 107)
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 277)
