...
public class class609 extends OutputStream {
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(IIIIFZIIFI[F)V", line = 9)
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!aga", name = "write", descriptor = "(I)V", line = 80)
