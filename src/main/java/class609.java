...
public class class609 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Les;Luf;)V", line = 5)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IF)I", line = 70)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(F)F", line = 133)
    private static final float method3456(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIF)F", line = 144)
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(IIF)F", line = 151)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "()V", line = 171)
