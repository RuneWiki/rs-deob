...
public class class609 {
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Ler;)V", line = 134)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(JB)V", line = 10)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(II)Z", line = 117)
