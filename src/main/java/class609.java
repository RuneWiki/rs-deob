...
public class class609 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(II)Lrg;", line = 21)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(I[ILed;J)Ljava/lang/String;", line = 54)
    ...
    @OriginalMember(owner = "client!pm", name = "<init>", descriptor = "(ILuq;Luq;Lhj;)V", line = 104)
