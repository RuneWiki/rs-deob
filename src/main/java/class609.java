...
public class class609 implements class169 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IIIIILr;I)Lda;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(I)Lkq;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lll;Lis;Lua;Lla;IILjava/lang/String;IIIII)V")
    ...
    @OriginalMember(owner = "client!a", name = "<init>", descriptor = "(ILvn;Lmf;II)V")
