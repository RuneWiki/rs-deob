...
public class class609 extends class437 {
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "(Ljava/awt/Canvas;Le;)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Ldi;IIII)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "([Lba;Lc;Lq;[Lot;I)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Ljava/lang/Runnable;)Leo;")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lpf;IIII)Lba;")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "([Lba;Lq;[Lot;I)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lxa;Z)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(II[[I[[IIII)Ld;")
