...
public class class609 extends class474 implements class249 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(BIZ)Lda;", line = 7)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;Lpba;I)V", line = 11)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lda;IIIZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IILq;Z)Z", line = 34)
    ...
    @OriginalMember(owner = "client!v", name = "f", descriptor = "()[Lqg;", line = 37)
    public final class214[] method706() {
        return this.field8549;
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;)V", line = 40)
    ...
    @OriginalMember(owner = "client!v", name = "b", descriptor = "()Z", line = 102)
    public final boolean method736() {
        return true;
    }

    @OriginalMember(owner = "client!v", name = "e", descriptor = "()V", line = 105)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IIII)V", line = 122)
    public final void method755(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "()V", line = 125)
    public final void method726() {
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "([ILq;)V", line = 135)
    private final void method3329(int[] arg0, class491 arg1) {
        this.field8550.method986().method1104(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IILq;ZI)Z", line = 138)
    public final boolean method738(int arg0, int arg1, class491 arg2, boolean arg3, int arg4) {
        return this.field8550.method986().method1106(this, arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!v", name = "finalize", descriptor = "()V", line = 142)
    ...
    @OriginalMember(owner = "client!v", name = "c", descriptor = "()[Lhi;", line = 153)
    public final class64[] method728() {
        return this.field8551;
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(I[IIIIIZ)V", line = 157)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;Lpba;II)V", line = 164)
    ...
    @OriginalMember(owner = "client!v", name = "d", descriptor = "()V", line = 183)
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(Ll;Lm;Leg;IIII)V", line = 197)
