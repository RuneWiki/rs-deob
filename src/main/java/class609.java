...
public class class609 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(I[S)[S", line = 6)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(I)Ldfa;", line = 78)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IB)I", line = 91)
    ...
    @OriginalMember(owner = "client!pe", name = "b", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "([BI)[B", line = 118)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "([IZ)Ljava/lang/String;", line = 189)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Lks;)V", line = 246)
    public static final void method3466(class440 arg0) {
        class545.field7511 = arg0;
    }

    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(II)I", line = 249)
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(II)V", line = 266)
    ...
    @OriginalMember(owner = "client!pe", name = "c", descriptor = "(I)V", line = 325)
