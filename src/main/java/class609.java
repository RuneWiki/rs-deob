...
public class class609 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Let;Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!pl", name = "b", descriptor = "(I)I", line = 64)
    ...
    @OriginalMember(owner = "client!pl", name = "c", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(IIII)Z", line = 91)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(II)V", line = 228)
