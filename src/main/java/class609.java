...
public class class609 {
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(BLol;)V")
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Ljava/lang/String;Lha;BLrt;Lda;Z)V")
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(BLhl;Lol;)Lwm;")
