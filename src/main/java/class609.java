...
public class class609 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(BLwq;)Lnt;", line = 9)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Lgda;B)V", line = 61)
