...
public class class609 extends class145 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(I[J[Ljava/lang/Object;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(ZI)[I", line = 60)
    ...
    @OriginalMember(owner = "client!gn", name = "i", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "()V", line = 99)
    public class609() {
        super(0, true);
    }
}
