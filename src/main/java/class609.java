...
public class class609 extends class237 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IIIBI)V", line = 4)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(ILha;ILwq;I)V", line = 62)
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(I)V", line = 376)
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(Z)V", line = 394)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(II)V", line = 418)
    ...
    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "(IIIIIF)V", line = 429)
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(III)V", line = 446)
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(B)V", line = 460)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(ZBI)V", line = 472)
    ...
    @OriginalMember(owner = "client!id", name = "c", descriptor = "(I)V", line = 484)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(III)V", line = 511)
