...
public class class609 extends class747 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "([[IIIIIILjava/util/Random;)V", line = 5)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Lob;Lob;Z)V", line = 203)
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "()V", line = 617)
    public class609() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(II)[I", line = 228)
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(I)V", line = 482)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Ldc;II)V", line = 495)
