...
public class class609 extends class601 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Lee;BI)V", line = 14)
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "()V", line = 58)
    public class609() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IIIIIII)V", line = 65)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(B)V", line = 93)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(BI)[I", line = 103)
    ...
    @OriginalMember(owner = "client!pe", name = "e", descriptor = "(I)I", line = 171)
    ...
    @OriginalMember(owner = "client!pe", name = "f", descriptor = "(I)V", line = 193)
