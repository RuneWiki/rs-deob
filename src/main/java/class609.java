...
public class class609 extends class108 {
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(IIIB)I", line = 7)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(Z)V", line = 28)
    ...
    @OriginalMember(owner = "client!qca", name = "c", descriptor = "(Z)V", line = 61)
    ...
    @OriginalMember(owner = "client!qca", name = "<init>", descriptor = "()V", line = 107)
    public class609() {
    }

    @OriginalMember(owner = "client!qca", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 110)
