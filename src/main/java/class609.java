...
public class class609 {
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(I)V", line = 37)
    public static void method3378(int arg0) {
        int var1 = 108 / ((-arg0 - 68) / 35);
        field8466 = null;
    }

    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IIIIIZ)V", line = 47)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Ljd;Z)V", line = 66)
