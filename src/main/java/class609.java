...
public class class609 extends class65 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lqaa;Lqaa;FLqaa;)Lqaa;")
    public final class29 method470(class29 arg0, class29 arg1, float arg2, class29 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!pm", name = "A", descriptor = "()Lcq;")
    public final class491 method553() {
        return new class491(0, "Pure Java", 1, "CPU", 0L);
    }

    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lon;IIII)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lkd;I)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lqja;)V")
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(II)Lkfa;")
    ...
    @OriginalMember(owner = "client!pm", name = "d", descriptor = "(IIIIII)Lqaa;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(I[Lqm;)V")
    public final void method461(int arg0, class154[] arg1) {
    }

    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Ljava/lang/Runnable;)Ldv;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lkfa;Lts;)Lpt;")
    public final class555 method443(class627 arg0, class560 arg1) {
        return new class227(this, (class241) arg0, (class515) arg1);
    }

    @OriginalMember(owner = "client!pm", name = "<init>", descriptor = "(Ld;)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Ldba;IIII)Lka;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lie;[Lus;Z)Lda;")
    ...
    @OriginalMember(owner = "client!pm", name = "d", descriptor = "(II)Lts;")
    ...
    @OriginalMember(owner = "client!pm", name = "u", descriptor = "()Lqja;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIIIZ)Ljd;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "([IIIIIZ)Ljd;")
    ...
    @OriginalMember(owner = "client!pm", name = "s", descriptor = "()Lqja;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lus;Z)Ljd;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lkd;)V")
    ...
    @OriginalMember(owner = "client!pm", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ld;II)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(II[I[I)Laa;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lpt;)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIZ)Ljd;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(II[[I[[IIII)Ls;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIIIIILaa;IIIII)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(I)Lza;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lqaa;)V")
    ...
    @OriginalMember(owner = "client!pm", name = "A", descriptor = "(ILaa;II)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIIIIF)Lqm;")
    ...
    @OriginalMember(owner = "client!pm", name = "c", descriptor = "()Lqja;")
