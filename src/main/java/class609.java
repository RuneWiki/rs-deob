...
public class class609 {
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(IIILjava/lang/Class;)Lhc;")
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(I)Lct;")
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(Lgca;I)Lmv;")
    ...
    @OriginalMember(owner = "client!fda", name = "<init>", descriptor = "(Lpq;)V")
