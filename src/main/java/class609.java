...
public class class609 extends class601 {
    ...
    @OriginalMember(owner = "client!hg", name = "d", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lmc;II)V", line = 16)
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "()V", line = 42)
    public class609() {
        this(4096);
    }

    @OriginalMember(owner = "client!hg", name = "e", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IB)[I", line = 70)
