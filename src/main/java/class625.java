...
public class class625 extends class118 {
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "(Los;)V")
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Lbaa;IB)V")
