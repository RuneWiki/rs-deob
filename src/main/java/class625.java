...
public class class625 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(BII)I", line = 3)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(ILnp;)Lqt;", line = 26)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IIIII)V", line = 87)
