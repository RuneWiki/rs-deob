...
public class class625 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(ILjava/lang/String;IZ)V", line = 9)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(B)Ldm;", line = 49)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(III)Z", line = 69)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IB)V", line = 83)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Llaa;Z)V", line = 122)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(I)V", line = 168)
