...
public class class625 extends class529 {
    ...
    @OriginalMember(owner = "client!oh", name = "e", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(IIII)I", line = 15)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(IBLtn;)V", line = 47)
    ...
    @OriginalMember(owner = "client!oh", name = "b", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "([I[IILbm;IB)Ljj;", line = 75)
    ...
    @OriginalMember(owner = "client!oh", name = "e", descriptor = "(B)V", line = 136)
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "()V", line = 223)
    public class625() {
        super(0, false);
    }

    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(II)[[I", line = 155)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(IZI)I", line = 228)
    ...
    @OriginalMember(owner = "client!oh", name = "f", descriptor = "(I)Z", line = 244)
    ...
    @OriginalMember(owner = "client!oh", name = "g", descriptor = "(I)Z", line = 277)
