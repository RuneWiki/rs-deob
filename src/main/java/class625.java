...
public class class625 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IIILjga;)V", line = 32)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(B)V", line = 877)
    ...
    @OriginalMember(owner = "client!gl", name = "finalize", descriptor = "()V", line = 986)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(Lko;J[Lec;)V", line = 1002)
