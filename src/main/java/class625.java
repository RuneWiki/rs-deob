...
public class class625 extends class642 {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(IIIII)I", line = 4)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(ILgk;B)V", line = 16)
    ...
    @OriginalMember(owner = "client!hu", name = "b", descriptor = "(II)[I", line = 64)
    ...
    @OriginalMember(owner = "client!hu", name = "e", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!hu", name = "<init>", descriptor = "()V", line = 152)
    public class625() {
        super(1, true);
    }

    @OriginalMember(owner = "client!hu", name = "b", descriptor = "(B)V", line = 168)
    ...
    @OriginalMember(owner = "client!hu", name = "f", descriptor = "(I)V", line = 207)
