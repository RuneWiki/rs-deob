...
public class class625 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Laq;B)V", line = 30)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(I)I", line = 55)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IIIIZ)Z", line = 70)
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(B)Z", line = 121)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Z)V", line = 252)
    ...
    @OriginalMember(owner = "client!hn", name = "c", descriptor = "(B)V", line = 316)
    ...
    @OriginalMember(owner = "client!hn", name = "<init>", descriptor = "(Lad;)V", line = 552)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(BJ)V", line = 430)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(ILaq;)Z", line = 447)
    ...
    @OriginalMember(owner = "client!hn", name = "c", descriptor = "(I)Z", line = 491)
