...
public class class625 extends class573 implements class457 {
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(IIILha;IBILjava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(BILha;I)Z")
    ...
    @OriginalMember(owner = "client!paa", name = "<init>", descriptor = "(Lha;Lac;IIIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(ILtd;)V")
    ...
    @OriginalMember(owner = "client!paa", name = "j", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!paa", name = "b", descriptor = "(Lha;I)Ljk;")
    ...
    @OriginalMember(owner = "client!paa", name = "d", descriptor = "(ILha;)Lwg;")
