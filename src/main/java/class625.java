...
public class class625 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(B[II)Ljg;", line = 7)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "([III)Ljg;", line = 31)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IIZIII)V", line = 50)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(I)V", line = 151)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(B[III)Ljg;", line = 162)
    ...
    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "(Lgda;Lgda;)V", line = 282)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(DI)V", line = 208)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(I[III)Ljg;", line = 226)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(III)Z", line = 269)
