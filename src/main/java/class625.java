...
public class class625 extends class292 {
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIILep;)V", line = 41)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ILoa;)Lgr;", line = 65)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IZIIII)V", line = 77)
    ...
    @OriginalMember(owner = "client!ag", name = "d", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!ag", name = "i", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(Loa;I)Lok;", line = 175)
    ...
    @OriginalMember(owner = "client!ag", name = "j", descriptor = "(I)Z", line = 244)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ZIZIILfl;Loa;)V", line = 255)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ILoa;Z)Z", line = 269)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(B)I", line = 467)
    ...
    @OriginalMember(owner = "client!ag", name = "e", descriptor = "(I)I", line = 488)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IILoa;I)Z", line = 500)
    ...
    @OriginalMember(owner = "client!ag", name = "d", descriptor = "(B)Z", line = 537)
    public final boolean method449(byte arg0) {
        ++field8856;
        return arg0 != -126;
    }

    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lnc;I)V", line = 548)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(IBI)V", line = 562)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(I)I", line = 608)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(B)I", line = 634)
    ...
    @OriginalMember(owner = "client!ag", name = "d", descriptor = "(Z)Z", line = 661)
    ...
    @OriginalMember(owner = "client!ag", name = "c", descriptor = "(II)Ljava/lang/String;", line = 682)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(III)V", line = 715)
    ...
    @OriginalMember(owner = "client!ag", name = "c", descriptor = "(Loa;I)V", line = 810)
