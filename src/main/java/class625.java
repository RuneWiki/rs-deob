...
public class class625 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(I)Loo;", line = 4)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(III)I", line = 21)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Ljava/lang/String;CI)[Ljava/lang/String;", line = 42)
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "(I)V", line = 117)
    public class625(int arg0) {
        this.field8979 = arg0;
    }

    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "(IIIIII)V", line = 124)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(ILoo;)V", line = 82)
    ...
    @OriginalMember(owner = "client!oo", name = "b", descriptor = "(I)V", line = 101)
