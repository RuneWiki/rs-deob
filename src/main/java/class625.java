...
public class class625 extends class748 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ILwu;)I")
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IZLvj;)V")
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IBLvj;)Ljava/lang/String;")
