...
public class class625 extends class129 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ZI)V", line = 24)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IILrca;)V", line = 68)
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Lkd;)V", line = 198)
    ...
    @OriginalMember(owner = "client!ai", name = "f", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ZB)V", line = 97)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Lic;I[II)V", line = 112)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(I)V", line = 315)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Z)Z", line = 358)
