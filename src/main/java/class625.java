...
public class class625 {
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(I)Lrf;")
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(ZLdga;)V")
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(Z)Lrf;")
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(Ldga;II)V")
