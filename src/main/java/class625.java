...
public class class625 extends class48 implements class493 {
    ...
    @OriginalMember(owner = "client!lha", name = "c", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!lha", name = "<init>", descriptor = "(Llaa;IZ[[I)V")
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;II)V")
