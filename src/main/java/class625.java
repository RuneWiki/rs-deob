...
public class class625 implements class236 {
    ...
    @OriginalMember(owner = "client!ufa", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!ufa", name = "b", descriptor = "(Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(BI)V", line = 50)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Lwg;IIB)V", line = 68)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(IIILwaa;)V", line = 81)
    ...
    @OriginalMember(owner = "client!ufa", name = "c", descriptor = "(I)I", line = 113)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(IZ)V", line = 136)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(BIILwg;I)V", line = 150)
    ...
    @OriginalMember(owner = "client!ufa", name = "d", descriptor = "(I)Z", line = 184)
    ...
    @OriginalMember(owner = "client!ufa", name = "b", descriptor = "(I)V", line = 205)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(ILfj;I)V", line = 220)
    ...
    @OriginalMember(owner = "client!ufa", name = "<init>", descriptor = "(Len;)V", line = 371)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(I)V", line = 260)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Lwaa;BI)V", line = 275)
    ...
    @OriginalMember(owner = "client!ufa", name = "e", descriptor = "(I)V", line = 290)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(IC)Z", line = 315)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Z)V", line = 326)
    ...
    @OriginalMember(owner = "client!ufa", name = "b", descriptor = "(BI)V", line = 340)
    ...
    @OriginalMember(owner = "client!ufa", name = "finalize", descriptor = "()V", line = 355)
