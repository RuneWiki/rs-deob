...
public class class625 implements class145 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!t", name = "b", descriptor = "()V", line = 32)
    public final void method3487() {
        this.field8486 = Thread.currentThread();
        this.method3482();
    }

    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lj;BIZ)Lba;", line = 43)
