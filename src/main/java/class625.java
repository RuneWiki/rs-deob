...
public class class625 extends class460 {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(ILjo;I)V")
    ...
    @OriginalMember(owner = "client!hu", name = "<init>", descriptor = "(Lkfa;)V")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Lvo;BI)Lfm;")
    ...
    @OriginalMember(owner = "client!hu", name = "b", descriptor = "(II)Llq;")
