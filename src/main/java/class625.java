...
public class class625 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(II)Ljava/lang/Integer;", line = 10)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Ljava/io/File;I[BI)V", line = 33)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(III)Z", line = 51)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IIZII)I", line = 91)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(I)[I", line = 120)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IZII)Ljava/lang/Integer;", line = 168)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(BJLjava/lang/String;)V", line = 191)
    ...
    @OriginalMember(owner = "client!ke", name = "b", descriptor = "(I)V", line = 236)
    ...
    @OriginalMember(owner = "client!ke", name = "b", descriptor = "(II)Ljava/lang/Long;", line = 288)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(ILjava/lang/String;I)Z", line = 309)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(BI)V", line = 356)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(ILjp;)V", line = 386)
    ...
    @OriginalMember(owner = "client!ke", name = "c", descriptor = "(II)V", line = 552)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IIII)I", line = 585)
    ...
    @OriginalMember(owner = "client!ke", name = "c", descriptor = "(I)V", line = 600)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IB)Ljava/lang/String;", line = 619)
    ...
    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "(Ljp;)V", line = 955)
    public class625(class376 arg0) {
        this.method3431(127, arg0);
    }

    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "()V", line = 963)
    private class625() {
    }

    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(JII)Z", line = 643)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(BLjava/lang/String;)I", line = 683)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(B)V", line = 712)
    ...
    @OriginalMember(owner = "client!ke", name = "d", descriptor = "(I)V", line = 723)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IZ)V", line = 737)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IIIZI)Z", line = 784)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Ljava/lang/String;IJ)V", line = 832)
    ...
    @OriginalMember(owner = "client!ke", name = "d", descriptor = "(II)V", line = 869)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IBB)I", line = 923)
