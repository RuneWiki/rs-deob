...
public class class625 extends class182 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(ZLwv;)V")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(ILvfa;B)V")
    ...
    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "(Lag;Lica;)V")
