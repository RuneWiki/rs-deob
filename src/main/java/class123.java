...
public class class123 extends class702 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(FFFFFFILua;II)V")
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(IILua;II)V")
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "(Lok;IIZ)V")
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "(Lok;IIII)V")
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "(Lok;II[III)V")
