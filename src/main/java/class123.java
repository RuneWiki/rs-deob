...
public class class123 extends class135 implements class9 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(I)I", line = 66)
    ...
    @OriginalMember(owner = "client!jl", name = "d", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(BI[BI)V", line = 92)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Z)I", line = 104)
    ...
    @OriginalMember(owner = "client!jl", name = "c", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(Los;I[BIZ)V", line = 130)
    public class123(class468 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field1586 = arg1;
    }

    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(Los;ILjaclib/memory/Buffer;IZ)V", line = 139)
    public class123(class468 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field1586 = arg1;
    }

    @OriginalMember(owner = "client!jl", name = "b", descriptor = "(I)J", line = 147)
