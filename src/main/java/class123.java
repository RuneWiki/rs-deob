...
public class class123 {
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(Ljava/lang/String;ILjava/applet/Applet;)V", line = 3)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(BLjava/lang/String;Ljava/applet/Applet;)Ljava/lang/Object;", line = 13)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(Ljava/applet/Applet;BLjava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;", line = 25)
