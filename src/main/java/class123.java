...
public class class123 extends class98 {
    ...
    @OriginalMember(owner = "client!ui", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ui", name = "d", descriptor = "(B)I", line = 17)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;IILjava/lang/String;ILjava/lang/String;)V", line = 28)
    ...
    @OriginalMember(owner = "client!ui", name = "f", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!ui", name = "f", descriptor = "(I)Z", line = 491)
    ...
    @OriginalMember(owner = "client!ui", name = "c", descriptor = "(I)V", line = 517)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ILdg;I)V", line = 534)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "()V", line = 552)
    public class123() {
        super(0, false);
    }

    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(II)[[I", line = 555)
