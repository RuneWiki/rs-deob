...
public class class123 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(ILqa;Lwl;II)V", line = 26)
    ...
    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 62)
    public class123(Throwable arg0, String arg1) {
        this.field1806 = arg1;
        this.field1810 = arg0;
    }

    @OriginalMember(owner = "client!vp", name = "a", descriptor = "()V", line = 72)
    public static final void method902() {
        class402.method2334(1, class508.field7055);
    }

    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IBI)Z", line = 75)
