...
public class class123 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "([I[IIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "(Llea;)V")
