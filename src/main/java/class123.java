...
public class class123 {
    ...
    @OriginalMember(owner = "client!nb", name = "m", descriptor = "[Ldf;")
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IIIIIIIILka;IZJ)Z")
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(ZI)Lrd;")
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(II[BI[Llb;)V")
