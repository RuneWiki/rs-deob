...
public class class123 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(B)Lhq;")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Ldk;I)V")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(I)Lhq;")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(ILhq;)V")
