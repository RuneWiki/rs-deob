...
public abstract class class123 extends class168 {
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!laa", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(B)I", line = 38)
    ...
    @OriginalMember(owner = "client!laa", name = "c", descriptor = "(I)I", line = 55)
    ...
    @OriginalMember(owner = "client!laa", name = "<init>", descriptor = "(IIIIIF)V", line = 67)
    ...
    @OriginalMember(owner = "client!laa", name = "e", descriptor = "(I)I", line = 83)
    public final int method937(int arg0) {
        field1768++;
        return arg0 <= 44 ? 111 : this.field1774;
    }

    @OriginalMember(owner = "client!laa", name = "f", descriptor = "(I)I", line = 94)
    ...
    @OriginalMember(owner = "client!laa", name = "g", descriptor = "(I)F", line = 105)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(BLbp;)I", line = 116)
