...
public class class123 extends class298 {
    ...
    @OriginalMember(owner = "client!hr", name = "d", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!hr", name = "c", descriptor = "()I", line = 24)
    public final int method185() {
        field1952++;
        return 0;
    }

    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(BLdp;)V", line = 32)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "()Lwm;", line = 47)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "()Lwm;", line = 67)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "([III)V", line = 85)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "([IBIILea;I)V", line = 131)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Ldp;IZ)Lbs;", line = 197)
    ...
    @OriginalMember(owner = "client!hr", name = "e", descriptor = "(I)V", line = 216)
    ...
    @OriginalMember(owner = "client!hr", name = "f", descriptor = "(I)V", line = 228)
    ...
    @OriginalMember(owner = "client!hr", name = "g", descriptor = "(I)V", line = 249)
    ...
    @OriginalMember(owner = "client!hr", name = "c", descriptor = "(I)V", line = 852)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(CI)B", line = 890)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lea;IZ)V", line = 1015)
    ...
    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "(Lfh;)V", line = 1061)
