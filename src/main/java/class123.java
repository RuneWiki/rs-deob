...
public class class123 extends class460 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 3)
    ...
    @OriginalMember(owner = "client!pe", name = "d", descriptor = "()I", line = 10)
    public final int method913() {
        return field1849.method3164(103, this.field1848);
    }

    @OriginalMember(owner = "client!pe", name = "e", descriptor = "()V", line = 13)
    public static void method914() {
        field1849 = null;
    }

    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(Lgt;I)V", line = 16)
    public class123(class66 arg0, int arg1) {
        field1849 = arg0.method451(false);
        this.field1848 = arg1;
    }

    @OriginalMember(owner = "client!pe", name = "b", descriptor = "()V", line = 21)
    public final void method915() {
        field1849.method3168(this.field1848, super.field6823);
    }

    @OriginalMember(owner = "client!pe", name = "b", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!pe", name = "c", descriptor = "()V", line = 30)
