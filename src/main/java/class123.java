...
public class class123 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(ILj;II)V", line = 8)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(IIBII)V", line = 80)
    ...
    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(ILj;II)V", line = 119)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(IILj;I)Z", line = 194)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(II)Z", line = 267)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(I)V", line = 278)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(ZI[[ZIBI)V", line = 307)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(B)V", line = 493)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(FIIBIIZI)[I", line = 503)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Lco;III)V", line = 531)
    ...
    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "(Lbv;Llh;)V", line = 581)
