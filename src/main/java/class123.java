...
public class class123 extends class80 {
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IILnn;)V", line = 10)
    ...
    @OriginalMember(owner = "client!r", name = "d", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IIIIBII[B[B)V", line = 88)
    ...
    @OriginalMember(owner = "client!r", name = "c", descriptor = "(II)[[I", line = 135)
