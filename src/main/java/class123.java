...
public class class123 extends class469 implements class534 {
    ...
    @OriginalMember(owner = "client!cw", name = "c", descriptor = "(I)Z", line = 8)
    ...
    @OriginalMember(owner = "client!cw", name = "b", descriptor = "(Lqa;B)Lem;", line = 20)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(IBLqa;)Lka;", line = 35)
    ...
    @OriginalMember(owner = "client!cw", name = "b", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!cw", name = "b", descriptor = "(B)I", line = 67)
    public final int method561(byte arg0) {
        ++field1934;
        return arg0 != -85 ? -51 : 65535 & this.field1920;
    }

    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(ILqa;)Lnj;", line = 85)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(ILqa;I)Lka;", line = 109)
    public final class336 method550(int arg0, class167 arg1, int arg2) {
        ++field1930;
        return arg0 != -14322 ? null : this.method909(arg2, (byte) -112, arg1);
    }

    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(IIILqa;)Z", line = 120)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(B)I", line = 142)
    ...
    @OriginalMember(owner = "client!cw", name = "e", descriptor = "(I)I", line = 153)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(I)I", line = 164)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(BLqa;)V", line = 175)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(IC)Z", line = 206)
    ...
    @OriginalMember(owner = "client!cw", name = "<init>", descriptor = "(Lqa;Lku;IIIIZIIIII)V", line = 243)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(Lqa;B)V", line = 269)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(Lqa;I)V", line = 280)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(ZLqa;IB)Lso;", line = 315)
