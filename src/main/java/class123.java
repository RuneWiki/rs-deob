...
public class class123 extends class45 {
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(II)[[I", line = 4)
    ...
    @OriginalMember(owner = "client!vp", name = "f", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(ZZLdk;B)V", line = 78)
    ...
    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "()V", line = 174)
    public class123() {
        super(1, false);
    }
    ...
    @OriginalMember(owner = "client!vp", name = "d", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!vp", name = "e", descriptor = "(I)V", line = 189)
    public static void method947(int arg0) {
        int var1 = -55 / ((arg0 - 28) / 39);
        field1993 = null;
    }

    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lcu;II)V", line = 203)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IIIIII)V", line = 251)
