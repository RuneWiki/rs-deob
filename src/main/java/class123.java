...
public class class123 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IZIIIZ)V", line = 10)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!ls", name = "<init>", descriptor = "(Lkga;)V", line = 133)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(II)Z", line = 86)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ZLjf;I)Z", line = 99)
