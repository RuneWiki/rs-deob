...
public class class123 extends class383 {
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(Lsq;I)V", line = 18)
    public class123(class96 arg0, int arg1) {
        this.field1817 = arg0;
        this.field1818 = new class352(arg0, 6408, arg1);
    }

    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(I)Lrj;", line = 28)
    public final class352 method900(int arg0) {
        return arg0 == 16057 ? this.field1818 : (class352) null;
    }

    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Lrj;Lrj;FI)V", line = 39)
