...
public class class123 extends class435 {
    ...
    @OriginalMember(owner = "client!r", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IIILfo;)Lgf;", line = 17)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IIIIII)V", line = 54)
    ...
    @OriginalMember(owner = "client!r", name = "<init>", descriptor = "(I[B)V", line = 84)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IBI)V", line = 142)
