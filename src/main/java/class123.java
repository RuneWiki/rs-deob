...
public class class123 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IZIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(ZZ)V", line = 22)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Ljava/lang/String;B)J", line = 36)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Lt;IIBZILya;IIIILlc;III)Lt;", line = 202)
    ...
    @OriginalMember(owner = "client!pe", name = "toString", descriptor = "()Ljava/lang/String;", line = 419)
    public final String toString() {
        field1864++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(II)V", line = 432)
