...
public class class123 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Lvt;)V", line = 34)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "()V", line = 49)
    public class123() {
        this.field1527[0] = 0;
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(Lvt;)V", line = 65)
