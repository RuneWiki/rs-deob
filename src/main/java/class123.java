...
public class class123 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(ZILvn;Len;I)V")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(BLbk;I)V")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Z)Lcl;")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IILbk;I)V")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(ILjf;)V")
