...
public class class123 extends class450 {
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "(Lup;)V")
    ...
    @OriginalMember(owner = "client!fv", name = "b", descriptor = "(Z)I")
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "(ILup;)V")
