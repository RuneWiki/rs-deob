...
public class class123 extends class508 {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Lri;)Lmr;", line = 5)
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
