...
public class class123 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(III)Lhl;", line = 4)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Ljava/awt/Component;Lud;IBI)Lwi;", line = 17)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IZIILfg;II)V", line = 99)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ZLaf;)V", line = 139)
