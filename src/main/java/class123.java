...
public class class123 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(IB)Lui;", line = 3)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(II)I", line = 29)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Z)V", line = 63)
