...
public class class123 extends class294 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IBLtq;I)Z")
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(III)Lmp;")
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lcj;B)V")
