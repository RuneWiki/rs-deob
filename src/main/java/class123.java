...
public class class123 {
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Lsaa;I)Z")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IILoa;IIII)V")
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Loa;Ldga;I)V")
