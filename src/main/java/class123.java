...
public class class123 extends class232 {
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Lsf;IIIII)V")
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Lija;III)J")
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(ILdr;I)V")
    ...
    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "(Lwk;Llo;)V")
