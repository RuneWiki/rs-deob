...
public class class123 extends class529 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IBLtn;)V", line = 4)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IB)[I", line = 40)
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "()V", line = 285)
    public class123() {
        super(2, false);
    }

    @OriginalMember(owner = "client!th", name = "a", descriptor = "(II)[[I", line = 288)
