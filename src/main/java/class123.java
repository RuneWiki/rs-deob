...
public class class123 {
    ...
    @OriginalMember(owner = "client!ej", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field1663++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Z[[[Lffa;IIII)Z", line = 12)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Z)V", line = 337)
