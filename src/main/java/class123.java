...
public class class123 extends class748 {
    ...
    @OriginalMember(owner = "client!gi", name = "b", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "()V", line = 187)
    public class123() {
        super(0, false);
    }

    @OriginalMember(owner = "client!gi", name = "b", descriptor = "(II)[[I", line = 122)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Z)V", line = 191)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(III)V", line = 200)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ZIIBIIII)V", line = 226)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IZLvj;)V", line = 243)
    ...
    @OriginalMember(owner = "client!gi", name = "f", descriptor = "(I)I", line = 262)
