...
public class class123 extends class56 {
    ...
    @OriginalMember(owner = "client!ut", name = "<init>", descriptor = "()V", line = 569)
    public class123() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(ILee;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!ut", name = "e", descriptor = "(III)V", line = 97)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(BILjava/lang/String;Z)I", line = 127)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(IBLjb;)Ljava/lang/String;", line = 211)
    ...
    @OriginalMember(owner = "client!ut", name = "b", descriptor = "(II)I", line = 234)
    ...
    @OriginalMember(owner = "client!ut", name = "e", descriptor = "(I)V", line = 253)
    ...
    @OriginalMember(owner = "client!ut", name = "b", descriptor = "(I)V", line = 330)
    ...
    @OriginalMember(owner = "client!ut", name = "c", descriptor = "(B)V", line = 341)
    ...
    @OriginalMember(owner = "client!ut", name = "c", descriptor = "(II)V", line = 551)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(IZ)[I", line = 582)
