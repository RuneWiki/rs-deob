...
public class class123 {
    ...
    @OriginalMember(owner = "client!vp", name = "toString", descriptor = "()Ljava/lang/String;", line = 16)
    public final String toString() {
        field1914++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "(II)V", line = 30)
    public class123(int arg0, int arg1) {
        this.field1912 = arg0;
    }

    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(B)V", line = 43)
