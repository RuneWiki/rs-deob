...
public class class123 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(ILrg;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "([I[I[ILql;I)V", line = 16)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(BII)I", line = 123)
    ...
    @OriginalMember(owner = "client!em", name = "b", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!em", name = "c", descriptor = "(I)V", line = 168)
