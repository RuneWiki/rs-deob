...
public class class123 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(ZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(II)V", line = 54)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(BIIII)V", line = 82)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(IIIZ)I", line = 157)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(ILha;)V", line = 177)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(I)V", line = 285)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(B)V", line = 321)
