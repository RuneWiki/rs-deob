...
public class class123 extends class195 {
    ...
    @OriginalMember(owner = "client!vr", name = "<init>", descriptor = "(Lap;Led;[Laaa;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!vr", name = "q", descriptor = "(CIIIZ)V", line = 243)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(CIIIZLfa;II)V", line = 265)
