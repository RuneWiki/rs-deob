...
public class class123 extends class617 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(IFFFILss;[BIIIIFIF)V", line = 5)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(BII)V", line = 68)
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "(II[I[I)V", line = 86)
