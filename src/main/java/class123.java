...
public class class123 extends class424 {
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(Lkq;)V", line = 77)
    public class123(class700 arg0) {
        this.field1596 = arg0;
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(III)Z", line = 36)
