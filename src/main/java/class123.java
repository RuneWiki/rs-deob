...
public class class123 implements class343 {
    ...
    @OriginalMember(owner = "client!fn", name = "b", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "(Lsea;Ljava/lang/String;)V", line = 21)
    public class123(class648 arg0, String arg1) {
        this.field1687 = arg1;
        this.field1689 = arg0;
    }

    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(I)I", line = 34)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(B)Lmv;", line = 48)
