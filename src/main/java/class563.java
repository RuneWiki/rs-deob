...
public abstract class class563 extends class692 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(B[Lcp;)I")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lfa;ILri;)V")
    ...
    @OriginalMember(owner = "client!iq", name = "h", descriptor = "(B)V")
