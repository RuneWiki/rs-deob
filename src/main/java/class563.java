...
public class class563 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IIIIIIII)V", line = 27)
