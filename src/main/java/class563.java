...
public class class563 extends class92 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IILqv;)V")
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(Lnd;Lom;)V")
    public class563(class632 arg0, class331 arg1) {
        super(arg0);
        this.field8063 = arg1;
    }

    @OriginalMember(owner = "client!et", name = "e", descriptor = "(B)V")
