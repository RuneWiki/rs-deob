...
public class class563 extends class324 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(CB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IIILhh;)V", line = 15)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(III)Z", line = 27)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IIIIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lqb;B)V", line = 145)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(BIIIIIII)V", line = 204)
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(Z)V", line = 264)
