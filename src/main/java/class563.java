...
public class class563 extends class318 {
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(B)Lku;", line = 7)
    ...
    @OriginalMember(owner = "client!via", name = "c", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!via", name = "d", descriptor = "(B)V", line = 79)
    ...
    @OriginalMember(owner = "client!via", name = "<init>", descriptor = "(Leea;IIIIII)V", line = 100)
