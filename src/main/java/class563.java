...
public class class563 {
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(IB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(ZZ)V", line = 16)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(Z)V", line = 60)
    ...
    @OriginalMember(owner = "client!tea", name = "b", descriptor = "(Z)Z", line = 74)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(Lofa;I)V", line = 98)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(ZILofa;)V", line = 129)
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(I)V", line = 169)
