...
public class class563 implements class243 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Loh;II)Lhu;")
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(I)Lhs;")
    ...
    @OriginalMember(owner = "client!k", name = "<init>", descriptor = "(Ljava/lang/String;Lkda;Lcu;IIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(ILs;)V")
