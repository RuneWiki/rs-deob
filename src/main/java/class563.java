...
public class class563 extends class86 implements class147 {
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(ZLoa;)V")
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(IILgfa;IIZLoa;)V")
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(ILoa;)Lwc;")
    public final class60 method555(int arg0, class638 arg1) {
        field7603++;
        return arg0 == 0 ? null : null;
    }

    @OriginalMember(owner = "client!jaa", name = "<init>", descriptor = "(IIIIILal;)V")
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(IILoa;I)Z")
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(IILoa;)Lba;")
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(Loa;B)Lac;")
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(BLoa;)V")
    ...
    @OriginalMember(owner = "client!jaa", name = "b", descriptor = "(BLoa;)V")
