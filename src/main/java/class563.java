...
public class class563 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(BLtm;J)V", line = 6)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IIIBIIIIII)Z", line = 64)
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(JB)Ltm;", line = 122)
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Z)Ltm;", line = 173)
