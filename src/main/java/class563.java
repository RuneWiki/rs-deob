...
public class class563 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ZI[[[Lko;IIZ)Z", line = 32)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(BI)Lma;", line = 351)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(I)V", line = 382)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 449)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(B)V", line = 505)
    ...
    @OriginalMember(owner = "client!cs", name = "c", descriptor = "(I)V", line = 516)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(II)V", line = 530)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IB)V", line = 553)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lgn;ILvo;)V", line = 574)
