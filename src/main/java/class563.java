...
public class class563 {
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(B)Z", line = 18)
    public final boolean method3214(byte arg0) {
        field7916++;
        return arg0 >= -77 ? false : this.field7925.field7544.method2997((byte) -95, this.field7923);
    }

    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(ZLvg;)V", line = 31)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(III)I", line = 50)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(ILmo;I)V", line = 70)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(IIZLr;)Lf;", line = 98)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(ILmo;)V", line = 144)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/String;", line = 165)
