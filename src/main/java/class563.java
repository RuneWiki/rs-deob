...
public class class563 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(BLac;)V")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Ljava/lang/String;Lac;B)I")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ZBLqh;)V")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IBLac;)V")
