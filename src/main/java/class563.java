...
public class class563 {
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Ljv;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(II)I", line = 27)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(B)Lkg;", line = 41)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IB)Ljv;", line = 59)
    ...
    @OriginalMember(owner = "client!eda", name = "<init>", descriptor = "(Ljv;)V", line = 70)
    public class563(class638 arg0) {
        this.field7821 = 1;
        this.field7820 = arg0.field8944;
    }

    @OriginalMember(owner = "client!eda", name = "b", descriptor = "(I)I", line = 80)
    ...
    @OriginalMember(owner = "client!eda", name = "<init>", descriptor = "([Ljv;)V", line = 89)
    public class563(class638[] arg0) {
