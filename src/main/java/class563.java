...
public class class563 extends class571 implements class675 {
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(ZLha;)Lrs;", line = 5)
    ...
    @OriginalMember(owner = "client!nl", name = "f", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(BLha;I)Lka;", line = 42)
    ...
    @OriginalMember(owner = "client!nl", name = "e", descriptor = "(Z)Z", line = 61)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(ZLha;)V", line = 78)
    ...
    @OriginalMember(owner = "client!nl", name = "c", descriptor = "(B)I", line = 105)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lha;I)V", line = 116)
    ...
    @OriginalMember(owner = "client!nl", name = "d", descriptor = "(B)V", line = 126)
    ...
    @OriginalMember(owner = "client!nl", name = "d", descriptor = "(Z)Z", line = 142)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Z)I", line = 157)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lha;IZI)Lni;", line = 168)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IBILrfa;ZILha;)V", line = 202)
    ...
    @OriginalMember(owner = "client!nl", name = "c", descriptor = "(I)I", line = 233)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lha;III)Z", line = 245)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(III)Ljea;", line = 268)
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(I)I", line = 280)
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(Lha;Lfw;IIIIIZIIZ)V", line = 291)
    ...
    @OriginalMember(owner = "client!nl", name = "c", descriptor = "(Z)I", line = 324)
    ...
    @OriginalMember(owner = "client!nl", name = "g", descriptor = "(I)Z", line = 340)
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(Z)V", line = 353)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lha;B)Lsba;", line = 367)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(I)Z", line = 384)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(ILha;)V", line = 404)
