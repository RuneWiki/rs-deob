...
public class class563 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(BLdt;I)V", line = 17)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "([J[Ljava/lang/Object;ZII)V", line = 47)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(B)Z", line = 106)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(BLdt;)V", line = 147)
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(I)V", line = 173)
