...
public class class563 extends class299 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "(Les;)V", line = 21)
    public class563(class404 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(Z)I", line = 26)
    ...
    @OriginalMember(owner = "client!ts", name = "c", descriptor = "(Z)Z", line = 37)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IZ)V", line = 48)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(II)I", line = 58)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(JZ)V", line = 77)
    ...
    @OriginalMember(owner = "client!ts", name = "d", descriptor = "(Z)V", line = 92)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(I)I", line = 103)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(IZ)V", line = 121)
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "(ILes;)V", line = 144)
    public class563(int arg0, class404 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ts", name = "c", descriptor = "(I)Z", line = 148)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(I)V", line = 163)
