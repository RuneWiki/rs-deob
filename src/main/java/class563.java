...
public class class563 extends class170 {
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Lha;B)Lac;", line = 3)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(II)V", line = 24)
    ...
    @OriginalMember(owner = "client!ce", name = "b", descriptor = "(I)F", line = 56)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(ILtn;)V", line = 77)
    ...
    @OriginalMember(owner = "client!ce", name = "c", descriptor = "(I)Z", line = 121)
    ...
    @OriginalMember(owner = "client!ce", name = "e", descriptor = "(I)J", line = 132)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(IZIZI)I", line = 148)
    ...
    @OriginalMember(owner = "client!ce", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 187)
    public class563(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ce", name = "f", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!ce", name = "g", descriptor = "(I)D", line = 210)
    public final double method3182(int arg0) {
        field7876++;
        return arg0 <= 95 ? 2.6488495145771407D : this.field7871;
    }

    @OriginalMember(owner = "client!ce", name = "b", descriptor = "(ILjagtheora/ogg/OggPacket;)V", line = 221)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Z)V", line = 301)
