...
public class class563 extends class394 implements class175 {
    ...
    @OriginalMember(owner = "client!bf", name = "c", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(III)Z", line = 13)
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(Lnv;Lpe;II[FII)V", line = 25)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(BLpe;)I", line = 38)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIII[BILpe;II)V", line = 77)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(I)Z", line = 103)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(BF)F", line = 115)
    ...
    @OriginalMember(owner = "client!bf", name = "b", descriptor = "(I)I", line = 128)
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(Lnv;II[III)V", line = 139)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIII[IIBI)V", line = 153)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIII[IBI)V", line = 177)
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(Lnv;Lpe;II[BII)V", line = 200)
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(Lnv;Lpe;Ldw;II)V", line = 215)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(ZZB)V", line = 226)
    public final void method1198(boolean arg0, boolean arg1, byte arg2) {
        ++field7777;
        int var4 = 86 % ((arg2 - -68) / 55);
    }

    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IF)F", line = 236)
