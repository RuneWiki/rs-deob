...
public abstract class class170 {
    ...
    @OriginalMember(owner = "client!oe", name = "c", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "([BIIIII)Z", line = 23)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(I[Ljava/lang/String;I[SI)V", line = 106)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lmd;B)V", line = 169)
