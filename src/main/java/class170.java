...
public class class170 extends class294 {
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Luf;[I)V")
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IILfi;I)V")
    ...
    @OriginalMember(owner = "client!aq", name = "<init>", descriptor = "(Lffa;IIII[[I[[II)V")
