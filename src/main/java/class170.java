...
public class class170 extends class194 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IILbg;)V", line = 8)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IIIII)V", line = 43)
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(Z)V", line = 63)
    ...
    @OriginalMember(owner = "client!js", name = "c", descriptor = "(II)V", line = 75)
    ...
    @OriginalMember(owner = "client!js", name = "d", descriptor = "(II)V", line = 85)
    ...
    @OriginalMember(owner = "client!js", name = "c", descriptor = "(Z)V", line = 100)
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "()V", line = 113)
    public class170() {
        super(1, false);
    }

    @OriginalMember(owner = "client!js", name = "a", descriptor = "(II)[I", line = 125)
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(II)[[I", line = 177)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Lwo;ILwo;Lwo;)V", line = 245)
