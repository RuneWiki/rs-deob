...
public class class170 {
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ILoa;)V")
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(Lq;BLba;IZIILoa;I)V")
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IZIIILoa;Z)Lba;")
    ...
    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "(Loa;Lqd;IIIIIIZI)V")
