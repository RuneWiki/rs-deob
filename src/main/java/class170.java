...
public class class170 extends class179 {
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(Lqi;II[BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IZ)V", line = 22)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "()V", line = 34)
