...
public class class170 extends class138 {
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!al", name = "c", descriptor = "()I", line = 47)
    public final int method1053() {
        return this.field2751 - (this.field2752.available() >> (class525.field7704 ? 2 : 1));
    }

    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 55)
    ...
    @OriginalMember(owner = "client!al", name = "d", descriptor = "()V", line = 101)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 107)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!al", name = "b", descriptor = "()V", line = 144)
