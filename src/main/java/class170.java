...
public class class170 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IIIF[BFFLmm;FFBII)V", line = 4)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(II)V", line = 43)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IZIIII)V", line = 193)
