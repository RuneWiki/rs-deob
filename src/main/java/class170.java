...
public class class170 extends class71 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!rs", name = "b", descriptor = "(B)V", line = 33)
    public static void method1088(byte arg0) {
        field2360 = null;
        int var1 = -89 / ((arg0 + 25) / 50);
    }

    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(I)[Lbk;", line = 42)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(ZBI)Lwda;", line = 58)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IILha;)Z", line = 71)
    ...
    @OriginalMember(owner = "client!rs", name = "<init>", descriptor = "(II)V", line = 522)
