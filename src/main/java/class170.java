...
public class class170 extends InputStream {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(BLtj;)V")
    ...
    @OriginalMember(owner = "client!aj", name = "read", descriptor = "()I")
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(II)Lqn;")
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Lbr;I)Ljava/lang/String;")
