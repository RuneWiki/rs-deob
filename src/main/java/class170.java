...
public class class170 {
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(Z)V", line = 49)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(II)Lnba;", line = 86)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(IB)I", line = 125)
    ...
    @OriginalMember(owner = "client!cfa", name = "b", descriptor = "(B)V", line = 137)
    ...
    @OriginalMember(owner = "client!cfa", name = "<init>", descriptor = "(Lrga;ILni;)V", line = 156)
