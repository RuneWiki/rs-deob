...
public class class170 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ILts;)V")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Lae;Z)V")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IILae;)V")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ILeq;)Lqg;")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ILeq;Z)Lqg;")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ILno;)Z")
