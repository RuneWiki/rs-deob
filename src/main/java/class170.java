...
public class class170 {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Lqj;BLqj;)I")
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IIILeb;)V")
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IILeb;)V")
