...
public class class170 {
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(BIILaga;II)Lpj;")
    ...
    @OriginalMember(owner = "client!ffa", name = "b", descriptor = "(II)Lte;")
    ...
    @OriginalMember(owner = "client!ffa", name = "<init>", descriptor = "(Lei;ILri;)V")
