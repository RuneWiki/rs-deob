...
public class class170 extends class139 {
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "([BBZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(BILgl;)V", line = 45)
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(I)Z", line = 58)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(IZ)V", line = 68)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(ZI)V", line = 80)
    ...
    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(Lkea;)V", line = 146)
    public class170(class223 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!vda", name = "d", descriptor = "(B)V", line = 150)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(III)V", line = 164)
