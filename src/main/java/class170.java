...
public class class170 extends class494 {
    ...
    @OriginalMember(owner = "client!kg", name = "d", descriptor = "(I)J", line = 4)
    public final long method1066(int arg0) {
        field2638++;
        return arg0 == -8934 ? this.field2644 : 30L;
    }

    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(I)C", line = 15)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Z)Z", line = 30)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(I[ILbl;IZI)Ljs;", line = 49)
    ...
    @OriginalMember(owner = "client!kg", name = "f", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!kg", name = "c", descriptor = "(I)I", line = 86)
    ...
    @OriginalMember(owner = "client!kg", name = "g", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(I)I", line = 114)
