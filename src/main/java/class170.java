...
public class class170 extends class242 implements class691 {
    ...
    @OriginalMember(owner = "client!ov", name = "k", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(IIZLr;ILub;I)V")
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Lr;Z)V")
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Lr;III)Z")
    ...
    @OriginalMember(owner = "client!ov", name = "<init>", descriptor = "(Lr;Lfga;IIIIIZIII)V")
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Lr;B)Llt;")
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(BLr;)V")
    ...
    @OriginalMember(owner = "client!ov", name = "b", descriptor = "(BLr;)Lsr;")
