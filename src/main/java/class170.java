...
public class class170 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(I[B)V", line = 35)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(I)V", line = 232)
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "([BI[B)V", line = 250)
