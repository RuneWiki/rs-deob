...
public class class170 extends class431 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "([I)Lfv;")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Lul;)Z")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Lul;II)Lok;")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Lul;I)Lok;")
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "([B)V")
