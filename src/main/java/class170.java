...
public class class170 {
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(III)Z", line = 18)
    ...
    @OriginalMember(owner = "client!ew", name = "b", descriptor = "(III)V", line = 36)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(IIILjb;)V", line = 87)
