...
public class class170 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Ljava/lang/Object;IZ)[B", line = 3)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(II)V", line = 38)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(I)V", line = 57)
