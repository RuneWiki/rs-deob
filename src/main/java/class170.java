...
public class class170 {
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(BLfb;)V", line = 17)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(IILfb;)V", line = 40)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Z)Z", line = 193)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Ljava/lang/String;Lsj;I)Ljava/lang/String;", line = 212)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(B)V", line = 302)
    ...
    @OriginalMember(owner = "client!w", name = "b", descriptor = "(I)Z", line = 339)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(II)V", line = 391)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(ILfb;)Ljava/lang/String;", line = 430)
    ...
    @OriginalMember(owner = "client!w", name = "c", descriptor = "(I)V", line = 444)
    ...
    @OriginalMember(owner = "client!w", name = "b", descriptor = "(Z)V", line = 519)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(ZZLtj;)Ll;", line = 568)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(BLtj;)Ll;", line = 607)
