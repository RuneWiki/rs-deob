...
public class class170 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Lre;I)V")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IILre;)V")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIBI)V")
