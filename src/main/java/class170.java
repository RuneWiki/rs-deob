...
public class class170 {
    ...
    @OriginalMember(owner = "client!tj", name = "b", descriptor = "(I)Lrm;")
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(II)Lea;")
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IILpc;)Lkr;")
    ...
    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "(Lte;Ln;)V")
