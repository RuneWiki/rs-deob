...
public class class170 extends class270 {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(BII)Z", line = 7)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ILep;)V", line = 44)
