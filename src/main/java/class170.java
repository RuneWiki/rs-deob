...
public class class170 extends class522 implements class351 {
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "(Lqa;Lkn;IIIIIZIIIIII)V")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lic;BLic;Lic;Lic;)V")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IILqa;B)Z")
    ...
    @OriginalMember(owner = "client!uk", name = "c", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(ILqa;I)Lc;")
    ...
    @OriginalMember(owner = "client!uk", name = "b", descriptor = "(ILqa;)Lnf;")
