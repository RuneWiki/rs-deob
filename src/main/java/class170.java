...
public class class170 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(BJ)V", line = 27)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IIIIIII)V", line = 48)
