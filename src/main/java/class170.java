...
public class class170 extends class8 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lss;B)V")
    ...
    @OriginalMember(owner = "client!uk", name = "h", descriptor = "(I)Lgm;")
    ...
    @OriginalMember(owner = "client!uk", name = "c", descriptor = "(B)Llq;")
