...
public abstract class class170 extends class627 {
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(IIIZIIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(ILjagtheora/ogg/OggPacket;)V", line = 31)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(IZLjava/lang/String;I)V", line = 46)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(IIIIIIIIBILkfa;Lgq;)V", line = 83)
    ...
    @OriginalMember(owner = "client!oga", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 114)
