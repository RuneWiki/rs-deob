...
public class class170 extends class190 {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IILuo;Z)Z", line = 6)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ILbe;ILuo;Lco;I)Z", line = 33)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(I)V", line = 265)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IIILnq;ZI)V", line = 291)
