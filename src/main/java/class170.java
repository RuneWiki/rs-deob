...
public class class170 {
    ...
    public static int[] field2701 = new int[6];
    ...
    private static int[][] field2719 = new int[][] { { 0, 1, 2, 3, 0, 0, 1, 3 }, { 1, 1, 2, 3, 1, 0, 1, 3 }, { 0, 1, 2, 3, 1, 0, 1, 3 }, { 0, 0, 1, 2, 0, 0, 2, 4, 1, 0, 4, 3 }, { 0, 0, 1, 4, 0, 0, 4, 3, 1, 1, 2, 4 }, { 0, 0, 4, 3, 1, 0, 1, 2, 1, 0, 2, 4 }, { 0, 1, 2, 4, 1, 0, 1, 4, 1, 0, 4, 3 }, { 0, 4, 1, 2, 0, 4, 2, 5, 1, 0, 4, 5, 1, 0, 5, 3 }, { 0, 4, 1, 2, 0, 4, 2, 3, 0, 4, 3, 5, 1, 0, 4, 5 }, { 0, 0, 4, 5, 1, 4, 1, 2, 1, 4, 2, 3, 1, 4, 3, 5 }, { 0, 0, 1, 5, 0, 1, 4, 5, 0, 1, 2, 4, 1, 0, 5, 3, 1, 5, 4, 3, 1, 4, 2, 3 }, { 1, 0, 1, 5, 1, 1, 4, 5, 1, 1, 2, 4, 0, 0, 5, 3, 0, 5, 4, 3, 0, 4, 2, 3 }, { 1, 0, 5, 4, 1, 0, 1, 5, 0, 0, 4, 3, 0, 4, 5, 3, 0, 5, 2, 3, 0, 1, 2, 5 } };

    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(IIIIIIIIIIIIIIIIIII)V", line = 76)
    public class170(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13, int arg14, int arg15, int arg16, int arg17, int arg18) {
        ...
        this.field2721 = arg0;
        this.field2713 = arg1;
        this.field2703 = arg17;
        this.field2715 = arg18;
        short var20 = 128;
        int var21 = var20 / 2;
        int var22 = var20 / 4;
        int var23 = var20 * 3 / 4;
        ...
        this.field2722 = new int[var25];
        this.field2714 = new int[var25];
        this.field2708 = new int[var25];
        ...
        for (int var30 = 0; var30 < var25; var30++) {
            ...
            this.field2722[var30] = var32;
            this.field2714[var30] = var34;
            this.field2708[var30] = var33;
            var26[var30] = var35;
            var27[var30] = var36;
        }
        int[] var37 = field2719[arg0];
        int var38 = var37.length / 4;
        this.field2712 = new int[var38];
        this.field2709 = new int[var38];
        this.field2717 = new int[var38];
        this.field2706 = new int[var38];
        this.field2707 = new int[var38];
        this.field2702 = new int[var38];
        if (arg2 != -1) {
            this.field2710 = new int[var38];
        }
        int var39 = 0;
        for (int var40 = 0; var40 < var38; var40++) {
            ...
            this.field2712[var40] = var42;
            this.field2709[var40] = var43;
            this.field2717[var40] = var44;
            if (var41 == 0) {
                this.field2706[var40] = var26[var42];
                this.field2707[var40] = var26[var43];
                this.field2702[var40] = var26[var44];
                if (this.field2710 != null) {
                    this.field2710[var40] = -1;
                }
            } else {
                this.field2706[var40] = var27[var42];
                this.field2707[var40] = var27[var43];
                this.field2702[var40] = var27[var44];
                if (this.field2710 != null) {
                    this.field2710[var40] = arg2;
                }
            }
        }
        int var45 = arg5;
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "()V", line = 15)
