...
public class class170 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IZ)Lue;", line = 29)
    ...
    @OriginalMember(owner = "client!uk", name = "b", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(III)Z", line = 84)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lmk;BIIII)Ltc;", line = 108)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(ZZIII)V", line = 144)
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "(Lmt;ILhh;)V", line = 164)
    public class170(class271 arg0, int arg1, class84 arg2) {
        this.field2549 = arg2;
        this.field2549.method656((byte) 122, 29);
    }

    @OriginalMember(owner = "client!uk", name = "c", descriptor = "(I)V", line = 179)
