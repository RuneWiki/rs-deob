...
public class class170 extends class218 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lql;[IIZII)Lgn;")
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(Lql;IIII[I)V")
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(BIII[BILql;Z)Lgn;")
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(Lql;IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(Lql;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(Lql;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(Lql;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lql;IIIII)Lgn;")
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(Lql;IIIZ[I)V")
