...
public class class170 {
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(ILha;)V", line = 6)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!tba", name = "b", descriptor = "(B)[[[I", line = 50)
    ...
    @OriginalMember(owner = "client!tba", name = "<init>", descriptor = "(III)V", line = 157)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(IB)[[I", line = 86)
