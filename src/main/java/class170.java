...
public class class170 {
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(BLap;I)V")
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(Lap;I)V")
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(Lrk;I)V")
