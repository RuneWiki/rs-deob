...
public class class170 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IIIIILib;Laba;Lqa;IILkca;I)Lr;", line = 40)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Lib;BII)V", line = 192)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(B)V", line = 213)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Lrv;Lbc;ILhf;Lqa;IIILib;Laba;ILkca;)Lr;", line = 226)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(ZZ)V", line = 420)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IBZ[I[II)V", line = 434)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(III)V", line = 460)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(I[Ljs;ILaba;ILkca;Lbc;Lhf;ILow;ZLib;ZLaba;ILqa;IILrv;)Lr;", line = 473)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IIIILgea;IIIIIII)Z", line = 976)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(I)Z", line = 1422)
