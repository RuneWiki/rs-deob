...
public class class170 extends class179 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IIB)I", line = 7)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IIZ)V", line = 26)
    ...
    @OriginalMember(owner = "client!gn", name = "e", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lec;Z)Ljava/lang/String;", line = 60)
    ...
    @OriginalMember(owner = "client!gn", name = "b", descriptor = "(II)V", line = 89)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(I[BII)Z", line = 103)
    ...
    @OriginalMember(owner = "client!gn", name = "f", descriptor = "(I)V", line = 186)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lec;I[I)V", line = 202)
    ...
    @OriginalMember(owner = "client!gn", name = "c", descriptor = "(II)I", line = 230)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(ILec;)V", line = 264)
    ...
    @OriginalMember(owner = "client!gn", name = "e", descriptor = "(B)I", line = 294)
    ...
    @OriginalMember(owner = "client!gn", name = "d", descriptor = "(II)I", line = 315)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IIIIII)V", line = 333)
    ...
    @OriginalMember(owner = "client!gn", name = "g", descriptor = "(I)Ljava/lang/String;", line = 432)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Z)V", line = 460)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lec;II)V", line = 478)
