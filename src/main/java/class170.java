...
public class class170 extends class422 {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(BLnt;)V")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IZLta;FB)V")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lnt;I)V")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lnt;B)V")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lpg;I)V")
