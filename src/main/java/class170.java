...
public class class170 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lbf;ILjava/lang/String;)Lkd;", line = 6)
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(Lbf;II)V", line = 31)
