...
public class class170 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IB)V", line = 5)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(B)I", line = 44)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IIIIIIII)V", line = 61)
    ...
    @OriginalMember(owner = "client!uk", name = "b", descriptor = "(IB)Ldq;", line = 115)
    ...
    @OriginalMember(owner = "client!uk", name = "b", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!uk", name = "c", descriptor = "(I)V", line = 163)
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "(Lrb;ILpc;)V", line = 189)
