...
public class class137 {
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(BD)V", line = 14)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 52)
