...
public class class137 {
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "([BIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!hi", name = "finalize", descriptor = "()V", line = 23)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(JI)V", line = 35)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!hi", name = "b", descriptor = "(I)Ljava/io/File;", line = 63)
    public final File method1012(int arg0) {
        int var2 = -86 % ((arg0 - 16) / 61);
        return this.field2078;
    }

    @OriginalMember(owner = "client!hi", name = "a", descriptor = "([BIBI)I", line = 74)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Z)J", line = 91)
