...
public class class137 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IIIIBZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IB)V", line = 99)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ILdp;)I", line = 125)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(B)V", line = 160)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(II)V", line = 178)
