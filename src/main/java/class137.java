...
public class class137 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!fq", name = "b", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!fq", name = "c", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(IIIIIIIIII)V", line = 88)
