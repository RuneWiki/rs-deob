...
public class class137 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(B)Lrba;", line = 7)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "()V", line = 45)
    public class137() {
    }

    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(I)Lrba;", line = 49)
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "(Lwca;)V", line = 69)
