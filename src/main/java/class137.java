...
public class class137 {
    ...
    @OriginalMember(owner = "client!ju", name = "toString", descriptor = "()Ljava/lang/String;", line = 6)
    public final String toString() {
        field2348++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "(II)V", line = 19)
    public class137(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ILkka;I)V", line = 31)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(III)Z", line = 51)
