...
public class class137 implements Runnable {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(BLoe;)V", line = 3)
    ...
    @OriginalMember(owner = "client!eh", name = "run", descriptor = "()V", line = 25)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(I)V", line = 82)
