...
public class class137 implements Runnable {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!oe", name = "run", descriptor = "()V", line = 81)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Loi;IIIIIZ)V", line = 143)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(B)V", line = 164)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(I[BIB)V", line = 177)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(I)V", line = 221)
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 261)
