...
public class class137 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(B)Loj;", line = 40)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(BII)V", line = 84)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(ZIZII)V", line = 181)
