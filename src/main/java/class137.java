...
public class class137 extends class268 {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IB)V", line = 7)
    public void method883(int arg0, byte arg1) {
        field1560++;
        this.field1556[arg0] = arg1;
    }

    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lil;Lsq;)V", line = 17)
    ...
    @OriginalMember(owner = "client!se", name = "c", descriptor = "(B)V", line = 1142)
    ...
    @OriginalMember(owner = "client!se", name = "<init>", descriptor = "(IIIIIFFF)V", line = 1163)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(BII)V", line = 1186)
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(Z)V", line = 1227)
    ...
    @OriginalMember(owner = "client!se", name = "d", descriptor = "(B)V", line = 1249)
