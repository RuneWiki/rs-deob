...
public class class137 {
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "()V", line = 88)
    public class137() {
        this.field2077.field6389 = this.field2077;
        this.field2077.field6384 = this.field2077;
    }

    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lcf;I)V", line = 35)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(BLoe;)V", line = 55)
    ...
    @OriginalMember(owner = "client!oe", name = "b", descriptor = "(I)Lcf;", line = 67)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Z)V", line = 97)
    ...
    @OriginalMember(owner = "client!oe", name = "b", descriptor = "(Lcf;I)V", line = 111)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Loe;BLcf;)V", line = 128)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(B)I", line = 151)
    ...
    @OriginalMember(owner = "client!oe", name = "c", descriptor = "(I)Lcf;", line = 177)
    ...
    @OriginalMember(owner = "client!oe", name = "b", descriptor = "(B)Lcf;", line = 195)
    ...
    @OriginalMember(owner = "client!oe", name = "b", descriptor = "(Z)Lcf;", line = 216)
    ...
    @OriginalMember(owner = "client!oe", name = "c", descriptor = "(B)Lcf;", line = 239)
    ...
    @OriginalMember(owner = "client!oe", name = "d", descriptor = "(B)Z", line = 271)
