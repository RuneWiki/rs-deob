...
public class class137 extends class135 {
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(Lad;Lvo;)V")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(II)Lvfa;")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Laj;II)V")
