...
public class class137 extends class688 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Loa;J)V")
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Lul;IIIIIIIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Lul;IIIIIIIIIIIZZ)V")
