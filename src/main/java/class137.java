...
public class class137 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(B)J", line = 49)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Z)V", line = 60)
