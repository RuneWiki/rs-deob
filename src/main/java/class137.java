...
public class class137 extends class98 {
    ...
    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(III)Lmj;", line = 7)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IB[IJ)Ljava/lang/String;", line = 17)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "()V", line = 40)
    public class137() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(II)[I", line = 43)
