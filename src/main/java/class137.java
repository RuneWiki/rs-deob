...
public class class137 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lbt;BILjava/lang/String;)Lj;", line = 19)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IBLjava/lang/Object;I)[B", line = 59)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(BJ)Lpg;", line = 92)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(BJLpg;)V", line = 117)
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(I)V", line = 162)
