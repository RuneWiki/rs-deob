...
public class class137 extends class388 {
    ...
    @OriginalMember(owner = "client!pk", name = "c", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "(Lsfa;)V", line = 19)
    public class137(class124 arg0) {
        this.field1879 = arg0;
    }

    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IIILkw;II)Lof;", line = 28)
