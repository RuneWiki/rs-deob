...
public class class137 extends class264 {
    ...
    @OriginalMember(owner = "client!qea", name = "b", descriptor = "(II)I")
    ...
    @OriginalMember(owner = "client!qea", name = "b", descriptor = "(BI)V")
    ...
    @OriginalMember(owner = "client!qea", name = "<init>", descriptor = "(ILmfa;)V")
    public class137(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(BI)I")
    ...
    @OriginalMember(owner = "client!qea", name = "<init>", descriptor = "(Lmfa;)V")
