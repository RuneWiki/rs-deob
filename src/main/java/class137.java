...
public class class137 implements Runnable {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(IIBLjava/lang/Object;I)Ltc;")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ILjava/lang/String;I)Ltc;")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Ljava/lang/String;B)Ltc;")
    public final class236 method830(String arg0, byte arg1) {
        return arg1 == 58 ? this.method828(0, 0, (byte) -101, arg0, 21) : null;
    }

    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Ljava/lang/Class;I)Ltc;")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ILjava/net/URL;)Ltc;")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Ljava/lang/Object;ZIII)Ltc;")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ILjava/lang/String;[Ljava/lang/Class;Ljava/lang/Class;)Ltc;")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Ljava/lang/Class;BLjava/lang/String;)Ltc;")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Ljava/awt/Frame;I)Ltc;")
    public final class236 method837(Frame arg0, int arg1) {
        return arg1 == 7 ? this.method828(0, 0, (byte) -106, arg0, 7) : null;
    }

    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Ljava/lang/Runnable;IB)Ltc;")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Ljava/awt/Point;[IILjava/awt/Component;II)Ltc;")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(IIIII)Ltc;")
    ...
    @OriginalMember(owner = "client!fq", name = "b", descriptor = "(I)Ltc;")
    public final class236 method845(int arg0) {
        return arg0 >= -87 ? null : this.method828(0, 0, (byte) -114, null, 5);
    }

    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(B)Ltc;")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(BLjava/lang/Class;)Ltc;")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;I)Ltc;")
    public final class236 method849(Transferable arg0, int arg1) {
        return arg1 == 19 ? this.method828(0, 0, (byte) -124, arg0, 19) : null;
    }

    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Ljava/lang/String;ZZ)Ltc;")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(IIILjava/awt/Component;)Ltc;")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ZI)Ltc;")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(BLjava/lang/String;)Ltc;")
    public final class236 method854(byte arg0, String arg1) {
        int var3 = -72 % ((-arg0 - 46) / 54);
        return this.method828(0, 0, (byte) -127, arg1, 16);
    }

    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ZLjava/awt/Component;Z)Ltc;")
    ...
    @OriginalMember(owner = "client!fq", name = "c", descriptor = "(I)Lee;")
