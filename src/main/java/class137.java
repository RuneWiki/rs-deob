...
public abstract class class137 extends class488 {
    ...
    @OriginalMember(owner = "client!lca", name = "h", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "([Lgga;I)I", line = 14)
    ...
    @OriginalMember(owner = "client!lca", name = "f", descriptor = "(B)Z", line = 24)
    ...
    @OriginalMember(owner = "client!lca", name = "f", descriptor = "(I)Z", line = 35)
    ...
    @OriginalMember(owner = "client!lca", name = "d", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(II)V", line = 57)
    ...
    @OriginalMember(owner = "client!lca", name = "h", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(ZIBLr;Llo;II)V", line = 98)
    ...
    @OriginalMember(owner = "client!lca", name = "<init>", descriptor = "(IIIIIII)V", line = 111)
