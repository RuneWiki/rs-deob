...
public class class137 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(ILjava/lang/String;Lhf;I)Luu;")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(BI)Lin;")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(ILqh;II)V")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Lcm;IZLlt;Llt;)V")
