...
public class class137 extends class29 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IILat;)V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(III)Lcl;")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lat;I)V")
