...
public class class137 {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "Llf;")
    public static class109 field2643 = class35.method275("scape main", 2);

    @OriginalMember(owner = "client!og", name = "h", descriptor = "Llf;")
    private static class109 field2650 = class35.method275("Click to switch", 2);

    @OriginalMember(owner = "client!og", name = "g", descriptor = "Llf;")
    public static class109 field2649 = field2650;

    @OriginalMember(owner = "client!og", name = "o", descriptor = "Llf;")
    public static class109 field2657 = class35.method275("(U0a )2 via: ", 2);

    @OriginalMember(owner = "client!og", name = "p", descriptor = "Llf;")
    private static class109 field2658 = class35.method275("yellow:", 2);

    @OriginalMember(owner = "client!og", name = "l", descriptor = "Llf;")
    public static class109 field2654 = field2658;

    @OriginalMember(owner = "client!og", name = "m", descriptor = "Llf;")
    public static class109 field2655 = class35.method275("rect_debug=", 2);

    @OriginalMember(owner = "client!og", name = "c", descriptor = "[Lef;")
    public static class47[] field2645 = new class47[50];

    @OriginalMember(owner = "client!og", name = "b", descriptor = "Llf;")
    private static class109 field2644 = class35.method275("Please wait)3)3)3", 2);

    @OriginalMember(owner = "client!og", name = "i", descriptor = "Llf;")
    public static class109 field2651 = field2644;

    @OriginalMember(owner = "client!og", name = "q", descriptor = "Llf;")
    public static class109 field2659 = field2658;

    @OriginalMember(owner = "client!og", name = "j", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!og", name = "n", descriptor = "Lbg;")
    public static class18 field2656;

    @OriginalMember(owner = "client!og", name = "k", descriptor = "[Lkf;")
