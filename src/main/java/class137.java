...
public class class137 extends class324 {
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(I)Z", line = 5)
    public final boolean method939(int arg0) {
        return arg0 == 8519;
    }

    @OriginalMember(owner = "client!qea", name = "d", descriptor = "(I)Ljava/lang/Object;", line = 16)
    ...
    @OriginalMember(owner = "client!qea", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 25)
