...
public class class137 extends class247 {
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "()Lbi;", line = 6)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(B)[F", line = 27)
    ...
    @OriginalMember(owner = "client!bi", name = "e", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lib;)V", line = 78)
    ...
    @OriginalMember(owner = "client!bi", name = "f", descriptor = "(I)[F", line = 102)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(III)V", line = 124)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!bi", name = "c", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(III[I)V", line = 173)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "()V", line = 182)
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(III)V", line = 190)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lib;I)V", line = 205)
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(I)V", line = 227)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IIIIII)V", line = 254)
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "()V", line = 286)
    public class137() {
        this.method746();
    }

    @OriginalMember(owner = "client!bi", name = "d", descriptor = "(I)V", line = 298)
