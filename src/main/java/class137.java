...
public abstract class class137 implements class316 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Ljaggl/MapBuffer;B)Z")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lsl;Z)Lfga;")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ILjaclib/memory/Source;Z)Z")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ZLjaggl/MapBuffer;B)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!mc", name = "<init>", descriptor = "(Ltk;IZ)V")
