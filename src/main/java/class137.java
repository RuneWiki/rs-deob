...
public class class137 extends class446 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(II)V", line = 3)
    public final synchronized void method852(int arg0, int arg1) {
        this.method861(arg0, arg1, this.method885());
    }

    @OriginalMember(owner = "client!od", name = "d", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "([B[IIIIIIILod;)I", line = 55)
    ...
    @OriginalMember(owner = "client!od", name = "e", descriptor = "()Z", line = 81)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lig;II)Lod;", line = 166)
    ...
    @OriginalMember(owner = "client!od", name = "f", descriptor = "()Z", line = 172)
    public final boolean method857() {
        return this.field1891 != 0;
    }

    @OriginalMember(owner = "client!od", name = "a", descriptor = "(I[B[IIIIIIIIIILod;)I", line = 175)
    ...
    @OriginalMember(owner = "client!od", name = "e", descriptor = "(I)V", line = 228)
    private final synchronized void method859(int arg0) {
        this.method872(arg0, this.method885());
    }

    @OriginalMember(owner = "client!od", name = "b", descriptor = "([B[IIIIIIILod;)I", line = 232)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(III)V", line = 260)
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(II)I", line = 307)
    private static final int method862(int arg0, int arg1) {
        return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
    }

    @OriginalMember(owner = "client!od", name = "f", descriptor = "(I)V", line = 310)
    public final synchronized void method863(int arg0) {
        this.method872(arg0 << 6, this.method885());
    }

    @OriginalMember(owner = "client!od", name = "b", descriptor = "(I[B[IIIIIIIIIILod;)I", line = 314)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Z)V", line = 369)
    ...
    @OriginalMember(owner = "client!od", name = "d", descriptor = "()I", line = 375)
    public final int method490() {
        return this.field1897 == 0 && this.field1891 == 0 ? 0 : 1;
    }

    @OriginalMember(owner = "client!od", name = "g", descriptor = "()I", line = 381)
    public final synchronized int method866() {
        return this.field1897 == Integer.MIN_VALUE ? 0 : this.field1897;
    }

    @OriginalMember(owner = "client!od", name = "a", descriptor = "(II[B[IIIIIIIIIILod;II)I", line = 384)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "([B[IIIIIIIILod;)I", line = 427)
    ...
    @OriginalMember(owner = "client!od", name = "g", descriptor = "(I)V", line = 462)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(II[B[IIIIIIIILod;II)I", line = 472)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(II[B[IIIIIIILod;II)I", line = 505)
    ...
    @OriginalMember(owner = "client!od", name = "c", descriptor = "(II)V", line = 531)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "([IIIII)I", line = 537)
    ...
    @OriginalMember(owner = "client!od", name = "h", descriptor = "()V", line = 592)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "()I", line = 604)
    ...
    @OriginalMember(owner = "client!od", name = "i", descriptor = "()Z", line = 620)
    public final boolean method876() {
        return this.field1896 < 0 || this.field1896 >= ((class13) super.field6542).field209.length << 8;
    }

    @OriginalMember(owner = "client!od", name = "c", descriptor = "()Lpl;", line = 623)
    public final class446 method501() {
        return null;
    }

    @OriginalMember(owner = "client!od", name = "a", descriptor = "(I[B[IIIIIIIILod;)I", line = 627)
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "([III)V", line = 665)
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "([IIIII)I", line = 901)
    ...
    @OriginalMember(owner = "client!od", name = "h", descriptor = "(I)V", line = 957)
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(II[B[IIIIIIIILod;II)I", line = 964)
    ...
    @OriginalMember(owner = "client!od", name = "j", descriptor = "()I", line = 997)
    public final synchronized int method881() {
        return this.field1900 < 0 ? -this.field1900 : this.field1900;
    }

    @OriginalMember(owner = "client!od", name = "c", descriptor = "(I)V", line = 1000)
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(II[B[IIIIIIILod;II)I", line = 1218)
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "([B[IIIIIIIILod;)I", line = 1244)
    ...
    @OriginalMember(owner = "client!od", name = "c", descriptor = "(II[B[IIIIIIIILod;II)I", line = 1281)
    ...
    @OriginalMember(owner = "client!od", name = "k", descriptor = "()I", line = 1317)
    public final synchronized int method885() {
        return this.field1889 < 0 ? -1 : this.field1889;
    }

    @OriginalMember(owner = "client!od", name = "b", descriptor = "(II[B[IIIIIIIIIILod;II)I", line = 1320)
    ...
    @OriginalMember(owner = "client!od", name = "i", descriptor = "(I)V", line = 1361)
    public final synchronized void method887(int arg0) {
        this.field1898 = arg0;
    }

    @OriginalMember(owner = "client!od", name = "l", descriptor = "()V", line = 1364)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lig;III)Lod;", line = 1373)
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "()Lpl;", line = 1381)
    public final class446 method469() {
        return null;
    }

    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(Lig;II)V", line = 1383)
    ...
    @OriginalMember(owner = "client!od", name = "d", descriptor = "(II[B[IIIIIIIILod;II)I", line = 1395)
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(I[B[IIIIIIIILod;)I", line = 1428)
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(Lig;III)V", line = 1465)
    ...
    @OriginalMember(owner = "client!od", name = "d", descriptor = "(II)I", line = 1477)
