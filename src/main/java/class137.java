...
public class class137 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "([BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "(Lnv;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "(Lnv;Ljaclib/memory/Buffer;)V", line = 21)
