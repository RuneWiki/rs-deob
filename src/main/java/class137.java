...
public class class137 extends class193 {
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Z)Z", line = 19)
    ...
    @OriginalMember(owner = "client!oc", name = "c", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(ZZ)V", line = 55)
    ...
    @OriginalMember(owner = "client!oc", name = "d", descriptor = "(B)Z", line = 86)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(ZZ)V", line = 124)
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(Z)V", line = 135)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Lsq;II)V", line = 151)
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(Lug;)V", line = 167)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IIZ)V", line = 185)
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(I)Llf;", line = 195)
