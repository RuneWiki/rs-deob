...
public class class137 extends class601 {
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "()V", line = 33)
    public class137() {
        super(0, true);
    }

    @OriginalMember(owner = "client!um", name = "c", descriptor = "(II)V", line = 37)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IB)[I", line = 50)
    ...
    @OriginalMember(owner = "client!um", name = "d", descriptor = "(B)V", line = 195)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Lmc;II)V", line = 206)
