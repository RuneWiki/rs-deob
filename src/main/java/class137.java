...
public class class137 extends class381 {
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(Lmv;II)Lpda;")
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(Lmv;)Z")
    ...
    @OriginalMember(owner = "client!pda", name = "d", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "([I)Lwm;")
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(Lmv;I)Lpda;")
    ...
    @OriginalMember(owner = "client!pda", name = "<init>", descriptor = "([B)V")
