...
public abstract class class137 {
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(IZIZ)Ljava/lang/String;", line = 482)
    ...
    @OriginalMember(owner = "client!d", name = "<init>", descriptor = "(III)V", line = 532)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(I)V", line = 564)
