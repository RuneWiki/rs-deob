...
public class class137 extends class187 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ILoj;II)Z")
    ...
    @OriginalMember(owner = "client!qo", name = "d", descriptor = "(ILoj;)V")
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IIZLa;IBLoj;)V")
    ...
    @OriginalMember(owner = "client!qo", name = "c", descriptor = "(ILoj;)Lmg;")
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(BLqs;)V")
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IILoj;)Z")
