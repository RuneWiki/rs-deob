...
public class class137 implements class613 {
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(Ltb;Z)V")
    public class137(class364 arg0, boolean arg1) {
        this.field2004 = arg0;
        this.field2002 = arg1;
    }

    @OriginalMember(owner = "client!as", name = "a", descriptor = "(IIILjaclib/memory/Source;)Z")
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;")
