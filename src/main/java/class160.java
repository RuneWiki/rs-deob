...
public class class160 {
    ...
    @OriginalMember(owner = "client!c", name = "c", descriptor = "(I)Ls;", line = 40)
    ...
    @OriginalMember(owner = "client!c", name = "d", descriptor = "(I)Ls;", line = 69)
    ...
    @OriginalMember(owner = "client!c", name = "<init>", descriptor = "(Laj;)V", line = 94)
