...
public class class160 extends class34 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(BI)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IB)[I", line = 69)
    ...
    @OriginalMember(owner = "client!qg", name = "e", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Lsv;II)V", line = 119)
    ...
    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "()V", line = 174)
    public class160() {
        super(1, false);
    }
}
