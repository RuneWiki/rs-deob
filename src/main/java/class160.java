...
public class class160 {
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(ILhea;I[II[I)Lpl;", line = 4)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(ZI)I", line = 83)
