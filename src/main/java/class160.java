...
public class class160 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ZLei;)V", line = 22)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "()V", line = 34)
    public void method1151() throws Exception {
        field2405++;
    }

    @OriginalMember(owner = "client!ig", name = "c", descriptor = "()I", line = 41)
    public int method1152() throws Exception {
        field2415++;
        return this.field2421;
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Z)V", line = 55)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;ILjava/lang/String;Ljava/lang/String;I)V", line = 175)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "([II)V", line = 210)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(I)V", line = 373)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ZI)V", line = 392)
    ...
    @OriginalMember(owner = "client!ig", name = "d", descriptor = "()V", line = 412)
    public void method1158() throws Exception {
        field2428++;
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(B)V", line = 423)
    ...
    @OriginalMember(owner = "client!ig", name = "c", descriptor = "(I)V", line = 444)
    ...
    @OriginalMember(owner = "client!ig", name = "d", descriptor = "(I)V", line = 488)
    public void method1161(int arg0) throws Exception {
        field2402++;
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IIIIIZ)V", line = 495)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 548)
    public void method1163(Component arg0) throws Exception {
        field2399++;
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IILei;)V", line = 561)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(B)V", line = 582)
