...
public class class160 extends class136 {
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(I)V", line = 3)
    private class160(int arg0) {
        super(0, false);
        this.method1133(arg0, (byte) -88);
    }

    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lcw;I)V", line = 12)
    ...
    @OriginalMember(owner = "client!bj", name = "c", descriptor = "(B)V", line = 213)
    public static void method1131(byte arg0) {
        int var1 = -122 % ((-7 - arg0) / 42);
        field2254 = null;
    }

    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IFIIZI[FIII)V", line = 224)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IILiv;)V", line = 275)
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "()V", line = 306)
    public class160() {
        this(0);
    }

    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(BI)[[I", line = 313)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IB)V", line = 357)
