...
public class class160 extends class336 implements class416 {
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IILn;Z)Z", line = 4)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(ILn;)V", line = 8)
    ...
    @OriginalMember(owner = "client!fa", name = "c", descriptor = "()Z", line = 73)
    public final boolean method1141() {
        return true;
    }

    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Ln;Lwc;I)V", line = 76)
    ...
    @OriginalMember(owner = "client!fa", name = "d", descriptor = "()[Ltb;", line = 94)
    public final class280[] method1144() {
        return this.field2450;
    }

    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IIII)V", line = 98)
    public final void method1146(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!fa", name = "finalize", descriptor = "()V", line = 112)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Ln;Lwc;II)V", line = 117)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(BIZ)Lka;", line = 133)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lka;IIIZ)V", line = 138)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "()V", line = 144)
    public final void method1162() {
    }

    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "(Lc;Lk;Lch;IIII)V", line = 149)
    ...
    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "(Lc;)V", line = 220)
    ...
    @OriginalMember(owner = "client!fa", name = "b", descriptor = "()[Leh;", line = 234)
