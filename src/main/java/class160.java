...
public class class160 extends class66 {
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(Lie;Z)Lrh;")
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(Lri;Lr;B)V")
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(IIII)I")
