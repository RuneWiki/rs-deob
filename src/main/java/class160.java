...
public class class160 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(JB)V", line = 27)
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(I)V", line = 112)
