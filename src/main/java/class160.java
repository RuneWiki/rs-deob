...
public class class160 extends class232 {
    ...
    @OriginalMember(owner = "client!vf", name = "c", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(III)V", line = 44)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(ZB)V", line = 67)
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "(Lki;Lcb;Llo;)V", line = 84)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(ILdr;I)V", line = 102)
    ...
    @OriginalMember(owner = "client!vf", name = "c", descriptor = "(B)V", line = 140)
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(B)V", line = 157)
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(I)V", line = 171)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(ZI)V", line = 201)
    ...
    @OriginalMember(owner = "client!vf", name = "e", descriptor = "(I)Z", line = 211)
