...
public class class160 extends class228 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(IF)V", line = 5)
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(I)V", line = 19)
    public class160(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(FB)V", line = 24)
