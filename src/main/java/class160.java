...
public class class160 implements class666 {
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(IB)Z", line = 6)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!tba", name = "<init>", descriptor = "(II)V", line = 34)
