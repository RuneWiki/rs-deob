...
public class class160 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Lha;B)Lit;", line = 4)
    ...
    @OriginalMember(owner = "client!ij", name = "b", descriptor = "(Lha;B)Lit;", line = 26)
    ...
    @OriginalMember(owner = "client!ij", name = "c", descriptor = "(Lha;B)Lit;", line = 73)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Lha;I)Lit;", line = 99)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Lofa;Z)V", line = 122)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ZILofa;)V", line = 144)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(II)Ljava/lang/String;", line = 216)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IB)V", line = 252)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ILha;)V", line = 284)
