...
public class class160 extends class468 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lmq;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(Z)V", line = 30)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(I)Lmt;", line = 46)
