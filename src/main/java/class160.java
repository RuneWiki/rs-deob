...
public class class160 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "()V", line = 22)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Z)V", line = 247)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(B)V", line = 265)
