...
public class class160 extends class161 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(FI)V", line = 6)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(I)V", line = 19)
    public class160(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(BF)V", line = 23)
