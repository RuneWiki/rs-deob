...
public class class160 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IIIBI)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(I)[Lsb;", line = 51)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!ei", name = "c", descriptor = "(I)Z", line = 168)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(B)V", line = 180)
    ...
    @OriginalMember(owner = "client!ei", name = "d", descriptor = "(I)V", line = 211)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Luk;B)Z", line = 270)
    ...
    @OriginalMember(owner = "client!ei", name = "e", descriptor = "(I)Z", line = 305)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(ILuk;)V", line = 446)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(Lkga;)V", line = 1329)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IIILn;)V", line = 470)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(III)Z", line = 542)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IIIII[Ln;IIII)V", line = 554)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Z)V", line = 1275)
