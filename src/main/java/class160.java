...
public class class160 extends class12 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(III[B)V", line = 26)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(II[FII[FFIFIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(II[BI)I", line = 91)
    ...
    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 103)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(III)Z", line = 116)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Z)V", line = 127)
    ...
    @OriginalMember(owner = "client!uq", name = "b", descriptor = "(Z)V", line = 142)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(II)Z", line = 154)
    ...
    @OriginalMember(owner = "client!uq", name = "b", descriptor = "(I)V", line = 166)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 371)
    ...
    @OriginalMember(owner = "client!uq", name = "finalize", descriptor = "()V", line = 403)
