...
public class class160 {
    ...
    @OriginalMember(owner = "client!rc", name = "c", descriptor = "Lph;")
    private class147 field2994 = new class147();

    @OriginalMember(owner = "client!rc", name = "t", descriptor = "Ll;")
    ...
    @OriginalMember(owner = "client!rc", name = "r", descriptor = "Leh;")
    private class49 field3009;

    @OriginalMember(owner = "client!rc", name = "f", descriptor = "Llf;")
    public static class109 field2997 = class35.method275("Passwort: ", 2);

    @OriginalMember(owner = "client!rc", name = "d", descriptor = "Llf;")
    private static class109 field2995 = class35.method275("Service unavailable)3", 2);

    @OriginalMember(owner = "client!rc", name = "h", descriptor = "Llf;")
    public static class109 field2999 = class35.method275("(U0a )2 in: ", 2);

    @OriginalMember(owner = "client!rc", name = "k", descriptor = "I")
    public static int field3002 = 0;

    @OriginalMember(owner = "client!rc", name = "g", descriptor = "Llf;")
    public static class109 field2998 = field2995;

    @OriginalMember(owner = "client!rc", name = "u", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!rc", name = "l", descriptor = "Lkf;")
    public static class100 field3003;

    @OriginalMember(owner = "client!rc", name = "a", descriptor = "[I")
    public static int[] field2992;

    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(JILph;)V")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(I)Lhb;")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(JI)Lph;")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(B)Lhb;")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lvg;I)Lvg;")
