...
public class class160 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Lha;[II)V")
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Lha;[IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Lha;[II[I[I)V")
