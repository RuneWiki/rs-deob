...
public class class160 extends class331 {
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(B)I", line = 32)
    ...
    @OriginalMember(owner = "client!bs", name = "d", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(I)V", line = 434)
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "(Lts;)V", line = 463)
    public class160(class41 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "(ILts;)V", line = 468)
    public class160(int arg0, class41 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!bs", name = "c", descriptor = "(II)V", line = 472)
    ...
    @OriginalMember(owner = "client!bs", name = "c", descriptor = "(I)[Lan;", line = 483)
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(II)I", line = 495)
    ...
    @OriginalMember(owner = "client!bs", name = "e", descriptor = "(B)I", line = 507)
