...
public class class160 extends class384 implements class33 {
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(I)Lwq;", line = 7)
    public final class674 method176(int arg0) {
        ++field2302;
        return arg0 != 29119 ? null : this.field2294;
    }

    @OriginalMember(owner = "client!se", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IB)V", line = 28)
    public final void method174(int arg0, byte arg1) {
        ++field2306;
        super.method174(this.field2294.field9586 * arg0, arg1);
    }

    @OriginalMember(owner = "client!se", name = "<init>", descriptor = "(Lmba;Lwq;Z)V", line = 39)
    public class160(class643 arg0, class674 arg1, boolean arg2) {
        super(arg0, 34963, arg2);
        this.field2294 = arg1;
    }

    @OriginalMember(owner = "client!se", name = "a", descriptor = "(CB)C", line = 52)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;", line = 83)
    ...
    @OriginalMember(owner = "client!se", name = "f", descriptor = "(I)Z", line = 100)
    public static final boolean method1138(int arg0) {
        ++field2298;
        return arg0 <= class369.field5392;
    }

    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Z)I", line = 114)
    ...
    @OriginalMember(owner = "client!se", name = "d", descriptor = "(B)V", line = 136)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(B)Z", line = 149)
