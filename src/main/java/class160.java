...
public class class160 extends class398 {
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Lr;B)V")
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "(Luca;)V")
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(ILvaa;B)V")
