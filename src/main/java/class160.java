...
public class class160 {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIIZ)Lg;", line = 25)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Ljava/lang/String;B)Ljava/lang/String;", line = 64)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ZBILij;Lij;)V", line = 116)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(BII)I", line = 134)
