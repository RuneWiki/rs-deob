...
public class class160 extends class383 {
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ILwg;[I[I[I)V", line = 5)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(B)V", line = 115)
    ...
    @OriginalMember(owner = "client!dt", name = "b", descriptor = "(B)Lbh;", line = 196)
    ...
    @OriginalMember(owner = "client!dt", name = "<init>", descriptor = "(I)V", line = 400)
    public class160(int arg0) {
        this.field2035 = arg0;
    }

    @OriginalMember(owner = "client!dt", name = "a", descriptor = "([IIIIIIBLis;IZIII[II)I", line = 219)
