...
public class class160 extends class363 {
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(ILji;)Lre;", line = 11)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(III)V", line = 25)
    ...
    @OriginalMember(owner = "client!cda", name = "d", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!cda", name = "<init>", descriptor = "([B)V", line = 58)
