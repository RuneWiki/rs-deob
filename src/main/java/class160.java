...
public class class160 extends class340 {
    ...
    @OriginalMember(owner = "client!aq", name = "j", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!aq", name = "finalize", descriptor = "()V", line = 20)
    ...
    @OriginalMember(owner = "client!aq", name = "b", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!aq", name = "b", descriptor = "(ILha;)Llca;", line = 45)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(II)V", line = 56)
    ...
    @OriginalMember(owner = "client!aq", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 92)
    ...
    @OriginalMember(owner = "client!aq", name = "f", descriptor = "(I)I", line = 117)
    ...
    @OriginalMember(owner = "client!aq", name = "c", descriptor = "(I)Z", line = 130)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(ZLha;Lrr;IIII)V", line = 140)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Lha;Ldfa;Lka;B)V", line = 151)
    ...
    @OriginalMember(owner = "client!aq", name = "g", descriptor = "(I)Z", line = 182)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Lha;I)V", line = 196)
    ...
    @OriginalMember(owner = "client!aq", name = "h", descriptor = "(I)Z", line = 221)
    ...
    @OriginalMember(owner = "client!aq", name = "e", descriptor = "(Z)I", line = 246)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Lha;III)Lka;", line = 264)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(BLha;)Llba;", line = 282)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IILha;I)Z", line = 331)
