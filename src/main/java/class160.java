...
public class class160 extends class161 {
    ...
    @OriginalMember(owner = "client!tr", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IIIIIII)V", line = 61)
    ...
    @OriginalMember(owner = "client!tr", name = "<init>", descriptor = "()V", line = 87)
    public class160() {
    }

    @OriginalMember(owner = "client!tr", name = "<init>", descriptor = "(I)V", line = 93)
    public class160(int arg0) {
        this.field2527 = arg0;
    }

    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(Z)V", line = 101)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(III)Laq;", line = 112)
