...
public class class160 {
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(Lrd;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(Lwea;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(II)V", line = 47)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(I)I", line = 113)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(Ljava/lang/Object;IILwea;)V", line = 129)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(BLwea;)Ljava/lang/Object;", line = 159)
    ...
    @OriginalMember(owner = "client!dca", name = "b", descriptor = "(I)V", line = 213)
    ...
    @OriginalMember(owner = "client!dca", name = "<init>", descriptor = "(I)V", line = 270)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(Ljava/lang/Object;BLwea;)V", line = 242)
    ...
    @OriginalMember(owner = "client!dca", name = "c", descriptor = "(I)I", line = 259)
