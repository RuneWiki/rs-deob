...
public class class160 extends class5 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!io", name = "i", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IZ)[[I", line = 39)
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(B)I", line = 110)
    ...
    @OriginalMember(owner = "client!io", name = "j", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IBI)V", line = 171)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(I)V", line = 191)
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "()V", line = 203)
    public class160() {
        super(0, false);
    }

    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ILes;I)V", line = 206)
