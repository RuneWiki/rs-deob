...
public class class628 extends class634 {
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(Loh;II)Lqf;", line = 5)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 22)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(Z)V", line = 60)
    ...
    @OriginalMember(owner = "client!pda", name = "<init>", descriptor = "()V", line = 71)
    public class628() {
        this(0);
    }

    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(BI)[[I", line = 75)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(ILig;Z)V", line = 113)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(CI)B", line = 140)
    ...
    @OriginalMember(owner = "client!pda", name = "b", descriptor = "(III)Ljb;", line = 267)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(IB)V", line = 277)
    ...
    @OriginalMember(owner = "client!pda", name = "<init>", descriptor = "(I)V", line = 292)
