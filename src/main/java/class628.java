...
public class class628 extends class675 {
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(ILha;)Lww;")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(ILha;II)Lka;")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(ZLha;Lofa;Lka;)V")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Lkf;Lha;IIIZI)V")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Lha;IIB)Z")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(BLha;)Lck;")
