...
public class class628 {
    ...
    @OriginalMember(owner = "client!pc", name = "c", descriptor = "(I)Lpga;")
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IILeh;)V")
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Leh;Z)V")
