...
public class class628 {
    ...
    @OriginalMember(owner = "client!tq", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V")
    ...
    @OriginalMember(owner = "client!tq", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V")
    ...
    @OriginalMember(owner = "client!tq", name = "movemouse", descriptor = "(II)V")
