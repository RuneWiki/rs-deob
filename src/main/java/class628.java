...
public class class628 extends class3 {
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(ZB)V", line = 6)
    ...
    @OriginalMember(owner = "client!kaa", name = "c", descriptor = "(I)I", line = 78)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(B)[B", line = 94)
    ...
    @OriginalMember(owner = "client!kaa", name = "h", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!kaa", name = "e", descriptor = "(B)V", line = 163)
