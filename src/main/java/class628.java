...
public class class628 extends class333 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Llb;IIIIZLea;IILr;)Lda;")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIIIIIILr;I)V")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lfa;ILjava/awt/Canvas;)Lr;")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
