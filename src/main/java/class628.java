...
public class class628 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Z)Lu;")
    ...
    @OriginalMember(owner = "client!ee", name = "c", descriptor = "(I)Lu;")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(BLor;)V")
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(Lor;)V")
