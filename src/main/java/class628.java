...
public class class628 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IBI)V", line = 7)
    ...
    @OriginalMember(owner = "client!sn", name = "toString", descriptor = "()Ljava/lang/String;", line = 21)
    public final String toString() {
        field9026++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(I)Z", line = 43)
