...
public class class628 extends class74 {
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Lgaa;Lpl;)V", line = 3)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(I)Z", line = 31)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(ZZ)V", line = 41)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IILhfa;)V", line = 53)
    ...
    @OriginalMember(owner = "client!hf", name = "e", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!hf", name = "c", descriptor = "(B)V", line = 140)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IIB)V", line = 159)
    ...
    @OriginalMember(owner = "client!hf", name = "f", descriptor = "(I)V", line = 168)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Z)V", line = 192)
    ...
    @OriginalMember(owner = "client!hf", name = "d", descriptor = "(I)V", line = 211)
    ...
    @OriginalMember(owner = "client!hf", name = "c", descriptor = "(I)V", line = 236)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IZ)V", line = 256)
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(I)V", line = 272)
