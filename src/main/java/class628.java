...
public class class628 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(ZII[[ZII)V", line = 18)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(BLr;II)V", line = 220)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IIIII)V", line = 292)
    ...
    @OriginalMember(owner = "client!oo", name = "b", descriptor = "(I)V", line = 337)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(ILr;II)V", line = 372)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Lr;III)Z", line = 445)
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "(Lij;Llp;)V", line = 522)
