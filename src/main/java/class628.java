...
public class class628 extends class402 {
    ...
    @OriginalMember(owner = "client!im", name = "fa", descriptor = "(CIIIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(CIIIZLaa;II)V", line = 28)
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(Ldw;Lej;[Loia;Z)V", line = 73)
