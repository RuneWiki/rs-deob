...
public class class628 extends class378 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "()Leh;")
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(ILrv;)Lfq;")
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Leh;)V")
