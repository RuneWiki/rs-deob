...
public class class628 extends class67 {
    ...
    @OriginalMember(owner = "client!re", name = "fa", descriptor = "(CIIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(CIIIZLaa;II)V", line = 28)
    public final void method225(char arg0, int arg1, int arg2, int arg3, boolean arg4, class513 arg5, int arg6, int arg7) {
    }

    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "(Lwg;Lbq;[Lcr;Z)V", line = 33)
