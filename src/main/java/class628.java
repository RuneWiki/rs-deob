...
public class class628 {
    ...
    @OriginalMember(owner = "client!qs", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "()V", line = 34)
    public class628() throws Exception {
    }

    @OriginalMember(owner = "client!qs", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V", line = 43)
    ...
    @OriginalMember(owner = "client!qs", name = "movemouse", descriptor = "(II)V", line = 59)
