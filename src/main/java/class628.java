...
public class class628 extends class647 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(ZIB)V", line = 8)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIII)[B", line = 24)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(BLaj;)V", line = 40)
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "()V", line = 50)
    public class628() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!re", name = "g", descriptor = "(I)V", line = 57)
