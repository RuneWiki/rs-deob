...
public class class628 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "Ljava/awt/Robot;")
    private Robot field8772 = new Robot();

    @OriginalMember(owner = "client!tq", name = "b", descriptor = "Ljava/awt/Component;")
    private Component field8773;

    @OriginalMember(owner = "client!tq", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V", line = 7)
    ...
    @OriginalMember(owner = "client!tq", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V", line = 23)
    public final void showcursor(Component arg0, boolean arg1) {
        ...
        if (this.field8773 == arg0) {
            return;
        }
        if (this.field8773 != null) {
            this.field8773.setCursor(null);
            this.field8773 = null;
        }
        if (arg0 != null) {
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "()V", line = 50)
    public class628() throws Exception {
    }

    @OriginalMember(owner = "client!tq", name = "movemouse", descriptor = "(II)V", line = 59)
    public final void movemouse(int arg0, int arg1) {
        this.field8772.mouseMove(arg0, arg1);
    }
}
