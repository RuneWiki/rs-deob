...
public class class628 implements class366 {
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(III)Z", line = 15)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ILjaclib/memory/Source;II)Z", line = 53)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(I)I", line = 70)
    public final int method1292(int arg0) {
        return arg0 == 128 ? this.field8781 : -102;
    }

    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;", line = 84)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Z)V", line = 107)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(B)Z", line = 126)
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Lfi;Z)V", line = 149)
