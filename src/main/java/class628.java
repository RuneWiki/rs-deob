...
public class class628 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lr;IBI)V")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IIILr;)V")
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(Lep;Ldn;)V")
