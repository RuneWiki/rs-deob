...
public class class628 {
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(IZIII)Lbfa;")
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Lfca;ZII)V")
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(ZLjava/awt/Component;B)Ljs;")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
