...
public class class628 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(B[III)Lnga;", line = 17)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Ljava/awt/Canvas;ILd;Lwm;I)Lha;", line = 55)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(II[IB)Lnga;", line = 84)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(II[I)Lnga;", line = 135)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IILha;)Lne;", line = 155)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "([III)Lnga;", line = 195)
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(Lwm;Lwm;)V", line = 221)
