...
public class class628 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(IIILjava/lang/String;IIII)V", line = 163)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(III)I", line = 187)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Lha;B)V", line = 202)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(B)V", line = 286)
    ...
    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "(IIIIIIIIIZI)V", line = 304)
