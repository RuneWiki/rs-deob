...
public class class82 extends class387 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(BILiga;)V", line = 4)
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Lrda;Llba;)V", line = 23)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(BZ)V", line = 42)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ZB)V", line = 56)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(I)Z", line = 88)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(III)V", line = 116)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Z)V", line = 152)
