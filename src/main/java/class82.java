...
public class class82 {
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(Llp;I)Z")
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(Llp;B)V")
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(IBLjava/awt/Canvas;I)Lhca;")
    ...
    @OriginalMember(owner = "client!kea", name = "<init>", descriptor = "(Lck;)V")
