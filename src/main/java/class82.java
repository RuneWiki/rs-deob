...
public class class82 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(II)Lrh;")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IIIIILhl;)Lci;")
    ...
    @OriginalMember(owner = "client!tl", name = "<init>", descriptor = "(Llo;ILnl;)V")
