...
public class class82 {
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(ILka;IZII)Lka;")
    ...
    @OriginalMember(owner = "client!vga", name = "b", descriptor = "(II)Lln;")
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(BLofa;I)V")
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(Lofa;B)V")
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(BIIIIILka;I)Lka;")
