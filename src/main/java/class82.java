...
public class class82 {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Lr;Ljava/lang/String;[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Lr;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Lr;Ljava/lang/String;IIIZ)V")
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(Lr;IZLjava/awt/Component;)V")
