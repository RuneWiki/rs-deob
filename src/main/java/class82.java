...
public class class82 extends class181 {
    ...
    @OriginalMember(owner = "client!mq", name = "c", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Z)[I", line = 23)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IIIFIFZF)[F", line = 34)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(I)[B", line = 120)
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(B)I", line = 149)
