...
public abstract class class82 extends class544 {
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Ljava/awt/Canvas;I)Lfk;")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Lqa;IILm;III[[[B[I[I[I[I[IIBIIZ)V")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(IILos;)V")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Ldn;B)I")
