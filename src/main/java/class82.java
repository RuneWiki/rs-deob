...
public class class82 extends class224 {
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(IC)Z", line = 14)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(III)V", line = 27)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(IB)V", line = 42)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(IIZ)V", line = 62)
    ...
    @OriginalMember(owner = "client!d", name = "b", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!d", name = "b", descriptor = "(III)V", line = 85)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(ILjava/lang/String;)I", line = 124)
    ...
    @OriginalMember(owner = "client!d", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 151)
