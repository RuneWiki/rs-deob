...
public class class82 extends class170 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(ILrg;)V")
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(ILrg;B)V")
    ...
    @OriginalMember(owner = "client!df", name = "e", descriptor = "(I)Lqg;")
