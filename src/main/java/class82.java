...
public class class82 extends IOException {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(II[JI[I)V", line = 9)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ZIZI)V", line = 77)
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 94)
