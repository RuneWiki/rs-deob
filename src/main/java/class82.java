...
public class class82 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IIIII)Ltt;", line = 24)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(BI)V", line = 51)
    ...
    @OriginalMember(owner = "client!tt", name = "<init>", descriptor = "(IIIIIIIIIZ)V", line = 64)
