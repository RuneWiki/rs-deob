...
public class class82 extends class260 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZ)V", line = 37)
