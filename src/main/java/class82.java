...
public class class82 {
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(BI)V", line = 42)
