...
public class class82 implements class515 {
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(Lqo;IIILqo;IIIII)V")
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(ILjc;I)V")
    ...
    @OriginalMember(owner = "client!fea", name = "<init>", descriptor = "(Ldq;Laea;)V")
