...
public class class82 extends class72 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lsj;I)I")
    ...
    @OriginalMember(owner = "client!wr", name = "c", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lr;I)Lej;")
    ...
    @OriginalMember(owner = "client!wr", name = "b", descriptor = "(ILr;)Leh;")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IILr;B)Z")
