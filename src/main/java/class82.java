...
public class class82 {
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(I)I", line = 9)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!iv", name = "toString", descriptor = "()Ljava/lang/String;", line = 41)
    public final String toString() {
        field1179++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(II)V", line = 49)
