...
public class class82 extends class274 {
    ...
    @OriginalMember(owner = "client!ho", name = "e", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ho", name = "d", descriptor = "(B)Ljava/lang/Object;", line = 16)
    ...
    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(Ljava/lang/Object;)V", line = 24)
