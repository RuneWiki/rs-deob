...
public class class82 extends class382 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(BLqa;II)Z", line = 24)
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(IB)V", line = 69)
    ...
    @OriginalMember(owner = "client!gea", name = "b", descriptor = "(ILqa;)Lkm;", line = 86)
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(Lqa;B)V", line = 97)
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(ILjava/lang/Class;Ljava/lang/String;)Z", line = 109)
    ...
    @OriginalMember(owner = "client!gea", name = "c", descriptor = "(Z)V", line = 179)
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(Lqa;I)Lbi;", line = 194)
