...
public class class82 implements class387 {
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(IILrba;)V")
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(Liv;IIII)V")
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(Liv;BII)V")
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(IBILrba;)V")
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(Ldf;II)V")
    ...
    @OriginalMember(owner = "client!gea", name = "<init>", descriptor = "(Llf;)V")
