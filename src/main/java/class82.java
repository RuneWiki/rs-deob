...
public class class82 {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Lha;)V", line = 10)
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(Lha;)V", line = 70)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "()V", line = 155)
    public final void method721() {
        this.field1208 = null;
    }

    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IIII)Z", line = 161)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Lha;Lqq;)Z", line = 219)
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "()V", line = 262)
    public static final void method724() {
        field1210 = null;
        field1215 = null;
    }

    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(Lha;Lqq;)V", line = 268)
    ...
    @OriginalMember(owner = "client!qq", name = "c", descriptor = "(Lha;Lqq;)Z", line = 351)
    public final boolean method726(class475 arg0, class82 arg1) {
        return this.field1208 != null || this.method723(arg0, arg1);
    }

    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Lha;IIIIII)V", line = 360)
    ...
    @OriginalMember(owner = "client!qq", name = "d", descriptor = "(Lha;Lqq;)V", line = 384)
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 466)
    ...
    @OriginalMember(owner = "client!qq", name = "c", descriptor = "()V", line = 477)
