...
public class class82 extends class42 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Lpc;II)Ldi;")
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Lpc;)Z")
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Lpc;I)Ldi;")
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "([I)Luo;")
