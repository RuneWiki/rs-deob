...
public class class82 extends class131 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ZCLjava/lang/String;)[Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IF)V", line = 39)
    ...
    @OriginalMember(owner = "client!di", name = "d", descriptor = "(Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!di", name = "<init>", descriptor = "(IIIIIF)V", line = 81)
