...
public class class82 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(IIIIIIZII)V")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(ILeo;IZLeo;)Lkr;")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Leo;IBLeo;)Lkr;")
    ...
    @OriginalMember(owner = "client!ut", name = "<init>", descriptor = "(Lpr;Ltj;)V")
