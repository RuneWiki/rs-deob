...
public class class82 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IBLjava/lang/String;I[Laa;)I", line = 30)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IIC)I", line = 55)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IB)V", line = 72)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ILjava/lang/String;[Laa;I)Ljava/lang/String;", line = 83)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "([Laa;Ljava/lang/String;I)I", line = 218)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IIIB)Lwj;", line = 320)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "([Laa;ILjava/lang/String;I)I", line = 382)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(I[Laa;Ljava/lang/String;Z)I", line = 409)
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "([B)V", line = 419)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ILjava/lang/String;)I", line = 541)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "([Laa;[Ljava/lang/String;Ljava/lang/String;[IB)I", line = 551)
