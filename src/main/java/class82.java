...
public class class82 extends class136 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IILiv;)V")
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Let;ILjava/lang/String;I)Lqt;")
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Lqc;)V")
