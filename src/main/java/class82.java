...
public class class82 extends class220 {
    ...
    @OriginalMember(owner = "client!df", name = "f", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Ltr;")
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(IBLil;)V")
    ...
    @OriginalMember(owner = "client!df", name = "g", descriptor = "(B)[Ldk;")
