...
public class class82 extends class56 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(II)Lpj;")
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(Lbv;Lre;)V")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ILic;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Ljb;I)V")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IILkv;)V")
