...
public class class82 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Ltq;ZZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lqq;Lps;IIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(III)Ljk;", line = 119)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IIIIII)V", line = 140)
