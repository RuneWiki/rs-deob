...
public class class82 extends class192 {
    ...
    @OriginalMember(owner = "client!wr", name = "b", descriptor = "(ZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "()V", line = 210)
    public class82() {
        super(0, true);
    }

    @OriginalMember(owner = "client!wr", name = "e", descriptor = "(B)V", line = 78)
    public static void method636(byte arg0) {
        int var1 = -69 / ((60 - arg0) / 58);
        field1117 = null;
    }

    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IB)[I", line = 92)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ILfd;I)V", line = 219)
    ...
    @OriginalMember(owner = "client!wr", name = "c", descriptor = "(I)V", line = 263)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Z[Ljava/lang/String;[S)V", line = 294)
    ...
    @OriginalMember(owner = "client!wr", name = "c", descriptor = "(B)V", line = 311)
    ...
    @OriginalMember(owner = "client!wr", name = "b", descriptor = "(III)I", line = 329)
