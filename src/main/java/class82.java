...
public class class82 {
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(I)Z", line = 42)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(Lee;II)V", line = 57)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(Lee;I)V", line = 88)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(ILafa;)Z", line = 108)
