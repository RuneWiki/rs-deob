...
public class class82 implements Runnable {
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IB)I", line = 52)
    public static final int method539(int arg0, byte arg1) {
        field910++;
        return arg1 <= 31 ? -40 : arg0 >>> 7;
    }

    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(BLuj;)V", line = 64)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IILjava/lang/String;Ljava/lang/String;)I", line = 77)
    ...
    @OriginalMember(owner = "client!qu", name = "<init>", descriptor = "()V", line = 248)
    public class82() {
        this.field912.setDaemon(true);
        this.field912.start();
    }

    @OriginalMember(owner = "client!qu", name = "run", descriptor = "()V", line = 208)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(IB)I", line = 267)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(Ljava/lang/String;I)Lqm;", line = 278)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(I)V", line = 299)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IIIIIII)Ldw;", line = 320)
