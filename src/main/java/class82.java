...
public class class82 extends class571 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(I[B)[B", line = 4)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(III)V", line = 25)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ILwu;ZIBI)V", line = 125)
    ...
    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "(Lpga;II[B)V", line = 145)
    ...
    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "(Lpga;II[I)V", line = 157)
