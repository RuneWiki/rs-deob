...
public class class82 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "()V", line = 27)
    public static final void method771() {
        class456.method2720(1, class138.field2320);
    }

    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(IIII)I", line = 30)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(BB)V", line = 60)
    ...
    @OriginalMember(owner = "client!ut", name = "b", descriptor = "(IIII)I", line = 103)
