...
public class class82 extends class17 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(IB)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Lwm;II)V", line = 83)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(II)[I", line = 103)
    ...
    @OriginalMember(owner = "client!ut", name = "d", descriptor = "(III)Z", line = 158)
    ...
    @OriginalMember(owner = "client!ut", name = "<init>", descriptor = "()V", line = 168)
    public class82() {
        super(3, false);
    }
}
