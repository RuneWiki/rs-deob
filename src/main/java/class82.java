...
public class class82 extends class297 {
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ZLwaa;Lwaa;F)Z", line = 18)
    ...
    @OriginalMember(owner = "client!eb", name = "c", descriptor = "(I)V", line = 218)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(B)Lwaa;", line = 231)
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Lqj;I)V", line = 241)
