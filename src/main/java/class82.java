...
public class class82 extends class129 implements class324 {
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(Lha;Lrq;IIIIIZIIII)V")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Lha;Z)V")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IIILha;)Z")
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!ji", name = "c", descriptor = "(BLha;)Lro;")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(ZLha;II)Lmg;")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(BLha;)Lqs;")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(ILha;I)Lka;")
