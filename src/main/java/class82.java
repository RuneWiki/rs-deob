...
public class class82 extends class269 {
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(Liw;I)V", line = 12)
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(I)Lve;", line = 87)
    ...
    @OriginalMember(owner = "client!gea", name = "<init>", descriptor = "(Lfda;Laba;IIIIIIIIIIIII)V", line = 101)
    ...
    @OriginalMember(owner = "client!gea", name = "c", descriptor = "(I)V", line = 118)
