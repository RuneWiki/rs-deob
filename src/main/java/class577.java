...
public class class577 {
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(IIII)Lcba;")
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(Z)Lnd;")
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(I)Llda;")
