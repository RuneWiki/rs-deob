...
public class class577 {
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(I)Lit;", line = 4)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(Z)Lit;", line = 38)
    ...
    @OriginalMember(owner = "client!aea", name = "<init>", descriptor = "()V", line = 158)
    public class577() {
    }

    @OriginalMember(owner = "client!aea", name = "<init>", descriptor = "(Lsi;)V", line = 160)
    public class577(class769 arg0) {
        this.field8317 = arg0;
    }

    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(ZI[Ljava/lang/String;I[S)V", line = 53)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(IIII)I", line = 112)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "()V", line = 148)
