...
public abstract class class577 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(ILjava/awt/Canvas;Luu;Ld;II)Lha;", line = 6)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "()V", line = 49)
