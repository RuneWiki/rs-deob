...
public class class577 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(BLwia;Lwia;Lwia;Lwia;)V", line = 40)
    ...
    @OriginalMember(owner = "client!lq", name = "f", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(II)Lru;", line = 81)
