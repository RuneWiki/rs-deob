...
public class class577 extends class135 {
    ...
    @OriginalMember(owner = "client!hi", name = "c", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(B)Lio;", line = 14)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "([BB)Lit;", line = 77)
    ...
    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "(Lrs;IIIIII)V", line = 136)
