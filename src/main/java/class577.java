...
public class class577 implements class702 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(FIIZII)[F", line = 9)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IZFIIB)[I", line = 20)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ZIIIFI)[I", line = 44)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IIILfi;Lfi;)V", line = 62)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(BI)Lkc;", line = 72)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IB)Lfga;", line = 85)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(BI)Z", line = 110)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ZLjava/awt/Canvas;)Lfr;", line = 124)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(Lpe;Lpe;Lpe;)V", line = 151)
