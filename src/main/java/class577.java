...
public class class577 extends class298 {
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Lkga;IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Lkga;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Lkga;IIII)V")
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Lkga;IIIII)V")
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Lkga;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Lkga;IIIZ[I)V")
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Lkga;IIII[I)V")
    public class577(class506 arg0, int arg1, int arg2, int arg3, int arg4, int[] arg5) {
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Lkga;IIIIZ[BI)V")
