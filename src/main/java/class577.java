...
public class class577 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lwk;Lhea;II)V")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lwk;IB)V")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(BLwk;)V")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(ILwk;)V")
    ...
    @OriginalMember(owner = "client!ii", name = "b", descriptor = "(BLwk;)V")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lwk;II)V")
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(Lwk;)V")
