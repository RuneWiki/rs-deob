...
public abstract class class577 extends class361 {
    ...
    @OriginalMember(owner = "client!v", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!v", name = "d", descriptor = "(I)Z", line = 16)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Ljava/awt/Color;ILjava/awt/Color;Ljava/lang/String;ILjava/awt/Color;)V", line = 29)
    ...
    @OriginalMember(owner = "client!v", name = "e", descriptor = "(I)Z", line = 115)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(ZLha;Lrr;IIII)V", line = 131)
    ...
    @OriginalMember(owner = "client!v", name = "i", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(B[Lada;)I", line = 159)
    ...
    @OriginalMember(owner = "client!v", name = "h", descriptor = "(I)Z", line = 171)
    ...
    @OriginalMember(owner = "client!v", name = "g", descriptor = "(B)V", line = 181)
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(IIIIIII)V", line = 268)
