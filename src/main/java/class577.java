...
public class class577 extends class413 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "([B[IIIIIIIIIIILua;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!cm", name = "OA", descriptor = "(CIIIZ)V", line = 99)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "([B[IIIIIIII)V", line = 158)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Lcc;Lho;[Lqo;[I[I)V", line = 191)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(CIIIZLua;II)V", line = 235)
