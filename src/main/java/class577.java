...
public class class577 extends class521 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IIIIIIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(III)V", line = 56)
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(I)Z", line = 82)
    ...
    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "(Ltm;Ldn;Llba;)V", line = 102)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Z)V", line = 118)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ILhv;I)V", line = 132)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(BZ)V", line = 142)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Lbg;I)I", line = 160)
