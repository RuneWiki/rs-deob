...
public class class577 {
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(IIZIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Lr;IIBI)Lkm;", line = 43)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!laa", name = "b", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Z)V", line = 122)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(BI)Ldj;", line = 135)
    ...
    @OriginalMember(owner = "client!laa", name = "<init>", descriptor = "(ILgp;Lgp;)V", line = 175)
