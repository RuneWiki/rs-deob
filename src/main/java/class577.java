...
public class class577 extends class298 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(ZIB)V", line = 8)
    ...
    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(III)Z", line = 23)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "(IIIIIF)V", line = 51)
    ...
    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(B)V", line = 74)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(III)V", line = 91)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(ILgk;)Lpv;", line = 102)
