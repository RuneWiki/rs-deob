...
public class class577 extends class109 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(I)Ljw;", line = 6)
    public final class551 method930(int arg0) {
        field8162++;
        return arg0 == 17503 ? class54.field1031 : null;
    }

    @OriginalMember(owner = "client!gu", name = "c", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(ILjg;Ljha;III)V", line = 29)
