...
public class class577 {
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(III)Z", line = 5)
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!fia", name = "b", descriptor = "(III)Lng;", line = 30)
    ...
    @OriginalMember(owner = "client!fia", name = "c", descriptor = "(III)I", line = 37)
