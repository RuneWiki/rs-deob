...
public class class577 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!po", name = "c", descriptor = "(I)V", line = 55)
    public static final void method3421(int arg0) {
        class352.field5212 = arg0;
    }

    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IB)Lqg;", line = 60)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IZ)V", line = 95)
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Lmp;ILla;Lla;)V", line = 117)
