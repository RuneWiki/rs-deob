...
public class class577 extends class425 {
    ...
    @OriginalMember(owner = "client!paa", name = "e", descriptor = "(B)Z", line = 6)
    ...
    @OriginalMember(owner = "client!paa", name = "j", descriptor = "(I)Z", line = 18)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(BII)V", line = 31)
    ...
    @OriginalMember(owner = "client!paa", name = "p", descriptor = "(I)I", line = 132)
    ...
    @OriginalMember(owner = "client!paa", name = "b", descriptor = "(ILr;)Lnu;", line = 157)
    ...
    @OriginalMember(owner = "client!paa", name = "f", descriptor = "(B)Z", line = 169)
    ...
    @OriginalMember(owner = "client!paa", name = "q", descriptor = "(I)Z", line = 185)
    private final boolean method3269(int arg0) {
        ++field8110;
        return arg0 != 0 ? false : this.field8121.field8352;
    }

    @OriginalMember(owner = "client!paa", name = "b", descriptor = "(Lr;Z)Lkq;", line = 198)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(ZILr;)Z", line = 323)
    ...
    @OriginalMember(owner = "client!paa", name = "c", descriptor = "(I)I", line = 496)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Z)V", line = 517)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(IILr;I)Z", line = 538)
    ...
    @OriginalMember(owner = "client!paa", name = "f", descriptor = "(I)V", line = 593)
    ...
    @OriginalMember(owner = "client!paa", name = "r", descriptor = "(I)V", line = 604)
    ...
    @OriginalMember(owner = "client!paa", name = "d", descriptor = "(I)I", line = 620)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(IIZIIZ)V", line = 641)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(IZLr;Lrga;IIZ)V", line = 727)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(IILjava/lang/String;)I", line = 740)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(ILr;)V", line = 752)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Lav;B)V", line = 776)
    ...
    @OriginalMember(owner = "client!paa", name = "c", descriptor = "(II)V", line = 801)
