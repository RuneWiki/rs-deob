...
public class class577 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ZII)I", line = 3)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IFFF)I", line = 50)
