...
public class class577 extends class45 {
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(I)[F", line = 155)
    ...
    @OriginalMember(owner = "client!pga", name = "b", descriptor = "(I)I", line = 568)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "()V", line = 603)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(Lga;I)Lpga;", line = 623)
    ...
    @OriginalMember(owner = "client!pga", name = "c", descriptor = "(I)F", line = 644)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(Lga;)Z", line = 656)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "([I)Lql;", line = 671)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "([BI)V", line = 730)
    ...
    @OriginalMember(owner = "client!pga", name = "b", descriptor = "([B)V", line = 738)
    ...
    @OriginalMember(owner = "client!pga", name = "b", descriptor = "()I", line = 785)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(Lga;II)Lpga;", line = 797)
    ...
    @OriginalMember(owner = "client!pga", name = "<init>", descriptor = "([B)V", line = 815)
