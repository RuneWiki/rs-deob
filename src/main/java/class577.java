...
public class class577 extends class96 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!di", name = "d", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Z)Z", line = 130)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ZB)V", line = 141)
    ...
    @OriginalMember(owner = "client!di", name = "c", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!di", name = "<init>", descriptor = "(Lml;)V", line = 221)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(ZII)V", line = 334)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IZLica;)V", line = 355)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IIIIBI)V", line = 374)
