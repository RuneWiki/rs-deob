...
public class class269 {
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(IIII)I", line = 12)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(I)V", line = 23)
    public static void method1791(int arg0) {
        field3924 = null;
        int var1 = 48 % ((-arg0 - 8) / 49);
    }

    @OriginalMember(owner = "client!fga", name = "toString", descriptor = "()Ljava/lang/String;", line = 34)
    public final String toString() {
        field3928++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(ZLlf;III[III)Lfu;", line = 47)
