...
public class class269 {
    ...
    @OriginalMember(owner = "client!tia", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!tia", name = "a", descriptor = "([ILfa;JI)Ljava/lang/String;", line = 19)
    ...
    @OriginalMember(owner = "client!tia", name = "a", descriptor = "(II)Llq;", line = 44)
    ...
    @OriginalMember(owner = "client!tia", name = "<init>", descriptor = "(ILvd;Lvd;Lrw;)V", line = 95)
