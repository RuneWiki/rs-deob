...
public class class269 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lni;II)Lcl;", line = 5)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(Lji;)V", line = 16)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "()V", line = 88)
    private class269() {
    }

    @OriginalMember(owner = "client!cl", name = "a", descriptor = "()I", line = 39)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "()Lib;", line = 84)
    ...
    @OriginalMember(owner = "client!cl", name = "c", descriptor = "()[B", line = 92)
