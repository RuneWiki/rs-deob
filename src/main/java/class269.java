...
public class class269 extends class45 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(BLio;)V", line = 31)
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "(ZLgba;)V", line = 55)
