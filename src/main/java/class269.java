...
public class class269 extends class576 {
    ...
    @OriginalMember(owner = "client!vca", name = "d", descriptor = "(I)J", line = 3)
    ...
    @OriginalMember(owner = "client!vca", name = "<init>", descriptor = "()V", line = 116)
    public class269() {
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(B)J", line = 42)
    public final long method41(byte arg0) {
        int var2 = 115 / ((arg0 + 75) / 37);
        return this.field4145;
    }

    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!vca", name = "b", descriptor = "(I)J", line = 64)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(JB)I", line = 85)
