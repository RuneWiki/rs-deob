...
public class class269 extends class601 {
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(IB)[I", line = 3)
    ...
    @OriginalMember(owner = "client!mca", name = "<init>", descriptor = "()V", line = 49)
    public class269() {
        super(0, true);
    }

    @OriginalMember(owner = "client!mca", name = "f", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(IBI)I", line = 64)
