...
public abstract class class269 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!dh", name = "c", descriptor = "(II)I", line = 20)
    public static final int method1685(int arg0, int arg1) {
        return class226.field3194 == null ? 0 : class226.field3194[arg0][arg1] & 0xFF;
    }

    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(II)V", line = 27)
