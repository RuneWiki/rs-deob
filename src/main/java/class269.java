...
public class class269 extends class161 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IIIIIIIZ)V", line = 21)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Z[I)Ljava/lang/String;", line = 81)
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(IIIIIZ)V", line = 155)
