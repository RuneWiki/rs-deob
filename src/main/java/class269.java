...
public class class269 extends class204 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "(ILfs;)V", line = 18)
    public class269(int arg0, class607 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!cp", name = "c", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!cp", name = "d", descriptor = "(II)V", line = 35)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ILrh;)I", line = 46)
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "(B)I", line = 71)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "(Lfs;)V", line = 105)
    public class269(class607 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(B)I", line = 109)
