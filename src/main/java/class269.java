...
public class class269 implements class163 {

    @OriginalMember(owner = "client!rg", name = "a", descriptor = "I")
    private int field4095 = -1;

    @OriginalMember(owner = "client!rg", name = "c", descriptor = "[I")
    private int[] field4097 = null;

    @OriginalMember(owner = "client!rg", name = "b", descriptor = "Z")
    private boolean field4096 = false;

    @OriginalMember(owner = "client!rg", name = "a", descriptor = "()I", line = 6)
    public final int method281() {
        return 4;
    }

    @OriginalMember(owner = "client!rg", name = "d", descriptor = "()V", line = 12)
    private final void method1991() {
        GL var1 = class141.field2025;
        this.field4095 = var1.glGenLists(2);
        var1.glNewList(this.field4095, 4864);
        if (this.field4097 == null) {
            ...
            if (this.field4096) {
                ...
                var1.glTexEnvi(8960, 34162, 7681);
                var1.glTexEnvi(8960, 34184, 34167);
                var1.glBindTexture(3553, class141.field2030);
                var1.glEnable(3553);
            }
            var1.glActiveTexture(33984);
        }
        var1.glEndList();
        var1.glNewList(this.field4095 + 1, 4864);
        if (this.field4097 == null) {
    ...
    @OriginalMember(owner = "client!rg", name = "c", descriptor = "()V", line = 104)
    public final void method283() {
        GL var1 = class141.field2025;
        class141.method1013(1);
        if (class98.field1379) {
            var1.glCallList(this.field4095);
        } else {
            var1.glTexEnvi(8960, 34184, 34167);
        }
    }

    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "()V", line = 149)
    public class269() {
        if (class141.field2042 && class141.field2054 >= 2) {
            this.method1992();
            GL var1 = class141.field2025;
            var1.glBindTexture(34067, this.field4097[0]);
            ...
            var1.glBindTexture(34067, this.field4097[1]);
            var1.glTexParameteri(34067, 10241, 9729);
            var1.glTexParameteri(34067, 10240, 9729);
            var1.glTexParameteri(34067, 32882, 33071);
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            var1.glBindTexture(34067, this.field4097[2]);
            var1.glTexParameteri(34067, 10241, 9729);
            var1.glTexParameteri(34067, 10240, 9729);
            var1.glTexParameteri(34067, 32882, 33071);
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            this.field4096 = class141.field2054 < 3;
        }
        this.method1991();
    }

    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(I)V", line = 126)
    public final void method286(int arg0) {
        GL var2 = class141.field2025;
        if (class98.field1379 && this.field4097 != null) {
            var2.glActiveTexture(33985);
            var2.glBindTexture(34067, this.field4097[arg0 - 1]);
            var2.glActiveTexture(33984);
        }
    }

    @OriginalMember(owner = "client!rg", name = "b", descriptor = "()V", line = 139)
    public final void method288() {
        GL var1 = class141.field2025;
        if (class98.field1379) {
            var1.glCallList(this.field4095 + 1);
        } else {
            var1.glTexEnvi(8960, 34184, 5890);
        }
    }

    @OriginalMember(owner = "client!rg", name = "e", descriptor = "()V", line = 187)
    private final void method1992() {
        GL var1 = class141.field2025;
        if (this.field4097 == null) {
            this.field4097 = new int[3];
            var1.glGenTextures(3, this.field4097, 0);
        }
        short var2 = 4096;
