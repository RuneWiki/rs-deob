...
public abstract class class269 {
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(III)V", line = 25)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Ljava/lang/String;IBIII)V", line = 47)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Ljava/lang/String;[Laa;IZI[I[I[I)V", line = 63)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IIIILjava/lang/String;II)V", line = 233)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IIIIII[ILjava/util/Random;[ILjava/lang/String;[Laa;IIBI)I", line = 261)
    ...
    @OriginalMember(owner = "client!ba", name = "b", descriptor = "(I)V", line = 337)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "([Laa;BILjava/lang/String;II[II)V", line = 386)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Ljava/lang/String;BI)V", line = 405)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(ZIIII)Lsw;", line = 448)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IILjava/lang/String;IIIII)V", line = 488)
    ...
    @OriginalMember(owner = "client!ba", name = "<init>", descriptor = "(Lqa;Lgg;)V", line = 517)
    public class269(class167 arg0, class119 arg1) {
        this.field4047 = arg1;
        this.field4059 = arg0;
    }

    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IIIIIIIILi;I[IIIILjava/lang/String;[Laa;)I", line = 526)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Ljava/lang/String;IIIIB)V", line = 537)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Ljava/lang/String;III[Laa;IILjava/util/Random;I[I)I", line = 552)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(ILi;[III[Laa;IILjava/lang/String;)V", line = 590)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(ZIIILjava/lang/String;I)V", line = 739)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IIIII[ILi;IILjava/lang/String;IIIII[Laa;I)I", line = 755)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(B)V", line = 857)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(BLjava/lang/String;)V", line = 868)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IIIIIILjava/lang/String;)V", line = 945)
