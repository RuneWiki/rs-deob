...
public class class269 extends class139 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(FFFFFFLkf;II)V")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IILkf;II)V")
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Lbf;IIII)V")
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Lbf;II[III)V")
