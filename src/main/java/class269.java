...
public class class269 extends class71 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(II)Z", line = 42)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 94)
    public class269(String arg0) {
        this.field3928 = arg0;
    }

    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IILjava/lang/String;)I", line = 83)
