...
public class class269 extends class331 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(BIIIIII)Ltj;")
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "(ILts;)V")
    public class269(int arg0, class41 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!av", name = "c", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Lkha;Z)V")
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "(Lts;)V")
