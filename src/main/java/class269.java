...
public class class269 extends class161 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Lob;IIIIIIIIIIIZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "()V", line = 27)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(J)V", line = 36)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(JI)V", line = 163)
    ...
    @OriginalMember(owner = "client!qg", name = "b", descriptor = "()V", line = 559)
    ...
    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "(Lob;IIIIIIIIIIIZ)V", line = 569)
