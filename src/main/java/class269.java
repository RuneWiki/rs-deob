...
public class class269 implements class324 {
    ...
    @OriginalMember(owner = "client!gia", name = "b", descriptor = "(B)Z")
    ...
    @OriginalMember(owner = "client!gia", name = "d", descriptor = "(I)I")
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(IIIILku;)V")
    ...
    @OriginalMember(owner = "client!gia", name = "finalize", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(IIILku;)V")
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(IILnha;)V")
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(ILmfa;II)V")
    ...
    @OriginalMember(owner = "client!gia", name = "<init>", descriptor = "(Leea;)V")
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(IILmfa;)V")
