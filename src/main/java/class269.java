...
public class class269 extends InputStream {
    ...
    @OriginalMember(owner = "client!at", name = "read", descriptor = "()I", line = 19)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(II)[B", line = 28)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Lve;II)V", line = 78)
    ...
    @OriginalMember(owner = "client!at", name = "b", descriptor = "(B)V", line = 101)
