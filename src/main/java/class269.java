...
public class class269 implements Runnable {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IB[BLva;)Lmo;")
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IILva;)Lmo;")
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(ILva;I)Lmo;")
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Lmo;I)V")
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Ldr;)V")
