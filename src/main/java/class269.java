...
public class class269 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Lii;Lcg;)V")
    ...
    @OriginalMember(owner = "client!cg", name = "b", descriptor = "(Lii;Lcg;)Z")
    public final boolean method1835(class405 arg0, class269 arg1) {
        return this.field3894 != null || this.method1840(arg0, arg1);
    }

    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Lii;)V")
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Lii;IIIIII)V")
    ...
    @OriginalMember(owner = "client!cg", name = "b", descriptor = "(Lii;)V")
    ...
    @OriginalMember(owner = "client!cg", name = "c", descriptor = "(Lii;Lcg;)Z")
    ...
    @OriginalMember(owner = "client!cg", name = "d", descriptor = "(Lii;Lcg;)V")
