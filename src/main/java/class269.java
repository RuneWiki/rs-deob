...
public class class269 implements class547 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(I)Lwea;")
    public final class259 method235(int arg0) {
        field3391++;
        return arg0 <= 38 ? null : class484.field6425;
    }

    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IILrc;ILct;IIIIIII)V")
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(ILct;Lrc;IIIIIIIZ)V")
