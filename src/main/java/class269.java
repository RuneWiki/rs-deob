...
public class class269 extends class369 {
    ...
    @OriginalMember(owner = "client!tia", name = "a", descriptor = "(Lud;BI)V")
    ...
    @OriginalMember(owner = "client!tia", name = "c", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!tia", name = "<init>", descriptor = "(Lqo;Llc;)V")
