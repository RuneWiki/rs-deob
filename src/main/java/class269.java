...
public class class269 extends class430 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IIIC)V", line = 3)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 20)
    ...
    @OriginalMember(owner = "client!hw", name = "d", descriptor = "(I)I", line = 46)
    ...
    @OriginalMember(owner = "client!hw", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 75)
    ...
    @OriginalMember(owner = "client!hw", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 89)
    public final synchronized void focusLost(FocusEvent arg0) {
        field3517++;
        this.method1605(0, -1, -104, '\u0000');
    }

    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(III)V", line = 100)
    ...
    @OriginalMember(owner = "client!hw", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 111)
    public final synchronized void keyReleased(KeyEvent arg0) {
        field3516++;
        this.method1612(1, false, arg0);
    }

    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(II)Z", line = 119)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Llba;", line = 139)
    ...
    @OriginalMember(owner = "client!hw", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 156)
    public final void focusGained(FocusEvent arg0) {
        field3531++;
    }

    @OriginalMember(owner = "client!hw", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 163)
    public final synchronized void keyPressed(KeyEvent arg0) {
        this.method1612(0, false, arg0);
        field3514++;
    }

    @OriginalMember(owner = "client!hw", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 363)
    public class269(Component arg0) {
        class203.method1312((byte) 122);
        this.method1606(-113, arg0);
    }

    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(B)V", line = 175)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IZLjava/awt/event/KeyEvent;)V", line = 186)
    ...
    @OriginalMember(owner = "client!hw", name = "c", descriptor = "(I)V", line = 223)
    ...
    @OriginalMember(owner = "client!hw", name = "b", descriptor = "(I)Lwda;", line = 311)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Z)V", line = 323)
