...
public abstract class class269 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(BLil;)V", line = 5)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(II)V", line = 49)
