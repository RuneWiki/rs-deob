...
public class class269 extends class418 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "([B[IIIIIIIIIIILua;II)V")
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "([B[IIIIIIIIIIILua;II)V")
    ...
    @OriginalMember(owner = "client!tf", name = "OA", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(Lwk;Lufa;[Lwt;[I[I)V")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(CIIIZLua;II)V")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "([B[IIIIIIII)V")
