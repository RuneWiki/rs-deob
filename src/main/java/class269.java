...
public class class269 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(I[B)V", line = 5)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(III)V", line = 82)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(B)V", line = 111)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(II)Ldk;", line = 136)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(B)V", line = 170)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(II)V", line = 189)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(Lms;ILwu;Lwu;)V", line = 215)
