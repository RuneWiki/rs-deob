...
public class class269 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(II)Lbda;", line = 9)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(B)Llt;", line = 49)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(ILgj;Lgj;Lpu;)V", line = 140)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IIIILv;IIIILha;II)V", line = 85)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(JBLwg;[I)Ljava/lang/String;", line = 106)
