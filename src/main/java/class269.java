...
public class class269 {
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(IIBII)Z", line = 27)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Loa;B)V", line = 50)
