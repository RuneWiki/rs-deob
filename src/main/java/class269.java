...
public class class269 extends class396 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IILhm;IILjf;III)V")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Lbk;IZ)V")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(ILbk;)V")
