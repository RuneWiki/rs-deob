...
public abstract class class269 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(ILbk;Ljava/awt/Canvas;BLml;I)Lvq;")
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(BILbr;I)V")
    ...
    @OriginalMember(owner = "client!vq", name = "d", descriptor = "(II)Lcf;")
