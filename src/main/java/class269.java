...
public class class269 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(II)Lfp;", line = 3)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(BI)Z", line = 30)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(II)Ljava/lang/String;", line = 63)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(I)V", line = 84)
