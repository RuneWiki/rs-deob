...
public class class269 {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(III)I", line = 5)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Lhp;)V", line = 42)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(II)[I", line = 131)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "()V", line = 429)
