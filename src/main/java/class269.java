...
public class class269 extends class262 {
    ...
    @OriginalMember(owner = "client!gia", name = "b", descriptor = "(BIII)[B", line = 3)
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(ILha;IIIII)Lka;", line = 16)
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(IIB)V", line = 61)
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(IBI)V", line = 79)
    ...
    @OriginalMember(owner = "client!gia", name = "<init>", descriptor = "()V", line = 105)
    public class269() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(BI)Ltp;", line = 110)
