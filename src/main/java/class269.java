...
public class class269 extends class436 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IILeb;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "()V", line = 65)
    public class269() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ch", name = "d", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(III)Lab;", line = 88)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(II)[I", line = 116)
    ...
    @OriginalMember(owner = "client!ch", name = "e", descriptor = "(B)V", line = 252)
    public static void method1656(byte arg0) {
        field3671 = null;
        int var1 = 56 % ((arg0 - 1) / 41);
    }

    @OriginalMember(owner = "client!ch", name = "f", descriptor = "(B)V", line = 265)
