...
public class class269 {
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(II)I", line = 17)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(BIII)I", line = 60)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(Z)Lmha;", line = 111)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(I)[Lbn;", line = 132)
