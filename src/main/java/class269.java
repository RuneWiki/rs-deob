...
public class class269 {
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!sda", name = "b", descriptor = "(III)Z", line = 42)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(II)Lrfa;", line = 74)
    ...
    @OriginalMember(owner = "client!sda", name = "b", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(III)V", line = 121)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(ILha;)V", line = 138)
    ...
    @OriginalMember(owner = "client!sda", name = "<init>", descriptor = "(Lpo;ILgda;Lgda;)V", line = 234)
