...
public class class269 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(B)I", line = 17)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(ILjava/lang/String;ILjava/awt/Color;Ljava/awt/Color;Ljava/awt/Color;)V", line = 28)
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(I)I", line = 129)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "()V", line = 140)
    public class269() {
    }

    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IBILmea;ILha;)V", line = 143)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(Lso;)V", line = 175)
