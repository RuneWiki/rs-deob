...
public class class269 implements class702 {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lcb;I)I", line = 58)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(I)Lve;", line = 126)
    ...
    @OriginalMember(owner = "client!fc", name = "b", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(Lfda;Laba;IIIIIII)V", line = 150)
