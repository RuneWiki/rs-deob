...
public class class269 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(B)[Lqj;", line = 10)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(JB)V", line = 23)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(I)V", line = 38)
