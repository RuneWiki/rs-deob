...
public class class3 extends class349 {
    ...
    @OriginalMember(owner = "client!dba", name = "b", descriptor = "(BI)[I", line = 4)
    ...
    @OriginalMember(owner = "client!dba", name = "<init>", descriptor = "()V", line = 57)
    public class3() {
        super(1, false);
    }

    @OriginalMember(owner = "client!dba", name = "f", descriptor = "(I)Z", line = 61)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(IIB)Z", line = 76)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(IB)[[I", line = 88)
    ...
    @OriginalMember(owner = "client!dba", name = "g", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(IILdga;)V", line = 180)
