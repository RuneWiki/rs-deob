...
public class class3 extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!CMOCHGYM", name = "n", descriptor = "[LZWUMKFUX;")
    ...
    @OriginalMember(owner = "client!CMOCHGYM", name = "o", descriptor = "LFLFIRZAJ;")
    public class10 field537;

    @OriginalMember(owner = "client!CMOCHGYM", name = "m", descriptor = "LVOQVBLJN;")
