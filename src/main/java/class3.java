...
public class class3 implements class154 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Z)Lbv;")
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "(Lkaa;Lbv;Z)V")
