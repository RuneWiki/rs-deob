...
public class class3 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "()[F", line = 4)
    public final float[] method33() {
        return this.field54[this.method36()];
    }

    @OriginalMember(owner = "client!dp", name = "b", descriptor = "()V", line = 9)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(II)I", line = 149)
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "()V", line = 157)
    public class3() {
    ...
    @OriginalMember(owner = "client!dp", name = "c", descriptor = "()I", line = 301)
