...
@OriginalClass("client!AVKLDTFF")
public class class3 extends class50 {

    @OriginalMember(owner = "client!AVKLDTFF", name = "qb", descriptor = "Z")
    private boolean field39 = true;

    @OriginalMember(owner = "client!AVKLDTFF", name = "rb", descriptor = "Z")
    private boolean field40 = false;

    @OriginalMember(owner = "client!AVKLDTFF", name = "sb", descriptor = "LHQFMWUSH;")
    public class26 field41;

    @OriginalMember(owner = "client!AVKLDTFF", name = "a", descriptor = "(I)LKPUOCBCE;")
    ...
    @OriginalMember(owner = "client!AVKLDTFF", name = "b", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!AVKLDTFF", name = "c", descriptor = "(I)LKPUOCBCE;")
