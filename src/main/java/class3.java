...
public class class3 extends class229 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(I[Lf;)V", line = 3)
    ...
    @OriginalMember(owner = "client!dp", name = "c", descriptor = "(III)V", line = 32)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(B)Z", line = 50)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Lki;Lki;I)V", line = 64)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IIII)V", line = 83)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Z)V", line = 101)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ZI)V", line = 170)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(II)I", line = 187)
    public static final int method18(int arg0, int arg1) {
        return class393.field5478 != null ? class393.field5478[arg0][arg1] & 255 : 0;
    }

    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(I)V", line = 190)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ZZ)V", line = 218)
    ...
    @OriginalMember(owner = "client!dp", name = "c", descriptor = "(B)V", line = 246)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IILao;)V", line = 261)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ILqa;IIBI)V", line = 273)
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "(Lht;)V", line = 379)
