...
public class class3 extends class387 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IIIIIII)I", line = 3)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(Loa;I)Lqt;", line = 38)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(Loa;B)V", line = 54)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(BILoa;I)Z", line = 69)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "([BIIIII)V", line = 116)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ILoa;)Lww;", line = 147)
