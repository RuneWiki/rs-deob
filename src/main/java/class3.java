...
public class class3 {
    ...
    @OriginalMember(owner = "client!AOFTXYIM", name = "c", descriptor = "LWPDTVMXY;")
    ...
    @OriginalMember(owner = "client!AOFTXYIM", name = "a", descriptor = "[LAOFTXYIM;")
    ...
    @OriginalMember(owner = "client!AOFTXYIM", name = "b", descriptor = "(I)LAOFTXYIM;")
