...
public abstract class class3 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(II)V", line = 26)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IIIBII)V", line = 45)
