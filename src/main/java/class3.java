...
public class class3 extends class147 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ZLjagtheora/ogg/OggPacket;)V", line = 42)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(I)D", line = 106)
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 127)
    public class3(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!dp", name = "c", descriptor = "(I)I", line = 137)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Z)Lmi;", line = 150)
    ...
    @OriginalMember(owner = "client!dp", name = "g", descriptor = "(I)V", line = 167)
