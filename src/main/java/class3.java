...
public class class3 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IIIIIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(III)I", line = 219)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Lvc;BLjava/awt/Frame;)V", line = 242)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(III)V", line = 267)
    ...
    @OriginalMember(owner = "client!dp", name = "toString", descriptor = "()Ljava/lang/String;", line = 355)
