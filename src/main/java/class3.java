...
public class class3 extends class489 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(B)Z", line = 30)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(III)V", line = 41)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(IZ)V", line = 81)
    ...
    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "(Leq;Lfaa;)V", line = 128)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IZ)V", line = 94)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Z)V", line = 147)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(BLkp;I)V", line = 159)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(CI)Z", line = 178)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(II[BI)Ljava/lang/String;", line = 192)
