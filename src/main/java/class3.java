...
public class class3 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(BIII)I", line = 177)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(B)I", line = 199)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(I)V", line = 219)
    ...
    @OriginalMember(owner = "client!dp", name = "c", descriptor = "(I)I", line = 269)
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "()V", line = 290)
    private class3() {
    }

    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "([I)V", line = 292)
