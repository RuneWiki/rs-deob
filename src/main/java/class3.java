...
public class class3 extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!AYIVJZQQ", name = "p", descriptor = "[LINVDQNJU;")
    ...
    @OriginalMember(owner = "client!AYIVJZQQ", name = "o", descriptor = "LNUXCAHZM;")
    public class41 field72;

    @OriginalMember(owner = "client!AYIVJZQQ", name = "q", descriptor = "LYVSOOFAD;")
