...
public class class3 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Lha;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(ZLdr;)I", line = 86)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IIIIIII)V", line = 132)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IIIZZ)V", line = 209)
