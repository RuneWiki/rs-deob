...
public class class3 extends class61 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(CIIIZLaa;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!dp", name = "fa", descriptor = "(CIIIZ)V", line = 51)
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "(Lwh;Lhia;[Lfg;Z)V", line = 70)
