...
public class class3 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Lsp;ILsp;IZ)Lmc;", line = 80)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Z)V", line = 122)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(I)V", line = 166)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ILsp;ILsp;)Lmc;", line = 183)
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "(Llfa;Lmu;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", line = 193)
