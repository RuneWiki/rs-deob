...
@OriginalClass("client!BJGZFSFX")
public class class3 implements Runnable {

    @OriginalMember(owner = "client!BJGZFSFX", name = "a", descriptor = "I")
    private int field11 = 4;

    @OriginalMember(owner = "client!BJGZFSFX", name = "e", descriptor = "Z")
    private boolean field15 = false;

    @OriginalMember(owner = "client!BJGZFSFX", name = "j", descriptor = "Z")
    private boolean field20 = false;

    @OriginalMember(owner = "client!BJGZFSFX", name = "k", descriptor = "Z")
    private boolean field21 = false;

    @OriginalMember(owner = "client!BJGZFSFX", name = "f", descriptor = "LITJBTECW;")
    public class22 field16;

    @OriginalMember(owner = "client!BJGZFSFX", name = "d", descriptor = "Ljava/net/Socket;")
    private Socket field14;

    @OriginalMember(owner = "client!BJGZFSFX", name = "b", descriptor = "Ljava/io/InputStream;")
    private InputStream field12;

    @OriginalMember(owner = "client!BJGZFSFX", name = "c", descriptor = "Ljava/io/OutputStream;")
    private OutputStream field13;

    @OriginalMember(owner = "client!BJGZFSFX", name = "h", descriptor = "I")
    private int field18;

    @OriginalMember(owner = "client!BJGZFSFX", name = "i", descriptor = "I")
    private int field19;

    @OriginalMember(owner = "client!BJGZFSFX", name = "g", descriptor = "[B")
    private byte[] field17;

    @OriginalMember(owner = "client!BJGZFSFX", name = "<init>", descriptor = "(LITJBTECW;ZLjava/net/Socket;)V")
    ...
    @OriginalMember(owner = "client!BJGZFSFX", name = "a", descriptor = "()V")
    public void method1() {
        this.field15 = true;
        try {
    ...
    @OriginalMember(owner = "client!BJGZFSFX", name = "b", descriptor = "()I")
    public int method2() throws IOException {
        return this.field15 ? 0 : this.field12.read();
    }

    @OriginalMember(owner = "client!BJGZFSFX", name = "c", descriptor = "()I")
    public int method3() throws IOException {
        return this.field15 ? 0 : this.field12.available();
    }

    @OriginalMember(owner = "client!BJGZFSFX", name = "a", descriptor = "([BII)V")
    ...
    @OriginalMember(owner = "client!BJGZFSFX", name = "a", descriptor = "([BIIZ)V")
    ...
    @OriginalMember(owner = "client!BJGZFSFX", name = "run", descriptor = "()V")
    public void run() {
        while (this.field20) {
            int var2;
            int var3;
    ...
    @OriginalMember(owner = "client!BJGZFSFX", name = "a", descriptor = "(B)V")
