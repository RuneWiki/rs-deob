...
public class class3 {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(ZLps;)V", line = 25)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(I)Lbt;", line = 45)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(ZII)Z", line = 122)
    ...
    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(I)Lbt;", line = 133)
    ...
    @OriginalMember(owner = "client!uv", name = "c", descriptor = "(I)Z", line = 210)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(B)Z", line = 235)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(ILps;I)V", line = 277)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(Ljava/awt/Canvas;IZLn;)Lqa;", line = 357)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(ILwca;II)V", line = 384)
