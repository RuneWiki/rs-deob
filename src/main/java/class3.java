...
public class class3 extends class80 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IILsd;IIBIIZIII[II[I)I", line = 4)
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "()V", line = 178)
    public class3() {
        super(0, true);
    }

    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(Z)V", line = 184)
    ...
    @OriginalMember(owner = "client!dp", name = "c", descriptor = "(III)Z", line = 199)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(II)[I", line = 219)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IILnn;)V", line = 274)
    ...
    @OriginalMember(owner = "client!dp", name = "d", descriptor = "(Z)V", line = 357)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IBI)Z", line = 388)
