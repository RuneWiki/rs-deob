...
public class class3 extends class757 {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IIBI)V", line = 4)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 19)
    ...
    @OriginalMember(owner = "client!ua", name = "e", descriptor = "(B)V", line = 38)
    public static void method8(byte arg0) {
        int var1 = -85 % ((-84 - arg0) / 34);
        field16 = null;
    }

    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IZ)V", line = 52)
    ...
    @OriginalMember(owner = "client!ua", name = "<init>", descriptor = "(IIIIIF)V", line = 95)
    public class3(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(FI)V", line = 100)
