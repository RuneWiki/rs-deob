...
public class class3 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(B)I", line = 73)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(I)V", line = 138)
