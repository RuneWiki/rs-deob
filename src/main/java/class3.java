...
public class class3 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(ZLij;I[Lhh;BLuo;)V", line = 89)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 296)
