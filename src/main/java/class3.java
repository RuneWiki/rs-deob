...
public class class3 implements class73 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ILfb;)V")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ILfq;II)V")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ILhn;)V")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ILhn;I)V")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ILfq;I)V")
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lmm;)V")
