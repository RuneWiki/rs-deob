...
public class class3 {
    ...
    @OriginalMember(owner = "client!BYUDODIR", name = "n", descriptor = "LVNWSQIXW;")
    ...
    @OriginalMember(owner = "client!BYUDODIR", name = "f", descriptor = "LVYCKCNXO;")
    public class58 field45;

    @OriginalMember(owner = "client!BYUDODIR", name = "b", descriptor = "[LBYUDODIR;")
    public static class3[] field41;

    @OriginalMember(owner = "client!BYUDODIR", name = "a", descriptor = "(LDTIATKJO;I)V")
    ...
    @OriginalMember(owner = "client!BYUDODIR", name = "a", descriptor = "(LGHHPHSRU;I)V")
    ...
    @OriginalMember(owner = "client!BYUDODIR", name = "a", descriptor = "()LOQIGXOFQ;")
