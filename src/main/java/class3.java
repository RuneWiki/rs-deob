...
public class class3 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(ZILpo;)V")
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Lol;Z)Z")
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lpq;")
