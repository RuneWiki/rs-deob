...
public class class3 implements class758 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(B)Z", line = 18)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Ljava/lang/String;IILda;IB)I", line = 29)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ZI)V", line = 57)
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "(Lgm;Lvr;)V", line = 87)
