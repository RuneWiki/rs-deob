...
public class class3 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(II)Ljda;", line = 4)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Ltk;[BII)Ldc;", line = 53)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(BI)V", line = 96)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(BI)V", line = 118)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!dp", name = "c", descriptor = "(I)V", line = 153)
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "(Lal;ILnd;Lnd;)V", line = 178)
