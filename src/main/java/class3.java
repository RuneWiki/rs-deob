...
public class class3 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ZLjava/io/File;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IZ)V", line = 57)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Ljava/lang/String;IILjava/lang/String;)I", line = 74)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Lpn;III)V", line = 195)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IB)Llj;", line = 244)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(B)V", line = 274)
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "(Lei;ILri;)V", line = 290)
