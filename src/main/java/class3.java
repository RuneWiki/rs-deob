...
public class class3 extends class405 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lga;ILok;IDIZ)[I", line = 4)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lok;BLga;)Z", line = 142)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(DIZLga;Lok;IIZ)[I", line = 203)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lgk;I)Lnb;", line = 347)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ILga;Lok;ZIZ)[F", line = 358)
    ...
    @OriginalMember(owner = "client!ar", name = "c", descriptor = "(B)V", line = 478)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "()V", line = 494)
    public class3() {
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lgk;)V", line = 509)
