...
public class class3 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(BI)[B", line = 4)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(III)Z", line = 54)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(II)V", line = 177)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(B)V", line = 208)
