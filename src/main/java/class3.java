...
public abstract class class3 extends class149 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IIB)I", line = 6)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(III)Z", line = 42)
