...
public class class3 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ILha;)V", line = 17)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Loia;B)V", line = 128)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(II)V", line = 168)
