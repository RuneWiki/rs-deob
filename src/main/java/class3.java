...
public class class3 {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(I[B)Ljj;")
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Lru;)V")
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(II)Luw;")
    ...
    @OriginalMember(owner = "client!ua", name = "<init>", descriptor = "(Lmp;ILla;)V")
