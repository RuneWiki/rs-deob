...
public class class3 implements class215 {

    @OriginalMember(owner = "client!il", name = "a", descriptor = "Z")
    private boolean field16 = false;

    @OriginalMember(owner = "client!il", name = "c", descriptor = "[I")
    private int[] field18 = null;

    @OriginalMember(owner = "client!il", name = "b", descriptor = "I")
    private int field17 = -1;

    @OriginalMember(owner = "client!il", name = "c", descriptor = "()V", line = 6)
    public final void method18() {
        GL var1 = class56.field848;
        class56.method351(1);
        if (class249.field4166) {
            var1.glCallList(this.field17);
        } else {
            var1.glTexEnvi(8960, 34184, 34167);
        }
    }

    @OriginalMember(owner = "client!il", name = "a", descriptor = "()I", line = 18)
    public final int method19() {
        return 4;
    }

    @OriginalMember(owner = "client!il", name = "d", descriptor = "()V", line = 25)
    private final void method20() {
        GL var1 = class56.field848;
        this.field17 = var1.glGenLists(2);
        var1.glNewList(this.field17, 4864);
        if (this.field18 == null) {
            ...
            if (this.field16) {
                ...
                var1.glTexEnvi(8960, 34162, 7681);
                var1.glTexEnvi(8960, 34184, 34167);
                var1.glBindTexture(3553, class56.field854);
                var1.glEnable(3553);
            }
            var1.glActiveTexture(33984);
        }
        var1.glEndList();
        var1.glNewList(this.field17 + 1, 4864);
        if (this.field18 == null) {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(I)V", line = 117)
    public final void method21(int arg0) {
        GL var2 = class56.field848;
        if (class249.field4166 && this.field18 != null) {
            var2.glActiveTexture(33985);
            var2.glBindTexture(34067, this.field18[arg0 - 1]);
            var2.glActiveTexture(33984);
        }
    }

    @OriginalMember(owner = "client!il", name = "e", descriptor = "()V", line = 135)
    private final void method22() {
        GL var1 = class56.field848;
        if (this.field18 == null) {
            this.field18 = new int[3];
            var1.glGenTextures(3, this.field18, 0);
        }
        short var2 = 4096;
        ...
        for (int var6 = 0; var6 < 6; var6++) {
            ...
            var1.glBindTexture(34067, this.field18[0]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var4));
            var1.glBindTexture(34067, this.field18[1]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var5));
            var1.glBindTexture(34067, this.field18[2]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var3));
            class121.field2025 += var2 * 3;
        }
    }

    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "()V", line = 271)
    public class3() {
        if (class56.field872 && class56.field840 >= 2) {
            this.method22();
            GL var1 = class56.field848;
            var1.glBindTexture(34067, this.field18[0]);
            ...
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            this.field16 = class56.field840 < 3;
        }
        this.method20();
    }

    @OriginalMember(owner = "client!il", name = "b", descriptor = "()V", line = 264)
    public final void method23() {
        GL var1 = class56.field848;
        if (class249.field4166) {
            var1.glCallList(this.field17 + 1);
        } else {
            var1.glTexEnvi(8960, 34184, 5890);
        }
    }
