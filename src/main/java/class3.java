...
public class class3 extends class490 {
    ...
    @OriginalMember(owner = "client!uv", name = "M", descriptor = "(Lq;)V")
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "()Lq;")
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IBI)Lvf;")
