...
public class class3 {
    ...
    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(II)Lwu;")
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(ILfca;ZZ)V")
    ...
    @OriginalMember(owner = "client!uv", name = "<init>", descriptor = "(Lnq;ILga;)V")
