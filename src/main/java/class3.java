...
public class class3 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Lef;B)V")
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ILem;)Lem;")
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IILef;)V")
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ZLef;)V")
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ILef;)V")
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Lef;ILpn;)V")
