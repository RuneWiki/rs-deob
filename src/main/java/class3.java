...
public abstract class class3 implements class175 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(BZLjaggl/MapBuffer;)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Ljaggl/MapBuffer;B)Z")
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IZLjaclib/memory/Source;)Z")
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(II[IILffa;[I)Ltc;")
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "(Lrda;IZ)V")
