...
public class class3 extends class359 {
    ...
    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!dc", name = "c", descriptor = "(B)Lgg;", line = 18)
    ...
    @OriginalMember(owner = "client!dc", name = "d", descriptor = "(B)Z", line = 31)
    ...
    @OriginalMember(owner = "client!dc", name = "c", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Z)Z", line = 68)
    ...
    @OriginalMember(owner = "client!dc", name = "e", descriptor = "(B)Z", line = 79)
    ...
    @OriginalMember(owner = "client!dc", name = "d", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!dc", name = "e", descriptor = "(I)I", line = 148)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IBLjava/lang/String;)V", line = 159)
    ...
    @OriginalMember(owner = "client!dc", name = "f", descriptor = "(I)Z", line = 235)
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(II)V", line = 253)
    public class3(int arg0, int arg1) {
        this.field36 = arg1;
        this.field39 = arg0;
    }

    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(Z)Z", line = 262)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(BI)Z", line = 274)
    ...
    @OriginalMember(owner = "client!dc", name = "g", descriptor = "(I)V", line = 287)
    ...
    @OriginalMember(owner = "client!dc", name = "f", descriptor = "(B)Z", line = 303)
