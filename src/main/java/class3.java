...
public class class3 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(II)V", line = 165)
    ...
    @OriginalMember(owner = "client!qd", name = "b", descriptor = "(I)I", line = 178)
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "()V", line = 196)
    private class3() {
    }

    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "([I)V", line = 198)
    ...
    @OriginalMember(owner = "client!qd", name = "c", descriptor = "(I)V", line = 217)
