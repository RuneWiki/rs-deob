...
public class class3 {
    ...
    @OriginalMember(owner = "client!BGEXEDZG", name = "d", descriptor = "LUXRJCYSS;")
    public class60 field10 = new class60();

    @OriginalMember(owner = "client!BGEXEDZG", name = "e", descriptor = "LUXRJCYSS;")
    ...
    @OriginalMember(owner = "client!BGEXEDZG", name = "a", descriptor = "(LUXRJCYSS;)V")
    ...
    @OriginalMember(owner = "client!BGEXEDZG", name = "a", descriptor = "()LUXRJCYSS;")
    ...
    @OriginalMember(owner = "client!BGEXEDZG", name = "b", descriptor = "()LUXRJCYSS;")
    ...
    @OriginalMember(owner = "client!BGEXEDZG", name = "a", descriptor = "(I)LUXRJCYSS;")
