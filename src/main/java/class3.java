...
@OriginalClass("client!AWPNKCCI")
public class class3 {

    @OriginalMember(owner = "client!AWPNKCCI", name = "a", descriptor = "I")
    private int field27 = 2;

    @OriginalMember(owner = "client!AWPNKCCI", name = "b", descriptor = "Z")
    private boolean field28 = false;

    @OriginalMember(owner = "client!AWPNKCCI", name = "c", descriptor = "[I")
    public int[] field29 = new int[2];

    @OriginalMember(owner = "client!AWPNKCCI", name = "d", descriptor = "[[[I")
    public int[][][] field30 = new int[2][2][4];

    @OriginalMember(owner = "client!AWPNKCCI", name = "e", descriptor = "[[[I")
    public int[][][] field31 = new int[2][2][4];

    @OriginalMember(owner = "client!AWPNKCCI", name = "f", descriptor = "[I")
    public int[] field32 = new int[2];

    @OriginalMember(owner = "client!AWPNKCCI", name = "g", descriptor = "[[F")
    public static float[][] field33 = new float[2][8];

    @OriginalMember(owner = "client!AWPNKCCI", name = "h", descriptor = "[[I")
    public static int[][] field34 = new int[2][8];

    @OriginalMember(owner = "client!AWPNKCCI", name = "i", descriptor = "F")
    public static float field35;

    @OriginalMember(owner = "client!AWPNKCCI", name = "j", descriptor = "I")
    public static int field36;

    @OriginalMember(owner = "client!AWPNKCCI", name = "a", descriptor = "(IFII)F")
    ...
    @OriginalMember(owner = "client!AWPNKCCI", name = "a", descriptor = "(FZ)F")
    ...
    @OriginalMember(owner = "client!AWPNKCCI", name = "a", descriptor = "(IZIF)F")
    ...
    @OriginalMember(owner = "client!AWPNKCCI", name = "a", descriptor = "(FII)I")
    ...
    @OriginalMember(owner = "client!AWPNKCCI", name = "a", descriptor = "(ILMUKVLYLC;LLRDFYKJP;)V")
