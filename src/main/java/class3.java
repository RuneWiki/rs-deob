...
@OriginalClass("client!AWDRZEFD")
public class class3 {

    @OriginalMember(owner = "client!AWDRZEFD", name = "h", descriptor = "[LKMJDCQND;")
    private class31[] field78 = new class31[10];

    @OriginalMember(owner = "client!AWDRZEFD", name = "a", descriptor = "I")
    private static int field71 = 4;

    @OriginalMember(owner = "client!AWDRZEFD", name = "b", descriptor = "I")
    private static int field72 = 935;

    @OriginalMember(owner = "client!AWDRZEFD", name = "c", descriptor = "I")
    private static int field73 = 4;

    @OriginalMember(owner = "client!AWDRZEFD", name = "d", descriptor = "[LAWDRZEFD;")
    private static class3[] field74 = new class3[5000];

    @OriginalMember(owner = "client!AWDRZEFD", name = "e", descriptor = "[I")
    public static int[] field75 = new int[5000];

    @OriginalMember(owner = "client!AWDRZEFD", name = "i", descriptor = "I")
    private int field79;

    @OriginalMember(owner = "client!AWDRZEFD", name = "j", descriptor = "I")
    private int field80;

    @OriginalMember(owner = "client!AWDRZEFD", name = "g", descriptor = "LKHOMSBHW;")
    private static class30 field77;

    @OriginalMember(owner = "client!AWDRZEFD", name = "f", descriptor = "[B")
    private static byte[] field76;

    @OriginalMember(owner = "client!AWDRZEFD", name = "<init>", descriptor = "(I)V")
    private class3(int arg0) {
        int var2 = 45 / arg0;
    }

    @OriginalMember(owner = "client!AWDRZEFD", name = "a", descriptor = "(ILKHOMSBHW;)V")
    ...
    @OriginalMember(owner = "client!AWDRZEFD", name = "a", descriptor = "(III)LKHOMSBHW;")
    ...
    @OriginalMember(owner = "client!AWDRZEFD", name = "a", descriptor = "(LKHOMSBHW;I)V")
    ...
    @OriginalMember(owner = "client!AWDRZEFD", name = "a", descriptor = "(I)I")
    ...
    @OriginalMember(owner = "client!AWDRZEFD", name = "a", descriptor = "(II)LKHOMSBHW;")
    ...
    @OriginalMember(owner = "client!AWDRZEFD", name = "b", descriptor = "(I)I")
