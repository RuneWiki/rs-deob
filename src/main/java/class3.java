...
public class class3 extends class35 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(IB)V", line = 6)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(I[IB)V", line = 17)
    ...
    @OriginalMember(owner = "client!qd", name = "b", descriptor = "(II)V", line = 151)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ZIIIF)V", line = 165)
    ...
    @OriginalMember(owner = "client!qd", name = "c", descriptor = "(II)V", line = 275)
    public final void method14(int arg0, int arg1) {
        int var3 = 98 % ((20 - arg1) / 50);
        this.field18 = ByteBuffer.allocateDirect(arg0 * 4);
    }

    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(IIII)V", line = 286)
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lwh;IIII)V", line = 292)
