...
public class class3 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(II)Lhl;")
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ILr;Lr;)I")
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "(Ldn;ILr;)V")
