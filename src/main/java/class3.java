...
public class class3 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(I)I", line = 29)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(B)I", line = 42)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(ILjava/lang/String;)V", line = 55)
    ...
    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "()V", line = 71)
    public class3() {
    }

    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "(Lgk;)V", line = 73)
