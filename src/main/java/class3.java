...
public class class3 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(BI)Lvfa;", line = 19)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(I[B)Ljava/lang/String;", line = 48)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(II)V", line = 60)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ZCLjava/lang/String;)[Ljava/lang/String;", line = 77)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "(Ldt;ILwia;)V", line = 141)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(I)V", line = 132)
