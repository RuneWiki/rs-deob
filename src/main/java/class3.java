...
public class class3 extends class436 {
    ...
    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(III)Lmg;", line = 6)
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "()V", line = 16)
    public class3() {
        super(1, true);
    }

    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(II)[I", line = 22)
    ...
    @OriginalMember(owner = "client!dc", name = "e", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Z)V", line = 89)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(BLjava/lang/String;)J", line = 105)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IILeb;)V", line = 153)
