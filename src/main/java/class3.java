...
public class class3 {
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "([[II)V", line = 49)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IIILrj;ILtj;II)Ll;", line = 70)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(III)I", line = 92)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Z)V", line = 112)
