...
public class class3 extends class413 {
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "()Lpp;", line = 4)
    public final class413 method13() {
        return (class413) this.field24.method681(-15);
    }

    @OriginalMember(owner = "client!dp", name = "c", descriptor = "([III)V", line = 10)
    ...
    @OriginalMember(owner = "client!dp", name = "c", descriptor = "()Lpp;", line = 19)
    public final class413 method15() {
        return (class413) this.field24.method679((byte) -86);
    }

    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "([III)V", line = 85)
    ...
    @OriginalMember(owner = "client!dp", name = "e", descriptor = "()I", line = 129)
    public final synchronized int method19() {
        return this.field24.method684(-9);
    }

    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Lria;)V", line = 134)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Lpp;)V", line = 150)
    public final synchronized void method21(class413 arg0) {
        this.field24.method686(-1, arg0);
    }

    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(Lpp;)V", line = 153)
    public final synchronized void method22(class413 arg0) {
        arg0.method1102((byte) 103);
    }

    @OriginalMember(owner = "client!dp", name = "f", descriptor = "()V", line = 159)
    ...
    @OriginalMember(owner = "client!dp", name = "d", descriptor = "()I", line = 177)
    public final int method24() {
        return 0;
    }

    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Lmg;Lria;)V", line = 180)
