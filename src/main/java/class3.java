...
public class class3 extends class71 {
    ...
    @OriginalMember(owner = "client!ab", name = "t", descriptor = "[Led;")
    ...
    @OriginalMember(owner = "client!ab", name = "G", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ab", name = "K", descriptor = "Lla;")
    public class104 field34;

    @OriginalMember(owner = "client!ab", name = "L", descriptor = "Lnf;")
    public class127 field35;

    @OriginalMember(owner = "client!ab", name = "H", descriptor = "Lba;")
    public class12 field31;

    @OriginalMember(owner = "client!ab", name = "O", descriptor = "Ldg;")
    public class38 field38;

    @OriginalMember(owner = "client!ab", name = "A", descriptor = "Lab;")
    public class3 field24;

    @OriginalMember(owner = "client!ab", name = "M", descriptor = "Leb;")
    public class43 field36;

    @OriginalMember(owner = "client!ab", name = "D", descriptor = "Lei;")
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Luc;B)V")
