...
public class class710 {
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(ILjava/io/File;I[B)V", line = 15)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(B)Z", line = 33)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!lu", name = "<init>", descriptor = "(BIIIIIILgs;)V", line = 59)
