...
public abstract class class710 implements class241 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IZ)V", line = 8)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(II)V", line = 27)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Z)I", line = 50)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(B)V", line = 65)
    public static void method3901(byte arg0) {
        field9935 = null;
        int var1 = -94 % ((arg0 + 3) / 46);
    }

    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(I)I", line = 98)
    public final int method3903(int arg0) {
        field9934++;
        return arg0 == 7124 ? this.field9924 : -44;
    }

    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Lji;IIIZ)V", line = 176)
    ...
    @OriginalMember(owner = "client!gq", name = "c", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ZZ)V", line = 133)
    ...
    @OriginalMember(owner = "client!gq", name = "c", descriptor = "(I)Z", line = 154)
    ...
    @OriginalMember(owner = "client!gq", name = "finalize", descriptor = "()V", line = 194)
