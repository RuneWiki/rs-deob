...
public class class710 extends class103 implements class682 {
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(B)Z", line = 17)
    ...
    @OriginalMember(owner = "client!nfa", name = "<init>", descriptor = "(Ltia;Z)V", line = 28)
    public class710(class278 arg0, boolean arg1) {
        super(arg0, 34962, arg1);
    }

    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(BII)Z", line = 33)
    ...
    @OriginalMember(owner = "client!nfa", name = "b", descriptor = "(Z)I", line = 48)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(IIILjaclib/memory/Source;)Z", line = 72)
    ...
    @OriginalMember(owner = "client!nfa", name = "f", descriptor = "(B)V", line = 87)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;", line = 116)
