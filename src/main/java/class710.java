...
public class class710 implements Runnable {
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!kv", name = "b", descriptor = "()V", line = 103)
    ...
    @OriginalMember(owner = "client!kv", name = "c", descriptor = "()V", line = 109)
    ...
    @OriginalMember(owner = "client!kv", name = "d", descriptor = "()J", line = 115)
    public final long method3835() {
        return this.field9381;
    }

    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Lqia;)V", line = 119)
    ...
    @OriginalMember(owner = "client!kv", name = "e", descriptor = "()V", line = 129)
    ...
    @OriginalMember(owner = "client!kv", name = "f", descriptor = "()Z", line = 139)
    public final boolean method3838() {
        return this.field9383 == null || !this.field9379 && this.field9383.method1871(0);
    }

    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(ILha;)V", line = 167)
    public class710(int arg0, class570 arg1) {
        this.field9380 = arg0;
        this.field9384 = arg1;
    }

    @OriginalMember(owner = "client!kv", name = "run", descriptor = "()V", line = 159)
