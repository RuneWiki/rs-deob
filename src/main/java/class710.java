...
public class class710 implements Runnable {
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(ZLjb;Ljb;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(II)Ljava/lang/String;", line = 23)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(B)Ljava/lang/String;", line = 34)
    ...
    @OriginalMember(owner = "client!ega", name = "b", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!ega", name = "c", descriptor = "(B)Lkf;", line = 55)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Lkf;Ljava/lang/String;JIB)V", line = 67)
    ...
    @OriginalMember(owner = "client!ega", name = "d", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!ega", name = "run", descriptor = "()V", line = 95)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(III)Z", line = 224)
    ...
    @OriginalMember(owner = "client!ega", name = "e", descriptor = "(B)V", line = 237)
    ...
    @OriginalMember(owner = "client!ega", name = "f", descriptor = "(B)Z", line = 251)
    public final synchronized boolean method3991(byte arg0) {
        field9868++;
        return arg0 > -11 ? false : this.field9860.method185(this.field9877, 14320);
    }

    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Z)I", line = 269)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(I)I", line = 280)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Lge;B)V", line = 291)
    ...
    @OriginalMember(owner = "client!ega", name = "g", descriptor = "(B)I", line = 304)
    ...
    @OriginalMember(owner = "client!ega", name = "b", descriptor = "(I)J", line = 331)
