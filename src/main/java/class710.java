...
public abstract class class710 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ZZ)Z", line = 43)
