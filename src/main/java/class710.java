...
public class class710 extends class362 {
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!lga", name = "c", descriptor = "(II)I", line = 108)
    public static int method3948(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!lga", name = "<init>", descriptor = "(I)V", line = 136)
    public class710(int arg0) {
        this.field9629 = arg0;
    }

    @OriginalMember(owner = "client!lga", name = "b", descriptor = "(B)V", line = 123)
