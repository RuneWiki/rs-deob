...
public class class710 {
    ...
    @OriginalMember(owner = "client!tia", name = "a", descriptor = "(II)Lrm;")
    ...
    @OriginalMember(owner = "client!tia", name = "<init>", descriptor = "(Lpj;Ld;)V")
    public class710(class38 arg0, class267 arg1) {
        this.field9997 = arg1;
        this.field9991 = arg0;
    }

    @OriginalMember(owner = "client!tia", name = "d", descriptor = "(I)V")
