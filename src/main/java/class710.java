...
public class class710 {
    ...
    @OriginalMember(owner = "client!ag", name = "toString", descriptor = "()Ljava/lang/String;", line = 16)
    public final String toString() {
        field9704++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIIIIIIIILeq;II)Z", line = 34)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lha;IIIIIIII)V", line = 467)
