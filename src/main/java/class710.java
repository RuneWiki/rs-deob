...
public class class710 extends class418 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ILjava/awt/Graphics;IIIIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ILjava/awt/Canvas;II)V", line = 30)
