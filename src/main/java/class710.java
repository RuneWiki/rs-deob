...
public class class710 extends class756 {
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(III)V", line = 4)
    public final void method1897(int arg0, int arg1, int arg2) {
        int var4 = 20 / ((arg2 - 68) / 33);
        ++field9984;
    }

    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IIB)V", line = 20)
    ...
    @OriginalMember(owner = "client!qs", name = "b", descriptor = "(III)Z", line = 34)
    ...
    @OriginalMember(owner = "client!qs", name = "b", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(BII)V", line = 56)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IBI)Z", line = 84)
    ...
    @OriginalMember(owner = "client!qs", name = "c", descriptor = "(I)I", line = 97)
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 130)
