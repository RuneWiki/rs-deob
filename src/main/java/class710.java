...
public class class710 extends class656 implements class675 {
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(Lha;III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!oia", name = "c", descriptor = "(I)I", line = 23)
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(Lha;B)Lsba;", line = 34)
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(ILao;)V", line = 45)
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(IZ)I", line = 60)
    ...
    @OriginalMember(owner = "client!oia", name = "<init>", descriptor = "(Lha;Lfw;IIIIIZIIIII)V", line = 71)
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(Z)I", line = 81)
    ...
    @OriginalMember(owner = "client!oia", name = "h", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!oia", name = "b", descriptor = "(Z)V", line = 104)
    ...
    @OriginalMember(owner = "client!oia", name = "e", descriptor = "(Z)Z", line = 114)
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(Lha;I)V", line = 127)
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(I)Z", line = 157)
    ...
    @OriginalMember(owner = "client!oia", name = "c", descriptor = "(Z)I", line = 168)
    ...
    @OriginalMember(owner = "client!oia", name = "b", descriptor = "(ZLha;)Lrs;", line = 182)
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(ZLha;)V", line = 231)
    ...
    @OriginalMember(owner = "client!oia", name = "c", descriptor = "(B)I", line = 242)
    ...
    @OriginalMember(owner = "client!oia", name = "b", descriptor = "(I)I", line = 253)
    ...
    @OriginalMember(owner = "client!oia", name = "d", descriptor = "(Z)Z", line = 275)
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(ILha;)V", line = 286)
