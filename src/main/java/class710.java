...
public class class710 extends class739 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lsl;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IB)V", line = 42)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(BI)[[I", line = 296)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Ldfa;Ldfa;I)V", line = 348)
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "()V", line = 372)
    public class710() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ki", name = "c", descriptor = "(I)V", line = 375)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 392)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(B)V", line = 410)
