...
public class class710 extends class445 implements class310 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Loa;BI)Lba;")
    ...
    @OriginalMember(owner = "client!ms", name = "b", descriptor = "(Loa;B)V")
    ...
    @OriginalMember(owner = "client!ms", name = "b", descriptor = "(Loa;I)Lqt;")
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Loa;B)V")
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(ZLoa;Lnt;IIII)V")
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(ILoa;)Lww;")
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(BILoa;I)Z")
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(Loa;Lpg;IIIIIZII)V")
