...
public class class710 extends class328 implements class191 {
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lrda;II[III)V")
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lrda;Leu;II[FII)V")
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lrda;Leu;Lpj;II)V")
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lrda;Leu;II[BII)V")
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(I[BIIIIILeu;I)V")
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ILib;)Lsr;")
