...
public class class710 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(I)Lit;")
    ...
    @OriginalMember(owner = "client!vd", name = "b", descriptor = "(I)Lit;")
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ILow;)V")
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "(Low;)V")
