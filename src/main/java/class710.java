...
public class class710 {
    ...
    @OriginalMember(owner = "client!ms", name = "b", descriptor = "(Z)Z", line = 27)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Loa;ILee;BILub;)Z", line = 50)
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(Z)V", line = 267)
