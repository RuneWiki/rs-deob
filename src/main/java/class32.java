...
@OriginalClass("client!IIXKZWNC")
public class class32 {

    @OriginalMember(owner = "client!IIXKZWNC", name = "a", descriptor = "Z")
    private boolean field1075 = false;

    @OriginalMember(owner = "client!IIXKZWNC", name = "b", descriptor = "I")
    private int field1076 = 798;

    @OriginalMember(owner = "client!IIXKZWNC", name = "c", descriptor = "I")
    private int field1077 = 23;

    @OriginalMember(owner = "client!IIXKZWNC", name = "d", descriptor = "I")
    private int field1078 = 23;

    @OriginalMember(owner = "client!IIXKZWNC", name = "e", descriptor = "[I")
    public int[] field1079 = new int[2];

    @OriginalMember(owner = "client!IIXKZWNC", name = "f", descriptor = "[[[I")
    public int[][][] field1080 = new int[2][2][4];

    @OriginalMember(owner = "client!IIXKZWNC", name = "g", descriptor = "[[[I")
    public int[][][] field1081 = new int[2][2][4];

    @OriginalMember(owner = "client!IIXKZWNC", name = "h", descriptor = "[I")
    public int[] field1082 = new int[2];

    @OriginalMember(owner = "client!IIXKZWNC", name = "i", descriptor = "[[F")
    public static float[][] field1083 = new float[2][8];

    @OriginalMember(owner = "client!IIXKZWNC", name = "j", descriptor = "[[I")
    public static int[][] field1084 = new int[2][8];

    @OriginalMember(owner = "client!IIXKZWNC", name = "k", descriptor = "F")
    public static float field1085;

    @OriginalMember(owner = "client!IIXKZWNC", name = "l", descriptor = "I")
    public static int field1086;

    @OriginalMember(owner = "client!IIXKZWNC", name = "a", descriptor = "(FIII)F")
    ...
    @OriginalMember(owner = "client!IIXKZWNC", name = "a", descriptor = "(IF)F")
    ...
    @OriginalMember(owner = "client!IIXKZWNC", name = "a", descriptor = "(IFII)F")
    ...
    @OriginalMember(owner = "client!IIXKZWNC", name = "a", descriptor = "(FZI)I")
    ...
    @OriginalMember(owner = "client!IIXKZWNC", name = "a", descriptor = "(LVQRBOQUI;ILCKBTFRZM;)V")
    ...
    @OriginalMember(owner = "client!IIXKZWNC", name = "<init>", descriptor = "()V")
    public class32() {
