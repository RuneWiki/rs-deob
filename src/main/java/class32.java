...
public class class32 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(ZIII)Ljj;")
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Lne;Laa;Lu;I)V")
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IIILjava/lang/Class;)Lcp;")
