...
public class class32 implements Runnable {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(ILjava/lang/String;)Lqj;", line = 27)
    ...
    @OriginalMember(owner = "client!bt", name = "run", descriptor = "()V", line = 48)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Lcg;B)V", line = 87)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Lfi;)V", line = 103)
    ...
    @OriginalMember(owner = "client!bt", name = "<init>", descriptor = "()V", line = 198)
    public class32() {
        this.field532.setDaemon(true);
        this.field532.start();
    }

    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Z)V", line = 210)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IIIIIBIIIIIIII)V", line = 220)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(ZIZLcq;)V", line = 327)
