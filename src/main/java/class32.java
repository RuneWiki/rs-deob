...
public class class32 {
    ...
    @OriginalMember(owner = "client!IUTBNGPH", name = "u", descriptor = "I")
    ...
    @OriginalMember(owner = "client!IUTBNGPH", name = "e", descriptor = "[LIUTBNGPH;")
    public static class32[] field816;

    @OriginalMember(owner = "client!IUTBNGPH", name = "a", descriptor = "(LVSUYIIVA;I)V")
    ...
    @OriginalMember(owner = "client!IUTBNGPH", name = "a", descriptor = "(LCFARFRSG;I)V")
