...
public class class32 extends class313 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IIILah;Le;II)V", line = 23)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!dm", name = "c", descriptor = "(B)V", line = 139)
