...
public class class32 {
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(B[IJLff;)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Lmo;I)Lui;", line = 28)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(IBI)V", line = 40)
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "(ILpu;Lpu;Loe;)V", line = 176)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(III)V", line = 76)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(II)Lrh;", line = 132)
