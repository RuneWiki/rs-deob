...
public class class32 {
    ...
    @OriginalMember(owner = "client!MMADHCLT", name = "q", descriptor = "I")
    ...
    @OriginalMember(owner = "client!MMADHCLT", name = "a", descriptor = "(ILUAWAYCTK;)V")
    ...
    @OriginalMember(owner = "client!MMADHCLT", name = "a", descriptor = "(LUAWAYCTK;I)V")
