...
public class class32 extends class106 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ZI)V", line = 16)
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "(Lvj;)V", line = 30)
    public class32(class303 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ZB)V", line = 33)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(IILih;)V", line = 62)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(IBI)V", line = 74)
    ...
    @OriginalMember(owner = "client!vo", name = "b", descriptor = "(I)Z", line = 85)
