...
public class class32 extends class757 {
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(IIBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!kha", name = "e", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(FI)V", line = 40)
    ...
    @OriginalMember(owner = "client!kha", name = "<init>", descriptor = "(IIIIIF)V", line = 51)
    public class32(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!kha", name = "f", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!kha", name = "g", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 84)
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(IIBII)I", line = 95)
