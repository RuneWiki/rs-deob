...
public class class32 extends class59 {
    ...
    @OriginalMember(owner = "client!vo", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!vo", name = "c", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!vo", name = "d", descriptor = "(B)I", line = 106)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(I[Ll;)V", line = 122)
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "(Lya;Luj;Lmq;J)V", line = 507)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ILod;ZLjava/awt/Component;I)Ljd;", line = 162)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(JB)V", line = 246)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(II)V", line = 273)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(JIZLya;I)V", line = 309)
