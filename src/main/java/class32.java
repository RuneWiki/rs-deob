...
public class class32 {
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(ILjava/lang/String;)Ljava/io/File;", line = 8)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;)Ljava/io/File;", line = 19)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(BLjava/lang/String;I)V", line = 115)
