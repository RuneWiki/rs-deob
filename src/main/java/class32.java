...
public class class32 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IIB)Z", line = 6)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(II)Lua;", line = 35)
    ...
    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(B)Z", line = 67)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(BI)V", line = 83)
    ...
    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(BI)V", line = 104)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!rk", name = "c", descriptor = "(B)V", line = 152)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "([SZ)[S", line = 165)
    ...
    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "(Lcw;ILeq;)V", line = 197)
