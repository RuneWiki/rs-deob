...
public class class32 extends class74 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lnp;I)Ldt;", line = 21)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IIB)B", line = 37)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(BLjava/lang/String;I)V", line = 59)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Z)V", line = 75)
