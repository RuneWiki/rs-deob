...
public class class32 {
    ...
    @OriginalMember(owner = "client!KUSEAONH", name = "c", descriptor = "LGLMIQHJI;")
    ...
    @OriginalMember(owner = "client!KUSEAONH", name = "a", descriptor = "(LGLMIQHJI;II)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!KUSEAONH", name = "a", descriptor = "(Ljava/lang/String;ILGLMIQHJI;)V")
