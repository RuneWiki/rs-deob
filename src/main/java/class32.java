...
public class class32 extends class227 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(IZ)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Lug;II)V", line = 51)
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "()V", line = 64)
    public class32() {
        super(1, false);
    }

    @OriginalMember(owner = "client!vo", name = "c", descriptor = "(III)I", line = 67)
    ...
    @OriginalMember(owner = "client!vo", name = "b", descriptor = "(IB)V", line = 96)
    ...
    @OriginalMember(owner = "client!vo", name = "j", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!vo", name = "k", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(II)[I", line = 173)
