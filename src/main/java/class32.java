...
public class class32 {
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(BLjava/net/Socket;I)Lkfa;")
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(IIZLd;Ljava/awt/Canvas;)Lha;")
