...
public class class32 extends class169 {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IBII)V", line = 16)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IIIBI)V", line = 47)
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "(Ltt;IIZ[[BI)V", line = 61)
    ...
    @OriginalMember(owner = "client!rh", name = "e", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "(Ltt;IIZ[[I)V", line = 100)
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "(Ltt;II)V", line = 132)
