...
public class class32 {
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!rea", name = "b", descriptor = "(B)Lbg;", line = 35)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(ZI)Lrea;", line = 46)
    public final class32 method261(boolean arg0, int arg1) {
        field483++;
        return arg0 ? null : new class32(this.field476, arg1);
    }

    @OriginalMember(owner = "client!rea", name = "<init>", descriptor = "(II)V", line = 72)
    public class32(int arg0, int arg1) {
        this.field476 = arg0;
        this.field482 = arg1;
    }

    @OriginalMember(owner = "client!rea", name = "<init>", descriptor = "(Lrea;I)V", line = 80)
