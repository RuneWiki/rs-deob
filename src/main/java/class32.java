...
@OriginalClass("client!MPYOQJPZ")
public class class32 {

    @OriginalMember(owner = "client!MPYOQJPZ", name = "a", descriptor = "Z")
    private boolean field918 = false;

    @OriginalMember(owner = "client!MPYOQJPZ", name = "c", descriptor = "I")
    private int field920 = -929;

    @OriginalMember(owner = "client!MPYOQJPZ", name = "d", descriptor = "Z")
    private boolean field921 = false;

    @OriginalMember(owner = "client!MPYOQJPZ", name = "e", descriptor = "I")
    public int field922 = 0;

    @OriginalMember(owner = "client!MPYOQJPZ", name = "f", descriptor = "I")
    public int field923 = 0;

    @OriginalMember(owner = "client!MPYOQJPZ", name = "g", descriptor = "I")
    public int field924;

    @OriginalMember(owner = "client!MPYOQJPZ", name = "h", descriptor = "I")
    public int field925;

    @OriginalMember(owner = "client!MPYOQJPZ", name = "i", descriptor = "[[I")
    public int[][] field926;

    @OriginalMember(owner = "client!MPYOQJPZ", name = "b", descriptor = "I")
    private int field919;

    @OriginalMember(owner = "client!MPYOQJPZ", name = "<init>", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!MPYOQJPZ", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!MPYOQJPZ", name = "a", descriptor = "(ZIIZII)V")
    ...
    @OriginalMember(owner = "client!MPYOQJPZ", name = "a", descriptor = "(IIIIZII)V")
    ...
    @OriginalMember(owner = "client!MPYOQJPZ", name = "a", descriptor = "(IIB)V")
    ...
    @OriginalMember(owner = "client!MPYOQJPZ", name = "a", descriptor = "(III)V")
    private void method305(int arg0, int arg1, int arg2) {
        this.field926[arg0][arg1] |= arg2;
    }

    @OriginalMember(owner = "client!MPYOQJPZ", name = "a", descriptor = "(ZIIIII)V")
    ...
    @OriginalMember(owner = "client!MPYOQJPZ", name = "a", descriptor = "(IZIIZII)V")
    ...
    @OriginalMember(owner = "client!MPYOQJPZ", name = "a", descriptor = "(IIII)V")
    ...
    @OriginalMember(owner = "client!MPYOQJPZ", name = "b", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!MPYOQJPZ", name = "a", descriptor = "(IBIIIII)Z")
    ...
    @OriginalMember(owner = "client!MPYOQJPZ", name = "a", descriptor = "(IIIIIII)Z")
    ...
    @OriginalMember(owner = "client!MPYOQJPZ", name = "a", descriptor = "(BIIIIIII)Z")
