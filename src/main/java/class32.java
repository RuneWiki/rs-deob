...
public class class32 extends class170 {
    ...
    @OriginalMember(owner = "client!bk", name = "c", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(BLpm;)V", line = 27)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Lpm;B)V", line = 52)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(II)V", line = 75)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Lil;I)Lmn;", line = 101)
    ...
    @OriginalMember(owner = "client!bk", name = "b", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Lgm;FZIB)V", line = 143)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ILpm;)V", line = 168)
    ...
    @OriginalMember(owner = "client!bk", name = "c", descriptor = "(I)V", line = 191)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Lpr;B)V", line = 215)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IB)V", line = 387)
    ...
    @OriginalMember(owner = "client!bk", name = "b", descriptor = "(IB)V", line = 414)
    ...
    @OriginalMember(owner = "client!bk", name = "d", descriptor = "(I)V", line = 474)
