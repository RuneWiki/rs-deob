...
public class class32 {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(B)Lhv;", line = 16)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(ZZ)Z", line = 27)
    public static boolean method280(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IIIIIII)I", line = 38)
