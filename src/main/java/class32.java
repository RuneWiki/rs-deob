...
public class class32 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 8)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IILik;)V", line = 18)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IIIIIII)V", line = 223)
