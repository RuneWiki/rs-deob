...
public class class32 extends class417 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lob;Lr;)V")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lmq;)V")
    public final synchronized void method248(class417 arg0) {
        this.field516.method1576(false, arg0);
    }

    @OriginalMember(owner = "client!f", name = "b", descriptor = "(Lmq;)V")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lr;)V")
    ...
    @OriginalMember(owner = "client!f", name = "b", descriptor = "()Lmq;")
    public final class417 method156() {
        return (class417) this.field516.method1573((byte) -128);
    }

    @OriginalMember(owner = "client!f", name = "a", descriptor = "()Lmq;")
