...
public class class32 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Ljava/lang/Throwable;BLjava/lang/String;)V", line = 13)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IILjava/lang/String;)V", line = 75)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(I)V", line = 99)
