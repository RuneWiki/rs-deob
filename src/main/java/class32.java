...
public class class32 {
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IBLjc;)V", line = 7)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(ILjc;)V", line = 32)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Llga;I)V", line = 52)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IILqp;I)V", line = 76)
