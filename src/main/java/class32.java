...
public class class32 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lhq;B)V", line = 110)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(B)V", line = 160)
    ...
    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(I)V", line = 171)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lhq;Z)Z", line = 291)
    ...
    @OriginalMember(owner = "client!lg", name = "c", descriptor = "(I)V", line = 332)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IIIII)Z", line = 391)
    ...
    @OriginalMember(owner = "client!lg", name = "d", descriptor = "(I)Z", line = 436)
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(Los;)V", line = 651)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(II[ILos;BZ)Lgg;", line = 450)
    ...
    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(B)Z", line = 474)
