...
public class class32 extends class193 {
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(Lr;J)V")
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(Llh;IIIIIIIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!rea", name = "<init>", descriptor = "(Llh;IIIIIIIIIIIZZ)V")
