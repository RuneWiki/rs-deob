...
public class class32 extends class15 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(ILvt;I)V")
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Z[ILvt;)V")
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(ILvt;)V")
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lvt;B)Ljava/lang/String;")
