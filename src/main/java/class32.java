...
@OriginalClass("client!KMZLAUEV")
public class class32 {

    @OriginalMember(owner = "client!KMZLAUEV", name = "a", descriptor = "I")
    private int field1105 = 4;

    @OriginalMember(owner = "client!KMZLAUEV", name = "b", descriptor = "I")
    private int field1106;

    @OriginalMember(owner = "client!KMZLAUEV", name = "e", descriptor = "I")
    public int field1109;

    @OriginalMember(owner = "client!KMZLAUEV", name = "f", descriptor = "I")
    public int field1110;

    @OriginalMember(owner = "client!KMZLAUEV", name = "g", descriptor = "I")
    public int field1111;

    @OriginalMember(owner = "client!KMZLAUEV", name = "h", descriptor = "I")
    private int field1112;

    @OriginalMember(owner = "client!KMZLAUEV", name = "i", descriptor = "I")
    private int field1113;

    @OriginalMember(owner = "client!KMZLAUEV", name = "j", descriptor = "I")
    private int field1114;

    @OriginalMember(owner = "client!KMZLAUEV", name = "k", descriptor = "I")
    private int field1115;

    @OriginalMember(owner = "client!KMZLAUEV", name = "l", descriptor = "I")
    private int field1116;

    @OriginalMember(owner = "client!KMZLAUEV", name = "m", descriptor = "I")
    public static int field1117;

    @OriginalMember(owner = "client!KMZLAUEV", name = "c", descriptor = "[I")
    private int[] field1107;

    @OriginalMember(owner = "client!KMZLAUEV", name = "d", descriptor = "[I")
    private int[] field1108;

    @OriginalMember(owner = "client!KMZLAUEV", name = "a", descriptor = "(LKHOMSBHW;I)V")
    ...
    @OriginalMember(owner = "client!KMZLAUEV", name = "b", descriptor = "(LKHOMSBHW;I)V")
    ...
    @OriginalMember(owner = "client!KMZLAUEV", name = "a", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!KMZLAUEV", name = "a", descriptor = "(BI)I")
