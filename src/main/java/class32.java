...
public class class32 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Lfd;ZIII)V")
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ZLam;)I")
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Lkm;B)V")
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Ltq;I)V")
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ILtq;B)V")
