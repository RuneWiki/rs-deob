...
public class class32 extends class739 {
    ...
    @OriginalMember(owner = "client!bja", name = "<init>", descriptor = "()V", line = 395)
    public class32() {
        super(0, true);
    }

    @OriginalMember(owner = "client!bja", name = "a", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!bja", name = "a", descriptor = "(Lsl;II)V", line = 38)
    ...
    @OriginalMember(owner = "client!bja", name = "a", descriptor = "(II)[I", line = 116)
    ...
    @OriginalMember(owner = "client!bja", name = "c", descriptor = "(I)V", line = 324)
    ...
    @OriginalMember(owner = "client!bja", name = "a", descriptor = "(IIB)I", line = 359)
    ...
    @OriginalMember(owner = "client!bja", name = "e", descriptor = "(I)V", line = 404)
