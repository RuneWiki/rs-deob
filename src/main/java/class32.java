...
public class class32 {
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(IIII)Z", line = 28)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(Z)V", line = 164)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(ICI)I", line = 176)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(IZ)V", line = 195)
