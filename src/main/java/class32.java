...
public class class32 extends class40 {
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "()V", line = 5)
    public class32() {
        super(0, true);
    }

    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IILlf;)V", line = 8)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IB[I)V", line = 104)
    ...
    @OriginalMember(owner = "client!dm", name = "g", descriptor = "(B)V", line = 262)
    ...
    @OriginalMember(owner = "client!dm", name = "h", descriptor = "(B)V", line = 301)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Lop;B)V", line = 344)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(III)I", line = 395)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IIIIIII)I", line = 423)
    ...
    @OriginalMember(owner = "client!dm", name = "i", descriptor = "(B)V", line = 503)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(BI)[I", line = 544)
    ...
    @OriginalMember(owner = "client!dm", name = "c", descriptor = "(I)V", line = 571)
