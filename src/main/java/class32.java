...
public class class32 implements Runnable {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ILsl;)V", line = 25)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ILvu;)V", line = 36)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(II)V", line = 51)
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "()V", line = 148)
    public class32() {
        this.field367.setDaemon(true);
        this.field367.start();
    }

    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ILjava/lang/String;)Lva;", line = 69)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(B)V", line = 92)
    ...
    @OriginalMember(owner = "client!vo", name = "run", descriptor = "()V", line = 104)
