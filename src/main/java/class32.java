...
public class class32 extends class145 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Lpt;IIIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "()V", line = 378)
    public class32() {
        super(0, true);
    }

    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(ZI)[I", line = 90)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IIILta;ZZLoa;)V", line = 344)
    ...
    @OriginalMember(owner = "client!bh", name = "f", descriptor = "(I)V", line = 381)
    public final void method145(int arg0) {
        ++field359;
        int var2 = -50 % ((-46 - arg0) / 45);
    }

    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IILrt;)V", line = 391)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(I[[IILjava/util/Random;III)V", line = 503)
