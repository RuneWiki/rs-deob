...
public class class32 implements class29 {
    ...
    private int[] field534 = null;

    @OriginalMember(owner = "client!ih", name = "c", descriptor = "()I", line = 6)
    public final int method36() {
        return 4;
    }

    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(I)V", line = 12)
    public final void method35(int arg0) {
        GL var2 = class217.field3551;
        if (class81.field1131 && this.field534 != null) {
            var2.glActiveTexture(33985);
            var2.glBindTexture(34067, this.field534[arg0 - 1]);
            var2.glActiveTexture(33984);
        }
    }

    @OriginalMember(owner = "client!ih", name = "d", descriptor = "()V", line = 23)
    private final void method241() {
        GL var1 = class217.field3551;
        this.field533 = var1.glGenLists(2);
        var1.glNewList(this.field533, 4864);
        if (this.field534 == null) {
            ...
            if (this.field532) {
                ...
                var1.glTexEnvi(8960, 34162, 7681);
                var1.glTexEnvi(8960, 34184, 34167);
                var1.glBindTexture(3553, class217.field3523);
                var1.glEnable(3553);
            }
            var1.glActiveTexture(33984);
        }
        var1.glEndList();
        var1.glNewList(this.field533 + 1, 4864);
        if (this.field534 == null) {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "()V", line = 117)
    public final void method34() {
        GL var1 = class217.field3551;
        class217.method1475(1);
        if (class81.field1131) {
            var1.glCallList(this.field533);
        } else {
            var1.glTexEnvi(8960, 34184, 34167);
        }
    }

    @OriginalMember(owner = "client!ih", name = "e", descriptor = "()V", line = 137)
    private final void method242() {
        GL var1 = class217.field3551;
        if (this.field534 == null) {
            this.field534 = new int[3];
            var1.glGenTextures(3, this.field534, 0);
        }
        short var2 = 4096;
        ...
        for (int var6 = 0; var6 < 6; var6++) {
            ...
            var1.glBindTexture(34067, this.field534[0]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var4));
            var1.glBindTexture(34067, this.field534[1]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var5));
            var1.glBindTexture(34067, this.field534[2]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var3));
            class207.field3385 += var2 * 3;
        }
    }

    @OriginalMember(owner = "client!ih", name = "b", descriptor = "()V", line = 252)
    public final void method37() {
        GL var1 = class217.field3551;
        if (class81.field1131) {
            var1.glCallList(this.field533 + 1);
        } else {
            var1.glTexEnvi(8960, 34184, 5890);
        }
    }

    @OriginalMember(owner = "client!ih", name = "<init>", descriptor = "()V", line = 271)
    public class32() {
        if (class217.field3552 && class217.field3545 >= 2) {
            this.method242();
            GL var1 = class217.field3551;
            var1.glBindTexture(34067, this.field534[0]);
            ...
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            this.field532 = class217.field3545 < 3;
        }
        this.method241();
    }
}
