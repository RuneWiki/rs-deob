...
public class class32 implements class708 {
    ...
    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(I)I", line = 37)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(JI)Z", line = 64)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IIIBIIIII)V", line = 80)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ZI)V", line = 92)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(B)I", line = 121)
    public final int method188(byte arg0) {
        field415++;
        return arg0 <= 114 ? 29 : this.field420.field8018;
    }

    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(B)V", line = 133)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(Z)V", line = 145)
    ...
    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "(Lk;Loo;)V", line = 154)
    ...
    @OriginalMember(owner = "client!rk", name = "c", descriptor = "(B)I", line = 176)
