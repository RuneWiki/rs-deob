...
public class class32 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(Ljava/lang/String;BLjava/applet/Applet;)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(BLjava/applet/Applet;Ljava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(Ljava/applet/Applet;Ljava/lang/String;B[Ljava/lang/Object;)Ljava/lang/Object;")
