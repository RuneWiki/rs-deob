...
public class class32 {
    ...
    @OriginalMember(owner = "client!NQIAMATB", name = "f", descriptor = "[LNQIAMATB;")
    public static class32[] field1115;

    @OriginalMember(owner = "client!NQIAMATB", name = "a", descriptor = "(LGWOEELWB;B)V")
    ...
    @OriginalMember(owner = "client!NQIAMATB", name = "a", descriptor = "(LMLYYHULT;B)V")
    ...
    @OriginalMember(owner = "client!NQIAMATB", name = "b", descriptor = "(I)LCADBNSXE;")
    ...
    @OriginalMember(owner = "client!NQIAMATB", name = "a", descriptor = "(B)LCADBNSXE;")
