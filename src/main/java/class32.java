...
public class class32 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Z[III)Lfp;")
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "([III)Lfp;")
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(II[II)Lfp;")
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IB[I)Lfp;")
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(Lra;Lra;)V")
