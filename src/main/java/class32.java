...
@OriginalClass("client!LEBPILPF")
public class class32 {

    @OriginalMember(owner = "client!LEBPILPF", name = "a", descriptor = "B")
    private byte field964 = 44;

    @OriginalMember(owner = "client!LEBPILPF", name = "b", descriptor = "Z")
    private boolean field965 = true;

    @OriginalMember(owner = "client!LEBPILPF", name = "c", descriptor = "Z")
    private boolean field966 = true;

    @OriginalMember(owner = "client!LEBPILPF", name = "i", descriptor = "I")
    public int field972 = 65000;

    @OriginalMember(owner = "client!LEBPILPF", name = "h", descriptor = "I")
    public int field971;

    @OriginalMember(owner = "client!LEBPILPF", name = "f", descriptor = "Ljava/io/RandomAccessFile;")
    public RandomAccessFile field969;

    @OriginalMember(owner = "client!LEBPILPF", name = "g", descriptor = "Ljava/io/RandomAccessFile;")
    public RandomAccessFile field970;

    @OriginalMember(owner = "client!LEBPILPF", name = "e", descriptor = "[B")
    public static byte[] field968 = new byte[520];

    @OriginalMember(owner = "client!LEBPILPF", name = "d", descriptor = "I")
    private int field967;

    @OriginalMember(owner = "client!LEBPILPF", name = "<init>", descriptor = "(ILjava/io/RandomAccessFile;ILjava/io/RandomAccessFile;I)V")
    ...
    @OriginalMember(owner = "client!LEBPILPF", name = "a", descriptor = "(BI)[B")
    ...
    @OriginalMember(owner = "client!LEBPILPF", name = "a", descriptor = "(I[BII)Z")
    ...
    @OriginalMember(owner = "client!LEBPILPF", name = "a", descriptor = "(ZI[BII)Z")
    ...
    @OriginalMember(owner = "client!LEBPILPF", name = "a", descriptor = "(Ljava/io/RandomAccessFile;IZ)V")
