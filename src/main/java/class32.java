...
public class class32 extends class638 {
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(ZB)V", line = 32)
    ...
    @OriginalMember(owner = "client!faa", name = "<init>", descriptor = "(I)V", line = 60)
    public class32(int arg0) {
        this.field300 = arg0;
    }

    @OriginalMember(owner = "client!faa", name = "b", descriptor = "(I)V", line = 68)
