...
public class class32 extends class175 {
    ...
    @OriginalMember(owner = "client!iha", name = "<init>", descriptor = "()V", line = 4)
    public class32() {
        super(0, true);
    }

    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(ZI)[I", line = 10)
    ...
    @OriginalMember(owner = "client!iha", name = "b", descriptor = "(Z)V", line = 45)
    ...
    @OriginalMember(owner = "client!iha", name = "g", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(IILha;I)V", line = 266)
    ...
    @OriginalMember(owner = "client!iha", name = "c", descriptor = "(III)I", line = 815)
