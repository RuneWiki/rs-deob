...
public class class32 {
    ...
    @OriginalMember(owner = "client!LZWYDZNA", name = "a", descriptor = "Z")
    ...
    @OriginalMember(owner = "client!LZWYDZNA", name = "d", descriptor = "[LLZWYDZNA;")
    public static class32[] field1065;

    @OriginalMember(owner = "client!LZWYDZNA", name = "a", descriptor = "(ILINOFEYKQ;)V")
    ...
    @OriginalMember(owner = "client!LZWYDZNA", name = "a", descriptor = "(ILNHEPCMLW;I)V")
