...
public class class32 {
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(ZI)Lec;", line = 14)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(II)Z", line = 63)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(Z)V", line = 85)
    ...
    @OriginalMember(owner = "client!iha", name = "<init>", descriptor = "(Lai;Ld;)V", line = 110)
    public class32(class626 arg0, class161 arg1) {
        this.field523 = arg0;
        this.field519 = arg1;
    }

    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(B)V", line = 99)
    public static void method233(byte arg0) {
        int var1 = 93 / ((arg0 - 32) / 58);
        field524 = null;
    }

    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(IBI)I", line = 119)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 145)
