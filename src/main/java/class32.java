...
public class class32 extends class744 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(JI)V", line = 4)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Lha;J)V", line = 401)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "()V", line = 576)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Lta;IIIIIIIIIIIZZ)V", line = 586)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "()V", line = 606)
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(Lta;IIIIIIIIIIIZZ)V", line = 616)
