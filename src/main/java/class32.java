...
public class class32 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(Lgda;ZLtga;)V")
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ILvf;ZLjava/lang/String;)Lnl;")
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ILrk;)Z")
