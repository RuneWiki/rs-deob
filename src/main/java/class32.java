...
public class class32 extends class627 {
    ...
    @OriginalMember(owner = "client!bja", name = "a", descriptor = "(B)Lhw;")
    ...
    @OriginalMember(owner = "client!bja", name = "b", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!bja", name = "<init>", descriptor = "(Lac;IIIIII)V")
