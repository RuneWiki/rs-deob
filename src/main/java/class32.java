...
public class class32 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Luo;[IIII[I[I)V", line = 6)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I)Z", line = 44)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "()V", line = 122)
    public static void method323() {
        field514 = null;
    }

    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Luo;[II)V", line = 125)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(II)V", line = 130)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(I)V", line = 174)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "([III)V", line = 223)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "()V", line = 272)
    private static final void method328() {
        field507 = 0;
    }

    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Luo;[II[I[I)V", line = 275)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(II)V", line = 281)
