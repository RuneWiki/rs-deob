...
public class class32 extends class277 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IIIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IZII)V", line = 26)
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Lbk;)V", line = 44)
    public class32(class194 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!li", name = "a", descriptor = "(I)Z", line = 47)
    ...
    @OriginalMember(owner = "client!li", name = "c", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IIIIZ)V", line = 74)
