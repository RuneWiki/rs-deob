...
public class class32 extends class467 {
    ...
    @OriginalMember(owner = "client!ic", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IJ)V", line = 26)
    ...
    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZ)V", line = 109)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(II)I", line = 126)
