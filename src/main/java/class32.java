...
public class class32 extends class451 {
    ...
    @OriginalMember(owner = "client!bja", name = "a", descriptor = "(IBI)Lffa;")
    ...
    @OriginalMember(owner = "client!bja", name = "a", descriptor = "(B)Lvw;")
    ...
    @OriginalMember(owner = "client!bja", name = "<init>", descriptor = "(ILnw;Lnw;Ltha;Laca;I[BIZ)V")
