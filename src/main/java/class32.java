...
public class class32 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IZ)Z", line = 5)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IIZI)V", line = 16)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IIBIII)V", line = 50)
