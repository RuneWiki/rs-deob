...
public class class32 extends class67 {
    ...
    @OriginalMember(owner = "client!iha", name = "fa", descriptor = "(CIIIZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(CIIIZLaa;II)V", line = 25)
    ...
    @OriginalMember(owner = "client!iha", name = "<init>", descriptor = "(Lhk;Lkc;[Lgs;Z)V", line = 74)
