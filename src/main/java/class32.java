...
public class class32 {
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(ILqd;)V")
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(Lut;Ljava/lang/Object;IZ)V")
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(Lut;I)V")
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(Lut;B)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(Lut;Ljava/lang/Object;I)V")
