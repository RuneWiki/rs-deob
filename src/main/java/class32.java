...
public class class32 implements class66 {
    ...
    private int[] field658 = null;

    @OriginalMember(owner = "client!hb", name = "b", descriptor = "I")
    private static int field655 = 96;

    @OriginalMember(owner = "client!hb", name = "d", descriptor = "I")
    private static int field657 = 12;

    @OriginalMember(owner = "client!hb", name = "f", descriptor = "I")
    private static int field659 = 36;

    @OriginalMember(owner = "client!hb", name = "d", descriptor = "()V", line = 6)
    private final void method287() {
        GL var1 = class21.field377;
        this.field656 = var1.glGenLists(2);
        var1.glNewList(this.field656, 4864);
        if (this.field658 == null) {
            ...
            if (this.field654) {
                ...
                var1.glTexEnvi(8960, 34162, 7681);
                var1.glTexEnvi(8960, 34184, 34167);
                var1.glBindTexture(3553, class21.field381);
                var1.glEnable(3553);
            }
            var1.glActiveTexture(33984);
        }
        var1.glEndList();
        var1.glNewList(this.field656 + 1, 4864);
        if (this.field658 == null) {
    ...
    @OriginalMember(owner = "client!hb", name = "e", descriptor = "()V", line = 105)
    private final void method288() {
        GL var1 = class21.field377;
        if (this.field658 == null) {
            this.field658 = new int[3];
            var1.glGenTextures(3, this.field658, 0);
        }
        short var2 = 4096;
        ...
        for (int var6 = 0; var6 < 6; var6++) {
            ...
            for (int var8 = 0; var8 < 64; var8++) {
                for (int var9 = 0; var9 < 64; var9++) {
                    ...
                    int var18;
                    if (var15 > 0.0F) {
                        var16 = (int) (Math.pow((double) var15, (double) field655) * 255.0D);
                        var17 = (int) (Math.pow((double) var15, (double) field659) * 255.0D);
                        var18 = (int) (Math.pow((double) var15, (double) field657) * 255.0D);
                    } else {
                        var18 = 0;
                        var17 = 0;
                        var16 = 0;
            ...
            var1.glBindTexture(34067, this.field658[0]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var4));
            var1.glBindTexture(34067, this.field658[1]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var5));
            var1.glBindTexture(34067, this.field658[2]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var3));
            class136.field2303 += var2 * 3;
        }
    }

    @OriginalMember(owner = "client!hb", name = "b", descriptor = "()I", line = 224)
    public final int method91() {
        return 4;
    }

    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "()V", line = 277)
    public class32() {
        if (class21.field369 && class21.field365 >= 2) {
            this.method288();
            GL var1 = class21.field377;
            var1.glBindTexture(34067, this.field658[0]);
            ...
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            this.field654 = class21.field365 < 3;
        }
        this.method287();
    }

    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(I)V", line = 233)
    public final void method94(int arg0) {
        GL var2 = class21.field377;
        if (class1.field8 && this.field658 != null) {
            var2.glActiveTexture(33985);
            var2.glBindTexture(34067, this.field658[arg0 - 1]);
            var2.glActiveTexture(33984);
        }
    }

    @OriginalMember(owner = "client!hb", name = "a", descriptor = "()V", line = 252)
    public final void method93() {
        GL var1 = class21.field377;
        if (class1.field8) {
            var1.glCallList(this.field656 + 1);
        } else {
            var1.glTexEnvi(8960, 34184, 5890);
        }
    }

    @OriginalMember(owner = "client!hb", name = "c", descriptor = "()V", line = 262)
    public final void method92() {
        GL var1 = class21.field377;
        if (class1.field8) {
            class21.method164(1);
            var1.glCallList(this.field656);
        } else {
            var1.glTexEnvi(8960, 34184, 34167);
        }
    }
