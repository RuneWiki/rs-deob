...
public class class695 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ILjava/lang/Object;Lqj;)V", line = 4)
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(II)Z", line = 54)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(BI)Lco;", line = 69)
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Ljaa;Le;)V", line = 123)
