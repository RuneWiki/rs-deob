...
public class class695 extends class389 {
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IIB)V", line = 44)
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "(IIIIIFFF)V", line = 58)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IC)I", line = 69)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(III)V", line = 86)
    ...
    @OriginalMember(owner = "client!dq", name = "c", descriptor = "(I)V", line = 123)
