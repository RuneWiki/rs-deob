...
public class class695 extends class59 implements class533 {
    ...
    @OriginalMember(owner = "client!oa", name = "o", descriptor = "()Lofa;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lmj;Lbba;)Lnc;")
    public final class23 method463(class655 arg0, class115 arg1) {
        return new class611(this, (class542) arg0, (class504) arg1);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lur;IIII)Lka;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Luj;I)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lrc;[Ljn;Z)Lda;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Luj;Z)V")
    ...
    @OriginalMember(owner = "client!oa", name = "t", descriptor = "()Lofa;")
    public final class333 method474() {
        return this.field9678;
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "()Lkea;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II)Lbba;")
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(IIIIII)Ltea;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Luj;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lofa;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[Ltn;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljn;Z)Lhu;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIF)Ltn;")
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "()Lofa;")
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(II)Lmj;")
