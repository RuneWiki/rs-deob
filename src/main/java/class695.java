...
public class class695 extends class180 implements class302 {
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(Lr;Llr;IIIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(ILr;)Lod;")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(ZILr;I)Z")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(BLr;)Lll;")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Lr;Z)V")
