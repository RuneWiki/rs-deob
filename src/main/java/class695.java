...
public class class695 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(BI)V", line = 24)
    ...
    @OriginalMember(owner = "client!mg", name = "b", descriptor = "(II)V", line = 35)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(ZII)Ljava/lang/String;", line = 57)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(BZ)V", line = 75)
    ...
    @OriginalMember(owner = "client!mg", name = "c", descriptor = "(II)Ltc;", line = 93)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(BLjava/lang/String;)V", line = 142)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(I)V", line = 194)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(BIIII)V", line = 218)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(IZ)V", line = 236)
    ...
    @OriginalMember(owner = "client!mg", name = "b", descriptor = "(I)V", line = 253)
    ...
    @OriginalMember(owner = "client!mg", name = "c", descriptor = "(I)V", line = 275)
    ...
    @OriginalMember(owner = "client!mg", name = "<init>", descriptor = "(Lnq;IZLga;Lga;)V", line = 317)
