...
public class class695 extends class516 implements class392 {
    ...
    @OriginalMember(owner = "client!ua", name = "h", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ua", name = "n", descriptor = "(I)Z", line = 22)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(I)I", line = 34)
    public final int method18(int arg0) {
        ++field9737;
        return arg0 != -10908 ? 30 : this.field9738;
    }

    @OriginalMember(owner = "client!ua", name = "b", descriptor = "(I)I", line = 46)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IIILha;)Z", line = 57)
    ...
    @OriginalMember(owner = "client!ua", name = "l", descriptor = "(I)I", line = 82)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Lha;Lwea;ZIIII)V", line = 98)
    ...
    @OriginalMember(owner = "client!ua", name = "d", descriptor = "(I)Z", line = 132)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Lha;I)V", line = 143)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Lha;B)Lel;", line = 170)
    ...
    @OriginalMember(owner = "client!ua", name = "m", descriptor = "(I)I", line = 184)
    ...
    @OriginalMember(owner = "client!ua", name = "b", descriptor = "(Lha;I)V", line = 197)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IILha;Z)Lhi;", line = 224)
    ...
    @OriginalMember(owner = "client!ua", name = "<init>", descriptor = "(Lha;Lpu;IIIIIZIIZ)V", line = 258)
    ...
    @OriginalMember(owner = "client!ua", name = "c", descriptor = "(I)V", line = 291)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(ILha;)Ldfa;", line = 305)
    ...
    @OriginalMember(owner = "client!ua", name = "o", descriptor = "(I)V", line = 333)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Ljava/io/File;BI)[B", line = 348)
    ...
    @OriginalMember(owner = "client!ua", name = "e", descriptor = "(I)I", line = 379)
    ...
    @OriginalMember(owner = "client!ua", name = "k", descriptor = "(I)Z", line = 393)
    ...
    @OriginalMember(owner = "client!ua", name = "j", descriptor = "(I)V", line = 408)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(ILha;I)Lka;", line = 423)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(BLha;)V", line = 446)
