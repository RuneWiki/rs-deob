...
public abstract class class695 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!wh", name = "c", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!wh", name = "d", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Lfc;)V", line = 85)
    public class695(class575 arg0) {
        this.field9493 = arg0;
    }

    @OriginalMember(owner = "client!wh", name = "c", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!wh", name = "d", descriptor = "(I)V", line = 110)
