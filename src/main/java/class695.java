...
public class class695 extends class206 {
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(II)I", line = 16)
    public static final int method5076(int arg0, int arg1) {
        return class574.field8476 == null ? 0 : class574.field8476[arg0][arg1] & 0xFF;
    }

    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "()V", line = 25)
    public class695() {
    }

    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(S)V", line = 28)
