...
public class class695 implements class65 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lha;[I[I[I[SI)V", line = 11)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;III)V", line = 16)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILqa;Z)Z", line = 19)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lqa;[III)V", line = 24)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;II)V", line = 86)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILqa;ZI)Z", line = 89)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;[ILqa;)V", line = 92)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lqa;[II)V", line = 98)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "()V", line = 107)
    private final void method5005() {
        this.method4994(this.nativeid);
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lha;IIIIIII)V", line = 113)
    ...
    @OriginalMember(owner = "client!a", name = "finalize", descriptor = "()V", line = 118)
    ...
    @OriginalMember(owner = "client!a", name = "w", descriptor = "(Z)V", line = 123)
    public final void method690(boolean arg0) {
        this.method5009(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!a", name = "<init>", descriptor = "(Loa;II)V", line = 128)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ls;IIIIIII[[Z)V", line = 143)
