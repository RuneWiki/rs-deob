...
public class class695 extends class384 {
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(Lke;BI)V")
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(ILat;IIII)V")
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(IILha;IIIIIII[[[BII)V")
    ...
    @OriginalMember(owner = "client!sea", name = "<init>", descriptor = "(Lai;Loh;Lwt;)V")
