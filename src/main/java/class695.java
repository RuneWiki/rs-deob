...
public class class695 extends class56 {
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(IZ)[I")
    ...
    @OriginalMember(owner = "client!sfa", name = "c", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(ILee;I)V")
