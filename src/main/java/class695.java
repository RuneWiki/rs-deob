...
public class class695 {
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(Lkw;II)V", line = 10)
    public class695(class346 arg0, int arg1, int arg2) {
        this.field9829 = arg0;
        this.field9830 = arg2;
    }

    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(B)I", line = 25)
    ...
    @OriginalMember(owner = "client!ft", name = "finalize", descriptor = "()V", line = 44)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Z)V", line = 53)
