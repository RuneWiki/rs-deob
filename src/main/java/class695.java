...
public abstract class class695 implements class200 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lsl;I)Lum;", line = 6)
    ...
    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(ZI)V", line = 33)
    ...
    @OriginalMember(owner = "client!cj", name = "finalize", descriptor = "()V", line = 53)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IB)V", line = 70)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(B)I", line = 82)
    ...
    @OriginalMember(owner = "client!cj", name = "c", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(B)Z", line = 112)
    ...
    @OriginalMember(owner = "client!cj", name = "<init>", descriptor = "(Lbi;IIIZ)V", line = 191)
    ...
    @OriginalMember(owner = "client!cj", name = "d", descriptor = "(I)I", line = 143)
    ...
    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(ZI)V", line = 156)
    ...
    @OriginalMember(owner = "client!cj", name = "e", descriptor = "(I)I", line = 180)
    ...
    @OriginalMember(owner = "client!cj", name = "f", descriptor = "(I)V", line = 214)
