...
public class class695 extends class649 {
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(Lhs;)V")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Lei;I)I")
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(ILhs;)V")
