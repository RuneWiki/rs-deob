...
public class class695 {
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(I)Lkh;")
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(B)Lkh;")
    ...
    @OriginalMember(owner = "client!dt", name = "<init>", descriptor = "(Lut;)V")
    public class695(class719 arg0) {
        this.field8910 = arg0;
    }

    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Z)Lcc;")
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Lmc;I)Ljk;")
