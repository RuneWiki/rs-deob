...
public class class695 {
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IZ)Z")
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(ZI)Llda;")
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(Ldt;ILwia;)V")
