...
public class class695 extends class748 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IZLvj;)V", line = 8)
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "()V", line = 230)
    public class695() {
        super(0, true);
    }

    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(II)[I", line = 96)
