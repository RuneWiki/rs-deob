...
public class class695 {
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Lnp;I)V", line = 50)
    ...
    @OriginalMember(owner = "client!uca", name = "b", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Ljava/lang/String;Lr;Lla;ZLho;Z)V", line = 84)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(IILnp;)V", line = 171)
