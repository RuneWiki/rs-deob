...
public class Isaac {
    ...
    @OriginalMember(owner = "xb", name = "<init>", descriptor = "(Z[I)V")
    public Isaac(boolean arg0, int[] arg1) {
        if (!arg0) {
            this.field860 = 414;
        }
        this.field863 = new int[256];
        this.field862 = new int[256];
        for (int var3 = 0; var3 < arg1.length; var3++) {
            this.field862[var3] = arg1[var3];
        }
        this.method296();
    }
    ...
    private final void method295() {
        ...
        for (int var1 = 0; var1 < 256; var1++) {
            ...
            this.field864 += this.field863[var1 + 128 & 0xFF];
            int var3;
            this.field863[var1] = var3 = this.field863[var2 >> 2 & 0xFF] + this.field864 + this.field865;
            this.field862[var1] = this.field865 = this.field863[var3 >> 8 >> 2 & 0xFF] + var2;
        }
    }
    ...
    private final void method296() {
        ...
        for (int var10 = 0; var10 < 256; var10 += 8) {
            int var36 = this.field862[var10] + var8;
            int var37 = this.field862[var10 + 1] + var7;
            int var38 = this.field862[var10 + 2] + var6;
            int var39 = this.field862[var10 + 3] + var5;
            int var40 = this.field862[var10 + 4] + var4;
            int var41 = this.field862[var10 + 5] + var3;
            int var42 = this.field862[var10 + 6] + var2;
            int var43 = this.field862[var10 + 7] + var1;
            ...
            var6 = var1 + var50;
            var8 = var7 + var57;
            this.field863[var10] = var8;
            this.field863[var10 + 1] = var7;
            this.field863[var10 + 2] = var6;
            this.field863[var10 + 3] = var5;
            this.field863[var10 + 4] = var4;
            this.field863[var10 + 5] = var3;
            this.field863[var10 + 6] = var2;
            this.field863[var10 + 7] = var1;
        }
        for (int var11 = 0; var11 < 256; var11 += 8) {
            int var12 = this.field863[var11] + var8;
            int var13 = this.field863[var11 + 1] + var7;
            int var14 = this.field863[var11 + 2] + var6;
            int var15 = this.field863[var11 + 3] + var5;
            int var16 = this.field863[var11 + 4] + var4;
            int var17 = this.field863[var11 + 5] + var3;
            int var18 = this.field863[var11 + 6] + var2;
            int var19 = this.field863[var11 + 7] + var1;
            ...
            var6 = var1 + var26;
            var8 = var7 + var33;
            this.field863[var11] = var8;
            this.field863[var11 + 1] = var7;
            this.field863[var11 + 2] = var6;
            this.field863[var11 + 3] = var5;
            this.field863[var11 + 4] = var4;
            this.field863[var11 + 5] = var3;
            this.field863[var11 + 6] = var2;
            this.field863[var11 + 7] = var1;
        }
        this.method295();
        this.field861 = 256;
    }
