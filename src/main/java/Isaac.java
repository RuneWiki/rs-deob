...
@OriginalClass("JOCFVBOI")
public class Isaac {

    @OriginalMember(owner = "JOCFVBOI", name = "a", descriptor = "I")
    private int _flowObfuscator1 = -436;

    @OriginalMember(owner = "JOCFVBOI", name = "b", descriptor = "I")
    private int _flowObfuscator2 = -431;

    @OriginalMember(owner = "JOCFVBOI", name = "e", descriptor = "[I")
    private int[] mem = new int[256];

    @OriginalMember(owner = "JOCFVBOI", name = "d", descriptor = "[I")
    private int[] rsl = new int[256];

    @OriginalMember(owner = "JOCFVBOI", name = "f", descriptor = "I")
    private int a;

    @OriginalMember(owner = "JOCFVBOI", name = "g", descriptor = "I")
    private int b;

    @OriginalMember(owner = "JOCFVBOI", name = "h", descriptor = "I")
    private int c;

    @OriginalMember(owner = "JOCFVBOI", name = "c", descriptor = "I")
    private int count;

    @OriginalMember(owner = "JOCFVBOI", name = "<init>", descriptor = "(I[I)V")
    ...
    @OriginalMember(owner = "JOCFVBOI", name = "b", descriptor = "()V")
    ...
    @OriginalMember(owner = "JOCFVBOI", name = "c", descriptor = "()V")
