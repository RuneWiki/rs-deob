...
public class Isaac {
    ...
    private int[] field728 = new int[256];
    ...
    public Isaac(int[] arg0, int arg1) {
        if (arg1 < this.field725 || arg1 > this.field725) {
            this.field725 = -37;
        }
        this.field727 = new int[256];
        for (int var3 = 0; var3 < arg0.length; var3++) {
            this.field727[var3] = arg0[var3];
        }
        this.method248();
    }
    ...
    public final int method246() {
        ...
        return this.field727[this.field726];
    }

    @OriginalMember(owner = "tb", name = "b", descriptor = "()V")
    private final void method247() {
        this.field730 += ++this.field731;
        for (int var1 = 0; var1 < 256; var1++) {
            int var2 = this.field728[var1];
            switch(var1 & 0x3) {
                case 0:
                    this.field729 ^= this.field729 << 13;
                    break;
                case 1:
                    this.field729 ^= this.field729 >>> 6;
                    break;
                case 2:
                    this.field729 ^= this.field729 << 2;
                    break;
                case 3:
                    this.field729 ^= this.field729 >>> 16;
            }
            this.field729 += this.field728[var1 + 128 & 0xFF];
            int var3;
            this.field728[var1] = var3 = this.field728[var2 >> 2 & 0xFF] + this.field729 + this.field730;
            this.field727[var1] = this.field730 = this.field728[var3 >> 8 >> 2 & 0xFF] + var2;
        }
    }
    ...
    private final void method248() {
        ...
        for (int var10 = 0; var10 < 256; var10 += 8) {
            int var36 = this.field727[var10] + var8;
            int var37 = this.field727[var10 + 1] + var7;
            int var38 = this.field727[var10 + 2] + var6;
            int var39 = this.field727[var10 + 3] + var5;
            int var40 = this.field727[var10 + 4] + var4;
            int var41 = this.field727[var10 + 5] + var3;
            int var42 = this.field727[var10 + 6] + var2;
            int var43 = this.field727[var10 + 7] + var1;
            ...
            var6 = var1 + var50;
            var8 = var7 + var57;
            this.field728[var10] = var8;
            this.field728[var10 + 1] = var7;
            this.field728[var10 + 2] = var6;
            this.field728[var10 + 3] = var5;
            this.field728[var10 + 4] = var4;
            this.field728[var10 + 5] = var3;
            this.field728[var10 + 6] = var2;
            this.field728[var10 + 7] = var1;
        }
        for (int var11 = 0; var11 < 256; var11 += 8) {
            int var12 = this.field728[var11] + var8;
            int var13 = this.field728[var11 + 1] + var7;
            int var14 = this.field728[var11 + 2] + var6;
            int var15 = this.field728[var11 + 3] + var5;
            int var16 = this.field728[var11 + 4] + var4;
            int var17 = this.field728[var11 + 5] + var3;
            int var18 = this.field728[var11 + 6] + var2;
            int var19 = this.field728[var11 + 7] + var1;
            ...
            var6 = var1 + var26;
            var8 = var7 + var33;
            this.field728[var11] = var8;
            this.field728[var11 + 1] = var7;
            this.field728[var11 + 2] = var6;
            this.field728[var11 + 3] = var5;
            this.field728[var11 + 4] = var4;
            this.field728[var11 + 5] = var3;
            this.field728[var11 + 6] = var2;
            this.field728[var11 + 7] = var1;
        }
        this.method247();
        this.field726 = 256;
    }
