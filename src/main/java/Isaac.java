...
public class Isaac {
    ...
    private int[] field729 = new int[256];
    ...
    public final int method253() {
        ...
        return this.field728[this.field727];
    }
    ...
    private final void method254() {
        ...
        for (int var1 = 0; var1 < 256; var1++) {
            int var2 = this.field729[var1];
            switch(var1 & 0x3) {
                case 0:
                    this.field730 ^= this.field730 << 13;
                    break;
                case 1:
                    this.field730 ^= this.field730 >>> 6;
                    break;
                case 2:
                    this.field730 ^= this.field730 << 2;
                    break;
                case 3:
                    this.field730 ^= this.field730 >>> 16;
            }
            this.field730 += this.field729[var1 + 128 & 0xFF];
            int var3;
            this.field729[var1] = var3 = this.field729[var2 >> 2 & 0xFF] + this.field730 + this.field731;
            this.field728[var1] = this.field731 = this.field729[var3 >> 8 >> 2 & 0xFF] + var2;
        }
    }
    ...
    private final void method255() {
        ...
        for (int var10 = 0; var10 < 256; var10 += 8) {
            int var36 = this.field728[var10] + var8;
            int var37 = this.field728[var10 + 1] + var7;
            int var38 = this.field728[var10 + 2] + var6;
            int var39 = this.field728[var10 + 3] + var5;
            int var40 = this.field728[var10 + 4] + var4;
            int var41 = this.field728[var10 + 5] + var3;
            int var42 = this.field728[var10 + 6] + var2;
            int var43 = this.field728[var10 + 7] + var1;
            ...
            var6 = var1 + var50;
            var8 = var7 + var57;
            this.field729[var10] = var8;
            this.field729[var10 + 1] = var7;
            this.field729[var10 + 2] = var6;
            this.field729[var10 + 3] = var5;
            this.field729[var10 + 4] = var4;
            this.field729[var10 + 5] = var3;
            this.field729[var10 + 6] = var2;
            this.field729[var10 + 7] = var1;
        }
        for (int var11 = 0; var11 < 256; var11 += 8) {
            int var12 = this.field729[var11] + var8;
            int var13 = this.field729[var11 + 1] + var7;
            int var14 = this.field729[var11 + 2] + var6;
            int var15 = this.field729[var11 + 3] + var5;
            int var16 = this.field729[var11 + 4] + var4;
            int var17 = this.field729[var11 + 5] + var3;
            int var18 = this.field729[var11 + 6] + var2;
            int var19 = this.field729[var11 + 7] + var1;
            ...
            var6 = var1 + var26;
            var8 = var7 + var33;
            this.field729[var11] = var8;
            this.field729[var11 + 1] = var7;
            this.field729[var11 + 2] = var6;
            this.field729[var11 + 3] = var5;
            this.field729[var11 + 4] = var4;
            this.field729[var11 + 5] = var3;
            this.field729[var11 + 6] = var2;
            this.field729[var11 + 7] = var1;
        }
        this.method254();
        this.field727 = 256;
    }
