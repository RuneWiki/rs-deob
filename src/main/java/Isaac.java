...
public class Isaac {
    ...
    private int[] field864 = new int[256];

    @OriginalMember(owner = "wb", name = "b", descriptor = "[I")
    private int[] field863 = new int[256];
    ...
    public final int method295() {
        ...
        return this.field863[this.field862];
    }

    @OriginalMember(owner = "wb", name = "b", descriptor = "()V")
    private final void method296() {
        this.field866 += ++this.field867;
        for (int var1 = 0; var1 < 256; var1++) {
            int var2 = this.field864[var1];
            switch(var1 & 0x3) {
                case 0:
                    this.field865 ^= this.field865 << 13;
                    break;
                case 1:
                    this.field865 ^= this.field865 >>> 6;
                    break;
                case 2:
                    this.field865 ^= this.field865 << 2;
                    break;
                case 3:
                    this.field865 ^= this.field865 >>> 16;
            }
            this.field865 += this.field864[var1 + 128 & 0xFF];
            int var3;
            this.field864[var1] = var3 = this.field864[var2 >> 2 & 0xFF] + this.field865 + this.field866;
            this.field863[var1] = this.field866 = this.field864[var3 >> 8 >> 2 & 0xFF] + var2;
        }
    }
    ...
    private final void method297() {
        ...
        for (int var10 = 0; var10 < 256; var10 += 8) {
            int var36 = this.field863[var10] + var8;
            int var37 = this.field863[var10 + 1] + var7;
            int var38 = this.field863[var10 + 2] + var6;
            int var39 = this.field863[var10 + 3] + var5;
            int var40 = this.field863[var10 + 4] + var4;
            int var41 = this.field863[var10 + 5] + var3;
            int var42 = this.field863[var10 + 6] + var2;
            int var43 = this.field863[var10 + 7] + var1;
            ...
            var6 = var1 + var50;
            var8 = var7 + var57;
            this.field864[var10] = var8;
            this.field864[var10 + 1] = var7;
            this.field864[var10 + 2] = var6;
            this.field864[var10 + 3] = var5;
            this.field864[var10 + 4] = var4;
            this.field864[var10 + 5] = var3;
            this.field864[var10 + 6] = var2;
            this.field864[var10 + 7] = var1;
        }
        for (int var11 = 0; var11 < 256; var11 += 8) {
            int var12 = this.field864[var11] + var8;
            int var13 = this.field864[var11 + 1] + var7;
            int var14 = this.field864[var11 + 2] + var6;
            int var15 = this.field864[var11 + 3] + var5;
            int var16 = this.field864[var11 + 4] + var4;
            int var17 = this.field864[var11 + 5] + var3;
            int var18 = this.field864[var11 + 6] + var2;
            int var19 = this.field864[var11 + 7] + var1;
            ...
            var6 = var1 + var26;
            var8 = var7 + var33;
            this.field864[var11] = var8;
            this.field864[var11 + 1] = var7;
            this.field864[var11 + 2] = var6;
            this.field864[var11 + 3] = var5;
            this.field864[var11 + 4] = var4;
            this.field864[var11 + 5] = var3;
            this.field864[var11 + 6] = var2;
            this.field864[var11 + 7] = var1;
        }
        this.method296();
        this.field862 = 256;
    }
