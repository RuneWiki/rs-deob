...
public class Isaac {
    ...
    private int[] field726 = new int[256];
    ...
    public final int method245() {
        ...
        return this.field726[this.field725];
    }

    @OriginalMember(owner = "tb", name = "b", descriptor = "()V")
    private final void method246() {
        this.field729 += ++this.field730;
        for (int var1 = 0; var1 < 256; var1++) {
            int var2 = this.field727[var1];
            switch(var1 & 0x3) {
                case 0:
                    this.field728 ^= this.field728 << 13;
                    break;
                case 1:
                    this.field728 ^= this.field728 >>> 6;
                    break;
                case 2:
                    this.field728 ^= this.field728 << 2;
                    break;
                case 3:
                    this.field728 ^= this.field728 >>> 16;
            }
            this.field728 += this.field727[var1 + 128 & 0xFF];
            int var3;
            this.field727[var1] = var3 = this.field727[var2 >> 2 & 0xFF] + this.field728 + this.field729;
            this.field726[var1] = this.field729 = this.field727[var3 >> 8 >> 2 & 0xFF] + var2;
        }
    }
    ...
    private final void method247() {
        ...
        for (int var10 = 0; var10 < 256; var10 += 8) {
            int var36 = this.field726[var10] + var8;
            int var37 = this.field726[var10 + 1] + var7;
            int var38 = this.field726[var10 + 2] + var6;
            int var39 = this.field726[var10 + 3] + var5;
            int var40 = this.field726[var10 + 4] + var4;
            int var41 = this.field726[var10 + 5] + var3;
            int var42 = this.field726[var10 + 6] + var2;
            int var43 = this.field726[var10 + 7] + var1;
            ...
            var6 = var1 + var50;
            var8 = var7 + var57;
            this.field727[var10] = var8;
            this.field727[var10 + 1] = var7;
            this.field727[var10 + 2] = var6;
            this.field727[var10 + 3] = var5;
            this.field727[var10 + 4] = var4;
            this.field727[var10 + 5] = var3;
            this.field727[var10 + 6] = var2;
            this.field727[var10 + 7] = var1;
        }
        for (int var11 = 0; var11 < 256; var11 += 8) {
            int var12 = this.field727[var11] + var8;
            int var13 = this.field727[var11 + 1] + var7;
            int var14 = this.field727[var11 + 2] + var6;
            int var15 = this.field727[var11 + 3] + var5;
            int var16 = this.field727[var11 + 4] + var4;
            int var17 = this.field727[var11 + 5] + var3;
            int var18 = this.field727[var11 + 6] + var2;
            int var19 = this.field727[var11 + 7] + var1;
            ...
            var6 = var1 + var26;
            var8 = var7 + var33;
            this.field727[var11] = var8;
            this.field727[var11 + 1] = var7;
            this.field727[var11 + 2] = var6;
            this.field727[var11 + 3] = var5;
            this.field727[var11 + 4] = var4;
            this.field727[var11 + 5] = var3;
            this.field727[var11 + 6] = var2;
            this.field727[var11 + 7] = var1;
        }
        this.method246();
        this.field725 = 256;
    }
