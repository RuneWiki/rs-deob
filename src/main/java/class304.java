...
public class class304 extends class398 {
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(B[Ljava/lang/String;[S)V")
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(ILvaa;B)V")
    ...
    @OriginalMember(owner = "client!ww", name = "<init>", descriptor = "(Luca;)V")
