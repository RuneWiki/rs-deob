...
public abstract class class304 {
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(III)Z", line = 17)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(II)I", line = 28)
    public static final int method1827(int arg0, int arg1) {
        return class703.field9910 == null ? 0 : class703.field9910[arg0][arg1] & 0xFF;
    }

    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(IIIILkw;)V", line = 44)
