...
public class class304 extends class194 {
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "(Lbl;II)V")
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "(Lbl;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "(Lbl;IIZ[[BI)V")
