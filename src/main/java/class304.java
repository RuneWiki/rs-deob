...
public class class304 extends class45 {
    ...
    @OriginalMember(owner = "client!dj", name = "b", descriptor = "(B)I", line = 11)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IZ)V", line = 23)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IIII)I", line = 40)
    ...
    @OriginalMember(owner = "client!dj", name = "c", descriptor = "(I)Z", line = 51)
    ...
    @OriginalMember(owner = "client!dj", name = "d", descriptor = "(I)Z", line = 76)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Z)V", line = 87)
    ...
    @OriginalMember(owner = "client!dj", name = "e", descriptor = "(I)Z", line = 101)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(II)Z", line = 115)
    ...
    @OriginalMember(owner = "client!dj", name = "f", descriptor = "(I)Z", line = 127)
    ...
    @OriginalMember(owner = "client!dj", name = "g", descriptor = "(I)Z", line = 142)
    ...
    @OriginalMember(owner = "client!dj", name = "h", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!dj", name = "i", descriptor = "(I)I", line = 170)
    ...
    @OriginalMember(owner = "client!dj", name = "<init>", descriptor = "(II)V", line = 179)
    public class304(int arg0, int arg1) {
        this.field4475 = arg0;
        this.field4474 = arg1;
    }

    @OriginalMember(owner = "client!dj", name = "j", descriptor = "(I)Z", line = 189)
