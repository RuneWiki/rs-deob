...
public class class304 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IIIIILrb;)Lib;")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Ljava/lang/String;ILcu;)I")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ILli;I)I")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Ljava/awt/Component;I)Luv;")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IB)Leo;")
    ...
    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "(Loq;ILbu;)V")
