...
public class class304 extends class606 {
    ...
    @OriginalMember(owner = "client!vw", name = "<init>", descriptor = "(Ltg;Lfp;)V")
    ...
    @OriginalMember(owner = "client!vw", name = "d", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(Lma;II)V")
