...
public abstract class class304 {
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(II)Ljava/lang/String;", line = 8)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "([BI)Ltg;", line = 19)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIIIIIIIILcf;Lur;Z)V", line = 121)
    ...
    @OriginalMember(owner = "client!ao", name = "c", descriptor = "(I)V", line = 155)
