...
public class class304 extends class86 {
    ...
    @OriginalMember(owner = "client!sj", name = "d", descriptor = "(B)V", line = 9)
    public static void method1827(byte arg0) {
        field4411 = null;
        int var1 = 106 / ((arg0 - 20) / 50);
    }

    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(B[B)[B", line = 18)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(BII)V", line = 35)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(BLae;)Laf;", line = 51)
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "()V", line = 61)
    public class304() {
    }

    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "(I)V", line = 66)
