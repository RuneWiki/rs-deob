...
public class class304 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Ljava/lang/Throwable;I)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(I)Z", line = 79)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!tg", name = "c", descriptor = "(I)Lsa;", line = 114)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(B)I", line = 140)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILsa;)V", line = 183)
    ...
    @OriginalMember(owner = "client!tg", name = "d", descriptor = "(I)Lsa;", line = 200)
    ...
    @OriginalMember(owner = "client!tg", name = "e", descriptor = "(I)Lsa;", line = 218)
    ...
    @OriginalMember(owner = "client!tg", name = "f", descriptor = "(I)I", line = 241)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(B)Lsa;", line = 264)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(III)I", line = 287)
    ...
    @OriginalMember(owner = "client!tg", name = "c", descriptor = "(B)V", line = 302)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IIIIIII)V", line = 324)
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "()V", line = 354)
    public class304() {
