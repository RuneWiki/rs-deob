...
public class class304 extends class287 {
    ...
    @OriginalMember(owner = "client!vj", name = "d", descriptor = "(I)J", line = 3)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!vj", name = "c", descriptor = "(I)J", line = 56)
    ...
    @OriginalMember(owner = "client!vj", name = "b", descriptor = "(II)I", line = 66)
