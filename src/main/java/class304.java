...
public class class304 extends class461 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Lpba;)V", line = 3)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Lmi;)V", line = 18)
    public final synchronized void method1802(class461 arg0) {
        this.field4061.method1133(arg0, -121);
    }

    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "()Lmi;", line = 82)
    public final class461 method1229() {
        return (class461) this.field4061.method1132((byte) -118);
    }

    @OriginalMember(owner = "client!bb", name = "d", descriptor = "()I", line = 87)
    public final int method1223() {
        return 0;
    }

    @OriginalMember(owner = "client!bb", name = "c", descriptor = "([III)V", line = 92)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "([III)V", line = 105)
    ...
    @OriginalMember(owner = "client!bb", name = "c", descriptor = "()Lmi;", line = 150)
    public final class461 method1221() {
        return (class461) this.field4061.method1134(8446);
    }

    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(Lmi;)V", line = 157)
    public final synchronized void method1805(class461 arg0) {
        arg0.method3045(true);
    }

    @OriginalMember(owner = "client!bb", name = "e", descriptor = "()I", line = 161)
    public final synchronized int method1806() {
        return this.field4061.method1142(-22382);
    }

    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Lii;Lpba;)V", line = 169)
    ...
    @OriginalMember(owner = "client!bb", name = "f", descriptor = "()V", line = 178)
