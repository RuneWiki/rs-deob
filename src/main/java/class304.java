...
public class class304 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Ljc;I)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Ljp;ILjp;)V")
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "(Lih;II)V")
