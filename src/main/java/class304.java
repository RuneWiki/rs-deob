...
public class class304 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Lsi;BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(B)Lqm;", line = 26)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Lsi;I)V", line = 71)
