...
public class class304 extends class390 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lms;I)Lms;")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(ILnj;Ljm;IIIIZLuo;I)Lmj;")
    ...
    @OriginalMember(owner = "client!cb", name = "c", descriptor = "(I)[Ldp;")
