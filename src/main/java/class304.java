...
public class class304 {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Lil;)V", line = 4)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "()V", line = 21)
    ...
    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(Lil;)V", line = 31)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(I)I", line = 38)
    ...
    @OriginalMember(owner = "client!bd", name = "<init>", descriptor = "()V", line = 55)
    public class304() {
        this.field4354[0] = 0;
