...
public class class304 extends class194 {
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(Lfv;Lmj;[Lkq;[I[I)V")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(CIIIZLfa;II)V")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "([B[IIIIIIIIIIILfa;II)V")
