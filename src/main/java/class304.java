...
public class class304 extends class119 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IIILaq;IIILem;I)V")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Lip;[[B[[B[[I[[BZILuo;II[[BBLip;)V")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Luo;Lpc;IIIII)V")
