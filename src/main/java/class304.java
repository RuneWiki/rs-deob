...
public class class304 {
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BLjagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 15)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(I)Z", line = 27)
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 37)
    public class304(IDirect3DSwapChain arg0, IDirect3DSurface arg1) {
        this.method1810((byte) 7, arg0, arg1);
    }

    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(B)V", line = 46)
