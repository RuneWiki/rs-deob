...
public class class304 extends class645 {
    ...
    @OriginalMember(owner = "client!vt", name = "q", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!vt", name = "l", descriptor = "(II)I", line = 21)
    ...
    @OriginalMember(owner = "client!vt", name = "r", descriptor = "(B)I", line = 52)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "([BIII)V", line = 69)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(ILhd;)V", line = 83)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "([SI)[S", line = 98)
    ...
    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "(I)V", line = 115)
    public class304(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!vt", name = "a", descriptor = "([II)V", line = 122)
    ...
    @OriginalMember(owner = "client!vt", name = "e", descriptor = "(Z)V", line = 133)
    ...
    @OriginalMember(owner = "client!vt", name = "m", descriptor = "(II)V", line = 146)
    ...
    @OriginalMember(owner = "client!vt", name = "r", descriptor = "(I)Z", line = 159)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(IIILica;Lica;)V", line = 183)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Lrg;I)Lap;", line = 241)
    ...
    @OriginalMember(owner = "client!vt", name = "n", descriptor = "(II)I", line = 278)
    ...
    @OriginalMember(owner = "client!vt", name = "s", descriptor = "(B)V", line = 292)
