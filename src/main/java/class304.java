...
public class class304 extends class209 {
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(Lpo;)V", line = 12)
    public class304(class332 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "()Z", line = 22)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(ILfc;Lfc;)V", line = 51)
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "()V", line = 198)
    ...
    @OriginalMember(owner = "client!cb", name = "e", descriptor = "()Z", line = 210)
    public final boolean method1912() {
        return this.field2828.field4862 && this.field2828.field4835 && this.field2828.field4851;
    }

    @OriginalMember(owner = "client!cb", name = "d", descriptor = "()Z", line = 215)
    public final boolean method1327() {
        return this.field4354 != null;
    }

    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(II)V", line = 224)
    ...
    @OriginalMember(owner = "client!cb", name = "c", descriptor = "()I", line = 301)
