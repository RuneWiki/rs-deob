...
public class class304 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IB)I", line = 7)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(Z)Z", line = 20)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(I)V", line = 137)
