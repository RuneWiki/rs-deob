...
public class class304 extends class393 {
    ...
    @OriginalMember(owner = "client!pda", name = "c", descriptor = "(B)I", line = 11)
    ...
    @OriginalMember(owner = "client!pda", name = "d", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!pda", name = "b", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(III)Lft;", line = 93)
    ...
    @OriginalMember(owner = "client!pda", name = "c", descriptor = "(I)I", line = 369)
    public final int method1738(int arg0) {
        field3729++;
        return arg0 == -14311 ? this.field3734 : 76;
    }

    @OriginalMember(owner = "client!pda", name = "d", descriptor = "(I)V", line = 380)
    ...
    @OriginalMember(owner = "client!pda", name = "e", descriptor = "(I)V", line = 564)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(Z)I", line = 577)
    ...
    @OriginalMember(owner = "client!pda", name = "b", descriptor = "(Z)I", line = 605)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(B)Lds;", line = 623)
    ...
    @OriginalMember(owner = "client!pda", name = "f", descriptor = "(I)V", line = 720)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(II)V", line = 1590)
    ...
    @OriginalMember(owner = "client!pda", name = "d", descriptor = "(II)V", line = 1619)
    ...
    @OriginalMember(owner = "client!pda", name = "b", descriptor = "(II)[B", line = 1636)
    ...
    @OriginalMember(owner = "client!pda", name = "<init>", descriptor = "(ILlf;Llf;Luaa;Lth;I[BIZ)V", line = 1704)
    ...
    @OriginalMember(owner = "client!pda", name = "c", descriptor = "(II)I", line = 1669)
