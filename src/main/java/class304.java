...
public class class304 extends class130 {
    ...
    @OriginalMember(owner = "client!cb", name = "j", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!cb", name = "k", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!cb", name = "n", descriptor = "(II)V", line = 35)
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(I)V", line = 46)
    public class304(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(I[I)V", line = 50)
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(BI)I", line = 62)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "([BBII)V", line = 74)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IIII)V", line = 97)
    ...
    @OriginalMember(owner = "client!cb", name = "c", descriptor = "(BI)I", line = 104)
    ...
    @OriginalMember(owner = "client!cb", name = "t", descriptor = "(I)V", line = 136)
