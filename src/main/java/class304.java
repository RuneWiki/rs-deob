...
public class class304 extends class669 {
    ...
    @OriginalMember(owner = "client!ofa", name = "b", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!ofa", name = "<init>", descriptor = "(Lej;)V")
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(IILnq;)V")
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(Loa;ILbd;IIB)V")
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(III)Ll;")
