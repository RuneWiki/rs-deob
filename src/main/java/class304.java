...
public class class304 extends class331 implements class289 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(ILoa;)V", line = 26)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(BLoa;)V", line = 39)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Z)Z", line = 51)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(IIILul;)V", line = 62)
    public class304(int arg0, int arg1, int arg2, class331 arg3) {
        super(arg0, arg1, arg2, arg3.field4842, false, false);
        this.field4086 = arg3;
    }

    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Lbo;ILoa;IIIZ)V", line = 71)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(I)I", line = 87)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ILjava/lang/String;)I", line = 98)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(I)I", line = 121)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IIILoa;)Z", line = 133)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Loa;B)Llt;", line = 145)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IILoa;)Lba;", line = 156)
    ...
    @OriginalMember(owner = "client!hq", name = "c", descriptor = "(I)V", line = 168)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ILoa;)V", line = 178)
    ...
    @OriginalMember(owner = "client!hq", name = "e", descriptor = "(I)Z", line = 188)
    ...
    @OriginalMember(owner = "client!hq", name = "g", descriptor = "(I)V", line = 201)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(B)V", line = 281)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(BLoa;)Lvg;", line = 295)
