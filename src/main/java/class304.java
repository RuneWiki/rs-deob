...
public class class304 extends class289 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(III)[B", line = 12)
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "()V", line = 17)
    public class304() {
