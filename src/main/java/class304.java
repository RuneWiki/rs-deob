...
public abstract class class304 implements class329 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "([IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IBII)I", line = 174)
    ...
    @OriginalMember(owner = "client!ft", name = "c", descriptor = "(B)I", line = 199)
    ...
    @OriginalMember(owner = "client!ft", name = "e", descriptor = "(I)V", line = 212)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Lbba;I)V", line = 225)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Z)V", line = 241)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "([BIIII)V", line = 263)
    ...
    @OriginalMember(owner = "client!ft", name = "c", descriptor = "(I)V", line = 366)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IIZII[[[Lfu;)Z", line = 395)
    ...
    @OriginalMember(owner = "client!ft", name = "finalize", descriptor = "()V", line = 722)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(I[FIII)V", line = 732)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IZ)V", line = 830)
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(Lck;ILem;Lew;IZ)V", line = 956)
    ...
    @OriginalMember(owner = "client!ft", name = "f", descriptor = "(I)V", line = 845)
    ...
    @OriginalMember(owner = "client!ft", name = "g", descriptor = "(I)I", line = 862)
