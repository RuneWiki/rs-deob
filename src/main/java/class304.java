...
public class class304 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(ILuo;)I")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lwq;B)V")
