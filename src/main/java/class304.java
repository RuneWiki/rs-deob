...
public class class304 extends class577 {
    ...
    @OriginalMember(owner = "client!jfa", name = "b", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(BLnq;)Z", line = 16)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(I)V", line = 43)
