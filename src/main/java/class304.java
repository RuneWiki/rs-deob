...
public abstract class class304 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(IBI)Z", line = 16)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!ip", name = "b", descriptor = "(I)Ljava/net/Socket;", line = 64)
