...
public class class304 extends class46 {
    ...
    @OriginalMember(owner = "client!jfa", name = "c", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(BII)V", line = 23)
    ...
    @OriginalMember(owner = "client!jfa", name = "<init>", descriptor = "(Ldga;)V", line = 115)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(III)Z", line = 123)
