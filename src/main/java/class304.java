...
public class class304 extends class257 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(B)I", line = 7)
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!io", name = "d", descriptor = "(III)Z", line = 70)
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(Z)[B", line = 81)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Ljava/awt/Component;ZB)Lnb;", line = 106)
    ...
    @OriginalMember(owner = "client!io", name = "j", descriptor = "(I)V", line = 117)
