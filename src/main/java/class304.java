...
public class class304 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(ILcp;Ltq;)V")
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(JB)Lbk;")
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(JLbk;B)V")
