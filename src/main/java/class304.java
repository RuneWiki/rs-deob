...
public class class304 extends class730 implements class94 {
    ...
    @OriginalMember(owner = "client!ria", name = "b", descriptor = "(B)J", line = 7)
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(IIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(Z)I", line = 198)
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(I)V", line = 214)
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(II[BB)V", line = 231)
    ...
    @OriginalMember(owner = "client!ria", name = "<init>", descriptor = "(Lml;I[BI)V", line = 246)
    ...
    @OriginalMember(owner = "client!ria", name = "<init>", descriptor = "(Lml;ILjaclib/memory/Buffer;)V", line = 255)
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(B)I", line = 267)
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(ZLlga;I)Ltb;", line = 278)
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(ZLjava/lang/String;)I", line = 302)
