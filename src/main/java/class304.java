...
public class class304 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 8)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(II)Lri;", line = 34)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "(II)V", line = 82)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!hm", name = "<init>", descriptor = "(Lci;ILg;)V", line = 139)
