...
public class class304 implements Runnable {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Ljava/net/URL;I)Lid;")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(I)Lid;")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(ILjava/lang/String;)Lid;")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(BZLjava/awt/Component;)Lid;")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(BLjava/lang/Class;)Lid;")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Ljava/awt/Component;BII)Lid;")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IILjava/lang/Object;IB)Lid;")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(B)Lid;")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(ILjava/lang/Class;)Lid;")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IILjava/lang/Runnable;)Lid;")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Ljava/awt/Frame;I)Lid;")
    public final class242 method1951(Frame arg0, int arg1) {
        return arg1 == 0 ? this.method1962(7, arg0, 0, 0, 0) : null;
    }

    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(BIIII)Lid;")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(II)Lid;")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(ILjava/lang/String;I)Lid;")
    public final class242 method1955(int arg0, String arg1, int arg2) {
        return arg2 >= -16 ? null : this.method1962(1, arg1, arg0, 0, 0);
    }

    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(ILjava/lang/String;[Ljava/lang/Class;Ljava/lang/Class;)Lid;")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Z)Lro;")
    public final class250 method1957(boolean arg0) {
        return arg0 ? this.field4127 : null;
    }

    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(I)Lid;")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;I)Lid;")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;B)Lid;")
    ...
    @OriginalMember(owner = "client!bd", name = "c", descriptor = "(I)Lid;")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(ILjava/lang/Object;III)Lid;")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Ljava/lang/Class;I)Lid;")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IILjava/awt/Point;I[ILjava/awt/Component;)Lid;")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Ljava/lang/String;B)Lid;")
