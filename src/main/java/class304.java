...
public class class304 extends class522 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(II[[B[I[BI[[B[I)I", line = 5)
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 359)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IIII[BI[BII)V", line = 72)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!bn", name = "c", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!bn", name = "e", descriptor = "(I)Z", line = 144)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Lht;B)V", line = 155)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(BI)V", line = 166)
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(I)V", line = 196)
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(Lya;I)Lmo;", line = 233)
    ...
    @OriginalMember(owner = "client!bn", name = "g", descriptor = "(I)I", line = 265)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(ILya;II)Z", line = 277)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Lya;IIILqj;IZ)V", line = 296)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Lya;I)V", line = 306)
    ...
    @OriginalMember(owner = "client!bn", name = "finalize", descriptor = "()V", line = 322)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Lok;IIIBZI)V", line = 340)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Lt;Lya;I)V", line = 393)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IIILya;)Lt;", line = 417)
