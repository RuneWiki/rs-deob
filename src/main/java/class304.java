...
public class class304 extends class42 {
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IIZILkg;IIBLqa;Lgv;)Lka;")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(ILl;Lqa;IIIB)V")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(III)Lbl;")
