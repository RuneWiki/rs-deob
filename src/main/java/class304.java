...
public class class304 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IILk;I)V")
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IBILk;)Z")
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(IILk;I)V")
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(Lkw;Leo;)V")
