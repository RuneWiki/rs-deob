...
public class class304 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lfca;I)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lkka;I)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IILfca;)V")
