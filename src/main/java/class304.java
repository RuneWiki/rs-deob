...
public class class304 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(B)Lvg;")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Lou;I)Z")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(I)Lvg;")
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "(Lqo;)V")
