...
public class class633 extends class9 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IZZIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IB)V", line = 51)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IC)Z", line = 69)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(Lrj;)V", line = 105)
