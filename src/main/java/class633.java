...
public class class633 extends class763 implements class248 {
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lpa;Lsw;II[FII)V")
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lpa;Lsw;Lig;II)V")
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lpa;Lsw;II[BII)V")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lsw;IIII[BIII)V")
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lpa;II[III)V")
