...
public class class633 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(II)Liaa;")
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IB)Lmga;")
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(Lsaa;ILfp;Lfp;Lfp;)V")
