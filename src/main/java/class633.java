...
public class class633 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lbt;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(BLiq;)Z", line = 30)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(III)V", line = 54)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Z)V", line = 70)
