...
public class class633 extends class759 implements class399 {
    ...
    @OriginalMember(owner = "client!cb", name = "c", descriptor = "(I)J", line = 4)
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(I)I", line = 23)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(I)I", line = 35)
    ...
    @OriginalMember(owner = "client!cb", name = "d", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(II[BI)V", line = 57)
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(Ldw;I[BI)V", line = 69)
    public class633(class664 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field8517 = arg1;
    }

    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(II)I", line = 79)
