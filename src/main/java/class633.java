...
public class class633 {
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(BII)V", line = 18)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(ZLjava/lang/String;Ljava/lang/String;C)Ljava/lang/String;", line = 45)
