...
public class class633 extends class515 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IIIILup;[I)V")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "()Lef;")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ILup;I)V")
    ...
    @OriginalMember(owner = "client!iq", name = "d", descriptor = "()Lef;")
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Leg;)V")
