...
public class class633 {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IIILpg;)V", line = 5)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(JI)V", line = 36)
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "(ILjava/lang/String;ILjava/lang/String;J)V", line = 123)
