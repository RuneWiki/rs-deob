...
public class class633 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(ZLoa;ZI)Lxa;", line = 8)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(I)V", line = 53)
    public static void method3516(int arg0) {
        field8868 = null;
        int var1 = 48 / ((arg0 - 20) / 62);
    }

    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Ljr;I)V", line = 65)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(ZII)Liaa;", line = 96)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(ILjr;I)V", line = 116)
    ...
    @OriginalMember(owner = "client!jm", name = "b", descriptor = "(I)Z", line = 152)
