...
public class class633 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Luq;II)Llj;", line = 5)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "()[B", line = 17)
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "()Lpv;", line = 76)
    ...
    @OriginalMember(owner = "client!lj", name = "c", descriptor = "()I", line = 82)
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(Ldt;)V", line = 129)
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "()V", line = 149)
    private class633() {
    }
}
