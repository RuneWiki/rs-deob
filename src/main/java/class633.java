...
public class class633 implements class450 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Lha;Lfo;IILtl;I)Z")
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ILda;ILjava/lang/String;II)I")
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(Lkv;Lhu;)V")
