...
public class class633 extends class703 {
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(I)I", line = 4)
    public final int method3022(int arg0) {
        return arg0 <= 29 ? 46 : this.field8884;
    }

    @OriginalMember(owner = "client!fca", name = "c", descriptor = "(I)I", line = 14)
    ...
    @OriginalMember(owner = "client!fca", name = "b", descriptor = "(I)I", line = 28)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(Z)J", line = 41)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(B)I", line = 51)
