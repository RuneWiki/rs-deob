...
public class class633 extends class396 {
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "(Lep;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "(Lep;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "(Lep;II)V")
