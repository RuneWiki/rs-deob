...
public class class633 extends class513 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(B)I", line = 6)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lkfa;)V", line = 31)
