...
public class class633 implements class186 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!mh", name = "c", descriptor = "(I)Z", line = 24)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 35)
    ...
    @OriginalMember(owner = "client!mh", name = "b", descriptor = "(Ljava/lang/String;I)J", line = 49)
    ...
    @OriginalMember(owner = "client!mh", name = "b", descriptor = "(I)Lqia;", line = 92)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(CI)C", line = 104)
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 496)
