...
public class class633 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "([BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Llea;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Llea;Ljaclib/memory/Buffer;)V", line = 21)
