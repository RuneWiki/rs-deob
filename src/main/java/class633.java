...
public class class633 {
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(IF)I", line = 4)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Lek;Lrc;)V", line = 64)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(F)F", line = 131)
    private static final float method3568(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!bm", name = "a", descriptor = "()V", line = 135)
    public static void method3569() {
        field8970 = null;
        field8975 = null;
    }

    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(IIF)F", line = 153)
    ...
    @OriginalMember(owner = "client!bm", name = "b", descriptor = "(IIF)F", line = 166)
