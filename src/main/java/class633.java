...
public class class633 {
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(BI)I", line = 20)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(II)Z", line = 40)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IZ)Ljava/lang/String;", line = 64)
    ...
    @OriginalMember(owner = "client!sp", name = "b", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(ILaia;)Z", line = 111)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 143)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lig;BI)V", line = 170)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lig;B)V", line = 223)
    ...
    @OriginalMember(owner = "client!sp", name = "c", descriptor = "(I)V", line = 247)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(ILha;I)Lur;", line = 269)
