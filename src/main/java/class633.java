...
public class class633 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Ljava/lang/String;I[Lha;I)I")
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IILtk;ZI)V")
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "([Lha;Ljava/lang/String;II)I")
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(I)[Lqba;")
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "([Lha;Ljava/lang/String;I)I")
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Ljava/lang/String;IB[Lha;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Loh;ZB)V")
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "([Lha;ILjava/lang/String;II)I")
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Ljava/lang/String;I[Lha;[I[Ljava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(ILco;)V")
