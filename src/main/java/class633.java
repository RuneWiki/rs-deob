...
public class class633 extends class377 {
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "()V", line = 10)
    public class633() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ee", name = "f", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IILji;)V", line = 53)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IB)[[I", line = 100)
    ...
    @OriginalMember(owner = "client!ee", name = "g", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IIIII[B)Z", line = 190)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IIII)V", line = 280)
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(IIII)V", line = 386)
