...
public class class633 {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Lst;II[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(B)V", line = 92)
    ...
    @OriginalMember(owner = "client!lt", name = "toString", descriptor = "()Ljava/lang/String;", line = 102)
    public final String toString() {
        field8508++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(I)I", line = 113)
    ...
    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 126)
