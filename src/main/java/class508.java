...
public class class508 extends class654 {
    ...
    @OriginalMember(owner = "client!bi", name = "c", descriptor = "(B)J", line = 3)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IJ)I", line = 13)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Z)J", line = 45)
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "()V", line = 117)
    public class508() {
    ...
    @OriginalMember(owner = "client!bi", name = "e", descriptor = "(B)J", line = 70)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(B)V", line = 105)
