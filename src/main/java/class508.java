...
public class class508 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IFLav;IBFFIFIF)[B", line = 7)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(ZIIB)I", line = 21)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IIIZ)Ljava/lang/String;", line = 47)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(JBLqa;)V", line = 94)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Z)V", line = 128)
