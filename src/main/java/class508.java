...
public class class508 extends class615 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IB)[I", line = 5)
    ...
    @OriginalMember(owner = "client!lb", name = "f", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!lb", name = "d", descriptor = "(B)V", line = 70)
