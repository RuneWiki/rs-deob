...
public class class508 implements class464 {
    ...
    @OriginalMember(owner = "client!ip", name = "toString", descriptor = "()Ljava/lang/String;", line = 25)
    public final String toString() {
        field7474++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 44)
