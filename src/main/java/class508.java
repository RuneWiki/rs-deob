...
public class class508 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Loa;[IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Loa;[II[I[I)V")
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Loa;[II)V")
