...
public class class508 {
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!lf", name = "c", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(ZI)V", line = 74)
