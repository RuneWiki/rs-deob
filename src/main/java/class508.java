...
public class class508 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "()I", line = 144)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(II)I", line = 152)
    ...
    @OriginalMember(owner = "client!cp", name = "c", descriptor = "()[F", line = 159)
    public final float[] method3031() {
        return this.field7480[this.method3029()];
    }

    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "()V", line = 165)
    public class508() {
