...
public class class508 {
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(ILsl;)Lufa;", line = 3)
    ...
    @OriginalMember(owner = "client!bda", name = "toString", descriptor = "()Ljava/lang/String;", line = 24)
    public final String toString() {
        field7161++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(ILria;BIILjl;ILda;Ljava/lang/String;Laa;II)V", line = 34)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(BI)Lau;", line = 84)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(IIILrea;)V", line = 407)
