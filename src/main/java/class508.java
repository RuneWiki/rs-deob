...
public class class508 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "([BI)Ljava/lang/String;", line = 7)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IZ)Ljava/lang/String;", line = 85)
    ...
    @OriginalMember(owner = "client!jn", name = "b", descriptor = "([BI)[B", line = 96)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ILza;II)V", line = 114)
    ...
    @OriginalMember(owner = "client!jn", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 133)
