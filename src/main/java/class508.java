...
public class class508 extends class89 {
    ...
    @OriginalMember(owner = "client!vs", name = "b", descriptor = "(IIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "(Lkha;Lkha;Lfa;)V", line = 14)
    public class508(class687 arg0, class687 arg1, class663 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!vs", name = "a", descriptor = "([BZI)V", line = 17)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IIIZ)V", line = 59)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Ljava/lang/String;ZI)V", line = 85)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(B)Z", line = 185)
    ...
    @OriginalMember(owner = "client!vs", name = "c", descriptor = "(I)V", line = 200)
