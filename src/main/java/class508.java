...
public class class508 implements class666 {
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(I)I", line = 16)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IIZIIB)V", line = 31)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Z)[Lin;", line = 125)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(B)Lpw;", line = 145)
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(Lgga;Ljava/lang/String;)V", line = 157)
