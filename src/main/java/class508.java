...
public abstract class class508 {
    ...
    @OriginalMember(owner = "client!dr", name = "b", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IIII)V", line = 59)
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(IIIII)V", line = 306)
    ...
    @OriginalMember(owner = "client!dr", name = "b", descriptor = "(IIB)B", line = 234)
    ...
    @OriginalMember(owner = "client!dr", name = "c", descriptor = "(B)V", line = 252)
    ...
    @OriginalMember(owner = "client!dr", name = "b", descriptor = "(I)V", line = 279)
