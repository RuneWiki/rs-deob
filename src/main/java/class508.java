...
public class class508 extends class329 {
    ...
    @OriginalMember(owner = "client!pp", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!pp", name = "c", descriptor = "(I)Z", line = 24)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(B)V", line = 39)
