...
public class class508 extends OutputStream {
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!uda", name = "write", descriptor = "(I)V", line = 28)
    public final void write(int arg0) throws IOException {
        field7550++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(IBII)I", line = 37)
    ...
    @OriginalMember(owner = "client!uda", name = "b", descriptor = "(B)V", line = 60)
