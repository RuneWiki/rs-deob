...
public class class508 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(FFIF)F", line = 16)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "([BI)V", line = 26)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(I)[Ltb;", line = 195)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Z)V", line = 290)
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(I)V", line = 300)
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "([BI)V", line = 320)
