...
public class class508 extends class154 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IB)Lqn;", line = 23)
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(I)V", line = 66)
    public class508(int arg0) {
        this.field6973 = arg0;
    }

    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(II)V", line = 75)
