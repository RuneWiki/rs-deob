...
public class class508 extends class583 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(ZLjb;)V")
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(BLbe;)Z")
    ...
    @OriginalMember(owner = "client!mq", name = "c", descriptor = "(B)I")
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Lbe;B)Z")
    ...
    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "(Ljava/lang/String;)V")
