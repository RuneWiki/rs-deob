...
public class class508 extends class167 {
    ...
    @OriginalMember(owner = "client!sv", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!sv", name = "c", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IIIIIIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(I)Lmh;", line = 203)
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "(Ltca;Lvea;IIIIIIIIII)V", line = 224)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(B)V", line = 235)
