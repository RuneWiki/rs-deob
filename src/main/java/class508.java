...
public class class508 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!dk", name = "b", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IIIBZ)Lnl;", line = 56)
    ...
    @OriginalMember(owner = "client!dk", name = "c", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(II)V", line = 120)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(BI)V", line = 142)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IB)Lnp;", line = 161)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IZ)V", line = 197)
    ...
    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "(Lcw;IZLeq;Leq;)V", line = 232)
