...
public class class508 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IZ)V", line = 8)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(II)Llm;", line = 22)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(Lgo;ILns;Lns;)V", line = 95)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(I)V", line = 112)
