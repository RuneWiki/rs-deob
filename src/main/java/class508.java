...
public class class508 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(II)Lnaa;", line = 8)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(IB)V", line = 89)
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(Lqg;ILvd;)V", line = 105)
