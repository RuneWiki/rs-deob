...
public class class508 extends class617 implements class657 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ZLsp;)V")
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(Lvj;III)V")
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(Lvj;IIII)V")
