...
public class class508 extends class682 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Ltha;II)V", line = 16)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(BZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(Lnv;)V", line = 40)
    public class508(class417 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IZ)V", line = 43)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lnaa;BI)V", line = 53)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IIIIIII)V", line = 99)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Z)Z", line = 151)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IBI)V", line = 162)
