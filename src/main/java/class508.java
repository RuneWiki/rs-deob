...
public class class508 extends class92 {
    ...
    @OriginalMember(owner = "client!vq", name = "e", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IIII[BI)Z", line = 32)
    ...
    @OriginalMember(owner = "client!vq", name = "c", descriptor = "(I)Lqn;", line = 114)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(B)V", line = 186)
    ...
    @OriginalMember(owner = "client!vq", name = "<init>", descriptor = "(Lpj;IIIIII)V", line = 207)
