...
public class class508 extends class148 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(IIZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "()V", line = 61)
    public class508() {
        super(1, false);
    }

    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(IIFIF[FIIFIIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ZI)[[I", line = 157)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ILdh;I)V", line = 236)
    ...
    @OriginalMember(owner = "client!cp", name = "e", descriptor = "(I)V", line = 281)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(IIIB)V", line = 292)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(BII)Z", line = 309)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(IIII)V", line = 329)
