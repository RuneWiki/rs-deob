...
public class class508 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(BI)Lf;")
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IILrl;IIB)Lfj;")
    ...
    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "(Lbt;ILkda;)V")
