...
public class class508 extends class339 implements class2 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(III[[ZZI)V", line = 8)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lkb;[I)V", line = 60)
    ...
    @OriginalMember(owner = "client!t", name = "finalize", descriptor = "()V", line = 66)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(III[[ZZII)V", line = 71)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 118)
    ...
    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(Loa;Lya;II[[I[[IIII)V", line = 227)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(II)V", line = 233)
