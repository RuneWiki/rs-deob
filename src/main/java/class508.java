...
public class class508 {
    ...
    @OriginalMember(owner = "client!maa", name = "toString", descriptor = "()Ljava/lang/String;", line = 12)
    public final String toString() {
        field7055++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!maa", name = "<init>", descriptor = "(II)V", line = 40)
