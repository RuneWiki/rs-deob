...
public class class508 {
    ...
    @OriginalMember(owner = "client!dv", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!dv", name = "c", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Lfh;II)V", line = 91)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(II)I", line = 152)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Lfh;B)V", line = 174)
