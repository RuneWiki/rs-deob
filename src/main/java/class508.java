...
public class class508 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(II)Lvb;", line = 15)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(BZIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IBIII)V", line = 55)
