...
public class class508 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lqq;)V", line = 5)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(II)Luo;", line = 83)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(II)V", line = 129)
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(I)V", line = 159)
