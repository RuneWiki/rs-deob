...
public class class508 extends class389 implements class164 {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!dr", name = "d", descriptor = "(I)Z", line = 18)
    public final boolean method614(int arg0) {
        ++field7442;
        return arg0 != -1086 ? false : this.field7417;
    }

    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(Lya;Ljt;IIIIIZIIIIIIZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(BLya;II)Z", line = 64)
    ...
    @OriginalMember(owner = "client!dr", name = "e", descriptor = "(B)I", line = 86)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Lya;I)Lag;", line = 100)
    ...
    @OriginalMember(owner = "client!dr", name = "h", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!dr", name = "c", descriptor = "(I)I", line = 140)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ILya;)V", line = 152)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ZLya;)V", line = 181)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(B)I", line = 210)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IZILya;)Lpm;", line = 221)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Lya;II)Lt;", line = 253)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(I)I", line = 273)
    public final int method621(int arg0) {
        ++field7427;
        return arg0 != 3021 ? 124 : this.field7432;
    }

    @OriginalMember(owner = "client!dr", name = "f", descriptor = "(I)Z", line = 284)
    ...
    @OriginalMember(owner = "client!dr", name = "g", descriptor = "(I)I", line = 295)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Lya;ZI)Lt;", line = 309)
    public final class475 method615(class38 arg0, boolean arg1, int arg2) {
        ++field7422;
        return arg1 ? null : this.method3029(arg0, -121, arg2);
    }

    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IIZII)Lij;", line = 325)
    ...
    @OriginalMember(owner = "client!dr", name = "b", descriptor = "(I)V", line = 365)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Lya;Z)V", line = 381)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IILya;ILor;IZ)V", line = 392)
