...
public class class508 extends class318 implements class659 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(BI[BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lep;B)Lep;", line = 39)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Z)J", line = 71)
    public final long method781(boolean arg0) {
        ++field7314;
        return arg0 ? 26L : 0L;
    }

    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(I)I", line = 82)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(I)I", line = 95)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(Lap;ILjaclib/memory/Buffer;IZ)V", line = 106)
    public class508(class435 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field7306 = arg1;
    }

    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(B)V", line = 115)
    ...
    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(Lap;I[BIZ)V", line = 137)
    public class508(class435 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field7306 = arg1;
    }

    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(B)V", line = 147)
    ...
    @OriginalMember(owner = "client!fi", name = "d", descriptor = "(I)V", line = 158)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IB)V", line = 209)
