...
public class class768 implements Runnable {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(BIIII)Lfe;", line = 14)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Z)Ljava/lang/Object;", line = 23)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(ILjava/lang/String;)Lgba;", line = 33)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;)Lgba;", line = 47)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(ILjava/net/URL;)Lfe;", line = 89)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(II)Lfe;", line = 99)
    ...
    @OriginalMember(owner = "client!vt", name = "b", descriptor = "(ILjava/lang/String;)Lfe;", line = 112)
    public final class344 method4234(int arg0, String arg1) {
        return arg0 == 26126 ? this.method4245(16, 67, 0, 0, arg1) : null;
    }

    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "(ILjava/lang/String;IZ)V", line = 702)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;I)Lfe;", line = 129)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Ljava/lang/Runnable;II)Lfe;", line = 138)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(ILjava/io/File;[B)Z", line = 213)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Z[ILjava/awt/Component;IILjava/awt/Point;)Lfe;", line = 243)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(B)Z", line = 255)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Ljava/awt/Frame;I)Lfe;", line = 274)
    public final class344 method4241(Frame arg0, int arg1) {
        return arg1 < 59 ? null : this.method4245(7, 98, 0, 0, arg0);
    }

    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Ljava/lang/String;ZII)Lfe;", line = 284)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(BZLjava/lang/String;)Lfe;", line = 295)
    ...
    @OriginalMember(owner = "client!vt", name = "b", descriptor = "(B)Lfe;", line = 332)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(IIIILjava/lang/Object;)Lfe;", line = 342)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;[Ljava/lang/Class;I)Lfe;", line = 374)
    ...
    @OriginalMember(owner = "client!vt", name = "run", descriptor = "()V", line = 386)
    ...
    @OriginalMember(owner = "client!vt", name = "b", descriptor = "(Z)V", line = 684)
