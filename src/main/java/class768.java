...
public abstract class class768 extends class459 {
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(I)V", line = 157)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Ltga;IIILjava/awt/Component;)Leca;", line = 170)
