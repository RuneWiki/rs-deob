...
public class class768 extends class753 {
    ...
    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "([Lls;)V", line = 6)
    public class768(class592[] arg0) {
        this.field10436 = arg0;
    }

    @OriginalMember(owner = "client!le", name = "a", descriptor = "(ZLjava/lang/String;IIZ)V", line = 14)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(ZZ)Z", line = 25)
