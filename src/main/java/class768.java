...
public class class768 extends class320 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 29)
    ...
    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(Z)V", line = 40)
    ...
    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 51)
    public class768(Object arg0, int arg1) {
        super(arg1);
        this.field10591 = arg0;
    }

    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(I)Z", line = 60)
