...
public class class320 extends class325 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IBIC)V", line = 3)
    ...
    @OriginalMember(owner = "client!rb", name = "b", descriptor = "(Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!rb", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 32)
    public final synchronized void keyReleased(KeyEvent arg0) {
        field4144++;
        this.method1800(arg0, (byte) 10, 1);
    }

    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(ILjo;)V", line = 46)
    ...
    @OriginalMember(owner = "client!rb", name = "b", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(B)Lmj;", line = 151)
    ...
    @OriginalMember(owner = "client!rb", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 164)
    public final void focusGained(FocusEvent arg0) {
        field4139++;
    }

    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Ljava/lang/Throwable;I)Ljava/lang/String;", line = 172)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Ljava/awt/event/KeyEvent;BI)V", line = 242)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(BLjava/awt/Component;)V", line = 279)
    ...
    @OriginalMember(owner = "client!rb", name = "c", descriptor = "(I)V", line = 304)
    ...
    @OriginalMember(owner = "client!rb", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 332)
    public final synchronized void keyPressed(KeyEvent arg0) {
        this.method1800(arg0, (byte) 10, 0);
        field4143++;
    }

    @OriginalMember(owner = "client!rb", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 341)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Z)V", line = 355)
    ...
    @OriginalMember(owner = "client!rb", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 438)
    public class320(Component arg0) {
        class25.method126((byte) -103);
        this.method1801((byte) -19, arg0);
    }

    @OriginalMember(owner = "client!rb", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 376)
    public final synchronized void focusLost(FocusEvent arg0) {
        this.method1794(-1, (byte) 106, 0, '\u0000');
        field4149++;
    }

    @OriginalMember(owner = "client!rb", name = "d", descriptor = "(I)I", line = 388)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(BI)Z", line = 408)
