...
public class class320 extends class386 {
    ...
    @OriginalMember(owner = "client!ak", name = "b", descriptor = "(II)[[I", line = 4)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IBLun;)V", line = 72)
    ...
    @OriginalMember(owner = "client!ak", name = "e", descriptor = "(I)V", line = 85)
    public static void method1861(int arg0) {
        int var1 = 65 % ((arg0 - 15) / 49);
        field4217 = null;
    }

    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(B)I", line = 97)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Z)V", line = 110)
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "()V", line = 119)
    public class320() {
        super(0, false);
    }

    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IBI)V", line = 123)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(ZIZIB)V", line = 143)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(ZLjn;JIZII)V", line = 165)
