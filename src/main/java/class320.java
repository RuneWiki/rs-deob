...
public class class320 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ILtl;BI)V", line = 11)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(II)Z", line = 67)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(I)I", line = 94)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Ltl;II)V", line = 131)
