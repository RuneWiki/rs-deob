...
public class class320 extends class80 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Ljava/lang/String;II)Z", line = 7)
    ...
    @OriginalMember(owner = "client!wr", name = "d", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "()V", line = 244)
    public class320() {
        super(1, false);
    }

    @OriginalMember(owner = "client!wr", name = "c", descriptor = "(II)[[I", line = 69)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IILnn;)V", line = 202)
    ...
    @OriginalMember(owner = "client!wr", name = "b", descriptor = "(II)[I", line = 247)
    ...
    @OriginalMember(owner = "client!wr", name = "e", descriptor = "(I)V", line = 337)
    ...
    @OriginalMember(owner = "client!wr", name = "f", descriptor = "(I)V", line = 386)
