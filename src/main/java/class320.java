...
public class class320 extends class210 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(IILat;)V")
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(BLct;)V")
    ...
    @OriginalMember(owner = "client!so", name = "b", descriptor = "(IB)Ldi;")
