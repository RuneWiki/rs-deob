...
public class class320 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "([Lhm;IIIIZ)V", line = 9)
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "()V", line = 59)
    public class320() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Z)V", line = 67)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Lwm;I[B)V", line = 80)
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(III)V", line = 107)
