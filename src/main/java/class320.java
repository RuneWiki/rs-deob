...
public class class320 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IILud;)V")
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(Lud;I)V")
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(ILwc;BI)V")
