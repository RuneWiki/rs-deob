...
public class class320 extends class245 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!td", name = "g", descriptor = "(I)I", line = 16)
    public final int method1570(int arg0) {
        field4630++;
        return arg0 == 3 ? 0 : -95;
    }

    @OriginalMember(owner = "client!td", name = "f", descriptor = "(I)I", line = 27)
    ...
    @OriginalMember(owner = "client!td", name = "j", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(I)I", line = 72)
    ...
    @OriginalMember(owner = "client!td", name = "h", descriptor = "(I)J", line = 83)
