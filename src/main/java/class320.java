...
public class class320 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IIIIIZII)V", line = 4)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(II)Lrd;", line = 18)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(ILtf;)V", line = 43)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IB)V", line = 66)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "([BI[Lg;IIIZILuo;III)[I", line = 84)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(B)V", line = 556)
