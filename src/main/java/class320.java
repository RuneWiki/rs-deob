...
public class class320 extends class306 implements class201 {
    ...
    @OriginalMember(owner = "client!vq", name = "<init>", descriptor = "(Lqg;I[BI)V", line = 5)
    public class320(class321 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field4569 = arg1;
    }

    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(BC)Z", line = 14)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IBII)I", line = 72)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(I)I", line = 103)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "([BIII)V", line = 117)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Z)J", line = 131)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(B)I", line = 143)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(I[[BZ[I[II[B[[B)I", line = 157)
