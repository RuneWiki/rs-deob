...
public class class320 extends class392 {
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(ILol;)Lwda;")
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(ILw;)V")
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(Lw;)V")
