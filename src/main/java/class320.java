...
public class class320 extends class130 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Z)I", line = 10)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(II)[B", line = 26)
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(I)I", line = 50)
    ...
    @OriginalMember(owner = "client!si", name = "c", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!si", name = "d", descriptor = "(I)I", line = 90)
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(III)Lvd;", line = 108)
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(Z)V", line = 328)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(B)Log;", line = 503)
    ...
    @OriginalMember(owner = "client!si", name = "e", descriptor = "(I)V", line = 605)
    ...
    @OriginalMember(owner = "client!si", name = "f", descriptor = "(I)I", line = 656)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(BI)I", line = 685)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ZI)V", line = 702)
    ...
    @OriginalMember(owner = "client!si", name = "<init>", descriptor = "(ILv;Lv;Lp;Lro;IIZ)V", line = 756)
