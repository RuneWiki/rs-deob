...
public class class320 extends class665 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IIILde;)V", line = 4)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(II)Z", line = 18)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(I)Lws;", line = 29)
    public static final class325 method2004(int arg0) {
        field4707++;
        return arg0 == 1 ? class127.method957(1, 5492) : null;
    }

    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lha;III[Z)V", line = 51)
