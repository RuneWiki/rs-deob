...
public class class320 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!dh", name = "toString", descriptor = "()Ljava/lang/String;", line = 32)
    public final String toString() {
        field4081++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IIIIIIIIBI)Z", line = 41)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(Lha;IILei;IIIIIIII)V", line = 73)
    ...
    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(II)V", line = 88)
    public class320(int arg0, int arg1) {
        this.field4086 = arg1;
        this.field4087 = arg0;
    }

    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(Ljava/lang/String;IZI[BI)I", line = 97)
