...
public class class320 extends class435 {
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "(Lql;)V", line = 73)
    public class320(class519 arg0) {
        this.field4272 = arg0;
    }

    @OriginalMember(owner = "client!sl", name = "c", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(IZI)Z", line = 29)
