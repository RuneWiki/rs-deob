...
public class class320 extends class430 {
    ...
    private static int[] field4360;

    @OriginalMember(owner = "client!tba", name = "b", descriptor = "(II)V", line = 3)
    public final void method1987(int arg0, int arg1) {
        if (arg0 == 0 && arg1 == 0) {
            return;
        }
        if (field4360 == null || field4360.length != this.field4362.length) {
            field4360 = new int[this.field4362.length];
        }
        int var3 = this.field4362.length;
        int var4 = arg0;
        ...
        for (int var8 = 0; var8 < var3; var8 += this.field4358) {
            ...
            for (int var11 = 0; var11 < this.field4358; var11++) {
                ...
                field4360[var12] = this.field4362[var13];
            }
        }
        int[] var9 = this.field4362;
        this.field4362 = field4360;
        field4360 = var9;
    }

    @OriginalMember(owner = "client!tba", name = "b", descriptor = "()V", line = 52)
    public static void method1988() {
        field4360 = null;
    }

    @OriginalMember(owner = "client!tba", name = "c", descriptor = "()[I", line = 56)
    public final int[] method1989() {
        return this.field4362;
    }

    @OriginalMember(owner = "client!tba", name = "<init>", descriptor = "(II[IZ)V", line = 59)
    public class320(int arg0, int arg1, int[] arg2, boolean arg3) {
        this.field4363 = arg0;
        this.field4358 = arg1;
        this.field4362 = arg2;
        if (arg3) {
            ...
            int[] var8 = new int[this.field4358];
            if (field4360 == null || field4360.length != this.field4362.length) {
                field4360 = new int[this.field4362.length];
            }
            int var9 = this.field4358;
            int var10 = this.field4358;
            int var11 = var9 - 1;
            int var12 = var10 - 1;
            ...
            for (int var16 = 2; var16 >= 0; var16--) {
                for (int var35 = var11; var35 >= 0; var35--) {
                    var14--;
                    int var36 = this.field4362[var14];
            ...
            for (int var18 = var12; var18 >= 0; var18--) {
                ...
                for (int var27 = var11; var27 >= 0; var27--) {
                    ...
                    int var34 = var23 / 9;
                    var17--;
                    field4360[var17] = var31 << 24 | var32 << 16 | var33 << 8 | var34;
                ...
                for (int var28 = var11; var28 >= 0; var28--) {
                    var14--;
                    int var29 = this.field4362[var14];
                    var15--;
                    int var30 = this.field4362[var15];
