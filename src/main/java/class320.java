...
public class class320 extends class234 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(BI)I", line = 30)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Lkj;ILjava/awt/Component;II)Lhv;", line = 48)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(B)Lal;", line = 137)
