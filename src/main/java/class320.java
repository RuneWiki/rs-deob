...
public class class320 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(B)Lqq;")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(BLsv;)V")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IBLsv;)V")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(Z)Lqq;")
