...
public class class320 {
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(IB)V", line = 22)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(IIIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!caa", name = "b", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!caa", name = "<init>", descriptor = "(Lmja;ILbt;)V", line = 147)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(BI)V", line = 87)
    ...
    @OriginalMember(owner = "client!caa", name = "c", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(II)Lkr;", line = 116)
