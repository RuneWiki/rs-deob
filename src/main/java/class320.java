...
public class class320 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ILvq;ZB)Lvj;")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Llf;IBI)V")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Llf;IB)V")
