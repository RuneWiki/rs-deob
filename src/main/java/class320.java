...
public class class320 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(BILas;I)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Las;IIZ)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Las;III)Z")
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Lsq;Lkg;)V")
