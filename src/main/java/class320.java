...
public class class320 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Ltb;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Ltb;I)V", line = 11)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Ltb;Lmr;)V", line = 355)
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(Ltb;)V", line = 584)
    ...
    @OriginalMember(owner = "client!ac", name = "c", descriptor = "(Ltb;)V", line = 592)
