...
public class class320 extends class687 implements class295 {
    ...
    @OriginalMember(owner = "client!tba", name = "<init>", descriptor = "(Lhb;IZ[[I)V")
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(Lgca;I)V")
    public final void method204(class206 arg0, int arg1) {
        int var3 = 100 % ((-arg1 - 2) / 39);
        super.method204(arg0, 121);
    }

    @OriginalMember(owner = "client!tba", name = "c", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;")
