...
public class class320 {
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(ZI)Lih;", line = 28)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(II)V", line = 72)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(B)V", line = 92)
    ...
    @OriginalMember(owner = "client!nw", name = "b", descriptor = "(ZI)V", line = 103)
    ...
    @OriginalMember(owner = "client!nw", name = "b", descriptor = "(B)V", line = 119)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(IZ)V", line = 141)
    ...
    @OriginalMember(owner = "client!nw", name = "b", descriptor = "(IZ)V", line = 157)
    ...
    @OriginalMember(owner = "client!nw", name = "<init>", descriptor = "(Loda;IZLdda;Ldda;)V", line = 220)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(BI)V", line = 181)
