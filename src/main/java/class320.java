...
public class class320 extends class30 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(BILac;)V", line = 28)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(III)V", line = 56)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "()V", line = 89)
    public class320() {
        this(4096);
    }

    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(Z)V", line = 92)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IIII)V", line = 117)
