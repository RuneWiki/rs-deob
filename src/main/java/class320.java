...
public class class320 extends class148 implements class395 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ZLja;)V")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ILja;II)Z")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IBZIILnf;Lja;)V")
    ...
    @OriginalMember(owner = "client!si", name = "<init>", descriptor = "(Lja;Lfb;IIIIIIIZI)V")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Lja;I)V")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(BLja;)Lkh;")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(BILja;)Lrc;")
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ILja;)V")
