...
public class class320 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Lqq;Lnc;ILrt;IIILfn;IIII)Lcd;")
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Lfn;IILdv;IIIZII[Lcc;Lmo;Lrr;Lqq;ILdr;Lfn;Lrt;Lnc;)Lcd;")
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IILnc;Lrt;Lfn;Ldr;Lmo;Lqq;Ldv;III)Lcd;")
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IILrt;I)V")
