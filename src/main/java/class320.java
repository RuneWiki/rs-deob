...
public class class320 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Lmd;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Lmd;B)V", line = 66)
