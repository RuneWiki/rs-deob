...
public class class320 {
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(ZI)Lkm;")
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(ILgo;)Lgo;")
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "(Lkr;ILok;)V")
