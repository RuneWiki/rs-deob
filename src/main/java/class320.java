...
public class class320 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(I)V", line = 5)
    public static void method2047(int arg0) {
        field4813 = null;
        int var1 = 72 / ((arg0 - 22) / 60);
    }

    @OriginalMember(owner = "client!wr", name = "b", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(II)Z", line = 74)
