...
public class class320 implements class707 {
    ...
    @OriginalMember(owner = "client!vw", name = "c", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!vw", name = "b", descriptor = "(I)I", line = 21)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(IIIIIBI)V", line = 39)
    ...
    @OriginalMember(owner = "client!vw", name = "<init>", descriptor = "(Lwia;)V", line = 56)
    public class320(class791 arg0) {
        this.field4531 = arg0;
    }

    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(I)Llj;", line = 64)
