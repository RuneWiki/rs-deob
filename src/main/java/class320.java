...
public class class320 {
    ...
    @OriginalMember(owner = "client!pr", name = "movemouse", descriptor = "(II)V")
    public final void movemouse(int arg0, int arg1) {
        this.field4088.mouseMove(arg0, arg1);
    }

    @OriginalMember(owner = "client!pr", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V")
    ...
    @OriginalMember(owner = "client!pr", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V")
