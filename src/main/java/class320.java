...
public class class320 extends class686 implements class394 {
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lvj;IZLr;IIB)V")
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "(Lr;Lnf;IIIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(ILr;)Leh;")
    ...
    @OriginalMember(owner = "client!nb", name = "c", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lr;B)V")
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lr;I)Lej;")
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IILr;B)Z")
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IILr;Z)Lfj;")
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(ILr;B)Lda;")
