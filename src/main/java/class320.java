...
public class class320 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(ILjava/lang/Throwable;Ljava/lang/String;)V", line = 7)
    ...
    @OriginalMember(owner = "client!qg", name = "b", descriptor = "(B)Z", line = 73)
    ...
    @OriginalMember(owner = "client!qg", name = "b", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!qg", name = "c", descriptor = "(B)Z", line = 104)
