...
public class class611 implements class142 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lj;BIZ)Lba;", line = 7)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "()V", line = 60)
    public final void method3408() {
        this.field8647 = null;
        this.method3412();
    }

    @OriginalMember(owner = "client!t", name = "b", descriptor = "()V", line = 76)
    public final void method3417() {
        this.field8647 = Thread.currentThread();
        this.method3409();
    }

    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(Lda;II)V", line = 86)
    ...
    @OriginalMember(owner = "client!t", name = "finalize", descriptor = "()V", line = 101)
