...
public class class611 {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(B)Lhha;", line = 28)
    ...
    @OriginalMember(owner = "client!mr", name = "b", descriptor = "(I)Z", line = 72)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(ILqm;Lmr;)V", line = 86)
    ...
    @OriginalMember(owner = "client!mr", name = "c", descriptor = "(I)I", line = 108)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(ILqm;)V", line = 133)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Lqm;B)V", line = 152)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(ILla;[ILla;)V", line = 169)
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "()V", line = 295)
    public class611() {
        this.field8734.field6189 = this.field8734;
        this.field8734.field6186 = this.field8734;
    }

    @OriginalMember(owner = "client!mr", name = "b", descriptor = "(B)Lqm;", line = 190)
    ...
    @OriginalMember(owner = "client!mr", name = "d", descriptor = "(I)Lqm;", line = 213)
    ...
    @OriginalMember(owner = "client!mr", name = "e", descriptor = "(I)Lqm;", line = 235)
    ...
    @OriginalMember(owner = "client!mr", name = "c", descriptor = "(B)Lqm;", line = 255)
    ...
    @OriginalMember(owner = "client!mr", name = "f", descriptor = "(I)Lqm;", line = 276)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Lmr;B)V", line = 305)
    ...
    @OriginalMember(owner = "client!mr", name = "g", descriptor = "(I)V", line = 321)
