...
public class class611 extends class646 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IBI)Lep;")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IILr;Z)V")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Lek;IB)V")
