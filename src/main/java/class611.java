...
public class class611 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Z)V", line = 190)
    ...
    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 206)
