...
public class class611 extends class163 implements class405 {
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IIZI[IIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "(Llh;II[III)V", line = 24)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(I)I", line = 38)
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "(Llh;Lkl;II[BII)V", line = 49)
    ...
    @OriginalMember(owner = "client!sj", name = "b", descriptor = "(I)I", line = 66)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IB)Lak;", line = 77)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(ZF)F", line = 92)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IILkl;III[BII)V", line = 103)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IIIIIII)V", line = 128)
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "(Llh;Lkl;Lvt;II)V", line = 176)
    ...
    @OriginalMember(owner = "client!sj", name = "c", descriptor = "(I)Z", line = 189)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IF)F", line = 202)
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "(Llh;Lkl;II[FII)V", line = 213)
    ...
    @OriginalMember(owner = "client!sj", name = "h", descriptor = "(I)V", line = 229)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(ZZI)V", line = 253)
