...
public abstract class class611 extends class20 {
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "([Lul;I)I")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IIZLr;ILub;I)V")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Lr;I)V")
