...
public class class611 extends class377 {
    ...
    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "()V", line = 11)
    public class611() {
        super(1, false);
    }

    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(IILji;)V", line = 20)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(IB)[[I", line = 71)
    ...
    @OriginalMember(owner = "client!fk", name = "f", descriptor = "(I)V", line = 133)
