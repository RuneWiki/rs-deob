...
public class class611 extends class416 {
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "(Lhea;Luq;[Lfg;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!sv", name = "OA", descriptor = "(CIIIZ)V", line = 307)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(CIIIZLua;II)V", line = 330)
