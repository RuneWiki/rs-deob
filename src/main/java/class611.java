...
public class class611 {
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(ILlga;)V")
    ...
    @OriginalMember(owner = "client!tca", name = "b", descriptor = "(II)Lhf;")
    ...
    @OriginalMember(owner = "client!tca", name = "<init>", descriptor = "(Lfs;ILlga;Llga;)V")
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(ILjc;)Lqfa;")
