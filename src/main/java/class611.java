...
public class class611 implements class762 {
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lda;IBIILjava/lang/String;)I", line = 21)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(B)I", line = 55)
    public static final int method3379(byte arg0) {
        field8302++;
        return arg0 == 33 ? class728.field10115++ : 79;
    }

    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Z[I[I)V", line = 66)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IZ)V", line = 97)
    ...
    @OriginalMember(owner = "client!pm", name = "<init>", descriptor = "(Lup;Lkv;)V", line = 143)
