...
public class class611 {
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(ZII)Z", line = 8)
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(II)Loha;", line = 56)
    ...
    @OriginalMember(owner = "client!kea", name = "<init>", descriptor = "(Ljk;ILae;)V", line = 97)
