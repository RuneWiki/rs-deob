...
public class class611 extends class91 {
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(JIZILha;)V")
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(Lha;JI)V")
    ...
    @OriginalMember(owner = "client!tca", name = "<init>", descriptor = "(Lha;Lpi;Leea;J)V")
