...
public class class611 extends class531 {
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(ILwia;I)Ljd;")
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(IZLdca;)V")
    ...
    @OriginalMember(owner = "client!nw", name = "<init>", descriptor = "(Lqfa;)V")
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(ILjava/awt/Canvas;II)Lub;")
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(IILwia;ILjc;IZ)V")
