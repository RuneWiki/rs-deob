...
public class class611 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IILkn;II)V", line = 14)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IIIIII)V", line = 69)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(BZ)V", line = 96)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IIIIIIZ)V", line = 140)
