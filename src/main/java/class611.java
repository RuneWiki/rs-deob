...
public class class611 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lqw;Lmj;IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(ILmj;I)V", line = 163)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(I)V", line = 550)
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(Lmj;)V", line = 721)
    ...
    @OriginalMember(owner = "client!gp", name = "b", descriptor = "(ILmj;I)V", line = 573)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IZI)V", line = 590)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(BI)I", line = 640)
    ...
    @OriginalMember(owner = "client!gp", name = "b", descriptor = "(I)V", line = 654)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(ZLmj;)V", line = 666)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(ILmj;)V", line = 678)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lmj;B)V", line = 689)
