...
public class class611 extends class219 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "([I[III)V")
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!pm", name = "<init>", descriptor = "(Lfba;[B[III)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IILaa;II)V")
