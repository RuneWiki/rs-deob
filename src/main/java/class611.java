...
public class class611 {
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!sv", name = "b", descriptor = "(I)Z", line = 50)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Z)V", line = 129)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Lmu;ILmu;B)Llh;", line = 140)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IIIZZ[Lpca;)V", line = 154)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(B)V", line = 208)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(BZILmu;Lmu;)Llh;", line = 224)
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "(Lgq;Lrs;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", line = 267)
