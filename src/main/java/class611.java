...
public class class611 extends class717 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!ji", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 5)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field8467;
        return this.field8462 == arg0;
    }

    @OriginalMember(owner = "client!ji", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 14)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IIILjava/awt/Canvas;)V", line = 27)
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!ji", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 60)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IIIIB)V", line = 74)
    ...
    @OriginalMember(owner = "client!ji", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 94)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field8458;
    }

    @OriginalMember(owner = "client!ji", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 101)
    public final void startProduction(ImageConsumer arg0) {
        this.addConsumer(arg0);
        ++field8464;
    }

    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IIIIIILjava/awt/Graphics;I)V", line = 110)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(BII)V", line = 129)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Z)V", line = 175)
