...
public class class270 {
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(IJ)Ldaa;")
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(Ldaa;IJ)V")
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(ILeh;)V")
