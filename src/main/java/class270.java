...
public class class270 extends class529 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(FFFFFFLea;II)V")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IILea;II)V")
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Lvj;IIII)V")
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Lvj;II[III)V")
