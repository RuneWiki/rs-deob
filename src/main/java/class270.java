...
public class class270 extends class353 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!vi", name = "c", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(ILqda;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IIIZIIII)V", line = 37)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IZ)V", line = 62)
    ...
    @OriginalMember(owner = "client!vi", name = "g", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(IZ)V", line = 86)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(B)Z", line = 101)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(III)Z", line = 113)
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(Lum;)V", line = 124)
