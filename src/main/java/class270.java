...
public class class270 {
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!mu", name = "c", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!mu", name = "e", descriptor = "(I)Z", line = 39)
    ...
    @OriginalMember(owner = "client!mu", name = "f", descriptor = "(I)[Lbi;", line = 53)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(FIIIIFIIIF[FII)V", line = 150)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(III)Z", line = 236)
    ...
    @OriginalMember(owner = "client!mu", name = "g", descriptor = "(I)V", line = 257)
