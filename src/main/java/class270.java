...
public class class270 {
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(BIIIIIIIIILnt;)Z")
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(ILig;)V")
    ...
    @OriginalMember(owner = "client!vca", name = "b", descriptor = "(ILig;)V")
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(ILnba;)V")
    ...
    @OriginalMember(owner = "client!vca", name = "c", descriptor = "(I)Lib;")
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(Lls;I)V")
