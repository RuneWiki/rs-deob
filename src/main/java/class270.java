...
public class class270 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(BI)Lwk;")
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(B)Lts;")
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "(Loda;ILdda;Ldda;)V")
