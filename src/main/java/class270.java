...
public class class270 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(I)Lkd;", line = 5)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(III)I", line = 43)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lws;B)V", line = 60)
    ...
    @OriginalMember(owner = "client!bq", name = "b", descriptor = "(I)Lkd;", line = 77)
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "()V", line = 100)
    public class270() {
    }

    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(Lws;)V", line = 102)
