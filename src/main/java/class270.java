...
public class class270 implements class134 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!ol", name = "c", descriptor = "(B)I", line = 17)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(FIIIIIFI[FII)V", line = 44)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(JI)Z", line = 99)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(ZZ)V", line = 110)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(ILjava/awt/Canvas;)Lnc;", line = 132)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(BLni;)V", line = 191)
    ...
    @OriginalMember(owner = "client!ol", name = "<init>", descriptor = "(Lnh;Lhm;)V", line = 251)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(B)I", line = 269)
