...
public class class270 implements Runnable {
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(ILjava/lang/String;)Lcb;")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(BI)Lgb;")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(ILgk;)V")
