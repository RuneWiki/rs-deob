...
public class class270 {
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(ZI)V", line = 25)
    public static final synchronized void method1723(boolean arg0, int arg1) {
        int var2 = 90 % ((arg1 + 44) / 35);
        field3803 = arg0;
    }

    @OriginalMember(owner = "client!nga", name = "b", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!nga", name = "c", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(Le;I)V", line = 61)
