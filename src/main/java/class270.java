...
public class class270 {
    ...
    @OriginalMember(owner = "client!tia", name = "<init>", descriptor = "(Lda;)V", line = 46)
    public class270(class61 arg0) {
        this.field3397 = arg0;
    }

    @OriginalMember(owner = "client!tia", name = "<init>", descriptor = "(Lda;Ljl;)V", line = 62)
    public class270(class61 arg0, class274 arg1) {
        this.field3397 = arg0;
        this.field3402 = arg1;
    }

    @OriginalMember(owner = "client!tia", name = "a", descriptor = "(IBI)Z", line = 10)
    ...
    @OriginalMember(owner = "client!tia", name = "a", descriptor = "(B)V", line = 24)
