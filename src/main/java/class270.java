...
public class class270 extends class183 {
    ...
    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "()V", line = 104)
    public class270() {
    ...
    @OriginalMember(owner = "client!qg", name = "b", descriptor = "(I)J", line = 8)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(I)J", line = 59)
