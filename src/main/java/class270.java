...
public class class270 extends class751 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(ILha;Lnba;IIIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!uk", name = "e", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!uk", name = "c", descriptor = "(I)[Ldba;", line = 93)
    ...
    @OriginalMember(owner = "client!uk", name = "<init>", descriptor = "()V", line = 106)
    public class270() {
        super(1, true);
    }

    @OriginalMember(owner = "client!uk", name = "f", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(II)[I", line = 140)
