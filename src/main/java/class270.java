...
public class class270 {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(ILal;)Lbka;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lwq;I)Lgm;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Z)Lfb;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(ILd;Ljava/awt/Canvas;I)Lha;")
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(Lgda;Lgda;)V")
