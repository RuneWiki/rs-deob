...
public class class270 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(BI)Lad;", line = 5)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IIIII)V", line = 65)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lse;Z)I", line = 98)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Lgp;ILui;)V", line = 177)
