...
public class class270 {
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(IIIZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(I[B[BIIIIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(B)V", line = 79)
