...
public class class270 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(BLjava/awt/Component;)Lno;", line = 32)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Z)Z", line = 46)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IZ)V", line = 169)
    ...
    @OriginalMember(owner = "client!ml", name = "b", descriptor = "(Z)V", line = 202)
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "([I)V", line = 374)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IILwo;I)J", line = 410)
