...
public class class270 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(BJ)V", line = 22)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(BI)Lof;", line = 36)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Z)V", line = 72)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Lae;ILqn;)V", line = 104)
