...
public class class270 {
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IB)Lcf;", line = 42)
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "(Ljj;Ld;)V", line = 96)
