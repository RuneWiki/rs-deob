...
public class class270 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(I)Lefa;", line = 7)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Z)Lefa;", line = 50)
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "()V", line = 90)
    public class270() {
    }

    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(Lhe;)V", line = 96)
