...
public abstract class class270 extends class337 {
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!za", name = "b", descriptor = "(II)V", line = 23)
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(ZI)V", line = 39)
