...
public class class270 extends class30 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(BI)Z", line = 30)
    ...
    @OriginalMember(owner = "client!tm", name = "b", descriptor = "(III)V", line = 55)
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(II[I[I)V", line = 68)
