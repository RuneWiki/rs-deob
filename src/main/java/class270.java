...
public class class270 extends class38 {
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IBB)V", line = 33)
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(ILsg;)Ljava/lang/String;", line = 62)
    ...
    @OriginalMember(owner = "client!pd", name = "c", descriptor = "(III)V", line = 91)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IIII)[B", line = 107)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "()V", line = 121)
    public class270() {
