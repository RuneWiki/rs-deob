...
public class class270 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IIBIIII)V", line = 21)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "([IIIII)V", line = 40)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Z)V", line = 68)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ILtd;)Z", line = 83)
