...
public class class270 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(Lmr;B)V", line = 164)
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "(Lbt;)V", line = 261)
