...
public class class270 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(I)Lpn;", line = 5)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(I)Lpn;", line = 26)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(B)Lpn;", line = 50)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ILpn;)V", line = 71)
    ...
    @OriginalMember(owner = "client!bb", name = "c", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IIIILwd;)V", line = 102)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(B)I", line = 155)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ILbb;)V", line = 183)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ZLpn;)V", line = 195)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Lbg;I)V", line = 213)
    ...
    @OriginalMember(owner = "client!bb", name = "d", descriptor = "(I)Z", line = 246)
    ...
    @OriginalMember(owner = "client!bb", name = "c", descriptor = "(B)Lpn;", line = 258)
    ...
    @OriginalMember(owner = "client!bb", name = "d", descriptor = "(B)Lpn;", line = 285)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Z)V", line = 306)
    ...
    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "()V", line = 372)
    public class270() {
        this.field3483.field507 = this.field3483;
        this.field3483.field508 = this.field3483;
    }

    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Lwo;Lwo;Z)V", line = 332)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Lpn;ILbb;)V", line = 351)
