...
public class class270 {
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BJ)Ljava/lang/String;", line = 78)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(II)V", line = 117)
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(II)Z", line = 127)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Z)Leo;", line = 145)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Lwaa;B)Lkba;", line = 161)
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Lpu;Lpu;)V", line = 213)
