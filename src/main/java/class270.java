...
public abstract class class270 extends class242 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IIIJ)V", line = 5)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(ZIIIIIIIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!nm", name = "b", descriptor = "(Z)V", line = 79)
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(IIII)V", line = 90)
