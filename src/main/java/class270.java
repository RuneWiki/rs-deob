...
public class class270 {
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(I)Luj;", line = 7)
    ...
    @OriginalMember(owner = "client!ew", name = "b", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(B)V", line = 74)
    ...
    @OriginalMember(owner = "client!ew", name = "b", descriptor = "(B)I", line = 87)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(Luj;JI)V", line = 119)
    ...
    @OriginalMember(owner = "client!ew", name = "c", descriptor = "(B)I", line = 141)
    ...
    @OriginalMember(owner = "client!ew", name = "c", descriptor = "(I)Luj;", line = 154)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "([Luj;B)I", line = 169)
    ...
    @OriginalMember(owner = "client!ew", name = "d", descriptor = "(B)Luj;", line = 202)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(B[Ljava/lang/Object;[I)V", line = 234)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(BJ)Luj;", line = 245)
    ...
    @OriginalMember(owner = "client!ew", name = "<init>", descriptor = "(I)V", line = 279)
