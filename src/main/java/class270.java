...
public abstract class class270 extends class86 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!rm", name = "c", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!rm", name = "e", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!rm", name = "e", descriptor = "(B)V", line = 105)
