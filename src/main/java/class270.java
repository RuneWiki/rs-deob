...
public class class270 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IIBILc;I)Lc;")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Ltl;II)V")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Ljb;I)Ljb;")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ILtl;)V")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lc;IIIIBII)Lc;")
