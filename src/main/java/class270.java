...
public class class270 {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(II[BIII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(B)V", line = 102)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IZLjava/lang/String;Ljava/lang/String;)V", line = 132)
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(IIII)V", line = 143)
    ...
    @OriginalMember(owner = "client!lp", name = "toString", descriptor = "()Ljava/lang/String;", line = 154)
