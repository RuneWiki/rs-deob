...
public class class270 {
    ...
    @OriginalMember(owner = "client!bg", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(BII)V", line = 46)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lqj;I)V", line = 80)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "([BB)Lvf;", line = 100)
