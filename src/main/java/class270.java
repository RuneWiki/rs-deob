...
public class class270 extends class343 {
    ...
    @OriginalMember(owner = "client!cg", name = "e", descriptor = "()Z", line = 5)
    public final boolean method1731() {
        return this.field4661.field295 && this.field4661.field304 && this.field4661.field238;
    }

    @OriginalMember(owner = "client!cg", name = "d", descriptor = "()V", line = 12)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(II)V", line = 26)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(ILoe;Loe;)V", line = 94)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "()Z", line = 250)
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "(Lhd;)V", line = 278)
    public class270(class17 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!cg", name = "b", descriptor = "()I", line = 286)
    public final int method1736() {
        return 1;
    }

    @OriginalMember(owner = "client!cg", name = "c", descriptor = "(I)V", line = 295)
    ...
    @OriginalMember(owner = "client!cg", name = "c", descriptor = "()Z", line = 301)
