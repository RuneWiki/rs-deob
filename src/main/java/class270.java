...
public class class270 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(JBLlha;)V", line = 36)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(ZJ)V", line = 78)
    ...
    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(I)V", line = 135)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(JI)Llha;", line = 102)
