...
public class class270 {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(II)V", line = 82)
    ...
    @OriginalMember(owner = "client!se", name = "c", descriptor = "(I)I", line = 94)
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(Z)V", line = 112)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(III)I", line = 127)
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(II)Lfv;", line = 144)
    ...
    @OriginalMember(owner = "client!se", name = "<init>", descriptor = "(Lkw;ILuq;)V", line = 184)
