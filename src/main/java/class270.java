...
public class class270 implements Runnable {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Lge;B)V")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Ltj;Z)V")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Ljava/lang/String;B)Lpp;")
