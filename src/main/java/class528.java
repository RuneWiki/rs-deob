...
public class class528 extends class270 implements class142 {
    ...
    @OriginalMember(owner = "client!v", name = "finalize", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 12)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "()V", line = 37)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Ljava/lang/Exception;)V", line = 45)
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(Lda;Ljava/awt/Canvas;)V", line = 67)
    ...
    @OriginalMember(owner = "client!v", name = "b", descriptor = "()V", line = 74)
