...
public class class528 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(BI)[I", line = 9)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(BII)Z", line = 54)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(II)Leu;", line = 128)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IIIII)V", line = 141)
    ...
    @OriginalMember(owner = "client!tt", name = "<init>", descriptor = "(Ljk;ILae;)V", line = 152)
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(I)Z", line = 295)
