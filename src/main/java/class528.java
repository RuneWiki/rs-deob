...
public class class528 {
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(II)V", line = 28)
    ...
    @OriginalMember(owner = "client!cv", name = "b", descriptor = "(B)Lcv;", line = 42)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Lcv;I)V", line = 53)
    ...
    @OriginalMember(owner = "client!cv", name = "<init>", descriptor = "(I)V", line = 82)
    public class528(int arg0) {
        this.field7153 = arg0;
    }

    @OriginalMember(owner = "client!cv", name = "<init>", descriptor = "(IIIIII)V", line = 89)
