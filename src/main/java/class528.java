...
public class class528 extends class253 {
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "()V", line = 38)
    public class528() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IBZ)V", line = 42)
    ...
    @OriginalMember(owner = "client!hg", name = "g", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(ZLd;Lgga;)V", line = 68)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IBII)[B", line = 88)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IIIII)V", line = 100)
