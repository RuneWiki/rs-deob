...
public class class528 implements class179 {
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "()V", line = 190)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(BLjava/awt/Component;ZI)V", line = 17)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(I[I)V", line = 53)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IZ)V", line = 88)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IZI)V", line = 98)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(BI)I", line = 120)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(II)V", line = 158)
