...
public class class528 extends class45 {
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "()V", line = 20)
    public class528() {
        super(1, false);
    }

    @OriginalMember(owner = "client!lo", name = "f", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!lo", name = "b", descriptor = "(II)[[I", line = 41)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lcu;II)V", line = 118)
