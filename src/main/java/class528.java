...
public class class528 {
    ...
    @OriginalMember(owner = "client!eaa", name = "d", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!eaa", name = "e", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!eaa", name = "c", descriptor = "(I)I", line = 28)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(BILnba;Ljava/lang/Object;)V", line = 40)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(Lnba;B)Ljava/lang/Object;", line = 74)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(B)V", line = 132)
    ...
    @OriginalMember(owner = "client!eaa", name = "b", descriptor = "(I)I", line = 146)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(I)V", line = 159)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(BI)V", line = 187)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(ZLqia;)V", line = 237)
    ...
    @OriginalMember(owner = "client!eaa", name = "<init>", descriptor = "(I)V", line = 257)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(BLjava/lang/Object;Lnba;)V", line = 272)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(ILnba;)V", line = 283)
