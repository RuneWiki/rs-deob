...
public class class528 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(I)Z", line = 41)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IIII)Z", line = 52)
