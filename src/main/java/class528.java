...
public class class528 extends class657 {
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IIIIZIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!hj", name = "<init>", descriptor = "(Lok;IIII[BI)V", line = 22)
    ...
    @OriginalMember(owner = "client!hj", name = "c", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!hj", name = "<init>", descriptor = "(Lok;IIII)V", line = 62)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(I)V", line = 76)
