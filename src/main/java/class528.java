...
public class class528 {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!hu", name = "b", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Lnk;IIIII)Ltw;", line = 36)
    ...
    @OriginalMember(owner = "client!hu", name = "c", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "([BBI)I", line = 84)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(BI)V", line = 100)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(II)Ltv;", line = 116)
    ...
    @OriginalMember(owner = "client!hu", name = "<init>", descriptor = "(Lrf;ILpl;)V", line = 150)
