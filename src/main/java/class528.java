...
public class class528 extends class334 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(B)Lhd;")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IBI)Lku;")
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(ILeo;Leo;Lpr;Ltj;IIZ)V")
