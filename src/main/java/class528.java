...
public class class528 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IBLqa;)Z", line = 5)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(ZIIILhu;I)Ljava/awt/Frame;", line = 115)
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(I[Lte;IIII)V", line = 323)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IIIIILqa;IIII)V", line = 201)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(BLns;)V", line = 278)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(ILjava/lang/String;)I", line = 288)
