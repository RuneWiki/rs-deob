...
public class class528 extends class127 {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(ILha;IIIII)Lka;")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(ILub;)V")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(IIILhs;ILka;IIIILha;III)Lka;")
