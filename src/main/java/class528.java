...
public class class528 extends class443 implements class238 {
    ...
    @OriginalMember(owner = "client!cm", name = "finalize", descriptor = "()V", line = 13)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Ljj;III)V", line = 90)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Ljj;IIII)V", line = 113)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!cm", name = "c", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!cm", name = "f", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(III)V", line = 74)
