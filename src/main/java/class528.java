...
public class class528 extends class86 {
    ...
    @OriginalMember(owner = "client!ob", name = "c", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(ZLlr;I)V", line = 21)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IZ)V", line = 38)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "([Laa;B)V", line = 56)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IBI)V", line = 98)
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(Lnq;Lhl;)V", line = 157)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Lnq;I)V", line = 189)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(ZB)V", line = 228)
    ...
    @OriginalMember(owner = "client!ob", name = "b", descriptor = "(B)Z", line = 240)
