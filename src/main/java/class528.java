...
public class class528 extends class47 {
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(B)J", line = 4)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(IJ)I", line = 39)
    ...
    @OriginalMember(owner = "client!iw", name = "b", descriptor = "(I)J", line = 73)
    ...
    @OriginalMember(owner = "client!iw", name = "<init>", descriptor = "()V", line = 116)
    public class528() {
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(Z)V", line = 94)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(I)J", line = 107)
