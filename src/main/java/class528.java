...
public class class528 extends class128 {
    ...
    @OriginalMember(owner = "client!maa", name = "<init>", descriptor = "(Lck;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!maa", name = "<init>", descriptor = "(Lck;II)V")
    ...
    @OriginalMember(owner = "client!maa", name = "<init>", descriptor = "(Lck;IIZ[[I)V")
