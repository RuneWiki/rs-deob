...
public class class528 {
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(BII)Z", line = 24)
    ...
    @OriginalMember(owner = "client!raa", name = "toString", descriptor = "()Ljava/lang/String;", line = 49)
    public final String toString() {
        field7646++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!raa", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 56)
