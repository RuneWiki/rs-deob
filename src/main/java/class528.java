...
public class class528 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IBI)Z", line = 11)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IB)V", line = 40)
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(IB)V", line = 53)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IZ)Llf;", line = 67)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(II)I", line = 108)
    public static final int method3006(int arg0, int arg1) {
        return class298.field3992 == null ? 0 : class298.field3992[arg0][arg1] & 0xFF;
    }

    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Z)V", line = 111)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(Luea;ILpq;)V", line = 144)
