...
public class class528 extends class184 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Lbs;I[II)V", line = 5)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ILrg;)V", line = 88)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(B)I", line = 128)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(B)V", line = 149)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(I)V", line = 200)
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "()V", line = 296)
    public class528() {
    }

    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(ZLge;)V", line = 298)
