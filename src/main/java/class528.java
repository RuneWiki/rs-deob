...
public class class528 extends class63 implements class303 {
    ...
    @OriginalMember(owner = "client!eu", name = "c", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(BLza;)Lql;")
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(IIIIILbp;)V")
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IBILza;)Z")
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(ILza;B)Le;")
