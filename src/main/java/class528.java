...
public class class528 extends class271 {
    ...
    @OriginalMember(owner = "client!lo", name = "b", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!lo", name = "c", descriptor = "(II)Z", line = 14)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(I)Z", line = 28)
    ...
    @OriginalMember(owner = "client!lo", name = "d", descriptor = "(II)Z", line = 128)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lmv;II)Z", line = 140)
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(I)V", line = 303)
