...
public abstract class class528 {
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IIII)I", line = 8)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IZIIII)V", line = 35)
    ...
    @OriginalMember(owner = "client!uba", name = "<init>", descriptor = "(IIIII)V", line = 355)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(ILuv;)Luv;", line = 123)
    ...
    @OriginalMember(owner = "client!uba", name = "b", descriptor = "(IIII)V", line = 149)
    ...
    @OriginalMember(owner = "client!uba", name = "c", descriptor = "(B)V", line = 316)
