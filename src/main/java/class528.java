...
public class class528 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IILr;I)Z")
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ZIILr;)V")
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ILr;BI)V")
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(Lpj;Lmf;)V")
