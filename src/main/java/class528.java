...
public class class528 {
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Liaa;I)Lim;", line = 5)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(I)I", line = 28)
    ...
    @OriginalMember(owner = "client!cv", name = "b", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!cv", name = "c", descriptor = "(I)V", line = 65)
