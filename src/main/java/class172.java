...
public class class172 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lmc;I)V")
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lfr;)V")
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lfr;I)V")
