...
public class class172 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "([I[IIIIIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "([I[IIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "([I[IIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "([IIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(Lpm;)V")
