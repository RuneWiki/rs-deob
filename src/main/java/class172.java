...
public class class172 extends class108 {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(II)I", line = 18)
    ...
    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "()V", line = 33)
    public class172() {
    }

    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 35)
