...
public class class172 extends class455 implements class113 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Leq;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!gf", name = "d", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(B)I", line = 42)
    public final int method362(byte arg0) {
        field2337++;
        return arg0 == -72 ? 0 : -111;
    }

    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Leq;Z)V", line = 53)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(BLeq;)V", line = 65)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ZLjava/lang/String;)J", line = 76)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(Leq;Z)Lgl;", line = 99)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ILeq;Z)Lva;", line = 110)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(B)I", line = 122)
    ...
    @OriginalMember(owner = "client!gf", name = "c", descriptor = "(B)I", line = 137)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IZIIIII)V", line = 156)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Z)Z", line = 210)
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(IIIIILab;)V", line = 221)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ILeq;BI)Z", line = 230)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(I)I", line = 246)
