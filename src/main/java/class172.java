...
public class class172 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(Luf;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(II)I", line = 21)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(I)V", line = 44)
