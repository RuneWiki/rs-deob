...
public class class172 extends class401 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(I)F", line = 6)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "()I", line = 25)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(I)[F", line = 33)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lsea;II)Lvp;", line = 447)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "([I)Lbu;", line = 463)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lsea;I)Lvp;", line = 528)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lsea;)Z", line = 546)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "([BI)V", line = 563)
    ...
    @OriginalMember(owner = "client!vp", name = "c", descriptor = "(I)I", line = 570)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "()V", line = 597)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "([B)V", line = 621)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "([B)V", line = 774)
    ...
    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "([B)V", line = 817)
