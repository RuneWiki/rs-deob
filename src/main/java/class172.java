...
public class class172 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(I[B)V", line = 4)
    public final void method1161(int arg0, byte[] arg1) throws IOException {
        field2745++;
        this.method1168(arg0, arg1.length, arg1, ~arg0);
    }

    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(B)J", line = 14)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(I[BII)V", line = 135)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Lje;II)V", line = 597)
    ...
    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(I)Ljava/io/File;", line = 266)
    private final File method1166(int arg0) {
        field2766++;
        return arg0 == 2149 ? this.field2752.method413(-1) : null;
    }

    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IIIIZLsq;B)V", line = 279)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(II[BI)V", line = 342)
    ...
    @OriginalMember(owner = "client!ok", name = "c", descriptor = "(B)V", line = 529)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(JB)V", line = 574)
