...
public class class172 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Ltq;II)Lne;")
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "()Lvo;")
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(Ldg;)V")
