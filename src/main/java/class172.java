...
public class class172 {
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(ILpp;)V")
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(Lrda;Z)V")
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(IBI)Z")
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(Lrda;B)V")
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(ILjw;)V")
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(Z)Lhga;")
