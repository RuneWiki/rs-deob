...
public class class172 {
    ...
    @OriginalMember(owner = "client!gw", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!gw", name = "c", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(IB)Lgia;", line = 50)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(II)V", line = 79)
    ...
    @OriginalMember(owner = "client!gw", name = "<init>", descriptor = "(Lms;ILwu;)V", line = 99)
