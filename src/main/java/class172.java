...
public class class172 extends class130 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(FFFFFFLtm;II)V")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IILtm;II)V")
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Lhj;IIII)V")
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Lhj;II[III)V")
