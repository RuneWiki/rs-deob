...
public class class172 extends class80 {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(BII)Z", line = 9)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "([Lo;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "()V", line = 48)
    public class172() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IILnn;)V", line = 51)
    ...
    @OriginalMember(owner = "client!fc", name = "b", descriptor = "(II)[I", line = 86)
