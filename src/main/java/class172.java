...
public class class172 extends class168 implements class303 {
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(Lza;Lpm;IIIIIZIII)V")
    ...
    @OriginalMember(owner = "client!to", name = "c", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IBILza;)Z")
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILza;B)Le;")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Llb;IZIBILza;)V")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(BLza;)Lql;")
