...
public class class172 {
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Lsaa;ILsaa;F)Z", line = 20)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(B)Z", line = 90)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(I[BIIIIII[B)V", line = 119)
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "(Leq;)V", line = 163)
