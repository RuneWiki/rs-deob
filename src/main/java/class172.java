...
public class class172 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(III)Z", line = 35)
