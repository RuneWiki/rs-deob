...
public abstract class class172 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(ZII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(BIZ)V", line = 46)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(II)Z", line = 73)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(I)V", line = 190)
