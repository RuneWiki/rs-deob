...
public class class172 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(IIBLdg;)V", line = 7)
    ...
    @OriginalMember(owner = "client!hga", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 26)
