...
public abstract class class172 extends class36 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IIIIILoa;I)Lba;", line = 3)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ZLoa;)V", line = 56)
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(I)V", line = 77)
    public class172(int arg0) {
        this.field2116 = arg0;
    }

    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lw;III[Z)Z", line = 86)
