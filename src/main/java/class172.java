...
public class class172 extends class132 {
    ...
    @OriginalMember(owner = "client!efa", name = "b", descriptor = "(Z)I", line = 5)
    public final int method860(boolean arg0) {
        return arg0 ? this.field2021 : -20;
    }

    @OriginalMember(owner = "client!efa", name = "b", descriptor = "(B)I", line = 17)
    public final int method861(byte arg0) {
        int var2 = -9 / ((-arg0 - 10) / 43);
        return this.field2022;
    }

    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(I)I", line = 26)
    ...
    @OriginalMember(owner = "client!efa", name = "b", descriptor = "(I)J", line = 37)
    public final long method854(int arg0) {
        return arg0 == 32055 ? this.field2020 : 77L;
    }

    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(B)I", line = 47)
