...
public class class172 {
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Lsl;ZI)V", line = 40)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(III)Z", line = 60)
    ...
    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Lsl;Z)V", line = 84)
