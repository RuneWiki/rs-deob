...
public class class172 extends class381 {
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(SI)V", line = 7)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(I[[ZIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(BII)V", line = 79)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(IIIIBII)V", line = 137)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(BLlr;)V", line = 320)
    ...
    @OriginalMember(owner = "client!hga", name = "<init>", descriptor = "(Lum;Lom;Ltg;[I)V", line = 514)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(IBI)Z", line = 776)
