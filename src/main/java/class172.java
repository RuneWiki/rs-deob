...
public class class172 {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(II)Lnm;")
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(II)Llo;")
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "(Lai;ILic;Lic;Lic;)V")
