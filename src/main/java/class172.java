...
public class class172 extends class673 implements Runnable {
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(BLjava/lang/String;ZLoa;Lta;Lkga;)V")
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!qga", name = "<init>", descriptor = "(Ldt;)V")
