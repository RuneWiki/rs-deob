...
public class class172 extends class454 implements class614 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IZLr;Lrga;IIZ)V", line = 15)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lr;I)V", line = 27)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(Lr;Z)Lkq;", line = 40)
    ...
    @OriginalMember(owner = "client!vp", name = "c", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(I)I", line = 103)
    ...
    @OriginalMember(owner = "client!vp", name = "f", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lr;Z)V", line = 124)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(ILr;)V", line = 139)
    ...
    @OriginalMember(owner = "client!vp", name = "c", descriptor = "(B)V", line = 160)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Z)I", line = 170)
    ...
    @OriginalMember(owner = "client!vp", name = "d", descriptor = "(I)Z", line = 184)
    ...
    @OriginalMember(owner = "client!vp", name = "i", descriptor = "(I)Z", line = 195)
    public final boolean method1181(int arg0) {
        ++field2453;
        return arg0 != -1 ? false : false;
    }

    @OriginalMember(owner = "client!vp", name = "g", descriptor = "(I)I", line = 209)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(ILr;)Lnu;", line = 221)
    ...
    @OriginalMember(owner = "client!vp", name = "h", descriptor = "(I)Z", line = 234)
    ...
    @OriginalMember(owner = "client!vp", name = "j", descriptor = "(I)Z", line = 245)
    public final boolean method951(int arg0) {
        ++field2457;
        return arg0 > -26;
    }

    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "(Lr;Let;IIIIIZIIIIIII)V", line = 256)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IILr;I)Z", line = 277)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(I)I", line = 296)
