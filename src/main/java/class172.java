...
public abstract class class172 extends class295 {
    ...
    @OriginalMember(owner = "client!gn", name = "e", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!gn", name = "g", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lsa;Lpe;[[II[[BB[[BIZ[[B[[BLsa;I)V", line = 34)
