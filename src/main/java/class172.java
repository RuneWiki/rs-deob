...
public class class172 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(I)Lfi;", line = 11)
    ...
    @OriginalMember(owner = "client!up", name = "b", descriptor = "(I)Lfi;", line = 33)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "()V", line = 114)
    public class172() {
        this.field2654.field5454 = this.field2654;
        this.field2654.field5456 = this.field2654;
    }

    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Lfi;B)V", line = 80)
    ...
    @OriginalMember(owner = "client!up", name = "c", descriptor = "(I)V", line = 98)
