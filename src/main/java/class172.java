...
public class class172 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IIIIII)V", line = 21)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(III)Z", line = 48)
    ...
    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(III)Z", line = 60)
