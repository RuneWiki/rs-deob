...
public class class172 extends class532 {
    ...
    @OriginalMember(owner = "client!aq", name = "d", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(III)B", line = 14)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IBI)V", line = 33)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(ZI)V", line = 57)
    ...
    @OriginalMember(owner = "client!aq", name = "<init>", descriptor = "(Lwg;)V", line = 70)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(ZB)V", line = 181)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Z)V", line = 227)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(ZILgaa;)V", line = 274)
    ...
    @OriginalMember(owner = "client!aq", name = "e", descriptor = "(I)V", line = 286)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IILjw;I)V", line = 297)
