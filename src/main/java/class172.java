...
public class class172 extends class649 {
    ...
    @OriginalMember(owner = "client!ad", name = "c", descriptor = "(I)I", line = 4)
    public final int method1358(int arg0) {
        ++field2944;
        return arg0 != 3 ? 1 : super.field9223;
    }

    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(IZ[B)I", line = 17)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(I)I", line = 29)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(IZI)V", line = 39)
    ...
    @OriginalMember(owner = "client!ad", name = "b", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(II)I", line = 74)
    ...
    @OriginalMember(owner = "client!ad", name = "<init>", descriptor = "(Lhs;)V", line = 85)
    public class172(class358 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(IB)V", line = 88)
    ...
    @OriginalMember(owner = "client!ad", name = "<init>", descriptor = "(ILhs;)V", line = 99)
    public class172(int arg0, class358 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(III)Z", line = 102)
    ...
    @OriginalMember(owner = "client!ad", name = "d", descriptor = "(I)V", line = 117)
