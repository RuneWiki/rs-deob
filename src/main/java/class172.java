...
public class class172 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IILjava/awt/Canvas;Ll;)Lqa;", line = 8)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IIILjava/lang/Class;)Lhi;", line = 36)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(II)V", line = 60)
