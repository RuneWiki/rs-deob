...
public class class172 extends class303 implements class323 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IZILqa;)Z")
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(Lqa;B)Lvs;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(Lqa;Ljt;IIIIIZIIIIII)V")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IILqa;)Lc;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lqa;B)V")
