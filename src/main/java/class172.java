...
public class class172 extends class63 {
    ...
    @OriginalMember(owner = "client!bga", name = "k", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 17)
    ...
    @OriginalMember(owner = "client!bga", name = "<init>", descriptor = "(I)V", line = 93)
    public class172(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(FI)V", line = 96)
    ...
    @OriginalMember(owner = "client!bga", name = "l", descriptor = "(B)Z", line = 112)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(IF)V", line = 141)
    ...
    @OriginalMember(owner = "client!bga", name = "w", descriptor = "(I)V", line = 159)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(IBLjava/lang/String;Lrp;)Ljg;", line = 636)
