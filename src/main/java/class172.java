...
public class class172 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Z)Lek;")
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Ljava/lang/String;IIZLjava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(B)[Lvl;")
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ILee;)Loq;")
