...
public class class172 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IBLnj;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(II)I", line = 19)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lnj;I)V", line = 29)
