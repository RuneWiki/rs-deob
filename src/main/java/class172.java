...
public class class172 extends class211 {
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!tba", name = "e", descriptor = "(III)Z", line = 16)
    ...
    @OriginalMember(owner = "client!tba", name = "<init>", descriptor = "()V", line = 165)
    public class172() {
        super(0, true);
    }

    @OriginalMember(owner = "client!tba", name = "b", descriptor = "(II)[I", line = 41)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(IIIIILcca;I)Z", line = 91)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(BI)V", line = 152)
    ...
    @OriginalMember(owner = "client!tba", name = "d", descriptor = "(III)Z", line = 169)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(I[BLrda;I)Lhu;", line = 188)
    ...
    @OriginalMember(owner = "client!tba", name = "c", descriptor = "(I)I", line = 241)
    ...
    @OriginalMember(owner = "client!tba", name = "g", descriptor = "(I)V", line = 253)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(BILib;)V", line = 268)
