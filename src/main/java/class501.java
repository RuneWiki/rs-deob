...
public class class501 extends class252 {
    ...
    @OriginalMember(owner = "client!j", name = "e", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!j", name = "g", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!j", name = "f", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Ltb;Lpu;Luk;)V", line = 60)
    ...
    @OriginalMember(owner = "client!j", name = "d", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!j", name = "b", descriptor = "(ZI)V", line = 104)
    ...
    @OriginalMember(owner = "client!j", name = "c", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(B)V", line = 132)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(III)V", line = 153)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(ZI)V", line = 181)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Z)V", line = 216)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lbb;II)V", line = 239)
