...
public class class501 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(BLuk;[[B)V")
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Lqh;ILtf;)V")
    public class501(class320 arg0, int arg1, class701 arg2) {
        this.field7239 = arg2;
        this.field7239.method3883(5, 0);
    }

    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(II)Lfm;")
