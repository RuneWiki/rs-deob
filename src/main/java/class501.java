...
public class class501 extends class194 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "([B[IIIIIIIIIIILfa;II)V")
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "([B[IIIIIIIIIIILfa;II)V")
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(CIIIZLfa;II)V")
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Lfv;Lmj;[Lkq;[I[I)V")
