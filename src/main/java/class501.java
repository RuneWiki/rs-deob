...
public class class501 {
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(BLjava/lang/String;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(II)I", line = 95)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!lu", name = "b", descriptor = "(II)V", line = 131)
