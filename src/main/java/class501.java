...
public class class501 extends class197 implements class394 {
    ...
    @OriginalMember(owner = "client!jh", name = "c", descriptor = "(ILr;)V", line = 3)
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "(Lr;Lnf;IIIIIZIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!jh", name = "i", descriptor = "(I)I", line = 37)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(B)I", line = 49)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Lvj;IZLr;IIB)V", line = 60)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Lr;I)Lej;", line = 74)
    ...
    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(ILr;)Leh;", line = 129)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Lr;B)V", line = 151)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(I)I", line = 162)
    public final int method903(int arg0) {
        ++field7455;
        return arg0 <= 76 ? -114 : this.field7437.field9382;
    }

    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(I)I", line = 174)
    ...
    @OriginalMember(owner = "client!jh", name = "j", descriptor = "(I)V", line = 191)
    ...
    @OriginalMember(owner = "client!jh", name = "g", descriptor = "(I)Z", line = 203)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Z)I", line = 214)
    public final int method907(boolean arg0) {
        ++field7444;
        return arg0 ? -87 : this.field7437.field9418;
    }

    @OriginalMember(owner = "client!jh", name = "c", descriptor = "(I)V", line = 225)
    ...
    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(Z)Z", line = 238)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IILr;B)Z", line = 252)
    ...
    @OriginalMember(owner = "client!jh", name = "h", descriptor = "(I)Z", line = 270)
    ...
    @OriginalMember(owner = "client!jh", name = "c", descriptor = "(Z)Z", line = 280)
    public final boolean method633(boolean arg0) {
        ++field7452;
        return !arg0;
    }

    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ILr;)V", line = 291)
