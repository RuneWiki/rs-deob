...
public class class501 implements class418 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IZ)I", line = 4)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(II)V", line = 38)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(B)I", line = 51)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(I)Lcca;", line = 65)
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(Luu;)V", line = 82)
    public class501(class237 arg0) {
        this.field6983 = arg0;
    }

    @OriginalMember(owner = "client!ak", name = "b", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIII)I", line = 102)
