...
public class class501 extends class431 {
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(I[II[IILmj;)Llh;")
    ...
    @OriginalMember(owner = "client!bca", name = "q", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(ILvi;)V")
