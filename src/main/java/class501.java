...
public class class501 extends class223 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(IIIIIIII)V", line = 127)
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(I[B)V", line = 152)
