...
public class class501 extends class12 {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Lnv;[Lw;I)Lrda;")
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    public class501(OggStreamState arg0) {
        super(arg0);
    }

    // $FF: synthetic method
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
