...
public class class501 implements Runnable {
    ...
    @OriginalMember(owner = "client!ad", name = "finalize", descriptor = "()V", line = 3)
    protected final void finalize() {
        field7476++;
        this.method2994(-1);
    }

    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(IZIIIIIIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "([FII)[F", line = 74)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(IIIILjava/lang/String;ILjb;IBLse;Lea;Loa;)V", line = 105)
    ...
    @OriginalMember(owner = "client!ad", name = "b", descriptor = "(I)V", line = 153)
    ...
    @OriginalMember(owner = "client!ad", name = "b", descriptor = "(B)I", line = 191)
    ...
    @OriginalMember(owner = "client!ad", name = "<init>", descriptor = "(Ljava/net/Socket;Lhu;)V", line = 458)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(IB)I", line = 214)
    ...
    @OriginalMember(owner = "client!ad", name = "run", descriptor = "()V", line = 245)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "([BIBI)V", line = 313)
    ...
    @OriginalMember(owner = "client!ad", name = "c", descriptor = "(I)V", line = 353)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "([BIII)V", line = 376)
    ...
    @OriginalMember(owner = "client!ad", name = "c", descriptor = "(B)I", line = 432)
