...
public class class501 extends class96 {
    ...
    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "(Lml;)V", line = 5)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Z)Z", line = 47)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(IZLica;)V", line = 58)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(ZB)V", line = 71)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(ZI)V", line = 82)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!mt", name = "c", descriptor = "(I)V", line = 135)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(III)Llg;", line = 146)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(ZII)V", line = 156)
