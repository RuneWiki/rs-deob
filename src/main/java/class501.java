...
public class class501 {
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(IB)Leba;")
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(IIIILhh;I)Lvaa;")
    ...
    @OriginalMember(owner = "client!eaa", name = "<init>", descriptor = "(Lrga;ILni;)V")
