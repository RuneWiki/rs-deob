...
public class class501 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IIBIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(BIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(I[Ljava/lang/String;II)Ljava/lang/String;", line = 54)
