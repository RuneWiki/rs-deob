...
public class class501 extends class417 {
    ...
    @OriginalMember(owner = "client!pm", name = "c", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ZI)V", line = 36)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Z)Z", line = 77)
