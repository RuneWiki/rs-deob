...
public class class501 extends class316 {
    ...
    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "(Lur;Lgf;[Lev;Z)V")
    ...
    @OriginalMember(owner = "client!ip", name = "B", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(CIIIZLta;II)V")
