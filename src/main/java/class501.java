...
public class class501 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(I)Lhm;", line = 3)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(III)V", line = 21)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(ZI)Lnk;", line = 55)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(II)V", line = 88)
    public class501(int arg0, int arg1) {
        this.field7393 = arg1;
        this.field7389 = arg0;
    }

    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(Lnk;I)V", line = 96)
