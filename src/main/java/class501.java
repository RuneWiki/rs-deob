...
public class class501 {
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "([IIBI)Lmda;", line = 28)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(II[I)Lmda;", line = 73)
    ...
    @OriginalMember(owner = "client!iu", name = "b", descriptor = "(II[I)Lmda;", line = 95)
    ...
    @OriginalMember(owner = "client!iu", name = "b", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(I[IZI)Lmda;", line = 136)
    ...
    @OriginalMember(owner = "client!iu", name = "<init>", descriptor = "(Lpq;Lpq;)V", line = 188)
