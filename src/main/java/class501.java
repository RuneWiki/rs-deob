...
public class class501 extends class295 {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ILri;II)V")
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!qq", name = "CA", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!qq", name = "fa", descriptor = "(IILr;)Lr;")
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "(Lee;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Lr;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Luaa;[I)V")
    ...
    @OriginalMember(owner = "client!qq", name = "wa", descriptor = "(Lr;IIIIZ)V")
