...
public class class501 implements class370 {
    ...
    @OriginalMember(owner = "client!nha", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 9)
    public class501(String arg0, int arg1) {
        this.field7063 = arg1;
    }

    @OriginalMember(owner = "client!nha", name = "toString", descriptor = "()Ljava/lang/String;", line = 19)
