...
public class class501 extends class532 {
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(ZILgaa;)V", line = 4)
    ...
    @OriginalMember(owner = "client!gk", name = "d", descriptor = "(B)Z", line = 17)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Z)V", line = 28)
    public final void method699(boolean arg0) {
        ++field7030;
        super.field7494.method2659(arg0, 24103);
    }

    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IIIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!gk", name = "e", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!gk", name = "f", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(ZB)V", line = 82)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IBI)V", line = 93)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(ZI)V", line = 111)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IB)Z", line = 122)
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(Lwg;)V", line = 139)
