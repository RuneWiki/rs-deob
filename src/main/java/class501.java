...
public class class501 extends class412 {
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(Lpm;[III)V")
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(Lpm;[IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(Lpm;II)V")
