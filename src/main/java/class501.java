...
public class class501 extends class766 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IDI)Lqg;", line = 5)
    ...
    @OriginalMember(owner = "client!nm", name = "b", descriptor = "()I", line = 29)
    public final int method591() {
        field6927++;
        return 1;
    }

    @OriginalMember(owner = "client!nm", name = "d", descriptor = "()Lsia;", line = 39)
    public final class766 method592() {
        field6916++;
        return null;
    }

    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IB)V", line = 47)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(B)I", line = 97)
    public final synchronized int method2893(byte arg0) {
        field6914++;
        return arg0 > -82 ? -95 : this.field6930;
    }

    @OriginalMember(owner = "client!nm", name = "a", descriptor = "([III)V", line = 108)
    ...
    @OriginalMember(owner = "client!nm", name = "b", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!nm", name = "b", descriptor = "(III)Ljd;", line = 187)
    ...
    @OriginalMember(owner = "client!nm", name = "d", descriptor = "(B)V", line = 200)
    ...
    @OriginalMember(owner = "client!nm", name = "e", descriptor = "(B)V", line = 217)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(ILqg;)V", line = 239)
    ...
    @OriginalMember(owner = "client!nm", name = "d", descriptor = "(I)D", line = 259)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "()Lsia;", line = 279)
    public final class766 method595() {
        field6911++;
        return null;
    }

    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(BC)Z", line = 288)
    ...
    @OriginalMember(owner = "client!nm", name = "e", descriptor = "(I)Lqg;", line = 299)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(ZI)V", line = 314)
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(I)V", line = 363)
    public class501(int arg0) {
        this.field6928 = arg0;
    }

    @OriginalMember(owner = "client!nm", name = "f", descriptor = "(I)V", line = 331)
