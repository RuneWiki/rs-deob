...
public abstract class class501 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ZILjava/net/Socket;)Ltn;", line = 7)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ZI)I", line = 19)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IIII)I", line = 65)
