...
public class class501 extends class258 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(BI)Z", line = 27)
    ...
    @OriginalMember(owner = "client!oga", name = "b", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!oga", name = "c", descriptor = "(I)I", line = 54)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "([BIII)I", line = 83)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!oga", name = "finalize", descriptor = "()V", line = 111)
    ...
    @OriginalMember(owner = "client!oga", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 118)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "([BZII)V", line = 135)
