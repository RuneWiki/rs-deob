...
public class class501 extends class362 {
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(IIIIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(IB)[[I", line = 53)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(Lfca;II)V", line = 129)
    ...
    @OriginalMember(owner = "client!oga", name = "d", descriptor = "(B)V", line = 173)
    ...
    @OriginalMember(owner = "client!oga", name = "<init>", descriptor = "()V", line = 200)
    public class501() {
        super(1, false);
    }

    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(II)[I", line = 203)
