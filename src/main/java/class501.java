...
public class class501 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(Ljava/lang/String;Ljava/applet/Applet;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(I[Ljava/lang/Object;Ljava/applet/Applet;Ljava/lang/String;)Ljava/lang/Object;", line = 15)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(Ljava/lang/String;BLjava/applet/Applet;)Ljava/lang/Object;", line = 25)
