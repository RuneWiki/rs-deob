...
public class class501 extends class190 {
    ...
    @OriginalMember(owner = "client!dca", name = "<init>", descriptor = "(Ljj;Llm;)V", line = 4)
    ...
    @OriginalMember(owner = "client!dca", name = "b", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(ILaba;I)V", line = 49)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(ZB)V", line = 62)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(III)V", line = 79)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(CB)I", line = 134)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(ZI)V", line = 150)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(B)V", line = 161)
    ...
    @OriginalMember(owner = "client!dca", name = "c", descriptor = "(I)V", line = 180)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(IIIII)V", line = 190)
    ...
    @OriginalMember(owner = "client!dca", name = "b", descriptor = "(I)Z", line = 218)
