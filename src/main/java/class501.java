...
public class class501 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IZ)I", line = 6)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(B[B)[B", line = 25)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(II)I", line = 93)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(BI)Z", line = 122)
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(II)V", line = 133)
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(II)V", line = 152)
