...
public class class501 extends class508 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(CZI)I", line = 18)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(III)Z", line = 41)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(I[III)V", line = 59)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IIB)Z", line = 72)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(BII[I)V", line = 88)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IIII)Z", line = 115)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(IIIIIIIII)V", line = 129)
