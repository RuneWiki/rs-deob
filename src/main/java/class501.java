...
public class class501 implements Runnable {
    ...
    @OriginalMember(owner = "client!eaa", name = "run", descriptor = "()V", line = 15)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(IBIIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(IILat;B)V", line = 161)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(ZI)Lwc;", line = 206)
    ...
    @OriginalMember(owner = "client!eaa", name = "b", descriptor = "(I)Z", line = 225)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "([Ljava/lang/Object;[JI)V", line = 272)
