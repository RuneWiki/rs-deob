...
public class class501 extends class535 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(BLjava/lang/String;)I", line = 3)
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "()V", line = 25)
    public class501() {
        super(0, true);
    }

    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(II)[I", line = 29)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILwn;I)V", line = 109)
    ...
    @OriginalMember(owner = "client!dq", name = "c", descriptor = "(I)I", line = 135)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(BLki;)V", line = 149)
    ...
    @OriginalMember(owner = "client!dq", name = "f", descriptor = "(B)V", line = 175)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Z)V", line = 187)
    ...
    @OriginalMember(owner = "client!dq", name = "e", descriptor = "(I)V", line = 275)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Lsv;Z)Z", line = 293)
