...
public class class503 extends class86 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IIILfda;I)V")
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(ILsf;)V")
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(Lsf;)V")
