...
public class class503 extends class642 {
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(Lji;B)V")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(FFIF)F")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Lqj;I)V")
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "(Lqj;)V")
