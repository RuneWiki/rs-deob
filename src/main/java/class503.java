...
public class class503 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(BI)Lts;")
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IBLjava/lang/String;)Lpu;")
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(ZILda;IILae;IIBLha;Lha;Z)Lmq;")
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IILha;IIILae;I)Lmq;")
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "(Lmca;IZLva;Lgga;Lgga;)V")
