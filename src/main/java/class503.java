...
public class class503 extends class388 {
    ...
    @OriginalMember(owner = "client!jn", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Lbi;III)V", line = 37)
