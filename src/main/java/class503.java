...
public class class503 {
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(I)J", line = 4)
    ...
    @OriginalMember(owner = "client!bda", name = "b", descriptor = "(I)Ljava/io/File;", line = 17)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!bda", name = "c", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(JI)V", line = 94)
    ...
    @OriginalMember(owner = "client!bda", name = "d", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "([BB)V", line = 138)
    ...
    @OriginalMember(owner = "client!bda", name = "<init>", descriptor = "(Lbt;II)V", line = 657)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(Lha;I)V", line = 156)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(III[B)V", line = 262)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(II[BB)V", line = 394)
    ...
    @OriginalMember(owner = "client!bda", name = "b", descriptor = "(B)V", line = 580)
