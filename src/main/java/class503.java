...
public class class503 {
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(Lpj;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(Lpj;B)V", line = 34)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(Lpj;BI)V", line = 50)
    ...
    @OriginalMember(owner = "client!iea", name = "b", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!iea", name = "<init>", descriptor = "(Lpj;)V", line = 684)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(ILpj;)V", line = 88)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(ZILpj;)V", line = 102)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(Lkd;IBLpj;)V", line = 497)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(II)V", line = 656)
