...
public class class503 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(IBJI)V", line = 6)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(II)[[I", line = 52)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(I)[[[I", line = 127)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(III)V", line = 218)
    ...
    @OriginalMember(owner = "client!td", name = "c", descriptor = "(I)V", line = 167)
