...
public class class503 implements class200 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Ljava/lang/Object;Ljava/lang/Class;ILjava/lang/String;)Z", line = 5)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Z)I", line = 19)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IIII)I", line = 42)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(BZ)V", line = 70)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ILsj;I)Z", line = 258)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(B)V", line = 426)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(I)I", line = 436)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Object;BLjava/lang/Class;)I", line = 448)
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(I)V", line = 461)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(II)I", line = 473)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;", line = 487)
    ...
    @OriginalMember(owner = "client!gu", name = "c", descriptor = "(I)V", line = 508)
    ...
    @OriginalMember(owner = "client!gu", name = "d", descriptor = "(I)V", line = 557)
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(II)I", line = 575)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(BILjava/net/Socket;)Lbj;", line = 590)
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(Z)V", line = 603)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(JB)Z", line = 613)
