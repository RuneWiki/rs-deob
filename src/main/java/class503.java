...
public class class503 extends class446 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IILac;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(III)V", line = 18)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IIIII)V", line = 34)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "(Lda;)V", line = 80)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(BZ)V", line = 120)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(B)Z", line = 131)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ZB)V", line = 145)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IBII[I)V", line = 169)
