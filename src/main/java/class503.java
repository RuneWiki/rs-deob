...
public abstract class class503 implements class326 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Ljaggl/MapBuffer;I)Z")
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(ILjaclib/memory/Source;I)Z")
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(ILjaggl/MapBuffer;Z)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!hm", name = "<init>", descriptor = "(Lmr;IZ)V")
