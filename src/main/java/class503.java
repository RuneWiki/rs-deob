...
public class class503 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Lvj;I)V", line = 19)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(BI)V", line = 40)
    ...
    @OriginalMember(owner = "client!jn", name = "b", descriptor = "(B)V", line = 60)
    public static void method3011(byte arg0) {
        field7416 = null;
        int var1 = -103 / ((arg0 - 1) / 40);
    }

    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(BLvj;Lsh;)V", line = 71)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Lvj;IB)V", line = 360)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Lvj;B)V", line = 716)
    ...
    @OriginalMember(owner = "client!jn", name = "b", descriptor = "(Lvj;I)V", line = 733)
