...
public class class503 extends class513 {
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(ZB)C", line = 58)
