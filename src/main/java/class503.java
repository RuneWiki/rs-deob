...
public class class503 {
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(B)[[[I", line = 3)
    ...
    @OriginalMember(owner = "client!lu", name = "b", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(II)[[I", line = 39)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!lu", name = "<init>", descriptor = "(III)V", line = 177)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(BFFFI)F", line = 141)
