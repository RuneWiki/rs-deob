...
public class class503 extends class392 implements class737 {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(III)V", line = 11)
    ...
    @OriginalMember(owner = "client!is", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(ZB)V", line = 35)
    ...
    @OriginalMember(owner = "client!is", name = "b", descriptor = "(III)V", line = 65)
    ...
    @OriginalMember(owner = "client!is", name = "e", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "(Lac;III)V", line = 140)
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "(Lac;IIII)V", line = 155)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Loia;B)Z", line = 97)
    ...
    @OriginalMember(owner = "client!is", name = "finalize", descriptor = "()V", line = 115)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(B)V", line = 124)
