...
public class class503 extends class409 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(CIIIZLua;II)V", line = 2)
    public final void method756(char arg0, int arg1, int arg2, int arg3, boolean arg4, class596 arg5, int arg6, int arg7) {
    }

    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(Lqq;Laga;[Ltq;Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!kp", name = "OA", descriptor = "(CIIIZ)V", line = 312)
