...
public abstract class class503 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(III)I", line = 4)
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(III)V", line = 19)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(III)V", line = 90)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(BI)I", line = 101)
