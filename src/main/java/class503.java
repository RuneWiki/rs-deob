...
public class class503 extends class138 {
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(ZI)V", line = 26)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(IIIII)V", line = 48)
