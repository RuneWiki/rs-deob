...
public class class503 extends class739 {
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(Lsl;II)V", line = 28)
    ...
    @OriginalMember(owner = "client!eaa", name = "c", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "([BB)Ljava/lang/String;", line = 156)
    ...
    @OriginalMember(owner = "client!eaa", name = "<init>", descriptor = "()V", line = 224)
    public class503() {
        super(0, true);
    }

    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(B)V", line = 179)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(I[II)V", line = 228)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(BIIIIII)I", line = 398)
    ...
    @OriginalMember(owner = "client!eaa", name = "e", descriptor = "(I)V", line = 476)
