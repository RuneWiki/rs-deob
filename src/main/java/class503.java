...
public class class503 extends class322 implements class228 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IIII[BLvj;III)V")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "([FIBILvj;IIII)V")
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(Lnfa;Lvj;Lnb;II)V")
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(Lnfa;Lvj;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(Lnfa;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(Lnfa;Lvj;IIZ[FII)V")
