...
public class class503 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(ILih;)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IBLkj;I)J")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(ZLlb;)Z")
