...
public class class503 extends class601 {
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(Lgn;)V")
    public class503(class699 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILjava/awt/Canvas;ZLoh;Ld;)Lha;")
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(ILgn;)V")
