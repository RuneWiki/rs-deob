...
public abstract class class503 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IIZZI[Lfi;)V")
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lum;I)V")
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IFFIIIFFFLcc;I)[B")
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(ILfi;)V")
