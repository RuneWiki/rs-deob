...
public class class503 extends class426 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IZ[S)[S", line = 10)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(B)I", line = 24)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IIZII[Ln;)V", line = 37)
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(I)V", line = 79)
