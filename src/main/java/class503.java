...
public class class503 extends class529 {
    ...
    @OriginalMember(owner = "client!iu", name = "<init>", descriptor = "()V", line = 4)
    public class503() {
        super(1, false);
    }

    @OriginalMember(owner = "client!iu", name = "e", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(IBLtn;)V", line = 22)
    ...
    @OriginalMember(owner = "client!iu", name = "c", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!iu", name = "f", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(II)[[I", line = 191)
    ...
    @OriginalMember(owner = "client!iu", name = "b", descriptor = "(II)V", line = 245)
