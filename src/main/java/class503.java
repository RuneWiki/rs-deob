...
public class class503 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(IBI)Z", line = 85)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lbv;B)V", line = 98)
    ...
    @OriginalMember(owner = "client!on", name = "b", descriptor = "(Lbv;B)V", line = 112)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lbv;BI)V", line = 129)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lvo;Lbv;I)V", line = 502)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(ILbv;)V", line = 789)
