...
public class class503 {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(IIIII)Z", line = 15)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!ih", name = "b", descriptor = "(I)Z", line = 161)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(BLek;)Z", line = 293)
    ...
    @OriginalMember(owner = "client!ih", name = "<init>", descriptor = "(Lbt;)V", line = 640)
    ...
    @OriginalMember(owner = "client!ih", name = "c", descriptor = "(I)V", line = 334)
    ...
    @OriginalMember(owner = "client!ih", name = "d", descriptor = "(I)Z", line = 413)
    ...
    @OriginalMember(owner = "client!ih", name = "e", descriptor = "(I)V", line = 431)
    ...
    @OriginalMember(owner = "client!ih", name = "f", descriptor = "(I)V", line = 457)
    ...
    @OriginalMember(owner = "client!ih", name = "b", descriptor = "(BLek;)V", line = 471)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(IIIILjava/lang/String;)V", line = 500)
