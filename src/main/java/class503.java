...
public class class503 extends class188 {
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(III)Lfk;", line = 4)
    ...
    @OriginalMember(owner = "client!dw", name = "<init>", descriptor = "(Lht;IIII[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(IIIIIIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!dw", name = "<init>", descriptor = "(Lht;IIII)V", line = 91)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(IIBII)V", line = 69)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Z)V", line = 104)
