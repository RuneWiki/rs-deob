...
public class class503 extends class751 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(ILrv;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(IB)[I", line = 57)
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(II)I", line = 82)
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "()V", line = 99)
    public class503() {
        this(4096);
    }
}
