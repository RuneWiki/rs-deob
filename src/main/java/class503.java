...
public class class503 extends class256 {
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!mp", name = "ca", descriptor = "()I", line = 48)
    public final int method43() {
        field7118++;
        return this.field7120.field7160 + this.field7131 + this.field7113;
    }

    @OriginalMember(owner = "client!mp", name = "YA", descriptor = "(IIIIIIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(Luca;IIZ)V", line = 695)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(Luca;IIII)V", line = 705)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(Luca;II[III)V", line = 715)
    ...
    @OriginalMember(owner = "client!mp", name = "E", descriptor = "()I", line = 170)
    public final int method48() {
        field7129++;
        return this.field7120.field7156;
    }

    @OriginalMember(owner = "client!mp", name = "qa", descriptor = "(FFFFFFIIII)V", line = 181)
    ...
    @OriginalMember(owner = "client!mp", name = "DA", descriptor = "(IIIIIII)V", line = 249)
    ...
    @OriginalMember(owner = "client!mp", name = "xa", descriptor = "(III)V", line = 386)
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(I)V", line = 414)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(FFFFFFILua;II)V", line = 429)
    ...
    @OriginalMember(owner = "client!mp", name = "Q", descriptor = "(IIII)V", line = 514)
    ...
    @OriginalMember(owner = "client!mp", name = "u", descriptor = "()I", line = 526)
    public final int method56() {
        field7117++;
        return this.field7120.field7160;
    }

    @OriginalMember(owner = "client!mp", name = "V", descriptor = "(IIIII)V", line = 536)
    ...
    @OriginalMember(owner = "client!mp", name = "da", descriptor = "(IIIIII)V", line = 587)
    ...
    @OriginalMember(owner = "client!mp", name = "A", descriptor = "()I", line = 598)
    public final int method50() {
        field7109++;
        return this.field7120.field7156 + this.field7127 + this.field7134;
    }

    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IILua;II)V", line = 611)
