...
public class class503 {
    ...
    @OriginalMember(owner = "client!va", name = "b", descriptor = "(Z)Lug;")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(B)Lug;")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Lug;I)V")
