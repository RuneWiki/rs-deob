...
public class class503 implements Runnable {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(II)I", line = 52)
    ...
    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 220)
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IIII)V", line = 84)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "([BIBI)V", line = 116)
    ...
    @OriginalMember(owner = "client!ae", name = "run", descriptor = "()V", line = 158)
