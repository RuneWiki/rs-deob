...
public class class503 extends class366 implements class596 {
    ...
    @OriginalMember(owner = "client!dj", name = "<init>", descriptor = "(Lsga;IZ[[I)V", line = 15)
    ...
    @OriginalMember(owner = "client!dj", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 66)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(BLcw;)V", line = 79)
