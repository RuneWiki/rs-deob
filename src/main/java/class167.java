...
public class class167 implements class462 {
    ...
    @OriginalMember(owner = "client!jm", name = "toString", descriptor = "()Ljava/lang/String;", line = 6)
    public final String toString() {
        field2205++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 35)
    public class167(String arg0, int arg1) {
        this.field2200 = arg1;
    }

    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(B)V", line = 51)
