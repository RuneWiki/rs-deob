...
public class class167 extends class220 {
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "()V", line = 172)
    public class167() {
        super(1, false);
    }

    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IIIIZIIIIIIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!rm", name = "e", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(II)[[I", line = 47)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IIIIB)V", line = 139)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IBLil;)V", line = 176)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ZI)Z", line = 241)
