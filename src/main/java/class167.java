...
public abstract class class167 extends class503 {
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(I[Luca;IB)I")
    ...
    @OriginalMember(owner = "client!wea", name = "b", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Lr;III[Z)Z")
