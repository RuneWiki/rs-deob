...
public class class167 extends class566 {
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(BII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!efa", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!efa", name = "b", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!efa", name = "c", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 65)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(I)Loh;", line = 131)
    ...
    @OriginalMember(owner = "client!efa", name = "<init>", descriptor = "(Lor;Lma;IIIIIIIIIIIIII)V", line = 147)
