...
public class class167 extends class13 {
    ...
    @OriginalMember(owner = "client!le", name = "d", descriptor = "(I)J", line = 6)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(ZI)[I", line = 18)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(II)[[I", line = 72)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Lkh;BI)V", line = 141)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(ILoo;)V", line = 177)
    ...
    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "()V", line = 260)
    public class167() {
        super(1, false);
    }

    @OriginalMember(owner = "client!le", name = "e", descriptor = "(I)V", line = 245)
