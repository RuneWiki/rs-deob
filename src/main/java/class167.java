...
public class class167 extends class649 {
    ...
    @OriginalMember(owner = "client!jc", name = "c", descriptor = "(I)Lcc;", line = 6)
    ...
    @OriginalMember(owner = "client!jc", name = "d", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "(ILhs;)V", line = 53)
    public class167(int arg0, class358 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(I)I", line = 57)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(IB)V", line = 67)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(II)I", line = 80)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "(Lhs;)V", line = 107)
    public class167(class358 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jc", name = "e", descriptor = "(I)I", line = 110)
    ...
    @OriginalMember(owner = "client!jc", name = "f", descriptor = "(I)V", line = 126)
