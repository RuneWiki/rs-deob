...
public class class167 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IIIIIIIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IIILeq;IIBIIIII)Z", line = 41)
