...
public class class167 extends class439 {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(CI)B", line = 3)
    ...
    @OriginalMember(owner = "client!se", name = "c", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IBI)Z", line = 151)
