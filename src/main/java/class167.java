...
public class class167 extends class398 {
    ...
    @OriginalMember(owner = "client!th", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "()V", line = 25)
    public class167() {
        super(0, true);
    }

    @OriginalMember(owner = "client!th", name = "c", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Lnj;II)V", line = 45)
    ...
    @OriginalMember(owner = "client!th", name = "c", descriptor = "(II)V", line = 125)
    ...
    @OriginalMember(owner = "client!th", name = "c", descriptor = "(III)Z", line = 188)
    ...
    @OriginalMember(owner = "client!th", name = "d", descriptor = "(II)Lnn;", line = 219)
    ...
    @OriginalMember(owner = "client!th", name = "f", descriptor = "(I)V", line = 248)
    ...
    @OriginalMember(owner = "client!th", name = "g", descriptor = "(I)V", line = 269)
    ...
    @OriginalMember(owner = "client!th", name = "d", descriptor = "(III)Z", line = 292)
