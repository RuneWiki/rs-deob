...
public abstract class class167 extends class544 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Llp;Ldg;)V")
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Lmh;)V")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Let;IIILqa;)V")
    ...
    @OriginalMember(owner = "client!vb", name = "g", descriptor = "(I)[Lhba;")
