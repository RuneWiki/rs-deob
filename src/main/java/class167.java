...
public class class167 extends class168 {
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(IIIII)V", line = 78)
    ...
    @OriginalMember(owner = "client!pha", name = "b", descriptor = "(IIIII)V", line = 105)
    ...
    @OriginalMember(owner = "client!pha", name = "<init>", descriptor = "(IIIIIZ)V", line = 123)
