...
public class class167 extends class418 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IIBIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(I)Z", line = 55)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(ZLtj;)V", line = 2902)
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(Lbd;)V", line = 3075)
    public class167(class27 arg0) {
        this.field2260 = arg0;
    }

    @OriginalMember(owner = "client!ed", name = "c", descriptor = "(Z)V", line = 2995)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(III)Z", line = 3032)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(B)V", line = 3050)
