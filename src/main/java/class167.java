...
public class class167 implements class323 {
    ...
    private int[] field2685 = null;

    @OriginalMember(owner = "client!in", name = "c", descriptor = "Z")
    private boolean field2686 = false;

    @OriginalMember(owner = "client!in", name = "d", descriptor = "()V", line = 13)
    private final void method1061() {
        GL var1 = class249.field3898;
        if (this.field2685 == null) {
            this.field2685 = new int[3];
            var1.glGenTextures(3, this.field2685, 0);
        }
        short var2 = 4096;
        ...
        for (int var6 = 0; var6 < 6; var6++) {
            ...
            var1.glBindTexture(34067, this.field2685[0]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var4));
            var1.glBindTexture(34067, this.field2685[1]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var5));
            var1.glBindTexture(34067, this.field2685[2]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var3));
            class258.field4014 += var2 * 3;
        }
    }

    @OriginalMember(owner = "client!in", name = "e", descriptor = "()V", line = 128)
    private final void method1062() {
        GL var1 = class249.field3898;
        this.field2684 = var1.glGenLists(2);
        var1.glNewList(this.field2684, 4864);
        if (this.field2685 == null) {
            ...
            if (this.field2686) {
                ...
                var1.glTexEnvi(8960, 34162, 7681);
                var1.glTexEnvi(8960, 34184, 34167);
                var1.glBindTexture(3553, class249.field3909);
                var1.glEnable(3553);
            }
            var1.glActiveTexture(33984);
        }
        var1.glEndList();
        var1.glNewList(this.field2684 + 1, 4864);
        if (this.field2685 == null) {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "()I", line = 220)
    public final int method187() {
        return 4;
    }

    @OriginalMember(owner = "client!in", name = "b", descriptor = "()V", line = 225)
    public final void method188() {
        GL var1 = class249.field3898;
        class249.method1681(1);
        if (class334.field5115) {
            var1.glCallList(this.field2684);
        } else {
            var1.glTexEnvi(8960, 34184, 34167);
        }
    }

    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "()V", line = 271)
    public class167() {
        if (class249.field3879 && class249.field3906 >= 2) {
            this.method1061();
            GL var1 = class249.field3898;
            var1.glBindTexture(34067, this.field2685[0]);
            ...
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            this.field2686 = class249.field3906 < 3;
        }
        this.method1062();
    }

    @OriginalMember(owner = "client!in", name = "a", descriptor = "(I)V", line = 242)
    public final void method186(int arg0) {
        GL var2 = class249.field3898;
        if (class334.field5115 && this.field2685 != null) {
            var2.glActiveTexture(33985);
            var2.glBindTexture(34067, this.field2685[arg0 - 1]);
            var2.glActiveTexture(33984);
        }
    }

    @OriginalMember(owner = "client!in", name = "c", descriptor = "()V", line = 256)
    public final void method185() {
        GL var1 = class249.field3898;
        if (class334.field5115) {
            var1.glCallList(this.field2684 + 1);
        } else {
            var1.glTexEnvi(8960, 34184, 5890);
        }
    }
