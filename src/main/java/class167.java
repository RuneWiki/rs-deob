...
public class class167 extends class192 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "()I", line = 11)
    public final int method1186() {
        return this.field2345 - (this.field2347.available() >> (class105.field1478 ? 2 : 1));
    }

    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 21)
    ...
    @OriginalMember(owner = "client!ks", name = "d", descriptor = "()V", line = 57)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 64)
    ...
    @OriginalMember(owner = "client!ks", name = "f", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!ks", name = "c", descriptor = "()V", line = 105)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "()V", line = 141)
