...
public abstract class class167 {
    ...
    @OriginalMember(owner = "client!qa", name = "c", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IILjava/awt/Canvas;Ldda;Ln;I)Lqa;", line = 63)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Ljava/lang/String;IILos;)Lku;", line = 117)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(B)V", line = 147)
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(IIIIII)V", line = 172)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(BIIIII)V", line = 189)
    ...
    @OriginalMember(owner = "client!qa", name = "finalize", descriptor = "()V", line = 204)
    protected void finalize() {
        this.method1061(114);
        field2271++;
    }

    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "(Ln;)V", line = 212)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IBIIII)V", line = 248)
