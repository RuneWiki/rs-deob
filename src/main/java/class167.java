...
public class class167 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(IIIIILuo;)Lge;")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ILbg;)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lbg;II)V")
