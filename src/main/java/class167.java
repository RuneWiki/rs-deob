...
public abstract class class167 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIILjava/lang/String;III)V", line = 7)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([Lf;[IZIILjava/lang/String;II)V", line = 41)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(III[Lf;ILjava/lang/String;[IIILjava/util/Random;)I", line = 60)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/lang/String;IIBII)V", line = 101)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/lang/String;ZI)V", line = 116)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 155)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILjava/util/Random;III[Lf;[IBLjava/lang/String;[I)I", line = 232)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(BILea;ILjava/lang/String;III[IIII[Lf;III)I", line = 309)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([I[II[Lf;Ljava/lang/String;II[I)V", line = 319)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/lang/String;BIIIIII)V", line = 483)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIZLjava/lang/String;)V", line = 516)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIILjava/lang/String;II)V", line = 543)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([Lf;[IILea;IIILjava/lang/String;I)V", line = 558)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IBI)V", line = 707)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[ILea;I[Lf;IIIIILjava/lang/String;IIIIII)I", line = 729)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I)V", line = 829)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIILjava/lang/String;)V", line = 848)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Z)V", line = 864)
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Lqa;Lov;)V", line = 886)
