...
public abstract class class167 extends class16 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(FFFFFFIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!kf", name = "MA", descriptor = "(IIII)V", line = 101)
    ...
    @OriginalMember(owner = "client!kf", name = "j", descriptor = "()I", line = 108)
    public final int method148() {
        return this.field2129 + this.field2124 + this.field2152;
    }

    @OriginalMember(owner = "client!kf", name = "la", descriptor = "()I", line = 112)
    public final int method134() {
        return this.field2124;
    }

    @OriginalMember(owner = "client!kf", name = "ma", descriptor = "()I", line = 139)
    public final int method137() {
        return this.field2144;
    }

    @OriginalMember(owner = "client!kf", name = "JA", descriptor = "(IIIIIII)V", line = 152)
    ...
    @OriginalMember(owner = "client!kf", name = "T", descriptor = "()I", line = 197)
    public final int method131() {
        return this.field2150 + this.field2144 + this.field2125;
    }

    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "(Lji;II)V", line = 214)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(FFFFFF)V", line = 221)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(FFFFFFLma;II)V", line = 354)
