...
public class class167 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lwm;IIIIII)V")
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lwm;Lja;)V")
    ...
    @OriginalMember(owner = "client!ja", name = "b", descriptor = "(Lwm;Lja;)V")
    ...
    @OriginalMember(owner = "client!ja", name = "c", descriptor = "(Lwm;Lja;)Z")
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lwm;)V")
    ...
    @OriginalMember(owner = "client!ja", name = "d", descriptor = "(Lwm;Lja;)Z")
    public final boolean method987(class364 arg0, class167 arg1) {
        return this.field2315 != null || this.method985(arg0, arg1);
    }

    @OriginalMember(owner = "client!ja", name = "b", descriptor = "(Lwm;)V")
