...
public class class167 extends class130 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(IIZII)V", line = 25)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;II)V", line = 45)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(BLdk;ZLdk;I)I", line = 83)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(IILza;)Le;", line = 190)
