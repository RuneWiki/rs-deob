...
public class class167 {
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(ILr;)V", line = 3)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(I)V", line = 214)
    ...
    @OriginalMember(owner = "client!efa", name = "a", descriptor = "(B)V", line = 251)
