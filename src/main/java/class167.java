...
public class class167 extends class241 implements class248 {
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(Z)Z", line = 14)
    public final boolean method24(boolean arg0) {
        field2589++;
        return arg0 ? false : false;
    }

    @OriginalMember(owner = "client!se", name = "a", descriptor = "(ILqa;ZLto;III)V", line = 25)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lqa;I)V", line = 36)
    ...
    @OriginalMember(owner = "client!se", name = "<init>", descriptor = "(IIIIILeh;)V", line = 50)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(BLqa;)V", line = 58)
    public final void method25(byte arg0, class162 arg1) {
        int var3 = -92 % ((-arg0 - 45) / 48);
        field2582++;
    }

    @OriginalMember(owner = "client!se", name = "a", descriptor = "(ILbu;)V", line = 68)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IIILmq;)V", line = 84)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lqa;II)Lc;", line = 161)
    ...
    @OriginalMember(owner = "client!se", name = "c", descriptor = "(B)V", line = 172)
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(I)I", line = 189)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(I)Z", line = 201)
    ...
    @OriginalMember(owner = "client!se", name = "c", descriptor = "(I)V", line = 213)
    public final void method26(int arg0) {
        field2581++;
        int var2 = -111 / ((arg0 + 46) / 44);
    }

    @OriginalMember(owner = "client!se", name = "a", descriptor = "(B)I", line = 222)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(ILqa;)V", line = 248)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(ZLqa;)Lae;", line = 258)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(ILqa;II)Z", line = 271)
