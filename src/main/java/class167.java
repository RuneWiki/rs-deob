...
public class class167 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(BII)V", line = 121)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(IIIII)V", line = 138)
    ...
    @OriginalMember(owner = "client!le", name = "b", descriptor = "(I)V", line = 191)
    ...
    @OriginalMember(owner = "client!le", name = "c", descriptor = "(I)V", line = 225)
    ...
    @OriginalMember(owner = "client!le", name = "d", descriptor = "(I)Z", line = 242)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Lrb;BLrb;ZI)Lf;", line = 278)
    ...
    @OriginalMember(owner = "client!le", name = "e", descriptor = "(I)V", line = 321)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Lrb;Lrb;BI)Lf;", line = 333)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "()V", line = 348)
    public static final void method1135() {
        class46.method326(1, class176.field2480);
    }

    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "(Lul;Lmr;)V", line = 351)
