...
public class class167 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(ILap;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(ILrk;)I", line = 25)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(IZLap;)V", line = 96)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(B)V", line = 117)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Ljava/lang/String;BLjava/lang/String;Ljava/lang/String;)Ljava/lang/String;", line = 132)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Lfo;)V", line = 152)
