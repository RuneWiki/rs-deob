...
public class class167 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(BI)V", line = 49)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(II)Lmd;", line = 67)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IIILsi;)V", line = 111)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(Lcm;ILlt;)V", line = 137)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(Z)V", line = 125)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IBII)I", line = 164)
