...
public class class167 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(I)Lpe;", line = 4)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(ILpe;)V", line = 24)
    ...
    @OriginalMember(owner = "client!sr", name = "b", descriptor = "(I)Lpe;", line = 41)
    ...
    @OriginalMember(owner = "client!sr", name = "c", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Lsr;I)V", line = 76)
    ...
    @OriginalMember(owner = "client!sr", name = "b", descriptor = "(ILpe;)V", line = 89)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(B)Lpe;", line = 106)
    ...
    @OriginalMember(owner = "client!sr", name = "b", descriptor = "(B)Lpe;", line = 132)
    ...
    @OriginalMember(owner = "client!sr", name = "d", descriptor = "(I)I", line = 155)
    ...
    @OriginalMember(owner = "client!sr", name = "e", descriptor = "(I)Z", line = 176)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "()V", line = 471)
    public class167() {
        this.field2165.field6345 = this.field2165;
        this.field2165.field6344 = this.field2165;
    }

    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IIIIIII)V", line = 206)
    ...
    @OriginalMember(owner = "client!sr", name = "f", descriptor = "(I)Lpe;", line = 393)
    ...
    @OriginalMember(owner = "client!sr", name = "g", descriptor = "(I)V", line = 413)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Lsr;Lpe;I)V", line = 448)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Z)V", line = 482)
