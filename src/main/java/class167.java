...
public class class167 implements class159 {
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(I)Z", line = 37)
    ...
    @OriginalMember(owner = "client!ld", name = "b", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "(Lfp;Lwfa;)V", line = 69)
