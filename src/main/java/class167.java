...
public class class167 extends class377 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "()V", line = 45)
    public class167() {
        super(1, true);
    }

    @OriginalMember(owner = "client!sq", name = "f", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(BILpfa;I)Lnj;", line = 80)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(III)V", line = 101)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Z)V", line = 112)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIIZBII)V", line = 129)
    ...
    @OriginalMember(owner = "client!sq", name = "e", descriptor = "(B)V", line = 149)
