...
public class class167 implements class36 {
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IIIB)Lns;", line = 58)
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "(II)V", line = 121)
