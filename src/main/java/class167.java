...
public class class167 extends class129 {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lqa;IB)Z")
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lva;I)V")
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Lmq;I)Z")
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(ILqa;)Lnf;")
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(ZIILer;Lqa;IB)V")
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IILqa;B)Z")
