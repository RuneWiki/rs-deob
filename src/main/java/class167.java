...
public class class167 extends class485 {
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(I)Lfl;")
    public final class103 method318(int arg0) {
        field2090++;
        return arg0 == -26207 ? class549.field7127 : null;
    }

    @OriginalMember(owner = "client!pv", name = "d", descriptor = "(I)[Lffa;")
    ...
    @OriginalMember(owner = "client!pv", name = "<init>", descriptor = "(Lffa;Loca;IIIIIIIIIIIIII)V")
