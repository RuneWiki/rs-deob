...
public class class167 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(III[B)V", line = 3)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(JI)V", line = 21)
    ...
    @OriginalMember(owner = "client!le", name = "finalize", descriptor = "()V", line = 36)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Z)Ljava/io/File;", line = 50)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(I)J", line = 60)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "([BBII)I", line = 88)
