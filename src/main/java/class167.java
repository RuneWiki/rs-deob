...
public class class167 {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(ZJ)V", line = 5)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(ZIILjava/lang/String;)Z", line = 22)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(III[BII[BBI)V", line = 95)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(B)V", line = 145)
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(B)Ldi;", line = 169)
    ...
    @OriginalMember(owner = "client!se", name = "c", descriptor = "(B)Ldi;", line = 195)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Ldi;I)V", line = 215)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IIIIIII[B[B)V", line = 232)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(I)V", line = 278)
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(I)I", line = 289)
    ...
    @OriginalMember(owner = "client!se", name = "<init>", descriptor = "()V", line = 320)
    public class167() {
