...
public class class167 implements class2 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lih;[III)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;[ILih;)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILih;Z)Z")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;IILih;ZI)Z")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lka;Lih;[II)V")
