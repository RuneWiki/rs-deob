...
public class class167 extends class55 {
    ...
    @OriginalMember(owner = "client!id", name = "c", descriptor = "(III)[B", line = 3)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IB)V", line = 9)
    ...
    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "()V", line = 17)
    public class167() {
