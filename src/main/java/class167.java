...
public class class167 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IIIILkh;Lkh;IZII)V", line = 21)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Ljava/lang/String;BC)[Ljava/lang/String;", line = 71)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "([BII)[B", line = 106)
