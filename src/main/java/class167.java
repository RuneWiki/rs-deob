...
public class class167 extends class76 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IIIB)Lli;", line = 3)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IIILha;)Z", line = 70)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IIIIZII)V", line = 105)
