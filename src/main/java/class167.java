...
public class class167 extends class386 {
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(IIIIIIIII)V", line = 12)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(IBLun;)V", line = 48)
    ...
    @OriginalMember(owner = "client!qga", name = "<init>", descriptor = "()V", line = 83)
    public class167() {
        super(1, false);
    }

    @OriginalMember(owner = "client!qga", name = "b", descriptor = "(II)[[I", line = 98)
