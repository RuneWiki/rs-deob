...
public class class167 extends class601 {
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Lee;BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!dfa", name = "<init>", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!dfa", name = "e", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(BI)[I", line = 60)
