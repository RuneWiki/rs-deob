...
public class class382 {
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Lik;IIIII)Lml;", line = 5)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(II)Leb;", line = 35)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!vj", name = "b", descriptor = "(II)V", line = 78)
    ...
    @OriginalMember(owner = "client!vj", name = "b", descriptor = "(B)V", line = 92)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(Z[[[Lsk;)V", line = 106)
    ...
    @OriginalMember(owner = "client!vj", name = "c", descriptor = "(B)V", line = 184)
    ...
    @OriginalMember(owner = "client!vj", name = "<init>", descriptor = "(Loda;ILdda;)V", line = 202)
