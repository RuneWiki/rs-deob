...
public class class382 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Lqj;I)V", line = 19)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Lqj;ILjava/lang/Object;I)V", line = 45)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Lqj;B)Ljava/lang/Object;", line = 74)
    ...
    @OriginalMember(owner = "client!vo", name = "b", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ILtk;)V", line = 152)
    ...
    @OriginalMember(owner = "client!vo", name = "c", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(B)V", line = 184)
    ...
    @OriginalMember(owner = "client!vo", name = "b", descriptor = "(B)V", line = 197)
    ...
    @OriginalMember(owner = "client!vo", name = "d", descriptor = "(I)V", line = 228)
    ...
    @OriginalMember(owner = "client!vo", name = "e", descriptor = "(I)I", line = 240)
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "(I)V", line = 320)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(II)V", line = 261)
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ILjava/lang/Object;Lqj;)V", line = 308)
