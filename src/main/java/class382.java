...
public class class382 {
    ...
    @OriginalMember(owner = "client!oka", name = "a", descriptor = "(ZFLbe;Lbe;)Z")
    ...
    @OriginalMember(owner = "client!oka", name = "<init>", descriptor = "(Lvf;)V")
    ...
    @OriginalMember(owner = "client!oka", name = "b", descriptor = "(I)V")
