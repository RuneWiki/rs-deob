...
public class class382 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(II)[I", line = 8)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(I)[[I", line = 79)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "(III)V", line = 629)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(ILit;)V", line = 120)
    ...
    @OriginalMember(owner = "client!el", name = "c", descriptor = "(I)V", line = 542)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IIII)Z", line = 563)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Lj;III[Z)Z", line = 581)
