...
public class class382 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(BLji;Ljava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(II)Lmg;")
    ...
    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "(Lai;ILic;)V")
    public class382(class423 arg0, int arg1, class491 arg2) {
        this.field5781 = arg2;
        this.field5781.method2942(false, 29);
    }

    @OriginalMember(owner = "client!el", name = "a", descriptor = "(ILtv;IIII)Lvv;")
