...
public class class382 {
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Lip;B)V", line = 23)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(IZI)V", line = 98)
