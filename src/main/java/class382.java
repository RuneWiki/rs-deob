...
public class class382 extends class312 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Lza;J[Lod;[Lu;Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "()V", line = 24)
    public static void method2422() {
        field5607 = null;
        field5613 = null;
    }

    @OriginalMember(owner = "client!td", name = "a", descriptor = "(J)V", line = 28)
    public final void method2423(long arg0) {
        this.field5609 = arg0;
    }

    @OriginalMember(owner = "client!td", name = "c", descriptor = "()Lvm;", line = 33)
    public final class320 method2424() {
        return this.field5616;
    }

    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Lza;J)Z", line = 36)
    ...
    @OriginalMember(owner = "client!td", name = "d", descriptor = "()V", line = 85)
    public final void method2426() {
        this.field5617 = true;
    }

    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Lza;[Lod;Z)V", line = 91)
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(I)V", line = 331)
    ...
    @OriginalMember(owner = "client!td", name = "e", descriptor = "()V", line = 167)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "([Lu;Z)V", line = 190)
    ...
    @OriginalMember(owner = "client!td", name = "f", descriptor = "()V", line = 276)
    public final void method2430() {
        this.field5611 = true;
    }

    @OriginalMember(owner = "client!td", name = "a", descriptor = "(IIIII)V", line = 279)
    ...
    @OriginalMember(owner = "client!td", name = "g", descriptor = "()V", line = 295)
