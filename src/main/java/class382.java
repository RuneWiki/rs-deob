...
public class class382 extends class702 {
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(Lkga;Lwca;)V")
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Ljf;II)V")
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(ILrda;[IB)V")
