...
public class class382 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(B[J[Ljava/lang/Object;)V", line = 16)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(ZI)Lwl;", line = 27)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "([[S[[FI)[[S", line = 63)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(II)V", line = 124)
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lcw;ILeq;)V", line = 144)
