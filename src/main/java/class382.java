...
public class class382 {
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Lkd;BLjava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!hi", name = "b", descriptor = "(II)Lcu;")
    ...
    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "(Lci;IZLg;Lg;)V")
