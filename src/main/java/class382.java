...
public class class382 {
    ...
    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(II)Lma;")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(Lgf;IIIB)V")
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(Llo;ILnl;)V")
