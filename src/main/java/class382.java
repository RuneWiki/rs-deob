...
public class class382 {
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lah;", line = 13)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IIIIII)V", line = 58)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(I)V", line = 189)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(II)Ljava/lang/String;", line = 230)
    ...
    @OriginalMember(owner = "client!sp", name = "b", descriptor = "(I)V", line = 264)
