...
public class class382 extends class11 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!fr", name = "c", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!fr", name = "c", descriptor = "(I)J", line = 59)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IIZ)Z", line = 76)
    ...
    @OriginalMember(owner = "client!fr", name = "f", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(Z)I", line = 101)
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "(II)V", line = 111)
    public class382(int arg0, int arg1) {
        super.field6724 = (long) arg1 | (long) arg0 << 32;
    }

    @OriginalMember(owner = "client!fr", name = "d", descriptor = "(B)V", line = 119)
