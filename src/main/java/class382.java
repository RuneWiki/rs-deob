...
public class class382 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IILjava/lang/String;Z)Z", line = 3)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Z)V", line = 106)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(I)Lgl;", line = 120)
