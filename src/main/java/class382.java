...
public class class382 extends class444 {
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(Lvq;IIBI[I)V")
    ...
    @OriginalMember(owner = "client!ck", name = "b", descriptor = "()Lpn;")
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ILvq;I)V")
    ...
    @OriginalMember(owner = "client!ck", name = "d", descriptor = "()Lpn;")
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Lbe;)V")
