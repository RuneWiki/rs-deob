...
public class class382 extends class319 implements class392 {
    ...
    @OriginalMember(owner = "client!eh", name = "c", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!eh", name = "m", descriptor = "(I)I", line = 20)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(III)V", line = 34)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IIILha;)Z", line = 55)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(BLha;)V", line = 78)
    ...
    @OriginalMember(owner = "client!eh", name = "l", descriptor = "(I)I", line = 88)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(I)I", line = 101)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IILha;Z)Lhi;", line = 116)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(ILha;)Ldfa;", line = 148)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(Lha;I)V", line = 175)
    ...
    @OriginalMember(owner = "client!eh", name = "n", descriptor = "(I)Z", line = 202)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(I[B)Ljava/lang/String;", line = 217)
    ...
    @OriginalMember(owner = "client!eh", name = "j", descriptor = "(I)V", line = 228)
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(I)I", line = 242)
    ...
    @OriginalMember(owner = "client!eh", name = "k", descriptor = "(I)Z", line = 254)
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(Lha;I)V", line = 269)
    ...
    @OriginalMember(owner = "client!eh", name = "s", descriptor = "(I)V", line = 299)
    ...
    @OriginalMember(owner = "client!eh", name = "d", descriptor = "(I)Z", line = 310)
    public final boolean method30(int arg0) {
        ++field5568;
        return arg0 <= 59 ? false : this.field5569;
    }

    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(Lha;B)Lel;", line = 322)
    ...
    @OriginalMember(owner = "client!eh", name = "d", descriptor = "(B)I", line = 337)
    ...
    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "(Lha;Lpu;IIIIIZIIIIIIZ)V", line = 351)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(ILha;I)Lka;", line = 384)
    ...
    @OriginalMember(owner = "client!eh", name = "e", descriptor = "(I)I", line = 410)
    public final int method31(int arg0) {
        ++field5603;
        return arg0 != -23356 ? 22 : this.field5571 & 65535;
    }

    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(Lha;Lwea;ZIIII)V", line = 422)
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(IZ)V", line = 454)
    ...
    @OriginalMember(owner = "client!eh", name = "h", descriptor = "(I)Z", line = 469)
