...
public class class382 implements class526 {
    ...
    @OriginalMember(owner = "client!mea", name = "b", descriptor = "(B)Leea;")
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!mea", name = "<init>", descriptor = "(Lui;Leea;Z)V")
