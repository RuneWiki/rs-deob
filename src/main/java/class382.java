...
public class class382 implements class450 {
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(IZ)V", line = 16)
    ...
    @OriginalMember(owner = "client!aha", name = "b", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!aha", name = "b", descriptor = "(IZ)V", line = 53)
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(II)V", line = 76)
    ...
    @OriginalMember(owner = "client!aha", name = "<init>", descriptor = "(Lvd;Ljv;)V", line = 88)
