...
public class class382 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ILha;BIIII)V", line = 301)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Z)V", line = 312)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IIIII)V", line = 323)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "()V", line = 344)
    protected class382() {
        try {
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Lha;Ljc;I)V", line = 354)
