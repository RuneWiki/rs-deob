...
public abstract class class382 {
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(I)Lqf;")
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(B)Lfv;")
    ...
    @OriginalMember(owner = "client!rr", name = "b", descriptor = "(Z)Las;")
    ...
    @OriginalMember(owner = "client!rr", name = "f", descriptor = "(I)Lhi;")
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(Lvk;Z)V")
