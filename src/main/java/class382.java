...
public class class382 extends class656 implements class638 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(B)C", line = 7)
    ...
    @OriginalMember(owner = "client!ln", name = "b", descriptor = "(I)J", line = 19)
    ...
    @OriginalMember(owner = "client!ln", name = "d", descriptor = "(I)I", line = 31)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(ILha;BZ)Lda;", line = 42)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(IIIIIIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(I)I", line = 86)
    public final int method2253(int arg0) {
        field5308++;
        return arg0 == -24548 ? this.field5307 : -20;
    }

    @OriginalMember(owner = "client!ln", name = "c", descriptor = "(I)I", line = 98)
    public final int method2254(int arg0) {
        field5305++;
        return arg0 == -22313 ? this.field5314 : 30;
    }

    @OriginalMember(owner = "client!ln", name = "e", descriptor = "(I)V", line = 111)
