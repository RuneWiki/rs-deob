...
public class class382 {
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(IB)Ltd;", line = 23)
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(J[IILoaa;)Ljava/lang/String;", line = 55)
    ...
    @OriginalMember(owner = "client!aha", name = "<init>", descriptor = "(ILin;Lin;Lbq;)V", line = 117)
    ...
    @OriginalMember(owner = "client!aha", name = "b", descriptor = "(I)V", line = 86)
