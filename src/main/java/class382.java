...
public class class382 extends class145 {
    ...
    @OriginalMember(owner = "client!jc", name = "e", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "()V", line = 19)
    public class382() {
        super(0, true);
    }

    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Lap;BI)V", line = 22)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(II)V", line = 84)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(IIII)I", line = 111)
    ...
    @OriginalMember(owner = "client!jc", name = "c", descriptor = "(II)Lwd;", line = 147)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(II)[I", line = 172)
