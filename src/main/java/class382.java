...
public class class382 extends class263 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "([BB)Lxa;", line = 15)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "([IBI)V", line = 56)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(ZLwv;Z)V", line = 213)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IIII)V", line = 551)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(I)V", line = 564)
    public static void method2199(int arg0) {
        int var1 = 29 / ((arg0 - 29) / 60);
        field4907 = null;
    }

    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(II)V", line = 576)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(FIIII)V", line = 588)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IB)I", line = 719)
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(II)V", line = 736)
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "(Liq;IIIII)V", line = 750)
