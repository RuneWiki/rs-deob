...
public class class382 extends class260 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IIZIII)V", line = 12)
    ...
    @OriginalMember(owner = "client!ea", name = "c", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IIII)V", line = 47)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IIIIII)V", line = 62)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IIIBI)V", line = 99)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(B)V", line = 119)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(I[I[BLhf;)Z", line = 136)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "()V", line = 194)
    public class382() {
    }

    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "([B)V", line = 196)
