...
public class class382 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(BLns;)Z")
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(ILns;)V")
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(Lnv;)V")
