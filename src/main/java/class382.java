...
public class class382 {
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!uia", name = "b", descriptor = "(II)Luia;")
    ...
    @OriginalMember(owner = "client!uia", name = "<init>", descriptor = "(IILwj;)V")
