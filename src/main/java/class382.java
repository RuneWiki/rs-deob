...
public class class382 {
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "([I[[B[I[BI[[BII)I", line = 39)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ILam;)V", line = 96)
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(B)Ltm;", line = 108)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(III)Lsn;", line = 150)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ILtm;J)V", line = 168)
    ...
    @OriginalMember(owner = "client!eb", name = "c", descriptor = "(B)V", line = 191)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(B[Lqs;Lvm;I[BZI)V", line = 211)
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(I)V", line = 285)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(JI)Ltm;", line = 306)
