...
public class class382 {
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(II)I", line = 19)
    ...
    @OriginalMember(owner = "client!kfa", name = "<init>", descriptor = "([I)V", line = 46)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(B)V", line = 81)
