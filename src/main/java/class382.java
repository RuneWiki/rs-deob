...
public class class382 extends class476 {
    ...
    @OriginalMember(owner = "client!rc", name = "<init>", descriptor = "()V", line = 7)
    public class382() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IBI)V", line = 10)
    ...
    @OriginalMember(owner = "client!rc", name = "c", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IIII)[B", line = 47)
