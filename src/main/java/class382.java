...
public class class382 {
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(II)Z", line = 8)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(Lfh;)V", line = 65)
    public static final void method2245(class651 arg0) {
        class350.field4641 = arg0;
    }

    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!fha", name = "toString", descriptor = "()Ljava/lang/String;", line = 100)
    public final String toString() {
        field5393++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!fha", name = "<init>", descriptor = "(II)V", line = 108)
