...
public class class382 {
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Lio;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(B)Ltq;", line = 26)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(II)V", line = 48)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Z)V", line = 67)
    public static final void method2189(boolean arg0) {
        field5051++;
        class690.field9747 = arg0;
    }

    @OriginalMember(owner = "client!im", name = "b", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IBLio;)V", line = 114)
