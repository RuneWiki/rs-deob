...
public class class382 extends class35 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IIIIIBI)V", line = 5)
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "()V", line = 34)
    public class382() {
    }

    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(J)V", line = 39)
    public class382(long arg0) {
        this.field5654 = arg0;
    }

    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Z)V", line = 63)
