...
public class class382 {
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(Lwia;II)Luia;", line = 11)
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "()I", line = 19)
    ...
    @OriginalMember(owner = "client!uia", name = "b", descriptor = "()[B", line = 63)
    ...
    @OriginalMember(owner = "client!uia", name = "c", descriptor = "()Ldga;", line = 123)
    ...
    @OriginalMember(owner = "client!uia", name = "<init>", descriptor = "(Lso;)V", line = 129)
    ...
    @OriginalMember(owner = "client!uia", name = "<init>", descriptor = "()V", line = 149)
    private class382() {
    }
}
