...
public class class382 extends class522 {
    ...
    @OriginalMember(owner = "client!aw", name = "b", descriptor = "(Ldr;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(IIII)I", line = 23)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Lna;ZFIZ)V", line = 60)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!aw", name = "b", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Ldr;B)V", line = 104)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "([I[JI)V", line = 128)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(ILdr;)V", line = 139)
    ...
    @OriginalMember(owner = "client!aw", name = "c", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(B)V", line = 170)
    public final void method551(byte arg0) {
        int var2 = -109 / ((-9 - arg0) / 58);
        ++field5818;
    }

    @OriginalMember(owner = "client!aw", name = "d", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(II)V", line = 280)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(ZI)V", line = 291)
