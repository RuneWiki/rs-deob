...
public class class382 extends class439 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Lsq;I)V", line = 10)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(BLsq;)V", line = 27)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(ILsq;)V", line = 44)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(IILki;)V", line = 63)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(ZLip;FZI)V", line = 122)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(II)V", line = 140)
    ...
    @OriginalMember(owner = "client!df", name = "b", descriptor = "(II)V", line = 150)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!df", name = "b", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!df", name = "b", descriptor = "(B)V", line = 201)
    ...
    @OriginalMember(owner = "client!df", name = "c", descriptor = "(B)V", line = 215)
    ...
    @OriginalMember(owner = "client!df", name = "c", descriptor = "(I)V", line = 318)
