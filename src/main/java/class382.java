...
public class class382 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Lmm;I)V")
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Lmm;)V")
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Lmm;Lns;)V")
    ...
    @OriginalMember(owner = "client!s", name = "b", descriptor = "(Lmm;)V")
    ...
    @OriginalMember(owner = "client!s", name = "c", descriptor = "(Lmm;)V")
