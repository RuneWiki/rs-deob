...
public class class382 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IB)Lgd;")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Lgga;ZLjava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "(IILoea;)V")
