...
public class class683 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Z)Lsp;")
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lhaa;B)Lgb;")
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lwu;Lwu;)V")
