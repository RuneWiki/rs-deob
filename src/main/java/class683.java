...
public class class683 extends class682 {
    ...
    @OriginalMember(owner = "client!vha", name = "<init>", descriptor = "(Lnv;)V")
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(Ltha;II)V")
    ...
    @OriginalMember(owner = "client!vha", name = "a", descriptor = "(ZIZI)Loh;")
