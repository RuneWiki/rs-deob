...
public class class683 extends class262 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(IZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(IZ)V", line = 14)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(I)Z", line = 26)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ZI)V", line = 37)
    ...
    @OriginalMember(owner = "client!ql", name = "c", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ILoa;B)V", line = 58)
    ...
    @OriginalMember(owner = "client!ql", name = "h", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "(Lifa;)V", line = 95)
