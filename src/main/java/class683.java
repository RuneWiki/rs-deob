...
public class class683 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ZI)I", line = 15)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(III)Z", line = 45)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "([I)V", line = 719)
