...
public class class683 extends class55 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(II)I", line = 5)
    public static int method3840(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IIZ)V", line = 12)
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(Lij;)V", line = 35)
    public class683(class424 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qf", name = "f", descriptor = "(I)Z", line = 38)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IILfe;)V", line = 52)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Z)V", line = 64)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ZB)V", line = 81)
    public final void method197(boolean arg0, byte arg1) {
        int var3 = -39 / ((-61 - arg1) / 44);
        ++field9518;
    }

    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IZ)V", line = 96)
