...
public class class683 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(I[Luaa;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(ILdh;)Z", line = 76)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IIILck;[BZII)Lrc;", line = 97)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(II)Z", line = 119)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(B)V", line = 185)
