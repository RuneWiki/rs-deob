...
public class class683 {
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "([I)V", line = 3)
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(I)I", line = 52)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(ZLjava/lang/String;)I", line = 217)
