...
public class class683 extends class574 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(BII)Z", line = 6)
    ...
    @OriginalMember(owner = "client!qp", name = "d", descriptor = "(B)[B", line = 17)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IIZI)V", line = 35)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Z)V", line = 64)
    ...
    @OriginalMember(owner = "client!qp", name = "c", descriptor = "(B)I", line = 74)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(ILha;IIIII)V", line = 102)
