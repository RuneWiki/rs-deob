...
public class class683 extends class428 {
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(ZLhl;)V", line = 3)
    ...
    @OriginalMember(owner = "client!kr", name = "c", descriptor = "(II)V", line = 29)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ILhg;)V", line = 52)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IIB)I", line = 221)
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(IIB)Z", line = 240)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Ljr;B)V", line = 252)
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(II)V", line = 280)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IIZLd;)V", line = 327)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Lhl;B)V", line = 350)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ZLhl;)V", line = 373)
    ...
    @OriginalMember(owner = "client!kr", name = "c", descriptor = "(I)V", line = 396)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(B)V", line = 413)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(BI)V", line = 451)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(I)V", line = 489)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(II)V", line = 512)
