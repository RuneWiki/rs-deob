...
public class class683 {
    ...
    @OriginalMember(owner = "client!ew", name = "toString", descriptor = "()Ljava/lang/String;", line = 11)
    public final String toString() {
        field9698++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(I)I", line = 20)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(B)V", line = 225)
