...
public class class683 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(B)Lpi;")
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(ILpi;)V")
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(B)Lpi;")
