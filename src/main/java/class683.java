...
public class class683 extends class606 {
    ...
    @OriginalMember(owner = "client!jca", name = "c", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(Lma;II)V")
    ...
    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "(Ltg;Lfp;Lic;)V")
