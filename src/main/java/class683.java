...
public class class683 extends class251 {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(I)Lmh;")
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Ljava/awt/Frame;ILew;)V")
    ...
    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "(Ltca;Lvea;IIIIIIIIIIIIII)V")
