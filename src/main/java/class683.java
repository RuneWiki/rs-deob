...
public class class683 extends class513 implements class243 {
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Z)J", line = 7)
    ...
    @OriginalMember(owner = "client!nv", name = "d", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(B)I", line = 31)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(B)I", line = 42)
    ...
    @OriginalMember(owner = "client!nv", name = "e", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(I)C", line = 72)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(I)I", line = 94)
    public final int method1541(int arg0) {
        field9597++;
        return arg0 == -26820 ? this.field9595 : 84;
    }

    @OriginalMember(owner = "client!nv", name = "f", descriptor = "(I)V", line = 105)
