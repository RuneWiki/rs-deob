...
public class class683 extends class569 implements class65 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ILlca;IIIBI[FI)V")
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "(Lhp;Llca;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "(Lhp;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "(Lhp;Llca;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Llca;IIZIIII[B)V")
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "(Lhp;Llca;Lig;II)V")
