...
public class class683 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IZI)V", line = 19)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(BILes;)V", line = 37)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(ILes;)V", line = 60)
