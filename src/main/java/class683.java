...
public class class683 {
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "([BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!uba", name = "<init>", descriptor = "(Lag;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!uba", name = "<init>", descriptor = "(Lag;Ljaclib/memory/Buffer;)V", line = 21)
