...
public class class683 extends class446 implements class448 {
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(BIILjaclib/memory/Source;)Z", line = 16)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(B)Lrq;", line = 33)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(I)Z", line = 50)
    public final boolean method28(int arg0) {
        field9608++;
        return arg0 == 11390 ? super.method28(arg0) : false;
    }

    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(B)V", line = 62)
    public final void method24(byte arg0) {
        super.method24(arg0);
        field9612++;
    }

    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILoa;)V", line = 80)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(III)Z", line = 96)
    ...
    @OriginalMember(owner = "client!cm", name = "c", descriptor = "(Z)V", line = 112)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Ldc;Z)V", line = 125)
    public class683(class5 arg0, boolean arg1) {
        super(arg0, 34962, arg1);
    }

    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;", line = 129)
