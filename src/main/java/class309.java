...
public class class309 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(Lwv;I)Ltj;", line = 4)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(IIIIIIIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!qaa", name = "b", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(ILqaa;)Z", line = 75)
    ...
    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(Ljava/io/File;ZI)V", line = 102)
