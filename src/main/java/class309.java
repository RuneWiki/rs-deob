...
public class class309 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(II)I", line = 6)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IIBI)Lit;", line = 35)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IZ)Z", line = 94)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(II)I", line = 106)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(B[B)[B", line = 120)
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(II)V", line = 194)
