...
public class class309 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(II)Lcl;")
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(BILig;)V")
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(Lln;)V")
