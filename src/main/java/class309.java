...
public class class309 extends class324 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(BLrt;)V")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Lqb;II)V")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Lqf;B)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "(ZLtq;)V")
