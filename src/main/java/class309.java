...
public class class309 extends class156 {
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(IIZII)V", line = 3)
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(IIII)I", line = 32)
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(ILv;ZI)V", line = 62)
