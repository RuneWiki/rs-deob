...
public class class309 extends class367 implements class43 {
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(ZII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILoa;)V", line = 15)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILft;)V", line = 39)
    ...
    @OriginalMember(owner = "client!vr", name = "<init>", descriptor = "(Lih;I[BIZ)V", line = 59)
    public class309(class214 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34963, arg2, arg3, arg4);
        this.field4908 = arg1;
    }

    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(II[BI)V", line = 67)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(B)I", line = 80)
    ...
    @OriginalMember(owner = "client!vr", name = "c", descriptor = "(B)V", line = 92)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(B)I", line = 103)
    ...
    @OriginalMember(owner = "client!vr", name = "c", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!vr", name = "d", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(I)J", line = 168)
