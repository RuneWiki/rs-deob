...
public abstract class class309 extends class270 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIBZII)V", line = 6)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(I)V", line = 208)
