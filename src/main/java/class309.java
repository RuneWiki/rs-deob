...
public class class309 extends class503 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IBLtu;)V", line = 3)
    ...
    @OriginalMember(owner = "client!bg", name = "b", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!bg", name = "c", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IZBLjava/lang/String;ILjava/lang/String;ZJZII)V", line = 116)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IZ)V", line = 178)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(III)V", line = 189)
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(Lrl;)V", line = 222)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(B)Z", line = 343)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ZZ)V", line = 354)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ZI)V", line = 365)
    ...
    @OriginalMember(owner = "client!bg", name = "d", descriptor = "(I)V", line = 390)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IIIIII[B)Z", line = 402)
