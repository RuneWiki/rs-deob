...
public class class309 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "([III[IILgj;)Lgn;", line = 4)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(II)V", line = 63)
    ...
    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(II)Llfa;", line = 76)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Z)V", line = 115)
    ...
    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(Z)V", line = 150)
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "(Ldd;ILpj;)V", line = 304)
