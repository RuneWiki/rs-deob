...
public class class309 implements Runnable {
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(III)Liq;", line = 4)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!tr", name = "run", descriptor = "()V", line = 76)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IBI)Z", line = 137)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!tr", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 203)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(B[[I)V", line = 190)
