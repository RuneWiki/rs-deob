...
public class class309 {
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(ZZ)V", line = 40)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(BLkp;)Lkp;", line = 59)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(I)I", line = 89)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(III)V", line = 105)
