...
public class class309 {
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(Lge;Lek;Lwh;IIIII)V", line = 151)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Lgp;II)V", line = 27)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(I)V", line = 40)
