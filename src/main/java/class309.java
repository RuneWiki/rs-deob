...
public class class309 extends class333 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 22)
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(I)I", line = 128)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IFIII)V", line = 144)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ILr;)V", line = 258)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIBI)V", line = 273)
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(II)V", line = 285)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IB[I)V", line = 302)
    ...
    @OriginalMember(owner = "client!ac", name = "c", descriptor = "(II)V", line = 424)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Lnp;I)Ldd;", line = 435)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IB)V", line = 483)
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(Lmea;IIIII)V", line = 497)
