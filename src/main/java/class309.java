...
public class class309 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Len;[IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Len;[II)V")
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Len;[II[I[I)V")
