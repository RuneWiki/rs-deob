...
public class class309 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IBIZII)V", line = 6)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(B)V", line = 233)
    ...
    @OriginalMember(owner = "client!am", name = "toString", descriptor = "()Ljava/lang/String;", line = 248)
