...
public class class309 extends class366 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(ILgo;B)V")
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(Lqg;Lpe;)V")
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(ILqf;)V")
