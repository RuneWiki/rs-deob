...
public class class309 {
    ...
    @OriginalMember(owner = "client!dja", name = "a", descriptor = "(BI)Lki;")
    ...
    @OriginalMember(owner = "client!dja", name = "a", descriptor = "(Lgp;BLgp;F)Z")
    ...
    @OriginalMember(owner = "client!dja", name = "<init>", descriptor = "(Lwh;)V")
