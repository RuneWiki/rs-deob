...
public class class309 extends class392 {
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!bv", name = "<init>", descriptor = "(Lor;)V", line = 20)
    public class309(class640 arg0) {
        this.field4194 = arg0;
    }

    @OriginalMember(owner = "client!bv", name = "b", descriptor = "(I)V", line = 28)
