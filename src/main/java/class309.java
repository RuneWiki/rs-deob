...
public abstract class class309 extends class435 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(B)I", line = 7)
    ...
    @OriginalMember(owner = "client!bn", name = "c", descriptor = "(I)I", line = 21)
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(B)I", line = 39)
    ...
    @OriginalMember(owner = "client!bn", name = "c", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!bn", name = "d", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!bn", name = "e", descriptor = "(B)I", line = 84)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IIIII)V", line = 99)
    ...
    @OriginalMember(owner = "client!bn", name = "d", descriptor = "(I)I", line = 120)
    ...
    @OriginalMember(owner = "client!bn", name = "f", descriptor = "(B)V", line = 132)
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "(IIIIIF)V", line = 153)
    ...
    @OriginalMember(owner = "client!bn", name = "e", descriptor = "(I)F", line = 166)
