...
public class class309 implements class381 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(II[BIII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(I)J", line = 90)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(B)V", line = 127)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Ldk;B)I", line = 140)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(ILjo;)Z", line = 217)
