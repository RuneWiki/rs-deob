...
public class class309 {
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(I)I", line = 9)
    ...
    @OriginalMember(owner = "client!bv", name = "b", descriptor = "(I)I", line = 27)
    ...
    @OriginalMember(owner = "client!bv", name = "c", descriptor = "(I)Z", line = 39)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(BI)V", line = 51)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(BLha;)V", line = 176)
    ...
    @OriginalMember(owner = "client!bv", name = "<init>", descriptor = "(Lha;Liv;IIIILga;ZI)V", line = 544)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(ZZIILha;)Lka;", line = 192)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(II)Ljava/lang/String;", line = 335)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(ILbca;ILha;ILka;ZBI)V", line = 349)
    ...
    @OriginalMember(owner = "client!bv", name = "b", descriptor = "(II)V", line = 408)
    ...
    @OriginalMember(owner = "client!bv", name = "finalize", descriptor = "()V", line = 420)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(Lga;Z)V", line = 430)
    ...
    @OriginalMember(owner = "client!bv", name = "d", descriptor = "(I)V", line = 527)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(ILha;)V", line = 564)
