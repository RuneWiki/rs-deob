...
public class class309 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "([II[I[ILwq;)V", line = 6)
    ...
    @OriginalMember(owner = "client!os", name = "toString", descriptor = "()Ljava/lang/String;", line = 101)
    public final String toString() {
        field4656++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!os", name = "a", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "(I)V", line = 123)
    public class309(int arg0) {
        this.field4654 = arg0;
    }

    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Ljava/awt/Color;ILjava/lang/String;BLjava/awt/Color;Ljava/awt/Color;Z)V", line = 133)
