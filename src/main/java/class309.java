...
public class class309 extends class406 {
    ...
    @OriginalMember(owner = "client!lh", name = "c", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IZZI)Ljava/lang/String;", line = 41)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(I[I)Ljava/lang/String;", line = 89)
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "()V", line = 135)
    public class309() {
    }

    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 137)
