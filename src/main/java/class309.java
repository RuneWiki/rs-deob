...
public class class309 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(BLlm;)V", line = 14)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Llm;Llm;ZI)V", line = 49)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(B)V", line = 79)
