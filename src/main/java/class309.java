...
public class class309 extends class508 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Ldn;II)Lbb;")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Ldn;I)Lbb;")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "([I)Leb;")
    ...
    @OriginalMember(owner = "client!bb", name = "e", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Ldn;)Z")
