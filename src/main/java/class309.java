...
public class class309 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(BLol;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(ILha;ZI)Lmq;", line = 26)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Z)V", line = 73)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(I)Z", line = 103)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IILol;)V", line = 116)
