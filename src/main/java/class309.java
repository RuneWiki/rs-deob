...
public abstract class class309 extends class390 {
    ...
    @OriginalMember(owner = "client!lh", name = "c", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "()I", line = 15)
    public int method1989() {
        return 0;
    }

    @OriginalMember(owner = "client!lh", name = "c", descriptor = "(I)Z", line = 28)
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(Ltb;)V", line = 37)
    public class309(class227 arg0) {
        this.field4247 = arg0;
    }

    @OriginalMember(owner = "client!lh", name = "d", descriptor = "(I)Z", line = 47)
