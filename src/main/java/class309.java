...
public class class309 extends class244 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(B)J", line = 3)
    public final long method775(byte arg0) {
        int var2 = 117 / ((41 - arg0) / 62);
        return this.field4196;
    }

    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(I)J", line = 18)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IB)I", line = 59)
    ...
    @OriginalMember(owner = "client!vc", name = "c", descriptor = "(B)V", line = 96)
