...
public class class309 extends class642 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(IIZ[J[Ljava/lang/Object;)V", line = 3)
    ...
    @OriginalMember(owner = "client!fe", name = "f", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!fe", name = "<init>", descriptor = "()V", line = 74)
    public class309() {
        super(1, true);
    }

    @OriginalMember(owner = "client!fe", name = "b", descriptor = "(II)[I", line = 83)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(BLjava/lang/String;Lgk;)I", line = 126)
    ...
    @OriginalMember(owner = "client!fe", name = "g", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!fe", name = "h", descriptor = "(I)V", line = 163)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(IZ)[I", line = 351)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Lla;)V", line = 377)
    public static final void method1932(class393 arg0) {
        class125.field1832 = arg0;
    }

    @OriginalMember(owner = "client!fe", name = "e", descriptor = "(I)V", line = 384)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(ILgk;B)V", line = 407)
