...
public class class309 extends class164 implements class351 {
    ...
    @OriginalMember(owner = "client!vc", name = "b", descriptor = "(Lnr;Z)Lg;")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "([[BILnr;[ZLtc;[[BII[[BIILlf;II)V")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IIILnr;)V")
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Lnr;Lta;IIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(BILnr;Z)Lbc;")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(BILnr;)Lqc;")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(ILnr;I)Lqc;")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Lnr;Z)V")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(ILnr;II)Z")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(ILnr;)V")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Lnr;I)V")
