...
public class class309 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(II)Lpc;", line = 21)
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(III)Z", line = 59)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(I)V", line = 75)
