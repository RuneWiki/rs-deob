...
public class class309 extends class51 implements class209 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(ZZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!ks", name = "c", descriptor = "(B)I", line = 22)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(B)J", line = 43)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(I)Lqn;", line = 54)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "([BIII)V", line = 77)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(B)I", line = 94)
    public final int method408(byte arg0) {
        ++field4574;
        return arg0 != -62 ? 45 : this.field4570;
    }

    @OriginalMember(owner = "client!ks", name = "<init>", descriptor = "(Lbt;I[BIZ)V", line = 106)
