...
public class class309 extends class56 {
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(IZILjava/util/Random;II[[I)V", line = 5)
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(B)V", line = 201)
    public final void method493(byte arg0) {
        int var2 = 122 % ((arg0 - 37) / 62);
        ++field3839;
    }

    @OriginalMember(owner = "client!gga", name = "c", descriptor = "(I)V", line = 213)
    ...
    @OriginalMember(owner = "client!gga", name = "b", descriptor = "(IIB)Z", line = 226)
    ...
    @OriginalMember(owner = "client!gga", name = "<init>", descriptor = "()V", line = 240)
    public class309() {
        super(0, true);
    }

    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(BILes;)V", line = 247)
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(II)[I", line = 356)
