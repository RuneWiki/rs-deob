...
public class class309 extends class461 {
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(II)Lo;", line = 24)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Z)V", line = 56)
