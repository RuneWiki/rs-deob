...
public class class309 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IZILvb;Lvb;)I")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ILln;BIILr;I)Lda;")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIILi;Li;Lln;Lr;IZIBIII)Lda;")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ILln;ILr;IIB)Lda;")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ZLmo;I)V")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIIILvq;ILvq;III)V")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lmo;I)V")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIILi;ILr;ZIBIILi;Lln;)Lda;")
