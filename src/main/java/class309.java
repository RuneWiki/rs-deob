...
public class class309 {
    ...
    @OriginalMember(owner = "client!wt", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field4300++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(I)V", line = 11)
    private class309(int arg0) {
        this.field4299 = arg0;
    }

    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IIIZ)V", line = 43)
