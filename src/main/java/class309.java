...
public class class309 extends class489 {
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(Lod;Lje;[Lgu;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!pr", name = "B", descriptor = "(CIIIZ)V", line = 211)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(CIIIZLea;II)V", line = 229)
