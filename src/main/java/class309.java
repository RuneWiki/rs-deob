...
public class class309 extends class7 {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Ljg;I)V")
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Lmp;ILhe;Le;Le;ZIIIIZI)Lgl;")
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Ljg;IZ)V")
