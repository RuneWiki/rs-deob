...
public class class309 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(ILir;)V", line = 46)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(I)Lss;", line = 71)
