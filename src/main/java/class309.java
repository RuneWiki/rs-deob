...
public class class309 extends class425 {
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(IB)I", line = 3)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(I)Ljava/lang/String;", line = 109)
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "()V", line = 137)
    public class309() {
    }

    @OriginalMember(owner = "client!lh", name = "d", descriptor = "(B)V", line = 142)
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 154)
