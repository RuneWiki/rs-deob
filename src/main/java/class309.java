...
public abstract class class309 extends class167 {
    ...
    @OriginalMember(owner = "client!vda", name = "B", descriptor = "(IIIIII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(I)V", line = 32)
    public final void method521(int arg0) {
    }

    @OriginalMember(owner = "client!vda", name = "D", descriptor = "()V", line = 34)
    public final void method122() {
    }

    @OriginalMember(owner = "client!vda", name = "j", descriptor = "(I)Z", line = 37)
    public final boolean method1920(int arg0) {
        return this.field4487 || super.field2443.method2387((byte) 127, arg0).field8205;
    }

    @OriginalMember(owner = "client!vda", name = "N", descriptor = "(IIII)V", line = 43)
    ...
    @OriginalMember(owner = "client!vda", name = "q", descriptor = "()Z", line = 63)
    public final boolean method141() {
        return false;
    }

    @OriginalMember(owner = "client!vda", name = "ta", descriptor = "(II)V", line = 68)
    ...
    @OriginalMember(owner = "client!vda", name = "f", descriptor = "()Z", line = 74)
    public final boolean method559() {
        return false;
    }

    @OriginalMember(owner = "client!vda", name = "v", descriptor = "(IIII)[I", line = 78)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(IIIIZ)Lha;", line = 104)
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "()V", line = 135)
    public void method142() {
    }

    @OriginalMember(owner = "client!vda", name = "f", descriptor = "(IIIIII)V", line = 139)
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(Z)V", line = 273)
    public final void method131(boolean arg0) {
    }

    @OriginalMember(owner = "client!vda", name = "d", descriptor = "(I)Lu;", line = 276)
    public final class424 method614(int arg0) {
        return null;
    }

    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(II[I[I)Lpa;", line = 279)
    public final class593 method582(int arg0, int arg1, int[] arg2, int[] arg3) {
        return new class603(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ln;)V", line = 282)
    ...
    @OriginalMember(owner = "client!vda", name = "w", descriptor = "()V", line = 287)
    ...
    @OriginalMember(owner = "client!vda", name = "JA", descriptor = "(IIII)V", line = 308)
    ...
    @OriginalMember(owner = "client!vda", name = "L", descriptor = "(I)V", line = 313)
    public final void method642(int arg0) {
    }

    @OriginalMember(owner = "client!vda", name = "a", descriptor = "([IIIII)Lha;", line = 317)
    ...
    @OriginalMember(owner = "client!vda", name = "z", descriptor = "()Z", line = 354)
    public final boolean method595() {
        return false;
    }

    @OriginalMember(owner = "client!vda", name = "U", descriptor = "()I", line = 357)
    public final int method565() {
        return 0;
    }

    @OriginalMember(owner = "client!vda", name = "c", descriptor = "(IIIIII)Lkk;", line = 362)
    public final class149 method515(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!vda", name = "m", descriptor = "()Z", line = 365)
    public final boolean method629() {
        return false;
    }

    @OriginalMember(owner = "client!vda", name = "Z", descriptor = "(I)V", line = 373)
    public final void method121(int arg0) {
        this.method653(0, 0, this.field4481, this.field4497, arg0, 0);
    }

    @OriginalMember(owner = "client!vda", name = "a", descriptor = "()Lm;", line = 377)
    public final class105 method637() {
        class174 var1 = this.method395(Thread.currentThread());
        return var1.field2523;
    }

    @OriginalMember(owner = "client!vda", name = "o", descriptor = "()V", line = 381)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Lrl;[Lfba;Z)Lra;", line = 398)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(IIIIIIIII)V", line = 436)
    ...
    @OriginalMember(owner = "client!vda", name = "p", descriptor = "()Z", line = 469)
    public final boolean method157() {
        return false;
    }

    @OriginalMember(owner = "client!vda", name = "k", descriptor = "(I)Z", line = 472)
    public final boolean method1923(int arg0) {
        return super.field2443.method2387((byte) 127, arg0).field8213;
    }

    @OriginalMember(owner = "client!vda", name = "ba", descriptor = "()I", line = 476)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(FFF)V", line = 480)
    public final void method139(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!vda", name = "s", descriptor = "()V", line = 482)
    public final void method83() {
    }

    @OriginalMember(owner = "client!vda", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 486)
    ...
    @OriginalMember(owner = "client!vda", name = "u", descriptor = "()V", line = 514)
    public final void method153() {
    }

    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(IIIIII)V", line = 517)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Lkk;)V", line = 729)
    public final void method556(class149 arg0) {
    }

    @OriginalMember(owner = "client!vda", name = "E", descriptor = "(III)V", line = 732)
    ...
    @OriginalMember(owner = "client!vda", name = "q", descriptor = "(IIII)V", line = 757)
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(II)I", line = 764)
    public final int method649(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Z)V", line = 766)
    public final void method621(boolean arg0) {
    }

    @OriginalMember(owner = "client!vda", name = "e", descriptor = "()V", line = 768)
    public final void method124() {
    }

    @OriginalMember(owner = "client!vda", name = "l", descriptor = "(I)[I", line = 772)
    ...
    @OriginalMember(owner = "client!vda", name = "n", descriptor = "()V", line = 792)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(II)I", line = 799)
    public final int method560(int arg0, int arg1) {
        int var3 = arg0 | 133120;
        return var3 & arg1 ^ arg1;
    }

    @OriginalMember(owner = "client!vda", name = "UA", descriptor = "(IIIII)V", line = 803)
    ...
    @OriginalMember(owner = "client!vda", name = "l", descriptor = "()V", line = 903)
    public final void method567() {
        this.field4478.method2406(24);
    }

    @OriginalMember(owner = "client!vda", name = "d", descriptor = "([I)V", line = 908)
    ...
    @OriginalMember(owner = "client!vda", name = "CA", descriptor = "()I", line = 914)
    public final int method531() {
        return this.field4480;
    }

    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Lm;)V", line = 920)
    public final void method587(class105 arg0) {
        this.field4513 = (class199) arg0;
    }

    @OriginalMember(owner = "client!vda", name = "g", descriptor = "(I)V", line = 924)
    ...
    @OriginalMember(owner = "client!vda", name = "G", descriptor = "(ILpa;II)V", line = 957)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Ltl;III)V", line = 1015)
    ...
    @OriginalMember(owner = "client!vda", name = "j", descriptor = "()Z", line = 1053)
    public final boolean method660() {
        return true;
    }

    @OriginalMember(owner = "client!vda", name = "g", descriptor = "()Z", line = 1056)
    public final boolean method618() {
        return false;
    }

    @OriginalMember(owner = "client!vda", name = "n", descriptor = "(I)Z", line = 1059)
    public final boolean method1928(int arg0) {
        return super.field2443.method2389(-16, arg0);
    }

    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(Ln;)V", line = 1062)
    ...
    @OriginalMember(owner = "client!vda", name = "c", descriptor = "(Z)V", line = 1071)
    public final void method525(boolean arg0) {
        this.field4487 = arg0;
        this.field4478.method2406(-121);
    }

    @OriginalMember(owner = "client!vda", name = "e", descriptor = "(IIIII)V", line = 1075)
    ...
    @OriginalMember(owner = "client!vda", name = "IA", descriptor = "(III[I)V", line = 1152)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Lsh;)V", line = 1178)
    ...
    @OriginalMember(owner = "client!vda", name = "o", descriptor = "(I)[I", line = 1217)
    ...
    @OriginalMember(owner = "client!vda", name = "c", descriptor = "()I", line = 1239)
    public final int method537() {
        return this.field4490;
    }

    @OriginalMember(owner = "client!vda", name = "y", descriptor = "()Z", line = 1242)
    public final boolean method635() {
        return true;
    }

    @OriginalMember(owner = "client!vda", name = "A", descriptor = "()Z", line = 1249)
    public final boolean method524() {
        return false;
    }

    @OriginalMember(owner = "client!vda", name = "m", descriptor = "(IFFFFF)V", line = 1252)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Lkk;Lkk;FLkk;)Lkk;", line = 1261)
    public final class149 method104(class149 arg0, class149 arg1, float arg2, class149 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!vda", name = "A", descriptor = "(IIIII)V", line = 1264)
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "(IIII)V", line = 1550)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Lu;)V", line = 1557)
    public final void method593(class424 arg0) {
    }

    @OriginalMember(owner = "client!vda", name = "P", descriptor = "()F", line = 1561)
    public final float method542() {
        return this.field4507;
    }

    @OriginalMember(owner = "client!vda", name = "za", descriptor = "(IIIIII[BII)V", line = 1565)
    ...
    @OriginalMember(owner = "client!vda", name = "C", descriptor = "()Z", line = 1741)
    public final boolean method555() {
        return false;
    }

    @OriginalMember(owner = "client!vda", name = "d", descriptor = "()Z", line = 1745)
    public final boolean method650() {
        return true;
    }

    @OriginalMember(owner = "client!vda", name = "t", descriptor = "()V", line = 1749)
    ...
    @OriginalMember(owner = "client!vda", name = "v", descriptor = "()Z", line = 1762)
    public final boolean method529() {
        return true;
    }

    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Lr;Lsh;Lm;Lpaa;I)V", line = 1766)
    ...
    @OriginalMember(owner = "client!vda", name = "h", descriptor = "()Lm;", line = 1769)
    public final class105 method623() {
        return new class199();
    }

    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(IIIIII)V", line = 1772)
    ...
    @OriginalMember(owner = "client!vda", name = "i", descriptor = "()Ldp;", line = 1779)
    public final class425 method85() {
        return new class425(0, "Pure Java", 1, "CPU", 0L);
    }

    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(I[Luca;)V", line = 1782)
    public final void method586(int arg0, class637[] arg1) {
    }

    @OriginalMember(owner = "client!vda", name = "G", descriptor = "()V", line = 1787)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(IIII)V", line = 1795)
    public final void method99(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Lfba;Z)Lha;", line = 1799)
    ...
    @OriginalMember(owner = "client!vda", name = "c", descriptor = "(Ljava/awt/Canvas;)V", line = 1903)
    ...
    @OriginalMember(owner = "client!vda", name = "F", descriptor = "(IIII)V", line = 1912)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(IIIIIILpa;II)V", line = 1928)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 2166)
    ...
    @OriginalMember(owner = "client!vda", name = "M", descriptor = "(F)V", line = 2177)
    public final void method569(float arg0) {
        this.field4477 = (int) (arg0 * 65535.0F);
    }

    @OriginalMember(owner = "client!vda", name = "x", descriptor = "()Z", line = 2183)
    public final boolean method594() {
        return false;
    }

    @OriginalMember(owner = "client!vda", name = "k", descriptor = "()Z", line = 2186)
    public final boolean method645() {
        return false;
    }

    @OriginalMember(owner = "client!vda", name = "la", descriptor = "(FF)V", line = 2189)
    ...
    @OriginalMember(owner = "client!vda", name = "r", descriptor = "()I", line = 2215)
