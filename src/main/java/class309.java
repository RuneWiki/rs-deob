...
public class class309 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(FIFF)I", line = 17)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(III)Z", line = 67)
    ...
    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(I)V", line = 79)
