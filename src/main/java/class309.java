...
public class class309 {
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(Lum;I)Lrr;")
    ...
    @OriginalMember(owner = "client!rr", name = "b", descriptor = "(Lum;I)[Lrr;")
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(Lum;II)Lrr;")
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "([B)[Lrr;")
    ...
    @OriginalMember(owner = "client!rr", name = "b", descriptor = "(Lum;II)[Lrr;")
