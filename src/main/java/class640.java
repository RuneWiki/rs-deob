...
public class class640 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IIIZIIIIII)Z", line = 48)
    ...
    @OriginalMember(owner = "client!jf", name = "toString", descriptor = "()Ljava/lang/String;", line = 84)
    public final String toString() {
        field9090++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 96)
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(II)V", line = 124)
