...
public class class640 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "()I", line = 3)
    public final int method3641() {
        return this.field9148 - 1;
    }

    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lr;Ljava/lang/String;IIIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "()V", line = 24)
    public static void method3643() {
        field9155 = null;
    }

    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lr;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!kb", name = "c", descriptor = "()I", line = 118)
    public final int method3645() {
        return this.field9153;
    }

    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lr;Ljava/lang/String;[IIIIZ)V", line = 121)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Ljava/lang/String;)I", line = 146)
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(Lr;IZLjava/awt/Component;)V", line = 172)
