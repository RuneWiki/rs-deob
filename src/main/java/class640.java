...
public class class640 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(BI)V", line = 4)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(III)V", line = 19)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ZZIILqa;II)Lr;", line = 33)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lqa;I)V", line = 160)
    public final void method3669(class206 arg0, int arg1) {
        field9226++;
        this.method3668(true, true, arg1, this.field9205, arg0, this.field9233, -3);
    }

    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(BII)Z", line = 173)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(I)I", line = 187)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Z)V", line = 200)
    ...
    @OriginalMember(owner = "client!lo", name = "finalize", descriptor = "()V", line = 212)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(II)V", line = 228)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ILr;ILqa;IZII)V", line = 349)
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(Lqa;Lcn;IIIIIIZI)V", line = 669)
    ...
    @OriginalMember(owner = "client!lo", name = "b", descriptor = "(Z)Z", line = 394)
    ...
    @OriginalMember(owner = "client!lo", name = "b", descriptor = "(III)V", line = 405)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ZLqa;)V", line = 509)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ZI)Z", line = 535)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IJ)V", line = 601)
