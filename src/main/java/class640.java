...
public class class640 extends class584 {
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(IIIBLjava/awt/Graphics;III)V", line = 13)
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(Ljava/awt/Canvas;BII)V", line = 30)
