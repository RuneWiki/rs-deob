...
public class class640 extends class752 {
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!or", name = "d", descriptor = "(B)Z", line = 28)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lka;Lha;ILhba;)V", line = 55)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lha;III)Lka;", line = 82)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lgg;BZILha;II)V", line = 108)
    ...
    @OriginalMember(owner = "client!or", name = "finalize", descriptor = "()V", line = 123)
    ...
    @OriginalMember(owner = "client!or", name = "h", descriptor = "(I)I", line = 136)
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(Lha;I)Lbd;", line = 174)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IIIII)V", line = 224)
    ...
    @OriginalMember(owner = "client!or", name = "c", descriptor = "(Z)I", line = 257)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ILha;BI)Z", line = 268)
    ...
    @OriginalMember(owner = "client!or", name = "j", descriptor = "(I)V", line = 282)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(BI)V", line = 295)
    ...
    @OriginalMember(owner = "client!or", name = "c", descriptor = "(Lha;I)V", line = 327)
    ...
    @OriginalMember(owner = "client!or", name = "d", descriptor = "(I)Z", line = 348)
    ...
    @OriginalMember(owner = "client!or", name = "f", descriptor = "(B)V", line = 360)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(BLha;)Loia;", line = 379)
    ...
    @OriginalMember(owner = "client!or", name = "g", descriptor = "(I)Z", line = 399)
