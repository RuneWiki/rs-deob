...
public class class640 extends class144 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IILoa;I)Z", line = 47)
    ...
    @OriginalMember(owner = "client!fl", name = "b", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!fl", name = "c", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!fl", name = "e", descriptor = "(B)I", line = 93)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IIILva;Loa;ZI)V", line = 107)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(BILoa;)Lba;", line = 118)
    ...
    @OriginalMember(owner = "client!fl", name = "b", descriptor = "(Loa;I)Lew;", line = 133)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!fl", name = "finalize", descriptor = "()V", line = 164)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Loa;I)V", line = 176)
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "(IIIIIIIIIIIZ)V", line = 235)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Lq;ZLoa;Lba;)V", line = 205)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(ZI)V", line = 261)
    ...
    @OriginalMember(owner = "client!fl", name = "f", descriptor = "(I)Z", line = 281)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Loa;B)Laca;", line = 295)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Lkea;Lkea;ILkea;Lci;)Z", line = 335)
    ...
    @OriginalMember(owner = "client!fl", name = "f", descriptor = "(B)V", line = 351)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(II)V", line = 362)
