...
public abstract class class640 extends class583 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ZI)Ljava/lang/String;", line = 7)
    ...
    @OriginalMember(owner = "client!or", name = "e", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(Laf;I)V", line = 57)
