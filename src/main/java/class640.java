...
public class class640 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "([BLjava/lang/String;II)I", line = 35)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ZI)Lcl;", line = 95)
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "(Lbs;ILpfa;)V", line = 133)
