...
public class class640 {
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(BLjf;)Lgm;", line = 9)
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(II)Lhe;", line = 32)
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(ILsl;I)V", line = 73)
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(Lsl;I)V", line = 121)
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(B)V", line = 143)
    ...
    @OriginalMember(owner = "client!gea", name = "b", descriptor = "(II)V", line = 158)
