...
public class class640 extends class585 {
    ...
    @OriginalMember(owner = "client!jaa", name = "e", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!jaa", name = "<init>", descriptor = "()V", line = 56)
    public class640() {
        super(1, true);
    }

    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(Lda;)V", line = 23)
    public static final void method3654(class66 arg0) {
        class679.field9437 = arg0;
    }

    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(IZIIIIIIF)[[I", line = 26)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(Lso;II)V", line = 59)
    ...
    @OriginalMember(owner = "client!jaa", name = "b", descriptor = "(II)[I", line = 73)
