...
public class class640 extends class50 {
    ...
    @OriginalMember(owner = "client!cia", name = "d", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(IIB)V", line = 33)
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(IB)Z", line = 83)
    ...
    @OriginalMember(owner = "client!cia", name = "<init>", descriptor = "(IIIIIFFF)V", line = 97)
    ...
    @OriginalMember(owner = "client!cia", name = "b", descriptor = "(IIB)V", line = 114)
    ...
    @OriginalMember(owner = "client!cia", name = "b", descriptor = "(I)V", line = 128)
