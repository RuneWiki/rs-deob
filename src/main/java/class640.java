...
public class class640 implements Runnable {
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!wda", name = "run", descriptor = "()V", line = 18)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(II)Loi;", line = 62)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Z)Z", line = 82)
