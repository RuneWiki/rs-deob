...
public class class640 extends class586 {
    ...
    @OriginalMember(owner = "client!gi", name = "c", descriptor = "(I)V", line = 5)
    public static void method3677(int arg0) {
        int var1 = -5 / ((arg0 - 34) / 56);
        field9000 = null;
    }

    @OriginalMember(owner = "client!gi", name = "b", descriptor = "(I)Lfp;", line = 18)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IIIZII)V", line = 77)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Ljava/lang/Throwable;I)Ljava/lang/String;", line = 105)
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(Llba;IIIIII)V", line = 178)
