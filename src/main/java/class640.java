...
public class class640 {
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;BLjava/lang/String;)Ljava/lang/String;", line = 38)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(IIIII)V", line = 61)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(Lr;III)V", line = 103)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(IILr;I)V", line = 178)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(I)V", line = 259)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "([[ZZIIII)V", line = 276)
    ...
    @OriginalMember(owner = "client!jaa", name = "b", descriptor = "(Lr;III)Z", line = 476)
    ...
    @OriginalMember(owner = "client!jaa", name = "<init>", descriptor = "(Lee;Lqq;)V", line = 545)
