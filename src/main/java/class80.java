...
public class class80 {
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(IILha;I)Z")
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(ILha;ZI)V")
    ...
    @OriginalMember(owner = "client!haa", name = "b", descriptor = "(IILha;I)V")
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(ZLoh;B)V")
    ...
    @OriginalMember(owner = "client!haa", name = "<init>", descriptor = "(Lvj;Lmea;)V")
