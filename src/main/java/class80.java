...
public class class80 extends class230 implements class254 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(I[BI)V", line = 4)
    public final void method444(int arg0, byte[] arg1, int arg2) {
        this.method1473(arg1, arg2);
        this.field901 = arg0;
    }

    @OriginalMember(owner = "client!wh", name = "a", descriptor = "()I", line = 8)
    public final int method380() {
        return super.method380();
    }

    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Lpo;I[BIZ)V", line = 11)
    public class80(class332 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field901 = arg1;
    }

    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Lpo;ILjava/nio/ByteBuffer;Z)V", line = 15)
    public class80(class332 arg0, int arg1, ByteBuffer arg2, boolean arg3) {
        super(arg0, 34962, arg2, arg3);
        this.field901 = arg1;
    }

    @OriginalMember(owner = "client!wh", name = "b", descriptor = "()V", line = 19)
    public final void method383() {
        this.field3122.method2055(this);
    }

    @OriginalMember(owner = "client!wh", name = "c", descriptor = "(Lpe;)V", line = 22)
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(Lpe;)V", line = 25)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Lpe;)V", line = 29)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(ILpe;)V", line = 33)
