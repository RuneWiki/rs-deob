...
public class class80 extends class268 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(I)Lvj;", line = 3)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IIIII[FI)V", line = 15)
    ...
    @OriginalMember(owner = "client!ji", name = "c", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(ILnha;Ljn;III)V", line = 128)
