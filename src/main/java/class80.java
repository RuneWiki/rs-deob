...
public class class80 extends class431 {
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(BLod;I)I", line = 47)
