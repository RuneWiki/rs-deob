...
public class class80 {
    ...
    @OriginalMember(owner = "client!cb", name = "finalize", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(Llm;JI)V", line = 21)
    public class80(class337 arg0, long arg1, int arg2) {
        this.field1079 = arg1;
        this.field1082 = arg0;
    }

    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(II)Z", line = 32)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(I)V", line = 45)
