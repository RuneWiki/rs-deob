...
public class class80 implements class695 {
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(BIII)V", line = 12)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(IIII)V", line = 43)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(III)Lhl;", line = 60)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(BLuq;)Z", line = 76)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(BLuea;ILlt;IILkw;I)V", line = 97)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(IIZIIII)V", line = 194)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(I)Lhs;", line = 211)
    public class295 method52(int arg0) {
        field1105++;
        return arg0 == -14151 ? null : null;
    }

    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(B)V", line = 222)
    public static void method639(byte arg0) {
        int var1 = -92 / ((2 - arg0) / 42);
        field1112 = null;
    }

    @OriginalMember(owner = "client!dba", name = "<init>", descriptor = "(Lfw;Ldg;IIIII)V", line = 234)
