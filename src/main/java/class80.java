...
public class class80 extends class15 {
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(ZLjava/lang/String;)Z", line = 6)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Lrs;Lqa;)V", line = 17)
    ...
    @OriginalMember(owner = "client!ej", name = "b", descriptor = "(Z)V", line = 1141)
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "([B)V", line = 1160)
