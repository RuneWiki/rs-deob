...
public class class80 {
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(Ljava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!haa", name = "c", descriptor = "()V")
    public static void method629() {
        field1021 = null;
    }

    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(Lha;Ljava/lang/String;IIIZ)V")
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(Lha;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(Lha;Ljava/lang/String;[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!haa", name = "<init>", descriptor = "(Lha;IZLjava/awt/Component;)V")
