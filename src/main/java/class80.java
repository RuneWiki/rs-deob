...
public class class80 {
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(III)I", line = 21)
    ...
    @OriginalMember(owner = "client!oi", name = "c", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!oi", name = "b", descriptor = "(III)Z", line = 66)
