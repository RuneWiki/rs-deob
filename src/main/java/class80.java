...
public class class80 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "([II[III)V")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "([BI[BII)V")
    public static final void method495(byte[] arg0, int arg1, byte[] arg2, int arg3, int arg4) {
        if (arg0 == arg2) {
            if (arg1 == arg3) {
                return;
            }
