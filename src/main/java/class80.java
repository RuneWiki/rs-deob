...
public abstract class class80 extends class261 {
    ...
    @OriginalMember(owner = "client!ej", name = "b", descriptor = "(II)[I", line = 12)
    ...
    @OriginalMember(owner = "client!ej", name = "b", descriptor = "(Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!ej", name = "c", descriptor = "(II)[[I", line = 37)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(I)I", line = 49)
    public int method707(int arg0) {
        field1586++;
        return arg0 == -1 ? -1 : 28;
    }

    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(III)V", line = 62)
    ...
    @OriginalMember(owner = "client!ej", name = "c", descriptor = "(Z)V", line = 86)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IIB)[I", line = 103)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(ILjava/lang/String;)V", line = 124)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IZ)I", line = 146)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IILnn;)V", line = 158)
    public void method26(int arg0, int arg1, class289 arg2) {
        int var4 = 60 / ((arg1 - 28) / 53);
        field1583++;
    }

    @OriginalMember(owner = "client!ej", name = "b", descriptor = "(III)[[I", line = 175)
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "(IZ)V", line = 213)
    public class80(int arg0, boolean arg1) {
        this.field1603 = new class80[arg0];
        this.field1591 = arg1;
    }

    @OriginalMember(owner = "client!ej", name = "c", descriptor = "(I)I", line = 233)
    ...
    @OriginalMember(owner = "client!ej", name = "b", descriptor = "(B)V", line = 246)
