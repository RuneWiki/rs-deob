...
public class class80 {
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IBC)C", line = 25)
    ...
    @OriginalMember(owner = "client!ej", name = "finalize", descriptor = "()V", line = 111)
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "(Lbt;J[Lbn;)V", line = 125)
    public class80(class33 arg0, long arg1, class314[] arg2) {
        this.field1298 = arg0;
        this.field1301 = arg1;
    }

    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(BI)Z", line = 141)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(I)V", line = 160)
