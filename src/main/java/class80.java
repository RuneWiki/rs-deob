...
public class class80 {
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(II)V", line = 31)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(ILjava/awt/Component;)Lqn;", line = 46)
    public static final class436 method617(int arg0, Component arg1) {
        field1126++;
        return arg0 == 1 ? new class494(arg1) : null;
    }

    @OriginalMember(owner = "client!m", name = "b", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(IB)Lwm;", line = 72)
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(Lad;ILdk;)V", line = 119)
