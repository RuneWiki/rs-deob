...
public class class80 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ZII)I", line = 4)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(I)I", line = 20)
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(BLjc;)Lsca;", line = 76)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(B)V", line = 118)
