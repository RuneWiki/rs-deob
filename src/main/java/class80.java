...
public class class80 extends class544 {
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IZ)V", line = 53)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(BII[I)V", line = 68)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(Z)V", line = 81)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(II)I", line = 96)
    public static final int method465(int arg0, int arg1) {
        return class640.field9217 == null ? 0 : class640.field9217[arg0][arg1] & 0xFF;
    }

    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IZII)Z", line = 145)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IIIIIII)V", line = 160)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(II[II)V", line = 191)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IZI)Z", line = 212)
    ...
    @OriginalMember(owner = "client!qu", name = "<init>", descriptor = "(IIIIIIIII)V", line = 226)
