...
public class class80 extends class85 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "([B[IIIIIIIIIIILtm;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(CIIIZ)V", line = 102)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(CIIIZLtm;II)V", line = 164)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "([B[IIIIIIII)V", line = 231)
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "(Lpm;Lhi;[Ltr;[I[I)V", line = 268)
    ...
    @OriginalMember(owner = "client!wn", name = "b", descriptor = "([B[IIIIIIIIIIILtm;II)V", line = 291)
    ...
    @OriginalMember(owner = "client!wn", name = "b", descriptor = "([B[IIIIIIII)V", line = 376)
