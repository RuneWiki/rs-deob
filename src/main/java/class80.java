...
public class class80 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(I[Luj;)I", line = 3)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(BLuj;J)V", line = 39)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(B)I", line = 63)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!sd", name = "b", descriptor = "(I)Luj;", line = 110)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(BJ)Luj;", line = 121)
    ...
    @OriginalMember(owner = "client!sd", name = "c", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!sd", name = "d", descriptor = "(I)Luj;", line = 237)
    ...
    @OriginalMember(owner = "client!sd", name = "e", descriptor = "(I)V", line = 267)
    ...
    @OriginalMember(owner = "client!sd", name = "f", descriptor = "(I)V", line = 282)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Z)I", line = 320)
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "(I)V", line = 333)
    ...
    @OriginalMember(owner = "client!sd", name = "g", descriptor = "(I)Luj;", line = 358)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IZLkr;)Z", line = 393)
