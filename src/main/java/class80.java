...
public class class80 {
    ...
    @OriginalMember(owner = "client!aw", name = "b", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Ljagdx/IDirect3DSurface;ZLjagdx/IDirect3DSwapChain;)V", line = 43)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(II)I", line = 57)
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 65)
