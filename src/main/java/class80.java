...
public class class80 {
    ...
    @OriginalMember(owner = "client!m", name = "b", descriptor = "(II)Lwg;")
    ...
    @OriginalMember(owner = "client!m", name = "c", descriptor = "(II)Llc;")
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(Lkr;ILok;Lok;Lok;)V")
