...
public class class80 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Lkh;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Lnq;B)V", line = 26)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(II[Lms;)V", line = 38)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IB)I", line = 130)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 145)
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(IB)V", line = 163)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IILuo;III)Lmj;", line = 183)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(I)V", line = 308)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Lkh;BI)V", line = 322)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Lkr;Z)Z", line = 409)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(JI)V", line = 496)
