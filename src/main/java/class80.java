...
public class class80 extends class192 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(BI)I", line = 4)
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(B)J", line = 42)
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(I)J", line = 88)
    public final long method458(int arg0) {
        int var2 = -27 % ((arg0 - 77) / 35);
        return this.field1169;
    }

    @OriginalMember(owner = "client!ca", name = "c", descriptor = "(I)V", line = 100)
