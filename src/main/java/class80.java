...
public class class80 extends class14 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(IBLmd;)V")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Ljava/lang/String;B)Z")
    ...
    @OriginalMember(owner = "client!ut", name = "d", descriptor = "(Z)V")
