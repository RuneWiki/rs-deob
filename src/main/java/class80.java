...
public class class80 extends class49 {
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(BILgga;)V")
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(ILgga;)V")
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(IIZ)Z")
