...
public class class80 {
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(Lqs;II)Lht;")
    ...
    @OriginalMember(owner = "client!ht", name = "b", descriptor = "()Lmg;")
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "(Lia;)V")
