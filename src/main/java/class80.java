...
public class class80 extends class208 {
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 14)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 53)
    ...
    @OriginalMember(owner = "client!gw", name = "b", descriptor = "()I", line = 75)
    public final int method572() {
        return this.field1050 - (this.field1046.available() >> (class48.field709 ? 2 : 1));
    }

    @OriginalMember(owner = "client!gw", name = "c", descriptor = "()V", line = 85)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "()V", line = 113)
    ...
    @OriginalMember(owner = "client!gw", name = "d", descriptor = "()V", line = 146)
