...
public class class80 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lfo;Z)V")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ZLfo;)V")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lfo;I)V")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lfo;ILtg;)V")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ILfo;B)V")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ZLoa;Lgf;)I")
    ...
    @OriginalMember(owner = "client!tt", name = "<init>", descriptor = "(Lfo;)V")
