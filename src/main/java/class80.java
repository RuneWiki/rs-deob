...
public class class80 extends class263 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!gm", name = "e", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(III)Z", line = 34)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(BLjava/lang/String;)I", line = 45)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IIIZIII)V", line = 69)
    ...
    @OriginalMember(owner = "client!gm", name = "d", descriptor = "(I)V", line = 505)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Lfd;II)V", line = 552)
