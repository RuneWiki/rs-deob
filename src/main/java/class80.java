...
public class class80 extends class72 {
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(II)V", line = 231)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(I)V", line = 249)
    ...
    @OriginalMember(owner = "client!haa", name = "<init>", descriptor = "(ILcq;)V", line = 261)
    public class80(int arg0, class464 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(IZ)V", line = 267)
    ...
    @OriginalMember(owner = "client!haa", name = "b", descriptor = "(I)I", line = 310)
    ...
    @OriginalMember(owner = "client!haa", name = "d", descriptor = "(I)I", line = 328)
    public final int method788(int arg0) {
        ++field1491;
        return arg0 != 27669 ? 74 : super.field1282;
    }

    @OriginalMember(owner = "client!haa", name = "<init>", descriptor = "(Lcq;)V", line = 339)
    public class80(class464 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!haa", name = "b", descriptor = "(II)I", line = 343)
