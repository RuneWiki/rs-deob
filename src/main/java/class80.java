...
public class class80 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ZIIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ZII)V", line = 42)
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(Lge;)V", line = 101)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lmo;I)Z", line = 63)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(BI)Z", line = 87)
