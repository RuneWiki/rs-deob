...
public class class80 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "([[BZLbl;Lbl;IILvm;[[B[[BZ[[II[[B)V", line = 6)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(I)V", line = 288)
    ...
    @OriginalMember(owner = "client!nh", name = "b", descriptor = "(I)V", line = 298)
