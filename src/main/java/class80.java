...
public class class80 {
    ...
    @OriginalMember(owner = "client!ib", name = "o", descriptor = "Lda;")
    ...
    @OriginalMember(owner = "client!ib", name = "l", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ib", name = "r", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ib", name = "i", descriptor = "Llf;")
    private static class109 field1579 = class35.method275("You can(Wt add yourself to your own ignore list)3", 2);

    @OriginalMember(owner = "client!ib", name = "d", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(Lke;Ljava/net/URL;)V")
