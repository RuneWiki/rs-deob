...
public class class80 extends class35 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(IIIFI)V", line = 18)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(IIBI)V", line = 129)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(BI)V", line = 141)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(II)V", line = 154)
    public final void method665(int arg0, int arg1) {
        this.field1122 = ByteBuffer.allocateDirect(arg0 * arg1);
    }

    @OriginalMember(owner = "client!np", name = "a", descriptor = "(I[IZ)V", line = 166)
    ...
    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "(Llg;IIIII)V", line = 289)
