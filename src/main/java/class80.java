...
public abstract class class80 {
    ...
    @OriginalMember(owner = "client!gea", name = "b", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!gea", name = "b", descriptor = "(II)Z", line = 59)
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(IBI)V", line = 76)
