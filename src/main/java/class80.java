...
public class class80 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILnk;II)V", line = 59)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ZII)Lwe;", line = 91)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(I)V", line = 106)
