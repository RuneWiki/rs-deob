...
public class class80 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IBIIZILij;)V", line = 46)
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ILea;)V", line = 218)
    ...
    @OriginalMember(owner = "client!kb", name = "c", descriptor = "(I)V", line = 240)
    ...
    @OriginalMember(owner = "client!kb", name = "d", descriptor = "(I)I", line = 267)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(B)V", line = 312)
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "()V", line = 330)
    private class80() {
    }

    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "([I)V", line = 332)
