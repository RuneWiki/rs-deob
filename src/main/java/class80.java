...
public class class80 extends class601 {
    ...
    @OriginalMember(owner = "client!haa", name = "<init>", descriptor = "(ILgn;)V")
    ...
    @OriginalMember(owner = "client!haa", name = "<init>", descriptor = "(Lgn;)V")
    public class80(class699 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(BLtp;)V")
