...
public class class80 {
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(IILin;I)V", line = 15)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(ILsd;)V", line = 94)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(IB)V", line = 138)
