...
public class class80 extends class271 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Ldh;I[I)V")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(ILdh;)V")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Ldh;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(BI)Lgo;")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(ILna;)V")
    public static final void method477(int arg0, class35 arg1) {
        class86.field1324[arg0] = arg1;
    }

    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(IZLdh;)V")
