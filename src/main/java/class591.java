...
public class class591 {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Lr;III)V")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(ILr;IZ)V")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IZILr;)Z")
    ...
    @OriginalMember(owner = "client!bd", name = "<init>", descriptor = "(Ljj;Leh;)V")
