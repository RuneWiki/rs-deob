...
public class class591 implements Runnable {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(BII)I", line = 3)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Ltq;I)V", line = 30)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(I)I", line = 44)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Ljava/lang/String;B)Lnaa;", line = 90)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(B)Z", line = 111)
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "()V", line = 328)
    public class591() {
        this.field8296.setDaemon(true);
        this.field8296.start();
    }

    @OriginalMember(owner = "client!et", name = "b", descriptor = "(B)V", line = 155)
    ...
    @OriginalMember(owner = "client!et", name = "run", descriptor = "()V", line = 172)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IILud;Lvk;)V", line = 212)
