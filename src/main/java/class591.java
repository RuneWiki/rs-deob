...
public class class591 implements Runnable {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ZLjd;)V", line = 23)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!gl", name = "c", descriptor = "(I)Z", line = 61)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ILjava/lang/String;)Lwv;", line = 113)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IIII)V", line = 133)
    ...
    @OriginalMember(owner = "client!gl", name = "run", descriptor = "()V", line = 153)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(II)V", line = 192)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(B)V", line = 239)
    public static void method3446(byte arg0) {
        int var1 = 105 / ((-arg0 - 16) / 48);
        field8738 = null;
    }

    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "()V", line = 276)
    public class591() {
        this.field8747.setDaemon(true);
        this.field8747.start();
    }

    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Ljava/lang/String;IC)I", line = 251)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(II[Ljava/lang/String;I)Ljava/lang/String;", line = 288)
