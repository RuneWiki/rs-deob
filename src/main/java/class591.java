...
public class class591 extends class163 implements class405 {
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(IIZI[IIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(IILkl;III[BII)V", line = 22)
    ...
    @OriginalMember(owner = "client!ww", name = "b", descriptor = "(I)I", line = 38)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(I)I", line = 57)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(IIII[FIILkl;B)V", line = 68)
    ...
    @OriginalMember(owner = "client!ww", name = "<init>", descriptor = "(Llh;Lkl;IIZ[FII)V", line = 82)
    ...
    @OriginalMember(owner = "client!ww", name = "<init>", descriptor = "(Llh;IIZ[III)V", line = 101)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(ZF)F", line = 120)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(ZZI)V", line = 133)
    ...
    @OriginalMember(owner = "client!ww", name = "c", descriptor = "(I)Z", line = 145)
    ...
    @OriginalMember(owner = "client!ww", name = "<init>", descriptor = "(Llh;Lkl;Lvt;II)V", line = 156)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(IF)F", line = 167)
    ...
    @OriginalMember(owner = "client!ww", name = "h", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!ww", name = "<init>", descriptor = "(Llh;Lkl;IIZ[BII)V", line = 189)
