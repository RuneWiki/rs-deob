...
public class class591 extends class87 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(II)Loda;")
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(IIIIIF)V")
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(FI)V")
