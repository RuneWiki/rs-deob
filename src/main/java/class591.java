...
public class class591 {
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!wda", name = "b", descriptor = "(Z)Lwg;", line = 22)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(I)Lwg;", line = 44)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Lwg;I)V", line = 65)
    ...
    @OriginalMember(owner = "client!wda", name = "<init>", descriptor = "()V", line = 151)
    public class591() {
        this.field8273.field5770 = this.field8273;
        this.field8273.field5773 = this.field8273;
    }

    @OriginalMember(owner = "client!wda", name = "b", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!wda", name = "c", descriptor = "(Z)I", line = 119)
