...
public class class591 extends class335 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IZ)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!sa", name = "c", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "()V", line = 97)
    public class591() {
        super(1, false);
    }

    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(ILio;I)V", line = 100)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Laga;Lr;ZLjava/lang/String;Lla;Z)V", line = 154)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(ZI)[I", line = 246)
    ...
    @OriginalMember(owner = "client!sa", name = "d", descriptor = "(B)Z", line = 290)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(BZ)V", line = 417)
