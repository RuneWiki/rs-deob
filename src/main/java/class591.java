...
public class class591 {
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(Lfm;IIILfm;BIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(IC)C", line = 61)
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(B)V", line = 91)
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(Lmha;IIZILmha;Z)I", line = 103)
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(IIIIIIIIII)V", line = 133)
