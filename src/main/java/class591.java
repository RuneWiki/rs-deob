...
public abstract class class591 {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IIIZII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IBI[I[I)V", line = 130)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(ILel;)I", line = 185)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Ljava/awt/Color;ILjava/awt/Color;Ljava/awt/Color;ILjava/lang/String;)V", line = 220)
