...
public abstract class class591 {
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(IIIIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!tda", name = "b", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(JIII)V", line = 65)
