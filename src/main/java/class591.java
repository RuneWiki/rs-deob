...
public class class591 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(IZ)Lmn;")
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "([Ljava/lang/String;[SB)V")
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(ZJLas;[I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(ILjava/awt/Canvas;)V")
    ...
    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "(ILfp;Lfp;Lkh;)V")
