...
public class class591 extends class599 implements class670 {
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Loa;Lbfa;IIIIIZIIIIII)V")
    ...
    @OriginalMember(owner = "client!og", name = "c", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IILoa;I)Z")
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(ILoa;)Lgr;")
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Loa;B)V")
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IILoa;)Lba;")
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(Loa;I)Lok;")
