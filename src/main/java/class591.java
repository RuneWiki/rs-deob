...
public class class591 extends class741 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(III)V", line = 3)
    public final void method432(int arg0, int arg1, int arg2) {
        ++field8326;
        int var4 = -81 % ((arg2 - -18) / 51);
    }

    @OriginalMember(owner = "client!um", name = "a", descriptor = "(BZ)V", line = 13)
    ...
    @OriginalMember(owner = "client!um", name = "e", descriptor = "(I)Lwia;", line = 44)
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "(B)Z", line = 55)
    public final boolean method425(byte arg0) {
        ++field8327;
        return arg0 < -37;
    }

    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IZ)V", line = 67)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IILml;)V", line = 80)
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Llba;)V", line = 95)
    public class591(class223 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!um", name = "f", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!um", name = "d", descriptor = "(I)V", line = 108)
