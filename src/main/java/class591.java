...
public class class591 {
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(IBILvc;)V", line = 8)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!baa", name = "<init>", descriptor = "(Lqh;ILtf;)V", line = 44)
