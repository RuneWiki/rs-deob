...
public class class591 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(III)Z", line = 35)
