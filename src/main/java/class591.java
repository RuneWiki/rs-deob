...
public class class591 extends class428 {
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/pe;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Luba;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Ln;Ldn;I)V")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(ILde;)V")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Ljagdx/D3DPRESENT_PARAMETERS;IZILjagdx/IDirect3D;I)Z")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lsc;B)I")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lvr;I)V")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IZ)Lrq;")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(ZI[[IZ)Llm;")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lba;B)V")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(BLbk;)V")
    ...
    @OriginalMember(owner = "client!hg", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Ln;Ldn;Ljava/lang/Integer;)Lqa;")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "([Ljp;I)Lvr;")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IILg;ZLvp;)Leea;")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(II[BZILg;II)Leea;")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(BLie;)I")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(ZB)Liaa;")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(ILvp;Lg;)Z")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lbg;IZI)V")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lmv;Lmv;FLmv;)Lmv;")
    public final class313 method1162(class313 arg0, class313 arg1, float arg2, class313 arg3) {
        return arg2 < 0.5F ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(BLmda;)V")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(ILbg;)I")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IIILsc;Liaa;II)V")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lg;III[BZ)Law;")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(ILraa;)I")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(ZZIILbg;)V")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "([FIIZIILg;B)Leea;")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lsc;III)V")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lft;I)I")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(BLg;Lvp;)Z")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lrq;IB)V")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lg;ILvp;)I")
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(BI)Llj;")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IZI[IIII)Leea;")
