...
public class class591 extends class539 implements class310 {
    ...
    @OriginalMember(owner = "client!am", name = "<init>", descriptor = "(Loa;Lpg;IIIIIZIIIIII)V")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ILoa;)Lww;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(BILoa;I)Z")
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(Loa;B)V")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Loa;B)V")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Loa;BI)Lba;")
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(Loa;I)Lqt;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Lji;B)Leea;")
