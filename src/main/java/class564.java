...
public class class564 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IILqa;IIZIIII)V")
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lqa;II)Z")
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(I[Luf;IIII)V")
