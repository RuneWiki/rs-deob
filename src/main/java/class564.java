...
public class class564 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IIILjava/lang/Class;)Lna;")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(ZBIIILga;[III[IIIIII)I")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(ILrda;)V")
