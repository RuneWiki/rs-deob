...
public class class564 {
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(B)Z", line = 25)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IIZIIB)V", line = 38)
    ...
    @OriginalMember(owner = "client!fa", name = "b", descriptor = "(I)I", line = 171)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lfu;Z)V", line = 187)
    ...
    @OriginalMember(owner = "client!fa", name = "c", descriptor = "(I)Lfu;", line = 210)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 235)
    ...
    @OriginalMember(owner = "client!fa", name = "d", descriptor = "(I)V", line = 246)
    ...
    @OriginalMember(owner = "client!fa", name = "e", descriptor = "(I)V", line = 268)
    ...
    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "()V", line = 373)
    public class564() {
        this.field7983.field8962 = this.field7983;
        this.field7983.field8961 = this.field7983;
    }

    @OriginalMember(owner = "client!fa", name = "b", descriptor = "(B)Lfu;", line = 284)
    ...
    @OriginalMember(owner = "client!fa", name = "f", descriptor = "(I)Lfu;", line = 301)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(BII)V", line = 321)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Z)Lfu;", line = 347)
