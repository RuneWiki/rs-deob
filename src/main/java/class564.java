...
public abstract class class564 {
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(ILf;)V")
    ...
    @OriginalMember(owner = "client!r", name = "c", descriptor = "(I)[Lpa;")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IILfa;Ljava/awt/Canvas;ILtf;)Lr;")
