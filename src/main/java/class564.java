...
public class class564 implements class552 {
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(IZ)I", line = 21)
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IIB)Z", line = 84)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IBI)V", line = 95)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(BII)V", line = 124)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(II)I", line = 147)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(III)V", line = 161)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(FFFB)I", line = 194)
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(BII)V", line = 237)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IZ)I", line = 264)
