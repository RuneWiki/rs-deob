...
public class class564 extends class354 {
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(Lwo;)V", line = 14)
    public class564(class746 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(B)I", line = 19)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!pu", name = "c", descriptor = "(II)V", line = 43)
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(II)I", line = 57)
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(ILwo;)V", line = 68)
    public class564(int arg0, class746 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!pu", name = "c", descriptor = "(I)V", line = 72)
