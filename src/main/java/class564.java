...
public class class564 extends class197 implements class394 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(IILr;B)Z")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lvj;IZLr;IIB)V")
    ...
    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(ILr;)Leh;")
    ...
    @OriginalMember(owner = "client!ie", name = "c", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lr;B)V")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lr;IIZ)Lfj;")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lr;IZ)Lda;")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lr;I)Lej;")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!ie", name = "l", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lvj;[Lam;)V")
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(Lr;Lnf;IIIIIZIIZ)V")
