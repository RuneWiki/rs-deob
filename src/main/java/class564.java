...
public class class564 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ILgj;Lgj;)V")
    ...
    @OriginalMember(owner = "client!rc", name = "<init>", descriptor = "(Lkw;ILuq;)V")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IB)Lbe;")
