...
public class class564 extends class518 {
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 4)
    public class564(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V", line = 22)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(I)V", line = 32)
    public final void method1165(int arg0) {
        field8024++;
        int var2 = -22 % ((63 - arg0) / 49);
    }

    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(I)I", line = 42)
