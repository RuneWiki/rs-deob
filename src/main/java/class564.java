...
public class class564 extends class282 {
    ...
    @OriginalMember(owner = "client!via", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(III[[ZZII)V", line = 24)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(II)V", line = 34)
    public final void method1747(int arg0, int arg1) {
        ++field7399;
    }

    @OriginalMember(owner = "client!via", name = "wa", descriptor = "(Lr;IIIIZ)V", line = 44)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(Ltn;[I)V", line = 66)
    public final void method1736(class87 arg0, int[] arg1) {
        this.field7382.method11(new class29(this.field7381, this, arg0, arg1), -106);
        ++field7410;
    }

    @OriginalMember(owner = "client!via", name = "YA", descriptor = "()V", line = 75)
    ...
    @OriginalMember(owner = "client!via", name = "fa", descriptor = "(IILr;)Lr;", line = 684)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(Z)V", line = 711)
    ...
    @OriginalMember(owner = "client!via", name = "<init>", descriptor = "(Lrv;IIII[[I[[II)V", line = 1348)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(IIIIIII[[Z)V", line = 745)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(Lr;IIIIZ)Z", line = 947)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(IBILhv;)V", line = 964)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 1023)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(III[[ZZI)V", line = 1107)
    ...
    @OriginalMember(owner = "client!via", name = "U", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 1120)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(IIIIZ[[ZII)V", line = 1204)
    ...
    @OriginalMember(owner = "client!via", name = "ka", descriptor = "(III)V", line = 1419)
    ...
    @OriginalMember(owner = "client!via", name = "CA", descriptor = "(Lr;IIIIZ)V", line = 1435)
    ...
    @OriginalMember(owner = "client!via", name = "c", descriptor = "(I)V", line = 1454)
