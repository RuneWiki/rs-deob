...
public class class564 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IB)Lsk;", line = 16)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Z)V", line = 47)
    ...
    @OriginalMember(owner = "client!br", name = "b", descriptor = "(IB)V", line = 63)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(II)Lje;", line = 80)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!br", name = "b", descriptor = "(II)I", line = 127)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(I)V", line = 138)
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Lmca;ILgga;Lgga;Lgga;)V", line = 161)
