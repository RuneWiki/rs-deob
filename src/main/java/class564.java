...
public class class564 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(BLoaa;Lkw;)V", line = 17)
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(Lkw;)V", line = 812)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ILkw;)V", line = 299)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lkw;I)V", line = 314)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ZLkw;)V", line = 329)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Ljava/lang/String;ZLuf;ZB)V", line = 342)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lkw;II)V", line = 429)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(B)V", line = 798)
