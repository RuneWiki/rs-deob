...
public class class564 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(II)V", line = 13)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Luaa;ZI)V", line = 30)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(IIIII[BI[BI)V", line = 61)
