...
public class class564 extends class337 {
    ...
    @OriginalMember(owner = "client!ij", name = "e", descriptor = "()V", line = 3)
    public static void method3213() {
        field8079 = null;
    }

    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "()V", line = 9)
    public final void method2065() {
        field8079.method3723(this.field8078, true);
    }

    @OriginalMember(owner = "client!ij", name = "b", descriptor = "()V", line = 12)
    public final void method2070() {
        field8079.method3720(this.field8078, -991);
    }

    @OriginalMember(owner = "client!ij", name = "d", descriptor = "()V", line = 15)
    public final void method2077() {
        field8079.method3722(this.field8078, super.field4821);
    }

    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ij", name = "c", descriptor = "()I", line = 24)
    public final int method2075() {
        return field8079.method3724(8703, this.field8078);
    }

    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "(Lae;I)V", line = 27)
