...
public class class564 {
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "()V", line = 4)
    public static void method3183() {
        field7897 = null;
        field7899 = null;
    }

    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(F)F", line = 9)
    private static final float method3184(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(IF)I", line = 22)
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(IIF)F", line = 84)
    ...
    @OriginalMember(owner = "client!uia", name = "b", descriptor = "(IIF)F", line = 97)
    ...
    @OriginalMember(owner = "client!uia", name = "a", descriptor = "(Ltn;Lud;)V", line = 109)
