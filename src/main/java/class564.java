...
public class class564 {
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Lha;BI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Z)V", line = 85)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IIIIIIIILha;I)V", line = 124)
    ...
    @OriginalMember(owner = "client!tr", name = "<init>", descriptor = "(I[Lvw;IIII)V", line = 351)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IIIILnf;)Z", line = 225)
