...
public class class564 extends class588 {
    ...
    @OriginalMember(owner = "client!raa", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!raa", name = "b", descriptor = "(II)I", line = 16)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(FI[FFFIIIIIF)V", line = 19)
    ...
    @OriginalMember(owner = "client!raa", name = "<init>", descriptor = "(I)V", line = 123)
