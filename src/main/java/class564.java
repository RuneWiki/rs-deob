...
public class class564 {
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(ILfl;)Ljt;", line = 19)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(B)Lrfa;", line = 44)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(ILvia;)Z", line = 67)
    ...
    @OriginalMember(owner = "client!via", name = "b", descriptor = "(I)V", line = 83)
