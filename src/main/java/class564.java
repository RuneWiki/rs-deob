...
public class class564 {
    ...
    @OriginalMember(owner = "client!og", name = "finalize", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(III)B", line = 25)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "([BZI)V", line = 43)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IB)V", line = 84)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Lpea;J[Lpc;)V", line = 121)
    public class564(class641 arg0, long arg1, class216[] arg2) {
        this.field7722 = arg0;
        this.field7719 = arg1;
    }

    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IIIIIII)V", line = 133)
