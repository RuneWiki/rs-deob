...
public class class564 {
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!kfa", name = "b", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!kfa", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 44)
    public class564(IDirect3DSwapChain arg0, IDirect3DSurface arg1) {
        this.method3094(0, arg1, arg0);
    }

    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(ILjagdx/IDirect3DSurface;Ljagdx/IDirect3DSwapChain;)V", line = 53)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(IB)I", line = 62)
