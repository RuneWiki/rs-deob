...
public class class564 {
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Lha;III)Z")
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(ILha;ZI)V")
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Les;B)Ljs;")
    ...
    @OriginalMember(owner = "client!iu", name = "b", descriptor = "(Lha;III)V")
    ...
    @OriginalMember(owner = "client!iu", name = "<init>", descriptor = "(Lqj;Ldga;)V")
