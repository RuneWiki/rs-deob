...
public class class564 extends class531 {
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(Lqfa;Lgo;)V")
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IIILha;BIIIIIILjga;)V")
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IZLdca;)V")
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(Lmea;I)V")
