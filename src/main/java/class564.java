...
public class class564 extends class244 implements class614 {
    ...
    @OriginalMember(owner = "client!lj", name = "m", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(I)I", line = 18)
    public final int method1175(int arg0) {
        ++field7947;
        return arg0 != 24563 ? -67 : this.field7959.field151;
    }

    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ILr;)V", line = 31)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lr;I)V", line = 55)
    ...
    @OriginalMember(owner = "client!lj", name = "h", descriptor = "(I)Z", line = 70)
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(Lr;Let;IIIIIZIII)V", line = 82)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IZLr;Lrga;IIZ)V", line = 93)
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(ILr;)Lnu;", line = 104)
    public final class548 method1183(int arg0, class166 arg1) {
        ++field7943;
        return arg0 != 6433 ? null : this.field7955;
    }

    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lr;Z)V", line = 115)
    ...
    @OriginalMember(owner = "client!lj", name = "f", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!lj", name = "i", descriptor = "(I)Z", line = 140)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;", line = 154)
    ...
    @OriginalMember(owner = "client!lj", name = "d", descriptor = "(I)Z", line = 177)
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(Lr;Z)Lkq;", line = 190)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(B)I", line = 242)
    ...
    @OriginalMember(owner = "client!lj", name = "j", descriptor = "(I)Z", line = 256)
    public final boolean method951(int arg0) {
        ++field7956;
        return arg0 > -26;
    }

    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IILr;I)Z", line = 271)
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(I)I", line = 291)
    ...
    @OriginalMember(owner = "client!lj", name = "c", descriptor = "(I)V", line = 302)
    ...
    @OriginalMember(owner = "client!lj", name = "g", descriptor = "(I)I", line = 313)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Z)I", line = 324)
