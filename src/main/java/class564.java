...
public class class564 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ILib;)V", line = 15)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IIBZ)I", line = 35)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ZLla;)V", line = 68)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lib;BI)V", line = 98)
