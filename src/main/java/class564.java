...
public class class564 extends class238 {
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ILjagtheora/ogg/OggPacket;)V", line = 29)
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 40)
