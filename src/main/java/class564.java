...
public class class564 implements class142 {
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(B)J", line = 3)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(III)Z", line = 36)
    ...
    @OriginalMember(owner = "client!mfa", name = "b", descriptor = "(B)V", line = 53)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(ILva;I)V", line = 263)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(Lwea;I)Z", line = 334)
