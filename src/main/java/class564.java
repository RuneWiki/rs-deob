...
public abstract class class564 extends class49 {
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Lns;I)V")
    ...
    @OriginalMember(owner = "client!aw", name = "d", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "(Lwt;I)V")
