...
public class class564 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lha;Lcm;)Z", line = 5)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "()V", line = 41)
    public static final void method3309() {
        field7827 = null;
        field7828 = null;
    }

    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(Lha;Lcm;)V", line = 47)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lha;)V", line = 134)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IIII)Z", line = 200)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "()V", line = 256)
    public final void method3313() {
        this.field7835 = null;
    }

    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(Lha;)V", line = 266)
    ...
    @OriginalMember(owner = "client!cm", name = "c", descriptor = "()V", line = 345)
    ...
    @OriginalMember(owner = "client!cm", name = "c", descriptor = "(Lha;Lcm;)Z", line = 357)
    public final boolean method3316(class548 arg0, class564 arg1) {
        return this.field7835 != null || this.method3308(arg0, arg1);
    }

    @OriginalMember(owner = "client!cm", name = "d", descriptor = "(Lha;Lcm;)V", line = 364)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lha;IIIIII)V", line = 449)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 472)
