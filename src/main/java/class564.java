...
public class class564 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(ILaj;IB)Leia;", line = 9)
    ...
    @OriginalMember(owner = "client!ur", name = "toString", descriptor = "()Ljava/lang/String;", line = 25)
    public final String toString() {
        field7554++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IIZIILha;ILjava/lang/String;)V", line = 40)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IIB)I", line = 98)
