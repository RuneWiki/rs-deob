...
public class class564 extends class362 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Lha;BJ)V", line = 22)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IIZ)Z", line = 56)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(I)V", line = 84)
