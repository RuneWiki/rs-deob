...
public class class564 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(I)[Lsq;")
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(ILig;)V")
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(IILig;)V")
