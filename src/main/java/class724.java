...
public class class724 {
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!sea", name = "b", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(IIZII)V", line = 40)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(IB)V", line = 56)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(ZI)Lur;", line = 71)
    ...
    @OriginalMember(owner = "client!sea", name = "<init>", descriptor = "(Lkw;ILuq;)V", line = 103)
