...
public class class724 extends class13 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(BLha;I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(BIII)V", line = 309)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IILrba;Lha;ZII)V", line = 337)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(ZZ)Ljava/lang/String;", line = 350)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Z)I", line = 398)
    public final int method96(boolean arg0) {
        ++field10100;
        return !arg0 ? 11 : this.field10089;
    }

    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Lha;Lka;IIIIILpda;)V", line = 413)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(III)V", line = 443)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IZ)Ljava/lang/String;", line = 469)
    ...
    @OriginalMember(owner = "client!rl", name = "f", descriptor = "(B)V", line = 489)
    ...
    @OriginalMember(owner = "client!rl", name = "f", descriptor = "(I)Z", line = 504)
    public final boolean method759(int arg0) {
        ++field10061;
        return arg0 != 0 ? false : false;
    }

    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IIBB)V", line = 519)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Lha;I)V", line = 573)
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(B)I", line = 599)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IILka;IILha;ILpda;I)V", line = 616)
    ...
    @OriginalMember(owner = "client!rl", name = "j", descriptor = "(B)Z", line = 671)
    ...
    @OriginalMember(owner = "client!rl", name = "m", descriptor = "(I)V", line = 689)
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(Lha;I)Ljk;", line = 898)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(I)I", line = 1107)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Lsl;Z)V", line = 1118)
    ...
    @OriginalMember(owner = "client!rl", name = "n", descriptor = "(I)V", line = 1317)
    ...
    @OriginalMember(owner = "client!rl", name = "d", descriptor = "(ILha;)Lwg;", line = 1342)
    public final class428 method750(int arg0, class60 arg1) {
        ++field10082;
        return arg0 >= -22 ? null : null;
    }

    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(BILha;I)Z", line = 1363)
