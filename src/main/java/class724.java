...
public class class724 extends class185 {
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(B)Lbja;", line = 15)
    ...
    @OriginalMember(owner = "client!jha", name = "e", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(ZLtaa;)V", line = 90)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(ILjava/lang/String;)V", line = 102)
    ...
    @OriginalMember(owner = "client!jha", name = "<init>", descriptor = "(Lhk;IIIIII)V", line = 163)
