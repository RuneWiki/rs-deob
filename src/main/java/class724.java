...
public class class724 extends class120 {
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!aca", name = "e", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(I)Lhs;", line = 594)
    ...
    @OriginalMember(owner = "client!aca", name = "<init>", descriptor = "(Lkda;Lcu;IIIIIIIII)V", line = 605)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(B)[Lse;", line = 616)
