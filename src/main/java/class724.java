...
public class class724 extends class203 {
    ...
    @OriginalMember(owner = "client!lja", name = "b", descriptor = "(IZ)I", line = 6)
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(BZ)V", line = 44)
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(IIZ)V", line = 74)
    ...
    @OriginalMember(owner = "client!lja", name = "<init>", descriptor = "(Lpq;Lsa;)V", line = 109)
    ...
    @OriginalMember(owner = "client!lja", name = "c", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!lja", name = "b", descriptor = "(I)Z", line = 141)
    public final boolean method687(int arg0) {
        ++field10019;
        return arg0 != -12 ? false : false;
    }

    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(ZB)V", line = 162)
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(IZLwha;)V", line = 195)
