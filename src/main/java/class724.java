...
public class class724 extends class540 {
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(IBI)Z", line = 13)
    ...
    @OriginalMember(owner = "client!sea", name = "<init>", descriptor = "(Loga;)V", line = 104)
    public class724(class497 arg0) {
        this.field10157 = arg0;
    }

    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(Z)V", line = 49)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(IIZIIBIIF)[[I", line = 63)
