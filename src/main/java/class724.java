...
public abstract class class724 implements class132 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IIII[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(BLqt;)V", line = 111)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Z)V", line = 127)
    ...
    @OriginalMember(owner = "client!v", name = "b", descriptor = "(Z)I", line = 165)
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(Ljc;ILtn;Lds;IZ)V", line = 546)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(II)V", line = 181)
    ...
    @OriginalMember(owner = "client!v", name = "d", descriptor = "(I)I", line = 193)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(II[FII)V", line = 291)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(B)V", line = 389)
    ...
    @OriginalMember(owner = "client!v", name = "finalize", descriptor = "()V", line = 420)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "([BIBII)V", line = 429)
    ...
    @OriginalMember(owner = "client!v", name = "e", descriptor = "(I)V", line = 525)
