...
public class class724 extends class644 implements class324 {
    ...
    @OriginalMember(owner = "client!gu", name = "c", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(I)I", line = 18)
    public final int method606(int arg0) {
        ++field10184;
        return arg0 >= -32 ? -94 : this.field10191;
    }

    @OriginalMember(owner = "client!gu", name = "j", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IIIIIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IZZLha;)Lmg;", line = 112)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(I)Z", line = 145)
    public final boolean method611(int arg0) {
        ++field10189;
        return arg0 != 15795 ? false : this.field10176;
    }

    @OriginalMember(owner = "client!gu", name = "d", descriptor = "(B)I", line = 163)
    ...
    @OriginalMember(owner = "client!gu", name = "g", descriptor = "(B)Z", line = 176)
    ...
    @OriginalMember(owner = "client!gu", name = "e", descriptor = "(B)Z", line = 191)
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(Lha;Lrq;IIIIIZIZ)V", line = 205)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IIILha;)Z", line = 238)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Lha;Z)V", line = 260)
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(BLha;)V", line = 291)
    ...
    @OriginalMember(owner = "client!gu", name = "e", descriptor = "(I)V", line = 302)
    ...
    @OriginalMember(owner = "client!gu", name = "k", descriptor = "(I)V", line = 319)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Lha;I)V", line = 410)
    ...
    @OriginalMember(owner = "client!gu", name = "g", descriptor = "(I)I", line = 439)
    ...
    @OriginalMember(owner = "client!gu", name = "c", descriptor = "(BLha;)Lro;", line = 450)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(BLha;)Lqs;", line = 467)
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(B)I", line = 497)
    public final int method604(byte arg0) {
        ++field10168;
        return arg0 != 94 ? 125 : 22;
    }

    @OriginalMember(owner = "client!gu", name = "d", descriptor = "(I)Z", line = 509)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ILha;Z)Lka;", line = 522)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(B)I", line = 539)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ILjw;Lha;BIZI)V", line = 551)
