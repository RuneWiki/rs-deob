...
public class class724 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!wc", name = "b", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(BI)Lij;", line = 44)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(II)V", line = 80)
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(Lcr;ILla;Lla;)V", line = 131)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "([J[Ljava/lang/Object;B)V", line = 119)
