...
public abstract class class724 extends class299 {
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(ILpda;)I", line = 8)
    ...
    @OriginalMember(owner = "client!sea", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(B)V", line = 34)
