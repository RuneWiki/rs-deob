...
public class class724 extends class66 implements class559 {
    ...
    @OriginalMember(owner = "client!oa", name = "g", descriptor = "(IIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!oa", name = "g", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Z)V", line = 24)
    public final void method586(boolean arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 27)
    ...
    @OriginalMember(owner = "client!oa", name = "f", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lsea;Lup;)Lnm;", line = 51)
    public final class499 method70(class726 arg0, class292 arg1) {
        return new class638(this, (class568) arg0, (class528) arg1);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[I[I)Laa;", line = 54)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lza;)V", line = 57)
    public final void method581(class435 arg0) {
        this.field10147 = (class59) arg0;
        this.method4094(arg0);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I)V", line = 62)
    public final void method584(int arg0) {
        this.field10165[arg0].method3622();
    }

    @OriginalMember(owner = "client!oa", name = "r", descriptor = "()Z", line = 65)
    public final boolean method622() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(I)Lza;", line = 70)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(II)Lup;", line = 78)
    public final class292 method52(int arg0, int arg1) {
        return new class528(arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "m", descriptor = "()Z", line = 82)
    public final boolean method604() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Laf;)V", line = 85)
    ...
    @OriginalMember(owner = "client!oa", name = "o", descriptor = "()Lub;", line = 93)
    public final class22 method60() {
        return new class22(0, "SSE", 1, "CPU", 0L);
    }

    @OriginalMember(owner = "client!oa", name = "d", descriptor = "()Lnh;", line = 96)
    public final class778 method574() {
        return this.field10153;
    }

    @OriginalMember(owner = "client!oa", name = "g", descriptor = "()V", line = 101)
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(II)I", line = 108)
    public final int method632(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!oa", name = "n", descriptor = "()Z", line = 111)
    public final boolean method612() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[[I[[IIII)Ls;", line = 115)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZ)Ltf;", line = 119)
    public final class312 method638(int arg0, int arg1, boolean arg2) {
        return new class568(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(II)I", line = 124)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 130)
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ld;II)V", line = 144)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II)Lsea;", line = 171)
    public final class726 method44(int arg0, int arg1) {
        return this.method638(arg0, arg1, false);
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(II)V", line = 174)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Laf;I)V", line = 184)
    public final void method590(class460 arg0, int arg1) {
        this.method4101(arg0, false);
        this.method4103().method3614(this, field10154, field10158, field10151, field10160, arg0.field6472.method1058(-28700));
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "()Z", line = 194)
    public final boolean method71() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lnm;)V", line = 201)
    ...
    @OriginalMember(owner = "client!oa", name = "h", descriptor = "()V", line = 204)
    public final void method25() {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIII)V", line = 208)
    public final void method40(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILaa;II)V", line = 211)
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(I)V", line = 217)
    public final void method589(int arg0) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[Lkp;)V", line = 225)
    ...
    @OriginalMember(owner = "client!oa", name = "l", descriptor = "()Z", line = 244)
    public final boolean method603() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "A", descriptor = "()V", line = 247)
    public final void method647() {
    }

    @OriginalMember(owner = "client!oa", name = "t", descriptor = "()V", line = 250)
    public final void method20() {
        this.method627(this.field10155.field2766);
    }

    @OriginalMember(owner = "client!oa", name = "OA", descriptor = "()Ljava/lang/Object;", line = 254)
    private final Object method4100() {
        return new class407(this);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIII)V", line = 256)
    public final void method613(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIZ)Ltf;", line = 259)
    ...
    @OriginalMember(owner = "client!oa", name = "j", descriptor = "()Z", line = 262)
    public final boolean method599() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Laf;Z)V", line = 266)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljia;)V", line = 297)
    public final void method558(class645 arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILaa;IIIII)V", line = 299)
    ...
    @OriginalMember(owner = "client!oa", name = "WA", descriptor = "(S)Z", line = 303)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIII)V", line = 329)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Ljava/awt/Canvas;II)V", line = 336)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lnh;)V", line = 363)
    public final void method628(class778 arg0) {
        this.field10153 = arg0;
        this.method4096(((class294) arg0).nativeid);
    }

    @OriginalMember(owner = "client!oa", name = "k", descriptor = "()Z", line = 367)
    public final boolean method601() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "s", descriptor = "()Z", line = 370)
    public final boolean method625() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Z)V", line = 372)
    public final void method31(boolean arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "B", descriptor = "()La;", line = 378)
    ...
    @OriginalMember(owner = "client!oa", name = "w", descriptor = "()Z", line = 392)
    public final boolean method639() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "y", descriptor = "()Z", line = 396)
    public final boolean method646() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIIIIIII)V", line = 400)
    ...
    @OriginalMember(owner = "client!oa", name = "q", descriptor = "()V", line = 407)
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "()Lnh;", line = 439)
    public final class778 method576() {
        return this.field10161;
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(S)Z", line = 442)
    ...
    @OriginalMember(owner = "client!oa", name = "u", descriptor = "()Z", line = 453)
    public final boolean method629() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "()V", line = 459)
    public final void method2() {
    }

    @OriginalMember(owner = "client!oa", name = "p", descriptor = "()Lnh;", line = 462)
    public final class778 method614() {
        return new class294();
    }

    @OriginalMember(owner = "client!oa", name = "finalize", descriptor = "()V", line = 465)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lso;IIII)Lka;", line = 471)
    ...
    @OriginalMember(owner = "client!oa", name = "v", descriptor = "()Z", line = 474)
    public final boolean method54() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(I)V", line = 477)
    public final void method605(int arg0) {
        this.field10165[arg0].method3627();
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/awt/Canvas;II)V", line = 483)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "()Z", line = 491)
    public final boolean method561() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lcr;Z)Ltf;", line = 497)
    ...
    @OriginalMember(owner = "client!oa", name = "z", descriptor = "()V", line = 501)
    public final void method36() {
    }

    @OriginalMember(owner = "client!oa", name = "i", descriptor = "(I)V", line = 508)
    ...
    @OriginalMember(owner = "client!oa", name = "f", descriptor = "()I", line = 521)
    public final int method583() {
        return 4;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljia;Ljia;FLjia;)Ljia;", line = 530)
    public final class645 method65(class645 arg0, class645 arg1, float arg2, class645 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "x", descriptor = "()V", line = 540)
    public final void method32() {
    }

    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(IIIIII)Ljia;", line = 546)
    public final class645 method611(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIII)V", line = 550)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([I)V", line = 566)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lbq;[Lcr;Z)Lda;", line = 573)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([IIIIIZ)Ltf;", line = 611)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 614)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(FFF)V", line = 628)
    public final void method61(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIF)Lkp;", line = 642)
