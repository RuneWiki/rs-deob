...
public class class724 implements class279 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Lig;)V")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ILjava/awt/Canvas;ILd;)Lha;")
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(Lii;Lcw;Lst;)V")
