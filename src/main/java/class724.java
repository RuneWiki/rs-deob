...
public class class724 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(BI)V", line = 19)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IB)Lkt;", line = 31)
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "(Lms;ILwu;)V", line = 65)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(II)I", line = 83)
    public static final int method4078(int arg0, int arg1) {
        field10085++;
        return arg0 == 7600775 ? arg1 >>> 7 : -98;
    }

    @OriginalMember(owner = "client!wn", name = "b", descriptor = "(I)V", line = 94)
