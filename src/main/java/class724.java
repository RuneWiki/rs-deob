...
public class class724 implements Runnable {
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "([BLnw;BI)Lqh;")
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(Lqh;I)V")
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(Lnw;IB)Lqh;")
    ...
    @OriginalMember(owner = "client!aca", name = "b", descriptor = "(Lnw;IB)Lqh;")
    ...
    @OriginalMember(owner = "client!aca", name = "<init>", descriptor = "(Lwea;)V")
