...
public class class724 extends class65 implements class559 {
    ...
    @OriginalMember(owner = "client!oa", name = "A", descriptor = "()V", line = 2)
    public final void method568() {
    }

    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(IIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(II)Lbfa;", line = 13)
    public final class390 method528(int arg0, int arg1) {
        return this.method508(arg0, arg1, false);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ldn;Ldn;FLdn;)Ldn;", line = 17)
    public final class544 method497(class544 arg0, class544 arg1, float arg2, class544 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lbfa;Ltq;)Lvv;", line = 20)
    public final class345 method566(class390 arg0, class656 arg1) {
        return new class638(this, (class568) arg0, (class529) arg1);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(FFF)V", line = 22)
    public final void method512(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!oa", name = "w", descriptor = "()Z", line = 25)
    public final boolean method542() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(I)V", line = 28)
    public final void method493(int arg0) {
        this.field10096[arg0].method3594();
    }

    @OriginalMember(owner = "client!oa", name = "g", descriptor = "()V", line = 33)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/awt/Canvas;II)V", line = 39)
    ...
    @OriginalMember(owner = "client!oa", name = "p", descriptor = "()V", line = 48)
    public final void method511() {
        this.method460(this.field10093.field3149);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II)I", line = 53)
    public final int method498(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!oa", name = "y", descriptor = "()Z", line = 57)
    public final boolean method560() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "q", descriptor = "()Z", line = 60)
    public final boolean method513() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lef;)V", line = 65)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILaa;IIIII)V", line = 71)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([I)V", line = 75)
    ...
    @OriginalMember(owner = "client!oa", name = "f", descriptor = "()Luu;", line = 81)
    public final class303 method472() {
        return new class294();
    }

    @OriginalMember(owner = "client!oa", name = "u", descriptor = "()Z", line = 85)
    public final boolean method534() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[I[I)Laa;", line = 90)
    ...
    @OriginalMember(owner = "client!oa", name = "r", descriptor = "()Z", line = 97)
    public final boolean method519() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "()I", line = 103)
    public final int method451() {
        return 4;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lgfa;IIII)Lka;", line = 108)
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(II)I", line = 115)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lef;Z)V", line = 123)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIII)V", line = 152)
    public final void method516(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Z)V", line = 156)
    public final void method531(boolean arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[[I[[IIII)Ls;", line = 159)
    ...
    @OriginalMember(owner = "client!oa", name = "g", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!oa", name = "k", descriptor = "()Z", line = 175)
    public final boolean method485() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lza;)V", line = 179)
    public final void method449(class437 arg0) {
        this.field10075 = (class58) arg0;
        this.method4030(arg0);
    }

    @OriginalMember(owner = "client!oa", name = "B", descriptor = "()La;", line = 186)
    ...
    @OriginalMember(owner = "client!oa", name = "x", descriptor = "()Lcja;", line = 199)
    public final class45 method558() {
        return new class45(0, "SSE", 1, "CPU", 0L);
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 202)
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ld;II)V", line = 414)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I)V", line = 219)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIZ)Lvr;", line = 227)
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(IIIIII)V", line = 233)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILaa;II)V", line = 243)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 247)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "()Luu;", line = 258)
    public final class303 method450() {
        return this.field10085;
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "()Z", line = 263)
    public final boolean method461() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(I)Lza;", line = 268)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lef;I)V", line = 274)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ldn;)V", line = 278)
    public final void method473(class544 arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(II)V", line = 282)
    ...
    @OriginalMember(owner = "client!oa", name = "OA", descriptor = "()Ljava/lang/Object;", line = 294)
    private final Object method4042() {
        return new class409(this);
    }

    @OriginalMember(owner = "client!oa", name = "f", descriptor = "(I)V", line = 297)
    public final void method506(int arg0) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(IIIIII)Ldn;", line = 300)
    public final class544 method467(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "h", descriptor = "(I)V", line = 303)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Leia;[Leu;Z)Lda;", line = 318)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Ljava/awt/Canvas;II)V", line = 356)
    ...
    @OriginalMember(owner = "client!oa", name = "l", descriptor = "()Z", line = 379)
    public final boolean method491() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIIIIIII)V", line = 383)
    ...
    @OriginalMember(owner = "client!oa", name = "n", descriptor = "()Z", line = 386)
    public final boolean method501() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "m", descriptor = "()V", line = 388)
    public final void method500() {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([IIIIIZ)Lvr;", line = 391)
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "()V", line = 395)
    public final void method468() {
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(I)V", line = 400)
    public final void method469(int arg0) {
        this.field10096[arg0].method3593();
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lvv;)V", line = 404)
    ...
    @OriginalMember(owner = "client!oa", name = "j", descriptor = "()Z", line = 408)
    public final boolean method484() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "WA", descriptor = "(S)Z", line = 441)
    ...
    @OriginalMember(owner = "client!oa", name = "s", descriptor = "()Z", line = 465)
    public final boolean method522() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "d", descriptor = "()V", line = 468)
    ...
    @OriginalMember(owner = "client!oa", name = "o", descriptor = "()V", line = 499)
    public final void method503() {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[Luca;)V", line = 503)
    ...
    @OriginalMember(owner = "client!oa", name = "h", descriptor = "()Z", line = 522)
    public final boolean method478() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(II)Ltq;", line = 527)
    public final class656 method536(int arg0, int arg1) {
        return new class529(arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIII)V", line = 530)
    ...
    @OriginalMember(owner = "client!oa", name = "t", descriptor = "()V", line = 537)
    public final void method529() {
    }

    @OriginalMember(owner = "client!oa", name = "z", descriptor = "()Luu;", line = 541)
    public final class303 method565() {
        return this.field10086;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Leu;Z)Lvr;", line = 545)
    ...
    @OriginalMember(owner = "client!oa", name = "finalize", descriptor = "()V", line = 550)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Luu;)V", line = 556)
    public final void method526(class303 arg0) {
        this.field10086 = arg0;
        this.method4034(((class294) arg0).nativeid);
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(S)Z", line = 561)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIII)V", line = 574)
    public final void method507(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
    }

    @OriginalMember(owner = "client!oa", name = "v", descriptor = "()Z", line = 577)
    public final boolean method535() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 581)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZ)Lvr;", line = 596)
    public final class147 method508(int arg0, int arg1, boolean arg2) {
        return new class568(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIF)Luca;", line = 615)
