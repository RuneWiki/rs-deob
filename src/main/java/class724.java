...
public class class724 {
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(BJ)V", line = 8)
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(IIZ)Z", line = 45)
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(Luh;B)V", line = 57)
    ...
    @OriginalMember(owner = "client!lja", name = "<init>", descriptor = "(Z)V", line = 152)
    public class724(boolean arg0) {
        this.field10095 = arg0;
    }

    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(Z)V", line = 131)
