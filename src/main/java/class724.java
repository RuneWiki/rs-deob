...
public class class724 extends class243 {
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "()V", line = 3)
    public class724() {
        super(0, false);
    }

    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(FBFF)F", line = 6)
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "(II)[[I", line = 17)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(B)I", line = 88)
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(Lha;II)Z", line = 112)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ILji;B)V", line = 558)
