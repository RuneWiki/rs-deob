...
public class class664 extends IOException {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "([BIIII[BIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 67)
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 78)
