...
public class class664 {
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Lha;IIIIIIZZ)V", line = 41)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IIIIZ)Laj;", line = 162)
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 204)
