...
public abstract class class664 implements class619 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!lc", name = "e", descriptor = "(I)I", line = 37)
    ...
    @OriginalMember(owner = "client!lc", name = "finalize", descriptor = "()V", line = 135)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(I[FIBI)V", line = 157)
    ...
    @OriginalMember(owner = "client!lc", name = "f", descriptor = "(I)I", line = 257)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(ZI)I", line = 269)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(I[[[BIBII)V", line = 280)
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "(Lmc;ILnl;Leea;IZ)V", line = 703)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Ltd;B)V", line = 418)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(II)V", line = 434)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(B[BIII)V", line = 446)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "([IIIII)V", line = 543)
    ...
    @OriginalMember(owner = "client!lc", name = "g", descriptor = "(I)V", line = 653)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(I)V", line = 676)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(ILfca;)V", line = 723)
