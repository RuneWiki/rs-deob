...
public class class664 {
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;I)Ljava/io/File;", line = 4)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/io/File;", line = 103)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(IILjava/lang/String;)V", line = 118)
