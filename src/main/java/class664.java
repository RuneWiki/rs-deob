...
public class class664 extends class557 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Ltn;I)V")
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(BLdt;)V")
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "([[BLcc;I)V")
