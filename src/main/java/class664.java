...
public class class664 implements class722 {
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(IJ)Z", line = 3)
    ...
    @OriginalMember(owner = "client!rda", name = "b", descriptor = "(I)I", line = 16)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(II)I", line = 42)
    ...
    @OriginalMember(owner = "client!rda", name = "c", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(Z)V", line = 104)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(IB)I", line = 114)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;I)Ljava/lang/Object;", line = 133)
    ...
    @OriginalMember(owner = "client!rda", name = "b", descriptor = "(Z)V", line = 149)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(B)I", line = 163)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(BZ)V", line = 174)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Object;Ljava/lang/Class;)I", line = 365)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/String;I)Z", line = 397)
    ...
    @OriginalMember(owner = "client!rda", name = "d", descriptor = "(I)V", line = 410)
