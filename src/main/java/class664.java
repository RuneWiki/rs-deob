...
public class class664 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(IIIIIIIILoa;)V", line = 70)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ZII)V", line = 220)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(B)V", line = 237)
