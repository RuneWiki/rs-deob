...
public class class664 {
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(IILha;IIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "()V", line = 142)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!qt", name = "b", descriptor = "(I)V", line = 171)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(II)V", line = 182)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/Throwable;)V", line = 192)
