...
public class class664 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(IB)V", line = 26)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!cm", name = "c", descriptor = "(IB)Lbfa;", line = 71)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ZI)V", line = 122)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(B)V", line = 137)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(II)V", line = 164)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Ljda;IZLjo;Ljo;)V", line = 238)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(I)V", line = 183)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(ZI)V", line = 195)
