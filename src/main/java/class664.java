...
public class class664 {
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IIII)I", line = 5)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(ILjava/lang/String;)J", line = 34)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IIIILr;Ljs;)V", line = 90)
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(B)V", line = 148)
