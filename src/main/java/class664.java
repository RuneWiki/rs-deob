...
public class class664 extends class60 implements class532 {
    ...
    @OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Loa;Lya;Loea;[Lrh;[Lmi;)V", line = 4)
    ...
    @OriginalMember(owner = "client!h", name = "finalize", descriptor = "()V", line = 31)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(CIIIZLaa;II)V", line = 38)
