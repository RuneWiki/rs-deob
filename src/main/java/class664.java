...
public class class664 extends class393 {
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Lum;Lfo;[Lut;Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!me", name = "OA", descriptor = "(CIIIZ)V", line = 309)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(CIIIZLua;II)V", line = 331)
