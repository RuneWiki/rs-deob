...
public class class664 {
    ...
    @OriginalMember(owner = "client!aga", name = "<init>", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(ILig;)Lac;", line = 19)
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(Z)V", line = 32)
