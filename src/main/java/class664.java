...
public class class664 extends class99 {
    ...
    @OriginalMember(owner = "client!qca", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(Z)Ljava/lang/Object;", line = 16)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(IC)Z", line = 27)
    ...
    @OriginalMember(owner = "client!qca", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 63)
    public class664(Object arg0, int arg1) {
        super(arg1);
        this.field9453 = arg0;
    }

    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(IIIZI)I", line = 76)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(I)Z", line = 91)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(IIIBI)V", line = 106)
