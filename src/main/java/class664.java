...
public class class664 {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(II)Lua;", line = 56)
    ...
    @OriginalMember(owner = "client!ua", name = "<init>", descriptor = "(IILdr;)V", line = 130)
    ...
    @OriginalMember(owner = "client!ua", name = "toString", descriptor = "()Ljava/lang/String;", line = 146)
