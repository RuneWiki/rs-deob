...
public class class664 extends class165 {
    ...
    @OriginalMember(owner = "client!ar", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(B)Z", line = 16)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IBI)V", line = 29)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(III)Z", line = 50)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lvj;I)Lwia;", line = 62)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lep;)V", line = 94)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IZLhl;)V", line = 207)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(I)V", line = 221)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ZI)V", line = 291)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IZ)V", line = 302)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(B)V", line = 329)
