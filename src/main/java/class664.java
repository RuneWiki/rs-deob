...
public class class664 extends class69 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IBI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(BLjava/awt/Canvas;)V", line = 16)
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "()V", line = 42)
    public class664() {
    }

    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(J)V", line = 47)
    public class664(long arg0) {
        this.field9333 = arg0;
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(I)V", line = 55)
