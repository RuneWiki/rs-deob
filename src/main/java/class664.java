...
public class class664 extends class522 {
    ...
    @OriginalMember(owner = "client!pca", name = "<init>", descriptor = "()V", line = 11)
    public class664() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!pca", name = "d", descriptor = "(III)Z", line = 14)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(ILjava/awt/Canvas;)Lih;", line = 26)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(IIBI)[B", line = 48)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(II)I", line = 62)
    ...
    @OriginalMember(owner = "client!pca", name = "g", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!pca", name = "e", descriptor = "(III)Z", line = 103)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(IIB)V", line = 118)
