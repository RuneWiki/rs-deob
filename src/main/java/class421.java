...
public abstract class class421 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Lnn;I)Lej;", line = 3)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(Lwi;IIB)V", line = 45)
    ...
    @OriginalMember(owner = "client!vs", name = "e", descriptor = "(I)V", line = 787)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(ZILha;)V", line = 806)
    ...
    @OriginalMember(owner = "client!vs", name = "g", descriptor = "(I)V", line = 824)
