...
public class class421 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IB[BI)V", line = 8)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(I)J", line = 131)
    public final long method2579(int arg0) {
        field5941++;
        return arg0 >= -15 ? 0L : this.field5947;
    }

    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(B)V", line = 154)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(JZ)V", line = 165)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(B[B)V", line = 180)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(I[BIB)V", line = 237)
    ...
    @OriginalMember(owner = "client!ij", name = "c", descriptor = "(B)V", line = 423)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Z)V", line = 503)
    ...
    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "(Lsga;II)V", line = 554)
    ...
    @OriginalMember(owner = "client!ij", name = "b", descriptor = "(I)Ljava/io/File;", line = 524)
