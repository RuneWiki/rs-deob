...
public class class421 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IZ)Lfda;")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lno;II)Z")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(ILsa;)V")
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(Loda;ILdda;)V")
