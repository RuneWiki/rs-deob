...
public class class421 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Ljava/lang/String;)I", line = 4)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Lr;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 20)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "()I", line = 108)
    public final int method2547() {
        return this.field6189;
    }

    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Lr;Ljava/lang/String;[IIIIZ)V", line = 111)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "()I", line = 132)
    public final int method2549() {
        return this.field6195 - 1;
    }

    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Lr;Ljava/lang/String;IIIZ)V", line = 136)
    ...
    @OriginalMember(owner = "client!ks", name = "c", descriptor = "()V", line = 158)
    public static void method2551() {
        field6192 = null;
    }

    @OriginalMember(owner = "client!ks", name = "<init>", descriptor = "(Lr;IZLjava/awt/Component;)V", line = 192)
