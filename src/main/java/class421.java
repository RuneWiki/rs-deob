...
public class class421 extends class736 implements class362 {
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Lha;Ldja;IIIIIZIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(Lha;B)Lpw;", line = 37)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ILha;)V", line = 53)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Z)I", line = 80)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IZILha;)Luf;", line = 91)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ILsf;Lha;BIIZ)V", line = 121)
    ...
    @OriginalMember(owner = "client!ns", name = "j", descriptor = "(I)I", line = 144)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IZLha;I)Z", line = 155)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lha;II)Lka;", line = 176)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(B)Z", line = 197)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(B)I", line = 216)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(I)Z", line = 238)
    ...
    @OriginalMember(owner = "client!ns", name = "c", descriptor = "(I)V", line = 251)
    ...
    @OriginalMember(owner = "client!ns", name = "c", descriptor = "(B)Z", line = 267)
    ...
    @OriginalMember(owner = "client!ns", name = "g", descriptor = "(I)I", line = 288)
    ...
    @OriginalMember(owner = "client!ns", name = "i", descriptor = "(I)V", line = 300)
    ...
    @OriginalMember(owner = "client!ns", name = "c", descriptor = "(Z)V", line = 315)
    ...
    @OriginalMember(owner = "client!ns", name = "h", descriptor = "(I)Z", line = 330)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lha;I)V", line = 349)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(ILha;)V", line = 359)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lha;B)Lhq;", line = 386)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(I)I", line = 415)
