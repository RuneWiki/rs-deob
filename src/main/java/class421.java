...
public class class421 extends class264 {
    ...
    @OriginalMember(owner = "client!mi", name = "d", descriptor = "(I)Leg;", line = 3)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(Lia;B)I", line = 30)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(B)V", line = 101)
    ...
    @OriginalMember(owner = "client!mi", name = "e", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!mi", name = "<init>", descriptor = "(II)V", line = 134)
