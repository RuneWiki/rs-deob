...
public class class421 extends class372 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(B)Lef;")
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(B)[Lra;")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Lql;ILhq;II)V")
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(Lbo;IIIIII)V")
