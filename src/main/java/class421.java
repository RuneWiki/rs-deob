...
public class class421 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IZ)Lr;")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(J[IBLrr;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "(ILqs;Lqs;Lsu;)V")
