...
public class class421 extends class194 {
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ILuo;IIBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "()V", line = 101)
    public class421() {
        super(0, true);
    }

    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(Z)V", line = 107)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(IILbg;)V", line = 125)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "([IBI)V", line = 220)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(II)[I", line = 393)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ILaq;)V", line = 420)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(IIIIIII)I", line = 448)
    ...
    @OriginalMember(owner = "client!nq", name = "f", descriptor = "(I)V", line = 541)
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(B)V", line = 569)
    ...
    @OriginalMember(owner = "client!nq", name = "h", descriptor = "(I)V", line = 579)
