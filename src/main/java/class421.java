...
public class class421 extends class17 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Lvm;BI)Ljn;")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Llb;IIIIIIILvm;IILjn;IIZ)Ljn;")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Lvm;ZLjn;)V")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Lvm;I)V")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IIILvm;)Z")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IIILaa;Laa;)V")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Lvm;Z)Ldn;")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(ZIIILai;ILvm;)V")
