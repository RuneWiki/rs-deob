...
public class class421 extends class347 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IILjava/lang/String;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ke", name = "b", descriptor = "(II)Ltn;", line = 87)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IIB)I", line = 122)
    ...
    @OriginalMember(owner = "client!ke", name = "c", descriptor = "(I)V", line = 157)
    ...
    @OriginalMember(owner = "client!ke", name = "c", descriptor = "(II)V", line = 171)
