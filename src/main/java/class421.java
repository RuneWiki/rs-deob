...
public class class421 extends class235 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(ILil;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 61)
    ...
    @OriginalMember(owner = "client!of", name = "d", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!of", name = "d", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!of", name = "e", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IB)Z", line = 171)
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(II)V", line = 198)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(BI)Ljava/lang/String;", line = 220)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IILpp;)V", line = 242)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Lil;I)V", line = 285)
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(BI)Ldl;", line = 305)
    ...
    @OriginalMember(owner = "client!of", name = "c", descriptor = "(II)I", line = 337)
