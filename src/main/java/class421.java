...
public class class421 {
    ...
    @OriginalMember(owner = "client!jba", name = "b", descriptor = "(I)Lkc;")
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(IZLwq;)V")
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(ILwq;)V")
    ...
    @OriginalMember(owner = "client!jba", name = "c", descriptor = "(I)Lkc;")
