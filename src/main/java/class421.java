...
public class class421 extends class247 {
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(Ldq;IIIIIIIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(Lr;J)V")
    ...
    @OriginalMember(owner = "client!iga", name = "<init>", descriptor = "(Ldq;IIIIIIIIIIIZZ)V")
