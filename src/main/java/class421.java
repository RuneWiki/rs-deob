...
public class class421 extends class689 {
    ...
    @OriginalMember(owner = "client!ob", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(BII)Z", line = 17)
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(Ltl;Lfn;IIIIIIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(I)Ltca;", line = 58)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Lir;Z[[[BIB)Z", line = 70)
