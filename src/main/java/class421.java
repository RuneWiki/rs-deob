...
public class class421 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ILrk;Lrk;)V", line = 28)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IC)Z", line = 88)
