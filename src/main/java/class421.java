...
public class class421 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ZLme;)V")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ILme;)I")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Lnf;B)V")
