...
public class class421 extends class417 {
    ...
    @OriginalMember(owner = "client!ew", name = "c", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!ew", name = "b", descriptor = "()V")
    public static void method2481() {
        field5704 = null;
    }

    @OriginalMember(owner = "client!ew", name = "<init>", descriptor = "(II[IZ)V")
