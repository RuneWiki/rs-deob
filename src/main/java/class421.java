...
public class class421 extends class314 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(CIIIZLma;II)V")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "([B[IIIIIIIIIIILma;II)V")
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "([B[IIIIIIIIIIILma;II)V")
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(Lbc;Lgt;[Lbb;[I[I)V")
