...
public class class421 extends class26 {
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!hea", name = "h", descriptor = "(I)Ljava/lang/Object;", line = 17)
    ...
    @OriginalMember(owner = "client!hea", name = "i", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!hea", name = "b", descriptor = "(B)Z", line = 38)
    ...
    @OriginalMember(owner = "client!hea", name = "<init>", descriptor = "(Lrf;Ljava/lang/Object;I)V", line = 51)
    public class421(class83 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field5912 = arg1;
    }

    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(IIIIILjn;IBIII)Z", line = 61)
