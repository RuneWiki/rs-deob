...
public class class421 extends class149 {
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Lvg;Lvg;I)V")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IBLtl;)V")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(ILwq;I[IIIIII[IIIIIZ)I")
