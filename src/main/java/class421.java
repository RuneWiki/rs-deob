...
public class class421 extends class521 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(B)[B", line = 6)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(I[B)V", line = 20)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IZI)[B", line = 35)
