...
public class class421 extends class581 {
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(ZII)V", line = 5)
    ...
    @OriginalMember(owner = "client!uw", name = "b", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!uw", name = "d", descriptor = "()I", line = 175)
    public final int method49() {
        field5791++;
        return 1;
    }

    @OriginalMember(owner = "client!uw", name = "c", descriptor = "(I)I", line = 185)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(BZ)V", line = 199)
    ...
    @OriginalMember(owner = "client!uw", name = "c", descriptor = "(Z)D", line = 210)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(ZI)V", line = 230)
    ...
    @OriginalMember(owner = "client!uw", name = "d", descriptor = "(I)V", line = 243)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(III)V", line = 263)
    ...
    @OriginalMember(owner = "client!uw", name = "e", descriptor = "(I)Lrj;", line = 283)
    private final synchronized class596 method2443(int arg0) {
        field5805++;
        return arg0 == 1000 ? (class596) this.field5795.method21(2) : null;
    }

    @OriginalMember(owner = "client!uw", name = "b", descriptor = "()Lgu;", line = 294)
    public final class581 method33() {
        field5789++;
        return null;
    }

    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(BLrj;)V", line = 308)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "([III)V", line = 331)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "()Lgu;", line = 400)
    public final class581 method53() {
        field5797++;
        return null;
    }

    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IDB)Lrj;", line = 408)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(B)V", line = 431)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(I)V", line = 441)
    ...
    @OriginalMember(owner = "client!uw", name = "<init>", descriptor = "(I)V", line = 497)
