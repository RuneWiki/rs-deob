...
public abstract class class421 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(ILir;Lir;)V")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(ILfb;)Lrq;")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Ltj;I)V")
