...
public class class421 extends class135 {
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Ljava/lang/String;Lek;I)I")
    ...
    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "(Lnh;)V")
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(ILat;)Llba;")
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Laj;II)V")
