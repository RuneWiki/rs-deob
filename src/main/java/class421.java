...
public class class421 implements class98 {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(I)Lcg;", line = 4)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IBI)Z", line = 21)
    ...
    @OriginalMember(owner = "client!rt", name = "b", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(BJLmv;[I)Ljava/lang/String;", line = 49)
