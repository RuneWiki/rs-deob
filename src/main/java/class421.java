...
public class class421 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;ZLjava/lang/String;ILjava/lang/String;I)V", line = 35)
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V", line = 66)
    ...
    @OriginalMember(owner = "client!jm", name = "b", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(BII)Z", line = 103)
