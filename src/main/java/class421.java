...
public class class421 extends class284 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Z)V", line = 3)
    public final void method696(boolean arg0) {
        this.field3917.method2140(8448, 7681);
    }

    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Lnj;)V", line = 7)
    public final void method693(class133 arg0) {
        this.field3917.method2165(arg0);
    }

    @OriginalMember(owner = "client!ip", name = "b", descriptor = "()Z", line = 12)
    public final boolean method694() {
        return true;
    }

    @OriginalMember(owner = "client!ip", name = "b", descriptor = "(Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "(Lhj;)V", line = 37)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "()V", line = 73)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(I)V", line = 87)
