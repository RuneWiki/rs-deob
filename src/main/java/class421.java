...
public class class421 extends class174 {
    ...
    @OriginalMember(owner = "client!mu", name = "d", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!mu", name = "e", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Laj;BI)Z", line = 163)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(IIIIBIIII)V", line = 325)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(I)V", line = 369)
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Ljca;)V", line = 381)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(IIIIIIIIB[Loh;)V", line = 400)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(B)V", line = 1085)
