...
public class class421 extends class418 {
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "(Lwk;Lufa;[Lwt;[I[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "([B[I[IIIIIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(CIIIZLua;II)V", line = 86)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "([B[I[IIIIIIIIIIILua;II)V", line = 153)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "([B[IIIIIIIIIIILua;II)V", line = 243)
    ...
    @OriginalMember(owner = "client!gt", name = "OA", descriptor = "(CIIIZ)V", line = 328)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "([B[IIIIIIII)V", line = 392)
