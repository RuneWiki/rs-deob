...
public abstract class class421 extends class316 {
    ...
    @OriginalMember(owner = "client!a", name = "d", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!a", name = "e", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ljava/lang/String;Lnl;IZ)Lrj;", line = 36)
    ...
    @OriginalMember(owner = "client!a", name = "<init>", descriptor = "(IIII)V", line = 90)
