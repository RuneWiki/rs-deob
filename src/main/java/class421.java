...
public class class421 extends class468 implements class145 {
    ...
    @OriginalMember(owner = "client!la", name = "GA", descriptor = "(IIIIII)V", line = 4)
    public final void method1546(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(Lda;La;[I[BIIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(FFFFFFLfa;II)V", line = 15)
    ...
    @OriginalMember(owner = "client!la", name = "finalize", descriptor = "()V", line = 23)
    ...
    @OriginalMember(owner = "client!la", name = "t", descriptor = "(III)V", line = 30)
    public final void method1550(int arg0, int arg1, int arg2) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IILfa;II)V", line = 37)
