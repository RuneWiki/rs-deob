...
public class class421 {
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(II)Luv;", line = 9)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!ce", name = "<init>", descriptor = "(ILla;Lla;)V", line = 70)
