...
public class class421 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IIBI[B[BIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ILlb;ZI)V", line = 48)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ILlb;II)Z", line = 121)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IILlb;B)V", line = 193)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "([BIIIIII)Z", line = 266)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "([BII[BIIIIB)V", line = 316)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IIIII)V", line = 361)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(B)V", line = 399)
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(Lmm;Leb;)V", line = 423)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IIZII[[Z)V", line = 440)
