...
public class class421 {
    ...
    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "(I)V", line = 149)
    public class421(int arg0) {
        this.field5936 = arg0;
    }

    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "(IIIIII)V", line = 157)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(ILwm;)Lbu;", line = 28)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(I)Lid;", line = 68)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(BLid;)V", line = 78)
    ...
    @OriginalMember(owner = "client!id", name = "b", descriptor = "(I)V", line = 102)
