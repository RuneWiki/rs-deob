...
public class class421 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "([BLhp;B)V", line = 32)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!nu", name = "b", descriptor = "(B)V", line = 136)
    ...
    @OriginalMember(owner = "client!nu", name = "<init>", descriptor = "(III)V", line = 166)
