...
public class class421 extends class766 {
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(III)V", line = 25)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!bv", name = "b", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(IZI)Z", line = 188)
