...
public class class421 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(BI)V", line = 8)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IIII)V", line = 46)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IZ)Z", line = 61)
