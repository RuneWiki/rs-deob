...
public class class421 extends class223 {
    ...
    @OriginalMember(owner = "client!bb", name = "f", descriptor = "(I)[B", line = 5)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(B)I", line = 29)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IIIII)V", line = 46)
    ...
    @OriginalMember(owner = "client!bb", name = "g", descriptor = "(I)V", line = 80)
