...
public class class275 {
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(II)[B", line = 3)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "([BIII)[B", line = 85)
    ...
    @OriginalMember(owner = "client!mu", name = "toString", descriptor = "()Ljava/lang/String;", line = 122)
    public final String toString() {
        field4425++;
        return "Cache:" + this.field4423;
    }

    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(ILwm;Lwm;I)V", line = 319)
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "([BIII)Z", line = 159)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(I[BZZI)Z", line = 189)
