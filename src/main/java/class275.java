...
public class class275 implements class749 {
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Z)I", line = 35)
    ...
    @OriginalMember(owner = "client!mda", name = "b", descriptor = "(I)I", line = 46)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(ILgda;)V", line = 75)
    ...
    @OriginalMember(owner = "client!mda", name = "c", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(B)V", line = 122)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(ZB)V", line = 132)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(JI)Z", line = 161)
    ...
    @OriginalMember(owner = "client!mda", name = "<init>", descriptor = "(Leo;Lfc;)V", line = 171)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(BLjava/lang/String;I)V", line = 189)
