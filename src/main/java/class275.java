...
public class class275 extends OutputStream {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(CII)I", line = 4)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!uk", name = "b", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!uk", name = "write", descriptor = "(I)V", line = 99)
