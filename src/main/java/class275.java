...
public class class275 extends class369 {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(BILlc;)V", line = 5)
    ...
    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "(Lmj;)V", line = 71)
    public class275(class344 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!lt", name = "e", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IZ)V", line = 58)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(III)V", line = 74)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ZI)V", line = 85)
    ...
    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(III)Z", line = 117)
    ...
    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(ZI)V", line = 130)
    ...
    @OriginalMember(owner = "client!lt", name = "c", descriptor = "(I)Z", line = 179)
