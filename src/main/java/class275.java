...
public class class275 extends class208 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(ZI)I", line = 33)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(ZII)V", line = 58)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(BII)I", line = 82)
    ...
    @OriginalMember(owner = "client!ds", name = "b", descriptor = "(III)V", line = 97)
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(IIIIIII)V", line = 119)
