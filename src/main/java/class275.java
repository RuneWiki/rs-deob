...
public class class275 extends class233 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(BLcea;)V", line = 5)
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "()V", line = 64)
    public class275() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IBII)[B", line = 69)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(BIB)V", line = 86)
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 101)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Lvl;Lvl;B)V", line = 152)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(III[IZBIII[IILfe;III)I", line = 174)
