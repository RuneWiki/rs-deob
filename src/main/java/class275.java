...
public class class275 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(ZLha;II)V")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(IILrl;BB)V")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(IILsf;I)Lpc;")
