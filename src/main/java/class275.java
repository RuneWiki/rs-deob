...
public class class275 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(II)[B", line = 3)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(ILtl;)Ljava/lang/String;", line = 54)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Lap;B)V", line = 66)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(IILof;)V", line = 122)
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "(II)I", line = 314)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(I)V", line = 332)
