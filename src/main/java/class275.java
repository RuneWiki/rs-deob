...
public class class275 extends class669 implements class320 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(BF)F", line = 7)
    public final float method1322(byte arg0, float arg1) {
        int var3 = -120 % ((64 - arg0) / 52);
        return arg1 / (float) this.field3917;
    }

    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Llda;I)V", line = 15)
    public final void method81(class485 arg0, int arg1) {
        super.method81(arg0, arg1);
    }

    @OriginalMember(owner = "client!gf", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 22)
    public final IDirect3DBaseTexture method1787(int arg0) {
        return arg0 == -4406 ? this.field3913 : (IDirect3DBaseTexture) null;
    }

    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(Ltg;Lbda;Lwt;II)V", line = 31)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IZZ)V", line = 51)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(I)Z", line = 62)
    public final boolean method1324(int arg0) {
        return arg0 == -4111 ? true : true;
    }

    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(Ltg;Lbda;IIZ[BII)V", line = 71)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(B)I", line = 129)
    public final int method1316(byte arg0) {
        return arg0 > -2 ? 51 : this.field3915;
    }

    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ZF)F", line = 139)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ILbda;III[BZII)V", line = 149)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(II[IIZIII)V", line = 192)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(I)V", line = 232)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(B)I", line = 242)
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(Ltg;IIZ[III)V", line = 251)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IIIIII[I)V", line = 307)
