...
public class class275 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(BLon;Ljava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IILbda;IIZI)V")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Lon;Z)V")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ILjg;)V")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ILon;ILjava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Lon;I)Ljava/lang/Object;")
