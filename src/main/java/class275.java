...
public class class275 {
    ...
    @OriginalMember(owner = "client!rh", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field3822++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IZ)I", line = 17)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(BI)Ldda;", line = 61)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "(IIII)V", line = 97)
