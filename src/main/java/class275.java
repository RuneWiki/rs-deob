...
public class class275 implements Runnable {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IILfe;)Llk;")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(BLpp;I)Lca;")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Lca;B)V")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(ILpp;I)Lca;")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(BLjava/awt/Canvas;)Llo;")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(I[BZLpp;)Lca;")
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "(Lnh;)V")
