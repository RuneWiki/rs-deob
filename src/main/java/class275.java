...
public class class275 extends class115 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(BLbk;I)V")
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Lnj;I)V")
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(IIILfm;Lfm;)V")
