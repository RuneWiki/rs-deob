...
public class class275 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(II)Lgp;", line = 21)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IIIIIIIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "(Lae;ILqn;Lqn;)V", line = 145)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(II)V", line = 113)
    ...
    @OriginalMember(owner = "client!tb", name = "c", descriptor = "(I)V", line = 129)
