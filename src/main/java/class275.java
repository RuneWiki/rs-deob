...
public class class275 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(II)V", line = 20)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(IBI)Z", line = 53)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!kg", name = "toString", descriptor = "()Ljava/lang/String;", line = 79)
    public final String toString() {
        field3824++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "(IIII)V", line = 92)
