...
public class class275 extends class202 implements class161 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lza;III)Z")
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(IIIIILso;)V")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(ILza;)V")
    ...
    @OriginalMember(owner = "client!nm", name = "b", descriptor = "(ILza;)Lhp;")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lza;B)V")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lza;IZ)Le;")
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(BLza;)V")
