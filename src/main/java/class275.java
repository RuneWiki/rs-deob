...
public class class275 extends class518 {
    ...
    @OriginalMember(owner = "client!aea", name = "b", descriptor = "(IIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(ZLjava/lang/Class;Ljava/lang/String;)Z", line = 25)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(IIB)V", line = 93)
    ...
    @OriginalMember(owner = "client!aea", name = "<init>", descriptor = "(IIIIIII)V", line = 115)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(III)V", line = 127)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(Luaa;I)V", line = 151)
