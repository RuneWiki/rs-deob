...
public class class275 extends class367 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ZZB)V", line = 17)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!gaa", name = "<init>", descriptor = "(Lno;IIIIZ[BIZ)V", line = 46)
    ...
    @OriginalMember(owner = "client!gaa", name = "<init>", descriptor = "(Lno;IIIIZ[FI)V", line = 99)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Lcea;I)V", line = 122)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(IIIIIII)V", line = 161)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "([IIIIIIIIZ)V", line = 177)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(B)V", line = 224)
    ...
    @OriginalMember(owner = "client!gaa", name = "<init>", descriptor = "(Lno;IIII)V", line = 235)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 248)
    ...
    @OriginalMember(owner = "client!gaa", name = "<init>", descriptor = "(Lno;IIIII)V", line = 260)
    ...
    @OriginalMember(owner = "client!gaa", name = "<init>", descriptor = "(Lno;IIIIZ[IZ)V", line = 277)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(BIIIII[BIZI)V", line = 330)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Ljava/lang/String;IZ)V", line = 400)
