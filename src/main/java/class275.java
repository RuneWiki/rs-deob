...
public class class275 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(I[B)V", line = 7)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Ljava/lang/String;BC)I", line = 27)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(III[B)V", line = 52)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(I)V", line = 171)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IIILir;Lir;IIIII)V", line = 186)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(I)V", line = 235)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(JI)V", line = 281)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(B)V", line = 298)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(II[BI)V", line = 374)
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "(Lhi;II)V", line = 624)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Z)J", line = 577)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(B)Ljava/io/File;", line = 590)
