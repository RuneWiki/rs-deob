...
public class class275 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(BLtm;)V")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I)Ltm;")
    ...
    @OriginalMember(owner = "client!bg", name = "c", descriptor = "(I)Ltm;")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ZLsr;)I")
    ...
    @OriginalMember(owner = "client!bg", name = "c", descriptor = "(B)Ltm;")
