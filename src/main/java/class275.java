...
public class class275 extends class557 {
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IIILofa;)V")
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(ILnf;IB)J")
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(BLdt;)V")
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(Ltn;I)V")
