...
public abstract class class275 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(IILya;III)V", line = 4)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(BIII)V", line = 99)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(I)V", line = 265)
    ...
    @OriginalMember(owner = "client!df", name = "b", descriptor = "(I)V", line = 293)
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "(IIIII)V", line = 390)
    ...
    @OriginalMember(owner = "client!df", name = "b", descriptor = "(B)V", line = 315)
    ...
    @OriginalMember(owner = "client!df", name = "c", descriptor = "(I)V", line = 367)
