...
public class class275 extends class95 {
    ...
    @OriginalMember(owner = "client!af", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!af", name = "d", descriptor = "(I)J", line = 17)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ZI)I", line = 51)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(I)J", line = 92)
