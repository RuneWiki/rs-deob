...
public class class275 extends class439 implements class196 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!jl", name = "b", descriptor = "(I)I", line = 15)
    public final int method1707(int arg0) {
        int var2 = -45 % ((arg0 - 17) / 40);
        return this.field3892;
    }

    @OriginalMember(owner = "client!jl", name = "d", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 23)
    public final IDirect3DBaseTexture method2249(int arg0) {
        return arg0 > -77 ? (IDirect3DBaseTexture) null : this.field3889;
    }

    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(Los;Lhh;IIZ[BII)V", line = 32)
    ...
    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(Los;IIZ[III)V", line = 91)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(ZF)F", line = 148)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IIIII[IB)V", line = 159)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lhh;I[BIIIIII)V", line = 199)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IZZ)V", line = 240)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Ltd;I)V", line = 252)
    public final void method2250(class457 arg0, int arg1) {
        super.method2250(arg0, arg1);
    }

    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IIBI[IIII)V", line = 259)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(I)V", line = 299)
    ...
    @OriginalMember(owner = "client!jl", name = "c", descriptor = "(I)I", line = 309)
    ...
    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(Los;Lhh;Lon;II)V", line = 318)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IF)F", line = 338)
