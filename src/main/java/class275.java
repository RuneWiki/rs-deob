...
public class class275 extends class361 {
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(ILht;)V")
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(ILht;)V")
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IFZLna;I)V")
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lht;I)V")
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lcr;I)V")
