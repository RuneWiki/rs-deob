...
public abstract class class275 {
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!caa", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(ILun;)Lko;", line = 50)
