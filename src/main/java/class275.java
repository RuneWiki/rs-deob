...
public class class275 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(ZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(BI)Ldh;", line = 24)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(II)V", line = 80)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(ZI)V", line = 134)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(I)V", line = 153)
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "(Ld;IZLfo;Lfo;)V", line = 189)
