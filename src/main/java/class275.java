...
public class class275 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(I[IILkd;I[I)Lnn;", line = 5)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "()V", line = 43)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(IILah;)Z", line = 56)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(B)V", line = 217)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(I)V", line = 425)
