...
public class class275 extends class61 {
    ...
    @OriginalMember(owner = "client!nj", name = "b", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!nj", name = "e", descriptor = "()Z", line = 76)
    public final boolean method1815() {
        return this.field934.field4212 && this.field934.field4273 && this.field934.field4213;
    }

    @OriginalMember(owner = "client!nj", name = "c", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "()I", line = 90)
    public final int method541() {
        return 1;
    }

    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(Lse;)V", line = 93)
    public class275(class282 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!nj", name = "c", descriptor = "()Z", line = 97)
    public final boolean method545() {
        return this.field4037 != null;
    }

    @OriginalMember(owner = "client!nj", name = "b", descriptor = "()Z", line = 101)
    ...
    @OriginalMember(owner = "client!nj", name = "d", descriptor = "()V", line = 129)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(ILoa;Loa;)V", line = 158)
