...
public class class275 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(I)[[[I", line = 49)
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(III)V", line = 173)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(II)[[I", line = 79)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(BC)Z", line = 154)
