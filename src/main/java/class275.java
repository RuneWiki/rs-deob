...
public class class275 implements class637 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(I)Lhda;", line = 8)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(I)V", line = 30)
