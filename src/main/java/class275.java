...
public class class275 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "([J[Ljava/lang/Object;III)V", line = 5)
    ...
    @OriginalMember(owner = "client!js", name = "toString", descriptor = "()Ljava/lang/String;", line = 64)
    public final String toString() {
        field3620++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IIIIII)V", line = 72)
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(IIII)V", line = 178)
