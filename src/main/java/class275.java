...
public class class275 {
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(Lbm;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(Lbm;II)V", line = 19)
    ...
    @OriginalMember(owner = "client!fha", name = "<init>", descriptor = "(Lbm;)V", line = 743)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(BLbm;)V", line = 43)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(Lbm;Lcd;II)V", line = 54)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(Lmb;[Lpk;)V", line = 215)
    ...
    @OriginalMember(owner = "client!fha", name = "b", descriptor = "(Lbm;I)V", line = 285)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(ILrq;)Lof;", line = 300)
    ...
    @OriginalMember(owner = "client!fha", name = "b", descriptor = "(Lbm;II)V", line = 333)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(I)V", line = 720)
