...
public class class275 {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Ltq;BI)V", line = 9)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(III)Lnk;", line = 67)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Z)V", line = 85)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Ltq;I)V", line = 101)
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(Z)V", line = 126)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IIBLjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 173)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(ZFIIBIII)[I", line = 184)
