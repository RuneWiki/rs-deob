...
public class class275 extends class692 {
    ...
    @OriginalMember(owner = "client!bha", name = "<init>", descriptor = "(Llea;Lan;)V", line = 5)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(ZBI)Lng;", line = 28)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(ZB)V", line = 41)
    ...
    @OriginalMember(owner = "client!bha", name = "b", descriptor = "(I)Z", line = 52)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(Z)V", line = 65)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(IZI)V", line = 81)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(B)V", line = 122)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(ZI)V", line = 143)
    ...
    @OriginalMember(owner = "client!bha", name = "b", descriptor = "(Z)V", line = 176)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(ILfga;I)V", line = 396)
