...
public class class275 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!ln", name = "b", descriptor = "(I)V", line = 91)
