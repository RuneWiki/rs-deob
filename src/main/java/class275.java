...
public class class275 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(I)Lqg;", line = 5)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(I)Lqg;", line = 40)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "(Lan;)V", line = 73)
