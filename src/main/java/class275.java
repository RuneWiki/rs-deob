...
public class class275 extends class125 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "()Lc;")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(ZILoi;I)Lul;")
    ...
    @OriginalMember(owner = "client!hf", name = "ha", descriptor = "(Lc;)V")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(BLc;)V")
