...
public class class275 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IIIILha;III)V", line = 7)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IBII)V", line = 31)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IZI)Z", line = 93)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ZI)Luba;", line = 104)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(I)V", line = 424)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(B)V", line = 438)
