...
public class class275 extends class62 {
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "()V", line = 8)
    public class275() {
        super(1, false);
    }

    @OriginalMember(owner = "client!hp", name = "c", descriptor = "(II)[I", line = 12)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lgw;II)V", line = 101)
    ...
    @OriginalMember(owner = "client!hp", name = "h", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IB)[[I", line = 160)
