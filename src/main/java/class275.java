...
public class class275 {
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(IZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(II)Lmp;", line = 48)
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(Lve;IIIII)Lq;", line = 80)
    ...
    @OriginalMember(owner = "client!vea", name = "<init>", descriptor = "(Lqg;ILvd;)V", line = 114)
