...
public abstract class class275 extends class161 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lsd;B)I", line = 4)
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!ka", name = "d", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!ka", name = "c", descriptor = "(B)V", line = 89)
