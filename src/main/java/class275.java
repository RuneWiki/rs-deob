...
public class class275 {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Lds;JI)V")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Z)Lds;")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IJ)Lds;")
