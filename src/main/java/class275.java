...
public class class275 extends class335 {
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "()V", line = 3)
    public class275() {
        super(3, false);
    }

    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(ILio;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IZ)[[I", line = 20)
    ...
    @OriginalMember(owner = "client!uc", name = "c", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(ZI)[I", line = 124)
