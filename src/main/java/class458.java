...
public class class458 extends class535 {
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(ILwn;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!sp", name = "f", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!sp", name = "<init>", descriptor = "()V", line = 90)
    public class458() {
        super(0, true);
    }

    @OriginalMember(owner = "client!sp", name = "a", descriptor = "([[IZ)V", line = 94)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(II)[[I", line = 145)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(BZII)I", line = 209)
    ...
    @OriginalMember(owner = "client!sp", name = "b", descriptor = "(II)[I", line = 241)
    ...
    @OriginalMember(owner = "client!sp", name = "c", descriptor = "(I)V", line = 264)
