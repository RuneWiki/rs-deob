...
public abstract class class458 extends class324 {
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(III)Lmf;", line = 15)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Ljava/lang/String;ZLjava/lang/Class;)Z", line = 23)
