...
public abstract class class458 {
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(FFII)V", line = 11)
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(FFFFIIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!xa", name = "b", descriptor = "(IIII)V", line = 43)
    public final void method2611(int arg0, int arg1, int arg2, int arg3) {
        this.method413(arg0, arg1, arg2, arg3, 1, 0, 1);
    }

    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(II)V", line = 49)
    public final void method2612(int arg0, int arg1) {
        this.method416(arg0, arg1, 1, 0, 1);
    }

    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(FFIILfa;II)V", line = 52)
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(FFIIIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!xa", name = "a", descriptor = "(FFFFIILfa;II)V", line = 60)
