...
public class class458 extends class438 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(B)Lbl;")
    public final class240 method1966(byte arg0) {
        return arg0 > -60 ? (class240) null : this.field6469;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(BFLbl;Lbl;)V")
    ...
    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "(Lfu;I)V")
