...
public class class458 extends class185 implements class351 {
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(B)I", line = 16)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(I)I", line = 28)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(ZIILer;Lqa;IB)V", line = 39)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(ILqa;)V", line = 50)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!bl", name = "c", descriptor = "(I)Z", line = 78)
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(Lqa;Lkn;IIIIIZII)V", line = 89)
    ...
    @OriginalMember(owner = "client!bl", name = "c", descriptor = "(B)Z", line = 99)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IILqa;B)Z", line = 110)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(ILqa;)Lnf;", line = 129)
    ...
    @OriginalMember(owner = "client!bl", name = "e", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(BLqa;)V", line = 183)
    ...
    @OriginalMember(owner = "client!bl", name = "d", descriptor = "(B)V", line = 210)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(ILqa;I)Lc;", line = 221)
    ...
    @OriginalMember(owner = "client!bl", name = "g", descriptor = "(B)V", line = 232)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Lqa;B)V", line = 259)
