...
public class class458 implements class186 {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ILjava/lang/String;IZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(I)Lqia;", line = 142)
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "(Lnd;Ljava/lang/String;)V", line = 152)
    public class458(class547 arg0, String arg1) {
        this.field6081 = arg1;
        this.field6085 = arg0;
    }

    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(I)I", line = 161)
