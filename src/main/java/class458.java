...
public abstract class class458 extends class105 {
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "([Lwi;I)I")
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Lvl;I)Z")
    ...
    @OriginalMember(owner = "client!sl", name = "g", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!sl", name = "h", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "(IIIIIII)V")
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(ZLha;IILkba;II)V")
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Ljava/lang/String;Z)Ljava/lang/String;")
