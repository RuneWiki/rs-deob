...
public class class458 implements Runnable {
    ...
    @OriginalMember(owner = "client!nja", name = "a", descriptor = "(ILtk;[BI)Lci;")
    ...
    @OriginalMember(owner = "client!nja", name = "a", descriptor = "(ILtk;I)Lci;")
    ...
    @OriginalMember(owner = "client!nja", name = "a", descriptor = "(IILtk;)Lci;")
    ...
    @OriginalMember(owner = "client!nja", name = "a", descriptor = "(ZLci;)V")
    ...
    @OriginalMember(owner = "client!nja", name = "<init>", descriptor = "(Lqn;)V")
