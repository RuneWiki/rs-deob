...
public class class458 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(ZII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(BI)Lqr;", line = 24)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(III)I", line = 61)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IIILjo;II)V", line = 84)
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(Lrb;ILpc;)V", line = 211)
