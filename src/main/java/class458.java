...
public class class458 extends class649 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IB)V", line = 211)
    ...
    @OriginalMember(owner = "client!vf", name = "c", descriptor = "(I)V", line = 222)
    ...
    @OriginalMember(owner = "client!vf", name = "d", descriptor = "(I)I", line = 256)
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(I)V", line = 267)
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(II)I", line = 290)
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(B)V", line = 301)
    ...
    @OriginalMember(owner = "client!vf", name = "e", descriptor = "(I)V", line = 315)
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "(Lhs;)V", line = 332)
    public class458(class358 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lpe;B)V", line = 335)
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "(ILhs;)V", line = 393)
    public class458(int arg0, class358 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!vf", name = "f", descriptor = "(I)V", line = 397)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(I)I", line = 407)
    ...
    @OriginalMember(owner = "client!vf", name = "c", descriptor = "(II)V", line = 417)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(II)I", line = 430)
    ...
    @OriginalMember(owner = "client!vf", name = "g", descriptor = "(I)Z", line = 449)
