...
public class class458 extends class3 implements class723 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IILjaclib/memory/Source;I)Z")
    ...
    @OriginalMember(owner = "client!gr", name = "g", descriptor = "(I)Lil;")
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(Lrda;Z)V")
