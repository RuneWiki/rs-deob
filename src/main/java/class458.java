...
public class class458 {
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(ILlc;)[Lnga;", line = 14)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(B[B)[B", line = 59)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IIII)I", line = 75)
    ...
    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 106)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(III)V", line = 116)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(ZI)Z", line = 130)
