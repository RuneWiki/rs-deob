...
public abstract class class458 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(BZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIILuf;)V", line = 37)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 136)
