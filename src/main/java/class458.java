...
public class class458 implements class562 {
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!iga", name = "b", descriptor = "(I)Lkq;")
    ...
    @OriginalMember(owner = "client!iga", name = "<init>", descriptor = "(Lbea;Lkq;Z)V")
