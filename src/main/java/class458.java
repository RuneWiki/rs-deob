...
public class class458 extends class24 {
    ...
    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(I)Lui;")
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Lui;IFLui;)Z")
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "(Lvd;I)V")
