...
public class class458 {
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IILnt;)I", line = 4)
    public static final int method2673(int arg0, int arg1, class151 arg2) {
        field6417++;
        return arg0 <= 79 ? 72 : -1;
    }

    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(III[BIIII[B)V", line = 28)
