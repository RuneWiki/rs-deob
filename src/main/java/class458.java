...
public class class458 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(B)[Luh;", line = 7)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(BI)V", line = 19)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(B)V", line = 41)
