...
public class class458 extends class79 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IZ)Z", line = 3)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(JI)V", line = 23)
    ...
    @OriginalMember(owner = "client!jb", name = "c", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ZBLjava/lang/String;)V", line = 136)
