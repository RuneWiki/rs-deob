...
public class class458 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Lva;ILva;ZI)Lgi;")
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Lva;IILva;)Lgi;")
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(Lug;Lbr;)V")
