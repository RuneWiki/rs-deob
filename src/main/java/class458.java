...
public class class458 extends class503 implements class155 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!ls", name = "<init>", descriptor = "(Lmr;Z)V")
    public class458(class221 arg0, boolean arg1) {
        super(arg0, 34962, arg1);
    }

    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IILjaclib/memory/Source;I)Z")
