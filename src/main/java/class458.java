...
public class class458 {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(B)Lki;", line = 4)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(I)Lki;", line = 17)
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Lbj;)V", line = 80)
    public class458(class159 arg0) {
        this.field6682 = arg0;
    }

    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Lvh;Lm;B)V", line = 68)
