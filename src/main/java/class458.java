...
public class class458 extends class330 {
    ...
    @OriginalMember(owner = "client!nu", name = "e", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(ZIIIIIZ)V", line = 33)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(ZII)V", line = 79)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(BII)Z", line = 97)
    ...
    @OriginalMember(owner = "client!nu", name = "<init>", descriptor = "()V", line = 108)
    public class458() {
        super(0, false);
    }

    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(Z)I", line = 113)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(Lgga;IB)V", line = 127)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IIIII[[[BLha;IIIIII)V", line = 141)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(II)[[I", line = 178)
