...
public class class458 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IILwm;IIIIIII)V", line = 43)
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "(I[Lja;IIII)V", line = 424)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ILll;)V", line = 126)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Z)V", line = 180)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(BILwm;)Z", line = 323)
