...
public class class458 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(II)Lpea;", line = 4)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lha;III[Z)Z", line = 32)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(BI)Lqg;", line = 68)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(B)V", line = 101)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ZI)V", line = 116)
    ...
    @OriginalMember(owner = "client!jb", name = "b", descriptor = "(B)V", line = 136)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Lei;ILri;Lri;Lri;)V", line = 190)
