...
public class class458 {
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(II)Lcp;")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ILnf;IIII)Lad;")
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(Ld;ILfo;)V")
