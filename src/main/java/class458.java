...
public class class458 extends class648 {
    ...
    @OriginalMember(owner = "client!pi", name = "c", descriptor = "(Z)[B", line = 3)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IIIBI)V", line = 21)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(I)I", line = 42)
