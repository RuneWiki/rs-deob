...
public class class458 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IIIIFIZII)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IBIIIILmd;)V", line = 38)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ZZLjava/lang/String;)V", line = 67)
