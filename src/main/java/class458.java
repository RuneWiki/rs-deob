...
public class class458 extends class113 implements class231 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Lqa;I)Lpl;", line = 3)
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "(IIIIILhu;)V", line = 15)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ILqa;)V", line = 26)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(BILqa;)Lr;", line = 38)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IIIILvba;IIIIII)Z", line = 49)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ILqa;IB)Z", line = 403)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(ILqa;)Lin;", line = 414)
    ...
    @OriginalMember(owner = "client!ts", name = "c", descriptor = "(I)V", line = 425)
    ...
    @OriginalMember(owner = "client!ts", name = "e", descriptor = "(I)V", line = 435)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(B)Z", line = 445)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(I)I", line = 457)
    ...
    @OriginalMember(owner = "client!ts", name = "c", descriptor = "(B)Z", line = 469)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(B)I", line = 482)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Lqa;IZIILco;I)V", line = 492)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(BLqa;)V", line = 503)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(I)I", line = 513)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(BLqa;)V", line = 525)
