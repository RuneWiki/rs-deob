...
public class class458 extends class70 implements class196 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(ILqa;B)Lc;")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IIILqa;)Z")
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(IIIIILmj;)V")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IZI)Ljb;")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(ILqa;)V")
    public final void method67(int arg0, class496 arg1) {
        int var3 = 99 / ((arg0 - 59) / 60);
        field6726++;
    }

    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Lqa;I)Lpj;")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Lqv;BLqa;IZII)V")
    ...
    @OriginalMember(owner = "client!pe", name = "b", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(BLqa;)V")
