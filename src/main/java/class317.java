...
public class class317 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(I)Lrda;", line = 3)
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ILrda;)V", line = 41)
    ...
    @OriginalMember(owner = "client!ne", name = "c", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!ne", name = "d", descriptor = "(I)I", line = 81)
    ...
    @OriginalMember(owner = "client!ne", name = "e", descriptor = "(I)Lrda;", line = 105)
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "()V", line = 145)
    public class317() {
