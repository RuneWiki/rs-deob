...
public class class317 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IJ)V", line = 10)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I[B)V", line = 24)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!bg", name = "b", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(Lsb;II)V", line = 622)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ILjava/awt/Color;Ljava/awt/Color;ZILjava/awt/Color;Ljava/lang/String;)V", line = 166)
    ...
    @OriginalMember(owner = "client!bg", name = "c", descriptor = "(I)J", line = 252)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(II[BI)V", line = 269)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(B)Ljava/io/File;", line = 455)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Z)V", line = 478)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(BI[BI)V", line = 498)
