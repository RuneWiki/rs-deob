...
public abstract class class317 {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(I[JZ[II)V", line = 21)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(III)V", line = 80)
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IILr;I)V", line = 103)
