...
public class class317 extends class55 {
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IIII)Z", line = 17)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IBI)Z", line = 35)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(ZZIZI)I", line = 54)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(III[I)V", line = 98)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(III)Z", line = 109)
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(IILni;I)Llv;", line = 128)
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(IIIIIIIII)V", line = 152)
    ...
    @OriginalMember(owner = "client!cd", name = "b", descriptor = "(III[I)V", line = 168)
