...
public abstract class class317 extends class472 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IIB)I", line = 6)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!lk", name = "g", descriptor = "(I)Ldk;", line = 45)
    ...
    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "(Lbg;I)V", line = 58)
    public class317(class278 arg0, int arg1) {
        this.field4832 = arg1;
        this.field4829 = arg0;
    }

    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(II)I", line = 72)
    ...
    @OriginalMember(owner = "client!lk", name = "h", descriptor = "(I)V", line = 87)
