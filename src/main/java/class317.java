...
public class class317 implements class177 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(ILrq;)V")
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(ILih;I)V")
    public final void method2019(int arg0, class416 arg1, int arg2) {
        this.method2020(arg0, arg1, 0, arg2);
    }

    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(ILih;II)V")
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(ILrq;I)V")
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(Lhj;)V")
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(ILum;)V")
