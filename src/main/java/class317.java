...
public class class317 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lud;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IC)Z", line = 24)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IIII)I", line = 38)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(BIIIIIII)V", line = 61)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ILdm;)Ljava/lang/String;", line = 136)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(I)V", line = 166)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IBLud;)V", line = 176)
