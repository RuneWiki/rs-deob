...
public class class317 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(BLtga;)Z")
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(ILsda;)V")
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Lvj;I)V")
