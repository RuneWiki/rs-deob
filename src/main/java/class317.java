...
public class class317 {
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IILk;I)V")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IBILk;)Z")
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Lte;Lsb;)V")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(ILk;BI)V")
