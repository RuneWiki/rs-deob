...
public class class317 {
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lnh;", line = 10)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(ILka;IBIBII)Lka;", line = 32)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(ILdt;I)V", line = 115)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(IIIIILka;)Lka;", line = 327)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(IZII)I", line = 464)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(ZIZ[I[IIII[III[IIB[II[[[BI)V", line = 589)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(I)V", line = 1032)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Ldt;I)V", line = 1066)
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(I)Lrd;", line = 1086)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(IIIB)I", line = 1143)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Llf;Ljava/lang/String;II)Lie;", line = 1196)
