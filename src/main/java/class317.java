...
public class class317 extends class399 {
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "()Z", line = 6)
    public final boolean method375() {
        return true;
    }

    @OriginalMember(owner = "client!rc", name = "<init>", descriptor = "(Lpo;)V", line = 9)
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "()V", line = 70)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Z)V", line = 84)
    public final void method378(boolean arg0) {
        this.field5798.method2100(8448, 7681);
    }

    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lfl;)V", line = 87)
