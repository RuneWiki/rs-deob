...
public class class317 {
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;IB)Ljava/io/File;", line = 8)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/io/File;", line = 103)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(IILjava/lang/String;)V", line = 114)
