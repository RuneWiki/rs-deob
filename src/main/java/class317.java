...
public class class317 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(I)[Lhs;", line = 23)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(BI)Lwc;", line = 34)
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(II)Lfba;", line = 75)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;", line = 114)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ZI)V", line = 136)
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(IILefa;I)V", line = 152)
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(Lnb;ILoh;Loh;Loh;)V", line = 173)
