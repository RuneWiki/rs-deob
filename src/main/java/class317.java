...
public class class317 extends class299 implements class425 {
    ...
    @OriginalMember(owner = "client!un", name = "b", descriptor = "(Lii;I)Leb;")
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(ILii;Lps;)V")
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(ILii;I)Ldc;")
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(BLii;)V")
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Lii;I)V")
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(IIZLii;)Z")
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(Lii;Lge;IIIIIIIZIIII)V")
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(ILii;)V")
