...
public class class317 extends class162 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lqb;Lug;ILtj;IIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!kg", name = "e", descriptor = "(B)I", line = 32)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(IIIIZ)V", line = 45)
    ...
    @OriginalMember(owner = "client!kg", name = "h", descriptor = "(I)Z", line = 63)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(B)I", line = 77)
    public final int method1087(byte arg0) {
        ++field4653;
        return arg0 != 73 ? 121 : -1;
    }

    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(IZ)Ljava/lang/String;", line = 88)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(ILtj;BIZLkm;I)V", line = 131)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(BLtj;)V", line = 150)
    ...
    @OriginalMember(owner = "client!kg", name = "f", descriptor = "(B)I", line = 176)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(ILfb;)V", line = 197)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(IILtj;)Z", line = 396)
    ...
    @OriginalMember(owner = "client!kg", name = "g", descriptor = "(I)I", line = 542)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(ILtj;II)Z", line = 565)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Ltj;I)Lri;", line = 597)
    ...
    @OriginalMember(owner = "client!kg", name = "e", descriptor = "(I)V", line = 736)
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(ZI)Ljava/lang/String;", line = 762)
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(B)Z", line = 777)
    public final boolean method107(byte arg0) {
        ++field4655;
        return arg0 <= 119;
    }

    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(IIII)V", line = 798)
