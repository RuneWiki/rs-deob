...
public class class317 extends class45 {
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(Lcu;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!sj", name = "f", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "()V", line = 202)
    public class317() {
        super(1, true);
    }

    @OriginalMember(owner = "client!sj", name = "a", descriptor = "([ILln;I[I[I)V", line = 104)
    ...
    @OriginalMember(owner = "client!sj", name = "g", descriptor = "(B)V", line = 205)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(II)[I", line = 216)
