...
public class class317 extends class233 implements class438 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lfp;I)V")
    ...
    @OriginalMember(owner = "client!ve", name = "c", descriptor = "(ILfp;)V")
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(Lfp;Lgn;IIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lfp;III)Z")
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ILfp;B)Lbi;")
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lfp;Z)V")
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ZLfp;BI)Lwk;")
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lfp;II)Lbi;")
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ILfp;)Luq;")
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(ILfp;)V")
