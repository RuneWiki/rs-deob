...
public class class317 {
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "()V", line = 10)
    public class317() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "([BILlh;)V", line = 24)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(BIIIIII)I", line = 49)
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "(III)V", line = 100)
