...
public class class317 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Lgk;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IIIIIIIIIIIIBI)V", line = 42)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IILgk;)V", line = 153)
