...
public abstract class class317 {
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(I)Z", line = 16)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Z)Z", line = 27)
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IIIILql;)V", line = 64)
    ...
    @OriginalMember(owner = "client!oc", name = "c", descriptor = "(I)Z", line = 106)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(BZLjava/lang/String;Lnv;Z)V", line = 119)
