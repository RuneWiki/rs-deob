...
public class class317 extends class161 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IIII)I", line = 3)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(ZLjava/lang/String;)I", line = 32)
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "()V", line = 43)
    public class317() {
    }

    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(J)V", line = 46)
    public class317(long arg0) {
        this.field4968 = arg0;
    }

    @OriginalMember(owner = "client!vi", name = "d", descriptor = "(I)V", line = 56)
