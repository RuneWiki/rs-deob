...
public class class317 extends class70 {
    ...
    @OriginalMember(owner = "client!ft", name = "c", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(III)Z", line = 23)
    ...
    @OriginalMember(owner = "client!ft", name = "d", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IIILww;Lww;)V", line = 56)
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(I)Lwf;", line = 114)
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(Lmj;IIIIII)V", line = 176)
