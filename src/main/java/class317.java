...
public class class317 extends class147 implements class503 {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(BLya;I)Lt;", line = 5)
    ...
    @OriginalMember(owner = "client!gt", name = "c", descriptor = "(ILya;)V", line = 18)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ILya;)V", line = 40)
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "(Lya;Ljo;IIIIIZIIIIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(III)Z", line = 60)
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Lya;B)Lmf;", line = 85)
    ...
    @OriginalMember(owner = "client!gt", name = "c", descriptor = "(I)Z", line = 127)
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(ILya;)V", line = 141)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ZILya;I)Z", line = 154)
    ...
    @OriginalMember(owner = "client!gt", name = "e", descriptor = "(I)I", line = 175)
    public final int method499(int arg0) {
        ++field4340;
        return arg0 != -15561 ? -68 : this.field4348.field3891;
    }

    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(I)I", line = 187)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IB)Z", line = 197)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IIZ)V", line = 209)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(II)V", line = 224)
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(I)V", line = 240)
    ...
    @OriginalMember(owner = "client!gt", name = "i", descriptor = "(I)I", line = 250)
    ...
    @OriginalMember(owner = "client!gt", name = "d", descriptor = "(I)I", line = 263)
