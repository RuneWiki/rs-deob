...
public class class317 {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(II)I", line = 10)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(II)V", line = 26)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IIIII)V", line = 39)
