...
public class class317 extends class184 {
    ...
    @OriginalMember(owner = "client!uea", name = "<init>", descriptor = "()V", line = 6)
    public class317() {
    }

    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(I)Lcq;", line = 10)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(BI)Z", line = 23)
    ...
    @OriginalMember(owner = "client!uea", name = "b", descriptor = "(I)V", line = 49)
    public static void method2013(int arg0) {
        field4517 = null;
        int var1 = -22 % ((arg0 - 55) / 34);
    }

    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(BLjava/lang/String;)V", line = 62)
    ...
    @OriginalMember(owner = "client!uea", name = "<init>", descriptor = "(I)V", line = 74)
    public class317(int arg0) {
        this.field4518 = arg0;
    }

    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(IIIII)V", line = 83)
