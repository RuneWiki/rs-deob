...
public class class317 extends class495 {
    ...
    @OriginalMember(owner = "client!qq", name = "j", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "(Lrl;)V")
    public class317(class487 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ILud;ILud;)V")
