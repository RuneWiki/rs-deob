...
public class class317 extends class99 {
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(IBI)Lag;")
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Z)Lbm;")
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "(ILoc;Loc;Lbd;Lkf;IIZ)V")
