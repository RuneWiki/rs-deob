...
public class class317 extends class246 {
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(ILfg;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(II)Z", line = 21)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(ZIIIILza;)V", line = 33)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(ZB)V", line = 130)
    ...
    @OriginalMember(owner = "client!wv", name = "b", descriptor = "(I)V", line = 166)
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "(Lpg;Lrk;)V", line = 216)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(I)V", line = 227)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(ZI)V", line = 249)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(B)Z", line = 260)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(BII)V", line = 271)
    ...
    @OriginalMember(owner = "client!wv", name = "c", descriptor = "(B)V", line = 321)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(IIIZI)Lha;", line = 457)
