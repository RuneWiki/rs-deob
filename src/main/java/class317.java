...
public class class317 extends class448 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(I)I", line = 6)
    public final int method1855(int arg0) {
        ++field4060;
        return arg0 != 7 ? -62 : 1;
    }

    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(BII)V", line = 19)
    ...
    @OriginalMember(owner = "client!fr", name = "c", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "(Leq;)V", line = 120)
    public class317(class357 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(II)V", line = 123)
    ...
    @OriginalMember(owner = "client!fr", name = "g", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!fr", name = "e", descriptor = "(I)Z", line = 160)
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(I)Z", line = 197)
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(B)Z", line = 207)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(II)V", line = 219)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lhga;ILhga;B)V", line = 233)
