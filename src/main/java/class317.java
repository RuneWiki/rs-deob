...
public class class317 {
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(Lgk;B)Lkaa;", line = 6)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "([BI)V", line = 17)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(II)[B", line = 64)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(Z)[Lmh;", line = 118)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(III)Z", line = 149)
