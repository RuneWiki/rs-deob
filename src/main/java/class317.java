...
public class class317 extends class3 {
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Lkb;)V")
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Lar;)V")
    ...
    @OriginalMember(owner = "client!sv", name = "b", descriptor = "(Lar;)V")
    public final synchronized void method1891(class3 arg0) {
        this.field4079.method41(-792385400, arg0);
    }

    @OriginalMember(owner = "client!sv", name = "d", descriptor = "()Lar;")
    ...
    @OriginalMember(owner = "client!sv", name = "c", descriptor = "()Lar;")
    public final class3 method15() {
        return (class3) this.field4079.method49(108);
    }

    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Llf;Lkb;)V")
