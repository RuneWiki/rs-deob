...
public class class317 {
    ...
    @OriginalMember(owner = "client!w", name = "b", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!w", name = "c", descriptor = "(I)I", line = 78)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Z)V", line = 96)
    ...
    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "()V", line = 245)
    private class317() {
    }

    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "([I)V", line = 247)
