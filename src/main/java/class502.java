...
public class class502 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(BI)Lfl;")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ILtf;)V")
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(Lae;ILqn;)V")
