...
public class class502 {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(B)Lci;", line = 4)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(I)Z", line = 25)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(ZIIIIB)V", line = 55)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(ZI)Lco;", line = 210)
    ...
    @OriginalMember(owner = "client!ih", name = "b", descriptor = "(B)V", line = 242)
    ...
    @OriginalMember(owner = "client!ih", name = "c", descriptor = "(B)V", line = 256)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(ILvc;ZLvc;B)Lhn;", line = 297)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Lvc;ILvc;I)Lhn;", line = 336)
    ...
    @OriginalMember(owner = "client!ih", name = "<init>", descriptor = "(Lpq;Lqc;)V", line = 356)
