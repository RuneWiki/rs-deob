...
public class class502 {
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(Ljava/lang/String;BLjava/lang/Throwable;)V", line = 56)
