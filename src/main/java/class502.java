...
public class class502 implements Runnable {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lwi;B)V", line = 8)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ILek;I)Lwi;", line = 41)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(BILqn;)I", line = 59)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lek;II)Lwi;", line = 73)
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(II)V", line = 125)
    ...
    @OriginalMember(owner = "client!qc", name = "run", descriptor = "()V", line = 139)
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Lqn;)V", line = 213)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lek;II[B)Lwi;", line = 191)
