...
public class class502 extends class398 {
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Luca;Lal;)V")
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(ILvaa;B)V")
