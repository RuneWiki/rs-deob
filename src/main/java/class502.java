...
public class class502 {
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(B)Laca;")
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IIIILih;Lqa;)V")
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(ILps;Ljava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Laca;I)V")
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(I)Laca;")
