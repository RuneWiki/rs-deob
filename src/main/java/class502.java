...
public class class502 extends class421 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lig;IIIIIIIIIIIZZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(JI)V", line = 28)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lha;J)V", line = 423)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "()V", line = 598)
    ...
    @OriginalMember(owner = "client!nd", name = "b", descriptor = "()V", line = 609)
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "(Lig;IIIIIIIIIIIZZ)V", line = 616)
