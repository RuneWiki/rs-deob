...
public class class502 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(II)Lfea;")
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Lfea;B)V")
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lfea;)V")
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(BLpf;III)V")
