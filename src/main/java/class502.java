...
public class class502 extends class264 {
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(BI)I", line = 3)
    ...
    @OriginalMember(owner = "client!iea", name = "<init>", descriptor = "(Lmfa;)V", line = 14)
    public class502(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!iea", name = "b", descriptor = "(BI)V", line = 18)
    ...
    @OriginalMember(owner = "client!iea", name = "b", descriptor = "(B)I", line = 33)
    ...
    @OriginalMember(owner = "client!iea", name = "<init>", descriptor = "(ILmfa;)V", line = 45)
    public class502(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(B)I", line = 50)
    public final int method663(byte arg0) {
        ++field7181;
        return arg0 != -38 ? -117 : 3;
    }

    @OriginalMember(owner = "client!iea", name = "b", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(IZII)I", line = 81)
    ...
    @OriginalMember(owner = "client!iea", name = "c", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(ILjava/lang/String;ZIILjava/lang/String;IJZZIIJ)V", line = 127)
