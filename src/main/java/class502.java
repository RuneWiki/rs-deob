...
public class class502 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IB)Z", line = 4)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(III)Z", line = 15)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(B)Lsq;", line = 89)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(BI)Lqe;", line = 104)
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(II)V", line = 122)
    public class502(int arg0, int arg1) {
        this.field7344 = arg1;
        this.field7346 = arg0;
    }

    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(Lqe;I)V", line = 130)
