...
public class class502 {
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(BLcs;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(I)V", line = 345)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(ID)V", line = 356)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(ILjava/lang/String;[Ltd;I)I", line = 385)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(I[I[Ljava/lang/Object;)V", line = 397)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Ljw;)V", line = 411)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(ICB)I", line = 472)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(ILjava/lang/String;)I", line = 491)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "([ILjava/lang/String;[Ljava/lang/String;I[Ltd;)I", line = 506)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(I[Ltd;Ljava/lang/String;II)I", line = 753)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "([Ltd;Ljava/lang/String;B)I", line = 768)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(ILjava/lang/String;I[Ltd;)I", line = 875)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(II)I", line = 906)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "()V", line = 920)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(I[Ltd;Ljava/lang/String;I)Ljava/lang/String;", line = 1002)
    ...
    @OriginalMember(owner = "client!qt", name = "<init>", descriptor = "([B)V", line = 1127)
