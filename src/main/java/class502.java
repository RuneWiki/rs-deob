...
public class class502 extends class148 {
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(ZI)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!dw", name = "e", descriptor = "(B)Z", line = 80)
    ...
    @OriginalMember(owner = "client!dw", name = "c", descriptor = "(B)V", line = 106)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(B)I", line = 117)
    ...
    @OriginalMember(owner = "client!dw", name = "f", descriptor = "(B)V", line = 128)
    ...
    @OriginalMember(owner = "client!dw", name = "<init>", descriptor = "()V", line = 138)
    public class502() {
        super(0, false);
    }

    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(ILdh;I)V", line = 152)
