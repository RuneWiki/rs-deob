...
public abstract class class502 extends class405 {
    ...
    @OriginalMember(owner = "client!ba", name = "e", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!ba", name = "b", descriptor = "(Z)V", line = 37)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Ljava/lang/Object;ILec;)V", line = 52)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(ILta;)V", line = 76)
