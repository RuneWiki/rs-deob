...
public class class502 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IZLos;)V")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(ILgn;I)Lpv;")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IILr;III)Lr;")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Lmh;IBIII)Lwo;")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(BIILr;IIIB)Lr;")
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(Los;B)V")
