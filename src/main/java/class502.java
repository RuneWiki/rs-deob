...
public class class502 extends class147 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Lhi;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IIB)V", line = 21)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Ljava/net/Socket;II)Llga;", line = 54)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Lol;I)V", line = 65)
