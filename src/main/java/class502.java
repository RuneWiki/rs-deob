...
public class class502 extends class77 {
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Lya;B)Lmf;")
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(ILej;)V")
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(ZILya;I)Z")
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(ZLya;I)Z")
    ...
    @OriginalMember(owner = "client!dw", name = "c", descriptor = "(ILya;)V")
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Lya;IZLij;III)V")
