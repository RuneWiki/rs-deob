...
public abstract class class502 extends class270 {
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(ILjava/lang/String;I)Lcf;", line = 8)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(I)Z", line = 33)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(Z)I", line = 43)
    ...
    @OriginalMember(owner = "client!cba", name = "b", descriptor = "(I)I", line = 56)
    ...
    @OriginalMember(owner = "client!cba", name = "<init>", descriptor = "(Lap;)V", line = 69)
    public class502(class435 arg0) {
        this.field7229 = arg0;
    }

    @OriginalMember(owner = "client!cba", name = "b", descriptor = "(II)I", line = 82)
    ...
    @OriginalMember(owner = "client!cba", name = "h", descriptor = "(I)Z", line = 135)
