...
public class class502 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(I)Lpq;", line = 32)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(III[BBI)Z", line = 102)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Z)Z", line = 185)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(II)I", line = 209)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(B)V", line = 226)
    ...
    @OriginalMember(owner = "client!ki", name = "c", descriptor = "(I)V", line = 243)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(II)I", line = 860)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILug;I)V", line = 876)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lug;I)V", line = 958)
    ...
    @OriginalMember(owner = "client!ki", name = "d", descriptor = "(I)Lpq;", line = 990)
