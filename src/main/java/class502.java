...
public class class502 extends class715 {
    ...
    @OriginalMember(owner = "client!ko", name = "c", descriptor = "(B)V", line = 9)
    public static void method3014(byte arg0) {
        int var1 = 77 / ((arg0 - -13) / 46);
        field7171 = null;
    }

    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(B)Z", line = 43)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(BZ)V", line = 54)
    ...
    @OriginalMember(owner = "client!ko", name = "c", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(III)V", line = 82)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILdu;I)V", line = 126)
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(Lgt;Lwv;)V", line = 136)
    public class502(class453 arg0, class34 arg1) {
        super(arg0);
        this.field7167 = arg1;
    }

    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ZI)V", line = 151)
