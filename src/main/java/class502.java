...
public class class502 extends class404 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ILha;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!qc", name = "h", descriptor = "(I)V", line = 68)
    public static void method3010(int arg0) {
        int var1 = -92 % ((arg0 - -42) / 37);
        field7594 = null;
    }

    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "()V", line = 209)
    public class502() {
        super(1, false);
    }

    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(II)[[I", line = 91)
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(IBI)V", line = 189)
