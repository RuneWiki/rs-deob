...
public class class502 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IF)I", line = 5)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IIF)F", line = 65)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(F)F", line = 73)
    private static final float method2992(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!fr", name = "a", descriptor = "()V", line = 78)
    public static void method2993() {
        field7289 = null;
        field7288 = null;
    }

    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(IIF)F", line = 85)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lfh;Lkv;)V", line = 108)
