...
public class class502 extends class695 {
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!hb", name = "c", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(III)V", line = 56)
    ...
    @OriginalMember(owner = "client!hb", name = "d", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!hb", name = "c", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ZB)V", line = 125)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lnm;ZI)V", line = 143)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Z)Z", line = 152)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "(Lmba;Lpe;Lbl;)V", line = 180)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IZ)V", line = 198)
