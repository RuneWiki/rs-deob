...
public class class502 extends class463 implements class628 {
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(Lde;IZ[[I)V", line = 5)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Lem;I)V", line = 57)
    public final void method840(class599 arg0, int arg1) {
        int var3 = -15 / ((arg1 + 72) / 48);
        super.method840(arg0, 40);
    }

    @OriginalMember(owner = "client!oc", name = "e", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 65)
    ...
    @OriginalMember(owner = "client!oc", name = "d", descriptor = "(I)V", line = 76)
