...
public class class502 extends class634 {
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(BI)[I", line = 6)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ILig;Z)V", line = 61)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ILei;)Ljava/lang/String;", line = 81)
    ...
    @OriginalMember(owner = "client!ve", name = "f", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "()V", line = 185)
    public class502() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lha;B)V", line = 107)
