...
public class class502 extends class417 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;I)I", line = 5)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lgw;B)V", line = 140)
    ...
    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "(II)V", line = 169)
