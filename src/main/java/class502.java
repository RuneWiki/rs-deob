...
public class class502 extends class435 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!eaa", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 3)
    ...
    @OriginalMember(owner = "client!eaa", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 14)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        field7134++;
        this.method2982(arg0.getX(), arg0.getY(), 0);
    }

    @OriginalMember(owner = "client!eaa", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 25)
    public final synchronized void mouseExited(MouseEvent arg0) {
        field7143++;
        this.method2982(arg0.getX(), arg0.getY(), 0);
    }

    @OriginalMember(owner = "client!eaa", name = "f", descriptor = "(I)I", line = 33)
    public final int method2698(int arg0) {
        field7124++;
        return arg0 == 0 ? this.field7153 : -2;
    }

    @OriginalMember(owner = "client!eaa", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 45)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method2982(arg0.getX(), arg0.getY(), 0);
        field7148++;
    }

    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(Z)Lwi;", line = 55)
    ...
    @OriginalMember(owner = "client!eaa", name = "c", descriptor = "(I)Z", line = 68)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(III)V", line = 80)
    ...
    @OriginalMember(owner = "client!eaa", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 97)
    ...
    @OriginalMember(owner = "client!eaa", name = "h", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!eaa", name = "e", descriptor = "(I)I", line = 134)
    public final int method2697(int arg0) {
        field7128++;
        return arg0 == 4212 ? this.field7129 : 120;
    }

    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;B)I", line = 146)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(I)Z", line = 187)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(BIII)V", line = 199)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(IBIII)V", line = 224)
    ...
    @OriginalMember(owner = "client!eaa", name = "b", descriptor = "(I)V", line = 254)
    ...
    @OriginalMember(owner = "client!eaa", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 276)
    ...
    @OriginalMember(owner = "client!eaa", name = "d", descriptor = "(I)V", line = 307)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 318)
    ...
    @OriginalMember(owner = "client!eaa", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 335)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        this.method2982(arg0.getX(), arg0.getY(), 0);
        field7132++;
    }

    @OriginalMember(owner = "client!eaa", name = "i", descriptor = "(I)V", line = 344)
    ...
    @OriginalMember(owner = "client!eaa", name = "b", descriptor = "(B)Z", line = 368)
    ...
    @OriginalMember(owner = "client!eaa", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 392)
