...
public class class502 extends class45 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(BII)V", line = 3)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Lio;ILgba;I)V", line = 24)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(I)V", line = 143)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(II)V", line = 164)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(B)V", line = 182)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(BLrc;)Lri;", line = 279)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "([S[Ljava/lang/String;III)V", line = 303)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "()V", line = 366)
