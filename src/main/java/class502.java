...
public class class502 {
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lvs;)V", line = 63)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lam;Z)V", line = 155)
    ...
    @OriginalMember(owner = "client!qt", name = "<init>", descriptor = "([I)V", line = 189)
