...
public class class502 extends class775 {
    ...
    @OriginalMember(owner = "client!gk", name = "b", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IIIILpba;)Z", line = 68)
    ...
    @OriginalMember(owner = "client!gk", name = "b", descriptor = "(B)V", line = 207)
