...
public class class537 extends class484 {
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Lha;J)V", line = 18)
    ...
    @OriginalMember(owner = "client!vda", name = "b", descriptor = "()V", line = 191)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(Ltca;IIIIIIIIIIIZZ)V", line = 203)
    ...
    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(Ltca;IIIIIIIIIIIZZ)V", line = 222)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(JI)V", line = 242)
