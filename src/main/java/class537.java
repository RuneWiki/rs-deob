...
public class class537 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(B)I", line = 17)
    public final int method2911(byte arg0) {
        field7220++;
        return arg0 == 67 ? this.field7215 & 0x3FFF : 4;
    }

    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 33)
    public static final boolean method2912(byte arg0, String arg1) {
        field7207++;
        return arg0 <= 47 ? false : class288.method1622((byte) 8, arg1, true, 10);
    }

    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IZ)Liw;", line = 156)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(II)V", line = 172)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IIIB)Z", line = 183)
