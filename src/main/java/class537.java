...
public class class537 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(III[I)Lcba;", line = 5)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(II[I)Lcba;", line = 43)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "([IIII)Lcba;", line = 69)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(B[II)Lcba;", line = 115)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(I)V", line = 135)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(ILoh;IIJIZ)V", line = 162)
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(Loh;Loh;)V", line = 187)
