...
public class class537 extends class55 implements class200 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;Let;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!v", name = "finalize", descriptor = "()V", line = 26)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IILq;Z)Z", line = 65)
    ...
    @OriginalMember(owner = "client!v", name = "e", descriptor = "()[Lns;", line = 69)
    public final class369[] method451() {
        return this.field7255;
    }

    @OriginalMember(owner = "client!v", name = "d", descriptor = "()V", line = 72)
    ...
    @OriginalMember(owner = "client!v", name = "c", descriptor = "()V", line = 83)
    public final void method432() {
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;)V", line = 89)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IIII)V", line = 144)
    public final void method458(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!v", name = "b", descriptor = "()[Llp;", line = 154)
    public final class357[] method429() {
        return this.field7254;
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(BIZ)Lda;", line = 159)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IILq;ZI)Z", line = 170)
    public final boolean method419(int arg0, int arg1, class392 arg2, boolean arg3, int arg4) {
        return this.field7257.method140().method1419(this, arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(I[IIIIIZ)V", line = 176)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;Let;II)V", line = 181)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lda;IIIZ)V", line = 198)
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(Ll;Lm;Lnba;IIII)V", line = 200)
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(Ll;)V", line = 271)
