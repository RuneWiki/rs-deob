...
public class class537 extends class646 {
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Z)I", line = 20)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(II)[[I", line = 32)
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(Z)V", line = 101)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(B)V", line = 134)
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "()V", line = 220)
    public class537() {
        super(0, false);
    }

    @OriginalMember(owner = "client!pu", name = "d", descriptor = "(I)Z", line = 149)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Lek;IB)V", line = 182)
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(ZII)V", line = 196)
