...
public class class537 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(II)Lraa;", line = 3)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IIILsn;IIIIIIZ)Z", line = 31)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(I)V", line = 281)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(B)Liaa;", line = 303)
