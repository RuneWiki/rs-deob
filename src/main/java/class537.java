...
public class class537 extends class670 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Lha;J)Z")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IZ)Lur;")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(J)V")
    public final void method3112(long arg0) {
        this.field7533 = arg0;
    }

    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Lha;[Lde;Z)V")
    ...
    @OriginalMember(owner = "client!ur", name = "e", descriptor = "()Ldm;")
    public final class50 method3116() {
        return this.field7541;
    }

    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "([Lok;Z)V")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Lha;J[Lde;[Lok;Z)V")
    ...
    @OriginalMember(owner = "client!ur", name = "g", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!ur", name = "h", descriptor = "()Ldm;")
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "(IZ)V")
