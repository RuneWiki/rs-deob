...
public class class537 {
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(I)Z", line = 19)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!ac", name = "c", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!ac", name = "d", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIILfd;Lha;Lnd;)Z", line = 82)
