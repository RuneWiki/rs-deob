...
public class class537 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IZIII)I", line = 24)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IIZI)V", line = 54)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(II)Lqq;", line = 80)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(I)V", line = 151)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Lha;BII)V", line = 169)
