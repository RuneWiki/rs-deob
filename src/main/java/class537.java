...
public class class537 extends class293 {
    ...
    @OriginalMember(owner = "client!wba", name = "d", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Lq;Lr;ILda;)V", line = 28)
    ...
    @OriginalMember(owner = "client!wba", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(IIZLr;)Z", line = 83)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(ILr;ILcaa;ZII)V", line = 95)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(B)V", line = 107)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(IILmv;)Luw;", line = 120)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Lr;III)Lda;", line = 139)
    ...
    @OriginalMember(owner = "client!wba", name = "d", descriptor = "(Z)Z", line = 155)
    public final boolean method309(boolean arg0) {
        ++field7869;
        return !arg0;
    }

    @OriginalMember(owner = "client!wba", name = "b", descriptor = "(II)V", line = 173)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(ZI)V", line = 206)
    ...
    @OriginalMember(owner = "client!wba", name = "c", descriptor = "(Lr;I)Lifa;", line = 223)
    ...
    @OriginalMember(owner = "client!wba", name = "h", descriptor = "(I)Z", line = 235)
    public final boolean method270(int arg0) {
        ++field7859;
        return arg0 > -42 ? false : false;
    }

    @OriginalMember(owner = "client!wba", name = "f", descriptor = "(I)I", line = 247)
    ...
    @OriginalMember(owner = "client!wba", name = "b", descriptor = "(Z)I", line = 263)
    ...
    @OriginalMember(owner = "client!wba", name = "e", descriptor = "(I)Z", line = 284)
    ...
    @OriginalMember(owner = "client!wba", name = "b", descriptor = "(Lr;I)V", line = 315)
    ...
    @OriginalMember(owner = "client!wba", name = "finalize", descriptor = "()V", line = 335)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Lr;I)Lhr;", line = 355)
