...
public class class537 extends class272 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(JZLoa;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILoa;IZJ)V", line = 34)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(I)V", line = 292)
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(I)V", line = 333)
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "(Loa;Let;Ll;J)V", line = 380)
