...
public class class537 {
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(BJ)V", line = 127)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IBLkda;I)Lfd;", line = 142)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(B)J", line = 165)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(BC)Z", line = 184)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(BZIZI)I", line = 197)
    ...
    @OriginalMember(owner = "client!tq", name = "c", descriptor = "(I)Ljava/io/File;", line = 241)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lhd;II)V", line = 620)
    ...
    @OriginalMember(owner = "client!tq", name = "d", descriptor = "(I)V", line = 272)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(I[BBI)V", line = 290)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IB[BI)V", line = 478)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(I[B)V", line = 608)
