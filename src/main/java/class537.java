...
public class class537 extends class245 implements class334 {
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(Lhl;Lkt;Lkq;II)V")
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(Lhl;Lkt;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(Lhl;Lkt;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "([FLkt;IIBIIII)V")
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(Lhl;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(III)Ljn;")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIIIII[BLkt;I)V")
