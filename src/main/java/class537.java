...
public class class537 {
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(ILuaa;Luaa;I)Lim;")
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(IIILeba;Leba;)V")
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(IIILjava/lang/Class;)Lit;")
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(BILuaa;Luaa;Z)Lim;")
    ...
    @OriginalMember(owner = "client!uca", name = "<init>", descriptor = "(Lgu;Lrf;Ljava/math/BigInteger;Ljava/math/BigInteger;)V")
