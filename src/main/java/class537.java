...
public class class537 extends class459 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(I)Z", line = 8)
    ...
    @OriginalMember(owner = "client!qj", name = "b", descriptor = "(Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lgda;[IBLgda;)V", line = 40)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(ZLcaa;)V", line = 60)
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(Lsu;)V", line = 81)
