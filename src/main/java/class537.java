...
public class class537 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Luq;)V")
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ILdc;)V")
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ILdc;I)V")
