...
public class class537 {
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(B)Lef;", line = 12)
    ...
    @OriginalMember(owner = "client!pga", name = "b", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(I)I", line = 51)
