...
public class class537 extends class157 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IIIIIIIII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ZI)I", line = 22)
    ...
    @OriginalMember(owner = "client!jd", name = "z", descriptor = "(I)Z", line = 56)
    ...
    @OriginalMember(owner = "client!jd", name = "A", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "(I)V", line = 100)
    public class537(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jd", name = "B", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!jd", name = "h", descriptor = "(B)I", line = 116)
    ...
    @OriginalMember(owner = "client!jd", name = "C", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(III[B)V", line = 144)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(BLjh;)V", line = 168)
    ...
    @OriginalMember(owner = "client!jd", name = "D", descriptor = "(I)V", line = 180)
    ...
    @OriginalMember(owner = "client!jd", name = "p", descriptor = "(II)I", line = 192)
    ...
    @OriginalMember(owner = "client!jd", name = "b", descriptor = "(IB)V", line = 204)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "([II)V", line = 219)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(III)Z", line = 235)
