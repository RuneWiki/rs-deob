...
public class class537 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IZ)V", line = 14)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(B)Z", line = 36)
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "(Lwga;)V", line = 139)
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(B)V", line = 115)
