...
public class class537 extends class55 implements class201 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "([ILq;)V", line = 3)
    ...
    @OriginalMember(owner = "client!v", name = "b", descriptor = "()V", line = 12)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "()[Lti;", line = 31)
    public final class406[] method599() {
        return this.field7856;
    }

    @OriginalMember(owner = "client!v", name = "c", descriptor = "()V", line = 37)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;IZ)V", line = 43)
    public final void method634(class393 arg0, int arg1, boolean arg2) {
        this.method3263(((class94) arg0).nativeid, arg1, arg2);
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(BIZ)Lda;", line = 49)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;Lb;II)V", line = 60)
    ...
    @OriginalMember(owner = "client!v", name = "e", descriptor = "()Z", line = 76)
    public final boolean method637() {
        return true;
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;)V", line = 85)
    ...
    @OriginalMember(owner = "client!v", name = "d", descriptor = "()V", line = 145)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lda;IIIZ)V", line = 156)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(I[IIIIIZ)V", line = 159)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IIII)V", line = 164)
    public final void method636(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!v", name = "f", descriptor = "()[Lrea;", line = 167)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;Lb;I)V", line = 185)
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(Ll;Lm;Luo;IIII)V", line = 200)
