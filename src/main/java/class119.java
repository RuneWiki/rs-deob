...
public class class119 extends class46 {
    ...
    @OriginalMember(owner = "client!laa", name = "b", descriptor = "(III)V", line = 8)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(IIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(ZII)V", line = 45)
    ...
    @OriginalMember(owner = "client!laa", name = "<init>", descriptor = "(IIIIIII)V", line = 67)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(III)V", line = 82)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 100)
