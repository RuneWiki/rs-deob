...
public class class119 extends class9 {
    ...
    @OriginalMember(owner = "client!mg", name = "D", descriptor = "Lfg;")
    ...
    @OriginalMember(owner = "client!mg", name = "e", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!mg", name = "<init>", descriptor = "(Lke;I)V")
