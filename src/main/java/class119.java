...
public class class119 extends class208 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Ld;IBZ)V")
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(ZLuaa;)V")
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Luaa;B)V")
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Luaa;Z)V")
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Ltq;Ljava/lang/Object;I)V")
