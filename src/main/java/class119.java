...
public abstract class class119 extends class7 {
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(II)V", line = 7)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(I[BIZ)Z", line = 18)
    ...
    @OriginalMember(owner = "client!p", name = "f", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Ljava/awt/Component;IILap;I)Lbp;", line = 125)
    ...
    @OriginalMember(owner = "client!p", name = "<init>", descriptor = "(Lvh;)V", line = 226)
