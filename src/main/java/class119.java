...
public class class119 extends class189 {
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(II)Z", line = 20)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IIIII)I", line = 34)
    ...
    @OriginalMember(owner = "client!ei", name = "e", descriptor = "(B)Z", line = 47)
    ...
    @OriginalMember(owner = "client!ei", name = "c", descriptor = "(II)Z", line = 141)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lms;I)V", line = 154)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(ZI)Z", line = 212)
    public final boolean method963(boolean arg0, int arg1) {
        field2082++;
        return arg0 ? this.field2081[arg1].field2627 : false;
    }

    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IIIIIII)V", line = 230)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(I)V", line = 819)
    public class119(int arg0) {
        this.field2090 = arg0;
    }

    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(I)V", line = 827)
