...
public class class119 extends class216 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 15)
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 25)
