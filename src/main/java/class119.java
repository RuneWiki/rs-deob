...
public class class119 extends IOException {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILni;)I", line = 3)
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 83)
    public class119(String arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(B)V", line = 93)
