...
public class class119 extends class485 {
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(B)J", line = 5)
    ...
    @OriginalMember(owner = "client!cw", name = "c", descriptor = "(I)J", line = 39)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!cw", name = "<init>", descriptor = "()V", line = 104)
    public class119() {
        this.field1948 = System.nanoTime();
        this.field1947 = System.nanoTime();
    }

    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(II)I", line = 67)
