...
public class class119 extends class221 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(III)Lufa;")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(B)Lfga;")
    ...
    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(III)Lcu;")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lin;BII)V")
    ...
    @OriginalMember(owner = "client!mc", name = "<init>", descriptor = "(ILsp;Lsp;Llfa;Lmu;I[BIZ)V")
