...
public class class119 extends class354 {
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(IB)[I", line = 5)
    ...
    @OriginalMember(owner = "client!cw", name = "<init>", descriptor = "()V", line = 38)
    public class119() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cw", name = "b", descriptor = "(IBI)I", line = 41)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(ILkh;IB)V", line = 55)
    ...
    @OriginalMember(owner = "client!cw", name = "d", descriptor = "(Z)V", line = 112)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(Lqs;[[BB)V", line = 127)
