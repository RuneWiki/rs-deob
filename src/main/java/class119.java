...
public class class119 extends class220 {
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(IIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IBLil;)V", line = 120)
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(II)[[I", line = 166)
    ...
    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "()V", line = 239)
    public class119() {
        super(1, false);
    }

    @OriginalMember(owner = "client!eh", name = "e", descriptor = "(I)V", line = 246)
    ...
    @OriginalMember(owner = "client!eh", name = "c", descriptor = "(IIII)V", line = 264)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(Lme;II)Lis;", line = 334)
