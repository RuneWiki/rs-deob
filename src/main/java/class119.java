...
public class class119 extends class276 {
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "()[I", line = 51)
    public final int[] method947() {
        return this.field2105;
    }

    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(II[IZ)V", line = 58)
