...
public class class119 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Z)V", line = 64)
