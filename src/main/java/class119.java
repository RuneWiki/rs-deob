...
public class class119 implements class394 {
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(ZIIFII)[I", line = 3)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(II)Lrn;", line = 14)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IB)Z", line = 41)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(II)Lns;", line = 74)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(ZIIFII)[I", line = 87)
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(Lg;Lg;Lg;)V", line = 118)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IIZFII)[F", line = 102)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IIIBII)I", line = 306)
