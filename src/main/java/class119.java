...
public class class119 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(I)Lbo;")
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(BLbo;)V")
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(BLbo;)V")
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Z)Lbo;")
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(B)Lbo;")
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(B)Lbo;")
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(III)Lun;")
