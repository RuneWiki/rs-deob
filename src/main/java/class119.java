...
public class class119 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(IIIILha;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Z)V", line = 101)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(ILwia;I)Lie;", line = 118)
