...
public class class119 extends InputStream {
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Ljava/lang/Object;BLii;)V", line = 3)
    ...
    @OriginalMember(owner = "client!hw", name = "read", descriptor = "()I", line = 32)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(III)V", line = 43)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;II)I", line = 65)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(B)V", line = 188)
    public static void method931(byte arg0) {
        field2014 = null;
        int var1 = -45 / ((arg0 + 33) / 36);
    }

    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IIIILwh;)V", line = 198)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IIIZIIILed;IIIII[I[I)I", line = 239)
