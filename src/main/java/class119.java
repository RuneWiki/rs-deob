...
public class class119 extends class445 implements class75 {
    ...
    @OriginalMember(owner = "client!nf", name = "<init>", descriptor = "(Lkd;Lwu;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IC)Z")
    ...
    @OriginalMember(owner = "client!nf", name = "<init>", descriptor = "(Lkd;Lwu;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!nf", name = "<init>", descriptor = "(Lkd;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IIIIII[BLwu;I)V")
    ...
    @OriginalMember(owner = "client!nf", name = "<init>", descriptor = "(Lkd;Lwu;Lbk;II)V")
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IIIII[FIILwu;)V")
