...
public class class119 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(II)V", line = 16)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(BI)Lne;", line = 45)
    ...
    @OriginalMember(owner = "client!co", name = "b", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "(Lcw;ILeq;)V", line = 104)
