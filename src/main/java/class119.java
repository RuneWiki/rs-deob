...
public class class119 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Lsn;Z)V")
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(I[[B[[I[[BLui;IZ[[BILfp;[[BILui;)V")
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ZLkg;)V")
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ILwe;II)V")
