...
public class class119 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ILjava/lang/String;B[Laa;)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "([Laa;IILjava/lang/String;)I", line = 126)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "([IILjava/lang/String;[Ljava/lang/String;[Laa;)I", line = 159)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(II)S", line = 409)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(B)V", line = 434)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(CII)I", line = 457)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(I[Laa;ILjava/lang/String;)I", line = 475)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 486)
    ...
    @OriginalMember(owner = "client!gg", name = "b", descriptor = "(II)I", line = 509)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "([Laa;BLjava/lang/String;)I", line = 520)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(I[Laa;Ljava/lang/String;ZI)I", line = 625)
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "([B)V", line = 644)
