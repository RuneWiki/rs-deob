...
public class class119 extends class367 implements class278 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!kg", name = "c", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!kg", name = "c", descriptor = "(I)I", line = 32)
    public final int method219(int arg0) {
        ++field1666;
        return arg0 != -17942 ? 41 : this.field1675.field1425;
    }

    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(I)Z", line = 43)
    ...
    @OriginalMember(owner = "client!kg", name = "f", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!kg", name = "e", descriptor = "(I)Z", line = 65)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lkm;I)V", line = 76)
    ...
    @OriginalMember(owner = "client!kg", name = "c", descriptor = "(Lkm;I)V", line = 86)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(I)I", line = 117)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(BC)Z", line = 132)
    ...
    @OriginalMember(owner = "client!kg", name = "g", descriptor = "(I)I", line = 167)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lkm;II)Lab;", line = 178)
    ...
    @OriginalMember(owner = "client!kg", name = "d", descriptor = "(Lkm;I)Lto;", line = 189)
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(Lkm;I)V", line = 236)
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "(Lkm;Lcj;IIIIIZII)V", line = 249)
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(Z)I", line = 261)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lkm;BII)Z", line = 273)
    ...
    @OriginalMember(owner = "client!kg", name = "h", descriptor = "(I)V", line = 292)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(ILkm;IZILkj;B)V", line = 304)
