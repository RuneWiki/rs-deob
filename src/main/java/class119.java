...
public class class119 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Z)Ldi;")
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Lhp;I)V")
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Lhp;II)V")
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Lkk;B)V")
