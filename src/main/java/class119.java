...
public class class119 extends class540 {
    ...
    @OriginalMember(owner = "client!jja", name = "a", descriptor = "(Lrv;I)V", line = 27)
    ...
    @OriginalMember(owner = "client!jja", name = "a", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!jja", name = "a", descriptor = "(III)Z", line = 84)
    ...
    @OriginalMember(owner = "client!jja", name = "<init>", descriptor = "()V", line = 119)
    public class119() {
    }

    @OriginalMember(owner = "client!jja", name = "<init>", descriptor = "(ZLkj;)V", line = 125)
