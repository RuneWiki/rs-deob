...
public class class119 extends class47 {
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 4)
    public class119(Object arg0, int arg1) {
        super(arg1);
        this.field1471 = new SoftReference(arg0);
    }

    @OriginalMember(owner = "client!hh", name = "d", descriptor = "(I)Z", line = 13)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 23)
