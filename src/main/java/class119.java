...
public abstract class class119 implements class416 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(II)Llo;", line = 6)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(I)I", line = 40)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ZZ)V", line = 70)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ILtf;I)Z", line = 93)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lvh;III)V", line = 254)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(BI)V", line = 281)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Z)V", line = 294)
    ...
    @OriginalMember(owner = "client!sq", name = "finalize", descriptor = "()V", line = 309)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(Z)I", line = 318)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(B)Z", line = 331)
    ...
    @OriginalMember(owner = "client!sq", name = "c", descriptor = "(B)V", line = 360)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Lug;IIIZ)V", line = 433)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ZI)V", line = 382)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(III)Lev;", line = 399)
    ...
    @OriginalMember(owner = "client!sq", name = "c", descriptor = "(I)V", line = 413)
