...
public class class119 extends class328 implements class238 {
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IBILha;)Z")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(Lha;Ltba;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(ILha;)Lrk;")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ZLha;)Loba;")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ILgt;)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Ljw;B)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lgda;Lha;IIZII)V")
