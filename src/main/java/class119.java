...
public class class119 extends class252 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ZII)V", line = 5)
    ...
    @OriginalMember(owner = "client!oq", name = "b", descriptor = "(III)V", line = 26)
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "(IIIIIII)V", line = 45)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(III)V", line = 57)
    ...
    @OriginalMember(owner = "client!oq", name = "b", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Lam;Lam;Z)V", line = 105)
