...
public class class119 extends class456 {
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!fg", name = "c", descriptor = "(B)V", line = 72)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(ZLjava/lang/String;ZLng;B)V", line = 96)
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "()V", line = 164)
    public class119() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(IBLre;)V", line = 180)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Z)V", line = 266)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(ILvg;B)V", line = 281)
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(II)[I", line = 468)
