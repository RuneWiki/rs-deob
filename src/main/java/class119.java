...
public abstract class class119 {
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IB)Z", line = 14)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(II)Lnfa;", line = 27)
    ...
    @OriginalMember(owner = "client!sk", name = "<init>", descriptor = "(III)V", line = 53)
