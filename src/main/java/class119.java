...
public class class119 {
    ...
    @OriginalMember(owner = "client!ud", name = "toString", descriptor = "()Ljava/lang/String;", line = 5)
    public final String toString() {
        field1552++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Lqa;Lse;III)V", line = 15)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "([BIZ)V", line = 67)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(I)[Lql;", line = 112)
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(II)I", line = 191)
    ...
    @OriginalMember(owner = "client!ud", name = "b", descriptor = "(I)V", line = 204)
