...
public class class119 extends class498 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IILjava/util/Random;)I", line = 8)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ZII)Lkw;", line = 35)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(I[B)V", line = 117)
