...
public class class119 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(I)[Lcc;", line = 4)
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IIIBLe;Loa;I)V", line = 37)
