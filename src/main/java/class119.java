...
public class class119 {
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(I)Led;")
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(ILvj;)V")
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(ILqo;)V")
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(B)Led;")
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IIILja;IZLbn;I)Lof;")
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(ILed;)V")
