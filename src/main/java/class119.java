...
public class class119 extends class309 {
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(ILjava/awt/Graphics;IIIB)V", line = 9)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(ILjava/awt/Graphics;II)V", line = 26)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 36)
