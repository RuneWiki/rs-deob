...
public class class119 extends class159 {
    ...
    @OriginalMember(owner = "client!jja", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!jja", name = "a", descriptor = "(IIII)V", line = 21)
    ...
    @OriginalMember(owner = "client!jja", name = "a", descriptor = "(Z)V", line = 84)
    ...
    @OriginalMember(owner = "client!jja", name = "b", descriptor = "(Z)V", line = 118)
