...
public class class119 extends class389 {
    ...
    @OriginalMember(owner = "client!co", name = "b", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IBIII)V", line = 49)
    ...
    @OriginalMember(owner = "client!co", name = "c", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Z)V", line = 96)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ZIJLha;B)V", line = 111)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "(Lha;Lnda;Lpd;J)V", line = 428)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lha;IJ)V", line = 382)
