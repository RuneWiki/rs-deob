...
public class class119 {
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(BI)Lrw;", line = 8)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!oda", name = "b", descriptor = "(B)V", line = 59)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(IB)V", line = 75)
    ...
    @OriginalMember(owner = "client!oda", name = "c", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!oda", name = "<init>", descriptor = "(Lsj;ILin;Lin;)V", line = 158)
    ...
    @OriginalMember(owner = "client!oda", name = "d", descriptor = "(B)V", line = 138)
