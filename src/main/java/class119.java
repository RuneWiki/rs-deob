...
public class class119 extends class101 {
    ...
    @OriginalMember(owner = "client!jja", name = "<init>", descriptor = "()V", line = 7)
    public class119() {
    }

    @OriginalMember(owner = "client!jja", name = "<init>", descriptor = "(I)V", line = 9)
    public class119(int arg0) {
        this.field1725 = arg0;
    }

    @OriginalMember(owner = "client!jja", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!jja", name = "b", descriptor = "(III)Lie;", line = 28)
