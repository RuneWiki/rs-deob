...
public abstract class class119 {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Lbg;B)Lsb;", line = 5)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Luo;Ljn;I)I", line = 41)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(ZLwo;)V", line = 74)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "(III)V", line = 100)
