...
public class class119 extends class536 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(ZLsp;I)V", line = 9)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(I)V", line = 370)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(ILtf;)V", line = 384)
