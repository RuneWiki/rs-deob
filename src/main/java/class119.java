...
public class class119 extends class477 {
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(II)V", line = 16)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(Loa;IILq;III[[[B[I[I[I[I[IIBIIZ)V", line = 84)
    ...
    @OriginalMember(owner = "client!bca", name = "<init>", descriptor = "(Lsr;)V", line = 238)
