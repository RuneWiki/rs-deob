...
public class class119 extends class315 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Ltg;B)V")
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Ltg;I)V")
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lna;IBFZ)V")
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ZLtg;)V")
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Ldn;II)Lov;")
