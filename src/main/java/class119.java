...
public class class119 extends class739 {
    ...
    @OriginalMember(owner = "client!rea", name = "c", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!rea", name = "<init>", descriptor = "()V", line = 18)
    public class119() {
        super(1, false);
    }

    @OriginalMember(owner = "client!rea", name = "b", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/String;", line = 34)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(BI)V", line = 57)
    ...
    @OriginalMember(owner = "client!rea", name = "b", descriptor = "(II)[[I", line = 310)
    ...
    @OriginalMember(owner = "client!rea", name = "c", descriptor = "(I)V", line = 364)
    ...
    @OriginalMember(owner = "client!rea", name = "b", descriptor = "(I)V", line = 467)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(Lsl;IB)V", line = 481)
