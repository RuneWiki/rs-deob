...
public class class119 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lza;B)V", line = 31)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(II)Z", line = 147)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;IBLjava/lang/String;I)V", line = 163)
