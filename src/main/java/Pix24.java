...
public class Pix24 extends Draw2D {
    ...
    public void method166(int arg0) {
        Draw2D.method141(this.field566, this.field565, this.field567, -810);
        if (arg0 >= 0) {
            this.field558 = -63;
        }
    }
    ...
    public void method167(int arg0, int arg1, int arg2) {
        ...
        int var6 = Draw2D.field523 * var5 + var4;
        int var7 = 0;
        int var8 = this.field567;
        int var9 = this.field566;
        int var10 = Draw2D.field523 - var9;
        int var11 = 0;
        if (arg1 != 0) {
            return;
        }
        if (var5 < Draw2D.field525) {
            int var12 = Draw2D.field525 - var5;
            var8 -= var12;
            var5 = Draw2D.field525;
            var7 += var9 * var12;
            var6 += Draw2D.field523 * var12;
        }
        if (var5 + var8 > Draw2D.field526) {
            var8 -= var5 + var8 - Draw2D.field526;
        }
        if (var4 < Draw2D.field527) {
            int var13 = Draw2D.field527 - var4;
            var9 -= var13;
            var4 = Draw2D.field527;
            var7 += var13;
            var6 += var13;
            var11 += var13;
            var10 += var13;
        }
        if (var4 + var9 > Draw2D.field528) {
            int var14 = var4 + var9 - Draw2D.field528;
            var9 -= var14;
            var11 += var14;
            var10 += var14;
        }
        if (var9 > 0 && var8 > 0) {
            this.method168(var9, var8, var6, Draw2D.field522, 14588, this.field565, var7, var10, var11);
        }
    }
    ...
    public void method169(int arg0, int arg1, int arg2) {
        ...
        if (var9 > 0 && var8 > 0) {
            this.method170(Draw2D.field522, this.field565, 0, var7, var6, var9, var8, var10, var11);
        }
    }
    ...
    public void method171(boolean arg0, int arg1, int arg2, int arg3) {
        ...
        int var7 = Draw2D.field523 * var6 + var5;
        int var8 = 0;
        if (arg0) {
            this.field564 = 166;
        }
        ...
        int var11 = Draw2D.field523 - var10;
        int var12 = 0;
        if (var6 < Draw2D.field525) {
            int var13 = Draw2D.field525 - var6;
            var9 -= var13;
            var6 = Draw2D.field525;
            var8 += var10 * var13;
            var7 += Draw2D.field523 * var13;
        }
        if (var6 + var9 > Draw2D.field526) {
            var9 -= var6 + var9 - Draw2D.field526;
        }
        if (var5 < Draw2D.field527) {
            int var14 = Draw2D.field527 - var5;
            var10 -= var14;
            var5 = Draw2D.field527;
            var8 += var14;
            var7 += var14;
            var12 += var14;
            var11 += var14;
        }
        if (var5 + var10 > Draw2D.field528) {
            int var15 = var5 + var10 - Draw2D.field528;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method172(this.field565, var10, arg2, var8, var9, this.field562, var12, Draw2D.field522, var11, 0, var7);
        }
    }
    ...
    public void method173(int[] arg0, int arg1, int arg2, int arg3, int[] arg4, int arg5, int arg6, int arg7, int arg8, int arg9) {
        ...
        try {
            ...
            int var18 = Draw2D.field523 * arg6 + arg5;
            for (int var19 = 0; var19 < arg3; var19++) {
                ...
                for (int var24 = -arg0[var19]; var24 < 0; var24++) {
                    Draw2D.field522[var21++] = this.field565[(var22 >> 16) + (var23 >> 16) * this.field566];
                    var22 += var15;
                    var23 -= var14;
                }
                var16 += var14;
    ...
    public void method174(int arg0, int arg1, Pix8 arg2, int arg3) {
        ...
        if (var10 > 0 && var9 > 0) {
            this.method175(var8, 0, Draw2D.field522, var10, var9, this.field565, true, var12, var7, var11, arg2.field577);
        }
    }
