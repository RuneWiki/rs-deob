...
public class Pix24 extends Draw2D {
    ...
    public void method181(int arg0) {
        Draw2D.method152(this.field669, this.field670, (byte) 7, this.field668);
        if (arg0 < 1 || arg0 > 1) {
            this.field666 = -2;
        }
    }
    ...
    public void method184(int arg0, int arg1, boolean arg2) {
        ...
        int var7 = Draw2D.field622 * var5 + var4;
        int var8 = 0;
        ...
        if (var10 > 0 && var9 > 0) {
            this.method185(var7, var8, false, this.field668, var10, var9, Draw2D.field621, var11, var12);
        }
    }
    ...
    public void method186(int arg0, int arg1, int arg2) {
        ...
        if (var4 + var9 > Draw2D.field627) {
            int var15 = var4 + var9 - Draw2D.field627;
            var9 -= var15;
            var11 += var15;
            var10 += var15;
        }
        if (var9 > 0 && var8 > 0) {
            this.method187(Draw2D.field621, this.field668, 0, var7, var6, var9, var8, var10, var11);
        }
    }
    ...
    public void method188(int arg0, int arg1, int arg2, int arg3) {
        ...
        if (var10 > 0 && var9 > 0) {
            this.method189(var11, var7, 0, var8, Draw2D.field621, this.field668, var12, 0, var9, var10, arg3);
        }
    }
    ...
    public void method190(int arg0, int arg1, int arg2, int[] arg3, byte arg4, int[] arg5, int arg6, int arg7, int arg8, int arg9, int arg10) {
        ...
        try {
            ...
            int var20 = Draw2D.field622 * arg0 + arg1;
            for (int var21 = 0; var21 < arg2; var21++) {
                ...
                for (int var26 = -arg3[var21]; var26 < 0; var26++) {
                    Draw2D.field621[var23++] = this.field668[(var24 >> 16) + (var25 >> 16) * this.field669];
                    var24 += var17;
                    var25 -= var16;
                }
                var18 += var16;
                var19 += var17;
                var20 += Draw2D.field622;
            }
    ...
    public void method191(int arg0, int arg1, int arg2, int arg3, int arg4, double arg5, int arg6, int arg7, int arg8) {
        ...
        try {
            ...
            int var19 = Draw2D.field622 * arg8 + arg7;
    ...
    public void method192(int arg0, int arg1, int arg2, Pix8 arg3) {
        ...
        if (var10 > 0 && var9 > 0) {
            this.method193(var9, this.field665, var11, var12, var8, this.field668, 0, arg3.field680, Draw2D.field621, var10, var7);
            if (arg1 < 4 || arg1 > 4) {
                this.field660 = !this.field660;
            }
        }
