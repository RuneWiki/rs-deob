...
public class Pix24 extends Draw2D {
    ...
    public void blitOpaque(int arg0, int arg1, int arg2) {
        ...
        int var6 = Draw2D.width2d * var5 + var4;
        int var7 = 0;
        int var8 = this.cropBottom;
        int var9 = this.cropRight;
        int var10 = Draw2D.width2d - var9;
        int var11 = 0;
        if (this._flowObfuscator12 != arg2) {
            this._flowObfuscator19 = !this._flowObfuscator19;
        }
        if (var5 < Draw2D.top) {
            int var12 = Draw2D.top - var5;
            var8 -= var12;
            var5 = Draw2D.top;
            var7 += var9 * var12;
            var6 += Draw2D.width2d * var12;
        }
        if (var5 + var8 > Draw2D.bottom) {
            var8 -= var5 + var8 - Draw2D.bottom;
        }
        if (var4 < Draw2D.left) {
            int var13 = Draw2D.left - var4;
            var9 -= var13;
            var4 = Draw2D.left;
            var7 += var13;
            var6 += var13;
        ...
        if (var4 + var9 > Draw2D.right) {
            int var14 = var4 + var9 - Draw2D.right;
            var9 -= var14;
            var11 += var14;
            var10 += var14;
        }
        if (var9 > 0 && var8 > 0) {
            this.copyPixels(var6, var9, var8, var11, var7, 28339, var10, this.pixels, Draw2D.data);
        }
    }
    ...
    public void draw(int arg0, int arg1, int arg2) {
        ...
        if (var9 > 0 && var8 > 0) {
            this.copyPixels(Draw2D.data, this.pixels, 0, var7, var6, var9, var8, var10, var11);
        }
    }
    ...
    public void drawAlpha(int arg0, int arg1, int arg2, boolean arg3) {
        ...
        int var8 = Draw2D.width2d * var7 + var5;
        int var9 = 0;
        int var10 = this.cropBottom;
        int var11 = this.cropRight;
        int var12 = Draw2D.width2d - var11;
        int var13 = 0;
        if (var7 < Draw2D.top) {
            ...
            var7 = Draw2D.top;
            var9 += var11 * var14;
            var8 += Draw2D.width2d * var14;
        }
        if (var7 + var10 > Draw2D.bottom) {
            var10 -= var7 + var10 - Draw2D.bottom;
        }
        if (var5 < Draw2D.left) {
            int var15 = Draw2D.left - var5;
            var11 -= var15;
            var5 = Draw2D.left;
            var9 += var15;
            var8 += var15;
        ...
        if (var5 + var11 > Draw2D.right) {
            int var16 = var5 + var11 - Draw2D.right;
            var11 -= var16;
            var13 += var16;
            var12 += var16;
        }
        if (var11 > 0 && var10 > 0) {
            this.copyPixelsAlpha(var9, var11, Draw2D.data, 0, this.pixels, var13, var10, var12, arg2, var8, 8);
        }
    }
    ...
    public void drawRotatedMasked(int arg0, int arg1, int[] arg2, int arg3, int[] arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10) {
        ...
        try {
            ...
            int var20 = Draw2D.width2d * arg7 + arg8;
            for (int var21 = 0; var21 < arg0; var21++) {
                ...
                for (int var26 = -arg2[var21]; var26 < 0; var26++) {
                    Draw2D.data[var23++] = this.pixels[(var24 >> 16) + (var25 >> 16) * this.cropRight];
                    var24 += var17;
                    var25 -= var16;
                }
                var18 += var16;
                var19 += var17;
                var20 += Draw2D.width2d;
            }
    ...
    public void drawRotated(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, double arg7, int arg8) {
        ...
        try {
            ...
            int var19 = Draw2D.width2d * arg0 + arg8;
    ...
    public void drawMasked(Pix8 arg0, boolean arg1, int arg2, int arg3) {
        ...
        int var7 = Draw2D.width2d * var6 + var5;
        int var8 = 0;
        if (arg1) {
        ...
        int var11 = Draw2D.width2d - var10;
        int var12 = 0;
        if (var6 < Draw2D.top) {
            int var13 = Draw2D.top - var6;
            var9 -= var13;
            var6 = Draw2D.top;
            var8 += var10 * var13;
            var7 += Draw2D.width2d * var13;
        }
        if (var6 + var9 > Draw2D.bottom) {
            var9 -= var6 + var9 - Draw2D.bottom;
        }
        if (var5 < Draw2D.left) {
            int var14 = Draw2D.left - var5;
            var10 -= var14;
            var5 = Draw2D.left;
            var8 += var14;
            var7 += var14;
        ...
        if (var5 + var10 > Draw2D.right) {
            int var15 = var5 + var10 - Draw2D.right;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.copyPixelsMasked(this.pixels, var10, arg0.pixels, var9, Draw2D.data, 0, this._flowObfuscator17, var11, var7, var12, var8);
        }
    }
