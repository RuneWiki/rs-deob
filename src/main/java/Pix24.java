...
public class Pix24 extends Draw2D {
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(Lxb;Ljava/lang/String;I)V")
    ...
    public void method180(boolean arg0) {
        ...
        Draw2D.method151(this.field662, this.field663, this.field661, 9);
    }
    ...
    public void method183(int arg0, boolean arg1, int arg2) {
        ...
        int var6 = Draw2D.field616 * var5 + var4;
        int var7 = 0;
        if (arg1) {
            return;
        }
        ...
        int var10 = Draw2D.field616 - var9;
        int var11 = 0;
        if (var5 < Draw2D.field618) {
            int var12 = Draw2D.field618 - var5;
            var8 -= var12;
            var5 = Draw2D.field618;
            var7 += var9 * var12;
            var6 += Draw2D.field616 * var12;
        }
        if (var5 + var8 > Draw2D.field619) {
            var8 -= var5 + var8 - Draw2D.field619;
        }
        if (var4 < Draw2D.field620) {
            int var13 = Draw2D.field620 - var4;
            var9 -= var13;
            var4 = Draw2D.field620;
            var7 += var13;
            var6 += var13;
            var11 += var13;
            var10 += var13;
        }
        if (var4 + var9 > Draw2D.field621) {
            int var14 = var4 + var9 - Draw2D.field621;
            var9 -= var14;
            var11 += var14;
            var10 += var14;
        }
        if (var9 > 0 && var8 > 0) {
            this.method184(var11, var7, this.field661, this.field652, var8, var9, var10, var6, Draw2D.field615);
        }
    }
    ...
    public void method185(byte arg0, int arg1, int arg2) {
        ...
        int var11 = Draw2D.field616 - var10;
        int var12 = 0;
        if (var5 < Draw2D.field618) {
            int var13 = Draw2D.field618 - var5;
            var9 -= var13;
            var5 = Draw2D.field618;
            var7 += var10 * var13;
            var6 += Draw2D.field616 * var13;
        }
        if (var5 + var9 > Draw2D.field619) {
            var9 -= var5 + var9 - Draw2D.field619;
        }
        if (var4 < Draw2D.field620) {
            int var14 = Draw2D.field620 - var4;
            var10 -= var14;
            var4 = Draw2D.field620;
            var7 += var14;
            var6 += var14;
        ...
        if (var4 + var10 > Draw2D.field621) {
            int var15 = var4 + var10 - Draw2D.field621;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method186(Draw2D.field615, this.field661, 0, var7, var6, var10, var9, var11, var12);
        }
    }
    ...
    public void method187(int arg0, int arg1, int arg2, int arg3) {
        ...
        int var7 = Draw2D.field616 * var6 + var5;
        int var8 = 0;
        int var9 = this.field663;
        int var10 = this.field662;
        int var11 = Draw2D.field616 - var10;
        int var12 = 0;
        if (var6 < Draw2D.field618) {
            int var13 = Draw2D.field618 - var6;
            var9 -= var13;
            var6 = Draw2D.field618;
            var8 += var10 * var13;
            var7 += Draw2D.field616 * var13;
        }
        if (var6 + var9 > Draw2D.field619) {
            var9 -= var6 + var9 - Draw2D.field619;
        }
        if (var5 < Draw2D.field620) {
            int var14 = Draw2D.field620 - var5;
            var10 -= var14;
            var5 = Draw2D.field620;
            var8 += var14;
            var7 += var14;
            var12 += var14;
            var11 += var14;
        }
        if (var5 + var10 > Draw2D.field621) {
            int var15 = var5 + var10 - Draw2D.field621;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method188(var11, var12, arg3, var10, Draw2D.field615, 0, var7, this.field656, var8, var9, this.field661);
        }
    }
    ...
    public void method189(int arg0, int arg1, int arg2, int arg3, int arg4, int[] arg5, int arg6, int[] arg7, int arg8, int arg9, int arg10) {
        ...
        try {
            ...
            int var20 = Draw2D.field616 * arg10 + arg4;
            for (int var21 = 0; var21 < arg3; var21++) {
                ...
                for (int var26 = -arg5[var21]; var26 < 0; var26++) {
                    Draw2D.field615[var23++] = this.field661[(var24 >> 16) + (var25 >> 16) * this.field662];
                    var24 += var17;
                    var25 -= var16;
                }
                var18 += var16;
                var19 += var17;
                var20 += Draw2D.field616;
            }
    ...
    public void method190(int arg0, int arg1, int arg2, int arg3, double arg4, int arg5, byte arg6, int arg7, int arg8) {
        ...
        try {
            ...
            int var19 = Draw2D.field616 * arg3 + arg2;
            for (int var20 = 0; var20 < arg1; var20++) {
                ...
                var17 += var15;
                var18 += var16;
                var19 += Draw2D.field616;
            }
        } catch (Exception var26) {
        }
    }

    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IILjb;I)V")
    public void method191(int arg0, int arg1, Pix8 arg2, int arg3) {
        ...
        int var8 = Draw2D.field616 * var7 + var6;
        int var9 = 0;
        int var10 = this.field663;
        int var11 = this.field662;
        int var12 = Draw2D.field616 - var11;
        int var13 = 0;
        if (var7 < Draw2D.field618) {
            int var14 = Draw2D.field618 - var7;
            var10 -= var14;
            var7 = Draw2D.field618;
            var9 += var11 * var14;
            var8 += Draw2D.field616 * var14;
        }
        if (var7 + var10 > Draw2D.field619) {
            var10 -= var7 + var10 - Draw2D.field619;
        }
        if (var6 < Draw2D.field620) {
            int var15 = Draw2D.field620 - var6;
            var11 -= var15;
            var6 = Draw2D.field620;
            var9 += var15;
            var8 += var15;
            var13 += var15;
            var12 += var15;
        }
        if (var6 + var11 > Draw2D.field621) {
            int var16 = var6 + var11 - Draw2D.field621;
            var11 -= var16;
            var13 += var16;
            var12 += var16;
        }
        if (var11 > 0 && var10 > 0) {
            this.method192(Draw2D.field615, var8, var9, var10, 5, var13, var11, 0, arg2.field675, var12, this.field661);
        }
    }
