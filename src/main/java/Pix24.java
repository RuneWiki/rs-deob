...
public class Pix24 extends Draw2D {
    ...
    public void method31() {
        Draw2D.method18(this.field52, this.field53, this.field54);
    }
    ...
    public void method32(int arg0, int arg1) {
        ...
        int var5 = Draw2D.field38 * var4 + var3;
        int var6 = 0;
        int var7 = this.field54;
        int var8 = this.field53;
        int var9 = Draw2D.field38 - var8;
        int var10 = 0;
        if (var4 < Draw2D.field40) {
            int var11 = Draw2D.field40 - var4;
            var7 -= var11;
            var4 = Draw2D.field40;
            var6 += var8 * var11;
            var5 += Draw2D.field38 * var11;
        }
        if (var4 + var7 > Draw2D.field41) {
            var7 -= var4 + var7 - Draw2D.field41;
        }
        if (var3 < Draw2D.field42) {
            int var12 = Draw2D.field42 - var3;
            var8 -= var12;
            var3 = Draw2D.field42;
            var6 += var12;
            var5 += var12;
        ...
        if (var3 + var8 > Draw2D.field43) {
            int var13 = var3 + var8 - Draw2D.field43;
            var8 -= var13;
            var10 += var13;
            var9 += var13;
        }
        if (var8 > 0 && var7 > 0) {
            this.method33(Draw2D.field37, this.field52, 0, var6, var5, var8, var7, var9, var10);
        }
    }
    ...
    public Pix24(Jagfile arg0, String arg1, int arg2) {
        ...
        for (int var9 = 0; var9 < arg2; var9++) {
            var5.field79 += 2;
            var4.field79 += var5.method47() * var5.method47();
            var5.field79++;
        }
    ...
    public void method34(int arg0, int arg1) {
        ...
        if (var8 > 0 && var7 > 0) {
            this.method35(Draw2D.field37, this.field52, var6, var5, var8, var7, var9, var10);
        }
    }
