...
public class Pix24 extends Draw2D {
    ...
    public void method180(int arg0) {
        Draw2D.method151(this.field658, this.field660, this.field659, -578);
        while (arg0 >= 0) {
    ...
    public void method183(int arg0, int arg1, int arg2) {
        ...
        int var6 = Draw2D.field615 * var5 + var4;
        int var7 = 0;
        if (arg0 != -47173) {
            return;
        }
        ...
        int var10 = Draw2D.field615 - var9;
        int var11 = 0;
        if (var5 < Draw2D.field617) {
            int var12 = Draw2D.field617 - var5;
            var8 -= var12;
            var5 = Draw2D.field617;
            var7 += var9 * var12;
            var6 += Draw2D.field615 * var12;
        }
        if (var5 + var8 > Draw2D.field618) {
            var8 -= var5 + var8 - Draw2D.field618;
        }
        if (var4 < Draw2D.field619) {
            int var13 = Draw2D.field619 - var4;
            var9 -= var13;
            var4 = Draw2D.field619;
            var7 += var13;
            var6 += var13;
            var11 += var13;
            var10 += var13;
        }
        if (var4 + var9 > Draw2D.field620) {
            int var14 = var4 + var9 - Draw2D.field620;
            var9 -= var14;
            var11 += var14;
            var10 += var14;
        }
        if (var9 > 0 && var8 > 0) {
            this.method184(var7, Draw2D.field614, this.field658, var6, var11, var10, -39661, var9, var8);
        }
    }
    ...
    public void method185(int arg0, int arg1, int arg2) {
        ...
        if (var9 > 0 && var8 > 0) {
            this.method186(Draw2D.field614, this.field658, 0, var7, var6, var9, var8, var10, var11);
        }
    }
    ...
    public void method187(int arg0, int arg1, int arg2, byte arg3) {
        ...
        int var8 = Draw2D.field615 * var6 + var5;
        int var9 = 0;
        int var10 = this.field660;
        int var11 = this.field659;
        int var12 = Draw2D.field615 - var11;
        int var13 = 0;
        if (var6 < Draw2D.field617) {
            int var14 = Draw2D.field617 - var6;
            var10 -= var14;
            var6 = Draw2D.field617;
            var9 += var11 * var14;
            var8 += Draw2D.field615 * var14;
        }
        if (var6 + var10 > Draw2D.field618) {
            var10 -= var6 + var10 - Draw2D.field618;
        }
        if (var5 < Draw2D.field619) {
            int var15 = Draw2D.field619 - var5;
            var11 -= var15;
        ...
        if (var5 + var11 > Draw2D.field620) {
            int var16 = var5 + var11 - Draw2D.field620;
            var11 -= var16;
            var13 += var16;
            var12 += var16;
        }
        if (var11 > 0 && var10 > 0) {
            this.method188(0, var12, this.field654, arg1, var9, this.field658, Draw2D.field614, var10, var11, var13, var8);
        }
    }
    ...
    public void method189(int arg0, int arg1, int arg2, int arg3, int[] arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int[] arg10) {
        ...
        try {
            ...
            int var20 = Draw2D.field615 * arg3 + arg6;
            for (int var21 = 0; var21 < arg2; var21++) {
                ...
                for (int var26 = -arg4[var21]; var26 < 0; var26++) {
                    Draw2D.field614[var23++] = this.field658[(var24 >> 16) + (var25 >> 16) * this.field659];
                    var24 += var17;
                    var25 -= var16;
                }
                var18 += var16;
                var19 += var17;
                var20 += Draw2D.field615;
            }
    ...
    public void method190(int arg0, int arg1, int arg2, byte arg3, int arg4, int arg5, int arg6, int arg7, double arg8) {
        ...
        try {
            ...
            int var19 = Draw2D.field615 * arg1 + arg0;
            for (int var20 = 0; var20 < arg4; var20++) {
                ...
                var17 += var15;
                var18 += var16;
                var19 += Draw2D.field615;
            }
        } catch (Exception var26) {
        }
    }

    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IIILjb;)V")
    public void method191(int arg0, int arg1, int arg2, Pix8 arg3) {
        int var5 = this.field661 + arg1;
        int var6 = this.field662 + arg0;
        int var7 = Draw2D.field615 * var6 + var5;
        int var8 = 0;
        int var9 = this.field660;
        int var10 = this.field659;
        int var11 = Draw2D.field615 - var10;
        int var12 = 0;
        if (arg2 <= 0) {
            return;
        }
        if (var6 < Draw2D.field617) {
            int var13 = Draw2D.field617 - var6;
            var9 -= var13;
            var6 = Draw2D.field617;
            var8 += var10 * var13;
            var7 += Draw2D.field615 * var13;
        }
        if (var6 + var9 > Draw2D.field618) {
            var9 -= var6 + var9 - Draw2D.field618;
        }
        if (var5 < Draw2D.field619) {
            int var14 = Draw2D.field619 - var5;
            var10 -= var14;
            var5 = Draw2D.field619;
            var8 += var14;
            var7 += var14;
        ...
        if (var5 + var10 > Draw2D.field620) {
            int var15 = var5 + var10 - Draw2D.field620;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method192(0, this.field658, var10, var9, -968, var12, arg3.field669, Draw2D.field614, var11, var7, var8);
        }
    }
