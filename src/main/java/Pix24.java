...
public class Pix24 extends Draw2D {
    ...
    public void method181(byte arg0) {
        if (this.field659 == arg0) {
            Draw2D.method152(this.field663, 501, this.field664, this.field662);
        }
    }
    ...
    public void method184(int arg0, int arg1, int arg2) {
        ...
        int var6 = Draw2D.field620 * var5 + var4;
        int var7 = 0;
        int var8 = this.field664;
        int var9 = this.field663;
        int var10 = Draw2D.field620 - var9;
        int var11 = 0;
        if (var5 < Draw2D.field622) {
            int var12 = Draw2D.field622 - var5;
            var8 -= var12;
            var5 = Draw2D.field622;
            var7 += var9 * var12;
            var6 += Draw2D.field620 * var12;
        }
        if (var5 + var8 > Draw2D.field623) {
            var8 -= var5 + var8 - Draw2D.field623;
        }
        if (var4 < Draw2D.field624) {
            int var13 = Draw2D.field624 - var4;
            var9 -= var13;
            var4 = Draw2D.field624;
            var7 += var13;
            var6 += var13;
            var11 += var13;
            var10 += var13;
        }
        if (var4 + var9 > Draw2D.field625) {
            int var14 = var4 + var9 - Draw2D.field625;
            var9 -= var14;
            var11 += var14;
            var10 += var14;
        }
        if (var9 > 0 && var8 > 0) {
            this.method185(var7, var11, var6, var8, Draw2D.field619, 820, this.field662, var10, var9);
        }
    }
    ...
    public void method186(boolean arg0, int arg1, int arg2) {
        ...
        if (var9 > 0 && var8 > 0) {
            this.method187(Draw2D.field619, this.field662, 0, var7, var6, var9, var8, var10, var11);
        }
    }
    ...
    public void method188(int arg0, int arg1, int arg2, boolean arg3) {
        ...
        int var7 = Draw2D.field620 * var6 + var5;
        int var8 = 0;
        int var9 = this.field664;
        int var10 = this.field663;
        int var11 = Draw2D.field620 - var10;
        int var12 = 0;
        if (!arg3) {
            for (int var13 = 1; var13 > 0; var13++) {
            }
        }
        if (var6 < Draw2D.field622) {
            int var14 = Draw2D.field622 - var6;
            var9 -= var14;
            var6 = Draw2D.field622;
            var8 += var10 * var14;
            var7 += Draw2D.field620 * var14;
        }
        if (var6 + var9 > Draw2D.field623) {
            var9 -= var6 + var9 - Draw2D.field623;
        }
        if (var5 < Draw2D.field624) {
            int var15 = Draw2D.field624 - var5;
            var10 -= var15;
        ...
        if (var5 + var10 > Draw2D.field625) {
            int var16 = var5 + var10 - Draw2D.field625;
            var10 -= var16;
            var12 += var16;
            var11 += var16;
        }
        if (var10 > 0 && var9 > 0) {
            this.method189(var7, this.field662, var12, var9, var8, Draw2D.field619, arg0, var10, var11, 0, 28593);
        }
    }
    ...
    public void method190(int arg0, int arg1, int arg2, int arg3, int[] arg4, int arg5, int arg6, int[] arg7, int arg8, int arg9, int arg10) {
        ...
        try {
            ...
            int var21 = Draw2D.field620 * arg3 + arg1;
            for (int var22 = 0; var22 < arg8; var22++) {
                ...
                for (int var27 = -arg4[var22]; var27 < 0; var27++) {
                    Draw2D.field619[var24++] = this.field662[(var25 >> 16) + (var26 >> 16) * this.field663];
                    var25 += var18;
                    var26 -= var17;
                }
                var19 += var17;
                var20 += var18;
                var21 += Draw2D.field620;
            }
    ...
    public void method191(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, double arg8) {
        ...
        try {
            ...
            int var20 = Draw2D.field620 * arg4 + arg3;
            for (int var21 = 0; var21 < arg5; var21++) {
                ...
                var18 += var16;
                var19 += var17;
                var20 += Draw2D.field620;
            }
        } catch (Exception var27) {
        }
    }

    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Ljb;IIB)V")
    public void method192(Pix8 arg0, int arg1, int arg2, byte arg3) {
        ...
        int var12 = Draw2D.field620 - var11;
        int var13 = 0;
        if (var6 < Draw2D.field622) {
            int var14 = Draw2D.field622 - var6;
            var10 -= var14;
        ...
        if (var6 + var10 > Draw2D.field623) {
            var10 -= var6 + var10 - Draw2D.field623;
        }
        if (var5 < Draw2D.field624) {
            int var15 = Draw2D.field624 - var5;
            var11 -= var15;
        ...
        if (var5 + var11 > Draw2D.field625) {
            int var16 = var5 + var11 - Draw2D.field625;
            var11 -= var16;
            var13 += var16;
            var12 += var16;
        }
        if (var11 > 0 && var10 > 0) {
            this.method193(var8, 0, this.field662, Draw2D.field619, arg0.field676, var13, var12, var10, var11, (byte) 5, var7);
        }
    }
