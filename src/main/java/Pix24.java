...
public class Pix24 extends Draw2D {
    ...
    public void method194(int arg0) {
        if (arg0 >= 3 && arg0 <= 3) {
            Draw2D.method165(this.field672, this.field673, this.field674, (byte) -59);
        }
    }
    ...
    public void method197(int arg0, int arg1, boolean arg2) {
        ...
        int var6 = Draw2D.field630 * var5 + var4;
        int var7 = 0;
        int var8 = this.field674;
        int var9 = this.field673;
        int var10 = Draw2D.field630 - var9;
        int var11 = 0;
        if (var5 < Draw2D.field632) {
            int var12 = Draw2D.field632 - var5;
            var8 -= var12;
            var5 = Draw2D.field632;
            var7 += var9 * var12;
            var6 += Draw2D.field630 * var12;
        }
        if (var5 + var8 > Draw2D.field633) {
            var8 -= var5 + var8 - Draw2D.field633;
        }
        if (var4 < Draw2D.field634) {
            int var13 = Draw2D.field634 - var4;
            var9 -= var13;
            var4 = Draw2D.field634;
            var7 += var13;
            var6 += var13;
            var11 += var13;
            var10 += var13;
        }
        if (var4 + var9 > Draw2D.field635) {
            int var14 = var4 + var9 - Draw2D.field635;
            var9 -= var14;
            var11 += var14;
            var10 += var14;
        }
        if (var9 > 0 && var8 > 0) {
            this.method198(Draw2D.field629, var6, (byte) 3, var8, var10, var7, this.field672, var11, var9);
            if (arg2) {
                this.field666 = -314;
            }
        }
    ...
    public void method199(int arg0, int arg1, int arg2) {
        ...
        int var7 = Draw2D.field630 * var5 + var4;
        int var8 = 0;
        int var9 = this.field674;
        int var10 = this.field673;
        int var11 = Draw2D.field630 - var10;
        int var12 = 0;
        if (var5 < Draw2D.field632) {
            int var13 = Draw2D.field632 - var5;
            var9 -= var13;
            var5 = Draw2D.field632;
            var8 += var10 * var13;
            var7 += Draw2D.field630 * var13;
        }
        if (var5 + var9 > Draw2D.field633) {
            var9 -= var5 + var9 - Draw2D.field633;
        }
        if (var4 < Draw2D.field634) {
            int var14 = Draw2D.field634 - var4;
            var10 -= var14;
            var4 = Draw2D.field634;
            var8 += var14;
            var7 += var14;
        ...
        if (var4 + var10 > Draw2D.field635) {
            int var15 = var4 + var10 - Draw2D.field635;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method200(Draw2D.field629, this.field672, 0, var8, var7, var10, var9, var11, var12);
        }
    }
    ...
    public void method201(int arg0, int arg1, int arg2, int arg3) {
        ...
        int var8 = Draw2D.field630 * var7 + var5;
        int var9 = 0;
        int var10 = this.field674;
        int var11 = this.field673;
        int var12 = Draw2D.field630 - var11;
        int var13 = 0;
        if (var7 < Draw2D.field632) {
            int var14 = Draw2D.field632 - var7;
            var10 -= var14;
            var7 = Draw2D.field632;
            var9 += var11 * var14;
            var8 += Draw2D.field630 * var14;
        }
        if (var7 + var10 > Draw2D.field633) {
            var10 -= var7 + var10 - Draw2D.field633;
        }
        if (var5 < Draw2D.field634) {
            int var15 = Draw2D.field634 - var5;
            var11 -= var15;
            var5 = Draw2D.field634;
            var9 += var15;
            var8 += var15;
            var13 += var15;
            var12 += var15;
        }
        if (var5 + var11 > Draw2D.field635) {
            int var16 = var5 + var11 - Draw2D.field635;
            var11 -= var16;
            var13 += var16;
            var12 += var16;
        }
        if (var11 > 0 && var10 > 0) {
            this.method202(var13, arg0, var8, 0, var11, Draw2D.field629, false, var12, var9, var10, this.field672);
        }
    }
    ...
    public void method203(int arg0, int[] arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int[] arg8, int arg9, int arg10) {
        ...
        try {
            ...
            int var21 = Draw2D.field630 * arg0 + arg7;
            for (int var22 = 0; var22 < arg3; var22++) {
                ...
                for (int var27 = -arg1[var22]; var27 < 0; var27++) {
                    Draw2D.field629[var24++] = this.field672[(var25 >> 16) + (var26 >> 16) * this.field673];
                    var25 += var18;
                    var26 -= var17;
                }
                var19 += var17;
                var20 += var18;
                var21 += Draw2D.field630;
            }
    ...
    public void method204(int arg0, int arg1, int arg2, int arg3, double arg4, int arg5, int arg6, int arg7, byte arg8) {
        ...
        try {
            ...
            int var19 = Draw2D.field630 * arg6 + arg2;
            for (int var20 = 0; var20 < arg3; var20++) {
                ...
                var17 += var15;
                var18 += var16;
                var19 += Draw2D.field630;
            }
        } catch (Exception var26) {
        }
    }

    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IBILkb;)V")
    public void method205(int arg0, byte arg1, int arg2, Pix8 arg3) {
        ...
        int var9 = Draw2D.field630 * var8 + var7;
        int var10 = 0;
        int var11 = this.field674;
        int var12 = this.field673;
        int var13 = Draw2D.field630 - var12;
        int var14 = 0;
        if (var8 < Draw2D.field632) {
            int var15 = Draw2D.field632 - var8;
            var11 -= var15;
            var8 = Draw2D.field632;
            var10 += var12 * var15;
            var9 += Draw2D.field630 * var15;
        }
        if (var8 + var11 > Draw2D.field633) {
            var11 -= var8 + var11 - Draw2D.field633;
        }
        if (var7 < Draw2D.field634) {
            int var16 = Draw2D.field634 - var7;
            var12 -= var16;
            var7 = Draw2D.field634;
            var10 += var16;
            var9 += var16;
            var14 += var16;
            var13 += var16;
        }
        if (var7 + var12 > Draw2D.field635) {
            int var17 = var7 + var12 - Draw2D.field635;
            var12 -= var17;
            var14 += var17;
            var13 += var17;
        }
        if (var12 > 0 && var11 > 0) {
            this.method206(var14, var9, Draw2D.field629, var13, this.field672, var12, 0, var10, arg3.field681, var11, 770);
        }
    }
