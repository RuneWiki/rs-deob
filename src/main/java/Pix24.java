...
public class Pix24 extends Draw2D {
    ...
    public void method181(int arg0) {
        ...
        Draw2D.method152(-682, this.field682, this.field681, this.field683);
    }
    ...
    public void method184(int arg0, int arg1, int arg2) {
        ...
        int var6 = Draw2D.field640 * var5 + var4;
        int var7 = 0;
        int var8 = this.field683;
        int var9 = this.field682;
        int var10 = Draw2D.field640 - var9;
        int var11 = 0;
        if (arg0 != -30783) {
            this.field679 = !this.field679;
        }
        if (var5 < Draw2D.field642) {
            int var12 = Draw2D.field642 - var5;
            var8 -= var12;
            var5 = Draw2D.field642;
            var7 += var9 * var12;
            var6 += Draw2D.field640 * var12;
        }
        if (var5 + var8 > Draw2D.field643) {
            var8 -= var5 + var8 - Draw2D.field643;
        }
        if (var4 < Draw2D.field644) {
            int var13 = Draw2D.field644 - var4;
            var9 -= var13;
            var4 = Draw2D.field644;
            var7 += var13;
            var6 += var13;
            var11 += var13;
            var10 += var13;
        }
        if (var4 + var9 > Draw2D.field645) {
            int var14 = var4 + var9 - Draw2D.field645;
            var9 -= var14;
            var11 += var14;
            var10 += var14;
        }
        if (var9 > 0 && var8 > 0) {
            this.method185(var8, var6, 0, var7, var10, Draw2D.field639, this.field681, var9, var11);
        }
    }
    ...
    public void method186(int arg0, boolean arg1, int arg2) {
        ...
        int var11 = Draw2D.field640 - var10;
        int var12 = 0;
        if (var5 < Draw2D.field642) {
            int var13 = Draw2D.field642 - var5;
            var9 -= var13;
            var5 = Draw2D.field642;
            var7 += var10 * var13;
            var6 += Draw2D.field640 * var13;
        }
        if (var5 + var9 > Draw2D.field643) {
            var9 -= var5 + var9 - Draw2D.field643;
        }
        if (var4 < Draw2D.field644) {
            int var14 = Draw2D.field644 - var4;
            var10 -= var14;
            var4 = Draw2D.field644;
            var7 += var14;
            var6 += var14;
        ...
        if (var4 + var10 > Draw2D.field645) {
            int var15 = var4 + var10 - Draw2D.field645;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method187(Draw2D.field639, this.field681, 0, var7, var6, var10, var9, var11, var12);
        }
    }
    ...
    public void method188(int arg0, int arg1, int arg2, byte arg3) {
        ...
        int var7 = Draw2D.field640 * var6 + var5;
        int var8 = 0;
        if (arg3 != 6) {
        ...
        int var12 = Draw2D.field640 - var11;
        int var13 = 0;
        if (var6 < Draw2D.field642) {
            int var14 = Draw2D.field642 - var6;
            var10 -= var14;
            var6 = Draw2D.field642;
            var8 += var11 * var14;
            var7 += Draw2D.field640 * var14;
        }
        if (var6 + var10 > Draw2D.field643) {
            var10 -= var6 + var10 - Draw2D.field643;
        }
        if (var5 < Draw2D.field644) {
            int var15 = Draw2D.field644 - var5;
            var11 -= var15;
            var5 = Draw2D.field644;
            var8 += var15;
            var7 += var15;
            var13 += var15;
            var12 += var15;
        }
        if (var5 + var11 > Draw2D.field645) {
            int var16 = var5 + var11 - Draw2D.field645;
            var11 -= var16;
            var13 += var16;
            var12 += var16;
        }
        if (var11 > 0 && var10 > 0) {
            this.method189(var7, arg1, var8, var12, this.field681, 0, false, Draw2D.field639, var11, var13, var10);
        }
    }
    ...
    public void method190(int arg0, int arg1, int arg2, int[] arg3, int arg4, int arg5, int arg6, int arg7, int[] arg8, int arg9, int arg10) {
        ...
        try {
            ...
            int var21 = Draw2D.field640 * arg9 + arg5;
            for (int var22 = 0; var22 < arg10; var22++) {
                ...
                for (int var27 = -arg8[var22]; var27 < 0; var27++) {
                    Draw2D.field639[var24++] = this.field681[(var25 >> 16) + (var26 >> 16) * this.field682];
                    var25 += var18;
                    var26 -= var17;
                }
                var19 += var17;
                var20 += var18;
                var21 += Draw2D.field640;
            }
    ...
    public void method191(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, double arg6, int arg7, int arg8) {
        ...
        try {
            ...
            int var19 = Draw2D.field640 * arg8 + arg5;
            for (int var20 = 0; var20 < arg2; var20++) {
                ...
                var17 += var15;
                var18 += var16;
                var19 += Draw2D.field640;
            }
        } catch (Exception var26) {
        }
    }

    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ILjb;BI)V")
    public void method192(int arg0, Pix8 arg1, byte arg2, int arg3) {
        ...
        int var8 = Draw2D.field640 * var6 + var5;
        int var9 = 0;
        int var10 = this.field683;
        int var11 = this.field682;
        int var12 = Draw2D.field640 - var11;
        ...
        if (var11 > 0 && var10 > 0) {
            this.method193(var13, Draw2D.field639, 80, this.field681, 0, var9, var8, var11, arg1.field692, var12, var10);
        }
    }
