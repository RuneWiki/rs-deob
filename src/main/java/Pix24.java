...
public class Pix24 extends Draw2D {
    ...
    public Pix24(int arg0, int arg1, int arg2) {
    ...
    public Pix24(byte[] arg0, java.awt.Component arg1, int arg2) {
        if (arg2 != 0) {
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(Ljava/lang/String;IILtb;)V")
    public Pix24(String arg0, int arg1, int arg2, Jagfile arg3) {
    ...
    public void method152(int arg0) {
        Draw2D.method127(this.field544, this.field548, this.field547, this.field549);
        if (arg0 == 0) {
            ;
        }
    }
    ...
    public void method153(boolean arg0, int arg1, int arg2) {
        ...
        int var6 = Draw2D.field507 * var5 + var4;
        int var7 = 0;
        if (arg0) {
            this.field546 = -451;
        }
        ...
        int var10 = Draw2D.field507 - var9;
        int var11 = 0;
        if (var5 < Draw2D.field509) {
            int var12 = Draw2D.field509 - var5;
            var8 -= var12;
            var5 = Draw2D.field509;
            var7 += var9 * var12;
            var6 += Draw2D.field507 * var12;
        }
        if (var5 + var8 > Draw2D.field510) {
            var8 -= var5 + var8 - Draw2D.field510;
        }
        if (var4 < Draw2D.field511) {
            int var13 = Draw2D.field511 - var4;
            var9 -= var13;
            var4 = Draw2D.field511;
            var7 += var13;
            var6 += var13;
            var11 += var13;
            var10 += var13;
        }
        if (var4 + var9 > Draw2D.field512) {
            int var14 = var4 + var9 - Draw2D.field512;
            var9 -= var14;
            var11 += var14;
            var10 += var14;
        }
        if (var9 > 0 && var8 > 0) {
            this.method154(var9, var11, this.field543, Draw2D.field506, var6, var10, this.field547, var7, var8);
        }
    }
    ...
    public void method155(int arg0, boolean arg1, int arg2) {
        ...
        if (var9 > 0 && var8 > 0) {
            this.method156(Draw2D.field506, this.field547, 0, var7, var6, var9, var8, var10, var11);
        }
    }
    ...
    public void method157(int arg0, int arg1, int arg2, int arg3) {
        ...
        int var7 = Draw2D.field507 * var6 + var5;
        int var8 = 0;
        int var9 = this.field549;
        int var10 = this.field548;
        int var11 = Draw2D.field507 - var10;
        int var12 = 0;
        if (var6 < Draw2D.field509) {
            int var13 = Draw2D.field509 - var6;
            var9 -= var13;
            var6 = Draw2D.field509;
            var8 += var10 * var13;
            var7 += Draw2D.field507 * var13;
        }
        if (var6 + var9 > Draw2D.field510) {
            var9 -= var6 + var9 - Draw2D.field510;
        }
        if (var5 < Draw2D.field511) {
            int var14 = Draw2D.field511 - var5;
            var10 -= var14;
            var5 = Draw2D.field511;
            var8 += var14;
            var7 += var14;
            var12 += var14;
            var11 += var14;
        }
        if (var5 + var10 > Draw2D.field512) {
            int var15 = var5 + var10 - Draw2D.field512;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method158(this.field547, var7, var12, 0, arg3, var8, var11, Draw2D.field506, var9, var10, (byte) 94);
        }
    }
    ...
    public void method159(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int[] arg6, int arg7, int[] arg8, int arg9) {
        ...
        try {
            ...
            int var18 = Draw2D.field507 * arg9 + arg0;
            for (int var19 = 0; var19 < arg4; var19++) {
                ...
                for (int var24 = -arg6[var19]; var24 < 0; var24++) {
                    Draw2D.field506[var21++] = this.field547[(var22 >> 16) + (var23 >> 16) * this.field548];
                    var22 += var15;
                    var23 -= var14;
                }
                var16 += var14;
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lhb;III)V")
    public void method160(Pix8 arg0, int arg1, int arg2, int arg3) {
        ...
        if (var10 > 0 && var9 > 0) {
            this.method161(Draw2D.field506, var8, 0, var9, false, var12, var7, var11, this.field547, arg0.field557, var10);
        }
    }
