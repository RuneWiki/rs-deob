...
public class Pix24 extends Draw2D {
    ...
    public void method180(byte arg0) {
        Draw2D.method151(-78, this.field665, this.field666, this.field667);
        if (arg0 == 5) {
            boolean var2 = false;
        } else {
            this.field658 = 4;
    ...
    public void method183(int arg0, int arg1, int arg2) {
        ...
        int var6 = Draw2D.field621 * var5 + var4;
        int var7 = 0;
        int var8 = this.field667;
        int var9 = this.field666;
        int var10 = Draw2D.field621 - var9;
        int var11 = 0;
        if (arg2 != 8) {
            for (int var12 = 1; var12 > 0; var12++) {
            }
        }
        if (var5 < Draw2D.field623) {
            int var13 = Draw2D.field623 - var5;
            var8 -= var13;
            var5 = Draw2D.field623;
            var7 += var9 * var13;
            var6 += Draw2D.field621 * var13;
        }
        if (var5 + var8 > Draw2D.field624) {
            var8 -= var5 + var8 - Draw2D.field624;
        }
        if (var4 < Draw2D.field625) {
            int var14 = Draw2D.field625 - var4;
            var9 -= var14;
            var4 = Draw2D.field625;
            var7 += var14;
            var6 += var14;
            var11 += var14;
            var10 += var14;
        }
        if (var4 + var9 > Draw2D.field626) {
            int var15 = var4 + var9 - Draw2D.field626;
            var9 -= var15;
            var11 += var15;
            var10 += var15;
        }
        if (var9 > 0 && var8 > 0) {
            this.method184(var7, Draw2D.field620, this.field665, var6, var9, var8, true, var10, var11);
        }
    }
    ...
    public void method185(int arg0, byte arg1, int arg2) {
        ...
        if (var5 < Draw2D.field623) {
            int var12 = Draw2D.field623 - var5;
            var8 -= var12;
            var5 = Draw2D.field623;
            var7 += var9 * var12;
            var6 += Draw2D.field621 * var12;
        }
        if (var5 + var8 > Draw2D.field624) {
            var8 -= var5 + var8 - Draw2D.field624;
        }
        if (var4 < Draw2D.field625) {
            int var13 = Draw2D.field625 - var4;
            var9 -= var13;
            var4 = Draw2D.field625;
            var7 += var13;
            var6 += var13;
        ...
        if (var4 + var9 > Draw2D.field626) {
            int var14 = var4 + var9 - Draw2D.field626;
            var9 -= var14;
            var11 += var14;
            var10 += var14;
        }
        if (var9 > 0 && var8 > 0) {
            this.method186(Draw2D.field620, this.field665, 0, var7, var6, var9, var8, var10, var11);
        }
    }
    ...
    public void method187(int arg0, int arg1, int arg2, int arg3) {
        ...
        int var8 = Draw2D.field621 * var7 + var5;
        int var9 = 0;
        int var10 = this.field667;
        int var11 = this.field666;
        int var12 = Draw2D.field621 - var11;
        int var13 = 0;
        if (var7 < Draw2D.field623) {
            int var14 = Draw2D.field623 - var7;
            var10 -= var14;
            var7 = Draw2D.field623;
            var9 += var11 * var14;
            var8 += Draw2D.field621 * var14;
        }
        if (var7 + var10 > Draw2D.field624) {
            var10 -= var7 + var10 - Draw2D.field624;
        }
        if (var5 < Draw2D.field625) {
            int var15 = Draw2D.field625 - var5;
            var11 -= var15;
            var5 = Draw2D.field625;
            var9 += var15;
            var8 += var15;
            var13 += var15;
            var12 += var15;
        }
        if (var5 + var11 > Draw2D.field626) {
            int var16 = var5 + var11 - Draw2D.field626;
            var11 -= var16;
            var13 += var16;
            var12 += var16;
        }
        if (var11 > 0 && var10 > 0) {
            this.method188(var9, arg0, var8, var10, Draw2D.field620, this.field665, var12, var13, 0, var11, false);
        }
    }
    ...
    public void method189(int[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int[] arg6, int arg7, int arg8, int arg9, int arg10) {
        ...
        try {
            ...
            int var20 = Draw2D.field621 * arg1 + arg10;
            for (int var21 = 0; var21 < arg5; var21++) {
                ...
                for (int var26 = -arg6[var21]; var26 < 0; var26++) {
                    Draw2D.field620[var23++] = this.field665[(var24 >> 16) + (var25 >> 16) * this.field666];
                    var24 += var17;
                    var25 -= var16;
                }
                var18 += var16;
                var19 += var17;
                var20 += Draw2D.field621;
            }
    ...
    public void method190(int arg0, double arg1, int arg2, int arg3, int arg4, int arg5, byte arg6, int arg7, int arg8) {
        ...
        try {
            ...
            int var20 = Draw2D.field621 * arg8 + arg5;
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ILjb;ZI)V")
    public void method191(int arg0, Pix8 arg1, boolean arg2, int arg3) {
        int var5 = this.field668 + arg0;
        int var6 = this.field669 + arg3;
        int var7 = Draw2D.field621 * var6 + var5;
        int var8 = 0;
        int var9 = this.field667;
        int var10 = this.field666;
        int var11 = Draw2D.field621 - var10;
        int var12 = 0;
        if (!arg2) {
            this.field664 = !this.field664;
        }
        if (var6 < Draw2D.field623) {
            int var13 = Draw2D.field623 - var6;
            var9 -= var13;
            var6 = Draw2D.field623;
            var8 += var10 * var13;
            var7 += Draw2D.field621 * var13;
        }
        if (var6 + var9 > Draw2D.field624) {
            var9 -= var6 + var9 - Draw2D.field624;
        }
        if (var5 < Draw2D.field625) {
            int var14 = Draw2D.field625 - var5;
            var10 -= var14;
            var5 = Draw2D.field625;
            var8 += var14;
            var7 += var14;
        ...
        if (var5 + var10 > Draw2D.field626) {
            int var15 = var5 + var10 - Draw2D.field626;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method192(var8, var7, var12, arg1.field675, var10, var11, 0, var9, this.field665, true, Draw2D.field620);
        }
    }
