...
public class Pix24 extends Draw2D {
    ...
    public void method194(byte arg0) {
        ...
        Draw2D.method165(-216, this.field668, this.field666, this.field667);
    }
    ...
    public void method197(int arg0, int arg1, int arg2) {
        ...
        int var6 = Draw2D.field624 * var5 + var4;
        int var7 = 0;
        if (arg1 != -18217) {
        ...
        int var11 = Draw2D.field624 - var10;
        int var12 = 0;
        if (var5 < Draw2D.field626) {
            int var13 = Draw2D.field626 - var5;
            var9 -= var13;
            var5 = Draw2D.field626;
            var7 += var10 * var13;
            var6 += Draw2D.field624 * var13;
        }
        if (var5 + var9 > Draw2D.field627) {
            var9 -= var5 + var9 - Draw2D.field627;
        }
        if (var4 < Draw2D.field628) {
            int var14 = Draw2D.field628 - var4;
            var10 -= var14;
            var4 = Draw2D.field628;
            var7 += var14;
            var6 += var14;
            var12 += var14;
            var11 += var14;
        }
        if (var4 + var10 > Draw2D.field629) {
            int var15 = var4 + var10 - Draw2D.field629;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method198(0, Draw2D.field623, var12, this.field666, var7, var6, var11, var9, var10);
        }
    }
    ...
    public void method199(int arg0, int arg1, int arg2) {
        ...
        int var10 = Draw2D.field624 - var9;
        int var11 = 0;
        if (var5 < Draw2D.field626) {
            int var12 = Draw2D.field626 - var5;
            var8 -= var12;
            var5 = Draw2D.field626;
            var7 += var9 * var12;
            var6 += Draw2D.field624 * var12;
        }
        if (var5 + var8 > Draw2D.field627) {
            var8 -= var5 + var8 - Draw2D.field627;
        }
        if (var4 < Draw2D.field628) {
            int var13 = Draw2D.field628 - var4;
            var9 -= var13;
            var4 = Draw2D.field628;
            var7 += var13;
            var6 += var13;
        ...
        if (var4 + var9 > Draw2D.field629) {
            int var14 = var4 + var9 - Draw2D.field629;
            var9 -= var14;
            var11 += var14;
            var10 += var14;
        }
        if (var9 > 0 && var8 > 0) {
            this.method200(Draw2D.field623, this.field666, 0, var7, var6, var9, var8, var10, var11);
        }
    }
    ...
    public void method201(int arg0, int arg1, int arg2, int arg3) {
        ...
        int var7 = Draw2D.field624 * var6 + var5;
        int var8 = 0;
        int var9 = this.field668;
        int var10 = this.field667;
        int var11 = Draw2D.field624 - var10;
        int var12 = 0;
        if (var6 < Draw2D.field626) {
            int var13 = Draw2D.field626 - var6;
            var9 -= var13;
            var6 = Draw2D.field626;
            var8 += var10 * var13;
            var7 += Draw2D.field624 * var13;
        }
        if (var6 + var9 > Draw2D.field627) {
            var9 -= var6 + var9 - Draw2D.field627;
        }
        if (var5 < Draw2D.field628) {
            int var14 = Draw2D.field628 - var5;
            var10 -= var14;
            var5 = Draw2D.field628;
            var8 += var14;
            var7 += var14;
            var12 += var14;
            var11 += var14;
        }
        if (var5 + var10 > Draw2D.field629) {
            int var15 = var5 + var10 - Draw2D.field629;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method202(var10, this.field660, var8, var7, Draw2D.field623, arg2, 0, this.field666, var12, var9, var11);
            int var16 = 88 / arg1;
        }
    }
    ...
    public void method203(int arg0, int[] arg1, int arg2, int[] arg3, boolean arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10) {
        ...
        try {
            ...
            int var20 = Draw2D.field624 * arg8 + arg5;
            for (int var21 = 0; var21 < arg7; var21++) {
                ...
                for (int var26 = -arg3[var21]; var26 < 0; var26++) {
                    Draw2D.field623[var23++] = this.field666[(var24 >> 16) + (var25 >> 16) * this.field667];
                    var24 += var17;
                    var25 -= var16;
                }
                var18 += var16;
                var19 += var17;
                var20 += Draw2D.field624;
            }
    ...
    public void method204(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, double arg7, int arg8) {
        ...
        try {
            ...
            int var19 = Draw2D.field624 * arg0 + arg4;
            for (int var20 = 0; var20 < arg1; var20++) {
                ...
                var17 += var15;
                var18 += var16;
                var19 += Draw2D.field624;
            }
        } catch (Exception var26) {
        }
    }

    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ZLkb;II)V")
    public void method205(boolean arg0, Pix8 arg1, int arg2, int arg3) {
        ...
        if (var10 > 0 && var9 > 0) {
            this.method206(var8, var12, 0, this.field666, arg1.field674, var10, var9, Draw2D.field623, (byte) 118, var11, var7);
        }
    }
