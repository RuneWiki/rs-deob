...
public class Pix24 extends Draw2D {
    ...
    public Pix24(Jagfile arg0, String arg1, int arg2) {
        Packet var4 = new Packet(363, arg0.method257(arg1 + ".dat", null, (byte) 2));
        Packet var5 = new Packet(363, arg0.method257("index.dat", null, (byte) 2));
    ...
    public void method171(byte arg0) {
        ...
        Draw2D.method146(this.field578, this.field577, -657, this.field579);
    }
    ...
    public void method173(int arg0, int arg1, int arg2) {
        ...
        int var6 = Draw2D.field534 * var5 + var4;
        int var7 = 0;
        int var8 = this.field579;
        int var9 = this.field578;
        int var10 = Draw2D.field534 - var9;
        int var11 = 0;
        if (var5 < Draw2D.field536) {
            int var12 = Draw2D.field536 - var5;
            var8 -= var12;
            var5 = Draw2D.field536;
            var7 += var9 * var12;
            var6 += Draw2D.field534 * var12;
        }
        if (var5 + var8 > Draw2D.field537) {
            var8 -= var5 + var8 - Draw2D.field537;
        }
        if (var4 < Draw2D.field538) {
            int var13 = Draw2D.field538 - var4;
            var9 -= var13;
            var4 = Draw2D.field538;
            var7 += var13;
            var6 += var13;
            var11 += var13;
            var10 += var13;
        }
        if (var4 + var9 > Draw2D.field539) {
            int var14 = var4 + var9 - Draw2D.field539;
            var9 -= var14;
            var11 += var14;
            var10 += var14;
        }
        if (var9 > 0 && var8 > 0) {
            this.method174(15223, this.field577, var10, var8, var7, var11, var6, var9, Draw2D.field533);
            if (arg0 != 34676) {
                this.field573 = 117;
            }
        }
    ...
    public void method175(int arg0, int arg1, boolean arg2) {
        ...
        if (var9 > 0 && var8 > 0) {
            this.method176(Draw2D.field533, this.field577, 0, var7, var6, var9, var8, var10, var11);
        }
    }
    ...
    public void method177(int arg0, int arg1, int arg2, int arg3, int arg4) {
        ...
        try {
            ...
            int var20 = Draw2D.field534 * var17 + var16;
            int var21 = Draw2D.field534 - var18;
            if (var17 < Draw2D.field536) {
                int var22 = Draw2D.field536 - var17;
                var19 -= var22;
                var17 = 0;
                var20 += Draw2D.field534 * var22;
                var9 += var15 * var22;
            }
            if (var17 + var19 > Draw2D.field537) {
                var19 -= var17 + var19 - Draw2D.field537;
            }
            if (var16 < Draw2D.field538) {
                int var23 = Draw2D.field538 - var16;
                var18 -= var23;
                var16 = 0;
                var20 += var23;
                var8 += var14 * var23;
            ...
            if (var16 + var18 > Draw2D.field539) {
                int var24 = var16 + var18 - Draw2D.field539;
                var18 -= var24;
                var21 += var24;
            }
            this.method178(var8, var14, Draw2D.field533, 0, var15, var9, 0, this.field577, var21, var20, var19, var6, var18);
    ...
    public void method179(int arg0, int arg1, int arg2, byte arg3) {
        ...
        int var8 = Draw2D.field534 * var7 + var6;
        int var9 = 0;
        int var10 = this.field579;
        int var11 = this.field578;
        int var12 = Draw2D.field534 - var11;
        int var13 = 0;
        if (var7 < Draw2D.field536) {
            int var14 = Draw2D.field536 - var7;
            var10 -= var14;
            var7 = Draw2D.field536;
            var9 += var11 * var14;
            var8 += Draw2D.field534 * var14;
        }
        if (var7 + var10 > Draw2D.field537) {
            var10 -= var7 + var10 - Draw2D.field537;
        }
        if (var6 < Draw2D.field538) {
            int var15 = Draw2D.field538 - var6;
            var11 -= var15;
            var6 = Draw2D.field538;
            var9 += var15;
            var8 += var15;
            var13 += var15;
            var12 += var15;
        }
        if (var6 + var11 > Draw2D.field539) {
            int var16 = var6 + var11 - Draw2D.field539;
            var11 -= var16;
            var13 += var16;
            var12 += var16;
        }
        if (var11 > 0 && var10 > 0) {
            this.method180(var8, 0, this.field577, arg0, var10, Draw2D.field533, var9, (byte) 8, var11, var12, var13);
        }
    }
    ...
    public void method181(int arg0, int arg1, int[] arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, boolean arg9, int[] arg10) {
        ...
        try {
            ...
            int var20 = Draw2D.field534 * arg8 + arg7;
            for (int var21 = 0; var21 < arg3; var21++) {
                ...
                for (int var26 = -arg10[var21]; var26 < 0; var26++) {
                    Draw2D.field533[var23++] = this.field577[(var24 >> 16) + (var25 >> 16) * this.field578];
                    var24 += var17;
                    var25 -= var16;
                }
                var18 += var16;
                var19 += var17;
                var20 += Draw2D.field534;
            }
        } catch (Exception var27) {
        }
    }

    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lib;IIB)V")
    public void method182(Pix8 arg0, int arg1, int arg2, byte arg3) {
        int var5 = this.field580 + arg2;
        int var6 = this.field581 + arg1;
        int var7 = Draw2D.field534 * var6 + var5;
        int var8 = 0;
        if (arg3 != -15) {
            return;
        }
        ...
        int var11 = Draw2D.field534 - var10;
        int var12 = 0;
        if (var6 < Draw2D.field536) {
            int var13 = Draw2D.field536 - var6;
            var9 -= var13;
            var6 = Draw2D.field536;
            var8 += var10 * var13;
            var7 += Draw2D.field534 * var13;
        }
        if (var6 + var9 > Draw2D.field537) {
            var9 -= var6 + var9 - Draw2D.field537;
        }
        if (var5 < Draw2D.field538) {
            int var14 = Draw2D.field538 - var5;
            var10 -= var14;
            var5 = Draw2D.field538;
            var8 += var14;
            var7 += var14;
            var12 += var14;
            var11 += var14;
        }
        if (var5 + var10 > Draw2D.field539) {
            int var15 = var5 + var10 - Draw2D.field539;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method183(var10, var12, 0, -478, var9, var8, Draw2D.field533, this.field577, var7, arg0.field588, var11);
        }
    }
