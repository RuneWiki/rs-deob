...
public class Pix24 extends Draw2D {
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(Lyb;Ljava/lang/String;I)V")
    ...
    public void method180(int arg0) {
        Draw2D.method151(this.field662, this.field664, this.field665, this.field666);
        if (arg0 == 0) {
            ;
        }
    }
    ...
    public void method183(int arg0, int arg1, int arg2) {
        ...
        int var6 = Draw2D.field622 * var5 + var4;
        int var7 = 0;
        int var8 = this.field666;
        int var9 = this.field665;
        int var10 = Draw2D.field622 - var9;
        int var11 = 0;
        if (var5 < Draw2D.field624) {
            int var12 = Draw2D.field624 - var5;
            var8 -= var12;
            var5 = Draw2D.field624;
            var7 += var9 * var12;
            var6 += Draw2D.field622 * var12;
        }
        if (var5 + var8 > Draw2D.field625) {
            var8 -= var5 + var8 - Draw2D.field625;
        }
        if (var4 < Draw2D.field626) {
            int var13 = Draw2D.field626 - var4;
            var9 -= var13;
            var4 = Draw2D.field626;
            var7 += var13;
            var6 += var13;
            var11 += var13;
            var10 += var13;
        }
        if (var4 + var9 > Draw2D.field627) {
            int var14 = var4 + var9 - Draw2D.field627;
            var9 -= var14;
            var11 += var14;
            var10 += var14;
        }
        if (var9 > 0 && var8 > 0) {
            this.method184(var11, var10, 875, var9, Draw2D.field621, var7, this.field664, var8, var6);
            if (arg2 == 0) {
                ;
            }
        }
    ...
    public void method185(byte arg0, int arg1, int arg2) {
        ...
        int var11 = Draw2D.field622 - var10;
        int var12 = 0;
        if (var5 < Draw2D.field624) {
            int var13 = Draw2D.field624 - var5;
            var9 -= var13;
            var5 = Draw2D.field624;
            var7 += var10 * var13;
            var6 += Draw2D.field622 * var13;
        }
        if (var5 + var9 > Draw2D.field625) {
            var9 -= var5 + var9 - Draw2D.field625;
        }
        if (var4 < Draw2D.field626) {
            int var14 = Draw2D.field626 - var4;
            var10 -= var14;
            var4 = Draw2D.field626;
            var7 += var14;
            var6 += var14;
        ...
        if (var4 + var10 > Draw2D.field627) {
            int var15 = var4 + var10 - Draw2D.field627;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method186(Draw2D.field621, this.field664, 0, var7, var6, var10, var9, var11, var12);
        }
    }
    ...
    public void method187(int arg0, int arg1, int arg2, int arg3) {
        ...
        int var7 = Draw2D.field622 * var6 + var5;
        int var8 = 0;
        if (arg3 != 23391) {
            this.field662 = 148;
        }
        ...
        int var11 = Draw2D.field622 - var10;
        int var12 = 0;
        if (var6 < Draw2D.field624) {
            int var13 = Draw2D.field624 - var6;
            var9 -= var13;
            var6 = Draw2D.field624;
            var8 += var10 * var13;
            var7 += Draw2D.field622 * var13;
        }
        if (var6 + var9 > Draw2D.field625) {
            var9 -= var6 + var9 - Draw2D.field625;
        }
        if (var5 < Draw2D.field626) {
            int var14 = Draw2D.field626 - var5;
            var10 -= var14;
            var5 = Draw2D.field626;
            var8 += var14;
            var7 += var14;
            var12 += var14;
            var11 += var14;
        }
        if (var5 + var10 > Draw2D.field627) {
            int var15 = var5 + var10 - Draw2D.field627;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method188(Draw2D.field621, arg1, (byte) 6, 0, var10, var11, var12, var9, var7, this.field664, var8);
        }
    }
    ...
    public void method189(int arg0, int arg1, int arg2, int arg3, int arg4, int[] arg5, int arg6, int[] arg7, int arg8, int arg9, int arg10) {
        ...
        try {
            ...
            int var21 = Draw2D.field622 * arg8 + arg9;
            for (int var22 = 0; var22 < arg10; var22++) {
                ...
                for (int var27 = -arg7[var22]; var27 < 0; var27++) {
                    Draw2D.field621[var24++] = this.field664[(var25 >> 16) + (var26 >> 16) * this.field665];
                    var25 += var18;
                    var26 -= var17;
                }
                var19 += var17;
                var20 += var18;
                var21 += Draw2D.field622;
            }
    ...
    public void method190(int arg0, double arg1, boolean arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
        ...
        try {
            ...
            int var19 = Draw2D.field622 * arg3 + arg6;
    ...
    public void method191(int arg0, int arg1, Pix8 arg2, int arg3) {
        ...
        if (var10 > 0 && var9 > 0) {
            this.method192(var10, var9, var7, var11, this.field664, arg2.field675, 0, Draw2D.field621, var12, -6210, var8);
        }
    }
