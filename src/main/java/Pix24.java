...
public class Pix24 extends Draw2D {
    ...
    public void method193(byte arg0) {
        Draw2D.method164(this.field670, -258, this.field671, this.field672);
        if (arg0 != -41) {
            this.field669 = -444;
        }
    }
    ...
    public void method196(int arg0, int arg1, int arg2) {
        ...
        int var6 = Draw2D.field631 * var5 + var4;
        int var7 = 0;
        int var8 = this.field672;
        int var9 = this.field671;
        int var10 = Draw2D.field631 - var9;
        int var11 = 0;
        if (var5 < Draw2D.field633) {
            int var12 = Draw2D.field633 - var5;
            var8 -= var12;
            var5 = Draw2D.field633;
            var7 += var9 * var12;
            var6 += Draw2D.field631 * var12;
        }
        if (var5 + var8 > Draw2D.field634) {
            var8 -= var5 + var8 - Draw2D.field634;
        }
        if (var4 < Draw2D.field635) {
            int var13 = Draw2D.field635 - var4;
            var9 -= var13;
            var4 = Draw2D.field635;
            var7 += var13;
            var6 += var13;
            var11 += var13;
            var10 += var13;
        }
        if (var4 + var9 > Draw2D.field636) {
            int var14 = var4 + var9 - Draw2D.field636;
            var9 -= var14;
            var11 += var14;
            var10 += var14;
        }
        if (var9 > 0 && var8 > 0) {
            this.method197(var10, var9, var7, Draw2D.field630, var11, this.field670, var6, true, var8);
        }
    }
    ...
    public void method198(int arg0, int arg1, int arg2) {
        ...
        if (var9 > 0 && var8 > 0) {
            this.method199(Draw2D.field630, this.field670, 0, var7, var6, var9, var8, var10, var11);
        }
    }
    ...
    public void method200(int arg0, int arg1, int arg2, int arg3) {
        ...
        int var8 = Draw2D.field631 * var6 + var5;
        int var9 = 0;
        int var10 = this.field672;
        int var11 = this.field671;
        int var12 = Draw2D.field631 - var11;
        int var13 = 0;
        if (var6 < Draw2D.field633) {
            int var14 = Draw2D.field633 - var6;
            var10 -= var14;
            var6 = Draw2D.field633;
            var9 += var11 * var14;
            var8 += Draw2D.field631 * var14;
        }
        if (var6 + var10 > Draw2D.field634) {
            var10 -= var6 + var10 - Draw2D.field634;
        }
        if (var5 < Draw2D.field635) {
            int var15 = Draw2D.field635 - var5;
            var11 -= var15;
            var5 = Draw2D.field635;
            var9 += var15;
            var8 += var15;
            var13 += var15;
            var12 += var15;
        }
        if (var5 + var11 > Draw2D.field636) {
            int var16 = var5 + var11 - Draw2D.field636;
            var11 -= var16;
            var13 += var16;
            var12 += var16;
        }
        if (var11 > 0 && var10 > 0) {
            this.method201(var8, var13, var12, var10, (byte) 6, this.field670, 0, var9, arg1, Draw2D.field630, var11);
        }
    }
    ...
    public void method202(int[] arg0, boolean arg1, int[] arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10) {
        ...
        try {
            ...
            int var20 = Draw2D.field631 * arg4 + arg10;
            for (int var21 = 0; var21 < arg6; var21++) {
                ...
                for (int var26 = -arg2[var21]; var26 < 0; var26++) {
                    Draw2D.field630[var23++] = this.field670[(var24 >> 16) + (var25 >> 16) * this.field671];
                    var24 += var17;
                    var25 -= var16;
                }
                var18 += var16;
                var19 += var17;
                var20 += Draw2D.field631;
            }
    ...
    public void method203(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, boolean arg6, double arg7, int arg8) {
        ...
        try {
            ...
            int var19 = Draw2D.field631 * arg5 + arg3;
            for (int var20 = 0; var20 < arg4; var20++) {
                ...
                var17 += var15;
                var18 += var16;
                var19 += Draw2D.field631;
            }
        } catch (Exception var26) {
        }
    }

    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ILkb;IB)V")
    public void method204(int arg0, Pix8 arg1, int arg2, byte arg3) {
        int var5 = this.field673 + arg0;
        int var6 = this.field674 + arg2;
        int var7 = Draw2D.field631 * var6 + var5;
        int var8 = 0;
        int var9 = this.field672;
        int var10 = this.field671;
        int var11 = Draw2D.field631 - var10;
        int var12 = 0;
        if (var6 < Draw2D.field633) {
            int var13 = Draw2D.field633 - var6;
            var9 -= var13;
            var6 = Draw2D.field633;
            var8 += var10 * var13;
            var7 += Draw2D.field631 * var13;
        }
        if (var6 + var9 > Draw2D.field634) {
            var9 -= var6 + var9 - Draw2D.field634;
        }
        if (var5 < Draw2D.field635) {
            int var14 = Draw2D.field635 - var5;
            var10 -= var14;
            var5 = Draw2D.field635;
            var8 += var14;
            var7 += var14;
        ...
        if (var5 + var10 > Draw2D.field636) {
            int var15 = var5 + var10 - Draw2D.field636;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method205(var8, var9, arg1.field682, var10, Draw2D.field630, 0, this.field670, var12, var11, var7, (byte) -75);
            if (arg3 != 2) {
                this.field669 = 429;
            }
        }
