...
public class Pix24 extends Draw2D {
    ...
    public void method186(byte arg0) {
        ...
        Draw2D.method161(this.field657, this.field659, this.field658, 7);
    }
    ...
    public void method188(int arg0, int arg1, int arg2) {
        ...
        int var6 = Draw2D.field617 * var5 + var4;
        int var7 = 0;
        int var8 = this.field659;
        int var9 = this.field658;
        int var10 = Draw2D.field617 - var9;
        int var11 = 0;
        if (var5 < Draw2D.field619) {
            int var12 = Draw2D.field619 - var5;
            var8 -= var12;
            var5 = Draw2D.field619;
            var7 += var9 * var12;
            var6 += Draw2D.field617 * var12;
        }
        if (var5 + var8 > Draw2D.field620) {
            var8 -= var5 + var8 - Draw2D.field620;
        }
        if (var4 < Draw2D.field621) {
            int var13 = Draw2D.field621 - var4;
            var9 -= var13;
            var4 = Draw2D.field621;
            var7 += var13;
            var6 += var13;
            var11 += var13;
            var10 += var13;
        }
        if (var4 + var9 > Draw2D.field622) {
            int var14 = var4 + var9 - Draw2D.field622;
            var9 -= var14;
            var11 += var14;
            var10 += var14;
        }
        if (var9 > 0 && var8 > 0) {
            this.method189(this.field657, 0, var10, Draw2D.field616, var8, var9, var7, var11, var6);
            if (arg0 != 8) {
                this.field652 = -42;
            }
        }
    ...
    public void method190(int arg0, int arg1, int arg2) {
        ...
        int var7 = Draw2D.field617 * var6 + var5;
        int var8 = 0;
        int var9 = this.field659;
        int var10 = this.field658;
        int var11 = Draw2D.field617 - var10;
        int var12 = 0;
        if (var6 < Draw2D.field619) {
            int var13 = Draw2D.field619 - var6;
            var9 -= var13;
            var6 = Draw2D.field619;
            var8 += var10 * var13;
            var7 += Draw2D.field617 * var13;
        }
        if (var6 + var9 > Draw2D.field620) {
            var9 -= var6 + var9 - Draw2D.field620;
        }
        if (var5 < Draw2D.field621) {
            int var14 = Draw2D.field621 - var5;
            var10 -= var14;
            var5 = Draw2D.field621;
            var8 += var14;
            var7 += var14;
            var12 += var14;
            var11 += var14;
        }
        if (var5 + var10 > Draw2D.field622) {
            int var15 = var5 + var10 - Draw2D.field622;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method191(Draw2D.field616, this.field657, 0, var8, var7, var10, var9, var11, var12);
        }
    }
    ...
    public void method192(int arg0, int arg1, int arg2, int arg3, boolean arg4) {
        ...
        try {
            ...
            int var20 = Draw2D.field617 * var17 + var16;
            int var21 = Draw2D.field617 - var18;
            if (var17 < Draw2D.field619) {
                int var22 = Draw2D.field619 - var17;
                var19 -= var22;
                var17 = 0;
                var20 += Draw2D.field617 * var22;
                var9 += var15 * var22;
            }
            if (var17 + var19 > Draw2D.field620) {
                var19 -= var17 + var19 - Draw2D.field620;
            }
            if (var16 < Draw2D.field621) {
                int var23 = Draw2D.field621 - var16;
                var18 -= var23;
                var16 = 0;
                var20 += var23;
                var8 += var14 * var23;
            ...
            if (var16 + var18 > Draw2D.field622) {
                int var24 = var16 + var18 - Draw2D.field622;
                var18 -= var24;
                var21 += var24;
            }
            this.method193(0, var14, var6, 945, var19, var18, var21, this.field657, var20, Draw2D.field616, var9, var15, var8);
    ...
    public void method194(int arg0, int arg1, int arg2, int arg3) {
        ...
        if (var10 > 0 && var9 > 0) {
            this.method195(var10, var11, 0, var7, var8, this.field657, Draw2D.field616, true, var12, arg0, var9);
        }
    }
    ...
    public void method196(int arg0, int arg1, int arg2, int arg3, boolean arg4, int arg5, int[] arg6, int arg7, int[] arg8, int arg9, int arg10) {
        ...
        try {
            ...
            int var20 = Draw2D.field617 * arg5 + arg7;
            for (int var21 = 0; var21 < arg3; var21++) {
                ...
                for (int var26 = -arg6[var21]; var26 < 0; var26++) {
                    Draw2D.field616[var23++] = this.field657[(var24 >> 16) + (var25 >> 16) * this.field658];
                    var24 += var17;
                    var25 -= var16;
                }
                var18 += var16;
                var19 += var17;
                var20 += Draw2D.field617;
            }
        } catch (Exception var27) {
        }
    }

    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IIILkb;)V")
    public void method197(int arg0, int arg1, int arg2, Pix8 arg3) {
        ...
        int var8 = Draw2D.field617 * var7 + var6;
        int var9 = 0;
        int var10 = this.field659;
        int var11 = this.field658;
        int var12 = Draw2D.field617 - var11;
        int var13 = 0;
        if (var7 < Draw2D.field619) {
            int var14 = Draw2D.field619 - var7;
            var10 -= var14;
            var7 = Draw2D.field619;
            var9 += var11 * var14;
            var8 += Draw2D.field617 * var14;
        }
        if (var7 + var10 > Draw2D.field620) {
            var10 -= var7 + var10 - Draw2D.field620;
        }
        if (var6 < Draw2D.field621) {
            int var15 = Draw2D.field621 - var6;
            var11 -= var15;
            var6 = Draw2D.field621;
            var9 += var15;
            var8 += var15;
            var13 += var15;
            var12 += var15;
        }
        if (var6 + var11 > Draw2D.field622) {
            int var16 = var6 + var11 - Draw2D.field622;
            var11 -= var16;
            var13 += var16;
            var12 += var16;
        }
        if (var11 > 0 && var10 > 0) {
            this.method198(0, var11, var9, Draw2D.field616, var10, var13, 0, this.field657, arg3.field671, var12, var8);
        }
    }
