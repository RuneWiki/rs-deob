...
public class Pix24 extends Draw2D {
    ...
    public void method194(boolean arg0) {
        if (!arg0) {
            Draw2D.method165(this.field671, this.field669, this.field670, this.field666);
        }
    }
    ...
    public void method197(byte arg0, int arg1, int arg2) {
        ...
        int var6 = Draw2D.field628 * var5 + var4;
        int var7 = 0;
        int var8 = this.field671;
        int var9 = this.field670;
        int var10 = Draw2D.field628 - var9;
        int var11 = 0;
        if (arg0 == 0) {
            boolean var12 = false;
        } else {
        ...
        if (var5 < Draw2D.field630) {
            int var14 = Draw2D.field630 - var5;
            var8 -= var14;
            var5 = Draw2D.field630;
            var7 += var9 * var14;
            var6 += Draw2D.field628 * var14;
        }
        if (var5 + var8 > Draw2D.field631) {
            var8 -= var5 + var8 - Draw2D.field631;
        }
        if (var4 < Draw2D.field632) {
            int var15 = Draw2D.field632 - var4;
            var9 -= var15;
            var4 = Draw2D.field632;
            var7 += var15;
            var6 += var15;
            var11 += var15;
            var10 += var15;
        }
        if (var4 + var9 > Draw2D.field633) {
            int var16 = var4 + var9 - Draw2D.field633;
            var9 -= var16;
            var11 += var16;
            var10 += var16;
        }
        if (var9 > 0 && var8 > 0) {
            this.method198(Draw2D.field627, var9, var11, var7, var10, var8, this.field669, var6, 267);
        }
    }
    ...
    public void method199(int arg0, int arg1, int arg2) {
        ...
        int var11 = 0;
        if (var5 < Draw2D.field630) {
            int var12 = Draw2D.field630 - var5;
            var8 -= var12;
            var5 = Draw2D.field630;
            var7 += var9 * var12;
            var6 += Draw2D.field628 * var12;
        }
        if (var5 + var8 > Draw2D.field631) {
            var8 -= var5 + var8 - Draw2D.field631;
        }
        if (var4 < Draw2D.field632) {
            int var13 = Draw2D.field632 - var4;
            var9 -= var13;
            var4 = Draw2D.field632;
            var7 += var13;
            var6 += var13;
        ...
        if (var4 + var9 > Draw2D.field633) {
            int var14 = var4 + var9 - Draw2D.field633;
            var9 -= var14;
            var11 += var14;
            var10 += var14;
        }
        if (var9 > 0 && var8 > 0) {
            this.method200(Draw2D.field627, this.field669, 0, var7, var6, var9, var8, var10, var11);
        }
    }
    ...
    public void method201(int arg0, int arg1, int arg2, int arg3) {
        ...
        int var8 = Draw2D.field628 * var7 + var5;
        int var9 = 0;
        int var10 = this.field671;
        int var11 = this.field670;
        int var12 = Draw2D.field628 - var11;
        int var13 = 0;
        if (var7 < Draw2D.field630) {
            int var14 = Draw2D.field630 - var7;
            var10 -= var14;
            var7 = Draw2D.field630;
            var9 += var11 * var14;
            var8 += Draw2D.field628 * var14;
        }
        if (var7 + var10 > Draw2D.field631) {
            var10 -= var7 + var10 - Draw2D.field631;
        }
        if (var5 < Draw2D.field632) {
            int var15 = Draw2D.field632 - var5;
            var11 -= var15;
        ...
        if (var5 + var11 > Draw2D.field633) {
            int var16 = var5 + var11 - Draw2D.field633;
            var11 -= var16;
            var13 += var16;
            var12 += var16;
        }
        if (var11 > 0 && var10 > 0) {
            this.method202(Draw2D.field627, var10, var12, arg1, 0, var13, var9, var11, this.field669, 0, var8);
        }
    }
    ...
    public void method203(int[] arg0, int arg1, int arg2, int[] arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10) {
        ...
        try {
            ...
            int var20 = Draw2D.field628 * arg1 + arg2;
            for (int var21 = 0; var21 < arg9; var21++) {
                ...
                for (int var26 = -arg3[var21]; var26 < 0; var26++) {
                    Draw2D.field627[var23++] = this.field669[(var24 >> 16) + (var25 >> 16) * this.field670];
                    var24 += var17;
                    var25 -= var16;
                }
                var18 += var16;
                var19 += var17;
                var20 += Draw2D.field628;
            }
    ...
    public void method204(int arg0, int arg1, boolean arg2, int arg3, int arg4, int arg5, int arg6, double arg7, int arg8) {
        ...
        try {
            ...
            int var19 = Draw2D.field628 * arg5 + arg0;
    ...
    public void method205(int arg0, int arg1, int arg2, Pix8 arg3) {
        ...
        int var7 = Draw2D.field628 * var6 + var5;
        int var8 = 0;
        if (arg2 != 0) {
            return;
        }
        ...
        int var11 = Draw2D.field628 - var10;
        int var12 = 0;
        if (var6 < Draw2D.field630) {
            int var13 = Draw2D.field630 - var6;
            var9 -= var13;
            var6 = Draw2D.field630;
            var8 += var10 * var13;
            var7 += Draw2D.field628 * var13;
        }
        if (var6 + var9 > Draw2D.field631) {
            var9 -= var6 + var9 - Draw2D.field631;
        }
        if (var5 < Draw2D.field632) {
            int var14 = Draw2D.field632 - var5;
            var10 -= var14;
            var5 = Draw2D.field632;
            var8 += var14;
            var7 += var14;
        ...
        if (var5 + var10 > Draw2D.field633) {
            int var15 = var5 + var10 - Draw2D.field633;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method206(var7, var10, var8, 0, var12, arg3.field682, this.field669, -395, var9, Draw2D.field627, var11);
        }
    }
