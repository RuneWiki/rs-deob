...
public class Pix24 extends Draw2D {
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "(Lub;Ljava/lang/String;I)V")
    ...
    public void method169(int arg0) {
        Draw2D.method144(this.field580, true, this.field581, this.field579);
        if (arg0 != 0) {
    ...
    public void method170(int arg0, int arg1, int arg2) {
        ...
        int var6 = Draw2D.field535 * var5 + var4;
        int var7 = 0;
        int var8 = this.field581;
        int var9 = this.field580;
        int var10 = Draw2D.field535 - var9;
        int var11 = 0;
        if (var5 < Draw2D.field537) {
            int var12 = Draw2D.field537 - var5;
            var8 -= var12;
            var5 = Draw2D.field537;
            var7 += var9 * var12;
            var6 += Draw2D.field535 * var12;
        }
        if (var5 + var8 > Draw2D.field538) {
            var8 -= var5 + var8 - Draw2D.field538;
        }
        if (var4 < Draw2D.field539) {
            int var13 = Draw2D.field539 - var4;
            var9 -= var13;
            var4 = Draw2D.field539;
            var7 += var13;
            var6 += var13;
            var11 += var13;
            var10 += var13;
        }
        if (var4 + var9 > Draw2D.field540) {
            int var14 = var4 + var9 - Draw2D.field540;
            var9 -= var14;
            var11 += var14;
            var10 += var14;
        }
        if (var9 > 0 && var8 > 0) {
            this.method171(var9, var6, (byte) -100, this.field579, var10, var8, var11, var7, Draw2D.field534);
            while (arg0 >= 0) {
            }
        }
    }
    ...
    public void method172(int arg0, int arg1, int arg2) {
        ...
        int var7 = Draw2D.field535 * var5 + var4;
        int var8 = 0;
        int var9 = this.field581;
        int var10 = this.field580;
        int var11 = Draw2D.field535 - var10;
        int var12 = 0;
        if (var5 < Draw2D.field537) {
            int var13 = Draw2D.field537 - var5;
            var9 -= var13;
            var5 = Draw2D.field537;
            var8 += var10 * var13;
            var7 += Draw2D.field535 * var13;
        }
        if (var5 + var9 > Draw2D.field538) {
            var9 -= var5 + var9 - Draw2D.field538;
        }
        if (var4 < Draw2D.field539) {
            int var14 = Draw2D.field539 - var4;
            var10 -= var14;
            var4 = Draw2D.field539;
            var8 += var14;
            var7 += var14;
        ...
        if (var4 + var10 > Draw2D.field540) {
            int var15 = var4 + var10 - Draw2D.field540;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method173(Draw2D.field534, this.field579, 0, var8, var7, var10, var9, var11, var12);
        }
    }
    ...
    public void method174(int arg0, int arg1, int arg2, int arg3, byte arg4) {
        ...
        try {
            ...
            int var21 = Draw2D.field535 * var18 + var17;
            int var22 = Draw2D.field535 - var19;
            if (var18 < Draw2D.field537) {
                int var23 = Draw2D.field537 - var18;
                var20 -= var23;
                var18 = 0;
                var21 += Draw2D.field535 * var23;
                var10 += var16 * var23;
            }
            if (var18 + var20 > Draw2D.field538) {
                var20 -= var18 + var20 - Draw2D.field538;
            }
            if (var17 < Draw2D.field539) {
                int var24 = Draw2D.field539 - var17;
                var19 -= var24;
                var17 = 0;
                var21 += var24;
                var9 += var15 * var24;
            ...
            if (var17 + var19 > Draw2D.field540) {
                int var25 = var17 + var19 - Draw2D.field540;
                var19 -= var25;
                var22 += var25;
            }
            this.method175(var9, var22, Draw2D.field534, 0, this.field576, var10, var20, var19, var21, var16, this.field579, var7, var15);
    ...
    public void method176(int arg0, byte arg1, int arg2, int arg3) {
        ...
        int var9 = Draw2D.field535 * var8 + var7;
        int var10 = 0;
        int var11 = this.field581;
        int var12 = this.field580;
        int var13 = Draw2D.field535 - var12;
        int var14 = 0;
        if (var8 < Draw2D.field537) {
            int var15 = Draw2D.field537 - var8;
            var11 -= var15;
            var8 = Draw2D.field537;
            var10 += var12 * var15;
            var9 += Draw2D.field535 * var15;
        }
        if (var8 + var11 > Draw2D.field538) {
            var11 -= var8 + var11 - Draw2D.field538;
        }
        if (var7 < Draw2D.field539) {
            int var16 = Draw2D.field539 - var7;
            var12 -= var16;
            var7 = Draw2D.field539;
            var10 += var16;
            var9 += var16;
            var14 += var16;
            var13 += var16;
        }
        if (var7 + var12 > Draw2D.field540) {
            int var17 = var7 + var12 - Draw2D.field540;
            var12 -= var17;
            var14 += var17;
            var13 += var17;
        }
        if (var12 > 0 && var11 > 0) {
            this.method177(arg3, -583, var12, 0, var13, var11, this.field579, var10, Draw2D.field534, var9, var14);
        }
    }
    ...
    public void method178(int arg0, int[] arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int[] arg9) {
        ...
        try {
            ...
            int var17 = Draw2D.field535 * arg3 + arg8;
            for (int var18 = 0; var18 < arg6; var18++) {
                ...
                for (int var23 = -arg1[var18]; var23 < 0; var23++) {
                    Draw2D.field534[var20++] = this.field579[(var21 >> 16) + (var22 >> 16) * this.field580];
                    var21 += var14;
                    var22 -= var13;
                }
                var15 += var13;
                var16 += var14;
                var17 += Draw2D.field535;
            }
        } catch (Exception var24) {
        }
    }

    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ILib;ZI)V")
    public void method179(int arg0, Pix8 arg1, boolean arg2, int arg3) {
        int var5 = this.field582 + arg3;
        int var6 = this.field583 + arg0;
        int var7 = Draw2D.field535 * var6 + var5;
        int var8 = 0;
        if (arg2) {
            return;
        }
        ...
        int var11 = Draw2D.field535 - var10;
        int var12 = 0;
        if (var6 < Draw2D.field537) {
            int var13 = Draw2D.field537 - var6;
            var9 -= var13;
            var6 = Draw2D.field537;
            var8 += var10 * var13;
            var7 += Draw2D.field535 * var13;
        }
        if (var6 + var9 > Draw2D.field538) {
            var9 -= var6 + var9 - Draw2D.field538;
        }
        if (var5 < Draw2D.field539) {
            int var14 = Draw2D.field539 - var5;
            var10 -= var14;
            var5 = Draw2D.field539;
            var8 += var14;
            var7 += var14;
            var12 += var14;
            var11 += var14;
        }
        if (var5 + var10 > Draw2D.field540) {
            int var15 = var5 + var10 - Draw2D.field540;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method180((byte) -20, var8, var12, arg1.field593, var7, var9, 0, var10, this.field579, Draw2D.field534, var11);
        }
    }
