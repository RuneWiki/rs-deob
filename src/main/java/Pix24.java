...
public class Pix24 extends Draw2D {
    ...
    public void method181(int arg0) {
        Draw2D.method152(this.field675, this.field674, this.field676, (byte) 5);
        if (arg0 == 9) {
            ;
        }
    }
    ...
    public void method184(boolean arg0, int arg1, int arg2) {
        ...
        int var6 = Draw2D.field633 * var5 + var4;
        int var7 = 0;
        int var8 = this.field676;
        int var9 = this.field675;
        int var10 = Draw2D.field633 - var9;
        int var11 = 0;
        if (var5 < Draw2D.field635) {
            int var12 = Draw2D.field635 - var5;
            var8 -= var12;
            var5 = Draw2D.field635;
            var7 += var9 * var12;
            var6 += Draw2D.field633 * var12;
        }
        if (var5 + var8 > Draw2D.field636) {
            var8 -= var5 + var8 - Draw2D.field636;
        }
        if (var4 < Draw2D.field637) {
            int var13 = Draw2D.field637 - var4;
            var9 -= var13;
            var4 = Draw2D.field637;
            var7 += var13;
            var6 += var13;
            var11 += var13;
            var10 += var13;
        }
        if (var4 + var9 > Draw2D.field638) {
            int var14 = var4 + var9 - Draw2D.field638;
            var9 -= var14;
            var11 += var14;
            var10 += var14;
        }
        if (var9 > 0 && var8 > 0) {
            this.method185(true, var10, var6, this.field674, var8, var7, Draw2D.field632, var11, var9);
        }
    }
    ...
    public void method186(int arg0, int arg1, int arg2) {
        ...
        int var7 = Draw2D.field633 * var5 + var4;
        int var8 = 0;
        int var9 = this.field676;
        int var10 = this.field675;
        int var11 = Draw2D.field633 - var10;
        int var12 = 0;
        if (var5 < Draw2D.field635) {
            int var13 = Draw2D.field635 - var5;
            var9 -= var13;
            var5 = Draw2D.field635;
            var8 += var10 * var13;
            var7 += Draw2D.field633 * var13;
        }
        if (var5 + var9 > Draw2D.field636) {
            var9 -= var5 + var9 - Draw2D.field636;
        }
        if (var4 < Draw2D.field637) {
            int var14 = Draw2D.field637 - var4;
            var10 -= var14;
            var4 = Draw2D.field637;
            var8 += var14;
            var7 += var14;
        ...
        if (var4 + var10 > Draw2D.field638) {
            int var15 = var4 + var10 - Draw2D.field638;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method187(Draw2D.field632, this.field674, 0, var8, var7, var10, var9, var11, var12);
        }
    }
    ...
    public void method188(int arg0, int arg1, int arg2, int arg3) {
        ...
        int var7 = Draw2D.field633 * var6 + var5;
        int var8 = 0;
        int var9 = this.field676;
        int var10 = this.field675;
        int var11 = Draw2D.field633 - var10;
        int var12 = 0;
        if (var6 < Draw2D.field635) {
            int var13 = Draw2D.field635 - var6;
            var9 -= var13;
            var6 = Draw2D.field635;
            var8 += var10 * var13;
            var7 += Draw2D.field633 * var13;
        }
        if (var6 + var9 > Draw2D.field636) {
            var9 -= var6 + var9 - Draw2D.field636;
        }
        if (var5 < Draw2D.field637) {
            int var14 = Draw2D.field637 - var5;
            var10 -= var14;
            var5 = Draw2D.field637;
            var8 += var14;
            var7 += var14;
            var12 += var14;
            var11 += var14;
        }
        if (var5 + var10 > Draw2D.field638) {
            int var15 = var5 + var10 - Draw2D.field638;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        ...
        this.method189(var11, this.field674, var8, var10, 0, var9, Draw2D.field632, var7, -8178, var12, arg3);
        if (arg0 != 0) {
    ...
    public void method190(int arg0, byte arg1, int arg2, int arg3, int[] arg4, int arg5, int[] arg6, int arg7, int arg8, int arg9, int arg10) {
        ...
        try {
            ...
            int var20 = Draw2D.field633 * arg10 + arg5;
            for (int var21 = 0; var21 < arg3; var21++) {
                ...
                for (int var26 = -arg4[var21]; var26 < 0; var26++) {
                    Draw2D.field632[var23++] = this.field674[(var24 >> 16) + (var25 >> 16) * this.field675];
                    var24 += var17;
                    var25 -= var16;
                }
                var18 += var16;
                var19 += var17;
                var20 += Draw2D.field633;
            }
    ...
    public void method191(int arg0, int arg1, int arg2, byte arg3, int arg4, int arg5, int arg6, double arg7, int arg8) {
        ...
        try {
            ...
            int var20 = Draw2D.field633 * arg8 + arg5;
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Ljb;III)V")
    public void method192(Pix8 arg0, int arg1, int arg2, int arg3) {
        ...
        if (var10 > 0 && var9 > 0) {
            this.method193(var12, 2, var8, arg0.field684, var9, this.field674, 0, var10, var11, Draw2D.field632, var7);
        }
    }
