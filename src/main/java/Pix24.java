...
public class Pix24 extends Draw2D {
    ...
    public void method171(boolean arg0) {
        if (!arg0) {
            Draw2D.method146(this.field589, 0, this.field587, this.field588);
        }
    }
    ...
    public void method173(int arg0, int arg1, int arg2) {
        ...
        int var6 = Draw2D.field545 * var5 + var4;
        int var7 = 0;
        int var8 = this.field589;
        int var9 = this.field588;
        int var10 = Draw2D.field545 - var9;
        int var11 = 0;
        if (arg1 != 0) {
            this.field583 = 419;
        }
        if (var5 < Draw2D.field547) {
            int var12 = Draw2D.field547 - var5;
            var8 -= var12;
            var5 = Draw2D.field547;
            var7 += var9 * var12;
            var6 += Draw2D.field545 * var12;
        }
        if (var5 + var8 > Draw2D.field548) {
            var8 -= var5 + var8 - Draw2D.field548;
        }
        if (var4 < Draw2D.field549) {
            int var13 = Draw2D.field549 - var4;
            var9 -= var13;
            var4 = Draw2D.field549;
            var7 += var13;
            var6 += var13;
            var11 += var13;
            var10 += var13;
        }
        if (var4 + var9 > Draw2D.field550) {
            int var14 = var4 + var9 - Draw2D.field550;
            var9 -= var14;
            var11 += var14;
            var10 += var14;
        }
        if (var9 > 0 && var8 > 0) {
            this.method174(this.field587, true, var8, var6, var7, Draw2D.field544, var10, var9, var11);
        }
    }
    ...
    public void method175(int arg0, int arg1, int arg2) {
        ...
        if (var9 > 0 && var8 > 0) {
            this.method176(Draw2D.field544, this.field587, 0, var7, var6, var9, var8, var10, var11);
        }
    }
    ...
    public void method177(int arg0, int arg1, int arg2, int arg3, int arg4) {
        ...
        try {
            ...
            int var21 = Draw2D.field545 * var18 + var17;
            int var22 = Draw2D.field545 - var19;
            if (var18 < Draw2D.field547) {
                int var23 = Draw2D.field547 - var18;
                var20 -= var23;
                var18 = 0;
                var21 += Draw2D.field545 * var23;
                var10 += var16 * var23;
            }
            if (var18 + var20 > Draw2D.field548) {
                var20 -= var18 + var20 - Draw2D.field548;
            }
            if (var17 < Draw2D.field549) {
                int var24 = Draw2D.field549 - var17;
                var19 -= var24;
                var17 = 0;
                var21 += var24;
                var9 += var15 * var24;
            ...
            if (var17 + var19 > Draw2D.field550) {
                int var25 = var17 + var19 - Draw2D.field550;
                var19 -= var25;
                var22 += var25;
            }
            this.method178(Draw2D.field544, var9, true, var21, var7, this.field587, var15, var19, var10, var16, 0, var22, var20);
    ...
    public void method179(int arg0, byte arg1, int arg2, int arg3) {
        ...
        int var7 = Draw2D.field545 * var6 + var5;
        int var8 = 0;
        if (arg1 != 34) {
        ...
        int var11 = Draw2D.field545 - var10;
        int var12 = 0;
        if (var6 < Draw2D.field547) {
            int var13 = Draw2D.field547 - var6;
            var9 -= var13;
            var6 = Draw2D.field547;
            var8 += var10 * var13;
            var7 += Draw2D.field545 * var13;
        }
        if (var6 + var9 > Draw2D.field548) {
            var9 -= var6 + var9 - Draw2D.field548;
        }
        if (var5 < Draw2D.field549) {
            int var14 = Draw2D.field549 - var5;
            var10 -= var14;
            var5 = Draw2D.field549;
            var8 += var14;
            var7 += var14;
            var12 += var14;
            var11 += var14;
        }
        if (var5 + var10 > Draw2D.field550) {
            int var15 = var5 + var10 - Draw2D.field550;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method180(var10, var8, false, var12, var9, arg3, var7, 0, Draw2D.field544, var11, this.field587);
        }
    }
    ...
    public void method181(int arg0, int arg1, int arg2, int arg3, int arg4, int[] arg5, int arg6, int arg7, int arg8, int arg9, int[] arg10) {
        ...
        try {
            ...
            int var21 = Draw2D.field545 * arg9 + arg2;
            for (int var22 = 0; var22 < arg7; var22++) {
                ...
                for (int var27 = -arg5[var22]; var27 < 0; var27++) {
                    Draw2D.field544[var24++] = this.field587[(var25 >> 16) + (var26 >> 16) * this.field588];
                    var25 += var18;
                    var26 -= var17;
                }
                var19 += var17;
                var20 += var18;
                var21 += Draw2D.field545;
            }
        } catch (Exception var28) {
        }
    }

    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ZLib;II)V")
    public void method182(boolean arg0, Pix8 arg1, int arg2, int arg3) {
        ...
        int var12 = Draw2D.field545 - var11;
        int var13 = 0;
        if (var6 < Draw2D.field547) {
            int var14 = Draw2D.field547 - var6;
            var10 -= var14;
            var6 = Draw2D.field547;
            var8 += var11 * var14;
            var7 += Draw2D.field545 * var14;
        }
        if (var6 + var10 > Draw2D.field548) {
            var10 -= var6 + var10 - Draw2D.field548;
        }
        if (var5 < Draw2D.field549) {
            int var15 = Draw2D.field549 - var5;
            var11 -= var15;
            var5 = Draw2D.field549;
            var8 += var15;
            var7 += var15;
        ...
        if (var5 + var11 > Draw2D.field550) {
            int var16 = var5 + var11 - Draw2D.field550;
            var11 -= var16;
            var13 += var16;
            var12 += var16;
        }
        if (var11 > 0 && var10 > 0) {
            this.method183(var10, 0, var11, var12, -10520, var7, this.field587, var13, arg1.field597, Draw2D.field544, var8);
        }
    }
