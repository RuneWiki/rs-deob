...
public class Pix24 extends Draw2D {
    ...
    public void method194(int arg0) {
        Draw2D.method165(this.field688, 741, this.field689, this.field690);
        if (arg0 == 0) {
            ;
        }
    }
    ...
    public void method197(int arg0, int arg1, int arg2) {
        ...
        int var6 = Draw2D.field645 * var5 + var4;
        int var7 = 0;
        if (arg0 <= 0) {
        ...
        int var10 = Draw2D.field645 - var9;
        int var11 = 0;
        if (var5 < Draw2D.field647) {
            int var12 = Draw2D.field647 - var5;
            var8 -= var12;
            var5 = Draw2D.field647;
            var7 += var9 * var12;
            var6 += Draw2D.field645 * var12;
        }
        if (var5 + var8 > Draw2D.field648) {
            var8 -= var5 + var8 - Draw2D.field648;
        }
        if (var4 < Draw2D.field649) {
            int var13 = Draw2D.field649 - var4;
            var9 -= var13;
            var4 = Draw2D.field649;
            var7 += var13;
            var6 += var13;
            var11 += var13;
            var10 += var13;
        }
        if (var4 + var9 > Draw2D.field650) {
            int var14 = var4 + var9 - Draw2D.field650;
            var9 -= var14;
            var11 += var14;
            var10 += var14;
        }
        if (var9 > 0 && var8 > 0) {
            this.method198(this.field688, var6, Draw2D.field644, var11, var8, var9, var7, true, var10);
        }
    }
    ...
    public void method199(int arg0, int arg1, int arg2) {
        ...
        this.method200(Draw2D.field644, this.field688, 0, var7, var6, var9, var8, var10, var11);
    ...
    public void method201(int arg0, int arg1, int arg2, int arg3) {
        ...
        int var7 = Draw2D.field645 * var6 + var5;
        int var8 = 0;
        if (arg3 != 2) {
        ...
        int var12 = Draw2D.field645 - var11;
        int var13 = 0;
        if (var6 < Draw2D.field647) {
            int var14 = Draw2D.field647 - var6;
            var10 -= var14;
            var6 = Draw2D.field647;
            var8 += var11 * var14;
            var7 += Draw2D.field645 * var14;
        }
        if (var6 + var10 > Draw2D.field648) {
            var10 -= var6 + var10 - Draw2D.field648;
        }
        if (var5 < Draw2D.field649) {
            int var15 = Draw2D.field649 - var5;
            var11 -= var15;
            var5 = Draw2D.field649;
            var8 += var15;
            var7 += var15;
            var13 += var15;
            var12 += var15;
        }
        if (var5 + var11 > Draw2D.field650) {
            int var16 = var5 + var11 - Draw2D.field650;
            var11 -= var16;
            var13 += var16;
            var12 += var16;
        }
        if (var11 > 0 && var10 > 0) {
            this.method202(var7, (byte) -100, Draw2D.field644, var11, 0, var10, var8, this.field688, var13, var12, arg2);
        }
    }
    ...
    public void method203(int arg0, int arg1, int[] arg2, boolean arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int[] arg10) {
        ...
        try {
            ...
            int var21 = Draw2D.field645 * arg0 + arg8;
            for (int var22 = 0; var22 < arg4; var22++) {
                ...
                for (int var27 = -arg10[var22]; var27 < 0; var27++) {
                    Draw2D.field644[var24++] = this.field688[(var25 >> 16) + (var26 >> 16) * this.field689];
                    var25 += var18;
                    var26 -= var17;
                }
                var19 += var17;
                var20 += var18;
                var21 += Draw2D.field645;
            }
    ...
    public void method204(int arg0, int arg1, int arg2, int arg3, int arg4, double arg5, byte arg6, int arg7, int arg8) {
        ...
        try {
            ...
            int var20 = Draw2D.field645 * arg0 + arg2;
    ...
    public void method205(int arg0, int arg1, int arg2, Pix8 arg3) {
        ...
        int var11 = Draw2D.field645 - var10;
        int var12 = 0;
        if (var6 < Draw2D.field647) {
            int var13 = Draw2D.field647 - var6;
            var9 -= var13;
            var6 = Draw2D.field647;
            var8 += var10 * var13;
            var7 += Draw2D.field645 * var13;
        }
        if (var6 + var9 > Draw2D.field648) {
            var9 -= var6 + var9 - Draw2D.field648;
        }
        if (var5 < Draw2D.field649) {
            int var14 = Draw2D.field649 - var5;
            var10 -= var14;
            var5 = Draw2D.field649;
            var8 += var14;
            var7 += var14;
        ...
        if (var5 + var10 > Draw2D.field650) {
            int var15 = var5 + var10 - Draw2D.field650;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method206(var12, var10, var9, arg3.field700, var7, this.field688, 0, var11, var8, this.field686, Draw2D.field644);
            if (arg2 != 0) {
                this.field687 = 28;
            }
        }
