...
public class Pix24 extends Draw2D {
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Lyb;Ljava/lang/String;I)V")
    ...
    public void method186(byte arg0) {
        Draw2D.method161(this.field653, (byte) 102, this.field652, this.field651);
        if (arg0 == 0) {
            boolean var2 = false;
        } else {
            this.field650 = 321;
    ...
    public void method188(int arg0, int arg1, int arg2) {
        ...
        int var6 = Draw2D.field609 * var5 + var4;
        int var7 = 0;
        int var8 = this.field653;
        int var9 = this.field652;
        int var10 = Draw2D.field609 - var9;
        int var11 = 0;
        if (arg2 != -7650) {
            return;
        }
        if (var5 < Draw2D.field611) {
            int var12 = Draw2D.field611 - var5;
            var8 -= var12;
            var5 = Draw2D.field611;
            var7 += var9 * var12;
            var6 += Draw2D.field609 * var12;
        }
        if (var5 + var8 > Draw2D.field612) {
            var8 -= var5 + var8 - Draw2D.field612;
        }
        if (var4 < Draw2D.field613) {
            int var13 = Draw2D.field613 - var4;
            var9 -= var13;
            var4 = Draw2D.field613;
            var7 += var13;
            var6 += var13;
            var11 += var13;
            var10 += var13;
        }
        if (var4 + var9 > Draw2D.field614) {
            int var14 = var4 + var9 - Draw2D.field614;
            var9 -= var14;
            var11 += var14;
            var10 += var14;
        }
        if (var9 > 0 && var8 > 0) {
            this.method189(var8, var7, var6, 0, var9, var10, var11, this.field651, Draw2D.field608);
        }
    }
    ...
    public void method190(int arg0, int arg1, int arg2) {
        ...
        if (var9 > 0 && var8 > 0) {
            this.method191(Draw2D.field608, this.field651, 0, var7, var6, var9, var8, var10, var11);
        }
    }
    ...
    public void method192(int arg0, int arg1, int arg2, int arg3, int arg4) {
        ...
        try {
            ...
            int var20 = Draw2D.field609 * var17 + var16;
            int var21 = Draw2D.field609 - var18;
            if (var17 < Draw2D.field611) {
                int var22 = Draw2D.field611 - var17;
                var19 -= var22;
                var17 = 0;
                var20 += Draw2D.field609 * var22;
                var9 += var15 * var22;
            }
            if (var17 + var19 > Draw2D.field612) {
                var19 -= var17 + var19 - Draw2D.field612;
            }
            if (var16 < Draw2D.field613) {
                int var23 = Draw2D.field613 - var16;
                var18 -= var23;
                var16 = 0;
                var20 += var23;
                var8 += var14 * var23;
            ...
            if (var16 + var18 > Draw2D.field614) {
                int var24 = var16 + var18 - Draw2D.field614;
                var18 -= var24;
                var21 += var24;
            }
            this.method193(Draw2D.field608, var21, var9, var18, 0, var20, var8, this.field651, var6, var19, var15, true, var14);
    ...
    public void method194(int arg0, int arg1, int arg2, int arg3) {
        ...
        int var8 = Draw2D.field609 * var7 + var6;
        int var9 = 0;
        int var10 = this.field653;
        int var11 = this.field652;
        int var12 = Draw2D.field609 - var11;
        int var13 = 0;
        if (var7 < Draw2D.field611) {
            int var14 = Draw2D.field611 - var7;
            var10 -= var14;
            var7 = Draw2D.field611;
            var9 += var11 * var14;
            var8 += Draw2D.field609 * var14;
        }
        if (var7 + var10 > Draw2D.field612) {
            var10 -= var7 + var10 - Draw2D.field612;
        }
        if (var6 < Draw2D.field613) {
            int var15 = Draw2D.field613 - var6;
            var11 -= var15;
            var6 = Draw2D.field613;
            var9 += var15;
            var8 += var15;
            var13 += var15;
            var12 += var15;
        }
        if (var6 + var11 > Draw2D.field614) {
            int var16 = var6 + var11 - Draw2D.field614;
            var11 -= var16;
            var13 += var16;
            var12 += var16;
        }
        if (var11 > 0 && var10 > 0) {
            this.method195((byte) 34, var12, var10, var9, var11, 0, var13, Draw2D.field608, this.field651, var8, arg0);
        }
    }
    ...
    public void method196(int arg0, int[] arg1, int arg2, int arg3, int arg4, int arg5, int[] arg6, int arg7, int arg8, int arg9, int arg10) {
        ...
        try {
            ...
            int var21 = Draw2D.field609 * arg10 + arg4;
            for (int var22 = 0; var22 < arg5; var22++) {
                ...
                for (int var27 = -arg1[var22]; var27 < 0; var27++) {
                    Draw2D.field608[var24++] = this.field651[(var25 >> 16) + (var26 >> 16) * this.field652];
                    var25 += var18;
                    var26 -= var17;
                }
                var19 += var17;
                var20 += var18;
                var21 += Draw2D.field609;
            }
        } catch (Exception var28) {
        }
    }

    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lkb;ZII)V")
    public void method197(Pix8 arg0, boolean arg1, int arg2, int arg3) {
        ...
        int var7 = Draw2D.field609 * var6 + var5;
        int var8 = 0;
        int var9 = this.field653;
        int var10 = this.field652;
        int var11 = Draw2D.field609 - var10;
        int var12 = 0;
        if (var6 < Draw2D.field611) {
            int var13 = Draw2D.field611 - var6;
            var9 -= var13;
            var6 = Draw2D.field611;
            var8 += var10 * var13;
            var7 += Draw2D.field609 * var13;
        }
        if (var6 + var9 > Draw2D.field612) {
            var9 -= var6 + var9 - Draw2D.field612;
        }
        if (var5 < Draw2D.field613) {
            int var14 = Draw2D.field613 - var5;
            var10 -= var14;
            var5 = Draw2D.field613;
            var8 += var14;
            var7 += var14;
            var12 += var14;
            var11 += var14;
        }
        if (var5 + var10 > Draw2D.field614) {
            int var15 = var5 + var10 - Draw2D.field614;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method198(var8, var7, var10, (byte) 69, Draw2D.field608, var9, 0, var11, this.field651, arg0.field660, var12);
        }
    }
