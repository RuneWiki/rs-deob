...
public class Pix24 extends Draw2D {
    ...
    public void method170(int arg0) {
        Draw2D.method145(this.field580, this.field581, this.field582, (byte) 6);
    ...
    public void method171(int arg0, int arg1, boolean arg2) {
        ...
        int var6 = Draw2D.field540 * var5 + var4;
        int var7 = 0;
        int var8 = this.field582;
        int var9 = this.field581;
        int var10 = Draw2D.field540 - var9;
        int var11 = 0;
        if (!arg2) {
            this.field579 = -492;
        }
        if (var5 < Draw2D.field542) {
            int var12 = Draw2D.field542 - var5;
            var8 -= var12;
            var5 = Draw2D.field542;
            var7 += var9 * var12;
            var6 += Draw2D.field540 * var12;
        }
        if (var5 + var8 > Draw2D.field543) {
            var8 -= var5 + var8 - Draw2D.field543;
        }
        if (var4 < Draw2D.field544) {
            int var13 = Draw2D.field544 - var4;
            var9 -= var13;
            var4 = Draw2D.field544;
            var7 += var13;
            var6 += var13;
            var11 += var13;
            var10 += var13;
        }
        if (var4 + var9 > Draw2D.field545) {
            int var14 = var4 + var9 - Draw2D.field545;
            var9 -= var14;
            var11 += var14;
            var10 += var14;
        }
        if (var9 > 0 && var8 > 0) {
            this.method172(var8, var11, var10, var6, (byte) 5, this.field580, var7, Draw2D.field539, var9);
        }
    }
    ...
    public void method173(int arg0, boolean arg1, int arg2) {
        ...
        if (var9 > 0 && var8 > 0) {
            this.method174(Draw2D.field539, this.field580, 0, var7, var6, var9, var8, var10, var11);
        }
    }
    ...
    public void method175(int arg0, int arg1, int arg2, boolean arg3, int arg4) {
        ...
        try {
            ...
            int var20 = Draw2D.field540 * var17 + var16;
            int var21 = Draw2D.field540 - var18;
            if (var17 < Draw2D.field542) {
                int var22 = Draw2D.field542 - var17;
                var19 -= var22;
                var17 = 0;
                var20 += Draw2D.field540 * var22;
                var9 += var15 * var22;
            }
            if (var17 + var19 > Draw2D.field543) {
                var19 -= var17 + var19 - Draw2D.field543;
            }
            if (var16 < Draw2D.field544) {
                int var23 = Draw2D.field544 - var16;
                var18 -= var23;
                var16 = 0;
                var20 += var23;
                var8 += var14 * var23;
            ...
            if (var16 + var18 > Draw2D.field545) {
                int var24 = var16 + var18 - Draw2D.field545;
                var18 -= var24;
                var21 += var24;
            }
            this.method176(var15, false, var9, var19, var8, var18, Draw2D.field539, var14, this.field580, var21, 0, var6, var20);
    ...
    public void method177(int arg0, int arg1, int arg2, boolean arg3) {
        ...
        int var7 = Draw2D.field540 * var6 + var5;
        int var8 = 0;
        int var9 = this.field582;
        int var10 = this.field581;
        int var11 = Draw2D.field540 - var10;
        int var12 = 0;
        if (var6 < Draw2D.field542) {
            int var13 = Draw2D.field542 - var6;
            var9 -= var13;
            var6 = Draw2D.field542;
            var8 += var10 * var13;
            var7 += Draw2D.field540 * var13;
        }
        if (var6 + var9 > Draw2D.field543) {
            var9 -= var6 + var9 - Draw2D.field543;
        }
        if (var5 < Draw2D.field544) {
            int var14 = Draw2D.field544 - var5;
            var10 -= var14;
            var5 = Draw2D.field544;
            var8 += var14;
            var7 += var14;
            var12 += var14;
            var11 += var14;
        }
        if (var5 + var10 > Draw2D.field545) {
            int var15 = var5 + var10 - Draw2D.field545;
            var10 -= var15;
            var12 += var15;
            var11 += var15;
        }
        if (var10 > 0 && var9 > 0) {
            this.method178((byte) 0, var8, var7, var11, this.field580, Draw2D.field539, var10, var12, var9, 0, arg1);
        }
    }
    ...
    public void method179(int[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int[] arg7, int arg8, int arg9, int arg10) {
        ...
        try {
            ...
            int var20 = Draw2D.field540 * arg4 + arg6;
            for (int var21 = 0; var21 < arg1; var21++) {
                ...
                for (int var26 = -arg0[var21]; var26 < 0; var26++) {
                    Draw2D.field539[var23++] = this.field580[(var24 >> 16) + (var25 >> 16) * this.field581];
                    var24 += var17;
                    var25 -= var16;
                }
                var18 += var16;
                var19 += var17;
                var20 += Draw2D.field540;
            }
        } catch (Exception var27) {
        }
    }

    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ILib;II)V")
    public void method180(int arg0, Pix8 arg1, int arg2, int arg3) {
        ...
        if (var10 > 0 && var9 > 0) {
            this.method181(this.field580, var11, arg1.field591, (byte) 8, var10, var7, var12, 0, Draw2D.field539, var8, var9);
        }
    }
