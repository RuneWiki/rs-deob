...
public class class110 extends class173 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!jfa", name = "b", descriptor = "(Z)V", line = 6)
    public final void method391(boolean arg0) {
        this.field1439 = arg0;
        ++field1434;
    }

    @OriginalMember(owner = "client!jfa", name = "G", descriptor = "()V", line = 19)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "([Lba;Lqu;Lq;[Lht;I)V", line = 62)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(ILfd;)Lnl;", line = 81)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Lcp;III)V", line = 93)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(IIIIIIIIII)V", line = 125)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(II[[I[[IIII)Ld;", line = 172)
    ...
    @OriginalMember(owner = "client!jfa", name = "A", descriptor = "()V", line = 180)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Ljava/awt/Component;IZ)Lgda;", line = 266)
    ...
    @OriginalMember(owner = "client!jfa", name = "n", descriptor = "()V", line = 284)
    ...
    @OriginalMember(owner = "client!jfa", name = "c", descriptor = "(Ljava/awt/Canvas;)V", line = 306)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(IIIB)V", line = 357)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Lxa;Z)V", line = 372)
    ...
    @OriginalMember(owner = "client!jfa", name = "e", descriptor = "(I)V", line = 407)
    public final void method373(int arg0) {
        ++field1436;
        super.field2142[arg0].method2478(64, Thread.currentThread());
    }

    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Ljava/lang/Runnable;)Ltv;", line = 415)
    ...
    @OriginalMember(owner = "client!jfa", name = "b", descriptor = "(I)V", line = 436)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Lfu;IIII)V", line = 459)
    ...
    @OriginalMember(owner = "client!jfa", name = "g", descriptor = "(I)V", line = 504)
    public final void method398(int arg0) {
        ++field1445;
        super.field2142[arg0].method2478(64, (Runnable) null);
    }

    @OriginalMember(owner = "client!jfa", name = "b", descriptor = "(IIIIIIIIII)V", line = 512)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Lpo;IIIIIIIII)V", line = 553)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(IIIIIII)V", line = 1340)
    ...
    @OriginalMember(owner = "client!jfa", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 1422)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Lfca;IIII)Lba;", line = 1455)
    ...
    @OriginalMember(owner = "client!jfa", name = "b", descriptor = "(IIIIIII)V", line = 1463)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "([Lba;Lq;[Lht;I)V", line = 1797)
    ...
    @OriginalMember(owner = "client!jfa", name = "<init>", descriptor = "(Ljava/awt/Canvas;Le;)V", line = 1815)
    public class110(Canvas arg0, class702 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!jfa", name = "h", descriptor = "()Z", line = 1825)
