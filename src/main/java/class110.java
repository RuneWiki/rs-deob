...
public class class110 extends Canvas {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!aq", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 5)
    public class110(Component arg0) {
        this.field1580 = arg0;
    }

    @OriginalMember(owner = "client!aq", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 16)
    public final void paint(Graphics arg0) {
        field1584++;
        this.field1580.paint(arg0);
    }

    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(BIIIIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!aq", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 156)
    public final void update(Graphics arg0) {
        this.field1580.update(arg0);
        field1583++;
    }

    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IJLqa;)V", line = 178)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(III)V", line = 211)
