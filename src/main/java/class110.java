...
public class class110 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(I)Ljca;")
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(BLio;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lwv;III)V")
    ...
    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "(Lwh;)V")
    public class110(class546 arg0) {
        this.field1295 = arg0;
    }

    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(B)Ljca;")
