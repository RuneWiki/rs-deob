...
public class class110 {
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(ILwn;)V", line = 12)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(IZIIZ)V", line = 35)
