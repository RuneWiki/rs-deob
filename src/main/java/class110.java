...
public class class110 extends class10 implements class45 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Lgaa;I)V")
    public final void method54(class267 arg0, int arg1) {
        super.method54(arg0, arg1);
    }

    @OriginalMember(owner = "client!ju", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "(Ltb;IZ[[I)V")
