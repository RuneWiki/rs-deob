...
public class class110 extends class434 {
    ...
    @OriginalMember(owner = "client!nr", name = "f", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Llb;IZIBILza;)V", line = 21)
    ...
    @OriginalMember(owner = "client!nr", name = "c", descriptor = "(I)Z", line = 32)
    ...
    @OriginalMember(owner = "client!nr", name = "c", descriptor = "(Lza;I)V", line = 43)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IBILza;)Z", line = 60)
    public final boolean method158(int arg0, byte arg1, int arg2, class295 arg3) {
        ++field1794;
        return arg1 < 58;
    }

    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 72)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(BLza;)Lql;", line = 109)
    ...
    @OriginalMember(owner = "client!nr", name = "finalize", descriptor = "()V", line = 143)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IB)V", line = 154)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(B)V", line = 183)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(B)V", line = 193)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(II)I", line = 215)
    public static final int method840(int arg0, int arg1) {
        ++field1779;
        return arg0 <= 40 ? -3 : 255 & arg1;
    }

    @OriginalMember(owner = "client!nr", name = "e", descriptor = "(I)V", line = 229)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Le;BLza;)V", line = 246)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ILza;BI)Le;", line = 277)
