...
public class class110 {
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(III)Lfl;", line = 5)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(ILvg;)V", line = 45)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IZI)V", line = 58)
