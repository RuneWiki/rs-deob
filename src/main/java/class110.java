...
public class class110 extends class279 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IZLiu;)V", line = 4)
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(Lom;Lla;Lno;)V", line = 27)
    ...
    @OriginalMember(owner = "client!wd", name = "c", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(BZ)V", line = 67)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ZI)V", line = 79)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(B)Z", line = 118)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(III)V", line = 130)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Z)V", line = 159)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IBIII)V", line = 180)
