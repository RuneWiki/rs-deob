...
public class class110 {
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(IB)Lpe;")
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IILhj;IFIFFI[BIFF)V")
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(Lee;ILul;)V")
