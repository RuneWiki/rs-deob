...
public class class110 extends class674 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "(Lpj;Ljava/lang/Object;I)V", line = 16)
    public class110(class157 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field1519 = arg1;
    }

    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Z)Ljava/lang/Object;", line = 32)
