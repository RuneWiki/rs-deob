...
public class class110 extends class189 {
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IIIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(SI)V", line = 175)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(I)V", line = 204)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(FIFBF)F", line = 231)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(BI[[ZII)V", line = 245)
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(Leea;Lio;Lwi;[I)V", line = 311)
