...
public class class110 extends class714 {
    ...
    @OriginalMember(owner = "client!lca", name = "<init>", descriptor = "(Lmp;Lfe;IIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(Lbn;I)Z")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(B)Lhl;")
