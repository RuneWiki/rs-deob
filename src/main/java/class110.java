...
public class class110 extends class442 implements Runnable {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!ls", name = "<init>", descriptor = "(Ltr;)V", line = 167)
    public class110(class84 arg0) {
        this.field1543 = arg0;
    }

    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IZ)I", line = 50)
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(Z)I", line = 62)
    ...
    @OriginalMember(owner = "client!ls", name = "run", descriptor = "()V", line = 156)
