...
public class class110 extends class305 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(BILuh;IIIIIIIII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ILfh;B)V", line = 433)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "()V", line = 461)
    public class110() {
        this(0);
    }

    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Z)Llb;", line = 465)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(I)V", line = 513)
    private class110(int arg0) {
        super(0, false);
        this.method859((byte) -33, arg0);
    }

    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ILpn;)V", line = 521)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IBI)Z", line = 533)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(BI)V", line = 601)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IB)[[I", line = 619)
