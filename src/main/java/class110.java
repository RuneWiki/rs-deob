...
public class class110 extends class266 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(CIIIZLhb;II)V")
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(Lpk;Lth;[Lgo;[I[I)V")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "([B[IIIIIIIIIIILhb;II)V")
