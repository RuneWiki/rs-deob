...
public class class110 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IIIIIIB)Ldga;")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ZI)Lew;")
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Ljda;ILjo;)V")
