...
public class class110 {
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lnk;ZLnk;)V")
    ...
    @OriginalMember(owner = "client!r", name = "b", descriptor = "(IB)Ljs;")
    ...
    @OriginalMember(owner = "client!r", name = "<init>", descriptor = "(Ldi;ZI)V")
