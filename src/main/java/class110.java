...
public abstract class class110 extends class187 {
    ...
    @OriginalMember(owner = "client!gd", name = "f", descriptor = "(I)Ltl;")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IZ)Lvp;")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(ILvm;Lir;Lnj;)V")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(BLvm;Lwm;IIIZ)V")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "([I[I[ILc;Z)V")
