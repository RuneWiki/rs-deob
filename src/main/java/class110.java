...
public class class110 extends class134 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(ZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(Lkda;)V", line = 15)
    public class110(class391 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(ILkda;)V", line = 20)
    public class110(int arg0, class391 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!eg", name = "b", descriptor = "(B)I", line = 23)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(II)V", line = 36)
    ...
    @OriginalMember(owner = "client!eg", name = "c", descriptor = "(II)I", line = 48)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(I)I", line = 66)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!eg", name = "c", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(IBI)V", line = 120)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Z)Z", line = 142)
    ...
    @OriginalMember(owner = "client!eg", name = "d", descriptor = "(I)Z", line = 153)
