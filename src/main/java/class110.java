...
public class class110 extends class82 {
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(B)V", line = 106)
    ...
    @OriginalMember(owner = "client!hw", name = "c", descriptor = "(B)V", line = 117)
    ...
    @OriginalMember(owner = "client!hw", name = "c", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IIZLmca;Lmca;)I", line = 145)
    ...
    @OriginalMember(owner = "client!hw", name = "e", descriptor = "(III)V", line = 246)
    ...
    @OriginalMember(owner = "client!hw", name = "b", descriptor = "(II)[[I", line = 394)
    ...
    @OriginalMember(owner = "client!hw", name = "d", descriptor = "(II)V", line = 452)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IILos;)V", line = 702)
    ...
    @OriginalMember(owner = "client!hw", name = "c", descriptor = "(Z)V", line = 741)
    ...
    @OriginalMember(owner = "client!hw", name = "<init>", descriptor = "()V", line = 770)
    public class110() {
        super(1, false);
    }
}
