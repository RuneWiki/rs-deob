...
public class class110 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IILvd;Ld;Ljava/awt/Canvas;)Lha;")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IILrg;)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lrg;I)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lha;BILqq;ILtl;Lfo;II)V")
