...
public class class110 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "Lcf;")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lcf;)V")
    ...
    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(Lcf;)V")
    ...
    @OriginalMember(owner = "client!lg", name = "c", descriptor = "(Lcf;)B")
    private static final byte method816(class27 arg0) {
        return (byte) method817(8, arg0);
    }

    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ILcf;)I")
    ...
    @OriginalMember(owner = "client!lg", name = "d", descriptor = "(Lcf;)V")
    ...
    @OriginalMember(owner = "client!lg", name = "e", descriptor = "(Lcf;)B")
