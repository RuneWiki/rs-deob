...
public class class110 extends class114 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "()Z", line = 5)
    public final boolean method309() {
        return true;
    }

    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Z)V", line = 8)
    public final void method304(boolean arg0) {
        this.field1748.method2212(260, 8448);
    }

    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(Z)V", line = 49)
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(Lmm;Lgk;)V", line = 77)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Lt;)V", line = 84)
    public final void method307(class321 arg0) {
    }

    @OriginalMember(owner = "client!dm", name = "b", descriptor = "()V", line = 87)
    ...
    @OriginalMember(owner = "client!dm", name = "c", descriptor = "()V", line = 105)
