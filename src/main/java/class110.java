...
public class class110 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IIIIBIIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(II)Lb;", line = 85)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(III)V", line = 126)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(B)V", line = 147)
