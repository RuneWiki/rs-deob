...
public class class110 extends class449 {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ILae;)Lae;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(BILoj;ILrn;IILae;)V")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lae;ZI)V")
