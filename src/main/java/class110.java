...
public class class110 extends class513 {
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Lwu;)Z")
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "([I)Laaa;")
    ...
    @OriginalMember(owner = "client!qv", name = "b", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Lwu;I)Lqv;")
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Lwu;II)Lqv;")
    ...
    @OriginalMember(owner = "client!qv", name = "<init>", descriptor = "([B)V")
