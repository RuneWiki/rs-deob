...
public class class110 implements Runnable {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(BZ)V", line = 28)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IIILjava/awt/Canvas;Lfh;Lwd;)Lii;", line = 40)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IILnj;)V", line = 68)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!dm", name = "run", descriptor = "()V", line = 105)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Lps;I)V", line = 127)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(I)V", line = 158)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Z[I)Ljava/lang/String;", line = 212)
