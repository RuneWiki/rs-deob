...
public class class110 {
    ...
    @OriginalMember(owner = "client!af", name = "finalize", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(BI)V", line = 17)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ILoj;)V", line = 193)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(I)Z", line = 213)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Z)V", line = 228)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(JZ)Ljava/lang/String;", line = 240)
    ...
    @OriginalMember(owner = "client!af", name = "c", descriptor = "(I)[Lep;", line = 281)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Loj;I)V", line = 362)
    public final void method528(class280 arg0, int arg1) {
        field1338++;
        this.method529(true, 78, arg0, this.field1335, this.field1351, arg1, true);
    }

    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Loj;Lcu;IIIIIIZI)V", line = 773)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ZILoj;IIIZ)Lqh;", line = 382)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(Z)I", line = 510)
    public final int method530(boolean arg0) {
        field1344++;
        return arg0 ? this.field1350 : 67;
    }

    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IB)V", line = 541)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(BLqh;ZIIIILoj;)V", line = 555)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IZ)V", line = 596)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(III)V", line = 669)
