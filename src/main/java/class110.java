...
public abstract class class110 implements class616 {
    ...
    @OriginalMember(owner = "client!ms", name = "finalize", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!ms", name = "b", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!ms", name = "c", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(ZBLjaggl/MapBuffer;)Ljaclib/memory/Buffer;", line = 58)
    ...
    @OriginalMember(owner = "client!ms", name = "d", descriptor = "(I)J", line = 101)
    ...
    @OriginalMember(owner = "client!ms", name = "e", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(II)V", line = 142)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(ILjaclib/memory/Source;B)Z", line = 170)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Ljaggl/MapBuffer;I)Z", line = 211)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(B)I", line = 241)
    public int method330(byte arg0) {
        field1444++;
        return arg0 < 11 ? -47 : this.field1447;
    }

    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(Llm;IZ)V", line = 258)
