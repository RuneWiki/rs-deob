...
public class class110 extends class266 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Lmh;III)V")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "([BZ)Lxa;")
    ...
    @OriginalMember(owner = "client!ut", name = "<init>", descriptor = "(Lgj;Ldb;)V")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Lek;IB)V")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(ZLfaa;I)I")
