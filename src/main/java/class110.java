...
public class class110 {
    ...
    @OriginalMember(owner = "client!kt", name = "finalize", descriptor = "()V", line = 8)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(Lih;JI)V", line = 31)
    public class110(class503 arg0, long arg1, int arg2) {
        this.field1494 = arg0;
        this.field1493 = arg1;
    }

    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IIZIIIIII)Z", line = 77)
