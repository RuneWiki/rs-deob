...
public class class110 extends class223 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IZBILlp;IILcj;ILya;)Lt;", line = 8)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Z)V", line = 255)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "([IIZI[I)J", line = 267)
