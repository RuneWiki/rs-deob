...
public class class110 extends class193 {
    ...
    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(ZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Z)Z", line = 14)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ZZ)V", line = 28)
    public final void method94(boolean arg0, boolean arg1) {
        ++field1482;
        super.field2498.method2281(!arg0, arg0);
    }

    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IJLya;)V", line = 38)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Lsq;II)V", line = 75)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IIZ)V", line = 87)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "(Lug;)V", line = 108)
    public class110(class395 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(B)V", line = 115)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ILhd;)V", line = 127)
