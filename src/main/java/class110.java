...
public class class110 extends class657 {
    ...
    @OriginalMember(owner = "client!eda", name = "<init>", descriptor = "(Lffa;)V", line = 3)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IBLmw;)V", line = 44)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!eda", name = "c", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(BZ)V", line = 149)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(ZI)V", line = 161)
    ...
    @OriginalMember(owner = "client!eda", name = "d", descriptor = "(I)V", line = 192)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(I)Z", line = 204)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IIZ)V", line = 215)
    ...
    @OriginalMember(owner = "client!eda", name = "b", descriptor = "(I)V", line = 231)
