...
public class class110 extends class535 {
    ...
    @OriginalMember(owner = "client!kt", name = "f", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(ILwn;I)V")
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(ILwn;I)Ljava/lang/String;")
