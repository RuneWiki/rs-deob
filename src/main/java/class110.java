...
public class class110 extends class180 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Lrm;IIII)V")
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IIIILuc;)V")
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Lud;BILud;)V")
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(Lvd;)V")
