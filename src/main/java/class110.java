...
public class class110 extends class62 {
    ...
    @OriginalMember(owner = "client!fg", name = "g", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(I[BIIIBI)Z", line = 30)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Lgw;II)V", line = 80)
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "()V", line = 106)
    public class110() {
        super(1, true);
    }

    @OriginalMember(owner = "client!fg", name = "h", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(B)V", line = 126)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Z)V", line = 146)
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(B)V", line = 227)
    ...
    @OriginalMember(owner = "client!fg", name = "c", descriptor = "(II)[I", line = 418)
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(BI)[I", line = 461)
