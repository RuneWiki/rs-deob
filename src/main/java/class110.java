...
public class class110 extends class106 {
    ...
    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "(Lsa;II)V")
    ...
    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "(Lsa;[IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "(Lsa;[III)V")
