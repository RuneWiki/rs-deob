...
public class class110 extends class601 {
    ...
    @OriginalMember(owner = "client!qba", name = "<init>", descriptor = "()V", line = 220)
    public class110() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qba", name = "a", descriptor = "([Llq;II)V", line = 13)
    ...
    @OriginalMember(owner = "client!qba", name = "f", descriptor = "(I)V", line = 54)
    public static void method645(int arg0) {
        int var1 = 14 / ((-76 - arg0) / 37);
        field1479 = null;
    }

    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(IB)[I", line = 63)
    ...
    @OriginalMember(owner = "client!qba", name = "d", descriptor = "(B)V", line = 151)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(Lmc;II)V", line = 178)
