...
public class class110 {
    ...
    public static int[] field2060 = new int[6];

    @OriginalMember(owner = "client!mj", name = "c", descriptor = "[I")
    public static int[] field2062 = new int[6];
    ...
    public static int[] field2075 = new int[6];

    @OriginalMember(owner = "client!mj", name = "o", descriptor = "[I")
    public static int[] field2074 = new int[6];

    @OriginalMember(owner = "client!mj", name = "n", descriptor = "[[I")
    private static int[][] field2073 = new int[][] { { 1, 3, 5, 7 }, { 1, 3, 5, 7 }, { 1, 3, 5, 7 }, { 1, 3, 5, 7, 6 }, { 1, 3, 5, 7, 6 }, { 1, 3, 5, 7, 6 }, { 1, 3, 5, 7, 6 }, { 1, 3, 5, 7, 2, 6 }, { 1, 3, 5, 7, 2, 8 }, { 1, 3, 5, 7, 2, 8 }, { 1, 3, 5, 7, 11, 12 }, { 1, 3, 5, 7, 11, 12 }, { 1, 3, 5, 7, 13, 14 } };

    @OriginalMember(owner = "client!mj", name = "s", descriptor = "[I")
    public static int[] field2078 = new int[6];
    ...
    public class110(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13, int arg14, int arg15, int arg16, int arg17, int arg18) {
        ...
        this.field2070 = arg0;
        this.field2069 = arg1;
        this.field2067 = arg17;
        this.field2063 = arg18;
        short var20 = 128;
        int var21 = var20 / 2;
        int var22 = var20 / 4;
        int var23 = var20 * 3 / 4;
        int[] var24 = field2073[arg0];
        int var25 = var24.length;
        this.field2080 = new int[var25];
        this.field2065 = new int[var25];
        this.field2077 = new int[var25];
        ...
        for (int var30 = 0; var30 < var25; var30++) {
            ...
            this.field2080[var30] = var44;
            this.field2065[var30] = var46;
            this.field2077[var30] = var45;
            var26[var30] = var47;
            var27[var30] = var48;
        }
        int[] var31 = field2066[arg0];
        int var32 = var31.length / 4;
        this.field2079 = new int[var32];
        this.field2071 = new int[var32];
        this.field2076 = new int[var32];
        this.field2061 = new int[var32];
        this.field2081 = new int[var32];
        this.field2072 = new int[var32];
        if (arg2 != -1) {
            this.field2064 = new int[var32];
        }
        int var33 = 0;
        for (int var34 = 0; var34 < var32; var34++) {
            ...
            this.field2079[var34] = var40;
            this.field2071[var34] = var41;
            this.field2076[var34] = var42;
            if (var39 == 0) {
                this.field2061[var34] = var26[var40];
                this.field2081[var34] = var26[var41];
                this.field2072[var34] = var26[var42];
                if (this.field2064 != null) {
                    this.field2064[var34] = -1;
                }
            } else {
                this.field2061[var34] = var27[var40];
                this.field2081[var34] = var27[var41];
                this.field2072[var34] = var27[var42];
                if (this.field2064 != null) {
                    this.field2064[var34] = arg2;
                }
            }
        }
        int var35 = arg5;
