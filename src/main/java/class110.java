...
public class class110 extends class402 implements class425 {

    @OriginalMember(owner = "client!kt", name = "L", descriptor = "Lqi;")
    public class402 field2018;
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(IIIIIIIIIILqi;)V", line = 4)
    public class110(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, class402 arg10) {
        super(arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, false, class339.method2130(arg0, arg1, (byte) 124));
        this.field2018 = arg10;
    }

    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(Lza;I)Lnd;", line = 12)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(ILza;I)Le;", line = 23)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Z)I", line = 44)
    public final int method225(boolean arg0) {
        field2003++;
        return arg0 ? 31 : 0;
    }

    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Lza;I)V", line = 55)
    ...
    @OriginalMember(owner = "client!kt", name = "c", descriptor = "(I)I", line = 66)
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(Z)V", line = 77)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IBILvs;Lza;ZI)V", line = 89)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(B)Z", line = 102)
    ...
    @OriginalMember(owner = "client!kt", name = "h", descriptor = "(I)I", line = 121)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(BLza;)V", line = 136)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(ZLza;II)Z", line = 146)
    public final boolean method14(boolean arg0, class288 arg1, int arg2, int arg3) {
        field2008++;
        return arg0;
    }

    @OriginalMember(owner = "client!kt", name = "d", descriptor = "(I)I", line = 158)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Lza;Z)V", line = 172)
    ...
    @OriginalMember(owner = "client!kt", name = "f", descriptor = "(I)V", line = 184)
    public final void method12(int arg0) {
        field2002++;
        int var2 = 118 % ((-arg0 - 35) / 44);
    }

    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(I)Z", line = 197)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(III)V", line = 210)
    public static final void method927(int arg0, int arg1, int arg2) {
        if (arg1 == 0) {
            field2010++;
