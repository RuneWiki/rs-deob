...
public class class110 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Z)V", line = 67)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(II)Lcu;", line = 78)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Ld;ILfo;)V", line = 131)
    ...
    @OriginalMember(owner = "client!hq", name = "c", descriptor = "(II)V", line = 119)
