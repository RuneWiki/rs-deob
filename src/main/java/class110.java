...
public class class110 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ILli;)I", line = 5)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lra;I)V", line = 82)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(I)Lra;", line = 109)
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(I)V", line = 137)
    public class110(int arg0) {
        this.field1525 = arg0;
    }

    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(IIIIII)V", line = 144)
