...
public class class110 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IZLug;I)V")
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(ILug;II)V")
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(ILug;II)Z")
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(Lhd;Lag;)V")
