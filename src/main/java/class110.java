...
public class class110 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Lmo;ILe;)V", line = 8)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Z)V", line = 40)
    ...
    @OriginalMember(owner = "client!fq", name = "b", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(III)V", line = 86)
