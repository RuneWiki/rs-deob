...
public class class110 extends class80 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(III)[B", line = 4)
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "()V", line = 9)
    public class110() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IB)V", line = 13)
