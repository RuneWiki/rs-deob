...
public class class475 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IIB)Z", line = 15)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(ILts;)V", line = 29)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IIII)Z", line = 46)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(I)V", line = 63)
