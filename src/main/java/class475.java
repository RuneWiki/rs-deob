...
public class class475 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(II)Z", line = 6)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IBII)Z", line = 16)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IIIIIIIIIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 62)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "()V", line = 157)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 175)
