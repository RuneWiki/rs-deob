...
public class class475 extends class384 {
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(IIILe;Le;)V")
    ...
    @OriginalMember(owner = "client!ab", name = "c", descriptor = "(B)Lnn;")
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "(Lug;IIIIII)V")
