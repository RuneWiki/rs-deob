...
public class class475 extends class667 {
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(ZI)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(BI)[I", line = 323)
    ...
    @OriginalMember(owner = "client!lia", name = "<init>", descriptor = "()V", line = 661)
    public class475() {
        super(2, false);
    }

    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(IFFF)I", line = 576)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(Lfca;I)I", line = 621)
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(Lud;II)V", line = 664)
