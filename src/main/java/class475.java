...
public class class475 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Lqd;Z)V")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(ILpja;)V")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(ZIIZI)Ltca;")
