...
public class class475 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IB)V", line = 13)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!ci", name = "b", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ZZ)Z", line = 64)
