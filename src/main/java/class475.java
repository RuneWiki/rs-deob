...
public class class475 extends class28 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lha;I)Lpn;")
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lro;III)V")
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(Lbl;II[B)V")
