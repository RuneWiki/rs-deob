...
public class class475 {
    ...
    @OriginalMember(owner = "client!oja", name = "a", descriptor = "(II)Lmaa;", line = 4)
    ...
    @OriginalMember(owner = "client!oja", name = "a", descriptor = "(Z)V", line = 34)
    ...
    @OriginalMember(owner = "client!oja", name = "a", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!oja", name = "b", descriptor = "(II)V", line = 63)
    ...
    @OriginalMember(owner = "client!oja", name = "a", descriptor = "(ILrv;)V", line = 86)
    ...
    @OriginalMember(owner = "client!oja", name = "<init>", descriptor = "(Liv;ILcb;)V", line = 137)
