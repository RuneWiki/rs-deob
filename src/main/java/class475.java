...
public class class475 extends class703 {
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(Lhfa;B)V")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(ILsia;)V")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(Ljagdx/IDirect3D;IILjagdx/D3DPRESENT_PARAMETERS;ZI)Z")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(BLg;Lwj;)Z")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(Lrq;B)V")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(Lfga;I)I")
    ...
    @OriginalMember(owner = "client!uda", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Ld;Luq;Ljava/lang/Integer;)Lha;")
    ...
    @OriginalMember(owner = "client!uda", name = "m", descriptor = "(II)Lev;")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(Lwj;BLg;)I")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(BIILfga;)V")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(Lfea;I)I")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(BLjagdx/IDirect3DVertexShader;)V")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(ILg;III[B)Lor;")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(ZLwj;Lg;)Z")
    ...
    @OriginalMember(owner = "client!uda", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/hk;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Lwq;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Ld;Luq;I)V")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(ILmq;ZI)V")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(I[[IZB)Lfaa;")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "([Lrf;Z)Leda;")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(Lhg;)V")
    public final void method554(class718 arg0) {
    }

    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(Lwj;IBILg;)Lfk;")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(Lvba;B)I")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(IZ)Lkm;")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(Lag;Z)I")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(IZI[FIIILg;)Lfk;")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(Lmq;I)I")
    ...
    @OriginalMember(owner = "client!uda", name = "A", descriptor = "()Ldca;")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(ILg;[BIIIIZ)Lfk;")
    ...
    @OriginalMember(owner = "client!uda", name = "d", descriptor = "(II)Lio;")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(II)Lrr;")
    public final class381 method437(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(Lio;Lrr;)Lhg;")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(IZLmq;ZI)V")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(ZB)Lra;")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(ZIII[III)Lfk;")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(ILoga;)V")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(BLeda;)V")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(ZLkm;I)V")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(Lcj;Lcj;FLcj;)Lcj;")
    public final class720 method531(class720 arg0, class720 arg1, float arg2, class720 arg3) {
        return arg2 < 0.5F ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(IIIILfga;ILra;)V")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(Ljagdx/IDirect3DPixelShader;I)V")
