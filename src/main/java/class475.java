...
public abstract class class475 extends class143 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "([BI)Lf;", line = 10)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(BLga;I)V", line = 49)
    ...
    @OriginalMember(owner = "client!tt", name = "e", descriptor = "(B)V", line = 95)
    public static void method2784(byte arg0) {
        field6808 = null;
        int var1 = 71 % ((arg0 + 40) / 59);
    }

    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(III)Z", line = 105)
    ...
    @OriginalMember(owner = "client!tt", name = "<init>", descriptor = "(I)V", line = 115)
