...
public class class475 extends class574 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Lxa;Z)V")
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(II[[I[[IIII)Ld;")
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Lnj;IIII)Lba;")
    ...
    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "(Ljava/awt/Canvas;Le;)V")
    public class475(Canvas arg0, class498 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IIIIZIILen;II)V")
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "([Lba;Lq;[Lpo;I)V")
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Lfm;IIII)V")
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Ljava/lang/Runnable;)Lcm;")
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "([Lba;Lig;Lq;[Lpo;I)V")
