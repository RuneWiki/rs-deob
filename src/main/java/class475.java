...
public class class475 extends class384 implements class126 {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(III[B)V")
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Lnj;)V")
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "(Leea;I[BI)V")
    public class475(class131 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field6740 = arg1;
    }

    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IBILjb;)V")
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "(Leea;ILjaclib/memory/Buffer;)V")
