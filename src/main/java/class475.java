...
public class class475 extends class417 {
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "([B)V", line = 3)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "()I", line = 155)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "([I)Lqk;", line = 162)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(I)I", line = 224)
    ...
    @OriginalMember(owner = "client!jw", name = "b", descriptor = "(I)[F", line = 251)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(Lkda;)Z", line = 669)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(Lkda;I)Ljw;", line = 684)
    ...
    @OriginalMember(owner = "client!jw", name = "b", descriptor = "()V", line = 699)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "([BI)V", line = 719)
    ...
    @OriginalMember(owner = "client!jw", name = "c", descriptor = "(I)F", line = 726)
    ...
    @OriginalMember(owner = "client!jw", name = "b", descriptor = "([B)V", line = 747)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(Lkda;II)Ljw;", line = 800)
    ...
    @OriginalMember(owner = "client!jw", name = "<init>", descriptor = "([B)V", line = 813)
