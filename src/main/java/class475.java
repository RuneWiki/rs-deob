...
public class class475 extends class298 {
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IILvt;)V", line = 29)
    ...
    @OriginalMember(owner = "client!ot", name = "c", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "()V", line = 62)
    public class475() {
        super(0, false);
    }

    @OriginalMember(owner = "client!ot", name = "c", descriptor = "(Z)V", line = 69)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ILvt;)V", line = 85)
    ...
    @OriginalMember(owner = "client!ot", name = "c", descriptor = "(B)I", line = 127)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(II)[[I", line = 138)
