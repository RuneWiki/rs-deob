...
public abstract class class475 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lmq;B)V")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(II[IIII)Lmq;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIBILjava/awt/Canvas;Ld;Lgga;I)Lha;")
