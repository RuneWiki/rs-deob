...
public class class475 extends class362 implements class21 {
    ...
    @OriginalMember(owner = "client!fj", name = "f", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!fj", name = "c", descriptor = "(I)I", line = 16)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IILza;I)Z", line = 28)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(B)I", line = 50)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(I)I", line = 68)
    ...
    @OriginalMember(owner = "client!fj", name = "d", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!fj", name = "g", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(I)Z", line = 107)
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(Lza;B)Lkf;", line = 118)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(ILza;I)Le;", line = 160)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lza;B)V", line = 171)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(ILza;)V", line = 182)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IIII[BII[BI)V", line = 197)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Lza;Lfu;IIIIIZIIIIII)V", line = 241)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lza;I)V", line = 250)
