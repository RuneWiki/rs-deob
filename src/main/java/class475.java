...
public class class475 extends class111 {
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(IBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(ZLsea;Lsea;I)V", line = 24)
    ...
    @OriginalMember(owner = "client!nga", name = "b", descriptor = "(I)I", line = 38)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(B)V", line = 137)
    ...
    @OriginalMember(owner = "client!nga", name = "<init>", descriptor = "(IIIIIII)V", line = 209)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(III)V", line = 220)
    ...
    @OriginalMember(owner = "client!nga", name = "c", descriptor = "(I)V", line = 239)
    ...
    @OriginalMember(owner = "client!nga", name = "b", descriptor = "(III)V", line = 254)
