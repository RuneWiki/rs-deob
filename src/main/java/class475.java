...
public class class475 {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Z)V", line = 38)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(BLjava/lang/String;)V", line = 51)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(II)V", line = 65)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(BI)I", line = 79)
