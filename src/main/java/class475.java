...
public class class475 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IBI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(II)I", line = 18)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(ZILjava/lang/Object;)[B", line = 30)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!gn", name = "toString", descriptor = "()Ljava/lang/String;", line = 85)
    public final String toString() {
        field6852++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(B)I", line = 94)
    public final int method2782(byte arg0) {
        field6856++;
        return arg0 == 41 ? this.field6858 : 90;
    }

    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lhr;Ljava/lang/String;ZI)V", line = 107)
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(II)V", line = 135)
    public class475(int arg0, int arg1) {
        this.field6858 = arg0;
    }

    @OriginalMember(owner = "client!gn", name = "b", descriptor = "(I)V", line = 145)
