...
public abstract class class475 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lbe;Lbe;IIIIIZLbe;IB[ZLbe;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lbe;BI)V", line = 67)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ILbe;ZIIIIILbe;)V", line = 120)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lbw;)V", line = 164)
    public static final void method2676(class689 arg0) {
        class277.field3864 = arg0;
    }

    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIIIZIII[ILbe;Lbe;)V", line = 169)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Ls;IIIIIIII)V", line = 217)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIIZIB[I[III)V", line = 333)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(B)V", line = 439)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Ljava/lang/String;IZI)Z", line = 461)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lkn;IIIIII)V", line = 556)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Liia;ZILvr;II[ZLvr;Z[IBI)V", line = 580)
