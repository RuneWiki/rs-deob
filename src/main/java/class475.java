...
public class class475 extends class54 {
    ...
    @OriginalMember(owner = "client!uda", name = "<init>", descriptor = "(ILhia;)V")
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(BLib;)Luca;")
    ...
    @OriginalMember(owner = "client!uda", name = "<init>", descriptor = "(Lhia;)V")
