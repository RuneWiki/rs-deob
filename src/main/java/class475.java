...
public class class475 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Lmea;III)V", line = 17)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IB)V", line = 47)
    ...
    @OriginalMember(owner = "client!la", name = "b", descriptor = "(IB)Lew;", line = 62)
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(Ldt;ILwia;)V", line = 103)
