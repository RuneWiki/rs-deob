...
public abstract class class475 {
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "([BII)V", line = 7)
    ...
    @OriginalMember(owner = "client!via", name = "d", descriptor = "(I)Z", line = 32)
    ...
    @OriginalMember(owner = "client!via", name = "finalize", descriptor = "()V", line = 53)
    ...
    @OriginalMember(owner = "client!via", name = "<init>", descriptor = "(Ldw;I[BIZ)V", line = 66)
    ...
    @OriginalMember(owner = "client!via", name = "<init>", descriptor = "(Ldw;ILjaclib/memory/Buffer;IZ)V", line = 85)
