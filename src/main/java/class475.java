...
public class class475 extends class149 {
    ...
    @OriginalMember(owner = "client!bm", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(II)[I", line = 15)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Z)V", line = 133)
    ...
    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "()V", line = 165)
    public class475() {
        super(0, true);
    }

    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(IBLtl;)V", line = 168)
