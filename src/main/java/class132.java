...
public class class132 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(III)V", line = 18)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IILjava/lang/String;Z)Z", line = 34)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(II)V", line = 148)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IIIII)V", line = 163)
