...
public class class132 extends class535 {
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 3)
    public static final int method966(String arg0, int arg1) {
        ++field2066;
        return arg1 != 10240 ? -20 : arg0.length() - -1;
    }

    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(IIILci;)Ltg;", line = 14)
    ...
    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "()V", line = 38)
    public class132() {
        super(1, false);
    }

    @OriginalMember(owner = "client!pq", name = "c", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(ILwn;I)V", line = 57)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(II)[[I", line = 114)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(BIZ)V", line = 179)
    ...
    @OriginalMember(owner = "client!pq", name = "b", descriptor = "(II)[I", line = 201)
