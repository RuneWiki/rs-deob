...
public class class132 {
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IIBII)V", line = 3)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IIBIIIIIIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IIII)Z", line = 44)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Lin;Lwea;B)V", line = 88)
    ...
    @OriginalMember(owner = "client!hw", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 143)
