...
public class class132 extends class269 implements class202 {
    ...
    @OriginalMember(owner = "client!ig", name = "f", descriptor = "(II)I", line = 9)
    public final int method863(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!ig", name = "y", descriptor = "()Z", line = 13)
    public final boolean method864() {
        return true;
    }

    @OriginalMember(owner = "client!ig", name = "M", descriptor = "()V", line = 16)
    ...
    @OriginalMember(owner = "client!ig", name = "E", descriptor = "()F", line = 37)
    public final float method866() {
        return this.field1966;
    }

    @OriginalMember(owner = "client!ig", name = "N", descriptor = "()V", line = 41)
    ...
    @OriginalMember(owner = "client!ig", name = "d", descriptor = "(Z)V", line = 56)
    ...
    @OriginalMember(owner = "client!ig", name = "f", descriptor = "(IIIIII)V", line = 66)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lk;Z)Lvj;", line = 77)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ILsg;II)V", line = 136)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Leh;)V", line = 165)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IFFFFF)V", line = 179)
    ...
    @OriginalMember(owner = "client!ig", name = "c", descriptor = "(Z)V", line = 221)
    public final void method874(boolean arg0) {
        this.field1990 = arg0;
        this.method941();
    }

    @OriginalMember(owner = "client!ig", name = "O", descriptor = "()Lwl;", line = 225)
    public final class234 method875() {
        return this.field1965 == null ? null : this.field1965.method456(-32077);
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "([IIIII)Lvj;", line = 228)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(Z)V", line = 233)
    public final void method877(boolean arg0) {
    }

    @OriginalMember(owner = "client!ig", name = "P", descriptor = "()V", line = 236)
    ...
    @OriginalMember(owner = "client!ig", name = "B", descriptor = "()V", line = 243)
    public final void method879() {
    }

    @OriginalMember(owner = "client!ig", name = "D", descriptor = "()Z", line = 246)
    public final boolean method880() {
        return this.field1920.method1620();
    }

    @OriginalMember(owner = "client!ig", name = "h", descriptor = "(I)V", line = 250)
    public final synchronized void method881(int arg0) {
        class24 var2 = new class24(arg0);
        this.field1947.method2756(-55, var2);
    }

    @OriginalMember(owner = "client!ig", name = "K", descriptor = "()V", line = 259)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(F)V", line = 270)
    ...
    @OriginalMember(owner = "client!ig", name = "v", descriptor = "()Ls;", line = 278)
    public final class154 method884() {
        return this.field1927;
    }

    @OriginalMember(owner = "client!ig", name = "Q", descriptor = "()V", line = 284)
    ...
    @OriginalMember(owner = "client!ig", name = "c", descriptor = "(I)V", line = 307)
    ...
    @OriginalMember(owner = "client!ig", name = "k", descriptor = "()Z", line = 313)
    public final boolean method887() {
        return true;
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lee;)V", line = 329)
    ...
    @OriginalMember(owner = "client!ig", name = "R", descriptor = "()V", line = 358)
    ...
    @OriginalMember(owner = "client!ig", name = "f", descriptor = "(I)V", line = 371)
    public final void method890(int arg0) {
        this.method885();
    }

    @OriginalMember(owner = "client!ig", name = "G", descriptor = "()Z", line = 375)
    public final boolean method891() {
        return true;
    }

    @OriginalMember(owner = "client!ig", name = "n", descriptor = "()I", line = 379)
    public final int method892() {
        return this.field2036;
    }

    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(III)V", line = 382)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IZZ)V", line = 393)
    ...
    @OriginalMember(owner = "client!ig", name = "C", descriptor = "()I", line = 446)
    public final int method895() {
        return this.field1932 + this.field1931 + this.field1940;
    }

    @OriginalMember(owner = "client!ig", name = "q", descriptor = "()I", line = 450)
    ...
    @OriginalMember(owner = "client!ig", name = "l", descriptor = "()V", line = 457)
    public final void method897() {
        this.method969(true);
        this.field1918.glClear(256);
    }

    @OriginalMember(owner = "client!ig", name = "e", descriptor = "(IIII)[I", line = 464)
    ...
    @OriginalMember(owner = "client!ig", name = "S", descriptor = "()V", line = 477)
    ...
    @OriginalMember(owner = "client!ig", name = "d", descriptor = "()V", line = 490)
    public final void method900() {
        this.field1926.method1928();
    }

    @OriginalMember(owner = "client!ig", name = "d", descriptor = "(IIIII)V", line = 496)
    public final void method901(int arg0, int arg1, int arg2, int arg3, int arg4) {
        throw new IllegalStateException("Circle fill is not supported by the gl toolkit");
    }

    @OriginalMember(owner = "client!ig", name = "i", descriptor = "(I)I", line = 499)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IIIIIII)V", line = 515)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "([I)V", line = 520)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lqf;IIII)Lni;", line = 527)
    ...
    @OriginalMember(owner = "client!ig", name = "s", descriptor = "()I", line = 532)
    public final int method906() {
        return this.field1983;
    }

    @OriginalMember(owner = "client!ig", name = "T", descriptor = "()I", line = 536)
    ...
    @OriginalMember(owner = "client!ig", name = "c", descriptor = "()V", line = 610)
    public final void method556() {
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "()I", line = 612)
    public final int method565() {
        return this.field1938;
    }

    @OriginalMember(owner = "client!ig", name = "U", descriptor = "()V", line = 615)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Los;)V", line = 625)
    public final void method909(class257 arg0) {
        this.field1918.glPushMatrix();
        this.field1918.glMultMatrixf(arg0.method1780(5), 0);
    }

    @OriginalMember(owner = "client!ig", name = "V", descriptor = "()V", line = 630)
    ...
    @OriginalMember(owner = "client!ig", name = "g", descriptor = "()V", line = 639)
    ...
    @OriginalMember(owner = "client!ig", name = "j", descriptor = "(I)I", line = 675)
    ...
    @OriginalMember(owner = "client!ig", name = "k", descriptor = "(I)V", line = 710)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(III[I)V", line = 725)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(I[BIZ)Lmp;", line = 750)
    ...
    @OriginalMember(owner = "client!ig", name = "g", descriptor = "(II)V", line = 759)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "([Lni;Ls;[Lrh;I)V", line = 766)
    ...
    @OriginalMember(owner = "client!ig", name = "F", descriptor = "()Z", line = 778)
    public final boolean method918() {
        return true;
    }

    @OriginalMember(owner = "client!ig", name = "W", descriptor = "()V", line = 781)
    ...
    @OriginalMember(owner = "client!ig", name = "e", descriptor = "()Z", line = 794)
    public final boolean method920() {
        return true;
    }

    @OriginalMember(owner = "client!ig", name = "X", descriptor = "()V", line = 797)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ILjava/nio/ByteBuffer;Z)Lmp;", line = 807)
    ...
    @OriginalMember(owner = "client!ig", name = "i", descriptor = "(II)V", line = 862)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lrm;)V", line = 868)
    public final void method928(class235 arg0) {
        this.field1922.method2466(this, arg0);
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(FFFF)V", line = 871)
    ...
    @OriginalMember(owner = "client!ig", name = "j", descriptor = "()Z", line = 880)
    public final boolean method930() {
        return this.field1924.method1123(47, 3);
    }

    @OriginalMember(owner = "client!ig", name = "A", descriptor = "()V", line = 888)
    ...
    @OriginalMember(owner = "client!ig", name = "i", descriptor = "()V", line = 898)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IIIIIILsg;II)V", line = 909)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(I)Lbc;", line = 931)
    public final class205 method934(int arg0) {
        return null;
    }

    @OriginalMember(owner = "client!ig", name = "Y", descriptor = "()V", line = 935)
    ...
    @OriginalMember(owner = "client!ig", name = "d", descriptor = "(I)V", line = 989)
    ...
    @OriginalMember(owner = "client!ig", name = "d", descriptor = "(IIII)V", line = 996)
    ...
    @OriginalMember(owner = "client!ig", name = "e", descriptor = "(Z)V", line = 1017)
    ...
    @OriginalMember(owner = "client!ig", name = "Z", descriptor = "()V", line = 1031)
    ...
    @OriginalMember(owner = "client!ig", name = "ab", descriptor = "()V", line = 1096)
    ...
    @OriginalMember(owner = "client!ig", name = "bb", descriptor = "()V", line = 1103)
    private final void method941() {
        this.field1918.glDepthMask(this.field1948 && this.field1990);
    }

    @OriginalMember(owner = "client!ig", name = "f", descriptor = "(Z)V", line = 1106)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(FFF)V", line = 1115)
    ...
    @OriginalMember(owner = "client!ig", name = "c", descriptor = "(II)I", line = 1124)
    public final int method944(int arg0, int arg1) {
        return arg0 & arg1 ^ arg1;
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(I[Lpc;)V", line = 1130)
    ...
    @OriginalMember(owner = "client!ig", name = "c", descriptor = "(IIIII)V", line = 1168)
    ...
    @OriginalMember(owner = "client!ig", name = "cb", descriptor = "()V", line = 1181)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "()V", line = 1187)
    public final void method561() {
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lro;)V", line = 1189)
    public final void method948(class1 arg0) {
        this.field1965 = (class152) arg0;
    }

    @OriginalMember(owner = "client!ig", name = "c", descriptor = "(III)V", line = 1192)
    ...
    @OriginalMember(owner = "client!ig", name = "p", descriptor = "()V", line = 1201)
    ...
    @OriginalMember(owner = "client!ig", name = "db", descriptor = "()V", line = 1208)
    ...
    @OriginalMember(owner = "client!ig", name = "f", descriptor = "()Z", line = 1218)
    ...
    @OriginalMember(owner = "client!ig", name = "H", descriptor = "()I", line = 1230)
    public final int method953() {
        return 4;
    }

    @OriginalMember(owner = "client!ig", name = "eb", descriptor = "()V", line = 1233)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IIIIII[BII)V", line = 1249)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(FF)V", line = 1299)
    ...
    @OriginalMember(owner = "client!ig", name = "o", descriptor = "()Z", line = 1316)
    public final boolean method957() {
        return false;
    }

    @OriginalMember(owner = "client!ig", name = "d", descriptor = "(III)V", line = 1320)
    ...
    @OriginalMember(owner = "client!ig", name = "w", descriptor = "()I", line = 1325)
    ...
    @OriginalMember(owner = "client!ig", name = "J", descriptor = "()Z", line = 1333)
    public final boolean method960() {
        return false;
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lwi;Lwi;Lwi;Lwi;)V", line = 1337)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lis;)V", line = 1372)
    ...
    @OriginalMember(owner = "client!ig", name = "j", descriptor = "(II)V", line = 1381)
    ...
    @OriginalMember(owner = "client!ig", name = "m", descriptor = "()Z", line = 1386)
    public final boolean method964() {
        return false;
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(FFF)V", line = 1391)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(Leh;)V", line = 1396)
    ...
    @OriginalMember(owner = "client!ig", name = "z", descriptor = "()V", line = 1413)
    ...
    @OriginalMember(owner = "client!ig", name = "fb", descriptor = "()V", line = 1420)
    ...
    @OriginalMember(owner = "client!ig", name = "g", descriptor = "(Z)V", line = 1435)
    ...
    @OriginalMember(owner = "client!ig", name = "I", descriptor = "()V", line = 1446)
    ...
    @OriginalMember(owner = "client!ig", name = "L", descriptor = "()Z", line = 1477)
    public final boolean method971() {
        return this.field1920.method163(0);
    }

    @OriginalMember(owner = "client!ig", name = "m", descriptor = "(I)V", line = 1481)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Ls;)V", line = 1593)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lmp;)V", line = 1600)
    ...
    @OriginalMember(owner = "client!ig", name = "k", descriptor = "(II)V", line = 1609)
    ...
    @OriginalMember(owner = "client!ig", name = "h", descriptor = "()Z", line = 1614)
    public final boolean method976() {
        return !this.field1991;
    }

    @OriginalMember(owner = "client!ig", name = "n", descriptor = "(I)V", line = 1621)
    public final void method977(int arg0) {
        this.method923(arg0, true);
    }

    @OriginalMember(owner = "client!ig", name = "gb", descriptor = "()Leh;", line = 1624)
    public final class202 method978() {
        return this.field1929;
    }

    @OriginalMember(owner = "client!ig", name = "hb", descriptor = "()V", line = 1627)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(II)V", line = 1643)
    ...
    @OriginalMember(owner = "client!ig", name = "o", descriptor = "(I)V", line = 1663)
    public final synchronized void method981(int arg0) {
        class24 var2 = new class24(arg0);
        this.field1946.method2756(-84, var2);
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lis;III)V", line = 1668)
    public final void method982(class292 arg0, int arg1, int arg2, int arg3) {
        this.method962(arg0);
        arg0.method1979(arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!ig", name = "g", descriptor = "(IIIIII)V", line = 1677)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Z)V", line = 1701)
    public final void method984(boolean arg0) {
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IIIIIIIIII)V", line = 1703)
    public final void method985(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9) {
    }

    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(I[BIZ)Lis;", line = 1708)
    ...
    @OriginalMember(owner = "client!ig", name = "p", descriptor = "(I)V", line = 1716)
    ...
    @OriginalMember(owner = "client!ig", name = "t", descriptor = "()F", line = 1723)
    public final float method988() {
        return this.field1950;
    }

    @OriginalMember(owner = "client!ig", name = "e", descriptor = "(II)V", line = 1728)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(IIIII)V", line = 1745)
    ...
    @OriginalMember(owner = "client!ig", name = "ib", descriptor = "()V", line = 1758)
    ...
    @OriginalMember(owner = "client!ig", name = "jb", descriptor = "()V", line = 1769)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lro;Lro;FLro;)Lro;", line = 1782)
    ...
    @OriginalMember(owner = "client!ig", name = "kb", descriptor = "()V", line = 1820)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(F)V", line = 1844)
    ...
    @OriginalMember(owner = "client!ig", name = "h", descriptor = "(Z)V", line = 1858)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(II[[I[[IIII)Luh;", line = 1867)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(IIIIII)Z", line = 1871)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lbc;)V", line = 1901)
    public final void method999(class205 arg0) {
    }

    @OriginalMember(owner = "client!ig", name = "lb", descriptor = "()V", line = 1904)
    ...
    @OriginalMember(owner = "client!ig", name = "mb", descriptor = "()V", line = 1919)
    ...
    @OriginalMember(owner = "client!ig", name = "q", descriptor = "(I)V", line = 1923)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IIII)V", line = 1933)
    ...
    @OriginalMember(owner = "client!ig", name = "c", descriptor = "(IIII)V", line = 1950)
    ...
    @OriginalMember(owner = "client!ig", name = "g", descriptor = "(I)V", line = 1969)
    public final void method1005(int arg0) {
        this.method910();
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(III)V", line = 1975)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(I)V", line = 1987)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "([Lni;Lrm;Ls;[Lrh;I)V", line = 2153)
    ...
    @OriginalMember(owner = "client!ig", name = "nb", descriptor = "()V", line = 2158)
    ...
    @OriginalMember(owner = "client!ig", name = "ob", descriptor = "()V", line = 2165)
    public final void method1010() {
        this.field1918.glPopMatrix();
    }

    @OriginalMember(owner = "client!ig", name = "r", descriptor = "()Z", line = 2169)
    public final boolean method1011() {
        return this.field2010;
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IIIIII)V", line = 2175)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lni;Lrm;Ls;Lrh;I)V", line = 2200)
    ...
    @OriginalMember(owner = "client!ig", name = "e", descriptor = "(IIIIII)Lro;", line = 2204)
    ...
    @OriginalMember(owner = "client!ig", name = "r", descriptor = "(I)I", line = 2208)
    ...
    @OriginalMember(owner = "client!ig", name = "u", descriptor = "()Ls;", line = 2220)
    public final class154 method1016() {
        return new class257();
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 2227)
    public final void method1017(Canvas arg0) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ig", name = "pb", descriptor = "()V", line = 2231)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(FF)V", line = 2239)
    ...
    @OriginalMember(owner = "client!ig", name = "e", descriptor = "(III)V", line = 2246)
    public final void method1020(int arg0, int arg1, int arg2) {
        this.field1918.glDrawArrays(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!ig", name = "qb", descriptor = "()V", line = 2253)
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(Ljava/awt/Canvas;Lbk;IILml;)V", line = 2602)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(II[I[I)Lsg;", line = 2273)
    ...
    @OriginalMember(owner = "client!ig", name = "rb", descriptor = "()V", line = 2277)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lbb;[Lk;Z)Lug;", line = 2326)
    public final class335 method1024(class182 arg0, class337[] arg1, boolean arg2) {
        return new class362(this, arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 2341)
    public final void method1025(Rectangle[] arg0, int arg1) {
        this.method882();
    }

    @OriginalMember(owner = "client!ig", name = "x", descriptor = "()Z", line = 2349)
    public final boolean method1026() {
        return true;
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IIIIZ)Lvj;", line = 2352)
