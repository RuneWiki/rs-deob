...
public class class132 extends class447 implements class193 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IBIILrr;Luo;Z)V")
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(Luo;Lgm;IIIIIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ILuo;)V")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IILuo;I)Z")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ILuo;I)Lmj;")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ZLuo;)Laj;")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Luo;I)V")
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(Luo;I)V")
