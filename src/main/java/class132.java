...
public class class132 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ZI)Lkf;", line = 15)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(II)V", line = 42)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(B)V", line = 60)
