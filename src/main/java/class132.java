...
public class class132 extends class354 {
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "()V", line = 142)
    public class132() {
        super(1, false);
    }

    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(ILti;I)V", line = 14)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IB)[I", line = 59)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(BI)[[I", line = 96)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Z)V", line = 145)
    ...
    @OriginalMember(owner = "client!pk", name = "c", descriptor = "(B)V", line = 158)
