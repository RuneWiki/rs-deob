...
public class class132 extends class79 {
    ...
    @OriginalMember(owner = "client!pk", name = "d", descriptor = "()Lgm;", line = 4)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Lrv;IB)V", line = 29)
    ...
    @OriginalMember(owner = "client!pk", name = "d", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "([III)V", line = 83)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IIILrv;[II)V", line = 123)
    ...
    @OriginalMember(owner = "client!pk", name = "b", descriptor = "()Lgm;", line = 190)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(I)V", line = 214)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "()I", line = 248)
    public final int method83() {
        field1904++;
        return 0;
    }

    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IIIIIZII)V", line = 257)
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "(Ljb;)V", line = 465)
