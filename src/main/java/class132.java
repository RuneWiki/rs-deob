...
public class class132 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(III)I", line = 11)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "()V", line = 37)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(II)[I", line = 56)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Los;)V", line = 347)
