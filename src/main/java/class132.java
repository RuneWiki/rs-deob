...
public abstract class class132 extends class263 {
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(IBIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(ILpfa;I)Lxa;", line = 22)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(BI)V", line = 54)
    ...
    @OriginalMember(owner = "client!wk", name = "d", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lpg;ILac;ILpp;III)V", line = 96)
