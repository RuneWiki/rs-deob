...
public class class132 extends class221 {
    ...
    @OriginalMember(owner = "client!hw", name = "<init>", descriptor = "(Lac;II)V")
    ...
    @OriginalMember(owner = "client!hw", name = "<init>", descriptor = "(Lac;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!hw", name = "<init>", descriptor = "(Lac;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(ILeda;)[I")
    ...
    @OriginalMember(owner = "client!hw", name = "d", descriptor = "(Z)V")
