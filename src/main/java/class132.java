...
public class class132 {
    ...
    @OriginalMember(owner = "client!pq", name = "<init>", descriptor = "(Lih;)V", line = 193)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(BLza;)V", line = 21)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(B)V", line = 137)
    ...
    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(IBI)B", line = 169)
