...
public abstract class class132 extends class114 {
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(I)V", line = 7)
    public class132(int arg0) {
        this.field1781 = arg0;
    }

    @OriginalMember(owner = "client!me", name = "a", descriptor = "(IIIBI)V", line = 15)
    ...
    @OriginalMember(owner = "client!me", name = "b", descriptor = "(B)V", line = 35)
