...
public class class132 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Lr;IB)Z")
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(ILbea;[Ldg;)Lmd;")
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IBILr;IIIIII)V")
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "(I[Llc;IIII)V")
