...
public class class132 {
    ...
    @OriginalMember(owner = "client!ob", name = "j", descriptor = "Llf;")
    public static class109 field2550 = class35.method275("Null", 2);

    @OriginalMember(owner = "client!ob", name = "f", descriptor = "Llf;")
    public static class109 field2546 = class35.method275("title)3jpg", 2);

    @OriginalMember(owner = "client!ob", name = "e", descriptor = "[Lmh;")
    ...
    @OriginalMember(owner = "client!ob", name = "o", descriptor = "Loh;")
    public static class138 field2555;

    @OriginalMember(owner = "client!ob", name = "n", descriptor = "Lda;")
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(Lja;)V")
