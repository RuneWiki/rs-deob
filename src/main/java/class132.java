...
public class class132 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IC)C", line = 9)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Ljg;IBI)V", line = 53)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(ILjg;I)V", line = 103)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Lup;Z)Z", line = 123)
