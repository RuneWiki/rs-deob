...
public class class132 extends class665 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(I)I", line = 19)
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(B)Z", line = 41)
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!wh", name = "c", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!wh", name = "d", descriptor = "(B)Z", line = 97)
    ...
    @OriginalMember(owner = "client!wh", name = "e", descriptor = "(B)Z", line = 115)
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(II)V", line = 125)
