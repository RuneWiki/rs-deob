...
public class class132 extends IOException {
    ...
    @OriginalMember(owner = "client!dha", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 3)
    public class132(String arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(Lbo;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(BII)V", line = 41)
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(III[B)[B", line = 71)
