...
public class class132 extends class115 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Z)I", line = 6)
    ...
    @OriginalMember(owner = "client!cj", name = "c", descriptor = "(B)Ltr;", line = 20)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lok;III)Lio;", line = 72)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIII)V", line = 91)
    ...
    @OriginalMember(owner = "client!cj", name = "d", descriptor = "(B)V", line = 114)
