...
public class class132 extends class735 {
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(IIIIILdja;)V")
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(ILfca;)V")
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Lrh;Z)V")
