...
public abstract class class132 extends class187 {
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IZ)V", line = 31)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(II)[[[B", line = 43)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(IZ)V", line = 825)
    ...
    @OriginalMember(owner = "client!ub", name = "c", descriptor = "(B)V", line = 854)
