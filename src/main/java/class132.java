...
public class class132 extends class235 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(III)I", line = 4)
    ...
    @OriginalMember(owner = "client!gr", name = "d", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IIIIIIII)V", line = 35)
    ...
    @OriginalMember(owner = "client!gr", name = "e", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ZI)V", line = 81)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(BLqj;Lqj;)V", line = 100)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Loc;III[Z)V", line = 113)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ZILjava/lang/String;Ldr;)V", line = 143)
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "([B)V", line = 170)
    public class132(byte[] arg0) {
        this.field1773 = arg0;
    }

    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IB)Lhh;", line = 178)
