...
public class class132 extends class418 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ZLde;)[Lje;", line = 40)
    ...
    @OriginalMember(owner = "client!op", name = "c", descriptor = "(Z)V", line = 82)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "()V", line = 101)
    public class132() {
    }

    @OriginalMember(owner = "client!op", name = "b", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 115)
