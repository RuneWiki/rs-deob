...
public class class132 extends class509 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIIIIIIIIILuh;)Z")
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(BILin;)V")
    ...
    @OriginalMember(owner = "client!cj", name = "<init>", descriptor = "(Ltt;)V")
