...
public class class132 extends class62 {
    ...
    @OriginalMember(owner = "client!st", name = "c", descriptor = "(I)J", line = 3)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(JI)I", line = 37)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Z)J", line = 68)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "()V", line = 114)
    public class132() {
    ...
    @OriginalMember(owner = "client!st", name = "b", descriptor = "(I)J", line = 102)
