...
public class class132 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(I)[[I", line = 67)
    ...
    @OriginalMember(owner = "client!nj", name = "b", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!nj", name = "b", descriptor = "(B)V", line = 111)
    ...
    @OriginalMember(owner = "client!nj", name = "c", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(III)V", line = 247)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IZ)[I", line = 172)
