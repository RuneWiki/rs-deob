...
public class class132 extends class354 {
    ...
    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ct", name = "d", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ct", name = "b", descriptor = "(Loa;I)Lok;", line = 44)
    ...
    @OriginalMember(owner = "client!ct", name = "finalize", descriptor = "()V", line = 79)
    ...
    @OriginalMember(owner = "client!ct", name = "c", descriptor = "(Loa;I)V", line = 95)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IILoa;I)Z", line = 117)
    ...
    @OriginalMember(owner = "client!ct", name = "b", descriptor = "(Z)V", line = 133)
    ...
    @OriginalMember(owner = "client!ct", name = "e", descriptor = "(I)I", line = 147)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(ZIZIILfl;Loa;)V", line = 158)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(B)V", line = 170)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(BLoa;Lq;Lba;)V", line = 186)
    ...
    @OriginalMember(owner = "client!ct", name = "d", descriptor = "(B)Z", line = 211)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(ILoa;)Lgr;", line = 224)
    ...
    @OriginalMember(owner = "client!ct", name = "b", descriptor = "(IILoa;I)Lba;", line = 235)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(II)V", line = 266)
