...
public class class132 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IILso;BLso;ZZ)I")
    ...
    @OriginalMember(owner = "client!tp", name = "b", descriptor = "(II)Lsg;")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Lui;IZIII)V")
    ...
    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(Lgp;ILui;)V")
