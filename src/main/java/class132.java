...
public class class132 extends class206 {
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(IIILdja;BIIIIII)Z", line = 10)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Ldja;IIIIIIIIII)Z", line = 380)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(I)V", line = 624)
