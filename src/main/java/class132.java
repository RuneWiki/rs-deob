...
public class class132 extends class712 implements class238 {
    ...
    @OriginalMember(owner = "client!laa", name = "e", descriptor = "(Z)Z", line = 4)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Lha;I)V", line = 17)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Lha;IIIIIIZZ)V", line = 32)
    ...
    @OriginalMember(owner = "client!laa", name = "c", descriptor = "(III)Z", line = 150)
    ...
    @OriginalMember(owner = "client!laa", name = "e", descriptor = "(I)I", line = 161)
    ...
    @OriginalMember(owner = "client!laa", name = "b", descriptor = "(I)I", line = 173)
    ...
    @OriginalMember(owner = "client!laa", name = "i", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!laa", name = "b", descriptor = "(ILha;)Lrk;", line = 196)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(I)I", line = 241)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(B)I", line = 255)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(ILha;)V", line = 266)
    ...
    @OriginalMember(owner = "client!laa", name = "d", descriptor = "(Z)V", line = 280)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(IBILha;)Z", line = 291)
    ...
    @OriginalMember(owner = "client!laa", name = "f", descriptor = "(I)I", line = 313)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(ZLha;)Loba;", line = 325)
    ...
    @OriginalMember(owner = "client!laa", name = "<init>", descriptor = "(Lha;Ltba;IIIIIZIIIIIII)V", line = 336)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(CI)Z", line = 347)
    ...
    @OriginalMember(owner = "client!laa", name = "c", descriptor = "(I)Z", line = 371)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Lgda;Lha;IIZII)V", line = 390)
    ...
    @OriginalMember(owner = "client!laa", name = "c", descriptor = "(Z)Z", line = 401)
    ...
    @OriginalMember(owner = "client!laa", name = "b", descriptor = "(Lha;I)V", line = 412)
    ...
    @OriginalMember(owner = "client!laa", name = "d", descriptor = "(B)Z", line = 434)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Z)V", line = 445)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(ILgt;)V", line = 460)
