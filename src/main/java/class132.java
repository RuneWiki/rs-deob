...
public class class132 {
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(II)V", line = 17)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IIIIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IZIIZ)I", line = 132)
    ...
    @OriginalMember(owner = "client!ue", name = "b", descriptor = "(II)I", line = 176)
