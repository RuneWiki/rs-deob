...
public class class132 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Lgf;ZLqa;)I", line = 4)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(B[ILat;[I[I)V", line = 42)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(B)I", line = 139)
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(I[[[BIBII)V", line = 261)
