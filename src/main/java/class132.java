...
public class class132 extends class1 {
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "([I[III)V")
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!dv", name = "<init>", descriptor = "(Lrp;[B[III)V")
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IIIIIIIII)V")
