...
public class class132 extends class453 {
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(I[Lofa;)Lhi;")
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(ILtaa;ZI)V")
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(BLti;Lkca;)Z")
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(Lc;Lvi;)Luaa;")
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(Lhi;Z)V")
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(ZIZ[[I)Lsaa;")
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(IIILkca;I[BZI)Lwda;")
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(ZZBILtaa;)V")
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(Luf;III)V")
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(ILkca;Lti;II)Lwda;")
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "([FIIZIILkca;I)Lwda;")
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(ILti;Lkca;)Z")
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(BZ)Lcaa;")
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(BI)Ldw;")
    ...
    @OriginalMember(owner = "client!eea", name = "<init>", descriptor = "(Ljaggl/OpenGL;Ljava/awt/Canvas;JLd;Leq;I)V")
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(BLcv;)V")
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(Luaa;)V")
    ...
    @OriginalMember(owner = "client!eea", name = "q", descriptor = "()Lsia;")
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(IILida;BILuf;I)V")
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(Lsfa;Lsfa;FLsfa;)Lsfa;")
    public final class693 method571(class693 arg0, class693 arg1, float arg2, class693 arg3) {
        ++field2047;
        return !(arg2 < 0.5F) ? arg1 : arg0;
    }

    @OriginalMember(owner = "client!eea", name = "b", descriptor = "(IZ)Lida;")
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(III[IZIZ)Lwda;")
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(Lcaa;II)V")
    ...
    @OriginalMember(owner = "client!eea", name = "e", descriptor = "(II)Lc;")
    public final class185 method644(int arg0, int arg1) {
        ++field2017;
        return null;
    }

    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(Lkca;IBI[BI)Lii;")
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(II)Lvi;")
