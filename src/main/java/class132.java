...
public class class132 extends class73 implements class2 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "()Ltc;", line = 14)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(III[I)V", line = 34)
    ...
    @OriginalMember(owner = "client!ja", name = "e", descriptor = "(I)V", line = 44)
    public final void method674(int arg0) {
        this.method1064(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!ja", name = "d", descriptor = "(I)V", line = 47)
    public final void method672(int arg0) {
        this.method1072(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "()V", line = 51)
    public class132() {
        this.method1071();
    }

    @OriginalMember(owner = "client!ja", name = "b", descriptor = "(III)V", line = 56)
    public final void method675(int arg0, int arg1, int arg2) {
        this.method1065(this.nativeid, arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!ja", name = "finalize", descriptor = "()V", line = 60)
    ...
    @OriginalMember(owner = "client!ja", name = "b", descriptor = "(III[I)V", line = 65)
    ...
    @OriginalMember(owner = "client!ja", name = "g", descriptor = "(I)V", line = 71)
    public final void method678(int arg0) {
        this.method1063(this.nativeid, arg0);
    }

    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(Ltc;)V", line = 77)
    ...
    @OriginalMember(owner = "client!ja", name = "b", descriptor = "()V", line = 83)
    public final void method677() {
        this.method1068(this.nativeid);
    }

    @OriginalMember(owner = "client!ja", name = "f", descriptor = "(I)V", line = 88)
