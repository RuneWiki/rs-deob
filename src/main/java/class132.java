...
public class class132 extends class276 implements class242 {
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "()V", line = 19)
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(Lw;Ljava/awt/Canvas;)V", line = 24)
    ...
    @OriginalMember(owner = "client!b", name = "finalize", descriptor = "()V", line = 31)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(Ljava/lang/Exception;)V", line = 36)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 61)
