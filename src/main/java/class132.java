...
public class class132 extends class295 {
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IILrk;BLpg;Z)[F")
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Lpg;Lrk;I)Z")
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(BIDILpg;Lrk;Z)[I")
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IZDZLrk;Lpg;II)[I")
    ...
    @OriginalMember(owner = "client!ue", name = "<init>", descriptor = "(Lap;)V")
