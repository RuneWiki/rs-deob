...
public class class132 {
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ej", name = "b", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Lib;ZLib;IZ)I", line = 31)
