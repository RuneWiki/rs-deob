...
public class class606 extends class253 {
    ...
    @OriginalMember(owner = "client!ht", name = "c", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "(Lin;Lti;IIIIIIIIIIIIII)V", line = 98)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(FFBF)I", line = 106)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(I)Lsaa;", line = 159)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(B)V", line = 173)
