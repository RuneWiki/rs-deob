...
public class class606 {
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Lr;Lqa;IBIIIZ)V")
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IBLqa;IZZI)Lr;")
    ...
    @OriginalMember(owner = "client!ba", name = "<init>", descriptor = "(Lqa;Lih;IIIIIIZI)V")
    ...
    @OriginalMember(owner = "client!ba", name = "b", descriptor = "(Lqa;I)V")
