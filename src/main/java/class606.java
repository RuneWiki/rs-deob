...
public class class606 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(B)Llr;", line = 4)
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(ZLlr;)V", line = 54)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(BFFF)I", line = 73)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(I)Llr;", line = 150)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Z)I", line = 178)
    ...
    @OriginalMember(owner = "client!fk", name = "c", descriptor = "(B)V", line = 199)
    ...
    @OriginalMember(owner = "client!fk", name = "c", descriptor = "(I)V", line = 210)
    ...
    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "()V", line = 246)
    public class606() {
