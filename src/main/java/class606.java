...
public class class606 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Z)V", line = 75)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(BI)Lpk;", line = 86)
    ...
    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(Z)V", line = 113)
