...
public class class606 {
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(II)Lhp;", line = 50)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Loh;III)V", line = 100)
    ...
    @OriginalMember(owner = "client!ba", name = "<init>", descriptor = "(Ljj;Ln;)V", line = 137)
