...
public class class606 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(II)V", line = 133)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Lnw;ZI[I)V", line = 165)
