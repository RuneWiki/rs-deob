...
public class class606 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IIILha;IIIILwc;III)V", line = 9)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(B)Lpe;", line = 83)
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(I)V", line = 150)
    public class606(int arg0) {
        this.field8799 = arg0;
    }

    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(IIIIII)V", line = 157)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(FIFF)F", line = 102)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(ILpe;)V", line = 113)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(III)I", line = 132)
