...
public class class606 extends class37 implements class349 {
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(Lai;Lwd;III[B)V", line = 41)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lbda;BI)V", line = 57)
    ...
    @OriginalMember(owner = "client!lj", name = "d", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "([Ljava/lang/String;I)[Ljava/lang/String;", line = 146)
