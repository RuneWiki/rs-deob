...
public class class606 extends class296 {
    ...
    @OriginalMember(owner = "client!og", name = "d", descriptor = "(I)J", line = 4)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(ZJ)I", line = 21)
    ...
    @OriginalMember(owner = "client!og", name = "e", descriptor = "(I)J", line = 55)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "()V", line = 117)
    public class606() {
        this.field8026 = System.nanoTime();
        this.field8025 = System.nanoTime();
    }

    @OriginalMember(owner = "client!og", name = "a", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(I)J", line = 106)
