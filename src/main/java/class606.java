...
public abstract class class606 {
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(IJIILuv;IBLaa;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(IBIIIII)V", line = 65)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(IB)I", line = 108)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(B)V", line = 129)
