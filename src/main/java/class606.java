...
public class class606 extends class601 {
    ...
    @OriginalMember(owner = "client!kaa", name = "<init>", descriptor = "()V", line = 22)
    public class606() {
        super(1, false);
    }

    @OriginalMember(owner = "client!kaa", name = "f", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Lmc;II)V", line = 29)
    ...
    @OriginalMember(owner = "client!kaa", name = "b", descriptor = "(II)[[I", line = 64)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(IIB)Z", line = 146)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(CI)Z", line = 160)
