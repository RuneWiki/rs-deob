...
public abstract class class606 {
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!raa", name = "b", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(Z)V", line = 71)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!raa", name = "b", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!raa", name = "d", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!raa", name = "c", descriptor = "(B)V", line = 118)
    ...
    @OriginalMember(owner = "client!raa", name = "<init>", descriptor = "(Lsr;)V", line = 129)
    public class606(class251 arg0) {
        this.field8525 = arg0;
    }

    @OriginalMember(owner = "client!raa", name = "e", descriptor = "(I)V", line = 146)
