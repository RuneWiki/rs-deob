...
public class class606 extends class66 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(B)I", line = 7)
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(ZI)Lps;", line = 60)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(ILie;)V", line = 134)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(BII[B)Ljava/lang/String;", line = 166)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Ljava/lang/String;IILjava/lang/String;Z)V", line = 257)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(I)V", line = 270)
    ...
    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "()V", line = 294)
    public class606() {
    }

    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "(ZLk;)V", line = 296)
