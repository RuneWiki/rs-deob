...
public class class606 extends class473 implements class251 {
    ...
    @OriginalMember(owner = "client!v", name = "e", descriptor = "()[Lqr;")
    ...
    @OriginalMember(owner = "client!v", name = "c", descriptor = "()[Low;")
    public final class93[] method1910() {
        return this.field8506;
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;Lufa;I)V")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lq;Lufa;II)V")
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(Ll;Lm;Lef;IIII)V")
