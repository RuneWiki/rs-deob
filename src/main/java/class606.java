...
public class class606 {
    ...
    @OriginalMember(owner = "client!pw", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field9006++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(II)I", line = 21)
    public static final int method3565(int arg0, int arg1) {
        return class188.field2803 == null ? 0 : class188.field2803[arg0][arg1] & 0xFFFF;
    }

    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(ILkda;I)Lce;", line = 24)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(IIIIIIIIII)V", line = 46)
