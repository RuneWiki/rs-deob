...
public class class606 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Lgga;I)V")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Z)Lfm;")
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(BLgga;I)V")
