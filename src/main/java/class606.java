...
public class class606 extends OutputStream {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!cs", name = "write", descriptor = "(I)V", line = 23)
    public final void write(int arg0) throws IOException {
        field8411++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IBI)Z", line = 33)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I[BLck;I)Lhg;", line = 44)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IZ)I", line = 75)
