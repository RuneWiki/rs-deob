...
public class class606 {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(IIIILda;I)Lda;", line = 27)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(B)V", line = 160)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(ILda;BIIIII)Lda;", line = 198)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(ILek;)V", line = 262)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(ILek;I)V", line = 288)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(BIIZ)I", line = 498)
