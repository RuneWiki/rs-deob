...
public class class606 {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(IBI[Lf;Ljava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(II[Lf;Ljava/lang/String;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "([Lf;Ljava/lang/String;I)I")
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "([Lf;[Ljava/lang/String;[ILjava/lang/String;I)I")
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "([Lf;ZILjava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(IB[Lf;Ljava/lang/String;)I")
