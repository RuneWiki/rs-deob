...
public class class606 extends class214 {
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "()V", line = 246)
    public class606() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ph", name = "c", descriptor = "(II)[[I", line = 9)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IIIIZIIILup;[II[IIII)I", line = 74)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ILofa;I)V", line = 249)
    ...
    @OriginalMember(owner = "client!ph", name = "e", descriptor = "(B)V", line = 299)
