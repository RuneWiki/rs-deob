...
public class class606 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;ZIZ)V", line = 19)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ILjava/lang/String;I)I", line = 84)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Liq;B)V", line = 99)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Z)Liq;", line = 118)
