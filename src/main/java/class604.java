...
public class class604 extends InputStream {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(I)[Lhb;", line = 6)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(BLvi;ZZ)V", line = 20)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(II)I", line = 95)
    ...
    @OriginalMember(owner = "client!jh", name = "read", descriptor = "()I", line = 107)
