...
public class class604 extends class717 {
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "(Lla;Lla;Lge;)V", line = 3)
    public class604(class422 arg0, class422 arg1, class405 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!qs", name = "e", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!qs", name = "c", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IIIII)V", line = 34)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(I[B)[B", line = 50)
