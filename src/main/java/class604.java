...
public class class604 extends class694 {
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(II)[I", line = 5)
    ...
    @OriginalMember(owner = "client!sv", name = "i", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IIIIIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "()V", line = 245)
    public class604() {
        super(1, true);
    }
}
