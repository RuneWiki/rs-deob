...
public class class604 {
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(Lce;ILce;B)Lrn;")
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(II)Luf;")
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(ZLce;ILce;Z)Lrn;")
    ...
    @OriginalMember(owner = "client!vw", name = "<init>", descriptor = "(Ll;Lcda;Ljava/math/BigInteger;Ljava/math/BigInteger;)V")
