...
public class class604 {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "([B[B[SII)V", line = 8)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Lpfa;Lmga;Lhba;Lsj;Ln;Laba;Lada;)V", line = 151)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(II)Lkp;", line = 182)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Le;III)I", line = 199)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "()V", line = 255)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Loa;)V", line = 268)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(II)Lek;", line = 280)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Loa;IIII)V", line = 294)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Loa;IIII[S[B)V", line = 637)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(Loa;)Lws;", line = 698)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "()V", line = 710)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(I)V", line = 866)
    public static final void method3343(int arg0) {
        field8107 = (class474) field8103.method3828((long) arg0, (byte) -91);
    }

    @OriginalMember(owner = "client!it", name = "c", descriptor = "()V", line = 869)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Loa;Lji;IIII[I[I)V", line = 896)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(Loa;IIII)Lws;", line = 1032)
    ...
    @OriginalMember(owner = "client!it", name = "d", descriptor = "()V", line = 1046)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(I)Lek;", line = 1068)
    public static final class474 method3348(int arg0) {
        return (class474) field8103.method3828((long) arg0, (byte) -91);
    }

    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Loa;IIIIIII[S[BZ)V", line = 1072)
    ...
    @OriginalMember(owner = "client!it", name = "e", descriptor = "()V", line = 1233)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Loa;II)V", line = 1244)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Le;II)V", line = 1439)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Loa;Lfca;IIII)V", line = 1453)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IIIIIIII)V", line = 1470)
