...
public abstract class class604 {
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(ILwd;)V", line = 51)
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "(IIIII)V", line = 524)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(B)V", line = 265)
    ...
    @OriginalMember(owner = "client!qs", name = "c", descriptor = "(I)V", line = 292)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "()V", line = 306)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(BI)Z", line = 322)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IIII)V", line = 345)
