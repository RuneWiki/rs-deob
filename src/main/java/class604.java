...
public class class604 extends class4 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(III)Z", line = 14)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(II[II)Z", line = 40)
    ...
    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 231)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(IIIIII)V", line = 90)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "([IIZI)Z", line = 109)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(III[IB)Z", line = 134)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(BZ)V", line = 213)
