...
public class class604 implements class296 {
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(III)Z", line = 5)
    ...
    @OriginalMember(owner = "client!bca", name = "toString", descriptor = "()Ljava/lang/String;", line = 19)
    public final String toString() {
        field8550++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(I)I", line = 32)
    ...
    @OriginalMember(owner = "client!bca", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 51)
