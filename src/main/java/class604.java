...
public class class604 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(ZI)Lfk;", line = 21)
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(I)Lmp;", line = 33)
    ...
    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "(II)V", line = 50)
