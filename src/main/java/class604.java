...
public class class604 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(I)Lqr;", line = 3)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Lps;I)V", line = 23)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(BLps;I)V", line = 59)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(II)[[[B", line = 98)
