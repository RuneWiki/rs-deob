...
public class class604 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ZLdi;)Z")
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(II)Liba;")
    ...
    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "(Lre;ILdn;)V")
