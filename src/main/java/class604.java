...
public class class604 extends Callback {
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(ZZLjava/awt/Component;)V", line = 4)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(III)V", line = 47)
    ...
    @OriginalMember(owner = "client!kfa", name = "callback", descriptor = "(IIII)I", line = 65)
