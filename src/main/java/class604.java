...
public class class604 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IIB)Z", line = 116)
    ...
    @OriginalMember(owner = "client!wa", name = "b", descriptor = "(B)V", line = 127)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IIIIII)V", line = 138)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(JI[B)V", line = 240)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "([BII)V", line = 327)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(I)V", line = 381)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Z)Ljava/lang/String;", line = 441)
