...
public class class604 extends class671 implements class212 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(Z)V", line = 6)
    public final void method1398(boolean arg0) {
        super.method1398(arg0);
        ++field8633;
    }

    @OriginalMember(owner = "client!sw", name = "c", descriptor = "(Z)I", line = 15)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(Ljava/io/File;Ljava/lang/String;I)V", line = 32)
    ...
    @OriginalMember(owner = "client!sw", name = "c", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!sw", name = "b", descriptor = "(Z)Z", line = 64)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;", line = 76)
    ...
    @OriginalMember(owner = "client!sw", name = "<init>", descriptor = "(Lsb;Lkf;Z)V", line = 87)
    public class604(class93 arg0, class720 arg1, boolean arg2) {
        super(arg0, 34963, arg2);
        this.field8634 = arg1;
    }

    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(IZ)V", line = 96)
    public final void method1399(int arg0, boolean arg1) {
        super.method1399(this.field8634.field10158 * arg0, arg1);
        ++field8632;
    }

    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(I)Lkf;", line = 106)
    ...
    @OriginalMember(owner = "client!sw", name = "c", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(IIIIIII)V", line = 158)
