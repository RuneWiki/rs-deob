...
public class class604 implements class107 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILso;B)V")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Ldm;III)V")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IIILol;)V")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Ldm;IIIB)V")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IZLol;)V")
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(Lkw;)V")
