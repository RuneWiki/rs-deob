...
public class class604 extends class525 implements class559 {
    ...
    @OriginalMember(owner = "client!lia", name = "b", descriptor = "(Lha;B)Lufa;")
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(ZLha;)V")
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(Lha;I)Lie;")
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(IIBLha;)Z")
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(ZILmb;Lha;III)V")
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!lia", name = "<init>", descriptor = "(Lha;Lqg;IIIIIZIII)V")
