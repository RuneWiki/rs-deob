...
public class class604 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Lll;I)I", line = 57)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(BLdga;I)V", line = 83)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "([ILpq;ILpq;)V", line = 137)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Ldga;B)V", line = 156)
