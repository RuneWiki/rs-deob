...
public class class604 extends class384 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IIIIIII)V", line = 35)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(II)Ljava/lang/String;", line = 78)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lln;)V", line = 91)
    public class604(class377 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(II)I", line = 99)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IFFBFFFF)F", line = 114)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ZB)V", line = 181)
    ...
    @OriginalMember(owner = "client!iq", name = "c", descriptor = "(I)Z", line = 193)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(B)V", line = 206)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lke;BI)V", line = 232)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Z)V", line = 245)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IIIIII)V", line = 267)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IIZ)V", line = 368)
