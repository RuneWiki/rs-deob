...
public class class604 extends class62 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lgw;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IIIIIIIII)V", line = 60)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IIZIILkda;)V", line = 102)
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "()V", line = 214)
    public class604() {
        super(0, true);
    }

    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(B)V", line = 129)
    ...
    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(B)I", line = 141)
    ...
    @OriginalMember(owner = "client!dd", name = "c", descriptor = "(II)[I", line = 153)
