...
public abstract class class604 extends class202 {
    ...
    @OriginalMember(owner = "client!laa", name = "b", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(B[Lta;)I", line = 45)
    ...
    @OriginalMember(owner = "client!laa", name = "e", descriptor = "(B)V", line = 212)
    ...
    @OriginalMember(owner = "client!laa", name = "f", descriptor = "(B)V", line = 222)
    ...
    @OriginalMember(owner = "client!laa", name = "<init>", descriptor = "(IIIIIIIIIZB)V", line = 250)
    ...
    @OriginalMember(owner = "client!laa", name = "b", descriptor = "(Lha;B)Z", line = 268)
