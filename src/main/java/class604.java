...
public class class604 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(II)Lpo;")
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(IILds;)V")
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(BLjha;IIB)V")
