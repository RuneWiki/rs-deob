...
public abstract class class604 implements class575 {
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(FFFFFFLaa;II)V")
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(FFFFIILaa;II)V")
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(FFIILaa;II)V")
