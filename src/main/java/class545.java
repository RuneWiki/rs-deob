...
public class class545 extends class168 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IIB)Z", line = 5)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(II)V", line = 52)
