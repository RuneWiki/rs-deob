...
public class class545 extends class713 implements class523 {
    ...
    @OriginalMember(owner = "client!dca", name = "b", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(ZILha;Lov;IIZ)V")
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(IILha;I)Z")
    ...
    @OriginalMember(owner = "client!dca", name = "b", descriptor = "(ILha;)Lgh;")
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(Lha;I)Lkn;")
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!dca", name = "<init>", descriptor = "(Lha;Ljl;IIIIIZII)V")
