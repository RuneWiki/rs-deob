...
public class class545 implements class205 {
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Z)Lww;", line = 4)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(IIIIIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(IIIZBII)V", line = 90)
    ...
    @OriginalMember(owner = "client!cv", name = "b", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!cv", name = "<init>", descriptor = "(Lrg;Lal;IIIIIII)V", line = 131)
