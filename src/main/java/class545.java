...
public abstract class class545 {
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(IIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(IIIII)V", line = 187)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(Ljc;I)V", line = 252)
    ...
    @OriginalMember(owner = "client!sha", name = "c", descriptor = "(I)V", line = 303)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(BLla;IIJZI)V", line = 315)
    ...
    @OriginalMember(owner = "client!sha", name = "d", descriptor = "(I)V", line = 325)
    ...
    @OriginalMember(owner = "client!sha", name = "e", descriptor = "(I)V", line = 335)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(Z)V", line = 345)
    ...
    @OriginalMember(owner = "client!sha", name = "f", descriptor = "(I)V", line = 356)
    ...
    @OriginalMember(owner = "client!sha", name = "<init>", descriptor = "(Lch;)V", line = 367)
    public class545(class38 arg0) {
        this.field7920 = arg0;
    }

    @OriginalMember(owner = "client!sha", name = "b", descriptor = "(IIIIIII)V", line = 378)
    ...
    @OriginalMember(owner = "client!sha", name = "g", descriptor = "(I)V", line = 430)
    public void method1739(int arg0) {
        field7917++;
        int var2 = -104 % ((arg0 - 85) / 33);
    }

    @OriginalMember(owner = "client!sha", name = "h", descriptor = "(I)V", line = 447)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(IIIIZ)V", line = 464)
