...
public class class545 implements class432 {
    ...
    @OriginalMember(owner = "client!hha", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(IC)B", line = 17)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(Z)I", line = 142)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(I)Lkt;", line = 157)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(IIIZIIB)V", line = 169)
    ...
    @OriginalMember(owner = "client!hha", name = "<init>", descriptor = "(Luq;Ljava/lang/String;)V", line = 207)
