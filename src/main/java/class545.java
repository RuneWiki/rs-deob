...
public class class545 {
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(IILjb;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "([BIB)[B", line = 24)
    ...
    @OriginalMember(owner = "client!kga", name = "<init>", descriptor = "(I)V", line = 79)
    public class545(int arg0) {
        this.field7596 = arg0;
    }

    @OriginalMember(owner = "client!kga", name = "<init>", descriptor = "(IIIIII)V", line = 86)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(BLkga;)V", line = 50)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(B)Lkga;", line = 70)
