...
public class class545 extends class126 {
    ...
    @OriginalMember(owner = "client!rj", name = "f", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ILpea;Lpea;)V", line = 16)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(BIII)[B", line = 37)
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "()V", line = 50)
    public class545() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IZB)V", line = 58)
