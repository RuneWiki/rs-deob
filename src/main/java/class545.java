...
public class class545 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(ZLjava/lang/String;IB)V", line = 31)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(B)V", line = 154)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(II)V", line = 171)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IIIZ)V", line = 219)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(BLek;)V", line = 232)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lrba;B)V", line = 259)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(III)Z", line = 277)
    ...
    @OriginalMember(owner = "client!nd", name = "b", descriptor = "(I)I", line = 288)
    ...
    @OriginalMember(owner = "client!nd", name = "b", descriptor = "(BLek;)Ljava/lang/Object;", line = 300)
    ...
    @OriginalMember(owner = "client!nd", name = "c", descriptor = "(I)I", line = 353)
    public final int method3054(int arg0) {
        field7201++;
        return arg0 == 2 ? this.field7198 : 7;
    }

    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IILjava/lang/Object;Lek;)V", line = 369)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(BLjava/lang/Object;Lek;)V", line = 398)
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "(I)V", line = 416)
