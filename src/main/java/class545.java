...
public abstract class class545 {
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "([Ljava/awt/Rectangle;IB)V", line = 26)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIIBI)V", line = 45)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIIB)V", line = 76)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ZI)[B", line = 86)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "([IIIIII)Lcw;", line = 142)
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(IIIIBI)V", line = 155)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIII)V", line = 188)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lcw;I)V", line = 214)
    ...
    @OriginalMember(owner = "client!ha", name = "g", descriptor = "(I)V", line = 227)
    public final void method3262(int arg0) throws class425 {
        field7693++;
        this.method632(arg0, 0);
    }

    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIBIII)V", line = 259)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IBIII)V", line = 269)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IILjava/awt/Canvas;Ld;IIILwu;)Lha;", line = 296)
    ...
    @OriginalMember(owner = "client!ha", name = "k", descriptor = "(I)V", line = 355)
    ...
    @OriginalMember(owner = "client!ha", name = "<init>", descriptor = "(Ld;)V", line = 369)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(III)I", line = 403)
    ...
    @OriginalMember(owner = "client!ha", name = "finalize", descriptor = "()V", line = 427)
