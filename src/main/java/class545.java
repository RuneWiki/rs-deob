...
public class class545 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(BI)Lgca;", line = 18)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(III)V", line = 53)
    ...
    @OriginalMember(owner = "client!tp", name = "b", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!tp", name = "c", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!tp", name = "b", descriptor = "(BI)V", line = 99)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ID)V", line = 117)
    ...
    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(Lvd;ILpe;Lpe;)V", line = 162)
