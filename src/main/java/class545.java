...
public class class545 extends class472 implements class544 {
    ...
    @OriginalMember(owner = "client!qt", name = "b", descriptor = "(B)J", line = 3)
    ...
    @OriginalMember(owner = "client!qt", name = "<init>", descriptor = "(Lte;ILjaclib/memory/Buffer;IZ)V", line = 14)
    public class545(class527 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field8144 = arg1;
    }

    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(IIIIIZZ)V", line = 28)
    ...
    @OriginalMember(owner = "client!qt", name = "c", descriptor = "(B)I", line = 85)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(BII)Lvba;", line = 96)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(B)I", line = 118)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "([BBII)V", line = 132)
    ...
    @OriginalMember(owner = "client!qt", name = "b", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!qt", name = "e", descriptor = "(B)V", line = 159)
    ...
    @OriginalMember(owner = "client!qt", name = "<init>", descriptor = "(Lte;I[BIZ)V", line = 171)
