...
public class class545 implements Runnable {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(I[BLjava/io/File;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Ljava/lang/String;IBLjava/lang/String;)Lwr;", line = 37)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ZZLjava/lang/String;)Loc;", line = 79)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Ljava/net/URL;B)Loc;", line = 95)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(ILjava/lang/String;IZ)V", line = 684)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "([ILjava/awt/Point;ILjava/awt/Component;BI)Loc;", line = 110)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(B)Loc;", line = 120)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Z)Z", line = 131)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;I[Ljava/lang/Class;)Loc;", line = 156)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ILjava/lang/String;)Loc;", line = 166)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(BIIII)Loc;", line = 176)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IB)Loc;", line = 190)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Ljava/lang/String;ZLjava/lang/Class;)Loc;", line = 200)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IZILjava/lang/String;)Loc;", line = 217)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(I)V", line = 232)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ILjava/lang/Object;BII)Loc;", line = 292)
    ...
    @OriginalMember(owner = "client!tq", name = "run", descriptor = "()V", line = 326)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ZLjava/awt/Frame;)Loc;", line = 612)
    public final class175 method3174(boolean arg0, Frame arg1) {
        return arg0 ? null : this.method3173(0, arg1, (byte) -74, 7, 0);
    }

    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(B)Ljava/lang/Object;", line = 624)
    ...
    @OriginalMember(owner = "client!tq", name = "c", descriptor = "(B)V", line = 634)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IILjava/lang/Runnable;)Loc;", line = 666)
