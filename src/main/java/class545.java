...
public class class545 extends class392 {
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(Lw;)V")
    public class545(class675 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ti", name = "a", descriptor = "([[BLqv;I)V")
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(ILw;)V")
