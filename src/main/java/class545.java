...
public class class545 {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(BLw;Lmga;)Lkf;", line = 14)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(III)Z", line = 61)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(JB)I", line = 76)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(IJ)I", line = 89)
