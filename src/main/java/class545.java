...
public class class545 {
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(III)Ljp;", line = 13)
    ...
    @OriginalMember(owner = "client!tca", name = "toString", descriptor = "()Ljava/lang/String;", line = 21)
    public final String toString() {
        field8043++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!tca", name = "b", descriptor = "(III)I", line = 32)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(ZLjava/lang/String;IBLjava/lang/String;)V", line = 55)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(I)V", line = 71)
    public static void method3195(int arg0) {
        field8041 = null;
        int var1 = 57 % ((-arg0 - 24) / 63);
    }

    @OriginalMember(owner = "client!tca", name = "b", descriptor = "(I)V", line = 83)
