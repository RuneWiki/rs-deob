...
public class class545 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(BLgi;ZILgi;IZ)I", line = 30)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(ILjo;)V", line = 62)
    ...
    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 74)
