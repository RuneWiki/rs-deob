...
public class class545 {
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(Leba;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(B)Leba;", line = 22)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(I)Z", line = 35)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(BLr;II)V", line = 74)
    ...
    @OriginalMember(owner = "client!eba", name = "b", descriptor = "(B)V", line = 564)
    ...
    @OriginalMember(owner = "client!eba", name = "<init>", descriptor = "(I)V", line = 589)
    public class545(int arg0) {
        this.field7936 = arg0;
    }

    @OriginalMember(owner = "client!eba", name = "<init>", descriptor = "(IIIIII)V", line = 596)
