...
public class class545 extends class468 {
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(I)Lhba;", line = 6)
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "(Lnh;IIIIII)V", line = 85)
