...
public class class545 implements class90 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(IIIIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!ia", name = "c", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(B)Z", line = 708)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(BZ)V", line = 728)
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(Lpu;Lpu;Lpr;)V", line = 752)
