...
public class class545 extends class42 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(BC)Z", line = 8)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "()V", line = 17)
    public class545() {
    }

    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(S)V", line = 32)
    public class545(short arg0) {
        this.field7989 = arg0;
    }

    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(I)V", line = 45)
