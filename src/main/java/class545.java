...
public class class545 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(II)Ldm;")
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(II)Leg;")
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(Lcw;ILeq;)V")
