...
public class class359 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(III)Lqh;", line = 4)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ZLmv;Lmv;BI)I", line = 25)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(I[B)[B", line = 127)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IBII)V", line = 185)
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 218)
