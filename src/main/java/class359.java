...
public class class359 extends class623 {
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(ILet;)Z", line = 19)
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!jo", name = "c", descriptor = "(I)[Lo;", line = 61)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Let;I)Z", line = 73)
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 100)
