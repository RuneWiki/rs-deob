...
public class class359 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(JI)V", line = 3)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(JI)Ljava/lang/String;", line = 88)
