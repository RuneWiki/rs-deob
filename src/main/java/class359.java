...
public abstract class class359 {
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(Lbr;III)V", line = 11)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IILjava/lang/String;)V", line = 56)
