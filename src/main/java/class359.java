...
public class class359 implements Runnable {
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "([BILht;I)Lmk;")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IILht;)Lmk;")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lmk;I)V")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lht;II)Lmk;")
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "(Lhu;)V")
