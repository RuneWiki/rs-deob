...
public class class359 {
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IIIII)Lmk;", line = 8)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(I)Z", line = 56)
    ...
    @OriginalMember(owner = "client!qs", name = "b", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(CI)Z", line = 89)
