...
public class class359 extends class654 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(ILha;)Lrk;", line = 30)
    ...
    @OriginalMember(owner = "client!kf", name = "h", descriptor = "(B)Z", line = 162)
    ...
    @OriginalMember(owner = "client!kf", name = "c", descriptor = "(Lha;I)Ltja;", line = 174)
    ...
    @OriginalMember(owner = "client!kf", name = "n", descriptor = "(I)Z", line = 187)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(Z)V", line = 203)
    ...
    @OriginalMember(owner = "client!kf", name = "k", descriptor = "(I)I", line = 228)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(III)Z", line = 251)
    ...
    @OriginalMember(owner = "client!kf", name = "m", descriptor = "(I)I", line = 261)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(Lha;I)V", line = 283)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(ILem;)V", line = 317)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(ILha;II)Z", line = 337)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(IIZIZI)V", line = 398)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Loq;IZILha;II)V", line = 482)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(BII)V", line = 494)
    ...
    @OriginalMember(owner = "client!kf", name = "d", descriptor = "(Z)Z", line = 595)
    ...
    @OriginalMember(owner = "client!kf", name = "c", descriptor = "(B)I", line = 609)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(IILha;)Z", line = 629)
    ...
    @OriginalMember(owner = "client!kf", name = "e", descriptor = "(B)V", line = 696)
