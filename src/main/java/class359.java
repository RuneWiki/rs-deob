...
public class class359 extends class5 {
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "(Lic;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "(Lic;II)V")
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "(Lic;IIZ[[BI)V")
