...
public class class359 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Lkq;IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(B)Z", line = 91)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ZI)V", line = 365)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(I)V", line = 394)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Z)Z", line = 422)
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(I)I", line = 443)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ZIIZB)Ldv;", line = 454)
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(Z)V", line = 496)
    ...
    @OriginalMember(owner = "client!dn", name = "c", descriptor = "(I)V", line = 510)
    ...
    @OriginalMember(owner = "client!dn", name = "d", descriptor = "(I)V", line = 546)
    ...
    @OriginalMember(owner = "client!dn", name = "c", descriptor = "(B)V", line = 567)
    ...
    @OriginalMember(owner = "client!dn", name = "e", descriptor = "(I)I", line = 581)
    ...
    @OriginalMember(owner = "client!dn", name = "d", descriptor = "(B)Z", line = 592)
