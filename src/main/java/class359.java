...
public class class359 extends class371 implements class223 {
    ...
    @OriginalMember(owner = "client!md", name = "c", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(Lea;Lp;IIIIZIIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ZLea;II)Lto;", line = 43)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IIILal;Lal;)V", line = 73)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ILrg;)V", line = 85)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Lea;BI)Lts;", line = 125)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ILea;)V", line = 136)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ZILea;I)Z", line = 165)
    ...
    @OriginalMember(owner = "client!md", name = "c", descriptor = "(I)I", line = 190)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(ILea;)Lms;", line = 206)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(I)V", line = 232)
    ...
    @OriginalMember(owner = "client!md", name = "d", descriptor = "(B)V", line = 246)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(Z)I", line = 360)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(BLea;)V", line = 372)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(I)I", line = 400)
    public final int method709(int arg0) {
        ++field4969;
        return arg0 != 30030 ? -65 : this.field4960;
    }

    @OriginalMember(owner = "client!md", name = "a", descriptor = "(BILea;)Lts;", line = 414)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IB)V", line = 435)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Lea;I)V", line = 465)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Z)Z", line = 476)
    ...
    @OriginalMember(owner = "client!md", name = "c", descriptor = "(B)I", line = 487)
