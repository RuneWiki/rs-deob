...
public class class359 extends class151 implements class52 {
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "()V", line = 20)
    public class359() {
        this.method2212();
    }

    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(III[I)V", line = 26)
    public final void method892(int arg0, int arg1, int arg2, int[] arg3) {
        this.method2213(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!ra", name = "a", descriptor = "()Lq;", line = 35)
