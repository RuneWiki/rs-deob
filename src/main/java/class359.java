...
public class class359 implements class34 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIII)I", line = 4)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(Lpe;Lhh;IIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIILbd;II)Ljava/awt/Frame;", line = 104)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(B)V", line = 180)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(I)J", line = 196)
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(B)V", line = 228)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(Lpc;B)Z", line = 508)
