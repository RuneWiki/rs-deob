...
public class class359 extends class483 implements class691 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IIIIII[BLsk;I)V", line = 14)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ZBZ)V", line = 55)
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 66)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ILng;)V", line = 76)
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(Z)V", line = 86)
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(Lhb;IIZ[III)V", line = 95)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(FB)F", line = 154)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(III[IIBII)V", line = 164)
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(Lhb;Lsk;Lvea;II)V", line = 204)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(B)I", line = 225)
    public final int method842(byte arg0) {
        int var2 = 124 % ((-arg0 - 47) / 60);
        return this.field4769;
    }

    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(Lhb;Lsk;IIZ[BII)V", line = 232)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(I)Z", line = 291)
    public final boolean method849(int arg0) {
        return arg0 <= -23;
    }

    @OriginalMember(owner = "client!om", name = "a", descriptor = "(BF)F", line = 302)
