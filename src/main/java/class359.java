...
public class class359 implements class278 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(ILza;)V")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(ZLbg;)Z")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lza;B)V")
