...
public class class359 extends class366 {
    ...
    @OriginalMember(owner = "client!re", name = "c", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "(Lwn;)V", line = 18)
    public class359(class431 arg0) {
        this.field5180 = arg0;
    }

    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIIIIII)Lro;", line = 30)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(II)Z", line = 49)
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(I)Lso;", line = 77)
