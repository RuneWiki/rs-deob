...
public abstract class class359 {
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(I[I[ZIBILpi;ZILsm;ZLsm;)V")
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IBLtn;)V")
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Ltn;ZIIILtn;III)V")
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Ltn;ZLtn;Ltn;IZII[ZIIIIILtn;)V")
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "([ILtn;IIIIIZLtn;II)V")
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IBIIILd;III)V")
