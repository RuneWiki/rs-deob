...
public class class359 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(ILjia;)V", line = 7)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(B)Lwk;", line = 23)
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(I)Lwk;", line = 62)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Lfl;B)V", line = 82)
    ...
    @OriginalMember(owner = "client!jg", name = "<init>", descriptor = "()V", line = 103)
    public class359() {
    }

    @OriginalMember(owner = "client!jg", name = "<init>", descriptor = "(Ljia;)V", line = 105)
