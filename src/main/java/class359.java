...
public class class359 implements Runnable {
    ...
    @OriginalMember(owner = "client!as", name = "finalize", descriptor = "()V", line = 6)
    protected final void finalize() {
        this.method2360((byte) -32);
        field5308++;
    }

    @OriginalMember(owner = "client!as", name = "run", descriptor = "()V", line = 15)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(III)V", line = 86)
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(Ljava/net/Socket;Lde;)V", line = 364)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Z)I", line = 120)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(B)V", line = 137)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(I)V", line = 174)
    ...
    @OriginalMember(owner = "client!as", name = "b", descriptor = "(I)I", line = 200)
    ...
    @OriginalMember(owner = "client!as", name = "c", descriptor = "(I)V", line = 214)
    ...
    @OriginalMember(owner = "client!as", name = "d", descriptor = "(I)V", line = 232)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "([BIII)V", line = 252)
    ...
    @OriginalMember(owner = "client!as", name = "b", descriptor = "([BIII)V", line = 313)
    ...
    @OriginalMember(owner = "client!as", name = "e", descriptor = "(I)V", line = 339)
