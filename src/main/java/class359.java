...
public abstract class class359 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(ILm;ILjava/awt/Canvas;)Lqa;")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(ILsq;I)Llg;")
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(Lod;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(Lod;ILjaggl/memory/NativeBuffer;IZ)V")
