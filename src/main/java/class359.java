...
public class class359 extends class351 {
    ...
    @OriginalMember(owner = "client!re", name = "c", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(Ltq;Ltq;I)V", line = 32)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(III)Z", line = 45)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(B)I", line = 68)
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(B)I", line = 80)
    ...
    @OriginalMember(owner = "client!re", name = "c", descriptor = "(B)I", line = 102)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(I)Ler;", line = 126)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIB)Lia;", line = 222)
    ...
    @OriginalMember(owner = "client!re", name = "d", descriptor = "(B)V", line = 437)
    ...
    @OriginalMember(owner = "client!re", name = "d", descriptor = "(I)V", line = 624)
    ...
    @OriginalMember(owner = "client!re", name = "e", descriptor = "(I)V", line = 643)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(ILtq;)V", line = 689)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IB)I", line = 713)
    ...
    @OriginalMember(owner = "client!re", name = "f", descriptor = "(I)V", line = 733)
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(IB)V", line = 743)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(ILdn;)Ljava/lang/String;", line = 772)
    ...
    @OriginalMember(owner = "client!re", name = "e", descriptor = "(B)I", line = 787)
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "(ILgb;Lgb;Lqs;Lnh;IIZ)V", line = 866)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(BI)[B", line = 818)
    ...
    @OriginalMember(owner = "client!re", name = "g", descriptor = "(I)V", line = 848)
