...
public class class359 extends class14 {
    ...
    @OriginalMember(owner = "client!cb", name = "d", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IB)[I", line = 18)
    ...
    @OriginalMember(owner = "client!cb", name = "e", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IIIIIII)V", line = 223)
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "()V", line = 276)
    public class359() {
        super(1, true);
    }

    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IBLmd;)V", line = 279)
