...
public class class359 extends class207 {
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lrd;)V")
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(ILrd;)V")
    public class359(int arg0, class355 arg1) {
        super(arg1);
    }

    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(III)Leq;")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lnga;Z)Z")
