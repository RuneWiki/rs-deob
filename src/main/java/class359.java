...
public class class359 extends class374 implements class457 {
    ...
    @OriginalMember(owner = "client!du", name = "<init>", descriptor = "(Lha;Lac;IIIIIZIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!du", name = "b", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!du", name = "b", descriptor = "(I)Z", line = 24)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(I)I", line = 37)
    public final int method743(int arg0) {
        ++field4633;
        return arg0 != -30968 ? -113 : this.field4647.field3819;
    }

    @OriginalMember(owner = "client!du", name = "a", descriptor = "(IILrba;Lha;ZII)V", line = 48)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(B)I", line = 60)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Z)I", line = 70)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Lha;I)V", line = 83)
    ...
    @OriginalMember(owner = "client!du", name = "b", descriptor = "(Lha;I)Ljk;", line = 108)
    ...
    @OriginalMember(owner = "client!du", name = "f", descriptor = "(I)Z", line = 159)
    ...
    @OriginalMember(owner = "client!du", name = "f", descriptor = "(B)V", line = 172)
    ...
    @OriginalMember(owner = "client!du", name = "g", descriptor = "(B)Z", line = 183)
    public final boolean method83(byte arg0) {
        ++field4651;
        return arg0 != -69;
    }

    @OriginalMember(owner = "client!du", name = "a", descriptor = "(I[BII)[B", line = 199)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(BILha;I)Z", line = 210)
    ...
    @OriginalMember(owner = "client!du", name = "d", descriptor = "(ILha;)Lwg;", line = 230)
    public final class428 method750(int arg0, class60 arg1) {
        ++field4645;
        return arg0 >= -22 ? null : this.field4639;
    }

    @OriginalMember(owner = "client!du", name = "e", descriptor = "(I)Z", line = 243)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(ILha;)V", line = 255)
    ...
    @OriginalMember(owner = "client!du", name = "h", descriptor = "(I)I", line = 265)
    ...
    @OriginalMember(owner = "client!du", name = "b", descriptor = "(ILha;)V", line = 282)
    ...
    @OriginalMember(owner = "client!du", name = "d", descriptor = "(B)I", line = 293)
    ...
    @OriginalMember(owner = "client!du", name = "i", descriptor = "(B)V", line = 312)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(ZLtd;)V", line = 323)
