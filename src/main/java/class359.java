...
public class class359 extends class157 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!rc", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 3)
    public final void startProduction(ImageConsumer arg0) {
        this.addConsumer(arg0);
        ++field5334;
    }

    @OriginalMember(owner = "client!rc", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 11)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field5318;
        return this.field5322 == arg0;
    }

    @OriginalMember(owner = "client!rc", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 20)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Ljava/awt/Graphics;BII)V", line = 32)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IIIII)V", line = 43)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Ljava/awt/Graphics;IBIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "([FFFIIIIIIIIFZ)V", line = 74)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IILmd;)V", line = 167)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Ljava/awt/Canvas;B)V", line = 355)
    ...
    @OriginalMember(owner = "client!rc", name = "d", descriptor = "(I)V", line = 378)
    ...
    @OriginalMember(owner = "client!rc", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 396)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field5316;
    }

    @OriginalMember(owner = "client!rc", name = "d", descriptor = "(B)V", line = 403)
    ...
    @OriginalMember(owner = "client!rc", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 427)
