...
public class class359 {
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(IILd;Ljava/awt/Canvas;I)Lha;", line = 4)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(BLjava/lang/String;)V", line = 24)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(B)V", line = 55)
