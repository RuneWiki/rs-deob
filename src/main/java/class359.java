...
public class class359 extends class667 {
    ...
    @OriginalMember(owner = "client!vh", name = "b", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(BI)[I", line = 16)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IILrca;)Z", line = 50)
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "()V", line = 385)
    public class359() {
        super(1, false);
    }

    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IZB)Lvw;", line = 220)
    ...
    @OriginalMember(owner = "client!vh", name = "d", descriptor = "(Z)V", line = 259)
    ...
    @OriginalMember(owner = "client!vh", name = "b", descriptor = "(IBI)Z", line = 273)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(Lud;II)V", line = 286)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(ZI)[[I", line = 338)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(I[Ldm;I)V", line = 393)
