...
public class class359 {
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ILha;Lwu;)V")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Lwu;I)V")
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(Lep;I)V")
