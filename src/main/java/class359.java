...
public class class359 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(I)Ldba;")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(B)Ldba;")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Ltm;I)V")
    ...
    @OriginalMember(owner = "client!jg", name = "<init>", descriptor = "(Ltm;)V")
