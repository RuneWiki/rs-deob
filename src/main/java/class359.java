...
public class class359 extends class731 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(III)Z", line = 18)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(BF)V", line = 34)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(IIIIIF)V", line = 51)
