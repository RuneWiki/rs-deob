...
public class class359 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(Lya;Lkn;ILql;)V", line = 16)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(B[IIII)V", line = 164)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IIIIIIII)V", line = 198)
    ...
    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(I)V", line = 241)
