...
public class class359 {
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(IILtea;IIIIIIII)Z", line = 20)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(IBI)V", line = 376)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Lrg;BI)V", line = 395)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Lkb;I)V", line = 427)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(ILrg;)V", line = 446)
