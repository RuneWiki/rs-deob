...
public class class359 extends class372 implements class154 {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Z)Lbv;", line = 17)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;", line = 28)
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(Ldda;Lbv;Z)V", line = 40)
    public class359(class349 arg0, class279 arg1, boolean arg2) {
        super(arg0, 34963, arg2);
        this.field4779 = arg1;
    }

    @OriginalMember(owner = "client!lp", name = "e", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "([IIIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(II)V", line = 91)
    public final void method13(int arg0, int arg1) {
        ++field4777;
        super.method13(this.field4779.field3788 * arg0, arg1);
    }

    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(B)V", line = 101)
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(I)I", line = 118)
