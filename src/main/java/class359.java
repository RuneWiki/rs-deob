...
public class class359 extends class665 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "([I)Lmm;")
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Lpu;I)Lwj;")
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Lpu;II)Lwj;")
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Lpu;)Z")
