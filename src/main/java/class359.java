...
public class class359 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Lwn;)V")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Lwn;Z)V")
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(Lwn;)Z")
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "(Lqi;)V")
