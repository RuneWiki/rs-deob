...
public class class359 extends class337 {
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!wha", name = "b", descriptor = "(I)Lfi;", line = 26)
    ...
    @OriginalMember(owner = "client!wha", name = "<init>", descriptor = "(I[B)V", line = 43)
