...
public class class359 extends class478 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(BLka;Lqa;)V", line = 5)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(ILqa;)Lnj;", line = 28)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IIILqa;ZLee;Z)V", line = 64)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(B)V", line = 75)
    public static void method2225(byte arg0) {
        int var1 = -76 / ((43 - arg0) / 47);
        field5225 = null;
    }

    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Z)V", line = 85)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IB)Z", line = 111)
    ...
    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 122)
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(Z)I", line = 152)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IIILqa;)Z", line = 170)
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(Lqa;B)Lem;", line = 182)
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(II)V", line = 201)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(B[Ljava/lang/Object;[I)V", line = 234)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Lqa;B)V", line = 250)
    ...
    @OriginalMember(owner = "client!mq", name = "finalize", descriptor = "()V", line = 271)
    ...
    @OriginalMember(owner = "client!mq", name = "d", descriptor = "(I)Z", line = 282)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(ILqa;IB)Lka;", line = 293)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Lia;III[Z)Z", line = 317)
