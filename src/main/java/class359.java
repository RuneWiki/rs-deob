...
public class class359 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ZI)V", line = 19)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(BI)Leu;", line = 34)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(BLks;)V", line = 67)
    ...
    @OriginalMember(owner = "client!ij", name = "b", descriptor = "(B)V", line = 93)
    ...
    @OriginalMember(owner = "client!ij", name = "c", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "(Lbt;ILkda;)V", line = 130)
