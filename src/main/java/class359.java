...
public class class359 extends class124 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "()Lc;", line = 7)
    ...
    @OriginalMember(owner = "client!cn", name = "ca", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!cn", name = "A", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(III[I)V", line = 38)
    ...
    @OriginalMember(owner = "client!cn", name = "wa", descriptor = "([I)V", line = 45)
    ...
    @OriginalMember(owner = "client!cn", name = "U", descriptor = "(III)V", line = 56)
    ...
    @OriginalMember(owner = "client!cn", name = "W", descriptor = "(III)V", line = 67)
    ...
    @OriginalMember(owner = "client!cn", name = "EA", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!cn", name = "g", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!cn", name = "K", descriptor = "(III[I)V", line = 101)
    ...
    @OriginalMember(owner = "client!cn", name = "ea", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!cn", name = "ha", descriptor = "(Lc;)V", line = 129)
    ...
    @OriginalMember(owner = "client!cn", name = "v", descriptor = "()V", line = 144)
    ...
    @OriginalMember(owner = "client!cn", name = "YA", descriptor = "(IIIIII)V", line = 153)
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "()V", line = 183)
    public class359() {
        this.method741();
    }
}
