...
public class class276 extends class157 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IBI)Z", line = 6)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!je", name = "e", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(Z)[B", line = 56)
