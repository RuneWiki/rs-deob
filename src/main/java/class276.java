...
public class class276 {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IIB)V", line = 6)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(II)I", line = 22)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IIIIII)V", line = 60)
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(I)Z", line = 109)
    ...
    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "(II)V", line = 130)
    public class276(int arg0, int arg1) {
        this.field3715 = arg0;
        this.field3710 = arg1;
    }

    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "(Lae;I)V", line = 138)
