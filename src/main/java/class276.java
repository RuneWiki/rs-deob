...
public class class276 implements Runnable {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(BLvn;)V")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ILap;[BI)Lvn;")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(BLap;I)Lvn;")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Lap;II)Lvn;")
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lhf;)V")
