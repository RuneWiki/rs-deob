...
public abstract class class276 extends class330 {
    ...
    @OriginalMember(owner = "client!ka", name = "c", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IBIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!ka", name = "<init>", descriptor = "(IIIZZ)V", line = 59)
