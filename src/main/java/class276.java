...
public class class276 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(III[I)Luq;")
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "([IIB)Luq;")
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(Lqa;)V")
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "([III)Luq;")
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(B[III)Luq;")
    ...
    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "(Lns;Lns;)V")
