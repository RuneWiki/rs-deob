...
public class class276 extends class296 {
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(IB[B)I", line = 3)
    public static final int method1694(int arg0, byte arg1, byte[] arg2) {
        ++field3946;
        return arg1 != 19 ? -53 : class134.method805(0, arg0, (byte) 95, arg2);
    }

    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(Leq;Z)Lgl;", line = 48)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ILeq;BI)Z", line = 91)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Leq;I)V", line = 128)
