...
public class class276 implements class577 {
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(BILlaa;)V")
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(ILwh;B)V")
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IILqn;II)V")
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(ZIILwh;)V")
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lqn;IIB)V")
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "(Ler;)V")
