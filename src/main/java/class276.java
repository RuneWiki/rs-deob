...
public abstract class class276 extends class29 {
    ...
    @OriginalMember(owner = "client!ek", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ek", name = "c", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "(Lur;I)V", line = 43)
    public class276(class95 arg0, int arg1) {
        this.field4083 = arg0;
        this.field4086 = arg1;
    }

    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IIIII)V", line = 56)
