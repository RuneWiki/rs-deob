...
public class class276 {
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Z)Z", line = 3)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IIII)I", line = 19)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(II)Z", line = 45)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IB[BI)I", line = 84)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IZZ)V", line = 106)
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(I)V", line = 132)
