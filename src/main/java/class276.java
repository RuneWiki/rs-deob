...
public class class276 implements class406 {
    ...
    @OriginalMember(owner = "client!je", name = "d", descriptor = "(I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IZLvg;I)V", line = 49)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(ZI)V", line = 61)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IILsf;)V", line = 76)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(II)V", line = 108)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(B)V", line = 123)
    ...
    @OriginalMember(owner = "client!je", name = "e", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!je", name = "f", descriptor = "(I)I", line = 146)
    ...
    @OriginalMember(owner = "client!je", name = "c", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(BLvg;III)V", line = 175)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IIZLml;)V", line = 207)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(II)V", line = 238)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(B)V", line = 254)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Z)V", line = 267)
    ...
    @OriginalMember(owner = "client!je", name = "c", descriptor = "(II)V", line = 293)
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "(Lef;)V", line = 352)
    ...
    @OriginalMember(owner = "client!je", name = "c", descriptor = "(B)I", line = 321)
    ...
    @OriginalMember(owner = "client!je", name = "finalize", descriptor = "()V", line = 366)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IBLml;)V", line = 376)
