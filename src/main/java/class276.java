...
public class class276 extends class354 {
    ...
    @OriginalMember(owner = "client!wd", name = "q", descriptor = "Lcv;")
    public static class570 field3469;
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(Lwo;)V")
    public class276(class746 arg0) {
        super(arg0);
    }
    ...
    public static final void method1633(int arg0) {
        ...
        class595.field8306 = null;
        class80.field1109 = null;
    }
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(ILwo;)V")
    public class276(int arg0, class746 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(II[I[II)V")
    public static final void method1634(int arg0, int arg1, int[] arg2, int[] arg3, int arg4) {
        if (arg4 != -1) {
            method1634(7, 9, (int[]) null, (int[]) null, -108);
        }
        if (arg1 < arg0) {
            ...
            arg2[arg0] = arg2[var6];
            arg2[var6] = var8;
            method1634(var6 + -1, arg1, arg2, arg3, -1);
            method1634(arg0, var6 + 1, arg2, arg3, -1);
        }
        ++field3460;
    }
    ...
    public final void method388(int arg0) {
        ++field3462;
        if (super.field4544.field10413.method1186((byte) -9) && ~super.field4545 == -3) {
            super.field4545 = 1;
        }
        if (~super.field4545 > -1 || ~super.field4545 < -3) {
            super.field4545 = this.method393((byte) -63);
        }
        if (arg0 != 6384) {
            this.method391(-112, 107);
        }
    }
}
