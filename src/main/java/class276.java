...
public class class276 extends class42 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "()V", line = 46)
    public class276() {
    }

    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 48)
