...
public class class276 {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Z)Z", line = 7)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Lcr;B)I", line = 18)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(I)Z", line = 40)
    ...
    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "(Lifa;)V", line = 316)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(IIILhu;)Lht;", line = 128)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(BLjava/lang/String;IZ)I", line = 228)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(B)V", line = 305)
