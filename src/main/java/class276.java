...
public class class276 {
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lbg;III)V", line = 34)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILbg;I)V", line = 73)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(II)Z", line = 93)
    ...
    @OriginalMember(owner = "client!ul", name = "c", descriptor = "(B)V", line = 124)
    ...
    @OriginalMember(owner = "client!ul", name = "d", descriptor = "(B)V", line = 556)
