...
public class class276 extends class422 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(BLjava/lang/String;Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(II)V", line = 81)
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "()V", line = 99)
    public class276() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IIB)V", line = 102)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(III[B[BIIII)V", line = 119)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(Z)V", line = 165)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IIIB)[B", line = 192)
