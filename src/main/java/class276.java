...
public class class276 extends class502 {
    ...
    @OriginalMember(owner = "client!oba", name = "<init>", descriptor = "(ILeka;)V")
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(Lha;IIIIIII)V")
    ...
    @OriginalMember(owner = "client!oba", name = "<init>", descriptor = "(Leka;)V")
