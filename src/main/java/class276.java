...
public class class276 {
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(BI)[I", line = 3)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!pba", name = "<init>", descriptor = "(III)V", line = 154)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(Z)[[I", line = 101)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!pba", name = "b", descriptor = "(B)V", line = 166)
