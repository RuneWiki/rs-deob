...
public class class276 extends class690 {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(B)Ljd;")
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(ZI)Lsaa;")
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(ZLlh;)Z")
    ...
    @OriginalMember(owner = "client!eo", name = "<init>", descriptor = "(Ltl;Lpd;IIIIIIIIII)V")
