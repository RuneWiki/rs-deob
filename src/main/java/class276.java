...
public class class276 extends class609 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(ILjava/lang/String;)V", line = 6)
    public static final void method1750(int arg0, String arg1) {
        class25.method125(arg0, "", 0, arg1, 0, "", "");
        ++field3921;
    }

    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(IIIIIF)V", line = 16)
    public class276(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!up", name = "f", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IIIZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!up", name = "g", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(FI)V", line = 56)
    ...
    @OriginalMember(owner = "client!up", name = "h", descriptor = "(I)[Lcda;", line = 67)
