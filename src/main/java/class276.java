...
public class class276 implements class386 {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(II)Ldp;")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IBLdr;ZILnr;I)V")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Lnr;I)V")
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(II)Lwh;")
    ...
    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "(Lqj;Lqj;Lqj;)V")
