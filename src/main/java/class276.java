...
public class class276 extends OutputStream {
    ...
    @OriginalMember(owner = "client!no", name = "write", descriptor = "(I)V", line = 30)
    public final void write(int arg0) throws IOException {
        field3996++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Z)V", line = 45)
    ...
    @OriginalMember(owner = "client!no", name = "b", descriptor = "(Z)V", line = 81)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(I)V", line = 100)
