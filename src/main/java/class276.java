...
public class class276 {
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IIIIIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IBII)Z", line = 31)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!oba", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 176)
