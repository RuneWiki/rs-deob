...
public class class276 extends class436 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(ZILrg;)I", line = 25)
    ...
    @OriginalMember(owner = "client!nm", name = "b", descriptor = "(II)[[I", line = 234)
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "()V", line = 396)
    public class276() {
        super(1, false);
    }

    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(ZB)V", line = 307)
    ...
    @OriginalMember(owner = "client!nm", name = "e", descriptor = "(B)V", line = 380)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IILeb;)V", line = 403)
    ...
    @OriginalMember(owner = "client!nm", name = "g", descriptor = "(I)V", line = 447)
