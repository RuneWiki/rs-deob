...
public class class276 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Llr;II)Z")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Ljava/lang/String;Ldq;II)Low;")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(B[Lga;I)V")
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Lnq;)V")
