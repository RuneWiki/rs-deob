...
public class class276 {
    ...
    @OriginalMember(owner = "client!mt", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field4099++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(IIIZI)V", line = 12)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(B)V", line = 32)
    public static void method1738(byte arg0) {
        field4102 = null;
        int var1 = -119 % ((-arg0 - 45) / 58);
    }

    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "(IIII)V", line = 43)
