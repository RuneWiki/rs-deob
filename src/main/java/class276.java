...
public class class276 {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Lnba;B)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Laa;B)V")
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Lnba;ZLjava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(BLjava/lang/Object;Lnba;I)V")
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(Lnba;B)V")
