...
public class class276 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!dn", name = "toString", descriptor = "()Ljava/lang/String;", line = 49)
    public final String toString() {
        field3665++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(I)V", line = 57)
