...
public class class276 extends class434 implements class303 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(BLza;)Lql;")
    ...
    @OriginalMember(owner = "client!up", name = "b", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!up", name = "i", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(ILza;B)Le;")
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Llb;IZIBILza;)V")
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(Lza;Lpm;IIIIIZIIIIIII)V")
    ...
    @OriginalMember(owner = "client!up", name = "c", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IBILza;)Z")
