...
public class class276 extends class677 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(B[I)V", line = 7)
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(ZI)I", line = 23)
    ...
    @OriginalMember(owner = "client!wd", name = "c", descriptor = "(ZI)V", line = 34)
    ...
    @OriginalMember(owner = "client!wd", name = "t", descriptor = "(I)I", line = 49)
    ...
    @OriginalMember(owner = "client!wd", name = "u", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(I[BBI)V", line = 78)
    ...
    @OriginalMember(owner = "client!wd", name = "v", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!wd", name = "f", descriptor = "(Z)V", line = 109)
    ...
    @OriginalMember(owner = "client!wd", name = "w", descriptor = "(I)Z", line = 121)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Llg;I)V", line = 156)
    ...
    @OriginalMember(owner = "client!wd", name = "m", descriptor = "(II)I", line = 172)
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(I)V", line = 206)
