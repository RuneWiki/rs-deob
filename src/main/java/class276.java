...
public class class276 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(II)Lnc;", line = 3)
    ...
    @OriginalMember(owner = "client!vk", name = "b", descriptor = "(II)Lqp;", line = 30)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Z)V", line = 68)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!vk", name = "b", descriptor = "(Z)V", line = 96)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IB)V", line = 127)
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(Llo;ILnl;Lnl;Lnl;)V", line = 150)
