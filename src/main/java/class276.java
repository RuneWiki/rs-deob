...
public class class276 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Lnm;)V", line = 4)
    ...
    @OriginalMember(owner = "client!pb", name = "b", descriptor = "(Lnm;)V", line = 12)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Lnm;I)V", line = 23)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Lnm;Lim;)V", line = 367)
    ...
    @OriginalMember(owner = "client!pb", name = "c", descriptor = "(Lnm;)V", line = 609)
