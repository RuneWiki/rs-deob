...
public class class276 extends class122 {
    ...
    @OriginalMember(owner = "client!oca", name = "b", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(III)V", line = 18)
    ...
    @OriginalMember(owner = "client!oca", name = "<init>", descriptor = "(IIIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(ZII)V", line = 42)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(IIB)V", line = 52)
