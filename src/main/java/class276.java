...
public class class276 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(JI)V", line = 18)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(Llm;IJ)V", line = 40)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IJ)Llm;", line = 72)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "(I)V", line = 133)
