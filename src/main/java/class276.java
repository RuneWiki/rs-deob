...
public class class276 extends class443 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lpb;BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(BII)I", line = 42)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIIIIIIIII)V", line = 67)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(II)V", line = 107)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lrg;)V", line = 123)
