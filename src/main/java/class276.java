...
public abstract class class276 {
    ...
    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IIIIIII)V", line = 38)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(ILea;)V", line = 224)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(ILh;)V", line = 308)
