...
public class class276 extends class452 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(BLhp;)V")
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(BI)Lqu;")
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lhp;II)V")
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(ILhp;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Z[ILhp;)V")
