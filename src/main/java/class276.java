...
public class class276 {
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(III)V", line = 23)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IIIII)Lli;", line = 63)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IB)V", line = 96)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lpe;I)V", line = 121)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "([BI)Z", line = 162)
