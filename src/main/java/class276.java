...
public abstract class class276 extends class11 {
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(IIIILoa;II[[[BIIIBI)V", line = 14)
    ...
    @OriginalMember(owner = "client!w", name = "b", descriptor = "(IIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(ILoa;IIII)V", line = 73)
