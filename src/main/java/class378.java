...
public class class378 extends class205 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Lcd;Lqq;I)V")
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(BLqq;)Lkm;")
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(ILqq;Lps;ZZII)V")
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Lqq;BII)Z")
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(ZLqq;)V")
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IBILqq;)Lcd;")
