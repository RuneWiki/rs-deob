...
public class class378 implements Runnable {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(ILdd;)V", line = 3)
    ...
    @OriginalMember(owner = "client!kn", name = "run", descriptor = "()V", line = 19)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Ljava/lang/String;I)Ldn;", line = 86)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "()V", line = 113)
    public class378() {
