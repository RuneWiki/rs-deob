...
public abstract class class378 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ILui;ZIIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Lre;Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Z)V", line = 101)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Lct;B)V", line = 113)
