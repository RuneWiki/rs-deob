...
public class class378 extends class194 {
    ...
    @OriginalMember(owner = "client!nl", name = "d", descriptor = "(III)Laq;")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IILbg;)V")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lml;B)V")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(ILbe;BLnd;Lpi;III)V")
