...
public abstract class class378 extends class425 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(BZ)V", line = 19)
    ...
    @OriginalMember(owner = "client!mh", name = "c", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(ZB)V", line = 68)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Lec;IIZ)V", line = 161)
