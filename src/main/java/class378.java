...
public class class378 extends class82 {
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "()V", line = 279)
    public class378() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pr", name = "c", descriptor = "(II)[I", line = 10)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IIZIII)V", line = 69)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IILos;)V", line = 227)
    ...
    @OriginalMember(owner = "client!pr", name = "h", descriptor = "(I)V", line = 288)
