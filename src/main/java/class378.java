...
public class class378 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "()I", line = 3)
    public final int method2503() {
        return this.field5694 - 1;
    }

    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lnr;Ljava/lang/String;[IIIIZ)V", line = 10)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lnr;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 33)
    ...
    @OriginalMember(owner = "client!os", name = "b", descriptor = "()V", line = 126)
    public static void method2506() {
        field5693 = null;
    }

    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "(Lnr;IZLjava/awt/Component;)V", line = 192)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Ljava/lang/String;)I", line = 134)
    ...
    @OriginalMember(owner = "client!os", name = "c", descriptor = "()I", line = 152)
    public final int method2508() {
        return this.field5691;
    }

    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lnr;Ljava/lang/String;IIIZ)V", line = 176)
