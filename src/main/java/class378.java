...
public class class378 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IILkh;)V", line = 5)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IIIIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(B)Llg;", line = 62)
    ...
    @OriginalMember(owner = "client!mh", name = "b", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IILkh;I)V", line = 104)
