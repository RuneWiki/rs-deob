...
public class class378 implements class590 {
    ...
    @OriginalMember(owner = "client!bv", name = "b", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(II)Leda;", line = 25)
    ...
    @OriginalMember(owner = "client!bv", name = "b", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(B)Z", line = 53)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(IZBII)V", line = 72)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(IZ)V", line = 96)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!bv", name = "<init>", descriptor = "(Lmv;Lub;)V", line = 150)
