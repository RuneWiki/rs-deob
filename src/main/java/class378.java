...
public class class378 implements Runnable {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Z)Lep;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IILjava/lang/String;)Lep;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ILjava/awt/Frame;)Lep;")
    public final class241 method2381(int arg0, Frame arg1) {
        return arg0 == 0 ? this.method2403(7, arg1, 0, (byte) -91, 0) : null;
    }

    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ILjava/net/URL;)Lep;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IIIZLjava/lang/Object;)Lep;")
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(Z)Lep;")
    public final class241 method2385(boolean arg0) {
        return arg0 ? null : this.method2403(5, (Object) null, 0, (byte) -91, 0);
    }

    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ILjava/lang/Runnable;B)Lep;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ILjava/lang/Class;)Lep;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Ljava/lang/String;I)Lep;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IZLjava/awt/Component;)Lep;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IIIII)Lep;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(BLjava/lang/Class;)Lep;")
    ...
    @OriginalMember(owner = "client!am", name = "c", descriptor = "(Z)Lie;")
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(I)Lep;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IILjava/awt/Component;Ljava/awt/Point;I[I)Lep;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ILjava/awt/Component;II)Lep;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IB)Lep;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Ljava/lang/String;B)Lep;")
    public final class241 method2397(String arg0, byte arg1) {
        return arg1 == -79 ? this.method2403(21, arg0, 0, (byte) -91, 0) : null;
    }

    @OriginalMember(owner = "client!am", name = "a", descriptor = "(B)Lep;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Ljava/lang/Class;I)Lep;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ILjava/lang/Object;IBI)Lep;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;I)Lep;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ZLjava/lang/String;[Ljava/lang/Class;Ljava/lang/Class;)Lep;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;I)Lep;")
