...
public class class378 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ILha;BI)V")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lsea;ILsea;[I)V")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lha;III)Z")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IILha;I)V")
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(Llj;Lhca;)V")
