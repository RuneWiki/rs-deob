...
public class class378 extends class397 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IBLae;)V")
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IIILab;Lab;)V")
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IIILeq;III[[[BIIIII)V")
    ...
    @OriginalMember(owner = "client!wm", name = "f", descriptor = "(B)V")
