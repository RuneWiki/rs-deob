...
public class class378 extends class305 {
    ...
    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "(ILhb;)V", line = 5)
    public class378(int arg0, class728 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!at", name = "c", descriptor = "(II)I", line = 11)
    ...
    @OriginalMember(owner = "client!at", name = "b", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "(Lhb;)V", line = 43)
    public class378(class728 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!at", name = "b", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!at", name = "b", descriptor = "(II)V", line = 67)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Z)V", line = 78)
    ...
    @OriginalMember(owner = "client!at", name = "c", descriptor = "(I)Z", line = 183)
    ...
    @OriginalMember(owner = "client!at", name = "d", descriptor = "(I)I", line = 206)
    public final int method2446(int arg0) {
        ++field5720;
        return arg0 != 17503 ? -50 : super.field4320;
    }

    @OriginalMember(owner = "client!at", name = "a", descriptor = "(B)I", line = 221)
    ...
    @OriginalMember(owner = "client!at", name = "d", descriptor = "(B)V", line = 232)
