...
public abstract class class378 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Lct;BII)Lhi;", line = 15)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Ljava/awt/Component;I)Lon;", line = 55)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(II)V", line = 67)
