...
public class class378 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(BIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "([BB)V", line = 57)
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "([BI)V", line = 228)
