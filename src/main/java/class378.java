...
public class class378 extends class436 {
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(Z)V", line = 222)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(I)V", line = 238)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IBI)V", line = 255)
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(IIIIIFFF)V", line = 271)
    ...
    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(II)I", line = 285)
