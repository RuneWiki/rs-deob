...
public class class378 extends class659 {
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(ILjagtheora/ogg/OggPacket;)V")
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(Lha;I)Ltb;")
    ...
    @OriginalMember(owner = "client!rda", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(IB)Llq;")
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(ZBLjava/lang/String;Llga;)Lip;")
