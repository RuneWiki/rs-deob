...
public class class378 extends class214 {
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "()V", line = 8)
    public class378() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ILofa;I)V", line = 16)
    ...
    @OriginalMember(owner = "client!ot", name = "c", descriptor = "(II)[[I", line = 60)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(BIII)V", line = 133)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(III)Llo;", line = 241)
    ...
    @OriginalMember(owner = "client!ot", name = "f", descriptor = "(I)V", line = 260)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IZLul;)V", line = 277)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IIBI)V", line = 294)
