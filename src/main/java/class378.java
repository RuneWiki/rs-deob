...
public class class378 extends class256 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIILjava/awt/Canvas;)V", line = 11)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IILjava/awt/Graphics;IIIII)V", line = 34)
