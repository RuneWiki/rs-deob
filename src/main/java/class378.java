...
public class class378 {
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "([BI)V", line = 9)
    ...
    @OriginalMember(owner = "client!d", name = "<init>", descriptor = "(Lnf;[BI)V", line = 18)
    ...
    @OriginalMember(owner = "client!d", name = "<init>", descriptor = "(Lnf;Ljava/nio/ByteBuffer;)V", line = 28)
