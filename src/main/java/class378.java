...
public class class378 extends class354 {
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(BI)[I", line = 7)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(IIIII)V", line = 35)
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "()V", line = 49)
    public class378() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(CB)Z", line = 53)
