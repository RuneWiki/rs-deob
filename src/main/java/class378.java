...
public class class378 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;I)V", line = 14)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(ZI)V", line = 80)
    ...
    @OriginalMember(owner = "client!bn", name = "toString", descriptor = "()Ljava/lang/String;", line = 149)
    public final String toString() {
        field5215++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(III)Z", line = 160)
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(I)V", line = 171)
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "(II)V", line = 243)
