...
public class class378 implements class121 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(ILjava/lang/String;)I", line = 3)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(I)Lev;", line = 38)
    ...
    @OriginalMember(owner = "client!s", name = "b", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!s", name = "c", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(III)Z", line = 81)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Lcda;I)V", line = 94)
    ...
    @OriginalMember(owner = "client!s", name = "<init>", descriptor = "(Lpe;)V", line = 165)
