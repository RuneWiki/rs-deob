...
public class class378 extends class261 {
    ...
    @OriginalMember(owner = "client!go", name = "c", descriptor = "()V", line = 15)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 49)
    ...
    @OriginalMember(owner = "client!go", name = "c", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 86)
    ...
    @OriginalMember(owner = "client!go", name = "d", descriptor = "()V", line = 109)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "()V", line = 131)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "()I", line = 148)
