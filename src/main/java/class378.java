...
public class class378 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Lwu;III)Loq;")
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(II)Llba;")
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(BLlba;)V")
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Llba;)V")
