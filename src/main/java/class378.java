...
public class class378 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(BLr;IIIII)V")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(BLkp;)V")
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lr;Les;I)V")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Lkp;I)V")
