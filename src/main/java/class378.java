...
public class class378 extends class452 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(CI)I", line = 5)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(CI)I", line = 45)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ZLhp;I)V", line = 101)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lhp;B)V", line = 165)
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(II)Z", line = 184)
