...
public class class378 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(Ljava/lang/String;IZI)V", line = 17)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IILib;)V", line = 136)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(Lib;I)V", line = 185)
