...
public class class378 implements class187 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Lqr;I)V")
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IB)Lrq;")
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IZ)Lpt;")
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "(Lfc;Lfc;Lfc;)V")
