...
public class class378 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Z[IJLlg;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(BI)Lbca;")
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(ILga;Lga;Lhn;)V")
