...
public class class378 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lr;Lie;IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lr;IIIIIII[S[BZ)V")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lr;IIII)V")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(II)Lba;")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lfa;II)V")
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(II)Lce;")
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(Lr;IIII)Lor;")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lr;IIII[S[B)V")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lfa;III)I")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lr;)Lor;")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lr;II)V")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lr;Lkt;IIII)V")
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(I)Lba;")
    public static final class354 method2490(int arg0) {
        return (class354) field5867.method1558((long) arg0, (byte) -93);
    }

    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(Lr;)V")
    ...
    @OriginalMember(owner = "client!fr", name = "c", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lri;Lkca;Ldp;Lil;Llk;Lsb;Lhfa;)V")
