...
public class class378 extends class7 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Ljg;I)Lna;")
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Ljg;II)V")
    ...
    @OriginalMember(owner = "client!jk", name = "b", descriptor = "(Ljg;I)V")
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Lmo;Lah;I)V")
