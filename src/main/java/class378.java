...
public class class378 extends class439 {
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(IJ)I", line = 3)
    ...
    @OriginalMember(owner = "client!aha", name = "c", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(I)J", line = 56)
    ...
    @OriginalMember(owner = "client!aha", name = "b", descriptor = "(I)J", line = 76)
    public final long method2080(int arg0) {
        return arg0 < 58 ? 115L : this.field5279;
    }

    @OriginalMember(owner = "client!aha", name = "e", descriptor = "(I)J", line = 92)
