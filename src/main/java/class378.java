...
public class class378 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ILsl;)V", line = 18)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Ljava/lang/String;B)Ljava/lang/String;", line = 40)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Lsl;II)V", line = 86)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IBZLjava/lang/String;)V", line = 105)
