...
public class class378 extends class597 {
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(BLwc;Z)V")
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(Z)Llda;")
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(I)Lfn;")
    ...
    @OriginalMember(owner = "client!bga", name = "<init>", descriptor = "(Lai;IIIIII)V")
