...
public class class378 extends class478 {
    ...
    @OriginalMember(owner = "client!qd", name = "b", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "()V", line = 16)
    public class378() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qd", name = "c", descriptor = "(I)V", line = 23)
