...
public class LocType {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(BLlb;)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(BLub;)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IZII)Leb;")
