...
public class LocType {
    ...
    @OriginalMember(owner = "client!ec", name = "m", descriptor = "[Leb;")
    private static Model[] field959 = new Model[4];

    @OriginalMember(owner = "client!ec", name = "Y", descriptor = "Ls;")
    public static LruCache field997 = new LruCache(false, 500);

    @OriginalMember(owner = "client!ec", name = "Z", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!ec", name = "j", descriptor = "Llb;")
    private static Packet field956;

    @OriginalMember(owner = "client!ec", name = "g", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!ec", name = "c", descriptor = "(I)Lec;")
