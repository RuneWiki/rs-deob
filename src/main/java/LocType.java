...
public class LocType {
    ...
    @OriginalMember(owner = "client!ac", name = "P", descriptor = "Ls;")
    public static LruCache field840 = new LruCache((byte) 0, 500);

    @OriginalMember(owner = "client!ac", name = "Q", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Lub;)V")
    public static final void method280(Jagfile arg0) {
        field804 = new Packet(363, arg0.method257("loc.dat", null, (byte) 2));
        Packet var1 = new Packet(363, arg0.method257("loc.idx", null, (byte) 2));
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(I)Lac;")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ZLkb;)V")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIIIIII)Leb;")
