...
public class LocType {
    ...
    @OriginalMember(owner = "client!ac", name = "N", descriptor = "Ls;")
    public static LruCache field839 = new LruCache(500, (byte) 4);

    @OriginalMember(owner = "client!ac", name = "O", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!ac", name = "e", descriptor = "[Lac;")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Lkb;I)V")
