...
public class LocType {
    ...
    @OriginalMember(owner = "client!ac", name = "R", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!ac", name = "h", descriptor = "[Lac;")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(BLkb;)V")
