...
public class LocType {
    ...
    @OriginalMember(owner = "client!ec", name = "l", descriptor = "[Leb;")
    ...
    @OriginalMember(owner = "client!ec", name = "i", descriptor = "Llb;")
    ...
    @OriginalMember(owner = "client!ec", name = "j", descriptor = "[Lec;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(BIII)Leb;")
