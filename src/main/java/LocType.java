...
public class LocType {
    ...
    @OriginalMember(owner = "client!ec", name = "i", descriptor = "[Lfb;")
    private static Model[] field939 = new Model[4];

    @OriginalMember(owner = "client!ec", name = "R", descriptor = "Lt;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILmb;)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lvb;Z)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IIII)Lfb;")
