...
public class LocType {
    ...
    @OriginalMember(owner = "client!ec", name = "S", descriptor = "Ls;")
    public static LruCache field994 = new LruCache(500, (byte) 1);

    @OriginalMember(owner = "client!ec", name = "T", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!ec", name = "d", descriptor = "Llb;")
    private static Packet field953;

    @OriginalMember(owner = "client!ec", name = "a", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lub;B)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IBII)Leb;")
