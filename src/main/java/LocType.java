...
public class LocType {
    ...
    @OriginalMember(owner = "client!xb", name = "P", descriptor = "Ls;")
    public static LruCache field771 = new LruCache(-24094, 500);

    @OriginalMember(owner = "client!xb", name = "Q", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!xb", name = "f", descriptor = "Lkb;")
    ...
    @OriginalMember(owner = "client!xb", name = "a", descriptor = "(Lub;)V")
    ...
    @OriginalMember(owner = "client!xb", name = "a", descriptor = "(ILkb;)V")
    ...
    @OriginalMember(owner = "client!xb", name = "a", descriptor = "(IIIIIII)Leb;")
