...
public class LocType {
    ...
    @OriginalMember(owner = "client!ec", name = "V", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!ec", name = "g", descriptor = "Llb;")
    ...
    @OriginalMember(owner = "client!ec", name = "h", descriptor = "[Lec;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ZLlb;)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lub;I)V")
