...
public class LocType {
    ...
    @OriginalMember(owner = "client!fc", name = "i", descriptor = "[Leb;")
    private static Model[] field956 = new Model[4];

    @OriginalMember(owner = "client!fc", name = "R", descriptor = "Ls;")
    public static LruCache field991 = new LruCache(500, false);

    @OriginalMember(owner = "client!fc", name = "S", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lyb;)V")
    ...
    @OriginalMember(owner = "client!fc", name = "b", descriptor = "(I)Lfc;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(BLmb;)V")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(ZLvb;)V")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IIIIIII)Leb;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IIII)Leb;")
