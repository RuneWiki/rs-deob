...
public class LocType {
    ...
    @OriginalMember(owner = "client!ec", name = "j", descriptor = "[Lfb;")
    private static Model[] field968 = new Model[4];

    @OriginalMember(owner = "client!ec", name = "S", descriptor = "Lt;")
    public static LruCache field1003 = new LruCache(0, 500);

    @OriginalMember(owner = "client!ec", name = "T", descriptor = "Lt;")
    ...
    @OriginalMember(owner = "client!ec", name = "g", descriptor = "Lmb;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lyb;)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lmb;B)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lvb;I)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IIIIIII)Lfb;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ZIII)Lfb;")
