...
public class LocType {
    ...
    @OriginalMember(owner = "client!wb", name = "L", descriptor = "Lr;")
    ...
    @OriginalMember(owner = "client!wb", name = "e", descriptor = "Ljb;")
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(I)Lwb;")
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(BLjb;)V")
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IIIIIII)Ldb;")
