...
public class LocType {
    ...
    @OriginalMember(owner = "client!ec", name = "e", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(I)Lec;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Llb;I)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IIZI)Leb;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(B)Lec;")
