...
public class LocType {
    ...
    private static byte field947 = 59;

    @OriginalMember(owner = "client!ec", name = "k", descriptor = "[Leb;")
    private static Model[] field957 = new Model[4];

    @OriginalMember(owner = "client!ec", name = "W", descriptor = "Ls;")
    public static LruCache field995 = new LruCache(500, false);

    @OriginalMember(owner = "client!ec", name = "X", descriptor = "Ls;")
    public static LruCache field996 = new LruCache(30, false);
    ...
    @OriginalMember(owner = "client!ec", name = "h", descriptor = "Llb;")
    private static Packet field954;

    @OriginalMember(owner = "client!ec", name = "d", descriptor = "Lclient;")
    ...
    public static boolean field951;
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lxb;)V")
    public static final void method328(Jagfile arg0) {
        field954 = new Packet(false, arg0.method299("loc.dat", null));
        Packet var1 = new Packet(false, arg0.method299("loc.idx", null));
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(I)Lec;")
    public static final LocType method330(int arg0) {
        ...
        field954.field716 = field953[arg0];
        var2.field958 = arg0;
        var2.method331();
        var2.method332(field954, false);
        return var2;
    }
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Llb;Z)V")
            ...
            while (true) {
                ...
                do {
                    while (true) {
                        ...
                        if (var4 == 2) {
                            this.field961 = arg0.method236();
                        } else if (var4 == 3) {
                            this.field962 = arg0.method237(false);
                        } else if (var4 == 5) {
                            int var7 = arg0.method229();
                            if (var7 > 0) {
                                if (this.field959 == null || field951) {
                                    this.field960 = null;
                                    this.field959 = new int[var7];
                                    for (int var8 = 0; var8 < var7; var8++) {
                                        this.field959[var8] = arg0.method231();
                                    }
                                } else {
                                    arg0.field716 += var7 * 2;
                                }
                            }
                        } else if (var4 == 14) {
                            this.field965 = arg0.method229();
                        } else if (var4 == 15) {
                            this.field966 = arg0.method229();
                        } else if (var4 == 17) {
                            this.field967 = false;
                        } else if (var4 == 18) {
                            this.field968 = false;
                            ...
                            this.field974 = arg0.method229();
                        } else if (var4 == 29) {
                            this.field975 = arg0.method230();
                        } else if (var4 == 39) {
                            this.field976 = arg0.method230();
                        } else if (var4 >= 30 && var4 < 39) {
                            if (this.field977 == null) {
                                this.field977 = new String[5];
                            }
                            this.field977[var4 - 30] = arg0.method236();
                            ...
                            for (int var10 = 0; var10 < var9; var10++) {
                                this.field963[var10] = arg0.method231();
                                this.field964[var10] = arg0.method231();
                            }
                        } else if (var4 == 60) {
                            ...
                            this.field982 = arg0.method231();
                        } else if (var4 == 66) {
                            this.field983 = arg0.method231();
                        } else if (var4 == 67) {
                            this.field984 = arg0.method231();
                        } else if (var4 == 68) {
                            this.field979 = arg0.method231();
                        } else if (var4 == 69) {
                            this.field988 = arg0.method229();
                        } else if (var4 == 70) {
                            this.field985 = arg0.method232();
                        } else if (var4 == 71) {
                            this.field986 = arg0.method232();
                        } else if (var4 == 72) {
                            ...
                            this.field991 = arg0.method229();
                        } else if (var4 == 77) {
                            this.field993 = arg0.method231();
                            if (this.field993 == 65535) {
                                this.field993 = -1;
                            }
                            this.field994 = arg0.method231();
                            ...
                            for (int var12 = 0; var12 <= var11; var12++) {
                                this.field992[var12] = arg0.method231();
                ...
                if (this.field959 == null || field951) {
                    ...
                    for (int var6 = 0; var6 < var5; var6++) {
                        this.field959[var6] = arg0.method231();
                        this.field960[var6] = arg0.method229();
                    }
                } else {
                    arg0.field716 += var5 * 3;
                }
            }
        }
    }
    ...
    public final boolean method334(int arg0) {
        ...
        for (int var3 = 0; var3 < this.field959.length; var3++) {
            var2 &= Model.method127(this.field959[var3] & 0xFFFF);
        }
        int var4 = 59 / arg0;
        return var2;
    }

    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILub;)V")
    public final void method335(int arg0, OnDemand arg1) {
        if (this.field959 == null) {
            return;
        }
        for (int var3 = 0; var3 < this.field959.length; var3++) {
            arg1.method284(0, this.field959[var3] & 0xFFFF, 0);
        }
        while (arg0 >= 0) {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IIIIIII)Leb;")
    public final Model method336(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        Model var8 = this.method337(arg6, 49264, arg1, arg0);
        if (var8 == null) {
            return null;
        }
        if (this.field970 || this.field971) {
            var8 = new Model(this.field970, (byte) 6, var8, this.field971);
        }
        if (this.field970) {
            int var9 = (arg2 + arg3 + arg4 + arg5) / 4;
            for (int var10 = 0; var10 < var8.field547; var10++) {
                int var11 = var8.field548[var10];
                int var12 = var8.field550[var10];
                int var13 = (arg3 - arg2) * (var11 + 64) / 128 + arg2;
                int var14 = (arg4 - arg5) * (var11 + 64) / 128 + arg5;
                int var15 = (var14 - var13) * (var12 + 64) / 128 + var13;
                var8.field549[var10] += var15 - var9;
            }
            var8.method131(858);
        }
        return var8;
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IIII)Leb;")
    private final Model method337(int arg0, int arg1, int arg2, int arg3) {
        ...
        if (this.field960 == null) {
            ...
            var6 = ((long) (arg0 + 1) << 32) + (long) ((this.field958 << 6) + arg2);
            ...
            for (int var11 = 0; var11 < var10; var11++) {
                ...
                if (var5 == null) {
                    var5 = Model.method126(var12 & 0xFFFF, 0);
                    if (var5 == null) {
                        return null;
                    }
                    if (var9) {
                        var5.method141(false);
                    }
                    field995.method102(var5, (long) var12, this.field949);
                }
                if (var10 > 1) {
                    field957[var11] = var5;
                }
            ...
            if (var10 > 1) {
                var5 = new Model(var10, field957, (byte) 1);
            }
        } else {
            int var13 = -1;
            ...
            var6 = ((long) (arg0 + 1) << 32) + (long) ((this.field958 << 6) + (var13 << 3) + arg2);
            ...
            if (var5 == null) {
                var5 = Model.method126(var16 & 0xFFFF, 0);
                if (var5 == null) {
                    return null;
                }
                if (var17) {
                ...
                field995.method102(var5, (long) var16, this.field949);
            }
        }
        boolean var18;
        ...
        Model var20 = new Model(AnimFrame.method48(arg0, 0), arg2 == 0 && arg0 == -1 && !var18 && !var19, 0, this.field963 == null, var5);
        if (arg1 != 49264) {
            throw new NullPointerException();
        }
        if (arg0 != -1) {
            var20.method133(this.field948);
            var20.method134(-37879, arg0);
            var20.field579 = null;
            var20.field578 = null;
        }
        while (arg2-- > 0) {
            var20.method137(true);
        }
        ...
        if (var18) {
            var20.method142(this.field983, this.field984, false, this.field982);
        }
        if (var19) {
            var20.method139(this.field985, this.field986, this.field987, (byte) -5);
        }
        var20.method143(this.field975 + 64, this.field976 * 5 + 768, -50, -10, -50, !this.field971);
        if (this.field991 == 1) {
            var20.field575 = var20.field398;
        }
        field996.method102(var20, var6, this.field949);
        return var20;
    }

    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(B)Lec;")
    public final LocType method338(byte arg0) {
        ...
        int var3 = -1;
        if (this.field993 != -1) {
            VarbitType var4 = VarbitType.field1192[this.field993];
            int var5 = var4.field1194;
            int var6 = var4.field1195;
            int var7 = var4.field1196;
            int var8 = client.field1379[var7 - var6];
            var3 = field950.field1249[var5] >> var6 & var8;
        } else if (this.field994 != -1) {
            var3 = field950.field1249[this.field994];
        }
        return var3 < 0 || var3 >= this.field992.length || this.field992[var3] == -1 ? null : method330(this.field992[var3]);
    }
}
