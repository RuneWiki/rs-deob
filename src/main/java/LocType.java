...
public class LocType {
    ...
    @OriginalMember(owner = "client!ec", name = "i", descriptor = "[Leb;")
    private static Model[] field945 = new Model[4];

    @OriginalMember(owner = "client!ec", name = "R", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!ec", name = "f", descriptor = "Llb;")
    ...
    @OriginalMember(owner = "client!ec", name = "g", descriptor = "[Lec;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Llb;B)V")
