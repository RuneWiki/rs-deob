...
public class class25 {
    ...
    @OriginalMember(owner = "client!KTJKDKKM", name = "c", descriptor = "[LKTJKDKKM;")
    public static class25[] field966;

    @OriginalMember(owner = "client!KTJKDKKM", name = "a", descriptor = "(LGWOEELWB;B)V")
    ...
    @OriginalMember(owner = "client!KTJKDKKM", name = "a", descriptor = "(IILMLYYHULT;)V")
