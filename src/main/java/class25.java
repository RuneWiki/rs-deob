...
public class class25 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(I)I", line = 21)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(II)I", line = 37)
    public static int method183(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "()V", line = 47)
    public class25() {
    }

    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "(Llh;)V", line = 49)
    ...
    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(B)I", line = 62)
