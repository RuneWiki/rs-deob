...
public class class25 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(II)Lam;")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lpp;Lpp;Z)V")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IZ)Lro;")
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Ljda;ILjo;Ljo;Ljo;)V")
