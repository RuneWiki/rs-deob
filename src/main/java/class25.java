...
@OriginalClass("client!IBCKUTPD")
public class class25 {

    @OriginalMember(owner = "client!IBCKUTPD", name = "a", descriptor = "I")
    private static int field861 = 3;

    @OriginalMember(owner = "client!IBCKUTPD", name = "c", descriptor = "I")
    public int field863;

    @OriginalMember(owner = "client!IBCKUTPD", name = "e", descriptor = "I")
    public int field865;

    @OriginalMember(owner = "client!IBCKUTPD", name = "d", descriptor = "LMXTMAEWO;")
    public class36 field864;

    @OriginalMember(owner = "client!IBCKUTPD", name = "f", descriptor = "[I")
    public int[] field866;

    @OriginalMember(owner = "client!IBCKUTPD", name = "g", descriptor = "[I")
    public int[] field867;

    @OriginalMember(owner = "client!IBCKUTPD", name = "h", descriptor = "[I")
    public int[] field868;

    @OriginalMember(owner = "client!IBCKUTPD", name = "i", descriptor = "[I")
    public int[] field869;

    @OriginalMember(owner = "client!IBCKUTPD", name = "b", descriptor = "[LIBCKUTPD;")
    private static class25[] field862;

    @OriginalMember(owner = "client!IBCKUTPD", name = "j", descriptor = "[Z")
    private static boolean[] field870;

    @OriginalMember(owner = "client!IBCKUTPD", name = "a", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!IBCKUTPD", name = "a", descriptor = "(B[B)V")
    ...
    @OriginalMember(owner = "client!IBCKUTPD", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!IBCKUTPD", name = "c", descriptor = "(I)LIBCKUTPD;")
    public static class25 method308(int arg0) {
        return field862 == null ? null : field862[arg0];
    }

    @OriginalMember(owner = "client!IBCKUTPD", name = "a", descriptor = "(IZ)Z")
