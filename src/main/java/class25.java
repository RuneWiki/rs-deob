...
public abstract class class25 extends class362 {
    ...
    @OriginalMember(owner = "client!fba", name = "c", descriptor = "(II)Loaa;", line = 5)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(ZIILjava/awt/Canvas;Ld;)Lha;", line = 31)
    ...
    @OriginalMember(owner = "client!fba", name = "b", descriptor = "(III)V", line = 45)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!fba", name = "d", descriptor = "(I)Z", line = 175)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(B)Z", line = 187)
    ...
    @OriginalMember(owner = "client!fba", name = "b", descriptor = "(Z)I", line = 198)
    ...
    @OriginalMember(owner = "client!fba", name = "e", descriptor = "(I)V", line = 214)
    ...
    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "(Lqo;)V", line = 225)
    public class25(class22 arg0) {
        this.field730 = arg0;
    }

    @OriginalMember(owner = "client!fba", name = "f", descriptor = "(I)I", line = 234)
