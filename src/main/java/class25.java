...
public class class25 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IIIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ILfb;I)V", line = 33)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IIILfb;)V", line = 90)
