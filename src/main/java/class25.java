...
public class class25 extends class475 {
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(ZI)Lgi;", line = 7)
    ...
    @OriginalMember(owner = "client!nf", name = "b", descriptor = "(Z)V", line = 43)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IIII)I", line = 57)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IIIIIIIIII)V", line = 103)
