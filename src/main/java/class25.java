...
public class class25 implements class723 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IILjaclib/memory/Source;I)Z")
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Lsd;Z)V")
