...
public class class25 extends class54 {
    ...
    @OriginalMember(owner = "client!JKNLPRIU", name = "rb", descriptor = "LJKAPIYZO;")
    public class24 field871;

    @OriginalMember(owner = "client!JKNLPRIU", name = "b", descriptor = "(B)LWEVRTBOZ;")
    ...
    @OriginalMember(owner = "client!JKNLPRIU", name = "a", descriptor = "(Z)LWEVRTBOZ;")
