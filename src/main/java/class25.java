...
@OriginalClass("client!HASAJOKP")
public class class25 {

    @OriginalMember(owner = "client!HASAJOKP", name = "a", descriptor = "I")
    private int field985 = 23;

    @OriginalMember(owner = "client!HASAJOKP", name = "b", descriptor = "I")
    private int field986 = -49833;

    @OriginalMember(owner = "client!HASAJOKP", name = "c", descriptor = "LFRLKXEIS;")
    public class17 field987 = new class17();

    @OriginalMember(owner = "client!HASAJOKP", name = "d", descriptor = "LFRLKXEIS;")
    private class17 field988;

    @OriginalMember(owner = "client!HASAJOKP", name = "<init>", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!HASAJOKP", name = "a", descriptor = "(LFRLKXEIS;)V")
    ...
    @OriginalMember(owner = "client!HASAJOKP", name = "a", descriptor = "()LFRLKXEIS;")
    ...
    @OriginalMember(owner = "client!HASAJOKP", name = "b", descriptor = "()LFRLKXEIS;")
    ...
    @OriginalMember(owner = "client!HASAJOKP", name = "a", descriptor = "(I)LFRLKXEIS;")
    ...
    @OriginalMember(owner = "client!HASAJOKP", name = "c", descriptor = "()I")
