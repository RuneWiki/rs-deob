...
public class class25 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IZ)Lcu;", line = 5)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IB)V", line = 51)
    ...
    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(III)V", line = 111)
    ...
    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "(Lal;ILmg;Lmg;)V", line = 129)
