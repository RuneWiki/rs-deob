...
public class class25 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ZBLza;)Lo;")
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ILza;)Lo;")
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IZLnn;)V")
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(Lnn;B)V")
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ILhp;)Z")
