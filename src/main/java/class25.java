...
public class class25 extends class156 {
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "()Ln;")
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Lmk;)V")
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Lmk;I)V")
