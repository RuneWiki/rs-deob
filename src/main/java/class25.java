...
public class class25 {
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Lqj;I)Ln;")
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "([B)[Ln;")
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Lqj;II)[Ln;")
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "(Lqj;II)Ln;")
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "(Lqj;I)[Ln;")
