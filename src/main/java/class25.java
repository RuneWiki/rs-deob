...
public class class25 extends class578 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(I[Lin;IZII)V", line = 7)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(II)V", line = 55)
    ...
    @OriginalMember(owner = "client!ir", name = "c", descriptor = "(Z)V", line = 68)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IIIIII)V", line = 102)
