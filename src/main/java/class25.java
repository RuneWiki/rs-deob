...
public class class25 extends class460 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Ljaa;Ldk;)V", line = 51)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(BZ)V", line = 98)
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(BILjava/lang/String;)V", line = 141)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IILtj;)V", line = 169)
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(I)Z", line = 184)
    ...
    @OriginalMember(owner = "client!ir", name = "c", descriptor = "(I)V", line = 196)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IIB)V", line = 213)
