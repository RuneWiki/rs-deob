...
public class class25 extends class35 {
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "(II)V", line = 8)
    ...
    @OriginalMember(owner = "client!n", name = "<init>", descriptor = "(II[IZ)V", line = 56)
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "()V", line = 203)
