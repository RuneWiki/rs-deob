...
public class class25 extends class538 {
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "(Lnq;IIIII)V")
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "(Lnq;IIII)V")
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "(Lnq;IIIIZ[IZ)V")
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "(Lnq;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "(Lnq;IIIIZ[FI)V")
