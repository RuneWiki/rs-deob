...
public class class25 extends class140 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IILjl;)V")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IILjava/awt/Component;ILlp;)Lgaa;")
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Lte;)V")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(ZB)V")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(ILfaa;)V")
