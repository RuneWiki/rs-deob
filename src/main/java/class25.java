...
public class class25 extends class43 {
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IB)V", line = 5)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IFZII)V", line = 20)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(BI)V", line = 126)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(B[II)V", line = 138)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(II)V", line = 261)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IIII)V", line = 272)
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(Lef;IIII)V", line = 286)
