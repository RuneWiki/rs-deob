...
public class class25 {
    ...
    @OriginalMember(owner = "client!KDJQGGIG", name = "d", descriptor = "LUSEDATIW;")
    ...
    @OriginalMember(owner = "client!KDJQGGIG", name = "b", descriptor = "[LKDJQGGIG;")
    ...
    @OriginalMember(owner = "client!KDJQGGIG", name = "b", descriptor = "(I)LKDJQGGIG;")
