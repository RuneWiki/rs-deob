...
public class class25 extends class376 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(Liv;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ILiv;)V", line = 47)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(III)I", line = 79)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ILjava/lang/String;I)Ljava/lang/String;", line = 114)
