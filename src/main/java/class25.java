...
public class class25 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(II)V", line = 21)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "([IIILts;)V", line = 37)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(ILwq;B)I", line = 124)
