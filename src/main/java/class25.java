...
public class class25 {
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(ILsl;I)V")
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(Lsl;I)Lie;")
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IIILsl;)V")
