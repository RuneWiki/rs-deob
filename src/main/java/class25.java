...
public class class25 implements Runnable {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "([BIILnha;)Lffa;", line = 3)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(ILnha;I)Lffa;", line = 22)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(IILnha;)Lffa;", line = 40)
    ...
    @OriginalMember(owner = "client!jg", name = "<init>", descriptor = "(Lft;)V", line = 167)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Lffa;I)V", line = 79)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!jg", name = "run", descriptor = "()V", line = 120)
