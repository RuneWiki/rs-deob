...
@OriginalClass("client!HGWWWEIE")
public class class25 extends class64 {

    @OriginalMember(owner = "client!HGWWWEIE", name = "l", descriptor = "I")
    private int field827 = 617;

    @OriginalMember(owner = "client!HGWWWEIE", name = "m", descriptor = "I")
    private int field828 = -2273;

    @OriginalMember(owner = "client!HGWWWEIE", name = "p", descriptor = "B")
    private byte field831 = 6;

    @OriginalMember(owner = "client!HGWWWEIE", name = "r", descriptor = "Z")
    public boolean field833 = false;

    @OriginalMember(owner = "client!HGWWWEIE", name = "s", descriptor = "LIDQQUVDL;")
    private class27 field834;

    @OriginalMember(owner = "client!HGWWWEIE", name = "t", descriptor = "I")
    public int field835;

    @OriginalMember(owner = "client!HGWWWEIE", name = "u", descriptor = "I")
    public int field836;

    @OriginalMember(owner = "client!HGWWWEIE", name = "v", descriptor = "I")
    public int field837;

    @OriginalMember(owner = "client!HGWWWEIE", name = "w", descriptor = "I")
    public int field838;

    @OriginalMember(owner = "client!HGWWWEIE", name = "q", descriptor = "I")
    public int field832;

    @OriginalMember(owner = "client!HGWWWEIE", name = "n", descriptor = "I")
    private int field829;

    @OriginalMember(owner = "client!HGWWWEIE", name = "o", descriptor = "I")
    private int field830;

    @OriginalMember(owner = "client!HGWWWEIE", name = "a", descriptor = "(Z)LOIBEFFXI;")
    ...
    @OriginalMember(owner = "client!HGWWWEIE", name = "a", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!HGWWWEIE", name = "<init>", descriptor = "(IIBIIIII)V")
