...
public class class25 extends class298 {
    ...
    @OriginalMember(owner = "client!n", name = "h", descriptor = "(I)Z", line = 8)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IZ)Ljava/lang/String;", line = 22)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IIZLii;)Z", line = 42)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IIZIZ)V", line = 76)
    ...
    @OriginalMember(owner = "client!n", name = "e", descriptor = "(I)Z", line = 89)
    public final boolean method166(int arg0) {
        ++field355;
        return arg0 != -17506 ? false : false;
    }

    @OriginalMember(owner = "client!n", name = "a", descriptor = "(BLnj;)V", line = 100)
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "(I)I", line = 301)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Lii;IIIILnc;Z)V", line = 324)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(I)I", line = 339)
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "(Lii;I)Leb;", line = 353)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IIILjs;)V", line = 496)
    ...
    @OriginalMember(owner = "client!n", name = "c", descriptor = "(I)I", line = 506)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IILdc;Lvj;ILii;II)V", line = 517)
    ...
    @OriginalMember(owner = "client!n", name = "f", descriptor = "(I)I", line = 547)
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "(IZ)Ljava/lang/String;", line = 559)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(ILii;)V", line = 616)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Z)V", line = 639)
    ...
    @OriginalMember(owner = "client!n", name = "i", descriptor = "(I)V", line = 651)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IIZIZLlm;)V", line = 669)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(ILii;I)Z", line = 689)
    ...
    @OriginalMember(owner = "client!n", name = "j", descriptor = "(I)V", line = 835)
