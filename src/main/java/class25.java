...
public class class25 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lfa;III)I", line = 4)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lr;Llt;IIII)V", line = 60)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "()V", line = 65)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lpu;Lka;Ltu;Leu;Lqca;Lpf;Lqj;)V", line = 87)
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "()V", line = 121)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lr;II)V", line = 279)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(I)V", line = 458)
    public static final void method292(int arg0) {
        field336 = (class326) field340.method1405((long) arg0, (byte) -17);
    }

    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(II)Lgm;", line = 462)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lr;IIIIIII[S[BZ)V", line = 477)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lr;IIII[S[B)V", line = 639)
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(I)Loq;", line = 698)
    public static final class326 method296(int arg0) {
        return (class326) field340.method1405((long) arg0, (byte) -109);
    }

    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lr;IIII)Lwba;", line = 704)
    ...
    @OriginalMember(owner = "client!ir", name = "c", descriptor = "()V", line = 714)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lfa;II)V", line = 745)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "([B[B[SII)V", line = 756)
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(II)Loq;", line = 901)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IIIIIIII)V", line = 916)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lr;Lmo;IIII[I[I)V", line = 927)
    ...
    @OriginalMember(owner = "client!ir", name = "d", descriptor = "()V", line = 1061)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lr;)Lwba;", line = 1072)
    ...
    @OriginalMember(owner = "client!ir", name = "e", descriptor = "()V", line = 1083)
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(Lr;)V", line = 1096)
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(Lr;IIII)V", line = 1112)
