...
public class class25 {
    ...
    @OriginalMember(owner = "client!kba", name = "finalize", descriptor = "()V", line = 20)
    ...
    @OriginalMember(owner = "client!kba", name = "<init>", descriptor = "(Llea;J[Lck;)V", line = 33)
    public class25(class573 arg0, long arg1, class235[] arg2) {
        this.field275 = arg0;
        this.field277 = arg1;
    }

    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(II)Lqw;", line = 44)
