...
public class class25 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Ljn;B)V")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lir;B)V")
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(B)Lir;")
