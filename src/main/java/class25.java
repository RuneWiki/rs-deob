...
public class class25 extends class569 {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(Z)Lqi;", line = 4)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(ILkha;)V", line = 22)
    ...
    @OriginalMember(owner = "client!uv", name = "<init>", descriptor = "(Lgq;Lkfa;IIIIIIIIIIIIII)V", line = 34)
