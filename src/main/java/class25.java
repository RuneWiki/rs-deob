...
@OriginalClass("client!JDPRJRPB")
public class class25 {

    @OriginalMember(owner = "client!JDPRJRPB", name = "i", descriptor = "[LZOZPAWWH;")
    private class71[] field870 = new class71[10];

    @OriginalMember(owner = "client!JDPRJRPB", name = "a", descriptor = "I")
    private static int field862 = 8;

    @OriginalMember(owner = "client!JDPRJRPB", name = "b", descriptor = "I")
    private static int field863 = -10491;

    @OriginalMember(owner = "client!JDPRJRPB", name = "d", descriptor = "B")
    private static byte field865 = 2;

    @OriginalMember(owner = "client!JDPRJRPB", name = "e", descriptor = "[LJDPRJRPB;")
    private static class25[] field866 = new class25[5000];

    @OriginalMember(owner = "client!JDPRJRPB", name = "f", descriptor = "[I")
    public static int[] field867 = new int[5000];

    @OriginalMember(owner = "client!JDPRJRPB", name = "c", descriptor = "I")
    private int field864;

    @OriginalMember(owner = "client!JDPRJRPB", name = "j", descriptor = "I")
    private int field871;

    @OriginalMember(owner = "client!JDPRJRPB", name = "k", descriptor = "I")
    private int field872;

    @OriginalMember(owner = "client!JDPRJRPB", name = "h", descriptor = "LMUKVLYLC;")
    private static class33 field869;

    @OriginalMember(owner = "client!JDPRJRPB", name = "g", descriptor = "[B")
    private static byte[] field868;

    @OriginalMember(owner = "client!JDPRJRPB", name = "<init>", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!JDPRJRPB", name = "a", descriptor = "(LMUKVLYLC;Z)V")
    ...
    @OriginalMember(owner = "client!JDPRJRPB", name = "a", descriptor = "(III)LMUKVLYLC;")
    ...
    @OriginalMember(owner = "client!JDPRJRPB", name = "b", descriptor = "(LMUKVLYLC;Z)V")
    ...
    @OriginalMember(owner = "client!JDPRJRPB", name = "a", descriptor = "(Z)I")
    ...
    @OriginalMember(owner = "client!JDPRJRPB", name = "a", descriptor = "(IB)LMUKVLYLC;")
    ...
    @OriginalMember(owner = "client!JDPRJRPB", name = "a", descriptor = "(I)I")
