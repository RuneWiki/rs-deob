...
public class class25 extends class187 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IBLqk;)V", line = 41)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(ZB)V", line = 57)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Lhk;Lol;)V", line = 88)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Z)V", line = 111)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IZI)V", line = 134)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(I)Z", line = 174)
    public final boolean method171(int arg0) {
        ++field500;
        return arg0 != 20220 ? false : this.field498;
    }

    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IZ)V", line = 189)
