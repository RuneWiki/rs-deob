...
public class class25 {
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IB)Lkca;", line = 3)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!fba", name = "b", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!fba", name = "b", descriptor = "(IB)V", line = 83)
    ...
    @OriginalMember(owner = "client!fba", name = "b", descriptor = "(B)V", line = 100)
    ...
    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "(Lsaa;ILfp;)V", line = 119)
