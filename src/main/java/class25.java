...
public class class25 implements Runnable {
    ...
    @OriginalMember(owner = "client!JHRYTWFZ", name = "g", descriptor = "LTFSZPSRF;")
    ...
    @OriginalMember(owner = "client!JHRYTWFZ", name = "<init>", descriptor = "(Ljava/net/Socket;ILTFSZPSRF;)V")
