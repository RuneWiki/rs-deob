...
public class class25 {
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(Lig;I)V")
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(BIBIILka;II)Lka;")
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(Lig;IB)V")
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IILka;ZII)Lka;")
