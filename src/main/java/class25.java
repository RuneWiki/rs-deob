...
public class class25 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Los;)V", line = 5)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "()V", line = 11)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(I)I", line = 23)
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "()V", line = 40)
    public class25() {
        this.field178[0] = 0;
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(Los;)V", line = 56)
