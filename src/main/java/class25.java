...
public class class25 extends class121 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(IIIIIIIZ)V", line = 20)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(ILjava/lang/String;Ljava/io/File;)V", line = 67)
