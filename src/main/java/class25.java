...
public class class25 {
    ...
    @OriginalMember(owner = "client!GJBKSAZL", name = "b", descriptor = "LDNFIVRJB;")
    private class15 field759;

    @OriginalMember(owner = "client!GJBKSAZL", name = "c", descriptor = "LDNFIVRJB;")
    private class15 field760;

    @OriginalMember(owner = "client!GJBKSAZL", name = "d", descriptor = "LDNFIVRJB;")
    private class15 field761;

    @OriginalMember(owner = "client!GJBKSAZL", name = "e", descriptor = "LDNFIVRJB;")
    private class15 field762;

    @OriginalMember(owner = "client!GJBKSAZL", name = "f", descriptor = "LDNFIVRJB;")
    private class15 field763;

    @OriginalMember(owner = "client!GJBKSAZL", name = "g", descriptor = "LDNFIVRJB;")
    private class15 field764;

    @OriginalMember(owner = "client!GJBKSAZL", name = "h", descriptor = "LDNFIVRJB;")
    private class15 field765;

    @OriginalMember(owner = "client!GJBKSAZL", name = "i", descriptor = "LDNFIVRJB;")
    private class15 field766;

    @OriginalMember(owner = "client!GJBKSAZL", name = "p", descriptor = "LDNFIVRJB;")
    private class15 field773;

    @OriginalMember(owner = "client!GJBKSAZL", name = "o", descriptor = "LDRRJWDRT;")
    ...
    @OriginalMember(owner = "client!GJBKSAZL", name = "a", descriptor = "(LCFARFRSG;I)V")
