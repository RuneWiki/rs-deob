...
@OriginalClass("client!JQOEJEDB")
public class class25 {

    @OriginalMember(owner = "client!JQOEJEDB", name = "a", descriptor = "I")
    private int field990 = 3;

    @OriginalMember(owner = "client!JQOEJEDB", name = "b", descriptor = "I")
    private int field991 = 8;

    @OriginalMember(owner = "client!JQOEJEDB", name = "c", descriptor = "Z")
    private boolean field992 = false;

    @OriginalMember(owner = "client!JQOEJEDB", name = "e", descriptor = "LAIZKCREI;")
    public class1 field994 = new class1();

    @OriginalMember(owner = "client!JQOEJEDB", name = "d", descriptor = "I")
    private int field993;

    @OriginalMember(owner = "client!JQOEJEDB", name = "f", descriptor = "LAIZKCREI;")
    private class1 field995;

    @OriginalMember(owner = "client!JQOEJEDB", name = "<init>", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!JQOEJEDB", name = "a", descriptor = "(LAIZKCREI;)V")
    ...
    @OriginalMember(owner = "client!JQOEJEDB", name = "a", descriptor = "(ILAIZKCREI;)V")
    ...
    @OriginalMember(owner = "client!JQOEJEDB", name = "a", descriptor = "()LAIZKCREI;")
    ...
    @OriginalMember(owner = "client!JQOEJEDB", name = "b", descriptor = "()LAIZKCREI;")
    ...
    @OriginalMember(owner = "client!JQOEJEDB", name = "a", descriptor = "(I)LAIZKCREI;")
    ...
    @OriginalMember(owner = "client!JQOEJEDB", name = "b", descriptor = "(I)LAIZKCREI;")
    ...
    @OriginalMember(owner = "client!JQOEJEDB", name = "a", descriptor = "(Z)LAIZKCREI;")
    ...
    @OriginalMember(owner = "client!JQOEJEDB", name = "c", descriptor = "()V")
