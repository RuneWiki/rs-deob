...
public class class25 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(ZILjava/lang/String;BLjava/lang/String;)V", line = 46)
