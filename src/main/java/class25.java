...
public class class25 extends class276 {
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(Lmd;)Laaa;", line = 10)
    ...
    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
