...
public class class25 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ZLkh;)V", line = 7)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(BILkh;)V", line = 28)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Luo;B)Lsg;", line = 168)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IIZ)Ljava/lang/String;", line = 236)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(I)V", line = 255)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ZZLuo;)Lsg;", line = 280)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(II)V", line = 316)
    ...
    @OriginalMember(owner = "client!be", name = "b", descriptor = "(I)V", line = 349)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(B)Z", line = 392)
