...
public class class25 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "()Ljj;", line = 5)
    ...
    @OriginalMember(owner = "client!rk", name = "b", descriptor = "()[B", line = 12)
    ...
    @OriginalMember(owner = "client!rk", name = "c", descriptor = "()I", line = 73)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(Lfo;II)Lrk;", line = 120)
    ...
    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "(Lug;)V", line = 129)
    ...
    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "()V", line = 149)
    private class25() {
    }
}
