...
public class class25 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(B)I", line = 20)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IIB)V", line = 36)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(Ljava/lang/String;ILug;I)Lti;", line = 58)
    ...
    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(IIB)Z", line = 91)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(III)V", line = 178)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(Lya;IILc;III[[[B[I[I[I[I[IIBIIZ)V", line = 191)
