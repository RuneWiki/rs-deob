...
public class class25 {
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(Lda;)V", line = 39)
    public class25(class420 arg0) {
        this.field213 = arg0;
    }

    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(Lda;Lne;)V", line = 50)
    public class25(class420 arg0, class166 arg1) {
        this.field214 = arg1;
        this.field213 = arg0;
    }

    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(II)I", line = 20)
