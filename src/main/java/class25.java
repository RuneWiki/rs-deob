...
@OriginalClass("client!IEGUBMVC")
public class class25 {

    @OriginalMember(owner = "client!IEGUBMVC", name = "a", descriptor = "Z")
    private boolean field830 = false;

    @OriginalMember(owner = "client!IEGUBMVC", name = "f", descriptor = "I")
    public int field835 = 65000;

    @OriginalMember(owner = "client!IEGUBMVC", name = "e", descriptor = "I")
    public int field834;

    @OriginalMember(owner = "client!IEGUBMVC", name = "c", descriptor = "Ljava/io/RandomAccessFile;")
    public RandomAccessFile field832;

    @OriginalMember(owner = "client!IEGUBMVC", name = "d", descriptor = "Ljava/io/RandomAccessFile;")
    public RandomAccessFile field833;

    @OriginalMember(owner = "client!IEGUBMVC", name = "b", descriptor = "[B")
    public static byte[] field831 = new byte[520];

    @OriginalMember(owner = "client!IEGUBMVC", name = "<init>", descriptor = "(Ljava/io/RandomAccessFile;Ljava/io/RandomAccessFile;ZII)V")
    ...
    @OriginalMember(owner = "client!IEGUBMVC", name = "a", descriptor = "(II)[B")
    ...
    @OriginalMember(owner = "client!IEGUBMVC", name = "a", descriptor = "(IB[BI)Z")
    ...
    @OriginalMember(owner = "client!IEGUBMVC", name = "a", descriptor = "([BIZII)Z")
    ...
    @OriginalMember(owner = "client!IEGUBMVC", name = "a", descriptor = "(Ljava/io/RandomAccessFile;II)V")
