...
public class class25 {
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(I)Lefa;")
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(ILada;)V")
    ...
    @OriginalMember(owner = "client!fba", name = "b", descriptor = "(I)Lefa;")
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(Lwh;Z)V")
    ...
    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "(Lada;)V")
