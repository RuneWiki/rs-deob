...
public abstract class class25 extends class508 {
    ...
    @OriginalMember(owner = "client!as", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(II)Loj;", line = 34)
    ...
    @OriginalMember(owner = "client!as", name = "c", descriptor = "(B)V", line = 101)
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(Lgj;I)V", line = 119)
    public class25(class96 arg0, int arg1) {
        this.field381 = arg0;
        this.field376 = arg1;
    }

    @OriginalMember(owner = "client!as", name = "e", descriptor = "(B)[Lpk;", line = 131)
