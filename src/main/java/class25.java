...
public class class25 extends class186 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(CLjava/lang/String;Ljava/lang/String;I)Ljava/lang/String;", line = 16)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(BI[B)[B", line = 78)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(B)V", line = 97)
