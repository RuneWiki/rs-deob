...
public class class25 {
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(ILofa;)Ljr;")
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(IB)Ler;")
    ...
    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "(Lcr;ILla;)V")
