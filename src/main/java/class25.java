...
public class class25 implements class526 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(IB)I", line = 4)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(IZ)V", line = 24)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(II)I", line = 218)
    ...
    @OriginalMember(owner = "client!as", name = "d", descriptor = "(I)V", line = 235)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(I)V", line = 257)
    ...
    @OriginalMember(owner = "client!as", name = "b", descriptor = "(Z)V", line = 269)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/Class;Ljava/lang/Object;)Z", line = 282)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/Object;Ljava/lang/Class;)I", line = 299)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(JI)Z", line = 312)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Z)V", line = 327)
    ...
    @OriginalMember(owner = "client!as", name = "b", descriptor = "(I)I", line = 346)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Ljava/lang/Class;BLjava/lang/String;)Ljava/lang/Object;", line = 358)
    ...
    @OriginalMember(owner = "client!as", name = "c", descriptor = "(I)I", line = 373)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(B)V", line = 385)
    ...
    @OriginalMember(owner = "client!as", name = "c", descriptor = "(Z)V", line = 397)
