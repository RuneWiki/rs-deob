...
public class class25 extends class45 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(Lcu;II)V", line = 7)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(I[IB)V", line = 102)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IIIIBII)I", line = 262)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(II)[I", line = 339)
    ...
    @OriginalMember(owner = "client!rk", name = "e", descriptor = "(I)V", line = 361)
    ...
    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "()V", line = 406)
    public class25() {
        super(0, true);
    }

    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(Z)V", line = 416)
    ...
    @OriginalMember(owner = "client!rk", name = "c", descriptor = "(II)Ldj;", line = 431)
    ...
    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(Z)V", line = 471)
    ...
    @OriginalMember(owner = "client!rk", name = "d", descriptor = "(I)V", line = 500)
