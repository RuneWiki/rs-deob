...
public class class25 extends class435 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Lis;Z)V")
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IILis;I)V")
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(BLjava/awt/Canvas;Lfa;)Lr;")
