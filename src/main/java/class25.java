...
public class class25 extends class335 implements class627 {
    ...
    @OriginalMember(owner = "client!qaa", name = "<init>", descriptor = "(Lrca;IZ[[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!qaa", name = "d", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!qaa", name = "e", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 67)
    public final IDirect3DBaseTexture method153(int arg0) {
        return arg0 == 12874 ? this.field268 : (IDirect3DBaseTexture) null;
    }

    @OriginalMember(owner = "client!qaa", name = "a", descriptor = "(Llba;I)V", line = 77)
