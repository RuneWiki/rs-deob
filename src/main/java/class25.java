...
@OriginalClass("client!GXBMUAVX")
public class class25 extends class18 {

    @OriginalMember(owner = "client!GXBMUAVX", name = "t", descriptor = "I")
    private int field939 = -783;

    @OriginalMember(owner = "client!GXBMUAVX", name = "l", descriptor = "I")
    private int field931;

    @OriginalMember(owner = "client!GXBMUAVX", name = "m", descriptor = "I")
    private int field932;

    @OriginalMember(owner = "client!GXBMUAVX", name = "n", descriptor = "I")
    private int field933;

    @OriginalMember(owner = "client!GXBMUAVX", name = "v", descriptor = "I")
    private int field941;

    @OriginalMember(owner = "client!GXBMUAVX", name = "w", descriptor = "I")
    private int field942;

    @OriginalMember(owner = "client!GXBMUAVX", name = "x", descriptor = "I")
    private int field943;

    @OriginalMember(owner = "client!GXBMUAVX", name = "y", descriptor = "I")
    private int field944;

    @OriginalMember(owner = "client!GXBMUAVX", name = "q", descriptor = "LHARRRJHW;")
    private class26 field936;

    @OriginalMember(owner = "client!GXBMUAVX", name = "u", descriptor = "I")
    private int field940;

    @OriginalMember(owner = "client!GXBMUAVX", name = "r", descriptor = "I")
    private int field937;

    @OriginalMember(owner = "client!GXBMUAVX", name = "o", descriptor = "I")
    public int field934;

    @OriginalMember(owner = "client!GXBMUAVX", name = "p", descriptor = "I")
    public int field935;

    @OriginalMember(owner = "client!GXBMUAVX", name = "z", descriptor = "[I")
    public int[] field945;

    @OriginalMember(owner = "client!GXBMUAVX", name = "s", descriptor = "Lclient;")
    public static client field938;

    @OriginalMember(owner = "client!GXBMUAVX", name = "a", descriptor = "(B)LDHUPIIUL;")
    ...
    @OriginalMember(owner = "client!GXBMUAVX", name = "<init>", descriptor = "(ZIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!GXBMUAVX", name = "a", descriptor = "(Z)LUVSOAWGE;")
