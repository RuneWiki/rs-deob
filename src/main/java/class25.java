...
public class class25 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(BI)Lka;")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lfh;I)Lei;")
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(Lpt;ILum;)V")
