...
public class class25 extends class86 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ljb;I)Ljb;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ljb;ILjb;)V")
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Lei;)V")
