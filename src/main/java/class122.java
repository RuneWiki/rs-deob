...
public class class122 extends class433 implements class324 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lne;I)I")
    ...
    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "(Ldc;Lhi;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "(Ldc;Lhi;Lne;II)V")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IBII[BLhi;III)V")
    ...
    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "(Ldc;Lhi;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "(Ldc;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(II[FIIILhi;IB)V")
