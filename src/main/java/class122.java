...
public class class122 {
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(IIZII)Lva;")
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(Lcd;I)V")
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(IILcd;)V")
