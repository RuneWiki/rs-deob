...
public class class122 extends class193 {
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Ljava/awt/Frame;Lpc;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!r", name = "b", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IIZ)V", line = 41)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IIII)I", line = 73)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(CZ)B", line = 96)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Z)Z", line = 221)
    ...
    @OriginalMember(owner = "client!r", name = "b", descriptor = "(ZZ)V", line = 233)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(ZZ)V", line = 248)
    ...
    @OriginalMember(owner = "client!r", name = "<init>", descriptor = "(Lug;Lpl;)V", line = 286)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(B)V", line = 320)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lsq;II)V", line = 344)
