...
public class class122 extends class12 {
    ...
    @OriginalMember(owner = "client!ej", name = "g", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!ej", name = "h", descriptor = "(I)[Lso;", line = 23)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(ILig;Ljava/lang/String;)I", line = 39)
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 60)
    public class122(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(B)D", line = 75)
    ...
    @OriginalMember(owner = "client!ej", name = "b", descriptor = "(B)Lhe;", line = 97)
    ...
    @OriginalMember(owner = "client!ej", name = "f", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Z)V", line = 131)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V", line = 150)
