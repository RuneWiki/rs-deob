...
public class class122 extends class100 {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lza;[Lgh;Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lza;J[Lgh;[Lhv;Z)V", line = 78)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "()V", line = 87)
    private final void method961() {
        this.field2138 = false;
    }

    @OriginalMember(owner = "client!cc", name = "b", descriptor = "()V", line = 90)
    public final void method962() {
        this.field2138 = true;
    }

    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lza;J)Z", line = 94)
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "(I)V", line = 331)
    ...
    @OriginalMember(owner = "client!cc", name = "c", descriptor = "()Ld;", line = 146)
    public final class66 method964() {
        return this.field2147;
    }

    @OriginalMember(owner = "client!cc", name = "d", descriptor = "()V", line = 149)
    public static void method965() {
        field2139 = null;
        field2142 = null;
    }

    @OriginalMember(owner = "client!cc", name = "e", descriptor = "()V", line = 156)
    public final void method966() {
        this.field2151 = true;
    }

    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(J)V", line = 159)
    public final void method967(long arg0) {
        this.field2136 = arg0;
    }

    @OriginalMember(owner = "client!cc", name = "f", descriptor = "()V", line = 163)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "([Lhv;Z)V", line = 190)
    ...
    @OriginalMember(owner = "client!cc", name = "g", descriptor = "()V", line = 275)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IIIII)V", line = 295)
