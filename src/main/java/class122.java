...
public class class122 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ILgt;Ll;Ljava/awt/Canvas;II)Lza;", line = 10)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IIIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(B)Z", line = 95)
