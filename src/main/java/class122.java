...
public class class122 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IIIIB)V", line = 14)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(III)Z", line = 57)
