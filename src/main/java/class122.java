...
public class class122 extends class35 {
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IIILja;)V", line = 49)
    ...
    @OriginalMember(owner = "client!b", name = "c", descriptor = "(B)Z", line = 67)
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "(II)V", line = 94)
    ...
    @OriginalMember(owner = "client!b", name = "c", descriptor = "(II)I", line = 111)
    ...
    @OriginalMember(owner = "client!b", name = "d", descriptor = "(B)V", line = 124)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IIZIII)V", line = 199)
    ...
    @OriginalMember(owner = "client!b", name = "c", descriptor = "(I)Z", line = 216)
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(I[B)V", line = 232)
