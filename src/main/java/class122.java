...
public class class122 {
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(BI)Lsk;", line = 6)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(IBI)Z", line = 38)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!cw", name = "b", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!cw", name = "c", descriptor = "(I)V", line = 87)
    public static void method979(int arg0) {
        int var1 = -105 / ((-arg0 - 15) / 46);
        field2128 = null;
    }

    @OriginalMember(owner = "client!cw", name = "a", descriptor = "([BI)Z", line = 96)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 122)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(II)V", line = 138)
    ...
    @OriginalMember(owner = "client!cw", name = "<init>", descriptor = "(Lkp;ILph;)V", line = 157)
