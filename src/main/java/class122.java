...
public class class122 extends class216 {
    ...
    @OriginalMember(owner = "client!sfa", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!sfa", name = "c", descriptor = "(II)V", line = 22)
    ...
    @OriginalMember(owner = "client!sfa", name = "c", descriptor = "()Laca;", line = 39)
    public final class216 method531() {
        field1880++;
        return null;
    }

    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(BZ)V", line = 50)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "()Laca;", line = 61)
    public final class216 method532() {
        field1878++;
        return null;
    }

    @OriginalMember(owner = "client!sfa", name = "c", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!sfa", name = "b", descriptor = "()I", line = 82)
    public final int method552() {
        field1887++;
        return 1;
    }

    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(IID)Lgv;", line = 91)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!sfa", name = "f", descriptor = "(I)D", line = 154)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(ILgv;)V", line = 174)
    ...
    @OriginalMember(owner = "client!sfa", name = "g", descriptor = "(I)I", line = 194)
    ...
    @OriginalMember(owner = "client!sfa", name = "h", descriptor = "(I)Lgv;", line = 206)
    ...
    @OriginalMember(owner = "client!sfa", name = "<init>", descriptor = "(I)V", line = 350)
    public class122(int arg0) {
        this.field1884 = arg0;
    }

    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(Z)V", line = 233)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(ILha;B)Lit;", line = 244)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "([III)V", line = 272)
