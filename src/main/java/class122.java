...
public class class122 extends class402 {
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(ILei;)I", line = 10)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(III)V", line = 40)
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(IZ)V", line = 85)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(II)Lde;", line = 120)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(Lpc;Lod;)V", line = 172)
    ...
    @OriginalMember(owner = "client!jr", name = "c", descriptor = "(IZ)V", line = 183)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IBLfha;)V", line = 196)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(B)Z", line = 208)
    public final boolean method178(byte arg0) {
        ++field1570;
        return arg0 > -55 ? true : true;
    }

    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(I)V", line = 228)
