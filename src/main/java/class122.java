...
public class class122 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ZLsha;III)V", line = 5)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IIIIILha;II)V", line = 82)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Z)V", line = 139)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IBZ)Lrk;", line = 151)
