...
public class class122 {
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Lic;ZBIII)V")
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(BLbi;)Z")
    ...
    @OriginalMember(owner = "client!ov", name = "b", descriptor = "(BLbi;)V")
    ...
    @OriginalMember(owner = "client!ov", name = "<init>", descriptor = "(Lod;)V")
