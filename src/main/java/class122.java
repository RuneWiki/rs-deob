...
public class class122 extends class145 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(FIFFIIII)[F", line = 3)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IIFII[FIIIB)V", line = 85)
    ...
    @OriginalMember(owner = "client!hc", name = "f", descriptor = "(I)V", line = 137)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(Leca;I)V", line = 150)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "([BIIIIII)Z", line = 175)
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "()V", line = 225)
    public class122() {
        super(1, false);
    }

    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IB)V", line = 228)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IILrt;)V", line = 481)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(BI)[[I", line = 522)
    ...
    @OriginalMember(owner = "client!hc", name = "i", descriptor = "(I)V", line = 572)
    ...
    @OriginalMember(owner = "client!hc", name = "j", descriptor = "(I)V", line = 680)
