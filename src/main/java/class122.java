...
public class class122 extends class152 implements class620 {
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(IILoa;ILcq;ZI)V")
    ...
    @OriginalMember(owner = "client!aba", name = "b", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!aba", name = "<init>", descriptor = "(Loa;Lsa;IIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(Loa;II)Lba;")
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(IIIFIFFFFLjr;II[BI)V")
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(IIILwk;I)V")
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(Loa;B)Lpl;")
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(Lji;B)V")
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(IILoa;I)Z")
    ...
    @OriginalMember(owner = "client!aba", name = "d", descriptor = "(Loa;I)Lcd;")
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(ZIBLoa;)Lid;")
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!aba", name = "c", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(BLoa;I)Lba;")
    ...
    @OriginalMember(owner = "client!aba", name = "g", descriptor = "(B)V")
