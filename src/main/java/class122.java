...
public class class122 {
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "([ILrb;JB)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(II)Ltt;")
    ...
    @OriginalMember(owner = "client!dw", name = "<init>", descriptor = "(ILdda;Ldda;Lrl;)V")
