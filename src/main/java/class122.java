...
public class class122 extends class642 {
    ...
    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(BII)I", line = 5)
    ...
    @OriginalMember(owner = "client!tl", name = "<init>", descriptor = "()V", line = 21)
    public class122() {
        super(0, true);
    }

    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(II)[I", line = 24)
