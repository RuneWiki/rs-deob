...
public class class122 extends class513 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Z[I[IIZ)J", line = 3)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(IIZILjaa;Lr;IILwt;I)Lda;", line = 67)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lha;III[Z)V", line = 321)
