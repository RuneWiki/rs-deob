...
public class class122 extends class85 {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(IILbt;)V")
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Loh;)V")
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(BLbt;)V")
