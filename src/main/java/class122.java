...
public class class122 extends class337 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(II)[[I", line = 27)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Z)V", line = 113)
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "()V", line = 136)
    public class122() {
        super(1, false);
    }

    @OriginalMember(owner = "client!wp", name = "c", descriptor = "(B)V", line = 140)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(BILhp;)V", line = 150)
    ...
    @OriginalMember(owner = "client!wp", name = "i", descriptor = "(I)[Lqu;", line = 190)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IBII[BII)Z", line = 201)
