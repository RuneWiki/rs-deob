...
public class class122 implements class220 {

    @OriginalMember(owner = "client!ke", name = "a", descriptor = "Z")
    private boolean field1850 = false;

    @OriginalMember(owner = "client!ke", name = "b", descriptor = "I")
    private int field1851 = -1;

    @OriginalMember(owner = "client!ke", name = "c", descriptor = "[I")
    private int[] field1852 = null;

    @OriginalMember(owner = "client!ke", name = "a", descriptor = "()V", line = 6)
    public final void method300() {
        GL var1 = class186.field2990;
        class186.method1299(1);
        if (class269.field4250) {
            var1.glCallList(this.field1851);
        } else {
            var1.glTexEnvi(8960, 34184, 34167);
        }
    }

    @OriginalMember(owner = "client!ke", name = "d", descriptor = "()V", line = 19)
    private final void method846() {
        GL var1 = class186.field2990;
        this.field1851 = var1.glGenLists(2);
        var1.glNewList(this.field1851, 4864);
        if (this.field1852 == null) {
            ...
            if (this.field1850) {
                ...
                var1.glTexEnvi(8960, 34162, 7681);
                var1.glTexEnvi(8960, 34184, 34167);
                var1.glBindTexture(3553, class186.field2982);
                var1.glEnable(3553);
            }
            var1.glActiveTexture(33984);
        }
        var1.glEndList();
        var1.glNewList(this.field1851 + 1, 4864);
        if (this.field1852 == null) {
    ...
    @OriginalMember(owner = "client!ke", name = "e", descriptor = "()V", line = 120)
    private final void method847() {
        GL var1 = class186.field2990;
        if (this.field1852 == null) {
            this.field1852 = new int[3];
            var1.glGenTextures(3, this.field1852, 0);
        }
        short var2 = 4096;
        ...
        for (int var6 = 0; var6 < 6; var6++) {
            ...
            var1.glBindTexture(34067, this.field1852[0]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var4));
            var1.glBindTexture(34067, this.field1852[1]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var5));
            var1.glBindTexture(34067, this.field1852[2]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var3));
            class275.field4358 += var2 * 3;
        }
    }

    @OriginalMember(owner = "client!ke", name = "c", descriptor = "()V", line = 236)
    public final void method303() {
        GL var1 = class186.field2990;
        if (class269.field4250) {
            var1.glCallList(this.field1851 + 1);
        } else {
            var1.glTexEnvi(8960, 34184, 5890);
        }
    }

    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "()V", line = 271)
    public class122() {
        if (class186.field3023 && class186.field2985 >= 2) {
            this.method847();
            GL var1 = class186.field2990;
            var1.glBindTexture(34067, this.field1852[0]);
            ...
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            this.field1850 = class186.field2985 < 3;
        }
        this.method846();
    }

    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(I)V", line = 250)
    public final void method301(int arg0) {
        GL var2 = class186.field2990;
        if (class269.field4250 && this.field1852 != null) {
            var2.glActiveTexture(33985);
            var2.glBindTexture(34067, this.field1852[arg0 - 1]);
            var2.glActiveTexture(33984);
        }
    }

    @OriginalMember(owner = "client!ke", name = "b", descriptor = "()I", line = 265)
