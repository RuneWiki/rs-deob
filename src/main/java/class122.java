...
public class class122 extends class493 {
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(IZ)V", line = 24)
    ...
    @OriginalMember(owner = "client!laa", name = "c", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!laa", name = "f", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(IILbl;)V", line = 97)
    ...
    @OriginalMember(owner = "client!laa", name = "<init>", descriptor = "(Lhl;Lni;)V", line = 145)
    ...
    @OriginalMember(owner = "client!laa", name = "b", descriptor = "(I)V", line = 171)
    ...
    @OriginalMember(owner = "client!laa", name = "c", descriptor = "(B)V", line = 198)
    ...
    @OriginalMember(owner = "client!laa", name = "b", descriptor = "(B)Z", line = 216)
    ...
    @OriginalMember(owner = "client!laa", name = "b", descriptor = "(IZ)V", line = 233)
