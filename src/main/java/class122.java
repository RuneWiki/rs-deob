...
public class class122 extends class115 {
    ...
    @OriginalMember(owner = "client!qb", name = "e", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IIIBII)V", line = 17)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(III)Lka;", line = 42)
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "()V", line = 351)
    public class122() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(II)[I", line = 52)
    ...
    @OriginalMember(owner = "client!qb", name = "d", descriptor = "(I)V", line = 275)
    ...
    @OriginalMember(owner = "client!qb", name = "h", descriptor = "(I)V", line = 287)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Z)V", line = 317)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(III)Lfm;", line = 344)
    public static final class436 method692(int arg0, int arg1, int arg2) {
        class302 var3 = class19.field202[arg0][arg1][arg2];
        return var3 == null ? null : var3.field4324;
    }

    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(BLbk;I)V", line = 357)
    ...
    @OriginalMember(owner = "client!qb", name = "i", descriptor = "(I)V", line = 446)
