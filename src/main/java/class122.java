...
public class class122 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Ljagdx/IDirect3DSurface;Ljagdx/IDirect3DSwapChain;I)V")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IZ)I")
