...
public class class122 {
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(I)V", line = 24)
    public static final void method923(int arg0) {
        field1905++;
        class388.field5751.method2349(arg0);
    }

    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Z)Z", line = 32)
    ...
    @OriginalMember(owner = "client!ov", name = "b", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Lqa;ILhh;)V", line = 74)
    ...
    @OriginalMember(owner = "client!ov", name = "<init>", descriptor = "(Lqg;)V", line = 208)
    public class122(class321 arg0) {
        this.field1904 = arg0;
    }

    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Lbd;Lbd;IF)Z", line = 217)
