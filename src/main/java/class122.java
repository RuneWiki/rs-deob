...
public class class122 extends class435 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ZILjava/lang/String;)V", line = 19)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(II)I", line = 137)
    ...
    @OriginalMember(owner = "client!tl", name = "<init>", descriptor = "(II)V", line = 179)
