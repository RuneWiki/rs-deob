...
public class class122 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Lac;B)V")
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Ltg;Z)V")
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(ILr;BZ)Lf;")
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(IILac;)V")
