...
public class class122 {
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(B)Lag;")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ILag;)V")
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "(B)Lag;")
