...
public class class122 extends class220 {
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(Lro;ILfi;Ldr;Lsn;ILjava/lang/String;IIBII)V")
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IIIIIILqc;Lnr;III)Lqc;")
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "(Lnr;I)V")
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IBLil;)V")
