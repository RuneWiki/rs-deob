...
public class class122 extends class751 {
    ...
    @OriginalMember(owner = "client!ri", name = "<init>", descriptor = "()V", line = 163)
    public class122() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ZI)V", line = 9)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(II)[I", line = 27)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ILrv;I)V", line = 113)
