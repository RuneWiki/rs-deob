...
public abstract class class122 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(II[I[II)V", line = 39)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(B)V", line = 94)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(II)V", line = 111)
