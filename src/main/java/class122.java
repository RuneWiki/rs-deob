...
public class class122 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Luq;IJ)V")
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IJ)Luq;")
    ...
    @OriginalMember(owner = "client!bk", name = "b", descriptor = "(I)Luq;")
