...
public class class122 extends class271 {
    ...
    @OriginalMember(owner = "client!gp", name = "g", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!gp", name = "d", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!gp", name = "e", descriptor = "(I)I", line = 35)
    ...
    @OriginalMember(owner = "client!gp", name = "f", descriptor = "(I)I", line = 48)
    ...
    @OriginalMember(owner = "client!gp", name = "c", descriptor = "(B)J", line = 61)
