...
public class class122 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Ltq;I)Lri;")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IIBI)Llo;")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Ljava/lang/String;Ltq;I)I")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Ljava/lang/String;Lam;IZ)Lpm;")
