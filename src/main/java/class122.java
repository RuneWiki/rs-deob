...
public class class122 extends class138 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Loa;)V", line = 11)
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(I)V", line = 96)
    public class122(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qe", name = "e", descriptor = "(Z)Z", line = 103)
    ...
    @OriginalMember(owner = "client!qe", name = "y", descriptor = "(I)V", line = 120)
    public final void method745(int arg0) {
        ++field1570;
        this.field1574 = super.field1745 * arg0;
    }

    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(B[BII)V", line = 128)
    ...
    @OriginalMember(owner = "client!qe", name = "m", descriptor = "(II)I", line = 145)
    ...
    @OriginalMember(owner = "client!qe", name = "i", descriptor = "(B)I", line = 158)
    ...
    @OriginalMember(owner = "client!qe", name = "n", descriptor = "(II)V", line = 175)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "([IB)V", line = 189)
    ...
    @OriginalMember(owner = "client!qe", name = "z", descriptor = "(I)V", line = 201)
    ...
    @OriginalMember(owner = "client!qe", name = "o", descriptor = "(II)I", line = 213)
