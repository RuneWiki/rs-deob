...
public class class122 {
    ...
    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "(Lqfa;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "(Lqfa;Ljaclib/memory/Buffer;)V", line = 21)
