...
public abstract class class122 extends class406 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IBI)I", line = 3)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IBIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(ZI)V", line = 53)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lmm;III[Z)V", line = 73)
