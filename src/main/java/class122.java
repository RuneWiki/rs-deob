...
public class class122 {
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "([BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(Lmh;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(Lmh;Ljaclib/memory/Buffer;)V", line = 21)
