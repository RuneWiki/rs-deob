...
public class class122 {
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(III)I", line = 5)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Lcea;)V", line = 28)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "()V", line = 89)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(II)[I", line = 123)
