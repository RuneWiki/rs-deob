...
public class class122 {
    ...
    @OriginalMember(owner = "na", name = "a", descriptor = "([III)V")
    ...
    @OriginalMember(owner = "na", name = "a", descriptor = "([IIII)V")
    ...
    @OriginalMember(owner = "na", name = "a", descriptor = "([BI[BII)V")
    public static final void method878(byte[] arg0, int arg1, byte[] arg2, int arg3, int arg4) {
        if (arg0 == arg2) {
            if (arg1 == arg3) {
                return;
            }
    ...
    @OriginalMember(owner = "na", name = "a", descriptor = "([II[III)V")
