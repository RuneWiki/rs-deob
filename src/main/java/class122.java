...
public class class122 {
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Ldk;I)V")
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Lsl;II)V")
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Ldk;)V")
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Lsj;I)V")
