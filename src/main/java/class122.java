...
public class class122 extends class508 {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Lqfa;III)Lit;")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Ltba;B)V")
    ...
    @OriginalMember(owner = "client!ud", name = "<init>", descriptor = "(Lod;)V")
