...
public class class122 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIIIIIB)V", line = 16)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(I)Lfi;", line = 68)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(BLat;)V", line = 96)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIII)V", line = 115)
    ...
    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "()V", line = 143)
    public class122() {
    }

    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "(Lat;)V", line = 149)
    public class122(class412 arg0) {
        this.field1686 = arg0;
    }

    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(I)Lfi;", line = 157)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIIII)I", line = 178)
