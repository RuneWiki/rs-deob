...
public class class122 extends class195 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IIII)I", line = 4)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IBI)Z", line = 28)
    ...
    @OriginalMember(owner = "client!ri", name = "d", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(BIIIIII)V", line = 73)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(III)V", line = 511)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(I)V", line = 526)
    ...
    @OriginalMember(owner = "client!ri", name = "c", descriptor = "(I)V", line = 559)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Lka;IIII)Lln;", line = 571)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IIIII)V", line = 589)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Z)V", line = 609)
    ...
    @OriginalMember(owner = "client!ri", name = "<init>", descriptor = "(Lee;II)V", line = 665)
