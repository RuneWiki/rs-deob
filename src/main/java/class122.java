...
public class class122 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(B)Lfe;", line = 3)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IJ)V", line = 56)
    ...
    @OriginalMember(owner = "client!wp", name = "b", descriptor = "(I)I", line = 139)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Z)Lfe;", line = 168)
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "()V", line = 251)
    public class122() {
        this.field1905.field5794 = this.field1905;
        this.field1905.field5792 = this.field1905;
    }

    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Lfe;I)V", line = 196)
    ...
    @OriginalMember(owner = "client!wp", name = "b", descriptor = "(Z)Z", line = 216)
    ...
    @OriginalMember(owner = "client!wp", name = "c", descriptor = "(I)Lfe;", line = 228)
    ...
    @OriginalMember(owner = "client!wp", name = "d", descriptor = "(I)Lfe;", line = 261)
