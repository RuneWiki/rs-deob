...
public class class574 extends class633 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!a", name = "<init>", descriptor = "([Lej;)V", line = 21)
    public class574(class108[] arg0) {
        this.field8184 = arg0;
    }

    @OriginalMember(owner = "client!a", name = "b", descriptor = "(B)V", line = 32)
