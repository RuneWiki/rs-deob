...
public class class574 {
    ...
    @OriginalMember(owner = "client!gi", name = "b", descriptor = "(I)Lhm;")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IBII)Lgi;")
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(Lgi;I)V")
