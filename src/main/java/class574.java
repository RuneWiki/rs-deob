...
public class class574 {
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(ILvc;)V")
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(Lpha;B)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(ILjava/lang/Object;Lpha;)V")
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(Lpha;I)V")
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(BLwq;II)V")
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(IIBLcb;ZII)V")
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(IILjava/lang/Object;Lpha;)V")
