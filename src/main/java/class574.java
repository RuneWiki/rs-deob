...
public class class574 extends class148 {
    ...
    @OriginalMember(owner = "client!gba", name = "b", descriptor = "(ZI)V", line = 8)
    ...
    @OriginalMember(owner = "client!gba", name = "x", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!gba", name = "y", descriptor = "(I)Z", line = 34)
    ...
    @OriginalMember(owner = "client!gba", name = "z", descriptor = "(I)V", line = 51)
    public final void method3416(int arg0) {
        this.field8451 = super.field2177 * arg0;
        ++field8446;
    }

    @OriginalMember(owner = "client!gba", name = "e", descriptor = "(IB)I", line = 71)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(I[BII)V", line = 101)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(B[I)V", line = 118)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IILkda;ZIII)V", line = 132)
    ...
    @OriginalMember(owner = "client!gba", name = "A", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!gba", name = "B", descriptor = "(I)I", line = 176)
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(I)V", line = 193)
    public class574(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!gba", name = "p", descriptor = "(II)I", line = 197)
