...
public class class574 {
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(III)I", line = 9)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Lha;Ld;I)V", line = 69)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(ILjava/lang/String;)V", line = 299)
    ...
    @OriginalMember(owner = "client!bfa", name = "toString", descriptor = "()Ljava/lang/String;", line = 332)
