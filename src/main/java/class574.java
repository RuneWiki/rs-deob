...
public abstract class class574 extends class650 {
    ...
    @OriginalMember(owner = "client!lea", name = "t", descriptor = "()Ltaa;", line = 5)
    public final class379 method317() {
        return new class379(0, "Pure Java", 1, "CPU", 0L);
    }

    @OriginalMember(owner = "client!lea", name = "a", descriptor = "([IIIII)Lxa;", line = 11)
    ...
    @OriginalMember(owner = "client!lea", name = "s", descriptor = "()V", line = 48)
    ...
    @OriginalMember(owner = "client!lea", name = "AA", descriptor = "(IIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!lea", name = "j", descriptor = "()Z", line = 63)
    public final boolean method434() {
        return false;
    }

    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(IIZ)Lxa;", line = 66)
    ...
    @OriginalMember(owner = "client!lea", name = "d", descriptor = "(I)V", line = 72)
    public void method494(int arg0) {
        this.field7366[arg0].method3775(105, Thread.currentThread());
    }

    @OriginalMember(owner = "client!lea", name = "y", descriptor = "()Z", line = 75)
    public final boolean method466() {
        return true;
    }

    @OriginalMember(owner = "client!lea", name = "E", descriptor = "()Z", line = 78)
    public final boolean method404() {
        return false;
    }

    @OriginalMember(owner = "client!lea", name = "x", descriptor = "()Lq;", line = 82)
    public final class396 method431() {
        return new class538();
    }

    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(II)I", line = 85)
    public final int method469(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!lea", name = "ca", descriptor = "(IIII)V", line = 89)
    ...
    @OriginalMember(owner = "client!lea", name = "v", descriptor = "()I", line = 108)
    public final int method429() {
        return 0;
    }

    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(IIIIIILfa;II)V", line = 112)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(Liba;Z)Lxa;", line = 351)
    ...
    @OriginalMember(owner = "client!lea", name = "b", descriptor = "()Z", line = 454)
    public final boolean method422() {
        return false;
    }

    @OriginalMember(owner = "client!lea", name = "b", descriptor = "(Li;)V", line = 456)
    public final void method489(class37 arg0) {
    }

    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(Lub;[Liba;Z)Lta;", line = 461)
    ...
    @OriginalMember(owner = "client!lea", name = "D", descriptor = "()Z", line = 498)
    public final boolean method492() {
        return false;
    }

    @OriginalMember(owner = "client!lea", name = "<init>", descriptor = "(Le;)V", line = 501)
    ...
    @OriginalMember(owner = "client!lea", name = "b", descriptor = "(IIIIII)Lip;", line = 510)
    public final class662 method483(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!lea", name = "ka", descriptor = "(FF)V", line = 513)
    ...
    @OriginalMember(owner = "client!lea", name = "c", descriptor = "(I)[I", line = 519)
    ...
    @OriginalMember(owner = "client!lea", name = "f", descriptor = "(I)Li;", line = 539)
    public final class37 method468(int arg0) {
        return null;
    }

    @OriginalMember(owner = "client!lea", name = "m", descriptor = "()Z", line = 543)
    public final boolean method361() {
        return false;
    }

    @OriginalMember(owner = "client!lea", name = "l", descriptor = "()V", line = 545)
    public final void method325() {
    }

    @OriginalMember(owner = "client!lea", name = "h", descriptor = "(I)I", line = 549)
    public final int method3104(int arg0) {
        return super.field8781.method2718(arg0, (byte) 72).field1825 & 65535;
    }

    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(IIII)V", line = 554)
    public final void method379(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!lea", name = "FA", descriptor = "(IIIIII)Z", line = 558)
    ...
    @OriginalMember(owner = "client!lea", name = "aa", descriptor = "()I", line = 590)
    ...
    @OriginalMember(owner = "client!lea", name = "d", descriptor = "(Ljava/awt/Canvas;)V", line = 595)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(Z)V", line = 605)
    public final void method482(boolean arg0) {
        this.field7369 = arg0;
        this.field7337.method1218(116);
    }

    @OriginalMember(owner = "client!lea", name = "b", descriptor = "(Z)V", line = 608)
    public final void method388(boolean arg0) {
    }

    @OriginalMember(owner = "client!lea", name = "w", descriptor = "()V", line = 610)
    public final void method327() {
    }

    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(II[I[I)Lfa;", line = 613)
    public final class219 method400(int arg0, int arg1, int[] arg2, int[] arg3) {
        return new class2(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!lea", name = "m", descriptor = "(IIII)V", line = 619)
    ...
    @OriginalMember(owner = "client!lea", name = "i", descriptor = "(I)Z", line = 626)
    public final boolean method3105(int arg0) {
        return super.field8781.method2718(arg0, (byte) 72).field1811;
    }

    @OriginalMember(owner = "client!lea", name = "c", descriptor = "()Z", line = 629)
    public final boolean method488() {
        return false;
    }

    @OriginalMember(owner = "client!lea", name = "A", descriptor = "()V", line = 631)
    public final void method312() {
    }

    @OriginalMember(owner = "client!lea", name = "C", descriptor = "()Z", line = 634)
    public final boolean method424() {
        return true;
    }

    @OriginalMember(owner = "client!lea", name = "o", descriptor = "()V", line = 637)
    ...
    @OriginalMember(owner = "client!lea", name = "d", descriptor = "()V", line = 652)
    public final void method374() {
    }

    @OriginalMember(owner = "client!lea", name = "c", descriptor = "(Z)V", line = 657)
    public void method455(boolean arg0) {
    }

    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(FFF)V", line = 659)
    public final void method391(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(I[Lbj;)V", line = 662)
    public final void method473(int arg0, class227[] arg1) {
    }

    @OriginalMember(owner = "client!lea", name = "na", descriptor = "(III[I)V", line = 666)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 692)
    ...
    @OriginalMember(owner = "client!lea", name = "SA", descriptor = "()I", line = 722)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(Lq;)V", line = 728)
    public final void method490(class396 arg0) {
        this.field7353 = (class538) arg0;
    }

    @OriginalMember(owner = "client!lea", name = "YA", descriptor = "(IFFFFF)V", line = 731)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(I)V", line = 739)
    public final void method444(int arg0) {
    }

    @OriginalMember(owner = "client!lea", name = "h", descriptor = "()V", line = 743)
    ...
    @OriginalMember(owner = "client!lea", name = "H", descriptor = "()Z", line = 756)
    public final boolean method3106() {
        return this.field7334;
    }

    @OriginalMember(owner = "client!lea", name = "p", descriptor = "()Z", line = 760)
    public final boolean method465() {
        return false;
    }

    @OriginalMember(owner = "client!lea", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 764)
    ...
    @OriginalMember(owner = "client!lea", name = "e", descriptor = "(I)V", line = 774)
    ...
    @OriginalMember(owner = "client!lea", name = "D", descriptor = "(I)V", line = 807)
    public final void method315(int arg0) {
        this.method475(0, 0, this.field7339, this.field7373, arg0, 0);
    }

    @OriginalMember(owner = "client!lea", name = "IA", descriptor = "()I", line = 815)
    public final int method461() {
        return this.field7356;
    }

    @OriginalMember(owner = "client!lea", name = "h", descriptor = "(IIIII)V", line = 818)
    ...
    @OriginalMember(owner = "client!lea", name = "sa", descriptor = "(II)V", line = 1105)
    ...
    @OriginalMember(owner = "client!lea", name = "z", descriptor = "()Z", line = 1111)
    public final boolean method393() {
        return false;
    }

    @OriginalMember(owner = "client!lea", name = "k", descriptor = "()V", line = 1114)
    public final void method409() {
        this.field7372 = this.field7346;
        this.field7343 = false;
    }

    @OriginalMember(owner = "client!lea", name = "j", descriptor = "(I)Z", line = 1118)
    public final boolean method3107(int arg0) {
        return super.field8781.method2717(arg0, false);
    }

    @OriginalMember(owner = "client!lea", name = "b", descriptor = "(II)I", line = 1121)
    public final int method493(int arg0, int arg1) {
        int var3 = arg0 | 133120;
        return var3 & arg1 ^ arg1;
    }

    @OriginalMember(owner = "client!lea", name = "<init>", descriptor = "(Ljava/awt/Canvas;Le;)V", line = 1125)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(IIIIIF)Lbj;", line = 1130)
    public final class227 method436(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        return null;
    }

    @OriginalMember(owner = "client!lea", name = "q", descriptor = "()Lq;", line = 1134)
    public final class396 method470() {
        class683 var1 = this.method937(Thread.currentThread());
        return var1.field9306;
    }

    @OriginalMember(owner = "client!lea", name = "k", descriptor = "(I)[I", line = 1139)
    ...
    @OriginalMember(owner = "client!lea", name = "c", descriptor = "(IIIIII)V", line = 1159)
    ...
    @OriginalMember(owner = "client!lea", name = "ma", descriptor = "(IIIIII[BII)V", line = 1372)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(Lig;)V", line = 1548)
    ...
    @OriginalMember(owner = "client!lea", name = "JA", descriptor = "(I)V", line = 1583)
    public final void method442(int arg0) {
    }

    @OriginalMember(owner = "client!lea", name = "l", descriptor = "(I)Z", line = 1586)
    public final boolean method3109(int arg0) {
        return this.field7369 || super.field8781.method2718(arg0, (byte) 72).field1826;
    }

    @OriginalMember(owner = "client!lea", name = "I", descriptor = "()V", line = 1592)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "()Z", line = 1613)
    public final boolean method471() {
        return false;
    }

    @OriginalMember(owner = "client!lea", name = "g", descriptor = "()Z", line = 1620)
    public final boolean method481() {
        return true;
    }

    @OriginalMember(owner = "client!lea", name = "KA", descriptor = "(IIII)[I", line = 1624)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(Lip;)V", line = 1648)
    public final void method458(class662 arg0) {
    }

    @OriginalMember(owner = "client!lea", name = "n", descriptor = "()I", line = 1651)
    public final int method430() {
        return 0;
    }

    @OriginalMember(owner = "client!lea", name = "ya", descriptor = "(IIIII)V", line = 1657)
    ...
    @OriginalMember(owner = "client!lea", name = "L", descriptor = "(ILfa;II)V", line = 1734)
    ...
    @OriginalMember(owner = "client!lea", name = "Q", descriptor = "(IIII)V", line = 1792)
    ...
    @OriginalMember(owner = "client!lea", name = "C", descriptor = "(IIIIII)V", line = 1807)
    ...
    @OriginalMember(owner = "client!lea", name = "F", descriptor = "()V", line = 1942)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(Lba;Lig;Lq;Lpo;I)V", line = 1961)
    ...
    @OriginalMember(owner = "client!lea", name = "ha", descriptor = "(F)V", line = 1975)
    public final void method449(float arg0) {
        this.field7370 = (int) (arg0 * 65535.0F);
    }

    @OriginalMember(owner = "client!lea", name = "U", descriptor = "()I", line = 1981)
    public final int method423() {
        return this.field7351;
    }

    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(Lip;Lip;FLip;)Lip;", line = 1987)
    public final class662 method351(class662 arg0, class662 arg1, float arg2, class662 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!lea", name = "f", descriptor = "()Z", line = 1992)
    public final boolean method432() {
        return false;
    }

    @OriginalMember(owner = "client!lea", name = "e", descriptor = "()Z", line = 1996)
    public final boolean method477() {
        return true;
    }

    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(IIIIZ)Lxa;", line = 2001)
    ...
    @OriginalMember(owner = "client!lea", name = "e", descriptor = "(IIIII)V", line = 2048)
    ...
    @OriginalMember(owner = "client!lea", name = "X", descriptor = "(III)V", line = 2136)
    ...
    @OriginalMember(owner = "client!lea", name = "B", descriptor = "()V", line = 2159)
    public void method322() {
    }

    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(IIIIII)V", line = 2166)
    ...
    @OriginalMember(owner = "client!lea", name = "i", descriptor = "()V", line = 2187)
    public final void method401() {
        this.field7337.method1218(102);
        this.field7361.method1218(125);
    }

    @OriginalMember(owner = "client!lea", name = "LA", descriptor = "(IIII)V", line = 2192)
    ...
    @OriginalMember(owner = "client!lea", name = "A", descriptor = "([I)V", line = 2199)
