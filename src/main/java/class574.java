...
public class class574 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IILbba;)V", line = 3)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IIIIIIIIIII)V", line = 132)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IIBI)Z", line = 152)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(ILjp;)V", line = 182)
    ...
    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 235)
