...
public class class574 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BI)V", line = 4)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 25)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IZ)V", line = 90)
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(IZ)Low;", line = 111)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(II)V", line = 144)
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(B)V", line = 166)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BJ)V", line = 186)
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "(Lqg;IZLvd;Lvd;)V", line = 265)
