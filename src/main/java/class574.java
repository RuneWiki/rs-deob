...
public class class574 extends class145 {
    ...
    @OriginalMember(owner = "client!dv", name = "<init>", descriptor = "()V", line = 3)
    public class574() {
        super(1, true);
    }

    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(ZI)[I", line = 27)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IILrt;)V", line = 69)
