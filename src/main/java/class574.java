...
public class class574 extends class56 implements class269 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ILqa;Z)Lr;")
    ...
    @OriginalMember(owner = "client!pc", name = "c", descriptor = "(ILqa;)Loj;")
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(ILqa;)Lso;")
    public final class398 method328(int arg0, class206 arg1) {
        field8396++;
        return arg0 == 12 ? this.field8385.method328(12, arg1) : null;
    }

    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ZLqa;)V")
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lqa;Z)V")
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(IIIIILqn;)V")
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ILqa;II)Z")
