...
public class class574 extends class299 {
    ...
    @OriginalMember(owner = "client!ea", name = "c", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ea", name = "d", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(III)Z", line = 36)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(Z)I", line = 47)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(ILes;)V", line = 60)
    public class574(int arg0, class404 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IZ)V", line = 99)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Les;)V", line = 113)
    public class574(class404 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(II)I", line = 116)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(I)I", line = 149)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(BII)Z", line = 166)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(I)V", line = 181)
