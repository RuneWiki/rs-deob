...
public class class574 extends Canvas {
    ...
    @OriginalMember(owner = "client!nea", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 3)
    public final void update(Graphics arg0) {
        this.field8013.update(arg0);
        field8016++;
    }

    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "([BBZ)Ljava/lang/Object;", line = 39)
    ...
    @OriginalMember(owner = "client!nea", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 73)
    public final void paint(Graphics arg0) {
        field8015++;
        this.field8013.paint(arg0);
    }

    @OriginalMember(owner = "client!nea", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 84)
