...
public abstract class class574 implements class686 {
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!mfa", name = "d", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(I[BIII)V", line = 50)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(IZ)V", line = 150)
    ...
    @OriginalMember(owner = "client!mfa", name = "e", descriptor = "(I)I", line = 164)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(Ldj;B)V", line = 264)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(II[III)V", line = 283)
    ...
    @OriginalMember(owner = "client!mfa", name = "f", descriptor = "(I)I", line = 389)
    ...
    @OriginalMember(owner = "client!mfa", name = "finalize", descriptor = "()V", line = 402)
    ...
    @OriginalMember(owner = "client!mfa", name = "b", descriptor = "(Z)V", line = 411)
    ...
    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "(Lmr;ILsq;Lrt;IZ)V", line = 539)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "([FIIII)V", line = 440)
