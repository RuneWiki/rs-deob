...
public class class574 implements class116 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IIIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(BLvo;II)V", line = 71)
    ...
    @OriginalMember(owner = "client!op", name = "toString", descriptor = "()Ljava/lang/String;", line = 95)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 112)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(I)V", line = 126)
