...
public class class574 {
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(BII)Z", line = 74)
    ...
    @OriginalMember(owner = "client!lba", name = "b", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(Z)Lal;", line = 102)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(JI)Lal;", line = 133)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(JLal;B)V", line = 165)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(III)V", line = 186)
    ...
    @OriginalMember(owner = "client!lba", name = "<init>", descriptor = "(I)V", line = 202)
