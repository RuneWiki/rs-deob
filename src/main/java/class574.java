...
public class class574 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Lgk;I)V", line = 14)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Lgk;Lmh;I)Lnda;", line = 35)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ZIB)V", line = 83)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(III)Z", line = 109)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(I)V", line = 124)
