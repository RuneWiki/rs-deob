...
public abstract class class574 extends class388 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Lsl;Z)Lnaa;", line = 3)
    ...
    @OriginalMember(owner = "client!qd", name = "d", descriptor = "(I)Luea;", line = 33)
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lut;I)V", line = 62)
