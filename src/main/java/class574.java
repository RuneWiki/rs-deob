...
public class class574 extends class424 {
    ...
    @OriginalMember(owner = "client!ul", name = "E", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ul", name = "c", descriptor = "()Z", line = 16)
    public final boolean method442() {
        return false;
    }

    @OriginalMember(owner = "client!ul", name = "J", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!ul", name = "f", descriptor = "()V", line = 54)
    public final void method466() {
    }

    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(ZI)V", line = 57)
    ...
    @OriginalMember(owner = "client!ul", name = "e", descriptor = "(Z)V", line = 68)
    ...
    @OriginalMember(owner = "client!ul", name = "d", descriptor = "()V", line = 77)
    public final void method444() {
    }

    @OriginalMember(owner = "client!ul", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Ld;Lnd;Ljava/lang/Integer;)Lha;", line = 81)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IIIIIZLet;[B)Lwk;", line = 179)
    ...
    @OriginalMember(owner = "client!ul", name = "GA", descriptor = "(I)V", line = 190)
    public final void method462(int arg0) {
        this.field8080.Clear(1, arg0, 0.0F, 0);
    }

    @OriginalMember(owner = "client!ul", name = "eb", descriptor = "(I)V", line = 199)
    ...
    @OriginalMember(owner = "client!ul", name = "R", descriptor = "(I)V", line = 236)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lwha;Let;Z)I", line = 252)
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/gca;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Lmu;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Ld;Lnd;I)V", line = 288)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 335)
    public final void method432(Rectangle[] arg0, int arg1, int arg2, int arg3) throws class230 {
        this.method497(arg2, arg3);
    }

    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(FFF)V", line = 343)
    public final void method463(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!ul", name = "t", descriptor = "(B)V", line = 346)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IILjv;Liaa;ZII)V", line = 365)
    ...
    @OriginalMember(owner = "client!ul", name = "m", descriptor = "()V", line = 384)
    public final void method479() {
    }

    @OriginalMember(owner = "client!ul", name = "I", descriptor = "()I", line = 387)
    public final int method440() {
        return 0;
    }

    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(I[BIILet;I)Laga;", line = 395)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILjv;)I", line = 405)
    ...
    @OriginalMember(owner = "client!ul", name = "g", descriptor = "(Z)V", line = 438)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lhca;Llda;)Lnl;", line = 448)
    public final class554 method464(class492 arg0, class488 arg1) {
        return null;
    }

    @OriginalMember(owner = "client!ul", name = "i", descriptor = "(B)V", line = 456)
    public final void method2027(byte arg0) {
        int var2 = -14 % ((arg0 - 74) / 33);
        this.field8080.method2870(15, this.field5627);
    }

    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lwha;IIBLet;)Lwk;", line = 464)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Z[IIBIII)Lwk;", line = 475)
    ...
    @OriginalMember(owner = "client!ul", name = "g", descriptor = "(B)V", line = 485)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILri;)V", line = 495)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Ljava/lang/Object;Ljava/awt/Canvas;Z)V", line = 506)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Let;BLwha;)Z", line = 516)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Ljava/awt/Canvas;Ljava/lang/Object;I)V", line = 528)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILia;B)V", line = 539)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IILet;ZI[FIZ)Lwk;", line = 550)
    ...
    @OriginalMember(owner = "client!ul", name = "e", descriptor = "()V", line = 561)
    public final void method459() {
        this.field8058.method3804(22591);
        super.method459();
    }

    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Let;Lwha;Z)Z", line = 570)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lmb;I)V", line = 581)
    ...
    @OriginalMember(owner = "client!ul", name = "ya", descriptor = "()V", line = 621)
    public final void method512() {
        this.method2385(-58, true);
        this.field8080.Clear(2, 0, 1.0F, 0);
    }

    @OriginalMember(owner = "client!ul", name = "k", descriptor = "(B)V", line = 629)
    ...
    @OriginalMember(owner = "client!ul", name = "B", descriptor = "(I)V", line = 668)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ZB)Liaa;", line = 706)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lmda;Lmda;FLmda;)Lmda;", line = 716)
    public final class267 method485(class267 arg0, class267 arg1, float arg2, class267 arg3) {
        return arg2 < 0.5F ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BLjava/awt/Canvas;Ljava/lang/Object;)V", line = 727)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BI)Lgda;", line = 752)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILjava/awt/Canvas;)Ljava/lang/Object;", line = 794)
    public final Object method2011(int arg0, Canvas arg1) {
        return arg0 == 0 ? null : (Object) null;
    }

    @OriginalMember(owner = "client!ul", name = "w", descriptor = "(B)F", line = 804)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILjagdx/IDirect3DPixelShader;)V", line = 815)
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(IIIID)V", line = 825)
    public final void method524(int arg0, int arg1, int arg2, int arg3, double arg4) {
    }

    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IIILjagdx/IDirect3D;ILjagdx/D3DPRESENT_PARAMETERS;)Z", line = 830)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BZZLbp;I)V", line = 938)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ZZ)Lia;", line = 984)
    ...
    @OriginalMember(owner = "client!ul", name = "w", descriptor = "()V", line = 993)
    public final void method522() {
    }

    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BLbp;)I", line = 997)
    ...
    @OriginalMember(owner = "client!ul", name = "c", descriptor = "(B)V", line = 1023)
    ...
    @OriginalMember(owner = "client!ul", name = "j", descriptor = "()V", line = 1065)
    ...
    @OriginalMember(owner = "client!ul", name = "c", descriptor = "(II)V", line = 1089)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IILbp;Z)V", line = 1114)
    ...
    @OriginalMember(owner = "client!ul", name = "s", descriptor = "(B)V", line = 1163)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lpfa;Z)I", line = 1178)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lcg;I)I", line = 1207)
    ...
    @OriginalMember(owner = "client!ul", name = "u", descriptor = "(I)V", line = 1226)
    ...
    @OriginalMember(owner = "client!ul", name = "j", descriptor = "(B)V", line = 1236)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(I[Lfk;)Lri;", line = 1249)
    ...
    @OriginalMember(owner = "client!ul", name = "u", descriptor = "(B)V", line = 1259)
    ...
    @OriginalMember(owner = "client!ul", name = "F", descriptor = "(I)V", line = 1280)
    ...
    @OriginalMember(owner = "client!ul", name = "F", descriptor = "(II)V", line = 1290)
    public final void method493(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!ul", name = "r", descriptor = "()Lnia;", line = 1294)
    ...
    @OriginalMember(owner = "client!ul", name = "o", descriptor = "(B)V", line = 1302)
    ...
    @OriginalMember(owner = "client!ul", name = "D", descriptor = "(I)V", line = 1313)
    ...
    @OriginalMember(owner = "client!ul", name = "U", descriptor = "(I)V", line = 1342)
    ...
    @OriginalMember(owner = "client!ul", name = "d", descriptor = "(I)V", line = 1351)
    ...
    @OriginalMember(owner = "client!ul", name = "na", descriptor = "(IIII)[I", line = 1361)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lmg;I)V", line = 1404)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IIII)V", line = 1424)
    public final void method472(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!ul", name = "fb", descriptor = "(I)Z", line = 1427)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Ljv;III)V", line = 1469)
    ...
    @OriginalMember(owner = "client!ul", name = "n", descriptor = "(B)V", line = 1485)
    public final void method2037(byte arg0) {
        int var2 = 108 / ((arg0 + 23) / 62);
        this.field8080.SetTransform(3, this.field5609);
    }

    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lnl;)V", line = 1495)
    public final void method550(class554 arg0) {
    }

    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(II)Llda;", line = 1498)
    public final class488 method481(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!ul", name = "d", descriptor = "(II)Lhca;", line = 1505)
    public final class492 method523(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!ul", name = "A", descriptor = "(I)V", line = 1513)
    ...
    @OriginalMember(owner = "client!ul", name = "l", descriptor = "()Z", line = 1524)
    public final boolean method476() {
        return false;
    }

    @OriginalMember(owner = "client!ul", name = "W", descriptor = "(I)V", line = 1532)
    ...
    @OriginalMember(owner = "client!ul", name = "I", descriptor = "(I)V", line = 1543)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILjagdx/IDirect3DVertexShader;)V", line = 1556)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILem;)V", line = 1569)
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(Z)V", line = 1591)
    public final void method507(boolean arg0) {
    }

    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(I)V", line = 1594)
    public final synchronized void method448(int arg0) {
        this.field8058.method3802((byte) -72);
        super.method448(arg0);
    }

    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IZI[[I)Lnn;", line = 1602)
    ...
    @OriginalMember(owner = "client!ul", name = "t", descriptor = "(I)V", line = 1612)
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(BI)V", line = 1622)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BLkda;)V", line = 1632)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BLen;)I", line = 1663)
    ...
    @OriginalMember(owner = "client!ul", name = "v", descriptor = "(I)V", line = 1695)
