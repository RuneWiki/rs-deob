...
public class class574 implements class236 {
    ...
    @OriginalMember(owner = "client!nga", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(I)Ltca;", line = 16)
    ...
    @OriginalMember(owner = "client!nga", name = "<init>", descriptor = "(Ljava/lang/String;Ltl;Lfn;IIIIIIIIII)V", line = 48)
