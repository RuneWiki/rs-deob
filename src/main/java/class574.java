...
public class class574 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Ljr;Z)V")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Liv;B)I")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IILjr;)V")
