...
public class class574 extends class30 {
    ...
    @OriginalMember(owner = "client!a", name = "<init>", descriptor = "()V", line = 5)
    public class574() {
        super(1, false);
    }

    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IB)[[I", line = 11)
    ...
    @OriginalMember(owner = "client!a", name = "d", descriptor = "(I)I", line = 90)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(BLr;)V", line = 107)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(II)[I", line = 123)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(BILac;)V", line = 167)
    ...
    @OriginalMember(owner = "client!a", name = "b", descriptor = "(II)Lch;", line = 214)
