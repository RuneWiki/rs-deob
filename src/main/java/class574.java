...
public class class574 extends class395 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "([B[IIIIIIIIIIILua;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "([B[IIIIIIIIIIILua;II)V", line = 91)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "([B[IIIIIIII)V", line = 188)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(Lve;Lll;[Lfda;[I[I)V", line = 224)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "([B[IIIIIIII)V", line = 246)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(CIIIZLua;II)V", line = 302)
    ...
    @OriginalMember(owner = "client!gl", name = "OA", descriptor = "(CIIIZ)V", line = 368)
