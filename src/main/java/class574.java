...
public class class574 extends class386 {
    ...
    @OriginalMember(owner = "client!of", name = "e", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(II)[I", line = 17)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(ILi;)V", line = 28)
    public static final void method3362(int arg0, class37 arg1) {
        class155.field1899[arg0] = arg1;
    }

    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "()V", line = 36)
    public class574() {
        super(0, true);
    }

    @OriginalMember(owner = "client!of", name = "a", descriptor = "(ILr;)V", line = 42)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Ldc;B)V", line = 66)
