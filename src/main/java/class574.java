...
public class class574 extends class358 {
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lig;BII)V")
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IZLha;I)Lda;")
    ...
    @OriginalMember(owner = "client!rd", name = "wa", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!rd", name = "fa", descriptor = "(IILr;)Lr;")
    ...
    @OriginalMember(owner = "client!rd", name = "CA", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lr;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "(Lgd;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lgu;[I)V")
