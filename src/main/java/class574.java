...
public abstract class class574 extends class46 {
    ...
    @OriginalMember(owner = "client!gh", name = "c", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(I)Lot;", line = 19)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/String;)V", line = 36)
