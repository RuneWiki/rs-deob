...
public class class178 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(B[B)[B", line = 21)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lpi;I)Lbp;", line = 115)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(ILcj;)Z", line = 135)
    ...
    @OriginalMember(owner = "client!cj", name = "c", descriptor = "(I)V", line = 151)
