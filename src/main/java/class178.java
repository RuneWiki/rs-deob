...
public class class178 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(IIII)I", line = 4)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(BLfb;)V", line = 34)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(IBLfb;)V", line = 64)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(I)V", line = 84)
