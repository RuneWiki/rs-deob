...
public class class178 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "()[F", line = 4)
    public final float[] method1394() {
        return this.field2659[this.method1396()];
    }

    @OriginalMember(owner = "client!fq", name = "b", descriptor = "()V", line = 8)
    ...
    @OriginalMember(owner = "client!fq", name = "c", descriptor = "()I", line = 147)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(II)I", line = 158)
