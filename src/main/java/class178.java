...
public class class178 extends class408 {
    ...
    @OriginalMember(owner = "client!hs", name = "c", descriptor = "(II)I", line = 7)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(II)V", line = 23)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 53)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(III)Lqr;", line = 80)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(B)V", line = 285)
    ...
    @OriginalMember(owner = "client!hs", name = "d", descriptor = "(I)I", line = 302)
    ...
    @OriginalMember(owner = "client!hs", name = "e", descriptor = "(I)V", line = 323)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(II)[B", line = 336)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Z)V", line = 355)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(III)Lqc;", line = 398)
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(ILwe;Lwe;Las;Lef;IIZ)V", line = 919)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ICI)C", line = 630)
    ...
    @OriginalMember(owner = "client!hs", name = "c", descriptor = "(B)I", line = 722)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(I)Lr;", line = 735)
    ...
    @OriginalMember(owner = "client!hs", name = "d", descriptor = "(B)I", line = 832)
    ...
    @OriginalMember(owner = "client!hs", name = "e", descriptor = "(II)V", line = 876)
    ...
    @OriginalMember(owner = "client!hs", name = "f", descriptor = "(I)I", line = 890)
