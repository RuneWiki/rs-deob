...
public class class178 extends class30 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IB)[I", line = 5)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(II)Z", line = 90)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "()V", line = 150)
    public class178() {
        super(0, true);
    }

    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Ljg;II)V", line = 153)
