...
public class class178 extends class208 {
    ...
    @OriginalMember(owner = "client!vb", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!vb", name = "d", descriptor = "(I)Lun;", line = 18)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Lvg;BZII)V", line = 31)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IB)C", line = 110)
    ...
    @OriginalMember(owner = "client!vb", name = "c", descriptor = "(B)I", line = 137)
