...
public class class178 {
    ...
    @OriginalMember(owner = "client!fq", name = "b", descriptor = "(I)I", line = 23)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Ljava/lang/Object;Lkb;I)V", line = 59)
    ...
    @OriginalMember(owner = "client!fq", name = "c", descriptor = "(I)I", line = 90)
    public final int method1087(int arg0) {
        field2363++;
        return arg0 < 114 ? -128 : this.field2354;
    }

    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Lkb;I)V", line = 107)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(BI)V", line = 134)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Lkb;Z)Ljava/lang/Object;", line = 188)
    ...
    @OriginalMember(owner = "client!fq", name = "d", descriptor = "(I)V", line = 240)
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(I)V", line = 268)
