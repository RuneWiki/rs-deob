...
public class class178 extends class312 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(III)Z", line = 18)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(JB)V", line = 29)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(ZII)V", line = 51)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IJLza;ZB)V", line = 102)
    ...
    @OriginalMember(owner = "client!pj", name = "b", descriptor = "(I)V", line = 265)
    ...
    @OriginalMember(owner = "client!pj", name = "b", descriptor = "(III)Lem;", line = 284)
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "(Lza;Lod;Ltd;J)V", line = 405)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(BI)I", line = 302)
    ...
    @OriginalMember(owner = "client!pj", name = "c", descriptor = "(I)V", line = 318)
