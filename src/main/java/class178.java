...
public class class178 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(JLjava/lang/Object;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(IB)V", line = 16)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(BJ)Ljava/lang/Object;", line = 65)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Z)Ljava/lang/Object;", line = 125)
    ...
    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(Z)V", line = 157)
    ...
    @OriginalMember(owner = "client!wq", name = "c", descriptor = "(B)I", line = 168)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(ZIIII)V", line = 179)
    ...
    @OriginalMember(owner = "client!wq", name = "c", descriptor = "(Z)I", line = 206)
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(I)V", line = 230)
    public class178(int arg0) {
        this(arg0, arg0);
    }

    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Ljava/lang/Object;JIB)V", line = 233)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(JZ)V", line = 263)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(B)I", line = 276)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Ljs;I)V", line = 287)
    ...
    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(I)V", line = 306)
    ...
    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(B)Ljava/lang/Object;", line = 331)
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(II)V", line = 368)
