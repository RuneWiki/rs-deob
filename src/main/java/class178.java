...
public class class178 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(I)J", line = 6)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IZZIILqp;I)V", line = 18)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Z)V", line = 127)
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(B)V", line = 146)
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(Z)Ljava/io/File;", line = 161)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "([BZ)V", line = 184)
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(Lbt;II)V", line = 639)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(III[B)V", line = 207)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(II[BB)V", line = 336)
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(I)V", line = 521)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ZJ)V", line = 597)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(II)V", line = 618)
