...
public class class178 extends class85 {
    ...
    @OriginalMember(owner = "client!tc", name = "W", descriptor = "Llf;")
    private static class109 field3354 = class35.method275("Close", 2);

    @OriginalMember(owner = "client!tc", name = "ib", descriptor = "Llf;")
    private static class109 field3366 = class35.method275("We suspect someone knows your password)3", 2);

    @OriginalMember(owner = "client!tc", name = "db", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!tc", name = "gb", descriptor = "Llf;")
    public static class109 field3364 = field3354;

    @OriginalMember(owner = "client!tc", name = "Q", descriptor = "Llf;")
    public static class109 field3348 = field3361;

    @OriginalMember(owner = "client!tc", name = "nb", descriptor = "Llf;")
    public static class109 field3371 = field3361;

    @OriginalMember(owner = "client!tc", name = "eb", descriptor = "Llf;")
    public static class109 field3362 = class35.method275("::fps ", 2);

    @OriginalMember(owner = "client!tc", name = "rb", descriptor = "Llf;")
    private static class109 field3375 = class35.method275(" is already on your ignore list)3", 2);

    @OriginalMember(owner = "client!tc", name = "bb", descriptor = "Llf;")
    public static class109 field3359 = field3375;

    @OriginalMember(owner = "client!tc", name = "pb", descriptor = "Llf;")
    public static class109 field3373 = class35.method275(":clan:", 2);

    @OriginalMember(owner = "client!tc", name = "mb", descriptor = "Llf;")
    public static class109 field3370 = field3366;

    @OriginalMember(owner = "client!tc", name = "ob", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!tc", name = "S", descriptor = "[Lkf;")
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(BILja;)V")
    ...
    @OriginalMember(owner = "client!tc", name = "g", descriptor = "(B)[Ldf;")
