...
public class class178 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(ZIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(B)V", line = 36)
