...
public class class178 implements class690 {
    ...
    @OriginalMember(owner = "client!rt", name = "c", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!rt", name = "b", descriptor = "(II)V", line = 37)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(II)V", line = 52)
    ...
    @OriginalMember(owner = "client!rt", name = "<init>", descriptor = "()V", line = 192)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(I[I)V", line = 82)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(ZII)V", line = 126)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(Ljava/awt/Component;IZI)V", line = 151)
