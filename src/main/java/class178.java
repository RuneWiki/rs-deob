...
public class class178 extends class394 {
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(Lue;Ljava/lang/Object;I)V", line = 4)
    public class178(class154 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field2705 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(B)Z", line = 13)
    public final boolean method1266(byte arg0) {
        return arg0 >= 90;
    }

    @OriginalMember(owner = "client!wd", name = "d", descriptor = "(B)Ljava/lang/Object;", line = 24)
