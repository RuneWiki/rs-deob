...
public class class178 extends class233 {
    ...
    @OriginalMember(owner = "client!hp", name = "c", descriptor = "(II)V", line = 10)
    ...
    @OriginalMember(owner = "client!hp", name = "finalize", descriptor = "()V", line = 63)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Z)Z", line = 74)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ILae;II)Z", line = 86)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(IIIIIIIIIII)V", line = 162)
    ...
    @OriginalMember(owner = "client!hp", name = "e", descriptor = "(I)V", line = 185)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ILae;I)Lbk;", line = 197)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lae;Lbk;B)V", line = 219)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ILtq;I)Lth;", line = 252)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(BLae;)Ljg;", line = 268)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lae;B)V", line = 304)
    ...
    @OriginalMember(owner = "client!hp", name = "h", descriptor = "(I)I", line = 326)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ZIIII)V", line = 340)
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(I)V", line = 379)
    ...
    @OriginalMember(owner = "client!hp", name = "g", descriptor = "(I)V", line = 394)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ZBIILna;ILae;)V", line = 407)
    ...
    @OriginalMember(owner = "client!hp", name = "d", descriptor = "(II)V", line = 418)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(B)V", line = 521)
