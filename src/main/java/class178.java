...
public class class178 extends Canvas {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ILbk;)V", line = 11)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!hs", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 68)
    public final void update(Graphics arg0) {
        this.field2462.update(arg0);
        field2457++;
    }

    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 77)
    public class178(Component arg0) {
        this.field2462 = arg0;
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIIBI)V", line = 86)
    ...
    @OriginalMember(owner = "client!hs", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 108)
