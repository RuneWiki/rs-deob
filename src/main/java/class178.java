...
public class class178 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(CB)V", line = 4)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IB)V", line = 20)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(III)V", line = 32)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(CI)C", line = 41)
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(III)V", line = 441)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(I)V", line = 456)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Z)V", line = 468)
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(Lkd;I)V", line = 479)
