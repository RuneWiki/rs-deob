...
public class class178 {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IBZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(II)V", line = 45)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IIIIII)I", line = 59)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(BI)Lhe;", line = 119)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(B)V", line = 162)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "([Ljava/lang/Object;[IIII)V", line = 175)
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "(Lsn;ILci;)V", line = 234)
