...
public class class178 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(II)I", line = 43)
    ...
    @OriginalMember(owner = "client!tp", name = "b", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!tp", name = "c", descriptor = "(B)V", line = 136)
