...
public class class178 extends class601 {
    ...
    @OriginalMember(owner = "client!dca", name = "d", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(IILjava/lang/String;)V", line = 22)
    ...
    @OriginalMember(owner = "client!dca", name = "<init>", descriptor = "()V", line = 34)
    public class178() {
        super(1, true);
    }

    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(BI)[I", line = 41)
    ...
    @OriginalMember(owner = "client!dca", name = "e", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(Lee;BI)V", line = 122)
