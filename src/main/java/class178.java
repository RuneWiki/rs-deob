...
public class class178 extends class207 {
    ...
    @OriginalMember(owner = "client!bka", name = "b", descriptor = "(IB)I", line = 4)
    ...
    @OriginalMember(owner = "client!bka", name = "<init>", descriptor = "(ILrd;)V", line = 36)
    public class178(int arg0, class355 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!bka", name = "b", descriptor = "(I)I", line = 39)
    ...
    @OriginalMember(owner = "client!bka", name = "<init>", descriptor = "(Lrd;)V", line = 51)
    public class178(class355 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bka", name = "a", descriptor = "(IB)V", line = 54)
    ...
    @OriginalMember(owner = "client!bka", name = "a", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!bka", name = "c", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!bka", name = "a", descriptor = "(B)Z", line = 103)
    public final boolean method1214(byte arg0) {
        ++field2347;
        return arg0 != 8 ? true : true;
    }

    @OriginalMember(owner = "client!bka", name = "b", descriptor = "(B)Z", line = 121)
    ...
    @OriginalMember(owner = "client!bka", name = "d", descriptor = "(I)I", line = 131)
    ...
    @OriginalMember(owner = "client!bka", name = "a", descriptor = "(ZIIIII)V", line = 142)
