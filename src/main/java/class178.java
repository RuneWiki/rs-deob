...
public abstract class class178 implements class190 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ILs;)V")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ltha;B)V")
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Lhj;ILiv;Ljt;IZ)V")
