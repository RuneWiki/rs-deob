...
public class class178 extends class159 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(B)Lni;")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ZFLni;Lni;)Z")
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "(Loea;I)V")
