...
public class class178 extends class508 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Z)V", line = 56)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(I)Lhg;", line = 69)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(Lih;IIIIII)V", line = 142)
