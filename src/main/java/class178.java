...
public class class178 extends class512 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Let;I)[Lic;", line = 4)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(III)V", line = 48)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(ZZIIB)I", line = 71)
    ...
    @OriginalMember(owner = "client!kg", name = "c", descriptor = "(III)V", line = 113)
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "(IIIIIII)V", line = 133)
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(III)V", line = 146)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(IIIIIII)Ltb;", line = 165)
