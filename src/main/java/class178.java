...
public class class178 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Ltq;Ldf;)V", line = 25)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(IIF)F", line = 92)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(IF)I", line = 101)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(F)F", line = 167)
    private static final float method937(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!fq", name = "b", descriptor = "(IIF)F", line = 175)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "()V", line = 180)
