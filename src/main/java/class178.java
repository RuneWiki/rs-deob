...
public class class178 extends class115 {
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "()V")
    public final void method1218() {
        this.field2636 = null;
    }

    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Lok;II)Lpu;")
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(Lgk;)V")
