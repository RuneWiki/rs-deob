...
public class class178 {
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(BJ)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(II)Lwk;", line = 65)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(IZLkp;Z)V", line = 116)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(B)V", line = 169)
    ...
    @OriginalMember(owner = "client!aba", name = "b", descriptor = "(I)V", line = 180)
    ...
    @OriginalMember(owner = "client!aba", name = "b", descriptor = "(II)V", line = 191)
    ...
    @OriginalMember(owner = "client!aba", name = "<init>", descriptor = "(Lij;Ld;)V", line = 211)
