...
public class class178 {
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(II)Llm;", line = 18)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IB)V", line = 51)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "([BIIIII)V", line = 102)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IIIIBIIIII)V", line = 132)
    ...
    @OriginalMember(owner = "client!ik", name = "<init>", descriptor = "(Lcda;ILkea;Lkea;)V", line = 208)
    ...
    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(B)V", line = 189)
