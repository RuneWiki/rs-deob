...
public class class178 {
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Lug;B)V", line = 87)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Z)V", line = 107)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IBLug;)V", line = 120)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IJLza;)V", line = 191)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(II)Z", line = 227)
