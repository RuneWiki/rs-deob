...
public class class178 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IZI)I", line = 19)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IIIIIBI)V", line = 33)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(B)V", line = 91)
