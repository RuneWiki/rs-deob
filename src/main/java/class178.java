...
public class class178 extends class79 implements class113 {
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(Leq;Z)Lgl;", line = 5)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(B)I", line = 16)
    public final int method369(byte arg0) {
        field2554++;
        return arg0 < 24 ? 4 : 0;
    }

    @OriginalMember(owner = "client!ol", name = "d", descriptor = "(I)Z", line = 29)
    ...
    @OriginalMember(owner = "client!ol", name = "c", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!ol", name = "c", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(B)I", line = 67)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(BJ)V", line = 80)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Z)Z", line = 146)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Leq;I)V", line = 157)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(ILeq;BI)Z", line = 169)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IIILbp;IZLeq;)V", line = 180)
    ...
    @OriginalMember(owner = "client!ol", name = "<init>", descriptor = "(IIILfg;)V", line = 192)
    public class178(int arg0, int arg1, int arg2, class79 arg3) {
        super(arg0, arg1, arg2, false, false);
        this.field2548 = arg3;
    }

    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Leq;Z)V", line = 200)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(ILeq;Z)Lva;", line = 210)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(I)V", line = 231)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(BLeq;)V", line = 241)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(I)I", line = 251)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(II)Z", line = 263)
