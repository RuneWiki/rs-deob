...
public class class178 {
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(Lgw;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(Lgw;I)V", line = 41)
    ...
    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 80)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(B)Z", line = 115)
