...
public class class721 extends class739 {
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(Lsl;IB)V", line = 6)
    ...
    @OriginalMember(owner = "client!uha", name = "c", descriptor = "(I)I", line = 42)
    ...
    @OriginalMember(owner = "client!uha", name = "b", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!uha", name = "b", descriptor = "(II)[[I", line = 73)
    ...
    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(ZI)[I", line = 397)
    ...
    @OriginalMember(owner = "client!uha", name = "<init>", descriptor = "()V", line = 651)
    public class721() {
        super(2, false);
    }

    @OriginalMember(owner = "client!uha", name = "a", descriptor = "(IIIIIII)V", line = 659)
