...
public class class721 extends class160 {
    ...
    @OriginalMember(owner = "client!rea", name = "c", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!rea", name = "b", descriptor = "(III)V", line = 15)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "()V", line = 47)
    public static final void method5219() {
        class274.method2243(1, class293.field4121);
    }

    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(Leea;B)I", line = 50)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(III)V", line = 83)
    ...
    @OriginalMember(owner = "client!rea", name = "<init>", descriptor = "(IIIIIII)V", line = 97)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(IIB)V", line = 108)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(IIIIII)V", line = 133)
