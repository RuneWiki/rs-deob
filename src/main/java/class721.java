...
public class class721 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(ILit;)Lbt;", line = 7)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Z)V", line = 37)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(JB)V", line = 49)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(B)Z", line = 71)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lal;JZ)V", line = 111)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!cj", name = "<init>", descriptor = "(I)V", line = 199)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IJ)Lal;", line = 168)
