...
public class class721 extends class66 implements class558 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!oa", name = "j", descriptor = "()Lqq;", line = 17)
    public final class501 method517() {
        return new class292();
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/awt/Canvas;II)V", line = 22)
    ...
    @OriginalMember(owner = "client!oa", name = "finalize", descriptor = "()V", line = 33)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljw;I)V", line = 39)
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(II)I", line = 44)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Ljava/awt/Canvas;II)V", line = 51)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Z)V", line = 74)
    public final void method519(boolean arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZ)Lfs;", line = 78)
    public final class581 method534(int arg0, int arg1, boolean arg2) {
        return new class567(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIIIIIII)V", line = 82)
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(IIIIII)Lol;", line = 85)
    public final class299 method505(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II)Lrk;", line = 89)
    public final class35 method486(int arg0, int arg1) {
        return new class527(arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([IIIIIZ)Lfs;", line = 92)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIII)V", line = 95)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljw;)V", line = 102)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIII)V", line = 110)
    public final void method569(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lol;Lol;FLol;)Lol;", line = 113)
    public final class299 method485(class299 arg0, class299 arg1, float arg2, class299 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILaa;II)V", line = 117)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lnq;Lrk;)Lgea;", line = 122)
    public final class82 method507(class485 arg0, class35 arg1) {
        return new class637(this, (class567) arg0, (class527) arg1);
    }

    @OriginalMember(owner = "client!oa", name = "n", descriptor = "()Z", line = 125)
    public final boolean method559() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIZ)Lfs;", line = 129)
    ...
    @OriginalMember(owner = "client!oa", name = "f", descriptor = "(I)V", line = 133)
    public final void method510(int arg0) {
        this.field10452[arg0].method4726();
    }

    @OriginalMember(owner = "client!oa", name = "f", descriptor = "()V", line = 135)
    public final void method473() {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(FFF)V", line = 137)
    public final void method497(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!oa", name = "C", descriptor = "()La;", line = 144)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lju;IIII)Lka;", line = 156)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILaa;IIIII)V", line = 158)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lza;)V", line = 162)
    public final void method515(class434 arg0) {
        this.field10432 = (class59) arg0;
        this.method5254(arg0);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[[I[[IIII)Ls;", line = 167)
    ...
    @OriginalMember(owner = "client!oa", name = "r", descriptor = "()V", line = 172)
    public final void method574() {
    }

    @OriginalMember(owner = "client!oa", name = "y", descriptor = "()Z", line = 175)
    public final boolean method566() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "l", descriptor = "()Z", line = 179)
    public final boolean method542() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "h", descriptor = "()V", line = 185)
    public final void method484() {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([I)V", line = 189)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(IIIIII)V", line = 195)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lqq;)V", line = 198)
    public final void method495(class501 arg0) {
        this.field10450 = arg0;
        this.method5259(((class292) arg0).nativeid);
    }

    @OriginalMember(owner = "client!oa", name = "k", descriptor = "(I)Lza;", line = 207)
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "()Z", line = 214)
    public final boolean method472() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "p", descriptor = "()V", line = 216)
    public final void method575() {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[I[I)Laa;", line = 219)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[Luf;)V", line = 225)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Z)V", line = 244)
    public final void method554(boolean arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "m", descriptor = "()Lqq;", line = 250)
    public final class501 method511() {
        return this.field10445;
    }

    @OriginalMember(owner = "client!oa", name = "e", descriptor = "()Z", line = 253)
    public final boolean method469() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "g", descriptor = "()V", line = 256)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 262)
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ld;II)V", line = 279)
    ...
    @OriginalMember(owner = "client!oa", name = "g", descriptor = "(I)V", line = 306)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "()Z", line = 314)
    public final boolean method547() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Liga;Z)Lfs;", line = 320)
    ...
    @OriginalMember(owner = "client!oa", name = "u", descriptor = "()Z", line = 325)
    public final boolean method562() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "j", descriptor = "(I)V", line = 329)
    public final void method535(int arg0) {
        this.field10452[arg0].method4741();
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(II)Lnq;", line = 333)
    public final class485 method478(int arg0, int arg1) {
        return this.method534(arg0, arg1, false);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lol;)V", line = 335)
    public final void method555(class299 arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "o", descriptor = "()Z", line = 339)
    public final boolean method503() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "WA", descriptor = "(S)Z", line = 342)
    ...
    @OriginalMember(owner = "client!oa", name = "t", descriptor = "()Z", line = 368)
    public final boolean method561() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 371)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIII)V", line = 380)
    public final void method550(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!oa", name = "k", descriptor = "()Z", line = 385)
    public final boolean method576() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(I)V", line = 388)
    ...
    @OriginalMember(owner = "client!oa", name = "A", descriptor = "()V", line = 406)
    public final void method501() {
        this.method508(this.field10447.field3491);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIII)V", line = 409)
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "()Z", line = 412)
    public final boolean method502() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "()V", line = 415)
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(II)I", line = 445)
    public final int method499(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIF)Luf;", line = 450)
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(II)V", line = 455)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljw;Z)V", line = 466)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lgea;)V", line = 507)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Llq;[Liga;Z)Lda;", line = 515)
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(S)Z", line = 552)
    ...
    @OriginalMember(owner = "client!oa", name = "x", descriptor = "()Lmi;", line = 565)
    public final class521 method493() {
        return new class521(0, field10454[6], 1, field10454[7], 0L);
    }

    @OriginalMember(owner = "client!oa", name = "q", descriptor = "()V", line = 568)
    public final void method591() {
    }

    @OriginalMember(owner = "client!oa", name = "OA", descriptor = "()Ljava/lang/Object;", line = 576)
    private final Object method5269() {
        return new class406(this);
    }

    @OriginalMember(owner = "client!oa", name = "z", descriptor = "()I", line = 581)
    public final int method578() {
        return 4;
    }

    @OriginalMember(owner = "client!oa", name = "w", descriptor = "()Z", line = 595)
    public final boolean method588() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(I)V", line = 604)
    public final void method481(int arg0) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!oa", name = "v", descriptor = "()Lqq;", line = 610)
    public final class501 method577() {
        return this.field10450;
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 648)
