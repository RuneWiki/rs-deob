...
public class class721 extends class66 implements class558 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/awt/Canvas;II)V", line = 8)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIII)V", line = 30)
    public final void method486(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 36)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lcj;Lcj;FLcj;)Lcj;", line = 46)
    public final class720 method531(class720 arg0, class720 arg1, float arg2, class720 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lgl;IIII)Lka;", line = 51)
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(II)Lio;", line = 54)
    public final class461 method498(int arg0, int arg1) {
        return this.method488(arg0, arg1, false);
    }

    @OriginalMember(owner = "client!oa", name = "g", descriptor = "()V", line = 57)
    ...
    @OriginalMember(owner = "client!oa", name = "g", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Z)V", line = 74)
    public final void method470(boolean arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "C", descriptor = "()La;", line = 79)
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(IIIIII)V", line = 91)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(FFF)V", line = 98)
    public final void method549(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!oa", name = "f", descriptor = "()Z", line = 101)
    public final boolean method459() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!oa", name = "w", descriptor = "()V", line = 106)
    public final void method535() {
    }

    @OriginalMember(owner = "client!oa", name = "d", descriptor = "()Z", line = 109)
    public final boolean method455() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "r", descriptor = "()Z", line = 112)
    public final boolean method503() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "()Lal;", line = 124)
    public final class109 method444() {
        return this.field9800;
    }

    @OriginalMember(owner = "client!oa", name = "n", descriptor = "()Z", line = 129)
    public final boolean method480() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "()Z", line = 133)
    public final boolean method448() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "()Z", line = 138)
    public final boolean method450() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIIIIIII)V", line = 140)
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(I)V", line = 143)
    public final void method505(int arg0) {
        this.field9801[arg0].method3553();
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ltv;)V", line = 146)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ltv;Z)V", line = 158)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[[I[[IIII)Ls;", line = 191)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lal;)V", line = 195)
    public final void method509(class109 arg0) {
        this.field9800 = arg0;
        this.method3979(((class293) arg0).nativeid);
    }

    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(II)I", line = 200)
    ...
    @OriginalMember(owner = "client!oa", name = "v", descriptor = "()V", line = 206)
    public final void method527() {
    }

    @OriginalMember(owner = "client!oa", name = "l", descriptor = "()V", line = 209)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lvf;Z)Lhh;", line = 242)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIII)V", line = 246)
    public final void method506(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
    }

    @OriginalMember(owner = "client!oa", name = "s", descriptor = "()Z", line = 250)
    public final boolean method510() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "WA", descriptor = "(S)Z", line = 255)
    ...
    @OriginalMember(owner = "client!oa", name = "h", descriptor = "(I)V", line = 280)
    public final void method537(int arg0) {
        this.field9801[arg0].method3561();
    }

    @OriginalMember(owner = "client!oa", name = "t", descriptor = "()V", line = 282)
    public final void method511() {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lza;)V", line = 285)
    ...
    @OriginalMember(owner = "client!oa", name = "f", descriptor = "(I)V", line = 295)
    public final void method528(int arg0) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!oa", name = "j", descriptor = "()Z", line = 298)
    public final boolean method472() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "A", descriptor = "()Ldca;", line = 302)
    public final class189 method542() {
        return new class189(0, "SSE", 1, "CPU", 0L);
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(Z)V", line = 304)
    public final void method485(boolean arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II)Lrr;", line = 308)
    public final class381 method437(int arg0, int arg1) {
        return new class527(arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "y", descriptor = "()Z", line = 312)
    public final boolean method538() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Ljava/awt/Canvas;II)V", line = 322)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIF)Luaa;", line = 342)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([IIIIIZ)Lhh;", line = 348)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lhg;)V", line = 352)
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ld;II)V", line = 545)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[I[I)Laa;", line = 360)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILaa;II)V", line = 363)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Leb;[Lvf;Z)Lda;", line = 368)
    ...
    @OriginalMember(owner = "client!oa", name = "z", descriptor = "()Lal;", line = 418)
    public final class109 method541() {
        return new class293();
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 421)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 436)
    ...
    @OriginalMember(owner = "client!oa", name = "o", descriptor = "()V", line = 451)
    public final void method482() {
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(I)V", line = 456)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lcj;)V", line = 468)
    public final void method440(class720 arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "OA", descriptor = "()Ljava/lang/Object;", line = 471)
    private final Object method3992() {
        return new class407(this);
    }

    @OriginalMember(owner = "client!oa", name = "e", descriptor = "()Z", line = 474)
    public final boolean method458() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZ)Lhh;", line = 478)
    public final class140 method488(int arg0, int arg1, boolean arg2) {
        return new class567(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ltv;I)V", line = 481)
    public final void method524(class586 arg0, int arg1) {
        this.method3980(arg0, false);
        this.method3978().method3545(this, field9811, field9812, field9808, field9809, arg0.field7972.method1828((byte) 38));
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([I)V", line = 486)
    ...
    @OriginalMember(owner = "client!oa", name = "finalize", descriptor = "()V", line = 491)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[Luaa;)V", line = 498)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(IIIIII)Lcj;", line = 519)
    public final class720 method515(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIZ)Lhh;", line = 523)
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(II)I", line = 529)
    public final int method473(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIII)V", line = 533)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(I)Lza;", line = 537)
    ...
    @OriginalMember(owner = "client!oa", name = "q", descriptor = "()V", line = 576)
    public final void method490() {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILaa;IIIII)V", line = 578)
    ...
    @OriginalMember(owner = "client!oa", name = "u", descriptor = "()V", line = 582)
    public final void method514() {
        this.method556(this.field9796.field2964);
    }

    @OriginalMember(owner = "client!oa", name = "h", descriptor = "()Z", line = 585)
    public final boolean method460() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "x", descriptor = "()Z", line = 588)
    public final boolean method536() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(II)V", line = 595)
    ...
    @OriginalMember(owner = "client!oa", name = "p", descriptor = "()I", line = 606)
    public final int method489() {
        return 4;
    }

    @OriginalMember(owner = "client!oa", name = "k", descriptor = "()Lal;", line = 609)
    public final class109 method475() {
        return this.field9798;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lio;Lrr;)Lhg;", line = 616)
