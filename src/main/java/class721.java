...
public class class721 extends class34 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "(Lpj;IIZ)V")
    ...
    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "(Lpj;II[III)V")
