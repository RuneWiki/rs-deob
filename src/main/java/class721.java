...
public class class721 extends class198 {
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(IILgga;I)Ljea;")
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(ZLol;)V")
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(ILlm;)V")
