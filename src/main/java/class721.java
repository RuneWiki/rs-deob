...
public abstract class class721 extends class210 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "([Lgu;I)I")
    ...
    @OriginalMember(owner = "client!si", name = "f", descriptor = "(I)Laca;")
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(Lha;I)Z")
    ...
    @OriginalMember(owner = "client!si", name = "i", descriptor = "(B)V")
