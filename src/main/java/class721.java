...
public class class721 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "([BIII)V", line = 12)
    ...
    @OriginalMember(owner = "client!el", name = "finalize", descriptor = "()V", line = 31)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(ZI[[[Lch;III)Z", line = 44)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "([IIBII)V", line = 365)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(I)V", line = 393)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "([BIII)I", line = 404)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(B)Ljava/io/File;", line = 424)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(I)V", line = 436)
    ...
    @OriginalMember(owner = "client!el", name = "c", descriptor = "(I)J", line = 454)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IJ)V", line = 465)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IBI)Z", line = 479)
    ...
    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "(Ljava/io/File;Ljava/lang/String;J)V", line = 494)
