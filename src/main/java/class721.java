...
public class class721 {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ILka;ILha;IIIIIIILla;BI)Lka;")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Z)Ldg;")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Ldg;I)V")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(I)Ldg;")
    ...
    @OriginalMember(owner = "client!dr", name = "c", descriptor = "(I)Ldg;")
