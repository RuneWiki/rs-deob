...
public class class721 extends class634 {
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "()V", line = 152)
    public class721() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cp", name = "c", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "(BI)[I", line = 22)
    ...
    @OriginalMember(owner = "client!cp", name = "f", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ILig;Z)V", line = 104)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(II)V", line = 196)
