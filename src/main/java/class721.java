...
public class class721 extends class66 implements class556 {
    ...
    @OriginalMember(owner = "client!oa", name = "t", descriptor = "()Leh;")
    ...
    @OriginalMember(owner = "client!oa", name = "y", descriptor = "()Leh;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lhm;IIII)Lka;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lnea;Lvu;)Lcp;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lkf;[Lre;Z)Lda;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lag;Lag;FLag;)Lag;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lhea;I)V")
    ...
    @OriginalMember(owner = "client!oa", name = "x", descriptor = "()Lrda;")
    public final class689 method483() {
        return new class689(0, "SSE", 1, "CPU", 0L);
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(II)Lvu;")
    ...
    @OriginalMember(owner = "client!oa", name = "k", descriptor = "()Leh;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lre;Z)Lqda;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Leh;)V")
    public final void method445(class378 arg0) {
        this.field10123 = arg0;
        this.method4066(((class290) arg0).nativeid);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lag;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lhea;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIF)Ljw;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZ)Lqda;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([IIIIIZ)Lqda;")
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(IIIIZ)Lqda;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[Ljw;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lhea;Z)V")
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(II)Lnea;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lcp;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIII)Lag;")
