...
public class class430 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Lpt;III)V")
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Lil;II)V")
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(Lad;Lqq;Lpf;IIIII)V")
