...
public class class430 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(B)[Llt;", line = 24)
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(II)V", line = 119)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lfaa;IIIIII)V", line = 154)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(Lbt;ILkda;)V", line = 171)
