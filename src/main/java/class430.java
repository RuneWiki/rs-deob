...
public class class430 extends class381 {
    ...
    @OriginalMember(owner = "client!tj", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ILjava/lang/String;Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "(I)V", line = 53)
