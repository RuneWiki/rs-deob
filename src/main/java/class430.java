...
public class class430 extends class513 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(ZLun;)V")
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(BIIILda;)Lsr;")
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(ZLwd;)V")
