...
public class class430 extends class747 {
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(II)[[I", line = 4)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Ldc;II)V", line = 80)
    ...
    @OriginalMember(owner = "client!qq", name = "c", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "()V", line = 134)
    public class430() {
        super(1, false);
    }

    @OriginalMember(owner = "client!qq", name = "d", descriptor = "(I)I", line = 141)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(II)[I", line = 151)
