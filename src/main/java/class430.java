...
public class class430 {
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(B)Lr;", line = 4)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(III)V", line = 23)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(BLr;)V", line = 41)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lma;Lgo;IIJIIII)V", line = 61)
    ...
    @OriginalMember(owner = "client!r", name = "<init>", descriptor = "(I)V", line = 122)
    public class430(int arg0) {
        this.field6383 = arg0;
    }

    @OriginalMember(owner = "client!r", name = "<init>", descriptor = "(IIIIII)V", line = 129)
