...
public class class430 extends class337 {
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "(Lmh;Lpda;)V", line = 14)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(BZ)V", line = 34)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IBLuu;)V", line = 66)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IIII)V", line = 84)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IB)I", line = 106)
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "(B)Z", line = 124)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(ZII)V", line = 139)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(B)V", line = 175)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(ZI)V", line = 198)
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "(IIII)I", line = 215)
