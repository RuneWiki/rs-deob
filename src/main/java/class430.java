...
public class class430 extends class371 {
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IILza;I)Z")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(Lza;B)Lkf;")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ZI)Z")
