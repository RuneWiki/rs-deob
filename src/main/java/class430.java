...
public class class430 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lab;B)V", line = 31)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(B)Lab;", line = 52)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(I)Lab;", line = 72)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(II)V", line = 95)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(I)Lab;", line = 116)
    ...
    @OriginalMember(owner = "client!bj", name = "c", descriptor = "(I)I", line = 137)
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "()V", line = 162)
    public class430() {
