...
public class class430 extends class685 {
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(II)Z", line = 19)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(CI)I", line = 34)
    ...
    @OriginalMember(owner = "client!wga", name = "<init>", descriptor = "(Ljj;II[B)V", line = 56)
    ...
    @OriginalMember(owner = "client!wga", name = "<init>", descriptor = "(Ljj;II[I)V", line = 72)
