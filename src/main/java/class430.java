...
public class class430 extends class334 {
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(ZLha;I)Lrt;")
    ...
    @OriginalMember(owner = "client!eka", name = "g", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(Lfm;Z)V")
