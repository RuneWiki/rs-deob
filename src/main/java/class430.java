...
public class class430 {
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 15)
    public class430(String arg0, int arg1) {
        this.field6121 = arg0;
        this.field6119 = arg1;
    }

    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(II[Ljava/lang/String;I)Ljava/lang/String;", line = 24)
    ...
    @OriginalMember(owner = "client!gp", name = "toString", descriptor = "()Ljava/lang/String;", line = 86)
    public final String toString() {
        field6122++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(ILre;)V", line = 94)
