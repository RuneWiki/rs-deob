...
public class class430 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Z)Lwga;", line = 4)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(II)Lbc;", line = 50)
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(Lkw;ILuq;)V", line = 89)
