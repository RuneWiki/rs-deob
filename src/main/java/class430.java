...
public class class430 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ILsp;B)V")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(B[[[Lbr;)V")
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "(Lnd;Lhg;Lhm;IIIII)V")
