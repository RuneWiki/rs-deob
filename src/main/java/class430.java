...
public class class430 extends class224 {
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(ILeq;ZDLd;IIZ)[I")
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(IBLd;DZLeq;I)[I")
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(ZILeq;ILd;I)[F")
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Ld;ILeq;)Z")
    ...
    @OriginalMember(owner = "client!rba", name = "h", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!rba", name = "<init>", descriptor = "(Lud;)V")
