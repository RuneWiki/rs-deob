...
public class class430 extends class320 {
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(Lnba;)Lbp;", line = 6)
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
