...
public class class430 extends class45 {
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(II)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IB)I", line = 88)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Ljq;Lqa;ILqj;Lgj;IIB)V", line = 120)
    ...
    @OriginalMember(owner = "client!lj", name = "e", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IIIIFFFI)[F", line = 186)
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "()V", line = 333)
    public class430() {
        super(1, false);
    }

    @OriginalMember(owner = "client!lj", name = "f", descriptor = "(I)V", line = 286)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lcu;II)V", line = 297)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IIIIZ[[[Liq;)Z", line = 339)
