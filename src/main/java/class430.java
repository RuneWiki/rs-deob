...
public class class430 extends class379 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IZIILha;ILfs;ILnba;I)Lka;")
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Ljava/lang/String;BILjava/lang/String;Z)V")
