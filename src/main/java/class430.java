...
public class class430 extends class477 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Le;ILpq;ZII)[F")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(BLpq;Le;)Z")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IZDLe;ILpq;I)[I")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(ZILe;IDILpq;Z)[I")
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(Ldga;)V")
