...
public class class430 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(BIIIII)I", line = 19)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(BII)I", line = 88)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(II)V", line = 117)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(ILlf;)V", line = 131)
    ...
    @OriginalMember(owner = "client!rl", name = "<init>", descriptor = "(II)V", line = 370)
    public class430(int arg0, int arg1) {
        this.field6113 = arg1;
        this.field6121 = arg0;
    }

    @OriginalMember(owner = "client!rl", name = "<init>", descriptor = "(Lrl;I)V", line = 378)
