...
public class class430 {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(II)[B", line = 7)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IIILab;)V", line = 44)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IIIIIIIIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(B)V", line = 82)
