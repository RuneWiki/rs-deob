...
public abstract class class430 {
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IIIIB)V", line = 35)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IIZI)V", line = 52)
    ...
    @OriginalMember(owner = "client!uba", name = "<init>", descriptor = "(IIIII)V", line = 1215)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(II)I", line = 226)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IIIIIII)V", line = 237)
    ...
    @OriginalMember(owner = "client!uba", name = "b", descriptor = "(I)V", line = 256)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(Z)V", line = 298)
    ...
    @OriginalMember(owner = "client!uba", name = "d", descriptor = "(I)V", line = 1172)
    ...
    @OriginalMember(owner = "client!uba", name = "b", descriptor = "(Z)V", line = 1201)
