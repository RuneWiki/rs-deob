...
public class class430 {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(BLac;)V", line = 8)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(ILpc;III)V", line = 89)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(B)V", line = 147)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IILac;)V", line = 166)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 410)
