...
public class class430 {
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(ZLea;I)Lwn;", line = 55)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lrg;B)V", line = 111)
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(B)Z", line = 151)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(I)V", line = 203)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(ILea;)Lwn;", line = 221)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(IZLrg;)V", line = 305)
