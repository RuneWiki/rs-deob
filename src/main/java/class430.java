...
public class class430 extends class30 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(BLjava/lang/String;Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(BI)[[I", line = 81)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(IB)[I", line = 144)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(Ljg;II)V", line = 172)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "([[IB)V", line = 245)
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "()V", line = 294)
    public class430() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cp", name = "e", descriptor = "(B)V", line = 301)
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "(III)Lfn;", line = 317)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(II)V", line = 339)
