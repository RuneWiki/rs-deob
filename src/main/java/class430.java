...
public class class430 extends class337 {
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IB)[I", line = 3)
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "()V", line = 76)
    public class430() {
        super(1, true);
    }

    @OriginalMember(owner = "client!qs", name = "i", descriptor = "(I)V", line = 66)
    public static void method2673(int arg0) {
        int var1 = -128 % ((arg0 - 29) / 39);
        field6378 = null;
    }

    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(BILhp;)V", line = 79)
