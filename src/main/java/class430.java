...
public class class430 extends class416 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Lee;B)Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(Lee;B)V", line = 56)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Lee;B[I)V", line = 80)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIB)I", line = 107)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Lee;IB)V", line = 126)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ZI)Lkg;", line = 201)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(I)I", line = 218)
    ...
    @OriginalMember(owner = "client!wg", name = "d", descriptor = "(Z)Ljava/lang/String;", line = 233)
