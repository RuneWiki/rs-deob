...
public class class430 extends class98 {
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "()Leha;", line = 4)
    public final class98 method687() {
        field6127++;
        return null;
    }

    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(Lof;Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "([III)V", line = 94)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IDZ)Lof;", line = 161)
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "()Leha;", line = 186)
    public final class98 method688() {
        field6117++;
        return null;
    }

    @OriginalMember(owner = "client!dg", name = "d", descriptor = "()I", line = 195)
    public final int method691() {
        field6126++;
        return 1;
    }

    @OriginalMember(owner = "client!dg", name = "c", descriptor = "(I)D", line = 203)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIILd;IILha;)V", line = 223)
    ...
    @OriginalMember(owner = "client!dg", name = "g", descriptor = "(I)Lof;", line = 303)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(Z)V", line = 314)
    ...
    @OriginalMember(owner = "client!dg", name = "h", descriptor = "(I)I", line = 324)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(ZI)V", line = 336)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(B)V", line = 348)
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(I)V", line = 431)
    public class430(int arg0) {
        this.field6121 = arg0;
    }

    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(II)V", line = 375)
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(Z)Z", line = 386)
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(II)V", line = 407)
