...
public class class430 extends class448 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lvf;", line = 3)
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(II)Lub;", line = 39)
    ...
    @OriginalMember(owner = "client!iq", name = "c", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!iq", name = "c", descriptor = "(B)V", line = 91)
