...
public class class430 extends class359 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(B[BLdm;[I)Z")
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ILbk;)Lcc;")
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(II)Lpn;")
