...
public class class430 extends class477 {
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(Lgk;Lwl;)V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lbt;I)Lpf;")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lrh;II)V")
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(Lbt;I)Lsh;")
