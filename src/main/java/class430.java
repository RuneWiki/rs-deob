...
public class class430 {
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(Lqg;)V", line = 73)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IIILnh;Lnh;)V", line = 38)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "([BBI)I", line = 51)
