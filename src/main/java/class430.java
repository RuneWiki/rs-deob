...
public class class430 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;IZB)V")
    ...
    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "(Lfha;III)V")
