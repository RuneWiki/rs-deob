...
public class class204 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IIIIIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(BI)V", line = 122)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Lfd;B)V", line = 200)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(I)V", line = 222)
    ...
    @OriginalMember(owner = "client!pb", name = "b", descriptor = "(I)I", line = 257)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(II)Ldn;", line = 367)
