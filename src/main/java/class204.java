...
public class class204 {
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Lfp;BLct;)V", line = 3)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(Z)V", line = 151)
