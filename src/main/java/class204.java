...
public class class204 extends class459 {
    ...
    @OriginalMember(owner = "client!sa", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!sa", name = "b", descriptor = "(B)[B", line = 18)
    ...
    @OriginalMember(owner = "client!sa", name = "f", descriptor = "(I)I", line = 50)
