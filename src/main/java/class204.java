...
public class class204 extends class399 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "([J[IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IIIIIB)V", line = 15)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(II)V", line = 118)
    ...
    @OriginalMember(owner = "client!uk", name = "b", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!uk", name = "c", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!uk", name = "d", descriptor = "(I)V", line = 168)
    ...
    @OriginalMember(owner = "client!uk", name = "e", descriptor = "(I)Ljava/lang/String;", line = 227)
