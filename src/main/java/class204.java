...
public class class204 extends class263 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lgn;B)V", line = 8)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I[S)[S", line = 621)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "()V", line = 672)
    public class204() {
        super(0, true);
    }

    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ILya;)V", line = 646)
    ...
    @OriginalMember(owner = "client!lr", name = "c", descriptor = "(B)V", line = 662)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IZLgk;)V", line = 677)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IB)[I", line = 772)
    ...
    @OriginalMember(owner = "client!lr", name = "d", descriptor = "(I)V", line = 1026)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "([[IIIILjava/util/Random;II)V", line = 1063)
