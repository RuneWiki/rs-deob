...
public class class204 extends class451 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(I[BII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(I[BB)I", line = 92)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(II)V", line = 108)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(B)V", line = 139)
    ...
    @OriginalMember(owner = "client!q", name = "b", descriptor = "(B)V", line = 158)
