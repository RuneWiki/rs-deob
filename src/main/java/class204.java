...
public class class204 {
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(ILpk;)V", line = 14)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(IIIIIII)V", line = 37)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!lda", name = "b", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(Lrb;B)V", line = 124)
    ...
    @OriginalMember(owner = "client!lda", name = "b", descriptor = "(Lrb;B)V", line = 146)
    ...
    @OriginalMember(owner = "client!lda", name = "c", descriptor = "(I)Lki;", line = 170)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(ILhs;)V", line = 188)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(III[B)Ljava/lang/String;", line = 199)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(ILce;I)V", line = 250)
    ...
    @OriginalMember(owner = "client!lda", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 508)
    public class204(String arg0) {
        this.field2415 = arg0;
    }

    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(B[[BLuk;)V", line = 279)
    ...
    @OriginalMember(owner = "client!lda", name = "d", descriptor = "(I)V", line = 363)
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(ZLr;)V", line = 486)
