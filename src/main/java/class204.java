...
public class class204 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Lofa;II)V", line = 21)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ILofa;)V", line = 56)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IILjava/lang/String;Z)Z", line = 82)
