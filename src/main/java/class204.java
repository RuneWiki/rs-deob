...
public class class204 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(B)Lcv;")
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Lcv;I)V")
    ...
    @OriginalMember(owner = "client!vu", name = "c", descriptor = "(I)Lcv;")
    ...
    @OriginalMember(owner = "client!vu", name = "c", descriptor = "(B)Lcv;")
    ...
    @OriginalMember(owner = "client!vu", name = "d", descriptor = "(B)Lcv;")
