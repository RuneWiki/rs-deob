...
public class class204 extends class108 {
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(Laj;IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(BS)V", line = 45)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "([[ZIIII)V", line = 61)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(BI)I", line = 121)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(IIIIIII)V", line = 137)
    ...
    @OriginalMember(owner = "client!ica", name = "<init>", descriptor = "(Ljj;Lvh;Luca;[I)V", line = 319)
