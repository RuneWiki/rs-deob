...
public class class204 {
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(BI)[[[B", line = 23)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(Lsba;I)Z", line = 804)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(BLii;)Lsa;", line = 819)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(Z)V", line = 843)
    ...
    @OriginalMember(owner = "client!sba", name = "b", descriptor = "(B)V", line = 868)
