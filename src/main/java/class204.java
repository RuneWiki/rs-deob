...
public class class204 {
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(ILtq;IIIIIII)V")
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Lbg;B)V")
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Lug;Z)Z")
