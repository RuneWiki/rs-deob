...
public class class204 extends class337 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 370)
    public class204(String arg0) {
        this.field2823 = arg0;
    }

    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(IZLfda;)V", line = 47)
