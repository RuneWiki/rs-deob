...
public class class204 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(ZLfi;)V")
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(B)Ls;")
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lbd;I)V")
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(B)Ls;")
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(ILoa;IIIIIIIIII)Z")
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Lfi;)V")
