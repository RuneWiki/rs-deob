...
public class class204 extends class16 {
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!aj", name = "d", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(Z)V", line = 49)
    ...
    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(I)V", line = 60)
