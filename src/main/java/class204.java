...
public class class204 implements class255 {
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(Z)Lqi;", line = 7)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(ILkba;)V", line = 18)
    ...
    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "(I)V", line = 486)
    public class204(int arg0) {
        this.field2588 = arg0;
    }

    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(II[B)[B", line = 494)
    ...
    @OriginalMember(owner = "client!mfa", name = "b", descriptor = "(Z)V", line = 510)
