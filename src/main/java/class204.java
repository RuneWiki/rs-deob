...
public class class204 extends class747 implements class200 {
    ...
    @OriginalMember(owner = "client!tw", name = "<init>", descriptor = "(Lbga;II[III)V")
    ...
    @OriginalMember(owner = "client!tw", name = "<init>", descriptor = "(Lbga;Lwq;II[BII)V")
    ...
    @OriginalMember(owner = "client!tw", name = "<init>", descriptor = "(Lbga;Lwq;Lbaa;II)V")
    ...
    @OriginalMember(owner = "client!tw", name = "<init>", descriptor = "(Lbga;Lwq;II[FII)V")
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(IIBIIII[BLwq;)V")
