...
public class class204 {
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(III[I)Lvfa;")
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(II[IB)Lvfa;")
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(I[II)Lvfa;")
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "([Ltb;B)V")
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "([IBI)Lvfa;")
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(Llga;Llga;)V")
