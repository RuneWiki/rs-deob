...
public class class204 extends class447 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(ILja;)V", line = 7)
    ...
    @OriginalMember(owner = "client!pb", name = "d", descriptor = "(II)V", line = 30)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(BLja;)Lkh;", line = 86)
    ...
    @OriginalMember(owner = "client!pb", name = "b", descriptor = "(B)Z", line = 118)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IZIII)V", line = 131)
    ...
    @OriginalMember(owner = "client!pb", name = "<init>", descriptor = "(IIIIIIIIIII)V", line = 247)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!pb", name = "d", descriptor = "(B)V", line = 200)
    ...
    @OriginalMember(owner = "client!pb", name = "d", descriptor = "(I)V", line = 213)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(ILja;II)Z", line = 224)
    ...
    @OriginalMember(owner = "client!pb", name = "finalize", descriptor = "()V", line = 236)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(BLja;Lrc;)V", line = 274)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IBZIILnf;Lja;)V", line = 303)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IILja;)Lrc;", line = 322)
    ...
    @OriginalMember(owner = "client!pb", name = "e", descriptor = "(I)I", line = 348)
