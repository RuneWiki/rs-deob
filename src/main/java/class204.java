...
public abstract class class204 {
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(I)Z", line = 15)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(II)I", line = 36)
    ...
    @OriginalMember(owner = "client!li", name = "c", descriptor = "(II)V", line = 49)
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Lfs;)V", line = 61)
    public class204(class607 arg0) {
        this.field2853 = arg0;
        this.field2852 = this.method490((byte) 88);
    }

    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(ILfs;)V", line = 69)
    public class204(int arg0, class607 arg1) {
        this.field2853 = arg1;
        this.field2852 = arg0;
    }

    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Z)V", line = 78)
