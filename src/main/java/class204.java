...
public class class204 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IIILjk;II)Luf;", line = 4)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(II)Lsq;", line = 49)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(ZI)V", line = 82)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(Lal;ILmg;)V", line = 138)
