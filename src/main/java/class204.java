...
public class class204 extends class613 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Llea;)V", line = 4)
    public final synchronized void method1319(class613 arg0) {
        arg0.method1175(-2);
    }

    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Ldfa;Lwr;)V", line = 9)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!fq", name = "b", descriptor = "(Llea;)V", line = 66)
    public final synchronized void method1321(class613 arg0) {
        this.field2721.method3659(false, arg0);
    }

    @OriginalMember(owner = "client!fq", name = "d", descriptor = "()I", line = 69)
    public final int method349() {
        return 0;
    }

    @OriginalMember(owner = "client!fq", name = "a", descriptor = "([III)V", line = 78)
    ...
    @OriginalMember(owner = "client!fq", name = "b", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "()Llea;", line = 136)
    public final class613 method317() {
        return (class613) this.field2721.method3672(-1);
    }

    @OriginalMember(owner = "client!fq", name = "e", descriptor = "()V", line = 141)
    ...
    @OriginalMember(owner = "client!fq", name = "f", descriptor = "()I", line = 158)
    public final synchronized int method1324() {
        return this.field2721.method3666(0);
    }

    @OriginalMember(owner = "client!fq", name = "c", descriptor = "([III)V", line = 163)
    ...
    @OriginalMember(owner = "client!fq", name = "b", descriptor = "()Llea;", line = 174)
    public final class613 method327() {
        return (class613) this.field2721.method3662(-1);
    }

    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Lwr;)V", line = 178)
