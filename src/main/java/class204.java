...
public class class204 extends class278 {
    ...
    @OriginalMember(owner = "client!aj", name = "g", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Ljava/lang/String;II)I", line = 21)
    ...
    @OriginalMember(owner = "client!aj", name = "d", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(II)[I", line = 47)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(II)[[I", line = 97)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Llh;II)V", line = 159)
