...
public class class204 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IILhn;Lcu;ZILso;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIIIIIZLva;IIILeq;Ljl;II)Lva;", line = 94)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIIZLjl;II)V", line = 317)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IZZ)V", line = 377)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(B)V", line = 442)
