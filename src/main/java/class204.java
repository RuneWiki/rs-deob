...
public class class204 extends class467 {
    ...
    @OriginalMember(owner = "client!vi", name = "b", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(Lps;)V", line = 84)
    public class204(class5 arg0) {
        this.field2867 = arg0;
    }

    @OriginalMember(owner = "client!vi", name = "a", descriptor = "(IIZ)Z", line = 50)
