...
public class class204 {
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Luk;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Luk;Z)V", line = 161)
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "(Lbf;)V", line = 361)
    ...
    @OriginalMember(owner = "client!rd", name = "b", descriptor = "(Luk;)V", line = 322)
