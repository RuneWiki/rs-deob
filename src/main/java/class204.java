...
public class class204 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(I)Z", line = 15)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(ILal;Z)V", line = 26)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(ZB)V", line = 123)
    ...
    @OriginalMember(owner = "client!vn", name = "c", descriptor = "(B)V", line = 151)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IBBZI)Lje;", line = 171)
    ...
    @OriginalMember(owner = "client!vn", name = "d", descriptor = "(B)V", line = 214)
    ...
    @OriginalMember(owner = "client!vn", name = "e", descriptor = "(B)V", line = 227)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(I)Z", line = 257)
    ...
    @OriginalMember(owner = "client!vn", name = "c", descriptor = "(I)I", line = 538)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(II)Z", line = 549)
    ...
    @OriginalMember(owner = "client!vn", name = "d", descriptor = "(I)V", line = 561)
    ...
    @OriginalMember(owner = "client!vn", name = "f", descriptor = "(B)Z", line = 571)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Lnf;I)Z", line = 591)
    ...
    @OriginalMember(owner = "client!vn", name = "e", descriptor = "(I)V", line = 621)
