...
public class class204 extends class440 {
    ...
    @OriginalMember(owner = "client!jda", name = "c", descriptor = "(III)I", line = 12)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(Lpu;Ljava/lang/String;ZI)Lam;", line = 28)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!jda", name = "b", descriptor = "(II)V", line = 93)
    ...
    @OriginalMember(owner = "client!jda", name = "<init>", descriptor = "()V", line = 344)
    public class204() {
        super(1, false);
    }

    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(IB)Z", line = 347)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(ILmo;I)V", line = 358)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(ILwe;)V", line = 396)
    ...
    @OriginalMember(owner = "client!jda", name = "g", descriptor = "(I)V", line = 412)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(II)[[I", line = 514)
