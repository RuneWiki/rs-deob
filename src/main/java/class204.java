...
public class class204 extends class758 {
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Lod;BFLod;)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ru", name = "e", descriptor = "(I)V", line = 205)
    ...
    @OriginalMember(owner = "client!ru", name = "f", descriptor = "(I)V", line = 215)
    ...
    @OriginalMember(owner = "client!ru", name = "c", descriptor = "(I)Lod;", line = 225)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(B)I", line = 242)
    ...
    @OriginalMember(owner = "client!ru", name = "b", descriptor = "(B)V", line = 257)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IIIIIII)I", line = 271)
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(Lffa;I)V", line = 311)
