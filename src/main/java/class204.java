...
public class class204 extends class396 {
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(Lep;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(Lep;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(Lep;IIII)V")
    ...
    @OriginalMember(owner = "client!fq", name = "h", descriptor = "(I)Loj;")
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(Lep;IIIII)V")
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(Lep;IIIIZ[IIIZ)V")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(III)Lfw;")
