...
public class class204 extends class362 {
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Lfca;II)V", line = 7)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IB)[[I", line = 42)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(II)[I", line = 110)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(II)I", line = 164)
    public static int method1456(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!kk", name = "d", descriptor = "(B)V", line = 172)
    ...
    @OriginalMember(owner = "client!kk", name = "c", descriptor = "(I)V", line = 188)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "()V", line = 211)
    public class204() {
        super(1, false);
    }
}
