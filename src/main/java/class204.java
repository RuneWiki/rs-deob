...
public class class204 extends class545 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(Lrg;Lal;IIIIIIIIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!fq", name = "c", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Z)Lww;", line = 61)
