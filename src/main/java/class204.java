...
public class class204 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ILvq;[[ILuh;[[BILuh;[[BZI[[B[[BI)V")
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(II)Lph;")
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(Lsf;II)Lkq;")
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(ZLtj;)V")
