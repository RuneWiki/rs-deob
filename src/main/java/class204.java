...
public class class204 extends class387 {
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(BLwu;Lwu;Lwu;Lwu;)V", line = 3)
    ...
    @OriginalMember(owner = "client!tw", name = "<init>", descriptor = "(Lrda;)V", line = 25)
    public class204(class663 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(I)Z", line = 29)
    ...
    @OriginalMember(owner = "client!tw", name = "b", descriptor = "(III)Z", line = 44)
    ...
    @OriginalMember(owner = "client!tw", name = "b", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(Z)V", line = 70)
    public final void method644(boolean arg0) {
        ++field3049;
        super.field5405.method3652(41, arg0);
    }

    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(BZ)V", line = 79)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(III)V", line = 91)
    public final void method643(int arg0, int arg1, int arg2) {
        int var4 = 46 % ((arg2 - 74) / 36);
        ++field3055;
    }

    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(ZB)V", line = 100)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(BILiga;)V", line = 116)
