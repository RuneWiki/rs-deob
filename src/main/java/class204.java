...
public class class204 extends class309 {
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!dea", name = "c", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(IC)Z", line = 40)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(IIIIIIII[[[BILqa;II)V", line = 51)
    ...
    @OriginalMember(owner = "client!dea", name = "<init>", descriptor = "(Lbda;II[B)V", line = 84)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!dea", name = "<init>", descriptor = "(Lbda;II[I)V", line = 258)
