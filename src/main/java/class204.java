...
public class class204 extends class311 {
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(II)Lwk;")
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lij;Lij;I)V")
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lrg;B)Lwr;")
    ...
    @OriginalMember(owner = "client!po", name = "c", descriptor = "(I)[Lip;")
