...
public class class204 extends class245 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(IIIIIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IBI)V", line = 57)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(III)V", line = 76)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(BII)V", line = 96)
