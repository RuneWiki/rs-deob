...
public class class204 extends class148 {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(BLic;IZIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "()V", line = 28)
    public class204() {
        super(0, true);
    }

    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IIZ)Z", line = 35)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(B[Ljava/lang/Object;[I)V", line = 65)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(III)Z", line = 77)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(CI)Z", line = 101)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(I)V", line = 137)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(II)[I", line = 150)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ILdh;I)V", line = 209)
