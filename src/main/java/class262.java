...
public abstract class class262 {
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(DI)V", line = 24)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(II)Z", line = 58)
