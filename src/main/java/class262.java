...
public class class262 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Ljava/lang/String;Ljava/applet/Applet;B)Ljava/lang/Object;", line = 3)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "([Ljava/lang/Object;Ljava/lang/String;Ljava/applet/Applet;I)Ljava/lang/Object;", line = 15)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Ljava/lang/String;Ljava/applet/Applet;I)V", line = 25)
