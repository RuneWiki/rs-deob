...
public class class262 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(ILuq;)V", line = 4)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(IBI)Z", line = 34)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(IIBI)Luj;", line = 64)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(I)Lgf;", line = 80)
    ...
    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "(IIIIB)V", line = 92)
    ...
    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "(Luj;I)V", line = 103)
