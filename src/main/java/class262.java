...
public class class262 extends class377 {
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(ILjava/lang/String;)I", line = 3)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(II)[I", line = 38)
    ...
    @OriginalMember(owner = "client!vca", name = "<init>", descriptor = "()V", line = 71)
    public class262() {
        super(0, true);
    }

    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(BII)I", line = 74)
