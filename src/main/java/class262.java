...
public class class262 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(II)[B", line = 14)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(I[IBII)V", line = 50)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(I[I[II[[BI[[B[B)I", line = 78)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(III)Z", line = 138)
