...
public class class262 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Z)Lag;")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(I)Lag;")
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(Lad;)V")
