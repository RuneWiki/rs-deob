...
public abstract class class262 {
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(IILn;I)V")
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Lun;I)Lat;")
    ...
    @OriginalMember(owner = "client!jfa", name = "<init>", descriptor = "(Lifa;)V")
    public class262(class393 arg0) {
        this.field3601 = arg0;
    }

    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(B[IILkfa;)V")
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(B)[Lpe;")
