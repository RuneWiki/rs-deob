...
public class class262 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(III[I)Lqr;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIZ[I)Lqr;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(II[I)Lqr;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(I[IB)Lqr;")
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Lri;Lri;)V")
