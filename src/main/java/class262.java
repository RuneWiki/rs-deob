...
public class class262 {
    ...
    @OriginalMember(owner = "client!wt", name = "n", descriptor = "[B")
    public static byte[] field3727 = new byte[2048];
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(I)V", line = 16)
