...
public class class262 extends class298 {
    ...
    @OriginalMember(owner = "client!lt", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "()V", line = 20)
    public class262() {
        super(1, false);
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(II)[[I", line = 34)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IILvt;)V", line = 120)
