...
public class class262 extends class568 {
    ...
    @OriginalMember(owner = "client!ae", name = "c", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(CB)Z", line = 45)
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(II)Lhu;", line = 73)
    ...
    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "(II)V", line = 88)
