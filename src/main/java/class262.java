...
public class class262 {
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(IILmo;)V")
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(B)Ld;")
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(ZLmo;)V")
