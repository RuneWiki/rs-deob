...
public class class262 {
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(I)Lof;")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lof;I)V")
    ...
    @OriginalMember(owner = "client!l", name = "c", descriptor = "(I)Lof;")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lrk;BI)Lqe;")
