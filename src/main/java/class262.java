...
public class class262 extends class168 {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(II)Z", line = 14)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Z)I", line = 25)
    ...
    @OriginalMember(owner = "client!fc", name = "b", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!fc", name = "c", descriptor = "(I)I", line = 64)
    public final int method1573(int arg0) {
        field3292++;
        return arg0 == 0 ? this.field3291 >> 18 & 0x7 : -54;
    }

    @OriginalMember(owner = "client!fc", name = "b", descriptor = "(Z)V", line = 80)
    ...
    @OriginalMember(owner = "client!fc", name = "c", descriptor = "(Z)Z", line = 99)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(B)Z", line = 115)
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(II)V", line = 131)
