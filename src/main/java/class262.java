...
public class class262 extends class264 {
    ...
    @OriginalMember(owner = "client!sr", name = "c", descriptor = "(BI)C", line = 3)
    ...
    @OriginalMember(owner = "client!sr", name = "b", descriptor = "(BI)V", line = 31)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(Lmfa;)V", line = 42)
    public class262(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(BI)I", line = 45)
    ...
    @OriginalMember(owner = "client!sr", name = "c", descriptor = "(I)Z", line = 77)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(B)I", line = 88)
    ...
    @OriginalMember(owner = "client!sr", name = "b", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!sr", name = "b", descriptor = "(B)I", line = 134)
    public final int method1723(byte arg0) {
        ++field3696;
        return arg0 > -31 ? -63 : super.field3733;
    }

    @OriginalMember(owner = "client!sr", name = "d", descriptor = "(I)Z", line = 145)
    ...
    @OriginalMember(owner = "client!sr", name = "c", descriptor = "(B)V", line = 157)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(ILmfa;)V", line = 171)
    public class262(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IIIII)V", line = 174)
