...
public class class262 extends class696 implements class550 {
    ...
    @OriginalMember(owner = "client!oca", name = "c", descriptor = "(B)Ljj;", line = 7)
    ...
    @OriginalMember(owner = "client!oca", name = "<init>", descriptor = "(Leea;Lkca;III[B)V", line = 35)
    ...
    @OriginalMember(owner = "client!oca", name = "b", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(ILdm;)V", line = 72)
