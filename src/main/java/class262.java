...
public class class262 extends class194 {
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(Lbl;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(Lbl;IIIII)V")
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(Lbl;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(Lbl;IIII)V")
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(Lbl;IIIIZ[IZ)V")
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(ILta;)V")
