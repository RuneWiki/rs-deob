...
public class class262 extends class206 {
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(ILjagtheora/ogg/OggPacket;)V")
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "([BZ)[B")
    ...
    @OriginalMember(owner = "client!oca", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    ...
    @OriginalMember(owner = "client!oca", name = "b", descriptor = "(Z)D")
    ...
    @OriginalMember(owner = "client!oca", name = "b", descriptor = "(B)Ltv;")
