...
public class class262 extends class139 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(II)V", line = 8)
    public final void method18(int arg0, int arg1) {
        ++field3606;
    }

    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(Lno;IIII[[I[[II)V", line = 18)
    ...
    @OriginalMember(owner = "client!sm", name = "c", descriptor = "(IILw;)Lw;", line = 76)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lnw;IBI)V", line = 104)
    ...
    @OriginalMember(owner = "client!sm", name = "JA", descriptor = "(II)I", line = 166)
    public final int method195(int arg0, int arg1) {
        ++field3638;
        return this.field3605[arg0][arg1];
    }

    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(III[[ZZ)V", line = 174)
    ...
    @OriginalMember(owner = "client!sm", name = "EA", descriptor = "(III)V", line = 190)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(B)V", line = 202)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 235)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIIIIII[[Z)V", line = 329)
    ...
    @OriginalMember(owner = "client!sm", name = "BA", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 502)
    ...
    @OriginalMember(owner = "client!sm", name = "FA", descriptor = "(Lw;IIIIZ)V", line = 574)
    ...
    @OriginalMember(owner = "client!sm", name = "aa", descriptor = "(Lw;IIIIZ)V", line = 594)
    ...
    @OriginalMember(owner = "client!sm", name = "ba", descriptor = "()V", line = 616)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ZLjava/io/File;)[B", line = 1192)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lw;IIIIZ)Z", line = 1205)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lpv;[I)V", line = 1225)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(II[[ZZIII)V", line = 1242)
    ...
    @OriginalMember(owner = "client!sm", name = "sa", descriptor = "(II)I", line = 1384)
    ...
    @OriginalMember(owner = "client!sm", name = "b", descriptor = "(I)V", line = 1418)
