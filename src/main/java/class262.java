...
public class class262 extends class195 {
    ...
    @OriginalMember(owner = "client!qa", name = "c", descriptor = "(III)Z", line = 8)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(ZIIIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!qa", name = "e", descriptor = "(I)V", line = 469)
    ...
    @OriginalMember(owner = "client!qa", name = "f", descriptor = "(I)V", line = 483)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(BIIII)V", line = 513)
    ...
    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "(Ldia;II)V", line = 536)
