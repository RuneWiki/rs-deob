...
public class class262 {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!fc", name = "b", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(ILjava/lang/Class;Ljava/lang/String;)Z", line = 31)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lbda;I)V", line = 100)
    ...
    @OriginalMember(owner = "client!fc", name = "c", descriptor = "(I)I", line = 118)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(B)V", line = 143)
    ...
    @OriginalMember(owner = "client!fc", name = "d", descriptor = "(I)I", line = 160)
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(I)V", line = 177)
    public class262(int arg0) {
        this(arg0, arg0);
    }

    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(BI)V", line = 180)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(BIII)I", line = 228)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IJ)Ljava/lang/Object;", line = 258)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Z)Ljava/lang/Object;", line = 302)
    ...
    @OriginalMember(owner = "client!fc", name = "b", descriptor = "(Z)Ljava/lang/Object;", line = 338)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(JLjava/lang/Object;B)V", line = 369)
    ...
    @OriginalMember(owner = "client!fc", name = "b", descriptor = "(B)V", line = 380)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IJILjava/lang/Object;)V", line = 409)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(JI)V", line = 443)
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(II)V", line = 461)
