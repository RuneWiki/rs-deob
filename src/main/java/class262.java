...
public abstract class class262 implements class623 {
    ...
    @OriginalMember(owner = "client!cca", name = "c", descriptor = "(B)J", line = 4)
    ...
    @OriginalMember(owner = "client!cca", name = "finalize", descriptor = "()V", line = 23)
    ...
    @OriginalMember(owner = "client!cca", name = "<init>", descriptor = "(Loia;IZ)V", line = 311)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(Ljaggl/MapBuffer;BZ)Ljaclib/memory/Buffer;", line = 44)
    ...
    @OriginalMember(owner = "client!cca", name = "d", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(ILjaclib/memory/Source;Z)Z", line = 128)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(Z)V", line = 169)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(II)V", line = 188)
    ...
    @OriginalMember(owner = "client!cca", name = "e", descriptor = "(I)I", line = 222)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(Ljaggl/MapBuffer;B)Z", line = 244)
    ...
    @OriginalMember(owner = "client!cca", name = "f", descriptor = "(I)V", line = 275)
    ...
    @OriginalMember(owner = "client!cca", name = "b", descriptor = "(B)I", line = 299)
