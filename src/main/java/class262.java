...
public class class262 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Lct;I)I", line = 14)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Lgt;BLjava/awt/Frame;)V", line = 83)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Lfp;B)V", line = 109)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(B)V", line = 186)
