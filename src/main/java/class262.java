...
public class class262 extends class158 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(BIZ)Lba;")
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Luq;[Lsb;)V")
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Luq;)V")
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Luq;Lqda;IIII)V")
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lcr;[Lsb;)Lsb;")
