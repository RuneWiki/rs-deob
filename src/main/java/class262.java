...
public class class262 {
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(II)[B", line = 13)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(BI)V", line = 78)
    ...
    @OriginalMember(owner = "client!bp", name = "b", descriptor = "(II)V", line = 91)
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "(Ljk;ILfs;)V", line = 136)
    ...
    @OriginalMember(owner = "client!bp", name = "c", descriptor = "(II)Lki;", line = 109)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(IIILjava/lang/Class;)Lpe;", line = 161)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(B)V", line = 186)
    ...
    @OriginalMember(owner = "client!bp", name = "b", descriptor = "(B)V", line = 199)
