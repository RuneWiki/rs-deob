...
public abstract class class262 {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(B)Llb;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lvfa;BIILrc;Ljava/lang/String;IIIILda;Laa;)V")
    ...
    @OriginalMember(owner = "client!fc", name = "c", descriptor = "(B)Lei;")
    ...
    @OriginalMember(owner = "client!fc", name = "d", descriptor = "(B)Lbc;")
    ...
    @OriginalMember(owner = "client!fc", name = "f", descriptor = "(I)Lsc;")
