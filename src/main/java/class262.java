...
public abstract class class262 extends class117 {
    ...
    @OriginalMember(owner = "client!ah", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lhd;I)Lhd;", line = 39)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(B)Z", line = 70)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(BI)V", line = 81)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lgg;IZIIILya;)V", line = 122)
