...
public class class262 extends class165 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lwu;Lwu;Lwu;ILwu;)V")
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(Lep;Lfa;)V")
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IZLhl;)V")
