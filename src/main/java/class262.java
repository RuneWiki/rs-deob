...
public abstract class class262 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IIZLjava/lang/String;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "([Lha;IIBLpa;IIIIIIILjava/lang/String;I[III)I", line = 21)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "([ILjava/lang/String;[I[Lha;II[II)V", line = 123)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IIIIILjava/lang/String;B)V", line = 295)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Ljava/lang/String;I[Lha;I[IIILjava/util/Random;II)I", line = 331)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Ljava/lang/String;IIIII)V", line = 369)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Ljava/lang/String;IIIIII)V", line = 394)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IBI)V", line = 428)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ILqa;)V", line = 448)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(BLjava/lang/String;)V", line = 513)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Ljava/lang/String;BI)V", line = 587)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ILjava/lang/String;IBIIII)V", line = 629)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(I)V", line = 666)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "([Lha;BIIIILjava/lang/String;[I)V", line = 679)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(II[IIIILjava/lang/String;IIILpa;I[Lha;III)I", line = 694)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "([IZIILjava/util/Random;IIIIIIILjava/lang/String;[I[Lha;)I", line = 705)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lqa;B)V", line = 780)
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(Lqa;Ldd;)V", line = 805)
    public class262(class167 arg0, class166 arg1) {
        this.field3875 = arg1;
        this.field3868 = arg0;
    }

    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ILpa;IZ[Lha;I[IILjava/lang/String;)V", line = 814)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IILjava/lang/String;III)V", line = 966)
