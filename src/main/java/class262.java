...
public class class262 extends class214 {
    ...
    @OriginalMember(owner = "client!ns", name = "f", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ns", name = "e", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(BI)[I", line = 40)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(II)[I", line = 83)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(BI)V", line = 102)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Llk;II)V", line = 125)
    ...
    @OriginalMember(owner = "client!ns", name = "c", descriptor = "(Z)V", line = 154)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(IB)Z", line = 174)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(B)V", line = 222)
    ...
    @OriginalMember(owner = "client!ns", name = "g", descriptor = "(I)I", line = 401)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "()V", line = 413)
    public class262() {
        super(1, true);
    }
}
