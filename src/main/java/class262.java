...
public class class262 extends class388 {
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(Ljf;Z)Z", line = 4)
    ...
    @OriginalMember(owner = "client!cfa", name = "c", descriptor = "(Z)V", line = 120)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(IIIII[ILkw;Z)Lof;", line = 131)
    ...
    @OriginalMember(owner = "client!cfa", name = "c", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!cfa", name = "d", descriptor = "(I)Ljava/lang/String;", line = 172)
    ...
    @OriginalMember(owner = "client!cfa", name = "<init>", descriptor = "(Lkba;)V", line = 194)
