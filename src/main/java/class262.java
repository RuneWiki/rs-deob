...
public class class262 {
    ...
    @OriginalMember(owner = "client!l", name = "finalize", descriptor = "()V", line = 3)
    protected final void finalize() throws Throwable {
        this.field3605.method2164(this.field3607);
        super.finalize();
    }

    @OriginalMember(owner = "client!l", name = "<init>", descriptor = "(Lmm;II)V", line = 15)
    private class262(class357 arg0, int arg1, int arg2) {
        this.field3605 = arg0;
        this.field3607 = arg2;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lmm;ILjava/lang/String;)Ll;", line = 23)
