...
public class class262 extends class649 {
    ...
    @OriginalMember(owner = "client!cfa", name = "<init>", descriptor = "(ILhs;)V")
    ...
    @OriginalMember(owner = "client!cfa", name = "<init>", descriptor = "(Lhs;)V")
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(Lov;ILvga;I)V")
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(IB)V")
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(IIIIILha;)V")
