...
public class class262 extends class127 implements class60 {
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(IIILjaclib/memory/Source;)Z")
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!te", name = "<init>", descriptor = "(Lck;Z)V")
