...
public class class262 {
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(B)Lgh;")
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Z)[Lha;")
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(ILgh;)V")
    ...
    @OriginalMember(owner = "client!mb", name = "b", descriptor = "(B)Lgh;")
    ...
    @OriginalMember(owner = "client!mb", name = "b", descriptor = "(Z)Lgh;")
    ...
    @OriginalMember(owner = "client!mb", name = "b", descriptor = "(I)Lgh;")
