...
public class class262 extends class261 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(III[[ZZ)V", line = 11)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(IIIIIII)V", line = 68)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(SI)V", line = 232)
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "(B)V", line = 262)
    ...
    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "(Lda;Lwv;Lbk;[I)V", line = 283)
