...
public class class262 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Lhu;IIILjava/awt/Canvas;Lm;)Lqa;", line = 6)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Ljava/awt/Component;BZ)Lan;", line = 18)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(II)V", line = 30)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(II)Lao;", line = 44)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IIII)V", line = 102)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(Lgo;ILns;)V", line = 132)
