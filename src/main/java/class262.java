...
public class class262 extends class360 implements class231 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(IZII)I", line = 3)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(ILqa;)Lkm;", line = 28)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(ZLqa;)V", line = 40)
    ...
    @OriginalMember(owner = "client!kf", name = "e", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!kf", name = "c", descriptor = "(I)V", line = 63)
    public final void method270(int arg0) {
        field3819++;
        int var2 = -3 / ((-arg0 - 1) / 47);
    }

    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Lco;B)V", line = 72)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(Z)I", line = 116)
    ...
    @OriginalMember(owner = "client!kf", name = "f", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(IIIZ)V", line = 140)
    ...
    @OriginalMember(owner = "client!kf", name = "d", descriptor = "(I)Z", line = 155)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(I)I", line = 168)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(BLqa;II)Z", line = 180)
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "(IIIIIIIIIILtv;)V", line = 191)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(I)I", line = 200)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(B)I", line = 212)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Lqa;B)V", line = 223)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Lqa;I)Lbi;", line = 235)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(BZILqa;IILcea;)V", line = 255)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Z)Z", line = 266)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(ILqa;Z)Lr;", line = 277)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(ILqa;)V", line = 289)
