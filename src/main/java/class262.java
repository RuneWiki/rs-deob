...
public abstract class class262 extends class447 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(JI)V", line = 4)
    ...
    @OriginalMember(owner = "client!la", name = "d", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Lrg;II)Ljava/lang/String;", line = 40)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljj;ZI)V", line = 66)
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(Lc;)V", line = 132)
