...
public class class262 {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ILam;)V")
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ZLtq;I)V")
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Ltq;III)V")
