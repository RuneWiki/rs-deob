...
public class class262 {
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(IIILmea;)V")
    ...
    @OriginalMember(owner = "client!gca", name = "b", descriptor = "(IB)Lkb;")
    ...
    @OriginalMember(owner = "client!gca", name = "<init>", descriptor = "(Ldt;ILwia;)V")
