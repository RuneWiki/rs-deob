...
public class class262 extends class494 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IBI)Z", line = 51)
    ...
    @OriginalMember(owner = "client!uk", name = "b", descriptor = "(I)V", line = 65)
