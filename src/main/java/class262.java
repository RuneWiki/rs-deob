...
public class class262 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(BIZ)Lge;", line = 3)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Lkd;[Loh;B)Lro;", line = 30)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(II)I", line = 100)
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "([I)V", line = 138)
