...
public class class404 extends class115 {
    ...
    @OriginalMember(owner = "client!hu", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!hu", name = "d", descriptor = "(B)Z", line = 20)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(JB)V", line = 41)
    ...
    @OriginalMember(owner = "client!hu", name = "<init>", descriptor = "(II)V", line = 110)
