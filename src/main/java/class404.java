...
public class class404 {
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(FFFI)F", line = 4)
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!vea", name = "toString", descriptor = "()Ljava/lang/String;", line = 35)
    public final String toString() {
        field5330++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(ZI)Z", line = 47)
    ...
    @OriginalMember(owner = "client!vea", name = "a", descriptor = "(III)V", line = 64)
    ...
    @OriginalMember(owner = "client!vea", name = "<init>", descriptor = "(I)V", line = 82)
