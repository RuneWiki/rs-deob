...
public class class404 {
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IIIIFZIII)[[I", line = 9)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(II)V", line = 39)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(ILjava/lang/String;Z)V", line = 53)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(ZZI)V", line = 128)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(I)V", line = 159)
