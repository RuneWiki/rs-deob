...
public class class404 extends class174 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!dda", name = "b", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!dda", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 15)
    public final synchronized void mouseExited(MouseEvent arg0) {
        field5552++;
        this.method2411(arg0.getY(), -1, arg0.getX());
    }

    @OriginalMember(owner = "client!dda", name = "b", descriptor = "(III)V", line = 24)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 42)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(IIIII)V", line = 55)
    ...
    @OriginalMember(owner = "client!dda", name = "c", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!dda", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 87)
    ...
    @OriginalMember(owner = "client!dda", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 112)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method2411(arg0.getY(), -1, arg0.getX());
        field5544++;
    }

    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(I)Z", line = 120)
    ...
    @OriginalMember(owner = "client!dda", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 132)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        field5558++;
        this.method2411(arg0.getY(), -1, arg0.getX());
    }

    @OriginalMember(owner = "client!dda", name = "b", descriptor = "(Z)Lhl;", line = 141)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(IIIBI)V", line = 152)
    ...
    @OriginalMember(owner = "client!dda", name = "f", descriptor = "(B)V", line = 193)
    ...
    @OriginalMember(owner = "client!dda", name = "b", descriptor = "(B)I", line = 207)
    ...
    @OriginalMember(owner = "client!dda", name = "c", descriptor = "(Z)V", line = 222)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(B)V", line = 235)
    ...
    @OriginalMember(owner = "client!dda", name = "d", descriptor = "(I)V", line = 262)
    ...
    @OriginalMember(owner = "client!dda", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 287)
    ...
    @OriginalMember(owner = "client!dda", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 318)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        field5550++;
        this.method2411(arg0.getY(), -1, arg0.getX());
    }

    @OriginalMember(owner = "client!dda", name = "d", descriptor = "(B)I", line = 335)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;Z)I", line = 345)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(Z)Z", line = 382)
    ...
    @OriginalMember(owner = "client!dda", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 393)
    ...
    @OriginalMember(owner = "client!dda", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 416)
