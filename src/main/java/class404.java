...
public class class404 extends class337 {
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IIII)I", line = 10)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(ILjava/awt/Component;)Lbv;", line = 39)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(IIII)V", line = 67)
    ...
    @OriginalMember(owner = "client!uo", name = "e", descriptor = "(I)V", line = 89)
