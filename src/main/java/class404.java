...
public class class404 extends class445 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IIIILr;ZI)V", line = 21)
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(I)V", line = 55)
