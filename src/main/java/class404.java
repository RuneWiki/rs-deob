...
public class class404 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(B)Lg;")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(BLg;)V")
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(B)Lg;")
