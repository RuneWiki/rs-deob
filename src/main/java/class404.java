...
public class class404 extends class407 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(ILpca;II)V", line = 18)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(IIIIILr;III)V", line = 44)
    ...
    @OriginalMember(owner = "client!ks", name = "<init>", descriptor = "(Lri;Lri;Lbl;)V", line = 184)
