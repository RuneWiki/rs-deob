...
public class class404 {
    ...
    @OriginalMember(owner = "client!ah", name = "d", descriptor = "(Lha;Lah;)Z", line = 3)
    public final boolean method3170(class66 arg0, class404 arg1) {
        return this.field6023 != null || this.method3173(arg0, arg1);
    }

    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lha;IIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(Lha;Lah;)V", line = 39)
    ...
    @OriginalMember(owner = "client!ah", name = "c", descriptor = "(Lha;Lah;)Z", line = 124)
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(Lha;)V", line = 159)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lha;Lah;)V", line = 219)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IIII)Z", line = 306)
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "()V", line = 364)
    public static final void method3177() {
        field6020 = null;
        field6035 = null;
    }

    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lha;)V", line = 368)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "()V", line = 447)
    public final void method3179() {
        this.field6023 = null;
    }

    @OriginalMember(owner = "client!ah", name = "c", descriptor = "()V", line = 455)
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 472)
