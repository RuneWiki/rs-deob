...
public abstract class class404 extends class179 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IBI)[I", line = 6)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(II)[I", line = 28)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(BII)V", line = 41)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ILha;I)V", line = 63)
    ...
    @OriginalMember(owner = "client!et", name = "d", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 88)
    ...
    @OriginalMember(owner = "client!et", name = "e", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!et", name = "f", descriptor = "(I)I", line = 165)
    ...
    @OriginalMember(owner = "client!et", name = "g", descriptor = "(I)I", line = 178)
    public int method2399(int arg0) {
        field5875++;
        return arg0 < 119 ? -77 : -1;
    }

    @OriginalMember(owner = "client!et", name = "a", descriptor = "(III)[[I", line = 189)
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(II)[[I", line = 225)
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(IZ)V", line = 236)
