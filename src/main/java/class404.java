...
public class class404 extends class252 {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!ti", name = "g", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!ti", name = "h", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!ti", name = "f", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!ti", name = "c", descriptor = "(B)V", line = 141)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(III)V", line = 160)
    ...
    @OriginalMember(owner = "client!ti", name = "d", descriptor = "(I)V", line = 188)
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(Ltb;Lpu;)V", line = 204)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(ZI)V", line = 232)
    ...
    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(ZI)V", line = 252)
    ...
    @OriginalMember(owner = "client!ti", name = "e", descriptor = "(I)Z", line = 265)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Lbb;II)V", line = 278)
