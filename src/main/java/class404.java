...
public class class404 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(BII)V", line = 9)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Z)I", line = 22)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(ZI)Lwl;", line = 53)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IZLjava/lang/String;Z)Z", line = 81)
    ...
    @OriginalMember(owner = "client!jl", name = "b", descriptor = "(Z)V", line = 156)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Lbf;Z)Z", line = 170)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(II)V", line = 263)
    ...
    @OriginalMember(owner = "client!jl", name = "c", descriptor = "(Z)I", line = 274)
    ...
    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "()V", line = 285)
    public class404() {
    }

    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(Lat;)V", line = 301)
