...
public class class404 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ILae;)V")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IZILae;IZI)Lbk;")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IIIIZLae;Lbk;I)V")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IILae;)V")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lae;B)V")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IIII)Lfj;")
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(Lae;Ljh;IIIIIIZI)V")
