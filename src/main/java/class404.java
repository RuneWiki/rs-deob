...
public abstract class class404 extends class687 {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IILgfa;IIZLoa;)V", line = 8)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(I[Lhba;Len;)Lkba;", line = 22)
    ...
    @OriginalMember(owner = "client!ti", name = "i", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(II)V", line = 105)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Z)V", line = 124)
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(IIIIIII)V", line = 134)
    ...
    @OriginalMember(owner = "client!ti", name = "g", descriptor = "(I)Z", line = 148)
