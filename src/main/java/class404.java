...
public abstract class class404 extends class101 {
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!dda", name = "d", descriptor = "(I)I", line = 25)
    ...
    @OriginalMember(owner = "client!dda", name = "e", descriptor = "(I)I", line = 36)
    ...
    @OriginalMember(owner = "client!dda", name = "<init>", descriptor = "(Ldia;)V", line = 50)
    public class404(class246 arg0) {
        this.field5860 = arg0;
    }

    @OriginalMember(owner = "client!dda", name = "f", descriptor = "(I)Z", line = 62)
    ...
    @OriginalMember(owner = "client!dda", name = "g", descriptor = "(I)V", line = 74)
