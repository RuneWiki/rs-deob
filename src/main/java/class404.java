...
public class class404 extends class24 {
    ...
    @OriginalMember(owner = "client!ee", name = "c", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ILms;)V", line = 38)
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(III)I", line = 58)
    ...
    @OriginalMember(owner = "client!ee", name = "c", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!ee", name = "c", descriptor = "(III)V", line = 93)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ZII)V", line = 103)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IIIII)V", line = 180)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IIIIIII)V", line = 195)
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "()V", line = 246)
    protected class404() {
    ...
    @OriginalMember(owner = "client!ee", name = "d", descriptor = "(I)V", line = 260)
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(Lkh;)V", line = 456)
