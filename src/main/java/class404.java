...
public class class404 {
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(ZI)Lfm;", line = 7)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(IZ)I", line = 36)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(I)V", line = 93)
    public static void method2505(int arg0) {
        int var1 = 62 % ((-arg0 - 23) / 52);
        field6139 = null;
    }

    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(II)I", line = 104)
    public static final int method2506(int arg0, int arg1) {
        field6137++;
        return arg1 == 32693 ? arg0 & 0xFF : -31;
    }

    @OriginalMember(owner = "client!ce", name = "b", descriptor = "(B)V", line = 115)
    ...
    @OriginalMember(owner = "client!ce", name = "<init>", descriptor = "(Lwv;ILqs;)V", line = 155)
    public class404(class535 arg0, int arg1, class496 arg2) {
        this.field6132 = arg2;
        this.field6132.method2940(30, -10511);
    }

    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(IB)V", line = 139)
