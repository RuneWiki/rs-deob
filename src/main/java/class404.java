...
public abstract class class404 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IB)V", line = 8)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Ld;Ld;I)V", line = 24)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!pb", name = "<init>", descriptor = "(III)V", line = 56)
    ...
    @OriginalMember(owner = "client!pb", name = "b", descriptor = "(IB)V", line = 66)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(II)V", line = 103)
