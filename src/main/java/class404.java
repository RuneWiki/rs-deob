...
public class class404 extends class182 {
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(Lql;[Llo;)V")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(BIZ)Lba;")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lap;[Llo;)Llo;")
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(Lql;)V")
    public class404(class173 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(Lql;Lfca;IIII)V")
