...
public abstract class class404 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IZIIII)I", line = 17)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIBIIII)Lqba;", line = 80)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(B)Z", line = 105)
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(I)Z", line = 117)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IJII)V", line = 129)
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(B)Z", line = 170)
    ...
    @OriginalMember(owner = "client!ka", name = "c", descriptor = "(B)V", line = 191)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(II)I", line = 203)
