...
public class class404 extends class61 {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!ga", name = "fa", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!ga", name = "b", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(Liw;Lhia;[Lfg;[I[I)V")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(CIIIZLaa;II)V")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ga", name = "b", descriptor = "([B[IIIIIIII)V")
