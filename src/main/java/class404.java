...
public abstract class class404 implements class330 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Ljaggl/opengl;IIIII[B)V")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Ljaggl/opengl;IIIIII[I)V")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Ljaggl/opengl;IIIII[F)V")
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(Lig;IIIZ)V")
