...
public class class404 implements class396 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Ljava/lang/Throwable;I)Ljava/lang/String;", line = 58)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(I)Z", line = 129)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(ZI)V", line = 143)
    ...
    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "(Luq;Lefa;)V", line = 183)
