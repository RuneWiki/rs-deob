...
public abstract class class404 {
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(III)B", line = 5)
    ...
    @OriginalMember(owner = "client!im", name = "b", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(BII)I", line = 62)
    ...
    @OriginalMember(owner = "client!im", name = "b", descriptor = "(III)V", line = 89)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IIIIIII)V", line = 102)
