...
public class class404 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IIBZ)I", line = 10)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(II)V", line = 43)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IIII)Z", line = 57)
