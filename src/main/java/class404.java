...
public class class404 implements class126 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(B)Ljv;", line = 9)
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "(Ljava/lang/String;Lrn;Lhv;IIII)V", line = 27)
