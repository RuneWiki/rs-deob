...
public class class404 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IILoa;)Z")
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IIIIIIILoa;II)V")
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Ljo;B)V")
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "(I[Loc;IIII)V")
