...
public class class404 extends class472 {
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ILl;Lum;)Z")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ZLum;ILl;II)[F")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IIBLum;)Lfe;")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(III)Les;")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(BZDIILum;Ll;)[I")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IZILum;ZILl;D)[I")
    ...
    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(Lfh;)V")
