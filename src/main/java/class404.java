...
public class class404 {
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(BI)Z", line = 4)
    public final boolean method2378(byte arg0, int arg1) {
        return arg0 > -105 ? true : this.field5599[arg1].method7();
    }

    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IBZZ)V", line = 14)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(BLet;)Z", line = 54)
    ...
    @OriginalMember(owner = "client!vg", name = "<init>", descriptor = "(Lqi;)V", line = 103)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IZI)V", line = 80)
