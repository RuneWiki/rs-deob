...
public class class404 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IB)Lgu;", line = 4)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IZ)V", line = 54)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(II)I", line = 67)
    public static final int method2322(int arg0, int arg1) {
        return class600.field7970 == null ? 0 : class600.field7970[arg0][arg1] & 0xFF;
    }

    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(Lpca;ILbi;)V", line = 92)
