...
public abstract class class404 extends class726 {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Lha;ILat;)V")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Lat;ILaa;IIIBILha;)V")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "([Lab;III)I")
