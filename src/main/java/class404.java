...
public class class404 extends class398 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IJLii;)V")
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lnj;II)V")
    ...
    @OriginalMember(owner = "client!ta", name = "c", descriptor = "(B)Lni;")
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lds;Lds;I)V")
