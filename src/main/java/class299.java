...
public class class299 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IBI)Z", line = 5)
    ...
    @OriginalMember(owner = "client!km", name = "toString", descriptor = "()Ljava/lang/String;", line = 16)
    public final String toString() {
        field4411++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!km", name = "a", descriptor = "(I)V", line = 27)
