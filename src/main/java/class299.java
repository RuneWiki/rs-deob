...
public class class299 {
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!uu", name = "b", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(II)Low;", line = 40)
    ...
    @OriginalMember(owner = "client!uu", name = "c", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(Lka;IIILpw;I)V", line = 88)
    ...
    @OriginalMember(owner = "client!uu", name = "b", descriptor = "(II)V", line = 109)
    ...
    @OriginalMember(owner = "client!uu", name = "<init>", descriptor = "(Liv;ILcb;Lcb;)V", line = 139)
