...
public class class299 extends class175 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ILdt;Z)V")
    ...
    @OriginalMember(owner = "client!sm", name = "d", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Luq;Luq;[IB)V")
