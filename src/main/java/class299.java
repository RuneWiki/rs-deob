...
public class class299 extends class337 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(II)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(BILhp;)V", line = 79)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IB)[I", line = 134)
    ...
    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "()V", line = 182)
    public class299() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ss", name = "c", descriptor = "(B)Lhs;", line = 185)
    ...
    @OriginalMember(owner = "client!ss", name = "d", descriptor = "(B)V", line = 209)
