...
public class class299 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(B)V", line = 9)
    public static void method1692(byte arg0) {
        field3914 = null;
        int var1 = -118 / ((-arg0 - 51) / 54);
    }

    @OriginalMember(owner = "client!js", name = "a", descriptor = "(II)V", line = 19)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ZIIIZII)V", line = 34)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IIIIII)V", line = 54)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(I)V", line = 137)
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(II)V", line = 149)
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(B)V", line = 164)
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(Ljda;ILjo;)V", line = 210)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(BI)Lh;", line = 181)
