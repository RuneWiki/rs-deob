...
public class class299 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ILna;)V")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IIIILqa;IILjb;Lea;)V")
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(Lgo;ILns;)V")
