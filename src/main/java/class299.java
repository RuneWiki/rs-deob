...
public class class299 extends class450 {
    ...
    @OriginalMember(owner = "client!pfa", name = "<init>", descriptor = "(ILup;)V")
    public class299(int arg0, class278 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!pfa", name = "<init>", descriptor = "(Lup;)V")
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(ZLwu;)V")
