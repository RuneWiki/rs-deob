...
public class class299 extends class194 {
    ...
    @OriginalMember(owner = "client!ci", name = "d", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ci", name = "b", descriptor = "(ZI)V", line = 20)
    ...
    @OriginalMember(owner = "client!ci", name = "e", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "(Lbl;II[BI)V", line = 73)
