...
public class class299 extends class396 {
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Lfd;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Lfd;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Lfd;IIII)V")
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Lfd;IIIIZ[IZ)V")
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Lfd;IIIII)V")
