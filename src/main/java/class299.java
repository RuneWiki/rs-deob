...
public class class299 {
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(IIIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(IZLwn;)V", line = 20)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ILwn;)V", line = 95)
