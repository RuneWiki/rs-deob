...
public class class299 extends class426 {
    ...
    @OriginalMember(owner = "client!jp", name = "finalize", descriptor = "()V", line = 3)
    protected final void finalize() {
        field4104++;
        this.method1830(-119);
    }

    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(III[B)V", line = 12)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(ZI)Z", line = 42)
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!jp", name = "<init>", descriptor = "(Ljava/net/Socket;I)V", line = 71)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IB[BI)I", line = 83)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IIZ)V", line = 94)
