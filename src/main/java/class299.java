...
public class class299 {
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(ZIIILtp;)V", line = 34)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(ZI)Lvba;", line = 110)
    ...
    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "(Lnv;JI)V", line = 149)
