...
public class class299 extends class341 implements class415 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IILi;II)V", line = 3)
    public final void method303(int arg0, int arg1, class30 arg2, int arg3, int arg4) {
        this.method1904(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!q", name = "J", descriptor = "(III)V", line = 7)
    public final void method307(int arg0, int arg1, int arg2) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!q", name = "a", descriptor = "(FFFFFFLi;II)V", line = 26)
    ...
    @OriginalMember(owner = "client!q", name = "finalize", descriptor = "()V", line = 29)
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "(Lc;Lk;[IIIII)V", line = 38)
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "(Lc;Lk;IIII)V", line = 41)
