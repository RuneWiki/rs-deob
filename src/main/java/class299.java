...
public class class299 {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(CZ)B", line = 20)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IILea;)Z", line = 145)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(I)V", line = 163)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(II)Ltp;", line = 179)
    ...
    @OriginalMember(owner = "client!eo", name = "b", descriptor = "(I)V", line = 229)
    ...
    @OriginalMember(owner = "client!eo", name = "c", descriptor = "(I)V", line = 241)
    ...
    @OriginalMember(owner = "client!eo", name = "<init>", descriptor = "(Lqo;Ld;)V", line = 256)
