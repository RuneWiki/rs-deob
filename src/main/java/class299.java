...
public class class299 extends class30 {
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(BILac;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ofa", name = "b", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!ofa", name = "c", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!ofa", name = "<init>", descriptor = "()V", line = 74)
    public class299() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;IZ)V", line = 77)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(II)[I", line = 107)
