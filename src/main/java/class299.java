...
public abstract class class299 {
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(Lrda;[Lih;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(BI)V", line = 80)
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(Z)V", line = 96)
    ...
    @OriginalMember(owner = "client!ria", name = "<init>", descriptor = "(Les;)V", line = 107)
    ...
    @OriginalMember(owner = "client!ria", name = "<init>", descriptor = "(ILes;)V", line = 115)
