...
public class class299 extends class497 {
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(BI)I", line = 5)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IBII)V", line = 38)
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(Lpp;)V", line = 99)
    public class299(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!ou", name = "d", descriptor = "(I)I", line = 134)
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(ILpp;)V", line = 145)
    public class299(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(B)V", line = 155)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(I)I", line = 179)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(II)V", line = 190)
