...
public class class299 extends class456 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lak;IIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(II)[[I", line = 56)
    ...
    @OriginalMember(owner = "client!ss", name = "h", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "()V", line = 143)
    public class299() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(II)[I", line = 148)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lfq;III[Z)V", line = 201)
    ...
    @OriginalMember(owner = "client!ss", name = "i", descriptor = "(I)V", line = 228)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IBLre;)V", line = 247)
