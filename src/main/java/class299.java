...
public class class299 {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Lbg;II)V", line = 20)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(CB)Z", line = 41)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Lki;B)I", line = 87)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(B)V", line = 168)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IIILbg;)V", line = 184)
