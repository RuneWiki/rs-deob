...
public class class299 extends class390 {
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IIIIII)V", line = 70)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IIILmg;Lmg;)V", line = 99)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(B)I", line = 106)
    ...
    @OriginalMember(owner = "client!gq", name = "c", descriptor = "(I)V", line = 120)
