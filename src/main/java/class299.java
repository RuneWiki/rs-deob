...
public class class299 extends class111 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(III)Lp;")
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(ILlf;I)V")
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IIB)Lbr;")
