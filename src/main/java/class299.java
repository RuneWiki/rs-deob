...
public abstract class class299 implements class341 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ILjaggl/MapBuffer;)Z", line = 4)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I)I", line = 34)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Ljaclib/memory/Source;BI)Z", line = 55)
    ...
    @OriginalMember(owner = "client!cs", name = "c", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IB)I", line = 129)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(Z)V", line = 147)
    ...
    @OriginalMember(owner = "client!cs", name = "c", descriptor = "(Z)J", line = 171)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Ljaggl/MapBuffer;ZI)Ljaclib/memory/Buffer;", line = 189)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lqi;IZ)V", line = 304)
    ...
    @OriginalMember(owner = "client!cs", name = "finalize", descriptor = "()V", line = 240)
    ...
    @OriginalMember(owner = "client!cs", name = "c", descriptor = "(B)V", line = 249)
    public static void method1763(byte arg0) {
        field3960 = null;
        int var1 = -98 % ((-arg0 - 42) / 54);
    }

    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(BII)Z", line = 264)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(II)V", line = 276)
