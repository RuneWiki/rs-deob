...
public abstract class class299 extends class126 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IIIIIIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!je", name = "e", descriptor = "(I)Z", line = 58)
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "(IIIIIII)V", line = 80)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lii;IIIILnc;Z)V", line = 94)
