...
public class class299 extends class496 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Ldda;I)Lav;")
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Ldda;)Z")
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "([I)Lmca;")
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Ldda;II)Lav;")
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "([B)V")
