...
public class class299 {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(B)Lfg;", line = 4)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(BIIIIII)V", line = 81)
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(I)V", line = 663)
