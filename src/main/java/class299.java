...
public class class299 {
    ...
    @OriginalMember(owner = "client!wha", name = "b", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(II)V", line = 37)
    ...
    @OriginalMember(owner = "client!wha", name = "c", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!wha", name = "b", descriptor = "(II)Lsda;", line = 66)
    ...
    @OriginalMember(owner = "client!wha", name = "c", descriptor = "(II)V", line = 103)
    ...
    @OriginalMember(owner = "client!wha", name = "<init>", descriptor = "(Lim;ILgj;)V", line = 123)
