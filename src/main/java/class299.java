...
public class class299 extends class366 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(BF)V", line = 6)
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(I)V", line = 19)
    public class299(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(FI)V", line = 24)
