...
public class class299 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!jq", name = "b", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Lfg;)V", line = 44)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(I)V", line = 138)
