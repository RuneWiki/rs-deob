...
public class class299 extends class539 implements class302 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(Lr;Llr;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIILr;ZILpn;)V")
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(ILr;)Lod;")
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ZILr;I)Z")
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Lr;Z)V")
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(BLr;)Lll;")
    ...
    @OriginalMember(owner = "client!hs", name = "j", descriptor = "(I)V")
