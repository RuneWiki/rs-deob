...
public class class299 extends class85 implements class722 {
    ...
    @OriginalMember(owner = "client!bha", name = "<init>", descriptor = "(Lrd;Lkea;III[B)V", line = 4)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(BLtb;)V", line = 90)
    ...
    @OriginalMember(owner = "client!bha", name = "b", descriptor = "(Z)Ljagdx/IDirect3DBaseTexture;", line = 101)
