...
public class class299 {
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Lqa;[II[I[I)V", line = 55)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(II)V", line = 60)
    ...
    @OriginalMember(owner = "client!rp", name = "b", descriptor = "(II)V", line = 97)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "([III)V", line = 147)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "()V", line = 196)
    public static void method1845() {
        field4261 = null;
    }

    @OriginalMember(owner = "client!rp", name = "b", descriptor = "()V", line = 199)
    private static final void method1846() {
        field4262 = 0;
    }

    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Lqa;[II)V", line = 202)
    public static final void method1847(class162 arg0, int[] arg1, int arg2) {
        method1848(arg0, arg1, 0, arg1.length, arg2, null, null);
    }

    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Lqa;[IIII[I[I)V", line = 208)
    ...
    @OriginalMember(owner = "client!rp", name = "b", descriptor = "(I)Z", line = 245)
