...
public class class299 extends class175 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(CIIIZLvj;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(CIIIZ)V", line = 53)
    ...
    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "(Lhd;Lvm;[Ldr;Z)V", line = 73)
