...
public abstract class class299 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Lda;)V", line = 5)
    public static final void method2520(class67 arg0) {
        class210.field3216 = arg0;
    }

    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(I)Lmja;", line = 22)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "()V", line = 37)
