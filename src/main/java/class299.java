...
public class class299 implements class630 {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IIII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Z)J", line = 25)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(ILsn;)Z", line = 57)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Ljava/lang/String;IC)I", line = 114)
