...
public class class299 implements Runnable {
    ...
    @OriginalMember(owner = "client!wha", name = "run", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(I)I", line = 76)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "([BIII)V", line = 100)
    ...
    @OriginalMember(owner = "client!wha", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 203)
    ...
    @OriginalMember(owner = "client!wha", name = "b", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!wha", name = "c", descriptor = "(I)V", line = 177)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(B)[Lfj;", line = 190)
