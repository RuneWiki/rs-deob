...
public abstract class class299 extends class417 {
    ...
    @OriginalMember(owner = "client!bd", name = "b", descriptor = "()I", line = 9)
    public final int method1293() {
        return this.field4235;
    }

    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IIIIIII)V", line = 13)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(FFFFFFIII)V", line = 54)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(FFFFFFLoj;II)V", line = 131)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IIII)V", line = 164)
    ...
    @OriginalMember(owner = "client!bd", name = "c", descriptor = "()I", line = 172)
    public final int method1294() {
        return this.field4235 + this.field4233 + this.field4236;
    }

    @OriginalMember(owner = "client!bd", name = "d", descriptor = "()I", line = 201)
    public final int method1287() {
        return this.field4240;
    }

    @OriginalMember(owner = "client!bd", name = "<init>", descriptor = "(Let;II)V", line = 208)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(FFFFFF)V", line = 215)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "()I", line = 348)
