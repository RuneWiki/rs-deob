...
public class class299 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IIZZ)Ljn;")
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(II)Lgr;")
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lip;Ljk;I)Leba;")
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Ler;ILjn;)V")
