...
public class class299 extends class293 {
    ...
    @OriginalMember(owner = "client!gr", name = "d", descriptor = "()Lad;")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lps;BIII[I)V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lps;BI)V")
    ...
    @OriginalMember(owner = "client!gr", name = "c", descriptor = "()Lad;")
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(Lqu;)V")
