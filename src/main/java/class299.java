...
public class class299 extends class741 {
    ...
    @OriginalMember(owner = "client!cu", name = "c", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IZ)V", line = 43)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!cu", name = "d", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(BZ)V", line = 99)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "(Lsga;Lae;)V", line = 117)
    ...
    @OriginalMember(owner = "client!cu", name = "d", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!cu", name = "c", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(III)V", line = 212)
    public final void method432(int arg0, int arg1, int arg2) {
        int var4 = -116 / ((-arg2 - 18) / 51);
    }

    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(B)V", line = 219)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(I)V", line = 237)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(I)V", line = 253)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IILml;)V", line = 271)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(B)Z", line = 307)
