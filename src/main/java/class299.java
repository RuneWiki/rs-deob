...
public class class299 {
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(IB)I", line = 7)
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(ZLqg;)[Lpv;", line = 62)
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(B)V", line = 119)
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "([SBI)[S", line = 151)
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(ZLha;)V", line = 166)
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(Lrba;[Llaa;)V", line = 181)
