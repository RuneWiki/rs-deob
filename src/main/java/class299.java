...
public class class299 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Z)Z", line = 30)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Luo;I)V", line = 145)
