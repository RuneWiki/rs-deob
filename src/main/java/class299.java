...
public class class299 extends class24 implements class130 {
    ...
    @OriginalMember(owner = "client!q", name = "oa", descriptor = "(III)V", line = 19)
    public final void method160(int arg0, int arg1, int arg2) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "(Lw;Lg;[I[BIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!q", name = "XA", descriptor = "(IIIIII)V", line = 27)
    public final void method147(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!q", name = "finalize", descriptor = "()V", line = 32)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IILta;II)V", line = 37)
