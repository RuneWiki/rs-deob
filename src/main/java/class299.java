...
public class class299 extends class468 {
    ...
    @OriginalMember(owner = "client!pb", name = "g", descriptor = "(II)Ltq;")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IIILma;Ll;ILgo;I)V")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(ILgo;IZ)V")
