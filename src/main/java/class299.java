...
public abstract class class299 {
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(ILlf;Lda;IBI)V", line = 27)
    ...
    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "(III)V", line = 43)
