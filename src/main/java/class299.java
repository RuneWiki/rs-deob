...
public class class299 {
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IB)Ljava/lang/String;", line = 20)
    ...
    @OriginalMember(owner = "client!st", name = "b", descriptor = "(IB)I", line = 40)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(ZLjava/lang/String;)Z", line = 62)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IILfh;)V", line = 92)
    ...
    @OriginalMember(owner = "client!st", name = "b", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Lfh;Z)V", line = 167)
    ...
    @OriginalMember(owner = "client!st", name = "c", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!st", name = "c", descriptor = "(IB)Z", line = 215)
