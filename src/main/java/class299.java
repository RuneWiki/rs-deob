...
public abstract class class299 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIIILis;I[IIZZLis;)V", line = 14)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIIIII[B)Z", line = 58)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lis;IZ)V", line = 132)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 181)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(II[IILuo;ZLwha;IILuo;[ZZ)V", line = 208)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lis;Lis;Lis;IIIIZLis;B[ZIIII)V", line = 428)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IILs;IIIIII)V", line = 511)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(III[IIII[IIZ)V", line = 635)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IILis;IIIIZLis;)V", line = 731)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IB)V", line = 772)
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(I)V", line = 786)
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(III)Lbj;", line = 805)
