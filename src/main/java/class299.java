...
public class class299 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ILph;II)Lpn;", line = 3)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IZIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 48)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IIILph;)Lfj;", line = 74)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(I)V", line = 92)
