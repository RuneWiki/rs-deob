...
public class class299 extends class16 {
    ...
    @OriginalMember(owner = "client!wm", name = "f", descriptor = "(I)J", line = 3)
    ...
    @OriginalMember(owner = "client!wm", name = "e", descriptor = "(I)J", line = 37)
    public final long method42(int arg0) {
        return arg0 == 30786 ? this.field4287 : 79L;
    }

    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(II)I", line = 47)
    ...
    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "()V", line = 102)
    public class299() {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(I)V", line = 86)
