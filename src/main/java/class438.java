...
public abstract class class438 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(BI)I", line = 4)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "(IIIII)V", line = 479)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IBZ)V", line = 51)
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(I)V", line = 67)
    public static void method2751(int arg0) {
        field6168 = null;
        int var1 = 88 % ((-arg0 - 14) / 49);
    }

    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Z)V", line = 92)
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(III)Lmk;", line = 130)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(II)I", line = 138)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IIII)V", line = 238)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IIIIIIIIZ)V", line = 411)
