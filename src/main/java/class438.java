...
public class class438 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(B)V", line = 13)
    public static void method2551(byte arg0) {
        int var1 = -97 / ((arg0 - 66) / 36);
        field5854 = null;
    }

    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 23)
    ...
    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "(Lcb;)V", line = 141)
    ...
    @OriginalMember(owner = "client!jq", name = "b", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Ljava/lang/String;ZBLra;)V", line = 101)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Z)Z", line = 196)
