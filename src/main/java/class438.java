...
public class class438 {
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(II)I", line = 11)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lbg;I)V", line = 50)
    ...
    @OriginalMember(owner = "client!sp", name = "b", descriptor = "(II)I", line = 72)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IIII)I", line = 76)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IILaq;ZLuo;)V", line = 105)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lbg;IZ)V", line = 416)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(I)V", line = 647)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(B)V", line = 659)
