...
public class class438 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(III)V", line = 6)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IIZLha;)Lda;", line = 42)
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 70)
