...
public class class438 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(BLji;)V")
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Lgo;[[BI)V")
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(ILji;I)V")
