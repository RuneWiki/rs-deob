...
public class class438 extends class436 implements class265 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Len;I)V")
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(ILen;)Lir;")
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IIZLen;)Z")
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(BLen;)V")
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(Len;Lnl;IIIIIIIZI)V")
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(ILen;IBLfs;IZ)V")
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(BILen;)Lmj;")
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Len;B)V")
