...
public class class438 extends class212 {
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ILjr;)Ldaa;", line = 5)
    ...
    @OriginalMember(owner = "client!ap", name = "c", descriptor = "(B)V", line = 25)
    public static void method2513(byte arg0) {
        int var1 = -53 / ((-arg0 - 50) / 63);
        field6176 = null;
    }

    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Lpj;IIZIBI)V", line = 36)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IIIIIII)V", line = 59)
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(Len;II[B)V", line = 201)
