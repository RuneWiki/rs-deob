...
public abstract class class438 implements class460 {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Ljaggl/MapBuffer;I)Z")
    ...
    @OriginalMember(owner = "client!du", name = "<init>", descriptor = "(Ljc;IZ)V")
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(ZILjaggl/MapBuffer;)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(ILjaclib/memory/Source;I)Z")
