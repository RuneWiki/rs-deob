...
public class class438 extends class189 implements class131 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!wa", name = "finalize", descriptor = "()V", line = 18)
    ...
    @OriginalMember(owner = "client!wa", name = "<init>", descriptor = "(Lda;III)V", line = 73)
    ...
    @OriginalMember(owner = "client!wa", name = "<init>", descriptor = "(Lda;IIII)V", line = 105)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!wa", name = "c", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!wa", name = "e", descriptor = "(B)V", line = 90)
