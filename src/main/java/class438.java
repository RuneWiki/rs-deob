...
public class class438 extends class421 {
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IILrn;II)V")
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(FFFFFFLrn;II)V")
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "(Lge;IIII)V")
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "(Lge;II[III)V")
