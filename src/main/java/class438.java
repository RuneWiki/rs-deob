...
public class class438 extends class585 {
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(I)Ljk;")
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(I[Lgba;Z)V")
    ...
    @OriginalMember(owner = "client!vaa", name = "<init>", descriptor = "(Lno;IIIIII)V")
