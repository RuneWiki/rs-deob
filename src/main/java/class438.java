...
public class class438 {
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(Z)V", line = 7)
    public class438(boolean arg0) {
        this.field6394 = arg0;
    }

    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(III)I", line = 16)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(I)Z", line = 38)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Z)V", line = 53)
