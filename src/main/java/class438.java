...
public class class438 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(ILjava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(ILls;IIILtr;Lqa;Lrs;)V", line = 33)
    ...
    @OriginalMember(owner = "client!of", name = "toString", descriptor = "()Ljava/lang/String;", line = 76)
    public final String toString() {
        field6388++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 105)
