...
public class class438 extends class214 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(IIIILes;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(BI)[I", line = 164)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Llk;II)V", line = 380)
    ...
    @OriginalMember(owner = "client!ma", name = "<init>", descriptor = "()V", line = 464)
    public class438() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ma", name = "e", descriptor = "(I)V", line = 467)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lca;ZIII)V", line = 479)
    ...
    @OriginalMember(owner = "client!ma", name = "f", descriptor = "(I)V", line = 532)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(IIIIIII)V", line = 546)
    ...
    @OriginalMember(owner = "client!ma", name = "b", descriptor = "(B)V", line = 688)
