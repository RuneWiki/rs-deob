...
public class class438 {
    ...
    @OriginalMember(owner = "client!ph", name = "toString", descriptor = "()Ljava/lang/String;", line = 10)
    public final String toString() {
        field6405++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 40)
