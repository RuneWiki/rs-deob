...
public class class438 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(ZB)V", line = 3)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(ZI)V", line = 24)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(II)Llt;", line = 44)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IZ)V", line = 114)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(BI)V", line = 149)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(III)Z", line = 171)
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(Lsea;IZLmv;Lmv;)V", line = 226)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(ZB)V", line = 190)
