...
public class class438 extends class322 {
    ...
    @OriginalMember(owner = "client!ks", name = "<init>", descriptor = "(Lch;)V")
    ...
    @OriginalMember(owner = "client!ks", name = "<init>", descriptor = "(ILch;)V")
    public class438(int arg0, class463 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ks", name = "d", descriptor = "(B)Z")
