...
public class class438 {
    ...
    @OriginalMember(owner = "client!wk", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V")
    ...
    @OriginalMember(owner = "client!wk", name = "movemouse", descriptor = "(II)V")
    public final void movemouse(int arg0, int arg1) {
        this.field5825.mouseMove(arg0, arg1);
    }

    @OriginalMember(owner = "client!wk", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V")
