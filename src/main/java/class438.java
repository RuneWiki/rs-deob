...
public class class438 extends class518 {
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(BLwq;I)V", line = 16)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IZI)V", line = 29)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Z)Z", line = 99)
    public final boolean method1131(boolean arg0) {
        ++field6050;
        return !arg0;
    }

    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Loa;I)V", line = 113)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(ZI)V", line = 227)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(BLpq;)V", line = 238)
    ...
    @OriginalMember(owner = "client!hg", name = "d", descriptor = "(I)V", line = 251)
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "(Lpea;Lpba;)V", line = 281)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(ZB)V", line = 332)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(I)V", line = 380)
