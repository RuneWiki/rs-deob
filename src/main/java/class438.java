...
public class class438 implements class209 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(I)Z", line = 16)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(III)Z", line = 29)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Lil;I)I", line = 52)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ZB)V", line = 83)
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Lni;Lwd;)V", line = 127)
