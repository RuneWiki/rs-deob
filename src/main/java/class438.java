...
public class class438 {
    ...
    @OriginalMember(owner = "client!mha", name = "<init>", descriptor = "(Ldia;)V", line = 95)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(ZJ)V", line = 12)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(I)V", line = 35)
    public static void method2637(int arg0) {
        int var1 = -58 / ((arg0 + 70) / 55);
        field6168 = null;
    }

    @OriginalMember(owner = "client!mha", name = "b", descriptor = "(I)I", line = 49)
