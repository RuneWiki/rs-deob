...
public class class438 extends class4 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(CI)I", line = 7)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(II)Lmga;", line = 30)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(ILdc;I)V", line = 59)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(B)V", line = 159)
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(II)Z", line = 178)
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(CI)I", line = 189)
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(ILdc;)V", line = 214)
