...
public class class438 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILoa;II)V", line = 14)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(BZ)V", line = 491)
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(I)V", line = 570)
