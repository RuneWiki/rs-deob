...
public class class438 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(B)Luj;")
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(B)Luj;")
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(Lsd;)V")
