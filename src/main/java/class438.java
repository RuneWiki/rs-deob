...
public class class438 {
    ...
    @OriginalMember(owner = "client!ti", name = "toString", descriptor = "()Ljava/lang/String;", line = 6)
    public final String toString() {
        field6114++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(I)V", line = 18)
    private class438(int arg0) {
        this.field6113 = arg0;
    }

    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IIILdm;)V", line = 27)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(B)V", line = 59)
