...
public class class438 extends class593 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Lwb;Lwb;B)V", line = 6)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Ljj;)V", line = 25)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IIB)V", line = 136)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(I)Z", line = 157)
    ...
    @OriginalMember(owner = "client!gm", name = "c", descriptor = "(I)V", line = 168)
    ...
    @OriginalMember(owner = "client!gm", name = "h", descriptor = "(I)V", line = 215)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Lhia;IIII)V", line = 226)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IFFF)F", line = 279)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IZ)V", line = 292)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(BZ)V", line = 336)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IBLah;)V", line = 352)
