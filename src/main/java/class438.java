...
public class class438 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IB)Lcp;", line = 5)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(II)V", line = 38)
    ...
    @OriginalMember(owner = "client!a", name = "b", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;)V", line = 97)
    ...
    @OriginalMember(owner = "client!a", name = "<init>", descriptor = "(Lae;ILqn;)V", line = 125)
