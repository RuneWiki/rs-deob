...
public class class438 extends class228 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Lkk;BIII)V")
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ILpe;B)Lsj;")
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(BLsj;Lpe;)V")
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ILpe;)V")
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ZILhh;Lpe;III)V")
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IILpe;I)Z")
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Lpe;B)Lca;")
