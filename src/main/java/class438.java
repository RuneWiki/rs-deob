...
public class class438 extends class206 {
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "([I)Lps;")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Lla;I)Lnv;")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Lla;II)Lnv;")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Lla;)Z")
    ...
    @OriginalMember(owner = "client!nv", name = "<init>", descriptor = "([B)V")
