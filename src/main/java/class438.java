...
public abstract class class438 extends class693 {
    ...
    @OriginalMember(owner = "client!mha", name = "<init>", descriptor = "(IIIIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!mha", name = "b", descriptor = "(ILha;)Z", line = 30)
    ...
    @OriginalMember(owner = "client!mha", name = "b", descriptor = "(Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "([Lih;Z)I", line = 53)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(IB)[[[B", line = 66)
    ...
    @OriginalMember(owner = "client!mha", name = "d", descriptor = "(I)Z", line = 846)
    ...
    @OriginalMember(owner = "client!mha", name = "d", descriptor = "(B)V", line = 857)
    ...
    @OriginalMember(owner = "client!mha", name = "c", descriptor = "(III)Lgf;", line = 868)
    ...
    @OriginalMember(owner = "client!mha", name = "e", descriptor = "(I)Z", line = 883)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(ZILha;ILrda;II)V", line = 898)
