...
public class class438 {
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(I[Ljava/lang/Object;[IIB)V", line = 182)
    ...
    @OriginalMember(owner = "client!sk", name = "toString", descriptor = "()Ljava/lang/String;", line = 238)
    public final String toString() {
        field6550++;
        return "Cache:" + this.field6546;
    }

    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(I)V", line = 255)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ZI[BII)Z", line = 265)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(BI[BI)Z", line = 385)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ZI)[B", line = 417)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ILck;)I", line = 497)
    ...
    @OriginalMember(owner = "client!sk", name = "<init>", descriptor = "(ILho;Lho;I)V", line = 534)
