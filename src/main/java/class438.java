...
public class class438 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(ILtd;Laa;IIILqk;I)V")
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(IB)Lrq;")
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "(Lmp;IZLla;Lla;)V")
