...
public class class438 extends class305 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Ljava/awt/Canvas;I)Lgq;")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ILfh;B)V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(I[B)Ltr;")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IBLpq;I)V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lwl;I)V")
