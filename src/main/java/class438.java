...
public class class438 {
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(I)Z", line = 11)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Lrg;I)V", line = 41)
    ...
    @OriginalMember(owner = "client!rp", name = "b", descriptor = "(I)Ldh;", line = 62)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Z)V", line = 139)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(ILvt;)V", line = 177)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(BI)Lcha;", line = 207)
    ...
    @OriginalMember(owner = "client!rp", name = "c", descriptor = "(I)Ldh;", line = 229)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IBLrg;)V", line = 297)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(B)Z", line = 379)
    ...
    @OriginalMember(owner = "client!rp", name = "b", descriptor = "(B)V", line = 412)
