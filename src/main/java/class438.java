...
public class class438 extends class290 implements class518 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IILza;IILvl;Z)V")
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lza;III)Z")
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(ILza;)Lsr;")
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(Lza;Lp;IIIIIZIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ILza;)V")
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ILza;I)Le;")
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(BLza;)V")
