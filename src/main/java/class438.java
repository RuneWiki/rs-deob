...
public class class438 extends class192 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lpca;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "()V", line = 42)
    public class438() {
        super(0, false);
    }

    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IIII)V", line = 45)
    ...
    @OriginalMember(owner = "client!qm", name = "c", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ILfd;I)V", line = 88)
    ...
    @OriginalMember(owner = "client!qm", name = "h", descriptor = "(I)Z", line = 107)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(IB)[[I", line = 135)
    ...
    @OriginalMember(owner = "client!qm", name = "d", descriptor = "(B)I", line = 206)
