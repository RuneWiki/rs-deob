...
public class class438 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(ILkha;I)Lbea;", line = 22)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(B)Lid;", line = 38)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(Z)Z", line = 112)
    ...
    @OriginalMember(owner = "client!nu", name = "b", descriptor = "(B)V", line = 140)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(ILtn;B)V", line = 165)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(ILtn;)V", line = 248)
    ...
    @OriginalMember(owner = "client!nu", name = "c", descriptor = "(B)Z", line = 281)
    ...
    @OriginalMember(owner = "client!nu", name = "b", descriptor = "(I)Lid;", line = 313)
