...
public class NpcType {
    ...
    @OriginalMember(owner = "client!gc", name = "L", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!gc", name = "f", descriptor = "Llb;")
    private static Packet field1003;

    @OriginalMember(owner = "client!gc", name = "c", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!gc", name = "g", descriptor = "[Lgc;")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(I[IZI)Leb;")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(B)Lgc;")
