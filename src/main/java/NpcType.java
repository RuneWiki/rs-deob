...
public class NpcType {
    ...
    @OriginalMember(owner = "client!gc", name = "G", descriptor = "Lt;")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(Lmb;B)V")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(II[II)Lfb;")
    ...
    @OriginalMember(owner = "client!gc", name = "b", descriptor = "(Z)Lfb;")
