...
public class NpcType {
    ...
    @OriginalMember(owner = "client!gc", name = "J", descriptor = "Lt;")
    ...
    @OriginalMember(owner = "client!gc", name = "g", descriptor = "Lmb;")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(IB[II)Lfb;")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(Z)Lfb;")
