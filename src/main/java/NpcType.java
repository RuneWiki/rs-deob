...
public class NpcType {
    ...
    @OriginalMember(owner = "client!yb", name = "B", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!yb", name = "c", descriptor = "Lkb;")
    ...
    @OriginalMember(owner = "client!yb", name = "a", descriptor = "(Lub;)V")
    ...
    @OriginalMember(owner = "client!yb", name = "a", descriptor = "(II[I)Leb;")
    ...
    @OriginalMember(owner = "client!yb", name = "c", descriptor = "(I)Leb;")
