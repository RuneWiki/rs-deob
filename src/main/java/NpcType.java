...
public class NpcType {
    ...
    @OriginalMember(owner = "client!gc", name = "Q", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!gc", name = "k", descriptor = "Llb;")
    private static Packet field1014;

    @OriginalMember(owner = "client!gc", name = "h", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!gc", name = "l", descriptor = "[Lgc;")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(Lxb;)V")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(Llb;Z)V")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(IZ[II)Leb;")
    ...
    @OriginalMember(owner = "client!gc", name = "b", descriptor = "(B)Leb;")
    ...
    @OriginalMember(owner = "client!gc", name = "c", descriptor = "(B)Lgc;")
