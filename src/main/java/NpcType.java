...
public class NpcType {
    ...
    @OriginalMember(owner = "client!bc", name = "D", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!bc", name = "e", descriptor = "Lkb;")
    ...
    @OriginalMember(owner = "client!bc", name = "f", descriptor = "[Lbc;")
    ...
    @OriginalMember(owner = "client!bc", name = "b", descriptor = "(I)Lbc;")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Lkb;Z)V")
    ...
    @OriginalMember(owner = "client!bc", name = "c", descriptor = "(I)Leb;")
