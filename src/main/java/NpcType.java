...
public class NpcType {
    ...
    @OriginalMember(owner = "client!xb", name = "E", descriptor = "Lr;")
    ...
    @OriginalMember(owner = "client!xb", name = "f", descriptor = "Ljb;")
    ...
    @OriginalMember(owner = "client!xb", name = "b", descriptor = "(I)Lxb;")
    ...
    @OriginalMember(owner = "client!xb", name = "a", descriptor = "(BLjb;)V")
    ...
    @OriginalMember(owner = "client!xb", name = "a", descriptor = "(II[I)Ldb;")
    ...
    @OriginalMember(owner = "client!xb", name = "c", descriptor = "(I)Ldb;")
