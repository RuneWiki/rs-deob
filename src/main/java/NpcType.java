...
public class NpcType {
    ...
    @OriginalMember(owner = "client!fc", name = "D", descriptor = "Lt;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(ILmb;)V")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IIZ[I)Lfb;")
