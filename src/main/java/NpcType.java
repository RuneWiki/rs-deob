...
public class NpcType {
    ...
    @OriginalMember(owner = "client!bc", name = "C", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!bc", name = "d", descriptor = "Lkb;")
    ...
    @OriginalMember(owner = "client!bc", name = "e", descriptor = "[Lbc;")
    private static NpcType[] field846;

    @OriginalMember(owner = "client!bc", name = "u", descriptor = "[Ljava/lang/String;")
    public String[] field862;

    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Lub;)V")
    public static final void method286(Jagfile arg0) {
        field845 = new Packet(363, arg0.method257("npc.dat", null, (byte) 2));
        Packet var1 = new Packet(363, arg0.method257("npc.idx", null, (byte) 2));
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(I)Lbc;")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(ZLkb;)V")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(II[I)Leb;")
    ...
    @OriginalMember(owner = "client!bc", name = "b", descriptor = "(Z)Leb;")
