...
public class NpcType {
    ...
    @OriginalMember(owner = "client!hc", name = "H", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(BLmb;)V")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(ZII[I)Leb;")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(B)Leb;")
