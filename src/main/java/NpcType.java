...
public class NpcType {
    ...
    @OriginalMember(owner = "client!gc", name = "K", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!gc", name = "e", descriptor = "Llb;")
    private static Packet field1014;

    @OriginalMember(owner = "client!gc", name = "b", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!gc", name = "b", descriptor = "(I)Lgc;")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(Llb;I)V")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(I[IIZ)Leb;")
    ...
    @OriginalMember(owner = "client!gc", name = "c", descriptor = "(I)Leb;")
    ...
    @OriginalMember(owner = "client!gc", name = "d", descriptor = "(I)Lgc;")
