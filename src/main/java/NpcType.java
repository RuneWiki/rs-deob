...
public class NpcType {
    ...
    @OriginalMember(owner = "client!fc", name = "B", descriptor = "Lt;")
    ...
    @OriginalMember(owner = "client!fc", name = "c", descriptor = "Lmb;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(ZLmb;)V")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(II[II)Lfb;")
