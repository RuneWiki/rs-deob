...
public class NpcType {
    ...
    @OriginalMember(owner = "client!gc", name = "N", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!gc", name = "h", descriptor = "Llb;")
    private static Packet field1012;

    @OriginalMember(owner = "client!gc", name = "e", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(IIZ[I)Leb;")
    ...
    @OriginalMember(owner = "client!gc", name = "b", descriptor = "(I)Leb;")
    ...
    @OriginalMember(owner = "client!gc", name = "c", descriptor = "(I)Lgc;")
