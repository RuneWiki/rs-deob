...
public class NpcType {
    ...
    @OriginalMember(owner = "client!gc", name = "M", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!gc", name = "g", descriptor = "Llb;")
    private static Packet field1008;

    @OriginalMember(owner = "client!gc", name = "d", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!gc", name = "h", descriptor = "[Lgc;")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(ILlb;)V")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(II[II)Leb;")
    ...
    @OriginalMember(owner = "client!gc", name = "b", descriptor = "(Z)Lgc;")
