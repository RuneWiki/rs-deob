...
public abstract class class10 extends class325 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(JZILjava/lang/String;)V", line = 27)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(I)V", line = 94)
