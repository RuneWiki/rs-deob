...
@OriginalClass("client!DDJBHEGS")
public class class10 {

    @OriginalMember(owner = "client!DDJBHEGS", name = "b", descriptor = "I")
    private static int field635 = -563;

    @OriginalMember(owner = "client!DDJBHEGS", name = "c", descriptor = "Z")
    private static boolean field636 = true;

    @OriginalMember(owner = "client!DDJBHEGS", name = "d", descriptor = "I")
    private static int field637 = 760;

    @OriginalMember(owner = "client!DDJBHEGS", name = "a", descriptor = "Z")
    private static boolean field634;

    @OriginalMember(owner = "client!DDJBHEGS", name = "a", descriptor = "(IIII)I")
    ...
    @OriginalMember(owner = "client!DDJBHEGS", name = "b", descriptor = "(IIII)I")
    ...
    @OriginalMember(owner = "client!DDJBHEGS", name = "a", descriptor = "(IIIBII)I")
    ...
    @OriginalMember(owner = "client!DDJBHEGS", name = "a", descriptor = "(IIIZII)I")
