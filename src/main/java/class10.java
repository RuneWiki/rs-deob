...
public class class10 extends class313 {
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Lh;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Lh;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Lh;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IILh;ZII)Ldg;")
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Lh;IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Lh;IIII[I)V")
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IZLh;B[II)Ldg;")
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Lh;IIIZ[I)V")
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(ZLh;III[BBI)Ldg;")
