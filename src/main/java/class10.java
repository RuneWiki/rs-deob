...
public class class10 extends class5 {
    ...
    @OriginalMember(owner = "client!DLNPJUEQ", name = "sb", descriptor = "LHEKJNUPL;")
    public class20 field626;

    @OriginalMember(owner = "client!DLNPJUEQ", name = "a", descriptor = "(B)LSNMMQNPZ;")
    ...
    @OriginalMember(owner = "client!DLNPJUEQ", name = "c", descriptor = "(B)LSNMMQNPZ;")
