...
public class class10 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(II)Lgn;", line = 102)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(IZLio;)V", line = 149)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(B)V", line = 169)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(I)V", line = 186)
    ...
    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "(Lqq;Lfa;)V", line = 212)
