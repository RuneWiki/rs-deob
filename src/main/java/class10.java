...
public class class10 extends class476 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Lkm;)V")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Lko;Lfd;)V")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Lfd;)V")
