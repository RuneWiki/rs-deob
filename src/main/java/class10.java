...
public class class10 implements class401 {
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(B)Lio;", line = 4)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(ILns;B)V", line = 14)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(JJ)J", line = 86)
    public static long method71(long arg0, long arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(IIIIIIBII)V", line = 93)
    ...
    @OriginalMember(owner = "client!hba", name = "<init>", descriptor = "(I)V", line = 159)
    public class10(int arg0) {
        this.field149 = arg0;
    }

    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(I)V", line = 168)
