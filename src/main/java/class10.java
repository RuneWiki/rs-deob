...
public class class10 {
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(B)V", line = 5)
    public static void method46(byte arg0) {
        field205 = null;
        int var1 = -105 / ((arg0 - 38) / 60);
    }

    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!hba", name = "b", descriptor = "(Z)V", line = 43)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(Ltc;I)V", line = 64)
    ...
    @OriginalMember(owner = "client!hba", name = "<init>", descriptor = "(Len;JI)V", line = 76)
    public class10(class289 arg0, long arg1, int arg2) {
        this.field201 = arg1;
        this.field199 = arg0;
    }

    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(III)Z", line = 89)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(II)V", line = 100)
    ...
    @OriginalMember(owner = "client!hba", name = "finalize", descriptor = "()V", line = 113)
