...
@OriginalClass("client!EPIGJXFD")
public class class10 {

    @OriginalMember(owner = "client!EPIGJXFD", name = "b", descriptor = "Z")
    private boolean field700 = false;

    @OriginalMember(owner = "client!EPIGJXFD", name = "g", descriptor = "I")
    public int field705 = -1;

    @OriginalMember(owner = "client!EPIGJXFD", name = "h", descriptor = "Z")
    public boolean field706 = false;

    @OriginalMember(owner = "client!EPIGJXFD", name = "i", descriptor = "Z")
    public boolean field707 = true;

    @OriginalMember(owner = "client!EPIGJXFD", name = "a", descriptor = "I")
    private static int field699 = 627;

    @OriginalMember(owner = "client!EPIGJXFD", name = "c", descriptor = "I")
    public static int field701;

    @OriginalMember(owner = "client!EPIGJXFD", name = "f", descriptor = "I")
    public int field704;

    @OriginalMember(owner = "client!EPIGJXFD", name = "j", descriptor = "I")
    public int field708;

    @OriginalMember(owner = "client!EPIGJXFD", name = "k", descriptor = "I")
    public int field709;

    @OriginalMember(owner = "client!EPIGJXFD", name = "l", descriptor = "I")
    public int field710;

    @OriginalMember(owner = "client!EPIGJXFD", name = "m", descriptor = "I")
    public int field711;

    @OriginalMember(owner = "client!EPIGJXFD", name = "n", descriptor = "I")
    public int field712;

    @OriginalMember(owner = "client!EPIGJXFD", name = "o", descriptor = "I")
    public int field713;

    @OriginalMember(owner = "client!EPIGJXFD", name = "e", descriptor = "Ljava/lang/String;")
    public String field703;

    @OriginalMember(owner = "client!EPIGJXFD", name = "d", descriptor = "[LEPIGJXFD;")
    public static class10[] field702;

    @OriginalMember(owner = "client!EPIGJXFD", name = "a", descriptor = "(ILSYUGXMZF;)V")
    ...
    @OriginalMember(owner = "client!EPIGJXFD", name = "a", descriptor = "(LKHOMSBHW;I)V")
    ...
    @OriginalMember(owner = "client!EPIGJXFD", name = "a", descriptor = "(BI)V")
    ...
    @OriginalMember(owner = "client!EPIGJXFD", name = "a", descriptor = "(III)I")
