...
public class class10 {
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(IIIIBI)Z", line = 20)
    ...
    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!vl", name = "c", descriptor = "(I)V", line = 67)
