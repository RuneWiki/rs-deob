...
public class class10 extends class36 {
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(ILrt;I)V", line = 17)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(ILjava/lang/String;I)Ljava/lang/String;", line = 64)
    ...
    @OriginalMember(owner = "client!hba", name = "b", descriptor = "(II)Z", line = 88)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(IB)V", line = 99)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(Loa;Lva;IIIII)V", line = 137)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(IIIIZII)V", line = 232)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(ZLrt;)V", line = 248)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(ZII)I", line = 268)
