...
public class class10 implements class276 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lp;BIZ)Lc;", line = 6)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "()V", line = 62)
    public final void method81() {
        this.field109 = null;
        this.method86();
    }

    @OriginalMember(owner = "client!ma", name = "b", descriptor = "()V", line = 72)
    public final void method85() {
        this.field109 = Thread.currentThread();
        this.method89();
    }

    @OriginalMember(owner = "client!ma", name = "finalize", descriptor = "()V", line = 82)
