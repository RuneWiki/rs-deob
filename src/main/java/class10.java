...
public class class10 {
    ...
    @OriginalMember(owner = "client!ECJPTPHH", name = "e", descriptor = "[LECJPTPHH;")
    public static class10[] field642;

    @OriginalMember(owner = "client!ECJPTPHH", name = "a", descriptor = "(ILRVLWVPJQ;)V")
    ...
    @OriginalMember(owner = "client!ECJPTPHH", name = "a", descriptor = "(ILUAWAYCTK;)V")
