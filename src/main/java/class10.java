...
@OriginalClass("client!CMGLYFCQ")
public class class10 extends class67 {

    @OriginalMember(owner = "client!CMGLYFCQ", name = "pb", descriptor = "B")
    private byte field651 = 6;

    @OriginalMember(owner = "client!CMGLYFCQ", name = "qb", descriptor = "I")
    private int field652 = 7;

    @OriginalMember(owner = "client!CMGLYFCQ", name = "rb", descriptor = "LFKIKYVJJ;")
    public class19 field653;

    @OriginalMember(owner = "client!CMGLYFCQ", name = "b", descriptor = "(I)LOIBEFFXI;")
    ...
    @OriginalMember(owner = "client!CMGLYFCQ", name = "a", descriptor = "(Z)LOIBEFFXI;")
    ...
    @OriginalMember(owner = "client!CMGLYFCQ", name = "a", descriptor = "(I)Z")
