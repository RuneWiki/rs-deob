...
@OriginalClass("client!DNACUOZQ")
public class class10 extends class29 {

    @OriginalMember(owner = "client!DNACUOZQ", name = "w", descriptor = "Z")
    private boolean field589 = false;

    @OriginalMember(owner = "client!DNACUOZQ", name = "x", descriptor = "I")
    private int field590 = -208;

    @OriginalMember(owner = "client!DNACUOZQ", name = "y", descriptor = "I")
    private int field591 = -10464;

    @OriginalMember(owner = "client!DNACUOZQ", name = "z", descriptor = "I")
    private int field592 = 22876;

    @OriginalMember(owner = "client!DNACUOZQ", name = "A", descriptor = "I")
    private int field593 = 8;

    @OriginalMember(owner = "client!DNACUOZQ", name = "B", descriptor = "Z")
    private boolean field594 = true;

    @OriginalMember(owner = "client!DNACUOZQ", name = "I", descriptor = "I")
    public int field601;

    @OriginalMember(owner = "client!DNACUOZQ", name = "J", descriptor = "I")
    public int field602;

    @OriginalMember(owner = "client!DNACUOZQ", name = "D", descriptor = "[I")
    public int[] field596;

    @OriginalMember(owner = "client!DNACUOZQ", name = "G", descriptor = "I")
    public int field599;

    @OriginalMember(owner = "client!DNACUOZQ", name = "H", descriptor = "I")
    public int field600;

    @OriginalMember(owner = "client!DNACUOZQ", name = "E", descriptor = "I")
    public int field597;

    @OriginalMember(owner = "client!DNACUOZQ", name = "F", descriptor = "I")
    public int field598;

    @OriginalMember(owner = "client!DNACUOZQ", name = "C", descriptor = "[B")
    public byte[] field595;

    @OriginalMember(owner = "client!DNACUOZQ", name = "<init>", descriptor = "(LCVNWKEAW;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!DNACUOZQ", name = "c", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!DNACUOZQ", name = "a", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!DNACUOZQ", name = "b", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!DNACUOZQ", name = "c", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!DNACUOZQ", name = "a", descriptor = "(ZIII)V")
    ...
    @OriginalMember(owner = "client!DNACUOZQ", name = "a", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!DNACUOZQ", name = "a", descriptor = "(IIIZII[I[II[B)V")
