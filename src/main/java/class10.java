...
public class class10 extends class127 {
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(Ltb;II)V")
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(Ltb;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(Ltb;IIZ[[BI)V")
