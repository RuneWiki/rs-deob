...
public class class10 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ILjava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(I)[[I", line = 99)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IBIBSIISB)I", line = 171)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(I[B)V", line = 190)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IIII)I", line = 710)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(SIS)V", line = 742)
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "([B)V", line = 1631)
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(III)V", line = 1642)
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "([Lkp;I)V", line = 1679)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ZIII)V", line = 768)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Z)V", line = 792)
    ...
    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(I)[[I", line = 985)
    ...
    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(IIII)V", line = 1047)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(II)Ljava/lang/String;", line = 1140)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ILkp;SI)I", line = 1158)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(SSBBBSSZSS)B", line = 1197)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ZSS)V", line = 1226)
    ...
    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(I[B)V", line = 1251)
