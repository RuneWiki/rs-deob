...
public class class10 extends class46 {
    ...
    @OriginalMember(owner = "client!CUKAGIIJ", name = "<init>", descriptor = "(LVSUYIIVA;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!CUKAGIIJ", name = "a", descriptor = "(LFDCAWVRL;III)V")
