...
public class class10 extends class16 {
    ...
    @OriginalMember(owner = "client!EJJAKGTE", name = "Hb", descriptor = "LVNWSQIXW;")
    ...
    @OriginalMember(owner = "client!EJJAKGTE", name = "Fb", descriptor = "LOQIGXOFQ;")
    public class35 field632;

    @OriginalMember(owner = "client!EJJAKGTE", name = "tb", descriptor = "LDDJHHGTJ;")
    ...
    @OriginalMember(owner = "client!EJJAKGTE", name = "a", descriptor = "(B)LOQIGXOFQ;")
    ...
    @OriginalMember(owner = "client!EJJAKGTE", name = "a", descriptor = "(Z)LOQIGXOFQ;")
    ...
    @OriginalMember(owner = "client!EJJAKGTE", name = "b", descriptor = "(Z)LOQIGXOFQ;")
    ...
    @OriginalMember(owner = "client!EJJAKGTE", name = "a", descriptor = "(ILGHHPHSRU;)V")
