...
public abstract class class10 extends class11 {
    ...
    @OriginalMember(owner = "client!hba", name = "c", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(Ldw;IIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(Leh;BLjava/lang/String;)I", line = 71)
