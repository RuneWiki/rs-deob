...
public class class10 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(BLjava/lang/String;Z)V", line = 12)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(BII)Llb;", line = 91)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(II)V", line = 110)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Z)V", line = 136)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(IB)Llf;", line = 154)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(B)V", line = 184)
    ...
    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "(Lpt;ILum;)V", line = 202)
