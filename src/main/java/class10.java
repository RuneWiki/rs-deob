...
public class class10 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Leq;[IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Leq;[II[I[I)V")
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Leq;[II)V")
