...
public class class10 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "()I", line = 6)
    public final int method49() {
        return this.field105;
    }

    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Loa;Ljava/lang/String;IIIZ)V", line = 11)
    ...
    @OriginalMember(owner = "client!oo", name = "b", descriptor = "()I", line = 33)
    public final int method51() {
        return this.field112 - 1;
    }

    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Ljava/lang/String;)I", line = 38)
    ...
    @OriginalMember(owner = "client!oo", name = "c", descriptor = "()V", line = 53)
    public static void method53() {
        field109 = null;
    }

    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "(Loa;IZLjava/awt/Component;)V", line = 192)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Loa;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 61)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Loa;Ljava/lang/String;[IIIIZ)V", line = 171)
