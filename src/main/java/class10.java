...
public class class10 extends class548 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(ILhp;ZLhp;)V")
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "(Ljj;)V")
    ...
    @OriginalMember(owner = "client!tu", name = "d", descriptor = "(Z)V")
