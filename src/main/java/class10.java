...
@OriginalClass("client!CGPATBOH")
public class class10 {

    @OriginalMember(owner = "client!CGPATBOH", name = "a", descriptor = "LYZXSAOBR;")
    private static class72 field162 = new class72();

    @OriginalMember(owner = "client!CGPATBOH", name = "a", descriptor = "([BI[BII)I")
    ...
    @OriginalMember(owner = "client!CGPATBOH", name = "a", descriptor = "(LYZXSAOBR;)V")
    ...
    @OriginalMember(owner = "client!CGPATBOH", name = "b", descriptor = "(LYZXSAOBR;)V")
    ...
    @OriginalMember(owner = "client!CGPATBOH", name = "c", descriptor = "(LYZXSAOBR;)B")
    private static byte method39(class72 arg0) {
        return (byte) method41(8, arg0);
    }

    @OriginalMember(owner = "client!CGPATBOH", name = "d", descriptor = "(LYZXSAOBR;)B")
    private static byte method40(class72 arg0) {
        return (byte) method41(1, arg0);
    }

    @OriginalMember(owner = "client!CGPATBOH", name = "a", descriptor = "(ILYZXSAOBR;)I")
    ...
    @OriginalMember(owner = "client!CGPATBOH", name = "e", descriptor = "(LYZXSAOBR;)V")
    ...
    @OriginalMember(owner = "client!CGPATBOH", name = "a", descriptor = "([I[I[I[BIII)V")
