...
public class class10 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Lkk;IB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(II)Z", line = 24)
    public final boolean method57(int arg0, int arg1) {
        field103++;
        return arg0 < 31 ? false : this.field97[arg1].method1026(78);
    }

    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(IZIIIZ)V", line = 39)
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "(Lih;)V", line = 140)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(BLec;)Lec;", line = 106)
