...
public class class10 extends class101 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ds", name = "d", descriptor = "(I)[B", line = 16)
    ...
    @OriginalMember(owner = "client!ds", name = "e", descriptor = "(B)I", line = 36)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IIIIIII)I", line = 52)
    ...
    @OriginalMember(owner = "client!ds", name = "g", descriptor = "(B)V", line = 85)
