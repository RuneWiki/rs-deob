...
@OriginalClass("client!DIQFKGVT")
public class class10 {

    @OriginalMember(owner = "client!DIQFKGVT", name = "a", descriptor = "Z")
    private boolean field708 = false;

    @OriginalMember(owner = "client!DIQFKGVT", name = "b", descriptor = "I")
    public int field709;

    @OriginalMember(owner = "client!DIQFKGVT", name = "c", descriptor = "[I")
    public int[] field710;

    @OriginalMember(owner = "client!DIQFKGVT", name = "d", descriptor = "[[I")
    public int[][] field711;

    @OriginalMember(owner = "client!DIQFKGVT", name = "<init>", descriptor = "(LZOMNSJJM;I)V")
