...
public class class10 extends class53 {
    ...
    @OriginalMember(owner = "client!DUMEPGRH", name = "<init>", descriptor = "(LSPZBTZXL;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!DUMEPGRH", name = "a", descriptor = "(IILLKEIRLLI;Z)V")
