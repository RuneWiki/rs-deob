...
public class class10 extends OutputStream {
    ...
    @OriginalMember(owner = "client!hba", name = "write", descriptor = "(I)V")
    public final void write(int arg0) throws IOException {
        field132++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(Lsl;I)V")
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(Lnd;B)V")
