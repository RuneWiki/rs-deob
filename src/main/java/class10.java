...
public class class10 extends class30 {
    ...
    @OriginalMember(owner = "client!hba", name = "<init>", descriptor = "()V", line = 3)
    public class10() {
        super(1, true);
    }

    @OriginalMember(owner = "client!hba", name = "c", descriptor = "(B)I", line = 6)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(II)[I", line = 41)
    ...
    @OriginalMember(owner = "client!hba", name = "d", descriptor = "(I)V", line = 80)
