...
public class class10 {
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ai", name = "j", descriptor = "Llf;")
    public static class109 field167 = class35.method275("<img=1>", 2);

    @OriginalMember(owner = "client!ai", name = "k", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IIZLu;)V")
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ZLlf;B)V")
