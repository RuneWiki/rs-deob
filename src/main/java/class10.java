...
public class class10 extends class601 {
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(ILei;)V")
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(Lbda;ZI)V")
    ...
    @OriginalMember(owner = "client!hba", name = "<init>", descriptor = "(Lgn;)V")
    public class10(class699 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!hba", name = "<init>", descriptor = "(ILgn;)V")
