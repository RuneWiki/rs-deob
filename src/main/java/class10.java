...
public class class10 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lsr;Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!ma", name = "b", descriptor = "(B)Lpe;", line = 27)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(IZ)Z", line = 48)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "([Ljava/lang/String;B)[Ljava/lang/String;", line = 63)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(I)Lpe;", line = 93)
    ...
    @OriginalMember(owner = "client!ma", name = "<init>", descriptor = "()V", line = 115)
    public class10() {
    }

    @OriginalMember(owner = "client!ma", name = "<init>", descriptor = "(Lsr;)V", line = 117)
    public class10(class167 arg0) {
        this.field120 = arg0;
    }

    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lza;ZIILsr;)V", line = 125)
