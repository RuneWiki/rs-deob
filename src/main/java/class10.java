...
public class class10 extends class498 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(I[Lhm;IIIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(BII)V", line = 656)
    ...
    @OriginalMember(owner = "client!ma", name = "<init>", descriptor = "()V", line = 671)
    public class10() {
    }

    @OriginalMember(owner = "client!ma", name = "<init>", descriptor = "(S)V", line = 675)
