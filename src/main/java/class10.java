...
public class class10 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lat;B)V")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IIIIZ[[[Log;)Z")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IILat;)V")
