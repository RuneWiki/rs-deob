...
public abstract class class10 {
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(BC)Z", line = 3)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 45)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(IIB)Z", line = 71)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(Lgg;)V", line = 85)
