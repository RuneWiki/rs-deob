...
public class class10 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Lbc;B)V")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(ILs;)V")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(B)Lbc;")
