...
public class class10 extends class33 {
    ...
    @OriginalMember(owner = "client!CYIKEZWP", name = "h", descriptor = "I")
    public static int field597;

    @OriginalMember(owner = "client!CYIKEZWP", name = "f", descriptor = "LCYIKEZWP;")
    public class10 field595;

    @OriginalMember(owner = "client!CYIKEZWP", name = "g", descriptor = "LCYIKEZWP;")
