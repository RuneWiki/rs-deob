...
public class class10 extends class108 {
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(IIII)[B", line = 15)
    ...
    @OriginalMember(owner = "client!hba", name = "c", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!hba", name = "f", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!hba", name = "a", descriptor = "(IBB)V", line = 59)
    ...
    @OriginalMember(owner = "client!hba", name = "<init>", descriptor = "()V", line = 76)
    public class10() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!hba", name = "a", descriptor = "([I[ILai;III)Lmh;", line = 79)
