...
public class class10 implements class276 {
    ...
    @OriginalMember(owner = "client!ma", name = "finalize", descriptor = "()V", line = 14)
    protected final void finalize() {
        class379.method2355(4650, this);
    }

    @OriginalMember(owner = "client!ma", name = "b", descriptor = "()V", line = 29)
    public final void method62() {
        this.field154 = null;
        this.method60();
    }

    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lp;BIZ)Lc;", line = 40)
