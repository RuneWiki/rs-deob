...
public class class576 extends class177 implements class258 {
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Lha;IZLga;IBI)V")
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Lha;IZI)Lak;")
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(ILha;)Ljda;")
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Lha;III)Z")
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Lha;II)Lka;")
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(Lha;Liv;IIIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(Lha;I)Lhw;")
    ...
    @OriginalMember(owner = "client!uo", name = "c", descriptor = "(Lha;I)V")
