...
public abstract class class576 {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(JI)I", line = 7)
    ...
    @OriginalMember(owner = "client!cc", name = "c", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lha;I)V", line = 40)
