...
public class class576 extends class243 {
    ...
    @OriginalMember(owner = "client!fia", name = "b", descriptor = "(II)[[I", line = 13)
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(ILji;B)V", line = 80)
    ...
    @OriginalMember(owner = "client!fia", name = "<init>", descriptor = "()V", line = 124)
    public class576() {
        super(1, false);
    }

    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(II)[I", line = 131)
