...
public class class576 {
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(Lhk;Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(II)I", line = 43)
    public static final int method3323(int arg0, int arg1) {
        return class240.field3420 == null ? 0 : class240.field3420[arg0][arg1] & 0xFFFF;
    }

    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(B)V", line = 171)
