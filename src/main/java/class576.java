...
public class class576 extends class358 implements class654 {
    ...
    @OriginalMember(owner = "client!lba", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!lba", name = "<init>", descriptor = "(Lrja;Lsw;III[B)V")
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(ILwga;)V")
