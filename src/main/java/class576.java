...
public class class576 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IIILba;II)Lba;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(BLba;IIIIII)Lba;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IILiaa;)V")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ILiaa;)V")
