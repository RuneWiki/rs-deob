...
public class class576 extends class667 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IIIZ)I", line = 3)
    ...
    @OriginalMember(owner = "client!v", name = "b", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lud;II)V", line = 77)
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "()V", line = 118)
    public class576() {
        super(1, false);
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(ILjda;Ljda;)V", line = 125)
    ...
    @OriginalMember(owner = "client!v", name = "c", descriptor = "(B)V", line = 141)
    public static void method3344(byte arg0) {
        int var1 = 125 / ((-63 - arg0) / 32);
        field8161 = null;
    }

    @OriginalMember(owner = "client!v", name = "a", descriptor = "(ZI)[[I", line = 150)
