...
public class class576 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IBILvba;)V", line = 9)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(I)V", line = 869)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(ZIILjava/awt/Canvas;Lwm;Ld;)Lha;", line = 882)
    ...
    @OriginalMember(owner = "client!gp", name = "toString", descriptor = "()Ljava/lang/String;", line = 907)
    public final String toString() {
        field7319++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(II)V", line = 921)
