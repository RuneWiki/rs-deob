...
public class class576 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Lfba;Lfba;BF)Z", line = 10)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(III)Z", line = 80)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IIIZII)V", line = 92)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IIIIIIIII)Z", line = 195)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(I)Z", line = 214)
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(Llj;)V", line = 241)
