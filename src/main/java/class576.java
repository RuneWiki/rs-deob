...
public abstract class class576 implements class316 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILjaclib/memory/Source;I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Ljaggl/MapBuffer;I)Z", line = 47)
    ...
    @OriginalMember(owner = "client!dq", name = "e", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(I)I", line = 90)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ZLjaggl/MapBuffer;I)Ljaclib/memory/Buffer;", line = 106)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(II)V", line = 155)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B)J", line = 184)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(BI)V", line = 196)
    ...
    @OriginalMember(owner = "client!dq", name = "finalize", descriptor = "()V", line = 212)
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "(Loaa;IZ)V", line = 286)
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(I)V", line = 231)
    ...
    @OriginalMember(owner = "client!dq", name = "f", descriptor = "(I)V", line = 247)
    ...
    @OriginalMember(owner = "client!dq", name = "g", descriptor = "(I)V", line = 270)
