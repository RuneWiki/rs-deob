...
public class class576 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Lqd;B)V", line = 27)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Z)Lqd;", line = 43)
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(I)V", line = 80)
    public class576(int arg0) {
        this.field8302 = arg0;
    }

    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(IIIIII)V", line = 87)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(I)V", line = 63)
