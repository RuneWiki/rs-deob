...
public class class576 extends class175 {
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(Ljava/lang/Object;I)V")
    public class576(Object arg0, int arg1) {
        super(arg1);
        this.field8144 = arg0;
    }

    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(BII)Z")
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(I)Ljava/lang/Object;")
