...
public class class576 extends class779 implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(B)V", line = 6)
    public final void method1657(byte arg0) {
        int var2 = -93 / ((arg0 + 33) / 60);
        this.method3266(92);
    }

    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(III)V", line = 17)
    ...
    @OriginalMember(owner = "client!cba", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 32)
    ...
    @OriginalMember(owner = "client!cba", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 42)
    ...
    @OriginalMember(owner = "client!cba", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 66)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        this.method3265(arg0.getX(), arg0.getY(), -14944);
    }

    @OriginalMember(owner = "client!cba", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 74)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method3265(arg0.getX(), arg0.getY(), -14944);
    }

    @OriginalMember(owner = "client!cba", name = "b", descriptor = "(B)I", line = 82)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(I)I", line = 92)
    ...
    @OriginalMember(owner = "client!cba", name = "g", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!cba", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 126)
    ...
    @OriginalMember(owner = "client!cba", name = "d", descriptor = "(I)Z", line = 141)
    ...
    @OriginalMember(owner = "client!cba", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 151)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method3265(arg0.getX(), arg0.getY(), -14944);
    }

    @OriginalMember(owner = "client!cba", name = "b", descriptor = "(I)Ltaa;", line = 158)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(BLjava/awt/event/MouseEvent;)I", line = 168)
    ...
    @OriginalMember(owner = "client!cba", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 197)
    ...
    @OriginalMember(owner = "client!cba", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 311)
    public class576(Component arg0, boolean arg1) {
        this.method3269(arg0, (byte) -91);
        this.field7849 = arg1;
    }

    @OriginalMember(owner = "client!cba", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 225)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.method3265(arg0.getX(), arg0.getY(), -14944);
    }

    @OriginalMember(owner = "client!cba", name = "f", descriptor = "(I)V", line = 234)
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(IIZII)V", line = 255)
    ...
    @OriginalMember(owner = "client!cba", name = "e", descriptor = "(I)Z", line = 271)
    ...
    @OriginalMember(owner = "client!cba", name = "c", descriptor = "(B)Z", line = 285)
    public final boolean method1661(byte arg0) {
        int var2 = -13 / ((88 - arg0) / 38);
        return (this.field7844 & 0x1) != 0;
    }

    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(Ljava/awt/Component;B)V", line = 293)
