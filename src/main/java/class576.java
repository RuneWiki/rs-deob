...
public class class576 {
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Lqi;IIILoa;ZI)Lba;")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(BLd;Lqi;IIIIILoa;ZLd;II)Lba;")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(ILrt;)V")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(BLrt;I)V")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "([BI)Lka;")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(ILd;ILqi;BILoa;Ld;IIZIII)Lba;")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IILqi;ILoa;II)Lba;")
