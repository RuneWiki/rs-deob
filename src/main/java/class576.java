...
public class class576 extends class287 {
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(BJLqa;)V", line = 21)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Ljava/lang/String;IIII[B)I", line = 41)
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "(Lqa;Llh;Ldea;J)V", line = 471)
    ...
    @OriginalMember(owner = "client!ab", name = "b", descriptor = "(I)V", line = 192)
    ...
    @OriginalMember(owner = "client!ab", name = "c", descriptor = "(I)V", line = 274)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(BJIZLqa;)V", line = 300)
