...
public class class576 {
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(IIIB)I", line = 18)
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(IIIIB)V", line = 42)
