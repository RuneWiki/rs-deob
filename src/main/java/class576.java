...
public class class576 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(BILjs;ILfb;)V")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(BLso;)V")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(BILso;)V")
