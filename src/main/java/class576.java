...
public class class576 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Lps;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(BLps;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(ILlk;II)V", line = 65)
