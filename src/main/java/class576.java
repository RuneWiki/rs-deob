...
public class class576 {
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(Lkq;I)V", line = 46)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(IIILjava/lang/String;I)V", line = 72)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(Z)V", line = 202)
