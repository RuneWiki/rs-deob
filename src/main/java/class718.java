...
public class class718 {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IIILns;III)V", line = 7)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(ILoc;)Z", line = 36)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(II)Z", line = 64)
    ...
    @OriginalMember(owner = "client!rh", name = "toString", descriptor = "()Ljava/lang/String;", line = 138)
