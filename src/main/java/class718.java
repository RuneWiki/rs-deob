...
public class class718 extends class568 {
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(I[II)V", line = 3)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(BI)V", line = 166)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IBI)V", line = 180)
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(BI)V", line = 194)
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "(Lkb;IIIII)V", line = 674)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Z[[[BIBIIZ)V", line = 215)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IIIFI)V", line = 516)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(ZI)V", line = 638)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IB)V", line = 663)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IIII)V", line = 690)
