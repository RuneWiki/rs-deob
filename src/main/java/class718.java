...
public class class718 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IIILka;II)Lka;", line = 16)
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Lka;BIIIIIB)Lka;", line = 185)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Lud;I)V", line = 248)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IILud;)V", line = 273)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Z[[[Lmf;)V", line = 483)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IIIZ)I", line = 576)
