...
public class class718 extends class24 {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(ILjp;)V", line = 18)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IIIIIIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Lke;I)V", line = 101)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IZII[[[Ljd;I)Z", line = 113)
