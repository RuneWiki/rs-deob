...
public class class718 {
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(ILuu;Ljava/lang/String;Z)Ldp;")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Ljava/awt/Canvas;III)Lev;")
