...
public class class718 extends class337 {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(ZLmc;)Lms;", line = 22)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(II[[ZBI)V", line = 37)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(SI)V", line = 94)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IIIIIIZ)V", line = 113)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(B)V", line = 292)
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(Lgd;Lrd;Lgu;[I)V", line = 312)
