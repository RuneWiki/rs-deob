...
public class class718 extends class502 {
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(Leka;)V", line = 3)
    public class718(class492 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jm", name = "c", descriptor = "(B)I", line = 11)
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(ILeka;)V", line = 24)
    public class718(int arg0, class492 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Z)V", line = 34)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(IZLia;)Z", line = 51)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(II)I", line = 72)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(I)I", line = 86)
    ...
    @OriginalMember(owner = "client!jm", name = "b", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!jm", name = "c", descriptor = "(II)V", line = 109)
