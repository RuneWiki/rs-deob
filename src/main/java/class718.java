...
public class class718 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "([II)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(III)Z", line = 69)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(III)Z", line = 97)
