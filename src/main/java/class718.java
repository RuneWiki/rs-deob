...
public class class718 extends class56 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IZ)[I", line = 3)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ILd;Ljava/awt/Canvas;ILfp;)Lha;", line = 37)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ILee;I)V", line = 65)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ZII)V", line = 100)
    ...
    @OriginalMember(owner = "client!jn", name = "<init>", descriptor = "()V", line = 127)
    public class718() {
        super(1, true);
    }

    @OriginalMember(owner = "client!jn", name = "e", descriptor = "(I)V", line = 143)
