...
public class class278 extends class481 implements class602 {
    ...
    @OriginalMember(owner = "client!mda", name = "b", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(ILfq;BIILha;Z)V", line = 28)
    ...
    @OriginalMember(owner = "client!mda", name = "b", descriptor = "(Z)I", line = 57)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Luq;III)Leb;", line = 68)
    ...
    @OriginalMember(owner = "client!mda", name = "i", descriptor = "(I)Z", line = 84)
    ...
    @OriginalMember(owner = "client!mda", name = "g", descriptor = "(I)Z", line = 99)
    ...
    @OriginalMember(owner = "client!mda", name = "<init>", descriptor = "(Lha;Llp;IIIIIZIIZ)V", line = 115)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Lha;II)Lka;", line = 151)
    ...
    @OriginalMember(owner = "client!mda", name = "b", descriptor = "(Lha;B)V", line = 171)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(ZILha;B)Lsw;", line = 207)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(B)Z", line = 237)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Lha;B)V", line = 247)
    ...
    @OriginalMember(owner = "client!mda", name = "e", descriptor = "(Lha;B)V", line = 276)
    ...
    @OriginalMember(owner = "client!mda", name = "h", descriptor = "(I)V", line = 286)
    ...
    @OriginalMember(owner = "client!mda", name = "c", descriptor = "(Lha;B)Lpia;", line = 301)
    ...
    @OriginalMember(owner = "client!mda", name = "d", descriptor = "(Lha;B)Lln;", line = 327)
    ...
    @OriginalMember(owner = "client!mda", name = "c", descriptor = "(I)I", line = 347)
    public final int method1750(int arg0) {
        ++field4022;
        return arg0 != 29244 ? -30 : this.field4012;
    }

    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Z)V", line = 362)
    ...
    @OriginalMember(owner = "client!mda", name = "b", descriptor = "(I)I", line = 376)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Lfq;IIIII)V", line = 391)
    ...
    @OriginalMember(owner = "client!mda", name = "d", descriptor = "(B)I", line = 482)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(ILha;II)Z", line = 496)
