...
public class class278 extends class748 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "([IB)Ljava/lang/String;", line = 9)
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "()V", line = 59)
    public class278() {
        super(0, true);
    }

    @OriginalMember(owner = "client!re", name = "a", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(II)[I", line = 98)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IB[I)V", line = 123)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIIIIII)I", line = 283)
    ...
    @OriginalMember(owner = "client!re", name = "g", descriptor = "(I)V", line = 358)
    ...
    @OriginalMember(owner = "client!re", name = "h", descriptor = "(I)V", line = 413)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IZLvj;)V", line = 442)
