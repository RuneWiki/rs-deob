...
public class class278 extends class337 {
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(Lbaa;B)V", line = 21)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(ZI)V", line = 66)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(ZIIZ)V", line = 115)
