...
public class class278 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(III)Z", line = 53)
