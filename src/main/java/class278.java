...
public class class278 extends class430 implements class161 {
    ...
    @OriginalMember(owner = "client!qq", name = "f", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Laa;I)Lcn;", line = 20)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Laa;B)V", line = 59)
    ...
    @OriginalMember(owner = "client!qq", name = "c", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!qq", name = "c", descriptor = "(I)I", line = 82)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Laa;Z)V", line = 93)
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Laa;IB)Lhc;", line = 117)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(B)I", line = 128)
    public final int method123(byte arg0) {
        ++field3759;
        return arg0 < 108 ? -123 : this.field3760.field6316;
    }

    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(I)I", line = 139)
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "(Laa;Lsk;IIIIIIIZIIIII)V", line = 150)
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(Z)I", line = 163)
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(B)Z", line = 174)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IIILaa;)Z", line = 185)
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(Laa;B)V", line = 208)
    ...
    @OriginalMember(owner = "client!qq", name = "d", descriptor = "(I)Z", line = 221)
    public final boolean method137(int arg0) {
        ++field3766;
        return arg0 != 0 ? false : false;
    }

    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IZIILaa;ILqh;)V", line = 232)
