...
public class class278 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ILua;)V", line = 3)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IIILwm;I)V", line = 52)
