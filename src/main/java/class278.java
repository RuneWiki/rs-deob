...
public class class278 extends class127 {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(ILtj;II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(IILao;IIIIIIIII)Z", line = 39)
    ...
    @OriginalMember(owner = "client!ga", name = "c", descriptor = "(I)V", line = 472)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Ltj;I)Lri;", line = 488)
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(BLtj;)V", line = 542)
