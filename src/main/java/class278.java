...
public class class278 {
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(BLed;IILr;I)V")
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(Lps;I)V")
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(ILjda;)Z")
    ...
    @OriginalMember(owner = "client!jda", name = "<init>", descriptor = "(Lps;)V")
