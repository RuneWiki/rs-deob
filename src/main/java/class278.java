...
public abstract class class278 extends class499 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(III)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!oh", name = "d", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!oh", name = "c", descriptor = "(B)I", line = 60)
    ...
    @OriginalMember(owner = "client!oh", name = "b", descriptor = "(III)[I", line = 73)
    ...
    @OriginalMember(owner = "client!oh", name = "e", descriptor = "(I)I", line = 95)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(BI)Le;", line = 108)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Llh;II)V", line = 149)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Z)V", line = 159)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(BII)V", line = 188)
    ...
    @OriginalMember(owner = "client!oh", name = "f", descriptor = "(I)[Lof;", line = 210)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(II)[[I", line = 221)
    ...
    @OriginalMember(owner = "client!oh", name = "b", descriptor = "(II)[I", line = 237)
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(IZ)V", line = 253)
