...
public class class278 extends class201 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(IILjt;I)J")
    ...
    @OriginalMember(owner = "client!sg", name = "b", descriptor = "(I)Lus;")
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(Lnq;IIIIII)V")
