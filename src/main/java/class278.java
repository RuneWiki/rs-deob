...
public class class278 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(B)V", line = 6)
    public static void method1698(byte arg0) {
        int var1 = 7 / ((-arg0 - 31) / 58);
        field4229 = null;
    }

    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Ljava/lang/String;BIZ)I", line = 30)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IB)Lm;", line = 109)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Ljava/lang/String;IB)V", line = 140)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Lia;II)V", line = 154)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(I)V", line = 177)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(II)V", line = 190)
    ...
    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "(Lcm;ILlt;)V", line = 210)
