...
public class class278 extends class159 {
    ...
    @OriginalMember(owner = "client!le", name = "c", descriptor = "(B)Lwg;", line = 8)
    ...
    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "(Len;I)V", line = 22)
    public class278(class289 arg0, int arg1) {
        this.field3892 = arg0;
        this.field3893 = new class389(arg0, 6408, arg1);
    }

    @OriginalMember(owner = "client!le", name = "e", descriptor = "(B)I", line = 33)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(Lwg;Lwg;IF)Z", line = 54)
