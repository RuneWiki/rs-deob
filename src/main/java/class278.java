...
public class class278 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(ILdr;)I")
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Lwd;B)[Lvi;")
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(Lim;II)V")
