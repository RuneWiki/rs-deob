...
public class class278 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(III)I", line = 16)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(II)[I", line = 50)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Lia;)V", line = 395)
