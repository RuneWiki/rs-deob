...
public class class278 {
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 4)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(BLjava/lang/String;I[Lf;)Ljava/lang/String;", line = 23)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(BLjava/lang/String;)I", line = 145)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(BZIII)Lte;", line = 163)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(IILjava/lang/String;I[Lf;)I", line = 205)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(I)V", line = 221)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Ljava/lang/String;B[Lf;I)I", line = 423)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(B[Lf;Ljava/lang/String;)I", line = 434)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(B[I[Lf;Ljava/lang/String;[Ljava/lang/String;)I", line = 537)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(ILjava/lang/String;I[Lf;)I", line = 794)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(CZI)I", line = 821)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(IZ)I", line = 842)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Z)V", line = 854)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(ZZ)Z", line = 872)
    public static boolean method1715(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!ov", name = "<init>", descriptor = "([B)V", line = 883)
