...
public class class278 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ILso;I)V")
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ILs;IBZLha;ILs;ILjv;IIII)Lka;")
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lne;I)Z")
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lso;I)Lwd;")
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Ljv;IIIIBLha;)Lka;")
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ILso;)V")
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IIILjv;ZBILha;)Lka;")
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Ljv;Lha;Ls;IIIILs;IIZII)Lka;")
