...
public class class278 {
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "()V", line = 16)
    ...
    @OriginalMember(owner = "client!oca", name = "<init>", descriptor = "(Loia;J[Lwja;)V", line = 187)
    public class278(class97 arg0, long arg1, class283[] arg2) {
        this.field3843 = arg1;
        this.field3844 = arg0;
    }

    @OriginalMember(owner = "client!oca", name = "finalize", descriptor = "()V", line = 199)
