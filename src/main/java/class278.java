...
public class class278 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Ltm;BLtm;)V")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(III)Lwo;")
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(Lji;)V")
