...
public class class278 implements Runnable {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!np", name = "run", descriptor = "()V", line = 42)
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(III)Z", line = 122)
    ...
    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "(Ljava/io/InputStream;I)V", line = 225)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(III[B)I", line = 136)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(ZI)Z", line = 179)
