...
public class class278 {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Lkea;Lkea;II)V", line = 14)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Lada;BI)Lfv;", line = 31)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(I)V", line = 55)
