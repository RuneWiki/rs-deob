...
public class class278 extends class413 {
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(BLae;)V")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Lrd;B)V")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(B)Ldg;")
