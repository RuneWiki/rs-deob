...
public class class278 extends class317 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(CIIIZLma;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!je", name = "OA", descriptor = "(CIIIZ)V", line = 50)
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "(Lkd;Llm;[Ldi;Z)V", line = 70)
