...
public class class278 extends class17 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lwm;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "()V", line = 49)
    public class278() {
        super(1, false);
    }

    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IB)[[I", line = 53)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(II)[I", line = 102)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lwm;Z)Lme;", line = 136)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IZ)V", line = 152)
    ...
    @OriginalMember(owner = "client!tb", name = "g", descriptor = "(I)V", line = 263)
    ...
    @OriginalMember(owner = "client!tb", name = "h", descriptor = "(I)V", line = 277)
