...
public class class278 implements class90 {
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(ILjava/lang/String;IIBLla;)I", line = 3)
    ...
    @OriginalMember(owner = "client!ce", name = "b", descriptor = "(B)Z", line = 14)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(BZ)V", line = 26)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(IIIII)Z", line = 58)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Ljava/lang/String;IILjava/lang/String;)I", line = 82)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(B)V", line = 212)
    ...
    @OriginalMember(owner = "client!ce", name = "<init>", descriptor = "(Leo;Lnd;)V", line = 222)
    public class278(class266 arg0, class504 arg1) {
        this.field4206 = arg1;
        this.field4205 = arg0;
    }

    @OriginalMember(owner = "client!ce", name = "c", descriptor = "(B)V", line = 231)
