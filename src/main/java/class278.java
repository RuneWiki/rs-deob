...
public class class278 extends class390 {
    ...
    @OriginalMember(owner = "client!nm", name = "c", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!nm", name = "b", descriptor = "(III)Z", line = 24)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lkr;)V", line = 43)
    ...
    @OriginalMember(owner = "client!nm", name = "d", descriptor = "(B)V", line = 94)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IIZ)Z", line = 106)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "([IIII)V", line = 129)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(BI[II)V", line = 147)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IZII)Z", line = 160)
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(IIIIIIIII)V", line = 175)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Loo;Loo;IIIIZIII)V", line = 191)
