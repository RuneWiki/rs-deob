...
public class class278 {
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(B)Z", line = 6)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lek;I)V", line = 29)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Z)V", line = 91)
