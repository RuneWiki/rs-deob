...
public class class278 extends class114 {
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IIIIILjka;IIIILha;I)V", line = 12)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ILwfa;)V", line = 81)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Ljc;I)V", line = 105)
