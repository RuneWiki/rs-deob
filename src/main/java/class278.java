...
public class class278 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(BI)Lck;", line = 7)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Z)V", line = 69)
    ...
    @OriginalMember(owner = "client!ks", name = "<init>", descriptor = "(Ldn;ILr;)V", line = 87)
