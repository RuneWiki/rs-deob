...
public class class278 extends class417 {
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(BI[II)V", line = 3)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(IIII)Z", line = 16)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(BII)Z", line = 33)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(II[II)V", line = 73)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(BI)V", line = 89)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(III)Z", line = 102)
    ...
    @OriginalMember(owner = "client!pba", name = "<init>", descriptor = "(IIIIIIIII)V", line = 123)
