...
public class class278 extends class377 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(FBIZLuh;)V", line = 3)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lls;Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Z)V", line = 38)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Lls;B)V", line = 58)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IB)V", line = 75)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(II)V", line = 91)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!nm", name = "b", descriptor = "(B)V", line = 123)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(ILls;)V", line = 134)
    ...
    @OriginalMember(owner = "client!nm", name = "b", descriptor = "(I)V", line = 151)
