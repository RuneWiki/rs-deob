...
public class class278 extends class195 {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "()Leq;", line = 4)
    public final class195 method220() {
        return (class195) this.field4487.method3469(0);
    }

    @OriginalMember(owner = "client!vt", name = "e", descriptor = "()V", line = 8)
    ...
    @OriginalMember(owner = "client!vt", name = "c", descriptor = "([III)V", line = 28)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!vt", name = "b", descriptor = "([III)V", line = 92)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Leq;)V", line = 136)
    public final synchronized void method1985(class195 arg0) {
        arg0.method707((byte) -115);
    }

    @OriginalMember(owner = "client!vt", name = "b", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!vt", name = "f", descriptor = "()I", line = 158)
    public final synchronized int method1987() {
        return this.field4487.method3468(0);
    }

    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Lnl;)V", line = 165)
    ...
    @OriginalMember(owner = "client!vt", name = "c", descriptor = "()Leq;", line = 178)
    public final class195 method219() {
        return (class195) this.field4487.method3465((byte) -125);
    }

    @OriginalMember(owner = "client!vt", name = "b", descriptor = "()I", line = 181)
    public final int method215() {
        return 0;
    }

    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Lu;Lnl;)V", line = 184)
    ...
    @OriginalMember(owner = "client!vt", name = "b", descriptor = "(Leq;)V", line = 194)
