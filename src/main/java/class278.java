...
public abstract class class278 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(ZZ)Z", line = 6)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(III)I", line = 36)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(BII)I", line = 63)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(ZI)Z", line = 78)
    ...
    @OriginalMember(owner = "client!s", name = "<init>", descriptor = "(III[[I)V", line = 164)
