...
public class class278 extends class35 {
    ...
    @OriginalMember(owner = "client!qp", name = "c", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IZ)V", line = 28)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IIIIB)V", line = 54)
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIJII)V", line = 106)
