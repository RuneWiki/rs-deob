...
public class class278 {
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(BII)I", line = 17)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(IIB)I", line = 31)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Liaa;ILpe;I)V", line = 55)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Lag;BII)V", line = 173)
    ...
    @OriginalMember(owner = "client!ce", name = "toString", descriptor = "()Ljava/lang/String;", line = 228)
    public final String toString() {
        field3516++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(BZ)C", line = 237)
