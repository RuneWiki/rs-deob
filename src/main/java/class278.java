...
public class class278 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(I)Leg;")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ILes;)V")
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(Z)Leg;")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ILes;Z)V")
