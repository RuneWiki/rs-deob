...
public class class278 extends class311 {
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(BI)V", line = 25)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Lcd;B)V", line = 41)
    ...
    @OriginalMember(owner = "client!no", name = "c", descriptor = "(I)Lae;", line = 62)
    ...
    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(II)V", line = 76)
    public class278(int arg0, int arg1) {
        this.field3793 = arg1;
        this.field3795 = arg0;
    }

    @OriginalMember(owner = "client!no", name = "d", descriptor = "(I)V", line = 86)
