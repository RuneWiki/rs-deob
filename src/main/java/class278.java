...
public class class278 extends class208 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(III)V", line = 12)
    ...
    @OriginalMember(owner = "client!qd", name = "b", descriptor = "(III)V", line = 25)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ZII)V", line = 83)
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 98)
