...
public class class278 extends class161 {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "([I)Lkr;")
    ...
    @OriginalMember(owner = "client!qq", name = "e", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Lmo;)Z")
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Lmo;II)Lqq;")
