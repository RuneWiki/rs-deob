...
public class class278 extends class544 implements class28 {
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 19)
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(La;Ljava/awt/Canvas;)V", line = 46)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(Ljava/lang/Exception;)V", line = 53)
    ...
    @OriginalMember(owner = "client!b", name = "finalize", descriptor = "()V", line = 74)
