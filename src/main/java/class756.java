...
public class class756 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IIZII)V", line = 5)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "([IZIIIIII)Z", line = 31)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Z)Z", line = 128)
