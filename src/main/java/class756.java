...
public class class756 extends class392 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lgg;III)V")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ILem;)Z")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Z)Leda;")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(BLem;)Z")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(BLov;)V")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lha;I)V")
