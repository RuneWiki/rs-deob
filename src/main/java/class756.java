...
public class class756 {
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(Lwf;Ljava/lang/Object;II)V", line = 15)
    ...
    @OriginalMember(owner = "client!kca", name = "b", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(Lvj;B)V", line = 51)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(Lwf;Z)Ljava/lang/Object;", line = 99)
    ...
    @OriginalMember(owner = "client!kca", name = "b", descriptor = "(B)I", line = 167)
    ...
    @OriginalMember(owner = "client!kca", name = "c", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(Ldc;I)V", line = 203)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(Lwf;ILjava/lang/Object;)V", line = 222)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(ZI)V", line = 234)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(Lwf;I)V", line = 282)
    ...
    @OriginalMember(owner = "client!kca", name = "<init>", descriptor = "(I)V", line = 309)
