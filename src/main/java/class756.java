...
public class class756 extends class573 {
    ...
    @OriginalMember(owner = "client!nca", name = "b", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!nca", name = "b", descriptor = "(Z)V", line = 63)
    ...
    @OriginalMember(owner = "client!nca", name = "f", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(ZI)V", line = 110)
    ...
    @OriginalMember(owner = "client!nca", name = "<init>", descriptor = "(Llaa;Lwu;)V", line = 120)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(ZZ)V", line = 156)
    ...
    @OriginalMember(owner = "client!nca", name = "b", descriptor = "(I)Z", line = 177)
    public final boolean method605(int arg0) {
        ++field10511;
        return arg0 != 4095 ? false : this.field10518;
    }

    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(III)V", line = 189)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(Lwc;IB)V", line = 203)
