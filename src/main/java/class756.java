...
public class class756 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(I)Lqm;")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lsl;Ljava/lang/String;I)I")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "([Ljw;II)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Z)Lqm;")
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(Lqp;)V")
