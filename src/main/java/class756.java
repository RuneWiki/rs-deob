...
public class class756 {
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(IIIIIIIBIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(II[Lvo;)V", line = 27)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(Lrfa;ZZ)V", line = 93)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(IIZ)Z", line = 129)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(IIZI)V", line = 140)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(IBLjava/lang/String;)V", line = 165)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 178)
