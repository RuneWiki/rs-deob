...
public class class756 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IIIZ)Z", line = 13)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(B)I", line = 153)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(II)V", line = 165)
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(B)V", line = 183)
