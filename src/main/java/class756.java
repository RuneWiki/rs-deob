...
public class class756 extends class741 {
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(IZII)V", line = 25)
    ...
    @OriginalMember(owner = "client!pea", name = "<init>", descriptor = "(Laj;Laj;Lgn;)V", line = 57)
    public class756(class333 arg0, class333 arg1, class731 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(IZIII)V", line = 60)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(ZBII)V", line = 77)
    ...
    @OriginalMember(owner = "client!pea", name = "b", descriptor = "(I)Z", line = 114)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(B)V", line = 154)
