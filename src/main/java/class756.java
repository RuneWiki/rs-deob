...
public class class756 extends class189 {
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(I[I[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(CI)Z", line = 45)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(II)V", line = 86)
    ...
    @OriginalMember(owner = "client!eca", name = "<init>", descriptor = "()V", line = 107)
    public class756() {
    }

    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(JI)V", line = 111)
    ...
    @OriginalMember(owner = "client!eca", name = "<init>", descriptor = "(I)V", line = 129)
