...
public class class756 {
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(BI)Ltt;", line = 16)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(IB)V", line = 45)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!kca", name = "b", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(CI)Z", line = 89)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(Lsr;I)V", line = 100)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(BLofa;)Lji;", line = 114)
    ...
    @OriginalMember(owner = "client!kca", name = "<init>", descriptor = "(Lcr;ILla;)V", line = 137)
