...
public class class756 extends class512 {
    ...
    @OriginalMember(owner = "client!aca", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(IFII[FII[FIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!aca", name = "<init>", descriptor = "(Llf;II[B)V", line = 105)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(Z)V", line = 116)
