...
public class class756 {
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(B)Lwm;")
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(Lcea;B)V")
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(ILcea;I)V")
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(ILin;II)Lbh;")
