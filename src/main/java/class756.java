...
public class class756 extends class601 {
    ...
    @OriginalMember(owner = "client!wia", name = "b", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!wia", name = "<init>", descriptor = "(ILgn;)V")
    ...
    @OriginalMember(owner = "client!wia", name = "<init>", descriptor = "(Lgn;)V")
