...
public class class660 extends class525 {
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(III)Lhia;")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(B)Lte;")
    ...
    @OriginalMember(owner = "client!lw", name = "<init>", descriptor = "(ILbg;Lbg;Ljd;Lpt;I[BIZ)V")
