...
public class class660 {
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(IIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!rda", name = "finalize", descriptor = "()V", line = 33)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(IIIIZ)V", line = 42)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(BI)S", line = 63)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(III)Z", line = 91)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!rda", name = "<init>", descriptor = "(Lnv;J[Lw;)V", line = 121)
    public class660(class417 arg0, long arg1, class299[] arg2) {
        this.field9421 = arg0;
        this.field9424 = arg1;
    }

    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(JJ)J", line = 135)
