...
public class class660 extends class299 {
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(Les;)V", line = 3)
    public class660(class404 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!mh", name = "b", descriptor = "(Z)I", line = 8)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Ljava/lang/String;Z)J", line = 19)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(I)I", line = 73)
    ...
    @OriginalMember(owner = "client!mh", name = "b", descriptor = "(II)V", line = 88)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(II)I", line = 112)
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(ILes;)V", line = 123)
    public class660(int arg0, class404 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!mh", name = "b", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IZ)V", line = 140)
