...
public class class660 extends class375 {
    ...
    @OriginalMember(owner = "client!mga", name = "d", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(Lmo;I)V", line = 22)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!mga", name = "c", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(Lmo;IB)V", line = 99)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(IC)I", line = 162)
    ...
    @OriginalMember(owner = "client!mga", name = "c", descriptor = "(Z)V", line = 188)
    ...
    @OriginalMember(owner = "client!mga", name = "b", descriptor = "(IC)I", line = 287)
