...
public class class660 extends class56 {
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(I[[IBIIILjava/util/Random;)V")
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(Lqm;Ljava/lang/String;ZILda;Lha;)V")
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(ILee;I)V")
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(IZ)[I")
