...
public class class660 extends class204 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!co", name = "c", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "(Lfs;)V", line = 28)
    public class660(class607 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!co", name = "d", descriptor = "(II)V", line = 31)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(II)I", line = 43)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "(ILfs;)V", line = 82)
    public class660(int arg0, class607 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!co", name = "b", descriptor = "(B)I", line = 85)
