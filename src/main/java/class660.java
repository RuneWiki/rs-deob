...
public class class660 {
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(III)V", line = 9)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IIIBII)V", line = 36)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(B)V", line = 168)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(I[B)V", line = 181)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(BII)Z", line = 374)
    ...
    @OriginalMember(owner = "client!gj", name = "<init>", descriptor = "([BI[B)V", line = 399)
