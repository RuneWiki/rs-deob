...
public class class660 {
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(ZILr;I)Z", line = 28)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(IIB[[ZZI)V", line = 101)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(BZLjava/lang/String;Leq;)Lsw;", line = 300)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(I)V", line = 351)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(Lr;BII)V", line = 380)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(IIIII)V", line = 452)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(IIILr;)V", line = 494)
    ...
    @OriginalMember(owner = "client!ica", name = "<init>", descriptor = "(Lgt;Lov;)V", line = 564)
