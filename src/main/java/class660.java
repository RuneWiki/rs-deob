...
public class class660 {
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lha;Ljava/lang/String;IIIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lha;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 25)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "()I", line = 115)
    public final int method3767() {
        return this.field9204 - 1;
    }

    @OriginalMember(owner = "client!gj", name = "b", descriptor = "()I", line = 119)
    public final int method3768() {
        return this.field9199;
    }

    @OriginalMember(owner = "client!gj", name = "<init>", descriptor = "(Lha;IZLjava/awt/Component;)V", line = 173)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lha;Ljava/lang/String;[IIIIZ)V", line = 126)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Ljava/lang/String;)I", line = 156)
    ...
    @OriginalMember(owner = "client!gj", name = "c", descriptor = "()V", line = 216)
