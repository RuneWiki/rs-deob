...
public class class660 {
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IZ)V", line = 9)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IB)V", line = 47)
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(B)V", line = 93)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(II)Lrf;", line = 110)
    ...
    @OriginalMember(owner = "client!pa", name = "<init>", descriptor = "(Lmca;IZLgga;Lgga;)V", line = 190)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(ZB)V", line = 153)
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(IB)V", line = 169)
