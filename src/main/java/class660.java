...
public class class660 extends class260 {
    ...
    @OriginalMember(owner = "client!am", name = "<init>", descriptor = "(ILfca;)V", line = 4)
    public class660(int arg0, class92 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(I)I", line = 38)
    ...
    @OriginalMember(owner = "client!am", name = "c", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Lda;Lha;Leia;ZILjava/lang/String;)V", line = 61)
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(IB)V", line = 158)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(B)I", line = 172)
    ...
    @OriginalMember(owner = "client!am", name = "<init>", descriptor = "(Lfca;)V", line = 183)
    public class660(class92 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IB)I", line = 186)
    ...
    @OriginalMember(owner = "client!am", name = "d", descriptor = "(I)Z", line = 214)
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(B)Z", line = 235)
