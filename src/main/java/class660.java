...
public class class660 extends class701 {
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(Lmv;Lmv;Lvt;)V", line = 5)
    public class660(class295 arg0, class295 arg1, class683 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(III)V", line = 24)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IIB)Z", line = 36)
