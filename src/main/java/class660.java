...
public class class660 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Ltc;IIII)Z", line = 18)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(FFFB)F", line = 146)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(BZZ)V", line = 163)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Ljava/io/File;IZ)V", line = 194)
    ...
    @OriginalMember(owner = "client!am", name = "b", descriptor = "(I)V", line = 224)
    ...
    @OriginalMember(owner = "client!am", name = "toString", descriptor = "()Ljava/lang/String;", line = 337)
