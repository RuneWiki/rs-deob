...
public class class660 {
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(B)V", line = 126)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(I)V", line = 168)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IIIIILkb;IIIIII)Z", line = 183)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IBI)V", line = 624)
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 637)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Lrda;IIBII)Lqd;", line = 652)
