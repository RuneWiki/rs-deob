...
public class class660 {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!dr", name = "b", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(II)V", line = 44)
    ...
    @OriginalMember(owner = "client!dr", name = "b", descriptor = "(II)Lfp;", line = 57)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(III)V", line = 96)
    ...
    @OriginalMember(owner = "client!dr", name = "c", descriptor = "(B)V", line = 116)
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(Ldd;ILpj;)V", line = 136)
