...
public class class660 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Liaa;)V", line = 4)
    ...
    @OriginalMember(owner = "client!wn", name = "b", descriptor = "(Liaa;)V", line = 13)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "()V", line = 49)
    public class660() {
        this.field9398[0] = 0;
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "()V", line = 64)
