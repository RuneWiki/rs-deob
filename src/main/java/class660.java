...
public class class660 extends class205 {
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(Lofa;B)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "([IBLofa;)V")
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(ILgba;B)V")
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(IZLofa;)V")
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(BI)Lln;")
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(BLofa;)V")
