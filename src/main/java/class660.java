...
public class class660 extends class710 {
    ...
    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "(Lji;II)V")
    ...
    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "(Lji;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "(Lji;IIZ[[BI)V")
