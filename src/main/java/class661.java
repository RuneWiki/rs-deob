...
public class class661 implements class549 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(B[IJLo;)Ljava/lang/String;", line = 45)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(II)Z", line = 77)
