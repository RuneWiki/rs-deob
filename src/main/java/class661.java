...
public class class661 extends class77 {
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 4)
    public class661(Object arg0, int arg1) {
        super(arg1);
        this.field9206 = new SoftReference(arg0);
    }

    @OriginalMember(owner = "client!qs", name = "h", descriptor = "(I)Z", line = 14)
    ...
    @OriginalMember(owner = "client!qs", name = "i", descriptor = "(I)Ljava/lang/Object;", line = 24)
