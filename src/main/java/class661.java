...
public class class661 extends class165 {
    ...
    @OriginalMember(owner = "client!dw", name = "<init>", descriptor = "(Lep;Lfa;)V")
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Lvj;I)Lvc;")
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(IZLhl;)V")
