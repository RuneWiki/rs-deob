...
public class class661 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Z)I", line = 63)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(JI)Lgga;", line = 96)
    ...
    @OriginalMember(owner = "client!wa", name = "b", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(ZLgga;J)V", line = 134)
    ...
    @OriginalMember(owner = "client!wa", name = "c", descriptor = "(I)Lgga;", line = 155)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(B)Lgga;", line = 187)
    ...
    @OriginalMember(owner = "client!wa", name = "d", descriptor = "(I)Lgga;", line = 224)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "([Lgga;B)I", line = 240)
    ...
    @OriginalMember(owner = "client!wa", name = "b", descriptor = "(III)I", line = 271)
    ...
    @OriginalMember(owner = "client!wa", name = "e", descriptor = "(I)I", line = 286)
    ...
    @OriginalMember(owner = "client!wa", name = "<init>", descriptor = "(I)V", line = 308)
