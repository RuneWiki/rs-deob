...
public class class661 {
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(IILjava/util/Random;)I", line = 5)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(IBI)V", line = 51)
