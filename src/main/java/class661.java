...
public class class661 {
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(Lpl;II)Laga;")
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(Lpl;I)[Laga;")
    ...
    @OriginalMember(owner = "client!aga", name = "b", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "([B)[Laga;")
    ...
    @OriginalMember(owner = "client!aga", name = "b", descriptor = "(Lpl;I)Laga;")
    ...
    @OriginalMember(owner = "client!aga", name = "b", descriptor = "(Lpl;II)[Laga;")
