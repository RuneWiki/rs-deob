...
public class class661 {
    ...
    @OriginalMember(owner = "client!bca", name = "<init>", descriptor = "(III)V", line = 166)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(BI)[I", line = 46)
    ...
    @OriginalMember(owner = "client!bca", name = "b", descriptor = "(I)[[I", line = 114)
