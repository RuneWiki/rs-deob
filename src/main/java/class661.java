...
public class class661 extends class440 {
    ...
    @OriginalMember(owner = "client!ega", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ega", name = "<init>", descriptor = "()V", line = 49)
    public class661() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ega", name = "d", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(ILmo;I)V", line = 86)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(BI)[I", line = 138)
