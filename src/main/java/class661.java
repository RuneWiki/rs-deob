...
public class class661 {
    ...
    @OriginalMember(owner = "client!sp", name = "b", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(II)V", line = 22)
    ...
    @OriginalMember(owner = "client!sp", name = "b", descriptor = "(II)Leea;", line = 35)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IZLnw;)V", line = 67)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(I)V", line = 228)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(BILec;)V", line = 241)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(ZLib;)Loca;", line = 324)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Z)V", line = 337)
    ...
    @OriginalMember(owner = "client!sp", name = "<init>", descriptor = "(Lto;ILla;Lkca;)V", line = 367)
