...
public class class661 extends class56 {
    ...
    @OriginalMember(owner = "client!jk", name = "d", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!jk", name = "g", descriptor = "(I)V", line = 198)
    ...
    @OriginalMember(owner = "client!jk", name = "h", descriptor = "(I)V", line = 316)
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "()V", line = 360)
    public class661() {
        super(1, true);
    }

    @OriginalMember(owner = "client!jk", name = "b", descriptor = "(II)[I", line = 343)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(BILes;)V", line = 368)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(B)V", line = 396)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(II)[I", line = 417)
