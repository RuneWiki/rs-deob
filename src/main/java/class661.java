...
public class class661 {
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lcm;IZ)V", line = 27)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(B)V", line = 178)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lcm;[IBI)V", line = 189)
