...
public class class661 extends class123 {
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "(IIIIIF)V", line = 3)
    public class661(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IILcu;)Z", line = 6)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(II)V", line = 27)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(FI)V", line = 40)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IIBI)V", line = 56)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IBII)I", line = 69)
