...
public class class661 extends class737 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IIIILjava/awt/Graphics;III)V", line = 16)
    ...
    @OriginalMember(owner = "client!vp", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 32)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field9065;
    }

    @OriginalMember(owner = "client!vp", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 41)
    ...
    @OriginalMember(owner = "client!vp", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 52)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field9071;
        return this.field9068 == arg0;
    }

    @OriginalMember(owner = "client!vp", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 62)
    public final void startProduction(ImageConsumer arg0) {
        this.addConsumer(arg0);
        ++field9059;
    }

    @OriginalMember(owner = "client!vp", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 70)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IIIBI)V", line = 84)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(B)V", line = 102)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Ljava/awt/Canvas;III)V", line = 112)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(I)V", line = 142)
