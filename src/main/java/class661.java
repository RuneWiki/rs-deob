...
public class class661 extends class362 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(CI)Z", line = 6)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(II)[I", line = 28)
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "()V", line = 111)
    public class661() {
        super(1, true);
    }

    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(Lfca;II)V", line = 76)
    ...
    @OriginalMember(owner = "client!jk", name = "c", descriptor = "(I)V", line = 115)
