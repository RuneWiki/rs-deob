...
public abstract class class661 {
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "([Lmi;I)V", line = 110)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(ILqo;III)Leba;", line = 142)
    ...
    @OriginalMember(owner = "client!bca", name = "f", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!bca", name = "h", descriptor = "(I)V", line = 179)
