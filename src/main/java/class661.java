...
public class class661 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IZIIIZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(ZII)V", line = 49)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Z)V", line = 93)
    public static final void method3704(boolean arg0) {
        class684.field9622 = arg0;
        field9396++;
    }

    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IIIIIIII)Z", line = 103)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IIIIIBIII)Z", line = 483)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IIIIIBII)Z", line = 523)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IIIB)V", line = 711)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IIIZIIZI)V", line = 729)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(ZZIIIII)V", line = 788)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IZZIZII)V", line = 1096)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IIII)V", line = 1405)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(III)V", line = 1416)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IBI)V", line = 1426)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(B)I", line = 1439)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IIIIIIIIII)Z", line = 1453)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(III)V", line = 1546)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(I)V", line = 1568)
