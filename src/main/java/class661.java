...
public class class661 {
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(I)Lko;", line = 7)
    ...
    @OriginalMember(owner = "client!fca", name = "b", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(Lko;I)V", line = 64)
    ...
    @OriginalMember(owner = "client!fca", name = "c", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!fca", name = "d", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!fca", name = "e", descriptor = "(I)Z", line = 122)
    ...
    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "()V", line = 281)
    public class661() {
        this.field8613.field4103 = this.field8613;
        this.field8613.field4111 = this.field8613;
    }

    @OriginalMember(owner = "client!fca", name = "f", descriptor = "(I)I", line = 140)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(Lko;Z)V", line = 163)
    ...
    @OriginalMember(owner = "client!fca", name = "g", descriptor = "(I)Lko;", line = 181)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(B)Lko;", line = 199)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(BLfca;Lko;)V", line = 220)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(ZLfca;)V", line = 246)
    ...
    @OriginalMember(owner = "client!fca", name = "b", descriptor = "(B)Lko;", line = 259)
    ...
    @OriginalMember(owner = "client!fca", name = "h", descriptor = "(I)Lko;", line = 290)
