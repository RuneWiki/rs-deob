...
public class class661 {
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(ILie;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 26)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!ega", name = "b", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(B)V", line = 190)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(BII[Ljava/lang/String;)Ljava/lang/String;", line = 204)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(IILie;)V", line = 295)
