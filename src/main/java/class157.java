...
public class class157 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IBLss;)Ljava/lang/String;", line = 20)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(I)I", line = 53)
    public static final int method973(int arg0) {
        field2239++;
        return arg0 == -256 ? 16 : 70;
    }

    @OriginalMember(owner = "client!lf", name = "toString", descriptor = "()Ljava/lang/String;", line = 68)
    public final String toString() {
        field2231++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(ID)V", line = 83)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 108)
