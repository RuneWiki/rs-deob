...
public class class157 extends class4 {
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Lsq;)V", line = 4)
    public class157(class96 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(ILai;Lai;)V", line = 15)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "()Z", line = 162)
    ...
    @OriginalMember(owner = "client!ao", name = "e", descriptor = "()Z", line = 190)
    public final boolean method1107() {
        return this.field82.field1196 && this.field82.field1287 && this.field82.field1222;
    }

    @OriginalMember(owner = "client!ao", name = "c", descriptor = "()V", line = 196)
    ...
    @OriginalMember(owner = "client!ao", name = "d", descriptor = "()I", line = 209)
    public final int method75() {
        return 1;
    }

    @OriginalMember(owner = "client!ao", name = "e", descriptor = "(I)V", line = 215)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(II)V", line = 223)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "()Z", line = 291)
