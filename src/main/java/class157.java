...
public abstract class class157 {
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IIIIILsba;Lsba;ZII[I)V")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lsba;IIIZILsba;II)V")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IIIIIILsa;II)V")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lsba;IIIIIII[ZZILsba;Lsba;Lsba;I)V")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(ILmd;)V")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IILsba;)V")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(ILeaa;Leaa;I[Z[IZIIZBLcda;)V")
