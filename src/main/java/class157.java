...
public class class157 extends class377 {
    ...
    @OriginalMember(owner = "client!cfa", name = "f", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(IILji;)V", line = 35)
    ...
    @OriginalMember(owner = "client!cfa", name = "e", descriptor = "(B)V", line = 128)
    ...
    @OriginalMember(owner = "client!cfa", name = "b", descriptor = "(B)V", line = 141)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(Lw;III[Z)Z", line = 171)
    ...
    @OriginalMember(owner = "client!cfa", name = "g", descriptor = "(I)V", line = 209)
    ...
    @OriginalMember(owner = "client!cfa", name = "<init>", descriptor = "()V", line = 496)
    public class157() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(IIIIIII)I", line = 263)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(BI[I)V", line = 339)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "([BBIIIII)V", line = 507)
    ...
    @OriginalMember(owner = "client!cfa", name = "a", descriptor = "(II)[I", line = 604)
