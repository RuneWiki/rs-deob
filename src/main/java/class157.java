...
public class class157 extends class4 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ILha;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(III)Z", line = 101)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Ld;ILuu;)Z", line = 113)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ZIILuu;Ld;I)[F", line = 166)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(DIZZLuu;Ld;II)[I", line = 281)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(I)V", line = 423)
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "()V", line = 433)
    public class157() {
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(Ldc;)V", line = 448)
    ...
    @OriginalMember(owner = "client!ia", name = "f", descriptor = "(I)V", line = 534)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(BDILuu;IZLd;)[I", line = 569)
