...
public class class157 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(ILbq;)V", line = 73)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IIILbo;I)V", line = 91)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Z)V", line = 252)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(II)Lnl;", line = 271)
