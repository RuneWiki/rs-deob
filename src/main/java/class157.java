...
public class class157 extends class184 {
    ...
    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Ljava/lang/String;IILug;)Lsl;", line = 16)
    ...
    @OriginalMember(owner = "client!fa", name = "e", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(II)[I", line = 75)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(BILfh;)V", line = 105)
