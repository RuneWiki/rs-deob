...
public class class157 extends class388 {
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(ILsl;)V")
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(Lsl;B)Lqfa;")
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(Lsl;II)V")
