...
public class class157 extends class277 {
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(Lfg;)V")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(BI)Lqda;")
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IIBLwca;)V")
