...
public class class157 extends class134 implements class107 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(ILjava/nio/ByteBuffer;Z)Lum;")
    ...
    @OriginalMember(owner = "client!ao", name = "n", descriptor = "()Lnc;")
    public final class18 method649() {
        return this.field1931;
    }

    @OriginalMember(owner = "client!ao", name = "a", descriptor = "([IIIII)Lgj;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lbm;Lbm;FLbm;)Lbm;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lem;)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lbm;)V")
    public final void method688(class59 arg0) {
        this.field1973 = (class438) arg0;
    }

    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lgm;)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Ltj;)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Ltr;IIII)Lbk;")
    ...
    @OriginalMember(owner = "client!ao", name = "x", descriptor = "()Lnc;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(I[Lqp;)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "([Lbk;Lgm;Lnc;[Lkf;I)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lpm;)V")
    public final void method950(class349 arg0) {
        this.field1927.glPushMatrix();
        this.field1927.glMultMatrixf(arg0.method2234(87), 0);
    }

    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIIIIILhb;II)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(I[BIZ)Lum;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lth;[Lgo;Z)Lsj;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lnc;)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(II[I[I)Lhb;")
    ...
    @OriginalMember(owner = "client!ao", name = "U", descriptor = "()Lvk;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "([Lbk;Lnc;[Lkf;I)V")
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(I[BIZ)Las;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lgo;Z)Lgj;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Las;III)V")
    ...
    @OriginalMember(owner = "client!ao", name = "Z", descriptor = "()Ltj;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Las;)V")
    ...
    @OriginalMember(owner = "client!ao", name = "c", descriptor = "(IIIIII)Lbm;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lum;)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lhf;Lhf;Lhf;Lhf;)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(II[[I[[IIII)Lgh;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(ILhb;II)V")
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(Ltj;)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIIIZ)Lgj;")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Llp;)V")
    ...
    @OriginalMember(owner = "client!ao", name = "g", descriptor = "(I)Lem;")
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Ljava/awt/Canvas;Lul;IILrd;)V")
