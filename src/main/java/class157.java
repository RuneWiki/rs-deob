...
public class class157 extends class5 {
    ...
    @OriginalMember(owner = "client!ea", name = "i", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IZ)[[I", line = 19)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(II)[I", line = 106)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "()V", line = 158)
    public class157() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(ILes;I)V", line = 161)
