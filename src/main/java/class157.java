...
public class class157 {
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(ILgga;II)Lida;")
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(Lcea;ZIZLjava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(ILol;)Lkh;")
    ...
    @OriginalMember(owner = "client!pda", name = "c", descriptor = "(B)V")
