...
public class class157 {
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(II)I", line = 17)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(II[BI)Z", line = 28)
    ...
    @OriginalMember(owner = "client!cw", name = "toString", descriptor = "()Ljava/lang/String;", line = 57)
    public final String toString() {
        field2327++;
        return "Cache:" + this.field2336;
    }

    @OriginalMember(owner = "client!cw", name = "<init>", descriptor = "(ILtq;Ltq;I)V", line = 304)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(III[BZ)Z", line = 82)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(I)V", line = 201)
    ...
    @OriginalMember(owner = "client!cw", name = "b", descriptor = "(II)[B", line = 214)
