...
public class class157 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IZZ)V", line = 55)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Z)V", line = 79)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(ILpf;IIIIIIIII)Z", line = 92)
