...
public class class157 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(ILat;II)V", line = 21)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(BLnf;I)V", line = 90)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IB)Ljava/lang/String;", line = 131)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(I)V", line = 157)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(BIIII)V", line = 193)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IZ)Lvu;", line = 221)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IIIB)I", line = 287)
    ...
    @OriginalMember(owner = "client!kc", name = "toString", descriptor = "()Ljava/lang/String;", line = 318)
    public final String toString() {
        field2402++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 327)
