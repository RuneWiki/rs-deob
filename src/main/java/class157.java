...
public class class157 extends class626 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(II)Lgba;")
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(B[ILfca;[I[I)V")
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Lnc;I[B[I)Z")
