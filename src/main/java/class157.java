...
public class class157 extends class447 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ol", name = "d", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!ol", name = "e", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!ol", name = "e", descriptor = "(B)I", line = 85)
    public static final int method1056(byte arg0) {
        field2228++;
        return arg0 > -96 ? -12 : class307.field4213;
    }

    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IIIZI)V", line = 107)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Z)V", line = 126)
    ...
    @OriginalMember(owner = "client!ol", name = "<init>", descriptor = "(Lhp;Ljl;)V", line = 141)
    ...
    @OriginalMember(owner = "client!ol", name = "f", descriptor = "(I)V", line = 155)
