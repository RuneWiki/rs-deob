...
public class class157 extends class512 {
    ...
    @OriginalMember(owner = "client!er", name = "c", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "()V", line = 17)
    public class157() {
        super(1, true);
    }

    @OriginalMember(owner = "client!er", name = "a", descriptor = "(ZILia;)V", line = 21)
    ...
    @OriginalMember(owner = "client!er", name = "f", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IB)[I", line = 75)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(II[FIIZIIFI)V", line = 113)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(ILjava/lang/String;I)I", line = 167)
