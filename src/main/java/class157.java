...
public class class157 extends class148 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(ZI)[[I", line = 23)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(ILdh;I)V", line = 87)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "()V", line = 132)
    public class157() {
        super(1, false);
    }
}
