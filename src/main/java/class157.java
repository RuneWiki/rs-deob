...
public class class157 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(II)[B", line = 3)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIIII)V", line = 68)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ILwm;I)V", line = 83)
    ...
    @OriginalMember(owner = "client!sm", name = "b", descriptor = "(I)Z", line = 145)
    ...
    @OriginalMember(owner = "client!sm", name = "c", descriptor = "(I)V", line = 172)
