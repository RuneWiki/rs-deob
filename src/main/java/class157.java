...
public class class157 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(I[B[BIII)I", line = 5)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(ZI[BII[B)I", line = 74)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(Z)V", line = 232)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(I)V", line = 284)
    ...
    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "([B)V", line = 309)
