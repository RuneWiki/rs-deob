...
public abstract class class157 extends class86 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Leq;Lbp;III)V", line = 5)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(ILqn;ILae;)V", line = 54)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(JB)V", line = 167)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(BII)Z", line = 257)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(I)[Liu;", line = 272)
    ...
    @OriginalMember(owner = "client!sr", name = "c", descriptor = "(I)V", line = 286)
    ...
    @OriginalMember(owner = "client!sr", name = "b", descriptor = "(BII)I", line = 307)
