...
public class class157 extends class546 {
    ...
    @OriginalMember(owner = "client!tca", name = "<init>", descriptor = "(Lrr;)V", line = 3)
    public class157(class332 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(IZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!tca", name = "b", descriptor = "(III)V", line = 19)
    ...
    @OriginalMember(owner = "client!tca", name = "f", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(IZLwq;)V", line = 56)
    ...
    @OriginalMember(owner = "client!tca", name = "c", descriptor = "(III)Z", line = 72)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(B)Z", line = 87)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(ZI)V", line = 104)
    ...
    @OriginalMember(owner = "client!tca", name = "h", descriptor = "(I)V", line = 139)
