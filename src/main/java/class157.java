...
public class class157 {
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(ILnu;ILr;IZI)Lda;", line = 9)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(ILac;)V", line = 20)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(ILi;ILnu;IIIBLi;ILr;IIZ)Lda;", line = 43)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(Lnu;ILr;IIII)Lda;", line = 178)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(IILac;)V", line = 193)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(Li;IIIILi;IZLr;Lnu;IBI)Lda;", line = 326)
