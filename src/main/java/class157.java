...
public class class157 implements class557 {
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "([IIJLlj;)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(B)I", line = 42)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(III)V", line = 59)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IZIIIBIII)Z", line = 72)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IIZI)V", line = 103)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(BI)Lpe;", line = 119)
