...
public class class157 {
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(BLun;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(ZI)V", line = 63)
