...
public class class157 {
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(B)Lbk;")
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(B)Lbk;")
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(I)Lbk;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIILmp;Lmp;)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(BLbk;)V")
