...
public class class157 extends class627 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(I)Z", line = 44)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ZIIIB)V", line = 87)
