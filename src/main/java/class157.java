...
public class class157 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Luq;Luq;BLuq;Luq;)V", line = 3)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(I)Lvia;", line = 41)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Lfq;I)V", line = 60)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Ljc;I)V", line = 82)
    ...
    @OriginalMember(owner = "client!pj", name = "b", descriptor = "(I)Z", line = 104)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(BLqn;)V", line = 121)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Lfq;B)V", line = 132)
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 170)
