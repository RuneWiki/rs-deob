...
public class class157 extends class504 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lqc;Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "([Lkga;Ljc;Z)Lhia;", line = 29)
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(B)V", line = 99)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(ILmc;)V", line = 113)
