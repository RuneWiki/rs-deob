...
public class class157 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!ct", name = "finalize", descriptor = "()V", line = 24)
    ...
    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "(Lnv;J[Lpj;)V", line = 37)
