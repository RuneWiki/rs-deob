...
public class class157 extends class518 {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(ZLjava/lang/String;ILjava/lang/String;Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!oj", name = "c", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "()V", line = 60)
    public class157() {
        super(0, false);
    }

    @OriginalMember(owner = "client!oj", name = "f", descriptor = "(I)Z", line = 70)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(II)[[I", line = 100)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(ILjc;I)V", line = 172)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(B)I", line = 189)
