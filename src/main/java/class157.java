...
public class class157 {
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(BC)C", line = 6)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(II[BIIIIB[B)V", line = 51)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(BI)Lnm;", line = 97)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(III)Lhh;", line = 134)
    ...
    @OriginalMember(owner = "client!cw", name = "<init>", descriptor = "(Lcda;ILkea;)V", line = 150)
