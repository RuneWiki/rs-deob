...
public class class157 extends class381 implements class351 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Lnr;Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!jj", name = "b", descriptor = "(Lnr;Z)Lg;", line = 16)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(B)Z", line = 50)
    public final boolean method146(byte arg0) {
        ++field2063;
        return arg0 <= 102 ? true : this.field2067.method743(-1724944720);
    }

    @OriginalMember(owner = "client!jj", name = "d", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!jj", name = "b", descriptor = "(B)I", line = 76)
    ...
    @OriginalMember(owner = "client!jj", name = "e", descriptor = "(B)Z", line = 87)
    ...
    @OriginalMember(owner = "client!jj", name = "d", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!jj", name = "g", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(BLnr;IIZLcb;I)V", line = 121)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IIIIII)Z", line = 137)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ILnr;)V", line = 199)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(BILnr;)Lqc;", line = 212)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Lnr;I)V", line = 222)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ILim;BI)J", line = 238)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ILnr;II)Z", line = 274)
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(Lnr;Lta;IIIIIIZI)V", line = 295)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(I)I", line = 304)
    ...
    @OriginalMember(owner = "client!jj", name = "c", descriptor = "(B)I", line = 319)
