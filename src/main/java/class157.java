...
public class class157 {
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IIIIJLmj;IILaa;)V", line = 17)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IIB)Z", line = 73)
