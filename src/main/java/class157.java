...
public class class157 {
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IIII)Lou;")
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(ILha;IILjl;I)V")
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(I)Lvfa;")
