...
public class class157 extends class85 {
    ...
    @OriginalMember(owner = "client!r", name = "R", descriptor = "Llf;")
    public static class109 field2949 = class35.method275("::qa_op_test", 2);

    @OriginalMember(owner = "client!r", name = "S", descriptor = "Llf;")
    public static class109 field2950 = class35.method275(":", 2);

    @OriginalMember(owner = "client!r", name = "W", descriptor = "Ljava/util/zip/CRC32;")
    ...
    @OriginalMember(owner = "client!r", name = "eb", descriptor = "Llf;")
    private static class109 field2962 = class35.method275("red:", 2);

    @OriginalMember(owner = "client!r", name = "Z", descriptor = "Llf;")
    public static class109 field2957 = field2962;

    @OriginalMember(owner = "client!r", name = "cb", descriptor = "Llf;")
    public static class109 field2960 = field2962;

    @OriginalMember(owner = "client!r", name = "bb", descriptor = "[[S")
    ...
    @OriginalMember(owner = "client!r", name = "X", descriptor = "Lu;")
    public static class184 field2955;

    @OriginalMember(owner = "client!r", name = "gb", descriptor = "[Lch;")
    private class29[] field2964;

    @OriginalMember(owner = "client!r", name = "a", descriptor = "(ZBLfi;)V")
