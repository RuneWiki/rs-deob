...
public class class157 extends class377 {
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 27)
    public class157(Object arg0, int arg1) {
        super(arg1);
        this.field2064 = arg0;
    }

    @OriginalMember(owner = "client!kv", name = "g", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(I)Z", line = 49)
    ...
    @OriginalMember(owner = "client!kv", name = "d", descriptor = "(B)Ljava/lang/Object;", line = 65)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(I[B)Z", line = 77)
