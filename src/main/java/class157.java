...
public class class157 {
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(II)Laa;", line = 23)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(ZI)Lqg;", line = 54)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(ZLjava/lang/String;IZBZLjava/lang/String;IIJI)V", line = 84)
    ...
    @OriginalMember(owner = "client!p", name = "b", descriptor = "(Z)V", line = 143)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(I)V", line = 159)
    ...
    @OriginalMember(owner = "client!p", name = "<init>", descriptor = "(Ldk;ILfc;Lfc;Lfc;)V", line = 222)
    ...
    @OriginalMember(owner = "client!p", name = "b", descriptor = "(I)V", line = 181)
    ...
    @OriginalMember(owner = "client!p", name = "b", descriptor = "(II)V", line = 197)
