...
public class class157 {
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(ILoa;)V", line = 18)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(Lvp;IIII)V", line = 83)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(B)V", line = 135)
    ...
    @OriginalMember(owner = "client!cda", name = "b", descriptor = "(B)I", line = 151)
    ...
    @OriginalMember(owner = "client!cda", name = "<init>", descriptor = "()V", line = 171)
    public class157() {
    }

    @OriginalMember(owner = "client!cda", name = "<init>", descriptor = "(Liaa;)V", line = 173)
