...
public class class157 extends class168 implements class164 {
    ...
    @OriginalMember(owner = "client!tg", name = "c", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IB)V", line = 21)
    ...
    @OriginalMember(owner = "client!tg", name = "d", descriptor = "(I)Z", line = 58)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lya;II)Lt;", line = 70)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IILya;Z)Lpm;", line = 91)
    ...
    @OriginalMember(owner = "client!tg", name = "g", descriptor = "(I)I", line = 126)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lig;I)Z", line = 138)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(I)I", line = 158)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lya;ZI)Lt;", line = 171)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(BI)I", line = 182)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lya;I)Lag;", line = 193)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(BLya;II)Z", line = 220)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILkk;I)V", line = 245)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(Z)V", line = 309)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ZLya;)V", line = 320)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lya;Z)V", line = 354)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(II)V", line = 365)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(B)I", line = 376)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ILya;)V", line = 396)
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(Lya;Ljt;IIIIZIIIII)V", line = 424)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(I)V", line = 450)
