...
public class class157 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(FFBIFIII)[F", line = 3)
    ...
    @OriginalMember(owner = "client!rf", name = "toString", descriptor = "()Ljava/lang/String;", line = 86)
    public final String toString() {
        field2233++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!rf", name = "a", descriptor = "([FIIIFFIIIIB)V", line = 97)
