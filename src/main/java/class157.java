...
public class class157 extends class311 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IZ)Lvg;")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(ILof;)V")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "([IILof;[I[I)V")
