...
public class class157 {
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(IIZLjava/lang/String;Ljava/lang/String;)V", line = 8)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(ZI)I", line = 22)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(I)Z", line = 59)
    public static final boolean method1159(int arg0) {
        field2515++;
        return class87.field1246 >= arg0;
    }

    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(ILjava/lang/String;)V", line = 84)
