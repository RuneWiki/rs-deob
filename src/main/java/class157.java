...
public class class157 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(II)[[[B", line = 10)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(B)V", line = 790)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IIIIIII)V", line = 811)
