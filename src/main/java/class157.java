...
public class class157 {
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(IB)Lp;")
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(Lcr;Ljava/awt/Frame;I)V")
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(Ljava/lang/String;ZBLpq;)Lps;")
    ...
    @OriginalMember(owner = "client!gda", name = "<init>", descriptor = "(Luea;ILpq;Lpq;)V")
