...
public class class157 {
    ...
    @OriginalMember(owner = "client!jd", name = "e", descriptor = "Lus;")
    public class1 field2398;
    ...
    @OriginalMember(owner = "client!jd", name = "i", descriptor = "Lqa;")
    public static class167 field2402;

    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(II)[[[B", line = 4)
    public static final byte[][][] method1100(int arg0, int arg1) {
        field2394++;
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(B)V", line = 785)
    public static void method1101(byte arg0) {
        if (arg0 > -73) {
            method1102(114, -108, -37);
        }
        field2395 = null;
        field2402 = null;
        field2403 = null;
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(III)I", line = 797)
    public static final int method1102(int arg0, int arg1, int arg2) {
        field2397++;
        if (arg0 > -2) {
            method1100(-102, -116);
        }
        int var3 = class521.method3088((byte) 88, 4, arg2 + 45365, arg1 + 91923) + (class521.method3088((byte) 88, 2, arg2 + 10294, arg1 - -37821) - 128 >> 1) + (class521.method3088((byte) 88, 1, arg2, arg1) + -128 >> 2) - 128;
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "(Lus;III)V", line = 826)
    public class157(class1 arg0, int arg1, int arg2, int arg3) {
        this.field2400 = (short) arg1;
        this.field2398 = arg0;
        this.field2399 = (byte) arg3;
        this.field2396 = (byte) arg2;
    }
}
