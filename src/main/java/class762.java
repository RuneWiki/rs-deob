...
public class class762 extends class175 {
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "()V", line = 9)
    public class762() {
        super(3, false);
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IIIIIII)Lcj;", line = 20)
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ILdt;Z)V", line = 55)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IB)[[I", line = 69)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ZI)[I", line = 154)
