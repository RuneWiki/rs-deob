...
public class class762 extends class316 {
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(ILso;)V")
    ...
    @OriginalMember(owner = "client!ww", name = "c", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(BLmda;)V")
