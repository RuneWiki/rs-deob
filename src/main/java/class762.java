...
public class class762 extends class245 {
    ...
    @OriginalMember(owner = "client!ms", name = "e", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!ms", name = "c", descriptor = "(III)V", line = 25)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IIB)V", line = 35)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(III)V", line = 50)
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(IIIIIII)V", line = 73)
