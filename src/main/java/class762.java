...
public class class762 {
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(III)Z", line = 19)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(B)Lwia;", line = 54)
    ...
    @OriginalMember(owner = "client!wia", name = "<init>", descriptor = "(I)V", line = 95)
    public class762(int arg0) {
        this.field10610 = arg0;
    }

    @OriginalMember(owner = "client!wia", name = "<init>", descriptor = "(IIIIII)V", line = 102)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(ILwia;)V", line = 75)
