...
public class class762 extends class441 implements class722 {
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(Lha;B)Liha;")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IBLha;Z)Lcn;")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lha;I)Lua;")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ILha;IB)Z")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ZLha;)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IILnfa;IIIIIIII)Z")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lha;Z)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(BLha;ZILuq;II)V")
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(Lha;Lts;IIIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ZLha;I)Lka;")
