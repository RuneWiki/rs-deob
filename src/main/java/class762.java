...
public class class762 extends class454 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Lol;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(CI)I", line = 69)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Z)V", line = 91)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Lol;B)V", line = 108)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(BC)I", line = 138)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(I)V", line = 171)
