...
public class class762 {
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Lha;IIIIIIZZ)V", line = 35)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(BI)Lro;", line = 153)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IB)V", line = 195)
    ...
    @OriginalMember(owner = "client!mp", name = "c", descriptor = "(I)V", line = 211)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(Lal;ILnd;)V", line = 232)
