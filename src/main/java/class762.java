...
public class class762 extends class299 {
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(ILes;)V", line = 4)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IZ)V", line = 23)
    ...
    @OriginalMember(owner = "client!cm", name = "c", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(I)I", line = 44)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(Z)I", line = 57)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Les;)V", line = 68)
    public class762(class404 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(I)V", line = 78)
