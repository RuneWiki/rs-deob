...
public class class681 implements Runnable {
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Ljava/lang/String;I)Lu;", line = 24)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(I[BFIFBFFFIIIILcq;)V", line = 46)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(ILpb;)V", line = 115)
    ...
    @OriginalMember(owner = "client!ufa", name = "<init>", descriptor = "()V", line = 132)
    public class681() {
        this.field9509.setDaemon(true);
        this.field9509.start();
    }

    @OriginalMember(owner = "client!ufa", name = "run", descriptor = "()V", line = 144)
