...
public class class681 extends class253 implements class466 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ILha;)Lrk;")
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ILha;II)Z")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lha;Z)V")
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(Lha;Lro;IIIIIZIIIIIII)V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Laka;I)V")
    ...
    @OriginalMember(owner = "client!gr", name = "c", descriptor = "(Lha;I)Ltja;")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Loq;IZILha;II)V")
