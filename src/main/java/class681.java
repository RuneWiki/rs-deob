...
public class class681 {
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(Ldga;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(IF[FIFIFIIIIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(Ldga;II)V", line = 113)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(Z)Lme;", line = 137)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(I)V", line = 164)
