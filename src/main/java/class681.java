...
public class class681 extends class710 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIIFZIIZ)[I", line = 37)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(BZ)V", line = 67)
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(Lji;II[BI)V", line = 81)
