...
public abstract class class681 {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(BLsea;)V", line = 38)
    ...
    @OriginalMember(owner = "client!cc", name = "c", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!cc", name = "e", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "(Lnv;)V", line = 89)
    public class681(class382 arg0) {
        this.field9721 = arg0;
    }

    @OriginalMember(owner = "client!cc", name = "f", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(BIII)I", line = 108)
