...
public class class681 extends class616 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IIB)Z", line = 4)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(II[F)[F", line = 38)
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(Lkga;II[B)V", line = 62)
