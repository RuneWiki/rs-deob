...
public class class681 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(Lr;III[Z)V")
    ...
    @OriginalMember(owner = "client!rs", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V")
