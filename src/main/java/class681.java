...
public class class681 {
    ...
    @OriginalMember(owner = "client!nfa", name = "b", descriptor = "(Z)V", line = 13)
    ...
    @OriginalMember(owner = "client!nfa", name = "c", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!nfa", name = "d", descriptor = "(I)V", line = 46)
