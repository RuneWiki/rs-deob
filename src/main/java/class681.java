...
public class class681 {
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIIB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(I)V", line = 32)
    public static void method3799(int arg0) {
        field9631 = null;
        int var1 = -12 % ((arg0 + 27) / 63);
    }

    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Ltg;IIBLha;)V", line = 44)
