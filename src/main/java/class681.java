...
public class class681 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IILha;)Z")
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(ILcm;)V")
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IBIIIIIILha;I)V")
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(I[Lth;IIII)V")
