...
public class class681 extends class459 implements class695 {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Lkk;I)V")
    public final void method1215(class238 arg0, int arg1) {
        super.method1215(arg0, arg1);
    }

    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "(Lik;Lwu;III[B)V")
    ...
    @OriginalMember(owner = "client!it", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
