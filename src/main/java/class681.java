...
public class class681 {
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(I)Z", line = 9)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(III)Liq;", line = 24)
    ...
    @OriginalMember(owner = "client!ww", name = "<init>", descriptor = "(BIIIIIILpn;)V", line = 36)
