...
public class class681 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(BI)Lu;", line = 22)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(Lsj;ILin;)V", line = 111)
    public class681(class460 arg0, int arg1, class91 arg2) {
        this.field9220 = arg2;
        this.field9220.method860(0, 31);
    }

    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(III)V", line = 88)
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(B)V", line = 129)
