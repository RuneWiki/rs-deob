...
public class class681 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(II)V", line = 22)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Z)V", line = 64)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IIIIIII)V", line = 80)
