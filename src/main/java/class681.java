...
public class class681 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Ljava/awt/Canvas;B)Lmv;", line = 26)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(BI)V", line = 49)
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(II)Lql;", line = 213)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(BZ)V", line = 247)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(I)V", line = 265)
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(I)Z", line = 282)
    ...
    @OriginalMember(owner = "client!hb", name = "c", descriptor = "(B)V", line = 307)
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "(Lbs;IZLpfa;Lpfa;)V", line = 386)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IB)V", line = 341)
    ...
    @OriginalMember(owner = "client!hb", name = "c", descriptor = "(I)V", line = 364)
