...
public class class681 extends class362 {
    ...
    @OriginalMember(owner = "client!mj", name = "d", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!mj", name = "<init>", descriptor = "()V", line = 21)
    public class681() {
        super(0, true);
    }

    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Lfca;II)V", line = 28)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!mj", name = "e", descriptor = "(III)V", line = 119)
    ...
    @OriginalMember(owner = "client!mj", name = "c", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(BII)Z", line = 151)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(II)[I", line = 172)
