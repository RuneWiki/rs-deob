...
public class class681 {
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(Lr;ILoj;IIII)Lda;")
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(Lnp;IB)V")
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(ILoj;Lr;IIII)Lda;")
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(IILr;Loj;BIILi;IILi;IZ)Lda;")
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(Li;Li;IILr;Loj;BIIZIIII)Lda;")
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(Lnp;I)V")
