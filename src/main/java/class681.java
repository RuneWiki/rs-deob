...
public class class681 {
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(Lr;IIIIII)V")
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(Lr;)V")
    ...
    @OriginalMember(owner = "client!raa", name = "b", descriptor = "(Lr;)V")
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(Lr;Lraa;)Z")
    ...
    @OriginalMember(owner = "client!raa", name = "b", descriptor = "(Lr;Lraa;)Z")
    public final boolean method3835(class566 arg0, class681 arg1) {
        return this.field9575 != null || this.method3833(arg0, arg1);
    }

    @OriginalMember(owner = "client!raa", name = "c", descriptor = "(Lr;Lraa;)V")
    ...
    @OriginalMember(owner = "client!raa", name = "b", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!raa", name = "d", descriptor = "(Lr;Lraa;)V")
