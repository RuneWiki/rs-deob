...
public class class681 implements Runnable {
    ...
    @OriginalMember(owner = "client!it", name = "run", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Ljava/lang/String;IB)I", line = 64)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(B)V", line = 112)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(III[B)I", line = 123)
    ...
    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "(Ljava/io/InputStream;I)V", line = 226)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IZ)Z", line = 181)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(III)Lvea;", line = 214)
