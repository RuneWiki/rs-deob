...
public class class681 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(I[BIBI[B)I", line = 12)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IIII)I", line = 82)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(BILeea;II)Lll;", line = 124)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "([BII[BII)I", line = 145)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IIZLjb;)V", line = 292)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "([B)V", line = 316)
