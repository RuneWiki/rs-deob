...
public class class681 implements class152 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ZI)Lmp;")
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(II)Lpba;")
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(Lni;Lni;Lni;)V")
