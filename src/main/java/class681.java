...
public class class681 extends class363 implements class599 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Lr;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(ZLr;II)Z", line = 26)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(BLr;)Lqw;", line = 43)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(Lr;I)Lcu;", line = 99)
    ...
    @OriginalMember(owner = "client!qb", name = "j", descriptor = "(I)Z", line = 110)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(B)I", line = 128)
    ...
    @OriginalMember(owner = "client!qb", name = "l", descriptor = "(I)I", line = 143)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Lr;Ltc;IIIIIZIIIII)V", line = 413)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(B)I", line = 169)
    ...
    @OriginalMember(owner = "client!qb", name = "m", descriptor = "(I)V", line = 183)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(BLjd;)V", line = 194)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(I)Z", line = 379)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Lr;I)V", line = 393)
    ...
    @OriginalMember(owner = "client!qb", name = "c", descriptor = "(I)I", line = 422)
    public final int method706(int arg0) {
        ++field9673;
        return arg0 != 16259 ? 118 : this.field9660.field129;
    }

    @OriginalMember(owner = "client!qb", name = "f", descriptor = "(I)Z", line = 434)
    ...
    @OriginalMember(owner = "client!qb", name = "d", descriptor = "(B)I", line = 445)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Lr;B)V", line = 456)
