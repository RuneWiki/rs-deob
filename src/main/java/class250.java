...
public class class250 implements Runnable {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Lfr;Le;Z)I")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Ltf;I)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Ljava/lang/String;I)Lsa;")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ZLfn;ILe;IZIIIIIII)V")
