...
public class class250 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IIZII)V", line = 3)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(II)Lhn;", line = 21)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IZ)Lqk;", line = 54)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(BI)Z", line = 92)
    ...
    @OriginalMember(owner = "client!pi", name = "b", descriptor = "(II)V", line = 104)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(B)V", line = 126)
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(Lmp;ILla;)V", line = 148)
