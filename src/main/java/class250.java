...
public class class250 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IB)Lv;")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(ZZLls;Z)V")
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "(Lai;ILic;)V")
