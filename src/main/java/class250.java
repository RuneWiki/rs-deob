...
public class class250 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Liaa;I)V")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Lap;I)V")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IBLiaa;)V")
