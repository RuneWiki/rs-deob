...
public class class250 extends class218 implements class121 {
    ...
    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "(Ltt;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Lza;)V")
    ...
    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "(Ltt;ILjaggl/memory/NativeBuffer;IZ)V")
