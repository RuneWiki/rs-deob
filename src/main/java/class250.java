...
public class class250 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(II)Lhf;", line = 7)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(III)Lgg;", line = 127)
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(Ldn;ILr;Lr;)V", line = 167)
