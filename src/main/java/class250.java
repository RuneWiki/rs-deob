...
public class class250 extends class50 implements class425 {

    @OriginalMember(owner = "client!vk", name = "y", descriptor = "Ljp;")
    public class239 field3855;
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ZLza;II)Z", line = 3)
    public final boolean method14(boolean arg0, class288 arg1, int arg2, int arg3) {
        ++field3871;
        class374 var5 = this.field3855.method1559(super.field1002, super.field1005, 131072, -12, arg1, false, arg0);
        if (var5 == null) {
            return false;
        } else {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Z)I", line = 19)
    public final int method225(boolean arg0) {
        if (arg0) {
            field3865 = 10;
        }
        ++field3862;
        return this.field3855.field3711;
    }

    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(B)Z", line = 48)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Ljava/lang/String;ZBI)I", line = 59)
    public static final int method1623(String arg0, boolean arg1, byte arg2, int arg3) {
        ++field3858;
        if (~arg3 <= -3 && arg3 <= 36) {
            boolean var4 = false;
            boolean var5 = false;
    ...
    @OriginalMember(owner = "client!vk", name = "c", descriptor = "(I)I", line = 141)
    public final int method231(int arg0) {
        ++field3860;
        return arg0 <= 7 ? -11 : this.field3855.field3687;
    }

    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IBILvs;Lza;ZI)V", line = 152)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(BLza;)V", line = 163)
    public final void method9(byte arg0, class288 arg1) {
        if (arg0 <= -98) {
            ++field3870;
            class374 var3 = this.field3855.method1559(super.field1002, super.field1005, 262144, -12, arg1, true, true);
            if (var3 != null) {
                int var4 = super.field1002 >> 7;
                int var5 = super.field1005 >> 7;
                this.field3855.method1562(var4, 1, var5, var4, var5, var3, false, arg1);
            }
        }
    }

    @OriginalMember(owner = "client!vk", name = "d", descriptor = "(I)I", line = 184)
    public final int method224(int arg0) {
        if (arg0 != -10848) {
            return -125;
        } else {
            ++field3850;
            return this.field3855.field3692;
        }
    }

    @OriginalMember(owner = "client!vk", name = "j", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Lza;I)V", line = 207)
    public final void method233(class288 arg0, int arg1) {
        if (arg1 != 13367) {
            method1625((class459) null, -10);
        }
        this.field3855.method1564((byte) 67, arg0);
        ++field3853;
    }

    @OriginalMember(owner = "client!vk", name = "f", descriptor = "(I)V", line = 219)
    public final void method12(int arg0) {
        ++field3866;
        int var2 = -35 % ((arg0 - -35) / 44);
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Lph;I)V", line = 230)
    public static final void method1625(class459 arg0, int arg1) {
        if (arg1 == 704) {
            ++field3869;
            class204.field3269 = arg0;
        }
    }

    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Lza;Z)V", line = 241)
    public final void method232(class288 arg0, boolean arg1) {
        this.field3855.method1571(arg0, 63);
        if (!arg1) {
            this.method229(98);
        }
        ++field3859;
    ...
    @OriginalMember(owner = "client!vk", name = "b", descriptor = "(Lza;I)Lnd;", line = 258)
    public final class385 method15(class288 arg0, int arg1) {
        ++field3867;
        class374 var3 = this.field3855.method1559(super.field1002, super.field1005, 2048, -12, arg0, true, false);
        if (var3 == null) {
            return null;
        } else {
            class124 var4 = arg0.method364();
            var4.method835(super.field1002, super.field1004, super.field1005);
            class385 var5 = null;
            if (arg1 != 2) {
                method1625((class459) null, -19);
            }
            if (this.field3856) {
                var5 = class497.method3001(1, false);
            }
            if (this.field3855.field3707 == null) {
                var3.method723(var4, var5 == null ? null : var5.field5620[0], 0);
            } else {
                class502 var6 = this.field3855.field3707.method490();
                arg0.method298(var3, var6, var4, var5 == null ? null : var5.field5620[0], 0);
            }
            int var7 = super.field1002 >> 7;
            int var8 = super.field1005 >> 7;
            this.field3855.method1562(var7, 1, var8, var7, var8, var3, true, arg0);
            return var5;
        }
    }

    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "(Lza;Ljc;IIIIIZIII)V", line = 301)
    public class250(class288 arg0, class306 arg1, int arg2, int arg3, int arg4, int arg5, int arg6, boolean arg7, int arg8, int arg9, int arg10) {
        super(arg4, arg5, arg6, class490.method2961(arg9, (byte) 118, arg8));
        this.field3855 = new class239(arg0, arg1, arg8, arg9, arg2, arg3, super.field1002, super.field1005, arg7, arg10);
        this.field3856 = ~arg1.field4587 != -1 && !arg7;
    }

    @OriginalMember(owner = "client!vk", name = "b", descriptor = "(I)Z", line = 315)
    public final boolean method228(int arg0) {
        if (arg0 != 1396) {
            method1624(-91);
        }
        ++field3851;
        return this.field3855.method1563(1);
    }

    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ILza;I)Le;", line = 326)
    public final class374 method234(int arg0, class288 arg1, int arg2) {
        if (arg0 <= 99) {
            this.method224(-10);
        }
        ++field3854;
        return this.field3855.method1559(0, 0, arg2, -12, arg1, false, false);
    }
}
