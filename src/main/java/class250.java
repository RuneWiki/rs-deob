...
public class class250 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!hb", name = "toString", descriptor = "()Ljava/lang/String;", line = 15)
    public final String toString() {
        field3191++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(III)Z", line = 35)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "(II)V", line = 73)
