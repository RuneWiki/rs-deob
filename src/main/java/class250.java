...
public class class250 extends class320 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Z)Z", line = 3)
    ...
    @OriginalMember(owner = "client!wu", name = "c", descriptor = "(I)I", line = 18)
    public final int method1607(int arg0) {
        field3574++;
        return arg0 == -1 ? class366.method2286((byte) 87, this.field3585) : -10;
    }

    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IIIIIIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IB)Z", line = 60)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Lqf;III)V", line = 73)
    ...
    @OriginalMember(owner = "client!wu", name = "b", descriptor = "(Z)I", line = 101)
    public final int method1611(boolean arg0) {
        field3580++;
        return arg0 ? (this.field3585 & 0x1DF351) >> 18 : -56;
    }

    @OriginalMember(owner = "client!wu", name = "c", descriptor = "(Z)Z", line = 112)
    ...
    @OriginalMember(owner = "client!wu", name = "d", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(B)Z", line = 137)
    ...
    @OriginalMember(owner = "client!wu", name = "e", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "(II)V", line = 170)
    public class250(int arg0, int arg1) {
        this.field3578 = arg1;
        this.field3585 = arg0;
    }

    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(II)V", line = 183)
