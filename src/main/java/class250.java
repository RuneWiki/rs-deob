...
public class class250 {
    ...
    @OriginalMember(owner = "client!nb", name = "finalize", descriptor = "()V", line = 10)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lpq;BILjava/lang/String;)Lvs;", line = 39)
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "(Lmh;II)V", line = 120)
