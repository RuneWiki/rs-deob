...
public class class250 {
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(IIIIIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(IILwq;)V", line = 29)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(IIIB)Z", line = 49)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!rga", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 97)
