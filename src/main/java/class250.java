...
public class class250 extends class43 {
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(I)V", line = 3)
    public static void method1624(int arg0) {
        field3289 = null;
        int var1 = -78 / ((arg0 - 76) / 49);
    }

    @OriginalMember(owner = "client!uf", name = "c", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "(I[B)V", line = 57)
