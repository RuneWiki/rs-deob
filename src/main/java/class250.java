...
public class class250 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IZ)Liv;", line = 6)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(BLnt;)[Lnl;", line = 38)
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "(Lle;ILoi;)V", line = 114)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Lza;I)V", line = 135)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(II)V", line = 239)
