...
public class class250 extends class210 {
    ...
    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "()V", line = 183)
    public class250() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(II)Lhr;", line = 13)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IILat;)V", line = 40)
    ...
    @OriginalMember(owner = "client!qa", name = "e", descriptor = "(I)V", line = 121)
    public final void method363(int arg0) {
        class51.method392(arg0);
        ++field3676;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IB)[I", line = 132)
    ...
    @OriginalMember(owner = "client!qa", name = "d", descriptor = "(III)Z", line = 187)
    ...
    @OriginalMember(owner = "client!qa", name = "g", descriptor = "(I)V", line = 203)
    ...
    @OriginalMember(owner = "client!qa", name = "e", descriptor = "(III)Z", line = 224)
