...
public class class250 extends class30 {
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "([BIIIIII)Z", line = 16)
    ...
    @OriginalMember(owner = "client!gf", name = "d", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(II)Lsr;", line = 85)
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "()V", line = 311)
    public class250() {
        super(0, true);
    }

    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(BILac;)V", line = 106)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(II)[I", line = 157)
    ...
    @OriginalMember(owner = "client!gf", name = "g", descriptor = "(I)V", line = 273)
