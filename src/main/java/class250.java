...
public abstract class class250 {
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(ILvk;Liaa;IILtba;II)V", line = 22)
    ...
    @OriginalMember(owner = "client!ida", name = "b", descriptor = "(B)V", line = 129)
