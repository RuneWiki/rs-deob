...
public class class250 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(BII)Lid;", line = 16)
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "(Lht;I)V", line = 40)
    public class250(class410 arg0, int arg1) {
        this.field3476 = OpenGL.glGenLists(arg1);
    }

    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IC)V", line = 56)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!wu", name = "b", descriptor = "(I)V", line = 83)
