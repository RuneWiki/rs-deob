...
public class class250 extends class398 {
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "()V", line = 407)
    public class250() {
        super(0, true);
    }

    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lnj;II)V", line = 20)
    ...
    @OriginalMember(owner = "client!tq", name = "f", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!tq", name = "c", descriptor = "(I)V", line = 173)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(BI)I", line = 187)
    ...
    @OriginalMember(owner = "client!tq", name = "c", descriptor = "(B)V", line = 202)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lnj;B)Ljava/lang/String;", line = 212)
    public static final String method1517(class228 arg0, byte arg1) {
        ++field3432;
        return arg1 <= 43 ? null : class156.method966(arg0, false, 32767);
    }

    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IIILps;)V", line = 227)
    ...
    @OriginalMember(owner = "client!tq", name = "g", descriptor = "(I)V", line = 251)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(II)[I", line = 265)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IIII)V", line = 367)
