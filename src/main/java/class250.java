...
public class class250 {
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(III)Z", line = 5)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(II)I", line = 18)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(Z)V", line = 31)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(ILjda;II)Lvfa;", line = 43)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(I)V", line = 129)
