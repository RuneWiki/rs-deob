...
public class class250 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Lkh;II)V", line = 34)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(B)Z", line = 136)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(B)Lbr;", line = 163)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Lkh;I)V", line = 227)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Z)Lbr;", line = 253)
