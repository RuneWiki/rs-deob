...
public class class250 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(II)Luh;", line = 20)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!he", name = "<init>", descriptor = "(Ljk;ILfs;)V", line = 69)
