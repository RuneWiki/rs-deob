...
public class class250 extends class419 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "([B[IIIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "([B[I[IIIIIIIIIIILua;II)V", line = 62)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "(Lcb;Lgda;[Lpga;[I[I)V", line = 153)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "([B[I[IIIIIII)V", line = 176)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "([B[IIIIIIIIIIILua;II)V", line = 236)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(CIIIZLua;II)V", line = 322)
    ...
    @OriginalMember(owner = "client!up", name = "OA", descriptor = "(CIIIZ)V", line = 389)
