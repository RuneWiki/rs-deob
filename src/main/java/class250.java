...
public abstract class class250 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Lvq;IILs;III[[[B[I[I[I[I[IIBIIZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(II)V", line = 162)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ZLlf;)V", line = 174)
