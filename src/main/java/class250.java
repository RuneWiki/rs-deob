...
public class class250 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ZLji;)V", line = 6)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IZ)I", line = 27)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 73)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(II)Ljava/lang/String;", line = 105)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(CB)Z", line = 130)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Z)V", line = 174)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ZI)Z", line = 197)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(BII)Z", line = 223)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(I)V", line = 235)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IILji;)V", line = 258)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IZIII)V", line = 311)
    ...
    @OriginalMember(owner = "client!cl", name = "c", descriptor = "(I)V", line = 601)
