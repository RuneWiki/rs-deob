...
public class class250 {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IB)V", line = 6)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!uv", name = "<init>", descriptor = "(Lbt;I)V", line = 41)
    public class250(class33 arg0, int arg1) {
        this.field3721 = OpenGL.glGenLists(arg1);
    }

    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(CB)V", line = 66)
