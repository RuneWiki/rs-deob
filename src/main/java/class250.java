...
public class class250 {
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IIZIILaa;IIIII[[[BI)V", line = 21)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(IIII)I", line = 66)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(ILjava/lang/String;)V", line = 87)
