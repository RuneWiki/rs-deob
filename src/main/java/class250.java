...
public class class250 extends class184 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "()V", line = 17)
    public class250() {
    }

    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "(S)V", line = 19)
