...
public class class250 extends class145 {
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(BLkea;)V", line = 4)
    ...
    @OriginalMember(owner = "client!gaa", name = "<init>", descriptor = "()V", line = 204)
    public class250() {
        super(1, false);
    }

    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(IILrt;)V", line = 18)
    ...
    @OriginalMember(owner = "client!gaa", name = "i", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ZI)[I", line = 68)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(BI)[[I", line = 121)
