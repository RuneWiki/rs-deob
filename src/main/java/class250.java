...
public class class250 {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(I)Lul;", line = 3)
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(II)V", line = 54)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(B)Z", line = 68)
    ...
    @OriginalMember(owner = "client!sc", name = "c", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!sc", name = "d", descriptor = "(I)Lul;", line = 93)
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(B)Lul;", line = 116)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Z)Lul;", line = 139)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Lul;B)V", line = 159)
    ...
    @OriginalMember(owner = "client!sc", name = "e", descriptor = "(I)I", line = 175)
    ...
    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "()V", line = 205)
    public class250() {
