...
public class class250 extends class477 {
    ...
    @OriginalMember(owner = "client!he", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 241)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(I[III)Z", line = 64)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(III)Z", line = 99)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IZI[I)Z", line = 122)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IIII[I)Z", line = 149)
    ...
    @OriginalMember(owner = "client!he", name = "d", descriptor = "(B)V", line = 184)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(I)V", line = 221)
