...
public class class250 extends class97 {
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(Lufa;Z)V")
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(ILfd;)V")
    ...
    @OriginalMember(owner = "client!jaa", name = "<init>", descriptor = "(Lufa;)V")
