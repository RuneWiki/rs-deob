...
public class class250 {
    ...
    @OriginalMember(owner = "client!hh", name = "toString", descriptor = "()Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IZ)V", line = 14)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(II)I", line = 59)
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(B)V", line = 74)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Lvo;Z)V", line = 87)
