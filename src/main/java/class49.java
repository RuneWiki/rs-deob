...
public class class49 extends class457 {
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(II)I", line = 6)
    public static final int method428(int arg0, int arg1) {
        ++field590;
        return arg1 != 872959912 ? 38 : arg0 >>> 8;
    }

    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(I)Z", line = 17)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(IIZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Lmk;II)V", line = 75)
    ...
    @OriginalMember(owner = "client!qh", name = "b", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(B)V", line = 99)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(IZ)V", line = 127)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(ZB)V", line = 161)
    ...
    @OriginalMember(owner = "client!qh", name = "e", descriptor = "(I)V", line = 173)
    ...
    @OriginalMember(owner = "client!qh", name = "f", descriptor = "(I)V", line = 188)
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "(Lef;Lmc;)V", line = 229)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 240)
