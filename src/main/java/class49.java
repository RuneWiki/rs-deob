...
public class class49 extends class406 {
    ...
    @OriginalMember(owner = "client!in", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IIIIZI)V", line = 22)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IIIIIIIZIILp;I)Z", line = 41)
    ...
    @OriginalMember(owner = "client!in", name = "b", descriptor = "(Z)V", line = 470)
    public static final void method283(boolean arg0) {
        class285.field4008 = class131.method811(8, 0.4F, -62, arg0, 4, 35, 2048, 8);
        field583++;
    }

    @OriginalMember(owner = "client!in", name = "b", descriptor = "(I)V", line = 480)
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "()V", line = 497)
    public class49() {
    }

    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 499)
