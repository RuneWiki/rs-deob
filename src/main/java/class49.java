...
public class class49 extends class220 {
    ...
    @OriginalMember(owner = "client!ip", name = "d", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(IBLil;)V", line = 19)
    ...
    @OriginalMember(owner = "client!ip", name = "b", descriptor = "(III)V", line = 32)
    ...
    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "()V", line = 106)
    public class49() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Lro;BI)I", line = 109)
    ...
    @OriginalMember(owner = "client!ip", name = "b", descriptor = "(II)[[I", line = 123)
    ...
    @OriginalMember(owner = "client!ip", name = "e", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!ip", name = "c", descriptor = "(II)[I", line = 180)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ZZ)V", line = 214)
