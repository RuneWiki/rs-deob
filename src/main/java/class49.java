...
public class class49 {
    ...
    @OriginalMember(owner = "client!OZAHPBMK", name = "c", descriptor = "[LOZAHPBMK;")
    public static class49[] field1285;

    @OriginalMember(owner = "client!OZAHPBMK", name = "a", descriptor = "(LVSUYIIVA;I)V")
    ...
    @OriginalMember(owner = "client!OZAHPBMK", name = "a", descriptor = "(IBLCFARFRSG;)V")
