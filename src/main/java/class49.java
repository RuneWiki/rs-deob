...
@OriginalClass("client!SCIASJXX")
public class class49 {

    @OriginalMember(owner = "client!SCIASJXX", name = "b", descriptor = "I")
    public int field1273;

    @OriginalMember(owner = "client!SCIASJXX", name = "d", descriptor = "I")
    public int field1275;

    @OriginalMember(owner = "client!SCIASJXX", name = "c", descriptor = "LYRWSITPW;")
    public class68 field1274;

    @OriginalMember(owner = "client!SCIASJXX", name = "e", descriptor = "[I")
    public int[] field1276;

    @OriginalMember(owner = "client!SCIASJXX", name = "f", descriptor = "[I")
    public int[] field1277;

    @OriginalMember(owner = "client!SCIASJXX", name = "g", descriptor = "[I")
    public int[] field1278;

    @OriginalMember(owner = "client!SCIASJXX", name = "h", descriptor = "[I")
    public int[] field1279;

    @OriginalMember(owner = "client!SCIASJXX", name = "a", descriptor = "[LSCIASJXX;")
    private static class49[] field1272;

    @OriginalMember(owner = "client!SCIASJXX", name = "i", descriptor = "[Z")
    private static boolean[] field1280;

    @OriginalMember(owner = "client!SCIASJXX", name = "a", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!SCIASJXX", name = "a", descriptor = "(Z[B)V")
    ...
    @OriginalMember(owner = "client!SCIASJXX", name = "b", descriptor = "(I)V")
    public static void method399(int arg0) {
        int var1 = 65 / arg0;
        field1272 = null;
    }

    @OriginalMember(owner = "client!SCIASJXX", name = "a", descriptor = "(BI)LSCIASJXX;")
    ...
    @OriginalMember(owner = "client!SCIASJXX", name = "a", descriptor = "(II)Z")
