...
public class class49 {
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(IIIZII)V", line = 21)
    ...
    @OriginalMember(owner = "client!gda", name = "b", descriptor = "(I)V", line = 118)
