...
public class class49 {
    ...
    @OriginalMember(owner = "client!QUHNUHWS", name = "b", descriptor = "LNFNHZJTP;")
    public class36 field1286 = new class36();

    @OriginalMember(owner = "client!QUHNUHWS", name = "c", descriptor = "LNFNHZJTP;")
    ...
    @OriginalMember(owner = "client!QUHNUHWS", name = "a", descriptor = "(LNFNHZJTP;)V")
    ...
    @OriginalMember(owner = "client!QUHNUHWS", name = "a", descriptor = "()LNFNHZJTP;")
    ...
    @OriginalMember(owner = "client!QUHNUHWS", name = "a", descriptor = "(I)LNFNHZJTP;")
