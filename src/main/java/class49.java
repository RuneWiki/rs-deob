...
public class class49 {
    ...
    @OriginalMember(owner = "client!QXFWPOFL", name = "c", descriptor = "[LQXFWPOFL;")
    public static class49[] field1296;

    @OriginalMember(owner = "client!QXFWPOFL", name = "a", descriptor = "(ILTXPLZUUI;)V")
    ...
    @OriginalMember(owner = "client!QXFWPOFL", name = "a", descriptor = "(LPKHWFJLM;Z)V")
