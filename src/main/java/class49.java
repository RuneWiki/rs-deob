...
public class class49 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Lqa;JI)V", line = 4)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(B)[Lgr;", line = 48)
