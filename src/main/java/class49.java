...
public class class49 {
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(Z)Lai;", line = 3)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IB)Lld;", line = 17)
    public final class49 method317(int arg0, byte arg1) {
        field644++;
        return arg1 > -8 ? null : new class49(this.field647, arg0);
    }

    @OriginalMember(owner = "client!ld", name = "b", descriptor = "(IB)V", line = 32)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(II)Z", line = 65)
    ...
    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "(II)V", line = 83)
