...
public class class49 {
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(IIILjava/awt/Canvas;)Lkq;")
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(Lvc;Ljava/lang/String;IZ)Lgca;")
    ...
    @OriginalMember(owner = "client!aea", name = "<init>", descriptor = "(Leea;J[Lbu;)V")
