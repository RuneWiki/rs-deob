...
public class class49 implements class334 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!gs", name = "c", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Z)V", line = 82)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(BJ)Z", line = 92)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IIB)Z", line = 103)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(B)I", line = 126)
    ...
    @OriginalMember(owner = "client!gs", name = "b", descriptor = "(B)V", line = 138)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(Lww;Lhq;)V", line = 152)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ZB)V", line = 173)
