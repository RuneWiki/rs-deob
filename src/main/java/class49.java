...
public class class49 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Lgs;Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IZI)V", line = 22)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(I)V", line = 60)
    public class49(int arg0) {
        this.field687 = arg0;
    }

    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(IIIIII)V", line = 67)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(I)Lgs;", line = 43)
