...
public class class49 extends class58 implements class171 {
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Lfu;I[BI)V", line = 4)
    public class49(class42 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field733 = arg1;
    }

    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lfm;)V", line = 8)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(I[BI)V", line = 11)
    public final void method467(int arg0, byte[] arg1, int arg2) {
        this.method525(arg1, arg2);
        this.field733 = arg0;
    }

    @OriginalMember(owner = "client!fj", name = "c", descriptor = "(Lfm;)V", line = 16)
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(Lfm;)V", line = 19)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Lfu;ILjava/nio/ByteBuffer;)V", line = 22)
    public class49(class42 arg0, int arg1, ByteBuffer arg2) {
        super(arg0, arg2);
        this.field733 = arg1;
    }

    @OriginalMember(owner = "client!fj", name = "a", descriptor = "()I", line = 26)
    public final int method464() {
        return 0;
    }

    @OriginalMember(owner = "client!fj", name = "d", descriptor = "(Lfm;)V", line = 30)
