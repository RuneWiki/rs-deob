...
public class class49 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(Lec;)V", line = 55)
