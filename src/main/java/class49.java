...
@OriginalClass("client!TEBIXSCV")
public class class49 extends class38 {

    @OriginalMember(owner = "client!TEBIXSCV", name = "pb", descriptor = "LZDMOUFDZ;")
    public class68 field1441;

    @OriginalMember(owner = "client!TEBIXSCV", name = "a", descriptor = "(B)LCCYECDYX;")
    ...
    @OriginalMember(owner = "client!TEBIXSCV", name = "c", descriptor = "(Z)LCCYECDYX;")
    ...
    @OriginalMember(owner = "client!TEBIXSCV", name = "a", descriptor = "(Z)Z")
