...
public class class49 extends class5 {
    ...
    @OriginalMember(owner = "client!SJUCHLXH", name = "Cb", descriptor = "LWMYPWVZI;")
    ...
    @OriginalMember(owner = "client!SJUCHLXH", name = "Db", descriptor = "LWHKCNEXD;")
    public class60 field1296;

    @OriginalMember(owner = "client!SJUCHLXH", name = "Qb", descriptor = "LYABPKWWG;")
    public class67 field1309;

    @OriginalMember(owner = "client!SJUCHLXH", name = "Jb", descriptor = "Ljava/lang/String;")
    public String field1302;

    @OriginalMember(owner = "client!SJUCHLXH", name = "a", descriptor = "(ILIMUIZRAF;)V")
    ...
    @OriginalMember(owner = "client!SJUCHLXH", name = "a", descriptor = "(B)LYABPKWWG;")
    ...
    @OriginalMember(owner = "client!SJUCHLXH", name = "a", descriptor = "(Z)LYABPKWWG;")
    ...
    @OriginalMember(owner = "client!SJUCHLXH", name = "c", descriptor = "(I)LYABPKWWG;")
