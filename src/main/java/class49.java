...
public class class49 extends class580 {
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Lnd;I)I", line = 6)
    ...
    @OriginalMember(owner = "client!vg", name = "T", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Ljava/lang/Object;BLjava/awt/Canvas;)V", line = 47)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Lkda;I)V", line = 58)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(BLcl;)V", line = 82)
    ...
    @OriginalMember(owner = "client!vg", name = "V", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!vg", name = "j", descriptor = "(I)V", line = 116)
    public final void method289(int arg0) {
        int var2 = -48 / ((arg0 + 38) / 58);
        this.field720.method2559(27, this.field8060);
    }

    @OriginalMember(owner = "client!vg", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/ca;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Ldk;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Le;Lpj;I)V", line = 123)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(ZI)Ljn;", line = 173)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(BLjava/lang/Object;Ljava/awt/Canvas;)V", line = 184)
    ...
    @OriginalMember(owner = "client!vg", name = "n", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!vg", name = "p", descriptor = "(B)V", line = 214)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IIBLuj;)V", line = 225)
    ...
    @OriginalMember(owner = "client!vg", name = "d", descriptor = "(ZI)V", line = 240)
    public final void method295(boolean arg0, int arg1) {
        int var3 = -65 / ((arg1 - 42) / 62);
        this.field720.method2559(161, arg0);
    }

    @OriginalMember(owner = "client!vg", name = "t", descriptor = "()V", line = 247)
    public final void method296() {
    }

    @OriginalMember(owner = "client!vg", name = "i", descriptor = "()Z", line = 251)
    public final boolean method297() {
        return false;
    }

    @OriginalMember(owner = "client!vg", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Le;Lpj;Ljava/lang/Integer;)Loa;", line = 262)
    ...
    @OriginalMember(owner = "client!vg", name = "r", descriptor = "(I)V", line = 359)
    ...
    @OriginalMember(owner = "client!vg", name = "e", descriptor = "(I)V", line = 371)
    public final synchronized void method299(int arg0) {
        this.field726.method3436(false);
        super.method299(arg0);
    }

    @OriginalMember(owner = "client!vg", name = "K", descriptor = "(I)V", line = 379)
    ...
    @OriginalMember(owner = "client!vg", name = "v", descriptor = "(I)V", line = 393)
    ...
    @OriginalMember(owner = "client!vg", name = "h", descriptor = "(I)V", line = 429)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Lkf;IILps;I)Lhr;", line = 440)
    ...
    @OriginalMember(owner = "client!vg", name = "g", descriptor = "(B)V", line = 452)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IZI[BLkf;ZII)Lhr;", line = 463)
    ...
    @OriginalMember(owner = "client!vg", name = "D", descriptor = "()V", line = 473)
    public final void method306() {
        this.field726.method3437((byte) -86);
        super.method306();
    }

    @OriginalMember(owner = "client!vg", name = "a", descriptor = "([Llf;B)Lfl;", line = 481)
    public final class677 method307(class215[] arg0, byte arg1) {
        return arg1 < 105 ? (class677) null : new dxVertexLayout(this, arg0);
    }

    @OriginalMember(owner = "client!vg", name = "o", descriptor = "()Z", line = 491)
    public final boolean method308() {
        return false;
    }

    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(ILsf;)V", line = 498)
    ...
    @OriginalMember(owner = "client!vg", name = "D", descriptor = "(I)V", line = 541)
    public final void method310(int arg0) {
        this.field720.Clear(1, arg0, 0.0F, 0);
    }

    @OriginalMember(owner = "client!vg", name = "a", descriptor = "([IIZIIII)Lhr;", line = 548)
    ...
    @OriginalMember(owner = "client!vg", name = "db", descriptor = "(I)Z", line = 559)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Liq;II)V", line = 600)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Lqaa;B)I", line = 611)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(BLps;Lkf;)Z", line = 627)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(ZLiv;ZIZ)V", line = 651)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Lka;Lka;FLka;)Lka;", line = 690)
    public final class434 method317(class434 arg0, class434 arg1, float arg2, class434 arg3) {
        return (arg2 < 0.5F) ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IIIILjn;Luj;I)V", line = 698)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 718)
    public final void method319(Rectangle[] arg0, int arg1) throws class211 {
        this.method365();
    }

    @OriginalMember(owner = "client!vg", name = "i", descriptor = "(I)V", line = 726)
    ...
    @OriginalMember(owner = "client!vg", name = "s", descriptor = "(I)V", line = 752)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(FFF)V", line = 762)
    public final void method322(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(ILuj;)I", line = 765)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(I[[IZI)Ljs;", line = 798)
    ...
    @OriginalMember(owner = "client!vg", name = "h", descriptor = "()V", line = 810)
    ...
    @OriginalMember(owner = "client!vg", name = "cb", descriptor = "(I)V", line = 834)
    public final void method326(int arg0) {
        int var2 = -44 % ((arg0 - 47) / 60);
        this.field720.method2559(7, this.field7976);
    }

    @OriginalMember(owner = "client!vg", name = "A", descriptor = "()V", line = 841)
    public final void method327() {
    }

    @OriginalMember(owner = "client!vg", name = "b", descriptor = "(B)V", line = 845)
    ...
    @OriginalMember(owner = "client!vg", name = "b", descriptor = "(ILkh;)I", line = 855)
    ...
    @OriginalMember(owner = "client!vg", name = "y", descriptor = "(I)F", line = 885)
    ...
    @OriginalMember(owner = "client!vg", name = "e", descriptor = "(B)V", line = 895)
    ...
    @OriginalMember(owner = "client!vg", name = "C", descriptor = "(I)V", line = 935)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IB)V", line = 946)
    ...
    @OriginalMember(owner = "client!vg", name = "k", descriptor = "(I)V", line = 958)
    ...
    @OriginalMember(owner = "client!vg", name = "Y", descriptor = "(I)V", line = 981)
    ...
    @OriginalMember(owner = "client!vg", name = "z", descriptor = "(I)V", line = 995)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(BZ)Liq;", line = 1031)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Liv;I)I", line = 1041)
    ...
    @OriginalMember(owner = "client!vg", name = "l", descriptor = "(Z)V", line = 1067)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "()Lfea;", line = 1098)
    ...
    @OriginalMember(owner = "client!vg", name = "N", descriptor = "(I)V", line = 1108)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IIII)V", line = 1118)
    public final void method342(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(II[BILkf;I)Lk;", line = 1122)
    ...
    @OriginalMember(owner = "client!vg", name = "C", descriptor = "()V", line = 1130)
    public final void method344() {
        this.method3250(true, false);
        this.field720.Clear(2, 0, 1.0F, 0);
    }

    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Lkf;BLps;)Z", line = 1143)
    ...
    @OriginalMember(owner = "client!vg", name = "l", descriptor = "(B)V", line = 1157)
    ...
    @OriginalMember(owner = "client!vg", name = "Z", descriptor = "(I)V", line = 1194)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(BLfl;)V", line = 1228)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IIILjagdx/IDirect3D;Ljagdx/D3DPRESENT_PARAMETERS;B)Z", line = 1242)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Ljava/awt/Canvas;I)Ljava/lang/Object;", line = 1348)
    public final Object method350(Canvas arg0, int arg1) {
        int var3 = 89 % ((9 - arg1) / 48);
        return null;
    }

    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(ZZILiv;)V", line = 1356)
    ...
    @OriginalMember(owner = "client!vg", name = "c", descriptor = "(Z)V", line = 1403)
    public final void method352(boolean arg0) {
    }

    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Ljava/awt/Canvas;ILjava/lang/Object;)V", line = 1407)
    ...
    @OriginalMember(owner = "client!vg", name = "S", descriptor = "(I)V", line = 1433)
    ...
    @OriginalMember(owner = "client!vg", name = "A", descriptor = "(I)V", line = 1443)
    ...
    @OriginalMember(owner = "client!vg", name = "SA", descriptor = "()I", line = 1461)
    public final int method356() {
        return 0;
    }

    @OriginalMember(owner = "client!vg", name = "o", descriptor = "(I)V", line = 1468)
    ...
    @OriginalMember(owner = "client!vg", name = "f", descriptor = "()V", line = 1479)
    public final void method358() {
    }

    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Lps;ZLkf;)I", line = 1482)
    ...
    @OriginalMember(owner = "client!vg", name = "KA", descriptor = "(IIII)[I", line = 1521)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IZLkf;IIII[F)Lhr;", line = 1559)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(ILeh;)V", line = 1569)
    ...
    @OriginalMember(owner = "client!vg", name = "f", descriptor = "(II)Ltf;", line = 1592)
    ...
    @OriginalMember(owner = "client!vg", name = "n", descriptor = "(B)V", line = 1626)
    ...
    @OriginalMember(owner = "client!vg", name = "y", descriptor = "()V", line = 1638)
