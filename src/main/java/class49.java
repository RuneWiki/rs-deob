...
public abstract class class49 extends class435 {
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;ZIZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "()V", line = 123)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(Ln;[[BI)V", line = 225)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(I)V", line = 259)
