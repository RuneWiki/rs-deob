...
public class class49 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(IIBI)Lmc;", line = 6)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(IIIZ)V", line = 119)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(B)I", line = 134)
    ...
    @OriginalMember(owner = "client!ip", name = "b", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(III)V", line = 167)
    ...
    @OriginalMember(owner = "client!ip", name = "c", descriptor = "(I)V", line = 179)
