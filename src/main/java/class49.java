...
public class class49 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Lgj;II)Lgs;")
    ...
    @OriginalMember(owner = "client!gs", name = "c", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Lgj;I)Lgs;")
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "([B)[Lgs;")
