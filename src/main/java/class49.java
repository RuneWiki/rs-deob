...
public class class49 extends class337 {
    ...
    @OriginalMember(owner = "client!sh", name = "e", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!sh", name = "f", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Lvg;I)Lvg;", line = 38)
    ...
    @OriginalMember(owner = "client!sh", name = "g", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "([BILrt;[I)Z", line = 927)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "()V", line = 990)
    public class49() {
    }

    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "([B)V", line = 992)
