...
public class class49 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lha;IIILme;II)Lka;")
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lha;Lme;IIIZLs;IILs;IIB)Lka;")
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IIIILs;Ls;IBLme;ZLha;ZII)Lka;")
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(ILji;)V")
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(ILji;I)V")
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(ILme;IIBILha;)Lka;")
