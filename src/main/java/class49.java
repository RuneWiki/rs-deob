...
public class class49 {
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "([Lvp;BZIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!gda", name = "finalize", descriptor = "()V", line = 63)
    ...
    @OriginalMember(owner = "client!gda", name = "<init>", descriptor = "(Lte;J[Lwe;)V", line = 77)
