...
public class class49 implements class178 {
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Ljava/lang/Object;Ljava/lang/Class;Ljava/lang/String;I)I", line = 47)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Ljava/lang/Class;ILjava/lang/String;)Ljava/lang/Object;", line = 60)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(B)I", line = 78)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(BJ)Z", line = 90)
    ...
    @OriginalMember(owner = "client!wba", name = "d", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!wba", name = "c", descriptor = "(I)I", line = 113)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(BI)I", line = 125)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!wba", name = "b", descriptor = "(I)V", line = 153)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Ljava/lang/Object;ZLjava/lang/Class;Ljava/lang/String;)Z", line = 164)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(III)Z", line = 177)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(ZI)V", line = 190)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(II)I", line = 378)
    ...
    @OriginalMember(owner = "client!wba", name = "e", descriptor = "(I)V", line = 401)
