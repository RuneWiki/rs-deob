...
public class class49 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ILi;ZI)V")
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IILi;B)V")
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(IILi;B)Z")
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(Lpg;Lmr;)V")
