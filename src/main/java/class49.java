...
public class class49 extends class195 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IIIIIILka;Lha;IILao;III)Lka;", line = 4)
    ...
    @OriginalMember(owner = "client!gp", name = "d", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!gp", name = "e", descriptor = "(I)I", line = 184)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(II)I", line = 218)
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(Lwh;IIII)V", line = 415)
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(Lwh;IIII[BI)V", line = 440)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(I)V", line = 236)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(IIBIIIII)V", line = 254)
    ...
    @OriginalMember(owner = "client!gp", name = "b", descriptor = "(II)V", line = 267)
