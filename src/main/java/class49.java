...
public class class49 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(II)[I", line = 16)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(III)I", line = 320)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "()V", line = 345)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Leb;)V", line = 385)
