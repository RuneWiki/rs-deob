...
public class class49 {
    ...
    @OriginalMember(owner = "client!eh", name = "k", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!eh", name = "u", descriptor = "Lhb;")
    private class71 field1015;

    @OriginalMember(owner = "client!eh", name = "w", descriptor = "Lhb;")
    private class71 field1017;

    @OriginalMember(owner = "client!eh", name = "o", descriptor = "Lke;")
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(I)Lhb;")
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "([Lhb;I)I")
    ...
    @OriginalMember(owner = "client!eh", name = "c", descriptor = "(I)Lhb;")
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(JB)Lhb;")
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(B)Lhb;")
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(JZLhb;)V")
