...
@OriginalClass("client!STTRNURD")
public class class49 {

    @OriginalMember(owner = "client!STTRNURD", name = "b", descriptor = "I")
    private int field1297;

    @OriginalMember(owner = "client!STTRNURD", name = "c", descriptor = "[LZSZDCWXM;")
    private class72[] field1298;

    @OriginalMember(owner = "client!STTRNURD", name = "a", descriptor = "I")
    private int field1296;

    @OriginalMember(owner = "client!STTRNURD", name = "<init>", descriptor = "(ZI)V")
    ...
    @OriginalMember(owner = "client!STTRNURD", name = "a", descriptor = "(J)LZSZDCWXM;")
    ...
    @OriginalMember(owner = "client!STTRNURD", name = "a", descriptor = "(JLZSZDCWXM;I)V")
