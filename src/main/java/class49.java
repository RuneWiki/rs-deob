...
public class class49 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Z)Lea;")
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(BLje;)V")
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ZLje;)V")
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(BLcga;)V")
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(BLhk;)V")
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(ILfl;)V")
