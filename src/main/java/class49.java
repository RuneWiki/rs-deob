...
public class class49 extends class124 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(B)J", line = 4)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(II)I", line = 15)
    ...
    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "()V", line = 102)
    public class49() {
        this.field566 = System.nanoTime();
        this.field565 = System.nanoTime();
    }

    @OriginalMember(owner = "client!tn", name = "c", descriptor = "(I)J", line = 70)
