...
public class class49 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Lnd;II)Lgp;")
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "()Lct;")
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(Lsl;)V")
