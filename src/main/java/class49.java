...
public class class49 extends class223 {
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(BLrs;)I")
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(ZLrs;Z)V")
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(BLfd;ILjava/lang/String;)Lwl;")
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Loj;I[B[I)Z")
