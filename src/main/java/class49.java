...
public class class49 {
    ...
    @OriginalMember(owner = "client!sca", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field732++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(III)V", line = 15)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(II)Loja;", line = 29)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(IZILaj;III)V", line = 112)
    ...
    @OriginalMember(owner = "client!sca", name = "<init>", descriptor = "(I)V", line = 140)
