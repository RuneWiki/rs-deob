...
public class class49 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Lnk;II)V", line = 8)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(I)V", line = 130)
    public static void method306(int arg0) {
        field679 = null;
        int var1 = -63 % ((-arg0 - 64) / 51);
    }

    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Lvh;II)Lgv;", line = 139)
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(B)V", line = 159)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "([BIII)Ljava/lang/String;", line = 171)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(II[BI)V", line = 212)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(Lht;Lac;Ljt;IIIII)V", line = 263)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "([BB)[B", line = 236)
