...
public class class49 {
    ...
    @OriginalMember(owner = "client!RRCEOPDB", name = "b", descriptor = "[LRRCEOPDB;")
    public static class49[] field1311;

    @OriginalMember(owner = "client!RRCEOPDB", name = "a", descriptor = "(ILRVLWVPJQ;)V")
    ...
    @OriginalMember(owner = "client!RRCEOPDB", name = "a", descriptor = "(LUAWAYCTK;II)V")
