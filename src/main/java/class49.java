...
public abstract class class49 extends class385 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "()I", line = 8)
    public final int method382() {
        return this.field810 + this.field791 + this.field801;
    }

    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IIIIIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(FFFFFFIII)V", line = 72)
    ...
    @OriginalMember(owner = "client!jb", name = "d", descriptor = "()I", line = 154)
    public final int method388() {
        return this.field810;
    }

    @OriginalMember(owner = "client!jb", name = "b", descriptor = "()I", line = 164)
    public final int method389() {
        return this.field808 + this.field802 + this.field815;
    }

    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(FFFFFF)V", line = 168)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(FFFFFFLvb;II)V", line = 308)
    ...
    @OriginalMember(owner = "client!jb", name = "b", descriptor = "(IIII)V", line = 324)
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Lfu;II)V", line = 335)
    ...
    @OriginalMember(owner = "client!jb", name = "c", descriptor = "()I", line = 347)
