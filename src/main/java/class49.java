...
public class class49 extends class290 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Ljava/lang/Runnable;)Lbv;")
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(ILl;)V")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Lld;IIII)Le;")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "([Le;Lc;[Lwp;I)V")
    ...
    @OriginalMember(owner = "client!wc", name = "ra", descriptor = "(ILta;II)V")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IIIIZ)Lo;")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "([Le;Lsj;Lc;[Lwp;I)V")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Lud;)V")
    public final void method311(class27 arg0) {
    }

    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Ldd;Z)Lo;")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Lul;[Ldd;Z)Lla;")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(II[[I[[IIII)Lya;")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Lrl;III)V")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IIIIIILta;II)V")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(II[I[I)Lta;")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "([IIIII)Lo;")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Lud;Lud;FLud;)Lud;")
    public final class27 method351(class27 arg0, class27 arg1, float arg2, class27 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(I[Lls;)V")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Ln;)V")
    ...
    @OriginalMember(owner = "client!wc", name = "w", descriptor = "()Lc;")
    public final class125 method358() {
        return new class457();
    }

    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Lsj;)V")
    ...
    @OriginalMember(owner = "client!wc", name = "SA", descriptor = "(Lc;)V")
    public final void method367(class125 arg0) {
        this.field572 = (class457) arg0;
    }

    @OriginalMember(owner = "client!wc", name = "h", descriptor = "()Lc;")
    ...
    @OriginalMember(owner = "client!wc", name = "h", descriptor = "(I)Ln;")
    public final class15 method379(int arg0) {
        return null;
    }

    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IIIIIF)Lls;")
    ...
    @OriginalMember(owner = "client!wc", name = "c", descriptor = "(IIIIII)Lud;")
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(ILjava/awt/Canvas;Ll;)V")
