...
public class class49 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Lbi;IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(II)Lgq;", line = 89)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(B)V", line = 123)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IIB)V", line = 135)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(III)I", line = 166)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Z)V", line = 208)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(Lrb;ILpc;Lpc;)V", line = 247)
