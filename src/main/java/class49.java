...
public class class49 extends class321 {
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(BLgk;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(F[BIIFLbt;FFFIIIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(IIIIIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!pba", name = "e", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(ILjava/lang/String;B)Ljava/lang/String;", line = 134)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(IIIIZI)V", line = 156)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(IIZ)I", line = 241)
    ...
    @OriginalMember(owner = "client!pba", name = "a", descriptor = "(Lgk;I)V", line = 265)
