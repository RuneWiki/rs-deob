...
public class class49 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(BZ)V", line = 13)
    public static final synchronized void method260(byte arg0, boolean arg1) {
        field408 = arg1;
        int var2 = -9 / ((arg0 - 58) / 55);
    }

    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(ILo;)V", line = 23)
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(B)V", line = 67)
