...
public class class49 {
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(Lgda;I)V", line = 46)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(III)I", line = 65)
    ...
    @OriginalMember(owner = "client!gda", name = "<init>", descriptor = "(I)V", line = 116)
    public class49(int arg0) {
        this.field574 = arg0;
    }

    @OriginalMember(owner = "client!gda", name = "<init>", descriptor = "(IIIIII)V", line = 123)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(B)Lgda;", line = 99)
