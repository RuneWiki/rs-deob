...
public class class49 {
    ...
    @OriginalMember(owner = "client!TMVRZUVH", name = "n", descriptor = "I")
    ...
    @OriginalMember(owner = "client!TMVRZUVH", name = "a", descriptor = "(LGHHPHSRU;I)V")
    ...
    @OriginalMember(owner = "client!TMVRZUVH", name = "a", descriptor = "(LGHHPHSRU;B)V")
