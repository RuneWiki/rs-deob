...
public class class49 {
    ...
    @OriginalMember(owner = "client!RXQASTJV", name = "b", descriptor = "[LDJXGSHIT;")
    ...
    @OriginalMember(owner = "client!RXQASTJV", name = "a", descriptor = "(J)LDJXGSHIT;")
    ...
    @OriginalMember(owner = "client!RXQASTJV", name = "a", descriptor = "(ILDJXGSHIT;J)V")
