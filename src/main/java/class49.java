...
public class class49 extends class404 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ILug;)V")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(B)Lf;")
    ...
    @OriginalMember(owner = "client!wc", name = "c", descriptor = "(III)Lau;")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Lga;Lya;I)V")
    ...
    @OriginalMember(owner = "client!wc", name = "f", descriptor = "(I)[Lud;")
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(ILht;Lht;Ldn;Lsu;IIZ)V")
