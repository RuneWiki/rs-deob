...
public class class49 {
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "()I", line = 3)
    public final int method381() {
        return this.field678 - 1;
    }

    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(Lha;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(Lha;Ljava/lang/String;[IIIIZ)V", line = 97)
    ...
    @OriginalMember(owner = "client!hia", name = "b", descriptor = "()V", line = 118)
    public static void method384() {
        field685 = null;
    }

    @OriginalMember(owner = "client!hia", name = "<init>", descriptor = "(Lha;IZLjava/awt/Component;)V", line = 168)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(Lha;Ljava/lang/String;IIIZ)V", line = 128)
    ...
    @OriginalMember(owner = "client!hia", name = "c", descriptor = "()I", line = 145)
    public final int method386() {
        return this.field682;
    }

    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(Ljava/lang/String;)I", line = 153)
