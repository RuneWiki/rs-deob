...
public class class49 implements Runnable {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IB)Z", line = 40)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(II[BI)I", line = 98)
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(Ljava/io/InputStream;I)V", line = 149)
    ...
    @OriginalMember(owner = "client!ak", name = "run", descriptor = "()V", line = 167)
