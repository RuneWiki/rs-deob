...
public class class49 extends class431 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(III)I", line = 3)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IIB)V", line = 24)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!wc", name = "b", descriptor = "(B)V", line = 126)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Lpd;IIIIIIIIII)Z", line = 136)
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "()V", line = 487)
    public class49() {
    }

    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(BI)I", line = 490)
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(S)V", line = 499)
