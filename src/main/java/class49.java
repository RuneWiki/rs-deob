...
public class class49 extends class80 {
    ...
    @OriginalMember(owner = "client!wc", name = "b", descriptor = "(II)[I", line = 5)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IIIIIIIII)V", line = 250)
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "()V", line = 272)
    public class49() {
        super(2, false);
    }

    @OriginalMember(owner = "client!wc", name = "c", descriptor = "(II)[[I", line = 278)
    ...
    @OriginalMember(owner = "client!wc", name = "d", descriptor = "(I)V", line = 597)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IILnn;)V", line = 611)
