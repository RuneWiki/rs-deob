...
public class class323 extends class43 {
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(IIIIBII)V", line = 10)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "([[ZZIII)V", line = 183)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(IS)V", line = 240)
    ...
    @OriginalMember(owner = "client!te", name = "<init>", descriptor = "(Lh;Lef;Lsi;[I)V", line = 255)
