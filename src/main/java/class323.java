...
public abstract class class323 {
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "(IIIII)V", line = 391)
    ...
    @OriginalMember(owner = "client!bp", name = "b", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(IIII)V", line = 89)
    ...
    @OriginalMember(owner = "client!bp", name = "c", descriptor = "(I)V", line = 271)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(IIIIII)V", line = 284)
