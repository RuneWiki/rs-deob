...
public class class323 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(JZ)Lwf;", line = 22)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Lwf;JI)V", line = 74)
    ...
    @OriginalMember(owner = "client!vq", name = "<init>", descriptor = "(I)V", line = 129)
