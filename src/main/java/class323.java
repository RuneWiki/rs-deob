...
public abstract class class323 extends class309 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lct;Lct;Lct;I)V", line = 12)
    ...
    @OriginalMember(owner = "client!cl", name = "e", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(IIIZZ)V", line = 102)
    ...
    @OriginalMember(owner = "client!cl", name = "f", descriptor = "(B)V", line = 50)
