...
public class class323 extends class603 implements class396 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(Lgf;Lvt;Z)V")
    ...
    @OriginalMember(owner = "client!es", name = "c", descriptor = "(I)Lvt;")
