...
public class class323 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(I)Laq;", line = 31)
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "()V", line = 142)
    public class323() {
        this.field4349.field9869 = this.field4349;
        this.field4349.field9865 = this.field4349;
    }

    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Ltc;IIII)V", line = 62)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(BLaq;)V", line = 102)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(Z)Laq;", line = 123)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!gv", name = "c", descriptor = "(I)I", line = 169)
