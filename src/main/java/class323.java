...
public abstract class class323 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(III)V", line = 44)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(I)V", line = 186)
    ...
    @OriginalMember(owner = "client!md", name = "c", descriptor = "(I)V", line = 198)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ZLlf;)Lcd;", line = 252)
