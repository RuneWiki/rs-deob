...
public class class323 extends class445 implements class447 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 4)
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "(Lkd;IZ[[I)V", line = 27)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(IIIIIILua;Lps;J)V", line = 63)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(I)V", line = 116)
