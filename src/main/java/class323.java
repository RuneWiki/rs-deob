...
public class class323 extends class329 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IIIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(II)V", line = 18)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Lpl;I)I", line = 30)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(II)V", line = 100)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IIBFI)V", line = 111)
    ...
    @OriginalMember(owner = "client!bl", name = "c", descriptor = "(II)Z", line = 234)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(BI)V", line = 251)
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(Ldaa;IIIII)V", line = 452)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "([III)V", line = 280)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(I)V", line = 439)
