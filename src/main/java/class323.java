...
public class class323 extends class512 {
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!ha", name = "<init>", descriptor = "()V", line = 16)
    public class323() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IB)[I", line = 19)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 57)
