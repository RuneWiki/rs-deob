...
public class class323 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ef", name = "b", descriptor = "(I)V", line = 243)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ILqq;Ltq;)V", line = 256)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IIZII)V", line = 275)
