...
public class class323 extends class15 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(II)Ldl;", line = 5)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lvt;II)V", line = 34)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(BII)I", line = 97)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IBLjava/lang/String;)Ljava/lang/String;", line = 117)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IIIIIIIIII)V", line = 147)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(BLvt;)V", line = 188)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(BII)V", line = 214)
