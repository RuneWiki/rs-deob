...
public class class323 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Lvv;I)I")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Lmb;Z)V")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(B)Lcca;")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Lol;B)V")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(BLrg;)V")
