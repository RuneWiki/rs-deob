...
public class class323 extends class467 implements class278 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lkm;IBZ)Llt;")
    ...
    @OriginalMember(owner = "client!bq", name = "d", descriptor = "(Lkm;I)Lto;")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lkm;I)V")
    ...
    @OriginalMember(owner = "client!bq", name = "c", descriptor = "(Lkm;I)V")
    public final void method197(class487 arg0, int arg1) {
        ++field4445;
        int var3 = -41 / ((64 - arg1) / 59);
    }

    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lkm;II)Lab;")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(BILkm;)Lab;")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(ILkm;IZILkj;B)V")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Llk;I)V")
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(Lkm;Lcj;IIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lkm;BII)Z")
    ...
    @OriginalMember(owner = "client!bq", name = "b", descriptor = "(Lkm;I)V")
