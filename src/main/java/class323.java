...
public class class323 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Laa;ZI[BZI[Lie;III)[I", line = 27)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(I[Lrg;IIZI)V", line = 468)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(ILql;)I", line = 520)
