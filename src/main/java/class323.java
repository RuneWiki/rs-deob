...
public class class323 extends class682 {
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!fp", name = "c", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "(Lnv;Lpr;)V", line = 302)
    ...
    @OriginalMember(owner = "client!fp", name = "d", descriptor = "(I)Z", line = 56)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(IBI)V", line = 154)
    ...
    @OriginalMember(owner = "client!fp", name = "e", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Ltha;II)V", line = 194)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Z)Z", line = 212)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(BLig;)V", line = 224)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(BZ)V", line = 272)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(IZ)V", line = 325)
