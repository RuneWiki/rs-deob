...
public class class323 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(III)Lhg;", line = 4)
    ...
    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IIIIIIIIII)V", line = 61)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IC)C", line = 147)
    ...
    @OriginalMember(owner = "client!kp", name = "c", descriptor = "(I)V", line = 540)
