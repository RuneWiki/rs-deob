...
public class class323 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(ILrq;ILrq;)Lbl;")
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IZLrq;Lrq;I)Lbl;")
    ...
    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "(Lpp;Lro;)V")
