...
public class class323 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(ZI)Z", line = 9)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(ILem;IB)V", line = 46)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IIZ)V", line = 134)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(II)[[[B", line = 187)
