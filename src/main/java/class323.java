...
public class class323 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(B)Lgs;", line = 10)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(II)I", line = 21)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(BLjava/lang/String;[Ljava/lang/String;[Lkb;[I)I", line = 32)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 272)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Ljava/lang/String;BI[Lkb;)I", line = 286)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(I)V", line = 301)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(II[Lkb;ILjava/lang/String;)I", line = 313)
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(I)V", line = 334)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IBC)I", line = 358)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Ljava/lang/String;B[Lkb;I)I", line = 376)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;I)V", line = 404)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(III)I", line = 438)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "([Lkb;ILjava/lang/String;)I", line = 464)
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(II)I", line = 571)
    public static int method2059(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 578)
    public final int method2060(String arg0, byte arg1) {
        field4392++;
        return arg1 <= 29 ? -96 : this.method2058((class80[]) null, -63, arg0);
    }

    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "([B)V", line = 597)
