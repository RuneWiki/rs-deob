...
public class class323 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IB)Lmp;", line = 33)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IILjava/io/File;[B)V", line = 72)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(III)I", line = 96)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(B)Z", line = 137)
    ...
    @OriginalMember(owner = "client!rb", name = "b", descriptor = "(B)V", line = 168)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lec;I)V", line = 186)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lri;B)Lrb;", line = 275)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(ILun;)V", line = 306)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(ZLri;)Z", line = 327)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(ZILun;)V", line = 368)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lcf;Lr;IIIILri;Lwt;Z)Lda;", line = 865)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(BILjava/lang/String;)Ljava/lang/String;", line = 1021)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IIILr;Lwt;IZIIILcf;Ljr;Lwt;I[Lgw;[ILri;)Lda;", line = 1053)
