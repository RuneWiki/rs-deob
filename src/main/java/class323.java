...
public class class323 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IBI)I", line = 24)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IIIBI)V", line = 49)
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Lfda;)V", line = 69)
