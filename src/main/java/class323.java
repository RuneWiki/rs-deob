...
public class class323 extends class439 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!bg", name = "c", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(III)Z", line = 123)
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 145)
