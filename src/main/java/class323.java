...
public class class323 extends class144 {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(I)J", line = 41)
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(B)J", line = 51)
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "()V", line = 103)
    public class323() {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(B)V", line = 88)
