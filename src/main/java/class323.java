...
public class class323 extends class398 {
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Lnj;II)V")
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Llm;ILlm;Lrh;Llm;)Z")
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Lfh;Ljava/awt/Canvas;II)Lii;")
