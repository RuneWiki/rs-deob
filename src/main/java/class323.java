...
public abstract class class323 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(ILek;)Lnda;", line = 14)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IILis;Lf;ILua;II)V", line = 30)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Z)V", line = 77)
    ...
    @OriginalMember(owner = "client!mk", name = "b", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(IIIII)V", line = 349)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IIILga;)V", line = 141)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(IIIZ)V", line = 163)
