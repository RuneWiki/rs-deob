...
public class class323 extends class70 implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    @OriginalMember(owner = "client!fda", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 5)
    ...
    @OriginalMember(owner = "client!fda", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 19)
    ...
    @OriginalMember(owner = "client!fda", name = "d", descriptor = "(B)Z", line = 43)
    ...
    @OriginalMember(owner = "client!fda", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 55)
    ...
    @OriginalMember(owner = "client!fda", name = "e", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!fda", name = "c", descriptor = "(I)Z", line = 102)
    ...
    @OriginalMember(owner = "client!fda", name = "c", descriptor = "(B)I", line = 113)
    ...
    @OriginalMember(owner = "client!fda", name = "e", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(I)Lhfa;", line = 134)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(IBIII)V", line = 145)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(Ljava/awt/Component;B)V", line = 161)
    ...
    @OriginalMember(owner = "client!fda", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 175)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method1932(-11571, arg0.getX(), arg0.getY());
    }

    @OriginalMember(owner = "client!fda", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 183)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        this.method1932(-11571, arg0.getX(), arg0.getY());
    }

    @OriginalMember(owner = "client!fda", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 190)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.method1932(-11571, arg0.getX(), arg0.getY());
    }

    @OriginalMember(owner = "client!fda", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 198)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method1932(-11571, arg0.getX(), arg0.getY());
    }

    @OriginalMember(owner = "client!fda", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 206)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;I)I", line = 216)
    ...
    @OriginalMember(owner = "client!fda", name = "f", descriptor = "(I)V", line = 241)
    ...
    @OriginalMember(owner = "client!fda", name = "d", descriptor = "(I)I", line = 263)
    ...
    @OriginalMember(owner = "client!fda", name = "b", descriptor = "(III)V", line = 274)
    ...
    @OriginalMember(owner = "client!fda", name = "b", descriptor = "(B)Z", line = 291)
    public final boolean method520(byte arg0) {
        int var2 = -116 / ((72 - arg0) / 35);
        return (this.field4333 & 0x1) != 0;
    }

    @OriginalMember(owner = "client!fda", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 310)
