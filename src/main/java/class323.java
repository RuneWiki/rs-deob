...
public class class323 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(Lee;Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IZI)I", line = 42)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IILee;)V", line = 60)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(ILjava/lang/String;C)[Ljava/lang/String;", line = 97)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(B)V", line = 131)
