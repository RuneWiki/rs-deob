...
public class class323 extends class30 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(II[Lne;)V")
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Ljg;II)V")
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(II)Lrd;")
