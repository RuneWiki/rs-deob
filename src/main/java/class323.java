...
public class class323 implements Runnable {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(Lhw;Lha;ZZLda;Ljava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(BLjava/lang/String;)Ljw;")
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(Lsja;B)V")
