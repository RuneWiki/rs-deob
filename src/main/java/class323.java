...
public class class323 {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IZI)V", line = 12)
    ...
    @OriginalMember(owner = "client!fc", name = "b", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!fc", name = "c", descriptor = "(I)V", line = 324)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IIIILqa;IB)V", line = 335)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lhca;ZI)V", line = 354)
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "()V", line = 507)
    protected class323() {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IIIII)V", line = 519)
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(Lqa;Lps;I)V", line = 536)
