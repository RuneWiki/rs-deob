...
public abstract class class323 {
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(BI)Lqa;")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ILrg;)Lag;")
    ...
    @OriginalMember(owner = "client!dn", name = "d", descriptor = "(II)Lhl;")
