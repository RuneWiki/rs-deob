...
public class class323 {
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(ZII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(B)V", line = 44)
