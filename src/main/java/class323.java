...
public class class323 implements class437 {
    ...
    @OriginalMember(owner = "client!nha", name = "b", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(B)Lad;", line = 19)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(IIIBI)Z", line = 35)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(IIIIII)V", line = 67)
    ...
    @OriginalMember(owner = "client!nha", name = "<init>", descriptor = "(ILsd;Lec;IIIIIIIZ)V", line = 99)
