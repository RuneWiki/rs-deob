...
public class class323 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(BI[BI)[B", line = 5)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(II)Lqw;", line = 51)
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Lim;ILgj;)V", line = 94)
