...
public class class323 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Lre;)V", line = 23)
    ...
    @OriginalMember(owner = "client!sr", name = "b", descriptor = "(Lre;)V", line = 40)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "()V", line = 47)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "()V", line = 56)
    public class323() {
        this.field4849[0] = 0;
