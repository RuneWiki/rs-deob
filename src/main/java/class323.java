...
public class class323 extends class403 {
    ...
    @OriginalMember(owner = "client!sg", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!sg", name = "c", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(ILya;)V", line = 29)
    public static final void method1913(int arg0, class11 arg1) {
        class492.field7122[arg0] = arg1;
    }

    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(FBLgi;Lgi;)Z", line = 42)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(B)Lgi;", line = 240)
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(Lpg;I)V", line = 253)
