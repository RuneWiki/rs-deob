...
public class class323 extends class276 implements class265 {
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "(Len;Lnl;IIIIIIZI)V")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Len;B)V")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(ILen;)Lir;")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(BLen;)V")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(BILen;)Lmj;")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Len;I)V")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(ILen;IBLfs;IZ)V")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IIZLen;)Z")
