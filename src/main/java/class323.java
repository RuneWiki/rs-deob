...
public class class323 extends class264 {
    ...
    @OriginalMember(owner = "client!ce", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(BI)I", line = 17)
    ...
    @OriginalMember(owner = "client!ce", name = "b", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!ce", name = "c", descriptor = "(B)I", line = 40)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(B)I", line = 55)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(ZLrv;)Ltu;", line = 67)
    ...
    @OriginalMember(owner = "client!ce", name = "<init>", descriptor = "(ILmfa;)V", line = 84)
    public class323(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ce", name = "<init>", descriptor = "(Lmfa;)V", line = 87)
    public class323(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ce", name = "b", descriptor = "(BI)V", line = 90)
