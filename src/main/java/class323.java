...
public class class323 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(BLne;)Z")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Ljd;IIIII)V")
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(Lnc;III)V")
