...
public class class323 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Z)V", line = 45)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 79)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(ILro;Lnr;)V", line = 137)
