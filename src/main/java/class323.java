...
public class class323 extends class42 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ILqa;)V", line = 12)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(II)[B", line = 33)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I[[[BIBII)V", line = 94)
    ...
    @OriginalMember(owner = "client!bg", name = "d", descriptor = "(I)Ljr;", line = 232)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(II[[ZBI)V", line = 263)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(SI)V", line = 318)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(III)V", line = 337)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IIIIIII)V", line = 359)
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(Lbo;Lui;Lor;[I)V", line = 527)
