...
public class class323 extends class460 {
    ...
    @OriginalMember(owner = "client!sv", name = "c", descriptor = "()V", line = 10)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "()V", line = 29)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 35)
    ...
    @OriginalMember(owner = "client!sv", name = "b", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!sv", name = "d", descriptor = "()I", line = 72)
    public final int method913() {
        return this.field4904 - (this.field4906.available() >> (class162.field2453 ? 2 : 1));
    }

    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 80)
    ...
    @OriginalMember(owner = "client!sv", name = "b", descriptor = "()V", line = 120)
