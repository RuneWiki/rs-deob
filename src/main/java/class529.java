...
public class class529 {
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 18)
    ...
    @OriginalMember(owner = "client!im", name = "b", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Lec;IB)V", line = 45)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(IIB)I", line = 115)
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Z)V", line = 138)
