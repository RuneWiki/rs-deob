...
public class class529 extends class337 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Lkf;B)V", line = 30)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!ms", name = "b", descriptor = "(II)V", line = 91)
    ...
    @OriginalMember(owner = "client!ms", name = "b", descriptor = "(IZ)V", line = 126)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IZ)V", line = 155)
    ...
    @OriginalMember(owner = "client!ms", name = "b", descriptor = "(Lkf;I)V", line = 179)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(ZFBLna;I)V", line = 209)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(ZI)V", line = 234)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IJ)V", line = 283)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Lkf;I)V", line = 301)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(ZLau;)V", line = 341)
