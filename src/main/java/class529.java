...
public class class529 extends OutputStream {
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(ILwca;)V", line = 3)
    ...
    @OriginalMember(owner = "client!aaa", name = "write", descriptor = "(I)V", line = 22)
    public final void write(int arg0) throws IOException {
        field7897++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(I)V", line = 43)
