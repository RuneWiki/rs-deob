...
public class class529 extends class286 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(II)V", line = 7)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(III)Luj;", line = 21)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IIIIII)V", line = 38)
