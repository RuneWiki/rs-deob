...
public class class529 extends class164 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Llb;I)V")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(II[[I[[IIII)Lsa;")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "([Lr;Lm;[Lgr;I)V")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lbt;IIII)Lr;")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Ljava/lang/Runnable;)Lrs;")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "([Lr;Loaa;Lm;[Lgr;I)V")
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ln;)V")
