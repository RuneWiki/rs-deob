...
public class class529 extends class156 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILad;)V")
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(IB)Lnm;")
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(Ljaggl/OpenGL;Ljava/awt/Canvas;JLd;Lwia;I)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lbja;Lvea;I)Z")
    ...
    @OriginalMember(owner = "client!ko", name = "d", descriptor = "(II)Lts;")
    public final class560 method532(int arg0, int arg1) {
        ++field7584;
        return null;
    }

    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ZZBLip;I)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IBLhl;)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lkfa;Lts;)Lpt;")
    public final class555 method443(class627 arg0, class560 arg1) {
        ++field7594;
        return null;
    }

    @OriginalMember(owner = "client!ko", name = "A", descriptor = "()Lcq;")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(I[Lwk;)Lkq;")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIIBI[BZLvea;)Loga;")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ZILcfa;I)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(BLkq;)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ZLha;)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILdk;IIILcfa;B)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(BZ)Lhl;")
    ...
    @OriginalMember(owner = "client!ko", name = "d", descriptor = "(IZ)Ldk;")
    ...
    @OriginalMember(owner = "client!ko", name = "bb", descriptor = "(I)Lbea;")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IILvea;ZI[FZI)Loga;")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ZII[[I)Lks;")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lip;ZII)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(I[IIIIBZ)Loga;")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lvea;[BIZII)Lgga;")
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(II)Lkfa;")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lpt;)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lqaa;Lqaa;FLqaa;)Lqaa;")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Lvea;Lbja;III)Loga;")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILvea;Lbja;)Z")
