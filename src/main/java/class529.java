...
public class class529 extends class31 implements class269 {
    ...
    @OriginalMember(owner = "client!sk", name = "f", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!sk", name = "c", descriptor = "(ILqa;)Loj;", line = 464)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ZLoe;ILqa;III)V", line = 490)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(Z)I", line = 514)
    public final int method337(boolean arg0) {
        ++field7428;
        return !arg0 ? -86 : 22;
    }

    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(ILqa;)Lso;", line = 526)
    ...
    @OriginalMember(owner = "client!sk", name = "<init>", descriptor = "(Lqa;Lcn;IIIIZIZ)V", line = 542)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(B)I", line = 576)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(JBLqa;)V", line = 587)
    ...
    @OriginalMember(owner = "client!sk", name = "g", descriptor = "(B)V", line = 620)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(BLqa;ZI)Ljc;", line = 632)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(Lqa;Z)V", line = 662)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ILqa;II)Z", line = 691)
    ...
    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(I)Z", line = 723)
    ...
    @OriginalMember(owner = "client!sk", name = "e", descriptor = "(I)V", line = 733)
    ...
    @OriginalMember(owner = "client!sk", name = "c", descriptor = "(B)V", line = 770)
    ...
    @OriginalMember(owner = "client!sk", name = "h", descriptor = "(B)I", line = 788)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(I)I", line = 803)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ZLqa;)V", line = 815)
    ...
    @OriginalMember(owner = "client!sk", name = "i", descriptor = "(B)V", line = 845)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ILqa;)V", line = 874)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(ILqa;Z)Lr;", line = 885)
    ...
    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(B)V", line = 896)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(II)I", line = 911)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IILqa;)Lr;", line = 922)
    ...
    @OriginalMember(owner = "client!sk", name = "d", descriptor = "(I)Z", line = 942)
