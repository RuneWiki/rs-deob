...
public class class529 extends class303 {
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(BLag;)I", line = 4)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(II)Low;", line = 34)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(I)I", line = 56)
    ...
    @OriginalMember(owner = "client!iba", name = "c", descriptor = "(B)[B", line = 77)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "([BIII)Ljava/lang/String;", line = 98)
    ...
    @OriginalMember(owner = "client!iba", name = "i", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "([BB)[B", line = 150)
