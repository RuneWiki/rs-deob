...
public class class529 extends class254 {
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(B[Lpc;Lpea;)Log;")
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "(Lpea;IIII[BI)V")
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "(Lpea;IIII)V")
