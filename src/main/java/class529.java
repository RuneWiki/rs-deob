...
public class class529 extends class35 implements class90 {
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(Lom;Llw;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(Lom;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(Lom;Llw;Lal;II)V")
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(Lom;Llw;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "([FLlw;IIIIZII)V")
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(ILlw;IIIIII[B)V")
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Lfu;BLfu;)V")
