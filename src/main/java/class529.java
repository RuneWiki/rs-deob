...
public class class529 extends class55 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!lh", name = "d", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIZ)V", line = 81)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ZB)V", line = 123)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IILfe;)V", line = 137)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Z)V", line = 146)
    ...
    @OriginalMember(owner = "client!lh", name = "f", descriptor = "(I)Z", line = 158)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(I)V", line = 168)
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(Lul;Lnd;Ltn;)V", line = 186)
    ...
    @OriginalMember(owner = "client!lh", name = "e", descriptor = "(I)V", line = 204)
