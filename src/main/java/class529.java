...
public class class529 extends class578 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(III)Z", line = 15)
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "()V", line = 26)
    public class529() {
    }

    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "(I)V", line = 28)
