...
public class class529 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "()V", line = 4)
    public void method2399() throws Exception {
        field7397++;
    }

    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ILua;B)V", line = 134)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(BLvj;)Leia;", line = 156)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Z)V", line = 192)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(BLua;)V", line = 202)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "([II)V", line = 214)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(I)V", line = 373)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 418)
    public void method2400(Component arg0) throws Exception {
        field7393++;
    }

    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ZI)V", line = 428)
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "()V", line = 449)
    public void method2398() {
        field7400++;
    }

    @OriginalMember(owner = "client!hh", name = "c", descriptor = "()I", line = 465)
    public int method2403() throws Exception {
        field7386++;
        return this.field7405;
    }

    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(Z)V", line = 474)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IZ)V", line = 489)
    ...
    @OriginalMember(owner = "client!hh", name = "d", descriptor = "()V", line = 565)
    public void method2401() throws Exception {
        field7389++;
    }

    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(I)V", line = 572)
    public void method2402(int arg0) throws Exception {
        field7392++;
    }

    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(B)V", line = 587)
