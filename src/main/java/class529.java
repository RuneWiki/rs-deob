...
public class class529 implements IEnumModesCallback {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(B)[I", line = 4)
    ...
    @OriginalMember(owner = "client!fd", name = "callbackEnumModes", descriptor = "(Lcom/ms/directX/DDSurfaceDesc;Lcom/ms/com/IUnknown;)V", line = 21)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Ljava/awt/Frame;B)V", line = 37)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Ljava/awt/Frame;IIIII)V", line = 49)
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "()V", line = 67)
    public class529() {
