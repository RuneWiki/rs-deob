...
public class class529 extends class145 {
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(III)B", line = 8)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IILrt;)V", line = 30)
    ...
    @OriginalMember(owner = "client!lj", name = "i", descriptor = "(I)V", line = 60)
    public static void method3104(int arg0) {
        field7653 = null;
        int var1 = -127 / ((30 - arg0) / 63);
    }

    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(II)V", line = 69)
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(I)V", line = 82)
    private class529(int arg0) {
        super(0, false);
        this.method3105(0, arg0);
    }

    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(I[FIIIIIFIFI)V", line = 93)
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "()V", line = 153)
    public class529() {
        this(0);
    }

    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(BI)[[I", line = 156)
