...
public class class529 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lha;I)Lhh;")
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(BLdt;)V")
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(Lha;I)Lhh;")
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ILdt;B)V")
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(ILha;)Lhh;")
    ...
    @OriginalMember(owner = "client!ve", name = "c", descriptor = "(Lha;I)Lhh;")
