...
public class class529 extends class305 {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(ZBI)Les;", line = 6)
    ...
    @OriginalMember(owner = "client!fd", name = "e", descriptor = "(II)Z", line = 20)
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "(II)V", line = 30)
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "(Lhb;)V", line = 41)
    public class529(class728 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fd", name = "b", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!fd", name = "c", descriptor = "(I)I", line = 57)
    ...
    @OriginalMember(owner = "client!fd", name = "d", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "(ILhb;)V", line = 83)
    public class529(int arg0, class728 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!fd", name = "c", descriptor = "(II)I", line = 90)
    ...
    @OriginalMember(owner = "client!fd", name = "b", descriptor = "(B)V", line = 101)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(B)I", line = 122)
