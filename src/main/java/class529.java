...
public abstract class class529 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!gu", name = "start", descriptor = "()V", line = 35)
    ...
    @OriginalMember(owner = "client!gu", name = "stop", descriptor = "()V", line = 47)
    ...
    @OriginalMember(owner = "client!gu", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 59)
    public final void windowActivated(WindowEvent arg0) {
        field7560++;
    }

    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(I)Ljava/lang/String;", line = 121)
    ...
    @OriginalMember(owner = "client!gu", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 134)
    public final void focusLost(FocusEvent arg0) {
        field7563++;
        class535.field7644 = false;
    }

    @OriginalMember(owner = "client!gu", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 144)
    public final void windowOpened(WindowEvent arg0) {
        field7556++;
    }

    @OriginalMember(owner = "client!gu", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 151)
    public final void windowDeiconified(WindowEvent arg0) {
        field7544++;
    }

    @OriginalMember(owner = "client!gu", name = "d", descriptor = "(B)Z", line = 159)
    public final boolean method3012(byte arg0) {
        field7559++;
        return arg0 == -107 ? class527.method2998("jaclib", (byte) 14) : true;
    }

    @OriginalMember(owner = "client!gu", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 170)
    public final void windowDeactivated(WindowEvent arg0) {
        field7542++;
    }

    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ZZ)V", line = 178)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ILjava/lang/String;)V", line = 259)
    ...
    @OriginalMember(owner = "client!gu", name = "e", descriptor = "(B)V", line = 285)
    ...
    @OriginalMember(owner = "client!gu", name = "provideLoaderApplet", descriptor = "(Ljava/applet/Applet;)V", line = 297)
    public static final void provideLoaderApplet(Applet arg0) {
        class485.field7068 = arg0;
        field7573++;
    }

    @OriginalMember(owner = "client!gu", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 305)
    public final void windowClosed(WindowEvent arg0) {
        field7554++;
    }

    @OriginalMember(owner = "client!gu", name = "destroy", descriptor = "()V", line = 312)
    ...
    @OriginalMember(owner = "client!gu", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 326)
    public final void windowIconified(WindowEvent arg0) {
        field7547++;
    }

    @OriginalMember(owner = "client!gu", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 333)
    public final void update(Graphics arg0) {
        field7571++;
        this.paint(arg0);
    }

    @OriginalMember(owner = "client!gu", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 342)
    ...
    @OriginalMember(owner = "client!gu", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 366)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ILpi;IB)V", line = 381)
    ...
    @OriginalMember(owner = "client!gu", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 432)
    ...
    @OriginalMember(owner = "client!gu", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 451)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IIZIIILjava/lang/String;I)V", line = 466)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IIIIIILjava/lang/String;)V", line = 513)
    ...
    @OriginalMember(owner = "client!gu", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 559)
    ...
    @OriginalMember(owner = "client!gu", name = "d", descriptor = "(I)V", line = 571)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ZII)Z", line = 615)
    ...
    @OriginalMember(owner = "client!gu", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 641)
    ...
    @OriginalMember(owner = "client!gu", name = "run", descriptor = "()V", line = 661)
    ...
    @OriginalMember(owner = "client!gu", name = "g", descriptor = "(B)Z", line = 787)
    ...
    @OriginalMember(owner = "client!gu", name = "f", descriptor = "(I)Z", line = 832)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IIZ)V", line = 843)
    ...
    @OriginalMember(owner = "client!gu", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 860)
