...
public class class529 extends class202 {
    ...
    @OriginalMember(owner = "client!f", name = "g", descriptor = "(I)Ljava/lang/Object;", line = 5)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(B)Z", line = 15)
    public final boolean method1041(byte arg0) {
        return arg0 < -106;
    }

    @OriginalMember(owner = "client!f", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 25)
