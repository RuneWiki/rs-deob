...
public class class529 extends class130 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(I)Lwea;")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ZILpl;)Lul;")
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(Lct;Lrc;IIIIIIIIIIIII)V")
