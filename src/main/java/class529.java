...
public class class529 extends class269 {
    ...
    @OriginalMember(owner = "client!fl", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Z)V", line = 41)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IBI)V", line = 52)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(BIB)V", line = 102)
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "(IIIIIFFF)V", line = 115)
