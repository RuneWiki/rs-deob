...
public class class730 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Z)Lfga;", line = 5)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(III)Z", line = 34)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "([SIZ)[S", line = 60)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IIII)Lcm;", line = 75)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(IIIIB)V", line = 90)
