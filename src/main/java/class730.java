...
public abstract class class730 extends class379 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IIB)V", line = 87)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(II)Z", line = 105)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IIIIIIIIII)V", line = 119)
