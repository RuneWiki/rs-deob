...
public class class730 {
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!sha", name = "b", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(IB)Lor;", line = 54)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(III)V", line = 87)
    ...
    @OriginalMember(owner = "client!sha", name = "<init>", descriptor = "(Lqg;ILvd;Lvd;)V", line = 139)
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(ZI)V", line = 103)
