...
public class class730 extends class706 {
    ...
    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(Lin;Lti;IIIIIIIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(I)Lsaa;", line = 28)
    public final class345 method1656(int arg0) {
        field10112++;
        return arg0 == 0 ? class759.field10480 : null;
    }

    @OriginalMember(owner = "client!no", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(BI)I", line = 55)
