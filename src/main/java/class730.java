...
public class class730 extends class529 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IB)[I", line = 4)
    ...
    @OriginalMember(owner = "client!ak", name = "c", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IBLtn;)V", line = 114)
    ...
    @OriginalMember(owner = "client!ak", name = "g", descriptor = "(I)V", line = 157)
    ...
    @OriginalMember(owner = "client!ak", name = "c", descriptor = "(III)Z", line = 168)
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "()V", line = 186)
    public class730() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIILjava/lang/Class;)Lrq;", line = 191)
    ...
    @OriginalMember(owner = "client!ak", name = "d", descriptor = "(III)V", line = 216)
