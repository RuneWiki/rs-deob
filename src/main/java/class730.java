...
public class class730 implements class234 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;", line = 38)
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "(I)I", line = 59)
    public final int method1491(int arg0) {
        int var2 = 66 % ((arg0 + 42) / 46);
        return this.field10225;
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(I)Lti;", line = 68)
    public final class438 method1598(int arg0) {
        int var2 = -56 % ((70 - arg0) / 40);
        return this.field10227;
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Z)V", line = 76)
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(Llt;Lti;Z)V", line = 121)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(I)Z", line = 100)
