...
public class class730 extends class264 {
    ...
    @OriginalMember(owner = "client!waa", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "(Lmfa;)V", line = 15)
    public class730(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(BI)I", line = 18)
    ...
    @OriginalMember(owner = "client!waa", name = "c", descriptor = "(B)I", line = 30)
    public final int method4094(byte arg0) {
        ++field10203;
        return arg0 > -31 ? -49 : super.field3733;
    }

    @OriginalMember(owner = "client!waa", name = "b", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!waa", name = "b", descriptor = "(BI)V", line = 58)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(B)I", line = 77)
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "(ILmfa;)V", line = 91)
