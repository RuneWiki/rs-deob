...
public class class730 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "([BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(Lml;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(Lml;Ljaclib/memory/Buffer;)V", line = 21)
