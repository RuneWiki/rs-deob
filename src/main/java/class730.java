...
public class class730 extends class61 {
    ...
    @OriginalMember(owner = "client!bo", name = "<init>", descriptor = "(Lac;Lmv;[Ltw;Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(CIIIZLaa;II)V", line = 243)
    ...
    @OriginalMember(owner = "client!bo", name = "fa", descriptor = "(CIIIZ)V", line = 290)
