...
public class class730 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(II)V", line = 41)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Ljava/io/File;ILjava/lang/String;)V", line = 64)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(BI)Lsda;", line = 80)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(II)V", line = 111)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IIIII)V", line = 135)
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(Lsj;ILin;Lin;)V", line = 195)
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "(I)V", line = 176)
