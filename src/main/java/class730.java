...
public class class730 {
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(IBILr;)Z", line = 5)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Z[[ZIIII)V", line = 78)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(II)V", line = 277)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(IILr;I)V", line = 332)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(IC)I", line = 400)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Lr;IBI)V", line = 419)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(B)V", line = 494)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(IIIII)V", line = 510)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(I)V", line = 552)
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "(Lkd;Lim;)V", line = 590)
