...
public class class225 implements class512 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "([Lvs;II)V", line = 26)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(II)V", line = 113)
