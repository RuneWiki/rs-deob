...
public class class225 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Loa;IIIIII)V")
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(I)Lfda;")
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(Loa;Leh;I)V")
