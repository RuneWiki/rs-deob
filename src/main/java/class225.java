...
public class class225 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(FIIIZIIII)[[I", line = 6)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Lga;ILmg;)V", line = 60)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(CI)C", line = 76)
