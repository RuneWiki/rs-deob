...
public class class225 extends class631 {
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(B)Lib;", line = 3)
    ...
    @OriginalMember(owner = "client!dt", name = "b", descriptor = "(I)[Lib;", line = 15)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(IIZLwp;)V", line = 26)
    ...
    @OriginalMember(owner = "client!dt", name = "<init>", descriptor = "(Ldba;Lpa;IIIIIIIIIIIIII)V", line = 102)
