...
public class class225 extends class83 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "([[II)V", line = 3)
    ...
    @OriginalMember(owner = "client!rb", name = "e", descriptor = "(B)I", line = 14)
    ...
    @OriginalMember(owner = "client!rb", name = "f", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(I[Lts;B)V", line = 44)
    ...
    @OriginalMember(owner = "client!rb", name = "g", descriptor = "(B)Lqp;", line = 132)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(I)[B", line = 163)
