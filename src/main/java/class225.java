...
public class class225 extends class485 {
    ...
    @OriginalMember(owner = "client!cs", name = "d", descriptor = "(I)J", line = 5)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(II)I", line = 38)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!cs", name = "c", descriptor = "(I)J", line = 100)
