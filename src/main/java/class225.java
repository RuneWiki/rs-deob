...
public class class225 {
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "([ILsp;[II[I)V")
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(ILdea;)V")
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(I)Ldea;")
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(Ljava/awt/Component;ZI)Lsi;")
