...
public class class225 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(B)Lut;")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I)Lut;")
    ...
    @OriginalMember(owner = "client!cs", name = "d", descriptor = "(I)Lut;")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ILut;)V")
