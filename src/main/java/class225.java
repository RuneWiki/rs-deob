...
public class class225 extends class497 {
    ...
    @OriginalMember(owner = "client!ska", name = "a", descriptor = "(IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!ska", name = "a", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!ska", name = "<init>", descriptor = "(Lpp;)V", line = 29)
    public class225(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ska", name = "<init>", descriptor = "(ILpp;)V", line = 34)
    public class225(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ska", name = "b", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!ska", name = "c", descriptor = "(I)I", line = 47)
    ...
    @OriginalMember(owner = "client!ska", name = "a", descriptor = "(BI)I", line = 63)
    ...
    @OriginalMember(owner = "client!ska", name = "a", descriptor = "(IIIB)I", line = 74)
    ...
    @OriginalMember(owner = "client!ska", name = "a", descriptor = "(ZC)Z", line = 100)
    ...
    @OriginalMember(owner = "client!ska", name = "a", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!ska", name = "a", descriptor = "(II)V", line = 137)
