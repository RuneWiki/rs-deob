...
public class class225 extends class200 {
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Z)Lvda;")
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Lvda;FILvda;)Z")
    ...
    @OriginalMember(owner = "client!mda", name = "<init>", descriptor = "(Lad;I)V")
