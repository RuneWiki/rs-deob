...
public class class225 extends class499 {
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(IIIIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(I)Z", line = 40)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(III)V", line = 61)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(B)V", line = 94)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IBI)V", line = 571)
