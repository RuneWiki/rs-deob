...
public class class225 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(Lgr;Z)V")
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(Ldg;III)V")
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(ILbj;IZLbj;)I")
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(Ldg;II)V")
