...
public class class225 extends class367 {
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(IIZLkt;III[F)Ljs;")
    ...
    @OriginalMember(owner = "client!bea", name = "b", descriptor = "(BZ)Lug;")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(Lef;B)I")
    ...
    @OriginalMember(owner = "client!bea", name = "o", descriptor = "()Leca;")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(ILoq;)I")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(Ljagdx/IDirect3DVertexShader;Z)V")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(Lqp;)V")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(Lqc;I)I")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(Loq;IBI)V")
    ...
    @OriginalMember(owner = "client!bea", name = "e", descriptor = "(II)Lci;")
    ...
    @OriginalMember(owner = "client!bea", name = "c", descriptor = "(ZI)Ltea;")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(Lkq;ZLkt;)Z")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(ZLil;)I")
    ...
    @OriginalMember(owner = "client!bea", name = "c", descriptor = "(IB)Lew;")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(ILnd;)I")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(Ldi;Ldi;FLdi;)Ldi;")
    public final class128 method378(class128 arg0, class128 arg1, float arg2, class128 arg3) {
        return arg2 < 0.5F ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(Lcm;B)V")
    ...
    @OriginalMember(owner = "client!bea", name = "b", descriptor = "(ILkt;Lkq;)I")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(Loq;IIILug;II)V")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(ILjagdx/IDirect3DPixelShader;)V")
    ...
    @OriginalMember(owner = "client!bea", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/jaa;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Loj;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Ld;Lni;I)V")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(IILkt;BLkq;)Ljs;")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(II)Lku;")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(ZLoha;)V")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(Lbt;I)V")
    ...
    @OriginalMember(owner = "client!bea", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Ld;Lni;Ljava/lang/Integer;)Lha;")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(ILkt;Lkq;)Z")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "([Ldia;I)Lqa;")
    public final class251 method1316(class235[] arg0, int arg1) {
        return arg1 == 6 ? new dxVertexLayout(this, arg0) : (class251) null;
    }

    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(IB[IZIII)Ljs;")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "([BZLkt;IIZII)Ljs;")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(ZLvs;)V")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(IZ[[II)Ltd;")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(IZLtea;)V")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(Lci;Lku;)Lqp;")
    public final class657 method443(class451 arg0, class379 arg1) {
        return null;
    }

    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(IILjagdx/IDirect3D;ILjagdx/D3DPRESENT_PARAMETERS;I)Z")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(IZBLef;Z)V")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(ILkt;[BIII)Lff;")
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(IZBLef;)V")
