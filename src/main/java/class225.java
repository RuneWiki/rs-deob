...
public class class225 extends class370 implements class232 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!cs", name = "c", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lti;I)Lqp;")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIILqa;)Z")
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IILqa;IZLha;I)V")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IILqa;Z)Lrl;")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(BILqa;)Lc;")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lhh;Z)V")
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lqa;Lbo;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IILqa;)Lc;")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ILqa;)Lbw;")
