...
public class class225 extends class45 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ILkba;[IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "()V", line = 102)
    public class225() {
    }

    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 104)
