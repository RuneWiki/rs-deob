...
public class class225 extends class456 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(ZI)V", line = 9)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(ZLjava/lang/Object;B)[B", line = 49)
    ...
    @OriginalMember(owner = "client!pr", name = "h", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IBLre;)V", line = 107)
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "()V", line = 232)
    public class225() {
        super(1, false);
    }

    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(II)[[I", line = 154)
    ...
    @OriginalMember(owner = "client!pr", name = "c", descriptor = "(II)Lcj;", line = 242)
