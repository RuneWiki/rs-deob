...
public class class225 extends class226 implements class171 {
    ...
    @OriginalMember(owner = "client!j", name = "c", descriptor = "(Luo;B)Lkj;")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Luo;B)V")
    ...
    @OriginalMember(owner = "client!j", name = "b", descriptor = "(Luo;B)V")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Luo;IIZ)Z")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(BLuo;)V")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IB)Lvq;")
    ...
    @OriginalMember(owner = "client!j", name = "f", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Luo;ILwo;Lwo;)V")
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Luo;Lnd;IIIIIIIZI)V")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Luo;IIIZBLpc;)V")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Luo;II)Lge;")
