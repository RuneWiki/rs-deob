...
public class class225 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lha;I)V", line = 45)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ZLjava/lang/String;ILjava/lang/String;)V", line = 70)
