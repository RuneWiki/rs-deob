...
public class class225 extends class210 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(II)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IILat;)V", line = 46)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(BII)V", line = 63)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IB)[I", line = 137)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IIIIILrc;Lfp;I[[BI[ZLsf;[[B[[B)V", line = 171)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(ILjava/lang/String;)V", line = 637)
    ...
    @OriginalMember(owner = "client!hf", name = "g", descriptor = "(I)V", line = 648)
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "()V", line = 658)
    public class225() {
        super(1, false);
    }

    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(IB)Lqm;", line = 665)
