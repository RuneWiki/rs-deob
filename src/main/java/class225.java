...
public class class225 extends class457 {
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(IILoa;I)Z")
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(ZLoa;)V")
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(ILoa;)Lwc;")
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(IILgfa;IIZLoa;)V")
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(BILoa;)Z")
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(ILei;)V")
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(Loa;B)Lac;")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
