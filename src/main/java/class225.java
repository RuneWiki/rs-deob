...
public class class225 extends class189 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(B)Z", line = 32)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(ZI)V", line = 42)
    ...
    @OriginalMember(owner = "client!on", name = "b", descriptor = "(ZI)V", line = 53)
    ...
    @OriginalMember(owner = "client!on", name = "<init>", descriptor = "(Lih;)V", line = 92)
    ...
    @OriginalMember(owner = "client!on", name = "b", descriptor = "(B)V", line = 136)
    ...
    @OriginalMember(owner = "client!on", name = "c", descriptor = "(Z)V", line = 154)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lsv;IB)V", line = 165)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(BII)V", line = 181)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lhm;III)V", line = 191)
