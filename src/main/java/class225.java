...
public class class225 implements class362 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(I)Lac;", line = 54)
