...
public class class225 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!hf", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 3)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(ZIIIFIIII)[[I", line = 32)
    ...
    @OriginalMember(owner = "client!hf", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 64)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Lrg;III)V", line = 86)
    ...
    @OriginalMember(owner = "client!hf", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 110)
    public final void focusGained(FocusEvent arg0) {
        field3026++;
    }

    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Z)V", line = 118)
    ...
    @OriginalMember(owner = "client!hf", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 136)
    ...
    @OriginalMember(owner = "client!hf", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 169)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(B)V", line = 225)
