...
public class class225 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(I)V", line = 131)
