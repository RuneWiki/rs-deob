...
public class class225 extends class621 implements class585 {
    ...
    @OriginalMember(owner = "client!in", name = "c", descriptor = "(I)Lbc;")
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(Lqj;ILjaclib/memory/Buffer;)V")
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(B[BLlm;I)Lml;")
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(Lqj;I[BI)V")
