...
public class class225 extends class585 {
    ...
    @OriginalMember(owner = "client!cea", name = "e", descriptor = "(B)Lru;", line = 5)
    ...
    @OriginalMember(owner = "client!cea", name = "<init>", descriptor = "()V", line = 18)
    public class225() {
        super(1, false);
    }

    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(IIILmi;II)V", line = 22)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Lso;II)V", line = 60)
    ...
    @OriginalMember(owner = "client!cea", name = "f", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(ZI)[[I", line = 105)
    ...
    @OriginalMember(owner = "client!cea", name = "b", descriptor = "(ZI)V", line = 199)
