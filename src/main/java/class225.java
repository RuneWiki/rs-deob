...
public class class225 extends class272 {
    ...
    @OriginalMember(owner = "client!ds", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(BLdp;)V", line = 14)
    ...
    @OriginalMember(owner = "client!ds", name = "d", descriptor = "(I)V", line = 27)
