...
public class class225 implements class454 {
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!sba", name = "b", descriptor = "(I)Lbja;", line = 36)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(I)I", line = 47)
    ...
    @OriginalMember(owner = "client!sba", name = "<init>", descriptor = "(Lcb;Ljava/lang/String;)V", line = 61)
