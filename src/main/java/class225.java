...
public abstract class class225 extends class287 {
    ...
    @OriginalMember(owner = "client!nb", name = "f", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!nb", name = "e", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!nb", name = "g", descriptor = "(I)Lgk;", line = 65)
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "(Ljo;I)V", line = 80)
