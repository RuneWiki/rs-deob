...
public class class225 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(CILjava/lang/String;)I", line = 3)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lwm;B)V", line = 34)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IIBII[B)V", line = 44)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IBLmc;I)V", line = 123)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(ILmc;I)V", line = 173)
