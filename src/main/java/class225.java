...
public class class225 extends class269 implements class416 {
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(CIIIZLi;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(Lc;Lk;Lgg;[Lho;[Laa;)V", line = 8)
    ...
    @OriginalMember(owner = "client!b", name = "finalize", descriptor = "()V", line = 36)
