...
public class class225 extends class276 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Lvg;IIB)V", line = 5)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(III)V", line = 19)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(CIZI)V", line = 33)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(II)Z", line = 55)
    ...
    @OriginalMember(owner = "client!er", name = "c", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!er", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 98)
    public final synchronized void keyReleased(KeyEvent arg0) {
        field3122++;
        this.method1481(arg0, 1, (byte) 76);
    }

    @OriginalMember(owner = "client!er", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 110)
    public final synchronized void keyPressed(KeyEvent arg0) {
        this.method1481(arg0, 0, (byte) 116);
        field3123++;
    }

    @OriginalMember(owner = "client!er", name = "c", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(ZZ)Z", line = 132)
    public static boolean method1477(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!er", name = "b", descriptor = "(B)Lmb;", line = 140)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(B)V", line = 161)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(BLjava/awt/Component;)V", line = 218)
    ...
    @OriginalMember(owner = "client!er", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 245)
    ...
    @OriginalMember(owner = "client!er", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 264)
    public final void focusGained(FocusEvent arg0) {
        field3136++;
    }

    @OriginalMember(owner = "client!er", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 272)
    public final synchronized void focusLost(FocusEvent arg0) {
        field3124++;
        this.method1473('\u0000', -1, true, 0);
    }

    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Ljava/awt/event/KeyEvent;IB)V", line = 283)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 451)
    public class225(Component arg0) {
        class383.method2367(false);
        this.method1480((byte) -34, arg0);
    }

    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IIBIIII)V", line = 324)
