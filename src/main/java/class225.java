...
public class class225 extends class260 {
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(Lfca;)V", line = 3)
    public class225(class92 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(IB)V", line = 7)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lsia;I)V", line = 41)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IB)I", line = 62)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(B)I", line = 76)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(I)I", line = 98)
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(ILfca;)V", line = 110)
    public class225(int arg0, class92 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ta", name = "c", descriptor = "(I)Z", line = 113)
