...
public abstract class class225 extends class318 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(BLha;ZILuq;II)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "([Ltj;B)I")
    ...
    @OriginalMember(owner = "client!ki", name = "c", descriptor = "(Lha;B)Z")
