...
public class class225 extends class210 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I)I", line = 11)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IB)V", line = 23)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(B)J", line = 37)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lcr;I)V", line = 51)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(I)Z", line = 84)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(IB)V", line = 96)
    ...
    @OriginalMember(owner = "client!cs", name = "c", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(B)C", line = 128)
    ...
    @OriginalMember(owner = "client!cs", name = "c", descriptor = "(B)I", line = 139)
