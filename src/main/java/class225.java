...
public class class225 extends class400 {
    ...
    @OriginalMember(owner = "client!bea", name = "b", descriptor = "()Ljba;", line = 3)
    ...
    @OriginalMember(owner = "client!bea", name = "b", descriptor = "([III)V", line = 25)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(ILua;I)V", line = 64)
    ...
    @OriginalMember(owner = "client!bea", name = "b", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(IBLvv;)V", line = 98)
    ...
    @OriginalMember(owner = "client!bea", name = "d", descriptor = "()I", line = 138)
    public final int method111() {
        field3213++;
        return 0;
    }

    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(ILvv;IBI[I)V", line = 180)
    ...
    @OriginalMember(owner = "client!bea", name = "<init>", descriptor = "(Lma;)V", line = 294)
    public class225(class12 arg0) {
        this.field3207 = arg0;
    }

    @OriginalMember(owner = "client!bea", name = "d", descriptor = "(I)Lio;", line = 258)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "()Ljba;", line = 274)
