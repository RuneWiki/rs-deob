...
public class class477 extends class417 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "([Lha;B)V", line = 32)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(BII)Z", line = 91)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ZI)V", line = 105)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IBIIILte;)Lrp;", line = 143)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Z)V", line = 161)
