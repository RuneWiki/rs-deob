...
public class class477 {
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(BI)V", line = 24)
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IB)I", line = 51)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(II)Log;", line = 158)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(Z)V", line = 186)
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Ldk;ILfc;)V", line = 214)
