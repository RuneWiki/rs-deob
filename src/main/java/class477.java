...
public class class477 extends class232 {
    ...
    @OriginalMember(owner = "client!uda", name = "d", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!uda", name = "<init>", descriptor = "()V", line = 15)
    public class477() {
        super(1, true);
    }

    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(ILwq;I)V", line = 19)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(IIIIIII)J", line = 32)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(IB)[I", line = 51)
