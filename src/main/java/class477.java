...
public class class477 extends class115 {
    ...
    @OriginalMember(owner = "client!sm", name = "c", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lvi;ZI)V", line = 36)
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZ)V", line = 192)
