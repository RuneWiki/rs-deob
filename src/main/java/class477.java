...
public class class477 extends class627 {
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(BIII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(I[IIB)V", line = 21)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IZI)Z", line = 37)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IBI)Z", line = 57)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(BIIII)Z", line = 73)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(II[II)V", line = 110)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Z)V", line = 121)
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(IIIIIIIII)V", line = 145)
