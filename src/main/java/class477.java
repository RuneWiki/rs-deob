...
public class class477 implements Runnable {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(BI[BLpd;)Lcv;", line = 29)
    ...
    @OriginalMember(owner = "client!dk", name = "run", descriptor = "()V", line = 48)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(II)V", line = 114)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(III)Z", line = 127)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IBLpd;)Lcv;", line = 139)
    ...
    @OriginalMember(owner = "client!dk", name = "b", descriptor = "(IBLpd;)Lcv;", line = 161)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(ILcv;)V", line = 196)
    ...
    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "(Lnv;)V", line = 233)
