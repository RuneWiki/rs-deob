...
public class class477 extends class256 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(IILka;II)Lgp;", line = 3)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Lsb;B[BI)Loha;", line = 19)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "(I)V", line = 66)
    public class477(int arg0) {
        this.field6504 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(III)I", line = 90)
    ...
    @OriginalMember(owner = "client!tu", name = "d", descriptor = "(B)V", line = 170)
