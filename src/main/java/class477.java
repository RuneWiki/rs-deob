...
public class class477 {
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(ILig;)V")
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(Lwp;I)V")
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(ZLha;ZII)Lka;")
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(Lrr;B)V")
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(IILka;ILdfa;ILha;BZ)V")
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!iea", name = "b", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!iea", name = "<init>", descriptor = "(Lha;Lvc;IIIILrr;ZI)V")
