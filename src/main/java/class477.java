...
public class class477 extends class127 {
    ...
    @OriginalMember(owner = "client!oja", name = "a", descriptor = "(IBI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!oja", name = "a", descriptor = "(BIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!oja", name = "a", descriptor = "(IF)V", line = 26)
    ...
    @OriginalMember(owner = "client!oja", name = "<init>", descriptor = "(IIIIIF)V", line = 43)
