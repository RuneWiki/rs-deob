...
public class class477 extends class449 {
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IZIII)Lra;", line = 56)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IIIIIIII)V", line = 112)
