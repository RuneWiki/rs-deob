...
public class class477 extends Canvas {
    ...
    @OriginalMember(owner = "client!rca", name = "paint", descriptor = "(Ljava/awt/Graphics;)V")
    ...
    @OriginalMember(owner = "client!rca", name = "update", descriptor = "(Ljava/awt/Graphics;)V")
    ...
    @OriginalMember(owner = "client!rca", name = "<init>", descriptor = "(Ljava/awt/Component;)V")
    public class477(Component arg0) {
        this.field6776 = arg0;
    }

    // $FF: synthetic method
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
