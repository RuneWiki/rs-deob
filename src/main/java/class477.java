...
public class class477 extends class211 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lqq;J)Z")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lqq;[Loo;Z)V")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lqq;J[Loo;[Lma;Z)V")
    ...
    @OriginalMember(owner = "client!dd", name = "c", descriptor = "()Lii;")
