...
public class class477 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "()[F", line = 5)
    public final float[] method2783() {
        return this.field6699[this.method2784()];
    }

    @OriginalMember(owner = "client!po", name = "b", descriptor = "()I", line = 9)
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "()V", line = 18)
    public class477() {
    ...
    @OriginalMember(owner = "client!po", name = "c", descriptor = "()V", line = 162)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(II)I", line = 301)
