...
public class class477 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lwm;I)V", line = 60)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lwm;ILgn;IIZBI)V", line = 322)
    ...
    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "(Lwm;Lct;IIIIIIZI)V", line = 660)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(I)V", line = 385)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lnk;IIB)V", line = 415)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ILwm;)V", line = 500)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ZZLwm;IIIB)Lgn;", line = 529)
