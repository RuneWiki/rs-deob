...
public class class477 extends class453 {
    ...
    @OriginalMember(owner = "client!gi", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!gi", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IBI)Lrn;", line = 195)
    ...
    @OriginalMember(owner = "client!gi", name = "c", descriptor = "(I)V", line = 420)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(II)V", line = 467)
    ...
    @OriginalMember(owner = "client!gi", name = "c", descriptor = "(B)I", line = 500)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(BI)[B", line = 532)
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(ILva;Lva;Lug;Lbr;IIZ)V", line = 808)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IB)I", line = 560)
    ...
    @OriginalMember(owner = "client!gi", name = "d", descriptor = "(B)I", line = 576)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Leo;IIIII)V", line = 587)
    ...
    @OriginalMember(owner = "client!gi", name = "d", descriptor = "(I)I", line = 654)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(B)Lqn;", line = 671)
    ...
    @OriginalMember(owner = "client!gi", name = "e", descriptor = "(I)I", line = 769)
