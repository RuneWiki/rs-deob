...
public class class477 extends class487 {
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(ILbf;I)V")
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "()Lqp;")
    ...
    @OriginalMember(owner = "client!bp", name = "c", descriptor = "()Lqp;")
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(IIIILbf;[I)V")
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "(Llp;)V")
