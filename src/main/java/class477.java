...
public class class477 extends class28 {
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(B)Z", line = 22)
    ...
    @OriginalMember(owner = "client!lj", name = "c", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(BLjava/lang/String;)V", line = 51)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lw;III[Z)V", line = 153)
    ...
    @OriginalMember(owner = "client!lj", name = "f", descriptor = "(I)V", line = 179)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ILnn;)V", line = 202)
