...
public class class477 {
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(I)Lnn;")
    ...
    @OriginalMember(owner = "client!dv", name = "c", descriptor = "(I)Lnn;")
    ...
    @OriginalMember(owner = "client!dv", name = "d", descriptor = "(I)Lnn;")
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(Z)Lnn;")
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(ILnn;)V")
