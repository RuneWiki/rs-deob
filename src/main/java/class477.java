...
public class class477 extends class417 {
    ...
    @OriginalMember(owner = "client!ap", name = "c", descriptor = "()I", line = 4)
    public final int method1979() {
        field6597++;
        return 0;
    }

    @OriginalMember(owner = "client!ap", name = "b", descriptor = "([III)V", line = 12)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IIII[ILhea;)V", line = 52)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!ap", name = "d", descriptor = "()Lmha;", line = 125)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "()Lmha;", line = 147)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ILhea;I)V", line = 197)
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(Ljga;)V", line = 247)
