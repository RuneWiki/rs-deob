...
public abstract class class477 extends class443 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(ILgm;)V", line = 4)
    ...
    @OriginalMember(owner = "client!au", name = "f", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(IBI)B", line = 72)
