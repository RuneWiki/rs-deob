...
public class class477 extends class763 implements class149 {
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(Lgaa;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!jea", name = "<init>", descriptor = "(Lpa;IZ[[I)V", line = 208)
    ...
    @OriginalMember(owner = "client!jea", name = "b", descriptor = "(I)V", line = 253)
