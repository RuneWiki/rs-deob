...
public class class477 {
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(I[FIFIIIIII)V", line = 21)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IJ)V", line = 70)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(B)V", line = 89)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(ZII)I", line = 106)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IIIIZ)V", line = 120)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(JI)V", line = 142)
