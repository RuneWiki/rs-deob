...
public class class477 extends class556 {
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!uda", name = "f", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!uda", name = "g", descriptor = "(I)I", line = 27)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(Z)I", line = 37)
    ...
    @OriginalMember(owner = "client!uda", name = "c", descriptor = "(I)J", line = 48)
