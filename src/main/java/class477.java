...
public class class477 {
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ZIIII)V", line = 32)
