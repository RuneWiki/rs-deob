...
public abstract class class477 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IZLwt;)V", line = 5)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(I)V", line = 214)
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "(Lgk;)V", line = 225)
