...
public class class477 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(ZLhp;)V", line = 19)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Z)V", line = 33)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IB)[I", line = 51)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(Z)V", line = 118)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(II)I", line = 140)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "(III)V", line = 252)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(III)V", line = 192)
    ...
    @OriginalMember(owner = "client!hv", name = "c", descriptor = "(I)[[I", line = 223)
