...
public class class477 extends Canvas {
    ...
    @OriginalMember(owner = "client!uj", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 4)
    ...
    @OriginalMember(owner = "client!uj", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 23)
    public final void update(Graphics arg0) {
        field6752++;
        this.field6750.update(arg0);
    }

    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 36)
    public class477(Component arg0) {
        this.field6750 = arg0;
    }

    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Lmg;B)V", line = 49)
