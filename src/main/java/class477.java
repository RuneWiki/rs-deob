...
public abstract class class477 {
    ...
    @OriginalMember(owner = "client!ab", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(ILwi;)Ljava/lang/String;", line = 17)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(IBIFIIIZI)[[I", line = 38)
