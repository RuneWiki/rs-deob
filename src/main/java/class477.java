...
public class class477 extends class31 {
    ...
    @OriginalMember(owner = "client!es", name = "e", descriptor = "()Z", line = 48)
    public final boolean method2794() {
        return this.field6889 != 0;
    }

    @OriginalMember(owner = "client!es", name = "a", descriptor = "([B[IIIIIIIILes;)I", line = 56)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "([IIIII)I", line = 90)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(II[B[IIIIIIIILes;II)I", line = 145)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Z)V", line = 177)
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "()Loo;", line = 183)
    public final class31 method226() {
        return null;
    }

    @OriginalMember(owner = "client!es", name = "a", descriptor = "(I[B[IIIIIIIIIILes;)I", line = 186)
    ...
    @OriginalMember(owner = "client!es", name = "f", descriptor = "()Z", line = 239)
    public final boolean method2800() {
        return this.field6900 < 0 || this.field6900 >= ((class174) super.field469).field2641.length << 8;
    }

    @OriginalMember(owner = "client!es", name = "a", descriptor = "(II[B[IIIIIIILes;II)I", line = 242)
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(I)V", line = 272)
    ...
    @OriginalMember(owner = "client!es", name = "d", descriptor = "(I)V", line = 492)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "([B[IIIIIIILes;)I", line = 504)
    ...
    @OriginalMember(owner = "client!es", name = "g", descriptor = "()Z", line = 530)
    ...
    @OriginalMember(owner = "client!es", name = "h", descriptor = "()I", line = 615)
    public final synchronized int method2805() {
        return this.field6888 < 0 ? -this.field6888 : this.field6888;
    }

    @OriginalMember(owner = "client!es", name = "i", descriptor = "()I", line = 618)
    public final synchronized int method2806() {
        return this.field6901 < 0 ? -1 : this.field6901;
    }

    @OriginalMember(owner = "client!es", name = "b", descriptor = "(II[B[IIIIIIIILes;II)I", line = 621)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Lhe;III)Les;", line = 654)
    ...
    @OriginalMember(owner = "client!es", name = "c", descriptor = "(II[B[IIIIIIIILes;II)I", line = 678)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(II[B[IIIIIIIIIILes;II)I", line = 711)
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(II[B[IIIIIIIIIILes;II)I", line = 754)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(I[B[IIIIIIIILes;)I", line = 795)
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(I[B[IIIIIIIILes;)I", line = 836)
    ...
    @OriginalMember(owner = "client!es", name = "k", descriptor = "()I", line = 874)
    public final synchronized int method2817() {
        return this.field6893 == Integer.MIN_VALUE ? 0 : this.field6893;
    }

    @OriginalMember(owner = "client!es", name = "l", descriptor = "()V", line = 877)
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "([IIIII)I", line = 883)
    ...
    @OriginalMember(owner = "client!es", name = "d", descriptor = "()Loo;", line = 938)
    public final class31 method228() {
        return null;
    }

    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Lhe;II)Les;", line = 943)
    ...
    @OriginalMember(owner = "client!es", name = "f", descriptor = "(I)V", line = 949)
    public final synchronized void method2821(int arg0) {
        this.method2828(arg0 << 6, this.method2806());
    }

    @OriginalMember(owner = "client!es", name = "a", descriptor = "()I", line = 953)
    public final int method225() {
        return this.field6893 == 0 && this.field6889 == 0 ? 0 : 1;
    }

    @OriginalMember(owner = "client!es", name = "b", descriptor = "(II)I", line = 959)
    private static final int method2822(int arg0, int arg1) {
        return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
    }

    @OriginalMember(owner = "client!es", name = "b", descriptor = "([B[IIIIIIILes;)I", line = 962)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(III)V", line = 988)
    ...
    @OriginalMember(owner = "client!es", name = "g", descriptor = "(I)V", line = 1036)
    public final synchronized void method2825(int arg0) {
        this.field6896 = arg0;
    }

    @OriginalMember(owner = "client!es", name = "c", descriptor = "(II)I", line = 1043)
    private static final int method2826(int arg0, int arg1) {
        return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
    }

    @OriginalMember(owner = "client!es", name = "b", descriptor = "(II[B[IIIIIIILes;II)I", line = 1046)
    ...
    @OriginalMember(owner = "client!es", name = "d", descriptor = "(II)V", line = 1073)
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "([B[IIIIIIIILes;)I", line = 1082)
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(I[B[IIIIIIIIIILes;)I", line = 1116)
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "([III)V", line = 1170)
    ...
    @OriginalMember(owner = "client!es", name = "d", descriptor = "(II[B[IIIIIIIILes;II)I", line = 1406)
    ...
    @OriginalMember(owner = "client!es", name = "h", descriptor = "(I)V", line = 1439)
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(Lhe;II)V", line = 1445)
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(Lhe;III)V", line = 1456)
    ...
    @OriginalMember(owner = "client!es", name = "c", descriptor = "()I", line = 1469)
