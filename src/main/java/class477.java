...
public class class477 {
    ...
    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "(Ljaa;)V", line = 107)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IBI)V", line = 33)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Lpg;IIII)V", line = 65)
