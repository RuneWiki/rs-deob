...
public class class477 extends class440 {
    ...
    @OriginalMember(owner = "client!dn", name = "c", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!dn", name = "g", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(IIZ)V", line = 28)
    ...
    @OriginalMember(owner = "client!dn", name = "f", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ILmo;I)V", line = 59)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 75)
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "()V", line = 113)
    public class477() {
        super(0, false);
    }

    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(II)[[I", line = 116)
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(B)J", line = 182)
    ...
    @OriginalMember(owner = "client!dn", name = "c", descriptor = "(III)I", line = 195)
