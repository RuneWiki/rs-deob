...
public abstract class class477 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Ljava/util/Random;II)I", line = 63)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ZIIIII[B)V", line = 98)
