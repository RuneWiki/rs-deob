...
public class class477 {
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Lwb;JI)V")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(ZJ)Lwb;")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(B[Lwb;)I")
    ...
    @OriginalMember(owner = "client!dfa", name = "b", descriptor = "(I)Lwb;")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(I)Lwb;")
    ...
    @OriginalMember(owner = "client!dfa", name = "d", descriptor = "(I)Lwb;")
