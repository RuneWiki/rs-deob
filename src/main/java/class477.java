...
public class class477 extends class189 {
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(II)Z")
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(IZIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(IIILjava/lang/Class;)V")
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(Z)I")
    ...
    @OriginalMember(owner = "client!lia", name = "d", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!lia", name = "<init>", descriptor = "(II)V")
