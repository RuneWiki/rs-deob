...
public class class477 extends Exception {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(B)I", line = 6)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(I)I", line = 26)
    ...
    @OriginalMember(owner = "client!au", name = "b", descriptor = "(B)V", line = 40)
