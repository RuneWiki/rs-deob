...
public class class477 extends class303 {
    ...
    @OriginalMember(owner = "client!qf", name = "s", descriptor = "(B)I", line = 6)
    ...
    @OriginalMember(owner = "client!qf", name = "p", descriptor = "(II)I", line = 21)
    ...
    @OriginalMember(owner = "client!qf", name = "n", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!qf", name = "o", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!qf", name = "t", descriptor = "(B)Z", line = 83)
    ...
    @OriginalMember(owner = "client!qf", name = "u", descriptor = "(B)V", line = 99)
    ...
    @OriginalMember(owner = "client!qf", name = "q", descriptor = "(II)V", line = 110)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lhh;B)V", line = 124)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(III)I", line = 135)
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(I)V", line = 158)
    public class477(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qf", name = "p", descriptor = "(I)V", line = 161)
    ...
    @OriginalMember(owner = "client!qf", name = "r", descriptor = "(II)I", line = 365)
    ...
    @OriginalMember(owner = "client!qf", name = "q", descriptor = "(I)V", line = 377)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "([IB)V", line = 392)
    ...
    @OriginalMember(owner = "client!qf", name = "c", descriptor = "(II[BI)V", line = 410)
