...
public class class477 extends class65 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Ljava/awt/Canvas;III)Llc;", line = 3)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Ld;ZILha;III)V", line = 29)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(I)V", line = 115)
