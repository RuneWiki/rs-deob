...
public class class477 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(BI)Luj;")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IB)Lkl;")
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(Lai;ILic;)V")
