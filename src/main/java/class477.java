...
public class class477 {
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IIZI)Luu;", line = 22)
    ...
    @OriginalMember(owner = "client!sj", name = "b", descriptor = "(I)I", line = 40)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IBI)Lnfa;", line = 488)
